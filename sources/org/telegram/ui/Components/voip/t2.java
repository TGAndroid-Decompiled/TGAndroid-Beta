...
public final class t2 extends View {
    public StaticLayout f29636a;
    public final RectF f29637b;
    public final Paint f29638c;
    public final Paint d;
    public String e;
    public final TextPaint f29639f;
    public int h;
    public boolean f29640n;
    public final Drawable f29641r;
    public final i2.g0 f29642s;

    public t2(Activity activity) {
        super(activity);
        this.f29637b = new RectF();
        Paint paint = new Paint(1);
        this.f29638c = paint;
        Paint paint2 = new Paint(1);
        this.d = paint2;
        TextPaint textPaint = new TextPaint(1);
        this.f29639f = textPaint;
        this.h = 4;
        this.f29640n = false;
        this.f29642s = new i2.g0(this, 26);
    ...
    public final void a() {
        ...
        if (str == null || !str.equals(formatLongDuration)) {
            ...
            String str2 = this.e;
            TextPaint textPaint = this.f29639f;
            this.f29636a = new StaticLayout(str2, textPaint, (int) textPaint.measureText(str2), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        }
    ...
    public final void onDraw(Canvas canvas) {
        int dp;
        Paint paint;
        StaticLayout staticLayout = this.f29636a;
        int i10 = 0;
    ...
    public void setVisibility(int i10) {
        if (getVisibility() != i10) {
            if (i10 == 0) {
                ...
                String str = this.e;
                TextPaint textPaint = this.f29639f;
                this.f29636a = new StaticLayout(str, textPaint, (int) textPaint.measureText(str), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                a();
            } else {
                this.e = null;
                this.f29636a = null;
