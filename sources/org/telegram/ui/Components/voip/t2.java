...
public final class t2 extends View {
    public StaticLayout f29529a;
    public final RectF f29530b;
    public final Paint f29531c;
    public final Paint d;
    public String e;
    public final TextPaint f29532f;
    public int h;
    public boolean f29533n;
    public final Drawable f29534r;
    public final i2.g0 f29535s;

    public t2(Activity activity) {
        super(activity);
        this.f29530b = new RectF();
        Paint paint = new Paint(1);
        this.f29531c = paint;
        Paint paint2 = new Paint(1);
        this.d = paint2;
        TextPaint textPaint = new TextPaint(1);
        this.f29532f = textPaint;
        this.h = 4;
        this.f29533n = false;
        this.f29535s = new i2.g0(this, 25);
    ...
    public final void a() {
        ...
        if (str == null || !str.equals(formatLongDuration)) {
            ...
            String str2 = this.e;
            TextPaint textPaint = this.f29532f;
            this.f29529a = new StaticLayout(str2, textPaint, (int) textPaint.measureText(str2), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        }
    ...
    public final void onDraw(Canvas canvas) {
        int dp;
        Paint paint;
        StaticLayout staticLayout = this.f29529a;
        int i10 = 0;
    ...
    public void setVisibility(int i10) {
        if (getVisibility() != i10) {
            if (i10 == 0) {
                ...
                String str = this.e;
                TextPaint textPaint = this.f29532f;
                this.f29529a = new StaticLayout(str, textPaint, (int) textPaint.measureText(str), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                a();
            } else {
                this.e = null;
                this.f29529a = null;
