...
public final class t2 extends View {
    public StaticLayout f29598a;
    public final RectF f29599b;
    public final Paint f29600c;
    public final Paint d;
    public String e;
    public final TextPaint f29601f;
    public int h;
    public boolean f29602n;
    public final Drawable f29603r;
    public final i2.g0 f29604s;
    ...
    public t2(Activity activity) {
        ...
        this.f29601f = textPaint;
        this.h = 4;
        this.f29602n = false;
        this.f29604s = new i2.g0(this, 26);
    ...
    public final void a() {
        ...
        if (str == null || !str.equals(formatLongDuration)) {
            ...
            String str2 = this.e;
            TextPaint textPaint = this.f29601f;
            this.f29598a = new StaticLayout(str2, textPaint, (int) textPaint.measureText(str2), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        }
    ...
    public final void onDraw(Canvas canvas) {
        int dp;
        Paint paint;
        StaticLayout staticLayout = this.f29598a;
        int i10 = 0;
    ...
    public void setVisibility(int i10) {
        if (getVisibility() != i10) {
            if (i10 == 0) {
                ...
                String str = this.e;
                TextPaint textPaint = this.f29601f;
                this.f29598a = new StaticLayout(str, textPaint, (int) textPaint.measureText(str), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                a();
            } else {
                this.e = null;
                this.f29598a = null;
