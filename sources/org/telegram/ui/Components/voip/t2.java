...
public final class t2 extends View {
    public StaticLayout f29956a;
    public final RectF f29957b;
    public final Paint f29958c;
    public final Paint d;
    public String e;
    public final TextPaint f29959f;
    public int h;
    public boolean f29960n;
    public final Drawable f29961r;
    public final n5 f29962s;
    ...
    public t2(Activity activity) {
        ...
        this.f29959f = textPaint;
        this.h = 4;
        this.f29960n = false;
        this.f29962s = new n5(this, 26);
    ...
    public final void a() {
        ...
        if (str == null || !str.equals(formatLongDuration)) {
            ...
            String str2 = this.e;
            TextPaint textPaint = this.f29959f;
            this.f29956a = new StaticLayout(str2, textPaint, (int) textPaint.measureText(str2), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        }
    ...
    public final void onDraw(Canvas canvas) {
        int dp;
        Paint paint;
        StaticLayout staticLayout = this.f29956a;
        int i10 = 0;
    ...
    public void setVisibility(int i10) {
        if (getVisibility() != i10) {
            if (i10 == 0) {
                ...
                String str = this.e;
                TextPaint textPaint = this.f29959f;
                this.f29956a = new StaticLayout(str, textPaint, (int) textPaint.measureText(str), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                a();
            } else {
                this.e = null;
                this.f29956a = null;
