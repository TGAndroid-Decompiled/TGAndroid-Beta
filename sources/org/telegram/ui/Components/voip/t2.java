...
public final class t2 extends View {
    public StaticLayout f29210a;
    public final RectF f29211b;
    public final Paint f29212c;
    public final Paint d;
    public String e;
    public final TextPaint f29213f;
    public int h;
    public boolean f29214n;
    public final Drawable f29215r;
    public final i2.g0 f29216s;

    public t2(Activity activity) {
        super(activity);
        this.f29211b = new RectF();
        Paint paint = new Paint(1);
        this.f29212c = paint;
        Paint paint2 = new Paint(1);
        this.d = paint2;
        TextPaint textPaint = new TextPaint(1);
        this.f29213f = textPaint;
        this.h = 4;
        this.f29214n = false;
        this.f29216s = new i2.g0(this, 25);
    ...
    public final void a() {
        ...
        if (str == null || !str.equals(formatLongDuration)) {
            ...
            String str2 = this.e;
            TextPaint textPaint = this.f29213f;
            this.f29210a = new StaticLayout(str2, textPaint, (int) textPaint.measureText(str2), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        }
    ...
    public final void onDraw(Canvas canvas) {
        int dp;
        Paint paint;
        StaticLayout staticLayout = this.f29210a;
        int i10 = 0;
    ...
    public void setVisibility(int i10) {
        if (getVisibility() != i10) {
            if (i10 == 0) {
                ...
                String str = this.e;
                TextPaint textPaint = this.f29213f;
                this.f29210a = new StaticLayout(str, textPaint, (int) textPaint.measureText(str), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                a();
            } else {
                this.e = null;
                this.f29210a = null;
