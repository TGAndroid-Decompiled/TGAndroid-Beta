...
public final class n2 implements VoIPService.StateListener, rf.a, NotificationCenter.NotificationCenterDelegate {
    ...
    public final m6 f29495a;
    public final m2 f29496b;
    public WindowManager f29497c;
    public WindowManager.LayoutParams d;
    public pf.e e;
    public final int f29498f;
    public final int h;
    public final t2 f29499n;
    public final t2 f29500r;
    public float f29501s;
    public ValueAnimator v;
    public final int f29504y;
    public final r0 f29502w = new r0(this, 4);
    public final float[] f29503x = new float[2];
    ...
    public static void l(Activity activity, int i10, int i11, int i12, int i13) {
        ...
        if (U == null && VideoCapturerDevice.eglBase != null) {
            ...
            float f17 = n2Var2.f29498f * 0.25f;
            float f18 = n2Var2.h * 0.25f;
            m2 m2Var = n2Var2.f29496b;
            ...
            layoutParams2.x = (int) (((((f15 - dp) - dp2) - f17) * f13) - (n2Var2.f29504y - dp));
            layoutParams2.y = (int) (((((f16 - dp3) - dp4) - f18) * f14) - (n2Var2.E - dp3));
            AndroidUtilities.updateViewLayout(n2Var2.f29497c, n2Var2.f29495a, layoutParams2);
            NotificationCenter.getGlobalInstance().addObserver(U, NotificationCenter.didEndCall);
            windowManager.addView(U.f29495a, layoutParams);
            U.f29499n.d.init(VideoCapturerDevice.eglBase.getEglBaseContext(), null);
            U.f29500r.d.init(VideoCapturerDevice.eglBase.getEglBaseContext(), U.S);
            if (i13 == 0) {
                U.f29495a.setScaleX(0.5f);
                U.f29495a.setScaleY(0.5f);
                U.f29495a.setAlpha(0.0f);
                U.f29495a.animate().alpha(1.0f).scaleY(1.0f).scaleX(1.0f).start();
                if (VoIPService.getSharedInstance() != null) {
                    VoIPService sharedInstance = VoIPService.getSharedInstance();
                    n2 n2Var3 = U;
                    sharedInstance.setSinks(n2Var3.f29499n.d, n2Var3.f29500r.d);
                }
            } else if (i13 == 1) {
                U.f29495a.setAlpha(0.0f);
                if (VoIPService.getSharedInstance() != null) {
                    ...
                    n2 n2Var4 = U;
                    sharedInstance2.setBackgroundSinks(n2Var4.f29499n.d, n2Var4.f29500r.d);
                }
            }
            ...
            if (sharedInstance3 != null && sharedInstance3.getRemoteVideoState() == 2 && sf.c.a(activity) == 1) {
                ...
                dVar.f41038c = "voip-pip";
                dVar.e = 1;
                t2 t2Var = n2Var5.f29500r;
    ...
    public final void a(com.google.android.gms.internal.cast.p pVar) {
        this.R = pVar;
        t2 t2Var = this.f29500r;
        if (t2Var != null) {
            t2Var.d.clearFirstFrame();
        }
        VoIPService sharedInstance = VoIPService.getSharedInstance();
        if (sharedInstance != null) {
            sharedInstance.setSinks(this.f29499n.d, this.Q.d);
        }
        WindowManager windowManager = this.f29497c;
        m6 m6Var = this.f29495a;
    ...
    public final void b(com.google.android.gms.internal.cast.p pVar) {
        ...
        VoIPService sharedInstance = VoIPService.getSharedInstance();
        if (sharedInstance != null) {
            sharedInstance.setSinks(this.f29499n.d, this.f29500r.d);
        }
    }
    ...
    @Override
    public final View h() {
        t2 t2Var = new t2(this.f29500r.getContext(), false, true, false, false);
        this.Q = t2Var;
    ...
    public final void j() {
        this.f29499n.d.release();
        this.f29500r.d.release();
        VoIPService sharedInstance = VoIPService.getSharedInstance();
        if (sharedInstance != null) {
            sharedInstance.unregisterStateListener(this);
        }
        this.f29495a.setVisibility(8);
        if (this.f29495a.getParent() != null) {
            m2 m2Var = this.f29496b;
            float[] fArr = this.f29503x;
            int i10 = m2.h;
            m2Var.getClass();
            Point point = AndroidUtilities.displaySize;
            n2 n2Var = m2Var.f29490f;
            int i11 = n2Var.d.x;
            m2 m2Var2 = n2Var.f29496b;
            float left = m2Var2.getLeft() + i11;
            float f7 = m2Var.f29488b;
            fArr[0] = (left - f7) / (((point.x - f7) - m2Var.f29489c) - m2Var2.getMeasuredWidth());
            float top = m2Var2.getTop() + n2Var.d.y;
            float f10 = m2Var.d;
            fArr[1] = (top - f10) / (((point.y - f10) - m2Var.e) - m2Var2.getMeasuredHeight());
            fArr[0] = Math.min(1.0f, Math.max(0.0f, fArr[0]));
            fArr[1] = Math.min(1.0f, Math.max(0.0f, fArr[1]));
            ApplicationLoader.applicationContext.getSharedPreferences("voippipconfig", 0).edit().putFloat("relativeX", Math.min(1.0f, Math.max(0.0f, this.f29503x[0]))).putFloat("relativeY", Math.min(1.0f, Math.max(0.0f, this.f29503x[1]))).apply();
            try {
                this.f29497c.removeView(this.f29495a);
            } catch (Throwable th2) {
                FileLog.e(th2);
            }
        }
    ...
    public final void m() {
        ...
        boolean z11;
        boolean z12;
        if (this.f29496b.getMeasuredWidth() != 0) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        if (!z10) {
            ...
            float f10 = this.f29501s;
            if (!this.G) {
                f7 = 0.0f;
            }
            ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, f7);
            this.v = ofFloat;
            ofFloat.addUpdateListener(this.f29502w);
            this.v.setDuration(300L).setInterpolator(rr.f28022f);
            this.v.start();
        }
    }
    ...
    public final void onMediaStateUpdated(int i10, int i11) {
        ...
        if (sharedInstance != null && sharedInstance.getRemoteVideoState() == 2) {
            Context context = U.f29495a.getContext();
