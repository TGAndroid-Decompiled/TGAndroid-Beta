...
public class n2 extends TextView {
    ...
    public void c() {
        CharSequence text;
        g90 g90Var = (g90) this.f29090c;
        Layout layout = getLayout();
        if (layout == null || (text = layout.getText()) == null) {
            return;
        }
        w80 w80Var = new w80(0);
        w80Var.f29605q = AndroidUtilities.dp(3.0f);
        w80Var.f29606r = AndroidUtilities.dp(6.0f);
        int length = text.length();
        w80Var.d(layout, 0, 0.0f);
        layout.getSelectionPath(0, length, w80Var);
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(w80Var.f29607s, w80Var.f29609u, w80Var.f29608t, w80Var.v);
        ((org.telegram.ui.Cells.z) this.f29089b).setBounds((int) rectF.left, (int) rectF.top, (int) rectF.right, (int) rectF.bottom);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        switch (this.f29088a) {
            case 0:
                RectF rectF = (RectF) this.f29089b;
            ...
            default:
                ...
                ((org.telegram.ui.Cells.z) this.f29089b).draw(canvas);
                canvas.restore();
                super.onDraw(canvas);
                if (a() || g90Var.c()) {
                    canvas.save();
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        switch (this.f29088a) {
            case 1:
                org.telegram.ui.Cells.z zVar = (org.telegram.ui.Cells.z) this.f29089b;
    ...
    public boolean verifyDrawable(Drawable drawable) {
        switch (this.f29088a) {
            case 1:
                if (drawable != ((org.telegram.ui.Cells.z) this.f29089b) && !super.verifyDrawable(drawable)) {
                    return false;
                }
                return true;
            default:
