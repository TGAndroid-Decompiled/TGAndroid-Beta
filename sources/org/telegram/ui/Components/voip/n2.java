...
public final class n2 implements VoIPService.StateListener, ef.a, NotificationCenter.NotificationCenterDelegate {
    ...
    public t2 N;
    public c2.p O;
    public final ag.l f32206a;
    public final m2 f32207b;
    public WindowManager f32208c;
    public WindowManager.LayoutParams d;
    public cf.f f32209e;
    public final int f32210f;
    public final int h;
    public final t2 f32211n;
    public final t2 f32212r;
    public float f32213s;
    public ValueAnimator v;
    public final int f32216y;
    public final f5 f32214w = new f5(this, 7);
    public final float[] f32215x = new float[2];
    ...
    public static void l(Activity activity, int i10, int i11, int i12, int i13) {
        ...
        if (R == null && VideoCapturerDevice.eglBase != null) {
            ...
            float f18 = n2Var2.f32210f * 0.25f;
            float f19 = n2Var2.h * 0.25f;
            m2 m2Var = n2Var2.f32207b;
            ...
            layoutParams2.x = (int) (((((f16 - dp) - dp2) - f18) * f14) - (n2Var2.f32216y - dp));
            layoutParams2.y = (int) (((((f17 - dp3) - dp4) - f19) * f15) - (n2Var2.B - dp3));
            AndroidUtilities.updateViewLayout(n2Var2.f32208c, n2Var2.f32206a, layoutParams2);
            NotificationCenter.getGlobalInstance().addObserver(R, NotificationCenter.didEndCall);
            windowManager.addView(R.f32206a, layoutParams);
            R.f32211n.d.init(VideoCapturerDevice.eglBase.getEglBaseContext(), null);
            R.f32212r.d.init(VideoCapturerDevice.eglBase.getEglBaseContext(), R.P);
            if (i13 == 0) {
                R.f32206a.setScaleX(0.5f);
                R.f32206a.setScaleY(0.5f);
                R.f32206a.setAlpha(0.0f);
                R.f32206a.animate().alpha(1.0f).scaleY(1.0f).scaleX(1.0f).start();
                if (VoIPService.getSharedInstance() != null) {
                    VoIPService sharedInstance = VoIPService.getSharedInstance();
                    n2 n2Var3 = R;
                    sharedInstance.setSinks(n2Var3.f32211n.d, n2Var3.f32212r.d);
                }
            } else if (i13 == 1) {
                R.f32206a.setAlpha(0.0f);
                if (VoIPService.getSharedInstance() != null) {
                    ...
                    n2 n2Var4 = R;
                    sharedInstance2.setBackgroundSinks(n2Var4.f32211n.d, n2Var4.f32212r.d);
                }
            }
            ...
            if (sharedInstance3 != null && sharedInstance3.getRemoteVideoState() == 2 && ff.d.a(activity) == 1) {
                ...
                eVar.f2483e = 1;
                t2 t2Var = n2Var5.f32212r;
                eVar.f2487j = t2Var.d;
                eVar.f2488k = t2Var.getPlaceholderView();
                n2Var5.f32209e = eVar.a();
            }
        }
    }
    ...
    public final void a(c2.p pVar) {
        this.O = pVar;
        WindowManager windowManager = this.f32208c;
        WindowManager.LayoutParams layoutParams = this.d;
        ag.l lVar = this.f32206a;
        ...
        VoIPService sharedInstance = VoIPService.getSharedInstance();
        if (sharedInstance != null) {
            sharedInstance.setSinks(this.f32211n.d, this.f32212r.d);
        }
    }
    ...
    public final void e(c2.p pVar) {
        ...
        VoIPService sharedInstance = VoIPService.getSharedInstance();
        if (sharedInstance != null) {
            sharedInstance.setSinks(this.f32211n.d, this.N.d);
        }
        WindowManager windowManager = this.f32208c;
        ag.l lVar = this.f32206a;
    ...
    @Override
    public final View h() {
        t2 t2Var = new t2(this.f32212r.getContext(), false, true, false, false);
        this.N = t2Var;
    ...
    public final void j() {
        this.f32211n.d.release();
        this.f32212r.d.release();
        VoIPService sharedInstance = VoIPService.getSharedInstance();
        if (sharedInstance != null) {
            sharedInstance.unregisterStateListener(this);
        }
        this.f32206a.setVisibility(8);
        if (this.f32206a.getParent() != null) {
            m2 m2Var = this.f32207b;
            float[] fArr = this.f32215x;
            int i10 = m2.h;
            m2Var.getClass();
            Point point = AndroidUtilities.displaySize;
            n2 n2Var = m2Var.f32201f;
            int i11 = n2Var.d.x;
            m2 m2Var2 = n2Var.f32207b;
            float left = m2Var2.getLeft() + i11;
            float f10 = m2Var.f32198b;
            fArr[0] = (left - f10) / (((point.x - f10) - m2Var.f32199c) - m2Var2.getMeasuredWidth());
            float top = m2Var2.getTop() + n2Var.d.y;
            float f11 = m2Var.d;
            fArr[1] = (top - f11) / (((point.y - f11) - m2Var.f32200e) - m2Var2.getMeasuredHeight());
            fArr[0] = Math.min(1.0f, Math.max(0.0f, fArr[0]));
            fArr[1] = Math.min(1.0f, Math.max(0.0f, fArr[1]));
            ApplicationLoader.applicationContext.getSharedPreferences("voippipconfig", 0).edit().putFloat("relativeX", Math.min(1.0f, Math.max(0.0f, this.f32215x[0]))).putFloat("relativeY", Math.min(1.0f, Math.max(0.0f, this.f32215x[1]))).apply();
            try {
                this.f32208c.removeView(this.f32206a);
            } catch (Throwable th2) {
                FileLog.e(th2);
            }
        }
        cf.f fVar = this.f32209e;
        if (fVar != null) {
            fVar.c();
            this.f32209e = null;
        }
    ...
    public final void m() {
        ...
        boolean z10;
        boolean z11;
        if (this.f32207b.getMeasuredWidth() != 0) {
            z4 = true;
        } else {
            z4 = false;
        }
        ...
        if (!z4) {
            ...
            float f11 = this.f32213s;
            if (!this.D) {
                f10 = 0.0f;
            }
            ValueAnimator ofFloat = ValueAnimator.ofFloat(f11, f10);
            this.v = ofFloat;
            ofFloat.addUpdateListener(this.f32214w);
            this.v.setDuration(300L).setInterpolator(pr.f30168f);
            this.v.start();
        }
    }
    ...
    public final void onMediaStateUpdated(int i10, int i11) {
        ...
        if (sharedInstance != null && sharedInstance.getRemoteVideoState() == 2) {
            Context context = R.f32206a.getContext();
            if (this.f32209e == null && ff.d.a(context) == 1 && (context instanceof Activity)) {
