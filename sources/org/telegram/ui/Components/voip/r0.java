    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (i10) {
            case 0:
                s0 s0Var = (s0) obj;
                s0Var.getClass();
                s0Var.f29174i = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                return;
            case 1:
                mi1 mi1Var = (mi1) obj;
            ...
            case 4:
                m2 m2Var = (m2) obj;
                m2Var.getClass();
                m2Var.f29074s = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                m2Var.f29069b.invalidate();
                return;
            case 5:
                l4 l4Var = (l4) obj;
                ((z5) l4Var.f1180b).f28301a.setAlpha(((Float) valueAnimator.getAnimatedValue()).floatValue());
                l4Var.invalidate();
                return;
            case 6:
            ...
            case 7:
                ...
                k0Var.f38950a0 = floatValue2;
                k0Var.j(floatValue2);
                k0Var.f38952b0.setAlpha(k0Var.f38950a0);
                ...
                return;
            case 8:
                ((bu0) ((qg.z0) obj)).K.f30950e0.invalidate();
                return;
            case 9:
                qg.u1 u1Var2 = (qg.u1) obj;
                u1Var2.getClass();
                u1Var2.f41690n = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                u1Var2.invalidate();
                return;
            case 10:
                qg.b2 b2Var = (qg.b2) obj;
                b2Var.getClass();
                b2Var.f41341x = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                b2Var.invalidate();
                return;
            case 11:
                pg.n nVar = (pg.n) obj;
                nVar.f41341x = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                nVar.invalidate();
                return;
            case 12:
            ...
            case 13:
                ...
                v2Var.f41715y = floatValue3;
                zd zdVar = v2Var.f41708c;
                zdVar.setAlpha(floatValue3);
                zdVar.setScaleX(AndroidUtilities.lerp(0.9f, 1.0f, v2Var.f41715y));
                zdVar.setScaleY(AndroidUtilities.lerp(0.9f, 1.0f, v2Var.f41715y));
                v2Var.f41707b.invalidate();
                return;
            case 14:
            ...
            case 15:
                ...
                int i11 = LimitPreviewView.f22110l0;
            ...
            case 16:
                ...
                return;
            case 17:
                ((rg.v1) obj).f42544a.f42529o = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                return;
            case 18:
                tg.b bVar = (tg.b) obj;
                bVar.getClass();
                bVar.f43108b = Math.max(1.0f, ((Float) valueAnimator.getAnimatedValue()).floatValue());
                bVar.invalidate();
                return;
            case 19:
                xg.i iVar = (xg.i) obj;
            ...
            case 22:
                ...
                s2Var.E = floatValue5;
                if (floatValue5 >= 0.8f && (r2Var = s2Var.H) != null && (z10 = r2Var.f47727l) && z10) {
                    r2Var.f47727l = false;
                    r2Var.b();
                }
                s2Var.invalidate();
            ...
            case 24:
                e4 e4Var = (e4) obj;
                e4Var.getClass();
                e4Var.f47140y = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                e4Var.invalidate();
                return;
            case 25:
                float floatValue6 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                u00 u00Var = ((m7) obj).f47493c;
            ...
            case 26:
                n8 n8Var = (n8) obj;
                n8Var.getClass();
                n8Var.f47545c0 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                n8Var.invalidate();
                return;
            default:
                float floatValue7 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                zg.s sVar = ((zg.t) obj).f49192b;
                if (sVar != null) {
