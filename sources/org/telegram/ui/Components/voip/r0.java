    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (i10) {
            case 0:
                s0 s0Var = (s0) obj;
                s0Var.getClass();
                s0Var.f29519i = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                return;
            case 1:
                fi1 fi1Var = (fi1) obj;
            ...
            case 4:
                n2 n2Var = (n2) obj;
                n2Var.getClass();
                n2Var.f29427s = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                n2Var.f29422b.invalidate();
                return;
            case 5:
                l4 l4Var = (l4) obj;
                ((y5) l4Var.f1180b).f29958a.setAlpha(((Float) valueAnimator.getAnimatedValue()).floatValue());
                l4Var.invalidate();
                return;
            case 6:
            ...
            case 7:
                ...
                l0Var.f39226a0 = floatValue2;
                l0Var.j(floatValue2);
                l0Var.f39228b0.setAlpha(l0Var.f39226a0);
                ...
                return;
            case 8:
                ((rt0) ((qg.x0) obj)).K.f31222e0.invalidate();
                return;
            case 9:
                qg.s1 s1Var = (qg.s1) obj;
                s1Var.getClass();
                s1Var.f41921n = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                s1Var.invalidate();
                return;
            case 10:
                qg.z1 z1Var = (qg.z1) obj;
                z1Var.getClass();
                z1Var.f42027x = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                z1Var.invalidate();
                return;
            case 11:
                pg.n nVar = (pg.n) obj;
                nVar.f42027x = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                nVar.invalidate();
                return;
            case 12:
            ...
            case 13:
                ...
                t2Var.f41946y = floatValue3;
                xd xdVar = t2Var.f41939c;
                xdVar.setAlpha(floatValue3);
                xdVar.setScaleX(AndroidUtilities.lerp(0.9f, 1.0f, t2Var.f41946y));
                xdVar.setScaleY(AndroidUtilities.lerp(0.9f, 1.0f, t2Var.f41946y));
                t2Var.f41938b.invalidate();
                return;
            case 14:
            ...
            case 16:
                ...
                return;
            case 17:
                ((rg.w1) obj).f42814a.f42796o = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                return;
            case 18:
                tg.b bVar = (tg.b) obj;
                bVar.getClass();
                bVar.f43377b = Math.max(1.0f, ((Float) valueAnimator.getAnimatedValue()).floatValue());
                bVar.invalidate();
                return;
            case 19:
                xg.i iVar = (xg.i) obj;
            ...
            case 22:
                ...
                p2Var.E = floatValue5;
                if (floatValue5 >= 0.8f && (o2Var = p2Var.H) != null && (z10 = o2Var.f47807l) && z10) {
                    o2Var.f47807l = false;
                    o2Var.b();
                }
                p2Var.invalidate();
            ...
            case 24:
                b4 b4Var = (b4) obj;
                b4Var.getClass();
                b4Var.f47234y = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                b4Var.invalidate();
                return;
            case 25:
                float floatValue6 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                o00 o00Var = ((k7) obj).f47622c;
            ...
            case 26:
                l8 l8Var = (l8) obj;
                l8Var.getClass();
                l8Var.f47678c0 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                l8Var.invalidate();
                return;
            default:
                float floatValue7 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                zg.s sVar = ((zg.t) obj).f49439b;
                if (sVar != null) {
