...
public final class p1 extends FrameLayout {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        int i14;
        if (this.f31721e) {
            int childCount = (int) (((getChildCount() - this.f31718a) / 2.0f) * ((this.f31720c * 2) + this.f31719b));
            for (int i15 = 0; i15 < getChildCount(); i15++) {
                View childAt = getChildAt(i15);
                if (childAt.getVisibility() != 8) {
                    int i16 = this.f31720c;
                    childAt.layout(childCount + i16, 0, childAt.getMeasuredWidth() + i16 + childCount, childAt.getMeasuredHeight());
                    childCount = childAt.getMeasuredWidth() + (this.f31720c * 2) + childCount;
                }
            }
            return;
        }
        if (this.f31718a > 0) {
            i14 = (getMeasuredWidth() - this.f31719b) / (this.f31718a - 1);
        } else {
            i14 = 0;
        }
        int i17 = 0;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f31719b = AndroidUtilities.dp(this.d);
        this.f31720c = ((size / getChildCount()) - this.f31719b) / 2;
        int i13 = 0;
        for (int i14 = 0; i14 < getChildCount(); i14++) {
            if (getChildAt(i14).getVisibility() != 8) {
                getChildAt(i14).measure(View.MeasureSpec.makeMeasureSpec(this.f31719b, 1073741824), i11);
