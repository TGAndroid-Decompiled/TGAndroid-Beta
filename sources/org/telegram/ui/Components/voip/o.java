    ...
    public final void onClick(View view) {
        ...
        switch (this.f29095a) {
            case 0:
                ...
                return;
            case 1:
                x0 x0Var = (x0) this.f29096b;
                if (!x0Var.f29320a) {
                    if (x0Var.f29328x == 0 && x0Var.f29329y) {
            ...
            case 2:
                ...
                return;
            case 3:
                Context context = (Context) this.f29096b;
                if (VoIPService.getSharedInstance() != null) {
                ...
                return;
            case 4:
                org.telegram.ui.web.k kVar = (org.telegram.ui.web.k) this.f29096b;
                AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(kVar.getContext());
                alertDialog$Builder.f18447a.R = LocaleController.getString(R.string.WebRecentClearTitle);
                alertDialog$Builder.f18447a.T = LocaleController.getString(R.string.WebRecentClearText);
                ...
                return;
            case 5:
                ((pg.x) this.f29096b).dismiss();
                return;
            case 6:
                ((gm0) this.f29096b).run();
                return;
            case 7:
                ((qg.v2) this.f29096b).onBackPressed();
                return;
            case 8:
                ((wg) this.f29096b).run();
                return;
            case 9:
                ((c90) this.f29096b).performClick();
                return;
            case 10:
                PremiumPreviewFragment.p0();
                PremiumPreviewFragment.k0(((rg.k1) this.f29096b).f42389t0, null, "profile", null);
                return;
            case 11:
                final tg.h0 h0Var = (tg.h0) this.f29096b;
                vg.a aVar = h0Var.Q0;
                if (!aVar.f44325a.N) {
                    aVar.b(true);
                    String str = h0Var.R0;
                ...
                return;
            case 12:
                ((tg.k0) this.f29096b).dismiss();
                return;
            case 13:
                ((tg.c0) ((ug.e) this.f29096b)).f43144r.dismiss();
                return;
            case 14:
                Runnable runnable = ((xg.c) this.f29096b).d;
                if (runnable != null) {
                    runnable.run();
                    return;
                }
                return;
            case 15:
                ((xh.c) this.f29096b).dismiss();
                return;
            case 16:
                ((xh.c0) this.f29096b).dismiss();
                return;
            case 17:
                if (((xh.q1) this.f29096b).f46109f0.f47499f > 0 && (R = LaunchActivity.R()) != 0) {
                    ?? obj = new Object();
                    obj.f19398a = true;
                ...
                return;
            case 18:
                ((yh.s) this.f29096b).dismiss();
                return;
            case 19:
                ((yh.e0) this.f29096b).dismiss();
                return;
            case 20:
                yh.i0 i0Var = (yh.i0) this.f29096b;
                zf.b bVar = i0Var.E.f48980a;
                zf.b bVar2 = zf.b.f48983b;
                if (bVar == bVar2) {
                    bVar2 = zf.b.f48982a;
                }
                i0Var.n(zf.a.i(0L, bVar2), true, false, true);
                i0Var.f47296c.setText("");
                return;
            case 21:
                ((yh.s0) this.f29096b).dismiss();
                return;
            case 22:
                ((yh.r1) this.f29096b).run();
                return;
            case 23:
                ((yh.r1) this.f29096b).run();
                return;
            case 24:
                yh.f3 f3Var = (yh.f3) this.f29096b;
                f3Var.getClass();
                new o7(f3Var.f47175b, f3Var.f47178g).show();
                return;
            case 25:
                ((z3) this.f29096b).dismiss();
                return;
            case 26:
                ((y5) this.f29096b).run();
                return;
            case 27:
                if (((m7) ((q20) this.f29096b).d).f47499f > 0 && (R2 = LaunchActivity.R()) != 0) {
                    ?? obj2 = new Object();
                    obj2.f19398a = true;
                ...
                return;
            default:
                zg.c0 c0Var = (zg.c0) this.f29096b;
                if (c0Var.f49018k) {
                    c0Var.d();
                    return;
                }
