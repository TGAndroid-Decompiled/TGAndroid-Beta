...
public final class x1 implements v70, org.telegram.ui.ActionBar.a2 {
    public final TLRPC.User f29321a;
    public final TLRPC.Chat f29322b;
    public final String f29323c;
    public final boolean d;
    public final boolean e;
    public final boolean f29324f;
    public final Activity h;
    public final org.telegram.ui.ActionBar.n2 f29325n;
    public final AccountInstance f29326r;
    ...
    public void a(TLRPC.InputPeer inputPeer, boolean z10, boolean z11, boolean z12) {
        ...
        AccountInstance accountInstance = this.f29326r;
        TLRPC.Chat chat = this.f29322b;
        String str = this.f29323c;
        if (z13 && z11) {
            f60.c1((LaunchActivity) activity, accountInstance, chat, inputPeer, z10, str);
            return;
        }
        TLRPC.User user = this.f29321a;
        boolean z14 = this.e;
        boolean z15 = this.f29324f;
        org.telegram.ui.ActionBar.n2 n2Var = this.f29325n;
        if (!z10 && str != null) {
    ...
    public void f(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        ...
        final TLRPC.User user = this.f29321a;
        final TLRPC.Chat chat = this.f29322b;
        final String str = this.f29323c;
        final boolean z10 = this.d;
        final boolean z11 = this.e;
        final boolean z12 = this.f29324f;
        final Activity activity = this.h;
        final org.telegram.ui.ActionBar.n2 n2Var = this.f29325n;
        final AccountInstance accountInstance = this.f29326r;
