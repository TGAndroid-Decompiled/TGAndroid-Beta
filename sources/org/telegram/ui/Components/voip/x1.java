...
public final class x1 implements f80, org.telegram.ui.ActionBar.a2 {
    public final TLRPC.User f29715a;
    public final TLRPC.Chat f29716b;
    public final String f29717c;
    public final boolean d;
    public final boolean e;
    public final boolean f29718f;
    public final Activity h;
    public final org.telegram.ui.ActionBar.n2 f29719n;
    public final AccountInstance f29720r;
    ...
    public void a(TLRPC.InputPeer inputPeer, boolean z10, boolean z11, boolean z12) {
        ...
        AccountInstance accountInstance = this.f29720r;
        TLRPC.Chat chat = this.f29716b;
        String str = this.f29717c;
        if (z13 && z11) {
            i60.c1((LaunchActivity) activity, accountInstance, chat, inputPeer, z10, str);
            return;
        }
        TLRPC.User user = this.f29715a;
        boolean z14 = this.e;
        boolean z15 = this.f29718f;
        org.telegram.ui.ActionBar.n2 n2Var = this.f29719n;
        if (!z10 && str != null) {
    ...
    public void k(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        ...
        final TLRPC.User user = this.f29715a;
        final TLRPC.Chat chat = this.f29716b;
        final String str = this.f29717c;
        final boolean z10 = this.d;
        final boolean z11 = this.e;
        final boolean z12 = this.f29718f;
        final Activity activity = this.h;
        final org.telegram.ui.ActionBar.n2 n2Var = this.f29719n;
        final AccountInstance accountInstance = this.f29720r;
