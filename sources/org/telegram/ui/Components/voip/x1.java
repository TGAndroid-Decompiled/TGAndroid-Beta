...
public final class x1 implements y70, org.telegram.ui.ActionBar.c2 {
    public final TLRPC.User f32457a;
    public final TLRPC.Chat f32458b;
    public final String f32459c;
    public final boolean d;
    public final boolean f32460e;
    public final boolean f32461f;
    public final Activity h;
    public final org.telegram.ui.ActionBar.p2 f32462n;
    public final AccountInstance f32463r;
    ...
    public void a(TLRPC.InputPeer inputPeer, boolean z4, boolean z10, boolean z11) {
        ...
        AccountInstance accountInstance = this.f32463r;
        TLRPC.Chat chat = this.f32458b;
        String str = this.f32459c;
        if (z12 && z10) {
            d60.c1((LaunchActivity) activity, accountInstance, chat, inputPeer, z4, str);
            return;
        }
        TLRPC.User user = this.f32457a;
        boolean z13 = this.f32460e;
        boolean z14 = this.f32461f;
        org.telegram.ui.ActionBar.p2 p2Var = this.f32462n;
        if (!z4 && str != null) {
    ...
    public void j(org.telegram.ui.ActionBar.d2 d2Var, int i10) {
        ...
        final TLRPC.User user = this.f32457a;
        final TLRPC.Chat chat = this.f32458b;
        final String str = this.f32459c;
        final boolean z4 = this.d;
        final boolean z10 = this.f32460e;
        final boolean z11 = this.f32461f;
        final Activity activity = this.h;
        final org.telegram.ui.ActionBar.p2 p2Var = this.f32462n;
        final AccountInstance accountInstance = this.f32463r;
