...
public final class x1 implements u70, org.telegram.ui.ActionBar.b2 {
    public final TLRPC.User f29327a;
    public final TLRPC.Chat f29328b;
    public final String f29329c;
    public final boolean d;
    public final boolean e;
    public final boolean f29330f;
    public final Activity h;
    public final org.telegram.ui.ActionBar.o2 f29331n;
    public final AccountInstance f29332r;
    ...
    public void a(TLRPC.InputPeer inputPeer, boolean z10, boolean z11, boolean z12) {
        ...
        AccountInstance accountInstance = this.f29332r;
        TLRPC.Chat chat = this.f29328b;
        String str = this.f29329c;
        if (z13 && z11) {
            k60.c1((LaunchActivity) activity, accountInstance, chat, inputPeer, z10, str);
            return;
        }
        TLRPC.User user = this.f29327a;
        boolean z14 = this.e;
        boolean z15 = this.f29330f;
        org.telegram.ui.ActionBar.o2 o2Var = this.f29331n;
        if (!z10 && str != null) {
    ...
    public void f(org.telegram.ui.ActionBar.c2 c2Var, int i10) {
        ...
        final TLRPC.User user = this.f29327a;
        final TLRPC.Chat chat = this.f29328b;
        final String str = this.f29329c;
        final boolean z10 = this.d;
        final boolean z11 = this.e;
        final boolean z12 = this.f29330f;
        final Activity activity = this.h;
        final org.telegram.ui.ActionBar.o2 o2Var = this.f29331n;
        final AccountInstance accountInstance = this.f29332r;
