...
public final class x1 implements u70, org.telegram.ui.ActionBar.a2 {
    public final TLRPC.User f29350a;
    public final TLRPC.Chat f29351b;
    public final String f29352c;
    public final boolean d;
    public final boolean e;
    public final boolean f29353f;
    public final Activity h;
    public final org.telegram.ui.ActionBar.n2 f29354n;
    public final AccountInstance f29355r;
    ...
    public void a(TLRPC.InputPeer inputPeer, boolean z10, boolean z11, boolean z12) {
        ...
        AccountInstance accountInstance = this.f29355r;
        TLRPC.Chat chat = this.f29351b;
        String str = this.f29352c;
        if (z13 && z11) {
            i60.c1((LaunchActivity) activity, accountInstance, chat, inputPeer, z10, str);
            return;
        }
        TLRPC.User user = this.f29350a;
        boolean z14 = this.e;
        boolean z15 = this.f29353f;
        org.telegram.ui.ActionBar.n2 n2Var = this.f29354n;
        if (!z10 && str != null) {
    ...
    public void f(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        ...
        final TLRPC.User user = this.f29350a;
        final TLRPC.Chat chat = this.f29351b;
        final String str = this.f29352c;
        final boolean z10 = this.d;
        final boolean z11 = this.e;
        final boolean z12 = this.f29353f;
        final Activity activity = this.h;
        final org.telegram.ui.ActionBar.n2 n2Var = this.f29354n;
        final AccountInstance accountInstance = this.f29355r;
