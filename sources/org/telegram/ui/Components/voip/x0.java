...
public abstract class x0 extends FrameLayout implements VoIPService.StateListener {
    ...
    public final z4.g f29655b;
    public final bi.o f29656c;
    public final LinearLayout d;
    public final mj0 e;
    public final TextView[] f29657f;
    public final t2 h;
    public int f29658n;
    public int f29659r;
    public boolean f29660s;
    public boolean v;
    public float f29661w;
    public int f29662x;
    public final boolean f29663y;
    ...
    public x0(Context context, boolean z10) {
        ...
        int i12 = 0;
        while (true) {
            TextView[] textViewArr = this.f29657f;
            if (i12 >= textViewArr.length) {
                break;
            }
            textViewArr[i12] = new TextView(context);
            this.f29657f[i12].setTextSize(1, 12.0f);
            this.f29657f[i12].setTextColor(-1);
            this.f29657f[i12].setTypeface(AndroidUtilities.bold());
            this.f29657f[i12].setPadding(AndroidUtilities.dp(10.0f), 0, AndroidUtilities.dp(10.0f), 0);
            this.f29657f[i12].setGravity(16);
            this.f29657f[i12].setSingleLine(true);
            this.d.addView(this.f29657f[i12], y5.n(-2, -1));
            if (i12 == 0 && this.f29663y) {
                this.f29657f[i12].setText(LocaleController.getString(R.string.VoipPhoneScreen));
            } else if (i12 != 0 && (i12 != 1 || !this.f29663y)) {
                this.f29657f[i12].setText(LocaleController.getString(R.string.VoipBackCamera));
            } else {
                this.f29657f[i12].setText(LocaleController.getString(R.string.VoipFrontCamera));
            }
            this.f29657f[i12].setOnClickListener(new n4(this, i12, 15));
            i12++;
        }
        setAlpha(0.0f);
        ...
        this.f29655b.setCurrentItem(this.f29663y ? 1 : 0);
        ...
        jj0 jj0Var = new jj0(R.raw.voice_mini, AndroidUtilities.dp(24.0f), AndroidUtilities.dp(24.0f), true, null);
        imageView.setAnimation(jj0Var);
        imageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
        this.v = true;
        jj0Var.M(69);
        imageView.setOnClickListener(new ft(24, this, jj0Var));
        addView((View) imageView, y5.d(48, 48.0f, 83, 24.0f, 0.0f, 0.0f, 136.0f));
    }

    public static void a(x0 x0Var) {
        VoIPService sharedInstance = VoIPService.getSharedInstance();
        if (x0Var.f29658n != x0Var.f29659r && sharedInstance != null) {
            boolean isFrontFaceCamera = sharedInstance.isFrontFaceCamera();
            int i10 = x0Var.f29658n;
    ...
    public final void b(boolean z10, boolean z11) {
        ...
        boolean z12 = d60Var.f33037z0.v;
        d60Var.f33037z0 = null;
        VoIPService sharedInstance = VoIPService.getSharedInstance();
        if (z11) {
            if (sharedInstance != null) {
            ...
            try {
                ...
                if (bitmap != null) {
                    ...
                    if (createScaledBitmap != null) {
                        ...
                        createScaledBitmap.compress(Bitmap.CompressFormat.JPEG, 87, new FileOutputStream(new File(filesDirFixed, "cthumb" + this.f29659r + ".jpg")));
                        View findViewWithTag = this.f29655b.findViewWithTag(Integer.valueOf(this.f29659r - (1 ^ (this.f29663y ? 1 : 0))));
    ...
    public final void d() {
        ...
        if (textView != null) {
            measuredWidth2 -= (((textView.getMeasuredWidth() / 2) + textView.getLeft()) - measuredWidth) * this.f29661w;
        }
        for (int i11 = 0; i11 < textViewArr.length; i11++) {
            int i12 = this.f29662x;
            float f7 = 0.9f;
            float f10 = 0.7f;
            if (i11 >= i12 && i11 <= i12 + 1) {
                if (i11 == i12) {
                    float f11 = this.f29661w;
                    f10 = 1.0f - (0.3f * f11);
                    f7 = 1.0f - (f11 * 0.1f);
                } else {
                    float f12 = this.f29661w;
                    f10 = 0.7f + (0.3f * f12);
                    f7 = 0.9f + (f12 * 0.1f);
                }
            }
        ...
        this.f29656c.invalidate();
        boolean z10 = this.f29663y;
        t2 t2Var = this.h;
        if (z10 && this.f29662x == 0 && this.f29661w <= 0.0f) {
            t2Var.setVisibility(4);
            return;
        }
        t2Var.setVisibility(0);
        if (this.f29662x + (!z10 ? 1 : 0) == this.f29658n) {
            t2Var.setTranslationX((-this.f29661w) * getMeasuredWidth());
        } else {
            t2Var.setTranslationX((1.0f - this.f29661w) * getMeasuredWidth());
        }
    }

    public int getBackgroundColor() {
        return i0.a.k(h6.w0(null, h6.f19121gg, false), (int) (getAlpha() * 1.0f * 255.0f));
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.f29656c.getLayoutParams();
        if (z10) {
        ...
        mj0 mj0Var = this.e;
        if (mj0Var != null) {
            ViewGroup.MarginLayoutParams marginLayoutParams2 = (ViewGroup.MarginLayoutParams) mj0Var.getLayoutParams();
            if (z10) {
    ...
    public void setBottomPadding(int i10) {
        ((FrameLayout.LayoutParams) this.f29656c.getLayoutParams()).bottomMargin = AndroidUtilities.dp(64.0f) + i10;
