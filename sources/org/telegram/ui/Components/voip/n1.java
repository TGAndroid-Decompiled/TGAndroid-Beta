...
public final class n1 extends FrameLayout {
    public final bj0 f29087a;
    public final bj0 f29088b;
    public final org.telegram.ui.Cells.z f29089c;
    public mf d;
    public m1 e;
    public int f29090f;
    ...
    public n1(Context context) {
        ...
        this.f29087a = imageView;
        ?? imageView2 = new ImageView(context);
        this.f29088b = imageView2;
        ...
        if (action != 0) {
            if (action != 1) {
                if (action == 3 && (m1Var = this.e) != null) {
                    n1[] n1VarArr = ((o1) ((k2.v) m1Var).f13387b).f29099c;
                    int length = n1VarArr.length;
                    while (i11 < length) {
                        n1 n1Var = n1VarArr[i11];
                        bj0 bj0Var = n1Var.f29087a;
                        bj0 bj0Var2 = n1Var.f29088b;
                ...
                m1 m1Var2 = this.e;
                if (m1Var2 != null) {
                    n1[] n1VarArr2 = ((o1) ((k2.v) m1Var2).f13387b).f29099c;
                    for (int i12 = 0; i12 <= this.f29090f; i12++) {
                        n1 n1Var2 = n1VarArr2[i12];
                        bj0 bj0Var3 = n1Var2.f29087a;
                        bj0 bj0Var4 = n1Var2.f29088b;
                ...
                if (this.d != null) {
                    ...
                    int i15 = this.f29090f + 1;
                    o1 o1Var = (o1) mfVar.f26142b;
                    Context context = (Context) mfVar.f26143c;
                    if (i15 >= 4) {
                        ?? imageView = new ImageView(context);
            ...
            m1 m1Var3 = this.e;
            if (m1Var3 != null) {
                n1[] n1VarArr3 = ((o1) ((k2.v) m1Var3).f13387b).f29099c;
                while (true) {
                    i10 = this.f29090f;
                    if (i11 > i10) {
                        break;
                    ...
                    bj0 bj0Var5 = n1Var3.f29087a;
                    bj0 bj0Var6 = n1Var3.f29088b;
                ...
                for (int i18 = i10 + 1; i18 < n1VarArr3.length; i18++) {
                    ...
                    bj0 bj0Var7 = n1Var4.f29087a;
                    bj0 bj0Var8 = n1Var4.f29088b;
    ...
    public final void drawableStateChanged() {
        ...
        org.telegram.ui.Cells.z zVar = this.f29089c;
        if (zVar != null) {
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.f29089c != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
