...
public final class n1 extends FrameLayout {
    public final aj0 f29107a;
    public final aj0 f29108b;
    public final org.telegram.ui.Cells.z f29109c;
    public mf d;
    public m1 e;
    public int f29110f;
    ...
    public n1(Context context) {
        ...
        this.f29107a = imageView;
        ?? imageView2 = new ImageView(context);
        this.f29108b = imageView2;
        ...
        if (action != 0) {
            if (action != 1) {
                if (action == 3 && (m1Var = this.e) != null) {
                    n1[] n1VarArr = ((o1) ((k2.v) m1Var).f13384b).f29119c;
                    int length = n1VarArr.length;
                    while (i11 < length) {
                        n1 n1Var = n1VarArr[i11];
                        aj0 aj0Var = n1Var.f29107a;
                        aj0 aj0Var2 = n1Var.f29108b;
                ...
                m1 m1Var2 = this.e;
                if (m1Var2 != null) {
                    n1[] n1VarArr2 = ((o1) ((k2.v) m1Var2).f13384b).f29119c;
                    for (int i12 = 0; i12 <= this.f29110f; i12++) {
                        n1 n1Var2 = n1VarArr2[i12];
                        aj0 aj0Var3 = n1Var2.f29107a;
                        aj0 aj0Var4 = n1Var2.f29108b;
                ...
                if (this.d != null) {
                    ...
                    int i15 = this.f29110f + 1;
                    o1 o1Var = (o1) mfVar.f26154b;
                    Context context = (Context) mfVar.f26155c;
                    if (i15 >= 4) {
                        ?? imageView = new ImageView(context);
            ...
            m1 m1Var3 = this.e;
            if (m1Var3 != null) {
                n1[] n1VarArr3 = ((o1) ((k2.v) m1Var3).f13384b).f29119c;
                while (true) {
                    i10 = this.f29110f;
                    if (i11 > i10) {
                        break;
                    ...
                    aj0 aj0Var5 = n1Var3.f29107a;
                    aj0 aj0Var6 = n1Var3.f29108b;
                ...
                for (int i18 = i10 + 1; i18 < n1VarArr3.length; i18++) {
                    ...
                    aj0 aj0Var7 = n1Var4.f29107a;
                    aj0 aj0Var8 = n1Var4.f29108b;
    ...
    public final void drawableStateChanged() {
        ...
        org.telegram.ui.Cells.z zVar = this.f29109c;
        if (zVar != null) {
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.f29109c != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
