...
public final class n1 extends FrameLayout {
    public final lj0 f29403a;
    public final lj0 f29404b;
    public final org.telegram.ui.Cells.z f29405c;
        ...
        if (action != 0) {
            if (action != 1) {
                if (action == 3 && (m1Var = this.e) != null) {
                    n1[] n1VarArr = ((o1) ((k2.v) m1Var).f13385b).f29415c;
                    int length = n1VarArr.length;
                    while (i11 < length) {
                        n1 n1Var = n1VarArr[i11];
                        lj0 lj0Var = n1Var.f29403a;
                        lj0 lj0Var2 = n1Var.f29404b;
                ...
                m1 m1Var2 = this.e;
                if (m1Var2 != null) {
                    n1[] n1VarArr2 = ((o1) ((k2.v) m1Var2).f13385b).f29415c;
                    for (int i12 = 0; i12 <= this.f29406f; i12++) {
                        n1 n1Var2 = n1VarArr2[i12];
                        lj0 lj0Var3 = n1Var2.f29403a;
                        lj0 lj0Var4 = n1Var2.f29404b;
                ...
                if (this.d != null) {
                    ...
                    int i15 = this.f29406f + 1;
                    o1 o1Var = (o1) b3Var.f22793b;
                    Context context = (Context) b3Var.f22794c;
                    if (i15 >= 4) {
                        ?? imageView = new ImageView(context);
            ...
            m1 m1Var3 = this.e;
            if (m1Var3 != null) {
                n1[] n1VarArr3 = ((o1) ((k2.v) m1Var3).f13385b).f29415c;
                while (true) {
                    i10 = this.f29406f;
                    if (i11 > i10) {
                        break;
                    ...
                    lj0 lj0Var5 = n1Var3.f29403a;
                    lj0 lj0Var6 = n1Var3.f29404b;
                ...
                for (int i18 = i10 + 1; i18 < n1VarArr3.length; i18++) {
                    ...
                    lj0 lj0Var7 = n1Var4.f29403a;
                    lj0 lj0Var8 = n1Var4.f29404b;
    ...
    public final void drawableStateChanged() {
        ...
        org.telegram.ui.Cells.z zVar = this.f29405c;
        if (zVar != null) {
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.f29405c != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
