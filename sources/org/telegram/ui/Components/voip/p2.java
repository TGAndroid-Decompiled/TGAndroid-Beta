...
public final class p2 extends FrameLayout {
    ...
    public final void a(View view, View view2, Runnable runnable) {
        ...
        this.h.setDuration(250L).setInterpolator(mr.f27122f);
        this.h.start();
    }

    public final void b(String str, boolean z4, boolean z10) {
        View view = this.d;
        View[] viewArr = this.f29828a;
        if (z4) {
    ...
    public final void c(boolean z4) {
        FrameLayout frameLayout = this.f29830c;
        if (z4) {
            if (frameLayout.getVisibility() != 0) {
                ...
                org.telegram.ui.b.p(frameLayout.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f), mr.f27126k, 300L);
            }
        } else if (frameLayout.getVisibility() == 8) {
        } else {
            frameLayout.animate().alpha(0.0f).scaleX(0.6f).scaleY(0.6f).setInterpolator(mr.f27122f).setListener(new o2(this, 1)).setDuration(300L).start();
        }
    }
