...
public final class p2 extends FrameLayout {
    public TextView[] f29526a;
    public TextView f29527b;
    public FrameLayout f29528c;
    public t2 d;
    ...
    public final void a(View view, View view2, Runnable runnable) {
        ...
        this.h.setDuration(250L).setInterpolator(qr.f27653f);
        this.h.start();
    }

    public final void b(String str, boolean z10, boolean z11) {
        View view = this.d;
        View[] viewArr = this.f29526a;
        if (z10) {
        ...
        } else if (this.f29529f) {
            this.e = str;
        } else if (this.f29530n) {
            viewArr[0].setText(str);
            a(view, viewArr[0], null);
        } else if (!viewArr[0].getText().equals(str)) {
            viewArr[1].setText(str);
            a(viewArr[0], viewArr[1], new i2.g0(this, 24));
        }
    }

    public final void c(boolean z10) {
        FrameLayout frameLayout = this.f29528c;
        if (z10) {
            if (frameLayout.getVisibility() != 0) {
                ...
                rk.s(frameLayout.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f), qr.f27657k, 300L);
            }
        } else if (frameLayout.getVisibility() == 8) {
        } else {
            frameLayout.animate().alpha(0.0f).scaleX(0.6f).scaleY(0.6f).setInterpolator(qr.f27653f).setListener(new o2(this, 1)).setDuration(300L).start();
        }
    }

    public final void d(boolean z10, boolean z11) {
        TextView textView = this.f29527b;
        int i10 = 0;
        if (!z11) {
