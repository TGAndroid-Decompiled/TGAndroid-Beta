...
public final class p2 extends FrameLayout {
    public TextView[] f29457a;
    public TextView f29458b;
    public FrameLayout f29459c;
    public t2 d;
    public CharSequence e;
    public boolean f29460f;
    public ValueAnimator h;
    public boolean f29461n;
    ...
    public final void a(View view, View view2, Runnable runnable) {
        ...
        this.h.setDuration(250L).setInterpolator(qr.f27715f);
        this.h.start();
    }

    public final void b(String str, boolean z10, boolean z11) {
        View view = this.d;
        View[] viewArr = this.f29457a;
        if (z10) {
        ...
        } else if (this.f29460f) {
            this.e = str;
        } else if (this.f29461n) {
            viewArr[0].setText(str);
    ...
    public final void c(boolean z10) {
        FrameLayout frameLayout = this.f29459c;
        if (z10) {
            if (frameLayout.getVisibility() != 0) {
                ...
                wh.r(frameLayout.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f), qr.f27719k, 300L);
            }
        } else if (frameLayout.getVisibility() == 8) {
        } else {
            frameLayout.animate().alpha(0.0f).scaleX(0.6f).scaleY(0.6f).setInterpolator(qr.f27715f).setListener(new o2(this, 1)).setDuration(300L).start();
        }
    }

    public final void d(boolean z10, boolean z11) {
        TextView textView = this.f29458b;
        int i10 = 0;
        if (!z11) {
