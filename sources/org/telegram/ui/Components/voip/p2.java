...
public final class p2 extends FrameLayout {
    public TextView[] f29564a;
    public TextView f29565b;
    public FrameLayout f29566c;
    public t2 d;
    ...
    public final void a(View view, View view2, Runnable runnable) {
        ...
        this.h.setDuration(250L).setInterpolator(qr.f27642f);
        this.h.start();
    }

    public final void b(String str, boolean z10, boolean z11) {
        View view = this.d;
        View[] viewArr = this.f29564a;
        if (z10) {
    ...
    public final void c(boolean z10) {
        FrameLayout frameLayout = this.f29566c;
        if (z10) {
            if (frameLayout.getVisibility() != 0) {
                ...
                rk.s(frameLayout.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f), qr.f27646k, 300L);
            }
        } else if (frameLayout.getVisibility() == 8) {
        } else {
            frameLayout.animate().alpha(0.0f).scaleX(0.6f).scaleY(0.6f).setInterpolator(qr.f27642f).setListener(new o2(this, 1)).setDuration(300L).start();
        }
    }

    public final void d(boolean z10, boolean z11) {
        TextView textView = this.f29565b;
        int i10 = 0;
        if (!z11) {
