...
public final class p2 extends FrameLayout {
    ...
    public final void a(View view, View view2, Runnable runnable) {
        ...
        this.h.setDuration(250L).setInterpolator(qr.f27423f);
        this.h.start();
    }

    public final void b(String str, boolean z10, boolean z11) {
        View view = this.d;
        View[] viewArr = this.f29161a;
        if (z10) {
        ...
        } else if (this.f29164f) {
            this.e = str;
        } else if (this.f29165n) {
            viewArr[0].setText(str);
    ...
    public final void c(boolean z10) {
        FrameLayout frameLayout = this.f29163c;
        if (z10) {
            if (frameLayout.getVisibility() != 0) {
                ...
                wl.q(frameLayout.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f), qr.f27427k, 300L);
            }
        } else if (frameLayout.getVisibility() == 8) {
        } else {
            frameLayout.animate().alpha(0.0f).scaleX(0.6f).scaleY(0.6f).setInterpolator(qr.f27423f).setListener(new o2(this, 1)).setDuration(300L).start();
        }
    }

    public final void d(boolean z10, boolean z11) {
        TextView textView = this.f29162b;
        int i10 = 0;
        if (!z11) {
