...
public final class f2 extends LinearLayout {
    public HashMap f31482a;
    public ArrayList f31483b;
    public ArrayList f31484c;
    public TransitionSet d;
    public boolean f31485e;
    public boolean f31486f;
    public Runnable h;
    public o1 f31487n;
    public TextPaint f31488r;
    ...
    public final void a(int i10, String str, String str2) {
        ...
        e2 e2Var = new e2(getContext(), this.f31487n, i10);
        e2Var.f31469a = str2;
        int dp = AndroidUtilities.displaySize.x - AndroidUtilities.dp(120.0f);
        TextView textView = e2Var.f31471c;
        ...
        e2Var.f31470b.setImageResource(i10);
        hashMap.put(str2, e2Var);
        if (this.f31485e) {
            this.f31483b.add(e2Var);
            return;
        }
        this.f31486f = true;
    ...
    public final CharSequence b(String str) {
        ...
        return TextUtils.ellipsize(str, this.f31488r, AndroidUtilities.dp(300.0f), TextUtils.TruncateAt.END);
    }

    public final void c(String str) {
        e2 e2Var = (e2) this.f31482a.remove(str);
        this.f31487n.f31708m.remove(e2Var);
        if (e2Var != null) {
            if (this.f31485e) {
                if (!this.f31483b.remove(e2Var)) {
                    this.f31484c.add(e2Var);
                    return;
                }
                return;
            }
