...
public final class w implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (this.f29725a) {
            case 0:
                m0 m0Var = this.f29726b;
                m0Var.getClass();
                m0Var.I0 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                m0Var.invalidate();
                return;
            default:
                m0 m0Var2 = this.f29726b;
                m0Var2.getClass();
                float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                m0Var2.f29463c = floatValue;
                i60 i60Var = m0Var2.f29472j0;
                i60Var.f34464z1.setAlpha(1.0f - floatValue);
                e50 e50Var = i60Var.O;
                ...
                e50Var.setAlpha((1.0f - i60Var.a2.f29463c) * f7);
                i60Var.E1(i60Var.f34460y0);
                m0Var2.l();
                return;
        }
    }
