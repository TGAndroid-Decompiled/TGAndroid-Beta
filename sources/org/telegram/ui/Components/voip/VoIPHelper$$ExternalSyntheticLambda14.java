...
public final class VoIPHelper$$ExternalSyntheticLambda14 implements AlertDialog.OnButtonClickListener, JoinCallAlert.JoinCallAlertDelegate {
    ...
    public VoIPHelper$$ExternalSyntheticLambda14(TLRPC.User user, TLRPC.Chat chat, String str, boolean z, boolean z2, boolean z3, Activity activity, BaseFragment baseFragment, AccountInstance accountInstance) {
        this.f$0 = user;
        this.f$1 = chat;
        this.f$2 = str;
        this.f$3 = z;
    ...
    public VoIPHelper$$ExternalSyntheticLambda14(boolean z, Activity activity, AccountInstance accountInstance, TLRPC.Chat chat, String str, TLRPC.User user, boolean z2, boolean z3, BaseFragment baseFragment) {
        this.f$3 = z;
        this.f$6 = activity;
        this.f$8 = accountInstance;
        this.f$1 = chat;
