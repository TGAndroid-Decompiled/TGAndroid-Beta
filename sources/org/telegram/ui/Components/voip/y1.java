...
public final class y1 implements f80, org.telegram.ui.ActionBar.z1 {
    public final TLRPC.User f29763a;
    public final TLRPC.Chat f29764b;
    public final String f29765c;
    public final boolean d;
    public final boolean e;
    public final boolean f29766f;
    public final Activity h;
    public final org.telegram.ui.ActionBar.m2 f29767n;
    public final AccountInstance f29768r;
    ...
    public void a(TLRPC.InputPeer inputPeer, boolean z10, boolean z11, boolean z12) {
        ...
        AccountInstance accountInstance = this.f29768r;
        TLRPC.Chat chat = this.f29764b;
        String str = this.f29765c;
        if (z13 && z11) {
            d60.c1((LaunchActivity) activity, accountInstance, chat, inputPeer, z10, str);
            return;
        }
        TLRPC.User user = this.f29763a;
        boolean z14 = this.e;
        boolean z15 = this.f29766f;
        org.telegram.ui.ActionBar.m2 m2Var = this.f29767n;
        if (!z10 && str != null) {
    ...
    public void f(org.telegram.ui.ActionBar.a2 a2Var, int i10) {
        ...
        final TLRPC.User user = this.f29763a;
        final TLRPC.Chat chat = this.f29764b;
        final String str = this.f29765c;
        final boolean z10 = this.d;
        final boolean z11 = this.e;
        final boolean z12 = this.f29766f;
        final Activity activity = this.h;
        final org.telegram.ui.ActionBar.m2 m2Var = this.f29767n;
        final AccountInstance accountInstance = this.f29768r;
