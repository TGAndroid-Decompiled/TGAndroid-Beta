...
public final class o1 extends FrameLayout {
    public final lj0 f29519a;
    public final lj0 f29520b;
    public final org.telegram.ui.Cells.z f29521c;
        ...
        if (action != 0) {
            if (action != 1) {
                if (action == 3 && (n1Var = this.e) != null) {
                    o1[] o1VarArr = ((p1) ((le.b) n1Var).f14197b).f29551c;
                    int length = o1VarArr.length;
                    while (i11 < length) {
                        o1 o1Var = o1VarArr[i11];
                        lj0 lj0Var = o1Var.f29519a;
                        lj0 lj0Var2 = o1Var.f29520b;
                ...
                n1 n1Var2 = this.e;
                if (n1Var2 != null) {
                    o1[] o1VarArr2 = ((p1) ((le.b) n1Var2).f14197b).f29551c;
                    for (int i12 = 0; i12 <= this.f29522f; i12++) {
                        o1 o1Var2 = o1VarArr2[i12];
                        lj0 lj0Var3 = o1Var2.f29519a;
                        lj0 lj0Var4 = o1Var2.f29520b;
                ...
                if (this.d != null) {
                    ...
                    int i15 = this.f29522f + 1;
                    p1 p1Var = (p1) w2Var.f29868c;
                    Context context = (Context) w2Var.f29867b;
                    if (i15 >= 4) {
                        ?? imageView = new ImageView(context);
            ...
            n1 n1Var3 = this.e;
            if (n1Var3 != null) {
                o1[] o1VarArr3 = ((p1) ((le.b) n1Var3).f14197b).f29551c;
                while (true) {
                    i10 = this.f29522f;
                    if (i11 > i10) {
                        break;
                    ...
                    lj0 lj0Var5 = o1Var3.f29519a;
                    lj0 lj0Var6 = o1Var3.f29520b;
                ...
                for (int i18 = i10 + 1; i18 < o1VarArr3.length; i18++) {
                    ...
                    lj0 lj0Var7 = o1Var4.f29519a;
                    lj0 lj0Var8 = o1Var4.f29520b;
    ...
    public final void drawableStateChanged() {
        ...
        org.telegram.ui.Cells.z zVar = this.f29521c;
        if (zVar != null) {
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.f29521c != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
