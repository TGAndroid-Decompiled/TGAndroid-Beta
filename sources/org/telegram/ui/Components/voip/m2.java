...
public final class m2 implements VoIPService.StateListener, df.a, NotificationCenter.NotificationCenterDelegate {
    ...
    public s2 N;
    public c2.p O;
    public final ah.e f29744a;
    public final l2 f29745b;
    public WindowManager f29746c;
    public WindowManager.LayoutParams d;
    public bf.f e;
    public final int f29747f;
    public final int h;
    public final s2 f29748n;
    public final s2 f29749r;
    public float f29750s;
    public ValueAnimator v;
    public final int f29753y;
    public final e5 f29751w = new e5(this, 8);
    public final float[] f29752x = new float[2];
    ...
    public static void l(Activity activity, int i10, int i11, int i12, int i13) {
        ...
        if (R == null && VideoCapturerDevice.eglBase != null) {
            ...
            float f18 = m2Var2.f29747f * 0.25f;
            float f19 = m2Var2.h * 0.25f;
            l2 l2Var = m2Var2.f29745b;
            ...
            layoutParams2.x = (int) (((((f16 - dp) - dp2) - f18) * f14) - (m2Var2.f29753y - dp));
            ...
            windowManager.addView(R.f29744a, layoutParams);
            R.f29748n.d.init(VideoCapturerDevice.eglBase.getEglBaseContext(), null);
            R.f29749r.d.init(VideoCapturerDevice.eglBase.getEglBaseContext(), R.P);
            if (i13 == 0) {
                R.f29744a.setScaleX(0.5f);
                R.f29744a.setScaleY(0.5f);
                R.f29744a.setAlpha(0.0f);
                R.f29744a.animate().alpha(1.0f).scaleY(1.0f).scaleX(1.0f).start();
                if (VoIPService.getSharedInstance() != null) {
                    VoIPService sharedInstance = VoIPService.getSharedInstance();
                    m2 m2Var3 = R;
                    sharedInstance.setSinks(m2Var3.f29748n.d, m2Var3.f29749r.d);
                }
            } else if (i13 == 1) {
                R.f29744a.setAlpha(0.0f);
                if (VoIPService.getSharedInstance() != null) {
                    ...
                    m2 m2Var4 = R;
                    sharedInstance2.setBackgroundSinks(m2Var4.f29748n.d, m2Var4.f29749r.d);
                }
            }
            ...
            if (sharedInstance3 != null && sharedInstance3.getRemoteVideoState() == 2 && ef.d.a(activity) == 1) {
                ...
                eVar.f1809c = "voip-pip";
                eVar.e = 1;
                s2 s2Var = m2Var5.f29749r;
                eVar.f1813j = s2Var.d;
    ...
    public final void a(c2.p pVar) {
        this.O = pVar;
        WindowManager windowManager = this.f29746c;
        WindowManager.LayoutParams layoutParams = this.d;
        ah.e eVar = this.f29744a;
        ...
        VoIPService sharedInstance = VoIPService.getSharedInstance();
        if (sharedInstance != null) {
            sharedInstance.setSinks(this.f29748n.d, this.f29749r.d);
        }
    }
    ...
    public final void e(c2.p pVar) {
        ...
        VoIPService sharedInstance = VoIPService.getSharedInstance();
        if (sharedInstance != null) {
            sharedInstance.setSinks(this.f29748n.d, this.N.d);
        }
        WindowManager windowManager = this.f29746c;
        ah.e eVar = this.f29744a;
    ...
    @Override
    public final View h() {
        s2 s2Var = new s2(this.f29749r.getContext(), false, true, false, false);
        this.N = s2Var;
    ...
    public final void j() {
        this.f29748n.d.release();
        this.f29749r.d.release();
        VoIPService sharedInstance = VoIPService.getSharedInstance();
        if (sharedInstance != null) {
            sharedInstance.unregisterStateListener(this);
        }
        this.f29744a.setVisibility(8);
        if (this.f29744a.getParent() != null) {
            l2 l2Var = this.f29745b;
            float[] fArr = this.f29752x;
            int i10 = l2.h;
            l2Var.getClass();
            Point point = AndroidUtilities.displaySize;
            m2 m2Var = l2Var.f29739f;
            int i11 = m2Var.d.x;
            l2 l2Var2 = m2Var.f29745b;
            float left = l2Var2.getLeft() + i11;
            float f10 = l2Var.f29737b;
            fArr[0] = (left - f10) / (((point.x - f10) - l2Var.f29738c) - l2Var2.getMeasuredWidth());
            float top = l2Var2.getTop() + m2Var.d.y;
            float f11 = l2Var.d;
            fArr[1] = (top - f11) / (((point.y - f11) - l2Var.e) - l2Var2.getMeasuredHeight());
            fArr[0] = Math.min(1.0f, Math.max(0.0f, fArr[0]));
            fArr[1] = Math.min(1.0f, Math.max(0.0f, fArr[1]));
            ApplicationLoader.applicationContext.getSharedPreferences("voippipconfig", 0).edit().putFloat("relativeX", Math.min(1.0f, Math.max(0.0f, this.f29752x[0]))).putFloat("relativeY", Math.min(1.0f, Math.max(0.0f, this.f29752x[1]))).apply();
            try {
                this.f29746c.removeView(this.f29744a);
            } catch (Throwable th2) {
                FileLog.e(th2);
            }
        }
    ...
    public final void m() {
        ...
        boolean z10;
        boolean z11;
        if (this.f29745b.getMeasuredWidth() != 0) {
            z4 = true;
        } else {
            z4 = false;
        }
        ...
        if (!z4) {
            ...
            float f11 = this.f29750s;
            if (!this.D) {
                f10 = 0.0f;
            }
            ValueAnimator ofFloat = ValueAnimator.ofFloat(f11, f10);
            this.v = ofFloat;
            ofFloat.addUpdateListener(this.f29751w);
            this.v.setDuration(300L).setInterpolator(mr.f27122f);
            this.v.start();
        }
    }
    ...
    public final void onMediaStateUpdated(int i10, int i11) {
        ...
        if (sharedInstance != null && sharedInstance.getRemoteVideoState() == 2) {
            Context context = R.f29744a.getContext();
