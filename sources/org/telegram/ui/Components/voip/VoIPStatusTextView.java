...
public class VoIPStatusTextView extends FrameLayout {
    ...
    public void showBadConnection(boolean z, boolean z2) {
        ...
        if (z) {
            ...
            listener = this.badConnectionLayer.animate().alpha(0.0f).scaleX(0.6f).scaleY(0.6f).setInterpolator(CubicBezierInterpolator.DEFAULT).setListener(new AnimatorListenerAdapter() {
                @Override
                public void onAnimationEnd(Animator animator) {
    ...
    public void showReconnect(boolean z, boolean z2) {
        ...
        if (z) {
            ...
            listener = this.reconnectTextView.animate().alpha(0.0f).setListener(new AnimatorListenerAdapter() {
                @Override
                public void onAnimationEnd(Animator animator) {
