...
public final class i3 extends FrameLayout {
    public final o1 f31550a;
    public h3 f31551b;
    public int f31552c;
    public final TextView d;
    public final TextView f31553e;
    public int f31554f;
    ...
    public final void a(int i10) {
        this.f31551b.f31531a = new xi0(R.raw.bt_to_speaker, i10, i10, true, null);
        this.f31551b.f31532b = new xi0(R.raw.bt_to_speaker, i10, i10, true, null);
        this.f31551b.f31532b.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
    }

    public final void b(int i10, int i11, int i12, boolean z10) {
        h3 h3Var = new h3(getContext(), this.f31550a);
        if (i10 == R.raw.camera_flip2) {
            xi0 xi0Var = new xi0(i10, i11, i11, true, null);
            h3Var.f31533c = xi0Var;
            xi0Var.f32579v0 = h3Var;
        } else {
            h3Var.f31531a = new xi0(i10, i11, i11, true, null);
            xi0 xi0Var2 = new xi0(i10, i11, i11, true, null);
            h3Var.f31532b = xi0Var2;
            xi0Var2.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
        }
        h3Var.a(i12, z10, false);
        h3Var.setAlpha(0.0f);
        h3Var.setOnBtnClickedListener(this.f31551b.f31540x);
        addView(h3Var, x5.a(53.5f, 53.5f, 1));
        h3 h3Var2 = this.f31551b;
        this.f31551b = h3Var;
    ...
    public final void c(int i10) {
        this.f31551b.f31531a = new xi0(R.raw.speaker_to_bt, i10, i10, true, null);
        this.f31551b.f31532b = new xi0(R.raw.speaker_to_bt, i10, i10, true, null);
        this.f31551b.f31532b.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
    }
    ...
    public void setOnBtnClickedListener(g3 g3Var) {
        this.f31551b.setOnBtnClickedListener(g3Var);
    }
}
