...
public final class i3 extends FrameLayout {
    ...
    public final void a(int i10) {
        this.f31550b.f31530a = new xi0(R.raw.bt_to_speaker, i10, i10, true, null);
        this.f31550b.f31531b = new xi0(R.raw.bt_to_speaker, i10, i10, true, null);
        this.f31550b.f31531b.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
    }

    public final void b(int i10, int i11, int i12, boolean z10) {
        h3 h3Var = new h3(getContext(), this.f31549a);
        if (i10 == R.raw.camera_flip2) {
            xi0 xi0Var = new xi0(i10, i11, i11, true, null);
            h3Var.f31532c = xi0Var;
            xi0Var.f32578v0 = h3Var;
        } else {
            h3Var.f31530a = new xi0(i10, i11, i11, true, null);
            xi0 xi0Var2 = new xi0(i10, i11, i11, true, null);
            h3Var.f31531b = xi0Var2;
            xi0Var2.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
        }
        h3Var.a(i12, z10, false);
        h3Var.setAlpha(0.0f);
        h3Var.setOnBtnClickedListener(this.f31550b.f31539x);
        addView(h3Var, x5.a(53.5f, 53.5f, 1));
        h3 h3Var2 = this.f31550b;
        this.f31550b = h3Var;
    ...
    public final void c(int i10) {
        this.f31550b.f31530a = new xi0(R.raw.speaker_to_bt, i10, i10, true, null);
        this.f31550b.f31531b = new xi0(R.raw.speaker_to_bt, i10, i10, true, null);
        this.f31550b.f31531b.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
    }
    ...
    public void setOnBtnClickedListener(g3 g3Var) {
        this.f31550b.setOnBtnClickedListener(g3Var);
    }
}
