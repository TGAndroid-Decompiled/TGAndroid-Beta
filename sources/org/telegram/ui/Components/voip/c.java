...
public abstract class c extends AccessibilityNodeProvider {
    ...
    public final Rect f28859c = new Rect();
    public int e = -1;
    public final int f28858b = 2;
    ...
    public final void a(int i10) {
        View view;
        ViewParent parent;
        if (this.d.isTouchExplorationEnabled() && (parent = (view = this.f28857a).getParent()) != null) {
    ...
    public final AccessibilityNodeInfo createAccessibilityNodeInfo(int i10) {
        ...
        if (i10 == -1) {
            ...
            for (int i11 = 0; i11 < this.f28858b; i11++) {
        ...
        if (i10 == 0) {
            ...
            if (i10 == 1 && (staticLayout = eVar2.f28896f) != null) {
    ...
    public final boolean performAction(int i10, int i11, Bundle bundle) {
        if (i10 == -1) {
            return this.f28857a.performAccessibilityAction(i11, bundle);
        }
        if (i11 == 64) {
            a(i10);
            return false;
        } else if (i11 == 16) {
            d dVar = ((b) this).f28848g.Q;
            if (dVar != null) {
                if (i10 == 0) {
                    ((ki1) dVar).a();
                    return true;
