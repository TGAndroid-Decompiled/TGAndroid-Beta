...
public abstract class c extends AccessibilityNodeProvider {
    ...
    public final Rect f31434c = new Rect();
    public int f31435e = -1;
    public final int f31433b = 2;
    ...
    public final void a(int i10) {
        View view;
        ViewParent parent;
        if (this.d.isTouchExplorationEnabled() && (parent = (view = this.f31432a).getParent()) != null) {
    ...
    public final AccessibilityNodeInfo createAccessibilityNodeInfo(int i10) {
        ...
        if (i10 == -1) {
            ...
            for (int i11 = 0; i11 < this.f31433b; i11++) {
        ...
        if (i10 == 0) {
            if (eVar2.R) {
                ...
                StaticLayout staticLayout3 = eVar2.f31460e;
            ...
            if (i10 == 1 && (staticLayout = eVar2.f31461f) != null) {
    ...
    public final boolean performAction(int i10, int i11, Bundle bundle) {
        if (i10 == -1) {
            return this.f31432a.performAccessibilityAction(i11, bundle);
        }
        if (i11 == 64) {
            a(i10);
            return false;
        } else if (i11 == 16) {
            d dVar = ((b) this).f31412g.Q;
            if (dVar != null) {
                if (i10 == 0) {
                    ((si1) dVar).a();
                    return true;
