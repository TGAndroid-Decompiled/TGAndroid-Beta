...
public abstract class c extends AccessibilityNodeProvider {
    ...
    public final Rect f31983c = new Rect();
    public int f31984e = -1;
    public final int f31982b = 2;
    ...
    public final void a(int i10) {
        View view;
        ViewParent parent;
        if (this.d.isTouchExplorationEnabled() && (parent = (view = this.f31981a).getParent()) != null) {
    ...
    public final AccessibilityNodeInfo createAccessibilityNodeInfo(int i10) {
        ...
        if (i10 == -1) {
            ...
            for (int i11 = 0; i11 < this.f31982b; i11++) {
        ...
        if (i10 == 0) {
            if (eVar2.O) {
                ...
                StaticLayout staticLayout3 = eVar2.f32009e;
            ...
            if (i10 == 1 && (staticLayout = eVar2.f32010f) != null) {
    ...
    public final boolean performAction(int i10, int i11, Bundle bundle) {
        if (i10 == -1) {
            return this.f31981a.performAccessibilityAction(i11, bundle);
        }
        if (i11 == 64) {
            a(i10);
            return false;
        } else if (i11 == 16) {
            d dVar = ((b) this).f31962g.N;
            if (dVar != null) {
                if (i10 == 0) {
                    ((ai1) dVar).a();
                    return true;
