...
public abstract class c extends AccessibilityNodeProvider {
    ...
    public final Rect f33647c = new Rect();
    public int f33648e = -1;
    public final int f33646b = 2;
    ...
    public final void a(int i10) {
        View view;
        ViewParent parent;
        if (this.d.isTouchExplorationEnabled() && (parent = (view = this.f33645a).getParent()) != null) {
    ...
    public final AccessibilityNodeInfo createAccessibilityNodeInfo(int i10) {
        ...
        if (i10 == -1) {
            ...
            for (int i11 = 0; i11 < this.f33646b; i11++) {
        ...
        if (i10 == 0) {
            if (eVar2.N) {
                ...
                StaticLayout staticLayout3 = eVar2.f33665e;
            ...
            if (i10 == 1 && (staticLayout = eVar2.f33666f) != null) {
    ...
    public final boolean performAction(int i10, int i11, Bundle bundle) {
        if (i10 == -1) {
            return this.f33645a.performAccessibilityAction(i11, bundle);
        }
        if (i11 == 64) {
            a(i10);
            return false;
        } else if (i11 == 16) {
            d dVar = ((b) this).f33617g.M;
            if (dVar != null) {
                if (i10 == 0) {
                    ((mh1) dVar).a();
                    return true;
