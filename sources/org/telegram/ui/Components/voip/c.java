...
public abstract class c extends AccessibilityNodeProvider {
    public final e f28883a;
    public final AccessibilityManager d;
    public final Rect f28885c = new Rect();
    public int e = -1;
    public final int f28884b = 2;
    ...
    public final void a(int i10) {
        View view;
        ViewParent parent;
        if (this.d.isTouchExplorationEnabled() && (parent = (view = this.f28883a).getParent()) != null) {
    ...
    public final AccessibilityNodeInfo createAccessibilityNodeInfo(int i10) {
        ...
        if (i10 == -1) {
            ...
            for (int i11 = 0; i11 < this.f28884b; i11++) {
        ...
        if (i10 == 0) {
            ...
            if (i10 == 1 && (staticLayout = eVar2.f28922f) != null) {
    ...
    public final boolean performAction(int i10, int i11, Bundle bundle) {
        if (i10 == -1) {
            return this.f28883a.performAccessibilityAction(i11, bundle);
        }
        if (i11 == 64) {
            a(i10);
            return false;
        } else if (i11 == 16) {
            d dVar = ((b) this).f28874g.Q;
            if (dVar != null) {
                if (i10 == 0) {
                    ((si1) dVar).a();
                    return true;
