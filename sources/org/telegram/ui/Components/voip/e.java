...
public final class e extends View {
    ...
    public final s0 W;
    public final FabBackgroundDrawable f28920a;
    public final Paint f28921a0;
    public final FabBackgroundDrawable f28922b;
    public ValueAnimator f28923b0;
    public final Drawable f28924c;
    public final Drawable d;
    public final StaticLayout e;
    public final StaticLayout f28925f;
    public final StaticLayout h;
    public final wc f28926n;
    public final wc f28927r;
    public b f28928s;
    public final int v;
    public float f28929w;
    public float f28930x;
    public boolean f28931y;

    public e(Activity activity) {
        super(activity);
        Paint paint = new Paint(1);
        this.f28926n = new wc(this);
        this.f28927r = new wc(this);
        this.f28931y = true;
        this.E = true;
        this.M = new Rect();
        this.N = new Rect();
        ...
        this.f28920a = fabBackgroundDrawable;
        fabBackgroundDrawable.setColor(-12531895);
        FabBackgroundDrawable fabBackgroundDrawable2 = new FabBackgroundDrawable();
        this.f28922b = fabBackgroundDrawable2;
        ...
        this.f28925f = new StaticLayout(string2, textPaint, (int) textPaint.measureText(string2), alignment, 1.0f, 0.0f, false);
        this.h = new StaticLayout(string3, textPaint, (int) textPaint.measureText(string3), alignment, 1.0f, 0.0f, false);
        this.f28924c = activity.getDrawable(R.drawable.calls_decline).mutate();
    ...
    public final void onDetachedFromWindow() {
        ...
        ValueAnimator valueAnimator = this.f28923b0;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (!this.R) {
            if (this.f28931y) {
                float dp = (AndroidUtilities.dp(2.0f) * 0.04f) + this.f28929w;
                this.f28929w = dp;
                if (dp > AndroidUtilities.dp(4.0f)) {
                    this.f28929w = AndroidUtilities.dp(4.0f);
                    this.f28931y = false;
                }
            } else {
                float dp2 = this.f28929w - (AndroidUtilities.dp(2.0f) * 0.04f);
                this.f28929w = dp2;
                if (dp2 < 0.0f) {
                    this.f28929w = 0.0f;
                    this.f28931y = true;
            ...
            if (this.E) {
                float dp3 = (AndroidUtilities.dp(4.0f) * 0.03f) + this.f28930x;
                this.f28930x = dp3;
                if (dp3 > AndroidUtilities.dp(10.0f)) {
                    this.f28930x = AndroidUtilities.dp(10.0f);
                    this.E = false;
                }
            } else {
                float dp4 = this.f28930x - (AndroidUtilities.dp(5.0f) * 0.03f);
                this.f28930x = dp4;
                if (dp4 < AndroidUtilities.dp(5.0f)) {
                    this.f28930x = AndroidUtilities.dp(5.0f);
                    this.E = true;
                }
            }
            invalidate();
        }
        this.f28930x = (AndroidUtilities.dp(8.0f) * 0.005f) + this.f28930x;
        ...
        if (z10) {
            ...
            if (drawable instanceof BitmapDrawable) {
                ...
                if (bitmapDrawable.getBitmap() != null) {
                    canvas.drawBitmap(bitmapDrawable.getBitmap(), (Rect) null, bitmapDrawable.getBounds(), this.f28921a0);
                }
            }
            canvas.restore();
        } else {
        ...
        canvas.save();
        StaticLayout staticLayout = this.f28925f;
    ...
    public final boolean onHoverEvent(MotionEvent motionEvent) {
        ...
        if (bVar != null) {
            ...
            if (motionEvent.getAction() != 9 && motionEvent.getAction() != 7) {
                ...
                for (int i10 = 0; i10 < bVar.f28887b; i10++) {
                    e eVar = bVar.f28877g;
                    if (i10 == 0) {
                        rect.set(eVar.M);
                    } else if (i10 == 1) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f28924c.setBounds(y3, y3, AndroidUtilities.dp(28.0f) + y3, AndroidUtilities.dp(28.0f) + y3);
    ...
    public void setRetryMod(boolean z10) {
        ...
        this.f28923b0.setDuration(1500L);
        this.f28923b0.setRepeatMode(1);
        this.f28923b0.setRepeatCount(-1);
        this.f28923b0.start();
    }
