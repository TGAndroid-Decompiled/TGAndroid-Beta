...
public final class e extends View {
    ...
    public final s0 W;
    public final FabBackgroundDrawable f28917a;
    public final Paint f28918a0;
    public final FabBackgroundDrawable f28919b;
    public ValueAnimator f28920b0;
    public final Drawable f28921c;
    public final Drawable d;
    public final StaticLayout e;
    public final StaticLayout f28922f;
    public final StaticLayout h;
    public final wc f28923n;
    public final wc f28924r;
    public b f28925s;
    public final int v;
    ...
    public e(Activity activity) {
        ...
        this.f28923n = new wc(this);
        this.f28924r = new wc(this);
        this.f28928y = true;
        this.E = true;
        this.M = new Rect();
        this.N = new Rect();
        ...
        this.f28917a = fabBackgroundDrawable;
        fabBackgroundDrawable.setColor(-12531895);
        FabBackgroundDrawable fabBackgroundDrawable2 = new FabBackgroundDrawable();
        this.f28919b = fabBackgroundDrawable2;
        ...
        this.f28922f = new StaticLayout(string2, textPaint, (int) textPaint.measureText(string2), alignment, 1.0f, 0.0f, false);
        this.h = new StaticLayout(string3, textPaint, (int) textPaint.measureText(string3), alignment, 1.0f, 0.0f, false);
        this.f28921c = activity.getDrawable(R.drawable.calls_decline).mutate();
    ...
    public final void onDetachedFromWindow() {
        ...
        ValueAnimator valueAnimator = this.f28920b0;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (!this.R) {
            if (this.f28928y) {
                float dp = (AndroidUtilities.dp(2.0f) * 0.04f) + this.f28926w;
                this.f28926w = dp;
                if (dp > AndroidUtilities.dp(4.0f)) {
                    this.f28926w = AndroidUtilities.dp(4.0f);
                    this.f28928y = false;
                }
            } else {
                float dp2 = this.f28926w - (AndroidUtilities.dp(2.0f) * 0.04f);
                this.f28926w = dp2;
                if (dp2 < 0.0f) {
                    this.f28926w = 0.0f;
                    this.f28928y = true;
            ...
            if (this.E) {
                float dp3 = (AndroidUtilities.dp(4.0f) * 0.03f) + this.f28927x;
                this.f28927x = dp3;
                if (dp3 > AndroidUtilities.dp(10.0f)) {
                    this.f28927x = AndroidUtilities.dp(10.0f);
                    this.E = false;
                }
            } else {
                float dp4 = this.f28927x - (AndroidUtilities.dp(5.0f) * 0.03f);
                this.f28927x = dp4;
                if (dp4 < AndroidUtilities.dp(5.0f)) {
                    this.f28927x = AndroidUtilities.dp(5.0f);
                    this.E = true;
                }
            }
            invalidate();
        }
        this.f28927x = (AndroidUtilities.dp(8.0f) * 0.005f) + this.f28927x;
        int measuredWidth = getMeasuredWidth();
        int i10 = this.v;
        this.N.set(org.telegram.messenger.y0.B(46.0f, measuredWidth, i10), AndroidUtilities.dp(40.0f), getMeasuredWidth() - AndroidUtilities.dp(46.0f), AndroidUtilities.dp(40.0f) + i10);
        canvas.save();
        canvas.translate(0.0f, AndroidUtilities.dp(40.0f));
        canvas.save();
        float a2 = this.f28924r.a(0.1f);
        float f10 = i10;
        float f11 = f10 / 2.0f;
        canvas.scale(a2, a2, rect.centerX(), rect.top + f11);
        canvas.translate(((this.K + getMeasuredWidth()) - AndroidUtilities.dp(46.0f)) - f10, 0.0f);
        boolean z10 = this.R;
        FabBackgroundDrawable fabBackgroundDrawable = this.f28919b;
        if (z10) {
            f7 = 2.0f;
            ...
            if (drawable instanceof BitmapDrawable) {
                ...
                if (bitmapDrawable.getBitmap() != null) {
                    canvas.drawBitmap(bitmapDrawable.getBitmap(), (Rect) null, bitmapDrawable.getBounds(), this.f28918a0);
                }
            }
            canvas.restore();
        } else {
            f7 = 2.0f;
            fabBackgroundDrawable.draw(canvas);
            this.f28921c.draw(canvas);
        }
        canvas.save();
        StaticLayout staticLayout = this.f28922f;
    ...
    public final boolean onHoverEvent(MotionEvent motionEvent) {
        ...
        if (bVar != null) {
            ...
            if (motionEvent.getAction() != 9 && motionEvent.getAction() != 7) {
                ...
                for (int i10 = 0; i10 < bVar.f28884b; i10++) {
                    e eVar = bVar.f28874g;
                    if (i10 == 0) {
                        rect.set(eVar.M);
                    } else if (i10 == 1) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f28921c.setBounds(y3, y3, AndroidUtilities.dp(28.0f) + y3, AndroidUtilities.dp(28.0f) + y3);
    ...
    public void setRetryMod(boolean z10) {
        ...
        this.f28920b0.setDuration(1500L);
        this.f28920b0.setRepeatMode(1);
        this.f28920b0.setRepeatCount(-1);
        this.f28920b0.start();
    }
