...
public final class e extends View {
    ...
    public final s0 W;
    public final FabBackgroundDrawable f28897a;
    public final Paint f28898a0;
    public final FabBackgroundDrawable f28899b;
    public ValueAnimator f28900b0;
    public final Drawable f28901c;
    public final Drawable d;
    public final StaticLayout e;
    public final StaticLayout f28902f;
    public final StaticLayout h;
    public final wc f28903n;
    public final wc f28904r;
    public b f28905s;
    public final int v;
    public float f28906w;
    ...
    public e(Activity activity) {
        ...
        this.f28903n = new wc(this);
        this.f28904r = new wc(this);
        this.f28908y = true;
        this.E = true;
        this.M = new Rect();
        this.N = new Rect();
        ...
        this.f28897a = fabBackgroundDrawable;
        fabBackgroundDrawable.setColor(-12531895);
        FabBackgroundDrawable fabBackgroundDrawable2 = new FabBackgroundDrawable();
        this.f28899b = fabBackgroundDrawable2;
        ...
        this.f28902f = new StaticLayout(string2, textPaint, (int) textPaint.measureText(string2), alignment, 1.0f, 0.0f, false);
        this.h = new StaticLayout(string3, textPaint, (int) textPaint.measureText(string3), alignment, 1.0f, 0.0f, false);
        this.f28901c = activity.getDrawable(R.drawable.calls_decline).mutate();
    ...
    public final void onDetachedFromWindow() {
        ...
        ValueAnimator valueAnimator = this.f28900b0;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (!this.R) {
            if (this.f28908y) {
                float dp = (AndroidUtilities.dp(2.0f) * 0.04f) + this.f28906w;
                this.f28906w = dp;
                if (dp > AndroidUtilities.dp(4.0f)) {
                    this.f28906w = AndroidUtilities.dp(4.0f);
                    this.f28908y = false;
                }
            } else {
                float dp2 = this.f28906w - (AndroidUtilities.dp(2.0f) * 0.04f);
                this.f28906w = dp2;
                if (dp2 < 0.0f) {
                    this.f28906w = 0.0f;
                    this.f28908y = true;
            ...
            if (this.E) {
                float dp3 = (AndroidUtilities.dp(4.0f) * 0.03f) + this.f28907x;
                this.f28907x = dp3;
                if (dp3 > AndroidUtilities.dp(10.0f)) {
                    this.f28907x = AndroidUtilities.dp(10.0f);
                    this.E = false;
                }
            } else {
                float dp4 = this.f28907x - (AndroidUtilities.dp(5.0f) * 0.03f);
                this.f28907x = dp4;
                if (dp4 < AndroidUtilities.dp(5.0f)) {
                    this.f28907x = AndroidUtilities.dp(5.0f);
                    this.E = true;
                }
            }
            invalidate();
        }
        this.f28907x = (AndroidUtilities.dp(8.0f) * 0.005f) + this.f28907x;
        ...
        if (z10) {
            ...
            if (drawable instanceof BitmapDrawable) {
                ...
                if (bitmapDrawable.getBitmap() != null) {
                    canvas.drawBitmap(bitmapDrawable.getBitmap(), (Rect) null, bitmapDrawable.getBounds(), this.f28898a0);
                }
            }
            canvas.restore();
        } else {
            f7 = 2.0f;
            fabBackgroundDrawable.draw(canvas);
            this.f28901c.draw(canvas);
        }
        canvas.save();
        StaticLayout staticLayout = this.f28902f;
    ...
    public final boolean onHoverEvent(MotionEvent motionEvent) {
        ...
        if (bVar != null) {
            ...
            if (motionEvent.getAction() != 9 && motionEvent.getAction() != 7) {
                ...
                for (int i10 = 0; i10 < bVar.f28864b; i10++) {
                    e eVar = bVar.f28854g;
                    if (i10 == 0) {
                        rect.set(eVar.M);
                    } else if (i10 == 1) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f28901c.setBounds(y3, y3, AndroidUtilities.dp(28.0f) + y3, AndroidUtilities.dp(28.0f) + y3);
    ...
    public void setRetryMod(boolean z10) {
        ...
        this.f28900b0.setDuration(1500L);
        this.f28900b0.setRepeatMode(1);
        this.f28900b0.setRepeatCount(-1);
        this.f28900b0.start();
    }
