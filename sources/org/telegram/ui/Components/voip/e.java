...
public final class e extends View {
    ...
    public final s0 W;
    public final FabBackgroundDrawable f29240a;
    public final Paint f29241a0;
    public final FabBackgroundDrawable f29242b;
    public ValueAnimator f29243b0;
    public final Drawable f29244c;
    public final Drawable d;
    public final StaticLayout e;
    public final StaticLayout f29245f;
    public final StaticLayout h;
    public final yc f29246n;
    public final yc f29247r;
    public b f29248s;
    public final int v;
    public float f29249w;
    public float f29250x;
    public boolean f29251y;

    public e(Activity activity) {
        super(activity);
        Paint paint = new Paint(1);
        this.f29246n = new yc(this);
        this.f29247r = new yc(this);
        this.f29251y = true;
        this.E = true;
        this.M = new Rect();
        this.N = new Rect();
        ...
        this.f29240a = fabBackgroundDrawable;
        fabBackgroundDrawable.setColor(-12531895);
        FabBackgroundDrawable fabBackgroundDrawable2 = new FabBackgroundDrawable();
        this.f29242b = fabBackgroundDrawable2;
        ...
        this.f29245f = new StaticLayout(string2, textPaint, (int) textPaint.measureText(string2), alignment, 1.0f, 0.0f, false);
        this.h = new StaticLayout(string3, textPaint, (int) textPaint.measureText(string3), alignment, 1.0f, 0.0f, false);
        this.f29244c = activity.getDrawable(R.drawable.calls_decline).mutate();
        Drawable mutate = activity.getDrawable(R.drawable.ic_close_white).mutate();
        this.d = mutate;
        mutate.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
        jj0 jj0Var = new jj0(R.raw.call_accept, AndroidUtilities.dp(48.0f), AndroidUtilities.dp(48.0f), true, null);
        this.U = jj0Var;
        jj0Var.K(1);
        jj0Var.P(90);
        jj0Var.R(this);
    ...
    public final void onDetachedFromWindow() {
        ...
        ValueAnimator valueAnimator = this.f29243b0;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (!this.R) {
            if (this.f29251y) {
                float dp = (AndroidUtilities.dp(2.0f) * 0.04f) + this.f29249w;
                this.f29249w = dp;
                if (dp > AndroidUtilities.dp(4.0f)) {
                    this.f29249w = AndroidUtilities.dp(4.0f);
                    this.f29251y = false;
                }
            } else {
                float dp2 = this.f29249w - (AndroidUtilities.dp(2.0f) * 0.04f);
                this.f29249w = dp2;
                if (dp2 < 0.0f) {
                    this.f29249w = 0.0f;
                    this.f29251y = true;
            ...
            if (this.E) {
                float dp3 = (AndroidUtilities.dp(4.0f) * 0.03f) + this.f29250x;
                this.f29250x = dp3;
                if (dp3 > AndroidUtilities.dp(10.0f)) {
                    this.f29250x = AndroidUtilities.dp(10.0f);
                    this.E = false;
                }
            } else {
                float dp4 = this.f29250x - (AndroidUtilities.dp(5.0f) * 0.03f);
                this.f29250x = dp4;
                if (dp4 < AndroidUtilities.dp(5.0f)) {
                    this.f29250x = AndroidUtilities.dp(5.0f);
                    this.E = true;
                }
            }
            invalidate();
        }
        this.f29250x = (AndroidUtilities.dp(8.0f) * 0.005f) + this.f29250x;
        ...
        if (z10) {
            ...
            if (drawable instanceof BitmapDrawable) {
                ...
                if (bitmapDrawable.getBitmap() != null) {
                    canvas.drawBitmap(bitmapDrawable.getBitmap(), (Rect) null, bitmapDrawable.getBounds(), this.f29241a0);
                }
            }
            canvas.restore();
        } else {
            f7 = 2.0f;
            fabBackgroundDrawable.draw(canvas);
            this.f29244c.draw(canvas);
        }
        canvas.save();
        StaticLayout staticLayout = this.f29245f;
    ...
    public final boolean onHoverEvent(MotionEvent motionEvent) {
        ...
        if (bVar != null) {
            ...
            if (motionEvent.getAction() != 9 && motionEvent.getAction() != 7) {
                ...
                for (int i10 = 0; i10 < bVar.f29208b; i10++) {
                    e eVar = bVar.f29197g;
                    if (i10 == 0) {
                        rect.set(eVar.M);
                    } else if (i10 == 1) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f29244c.setBounds(A, A, AndroidUtilities.dp(28.0f) + A, AndroidUtilities.dp(28.0f) + A);
    ...
    public void setRetryMod(boolean z10) {
        ...
        this.f29243b0.setDuration(1500L);
        this.f29243b0.setRepeatMode(1);
        this.f29243b0.setRepeatCount(-1);
        this.f29243b0.start();
    }
