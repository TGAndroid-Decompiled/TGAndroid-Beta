...
public final class k1 extends FrameLayout {
    public final jj0 f29718a;
    public final jj0 f29719b;
    public final org.telegram.ui.Cells.z f29720c;
        ...
        if (action != 0) {
            if (action != 1) {
                if (action == 3 && (j1Var = this.e) != null) {
                    k1[] k1VarArr = ((l1) ((m5) j1Var).f12783b).f29735c;
                    int length = k1VarArr.length;
                    while (i11 < length) {
                        k1 k1Var = k1VarArr[i11];
                        jj0 jj0Var = k1Var.f29718a;
                        jj0 jj0Var2 = k1Var.f29719b;
                ...
                j1 j1Var2 = this.e;
                if (j1Var2 != null) {
                    k1[] k1VarArr2 = ((l1) ((m5) j1Var2).f12783b).f29735c;
                    for (int i12 = 0; i12 <= this.f29721f; i12++) {
                        k1 k1Var2 = k1VarArr2[i12];
                        jj0 jj0Var3 = k1Var2.f29718a;
                        jj0 jj0Var4 = k1Var2.f29719b;
                ...
                if (this.d != null) {
                    ...
                    int i15 = this.f29721f + 1;
                    l1 l1Var = (l1) o1Var.f27426b;
                    Context context = (Context) o1Var.f27427c;
                    if (i15 >= 4) {
                        ?? imageView = new ImageView(context);
            ...
            j1 j1Var3 = this.e;
            if (j1Var3 != null) {
                k1[] k1VarArr3 = ((l1) ((m5) j1Var3).f12783b).f29735c;
                while (true) {
                    i10 = this.f29721f;
                    if (i11 > i10) {
                        break;
                    ...
                    jj0 jj0Var5 = k1Var3.f29718a;
                    jj0 jj0Var6 = k1Var3.f29719b;
                ...
                for (int i18 = i10 + 1; i18 < k1VarArr3.length; i18++) {
                    ...
                    jj0 jj0Var7 = k1Var4.f29718a;
                    jj0 jj0Var8 = k1Var4.f29719b;
    ...
    public final void drawableStateChanged() {
        ...
        org.telegram.ui.Cells.z zVar = this.f29720c;
        if (zVar != null) {
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.f29720c != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
