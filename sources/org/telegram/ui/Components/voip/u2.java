...
public final class u2 extends View {
    public StaticLayout f32398a;
    public final RectF f32399b;
    public final Paint f32400c;
    public final Paint d;
    public String f32401e;
    public final TextPaint f32402f;
    public int h;
    public boolean f32403n;
    public final Drawable f32404r;
    public final t3 f32405s;

    public u2(Activity activity) {
        super(activity);
        this.f32399b = new RectF();
        Paint paint = new Paint(1);
        this.f32400c = paint;
        Paint paint2 = new Paint(1);
        this.d = paint2;
        TextPaint textPaint = new TextPaint(1);
        this.f32402f = textPaint;
        this.h = 4;
        this.f32403n = false;
        this.f32405s = new t3(this, 25);
    ...
    public final void a() {
        ...
        if (str == null || !str.equals(formatLongDuration)) {
            this.f32401e = formatLongDuration;
            if (this.f32398a == null) {
                requestLayout();
            }
            String str2 = this.f32401e;
            TextPaint textPaint = this.f32402f;
            this.f32398a = new StaticLayout(str2, textPaint, (int) textPaint.measureText(str2), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        }
    ...
    public final void onDraw(Canvas canvas) {
        int dp;
        Paint paint;
        StaticLayout staticLayout = this.f32398a;
        int i10 = 0;
    ...
    public void setVisibility(int i10) {
        if (getVisibility() != i10) {
            if (i10 == 0) {
                ...
                String str = this.f32401e;
                TextPaint textPaint = this.f32402f;
                this.f32398a = new StaticLayout(str, textPaint, (int) textPaint.measureText(str), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                a();
            } else {
                this.f32401e = null;
                this.f32398a = null;
