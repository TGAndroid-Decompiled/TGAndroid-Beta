...
public final class u2 extends View {
    public StaticLayout f29671a;
    public final RectF f29672b;
    public final Paint f29673c;
    public final Paint d;
    public String e;
    public final TextPaint f29674f;
    public int h;
    public boolean f29675n;
    public final Drawable f29676r;
    public final i2.h0 f29677s;

    public u2(Activity activity) {
        super(activity);
        this.f29672b = new RectF();
        Paint paint = new Paint(1);
        this.f29673c = paint;
        Paint paint2 = new Paint(1);
        this.d = paint2;
        TextPaint textPaint = new TextPaint(1);
        this.f29674f = textPaint;
        this.h = 4;
        this.f29675n = false;
        this.f29677s = new i2.h0(this, 26);
    ...
    public final void a() {
        ...
        if (str == null || !str.equals(formatLongDuration)) {
            ...
            String str2 = this.e;
            TextPaint textPaint = this.f29674f;
            this.f29671a = new StaticLayout(str2, textPaint, (int) textPaint.measureText(str2), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        }
    ...
    public final void onDraw(Canvas canvas) {
        int dp;
        Paint paint;
        StaticLayout staticLayout = this.f29671a;
        int i10 = 0;
    ...
    public void setVisibility(int i10) {
        if (getVisibility() != i10) {
            if (i10 == 0) {
                ...
                String str = this.e;
                TextPaint textPaint = this.f29674f;
                this.f29671a = new StaticLayout(str, textPaint, (int) textPaint.measureText(str), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                a();
            } else {
                this.e = null;
                this.f29671a = null;
