...
public final class u2 extends View {
    public StaticLayout f29680a;
    public final RectF f29681b;
    public final Paint f29682c;
    public final Paint d;
    public String e;
    public final TextPaint f29683f;
    public int h;
    public boolean f29684n;
    public final Drawable f29685r;
    public final i2.h0 f29686s;
    ...
    public u2(Activity activity) {
        ...
        this.f29683f = textPaint;
        this.h = 4;
        this.f29684n = false;
        this.f29686s = new i2.h0(this, 26);
    ...
    public final void a() {
        ...
        if (str == null || !str.equals(formatLongDuration)) {
            ...
            String str2 = this.e;
            TextPaint textPaint = this.f29683f;
            this.f29680a = new StaticLayout(str2, textPaint, (int) textPaint.measureText(str2), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        }
    ...
    public final void onDraw(Canvas canvas) {
        int dp;
        Paint paint;
        StaticLayout staticLayout = this.f29680a;
        int i10 = 0;
    ...
    public void setVisibility(int i10) {
        if (getVisibility() != i10) {
            if (i10 == 0) {
                ...
                String str = this.e;
                TextPaint textPaint = this.f29683f;
                this.f29680a = new StaticLayout(str, textPaint, (int) textPaint.measureText(str), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                a();
            } else {
                this.e = null;
                this.f29680a = null;
