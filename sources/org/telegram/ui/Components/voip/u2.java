...
public final class u2 extends View {
    public StaticLayout f29597a;
    public final RectF f29598b;
    public final Paint f29599c;
    public final Paint d;
    public String e;
    public final TextPaint f29600f;
    public int h;
    public boolean f29601n;
    public final Drawable f29602r;
    public final i2.h0 f29603s;
    ...
    public u2(Activity activity) {
        ...
        this.f29600f = textPaint;
        this.h = 4;
        this.f29601n = false;
        this.f29603s = new i2.h0(this, 26);
    ...
    public final void a() {
        ...
        if (str == null || !str.equals(formatLongDuration)) {
            ...
            String str2 = this.e;
            TextPaint textPaint = this.f29600f;
            this.f29597a = new StaticLayout(str2, textPaint, (int) textPaint.measureText(str2), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        }
    ...
    public final void onDraw(Canvas canvas) {
        int dp;
        Paint paint;
        StaticLayout staticLayout = this.f29597a;
        int i10 = 0;
    ...
    public void setVisibility(int i10) {
        if (getVisibility() != i10) {
            if (i10 == 0) {
                ...
                String str = this.e;
                TextPaint textPaint = this.f29600f;
                this.f29597a = new StaticLayout(str, textPaint, (int) textPaint.measureText(str), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                a();
            } else {
                this.e = null;
                this.f29597a = null;
