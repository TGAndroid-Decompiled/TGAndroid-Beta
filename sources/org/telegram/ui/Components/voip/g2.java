...
public final class g2 extends FrameLayout {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        Paint b11;
        Paint b12;
        RectF rectF = this.f29622f;
        rectF.set(0.0f, 0.0f, getWidth(), getHeight());
        float x10 = ((View) getParent()).getX() + getX();
        float y10 = ((View) getParent()).getY() + getY();
        n1 n1Var = this.e;
        n1Var.d(x10, y10);
        Paint paint = n1Var.f29776l;
        if (this.d) {
            b10 = paint;
        } else {
            b10 = n1Var.b();
        ...
        if (n1Var.e) {
            ...
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f), (Paint) n1Var.d.f142a);
