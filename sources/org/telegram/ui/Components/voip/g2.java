...
public final class g2 extends FrameLayout {
    ...
    public boolean d;
    public final q1 e;
    public final RectF f29362f;

    public g2(Context context, q1 q1Var, int i10) {
        super(context);
        float f7;
        this.f29362f = new RectF();
        setFocusable(true);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        Paint b11;
        Paint b12;
        RectF rectF = this.f29362f;
        rectF.set(0.0f, 0.0f, getWidth(), getHeight());
        float x10 = ((View) getParent()).getX() + getX();
        float y3 = ((View) getParent()).getY() + getY();
        q1 q1Var = this.e;
        q1Var.d(x10, y3);
        Paint paint = q1Var.f29580l;
        if (this.d) {
            b10 = paint;
        } else {
            b10 = q1Var.b();
        ...
        if (q1Var.e) {
            ...
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f), (Paint) q1Var.d.f7330a);
