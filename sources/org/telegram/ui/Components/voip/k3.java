...
public final class k3 extends FrameLayout {
    ...
    public final void a(int i10) {
        this.f29019b.f28998a = new yi0(R.raw.bt_to_speaker, i10, i10, true, null);
        this.f29019b.f28999b = new yi0(R.raw.bt_to_speaker, i10, i10, true, null);
        this.f29019b.f28999b.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
    }

    public final void b(int i10, int i11, int i12, boolean z10) {
        j3 j3Var = new j3(getContext(), this.f29018a);
        if (i10 == R.raw.camera_flip2) {
            yi0 yi0Var = new yi0(i10, i11, i11, true, null);
            j3Var.f29000c = yi0Var;
            yi0Var.R(j3Var);
        } else {
            j3Var.f28998a = new yi0(i10, i11, i11, true, null);
            yi0 yi0Var2 = new yi0(i10, i11, i11, true, null);
            j3Var.f28999b = yi0Var2;
            yi0Var2.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
        }
        j3Var.a(i12, z10, false);
        j3Var.setAlpha(0.0f);
        j3Var.setOnBtnClickedListener(this.f29019b.f29006x);
        addView(j3Var, x5.a(53.5f, 53.5f, 1));
        j3 j3Var2 = this.f29019b;
        this.f29019b = j3Var;
    ...
    public final void c(int i10) {
        this.f29019b.f28998a = new yi0(R.raw.speaker_to_bt, i10, i10, true, null);
        this.f29019b.f28999b = new yi0(R.raw.speaker_to_bt, i10, i10, true, null);
        this.f29019b.f28999b.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
    }
    ...
    public void setOnBtnClickedListener(i3 i3Var) {
        this.f29019b.setOnBtnClickedListener(i3Var);
    }
}
