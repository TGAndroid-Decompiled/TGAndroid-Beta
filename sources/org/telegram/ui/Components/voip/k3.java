...
public final class k3 extends FrameLayout {
    ...
    public final void a(int i10) {
        this.f29442b.f29421a = new hj0(R.raw.bt_to_speaker, i10, i10, true, null);
        this.f29442b.f29422b = new hj0(R.raw.bt_to_speaker, i10, i10, true, null);
        this.f29442b.f29422b.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
    }

    public final void b(int i10, int i11, int i12, boolean z10) {
        j3 j3Var = new j3(getContext(), this.f29441a);
        if (i10 == R.raw.camera_flip2) {
            hj0 hj0Var = new hj0(i10, i11, i11, true, null);
            j3Var.f29423c = hj0Var;
            hj0Var.R(j3Var);
        } else {
            j3Var.f29421a = new hj0(i10, i11, i11, true, null);
            hj0 hj0Var2 = new hj0(i10, i11, i11, true, null);
            j3Var.f29422b = hj0Var2;
            hj0Var2.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
        }
        j3Var.a(i12, z10, false);
        j3Var.setAlpha(0.0f);
        j3Var.setOnBtnClickedListener(this.f29442b.f29429x);
        addView(j3Var, y5.a(53.5f, 53.5f, 1));
        j3 j3Var2 = this.f29442b;
        this.f29442b = j3Var;
    ...
    public final void c(int i10) {
        this.f29442b.f29421a = new hj0(R.raw.speaker_to_bt, i10, i10, true, null);
        this.f29442b.f29422b = new hj0(R.raw.speaker_to_bt, i10, i10, true, null);
        this.f29442b.f29422b.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
    }
    ...
    public void setOnBtnClickedListener(i3 i3Var) {
        this.f29442b.setOnBtnClickedListener(i3Var);
    }
}
