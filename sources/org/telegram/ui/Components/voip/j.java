...
public final class j extends View {
    public org.telegram.ui.Cells.z f28965a;
    public final Paint f28966b;
    public final Paint f28967c;
    public final Paint d;
    public final RectF e;
    public final Drawable f28968f;
    ...
    public j(Context context) {
        ...
        this.e = new RectF();
        this.f28969n = -761748;
        this.f28970r = AndroidUtilities.dp(26.0f);
        this.f28971s = 255;
        this.v = 0;
    ...
    public final void drawableStateChanged() {
        ...
        org.telegram.ui.Cells.z zVar = this.f28965a;
        if (zVar != null) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int i10 = this.f28969n;
        Paint paint = this.f28966b;
        paint.setColor(i10);
        RectF rectF = this.e;
        rectF.set(0.0f, 0.0f, getWidth(), getHeight());
        float f7 = this.f28970r;
        canvas.drawRoundRect(rectF, f7, f7, paint);
        Drawable drawable = this.f28968f;
        ...
        drawable.setAlpha(this.f28971s);
        drawable.draw(canvas);
        int i11 = this.v;
        Paint paint2 = this.f28967c;
        paint2.setAlpha(i11);
        Paint paint3 = this.d;
        ...
        if (this.f28965a == null) {
            org.telegram.ui.Cells.z Y = h6.Y(h6.w0(null, h6.f18878i6, false), 8, 8);
            this.f28965a = Y;
            Y.setCallback(this);
        }
        this.f28965a.setBounds(0, 0, getWidth(), getHeight());
        this.f28965a.draw(canvas);
    }

    @Override
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.f28965a != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
