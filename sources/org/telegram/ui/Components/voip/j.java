...
public final class j extends View {
    public org.telegram.ui.Cells.z f29401a;
    public final Paint f29402b;
    public final Paint f29403c;
    public final Paint d;
    public final RectF e;
    public final Drawable f29404f;
    ...
    public j(Context context) {
        ...
        this.e = new RectF();
        this.f29405n = -761748;
        this.f29406r = AndroidUtilities.dp(26.0f);
        this.f29407s = 255;
        this.v = 0;
    ...
    public final void drawableStateChanged() {
        ...
        org.telegram.ui.Cells.z zVar = this.f29401a;
        if (zVar != null) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int i10 = this.f29405n;
        Paint paint = this.f29402b;
        paint.setColor(i10);
        RectF rectF = this.e;
        rectF.set(0.0f, 0.0f, getWidth(), getHeight());
        float f7 = this.f29406r;
        canvas.drawRoundRect(rectF, f7, f7, paint);
        Drawable drawable = this.f29404f;
        ...
        drawable.setAlpha(this.f29407s);
        drawable.draw(canvas);
        int i11 = this.v;
        Paint paint2 = this.f29403c;
        paint2.setAlpha(i11);
        Paint paint3 = this.d;
        ...
        this.f29401a.setBounds(0, 0, getWidth(), getHeight());
        this.f29401a.draw(canvas);
    }

    @Override
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.f29401a != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
