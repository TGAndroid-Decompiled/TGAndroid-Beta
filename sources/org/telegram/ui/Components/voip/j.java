...
public final class j extends View {
    public org.telegram.ui.Cells.z f29660a;
    public final Paint f29661b;
    public final Paint f29662c;
    public final Paint d;
    public final RectF e;
    public final Drawable f29663f;
    ...
    public j(Context context) {
        ...
        this.e = new RectF();
        this.f29664n = -761748;
        this.f29665r = AndroidUtilities.dp(26.0f);
        this.f29666s = 255;
        this.v = 0;
    ...
    public final void drawableStateChanged() {
        ...
        org.telegram.ui.Cells.z zVar = this.f29660a;
        if (zVar != null) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Paint paint = this.f29661b;
        paint.setColor(i10);
        RectF rectF = this.e;
        rectF.set(0.0f, 0.0f, getWidth(), getHeight());
        float f10 = this.f29665r;
        ...
        drawable.setAlpha(this.f29666s);
        drawable.draw(canvas);
        int i11 = this.v;
        Paint paint2 = this.f29662c;
        paint2.setAlpha(i11);
        Paint paint3 = this.d;
        ...
        if (this.f29660a == null) {
            org.telegram.ui.Cells.z Y = j6.Y(j6.w0(null, j6.f19971i6, false), 8, 8);
            this.f29660a = Y;
            Y.setCallback(this);
        }
        this.f29660a.setBounds(0, 0, getWidth(), getHeight());
        this.f29660a.draw(canvas);
    }

    @Override
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.f29660a != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
