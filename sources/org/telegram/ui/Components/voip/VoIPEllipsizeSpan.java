...
public final class VoIPEllipsizeSpan extends ReplacementSpan {
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
        switch (this.$r8$classId) {
            ...
            default:
                ...
                float f3 = fDpf2 / 2.0f;
                rectF.set(f, f2 - f3, ((int) (((Text) this.parents).getCurrentWidth() + AndroidUtilities.dp(10.0f))) + f, f3 + f2);
                ...
                ((Text) this.parents).draw(canvas, f + AndroidUtilities.dp(5.0f), f2, Theme.getColor(null, i7, false), Utilities.clamp((paint.getAlpha() * 2) / 255.0f, 1.0f, 0.0f));
                break;
        }
    }
    ...
    public final int getSize(Paint paint, CharSequence charSequence, int i, int i2, Paint.FontMetricsInt fontMetricsInt) {
        switch (this.$r8$classId) {
            ...
            default:
                return (int) (((Text) this.parents).getCurrentWidth() + AndroidUtilities.dp(10.0f));
        }
    }
