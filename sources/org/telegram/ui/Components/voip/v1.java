...
public final class v1 extends FrameLayout {
    ...
    public float f29681a0;
    public float f29682b;
    public boolean f29683b0;
    public float f29684c;
    public boolean f29685c0;
    public float d;
    public ValueAnimator f29686d0;
    public boolean e;
    public final k6 f29687e0;
    public int f29688f;
    public ValueAnimator f29689f0;
    public final r0 f29690g0;
    public int h;
    public View.OnClickListener f29691h0;
    public u1 f29692i0;
    public long f29693j0;
    public WindowInsets f29694n;
    public final float f29695r;
    public final Path f29696s;
    public final RectF v;
    public final Paint f29697w;
    public final Drawable f29698x;
    public float f29699y;

    public v1(Activity activity) {
        super(activity);
        this.f29696s = new Path();
        this.v = new RectF();
        new Paint(1);
        ...
        this.Q = -1.0f;
        this.R = true;
        this.f29687e0 = new k6(this, 10);
        this.f29690g0 = new r0(this, 3);
        this.f29695r = ViewConfiguration.get(activity).getScaledTouchSlop();
        setOutlineProvider(new ch.b(this, 4));
        setClipToOutline(true);
        paint.setColor(i0.a.k(-16777216, 102));
        this.f29698x = activity.getDrawable(R.drawable.calls_mute_mini);
    }
    ...
    public final void b() {
        ...
        if (getMeasuredWidth() > 0 && this.f29699y < 0.0f) {
            ViewParent parent = getParent();
            if (parent == null) {
                return;
            }
            WindowInsets windowInsets = this.f29694n;
            if (windowInsets == null) {
                systemWindowInsetTop = 0.0f;
            } else {
                systemWindowInsetTop = windowInsets.getSystemWindowInsetTop() + this.H;
            }
            WindowInsets windowInsets2 = this.f29694n;
    ...
    public final void c(boolean z10, boolean z11) {
        ...
        if (!((getMeasuredWidth() <= 0 || getVisibility() != 0) ? false : false)) {
            ...
            invalidate();
            ValueAnimator valueAnimator = v1Var.f29686d0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            ValueAnimator ofFloat = ValueAnimator.ofFloat(v1Var.J, 1.0f);
            v1Var.f29686d0 = ofFloat;
            ofFloat.addUpdateListener(v1Var.f29687e0);
            v1Var.f29686d0.setDuration(300L);
            v1Var.f29686d0.start();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f29699y >= 0.0f && this.M && getMeasuredWidth() > 0) {
            v1Var = this;
            v1Var.e(this.f29699y, this.E, getMeasuredWidth(), getMeasuredHeight(), false);
            v1Var.f29699y = -1.0f;
            v1Var.E = -1.0f;
        } else {
            v1Var = this;
        ...
        canvas.drawCircle(f7, f10, AndroidUtilities.dp(14.0f), v1Var.f29697w);
        Drawable drawable = v1Var.f29698x;
    ...
    public final void e(float f7, float f10, int i10, int i11, boolean z10) {
        ...
        if (parent != null && this.M && !this.O && this.R) {
            ...
            if (z10) {
                ...
                alpha.setStartDelay(j3).setDuration(150L).setInterpolator(rr.f28022f).start();
                return;
            }
            if (!this.S) {
                animate().setListener(null).cancel();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.M) {
            ...
            this.P = true;
        } else if (!this.f29683b0) {
            setTranslationX(0.0f);
            setTranslationY(0.0f);
        }
        u1 u1Var = this.f29692i0;
        if (u1Var != null) {
            ((uh1) u1Var).f38465b.f35564d0.d(this.J, this.P);
        }
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(size2, 1073741824));
        if (getMeasuredHeight() != this.f29688f && getMeasuredWidth() != this.h) {
            Path path = this.f29696s;
            path.reset();
            RectF rectF = this.v;
        ...
        this.f29688f = getMeasuredHeight();
