...
public final class q2 extends FrameLayout {
    ...
    public final void a(View view, View view2, Runnable runnable) {
        ...
        this.h.setDuration(250L).setInterpolator(rr.f28030f);
        this.h.start();
    }

    public final void b(String str, boolean z10, boolean z11) {
        View view = this.d;
        View[] viewArr = this.f29573a;
        if (z10) {
        ...
        } else if (this.f29576f) {
            this.e = str;
        } else if (this.f29577n) {
            viewArr[0].setText(str);
    ...
    public final void c(boolean z10) {
        ...
        if (z10) {
            if (frameLayout.getVisibility() != 0) {
                ...
                ok.s(frameLayout.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f), rr.f28034k, 300L);
            }
        } else if (frameLayout.getVisibility() == 8) {
        } else {
            frameLayout.animate().alpha(0.0f).scaleX(0.6f).scaleY(0.6f).setInterpolator(rr.f28030f).setListener(new p2(this, 1)).setDuration(300L).start();
        }
    }
