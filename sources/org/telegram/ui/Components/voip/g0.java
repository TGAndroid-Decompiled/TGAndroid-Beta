...
public final class g0 extends FrameLayout {
    public final ShapeDrawable f31494a;
    public final a40 f31495b;

    public g0(a40 a40Var, Context context, ShapeDrawable shapeDrawable) {
        super(context);
        this.f31495b = a40Var;
        this.f31494a = shapeDrawable;
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        a40 a40Var = this.f31495b;
        l9 l9Var = a40Var.J;
        TextView textView = a40Var.K;
        float f7 = a40Var.O;
        ShapeDrawable shapeDrawable = this.f31494a;
        if (f7 == 1.0f) {
            shapeDrawable.setBounds(0, 0, getMeasuredWidth(), getMeasuredHeight());
            l9Var.setTranslationX(0.0f);
            textView.setTranslationX(0.0f);
        } else {
            float interpolation = 1.0f - pr.f29466f.getInterpolation(f7);
