...
public class o2 extends TextView {
    ...
    public void c() {
        CharSequence text;
        k90 k90Var = (k90) this.f32240c;
        Layout layout = getLayout();
        if (layout == null || (text = layout.getText()) == null) {
            return;
        }
        z80 z80Var = new z80(0);
        z80Var.f33823q = AndroidUtilities.dp(3.0f);
        z80Var.f33824r = AndroidUtilities.dp(6.0f);
        int length = text.length();
        z80Var.d(layout, 0, 0.0f);
        layout.getSelectionPath(0, length, z80Var);
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(z80Var.f33825s, z80Var.f33827u, z80Var.f33826t, z80Var.v);
        ((org.telegram.ui.Cells.z) this.f32239b).setBounds((int) rectF.left, (int) rectF.top, (int) rectF.right, (int) rectF.bottom);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        switch (this.f32238a) {
            case 0:
                RectF rectF = (RectF) this.f32239b;
            ...
            default:
                ...
                ((org.telegram.ui.Cells.z) this.f32239b).draw(canvas);
                canvas.restore();
                super.onDraw(canvas);
                if (a() || k90Var.c()) {
                    canvas.save();
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        switch (this.f32238a) {
            case 1:
                org.telegram.ui.Cells.z zVar = (org.telegram.ui.Cells.z) this.f32239b;
    ...
    public boolean verifyDrawable(Drawable drawable) {
        switch (this.f32238a) {
            case 1:
                if (drawable != ((org.telegram.ui.Cells.z) this.f32239b) && !super.verifyDrawable(drawable)) {
                    return false;
                }
                return true;
            default:
