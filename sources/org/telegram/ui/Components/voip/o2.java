...
public class o2 extends TextView {
    ...
    public void c() {
        CharSequence text;
        r90 r90Var = (r90) this.f29525c;
        Layout layout = getLayout();
        if (layout == null || (text = layout.getText()) == null) {
            return;
        }
        h90 h90Var = new h90(0);
        h90Var.f24704q = AndroidUtilities.dp(3.0f);
        h90Var.f24705r = AndroidUtilities.dp(6.0f);
        int length = text.length();
        h90Var.d(layout, 0, 0.0f);
        layout.getSelectionPath(0, length, h90Var);
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(h90Var.f24706s, h90Var.f24708u, h90Var.f24707t, h90Var.v);
        ((org.telegram.ui.Cells.z) this.f29524b).setBounds((int) rectF.left, (int) rectF.top, (int) rectF.right, (int) rectF.bottom);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        switch (this.f29523a) {
            case 0:
                RectF rectF = (RectF) this.f29524b;
            ...
            default:
                ...
                ((org.telegram.ui.Cells.z) this.f29524b).draw(canvas);
                canvas.restore();
                super.onDraw(canvas);
                if (a() || r90Var.c()) {
                    canvas.save();
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        switch (this.f29523a) {
            case 1:
                org.telegram.ui.Cells.z zVar = (org.telegram.ui.Cells.z) this.f29524b;
    ...
    public boolean verifyDrawable(Drawable drawable) {
        switch (this.f29523a) {
            case 1:
                if (drawable != ((org.telegram.ui.Cells.z) this.f29524b) && !super.verifyDrawable(drawable)) {
                    return false;
                }
                return true;
            default:
