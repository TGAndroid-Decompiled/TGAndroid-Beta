...
public class v2 extends FrameLayout {
    ...
    public float T;
    public final Paint f29969a;
    public boolean f29970b;
    public boolean f29971c;
    public boolean d;
    public final Drawable[] e;
    public final FrameLayout f29972f;
    ...
    public v2(Context context, float f10) {
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            ...
            this.f29972f.addView(textView, b6.d(-1, -2.0f, 0, 0.0f, f10 + 6.0f, 0.0f, 0.0f));
            this.h[i10] = textView;
        }
    ...
    public final void a(int i10, int i11) {
        this.O = i10;
        this.P = i11;
        this.f29973n = i0.a.d(this.N, i10, i11);
        invalidate();
    }
    ...
    public final void c(int i10, int i11, int i12, float f10, boolean z4, String str, boolean z10, boolean z11) {
        ...
        if (this.f29976w == i10 && this.f29977x == i11 && ((this.L || this.f29978y == i12) && (str2 = this.B) != null && str2.equals(str) && z10 == this.I)) {
            return;
        }
        if (this.K == null || z4) {
        ...
        this.v.addListener(new m00(17, this, z14));
    ...
    public final void d(boolean z4, boolean z10) {
        float f10 = 0.0f;
        FrameLayout frameLayout = this.f29972f;
        if (z10) {
            if (z4) {
                f10 = 1.0f;
            }
