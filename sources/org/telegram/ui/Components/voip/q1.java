...
public final class q1 {
    ...
    public q1() {
        ...
        paint3.setAlpha(35);
        ((Paint) nVar2.f7330a).setAlpha(180);
    }
    ...
    public final Paint b() {
        ...
        return (Paint) this.f29573b.f7330a;
    }
    ...
    public final void d(float f7, float f10) {
        ...
        float f12 = -f7;
        float f13 = -f10;
        nVar.B(f12 - ((f11 - this.f29575f) / 2.0f), f13 - ((f11 - this.f29576g) / 2.0f), f11 / ((Bitmap) nVar.f7332c).getHeight(), this.h);
        ...
        if (this.f29577i && !z10) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    switch (r2) {
                        case 0:
                            q1 q1Var = this.f29563b;
                            q1Var.getClass();
                            float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            int i10 = (int) (35.0f * floatValue);
                            q1Var.f29580l.setAlpha(i10);
                            q1Var.f29579k.setAlpha((int) (floatValue * 102.0f));
                            q1Var.f29578j.setAlpha(i10);
                            q1Var.c();
                            return;
                        default:
                            q1 q1Var2 = this.f29563b;
                            q1Var2.getClass();
                            float floatValue2 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            ((Paint) q1Var2.f29573b.f7330a).setAlpha((int) (180.0f * floatValue2));
                            ((Paint) q1Var2.f29572a.f7330a).setAlpha((int) (floatValue2 * 255.0f));
                            q1Var2.c();
                            return;
                    }
                }
