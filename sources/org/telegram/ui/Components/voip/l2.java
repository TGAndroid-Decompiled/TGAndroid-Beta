...
public class l2 extends TextView {
    ...
    public void c() {
        CharSequence text;
        h90 h90Var = (h90) this.f31666c;
        Layout layout = getLayout();
        if (layout == null || (text = layout.getText()) == null) {
            return;
        }
        x80 x80Var = new x80(0);
        x80Var.f32488q = AndroidUtilities.dp(3.0f);
        x80Var.f32489r = AndroidUtilities.dp(6.0f);
        int length = text.length();
        x80Var.d(layout, 0, 0.0f);
        layout.getSelectionPath(0, length, x80Var);
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(x80Var.f32490s, x80Var.f32492u, x80Var.f32491t, x80Var.v);
        ((org.telegram.ui.Cells.z) this.f31665b).setBounds((int) rectF.left, (int) rectF.top, (int) rectF.right, (int) rectF.bottom);
        h90Var.f26719x = x80Var;
        h90Var.j(4.0f);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        switch (this.f31664a) {
            case 0:
                RectF rectF = (RectF) this.f31665b;
            ...
            default:
                ...
                ((org.telegram.ui.Cells.z) this.f31665b).draw(canvas);
                canvas.restore();
                super.onDraw(canvas);
                if (a() || h90Var.c()) {
                    canvas.save();
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        switch (this.f31664a) {
            case 1:
                org.telegram.ui.Cells.z zVar = (org.telegram.ui.Cells.z) this.f31665b;
    ...
    public boolean verifyDrawable(Drawable drawable) {
        switch (this.f31664a) {
            case 1:
                if (drawable != ((org.telegram.ui.Cells.z) this.f31665b) && !super.verifyDrawable(drawable)) {
                    return false;
                }
                return true;
            default:
