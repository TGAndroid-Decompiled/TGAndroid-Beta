...
public class l2 extends TextView {
    public final int f31637a = 0;
    public final Object f31638b;
    public final Object f31639c;
    ...
    public void c() {
        CharSequence text;
        h90 h90Var = (h90) this.f31639c;
        Layout layout = getLayout();
        if (layout == null || (text = layout.getText()) == null) {
            return;
        }
        x80 x80Var = new x80(0);
        x80Var.f32461q = AndroidUtilities.dp(3.0f);
        x80Var.f32462r = AndroidUtilities.dp(6.0f);
        int length = text.length();
        x80Var.d(layout, 0, 0.0f);
        layout.getSelectionPath(0, length, x80Var);
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(x80Var.f32463s, x80Var.f32465u, x80Var.f32464t, x80Var.v);
        ((org.telegram.ui.Cells.z) this.f31638b).setBounds((int) rectF.left, (int) rectF.top, (int) rectF.right, (int) rectF.bottom);
        h90Var.f26692x = x80Var;
        h90Var.j(4.0f);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        switch (this.f31637a) {
            case 0:
                RectF rectF = (RectF) this.f31638b;
            ...
            default:
                ...
                ((org.telegram.ui.Cells.z) this.f31638b).draw(canvas);
                canvas.restore();
                super.onDraw(canvas);
                if (a() || h90Var.c()) {
                    canvas.save();
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        switch (this.f31637a) {
            case 1:
                org.telegram.ui.Cells.z zVar = (org.telegram.ui.Cells.z) this.f31638b;
    ...
    public boolean verifyDrawable(Drawable drawable) {
        switch (this.f31637a) {
            case 1:
                if (drawable != ((org.telegram.ui.Cells.z) this.f31638b) && !super.verifyDrawable(drawable)) {
                    return false;
                }
                return true;
            default:
