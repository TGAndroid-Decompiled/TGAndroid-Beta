...
public final class b1 extends TextView {
    public final Paint f28859a;
    public final Paint[] f28860b;
    public final mi1 f28861c;
    ...
    public b1(mi1 mi1Var, Context context) {
        ...
        this.f28859a = paint;
        this.f28860b = new Paint[mi1Var.e.length];
        cc0 cc0Var = mi1Var.R;
        ...
        ((Canvas) nVar.f7337b).drawColor(0, mode);
        ((Canvas) nVar2.f7337b).drawColor(0, mode);
        cc0Var.draw((Canvas) nVar.f7337b);
        cc0Var2.draw((Canvas) nVar2.f7337b);
        paint.setColor(-1);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int i11 = mi1Var.v;
        Paint[] paintArr = this.f28860b;
        paintArr[i11].setAlpha(255);
        float dp = AndroidUtilities.dp(8.0f) + ((int) ((1.0f - mi1Var.f28894y) * (AndroidUtilities.dp(26.0f) - AndroidUtilities.dp(8.0f))));
        canvas.drawRoundRect(rectF, dp, dp, paintArr[mi1Var.v]);
        float f7 = mi1Var.f28891s;
        ...
        float f10 = mi1Var.f28894y;
        if (f10 < 1.0f) {
            Paint paint = this.f28859a;
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        while (true) {
            ...
            if (i14 < paintArr.length) {
                if (i14 == 0) {
                    paintArr[i14] = (Paint) nVar.f7336a;
                } else if (i14 == 1) {
                    paintArr[i14] = (Paint) mi1Var.Q.f7336a;
                } else {
                    paintArr[i14] = (Paint) nVar.f7336a;
                }
                i14++;
