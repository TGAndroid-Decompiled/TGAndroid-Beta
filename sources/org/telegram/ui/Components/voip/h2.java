...
public final class h2 extends LinearLayout {
    public HashMap f29671a;
    public ArrayList f29672b;
    public ArrayList f29673c;
    public TransitionSet d;
    public boolean e;
    public boolean f29674f;
    public Runnable h;
    public n1 f29675n;
    public TextPaint f29676r;

    public final void a(int i10, String str, String str2) {
        HashMap hashMap = this.f29671a;
        if (hashMap.get(str2) != null) {
            return;
        }
        g2 g2Var = new g2(getContext(), this.f29675n, i10);
        g2Var.f29647a = str2;
        int dp = AndroidUtilities.displaySize.x - AndroidUtilities.dp(120.0f);
        TextView textView = g2Var.f29649c;
        ...
        g2Var.f29648b.setImageResource(i10);
        hashMap.put(str2, g2Var);
        if (this.e) {
            this.f29672b.add(g2Var);
            return;
        }
        this.f29674f = true;
    ...
    public final CharSequence b(String str) {
        ...
        return TextUtils.ellipsize(str, this.f29676r, AndroidUtilities.dp(300.0f), TextUtils.TruncateAt.END);
    }

    public final void c(String str) {
        g2 g2Var = (g2) this.f29671a.remove(str);
        this.f29675n.f29805m.remove(g2Var);
        if (g2Var != null) {
            if (this.e) {
                if (!this.f29672b.remove(g2Var)) {
                    this.f29673c.add(g2Var);
                    return;
                }
                return;
            }
