...
public final class h2 extends LinearLayout {
    public HashMap f28957a;
    public ArrayList f28958b;
    public ArrayList f28959c;
    public TransitionSet d;
    public boolean e;
    public boolean f28960f;
    public Runnable h;
    public q1 f28961n;
    public TextPaint f28962r;

    public final void a(int i10, String str, String str2) {
        HashMap hashMap = this.f28957a;
        if (hashMap.get(str2) != null) {
            return;
        }
        g2 g2Var = new g2(getContext(), this.f28961n, i10);
        g2Var.f28933a = str2;
        int dp = AndroidUtilities.displaySize.x - AndroidUtilities.dp(120.0f);
        TextView textView = g2Var.f28935c;
        ...
        g2Var.f28934b.setImageResource(i10);
        hashMap.put(str2, g2Var);
        if (this.e) {
            this.f28958b.add(g2Var);
            return;
        }
        this.f28960f = true;
    ...
    public final CharSequence b(String str) {
        ...
        return TextUtils.ellipsize(str, this.f28962r, AndroidUtilities.dp(300.0f), TextUtils.TruncateAt.END);
    }

    public final void c(String str) {
        g2 g2Var = (g2) this.f28957a.remove(str);
        this.f28961n.f29155m.remove(g2Var);
        if (g2Var != null) {
            if (this.e) {
                if (!this.f28958b.remove(g2Var)) {
                    this.f28959c.add(g2Var);
                    return;
                }
                return;
            }
