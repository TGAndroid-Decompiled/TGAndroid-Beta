...
public final class h2 extends LinearLayout {
    public HashMap f29276a;
    public ArrayList f29277b;
    public ArrayList f29278c;
    public TransitionSet d;
    public boolean e;
    public boolean f29279f;
    public Runnable h;
    public q1 f29280n;
    public TextPaint f29281r;
    ...
    public final void a(int i10, String str, String str2) {
        ...
        g2 g2Var = new g2(getContext(), this.f29280n, i10);
        g2Var.f29252a = str2;
        int dp = AndroidUtilities.displaySize.x - AndroidUtilities.dp(120.0f);
        TextView textView = g2Var.f29254c;
        ...
        g2Var.f29253b.setImageResource(i10);
        hashMap.put(str2, g2Var);
        if (this.e) {
            this.f29277b.add(g2Var);
            return;
        }
        this.f29279f = true;
    ...
    public final CharSequence b(String str) {
        ...
        return TextUtils.ellipsize(str, this.f29281r, AndroidUtilities.dp(300.0f), TextUtils.TruncateAt.END);
    }

    public final void c(String str) {
        g2 g2Var = (g2) this.f29276a.remove(str);
        this.f29280n.f29474m.remove(g2Var);
        if (g2Var != null) {
            if (this.e) {
                if (!this.f29277b.remove(g2Var)) {
                    this.f29278c.add(g2Var);
                    return;
                }
                return;
            }
    ...
    public int getChildsHight() {
        ...
        return wh.c(32.0f, childCount, i10);
    }
