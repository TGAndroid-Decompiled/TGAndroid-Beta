...
public final class ly extends vl0 {
    public boolean E;
    public final lz F;
    public final gy f26212c;
    public long d;
    public TLRPC.StickerSet e;
    public ArrayList f26213f;
    public final ArrayList h = new ArrayList();
    public final ArrayList f26214n = new ArrayList();
    public final ArrayList f26215r = new ArrayList();
    public final ArrayList f26216s = new ArrayList();
    public String v;
    public String f26217w;
    public ky f26218x;
    public boolean f26219y;

    public ly(lz lzVar, Context context) {
        this.F = lzVar;
        ?? aVar = new nh.a(context, lzVar.f26229c1, new d(this, 11), new nv(this, 1), lzVar.Z1);
        this.f26212c = aVar;
    ...
    public static void E(ly lyVar, Runnable runnable, ArrayList arrayList, boolean z10) {
        ...
        MediaDataController.getInstance(lzVar.f26229c1).searchStickers(true, str2, str3, new ai.e4((Object) lyVar, str3, arrayList, (Object) runnable, 9), z10);
    }
    ...
    public final void F(String str, boolean z10) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            this.d = 0L;
            lzVar.f26223b.a(false, true);
            l();
        } else {
            this.v = str.toLowerCase();
        }
        ky kyVar = this.f26218x;
        if (kyVar != null) {
    ...
    public final int h() {
        if (this.d != 0) {
            return this.f26213f.size() + 4;
        }
        ArrayList arrayList = this.h;
        boolean isEmpty = arrayList.isEmpty();
        ArrayList arrayList2 = this.f26216s;
        ArrayList arrayList3 = this.f26215r;
        if (isEmpty && arrayList3.isEmpty() && arrayList2.isEmpty() && !this.f26219y) {
            ...
            if (i10 != 1) {
                if (i10 != 3) {
                    if (i10 != 4) {
                        ...
                        View view2 = this.f26212c;
                        view2.setLayoutParams(p0Var);
                        f0Var = view2;
                    }
                } else {
                    f0Var = new org.telegram.ui.Cells.o8(lzVar.getContext(), true, false, lzVar.Z1, lzVar.f26249i2);
                }
            } else {
                View view3 = new View(lzVar.getContext());
                view3.setLayoutParams(new s4.p0(-1, lzVar.f26225b1));
                f0Var = view3;
            }
        } else {
