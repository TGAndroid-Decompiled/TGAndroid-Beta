...
public final class h21 {
    public final Paint f24648a;
    public final Paint f24649b;
    public final Paint f24650c;
    public Drawable d;
    public Drawable e;
    public final i21 f24651f;

    public h21(i21 i21Var) {
        this.f24651f = i21Var;
        Paint paint = new Paint(1);
        this.f24648a = paint;
        this.f24649b = new Paint(1);
        this.f24650c = new Paint(1);
    ...
    public final void a(Canvas canvas, float f7) {
        ...
        int i11;
        float f18;
        i21 i21Var = this.f24651f;
        ImageReceiver imageReceiver = i21Var.P;
        float f19 = i21Var.e;
        org.telegram.ui.ActionBar.d5 d5Var = i21Var.S;
        org.telegram.ui.ActionBar.d5 d5Var2 = i21Var.R;
        float f20 = i21Var.d;
        float f21 = i21Var.f24963c;
        int i12 = i21Var.K;
        RectF rectF = i21Var.v;
        if (!i21Var.W && i21Var.f24970y == null) {
            f10 = 255.0f;
            f11 = 4.0f;
            f12 = 0.5f;
        } else {
            np npVar = i21Var.G;
            f10 = 255.0f;
            org.telegram.ui.ActionBar.a4 a4Var = (org.telegram.ui.ActionBar.a4) npVar.f26860a.f18759f.get(npVar.f26862c);
            if (i21Var.G.f26860a.m()) {
                i10 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Oh, i21Var.f24969x);
            } else {
                i10 = a4Var.f18715j;
            }
            Paint paint = this.f24648a;
            paint.setColor(i10);
            ...
            float f22 = i21Var.f24961a;
            canvas.drawRoundRect(rectF, f22, f22, paint);
        }
        int i13 = (int) (f7 * f10);
        Paint paint2 = this.f24649b;
        paint2.setAlpha(i13);
        Paint paint3 = this.f24650c;
        paint3.setAlpha(i13);
        rectF.set(f21, f21, i21Var.getWidth() - f21, i21Var.getHeight() - f21);
        org.telegram.ui.ActionBar.b4 b4Var = i21Var.G.f26860a;
        if (b4Var != null) {
            if (b4Var.m()) {
                i21Var.G.f26860a.getClass();
            } else if (i12 != 4) {
                if (i12 == 2) {
                    if (i21Var.G.e != null) {
        ...
        if (i21Var.T == null) {
            float f23 = i21Var.f24962b;
            canvas.drawRoundRect(rectF, f23, f23, i21Var.f24967s);
            canvas.save();
    ...
    public final void b(Canvas canvas, float f7) {
        ...
        if (drawable != null) {
            canvas.save();
            canvas.clipPath(i21Var.f24968w);
            ...
            if ((drawable3 instanceof ColorDrawable) || ((drawable3 instanceof nc0) && (i10 = (iArr = ((nc0) drawable3).f26752a)[0]) == iArr[1] && i10 == iArr[2] && i10 == iArr[3])) {
                int alpha = i21Var.f24966r.getAlpha();
                i21Var.f24966r.setAlpha((int) (alpha * f7));
                float f10 = i21Var.f24963c;
                RectF rectF = AndroidUtilities.rectTmp;
                rectF.set(f10, f10, i21Var.getWidth() - f10, i21Var.getHeight() - f10);
                float f11 = i21Var.f24962b;
                canvas.drawRoundRect(rectF, f11, f11, i21Var.f24966r);
                i21Var.f24966r.setAlpha(alpha);
            }
            canvas.restore();
            return;
        }
        np npVar = i21Var.G;
        if (npVar != null && (b4Var = npVar.f26860a) != null && b4Var.m() && i21Var.N != null) {
            return;
        }
        RectF rectF2 = i21Var.v;
        float f12 = i21Var.f24962b;
        canvas.drawRoundRect(rectF2, f12, f12, i21Var.f24967s);
    }
}
