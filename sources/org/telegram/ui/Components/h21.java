...
public final class h21 {
    ...
    public final Paint f24532c;
    public Drawable d;
    public Drawable e;
    public final i21 f24533f;

    public h21(i21 i21Var) {
        this.f24533f = i21Var;
        Paint paint = new Paint(1);
        this.f24530a = paint;
        this.f24531b = new Paint(1);
        this.f24532c = new Paint(1);
    ...
    public final void a(Canvas canvas, float f7) {
        ...
        float f20 = i21Var.d;
        float f21 = i21Var.f24858c;
        int i12 = i21Var.K;
        RectF rectF = i21Var.v;
        if (!i21Var.W && i21Var.f24865y == null) {
            f10 = 255.0f;
            f11 = 4.0f;
            f12 = 0.5f;
        } else {
            lp lpVar = i21Var.G;
            f10 = 255.0f;
            org.telegram.ui.ActionBar.c4 c4Var = (org.telegram.ui.ActionBar.c4) lpVar.f26219a.f18810f.get(lpVar.f26221c);
            if (i21Var.G.f26219a.m()) {
                i10 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Oh, i21Var.f24864x);
            } else {
                i10 = c4Var.f18771j;
            }
            Paint paint = this.f24530a;
            paint.setColor(i10);
            ...
            float f22 = i21Var.f24856a;
            canvas.drawRoundRect(rectF, f22, f22, paint);
        }
        int i13 = (int) (f7 * f10);
        Paint paint2 = this.f24531b;
        paint2.setAlpha(i13);
        Paint paint3 = this.f24532c;
        paint3.setAlpha(i13);
        rectF.set(f21, f21, i21Var.getWidth() - f21, i21Var.getHeight() - f21);
        org.telegram.ui.ActionBar.d4 d4Var = i21Var.G.f26219a;
        if (d4Var != null) {
            if (d4Var.m()) {
                i21Var.G.f26219a.getClass();
            } else if (i12 != 4) {
                if (i12 == 2) {
                    if (i21Var.G.e != null) {
        ...
        if (i21Var.T == null) {
            float f23 = i21Var.f24857b;
            canvas.drawRoundRect(rectF, f23, f23, i21Var.f24862s);
            canvas.save();
    ...
    public final void b(Canvas canvas, float f7) {
        ...
        if (drawable != null) {
            canvas.save();
            canvas.clipPath(i21Var.f24863w);
            ...
            if ((drawable3 instanceof ColorDrawable) || ((drawable3 instanceof kc0) && (i10 = (iArr = ((kc0) drawable3).f25734a)[0]) == iArr[1] && i10 == iArr[2] && i10 == iArr[3])) {
                int alpha = i21Var.f24861r.getAlpha();
                i21Var.f24861r.setAlpha((int) (alpha * f7));
                float f10 = i21Var.f24858c;
                RectF rectF = AndroidUtilities.rectTmp;
                rectF.set(f10, f10, i21Var.getWidth() - f10, i21Var.getHeight() - f10);
                float f11 = i21Var.f24857b;
                canvas.drawRoundRect(rectF, f11, f11, i21Var.f24861r);
                i21Var.f24861r.setAlpha(alpha);
            }
            canvas.restore();
            return;
        }
        lp lpVar = i21Var.G;
        if (lpVar != null && (d4Var = lpVar.f26219a) != null && d4Var.m() && i21Var.N != null) {
            return;
        }
        RectF rectF2 = i21Var.v;
        float f12 = i21Var.f24857b;
        canvas.drawRoundRect(rectF2, f12, f12, i21Var.f24862s);
    }
}
