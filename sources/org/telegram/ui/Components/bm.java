...
public final class bm implements CameraView.CameraViewDelegate {
    public final ChatAttachAlertPhotoLayout f21857a;

    public bm(ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout) {
        this.f21857a = chatAttachAlertPhotoLayout;
    }
    ...
    public final void onCameraInit() {
        ...
        float f7;
        int i11;
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.f21857a;
        ...
        if (currentFlashMode != null && nextFlashMode != null) {
            ...
            if (currentFlashMode.equals(nextFlashMode)) {
                ...
                for (int i14 = 0; i14 < 2; i14++) {
                    ...
                    if (i14 == 0 && chatAttachAlertPhotoLayout.f20990b0) {
                        f7 = 1.0f;
                    } else {
                        f7 = 0.0f;
                    }
