        ...
        if (messageObject != null) {
            ...
            if (sparseArrayArr[c10].indexOfKey(messageObject.getId()) < 0) {
                if (sparseArrayArr[1].size() + sparseArrayArr[0].size() < 100) {
                    ...
                    if (!zu0Var.C1) {
                        AndroidUtilities.hideKeyboard(zu0Var.f30659v1.getParentActivity().getCurrentFocus());
                        org.telegram.ui.ActionBar.w0 w0Var = zu0Var.f30637l0;
                        int i12 = 8;
                        if (zu0Var.f30611a1 == 0) {
                            i10 = 0;
                        } else {
                            i10 = 8;
                        }
                        w0Var.setVisibility(i10);
                        org.telegram.ui.ActionBar.w0 w0Var2 = zu0Var.f30656u0;
                        if (w0Var2 != null) {
                        ...
                        org.telegram.ui.ActionBar.w0 w0Var5 = zu0Var.f30654t0;
                        if (w0Var5 != null) {
                            if (zu0Var.getClosestTab() != 8 && zu0Var.getClosestTab() != 13) {
                                i12 = 0;
                            }
