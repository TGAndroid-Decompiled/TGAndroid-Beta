...
public final class nr0 implements Runnable {
    ...
    public final void run() {
        switch (this.f26797a) {
            case 0:
                org.telegram.ui.ActionBar.a2[] a2VarArr = this.f26798b;
                org.telegram.ui.ActionBar.a2 a2Var = a2VarArr[0];
                if (a2Var != null) {
                    final int i10 = this.f26799c;
                ...
                return;
            default:
                org.telegram.ui.ActionBar.a2[] a2VarArr2 = this.f26798b;
                org.telegram.ui.ActionBar.a2 a2Var2 = a2VarArr2[0];
                if (a2Var2 != null) {
                    final int i12 = this.f26799c;
