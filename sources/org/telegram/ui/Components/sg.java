...
public final class sg extends FrameLayout {
    ...
    public ci.e4 f28234a;
    public ci.e4 f28235b;
    public ShapeDrawable f28236c;
    public final Drawable d;
    public final String e;
    public StaticLayout f28237f;
    public float h;
    public final TextPaint f28238n;
    public final Paint f28239r;
    public final Paint f28240s;
    public final Paint v;
    public final Path f28241w;
    public final Paint f28242x;
    public final ci.l f28243y;
    ...
    public sg(ChatActivityEnterView chatActivityEnterView, Context context) {
        ...
        this.f28239r = new Paint(1);
        this.f28240s = new Paint(1);
        Paint paint = new Paint(1);
        this.v = paint;
        this.f28241w = new Path();
        this.f28242x = new Paint(1);
        this.I = new RectF();
        this.J = new RectF();
        this.L = new Path();
        this.M = r4;
        ...
        drawable.setColorFilter(new PorterDuffColorFilter(chatActivityEnterView.i0(org.telegram.ui.ActionBar.h6.f19015be), PorterDuff.Mode.MULTIPLY));
        this.f28236c = org.telegram.ui.ActionBar.h6.b0(AndroidUtilities.dp(5.0f), chatActivityEnterView.i0(org.telegram.ui.ActionBar.h6.f19292qf));
    ...
    public final void a() {
        ci.e4 e4Var = this.f28234a;
        if (e4Var != null) {
            e4Var.f4615l0 = new qg(this, e4Var, 1);
            e4Var.e(true);
            this.f28234a = null;
        }
        ci.e4 e4Var2 = this.f28235b;
        if (e4Var2 != null) {
    ...
    public final void b() {
        ...
        this.f28235b.s(AndroidUtilities.replaceTags(LocaleController.getString(i10)));
        ci.e4 e4Var2 = this.f28235b;
        e4Var2.h = ci.e4.a(e4Var2.getText(), this.f28235b.getTextPaint());
        if (chatActivityEnterView.O) {
            ci.e4 e4Var3 = this.f28235b;
        ...
        addView(this.f28235b, w7.y5.d(-1, -1.0f, 119, 0.0f, 0.0f, 54.0f, 58.0f));
        ci.e4 e4Var4 = this.f28235b;
    ...
    public final void c() {
        ...
        ChatActivityEnterView chatActivityEnterView = this.V;
        this.f28243y.e(chatActivityEnterView.i0(i10), chatActivityEnterView.i0(org.telegram.ui.ActionBar.h6.f19035cf), -1);
        this.f28238n.setColor(chatActivityEnterView.i0(org.telegram.ui.ActionBar.h6.f19273pf));
        int dp = AndroidUtilities.dp(5.0f);
        int i15 = org.telegram.ui.ActionBar.h6.f19292qf;
        this.f28236c = org.telegram.ui.ActionBar.h6.b0(dp, chatActivityEnterView.i0(i15));
        int i02 = chatActivityEnterView.i0(i15);
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.d.setColorFilter(new PorterDuffColorFilter(i02, mode));
        this.f28239r.setColor(chatActivityEnterView.i0(org.telegram.ui.ActionBar.h6.f18996ae));
        if (this.Q) {
            i11 = org.telegram.ui.ActionBar.h6.Wk;
        } else {
            i11 = org.telegram.ui.ActionBar.h6.Zd;
        }
        this.f28240s.setColor(chatActivityEnterView.i0(i11));
        if (this.Q) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.H != size) {
            this.H = size;
            StaticLayout staticLayout = new StaticLayout(this.e, this.f28238n, AndroidUtilities.dp(220.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, true);
            this.f28237f = staticLayout;
            int lineCount = staticLayout.getLineCount();
            this.h = 0.0f;
            for (int i12 = 0; i12 < lineCount; i12++) {
                float lineWidth = this.f28237f.getLineWidth(i12);
                if (lineWidth > this.h) {
                    this.h = lineWidth;
                }
            }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (chatActivityEnterView.P && chatActivityEnterView.N1 != null && chatActivityEnterView.f22021n4 > 0.1f) {
            ...
            if (this.U && rectF.contains(x10, y3)) {
                if (chatActivityEnterView.f21954c1) {
                    ...
                    if (MediaController.getInstance().isRecordingPaused() && (chatActivityEnterView.f21985h1.getAudioLeft() > 0.01f || chatActivityEnterView.f21985h1.getAudioRight() < 0.99f)) {
                        ...
                        if (MessagesController.getGlobalMainSettings().getBoolean("trimvoicehint", true)) {
                            ...
                            alertDialog$Builder.f18647a.R = LocaleController.getString(R.string.RecordingTrimTitle);
                            alertDialog$Builder.f18647a.T = LocaleController.getString(R.string.RecordingTrimText);
    ...
    public void setBlurredBackgroundFactory(ah.c cVar) {
        this.Q = true;
        if (this.P == null) {
            this.P = new dh.b(org.telegram.ui.ActionBar.h6.f18996ae, this.V.W3);
        }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f28243y && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
