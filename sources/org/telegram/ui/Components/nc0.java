...
public final class nc0 extends Drawable {
    public static final boolean f26723e0;
    public static final boolean f26724f0;
    public Matrix A;
    public boolean B;
    ...
    public int f26726a0;
    public long f26727b;
    public final gh.a f26728b0;
    public WeakReference f26729c;
    public Bitmap f26730c0;
    public boolean d;
    public int f26731d0;
    public final qr e;
    public int f26732f;
    ...
    public float h;
    public int f26734i;
    public final RectF f26735j;
    public Bitmap f26736k;
    public Bitmap f26737l;
    public final Bitmap[] f26738m;
    public final Paint f26739n;
    public final Paint f26740o;
    public final Paint f26741p;
    public int f26742q;
    public Canvas f26743r;
    public Canvas f26744s;
    public boolean f26745t;
    public Bitmap f26746u;
    public BitmapShader v;
    public BitmapShader f26747w;
    public Bitmap f26748x;
    public ImageReceiver f26749y;
    ...
    public nc0() {
        this.f26725a = new int[]{-12423849, -531317, -7888252, -133430};
        this.e = new qr(0.33d, 0.0d, 0.0d, 1.0d);
        this.h = 1.0f;
        this.f26735j = new RectF();
        this.f26738m = new Bitmap[3];
        this.f26739n = new Paint(2);
        this.f26740o = new Paint(2);
        this.f26741p = new Paint();
        this.f26742q = 100;
        ...
        this.V = new gh.a();
        this.W = new gh.a();
        this.f26728b0 = new gh.a();
        h();
    }

    public static int g(int i10, int i11, int i12, int i13) {
        boolean j3 = j(i10, i11, i12, i13);
        boolean z10 = f26724f0;
        if (j3) {
            if (!z10) {
    ...
    public final void a(Canvas canvas, int i10, float f7, float f10, float f11, float f12) {
        List list = this.R;
        if (list != null && this.f26749y != null && i10 >= 0 && i10 < list.size()) {
            dg.c cVar = (dg.c) this.R.get(i10);
            canvas.save();
            canvas.translate(f7, f10);
            canvas.scale(f11, f12);
            canvas.concat(cVar.f7730b);
            this.f26749y.setImageCoords(cVar.f7729a);
            this.f26749y.draw(canvas);
            canvas.restore();
        }
    }

    public final void b(Canvas canvas, RectF rectF, int i10) {
        if (this.R != null && this.f26746u != null) {
            a(canvas, i10, rectF.left, rectF.top, rectF.width() / this.f26746u.getWidth(), rectF.height() / this.f26746u.getHeight());
        }
    }
    ...
    public final void c() {
        ...
        while (i10 < 3) {
            ...
            if (i10 < 0) {
                ...
                bitmap = this.f26738m[i10];
            }
            Utilities.generateGradient(bitmap, this.f26734i, f7, this.f26725a);
            i10 = i11;
        }
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        float f7 = i10;
        int width = this.f26736k.getWidth();
        int height = this.f26736k.getHeight();
        ...
        if (Build.VERSION.SDK_INT >= 28 && this.Q != null && this.f26736k != null && e != null) {
            z10 = true;
        } else {
            z10 = false;
        }
        int i13 = this.f26742q;
        float f16 = 1.0f;
        Paint paint = this.f26739n;
        Paint paint2 = this.f26740o;
        RectF rectF = this.f26735j;
        if (i13 < 0) {
            boolean z11 = f26723e0;
            if (!z10 && (!z11 || e == null)) {
                canvas.drawColor(i0.a.k(-16777216, (int) (this.L * this.K)));
            }
            if (e != null) {
                if (z11) {
                    int i14 = (((int) (this.L * this.J)) * (-this.f26742q)) / 100;
                    if (this.f26746u != null) {
                        Bitmap e7 = e();
                        gh.a aVar = this.f26728b0;
                        if (aVar.a(e7) || this.f26730c0 == null || this.f26731d0 != i14) {
                            int width3 = this.f26746u.getWidth();
                            int height3 = this.f26746u.getHeight();
                            this.f26731d0 = i14;
                            Bitmap bitmap = this.f26730c0;
                            if (bitmap == null || bitmap.getWidth() != width3 || this.f26730c0.getHeight() != height3) {
                                this.f26730c0 = Bitmap.createBitmap(width3, height3, Bitmap.Config.ARGB_8888);
                            }
                            Utilities.applyAlphaInvert(e7, this.f26730c0, i14);
                        }
                        aVar.b(e7);
                    }
                    ...
                    if (this.f26730c0 != null) {
                        canvas.drawBitmap(this.f26736k, (Rect) null, rectF, paint);
                        canvas.drawBitmap(this.f26730c0, (Rect) null, rectF, paint);
                    } else {
                        canvas.drawColor(i0.a.k(-16777216, (int) (this.L * this.K)));
                    }
                    ...
                    float min = 1.0f / Math.min(this.f26736k.getWidth() / bounds.width(), this.f26736k.getHeight() / bounds.height());
                    ...
                    if (!this.f26750z || max3 > 1.4f || max3 < 0.8f) {
                        this.A.preScale(max3, max3);
                        f16 = max3;
                    }
                    this.f26747w.setLocalMatrix(this.A);
                    paint2.setColorFilter(null);
                    paint2.setAlpha((int) ((Math.abs(this.f26742q) / 100.0f) * this.L * this.J));
                    rectF.set(bounds.left, bounds.top, bounds.right, bounds.bottom);
                    if (z10) {
                        Paint e10 = this.Q.e(this.f26736k, e, this.U, (int) (this.L * this.J), this.f26742q, canvas.isHardwareAccelerated());
                        this.Q.d(this.A);
                        this.Q.c(rectF);
                        float f23 = this.I;
            ...
            if (this.I != 0) {
                ...
                float min2 = 1.0f / Math.min(this.f26736k.getWidth() / bounds.width(), this.f26736k.getHeight() / bounds.height());
            ...
            if (e != null) {
                ...
                paint2.setAlpha((int) ((Math.abs(this.f26742q) / 100.0f) * this.L * this.J));
                if (z12) {
                    Paint e11 = this.Q.e(this.f26736k, e, this.U, (int) (this.L * this.J), this.f26742q, canvas.isHardwareAccelerated());
                    sc0 sc0Var = this.Q;
                    RectF rectF2 = sc0Var.f28162j;
                    rectF2.set(0.0f, 0.0f, sc0Var.f28160g, sc0Var.h);
                    Matrix matrix = sc0Var.f28161i;
                ...
                paint2.setAlpha((int) ((Math.abs(this.f26742q) / 100.0f) * this.L * this.J * 0.8f));
                b(canvas, rectF, this.S);
            }
        }
        canvas.restore();
    ...
    public final Bitmap e() {
        boolean z10;
        Bitmap bitmap = this.f26746u;
        if (bitmap == null) {
            return null;
        }
        if (this.f26748x == null) {
            return bitmap;
        }
        gh.a aVar = this.V;
        boolean a2 = aVar.a(bitmap);
        Bitmap bitmap2 = this.f26748x;
        gh.a aVar2 = this.W;
        boolean a10 = aVar2.a(bitmap2);
        boolean z11 = true;
        if (this.f26726a0 != this.S) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        int width = this.f26746u.getWidth();
        int height = this.f26746u.getHeight();
        ...
        Bitmap.Config config = this.f26746u.getConfig();
        if (config == Bitmap.Config.ARGB_8888) {
            Utilities.copyBitmaps(this.f26746u, this.X);
        } else if (config == Bitmap.Config.ALPHA_8) {
            Utilities.expandAlphaToBlack(this.f26746u, this.X);
        }
        if (this.Z == null) {
        ...
        Paint paint2 = this.Z;
        int i10 = this.S;
        if (this.f26748x != null && this.R != null) {
            for (int i11 = 0; i11 < this.R.size(); i11++) {
                if (i11 != i10) {
                    dg.c cVar = (dg.c) this.R.get(i11);
                    canvas.save();
                    canvas.concat(cVar.f7730b);
                    canvas.drawBitmap(this.f26748x, (Rect) null, cVar.f7729a, paint2);
                    canvas.restore();
                }
            }
        }
        this.f26726a0 = this.S;
        aVar.b(this.f26746u);
        aVar2.b(this.f26748x);
        return this.X;
    }
    ...
    public final void h() {
        ...
        this.f26736k = createBitmap;
        createBitmap.setHasAlpha(false);
        for (int i12 = 0; i12 < 3; i12++) {
            Bitmap createBitmap2 = Bitmap.createBitmap(i10, i11, Bitmap.Config.ARGB_8888);
            this.f26738m[i12] = createBitmap2;
            createBitmap2.setHasAlpha(false);
        }
        this.f26743r = new Canvas(this.f26736k);
        Bitmap createBitmap3 = Bitmap.createBitmap(i10, i11, Bitmap.Config.ARGB_8888);
        this.f26737l = createBitmap3;
        createBitmap3.setHasAlpha(false);
        this.f26744s = new Canvas(this.f26737l);
        Utilities.generateGradient(this.f26736k, this.f26734i, this.e.getInterpolation(this.h), this.f26725a);
        if (f26724f0) {
            this.f26740o.setBlendMode(m4.q0.c());
        }
    }

    public final void i() {
        invalidateSelf();
        WeakReference weakReference = this.f26729c;
        if (weakReference != null && weakReference.get() != null) {
            ((View) this.f26729c.get()).invalidate();
        }
        if (this.f26745t) {
    ...
    public final void k() {
        this.T = true;
        ImageReceiver imageReceiver = this.f26749y;
    ...
    public final void o(int i10, int i11, int i12, int i13, int i14, boolean z10) {
        ...
        if (iArr[0] != i10 || iArr[1] != i11 || iArr[2] != i12 || iArr[3] != i13) {
            ...
            iArr[2] = i12;
            iArr[3] = i13;
            Bitmap bitmap = this.f26736k;
            if (bitmap != null) {
                Utilities.generateGradient(bitmap, this.f26734i, this.e.getInterpolation(this.h), iArr);
                if (z10) {
                    i();
                }
            }
    ...
    public final void r(View view) {
        this.f26729c = new WeakReference(view);
        ImageReceiver imageReceiver = this.f26749y;
        if (imageReceiver != null) {
    ...
    public final void setAlpha(int i10) {
        this.L = i10;
        this.f26739n.setAlpha(i10);
        this.f26740o.setAlpha(i10);
    }
    ...
    public final void t(Bitmap bitmap, int i10) {
        ...
        if (bitmap != null) {
            ...
            if (i10 < 0) {
                if (!z11) {
                    Bitmap bitmap2 = this.f26736k;
                    Shader.TileMode tileMode = Shader.TileMode.CLAMP;
                    this.v = new BitmapShader(bitmap2, tileMode, tileMode);
                    Bitmap bitmap3 = this.f26746u;
                    Shader.TileMode tileMode2 = Shader.TileMode.REPEAT;
                    this.f26747w = new BitmapShader(bitmap3, tileMode2, tileMode2);
                    this.f26750z = true;
                    paint.setShader(new ComposeShader(this.v, this.f26747w, PorterDuff.Mode.DST_IN));
    ...
    public final void w(int i10) {
        ...
        this.v = bitmapShader;
        this.f26739n.setShader(bitmapShader);
        i();
    }
    ...
    public final void x(boolean z10) {
        if (this.h >= 1.0f && LiteMode.isEnabled(32)) {
            ...
            this.B = z10;
            this.h = 0.0f;
            int i10 = this.f26734i - 1;
            this.f26734i = i10;
            if (i10 < 0) {
                this.f26734i = 7;
            }
            i();
            this.f26744s.drawBitmap(this.f26736k, 0.0f, 0.0f, (Paint) null);
            c();
            return;
        }
        i();
    ...
    public final void y() {
        ...
        this.h = 0.0f;
        i();
        Utilities.generateGradient(this.f26737l, this.f26734i, 0.0f, this.f26725a);
        c();
    }
    ...
    public final void z() {
        ...
        long j3 = elapsedRealtime - this.f26727b;
        if (j3 > 20) {
            j3 = 17;
        }
        this.f26727b = elapsedRealtime;
        if (j3 > 1) {
            boolean z11 = this.N;
            if (z11 && this.h == 1.0f) {
                this.h = 0.0f;
            ...
            if (f13 < 1.0f) {
                ...
                if (z12) {
                    Utilities.generateGradient(this.f26736k, this.f26734i, f10, this.f26725a);
                } else {
                    Paint paint = this.f26741p;
                    Bitmap[] bitmapArr = this.f26738m;
                    if (f10 != 1.0f) {
                        int i15 = (int) (f10 / 0.33333334f);
                        if (i15 == 0) {
                            this.f26743r.drawBitmap(this.f26737l, 0.0f, 0.0f, (Paint) null);
                        } else {
                            this.f26743r.drawBitmap(bitmapArr[i15 - 1], 0.0f, 0.0f, (Paint) null);
                        }
                        paint.setAlpha((int) (((f10 - (i15 * 0.33333334f)) / 0.33333334f) * 255.0f));
                        this.f26743r.drawBitmap(bitmapArr[i15], 0.0f, 0.0f, paint);
                    } else {
                        this.f26743r.drawBitmap(bitmapArr[2], 0.0f, 0.0f, paint);
                    }
                }
                i();
            }
