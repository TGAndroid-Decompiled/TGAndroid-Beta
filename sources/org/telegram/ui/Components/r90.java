...
public abstract class r90 {
    public static final Pattern f30020a = Pattern.compile("^\\[\\^([^\\]]+)\\]:[ \\t]*(.*)$");
    public static final Pattern f30021b = Pattern.compile("\\[\\^([^\\]]+)\\]");
    public static final Pattern f30022c = Pattern.compile("^(\\d+)[.)]\\s");

    public static TL_iv.RichText a(bf.p pVar, TL_iv.PageBlock pageBlock) {
        o90 o90Var = new o90(pageBlock);
        pVar.a(o90Var);
        return g(h(o90.x(o90Var.f29038c)));
    }
