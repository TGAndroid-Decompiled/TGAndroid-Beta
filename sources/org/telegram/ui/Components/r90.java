...
public final class r90 extends View {
    public final TextPaint f27811a;
    public final Paint f27812b;
    ...
    public r90(Context context) {
        ...
        this.f27811a = textPaint;
        this.f27812b = new Paint(1);
        this.d = new Rect();
        this.f27813c = LocaleController.getString(R.string.LoginOrSingInWithGoogle);
        textPaint.setTextSize(AndroidUtilities.dp(14.0f));
        a();
    }

    public final void a() {
        this.f27811a.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19477y6, false));
        this.f27812b.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.Ii, false));
        invalidate();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawText(this.f27813c, (getWidth() - rect.width()) / 2.0f, (rect.height() + height) / 2.0f, this.f27811a);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f27811a.getTextBounds(str, 0, str.length(), this.d);
    }
