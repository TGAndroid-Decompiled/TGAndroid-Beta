...
public final class zn extends u9 {
        ...
        if (eoVar.f23700b && this.e == null) {
            ...
            if (boVar != null) {
                ...
                if (n2Var instanceof eg1) {
                    j3 = -((eg1) n2Var).f33291a;
                } else {
                    j3 = 0;
                }
            }
            ai.ia.h(j3, canvas, this.f28311a, m6Var);
            return;
        }
        super.onDraw(canvas);
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (this.K.f23700b && this.G.a(motionEvent, this)) {
            return true;
        }
