...
public final class zn extends LinearLayout {
    public final org.telegram.ui.ActionBar.f6 f31434a;
    public final TextView f31435b;
    ...
    public zn(Activity activity, View view, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        int i15 = org.telegram.ui.ActionBar.j6.f19820a;
        ...
        for (int i17 = 0; i17 < 4; i17++) {
            ...
            imageView2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i18, this.f31434a), PorterDuff.Mode.MULTIPLY));
            if (i10 == 0) {
            ...
            textView4.setTextColor(org.telegram.ui.ActionBar.j6.v0(i18, this.f31434a));
            this.f31436c.add(textView4);
            if (LocaleController.isRTL) {
                i14 = 5;
            } else {
                i14 = 3;
    ...
    public void setStatusText(CharSequence charSequence) {
        this.f31435b.setText(charSequence);
    }
    ...
    public void setTextColor(int i10) {
        ...
        while (true) {
            ...
            if (i11 < arrayList2.size()) {
                ((ImageView) arrayList2.get(i11)).setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.ic, this.f31434a), PorterDuff.Mode.MULTIPLY));
                i11++;
            } else {
                return;
            }
