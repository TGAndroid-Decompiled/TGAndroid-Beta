...
public final class v90 extends qv0 {
    public final int f28666w0;
    public final FrameLayout f28667x0;
    public final org.telegram.ui.ActionBar.o2 f28668y0;

    public v90(org.telegram.ui.ActionBar.o2 o2Var, Context context, FrameLayout frameLayout, int i10) {
        super(context, null);
        this.f28666w0 = i10;
        this.f28668y0 = o2Var;
        this.f28667x0 = frameLayout;
    }

    @Override
    public void L(Canvas canvas, ArrayList arrayList) {
        switch (this.f28666w0) {
            case 0:
                ((ba0) this.f28668y0).V.Q(canvas, arrayList);
                return;
            default:
                return;
        }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        switch (this.f28666w0) {
            case 0:
                ba0 ba0Var = (ba0) this.f28668y0;
                y90 y90Var = ba0Var.V;
                if (y90Var != null && (st0Var = (st0VarArr = y90Var.f30632k0)[0]) != null && st0Var.h.getFastScroll() != null && st0VarArr[0].h.getFastScroll().f28138n) {
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        switch (this.f28666w0) {
            case 1:
                PasscodeActivity passcodeActivity = (PasscodeActivity) this.f28668y0;
                int visibility = passcodeActivity.v.getVisibility();
                FrameLayout frameLayout = this.f28667x0;
                ...
                return;
            case 2:
                org.telegram.ui.j0 j0Var = (org.telegram.ui.j0) this.f28667x0;
                ih1 ih1Var = (ih1) this.f28668y0;
                if (ih1Var.f34578e0.getVisibility() != 8 && R() >= AndroidUtilities.dp(20.0f)) {
                    if (ih1Var.v0()) {
                ...
                } else if (ih1Var.f34578e0.getVisibility() != 8) {
                ...
                ih1Var.f34578e0.layout(0, measuredHeight2, getMeasuredWidth(), AndroidUtilities.dp(230.0f) + measuredHeight2);
                return;
            default:
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        switch (this.f28666w0) {
            case 0:
                ...
                FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) this.f28667x0.getLayoutParams();
                ...
                ((FrameLayout.LayoutParams) ba0Var.f22690y.getLayoutParams()).topMargin = org.telegram.messenger.wl.y(42.0f, org.telegram.ui.ActionBar.k.getCurrentActionBarHeight(), 2);
            ...
            case 1:
                ...
                this.f28667x0.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(size2, 1073741824));
            ...
            default:
                ...
                ((org.telegram.ui.j0) this.f28667x0).measure(View.MeasureSpec.makeMeasureSpec(size3, 1073741824), View.MeasureSpec.makeMeasureSpec(size4, 1073741824));
                ih1Var.f34578e0.measure(View.MeasureSpec.makeMeasureSpec(size3, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(230.0f), 1073741824));
                return;
        }
    }
}
