...
public final class v90 extends View {
    public final TextPaint f29050a;
    ...
    public v90(Context context) {
        ...
        this.f29050a = textPaint;
        this.f29051b = new Paint(1);
        this.d = new Rect();
        this.f29052c = LocaleController.getString(R.string.LoginOrSingInWithGoogle);
        textPaint.setTextSize(AndroidUtilities.dp(14.0f));
        a();
    }

    public final void a() {
        this.f29050a.setColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19442y6, false));
        this.f29051b.setColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.Ii, false));
        invalidate();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawText(this.f29052c, (getWidth() - rect.width()) / 2.0f, (rect.height() + height) / 2.0f, this.f29050a);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f29050a.getTextBounds(str, 0, str.length(), this.d);
    }
