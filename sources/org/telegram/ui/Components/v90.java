        ...
        if (i10 == -1) {
            ...
            if (ca0Var.I != null) {
                ...
                if (!arrayList.isEmpty()) {
                    ...
                    alertDialog$Builder.f18409a.T = LocaleController.formatPluralString("DeleteStoriesSubtitle", arrayList.size(), new Object[0]);
