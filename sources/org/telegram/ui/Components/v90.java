...
public final class v90 extends pv0 {
    public final int f28670w0;
    public final FrameLayout f28671x0;
    public final org.telegram.ui.ActionBar.n2 f28672y0;

    public v90(org.telegram.ui.ActionBar.n2 n2Var, Context context, FrameLayout frameLayout, int i10) {
        super(context, null);
        this.f28670w0 = i10;
        this.f28672y0 = n2Var;
        this.f28671x0 = frameLayout;
    }

    @Override
    public void L(Canvas canvas, ArrayList arrayList) {
        switch (this.f28670w0) {
            case 0:
                ((ba0) this.f28672y0).V.Q(canvas, arrayList);
                return;
            default:
                return;
        }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        switch (this.f28670w0) {
            case 0:
                ba0 ba0Var = (ba0) this.f28672y0;
                y90 y90Var = ba0Var.V;
                if (y90Var != null && (rt0Var = (rt0VarArr = y90Var.f30365k0)[0]) != null && rt0Var.h.getFastScroll() != null && rt0VarArr[0].h.getFastScroll().f27898n) {
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        switch (this.f28670w0) {
            case 1:
                PasscodeActivity passcodeActivity = (PasscodeActivity) this.f28672y0;
                int visibility = passcodeActivity.v.getVisibility();
                FrameLayout frameLayout = this.f28671x0;
                ...
                return;
            case 2:
                org.telegram.ui.j0 j0Var = (org.telegram.ui.j0) this.f28671x0;
                hh1 hh1Var = (hh1) this.f28672y0;
                if (hh1Var.f34275e0.getVisibility() != 8 && R() >= AndroidUtilities.dp(20.0f)) {
                    if (hh1Var.v0()) {
                ...
                } else if (hh1Var.f34275e0.getVisibility() != 8) {
                ...
                hh1Var.f34275e0.layout(0, measuredHeight2, getMeasuredWidth(), AndroidUtilities.dp(230.0f) + measuredHeight2);
                return;
            default:
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        switch (this.f28670w0) {
            case 0:
                ...
                FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) this.f28671x0.getLayoutParams();
                ...
                ((FrameLayout.LayoutParams) ba0Var.f22740y.getLayoutParams()).topMargin = org.telegram.messenger.vl.y(42.0f, org.telegram.ui.ActionBar.k.getCurrentActionBarHeight(), 2);
            ...
            case 1:
                ...
                this.f28671x0.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(size2, 1073741824));
            ...
            default:
                ...
                ((org.telegram.ui.j0) this.f28671x0).measure(View.MeasureSpec.makeMeasureSpec(size3, 1073741824), View.MeasureSpec.makeMeasureSpec(size4, 1073741824));
                hh1Var.f34275e0.measure(View.MeasureSpec.makeMeasureSpec(size3, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(230.0f), 1073741824));
                return;
        }
    }
}
