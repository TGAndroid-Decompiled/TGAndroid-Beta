...
public final class c21 implements MessagesController.IsInChatCheckedCallback, org.telegram.ui.ActionBar.a2 {
    ...
    public final TLObject f24872e;
    public final Object f24873f;
    ...
    public void g(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        zh.w3.L0((zh.w3) this.f24870b, (TL_stars.TL_starGiftUnique) this.f24871c, (TLRPC.PaymentForm) this.d, (TLRPC.TL_inputInvoiceStarGiftDropOriginalDetails) this.f24872e, this.f24869a, (CharSequence) this.f24873f, b2Var);
    }

    @Override
    public void run(boolean z10, TLRPC.TL_chatAdminRights tL_chatAdminRights, String str) {
        AndroidUtilities.runOnUIThread(new g21((w21) this.f24870b, z10, (org.telegram.ui.ActionBar.f1) this.f24871c, (n70) this.d, this.f24869a, (TLRPC.User) this.f24872e, (TLRPC.Chat) this.f24873f));
    }
    ...
    public c21(zh.w3 w3Var, TL_stars.TL_starGiftUnique tL_starGiftUnique, TLRPC.PaymentForm paymentForm, TLRPC.TL_inputInvoiceStarGiftDropOriginalDetails tL_inputInvoiceStarGiftDropOriginalDetails, long j3, CharSequence charSequence) {
        this.f24870b = w3Var;
        this.f24871c = tL_starGiftUnique;
        this.d = paymentForm;
        this.f24872e = tL_inputInvoiceStarGiftDropOriginalDetails;
        this.f24869a = j3;
