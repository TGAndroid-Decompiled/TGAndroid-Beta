...
public final class l60 implements v80 {
    ...
    @Override
    public final void b() {
        r60 r60Var = this.f28067a.f28393c;
        ...
        if (n2Var instanceof org.telegram.ui.yh0) {
            ...
            org.telegram.ui.xb0 xb0Var = new org.telegram.ui.xb0(1, yh0Var.f43136n);
            xb0Var.T = yh0Var.f43144s0;
            xb0Var.Y(tL_chatInviteExported);
            yh0Var.presentFragment(xb0Var);
        } else {
            org.telegram.ui.xb0 xb0Var2 = new org.telegram.ui.xb0(1, r60Var.f29950g0);
            xb0Var2.Y(r60Var.f29941b);
    ...
    public final void c() {
        ...
        org.telegram.ui.ActionBar.n2 n2Var = r60Var.U;
        if (n2Var instanceof org.telegram.ui.yh0) {
            ((org.telegram.ui.yh0) n2Var).e0(r60Var.f29941b);
        } else {
            TLRPC.TL_messages_editExportedChatInvite tL_messages_editExportedChatInvite = new TLRPC.TL_messages_editExportedChatInvite();
            tL_messages_editExportedChatInvite.link = r60Var.f29941b.link;
            tL_messages_editExportedChatInvite.revoked = true;
            i10 = ((org.telegram.ui.ActionBar.f3) r60Var).currentAccount;
            tL_messages_editExportedChatInvite.peer = MessagesController.getInstance(i10).getInputPeer(-r60Var.f29950g0);
    ...
    public final void j() {
        ...
        org.telegram.ui.ActionBar.n2 n2Var = r60Var.U;
        if (n2Var instanceof org.telegram.ui.yh0) {
            ((org.telegram.ui.yh0) n2Var).b0(r60Var.f29941b);
        } else {
            TLRPC.TL_messages_deleteExportedChatInvite tL_messages_deleteExportedChatInvite = new TLRPC.TL_messages_deleteExportedChatInvite();
            tL_messages_deleteExportedChatInvite.link = r60Var.f29941b.link;
            i10 = ((org.telegram.ui.ActionBar.f3) r60Var).currentAccount;
            tL_messages_deleteExportedChatInvite.peer = MessagesController.getInstance(i10).getInputPeer(-r60Var.f29950g0);
            i11 = ((org.telegram.ui.ActionBar.f3) r60Var).currentAccount;
