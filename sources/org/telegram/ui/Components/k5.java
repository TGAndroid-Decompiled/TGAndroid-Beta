...
public final class k5 {
    public HashMap f25565a;
    public HashMap f25566b;
    public HashSet f25567c;
    public ng d;
    public final int e;
            ...
            synchronized (this) {
                try {
                    ...
                    if (hashMap != null && (document = (TLRPC.Document) hashMap.get(Long.valueOf(j3))) != null) {
                        ...
                        ArrayList arrayList = (ArrayList) this.f25566b.get(Long.valueOf(j3));
                        if (arrayList != null) {
                            arrayList.add(l5Var);
                            return;
                        }
                        ...
                        this.f25566b.put(Long.valueOf(j3), arrayList2);
                        if (this.f25567c == null) {
                            this.f25567c = new HashSet();
                        }
                        this.f25567c.add(Long.valueOf(j3));
                        if (this.d != null) {
                            return;
                        }
        ...
        synchronized (this) {
            try {
                if (this.f25565a == null) {
                    this.f25565a = new HashMap();
                }
                this.f25565a.put(Long.valueOf(document.f18127id), document);
            } catch (Throwable th2) {
                throw th2;
            }
        }
