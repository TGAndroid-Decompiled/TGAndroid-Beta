...
public final class f41 extends FrameLayout implements org.telegram.ui.ActionBar.z5 {
    public final org.telegram.ui.ActionBar.e6 f23806a;
    public boolean f23807b;
    public final c41 f23808c;
    public final TextView d;
    public final FrameLayout.LayoutParams e;
    public final d41 f23809f;
    public boolean h;
    public final ImageView f23810n;
    public int f23811r;
    public final c6 f23812s;

    public f41(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
        this.f23811r = -1;
        this.f23812s = new c6(this, 0L, 320L, qr.h);
        this.f23806a = e6Var;
    ...
    public final void dispatchDraw(Canvas canvas) {
        canvas.save();
        canvas.clipRect(0.0f, 0.0f, getWidth(), this.f23812s.d(this.f23811r, false));
    ...
    public final void e() {
        ...
        org.telegram.ui.ActionBar.e6 e6Var = this.f23806a;
        this.f23808c.setTextColor(org.telegram.ui.ActionBar.i6.v0(i10, e6Var));
        ...
        d41 d41Var = this.f23809f;
        d41Var.setTextColor(v03);
        d41Var.setLinkTextColor(org.telegram.ui.ActionBar.i6.v0(i11, e6Var));
        d41Var.setHighlightColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19157uf, e6Var));
        setHandlesColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19174vf, e6Var));
        ...
        ImageView imageView = this.f23810n;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f23807b) {
            ...
            Paint T0 = org.telegram.ui.ActionBar.i6.T0("paintDivider", this.f23806a);
            if (T0 == null) {
    ...
    public final void onMeasure(int i10, int i11) {
        this.f23811r = getMeasuredHeight();
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824);
        FrameLayout.LayoutParams layoutParams = this.e;
        layoutParams.bottomMargin = 0;
        super.onMeasure(makeMeasureSpec, i11);
        if (this.f23810n.getVisibility() == 0) {
            Layout layout = this.f23809f.getLayout();
        ...
        if (getMeasuredHeight() > this.f23811r && !this.h) {
            this.f23811r = getMeasuredHeight();
            invalidate();
            return;
        }
        int measuredHeight = getMeasuredHeight();
        this.f23811r = measuredHeight;
        this.f23812s.d(measuredHeight, true);
    }
