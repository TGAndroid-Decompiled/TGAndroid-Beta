...
public final class ug extends FrameLayout {
    public final org.telegram.ui.ActionBar.j5 f28391a;
    public final RectF f28392b;
    public final Paint f28393c;
    public final Drawable d;
    public boolean e;

    public ug(Activity activity) {
        super(activity);
        this.f28392b = new RectF();
        this.f28393c = new Paint(1);
        this.e = false;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        this.f28393c.setShader(new LinearGradient(0.0f, 0.0f, getMeasuredWidth(), 0.0f, new int[]{-9071617, -5999873}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP));
    }
}
