...
public class yc0 extends FrameLayout {
    ...
    public final Paint f30172c;
    public final TextPaint d;
    public final o1.k e;
    public float f30173f;
    public final o1.k h;
    public float f30174n;
    public final o1.k f30175r;
    public float f30176s;
    public final float v;
    public final float f30177w;
    public EditText f30178x;
    public boolean f30179y;
    ...
    public yc0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f30175r = new o1.k(this, K);
        float max = Math.max(2, AndroidUtilities.dp(0.5f));
        this.v = max;
        this.f30177w = AndroidUtilities.dp(1.6667f);
        this.G = f6Var;
    ...
    public final void b(float f7, float f10, boolean z10) {
        if (!z10) {
            ...
            this.f30174n = f10;
            if (!this.f30179y) {
                float f11 = this.f30177w;
                float f12 = this.v;
                this.f30172c.setStrokeWidth(((f11 - f12) * f7) + f12);
            }
            f();
            return;
        }
    ...
    public final void e(EditTextBoldCursor editTextBoldCursor) {
        this.f30178x = editTextBoldCursor;
        invalidate();
    }
    ...
    public final void f() {
        ...
        float f10 = 0.0f;
        if (this.f30179y && !this.F) {
            f7 = 0.0f;
        } else {
            f7 = this.f30174n;
        }
        int d = i0.a.d(f7, v02, v03);
        int i11 = org.telegram.ui.ActionBar.j6.f19101q7;
        this.d.setColor(i0.a.d(this.f30176s, d, org.telegram.ui.ActionBar.j6.v0(i11, f6Var)));
        int v04 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18991k6, f6Var);
        int v05 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19009l6, f6Var);
        if (!this.f30179y || this.F) {
            f10 = this.f30173f;
        }
        setColor(i0.a.d(this.f30176s, i0.a.d(f10, v04, v05), org.telegram.ui.ActionBar.j6.v0(i11, f6Var)));
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        EditText editText = this.f30178x;
        if ((editText == null || editText.length() != 0 || !TextUtils.isEmpty(this.f30178x.getHint())) && !this.f30179y && !this.E) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (z10) {
            paddingTop = com.google.android.gms.internal.vision.e2.z(1.0f, this.f30174n, textSize - paddingTop, paddingTop);
        }
        float f13 = paddingTop;
        if (z10) {
            f7 = (1.0f - this.f30174n) * this.H;
        } else {
            f7 = 0.0f;
        }
        Paint paint = this.f30172c;
        float strokeWidth = paint.getStrokeWidth();
        if (z10) {
            f10 = com.google.android.gms.internal.vision.e2.z(1.0f, this.f30174n, 0.25f, 0.75f);
        } else {
            f10 = 0.75f;
        }
        float measureText = textPaint.measureText(this.f30171b) * f10;
        canvas.save();
        RectF rectF = this.f30170a;
        ...
        canvas.drawText(this.f30171b, AndroidUtilities.dp(14.0f) + getPaddingLeft() + f7, f13, textPaint);
        canvas.restore();
    }
