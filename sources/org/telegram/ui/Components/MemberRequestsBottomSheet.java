...
public class MemberRequestsBottomSheet extends UsersAlertBase {
    ...
    public void lambda$onSearchViewTouched$1(EditTextBoldCursor editTextBoldCursor) {
        setFocusable(true);
        editTextBoldCursor.requestFocus();
        AndroidUtilities.runOnUIThread(new TagEditCell$$ExternalSyntheticLambda3(6, editTextBoldCursor));
    }
    ...
    public void onSearchViewTouched(MotionEvent motionEvent, EditTextBoldCursor editTextBoldCursor) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (baseFragment instanceof ChatActivity) {
                ...
                AndroidUtilities.runOnUIThread(new UndoView$$ExternalSyntheticLambda3(4, this, editTextBoldCursor), zNeedEnterText ? 200L : 0L);
            } else {
                this.enterEventSent = true;
                setFocusable(true);
                editTextBoldCursor.requestFocus();
                AndroidUtilities.runOnUIThread(new TagEditCell$$ExternalSyntheticLambda3(5, editTextBoldCursor));
            }
        }
