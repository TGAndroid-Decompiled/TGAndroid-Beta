...
public final class zu implements Runnable {
    ...
    public final void run() {
        ...
        boolean z13;
        boolean z14;
        int i11 = this.f33258a;
        boolean z15 = false;
        boolean z16 = true;
        Object obj = this.f33259b;
        Object obj2 = this.f33260c;
        switch (i11) {
            case 0:
                MessagesController.getInstance(rv.U(((av) obj2).f24485a)).updateEmojiStatus((TLRPC.EmojiStatus) obj);
                return;
            case 1:
                MessagesController.getInstance(((dx) obj2).f25500a.f27959c1).updateEmojiStatus((TLRPC.EmojiStatus) obj);
                return;
            case 2:
                TLObject tLObject = (TLObject) obj;
                kz kzVar = ((dx) obj2).f25500a;
                if (tLObject instanceof TLRPC.TL_messages_stickerSet) {
                    TLRPC.TL_messages_stickerSet tL_messages_stickerSet = (TLRPC.TL_messages_stickerSet) tLObject;
                    MediaDataController.getInstance(kzVar.f27959c1).putStickerSet(tL_messages_stickerSet);
                    MediaDataController.getInstance(kzVar.f27959c1).replaceStickerSet(tL_messages_stickerSet);
                    return;
                }
                return;
            case 3:
                ...
                kz kzVar2 = cyVar.E;
                if (!kzVar2.f27999p1.contains(Long.valueOf(tL_messages_stickerSet2.set.f19923id))) {
                    kzVar2.f27999p1.add(Long.valueOf(tL_messages_stickerSet2.set.f19923id));
                }
                cyVar.a(true);
                return;
            case 4:
                ...
                kz kzVar3 = jyVar.f27611a.F;
                if (!Arrays.equals(kzVar3.W0, currentKeyboardLanguage)) {
                    MediaDataController.getInstance(kzVar3.f27959c1).fetchNewEmojiKeywords(currentKeyboardLanguage);
                }
                ...
                Utilities.doCallbacks(new Utilities.Callback() {
                    ...
                    public final void run(Object obj3) {
                        ...
                        switch (r4) {
                            case 0:
                                jy jyVar2 = jyVar;
                                MediaDataController.getInstance(jyVar2.f27611a.F.f27959c1).searchStickerSets(true, str, new bi.o4(jyVar2, arrayList3, runnable, 5));
                                return;
                            default:
                                kz kzVar4 = jyVar.f27611a.F;
                                if (SharedConfig.suggestAnimatedEmoji || UserConfig.getInstance(kzVar4.f27959c1).isPremium()) {
                                    String translitSafe = AndroidUtilities.translitSafe((str + "").toLowerCase());
                                    int i12 = kzVar4.f27959c1;
                    ...
                    public final void run(Object obj3) {
                        ...
                        switch (r4) {
                            case 0:
                                jy jyVar2 = jyVar;
                                MediaDataController.getInstance(jyVar2.f27611a.F.f27959c1).searchStickerSets(true, str, new bi.o4(jyVar2, arrayList2, runnable, 5));
                                return;
                            default:
                                kz kzVar4 = jyVar.f27611a.F;
                                if (SharedConfig.suggestAnimatedEmoji || UserConfig.getInstance(kzVar4.f27959c1).isPremium()) {
            ...
            case 5:
                ...
                ky kyVar = ((jy) obj2).f27611a;
                kyVar.F.V.e(false);
                ArrayList arrayList5 = kyVar.f27945r;
            ...
            case 7:
                ...
                kz kzVar4 = pyVar.L;
                MessagesController.getInstance(kzVar4.f27959c1).putUsers(tL_contacts_resolvedPeer.users, false);
                int i12 = kzVar4.f27959c1;
            ...
            case 8:
                ...
                vzVar.h(n8Var);
                zz zzVar = vzVar.J;
                zzVar.f33325h1 = n8Var;
                zzVar.j();
                return;
            case 9:
                ((vz) obj2).J.f33320f1 = (yz) obj;
                return;
            case 10:
                ((c10) obj2).f24892z0 = -1;
            ...
            case 12:
                ...
                u40Var.getClass();
                try {
                    LaunchActivity launchActivity = (LaunchActivity) u40Var.f30826a.getParentActivity();
                    if (launchActivity != 0) {
            ...
            case 13:
                ...
                videoEditedInfo2.originalPath = v50Var.f31123a.getAbsolutePath();
                VideoEditedInfo videoEditedInfo3 = w50Var.N;
                videoEditedInfo3.notReadyYet = true;
                videoEditedInfo3.thumb = w50Var.Z0;
                videoEditedInfo3.estimatedDuration = w50Var.f32163f0;
                w50Var.Z0 = null;
                MediaController.PhotoEntry photoEntry = new MediaController.PhotoEntry(0, 0, 0L, v50Var.f31123a.getAbsolutePath(), 0, true, 0, 0, 0L);
                if (q50Var != null) {
                    photoEntry.ttl = q50Var.f29619c;
                    photoEntry.effectId = q50Var.d;
                }
                o50 o50Var = w50Var.f32157c;
                VideoEditedInfo videoEditedInfo4 = w50Var.N;
                if (q50Var != null && !q50Var.f29617a) {
                    z11 = false;
                } else {
                    z11 = true;
                }
            ...
            case 14:
                ...
                v50 v50Var2 = (v50) ((org.telegram.ui.Cells.l7) obj2).f22282b;
            ...
            case 15:
                ...
                if (tLObject2 instanceof Vector) {
                    ...
                    if (!vector.objects.isEmpty()) {
                        r60Var2.f29970c.put(Long.valueOf(r60Var2.f29968b.admin_id), (TLRPC.User) vector.objects.get(0));
                        r60Var2.T.l();
                        return;
                    }
                    return;
            ...
            case 16:
                l60 l60Var = (l60) obj2;
                if (((TLRPC.TL_error) obj) == null && (hbVar = (r60Var = l60Var.f28094a.f28420c).f29980j0) != null) {
                    TLRPC.TL_chatInviteExported tL_chatInviteExported = r60Var.f29968b;
                    org.telegram.ui.ub ubVar = hbVar.f36971a;
                    ArrayList arrayList7 = ubVar.f41067s0;
                    ...
                    if (new MessageObject(org.telegram.ui.ub.L0(ubVar), tL_channelAdminLogEvent, (ArrayList<MessageObject>) ubVar.f41065r0, (HashMap<String, ArrayList<MessageObject>>) ubVar.f41063q0, ubVar.f41066s, ubVar.X, true).contentType >= 0) {
                        ubVar.R0();
            ...
            case 25:
                ...
                ArrayList arrayList9 = dh0Var.f25412a;
                int i14 = dh0Var.f25425x;
                int size3 = arrayList8.size();
                dh0Var.f25425x = size3;
                ...
                while (i15 < size4) {
                    ...
                    if (ah0Var.f24413o && !ah0Var.f24414p) {
                        arrayList8.add(ah0Var);
                    } else if (dh0.j(ah0Var.f24401a, arrayList8) == null) {
                        dh0 dh0Var2 = ah0Var.f24422y;
                        float f7 = dh0Var2.N;
                        RectF rectF = ah0Var.f24403c;
                        RectF rectF2 = ah0Var.f24405f;
                        h90 h90Var = ah0Var.f24416r;
                        if (h90Var != null) {
                            h90Var.a();
                            ah0Var.f24418t = z15;
                            ah0Var.f24417s = z15;
            ...
            case 26:
                ...
                int i17 = ah0Var2.f24401a;
                RectF rectF3 = ah0Var2.d;
                ProfileActivity.Y(((org.telegram.ui.ky0) ch0Var).f38179b, i17, rectF3.left, rectF3.top);
                return;
            case 27:
            ...
            default:
                ...
                ArrayList arrayList11 = fj0Var.f26100r;
                fj0Var.f26099n.addAll(arrayList10);
                ...
                while (i18 < size5) {
                    ...
                    while (true) {
                        if (i19 < arrayList11.size()) {
                            if (MessageObject.getObjectPeerId(((ej0) arrayList11.get(i19)).f25745a) == MessageObject.getObjectPeerId(ej0Var.f25745a)) {
                                if (ej0Var.f25747c > 0) {
                                    ((ej0) arrayList11.get(i19)).f25747c = ej0Var.f25747c;
                                }
                            } else {
                                i19++;
                            }
