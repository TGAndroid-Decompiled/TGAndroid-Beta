...
public final class zu implements Runnable {
    ...
    public final void run() {
        ...
        Object obj2 = this.f33234c;
        switch (i11) {
            case 0:
                MessagesController.getInstance(rv.U(((av) obj2).f24459a)).updateEmojiStatus((TLRPC.EmojiStatus) obj);
                return;
            case 1:
                MessagesController.getInstance(((dx) obj2).f25474a.f27933c1).updateEmojiStatus((TLRPC.EmojiStatus) obj);
                return;
            case 2:
                TLObject tLObject = (TLObject) obj;
                kz kzVar = ((dx) obj2).f25474a;
                if (tLObject instanceof TLRPC.TL_messages_stickerSet) {
                    TLRPC.TL_messages_stickerSet tL_messages_stickerSet = (TLRPC.TL_messages_stickerSet) tLObject;
                    MediaDataController.getInstance(kzVar.f27933c1).putStickerSet(tL_messages_stickerSet);
                    MediaDataController.getInstance(kzVar.f27933c1).replaceStickerSet(tL_messages_stickerSet);
                    return;
                }
                return;
            case 3:
                ...
                cyVar.f25125s.f32768f = true;
                kz kzVar2 = cyVar.E;
                if (!kzVar2.f27973p1.contains(Long.valueOf(tL_messages_stickerSet2.set.f19896id))) {
                    kzVar2.f27973p1.add(Long.valueOf(tL_messages_stickerSet2.set.f19896id));
                }
                cyVar.a(true);
                return;
            case 4:
                ...
                kz kzVar3 = jyVar.f27585a.F;
                if (!Arrays.equals(kzVar3.W0, currentKeyboardLanguage)) {
                    MediaDataController.getInstance(kzVar3.f27933c1).fetchNewEmojiKeywords(currentKeyboardLanguage);
                }
                ...
                Utilities.doCallbacks(new Utilities.Callback() {
                    ...
                    public final void run(Object obj3) {
                        ...
                        switch (r4) {
                            case 0:
                                jy jyVar2 = jyVar;
                                MediaDataController.getInstance(jyVar2.f27585a.F.f27933c1).searchStickerSets(true, str, new bi.o4(jyVar2, arrayList3, runnable, 5));
                                return;
                            default:
                                kz kzVar4 = jyVar.f27585a.F;
                                if (SharedConfig.suggestAnimatedEmoji || UserConfig.getInstance(kzVar4.f27933c1).isPremium()) {
                                    String translitSafe = AndroidUtilities.translitSafe((str + "").toLowerCase());
                                    int i12 = kzVar4.f27933c1;
                    ...
                    public final void run(Object obj3) {
                        ...
                        switch (r4) {
                            case 0:
                                jy jyVar2 = jyVar;
                                MediaDataController.getInstance(jyVar2.f27585a.F.f27933c1).searchStickerSets(true, str, new bi.o4(jyVar2, arrayList2, runnable, 5));
                                return;
                            default:
                                kz kzVar4 = jyVar.f27585a.F;
                                if (SharedConfig.suggestAnimatedEmoji || UserConfig.getInstance(kzVar4.f27933c1).isPremium()) {
            ...
            case 5:
                ...
                ky kyVar = ((jy) obj2).f27585a;
                kyVar.F.V.e(false);
                ArrayList arrayList5 = kyVar.f27919r;
            ...
            case 7:
                ...
                kz kzVar4 = pyVar.L;
                MessagesController.getInstance(kzVar4.f27933c1).putUsers(tL_contacts_resolvedPeer.users, false);
                int i12 = kzVar4.f27933c1;
            ...
            case 8:
                ...
                vzVar.h(n8Var);
                zz zzVar = vzVar.J;
                zzVar.f33299h1 = n8Var;
                zzVar.j();
                return;
            case 9:
                ((vz) obj2).J.f33294f1 = (yz) obj;
                return;
            case 10:
                ((c10) obj2).f24866z0 = -1;
            ...
            case 12:
                ...
                u40Var.getClass();
                try {
                    LaunchActivity launchActivity = (LaunchActivity) u40Var.f30800a.getParentActivity();
                    if (launchActivity != 0) {
            ...
            case 13:
                ...
                videoEditedInfo2.originalPath = v50Var.f31097a.getAbsolutePath();
                VideoEditedInfo videoEditedInfo3 = w50Var.N;
                videoEditedInfo3.notReadyYet = true;
                videoEditedInfo3.thumb = w50Var.Z0;
                videoEditedInfo3.estimatedDuration = w50Var.f32137f0;
                w50Var.Z0 = null;
                MediaController.PhotoEntry photoEntry = new MediaController.PhotoEntry(0, 0, 0L, v50Var.f31097a.getAbsolutePath(), 0, true, 0, 0, 0L);
                if (q50Var != null) {
                    photoEntry.ttl = q50Var.f29593c;
                    photoEntry.effectId = q50Var.d;
                }
                o50 o50Var = w50Var.f32131c;
                VideoEditedInfo videoEditedInfo4 = w50Var.N;
                if (q50Var != null && !q50Var.f29591a) {
                    z11 = false;
                } else {
                    z11 = true;
                }
            ...
            case 14:
                ...
                v50 v50Var2 = (v50) ((org.telegram.ui.Cells.l7) obj2).f22256b;
            ...
            case 15:
                ...
                if (tLObject2 instanceof Vector) {
                    ...
                    if (!vector.objects.isEmpty()) {
                        r60Var2.f29944c.put(Long.valueOf(r60Var2.f29942b.admin_id), (TLRPC.User) vector.objects.get(0));
                        r60Var2.T.l();
                        return;
                    }
                    return;
            ...
            case 16:
                l60 l60Var = (l60) obj2;
                if (((TLRPC.TL_error) obj) == null && (hbVar = (r60Var = l60Var.f28068a.f28394c).f29954j0) != null) {
                    TLRPC.TL_chatInviteExported tL_chatInviteExported = r60Var.f29942b;
                    org.telegram.ui.ub ubVar = hbVar.f36945a;
                    ArrayList arrayList7 = ubVar.f41041s0;
                    ...
                    if (new MessageObject(org.telegram.ui.ub.L0(ubVar), tL_channelAdminLogEvent, (ArrayList<MessageObject>) ubVar.f41039r0, (HashMap<String, ArrayList<MessageObject>>) ubVar.f41037q0, ubVar.f41040s, ubVar.X, true).contentType >= 0) {
                        ubVar.R0();
            ...
            case 25:
                ...
                ArrayList arrayList9 = dh0Var.f25386a;
                int i14 = dh0Var.f25399x;
                int size3 = arrayList8.size();
                dh0Var.f25399x = size3;
                ...
                while (i15 < size4) {
                    ...
                    if (ah0Var.f24387o && !ah0Var.f24388p) {
                        arrayList8.add(ah0Var);
                    } else if (dh0.j(ah0Var.f24375a, arrayList8) == null) {
                        dh0 dh0Var2 = ah0Var.f24396y;
                        float f7 = dh0Var2.N;
                        RectF rectF = ah0Var.f24377c;
                        RectF rectF2 = ah0Var.f24379f;
                        h90 h90Var = ah0Var.f24390r;
                        if (h90Var != null) {
                            h90Var.a();
                            ah0Var.f24392t = z15;
                            ah0Var.f24391s = z15;
            ...
            case 26:
                ...
                int i17 = ah0Var2.f24375a;
                RectF rectF3 = ah0Var2.d;
                ProfileActivity.Y(((org.telegram.ui.ky0) ch0Var).f38153b, i17, rectF3.left, rectF3.top);
                return;
            case 27:
            ...
            default:
                ...
                ArrayList arrayList11 = fj0Var.f26074r;
                fj0Var.f26073n.addAll(arrayList10);
                ...
                while (i18 < size5) {
                    ...
                    while (true) {
                        if (i19 < arrayList11.size()) {
                            if (MessageObject.getObjectPeerId(((ej0) arrayList11.get(i19)).f25719a) == MessageObject.getObjectPeerId(ej0Var.f25719a)) {
                                if (ej0Var.f25721c > 0) {
                                    ((ej0) arrayList11.get(i19)).f25721c = ej0Var.f25721c;
                                }
                            } else {
                                i19++;
                            }
