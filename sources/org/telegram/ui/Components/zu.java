...
public final class zu implements Runnable {
    ...
    public final void run() {
        ...
        Object obj2 = this.f33261c;
        switch (i11) {
            case 0:
                MessagesController.getInstance(rv.U(((av) obj2).f24486a)).updateEmojiStatus((TLRPC.EmojiStatus) obj);
                return;
            case 1:
                MessagesController.getInstance(((dx) obj2).f25501a.f27960c1).updateEmojiStatus((TLRPC.EmojiStatus) obj);
                return;
            case 2:
                TLObject tLObject = (TLObject) obj;
                kz kzVar = ((dx) obj2).f25501a;
                if (tLObject instanceof TLRPC.TL_messages_stickerSet) {
                    TLRPC.TL_messages_stickerSet tL_messages_stickerSet = (TLRPC.TL_messages_stickerSet) tLObject;
                    MediaDataController.getInstance(kzVar.f27960c1).putStickerSet(tL_messages_stickerSet);
                    MediaDataController.getInstance(kzVar.f27960c1).replaceStickerSet(tL_messages_stickerSet);
                    return;
                }
                return;
            case 3:
                ...
                cyVar.f25152s.f32795f = true;
                kz kzVar2 = cyVar.E;
                if (!kzVar2.f28000p1.contains(Long.valueOf(tL_messages_stickerSet2.set.f19923id))) {
                    kzVar2.f28000p1.add(Long.valueOf(tL_messages_stickerSet2.set.f19923id));
                }
                cyVar.a(true);
                return;
            case 4:
                ...
                kz kzVar3 = jyVar.f27612a.F;
                if (!Arrays.equals(kzVar3.W0, currentKeyboardLanguage)) {
                    MediaDataController.getInstance(kzVar3.f27960c1).fetchNewEmojiKeywords(currentKeyboardLanguage);
                }
                ...
                Utilities.doCallbacks(new Utilities.Callback() {
                    ...
                    public final void run(Object obj3) {
                        ...
                        switch (r4) {
                            case 0:
                                jy jyVar2 = jyVar;
                                MediaDataController.getInstance(jyVar2.f27612a.F.f27960c1).searchStickerSets(true, str, new bi.o4(jyVar2, arrayList3, runnable, 5));
                                return;
                            default:
                                kz kzVar4 = jyVar.f27612a.F;
                                if (SharedConfig.suggestAnimatedEmoji || UserConfig.getInstance(kzVar4.f27960c1).isPremium()) {
                                    String translitSafe = AndroidUtilities.translitSafe((str + "").toLowerCase());
                                    int i12 = kzVar4.f27960c1;
                                    ...
                                    if (stickerSets != null) {
                                        for (int i13 = 0; i13 < stickerSets.size(); i13++) {
                                            ...
                                            if (tL_messages_stickerSet3 != null && (stickerSet2 = tL_messages_stickerSet3.set) != null && stickerSet2.title != null && (arrayList5 = tL_messages_stickerSet3.documents) != null && !arrayList5.isEmpty() && !hashSet.contains(Long.valueOf(tL_messages_stickerSet3.set.f19923id))) {
                    ...
                    public final void run(Object obj3) {
                        ...
                        switch (r4) {
                            case 0:
                                jy jyVar2 = jyVar;
                                MediaDataController.getInstance(jyVar2.f27612a.F.f27960c1).searchStickerSets(true, str, new bi.o4(jyVar2, arrayList2, runnable, 5));
                                return;
                            default:
                                kz kzVar4 = jyVar.f27612a.F;
                                if (SharedConfig.suggestAnimatedEmoji || UserConfig.getInstance(kzVar4.f27960c1).isPremium()) {
            ...
            case 5:
                ...
                ky kyVar = ((jy) obj2).f27612a;
                kyVar.F.V.e(false);
                ArrayList arrayList5 = kyVar.f27946r;
            ...
            case 7:
                ...
                kz kzVar4 = pyVar.L;
                MessagesController.getInstance(kzVar4.f27960c1).putUsers(tL_contacts_resolvedPeer.users, false);
                int i12 = kzVar4.f27960c1;
            ...
            case 8:
                ...
                vzVar.h(n8Var);
                zz zzVar = vzVar.J;
                zzVar.f33326h1 = n8Var;
                zzVar.j();
                return;
            case 9:
                ((vz) obj2).J.f33321f1 = (yz) obj;
                return;
            case 10:
                ((c10) obj2).f24893z0 = -1;
            ...
            case 12:
                ...
                u40Var.getClass();
                try {
                    LaunchActivity launchActivity = (LaunchActivity) u40Var.f30827a.getParentActivity();
                    if (launchActivity != 0) {
            ...
            case 13:
                ...
                videoEditedInfo2.originalPath = v50Var.f31124a.getAbsolutePath();
                VideoEditedInfo videoEditedInfo3 = w50Var.N;
                videoEditedInfo3.notReadyYet = true;
                videoEditedInfo3.thumb = w50Var.Z0;
                videoEditedInfo3.estimatedDuration = w50Var.f32164f0;
                w50Var.Z0 = null;
                MediaController.PhotoEntry photoEntry = new MediaController.PhotoEntry(0, 0, 0L, v50Var.f31124a.getAbsolutePath(), 0, true, 0, 0, 0L);
                if (q50Var != null) {
                    photoEntry.ttl = q50Var.f29620c;
                    photoEntry.effectId = q50Var.d;
                }
                o50 o50Var = w50Var.f32158c;
                VideoEditedInfo videoEditedInfo4 = w50Var.N;
                if (q50Var != null && !q50Var.f29618a) {
                    z11 = false;
                } else {
                    z11 = true;
                }
            ...
            case 14:
                ...
                v50 v50Var2 = (v50) ((org.telegram.ui.Cells.l7) obj2).f22283b;
            ...
            case 15:
                ...
                if (tLObject2 instanceof Vector) {
                    ...
                    if (!vector.objects.isEmpty()) {
                        r60Var2.f29971c.put(Long.valueOf(r60Var2.f29969b.admin_id), (TLRPC.User) vector.objects.get(0));
                        r60Var2.T.l();
                        return;
                    }
                    return;
            ...
            case 16:
                l60 l60Var = (l60) obj2;
                if (((TLRPC.TL_error) obj) == null && (hbVar = (r60Var = l60Var.f28095a.f28421c).f29981j0) != null) {
                    TLRPC.TL_chatInviteExported tL_chatInviteExported = r60Var.f29969b;
                    org.telegram.ui.ub ubVar = hbVar.f36972a;
                    ArrayList arrayList7 = ubVar.f41068s0;
                    ...
                    if (new MessageObject(org.telegram.ui.ub.L0(ubVar), tL_channelAdminLogEvent, (ArrayList<MessageObject>) ubVar.f41066r0, (HashMap<String, ArrayList<MessageObject>>) ubVar.f41064q0, ubVar.f41067s, ubVar.X, true).contentType >= 0) {
                        ubVar.R0();
            ...
            case 23:
                ...
                g0Var.getClass();
                runnable.run();
                ((HashMap) g0Var.f14604b).remove(runnable);
                return;
            case 24:
                yg0 yg0Var = (yg0) obj2;
            ...
            case 25:
                ...
                ArrayList arrayList9 = dh0Var.f25413a;
                int i14 = dh0Var.f25426x;
                int size3 = arrayList8.size();
                dh0Var.f25426x = size3;
                ...
                while (i15 < size4) {
                    ...
                    if (ah0Var.f24414o && !ah0Var.f24415p) {
                        arrayList8.add(ah0Var);
                    } else if (dh0.j(ah0Var.f24402a, arrayList8) == null) {
                        dh0 dh0Var2 = ah0Var.f24423y;
                        float f7 = dh0Var2.N;
                        RectF rectF = ah0Var.f24404c;
                        RectF rectF2 = ah0Var.f24406f;
                        h90 h90Var = ah0Var.f24417r;
                        if (h90Var != null) {
                            h90Var.a();
                            ah0Var.f24419t = z15;
                            ah0Var.f24418s = z15;
            ...
            case 26:
                ...
                int i17 = ah0Var2.f24402a;
                RectF rectF3 = ah0Var2.d;
                ProfileActivity.Y(((org.telegram.ui.ky0) ch0Var).f38180b, i17, rectF3.left, rectF3.top);
                return;
            case 27:
            ...
            default:
                ...
                ArrayList arrayList11 = fj0Var.f26101r;
                fj0Var.f26100n.addAll(arrayList10);
                ...
                while (i18 < size5) {
                    ...
                    while (true) {
                        if (i19 < arrayList11.size()) {
                            if (MessageObject.getObjectPeerId(((ej0) arrayList11.get(i19)).f25746a) == MessageObject.getObjectPeerId(ej0Var.f25746a)) {
                                if (ej0Var.f25748c > 0) {
                                    ((ej0) arrayList11.get(i19)).f25748c = ej0Var.f25748c;
                                }
                            } else {
                                i19++;
                            }
