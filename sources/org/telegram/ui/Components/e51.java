...
public final class e51 extends ll0 {
    ...
    public int f23495w;
    public final f51 f23496x;
    public final SparseArray d = new SparseArray();
    public final ArrayList e = new ArrayList();
    public final SparseArray f23491f = new SparseArray();
    public final HashMap h = new HashMap();
    public final ArrayList f23492n = new ArrayList();
    public int v = 5;
    ...
    public final void E(View view, int i10, boolean z10) {
        ...
        boolean z16;
        boolean z17;
        f51 f51Var = this.f23496x;
        LongSparseArray longSparseArray = f51Var.e;
        LongSparseArray longSparseArray2 = f51Var.d;
        TLRPC.StickerSetCovered[] stickerSetCoveredArr = f51Var.f23783c;
        int i11 = f51Var.f23781a;
        MediaDataController mediaDataController = MediaDataController.getInstance(i11);
        int i12 = this.f23495w;
    ...
    public final void G() {
        ...
        SparseArray sparseArray = this.d;
        sparseArray.clear();
        SparseArray sparseArray2 = this.f23491f;
        sparseArray2.clear();
        ...
        arrayList.clear();
        this.f23495w = 0;
        MediaDataController mediaDataController = MediaDataController.getInstance(f51Var.f23781a);
        ArrayList arrayList2 = new ArrayList(mediaDataController.getFeaturedStickerSets());
        int size = arrayList2.size();
        arrayList2.addAll(this.f23492n);
        int i11 = 0;
        int i12 = 0;
        while (true) {
            int i13 = 1;
            ...
            if (!stickerSetCovered.covers.isEmpty() || stickerSetCovered.cover != null) {
                if (i11 == size) {
                    int i14 = this.f23495w;
                    this.f23495w = i14 + 1;
                    sparseArray.put(i14, -1);
                }
                arrayList.add(stickerSetCovered);
                sparseArray2.put(this.f23495w, stickerSetCovered);
                hashMap.put(stickerSetCovered, Integer.valueOf(this.f23495w));
                int i15 = this.f23495w;
                this.f23495w = i15 + 1;
                int i16 = i12 + 1;
                ...
                if (!stickerSetCovered.covers.isEmpty()) {
                    ...
                    for (int i17 = 0; i17 < stickerSetCovered.covers.size(); i17++) {
                        sparseArray.put(this.f23495w + i17, stickerSetCovered.covers.get(i17));
                    }
                } else {
                    sparseArray.put(this.f23495w, stickerSetCovered.cover);
                }
                int i18 = 0;
                while (true) {
                    i10 = this.v * i13;
                    ...
                    sparseArray2.put(this.f23495w + i18, stickerSetCovered);
                    i18++;
                }
                this.f23495w = i10 + this.f23495w;
                i12 = i16;
            }
            i11++;
        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        ((org.telegram.ui.Cells.f8) view).d((TLRPC.Document) this.d.get(i10), null, this.f23491f.get(i10), null, false, false);
    }
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 != 2) {
                                    ...
                                    public final void onClick(View view) {
                                        switch (r2) {
                                            ...
                                            default:
                                                ...
                                                e51 e51Var2 = this.f23215b;
                                                f51 f51Var3 = e51Var2.f23496x;
                    ...
                    org.telegram.ui.Cells.r3 r3Var = new org.telegram.ui.Cells.r3(17, this.f23490c, f51Var.P, true, true);
