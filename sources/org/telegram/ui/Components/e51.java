...
public final class e51 extends bw0 {
    ...
    public boolean D0;
    public final f51 E0;
    public final Paint f23788w0;
    public boolean f23789x0;
    public boolean f23790y0;
    public boolean f23791z0;
    ...
    public final float Z() {
        f51 f51Var = this.E0;
        return Math.min(1.0f, Math.max(0.0f, f51Var.f24023f / (f51Var.f24021b * 2.0f)));
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        f51 f51Var = this.E0;
        t51 t51Var = f51Var.e;
        int i12 = f51Var.f24021b;
        GradientDrawable gradientDrawable = f51Var.f24022c;
        float Z = Z();
        boolean z13 = false;
        ...
        if (this.D0 != z11) {
            this.D0 = z11;
            if (AndroidUtilities.computePerceivedBrightness(f51Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19133h5)) > 0.721f) {
                z12 = true;
            } else {
                z12 = false;
            }
            if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v(f51Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19340s8), 855638016)) > 0.721f) {
                z13 = true;
            }
            if (!z11) {
                z12 = z13;
        ...
        if (this.B0 > 0.0f) {
            int themedColor2 = f51Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19133h5);
            Paint paint = this.f23788w0;
            paint.setColor(themedColor2);
            int max = (int) Math.max(0.0f, t51Var.getTranslationY() + (AndroidUtilities.statusBarHeight - i12) + ((1.0f - Z()) * i12) + f51Var.f24023f + AndroidUtilities.dp(24.0f));
            i10 = ((org.telegram.ui.ActionBar.f3) f51Var).backgroundPaddingLeft;
        ...
        gradientDrawable.setColor(i0.a.k(f51Var.getThemedColor(org.telegram.ui.ActionBar.j6.Ii), (int) (Color.alpha(themedColor) * Z)));
        gradientDrawable.setBounds((getWidth() - dp) / 2, org.telegram.messenger.q.D(10.0f, f51Var.f24023f, i13), (getWidth() + dp) / 2, AndroidUtilities.dp(10.0f) + f51Var.f24023f + i13 + dp2);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (Z > 0.0f && Z < 1.0f) {
            ...
            gradientDrawable.setColor(f51Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19133h5));
            float[] fArr = this.C0;
            fArr[3] = dp;
            fArr[2] = dp;
            fArr[1] = dp;
            ...
            int width = getWidth();
            i13 = ((org.telegram.ui.ActionBar.f3) f51Var).backgroundPaddingLeft;
            gradientDrawable.setBounds(i12, f51Var.f24023f + i15, width - i13, AndroidUtilities.dp(24.0f) + f51Var.f24023f + i15);
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            f51 f51Var = this.E0;
            if (f51Var.f24023f != 0 && motionEvent.getY() < f51Var.f24023f) {
                f51Var.dismiss();
                return true;
            }
        }
