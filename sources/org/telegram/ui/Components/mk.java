...
public final class mk implements ViewTreeObserver.OnPreDrawListener {
    ...
    public final MessageObject f26171b;
    ...
    public final boolean onPreDraw() {
        switch (this.f26170a) {
            case 0:
                ...
                ok okVar = nkVar.X;
                boolean s10 = okVar.f26462b.X0.s();
                boolean z10 = this.f26172c;
                if (s10) {
                    MessageObject messageObject = this.f26171b;
            ...
            case 1:
                ...
                org.telegram.ui.x10 x10Var = ((org.telegram.ui.q10) this.e).f36729c;
                boolean g10 = x10Var.f39456o0.g();
                boolean z11 = this.f26172c;
                if (g10) {
                    org.telegram.ui.p10 p10Var2 = x10Var.S;
                    MessageObject messageObject2 = this.f26171b;
                    int id3 = messageObject2.getId();
                    p10Var2.f36388a = messageObject2.getDialogId();
                    p10Var2.f36389b = id3;
                    r2Var.V(x10Var.f39456o0.c(x10Var.S), z11);
                    return true;
                }
                r2Var.V(false, z11);
                return true;
            case 2:
                ...
                boolean g11 = x10Var2.f39456o0.g();
                boolean z12 = this.f26172c;
                if (g11) {
                    org.telegram.ui.p10 p10Var3 = x10Var2.S;
                    MessageObject messageObject3 = this.f26171b;
                    int id4 = messageObject3.getId();
                    p10Var3.f36388a = messageObject3.getDialogId();
                    p10Var3.f36389b = id4;
                    j7Var2.b(x10Var2.f39456o0.c(x10Var2.S), z12);
                    return true;
                }
                j7Var2.b(false, z12);
                return true;
            case 3:
                ...
                boolean g12 = x10Var3.f39456o0.g();
                boolean z13 = this.f26172c;
                if (g12) {
                    org.telegram.ui.p10 p10Var4 = x10Var3.S;
                    MessageObject messageObject4 = this.f26171b;
                    int id5 = messageObject4.getId();
                    p10Var4.f36388a = messageObject4.getDialogId();
                    p10Var4.f36389b = id5;
                    i7Var.e(x10Var3.f39456o0.c(x10Var3.S), z13);
                    return true;
                }
                i7Var.e(false, z13);
                return true;
            default:
                ...
                boolean g13 = x10Var4.f39456o0.g();
                boolean z14 = this.f26172c;
                if (g13) {
                    org.telegram.ui.p10 p10Var5 = x10Var4.S;
                    MessageObject messageObject5 = this.f26171b;
                    int id6 = messageObject5.getId();
                    p10Var5.f36388a = messageObject5.getDialogId();
                    p10Var5.f36389b = id6;
                    n7Var.f(x10Var4.f39456o0.c(x10Var4.S), z14);
                    return true;
                }
                n7Var.f(false, z14);
                return true;
