...
public final class xe extends ImageView {
    ...
    public final void setTranslationX(float f7) {
        ...
        this.f29900a = f7;
        float f11 = -44.0f;
        float dp = AndroidUtilities.dp(-44.0f) + this.f29900a;
        ChatActivityEnterView chatActivityEnterView = this.f29901b;
        float f12 = dp + chatActivityEnterView.f21878y + chatActivityEnterView.f21872x;
        ...
        ze zeVar3 = chatActivityEnterView.f21868w1;
        float dp3 = AndroidUtilities.dp((zeVar3 == null || zeVar3.getVisibility() != 0) ? 0.0f : 0.0f);
        ze zeVar4 = chatActivityEnterView.f21868w1;
        if (zeVar4 != null) {
            f13 = zeVar4.getAlpha();
        }
