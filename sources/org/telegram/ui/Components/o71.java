...
public abstract class o71 extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public long f26658a0;
    public b6 f26659b;
    public int f26660b0;
    public long f26661c;
    public int f26662c0;
    public Uri d;
    public ArrayList f26663d0;
    public Runnable e;
    public TLRPC.Document f26664e0;
    public m71 f26665f;
    public String f26666f0;
    public int f26667g0;
    public float h;
    public int f26668n;
    public int f26669r;
    ...
    public Bitmap v;
    public Bitmap f26671w;
    public final Drawable f26672x;
    ...
    public o71(Context context, org.telegram.ui.sr0 sr0Var) {
        ...
        this.f26667g0 = -1;
        setVisibility(4);
        this.f26672x = context.getResources().getDrawable(R.drawable.videopreview);
    ...
    public final void a() {
        ...
        if (this.f26665f != null) {
            Utilities.globalQueue.cancelRunnable(this.f26665f);
            this.f26665f = null;
        }
        b6 b6Var = this.f26659b;
        if (b6Var != null) {
            AnimatedFileDrawableStream animatedFileDrawableStream = b6Var.f22609u0;
            if (animatedFileDrawableStream != null) {
                animatedFileDrawableStream.cancel(true);
            }
            if (b6Var.f22589d0 != null) {
                b6Var.f22589d0.h();
            }
        }
    ...
    public final void b(int i10) {
        int i11 = this.f26667g0;
        if (i11 == i10) {
            return;
        }
        if (i10 == -1) {
            NotificationCenter.getInstance(i11).removeObserver(this, NotificationCenter.fileLoaded);
            NotificationCenter.getInstance(this.f26667g0).removeObserver(this, NotificationCenter.fileLoadFailed);
        } else {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.fileLoaded) {
            if (((String) objArr[0]).equals(this.f26666f0)) {
                File pathToAttach = FileLoader.getInstance(i11).getPathToAttach(this.f26664e0);
        ...
        } else if (i10 == NotificationCenter.fileLoadFailed && ((String) objArr[0]).equals(this.f26666f0)) {
            this.f26666f0 = null;
            this.f26664e0 = null;
            b(-1);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Drawable drawable = this.f26672x;
        if (z10) {
            canvas.save();
            Path path = this.V;
            path.rewind();
            ...
            canvas.drawText(this.f26673y, (getMeasuredWidth() - this.E) / 2.0f, getMeasuredHeight() - AndroidUtilities.dp(9.0f), textPaint);
        } else if (this.f26671w != null && this.G != null) {
            Matrix matrix = this.L;
            matrix.reset();
            float measuredWidth = getMeasuredWidth() / this.f26671w.getWidth();
