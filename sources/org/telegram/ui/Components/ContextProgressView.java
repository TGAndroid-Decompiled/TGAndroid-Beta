...
public class ContextProgressView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        this.cicleRect.set(measuredWidth, measuredHeight, AndroidUtilities.dp(18.0f) + measuredWidth, AndroidUtilities.dp(18.0f) + measuredHeight);
    ...
    public void updateColors() {
        int i = this.innerKey;
        if (i >= 0) {
            this.innerPaint.setColor(Theme.getColor(null, i, false));
        } else {
            this.innerPaint.setColor(this.innerColor);
        }
        int i2 = this.outerKey;
        if (i2 >= 0) {
            this.outerPaint.setColor(Theme.getColor(null, i2, false));
        } else {
