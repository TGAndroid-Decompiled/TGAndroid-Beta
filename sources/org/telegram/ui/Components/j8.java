...
public final class j8 extends kl0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        if (this.f27404n.f27768v0 && c1Var.b() == 0) {
            return false;
        }
        return true;
    }
    ...
    public final void E(String str) {
        if (this.f27403f != null) {
            Utilities.searchQueue.cancelRunnable(this.f27403f);
            this.f27403f = null;
        }
        if (str == null) {
            this.f27402e = null;
    ...
    public final int h() {
        int size;
        k8 k8Var = this.f27404n;
        boolean z10 = k8Var.f27768v0;
        if (k8Var.f27749f) {
            size = this.d.size();
        } else if (k8Var.f27772x0.size() > 1) {
            size = k8Var.f27772x0.size();
        } else {
            return 0;
        }
        return size + (z10 ? 1 : 0);
    ...
    public final int j(int i10) {
        if (this.f27404n.f27768v0 && i10 == 0) {
            return 1;
        }
        return 0;
    }
    ...
    public final void l() {
        ...
        super.l();
        k8 k8Var = this.f27404n;
        View view = k8Var.f27747e;
        q7 q7Var = k8Var.E;
        v7 v7Var = k8Var.f27757n;
        int i10 = 0;
        if (k8Var.f27772x0.size() > 1) {
            z10 = true;
        } else {
            z10 = false;
        }
            ...
            if (z11) {
                ...
                v7Var.animate().translationY(0.0f).setUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        ...
                        switch (r2) {
                            case 0:
                                viewGroup = ((org.telegram.ui.ActionBar.f3) this.f26347b.f27404n).containerView;
                                viewGroup.invalidate();
                                return;
                            default:
                                viewGroup2 = ((org.telegram.ui.ActionBar.f3) this.f26347b.f27404n).containerView;
        ...
        k8Var.v.setVisibility((k8Var.h && k8Var.f27764s.h() == 0) ? 8 : 8);
        k8Var.E0();
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        f6Var = ((org.telegram.ui.ActionBar.f3) this.f27404n).resourcesProvider;
