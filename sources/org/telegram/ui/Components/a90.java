...
public final class a90 {
    public View f24334a;
    public org.telegram.ui.Cells.b1 f24335b;
    public final ArrayList f24336c = new ArrayList();
    public int d = 0;
    ...
    public final void a(e90 e90Var, Object obj) {
        this.f24336c.add(new Pair(e90Var, obj));
        this.d++;
        h(obj, true);
    }

    public final void b(h90 h90Var, Object obj) {
        this.f24337e.add(new Pair(h90Var, obj));
        this.f24338f++;
        h(obj, true);
    }
    ...
    public final void d(boolean z10) {
        if (z10) {
            ...
            while (true) {
                int i12 = this.d;
                ArrayList arrayList = this.f24336c;
                if (i11 < i12) {
    ...
    public final void e() {
        for (int i10 = 0; i10 < this.f24338f; i10++) {
            m(i10, true);
        }
    }
    ...
    public final boolean f(Canvas canvas) {
        int i10 = 0;
        boolean z10 = false;
        while (i10 < this.f24338f) {
            ((h90) ((Pair) this.f24337e.get(i10)).first).draw(canvas);
            i10++;
            z10 = true;
        }
        for (int i11 = 0; i11 < this.d; i11++) {
            if (!((e90) ((Pair) this.f24336c.get(i11)).first).a(canvas) && !z10) {
                z10 = false;
            } else {
                z10 = true;
            }
    ...
    public final boolean g(Canvas canvas, Object obj) {
        ...
        for (int i11 = 0; i11 < this.d; i11++) {
            ArrayList arrayList2 = this.f24336c;
    ...
    public final void h(Object obj, boolean z10) {
        ...
        if (obj instanceof View) {
            ...
            if (!b3Var.f34639c && (view2 = b3Var.f34638b) != null) {
                view2.invalidate();
            }
        } else if (z10 && (view = this.f24334a) != null) {
            view.invalidate();
        }
        org.telegram.ui.Cells.b1 b1Var = this.f24335b;
        if (b1Var != null) {
            b1Var.run();
        }
    }
    ...
    public final void j(int i10) {
        if (i10 >= 0 && i10 < this.d) {
            Pair pair = (Pair) this.f24336c.get(i10);
            e90 e90Var = (e90) pair.first;
            if (e90Var.f25657p < 0) {
                e90Var.f25657p = Math.max(e90Var.f25656o + e90Var.f25658q, SystemClock.elapsedRealtime());
                h(pair.second, true);
                AndroidUtilities.runOnUIThread(new z80(this, e90Var, 1), Math.max(0L, (e90Var.f25657p - SystemClock.elapsedRealtime()) + 175));
            }
        }
    }
            ...
            if (pair != null) {
                if (z10) {
                    if (e90Var.f25657p < 0) {
                        e90Var.f25657p = Math.max(e90Var.f25656o + e90Var.f25658q, SystemClock.elapsedRealtime());
                        h(pair.second, true);
                        AndroidUtilities.runOnUIThread(new z80(this, e90Var, 0), Math.max(0L, (e90Var.f25657p - SystemClock.elapsedRealtime()) + 175));
                        return;
                    }
                    return;
                }
    ...
    public final void l(h90 h90Var, boolean z10) {
        if (h90Var != null) {
            for (int i10 = 0; i10 < this.f24338f; i10++) {
                if (((Pair) this.f24337e.get(i10)).first == h90Var) {
                    m(i10, z10);
                    return;
                }
            }
            ...
            if (pair != null) {
                ...
                if (z10) {
                    if (!h90Var.b()) {
                        ...
                        long j3 = 0;
                        if (h90Var.f26700c > 0) {
                            j3 = 320 - (SystemClock.elapsedRealtime() - h90Var.f26700c);
                        }
