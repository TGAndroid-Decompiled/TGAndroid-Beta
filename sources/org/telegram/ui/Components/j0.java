...
public final class j0 extends Drawable {
    public final Drawable f27292a;
    public final Drawable f27293b;
    public final e6 f27294c = new e6(new i0(this, 0), 1200, pr.h, 0);

    public j0(Context context) {
        this.f27292a = context.getResources().getDrawable(R.drawable.input_ai).mutate();
        this.f27293b = context.getResources().getDrawable(R.drawable.input_ai_star).mutate();
    }

    @Override
    public final void draw(Canvas canvas) {
        Rect bounds = getBounds();
        Drawable drawable = this.f27292a;
        drawable.setBounds(bounds);
        drawable.draw(canvas);
        float d = this.f27294c.d(1.0f, false);
        ...
        Drawable drawable2 = this.f27293b;
    ...
    public final int getIntrinsicHeight() {
        return this.f27292a.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f27292a.getIntrinsicWidth();
    }
    ...
    public final void setAlpha(int i10) {
        this.f27292a.setAlpha(i10);
        this.f27293b.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f27292a.setColorFilter(colorFilter);
        this.f27293b.setColorFilter(colorFilter);
    }
}
