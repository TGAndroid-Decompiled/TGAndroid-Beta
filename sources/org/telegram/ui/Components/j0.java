...
public final class j0 extends Drawable {
    public final Drawable f27291a;
    public final Drawable f27292b;
    public final e6 f27293c = new e6(new i0(this, 0), 1200, pr.h, 0);

    public j0(Context context) {
        this.f27291a = context.getResources().getDrawable(R.drawable.input_ai).mutate();
        this.f27292b = context.getResources().getDrawable(R.drawable.input_ai_star).mutate();
    }

    @Override
    public final void draw(Canvas canvas) {
        Rect bounds = getBounds();
        Drawable drawable = this.f27291a;
        drawable.setBounds(bounds);
        drawable.draw(canvas);
        float d = this.f27293c.d(1.0f, false);
        ...
        Drawable drawable2 = this.f27292b;
    ...
    public final int getIntrinsicHeight() {
        return this.f27291a.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f27291a.getIntrinsicWidth();
    }
    ...
    public final void setAlpha(int i10) {
        this.f27291a.setAlpha(i10);
        this.f27292b.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f27291a.setColorFilter(colorFilter);
        this.f27292b.setColorFilter(colorFilter);
    }
}
