...
public final class j0 extends Drawable {
    public final Drawable f27925a;
    public final Drawable f27926b;
    public final z5 f27927c = new z5(new i0(this, 0), 1200, pr.h, 0);

    public j0(Context context) {
        this.f27925a = context.getResources().getDrawable(R.drawable.input_ai).mutate();
        this.f27926b = context.getResources().getDrawable(R.drawable.input_ai_star).mutate();
    }

    @Override
    public final void draw(Canvas canvas) {
        Rect bounds = getBounds();
        Drawable drawable = this.f27925a;
        drawable.setBounds(bounds);
        drawable.draw(canvas);
        float d = this.f27927c.d(1.0f, false);
        ...
        Drawable drawable2 = this.f27926b;
    ...
    public final int getIntrinsicHeight() {
        return this.f27925a.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f27925a.getIntrinsicWidth();
    }
    ...
    public final void setAlpha(int i10) {
        this.f27925a.setAlpha(i10);
        this.f27926b.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f27925a.setColorFilter(colorFilter);
        this.f27926b.setColorFilter(colorFilter);
    }
}
