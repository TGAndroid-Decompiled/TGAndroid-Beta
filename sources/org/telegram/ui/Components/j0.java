...
public final class j0 implements org.telegram.ui.ActionBar.a2 {
    ...
    public final void f(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        switch (this.f25095a) {
            ...
            case 2:
                nf.f.s(this.f25096b, BuildVars.PLAYSTORE_APP_URL);
                return;
            default:
                Context context3 = this.f25096b;
                if (context3 != null) {
                    try {
