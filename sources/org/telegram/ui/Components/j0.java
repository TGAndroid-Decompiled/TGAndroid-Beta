...
public final class j0 extends Drawable {
    public final Drawable f27939a;
    public final Drawable f27940b;
    public final z5 f27941c = new z5(new i0(this, 0), 1200, pr.h, 0);

    public j0(Context context) {
        this.f27939a = context.getResources().getDrawable(R.drawable.input_ai).mutate();
        this.f27940b = context.getResources().getDrawable(R.drawable.input_ai_star).mutate();
    }

    @Override
    public final void draw(Canvas canvas) {
        Rect bounds = getBounds();
        Drawable drawable = this.f27939a;
        drawable.setBounds(bounds);
        drawable.draw(canvas);
        float d = this.f27941c.d(1.0f, false);
        ...
        Drawable drawable2 = this.f27940b;
    ...
    public final int getIntrinsicHeight() {
        return this.f27939a.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f27939a.getIntrinsicWidth();
    }
    ...
    public final void setAlpha(int i10) {
        this.f27939a.setAlpha(i10);
        this.f27940b.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f27939a.setColorFilter(colorFilter);
        this.f27940b.setColorFilter(colorFilter);
    }
}
