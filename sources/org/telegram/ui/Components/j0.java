...
public final class j0 extends Drawable {
    ...
    public final Drawable f25800b;
    public final z5 f25801c = new z5(new i0(this, 0), 1200, mr.h, 0);

    public j0(Context context) {
        this.f25799a = context.getResources().getDrawable(R.drawable.input_ai).mutate();
        this.f25800b = context.getResources().getDrawable(R.drawable.input_ai_star).mutate();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        float d = this.f25801c.d(1.0f, false);
        ...
        Drawable drawable2 = this.f25800b;
    ...
    public final int getIntrinsicHeight() {
        return this.f25799a.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f25799a.getIntrinsicWidth();
    }
    ...
    public final void setAlpha(int i10) {
        this.f25799a.setAlpha(i10);
        this.f25800b.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f25799a.setColorFilter(colorFilter);
        this.f25800b.setColorFilter(colorFilter);
    }
}
