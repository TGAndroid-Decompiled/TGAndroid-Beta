...
public final class j0 extends Drawable {
    public final Drawable f27318a;
    public final Drawable f27319b;
    public final e6 f27320c = new e6(new i0(this, 0), 1200, pr.h, 0);

    public j0(Context context) {
        this.f27318a = context.getResources().getDrawable(R.drawable.input_ai).mutate();
        this.f27319b = context.getResources().getDrawable(R.drawable.input_ai_star).mutate();
    }

    @Override
    public final void draw(Canvas canvas) {
        Rect bounds = getBounds();
        Drawable drawable = this.f27318a;
        drawable.setBounds(bounds);
        drawable.draw(canvas);
        float d = this.f27320c.d(1.0f, false);
        ...
        Drawable drawable2 = this.f27319b;
    ...
    public final int getIntrinsicHeight() {
        return this.f27318a.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f27318a.getIntrinsicWidth();
    }
    ...
    public final void setAlpha(int i10) {
        this.f27318a.setAlpha(i10);
        this.f27319b.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f27318a.setColorFilter(colorFilter);
        this.f27319b.setColorFilter(colorFilter);
    }
}
