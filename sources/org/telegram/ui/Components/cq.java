...
public final class cq extends q6 {
    public final Rect f25103s;
    public Drawable v;
    public boolean f25104w;

    public cq(Context context) {
        super(context, false, false, false);
        this.f25103s = new Rect();
    }
    ...
    public final void onDraw(Canvas canvas) {
        if (this.v != null) {
            ...
            Rect rect = this.f25103s;
            rect.set(bounds);
            int ceil = (int) Math.ceil(getDrawable().d());
            if (getDrawable().f29313b == 3) {
                rect.right = rect.left + ceil;
            } else if (getDrawable().f29313b == 5) {
                rect.left = rect.right - ceil;
            } else if (getDrawable().f29313b == 17) {
