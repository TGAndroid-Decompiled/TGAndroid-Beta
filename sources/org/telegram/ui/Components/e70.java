...
public final class e70 extends vl0 {
    ...
    public final TLObject E(int i10) {
        int i11;
        int i12;
        k70 k70Var = this.f23803c;
        if (k70Var.m0 != null) {
            TLRPC.Dialog dialog = (TLRPC.Dialog) k70Var.f25612n0.get(i10 - k70Var.Y);
            if (DialogObject.isUserDialog(dialog.f18300id)) {
                i12 = ((org.telegram.ui.ActionBar.f3) k70Var).currentAccount;
                return MessagesController.getInstance(i12).getUser(Long.valueOf(dialog.f18300id));
            }
            i11 = ((org.telegram.ui.ActionBar.f3) k70Var).currentAccount;
            return MessagesController.getInstance(i11).getChat(Long.valueOf(-dialog.f18300id));
        }
        return (TLObject) k70Var.f25604e0.get(i10 - k70Var.Y);
    }

    @Override
    public final int h() {
        return this.f23803c.f25602c0;
    }
    ...
    public final int j(int i10) {
        ...
        if (i10 == k70Var.f25601b0) {
            return 4;
        }
        if (i10 == k70Var.f25600a0) {
            return 5;
        }
        return 0;
    }
        ...
        if (i11 != 2) {
            if (i11 == 3) {
                ...
                if (E instanceof TLRPC.User) {
                    j10 = ((TLRPC.User) E).f18443id;
                } else if (E instanceof TLRPC.Chat) {
                    j10 = -((TLRPC.Chat) E).f18296id;
                } else {
                    j10 = 0;
                }
                if (j10 != 0) {
            ...
            if (i10 != 3) {
                if (i10 != 4) {
                    if (i10 != 5) {
                        ...
                        int i11 = org.telegram.ui.ActionBar.j6.f19246n5;
                        y4Var2.a(i11, i11);
                        y4Var = y4Var2;
                    } else {
