...
public final class oi implements Utilities.Callback2 {
    ...
    public final wi f27572b;
    public final MessagesController f27573c;
    public final int d;

    public oi(wi wiVar, MessagesController messagesController, int i10, int i11) {
        this.f27571a = i11;
        this.f27572b = wiVar;
        this.f27573c = messagesController;
        this.d = i10;
    }
    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (this.f27571a) {
            case 0:
                ...
                wi wiVar = this.f27572b;
                wiVar.f30280b0 = -1;
                wiVar.f30289k0 = false;
                if (messages_botresults != null) {
                    this.f27573c.putUsers(messages_botresults.users, false);
                    ...
                    while (i10 < size) {
                        ...
                        if (botInlineResult2 instanceof TLRPC.TL_botInlineMediaResult) {
                            ...
                            if (tL_botInlineMediaResult.document != null) {
                                ...
                                tL_message.out = true;
                                int i11 = wiVar.f30288j0;
                                wiVar.f30288j0 = i11 - 1;
                    ...
                    wiVar.f30287i0 = messages_botresults.next_offset;
                    wiVar.f30283e0 = !TextUtils.isEmpty(str);
                    wiVar.P();
                    return;
                }
                return;
            default:
                ...
                if (messages_messages != null) {
                    ...
                    MessagesController messagesController = this.f27573c;
