...
public final class ap implements ti {
    public final vi f24459a;
    public final TL_stories.TL_premium_boostsStatus f24460b;
    public final org.telegram.ui.ActionBar.f6 f24461c;
    public final org.telegram.ui.g d;
    public final long f24462e;
    public final org.telegram.ui.t3 f24463f;
    ...
    public ap(vi viVar, TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus, org.telegram.ui.ActionBar.f6 f6Var, org.telegram.ui.g gVar, long j3, org.telegram.ui.t3 t3Var, org.telegram.ui.bd bdVar) {
        this.f24459a = viVar;
        this.f24460b = tL_premium_boostsStatus;
        this.f24461c = f6Var;
        this.d = gVar;
        this.f24462e = j3;
        this.f24463f = t3Var;
    ...
    public final void K(Object obj) {
        ...
        zoVar.V1 = this.f24460b;
        zoVar.f41942a.f41926a = this.f24461c;
        zoVar.f41986p1 = this.d;
        zoVar.c1(this.f24462e);
        zoVar.I1 = new yo(this.f24459a, this.f24463f, 1);
        ?? obj2 = new Object();
        obj2.f21170a = true;
        obj2.f21173e = true;
        ...
        try {
            ...
            if (!selectedPhotos.isEmpty()) {
                ...
                if (str != null) {
                    ...
                    zoVar.f41982n1 = 0.2f;
                    zoVar.c1(this.f24462e);
                    zoVar.I1 = new yo(viVar, this.f24463f, 0);
                    ?? obj = new Object();
                    obj.f21170a = true;
                    obj.f21173e = true;
