...
public final class ap implements ti {
    public final vi f24431a;
    public final TL_stories.TL_premium_boostsStatus f24432b;
    public final org.telegram.ui.ActionBar.f6 f24433c;
    public final org.telegram.ui.g d;
    public final long f24434e;
    public final org.telegram.ui.t3 f24435f;
    ...
    public ap(vi viVar, TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus, org.telegram.ui.ActionBar.f6 f6Var, org.telegram.ui.g gVar, long j3, org.telegram.ui.t3 t3Var, org.telegram.ui.bd bdVar) {
        this.f24431a = viVar;
        this.f24432b = tL_premium_boostsStatus;
        this.f24433c = f6Var;
        this.d = gVar;
        this.f24434e = j3;
        this.f24435f = t3Var;
    ...
    public final void K(Object obj) {
        ...
        zoVar.V1 = this.f24432b;
        zoVar.f41914a.f41898a = this.f24433c;
        zoVar.f41958p1 = this.d;
        zoVar.c1(this.f24434e);
        zoVar.I1 = new yo(this.f24431a, this.f24435f, 1);
        ?? obj2 = new Object();
        obj2.f21142a = true;
        obj2.f21145e = true;
        ...
        try {
            ...
            if (!selectedPhotos.isEmpty()) {
                ...
                if (str != null) {
                    ...
                    zoVar.f41954n1 = 0.2f;
                    zoVar.c1(this.f24434e);
                    zoVar.I1 = new yo(viVar, this.f24435f, 0);
                    ?? obj = new Object();
                    obj.f21142a = true;
                    obj.f21145e = true;
