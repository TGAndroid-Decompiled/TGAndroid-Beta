...
public abstract class ou0 extends qt0 {
    public final HashSet f26889f3;
    public final ArrayList f26890g3;
    public final ArrayList f26891h3;
    public final ArrayList f26892i3;
    public TextPaint j3;
    public StaticLayout f26893k3;
    public float f26894l3;
    public float f26895m3;
    public ai.rc f26896n3;
    public int f26897o3;
    public final ArrayList f26898p3;

    public ou0(Context context) {
        super(context, null);
        this.f26889f3 = new HashSet();
        this.f26890g3 = new ArrayList();
        this.f26891h3 = new ArrayList();
        this.f26892i3 = new ArrayList();
        this.f26898p3 = new ArrayList();
    }
