...
public final class ou0 implements org.telegram.ui.Cells.l1 {
    ...
    public final org.telegram.ui.ActionBar.d6 f27191b;
    public final qu0 f27192c;
    ...
    public static TLRPC.TL_message a(TLRPC.Message message) {
        ...
        tL_message.f18342id = message.f18342id;
    ...
    public final void P0(int i10, org.telegram.ui.Cells.u1 u1Var) {
        if (i10 == 80) {
            org.telegram.ui.ActionBar.m2 m2Var = this.f27192c.f27763s.f25543v1;
    ...
    public final void j(org.telegram.ui.Cells.u1 u1Var, ArrayList arrayList, int i10, int i11, int i12) {
        SendMessagesHelper.getInstance(this.f27190a).sendVote(u1Var.getMessageObject(), arrayList, null);
    }
    ...
    public final void n(org.telegram.ui.Cells.u1 u1Var, TLRPC.PollAnswer pollAnswer, TLRPC.MessageMedia messageMedia, int i10) {
        ...
        jv0 jv0Var = this.f27192c.f27763s;
        MessageObject messageObject = u1Var.getMessageObject();
        TLRPC.MessageMedia media = MessageObject.getMedia(messageObject);
        if (messageMedia != null && messageObject != null && (media instanceof TLRPC.TL_messageMediaPoll)) {
            TLRPC.TL_messageMediaPoll tL_messageMediaPoll = (TLRPC.TL_messageMediaPoll) media;
            TLRPC.GeoPoint geoPoint = messageMedia.geo;
            org.telegram.ui.ActionBar.d6 d6Var = this.f27191b;
            int i14 = this.f27190a;
            if (geoPoint != null) {
                if (AndroidUtilities.isMapsInstalled(jv0Var.f25543v1)) {
                    org.telegram.ui.cd0 cd0Var = new org.telegram.ui.cd0(3);
                    cd0Var.setResourceProvider(d6Var);
                    TLRPC.TL_message tL_message = new TLRPC.TL_message();
                    tL_message.local_id = -1;
                    tL_message.peer_id = MessagesController.getInstance(i14).getPeer(jv0Var.f25518j1);
                    ...
                    jv0Var.f25543v1.presentFragment(cd0Var);
                }
            } else if (MessageObject.isAnyKindOfStickerOrEmoji(messageMedia.document)) {
                org.telegram.ui.nt.q().w(jv0Var.f25543v1.getParentActivity());
                ...
                q6.t(document4, null, "", null, null, i13, false, u1Var.getMessageObject(), this.f27191b, 200);
            } else {
                ...
                if (i11 > -1 && !arrayList2.isEmpty()) {
                    ...
                    PhotoViewer.t1().J2(null, jv0Var.f25543v1, d6Var);
                    PhotoViewer.t1().a2(arrayList2, i11, jv0Var.f25518j1, 0L, 0L, new nu0(this));
                }
            }
        }
    }
