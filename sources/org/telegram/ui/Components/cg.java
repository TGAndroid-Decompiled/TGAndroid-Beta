...
public final class cg implements Runnable {
    public final MessageObject f25002a;
    public final long f25003b;
    public final TL_keyboard.KeyboardButtonProto f25004c;
    public final MessageObject d;
    public final TLRPC.User f25005e;
    public final ChatActivityEnterView f25006f;
    ...
    public cg(ChatActivityEnterView chatActivityEnterView, MessageObject messageObject, long j3, TL_keyboard.KeyboardButtonProto keyboardButtonProto, MessageObject messageObject2, TLRPC.User user) {
        this.f25006f = chatActivityEnterView;
        this.f25002a = messageObject;
        this.f25003b = j3;
        this.f25004c = keyboardButtonProto;
    ...
    public final void run() {
        ...
        ChatActivityEnterView chatActivityEnterView = this.f25006f;
        ...
        if (chatActivityEnterView.l1.R() <= AndroidUtilities.dp(20.0f) && !chatActivityEnterView.t0()) {
            if (coVar != null) {
                ...
                long j3 = this.f25002a.messageOwner.dialog_id;
                TL_keyboard.KeyboardButtonProto keyboardButtonProto = this.f25004c;
                ...
                fi.f5 b10 = fi.f5.b(i11, j3, this.f25003b, text, url, c10 ? 1 : 0, i10, N8, null, false, null, null, 0, false, false);
