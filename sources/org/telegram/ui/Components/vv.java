...
public final class vv extends LinearLayout {
    public final a0.i f29398a;
    public final Paint f29399b;
    public final RectF f29400c;
    public final RectF d;
    public final RectF e;
    public final Path f29401f;
    public final boolean h;
    public final boolean f29402n;
    public final dw f29403r;
    ...
    public vv(dw dwVar, Context context, boolean z10, boolean z11) {
        ...
        this.h = z10;
        this.f29402n = z11;
        this.f29398a = new a0.i();
        this.f29399b = new Paint(1);
        this.f29400c = new RectF();
        this.d = new RectF();
        this.e = new RectF();
        this.f29401f = new Path();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (dwVar.f23475s == null) {
            dwVar.f23475s = new e6(this, 350L, rr.h);
        }
        e6 e6Var = dwVar.f23475s;
        float f11 = 0.0f;
        if (dwVar.f23474r) {
            f7 = 1.0f;
        } else {
        ...
        Path path = this.f29401f;
        path.rewind();
        boolean z11 = this.f29402n;
        if (z11) {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (view == this.f29403r.G) {
            canvas.save();
            canvas.clipPath(this.f29401f);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
            ...
            while (true) {
                ...
                if (childAt != zvVar && !dwVar.H.containsKey(childAt) && childAt != null) {
                    ...
                    if (z11) {
                        ...
                        Long l10 = zvVar2.f30660a;
                        if (l10 == null) {
                            xx xxVar = zvVar2.v;
                            if (xxVar != null && (stickerSet = xxVar.f30088b) != null) {
                                l4 = Long.valueOf(stickerSet.f18110id);
                            } else {
                                l10 = zvVar2.f30665r;
                                if (l10 == null) {
                                    TLRPC.Document document = zvVar2.f30666s;
                                    if (document != null) {
                                        l4 = Long.valueOf(document.f18089id);
                                    }
                                }
                            }
                        }
                    ...
                    if ((childAt != dwVar.f23478y || dwVar.W) && (childAt != dwVar.E || dwVar.f23470b0)) {
                        paddingLeft = org.telegram.messenger.z0.C(3.0f, childAt.getMeasuredWidth(), paddingLeft);
                    }
                }
                i15++;
            }
            if (zvVar != null) {
                Long l11 = zvVar.f30660a;
        ...
        int childCount2 = (getChildCount() - (!dwVar.W ? 1 : 0)) - (!dwVar.f23470b0 ? 1 : 0);
        int A = (int) (org.telegram.messenger.ul.A(30.0f, childCount2, ((i12 - i10) - getPaddingLeft()) - getPaddingRight()) / Math.max(1, childCount2 - 1));
        int paddingLeft2 = getPaddingLeft();
        for (int i17 = 0; i17 < childCount2; i17++) {
            View childAt2 = getChildAt((!dwVar.W ? 1 : 0) + (!dwVar.f23470b0 ? 1 : 0) + i17);
            if (childAt2 != null) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        dw dwVar = this.f29403r;
        float f10 = 0.0f;
        if (!dwVar.W && (zvVar2 = dwVar.f23478y) != null) {
            f7 = zvVar2.getAlpha() * AndroidUtilities.dp(33.0f);
        } else {
            f7 = 0.0f;
        }
        int i13 = paddingRight - ((int) f7);
        if (!dwVar.f23470b0 && (zvVar = dwVar.E) != null) {
