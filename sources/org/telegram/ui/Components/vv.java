...
public final class vv extends LinearLayout {
    public final a0.i f29842a;
    public final Paint f29843b;
    public final RectF f29844c;
    public final RectF d;
    public final RectF e;
    public final Path f29845f;
    public final boolean h;
    public final boolean f29846n;
    public final dw f29847r;
    ...
    public vv(dw dwVar, Context context, boolean z10, boolean z11) {
        ...
        this.h = z10;
        this.f29846n = z11;
        this.f29842a = new a0.i();
        this.f29843b = new Paint(1);
        this.f29844c = new RectF();
        this.d = new RectF();
        this.e = new RectF();
        this.f29845f = new Path();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (dwVar.f23656s == null) {
            dwVar.f23656s = new d6(this, 350L, qr.h);
        }
        d6 d6Var = dwVar.f23656s;
        float f11 = 0.0f;
        if (dwVar.f23655r) {
            f7 = 1.0f;
        } else {
        ...
        Path path = this.f29845f;
        path.rewind();
        boolean z11 = this.f29846n;
        if (z11) {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (view == this.f29847r.G) {
            canvas.save();
            canvas.clipPath(this.f29845f);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
            ...
            while (true) {
                ...
                if (childAt != zvVar && !dwVar.H.containsKey(childAt) && childAt != null) {
                    ...
                    if (z11) {
                        ...
                        Long l10 = zvVar2.f30940a;
                        if (l10 == null) {
                            xx xxVar = zvVar2.v;
                            if (xxVar != null && (stickerSet = xxVar.f30372b) != null) {
                                l4 = Long.valueOf(stickerSet.f18355id);
                            } else {
                                l10 = zvVar2.f30945r;
                                if (l10 == null) {
                                    TLRPC.Document document = zvVar2.f30946s;
                                    if (document != null) {
                                        l4 = Long.valueOf(document.f18334id);
                                    }
                                }
                            }
                        }
                    ...
                    if ((childAt != dwVar.f23659y || dwVar.W) && (childAt != dwVar.E || dwVar.f23651b0)) {
        ...
        int childCount2 = (getChildCount() - (!dwVar.W ? 1 : 0)) - (!dwVar.f23651b0 ? 1 : 0);
        ...
        for (int i17 = 0; i17 < childCount2; i17++) {
            View childAt2 = getChildAt((!dwVar.W ? 1 : 0) + (!dwVar.f23651b0 ? 1 : 0) + i17);
            if (childAt2 != null) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        dw dwVar = this.f29847r;
        float f10 = 0.0f;
        if (!dwVar.W && (zvVar2 = dwVar.f23659y) != null) {
            f7 = zvVar2.getAlpha() * AndroidUtilities.dp(33.0f);
        } else {
            f7 = 0.0f;
        }
        int i13 = paddingRight - ((int) f7);
        if (!dwVar.f23651b0 && (zvVar = dwVar.E) != null) {
