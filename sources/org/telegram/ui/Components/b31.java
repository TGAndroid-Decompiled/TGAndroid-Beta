...
public final class b31 extends u61 {
    public final org.telegram.ui.l20 f22826f3;
    public final d6 f22827g3;
    public final d6 f22828h3;
    public final RectF f22829i3;
    public final Paint j3;
    public final d6 f22830k3;
    public Drawable f22831l3;
    public int f22832m3;
    public final Paint f22833n3;
    public final n31 f22834o3;
    ...
    public b31(n31 n31Var, Context context, int i10, a31 a31Var, s21 s21Var, s21 s21Var2, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f22834o3 = n31Var;
        this.f22826f3 = new org.telegram.ui.l20();
        qr qrVar = qr.h;
        this.f22827g3 = new d6(this, 320L, qrVar);
        this.f22828h3 = new d6(this, 320L, qrVar);
        this.f22829i3 = new RectF();
        this.j3 = new Paint(1);
        this.f22830k3 = new d6(this, 420L, qrVar);
        this.f22833n3 = new Paint(1);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f12;
        int i10;
        float e = this.f22827g3.e(canScrollHorizontally(-1));
        float e7 = this.f22828h3.e(canScrollHorizontally(1));
        ...
        if (f13 > width) {
            ...
            if (this.f22831l3 == null) {
                this.f22831l3 = getContext().getResources().getDrawable(R.drawable.msg_limit_pin).mutate();
            }
            int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19075b9, f6Var);
            if (this.f22832m3 != v02) {
                Drawable drawable = this.f22831l3;
                this.f22832m3 = v02;
                drawable.setColorFilter(new PorterDuffColorFilter(v02, PorterDuff.Mode.SRC_IN));
            }
            this.f22831l3.setBounds((int) (AndroidUtilities.dp(-17.0f) + f13), (int) (rectF.top + AndroidUtilities.dp(10.0f)), (int) (f13 + AndroidUtilities.dp(-7.0f)), (int) (rectF.top + AndroidUtilities.dp(20.0f)));
            this.f22831l3.draw(canvas2);
        } else {
            f7 = 14.0f;
            f10 = 1.0f;
        }
        super.dispatchDraw(canvas);
        n31 n31Var = this.f22834o3;
        long j3 = n31Var.H;
        long j10 = n31Var.V;
        d6 d6Var = this.f22830k3;
        if (j3 != j10) {
            n31Var.I = j3;
            d6Var.d(0.0f, true);
        }
        ...
        if (z10) {
            canvas2.save();
            org.telegram.ui.l20 l20Var = this.f22826f3;
            if (i14 > 0) {
