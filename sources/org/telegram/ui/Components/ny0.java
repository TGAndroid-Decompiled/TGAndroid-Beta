...
public class ny0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public float f26614a0;
    public final org.telegram.ui.ActionBar.e6 f26615b;
    public c6 f26616b0;
    public ly0 f26617c;
    public c6 f26618c0;
    public ai.f0 d;
    ...
    public ny0(Context context, int i10, org.telegram.ui.mk mkVar, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
        this.h = 0;
        this.f26621n = AndroidUtilities.dp(10.0f);
        this.L = 0L;
        this.f26613a = i10;
        this.f26617c = mkVar;
        this.f26615b = e6Var;
    ...
    public static boolean a(ny0 ny0Var, j jVar, MotionEvent motionEvent) {
        return org.telegram.ui.st.q().s(motionEvent, ny0Var.e, jVar, ny0Var.getPreviewDelegate(), ny0Var.f26615b);
    }

    public org.telegram.ui.qt getPreviewDelegate() {
        if (this.f26622r == null) {
            this.f26622r = new iy0(this);
        }
        return this.f26622r;
    }
    ...
    public final void c() {
        if (this.e == null) {
            ...
            this.f26616b0 = new c6(this.d, 200L, qrVar);
            this.f26618c0 = new c6(this.d, 350L, qrVar);
            this.f26619d0 = new c6(this.d, 350L, qrVar);
            ...
            this.e.setSelectorDrawableColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18923i6, this.f26615b));
            jy0 jy0Var2 = this.e;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.newEmojiSuggestionsAvailable) {
            ArrayList arrayList = this.f26624w;
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        float f7 = this.f26619d0.f22951c;
        float f10 = this.f26618c0.f22951c;
        ...
        if (this.f26623s && rectF.contains(motionEvent.getX(), motionEvent.getY())) {
            return super.dispatchTouchEvent(motionEvent);
        }
    ...
    public final void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f26613a).addObserver(this, NotificationCenter.newEmojiSuggestionsAvailable);
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        NotificationCenter.getInstance(this.f26613a).removeObserver(this, NotificationCenter.newEmojiSuggestionsAvailable);
    }
