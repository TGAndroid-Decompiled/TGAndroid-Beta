...
public abstract class ny0 extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public RectF f26824a;
    public my0[] f26825b;
    public float[] f26826c;
    public float[] d;
    public float[] e;
    public float f26827f;
    public ImageReceiver h;
    public Long f26828n;
    public o6 f26829r;
    public o6 f26830s;
    public CharSequence v;
    public TextPaint f26831w;
    public StaticLayout f26832x;
    public int f26833y;
    ...
    public final long a() {
        ...
        long j3 = 0;
        for (int i10 = 0; i10 < this.f26825b.length; i10++) {
            long f7 = this.F.f(i10);
            my0 my0Var = this.f26825b[i10];
            if (my0Var != null && (my0Var.f26594c || f7 > 0)) {
                if (f7 <= 0) {
                    f7 = my0Var.e;
                }
                j3 += f7;
    ...
    public final void c(boolean z10) {
        ...
        for (int i11 = 0; i11 < my0VarArr.length; i11++) {
            ...
            if (my0Var2 != null && (my0Var2.f26594c || f12 > 0)) {
                this.f26833y++;
            }
            if (my0Var2 != null && ((z11 = my0Var2.f26594c) || f12 > 0)) {
        ...
        if (!z10) {
            System.arraycopy(this.d, 0, this.f26826c, 0, my0VarArr.length);
            return;
        }
        System.arraycopy(this.f26826c, 0, this.e, 0, my0VarArr.length);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f10;
        int i11;
        o6 o6Var = this.f26830s;
        ImageReceiver imageReceiver = this.h;
        o6 o6Var2 = this.f26829r;
        ...
        if (this.f26825b != null) {
            ...
            while (true) {
                ...
                if (my0Var != null) {
                    float f18 = this.f26826c[i12];
                    if (f18 != 0.0f) {
                        if (my0Var.d) {
                            float z12 = com.google.android.gms.internal.vision.e2.z(f11, this.f26827f, 10.0f, f18 * (-360.0f));
                            if (z12 > 0.0f) {
                                z12 = 0.0f;
                            }
                            my0Var.f26593b.setColor(org.telegram.ui.ActionBar.h6.w0(null, my0Var.f26592a, z11));
                            this.f26825b[i12].f26593b.setAlpha(255);
                            double width = rectF.width() / 2.0f;
                            i11 = i12;
                            if (Math.abs((float) (((3.141592653589793d * width) / 180.0d) * z12)) <= f11) {
                                double d = (-90.0f) - (360.0f * f17);
                                canvas.drawPoint(rectF.centerX() + ((float) (Math.cos(Math.toRadians(d)) * width)), rectF.centerY() + ((float) (Math.sin(Math.toRadians(d)) * width)), this.f26825b[i11].f26593b);
                            } else {
                                this.f26825b[i11].f26593b.setStyle(Paint.Style.STROKE);
                                canvas.drawArc(rectF, (-90.0f) - (360.0f * f17), z12, false, this.f26825b[i11].f26593b);
                            }
                        } else {
                            i11 = i12;
                        }
            ...
            float f19 = 0.0f;
            while (true) {
                my0[] my0VarArr2 = this.f26825b;
                if (i13 >= my0VarArr2.length) {
                    break;
                }
                my0 my0Var2 = my0VarArr2[i13];
                if (my0Var2 != null) {
                    float f20 = this.f26826c[i13];
                    if (f20 != 0.0f) {
                        if (!my0Var2.d) {
                            float z13 = com.google.android.gms.internal.vision.e2.z(1.0f, this.f26827f, f7, f20 * (-360.0f));
                            if (z13 > 0.0f) {
                                z13 = 0.0f;
                            }
                            my0Var2.f26593b.setColor(org.telegram.ui.ActionBar.h6.w0(null, my0Var2.f26592a, false));
                            this.f26825b[i13].f26593b.setAlpha(i10);
                            double width2 = rectF.width() / 2.0f;
                            f10 = f20;
                            if (Math.abs((float) (z13 * ((width2 * 3.141592653589793d) / 180.0d))) <= 1.0f) {
                                double d10 = (-90.0f) - (f19 * 360.0f);
                                canvas.drawPoint(rectF.centerX() + ((float) (Math.cos(Math.toRadians(d10)) * width2)), rectF.centerY() + ((float) (Math.sin(Math.toRadians(d10)) * width2)), this.f26825b[i13].f26593b);
                            } else {
                                this.f26825b[i13].f26593b.setStyle(Paint.Style.STROKE);
                                canvas.drawArc(rectF, (-90.0f) - (f19 * 360.0f), z13, false, this.f26825b[i13].f26593b);
                                f19 += f10;
                                i13++;
                                i10 = 255;
                                f7 = 10.0f;
            ...
            if (this.f26832x != null) {
                canvas.save();
                canvas.translate(AndroidUtilities.dp(30.0f), AndroidUtilities.dp(148.0f) - ((this.f26832x.getHeight() - AndroidUtilities.dp(13.0f)) / 2.0f));
                this.f26831w.setColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19165j5, false));
                this.f26832x.draw(canvas);
                canvas.restore();
            }
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (l4 != null) {
            ...
            int textSize = (int) o6Var2.f26928a.getTextSize();
            int textSize2 = (int) o6Var.f26928a.getTextSize();
        ...
        if (this.v != null) {
            if (this.f26831w == null) {
                this.f26831w = new TextPaint(1);
            }
            this.f26831w.setTextSize(AndroidUtilities.dp(13.0f));
            int size = View.MeasureSpec.getSize(i10) - AndroidUtilities.dp(60.0f);
            CharSequence charSequence = this.v;
            TextPaint textPaint = this.f26831w;
            Layout.Alignment alignment = Layout.Alignment.ALIGN_CENTER;
            TextUtils.TruncateAt truncateAt = TextUtils.TruncateAt.END;
            this.f26832x = uw0.d(charSequence, textPaint, size, false, size, 1);
        }
        if (imageReceiver != null) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        Long l4;
        ImageReceiver imageReceiver = this.h;
        if (imageReceiver != null && (l4 = this.f26828n) != null && l4.longValue() != Long.MAX_VALUE && motionEvent.getX() > imageReceiver.getImageX() && motionEvent.getX() <= imageReceiver.getImageX2() && motionEvent.getY() > imageReceiver.getImageY() && motionEvent.getY() <= imageReceiver.getImageY2()) {
            z10 = true;
        } else {
            z10 = false;
        }
