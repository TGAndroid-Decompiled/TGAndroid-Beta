...
public class hj0 extends jj0 {
    ...
    public hj0(String str, int i10, int i11) {
        super(i10, i11);
        String str2;
        this.Z0 = -1;
        this.J = 1;
    ...
    public int B(Bitmap bitmap, boolean z10) {
        ...
        if (i10 == 1) {
            ...
            if (this.X0) {
                this.f25422a0 = this.f24813a1 - 1;
            }
        } else {
            rLottieNative = this.m0;
        }
        if (rLottieNative.c(this.f25422a0, bitmap, z10) < 0) {
            return 2;
        }
        return 1;
    }
    ...
    public void i() {
        ...
        if (i10 == 1) {
            ...
            int i13 = this.f25422a0 + 1;
            if (i13 < this.f24813a1) {
                this.f25422a0 = i13;
                return;
            }
            this.N = true;
