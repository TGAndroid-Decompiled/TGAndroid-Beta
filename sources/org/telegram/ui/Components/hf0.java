...
public final class hf0 extends FrameLayout {
    ...
    public float h;
    public float f23618n;
    public RectF f23619r;
    public float f23620s;
    public float v;
    public float f23621w;
    public float f23622x;
    ...
    private PointF getActualCenterPoint() {
        ...
        float f11 = tv0Var.f27499a;
        return new PointF(width, (this.e.y * f11) + org.telegram.messenger.a2.y(f11, f10, 2.0f, A));
    }

    private float getActualInnerRadius() {
        tv0 tv0Var = this.d;
        return Math.min(tv0Var.f27499a, tv0Var.f27500b) * this.f23617f;
    }

    private float getActualOuterRadius() {
        tv0 tv0Var = this.d;
        return Math.min(tv0Var.f27499a, tv0Var.f27500b) * this.h;
    }
    ...
    public final void c(int i10, MotionEvent motionEvent) {
        ...
        tv0 tv0Var = this.d;
        float min = Math.min(tv0Var.f27499a, tv0Var.f27500b);
        float f12 = this.f23617f * min;
        float f13 = this.h * min;
        float abs = (float) Math.abs((Math.sin(a(this.f23618n) + 1.5707963267948966d) * f11) + (Math.cos(a(this.f23618n) + 1.5707963267948966d) * f10));
        float f14 = 0.0f;
        if (i10 != 1) {
            if (i10 != 2) {
            ...
            if (i14 == 0) {
                ...
                if (c10 != 1) {
                    if (c10 != 2) {
                        if (c10 != 3) {
                            if (c10 == 5) {
                                ...
                                this.f23618n = (((((float) Math.sqrt((f16 * f16) + (f15 * f15))) * ((i13 * 2) - 1)) / 3.1415927f) / 1.15f) + this.f23618n;
                                this.f23620s = x10;
                                this.v = y3;
                            }
                        } else {
                            this.h = Math.max(this.f23617f + 0.02f, (this.f23616c + (abs - this.f23615b)) / min);
                        }
                    } else {
                        this.f23617f = Math.min(Math.max(0.1f, (this.f23616c + (abs - this.f23615b)) / min), this.h - 0.02f);
                    }
                } else {
                    float f17 = x10 - this.f23620s;
                    float f18 = y3 - this.v;
                    float width = (getWidth() - tv0Var.f27499a) / 2.0f;
                    if (!z13) {
                    ...
                    float height = getHeight();
                    float f19 = tv0Var.f27500b;
                    float A = com.google.android.gms.internal.vision.e2.A(height, f19, 2.0f, i12);
                    PointF pointF = new PointF(Math.max(width, Math.min(tv0Var.f27499a + width, this.f23614a.x + f17)), Math.max(A, Math.min(f19 + A, this.f23614a.y + f18)));
                    float f20 = pointF.x - width;
                    float f21 = tv0Var.f27499a;
                    this.e = new PointF(f20 / f21, (((f21 - tv0Var.f27500b) / 2.0f) + (pointF.y - A)) / f21);
                }
            } else if (i14 == 1) {
                ...
                if (c11 != 1) {
                    if (c11 != 2) {
                        if (c11 == 3) {
                            this.h = Math.max(this.f23617f + 0.02f, (this.f23616c + (sqrt - this.f23615b)) / min);
                        }
                    } else {
                        this.f23617f = Math.min(Math.max(0.1f, (this.f23616c + (sqrt - this.f23615b)) / min), this.h - 0.02f);
                    }
                } else {
                    float f22 = x10 - this.f23620s;
                    float f23 = y3 - this.v;
                    float width2 = (getWidth() - tv0Var.f27499a) / 2.0f;
                    if (!z13) {
                    ...
                    float f24 = tv0Var.f27500b;
                    float A2 = com.google.android.gms.internal.vision.e2.A(height2, f24, 2.0f, i11);
                    PointF pointF2 = new PointF(Math.max(width2, Math.min(tv0Var.f27499a + width2, this.f23614a.x + f22)), Math.max(A2, Math.min(f24 + A2, this.f23614a.y + f23)));
                    float f25 = pointF2.x - width2;
                    float f26 = tv0Var.f27499a;
                    this.e = new PointF(f25 / f26, (((f26 - tv0Var.f27500b) / 2.0f) + (pointF2.y - A2)) / f26);
                }
            }
            invalidate();
            gf0 gf0Var = this.L;
            if (gf0Var != null) {
                ...
                float f27 = this.f23617f;
                float f28 = this.h;
                sf0 sf0Var = ((kf0) gf0Var).f24707a;
                sf0Var.f27012a0 = f28;
                sf0Var.f27014b0 = pointF3;
                sf0Var.f27016c0 = f27;
                sf0Var.f27017d0 = a(this.f23618n) + 1.5707964f;
        ...
        if (i15 == 0) {
            if (sqrt < f30) {
                this.M = 2;
                this.f23614a = actualCenterPoint;
                return;
            }
            float f31 = f12 - f29;
    ...
    public final void d(int i10, MotionEvent motionEvent) {
        if (i10 != 1) {
            ...
            this.f23621w = b(motionEvent);
            this.f23622x = 1.0f;
            this.M = 5;
        }
        float b10 = b(motionEvent);
        float e = a4.a.e(b10 - this.f23621w, AndroidUtilities.density, 0.01f, this.f23622x);
        this.f23622x = e;
        float max = Math.max(0.1f, this.f23617f * e);
        this.f23617f = max;
        this.h = Math.max(max + 0.02f, this.h * this.f23622x);
        this.f23622x = 1.0f;
        this.f23621w = b10;
        invalidate();
        gf0 gf0Var = this.L;
        if (gf0Var != null) {
            ...
            float f7 = this.f23617f;
            float f10 = this.h;
            sf0 sf0Var = ((kf0) gf0Var).f24707a;
            sf0Var.f27012a0 = f10;
            sf0Var.f27014b0 = pointF;
            sf0Var.f27016c0 = f7;
            sf0Var.f27017d0 = a(this.f23618n) + 1.5707964f;
            c00 c00Var = sf0Var.f27026l0;
            if (c00Var != null) {
