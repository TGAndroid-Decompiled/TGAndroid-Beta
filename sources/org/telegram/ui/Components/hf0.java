...
public final class hf0 extends View {
    ...
    public float H;
    public ac0 I;
    public TextPaint f24661a;
    public TextPaint f24662b;
    public StaticLayout f24663c;
    public float d;
    public float e;
    ...
    public boolean v;
    public jf0 f24668w;
    public ci.ha f24669x;
    public boolean f24670y;

    @Override
    public final void onDraw(Canvas canvas) {
        float e = this.f24667s.e(this.f24666r);
        if (e > 0.0f && this.f24663c != null && this.f24664f != null) {
            ...
            this.f24663c.draw(canvas);
            canvas.restore();
            canvas.save();
            canvas.translate(((getWidth() - this.h) / 2.0f) - this.f24665n, (getHeight() * 0.22f) + AndroidUtilities.dp(60.0f));
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f24663c == null) {
            ...
            this.f24663c = staticLayout;
            if (staticLayout.getLineCount() > 0) {
                f7 = this.f24663c.getLineWidth(0);
            } else {
                f7 = 0.0f;
            }
            this.d = f7;
            if (this.f24663c.getLineCount() > 0) {
                f10 = this.f24663c.getLineLeft(0);
            }
            this.e = f10;
        }
    }
