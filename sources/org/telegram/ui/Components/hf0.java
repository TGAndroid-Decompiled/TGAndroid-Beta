...
public final class hf0 extends FrameLayout {
    ...
    public gf0 L;
    public int M;
    public PointF f24663a;
    public float f24664b;
    public float f24665c;
    public vv0 d;
    public PointF e;
    public float f24666f;
    public float h;
    public float f24667n;
    public RectF f24668r;
    public float f24669s;
    public float v;
    public float f24670w;
    public float f24671x;
    ...
    private PointF getActualCenterPoint() {
        ...
        float f11 = vv0Var.f29776a;
        return new PointF(width, (this.e.y * f11) + org.telegram.messenger.q.y(f11, f10, 2.0f, A));
    }

    private float getActualInnerRadius() {
        vv0 vv0Var = this.d;
        return Math.min(vv0Var.f29776a, vv0Var.f29777b) * this.f24666f;
    }

    private float getActualOuterRadius() {
        vv0 vv0Var = this.d;
        return Math.min(vv0Var.f29776a, vv0Var.f29777b) * this.h;
    }
    ...
    public final void c(int i10, MotionEvent motionEvent) {
        ...
        vv0 vv0Var = this.d;
        float min = Math.min(vv0Var.f29776a, vv0Var.f29777b);
        float f12 = this.f24666f * min;
        float f13 = this.h * min;
        float abs = (float) Math.abs((Math.sin(a(this.f24667n) + 1.5707963267948966d) * f11) + (Math.cos(a(this.f24667n) + 1.5707963267948966d) * f10));
        float f14 = 0.0f;
        if (i10 != 1) {
            if (i10 != 2) {
            ...
            if (i14 == 0) {
                ...
                if (c10 != 1) {
                    if (c10 != 2) {
                        if (c10 != 3) {
                            if (c10 == 5) {
                                ...
                                this.f24667n = (((((float) Math.sqrt((f16 * f16) + (f15 * f15))) * ((i13 * 2) - 1)) / 3.1415927f) / 1.15f) + this.f24667n;
                                this.f24669s = x10;
                                this.v = y3;
                            }
                        } else {
                            this.h = Math.max(this.f24666f + 0.02f, (this.f24665c + (abs - this.f24664b)) / min);
                        }
                    } else {
                        this.f24666f = Math.min(Math.max(0.1f, (this.f24665c + (abs - this.f24664b)) / min), this.h - 0.02f);
                    }
                } else {
                    float f17 = x10 - this.f24669s;
                    float f18 = y3 - this.v;
                    float width = (getWidth() - vv0Var.f29776a) / 2.0f;
                    if (!z13) {
                    ...
                    float height = getHeight();
                    float f19 = vv0Var.f29777b;
                    float A = com.google.android.gms.internal.vision.e2.A(height, f19, 2.0f, i12);
                    PointF pointF = new PointF(Math.max(width, Math.min(vv0Var.f29776a + width, this.f24663a.x + f17)), Math.max(A, Math.min(f19 + A, this.f24663a.y + f18)));
                    float f20 = pointF.x - width;
                    float f21 = vv0Var.f29776a;
                    this.e = new PointF(f20 / f21, (((f21 - vv0Var.f29777b) / 2.0f) + (pointF.y - A)) / f21);
                }
            } else if (i14 == 1) {
                ...
                if (c11 != 1) {
                    if (c11 != 2) {
                        if (c11 == 3) {
                            this.h = Math.max(this.f24666f + 0.02f, (this.f24665c + (sqrt - this.f24664b)) / min);
                        }
                    } else {
                        this.f24666f = Math.min(Math.max(0.1f, (this.f24665c + (sqrt - this.f24664b)) / min), this.h - 0.02f);
                    }
                } else {
                    float f22 = x10 - this.f24669s;
                    float f23 = y3 - this.v;
                    float width2 = (getWidth() - vv0Var.f29776a) / 2.0f;
                    if (!z13) {
                    ...
                    float f24 = vv0Var.f29777b;
                    float A2 = com.google.android.gms.internal.vision.e2.A(height2, f24, 2.0f, i11);
                    PointF pointF2 = new PointF(Math.max(width2, Math.min(vv0Var.f29776a + width2, this.f24663a.x + f22)), Math.max(A2, Math.min(f24 + A2, this.f24663a.y + f23)));
                    float f25 = pointF2.x - width2;
                    float f26 = vv0Var.f29776a;
                    this.e = new PointF(f25 / f26, (((f26 - vv0Var.f29777b) / 2.0f) + (pointF2.y - A2)) / f26);
                }
            }
            invalidate();
            gf0 gf0Var = this.L;
            if (gf0Var != null) {
                ...
                float f27 = this.f24666f;
                float f28 = this.h;
                sf0 sf0Var = ((kf0) gf0Var).f25718a;
                sf0Var.f28132a0 = f28;
                sf0Var.f28134b0 = pointF3;
                sf0Var.f28136c0 = f27;
                sf0Var.f28137d0 = a(this.f24667n) + 1.5707964f;
        ...
        if (i15 == 0) {
            if (sqrt < f30) {
                this.M = 2;
                this.f24663a = actualCenterPoint;
                return;
            }
            float f31 = f12 - f29;
    ...
    public final void d(int i10, MotionEvent motionEvent) {
        if (i10 != 1) {
            ...
            this.f24670w = b(motionEvent);
            this.f24671x = 1.0f;
            this.M = 5;
        }
        float b10 = b(motionEvent);
        float e = a4.a.e(b10 - this.f24670w, AndroidUtilities.density, 0.01f, this.f24671x);
        this.f24671x = e;
        float max = Math.max(0.1f, this.f24666f * e);
        this.f24666f = max;
        this.h = Math.max(max + 0.02f, this.h * this.f24671x);
        this.f24671x = 1.0f;
        this.f24670w = b10;
        invalidate();
        gf0 gf0Var = this.L;
        if (gf0Var != null) {
            ...
            float f7 = this.f24666f;
            float f10 = this.h;
            sf0 sf0Var = ((kf0) gf0Var).f25718a;
            sf0Var.f28132a0 = f10;
            sf0Var.f28134b0 = pointF;
            sf0Var.f28136c0 = f7;
            sf0Var.f28137d0 = a(this.f24667n) + 1.5707964f;
            vz vzVar = sf0Var.f28146l0;
            if (vzVar != null) {
    ...
    public final boolean onTouchEvent(android.view.MotionEvent r21) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.hf0.onTouchEvent(android.view.MotionEvent):boolean");
    }
