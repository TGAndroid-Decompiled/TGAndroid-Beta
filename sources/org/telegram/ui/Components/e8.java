...
public abstract class e8 extends FrameLayout {
    ...
    public final Paint f25594e;
    public final Paint f25595f;
    public int h;
    public AnimatorSet f25596n;
    public LinearGradient f25597r;
    public int f25598s;
    ...
    public e8(Context context) {
        super(context);
        this.f25591a = new TextView[2];
        this.f25592b = new float[]{0.0f, 0.75f};
        this.f25593c = AndroidUtilities.dp(24.0f);
        this.f25598s = -1;
        this.v = new RectF();
        for (int i10 = 0; i10 < 2; i10++) {
            this.f25591a[i10] = a();
            if (i10 == 1) {
                this.f25591a[i10].setAlpha(0.0f);
                this.f25591a[i10].setVisibility(8);
            }
            addView(this.f25591a[i10], w7.x5.c(-1.0f, -2));
        }
        this.d = new Matrix();
    ...
    public final void b(CharSequence charSequence, boolean z10) {
        final int i10;
        int i11 = this.h;
        TextView[] textViewArr = this.f25591a;
        ...
        if (!TextUtils.isEmpty(text) && z10) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    switch (r3) {
                        case 0:
                            e8 e8Var = this.f25290b;
                            e8Var.f25592b[i13] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            e8Var.invalidate();
                            return;
                        default:
                            e8 e8Var2 = this.f25290b;
                            e8Var2.f25592b[i13] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            e8Var2.invalidate();
                            return;
                    }
                }
            ...
            ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    switch (r3) {
                        case 0:
                            e8 e8Var = this.f25290b;
                            e8Var.f25592b[i10] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            e8Var.invalidate();
                            return;
                        default:
                            e8 e8Var2 = this.f25290b;
                            e8Var2.f25592b[i10] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            e8Var2.invalidate();
                            return;
                    }
                }
            ...
            this.f25596n.playTogether(ofFloat, ofFloat2, ofFloat3, ofFloat4);
            this.f25596n.start();
            return;
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (i12 > 0 && textViewArr[this.h].getAlpha() != 1.0f && textViewArr[this.h].getLayout() != null) {
            ...
            float primaryHorizontal2 = textViewArr[this.h].getLayout().getPrimaryHorizontal(this.f25598s);
        ...
        float f10 = f7 + this.f25593c;
        Matrix matrix = this.d;
        matrix.setTranslate(f7, 0.0f);
        this.f25597r.setLocalMatrix(matrix);
        canvas.drawRect(f7, 0.0f, f10, min2, this.f25594e);
        Paint paint = this.f25595f;
        if (min > f10) {
            canvas2 = canvas;
    ...
    public TextView getNextTextView() {
        ...
        return this.f25591a[c10];
    }

    public TextView getTextView() {
        return this.f25591a[this.h];
    }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        LinearGradient linearGradient = new LinearGradient(this.f25593c, 0.0f, 0.0f, 0.0f, 0, -16777216, Shader.TileMode.CLAMP);
        this.f25597r = linearGradient;
        this.f25594e.setShader(linearGradient);
    }

    public void setCustomPaddingRight(int i10) {
        TextView[] textViewArr;
        this.f25599w = i10;
        for (TextView textView : this.f25591a) {
