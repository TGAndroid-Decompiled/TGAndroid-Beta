...
public abstract class e8 extends FrameLayout {
    ...
    public final Paint f25621e;
    public final Paint f25622f;
    public int h;
    public AnimatorSet f25623n;
    public LinearGradient f25624r;
    public int f25625s;
    ...
    public e8(Context context) {
        super(context);
        this.f25618a = new TextView[2];
        this.f25619b = new float[]{0.0f, 0.75f};
        this.f25620c = AndroidUtilities.dp(24.0f);
        this.f25625s = -1;
        this.v = new RectF();
        for (int i10 = 0; i10 < 2; i10++) {
            this.f25618a[i10] = a();
            if (i10 == 1) {
                this.f25618a[i10].setAlpha(0.0f);
                this.f25618a[i10].setVisibility(8);
            }
            addView(this.f25618a[i10], w7.x5.c(-1.0f, -2));
        }
        this.d = new Matrix();
    ...
    public final void b(CharSequence charSequence, boolean z10) {
        final int i10;
        int i11 = this.h;
        TextView[] textViewArr = this.f25618a;
        ...
        if (!TextUtils.isEmpty(text) && z10) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    switch (r3) {
                        case 0:
                            e8 e8Var = this.f25317b;
                            e8Var.f25619b[i13] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            e8Var.invalidate();
                            return;
                        default:
                            e8 e8Var2 = this.f25317b;
                            e8Var2.f25619b[i13] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            e8Var2.invalidate();
                            return;
                    }
                }
            ...
            ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    switch (r3) {
                        case 0:
                            e8 e8Var = this.f25317b;
                            e8Var.f25619b[i10] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            e8Var.invalidate();
                            return;
                        default:
                            e8 e8Var2 = this.f25317b;
                            e8Var2.f25619b[i10] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            e8Var2.invalidate();
                            return;
                    }
                }
            ...
            this.f25623n.playTogether(ofFloat, ofFloat2, ofFloat3, ofFloat4);
            this.f25623n.start();
            return;
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (i12 > 0 && textViewArr[this.h].getAlpha() != 1.0f && textViewArr[this.h].getLayout() != null) {
            ...
            float primaryHorizontal2 = textViewArr[this.h].getLayout().getPrimaryHorizontal(this.f25625s);
        ...
        float f10 = f7 + this.f25620c;
        Matrix matrix = this.d;
        matrix.setTranslate(f7, 0.0f);
        this.f25624r.setLocalMatrix(matrix);
        canvas.drawRect(f7, 0.0f, f10, min2, this.f25621e);
        Paint paint = this.f25622f;
        if (min > f10) {
            canvas2 = canvas;
    ...
    public TextView getNextTextView() {
        ...
        return this.f25618a[c10];
    }

    public TextView getTextView() {
        return this.f25618a[this.h];
    }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        LinearGradient linearGradient = new LinearGradient(this.f25620c, 0.0f, 0.0f, 0.0f, 0, -16777216, Shader.TileMode.CLAMP);
        this.f25624r = linearGradient;
        this.f25621e.setShader(linearGradient);
    }

    public void setCustomPaddingRight(int i10) {
        TextView[] textViewArr;
        this.f25626w = i10;
        for (TextView textView : this.f25618a) {
