...
public final class bp implements ti {
    public final vi f22782a;
    public final TL_stories.TL_premium_boostsStatus f22783b;
    public final org.telegram.ui.ActionBar.f6 f22784c;
    public final org.telegram.ui.g d;
    public final long e;
    public final org.telegram.ui.s3 f22785f;
    ...
    public bp(vi viVar, TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus, org.telegram.ui.ActionBar.f6 f6Var, org.telegram.ui.g gVar, long j3, org.telegram.ui.s3 s3Var, org.telegram.ui.cd cdVar) {
        this.f22782a = viVar;
        this.f22783b = tL_premium_boostsStatus;
        this.f22784c = f6Var;
        this.d = gVar;
        this.e = j3;
        this.f22785f = s3Var;
        ...
        try {
            ...
            if (!selectedPhotos.isEmpty()) {
                ...
                if (str != null) {
                    ...
                    apVar.V1 = this.f22783b;
                    apVar.f39536a.f39522a = this.f22784c;
                    apVar.f39579p1 = this.d;
                    apVar.F1 = false;
                    apVar.E1 = false;
                    apVar.f39575n1 = 0.2f;
                    apVar.c1(this.e);
                    apVar.I1 = new zo(viVar, this.f22785f, 0);
                    ?? obj = new Object();
                    obj.f19398a = true;
                    obj.e = true;
    ...
    public final void U0(Object obj) {
        ...
        apVar.f39579p1 = this.d;
        apVar.c1(this.e);
        apVar.I1 = new zo(this.f22782a, this.f22785f, 1);
        ?? obj2 = new Object();
        obj2.f19398a = true;
        obj2.e = true;
