...
public final class tn extends vl0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        int b10 = c1Var.b();
        vn vnVar = this.d;
        if (b10 != vnVar.f29217u0 && b10 != vnVar.G0 && b10 != vnVar.B0 && b10 != vnVar.F0 && b10 != vnVar.C0 && b10 != vnVar.H0 && b10 != vnVar.D0 && b10 != vnVar.E0 && b10 != vnVar.I0 && b10 != vnVar.J0 && b10 != vnVar.N0.f3649b && b10 != vnVar.M0.f3649b && b10 != vnVar.L0) {
            return false;
        }
        return true;
    }
    ...
    public final int j(int i10) {
        ...
        if (i10 != vnVar.B0 && i10 != vnVar.F0 && i10 != vnVar.G0 && i10 != vnVar.C0 && i10 != vnVar.D0 && i10 != vnVar.E0 && i10 != vnVar.H0 && i10 != vnVar.M0.f3649b && i10 != vnVar.N0.f3649b) {
            if (i10 != vnVar.f29206l0 && i10 != vnVar.f29215s0 && i10 != vnVar.f29220w0 && i10 != vnVar.f29209o0) {
                if (i10 == vnVar.f29213r0) {
                    return 1;
                }
                if (i10 != vnVar.f29218v0 && i10 != vnVar.f29222x0 && i10 != vnVar.f29211q0 && i10 != vnVar.K0) {
                    if (i10 != vnVar.f29217u0 && i10 != vnVar.I0 && i10 != vnVar.L0) {
                        if (i10 == vnVar.m0) {
                            return 4;
                        }
                        if (i10 == vnVar.f29208n0) {
                            return 11;
                        }
                        if (i10 == vnVar.f29210p0) {
                            return 7;
                        }
                        if (i10 != vnVar.f29224y0 && i10 != vnVar.f29225z0 && i10 != vnVar.J0) {
                            if (i10 == vnVar.A0) {
                                return 8;
                            }
                            if (i10 == 0) {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        boolean z11;
        vn vnVar = this.d;
        boolean z12 = vnVar.f29192e0;
        c2.a aVar = vnVar.M0;
        c2.a aVar2 = vnVar.N0;
        org.telegram.ui.ActionBar.d6 d6Var = vnVar.f27086a;
        boolean z13 = vnVar.f29207n;
        ...
        if (i15 != 0) {
            ...
            if (i15 != 6) {
                    ...
                    if (i15 != 3) {
                        if (i15 != 9) {
                            if (i15 == 10) {
                                ...
                                if (i10 == vnVar.B0) {
                                    a6Var.a(LocaleController.getString(R.string.PollV2ShowWhoVoted), LocaleController.getString(R.string.PollV2ShowWhoVotedInfo), 1, R.drawable.filled_poll_view_24, !vnVar.f29184a0);
                                } else {
                                    if (i10 == vnVar.F0) {
                                        a6Var.a(LocaleController.getString(R.string.PollV2AllowMultipleAnswers), LocaleController.getString(R.string.PollV2AllowMultipleAnswersInfo), 5, R.drawable.filled_poll_multiple_24, vnVar.f29186b0);
                                        ...
                                        a6Var.a(LocaleController.getString(R.string.PollV2SetCorrectAnswer), LocaleController.getString(R.string.PollV2SetCorrectAnswerInfo), 7, R.drawable.filled_poll_correct_24, vnVar.f29188c0);
                                ...
                                if (i10 == vnVar.G0) {
                                    ...
                                    if (!vnVar.f29188c0 && !vnVar.f29184a0) {
                                        z14 = false;
                                    }
                ...
                new qq(new ColorDrawable(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19003a7, d6Var)), org.telegram.ui.ActionBar.h6.V0(context, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.h6.f19023b7)).f27739w = true;
                if (i10 == vnVar.f29211q0) {
                    e9Var.setText(LocaleController.getString(R.string.AddAnExplanationInfo));
                    return;
                } else if (i10 == vnVar.f29222x0) {
            ...
            if (i10 == vnVar.f29224y0) {
                ...
                w8Var.e(null, true);
                return;
            } else if (i10 == vnVar.f29225z0) {
                w8Var.f(LocaleController.getString(R.string.TodoAllowMarkingDone), vnVar.f29196g0, false);
                w8Var.e(null, true);
                return;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        View view;
        vn vnVar = this.d;
        boolean z10 = vnVar.f29207n;
        org.telegram.ui.ActionBar.d6 d6Var = vnVar.f27086a;
        Context context = this.f28570c;
        switch (i10) {
            case 0:
                m4Var = new org.telegram.ui.Cells.m4(this.f28570c, org.telegram.ui.ActionBar.h6.L6, 21, 15, false, vnVar.f27086a);
                break;
            case 1:
                View b7Var = new org.telegram.ui.Cells.b7(context, (org.telegram.ui.Cells.c1) null);
                new qq(new ColorDrawable(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19003a7, d6Var)), org.telegram.ui.ActionBar.h6.V0(context, R.drawable.greydivider, org.telegram.ui.ActionBar.h6.f19023b7)).f27739w = true;
                m4Var = b7Var;
                break;
            case 2:
            ...
            case 11:
                boolean z11 = vnVar.I;
                on onVar = new on(this, this.f28570c, z11 ? 1 : 0, vnVar.f27086a, i10);
                if (i10 == 11 && !z10) {
                    onVar.setTextRight(98);
                    onVar.b().setOnClickListener(new View.OnClickListener(this) {
                        public final tn f26552b;
                        ...
                        public final void onClick(View view2) {
                            switch (r2) {
                                case 0:
                                    vn.O(this.f26552b.d, -2);
                                    return;
                                case 1:
                                    vn.O(this.f26552b.d, -3);
                                    return;
                                default:
                                    this.f26552b.d.X(view2, (org.telegram.ui.Cells.d6) view2.getParent(), true);
                                    return;
                            }
                        }
                    });
                ...
                onVar.d();
                onVar.setIconsColor(org.telegram.ui.ActionBar.h6.f19261o7);
            ...
            default:
                boolean z12 = vnVar.I;
                sn snVar = new sn(this, this.f28570c, z12 ? 1 : 0, new View.OnClickListener(this) {
                    public final tn f26552b;
            ...
            case 7:
                ...
                qnVar.setIconsColor(org.telegram.ui.ActionBar.h6.f19261o7);
    ...
    public final void y(s4.c1 c1Var) {
        ...
        if (i12 == 4) {
            ...
            d6Var3.setTag(1);
            d6Var3.f20134a.a(vnVar.f29186b0, false);
            int i13 = b10 - vnVar.f29216t0;
