...
public final class wq0 implements Runnable {
    public final int f32319a = 0;
    public final xu0 f32320b;
    public final org.telegram.ui.ActionBar.f6 f32321c;
    ...
    public final void run() {
        switch (this.f32319a) {
            case 0:
                org.telegram.ui.ActionBar.b2[] b2VarArr = {new org.telegram.ui.ActionBar.b2(this.f32320b.getContext(), 3, this.f32321c)};
                int i10 = this.f32322e;
                ...
                return;
            default:
                xu0 xu0Var = this.f32320b;
                Context context = xu0Var.getContext();
                org.telegram.ui.ActionBar.f6 f6Var = this.f32321c;
                ...
                alertDialog$Builder.k(LocaleController.getString(R.string.Stop), new org.telegram.ui.da(xu0Var, f6Var, messageObject, this.f32322e, 4));
