...
public final class wq0 implements Runnable {
    public final int f32346a = 0;
    public final xu0 f32347b;
    public final org.telegram.ui.ActionBar.f6 f32348c;
    ...
    public final void run() {
        switch (this.f32346a) {
            case 0:
                org.telegram.ui.ActionBar.b2[] b2VarArr = {new org.telegram.ui.ActionBar.b2(this.f32347b.getContext(), 3, this.f32348c)};
                ...
                return;
            default:
                xu0 xu0Var = this.f32347b;
                Context context = xu0Var.getContext();
                org.telegram.ui.ActionBar.f6 f6Var = this.f32348c;
                ...
                alertDialog$Builder.k(LocaleController.getString(R.string.Stop), new org.telegram.ui.da(xu0Var, f6Var, messageObject, this.f32349e, 4));
