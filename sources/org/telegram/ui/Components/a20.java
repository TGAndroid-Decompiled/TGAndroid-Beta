...
public final class a20 extends FrameLayout implements le.e {
    public final le.c f22510a;
    public final le.c f22511b;
    public final mj0 f22512c;
    public final RadialProgressView d;
    public final org.telegram.ui.ActionBar.d6 e;
    public ArrayList f22513f;
    public final boolean h;
    public final fh.c f22514n;
    public final ch.f f22515r;
    public final ci.f f22516s;
    public float v;
    public float f22517w;
    public boolean f22518x;

    public a20(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
    ...
    private void setAdditionalTranslationY(float f7) {
        if (this.v != f7) {
            this.f22518x = true;
            super.setTranslationY(this.f22517w + f7);
            this.f22518x = false;
            this.v = f7;
        }
    }
    ...
    public final void D(int i10, float f7, float f10, le.f fVar) {
        ...
        if (i10 == 0) {
            ...
            float f12 = 1.0f - f7;
            d(this.f22512c, f12);
            ArrayList arrayList = this.f22513f;
            if (arrayList != null) {
    ...
    public final void a(View view) {
        ...
        this.f22513f.add(view);
        d(view, 1.0f - this.f22511b.e);
    }

    @Override
    public final void draw(Canvas canvas) {
        ch.f fVar = this.f22515r;
        if (fVar != null) {
            fVar.draw(canvas);
        }
        super.draw(canvas);
    ...
    public final void e(boolean z10, boolean z11) {
        this.f22510a.a(z10, z11);
    }

    public final void f(boolean z10, boolean z11) {
        this.f22511b.a(z10, z11);
    }

    public final void g() {
        boolean z10 = this.h;
        RadialProgressView radialProgressView = this.d;
        mj0 mj0Var = this.f22512c;
        org.telegram.ui.ActionBar.d6 d6Var = this.e;
        if (z10) {
            int i10 = org.telegram.ui.ActionBar.h6.f19392v8;
            mj0Var.setColorFilter(org.telegram.ui.ActionBar.h6.v0(i10, d6Var), PorterDuff.Mode.SRC_IN);
            radialProgressView.setProgressColor(org.telegram.ui.ActionBar.h6.v0(i10, d6Var));
            this.f22514n.a(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19059d6, false));
            this.f22516s.d();
            this.f22515r.v();
            invalidate();
        ...
        mj0Var.setColorFilter(org.telegram.ui.ActionBar.h6.v0(i11, d6Var), PorterDuff.Mode.SRC_IN);
    ...
    public boolean getButtonVisible() {
        return this.f22510a.f14201f;
    }

    public boolean getProgressVisible() {
        return this.f22511b.f14201f;
    }
    ...
    public void setImageResource(int i10) {
        this.f22512c.setImageResource(i10);
    }
    ...
    public a20(Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10) {
        super(context);
        sr srVar = sr.h;
        this.f22510a = new le.c(0, this, srVar, 380L, true);
        this.f22511b = new le.c(1, this, srVar, 380L, false);
        this.e = d6Var;
        this.h = z10;
        ...
        w7.a6.a(this);
        if (!z10) {
            setOutlineProvider(yf.i0.f47110a);
