...
public final class sq0 extends View {
    public Random f31151a;
    public Paint f31152b;
    public Paint f31153c;
    public Paint d;
    public Paint f31154e;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f13 = (this.f31156n * interpolation) + ((1.0f - interpolation) * this.h);
        canvas.save();
        ...
        canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), AndroidUtilities.dp(4.0f), this.f31154e);
        canvas.restore();
        ...
        float f16 = this.f31155f + 0.016f;
        this.f31155f = f16;
        if (f16 > 1.0f) {
            this.h = this.f31156n;
            float f17 = org.telegram.ui.yh.f(this.f31151a, 1001) / 1000.0f;
            this.f31156n = f17;
            if (f17 > this.h) {
                this.f31156n = f17 + 0.3f;
            } else {
                this.f31156n = f17 - 0.3f;
            }
            this.f31156n = Math.max(0.0f, Math.min(1.0f, this.f31156n));
            this.f31155f = 0.0f;
        }
        invalidate();
    }
