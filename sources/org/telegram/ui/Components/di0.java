...
public final class di0 extends Drawable {
    public Path f27774a;
    public Paint f27775b;
    public float f27776c;

    public final void a() {
        int dp = AndroidUtilities.dp(18.0f);
        Path path = this.f27774a;
        path.reset();
        float f9 = dp >> 1;
        ...
        Paint paint = this.f27775b;
        paint.setStyle(Paint.Style.FILL_AND_STROKE);
        paint.setStrokeJoin(Paint.Join.ROUND);
        paint.setStrokeWidth(AndroidUtilities.dpf2(1.0f));
        this.f27776c = AndroidUtilities.density;
    }

    @Override
    public final void draw(Canvas canvas) {
        Paint paint = this.f27775b;
        if (this.f27776c != AndroidUtilities.density) {
            a();
        }
        canvas.save();
        canvas.translate(getBounds().left, getBounds().top);
        canvas.drawPath(this.f27774a, paint);
