...
public final class di0 extends View {
    ...
    public float H;
    public float I;
    public final org.telegram.ui.ActionBar.f6 f24285a;
    public final PorterDuffColorFilter f24286b;
    public final PorterDuffColorFilter f24287c;
    public k01 d;
    public k01 e;
    public final Paint f24288f;
    public final Paint h;
    public final Path f24289n;
    public final Drawable f24290r;
    public final RectF f24291s;
    public final Paint v;
    public final Paint f24292w;
    public final Path f24293x;
    public final rc f24294y;

    public di0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.f24286b = new PorterDuffColorFilter(-1, mode);
        this.f24287c = new PorterDuffColorFilter(-16777216, mode);
        this.f24288f = new Paint();
        Paint paint = new Paint();
        this.h = paint;
        Path path = new Path();
        this.f24289n = path;
        this.f24291s = new RectF();
        this.v = new Paint(1);
        this.f24292w = new Paint(1);
        this.f24293x = new Path();
        this.f24294y = new rc(this);
        this.B = -1;
        this.f24285a = f6Var;
        this.f24290r = context.getResources().getDrawable(R.drawable.files_music).mutate();
    ...
    public final void a() {
        ...
        this.B = i10;
        if (z4) {
            porterDuffColorFilter = this.f24287c;
        } else {
            porterDuffColorFilter = this.f24286b;
        }
        this.f24290r.setColorFilter(porterDuffColorFilter);
        this.f24288f.setColor(this.B);
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        RectF rectF = this.f24291s;
        rc rcVar = this.f24294y;
        if (action == 0) {
    ...
    public final void onDraw(Canvas canvas) {
        if (this.d != null && this.e != null) {
            ...
            float a2 = this.f24294y.a(0.02f);
            if (clamp01 > 0.0f) {
                int width = getWidth() - (AndroidUtilities.dp(12.0f) * 2);
                this.d.f26134p = (width - AndroidUtilities.dp(35.0f)) / 2.0f;
                this.e.f26134p = (width - this.d.l()) - AndroidUtilities.dp(35.0f);
                ...
                int i12 = i10 - i11;
                int i13 = i10 + i11;
                Drawable drawable = this.f24290r;
                ...
                canvas.drawPath(this.f24289n, paint3);
                canvas.restore();
                canvas.restore();
            }
        }
    ...
    public void setColor(MessagesController.PeerColor peerColor) {
        int bgColor1;
        int bgColor2;
        org.telegram.ui.ActionBar.f6 f6Var = this.f24285a;
        if (peerColor == null) {
            bgColor1 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20151s8, f6Var);
            bgColor2 = bgColor1;
        } else {
        ...
        if (peerColor == null) {
            this.D = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19881d6, f6Var);
            this.E = true;
        } else {
