...
public final class di0 extends FrameLayout {
    public final Paint f23584a;
    public final Path f23585b;
    public final ci0 f23586c;
    public float d;
    public float e;
    public float f23587f;
    public boolean h;
    public NotchInfoUtils.NotchInfo f23588n;
    ...
    public di0(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 31 && SharedConfig.getDevicePerformanceClass() >= 1) {
            ...
            this.f23586c = new bi0(this, f7);
        } else {
            this.f23586c = new ai0(this);
        }
        setIntensity(15.0f);
    ...
    public static void a(di0 di0Var, Canvas canvas) {
        canvas.save();
    ...
    public final void draw(Canvas canvas) {
        ...
        this.f23586c.c(new lv(this, 12), canvas);
    }

    public float getAvatarEndScale() {
        float min;
        int dp;
        NotchInfoUtils.NotchInfo notchInfo = this.f23588n;
        if (notchInfo == null) {
            return 0.8f;
        }
        if (notchInfo.isLikelyCircle) {
            ...
            min = Math.min(notchInfo.bounds.width(), this.f23588n.bounds.height());
            dp = AndroidUtilities.dp(100.0f);
        }
