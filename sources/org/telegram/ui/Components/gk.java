...
public final class gk extends ol0 {
    ...
    public boolean S;
    public final hk U;
    public final Context f25181r;
    public bk v;
    public org.telegram.ui.hp f25183w;
    public long f25184x;
    public tf.e0 f25185y;
    public ArrayList f25182s = new ArrayList();
    ...
    public final Object O(int i10, int i11) {
        ...
        int i12;
        if (i10 == 0) {
            if (i11 < this.f25182s.size()) {
                return this.f25182s.get(i11);
            }
            return null;
        }
        int i13 = i10 - 1;
    ...
    public final int P(int i10, int i11) {
        ...
        int i12 = i10 - 1;
        if (i12 < this.M.size()) {
            if ((i12 != 0 || !this.f25182s.isEmpty()) && i11 == 0) {
                return 0;
            }
            return 4;
        }
    ...
    public final View T(int i10, View view) {
        ...
        if (u3Var == null) {
            Context context = this.f25181r;
            hk hkVar = this.U;
            u3Var = new org.telegram.ui.Cells.u3(context, hkVar.f24277a);
            u3Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19924e7, hkVar.f24277a) & (-218103809));
        }
        if (i10 != 0 && (i10 != 1 || !this.f25182s.isEmpty())) {
            int i11 = i10 - 1;
            ArrayList arrayList = this.M;
            if (i11 < arrayList.size()) {
                u3Var.setAlpha(1.0f);
            ...
            if (i13 != 0) {
                if (i13 == 1 || i13 == 4) {
                    ...
                    if (i10 == 0) {
                        ...
                        int i14 = akVar.f23412a;
                        if (i14 != 0) {
                            i7Var.d(false, akVar.f23413b, i14, akVar.f23414c, null, null);
                        } else {
                            i7Var.d(false, akVar.f23413b, 0, akVar.f23414c, akVar.d.toUpperCase().substring(0, Math.min(akVar.d.length(), 4)), akVar.e);
                        }
                    ...
                    if (arrayList2 != null) {
                        ...
                        i7Var.getViewTreeObserver().addOnPreDrawListener(new fk(this, i7Var, messageObject, z4, 0));
                        return;
                    }
                    return;
                }
    ...
    public final void Y(String str, boolean z4) {
        ...
        org.telegram.ui.hp hpVar = this.f25183w;
        if (hpVar != null) {
        ...
        ?? r02 = new Runnable() {
            ...
            public final void run() {
                ...
                if (j16 != 0) {
                    ...
                    tL_messages_search.filter = gkVar.f25185y.e;
                    ...
                    tL_messages_searchGlobal2.f19295q = str4;
                    tL_messages_searchGlobal2.filter = gkVar.f25185y.e;
                    if (j17 > 0) {
        ...
        if (i10 != 0) {
            ...
            if (i10 != 1) {
                if (i10 != 2) {
                    ...
                    t00 t00Var = new t00(context, hkVar.f24277a);
            ...
            org.telegram.ui.Cells.i7 i7Var = new org.telegram.ui.Cells.i7(context, i11, hkVar.f24277a);
