...
public final class tq extends View {
    ...
    public tq(Context context, int i10) {
        ...
        if (i10 == 0) {
            this.f28169f = org.telegram.ui.ActionBar.i6.B7;
            this.h = org.telegram.ui.ActionBar.i6.C7;
        } else if (i10 == 1) {
            this.f28169f = org.telegram.ui.ActionBar.i6.D7;
            this.h = org.telegram.ui.ActionBar.i6.E7;
        } else if (i10 == 2) {
            this.f28169f = org.telegram.ui.ActionBar.i6.F7;
            this.h = org.telegram.ui.ActionBar.i6.G7;
        } else if (i10 == 3) {
            this.f28169f = org.telegram.ui.ActionBar.i6.H7;
    ...
    public final void b() {
        int i10 = this.f28169f;
        Paint paint = this.f28166a;
        if (i10 >= 0) {
            paint.setColor(org.telegram.ui.ActionBar.i6.w0(null, i10, false));
        } else {
            paint.setColor(this.f28170n);
        }
        int i11 = this.h;
        Paint paint2 = this.f28167b;
        if (i11 >= 0) {
            paint2.setColor(org.telegram.ui.ActionBar.i6.w0(null, i11, false));
        } else {
            paint2.setColor(this.f28171r);
        }
        invalidate();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        RectF rectF = this.f28168c;
        rectF.set(measuredWidth, measuredHeight, AndroidUtilities.dp(18.0f) + measuredWidth, AndroidUtilities.dp(18.0f) + measuredHeight);
        canvas.drawCircle(getMeasuredWidth() / 2, getMeasuredHeight() / 2, AndroidUtilities.dp(9.0f), this.f28166a);
        canvas.drawArc(rectF, this.d - 90, 90.0f, false, this.f28167b);
        invalidate();
    }
