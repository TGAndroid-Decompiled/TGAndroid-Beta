...
public final class fl0 extends l20 {
    ...
    public final boolean a() {
        if (((ll0) this.f26154b.f26487b).Y0 != null) {
            return true;
        }
        return false;
    }
    ...
    public final void b(MotionEvent motionEvent, View view) {
        ll0 ll0Var = (ll0) this.f26154b.f26487b;
        if (view != null) {
    ...
    public final boolean onDoubleTap(MotionEvent motionEvent) {
        ...
        if (view != null && (al0Var = ll0Var.W0) != null && al0Var.d1(view)) {
            ll0Var.W0.q0(this.f26153a, motionEvent.getX(), motionEvent.getY());
            this.f26153a = null;
            return true;
        }
        return false;
    ...
    public final boolean onSingleTapConfirmed(MotionEvent motionEvent) {
        al0 al0Var;
        View view = this.f26153a;
        if (view != null && (al0Var = ((ll0) this.f26154b.f26487b).W0) != null && al0Var.d1(view)) {
            b(motionEvent, this.f26153a);
            this.f26153a = null;
            return true;
        }
        return false;
