...
public final class fl0 extends View {
    ...
    public boolean f24256a0;
    public final RectF f24257b;
    public final float f24258b0;
    public final Paint f24259c;
    public final Drawable f24260c0;
    public final Paint d;
    public final Drawable f24261d0;
    public float e;
    public ch.d f24262e0;
    public float f24263f;
    public ch.d f24264f0;
    public final boolean f24265g0;
    public float h;
    public int f24266h0;
    public final org.telegram.ui.Cells.u6 f24267i0;
    public float f24268j0;
    public boolean f24269k0;
    public long f24270l0;
    public float m0;
    public boolean f24271n;
    public float f24272n0;
    public final yl0 f24273o0;
    public StaticLayout f24274r;
    public StaticLayout f24275s;
    public StaticLayout v;
    public StaticLayout f24276w;
    public StaticLayout f24277x;
    ...
    public fl0(yl0 yl0Var, Context context, int i10) {
        ...
        float f7;
        float f10;
        org.telegram.ui.ActionBar.f6 f6Var = yl0Var.f30704p2;
        this.f24273o0 = yl0Var;
        this.f24255a = true;
        this.f24257b = new RectF();
        this.f24259c = new Paint(1);
        ...
        this.L = new float[8];
        this.W = new int[2];
        this.f24267i0 = new org.telegram.ui.Cells.u6(this, 21);
        this.f24272n0 = 1.0f;
        this.R = i10;
        if (i10 == 0) {
            textPaint.setTextSize(AndroidUtilities.dp(45.0f));
            this.f24265g0 = LocaleController.isRTL;
        } else {
            this.f24265g0 = false;
        ...
        this.f24258b0 = ViewConfiguration.get(context).getScaledTouchSlop();
        this.f24260c0 = context.getDrawable(R.drawable.fast_scroll_shadow);
    }

    public final void a(boolean z10) {
        yl0 yl0Var = this.f24273o0;
        ...
        if (layoutManager instanceof s4.c0) {
            ...
            if (c0Var.f42983o == 1) {
                ...
                if (adapter instanceof gl0) {
                    ...
                    if (z10) {
                        c0Var.h1(iArr[0], (-iArr[1]) + yl0Var.f30717w1);
                    }
                    String F = gl0Var.F(iArr[0]);
                    if (F == null) {
                        StaticLayout staticLayout = this.f24274r;
                        if (staticLayout != null) {
                            this.f24275s = staticLayout;
                        }
                        this.f24274r = null;
                        ...
                        if (i10 == 0) {
                            this.f24274r = new StaticLayout(F, textPaint, 1000, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                        } else {
                            this.v = this.f24274r;
                            int measureText = ((int) textPaint.measureText(F)) + 1;
                            Layout.Alignment alignment = Layout.Alignment.ALIGN_NORMAL;
                            this.f24274r = new StaticLayout(F, textPaint, measureText, alignment, 1.0f, 0.0f, false);
                            if (this.v != null) {
                                ...
                                if (split != null && split2 != null && split.length == 2 && split2.length == 2 && split[1].equals(split2[1])) {
                                    ...
                                    this.f24276w = new StaticLayout(spannableStringBuilder2, textPaint, measureText, alignment, 1.0f, 0.0f, false);
                                    ...
                                    this.f24277x = new StaticLayout(spannableStringBuilder3, textPaint, measureText, alignment, 1.0f, 0.0f, false);
                                } else {
                                    this.f24276w = this.f24274r;
                                    this.f24277x = null;
                                }
                        ...
                        this.f24275s = null;
                        if (this.f24274r.getLineCount() > 0) {
                            this.f24274r.getLineWidth(0);
                            this.f24274r.getLineLeft(0);
                            if (this.f24265g0) {
                                this.M = (((AndroidUtilities.dp(88.0f) - this.f24274r.getLineWidth(0)) / 2.0f) + AndroidUtilities.dp(10.0f)) - this.f24274r.getLineLeft(0);
                            } else {
                                this.M = ((AndroidUtilities.dp(88.0f) - this.f24274r.getLineWidth(0)) / 2.0f) - this.f24274r.getLineLeft(0);
                            }
                            this.N = (AndroidUtilities.dp(88.0f) - this.f24274r.getHeight()) / 2;
                        }
                    }
                }
            }
    ...
    public final void b() {
        ...
        org.telegram.ui.Cells.u6 u6Var = this.f24267i0;
    ...
    public final void c() {
        ...
        int i10 = this.R;
        if (i10 == 0) {
            k10 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19275m7, yl0Var.f30704p2);
        } else {
            k10 = i0.a.k(-16777216, 102);
        }
        this.S = k10;
        this.T = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19256l7, yl0Var.f30704p2);
        this.f24259c.setColor(this.S);
        TextPaint textPaint = this.H;
        if (i10 == 0) {
            textPaint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19295n7, yl0Var.f30704p2));
        } else {
            textPaint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, yl0Var.f30704p2));
        }
        invalidate();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (i14 == 0) {
            ...
            yl0 yl0Var = this.f24273o0;
            f11 = 8.0f;
            paint.setColor(i0.a.d(0.1f, org.telegram.ui.ActionBar.j6.v0(i15, yl0Var.f30704p2), -1));
            float dp3 = AndroidUtilities.dp(27.0f) + ceil;
            ch.d dVar = this.f24262e0;
            if (dVar != null) {
                c10 = 2;
                f12 = 24.0f;
                ...
                this.f24262e0.draw(canvas);
                f13 = 4.0f;
            } else {
                c10 = 2;
                f12 = 24.0f;
                int measuredWidth = getMeasuredWidth();
                Drawable drawable = this.f24260c0;
                f13 = 4.0f;
            ...
            paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, yl0Var.f30704p2));
            canvas.save();
        ...
        if (i14 == 0) {
        ...
        } else if (i14 == 1 && this.f24274r != null && this.V != 0.0f) {
            canvas.save();
            ...
            this.f24274r.getHeight();
            AndroidUtilities.dp(6.0f);
            rectF.set((dp6 - (((1.0f - this.f24278y) * this.G) + (this.f24278y * this.f24274r.getWidth()))) - AndroidUtilities.dp(f10), (centerY - (this.f24274r.getHeight() / 2.0f)) - AndroidUtilities.dp(f11), dp6 - AndroidUtilities.dp(f7), (this.f24274r.getHeight() / 2.0f) + centerY + AndroidUtilities.dp(f11));
            Paint paint2 = this.d;
            int alpha = paint2.getAlpha();
            TextPaint textPaint = this.H;
            int alpha2 = textPaint.getAlpha();
            paint2.setAlpha((int) (alpha * this.V));
            if (this.f24264f0 != null) {
                Rect rect = AndroidUtilities.rectTmp2;
                rectF.round(rect);
                rect.inset(-AndroidUtilities.dp(f13), -AndroidUtilities.dp(f13));
                this.f24264f0.setBounds(rect);
                this.f24264f0.draw(canvas);
            } else {
                Drawable drawable2 = this.f24261d0;
                drawable2.setBounds((int) rectF.left, (int) rectF.top, (int) rectF.right, (int) rectF.bottom);
                drawable2.setAlpha((int) (this.V * 255.0f));
                drawable2.draw(canvas);
            }
            float f20 = this.f24278y;
            if (f20 != 1.0f) {
            ...
            if (this.f24278y != 1.0f) {
                canvas.save();
                rectF.inset(AndroidUtilities.dp(f13), AndroidUtilities.dp(2.0f));
                canvas.clipRect(rectF);
                if (this.v != null) {
                    textPaint.setAlpha((int) ((1.0f - this.f24278y) * alpha2 * this.V));
                    canvas.save();
                    ...
                    canvas.translate(width, (AndroidUtilities.dp(15.0f) * i12 * this.f24278y) + height);
                    this.v.draw(canvas);
                    canvas.restore();
                }
                if (this.f24276w != null) {
                    textPaint.setAlpha((int) (alpha2 * this.V * this.f24278y));
                    canvas.save();
                    float width2 = (dp6 - this.f24276w.getWidth()) - AndroidUtilities.dp(f12);
                    float height2 = centerY - (this.f24276w.getHeight() / 2.0f);
                    if (this.E) {
                        i11 = 1;
                    } else {
                        i11 = -1;
                    }
                    canvas.translate(width2, com.google.android.gms.internal.vision.e2.z(1.0f, this.f24278y, AndroidUtilities.dp(15.0f) * i11, height2));
                    this.f24276w.draw(canvas);
                    canvas.restore();
                }
                if (this.f24277x != null) {
                    textPaint.setAlpha((int) (alpha2 * this.V));
                    canvas.save();
                    canvas.translate((dp6 - this.f24277x.getWidth()) - AndroidUtilities.dp(f12), centerY - (this.f24277x.getHeight() / 2.0f));
                    this.f24277x.draw(canvas);
                    canvas.restore();
                }
                canvas.restore();
            } else {
                textPaint.setAlpha((int) (alpha2 * this.V));
                canvas.save();
                canvas.translate((dp6 - this.f24274r.getWidth()) - AndroidUtilities.dp(f12), com.google.android.gms.internal.vision.e2.z(1.0f, this.f24278y, AndroidUtilities.dp(15.0f), centerY - (this.f24274r.getHeight() / 2.0f)));
                this.f24274r.draw(canvas);
                canvas.restore();
            }
        ...
        boolean z11 = this.f24269k0;
        if ((z11 && this.f24274r != null && this.O < 1.0f) || ((!z11 || this.f24274r == null) && this.O > 0.0f)) {
            this.P = currentTimeMillis;
            invalidate();
            if (this.f24269k0 && this.f24274r != null) {
    ...
    public final boolean onTouchEvent(android.view.MotionEvent r10) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.fl0.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public void setIsVisible(boolean z10) {
        ...
        if (this.f24256a0 != z10) {
            ...
            this.m0 = f7;
            super.setAlpha(this.f24272n0 * f7);
        }
    }
