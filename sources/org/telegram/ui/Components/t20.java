...
public final class t20 extends FrameLayout implements org.telegram.ui.Components.voip.o0 {
    ...
    public boolean O;
    public final u20 P;
    public final h9 f28416a;
    public TLRPC.User f28417b;
    public TLRPC.Chat f28418c;
    public final w9 d;
    public long e;
    public ChatObject.VideoParticipant f28419f;
    public TLRPC.GroupCallParticipant h;
    public final Paint f28420n;
    public final Paint f28421r;
    public float f28422s;
    public org.telegram.ui.Components.voip.u v;
    public String f28423w;
    public String f28424x;
    public int f28425y;
    ...
    private void setSelectedProgress(float f7) {
        if (this.G != f7) {
            this.G = f7;
            this.f28421r.setAlpha((int) (f7 * 255.0f));
        }
    }
    ...
    public final void b(boolean z10) {
        u20 u20Var = this.P;
        if (!u20Var.f28683r.isDismissed()) {
            if (z10 && this.v == null) {
                this.v = org.telegram.ui.Components.voip.u.c(u20Var.h, u20Var.f28682n, null, this, null, this.f28419f, u20Var.f28680c, u20Var.f28683r);
            } else if (!z10) {
    ...
    public final void c(Canvas canvas) {
        if (this.f28423w != null) {
            canvas.save();
            int A = org.telegram.messenger.ok.A(24.0f, getMeasuredWidth() - this.f28425y, 2);
            int alpha = (int) (getAlpha() * this.f28422s * 255.0f);
            TextPaint textPaint = this.E;
            textPaint.setAlpha(alpha);
            canvas.drawText(this.f28423w, AndroidUtilities.dp(22.0f) + A, AndroidUtilities.dp(69.0f), textPaint);
            canvas.restore();
            canvas.save();
            canvas.translate(A, AndroidUtilities.dp(53.0f));
            org.telegram.ui.id idVar = this.F;
            if (idVar.getDrawable() != null) {
                idVar.getDrawable().setAlpha((int) (getAlpha() * this.f28422s * 255.0f));
                idVar.draw(canvas);
    ...
    public final void dispatchDraw(Canvas canvas) {
        org.telegram.ui.Components.voip.u uVar = this.v;
        if (uVar != null && !uVar.f29561b && !uVar.f29580r && uVar.v && uVar.f29559a.d.isFirstFrameRendered() && uVar.getAlpha() == 1.0f && !this.P.f28683r.F2) {
            d(canvas);
            return;
        }
        if (this.f28422s > 0.0f) {
            float measuredWidth = (1.0f - this.f28422s) * (getMeasuredWidth() / 2.0f);
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(measuredWidth, measuredWidth, getMeasuredWidth() - measuredWidth, getMeasuredHeight() - measuredWidth);
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(13.0f), AndroidUtilities.dp(13.0f), this.f28420n);
            d(canvas);
        }
        w9 w9Var = this.d;
    ...
    public final void e(ChatObject.VideoParticipant videoParticipant, TLRPC.GroupCallParticipant groupCallParticipant) {
        ...
        boolean z11 = true;
        w9 w9Var = this.d;
        h9 h9Var = this.f28416a;
        if (peerId > 0) {
            TLRPC.User user = AccountInstance.getInstance(i10).getMessagesController().getUser(Long.valueOf(this.e));
            this.f28417b = user;
            this.f28418c = null;
            h9Var.m(i10, user);
            this.f28424x = UserObject.getFirstName(this.f28417b);
            w9Var.getImageReceiver().setCurrentAccount(i10);
            w9Var.h(ImageLocation.getForUser(this.f28417b, 1), "50_50", h9Var, this.f28417b);
        } else {
            TLRPC.Chat chat = AccountInstance.getInstance(i10).getMessagesController().getChat(Long.valueOf(-this.e));
            this.f28418c = chat;
            this.f28417b = null;
            h9Var.k(i10, chat);
            TLRPC.Chat chat2 = this.f28418c;
            if (chat2 != null) {
                this.f28424x = chat2.title;
                w9Var.getImageReceiver().setCurrentAccount(i10);
                w9Var.h(ImageLocation.getForChat(this.f28418c, 1), "50_50", h9Var, this.f28418c);
            }
        }
        if (j3 == this.e) {
            z10 = true;
        ...
        if (videoParticipant == null) {
            if (u20Var.f28682n.d != MessageObject.getPeerId(groupCallParticipant.peer)) {
                z11 = false;
            }
            this.H = z11;
        } else {
            ChatObject.VideoParticipant videoParticipant2 = u20Var.f28682n.e;
    ...
    public final void onAttachedToWindow() {
        ...
        u20 u20Var = this.P;
        org.telegram.ui.d60 d60Var = u20Var.f28683r;
        if (u20Var.f28684s && this.f28419f != null) {
            b(true);
        }
        this.K = true;
        if (d60Var.f33013t2.size() > 0) {
            this.I = (org.telegram.ui.Components.voip.p0) hg.c.x(1, d60Var.f33013t2);
        } else {
            this.I = new org.telegram.ui.Components.voip.p0();
        }
        org.telegram.ui.Components.voip.p0 p0Var = this.I;
        p0Var.f29459g = this;
        p0Var.f29457c = this.F;
        p0Var.c(false);
    ...
    public final void onDetachedFromWindow() {
        ...
        org.telegram.ui.Components.voip.p0 p0Var = this.I;
        if (p0Var != null) {
            this.P.f28683r.f33013t2.add(p0Var);
            org.telegram.ui.Components.voip.p0 p0Var2 = this.I;
            p0Var2.f29457c = null;
            p0Var2.c(false);
            this.I.b();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f28424x != null) {
            int min = (int) Math.min(AndroidUtilities.dp(46.0f), textPaint.measureText(this.f28424x));
            this.f28425y = min;
            this.f28423w = TextUtils.ellipsize(this.f28424x, textPaint, min, TextUtils.TruncateAt.END).toString();
        }
