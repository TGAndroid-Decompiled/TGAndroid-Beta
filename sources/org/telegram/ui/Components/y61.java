    ...
    public final void run() {
        switch (this.f30132a) {
            case 0:
                ...
                return;
            case 1:
                h71 h71Var2 = ((g71) this.f30133b).f24108f;
                h71Var2.f24525a0.removeCallbacksAndMessages(null);
                h71Var2.K.onVisualizerUpdate(false, true, null);
                return;
            case 2:
                ((j71) this.f30133b).f25155g = false;
                return;
            case 3:
                ((d91) ((j50) ((org.telegram.ui.Cells.fa) this.f30133b).f20123b).f25117b).v.b();
                return;
            default:
                ((z81) this.f30133b).d(false, true);
                return;
        }
    }
}
