...
public final class vf0 extends View {
    ...
    public float f28699r;
    public float f28700s;
    public int v;
    public int f28701w;
    public final RectF f28702x;
    ...
    public final void a() {
        ...
        boolean z10;
        if (this.f28698n) {
            i10 = Math.max(this.e, this.f28697f);
        } else {
            i10 = this.f28695b;
        }
        int i11 = 0;
    ...
    public final void b(int i10) {
        ...
        if (this.h) {
            if (this.f28696c != i10) {
                ...
                this.d = (this.f28696c * f10) + ((1.0f - f10) * f7);
            } else {
                return;
            }
        } else {
    ...
    public final void c(int i10, int i11, boolean z10) {
        ...
        int i12;
        int i13;
        int i14 = this.f28694a;
        if (!((i14 < 0 || i11 == 0 || this.f28695b == 0) ? false : false)) {
            ValueAnimator valueAnimator = this.E;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            ...
            this.f28695b = i11;
            invalidate();
        } else if (this.f28695b == i11 && (Math.abs(i14 - i10) <= 2 || this.h || this.f28698n)) {
            b(i10);
        } else {
            ...
            this.v = (getMeasuredHeight() - dp2) / Math.min(this.f28695b, 3);
            this.f28701w = (getMeasuredHeight() - dp2) / Math.min(i11, 3);
            float f7 = (this.f28694a - 1) * this.v;
            this.f28699r = f7;
            if (f7 < 0.0f) {
                this.f28699r = 0.0f;
            } else {
                int i15 = this.v;
                if (hg.k0.g(this.f28695b, 1, i12, dp) - f7 < (getMeasuredHeight() - dp) - i15) {
                    this.f28699r = hg.k0.g(this.f28695b, 1, i15, dp) - ((getMeasuredHeight() - dp) - this.v);
                }
            }
            float f10 = (i10 - 1) * this.f28701w;
            this.f28700s = f10;
            if (f10 < 0.0f) {
                this.f28700s = 0.0f;
            } else {
                int i16 = i11 - 1;
                int i17 = this.f28701w;
                if (((i13 * i16) + dp) - f10 < (getMeasuredHeight() - dp) - i17) {
                    this.f28700s = ((i16 * i17) + dp) - ((getMeasuredHeight() - dp) - this.f28701w);
                }
            }
            this.d = this.f28694a;
            this.f28696c = i10;
    ...
    public final void d() {
        int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18888ee, this.L);
        this.K = v02;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int i14;
        super.onDraw(canvas);
        if (this.f28694a >= 0 && this.f28695b != 0) {
            int dp = AndroidUtilities.dp(8.0f);
            if (this.f28698n) {
                float f10 = this.f28703y;
                measuredHeight = (this.f28701w * f10) + ((1.0f - f10) * this.v);
            } else if (this.f28695b != 0) {
                measuredHeight = (getMeasuredHeight() - (dp * 2)) / Math.min(this.f28695b, 3);
            } else {
                return;
            }
            if (measuredHeight != 0.0f) {
                ...
                if (this.f28698n) {
                    float f11 = this.f28699r;
                    float f12 = this.f28703y;
                    f7 = (this.f28700s * f12) + ((1.0f - f12) * f11);
                } else {
                    if (this.h) {
                        float f13 = this.f28703y;
                        f7 = ((this.f28696c - 1) * measuredHeight * f13) + ((1.0f - f13) * (this.d - 1.0f) * measuredHeight);
                    } else {
                        f7 = (this.f28694a - 1) * measuredHeight;
                    }
                    if (f7 < 0.0f) {
                        f7 = 0.0f;
                    } else {
                        float f14 = dp;
                        if ((((this.f28695b - 1) * measuredHeight) + f14) - f7 < (getMeasuredHeight() - dp) - measuredHeight) {
                            f7 = (((this.f28695b - 1) * measuredHeight) + f14) - ((getMeasuredHeight() - dp) - measuredHeight);
                        }
                    }
                }
                ...
                while (true) {
                    ...
                    if (f17 >= 0.0f && f16 <= getMeasuredHeight()) {
                        ...
                        boolean z10 = this.f28698n;
                        Paint paint = this.H;
                        if (z10 && max >= this.f28697f) {
                            paint.setColor(i0.a.k(this.K, (int) ((1.0f - this.f28703y) * (Color.alpha(i13) / 255.0f) * 76.0f)));
                            ...
                            paint.setColor(i0.a.k(this.K, (int) ((Color.alpha(i11) / 255.0f) * 76.0f * this.f28703y)));
                            canvas.drawRoundRect(rectF, measuredWidth, measuredWidth, paint);
                ...
                if (z11) {
                    float f18 = this.d;
                    float f19 = this.f28703y;
                    float f20 = ((((this.f28696c * f19) + ((1.0f - f19) * f18)) * measuredHeight) + f15) - f7;
                    ...
                    float f21 = ((this.f28694a * measuredHeight) + f15) - f7;
