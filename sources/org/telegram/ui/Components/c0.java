...
public final class c0 extends FrameLayout implements org.telegram.ui.ActionBar.x5 {
    ...
    public final org.telegram.ui.ActionBar.d6 f23159b;
    public int f23160c;
    public boolean d;
    public TL_aicompose.AiComposeTone e;
    public boolean f23161f;
    public final w9 h;
    public final TextView f23162n;
    ...
    public final void a(float f7, boolean z10) {
        ...
        if (!z10 && Math.abs(f7 - this.f23163r) < 0.01f) {
            return;
        }
        this.f23163r = f7;
        int i10 = org.telegram.ui.ActionBar.h6.G6;
        org.telegram.ui.ActionBar.d6 d6Var = this.f23159b;
