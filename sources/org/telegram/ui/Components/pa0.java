...
public final class pa0 extends Drawable {
    public Paint f26986a;
    public Paint f26987b;
    public long f26988c;
    public float d;
    public boolean e;
    ...
    public long f26994l;
    public org.telegram.ui.Cells.t1 f26995m;
    ...
    public final void a() {
        ...
        this.f26990g = (float) Math.ceil(Math.sqrt(com.google.android.gms.internal.vision.e2.z(i11, centerY, f10, f7 * (i10 - centerX))));
    }
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f26986a.setColorFilter(colorFilter);
    }
