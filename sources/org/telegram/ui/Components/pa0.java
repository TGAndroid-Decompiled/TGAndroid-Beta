...
public final class pa0 extends Drawable {
    public Paint f26983a;
    public Paint f26984b;
    public long f26985c;
    public float d;
    public boolean e;
    ...
    public long f26991l;
    public org.telegram.ui.Cells.t1 f26992m;
    ...
    public final void a() {
        ...
        this.f26987g = (float) Math.ceil(Math.sqrt(com.google.android.gms.internal.vision.e2.z(i11, centerY, f10, f7 * (i10 - centerX))));
    }
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f26983a.setColorFilter(colorFilter);
    }
