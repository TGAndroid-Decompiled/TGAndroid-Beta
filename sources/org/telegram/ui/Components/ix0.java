...
public final class ix0 implements Runnable {
    ...
    public final TLObject f25048b;
    public final Utilities.Callback f25049c;

    public ix0(TLObject tLObject, Utilities.Callback callback, int i10) {
        this.f25047a = i10;
        this.f25048b = tLObject;
        this.f25049c = callback;
    }
    ...
    public final void run() {
        ...
        switch (this.f25047a) {
            case 0:
                TLObject tLObject = this.f25048b;
                ...
                this.f25049c.run(Boolean.valueOf(z10));
                return;
            default:
                TLObject tLObject2 = this.f25048b;
                boolean z11 = tLObject2 instanceof TL_account.paidMessagesRevenue;
                Utilities.Callback callback = this.f25049c;
                if (z11) {
