...
public class ix0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public float I;
    public boolean J;
    public final ub1 f25188a;
    public final w9 f25189b;
    public final RadialProgressView f25190c;
    public final vh.n d;
    public final n90 e;
    public final ci.d f25191f;
    public boolean h;
    public final org.telegram.ui.ActionBar.d6 f25192n;
    public int f25193r;
    public final View f25194s;
    public int v;
    public final int f25195w;
    public boolean f25196x;
    public final org.telegram.ui.Cells.t6 f25197y;
    ...
    public final void b(int i10, boolean z10) {
        if (this.v != i10) {
            ...
            float f7 = i12 + i11;
            RadialProgressView radialProgressView = this.f25190c;
            ub1 ub1Var = this.f25188a;
            if (z10) {
        ...
        if (i11 != 0) {
            ...
            if (i11 != 1) {
                ...
                if (i11 == 16) {
                    ...
                    if (stickerSetByName != null && (i10 = this.f25193r) >= 0 && i10 < stickerSetByName.documents.size()) {
                        document2 = stickerSetByName.documents.get(this.f25193r);
                    }
    ...
    public void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f25195w).addObserver(this, NotificationCenter.diceStickersDidLoad);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f25195w).removeObserver(this, NotificationCenter.diceStickersDidLoad);
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if ((this.E || this.f25196x) && (i14 = this.F) > 0 && i14 != getMeasuredHeight()) {
            float measuredHeight = (this.F - getMeasuredHeight()) / 2.0f;
            ub1 ub1Var = this.f25188a;
            ub1Var.setTranslationY(ub1Var.getTranslationY() + measuredHeight);
            if (!this.f25196x) {
                ub1Var.animate().translationY(0.0f).setInterpolator(rr.f28030f).setDuration(250L);
            }
            RadialProgressView radialProgressView = this.f25190c;
            if (radialProgressView != null) {
                radialProgressView.setTranslationY(radialProgressView.getTranslationY() + measuredHeight);
                if (!this.f25196x) {
                    radialProgressView.animate().translationY(0.0f).setInterpolator(rr.f28030f).setDuration(250L);
                }
            }
        }
    ...
    public void setPreventMoving(boolean z10) {
        this.f25196x = z10;
        if (!z10) {
            this.f25188a.setTranslationY(0.0f);
            RadialProgressView radialProgressView = this.f25190c;
            if (radialProgressView != null) {
    ...
    public ix0(Context context, View view, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f25195w = UserConfig.selectedAccount;
        this.f25197y = new org.telegram.ui.Cells.t6(this, 25);
        ...
        if (view == null) {
            ...
            this.f25190c = radialProgressView;
            radialProgressView.setAlpha(0.0f);
            radialProgressView.setScaleY(0.5f);
            radialProgressView.setScaleX(0.5f);
