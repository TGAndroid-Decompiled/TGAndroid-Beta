...
public class ix0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public float I;
    public boolean J;
    public final ub1 f25163a;
    public final w9 f25164b;
    public final RadialProgressView f25165c;
    public final vh.n d;
    public final n90 e;
    public final ci.d f25166f;
    public boolean h;
    public final org.telegram.ui.ActionBar.d6 f25167n;
    public int f25168r;
    public final View f25169s;
    public int v;
    public final int f25170w;
    public boolean f25171x;
    public final org.telegram.ui.Cells.t6 f25172y;
    ...
    public final void b(int i10, boolean z10) {
        if (this.v != i10) {
            ...
            float f7 = i12 + i11;
            RadialProgressView radialProgressView = this.f25165c;
            ub1 ub1Var = this.f25163a;
            if (z10) {
    ...
    public final void c() {
        ...
        int i10;
        int i11 = this.f25168r;
        w9 w9Var = this.f25164b;
        if (i11 != 0) {
            boolean z10 = true;
            if (i11 != 1) {
                ...
                if (i11 == 16) {
                    ...
                    if (stickerSetByName != null && (i10 = this.f25168r) >= 0 && i10 < stickerSetByName.documents.size()) {
                        document2 = stickerSetByName.documents.get(this.f25168r);
                    }
    ...
    public void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f25170w).addObserver(this, NotificationCenter.diceStickersDidLoad);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f25170w).removeObserver(this, NotificationCenter.diceStickersDidLoad);
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if ((this.E || this.f25171x) && (i14 = this.F) > 0 && i14 != getMeasuredHeight()) {
            float measuredHeight = (this.F - getMeasuredHeight()) / 2.0f;
            ub1 ub1Var = this.f25163a;
            ub1Var.setTranslationY(ub1Var.getTranslationY() + measuredHeight);
            if (!this.f25171x) {
                ub1Var.animate().translationY(0.0f).setInterpolator(rr.f28022f).setDuration(250L);
            }
            RadialProgressView radialProgressView = this.f25165c;
            if (radialProgressView != null) {
                radialProgressView.setTranslationY(radialProgressView.getTranslationY() + measuredHeight);
                if (!this.f25171x) {
                    radialProgressView.animate().translationY(0.0f).setInterpolator(rr.f28022f).setDuration(250L);
                }
            }
        }
    ...
    public void setPreventMoving(boolean z10) {
        this.f25171x = z10;
        if (!z10) {
            this.f25163a.setTranslationY(0.0f);
            RadialProgressView radialProgressView = this.f25165c;
            if (radialProgressView != null) {
    ...
    public ix0(Context context, View view, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f25170w = UserConfig.selectedAccount;
        this.f25172y = new org.telegram.ui.Cells.t6(this, 25);
        this.G = org.telegram.ui.ActionBar.h6.f19028c7;
        this.f25167n = d6Var;
        this.f25169s = view;
        this.f25168r = i10;
        ...
        if (view == null) {
            ...
            this.f25165c = radialProgressView;
            radialProgressView.setAlpha(0.0f);
            radialProgressView.setScaleY(0.5f);
            radialProgressView.setScaleX(0.5f);
