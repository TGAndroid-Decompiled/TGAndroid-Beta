...
public final class si0 extends Drawable {
    public Path f28251a;
    public Paint f28252b;
    public float f28253c;

    public final void a() {
        int dp = AndroidUtilities.dp(18.0f);
        Path path = this.f28251a;
        path.reset();
        float f7 = dp >> 1;
        ...
        Paint paint = this.f28252b;
        paint.setStyle(Paint.Style.FILL_AND_STROKE);
        paint.setStrokeJoin(Paint.Join.ROUND);
        paint.setStrokeWidth(AndroidUtilities.dpf2(1.0f));
        this.f28253c = AndroidUtilities.density;
    }

    @Override
    public final void draw(Canvas canvas) {
        Paint paint = this.f28252b;
        if (this.f28253c != AndroidUtilities.density) {
            a();
        }
        canvas.save();
        canvas.translate(getBounds().left, getBounds().top);
        canvas.drawPath(this.f28251a, paint);
