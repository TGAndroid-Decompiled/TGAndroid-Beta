...
public final class si0 implements LeadingMarginSpan {
    ...
    public final ri0 f27875s;
    public ii.z5 v;
    public final Drawable f27876w;
    public final Paint f27877x;
    public final float[] f27878y;

    public si0(boolean z10, boolean z11, ri0 ri0Var) {
        Paint paint = new Paint(1);
        this.f27877x = paint;
        this.f27878y = new float[8];
        this.E = new Path();
        ...
        this.f27875s = ri0Var;
        this.e = z11;
        this.f27876w = ApplicationLoader.applicationContext.getResources().getDrawable(R.drawable.mini_quote).mutate();
    ...
    public static void a(SpannableStringBuilder spannableStringBuilder) {
        ...
        while (true) {
            ...
            spannableStringBuilder.removeSpan(ri0Var.f27636a);
            i13++;
        }
    ...
    public static void b(Spannable spannable, int i10, int i11, boolean z10) {
        ...
        metricAffectingSpan.f27636a = si0Var;
        si0Var.f27871c = clamp;
        si0Var.d = clamp2;
    ...
    public static java.util.ArrayList d(org.telegram.ui.Components.du r19, android.text.Layout r20, java.util.ArrayList r21, boolean[] r22) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.si0.d(org.telegram.ui.Components.du, android.text.Layout, java.util.ArrayList, boolean[]):java.util.ArrayList");
    }
