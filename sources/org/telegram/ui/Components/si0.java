...
public final class si0 extends Drawable {
    public Path f28179a;
    public Paint f28180b;
    public float f28181c;

    public final void a() {
        int dp = AndroidUtilities.dp(18.0f);
        Path path = this.f28179a;
        path.reset();
        float f7 = dp >> 1;
        ...
        Paint paint = this.f28180b;
        paint.setStyle(Paint.Style.FILL_AND_STROKE);
        paint.setStrokeJoin(Paint.Join.ROUND);
        paint.setStrokeWidth(AndroidUtilities.dpf2(1.0f));
        this.f28181c = AndroidUtilities.density;
    }

    @Override
    public final void draw(Canvas canvas) {
        Paint paint = this.f28180b;
        if (this.f28181c != AndroidUtilities.density) {
            a();
        }
        canvas.save();
        canvas.translate(getBounds().left, getBounds().top);
        canvas.drawPath(this.f28179a, paint);
