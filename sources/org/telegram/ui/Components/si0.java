...
public final class si0 extends Drawable {
    public Path f28259a;
    public Paint f28260b;
    public float f28261c;

    public final void a() {
        int dp = AndroidUtilities.dp(18.0f);
        Path path = this.f28259a;
        path.reset();
        float f7 = dp >> 1;
        ...
        Paint paint = this.f28260b;
        paint.setStyle(Paint.Style.FILL_AND_STROKE);
        paint.setStrokeJoin(Paint.Join.ROUND);
        paint.setStrokeWidth(AndroidUtilities.dpf2(1.0f));
        this.f28261c = AndroidUtilities.density;
    }

    @Override
    public final void draw(Canvas canvas) {
        Paint paint = this.f28260b;
        if (this.f28261c != AndroidUtilities.density) {
            a();
        }
        canvas.save();
        canvas.translate(getBounds().left, getBounds().top);
        canvas.drawPath(this.f28259a, paint);
