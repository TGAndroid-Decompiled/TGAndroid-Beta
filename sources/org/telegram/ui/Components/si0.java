...
public final class si0 implements LeadingMarginSpan {
    ...
    public final ri0 f27872s;
    public ii.z5 v;
    public final Drawable f27873w;
    public final Paint f27874x;
    public final float[] f27875y;

    public si0(boolean z10, boolean z11, ri0 ri0Var) {
        Paint paint = new Paint(1);
        this.f27874x = paint;
        this.f27875y = new float[8];
        this.E = new Path();
        ...
        this.f27872s = ri0Var;
        this.e = z11;
        this.f27873w = ApplicationLoader.applicationContext.getResources().getDrawable(R.drawable.mini_quote).mutate();
    ...
    public static void a(SpannableStringBuilder spannableStringBuilder) {
        ...
        while (true) {
            ...
            spannableStringBuilder.removeSpan(ri0Var.f27633a);
            i13++;
        }
    ...
    public static void b(Spannable spannable, int i10, int i11, boolean z10) {
        ...
        metricAffectingSpan.f27633a = si0Var;
        si0Var.f27868c = clamp;
        si0Var.d = clamp2;
