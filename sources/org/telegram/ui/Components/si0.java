...
public final class si0 extends Drawable {
    public Path f28258a;
    public Paint f28259b;
    public float f28260c;

    public final void a() {
        int dp = AndroidUtilities.dp(18.0f);
        Path path = this.f28258a;
        path.reset();
        float f7 = dp >> 1;
        ...
        this.f28260c = AndroidUtilities.density;
    }

    @Override
    public final void draw(Canvas canvas) {
        Paint paint = this.f28259b;
        if (this.f28260c != AndroidUtilities.density) {
            a();
        }
        canvas.save();
        canvas.translate(getBounds().left, getBounds().top);
        canvas.drawPath(this.f28258a, paint);
