...
public final class bo implements n8 {
    public final org.telegram.ui.ActionBar.m1[] f23031a;
    public final fo f23032b;

    public bo(fo foVar, org.telegram.ui.ActionBar.m1[] m1VarArr) {
        this.f23032b = foVar;
        this.f23031a = m1VarArr;
    }

    @Override
    public final void U0(int i10, int i11) {
        int i12;
        org.telegram.ui.wn wnVar = this.f23032b.G;
        if (wnVar != null) {
    ...
    public final void dismiss() {
        org.telegram.ui.ActionBar.m1 m1Var = this.f23031a[0];
        if (m1Var != null) {
            m1Var.dismiss();
        }
    }
