...
public final class bo extends LinearLayout {
    public final org.telegram.ui.ActionBar.g6 f25667a;
    public final TextView f25668b;
    public final ArrayList f25669c;
    ...
    public bo(Activity activity, View view, int i10, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        paint = paint == null ? org.telegram.ui.ActionBar.k6.S0("paintChatActionBackground") : paint;
        int i15 = org.telegram.ui.ActionBar.k6.f21600a;
        setBackground(new org.telegram.ui.ActionBar.x5(this, view, dp, paint));
        ...
        if (i10 == 0) {
            ...
            imageView.d();
            addView((View) imageView, k7.c6.t(-2, -2, 49, 0, 2, 0, 0));
        }
        ...
        addView(textView3, k7.c6.t(-2, -2, i16, 0, 8, 0, i12));
        for (int i17 = 0; i17 < 4; i17++) {
            ...
            addView(h, k7.c6.t(-2, -2, i13, 0, 8, 0, 0));
            ImageView imageView2 = new ImageView(activity);
            int i18 = org.telegram.ui.ActionBar.k6.ic;
            imageView2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.k6.v0(i18, this.f25667a), PorterDuff.Mode.MULTIPLY));
            if (i10 == 0) {
            ...
            textView4.setTextColor(org.telegram.ui.ActionBar.k6.v0(i18, this.f25667a));
            this.f25669c.add(textView4);
            if (LocaleController.isRTL) {
                i14 = 5;
            } else {
                i14 = 3;
            ...
            if (LocaleController.isRTL) {
                ...
                if (i10 == 0) {
                    h.addView(imageView2, k7.c6.k(8.0f, 3.0f, 0.0f, 0.0f, -2, -2));
                } else if (i10 == 2) {
                    h.addView(imageView2, k7.c6.k(8.0f, 7.0f, 0.0f, 0.0f, -2, -2));
                } else {
                    h.addView(imageView2, k7.c6.k(8.0f, 3.0f, 0.0f, 0.0f, -2, -2));
                }
            } else {
                if (i10 == 0) {
                    h.addView(imageView2, k7.c6.k(0.0f, 4.0f, 8.0f, 0.0f, -2, -2));
                } else if (i10 == 2) {
                    h.addView(imageView2, k7.c6.k(0.0f, 8.0f, 8.0f, 0.0f, -2, -2));
                } else {
                    h.addView(imageView2, k7.c6.k(0.0f, 4.0f, 8.0f, 0.0f, -2, -2));
                }
                h.addView(textView4, k7.c6.n(-2, -2));
    ...
    public void setStatusText(CharSequence charSequence) {
        this.f25668b.setText(charSequence);
    }
    ...
    public void setTextColor(int i10) {
        ...
        int i12 = 0;
        while (true) {
            ArrayList arrayList = this.f25669c;
        ...
        while (true) {
            ...
            if (i11 < arrayList2.size()) {
                ((ImageView) arrayList2.get(i11)).setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.ic, this.f25667a), PorterDuff.Mode.MULTIPLY));
                i11++;
            } else {
                return;
            }
