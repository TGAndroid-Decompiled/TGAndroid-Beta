...
public final class bo implements n8 {
    public final org.telegram.ui.ActionBar.m1[] f23058a;
    public final fo f23059b;

    public bo(fo foVar, org.telegram.ui.ActionBar.m1[] m1VarArr) {
        this.f23059b = foVar;
        this.f23058a = m1VarArr;
    }

    @Override
    public final void U0(int i10, int i11) {
        int i12;
        org.telegram.ui.wn wnVar = this.f23059b.G;
        if (wnVar != null) {
    ...
    public final void dismiss() {
        org.telegram.ui.ActionBar.m1 m1Var = this.f23058a[0];
        if (m1Var != null) {
            m1Var.dismiss();
        }
    }
