...
public final class mu0 extends uk0 {
    ...
    public final String F(int i10) {
        ArrayList arrayList = this.f26272f.f30655t1[this.d].e;
    ...
    public final void J(ml0 ml0Var) {
        if (this.e) {
            ...
            if (i10 == 0) {
                this.f26272f.S(this.d, ml0Var, true);
            }
        }
    }
    ...
    public final int h() {
        int i10;
        int i11;
        ou0[] ou0VarArr = this.f26272f.f30655t1;
        int i12 = this.d;
        ou0 ou0Var = ou0VarArr[i12];
        if (ou0Var.f26863o) {
            return ou0Var.e();
        }
        if (ou0Var.f26852a.size() == 0 && !ou0VarArr[i12].f26856g) {
            return 1;
        }
        if (ou0VarArr[i12].f26852a.size() == 0) {
            ou0 ou0Var2 = ou0VarArr[i12];
            boolean[] zArr = ou0Var2.f26857i;
            if ((!zArr[0] || !zArr[1]) && ou0Var2.f26860l) {
                return 0;
            }
        }
        if (ou0VarArr[i12].e() == 0) {
            ...
            if (size != 0) {
                ...
                boolean[] zArr2 = ou0Var3.f26857i;
                if (!zArr2[0] || !zArr2[1]) {
                    boolean z10 = ou0Var3.f26866r;
                    if (z10) {
                        i10 = ou0Var3.f26869u;
                    } else {
                        i10 = ou0Var3.f26862n;
    ...
    public final int j(int i10) {
        ou0[] ou0VarArr = this.f26272f.f30655t1;
        int i11 = this.d;
        if (ou0VarArr[i11].f26854c.size() == 0 && !ou0VarArr[i11].f26856g) {
            return 9;
        }
        ou0 ou0Var = ou0VarArr[i11];
        int i12 = ou0Var.f26861m;
        if (i10 >= i12 && i10 < ou0Var.f26852a.size() + i12) {
            if (i11 != 2 && i11 != 4) {
                return 7;
            }
            return 10;
    ...
    @Override
    public final int k() {
        return this.f26272f.f30655t1[this.d].e();
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        boolean z11;
        char c11;
        zu0 zu0Var = this.f26272f;
        long j3 = zu0Var.f30634j1;
        SparseArray[] sparseArrayArr = zu0Var.Z0;
        ou0 ou0Var = zu0Var.f30655t1[this.d];
        ArrayList arrayList = ou0Var.f26852a;
        ...
        if (i11 != 7) {
            if (i11 == 10 && (view instanceof org.telegram.ui.Cells.i7)) {
                ...
                MessageObject messageObject = (MessageObject) arrayList.get(i10 - ou0Var.f26861m);
                ...
                if (zu0Var.C1) {
                    ...
                    i7Var.e(z12, !zu0Var.f30614b1);
                    return;
                }
                i7Var.e(false, !zu0Var.f30614b1);
            }
        } else if (!(view instanceof org.telegram.ui.Cells.j7)) {
        } else {
            org.telegram.ui.Cells.j7 j7Var = (org.telegram.ui.Cells.j7) view;
            MessageObject messageObject2 = (MessageObject) arrayList.get(i10 - ou0Var.f26861m);
            if (i10 != arrayList.size() - 1) {
                z10 = true;
            } else {
                z10 = false;
            ...
            if (zu0Var.C1) {
                ...
                j7Var.b(z12, !zu0Var.f30614b1);
                return;
            }
            j7Var.b(false, !zu0Var.f30614b1);
        }
    }
        ...
        if (i10 != 7) {
            ...
            if (i10 != 8) {
                if (i10 != 9) {
                    ...
                    mt0 M = zu0.M(i11, zu0Var.f30634j1, context, f6Var);
