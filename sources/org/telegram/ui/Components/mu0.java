...
public final class mu0 extends hl0 {
    public final Context f26250r;
    public final yu0 f26251s;
    ...
    public final int M(int i10) {
        nu0[] nu0VarArr = this.f26251s.f30385t1;
        int i11 = 1;
        if ((nu0VarArr[3].f26577c.size() == 0 && !nu0VarArr[3].f26579g) || i10 >= nu0VarArr[3].f26577c.size()) {
            return 1;
        }
        nu0 nu0Var = nu0VarArr[3];
        int size = ((ArrayList) nu0Var.d.get(nu0Var.f26577c.get(i10))).size();
        if (i10 == 0) {
            i11 = 0;
        }
        return size + i11;
    ...
    public final int P(int i10, int i11) {
        nu0[] nu0VarArr = this.f26251s.f30385t1;
        if (nu0VarArr[3].f26577c.size() == 0 && !nu0VarArr[3].f26579g) {
            return 5;
        }
        if (i10 < nu0VarArr[3].f26577c.size()) {
            if (i10 != 0 && i11 == 0) {
                return 3;
            }
            return 4;
    ...
    public final View T(int i10, View view) {
        yu0 yu0Var = this.f26251s;
        if (view == null) {
            view = new org.telegram.ui.Cells.v3(this.f26250r, 28, yu0Var.F1);
        }
        if (i10 == 0) {
            view.setAlpha(0.0f);
            return view;
        }
        if (i10 < yu0Var.f30385t1[3].f26577c.size()) {
            view.setAlpha(1.0f);
            ((org.telegram.ui.Cells.v3) view).setText(LocaleController.formatSectionDate(((MessageObject) ((ArrayList) yu0Var.f30385t1[3].d.get((String) yu0Var.f30385t1[3].f26577c.get(i10))).get(0)).messageOwner.date));
        }
        return view;
    }
    ...
    public final void W(int i10, int i11, s4.c1 c1Var) {
        ...
        if (i12 != 6 && i12 != 5) {
            ArrayList arrayList = (ArrayList) nu0VarArr[3].d.get((String) nu0VarArr[3].f26577c.get(i10));
            ...
            if (i13 != 3) {
                if (i13 == 4) {
                    ...
                    if ((view instanceof org.telegram.ui.Cells.n7) && i11 >= 0 && i11 < arrayList.size()) {
                        ...
                        if (i11 == arrayList.size() - 1 && (i10 != nu0VarArr[3].f26577c.size() - 1 || !nu0VarArr[3].f26579g)) {
                            z10 = false;
                        } else {
                            z10 = true;
                        }
                        ...
                        if (yu0Var.C1) {
                            ...
                            n7Var.f(z11, !yu0Var.f30344b1);
                            return;
                        }
                        n7Var.f(false, !yu0Var.f30344b1);
                        return;
                    }
                    return;
                }
        ...
        if (i10 != 3) {
            if (i10 != 4) {
                if (i10 != 5) {
                    ...
                    lt0 M = yu0.M(3, yu0Var.f30364j1, context, e6Var);
