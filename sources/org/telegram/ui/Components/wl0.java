...
public final class wl0 extends mw0 {
    public float d;
    public final Paint f29693f;
    public boolean f29690a = false;
    public long f29691b = 0;
    public boolean f29692c = false;
    public int e = 1;

    public wl0(boolean z10) {
        if (z10) {
            this.f29693f = new Paint(1);
        }
    }

    @Override
    public final void b(int i10) {
        Paint paint = this.f29693f;
        if (paint != null) {
            paint.setColor(i10);
        }
    }
    ...
    @Override
    public final void d() {
        this.f29691b = System.currentTimeMillis();
        this.f29692c = true;
        invalidateSelf();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        Paint paint = this.f29693f;
        if (paint == null) {
            paint = org.telegram.ui.ActionBar.j6.f18841c2;
        }
        ...
        if (this.f29692c) {
            ...
            long j3 = currentTimeMillis - this.f29691b;
            this.f29691b = currentTimeMillis;
            if (j3 > 50) {
                j3 = 50;
            }
            float f10 = this.d;
