...
public abstract class g9 extends FrameLayout {
    ...
    public final TLRPC.TL_emojiList f24400n;
    public final int f24401r;
    public int f24402s;
    public int v;
    public float f24403w;
    public boolean f24404x;
    public final f9 f24405y;
    ...
    public g9(Context context) {
        ...
        this.v = 0;
        this.f24403w = 1.0f;
        this.f24405y = new f9((hm) this);
        TLRPC.TL_emojiList a2 = a(i10);
        this.f24400n = a2;
        this.f24398c = new w9(context);
        this.d = new w9(context);
        addView(this.f24398c, w7.y5.e(50, 50, 1));
        addView(this.d, w7.y5.e(50, 50, 1));
        if (!a2.document_id.isEmpty()) {
            q5 q5Var = new q5(4, i10, a2.document_id.get(0).longValue());
            this.f24396a = q5Var;
            this.f24398c.setAnimatedEmojiDrawable(q5Var);
            b();
        }
        int[] iArr = e9.f23877c0[this.f24402s];
        int i11 = iArr[0];
        int i12 = iArr[1];
        int i13 = iArr[2];
        int i14 = iArr[3];
    ...
    public final void b() {
        ...
        int i10 = this.v + 1;
        TLRPC.TL_emojiList tL_emojiList = this.f24400n;
        if (i10 > tL_emojiList.document_id.size() - 1) {
            this.f24404x = true;
            return;
        }
        q5 q5Var = new q5(4, this.f24401r, tL_emojiList.document_id.get(i10).longValue());
        this.f24397b = q5Var;
        q5Var.f27507m = true;
        q5Var.v();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        p20 p20Var2 = this.f24399f;
        if (p20Var2 != null) {
            p20Var2.b(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
        }
        float f7 = this.f24403w;
        if (f7 == 1.0f) {
            this.e.f27248c.setAlpha(255);
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), this.e.f27248c);
            this.f24398c.setAlpha(1.0f);
            this.f24398c.setScaleX(1.0f);
            this.f24398c.setScaleY(1.0f);
            this.d.setAlpha(0.0f);
        } else {
            float interpolation = rr.f28031f.getInterpolation(f7);
            this.e.f27248c.setAlpha(255);
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), this.e.f27248c);
            this.f24399f.f27248c.setAlpha((int) (255.0f * interpolation));
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), this.f24399f.f27248c);
            this.f24403w += 0.064f;
            float f10 = 1.0f - interpolation;
            this.f24398c.setAlpha(f10);
            this.f24398c.setScaleX(f10);
            this.f24398c.setScaleY(f10);
            this.f24398c.setPivotY(0.0f);
            ...
            if (this.f24403w > 1.0f) {
                this.f24403w = 1.0f;
                this.e = this.f24399f;
                w9 w9Var2 = this.f24398c;
                this.f24398c = this.d;
                this.d = w9Var2;
            }
            invalidate();
    ...
    public final void onAttachedToWindow() {
        ...
        AndroidUtilities.runOnUIThread(this.f24405y, 1000L);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        AndroidUtilities.cancelRunOnUIThread(this.f24405y);
    }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        ViewGroup.LayoutParams layoutParams = this.f24398c.getLayoutParams();
        this.f24398c.getLayoutParams().height = i12;
        layoutParams.width = i12;
        ViewGroup.LayoutParams layoutParams2 = this.d.getLayoutParams();
        this.d.getLayoutParams().height = i12;
        layoutParams2.width = i12;
        ((FrameLayout.LayoutParams) this.f24398c.getLayoutParams()).topMargin = i13;
