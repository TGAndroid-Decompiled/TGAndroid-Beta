...
public final class ad0 extends Dialog implements org.telegram.ui.ActionBar.a5 {
    public final ActionBarLayout f24341a;
    public final FrameLayout f24342b;
    public final sd0 f24343c;

    public ad0(Context context) {
        super(context, R.style.TransparentDialog);
        ActionBarLayout actionBarLayout = new ActionBarLayout(context, false);
        this.f24341a = actionBarLayout;
    ...
    public final boolean l(ActionBarLayout actionBarLayout, org.telegram.ui.ActionBar.b5 b5Var) {
        org.telegram.ui.ActionBar.n2 n2Var = b5Var.f20269a;
        return true;
    }

    @Override
    public final void onBackPressed() {
        if (this.f24343c.getVisibility() == 0) {
        ...
        ActionBarLayout actionBarLayout = this.f24341a;
        actionBarLayout.G();
        if (actionBarLayout.getFragmentStack().size() <= 1) {
            dismiss();
        }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        FrameLayout frameLayout = this.f24342b;
        frameLayout.setSystemUiVisibility(1280);
        frameLayout.setOnApplyWindowInsetsListener(new org.telegram.ui.ActionBar.g3(2));
        if (i10 >= 26) {
            if (i0.a.f(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20664d6, true)) < 0.9d) {
                z10 = false;
            }
    ...
    public final void onStart() {
        ...
        if (context instanceof LaunchActivity) {
            ((LaunchActivity) context).B0.add(this.f24343c);
        }
    }
    ...
    public final void onStop() {
        ...
        if (context instanceof LaunchActivity) {
            ((LaunchActivity) context).B0.remove(this.f24343c);
        }
    }
