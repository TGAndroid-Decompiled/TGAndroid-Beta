...
public final class ad0 extends Dialog implements org.telegram.ui.ActionBar.a5 {
    public final ActionBarLayout f24368a;
    public final FrameLayout f24369b;
    public final sd0 f24370c;

    public ad0(Context context) {
        super(context, R.style.TransparentDialog);
        ActionBarLayout actionBarLayout = new ActionBarLayout(context, false);
        this.f24368a = actionBarLayout;
    ...
    public final void onBackPressed() {
        if (this.f24370c.getVisibility() == 0) {
        ...
        ActionBarLayout actionBarLayout = this.f24368a;
        actionBarLayout.G();
        if (actionBarLayout.getFragmentStack().size() <= 1) {
            dismiss();
        }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        FrameLayout frameLayout = this.f24369b;
        frameLayout.setSystemUiVisibility(1280);
        frameLayout.setOnApplyWindowInsetsListener(new org.telegram.ui.ActionBar.g3(2));
        if (i10 >= 26) {
            if (i0.a.f(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20691d6, true)) < 0.9d) {
                z10 = false;
            }
    ...
    public final void onStart() {
        ...
        if (context instanceof LaunchActivity) {
            ((LaunchActivity) context).B0.add(this.f24370c);
        }
    }
    ...
    public final void onStop() {
        ...
        if (context instanceof LaunchActivity) {
            ((LaunchActivity) context).B0.remove(this.f24370c);
        }
    }
