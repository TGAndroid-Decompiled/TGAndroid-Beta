...
public abstract class b81 extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final Path V;
    public long W;
    public boolean f22912a;
    public long f22913a0;
    public d6 f22914b;
    public int f22915b0;
    public long f22916c;
    public int f22917c0;
    public Uri d;
    public ArrayList f22918d0;
    public Runnable e;
    public TLRPC.Document f22919e0;
    public z71 f22920f;
    public String f22921f0;
    public int f22922g0;
    public float h;
    public int f22923n;
    public int f22924r;
    ...
    public Bitmap v;
    public Bitmap f22926w;
    public final Drawable f22927x;
    public String f22928y;

    public b81(Context context, org.telegram.ui.ir0 ir0Var) {
        super(context);
        this.f22923n = -1;
        ...
        this.f22922g0 = -1;
        setVisibility(4);
        this.f22927x = context.getResources().getDrawable(R.drawable.videopreview);
    ...
    public final void a() {
        ...
        if (this.f22920f != null) {
            Utilities.globalQueue.cancelRunnable(this.f22920f);
            this.f22920f = null;
        }
        d6 d6Var = this.f22914b;
        if (d6Var != null) {
            AnimatedFileDrawableStream animatedFileDrawableStream = d6Var.f23539u0;
            if (animatedFileDrawableStream != null) {
                animatedFileDrawableStream.cancel(true);
            }
            if (d6Var.f23519d0 != null) {
                d6Var.f23519d0.h();
            }
        }
    ...
    public final void b(int i10) {
        int i11 = this.f22922g0;
        if (i11 == i10) {
            return;
        }
        if (i10 == -1) {
            NotificationCenter.getInstance(i11).removeObserver(this, NotificationCenter.fileLoaded);
            NotificationCenter.getInstance(this.f22922g0).removeObserver(this, NotificationCenter.fileLoadFailed);
        } else {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.fileLoaded) {
            if (((String) objArr[0]).equals(this.f22921f0)) {
                File pathToAttach = FileLoader.getInstance(i11).getPathToAttach(this.f22919e0);
        ...
        } else if (i10 == NotificationCenter.fileLoadFailed && ((String) objArr[0]).equals(this.f22921f0)) {
            this.f22921f0 = null;
            this.f22919e0 = null;
            b(-1);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Drawable drawable = this.f22927x;
        if (z10) {
            canvas.save();
            Path path = this.V;
            path.rewind();
            ...
            canvas.drawText(this.f22928y, (getMeasuredWidth() - this.E) / 2.0f, getMeasuredHeight() - AndroidUtilities.dp(9.0f), textPaint);
        } else if (this.f22926w != null && this.G != null) {
            Matrix matrix = this.L;
            matrix.reset();
            float measuredWidth = getMeasuredWidth() / this.f22926w.getWidth();
