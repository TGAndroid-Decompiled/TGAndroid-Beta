...
public final class pk extends tl0 {
    public long E;
    public long F;
    public int G;
    public String I;
    ...
    public boolean V;
    public final qk X;
    public final Context f27402r;
    public lk v;
    public kd f27404w;
    public long f27405x;
    public gg.q0 f27406y;
    public ArrayList f27403s = new ArrayList();
    ...
    public final Object O(int i10, int i11) {
        ...
        int i12;
        if (i10 == 0) {
            if (i11 < this.f27403s.size()) {
                return this.f27403s.get(i11);
            }
            return null;
        }
        int i13 = i10 - 1;
    ...
    public final int P(int i10, int i11) {
        ...
        int i12 = i10 - 1;
        if (i12 < this.P.size()) {
            if ((i12 != 0 || !this.f27403s.isEmpty()) && i11 == 0) {
                return 0;
            }
            return 4;
        }
    ...
    public final View T(int i10, View view) {
        ...
        if (v3Var == null) {
            Context context = this.f27402r;
            qk qkVar = this.X;
            v3Var = new org.telegram.ui.Cells.v3(context, qkVar.f27042a);
            v3Var.setBackgroundColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.e7, qkVar.f27042a) & (-218103809));
        }
        if (i10 != 0 && (i10 != 1 || !this.f27403s.isEmpty())) {
            int i11 = i10 - 1;
            ArrayList arrayList = this.P;
            if (i11 < arrayList.size()) {
                v3Var.setAlpha(1.0f);
            ...
            if (i13 != 0) {
                if (i13 == 1 || i13 == 4) {
                    ...
                    if (i10 == 0) {
                        ...
                        int i14 = kkVar.f25745a;
                        if (i14 != 0) {
                            k7Var.d(kkVar.f25746b, kkVar.f25747c, null, null, i14, false);
                        } else {
                            k7Var.d(kkVar.f25746b, kkVar.f25747c, kkVar.d.toUpperCase().substring(0, Math.min(kkVar.d.length(), 4)), kkVar.e, 0, false);
                        }
                    ...
                    if (arrayList2 != null) {
                        ...
                        k7Var.getViewTreeObserver().addOnPreDrawListener(new ok(this, k7Var, messageObject, z10, 0));
                        return;
                    }
                    return;
                }
        ...
        ?? r02 = new Runnable() {
            ...
            public final void run() {
                ...
                if (j15 != 0) {
                    ...
                    tL_messages_search.filter = pkVar.f27406y.e;
                    ...
                    tL_messages_searchGlobal2.filter = pkVar.f27406y.e;
                    if (j16 > 0) {
                ...
                connectionsManager.sendRequest(tL_messages_searchGlobal, new RequestDelegate() {
                    ...
                    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                        ...
                        AndroidUtilities.runOnUIThread(new ei.t3(pk.this, i12, tL_error, tLObject, accountInstance3, z13, str7, arrayList9, j15, j16, arrayList8, arrayList7));
                    }
                });
            }
        };
    ...
    public final void a0(java.util.ArrayList r12, java.util.ArrayList r13, boolean r14) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.pk.a0(java.util.ArrayList, java.util.ArrayList, boolean):void");
    }
        ...
        if (i10 != 0) {
            ...
            if (i10 != 1) {
                if (i10 != 2) {
                    ...
                    v00 v00Var = new v00(context, qkVar.f27042a);
            ...
            org.telegram.ui.Cells.k7 k7Var = new org.telegram.ui.Cells.k7(context, i11, qkVar.f27042a);
