...
public final class jc0 extends Drawable {
    ...
    public jc0(Context context) {
        ...
        this.f25255c = paint2;
        this.d = new e6(new ac0(this, 2), 200L, rr.f27702g, 0);
        this.f25253a = context.getResources().getDrawable(R.drawable.filled_sound_on).mutate();
    ...
    public final void draw(Canvas canvas) {
        ...
        Drawable drawable = this.f25253a;
        ...
        if (e > 0.0f) {
            ...
            float f11 = centerY;
            float f12 = dp;
            canvas.drawLine(f10, f11, f12, f7, this.f25255c);
            Paint paint = this.f25254b;
