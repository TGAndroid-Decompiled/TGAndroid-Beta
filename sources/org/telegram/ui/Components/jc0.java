...
public final class jc0 extends Drawable {
    public final int f25954a = 0;
    public final Paint f25955b;
    public final Paint f25956c;
    public final Paint d;
    public final Path e;
    public boolean f25957f;
    public final Object f25958g;
    ...
    public jc0() {
        ...
        this.d = paint3;
        this.f25958g = new z5(new cc0(this, 1), 320L, nr.h, 0);
    ...
    public final void draw(Canvas canvas) {
        switch (this.f25954a) {
            case 0:
                ...
                canvas.drawPath(this.e, this.f25956c);
                canvas.restore();
                if (i10 > 0) {
                    if (this.f25957f) {
            ...
            default:
                ...
                canvas.drawPath(this.e, this.f25955b);
                if (z4) {
                    canvas.drawLine(-AndroidUtilities.dp(8.66f), -AndroidUtilities.dp(8.66f), AndroidUtilities.dp(8.66f), AndroidUtilities.dp(8.66f), this.f25956c);
    ...
    public final void setAlpha(int i10) {
        switch (this.f25954a) {
            case 0:
                this.f25955b.setAlpha(i10);
                this.f25956c.setAlpha(i10);
                return;
            default:
                this.f25955b.setAlpha(i10);
                return;
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        switch (this.f25954a) {
            case 0:
                this.f25956c.setColorFilter(colorFilter);
                this.f25955b.setColorFilter(colorFilter);
                return;
            default:
                this.f25955b.setColorFilter(colorFilter);
                return;
    ...
    public jc0(ph.r rVar, boolean z4) {
        ...
        Paint paint = new Paint(1);
        this.f25955b = paint;
        this.f25956c = new Paint(1);
        this.d = new Paint(1);
        Path path = new Path();
        this.e = path;
        this.f25958g = new float[8];
        this.f25957f = z4;
        paint.setColor(-1);
        ...
        while (i12 < size) {
            ...
            ph.q qVar = (ph.q) obj;
            int[] iArr = rVar2.d;
            int i14 = qVar.f42196c;
            int i15 = qVar.f42195b;
            int i16 = iArr[i14];
            int i17 = i16 - 1;
        ...
        Paint paint2 = this.f25956c;
        Paint.Style style = Paint.Style.STROKE;
        paint2.setStyle(style);
        this.f25956c.setStrokeWidth(AndroidUtilities.dp(3.33f));
        this.f25956c.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.CLEAR));
