...
public final class jc0 extends Drawable {
    ...
    public final void a(int i10) {
        if (i10 != this.f25281f) {
            ...
            this.d = alpha;
            this.f25279b.setColor(i0.a.k(i10, (int) ((alpha / 255.0f) * this.f25280c)));
        }
        this.f25281f = i10;
    }
    ...
    public final Drawable.ConstantState getConstantState() {
        if (this.f25278a == null) {
            this.f25278a = new Drawable.ConstantState();
        }
        return this.f25278a;
    }
    ...
    public final void setAlpha(int i10) {
        if (this.f25280c != i10) {
            this.f25280c = i10;
            this.f25279b.setAlpha((int) ((this.d / 255.0f) * i10));
        }
    }
