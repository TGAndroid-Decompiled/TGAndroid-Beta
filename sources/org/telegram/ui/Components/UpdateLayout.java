...
public class UpdateLayout extends IUpdateLayout {
    ...
    public void updateFileProgress(Object[] objArr) {
        ...
        this.updateTextView.setText(LocaleController.formatString(2131690193, Integer.valueOf((int) (downloadingUpdateProgress * 100.0f))));
    ...
    public void createUpdateUI(final int i) {
        ...
        this.updateTextView.setText(LocaleController.getString(2131690190), false);
    ...
    public void updateAppUpdateViews(int i, boolean z) {
        ...
        if (ApplicationLoader.applicationLoaderInstance.getUpdate() != null) {
            ...
            if (downloadedUpdateFile != null && downloadedUpdateFile.exists()) {
                ...
                setUpdateText(LocaleController.getString(2131690194), z);
                ...
                setUpdateText(LocaleController.formatString(2131690193, Integer.valueOf((int) (ApplicationLoader.applicationLoaderInstance.getDownloadingUpdateProgress() * 100.0f))), z);
            } else {
