...
public final class b6 extends BitmapDrawable implements Animatable, yf.c {
    ...
    public final RectF f22581a0;
    public boolean f22582b;
    public volatile boolean f22583b0;
    public int f22584c;
    public volatile boolean f22585c0;
    public final int[] d;
    public volatile AnimatedFileNative f22586d0;
    public z5 e;
    public boolean f22587e0;
    public boolean f22588f;
    public DispatchQueue f22589f0;
    public float f22590g0;
    public final ArrayList h;
    public float f22591h0;
    public int f22592i0;
    public int f22593j0;
    public final boolean f22594k0;
    public final boolean f22595l0;
    public float m0;
    public y5 f22596n;
    public boolean f22597n0;
    public final TLRPC.Document f22598o0;
    public final RectF[] f22599p0;
    public final Paint[] f22600q0;
    public y5 f22601r;
    public View f22602r0;
    public y5 f22603s;
    public final ArrayList f22604s0;
    public final ArrayList f22605t0;
    public AnimatedFileDrawableStream f22606u0;
    public y5 v;
    public boolean f22607v0;
    public boolean f22608w;
    public boolean f22609w0;
    public boolean f22610x;
    public boolean f22611x0;
    public boolean f22612y;
    public int f22613y0;
    public final yf.e f22614z0;
    ...
    public final void B(int[] iArr) {
        boolean isEmpty = this.f22604s0.isEmpty();
        int[] iArr2 = this.T;
        if (!isEmpty) {
            if (this.U == null) {
                this.U = new int[4];
        ...
        for (int i10 = 0; i10 < 4; i10++) {
            if (!this.f22609w0 && iArr[i10] != iArr2[i10]) {
                this.f22609w0 = true;
            }
            iArr2[i10] = iArr[i10];
        }
    ...
    public final void C(long j3, long j10) {
        this.f22590g0 = ((float) j3) / 1000.0f;
        this.f22591h0 = ((float) j10) / 1000.0f;
        if (j3 >= 0 && o() < j3) {
            y(j3, true, false);
        }
    }
    ...
    public final void D(long j3) {
        ...
        if (!this.T0 && (this.f22583b0 || !this.f22612y)) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (this.f22583b0) {
            y5 y5Var = this.f22596n;
            if (y5Var == null && this.f22601r == null) {
                x(false);
            } else if (this.f22601r != null) {
                if (y5Var == null || (z10 && !this.f22580a && this.M < 0)) {
                    y5 y5Var2 = this.f22596n;
                    if (y5Var2 != null) {
                        this.h.add(y5Var2);
                    }
                    this.f22596n = this.f22601r;
                    this.f22601r = this.f22603s;
                    this.f22603s = null;
                    this.T0 = false;
                    x(false);
                }
            }
        } else if (!this.f22583b0 && this.f22612y && z10 && this.f22601r != null) {
            y5 y5Var3 = this.f22596n;
            if (y5Var3 != null) {
                this.h.add(y5Var3);
            }
            this.f22596n = this.f22601r;
    ...
    public final void E() {
        ...
        int i12;
        int i13;
        if (!this.f22597n0 && (i10 = this.f22592i0) > 0 && (i11 = this.f22593j0) > 0 && (i12 = (iArr = this.d)[0]) > 0 && (i13 = iArr[1]) > 0) {
    ...
    public final int a(Bitmap bitmap) {
        ...
        this.N0.c(this.M0, false, this.f22590g0, this.f22591h0, this.f22594k0);
        long j3 = this.L0;
        ...
        bitmap.eraseColor(0);
        canvas.save();
        float width = this.f22593j0 / this.M0.getWidth();
    ...
    @Override
    public final void b() {
        this.N0 = AnimatedFileNative.a(this.G.getAbsolutePath(), this.d, this.J, this.H, this.f22606u0, false);
    }
    ...
    public final void d() {
        int i10;
        if (this.f22593j0 == 0 && this.f22592i0 == 0) {
            int[] iArr = this.d;
            int i11 = iArr[0];
    ...
    public final void e(ImageReceiver imageReceiver) {
        if (!this.f22605t0.contains(imageReceiver)) {
            this.f22605t0.add(imageReceiver);
            if (this.f22583b0) {
                x(false);
            }
        }
    ...
    public final void f(View view) {
        if (view != null) {
            ArrayList arrayList = this.f22604s0;
    ...
    public final boolean g() {
        if (this.f22595l0) {
            if (this.f22614z0 == null) {
                return false;
            }
            return true;
        } else if (this.f22586d0 == null && this.f22610x) {
            return false;
        } else {
            return true;
        }
    ...
    public final void h() {
        z5 z5Var;
        if (this.f22614z0 != null) {
            boolean isEmpty = this.f22605t0.isEmpty();
    ...
    public final void i() {
        int i10;
        if (this.f22583b0 && !this.R0 && !this.f22588f) {
    ...
    public final void k() {
        if (!g()) {
            y5 y5Var = this.f22596n;
            if (y5Var != null) {
                y5Var.f30121b.recycle();
                Arrays.fill(y5Var.f30120a, (Object) null);
                this.f22596n = null;
            }
            y5 y5Var2 = this.v;
            if (y5Var2 != null) {
                y5Var2.f30121b.recycle();
                Arrays.fill(y5Var2.f30120a, (Object) null);
                this.v = null;
            }
            DispatchQueue dispatchQueue = this.f22589f0;
            ...
            while (true) {
                ...
                if (i10 < arrayList.size()) {
                    ...
                    y5Var3.f30121b.recycle();
                    Arrays.fill(y5Var3.f30120a, (Object) null);
                    i10++;
                } else {
                    arrayList.clear();
                    t();
    ...
    public final Bitmap m() {
        y5 y5Var = this.f22596n;
        if (y5Var != null) {
            return y5Var.f30121b;
        }
        y5 y5Var2 = this.f22601r;
        if (y5Var2 != null) {
            return y5Var2.f30121b;
        }
        y5 y5Var3 = this.f22603s;
        if (y5Var3 != null) {
            return y5Var3.f30121b;
        }
        return null;
    }
    ...
    public final Bitmap p() {
        int i10 = this.f22593j0;
        int i11 = this.f22592i0;
        Bitmap.Config config = Bitmap.Config.ARGB_8888;
        Bitmap createBitmap = Bitmap.createBitmap(i10, i11, config);
        Canvas canvas = new Canvas(createBitmap);
        AnimatedFileNative a2 = AnimatedFileNative.a(this.G.getAbsolutePath(), this.d, this.J, this.H, this.f22606u0, false);
        if (a2 == null) {
            return createBitmap;
        }
        if (this.M0 == null) {
        ...
        a2.c(this.M0, false, this.f22590g0, this.f22591h0, true);
        a2.f();
    ...
    public final Bitmap q(long j3, boolean z10) {
        int c10;
        if (this.f22610x && this.f22586d0 != null) {
            AnimatedFileDrawableStream animatedFileDrawableStream = this.f22606u0;
            if (animatedFileDrawableStream != null) {
                animatedFileDrawableStream.cancel(false);
                this.f22606u0.reset();
            }
            if (!z10) {
                this.f22586d0.g(j3, z10);
            }
            int[] iArr = this.d;
            Bitmap createBitmap = Bitmap.createBitmap(iArr[0], iArr[1], Bitmap.Config.ARGB_8888);
            if (z10) {
                c10 = this.f22586d0.b(createBitmap, j3);
            } else {
                c10 = this.f22586d0.c(createBitmap, true, 0.0f, 0.0f, true);
            }
            if (c10 != 0) {
                return createBitmap;
            }
    ...
    public final Bitmap r(boolean z10) {
        ...
        this.f22586d0.c(this.v.f30121b, false, this.f22590g0, this.f22591h0, z10);
        return this.v.f30121b;
    }

    public final boolean s() {
        if (g()) {
            if (this.f22596n != null || this.f22601r != null) {
                return true;
            }
            return false;
        }
    ...
    public final void start() {
        if (!this.f22583b0 && !this.f22605t0.isEmpty()) {
            this.f22583b0 = true;
            this.R0 = false;
            x(false);
    ...
    public final void t() {
        int i10 = 0;
        while (true) {
            ArrayList arrayList = this.f22605t0;
            if (i10 < arrayList.size()) {
    ...
    public final void u() {
        ...
        if (this.e == null) {
            ...
            y5 y5Var = this.f22596n;
            if (y5Var != null) {
                arrayList.add(y5Var.f30121b);
            }
            y5 y5Var2 = this.f22601r;
            if (y5Var2 != null) {
                arrayList.add(y5Var2.f30121b);
            }
            y5 y5Var3 = this.f22603s;
            if (y5Var3 != null) {
                arrayList.add(y5Var3.f30121b);
            }
            y5 y5Var4 = this.v;
            if (y5Var4 != null) {
                arrayList.add(y5Var4.f30121b);
            }
    ...
    public final void x(boolean z10) {
        ...
        z5 z5Var2;
        if (this.e == null || z10) {
            if ((this.f22582b && (this.f22603s == null || (!this.K0 && this.M >= 0))) || this.f22601r == null) {
                if ((this.f22596n == null || !this.f22588f) && g() && !this.f22608w) {
                    if ((this.f22583b0 || (this.f22612y && !this.E)) && !this.f22605t0.isEmpty() && !this.C0) {
                        if (this.f22607v0) {
                            if (this.f22611x0) {
                                z5 z5Var3 = this.H0;
                                this.e = z5Var3;
                            ...
                            if (this.f22589f0 == null) {
                                this.f22589f0 = new DispatchQueue("decodeQueue" + this);
                            }
                            if (z10 && (z5Var = this.e) != null) {
                                this.f22589f0.cancelRunnable(z5Var);
                            }
                            DispatchQueue dispatchQueue = this.f22589f0;
                            z5 z5Var5 = this.H0;
                            this.e = z5Var5;
    ...
    public final void y(long j3, boolean z10, boolean z11) {
        ...
        synchronized (this.Q) {
            try {
                ...
                if (this.f22610x && (animatedFileDrawableStream = this.f22606u0) != null) {
