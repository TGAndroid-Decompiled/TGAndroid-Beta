...
public final class na {
    public final ja f26687a;
    public final View f26688b;
    public final ColorMatrix f26689c;
    public final boolean d;
    public boolean e;
    public float f26690f;
    public Paint f26691g;
    public Paint h;
    public final int f26692i;
    public final Integer f26693j;
    public final Path f26694k;
    public int f26695l;
    public int f26696m;
    public Bitmap f26697n;
    public BitmapShader f26698o;
    public final Matrix f26699p;
    public final RectF f26700q;
    public boolean f26701r;
    public Paint[] f26702s;
    public ValueAnimator f26703t;
    public final int[] f26704u;
    public final int[] v;
    ...
    public final void b(Canvas canvas, boolean z10) {
        ...
        if (jaVar.c() && Build.VERSION.SDK_INT >= 31) {
            ...
            RenderNode renderNode = (RenderNode) jaVar.f25373l;
            if (!renderNode.hasDisplayList()) {
                RenderNode renderNode2 = (RenderNode) jaVar.f25372k;
            ...
            if (renderNode.hasDisplayList()) {
                Matrix matrix = this.f26699p;
                matrix.postTranslate(-0.0f, -0.0f);
                this.h.setAlpha((int) 255.0f);
                canvas.saveLayer(null, this.h);
                canvas.concat(matrix);
                if (z10) {
                    int i14 = this.f26695l;
                    int width = renderNode.getWidth();
                    Path path = this.f26694k;
                    if (i14 != width || this.f26696m != renderNode.getHeight()) {
                        path.rewind();
    ...
    public final Paint c(float f7) {
        ...
        BitmapShader bitmapShader = this.f26698o;
        if (bitmapShader == null || this.f26697n != b10) {
            if (this.d && bitmapShader != null && (bitmap = this.f26697n) != null && !bitmap.isRecycled() && !b10.isRecycled()) {
                Paint paint = this.h;
                this.h = this.f26691g;
                this.f26691g = paint;
                this.e = true;
                ValueAnimator valueAnimator = this.f26703t;
    ...
    public final Paint[] d() {
        ...
        if (c10 != null && z10) {
            c10.setAlpha((int) org.telegram.messenger.f0.z(1.0f, this.f26690f, 255.0f, 1.0f));
        }
        if (paint != null) {
            paint.setAlpha((int) 255.0f);
        }
        if (this.f26702s == null) {
            this.f26702s = new Paint[2];
        }
        Paint[] paintArr = this.f26702s;
        paintArr[0] = paint;
        paintArr[1] = c10;
        return paintArr;
    }
    ...
    public final void e(float f7, float f10, float f11, float f12) {
        ...
        RectF rectF2 = this.f26700q;
        if (rectF2.top != rectF.top || rectF2.bottom != rectF.bottom || rectF2.left != rectF.left || rectF2.right != rectF.right) {
            rectF2.set(rectF);
            Bitmap b10 = this.f26687a.b();
            if (b10 == null) {
                return;
            }
            if (this.f26698o == null || this.f26697n != b10) {
                this.f26697n = b10;
                Shader.TileMode tileMode = Shader.TileMode.CLAMP;
                BitmapShader bitmapShader = new BitmapShader(b10, tileMode, tileMode);
                this.f26698o = bitmapShader;
                this.h.setShader(bitmapShader);
            }
            float width = rectF2.width() / this.f26697n.getWidth();
            float height = rectF2.height() / this.f26697n.getHeight();
            Matrix matrix = this.f26699p;
            matrix.reset();
    ...
    public na(ja jaVar, View view, int i10, boolean z10) {
        this.f26691g = new Paint(3);
        this.h = new Paint(3);
        this.f26694k = new Path();
        this.f26699p = new Matrix();
        this.f26700q = new RectF();
        this.f26701r = false;
        this.f26704u = new int[2];
        this.v = new int[2];
        this.f26687a = jaVar;
        this.f26688b = view;
        this.f26692i = i10;
        ...
        if (i10 == 0) {
            ...
            this.f26691g.setXfermode(new PorterDuffXfermode(mode));
            AndroidUtilities.adjustSaturationColorMatrix(colorMatrix, 0.3f);
        } else if (i10 == 2) {
            Paint paint2 = this.h;
            PorterDuff.Mode mode2 = PorterDuff.Mode.SRC_IN;
            paint2.setXfermode(new PorterDuffXfermode(mode2));
            this.f26691g.setXfermode(new PorterDuffXfermode(mode2));
            ...
            this.f26691g.setXfermode(new PorterDuffXfermode(mode3));
            AndroidUtilities.adjustBrightnessColorMatrix(colorMatrix, 0.4f);
            AndroidUtilities.adjustSaturationColorMatrix(colorMatrix, 0.45f);
        } else if (i10 == 10) {
            colorMatrix.setSaturation(1.6f);
            AndroidUtilities.multiplyBrightnessColorMatrix(colorMatrix, this.f26701r ? 0.97f : 0.92f);
            AndroidUtilities.adjustBrightnessColorMatrix(colorMatrix, this.f26701r ? 0.12f : -0.06f);
        }
        this.h.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
        this.f26691g.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
