...
public final class na {
    public final ja f26635a;
    public final View f26636b;
    public final ColorMatrix f26637c;
    public final boolean d;
    public boolean e;
    public float f26638f;
    public Paint f26639g;
    public Paint h;
    public final int f26640i;
    public final Integer f26641j;
    public final Path f26642k;
    public int f26643l;
    public int f26644m;
    public Bitmap f26645n;
    public BitmapShader f26646o;
    public final Matrix f26647p;
    public final RectF f26648q;
    public boolean f26649r;
    public Paint[] f26650s;
    public ValueAnimator f26651t;
    ...
    public final void b(Canvas canvas, boolean z10) {
        ...
        if (jaVar.c() && Build.VERSION.SDK_INT >= 31) {
            ...
            RenderNode renderNode = (RenderNode) jaVar.f25279l;
            if (!renderNode.hasDisplayList()) {
                RenderNode renderNode2 = (RenderNode) jaVar.f25278k;
            ...
            if (renderNode.hasDisplayList()) {
                Matrix matrix = this.f26647p;
                matrix.postTranslate(-0.0f, -0.0f);
                this.h.setAlpha((int) 255.0f);
                canvas.saveLayer(null, this.h);
                canvas.concat(matrix);
                if (z10) {
                    int i14 = this.f26643l;
                    int width = renderNode.getWidth();
                    Path path = this.f26642k;
                    if (i14 != width || this.f26644m != renderNode.getHeight()) {
                        path.rewind();
    ...
    public final Paint c(float f7) {
        ...
        BitmapShader bitmapShader = this.f26646o;
        if (bitmapShader == null || this.f26645n != b10) {
            if (this.d && bitmapShader != null && (bitmap = this.f26645n) != null && !bitmap.isRecycled() && !b10.isRecycled()) {
                Paint paint = this.h;
                this.h = this.f26639g;
                this.f26639g = paint;
                this.e = true;
                ValueAnimator valueAnimator = this.f26651t;
    ...
    public final Paint[] d() {
        ...
        if (c10 != null && z10) {
            c10.setAlpha((int) org.telegram.messenger.q.A(1.0f, this.f26638f, 255.0f, 1.0f));
        }
        if (paint != null) {
            paint.setAlpha((int) 255.0f);
        }
        if (this.f26650s == null) {
            this.f26650s = new Paint[2];
        }
        Paint[] paintArr = this.f26650s;
        paintArr[0] = paint;
        paintArr[1] = c10;
        return paintArr;
    }
    ...
    public final void e(float f7, float f10, float f11, float f12) {
        ...
        RectF rectF2 = this.f26648q;
        if (rectF2.top != rectF.top || rectF2.bottom != rectF.bottom || rectF2.left != rectF.left || rectF2.right != rectF.right) {
            rectF2.set(rectF);
            Bitmap b10 = this.f26635a.b();
            if (b10 == null) {
                return;
            }
            if (this.f26646o == null || this.f26645n != b10) {
                this.f26645n = b10;
                Shader.TileMode tileMode = Shader.TileMode.CLAMP;
                BitmapShader bitmapShader = new BitmapShader(b10, tileMode, tileMode);
                this.f26646o = bitmapShader;
                this.h.setShader(bitmapShader);
            }
            float width = rectF2.width() / this.f26645n.getWidth();
            float height = rectF2.height() / this.f26645n.getHeight();
            Matrix matrix = this.f26647p;
            matrix.reset();
    ...
    public na(ja jaVar, View view, int i10, boolean z10) {
        this.f26639g = new Paint(3);
        this.h = new Paint(3);
        this.f26642k = new Path();
        this.f26647p = new Matrix();
        this.f26648q = new RectF();
        this.f26649r = false;
        this.f26652u = new int[2];
        this.v = new int[2];
        this.f26635a = jaVar;
        this.f26636b = view;
        this.f26640i = i10;
        ...
        if (i10 == 0) {
            ...
            this.f26639g.setXfermode(new PorterDuffXfermode(mode));
            AndroidUtilities.adjustSaturationColorMatrix(colorMatrix, 0.3f);
        } else if (i10 == 2) {
            Paint paint2 = this.h;
            PorterDuff.Mode mode2 = PorterDuff.Mode.SRC_IN;
            paint2.setXfermode(new PorterDuffXfermode(mode2));
            this.f26639g.setXfermode(new PorterDuffXfermode(mode2));
            ...
            this.f26639g.setXfermode(new PorterDuffXfermode(mode3));
            AndroidUtilities.adjustBrightnessColorMatrix(colorMatrix, 0.4f);
            AndroidUtilities.adjustSaturationColorMatrix(colorMatrix, 0.45f);
        } else if (i10 == 10) {
            colorMatrix.setSaturation(1.6f);
            AndroidUtilities.multiplyBrightnessColorMatrix(colorMatrix, this.f26649r ? 0.97f : 0.92f);
            AndroidUtilities.adjustBrightnessColorMatrix(colorMatrix, this.f26649r ? 0.12f : -0.06f);
        }
        this.h.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
        this.f26639g.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
