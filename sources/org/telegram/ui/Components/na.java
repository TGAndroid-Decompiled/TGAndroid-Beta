...
public final class na {
    public final ja f28730a;
    public final View f28731b;
    public final ColorMatrix f28732c;
    public final boolean d;
    public boolean f28733e;
    public float f28734f;
    public Paint f28735g;
    public Paint h;
    public final int f28736i;
    public final Integer f28737j;
    public final Path f28738k;
    public int f28739l;
    public int f28740m;
    public Bitmap f28741n;
    public BitmapShader f28742o;
    public final Matrix f28743p;
    public final RectF f28744q;
    public boolean f28745r;
    public Paint[] f28746s;
    public ValueAnimator f28747t;
    public final int[] f28748u;
    public final int[] v;
    ...
    public final void b(Canvas canvas, boolean z10) {
        ...
        if (jaVar.c() && Build.VERSION.SDK_INT >= 31) {
            ...
            RenderNode renderNode = (RenderNode) jaVar.f27444l;
            if (!renderNode.hasDisplayList()) {
                RenderNode renderNode2 = (RenderNode) jaVar.f27443k;
    ...
    public final Paint c(float f7) {
        ...
        BitmapShader bitmapShader = this.f28742o;
        if (bitmapShader == null || this.f28741n != b10) {
            if (this.d && bitmapShader != null && (bitmap = this.f28741n) != null && !bitmap.isRecycled() && !b10.isRecycled()) {
                Paint paint = this.h;
                this.h = this.f28735g;
                this.f28735g = paint;
                this.f28733e = true;
                ValueAnimator valueAnimator = this.f28747t;
    ...
    public final Paint[] d() {
        ...
        if (c10 != null && z10) {
            c10.setAlpha((int) org.telegram.messenger.w1.A(1.0f, this.f28734f, 255.0f, 1.0f));
        }
        if (paint != null) {
            paint.setAlpha((int) 255.0f);
        }
        if (this.f28746s == null) {
            this.f28746s = new Paint[2];
        }
        Paint[] paintArr = this.f28746s;
        paintArr[0] = paint;
        paintArr[1] = c10;
        return paintArr;
    }
    ...
    public final void e(float f7, float f10, float f11, float f12) {
        ...
        RectF rectF2 = this.f28744q;
        if (rectF2.top != rectF.top || rectF2.bottom != rectF.bottom || rectF2.left != rectF.left || rectF2.right != rectF.right) {
            rectF2.set(rectF);
            Bitmap b10 = this.f28730a.b();
            if (b10 == null) {
                return;
            }
            if (this.f28742o == null || this.f28741n != b10) {
                this.f28741n = b10;
                Shader.TileMode tileMode = Shader.TileMode.CLAMP;
                BitmapShader bitmapShader = new BitmapShader(b10, tileMode, tileMode);
                this.f28742o = bitmapShader;
                this.h.setShader(bitmapShader);
            }
            float width = rectF2.width() / this.f28741n.getWidth();
            float height = rectF2.height() / this.f28741n.getHeight();
            Matrix matrix = this.f28743p;
            matrix.reset();
    ...
    public na(ja jaVar, View view, int i10, boolean z10) {
        this.f28735g = new Paint(3);
        this.h = new Paint(3);
        this.f28738k = new Path();
        this.f28743p = new Matrix();
        this.f28744q = new RectF();
        this.f28745r = false;
        this.f28748u = new int[2];
        this.v = new int[2];
        this.f28730a = jaVar;
        this.f28731b = view;
        this.f28736i = i10;
        ...
        if (i10 == 0) {
            ...
            this.f28735g.setXfermode(new PorterDuffXfermode(mode));
            AndroidUtilities.adjustSaturationColorMatrix(colorMatrix, 0.3f);
        } else if (i10 == 2) {
            Paint paint2 = this.h;
            PorterDuff.Mode mode2 = PorterDuff.Mode.SRC_IN;
            paint2.setXfermode(new PorterDuffXfermode(mode2));
            this.f28735g.setXfermode(new PorterDuffXfermode(mode2));
            ...
            this.f28735g.setXfermode(new PorterDuffXfermode(mode3));
            AndroidUtilities.adjustBrightnessColorMatrix(colorMatrix, 0.4f);
            AndroidUtilities.adjustSaturationColorMatrix(colorMatrix, 0.45f);
        } else if (i10 == 10) {
            colorMatrix.setSaturation(1.6f);
            AndroidUtilities.multiplyBrightnessColorMatrix(colorMatrix, this.f28745r ? 0.97f : 0.92f);
            AndroidUtilities.adjustBrightnessColorMatrix(colorMatrix, this.f28745r ? 0.12f : -0.06f);
        }
        this.h.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
        this.f28735g.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
