...
public class BlurringShader {
    ...
    public static class BlurManager {
        ...
        private final ThumbBlurer thumbBlurer = new ThumbBlurer(0, new ShareAlert$23$$ExternalSyntheticLambda0(this, 25));
        private int i = 0;
        ...
        public void setRenderNode(View view, Object obj) {
            setRenderNode(view, obj, -16777216);
        }
        ...
        public void setRenderNode(View view, Object obj, int i) {
            ...
            RenderNode renderNodeM2 = BaseChartView$$ExternalSyntheticApiModelOutline0.m();
            float fDp = AndroidUtilities.dp(35.0f);
            float fDp2 = AndroidUtilities.dp(35.0f);
            Shader.TileMode tileMode = Shader.TileMode.CLAMP;
            renderNodeM2.setRenderEffect(RenderEffect.createBlurEffect(fDp, fDp2, Shader.TileMode.CLAMP));
    ...
    public static class StoryBlurDrawer {
        ...
        private void animateOldPaint() {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ButtonBounce$$ExternalSyntheticLambda0(this, 27));
        ...
        public Paint[] getPaints(float f, float f2, float f3) {
            ...
            if (paint != null && z) {
                paint.setAlpha((int) ImageReceiver$$ExternalSyntheticOutline2.m(1.0f, this.oldPaintAlpha, 255.0f, f));
            }
            if (paint2 != null) {
                ...
                public void draw(Canvas canvas) {
                    ...
                    if (f3 > 0.0f) {
                        ...
                        if (StoryBlurDrawer.this.manager == null || !StoryBlurDrawer.this.manager.hasRenderNode()) {
                            ...
                            float f8 = f3;
                            path2.addRoundRect(rectF4, f8, f8, Path.Direction.CW);
                            canvas.clipPath(this.clipPath);
                            StoryBlurDrawer.this.drawRect(canvas, 0.0f, 0.0f, 1.0f, false);
                            canvas.restore();
                        }
        ...
        public StoryBlurDrawer setOffset(float f, float f2) {
            this.customOffset = true;
            this.customOffsetX = f;
            this.customOffsetY = f2;
            return this;
        }
        ...
        public void drawRect(Canvas canvas, float f, float f2, float f3, boolean z) {
            if (this.manager.hasRenderNode() && Build.VERSION.SDK_INT >= 31) {
                if (canvas.isHardwareAccelerated()) {
                    RenderNode renderNodeM = AndroidUtilities$$ExternalSyntheticApiModelOutline5.m(this.manager.blurRenderNode);
                    if (!renderNodeM.hasDisplayList()) {
                        RenderNode renderNodeM2 = AndroidUtilities$$ExternalSyntheticApiModelOutline5.m(this.manager.renderNode);
    ...
    public static class ThumbBlurer {
        ...
        public void lambda$getBitmap$1(Bitmap bitmap, int i, int i2, String str, boolean z) {
            int i3;
            int i4;
            ...
            Bitmap bitmapCreateBitmap = Bitmap.createBitmap(i5 + i3, i5 + i4, Bitmap.Config.ARGB_8888);
            ...
            AndroidUtilities.runOnUIThread(new StickersAlert$$ExternalSyntheticLambda48(this, str, bitmapCreateBitmap, z, bitmap));
        }
        ...
        public android.graphics.Bitmap getBitmap(final android.graphics.Bitmap r9, final java.lang.String r10, final int r11, final int r12, final boolean r13) {
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.BlurringShader.ThumbBlurer.getBitmap(android.graphics.Bitmap, java.lang.String, int, int, boolean):android.graphics.Bitmap");
        }

        public ThumbBlurer(int i) {
    ...
    public BlurringShader(FilterGLThread filterGLThread) {
        ...
        this.invalidateViews = new ShareAlert$23$$ExternalSyntheticLambda0(this, 24);
