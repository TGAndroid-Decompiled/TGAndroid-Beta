...
public final class j90 extends View {
    public final TextPaint f25191a;
    ...
    public j90(Context context) {
        ...
        this.f25191a = textPaint;
        this.f25192b = new Paint(1);
        this.d = new Rect();
        this.f25193c = LocaleController.getString(R.string.LoginOrSingInWithGoogle);
        textPaint.setTextSize(AndroidUtilities.dp(14.0f));
        a();
    }

    public final void a() {
        this.f25191a.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19244y6, false));
        this.f25192b.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.Ii, false));
        invalidate();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawText(this.f25193c, (getWidth() - rect.width()) / 2.0f, (rect.height() + height) / 2.0f, this.f25191a);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f25191a.getTextBounds(str, 0, str.length(), this.d);
    }
