...
public class kx0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public float I;
    public boolean J;
    public final bc1 f25864a;
    public final w9 f25865b;
    public final RadialProgressView f25866c;
    public final vh.o d;
    public final l90 e;
    public final ci.d f25867f;
    public boolean h;
    public final org.telegram.ui.ActionBar.e6 f25868n;
    public int f25869r;
    public final View f25870s;
    public int v;
    public final int f25871w;
    public boolean f25872x;
    public final org.telegram.ui.Cells.t6 f25873y;
    ...
    public final void b(int i10, boolean z10) {
        if (this.v != i10) {
            ...
            float f7 = i12 + i11;
            RadialProgressView radialProgressView = this.f25866c;
            bc1 bc1Var = this.f25864a;
            if (z10) {
                ViewPropertyAnimator translationY = bc1Var.animate().translationY(f7);
                qr qrVar = qr.f27715f;
    ...
    public final void c() {
        ...
        int i10;
        int i11 = this.f25869r;
        w9 w9Var = this.f25865b;
        if (i11 != 0) {
            boolean z10 = true;
            if (i11 != 1) {
                ...
                if (i11 == 16) {
                    ...
                    if (stickerSetByName != null && (i10 = this.f25869r) >= 0 && i10 < stickerSetByName.documents.size()) {
                        document2 = stickerSetByName.documents.get(this.f25869r);
                    }
        ...
        if (this.h != z10) {
            ...
            if (getVisibility() == 0) {
                ...
                if (z11) {
                    ...
                    this.f25865b.getImageReceiver().startAnimation();
                } else if (z10) {
    ...
    public void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f25871w).addObserver(this, NotificationCenter.diceStickersDidLoad);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f25871w).removeObserver(this, NotificationCenter.diceStickersDidLoad);
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if ((this.E || this.f25872x) && (i14 = this.F) > 0 && i14 != getMeasuredHeight()) {
            float measuredHeight = (this.F - getMeasuredHeight()) / 2.0f;
            bc1 bc1Var = this.f25864a;
            bc1Var.setTranslationY(bc1Var.getTranslationY() + measuredHeight);
            if (!this.f25872x) {
                bc1Var.animate().translationY(0.0f).setInterpolator(qr.f27715f).setDuration(250L);
            }
            RadialProgressView radialProgressView = this.f25866c;
            if (radialProgressView != null) {
                radialProgressView.setTranslationY(radialProgressView.getTranslationY() + measuredHeight);
                if (!this.f25872x) {
                    radialProgressView.animate().translationY(0.0f).setInterpolator(qr.f27715f).setDuration(250L);
                }
            }
        }
    ...
    public void setPreventMoving(boolean z10) {
        this.f25872x = z10;
        if (!z10) {
            this.f25864a.setTranslationY(0.0f);
            RadialProgressView radialProgressView = this.f25866c;
            if (radialProgressView != null) {
    ...
    public kx0(Context context, View view, int i10, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
        this.f25871w = UserConfig.selectedAccount;
        this.f25873y = new org.telegram.ui.Cells.t6(this, 26);
        this.G = org.telegram.ui.ActionBar.j6.f19045c7;
        this.f25868n = e6Var;
        this.f25870s = view;
        this.f25869r = i10;
        ...
        if (view == null) {
            ...
            this.f25866c = radialProgressView;
            radialProgressView.setAlpha(0.0f);
            radialProgressView.setScaleY(0.5f);
            radialProgressView.setScaleX(0.5f);
