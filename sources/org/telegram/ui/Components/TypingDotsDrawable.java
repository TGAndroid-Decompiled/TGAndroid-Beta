...
public class TypingDotsDrawable extends StatusDrawable {
    ...
    public void checkUpdate() {
        if (this.started) {
            if (!NotificationCenter.getInstance(this.currentAccount).isAnimationInProgress() || this.ignoreAnimationLocks) {
                ...
                AndroidUtilities.runOnUIThread(new Tooltip$$ExternalSyntheticLambda0(this, 28), 100L);
            }
        }
    }
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawCircle(AndroidUtilities.dp(15.0f) + i2, f, this.scales[2] * AndroidUtilities.density, paint);
        checkUpdate();
    }
