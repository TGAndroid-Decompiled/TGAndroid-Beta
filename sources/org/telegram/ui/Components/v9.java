...
public final class v9 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public eg.s2 f31856c;
    public eg.s2 d;
    public mj0 f31857e;
    public ScrollView f31858f;
    public AnimatorSet h;
    public TLRPC.TL_help_appUpdate f31859n;
    public String f31860r;
    public int f31861s;
    public int v;
    public GradientDrawable f31862w;
    public GradientDrawable f31863x;

    public final void a(boolean z4) {
        eg.s2 s2Var = this.d;
        TextView textView = this.f31855b;
        eg.s2 s2Var2 = this.f31856c;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.fileLoaded) {
            ...
            if (str2 != null && str2.equals(str)) {
                a(false);
                ApplicationLoader.applicationLoaderInstance.openApkInstall((Activity) getContext(), this.f31859n.document);
            }
        } else if (i10 == NotificationCenter.fileLoadFailed) {
            String str3 = (String) objArr[0];
            String str4 = this.f31860r;
            if (str4 != null && str4.equals(str3)) {
                a(false);
            }
        } else if (i10 == NotificationCenter.fileLoadProgressChanged) {
            String str5 = (String) objArr[0];
            String str6 = this.f31860r;
            if (str6 != null && str6.equals(str5)) {
                this.f31857e.e(Math.min(1.0f, ((float) ((Long) objArr[1]).longValue()) / ((float) ((Long) objArr[2]).longValue())), true);
            }
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        GradientDrawable gradientDrawable = this.f31862w;
        ScrollView scrollView = this.f31858f;
        ...
        GradientDrawable gradientDrawable2 = this.f31863x;
    ...
    public void setVisibility(int i10) {
        ...
        if (i10 == 8) {
            NotificationCenter.getInstance(this.f31861s).removeObserver(this, NotificationCenter.fileLoaded);
            NotificationCenter.getInstance(this.f31861s).removeObserver(this, NotificationCenter.fileLoadFailed);
            NotificationCenter.getInstance(this.f31861s).removeObserver(this, NotificationCenter.fileLoadProgressChanged);
        }
    }
}
