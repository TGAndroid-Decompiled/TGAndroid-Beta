...
public final class v9 extends GradientDrawable {
    ...
    public final a0.f f28964b;
    public final a0.f f28965c;
    public final a0.f d;
    public final ArrayList e;
    public final Paint f28966f;
    public boolean f28967g;

    public v9(GradientDrawable.Orientation orientation, int[] iArr) {
        super(orientation, iArr);
        this.f28964b = new a0.m(0);
        this.f28965c = new a0.m(0);
        this.d = new a0.m(0);
    ...
    public static void a(v9 v9Var, Runnable[] runnableArr, Bitmap bitmap, h60 h60Var, int i10, w7.j0[] j0VarArr) {
        a0.f fVar = v9Var.f28964b;
        ...
        if (j0Var != null) {
            j0Var.b(h60Var.f24565a, h60Var.f24566b);
            if (!z10) {
                j0VarArr[0].a();
                j0VarArr[0] = null;
            }
    ...
    public static Rect e(GradientDrawable.Orientation orientation, int i10, int i11) {
        Rect rect = new Rect();
        switch (t9.f28357a[orientation.ordinal()]) {
            case 1:
                int i12 = i10 / 2;
                rect.left = i12;
                rect.top = 0;
    ...
    public final void b() {
        if (!this.f28967g) {
            ...
            for (int i10 = this.f28964b.f30c - 1; i10 >= 0; i10--) {
                Bitmap bitmap = (Bitmap) this.f28964b.f(i10);
                if (bitmap != null) {
                    bitmap.recycle();
                }
            }
    ...
    public final u9 c(Canvas canvas, final ViewGroup viewGroup) {
        ...
        while (true) {
            ...
            if (i11 < i10) {
                ...
                if (h60Var.f24565a == width && h60Var.f24566b == height) {
                    Bitmap bitmap = (Bitmap) fVar.h(i11);
                    if (bitmap != null) {
                        canvas.drawBitmap(bitmap, (Rect) null, bounds, this.f28966f);
                    } else {
                        super.draw(canvas);
                    }
                ...
                this.f28965c.put(h60Var2, Boolean.TRUE);
    ...
    public final void draw(Canvas canvas) {
        ...
        for (int i11 = 0; i11 < i10; i11++) {
            h60 h60Var = (h60) fVar.e(i11);
            float f10 = f7;
            float sqrt = (float) Math.sqrt(Math.pow(height - h60Var.f24566b, 2.0d) + Math.pow(width - h60Var.f24565a, 2.0d));
            if (sqrt < f10 && (bitmap = (Bitmap) fVar.h(i11)) != null && ((bool = (Boolean) this.f28965c.get(h60Var)) == null || !bool.booleanValue())) {
                bitmap2 = bitmap;
                f7 = sqrt;
            } else {
                f7 = f10;
        ...
        if (bitmap2 != null) {
            canvas.drawBitmap(bitmap2, (Rect) null, bounds, this.f28966f);
        } else {
            super.draw(canvas);
        }
    }
    ...
    public final q9 f(n2.e eVar, w7.j0 j0Var, long j3) {
        h60[] h60VarArr = (h60[]) eVar.f15073b;
        if (!this.f28967g) {
    ...
    public final q9 g(h60[] h60VarArr, w7.j0 j0Var, long j3) {
        ...
        for (int i10 = 0; i10 < h60VarArr.length; i10++) {
            ...
            if (h60Var.f24565a != 0 && h60Var.f24566b != 0) {
    ...
    public final void setAlpha(int i10) {
        super.setAlpha(i10);
        this.f28966f.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        super.setColorFilter(colorFilter);
        this.f28966f.setColorFilter(colorFilter);
    }
}
