...
public class d61 extends ll0 {
    ...
    public final v51 Y2;
    public s4.y Z2;
    public boolean f25280a3;
    public boolean f25281b3;
    public boolean f25282c3;
    public s4.c1 f25283d3;
    public boolean f25284e3;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (!a1()) {
            ...
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                ...
                int i12 = t51Var.f30535b;
                if (i12 >= 0) {
                    int i13 = t51Var.f30534a;
                    if (v51Var.f31135n) {
                    ...
                    if (i12 >= i13 && i13 >= 0 && i12 >= 0) {
                        ...
                        if (i14 < i15) {
                            if (this.f28235u2 == null) {
                                this.f28235u2 = new Paint(1);
                            }
                            this.f28235u2.setColor(v02);
                            canvas.drawRect(0.0f, i14, getWidth(), i15, this.f28235u2);
                        }
                    }
                }
            }
