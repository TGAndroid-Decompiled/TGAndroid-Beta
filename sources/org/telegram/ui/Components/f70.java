...
public final class f70 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f24035a) {
            case 0:
                g70 g70Var = this.f24036b;
                String str2 = this.f24037c;
                g70Var.getClass();
                AndroidUtilities.runOnUIThread(new f70(g70Var, str2, 1));
                return;
            case 1:
                g70 g70Var2 = this.f24036b;
                String str3 = this.f24037c;
                gg.c2 c2Var = g70Var2.e;
                org.telegram.ui.fu fuVar = g70Var2.f24325n.m0;
                boolean z10 = false;
                if (fuVar != null) {
                    z10 = true;
                }
                ...
                return;
            default:
                g70 g70Var3 = this.f24036b;
                String str4 = this.f24037c;
                ArrayList arrayList2 = g70Var3.f24325n.f25604e0;
