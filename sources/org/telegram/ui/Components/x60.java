...
public final class x60 extends kl0 {
    public ArrayList f29893c = new ArrayList();
    public ArrayList d = new ArrayList();
    public final gg.c2 e;
    public int f29894f;
    public Runnable h;
    public final b70 f29895n;

    public x60(b70 b70Var) {
        this.f29895n = b70Var;
        gg.c2 c2Var = new gg.c2(false);
        this.e = c2Var;
        c2Var.f9686a = new lv(this, 7);
    }
    ...
    public final int j(int i10) {
        ...
        if (i10 == this.f29894f - 1) {
            return 4;
        }
        if (i10 - 1 != this.e.d.size() + this.f29893c.size()) {
            return 1;
        }
        return 0;
    }
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 != 4) {
                    ...
                    frameLayout.f20066b = textView;
                    com.google.android.gms.internal.vision.e2.l(14.0f, 1, textView);
                    textView.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18789ai, false));
                    int i12 = 3;
