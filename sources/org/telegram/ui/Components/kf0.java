...
public final class kf0 extends FrameLayout {
    public final ci.wc f25590a;
    public final ci.d f25591b;
    public final qt f25592c;
    public f71 d;
    public long e;
    public float f25593f;
    public ci.a4 h;
    public Utilities.Callback f25594n;
    public Runnable f25595r;
    ...
    public final void a(MediaController.PhotoEntry photoEntry, f71 f71Var, org.telegram.ui.ActionBar.d6 d6Var) {
        int i10;
        ci.d dVar = this.f25591b;
        dVar.f4461a = d6Var;
        dVar.j();
        int i11 = photoEntry.width;
        if (i11 > 0 && (i10 = photoEntry.height) > 0) {
            this.f25593f = Utilities.clamp(i10 / i11, 1.39f, 0.85f);
        } else {
            this.f25593f = 1.39f;
        }
        this.d = f71Var;
        ...
        f0Var.B1();
        this.f25590a.o(false, path, p5, f0Var.Z);
        long p10 = f71Var.p();
        float max = 2.8f / ((float) Math.max(60L, p10));
        float max2 = (1.0f - max) * (((float) this.e) / ((float) Math.max(1L, f71Var.p())));
        ci.wc wcVar = this.f25590a;
