...
public final class kf0 {
    public float f26260a = 0.0f;
    public float f26261b = 25.0f;
    public float f26262c = 50.0f;
    public float d = 75.0f;
    public float e = 100.0f;
    public float[] f26263f;

    public final float[] a() {
        float f10 = this.f26260a;
        float f11 = this.e;
        int i10 = 5;
        float[] fArr = {-0.001f, f10 / 100.0f, 0.0f, f10 / 100.0f, 0.25f, this.f26261b / 100.0f, 0.5f, this.f26262c / 100.0f, 0.75f, this.d / 100.0f, 1.0f, f11 / 100.0f, 1.001f, f11 / 100.0f};
        int i11 = 100;
        ...
        this.f26263f = new float[arrayList.size()];
        int i19 = 0;
        while (true) {
            float[] fArr2 = this.f26263f;
            if (i19 >= fArr2.length) {
                break;
            }
    ...
    public final boolean b() {
        if (Math.abs(this.f26260a - 0.0f) < 1.0E-5d && Math.abs(this.f26261b - 25.0f) < 1.0E-5d && Math.abs(this.f26262c - 50.0f) < 1.0E-5d && Math.abs(this.d - 75.0f) < 1.0E-5d && Math.abs(this.e - 100.0f) < 1.0E-5d) {
            return true;
        }
        return false;
    }
    ...
    public final void c(InputSerializedData inputSerializedData, boolean z4) {
        this.f26260a = inputSerializedData.readFloat(z4);
        this.f26261b = inputSerializedData.readFloat(z4);
        this.f26262c = inputSerializedData.readFloat(z4);
    ...
    public final void d(OutputSerializedData outputSerializedData) {
        outputSerializedData.writeFloat(this.f26260a);
        outputSerializedData.writeFloat(this.f26261b);
        outputSerializedData.writeFloat(this.f26262c);
