...
public final class kf0 extends FrameLayout {
    public final ci.zc f25624a;
    public final ci.d f25625b;
    public final pt f25626c;
    public h71 d;
    public long e;
    public float f25627f;
    public ci.b4 h;
    public Utilities.Callback f25628n;
    public Runnable f25629r;
    ...
    public final void a(MediaController.PhotoEntry photoEntry, h71 h71Var, org.telegram.ui.ActionBar.f6 f6Var) {
        int i10;
        ci.d dVar = this.f25625b;
        dVar.f4447a = f6Var;
        dVar.j();
        int i11 = photoEntry.width;
        if (i11 > 0 && (i10 = photoEntry.height) > 0) {
            this.f25627f = Utilities.clamp(i10 / i11, 1.39f, 0.85f);
        } else {
            this.f25627f = 1.39f;
        }
        this.d = h71Var;
