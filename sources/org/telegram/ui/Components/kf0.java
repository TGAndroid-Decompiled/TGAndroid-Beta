...
public final class kf0 extends FrameLayout {
    public final ci.zc f25593a;
    public final ci.d f25594b;
    public final pt f25595c;
    public g71 d;
    public long e;
    public float f25596f;
    public ci.b4 h;
    public Utilities.Callback f25597n;
    public Runnable f25598r;
    ...
    public final void a(MediaController.PhotoEntry photoEntry, g71 g71Var, org.telegram.ui.ActionBar.e6 e6Var) {
        int i10;
        ci.d dVar = this.f25594b;
        dVar.f4444a = e6Var;
        dVar.j();
        int i11 = photoEntry.width;
        if (i11 > 0 && (i10 = photoEntry.height) > 0) {
            this.f25596f = Utilities.clamp(i10 / i11, 1.39f, 0.85f);
        } else {
            this.f25596f = 1.39f;
        }
        this.d = g71Var;
