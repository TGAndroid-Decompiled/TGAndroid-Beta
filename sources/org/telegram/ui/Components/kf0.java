...
public final class kf0 extends FrameLayout {
    public final di.zc f27842a;
    public final di.d f27843b;
    public final nt f27844c;
    public g71 d;
    public long f27845e;
    public float f27846f;
    public di.b4 h;
    public Utilities.Callback f27847n;
    public Runnable f27848r;
    ...
    public final void a(MediaController.PhotoEntry photoEntry, g71 g71Var, org.telegram.ui.ActionBar.f6 f6Var) {
        int i10;
        di.d dVar = this.f27843b;
        dVar.f7035a = f6Var;
        dVar.j();
        int i11 = photoEntry.width;
        if (i11 > 0 && (i10 = photoEntry.height) > 0) {
            this.f27846f = Utilities.clamp(i10 / i11, 1.39f, 0.85f);
        } else {
            this.f27846f = 1.39f;
        }
        this.d = g71Var;
        ...
        if (j3 >= 0) {
            ...
            this.f27845e = g71Var.n();
        }
        String path = g71Var.F.getPath();
        long p5 = g71Var.p();
        i2.f0 f0Var = g71Var.d;
        f0Var.B1();
        this.f27842a.o(false, path, p5, f0Var.Z);
        long p10 = g71Var.p();
        float max = 2.8f / ((float) Math.max(60L, p10));
        float max2 = (1.0f - max) * (((float) this.f27845e) / ((float) Math.max(1L, g71Var.p())));
        di.zc zcVar = this.f27842a;
