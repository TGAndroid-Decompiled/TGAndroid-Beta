...
public abstract class dy0 extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public TextPaint f23425w;
    public StaticLayout f23426x;
    public int f23427y;
    ...
    public final long a() {
        ...
        long j3 = 0;
        for (int i10 = 0; i10 < this.f23419b.length; i10++) {
            long f7 = this.F.f(i10);
            cy0 cy0Var = this.f23419b[i10];
            if (cy0Var != null && (cy0Var.f23165c || f7 > 0)) {
                if (f7 <= 0) {
                    f7 = cy0Var.e;
                }
                j3 += f7;
    ...
    public final void c(boolean z10) {
        ...
        for (int i11 = 0; i11 < cy0VarArr.length; i11++) {
            ...
            if (cy0Var2 != null && (cy0Var2.f23165c || f12 > 0)) {
                this.f23427y++;
            }
            if (cy0Var2 != null && ((z11 = cy0Var2.f23165c) || f12 > 0)) {
        ...
        if (!z10) {
            System.arraycopy(this.d, 0, this.f23420c, 0, cy0VarArr.length);
            return;
        }
        System.arraycopy(this.f23420c, 0, this.e, 0, cy0VarArr.length);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f10;
        int i11;
        m6 m6Var = this.f23424s;
        ImageReceiver imageReceiver = this.h;
        m6 m6Var2 = this.f23423r;
        RectF rectF = this.f23418a;
        if (this.f23419b != null) {
            float f11 = 1.0f;
            if (imageReceiver != null) {
                canvas.save();
            ...
            while (true) {
                ...
                if (cy0Var != null) {
                    float f18 = this.f23420c[i12];
                    if (f18 != 0.0f) {
                        if (cy0Var.d) {
                            float z12 = com.google.android.gms.internal.vision.e2.z(f11, this.f23421f, 10.0f, f18 * (-360.0f));
                            if (z12 > 0.0f) {
                                z12 = 0.0f;
                            }
                            cy0Var.f23164b.setColor(org.telegram.ui.ActionBar.i6.w0(null, cy0Var.f23163a, z11));
                            this.f23419b[i12].f23164b.setAlpha(255);
                            double width = rectF.width() / 2.0f;
                            i11 = i12;
                            if (Math.abs((float) (((3.141592653589793d * width) / 180.0d) * z12)) <= f11) {
                                double d = (-90.0f) - (360.0f * f17);
                                canvas.drawPoint(rectF.centerX() + ((float) (Math.cos(Math.toRadians(d)) * width)), rectF.centerY() + ((float) (Math.sin(Math.toRadians(d)) * width)), this.f23419b[i11].f23164b);
                            } else {
                                this.f23419b[i11].f23164b.setStyle(Paint.Style.STROKE);
                                canvas.drawArc(rectF, (-90.0f) - (360.0f * f17), z12, false, this.f23419b[i11].f23164b);
                            }
                        } else {
                            i11 = i12;
                        }
            ...
            float f19 = 0.0f;
            while (true) {
                cy0[] cy0VarArr2 = this.f23419b;
                if (i13 >= cy0VarArr2.length) {
                    break;
                }
                cy0 cy0Var2 = cy0VarArr2[i13];
                if (cy0Var2 != null) {
                    float f20 = this.f23420c[i13];
                    if (f20 != 0.0f) {
                        if (!cy0Var2.d) {
                            float z13 = com.google.android.gms.internal.vision.e2.z(1.0f, this.f23421f, f7, f20 * (-360.0f));
                            if (z13 > 0.0f) {
                                z13 = 0.0f;
                            }
                            cy0Var2.f23164b.setColor(org.telegram.ui.ActionBar.i6.w0(null, cy0Var2.f23163a, false));
                            this.f23419b[i13].f23164b.setAlpha(i10);
                            double width2 = rectF.width() / 2.0f;
                            f10 = f20;
                            if (Math.abs((float) (z13 * ((width2 * 3.141592653589793d) / 180.0d))) <= 1.0f) {
                                double d10 = (-90.0f) - (f19 * 360.0f);
                                canvas.drawPoint(rectF.centerX() + ((float) (Math.cos(Math.toRadians(d10)) * width2)), rectF.centerY() + ((float) (Math.sin(Math.toRadians(d10)) * width2)), this.f23419b[i13].f23164b);
                            } else {
                                this.f23419b[i13].f23164b.setStyle(Paint.Style.STROKE);
                                canvas.drawArc(rectF, (-90.0f) - (f19 * 360.0f), z13, false, this.f23419b[i13].f23164b);
                                f19 += f10;
                                i13++;
                                i10 = 255;
                                f7 = 10.0f;
            ...
            if (this.f23426x != null) {
                canvas.save();
                canvas.translate(AndroidUtilities.dp(30.0f), AndroidUtilities.dp(148.0f) - ((this.f23426x.getHeight() - AndroidUtilities.dp(13.0f)) / 2.0f));
                this.f23425w.setColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18943j5, false));
                this.f23426x.draw(canvas);
                canvas.restore();
            }
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (l4 != null) {
            ...
            int textSize = (int) m6Var2.f26085a.getTextSize();
            int textSize2 = (int) m6Var.f26085a.getTextSize();
        ...
        if (this.v != null) {
            if (this.f23425w == null) {
                this.f23425w = new TextPaint(1);
            }
            this.f23425w.setTextSize(AndroidUtilities.dp(13.0f));
            int size = View.MeasureSpec.getSize(i10) - AndroidUtilities.dp(60.0f);
            CharSequence charSequence = this.v;
            TextPaint textPaint = this.f23425w;
            Layout.Alignment alignment = Layout.Alignment.ALIGN_CENTER;
            TextUtils.TruncateAt truncateAt = TextUtils.TruncateAt.END;
            this.f23426x = jw0.d(charSequence, textPaint, size, false, size, 1);
        }
        if (imageReceiver != null) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        Long l4;
        ImageReceiver imageReceiver = this.h;
        if (imageReceiver != null && (l4 = this.f23422n) != null && l4.longValue() != Long.MAX_VALUE && motionEvent.getX() > imageReceiver.getImageX() && motionEvent.getX() <= imageReceiver.getImageX2() && motionEvent.getY() > imageReceiver.getImageY() && motionEvent.getY() <= imageReceiver.getImageY2()) {
            z10 = true;
        } else {
            z10 = false;
        }
