...
public final class fc0 extends Drawable {
    ...
    public fc0() {
        ...
        this.f28382e = System.currentTimeMillis();
    }
    ...
    public final void a(int i10) {
        if (i10 != this.f28383f) {
            ...
            this.d = alpha;
            this.f28380b.setColor(i0.a.k(i10, (int) ((alpha / 255.0f) * this.f28381c)));
        }
        this.f28383f = i10;
    }
    ...
    public final Drawable.ConstantState getConstantState() {
        if (this.f28379a == null) {
            this.f28379a = new Drawable.ConstantState();
        }
        return this.f28379a;
    }
    ...
    public final void setAlpha(int i10) {
        if (this.f28381c != i10) {
            this.f28381c = i10;
            this.f28380b.setAlpha((int) ((this.d / 255.0f) * i10));
        }
    }
