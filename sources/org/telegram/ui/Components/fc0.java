...
public abstract class fc0 extends FrameLayout {
    ...
    public final bc0 F;
    public final ah.c G;
    public TLRPC.Peer f24139a;
    public final boolean f24140b;
    public final org.telegram.ui.wn f24141c;
    public final MessagePreviewParams d;
    public final dc0 e;
    public final hb0 f24142f;
    public ValueAnimator h;
    public final TLRPC.User f24143n;
    public final TLRPC.Chat f24144r;
    public boolean f24145s;
    public boolean v;
    public final int f24146w;
    public boolean f24147x;
    public final org.telegram.ui.Cells.t6 f24148y;
    ...
    public fc0(Context context, org.telegram.ui.wn wnVar, ah.c cVar, MessagePreviewParams messagePreviewParams, TLRPC.User user, TLRPC.Chat chat, int i10, bc0 bc0Var, int i11, final boolean z10) {
        super(context);
        this.f24148y = new org.telegram.ui.Cells.t6(this, 17);
        ...
        this.F = bc0Var;
        this.f24142f = new hb0(this, context, bc0Var);
        ...
        for (int i13 = 0; i13 < 3; i13++) {
            ...
            if (i13 == i11) {
                i12 = this.e.f23585a.size() - 1;
            }
        }
        this.f24142f.setAdapter(new ib0(this, context));
        this.f24142f.setPosition(i12);
        this.e.setSelectedTab(i12);
        addView(this.e, w7.y5.e(-1, 66, 87));
        addView(this.f24142f, w7.y5.d(-1, -1.0f, 119, 0.0f, 0.0f, 0.0f, 66.0f));
