...
public class ao0 extends ScrollView {
    public final org.telegram.ui.ActionBar.f6 f22448a;
    public final LinearLayout f22449b;
    public final float f22450c;
    public final float[] d;
    public final float[] e;
    public final ArrayList f22451f;
    public final ArrayList h;
    public final Path f22452n;

    public ao0(Context context, LinearLayout linearLayout, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        super(context);
        float f7;
        this.f22450c = AndroidUtilities.dp(16.0f);
        this.f22451f = new ArrayList();
        this.h = new ArrayList();
        this.f22452n = new Path();
        this.f22448a = f6Var;
        this.f22449b = linearLayout;
    ...
    public final void a(Canvas canvas, View view, View view2) {
        ...
        if (view != null && view2 != null) {
            ...
            float f10 = 0.0f;
            LinearLayout linearLayout = this.f22449b;
            ...
            if (rectF.bottom >= rectF.top) {
                ml0.P0(canvas, rectF, AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f), view.getAlpha(), this.f22448a);
            }
        }
    }
            ...
            if (childAt.getVisibility() == 0) {
                if (childAt instanceof LinearLayout) {
                    ...
                    if (linearLayout.getOrientation() == 1) {
                        LinearLayout linearLayout2 = this.f22449b;
    ...
    public final float c(View view) {
        if (view != this.f22449b && (view.getParent() instanceof View)) {
    ...
    public final void onScrollChanged(int i10, int i11, int i12, int i13) {
        ...
        ArrayList arrayList = this.f22451f;
        int size = arrayList.size();
        int i14 = 0;
        while (i14 < size) {
