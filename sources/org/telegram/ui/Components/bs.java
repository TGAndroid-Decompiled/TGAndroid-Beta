...
public final class bs implements MessagesStorage.LongCallback, kl0 {
    public final int f23042a;
    public final fs f23043b;
    ...
    public void c(float f7, float f10, int i10, View view) {
        boolean z10;
        boolean[] zArr;
        fs fsVar = this.f23043b;
        w51 G = fsVar.X.G(i10 - 1);
        if (G != null) {
            es esVar = fsVar.f24168k0;
            es esVar2 = fsVar.f24167j0;
            es esVar3 = fsVar.f24166i0;
            es esVar4 = fsVar.f24169l0;
            TLRPC.TL_chatBannedRights tL_chatBannedRights = fsVar.f24179w0;
            int i11 = G.d;
            if (i11 == 103) {
                boolean z11 = !fsVar.f24172p0;
                fsVar.f24172p0 = z11;
            ...
            if (i12 == 37) {
                ...
                if (i12 == 39) {
                    if (G.f29956t) {
                        ...
                        alertDialog$Builder.f18654a.R = LocaleController.getString(R.string.UserRestrictionsCantModify);
                        alertDialog$Builder.f18654a.T = LocaleController.getString(R.string.UserRestrictionsCantModifyDisabled);
                ...
                if (G.f29956t) {
                    ...
                    alertDialog$Builder2.f18654a.R = LocaleController.getString(R.string.UserRestrictionsCantModify);
                    alertDialog$Builder2.f18654a.T = LocaleController.getString(R.string.UserRestrictionsCantModifyDisabled);
                    alertDialog$Builder2.k(LocaleController.getString(R.string.OK), null);
                    alertDialog$Builder2.f18654a.show();
                    return;
                }
                if (i11 == 6) {
                    z10 = true;
                    ...
                    if (i11 == 7) {
                        ...
                        if (i11 == 12) {
                            ...
                            if (!tL_chatBannedRights.send_plain && !fsVar.f24178v0.send_plain) {
                                tL_chatBannedRights.embed_links = !tL_chatBannedRights.embed_links;
                                fsVar.V();
                            } else {
                                int i15 = 0;
                                while (true) {
                                    if (i15 >= fsVar.X.f25681x.size()) {
                                        break;
                                    }
                                    w51 G2 = fsVar.X.G(i15);
                                    if (G2.f15704a == 39 && G2.d == 0) {
