...
public final class v50 implements Runnable {
    ...
    public File f29009b;
    public long f29010b0;
    public boolean f29011c;
    public int d;
    public long f29013d0;
    public int e;
    public long f29014e0;
    public int f29015f;
    public long f29016f0;
    public boolean f29022l0;
    public int m0;
    ...
    public int f29026p0;
    public int f29027q0;
    public Surface f29028r;
    public int f29029r0;
    public int f29031s0;
    public int f29032t0;
    public int f29033u0;
    public int f29034v0;
    public EGLContext f29035w;
    public EGLConfig f29037x;
    public c50 f29038x0;
    public AudioRecord f29040y0;
    public boolean h = true;
    public EGLDisplay f29030s = EGL14.EGL_NO_DISPLAY;
    public EGLContext v = EGL14.EGL_NO_CONTEXT;
    public EGLSurface f29039y = EGL14.EGL_NO_SURFACE;
    ...
    public long f29012c0 = -1;
    public long f29017g0 = -1;
    public long f29018h0 = -1;
    public long f29019i0 = -1;
    public long f29020j0 = 0;
    public long f29021k0 = -1;
    public Integer f29036w0 = 0;
    public final ArrayBlockingQueue f29041z0 = new ArrayBlockingQueue(10);
    ...
    public static void a(v50 v50Var, boolean z10) {
        ...
        try {
            ...
            v50Var.f29041z0.clear();
            for (int i12 = 0; i12 < 3; i12++) {
                v50Var.f29041z0.add(new k50());
            }
            if (z10) {
                v50Var.f29017g0 = v50Var.f29013d0 + v50Var.f29014e0;
                v50Var.f29021k0 = v50Var.f29019i0 + v50Var.f29020j0;
                v50Var.Q = true;
                j3 = 0;
            } else {
                v50Var.f29017g0 = -1L;
            ...
            v50Var.f29016f0 = -1L;
            v50Var.f29019i0 = -1L;
            v50Var.f29008a0 = false;
            v50Var.Z = 0L;
            AudioRecord audioRecord = new AudioRecord(0, 48000, 16, 2, i10);
            v50Var.f29040y0 = audioRecord;
            audioRecord.startRecording();
            if (BuildVars.LOGS_ENABLED) {
                FileLog.d("InstantCamera initied audio record with channels " + v50Var.f29040y0.getChannelCount() + " sample rate = " + v50Var.f29040y0.getSampleRate() + " bufferSize = " + i10);
            }
            v50Var.D0 = false;
            ...
            mediaFormat.setInteger("bitrate", MessagesController.getInstance(v50Var.H0.f23221f).roundAudioBitrate * 1024);
            ...
            createVideoFormat.setInteger("bitrate", v50Var.f29015f);
            createVideoFormat.setInteger("frame-rate", 30);
            createVideoFormat.setInteger("i-frame-interval", 1);
            v50Var.E.configure(createVideoFormat, (Surface) null, (MediaCrypto) null, 1);
            v50Var.f29028r = v50Var.E.createInputSurface();
            v50Var.E.start();
            if (!z10) {
                boolean isSdCardPath = ImageLoader.isSdCardPath(v50Var.f29007a);
                v50Var.f29009b = v50Var.f29007a;
                if (isSdCardPath) {
                    File file = new File(ApplicationLoader.getFilesDirFixed(), "camera_tmp.mp4");
                    v50Var.f29009b = file;
                    if (file.exists()) {
                        v50Var.f29009b.delete();
                    }
                    v50Var.f29011c = true;
                }
                Mp4Movie mp4Movie = new Mp4Movie();
                mp4Movie.setCacheFile(v50Var.f29009b);
            ...
            if (v50Var.f29030s == EGL14.EGL_NO_DISPLAY) {
                EGLDisplay eglGetDisplay = EGL14.eglGetDisplay(0);
                v50Var.f29030s = eglGetDisplay;
                if (eglGetDisplay != EGL14.EGL_NO_DISPLAY) {
                    int[] iArr = new int[2];
                    if (EGL14.eglInitialize(eglGetDisplay, iArr, 0, iArr, 1)) {
                        if (v50Var.v == EGL14.EGL_NO_CONTEXT) {
                            EGLConfig[] eGLConfigArr = new EGLConfig[1];
                            if (EGL14.eglChooseConfig(v50Var.f29030s, new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12352, 4, 12610, 1, 12344}, 0, eGLConfigArr, 0, 1, new int[1], 0)) {
                                i11 = 0;
                                v50Var.v = EGL14.eglCreateContext(v50Var.f29030s, eGLConfigArr[0], v50Var.f29035w, new int[]{12440, 2, 12344}, 0);
                                v50Var.f29037x = eGLConfigArr[0];
                            } else {
                        ...
                        EGL14.eglQueryContext(v50Var.f29030s, v50Var.v, 12440, new int[1], i11);
                        if (v50Var.f29039y == EGL14.EGL_NO_SURFACE) {
                            EGLSurface eglCreateWindowSurface = EGL14.eglCreateWindowSurface(v50Var.f29030s, v50Var.f29037x, v50Var.f29028r, new int[]{12344}, i11);
                            v50Var.f29039y = eglCreateWindowSurface;
                            if (eglCreateWindowSurface != null) {
                                if (!EGL14.eglMakeCurrent(v50Var.f29030s, eglCreateWindowSurface, eglCreateWindowSurface, v50Var.v)) {
                                    if (BuildVars.LOGS_ENABLED) {
                                ...
                                c50 c50Var = v50Var.f29038x0;
                                if (c50Var != null) {
                                    c50Var.b();
                                    v50Var.f29038x0 = null;
                                }
                                v50Var.f29038x0 = new c50(v50Var.d, v50Var.e);
                                c60 c60Var2 = v50Var.H0;
                                Size size = c60Var2.f23232n0[0];
                                if (!SharedConfig.deviceIsLow() && c60.k() && (size == null || Math.max(size.getHeight(), size.getWidth()) * 0.7f >= MessagesController.getInstance(c60Var2.f23221f).roundVideoSize)) {
                                ...
                                if (j10 != 0 && j11 != 0) {
                                    ...
                                    v50Var.f29026p0 = GLES20.glGetAttribLocation(v50Var.m0, "aPosition");
                                    v50Var.f29027q0 = GLES20.glGetAttribLocation(v50Var.m0, "aTextureCoord");
                                    v50Var.f29031s0 = GLES20.glGetUniformLocation(v50Var.m0, "preview");
                                    v50Var.f29029r0 = GLES20.glGetUniformLocation(v50Var.m0, "resolution");
                                    v50Var.f29033u0 = GLES20.glGetUniformLocation(v50Var.m0, "alpha");
                                    v50Var.f29024n0 = GLES20.glGetUniformLocation(v50Var.m0, "uMVPMatrix");
                                    v50Var.f29025o0 = GLES20.glGetUniformLocation(v50Var.m0, "uSTMatrix");
                                    v50Var.f29032t0 = GLES20.glGetUniformLocation(v50Var.m0, "texelSize");
                                    return;
                                }
                                return;
                            }
    ...
    public static void b(v50 v50Var, int i10, q50 q50Var) {
        ...
        if (i10 == 1 && (((videoEditedInfo = v50Var.H0.S) == null || !videoEditedInfo.needConvert()) && !v50Var.H0.f23231n.c())) {
            if (!v50Var.G0) {
                v50Var.G0 = true;
        ...
        File file = v50Var.H0.f23224g0;
        if (file != null) {
            file.delete();
            v50Var.H0.f23224g0 = null;
        }
        ...
        if (mP4Builder != null) {
            ...
            if (v50Var.f29011c) {
                if (v50Var.f29007a.exists()) {
                    try {
                        v50Var.f29007a.delete();
                    } catch (Exception e12) {
                        FileLog.e("InstantCamera copying fileToWrite to videoFile, deleting videoFile error " + v50Var.f29007a);
                        FileLog.e(e12);
                    }
                }
                if (!v50Var.f29009b.renameTo(v50Var.f29007a)) {
                    FileLog.e("InstantCamera unable to rename file, try move file");
                    try {
                        AndroidUtilities.copyFile(v50Var.f29009b, v50Var.f29007a);
                        v50Var.f29009b.delete();
        ...
        if (i10 == 0) {
            FileLoader.getInstance(v50Var.H0.f23221f).cancelFileUpload(v50Var.f29007a.getAbsolutePath(), false);
            try {
                v50Var.f29009b.delete();
        ...
        EGL14.eglDestroySurface(v50Var.f29030s, v50Var.f29039y);
        v50Var.f29039y = EGL14.EGL_NO_SURFACE;
        Surface surface = v50Var.f29028r;
        if (surface != null) {
            surface.release();
            v50Var.f29028r = null;
        }
        EGLDisplay eGLDisplay = v50Var.f29030s;
        if (eGLDisplay != EGL14.EGL_NO_DISPLAY) {
            EGLSurface eGLSurface = EGL14.EGL_NO_SURFACE;
            EGL14.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, EGL14.EGL_NO_CONTEXT);
            EGL14.eglDestroyContext(v50Var.f29030s, v50Var.v);
            EGL14.eglReleaseThread();
            EGL14.eglTerminate(v50Var.f29030s);
        }
        v50Var.f29030s = EGL14.EGL_NO_DISPLAY;
                ...
                if (outputBuffer != null) {
                    ...
                    if (i10 > 1) {
                        ...
                        if ((i11 & 2) == 0) {
                            ...
                            if (writeSampleData != 0 && !this.f29011c && this.H0.V0) {
                                c(this.f29007a, writeSampleData, false);
                            }
                        } else if (this.M == -5) {
                ...
                if (dequeueOutputBuffer2 == -2) {
                    ...
                    if (outputBuffer2 != null) {
                        ...
                        if (bufferInfo3.size != 0) {
                            ...
                            if (writeSampleData2 != 0 && !this.f29011c && this.H0.V0) {
                                c(this.f29007a, writeSampleData2, false);
                            }
    ...
    public final void finalize() {
        c50 c50Var = this.f29038x0;
        if (c50Var != null) {
            c50Var.b();
            this.f29038x0 = null;
        }
        try {
            EGLDisplay eGLDisplay = this.f29030s;
            if (eGLDisplay != EGL14.EGL_NO_DISPLAY) {
                EGLSurface eGLSurface = EGL14.EGL_NO_SURFACE;
                EGL14.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, EGL14.EGL_NO_CONTEXT);
                EGL14.eglDestroyContext(this.f29030s, this.v);
                EGL14.eglReleaseThread();
                EGL14.eglTerminate(this.f29030s);
                this.f29030s = EGL14.EGL_NO_DISPLAY;
    ...
    public final void h(File file) {
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(linearLayout, property, 0.0f), ObjectAnimator.ofInt(c60Var.f23236r, s6.f28161b, 0), ObjectAnimator.ofFloat(c60Var.G, property, 1.0f));
        animatorSet.setDuration(180L);
        animatorSet.setInterpolator(new DecelerateInterpolator());
        animatorSet.start();
        EGL14.eglDestroySurface(this.f29030s, this.f29039y);
        this.f29039y = EGL14.EGL_NO_SURFACE;
        Surface surface = this.f29028r;
        if (surface != null) {
            surface.release();
            this.f29028r = null;
        }
