...
public final class v50 implements Runnable {
    ...
    public int d;
    public long f28609d0;
    public int e;
    public long f28610e0;
    public int f28611f;
    public long f28612f0;
    public boolean f28618l0;
    public int m0;
    ...
    public int f28622p0;
    public int f28623q0;
    public Surface f28624r;
    public int f28625r0;
    public int f28627s0;
    public int f28628t0;
    public int f28629u0;
    public int f28630v0;
    public EGLContext f28631w;
    public EGLConfig f28633x;
    public b50 f28634x0;
    public AudioRecord f28636y0;
    public boolean h = true;
    public EGLDisplay f28626s = EGL14.EGL_NO_DISPLAY;
    public EGLContext v = EGL14.EGL_NO_CONTEXT;
    public EGLSurface f28635y = EGL14.EGL_NO_SURFACE;
    ...
    public long f28608c0 = -1;
    public long f28613g0 = -1;
    public long f28614h0 = -1;
    public long f28615i0 = -1;
    public long f28616j0 = 0;
    public long f28617k0 = -1;
    public Integer f28632w0 = 0;
    public final ArrayBlockingQueue f28637z0 = new ArrayBlockingQueue(10);
    ...
    public static void a(v50 v50Var, boolean z10) {
        ...
        try {
            ...
            v50Var.f28637z0.clear();
            for (int i12 = 0; i12 < 3; i12++) {
                v50Var.f28637z0.add(new k50());
            }
            if (z10) {
                v50Var.f28613g0 = v50Var.f28609d0 + v50Var.f28610e0;
                v50Var.f28617k0 = v50Var.f28615i0 + v50Var.f28616j0;
                v50Var.Q = true;
                j3 = 0;
            } else {
                v50Var.f28613g0 = -1L;
            ...
            v50Var.f28612f0 = -1L;
            v50Var.f28615i0 = -1L;
            v50Var.f28604a0 = false;
            v50Var.Z = 0L;
            AudioRecord audioRecord = new AudioRecord(0, 48000, 16, 2, i10);
            v50Var.f28636y0 = audioRecord;
            audioRecord.startRecording();
            if (BuildVars.LOGS_ENABLED) {
                FileLog.d("InstantCamera initied audio record with channels " + v50Var.f28636y0.getChannelCount() + " sample rate = " + v50Var.f28636y0.getSampleRate() + " bufferSize = " + i10);
            }
            v50Var.D0 = false;
            ...
            mediaFormat.setInteger("bitrate", MessagesController.getInstance(v50Var.H0.f29574a).roundAudioBitrate * 1024);
            ...
            createVideoFormat.setInteger("bitrate", v50Var.f28611f);
            createVideoFormat.setInteger("frame-rate", 30);
            createVideoFormat.setInteger("i-frame-interval", 1);
            v50Var.E.configure(createVideoFormat, (Surface) null, (MediaCrypto) null, 1);
            v50Var.f28624r = v50Var.E.createInputSurface();
            v50Var.E.start();
            if (!z10) {
                boolean isSdCardPath = ImageLoader.isSdCardPath(v50Var.f28603a);
                v50Var.f28605b = v50Var.f28603a;
                if (isSdCardPath) {
                    File file = new File(ApplicationLoader.getFilesDirFixed(), "camera_tmp.mp4");
                    v50Var.f28605b = file;
                    if (file.exists()) {
                        v50Var.f28605b.delete();
                    }
                    v50Var.f28607c = true;
                }
                Mp4Movie mp4Movie = new Mp4Movie();
                mp4Movie.setCacheFile(v50Var.f28605b);
            ...
            if (v50Var.f28626s == EGL14.EGL_NO_DISPLAY) {
                EGLDisplay eglGetDisplay = EGL14.eglGetDisplay(0);
                v50Var.f28626s = eglGetDisplay;
                if (eglGetDisplay != EGL14.EGL_NO_DISPLAY) {
                    int[] iArr = new int[2];
                    if (EGL14.eglInitialize(eglGetDisplay, iArr, 0, iArr, 1)) {
                        if (v50Var.v == EGL14.EGL_NO_CONTEXT) {
                            EGLConfig[] eGLConfigArr = new EGLConfig[1];
                            if (EGL14.eglChooseConfig(v50Var.f28626s, new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12352, 4, 12610, 1, 12344}, 0, eGLConfigArr, 0, 1, new int[1], 0)) {
                                i11 = 0;
                                v50Var.v = EGL14.eglCreateContext(v50Var.f28626s, eGLConfigArr[0], v50Var.f28631w, new int[]{12440, 2, 12344}, 0);
                                v50Var.f28633x = eGLConfigArr[0];
                            } else {
                        ...
                        EGL14.eglQueryContext(v50Var.f28626s, v50Var.v, 12440, new int[1], i11);
                        if (v50Var.f28635y == EGL14.EGL_NO_SURFACE) {
                            EGLSurface eglCreateWindowSurface = EGL14.eglCreateWindowSurface(v50Var.f28626s, v50Var.f28633x, v50Var.f28624r, new int[]{12344}, i11);
                            v50Var.f28635y = eglCreateWindowSurface;
                            if (eglCreateWindowSurface != null) {
                                if (!EGL14.eglMakeCurrent(v50Var.f28626s, eglCreateWindowSurface, eglCreateWindowSurface, v50Var.v)) {
                                    if (BuildVars.LOGS_ENABLED) {
                                ...
                                b50 b50Var = v50Var.f28634x0;
                                if (b50Var != null) {
                                    b50Var.b();
                                    v50Var.f28634x0 = null;
                                }
                                v50Var.f28634x0 = new b50(v50Var.d, v50Var.e);
                                w50 w50Var2 = v50Var.H0;
                                Size size = w50Var2.f29588i0[0];
                                if (!SharedConfig.deviceIsLow() && w50.b() && (size == null || Math.max(size.getHeight(), size.getWidth()) * 0.7f >= MessagesController.getInstance(w50Var2.f29574a).roundVideoSize)) {
                                ...
                                if (a2 != 0 && a10 != 0) {
                                    ...
                                    v50Var.f28622p0 = GLES20.glGetAttribLocation(v50Var.m0, "aPosition");
                                    v50Var.f28623q0 = GLES20.glGetAttribLocation(v50Var.m0, "aTextureCoord");
                                    v50Var.f28627s0 = GLES20.glGetUniformLocation(v50Var.m0, "preview");
                                    v50Var.f28625r0 = GLES20.glGetUniformLocation(v50Var.m0, "resolution");
                                    v50Var.f28629u0 = GLES20.glGetUniformLocation(v50Var.m0, "alpha");
                                    v50Var.f28620n0 = GLES20.glGetUniformLocation(v50Var.m0, "uMVPMatrix");
                                    v50Var.f28621o0 = GLES20.glGetUniformLocation(v50Var.m0, "uSTMatrix");
                                    v50Var.f28628t0 = GLES20.glGetUniformLocation(v50Var.m0, "texelSize");
                                    return;
                                }
                                return;
                            }
    ...
    public static void b(v50 v50Var, int i10, q50 q50Var) {
        ...
        if (i10 == 1 && (((videoEditedInfo = v50Var.H0.N) == null || !videoEditedInfo.needConvert()) && !v50Var.H0.f29580c.c())) {
            if (!v50Var.G0) {
                v50Var.G0 = true;
        ...
        File file = v50Var.H0.f29578b0;
        if (file != null) {
            file.delete();
            v50Var.H0.f29578b0 = null;
        }
        ...
        if (mP4Builder != null) {
            ...
            if (v50Var.f28607c) {
                if (v50Var.f28603a.exists()) {
                    try {
                        v50Var.f28603a.delete();
                    } catch (Exception e12) {
                        FileLog.e("InstantCamera copying fileToWrite to videoFile, deleting videoFile error " + v50Var.f28603a);
                        FileLog.e(e12);
                    }
                }
                if (!v50Var.f28605b.renameTo(v50Var.f28603a)) {
                    FileLog.e("InstantCamera unable to rename file, try move file");
                    try {
                        AndroidUtilities.copyFile(v50Var.f28605b, v50Var.f28603a);
                        v50Var.f28605b.delete();
        ...
        if (i10 == 0) {
            FileLoader.getInstance(v50Var.H0.f29574a).cancelFileUpload(v50Var.f28603a.getAbsolutePath(), false);
            try {
                v50Var.f28605b.delete();
        ...
        EGL14.eglDestroySurface(v50Var.f28626s, v50Var.f28635y);
        v50Var.f28635y = EGL14.EGL_NO_SURFACE;
        Surface surface = v50Var.f28624r;
        if (surface != null) {
            surface.release();
            v50Var.f28624r = null;
        }
        EGLDisplay eGLDisplay = v50Var.f28626s;
        if (eGLDisplay != EGL14.EGL_NO_DISPLAY) {
            EGLSurface eGLSurface = EGL14.EGL_NO_SURFACE;
            EGL14.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, EGL14.EGL_NO_CONTEXT);
            EGL14.eglDestroyContext(v50Var.f28626s, v50Var.v);
            EGL14.eglReleaseThread();
            EGL14.eglTerminate(v50Var.f28626s);
        }
        v50Var.f28626s = EGL14.EGL_NO_DISPLAY;
                ...
                if (outputBuffer != null) {
                    ...
                    if (i10 > 1) {
                        ...
                        if ((i11 & 2) == 0) {
                            ...
                            if (writeSampleData != 0 && !this.f28607c && this.H0.Q0) {
                                c(this.f28603a, writeSampleData, false);
                            }
                        } else if (this.M == -5) {
                ...
                if (dequeueOutputBuffer2 == -2) {
                    ...
                    if (outputBuffer2 != null) {
                        ...
                        if (bufferInfo3.size != 0) {
                            ...
                            if (writeSampleData2 != 0 && !this.f28607c && this.H0.Q0) {
                                c(this.f28603a, writeSampleData2, false);
                            }
    ...
    public final void finalize() {
        b50 b50Var = this.f28634x0;
        if (b50Var != null) {
            b50Var.b();
            this.f28634x0 = null;
        }
        try {
            EGLDisplay eGLDisplay = this.f28626s;
            if (eGLDisplay != EGL14.EGL_NO_DISPLAY) {
                EGLSurface eGLSurface = EGL14.EGL_NO_SURFACE;
                EGL14.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, EGL14.EGL_NO_CONTEXT);
                EGL14.eglDestroyContext(this.f28626s, this.v);
                EGL14.eglReleaseThread();
                EGL14.eglTerminate(this.f28626s);
                this.f28626s = EGL14.EGL_NO_DISPLAY;
    ...
    public final void h(File file) {
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(linearLayout, property, 0.0f), ObjectAnimator.ofInt(w50Var.d, q6.f27260b, 0), ObjectAnimator.ofFloat(w50Var.f29604w, property, 1.0f));
        animatorSet.setDuration(180L);
        animatorSet.setInterpolator(new DecelerateInterpolator());
        animatorSet.start();
        EGL14.eglDestroySurface(this.f28626s, this.f28635y);
        this.f28635y = EGL14.EGL_NO_SURFACE;
        Surface surface = this.f28624r;
        if (surface != null) {
            surface.release();
            this.f28624r = null;
        }
    ...
    public final void run() {
        ...
        synchronized (this.U) {
            g.d dVar = new g.d(1);
            dVar.f9234b = new WeakReference(this);
            this.T = dVar;
            this.V = true;
            this.U.notify();
        }
