...
public final class v50 implements Runnable {
    ...
    public File f28602b;
    public long f28603b0;
    public boolean f28604c;
    public int d;
    public long f28606d0;
    public int e;
    public long f28607e0;
    public int f28608f;
    public long f28609f0;
    public boolean f28615l0;
    public int m0;
    ...
    public int f28619p0;
    public int f28620q0;
    public Surface f28621r;
    public int f28622r0;
    public int f28624s0;
    public int f28625t0;
    public int f28626u0;
    public int f28627v0;
    public EGLContext f28628w;
    public EGLConfig f28630x;
    public b50 f28631x0;
    public AudioRecord f28633y0;
    public boolean h = true;
    public EGLDisplay f28623s = EGL14.EGL_NO_DISPLAY;
    public EGLContext v = EGL14.EGL_NO_CONTEXT;
    public EGLSurface f28632y = EGL14.EGL_NO_SURFACE;
    ...
    public long f28605c0 = -1;
    public long f28610g0 = -1;
    public long f28611h0 = -1;
    public long f28612i0 = -1;
    public long f28613j0 = 0;
    public long f28614k0 = -1;
    public Integer f28629w0 = 0;
    public final ArrayBlockingQueue f28634z0 = new ArrayBlockingQueue(10);
    ...
    public static void a(v50 v50Var, boolean z10) {
        ...
        try {
            ...
            v50Var.f28634z0.clear();
            for (int i12 = 0; i12 < 3; i12++) {
                v50Var.f28634z0.add(new k50());
            }
            if (z10) {
                v50Var.f28610g0 = v50Var.f28606d0 + v50Var.f28607e0;
                v50Var.f28614k0 = v50Var.f28612i0 + v50Var.f28613j0;
                v50Var.Q = true;
                j3 = 0;
            } else {
                v50Var.f28610g0 = -1L;
            ...
            v50Var.f28609f0 = -1L;
            v50Var.f28612i0 = -1L;
            v50Var.f28601a0 = false;
            v50Var.Z = 0L;
            AudioRecord audioRecord = new AudioRecord(0, 48000, 16, 2, i10);
            v50Var.f28633y0 = audioRecord;
            audioRecord.startRecording();
            if (BuildVars.LOGS_ENABLED) {
                FileLog.d("InstantCamera initied audio record with channels " + v50Var.f28633y0.getChannelCount() + " sample rate = " + v50Var.f28633y0.getSampleRate() + " bufferSize = " + i10);
            }
            v50Var.D0 = false;
            ...
            mediaFormat.setInteger("bitrate", MessagesController.getInstance(v50Var.H0.f29571a).roundAudioBitrate * 1024);
            ...
            createVideoFormat.setInteger("bitrate", v50Var.f28608f);
            createVideoFormat.setInteger("frame-rate", 30);
            createVideoFormat.setInteger("i-frame-interval", 1);
            v50Var.E.configure(createVideoFormat, (Surface) null, (MediaCrypto) null, 1);
            v50Var.f28621r = v50Var.E.createInputSurface();
            v50Var.E.start();
            if (!z10) {
                boolean isSdCardPath = ImageLoader.isSdCardPath(v50Var.f28600a);
                v50Var.f28602b = v50Var.f28600a;
                if (isSdCardPath) {
                    File file = new File(ApplicationLoader.getFilesDirFixed(), "camera_tmp.mp4");
                    v50Var.f28602b = file;
                    if (file.exists()) {
                        v50Var.f28602b.delete();
                    }
                    v50Var.f28604c = true;
                }
                Mp4Movie mp4Movie = new Mp4Movie();
                mp4Movie.setCacheFile(v50Var.f28602b);
            ...
            if (v50Var.f28623s == EGL14.EGL_NO_DISPLAY) {
                EGLDisplay eglGetDisplay = EGL14.eglGetDisplay(0);
                v50Var.f28623s = eglGetDisplay;
                if (eglGetDisplay != EGL14.EGL_NO_DISPLAY) {
                    int[] iArr = new int[2];
                    if (EGL14.eglInitialize(eglGetDisplay, iArr, 0, iArr, 1)) {
                        if (v50Var.v == EGL14.EGL_NO_CONTEXT) {
                            EGLConfig[] eGLConfigArr = new EGLConfig[1];
                            if (EGL14.eglChooseConfig(v50Var.f28623s, new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12352, 4, 12610, 1, 12344}, 0, eGLConfigArr, 0, 1, new int[1], 0)) {
                                i11 = 0;
                                v50Var.v = EGL14.eglCreateContext(v50Var.f28623s, eGLConfigArr[0], v50Var.f28628w, new int[]{12440, 2, 12344}, 0);
                                v50Var.f28630x = eGLConfigArr[0];
                            } else {
                        ...
                        EGL14.eglQueryContext(v50Var.f28623s, v50Var.v, 12440, new int[1], i11);
                        if (v50Var.f28632y == EGL14.EGL_NO_SURFACE) {
                            EGLSurface eglCreateWindowSurface = EGL14.eglCreateWindowSurface(v50Var.f28623s, v50Var.f28630x, v50Var.f28621r, new int[]{12344}, i11);
                            v50Var.f28632y = eglCreateWindowSurface;
                            if (eglCreateWindowSurface != null) {
                                if (!EGL14.eglMakeCurrent(v50Var.f28623s, eglCreateWindowSurface, eglCreateWindowSurface, v50Var.v)) {
                                    if (BuildVars.LOGS_ENABLED) {
                                ...
                                b50 b50Var = v50Var.f28631x0;
                                if (b50Var != null) {
                                    b50Var.b();
                                    v50Var.f28631x0 = null;
                                }
                                v50Var.f28631x0 = new b50(v50Var.d, v50Var.e);
                                w50 w50Var2 = v50Var.H0;
                                Size size = w50Var2.f29585i0[0];
                                if (!SharedConfig.deviceIsLow() && w50.b() && (size == null || Math.max(size.getHeight(), size.getWidth()) * 0.7f >= MessagesController.getInstance(w50Var2.f29571a).roundVideoSize)) {
                                ...
                                if (a2 != 0 && a10 != 0) {
                                    ...
                                    v50Var.f28619p0 = GLES20.glGetAttribLocation(v50Var.m0, "aPosition");
                                    v50Var.f28620q0 = GLES20.glGetAttribLocation(v50Var.m0, "aTextureCoord");
                                    v50Var.f28624s0 = GLES20.glGetUniformLocation(v50Var.m0, "preview");
                                    v50Var.f28622r0 = GLES20.glGetUniformLocation(v50Var.m0, "resolution");
                                    v50Var.f28626u0 = GLES20.glGetUniformLocation(v50Var.m0, "alpha");
                                    v50Var.f28617n0 = GLES20.glGetUniformLocation(v50Var.m0, "uMVPMatrix");
                                    v50Var.f28618o0 = GLES20.glGetUniformLocation(v50Var.m0, "uSTMatrix");
                                    v50Var.f28625t0 = GLES20.glGetUniformLocation(v50Var.m0, "texelSize");
                                    return;
                                }
                                return;
                            }
    ...
    public static void b(v50 v50Var, int i10, q50 q50Var) {
        ...
        if (i10 == 1 && (((videoEditedInfo = v50Var.H0.N) == null || !videoEditedInfo.needConvert()) && !v50Var.H0.f29577c.c())) {
            if (!v50Var.G0) {
                v50Var.G0 = true;
        ...
        File file = v50Var.H0.f29575b0;
        if (file != null) {
            file.delete();
            v50Var.H0.f29575b0 = null;
        }
        ...
        if (mP4Builder != null) {
            ...
            if (v50Var.f28604c) {
                if (v50Var.f28600a.exists()) {
                    try {
                        v50Var.f28600a.delete();
                    } catch (Exception e12) {
                        FileLog.e("InstantCamera copying fileToWrite to videoFile, deleting videoFile error " + v50Var.f28600a);
                        FileLog.e(e12);
                    }
                }
                if (!v50Var.f28602b.renameTo(v50Var.f28600a)) {
                    FileLog.e("InstantCamera unable to rename file, try move file");
                    try {
                        AndroidUtilities.copyFile(v50Var.f28602b, v50Var.f28600a);
                        v50Var.f28602b.delete();
        ...
        if (i10 == 0) {
            FileLoader.getInstance(v50Var.H0.f29571a).cancelFileUpload(v50Var.f28600a.getAbsolutePath(), false);
            try {
                v50Var.f28602b.delete();
        ...
        EGL14.eglDestroySurface(v50Var.f28623s, v50Var.f28632y);
        v50Var.f28632y = EGL14.EGL_NO_SURFACE;
        Surface surface = v50Var.f28621r;
        if (surface != null) {
            surface.release();
            v50Var.f28621r = null;
        }
        EGLDisplay eGLDisplay = v50Var.f28623s;
        if (eGLDisplay != EGL14.EGL_NO_DISPLAY) {
            EGLSurface eGLSurface = EGL14.EGL_NO_SURFACE;
            EGL14.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, EGL14.EGL_NO_CONTEXT);
            EGL14.eglDestroyContext(v50Var.f28623s, v50Var.v);
            EGL14.eglReleaseThread();
            EGL14.eglTerminate(v50Var.f28623s);
        }
        v50Var.f28623s = EGL14.EGL_NO_DISPLAY;
                ...
                if (outputBuffer != null) {
                    ...
                    if (i10 > 1) {
                        ...
                        if ((i11 & 2) == 0) {
                            ...
                            if (writeSampleData != 0 && !this.f28604c && this.H0.Q0) {
                                c(this.f28600a, writeSampleData, false);
                            }
                        } else if (this.M == -5) {
                ...
                if (dequeueOutputBuffer2 == -2) {
                    ...
                    if (outputBuffer2 != null) {
                        ...
                        if (bufferInfo3.size != 0) {
                            ...
                            if (writeSampleData2 != 0 && !this.f28604c && this.H0.Q0) {
                                c(this.f28600a, writeSampleData2, false);
                            }
    ...
    public final void finalize() {
        b50 b50Var = this.f28631x0;
        if (b50Var != null) {
            b50Var.b();
            this.f28631x0 = null;
        }
        try {
            EGLDisplay eGLDisplay = this.f28623s;
            if (eGLDisplay != EGL14.EGL_NO_DISPLAY) {
                EGLSurface eGLSurface = EGL14.EGL_NO_SURFACE;
                EGL14.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, EGL14.EGL_NO_CONTEXT);
                EGL14.eglDestroyContext(this.f28623s, this.v);
                EGL14.eglReleaseThread();
                EGL14.eglTerminate(this.f28623s);
                this.f28623s = EGL14.EGL_NO_DISPLAY;
    ...
    public final void h(File file) {
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(linearLayout, property, 0.0f), ObjectAnimator.ofInt(w50Var.d, q6.f27257b, 0), ObjectAnimator.ofFloat(w50Var.f29601w, property, 1.0f));
        animatorSet.setDuration(180L);
        animatorSet.setInterpolator(new DecelerateInterpolator());
        animatorSet.start();
        EGL14.eglDestroySurface(this.f28623s, this.f28632y);
        this.f28632y = EGL14.EGL_NO_SURFACE;
        Surface surface = this.f28621r;
        if (surface != null) {
            surface.release();
            this.f28621r = null;
        }
    ...
    public final void run() {
        ...
        synchronized (this.U) {
            g.d dVar = new g.d(1);
            dVar.f9236b = new WeakReference(this);
            this.T = dVar;
            this.V = true;
            this.U.notify();
        }
