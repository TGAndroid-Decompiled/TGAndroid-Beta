...
public final class v50 implements Runnable {
    ...
    public File f28603b;
    public long f28604b0;
    public boolean f28605c;
    public int d;
    public long f28607d0;
    public int e;
    public long f28608e0;
    public int f28609f;
    public long f28610f0;
    public boolean f28616l0;
    public int m0;
    ...
    public int f28620p0;
    public int f28621q0;
    public Surface f28622r;
    public int f28623r0;
    public int f28625s0;
    public int f28626t0;
    public int f28627u0;
    public int f28628v0;
    public EGLContext f28629w;
    public EGLConfig f28631x;
    public b50 f28632x0;
    public AudioRecord f28634y0;
    public boolean h = true;
    public EGLDisplay f28624s = EGL14.EGL_NO_DISPLAY;
    public EGLContext v = EGL14.EGL_NO_CONTEXT;
    public EGLSurface f28633y = EGL14.EGL_NO_SURFACE;
    ...
    public long f28606c0 = -1;
    public long f28611g0 = -1;
    public long f28612h0 = -1;
    public long f28613i0 = -1;
    public long f28614j0 = 0;
    public long f28615k0 = -1;
    public Integer f28630w0 = 0;
    public final ArrayBlockingQueue f28635z0 = new ArrayBlockingQueue(10);
    ...
    public static void a(v50 v50Var, boolean z10) {
        ...
        try {
            ...
            v50Var.f28635z0.clear();
            for (int i12 = 0; i12 < 3; i12++) {
                v50Var.f28635z0.add(new k50());
            }
            if (z10) {
                v50Var.f28611g0 = v50Var.f28607d0 + v50Var.f28608e0;
                v50Var.f28615k0 = v50Var.f28613i0 + v50Var.f28614j0;
                v50Var.Q = true;
                j3 = 0;
            } else {
                v50Var.f28611g0 = -1L;
            ...
            v50Var.f28610f0 = -1L;
            v50Var.f28613i0 = -1L;
            v50Var.f28602a0 = false;
            v50Var.Z = 0L;
            AudioRecord audioRecord = new AudioRecord(0, 48000, 16, 2, i10);
            v50Var.f28634y0 = audioRecord;
            audioRecord.startRecording();
            if (BuildVars.LOGS_ENABLED) {
                FileLog.d("InstantCamera initied audio record with channels " + v50Var.f28634y0.getChannelCount() + " sample rate = " + v50Var.f28634y0.getSampleRate() + " bufferSize = " + i10);
            }
            v50Var.D0 = false;
            ...
            mediaFormat.setInteger("bitrate", MessagesController.getInstance(v50Var.H0.f29532a).roundAudioBitrate * 1024);
            ...
            createVideoFormat.setInteger("bitrate", v50Var.f28609f);
            createVideoFormat.setInteger("frame-rate", 30);
            createVideoFormat.setInteger("i-frame-interval", 1);
            v50Var.E.configure(createVideoFormat, (Surface) null, (MediaCrypto) null, 1);
            v50Var.f28622r = v50Var.E.createInputSurface();
            v50Var.E.start();
            if (!z10) {
                boolean isSdCardPath = ImageLoader.isSdCardPath(v50Var.f28601a);
                v50Var.f28603b = v50Var.f28601a;
                if (isSdCardPath) {
                    File file = new File(ApplicationLoader.getFilesDirFixed(), "camera_tmp.mp4");
                    v50Var.f28603b = file;
                    if (file.exists()) {
                        v50Var.f28603b.delete();
                    }
                    v50Var.f28605c = true;
                }
                Mp4Movie mp4Movie = new Mp4Movie();
                mp4Movie.setCacheFile(v50Var.f28603b);
            ...
            if (v50Var.f28624s == EGL14.EGL_NO_DISPLAY) {
                EGLDisplay eglGetDisplay = EGL14.eglGetDisplay(0);
                v50Var.f28624s = eglGetDisplay;
                if (eglGetDisplay != EGL14.EGL_NO_DISPLAY) {
                    int[] iArr = new int[2];
                    if (EGL14.eglInitialize(eglGetDisplay, iArr, 0, iArr, 1)) {
                        if (v50Var.v == EGL14.EGL_NO_CONTEXT) {
                            EGLConfig[] eGLConfigArr = new EGLConfig[1];
                            if (EGL14.eglChooseConfig(v50Var.f28624s, new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12352, 4, 12610, 1, 12344}, 0, eGLConfigArr, 0, 1, new int[1], 0)) {
                                i11 = 0;
                                v50Var.v = EGL14.eglCreateContext(v50Var.f28624s, eGLConfigArr[0], v50Var.f28629w, new int[]{12440, 2, 12344}, 0);
                                v50Var.f28631x = eGLConfigArr[0];
                            } else {
                        ...
                        EGL14.eglQueryContext(v50Var.f28624s, v50Var.v, 12440, new int[1], i11);
                        if (v50Var.f28633y == EGL14.EGL_NO_SURFACE) {
                            EGLSurface eglCreateWindowSurface = EGL14.eglCreateWindowSurface(v50Var.f28624s, v50Var.f28631x, v50Var.f28622r, new int[]{12344}, i11);
                            v50Var.f28633y = eglCreateWindowSurface;
                            if (eglCreateWindowSurface != null) {
                                if (!EGL14.eglMakeCurrent(v50Var.f28624s, eglCreateWindowSurface, eglCreateWindowSurface, v50Var.v)) {
                                    if (BuildVars.LOGS_ENABLED) {
                                ...
                                b50 b50Var = v50Var.f28632x0;
                                if (b50Var != null) {
                                    b50Var.b();
                                    v50Var.f28632x0 = null;
                                }
                                v50Var.f28632x0 = new b50(v50Var.d, v50Var.e);
                                w50 w50Var2 = v50Var.H0;
                                Size size = w50Var2.f29546i0[0];
                                if (!SharedConfig.deviceIsLow() && w50.b() && (size == null || Math.max(size.getHeight(), size.getWidth()) * 0.7f >= MessagesController.getInstance(w50Var2.f29532a).roundVideoSize)) {
                                ...
                                if (a2 != 0 && a10 != 0) {
                                    ...
                                    v50Var.f28620p0 = GLES20.glGetAttribLocation(v50Var.m0, "aPosition");
                                    v50Var.f28621q0 = GLES20.glGetAttribLocation(v50Var.m0, "aTextureCoord");
                                    v50Var.f28625s0 = GLES20.glGetUniformLocation(v50Var.m0, "preview");
                                    v50Var.f28623r0 = GLES20.glGetUniformLocation(v50Var.m0, "resolution");
                                    v50Var.f28627u0 = GLES20.glGetUniformLocation(v50Var.m0, "alpha");
                                    v50Var.f28618n0 = GLES20.glGetUniformLocation(v50Var.m0, "uMVPMatrix");
                                    v50Var.f28619o0 = GLES20.glGetUniformLocation(v50Var.m0, "uSTMatrix");
                                    v50Var.f28626t0 = GLES20.glGetUniformLocation(v50Var.m0, "texelSize");
                                    return;
                                }
                                return;
                            }
    ...
    public static void b(v50 v50Var, int i10, q50 q50Var) {
        ...
        if (i10 == 1 && (((videoEditedInfo = v50Var.H0.N) == null || !videoEditedInfo.needConvert()) && !v50Var.H0.f29538c.c())) {
            if (!v50Var.G0) {
                v50Var.G0 = true;
        ...
        File file = v50Var.H0.f29536b0;
        if (file != null) {
            file.delete();
            v50Var.H0.f29536b0 = null;
        }
        ...
        if (mP4Builder != null) {
            ...
            if (v50Var.f28605c) {
                if (v50Var.f28601a.exists()) {
                    try {
                        v50Var.f28601a.delete();
                    } catch (Exception e12) {
                        FileLog.e("InstantCamera copying fileToWrite to videoFile, deleting videoFile error " + v50Var.f28601a);
                        FileLog.e(e12);
                    }
                }
                if (!v50Var.f28603b.renameTo(v50Var.f28601a)) {
                    FileLog.e("InstantCamera unable to rename file, try move file");
                    try {
                        AndroidUtilities.copyFile(v50Var.f28603b, v50Var.f28601a);
                        v50Var.f28603b.delete();
        ...
        if (i10 == 0) {
            FileLoader.getInstance(v50Var.H0.f29532a).cancelFileUpload(v50Var.f28601a.getAbsolutePath(), false);
            try {
                v50Var.f28603b.delete();
        ...
        EGL14.eglDestroySurface(v50Var.f28624s, v50Var.f28633y);
        v50Var.f28633y = EGL14.EGL_NO_SURFACE;
        Surface surface = v50Var.f28622r;
        if (surface != null) {
            surface.release();
            v50Var.f28622r = null;
        }
        EGLDisplay eGLDisplay = v50Var.f28624s;
        if (eGLDisplay != EGL14.EGL_NO_DISPLAY) {
            EGLSurface eGLSurface = EGL14.EGL_NO_SURFACE;
            EGL14.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, EGL14.EGL_NO_CONTEXT);
            EGL14.eglDestroyContext(v50Var.f28624s, v50Var.v);
            EGL14.eglReleaseThread();
            EGL14.eglTerminate(v50Var.f28624s);
        }
        v50Var.f28624s = EGL14.EGL_NO_DISPLAY;
                ...
                if (outputBuffer != null) {
                    ...
                    if (i10 > 1) {
                        ...
                        if ((i11 & 2) == 0) {
                            ...
                            if (writeSampleData != 0 && !this.f28605c && this.H0.Q0) {
                                c(this.f28601a, writeSampleData, false);
                            }
                        } else if (this.M == -5) {
                ...
                if (dequeueOutputBuffer2 == -2) {
                    ...
                    if (outputBuffer2 != null) {
                        ...
                        if (bufferInfo3.size != 0) {
                            ...
                            if (writeSampleData2 != 0 && !this.f28605c && this.H0.Q0) {
                                c(this.f28601a, writeSampleData2, false);
                            }
    ...
    public final void finalize() {
        b50 b50Var = this.f28632x0;
        if (b50Var != null) {
            b50Var.b();
            this.f28632x0 = null;
        }
        try {
            EGLDisplay eGLDisplay = this.f28624s;
            if (eGLDisplay != EGL14.EGL_NO_DISPLAY) {
                EGLSurface eGLSurface = EGL14.EGL_NO_SURFACE;
                EGL14.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, EGL14.EGL_NO_CONTEXT);
                EGL14.eglDestroyContext(this.f28624s, this.v);
                EGL14.eglReleaseThread();
                EGL14.eglTerminate(this.f28624s);
                this.f28624s = EGL14.EGL_NO_DISPLAY;
    ...
    public final void h(File file) {
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(linearLayout, property, 0.0f), ObjectAnimator.ofInt(w50Var.d, q6.f27225b, 0), ObjectAnimator.ofFloat(w50Var.f29562w, property, 1.0f));
        animatorSet.setDuration(180L);
        animatorSet.setInterpolator(new DecelerateInterpolator());
        animatorSet.start();
        EGL14.eglDestroySurface(this.f28624s, this.f28633y);
        this.f28633y = EGL14.EGL_NO_SURFACE;
        Surface surface = this.f28622r;
        if (surface != null) {
            surface.release();
            this.f28622r = null;
        }
