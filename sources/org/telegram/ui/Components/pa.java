...
public abstract class pa extends View {
    public final org.telegram.ui.ActionBar.e6 f26977a;
    public final oa[] f26978b;
    public final Paint f26979c;
    public float d;
    public int e;
    public boolean f26980f;
    public final c6 h;
    public Utilities.Callback f26981n;
    public boolean f26982r;

    public pa(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
        this.f26979c = new Paint(1);
        this.h = new c6(this, 0L, 210L, qr.h);
        this.f26977a = e6Var;
        aa0 aa0Var = (aa0) this;
        this.f26978b = new oa[]{new oa(aa0Var, 0, R.raw.msg_stories_saved, 20, 40, LocaleController.getString(R.string.ProfileMyStoriesTab)), new oa(aa0Var, 1, R.raw.msg_stories_archive, 0, 0, LocaleController.getString(R.string.ProfileStoriesArchiveTab))};
    ...
    public final void a(float f7, boolean z10) {
        ...
        for (int i10 = 0; i10 < oaVarArr.length; i10++) {
            ...
            int i11 = oaVar.f26735k;
            int i12 = oaVar.f26734j;
            xi0 xi0Var = oaVar.f26729b;
            if (oaVar.f26736l != z11) {
                if (oaVar.f26738n.f26978b[oaVar.f26728a].f26734j != 0) {
                    if (z11) {
                        xi0Var.P(i12);
                        if (xi0Var.f29943a0 >= i11 - 2) {
                            xi0Var.N(0, false, false);
                        }
                        if (xi0Var.f29943a0 <= i12) {
                            xi0Var.start();
                        } else {
                            xi0Var.M(i12);
                        }
                    } else if (xi0Var.f29943a0 >= i12 - 1) {
                        xi0Var.P(i11 - 1);
                        xi0Var.start();
                    } else {
                        xi0Var.P(0);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        org.telegram.ui.ActionBar.e6 e6Var2 = paVar.f26977a;
        canvas.drawColor(org.telegram.ui.ActionBar.i6.v0(i10, e6Var2));
        canvas.drawRect(0.0f, 0.0f, paVar.getWidth(), AndroidUtilities.getShadowHeight(), org.telegram.ui.ActionBar.i6.f18955k0);
        int width = (paVar.getWidth() - paVar.getPaddingLeft()) - paVar.getPaddingRight();
        oa[] oaVarArr = paVar.f26978b;
        int length = width / oaVarArr.length;
        int min = Math.min(AndroidUtilities.dp(64.0f), length);
        float e = paVar.h.e(paVar.f26980f);
        Paint paint = paVar.f26979c;
        float f14 = 0.0f;
        if (e > 0.0f) {
            f7 = 9.0f;
            f10 = 16.0f;
        ...
        while (i11 < oaVarArr.length) {
            ...
            org.telegram.ui.Cells.z zVar = oaVar.f26730c;
            xi0 xi0Var = oaVar.f26729b;
            int i12 = length;
            ...
            xi0Var.draw(canvas);
            canvas.save();
            canvas.translate((rectF2.centerX() - (oaVar.f26731f / 2.0f)) - oaVar.f26732g, AndroidUtilities.dp(50.0f) - (staticLayout.getHeight() / 2.0f));
        ...
        if (action != 1 && motionEvent.getAction() != 2) {
            if (motionEvent.getAction() == 3) {
                for (oa oaVar : oaVarArr) {
                    oaVar.f26730c.setState(new int[0]);
                }
                this.f26982r = false;
                return true;
            }
                ...
                if (i10 < oaVarArr.length) {
                    ...
                    if (rectF.left < x10 && rectF.right > x10) {
                        if (motionEvent.getAction() != 1) {
                            if (this.f26982r) {
                                oaVarArr[i10].f26730c.setState(new int[0]);
                            }
                            oaVarArr[i10].f26730c.setState(new int[]{16842919, 16842910});
                        }
                    } else {
                        i10++;
                    }
            ...
            for (int i11 = 0; i11 < oaVarArr.length; i11++) {
                if (i11 != i10 || motionEvent.getAction() == 1) {
                    oaVarArr[i11].f26730c.setState(new int[0]);
                }
            }
            if (i10 >= 0 && this.e != i10 && (callback = this.f26981n) != null) {
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        ...
        while (true) {
            oa[] oaVarArr = this.f26978b;
            if (i10 < oaVarArr.length) {
                if (oaVarArr[i10].f26730c == drawable) {
                    return true;
                }
                i10++;
            } else {
