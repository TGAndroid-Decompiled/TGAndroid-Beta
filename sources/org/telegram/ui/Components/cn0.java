...
public final class cn0 implements ll0 {
    ...
    public final void d(int i10, View view) {
        ...
        switch (this.f23364a) {
            case 0:
                jn0 jn0Var = (jn0) this.f23366c;
                org.telegram.ui.ActionBar.m2 m2Var = jn0Var.G;
                ...
                if (E != null) {
                    ...
                    if (view instanceof fn0) {
                        org.telegram.ui.Cells.k7 k7Var = ((fn0) view).f24299a;
                        ...
                        if (k7Var.G) {
                            if (!message.isRoundVideo() && !message.isVoice()) {
                                ...
                                AndroidUtilities.openDocument(message, jn0Var.F, m2Var);
                            } else {
                            ...
                            k7Var.f(true);
                            DownloadController.getInstance(this.f23365b).updateFilesLoadingPriority();
                        } else {
                ...
                return;
            case 1:
                org.telegram.ui.np0 np0Var2 = (org.telegram.ui.np0) this.f23366c;
                org.telegram.ui.tp0 tp0Var = np0Var2.f35954p0;
                ArrayList arrayList2 = np0Var2.f35950l0;
                if (view instanceof org.telegram.ui.mp0) {
                    org.telegram.ui.mp0 mp0Var = (org.telegram.ui.mp0) view;
                    int i15 = np0Var2.m0;
                    if (np0Var2.f35953o0 == null) {
                        o5 o5Var = mp0Var.f35641c;
                        ...
                        jp0Var.f32025g1 = true;
                        long j10 = np0Var2.f35951n;
                        if (j10 == 0) {
                            valueOf = null;
                        } else {
                ...
                int i17 = np0Var2.V;
                int i18 = this.f23365b;
                if (i10 == i17) {
                    np0Var2.h = -1;
                    np0Var2.f35951n = 0L;
                    np0Var2.f35955r = null;
                    np0Var2.f35956s = null;
                    np0Var2.I = null;
                    np0Var2.i();
                    if (i18 == 0) {
                        tp0Var.h.i();
                    }
                    org.telegram.ui.mp0 mp0Var2 = np0Var2.f35959y;
                    if (mp0Var2 != null) {
                        mp0Var2.b(true);
                    }
                    np0Var2.j(true);
                    np0Var2.f(true);
                    org.telegram.ui.np0 np0Var3 = tp0Var.f38178n;
                    if (np0Var3 != null && (rp0Var = np0Var3.f35935a) != null && (np0Var = tp0Var.h) != null) {
                        rp0Var.a(np0Var.h);
                        return;
                    }
                    return;
                }
                int i19 = np0Var2.f35938b0;
                if (i10 >= i19 && i10 < np0Var2.f35940c0) {
                    int i20 = i10 - i19;
                    if (np0Var2.K == null) {
                        if (i20 >= 0 && i20 < arrayList2.size()) {
                            ...
                            if (i18 == 1) {
                                ...
                                if (peerColor instanceof TLRPC.TL_peerColorCollectible) {
                                    ...
                                    np0Var2.I = null;
                                    np0Var2.f35955r = null;
                                    np0Var2.f35956s = (TLRPC.TL_peerColorCollectible) peerColor;
                                } else {
                                    return;
                                }
                            } else {
                                ...
                                np0Var2.h = -1;
                                np0Var2.I = null;
                                np0Var2.f35955r = MessagesController.emojiStatusCollectibleFromGift(tL_starGiftUnique);
                                np0Var2.f35956s = null;
                            }
                            np0Var2.j(true);
                            np0Var2.i();
                            np0Var2.f(true);
                            org.telegram.ui.mp0 mp0Var3 = np0Var2.f35959y;
                            if (mp0Var3 != null) {
                                mp0Var3.b(true);
                                return;
                            }
                        ...
                        if (i18 == 1) {
                            ...
                            if (peerColor2 instanceof TLRPC.TL_peerColorCollectible) {
                                ...
                                np0Var2.h = -1;
                                np0Var2.f35955r = null;
                                np0Var2.f35956s = (TLRPC.TL_peerColorCollectible) peerColor2;
                            } else {
                                return;
                            }
                        } else {
                            np0Var2.f35951n = 0L;
                            np0Var2.h = -1;
                            np0Var2.f35955r = MessagesController.emojiStatusCollectibleFromGift(tL_starGiftUnique2);
                            np0Var2.f35956s = null;
                        }
                        ...
                        np0Var2.i();
                        np0Var2.f(true);
                        org.telegram.ui.mp0 mp0Var4 = np0Var2.f35959y;
                        if (mp0Var4 != null) {
                            mp0Var4.b(true);
                            return;
                        }
                ...
                return;
            default:
                org.telegram.ui.a71 a71Var = (org.telegram.ui.a71) this.f23366c;
                boolean z12 = view instanceof org.telegram.ui.j61;
                int i21 = this.f23365b;
                try {
                    if (z12) {
                        org.telegram.ui.j61 j61Var = (org.telegram.ui.j61) view;
                        if (!j61Var.f34667s && (((o0Var = j61Var.f34669x) == null || !o0Var.f49392a) && i21 != 13 && i21 != 14)) {
                            ...
                            a71Var.l();
                            a71Var.r(j61Var, j61Var.f34669x);
                        }
                        if (i21 != 1 && i21 != 11) {
