...
public final class p21 {
    ...
    public final org.telegram.ui.ActionBar.d6 f27194c;
    public final boolean d;
    public u01 e;
    public final ImageReceiver f27196g;
    public q5 h;
    public int f27198j;
    public int f27199k;
    public boolean f27200l;
    public boolean f27201m;
    public final Paint f27202n;
    public final Path f27203o;
    public final RectF f27204p;
    public final yc f27205q;
    public Runnable f27206r;
    public long f27207s;
    public final h9 f27195f = new h9((org.telegram.ui.ActionBar.d6) null);
    public final Path f27197i = new Path();

    public p21(int i10, View view, org.telegram.ui.ActionBar.d6 d6Var, boolean z10) {
        Paint paint = new Paint(1);
        this.f27202n = paint;
        Path path = new Path();
        this.f27203o = path;
        this.f27204p = new RectF();
        this.f27192a = i10;
        this.f27193b = view;
        this.f27194c = d6Var;
        this.d = z10;
        this.f27205q = new yc(view);
        this.f27196g = new ImageReceiver(view);
        path.rewind();
    ...
    public final void a() {
        this.f27196g.onAttachedToWindow();
        q5 q5Var = this.h;
        if (q5Var != null) {
            q5Var.a(this.f27193b);
        }
    }

    public final void b() {
        this.f27196g.onDetachedFromWindow();
        q5 q5Var = this.h;
        if (q5Var != null) {
            q5Var.o(this.f27193b);
        }
    }
    ...
    public final void c(Canvas canvas, int i10, float f7, float f10, float f11, float f12, boolean z10) {
        ...
        u01 u01Var = this.e;
        if (u01Var != null) {
            u01Var.f28659p = i10 - AndroidUtilities.dp(144.66f);
            float l4 = this.e.l() + AndroidUtilities.dp(48.66f);
            float f15 = i10;
            float f16 = (f15 - l4) / 2.0f;
            int i11 = this.f27199k;
            int i12 = (int) l4;
            boolean z11 = this.d;
            Path path = this.f27197i;
            if (i11 == i12 && this.f27198j == i10 && this.f27201m == z10 && this.f27200l == z11) {
                f14 = l4;
                f13 = 2.0f;
            } else {
                path.rewind();
            ...
            org.telegram.ui.ActionBar.d6 d6Var = this.f27194c;
            ...
            float f20 = f19 + f16;
            float f21 = f20 + f14;
            this.f27204p.set(f20 - AndroidUtilities.dp(4.0f), f10 - AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f) + f21, AndroidUtilities.dp(32.0f) + f10);
            if (z10) {
                q5 q5Var = this.h;
                if (q5Var != null) {
                    ...
                    ImageReceiver imageReceiver = this.f27196g;
                ...
                Paint paint = this.f27202n;
                paint.setColor(l1);
                paint.setStrokeWidth(AndroidUtilities.dp(1.66f));
                canvas.drawPath(this.f27203o, paint);
                canvas.restore();
            }
        }
    }
    ...
    public final boolean f(MessageObject messageObject) {
        ...
        if (messageObject == null) {
            ...
            if (isMonoForum) {
                ...
                this.f27207s = monoForumTopicId;
                if (userOrChat == null) {
                    this.e = null;
                    return false;
                }
                h9 h9Var = this.f27195f;
                h9Var.p(userOrChat);
                ...
                if (topicId == 1) {
                    imageReceiver.setImageBitmap(ng.d.c(view.getContext(), 0.75f, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19392v8, this.f27194c), false));
