    ...
    public final void run() {
        ...
        switch (this.f26978a) {
            case 0:
                ...
                return;
            default:
                q30 q30Var2 = this.f26979b;
                String str2 = this.f26980c;
                int i11 = this.d;
                ArrayList arrayList = null;
                q30Var2.e = null;
                if (!ChatObject.isChannel(q30Var2.f27497w.V) && q30Var2.f27497w.W != null) {
                    arrayList = new ArrayList(q30Var2.f27497w.W.participants.participants);
                }
                if (arrayList != null) {
                ...
                boolean canAddUsers = ChatObject.canAddUsers(q30Var2.f27497w.V);
                if (ChatObject.isChannel(q30Var2.f27497w.V)) {
                    j3 = q30Var2.f27497w.V.f18343id;
                } else {
                    j3 = 0;
                }
