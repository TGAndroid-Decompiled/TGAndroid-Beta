...
public final class f20 extends ViewGroup {
    public AnimatorSet f24043a;
    public boolean f24044b;
    public final ArrayList f24045c;
    public n30 d;
    public final ArrayList e;
    public int f24046f;
    public int h;
    public int f24047n;
    public final g20 f24048r;
    ...
    public final void onMeasure(int i10, int i11) {
            ...
            if (childAt instanceof n30) {
                ...
                if (!this.f24044b) {
                    if (contains) {
                        ...
                        this.f24047n = Math.max(this.f24047n, dp2);
                    } else {
        ...
        boolean z10 = this.f24044b;
        g20 g20Var = this.f24048r;
        if (!z10) {
            int dp5 = AndroidUtilities.dp(42.0f) + dp3;
            g20Var.f24338n = dp2;
            if (this.f24043a != null) {
                this.h = AndroidUtilities.dp(42.0f) + dp2;
                this.f24043a.playTogether(arrayList);
                this.f24043a.addListener(new e20(this, 0));
                this.f24046f = NotificationCenter.getInstance(g20Var.f24334a).setAnimationInProgress(this.f24046f, null);
                this.f24043a.start();
                this.f24044b = true;
            } else {
                this.h = dp5;
