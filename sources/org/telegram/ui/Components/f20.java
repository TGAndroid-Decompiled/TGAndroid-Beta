...
public class f20 extends ScrollView {
    ...
    public final a0.i f23976b;
    public final ArrayList f23977c;
    public final e20 d;
    public int e;
    public c20 f23978f;
    public boolean h;
    ...
    public void a(m30 m30Var) {
        e20 e20Var = this.d;
        ArrayList arrayList = e20Var.f23715c;
        f20 f20Var = e20Var.f23718r;
        f20Var.f23977c.add(m30Var);
        if (!m30Var.d) {
            f20Var.f23976b.k(m30Var, m30Var.getUid());
        }
        ...
        e20Var.f23713a = animatorSet2;
        animatorSet2.addListener(new d20(e20Var, 1));
        e20Var.f23713a.setDuration(150L);
        e20Var.d = m30Var;
        arrayList.clear();
    ...
    public void b() {
        ...
        f20 f20Var = e20Var.f23718r;
        f20Var.h = true;
        ArrayList arrayList2 = f20Var.f23977c;
    ...
    public void c(m30 m30Var) {
        ...
        ArrayList arrayList2 = e20Var.f23715c;
        f20 f20Var = e20Var.f23718r;
        f20Var.h = true;
        if (!m30Var.d) {
            f20Var.f23976b.l(m30Var.getUid());
        }
        f20Var.f23977c.remove(m30Var);
    ...
    public final boolean requestChildRectangleOnScreen(View view, Rect rect, boolean z10) {
        ...
        rect.top = org.telegram.messenger.l0.C(20.0f, this.f23979n, rect.top);
        rect.bottom = org.telegram.messenger.l0.C(50.0f, this.f23979n, rect.bottom);
