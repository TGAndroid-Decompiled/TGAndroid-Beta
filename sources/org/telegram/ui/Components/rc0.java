...
public final class rc0 extends Drawable {
    ...
    public final void a(int i10) {
        if (i10 != this.f27840f) {
            ...
            this.d = alpha;
            this.f27838b.setColor(i0.a.k(i10, (int) ((alpha / 255.0f) * this.f27839c)));
        }
        this.f27840f = i10;
    }
    ...
    public final Drawable.ConstantState getConstantState() {
        if (this.f27837a == null) {
            this.f27837a = new Drawable.ConstantState();
        }
        return this.f27837a;
    }
    ...
    public final void setAlpha(int i10) {
        if (this.f27839c != i10) {
            this.f27839c = i10;
            this.f27838b.setAlpha((int) ((this.d / 255.0f) * i10));
        }
    }
