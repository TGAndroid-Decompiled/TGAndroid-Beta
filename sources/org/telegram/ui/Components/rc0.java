...
public final class rc0 {
    public final Shader.TileMode f27889a;
    public final Matrix f27890b = new Matrix();
    public boolean f27891c;
    public BitmapShader d;
    public WeakReference e;

    public rc0(Shader.TileMode tileMode) {
        this.f27889a = tileMode;
    }
    ...
    public final boolean b(Bitmap bitmap) {
        ...
        Shader.TileMode tileMode = this.f27889a;
        BitmapShader bitmapShader = new BitmapShader(bitmap, tileMode, tileMode);
        this.d = bitmapShader;
        bitmapShader.setLocalMatrix(this.f27890b);
