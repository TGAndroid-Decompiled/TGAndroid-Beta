...
public final class rc0 extends Canvas {
    public Canvas f30727a;

    @Override
    public final boolean clipOutPath(Path path) {
        if (Build.VERSION.SDK_INT >= 26) {
            return this.f30727a.clipOutPath(path);
        }
        return false;
    }
    ...
    public final boolean clipOutRect(float f10, float f11, float f12, float f13) {
        if (Build.VERSION.SDK_INT >= 26) {
            return this.f30727a.clipOutRect(f10, f11, f12, f13);
        }
        return false;
    }
    ...
    public final boolean clipPath(Path path) {
        return this.f30727a.clipPath(path);
    }
    ...
    public final void drawVertices(Canvas.VertexMode vertexMode, int i10, float[] fArr, int i11, float[] fArr2, int i12, int[] iArr, int i13, short[] sArr, int i14, int i15, Paint paint) {
        this.f30727a.drawVertices(vertexMode, i10, fArr, i11, fArr2, i12, iArr, i13, sArr, i14, i15, paint);
    }

    @Override
    public final void enableZ() {
        if (Build.VERSION.SDK_INT >= 29) {
            this.f30727a.enableZ();
        }
    }

    @Override
    public final boolean getClipBounds(Rect rect) {
        return this.f30727a.getClipBounds(rect);
    }

    @Override
    public final int getDensity() {
        return this.f30727a.getDensity();
    }

    @Override
    public final DrawFilter getDrawFilter() {
        return this.f30727a.getDrawFilter();
    }

    @Override
    public final int getHeight() {
        return this.f30727a.getHeight();
    }

    @Override
    public final void getMatrix(Matrix matrix) {
        this.f30727a.getMatrix(matrix);
    }

    @Override
    public final int getMaximumBitmapHeight() {
        return this.f30727a.getMaximumBitmapHeight();
    }

    @Override
    public final int getMaximumBitmapWidth() {
        return this.f30727a.getMaximumBitmapWidth();
    }

    @Override
    public final int getSaveCount() {
        return this.f30727a.getSaveCount();
    }

    @Override
    public final int getWidth() {
        return this.f30727a.getWidth();
    }

    @Override
    public final boolean isOpaque() {
        return this.f30727a.isOpaque();
    }

    @Override
    public final boolean quickReject(float f10, float f11, float f12, float f13) {
        if (Build.VERSION.SDK_INT >= 30) {
            return this.f30727a.quickReject(f10, f11, f12, f13);
        }
        return false;
    }
    ...
    public final void restore() {
        this.f30727a.restore();
    }

    @Override
    public final void restoreToCount(int i10) {
        this.f30727a.restoreToCount(i10);
    }

    @Override
    public final void rotate(float f10) {
        this.f30727a.rotate(f10);
    }

    @Override
    public final int save() {
        return this.f30727a.save();
    }

    @Override
    public final int saveLayer(float f10, float f11, float f12, float f13, Paint paint) {
        return this.f30727a.saveLayer(f10, f11, f12, f13, paint);
    }

    @Override
    public final int saveLayerAlpha(RectF rectF, int i10, int i11) {
        return this.f30727a.saveLayerAlpha(rectF, i10, i11);
    }

    @Override
    public final void scale(float f10, float f11) {
        this.f30727a.scale(f10, f11);
    }

    @Override
    public final void setBitmap(Bitmap bitmap) {
        this.f30727a.setBitmap(bitmap);
    }

    @Override
    public final void setDensity(int i10) {
        this.f30727a.setDensity(i10);
    }

    @Override
    public final void setDrawFilter(DrawFilter drawFilter) {
        this.f30727a.setDrawFilter(drawFilter);
    }

    @Override
    public final void setMatrix(Matrix matrix) {
        this.f30727a.setMatrix(matrix);
    }

    @Override
    public final void skew(float f10, float f11) {
        this.f30727a.skew(f10, f11);
    }

    @Override
    public final void translate(float f10, float f11) {
        this.f30727a.translate(f10, f11);
    }

    @Override
    public final boolean clipPath(Path path, Region.Op op) {
        return this.f30727a.clipPath(path, op);
    }
    ...
    public final void drawTextRun(MeasuredText measuredText, int i10, int i11, int i12, int i13, float f10, float f11, boolean z4, Paint paint) {
        this.f30727a.drawTextRun(measuredText, i10, i11, i12, i13, f10, f11, z4, paint);
    }

    @Override
    public final int saveLayer(RectF rectF, Paint paint) {
        return this.f30727a.saveLayer(rectF, paint);
    }

    @Override
    public final int saveLayerAlpha(float f10, float f11, float f12, float f13, int i10) {
        return this.f30727a.saveLayerAlpha(f10, f11, f12, f13, i10);
    }

    @Override
    public final boolean clipOutRect(int i10, int i11, int i12, int i13) {
        if (Build.VERSION.SDK_INT >= 26) {
            return this.f30727a.clipOutRect(i10, i11, i12, i13);
        }
        return false;
    }
    ...
    public final void drawBitmap(int[] iArr, int i10, int i11, float f10, float f11, int i12, int i13, boolean z4, Paint paint) {
        this.f30727a.drawBitmap(iArr, i10, i11, f10, f11, i12, i13, z4, paint);
    }

    @Override
    public final void drawColor(int i10, BlendMode blendMode) {
        if (Build.VERSION.SDK_INT >= 29) {
            this.f30727a.drawColor(i10, blendMode);
        }
    }
    ...
    public final void drawDoubleRoundRect(RectF rectF, float f10, float f11, RectF rectF2, float f12, float f13, Paint paint) {
        if (Build.VERSION.SDK_INT >= 29) {
            this.f30727a.drawDoubleRoundRect(rectF, f10, f11, rectF2, f12, f13, paint);
        }
    }
    ...
    public final void drawTextRun(CharSequence charSequence, int i10, int i11, int i12, int i13, float f10, float f11, boolean z4, Paint paint) {
        this.f30727a.drawTextRun(charSequence, i10, i11, i12, i13, f10, f11, z4, paint);
    }

    @Override
    public final boolean quickReject(RectF rectF) {
        if (Build.VERSION.SDK_INT >= 30) {
            return this.f30727a.quickReject(rectF);
        }
        return false;
    }
    ...
    public final int saveLayer(float f10, float f11, float f12, float f13, Paint paint, int i10) {
        return this.f30727a.saveLayer(f10, f11, f12, f13, paint, i10);
    }

    @Override
    public final int saveLayerAlpha(RectF rectF, int i10) {
        return this.f30727a.saveLayerAlpha(rectF, i10);
    }
    ...
    public final void drawBitmap(int[] iArr, int i10, int i11, int i12, int i13, int i14, int i15, boolean z4, Paint paint) {
        this.f30727a.drawBitmap(iArr, i10, i11, i12, i13, i14, i15, z4, paint);
    }

    @Override
    public final void drawText(CharSequence charSequence, int i10, int i11, float f10, float f11, Paint paint) {
        this.f30727a.drawText(charSequence, i10, i11, f10, f11, paint);
    }

    @Override
    public final int saveLayer(RectF rectF, Paint paint, int i10) {
        return this.f30727a.saveLayer(rectF, paint, i10);
    }

    @Override
    public final int saveLayerAlpha(float f10, float f11, float f12, float f13, int i10, int i11) {
        return this.f30727a.saveLayerAlpha(f10, f11, f12, f13, i10, i11);
    }

    @Override
    public final boolean clipOutRect(RectF rectF) {
        if (Build.VERSION.SDK_INT >= 26) {
            return this.f30727a.clipOutRect(rectF);
        }
        return false;
    }
    ...
    public final void drawBitmap(Bitmap bitmap, Rect rect, RectF rectF, Paint paint) {
        this.f30727a.drawBitmap(bitmap, rect, rectF, paint);
    }

    @Override
    public final void drawColor(int i10) {
        this.f30727a.drawColor(i10);
    }

    @Override
    public final boolean quickReject(Path path) {
        if (Build.VERSION.SDK_INT >= 30) {
            return this.f30727a.quickReject(path);
        }
        return false;
    }
    ...
    public final void drawBitmap(Bitmap bitmap, float f10, float f11, Paint paint) {
        this.f30727a.drawBitmap(bitmap, f10, f11, paint);
    }

    @Override
    public final void drawColor(int i10, PorterDuff.Mode mode) {
        this.f30727a.drawColor(i10, mode);
    }

    @Override
    public final boolean clipOutRect(Rect rect) {
        if (Build.VERSION.SDK_INT >= 26) {
            return this.f30727a.clipOutRect(rect);
        }
        return false;
    }
    ...
    public final void drawColor(long j10) {
        if (Build.VERSION.SDK_INT >= 29) {
            this.f30727a.drawColor(j10);
        }
    }

    @Override
    public final boolean quickReject(RectF rectF, Canvas.EdgeType edgeType) {
        return this.f30727a.quickReject(rectF, edgeType);
    }

    @Override
    public final boolean quickReject(Path path, Canvas.EdgeType edgeType) {
        return this.f30727a.quickReject(path, edgeType);
    }

    @Override
    public final boolean quickReject(float f10, float f11, float f12, float f13, Canvas.EdgeType edgeType) {
        return this.f30727a.quickReject(f10, f11, f12, f13, edgeType);
    }
}
