...
public final class rc0 {
    public static final float[] f27933k = new float[4];
    public static final Matrix f27934l = new Matrix();
    public final pc0 d;
    public int e;
    public int f27938f;
    public int f27939g;
    public int h;
    public final aa.a f27935a = new aa.a(new fa0(1));
    public final a5.a f27936b = new a5.a(13, (byte) 0);
    public final j10 f27937c = new j10();
    public final Matrix f27940i = new Matrix();
    public final RectF f27941j = new RectF();
    ...
    public final void c(RectF rectF) {
        RectF rectF2 = this.f27941j;
        rectF2.set(0.0f, 0.0f, this.e, this.f27938f);
        Matrix.ScaleToFit scaleToFit = Matrix.ScaleToFit.FILL;
        Matrix matrix = this.f27940i;
        matrix.setRectToRect(rectF2, rectF, scaleToFit);
        j10 j10Var = this.f27937c;
        qc0 qc0Var = (qc0) j10Var.f25211c;
        qc0Var.f27584b.set(matrix);
        BitmapShader bitmapShader = qc0Var.d;
        if (bitmapShader != null) {
            bitmapShader.setLocalMatrix(matrix);
        }
        qc0 qc0Var2 = (qc0) j10Var.d;
        qc0Var2.f27584b.set(matrix);
        ...
        if (pc0Var != null && Build.VERSION.SDK_INT >= 33) {
            float[] fArr = pc0Var.f27306g;
            a(matrix, fArr);
            pc0Var.e.a(fArr);
            pc0Var.f27305f.a(fArr);
        }
    }
    ...
    public final Paint e(Bitmap bitmap, Bitmap bitmap2, int i10, int i11, int i12, boolean z10) {
        ...
        this.f27938f = bitmap.getHeight();
        this.f27939g = bitmap4.getWidth();
        ...
        j10 j10Var = this.f27937c;
        ht htVar = (ht) j10Var.f25212f;
        ht htVar2 = (ht) j10Var.f25213g;
        qc0 qc0Var = (qc0) j10Var.d;
        Paint paint = (Paint) j10Var.f25210b;
        qc0 qc0Var2 = (qc0) j10Var.f25211c;
        boolean b10 = qc0Var2.b(bitmap);
        qc0 qc0Var3 = (qc0) j10Var.e;
        boolean b11 = b10 | qc0Var3.b(bitmap4);
        if (i12 >= 0) {
            if ((qc0Var.b(bitmap6) | b11) || j10Var.f25209a != 1) {
                j10Var.f25209a = 1;
        ...
        } else if ((htVar2.a(i0.a.k(-1, ((-i12) * i11) / 100)) | b11 | htVar.a(-16777216)) || j10Var.f25209a != 2) {
            j10Var.f25209a = 2;
            paint.setShader(new ComposeShader((yf.i) htVar.f24840b, new ComposeShader(new ComposeShader(qc0Var2.d, qc0Var3.d, PorterDuff.Mode.DST_IN), (yf.i) htVar2.f24840b, PorterDuff.Mode.MULTIPLY), PorterDuff.Mode.SRC_OVER));
            return paint;
        }
        return paint;
    }
