...
public final class rc0 {
    ...
    public int f27948g;
    public int h;
    public final aa.a f27944a = new aa.a(new fa0(1));
    public final a5.a f27945b = new a5.a(13, (byte) 0);
    public final j10 f27946c = new j10();
    ...
    public final void c(RectF rectF) {
        ...
        j10 j10Var = this.f27946c;
        qc0 qc0Var = (qc0) j10Var.f25237c;
        qc0Var.f27591b.set(matrix);
        BitmapShader bitmapShader = qc0Var.d;
        if (bitmapShader != null) {
            bitmapShader.setLocalMatrix(matrix);
        }
        qc0 qc0Var2 = (qc0) j10Var.d;
        qc0Var2.f27591b.set(matrix);
        ...
        if (pc0Var != null && Build.VERSION.SDK_INT >= 33) {
            float[] fArr = pc0Var.f27321g;
            a(matrix, fArr);
            pc0Var.e.a(fArr);
            pc0Var.f27320f.a(fArr);
        }
    }
    ...
    public final Paint e(Bitmap bitmap, Bitmap bitmap2, int i10, int i11, int i12, boolean z10) {
        ...
        j10 j10Var = this.f27946c;
        ht htVar = (ht) j10Var.f25238f;
        ht htVar2 = (ht) j10Var.f25239g;
        qc0 qc0Var = (qc0) j10Var.d;
        Paint paint = (Paint) j10Var.f25236b;
        qc0 qc0Var2 = (qc0) j10Var.f25237c;
        boolean b10 = qc0Var2.b(bitmap);
        qc0 qc0Var3 = (qc0) j10Var.e;
        boolean b11 = b10 | qc0Var3.b(bitmap4);
        if (i12 >= 0) {
            if ((qc0Var.b(bitmap6) | b11) || j10Var.f25235a != 1) {
                j10Var.f25235a = 1;
        ...
        } else if ((htVar2.a(i0.a.k(-1, ((-i12) * i11) / 100)) | b11 | htVar.a(-16777216)) || j10Var.f25235a != 2) {
            j10Var.f25235a = 2;
            paint.setShader(new ComposeShader((yf.i) htVar.f24867b, new ComposeShader(new ComposeShader(qc0Var2.d, qc0Var3.d, PorterDuff.Mode.DST_IN), (yf.i) htVar2.f24867b, PorterDuff.Mode.MULTIPLY), PorterDuff.Mode.SRC_OVER));
            return paint;
        }
        return paint;
    }
