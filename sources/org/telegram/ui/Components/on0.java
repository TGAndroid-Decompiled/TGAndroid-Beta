...
public final class on0 extends EditTextBoldCursor {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int a2 = this.f27139b.a(org.telegram.ui.ActionBar.h6.v0(i10, this.e), false);
        o6 o6Var = this.d;
        o6Var.r(a2);
    ...
    public final void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
        ...
        o6 o6Var = this.d;
        if (o6Var != null) {
            this.f27140c = 12 - charSequence.length();
            o6Var.b();
            String str = "";
            if (this.f27140c <= 4) {
                str = "" + this.f27140c;
