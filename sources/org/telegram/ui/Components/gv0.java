...
public class gv0 extends dv0 {
    ...
    public final int f24534n;
    public final ArrayList f24535r;
    public ai.d9 f24536s;
    public final int v;
    public final ev0 f24537w;
    public boolean f24538x;
    public final ArrayList f24539y;
    ...
    public final String F(int i10) {
        ...
        if (d9Var == null || i10 < 0 || i10 >= d9Var.f725i.size() || (messageObject = (MessageObject) this.f24536s.f725i.get(i10)) == null || (storyItem = messageObject.storyItem) == null) {
            return null;
        }
    ...
    public final boolean M(int i10) {
        ai.d9 d9Var;
        if (!this.h && (d9Var = this.f24536s) != null) {
            if (d9Var instanceof ai.u8) {
                jv0 jv0Var = this.F;
                TLRPC.User user = MessagesController.getInstance(jv0Var.f25560v1.getCurrentAccount()).getUser(Long.valueOf(jv0Var.f25535j1));
                if (user != null && user.bot && user.bot_has_main_app && user.bot_can_edit) {
                    return true;
                }
                return false;
            } else if (i10 >= 0 && i10 < d9Var.f725i.size()) {
                MessageObject messageObject = (MessageObject) this.f24536s.f725i.get(i10);
                ai.d9 d9Var2 = this.f24536s;
                if (d9Var2.f723f > 0) {
                    return true;
                }
    ...
    public final void N() {
        ...
        if (d9Var != null && !this.h) {
            ...
            if ((!z10 || (jv0Var.f25537k1 && d9Var.g() > 1)) && this.f24536s.g() > 0 && !jv0Var.v0()) {
                boolean z11 = false;
                if (this.f24536s.g() < 5) {
                    iArr[1] = this.f24536s.g();
                    ...
                    jv0Var.f25537k1 = z11;
                } else if (jv0Var.f25537k1) {
                    jv0Var.f25537k1 = false;
    ...
    public final int O() {
        ...
        return jv0Var.f25548q1;
    }

    public final void P() {
        if (this.f24536s == null) {
            return;
        }
        int O = O();
        this.f24536s.p(Math.min(100, Math.max(1, O / 2) * O * O), false);
    }
    ...
    public final int h() {
        ...
        int size = this.f24535r.size();
        if (!this.f24536s.l() || !this.F.i0()) {
            i10 = this.f24536s.g();
        }
        return size + i10;
    }
    ...
    public void l() {
        if (this.f24536s != null) {
            jv0 jv0Var = this.F;
            if (jv0Var.r0()) {
                ArrayList arrayList = this.f24535r;
                arrayList.clear();
                ArrayList E = MessagesController.getInstance(this.f24536s.f722c).getStoriesController().E(jv0Var.f25535j1);
                if (E != null) {
                    arrayList.addAll(E);
                }
            }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        char c10;
        boolean z12;
        if (this.f24536s != null && c1Var.f42964f == 19) {
            ...
            if (view instanceof org.telegram.ui.Cells.t7) {
                ...
                if (i10 >= 0 && i10 < arrayList.size()) {
                    ...
                    if (k9Var.K == null) {
                        ...
                        tL_storyItem.f18571id = i11;
                        tL_storyItem.attachPath = k9Var.f1144f;
                        MessageObject messageObject = new MessageObject(this.f24536s.f722c, tL_storyItem);
                ...
                if (size >= 0 && size < this.f24536s.f725i.size()) {
                    MessageObject messageObject2 = (MessageObject) this.f24536s.f725i.get(size);
                    if (messageObject2 != null && this.f24536s.m(messageObject2.getId())) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
                    ...
                    if (jv0Var.C1 && messageObject2 != null) {
                        ...
                        if (messageObject2.getDialogId() == jv0Var.f25535j1) {
                            c10 = 0;
                        } else {
                            c10 = 1;
                        }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (view instanceof org.telegram.ui.Cells.t7) {
            ((org.telegram.ui.Cells.t7) view).f21217d0 = true;
        }
        return x10;
    }
    ...
    public gv0(jv0 jv0Var, Context context, int i10, boolean z10) {
        ...
        if (!TextUtils.isEmpty(jv0Var.getStoriesHashtag())) {
            ...
            if (i10 > 0) {
                this.f24536s = m2Var.getMessagesController().getStoriesController().A(jv0Var.f25535j1, 0, i10, true);
            } else {
                this.f24536s = m2Var.getMessagesController().getStoriesController().A(jv0Var.f25535j1, z11 ? 4 : z10 ? 1 : 0, -1, true);
            }
        }
        ai.d9 d9Var = this.f24536s;
        if (d9Var != null) {
            this.v = d9Var.o();
            this.f24537w = new ev0(this, m2Var.getMessagesController().getStoriesController(), jv0Var.f25535j1, this.f24536s.f722c);
        }
        N();
    }
