...
public final class gv0 extends View {
    public final ImageReceiver f24404a;
    public final f9 f24405b;
    public final Paint f24406c;
    public float d;
    public boolean e;
    public ValueAnimator f24407f;

    public gv0(Context context) {
        super(context);
        ImageReceiver imageReceiver = new ImageReceiver(this);
        this.f24404a = imageReceiver;
        this.f24405b = new f9((org.telegram.ui.ActionBar.f6) null);
    ...
    public final void a(boolean z10, boolean z11) {
        ValueAnimator valueAnimator = this.f24407f;
    ...
    public final void onAttachedToWindow() {
        ...
        this.f24404a.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f24404a.onDetachedFromWindow();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.scale(f7, f7);
        int w02 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19026m5, false);
        Paint paint = this.f24406c;
        paint.setColor(w02);
        ...
        if (!this.e) {
            ...
            ImageReceiver imageReceiver = this.f24404a;
    ...
    public void setAvatar(TLObject tLObject) {
        f9 f9Var = this.f24405b;
        f9Var.p(tLObject);
        this.f24404a.setForUserOrChat(tLObject, f9Var);
    }
