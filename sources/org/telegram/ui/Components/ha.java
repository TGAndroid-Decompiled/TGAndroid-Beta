...
public abstract class ha extends vl0 {
    ...
    public int Y2;
    public int Z2;
    public boolean f24585a3;
    public int f24586b3;
    public boolean f24587c3;

    @Override
    public void dispatchDraw(Canvas canvas) {
        if (this.X2 != 0 && !a1()) {
            canvas.clipRect(0, this.X2, getMeasuredWidth(), getMeasuredHeight() + this.f24586b3);
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        if (view.getY() + view.getMeasuredHeight() < this.X2 && !this.f24587c3 && !a1()) {
            return true;
        }
