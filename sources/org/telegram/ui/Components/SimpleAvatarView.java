...
public class SimpleAvatarView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.scale(f, f);
        this.selectPaint.setColor(Theme.getColor(null, Theme.key_dialogTextBlue, false));
    ...
    public void setSelected(boolean z, boolean z2) {
        ...
        duration.addUpdateListener(new ItemOptions$$ExternalSyntheticLambda6(this, 28));
