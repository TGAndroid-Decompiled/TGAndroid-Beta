...
public abstract class xw0 extends ml0 {
    public static final vw0 f30000x3 = new CacheFetcher();
    public static final ww0 y3 = new CacheFetcher();
    public float X2;
    public tw0[] Y2;
    public final ow0 Z2;
    public final c6 f30001a3;
    public Drawable f30002b3;
    public Drawable f30003c3;
    public Paint f30004d3;
    public final Paint f30005e3;
    public int f30006f3;
    public int f30007g3;
    public Utilities.Callback f30008h3;
    public Utilities.Callback f30009i3;
    public boolean j3;
    public boolean f30010k3;
    public ci.eb f30011l3;
    public int f30012m3;
    public Utilities.Callback f30013n3;
    public float f30014o3;
    public ValueAnimator f30015p3;
    public boolean f30016q3;
    public final c6 f30017r3;
    public final c6 f30018s3;
    public final RectF f30019t3;
    public final RectF f30020u3;
    public final RectF f30021v3;
    public boolean f30022w3;
    ...
    public xw0(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.Y2 = null;
        qr qrVar = qr.h;
        this.f30001a3 = new c6(this, 360L, qrVar);
        Paint paint = new Paint(1);
        this.f30005e3 = paint;
        this.f30012m3 = -1;
        this.f30014o3 = 0.0f;
        this.f30016q3 = true;
        this.f30017r3 = new c6(this, 350L, qrVar);
        this.f30018s3 = new c6(this, 350L, qrVar);
        this.f30019t3 = new RectF();
        this.f30020u3 = new RectF();
        this.f30021v3 = new RectF();
        ...
        setSelectorDrawableColor(org.telegram.ui.ActionBar.j6.v0(i11, this.f26191p2));
        paint.setColor(org.telegram.ui.ActionBar.j6.v0(i11, this.f26191p2));
        setWillNotDraw(false);
        setOnItemClickListener(new j(this, 15));
        long currentTimeMillis = System.currentTimeMillis();
        f30000x3.fetch(UserConfig.selectedAccount, Integer.valueOf(i10), new ci.s9(this, currentTimeMillis, 2));
    }
    ...
    public static void A1(RectF rectF, View view) {
        ...
        if (view instanceof sw0) {
            sw0 sw0Var = (sw0) view;
            f7 = com.google.android.gms.internal.vision.e2.z(1.0f, sw0Var.E, 0.15f, 0.85f) * sw0Var.f27941y;
        }
        float f10 = width * f7;
    ...
    private int getScrollToStartWidth() {
        ...
        if (childAt instanceof sw0) {
            return Math.max(0, getHeight() * (RecyclerView.S(childAt) - 1)) + this.f30006f3 + (-childAt.getLeft());
        }
    ...
    public static void y1(xw0 xw0Var, TLRPC.TL_messages_emojiGroups tL_messages_emojiGroups, long j3) {
        ...
        for (int i10 = 0; i10 < tL_messages_emojiGroups.groups.size(); i10++) {
            ...
            ?? obj = new Object();
            obj.f28214c = emojiGroup.icon_emoji_id;
            if (emojiGroup instanceof TLRPC.TL_emojiGroupPremium) {
                obj.f28212a = "premium";
            } else {
                obj.f28212a = TextUtils.concat((CharSequence[]) emojiGroup.emoticons.toArray(new String[0])).toString();
            }
            obj.f28213b = emojiGroup instanceof TLRPC.TL_emojiGroupGreeting;
    ...
    public final void D1() {
        int dp = (AndroidUtilities.dp(34.0f) * this.f30012m3) + ((-getScrollToStartWidth()) - Math.max(0, this.f30007g3));
        scrollBy(dp, 0);
    ...
    public void F1(int i10) {
        boolean z10;
        if (this.f30012m3 < 0 && i10 >= 0) {
            this.f30018s3.d(i10, true);
        }
        this.f30012m3 = i10;
    ...
    public final void H1(boolean z10, boolean z11) {
        ...
        if (this.f30014o3 == ((float) r52)) {
            return;
        }
        ValueAnimator valueAnimator = this.f30015p3;
        ...
        float f7 = 0.0f;
        if (z11) {
            float f10 = this.f30014o3;
            if (r52 != 0) {
                f7 = 1.0f;
            }
            ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, f7);
            this.f30015p3 = ofFloat;
            ofFloat.addUpdateListener(new h70(this, 23));
            this.f30015p3.addListener(new jd0(this, 16));
            this.f30015p3.setInterpolator(qr.h);
            ValueAnimator valueAnimator2 = this.f30015p3;
            tw0[] tw0VarArr = this.Y2;
            if (tw0VarArr == null) {
                length = 5;
            } else {
    ...
    public int getCategoryIndex() {
        return this.f30012m3;
    }

    public tw0 getSelectedCategory() {
        int i10;
        tw0[] tw0VarArr = this.Y2;
        if (tw0VarArr != null && (i10 = this.f30012m3) >= 0 && i10 < tw0VarArr.length) {
    ...
    public final void l0(int i10, int i11) {
        ...
        if (getChildCount() > 0) {
            ...
            if (childAt instanceof sw0) {
                ...
                if (childAt.getRight() > this.f30007g3) {
                    z11 = false;
                }
                z10 = false;
            }
        ...
        if (z12 != z11) {
            this.j3 = z11;
            Utilities.Callback callback2 = this.f30008h3;
            if (callback2 != null) {
                if (z11) {
                    i12 = Math.max(0, getScrollToStartWidth() - (this.f30006f3 - this.f30007g3));
                }
                callback2.run(Integer.valueOf(i12));
            }
            invalidate();
        } else if (z12 && (callback = this.f30008h3) != null) {
            callback.run(Integer.valueOf(Math.max(0, getScrollToStartWidth() - (this.f30006f3 - this.f30007g3))));
        }
        if (this.f30010k3 != z10) {
            this.f30010k3 = z10;
            Utilities.Callback callback3 = this.f30009i3;
            if (callback3 != null) {
    ...
    public final void onAttachedToWindow() {
        ...
        H1(this.f30016q3, false);
    }

    @Override
    public final void onConfigurationChanged(Configuration configuration) {
        super.onConfigurationChanged(configuration);
        ci.eb ebVar = this.f30011l3;
        if (ebVar != null) {
            ebVar.requestLayout();
        }
    }
    ...
    public void setBackgroundColor(int i10) {
        if (this.f30004d3 == null) {
            this.f30004d3 = new Paint(1);
        }
        this.f30004d3.setColor(i10);
        Drawable mutate = getContext().getResources().getDrawable(R.drawable.gradient_right).mutate();
        this.f30002b3 = mutate;
