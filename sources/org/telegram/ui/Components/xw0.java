...
public class xw0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public float I;
    public boolean J;
    public final ub1 f30077a;
    public final w9 f30078b;
    public final RadialProgressView f30079c;
    public final vh.o d;
    public final d90 e;
    public final ci.d f30080f;
    public boolean h;
    public final org.telegram.ui.ActionBar.d6 f30081n;
    public int f30082r;
    public final View f30083s;
    public int v;
    public final int f30084w;
    public boolean f30085x;
    public final org.telegram.ui.Cells.l7 f30086y;
    ...
    public final void b(int i10, boolean z10) {
        if (this.v != i10) {
            ...
            float f7 = i12 + i11;
            RadialProgressView radialProgressView = this.f30079c;
            ub1 ub1Var = this.f30077a;
            if (z10) {
                ViewPropertyAnimator translationY = ub1Var.animate().translationY(f7);
                rr rrVar = rr.f27701f;
                translationY.setInterpolator(rrVar).setDuration(250L);
                if (radialProgressView != null) {
                    radialProgressView.animate().translationY(f7).setInterpolator(rrVar).setDuration(250L);
                    return;
                }
                return;
            }
    ...
    public final void c() {
        ...
        int i10;
        int i11 = this.f30082r;
        w9 w9Var = this.f30078b;
        if (i11 != 0) {
            boolean z10 = true;
            if (i11 != 1) {
                ...
                if (i11 == 16) {
                    ...
                    if (stickerSetByName != null && (i10 = this.f30082r) >= 0 && i10 < stickerSetByName.documents.size()) {
                        document2 = stickerSetByName.documents.get(this.f30082r);
                    }
    ...
    public void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f30084w).addObserver(this, NotificationCenter.diceStickersDidLoad);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f30084w).removeObserver(this, NotificationCenter.diceStickersDidLoad);
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if ((this.E || this.f30085x) && (i14 = this.F) > 0 && i14 != getMeasuredHeight()) {
            float measuredHeight = (this.F - getMeasuredHeight()) / 2.0f;
            ub1 ub1Var = this.f30077a;
            ub1Var.setTranslationY(ub1Var.getTranslationY() + measuredHeight);
            if (!this.f30085x) {
                ub1Var.animate().translationY(0.0f).setInterpolator(rr.f27701f).setDuration(250L);
            }
            RadialProgressView radialProgressView = this.f30079c;
            if (radialProgressView != null) {
                radialProgressView.setTranslationY(radialProgressView.getTranslationY() + measuredHeight);
                if (!this.f30085x) {
                    radialProgressView.animate().translationY(0.0f).setInterpolator(rr.f27701f).setDuration(250L);
                }
            }
        }
    ...
    public void setPreventMoving(boolean z10) {
        this.f30085x = z10;
        if (!z10) {
            this.f30077a.setTranslationY(0.0f);
            RadialProgressView radialProgressView = this.f30079c;
            if (radialProgressView != null) {
    ...
    public xw0(Context context, View view, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f30084w = UserConfig.selectedAccount;
        this.f30086y = new org.telegram.ui.Cells.l7(this, 24);
        this.G = org.telegram.ui.ActionBar.h6.f18772c7;
        this.f30081n = d6Var;
        this.f30083s = view;
        this.f30082r = i10;
        ...
        if (view == null) {
            ...
            this.f30079c = radialProgressView;
            radialProgressView.setAlpha(0.0f);
            radialProgressView.setScaleY(0.5f);
            radialProgressView.setScaleX(0.5f);
