...
public final class xw0 extends vl0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        cx0[] cx0VarArr;
        boolean z10 = true;
        if (c1Var.f42963f == 1 && (cx0VarArr = (gx0Var = this.d).Y2) != null) {
            int i11 = i10 - 1;
            cx0 cx0Var = cx0VarArr[i11];
            final bx0 bx0Var = (bx0) c1Var.f42960a;
            if (gx0Var.f24557m3 != i11) {
                z10 = false;
            }
            bx0Var.getClass();
            if (!TextUtils.isEmpty(cx0Var.d)) {
                bx0Var.setContentDescription(cx0Var.d);
            } else if (!TextUtils.isEmpty(cx0Var.f23408a)) {
                bx0Var.setContentDescription(cx0Var.f23408a);
            } else {
            ...
            bx0Var.f23118w = false;
            bx0Var.f23120y = 1.0f;
            q5.h(UserConfig.selectedAccount).b(cx0Var.f23410c, new n5() {
                @Override
            ...
            bx0Var.l(z10, false);
            bx0Var.setAlpha(gx0Var.f24559o3);
            bx0Var.setScaleX(gx0Var.f24559o3);
            bx0Var.setScaleY(gx0Var.f24559o3);
            bx0Var.j();
        }
    }
    ...
    public final void y(s4.c1 c1Var) {
        boolean z10 = true;
        if (c1Var.f42963f == 1) {
            bx0 bx0Var = (bx0) c1Var.f42960a;
            if (this.d.f24557m3 != c1Var.b() - 1) {
                z10 = false;
            }
            bx0Var.l(z10, false);
            bx0Var.j();
