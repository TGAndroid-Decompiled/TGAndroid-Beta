...
public final class xw0 {
    public final n5 f30419a;
    public Drawable f30420b;
    ...
    public final n5 a(TLRPC.User user, TLRPC.Chat chat, int i10, boolean z10) {
        n5 n5Var = this.f30419a;
        if (chat != null && chat.verified) {
            Drawable drawable = this.f30420b;
            if (drawable == null) {
                drawable = new pq(org.telegram.ui.ActionBar.j6.f19140f1, org.telegram.ui.ActionBar.j6.f19194i1);
            }
            this.f30420b = drawable;
            ...
            Drawable drawable2 = this.f30420b;
            if (drawable2 == null) {
                drawable2 = new pq(org.telegram.ui.ActionBar.j6.f19140f1, org.telegram.ui.ActionBar.j6.f19194i1);
            }
            this.f30420b = drawable2;
    ...
    public xw0(int i10, View view) {
        this.f30419a = new n5(AndroidUtilities.dp(i10), view);
    }
}
