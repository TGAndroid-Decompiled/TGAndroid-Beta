...
public final class cw0 extends TimeAnimator {
    public int f25128a;
    public int f25129b;
    public ValueAnimator.AnimatorUpdateListener f25130c;
    public Float d;
    public float[] f25131e;

    @Override
    public final void addUpdateListener(ValueAnimator.AnimatorUpdateListener animatorUpdateListener) {
        this.f25130c = animatorUpdateListener;
    }
    ...
    public final void start() {
        setTimeListener(new TimeAnimator.TimeListener() {
            ...
            public final void onTimeUpdate(TimeAnimator timeAnimator, long j3, long j10) {
                int i10;
                cw0 cw0Var = cw0.this;
                int i11 = cw0Var.f25128a;
                if (i11 > 0 && (i10 = cw0Var.f25129b) > 0) {
                    int i12 = i11 - 1;
                    cw0Var.f25128a = i12;
                    if (cw0Var.f25130c != null) {
                        float[] fArr = cw0Var.f25131e;
                        if (fArr != null && fArr.length == 2) {
                            float interpolation = cw0Var.getInterpolator().getInterpolation(1.0f - (i12 / i10));
                            float[] fArr2 = cw0Var.f25131e;
                            float f7 = fArr2[0];
                            cw0Var.d = Float.valueOf(((fArr2[1] - f7) * interpolation) + f7);
                            cw0Var.f25130c.onAnimationUpdate(cw0Var);
                            return;
                        }
                        cw0Var.end();
                        return;
        ...
        this.f25128a = duration;
        this.f25129b = duration;
        super.start();
    }
}
