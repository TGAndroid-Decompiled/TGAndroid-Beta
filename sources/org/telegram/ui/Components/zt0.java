...
public final class zt0 implements gg.b2, org.telegram.ui.Cells.a5 {
    ...
    public void a(int i10) {
        bu0 bu0Var = this.f30869a;
        bu0Var.l();
        if (i10 == 1) {
            int i11 = bu0Var.f23080r - 1;
            bu0Var.f23080r = i11;
            if (i11 == 0) {
                int i12 = 0;
                while (true) {
                    kv0 kv0Var = bu0Var.f23081s;
                    du0[] du0VarArr = kv0Var.f25824k0;
                    if (i12 < du0VarArr.length) {
                        du0 du0Var = du0VarArr[i12];
                        if (du0Var.F == 7) {
                            if (bu0Var.h == 0) {
                                du0Var.f23687w.e(false, true);
                            } else {
    ...
    public boolean e(org.telegram.ui.Cells.b5 b5Var, boolean z10) {
        ...
        if (E instanceof TLRPC.ChannelParticipant) {
            ...
            return bu0Var.f23081s.D1.h(tL_chatChannelParticipant, true, !z10, b5Var);
        }
        return false;
    }
