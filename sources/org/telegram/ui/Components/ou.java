...
public final class ou extends org.telegram.ui.ActionBar.i5 {
    ...
    public final boolean g() {
        ...
        try {
            ruVar.f30860r.getWindow().clearFlags(128);
            return true;
        } catch (Exception e6) {
            FileLog.e(e6);
            return true;
    ...
    public final void onOpenAnimationEnd() {
        ...
        ru ruVar = this.h;
        int i10 = ruVar.N;
        RadialProgressView radialProgressView = ruVar.f30859n;
        lu luVar = ruVar.f30855b;
        f91 f91Var = ruVar.f30856c;
        if (this.f29850f && ruVar.f30856c.g(ruVar.H, null, null, ruVar.F, true)) {
