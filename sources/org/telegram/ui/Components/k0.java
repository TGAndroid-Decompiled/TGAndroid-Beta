...
public final class k0 implements org.telegram.ui.ActionBar.a2 {
    ...
    public final void g(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        switch (this.f27630a) {
            ...
            case 2:
                of.f.s(this.f27631b, BuildVars.PLAYSTORE_APP_URL);
                return;
            default:
                Context context3 = this.f27631b;
                if (context3 != null) {
                    try {
