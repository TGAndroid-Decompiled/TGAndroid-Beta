...
public final class k0 extends Drawable {
    ...
    public final Drawable f29866b;
    public final d6 f29867c = new d6(new j0(this, 0), 1200, jr.h, 0);

    public k0(Context context) {
        this.f29865a = context.getResources().getDrawable(R.drawable.input_ai).mutate();
        this.f29866b = context.getResources().getDrawable(R.drawable.input_ai_star).mutate();
    }

    @Override
    public final void draw(Canvas canvas) {
        Rect bounds = getBounds();
        Drawable drawable = this.f29865a;
        drawable.setBounds(bounds);
        drawable.draw(canvas);
        float d = this.f29867c.d(1.0f, false);
        ...
        Drawable drawable2 = this.f29866b;
    ...
    public final int getIntrinsicHeight() {
        return this.f29865a.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f29865a.getIntrinsicWidth();
    }
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        ...
        this.f29866b.setColorFilter(colorFilter);
    }
}
