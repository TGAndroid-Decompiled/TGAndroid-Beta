...
public final class qb0 extends Drawable {
    ...
    public void b(int i10, int i11) {
        ((Paint) this.f27263c).setShader(new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.dp(28.0f), new int[]{i10, i11}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP));
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        switch (this.f27261a) {
            ...
            default:
                ...
                canvas.drawRoundRect(rectF, dp, dp, (Paint) this.f27263c);
                if (this.f27262b) {
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        switch (this.f27261a) {
            case 0:
                ((yi0) this.f27263c).setColorFilter(colorFilter);
