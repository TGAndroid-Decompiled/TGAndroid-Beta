...
public final class qb0 extends FrameLayout {
    ...
    public int f29685a0;
    public final org.telegram.ui.w8 f29686b;
    public boolean f29687b0;
    public final ah.w f29688c;
    public final wb0 f29689c0;
    public final org.telegram.ui.Cells.ca d;
    public final hb0 f29690e;
    public final ib0 f29691f;
    public final kb0 h;
    public final pb0 f29692n;
    public MessagePreviewParams.Messages f29693r;
    public final ActionBarPopupWindow$ActionBarPopupWindowLayout f29694s;
    public final gb0 v;
    public final gb0 f29695w;
    public final org.telegram.ui.ActionBar.f1 f29696x;
    public final org.telegram.ui.ActionBar.f1 f29697y;
    ...
    public static MessageObject.GroupedMessages a(qb0 qb0Var, MessageObject messageObject) {
        if (messageObject.getGroupId() != 0) {
            MessageObject.GroupedMessages groupedMessages = qb0Var.f29693r.groupedMessagesMap.get(messageObject.getGroupId());
    ...
    public static void b(qb0 qb0Var, org.telegram.ui.Cells.t1 t1Var) {
        ...
        if (qb0Var.f29684a == 2) {
            MessagePreviewParams messagePreviewParams = qb0Var.f29689c0.d;
    ...
    public final void e(float f7, int i10) {
        boolean z10 = this.f29689c0.v;
        ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout = this.f29694s;
        ah.w wVar = this.f29688c;
        org.telegram.ui.w8 w8Var = this.f29686b;
        if (z10) {
    ...
    public final void g(boolean z10, boolean z11) {
        ...
        if (!z11 || this.O != z10) {
            ...
            org.telegram.ui.ActionBar.f1 f1Var = this.f29697y;
            org.telegram.ui.ActionBar.f1 f1Var2 = this.f29696x;
            gb0 gb0Var = this.f29695w;
            gb0 gb0Var2 = this.v;
            float f15 = 0.0f;
            if (z11) {
    ...
    public final void h() {
        ...
        for (int i11 = 0; i11 < this.f29693r.previewMessages.size(); i11++) {
            MessageObject messageObject = this.f29693r.previewMessages.get(i11);
            messageObject.forceUpdate = true;
            messageObject.sendAsPeer = wb0Var.f32251a;
        ...
        for (int i12 = 0; i12 < this.f29693r.pollChosenAnswers.size(); i12++) {
            this.f29693r.pollChosenAnswers.get(i12).chosen = !messagePreviewParams.hideForwardSendersName;
        }
        for (int i13 = 0; i13 < this.f29693r.groupedMessagesMap.size(); i13++) {
            kb0Var.V(this.f29693r.groupedMessagesMap.valueAt(i13));
        }
        this.f29692n.q(0, this.f29693r.previewMessages.size());
    }
    ...
    public final void i() {
        ...
        if (!z10) {
            ...
            MessagePreviewParams.Messages messages = this.f29693r;
            ...
            float A = com.google.android.gms.internal.vision.e2.A(getMeasuredHeight() - AndroidUtilities.dp(16.0f), (this.f29686b.getMeasuredHeight() - this.R) + (this.W - AndroidUtilities.dp(8.0f)), 2.0f, AndroidUtilities.dp(8.0f)) - this.R;
            this.S = A;
        ...
        if (!z11 && (this.R != i10 || this.S != f7)) {
            ...
            AndroidUtilities.runOnUIThread(wb0Var.f32261y, 50L);
            this.T = i10;
            e(f7, i10);
        } else if (z11) {
            float f11 = this.S;
        ...
        if (this.f29684a == 0) {
            ...
            if (hb0Var.v - hb0Var.f21826u <= MessagesController.getInstance(wb0Var.f32259w).quoteLengthMax) {
                ...
                if (messagePreviewParams.quote != null && hb0Var.y()) {
                    messagePreviewParams.quoteStart = hb0Var.f21826u;
                    messagePreviewParams.quoteEnd = hb0Var.v;
                    if (c10 != null && ((messageObject2 = messagePreviewParams.quote.f40504a) == null || messageObject2.getId() != c10.getId())) {
    ...
    public final void k(boolean z10) {
        ...
        String string;
        wb0 wb0Var = this.f29689c0;
        TLRPC.User user = wb0Var.f32256n;
        MessagePreviewParams messagePreviewParams = wb0Var.d;
        TLRPC.Chat chat = wb0Var.f32257r;
        ah.w wVar = this.f29688c;
    ...
    public final void onAttachedToWindow() {
        ...
        if (this.f29684a == 0) {
            AndroidUtilities.forEachViews((RecyclerView) this.f29691f, (e2.h) new za0(this, 0));
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ((ViewGroup.MarginLayoutParams) this.f29691f.getLayoutParams()).topMargin = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight();
        ...
        if (this.f29685a0 != size2) {
            for (int i13 = 0; i13 < this.f29693r.previewMessages.size(); i13++) {
                MessageObject messageObject = this.f29693r.previewMessages.get(i13);
                if (wb0Var.v) {
