...
public final class ms0 extends jn0 {
    ...
    public final boolean f(zg.p0 p0Var) {
        ...
        if (i10 == 12 && (ft0Var = zu0Var.T) != null) {
            org.telegram.ui.co coVar = ft0Var.f33444a;
            org.telegram.ui.zk zkVar = coVar.f32388o1;
            if (zkVar != null) {
                zkVar.e(p0Var, true);
            }
            if (TextUtils.isEmpty(coVar.f32454t3) && coVar.f32414q3 == null) {
                z11 = false;
            } else {
                z11 = true;
            }
    ...
    public final void h(boolean z10) {
        ...
        if (w0Var != null) {
            if (a() && zu0Var.f30656v1.getUserConfig().isPremium()) {
                i11 = R.drawable.navbar_search_tag;
            } else {
                i11 = R.drawable.outline_header_search;
            }
            bj0 bj0Var = w0Var.f19631x;
            if (bj0Var != null && w0Var.f19632y != i11) {
                if (z10) {
                    w0Var.f19632y = i11;
        ...
        org.telegram.ui.ActionBar.w0 w0Var2 = zu0Var.f30637n0;
        if (w0Var2 != null) {
