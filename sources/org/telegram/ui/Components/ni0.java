...
public final class ni0 extends Path {
    public final org.telegram.ui.Cells.t1 f26464a;
    ...
    public int h;
    public final Paint f26469i;
    public final uq f26470j;
    public final c6 f26471k;
    public final ArrayList f26472l;
    public final ArrayList f26473m;
    public final float f26474n;
    public final float f26475o;
    public final float f26476p;
    public mi0 f26477q;
    ...
    public ni0(final org.telegram.ui.Cells.t1 t1Var, int i10, int i11) {
        ...
        this.f26464a = t1Var;
        this.f26471k = new c6(0.0f, new Runnable() {
            @Override
    ...
    public final void a(float f7, float f10, float f11, float f12) {
        ...
        float f13 = this.f26476p;
        float max = Math.max(f13, f7);
        float max2 = Math.max(f13, f11);
        float f14 = this.f26474n;
        float f15 = max + f14;
        float f16 = this.f26475o;
        float f17 = f10 + f16;
        float f18 = max2 + f14;
        ?? obj = new Object();
        obj.f26163a = f15 - AndroidUtilities.dp(3.0f);
        obj.f26164b = f18 + AndroidUtilities.dp(3.0f);
        obj.f26165c = f17;
        obj.d = f12 + f16;
        mi0 mi0Var = this.f26477q;
        if (mi0Var != null) {
            float f19 = mi0Var.d;
            mi0Var.h = (f19 + f17) / 2.0f;
            obj.f26167g = (f19 + f17) / 2.0f;
        }
        this.f26472l.add(obj);
        this.f26477q = obj;
    }
    ...
    public final void b(Canvas canvas, float f7, float f10, Rect rect, float f11) {
        ...
        float f13;
        int i10 = 0;
        float d = this.f26471k.d(1.0f, false);
        canvas.save();
        boolean z10 = this.f26467f;
        Paint paint = this.f26469i;
        org.telegram.ui.Cells.t1 t1Var = this.f26464a;
        uq uqVar = this.f26470j;
        if (z10) {
            ...
            while (true) {
                ...
                float lerp3 = AndroidUtilities.lerp(rect.left - f7, mi0Var.f26163a, d);
                if (mi0Var.e) {
                    f12 = rect.top - f10;
                } else {
                    f12 = mi0Var.f26167g;
                }
                float lerp4 = AndroidUtilities.lerp(f12, mi0Var.f26165c, d);
                float lerp5 = AndroidUtilities.lerp(rect.right - f7, mi0Var.f26164b, d);
                if (mi0Var.f26166f) {
                    f13 = rect.bottom - f10;
                } else {
                    f13 = mi0Var.h;
    ...
    public ni0(org.telegram.ui.Cells.t1 t1Var, ViewParent viewParent, int i10, ArrayList arrayList, int i11, int i12, float f7) {
        ...
        this.f26473m = new ArrayList();
        this.f26464a = null;
        this.f26471k = new c6(0.0f, new ny(21, t1Var, viewParent), 350L, 420L, qr.h);
        this.f26465b = i10;
        this.f26466c = i14;
        this.d = i12;
        int i15 = 0;
        ...
        while (i16 < arrayList2.size()) {
            ...
            if (textLayoutBlock != 0 && i14 <= textLayoutBlock.charactersEnd && i12 >= (i13 = textLayoutBlock.charactersOffset)) {
                ...
                if (textLayoutBlock.code && !textLayoutBlock.quote) {
                    this.f26474n = f10 + AndroidUtilities.dp(10.0f);
                }
                this.f26475o = textLayoutBlock.textYOffset(arrayList2) + textLayoutBlock.padTop;
                this.f26476p = textLayoutBlock.quote ? AndroidUtilities.dp(10.0f) : 0.0f;
                ...
                if (textLayoutBlock.quoteCollapse && textLayoutBlock.collapsed()) {
                    this.f26473m.add(Integer.valueOf(textLayoutBlock.index));
                }
            }
            i16++;
        ...
        if (this.f26472l.size() > 0) {
            mi0 mi0Var = (mi0) this.f26472l.get(0);
            mi0 mi0Var2 = (mi0) hg.c.h(1, this.f26472l);
            mi0Var.e = true;
            mi0Var.f26165c -= AndroidUtilities.dp(0.66f);
            mi0Var2.f26166f = true;
