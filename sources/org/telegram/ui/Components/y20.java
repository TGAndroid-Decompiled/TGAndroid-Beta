...
public final class y20 extends FrameLayout {
    ...
    public float f30140b;
    public boolean f30141c;
    public AnimatorSet d;
    public final x20 e;
    public final th f30142f;
    public final float h;
    public final a30 f30143n;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (i12 != a30Var.I || a30Var.J != point.y) {
            ...
            if (a30Var.K < 0.0f) {
                ...
                this.f30143n.K = sharedPreferences.getFloat("relativeX", 1.0f);
                this.f30143n.L = sharedPreferences.getFloat("relativeY", 0.4f);
            }
            a30 a30Var2 = a30.f22333d0;
            if (a30Var2 != null) {
                a30 a30Var3 = this.f30143n;
                float f7 = a30Var3.K;
                float f10 = a30Var3.L;
                float f11 = -AndroidUtilities.dp(36.0f);
                a30Var2.f22343r.x = (int) com.google.android.gms.internal.vision.e2.z(AndroidUtilities.displaySize.x - (2.0f * f11), AndroidUtilities.dp(105.0f), f7, f11);
                a30Var2.f22343r.y = (int) ((AndroidUtilities.displaySize.y - AndroidUtilities.dp(105.0f)) * f10);
                a30Var2.h();
                y20 y20Var = a30Var2.f22335a;
                if (y20Var.getParent() != null) {
                    a30Var2.f22342n.updateViewLayout(y20Var, a30Var2.f22343r);
                }
            }
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action != 0) {
            if (action != 1) {
                if (action != 2) {
                    ...
                    float f10 = rawX - this.f30139a;
                    float f11 = rawY - this.f30140b;
                    if (!this.f30143n.W) {
                        ...
                        if (f12 > f13 * f13) {
                            ...
                            a30 a30Var4 = this.f30143n;
                            a30Var4.W = true;
                            a30Var4.f(true);
                            this.f30143n.e(false);
                            this.f30139a = rawX;
                            this.f30140b = rawY;
                            f10 = 0.0f;
                            f11 = 0.0f;
                    ...
                    this.f30140b = rawY;
                    a30Var5.i();
                    float measuredWidth = (getMeasuredWidth() / 2.0f) + this.f30143n.O;
                    float measuredHeight = (getMeasuredHeight() / 2.0f) + this.f30143n.P;
                    float measuredWidth2 = (a30Var2.f22337b.getMeasuredWidth() / 2.0f) + (a30Var2.N - this.f30143n.Q);
                    float measuredHeight2 = (a30Var3.f22337b.getMeasuredHeight() / 2.0f) + (a30Var3.M - this.f30143n.R);
                    ...
                    if (f16 < AndroidUtilities.dp(80.0f) * AndroidUtilities.dp(80.0f)) {
                        ...
                        this.f30143n.U.setRemoveAngle(d - degrees);
                    ...
                    a30 a30Var6 = this.f30143n;
                    if (!a30Var6.F && a30Var6.f22336a0 != z10) {
                        a30Var6.f22336a0 = z10;
                        ValueAnimator valueAnimator = a30Var6.f22340c0;
                        if (valueAnimator != null) {
                            valueAnimator.removeAllListeners();
                            a30Var6.f22340c0.cancel();
                        }
                        float f17 = a30Var6.f22338b0;
                        if (z10) {
                            f7 = 1.0f;
                        } else {
                            f7 = 0.0f;
                        ...
                        a30Var6.f22340c0 = ofFloat;
                        ofFloat.addUpdateListener(new k6(a30Var6, 25));
                        a30Var6.f22340c0.addListener(new ca(10, a30Var6, z10));
                        a30Var6.f22340c0.setDuration(250L);
                        a30Var6.f22340c0.setInterpolator(rr.f27701f);
                        a30Var6.f22340c0.start();
                    }
                    a30 a30Var7 = this.f30143n;
                    g30 g30Var = a30Var7.U;
                    if (a30Var7.f22347y != z11) {
                        a30Var7.f22347y = z11;
                        a30Var7.f22339c.invalidate();
                        if (!a30Var7.F) {
                            yi0 yi0Var = a30Var7.v;
                            if (z11) {
                                i10 = 33;
                            }
                            yi0Var.P(i10);
            ...
            AndroidUtilities.cancelRunOnUIThread(this.f30142f);
            AndroidUtilities.cancelRunOnUIThread(this.e);
            a30 a30Var8 = this.f30143n;
            if (a30Var8.f22347y) {
                if (this.f30141c && VoIPService.getSharedInstance() != null) {
                    VoIPService.getSharedInstance().setMicMute(true, false, false);
                }
                this.f30141c = false;
                a30 a30Var9 = this.f30143n;
                bj0 bj0Var = a30Var9.V;
                yi0 yi0Var2 = a30Var9.v;
                ai.f0 f0Var = a30Var9.f22337b;
                y20 y20Var2 = a30Var9.f22335a;
                ci.r6 r6Var = a30Var9.f22339c;
                a30 a30Var10 = a30.f22333d0;
                if (a30Var10 == null) {
                    return false;
                }
                a30Var9.F = true;
                ...
                a30Var9.U.K = true;
                a30Var10.e(false);
                float measuredWidth3 = (y20Var2.getMeasuredWidth() / 2.0f) + a30Var9.f22343r.x;
                float measuredWidth4 = ((f0Var.getMeasuredWidth() / 2.0f) + (a30Var9.N - a30Var9.Q)) - measuredWidth3;
                float measuredHeight3 = ((f0Var.getMeasuredHeight() / 2.0f) + (a30Var9.M - a30Var9.R)) - ((y20Var2.getMeasuredHeight() / 2.0f) + a30Var9.f22343r.y);
                a30 a30Var11 = a30.f22333d0;
                WindowManager windowManager = a30Var11.f22342n;
                y20 y20Var3 = a30Var11.f22335a;
                ai.f0 f0Var2 = a30Var11.f22337b;
                FrameLayout frameLayout = a30Var11.d;
                org.telegram.ui.u7 u7Var = a30Var11.e;
                a30Var9.d();
                a30.f22333d0 = null;
                AnimatorSet animatorSet = new AnimatorSet();
                int i11 = yi0Var2.f30258a0;
                if (i11 < 33) {
                    y20Var = y20Var3;
                ...
                float f19 = a30Var9.f22343r.y;
                ValueAnimator ofFloat3 = ValueAnimator.ofFloat(f19, (f19 + measuredHeight3) - AndroidUtilities.dp(30.0f), a30Var9.f22343r.y + measuredHeight3);
            ...
            if (this.f30141c) {
                ...
                this.f30141c = false;
            } else if (motionEvent.getAction() == 1 && !this.f30143n.W) {
                if (VoIPService.getSharedInstance() != null) {
                    this.f30143n.e(!a30Var.f22345w);
                    return false;
                }
                return false;
            } else {
            ...
            if (parent != null && this.f30143n.W) {
                parent.requestDisallowInterceptTouchEvent(z12);
                Point point = AndroidUtilities.displaySize;
                int i12 = point.x;
                int i13 = point.y;
                float f21 = this.f30143n.f22343r.x;
                float measuredWidth5 = getMeasuredWidth() + f21;
                float f22 = this.f30143n.f22343r.y;
                float measuredHeight4 = getMeasuredHeight() + f22;
                this.d = new AnimatorSet();
                float f23 = -AndroidUtilities.dp(36.0f);
                if (f21 < f23) {
                    ValueAnimator ofFloat11 = ValueAnimator.ofFloat(this.f30143n.f22343r.x, f23);
                    ofFloat11.addUpdateListener(this.f30143n.S);
                    this.d.playTogether(ofFloat11);
                    f21 = f23;
                } else if (measuredWidth5 > i12 - f23) {
                    float measuredWidth6 = (i12 - getMeasuredWidth()) - f23;
                    ValueAnimator ofFloat12 = ValueAnimator.ofFloat(this.f30143n.f22343r.x, measuredWidth6);
                    ofFloat12.addUpdateListener(this.f30143n.S);
                ...
                if (f22 < AndroidUtilities.statusBarHeight - AndroidUtilities.dp(36.0f)) {
                    ...
                    ValueAnimator ofFloat13 = ValueAnimator.ofFloat(this.f30143n.f22343r.y, f22);
                    ofFloat13.addUpdateListener(this.f30143n.T);
                    this.d.playTogether(ofFloat13);
                } else if (measuredHeight4 > dp) {
                    f22 = dp - getMeasuredHeight();
                    ValueAnimator ofFloat14 = ValueAnimator.ofFloat(this.f30143n.f22343r.y, f22);
                    ofFloat14.addUpdateListener(this.f30143n.T);
                    this.d.playTogether(ofFloat14);
                }
                this.d.setDuration(150L).setInterpolator(rr.f27701f);
                this.d.start();
                a30 a30Var12 = this.f30143n;
                if (a30Var12.K >= 0.0f) {
                    ...
                    a30 a30Var13 = this.f30143n;
                    float f25 = a30Var13.H[0];
                    a30Var13.K = f25;
                    SharedPreferences.Editor putFloat = edit.putFloat("relativeX", f25);
                    a30 a30Var14 = this.f30143n;
                    float f26 = a30Var14.H[1];
                    a30Var14.L = f26;
                    putFloat.putFloat("relativeY", f26).apply();
                }
            }
            a30 a30Var15 = this.f30143n;
            a30Var15.W = false;
            a30Var15.f(false);
            return true;
        }
        getLocationOnScreen(this.f30143n.G);
        a30 a30Var16 = this.f30143n;
        int i14 = a30Var16.G[0];
        WindowManager.LayoutParams layoutParams = a30Var16.f22343r;
        ...
        a30 a30Var17 = this.f30143n;
        WindowManager.LayoutParams layoutParams2 = a30Var17.f22343r;
