        ...
        switch (this.f28034a) {
            case 0:
                ...
                for (int i14 = 0; i14 < 5; i14++) {
                    ...
                    c8 c8Var = this.f28035b;
                    View view = c8Var.f25815k0[i14];
                    view.layout(dp, dp2, view.getMeasuredWidth() + dp, c8Var.f25815k0[i14].getMeasuredHeight() + dp2);
                }
                return;
            case 1:
            default:
