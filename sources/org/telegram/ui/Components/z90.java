...
public final class z90 extends xu0 {
    public AnimatorSet f33136f2;
    public final FrameLayout f33137g2;
    public final w90 f33138h2;
    public final ca0 f33139i2;
    ...
    public z90(ca0 ca0Var, Context context, long j3, pu0 pu0Var, TLRPC.ChatFull chatFull, TLRPC.UserFull userFull, int i10, ca0 ca0Var2, y90 y90Var, org.telegram.ui.ActionBar.f6 f6Var, FrameLayout frameLayout, w90 w90Var) {
        ...
        this.f33139i2 = ca0Var;
        this.f33137g2 = frameLayout;
        this.f33138h2 = w90Var;
    }

    @Override
    public final boolean D() {
        int i10 = this.f33139i2.f24973a;
        if (i10 != 1 && i10 != 2) {
            return true;
        }
        return false;
    ...
    public final void D0(SparseArray sparseArray) {
        ...
        ca0 ca0Var = this.f33139i2;
        ca0Var.I = sparseArray;
        int i10 = ca0Var.f24973a;
        if (i10 == 1 || i10 == 2) {
            ca0Var.F.a();
    ...
    public final void K0(boolean z10) {
        ...
        AndroidUtilities.updateViewVisibilityAnimated(this.f33137g2, !z10, 0.95f, true);
    }
    ...
    public final void P(Canvas canvas, float f7, Rect rect, Paint paint) {
        this.f33138h2.J(canvas, getY() + f7, rect, paint, true);
    }
    ...
    public final void b1(boolean z10) {
        ...
        if (ca0Var.f24973a == 0) {
            ...
            this.C1 = z10;
            AnimatorSet animatorSet = this.f33136f2;
            if (animatorSet != null) {
                animatorSet.cancel();
            }
            int i10 = ca0Var.f24973a;
            ...
            if (z10) {
                ...
                ca0Var.f24982s.setVisibility(0);
            }
            ...
            FrameLayout frameLayout2 = ca0Var.f24982s;
            if (z10) {
                f11 = 0.0f;
            } else {
                f11 = 1.0f;
            ...
            this.f33136f2.playTogether(arrayList);
            this.f33136f2.setDuration(300L);
            this.f33136f2.setInterpolator(pr.h);
            this.f33136f2.addListener(new org.telegram.ui.ActionBar.g(this, z10, z11, 4));
            this.f33136f2.start();
        }
    }
    ...
    public final int getInitialTab() {
        return this.f33139i2.W;
    }

    @Override
    public final String getStoriesHashtag() {
        return this.f33139i2.h;
    }

    @Override
    public final String getStoriesHashtagUsername() {
        return this.f33139i2.f24980n;
    }

    @Override
    public final boolean l0() {
        ca0 ca0Var = this.f33139i2;
        if (ca0Var.f24973a == 0 && ca0Var.f24978e == ca0Var.getUserConfig().getClientUserId() && ca0Var.f24979f == 0) {
            return true;
        }
        return false;
    }
