...
public final class z90 extends yu0 {
    public AnimatorSet f30546f2;
    public final FrameLayout f30547g2;
    public final w90 f30548h2;
    public final ca0 f30549i2;
    ...
    public z90(ca0 ca0Var, Context context, long j3, qu0 qu0Var, TLRPC.ChatFull chatFull, TLRPC.UserFull userFull, int i10, ca0 ca0Var2, y90 y90Var, org.telegram.ui.ActionBar.d6 d6Var, FrameLayout frameLayout, w90 w90Var) {
        ...
        this.f30549i2 = ca0Var;
        this.f30547g2 = frameLayout;
        this.f30548h2 = w90Var;
    }

    @Override
    public final boolean D() {
        int i10 = this.f30549i2.f22993a;
        if (i10 != 1 && i10 != 2) {
            return true;
        }
        return false;
    ...
    public final void D0(SparseArray sparseArray) {
        ...
        ca0 ca0Var = this.f30549i2;
        ca0Var.I = sparseArray;
        int i10 = ca0Var.f22993a;
        if (i10 == 1 || i10 == 2) {
            ca0Var.F.a();
    ...
    public final void K0(boolean z10) {
        ...
        AndroidUtilities.updateViewVisibilityAnimated(this.f30547g2, !z10, 0.95f, true);
    }
    ...
    public final void P(Canvas canvas, float f7, Rect rect, Paint paint) {
        this.f30548h2.J(canvas, getY() + f7, rect, paint, true);
    }
    ...
    public final void b1(boolean z10) {
        ...
        if (ca0Var.f22993a == 0) {
            ...
            this.C1 = z10;
            AnimatorSet animatorSet = this.f30546f2;
            if (animatorSet != null) {
                animatorSet.cancel();
            }
            int i10 = ca0Var.f22993a;
            ...
            if (z10) {
                ...
                ca0Var.f23001s.setVisibility(0);
            }
            ...
            FrameLayout frameLayout2 = ca0Var.f23001s;
            if (z10) {
                f11 = 0.0f;
            } else {
                f11 = 1.0f;
            ...
            this.f30546f2.playTogether(arrayList);
            this.f30546f2.setDuration(300L);
            this.f30546f2.setInterpolator(rr.h);
            this.f30546f2.addListener(new org.telegram.ui.ActionBar.g(this, z10, z11, 4));
            this.f30546f2.start();
        }
    }
    ...
    public final int getInitialTab() {
        return this.f30549i2.W;
    }

    @Override
    public final String getStoriesHashtag() {
        return this.f30549i2.h;
    }

    @Override
    public final String getStoriesHashtagUsername() {
        return this.f30549i2.f22999n;
    }

    @Override
    public final boolean l0() {
        ca0 ca0Var = this.f30549i2;
        if (ca0Var.f22993a == 0 && ca0Var.e == ca0Var.getUserConfig().getClientUserId() && ca0Var.f22998f == 0) {
            return true;
        }
        return false;
    }
