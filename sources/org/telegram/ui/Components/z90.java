...
public abstract class z90 {
    public static final Pattern f30758a = Pattern.compile("^\\[\\^([^\\]]+)\\]:[ \\t]*(.*)$");
    public static final Pattern f30759b = Pattern.compile("\\[\\^([^\\]]+)\\]");
    public static final Pattern f30760c = Pattern.compile("^(\\d+)[.)]\\s");

    public static TL_iv.RichText a(bf.p pVar, TL_iv.PageBlock pageBlock) {
        w90 w90Var = new w90(pageBlock);
        pVar.a(w90Var);
        return g(h(w90.x(w90Var.f29999c)));
    }
    ...
    public static TL_iv.textMath c(String str) {
        ...
        if (a2 != null) {
            textmath.f18519w = a2.f11609b;
            textmath.h = a2.f11610c;
            textmath.depth = a2.d;
            textmath.bitmap = a2.f11608a;
        }
        return textmath;
    }
    ...
    public static TL_iv.RichText g(TL_iv.RichText richText) {
        ...
        if (richText instanceof TL_iv.textConcat) {
            ...
            return textconcat;
        } else if (richText instanceof y90) {
            y90 y90Var = (y90) richText;
            TL_iv.textStrike g10 = g(y90Var.text);
            int i11 = y90Var.f30516a;
            if ((i11 & 4) != 0) {
    ...
    public static org.telegram.tgnet.tl.TL_iv.RichText h(org.telegram.tgnet.tl.TL_iv.RichText r17) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.z90.h(org.telegram.tgnet.tl.TL_iv$RichText):org.telegram.tgnet.tl.TL_iv$RichText");
    }

    public static java.lang.String i(java.lang.String r23, java.util.ArrayList r24) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.z90.i(java.lang.String, java.util.ArrayList):java.lang.String");
    }
