...
public final class se extends FrameLayout {
    public final Paint f27849a;
    public final RectF f27850b;
    public final org.telegram.ui.ActionBar.f6 f27851c;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!chatActivityEnterView.f21815l5) {
            ...
            if (motionEvent.getAction() == 0) {
                if (ChatActivityEnterView.this.f21847r4) {
                    boolean z10 = chatActivityEnterView.f21766d2;
                    if (!z10 || chatActivityEnterView.I3) {
                        chatActivityEnterView.C2 = -1.0f;
                        if (z10 && chatActivityEnterView.f21759c1) {
                            if (c5.d0(chatActivityEnterView.Q, chatActivityEnterView.P2)) {
                                ...
                                c5.a0(chatActivityEnterView.Q, 1, chatActivityEnterView.P2, new Utilities.Callback(this) {
                                    ...
                                    public final void run(Object obj) {
                                        ...
                                        switch (r2) {
                                            case 0:
                                                this.f27273b.d.U0(0, true, 0, false, l4.longValue());
                                                return;
                                            case 1:
                                                this.f27273b.d.U0(0, true, 0, false, l4.longValue());
                                                return;
                            ...
                            if (chatActivityEnterView.E2 && chatActivityEnterView.c()) {
                                ...
                                org.telegram.ui.ActionBar.f6 f6Var = this.f27851c;
                                c5.K(activity, a2, -1L, 0, false, l2Var, fVar, new a5(f6Var), f6Var);
                            }
                            if (c5.d0(chatActivityEnterView.Q, chatActivityEnterView.P2)) {
                                if (chatActivityEnterView.f21759c1) {
                                    ChatActivityEnterView.SlideTextView slideTextView2 = chatActivityEnterView.f21802j1;
                                    ...
                                    ChatActivityEnterView.SlideTextView slideTextView3 = chatActivityEnterView.f21802j1;
                        ...
                        chatActivityEnterView.f21783g0 = false;
                        Runnable runnable = new Runnable(this) {
                            public final se f27601b;
                            ...
                            public final void run() {
                                switch (r2) {
                                    case 0:
                                        ChatActivityEnterView chatActivityEnterView2 = this.f27601b.d;
                                        chatActivityEnterView2.f21777f0 = null;
                                        chatActivityEnterView2.L1(1, true);
                                        return;
                                    default:
                                        ChatActivityEnterView chatActivityEnterView3 = this.f27601b.d;
                                        chatActivityEnterView3.f21777f0 = null;
                                        chatActivityEnterView3.L1(1, true);
                                        return;
                                }
                            }
                        };
                        chatActivityEnterView.f21777f0 = runnable;
                ...
                if (boVar == null) {
                    ...
                    userFull = boVar.f32225a8;
                }
                if ((chat != null && !ChatObject.canSendVoice(chat) && (!ChatObject.canSendRoundVideo(chat) || !chatActivityEnterView.f21766d2)) || (userFull != null && userFull.voice_messages_forbidden)) {
                    chatActivityEnterView.Y2.i2();
                    return true;
                } else if (chatActivityEnterView.f21766d2) {
                ...
                if (motionEvent.getAction() == 2 && chatActivityEnterView.E2) {
                    ...
                    boolean z11 = chatActivityEnterView2.f21847r4;
                    if (!z11) {
                        if (!z11) {
                            if (chatActivityEnterView2.f21810k4 == -1.0f) {
                                chatActivityEnterView2.f21804j4 = y3;
                            }
                            chatActivityEnterView2.f21810k4 = y3;
                            recordCircle.invalidate();
                            if (!chatActivityEnterView2.f21841q4 && chatActivityEnterView2.f21799i4 >= 0.7f && chatActivityEnterView2.f21804j4 - chatActivityEnterView2.f21810k4 >= AndroidUtilities.dp(57.0f)) {
                                chatActivityEnterView2.f21847r4 = true;
                                ...
                                if (qgVar != null && MessagesController.getGlobalMainSettings().getInt("voicepausehint", 0) <= 3) {
                                    ...
                                    qgVar.f27291a = f4Var;
                                    f4Var.l(1.0f, 0.0f);
                                    qgVar.f27291a.p(true);
                                    qgVar.f27291a.s(LocaleController.getString(R.string.VoicePauseHint));
                                    ...
                                    qgVar.addView(qgVar.f27291a, w7.x5.d(-1, -1.0f, 119, 0.0f, 0.0f, 54.0f, 58.0f));
                                    ci.f4 f4Var2 = qgVar.f27291a;
                                ...
                                if (chatActivityEnterView3.f21768d4 && chatActivityEnterView3.f21781f4 == 0.0f && f13 > recordCircle2.E) {
                                    f7 = 1.0f;
                                    chatActivityEnterView3.f21774e4 = System.currentTimeMillis();
                                } else {
                                    f7 = 1.0f;
                                }
                                ...
                                if (f14 != -1.0f) {
                                    ...
                                    ChatActivityEnterView.SlideTextView slideTextView4 = chatActivityEnterView.f21802j1;
                                    if (slideTextView4 != null) {
                                        slideTextView4.f21906r = f10;
                                    }
                                    chatActivityEnterView.setSlideToCancelProgress(f10);
                                    f15 = f10;
                                }
                                if (f15 == 0.0f) {
                                    if (chatActivityEnterView.f21766d2 && chatActivityEnterView.f21759c1) {
                ...
                if (chatActivityEnterView.f21799i4 < 0.7f) {
                    if (chatActivityEnterView.f21766d2 && chatActivityEnterView.f21759c1) {
                        CameraController.getInstance().cancelOnInitRunnable(yeVar);
                    ...
                    chatActivityEnterView.f21796i1 = j12;
                    chatActivityEnterView.E2 = false;
                    chatActivityEnterView.L1(5, true);
                    return false;
                }
                chatActivityEnterView.f21847r4 = true;
                ChatActivityEnterView.m(chatActivityEnterView);
                return false;
            } else {
                ChatActivityEnterView.RecordCircle recordCircle3 = chatActivityEnterView.M1;
                if ((recordCircle3 != null && ChatActivityEnterView.this.f21847r4) || ((ieVar = chatActivityEnterView.f21771e1) != null && ieVar.getVisibility() == 0)) {
                    ...
                    chatActivityEnterView.f21796i1 = j11;
                    chatActivityEnterView.E2 = false;
                    chatActivityEnterView.L1(5, true);
                    return true;
                } else if (chatActivityEnterView.H3) {
                    AndroidUtilities.cancelRunOnUIThread(hgVar);
                    if (chatActivityEnterView.f21882y0 && chatActivityEnterView.f21876x0) {
                        chatActivityEnterView.Y2.X(!chatActivityEnterView.f21759c1);
                        chatActivityEnterView.k1(!chatActivityEnterView.f21759c1, true);
                    } else {
                        chatActivityEnterView.Y2.i2();
                    }
                    ...
                    boolean z12 = chatActivityEnterView.f21766d2;
                    if (!z12 || chatActivityEnterView.I3) {
                        chatActivityEnterView.C2 = -1.0f;
                        if (z12 && chatActivityEnterView.f21759c1) {
                            if (c5.d0(chatActivityEnterView.Q, chatActivityEnterView.P2)) {
                                ChatActivityEnterView.SlideTextView slideTextView5 = chatActivityEnterView.f21802j1;
                            ...
                            j3 = 0;
                            if (!chatActivityEnterView.f21882y0) {
                                chatActivityEnterView.Y2.i2();
                                ...
                                MediaController.getInstance().toggleRecordingPause(chatActivityEnterView.O);
                                chatActivityEnterView.Y2.a1(0);
                                ChatActivityEnterView.SlideTextView slideTextView6 = chatActivityEnterView.f21802j1;
                                ...
                                if (chatActivityEnterView.E2 && chatActivityEnterView.c()) {
                                    ...
                                    org.telegram.ui.ActionBar.f6 f6Var2 = this.f27851c;
                        ...
                        Runnable runnable2 = new Runnable(this) {
                            ...
                            public final void run() {
                                switch (r2) {
                                    case 0:
                                        ChatActivityEnterView chatActivityEnterView22 = this.f27601b.d;
                                        chatActivityEnterView22.f21777f0 = null;
                                        chatActivityEnterView22.L1(1, true);
                                        return;
                                    default:
                                        ChatActivityEnterView chatActivityEnterView32 = this.f27601b.d;
                                        chatActivityEnterView32.f21777f0 = null;
                                        chatActivityEnterView32.L1(1, true);
                                        return;
                                }
                            }
                        };
                        chatActivityEnterView.f21777f0 = runnable2;
                        if (chatActivityEnterView.f21885y4) {
                            j10 = 500;
                        } else {
                            j10 = j3;
                        }
