...
public abstract class n71 extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public long f26375a0;
    public b6 f26376b;
    public int f26377b0;
    public long f26378c;
    public int f26379c0;
    public Uri d;
    public ArrayList f26380d0;
    public Runnable e;
    public TLRPC.Document f26381e0;
    public l71 f26382f;
    public String f26383f0;
    public int f26384g0;
    public float h;
    public int f26385n;
    public int f26386r;
    ...
    public Bitmap v;
    public Bitmap f26388w;
    public final Drawable f26389x;
    public String f26390y;
    ...
    public n71(Context context, org.telegram.ui.qr0 qr0Var) {
        ...
        this.f26384g0 = -1;
        setVisibility(4);
        this.f26389x = context.getResources().getDrawable(R.drawable.videopreview);
    ...
    public final void a() {
        ...
        if (this.f26382f != null) {
            Utilities.globalQueue.cancelRunnable(this.f26382f);
            this.f26382f = null;
        }
        b6 b6Var = this.f26376b;
        if (b6Var != null) {
            AnimatedFileDrawableStream animatedFileDrawableStream = b6Var.f22651u0;
            if (animatedFileDrawableStream != null) {
                animatedFileDrawableStream.cancel(true);
            }
            if (b6Var.f22631d0 != null) {
                b6Var.f22631d0.h();
            }
        }
    ...
    public final void b(int i10) {
        int i11 = this.f26384g0;
        if (i11 == i10) {
            return;
        }
        if (i10 == -1) {
            NotificationCenter.getInstance(i11).removeObserver(this, NotificationCenter.fileLoaded);
            NotificationCenter.getInstance(this.f26384g0).removeObserver(this, NotificationCenter.fileLoadFailed);
        } else {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.fileLoaded) {
            if (((String) objArr[0]).equals(this.f26383f0)) {
                File pathToAttach = FileLoader.getInstance(i11).getPathToAttach(this.f26381e0);
        ...
        } else if (i10 == NotificationCenter.fileLoadFailed && ((String) objArr[0]).equals(this.f26383f0)) {
            this.f26383f0 = null;
            this.f26381e0 = null;
            b(-1);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Drawable drawable = this.f26389x;
        if (z10) {
            canvas.save();
            Path path = this.V;
            path.rewind();
            ...
            canvas.drawText(this.f26390y, (getMeasuredWidth() - this.E) / 2.0f, getMeasuredHeight() - AndroidUtilities.dp(9.0f), textPaint);
        } else if (this.f26388w != null && this.G != null) {
            Matrix matrix = this.L;
            matrix.reset();
            float measuredWidth = getMeasuredWidth() / this.f26388w.getWidth();
