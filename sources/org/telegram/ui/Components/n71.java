...
public abstract class n71 extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public long f28669a0;
    public d6 f28670b;
    public int f28671b0;
    public long f28672c;
    public int f28673c0;
    public Uri d;
    public ArrayList f28674d0;
    public Runnable f28675e;
    public TLRPC.Document f28676e0;
    public l71 f28677f;
    public String f28678f0;
    public int f28679g0;
    public float h;
    public int f28680n;
    public int f28681r;
    public boolean f28682s;
    public Bitmap v;
    public Bitmap f28683w;
    public final Drawable f28684x;
    public String f28685y;
    ...
    public n71(Context context, org.telegram.ui.qr0 qr0Var) {
        ...
        this.f28679g0 = -1;
        setVisibility(4);
        this.f28684x = context.getResources().getDrawable(R.drawable.videopreview);
    ...
    public final void a() {
        if (this.f28675e != null) {
            Utilities.globalQueue.cancelRunnable(this.f28675e);
            this.f28675e = null;
        }
        if (this.f28677f != null) {
            Utilities.globalQueue.cancelRunnable(this.f28677f);
            this.f28677f = null;
        }
        d6 d6Var = this.f28670b;
        if (d6Var != null) {
            AnimatedFileDrawableStream animatedFileDrawableStream = d6Var.f25268u0;
            if (animatedFileDrawableStream != null) {
                animatedFileDrawableStream.cancel(true);
            }
            if (d6Var.f25247d0 != null) {
                d6Var.f25247d0.h();
            }
        }
    ...
    public final void b(int i10) {
        int i11 = this.f28679g0;
        if (i11 == i10) {
            return;
        }
        if (i10 == -1) {
            NotificationCenter.getInstance(i11).removeObserver(this, NotificationCenter.fileLoaded);
            NotificationCenter.getInstance(this.f28679g0).removeObserver(this, NotificationCenter.fileLoadFailed);
        } else {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.fileLoaded) {
            if (((String) objArr[0]).equals(this.f28678f0)) {
                File pathToAttach = FileLoader.getInstance(i11).getPathToAttach(this.f28676e0);
        ...
        } else if (i10 == NotificationCenter.fileLoadFailed && ((String) objArr[0]).equals(this.f28678f0)) {
            this.f28678f0 = null;
            this.f28676e0 = null;
            b(-1);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Drawable drawable = this.f28684x;
        if (z10) {
            canvas.save();
            Path path = this.V;
            path.rewind();
            ...
            canvas.drawText(this.f28685y, (getMeasuredWidth() - this.E) / 2.0f, getMeasuredHeight() - AndroidUtilities.dp(9.0f), textPaint);
        } else if (this.f28683w != null && this.G != null) {
            Matrix matrix = this.L;
            matrix.reset();
            float measuredWidth = getMeasuredWidth() / this.f28683w.getWidth();
