...
public final class gx0 implements RequestDelegate {
    public final int f24641a;
    public final Utilities.Callback4 f24642b;

    public gx0(Utilities.Callback4 callback4, int i10) {
        this.f24641a = i10;
        this.f24642b = callback4;
    }
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.f24641a) {
            case 0:
                ...
                Utilities.Callback4 callback4 = this.f24642b;
                if (z10) {
            ...
            default:
                ...
                Utilities.Callback4 callback42 = this.f24642b;
                if (z11) {
