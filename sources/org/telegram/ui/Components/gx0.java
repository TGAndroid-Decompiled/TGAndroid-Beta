...
public final class gx0 implements Runnable {
    ...
    public final TLObject f26547b;
    public final Utilities.Callback f26548c;

    public gx0(TLObject tLObject, Utilities.Callback callback, int i10) {
        this.f26546a = i10;
        this.f26547b = tLObject;
        this.f26548c = callback;
    }
    ...
    public final void run() {
        ...
        switch (this.f26546a) {
            case 0:
                TLObject tLObject = this.f26547b;
                ...
                this.f26548c.run(Boolean.valueOf(z10));
                return;
            default:
                TLObject tLObject2 = this.f26547b;
                boolean z11 = tLObject2 instanceof TL_account.paidMessagesRevenue;
                Utilities.Callback callback = this.f26548c;
                if (z11) {
