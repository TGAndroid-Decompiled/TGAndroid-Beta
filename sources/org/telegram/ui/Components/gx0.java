...
public final class gx0 implements Runnable {
    ...
    public final TLObject f26520b;
    public final Utilities.Callback f26521c;

    public gx0(TLObject tLObject, Utilities.Callback callback, int i10) {
        this.f26519a = i10;
        this.f26520b = tLObject;
    ...
    public final void run() {
        ...
        switch (this.f26519a) {
            case 0:
                TLObject tLObject = this.f26520b;
                ...
                this.f26521c.run(Boolean.valueOf(z10));
                return;
            default:
                TLObject tLObject2 = this.f26520b;
                boolean z11 = tLObject2 instanceof TL_account.paidMessagesRevenue;
                Utilities.Callback callback = this.f26521c;
                if (z11) {
