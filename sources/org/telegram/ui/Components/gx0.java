...
public final class gx0 extends FrameLayout {
    ...
    public boolean d;
    public final p9 f27313e;
    public final ImageView f27314f;
    public final hg.q h;
    public final View f27315n;
    public boolean f27316r;
    public final int f27317s;
    public SvgHelper.SvgDrawable v;
    public boolean f27318w;
    public ValueAnimator f27319x;
    ...
    public gx0(Context context, int i10) {
        ...
        if (i10 == 2) {
            ...
            this.f27314f = imageView;
            imageView.setScaleType(ImageView.ScaleType.CENTER_CROP);
            addView(imageView, k7.c6.e(24, 24, 17));
            this.f27315n = imageView;
        } else {
    ...
    public final void a(float f10) {
        ...
        boolean z4 = this.f27316r;
        View view = this.f27315n;
        if (z4) {
            if (i10 == 1) {
                f11 = 24.0f;
            } else {
    ...
    public void setExpanded(boolean z4) {
        ...
        if (i11 != 2) {
            ...
            if (i11 != 1 && this.f27318w) {
                this.f27313e.setRoundRadius(AndroidUtilities.dp(view.getLayoutParams().width / 2.0f));
            }
        }
    }
}
