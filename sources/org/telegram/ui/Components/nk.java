...
public final class nk implements ViewTreeObserver.OnPreDrawListener {
    ...
    public final MessageObject f26738b;
    ...
    public final boolean onPreDraw() {
        switch (this.f26737a) {
            case 0:
                ...
                pk pkVar = okVar.X;
                boolean s10 = pkVar.f27088b.X0.s();
                boolean z10 = this.f26739c;
                if (s10) {
                    MessageObject messageObject = this.f26738b;
            ...
            case 1:
                ...
                org.telegram.ui.t10 t10Var = ((org.telegram.ui.m10) this.e).f35445c;
                boolean g10 = t10Var.f37938o0.g();
                boolean z11 = this.f26739c;
                if (g10) {
                    org.telegram.ui.l10 l10Var2 = t10Var.S;
                    MessageObject messageObject2 = this.f26738b;
                    int id3 = messageObject2.getId();
                    l10Var2.f35206a = messageObject2.getDialogId();
                    l10Var2.f35207b = id3;
                    s2Var.V(t10Var.f37938o0.c(t10Var.S), z11);
                    return true;
                }
                s2Var.V(false, z11);
                return true;
            case 2:
                ...
                boolean g11 = t10Var2.f37938o0.g();
                boolean z12 = this.f26739c;
                if (g11) {
                    org.telegram.ui.l10 l10Var3 = t10Var2.S;
                    MessageObject messageObject3 = this.f26738b;
                    int id4 = messageObject3.getId();
                    l10Var3.f35206a = messageObject3.getDialogId();
                    l10Var3.f35207b = id4;
                    k7Var2.b(t10Var2.f37938o0.c(t10Var2.S), z12);
                    return true;
                }
                k7Var2.b(false, z12);
                return true;
            case 3:
                ...
                boolean g12 = t10Var3.f37938o0.g();
                boolean z13 = this.f26739c;
                if (g12) {
                    org.telegram.ui.l10 l10Var4 = t10Var3.S;
                    MessageObject messageObject4 = this.f26738b;
                    int id5 = messageObject4.getId();
                    l10Var4.f35206a = messageObject4.getDialogId();
                    l10Var4.f35207b = id5;
                    j7Var.e(t10Var3.f37938o0.c(t10Var3.S), z13);
                    return true;
                }
                j7Var.e(false, z13);
                return true;
            default:
                ...
                boolean g13 = t10Var4.f37938o0.g();
                boolean z14 = this.f26739c;
                if (g13) {
                    org.telegram.ui.l10 l10Var5 = t10Var4.S;
                    MessageObject messageObject5 = this.f26738b;
                    int id6 = messageObject5.getId();
                    l10Var5.f35206a = messageObject5.getDialogId();
                    l10Var5.f35207b = id6;
                    n7Var.f(t10Var4.f37938o0.c(t10Var4.S), z14);
                    return true;
                }
                n7Var.f(false, z14);
                return true;
