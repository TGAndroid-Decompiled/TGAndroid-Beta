...
public final class h2 implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        switch (this.f24463a) {
            case 0:
                o3 o3Var = (o3) this.e;
                q3 q3Var = (q3) this.f24466f;
                p3 p3Var = (p3) this.f24467g;
                Boolean bool = (Boolean) obj;
                int i12 = this.f24464b;
                int i13 = i12 % 60;
                int i14 = (i12 - i13) / 60;
                int i15 = this.f24465c;
                int i16 = i15 % 60;
                int i17 = (i15 - i16) / 60;
                int i18 = 59;
                if (i16 == 0 && i17 > 0) {
                ...
                return;
            default:
                yh.a4.E0((yh.a4) this.e, this.f24464b, this.f24465c, this.d, (TL_stars.TL_starGiftUnique) this.f24466f, (tg.n1[]) this.f24467g, (Long) obj);
                return;
        }
    }
    ...
    public h2(yh.a4 a4Var, int i10, int i11, int i12, TL_stars.TL_starGiftUnique tL_starGiftUnique, tg.n1[] n1VarArr) {
        ...
        this.f24465c = i11;
        this.d = i12;
        this.f24466f = tL_starGiftUnique;
        this.f24467g = n1VarArr;
    }
}
