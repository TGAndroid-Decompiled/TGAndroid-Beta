...
public final class h2 implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        switch (this.f24525a) {
            case 0:
                p3 p3Var = (p3) this.e;
                r3 r3Var = (r3) this.f24528f;
                q3 q3Var = (q3) this.f24529g;
                Boolean bool = (Boolean) obj;
                int i12 = this.f24526b;
                int i13 = i12 % 60;
                int i14 = (i12 - i13) / 60;
                int i15 = this.f24527c;
                int i16 = i15 % 60;
                int i17 = (i15 - i16) / 60;
                int i18 = 59;
                if (i16 == 0 && i17 > 0) {
                ...
                return;
            default:
                yh.y3.E0((yh.y3) this.e, this.f24526b, this.f24527c, this.d, (TL_stars.TL_starGiftUnique) this.f24528f, (tg.m1[]) this.f24529g, (Long) obj);
                return;
        }
    }
    ...
    public h2(yh.y3 y3Var, int i10, int i11, int i12, TL_stars.TL_starGiftUnique tL_starGiftUnique, tg.m1[] m1VarArr) {
        ...
        this.f24527c = i11;
        this.d = i12;
        this.f24528f = tL_starGiftUnique;
        this.f24529g = m1VarArr;
    }
}
