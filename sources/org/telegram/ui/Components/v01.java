...
public final class v01 extends ReplacementSpan {
    public static final int f28955f = 0;
    public ImageReceiver f28956a;
    public int f28957b;
    public int f28958c;
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        int i15 = this.f28957b;
        int i16 = this.f28958c;
        ImageReceiver imageReceiver = this.f28956a;
        canvas.save();
        if (this.d) {
