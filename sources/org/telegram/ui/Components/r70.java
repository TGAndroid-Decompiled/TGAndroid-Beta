...
public final class r70 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        int i10;
        w70 w70Var = this.f27574a;
        Drawable drawable = w70Var.f29577b;
        int i11 = w70Var.f29581r;
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            w70 w70Var = this.f27574a;
            if (w70Var.f29581r != 0 && motionEvent.getY() < w70Var.f29581r) {
                w70Var.dismiss();
                return true;
            }
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        w70 w70Var = this.f27574a;
        TextView textView = w70Var.f29579f;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (!this.f27574a.isDismissed() && super.onTouchEvent(motionEvent)) {
            return true;
        }
        return false;
    }
