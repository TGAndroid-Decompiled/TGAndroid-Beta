    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f32223a) {
            case 0:
                ...
                return;
            case 1:
                i81 i81Var2 = this.f32224b;
                i81Var2.getClass();
                i81Var2.R = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                return;
            case 2:
                i81 i81Var3 = this.f32224b;
                i81Var3.N.onAnimationUpdate(valueAnimator);
                i81Var3.M.f26660a = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                i81Var3.M.v.e1();
                i81Var3.M.invalidate();
                return;
            default:
                i81 i81Var4 = this.f32224b;
                i81Var4.getClass();
