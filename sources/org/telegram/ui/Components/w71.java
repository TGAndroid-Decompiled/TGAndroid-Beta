    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f29649a) {
            case 0:
                ...
                return;
            case 1:
                i81 i81Var2 = this.f29650b;
                i81Var2.getClass();
                i81Var2.R = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                return;
            case 2:
                i81 i81Var3 = this.f29650b;
                i81Var3.N.onAnimationUpdate(valueAnimator);
                i81Var3.M.f24588a = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                i81Var3.M.v.f1();
                i81Var3.M.invalidate();
                return;
            default:
                i81 i81Var4 = this.f29650b;
                i81Var4.getClass();
