...
public final class w71 extends View {
    ...
    public boolean h;
    public float f29590n;
    public MediaMetadataRetriever f29591r;
    public v71 f29592s;
    ...
    public w71(Context context) {
        ...
        paint2.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18807a7, false));
        this.L = 0;
        u71 u71Var = this.P;
        if (u71Var != null) {
            u71Var.b();
    ...
    public final void a(boolean z10) {
        synchronized (T) {
            try {
                MediaMetadataRetriever mediaMetadataRetriever = this.f29591r;
        ...
        if (this.f29591r != null) {
            if (i10 == 0) {
                if (this.I) {
                    ...
                    this.f29595y = (int) Math.ceil((getMeasuredWidth() - AndroidUtilities.dp(16.0f)) / this.F);
                }
                this.f29594x = this.f29586a / this.F;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int dp = AndroidUtilities.dp(12.0f) + ((int) (this.f29587b * measuredWidth));
        int dp2 = AndroidUtilities.dp(12.0f) + ((int) (measuredWidth * this.f29588c));
        float f7 = 32.0f;
        int measuredHeight = (getMeasuredHeight() - AndroidUtilities.dp(32.0f)) >> 1;
        ArrayList arrayList = this.v;
        if (arrayList.isEmpty() && this.f29593w == null) {
            b(0);
        }
        if (!arrayList.isEmpty()) {
            if (!this.O) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent != null) {
            ...
            int dp = AndroidUtilities.dp(12.0f) + ((int) (this.f29587b * f7));
            int dp2 = AndroidUtilities.dp(12.0f) + ((int) (this.f29588c * f7));
            if (motionEvent.getAction() == 0) {
                getParent().requestDisallowInterceptTouchEvent(true);
                if (this.f29591r != null) {
                    int dp3 = AndroidUtilities.dp(24.0f);
                    if (dp - dp3 <= x10 && x10 <= dp + dp3 && y3 >= 0.0f && y3 <= getMeasuredHeight()) {
                        v71 v71Var = this.f29592s;
                        if (v71Var != null) {
                            ((bf) v71Var).f22724a.Y2.K(0.0f, 1);
                        }
                        this.f29589f = true;
                        this.f29590n = (int) (x10 - dp);
                        this.P.setTime((int) ((((float) this.f29586a) / 1000.0f) * this.f29587b));
                        this.P.setCx(AndroidUtilities.dp(4.0f) + getLeft() + dp);
                        this.P.a(true);
                        invalidate();
                        return true;
                    } else if (dp2 - dp3 <= x10 && x10 <= dp3 + dp2 && y3 >= 0.0f && y3 <= getMeasuredHeight()) {
                        v71 v71Var2 = this.f29592s;
                        if (v71Var2 != null) {
                            ((bf) v71Var2).f22724a.Y2.K(0.0f, 1);
                        }
                        this.h = true;
                        this.f29590n = (int) (x10 - dp2);
                        this.P.setTime((int) ((((float) this.f29586a) / 1000.0f) * this.f29588c));
                ...
                if (motionEvent.getAction() == 2) {
                    if (this.f29589f) {
                        ...
                        this.P.setCx(((AndroidUtilities.dpf2(12.0f) + (f7 * this.f29587b)) + getLeft()) - AndroidUtilities.dp(4.0f));
                        this.P.setTime((int) ((((float) this.f29586a) / 1000.0f) * this.f29587b));
                        this.P.a(true);
                        v71 v71Var3 = this.f29592s;
                        if (v71Var3 != null) {
                            float f15 = this.f29587b;
                            ChatActivityEnterView chatActivityEnterView = ((bf) v71Var3).f22724a;
                            VideoEditedInfo videoEditedInfo = chatActivityEnterView.f21767d3;
                        ...
                        this.f29588c = dp5;
                        float f16 = this.f29587b;
                        float f17 = dp5 - f16;
                        float f18 = this.G;
                        if (f17 > f18) {
                            this.f29587b = dp5 - f18;
                        } else {
                            float f19 = this.H;
                            if (f19 != 0.0f && f17 < f19) {
                                float f20 = f16 + f19;
                        ...
                        this.P.setCx(AndroidUtilities.dpf2(12.0f) + (f7 * this.f29588c) + getLeft() + AndroidUtilities.dp(4.0f));
                        this.P.a(true);
                        this.P.setTime((int) ((((float) this.f29586a) / 1000.0f) * this.f29588c));
                        v71 v71Var4 = this.f29592s;
                        if (v71Var4 != null) {
                            float f21 = this.f29588c;
                            ChatActivityEnterView chatActivityEnterView2 = ((bf) v71Var4).f22724a;
                            VideoEditedInfo videoEditedInfo2 = chatActivityEnterView2.f21767d3;
                ...
                v71 v71Var5 = this.f29592s;
                if (v71Var5 != null) {
                    ((bf) v71Var5).f22724a.Y2.K(0.0f, 0);
                }
                this.f29589f = false;
                invalidate();
                this.P.a(false);
                ...
                v71 v71Var6 = this.f29592s;
                if (v71Var6 != null) {
                    ((bf) v71Var6).f22724a.Y2.K(0.0f, 0);
                }
                this.h = false;
                invalidate();
                this.P.a(false);
    ...
    public void setVideoPath(String str) {
        ...
        this.f29591r = mediaMetadataRetriever;
        this.f29587b = 0.0f;
        this.f29588c = 1.0f;
        try {
            mediaMetadataRetriever.setDataSource(str);
            this.f29586a = Long.parseLong(this.f29591r.extractMetadata(9));
        } catch (Exception e) {
            FileLog.e(e);
        }
        invalidate();
