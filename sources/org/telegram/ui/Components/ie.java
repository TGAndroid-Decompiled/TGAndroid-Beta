...
public final class ie implements org.telegram.ui.jj0, org.telegram.ui.ky {
    public final ChatActivityEnterView f25033a;
    public final MessageObject f25034b;
    public final TL_keyboard.TL_buttonTypeRequestPeer f25035c;
    ...
    public ie(ChatActivityEnterView chatActivityEnterView, MessageObject messageObject, TL_keyboard.TL_buttonTypeRequestPeer tL_buttonTypeRequestPeer) {
        this.f25033a = chatActivityEnterView;
        this.f25034b = messageObject;
        this.f25035c = tL_buttonTypeRequestPeer;
    }
    ...
    public void a(ArrayList arrayList) {
        ...
        if (!arrayList.isEmpty()) {
            ...
            ChatActivityEnterView chatActivityEnterView = this.f25033a;
            MessagesController messagesController = MessagesController.getInstance(chatActivityEnterView.Q);
            MessageObject messageObject = this.f25034b;
            ...
            tL_messages_sendBotRequestedPeer.button_id = this.f25035c.button_id;
