...
public final class ie implements org.telegram.ui.jj0, org.telegram.ui.ky {
    public final ChatActivityEnterView f25034a;
    public final MessageObject f25035b;
    public final TL_keyboard.TL_buttonTypeRequestPeer f25036c;
    ...
    public ie(ChatActivityEnterView chatActivityEnterView, MessageObject messageObject, TL_keyboard.TL_buttonTypeRequestPeer tL_buttonTypeRequestPeer) {
        this.f25034a = chatActivityEnterView;
        this.f25035b = messageObject;
        this.f25036c = tL_buttonTypeRequestPeer;
    }
    ...
    public void a(ArrayList arrayList) {
        ...
        if (!arrayList.isEmpty()) {
            ...
            ChatActivityEnterView chatActivityEnterView = this.f25034a;
            MessagesController messagesController = MessagesController.getInstance(chatActivityEnterView.Q);
            MessageObject messageObject = this.f25035b;
            ...
            tL_messages_sendBotRequestedPeer.button_id = this.f25036c.button_id;
