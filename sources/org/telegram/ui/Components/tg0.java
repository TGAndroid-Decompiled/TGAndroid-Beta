...
public final class tg0 extends yw0 {
    ...
    public final Paint f28465b = new Paint(1);
    public final int f28466c = UserConfig.selectedAccount;
    public long d = 0;
    public boolean e = false;
    public final RectF f28467f = new RectF();
    public float f28468g;
    public final boolean h;
    public final org.telegram.ui.ActionBar.f6 f28469i;
    ...
    public final void draw(Canvas canvas) {
        ...
        boolean z10 = this.h;
        if (z10) {
            i10 = org.telegram.ui.ActionBar.j6.f19332p9;
        } else {
            i10 = org.telegram.ui.ActionBar.j6.f19333pa;
        }
        int v02 = org.telegram.ui.ActionBar.j6.v0(i10, this.f28469i);
        Paint paint = this.f28465b;
        paint.setColor(v02);
        RectF rectF = this.f28467f;
        rectF.set(0.0f, i12, dp, i12 + dp);
        float f10 = this.f28468g;
        if (f10 < 0.5f) {
        ...
        if (z10) {
            ...
            i11 = org.telegram.ui.ActionBar.j6.f19387s8;
        }
    ...
    public final void f() {
        if (this.e) {
            if (!NotificationCenter.getInstance(this.f28466c).isAnimationInProgress()) {
                ...
                if (this.f28468g >= 1.0f) {
                    this.f28468g = 0.0f;
                }
                float f7 = (((float) j3) / 300.0f) + this.f28468g;
                this.f28468g = f7;
                if (f7 > 1.0f) {
                    this.f28468g = 1.0f;
                }
