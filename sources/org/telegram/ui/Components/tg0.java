...
public abstract class tg0 extends FrameLayout {
    public final t5 f28976a;
    public final TextView f28977b;
    public final org.telegram.ui.Cells.w1 f28978c;
    public final vg0 d;
    ...
    public tg0(vg0 vg0Var, Context context) {
        ...
        int i15;
        this.d = vg0Var;
        setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19995i5, false));
        t5 t5Var = new t5(getContext());
        this.f28976a = t5Var;
        t5Var.setTextSize(1, 14.0f);
        t5Var.setTypeface(AndroidUtilities.bold());
        int i16 = org.telegram.ui.ActionBar.j6.f19943f7;
    ...
    public final void a(String str, ArrayList arrayList, int i10, int i11, int i12, boolean z4) {
        ...
        if (LocaleController.isRTL) {
            ...
            spannableStringBuilder = new SpannableStringBuilder(kh.a2.k(i10, " – ", "%"));
        }
        spannableStringBuilder.setSpan(new f51(AndroidUtilities.bold()), 3, format.length() + 3, 33);
        this.f28977b.setText(spannableStringBuilder);
        org.telegram.ui.Cells.w1 w1Var = this.f28978c;
        if (i12 == 0) {
            if (this.d.f29465r.quiz) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        measureChildWithMargins(this.f28976a, i10, AndroidUtilities.dp(32.0f) + measuredWidth, makeMeasureSpec, 0);
