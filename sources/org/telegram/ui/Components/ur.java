...
public final class ur extends View {
    public final TextPaint f28908a;
    public final TextPaint f28909b;
    ...
    public ur(Context context, String str, String str2) {
        ...
        this.f28908a = textPaint;
        TextPaint textPaint2 = new TextPaint(1);
        this.f28909b = textPaint2;
        this.e = new Rect();
        this.f28910c = str;
        this.d = str2;
    ...
    public final void onDraw(Canvas canvas) {
        TextPaint textPaint = this.f28909b;
        String str = this.d;
        float measureText = textPaint.measureText(str);
        TextPaint textPaint2 = this.f28908a;
