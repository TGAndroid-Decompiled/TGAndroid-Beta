...
public class EarListener implements SensorEventListener {
    ...
    public boolean forbidRaiseToListen() {
        try {
            ...
            } else if (this.audioManager.isWiredHeadsetOn() || this.audioManager.isBluetoothA2dpOn() || this.audioManager.isBluetoothScoOn()) {
                return true;
            }
            return false;
        } catch (Exception e) {
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (this.attached && VoIPService.getSharedInstance() == null) {
            ...
            if (sensor2 == this.linearSensor || sensor2 == this.gravitySensor || sensor2 == this.accelerometerSensor) {
                ...
                float f10 = (fArr10[c] * fArr11[c]) + (fArr10[c2] * fArr11[c2]) + (f9 * fArr11[0]);
