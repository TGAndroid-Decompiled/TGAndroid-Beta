...
public abstract class d8 extends FrameLayout {
    public final TextView[] f23517a;
    public final float[] f23518b;
    public final int f23519c;
    public final Matrix d;
    public final Paint e;
    public final Paint f23520f;
    public int h;
    public AnimatorSet f23521n;
    public LinearGradient f23522r;
    public int f23523s;
    ...
    public d8(Context context) {
        super(context);
        this.f23517a = new TextView[2];
        this.f23518b = new float[]{0.0f, 0.75f};
        this.f23519c = AndroidUtilities.dp(24.0f);
        this.f23523s = -1;
        this.v = new RectF();
        for (int i10 = 0; i10 < 2; i10++) {
            this.f23517a[i10] = a();
            if (i10 == 1) {
                this.f23517a[i10].setAlpha(0.0f);
                this.f23517a[i10].setVisibility(8);
            }
            addView(this.f23517a[i10], w7.y5.c(-1.0f, -2));
        }
        this.d = new Matrix();
    ...
    public final void b(CharSequence charSequence, boolean z10) {
        final int i10;
        int i11 = this.h;
        TextView[] textViewArr = this.f23517a;
        ...
        if (!TextUtils.isEmpty(text) && z10) {
            ...
            this.h = i10;
            AnimatorSet animatorSet = this.f23521n;
            if (animatorSet != null) {
                animatorSet.cancel();
            }
            AnimatorSet animatorSet2 = new AnimatorSet();
            this.f23521n = animatorSet2;
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    switch (r3) {
                        case 0:
                            d8 d8Var = this.f23248b;
                            d8Var.f23518b[i13] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            d8Var.invalidate();
                            return;
                        default:
                            d8 d8Var2 = this.f23248b;
                            d8Var2.f23518b[i13] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            d8Var2.invalidate();
                            return;
                    }
                }
            ...
            ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    switch (r3) {
                        case 0:
                            d8 d8Var = this.f23248b;
                            d8Var.f23518b[i10] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            d8Var.invalidate();
                            return;
                        default:
                            d8 d8Var2 = this.f23248b;
                            d8Var2.f23518b[i10] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            d8Var2.invalidate();
                            return;
                    }
                }
            ...
            this.f23521n.playTogether(ofFloat, ofFloat2, ofFloat3, ofFloat4);
            this.f23521n.start();
            return;
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (i12 > 0 && textViewArr[this.h].getAlpha() != 1.0f && textViewArr[this.h].getLayout() != null) {
            ...
            float primaryHorizontal2 = textViewArr[this.h].getLayout().getPrimaryHorizontal(this.f23523s);
        ...
        float f10 = f7 + this.f23519c;
        Matrix matrix = this.d;
        matrix.setTranslate(f7, 0.0f);
        this.f23522r.setLocalMatrix(matrix);
        canvas.drawRect(f7, 0.0f, f10, min2, this.e);
        Paint paint = this.f23520f;
        if (min > f10) {
            canvas2 = canvas;
    ...
    public TextView getNextTextView() {
        ...
        return this.f23517a[c10];
    }

    public TextView getTextView() {
        return this.f23517a[this.h];
    }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        LinearGradient linearGradient = new LinearGradient(this.f23519c, 0.0f, 0.0f, 0.0f, 0, -16777216, Shader.TileMode.CLAMP);
        this.f23522r = linearGradient;
    ...
    public void setCustomPaddingRight(int i10) {
        ...
        this.f23524w = i10;
        for (TextView textView : this.f23517a) {
