...
public abstract class d8 extends FrameLayout {
    public final TextView[] f23478a;
    public final float[] f23479b;
    public final int f23480c;
    public final Matrix d;
    public final Paint e;
    public final Paint f23481f;
    public int h;
    public AnimatorSet f23482n;
    public LinearGradient f23483r;
    public int f23484s;
    ...
    public d8(Context context) {
        super(context);
        this.f23478a = new TextView[2];
        this.f23479b = new float[]{0.0f, 0.75f};
        this.f23480c = AndroidUtilities.dp(24.0f);
        this.f23484s = -1;
        this.v = new RectF();
        for (int i10 = 0; i10 < 2; i10++) {
            this.f23478a[i10] = a();
            if (i10 == 1) {
                this.f23478a[i10].setAlpha(0.0f);
                this.f23478a[i10].setVisibility(8);
            }
            addView(this.f23478a[i10], w7.y5.c(-1.0f, -2));
        }
        this.d = new Matrix();
    ...
    public final void b(CharSequence charSequence, boolean z10) {
        final int i10;
        int i11 = this.h;
        TextView[] textViewArr = this.f23478a;
        ...
        if (!TextUtils.isEmpty(text) && z10) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    switch (r3) {
                        case 0:
                            d8 d8Var = this.f23214b;
                            d8Var.f23479b[i13] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            d8Var.invalidate();
                            return;
                        default:
                            d8 d8Var2 = this.f23214b;
                            d8Var2.f23479b[i13] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            d8Var2.invalidate();
                            return;
                    }
                }
            ...
            ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    switch (r3) {
                        case 0:
                            d8 d8Var = this.f23214b;
                            d8Var.f23479b[i10] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            d8Var.invalidate();
                            return;
                        default:
                            d8 d8Var2 = this.f23214b;
                            d8Var2.f23479b[i10] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            d8Var2.invalidate();
                            return;
                    }
                }
            ...
            this.f23482n.playTogether(ofFloat, ofFloat2, ofFloat3, ofFloat4);
            this.f23482n.start();
            return;
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (i12 > 0 && textViewArr[this.h].getAlpha() != 1.0f && textViewArr[this.h].getLayout() != null) {
            ...
            float primaryHorizontal2 = textViewArr[this.h].getLayout().getPrimaryHorizontal(this.f23484s);
        ...
        float f10 = f7 + this.f23480c;
        Matrix matrix = this.d;
        matrix.setTranslate(f7, 0.0f);
        this.f23483r.setLocalMatrix(matrix);
        canvas.drawRect(f7, 0.0f, f10, min2, this.e);
        Paint paint = this.f23481f;
        if (min > f10) {
            canvas2 = canvas;
    ...
    public TextView getNextTextView() {
        ...
        return this.f23478a[c10];
    }

    public TextView getTextView() {
        return this.f23478a[this.h];
    }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        LinearGradient linearGradient = new LinearGradient(this.f23480c, 0.0f, 0.0f, 0.0f, 0, -16777216, Shader.TileMode.CLAMP);
        this.f23483r = linearGradient;
    ...
    public void setCustomPaddingRight(int i10) {
        ...
        this.f23485w = i10;
        for (TextView textView : this.f23478a) {
