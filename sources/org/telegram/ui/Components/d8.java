...
public abstract class d8 extends FrameLayout {
    public final TextView[] f22314a;
    public final float[] f22315b;
    public final int f22316c;
    public final Matrix d;
    public final Paint e;
    public final Paint f22317f;
    public int h;
    public AnimatorSet f22318n;
    public LinearGradient f22319r;
    public int f22320s;
    ...
    public d8(Context context) {
        super(context);
        this.f22314a = new TextView[2];
        this.f22315b = new float[]{0.0f, 0.75f};
        this.f22316c = AndroidUtilities.dp(24.0f);
        this.f22320s = -1;
        this.v = new RectF();
        for (int i10 = 0; i10 < 2; i10++) {
            this.f22314a[i10] = a();
            if (i10 == 1) {
                this.f22314a[i10].setAlpha(0.0f);
                this.f22314a[i10].setVisibility(8);
            }
            addView(this.f22314a[i10], w7.a6.c(-1.0f, -2));
        }
        this.d = new Matrix();
    ...
    public final void b(CharSequence charSequence, boolean z10) {
        final int i10;
        int i11 = this.h;
        TextView[] textViewArr = this.f22314a;
        ...
        if (!TextUtils.isEmpty(text) && z10) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    switch (r3) {
                        case 0:
                            d8 d8Var = this.f22039b;
                            d8Var.f22315b[i13] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            d8Var.invalidate();
                            return;
                        default:
                            d8 d8Var2 = this.f22039b;
                            d8Var2.f22315b[i13] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            d8Var2.invalidate();
                            return;
                    }
                }
            ...
            ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    switch (r3) {
                        case 0:
                            d8 d8Var = this.f22039b;
                            d8Var.f22315b[i10] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            d8Var.invalidate();
                            return;
                        default:
                            d8 d8Var2 = this.f22039b;
                            d8Var2.f22315b[i10] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            d8Var2.invalidate();
                            return;
                    }
                }
            ...
            this.f22318n.playTogether(ofFloat, ofFloat2, ofFloat3, ofFloat4);
            this.f22318n.start();
            return;
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (i12 > 0 && textViewArr[this.h].getAlpha() != 1.0f && textViewArr[this.h].getLayout() != null) {
            ...
            float primaryHorizontal2 = textViewArr[this.h].getLayout().getPrimaryHorizontal(this.f22320s);
        ...
        float f10 = f7 + this.f22316c;
        Matrix matrix = this.d;
        matrix.setTranslate(f7, 0.0f);
        this.f22319r.setLocalMatrix(matrix);
        canvas.drawRect(f7, 0.0f, f10, min2, this.e);
        Paint paint = this.f22317f;
        if (min > f10) {
            canvas2 = canvas;
    ...
    public TextView getNextTextView() {
        ...
        return this.f22314a[c10];
    }

    public TextView getTextView() {
        return this.f22314a[this.h];
    }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        LinearGradient linearGradient = new LinearGradient(this.f22316c, 0.0f, 0.0f, 0.0f, 0, -16777216, Shader.TileMode.CLAMP);
        this.f22319r = linearGradient;
    ...
    public void setCustomPaddingRight(int i10) {
        ...
        this.f22321w = i10;
        for (TextView textView : this.f22314a) {
