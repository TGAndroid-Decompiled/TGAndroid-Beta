...
public final class ge implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        Object obj2 = this.f24440i;
        Object obj3 = this.h;
        switch (i10) {
            case 0:
                ChatActivityEnterView chatActivityEnterView = (ChatActivityEnterView) obj3;
                int i11 = ChatActivityEnterView.f21952n5;
                sd sdVar = new sd(chatActivityEnterView, (TLRPC.Document) obj2, this.f24439g, (MessageObject.SendAnimationData) this.f24441j, this.f24437c, this.d, this.e, this.f24436b, (Long) obj, this.f24438f);
            ...
            default:
                hg hgVar = (hg) obj3;
                sd sdVar2 = new sd(hgVar, this.f24436b, (MediaController.PhotoEntry) obj2, this.f24437c, this.d, this.e, this.f24438f, (Long) obj, this.f24439g, this.f24441j);
                if (!hgVar.f24764a.r1(sdVar2)) {
                    sdVar2.run();
                    return;
                }
                return;
    ...
    public ge(ChatActivityEnterView chatActivityEnterView, TLRPC.Document document, String str, MessageObject.SendAnimationData sendAnimationData, boolean z10, int i10, int i11, Object obj, boolean z11) {
        ...
        this.f24440i = document;
        this.f24439g = str;
        this.f24441j = sendAnimationData;
        this.f24437c = z10;
        this.d = i10;
        this.e = i11;
        this.f24436b = obj;
