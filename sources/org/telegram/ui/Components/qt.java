...
public class qt extends View {
    public final t01 f27759a;
    public final Drawable f27760b;
    public final ImageReceiver f27761c;
    public final Rect d;
    ...
    public qt(Context context, CharSequence charSequence) {
        ...
        this.f27761c = imageReceiver;
        imageReceiver.setRoundRadius(AndroidUtilities.dp(22.66f));
        this.f27759a = new t01(charSequence, 14.0f, AndroidUtilities.bold());
    ...
    public final void a(TLRPC.Photo photo, Object obj) {
        ...
        this.f27761c.setImage(ImageLocation.getForPhoto(closestPhotoSizeWithSize, photo), "24_24", ImageLocation.getForPhoto(closestPhotoSizeWithSize2, photo), "24_24", 0L, null, obj, 0);
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.f27761c.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f27761c.onDetachedFromWindow();
    }
    ...
    public final void onDraw(Canvas canvas) {
        float f7;
        int dp;
        ImageReceiver imageReceiver = this.f27761c;
        ...
        int dp2 = AndroidUtilities.dp(19.0f) + ((int) Math.ceil(this.f27759a.f28364c)) + AndroidUtilities.dp(f7);
        ...
        ch.d dVar = this.f27762f;
        if (dVar != null) {
            dVar.setBounds(rect);
            this.f27762f.draw(canvas);
        }
        if (hasBitmapImage) {
            float f10 = height;
        ...
        this.f27759a.c(width + dp, height, 1.0f, -1, canvas);
        Drawable drawable = this.f27760b;
    ...
    public void setImage(Bitmap bitmap) {
        this.f27761c.setImageBitmap(bitmap);
        invalidate();
    }
