...
public class qt extends View {
    public final t01 f27758a;
    public final Drawable f27759b;
    public final ImageReceiver f27760c;
    public final Rect d;
    ...
    public qt(Context context, CharSequence charSequence) {
        ...
        this.f27760c = imageReceiver;
        imageReceiver.setRoundRadius(AndroidUtilities.dp(22.66f));
        this.f27758a = new t01(charSequence, 14.0f, AndroidUtilities.bold());
    ...
    public final void a(TLRPC.Photo photo, Object obj) {
        ...
        this.f27760c.setImage(ImageLocation.getForPhoto(closestPhotoSizeWithSize, photo), "24_24", ImageLocation.getForPhoto(closestPhotoSizeWithSize2, photo), "24_24", 0L, null, obj, 0);
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.f27760c.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f27760c.onDetachedFromWindow();
    }
    ...
    public final void onDraw(Canvas canvas) {
        float f7;
        int dp;
        ImageReceiver imageReceiver = this.f27760c;
        ...
        int dp2 = AndroidUtilities.dp(19.0f) + ((int) Math.ceil(this.f27758a.f28363c)) + AndroidUtilities.dp(f7);
        ...
        ch.d dVar = this.f27761f;
        if (dVar != null) {
            dVar.setBounds(rect);
            this.f27761f.draw(canvas);
        }
        if (hasBitmapImage) {
            float f10 = height;
        ...
        this.f27758a.c(width + dp, height, 1.0f, -1, canvas);
        Drawable drawable = this.f27759b;
    ...
    public void setImage(Bitmap bitmap) {
        this.f27760c.setImageBitmap(bitmap);
        invalidate();
    }
