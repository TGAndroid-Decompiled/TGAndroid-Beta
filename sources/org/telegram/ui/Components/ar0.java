...
public final class ar0 extends View {
    public Random f22746a;
    public Paint f22747b;
    public Paint f22748c;
    public Paint d;
    public Paint e;
    public float f22749f;
    public float h;
    public float f22750n;

    @Override
    public final void onDraw(Canvas canvas) {
        float f7;
        Paint paint = this.f22748c;
        Paint paint2 = this.f22747b;
        super.onDraw(canvas);
        ...
        float f12 = (this.f22750n * interpolation) + ((1.0f - interpolation) * this.h);
        canvas.save();
        ...
        float f15 = this.f22749f + 0.016f;
        this.f22749f = f15;
        if (f15 > 1.0f) {
            this.h = this.f22750n;
            float e = org.telegram.ui.Cells.c1.e(this.f22746a, 1001) / 1000.0f;
            this.f22750n = e;
            if (e > this.h) {
                this.f22750n = e + 0.3f;
            } else {
            ...
            this.f22750n = Math.max(0.0f, Math.min(1.0f, this.f22750n));
            this.f22749f = 0.0f;
        }
        invalidate();
    }
