...
public abstract class po0 extends View.AccessibilityDelegate {
    public static final String f27412c = "android.widget.SeekBar";
    public final HashMap f27413a = new HashMap(4);
    public final ai.u2 f27414b = new ai.u2(this, 9);
    ...
    public void e(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
        accessibilityNodeInfo.setClassName(f27412c);
        CharSequence d = d();
        ...
        if (view != null) {
            ...
            if (view.isAttachedToWindow()) {
                ...
                if (runnable == null) {
                    ...
                    view.addOnAttachStateChangeListener(this.f27414b);
                } else {
