...
public final class mg0 extends m20 {
    ...
    public final boolean a() {
        ...
        if (photoViewer != null) {
            if ((photoViewer.F2 != null || og0Var.f27064r != null) && !og0Var.f27052c0 && !og0Var.Y && !og0Var.f27066w && !og0Var.f27065s.isInProgress() && og0Var.f27056f0) {
                long l4 = og0Var.l();
                long m10 = og0Var.m();
        ...
        if (og0Var.E) {
            for (int i10 = 1; i10 < og0Var.e.getChildCount(); i10++) {
                ...
                if (childAt.dispatchTouchEvent(motionEvent)) {
                    og0Var.f27068y = childAt;
                    return true;
                }
            }
        }
        this.f26487a = og0Var.K;
        this.f26488b = og0Var.L;
        return true;
    }
    ...
    public final boolean onFling(MotionEvent motionEvent, MotionEvent motionEvent2, float f7, float f10) {
        ...
        float f11;
        og0 og0Var = this.d;
        if (og0Var.f27066w && !og0Var.f27067x) {
            o1.k kVar = og0Var.M;
            kVar.f15523a = f7;
            float f12 = og0Var.K;
            kVar.f15524b = f12;
    ...
    public final boolean onScroll(MotionEvent motionEvent, MotionEvent motionEvent2, float f7, float f10) {
        float dp;
        og0 og0Var = this.d;
        if (!og0Var.f27066w && og0Var.F == null && !og0Var.f27067x) {
        ...
        if (og0Var.f27066w) {
            float f12 = og0Var.K;
            float rawX = (motionEvent2.getRawX() + this.f26487a) - motionEvent.getRawX();
            og0Var.L = (motionEvent2.getRawY() + this.f26488b) - motionEvent.getRawY();
            int i10 = og0Var.H;
            if (rawX > (-i10) * 0.25f && rawX < AndroidUtilities.displaySize.x - (i10 * 0.75f)) {
                boolean z10 = og0Var.f27053d0;
                if (z10) {
                    if (z10) {
