...
public final class ao extends LinearLayout {
    public final org.telegram.ui.ActionBar.f6 f23479a;
    public final TextView f23480b;
    public final ArrayList f23481c;
    ...
    public ao(Activity activity, View view, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        int i15 = org.telegram.ui.ActionBar.j6.f19845a;
        ...
        if (i10 == 0) {
            ...
            imageView.d();
            addView((View) imageView, k7.b6.t(-2, -2, 49, 0, 2, 0, 0));
        }
        ...
        addView(textView3, k7.b6.t(-2, -2, i16, 0, 8, 0, i12));
        for (int i17 = 0; i17 < 4; i17++) {
            ...
            addView(h, k7.b6.t(-2, -2, i13, 0, 8, 0, 0));
            ImageView imageView2 = new ImageView(activity);
            int i18 = org.telegram.ui.ActionBar.j6.ic;
            imageView2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i18, this.f23479a), PorterDuff.Mode.MULTIPLY));
            if (i10 == 0) {
            ...
            textView4.setTextColor(org.telegram.ui.ActionBar.j6.v0(i18, this.f23479a));
            this.f23481c.add(textView4);
            if (LocaleController.isRTL) {
                i14 = 5;
            } else {
                i14 = 3;
            ...
            if (LocaleController.isRTL) {
                ...
                if (i10 == 0) {
                    h.addView(imageView2, k7.b6.k(8.0f, 3.0f, 0.0f, 0.0f, -2, -2));
                } else if (i10 == 2) {
                    h.addView(imageView2, k7.b6.k(8.0f, 7.0f, 0.0f, 0.0f, -2, -2));
                } else {
                    h.addView(imageView2, k7.b6.k(8.0f, 3.0f, 0.0f, 0.0f, -2, -2));
                }
            } else {
                if (i10 == 0) {
                    h.addView(imageView2, k7.b6.k(0.0f, 4.0f, 8.0f, 0.0f, -2, -2));
                } else if (i10 == 2) {
                    h.addView(imageView2, k7.b6.k(0.0f, 8.0f, 8.0f, 0.0f, -2, -2));
                } else {
                    h.addView(imageView2, k7.b6.k(0.0f, 4.0f, 8.0f, 0.0f, -2, -2));
                }
                h.addView(textView4, k7.b6.n(-2, -2));
    ...
    public void setStatusText(CharSequence charSequence) {
        this.f23480b.setText(charSequence);
    }
    ...
    public void setTextColor(int i10) {
        ...
        int i12 = 0;
        while (true) {
            ArrayList arrayList = this.f23481c;
        ...
        while (true) {
            ...
            if (i11 < arrayList2.size()) {
                ((ImageView) arrayList2.get(i11)).setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.ic, this.f23479a), PorterDuff.Mode.MULTIPLY));
                i11++;
            } else {
                return;
            }
