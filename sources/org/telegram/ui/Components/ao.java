...
public final class ao implements n8 {
    public final org.telegram.ui.ActionBar.n1[] f22683a;
    public final eo f22684b;

    public ao(eo eoVar, org.telegram.ui.ActionBar.n1[] n1VarArr) {
        this.f22684b = eoVar;
        this.f22683a = n1VarArr;
    }

    @Override
    public final void U0(int i10, int i11) {
        int i12;
        org.telegram.ui.zn znVar = this.f22684b.G;
        if (znVar != null) {
    ...
    public final void dismiss() {
        org.telegram.ui.ActionBar.n1 n1Var = this.f22683a[0];
        if (n1Var != null) {
            n1Var.dismiss();
        }
    }
