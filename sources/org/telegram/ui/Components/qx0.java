...
public final class qx0 extends kl0 {
    ...
    public int d;
    public final SparseArray f29834e = new SparseArray();
    public final SparseArray f29835f = new SparseArray();
    public int h;
    public int f29836n;
    public final ux0 f29837r;
    ...
    public final int j(int i10) {
        ux0 ux0Var = this.f29837r;
        if (ux0Var.W != null) {
            Object obj = this.f29834e.get(i10);
            if (obj != null) {
    ...
    public final void l() {
        ...
        if (ux0Var.W != null) {
            ...
            this.d = dp;
            ux0Var.M.y1(dp);
            SparseArray sparseArray = this.f29834e;
            sparseArray.clear();
            SparseArray sparseArray2 = this.f29835f;
            sparseArray2.clear();
            this.h = 0;
            this.f29836n = 0;
    ...
    public final void u(int i10) {
        ArrayList arrayList = this.f29837r.Y;
        if (arrayList != null) {
            this.h = arrayList.size();
        }
        super.u(i10);
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (arrayList != null) {
            ...
            ((org.telegram.ui.Cells.f8) view).d((TLRPC.Document) sparseArray.get(i10), null, this.f29835f.get(i10), null, false, false);
        } else if (ux0Var.X != null) {
            ((org.telegram.ui.Cells.f8) view).setSticker((SendMessagesHelper.ImportingSticker) ux0Var.Y.get(i10));
        } else if (c1Var.f45743f != 3) {
            org.telegram.ui.Cells.f8 f8Var = (org.telegram.ui.Cells.f8) view;
            TLRPC.TL_messages_stickerSet tL_messages_stickerSet = ux0Var.S;
            if (tL_messages_stickerSet != null) {
                f8Var.d(tL_messages_stickerSet.documents.get(i10), null, ux0Var.S, null, ux0Var.f31003h0, ux0Var.R);
        ...
        if (i10 == 0) {
            ...
            if (i10 != 1) {
                if (i10 == 2) {
                    ...
                    frameLayout2 = new org.telegram.ui.Cells.r3(8, this.f29833c, f6Var2, true, false);
                } else if (i10 == 3) {
