...
public final class qx0 extends FrameLayout {
    ...
    public boolean d;
    public final v9 e;
    public final ImageView f27690f;
    public final ai.p4 h;
    public final View f27691n;
    public boolean f27692r;
    public final int f27693s;
    public SvgHelper.SvgDrawable v;
    public boolean f27694w;
    public ValueAnimator f27695x;
    public float f27696y;
    ...
    public qx0(Context context, int i10) {
        ...
        if (i10 == 2) {
            ...
            this.f27690f = imageView;
            imageView.setScaleType(ImageView.ScaleType.CENTER_CROP);
            addView(imageView, w7.y5.e(24, 24, 17));
            this.f27691n = imageView;
        } else {
    ...
    public final void a(float f7) {
        ...
        boolean z10 = this.f27692r;
        View view = this.f27691n;
        if (z10) {
            if (i10 == 1) {
                f10 = 24.0f;
            } else {
