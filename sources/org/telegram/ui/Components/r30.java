...
public final class r30 extends o61 {
    ...
    public boolean Z;
    public final a0.i f27529a0;
    public final a0.i f27530b0;
    public boolean f27531c0;
    public boolean f27532d0;
    public final a0.i f27533e0;
    public final HashSet f27534f0;
    public org.telegram.ui.j30 f27535g0;
    public boolean f27536h0;
    public int f27537i0;
    public int f27538j0;
    public int f27539k0;
    public int f27540l0;
    ...
    public r30(Context context, int i10, TLRPC.Chat chat, TLRPC.ChatFull chatFull, a0.i iVar, HashSet hashSet) {
        ...
        this.f27529a0 = new a0.i();
        this.f27530b0 = new a0.i();
        setDimBehindAlpha(75);
        this.V = chat;
        this.W = chatFull;
        this.f27533e0 = iVar;
        this.f27534f0 = hashSet;
    ...
    public static void N(r30 r30Var, TLRPC.TL_error tL_error, TLObject tLObject, TLRPC.TL_channels_getParticipants tL_channels_getParticipants) {
        ...
        a0.i iVar2;
        boolean z10;
        yw0 yw0Var = r30Var.f26709s;
        a0.i iVar3 = r30Var.f27529a0;
        a0.i iVar4 = r30Var.f27530b0;
        ...
        if (tL_error == null) {
            ...
            while (i13 < size2) {
                ...
                if (iVar4.f(peerId) != null || ((iVar2 = r30Var.f27533e0) != null && iVar2.h(peerId) >= 0)) {
                    z10 = true;
                } else {
                    z10 = false;
                }
        ...
        if (r30Var.U <= 0) {
            r30Var.f27531c0 = false;
            r30Var.f27532d0 = true;
            if (r30Var.f27544q0 == 1) {
                i10 = 1;
            } else {
                kl0 kl0Var = r30Var.f26706f;
                if (kl0Var != null) {
                    i10 = kl0Var.h() - 1;
                } else {
                    i10 = 0;
            ...
            if (arrayList2.isEmpty()) {
                r30Var.f27536h0 = true;
                r30Var.S();
            }
        }
        r30Var.U();
        kl0 kl0Var2 = r30Var.f26706f;
        if (kl0Var2 != null) {
            kl0Var2.l();
            if (yw0Var != null && r30Var.f26706f.h() == 0 && r30Var.f27532d0) {
                yw0Var.e(false, true);
            }
        }
    }
    ...
    public final void E(MotionEvent motionEvent, ci.h2 h2Var) {
        org.telegram.ui.i60 i60Var = this.f27535g0.f34801a;
        if (!i60Var.f34500w0) {
    ...
    public final void G(String str) {
        ...
        c2Var.g(null, true, false, true, false, chat.f18112id, false, 2, -1);
        if (!TextUtils.isEmpty(str)) {
            r30Var.f26709s.e(true, true);
            w0Var.Y1 = false;
            w0Var.Z1 = 0;
            q30Var.l();
            w0Var.Y1 = true;
    ...
    public final void K() {
        ...
        this.K = org.telegram.ui.ActionBar.i6.f18880fg;
        this.L = org.telegram.ui.ActionBar.i6.f19139tg;
        this.M = org.telegram.ui.ActionBar.i6.f19028ng;
        this.N = org.telegram.ui.ActionBar.i6.f19047og;
        this.O = org.telegram.ui.ActionBar.i6.f18992lg;
        this.P = org.telegram.ui.ActionBar.i6.f19102rg;
        this.Q = org.telegram.ui.ActionBar.i6.f19011mg;
    }
    ...
    public final void S() {
        ...
        while (i10 < size) {
            ...
            if (tLObject instanceof TLRPC.TL_contact) {
                ...
                if (j10 == j3 || this.f27533e0.h(j10) >= 0 || this.f27534f0.contains(Long.valueOf(j10))) {
    ...
    public final void T() {
        ...
        if (!isChannel) {
            ...
            if (chatFull != null) {
                ...
                for (int i10 = 0; i10 < size; i10++) {
                    ...
                    if (j10 != j3 && ((iVar = this.f27533e0) == null || iVar.h(j10) < 0)) {
        ...
        this.f27531c0 = true;
        yw0 yw0Var = this.f26709s;
        if (yw0Var != null) {
            yw0Var.e(true, false);
        }
        kl0 kl0Var2 = this.f26706f;
        if (kl0Var2 != null) {
            kl0Var2.l();
        }
        ...
        tL_channels_getParticipants.filter.f18111q = "";
    ...
    public final void U() {
        ...
        if (ChatObject.isPublic(chat) || ChatObject.canUserDoAdminAction(chat, 3)) {
            int i10 = this.f27545r0;
            this.f27545r0 = i10 + 1;
            this.f27537i0 = i10;
        }
        if (!this.f27531c0 || this.f27532d0) {
            ArrayList arrayList = this.Y;
            if (!arrayList.isEmpty()) {
                int i11 = this.f27545r0;
                int i12 = i11 + 1;
                this.f27545r0 = i12;
                this.m0 = i11;
                this.f27541n0 = i12;
            ...
            if (!arrayList2.isEmpty()) {
                if (z10) {
                    int i13 = this.f27545r0;
                    this.f27545r0 = i13 + 1;
                    this.f27543p0 = i13;
                }
                int i14 = this.f27545r0;
                this.f27539k0 = i14;
        ...
        if (this.f27531c0) {
            int i15 = this.f27545r0;
            this.f27545r0 = i15 + 1;
            this.f27544q0 = i15;
        }
        int i16 = this.f27545r0;
        this.f27545r0 = i16 + 1;
        this.f27538j0 = i16;
    }
}
