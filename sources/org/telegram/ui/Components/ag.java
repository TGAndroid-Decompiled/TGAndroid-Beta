...
public final class ag implements Runnable {
    public final MessageObject f22387a;
    public final long f22388b;
    public final TL_keyboard.KeyboardButtonProto f22389c;
    public final MessageObject d;
    public final TLRPC.User e;
    public final ChatActivityEnterView f22390f;
    ...
    public ag(ChatActivityEnterView chatActivityEnterView, MessageObject messageObject, long j3, TL_keyboard.KeyboardButtonProto keyboardButtonProto, MessageObject messageObject2, TLRPC.User user) {
        this.f22390f = chatActivityEnterView;
        this.f22387a = messageObject;
        this.f22388b = j3;
        this.f22389c = keyboardButtonProto;
    ...
    public final void run() {
        ...
        ChatActivityEnterView chatActivityEnterView = this.f22390f;
        ...
        if (chatActivityEnterView.l1.R() <= AndroidUtilities.dp(20.0f) && !chatActivityEnterView.u0()) {
            if (boVar != null) {
                ...
                long j3 = this.f22387a.messageOwner.dialog_id;
                TL_keyboard.KeyboardButtonProto keyboardButtonProto = this.f22389c;
                ...
                if (messageObject != null) {
                    i10 = messageObject.messageOwner.f18130id;
                } else {
                    i10 = 0;
                }
                if (boVar == null) {
                ...
                ei.f5 b10 = ei.f5.b(i11, j3, this.f22388b, text, url, c10 ? 1 : 0, i10, N8, null, false, null, null, 0, false, false);
