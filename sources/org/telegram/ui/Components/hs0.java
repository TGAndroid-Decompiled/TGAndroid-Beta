...
public final class hs0 extends nz {
    ...
    public final vv0 D1(int i10) {
        ...
        if (adapter == kv0Var.O && !zu0VarArr[5].f30877a.isEmpty()) {
            document = ((MessageObject) zu0VarArr[5].f30877a.get(i10)).getDocument();
        } else {
            document = null;
        }
        vv0 vv0Var = this.X;
        ...
        if (document != null) {
            ...
            if (closestPhotoSizeWithSize != null && (i11 = closestPhotoSizeWithSize.f18321w) != 0 && (i12 = closestPhotoSizeWithSize.h) != 0) {
                vv0Var.f29776a = i11;
                vv0Var.f29777b = i12;
            }
