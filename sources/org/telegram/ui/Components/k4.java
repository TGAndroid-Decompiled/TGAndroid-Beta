...
public final class k4 extends m51 {
    ...
    public final void onClick(View view) {
        ...
        switch (this.e) {
            case 0:
                ((org.telegram.ui.ActionBar.n2) this.f25535f).dismissCurrentDialog();
                super.onClick(view);
                return;
            case 1:
                vx0 vx0Var = (vx0) this.f25535f;
            ...
            case 2:
                ...
                vc.a0((hg.v) this.f25535f).k(false).j();
                return;
            case 3:
                org.telegram.ui.t70 t70Var = ((org.telegram.ui.r70) this.f25535f).d;
                ...
                return;
            case 4:
                ((org.telegram.ui.wm0) this.f25535f).f39265a.dismissCurrentDialog();
                super.onClick(view);
                return;
            default:
                StickersActivity stickersActivity = (StickersActivity) this.f25535f;
