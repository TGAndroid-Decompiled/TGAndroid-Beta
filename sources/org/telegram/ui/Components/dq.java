...
public final class dq extends n6 {
    public final Rect f23378s;
    public Drawable v;
    public boolean f23379w;

    public dq(Context context) {
        super(context, false, false, false);
        this.f23378s = new Rect();
    }
    ...
    public final void onDraw(Canvas canvas) {
        if (this.v != null) {
            ...
            Rect rect = this.f23378s;
            rect.set(bounds);
            int ceil = (int) Math.ceil(getDrawable().d());
            if (getDrawable().f26070b == 3) {
                rect.right = rect.left + ceil;
            } else if (getDrawable().f26070b == 5) {
                rect.left = rect.right - ceil;
            } else if (getDrawable().f26070b == 17) {
