...
public final class k91 extends FrameLayout {
    ...
    public final g71 G;
    public final o91 H;
    public final ImageReceiver f25717a;
    public boolean f25718b;
    public final TextPaint f25719c;
    public StaticLayout d;
    public StaticLayout e;
    public final Paint f25720f;
    public final Paint h;
    public final Paint f25721n;
    public int f25722r;
    public int f25723s;
    public int v;
    public int f25724w;
    public boolean f25725x;
    public AnimatorSet f25726y;
    ...
    public k91(o91 o91Var, Context context) {
        ...
        this.f25721n = paint3;
        paint3.setColor(-1);
        this.f25717a = new ImageReceiver(this);
    }

    public final void a() {
        g71 g71Var = this.G;
        AndroidUtilities.cancelRunOnUIThread(g71Var);
        if (this.f25725x && this.H.f26995a.y()) {
            AndroidUtilities.runOnUIThread(g71Var, 3000L);
        }
    }

    public final void b(int i10) {
        if (this.f25723s != i10 && i10 >= 0 && !this.H.H) {
            this.f25723s = i10;
            StaticLayout staticLayout = new StaticLayout(AndroidUtilities.formatShortDuration(this.f25723s), this.f25719c, AndroidUtilities.dp(1000.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            this.d = staticLayout;
            if (staticLayout.getLineCount() > 0) {
                this.f25722r = (int) Math.ceil(this.d.getLineWidth(0));
            }
            invalidate();
        }
    }
    ...
    public final void c(int i10) {
        if (!this.f25718b && i10 >= 0 && !this.H.H) {
            this.v = i10;
            this.e = new StaticLayout(AndroidUtilities.formatShortDuration(this.v), this.f25719c, AndroidUtilities.dp(1000.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            invalidate();
        }
    }
    ...
    public final void d(boolean z10, boolean z11) {
        ...
        this.f25725x = z10;
        AnimatorSet animatorSet = this.f25726y;
        if (animatorSet != null) {
            animatorSet.cancel();
        }
        boolean z12 = this.f25725x;
        Property property = View.ALPHA;
        if (z12) {
            if (z11) {
                AnimatorSet animatorSet2 = new AnimatorSet();
                this.f25726y = animatorSet2;
                animatorSet2.playTogether(ObjectAnimator.ofFloat(this, property, 1.0f));
                this.f25726y.setDuration(150L);
                this.f25726y.addListener(new j91(this, 0));
                this.f25726y.start();
            } else {
                setAlpha(1.0f);
            }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (o91Var.P) {
            ...
            float f10 = o91Var.N;
            ImageReceiver imageReceiver = this.f25717a;
            imageReceiver.setAlpha(f10);
            imageReceiver.draw(canvas);
        }
        if (o91Var.f26995a.d != null && !o91Var.H) {
            ...
            if (!o91Var.U) {
                ...
                if (this.d != null) {
                    canvas.save();
                    float dp3 = (measuredWidth - AndroidUtilities.dp(58.0f)) - this.f25722r;
                    if (o91Var.T) {
                        i12 = 6;
                    } else {
                        i12 = 10;
            ...
            if (this.f25723s != 0) {
                ...
                if (o91Var.U) {
                    ...
                    i14 = AndroidUtilities.dp(36.0f) + this.f25722r;
                    measuredWidth = (measuredWidth - AndroidUtilities.dp(76.0f)) - this.f25722r;
                ...
                if (this.f25718b) {
                    ...
                    i10 = ((int) ((this.v / this.f25723s) * (measuredWidth - i14))) + i14;
                }
                int i16 = this.f25724w;
                if (i16 != 0 && (i11 = this.f25723s) != 0) {
                    float f12 = i14;
                    float f13 = dp;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (o91Var.T) {
            i10 = AndroidUtilities.dp(36.0f) + this.f25722r;
            measuredWidth = (getMeasuredWidth() - AndroidUtilities.dp(76.0f)) - this.f25722r;
        ...
        g71 g71Var = this.G;
        if (action == 0) {
            if (this.f25725x && !o91Var.U && !o91Var.H) {
                if (this.f25723s != 0) {
            ...
            if (motionEvent.getAction() == 2 && this.f25718b) {
                ...
                c((int) (((this.F - i10) / (measuredWidth - i10)) * this.f25723s * 1000));
                invalidate();
            }
        } else {
            if (o91Var.f27013w && s71Var.y()) {
                AndroidUtilities.runOnUIThread(g71Var, 3000L);
            }
            if (this.f25718b) {
                this.f25718b = false;
                if (o91Var.f27013w) {
                    int i15 = (int) (((this.F - i10) / (measuredWidth - i10)) * this.f25723s);
                    this.v = i15;
