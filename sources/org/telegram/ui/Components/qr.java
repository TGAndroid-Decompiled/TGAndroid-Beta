...
public final class qr implements Interpolator {
    public static final qr f27642f = new qr(0.25d, 0.1d, 0.25d, 1.0d);
    public static final qr f27643g = new qr(0.0d, 0.0d, 0.58d, 1.0d);
    public static final qr h = new qr(0.23d, 1.0d, 0.32d, 1.0d);
    public static final qr f27644i = new qr(0.42d, 0.0d, 1.0d, 1.0d);
    public static final qr f27645j = new qr(0.42d, 0.0d, 0.58d, 1.0d);
    public static final qr f27646k = new qr(0.34d, 1.56d, 0.64d, 1.0d);
    public static final PathInterpolator f27647l;
    public final PointF f27648a;
    public final PointF f27649b;
    ...
    public final float getInterpolation(float f7) {
        ...
        while (true) {
            pointF = this.f27649b;
            pointF2 = this.f27648a;
            pointF3 = this.f27650c;
            pointF4 = this.d;
            pointF5 = this.e;
            if (i10 >= 14) {
                break;
