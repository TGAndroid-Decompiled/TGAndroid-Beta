...
public final class qr implements Interpolator {
    public static final qr f27423f = new qr(0.25d, 0.1d, 0.25d, 1.0d);
    public static final qr f27424g = new qr(0.0d, 0.0d, 0.58d, 1.0d);
    public static final qr h = new qr(0.23d, 1.0d, 0.32d, 1.0d);
    public static final qr f27425i = new qr(0.42d, 0.0d, 1.0d, 1.0d);
    public static final qr f27426j = new qr(0.42d, 0.0d, 0.58d, 1.0d);
    public static final qr f27427k = new qr(0.34d, 1.56d, 0.64d, 1.0d);
    public static final PathInterpolator f27428l;
    public final PointF f27429a;
    public final PointF f27430b;
    public final PointF f27431c;
    ...
    public final float getInterpolation(float f7) {
        ...
        while (true) {
            pointF = this.f27430b;
            pointF2 = this.f27429a;
            pointF3 = this.f27431c;
            pointF4 = this.d;
            pointF5 = this.e;
            if (i10 >= 14) {
                break;
