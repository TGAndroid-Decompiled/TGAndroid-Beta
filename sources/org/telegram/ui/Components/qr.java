...
public final class qr implements Interpolator {
    public static final qr f27380f = new qr(0.25d, 0.1d, 0.25d, 1.0d);
    public static final qr f27381g = new qr(0.0d, 0.0d, 0.58d, 1.0d);
    public static final qr h = new qr(0.23d, 1.0d, 0.32d, 1.0d);
    public static final qr f27382i = new qr(0.42d, 0.0d, 1.0d, 1.0d);
    public static final qr f27383j = new qr(0.42d, 0.0d, 0.58d, 1.0d);
    public static final qr f27384k = new qr(0.34d, 1.56d, 0.64d, 1.0d);
    public static final PathInterpolator f27385l;
    public final PointF f27386a;
    public final PointF f27387b;
    public final PointF f27388c;
    ...
    public final float getInterpolation(float f7) {
        ...
        while (true) {
            pointF = this.f27387b;
            pointF2 = this.f27386a;
            pointF3 = this.f27388c;
            pointF4 = this.d;
            pointF5 = this.e;
            if (i10 >= 14) {
                break;
