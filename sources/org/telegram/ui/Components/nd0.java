...
public final class nd0 implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public final void onGlobalLayout() {
        ...
        int i13 = this.f26442a;
        int i14 = i11 - i13;
        int i15 = i14 * i14;
        int i16 = this.f26443b;
        int i17 = i12 - i16;
        int i18 = i17 * i17;
        ...
        while (i21 < childCount) {
            ...
            obj.f27008b = ((float) Math.sqrt(i22)) - AndroidUtilities.dp(40.0f);
            if (i21 != -1) {
            ...
            obj.f27007a.addListener(new jd0(animatorSet, 1));
            AnimatorSet animatorSet4 = obj.f27007a;
            if (i21 == -1) {
                j3 = 232;
            } else {
                j3 = 200;
            ...
            obj.f27007a.setInterpolator(new DecelerateInterpolator());
            arrayList3.add(obj);
            i21++;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                while (true) {
                    ...
                    if (i23 < arrayList4.size()) {
                        ...
                        if (pd0Var.f27008b <= animatedFraction) {
                            pd0Var.f27007a.start();
        ...
        animatorSet5.setInterpolator(qr.f27381g);
        animatorSet5.start();
    }
}
