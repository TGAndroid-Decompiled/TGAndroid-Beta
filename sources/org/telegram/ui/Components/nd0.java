...
public final class nd0 implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public final void onGlobalLayout() {
        ...
        while (i21 < childCount) {
            ...
            obj.f27018b = ((float) Math.sqrt(i22)) - AndroidUtilities.dp(40.0f);
            if (i21 != -1) {
            ...
            obj.f27017a.addListener(new jd0(animatorSet, 1));
            AnimatorSet animatorSet4 = obj.f27017a;
            if (i21 == -1) {
                j3 = 232;
            } else {
                j3 = 200;
            ...
            obj.f27017a.setInterpolator(new DecelerateInterpolator());
            arrayList3.add(obj);
            i21++;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                while (true) {
                    ...
                    if (i23 < arrayList4.size()) {
                        ...
                        if (pd0Var.f27018b <= animatedFraction) {
                            pd0Var.f27017a.start();
        ...
        animatorSet5.setInterpolator(qr.f27421g);
        animatorSet5.start();
    }
}
