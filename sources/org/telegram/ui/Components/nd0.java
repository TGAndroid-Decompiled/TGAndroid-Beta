...
public final class nd0 implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public final void onGlobalLayout() {
        ...
        while (i21 < childCount) {
            ...
            obj.f29382b = ((float) Math.sqrt(i22)) - AndroidUtilities.dp(40.0f);
            if (i21 != -1) {
            ...
            obj.f29381a.addListener(new r80(animatorSet, 4));
            AnimatorSet animatorSet4 = obj.f29381a;
            if (i21 == -1) {
                j3 = 232;
            } else {
                j3 = 200;
            ...
            obj.f29381a.setInterpolator(new DecelerateInterpolator());
            arrayList3.add(obj);
            i21++;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                while (true) {
                    ...
                    if (i23 < arrayList4.size()) {
                        ...
                        if (pd0Var.f29382b <= animatedFraction) {
                            pd0Var.f29381a.start();
        ...
        animatorSet5.setInterpolator(pr.f29495g);
        animatorSet5.start();
    }
}
