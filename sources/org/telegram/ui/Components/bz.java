...
public final class bz extends kl0 {
    ...
    public final HashMap f22888f = new HashMap();
    public final SparseArray h = new SparseArray();
    public final SparseArray f22889n = new SparseArray();
    public final SparseIntArray f22890r = new SparseIntArray();
    public int f22891s;
    public final kz v;
    ...
    public final boolean D(s4.c1 c1Var) {
        return c1Var.f42675a instanceof ll0;
    }

    public final int E(Object obj) {
        Integer num = (Integer) this.f22888f.get(obj);
        if (num == null) {
            return -1;
        }
        return num.intValue();
    ...
    public final int F(int i10) {
        ...
        if (!"search".equals(obj) && !"trend1".equals(obj) && !"trend2".equals(obj)) {
            ...
            int i12 = this.f22890r.get(i10, Integer.MIN_VALUE);
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i14 != 0) {
            ...
            if (i14 != 1) {
                ...
                if (i10 == kzVar.f25713f1) {
                    if (kzVar.f25716g1 && kzVar.f25719h1 == null) {
                        i11 = 0;
                    } else if (kzVar.f25719h1 != null) {
                        i11 = R.drawable.msg_mini_customize;
                    } else {
                        i11 = R.drawable.msg_close;
                    }
                    if (kzVar.J1 != null) {
                        chat = MessagesController.getInstance(i13).getChat(Long.valueOf(kzVar.J1.f18113id));
                    }
                ...
                if (obj instanceof TLRPC.TL_messages_stickerSet) {
                    ...
                    if (stickerSet != null) {
                        ...
                        if (tL_messages_stickerSet.set.creator && !kzVar.L2) {
                            o8Var2.setEdit(new View.OnClickListener(this) {
                                public final bz f22519b;
                                ...
                                public final void onClick(View view2) {
                                    switch (r3) {
                                        case 0:
                                            this.f22519b.v.f25756t1.d(tL_messages_stickerSet.set, null, true);
                                            return;
                                        default:
                                            this.f22519b.v.f25756t1.d(tL_messages_stickerSet.set, null, false);
                                            return;
                                    }
                                }
                            });
            ...
            if (i10 == this.f22891s) {
                int i17 = this.f22890r.get(i10 - 1, Integer.MIN_VALUE);
                ...
                if (obj2 instanceof TLRPC.TL_messages_stickerSet) {
                    ...
                    if ("recent".equals(obj2)) {
                        arrayList = kzVar.f25725j1;
                    } else {
                        arrayList = kzVar.f25728k1;
                    }
                }
                if (arrayList == null) {
                    k3Var.setHeight(1);
        ...
        f8Var.d(document, null, this.f22889n.get(i10), null, false, false);
        f8Var.setRecent(kzVar.f25725j1.contains(document));
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                break;
            case 2:
                org.telegram.ui.Cells.o8 o8Var = new org.telegram.ui.Cells.o8(this.f22887c, false, false, kzVar.Z1, kzVar.f25723i2);
                o8Var.setOnIconClickListener(new dt(2, this, o8Var));
                frameLayout = o8Var;
                break;
            case 3:
                ...
                linearLayout.f20502a = textView2;
                ...
                linearLayout.setAddOnClickListener(new View.OnClickListener(this) {
                    ...
                    public final void onClick(View view) {
                        switch (r2) {
                            case 0:
                                kz kzVar2 = this.f30672b.v;
                                ky kyVar = kzVar2.f25756t1;
                                if (kyVar != null) {
                                    kyVar.y(kzVar2.J1.f18113id);
                                    return;
                                }
                                return;
                            case 1:
                                kz kzVar3 = this.f30672b.v;
                                ArrayList<TLRPC.StickerSetCovered> featuredStickerSets = MediaDataController.getInstance(kzVar3.f25703c1).getFeaturedStickerSets();
                                if (!featuredStickerSets.isEmpty()) {
                                    MessagesController.getEmojiSettings(kzVar3.f25703c1).edit().putLong("featured_hidden", featuredStickerSets.get(0).set.f18139id).commit();
                                    bz bzVar = kzVar3.f25773y0;
                                    if (bzVar != null) {
                                        bzVar.t(1, 2);
                                    }
                                    kzVar3.Y(false);
                                ...
                                return;
                            default:
                                org.telegram.ui.ActionBar.n2 n2Var = this.f30672b.v.Y1;
            ...
            case 4:
                ...
                break;
            case 5:
                org.telegram.ui.Cells.o8 o8Var2 = new org.telegram.ui.Cells.o8(this.f22887c, false, false, kzVar.Z1, kzVar.f25723i2);
            ...
            case 7:
                ...
                linearLayout2.setBackground(org.telegram.ui.ActionBar.i6.b0(dp, org.telegram.ui.ActionBar.i6.l1(0.12f, kzVar.z(i11))));
