...
public final class bz extends kl0 {
    ...
    public int d;
    public final SparseArray f24852e = new SparseArray();
    public final HashMap f24853f = new HashMap();
    public final SparseArray h = new SparseArray();
    public final SparseArray f24854n = new SparseArray();
    public final SparseIntArray f24855r = new SparseIntArray();
    public int f24856s;
    public final kz v;
    ...
    public final boolean D(s4.c1 c1Var) {
        return c1Var.f45766a instanceof ll0;
    }

    public final int E(Object obj) {
        Integer num = (Integer) this.f24853f.get(obj);
        if (num == null) {
            return -1;
        }
        return num.intValue();
    ...
    public final int F(int i10) {
        ...
        if (!"search".equals(obj) && !"trend1".equals(obj) && !"trend2".equals(obj)) {
            ...
            int i12 = this.f24855r.get(i10, Integer.MIN_VALUE);
            if (i12 == Integer.MIN_VALUE) {
                indexOf = arrayList.size() - 1;
                i11 = kzVar.E1;
            } else {
                Object obj2 = this.f24852e.get(i12);
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i14 != 0) {
            ...
            if (i14 != 1) {
                ...
                if (i10 == kzVar.f27970f1) {
                    if (kzVar.f27973g1 && kzVar.f27976h1 == null) {
                        i11 = 0;
                    } else if (kzVar.f27976h1 != null) {
                        ...
                        if (tL_messages_stickerSet.set.creator && !kzVar.M2) {
                            o8Var2.setEdit(new View.OnClickListener(this) {
                                ...
                                public final void onClick(View view2) {
                                    switch (r3) {
                                        case 0:
                                            this.f24501b.v.f28013t1.d(tL_messages_stickerSet.set, null, true);
                                            return;
                                        default:
                                            this.f24501b.v.f28013t1.d(tL_messages_stickerSet.set, null, false);
                                            return;
                                    }
                                }
                            });
            ...
            if (i10 == this.f24856s) {
                int i17 = this.f24855r.get(i10 - 1, Integer.MIN_VALUE);
                if (i17 == Integer.MIN_VALUE) {
                    k3Var.setHeight(1);
                    return;
                }
                Object obj2 = this.f24852e.get(i17);
                if (obj2 instanceof TLRPC.TL_messages_stickerSet) {
                    arrayList = ((TLRPC.TL_messages_stickerSet) obj2).documents;
                } else if (obj2 instanceof String) {
                    if ("recent".equals(obj2)) {
                        arrayList = kzVar.f27982j1;
                    } else {
                        arrayList = kzVar.f27985k1;
                    }
                }
                if (arrayList == null) {
                    k3Var.setHeight(1);
        ...
        f8Var.d(document, null, this.f24854n.get(i10), null, false, false);
        f8Var.setRecent(kzVar.f27982j1.contains(document));
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                break;
            case 2:
                org.telegram.ui.Cells.o8 o8Var = new org.telegram.ui.Cells.o8(this.f24851c, false, false, kzVar.Z1, kzVar.f27980i2);
            ...
            case 3:
                ...
                linearLayout.f22394a = textView2;
                ...
                linearLayout.setAddOnClickListener(new View.OnClickListener(this) {
                    ...
                    public final void onClick(View view) {
                        switch (r2) {
                            case 0:
                                kz kzVar2 = this.f33282b.v;
                                ly lyVar = kzVar2.f28013t1;
                                if (lyVar != null) {
                                ...
                                return;
                            case 1:
                                kz kzVar3 = this.f33282b.v;
                                ArrayList<TLRPC.StickerSetCovered> featuredStickerSets = MediaDataController.getInstance(kzVar3.f27959c1).getFeaturedStickerSets();
                                if (!featuredStickerSets.isEmpty()) {
                                    MessagesController.getEmojiSettings(kzVar3.f27959c1).edit().putLong("featured_hidden", featuredStickerSets.get(0).set.f19923id).commit();
                                    bz bzVar = kzVar3.f28030y0;
                                    if (bzVar != null) {
                                        bzVar.t(1, 2);
                                    }
                                    kzVar3.Z(false);
                                ...
                                return;
                            default:
                                org.telegram.ui.ActionBar.n2 n2Var = this.f33282b.v.Y1;
            ...
            case 4:
                ...
                break;
            case 5:
                org.telegram.ui.Cells.o8 o8Var2 = new org.telegram.ui.Cells.o8(this.f24851c, false, false, kzVar.Z1, kzVar.f27980i2);
