...
public final class bz extends xl0 {
    ...
    public final HashMap f23118f = new HashMap();
    public final SparseArray h = new SparseArray();
    public final SparseArray f23119n = new SparseArray();
    public final SparseIntArray f23120r = new SparseIntArray();
    public int f23121s;
    public final kz v;
    ...
    public final boolean D(s4.c1 c1Var) {
        return c1Var.f42995a instanceof yl0;
    }

    public final int E(Object obj) {
        Integer num = (Integer) this.f23118f.get(obj);
        if (num == null) {
            return -1;
        }
        return num.intValue();
    ...
    public final int F(int i10) {
        ...
        int i11;
        kz kzVar = this.v;
        ArrayList arrayList = kzVar.f25861d1;
        ...
        if (!"search".equals(obj) && !"trend1".equals(obj) && !"trend2".equals(obj)) {
            ...
            int i12 = this.f23120r.get(i10, Integer.MIN_VALUE);
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i14 != 0) {
            ...
            if (i14 != 1) {
                ...
                if (i10 == kzVar.f25868f1) {
                    if (kzVar.f25871g1 && kzVar.f25874h1 == null) {
                        i11 = 0;
                    } else if (kzVar.f25874h1 != null) {
                        i11 = R.drawable.msg_mini_customize;
                    } else {
                        i11 = R.drawable.msg_close;
                    }
                    if (kzVar.J1 != null) {
                        chat = MessagesController.getInstance(i13).getChat(Long.valueOf(kzVar.J1.f18344id));
                    }
                        ...
                        if (tL_messages_stickerSet.set.creator && !kzVar.M2) {
                            p8Var2.setEdit(new View.OnClickListener(this) {
                                ...
                                public final void onClick(View view2) {
                                    switch (r3) {
                                        case 0:
                                            this.f22772b.v.f25911t1.d(tL_messages_stickerSet.set, null, true);
                                            return;
                                        default:
                                            this.f22772b.v.f25911t1.d(tL_messages_stickerSet.set, null, false);
                                            return;
                                    }
                                }
                            });
            ...
            if (i10 == this.f23121s) {
                int i17 = this.f23120r.get(i10 - 1, Integer.MIN_VALUE);
                ...
                if (obj2 instanceof TLRPC.TL_messages_stickerSet) {
                    ...
                    if ("recent".equals(obj2)) {
                        arrayList = kzVar.f25880j1;
                    } else {
                        arrayList = kzVar.f25883k1;
                    }
                }
                if (arrayList == null) {
                    m3Var.setHeight(1);
        ...
        g8Var.d(document, null, this.f23119n.get(i10), null, false, false);
        g8Var.setRecent(kzVar.f25880j1.contains(document));
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                break;
            case 2:
                org.telegram.ui.Cells.p8 p8Var = new org.telegram.ui.Cells.p8(this.f23117c, false, false, kzVar.Z1, kzVar.f25878i2);
            ...
            case 3:
                ...
                linearLayout.f20793a = textView2;
                ...
                linearLayout.setAddOnClickListener(new View.OnClickListener(this) {
                    ...
                    public final void onClick(View view) {
                        switch (r2) {
                            case 0:
                                kz kzVar2 = this.f30975b.v;
                                ly lyVar = kzVar2.f25911t1;
                                if (lyVar != null) {
                                    lyVar.y(kzVar2.J1.f18344id);
                                    return;
                                }
                                return;
                            case 1:
                                kz kzVar3 = this.f30975b.v;
                                ArrayList<TLRPC.StickerSetCovered> featuredStickerSets = MediaDataController.getInstance(kzVar3.f25858c1).getFeaturedStickerSets();
                                if (!featuredStickerSets.isEmpty()) {
                                    MessagesController.getEmojiSettings(kzVar3.f25858c1).edit().putLong("featured_hidden", featuredStickerSets.get(0).set.f18370id).commit();
                                    bz bzVar = kzVar3.f25928y0;
                                    if (bzVar != null) {
                                        bzVar.t(1, 2);
                                    }
                                    kzVar3.X(false);
                                ...
                                return;
                            default:
                                org.telegram.ui.ActionBar.n2 n2Var = this.f30975b.v.Y1;
            ...
            case 4:
                ...
                break;
            case 5:
                org.telegram.ui.Cells.p8 p8Var2 = new org.telegram.ui.Cells.p8(this.f23117c, false, false, kzVar.Z1, kzVar.f25878i2);
