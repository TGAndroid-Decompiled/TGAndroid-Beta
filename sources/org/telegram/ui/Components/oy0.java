...
public final class oy0 {
    public final org.telegram.ui.ActionBar.d6 f26882a;
    public StaticLayout f26883b;
    public final ArrayList f26884c = new ArrayList(2);
    public int d;
    public int e;
    public int f26885f;
    public int f26886g;
    ...
    public final void b(MessageObject messageObject) {
        ...
        org.telegram.ui.ActionBar.d6 d6Var = this.f26882a;
        if (d6Var != null) {
        ...
        this.f26886g = AndroidUtilities.dp(14.0f) * 2;
        ...
        while (i16 < size) {
            ...
            i16++;
            ny0 ny0Var = (ny0) obj;
            f10 = Math.max(f10, ny0Var.f26540a.l());
            f11 = Math.max(f11, ny0Var.f26541b.l());
            int j3 = ((int) ny0Var.f26540a.j()) + this.f26886g;
            this.f26886g = j3;
            this.f26886g = AndroidUtilities.dp(7.0f) + j3;
        }
        ...
        this.f26883b = new StaticLayout(AndroidUtilities.replaceTags(spannableStringBuilder), textPaint, max, Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
        int i30 = 0;
        for (int i31 = 0; i31 < this.f26883b.getLineCount(); i31++) {
            i30 = (int) Math.max(i30, this.f26883b.getLineWidth(i31));
        }
        int height = this.f26883b.getHeight() + this.f26886g;
        this.f26886g = height;
        this.f26886g = AndroidUtilities.dp(5.0f) + height;
        int D = org.telegram.messenger.z0.D(24.0f, 2, Math.max(dp, i30));
        this.h = D;
        this.d = (D - max) / 2;
        this.e = (D - dp) / 2;
        this.f26885f = (int) (AndroidUtilities.dp(f7) + i15 + f10);
    }
}
