...
public final class qy extends nz {
    ...
    public final jv0 D1(int i10) {
        ...
        if (adapter == pyVar2) {
            int i11 = pyVar2.H;
            if (i10 > i11) {
                TLRPC.BotInlineResult botInlineResult = (TLRPC.BotInlineResult) pyVar2.f27195x.get((i10 - i11) - 1);
                ...
                document2 = (TLRPC.Document) kzVar.f25722i1.get(i10);
                arrayList = document2.attributes;
                return F1(document2, arrayList);
            }
        } else if (!pyVar.f27195x.isEmpty()) {
            TLRPC.BotInlineResult botInlineResult2 = (TLRPC.BotInlineResult) pyVar.f27195x.get(i10);
    ...
    public final jv0 F1(TLRPC.Document document, List list) {
        ...
        if (document != null && (closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(document.thumbs, 90)) != null && (i10 = closestPhotoSizeWithSize.f18137w) != 0 && (i11 = closestPhotoSizeWithSize.h) != 0) {
            jv0Var.f25443a = i10;
            jv0Var.f25444b = i11;
        }
        if (list != null) {
