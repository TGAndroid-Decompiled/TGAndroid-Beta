...
public final class qy extends vl0 {
    ...
    public int h;
    public TLRPC.User f27778n;
    public String f27779r;
    public boolean f27780s;
    public boolean v;
    public String f27781w;
    public final ArrayList f27782x = new ArrayList();
    public final HashMap f27783y = new HashMap();
    public int I = -1;
    public int J = -1;
    ...
    public final void E(String str, String str2, boolean z10, boolean z11, boolean z12, String str3, TLObject tLObject) {
        boolean z13;
        if (str != null && str.equals(this.f27781w)) {
            this.h = 0;
            ...
            HashMap hashMap = this.f27783y;
            boolean z14 = this.d;
            ArrayList arrayList = this.f27782x;
            lz lzVar = this.L;
            if (!z14 && TextUtils.isEmpty(str2)) {
                arrayList.clear();
                hashMap.clear();
                lzVar.f26264o0.e(false);
            }
            if (tLObject instanceof TLRPC.messages_BotResults) {
                int size = arrayList.size();
                TLRPC.messages_BotResults messages_botresults = (TLRPC.messages_BotResults) tLObject;
                HashMap hashMap2 = lzVar.f26256l0;
                qy qyVar = lzVar.f26261n0;
                if (!hashMap2.containsKey(str3)) {
                    lzVar.f26256l0.put(str3, messages_botresults);
                }
                if (!z12 && messages_botresults.cache_time != 0) {
                    MessagesStorage.getInstance(lzVar.f26229c1).saveBotCache(str3, messages_botresults);
                }
                this.f27779r = messages_botresults.next_offset;
                int i10 = 0;
                for (int i11 = 0; i11 < messages_botresults.results.size(); i11++) {
                    ...
                    if (!hashMap.containsKey(botInlineResult.f18319id)) {
                        botInlineResult.query_id = messages_botresults.query_id;
                        arrayList.add(botInlineResult);
                        hashMap.put(botInlineResult.f18319id, botInlineResult);
                        i10++;
                    }
                }
                if (size != arrayList.size() && !TextUtils.isEmpty(this.f27779r)) {
                    z13 = false;
                } else {
                    z13 = true;
                }
            ...
            if (!z14) {
                if (lzVar.f26244h0.getAdapter() != this) {
                    lzVar.f26244h0.setAdapter(this);
                }
    ...
    public final void F(final String str, final String str2, final boolean z10, final boolean z11, final boolean z12) {
        ...
        if (i10 != 0) {
            if (i10 >= 0) {
                ConnectionsManager.getInstance(lzVar.f26229c1).cancelRequest(this.h, true);
            }
            this.h = 0;
        }
        this.f27781w = str;
        ...
        HashMap hashMap = lzVar.f26256l0;
        ...
        this.f27778n = (TLRPC.User) userOrChat;
        ...
        if (z12 && hashMap.containsKey(j3)) {
        ...
        } else if (lzVar.f26253k0.f28632a.contains(j3)) {
        } else {
            if (z12) {
                this.h = -1;
            ...
            tL_messages_getInlineBotResults.bot = MessagesController.getInstance(i12).getInputUser(this.f27778n);
    ...
    public final void G(String str, boolean z10) {
        ...
        if (!this.d) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                if (currentPosition != lzVar.f26274r0 && currentPosition != lzVar.f26278s0) {
                    H(MessagesController.getInstance(lzVar.f26229c1).gifSearchEmojies.get(currentPosition - lzVar.f26281t0));
                    return;
                }
            ...
            if (!TextUtils.isEmpty(lowerCase)) {
                ...
                AndroidUtilities.runOnUIThread(cvVar2, j3);
            }
        }
    }

    public final void H(String str) {
        if (this.v && TextUtils.equals(this.f27781w, str)) {
            this.L.f26247i0.h1(0, 0);
        } else {
    ...
    public final void l() {
        int i10;
        if (this.d && (i10 = this.f27777f) != 0) {
            lz lzVar = this.L;
            if (i10 == Integer.MAX_VALUE) {
                this.H = lzVar.f26248i1.size();
            } else {
                ow owVar = lzVar.f26244h0;
                ry ryVar = lzVar.f26247i0;
                if (owVar.getMeasuredWidth() != 0) {
                    int measuredWidth = lzVar.f26244h0.getMeasuredWidth();
                    int i11 = ryVar.J;
                    int dp = AndroidUtilities.dp(100.0f);
                    this.H = 0;
                    int size = lzVar.f26248i1.size();
                    int i12 = i11;
                    int i13 = 0;
                    int i14 = 0;
                    for (int i15 = 0; i15 < size; i15++) {
                        TLRPC.Document document = (TLRPC.Document) lzVar.f26248i1.get(i15);
                        uv0 C1 = oz.C1(ryVar.F1(document, document.attributes));
                        int min = Math.min(i11, (int) Math.floor((((C1.f28926a / C1.f28927b) * dp) / measuredWidth) * i11));
                        if (i12 < min) {
                            this.H += i13;
                            i14++;
                            if (i14 == i10) {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        org.telegram.ui.Cells.f2 f2Var = (org.telegram.ui.Cells.f2) c1Var.f42946a;
        int i11 = this.J;
        if (i11 >= 0 && i10 >= i11) {
            f2Var.e((TLRPC.BotInlineResult) this.f27782x.get(i10 - i11), this.f27778n, true, false, false, true);
            return;
        }
        TLRPC.Document document = (TLRPC.Document) this.L.f26248i1.get(i10);
        f2Var.getClass();
        ...
        if (i10 != 0) {
            ...
            if (i10 != 1) {
                if (i10 != 2) {
                    ...
                    org.telegram.ui.Cells.o8 o8Var2 = new org.telegram.ui.Cells.o8(this.f27776c, false, false, lzVar.Z1, lzVar.f26249i2);
                ...
                view2.setLayoutParams(new s4.p0(-1, lzVar.f26225b1));
                o8Var = view2;
            }
        } else {
            org.telegram.ui.Cells.f2 f2Var = new org.telegram.ui.Cells.f2(this.f27776c);
