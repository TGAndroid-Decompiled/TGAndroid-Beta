...
public final class hg0 extends mw0 {
    ...
    public final Paint f24662b = new Paint(1);
    public final int f24663c = UserConfig.selectedAccount;
    public long d = 0;
    public boolean e = false;
    public final RectF f24664f = new RectF();
    public float f24665g;
    public final boolean h;
    public final org.telegram.ui.ActionBar.f6 f24666i;
    ...
    public final void draw(Canvas canvas) {
        ...
        boolean z10 = this.h;
        if (z10) {
            i10 = org.telegram.ui.ActionBar.j6.f19084p9;
        } else {
            i10 = org.telegram.ui.ActionBar.j6.f19085pa;
        }
        int v02 = org.telegram.ui.ActionBar.j6.v0(i10, this.f24666i);
        Paint paint = this.f24662b;
        paint.setColor(v02);
        RectF rectF = this.f24664f;
        rectF.set(0.0f, i12, dp, i12 + dp);
        float f10 = this.f24665g;
        if (f10 < 0.5f) {
        ...
        if (z10) {
            ...
            i11 = org.telegram.ui.ActionBar.j6.f19139s8;
        }
    ...
    public final void f() {
        if (this.e) {
            if (!NotificationCenter.getInstance(this.f24663c).isAnimationInProgress()) {
                ...
                if (this.f24665g >= 1.0f) {
                    this.f24665g = 0.0f;
                }
                float f7 = (((float) j3) / 300.0f) + this.f24665g;
                this.f24665g = f7;
                if (f7 > 1.0f) {
                    this.f24665g = 1.0f;
                }
