...
public abstract class sb extends FrameLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (ocVar != null && ocVar.f26752k) {
            ...
            if (bVar.f43741c == null) {
                bVar.a(getMeasuredWidth(), getMeasuredHeight(), 6.0f, AndroidUtilities.dp(10.0f));
            }
            this.blurVisibilityDrawable.f43744i = w7.p.b((int) org.telegram.messenger.vl.v(this.inOutOffset, getMeasuredHeight(), 1.0f, 255.0f), 0, 255);
    ...
    public void dispatchDrawImpl(Canvas canvas, boolean z10, int i10) {
        ...
        if (this.bulletin != null && i10 != 0) {
            ...
            if (isTransitionRunning() && (mbVar = this.delegate) != null) {
                float h = mbVar.h(this.bulletin.f26745a) - getY();
                float measuredHeight = (((View) getParent()).getMeasuredHeight() - getBottomOffset()) - getY();
                if (!z10 && this.delegate.g(this.bulletin.f26745a)) {
                    z11 = true;
                } else {
                    z11 = false;
                }
    ...
    public float getBottomOffset() {
        ...
        oc ocVar;
        o1.k kVar;
        if (this.bulletin != null && (((mbVar = this.delegate) == null || mbVar.e()) && (kVar = (ocVar = this.bulletin).d) != null && kVar.f15342f)) {
            f7 = ocVar.f26756o;
        } else {
    ...
    public void onDetach() {
        ...
        uh.b bVar = this.blurVisibilityDrawable;
        if (bVar != null && (bitmap = bVar.f43741c) != null) {
            bitmap.recycle();
            bVar.f43741c = null;
        }
    }
