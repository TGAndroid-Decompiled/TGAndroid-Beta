...
public final class rd implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final ChatActivityEnterView f27943b;

    public rd(ChatActivityEnterView chatActivityEnterView, int i10) {
        this.f27942a = i10;
        this.f27943b = chatActivityEnterView;
    }

    @Override
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        int i10 = this.f27942a;
        ChatActivityEnterView chatActivityEnterView = this.f27943b;
        switch (i10) {
            case 0:
            ...
            case 4:
                ...
                chatActivityEnterView.f22065w0 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
            ...
            case 6:
                ...
                if (!chatActivityEnterView.f21954c1) {
                    chatActivityEnterView.f21985h1.setAlpha(chatActivityEnterView.N1.getTransformToSeekbarProgressStep3());
                    chatActivityEnterView.f21985h1.invalidate();
                }
            ...
            default:
                ...
                chatActivityEnterView.f22066w1.setScaleX(AndroidUtilities.lerp(0.6f, 1.0f, floatValue));
                chatActivityEnterView.f22066w1.setScaleY(AndroidUtilities.lerp(0.6f, 1.0f, floatValue));
                chatActivityEnterView.f22066w1.setAlpha(floatValue);
                return;
        }
    }
}
