...
public final class rd implements Runnable {
    ...
    public final Long h;
    public final String f30015n;
    public final Object f30016r;
    public final Object f30017s;
    ...
    public final void run() {
        ...
        switch (this.f30010a) {
            case 0:
                ChatActivityEnterView.g((ChatActivityEnterView) this.f30016r, (TLRPC.Document) this.f30017s, this.f30015n, (MessageObject.SendAnimationData) this.v, this.f30012c, this.d, this.f30013e, this.f30011b, this.h, this.f30014f);
                return;
            default:
                MediaController.PhotoEntry photoEntry = (MediaController.PhotoEntry) this.f30017s;
                ChatActivityEnterView chatActivityEnterView = ((hg) this.f30016r).f26730a;
                ...
                boolean z14 = this.f30012c;
                int i10 = this.d;
                int i11 = this.f30013e;
                Long l4 = this.h;
                int i12 = i10;
                String str3 = this.f30015n;
                Object obj2 = this.v;
                if (z13) {
    ...
    public rd(ChatActivityEnterView chatActivityEnterView, TLRPC.Document document, String str, MessageObject.SendAnimationData sendAnimationData, boolean z10, int i10, int i11, Object obj, Long l4, boolean z11) {
        this.f30016r = chatActivityEnterView;
        this.f30017s = document;
        this.f30015n = str;
