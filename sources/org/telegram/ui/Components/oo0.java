...
public class oo0 extends ScrollView {
    public final org.telegram.ui.ActionBar.f6 f27163a;
    public final LinearLayout f27164b;
    public final float f27165c;
    public final float[] d;
    public final float[] e;
    public final ArrayList f27166f;
    public final ArrayList h;
    public final Path f27167n;

    public oo0(Context context, LinearLayout linearLayout, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        super(context);
        float f7;
        this.f27165c = AndroidUtilities.dp(16.0f);
        this.f27166f = new ArrayList();
        this.h = new ArrayList();
        this.f27167n = new Path();
        this.f27163a = f6Var;
        this.f27164b = linearLayout;
    ...
    public final void a(Canvas canvas, View view, View view2) {
        ...
        if (view != null && view2 != null) {
            ...
            float f10 = 0.0f;
            LinearLayout linearLayout = this.f27164b;
            ...
            if (rectF.bottom >= rectF.top) {
                yl0.P0(canvas, rectF, AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f), view.getAlpha(), this.f27163a);
            }
        }
    }
            ...
            if (childAt.getVisibility() == 0) {
                if (childAt instanceof LinearLayout) {
                    ...
                    if (linearLayout.getOrientation() == 1) {
                        LinearLayout linearLayout2 = this.f27164b;
    ...
    public final float c(View view) {
        if (view != this.f27164b && (view.getParent() instanceof View)) {
    ...
    public final void onScrollChanged(int i10, int i11, int i12, int i13) {
        ...
        ArrayList arrayList = this.f27166f;
        int size = arrayList.size();
        int i14 = 0;
        while (i14 < size) {
