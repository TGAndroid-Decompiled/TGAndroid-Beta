...
public abstract class kn0 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.d6 f25764f;

    public kn0(Context context, float f7, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f25764f = d6Var;
