...
public class lx0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public float I;
    public boolean J;
    public final dc1 f26251a;
    public final v9 f26252b;
    public final RadialProgressView f26253c;
    public final vh.n d;
    public final n90 e;
    public final ci.d f26254f;
    public boolean h;
    public final org.telegram.ui.ActionBar.f6 f26255n;
    public int f26256r;
    public final View f26257s;
    public int v;
    public final int f26258w;
    public boolean f26259x;
    public final org.telegram.ui.Cells.u6 f26260y;
    ...
    public final void b(int i10, boolean z10) {
        if (this.v != i10) {
            ...
            float f7 = i12 + i11;
            RadialProgressView radialProgressView = this.f26253c;
            dc1 dc1Var = this.f26251a;
            if (z10) {
    ...
    public final void c() {
        ...
        int i10;
        int i11 = this.f26256r;
        v9 v9Var = this.f26252b;
        if (i11 != 0) {
            boolean z10 = true;
            if (i11 != 1) {
                ...
                if (i11 == 16) {
                    ...
                    if (stickerSetByName != null && (i10 = this.f26256r) >= 0 && i10 < stickerSetByName.documents.size()) {
                        document2 = stickerSetByName.documents.get(this.f26256r);
                    }
    ...
    public void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f26258w).addObserver(this, NotificationCenter.diceStickersDidLoad);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f26258w).removeObserver(this, NotificationCenter.diceStickersDidLoad);
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if ((this.E || this.f26259x) && (i14 = this.F) > 0 && i14 != getMeasuredHeight()) {
            float measuredHeight = (this.F - getMeasuredHeight()) / 2.0f;
            dc1 dc1Var = this.f26251a;
            dc1Var.setTranslationY(dc1Var.getTranslationY() + measuredHeight);
            if (!this.f26259x) {
                dc1Var.animate().translationY(0.0f).setInterpolator(qr.f27653f).setDuration(250L);
            }
            RadialProgressView radialProgressView = this.f26253c;
            if (radialProgressView != null) {
                radialProgressView.setTranslationY(radialProgressView.getTranslationY() + measuredHeight);
                if (!this.f26259x) {
                    radialProgressView.animate().translationY(0.0f).setInterpolator(qr.f27653f).setDuration(250L);
                }
            }
        }
    ...
    public void setPreventMoving(boolean z10) {
        this.f26259x = z10;
        if (!z10) {
            this.f26251a.setTranslationY(0.0f);
            RadialProgressView radialProgressView = this.f26253c;
            if (radialProgressView != null) {
    ...
    public lx0(Context context, View view, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f26258w = UserConfig.selectedAccount;
        this.f26260y = new org.telegram.ui.Cells.u6(this, 25);
        this.G = org.telegram.ui.ActionBar.j6.f19092c7;
        this.f26255n = f6Var;
        this.f26257s = view;
        this.f26256r = i10;
        ...
        if (view == null) {
            ...
            this.f26253c = radialProgressView;
            radialProgressView.setAlpha(0.0f);
            radialProgressView.setScaleY(0.5f);
            radialProgressView.setScaleX(0.5f);
