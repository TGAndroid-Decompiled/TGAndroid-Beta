...
public final class lx0 extends Drawable {
    ...
    public final q5[] f26216c;
    public final boolean e;
    public int d = 255;
    public final RectF f26217f = new RectF();
    ...
    public lx0(int i10, ArrayList arrayList, boolean z10) {
        ...
        for (int i12 = 0; i12 < this.f26215b; i12++) {
            this.f26216c[i12] = q5.m(i10, i11, (TLRPC.Document) arrayList.get(i12));
        }
    }

    public final void a(org.telegram.ui.Cells.u1 u1Var) {
        for (int i10 = 0; i10 < this.f26215b; i10++) {
            this.f26216c[i10].o(u1Var);
        }
    }
