...
public final class m11 extends ll0 {
    ...
    public ArrayList f26007f = new ArrayList();
    public wm h;
    public String f26008n;
    public final ThemeEditorView.EditorAlert f26009r;

    public m11(ThemeEditorView.EditorAlert editorAlert, Context context) {
        this.f26009r = editorAlert;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (c1Var.f42700f == 0) {
            ...
            if (l6Var.f19383f == org.telegram.ui.ActionBar.j6.Nd) {
                b10 = 0;
            } else {
                b10 = l6Var.b();
            }
            org.telegram.ui.Cells.z8 z8Var = (org.telegram.ui.Cells.z8) c1Var.f42697a;
            z8Var.f21714a.setText((CharSequence) this.f26007f.get(i11));
            z8Var.f21715b = b10;
            if (b10 != 0) {
                z10 = false;
            }
