...
public final class sv0 extends View {
    ...
    public final qv0 f30448a;
    public final Paint f30449b;
    ...
    public float f30457x;
    public float f30458y;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            Paint paint = this.f30449b;
            if (i13 < length) {
                int i14 = this.f30453n;
                int i15 = (this.h * 2) + this.f30454r;
                int i16 = this.f30452f;
                ...
                paint.setColor(d11);
                Paint paint2 = this.f30450c;
                paint2.setColor(d11);
                float f16 = dp3;
                canvas2.drawCircle(i17, f16, AndroidUtilities.lerp(this.f30452f / 2, AndroidUtilities.dp(6.0f), max), paint);
                if (i13 != 0) {
                    int i19 = (i17 - (this.f30452f / 2)) - this.h;
                    int i20 = this.f30454r;
                    int i21 = i19 - i20;
                    int i22 = this.f30455s;
                    if (i22 != -1 && i13 - 1 >= i22) {
                ...
                int d12 = i0.a.d(max, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f21070y6, f6Var), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20874n6, f6Var));
                ...
                int i24 = (this.h * 2) + this.f30454r;
                int i25 = this.f30452f;
                float f18 = ((i24 + i25) * d) + this.f30453n + (i25 / 2);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        this.f30448a.e(this, accessibilityNodeInfo);
    }

    @Override
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(74.0f), 1073741824));
        this.f30452f = AndroidUtilities.dp(6.0f);
        this.h = AndroidUtilities.dp(2.0f);
        this.f30453n = AndroidUtilities.dp(22.0f);
        int measuredWidth = getMeasuredWidth();
        int i12 = this.f30452f;
        String[] strArr = this.F;
        this.f30454r = (((measuredWidth - (i12 * strArr.length)) - ((strArr.length - 1) * (this.h * 2))) - (this.f30453n * 2)) / Math.max(1, strArr.length - 1);
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        float a2 = w7.p.a(((this.f30452f / 2.0f) + (x10 - this.f30453n)) / (((this.h * 2) + this.f30454r) + i10), 0.0f, this.F.length - 1);
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (!this.v && Math.abs(this.f30457x - x10) > Math.abs(this.f30458y - y3)) {
                getParent().requestDisallowInterceptTouchEvent(true);
            }
            if (this.f30456w && Math.abs(this.f30457x - x10) >= AndroidUtilities.touchSlop) {
                this.v = true;
                this.f30456w = false;
            }
            if (this.v) {
    ...
    public final boolean performAccessibilityAction(int i10, Bundle bundle) {
        if (!super.performAccessibilityAction(i10, bundle) && !this.f30448a.g(this, i10, bundle)) {
            return false;
        }
        return true;
    }
