...
public final class fi extends hi {
    public TLRPC.User f26923b;
    public TLRPC.TL_attachMenuBot f26924c;
    public final mi d;
    ...
    public fi(mi miVar, Context context) {
        ...
        bVar.f();
        this.f27492a = bVar;
        bVar.getBackupImageView().f29998a.setDelegate(new k2(11));
        addView(this.f27492a, k7.c6.c(-1.0f, -1));
    }

    public final void a(boolean z4) {
        boolean z10;
        if (this.f26924c != null && (-this.f26923b.f20990id) == this.d.T0) {
            z10 = true;
        } else {
            z10 = false;
        }
        this.f27492a.e(z10, z4);
        ij0 lottieAnimation = this.f27492a.getBackupImageView().getImageReceiver().getLottieAnimation();
        if (z4) {
