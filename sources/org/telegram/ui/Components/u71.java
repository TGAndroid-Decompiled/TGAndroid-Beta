...
public abstract class u71 extends View {
    public static final Object f31532c0 = new Object();
    public t71 B;
    ...
    public final z5 W;
    public long f31533a;
    public final Path f31534a0;
    public int f31535b;
    public boolean f31536b0;
    public int f31537c;
    public float d;
    ...
    public float f31542s;
    public float v;
    public boolean f31543w;
    public ParcelFileDescriptor f31544x;
    public MediaMetadataRetriever f31545y;
    ...
    public u71(Context context) {
        ...
        this.V = paint6;
        this.W = new z5(0.0f, this, 0L, 200L, pr.f30171j);
        this.f31534a0 = new Path();
        paint.setColor(-1);
        paint2.setColor(-256);
    ...
    public final void a() {
        Bitmap bitmap;
        synchronized (f31532c0) {
            try {
                ParcelFileDescriptor parcelFileDescriptor = this.f31544x;
            ...
            try {
                MediaMetadataRetriever mediaMetadataRetriever = this.f31545y;
        ...
        for (int i10 = 0; i10 < this.C.size(); i10++) {
            ...
            if (s71Var != null && (bitmap = s71Var.f30998a) != null) {
                bitmap.recycle();
            }
        }
        this.C.clear();
    ...
    public final void d(int i10) {
        ...
        if (i10 == 0) {
            ...
            int i12 = this.f31535b;
            if (i12 != 0 && (i11 = this.f31537c) != 0) {
                f10 = i12 / i11;
            } else {
                f10 = 1.0f;
            }
    ...
    public long getLength() {
        return Math.max(1L, this.f31533a);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float dp2 = AndroidUtilities.dp(10.0f) + dpf2 + ((int) ((measuredWidth - AndroidUtilities.dp(20.0f)) * this.f31538e));
        float dp3 = AndroidUtilities.dp(6.0f);
        float dp4 = dp3 + AndroidUtilities.dp(38.0f);
        ArrayList arrayList = this.C;
        boolean isEmpty = arrayList.isEmpty();
        Path path = this.f31534a0;
            ...
            if (!z4) {
                ...
                while (true) {
                    if (i10 >= arrayList.size()) {
                        break;
                    } else if (((s71) arrayList.get(i10)).f30998a == null) {
                        this.f31536b0 = true;
                        break;
                    } else {
                        i10++;
            ...
            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                ...
                if (bitmap != null) {
                    ...
                    if (f18 != 1.0f) {
                        ...
                        Paint paint = this.N;
                        paint.setAlpha((int) (pr.h.getInterpolation(s71Var.f30999b) * 255.0f));
        ...
        if (d > 0.0f) {
            c(this.f31538e, d, canvas2, paint3);
        }
        c(this.f31542s, 1.0f - d, canvas2, paint3);
        if (this.f31543w) {
            c(this.f31539f, 1.0f, canvas2, this.R);
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent != null) {
            ...
            int dp2 = AndroidUtilities.dp(22.0f) + ((int) (this.f31542s * f10));
            int dp3 = AndroidUtilities.dp(22.0f) + ((int) (this.f31538e * f10));
            if (motionEvent.getAction() == 0) {
                ...
                if (motionEvent.getAction() == 2) {
                    if (this.f31541r) {
                        ...
                        t71 t71Var6 = this.B;
                        if (t71Var6 != null) {
                            float f13 = this.f31542s;
                            com.google.android.gms.common.api.internal.v vVar2 = (com.google.android.gms.common.api.internal.v) t71Var6;
                        ...
                        this.d = dp8;
                        float f14 = this.f31538e;
                        float f15 = f14 - dp8;
                        float f16 = this.I;
                        if (f15 > f16) {
                            this.f31538e = dp8 + f16;
                        } else {
                            float f17 = this.J;
                            if (f17 != 0.0f && f15 < f17) {
                                float f18 = f14 - f17;
                        ...
                        float f19 = this.d;
                        float f20 = this.f31542s;
                        if (f19 > f20) {
                            this.f31542s = f19;
                        } else {
                            float f21 = this.f31538e;
                            if (f21 < f20) {
                                this.f31542s = f21;
                            }
                        }
                        t71 t71Var7 = this.B;
                        if (t71Var7 != null) {
                            com.google.android.gms.common.api.internal.v vVar3 = (com.google.android.gms.common.api.internal.v) t71Var7;
                        ...
                        float f27 = this.d;
                        float f28 = this.f31542s;
                        if (f27 > f28) {
                            this.f31542s = f27;
                        } else {
                            float f29 = this.f31538e;
                            if (f29 < f28) {
                                this.f31542s = f29;
                            }
                        }
                        t71 t71Var8 = this.B;
                        if (t71Var8 != null) {
                            ((com.google.android.gms.common.api.internal.v) t71Var8).h(this.f31538e);
                        }
                        invalidate();
                        return true;
                    }
                ...
                t71 t71Var9 = this.B;
                if (t71Var9 != null) {
                    ((com.google.android.gms.common.api.internal.v) t71Var9).g(0);
                }
                this.h = false;
                return true;
            } else if (this.f31540n) {
                t71 t71Var10 = this.B;
                if (t71Var10 != null) {
                    ((com.google.android.gms.common.api.internal.v) t71Var10).g(1);
                }
                this.f31540n = false;
                return true;
            } else if (this.f31541r) {
                t71 t71Var11 = this.B;
                if (t71Var11 != null) {
                    ((com.google.android.gms.common.api.internal.v) t71Var11).g(2);
                }
                this.f31541r = false;
            }
            return true;
    ...
    public void setMaxProgressDiff(float f10) {
        this.I = f10;
        float f11 = this.f31538e;
        float f12 = this.d;
        if (f11 - f12 > f10) {
            this.f31538e = f12 + f10;
            invalidate();
        }
    }
    ...
    public void setProgress(float f10) {
        float f11 = 0.0f;
        if (this.f31543w && (f10 <= 0.0f || f10 >= 1.0f)) {
            f10 = this.f31539f;
        }
        ...
        float f12 = this.f31542s;
        if (f10 < f12 && f10 <= this.d + f11 && f12 + f11 >= this.f31538e) {
            this.W.d(1.0f, true);
        }
        this.f31542s = f10;
        invalidate();
    ...
    public void setRightProgress(float f10) {
        ...
        t71 t71Var2 = this.B;
        if (t71Var2 != null) {
            ((com.google.android.gms.common.api.internal.v) t71Var2).h(this.f31538e);
        }
        t71 t71Var3 = this.B;
        if (t71Var3 != null) {
