...
public final class rd0 implements Runnable {
    ...
    public final void run() {
        ...
        ce0 ce0Var = this.f27953b;
        switch (i10) {
            case 0:
                EditTextBoldCursor editTextBoldCursor = ce0Var.f23325r;
                if (ce0Var.f23328x.getVisibility() != 0 && editTextBoldCursor != null) {
