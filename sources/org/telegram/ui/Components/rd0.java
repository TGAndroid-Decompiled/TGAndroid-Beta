...
public final class rd0 extends FrameLayout {
    public Bitmap f27894a;
    public HashMap f27895b;
            ...
            for (int i13 = 0; i13 < size; i13++) {
                ...
                if (b10 == 0) {
                    ...
                    if (z10) {
                        ...
                        if (z11) {
                            imageReceiver.setDelegate(new ga0(8));
                        }
                    }
                ...
                if (w9Var != null) {
                    ...
                    this.f27895b.put(w9Var, mediaEntity);
                }
            }
        }
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (this.f27895b != null) {
            ...
            for (int i17 = 0; i17 < childCount; i17++) {
                ...
                VideoEditedInfo.MediaEntity mediaEntity = (VideoEditedInfo.MediaEntity) this.f27895b.get(childAt);
                if (mediaEntity != null) {
