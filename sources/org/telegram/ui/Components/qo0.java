...
public final class qo0 extends kl0 {
    public final org.telegram.ui.ActionBar.f6 f29786c;
    public final List d;
    public final MessagesController f29787e;
    ...
    public qo0(org.telegram.ui.ActionBar.f6 f6Var, List list, MessagesController messagesController, int i10, TLRPC.Peer peer) {
        this.f29786c = f6Var;
        this.d = list;
        this.f29787e = messagesController;
        this.f29788f = i10;
        this.h = peer;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        MessagesController messagesController = this.f29787e;
        boolean z10 = true;
        if (j3 < 0) {
            ...
            if (chat != null) {
                if (tL_sendAsPeer.premium_required) {
                    ...
                    TextView textView = uo0Var.f30933b;
                    sb2.append((Object) TextUtils.ellipsize(str2, textView.getPaint(), this.f29788f - AndroidUtilities.dp(100.0f), TextUtils.TruncateAt.END));
                    sb2.append(" d");
                    ...
                    uo0Var.f30933b.setEllipsize(TextUtils.TruncateAt.END);
                    uo0Var.f30933b.setText(chat.title);
                }
                TextView textView2 = uo0Var.f30934c;
                ...
                uo0Var.f30932a.setAvatar(chat);
            }
            ev0 ev0Var = uo0Var.f30932a;
        ...
        if (user != null) {
            uo0Var.f30933b.setText(UserObject.getUserName(user));
            uo0Var.f30934c.setText(LocaleController.getString(R.string.VoipGroupPersonalAccount));
            uo0Var.f30932a.setAvatar(user);
        }
        ev0 ev0Var2 = uo0Var.f30932a;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        return new s4.c1(new uo0(viewGroup.getContext(), this.f29786c));
    }
}
