...
public final class qo0 extends kl0 {
    public final org.telegram.ui.ActionBar.e6 f27409c;
    public final List d;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (j3 < 0) {
            ...
            if (chat != null) {
                if (tL_sendAsPeer.premium_required) {
                    ...
                    TextView textView = uo0Var.f28478b;
                    sb2.append((Object) TextUtils.ellipsize(str2, textView.getPaint(), this.f27410f - AndroidUtilities.dp(100.0f), TextUtils.TruncateAt.END));
                    sb2.append(" d");
                    ...
                    uo0Var.f28478b.setEllipsize(TextUtils.TruncateAt.END);
                    uo0Var.f28478b.setText(chat.title);
                }
                TextView textView2 = uo0Var.f28479c;
        ...
        if (user != null) {
            uo0Var.f28478b.setText(UserObject.getUserName(user));
            uo0Var.f28479c.setText(LocaleController.getString(R.string.VoipGroupPersonalAccount));
            uo0Var.f28477a.setAvatar(user);
        }
        fv0 fv0Var2 = uo0Var.f28477a;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        return new s4.c1(new uo0(viewGroup.getContext(), this.f27409c));
    }
}
