...
public abstract class wc0 extends aw0 implements r0.m, View.OnLayoutChangeListener {
    ...
    public int B0;
    public boolean C0;
    public final b2.q0 f29948w0;
    public View f29949x0;
    public vc0 f29950y0;
    public org.telegram.ui.ActionBar.c3 f29951z0;

    public wc0(Context context) {
        super(context, null);
        this.f29948w0 = new Object();
    }

    public void E(ViewGroup viewGroup, int i10, int i11, int[] iArr, int i12) {
        vc0 vc0Var;
        int max;
        if (viewGroup == this.f29949x0 && (vc0Var = this.f29950y0) != null && ((org.telegram.ui.s7) vc0Var).getListView() != null) {
            int top = this.f29950y0.getTop();
            if (i11 < 0) {
                if (top <= this.A0) {
                    wl0 listView = ((org.telegram.ui.s7) this.f29950y0).getListView();
                    ...
                    return;
                } else if (this.f29951z0 != null && !this.f29949x0.canScrollVertically(i11)) {
                    this.f29951z0.onNestedScroll(viewGroup, 0, 0, i10, i11);
                    return;
                } else {
                    return;
                }
            }
            org.telegram.ui.ActionBar.c3 c3Var = this.f29951z0;
            if (c3Var != null) {
    ...
    public final void a0(vc0 vc0Var, int i10) {
        this.B0 = i10;
        if (this.f29950y0 != vc0Var) {
            this.f29950y0 = vc0Var;
    ...
    public final void b0() {
        View view = this.f29949x0;
        if (view != null && this.f29950y0 != null) {
            if (this.B0 != 0) {
                this.A0 = view.getPaddingTop() + this.B0;
            } else {
                this.A0 = (view.getMeasuredHeight() - this.f29949x0.getPaddingBottom()) - this.f29950y0.getMeasuredHeight();
            }
        }
    }
    ...
    public void j(ViewGroup viewGroup, int i10, int i11, int i12, int i13, int i14, int[] iArr) {
        ...
        if (viewGroup == this.f29949x0 && (vc0Var = this.f29950y0) != null && ((org.telegram.ui.s7) vc0Var).getListView() != null) {
            wl0 listView = ((org.telegram.ui.s7) this.f29950y0).getListView();
            if (this.f29950y0.getTop() == this.A0) {
                iArr[1] = i13;
