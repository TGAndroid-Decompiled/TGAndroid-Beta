...
public final class wc0 extends Canvas {
    public Canvas f30024a;

    @Override
    public final boolean clipOutPath(Path path) {
        if (Build.VERSION.SDK_INT >= 26) {
            return this.f30024a.clipOutPath(path);
        }
        return false;
    }
    ...
    public final boolean clipOutRect(float f7, float f10, float f11, float f12) {
        if (Build.VERSION.SDK_INT >= 26) {
            return this.f30024a.clipOutRect(f7, f10, f11, f12);
        }
        return false;
    }
    ...
    public final boolean clipPath(Path path) {
        return this.f30024a.clipPath(path);
    }
    ...
    public final void drawVertices(Canvas.VertexMode vertexMode, int i10, float[] fArr, int i11, float[] fArr2, int i12, int[] iArr, int i13, short[] sArr, int i14, int i15, Paint paint) {
        this.f30024a.drawVertices(vertexMode, i10, fArr, i11, fArr2, i12, iArr, i13, sArr, i14, i15, paint);
    }

    @Override
    public final void enableZ() {
        if (Build.VERSION.SDK_INT >= 29) {
            this.f30024a.enableZ();
        }
    }

    @Override
    public final boolean getClipBounds(Rect rect) {
        return this.f30024a.getClipBounds(rect);
    }

    @Override
    public final int getDensity() {
        return this.f30024a.getDensity();
    }

    @Override
    public final DrawFilter getDrawFilter() {
        return this.f30024a.getDrawFilter();
    }

    @Override
    public final int getHeight() {
        return this.f30024a.getHeight();
    }

    @Override
    public final void getMatrix(Matrix matrix) {
        this.f30024a.getMatrix(matrix);
    }

    @Override
    public final int getMaximumBitmapHeight() {
        return this.f30024a.getMaximumBitmapHeight();
    }

    @Override
    public final int getMaximumBitmapWidth() {
        return this.f30024a.getMaximumBitmapWidth();
    }

    @Override
    public final int getSaveCount() {
        return this.f30024a.getSaveCount();
    }

    @Override
    public final int getWidth() {
        return this.f30024a.getWidth();
    }

    @Override
    public final boolean isOpaque() {
        return this.f30024a.isOpaque();
    }

    @Override
    public final boolean quickReject(float f7, float f10, float f11, float f12) {
        if (Build.VERSION.SDK_INT >= 30) {
            return this.f30024a.quickReject(f7, f10, f11, f12);
        }
        return false;
    }
    ...
    public final void restore() {
        this.f30024a.restore();
    }

    @Override
    public final void restoreToCount(int i10) {
        this.f30024a.restoreToCount(i10);
    }

    @Override
    public final void rotate(float f7) {
        this.f30024a.rotate(f7);
    }

    @Override
    public final int save() {
        return this.f30024a.save();
    }

    @Override
    public final int saveLayer(float f7, float f10, float f11, float f12, Paint paint) {
        return this.f30024a.saveLayer(f7, f10, f11, f12, paint);
    }

    @Override
    public final int saveLayerAlpha(RectF rectF, int i10, int i11) {
        return this.f30024a.saveLayerAlpha(rectF, i10, i11);
    }

    @Override
    public final void scale(float f7, float f10) {
        this.f30024a.scale(f7, f10);
    }

    @Override
    public final void setBitmap(Bitmap bitmap) {
        this.f30024a.setBitmap(bitmap);
    }

    @Override
    public final void setDensity(int i10) {
        this.f30024a.setDensity(i10);
    }

    @Override
    public final void setDrawFilter(DrawFilter drawFilter) {
        this.f30024a.setDrawFilter(drawFilter);
    }

    @Override
    public final void setMatrix(Matrix matrix) {
        this.f30024a.setMatrix(matrix);
    }

    @Override
    public final void skew(float f7, float f10) {
        this.f30024a.skew(f7, f10);
    }

    @Override
    public final void translate(float f7, float f10) {
        this.f30024a.translate(f7, f10);
    }

    @Override
    public final boolean clipPath(Path path, Region.Op op) {
        return this.f30024a.clipPath(path, op);
    }
    ...
    public final void drawTextRun(MeasuredText measuredText, int i10, int i11, int i12, int i13, float f7, float f10, boolean z10, Paint paint) {
        this.f30024a.drawTextRun(measuredText, i10, i11, i12, i13, f7, f10, z10, paint);
    }

    @Override
    public final int saveLayer(RectF rectF, Paint paint) {
        return this.f30024a.saveLayer(rectF, paint);
    }

    @Override
    public final int saveLayerAlpha(float f7, float f10, float f11, float f12, int i10) {
        return this.f30024a.saveLayerAlpha(f7, f10, f11, f12, i10);
    }

    @Override
    public final boolean clipOutRect(int i10, int i11, int i12, int i13) {
        if (Build.VERSION.SDK_INT >= 26) {
            return this.f30024a.clipOutRect(i10, i11, i12, i13);
        }
        return false;
    }
    ...
    public final void drawBitmap(int[] iArr, int i10, int i11, float f7, float f10, int i12, int i13, boolean z10, Paint paint) {
        this.f30024a.drawBitmap(iArr, i10, i11, f7, f10, i12, i13, z10, paint);
    }

    @Override
    public final void drawColor(int i10, BlendMode blendMode) {
        if (Build.VERSION.SDK_INT >= 29) {
            this.f30024a.drawColor(i10, blendMode);
        }
    }
    ...
    public final void drawDoubleRoundRect(RectF rectF, float f7, float f10, RectF rectF2, float f11, float f12, Paint paint) {
        if (Build.VERSION.SDK_INT >= 29) {
            this.f30024a.drawDoubleRoundRect(rectF, f7, f10, rectF2, f11, f12, paint);
        }
    }
    ...
    public final void drawTextRun(CharSequence charSequence, int i10, int i11, int i12, int i13, float f7, float f10, boolean z10, Paint paint) {
        this.f30024a.drawTextRun(charSequence, i10, i11, i12, i13, f7, f10, z10, paint);
    }

    @Override
    public final boolean quickReject(RectF rectF) {
        if (Build.VERSION.SDK_INT >= 30) {
            return this.f30024a.quickReject(rectF);
        }
        return false;
    }
    ...
    public final int saveLayer(float f7, float f10, float f11, float f12, Paint paint, int i10) {
        return this.f30024a.saveLayer(f7, f10, f11, f12, paint, i10);
    }

    @Override
    public final int saveLayerAlpha(RectF rectF, int i10) {
        return this.f30024a.saveLayerAlpha(rectF, i10);
    }
    ...
    public final void drawBitmap(int[] iArr, int i10, int i11, int i12, int i13, int i14, int i15, boolean z10, Paint paint) {
        this.f30024a.drawBitmap(iArr, i10, i11, i12, i13, i14, i15, z10, paint);
    }

    @Override
    public final void drawText(CharSequence charSequence, int i10, int i11, float f7, float f10, Paint paint) {
        this.f30024a.drawText(charSequence, i10, i11, f7, f10, paint);
    }

    @Override
    public final int saveLayer(RectF rectF, Paint paint, int i10) {
        return this.f30024a.saveLayer(rectF, paint, i10);
    }

    @Override
    public final int saveLayerAlpha(float f7, float f10, float f11, float f12, int i10, int i11) {
        return this.f30024a.saveLayerAlpha(f7, f10, f11, f12, i10, i11);
    }

    @Override
    public final boolean clipOutRect(RectF rectF) {
        if (Build.VERSION.SDK_INT >= 26) {
            return this.f30024a.clipOutRect(rectF);
        }
        return false;
    }
    ...
    public final void drawBitmap(Bitmap bitmap, Rect rect, RectF rectF, Paint paint) {
        this.f30024a.drawBitmap(bitmap, rect, rectF, paint);
    }

    @Override
    public final void drawColor(int i10) {
        this.f30024a.drawColor(i10);
    }

    @Override
    public final boolean quickReject(Path path) {
        if (Build.VERSION.SDK_INT >= 30) {
            return this.f30024a.quickReject(path);
        }
        return false;
    }
    ...
    public final void drawBitmap(Bitmap bitmap, float f7, float f10, Paint paint) {
        this.f30024a.drawBitmap(bitmap, f7, f10, paint);
    }

    @Override
    public final void drawColor(int i10, PorterDuff.Mode mode) {
        this.f30024a.drawColor(i10, mode);
    }

    @Override
    public final boolean clipOutRect(Rect rect) {
        if (Build.VERSION.SDK_INT >= 26) {
            return this.f30024a.clipOutRect(rect);
        }
        return false;
    }
    ...
    public final void drawColor(long j3) {
        if (Build.VERSION.SDK_INT >= 29) {
            this.f30024a.drawColor(j3);
        }
    }

    @Override
    public final boolean quickReject(RectF rectF, Canvas.EdgeType edgeType) {
        return this.f30024a.quickReject(rectF, edgeType);
    }

    @Override
    public final boolean quickReject(Path path, Canvas.EdgeType edgeType) {
        return this.f30024a.quickReject(path, edgeType);
    }

    @Override
    public final boolean quickReject(float f7, float f10, float f11, float f12, Canvas.EdgeType edgeType) {
        return this.f30024a.quickReject(f7, f10, f11, f12, edgeType);
    }
}
