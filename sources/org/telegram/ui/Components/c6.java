...
public final class c6 {
    ...
    public final TextPaint f25805c;
    public ObjectAnimator d;
    public final org.telegram.ui.Cells.t1 f25808g;
    public final ArrayList f25803a = new ArrayList();
    public final ArrayList f25804b = new ArrayList();
    public float f25806e = 0.0f;
    public int f25807f = 1;

    public c6(org.telegram.ui.Cells.t1 t1Var, TextPaint textPaint) {
        this.f25805c = textPaint;
        this.f25808g = t1Var;
    }

    public final int a() {
        ArrayList arrayList = this.f25803a;
    ...
    public final void b(int i10, boolean z4) {
        ...
        ArrayList arrayList2 = this.f25803a;
        ...
        ArrayList arrayList3 = this.f25804b;
        arrayList3.clear();
        ...
        while (i13 < sb4.length()) {
            ...
            if (str != null && str.equals(substring)) {
                ...
                arrayList = arrayList3;
                arrayList2.add(new StaticLayout(substring, this.f25805c, (int) Math.ceil(textPaint.measureText(substring)), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false));
            }
            i13 = i14;
