...
public abstract class nb extends FrameLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (icVar != null && icVar.f25672k) {
            ...
            this.blurVisibilityDrawable.f7096i = k7.n.b((int) org.telegram.ui.b.c(this.inOutOffset, getMeasuredHeight(), 1.0f, 255.0f), 0, 255);
    ...
    public void dispatchDrawImpl(Canvas canvas, boolean z4, int i10) {
        ...
        if (this.bulletin != null && i10 != 0) {
            ...
            if (isTransitionRunning() && (fbVar = this.delegate) != null) {
                float h = fbVar.h(this.bulletin.f25665a) - getY();
                float measuredHeight = (((View) getParent()).getMeasuredHeight() - getBottomOffset()) - getY();
                if (!z4 && this.delegate.g(this.bulletin.f25665a)) {
                    z10 = true;
                } else {
                    z10 = false;
                }
    ...
    public float getBottomOffset() {
        ...
        ic icVar;
        o1.j jVar;
        if (this.bulletin != null && (((fbVar = this.delegate) == null || fbVar.e()) && (jVar = (icVar = this.bulletin).d) != null && jVar.f16172f)) {
            f10 = icVar.f25676o;
        } else {
    ...
    public void onDetach() {
        ...
        hh.b bVar = this.blurVisibilityDrawable;
        if (bVar != null && (bitmap = bVar.f7093c) != null) {
            bitmap.recycle();
            bVar.f7093c = null;
        }
    }
