...
public final class ox0 extends FrameLayout {
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            xx0 xx0Var = this.e;
            if (xx0Var.f30769b0 != 0 && motionEvent.getY() < xx0Var.f30769b0) {
                xx0Var.dismiss();
                return true;
            }
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) xx0Var.f30770c.getLayoutParams();
        int i23 = 3;
        if (arrayList != null) {
            ...
            if (xx0Var.T != null) {
                ...
                i17 = i19 + (xx0Var.d.f29066n * xx0Var.M) + size3;
        ...
        if (xx0Var.f30770c.getPaddingTop() != i20) {
            xx0Var.f30772d0 = true;
            xx0Var.f30770c.setPadding(AndroidUtilities.dp(10.0f), i20, AndroidUtilities.dp(10.0f), AndroidUtilities.dp(8.0f));
