    ...
    public final void onClick(View view) {
        ...
        switch (this.f27196a) {
            ...
            case 3:
                ...
                fy0Var2.f24270b0.d(fy0Var2.T, null, fy0Var2.S, null, fy0Var2.f24279i0, true, 0, 0);
                fy0Var2.dismiss();
                return;
            case 4:
                this.f27197b.f24283n.getPopupLayout().getSwipeBack().b(true);
                return;
            case 5:
                fy0 fy0Var3 = this.f27197b;
                org.telegram.ui.j70 j70Var = fy0Var3.f24273d0;
                org.telegram.ui.o70 o70Var = j70Var.f34661c;
                s4.c0 c0Var = o70Var.h;
                boolean z10 = o70Var.N;
                int L0 = c0Var.L0();
                gl0 gl0Var = (gl0) o70Var.d.K(L0);
                if (gl0Var != null) {
                    i10 = gl0Var.f42946a.getTop();
                } else {
                    i10 = Integer.MAX_VALUE;
                }
                int i11 = o70Var.f36046n;
                if (j70Var.f34659a) {
                    o70Var.f36047r = null;
                    o70Var.f36048s = true;
                } else {
                    o70Var.f36047r = j70Var.f34660b;
            ...
            case 12:
                ...
                return;
            case 13:
                fy0 fy0Var6 = this.f27197b;
                Context context = fy0Var6.getContext();
                int[] iArr = {0};
                FrameLayout frameLayout = new FrameLayout(context);
                AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(context);
                alertDialog$Builder.f18647a.R = LocaleController.getString(R.string.ImportStickersEnterName);
                ...
                f7.setTextColor(fy0Var6.getThemedColor(org.telegram.ui.ActionBar.h6.f19339t5));
                f7.setMaxLines(1);
                f7.setLines(1);
                ...
                editTextBoldCursor.setLineColors(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19357u5, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19375v5, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19284q7, false));
                editTextBoldCursor.setTextSize(1, 16.0f);
                editTextBoldCursor.setTextColor(fy0Var6.getThemedColor(org.telegram.ui.ActionBar.h6.f19151j5));
                ...
                textView.setTextColor(fy0Var6.getThemedColor(org.telegram.ui.ActionBar.h6.f19283q5));
