...
public final class ry0 extends Drawable {
    ...
    public final c6 f27717b;
    public final Drawable f27718c;
    public final Drawable d;
    public int e = 255;

    public ry0(org.telegram.ui.Cells.t1 t1Var) {
        this.f27717b = new c6(t1Var, 420L, qr.h);
        this.f27718c = t1Var.getContext().getResources().getDrawable(R.drawable.summary_arrow);
    ...
    public final void draw(Canvas canvas) {
        ...
        float e = this.f27717b.e(this.f27716a);
        ...
        Drawable drawable2 = this.f27718c;
    ...
    public final int getIntrinsicHeight() {
        return this.f27718c.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f27718c.getIntrinsicWidth();
    }
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f27718c.setColorFilter(colorFilter);
