...
public final class c71 {
    ...
    public c71(e71 e71Var) {
        ...
        this.d = arrayList;
        this.f24943a = e71Var.f25608b;
        this.f24944b = e71Var.f25613i;
        this.f24945c = e71Var.f25614j;
    ...
    public final e71 a() {
        ...
        for (int i11 = 0; i11 < arrayList.size(); i11++) {
            ...
            if (e71Var3.f25615k < j3 && g71.Y(e71Var3.f25617m)) {
                j3 = e71Var3.f25615k;
                e71Var = e71Var3;
            }
        }
    ...
    public final int b() {
        int min = Math.min(this.f24944b, this.f24945c);
    ...
    public final String toString() {
        ...
        if (z10) {
            ...
            sb2.append("\n");
            ArrayList arrayList = this.d;
            sb2.append(AndroidUtilities.formatFileSize((long) ((e71) arrayList.get(0)).f25616l).replace(" ", ""));
            sb2.append("/s");
            if (((e71) arrayList.get(0)).f25617m != null) {
                str2 = ", " + ((e71) arrayList.get(0)).f25617m;
            }
            sb2.append(str2);
            return sb2.toString();
        }
