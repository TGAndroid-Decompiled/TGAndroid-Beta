...
public final class c71 {
    ...
    public c71(e71 e71Var) {
        ...
        this.d = arrayList;
        this.f22969a = e71Var.f23569b;
        this.f22970b = e71Var.f23573i;
        this.f22971c = e71Var.f23574j;
    ...
    public final e71 a() {
        ...
        for (int i11 = 0; i11 < arrayList.size(); i11++) {
            ...
            if (e71Var3.f23575k < j3 && g71.Y(e71Var3.f23577m)) {
                j3 = e71Var3.f23575k;
                e71Var = e71Var3;
            }
        }
    ...
    public final int b() {
        int min = Math.min(this.f22970b, this.f22971c);
    ...
    public final String toString() {
        ...
        if (z10) {
            ...
            sb2.append("\n");
            ArrayList arrayList = this.d;
            sb2.append(AndroidUtilities.formatFileSize((long) ((e71) arrayList.get(0)).f23576l).replace(" ", ""));
            sb2.append("/s");
            if (((e71) arrayList.get(0)).f23577m != null) {
                str2 = ", " + ((e71) arrayList.get(0)).f23577m;
            }
            sb2.append(str2);
            return sb2.toString();
        }
