...
public final class dc extends GestureDetector.SimpleOnGestureListener {
    public final sb f23309a;
    public final gb f23310b;
    ...
    public final boolean onDown(MotionEvent motionEvent) {
        gb gbVar = this.f23310b;
        if (gbVar.f24161s) {
            return false;
        }
        sb sbVar = this.f23309a;
        gbVar.v = sb.access$1400(sbVar, true);
        gbVar.f24162w = sb.access$1400(sbVar, false);
        return true;
    }
    ...
    public final boolean onFling(MotionEvent motionEvent, MotionEvent motionEvent2, float f7, float f10) {
        ...
        gb gbVar = this.f23310b;
        if ((f7 < 0.0f && gbVar.v) || (f7 > 0.0f && gbVar.f24162w)) {
            z10 = true;
        }
        ...
        if (!z10) {
            kVar.a(new o1.f(this) {
                ...
                public final void a(o1.h hVar, boolean z11, float f11, float f12) {
                    switch (r2) {
                        case 0:
                            this.f22698b.f23310b.f24164y.b();
                            return;
                        default:
                            this.f22698b.f23310b.f24164y.b();
                            return;
    ...
    public final boolean onScroll(MotionEvent motionEvent, MotionEvent motionEvent2, float f7, float f10) {
        ...
        float f13 = gbVar.f24158f - f7;
        gbVar.f24158f = f13;
        sb sbVar = this.f23309a;
        sbVar.setTranslationX(f13);
        float f14 = gbVar.f24158f;
        if (f14 == 0.0f || ((f14 < 0.0f && gbVar.v) || (f14 > 0.0f && gbVar.f24162w))) {
