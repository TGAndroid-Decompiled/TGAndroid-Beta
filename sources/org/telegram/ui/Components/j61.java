...
public class j61 extends og.b {
    ...
    public Utilities.Callback2 f25292s;
    public final org.telegram.ui.ActionBar.d6 v;
    public ig.f f25295y;
    public boolean f25291r = true;
    public final ArrayList f25293w = new ArrayList();
    public final ArrayList f25294x = new ArrayList();
    public int E = 0;
    ...
    public final void F(int i10) {
        if (i10 >= 0) {
            ...
            if (i10 < arrayList.size()) {
                ...
                this.L.run(Integer.valueOf(i10), new ArrayList(this.f25294x.subList(h61Var.f24650a, h61Var.f24651b + 1)));
                this.K = false;
            }
        }
    }
    ...
    public final v51 G(int i10) {
        if (i10 >= 0) {
            ArrayList arrayList = this.f25294x;
            if (i10 < arrayList.size()) {
    ...
    public final int H(int i10) {
        ...
        while (true) {
            ...
            if (i11 < arrayList.size()) {
                ...
                if (i10 >= h61Var.f24650a && i10 <= h61Var.f24651b) {
                    return i11;
                }
                i11++;
            } else {
    ...
    public final boolean J(int i10) {
        v51 G = G(i10);
        v51 G2 = G(i10 + 1);
        if (G != null && !G.f29047j && G2 != null && K(G2.f15715a) == K(G.f15715a)) {
            return true;
        }
        return false;
    }
    ...
    public final void L() {
        h61 h61Var = this.I;
        if (h61Var != null) {
            h61Var.f24651b = Math.max(0, this.f25294x.size() - 1);
        }
    }
    ...
    public final void P(boolean z10) {
        wl0 wl0Var = this.d;
        if (wl0Var == null || !wl0Var.b0()) {
            ArrayList arrayList = this.f25293w;
            arrayList.clear();
            ArrayList arrayList2 = this.f25294x;
            arrayList.addAll(arrayList2);
            arrayList2.clear();
            this.H = null;
            this.F.clear();
            this.G.clear();
            Utilities.Callback2 callback2 = this.f25292s;
            if (callback2 != null) {
    ...
    public final void R() {
        ...
        if (wl0Var != null) {
            ...
            while (i10 < size) {
                ...
                i10++;
                h61 h61Var = (h61) obj;
                wl0Var.K2.add(Long.valueOf(AndroidUtilities.pack(h61Var.f24650a, h61Var.f24651b)));
            }
        }
    }
    ...
    public final void T() {
        h61 h61Var = this.H;
        if (h61Var != null) {
            h61Var.f24651b = Math.max(0, (this.f25294x.size() + this.E) - 1);
            h61 h61Var2 = this.H;
            if (h61Var2.f24650a == h61Var2.f24651b) {
    ...
    public final void U() {
        ?? obj = new Object();
        this.H = obj;
        obj.f24650a = this.f25294x.size() + this.E;
        h61 h61Var = this.H;
        h61Var.f24651b = -1;
        this.F.add(h61Var);
    }
    ...
    public s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        int i16;
        boolean z10 = this.f25290n;
        if (z10) {
            i11 = org.telegram.ui.ActionBar.h6.f19130h5;
        } else {
        ...
        if (i10 >= 10000) {
            u51 F = v51.F(i10);
            if (F != null) {
                a2Var = F.createView(this.e, this.d, this.f25289f, this.h, this.v);
            } else {
            ...
            switch (i10) {
                ...
                case 9:
                    ...
                    if (i10 == 9) {
                        ...
                        w8Var2.d(org.telegram.ui.ActionBar.h6.f19114g6, org.telegram.ui.ActionBar.h6.O6, org.telegram.ui.ActionBar.h6.P6, org.telegram.ui.ActionBar.h6.Q6, org.telegram.ui.ActionBar.h6.R6);
                ...
                case 10:
                    ...
                    frameLayout2.f21633c = textView2;
                    ...
                    radioButton.b(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19115g7, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19132h7, false));
                    if (!LocaleController.isRTL) {
                        i17 = 5;
                    }
                ...
                case 22:
                case 23:
                    if (this.f25295y == null) {
                        this.f25295y = new ig.f(null);
                    }
                    ig.f fVar = this.f25295y;
                    int i19 = this.h;
                    a2Var = new qa1(this.e, this.f25289f, i10 - 18, fVar, i19);
                    break;
                case 24:
                ...
                case 41:
                    ...
                    a2Var2.getCheckBoxRound().b(org.telegram.ui.ActionBar.h6.V6, org.telegram.ui.ActionBar.h6.f19115g7, org.telegram.ui.ActionBar.h6.f19188k7);
                    a2Var = a2Var2;
                    break;
                case 38:
