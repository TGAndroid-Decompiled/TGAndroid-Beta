...
public final class lv implements org.telegram.ui.ActionBar.s0, Utilities.Callback5, org.telegram.ui.ActionBar.b2, gg.b2, GenericProvider, u80, ve0, cl0, org.telegram.ui.qy, ai.t9, MessagesStorage.StringCallback, l81, LanguageDetector.StringCallback, tv0, ImageReceiver.ImageReceiverDelegate {
    ...
    public void b(boolean z10) {
        ai.d9 d9Var = (ai.d9) this.f25979b;
        if (z10) {
            d9Var.p(30, false);
        }
    }
    ...
    public boolean d(int i10, View view) {
        ...
        switch (this.f25978a) {
            case 14:
                qj0 qj0Var = (qj0) this.f25979b;
                ArrayList arrayList = qj0Var.f27331n;
                if (qj0Var.f27330f.j(i10) == 0 && (pj0Var = qj0Var.F) != null) {
                ...
                return true;
            default:
                wm0 wm0Var = (wm0) this.f25979b;
                vm0 vm0Var = wm0Var.f29699c;
                MessageObject E = vm0Var.E(i10);
                wm0 wm0Var2 = vm0Var.f28831c;
                if (E == null) {
                    return false;
                }
                if (!wm0Var.I.g()) {
                    wm0Var.I.a();
                    vm0Var.q(0, wm0Var2.f29702r);
                }
                if (wm0Var.I.g()) {
                    wm0Var.I.e(E, view, 0);
                    if (!wm0Var.I.g()) {
    ...
    public void didSetImage(ImageReceiver imageReceiver, boolean z10, boolean z11, boolean z12) {
        ...
        int ceil;
        double ceil2;
        o71 o71Var = (o71) this.f25979b;
        ImageReceiver imageReceiver2 = o71Var.Q;
        if (z10) {
            if (o71Var.N != null || o71Var.f26663d0 != null) {
                ...
                if (ku0Var != null) {
                    ...
                    int i13 = 0;
                    while (true) {
                        if (i13 < o71Var.f26663d0.size()) {
                            n71Var = (n71) o71Var.f26663d0.get(i13);
                            if (i13 == 0) {
                                d = 0.0d;
                            } else {
                                d = n71Var.f26394a;
                            }
                            if (i13 == o71Var.f26663d0.size() - 1) {
                                d10 = 9.9999999E7d;
                            } else {
                                d10 = ((n71) o71Var.f26663d0.get(i13 + 1)).f26394a;
                            }
                            double d11 = o71Var.O;
                            if (d11 >= d && d11 <= d10) {
                                break;
                    ...
                    if (n71Var != null) {
                        o71Var.R = n71Var.f26395b;
                        o71Var.S = n71Var.f26396c;
                        o71Var.T = o71Var.f26660b0;
                        o71Var.U = o71Var.f26662c0;
                    } else {
                        return;
                    }
                }
    ...
    public void f(org.telegram.ui.ActionBar.c2 c2Var, int i10) {
        switch (this.f25978a) {
            case 2:
                MediaDataController.getInstance(((bz) this.f25979b).v.f25716c1).clearRecentStickers();
                return;
            case 4:
                ((wm) this.f25979b).run();
                return;
            case 5:
                ...
                return;
            case 6:
                b70.Q((b70) this.f25979b);
                return;
            case 22:
                AndroidUtilities.hideKeyboard((EditTextBoldCursor) this.f25979b);
                return;
            case 23:
                yx0 yx0Var = (yx0) this.f25979b;
                yx0Var.e.presentFragment(new StickersActivity(yx0Var.d, null));
                c2Var.dismiss();
                return;
            default:
                AndroidUtilities.hideKeyboard((ay0) this.f25979b);
                c2Var.dismiss();
                return;
        }
    }
    ...
    public void g(int i10) {
        Utilities.Callback callback = ((j51) this.f25979b).C;
        if (callback != null) {
    ...
    public void h(int i10) {
        x60 x60Var = (x60) this.f25979b;
        b70 b70Var = x60Var.f29863n;
        b70Var.J(x60Var.f29862f - 1);
        if (x60Var.h == null && !x60Var.e.e() && x60Var.h() <= 2) {
            b70Var.f26946s.e(false, true);
        }
        x60Var.l();
    }
    ...
    public void k(int i10, int i11) {
        jf0 jf0Var = ((if0) this.f25979b).d;
        if (i10 == jf0Var.f25237b) {
            jf0Var.G = i11;
        } else if (i10 == jf0Var.f25256r) {
            jf0Var.P = i11;
        } else if (i10 == jf0Var.d) {
            jf0Var.I = i11;
        } else if (i10 == jf0Var.f25239c) {
            jf0Var.H = i11;
        } else if (i10 == jf0Var.f25243f) {
            jf0Var.J = i11;
        } else if (i10 == jf0Var.e) {
            jf0Var.K = i11;
        } else if (i10 == jf0Var.v) {
            jf0Var.R = i11;
        } else if (i10 == jf0Var.f25258s) {
            jf0Var.Q = i11;
        } else if (i10 == jf0Var.f25263w) {
            jf0Var.S = i11;
        } else if (i10 == jf0Var.f25265x) {
            jf0Var.U = i11;
        } else if (i10 == jf0Var.h) {
            jf0Var.L = i11;
        } else if (i10 == jf0Var.f25251n) {
            jf0Var.M = i11;
        }
    ...
    public Object provide(Object obj) {
        cc0 cc0Var = (cc0) obj;
        return Float.valueOf(((o1.j) this.f25979b).f15360a / 100.0f);
    }
    ...
    public void run(String str) {
        switch (this.f25978a) {
            case 19:
                final zu0 zu0Var = ((sr0) this.f25979b).d;
                zu0.r(zu0Var).r(zu0Var.f30634j1, str, new Utilities.Callback() {
                    @Override
                ...
                return;
            case 20:
                final zu0 zu0Var2 = ((dt0) this.f25979b).d;
                zu0.r(zu0Var2).r(zu0Var2.f30634j1, str, new Utilities.Callback() {
                    @Override
                    public final void run(Object obj) {
                        int i10 = r2;
                ...
                return;
            default:
                h41 h41Var = (h41) this.f25979b;
                h41Var.f24481e0 = str;
                h41Var.f24486j0.N(true);
                return;
        }
    }
