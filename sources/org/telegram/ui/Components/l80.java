...
public abstract class l80 extends LinearLayout {
    public final org.telegram.ui.Cells.m4 f25838a;
    public final org.telegram.ui.Cells.x8 f25839b;
    public final org.telegram.ui.Cells.x8 f25840c;
    public final org.telegram.ui.Cells.f9 d;
    public final org.telegram.ui.Cells.f9 e;
    public boolean f25841f;
    public boolean h;
    public TLRPC.Chat f25842n;
    public ValueAnimator f25843r;
    public float f25844s;
    public final int v;
    ...
    public l80(Context context, TLRPC.Chat chat) {
        ...
        this.f25842n = chat;
        this.f25841f = chat.join_to_send;
        ...
        x8Var.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        l80 l80Var = this.f24900b;
                        boolean z13 = l80Var.f25841f;
                        boolean z14 = !z13;
                        if (l80Var.b(z14, new k80(l80Var, l80Var.h, z13, 0))) {
                            l80Var.setJoinRequest(false);
                            l80Var.setJoinToSend(z14);
                            return;
                        }
                        return;
                    default:
                        l80 l80Var2 = this.f24900b;
                        boolean z15 = l80Var2.h;
                        boolean z16 = !z15;
                        if (l80Var2.a(z16, new j80(l80Var2, z15, 0))) {
                            l80Var2.setJoinRequest(z16);
                            return;
                        }
                        return;
                }
        ...
        addView(f9Var2);
        boolean z13 = this.f25841f;
        this.f25844s = z13 ? 1.0f : 0.0f;
    ...
    public final void c(boolean z10) {
        ...
        this.f25838a.setVisibility(i10);
        if (z10) {
            i11 = 0;
        }
        this.f25839b.setVisibility(i11);
        if (!z10) {
            this.f25841f = true;
    ...
    public final void d(float f7) {
        int measuredHeight;
        this.f25844s = f7;
        org.telegram.ui.Cells.x8 x8Var = this.f25840c;
        x8Var.setAlpha(f7);
        float f10 = 1.0f - f7;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        int i14;
        org.telegram.ui.Cells.x8 x8Var = this.f25839b;
        if (x8Var.getVisibility() == 0) {
            int i15 = i12 - i10;
            org.telegram.ui.Cells.m4 m4Var = this.f25838a;
        ...
        int i16 = i12 - i10;
        org.telegram.ui.Cells.x8 x8Var2 = this.f25840c;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (x8Var.getVisibility() == 0) {
            measuredHeight = (x8Var2.getMeasuredHeight() * this.f25844s) + x8Var.getMeasuredHeight() + m4Var.getMeasuredHeight();
        } else {
            measuredHeight = x8Var2.getMeasuredHeight();
        }
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec((int) (measuredHeight + AndroidUtilities.lerp(f9Var.getMeasuredHeight(), f9Var2.getMeasuredHeight(), this.f25844s)), 1073741824));
    }
    ...
    public void setJoinToSend(boolean z10) {
        ...
        x8Var.setDivider(this.f25841f);
        boolean z11 = this.h;
        org.telegram.ui.Cells.x8 x8Var2 = this.f25840c;
        x8Var2.setChecked(z11);
        ValueAnimator valueAnimator = this.f25843r;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        float f10 = this.f25844s;
        if (this.f25841f) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        ...
        this.f25843r = ofFloat;
        ofFloat.setDuration(200L);
        this.f25843r.setInterpolator(rr.f27701f);
        this.f25843r.addUpdateListener(new i70(this, 1));
        this.f25843r.addListener(new r8(this, 26));
