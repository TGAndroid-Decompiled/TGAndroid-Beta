...
public class rz extends s4.c0 {
    ...
    public rz(int i10, int i11, xl0 xl0Var) {
        super(1, false);
        this.I = new SparseArray();
        this.J = -1;
        this.P = true;
