...
public final class rz extends View {
    ...
    public final Path f28065c;
    public int d;
    public int e;
    public t01[] f28066f;
    public RectF[] h;
    public float f28067n;
    public org.telegram.ui.qo0 f28068r;
    public int f28069s;

    public rz(Context context) {
        super(context);
        this.f28063a = new Paint(1);
        this.f28064b = new Paint(1);
        this.f28065c = new Path();
        this.d = -1;
        this.e = -1;
        this.f28069s = -1;
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int dp = AndroidUtilities.dp(4.0f) + org.telegram.messenger.f0.D(24.0f, this.f28066f.length, AndroidUtilities.dp(4.0f));
        int i10 = 0;
        while (true) {
            t01[] t01VarArr = this.f28066f;
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(18.0f), AndroidUtilities.dp(18.0f), this.f28063a);
        float dp5 = f7 + AndroidUtilities.dp(16.0f);
        for (int i11 = 0; i11 < this.f28066f.length; i11++) {
            this.h[i11].set(dp5 - AndroidUtilities.dp(16.0f), dp2, this.f28066f[i11].l() + dp5 + AndroidUtilities.dp(16.0f), dp3);
            dp5 += this.f28066f[i11].l() + AndroidUtilities.dp(24.0f);
        }
        AndroidUtilities.dp(4.0f);
        int clamp = Utilities.clamp((int) Math.floor(this.f28067n), this.f28066f.length - 1, 0);
        int clamp2 = Utilities.clamp((int) Math.ceil(this.f28067n), this.f28066f.length - 1, 0);
        float dp6 = this.h[clamp].left + AndroidUtilities.dp(4.0f);
        float dp7 = this.h[clamp2].left + AndroidUtilities.dp(4.0f);
        float f10 = this.f28067n;
        ...
        Path path = this.f28065c;
        path.rewind();
        path.addRoundRect(rectF2, AndroidUtilities.dp(15.0f), AndroidUtilities.dp(15.0f), Path.Direction.CW);
        canvas.drawRoundRect(rectF2, AndroidUtilities.dp(15.0f), AndroidUtilities.dp(15.0f), this.f28064b);
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        int i10 = 0;
        if (this.f28066f == null || this.h == null) {
            return false;
        }
        while (true) {
        ...
        if (i10 >= 0 && i10 != this.f28069s) {
            this.f28069s = i10;
            org.telegram.ui.qo0 qo0Var = this.f28068r;
            if (qo0Var != null) {
    ...
    public void setSelected(float f7) {
        if (Math.abs(f7 - this.f28067n) > 0.001f) {
            invalidate();
        }
        this.f28067n = f7;
    }
    ...
    public void setTabs(CharSequence... charSequenceArr) {
        this.f28066f = new t01[charSequenceArr.length];
        this.h = new RectF[charSequenceArr.length];
        for (int i10 = 0; i10 < charSequenceArr.length; i10++) {
            this.f28066f[i10] = new t01(charSequenceArr[i10], 14.0f, AndroidUtilities.bold());
