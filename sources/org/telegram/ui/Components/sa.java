...
public final class sa extends View {
    public final Paint f27886a;
    public float f27887b;
    public int f27888c;
    public int d;
    public final RectF e;
    public final z4.g f27889f;
    public final int h;
    public int f27890n;
    public int f27891r;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        this.d = this.f27889f.getCurrentItem();
        int i12 = 0;
        while (true) {
            int i13 = this.h;
            rectF = this.e;
        ...
        if (this.f27887b != 0.0f) {
            if (this.f27888c >= this.d) {
                rectF.set(dp2, 0.0f, (AndroidUtilities.dp(11.0f) * this.f27887b) + AndroidUtilities.dp(5.0f) + dp2, AndroidUtilities.dp(5.0f));
            } else {
                rectF.set(com.google.android.gms.internal.vision.e2.b(1.0f, this.f27887b, AndroidUtilities.dp(11.0f), dp2), 0.0f, AndroidUtilities.dp(5.0f) + dp2, AndroidUtilities.dp(5.0f));
            }
        } else {
