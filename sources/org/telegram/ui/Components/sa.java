...
public abstract class sa extends org.telegram.ui.ActionBar.g3 {
    ...
    public int S;
    public int T;
    public final Drawable f28675b;
    public final org.telegram.ui.k f28676c;
    public final sl0 d;
    public final pa e;
    public boolean f28677f;
    public int h;
    public final org.telegram.ui.ActionBar.p2 f28678n;
    public final boolean f28679r;
    public final na f28680s;
    public float v;
    public boolean f28681w;
    public float f28682x;
    public boolean f28683y;
    ...
    public final boolean A() {
        if (i0.a.f(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19977h5, this.resourcesProvider)) > 0.699999988079071d) {
            return true;
        }
        return false;
    }
    ...
    public void H(Canvas canvas, View view) {
        ...
        if (!this.f28679r) {
            ...
            if (i15 == 1) {
                ...
                AndroidUtilities.updateViewVisibilityAnimated(paVar, z10, 1.0f, this.f28677f);
            } else if (i15 == 2) {
            ...
            if (K()) {
                ...
                if (this.f28683y && f13 > 0.0f) {
                    ...
                    org.telegram.ui.ActionBar.j6.f20185t0.setColor(getThemedColor(org.telegram.ui.ActionBar.j6.Ii));
                    org.telegram.ui.ActionBar.j6.f20185t0.setAlpha((int) (paint.getAlpha() * f13));
    ...
    public final void I() {
        sl0 sl0Var = this.d;
        if (sl0Var != null && this.f28676c != null && sl0Var.getChildCount() > 0) {
            View view = null;
            int i10 = -1;
    ...
    public final void u() {
        if (this.backDrawable != null && this.containerView != null && this.shadowDrawable != null && K() && !this.f28679r) {
    ...
    public sa(Context context, org.telegram.ui.ActionBar.p2 p2Var, boolean z4, boolean z10, boolean z11, boolean z12, boolean z13, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f28678n = p2Var;
        this.f28679r = z11;
        this.f28675b = context.getDrawable(R.drawable.header_shadow).mutate();
        if (z12) {
        ...
        na naVar3 = this.f28680s;
        if (naVar3 != null) {
            naVar3.setBottomSheetContainerView(getContainer());
            this.f28680s.setTargetListView(w10);
        }
        if (z11) {
            ...
            this.e = paVar;
            paVar.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19977h5));
            paVar.setTitleColor(getThemedColor(org.telegram.ui.ActionBar.j6.G6));
            paVar.B(getThemedColor(org.telegram.ui.ActionBar.j6.f20300z8), false);
            paVar.setBackButtonImage(R.drawable.ic_ab_back);
            paVar.C(getThemedColor(org.telegram.ui.ActionBar.j6.f20283y8), false);
