...
public final class q21 {
    ...
    public final org.telegram.ui.ActionBar.e6 f27416c;
    public final boolean d;
    public v01 e;
    public final ImageReceiver f27418g;
    public q5 h;
    public int f27420j;
    public int f27421k;
    public boolean f27422l;
    public boolean f27423m;
    public final Paint f27424n;
    public final Path f27425o;
    public final RectF f27426p;
    public final yc f27427q;
    public Runnable f27428r;
    public long f27429s;
    public final h9 f27417f = new h9((org.telegram.ui.ActionBar.e6) null);
    public final Path f27419i = new Path();
    ...
    public q21(int i10, View view, org.telegram.ui.ActionBar.e6 e6Var, boolean z10) {
        ...
        Path path = new Path();
        this.f27425o = path;
        this.f27426p = new RectF();
        this.f27414a = i10;
        this.f27415b = view;
        this.f27416c = e6Var;
        this.d = z10;
        this.f27427q = new yc(view);
        this.f27418g = new ImageReceiver(view);
        path.rewind();
    ...
    public final void a() {
        this.f27418g.onAttachedToWindow();
        q5 q5Var = this.h;
        if (q5Var != null) {
            q5Var.a(this.f27415b);
        }
    }

    public final void b() {
        this.f27418g.onDetachedFromWindow();
        q5 q5Var = this.h;
        if (q5Var != null) {
            q5Var.o(this.f27415b);
        }
    }
    ...
    public final void c(Canvas canvas, int i10, float f7, float f10, float f11, float f12, boolean z10) {
        ...
        v01 v01Var = this.e;
        if (v01Var != null) {
            v01Var.f28878p = i10 - AndroidUtilities.dp(144.66f);
            float l4 = this.e.l() + AndroidUtilities.dp(48.66f);
            float f15 = i10;
            float f16 = (f15 - l4) / 2.0f;
            int i11 = this.f27421k;
            int i12 = (int) l4;
            boolean z11 = this.d;
            Path path = this.f27419i;
            if (i11 == i12 && this.f27420j == i10 && this.f27423m == z10 && this.f27422l == z11) {
                f14 = l4;
                f13 = 2.0f;
            } else {
                path.rewind();
            ...
            org.telegram.ui.ActionBar.e6 e6Var = this.f27416c;
            ...
            float f20 = f19 + f16;
            float f21 = f20 + f14;
            this.f27426p.set(f20 - AndroidUtilities.dp(4.0f), f10 - AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f) + f21, AndroidUtilities.dp(32.0f) + f10);
            if (z10) {
                q5 q5Var = this.h;
                if (q5Var != null) {
                    ...
                    ImageReceiver imageReceiver = this.f27418g;
                ...
                int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19158ic, e6Var);
                ...
                Paint paint = this.f27424n;
                paint.setColor(l1);
                paint.setStrokeWidth(AndroidUtilities.dp(1.66f));
                canvas.drawPath(this.f27425o, paint);
                canvas.restore();
            }
        }
    }
    ...
    public final boolean d(android.view.MotionEvent r6, boolean r7) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.q21.d(android.view.MotionEvent, boolean):boolean");
    }
    ...
    public final boolean f(MessageObject messageObject) {
        ...
        if (messageObject == null) {
            ...
            if (isMonoForum) {
                ...
                this.f27429s = monoForumTopicId;
                if (userOrChat == null) {
                    this.e = null;
                    return false;
                }
                h9 h9Var = this.f27417f;
                h9Var.p(userOrChat);
                ...
                if (topicId == 1) {
                    imageReceiver.setImageBitmap(ng.d.c(view.getContext(), 0.75f, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19395v8, this.f27416c), false));
