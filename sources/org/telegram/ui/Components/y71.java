...
public final class y71 implements ImageReceiver.ImageReceiverDelegate {
    ...
    public void didSetImage(ImageReceiver imageReceiver, boolean z10, boolean z11, boolean z12) {
        ...
        int ceil;
        double ceil2;
        b81 b81Var = (b81) this.f30581a;
        ImageReceiver imageReceiver2 = b81Var.Q;
        if (z10) {
            if (b81Var.N != null || b81Var.f22918d0 != null) {
                int dp = AndroidUtilities.dp(150.0f);
                org.telegram.ui.au0 au0Var = b81Var.N;
                if (au0Var != null) {
                    ArrayList arrayList = au0Var.v;
                    int indexOf = arrayList.indexOf(au0Var.c((int) b81Var.O));
                    if (indexOf != -1) {
                    ...
                    org.telegram.ui.au0 au0Var2 = b81Var.N;
                    ...
                    int i13 = 0;
                    while (true) {
                        if (i13 < b81Var.f22918d0.size()) {
                            a81Var = (a81) b81Var.f22918d0.get(i13);
                            if (i13 == 0) {
                                d = 0.0d;
                            } else {
                                d = a81Var.f22567a;
                            }
                            if (i13 == b81Var.f22918d0.size() - 1) {
                                d10 = 9.9999999E7d;
                            } else {
                                d10 = ((a81) b81Var.f22918d0.get(i13 + 1)).f22567a;
                            }
                            double d11 = b81Var.O;
                            if (d11 >= d && d11 <= d10) {
                                break;
                    ...
                    if (a81Var != null) {
                        b81Var.R = a81Var.f22568b;
                        b81Var.S = a81Var.f22569c;
                        b81Var.T = b81Var.f22915b0;
                        b81Var.U = b81Var.f22917c0;
                    } else {
                        return;
                    }
                }
