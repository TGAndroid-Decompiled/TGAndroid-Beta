    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f30918a) {
            case 0:
                ...
                return;
            case 1:
                l81 l81Var2 = this.f30919b;
                l81Var2.getClass();
                l81Var2.O = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                return;
            case 2:
                l81 l81Var3 = this.f30919b;
                l81Var3.K.onAnimationUpdate(valueAnimator);
                l81Var3.J.f26206a = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                l81Var3.J.v.f1();
                l81Var3.J.invalidate();
                return;
            default:
                l81 l81Var4 = this.f30919b;
                l81Var4.getClass();
