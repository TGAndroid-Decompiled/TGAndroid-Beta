...
public final class xt0 implements org.telegram.ui.ot {
    public final TLRPC.TL_messageMediaPoll f33173a;
    public final TLRPC.PollAnswer f33174b;
    public final org.telegram.ui.Cells.t1 f33175c;
    public final cu0 d;
    ...
    public xt0(cu0 cu0Var, TLRPC.TL_messageMediaPoll tL_messageMediaPoll, TLRPC.PollAnswer pollAnswer, org.telegram.ui.Cells.t1 t1Var) {
        this.d = cu0Var;
        this.f33173a = tL_messageMediaPoll;
        this.f33174b = pollAnswer;
        this.f33175c = t1Var;
    }
    ...
    public final void K() {
        ...
        SendMessagesHelper.getInstance(this.d.f26041a).sendVote(this.f33175c.getMessageObject(), arrayList, null);
    }

    @Override
    public final void M(TLRPC.InputStickerSet inputStickerSet, boolean z4) {
        cu0 cu0Var = this.d;
        eu0 eu0Var = cu0Var.f26043c;
        if (inputStickerSet != null && eu0Var.f26668s.getContext() != null) {
            TLRPC.TL_inputStickerSetID tL_inputStickerSetID = new TLRPC.TL_inputStickerSetID();
            tL_inputStickerSetID.access_hash = inputStickerSet.access_hash;
            tL_inputStickerSetID.f20865id = inputStickerSet.f20865id;
            xx0 xx0Var = new xx0(eu0Var.f26668s.getContext(), eu0Var.f26668s.f33649s1, tL_inputStickerSetID, null, null, cu0Var.f26042b);
    ...
    @Override
    public final long a() {
        return this.d.f26043c.f26668s.f33624g1;
    }
    ...
    @Override
    public final void q() {
        SendMessagesHelper.getInstance(this.d.f26041a).sendVote(this.f33175c.getMessageObject(), null, null);
    }
    ...
    public final MessageObject y() {
        return this.f33175c.getMessageObject();
    }
