...
public final class n90 extends v7.i0 {
    public final ArrayList f28725a;
    public TL_iv.RichText f28726b;
    public final ArrayList f28727c = new ArrayList();
    public final StringBuilder d = new StringBuilder();
    public final ad.d f28728e = new ad.d(new qb.b(1), new rb.a(1));
    public final ArrayDeque f28729f;

    public n90(ArrayList arrayList, ArrayDeque arrayDeque) {
        this.f28725a = arrayList;
        this.f28729f = arrayDeque;
    }

    public static void A(int i10, List list, List list2) {
        for (Object obj : list) {
            if (obj instanceof l90) {
                list2.add(((l90) obj).f28151a);
    ...
    public static void C(m90 m90Var, List list, int i10) {
        ...
        boolean z10;
        TL_iv.RichText j3;
        ad.a aVar = m90Var.f28448a;
        ArrayList arrayList = m90Var.f28450c;
            ...
            case 1557721666:
                if (lowerCase.equals("details")) {
                    ...
                    while (i11 < size) {
                        ...
                        if (z11) {
                            m90 m90Var2 = (m90) obj;
                            if ("summary".equalsIgnoreCase(m90Var2.f28448a.f416a)) {
                                StringBuilder sb2 = new StringBuilder();
                                w(m90Var2.f28450c, sb2);
                        ...
                        if (obj instanceof l90) {
                            arrayList2.add(((l90) obj).f28151a);
                        } else if (z11) {
    ...
    public static void w(List list, StringBuilder sb2) {
        for (Object obj : list) {
            if (obj instanceof l90) {
                TL_iv.PageBlock pageBlock = ((l90) obj).f28151a;
    ...
    public final void k(bf.n nVar) {
        ...
        if (nVar instanceof we.a) {
                        ...
                        if (pVar2 instanceof we.f) {
                            ...
                            for (bf.p pVar3 = (bf.p) ((we.f) pVar2).f2666c; pVar3 != null; pVar3 = (bf.p) pVar3.f2668f) {
                                if (pVar3 instanceof we.d) {
                                    ...
                                    we.c cVar = dVar.h;
                                    if (cVar == we.c.f48521b) {
                                        pagetablecell.align_center = true;
                                    } else if (cVar == we.c.f48522c) {
            ...
            pageblockparagraph.text = r90.c(((zc.a) nVar).f51544g);
    ...
    public final void x(TL_iv.PageBlock pageBlock) {
        ...
        sb2.append((char) 1);
        sb2.length();
        this.f28727c.add(new l90(length, pageBlock));
    }
    ...
    public final void y() {
        ...
        ArrayList arrayList4 = this.f28727c;
        ...
        while (i10 < size) {
            ...
            i10++;
            l90 l90Var = (l90) obj;
            hashMap.put(Integer.valueOf(l90Var.f28152b), l90Var);
        }
        ...
        while (i13 < size3) {
            ...
            while (i12 < arrayList3.size() && ((ad.a) arrayList3.get(i12)).f417b <= l90Var2.f28152b) {
                int i14 = i12 + 1;
                ad.a aVar4 = (ad.a) arrayList3.get(i12);
                int i15 = aVar4.d;
                int i16 = aVar4.f417b;
                if (i15 >= l90Var2.f28152b) {
                    while (arrayDeque.peek() != m90Var && ((m90) arrayDeque.peek()).f28449b <= i16) {
                        arrayDeque.pop();
                    }
                    m90 m90Var2 = new m90(aVar4, aVar4.d);
                    ((m90) arrayDeque.peek()).f28450c.add(m90Var2);
                    arrayDeque.push(m90Var2);
                }
                i12 = i14;
            }
            while (arrayDeque.peek() != m90Var && ((m90) arrayDeque.peek()).f28449b <= l90Var2.f28152b) {
                arrayDeque.pop();
            }
            TL_iv.PageBlock pageBlock = l90Var2.f28151a;
            ((m90) arrayDeque.peek()).f28450c.add(l90Var2);
        }
        A(0, m90Var.f28450c, this.f28725a);
    }
}
