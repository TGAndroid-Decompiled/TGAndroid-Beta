...
public final class n90 extends View {
    ...
    public final Paint f26633b;
    public final Paint f26634c;
    public final e6 d;
    public boolean e;
    ...
    public n90(Context context) {
        ...
        w7.a6.a(this);
        this.f26632a = context.getResources().getDrawable(R.drawable.media_live_on).mutate();
