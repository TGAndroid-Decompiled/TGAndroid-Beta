...
public final class n90 extends v7.i0 {
    public final ArrayList f28698a;
    public TL_iv.RichText f28699b;
    public final ArrayList f28700c = new ArrayList();
    public final StringBuilder d = new StringBuilder();
    public final ad.d f28701e = new ad.d(new qb.b(1), new rb.a(1));
    public final ArrayDeque f28702f;

    public n90(ArrayList arrayList, ArrayDeque arrayDeque) {
        this.f28698a = arrayList;
        this.f28702f = arrayDeque;
    }

    public static void A(int i10, List list, List list2) {
        for (Object obj : list) {
            if (obj instanceof l90) {
                list2.add(((l90) obj).f28124a);
    ...
    public static void C(m90 m90Var, List list, int i10) {
        ...
        boolean z10;
        TL_iv.RichText j3;
        ad.a aVar = m90Var.f28421a;
        ArrayList arrayList = m90Var.f28423c;
            ...
            case 1557721666:
                if (lowerCase.equals("details")) {
                    ...
                    while (i11 < size) {
                        ...
                        if (z11) {
                            m90 m90Var2 = (m90) obj;
                            if ("summary".equalsIgnoreCase(m90Var2.f28421a.f404a)) {
                                StringBuilder sb2 = new StringBuilder();
                                w(m90Var2.f28423c, sb2);
                        ...
                        if (obj instanceof l90) {
                            arrayList2.add(((l90) obj).f28124a);
                        } else if (z11) {
    ...
    public static void w(List list, StringBuilder sb2) {
        for (Object obj : list) {
            if (obj instanceof l90) {
                TL_iv.PageBlock pageBlock = ((l90) obj).f28124a;
    ...
    public final void k(bf.n nVar) {
        ...
        if (nVar instanceof we.a) {
                        ...
                        if (pVar2 instanceof we.f) {
                            ...
                            for (bf.p pVar3 = (bf.p) ((we.f) pVar2).f2639c; pVar3 != null; pVar3 = (bf.p) pVar3.f2641f) {
                                if (pVar3 instanceof we.d) {
                                    ...
                                    we.c cVar = dVar.h;
                                    if (cVar == we.c.f48492b) {
                                        pagetablecell.align_center = true;
                                    } else if (cVar == we.c.f48493c) {
            ...
            pageblockparagraph.text = r90.c(((zc.a) nVar).f51513g);
    ...
    public final void x(TL_iv.PageBlock pageBlock) {
        ...
        sb2.append((char) 1);
        sb2.length();
        this.f28700c.add(new l90(length, pageBlock));
    }
    ...
    public final void y() {
        ...
        ArrayList arrayList4 = this.f28700c;
        ...
        while (i10 < size) {
            ...
            i10++;
            l90 l90Var = (l90) obj;
            hashMap.put(Integer.valueOf(l90Var.f28125b), l90Var);
        }
        ...
        while (i13 < size3) {
            ...
            while (i12 < arrayList3.size() && ((ad.a) arrayList3.get(i12)).f405b <= l90Var2.f28125b) {
                int i14 = i12 + 1;
                ad.a aVar4 = (ad.a) arrayList3.get(i12);
                int i15 = aVar4.d;
                int i16 = aVar4.f405b;
                if (i15 >= l90Var2.f28125b) {
                    while (arrayDeque.peek() != m90Var && ((m90) arrayDeque.peek()).f28422b <= i16) {
                        arrayDeque.pop();
                    }
                    m90 m90Var2 = new m90(aVar4, aVar4.d);
                    ((m90) arrayDeque.peek()).f28423c.add(m90Var2);
                    arrayDeque.push(m90Var2);
                }
                i12 = i14;
            }
            while (arrayDeque.peek() != m90Var && ((m90) arrayDeque.peek()).f28422b <= l90Var2.f28125b) {
                arrayDeque.pop();
            }
            TL_iv.PageBlock pageBlock = l90Var2.f28124a;
            ((m90) arrayDeque.peek()).f28423c.add(l90Var2);
        }
        A(0, m90Var.f28423c, this.f28698a);
    }
}
