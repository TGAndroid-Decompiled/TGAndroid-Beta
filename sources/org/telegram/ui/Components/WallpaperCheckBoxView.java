...
public class WallpaperCheckBoxView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawText(this.currentText, AndroidUtilities.dp(28.0f) + iM$2, AndroidUtilities.dp(21.0f), this.textPaint);
        canvas.save();
        canvas.translate(iM$2, AndroidUtilities.dp(7.0f));
        int i2 = 0;
        if (this.drawBitmap != null) {
            ...
            if (this.progress > 0.5f) {
                ...
                this.drawCanvas.drawLine(AndroidUtilities.dp(7.3f), AndroidUtilities.dp(13.0f), (int) ((AndroidUtilities.dp(6.0f) * f4) + AndroidUtilities.dp(7.3f)), (int) (AndroidUtilities.dp(13.0f) - (AndroidUtilities.dp(6.0f) * f4)), this.checkPaint);
            }
    ...
    public void onMeasure(int i, int i2) {
        super.onMeasure(ArticleViewer$10$$ExternalSyntheticOutline0.m(56.0f, this.maxTextSize, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(32.0f), 1073741824));
    }
