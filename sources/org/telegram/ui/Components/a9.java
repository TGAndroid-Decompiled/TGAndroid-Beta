...
public final class a9 extends yl0 {
    ...
    public final int Y2;
    public int Z2;
    public final org.telegram.ui.x7 f22564a3;
    public z8 f22565b3;
    public final d9 f22566c3;
    ...
    public a9(d9 d9Var, Activity activity) {
        ...
        for (int i12 = 0; i12 < 30; i12++) {
            ...
            this.Y2 = i13 + 1;
            obj2.f30842a = i13;
            int[] iArr2 = d9.f23603d0[i12];
            obj2.f30844c = iArr2[0];
            obj2.d = iArr2[1];
            obj2.e = 0;
            obj2.f30845f = 0;
            obj2.f30843b = true;
    ...
    public final void onMeasure(int i10, int i11) {
        int size = View.MeasureSpec.getSize(i10) / this.f22564a3.h();
        d9 d9Var = this.f22566c3;
        d9Var.P = size;
        ...
        while (true) {
            ...
            if (i10 < arrayList.size()) {
                if (((z8) arrayList.get(i10)).equals(z8Var)) {
                    this.Z2 = ((z8) arrayList.get(i10)).f30842a;
                    break;
                }
                i10++;
            } else {
