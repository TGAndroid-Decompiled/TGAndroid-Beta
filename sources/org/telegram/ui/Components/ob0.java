...
public final class ob0 extends s4.h0 {
    ...
    public static int D(org.telegram.ui.Cells.t1 t1Var, int i10, boolean z10) {
        ...
        if (t1Var != null) {
            ...
            if (messageObject != null && messageObject.getGroupId() == 0) {
                if (!TextUtils.isEmpty(messageObject.caption) && (textLayoutBlocks = t1Var.f21015c4) != null) {
                    i11 = (int) t1Var.f21211q4;
                    charSequence = messageObject.caption;
                    arrayList = textLayoutBlocks.textLayoutBlocks;
                } else {
                    t1Var.u3(true);
                    int i12 = t1Var.f21222r0;
                    CharSequence charSequence2 = messageObject.messageText;
                    ArrayList<MessageObject.TextLayoutBlock> arrayList2 = messageObject.textLayoutBlocks;
                    if (t1Var.f21254t1) {
                        i11 = org.telegram.messenger.w1.C(10.0f, t1Var.f21153m2, i12);
                    } else {
                        i11 = i12;
                    }
    ...
    @Override
    public final int h() {
        MessagePreviewParams.Messages messages = this.f26697c.f26994r;
        if (messages == null) {
            return 0;
        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        int i11;
        boolean z10;
        pb0 pb0Var = this.f26697c;
        hb0 hb0Var = pb0Var.f26992f;
        int i12 = pb0Var.f26986a;
        MessagePreviewParams.Messages messages = pb0Var.f26994r;
        if (messages != null && c1Var.f42705f == 0) {
            org.telegram.ui.Cells.t1 t1Var = (org.telegram.ui.Cells.t1) c1Var.f42702a;
            ...
            if (i12 == 2) {
                pb0Var.f26991c0.d.checkCurrentLink(pb0Var.f26994r.previewMessages.get(i10));
            }
            MessageObject messageObject = pb0Var.f26994r.previewMessages.get(i10);
            MessagePreviewParams.Messages messages2 = pb0Var.f26994r;
            ...
            if (pb0Var.f26994r.previewMessages.size() > 1) {
                if (i12 == 1) {
                    z10 = true;
                } else {
                    z10 = false;
                ...
                t1Var.J3(z10, false);
                if (i11 != pb0Var.f26994r.previewMessages.get(i10).getId()) {
                    z11 = false;
                }
                MessagePreviewParams.Messages messages3 = pb0Var.f26994r;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        mb0 mb0Var = new mb0(this, context, vb0Var.f28681w, pb0Var.J, vb0Var.F);
    ...
    public final void y(s4.c1 c1Var) {
        ...
        gb0 gb0Var = pb0Var.e;
        vb0 vb0Var = pb0Var.f26991c0;
        if (pb0Var.f26994r != null && (i10 = pb0Var.f26986a) != 1) {
