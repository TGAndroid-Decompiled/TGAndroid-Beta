...
public final class al0 extends AnimatorListenerAdapter {
    ...
    public void onAnimationCancel(Animator animator) {
        switch (this.f22724a) {
            case 11:
                ((ProfileActivity) this.f22726c).C5 = null;
                return;
            case 12:
                org.telegram.ui.w21 w21Var = (org.telegram.ui.w21) this.f22726c;
                super.onAnimationCancel(animator);
                float floatValue = ((Float) ((ValueAnimator) animator).getAnimatedValue()).floatValue();
                int[] iArr = (int[]) this.f22725b;
                if (iArr != null) {
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        Object obj2 = this.f22726c;
        switch (i10) {
            case 0:
                super.onAnimationEnd(animator);
                org.telegram.ui.wq wqVar = (org.telegram.ui.wq) obj2;
                ((bl0) wqVar.d).f23043g.remove((AnimatorSet) obj);
                if (((bl0) wqVar.d).f23043g.isEmpty()) {
                    ((bl0) wqVar.d).f23040b.clear();
            ...
            case 2:
                ...
                aw0Var.f22795f0 = 1.0f;
                aw0Var.S.add((wv0) obj);
                ((aw0) gVar.f1882c).f22787a0.setShader(null);
                ((aw0) gVar.f1882c).f22791c0.setShader(null);
                ((aw0) gVar.f1882c).N();
                super.onAnimationEnd(animator);
                return;
            case 3:
            ...
            case 9:
                ...
                AnimatorSet animatorSet = ef0Var.f23952s;
                if (animatorSet != null) {
                    animatorSet.cancel();
                }
                ...
                ef0Var.f23952s = animatorSet3;
                animatorSet3.playTogether(ObjectAnimator.ofFloat(ef0Var, ef0Var.E, 0.0f, 1.0f));
                ef0Var.f23952s.setDuration(250L);
                ef0Var.f23952s.setInterpolator(new OvershootInterpolator(1.01f));
                ef0Var.f23952s.addListener(new cf0(ef0Var, 0));
                ef0Var.f23952s.start();
                ...
                photoViewer.A2.setInterpolator(rr.f28031g);
            ...
            case 11:
                ...
                if (profileActivity.C5 != null) {
                    if (profileActivity.F5) {
                        ...
                        profileActivity.O.f25549r0.setVisibility(4);
    ...
    public void onAnimationStart(Animator animator) {
        switch (this.f22724a) {
            case 8:
                ((fw0) this.f22725b).setVisibility(0);
                return;
            default:
