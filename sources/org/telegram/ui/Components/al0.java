...
public final class al0 extends AnimatorListenerAdapter {
    ...
    public void onAnimationCancel(Animator animator) {
        switch (this.f22725a) {
            case 11:
                ((ProfileActivity) this.f22727c).C5 = null;
                return;
            case 12:
                org.telegram.ui.w21 w21Var = (org.telegram.ui.w21) this.f22727c;
                super.onAnimationCancel(animator);
                float floatValue = ((Float) ((ValueAnimator) animator).getAnimatedValue()).floatValue();
                int[] iArr = (int[]) this.f22726b;
                if (iArr != null) {
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        switch (i10) {
            case 0:
                ...
                ((bl0) wqVar.d).f23044g.remove((AnimatorSet) obj);
                if (((bl0) wqVar.d).f23044g.isEmpty()) {
                    ((bl0) wqVar.d).f23041b.clear();
            ...
            case 2:
                ...
                aw0Var.f22796f0 = 1.0f;
                aw0Var.S.add((wv0) obj);
                ((aw0) gVar.f1882c).f22788a0.setShader(null);
                ((aw0) gVar.f1882c).f22792c0.setShader(null);
                ((aw0) gVar.f1882c).N();
                super.onAnimationEnd(animator);
                return;
            case 3:
            ...
            case 9:
                ...
                AnimatorSet animatorSet = ef0Var.f23953s;
                if (animatorSet != null) {
                    animatorSet.cancel();
                }
                ...
                ef0Var.f23953s = animatorSet3;
                animatorSet3.playTogether(ObjectAnimator.ofFloat(ef0Var, ef0Var.E, 0.0f, 1.0f));
                ef0Var.f23953s.setDuration(250L);
                ef0Var.f23953s.setInterpolator(new OvershootInterpolator(1.01f));
                ef0Var.f23953s.addListener(new cf0(ef0Var, 0));
                ef0Var.f23953s.start();
                ...
                photoViewer.A2.setInterpolator(rr.f28032g);
            ...
            case 11:
                ...
                if (profileActivity.C5 != null) {
                    if (profileActivity.F5) {
                        ...
                        if (c01Var.s0(c01Var.f25536k0[0].F)) {
                            ((org.telegram.ui.ActionBar.u0) obj).setVisibility(0);
                        }
                        profileActivity.O.f25550r0.setVisibility(4);
    ...
    public void onAnimationStart(Animator animator) {
        switch (this.f22725a) {
            case 8:
                ((fw0) this.f22726b).setVisibility(0);
                return;
            default:
