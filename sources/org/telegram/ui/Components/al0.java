...
public final class al0 extends View {
    ...
    public final Drawable f23431a0;
    public final RectF f23432b;
    public pg.b f23433b0;
    public final Paint f23434c;
    public pg.b f23435c0;
    public final Paint d;
    public final boolean f23436d0;
    public float e;
    public int f23437e0;
    public float f23438f;
    public final m2.b f23439f0;
    public float f23440g0;
    public float h;
    public boolean f23441h0;
    public long f23442i0;
    public float f23443j0;
    public float f23444k0;
    public final rl0 f23445l0;
    public boolean f23446n;
    public StaticLayout f23447r;
    public StaticLayout f23448s;
    public StaticLayout v;
    public StaticLayout f23449w;
    public StaticLayout f23450x;
    public float f23451y;
    ...
    public al0(rl0 rl0Var, Context context, int i10) {
        ...
        float f10;
        float f11;
        org.telegram.ui.ActionBar.f6 f6Var = rl0Var.f28511m2;
        this.f23445l0 = rl0Var;
        this.f23430a = true;
        this.f23432b = new RectF();
        this.f23434c = new Paint(1);
        ...
        this.I = new float[8];
        this.T = new int[2];
        this.f23439f0 = new m2.b(this, 29);
        this.f23444k0 = 1.0f;
        this.O = i10;
        if (i10 == 0) {
            textPaint.setTextSize(AndroidUtilities.dp(45.0f));
            this.f23436d0 = LocaleController.isRTL;
        } else {
            this.f23436d0 = false;
        ...
        if (layoutManager instanceof f2.i0) {
            ...
            if (i0Var.f5720o == 1) {
                ...
                if (adapter instanceof bl0) {
                    ...
                    if (z4) {
                        i0Var.h1(iArr[0], (-iArr[1]) + rl0Var.f28524t1);
                    }
                    String F = bl0Var.F(iArr[0]);
                    if (F == null) {
                        StaticLayout staticLayout = this.f23447r;
                        if (staticLayout != null) {
                            this.f23448s = staticLayout;
                        }
                        this.f23447r = null;
                        ...
                        if (i10 == 0) {
                            this.f23447r = new StaticLayout(F, textPaint, 1000, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                        } else {
                            this.v = this.f23447r;
                            int measureText = ((int) textPaint.measureText(F)) + 1;
                            Layout.Alignment alignment = Layout.Alignment.ALIGN_NORMAL;
                            this.f23447r = new StaticLayout(F, textPaint, measureText, alignment, 1.0f, 0.0f, false);
                            if (this.v != null) {
                                ...
                                if (split != null && split2 != null && split.length == 2 && split2.length == 2 && split[1].equals(split2[1])) {
                                    ...
                                    this.f23449w = new StaticLayout(spannableStringBuilder2, textPaint, measureText, alignment, 1.0f, 0.0f, false);
                                    ...
                                    this.f23450x = new StaticLayout(spannableStringBuilder3, textPaint, measureText, alignment, 1.0f, 0.0f, false);
                                } else {
                                    this.f23449w = this.f23447r;
                                    this.f23450x = null;
                                }
                        ...
                        this.f23448s = null;
                        if (this.f23447r.getLineCount() > 0) {
                            this.f23447r.getLineWidth(0);
                            this.f23447r.getLineLeft(0);
                            if (this.f23436d0) {
                                this.J = (((AndroidUtilities.dp(88.0f) - this.f23447r.getLineWidth(0)) / 2.0f) + AndroidUtilities.dp(10.0f)) - this.f23447r.getLineLeft(0);
                            } else {
                                this.J = ((AndroidUtilities.dp(88.0f) - this.f23447r.getLineWidth(0)) / 2.0f) - this.f23447r.getLineLeft(0);
                            }
                            this.K = (AndroidUtilities.dp(88.0f) - this.f23447r.getHeight()) / 2;
                        }
                    }
                }
            }
    ...
    public final void c() {
        ...
        int i10 = this.O;
        if (i10 == 0) {
            k10 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20043m7, rl0Var.f28511m2);
        } else {
            k10 = i0.a.k(-16777216, 102);
        }
        this.P = k10;
        this.Q = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20025l7, rl0Var.f28511m2);
        this.f23434c.setColor(this.P);
        TextPaint textPaint = this.E;
        if (i10 == 0) {
            textPaint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20061n7, rl0Var.f28511m2));
        } else {
            textPaint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, rl0Var.f28511m2));
        }
        invalidate();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (i14 == 0) {
            ...
            rl0 rl0Var = this.f23445l0;
            f12 = 8.0f;
            paint.setColor(i0.a.d(0.1f, org.telegram.ui.ActionBar.j6.v0(i15, rl0Var.f28511m2), -1));
            float dp3 = AndroidUtilities.dp(27.0f) + ceil;
            pg.b bVar = this.f23433b0;
            if (bVar != null) {
                c3 = 2;
                f13 = 24.0f;
            ...
            paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, rl0Var.f28511m2));
            canvas.save();
        ...
        if (i14 == 0) {
        ...
        } else if (i14 == 1 && this.f23447r != null && this.S != 0.0f) {
            canvas.save();
            ...
            this.f23447r.getHeight();
            AndroidUtilities.dp(6.0f);
            rectF.set((dp6 - (((1.0f - this.f23451y) * this.D) + (this.f23451y * this.f23447r.getWidth()))) - AndroidUtilities.dp(f11), (centerY - (this.f23447r.getHeight() / 2.0f)) - AndroidUtilities.dp(f12), dp6 - AndroidUtilities.dp(f10), (this.f23447r.getHeight() / 2.0f) + centerY + AndroidUtilities.dp(f12));
            Paint paint2 = this.d;
            int alpha = paint2.getAlpha();
            TextPaint textPaint = this.E;
            int alpha2 = textPaint.getAlpha();
            paint2.setAlpha((int) (alpha * this.S));
            if (this.f23435c0 != null) {
                Rect rect = AndroidUtilities.rectTmp2;
                rectF.round(rect);
                rect.inset(-AndroidUtilities.dp(f14), -AndroidUtilities.dp(f14));
                this.f23435c0.setBounds(rect);
                this.f23435c0.draw(canvas);
            } else {
                Drawable drawable2 = this.f23431a0;
                drawable2.setBounds((int) rectF.left, (int) rectF.top, (int) rectF.right, (int) rectF.bottom);
                drawable2.setAlpha((int) (this.S * 255.0f));
                drawable2.draw(canvas);
            }
            float f21 = this.f23451y;
            if (f21 != 1.0f) {
            ...
            if (this.f23451y != 1.0f) {
                canvas.save();
                rectF.inset(AndroidUtilities.dp(f14), AndroidUtilities.dp(2.0f));
                canvas.clipRect(rectF);
                if (this.v != null) {
                    textPaint.setAlpha((int) ((1.0f - this.f23451y) * alpha2 * this.S));
                    canvas.save();
                    ...
                    canvas.translate(width, (AndroidUtilities.dp(15.0f) * i12 * this.f23451y) + height);
                    this.v.draw(canvas);
                    canvas.restore();
                }
                if (this.f23449w != null) {
                    textPaint.setAlpha((int) (alpha2 * this.S * this.f23451y));
                    canvas.save();
                    float width2 = (dp6 - this.f23449w.getWidth()) - AndroidUtilities.dp(f13);
                    float height2 = centerY - (this.f23449w.getHeight() / 2.0f);
                    if (this.B) {
                        i11 = 1;
                    } else {
                        i11 = -1;
                    }
                    canvas.translate(width2, e2.c.w(1.0f, this.f23451y, AndroidUtilities.dp(15.0f) * i11, height2));
                    this.f23449w.draw(canvas);
                    canvas.restore();
                }
                if (this.f23450x != null) {
                    textPaint.setAlpha((int) (alpha2 * this.S));
                    canvas.save();
                    canvas.translate((dp6 - this.f23450x.getWidth()) - AndroidUtilities.dp(f13), centerY - (this.f23450x.getHeight() / 2.0f));
                    this.f23450x.draw(canvas);
                    canvas.restore();
                }
                canvas.restore();
            } else {
                textPaint.setAlpha((int) (alpha2 * this.S));
                canvas.save();
                canvas.translate((dp6 - this.f23447r.getWidth()) - AndroidUtilities.dp(f13), e2.c.w(1.0f, this.f23451y, AndroidUtilities.dp(15.0f), centerY - (this.f23447r.getHeight() / 2.0f)));
                this.f23447r.draw(canvas);
                canvas.restore();
            }
        ...
        boolean z10 = this.f23441h0;
        if ((z10 && this.f23447r != null && this.L < 1.0f) || ((!z10 || this.f23447r == null) && this.L > 0.0f)) {
            this.M = currentTimeMillis;
            invalidate();
            if (this.f23441h0 && this.f23447r != null) {
    ...
    public final boolean onTouchEvent(android.view.MotionEvent r10) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.al0.onTouchEvent(android.view.MotionEvent):boolean");
    }

    @Override
    public void setAlpha(float f10) {
        if (this.f23444k0 != f10) {
            this.f23444k0 = f10;
            super.setAlpha(f10 * this.f23443j0);
        }
    }
    ...
    public void setIsVisible(boolean z4) {
        ...
        if (this.U != z4) {
            ...
            this.f23443j0 = f10;
            super.setAlpha(this.f23444k0 * f10);
        }
    }
