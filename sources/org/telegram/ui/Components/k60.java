...
public final class k60 implements org.telegram.ui.yb0 {
    ...
    public final void b(TLRPC.TL_chatInviteExported tL_chatInviteExported, TLObject tLObject) {
        int i10;
        org.telegram.ui.jb jbVar = this.f25570a.f25831a.f26088c.f27552j0;
        if (jbVar != null) {
            ...
            if (new MessageObject(i10, tL_channelAdminLogEvent, (ArrayList<MessageObject>) wbVar.f38661n0, (HashMap<String, ArrayList<MessageObject>>) wbVar.m0, wbVar.f38652f, wbVar.T, true).contentType >= 0) {
                wbVar.R0();
                wbVar.E.l();
