...
public final class k60 implements org.telegram.ui.wb0 {
    ...
    public final void b(TLRPC.TL_chatInviteExported tL_chatInviteExported, TLObject tLObject) {
        int i10;
        org.telegram.ui.hb hbVar = this.f25550a.f25843a.f26106c.f27568j0;
        if (hbVar != null) {
            ...
            if (new MessageObject(i10, tL_channelAdminLogEvent, (ArrayList<MessageObject>) ubVar.f37920n0, (HashMap<String, ArrayList<MessageObject>>) ubVar.m0, ubVar.f37911f, ubVar.T, true).contentType >= 0) {
                ubVar.R0();
                ubVar.E.l();
