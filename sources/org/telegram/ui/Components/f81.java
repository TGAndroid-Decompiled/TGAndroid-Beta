...
public abstract class f81 extends View {
    public static final Object f24159f0 = new Object();
    public e81 E;
    ...
    public long f24160a;
    public final Paint f24161a0;
    public int f24162b;
    public final Paint f24163b0;
    public int f24164c;
    public final e6 f24165c0;
    public float d;
    public final Path f24166d0;
    public float e;
    public boolean f24167e0;
    public float f24168f;
    public boolean h;
    public boolean f24169n;
    public boolean f24170r;
    public float f24171s;
    public float v;
    public boolean f24172w;
    public ParcelFileDescriptor f24173x;
    public MediaMetadataRetriever f24174y;
    ...
    public f81(Context context) {
        ...
        this.f24161a0 = paint5;
        Paint paint6 = new Paint(1);
        this.f24163b0 = paint6;
        this.f24165c0 = new e6(0.0f, this, 0L, 200L, sr.f28342j);
        this.f24166d0 = new Path();
        paint.setColor(-1);
        paint2.setColor(-256);
    ...
    public final void a() {
        Bitmap bitmap;
        synchronized (f24159f0) {
            try {
                ParcelFileDescriptor parcelFileDescriptor = this.f24173x;
            ...
            try {
                MediaMetadataRetriever mediaMetadataRetriever = this.f24174y;
        ...
        for (int i10 = 0; i10 < this.F.size(); i10++) {
            ...
            if (d81Var != null && (bitmap = d81Var.f23624a) != null) {
                bitmap.recycle();
            }
        }
        this.F.clear();
    ...
    public long getLength() {
        return Math.max(1L, this.f24160a);
    }
    ...
    public final void onDraw(Canvas canvas) {
            ...
            if (!z10) {
                ...
                while (true) {
                    if (i10 >= arrayList.size()) {
                        break;
                    } else if (((d81) arrayList.get(i10)).f23624a == null) {
                        this.f24167e0 = true;
                        break;
                    } else {
                        i10++;
            ...
            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                ...
                if (bitmap != null) {
                    ...
                    if (f17 != 1.0f) {
                        ...
                        Paint paint = this.Q;
                        paint.setAlpha((int) (sr.h.getInterpolation(d81Var.f23625b) * 255.0f));
        ...
        if (!z11) {
            ...
            canvas2.drawRect(rectF4, this.f24161a0);
            canvas2.restore();
        ...
        float d = this.f24165c0.d(0.0f, false);
        if (d > 0.0f) {
            c(this.e, d, canvas2, paint3);
        }
        c(this.f24171s, 1.0f - d, canvas2, paint3);
        if (this.f24172w) {
            c(this.f24168f, 1.0f, canvas2, this.U);
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent != null) {
            ...
            int dp2 = AndroidUtilities.dp(22.0f) + ((int) (this.f24171s * f7));
                    ...
                    if (this.f24170r) {
                        ...
                        if (e81Var7 != null) {
                            ...
                            if (t71Var != null) {
                                ...
                                vVar3.j(1);
                                vVar3.h(f18);
                                photoViewer3.f31328q3.h(0.0f, false);
    ...
    public void setProgress(float f7) {
        float f10 = 0.0f;
        if (this.f24172w && (f7 <= 0.0f || f7 >= 1.0f)) {
            f7 = this.f24168f;
        }
        long j3 = this.f24160a;
        if (j3 != 0) {
            f10 = 240.0f / ((float) j3);
        }
        float f11 = this.f24171s;
        if (f7 < f11 && f7 <= this.d + f10 && f11 + f10 >= this.e) {
            this.f24165c0.d(1.0f, true);
        }
        this.f24171s = f7;
        invalidate();
    }
