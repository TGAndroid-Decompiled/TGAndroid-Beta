...
public final class k10 implements org.telegram.ui.ActionBar.s0, xd.i, org.telegram.ui.ActionBar.c2, cv0 {
    public final FragmentContextView f28250a;

    public k10(FragmentContextView fragmentContextView) {
        this.f28250a = fragmentContextView;
    }

    @Override
    public void b(LocationController.SharingLocationInfo sharingLocationInfo) {
        float[] fArr = FragmentContextView.J0;
        this.f28250a.k(sharingLocationInfo);
    }
    ...
    public void j(org.telegram.ui.ActionBar.d2 d2Var, int i10) {
        ...
        LocationController.getInstance(p2Var.getCurrentAccount()).removeSharingLocation(fragmentContextView.f24888n.a());
    }
