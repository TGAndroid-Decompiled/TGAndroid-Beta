...
public final class bq extends FrameLayout {
    ...
    public bq(Context context) {
        ...
        this.f22860b = textView;
        textView.setLines(1);
        textView.setSingleLine(true);
        textView.setGravity(1);
        textView.setEllipsize(TextUtils.TruncateAt.END);
        textView.setGravity(17);
        org.telegram.messenger.w1.q(textView, org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.Sh, false), 1, 14.0f);
    ...
    public void setText(CharSequence charSequence) {
        this.f22860b.setText(charSequence);
    }
}
