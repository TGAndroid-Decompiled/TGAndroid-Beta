...
public final class op extends mw0 {
        ...
        switch (this.f27622a) {
            case 0:
                if (this.f27625f != i10) {
                    ...
                    this.f27626g.setColor(i10);
                }
                this.f27625f = i10;
                return;
            default:
                Paint paint = this.f27626g;
                if (paint != null) {
                    paint.setColor(i10);
                    return;
                }
    ...
    public final void d() {
        switch (this.f27622a) {
            case 0:
                this.f27624c = System.currentTimeMillis();
                this.f27623b = true;
                invalidateSelf();
                return;
            default:
    ...
    public final void draw(Canvas canvas) {
        ...
        switch (this.f27622a) {
            case 0:
                ...
                float interpolation2 = mrVar2.getInterpolation(f11);
                if (this.d) {
                    dp = e2.c.w(1.0f, interpolation, AndroidUtilities.dp(7.0f) - AndroidUtilities.dp(2.1f), AndroidUtilities.dp(2.1f) * interpolation);
                    dpf2 = (1.0f - mrVar2.getInterpolation(this.e / 2.0f)) * AndroidUtilities.dpf2(1.5f);
                } else {
                ...
                Paint paint = this.f27626g;
                if (paint == null) {
                    paint = org.telegram.ui.ActionBar.j6.f19877d2;
                }
                Paint paint2 = (Paint) this.h;
                if (paint2 == null) {
                    paint2 = org.telegram.ui.ActionBar.j6.f19860c2;
                }
                ...
                if (this.f27623b) {
                    ...
                    long j10 = currentTimeMillis - this.f27624c;
            ...
            default:
                ...
                Paint paint3 = this.f27626g;
                if (paint3 == null) {
                    paint3 = org.telegram.ui.ActionBar.j6.f19877d2;
                }
                Paint paint4 = paint3;
                float f13 = 2.0f;
                ...
                for (int i12 = 0; i12 < 4; i12++) {
                    if (i12 == 0) {
                        paint4.setAlpha((int) (this.f27625f * this.e));
                    } else if (i12 == 3) {
                        paint4.setAlpha((int) ((1.0f - this.e) * this.f27625f));
                    } else {
                        paint4.setAlpha(this.f27625f);
                    }
                ...
                if (this.d) {
                    ...
                    long j11 = currentTimeMillis2 - this.f27624c;
                    this.f27624c = currentTimeMillis2;
                    if (j11 > 50) {
                        j11 = 50;
                    }
