...
public final class r81 extends FrameLayout {
    public static final int f27580f = 0;
    public final org.telegram.ui.ActionBar.f6 f27581a;
    public final tl0 f27582b;
    public final RectF f27583c;
    ...
    public r81(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        tl0Var.A = v02;
        tl0Var.f28170z = v02;
        tl0Var.f28168x = org.telegram.ui.ActionBar.j6.l1(0.1f, v02);
        tl0Var.f28155j = false;
        tl0Var.f28154i = false;
        tl0Var.k();
    }

    @Override
    public final void onDraw(Canvas canvas) {
        RectF rectF = this.f27583c;
        rectF.set(0.0f, 0.0f, getWidth(), getHeight());
        tl0 tl0Var = this.f27582b;
        float[] fArr = tl0Var.e;
        ...
        this.f27582b.d(canvas, rectF, 1.0f, false, false);
        RectF rectF2 = this.d;
    ...
    public void setWebPage(TLRPC.WebPage webPage) {
        ...
        org.telegram.ui.ActionBar.f6 f6Var = this.f27581a;
        if (str != null) {
        ...
        if (webPage.description != null) {
            ...
            textView3.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18970j5, f6Var));
        ...
        if (z10) {
            ...
            u9Var.setBackground(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(6.0f), org.telegram.ui.ActionBar.j6.l1(0.08f, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18970j5, f6Var))));
