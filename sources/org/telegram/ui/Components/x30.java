...
public final class x30 extends View implements GestureDetector.OnGestureListener {
    ...
    public boolean V;
    public w30 W;
    public final Paint f30253a;
    public ValueAnimator f30254a0;
    public final ArrayList f30255b;
    public ValueAnimator f30256b0;
    public final ArrayList f30257c;
    public float f30258c0;
    ...
    public x30(ContextThemeWrapper contextThemeWrapper, int i10) {
        ...
        this.f30260n = AndroidUtilities.dp(42.0f);
        this.f30261r = AndroidUtilities.dp(56.0f);
    ...
    private ImageReceiver getFreeReceiver() {
        ...
        ArrayList arrayList = this.f30255b;
        ...
        this.f30257c.add(imageReceiver);
        imageReceiver.setCurrentAccount(((org.telegram.ui.ns0) this.W).f35968a.T);
        return imageReceiver;
    }

    private int getMaxScrollX() {
        return ((this.v * 2) + this.f30260n) * this.f30259f;
    }

    private int getMinScrollX() {
        return ((this.v * 2) + this.f30260n) * (-((this.d.size() - this.f30259f) - 1));
    }
    ...
    public final void a(int i10, boolean z10) {
        ...
        Object obj;
        ArrayList arrayList = this.f30255b;
        ArrayList arrayList2 = this.f30257c;
            ...
            if (!arrayList3.isEmpty()) {
                ...
                if (z10) {
                    ...
                    while (i15 < size) {
                        ...
                        int i16 = ((i13 + i14) * (param - this.f30259f)) + measuredWidth2 + i10;
                ...
                String str2 = "avatar_";
                int i17 = this.f30261r;
                int i18 = this.f30262s;
                ArrayList arrayList4 = this.e;
                if (i11 != Integer.MIN_VALUE) {
                    int size2 = arrayList3.size();
                    while (i11 < size2) {
                        int i19 = ((i13 + i14) * (i11 - this.f30259f)) + measuredWidth2 + i10;
                        ...
                        if (arrayList4.get(0) instanceof MessageObject) {
                            ...
                            org.telegram.ui.pu0 pu0Var = ((org.telegram.ui.ns0) this.W).f35968a.f31272j7;
                            if (pu0Var != null) {
                                obj = pu0Var.g();
                            } else {
                                obj = null;
                            ...
                            obj = "avatar_" + ((org.telegram.ui.ns0) this.W).f35968a.f31414z5;
                        }
                ...
                if (i12 != Integer.MAX_VALUE) {
                    while (i12 >= 0) {
                        int i23 = ((i13 + i14) * (i12 - this.f30259f)) + i22 + i10 + i13;
                        if (i23 <= 0) {
                            break;
                        }
                        ...
                        if (arrayList4.get(0) instanceof MessageObject) {
                            ...
                            org.telegram.ui.pu0 pu0Var2 = ((org.telegram.ui.ns0) this.W).f35968a.f31272j7;
                            if (pu0Var2 != null) {
                                sb2 = pu0Var2.g();
                            } else {
                                sb2 = null;
                            ...
                            str = str2;
                            sb3.append(((org.telegram.ui.ns0) this.W).f35968a.f31414z5);
                            sb2 = sb3.toString();
                ...
                ValueAnimator valueAnimator = this.f30254a0;
    ...
    public final boolean c() {
        if (this.U && this.f30256b0 == null) {
            if (this.f30258c0 <= 0.0f && this.V) {
                ValueAnimator valueAnimator = this.f30254a0;
                if (valueAnimator != null && valueAnimator.isStarted()) {
                    return true;
                }
    ...
    public final void e() {
        ...
        if (i10 >= 0 && i10 < this.e.size()) {
            ...
            this.L = i11;
            this.F = i11;
            this.J = (this.f30260n + this.v) * (this.f30259f - i11);
            this.K = this.f30263w;
            this.f30264x = 1.0f;
            this.T = -1;
            w30 w30Var = this.W;
            if (w30Var != null) {
                PhotoViewer photoViewer = ((org.telegram.ui.ns0) w30Var).f35968a;
    ...
    public final void f() {
        ...
        int i11;
        int i12;
        int i13 = this.f30263w;
        int abs = Math.abs(i13);
        int i14 = this.f30260n;
        int i15 = this.v;
        int i16 = (i14 / 2) + i15;
        int i17 = -1;
        if (abs > i16) {
        ...
        this.T = this.f30259f - i10;
        PhotoViewer photoViewer = ((org.telegram.ui.ns0) this.W).f35968a;
        int i18 = photoViewer.P4;
        ArrayList arrayList = photoViewer.f31191a7;
        ArrayList arrayList2 = photoViewer.Y6;
        org.telegram.ui.pu0 pu0Var = photoViewer.f31272j7;
        if (pu0Var != null) {
            list = pu0Var.getAll();
        } else {
            list = null;
        ...
        if (i18 != i19 && i19 >= 0 && i19 < this.d.size()) {
            ...
            if (i17 >= 0) {
                this.R = true;
                ((org.telegram.ui.ns0) this.W).a(i17);
            }
        }
        if (!this.P) {
            this.P = true;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        boolean z10 = this.U;
        ArrayList arrayList = this.f30257c;
        if (z10 || !arrayList.isEmpty()) {
            float f10 = this.f30258c0;
            if (!this.V) {
                if (this.U) {
                    f10 = 1.0f;
                } else {
            ...
            if (!arrayList.isEmpty()) {
                ...
                if (i22 >= 0 && i22 < arrayList2.size()) {
                    ...
                    if (imageLocation2 != null && (photoSize = imageLocation2.photoSize) != null) {
                        i19 = Math.max(i16, (int) ((i19 / photoSize.h) * photoSize.f18360w));
                    }
                } else {
                    i19 = i16;
                }
                ...
                for (int size = arrayList.size(); i26 < size; size = i14) {
                    ...
                    if (param == i27) {
                        ...
                        if (i28 < i27) {
                            if (param < i27) {
                                if (param <= i28) {
                                    imageReceiver.setImageX(((((i16 + i29) * ((imageReceiver.getParam() - this.f30259f) + 1)) + measuredWidth) - (i29 + i25)) + i24);
                                } else {
                                    imageReceiver.setImageX(((i29 + i16) * (imageReceiver.getParam() - this.f30259f)) + measuredWidth + i24);
                                }
                                i14 = size;
                            } else {
                                i14 = size;
                                imageReceiver.setImageX(((i29 + i16) * ((imageReceiver.getParam() - this.f30259f) - 1)) + measuredWidth + i21 + i29 + i24);
                            }
                        } else {
                            i14 = size;
                            if (param < i27) {
                                ...
                                imageReceiver.setImageX(i29 + i25 + ((i16 + i29) * ((imageReceiver.getParam() - this.f30259f) - 2)) + measuredWidth + i21 + i29 + i24);
                            }
                        }
                        if (param == this.F) {
                    ...
                    imageReceiver.setAlpha(this.f30258c0);
                ...
                if (i30 >= 0) {
                    ...
                    if (f16 > 0.0f) {
                        ...
                        if (i30 == this.f30259f) {
                            ...
                            this.f30263w = this.K + ((int) Math.ceil(this.f30265y * (this.J - i13)));
                        } else {
                            sr srVar = sr.f28340g;
                            this.E = srVar.getInterpolation(1.0f - f18);
                            if (this.Q) {
                                float f21 = this.f30265y;
                                if (f21 > 0.0f) {
                                ...
                                this.f30263w = this.K + ((int) Math.ceil(interpolation * (this.J - i12)));
                            } else {
                                this.f30265y = srVar.getInterpolation(this.f30264x);
                                this.f30263w = (int) Math.ceil(this.E * this.J);
                            }
                        }
                        if (this.f30264x <= 0.0f) {
                            this.f30259f = this.L;
                            this.f30264x = 1.0f;
                            this.f30265y = 1.0f;
                            this.E = 0.0f;
                ...
                if (!scroller.isFinished()) {
                    if (scroller.computeScrollOffset()) {
                        this.f30263w = scroller.getCurrX();
                        f();
                        invalidate();
                    }
                    if (scroller.isFinished()) {
    ...
    public final boolean onFling(MotionEvent motionEvent, MotionEvent motionEvent2, float f7, float f10) {
        ...
        scroller.abortAnimation();
        if (this.d.size() >= 10) {
            scroller.fling(this.f30263w, 0, Math.round(f7), 0, getMinScrollX(), getMaxScrollX(), 0, 0);
            return false;
        }
        return false;
    }
    ...
    public final boolean onScroll(MotionEvent motionEvent, MotionEvent motionEvent2, float f7, float f10) {
        this.f30263w = (int) (this.f30263w - f7);
        int minScrollX = getMinScrollX();
        int maxScrollX = getMaxScrollX();
        int i10 = this.f30263w;
        if (i10 < minScrollX) {
            this.f30263w = minScrollX;
        } else if (i10 > maxScrollX) {
            this.f30263w = maxScrollX;
        }
        f();
        return false;
    }
    ...
    public final boolean onSingleTapUp(MotionEvent motionEvent) {
        ...
        e();
        ArrayList arrayList3 = this.f30257c;
                    ...
                    if (param < arrayList4.size()) {
                        if (arrayList2 != null && !arrayList2.isEmpty()) {
                            ...
                            if (i10 != indexOf) {
                                this.f30264x = 1.0f;
                                this.I = true;
                                ((org.telegram.ui.ns0) this.W).a(indexOf);
                                return false;
                            }
                        } else if (list != null && !list.isEmpty()) {
                            ...
                            if (i10 != indexOf2) {
                                this.f30264x = 1.0f;
                                this.I = true;
                                ((org.telegram.ui.ns0) this.W).a(indexOf2);
                                return false;
                            }
                        } else if (arrayList != null && !arrayList.isEmpty()) {
                            ...
                            if (i10 != indexOf3) {
                                this.f30264x = 1.0f;
                                this.I = true;
                                ((org.telegram.ui.ns0) this.W).a(indexOf3);
                                return false;
                            }
                        }
                    }
    ...
    public void setAnimationsEnabled(boolean z10) {
        if (this.S != z10) {
            ...
            if (!z10) {
                ...
                ValueAnimator valueAnimator2 = this.f30256b0;
    ...
    public void setMoveProgress(float f7) {
        ...
        if (!this.P && this.L < 0) {
            ...
            if (i11 >= 0 && i11 < arrayList.size()) {
                this.f30265y = 1.0f - Math.abs(f7);
            } else {
                this.f30265y = 1.0f;
            }
            this.E = 1.0f - this.f30265y;
            if (i10 != 0) {
                z10 = true;
            } else {
                z10 = false;
            ...
            invalidate();
            if (!arrayList.isEmpty()) {
                if (f7 >= 0.0f || this.f30259f != arrayList.size() - 1) {
                    if (i10 <= 0 || this.f30259f != 0) {
                        int i12 = (int) (f7 * (this.f30260n + this.v));
                        this.f30263w = i12;
                        a(i12, true);
                    }
                }
