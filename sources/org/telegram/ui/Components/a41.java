...
public final class a41 extends h51 {
    ...
    public final void bindView(View view, i51 i51Var, boolean z10, w51 w51Var, e61 e61Var) {
        ...
        LinearLayout linearLayout = b41Var.f22618r;
        LinearLayout linearLayout2 = b41Var.h;
        LinearLayout linearLayout3 = b41Var.f22614b;
        b41Var.f22615c.setText(charSequence);
        b41Var.d.setText(charSequence2);
        b41Var.e.setText(charSequence3);
        ImageView imageView = b41Var.f22616f;
        int i12 = 8;
    ...
    public final boolean contentsEquals(i51 i51Var, i51 i51Var2) {
        if (TextUtils.equals(i51Var.f24894l, i51Var2.f24894l) && TextUtils.equals(i51Var.f24895m, i51Var2.f24895m) && TextUtils.equals(i51Var.f24896n, i51Var2.f24896n) && i51Var.E == i51Var2.E) {
            return true;
        }
        return false;
    }
