...
public final class a41 extends Thread {
    ...
    public final void run() {
        ...
        String str3 = null;
        try {
            httpURLConnection = (HttpURLConnection) new URI(("https://translate.googleapis.com/translate_a/single?client=gtx&sl=" + Uri.encode(this.f22494a) + "&tl=" + Uri.encode(this.f22495b) + "&dt=t&ie=UTF-8&oe=UTF-8&otf=1&ssel=0&tsel=0&kc=7&dt=at&dt=bd&dt=ex&dt=ld&dt=md&dt=qca&dt=rw&dt=rm&dt=ss&q=") + str2).toURL().openConnection();
        } catch (Exception e) {
            e = e;
        ...
        try {
            ...
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(httpURLConnection.getInputStream(), d9.d.f7564a));
            while (true) {
            ...
            AndroidUtilities.runOnUIThread(new po0(15, callback2, str4));
        } catch (Exception e7) {
            e = e7;
            try {
