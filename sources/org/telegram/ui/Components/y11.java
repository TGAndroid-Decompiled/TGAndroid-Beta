...
public final class y11 extends TextView {
    public View f30137a;
    public ViewPropertyAnimator f30138b;
    ...
    public final void a() {
        ...
        int i11 = 0;
        int i12 = 0;
        for (View view2 = this.f30137a; view2 != view; view2 = (View) view2.getParent()) {
            i12 += view2.getTop();
            i11 += view2.getLeft();
        }
        int width = ((this.f30137a.getWidth() / 2) + i11) - (getMeasuredWidth() / 2);
        if (width >= 0) {
