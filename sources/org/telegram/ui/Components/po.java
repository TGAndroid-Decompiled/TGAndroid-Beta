...
public final class po {
    public final org.telegram.ui.ActionBar.f1 f27096a;
    public final org.telegram.ui.ActionBar.f1 f27097b;
    public final org.telegram.ui.ActionBar.f1 f27098c;
    public final org.telegram.ui.ActionBar.f1 d;
    public final org.telegram.ui.ActionBar.f1 e;
    public final no f27099f;
    public final int f27100g;
    public org.telegram.ui.ActionBar.n1 h;
    public final oo f27101i;
    public long f27102j;
    public int f27103k;
    public int f27104l;
    public final FrameLayout f27105m;
    public final TextView f27106n;
    public int f27107o;
            ...
            public final void onClick(View view) {
                switch (r3) {
                    case 0:
                        ...
                        return;
                    case 1:
                        po poVar = this.f25995b;
                        poVar.a();
                        ooVar.t(poVar.f27104l);
                        return;
                    case 2:
                        po poVar2 = this.f25995b;
                        poVar2.a();
                        ooVar.t(poVar2.f27103k);
                        return;
                    case 3:
                        this.f25995b.a();
                        ooVar.o();
    ...
    public final void a() {
        ...
        this.f27101i.dismiss();
        this.f27102j = System.currentTimeMillis();
    }
    ...
    public final void d(long j3, long j10, HashSet hashSet) {
        ...
        int i11;
        int i12;
        if (System.currentTimeMillis() - this.f27102j < 200) {
        ...
        org.telegram.ui.ActionBar.f1 f1Var = this.f27097b;
        org.telegram.ui.ActionBar.f1 f1Var2 = this.f27098c;
        if (isDialogMuted) {
        ...
        if (!isDialogMuted && this.f27107o != 1) {
        ...
        FrameLayout frameLayout = this.f27105m;
        TextView textView = this.f27106n;
        if (hashSet != null && !hashSet.isEmpty()) {
            frameLayout.setVisibility(0);
            textView.setVisibility(0);
            textView.setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("TopicNotificationsExceptions", hashSet.size(), new Object[0]), org.telegram.ui.ActionBar.i6.f19018n6, 1, null));
            return;
        }
