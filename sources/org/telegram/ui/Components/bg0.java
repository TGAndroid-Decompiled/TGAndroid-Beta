...
public abstract class bg0 extends FrameLayout {
    ...
    public jc0 L;
    public int f22983a;
    public PhotoViewer f22984b;
    public LinearLayout f22985c;
    public TextView d;
    public TextView e;
    public pu f22986f;
    public ci.eb h;
    public RadialProgressView f22987n;
    public View f22988r;
    public String f22989s;
    public ArrayList v;
    public String f22990w;
    public boolean f22991x;
    public TLRPC.WebPage f22992y;
    ...
    public final boolean e() {
        boolean z10;
        if (this.f22991x && "inapp".equals(MessagesController.getInstance(this.f22983a).youtubePipType)) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (!z10 && Build.VERSION.SDK_INT >= 23 && !Settings.canDrawOverlays(getContext())) {
            ...
            return false;
        } else if (this.f22987n.getVisibility() == 0) {
            return false;
        } else {
            if (rg0.f27960p0.P) {
                rg0.j(false);
            ...
            pu puVar = this.f22986f;
            TLRPC.WebPage webPage = this.f22992y;
    ...
    public final void h(String str) {
        this.f22986f.evaluateJavascript(str, null);
    }
    ...
    public void setPlaybackSpeed(float f7) {
        this.E = f7;
        if (this.f22987n.getVisibility() != 0) {
            if (this.f22991x) {
