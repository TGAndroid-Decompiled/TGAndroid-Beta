...
public abstract class fu extends EditText {
    ...
    public fu(Context context) {
        ...
        this.spoilerTimeout = new eu(this, 2);
        this.rect = new Rect();
    ...
    public static void a(fu fuVar) {
        fuVar.postedSpoilerTimeout = false;
    ...
    public void onTextChanged(java.lang.CharSequence r4, int r5, int r6, int r7) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.fu.onTextChanged(java.lang.CharSequence, int, int, int):void");
    }
