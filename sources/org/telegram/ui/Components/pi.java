...
public final class pi extends qi {
    ...
    public pi(vi viVar, Context context) {
        ...
        bVar.a(false);
        bVar.f15545b.setLayoutParams(w7.x5.d(24, 24.0f, 49, 0.0f, 4.0f, 0.0f, 0.0f));
    ...
    public final void a(int i10, String str, oh.a aVar) {
        ...
        this.f27358a.setTabAnimation(aVar);
        this.f27050b = i10;
    }
    ...
    public final void onAttachedToWindow() {
        ...
        if (this.f27050b == this.f27051c.W0) {
            z10 = true;
        } else {
            z10 = false;
        }
        this.f27358a.e(z10, false);
    }
}
