...
public final class pi extends qi {
    ...
    public pi(vi viVar, Context context) {
        ...
        bVar.a(false);
        bVar.f15686b.setLayoutParams(w7.y5.d(24, 24.0f, 49, 0.0f, 4.0f, 0.0f, 0.0f));
    ...
    public final void a(int i10, String str, oh.a aVar) {
        this.f27614a.setText(str);
        this.f27614a.setTabAnimation(aVar);
        this.f27237b = i10;
    }
    ...
    public final void onAttachedToWindow() {
        ...
        if (this.f27237b == this.f27238c.W0) {
            z10 = true;
        } else {
            z10 = false;
        }
        this.f27614a.e(z10, false);
    }
}
