...
public final class k81 extends View {
    ...
    public float I;
    public final org.telegram.ui.ActionBar.f6 f25588a;
    public final Paint f25589b;
    public final Paint f25590c;
    public final TextPaint d;
    public final Paint e;
    public String f25591f;
    public int h;
    public int f25592n;
    public final RectF f25593r;
    public boolean f25594s;
    public final Canvas v;
    public final Bitmap f25595w;
    public float f25596x;
    public ObjectAnimator f25597y;
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        if (z11) {
            ...
            this.f25597y = ofFloat;
            ofFloat.setDuration(300L);
            this.f25597y.start();
            return;
        }
        ObjectAnimator objectAnimator = this.f25597y;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        RectF rectF = this.f25593r;
        rectF.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
        View view = this.E;
        org.telegram.ui.ActionBar.f6 f6Var = this.f25588a;
        ...
        canvas2.drawText(this.f25591f, AndroidUtilities.dp(28.0f) + y3, AndroidUtilities.dp(21.0f), textPaint);
        canvas2.save();
        canvas2.translate(y3, AndroidUtilities.dp(7.0f));
        Bitmap bitmap = this.f25595w;
        int i11 = 0;
        Paint paint3 = this.e;
        if (bitmap != null) {
            float f12 = this.f25596x;
            if (f12 <= 0.5f) {
                f7 = f12 / 0.5f;
                f10 = f7;
            } else {
            ...
            if (f10 != 1.0f) {
                ...
                canvas3.drawRoundRect(rectF, rectF.width() / 2.0f, rectF.height() / 2.0f, this.f25589b);
            }
            if (this.f25596x > 0.5f) {
                Paint paint4 = this.f25590c;
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(org.telegram.messenger.wl.C(56.0f, this.f25592n, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(32.0f), 1073741824));
    }
