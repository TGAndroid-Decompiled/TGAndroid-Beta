    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f25643a) {
            case 0:
                ...
                return;
            case 1:
                x81 x81Var2 = this.f25644b;
                x81Var2.getClass();
                x81Var2.S = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                return;
            case 2:
                x81 x81Var3 = this.f25644b;
                x81Var3.N.onAnimationUpdate(valueAnimator);
                x81Var3.M.f29960a = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                x81Var3.M.v.g1();
                x81Var3.M.invalidate();
                return;
            default:
                x81 x81Var4 = this.f25644b;
                x81Var4.getClass();
