...
public final class k81 extends View {
    ...
    public float I;
    public final org.telegram.ui.ActionBar.f6 f25585a;
    public final Paint f25586b;
    public final Paint f25587c;
    public final TextPaint d;
    public final Paint e;
    public String f25588f;
    public int h;
    public int f25589n;
    public final RectF f25590r;
    public boolean f25591s;
    public final Canvas v;
    public final Bitmap f25592w;
    public float f25593x;
    public ObjectAnimator f25594y;
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        if (z11) {
            ...
            this.f25594y = ofFloat;
            ofFloat.setDuration(300L);
            this.f25594y.start();
            return;
        }
        ObjectAnimator objectAnimator = this.f25594y;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        RectF rectF = this.f25590r;
        rectF.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
        View view = this.E;
        org.telegram.ui.ActionBar.f6 f6Var = this.f25585a;
        ...
        canvas2.drawText(this.f25588f, AndroidUtilities.dp(28.0f) + y3, AndroidUtilities.dp(21.0f), textPaint);
        canvas2.save();
        canvas2.translate(y3, AndroidUtilities.dp(7.0f));
        Bitmap bitmap = this.f25592w;
        int i11 = 0;
        Paint paint3 = this.e;
        if (bitmap != null) {
            float f12 = this.f25593x;
            if (f12 <= 0.5f) {
                f7 = f12 / 0.5f;
                f10 = f7;
            } else {
            ...
            if (f10 != 1.0f) {
                ...
                canvas3.drawRoundRect(rectF, rectF.width() / 2.0f, rectF.height() / 2.0f, this.f25586b);
            }
            if (this.f25593x > 0.5f) {
                Paint paint4 = this.f25587c;
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(org.telegram.messenger.wl.C(56.0f, this.f25589n, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(32.0f), 1073741824));
    }
