...
public final class eh0 extends View {
    ...
    public bh0 W;
    public final ArrayList f23555a;
    public float f23556a0;
    public final Paint f23557b;
    public float f23558b0;
    public final Paint f23559c;
    public long f23560c0;
    public float d;
    public ah0 f23561d0;
    public boolean e;
    public float f23562f;
    public final Path h;
    public final Path f23563n;
    public org.telegram.ui.o01 f23564r;
    public float f23565s;
    public float v;
    public RenderNode f23566w;
    public int f23567x;
    ...
    public eh0(Context context, int i10) {
        ...
        this.f23557b = paint;
        this.f23559c = new Paint();
        this.e = true;
        this.f23562f = -1.0f;
        this.h = new Path();
        this.f23563n = new Path();
        this.f23567x = 0;
        this.E = 0.0f;
        this.F = null;
        this.G = new HashSet();
        ...
        this.f23568y = (int) ((i10 - dpf2) - dpf22);
    ...
    public static bh0 j(int i10, List list) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            ...
            if (!bh0Var.f22739o && bh0Var.f22728a == i10) {
                return bh0Var;
            }
        }
        return null;
    ...
    public final void d() {
        ...
        if (this.H == 6) {
            this.f23567x = this.f23555a.size();
            invalidate();
            return;
        }
    ...
    public final void g() {
        ...
        if (i10 != 0) {
            ...
            float f10 = this.N;
            float max = ((measuredWidth - ((f10 / 2.0f) * Math.max(0, this.f23567x - 1))) - (f10 * 2.0f)) / Math.max(1, this.f23567x);
            float f11 = max / 2.0f;
            float f12 = this.f23568y / 2.0f;
            if (this.R) {
                f7 = max * 0.65f;
            } else {
                f7 = 1.0f;
            ...
            this.f23559c.setShader(radialGradient);
        }
    }

    @Override
    public AccessibilityNodeProvider getAccessibilityNodeProvider() {
        if (this.f23561d0 == null) {
            this.f23561d0 = new ah0(this);
        }
        return this.f23561d0;
    }
    ...
    public final bh0 k(int i10) {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                break;
            case 3:
                j3 = new bh0(this, ch0.f23038n);
                j3.f22744t = true;
                j3.f22747x = 200;
                break;
            case 4:
                j3 = new bh0(this, ch0.f23039r);
                break;
            case 5:
                j3 = new bh0(this, ch0.f23040s);
                this.K = j3;
                j3.f22744t = true;
                j3.f22747x = 500;
                break;
            case 6:
                ...
                break;
            case 7:
                j3 = new bh0(this, ch0.f23041w);
                j3.f22744t = true;
                j3.v = 300;
                break;
            case 8:
                j3 = new bh0(this, ch0.f23042x);
                j3.f22744t = true;
                j3.f22747x = 500;
                break;
            case 9:
                j3 = new bh0(this, ch0.f23043y);
                j3.f22744t = true;
                j3.f22745u = R.raw.profile_leave;
                j3.f22747x = 300;
                break;
            case 10:
                j3 = new bh0(this, ch0.E);
                j3.f22744t = true;
                j3.f22745u = R.raw.profile_voicechat;
                j3.f22747x = 500;
                break;
            case 11:
    ...
    public final void onMeasure(int i10, int i11) {
        setMeasuredDimension(View.MeasureSpec.getSize(i10), View.MeasureSpec.makeMeasureSpec((int) (this.f23568y + this.P + this.O), 1073741824));
    }
        ...
        if (this.E >= AndroidUtilities.dp(8.0f)) {
            ...
            if (action == 0) {
                ...
                while (true) {
                    ...
                    if (!bh0Var2.f22739o && bh0Var2.d.contains(x10, y3)) {
                        this.W = bh0Var2;
                        this.f23556a0 = x10;
                        this.f23558b0 = y3;
                        this.f23560c0 = System.currentTimeMillis();
                        this.W.f22729b.c(true);
                        break;
                    }
                    i10++;
                }
            } else if (action == 2) {
                if (this.W != null && (Math.abs(x10 - this.f23556a0) > 20.0f || Math.abs(y3 - this.f23558b0) > 20.0f)) {
                    this.W.f22729b.c(false);
                    this.W = null;
                }
            } else if ((action == 1 || action == 3) && (bh0Var = this.W) != null) {
                bh0Var.f22729b.c(false);
                if (action == 1 && this.W.d.contains(x10, y3)) {
                    if (System.currentTimeMillis() - this.f23560c0 > 250) {
                        try {
                    ...
                    bh0 bh0Var3 = this.W;
                    if (bh0Var3.f22744t && !bh0Var3.f22743s) {
                        bh0Var3.f22743s = true;
                        invalidate();
                    }
                    bh0 bh0Var4 = this.W;
                    int i11 = bh0Var4.f22745u;
                    if (i11 != 0) {
                        bh0Var4.d(i11, 0, 0);
                    }
                    this.W.f22746w = System.currentTimeMillis();
                    bh0 bh0Var5 = this.W;
                    dh0 dh0Var = this.F;
                    if (dh0Var != null) {
                        int i12 = bh0Var5.v;
                        if (i12 == 0) {
                            int i13 = bh0Var5.f22728a;
                            RectF rectF = bh0Var5.d;
                            ProfileActivity.Y(((org.telegram.ui.my0) dh0Var).f35907b, i13, rectF.left, rectF.top);
                        } else {
    ...
    public final void p(bh0 bh0Var, boolean z10) {
        ...
        if (z10) {
            if (this.J) {
                ch0 ch0Var2 = ch0.e;
                bh0Var.c(LocaleController.getString(ch0Var2.f23044a));
                bh0Var.d(R.raw.profile_unmuting, ch0Var2.f23045b, ch0Var2.f23046c);
                return;
            }
            ch0 ch0Var3 = ch0.f23037f;
            bh0Var.c(LocaleController.getString(ch0Var3.f23044a));
            bh0Var.d(R.raw.profile_muting, ch0Var3.f23045b, ch0Var3.f23046c);
            return;
        }
        if (this.J) {
            ch0Var = ch0.e;
        ...
        bh0Var.d(0, ch0Var.f23045b, ch0Var.f23046c);
        bh0Var.c(LocaleController.getString(ch0Var.f23044a));
    }
