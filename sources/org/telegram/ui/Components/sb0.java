...
public final class sb0 extends Drawable {
    ...
    public void b(int i10, int i11) {
        ((Paint) this.f28720c).setShader(new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.dp(28.0f), new int[]{i10, i11}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP));
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        switch (this.f28718a) {
            ...
            default:
                ...
                canvas.drawRoundRect(rectF, dp, dp, (Paint) this.f28720c);
                if (this.f28719b) {
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        switch (this.f28718a) {
            case 0:
                ((gj0) this.f28720c).setColorFilter(colorFilter);
