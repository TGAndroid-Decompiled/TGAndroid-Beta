...
public final class i0 extends Drawable {
    public final Drawable f24838a;
    public final Drawable f24839b;
    public final e6 f24840c = new e6(new h0(this, 0), 1200, rr.h, 0);

    public i0(Context context) {
        this.f24838a = context.getResources().getDrawable(R.drawable.input_ai).mutate();
        this.f24839b = context.getResources().getDrawable(R.drawable.input_ai_star).mutate();
    }

    @Override
    public final void draw(Canvas canvas) {
        Rect bounds = getBounds();
        Drawable drawable = this.f24838a;
        drawable.setBounds(bounds);
        drawable.draw(canvas);
        float d = this.f24840c.d(1.0f, false);
        ...
        Drawable drawable2 = this.f24839b;
    ...
    public final int getIntrinsicHeight() {
        return this.f24838a.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f24838a.getIntrinsicWidth();
    }
    ...
    public final void setAlpha(int i10) {
        this.f24838a.setAlpha(i10);
        this.f24839b.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f24838a.setColorFilter(colorFilter);
