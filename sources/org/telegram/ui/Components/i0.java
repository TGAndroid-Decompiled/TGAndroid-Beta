...
public final class i0 extends Drawable {
    ...
    public final e6 f24895c = new e6(new h0(this, 0), 1200, rr.h, 0);

    public i0(Context context) {
        this.f24893a = context.getResources().getDrawable(R.drawable.input_ai).mutate();
        this.f24894b = context.getResources().getDrawable(R.drawable.input_ai_star).mutate();
    }

    @Override
    public final void draw(Canvas canvas) {
        Rect bounds = getBounds();
        Drawable drawable = this.f24893a;
        drawable.setBounds(bounds);
        drawable.draw(canvas);
        float d = this.f24895c.d(1.0f, false);
        ...
        Drawable drawable2 = this.f24894b;
    ...
    public final int getIntrinsicHeight() {
        return this.f24893a.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f24893a.getIntrinsicWidth();
    }
    ...
    public final void setAlpha(int i10) {
        this.f24893a.setAlpha(i10);
        this.f24894b.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f24893a.setColorFilter(colorFilter);
        this.f24894b.setColorFilter(colorFilter);
    }
}
