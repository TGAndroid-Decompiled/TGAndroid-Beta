...
public final class i0 extends Drawable {
    ...
    public final Drawable f24784b;
    public final e6 f24785c = new e6(new h0(this, 0), 1200, qr.h, 0);

    public i0(Context context) {
        this.f24783a = context.getResources().getDrawable(R.drawable.input_ai).mutate();
        this.f24784b = context.getResources().getDrawable(R.drawable.input_ai_star).mutate();
    }

    @Override
    public final void draw(Canvas canvas) {
        Rect bounds = getBounds();
        Drawable drawable = this.f24783a;
        drawable.setBounds(bounds);
        drawable.draw(canvas);
        float d = this.f24785c.d(1.0f, false);
        ...
        Drawable drawable2 = this.f24784b;
    ...
    public final int getIntrinsicHeight() {
        return this.f24783a.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f24783a.getIntrinsicWidth();
    }
    ...
    public final void setAlpha(int i10) {
        this.f24783a.setAlpha(i10);
        this.f24784b.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f24783a.setColorFilter(colorFilter);
        this.f24784b.setColorFilter(colorFilter);
    }
}
