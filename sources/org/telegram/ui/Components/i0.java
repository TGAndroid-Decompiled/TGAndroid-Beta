...
public final class i0 extends Drawable {
    ...
    public final Drawable f24869b;
    public final e6 f24870c = new e6(new h0(this, 0), 1200, rr.h, 0);

    public i0(Context context) {
        this.f24868a = context.getResources().getDrawable(R.drawable.input_ai).mutate();
        this.f24869b = context.getResources().getDrawable(R.drawable.input_ai_star).mutate();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        float d = this.f24870c.d(1.0f, false);
        ...
        Drawable drawable2 = this.f24869b;
    ...
    public final int getIntrinsicHeight() {
        return this.f24868a.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f24868a.getIntrinsicWidth();
    }
    ...
    public final void setAlpha(int i10) {
        this.f24868a.setAlpha(i10);
        this.f24869b.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f24868a.setColorFilter(colorFilter);
        this.f24869b.setColorFilter(colorFilter);
    }
}
