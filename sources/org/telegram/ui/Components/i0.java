...
public final class i0 extends Drawable {
    public final Drawable f24827a;
    public final Drawable f24828b;
    public final c6 f24829c = new c6(new h0(this, 0), 1200, qr.h, 0);

    public i0(Context context) {
        this.f24827a = context.getResources().getDrawable(R.drawable.input_ai).mutate();
        this.f24828b = context.getResources().getDrawable(R.drawable.input_ai_star).mutate();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        float d = this.f24829c.d(1.0f, false);
        ...
        Drawable drawable2 = this.f24828b;
    ...
    public final int getIntrinsicHeight() {
        return this.f24827a.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f24827a.getIntrinsicWidth();
    }
    ...
    public final void setAlpha(int i10) {
        this.f24827a.setAlpha(i10);
        this.f24828b.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f24827a.setColorFilter(colorFilter);
