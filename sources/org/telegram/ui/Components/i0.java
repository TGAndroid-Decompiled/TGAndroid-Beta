...
public final class i0 extends Drawable {
    ...
    public final Drawable f24895b;
    public final e6 f24896c = new e6(new h0(this, 0), 1200, rr.h, 0);

    public i0(Context context) {
        this.f24894a = context.getResources().getDrawable(R.drawable.input_ai).mutate();
        this.f24895b = context.getResources().getDrawable(R.drawable.input_ai_star).mutate();
    }

    @Override
    public final void draw(Canvas canvas) {
        Rect bounds = getBounds();
        Drawable drawable = this.f24894a;
        drawable.setBounds(bounds);
        drawable.draw(canvas);
        float d = this.f24896c.d(1.0f, false);
        ...
        Drawable drawable2 = this.f24895b;
    ...
    public final int getIntrinsicHeight() {
        return this.f24894a.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f24894a.getIntrinsicWidth();
    }
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        ...
        this.f24895b.setColorFilter(colorFilter);
    }
}
