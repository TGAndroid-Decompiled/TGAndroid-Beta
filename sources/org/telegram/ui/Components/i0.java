...
public final class i0 extends Drawable {
    public final Drawable f24760a;
    public final Drawable f24761b;
    public final c6 f24762c = new c6(new h0(this, 0), 1200, qr.h, 0);

    public i0(Context context) {
        this.f24760a = context.getResources().getDrawable(R.drawable.input_ai).mutate();
        this.f24761b = context.getResources().getDrawable(R.drawable.input_ai_star).mutate();
    }

    @Override
    public final void draw(Canvas canvas) {
        Rect bounds = getBounds();
        Drawable drawable = this.f24760a;
        drawable.setBounds(bounds);
        drawable.draw(canvas);
        float d = this.f24762c.d(1.0f, false);
        ...
        Drawable drawable2 = this.f24761b;
    ...
    public final int getIntrinsicHeight() {
        return this.f24760a.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f24760a.getIntrinsicWidth();
    }
    ...
    public final void setAlpha(int i10) {
        this.f24760a.setAlpha(i10);
        this.f24761b.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f24760a.setColorFilter(colorFilter);
        this.f24761b.setColorFilter(colorFilter);
    }
}
