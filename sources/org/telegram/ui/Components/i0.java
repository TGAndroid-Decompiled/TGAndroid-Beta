...
public final class i0 extends Drawable {
    ...
    public final Drawable f24921b;
    public final e6 f24922c = new e6(new h0(this, 0), 1200, sr.h, 0);

    public i0(Context context) {
        this.f24920a = context.getResources().getDrawable(R.drawable.input_ai).mutate();
        this.f24921b = context.getResources().getDrawable(R.drawable.input_ai_star).mutate();
    }

    @Override
    public final void draw(Canvas canvas) {
        Rect bounds = getBounds();
        Drawable drawable = this.f24920a;
        drawable.setBounds(bounds);
        drawable.draw(canvas);
        float d = this.f24922c.d(1.0f, false);
        ...
        Drawable drawable2 = this.f24921b;
    ...
    public final int getIntrinsicHeight() {
        return this.f24920a.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f24920a.getIntrinsicWidth();
    }
    ...
    public final void setAlpha(int i10) {
        this.f24920a.setAlpha(i10);
        this.f24921b.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f24920a.setColorFilter(colorFilter);
        this.f24921b.setColorFilter(colorFilter);
    }
}
