...
public final class i0 extends Drawable {
    public final Drawable f24833a;
    public final Drawable f24834b;
    public final c6 f24835c = new c6(new h0(this, 0), 1200, qr.h, 0);

    public i0(Context context) {
        this.f24833a = context.getResources().getDrawable(R.drawable.input_ai).mutate();
        this.f24834b = context.getResources().getDrawable(R.drawable.input_ai_star).mutate();
    }

    @Override
    public final void draw(Canvas canvas) {
        Rect bounds = getBounds();
        Drawable drawable = this.f24833a;
        drawable.setBounds(bounds);
        drawable.draw(canvas);
        float d = this.f24835c.d(1.0f, false);
        ...
        Drawable drawable2 = this.f24834b;
    ...
    public final int getIntrinsicHeight() {
        return this.f24833a.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f24833a.getIntrinsicWidth();
    }
    ...
    public final void setAlpha(int i10) {
        this.f24833a.setAlpha(i10);
        this.f24834b.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f24833a.setColorFilter(colorFilter);
        this.f24834b.setColorFilter(colorFilter);
    }
}
