...
public final class i0 extends Drawable {
    ...
    public final c6 f24765c = new c6(new h0(this, 0), 1200, qr.h, 0);

    public i0(Context context) {
        this.f24763a = context.getResources().getDrawable(R.drawable.input_ai).mutate();
        this.f24764b = context.getResources().getDrawable(R.drawable.input_ai_star).mutate();
    }

    @Override
    public final void draw(Canvas canvas) {
        Rect bounds = getBounds();
        Drawable drawable = this.f24763a;
        drawable.setBounds(bounds);
        drawable.draw(canvas);
        float d = this.f24765c.d(1.0f, false);
        ...
        Drawable drawable2 = this.f24764b;
    ...
    public final int getIntrinsicHeight() {
        return this.f24763a.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f24763a.getIntrinsicWidth();
    }
    ...
    public final void setAlpha(int i10) {
        this.f24763a.setAlpha(i10);
        this.f24764b.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f24763a.setColorFilter(colorFilter);
        this.f24764b.setColorFilter(colorFilter);
    }
}
