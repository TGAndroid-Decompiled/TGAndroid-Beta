...
public final class i0 extends Drawable {
    public final Drawable f24910a;
    public final Drawable f24911b;
    public final d6 f24912c = new d6(new h0(this, 0), 1200, qr.h, 0);

    public i0(Context context) {
        this.f24910a = context.getResources().getDrawable(R.drawable.input_ai).mutate();
        this.f24911b = context.getResources().getDrawable(R.drawable.input_ai_star).mutate();
    }

    @Override
    public final void draw(Canvas canvas) {
        Rect bounds = getBounds();
        Drawable drawable = this.f24910a;
        drawable.setBounds(bounds);
        drawable.draw(canvas);
        float d = this.f24912c.d(1.0f, false);
        ...
        Drawable drawable2 = this.f24911b;
    ...
    public final int getIntrinsicHeight() {
        return this.f24910a.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f24910a.getIntrinsicWidth();
    }
