...
public final class i0 extends Drawable {
    ...
    public final d6 f24802c = new d6(new h0(this, 0), 1200, qr.h, 0);

    public i0(Context context) {
        this.f24800a = context.getResources().getDrawable(R.drawable.input_ai).mutate();
        this.f24801b = context.getResources().getDrawable(R.drawable.input_ai_star).mutate();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        float d = this.f24802c.d(1.0f, false);
        ...
        Drawable drawable2 = this.f24801b;
    ...
    public final int getIntrinsicHeight() {
        return this.f24800a.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f24800a.getIntrinsicWidth();
    }
    ...
    public final void setAlpha(int i10) {
        ...
        this.f24801b.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f24800a.setColorFilter(colorFilter);
        this.f24801b.setColorFilter(colorFilter);
    }
}
