...
public final class us extends AnimatorListenerAdapter {
    ...
    public final s4.c1 f30992b;
    public final org.telegram.ui.Cells.r2 f30993c;
    public final zs d;
    ...
    public final void onAnimationEnd(Animator animator) {
        switch (this.f30991a) {
            case 0:
                ...
                org.telegram.ui.Cells.r2 r2Var = this.f30993c;
                r2Var.setClipProgress(0.0f);
                r2Var.setElevation(0.0f);
                zs zsVar = this.d;
                s4.c1 c1Var = this.f30992b;
                zsVar.d(c1Var);
            ...
            default:
                animator.removeAllListeners();
                org.telegram.ui.Cells.r2 r2Var2 = this.f30993c;
                r2Var2.setClipProgress(0.0f);
                r2Var2.setElevation(0.0f);
                zs zsVar2 = this.d;
                s4.c1 c1Var2 = this.f30992b;
                zsVar2.d(c1Var2);
                zsVar2.f33252x.remove(c1Var2);
                zsVar2.A();
                return;
        }
    }
