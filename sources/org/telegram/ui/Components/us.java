...
public abstract class us extends j61 {
    ...
    public int Z;
    public int f28911a0;
    public String f28912b0;
    public final yp f28913c0;
    ...
    public us(wl0 wl0Var, Context context, int i10, int i11) {
        ...
        go0 go0Var = (go0) this;
        this.f28913c0 = new yp(go0Var, 6);
        this.f25291s = new d(go0Var, 9);
        this.N = i10;
        this.O = i11;
        N(false);
    }
    ...
    public final void V(boolean r9) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.us.V(boolean):void");
    }
