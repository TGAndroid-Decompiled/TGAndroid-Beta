...
public final class zp0 extends kl0 {
    public final Context f33202c;
    public final ArrayList d = new ArrayList();
    public final a0.i f33203e = new a0.i();
    public final hq0 f33204f;
    ...
    public final void E() {
        ...
        arrayList.clear();
        a0.i iVar = this.f33203e;
        iVar.b();
        hq0 hq0Var = this.f33204f;
        ...
        org.telegram.ui.co coVar = hq0Var.f26797f0;
        if (coVar != null) {
            int i16 = coVar.f35185a;
            if (i16 != 1) {
                if (i16 == 2) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            if (hq0Var.f26799h0 && hq0Var.f26806o0[1] != null) {
                f7 = 109.0f;
            } else {
                f7 = 56.0f;
            }
