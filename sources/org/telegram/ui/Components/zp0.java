...
public final class zp0 extends kl0 {
    ...
    public final a0.i f33230e = new a0.i();
    public final hq0 f33231f;
    ...
    public final void E() {
        ...
        arrayList.clear();
        a0.i iVar = this.f33230e;
        iVar.b();
        hq0 hq0Var = this.f33231f;
        ...
        if (hq0Var.Z) {
            ...
            dialog.f19900id = Long.MAX_VALUE;
        ...
        for (int i15 = 0; i15 < allDialogs.size(); i15++) {
            ...
            if (dialog3 instanceof TLRPC.TL_dialog) {
                long j10 = dialog3.f19900id;
                if (j10 != j3 && !DialogObject.isEncryptedDialog(j10)) {
                    if (!DialogObject.isUserDialog(dialog3.f19900id)) {
                        i13 = ((org.telegram.ui.ActionBar.f3) hq0Var).currentAccount;
                        TLRPC.Chat chat = MessagesController.getInstance(i13).getChat(Long.valueOf(-dialog3.f19900id));
                        if (chat != null && !ChatObject.isNotInChat(chat) && ((!chat.gigagroup || ChatObject.hasAdminRights(chat)) && (!ChatObject.isChannel(chat) || chat.creator || (((tL_chatAdminRights = chat.admin_rights) != null && tL_chatAdminRights.post_messages) || chat.megagroup)))) {
                            ...
                            iVar.k(dialog3, dialog3.f19900id);
                        }
                    } else {
                        if (dialog3.folder_id == 1) {
                            arrayList2.add(dialog3);
        ...
        org.telegram.ui.co coVar = hq0Var.f26824f0;
        if (coVar != null) {
            int i16 = coVar.f35212a;
            if (i16 != 1) {
                if (i16 == 2) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            if (hq0Var.f26826h0 && hq0Var.f26833o0[1] != null) {
                f7 = 109.0f;
            } else {
                f7 = 56.0f;
            }
