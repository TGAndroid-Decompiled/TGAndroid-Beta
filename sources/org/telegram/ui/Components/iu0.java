...
public final class iu0 extends kl0 {
    public int E;
    public final xu0 G;
    public final Context f27259c;
    public final int d;
    public boolean f27263r;
    public String f27265w;
    public ah.j1 f27266x;
    public final ArrayList f27260e = new ArrayList();
    public final ArrayList f27261f = new ArrayList();
    public final ArrayList h = new ArrayList();
    public final ArrayList f27262n = new ArrayList();
    public boolean f27264s = false;
    public int v = 0;
    public int f27267y = -1;
    public final jq0 F = new jq0(this, 6);

    public iu0(xu0 xu0Var, Context context) {
        this.G = xu0Var;
        this.f27259c = context;
        this.d = xu0Var.f32727v1.getCurrentAccount();
        C(true);
    }
    ...
    public final void E(ah.j1 j1Var, String str) {
        long j3;
        if (TextUtils.equals(str, this.f27265w)) {
            ah.j1 j1Var2 = this.f27266x;
        ...
        this.f27265w = str;
        this.f27266x = j1Var;
        int i10 = this.f27267y;
        int i11 = this.d;
        if (i10 >= 0) {
            ConnectionsManager.getInstance(i11).cancelRequest(this.f27267y, true);
            this.f27267y = -1;
        }
        this.f27262n.clear();
        this.h.clear();
    ...
    public final void F() {
        if (TextUtils.isEmpty(this.f27265w) && this.f27266x == null) {
            this.f27263r = false;
            return;
        }
        ...
        tL_messages_search.f19978q = this.f27265w;
        ah.j1 j1Var = this.f27266x;
        if (j1Var != null) {
        ...
        if (this.f27266x != null) {
            MessagesStorage.getInstance(i10).searchSavedByTag(this.f27266x.g(), 0L, this.f27265w, 100, this.f27262n.size(), new bi.x2(1, this, dmVar), false);
        } else {
            dmVar.run();
        }
    }
    ...
    public final void G(boolean z10) {
        ...
        qt0[] qt0VarArr = this.G.f32703k0;
        ArrayList arrayList2 = this.f27261f;
        arrayList2.clear();
        ...
        if (!z10 || !arrayList.isEmpty()) {
            for (int i12 = 0; i12 < qt0VarArr.length; i12++) {
                if (qt0VarArr[i12].F == 11 && arrayList2.isEmpty() && this.f27260e.isEmpty()) {
                    wh.p pVar = qt0VarArr[i12].f29824w.d;
                    if (this.f27266x != null && TextUtils.isEmpty(this.f27265w)) {
                        String string = LocaleController.getString(R.string.NoResultFoundForTag);
                        ah.j1 j1Var = this.f27266x;
                        Paint.FontMetricsInt fontMetricsInt = qt0VarArr[i12].f29824w.d.getPaint().getFontMetricsInt();
                        if (!TextUtils.isEmpty(j1Var.f597f)) {
                            charSequence = j1Var.f597f;
                        } else {
                            SpannableString spannableString = new SpannableString("😀");
                            spannableString.setSpan(new z5(j1Var.f598g, fontMetricsInt), 0, spannableString.length(), 17);
                            charSequence = spannableString;
                        }
                        formatString = AndroidUtilities.replaceCharSequence("%s", string, charSequence);
                    } else {
                        formatString = LocaleController.formatString(R.string.NoResultFoundFor, this.f27265w);
                    }
                    pVar.setText(formatString);
                    qt0VarArr[i12].f29824w.f32757f.setVisibility(8);
                    qt0VarArr[i12].f29824w.e(false, true);
                }
            }
        }
        l();
    ...
    @Override
    public final int h() {
        return this.f27261f.size() + this.f27260e.size();
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        hg.a0 a0Var = new hg.a0(1, this.f27259c, true);
        xu0 xu0Var = this.G;
        a0Var.setDialogCellDelegate(xu0Var);
        a0Var.f22618r0 = true;
        a0Var.setBackgroundColor(xu0Var.h0(org.telegram.ui.ActionBar.j6.f20664d6));
