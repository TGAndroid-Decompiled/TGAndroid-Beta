...
public final class iu0 extends kl0 {
    ...
    public ah.j1 f27293x;
    public final ArrayList f27287e = new ArrayList();
    public final ArrayList f27288f = new ArrayList();
    public final ArrayList h = new ArrayList();
    public final ArrayList f27289n = new ArrayList();
    public boolean f27291s = false;
    public int v = 0;
    public int f27294y = -1;
    public final jq0 F = new jq0(this, 6);

    public iu0(xu0 xu0Var, Context context) {
        this.G = xu0Var;
        this.f27286c = context;
        this.d = xu0Var.f32754v1.getCurrentAccount();
        C(true);
    }
    ...
    public final void E(ah.j1 j1Var, String str) {
        long j3;
        if (TextUtils.equals(str, this.f27292w)) {
            ah.j1 j1Var2 = this.f27293x;
        ...
        this.f27292w = str;
        this.f27293x = j1Var;
        int i10 = this.f27294y;
        int i11 = this.d;
        if (i10 >= 0) {
            ConnectionsManager.getInstance(i11).cancelRequest(this.f27294y, true);
            this.f27294y = -1;
        }
        this.f27289n.clear();
        this.h.clear();
    ...
    public final void F() {
        if (TextUtils.isEmpty(this.f27292w) && this.f27293x == null) {
            this.f27290r = false;
            return;
        }
        ...
        tL_messages_search.f20005q = this.f27292w;
        ah.j1 j1Var = this.f27293x;
        if (j1Var != null) {
        ...
        if (this.f27293x != null) {
            MessagesStorage.getInstance(i10).searchSavedByTag(this.f27293x.g(), 0L, this.f27292w, 100, this.f27289n.size(), new bi.x2(1, this, dmVar), false);
        } else {
            dmVar.run();
        }
    }
    ...
    public final void G(boolean z10) {
        ...
        qt0[] qt0VarArr = this.G.f32730k0;
        ArrayList arrayList2 = this.f27288f;
        arrayList2.clear();
        ...
        if (!z10 || !arrayList.isEmpty()) {
            for (int i12 = 0; i12 < qt0VarArr.length; i12++) {
                if (qt0VarArr[i12].F == 11 && arrayList2.isEmpty() && this.f27287e.isEmpty()) {
                    wh.p pVar = qt0VarArr[i12].f29851w.d;
                    if (this.f27293x != null && TextUtils.isEmpty(this.f27292w)) {
                        String string = LocaleController.getString(R.string.NoResultFoundForTag);
                        ah.j1 j1Var = this.f27293x;
                        Paint.FontMetricsInt fontMetricsInt = qt0VarArr[i12].f29851w.d.getPaint().getFontMetricsInt();
                        ...
                        formatString = LocaleController.formatString(R.string.NoResultFoundFor, this.f27292w);
                    }
                    pVar.setText(formatString);
                    qt0VarArr[i12].f29851w.f32784f.setVisibility(8);
                    qt0VarArr[i12].f29851w.e(false, true);
                }
            }
        }
        l();
    ...
    @Override
    public final int h() {
        return this.f27288f.size() + this.f27287e.size();
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        hg.a0 a0Var = new hg.a0(1, this.f27286c, true);
        xu0 xu0Var = this.G;
        a0Var.setDialogCellDelegate(xu0Var);
        a0Var.f22645r0 = true;
        a0Var.setBackgroundColor(xu0Var.h0(org.telegram.ui.ActionBar.j6.f20691d6));
