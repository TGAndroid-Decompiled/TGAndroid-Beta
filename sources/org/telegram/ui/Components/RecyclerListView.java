...
public class RecyclerListView extends RecyclerView implements IBlur3Capture {
    ...
    public class FastScroll extends View {
        ...
        public FastScroll(Context context, int i) {
            ...
            if (i == 0) {
                ...
                drawableMutate.setColorFilter(new PorterDuffColorFilter(ColorUtils.blendARGB(0.1f, Theme.getColor(i2, RecyclerListView.this.resourcesProvider), -1), PorterDuff.Mode.MULTIPLY));
            }
            ...
            if (RecyclerListView.this.hasSections()) {
                this.scrollX = AndroidUtilities.dp(this.isRtl ? -4.0f : 6.0f) + this.scrollX;
            }
            updateColors();
                ...
                if (linearLayoutManager.getOrientation() == 1) {
                    ...
                    if (adapter instanceof FastScrollAdapter) {
                        ...
                        if (z) {
                            ...
                            linearLayoutManager.scrollToPositionWithOffset(iArr[0], RecyclerListView.this.sectionOffset + (-iArr[1]));
                        }
        ...
        public void applyBlurDrawables(BlurredBackgroundDrawableViewFactory blurredBackgroundDrawableViewFactory, BlurredBackgroundProvider blurredBackgroundProvider) {
            BlurredBackgroundDrawable blurredBackgroundDrawableCreate = blurredBackgroundDrawableViewFactory.create(RecyclerListView.this.fastScroll, blurredBackgroundProvider, false);
            ...
            BlurredBackgroundDrawable blurredBackgroundDrawableCreate2 = blurredBackgroundDrawableViewFactory.create(RecyclerListView.this.fastScroll, blurredBackgroundProvider, false);
            ...
            BlurredBackgroundDrawable blurredBackgroundDrawable = this.blurredTagDrawable;
        ...
        public void onDraw(Canvas canvas) {
            ...
            this.rect.set(this.scrollX, AndroidUtilities.dp(12.0f) + iCeil, AndroidUtilities.dp(5.0f) + this.scrollX, AndroidUtilities.dp(42.0f) + iCeil);
            if (this.type == 0) {
                c = 0;
                this.paint.setColor(ColorUtils.blendARGB(this.bubbleProgress, this.inactiveColor, this.activeColor));
                canvas.drawRoundRect(this.rect, AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f), this.paint);
                f = 36.0f;
                f2 = 12.0f;
            } else {
                c = 0;
                this.paint.setColor(ColorUtils.blendARGB(0.1f, Theme.getColor(Theme.key_windowBackgroundWhite, RecyclerListView.this.resourcesProvider), -1));
                ...
                if (blurredBackgroundDrawable != null) {
                    f = 36.0f;
                    blurredBackgroundDrawable.setBounds(AndroidUtilities.dp(-20.0f) + this.scrollX, AndroidUtilities.dp(-1.0f) + iCeil, AndroidUtilities.dp(36.0f) + this.scrollX, AndroidUtilities.dp(55.0f) + iCeil);
                    ...
                    canvas.drawCircle(AndroidUtilities.dp(8.0f) + this.scrollX, AndroidUtilities.dp(27.0f) + iCeil, AndroidUtilities.dp(24.0f), this.paint);
                }
                this.paint.setColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlackText, RecyclerListView.this.resourcesProvider));
                canvas.save();
                canvas.translate(AndroidUtilities.dp(4.0f) + this.scrollX, (AndroidUtilities.dp(2.0f) * this.bubbleProgress) + AndroidUtilities.dp(34.0f) + iCeil);
                canvas.drawPath(this.arrowPath, this.paint);
                canvas.restore();
                canvas.save();
                canvas.translate(AndroidUtilities.dp(4.0f) + this.scrollX, (AndroidUtilities.dp(24.0f) + iCeil) - (AndroidUtilities.dp(2.0f) * this.bubbleProgress));
            ...
            if (i == 0) {
                if (this.isMoving || this.bubbleProgress != 0.0f) {
                    ...
                    if (iDp3 <= AndroidUtilities.dp(f2)) {
                        fDp = AndroidUtilities.dp(f2) - iDp3;
                    ...
                    if (fDp <= AndroidUtilities.dp(29.0f)) {
                        ...
                        fDp3 = ((fDp / AndroidUtilities.dp(29.0f)) * AndroidUtilities.dp(40.0f)) + AndroidUtilities.dp(4.0f);
                    } else {
                        float fDp6 = fDp - AndroidUtilities.dp(29.0f);
                        float fDp7 = AndroidUtilities.dp(44.0f);
                        fDp2 = ((1.0f - (fDp6 / AndroidUtilities.dp(29.0f))) * AndroidUtilities.dp(40.0f)) + AndroidUtilities.dp(4.0f);
                        fDp3 = fDp7;
                    }
                    boolean z = this.isRtl;
                    if (z) {
                        float[] fArr2 = this.radii;
                        if (fArr2[c] != fDp2 || fArr2[6] != fDp3) {
                            if (z) {
                            ...
                            rectF.set(fDp4, 0.0f, AndroidUtilities.dp(f3), AndroidUtilities.dp(88.0f));
                            this.path.addRoundRect(this.rect, this.radii, Path.Direction.CW);
                            this.path.close();
                        } else if (!z) {
                            fArr = this.radii;
                            if (fArr[2] == fDp2 || fArr[4] != fDp3) {
                                if (z) {
                                ...
                                rectF2.set(fDp4, 0.0f, AndroidUtilities.dp(f3), AndroidUtilities.dp(88.0f));
                                this.path.addRoundRect(this.rect, this.radii, Path.Direction.CW);
                                this.path.close();
                            }
                        }
                        ...
                        if (fArr[2] == fDp2) {
                            ...
                            rectF3.set(fDp4, 0.0f, AndroidUtilities.dp(f3), AndroidUtilities.dp(88.0f));
                            this.path.addRoundRect(this.rect, this.radii, Path.Direction.CW);
                            this.path.close();
                        } else {
                            if (z) {
                            ...
                            rectF4.set(fDp4, 0.0f, AndroidUtilities.dp(f3), AndroidUtilities.dp(88.0f));
                            this.path.addRoundRect(this.rect, this.radii, Path.Direction.CW);
                            this.path.close();
                        }
                    }
                    ...
                    if (staticLayout != null) {
                        ...
                        canvas.scale(f4, f4, this.scrollX, iDp2 - iDp);
                ...
                float fDp8 = (this.rect.left - (AndroidUtilities.dp(30.0f) * this.bubbleProgress)) - AndroidUtilities.dp(8.0f);
                this.letterLayout.getHeight();
                AndroidUtilities.dp(6.0f);
                this.rect.set((fDp8 - DiffUtil.m(1.0f, this.replaceLayoutProgress, this.fromWidth, this.replaceLayoutProgress * this.letterLayout.getWidth())) - AndroidUtilities.dp(f), (fCenterY - (this.letterLayout.getHeight() / 2.0f)) - AndroidUtilities.dp(8.0f), fDp8 - AndroidUtilities.dp(f2), (this.letterLayout.getHeight() / 2.0f) + fCenterY + AndroidUtilities.dp(8.0f));
                ...
                if (this.replaceLayoutProgress != 1.0f) {
                    ...
                    if (this.outLetterLayout != null) {
                        this.letterPaint.setAlpha((int) ((1.0f - this.replaceLayoutProgress) * alpha2 * this.floatingDateProgress));
                        canvas.save();
                        canvas.translate((fDp8 - this.outLetterLayout.getWidth()) - AndroidUtilities.dp(24.0f), (AndroidUtilities.dp(15.0f) * (this.fromTop ? -1 : 1) * this.replaceLayoutProgress) + (fCenterY - (this.outLetterLayout.getHeight() / 2.0f)));
                    ...
                    if (this.inLetterLayout != null) {
                        ...
                        canvas.save();
                        canvas.translate((fDp8 - this.inLetterLayout.getWidth()) - AndroidUtilities.dp(24.0f), DiffUtil.m(1.0f, this.replaceLayoutProgress, AndroidUtilities.dp(15.0f) * (this.fromTop ? 1 : -1), fCenterY - (this.inLetterLayout.getHeight() / 2.0f)));
                    ...
                    if (this.stableLetterLayout != null) {
                        ...
                        canvas.save();
                        canvas.translate((fDp8 - this.stableLetterLayout.getWidth()) - AndroidUtilities.dp(24.0f), fCenterY - (this.stableLetterLayout.getHeight() / 2.0f));
                    ...
                    this.letterPaint.setAlpha((int) (alpha2 * this.floatingDateProgress));
                    canvas.save();
                    canvas.translate((fDp8 - this.letterLayout.getWidth()) - AndroidUtilities.dp(24.0f), DiffUtil.m(1.0f, this.replaceLayoutProgress, AndroidUtilities.dp(15.0f), fCenterY - (this.letterLayout.getHeight() / 2.0f)));
            ...
            if ((z2 && this.letterLayout != null && this.bubbleProgress < 1.0f) || ((!z2 || this.letterLayout == null) && this.bubbleProgress > 0.0f)) {
                ...
                if (!this.isMoving || this.letterLayout == null) {
                    ...
                    float f9 = (j / 120.0f) + this.bubbleProgress;
        ...
        public RecyclerListViewItemClickListener(Context context) {
            RecyclerListView.this.gestureDetector = new GestureDetectorFixDoubleTap(context, new GestureDetectorFixDoubleTap.OnGestureListener() {
                ...
                public void onLongPress(MotionEvent motionEvent) {
                    ...
                    if (RecyclerListView.this.onItemLongClickListenerExtended.mo2353onItemClick(RecyclerListView.this.currentChildView, RecyclerListView.this.currentChildPosition, motionEvent.getX() - RecyclerListView.this.currentChildView.getX(), motionEvent.getY() - RecyclerListView.this.currentChildView.getY())) {
                        try {
                            view.performHapticFeedback(0);
                        } catch (Exception unused2) {
                        }
    ...
    public static class SectionsDrawer {
        ...
        private static float[] calculateGroup(List<Section> list, int i, int i2, float f) {
            ...
            if (z) {
                ...
                for (int i6 = i; i6 < i2; i6++) {
                    ...
                    float f7 = section6.alpha;
                    if (f7 < 0.99f) {
                        float f8 = section6.to;
                        if (f8 > fMax2) {
                            float f9 = (f8 - fMax2) * f7;
                            if (f9 > f2) {
                                section5 = section6;
                                f2 = f9;
                            }
                ...
                if (section3 != null) {
                    float f10 = section3.alpha;
                    if (f10 > 0.001f) {
                        float fLerp3 = AndroidUtilities.lerp(fMin2, section3.from, f10);
                ...
                fMax3 = 1.0f;
                if (section5 != null) {
                    float f11 = section5.alpha;
                    if (f11 > 0.001f) {
                        float fLerp4 = AndroidUtilities.lerp(fMax2, section5.to, f11);
        ...
        public static void draw(List<Section> list, float f, Utilities.Callback5<Float, Float, Float, Float, Float> callback5) {
            ...
            Collections.sort(list, new SeekBar$$ExternalSyntheticLambda0(9));
            groups.clear();
            ...
            while (true) {
                ...
                callback5.mo1122run(Float.valueOf(f2), Float.valueOf(f3), Float.valueOf(fMin), Float.valueOf(fMin2), Float.valueOf(f4));
                i3++;
            }
        }
    ...
    private static Pair<Utilities.CallbackReturn<View, Boolean>, Utilities.CallbackReturn<Integer, Boolean>> cachedIsViewTypeShadow(RecyclerListView recyclerListView, Utilities.CallbackReturn<View, Boolean> callbackReturn) {
        SparseIntArray sparseIntArray = new SparseIntArray();
        return new Pair<>(new AIEditorAlert$$ExternalSyntheticLambda13(recyclerListView, callbackReturn, sparseIntArray, 2), new RecyclerListView$$ExternalSyntheticLambda2(sparseIntArray, 0));
    }
    ...
    public static void drawBackgroundRect(Canvas canvas, RectF rectF, float f, float f2, float f3, Theme.ResourcesProvider resourcesProvider) {
        if (SharedConfig.shadowsInSections) {
            ...
            paint.setShadowLayer(AndroidUtilities.dpf2(0.33f), 0.0f, 0.0f, Theme.multAlpha(f3, 201326592));
            paint.setColor(0);
            sectionBackgroundPaint.setShadowLayer(AndroidUtilities.dpf2(2.0f), 0.0f, AndroidUtilities.dpf2(0.33f), Theme.multAlpha(f3, 167772160));
        } else {
            sectionBackgroundPaint.setShadowLayer(0.0f, 0.0f, 0.0f, 0);
        }
        Paint paint2 = sectionBackgroundPaint;
        paint2.setColor(Theme.multAlpha(f3, Theme.getColor(Theme.key_windowBackgroundWhite, resourcesProvider)));
        if (f == f2) {
            if (SharedConfig.shadowsInSections) {
    ...
    public void highlightRowInternal(IntReturnCallback intReturnCallback, int i, boolean z) {
        ...
        if (i > 0) {
            ...
            Tooltip$$ExternalSyntheticLambda0 tooltip$$ExternalSyntheticLambda0 = new Tooltip$$ExternalSyntheticLambda0(this, 6);
            this.removeHighlighSelectionRunnable = tooltip$$ExternalSyntheticLambda0;
            AndroidUtilities.runOnUIThread(tooltip$$ExternalSyntheticLambda0, i);
        }
    }
    ...
    public void lambda$drawSectionsBackgrounds$5(Canvas canvas, Float f, Float f2, Float f3, Float f4, Float f5) {
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(this.sectionsItemDecoration.padding + getPaddingLeft(), f.floatValue(), (getWidth() - this.sectionsItemDecoration.padding) - getPaddingRight(), f2.floatValue());
        this.drawSectionBackground.mo1122run(canvas, rectF, f3, f4, f5);
    }
    ...
    public void addEdgeEffectListener(Runnable runnable) {
        addEdgeEffectListener(new RecyclerListView$$ExternalSyntheticLambda5(runnable, 0));
    }
                ...
                if (linearLayoutManager.getOrientation() == 1) {
                    ...
                    if (this.sectionsType != 3) {
                        ...
                        for (int i9 = this.startSection; i9 < this.startSection + this.sectionsCount; i9++) {
                            ...
                            View sectionHeaderView2 = getSectionHeaderView(i9, view);
    ...
    public void drawItemBackground(Canvas canvas, int i, int i2) {
        drawItemBackground(canvas, i, -1, i2);
    }
    ...
    public void drawSectionsBackgrounds(Canvas canvas) {
        ...
        if (isAnimating()) {
            ...
            for (int i3 = 0; i3 < getChildCount(); i3++) {
                ...
                if (childAt2 != this.emptyView && childAt2.getVisibility() == 0 && childAt2.getAlpha() > 0.0f && this.sectionsItemDecoration.isSectionItem.run(childAt2).booleanValue()) {
                    ...
                    if (!childViewHolder.isRemoved() || childAt2.getAlpha() >= 1.0f) {
                    ...
                    } else if (!childViewHolder.isRemoved() || (i2 = childViewHolder.mOldCompoundPosition) < 0) {
                        this.sections.add(new SectionsDrawer.Section(pVar, fBottom, childAt2.getAlpha()));
                    } else {
                        int iCeil = ((int) Math.ceil(((double) i2) / 1000.0d)) + 1;
                        int i4 = 0;
                        while (true) {
                            if (i4 >= getChildCount()) {
                                childAt = null;
                        ...
                        if (childAt == null || fBottom <= childAt.getY() || !this.sectionsItemDecoration.isSectionItem.run(childAt).booleanValue() || getChildViewHolder(childAt).isRemoved()) {
                            this.sections.add(new SectionsDrawer.Section(pVar, fBottom, childAt2.getAlpha()));
                        } else {
                            pVar -= 1.0f;
            ...
            SectionsDrawer.draw(this.sections, this.sectionRadius, new AIEditorAlert$$ExternalSyntheticLambda34(28, this, canvas));
            this.sections.clear();
            canvas2 = canvas;
            ...
            while (i5 < getChildCount()) {
                ...
                if (childAt3 == this.emptyView || childAt3.getVisibility() != 0 || childAt3.getAlpha() <= 0.0f || !this.sectionsItemDecoration.isSectionItem.run(childAt3).booleanValue()) {
                    canvas3 = canvas;
                    view3 = view3;
                } else {
                    if (isInsideForcedSection(getChildAdapterPosition(childAt3))) {
                        canvas3 = canvas;
                    } else {
                        if (view2 == null || Math.abs(view3.getAlpha() - childAt3.getAlpha()) <= 0.1f) {
                            canvas4 = canvas;
                        } else {
                            boolean zHasAbove = hasAbove(view2, i6);
                            boolean zHasBelow = hasBelow(view3, i7);
                ...
                drawSectionBackground(canvas3, view2, view3, hasAbove(view2, i6), hasBelow(view3, i7));
                view = null;
                childAt3 = null;
                i6 = -1;
                i = -1;
            ...
            canvas2 = canvas;
            recyclerListView = this;
            recyclerListView.drawSectionBackground(canvas2, view2, view3, hasAbove(view2, i6), hasBelow(view3, i8));
        }
        if (recyclerListView.forcedSections != null) {
            for (int i9 = 0; i9 < recyclerListView.forcedSections.size(); i9++) {
                long jLongValue = recyclerListView.forcedSections.get(i9).longValue();
                ...
                if (fMin < fMax) {
                    RectF rectF = AndroidUtilities.rectTmp;
                    rectF.set(recyclerListView.sectionsItemDecoration.padding + getPaddingLeft(), fMin, (getWidth() - getPaddingRight()) - recyclerListView.sectionsItemDecoration.padding, fMax);
                    recyclerListView.drawSectionBackground.mo1122run(canvas2, rectF, Float.valueOf(recyclerListView.sectionRadius), Float.valueOf(recyclerListView.sectionRadius), Float.valueOf(1.0f));
                }
            }
        }
    }
    ...
    public boolean longClickItem(View view, int i) {
        ...
        OnItemLongClickListenerExtended onItemLongClickListenerExtended = this.onItemLongClickListenerExtended;
        if (onItemLongClickListenerExtended != null) {
            return onItemLongClickListenerExtended.mo2353onItemClick(view, i, 0.0f, 0.0f);
        }
        return false;
    }
    ...
    public void removeEdgeEffectListener(EdgeEffectTrackerFactory.OnEdgeEffectListener onEdgeEffectListener) {
        this.edgeEffectTrackerFactory.removeEdgeEffectListener(onEdgeEffectListener);
    }
    ...
    public void lambda$onCellEnter$52(RecyclerView.ItemAnimator itemAnimator) {
        super.lambda$onCellEnter$52(itemAnimator);
    }
    ...
    public RecyclerListView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        BaseCell.RippleDrawableSafe rippleDrawableSafeCreateSelectorDrawable = Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 2, -1);
    ...
    public void setSections(int i, float f, boolean z) {
        setSections(new AlertsCreator$$ExternalSyntheticLambda260(2), i, f, new EmojiView$$ExternalSyntheticLambda24(this), z);
    }
    ...
    private void drawSectionBackground(Canvas canvas, View view, View view2, boolean z, boolean z2) {
        ...
        this.drawSectionBackground.mo1122run(canvas, rectF, Float.valueOf(this.sectionRadius), Float.valueOf(this.sectionRadius), Float.valueOf(view.getAlpha()));
    }
    ...
    public interface OnItemLongClickListenerExtended {
        boolean mo2353onItemClick(View view, int i, float f, float f2);
