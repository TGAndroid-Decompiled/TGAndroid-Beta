...
public final class f30 extends LinearLayout implements VoIPService.StateListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public org.telegram.ui.Components.voip.w2 f24125c;
    public org.telegram.ui.Components.voip.w2 d;
    public w9 e;
    public RectF f24126f;
    public Paint h;
    public LinearGradient f24127n;
    public int f24128r;
    ...
    public static void b(f30 f30Var, Context context) {
        ...
        org.telegram.ui.d60.t1(context2, d30Var, z10, false);
    }
    ...
    public final void d(boolean z10) {
        ...
        org.telegram.ui.Components.voip.w2 w2Var2 = this.f24125c;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.groupCallUpdated) {
            e();
            if (VoIPService.getSharedInstance() != null && (mutedByAdmin = VoIPService.getSharedInstance().mutedByAdmin()) != this.f24132y) {
                this.f24132y = mutedByAdmin;
                invalidate();
            }
        }
    }
    ...
    public final void e() {
        String str;
        TextView textView = this.f24124b;
        VoIPService sharedInstance = VoIPService.getSharedInstance();
    ...
    public final void onAttachedToWindow() {
        ...
        if (sharedInstance != null && sharedInstance.groupCall != null) {
            ...
            this.f24123a.setText(str);
            e();
            sharedInstance.registerStateListener(this);
            if (VoIPService.getSharedInstance() != null) {
                this.f24132y = VoIPService.getSharedInstance().mutedByAdmin();
            }
            float f10 = 0.0f;
            if (this.f24132y) {
                f7 = 1.0f;
            ...
            this.F = f7;
            this.E = (VoIPService.getSharedInstance() == null || VoIPService.getSharedInstance().isMicMute() || this.f24132y) ? 1.0f : 1.0f;
        }
    ...
    public final void onDetachedFromWindow() {
        ...
        NotificationCenter.getInstance(this.f24131x).removeObserver(this, NotificationCenter.groupCallUpdated);
    }
