...
public final class m8 implements Runnable {
    ...
    public final void run() {
        ...
        String str2;
        int i15;
        int i16 = this.f28404a;
        float f7 = 1.0f;
        int i17 = 0;
        int i18 = this.f28405b;
        Object obj = this.f28406c;
        switch (i16) {
            case 0:
                ((q8) obj).b(i18);
                return;
            case 1:
                ld ldVar = (ld) obj;
                di.f4 f4Var = ldVar.f28143d1;
                if (ldVar.f28141b1 != i18) {
                    ldVar.setTimer(i18);
                    Utilities.Callback callback = ldVar.f28156r1;
                    if (callback != null) {
                    ...
                    if (i18 == 0) {
                        ...
                        f4Var.f7202e0 = AndroidUtilities.dp(0);
                        f4Var.f7200d0 = -AndroidUtilities.dp(1.0f);
                        ...
                        f4Var.f7202e0 = AndroidUtilities.dp(2);
                        f4Var.f7200d0 = 0.0f;
                    } else {
                        return;
                    }
                    ...
                    AndroidUtilities.cancelRunOnUIThread(ldVar.f28154p1);
                    ldVar.invalidate();
                    return;
                }
                return;
            case 2:
                ...
                if (egVar != null) {
                    ...
                    chatActivityEnterView.f23736m1.removeView(chatActivityEnterView.U0);
            ...
            case 3:
                pm pmVar = (pm) obj;
                qm qmVar = pmVar.P;
                if (i18 == pmVar.O && qmVar.f29772w.isShown()) {
                    qmVar.f29772w.e(1, true);
                    return;
                }
                return;
            case 4:
                ...
                return;
            case 5:
                ((pa0) obj).f29345b.run(Integer.valueOf(i18));
                return;
            case 6:
                pf0 pf0Var = (pf0) obj;
                org.telegram.ui.hu0 hu0Var = pf0Var.f29368a;
                TextView textView = hu0Var.f29711e;
                di.eb ebVar = hu0Var.h;
                RadialProgressView radialProgressView = hu0Var.f29713n;
                TextView textView2 = hu0Var.d;
                textView.setVisibility(8);
                hu0Var.f29712f.setVisibility(8);
                LinearLayout linearLayout = hu0Var.f29710c;
            ...
            case 10:
                ...
                if (n2Var != null) {
                    if (xu0Var.f32688d1 instanceof TLRPC.TL_channelFull) {
                        ...
                        tL_channels_setMainProfileTab.channel = n2Var.getMessagesController().getInputChannel(xu0Var.f32688d1.f19870id);
                        TLRPC.ChatFull chatFull = xu0Var.f32688d1;
            ...
            case 15:
                ...
                return;
            case 16:
                org.telegram.ui.j60 j60Var2 = ((org.telegram.ui.m50) obj).f38575b;
            ...
            case 17:
                ...
                int childCount = f70Var.f36296n.getChildCount();
                for (int i19 = 0; i19 < childCount; i19++) {
                    View childAt = f70Var.f36296n.getChildAt(i19);
                    f70Var.f36296n.getClass();
                    if (RecyclerView.R(childAt) >= i18) {
                        childAt.setAlpha(0.0f);
                        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(childAt, View.ALPHA, 0.0f, 1.0f);
                        ofFloat.setStartDelay((int) ((Math.min(f70Var.f36296n.getMeasuredHeight(), Math.max(0, childAt.getTop())) / f70Var.f36296n.getMeasuredHeight()) * 100.0f));
            ...
            case 18:
                ...
                return;
            case 19:
                ((org.telegram.ui.ge0) obj).f36643a.f36164f[i18].l(1.0f);
                return;
            case 20:
                ...
                notificationsSettingsActivity.f33487c.m(i18);
                return;
            case 21:
                ((org.telegram.ui.il0) obj).run(Integer.valueOf(i18));
                return;
            case 22:
                ((org.telegram.ui.op0) obj).f39297e.f41620p0.I.D(1 - i18);
                return;
            case 23:
                PhotoViewer photoViewer = (PhotoViewer) obj;
                Drawable[] drawableArr = PhotoViewer.T8;
                int i20 = i18 + 1;
                if (i20 < 6 && (uu0Var = photoViewer.f33550e0) != null) {
                    uu0Var.invalidate();
            ...
            case 25:
                ...
                NotificationCenter notificationCenter = a11Var.f34292e.getNotificationCenter();
            ...
            case 27:
                ...
                s4.o0 layoutManager = f31Var.f36261y.getLayoutManager();
                if (layoutManager != null) {
                    if (f31Var.R) {
                        if (i18 > f31Var.L) {
                            i15 = Math.min(i18 + 1, f31Var.f36252b.d.size() - 1);
                        } else {
                    ...
                    org.telegram.ui.c31 c31Var = f31Var.f36253c;
                    c31Var.f45907a = i15;
            ...
            case 28:
                ...
                sessionsActivity.m0();
                org.telegram.ui.t81 t81Var = sessionsActivity.f34119a;
                if (t81Var != null) {
                    t81Var.l();
                    return;
                }
