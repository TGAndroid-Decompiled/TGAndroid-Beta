...
public final class wd0 implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public final void onGlobalLayout() {
        ...
        int i13 = this.f30027a;
        int i14 = i11 - i13;
        int i15 = i14 * i14;
        int i16 = this.f30028b;
        int i17 = i12 - i16;
        int i18 = i17 * i17;
        ...
        while (i21 < childCount) {
            ...
            obj.f30557b = ((float) Math.sqrt(i22)) - AndroidUtilities.dp(40.0f);
            if (i21 != -1) {
            ...
            obj.f30556a.addListener(new ed0(animatorSet, 2));
            AnimatorSet animatorSet4 = obj.f30556a;
            if (i21 == -1) {
                j3 = 232;
            } else {
                j3 = 200;
            ...
            obj.f30556a.setInterpolator(new DecelerateInterpolator());
            arrayList3.add(obj);
            i21++;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                while (true) {
                    ...
                    if (i23 < arrayList4.size()) {
                        ...
                        if (yd0Var.f30557b <= animatedFraction) {
                            yd0Var.f30556a.start();
        ...
        animatorSet5.playTogether(ObjectAnimator.ofFloat(lj0Var, View.TRANSLATION_X, i13 - AndroidUtilities.dp(29.0f), f7 - dp), ObjectAnimator.ofFloat(lj0Var, View.TRANSLATION_Y, i16 - AndroidUtilities.dp(29.0f), be0Var.H), ObjectAnimator.ofFloat(lj0Var, View.SCALE_X, 0.5f, 1.0f), ObjectAnimator.ofFloat(lj0Var, View.SCALE_Y, 0.5f, 1.0f));
        animatorSet5.setInterpolator(qr.f27716g);
        animatorSet5.start();
    }
}
