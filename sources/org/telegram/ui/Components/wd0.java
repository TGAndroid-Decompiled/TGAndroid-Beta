...
public class wd0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final int[] T;
    public Drawable f30223a;
    public final FrameLayout f30224b;
    public final TextView f30225c;
    public final FrameLayout d;
    public final dh.d e;
    public final ArrayList f30226f;
    public final FrameLayout h;
    public final ud0 f30227n;
    public final EditTextBoldCursor f30228r;
    public final sd0 f30229s;
    public final ah.e v;
    public final TextView f30230w;
    public final TextView f30231x;
    ...
    public wd0(Context context) {
        ...
        this.f30228r = editTextBoldCursor;
                        ...
                        if (wd0Var.R) {
                            ...
                            switch (intValue) {
                                ...
                                case 10:
                                    ...
                                    break;
                                case 11:
                                    ArrayList arrayList = (ArrayList) sd0Var2.f28727c;
                                    Property property = View.TRANSLATION_Y;
                                    Property property2 = View.ALPHA;
                                    Property property3 = View.SCALE_Y;
                                    Property property4 = View.SCALE_X;
                                    ArrayList arrayList2 = (ArrayList) sd0Var2.f28726b;
                                    ...
                                    if (sb.length() == 0) {
                                        ...
                                        while (i16 < 4) {
                                            ...
                                            if (textView2.getAlpha() != 0.0f) {
                                                ...
                                                arrayList3.add(ObjectAnimator.ofFloat(textView2, property5, sd0Var2.c(i16)));
                                            } else {
                                                linkedList3 = linkedList5;
                                                i12 = intValue;
                                                i13 = 1;
                                        ...
                                        for (int i17 = 0; i17 < length; i17++) {
                                            arrayList3.add(ObjectAnimator.ofFloat((TextView) arrayList2.get(i17), property5, sd0Var2.c(i17)));
                                            arrayList3.add(ObjectAnimator.ofFloat((TextView) arrayList.get(i17), property5, sd0Var2.c(i17)));
                                        }
                                        ye yeVar = (ye) sd0Var2.f28728f;
                                        if (yeVar != null) {
                                            AndroidUtilities.cancelRunOnUIThread(yeVar);
                                            sd0Var2.f28728f = null;
                                        }
        ...
        while (true) {
            ...
            ud0Var.setTag(Integer.valueOf(i11));
            if (i11 == 11) {
                ...
                ud0Var.setContentDescription(i11 + "");
                ud0Var.setNum(i11);
                if (i11 == 0) {
            ...
            ud0Var.setId(iArr[i11]);
            ud0Var.setOnClickListener(new View.OnClickListener(this) {
                public final wd0 f26645b;
            ...
            this.f30226f.add(ud0Var);
            i11++;
        }
        for (i10 = 11; i10 >= 0; i10--) {
            this.e.addView((FrameLayout) this.f30226f.get(i10), k7.b6.e(60, 60, 51));
        }
        d();
    }
    ...
    public static void a(wd0 wd0Var) {
        ...
        float f10;
        float f11;
        FrameLayout frameLayout = wd0Var.f30224b;
        sd0 sd0Var = wd0Var.f30229s;
        if (sd0Var != null && ((StringBuilder) sd0Var.d).length() <= 0) {
            z4 = false;
        } else {
            z4 = true;
        }
        if (frameLayout != null) {
            ...
            org.telegram.ui.b.p(scaleX.scaleY(f12), mr.h, 320L);
        }
    }
    ...
    public final void b(ec0 ec0Var) {
        ...
        jVar2.f16178u = org.telegram.ui.ai.m(100.0f, 300.0f, 1.0f);
        this.I = jVar2;
    ...
    public final void c() {
        ...
        yd0 yd0Var;
        if (Build.VERSION.SDK_INT >= 23 && (findActivity = AndroidUtilities.findActivity(getContext())) != null && this.f30227n.getVisibility() == 0 && !ApplicationLoader.mainInterfacePaused) {
            if (findActivity instanceof LaunchActivity) {
                LaunchActivity launchActivity = (LaunchActivity) findActivity;
                ArrayList arrayList = launchActivity.f31634y0;
                if (arrayList.isEmpty() && (yd0Var = launchActivity.f31632x0) != null) {
                    if (this != yd0Var.f31003b) {
                        return;
                    }
                } else if (kf.k0.i(1, arrayList) != this) {
                    return;
                }
            }
            try {
                if (new af.d(new androidx.biometric.t(getContext(), 0)).i(15) == 0 && FingerprintController.isKeyReady() && !FingerprintController.checkDeviceFingerprintsChanged()) {
                    ...
                    uVar.f6981b = LocaleController.getString(R.string.UnlockToUse);
    ...
    public final void d() {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.wd0.d():void");
    }
    ...
    public final void e() {
        ...
        EditTextBoldCursor editTextBoldCursor = this.f30228r;
        FrameLayout frameLayout = this.h;
        m2.b bVar = this.O;
        TextView textView = this.f30231x;
        if (j11 > 0) {
    ...
    public final boolean g() {
        ...
        if (i3Var != null && i3Var.c()) {
            AndroidUtilities.hideKeyboard(this.f30228r);
            return false;
        }
        return true;
    }
    ...
    public final void i() {
        e();
        if (this.f30231x.getVisibility() != 0) {
            if (SharedConfig.passcodeType == 1) {
                EditTextBoldCursor editTextBoldCursor = this.f30228r;
    ...
    public final void j(boolean z4, int i10, int i11, org.telegram.ui.w10 w10Var) {
        ...
        if (z11) {
            ...
            this.f30223a = org.telegram.ui.ActionBar.j6.r0();
            ...
            if (org.telegram.ui.ActionBar.j6.W && !"CJz3BZ6YGEYBAAAABboWp6SAv04".equals(org.telegram.ui.ActionBar.j6.H0()) && !"qeZWES8rGVIEAAAARfWlK1lnfiI".equals(org.telegram.ui.ActionBar.j6.H0())) {
                ...
                if (!"d".equals(org.telegram.ui.ActionBar.j6.H0())) {
                    ...
                    if (!org.telegram.ui.ActionBar.j6.f19982j0 && !"CJz3BZ6YGEYBAAAABboWp6SAv04".equals(H0) && !"qeZWES8rGVIEAAAARfWlK1lnfiI".equals(H0)) {
        ...
        Drawable drawable = this.f30223a;
        if (drawable instanceof ec0) {
            ec0 ec0Var = (ec0) drawable;
            ...
            this.f30223a = new ec0(false, iArr[0], iArr[1], iArr[2], iArr[3]);
            if (ec0Var.f24590u != null && ec0Var.f24586q < 0) {
                eVar.setBackgroundColor(2130706432);
            } else {
                eVar.setBackgroundColor(570425344);
            }
            ((ec0) this.f30223a).r(eVar);
        }
        this.f30230w.setText(LocaleController.getString(R.string.AppLocked));
        int i16 = SharedConfig.passcodeType;
        ImageView imageView = this.B;
        ImageView imageView2 = this.f30232y;
        dh.d dVar = this.e;
        sd0 sd0Var = this.f30229s;
        if (i16 == 0) {
            if (textView.getVisibility() != 0) {
            ...
            imageView.setVisibility(this.f30227n.getVisibility());
        }
        setVisibility(0);
    ...
    public final void k(boolean z4) {
        ...
        if (!z4) {
            if (SharedConfig.passcodeRetryInMs <= 0) {
                ...
                sd0 sd0Var = this.f30229s;
                if (i10 == 0) {
                    str = ((StringBuilder) sd0Var.d).toString();
                } else if (i10 != 1) {
                    str = "";
                } else {
                ...
                FrameLayout frameLayout = this.f30224b;
                if (length == 0) {
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        TextView textView = this.f30230w;
        int[] iArr = this.T;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i23 = 0; i23 < 12; i23++) {
            ...
            FrameLayout frameLayout3 = (FrameLayout) this.f30226f.get(i23);
