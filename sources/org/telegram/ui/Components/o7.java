        ...
        switch (this.f26646a) {
            case 0:
                ...
                if (i10 == 1) {
                    ...
                    p7Var.f26949w = System.currentTimeMillis();
            ...
            default:
                p7 p7Var2 = this.f26647b;
                h8 h8Var2 = p7Var2.H;
                long duration = MediaController.getInstance().getDuration();
                if (duration != 0 && duration != -9223372036854775807L) {
                    float f7 = h8Var2.I0;
                    long currentTimeMillis = System.currentTimeMillis();
                    long j10 = currentTimeMillis - p7Var2.f26949w;
                    p7Var2.f26949w = currentTimeMillis;
                    long j11 = currentTimeMillis - p7Var2.f26950x;
                    int i11 = p7Var2.v;
                    if (i11 == 1) {
                        j3 = 3;
                    } else if (i11 == 2) {
                    ...
                    if (h8Var2.H0 == -1 && p7Var2.v > 0) {
                        if (j11 > 200 || h8Var2.I0 == 0.0f) {
                            p7Var2.f26950x = currentTimeMillis;
                            if (h8Var2.I0 == 0.0f) {
                ...
                p7Var2.f26949w = System.currentTimeMillis();
                return;
        }
    }
}
