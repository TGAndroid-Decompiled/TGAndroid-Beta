...
public final class nr extends View {
    public final TextPaint f31126a;
    public final TextPaint f31127b;
    public final String f31128c;
    public final String d;
    public final Rect f31129e;

    public nr(Context context, String str, String str2) {
        super(context);
        TextPaint textPaint = new TextPaint(1);
        this.f31126a = textPaint;
        TextPaint textPaint2 = new TextPaint(1);
        this.f31127b = textPaint2;
        this.f31129e = new Rect();
        this.f31128c = str;
        this.d = str2;
    ...
    public final void onDraw(Canvas canvas) {
        TextPaint textPaint = this.f31127b;
        String str = this.d;
        float measureText = textPaint.measureText(str);
        TextPaint textPaint2 = this.f31126a;
        String str2 = this.f31128c;
        float measureText2 = textPaint2.measureText(str2);
        int length = str2.length();
        Rect rect = this.f31129e;
