...
public final class ww extends qx {
    ...
    public final void o(int i10, int i11) {
        kz kzVar = this.G0;
        org.telegram.ui.Cells.l7 l7Var = kzVar.f25711f2;
        int i12 = kzVar.E1;
        int i13 = i10 - i12;
        int i14 = i11 - i12;
        int i15 = kzVar.f25700c1;
        MediaDataController mediaDataController = MediaDataController.getInstance(i15);
        ArrayList arrayList = kzVar.f25703d1;
        ...
        for (int i16 = kzVar.f25705e0; i16 < arrayList.size(); i16 = com.google.android.gms.internal.vision.e2.g(((TLRPC.TL_messages_stickerSet) arrayList.get(i16)).set.f18136id, tL_messages_reorderStickerSets.order, i16, 1)) {
        }
        ...
        if (SharedConfig.updateStickersOrderOnSend) {
            ...
            if (n2Var != null) {
                vc.a0(n2Var).K(R.raw.filter_reorder, LocaleController.getString(R.string.DynamicPackOrderOff), LocaleController.getString(R.string.DynamicPackOrderOffInfo), LocaleController.getString("Settings"), new rd(1, n2Var)).j();
                return;
            }
