...
public final class ww extends qx {
    ...
    public final void o(int i10, int i11) {
        ...
        for (int i16 = kzVar.f25721e0; i16 < arrayList.size(); i16 = com.google.android.gms.internal.vision.e2.g(((TLRPC.TL_messages_stickerSet) arrayList.get(i16)).set.f18148id, tL_messages_reorderStickerSets.order, i16, 1)) {
        }
