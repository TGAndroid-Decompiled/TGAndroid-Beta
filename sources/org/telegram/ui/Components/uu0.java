...
public final class uu0 extends vl0 {
    ...
    public String f28927w;
    public zg.o0 f28928x;
    public final ArrayList e = new ArrayList();
    public final ArrayList f28923f = new ArrayList();
    public final ArrayList h = new ArrayList();
    public final ArrayList f28924n = new ArrayList();
    public boolean f28926s = false;
    public int v = 0;
    public int f28929y = -1;
    public final wq0 F = new wq0(this, 7);

    public uu0(jv0 jv0Var, Context context) {
        this.G = jv0Var;
        this.f28922c = context;
        this.d = jv0Var.f25560v1.getCurrentAccount();
        C(true);
    }
    ...
    public final void E(zg.o0 o0Var, String str) {
        long j3;
        if (TextUtils.equals(str, this.f28927w)) {
            zg.o0 o0Var2 = this.f28928x;
        ...
        this.f28927w = str;
        this.f28928x = o0Var;
        int i10 = this.f28929y;
        int i11 = this.d;
        if (i10 >= 0) {
            ConnectionsManager.getInstance(i11).cancelRequest(this.f28929y, true);
            this.f28929y = -1;
        }
        this.f28924n.clear();
        this.h.clear();
        ...
        while (true) {
            cu0[] cu0VarArr = this.G.f25536k0;
            if (i12 >= cu0VarArr.length) {
                break;
            }
            cu0 cu0Var = cu0VarArr[i12];
            if (cu0Var.F == 11) {
                cu0Var.f23402w.e(true, true);
            }
            i12++;
        }
        if (this.f28928x == null) {
    ...
    public final void F() {
        if (TextUtils.isEmpty(this.f28927w) && this.f28928x == null) {
            this.f28925r = false;
            return;
        }
        ...
        tL_messages_search.f18445q = this.f28927w;
        zg.o0 o0Var = this.f28928x;
        if (o0Var != null) {
        ...
        if (this.f28928x != null) {
            MessagesStorage.getInstance(i10).searchSavedByTag(this.f28928x.g(), 0L, this.f28927w, 100, this.f28924n.size(), new ai.k3(1, this, xmVar), false);
        } else {
            xmVar.run();
        }
    }
    ...
    public final void G(boolean z10) {
        ...
        cu0[] cu0VarArr = this.G.f25536k0;
        ArrayList arrayList2 = this.f28923f;
        arrayList2.clear();
        ...
        if (!z10 || !arrayList.isEmpty()) {
            for (int i12 = 0; i12 < cu0VarArr.length; i12++) {
                if (cu0VarArr[i12].F == 11 && arrayList2.isEmpty() && this.e.isEmpty()) {
                    vh.n nVar = cu0VarArr[i12].f23402w.d;
                    if (this.f28928x != null && TextUtils.isEmpty(this.f28927w)) {
                        String string = LocaleController.getString(R.string.NoResultFoundForTag);
                        zg.o0 o0Var = this.f28928x;
                        Paint.FontMetricsInt fontMetricsInt = cu0VarArr[i12].f23402w.d.getPaint().getFontMetricsInt();
                        ...
                        formatString = LocaleController.formatString(R.string.NoResultFoundFor, this.f28927w);
                    }
                    nVar.setText(formatString);
                    cu0VarArr[i12].f23402w.f25192f.setVisibility(8);
                    cu0VarArr[i12].f23402w.e(false, true);
                }
            }
        }
        l();
    ...
    @Override
    public final int h() {
        return this.f28923f.size() + this.e.size();
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        gg.a0 a0Var = new gg.a0(1, this.f28922c, true);
        jv0 jv0Var = this.G;
        a0Var.setDialogCellDelegate(jv0Var);
        a0Var.f21005r0 = true;
        a0Var.setBackgroundColor(jv0Var.h0(org.telegram.ui.ActionBar.h6.f19060d6));
