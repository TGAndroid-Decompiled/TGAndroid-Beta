...
public final class a21 extends vl0 {
    ...
    public ArrayList f22470f = new ArrayList();
    public wm h;
    public String f22471n;
    public final ThemeEditorView.EditorAlert f22472r;

    public a21(ThemeEditorView.EditorAlert editorAlert, Context context) {
        this.f22472r = editorAlert;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (c1Var.f42932f == 0) {
            ...
            z8Var.f21888a.setText((CharSequence) this.f22470f.get(i11));
            z8Var.f21889b = b10;
            if (b10 != 0) {
                z10 = false;
            }
