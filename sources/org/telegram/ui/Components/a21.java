...
public final class a21 extends TextView {
    public View f23300a;
    public ViewPropertyAnimator f23301b;
    ...
    public final void a() {
        ...
        int i11 = 0;
        int i12 = 0;
        for (View view2 = this.f23300a; view2 != view; view2 = (View) view2.getParent()) {
            i12 += view2.getTop();
            i11 += view2.getLeft();
        }
        int width = ((this.f23300a.getWidth() / 2) + i11) - (getMeasuredWidth() / 2);
        if (width >= 0) {
