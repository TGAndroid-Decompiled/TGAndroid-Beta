...
public class CanvasButton {
    ...
    public CanvasButton(View view) {
        ...
        paint3.setColor(-1);
        BaseCell.RippleDrawableSafe rippleDrawableSafe = new BaseCell.RippleDrawableSafe(new ColorStateList(new int[][]{StateSet.WILD_CARD}, new int[]{Theme.getColor(null, Theme.key_listSelector, false) & 436207615}), null, new Drawable() {
            @Override
