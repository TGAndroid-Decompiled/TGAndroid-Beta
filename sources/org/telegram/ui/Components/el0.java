...
public final class el0 implements Runnable {
    ...
    public final void run() {
        gl0 gl0Var = this.f25756e.f26155b;
        ll0 ll0Var = (ll0) gl0Var.f26488b;
        if (this == ll0Var.S1) {
            ll0Var.S1 = null;
        }
        View view = this.f25753a;
        if (view != null) {
            ll0Var.g1(view, 0.0f, 0.0f, false);
            if (!((ll0) gl0Var.f26488b).R1) {
                try {
                ...
                if (i10 != -1) {
                    ll0 ll0Var2 = (ll0) gl0Var.f26488b;
                    ...
                    if (al0Var != null) {
                        al0Var.d(this.f25755c - view.getX(), this.d - view.getY(), i10, view);
                    }
                }
            }
        }
