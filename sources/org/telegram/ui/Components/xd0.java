...
public final class xd0 implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public final void onGlobalLayout() {
        ...
        int i15 = this.f30321a;
        int i16 = i13 - i15;
        int i17 = i16 * i16;
        int i18 = this.f30322b;
        int i19 = i14 - i18;
        int i20 = i19 * i19;
        ...
        while (i23 < childCount) {
            ...
            int i25 = i18;
            obj.f30853b = ((float) Math.sqrt(i24)) - AndroidUtilities.dp(40.0f);
            if (i23 != -1) {
            ...
            obj.f30852a.addListener(new fd0(animatorSet, 2));
            AnimatorSet animatorSet4 = obj.f30852a;
            if (i23 == -1) {
                j3 = 232;
            } else {
                j3 = 200;
            ...
            obj.f30852a.setInterpolator(new DecelerateInterpolator());
            arrayList2.add(obj);
            i23++;
            childCount = i11;
            i18 = i25;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                while (true) {
                    ...
                    if (i29 < arrayList3.size()) {
                        ...
                        if (zd0Var.f30853b <= animatedFraction) {
                            zd0Var.f30852a.start();
        ...
        animatorSet5.setInterpolator(rr.f28031g);
        animatorSet5.start();
    }
}
