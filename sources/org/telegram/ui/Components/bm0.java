...
public final class bm0 {
    ...
    public int f25659y;
    public int f25660z;
    public final RectF f25638a = new RectF();
    public final Paint f25639b = new Paint(1);
    public final Paint f25640c = new Paint(3);
    public final Matrix d = new Matrix();
    public final float[] f25641e = new float[8];
    public final Path f25642f = new Path();
    public final Paint f25643g = new Paint();
    public int f25652q = 0;
    public float f25653r = 1.0f;
    ...
    public final int a(MessageObject messageObject, TLRPC.User user, TLRPC.Chat chat, org.telegram.ui.ActionBar.g6 g6Var, int i10) {
        ...
        if (messageObject == null) {
            ...
            this.f25658x = org.telegram.ui.ActionBar.k6.l1(f10, v02);
            this.C = h();
        ...
        if (i10 == 4 && (message4 = messageObject.messageOwner) != null && MessageObject.getMedia(message4) != null && (MessageObject.getMedia(messageObject.messageOwner) instanceof TLRPC.TL_messageMediaContact)) {
            ...
            this.f25658x = org.telegram.ui.ActionBar.k6.l1(0.1f, this.f25660z);
            this.f25659y = this.f25660z;
        } else {
            c5Var = c5Var2;
            if (i10 != 0 && (messageObject.overrideLinkColor >= 0 || (messageObject.messageOwner != null && (((messageObject.isFromUser() || DialogObject.isEncryptedDialog(messageObject.getDialogId())) && user4 != null) || ((messageObject.isFromChannel() && chat != null) || (((message3 = messageObject.messageOwner) != null && (messageFwdHeader3 = message3.fwd_from) != null && messageFwdHeader3.from_id != null) || (messageObject.isSponsored() && (peerColor2 = messageObject.sponsoredColor) != null && peerColor2.color != -1))))))) {
                ...
                this.A = v04;
                this.f25660z = v04;
                this.f25658x = org.telegram.ui.ActionBar.k6.l1(0.1f, v04);
                this.f25659y = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.Wc, g6Var);
            }
        }
        if (messageObject.shouldDrawWithoutBackground()) {
            ...
            this.f25660z = -1;
            this.f25658x = 0;
            this.f25659y = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.Xc, g6Var);
            ...
            if (i10 == 2 && !messageObject.isOutOwner()) {
                ...
                if (!this.f25644i && !this.f25645j) {
                    i12 = org.telegram.ui.ActionBar.k6.f21609ab;
                } else {
                    i12 = org.telegram.ui.ActionBar.k6.f21628bb;
                }
            ...
            if (this.f25645j) {
                this.R = true;
                this.f25660z = org.telegram.ui.ActionBar.k6.l1(0.2f, this.f25660z);
                this.A = org.telegram.ui.ActionBar.k6.l1(0.5f, this.A);
            } else if (this.f25644i) {
                this.R = true;
                this.f25660z = org.telegram.ui.ActionBar.k6.l1(0.35f, this.f25660z);
            }
            int i16 = this.B;
            if (q10) {
                f11 = 0.12f;
            }
            this.f25658x = org.telegram.ui.ActionBar.k6.l1(f11, i16);
            this.f25659y = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21646cb, g6Var);
        }
        ...
        if (this.v != 0 && this.f25655t == null && (view = this.D) != null) {
            this.f25655t = new j5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.t1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.t1) view).J0) {
                this.f25655t.a();
            }
        }
        j5 j5Var = this.f25655t;
        if (j5Var != null) {
            z10 = true;
        ...
        j5 j5Var2 = this.f25656u;
        if (j5Var2 != null) {
            j5Var2.j(this.f25657w, z10);
        }
        this.C = h();
        return c5Var.a(this.f25659y, false);
    }
    ...
    public final void d(Canvas canvas, RectF rectF, float f10, boolean z4, boolean z10) {
        ...
        float f11;
        if (!z10) {
            int l1 = org.telegram.ui.ActionBar.k6.l1(f10, this.E.a(this.f25658x, false));
            Paint paint = this.f25643g;
            paint.setColor(l1);
            float[] fArr = this.f25641e;
            if (lf.l0.c(fArr)) {
                float f12 = fArr[0];
                ...
                Path path = this.f25642f;
                path.rewind();
                path.addRoundRect(rectF, fArr, Path.Direction.CW);
                canvas.drawPath(path, paint);
            }
        }
        j5 j5Var2 = this.f25655t;
        if (j5Var2 != null) {
            if (!this.Y) {
                Drawable drawable = j5Var2.f27998f[0];
                if ((drawable instanceof l5) && (z2Var = ((l5) drawable).f28604k) != null && z2Var.hasImageLoaded()) {
                    this.Y = true;
                } else {
                    z11 = false;
                    e6 = this.L.e(z11);
                    if (e6 <= 0.0f && this.f25653r > 0.0f) {
                        if (this.W == null) {
                        ...
                        j5 j5Var3 = this.f25656u;
                        if (j5Var3 != null) {
                            j5Var3.v = (int) (f10 * 255.0f);
                        }
                        this.f25655t.k(Integer.valueOf(this.C));
                        int i10 = 0;
                        while (true) {
                            am0[] am0VarArr = this.W;
                            if (i10 < am0VarArr.length) {
                                if (i10 != 0 || (j5Var = this.f25656u) == null || this.f25657w == 0) {
                                    j5Var = this.f25655t;
                                }
                                am0 am0Var = am0VarArr[i10];
                                if (!am0Var.f25295e || z4) {
                                    if (j5Var == this.f25656u) {
                                        f11 = 1.0f;
                                    } else {
                                        f11 = 0.3f;
                                    }
                                    j5Var.v = (int) (f11 * 255.0f * am0Var.d * this.f25653r);
                                    float dp = max - AndroidUtilities.dp(am0Var.f25292a);
                                    float dp2 = AndroidUtilities.dp(am0Var.f25293b) + min;
                                    float dp3 = AndroidUtilities.dp(10.0f) * am0Var.f25294c * e6;
    ...
    public final void e(android.graphics.Canvas r27, android.graphics.RectF r28, float r29) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.bm0.e(android.graphics.Canvas, android.graphics.RectF, float):void");
    }
    ...
    public final void f(Canvas canvas, RectF rectF, float f10, float f11, float f12, float f13) {
        ...
        if (this.h == null) {
            ...
            this.h = k90Var3;
            k90Var3.C = true;
            k90Var3.f28345t = 3.5f;
            k90Var3.f28346u = 0.5f;
        }
        this.h.f(org.telegram.ui.ActionBar.k6.l1(0.1f, this.f25660z), org.telegram.ui.ActionBar.k6.l1(0.3f, this.f25660z), org.telegram.ui.ActionBar.k6.l1(0.3f, this.f25660z), org.telegram.ui.ActionBar.k6.l1(1.25f, this.f25660z));
        this.h.d(rectF);
        this.h.i(fArr);
        this.h.f28347w.setStrokeWidth(AndroidUtilities.dp(1.0f));
    ...
    public final void k() {
        this.F.a(this.f25660z, true);
        this.G.a(this.A, true);
        this.J.f(this.f25644i, true);
        this.I.a(this.f25659y, true);
        this.E.a(this.f25658x, true);
        j5 j5Var = this.f25655t;
        if (j5Var != null) {
            j5Var.d.d(1.0f, true);
        }
    ...
    public final int l(MessageObject messageObject, TLRPC.TL_peerColorCollectible tL_peerColorCollectible, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        this.R = false;
        this.f25660z = tL_peerColorCollectible.colors.get(0).intValue() | (-16777216);
        if (arrayList.size() >= 2) {
            z4 = true;
        } else {
            z4 = false;
        ...
        this.f25659y = i12;
        this.f25658x = org.telegram.ui.ActionBar.k6.l1(0.1f, i12);
        long j10 = tL_peerColorCollectible.background_emoji_id;
        this.v = j10;
        this.f25657w = tL_peerColorCollectible.gift_emoji_id;
        View view = this.D;
        if (j10 != 0 && this.f25655t == null && view != null) {
            this.f25655t = new j5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.t1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.t1) view).J0) {
                this.f25655t.a();
            }
        ...
        this.C = this.f25659y;
        if (this.f25657w != 0 && this.f25656u == null && view != null) {
            this.f25656u = new j5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.t1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.t1) view).J0) {
                this.f25656u.a();
            }
        }
        j5 j5Var2 = this.f25656u;
        if (j5Var2 != null) {
            j5Var2.j(this.f25657w, true);
        }
        return this.I.a(this.f25659y, false);
    }
    ...
    public final void m(MessageObject messageObject, int i10, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        if (i10 < 7) {
            int v02 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21914r8[i10], g6Var);
            this.B = v02;
            this.A = v02;
            this.f25660z = v02;
            this.f25645j = false;
    ...
    public final int o(org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        this.f25659y = org.telegram.ui.ActionBar.k6.v0(i10, g6Var);
        this.f25660z = org.telegram.ui.ActionBar.k6.v0(i10, g6Var);
        this.f25644i = false;
        this.f25645j = false;
        this.f25658x = org.telegram.ui.ActionBar.k6.l1(0.1f, org.telegram.ui.ActionBar.k6.v0(i10, g6Var));
        if (this.v != 0 && this.f25655t == null && (view = this.D) != null) {
            this.f25655t = new j5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.t1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.t1) view).J0) {
                this.f25655t.a();
    ...
    public final void q(int i10, boolean z4) {
        ...
        this.f25658x = org.telegram.ui.ActionBar.k6.l1(f10, i10);
        this.C = i10;
    }
}
