...
public final class bm0 extends Dialog {
    ...
    public final org.telegram.ui.ActionBar.f6 f22766b;
    public Bitmap f22767c;
    public BitmapShader d;
    public Paint e;
    public Matrix f22768f;
    public final fh.b h;
    public final ah.c f22769n;
    public float f22770r;
    public final ai.f0 f22771s;
    public final qv0 v;
    public n70 f22772w;
    public FrameLayout f22773x;
    public ViewGroup f22774y;
    ...
    public final void dismiss() {
        ...
        this.f22771s.invalidate();
    }

    public final void e(n70 n70Var) {
        int i10 = org.telegram.ui.ActionBar.j6.E8;
        org.telegram.ui.ActionBar.f6 f6Var = this.f22766b;
        n70Var.T(org.telegram.ui.ActionBar.j6.l1(0.06f, org.telegram.ui.ActionBar.j6.v0(i10, f6Var)));
        n70Var.Q(this.f22769n, eh.b.k(f6Var), false);
        this.f22772w = n70Var;
        this.f22774y = n70Var.A;
        FrameLayout frameLayout = new FrameLayout(this.f22765a);
        this.f22773x = frameLayout;
        frameLayout.addView(this.f22774y, w7.x5.c(-2.0f, -2));
        this.v.addView(this.f22773x, w7.x5.c(-2.0f, -2));
    }
