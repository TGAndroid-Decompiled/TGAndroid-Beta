...
public final class mz extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.f6 f26563a;
    public final TextView f26564b;
    public final View f26565c;
    public final nj0 d;
    public boolean e;
    public int f26566f;
    ...
    public mz(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f26565c = radialProgressView;
        ...
        this.f26564b = textView;
        textView.setTextSize(1, 20.0f);
        textView.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19092c7, f6Var));
    ...
    public final void b() {
        AndroidUtilities.updateViewVisibilityAnimated(this.f26564b, false, 0.9f, true);
        AndroidUtilities.updateViewVisibilityAnimated(this.f26565c, true, 1.0f, true);
    }

    public final void c() {
        AndroidUtilities.updateViewVisibilityAnimated(this.f26564b, true, 0.9f, true);
        AndroidUtilities.updateViewVisibilityAnimated(this.f26565c, false, 1.0f, true);
    }
    ...
    public void setText(String str) {
        this.f26564b.setText(str);
    }

    public void setTextColor(int i10) {
        this.f26564b.setTextColor(i10);
    }

    public void setTextSize(int i10) {
        this.f26564b.setTextSize(1, i10);
    }

    public void setTopImage(int i10) {
        TextView textView = this.f26564b;
        if (i10 == 0) {
        ...
        if (mutate != null) {
            mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19092c7, this.f26563a), PorterDuff.Mode.MULTIPLY));
        }
