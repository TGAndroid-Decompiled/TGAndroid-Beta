...
public final class mz extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.e6 f26262a;
    public final TextView f26263b;
    public final View f26264c;
    public final aj0 d;
    public boolean e;
    public int f26265f;
    ...
    public mz(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.f26264c = radialProgressView;
        ...
        textView.setTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18817c7, e6Var));
    ...
    public final void b() {
        AndroidUtilities.updateViewVisibilityAnimated(this.f26263b, false, 0.9f, true);
        AndroidUtilities.updateViewVisibilityAnimated(this.f26264c, true, 1.0f, true);
    }

    public final void c() {
        AndroidUtilities.updateViewVisibilityAnimated(this.f26263b, true, 0.9f, true);
        AndroidUtilities.updateViewVisibilityAnimated(this.f26264c, false, 1.0f, true);
    }
    ...
    public void setText(String str) {
        this.f26263b.setText(str);
    }

    public void setTextColor(int i10) {
        this.f26263b.setTextColor(i10);
    }

    public void setTextSize(int i10) {
        this.f26263b.setTextSize(1, i10);
    }
    ...
    public void setTopImage(int i10) {
        ...
        if (mutate != null) {
            mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18817c7, this.f26262a), PorterDuff.Mode.MULTIPLY));
        }
