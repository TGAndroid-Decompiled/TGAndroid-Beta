...
public final class mz extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.f6 f28597a;
    public final TextView f28598b;
    public final View f28599c;
    public final aj0 d;
    ...
    public mz(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f28599c = radialProgressView;
        ...
        textView.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20673c7, f6Var));
    ...
    public final void b() {
        AndroidUtilities.updateViewVisibilityAnimated(this.f28598b, false, 0.9f, true);
        AndroidUtilities.updateViewVisibilityAnimated(this.f28599c, true, 1.0f, true);
    }

    public final void c() {
        AndroidUtilities.updateViewVisibilityAnimated(this.f28598b, true, 0.9f, true);
        AndroidUtilities.updateViewVisibilityAnimated(this.f28599c, false, 1.0f, true);
    }
    ...
    public void setText(String str) {
        this.f28598b.setText(str);
    }

    public void setTextColor(int i10) {
        this.f28598b.setTextColor(i10);
    }

    public void setTextSize(int i10) {
        this.f28598b.setTextSize(1, i10);
    }
    ...
    public void setTopImage(int i10) {
        ...
        if (mutate != null) {
            mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20673c7, this.f28597a), PorterDuff.Mode.MULTIPLY));
        }
