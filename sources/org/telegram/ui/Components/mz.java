...
public final class mz extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.f6 f28598a;
    public final TextView f28599b;
    public final View f28600c;
    public final aj0 d;
    ...
    public mz(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f28600c = radialProgressView;
        ...
        textView.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20674c7, f6Var));
    ...
    public final void b() {
        AndroidUtilities.updateViewVisibilityAnimated(this.f28599b, false, 0.9f, true);
        AndroidUtilities.updateViewVisibilityAnimated(this.f28600c, true, 1.0f, true);
    }

    public final void c() {
        AndroidUtilities.updateViewVisibilityAnimated(this.f28599b, true, 0.9f, true);
        AndroidUtilities.updateViewVisibilityAnimated(this.f28600c, false, 1.0f, true);
    }
    ...
    public void setText(String str) {
        this.f28599b.setText(str);
    }

    public void setTextColor(int i10) {
        this.f28599b.setTextColor(i10);
    }

    public void setTextSize(int i10) {
        this.f28599b.setTextSize(1, i10);
    }
    ...
    public void setTopImage(int i10) {
        ...
        if (mutate != null) {
            mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20674c7, this.f28598a), PorterDuff.Mode.MULTIPLY));
        }
