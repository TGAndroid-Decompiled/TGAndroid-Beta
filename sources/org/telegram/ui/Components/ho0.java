...
public final class ho0 {
    ...
    public Object f26806g;

    public ho0(y2.d dVar) {
        this.f26803c = dVar;
        int i10 = dVar.f49511b;
        this.f26801a = i10;
        this.d = new e2.v(32);
    ...
    public static u2.x0 d(u2.x0 x0Var, long j3, ByteBuffer byteBuffer, int i10) {
        while (j3 >= x0Var.f46884b) {
            x0Var = (u2.x0) x0Var.d;
        }
        while (i10 > 0) {
            int min = Math.min(i10, (int) (x0Var.f46884b - j3));
            y2.a aVar = (y2.a) x0Var.f46885c;
            byteBuffer.put(aVar.f49505a, ((int) (j3 - x0Var.f46883a)) + aVar.f49506b, min);
            i10 -= min;
            j3 += min;
            if (j3 == x0Var.f46884b) {
                x0Var = (u2.x0) x0Var.d;
    ...
    public static u2.x0 e(u2.x0 x0Var, long j3, byte[] bArr, int i10) {
        ...
        int i11 = i10;
        while (i11 > 0) {
            int min = Math.min(i11, (int) (x0Var.f46884b - j3));
            y2.a aVar = (y2.a) x0Var.f46885c;
            System.arraycopy(aVar.f49505a, ((int) (j3 - x0Var.f46883a)) + aVar.f49506b, bArr, i10 - i11, min);
            i11 -= min;
            j3 += min;
            if (j3 == x0Var.f46884b) {
                x0Var = (u2.x0) x0Var.d;
    ...
    public void a(u2.x0 x0Var) {
        ...
        y2.d dVar = (y2.d) this.f26803c;
        synchronized (dVar) {
            u2.x0 x0Var2 = x0Var;
            while (x0Var2 != null) {
                try {
                    y2.a[] aVarArr = dVar.f49514f;
                    int i10 = dVar.f49513e;
                    dVar.f49513e = i10 + 1;
                    y2.a aVar = (y2.a) x0Var2.f46885c;
                    aVar.getClass();
                    aVarArr[i10] = aVar;
                    dVar.d--;
                    x0Var2 = (u2.x0) x0Var2.d;
                    if (x0Var2 == null || ((y2.a) x0Var2.f46885c) == null) {
                        x0Var2 = null;
                    }
                } catch (Throwable th2) {
                    throw th2;
    ...
    public void b(long j3) {
        ...
        if (j3 != -1) {
            while (true) {
                ...
                u2.x0 x0Var2 = (u2.x0) this.f26804e;
                x0Var2.f46885c = null;
                x0Var2.d = null;
                this.f26804e = (u2.x0) x0Var2.d;
            }
            if (((u2.x0) this.f26805f).f46883a < x0Var.f46883a) {
                this.f26805f = x0Var;
            }
        }
    }
    ...
    public int c(int i10) {
        y2.a aVar;
        u2.x0 x0Var = (u2.x0) this.f26806g;
        if (((y2.a) x0Var.f46885c) == null) {
            y2.d dVar = (y2.d) this.f26803c;
            synchronized (dVar) {
                try {
                    ...
                    if (i12 > 0) {
                        ...
                        aVar = aVarArr[i13];
                        aVar.getClass();
                        dVar.f49514f[dVar.f49513e] = null;
                    } else {
                        y2.a aVar2 = new y2.a(new byte[dVar.f49511b], 0);
                        y2.a[] aVarArr2 = dVar.f49514f;
                        if (i11 > aVarArr2.length) {
                            dVar.f49514f = (y2.a[]) Arrays.copyOf(aVarArr2, aVarArr2.length * 2);
                        }
                        aVar = aVar2;
                    }
                } catch (Throwable th2) {
            ...
            u2.x0 x0Var2 = new u2.x0(((u2.x0) this.f26806g).f46884b, this.f26801a);
            x0Var.f46885c = aVar;
            x0Var.d = x0Var2;
        }
        return Math.min(i10, (int) (((u2.x0) this.f26806g).f46884b - this.f26802b));
    }

    public ho0(cc0 cc0Var) {
        this.d = new ArrayList(50);
        this.f26804e = new ArrayList(50);
