...
public final class sh0 extends FrameLayout {
    public final Paint f27853a;
    public final Path f27854b;
    public final rh0 f27855c;
    public float d;
    public float e;
    public float f27856f;
    public boolean h;
    public NotchInfoUtils.NotchInfo f27857n;
    ...
    public sh0(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 31 && SharedConfig.getDevicePerformanceClass() >= 1) {
            ...
            this.f27855c = new qh0(this, f7);
        } else {
            this.f27855c = new ph0(this);
        }
        setIntensity(15.0f);
    ...
    public final void draw(Canvas canvas) {
        ...
        this.f27855c.c(new lv(this, 12), canvas);
    }

    public float getAvatarEndScale() {
        float min;
        int dp;
        NotchInfoUtils.NotchInfo notchInfo = this.f27857n;
        if (notchInfo == null) {
            return 0.8f;
        }
        if (notchInfo.isLikelyCircle) {
            ...
            min = Math.min(notchInfo.bounds.width(), this.f27857n.bounds.height());
            dp = AndroidUtilities.dp(100.0f);
        }
