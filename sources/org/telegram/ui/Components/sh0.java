...
public final class sh0 extends View {
    ...
    public final gi0[] f28191c;
    public final gi0[] d;
    public volatile boolean e;
    public final Paint[] f28192f;
    public bi0 h;
    public int f28193n;
    public int f28194r;
    public final rh0 f28195s;
    public final rh0 v;
    public int f28196w;
    public int f28197x;
    public int f28198y;
    ...
    public sh0(Context context) {
        ...
        this.f28191c = new gi0[3];
        this.d = new gi0[3];
        this.e = false;
        Paint[] paintArr = {new Paint(), new Paint()};
        this.f28192f = paintArr;
        this.f28195s = new rh0(this, 0);
        ...
        this.H = false;
        this.N = new zv0[3];
        d6 d6Var = new d6(this, 0L, 350L, qr.f27653f);
        this.O = d6Var;
        this.P = new ai.m7(this, 3);
        d6Var.d(1.0f, true);
        boolean z11 = this.f28189a & SharedConfig.useNewBlur;
        this.f28189a = z11;
        if (z11) {
            setLayerType(2, null);
            return;
    ...
    public static void a(sh0 sh0Var, int i10, int i11, int i12) {
        synchronized (sh0Var.f28190b) {
            try {
                gi0[] gi0VarArr = sh0Var.f28191c;
                ...
                if (i10 == 2) {
                    if (gi0Var2.f24536f) {
                        sh0Var.b(gi0Var2.f24534b, i11);
                    }
                } else {
                    Paint[] paintArr = sh0Var.f28192f;
                    Paint paint = paintArr[i10];
                    paintArr[i10] = paintArr[i11];
                    paintArr[i11] = paint;
                }
                if (i12 != -1) {
                    sh0Var.f28192f[i12].setShader(null);
                    gi0 gi0Var3 = sh0Var.f28191c[i12];
                    if (gi0Var3 != null && !gi0Var3.e && !gi0Var3.d) {
                        gi0Var3.f24536f = false;
                        gi0Var3.f24534b.eraseColor(0);
                    }
                }
            } finally {
            }
    ...
    public final void b(Bitmap bitmap, int i10) {
        if (i10 < 2 && bitmap != null && !bitmap.isRecycled()) {
            LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, 0.0f, this.f28194r / 6.0f, new int[]{0, -1}, new float[]{0.0f, AndroidUtilities.dpf2(56.0f) / this.f28194r}, Shader.TileMode.CLAMP);
            Shader.TileMode tileMode = Shader.TileMode.MIRROR;
            this.f28192f[i10].setShader(new ComposeShader(new BitmapShader(bitmap, tileMode, tileMode), linearGradient, PorterDuff.Mode.DST_IN));
        }
    }
    ...
    public final void c(float f7, org.telegram.ui.m01 m01Var, float f10, float f11) {
        ...
        this.M.setPosition(0, 0, (int) Math.ceil(f7 / renderNodeScale), (int) ((this.f28193n + f11) / renderNodeScale));
        ...
        if (qh0Var2 != null) {
            if (m01Var != null) {
                qh0Var2.f27574w = this.M;
                qh0Var2.f27572r = m01Var;
                qh0Var2.f27573s = renderNodeScale / f10;
                qh0Var2.v = -f11;
                qh0Var2.invalidate();
            } else {
                qh0Var2.f27574w = this.M;
                qh0Var2.f27572r = null;
                qh0Var2.f27573s = renderNodeScale;
                qh0Var2.v = -f11;
                qh0Var2.invalidate();
            }
        }
    ...
    public final void e() {
        ...
        if (bi0Var != null) {
            ai.m7 m7Var = this.P;
            ArrayList arrayList = bi0Var.f48459k0;
            if (arrayList != null) {
        ...
        this.e = false;
        hi0.f24838a.cancelRunnable(this.f28195s);
        ...
        this.I = null;
        this.J = null;
        synchronized (this.f28190b) {
            for (int i10 = 0; i10 < 3; i10++) {
                try {
                    gi0 gi0Var = this.f28191c[i10];
                    if (gi0Var != null) {
                        gi0Var.a();
                        this.f28191c[i10] = null;
                    }
            ...
            this.f28192f[0].setShader(null);
            this.f28192f[1].setShader(null);
        }
    }
    ...
    public final void f(Canvas canvas, org.telegram.ui.m01 m01Var, float f7, float f10, boolean z10, float f11, float f12) {
        ...
        if (bi0Var != null && bi0Var.isAttachedToWindow() && this.h.getVisibility() != 8) {
            if (this.f28189a && Build.VERSION.SDK_INT >= 31) {
                if (canvas2.isHardwareAccelerated()) {
                    if (m01Var == null && getVisibility() == 0 && getAlpha() > 0.0f) {
                        ...
                        this.L.setPosition(0, 0, (int) (f7 / renderNodeScale), (int) ((this.f28194r + this.f28193n) / renderNodeScale));
                        RecordingCanvas beginRecording = this.L.beginRecording();
                        float f14 = 1.0f / renderNodeScale;
                        beginRecording.scale(f14, f14);
                        beginRecording.save();
                        beginRecording.translate(-this.f28197x, 0.0f);
                        i(beginRecording, 0);
                        beginRecording.restore();
                        if (this.f28197x != 0) {
                            beginRecording.save();
                            beginRecording.translate((-this.f28197x) + f7, 0.0f);
                            i(beginRecording, 1);
                            beginRecording.restore();
                        }
                        this.L.endRecording();
                        ...
                        if (getVisibility() == 0 && getAlpha() > 0.0f) {
                            c(f7, null, 1.0f, this.f28194r);
                            return;
                        }
                        return;
                    } else if (m01Var != null) {
                        float measuredWidth = f7 / this.h.getMeasuredWidth();
                        float f15 = this.f28194r * (1.0f - f11);
                        float f16 = f15 * measuredWidth;
                        float renderNodeScale2 = getRenderNodeScale() * measuredWidth;
                        j();
                        this.L.setPosition(0, 0, (int) (f7 / renderNodeScale2), (int) ((this.f28193n + f15) / renderNodeScale2));
                        ...
                        if (p5Var != null) {
                            ...
                            imageReceiver = m01Var.f29034a;
                        }
                        g(imageReceiver, beginRecording2, f16, f10);
                        if (m01Var.f35584a0 && m01Var.V > 0.0f) {
                    ...
                    this.f28189a = false;
                    setLayerType(1, this.f28192f[0]);
                    setLayerType(1, this.f28192f[1]);
                } else {
                    return;
                }
            }
            ...
            if (this.H || this.G || this.F || (this.f28192f[0].getShader() == null && this.f28192f[1].getShader() == null && !this.e)) {
                boolean d = d();
                if (!this.e && d) {
                    this.e = true;
                    DispatchQueue dispatchQueue = hi0.f24838a;
                    dispatchQueue.cancelRunnable(this.f28195s);
                    dispatchQueue.postRunnable(this.f28195s);
                }
            }
            if (this.f28192f[0].getShader() != null || this.f28192f[1].getShader() != null) {
                synchronized (this.f28190b) {
                    try {
                        float f18 = f7 / this.f28198y;
                        if (z10) {
                            canvas2.translate(0.0f, (-f18) * this.E);
                        }
                        canvas2.scale(f18, f18);
                        float f19 = this.f28193n / f18;
                        if (this.f28192f[0].getShader() != null) {
                            canvas2.save();
                            canvas2.translate((-this.f28197x) / f18, 0.0f);
                            canvas2.save();
                            ...
                            f13 = 2.0f;
                            c10 = 1;
                            canvas2.drawRect(0.0f, f20, this.f28198y, f20 + f19, this.f28192f[0]);
                            canvas.restore();
                            this.f28192f[0].setAlpha((int) (f12 * 255.0f));
                            float f21 = this.E;
                            canvas2 = canvas;
                            canvas2.drawRect(0.0f, f21 * f11, this.f28198y, f21, this.f28192f[0]);
                            this.f28192f[0].setAlpha(255);
                            canvas2.restore();
                        } else {
                            i10 = 255;
                            f13 = 2.0f;
                        ...
                        if (this.f28197x != 0 && this.f28192f[c10].getShader() != null) {
                            canvas2.save();
                            canvas2.translate(((-this.f28197x) + f7) / f18, 0.0f);
                            canvas2.save();
                            canvas2.scale(1.0f, f13, 0.0f, this.E);
                            float f22 = this.E;
                            canvas2.drawRect(0.0f, f22, this.f28198y, f22 + f19, this.f28192f[c10]);
                            canvas.restore();
                            this.f28192f[c10].setAlpha((int) (f12 * 255.0f));
                            float f23 = this.E;
                            canvas.drawRect(0.0f, f23 * f11, this.f28198y, f23, this.f28192f[c10]);
                            this.f28192f[c10].setAlpha(i10);
                            canvas.restore();
                        }
                    } catch (Throwable th2) {
                        throw th2;
    ...
    public final void h(int i10, View view) {
        ...
        if (view != null && !gi0Var.e) {
            Canvas canvas = gi0Var.f24533a;
            canvas.save();
            canvas.scale(0.16666667f, 0.16666667f);
            canvas.translate(0.0f, this.f28194r - view.getMeasuredHeight());
            view.draw(canvas);
            canvas.restore();
            gi0Var.f24536f = true;
        }
        if (i10 != 0 && (this.f28197x == 0 || i10 != 1)) {
            return;
        }
    ...
    public final void i(Canvas canvas, int i10) {
        View E = this.h.E(this.f28196w + i10);
        if (E != null) {
            int measuredHeight = E.getMeasuredHeight();
            canvas.save();
            canvas.translate(0.0f, this.f28194r - measuredHeight);
            E.draw(canvas);
            canvas.restore();
            canvas.save();
            canvas.scale(1.0f, -1.0f);
            canvas.translate(0.0f, (-measuredHeight) - this.f28194r);
    ...
    public final void j() {
        if (this.L == null) {
            ...
            float[] fArr = {0.0f, AndroidUtilities.dpf2(56.0f) / this.f28194r};
            Shader.TileMode tileMode = Shader.TileMode.CLAMP;
            LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, 0.0f, this.f28194r / renderNodeScale, new int[]{0, -1}, fArr, tileMode);
    ...
    public final void onMeasure(int i10, int i11) {
        setMeasuredDimension(View.MeasureSpec.getSize(i10), this.f28194r + this.f28193n);
    }
    ...
    public void setSize(int i10) {
        ...
        this.f28193n = i10;
        this.f28194r = (int) (AndroidUtilities.dp(64.0f) * 1.5f);
    }

    public void setView(bi0 bi0Var) {
        e();
        this.h = bi0Var;
        this.f28196w = bi0Var.getCurrentItem();
        this.f28197x = 0;
        bi0Var.b(this.P);
    }
