...
public final class tr extends View {
    public final TextPaint f31400a;
    public final TextPaint f31401b;
    public final String f31402c;
    public final String d;
    public final Rect f31403e;

    public tr(Context context, String str, String str2) {
        super(context);
        TextPaint textPaint = new TextPaint(1);
        this.f31400a = textPaint;
        TextPaint textPaint2 = new TextPaint(1);
        this.f31401b = textPaint2;
        this.f31403e = new Rect();
        this.f31402c = str;
        this.d = str2;
    ...
    public final void onDraw(Canvas canvas) {
        TextPaint textPaint = this.f31401b;
        String str = this.d;
        float measureText = textPaint.measureText(str);
        TextPaint textPaint2 = this.f31400a;
        String str2 = this.f31402c;
        float measureText2 = textPaint2.measureText(str2);
        int length = str2.length();
        Rect rect = this.f31403e;
