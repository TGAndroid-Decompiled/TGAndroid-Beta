...
public final class im extends uk0 {
    ...
    public final boolean E(ml0 ml0Var) {
        ...
        boolean isEmpty = ChatAttachAlertPhotoLayout.f21870r1.isEmpty();
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.v;
        if ((!isEmpty || ((albumEntry = chatAttachAlertPhotoLayout.T0) != null && !albumEntry.photos.isEmpty())) && chatAttachAlertPhotoLayout.f26744b.R && h() > 30) {
            return true;
        }
        return false;
    }
    ...
    public final String F(int i10) {
        ...
        if (M == null) {
            int i11 = this.f24999r;
            ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.v;
            if (i10 <= i11) {
                ArrayList arrayList2 = ChatAttachAlertPhotoLayout.f21870r1;
    ...
    public final float H(ml0 ml0Var) {
        int i10 = this.v.M0;
        int ceil = (int) Math.ceil(this.f24998n / i10);
        if (ml0Var.getChildCount() != 0) {
            int measuredHeight = ml0Var.getChildAt(0).getMeasuredHeight();
            View childAt = ml0Var.getChildAt(0);
            int R = RecyclerView.R(childAt);
            if (R >= 0) {
                return Utilities.clamp((((R / i10) * measuredHeight) - childAt.getTop()) / ((ceil * measuredHeight) - (ml0Var.getMeasuredHeight() - org.telegram.ui.ActionBar.k.getCurrentActionBarHeight())), 1.0f, 0.0f);
            }
        }
        return 0.0f;
    }
    ...
    public final wk0 L() {
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.v;
        org.telegram.ui.Cells.t5 t5Var = new org.telegram.ui.Cells.t5(this.f24996c, chatAttachAlertPhotoLayout.f26743a);
    ...
    public final int h() {
        ...
        if (!chatAttachAlertPhotoLayout.f21912v0) {
            return 1;
        }
        int i10 = 0;
        this.e = false;
        ...
        this.f24999r = i10;
        if (!z10) {
            i10 += ChatAttachAlertPhotoLayout.f21870r1.size();
            MediaController.AlbumEntry albumEntry = chatAttachAlertPhotoLayout.T0;
            if (albumEntry != null) {
    ...
    public final int j(int i10) {
        ...
        if (chatAttachAlertPhotoLayout.f21912v0) {
            ...
            if (chatAttachAlertPhotoLayout.f21887g1 && i11 == 0) {
                return 4;
            }
            if (this == imVar && i10 == this.f24998n - 1) {
                return 2;
            }
            if (z10) {
                return 3;
    ...
    public final void l() {
        ...
        if (this == chatAttachAlertPhotoLayout.G) {
            ...
            if ((h() == 1 && !chatAttachAlertPhotoLayout.P0 && chatAttachAlertPhotoLayout.T0 == null) || !chatAttachAlertPhotoLayout.f21912v0) {
                i10 = 0;
            } else {
                i10 = 4;
            }
            nzVar.setVisibility(i10);
        }
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 != 0) {
            if (i11 != 1) {
                if (i11 != 3) {
                    if (i11 == 7) {
                        ((h20) view).setUseAnEmojiVisible(chatAttachAlertPhotoLayout.f21887g1);
                        return;
                    }
                    return;
                }
        ...
        if (this.f24997f && i10 > chatAttachAlertPhotoLayout.M0) {
            i10--;
        }
        ...
        if (this == chatAttachAlertPhotoLayout.G) {
            ...
            if (chatAttachAlertPhotoLayout.f21908s.f42615o == 1) {
                z10 = true;
            } else {
                z10 = false;
            }
        ...
        if ((wiVar.f29665f0 instanceof org.telegram.ui.xn) && wiVar.T1) {
            t5Var.b(ChatAttachAlertPhotoLayout.f21872t1.indexOf(Integer.valueOf(b02.imageId)), hashMap.containsKey(Integer.valueOf(b02.imageId)), false);
        } else {
            t5Var.b(-1, hashMap.containsKey(Integer.valueOf(b02.imageId)), false);
        }
        if (!chatAttachAlertPhotoLayout.f21914w0 && b02.isVideo) {
            t5Var.setAlpha(0.3f);
        } else if (!chatAttachAlertPhotoLayout.f21916x0 && !b02.isVideo) {
            t5Var.setAlpha(0.3f);
        } else {
            t5Var.setAlpha(1.0f);
        }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.v;
        wi wiVar = chatAttachAlertPhotoLayout.f26744b;
        org.telegram.ui.ActionBar.d6 d6Var = chatAttachAlertPhotoLayout.f26743a;
        if (i10 != 0) {
                        ...
                        if (i10 != 5) {
                            if (i10 != 7) {
                                if (i10 != 8) {
                                    ...
                                    frameLayout.f20445a = imageView;
                                    ImageView.ScaleType scaleType = ImageView.ScaleType.CENTER;
                                    imageView.setScaleType(scaleType);
                                    int v02 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18736aa, d6Var);
                                    PorterDuff.Mode mode = PorterDuff.Mode.MULTIPLY;
                                    imageView.setColorFilter(new PorterDuffColorFilter(v02, mode));
                                    frameLayout.addView(imageView, w7.x5.d(44, 44.0f, 17, 5.0f, 0.0f, 0.0f, 27.0f));
                                    ImageView imageView2 = new ImageView(context);
                                    frameLayout.f20446b = imageView2;
                                    imageView2.setScaleType(scaleType);
                                    imageView2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18756ba, d6Var), mode));
                                    frameLayout.addView(imageView2, w7.x5.d(44, 44.0f, 17, 5.0f, 0.0f, 0.0f, 27.0f));
                                    TextView textView = new TextView(context);
                                    frameLayout.f20447c = textView;
                                    org.telegram.messenger.ul.o(org.telegram.ui.ActionBar.h6.f18775ca, d6Var, textView, 1, 12.0f);
                            ...
                            h20Var.isClickable();
                            h20Var.f24482b.setOnClickListener(new f0(new ml(chatAttachAlertPhotoLayout, 5), 18));
                            h20Var.f24481a.setOnClickListener(new f0(new ml(chatAttachAlertPhotoLayout, 6), 19));
                            h20Var.f24483c.setOnClickListener(new et(5, h20Var, new x2(this, 2)));
                            return new s4.c1(h20Var);
                        }
                        return new s4.c1(new View(context));
                    }
                    wiVar.getClass();
                    return new s4.c1(new hm(this, context));
                }
                return new s4.c1(new ci.bb(this, context, 13));
            }
            ?? view = new View(context);
            view.setFocusable(true);
            view.f20409a = AndroidUtilities.dp(0.0f);
    ...
    public final void y(s4.c1 c1Var) {
        if (c1Var.f42627a instanceof org.telegram.ui.Cells.m5) {
            this.v.Q.g();
        }
    }
}
