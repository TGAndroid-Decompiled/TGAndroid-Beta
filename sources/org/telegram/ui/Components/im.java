...
public final class im extends el0 {
    ...
    public final boolean E(wl0 wl0Var) {
        ...
        if ((!isEmpty || ((albumEntry = chatAttachAlertPhotoLayout.T0) != null && !albumEntry.photos.isEmpty())) && chatAttachAlertPhotoLayout.f27087b.R && h() > 30) {
            return true;
        }
        return false;
    }
    ...
    public final float H(wl0 wl0Var) {
        int i10 = this.v.M0;
        int ceil = (int) Math.ceil(this.f25113n / i10);
        if (wl0Var.getChildCount() != 0) {
            int measuredHeight = wl0Var.getChildAt(0).getMeasuredHeight();
            View childAt = wl0Var.getChildAt(0);
            int R = RecyclerView.R(childAt);
            if (R >= 0) {
                return Utilities.clamp((((R / i10) * measuredHeight) - childAt.getTop()) / ((ceil * measuredHeight) - (wl0Var.getMeasuredHeight() - org.telegram.ui.ActionBar.k.getCurrentActionBarHeight())), 1.0f, 0.0f);
            }
        }
        return 0.0f;
    }
    ...
    public final gl0 L() {
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.v;
        org.telegram.ui.Cells.t5 t5Var = new org.telegram.ui.Cells.t5(this.f25111c, chatAttachAlertPhotoLayout.f27086a);
    ...
    public final int j(int i10) {
        ...
        if (chatAttachAlertPhotoLayout.f22163v0) {
            ...
            if (this == imVar && i10 == this.f25113n - 1) {
                return 2;
            }
            if (z10) {
                return 3;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 != 0) {
            if (i11 != 1) {
                if (i11 != 3) {
                    if (i11 == 7) {
                        ((h20) view).setUseAnEmojiVisible(chatAttachAlertPhotoLayout.f22138g1);
                        return;
                    }
                    return;
                }
        ...
        if (this.f25112f && i10 > chatAttachAlertPhotoLayout.M0) {
            i10--;
        }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.v;
        wi wiVar = chatAttachAlertPhotoLayout.f27087b;
        org.telegram.ui.ActionBar.d6 d6Var = chatAttachAlertPhotoLayout.f27086a;
        if (i10 != 0) {
                ...
                if (i10 != 2) {
                    if (i10 != 4) {
                        if (i10 != 5) {
                            ...
                            h20Var.isClickable();
                            h20Var.f24616b.setOnClickListener(new f0(new ml(chatAttachAlertPhotoLayout, 5), 18));
                            h20Var.f24615a.setOnClickListener(new f0(new ml(chatAttachAlertPhotoLayout, 6), 19));
                            h20Var.f24617c.setOnClickListener(new et(5, h20Var, new y2(this, 2)));
