...
public final class p40 extends HorizontalScrollView {
    ...
    public final org.telegram.ui.ActionBar.g6 f29967a;
    public final z5 f29968b;
    public final z5 f29969c;
    public final LinearLayout d;
    public final Paint f29970e;
    public final TextPaint f29971f;
    public boolean h;
    public int f29972n;
    public final Path f29973r;
    public final Path f29974s;

    public p40(Context context, org.telegram.ui.ActionBar.g6 g6Var) {
        super(context);
        this.f29970e = new Paint(1);
        TextPaint textPaint = new TextPaint(1);
        this.f29971f = textPaint;
        this.f29973r = new Path();
        this.f29974s = new Path();
        this.f29967a = g6Var;
    ...
    public final void a(int i10, boolean z4) {
        ...
        boolean z10 = !z4;
        this.f29968b.d(linearLayout.getChildAt(i10).getLeft(), z10);
        this.f29969c.d(linearLayout.getChildAt(i10).getRight(), z10);
    }
    ...
    public final void b(ArrayList arrayList, MessagesStorage.IntCallback intCallback) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            h0Var.f6322b = new k01(charSequence, this.f29971f);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        path2.close();
        boolean z4 = this.h;
        org.telegram.ui.ActionBar.g6 g6Var = this.f29967a;
        if (z4) {
            v02 = org.telegram.ui.ActionBar.k6.l1(0.1f, org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.Oh, g6Var));
        } else {
            v02 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f22038y6, g6Var) & 520093695;
        }
        Paint paint = this.f29970e;
        paint.setColor(v02);
        canvas.drawPath(path, paint);
        int v04 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f22038y6, g6Var);
        TextPaint textPaint = this.f29971f;
