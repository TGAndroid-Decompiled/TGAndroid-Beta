...
public final class ge0 extends FrameLayout {
    public final RectF f24327a;
    public boolean f24328b;
    public final Context f24329c;
    public final pe0 d;

    public ge0(pe0 pe0Var, Activity activity, Activity activity2) {
        super(activity);
        this.d = pe0Var;
        this.f24329c = activity2;
        this.f24327a = new RectF();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (f7 != 1.0f) {
            paint.setColor(pe0Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18907h5));
        ...
        int themedColor = pe0Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18907h5);
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            pe0 pe0Var = this.d;
            if (pe0Var.f27029w != 0 && motionEvent.getY() < pe0Var.f27029w && pe0Var.e.getAlpha() == 0.0f) {
                pe0Var.dismiss();
                return true;
            }
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ((FrameLayout.LayoutParams) pe0Var.f27025f.getLayoutParams()).topMargin = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight();
        this.f24328b = true;
        int dp = AndroidUtilities.dp(80.0f);
        me0 me0Var = pe0Var.f27023b;
        int i16 = me0Var.f26152a.E;
        for (int i17 = 0; i17 < i16; i17++) {
            ViewGroup a2 = me0Var.a(this.f24329c, i17);
