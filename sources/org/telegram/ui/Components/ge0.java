...
public final class ge0 extends FrameLayout {
    ...
    public ge0(pe0 pe0Var, Activity activity, Activity activity2) {
        super(activity);
        this.d = pe0Var;
        this.f24272c = activity2;
        this.f24270a = new RectF();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (f7 != 1.0f) {
            paint.setColor(pe0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f18859h5));
            ...
            int i26 = i18 + i24;
            RectF rectF = this.f24270a;
            rectF.set(i15, i16 + i24, measuredWidth - i17, AndroidUtilities.dp(24.0f) + i26);
            float f10 = dp2 * f7;
            canvas.drawRoundRect(rectF, f10, f10, paint);
        }
        int themedColor = pe0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f18859h5);
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            pe0 pe0Var = this.d;
            if (pe0Var.f27014w != 0 && motionEvent.getY() < pe0Var.f27014w && pe0Var.e.getAlpha() == 0.0f) {
                pe0Var.dismiss();
                return true;
            }
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ((FrameLayout.LayoutParams) pe0Var.f27010f.getLayoutParams()).topMargin = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight();
        this.f24271b = true;
        int dp = AndroidUtilities.dp(80.0f);
        me0 me0Var = pe0Var.f27008b;
        int i16 = me0Var.f26167a.E;
        for (int i17 = 0; i17 < i16; i17++) {
            ViewGroup a2 = me0Var.a(this.f24272c, i17);
