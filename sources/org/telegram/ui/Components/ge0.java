...
public abstract class ge0 {
    public static int f25109a = 1500;
    ...
    public static void g(String[] strArr, Utilities.Callback callback) {
        ...
        if (activity != null) {
            if (Build.VERSION.SDK_INT >= 23) {
                int i11 = f25109a;
                f25109a = i11 + 1;
                NotificationCenter.NotificationCenterDelegate[] notificationCenterDelegateArr = {new fe0(i11, callback, notificationCenterDelegateArr)};
