...
public final class u90 extends Drawable {
    ...
    public int f28752i;
    public int f28753j;
    public final Paint f28748b = new Paint(2);
    public final Matrix e = new Matrix();

    public u90(w9 w9Var, String str, int i10, int i11) {
        this.f28747a = SvgHelper.getBitmapByPathOnly(str, 512, 512, i10, i11);
        this.h = w9Var;
    }

    @Override
    public final void draw(Canvas canvas) {
        Bitmap bitmap = this.f28747a;
        if (bitmap == null) {
            return;
        }
        ...
        long abs = Math.abs(this.f28749c - elapsedRealtime);
        if (abs > 17) {
            abs = 16;
        }
        this.f28749c = elapsedRealtime;
        this.f28750f = a4.a.B((float) abs, this.f28751g, 1800.0f, this.f28750f);
        while (true) {
            float f7 = this.f28750f;
            float f10 = this.f28751g * 2.0f;
            if (f7 >= f10) {
                this.f28750f = f7 - f10;
            } else {
