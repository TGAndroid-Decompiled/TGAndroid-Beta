        ...
        if (i10 == -1) {
            ...
            if (ba0Var.I != null) {
                ...
                if (!arrayList.isEmpty()) {
                    ...
                    alertDialog$Builder.f18446a.T = LocaleController.formatPluralString("DeleteStoriesSubtitle", arrayList.size(), new Object[0]);
