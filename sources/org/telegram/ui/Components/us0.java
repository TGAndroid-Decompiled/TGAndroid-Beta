...
public final class us0 implements ViewTreeObserver.OnPreDrawListener {
    ...
    public final KeyEvent.Callback f28500c;

    public us0(KeyEvent.Callback callback, int i10, int i11) {
        this.f28498a = i11;
        this.f28500c = callback;
        this.f28499b = i10;
    }
    ...
    public final boolean onPreDraw() {
        ...
        KeyEvent.Callback callback = this.f28500c;
        switch (i10) {
            case 0:
                yu0 yu0Var = (yu0) callback;
                yu0Var.f30365k0[i11].getViewTreeObserver().removeOnPreDrawListener(this);
                yu0Var.U(i11);
                return true;
            default:
