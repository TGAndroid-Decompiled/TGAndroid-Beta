...
public final class fu0 extends s4.v {
    ...
    public final void p(s4.c1 c1Var, int i10) {
        pt0 pt0Var;
        hu0 hu0Var = this.d;
        jq0 jq0Var = hu0Var.f26889n;
        if (c1Var != null && (pt0Var = hu0Var.f26891s) != null) {
            pt0Var.c1(false);
        }
        if (i10 == 0) {
    ...
    public final SavedMessagesController.SavedDialog r(s4.c1 c1Var) {
        ...
        if (c1Var != null && (b10 = c1Var.b()) >= 0) {
            hu0 hu0Var = this.d;
            if (b10 < hu0Var.f26888f.size()) {
                return (SavedMessagesController.SavedDialog) hu0Var.f26888f.get(b10);
            }
        }
        return null;
    }
