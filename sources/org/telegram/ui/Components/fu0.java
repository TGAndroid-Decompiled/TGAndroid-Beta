...
public final class fu0 extends vl0 {
    ...
    public ArrayList f24259f = new ArrayList();
    public int h = 0;
    ...
    public final boolean D(s4.c1 c1Var) {
        if (this.f24259f.size() + this.d.size() != 0) {
            return true;
        }
        return false;
    }
    ...
    public final MessageObject E(int i10) {
        ...
        return (MessageObject) this.f24259f.get(i10 - this.d.size());
    }

    public final void F(final int i10, final String str, long j3, long j10) {
        org.telegram.ui.ActionBar.m2 m2Var = this.v.f25543v1;
                    ...
                    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                        ...
                        if (tL_error == null) {
                            ...
                            for (int i13 = 0; i13 < messages_messages.messages.size(); i13++) {
                                ...
                                int i14 = i10;
                                if (i14 == 0 || message.f18342id <= i14) {
                                    arrayList.add(new MessageObject(fu0Var.v.f25543v1.getCurrentAccount(), message, false, true));
                                }
                            }
                        }
    ...
    public final void G(String str, boolean z10) {
        ...
        if (!this.d.isEmpty() || !this.f24259f.isEmpty()) {
            this.d.clear();
            this.f24259f.clear();
            l();
        }
        ...
        jv0 jv0Var = this.v;
        if (isEmpty) {
            if (!this.d.isEmpty() || !this.f24259f.isEmpty() || this.f24262s != 0) {
                this.d.clear();
                this.f24259f.clear();
                if (this.h != 0) {
                    jv0Var.f25543v1.getConnectionsManager().cancelRequest(this.h, true);
                    this.h = 0;
                    this.f24262s--;
                    return;
                }
        ...
        while (true) {
            ...
            if (i10 < cu0VarArr.length) {
                ...
                if (cu0Var.F == this.f24261r) {
                    cu0Var.f23391w.e(true, z10);
                }
                i10++;
            } else {
