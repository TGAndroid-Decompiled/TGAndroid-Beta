...
public final class v31 extends View {
    public float f28969a;
    public final Paint f28970b;
    public final Paint f28971c;
    public Drawable d;
    public boolean e;
    public int f28972f;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.e) {
            ...
            canvas2.drawRoundRect(rectF, dp, dp, this.f28970b);
        }
        int i10 = this.f28972f;
        Paint paint = this.f28971c;
        if (i10 != 0) {
            if (i10 == 1) {
                ...
                canvas2.save();
                canvas2.translate((-AndroidUtilities.dp(2.0f)) * this.f28969a, 0.0f);
                canvas2.rotate(this.f28969a * 90.0f, getWidth() / 2.0f, getHeight() / 2.0f);
                canvas2.drawLine(dp2 + ((width - dp2) * this.f28969a), height, width, height, paint);
                int dp3 = AndroidUtilities.dp((this.f28969a * (-1.0f)) + 9.0f);
                int dp4 = AndroidUtilities.dp((this.f28969a * 7.0f) + 9.0f);
                double d = width;
                double d10 = dp3;
                double d11 = height;
            ...
            float max = (Math.max(0.4f, this.f28969a) - 0.4f) / 0.6f;
            if (max != 0.0f) {
    ...
    public void setBackgroundColor(int i10) {
        this.f28970b.setColor(i10);
        invalidate();
    }

    public void setColor(int i10) {
        this.f28971c.setColor(i10);
        invalidate();
    }
