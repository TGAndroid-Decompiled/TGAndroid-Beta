...
public abstract class v31 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final CharSequence f28590c;
    public final TLRPC.InputPeer d;
    public final int e;
    public final boolean f28591f;
    public final TL_iv.RichMessage h;
    public final RichMessageLayout.PreviewView f28592n;
    public final RichMessageLayout.PreviewView f28593r;
    public final String f28594s;
    public String v;
    public String f28595w;
    public final t31 f28596x;
    public final bi.o f28597y;
    ...
    public v31(Context context, String str, String str2, CharSequence charSequence, TLRPC.InputPeer inputPeer, int i10, boolean z10, TL_iv.RichMessage richMessage) {
        ...
        c90Var.setHighlightColor(getThemedColor(org.telegram.ui.ActionBar.i6.f19157uf));
        int themedColor = getThemedColor(org.telegram.ui.ActionBar.i6.f19174vf);
        try {
        ...
        RichMessageLayout.PreviewView previewView3 = this.f28593r;
        ...
        frameLayout.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.i6.f18907h5));
    ...
    public static void m(v31 v31Var, TLRPC.TL_textWithEntities tL_textWithEntities, TLRPC.TL_textWithEntities tL_textWithEntities2, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && "TRANSLATIONS_DISABLED_ALT".equalsIgnoreCase(tL_error.text)) {
            ...
            org.telegram.messenger.w1.p(R.string.TranslationFailedAlert2, new vc((FrameLayout) v31Var.containerView, v31Var.resourcesProvider), null);
            r31 r31Var = v31Var.f28596x.e;
            String str = v31Var.f28595w;
            v31Var.v = str;
    ...
    public static void o(v31 v31Var, TLObject tLObject) {
        RichMessageLayout.PreviewView previewView = v31Var.f28593r;
        v31Var.f28589b = null;
    ...
    public final void M() {
        ...
        if (this.f28589b != null) {
            ConnectionsManager.getInstance(this.currentAccount).cancelRequest(this.f28589b.intValue(), true);
            this.f28589b = null;
        }
        ...
        if (richMessage != null && inputPeer != null) {
            ...
            tL_messages_translateRichMessage.f18233id.add(Integer.valueOf(i10));
            tL_messages_translateRichMessage.to_lang = TranslateController.normalizeLanguage(str);
            this.f28589b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_translateRichMessage, new x1(this, 16)));
            return;
        }
        TLRPC.TL_textWithEntities tL_textWithEntities = new TLRPC.TL_textWithEntities();
        CharSequence charSequence2 = this.f28590c;
        ...
        if (this.f28591f && inputPeer != null) {
            ...
            tL_messages_summarizeText.f18232id = i10;
            tL_messages_summarizeText.to_lang = TranslateController.normalizeLanguage(str);
            this.f28589b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequestTyped(tL_messages_summarizeText, new Object(), new ai.m0(13, this, tL_textWithEntities)));
            return;
        }
        ...
        if (inputPeer != null) {
            ...
            tL_messages_translateText.f18234id.add(Integer.valueOf(i10));
        } else {
            tL_messages_translateText.flags |= 2;
            tL_messages_translateText.text.add(tL_textWithEntities);
        }
        tL_messages_translateText.to_lang = TranslateController.normalizeLanguage(str);
        this.f28589b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_translateText, new org.telegram.ui.qo(17, this, tL_textWithEntities)));
    }
