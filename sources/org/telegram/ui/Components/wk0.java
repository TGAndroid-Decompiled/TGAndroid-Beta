...
public final class wk0 implements View.OnLayoutChangeListener {
    public final s4.h0 f30057a;
    public final ArrayList f30058b;
    ...
    public final void onLayoutChange(View view, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17) {
        ...
        View view2;
        zk0 zk0Var = this.e;
        HashMap hashMap = (HashMap) zk0Var.f30839k;
        ...
        while (true) {
            ...
            s4.h0 h0Var = this.f30057a;
            if (h0Var != null && (h0Var.f42979b || zk0Var.f30834c)) {
                wl0Var.getClass();
        ...
        ValueAnimator valueAnimator = (ValueAnimator) zk0Var.f30836g;
        if (valueAnimator != null) {
            valueAnimator.removeAllListeners();
            ((ValueAnimator) zk0Var.f30836g).cancel();
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        zk0Var.f30836g = ofFloat;
        final boolean z12 = this.f30059c;
        final int i28 = i19;
        ...
        ((ValueAnimator) zk0Var.f30836g).addListener(new ai.z(28, this, arrayList2));
        long j3 = 300;
        if (zk0Var.d) {
            if (z10) {
                ((ValueAnimator) zk0Var.f30836g).setDuration(150L);
                ((ValueAnimator) zk0Var.f30836g).setInterpolator(qr.f27716g);
            } else {
                long measuredHeight = ((i28 / wl0Var.getMeasuredHeight()) + 1.0f) * 200.0f;
                if (measuredHeight >= 300) {
                    j3 = measuredHeight;
                }
                ((ValueAnimator) zk0Var.f30836g).setDuration(Math.min(j3, 1300L));
                ((ValueAnimator) zk0Var.f30836g).setInterpolator(qr.h);
            }
        } else {
            if (z10) {
                min = 600;
            ...
            ((ValueAnimator) zk0Var.f30836g).setDuration(min);
            ((ValueAnimator) zk0Var.f30836g).setInterpolator(qr.h);
        }
        ((ValueAnimator) zk0Var.f30836g).start();
    }
}
