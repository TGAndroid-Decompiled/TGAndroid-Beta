...
public final class rx0 extends kl0 {
    public final Context f27701c;
    public int d;
    public final SparseArray e = new SparseArray();
    public final SparseArray f27702f = new SparseArray();
    public int h;
    public int f27703n;
    public final vx0 f27704r;
    ...
    public final void l() {
        ...
        if (vx0Var.W != null) {
            ...
            sparseArray.clear();
            SparseArray sparseArray2 = this.f27702f;
            sparseArray2.clear();
            this.h = 0;
            this.f27703n = 0;
    ...
    public final void u(int i10) {
        ArrayList arrayList = this.f27704r.Y;
        if (arrayList != null) {
            this.h = arrayList.size();
        }
        super.u(i10);
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (arrayList != null) {
            ...
            ((org.telegram.ui.Cells.f8) view).d((TLRPC.Document) sparseArray.get(i10), null, this.f27702f.get(i10), null, false, false);
        } else if (vx0Var.X != null) {
            ((org.telegram.ui.Cells.f8) view).setSticker((SendMessagesHelper.ImportingSticker) vx0Var.Y.get(i10));
        } else if (c1Var.f42674f != 3) {
            org.telegram.ui.Cells.f8 f8Var = (org.telegram.ui.Cells.f8) view;
            TLRPC.TL_messages_stickerSet tL_messages_stickerSet = vx0Var.S;
            if (tL_messages_stickerSet != null) {
                f8Var.d(tL_messages_stickerSet.documents.get(i10), null, vx0Var.S, null, vx0Var.f29461h0, vx0Var.R);
        ...
        if (i10 == 0) {
            ...
            if (i10 != 1) {
                if (i10 == 2) {
                    ...
                    frameLayout2 = new org.telegram.ui.Cells.s3(8, this.f27701c, e6Var2, true, false);
                } else if (i10 == 3) {
