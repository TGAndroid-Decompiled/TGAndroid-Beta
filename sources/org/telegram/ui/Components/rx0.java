...
public final class rx0 extends kl0 {
    ...
    public final SparseArray f27705f = new SparseArray();
    public int h;
    public int f27706n;
    public final vx0 f27707r;
    ...
    public final void l() {
        ...
        int i12 = 0;
        if (vx0Var.W != null) {
            int measuredWidth = vx0Var.f29457c.getMeasuredWidth();
            if (measuredWidth == 0) {
            ...
            sparseArray.clear();
            SparseArray sparseArray2 = this.f27705f;
            sparseArray2.clear();
            this.h = 0;
            this.f27706n = 0;
            for (int i13 = 0; i13 < vx0Var.W.size(); i13++) {
                TLRPC.StickerSetCovered stickerSetCovered = (TLRPC.StickerSetCovered) vx0Var.W.get(i13);
    ...
    public final void u(int i10) {
        ArrayList arrayList = this.f27707r.Y;
        if (arrayList != null) {
            this.h = arrayList.size();
        }
        super.u(i10);
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (arrayList != null) {
            ...
            ((org.telegram.ui.Cells.f8) view).d((TLRPC.Document) sparseArray.get(i10), null, this.f27705f.get(i10), null, false, false);
        } else if (vx0Var.X != null) {
            ((org.telegram.ui.Cells.f8) view).setSticker((SendMessagesHelper.ImportingSticker) vx0Var.Y.get(i10));
        } else if (c1Var.f42678f != 3) {
            org.telegram.ui.Cells.f8 f8Var = (org.telegram.ui.Cells.f8) view;
            TLRPC.TL_messages_stickerSet tL_messages_stickerSet = vx0Var.S;
            if (tL_messages_stickerSet != null) {
                f8Var.d(tL_messages_stickerSet.documents.get(i10), null, vx0Var.S, null, vx0Var.f29464h0, vx0Var.R);
        ...
        if (i10 == 0) {
            ...
            if (i10 != 1) {
                if (i10 == 2) {
                    ...
                    frameLayout2 = new org.telegram.ui.Cells.r3(8, this.f27704c, e6Var2, true, false);
                } else if (i10 == 3) {
