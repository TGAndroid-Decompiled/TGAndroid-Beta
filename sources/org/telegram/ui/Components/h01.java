...
public final class h01 extends ReplacementSpan {
    public static final int f24485f = 0;
    public ImageReceiver f24486a;
    public int f24487b;
    public int f24488c;
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        int i15 = this.f24487b;
        int i16 = this.f24488c;
        ImageReceiver imageReceiver = this.f24486a;
        canvas.save();
        if (this.d) {
