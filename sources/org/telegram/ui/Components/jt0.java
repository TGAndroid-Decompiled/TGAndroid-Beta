...
public final class jt0 extends ll0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (view instanceof org.telegram.ui.Cells.ab) {
            ...
            if (chatParticipant != null) {
                ...
                if (UserObject.isUserSelf(user) && ChatObject.canManageMyTag(o2Var.getMessagesController().getChat(Long.valueOf(-zu0Var.f30631j1)))) {
                    z14 = true;
                } else {
                    z14 = false;
                }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        zu0 zu0Var = this.f25429f;
        if (i10 == 20) {
            mt0 M = zu0.M(7, zu0Var.f30631j1, this.f25428c, zu0Var.F1);
            M.setLayoutParams(new s4.p0(-1, -1));
            return new s4.c1(M);
        }
        org.telegram.ui.Cells.ab abVar = new org.telegram.ui.Cells.ab(9, 0, this.f25428c, zu0Var.F1, true, false);
