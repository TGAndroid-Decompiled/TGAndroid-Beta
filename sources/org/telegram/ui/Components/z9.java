...
public final class z9 extends Drawable {
    public TextPaint f33129a;
    public final Paint f33130b;
    public final Paint f33131c;
    public final Paint d;
    public final float f33132e;
    public float f33133f;
    public float f33134g;
    public final RectF h;
    public ValueAnimator f33135i;

    public z9() {
        Paint paint = new Paint(1);
        this.f33130b = paint;
        this.f33131c = new Paint(1);
        this.d = new Paint(1);
        this.f33132e = 1.0f;
        this.f33133f = 0.0f;
        this.f33134g = 1.0f;
    ...
    public final void a(float f7, boolean z10) {
        ...
        ValueAnimator valueAnimator = this.f33135i;
        ...
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f33134g, max);
        this.f33135i = ofFloat;
        ofFloat.addUpdateListener(new l6(this, 5));
        this.f33135i.addListener(new org.telegram.ui.ActionBar.z0(this, max, 4));
        this.f33135i.setInterpolator(pr.h);
        this.f33135i.setDuration(200L);
        this.f33135i.start();
    }
    ...
    public final void draw(Canvas canvas) {
        if (getBounds() != null) {
            ...
            int i11 = getBounds().top + ((int) this.f33133f);
            int width = getBounds().width();
            int height = getBounds().height();
            int centerX = getBounds().centerX();
            int centerY = getBounds().centerY() + ((int) this.f33133f);
            TextPaint textPaint = this.f33129a;
            Paint paint = this.d;
            Paint paint2 = this.f33131c;
            Paint paint3 = this.f33130b;
            if (textPaint != null) {
            ...
            if (this.f33132e != 1.0f) {
                canvas.save();
                float f7 = this.f33132e;
            ...
            rectF.set((((f11 - AndroidUtilities.dpf2(13.0f)) / 2.0f) + f10) - AndroidUtilities.dpf2(1.66f), ((f13 - AndroidUtilities.dpf2(7.33f)) / 2.0f) + f12, Math.max(AndroidUtilities.dpf2(1.1f), this.f33134g * AndroidUtilities.dpf2(13.0f)) + ((((f11 - AndroidUtilities.dpf2(13.0f)) / 2.0f) + f10) - AndroidUtilities.dpf2(1.66f)), ((AndroidUtilities.dpf2(7.33f) + f13) / 2.0f) + f12);
    ...
    public final int getIntrinsicHeight() {
        return AndroidUtilities.dp(this.f33132e * 24.0f);
    }
    ...
    public final void setAlpha(int i10) {
        this.f33130b.setAlpha(i10);
        this.f33131c.setAlpha(i10);
        this.d.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f33130b.setColorFilter(colorFilter);
        this.f33131c.setColorFilter(colorFilter);
    ...
    public z9(float f7, int i10) {
        this();
        a(f7, false);
        this.f33130b.setColor(-1);
        this.f33131c.setColor(-1);
        this.d.setColor(i10);
        this.f33132e = 1.3f;
        invalidateSelf();
    }
