...
public final class z9 extends Drawable {
    public TextPaint f33128a;
    public final Paint f33129b;
    public final Paint f33130c;
    public final Paint d;
    public final float f33131e;
    public float f33132f;
    public float f33133g;
    ...
    public final void a(float f7, boolean z10) {
        ...
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f33133g, max);
        this.f33134i = ofFloat;
        ofFloat.addUpdateListener(new l6(this, 5));
        this.f33134i.addListener(new org.telegram.ui.ActionBar.z0(this, max, 4));
        this.f33134i.setInterpolator(pr.h);
        this.f33134i.setDuration(200L);
        this.f33134i.start();
    }
    ...
    public final void draw(Canvas canvas) {
        if (getBounds() != null) {
            ...
            int i11 = getBounds().top + ((int) this.f33132f);
            int width = getBounds().width();
            int height = getBounds().height();
            int centerX = getBounds().centerX();
            int centerY = getBounds().centerY() + ((int) this.f33132f);
            TextPaint textPaint = this.f33128a;
            Paint paint = this.d;
            Paint paint2 = this.f33130c;
            Paint paint3 = this.f33129b;
            if (textPaint != null) {
            ...
            if (this.f33131e != 1.0f) {
                canvas.save();
                float f7 = this.f33131e;
            ...
            rectF.set((((f11 - AndroidUtilities.dpf2(13.0f)) / 2.0f) + f10) - AndroidUtilities.dpf2(1.66f), ((f13 - AndroidUtilities.dpf2(7.33f)) / 2.0f) + f12, Math.max(AndroidUtilities.dpf2(1.1f), this.f33133g * AndroidUtilities.dpf2(13.0f)) + ((((f11 - AndroidUtilities.dpf2(13.0f)) / 2.0f) + f10) - AndroidUtilities.dpf2(1.66f)), ((AndroidUtilities.dpf2(7.33f) + f13) / 2.0f) + f12);
    ...
    public final int getIntrinsicHeight() {
        return AndroidUtilities.dp(this.f33131e * 24.0f);
    }
    ...
    public final void setAlpha(int i10) {
        this.f33129b.setAlpha(i10);
        this.f33130c.setAlpha(i10);
        this.d.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f33129b.setColorFilter(colorFilter);
        this.f33130c.setColorFilter(colorFilter);
    ...
    public z9(float f7, int i10) {
        this();
        a(f7, false);
        this.f33129b.setColor(-1);
        this.f33130c.setColor(-1);
        this.d.setColor(i10);
        this.f33131e = 1.3f;
        invalidateSelf();
    }
