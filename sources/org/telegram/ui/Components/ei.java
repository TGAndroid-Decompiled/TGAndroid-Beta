...
public final class ei implements TextWatcher {
    ...
    public final org.telegram.ui.ActionBar.n2 f23665c;
    public final vi d;
    ...
    public final void afterTextChanged(Editable editable) {
        ...
        boolean z12;
        vi viVar = this.d;
        n6 n6Var = viVar.f28786s;
        di diVar = viVar.P0;
        int i11 = viVar.J1;
        n6 n6Var2 = viVar.v;
        if (this.f23664b != TextUtils.isEmpty(editable)) {
            ni niVar = viVar.f28808y0;
            if (niVar != null) {
                niVar.A(niVar.getSelectedItemsCount());
            }
            this.f23664b = !this.f23664b;
        }
        boolean z13 = false;
        if (this.f23663a) {
        ...
        if (i12 > 0 && (i10 = i12 - viVar.L) <= 100) {
            ...
            if (i10 < 0) {
                n6Var2.setTextColor(viVar.getThemedColor(org.telegram.ui.ActionBar.i6.f19053p7));
                z11 = false;
            } else {
                n6Var2.setTextColor(viVar.getThemedColor(org.telegram.ui.ActionBar.i6.f19215y6));
                z11 = true;
            }
        ...
        if (!viVar.f28758i2 && !MessagesController.getInstance(i11).premiumFeaturesBlocked() && !UserConfig.getInstance(i11).isPremium() && viVar.L > MessagesController.getInstance(i11).captionLengthLimitDefault && viVar.L < MessagesController.getInstance(i11).captionLengthLimitPremium) {
            viVar.f28758i2 = true;
            viVar.O1(this.f23665c);
        }
        if (viVar.f28737c0) {
