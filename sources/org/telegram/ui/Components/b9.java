...
public final class b9 extends xl0 {
    public final ArrayList X2;
    public final int Y2;
    public int Z2;
    public final org.telegram.ui.w7 f22929a3;
    public a9 f22930b3;
    public final e9 f22931c3;
    ...
    public b9(e9 e9Var, Activity activity) {
        ...
        for (int i12 = 0; i12 < 30; i12++) {
            ...
            this.Y2 = i13 + 1;
            obj2.f22570a = i13;
            int[] iArr2 = e9.f23876d0[i12];
            obj2.f22572c = iArr2[0];
            obj2.d = iArr2[1];
            obj2.e = 0;
            obj2.f22573f = 0;
            obj2.f22571b = true;
    ...
    public final void onMeasure(int i10, int i11) {
        int size = View.MeasureSpec.getSize(i10) / this.f22929a3.h();
        e9 e9Var = this.f22931c3;
        e9Var.P = size;
        ...
        while (true) {
            ...
            if (i10 < arrayList.size()) {
                if (((a9) arrayList.get(i10)).equals(a9Var)) {
                    this.Z2 = ((a9) arrayList.get(i10)).f22570a;
                    break;
                }
                i10++;
            } else {
