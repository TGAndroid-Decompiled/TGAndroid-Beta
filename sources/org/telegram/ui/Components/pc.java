...
public final class pc extends nb {
    public final k9 f27299a;
    public final n90 f27300b;
    public final n90 f27301c;
    ...
    public pc(Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10) {
        ...
        this.f27300b.setLinkTextColor(getThemedColor(org.telegram.ui.ActionBar.h6.Gi));
    ...
    public CharSequence getAccessibilityText() {
        return this.f27300b.getText();
    }

    public void setTextColor(int i10) {
        this.f27300b.setTextColor(i10);
        n90 n90Var = this.f27301c;
        if (n90Var != null) {
