...
public abstract class qv0 extends pv0 {
    public Activity f27458w0;
    public final Rect f27459x0;
    public int f27460y0;
    public boolean f27461z0;

    public qv0(Context context, Activity activity) {
        super(context, null);
        this.f27459x0 = new Rect();
    ...
    public int R() {
        ...
        int height2 = (this.f27458w0.getWindow().getDecorView().getHeight() - AndroidUtilities.getViewInset(rootView)) - rootView.getBottom();
