...
public final class qv0 extends View {
    public final ImageReceiver f27774a;
    public final h9 f27775b;
    public final Paint f27776c;
    public float d;
    public boolean e;
    public ValueAnimator f27777f;

    public qv0(Context context) {
        super(context);
        ImageReceiver imageReceiver = new ImageReceiver(this);
        this.f27774a = imageReceiver;
        this.f27775b = new h9((org.telegram.ui.ActionBar.d6) null);
    ...
    public final void a(boolean z10, boolean z11) {
        ValueAnimator valueAnimator = this.f27777f;
    ...
    public final void onAttachedToWindow() {
        ...
        this.f27774a.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f27774a.onDetachedFromWindow();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (!this.e) {
            ...
            ImageReceiver imageReceiver = this.f27774a;
    ...
    public void setAvatar(TLObject tLObject) {
        h9 h9Var = this.f27775b;
        h9Var.p(tLObject);
        this.f27774a.setForUserOrChat(tLObject, h9Var);
    }
