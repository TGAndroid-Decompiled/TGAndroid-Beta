...
public class qv0 extends FrameLayout implements org.telegram.ui.ActionBar.a6 {
    public static DispatchQueue f28281r0;
    public static boolean f28282s0;
    public int B;
    public boolean C;
    ...
    public final Rect f28283a;
    public Paint f28284a0;
    public Drawable f28285b;
    public Paint f28286b0;
    public boolean f28287c;
    public float f28288c0;
    public Drawable d;
    public ValueAnimator f28289d0;
    public boolean e;
    ...
    public int h;
    public int f28294h0;
    public float f28295i0;
    public final androidx.activity.g f28296j0;
    public float f28297k0;
    public float f28298l0;
    public RenderNode[] m0;
    public pv0 f28299n;
    public final boolean[] f28300n0;
    public final boolean[] f28301o0;
    public final ArrayList f28302p0;
    public final ArrayList f28303q0;
    public final ArrayList f28304r;
    public boolean f28305s;
    public o81 v;
    public float f28306w;
    public float f28307x;
    public float f28308y;

    public qv0(Context context, org.telegram.ui.ActionBar.e5 e5Var) {
        super(context);
        this.f28283a = new Rect();
        this.f28304r = new ArrayList();
        this.f28305s = true;
        this.f28308y = 1.0f;
        this.C = true;
        ...
        this.W = new Paint();
        this.f28295i0 = 1.0f;
        this.f28296j0 = new androidx.activity.g(this);
        this.f28300n0 = new boolean[2];
        this.f28301o0 = new boolean[2];
        this.f28302p0 = new ArrayList();
        this.f28303q0 = new ArrayList();
    ...
    public final void I() {
        ...
        if (this.v == null) {
            ...
            this.v = o81Var2;
            o81Var2.f27495n = new ev(this, 21);
            if (getMeasuredWidth() != 0 && getMeasuredHeight() != 0) {
                o81 o81Var3 = this.v;
                int measuredWidth = getMeasuredWidth();
                int measuredHeight = getMeasuredHeight();
                o81Var3.getClass();
                this.f28308y = o81.a(measuredWidth, measuredHeight);
            }
        }
        if (!this.C) {
            this.v.c(true);
    ...
    public void J(Canvas canvas, float f10, Rect rect, Paint paint, boolean z4) {
        ...
        if (F() && SharedConfig.getDevicePerformanceClass() == 2) {
            i10 = org.telegram.ui.ActionBar.j6.f20247xf;
        } else {
            i10 = org.telegram.ui.ActionBar.j6.f20265yf;
        }
    ...
    public void S() {
        boolean z4;
        if (this.v != null) {
            this.f28308y = o81.a(getMeasuredWidth(), getMeasuredHeight());
        }
    ...
    public final void W() {
        mv0 mv0Var;
        mv0 mv0Var2;
        if (this.L && !this.M && this.f28290e0 && SharedConfig.chatBlurEnabled() && !F() && Color.alpha(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20265yf, false)) != 255) {
            int measuredWidth = getMeasuredWidth();
            ...
            if (measuredWidth != 0 && dp != 0) {
                ...
                if (mv0Var == null) {
                    ?? obj = new Object();
                    obj.f27147c = Bitmap.createBitmap(i11, i10, Bitmap.Config.ARGB_8888);
                    obj.f27146b = new Canvas(obj.f27147c);
                    mv0Var2 = obj;
                } else {
                    mv0Var.f27147c.eraseColor(0);
                    mv0Var2 = mv0Var;
                }
                float width = mv0Var2.f27147c.getWidth() / f11;
                float height = (mv0Var2.f27147c.getHeight() - 34) / f10;
                int save = mv0Var2.f27146b.save();
                mv0Var2.f27145a = getScrollOffset() % 24;
                float f12 = 10.0f * height;
                mv0Var2.f27146b.clipRect(1.0f, f12, mv0Var2.f27147c.getWidth(), mv0Var2.f27147c.getHeight() - 1);
                mv0Var2.f27146b.scale(width, height);
                mv0Var2.f27146b.translate(0.0f, f12 + mv0Var2.f27145a);
                mv0Var2.d = 1.0f / width;
                mv0Var2.e = 1.0f / height;
                L(mv0Var2.f27146b, null);
                try {
                    mv0Var2.f27146b.restoreToCount(save);
                } catch (Exception e) {
                    FileLog.e(e);
                }
                System.currentTimeMillis();
                int i12 = this.f28294h0 + 1;
                this.f28294h0 = i12;
                if (i12 >= 20) {
                    this.f28294h0 = 0;
                }
                if (f28281r0 == null) {
                    f28281r0 = new DispatchQueue("BlurQueue");
                }
                androidx.activity.g gVar = this.f28296j0;
                gVar.f312b = (int) (((int) (Math.max(6, Math.max(dp, measuredWidth) / 180) * 2.5f)) * org.telegram.ui.n5.d);
                gVar.d = mv0Var2;
                f28281r0.postRunnable(gVar);
            }
        }
    }
    ...
    public int getBackgroundSizeY() {
        int i10;
        if (this.f28285b instanceof org.telegram.ui.co) {
            i10 = this.B;
        } else {
            i10 = 0;
        }
    ...
    public int getBackgroundTranslationY() {
        Drawable drawable = this.f28285b;
        if (drawable instanceof ec0) {
            return this.B;
        }
    ...
    public int getHeightWithKeyboard() {
        return getMeasuredHeight() + this.f28291f;
    }
    ...
    public boolean getNewDrawableMotion() {
        return org.telegram.ui.ActionBar.j6.f19965i0;
    }
    ...
    public void onDetachedFromWindow() {
        ...
        ValueAnimator valueAnimator = this.f28289d0;
        ...
        while (true) {
            ...
            if (arrayList.get(i10) != null) {
                ((mv0) arrayList.get(i10)).f27147c.recycle();
            }
            i10++;
        }
        arrayList.clear();
