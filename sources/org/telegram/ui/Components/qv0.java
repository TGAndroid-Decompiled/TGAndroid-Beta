...
public final class qv0 extends View {
    public final ImageReceiver f27775a;
    public final h9 f27776b;
    public final Paint f27777c;
    public float d;
    public boolean e;
    public ValueAnimator f27778f;

    public qv0(Context context) {
        super(context);
        ImageReceiver imageReceiver = new ImageReceiver(this);
        this.f27775a = imageReceiver;
        this.f27776b = new h9((org.telegram.ui.ActionBar.d6) null);
    ...
    public final void a(boolean z10, boolean z11) {
        ValueAnimator valueAnimator = this.f27778f;
    ...
    public final void onAttachedToWindow() {
        ...
        this.f27775a.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f27775a.onDetachedFromWindow();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.scale(f7, f7);
        int w02 = org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19223m5, false);
        Paint paint = this.f27777c;
        paint.setColor(w02);
        ...
        if (!this.e) {
            ...
            ImageReceiver imageReceiver = this.f27775a;
    ...
    public void setAvatar(TLObject tLObject) {
        h9 h9Var = this.f27776b;
        h9Var.p(tLObject);
        this.f27775a.setForUserOrChat(tLObject, h9Var);
    }
