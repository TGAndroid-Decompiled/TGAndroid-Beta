...
public final class al extends gg.u0 {
    ...
    public final void l() {
        ...
        TextView textView = glVar.f24413y;
        if (textView != null) {
            textView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("NoPlacesFoundInfo", R.string.NoPlacesFoundInfo, alVar.f9680x)));
        }
        super.l();
    }
}
