...
public abstract class s90 {
    public static final Pattern f28672a = Pattern.compile("^\\[\\^([^\\]]+)\\]:[ \\t]*(.*)$");
    public static final Pattern f28673b = Pattern.compile("\\[\\^([^\\]]+)\\]");
    public static final Pattern f28674c = Pattern.compile("^(\\d+)[.)]\\s");

    public static TL_iv.RichText a(ne.p pVar, TL_iv.PageBlock pageBlock) {
        p90 p90Var = new p90(pageBlock);
        pVar.a(p90Var);
        return g(h(p90.x(p90Var.f27797c)));
    }
    ...
    public static TL_iv.RichText g(TL_iv.RichText richText) {
        ...
        if (richText instanceof TL_iv.textConcat) {
            ...
            return textconcat;
        } else if (richText instanceof r90) {
            r90 r90Var = (r90) richText;
            TL_iv.textStrike g10 = g(r90Var.text);
            int i11 = r90Var.f28422a;
            if ((i11 & 4) != 0) {
    ...
    public static org.telegram.tgnet.tl.TL_iv.RichText h(org.telegram.tgnet.tl.TL_iv.RichText r17) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.s90.h(org.telegram.tgnet.tl.TL_iv$RichText):org.telegram.tgnet.tl.TL_iv$RichText");
    }

    public static java.lang.String i(java.lang.String r23, java.util.ArrayList r24) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.s90.i(java.lang.String, java.util.ArrayList):java.lang.String");
    }
