...
public class ui0 extends org.telegram.ui.ActionBar.e3 {
    ...
    public ui0(Context context, String str, String str2, String str3, boolean z10) {
        ...
        try {
            ...
            this.f28785f = telegramQRCodeWriter.getImageSize();
            bitmap = encode;
        } catch (Exception e) {
            FileLog.e(e);
        }
    ...
    public final void n() {
        ...
        if (textView2 != null) {
            ...
            textView2.setBackground(org.telegram.ui.ActionBar.h6.f0(i0.a.k(getThemedColor(i10), Math.min(255, Color.alpha(getThemedColor(org.telegram.ui.ActionBar.h6.f19134i6)) * 2)), 7, -1));
        }
        int i11 = org.telegram.ui.ActionBar.h6.f19428y6;
        int themedColor4 = getThemedColor(i11);
        TextView textView3 = this.f28784c;
        ...
        setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.h6.f19115h5));
    }
}
