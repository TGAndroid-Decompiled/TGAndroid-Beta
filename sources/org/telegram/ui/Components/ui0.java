...
public class ui0 extends org.telegram.ui.ActionBar.f3 {
    ...
    public ui0(Context context, String str, String str2, String str3, boolean z10) {
        ...
        try {
            ...
            this.f28716f = telegramQRCodeWriter.getImageSize();
            bitmap = encode;
        } catch (Exception e) {
            FileLog.e(e);
        }
    ...
    public final void n() {
        ...
        if (textView2 != null) {
            ...
            textView2.setBackground(org.telegram.ui.ActionBar.j6.f0(i0.a.k(getThemedColor(i10), Math.min(255, Color.alpha(getThemedColor(org.telegram.ui.ActionBar.j6.f19152i6)) * 2)), 7, -1));
        }
        ...
        setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19133h5));
    }
}
