...
public final class kc0 extends Drawable {
    ...
    public final void a(int i10) {
        if (i10 != this.f27803f) {
            ...
            this.d = alpha;
            this.f27800b.setColor(i0.a.k(i10, (int) ((alpha / 255.0f) * this.f27801c)));
        }
        this.f27803f = i10;
    }
    ...
    public final Drawable.ConstantState getConstantState() {
        if (this.f27799a == null) {
            this.f27799a = new Drawable.ConstantState();
        }
        return this.f27799a;
    }
    ...
    public final void setAlpha(int i10) {
        if (this.f27801c != i10) {
            this.f27801c = i10;
            this.f27800b.setAlpha((int) ((this.d / 255.0f) * i10));
        }
    }
