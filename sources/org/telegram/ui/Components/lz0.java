...
public final class lz0 extends View {
    ...
    public final jz0 Q;
    public final org.telegram.ui.Cells.q9 f25990a;
    public int f25991b;
    public final bz0 f25992c;
    public final bz0 d;
    public int e;
    ...
    public lz0(Context context, kz0 kz0Var, org.telegram.ui.Cells.q9 q9Var) {
        super(context);
        this.f25992c = new bz0(this, true);
        this.d = new bz0(this, false);
        this.e = 0;
        this.f25993f = false;
        this.h = 1;
        this.f25994n = 0;
        this.f25995r = AndroidUtilities.dp(8.0f);
        this.f25996s = AndroidUtilities.dp(9.0f);
    ...
    public static void i(gz0 gz0Var, int i10, int i11, int i12, int i13) {
        ...
        iz0 iz0Var = gz0Var.f24430a;
        gz0Var.f24430a = new iz0(iz0Var.f25062a, fz0Var, iz0Var.f25064c, iz0Var.d);
        fz0 fz0Var2 = new fz0(i12, i13 + i12);
        iz0 iz0Var2 = gz0Var.f24431b;
        gz0Var.f24431b = new iz0(iz0Var2.f25062a, fz0Var2, iz0Var2.f25064c, iz0Var2.d);
    }
    ...
    public final void a(int i10, int i11, int i12, int i13) {
        ...
        xy0 xy0Var = U;
        gz0Var.f24430a = new iz0(false, fz0Var, xy0Var, 0.0f);
        gz0Var.f24431b = new iz0(false, new fz0(i10, i12 + i10), xy0Var, 0.0f);
        ez0Var.f23704a = gz0Var;
        ez0Var.f23710j = i11;
    ...
    public final void b(TL_iv.pageTableCell pagetablecell, int i10, int i11, int i12) {
        ...
        xy0 xy0Var = U;
        gz0Var.f24430a = new iz0(false, fz0Var, xy0Var, 0.0f);
        gz0Var.f24431b = new iz0(false, new fz0(i10, i12 + i10), xy0Var, 1.0f);
        ez0Var.f23704a = gz0Var;
        ez0Var.f23710j = i11;
        arrayList.add(ez0Var);
    ...
    public final void c() {
        ...
        if (i11 == 0) {
            ...
            for (int i16 = 0; i16 < childCount; i16++) {
                ...
                boolean z11 = iz0Var.f25062a;
                int i17 = fz0Var.f24043b;
                int i18 = fz0Var.f24042a;
                int i19 = i17 - i18;
                if (z11) {
                    i14 = i18;
                }
                ...
                fz0 fz0Var2 = iz0Var2.f25063b;
                boolean z12 = iz0Var2.f25062a;
                int i20 = fz0Var2.f24043b;
                int i21 = fz0Var2.f24042a;
                int i22 = i20 - i21;
                if (i13 != 0) {
                    if (z12) {
            ...
            for (int i25 = 0; i25 < childCount2; i25++) {
                i12 = (i12 * 31) + d(i25).f23704a.hashCode();
            }
            this.f25994n = i12;
            return;
        }
        ...
        for (int i27 = 0; i27 < childCount3; i27++) {
            i26 = (i26 * 31) + d(i27).f23704a.hashCode();
        }
        if (i11 != i26) {
            g();
            c();
    ...
    public final int e(ez0 ez0Var, boolean z10, boolean z11) {
        ...
        if (z11) {
            if (bz0Var.f22838j == null) {
                bz0Var.f22838j = new int[bz0Var.e() + 1];
            }
            if (!bz0Var.f22839k) {
                bz0Var.b(true);
                bz0Var.f22839k = true;
            ...
            if (bz0Var.f22840l == null) {
                bz0Var.f22840l = new int[bz0Var.e() + 1];
            }
            if (!bz0Var.f22841m) {
                bz0Var.b(false);
                bz0Var.f22841m = true;
    ...
    public final int f(ez0 ez0Var, boolean z10, boolean z11) {
        ...
        if (i10 == Integer.MIN_VALUE) {
            ...
            if (z12 != z11) {
                int i11 = fz0Var.f24042a;
                return 0;
            }
            int i12 = fz0Var.f24043b;
            bz0Var.e();
            return 0;
        }
        return i10;
    ...
    public final void h(int i10, boolean z10) {
        ...
        for (int i14 = 0; i14 < childCount; i14++) {
            ...
            if (z10) {
                ...
                d.e(this.O.createTextLayout(d.f23706c, i12));
                if (d.f23705b != null) {
                    ((ViewGroup.MarginLayoutParams) gz0Var).height = Math.max(this.f25997w, d.f23707f + this.f25995r + this.f25996s);
                    int emojiOnlyCount = d.f23705b.getEmojiOnlyCount();
                    if (emojiOnlyCount > 0) {
                ...
                if (iz0.a(iz0Var, z11) == U) {
                    ...
                    int[] g10 = bz0Var.g();
                    int e = (g10[fz0Var.f24043b] - g10[fz0Var.f24042a]) - (e(d, z11, false) + e(d, z11, true));
                    if (z11) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i16 = 0; i16 < childCount; i16++) {
            lz0Var.f25991b = Math.max(lz0Var.f25991b, lz0Var.d(i16).f23704a.f24431b.f25063b.f24043b);
        }
        lz0Var.h(i10, true);
        if (lz0Var.e == 0) {
            i12 = bz0Var2.i(i10);
            if (lz0Var.f25998x) {
                ...
                bz0Var2.v.f24759a = i12;
                bz0Var2.f22850w.f24759a = -i12;
                bz0Var2.f22845q = false;
                bz0Var2.g();
            }
            lz0Var.h(i10, false);
            i13 = bz0Var.i(i11);
        ...
        bz0Var2.f22845q = false;
        bz0Var2.g();
        bz0Var.v.f24759a = max;
        bz0Var.f22850w.f24759a = -max;
        bz0Var.f22845q = false;
        bz0Var.g();
        int[] g10 = bz0Var2.g();
        int[] g11 = bz0Var.g();
        ...
        while (i19 < childCount2) {
            ...
            ez0 d = lz0Var.d(i20);
            gz0 gz0Var = d.f23704a;
            iz0 iz0Var = gz0Var.f24431b;
            iz0 iz0Var2 = gz0Var.f24430a;
            fz0 fz0Var = iz0Var.f25063b;
            fz0 fz0Var2 = iz0Var2.f25063b;
            int i21 = childCount2;
            int i22 = g10[fz0Var.f24042a];
            int i23 = g11[fz0Var2.f24042a];
            int i24 = g10[fz0Var.f24043b] - i22;
            int i25 = g11[fz0Var2.f24043b] - i23;
            int i26 = d.f23711k;
            bz0 bz0Var3 = bz0Var;
            int i27 = d.f23712l;
            ...
            if (d.f23706c != null) {
                if (c10 != d.f23711k || c11 != d.f23712l) {
                    d.d(c10, c11, false);
                }
                int i32 = d.f23713m;
                if (i32 != 0 && i32 != c11) {
                    fz0 fz0Var3 = d.f23704a.f24430a.f25063b;
                    if (fz0Var3.f24043b - fz0Var3.f24042a <= 1) {
                        ...
                        while (true) {
                            if (i33 < size) {
                                ...
                                float f11 = pointF.x;
                                float f12 = d.f23704a.f24430a.f25063b.f24042a;
        ...
        while (i34 < size2) {
            ...
            int i35 = ez0Var.f23712l;
            int i36 = ez0Var.d;
            int i37 = i35 - ez0Var.f23713m;
            ArrayList arrayList3 = lz0Var.P;
            int size3 = arrayList3.size();
            for (int i38 = i36 + 1; i38 < size3; i38++) {
                ez0 ez0Var2 = (ez0) arrayList3.get(i38);
                if (ez0Var.f23704a.f24430a.f25063b.f24042a != ez0Var2.f23704a.f24430a.f25063b.f24042a) {
                    break;
                }
                int i39 = ez0Var.f23713m;
                int i40 = ez0Var2.f23713m;
                if (i39 < i40) {
                    z10 = true;
                    break;
                }
                int i41 = ez0Var2.f23712l - i40;
                if (i41 > 0) {
            ...
            if (!z10) {
                ...
                while (true) {
                    ...
                    if (ez0Var.f23704a.f24430a.f25063b.f24042a != ez0Var3.f23704a.f24430a.f25063b.f24042a) {
                        break;
                    }
                    int i43 = ez0Var.f23713m;
                    int i44 = ez0Var3.f23713m;
                    if (i43 < i44) {
                        z10 = true;
                        break;
                    }
                    int i45 = ez0Var3.f23712l - i44;
                    if (i45 > 0) {
            ...
            if (!z10) {
                ez0Var.f23712l = ez0Var.f23713m;
                ez0Var.g();
                max -= i37;
                int i46 = ez0Var.f23704a.f24430a.f25063b.f24042a;
                while (true) {
                    i46++;
                ...
                while (i49 < size4) {
                    ...
                    if (ez0Var == ez0Var4) {
                        ...
                        int i50 = ez0Var.f23704a.f24430a.f25063b.f24042a;
                        int i51 = ez0Var4.f23704a.f24430a.f25063b.f24042a;
                        if (i50 == i51) {
                            if (ez0Var4.f23713m != ez0Var4.f23712l) {
                            ...
                            int i52 = ez0Var4.f23712l - i37;
                            ez0Var4.f23712l = i52;
                            i14 = i49;
                            ez0Var4.d(ez0Var4.f23711k, i52, true);
                        } else {
                            i14 = i49;
                            if (i50 < i51) {
                                ez0Var4.f23717q -= i37;
        ...
        for (int i53 = 0; i53 < childCount3; i53++) {
            ...
            lz0Var.O.onLayoutChild(d10.f23705b, d10.b(), d10.c());
            d10.f23714n = d10.f23716p;
            d10.f23715o = d10.f23711k;
        }
        lz0Var.f25999y = i18;
        lz0Var.E = max;
        lz0Var.F = copyOf;
    ...
    public void setRenderWidth(int i10) {
        ...
        this.f25999y = Math.max(measuredWidth, i10);
        for (int i13 = 0; i13 < getChildCount(); i13++) {
            ez0 d = d(i13);
            if (measuredWidth > 0 && (i12 = this.f25999y) != measuredWidth) {
                float f7 = measuredWidth;
                int round = Math.round((d.f23714n * i12) / f7);
                int round2 = Math.round(((d.f23714n + d.f23715o) * this.f25999y) / f7);
                d.f23716p = round;
                d.f23711k = Math.max(0, round2 - round);
                if (d.f23706c != null && d.f23705b != null) {
                    d.f();
                }
            } else {
                int i14 = d.f23714n;
                d.f23716p = i14;
                d.f23711k = Math.max(0, (d.f23715o + i14) - i14);
                if (d.f23706c != null && d.f23705b != null) {
                    d.f();
                }
            }
        ...
        if (iArr.length < 2) {
            ...
            for (int i18 = 0; i18 < getChildCount(); i18++) {
                ...
                if (i11 > 0) {
                    fz0 fz0Var = d10.f23704a.f24430a.f25063b;
                    int max = Math.max(0, fz0Var.f24042a);
                    int min = Math.min(i15, fz0Var.f24043b);
                    if (max < min) {
                        int i19 = 0;
                        for (int i20 = max; i20 < min; i20++) {
                            i19 += iArr2[i20];
                        }
                        int max2 = Math.max(1, Math.round(d10.f23711k / i11)) - i19;
            ...
            for (int i25 = 0; i25 < getChildCount(); i25++) {
                ez0 d11 = d(i25);
                fz0 fz0Var2 = d11.f23704a.f24430a.f25063b;
                int max3 = Math.max(0, Math.min(i15, fz0Var2.f24042a));
                int max4 = Math.max(max3, Math.min(i15, fz0Var2.f24043b));
                int i26 = iArr4[max3];
                int i27 = iArr4[max4];
                d11.f23717q = i26;
                d11.f23712l = Math.max(0, i27 - i26);
                if (d11.f23706c != null) {
                    d11.g();
                }
                this.O.onLayoutChild(d11.f23705b, d11.b(), d11.c());
            }
        }
        invalidate();
    }
