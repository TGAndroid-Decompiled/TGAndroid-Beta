...
public final class lz0 {
    ...
    public int[] f26273t;
    public final vz0 f26276x;
    public int f26258b = Integer.MIN_VALUE;
    public int f26259c = Integer.MIN_VALUE;
    public boolean e = false;
    public boolean f26261g = false;
    public boolean f26262i = false;
    public boolean f26264k = false;
    public boolean f26266m = false;
    public boolean f26268o = false;
    public boolean f26270q = false;
    public boolean f26272s = false;
    public boolean f26274u = true;
    public final rz0 v = new rz0(0);
    public final rz0 f26275w = new rz0(-100000);
    ...
    public static void j(ArrayList arrayList, pz0 pz0Var, rz0 rz0Var, boolean z10) {
        if (pz0Var.f27470b - pz0Var.f27469a != 0) {
            if (z10) {
                ...
                while (i10 < size) {
                    ...
                    i10++;
                    if (((jz0) obj).f25563a.equals(pz0Var)) {
                        return;
                    }
                }
            }
    ...
    public static boolean m(int[] iArr, jz0 jz0Var) {
        if (jz0Var.f25565c) {
            pz0 pz0Var = jz0Var.f25563a;
            int i10 = pz0Var.f27469a;
            int i11 = pz0Var.f27470b;
            int i12 = iArr[i10] + jz0Var.f25564b.f27985a;
            if (i12 > iArr[i11]) {
                iArr[i11] = i12;
                return true;
            }
    ...
    public final void a(lf.h hVar, boolean z10) {
        for (rz0 rz0Var : (rz0[]) ((Object[]) hVar.d)) {
            rz0Var.f27985a = Integer.MIN_VALUE;
        }
        mz0[] mz0VarArr = (mz0[]) ((Object[]) f().d);
        for (int i10 = 0; i10 < mz0VarArr.length; i10++) {
            int d = mz0VarArr[i10].d(z10);
            rz0 rz0Var2 = (rz0) ((Object[]) hVar.d)[((int[]) hVar.f14215b)[i10]];
            int i11 = rz0Var2.f27985a;
            if (!z10) {
                d = -d;
            }
            rz0Var2.f27985a = Math.max(i11, d);
        }
    }
    ...
    public final lf.h c(boolean z10) {
        ...
        sz0[] sz0VarArr = (sz0[]) ((Object[]) f().f14216c);
        int length = sz0VarArr.length;
        for (int i10 = 0; i10 < length; i10++) {
            if (z10) {
                pz0Var = sz0VarArr[i10].f28238b;
            } else {
                pz0 pz0Var2 = sz0VarArr[i10].f28238b;
                pz0Var = new pz0(pz0Var2.f27470b, pz0Var2.f27469a);
            }
            ?? obj = new Object();
            obj.f27985a = Integer.MIN_VALUE;
    ...
    public final jz0[] d() {
        if (this.f26267n == null) {
            ...
            lf.h hVar = this.f26260f;
            int i10 = 0;
            while (true) {
                pz0[] pz0VarArr = (pz0[]) ((Object[]) hVar.f14216c);
            ...
            int i11 = 0;
            while (true) {
                pz0[] pz0VarArr2 = (pz0[]) ((Object[]) hVar2.f14216c);
            ...
            j(arrayList2, new pz0(e, 0), this.f26275w, false);
            jz0[] q6 = q(arrayList);
    ...
    public final int e() {
        return Math.max(this.f26258b, h());
    }
    ...
    public final lf.h f() {
        ...
        if (hVar == null) {
            ...
            for (int i13 = 0; i13 < childCount; i13++) {
                qz0 qz0Var = vz0Var.d(i13).f27084a;
                if (z10) {
                    sz0Var2 = qz0Var.f27698b;
                } else {
                    sz0Var2 = qz0Var.f27697a;
                }
                switch (sz0.a(sz0Var2, z10).f24796a) {
                    case 3:
                        mz0Var = new mz0();
                        break;
                    default:
        ...
        if (!this.e) {
            ...
            for (int i14 = 0; i14 < childCount2; i14++) {
                oz0 d = vz0Var.d(i14);
                qz0 qz0Var2 = d.f27084a;
                if (z10) {
                    sz0Var = qz0Var2.f27698b;
                } else {
                    sz0Var = qz0Var2.f27697a;
                }
                if (z10) {
                    i10 = d.f27091k;
                } else {
                ...
                if (f7 == 0.0f) {
                    ...
                    i11 = this.f26273t[i14];
                }
                int i15 = e + i11;
                lf.h hVar2 = this.d;
                mz0 mz0Var3 = (mz0) ((Object[]) hVar2.d)[((int[]) hVar2.f14215b)[i14]];
                int i16 = mz0Var3.f26514c;
                if (sz0Var.f28239c == vz0.R && f7 == 0.0f) {
                    i12 = 0;
                } else {
                    i12 = 2;
                }
                mz0Var3.f26514c = i12 & i16;
    ...
    public final int[] g() {
        ...
        if (this.f26269p == null) {
            this.f26269p = new int[e() + 1];
        }
        if (!this.f26270q) {
            int[] iArr = this.f26269p;
            boolean z11 = this.f26272s;
            float f7 = 0.0f;
            boolean z12 = this.f26257a;
            vz0 vz0Var = this.f26276x;
            if (!z11) {
                int childCount = vz0Var.getChildCount();
                int i10 = 0;
                while (true) {
                    if (i10 < childCount) {
                        qz0 qz0Var = vz0Var.d(i10).f27084a;
                        if (z12) {
                            sz0Var2 = qz0Var.f27698b;
                        } else {
                            sz0Var2 = qz0Var.f27697a;
            ...
            if (!this.f26271r) {
                ...
                if (this.f26273t == null) {
                    this.f26273t = new int[vz0Var.getChildCount()];
                }
                Arrays.fill(this.f26273t, 0);
                p(d(), iArr, true);
                int childCount2 = (vz0Var.getChildCount() * this.v.f27985a) + 1;
                if (childCount2 >= 2) {
                    int childCount3 = vz0Var.getChildCount();
                    for (int i11 = 0; i11 < childCount3; i11++) {
                        qz0 qz0Var2 = vz0Var.d(i11).f27084a;
                        if (z12) {
                            sz0Var = qz0Var2.f27698b;
                        } else {
                            sz0Var = qz0Var2.f27697a;
    ...
    public final int h() {
        ...
        if (this.f26259c == Integer.MIN_VALUE) {
            vz0 vz0Var = this.f26276x;
            int childCount = vz0Var.getChildCount();
            int i11 = -1;
            for (int i12 = 0; i12 < childCount; i12++) {
                qz0 qz0Var = vz0Var.d(i12).f27084a;
                if (this.f26257a) {
                    sz0Var = qz0Var.f27698b;
                } else {
                    sz0Var = qz0Var.f27697a;
                ...
                pz0 pz0Var = sz0Var.f28238b;
                int i13 = pz0Var.f27469a;
                int i14 = pz0Var.f27470b;
                i11 = Math.max(Math.max(Math.max(i11, i13), i14), i14 - pz0Var.f27469a);
            }
            if (i11 != -1) {
                i10 = i11;
            }
            this.f26259c = Math.max(0, i10);
        }
        return this.f26259c;
    }
    ...
    public final int i(int i10) {
        ...
        if (mode != Integer.MIN_VALUE) {
            if (mode != 0) {
                ...
                rz0Var2.f27985a = size;
                rz0Var.f27985a = -size;
                this.f26270q = false;
                return g()[e()];
            }
            rz0Var2.f27985a = 0;
            rz0Var.f27985a = -100000;
            this.f26270q = false;
            return g()[e()];
        }
        rz0Var2.f27985a = 0;
    ...
    public final void o(float f7, int i10) {
        ...
        int childCount = vz0Var.getChildCount();
        for (int i11 = 0; i11 < childCount; i11++) {
            qz0 qz0Var = vz0Var.d(i11).f27084a;
            if (this.f26257a) {
                sz0Var = qz0Var.f27698b;
            } else {
                sz0Var = qz0Var.f27697a;
        ...
        loop0: for (int i10 = 0; i10 < jz0VarArr.length; i10++) {
            ...
            while (true) {
                ...
                if (zArr[i14]) {
                    ...
                    pz0 pz0Var = jz0Var2.f25563a;
                    if (pz0Var.f27469a >= pz0Var.f27470b) {
                        jz0Var2.f25565c = false;
                        break;
                    }
                }
                i14++;
    ...
    public final jz0[] q(ArrayList arrayList) {
        ...
        int length = ((jz0[][]) i0Var.f7791c).length;
        for (int i10 = 0; i10 < length; i10++) {
            i0Var.f(i10);
        }
        return (jz0[]) i0Var.f7790b;
    }
}
