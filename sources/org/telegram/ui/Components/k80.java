...
public abstract class k80 extends LinearLayout {
    public final org.telegram.ui.Cells.l4 f25563a;
    public final org.telegram.ui.Cells.w8 f25564b;
    public final org.telegram.ui.Cells.w8 f25565c;
    public final org.telegram.ui.Cells.e9 d;
    public final org.telegram.ui.Cells.e9 e;
    public boolean f25566f;
    public boolean h;
    public TLRPC.Chat f25567n;
    public ValueAnimator f25568r;
    ...
    public k80(Context context, TLRPC.Chat chat) {
        ...
        this.f25567n = chat;
        this.f25566f = chat.join_to_send;
        ...
        w8Var.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        k80 k80Var = this.f24586b;
                        boolean z13 = k80Var.f25566f;
                        boolean z14 = !z13;
        ...
        addView(e9Var2);
        boolean z13 = this.f25566f;
        this.f25569s = z13 ? 1.0f : 0.0f;
    ...
    public final void c(boolean z10) {
        ...
        this.f25563a.setVisibility(i10);
        if (z10) {
            i11 = 0;
        }
        this.f25564b.setVisibility(i11);
        if (!z10) {
            this.f25566f = true;
    ...
    public final void d(float f7) {
        int measuredHeight;
        this.f25569s = f7;
        org.telegram.ui.Cells.w8 w8Var = this.f25565c;
        w8Var.setAlpha(f7);
        float f10 = 1.0f - f7;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        int i14;
        org.telegram.ui.Cells.w8 w8Var = this.f25564b;
        if (w8Var.getVisibility() == 0) {
            int i15 = i12 - i10;
            org.telegram.ui.Cells.l4 l4Var = this.f25563a;
        ...
        int i16 = i12 - i10;
        org.telegram.ui.Cells.w8 w8Var2 = this.f25565c;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (w8Var.getVisibility() == 0) {
            measuredHeight = (w8Var2.getMeasuredHeight() * this.f25569s) + w8Var.getMeasuredHeight() + l4Var.getMeasuredHeight();
        } else {
            measuredHeight = w8Var2.getMeasuredHeight();
        }
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec((int) (measuredHeight + AndroidUtilities.lerp(e9Var.getMeasuredHeight(), e9Var2.getMeasuredHeight(), this.f25569s)), 1073741824));
    }
    ...
    public void setJoinToSend(boolean z10) {
        ...
        w8Var.setDivider(this.f25566f);
        boolean z11 = this.h;
        org.telegram.ui.Cells.w8 w8Var2 = this.f25565c;
        w8Var2.setChecked(z11);
        ValueAnimator valueAnimator = this.f25568r;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        float f10 = this.f25569s;
        if (this.f25566f) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        ...
        this.f25568r = ofFloat;
        ofFloat.setDuration(200L);
        this.f25568r.setInterpolator(qr.f27423f);
        this.f25568r.addUpdateListener(new h70(this, 1));
        this.f25568r.addListener(new p8(this, 26));
