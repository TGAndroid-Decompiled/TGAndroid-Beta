...
public abstract class k80 extends LinearLayout {
    public final org.telegram.ui.Cells.l4 f25581a;
    public final org.telegram.ui.Cells.w8 f25582b;
    public final org.telegram.ui.Cells.w8 f25583c;
    public final org.telegram.ui.Cells.e9 d;
    public final org.telegram.ui.Cells.e9 e;
    public boolean f25584f;
    public boolean h;
    public TLRPC.Chat f25585n;
    public ValueAnimator f25586r;
    ...
    public k80(Context context, TLRPC.Chat chat) {
        ...
        this.f25585n = chat;
        this.f25584f = chat.join_to_send;
        ...
        w8Var.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        k80 k80Var = this.f24581b;
                        boolean z13 = k80Var.f25584f;
                        boolean z14 = !z13;
        ...
        addView(e9Var2);
        boolean z13 = this.f25584f;
        this.f25587s = z13 ? 1.0f : 0.0f;
    ...
    public final void d(float f7) {
        int measuredHeight;
        this.f25587s = f7;
        org.telegram.ui.Cells.w8 w8Var = this.f25583c;
        w8Var.setAlpha(f7);
        float f10 = 1.0f - f7;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        int i14;
        org.telegram.ui.Cells.w8 w8Var = this.f25582b;
        if (w8Var.getVisibility() == 0) {
            int i15 = i12 - i10;
            org.telegram.ui.Cells.l4 l4Var = this.f25581a;
        ...
        int i16 = i12 - i10;
        org.telegram.ui.Cells.w8 w8Var2 = this.f25583c;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (w8Var.getVisibility() == 0) {
            measuredHeight = (w8Var2.getMeasuredHeight() * this.f25587s) + w8Var.getMeasuredHeight() + l4Var.getMeasuredHeight();
        } else {
            measuredHeight = w8Var2.getMeasuredHeight();
        }
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec((int) (measuredHeight + AndroidUtilities.lerp(e9Var.getMeasuredHeight(), e9Var2.getMeasuredHeight(), this.f25587s)), 1073741824));
    }
    ...
    public void setJoinToSend(boolean z10) {
        ...
        w8Var.setDivider(this.f25584f);
        boolean z11 = this.h;
        org.telegram.ui.Cells.w8 w8Var2 = this.f25583c;
        w8Var2.setChecked(z11);
        ValueAnimator valueAnimator = this.f25586r;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        float f10 = this.f25587s;
        if (this.f25584f) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        ...
        this.f25586r = ofFloat;
        ofFloat.setDuration(200L);
        this.f25586r.setInterpolator(qr.f27383f);
        this.f25586r.addUpdateListener(new h70(this, 1));
        this.f25586r.addListener(new p8(this, 26));
