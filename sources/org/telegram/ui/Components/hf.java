...
public final class hf implements Runnable {
    ...
    public int f24661b;
    public final KeyEvent.Callback f24662c;
    ...
    public final void run() {
        ...
        KeyEvent.Callback callback = this.f24662c;
        switch (i10) {
            case 0:
                ChatActivityEnterView chatActivityEnterView = (ChatActivityEnterView) callback;
                dg dgVar = chatActivityEnterView.U0;
                if (dgVar != null && (currentPage = dgVar.getCurrentPage()) != this.f24661b) {
                    this.f24661b = currentPage;
                    boolean z12 = chatActivityEnterView.f22046w3;
                    int i11 = 2;
                    ...
                    chatActivityEnterView.f22046w3 = z10;
                    boolean z13 = chatActivityEnterView.f22052x3;
                    if (currentPage == 0) {
                        z11 = true;
                    } else {
                        z11 = false;
                    }
                    chatActivityEnterView.f22052x3 = z11;
                    ...
                    if (z12 != chatActivityEnterView.f22046w3 || z13 != chatActivityEnterView.f22052x3) {
            ...
            case 1:
                ...
                s4.o0 layoutManager = mpVar.f26488w.getLayoutManager();
    ...
    public hf(ChatActivityEnterView chatActivityEnterView) {
        this.f24660a = 0;
        this.f24662c = chatActivityEnterView;
        this.f24661b = -1;
    }
}
