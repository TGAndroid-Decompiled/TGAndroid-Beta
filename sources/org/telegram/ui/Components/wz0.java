...
public final class wz0 extends View {
    ...
    public final uz0 Q;
    public final org.telegram.ui.Cells.q9 f30188a;
    public int f30189b;
    public final mz0 f30190c;
    public final mz0 d;
    public int e;
    ...
    public wz0(Context context, vz0 vz0Var, org.telegram.ui.Cells.q9 q9Var) {
        super(context);
        this.f30190c = new mz0(this, true);
        this.d = new mz0(this, false);
        this.e = 0;
        this.f30191f = false;
        this.h = 1;
        this.f30192n = 0;
        this.f30193r = AndroidUtilities.dp(8.0f);
        this.f30194s = AndroidUtilities.dp(9.0f);
    ...
    public static void i(rz0 rz0Var, int i10, int i11, int i12, int i13) {
        ...
        tz0 tz0Var = rz0Var.f28006a;
        rz0Var.f28006a = new tz0(tz0Var.f28517a, qz0Var, tz0Var.f28519c, tz0Var.d);
        qz0 qz0Var2 = new qz0(i12, i13 + i12);
        tz0 tz0Var2 = rz0Var.f28007b;
        rz0Var.f28007b = new tz0(tz0Var2.f28517a, qz0Var2, tz0Var2.f28519c, tz0Var2.d);
    }
    ...
    public final void a(int i10, int i11, int i12, int i13) {
        ...
        iz0 iz0Var = U;
        rz0Var.f28006a = new tz0(false, qz0Var, iz0Var, 0.0f);
        rz0Var.f28007b = new tz0(false, new qz0(i10, i12 + i10), iz0Var, 0.0f);
        pz0Var.f27363a = rz0Var;
        pz0Var.f27369j = i11;
    ...
    public final void b(TL_iv.pageTableCell pagetablecell, int i10, int i11, int i12) {
        ...
        iz0 iz0Var = U;
        rz0Var.f28006a = new tz0(false, qz0Var, iz0Var, 0.0f);
        rz0Var.f28007b = new tz0(false, new qz0(i10, i12 + i10), iz0Var, 1.0f);
        pz0Var.f27363a = rz0Var;
        pz0Var.f27369j = i11;
        arrayList.add(pz0Var);
    ...
    public final void c() {
        ...
        if (i11 == 0) {
            ...
            for (int i16 = 0; i16 < childCount; i16++) {
                ...
                boolean z11 = tz0Var.f28517a;
                int i17 = qz0Var.f27760b;
                int i18 = qz0Var.f27759a;
                int i19 = i17 - i18;
                if (z11) {
                    i14 = i18;
                }
                ...
                qz0 qz0Var2 = tz0Var2.f28518b;
                boolean z12 = tz0Var2.f28517a;
                int i20 = qz0Var2.f27760b;
                int i21 = qz0Var2.f27759a;
                int i22 = i20 - i21;
                if (i13 != 0) {
                    if (z12) {
            ...
            for (int i25 = 0; i25 < childCount2; i25++) {
                i12 = (i12 * 31) + d(i25).f27363a.hashCode();
            }
            this.f30192n = i12;
            return;
        }
        ...
        for (int i27 = 0; i27 < childCount3; i27++) {
            i26 = (i26 * 31) + d(i27).f27363a.hashCode();
        }
        if (i11 != i26) {
            g();
            c();
    ...
    public final int e(pz0 pz0Var, boolean z10, boolean z11) {
        ...
        if (z11) {
            if (mz0Var.f26553j == null) {
                mz0Var.f26553j = new int[mz0Var.e() + 1];
            }
            if (!mz0Var.f26554k) {
                mz0Var.b(true);
                mz0Var.f26554k = true;
            ...
            if (mz0Var.f26555l == null) {
                mz0Var.f26555l = new int[mz0Var.e() + 1];
            }
            if (!mz0Var.f26556m) {
                mz0Var.b(false);
                mz0Var.f26556m = true;
    ...
    public final int f(pz0 pz0Var, boolean z10, boolean z11) {
        ...
        if (i10 == Integer.MIN_VALUE) {
            ...
            if (z12 != z11) {
                int i11 = qz0Var.f27759a;
                return 0;
            }
            int i12 = qz0Var.f27760b;
            mz0Var.e();
            return 0;
        }
        return i10;
    ...
    public final void h(int i10, boolean z10) {
        ...
        for (int i14 = 0; i14 < childCount; i14++) {
            ...
            if (z10) {
                ...
                d.e(this.O.createTextLayout(d.f27365c, i12));
                if (d.f27364b != null) {
                    ((ViewGroup.MarginLayoutParams) rz0Var).height = Math.max(this.f30195w, d.f27366f + this.f30193r + this.f30194s);
                    int emojiOnlyCount = d.f27364b.getEmojiOnlyCount();
                    if (emojiOnlyCount > 0) {
                ...
                if (tz0.a(tz0Var, z11) == U) {
                    ...
                    int[] g10 = mz0Var.g();
                    int e = (g10[qz0Var.f27760b] - g10[qz0Var.f27759a]) - (e(d, z11, false) + e(d, z11, true));
                    if (z11) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i16 = 0; i16 < childCount; i16++) {
            wz0Var.f30189b = Math.max(wz0Var.f30189b, wz0Var.d(i16).f27363a.f28007b.f28518b.f27760b);
        }
        wz0Var.h(i10, true);
        if (wz0Var.e == 0) {
            i12 = mz0Var2.i(i10);
            if (wz0Var.f30196x) {
                ...
                mz0Var2.v.f28259a = i12;
                mz0Var2.f26565w.f28259a = -i12;
                mz0Var2.f26560q = false;
                mz0Var2.g();
            }
            wz0Var.h(i10, false);
            i13 = mz0Var.i(i11);
        ...
        mz0Var2.f26560q = false;
        mz0Var2.g();
        mz0Var.v.f28259a = max;
        mz0Var.f26565w.f28259a = -max;
        mz0Var.f26560q = false;
        mz0Var.g();
        int[] g10 = mz0Var2.g();
        int[] g11 = mz0Var.g();
        ...
        while (i19 < childCount2) {
            ...
            pz0 d = wz0Var.d(i20);
            rz0 rz0Var = d.f27363a;
            tz0 tz0Var = rz0Var.f28007b;
            tz0 tz0Var2 = rz0Var.f28006a;
            qz0 qz0Var = tz0Var.f28518b;
            qz0 qz0Var2 = tz0Var2.f28518b;
            int i21 = childCount2;
            int i22 = g10[qz0Var.f27759a];
            int i23 = g11[qz0Var2.f27759a];
            int i24 = g10[qz0Var.f27760b] - i22;
            int i25 = g11[qz0Var2.f27760b] - i23;
            int i26 = d.f27370k;
            mz0 mz0Var3 = mz0Var;
            int i27 = d.f27371l;
            ...
            lf.i f7 = mz0Var2.f();
            nz0 nz0Var = (nz0) ((Object[]) f7.d)[((int[]) f7.f14179b)[i20]];
            lf.i f10 = mz0Var3.f();
            mz0 mz0Var4 = mz0Var2;
            nz0 nz0Var2 = (nz0) ((Object[]) f10.d)[((int[]) f10.f14179b)[i20]];
            ...
            if (d.f27365c != null) {
                if (c10 != d.f27370k || c11 != d.f27371l) {
                    d.d(c10, c11, false);
                }
                int i32 = d.f27372m;
                if (i32 != 0 && i32 != c11) {
                    qz0 qz0Var3 = d.f27363a.f28006a.f28518b;
                    if (qz0Var3.f27760b - qz0Var3.f27759a <= 1) {
                        ...
                        while (true) {
                            if (i33 < size) {
                                ...
                                float f11 = pointF.x;
                                float f12 = d.f27363a.f28006a.f28518b.f27759a;
        ...
        while (i34 < size2) {
            ...
            int i35 = pz0Var.f27371l;
            int i36 = pz0Var.d;
            int i37 = i35 - pz0Var.f27372m;
            ArrayList arrayList3 = wz0Var.P;
            int size3 = arrayList3.size();
            for (int i38 = i36 + 1; i38 < size3; i38++) {
                pz0 pz0Var2 = (pz0) arrayList3.get(i38);
                if (pz0Var.f27363a.f28006a.f28518b.f27759a != pz0Var2.f27363a.f28006a.f28518b.f27759a) {
                    break;
                }
                int i39 = pz0Var.f27372m;
                int i40 = pz0Var2.f27372m;
                if (i39 < i40) {
                    z10 = true;
                    break;
                }
                int i41 = pz0Var2.f27371l - i40;
                if (i41 > 0) {
            ...
            if (!z10) {
                ...
                while (true) {
                    ...
                    if (pz0Var.f27363a.f28006a.f28518b.f27759a != pz0Var3.f27363a.f28006a.f28518b.f27759a) {
                        break;
                    }
                    int i43 = pz0Var.f27372m;
                    int i44 = pz0Var3.f27372m;
                    if (i43 < i44) {
                        z10 = true;
                        break;
                    }
                    int i45 = pz0Var3.f27371l - i44;
                    if (i45 > 0) {
            ...
            if (!z10) {
                pz0Var.f27371l = pz0Var.f27372m;
                pz0Var.g();
                max -= i37;
                int i46 = pz0Var.f27363a.f28006a.f28518b.f27759a;
                while (true) {
                    i46++;
                ...
                while (i49 < size4) {
                    ...
                    if (pz0Var == pz0Var4) {
                        ...
                        int i50 = pz0Var.f27363a.f28006a.f28518b.f27759a;
                        int i51 = pz0Var4.f27363a.f28006a.f28518b.f27759a;
                        if (i50 == i51) {
                            if (pz0Var4.f27372m != pz0Var4.f27371l) {
                            ...
                            int i52 = pz0Var4.f27371l - i37;
                            pz0Var4.f27371l = i52;
                            i14 = i49;
                            pz0Var4.d(pz0Var4.f27370k, i52, true);
                        } else {
                            i14 = i49;
                            if (i50 < i51) {
                                pz0Var4.f27376q -= i37;
        ...
        for (int i53 = 0; i53 < childCount3; i53++) {
            ...
            wz0Var.O.onLayoutChild(d10.f27364b, d10.b(), d10.c());
            d10.f27373n = d10.f27375p;
            d10.f27374o = d10.f27370k;
        }
        wz0Var.f30197y = i18;
        wz0Var.E = max;
        wz0Var.F = copyOf;
    ...
    public void setRenderWidth(int i10) {
        ...
        this.f30197y = Math.max(measuredWidth, i10);
        for (int i13 = 0; i13 < getChildCount(); i13++) {
            pz0 d = d(i13);
            if (measuredWidth > 0 && (i12 = this.f30197y) != measuredWidth) {
                float f7 = measuredWidth;
                int round = Math.round((d.f27373n * i12) / f7);
                int round2 = Math.round(((d.f27373n + d.f27374o) * this.f30197y) / f7);
                d.f27375p = round;
                d.f27370k = Math.max(0, round2 - round);
                if (d.f27365c != null && d.f27364b != null) {
                    d.f();
                }
            } else {
                int i14 = d.f27373n;
                d.f27375p = i14;
                d.f27370k = Math.max(0, (d.f27374o + i14) - i14);
                if (d.f27365c != null && d.f27364b != null) {
                    d.f();
                }
            }
        ...
        if (iArr.length < 2) {
            ...
            for (int i18 = 0; i18 < getChildCount(); i18++) {
                ...
                if (i11 > 0) {
                    qz0 qz0Var = d10.f27363a.f28006a.f28518b;
                    int max = Math.max(0, qz0Var.f27759a);
                    int min = Math.min(i15, qz0Var.f27760b);
                    if (max < min) {
                        int i19 = 0;
                        for (int i20 = max; i20 < min; i20++) {
                            i19 += iArr2[i20];
                        }
                        int max2 = Math.max(1, Math.round(d10.f27370k / i11)) - i19;
            ...
            for (int i25 = 0; i25 < getChildCount(); i25++) {
                pz0 d11 = d(i25);
                qz0 qz0Var2 = d11.f27363a.f28006a.f28518b;
                int max3 = Math.max(0, Math.min(i15, qz0Var2.f27759a));
                int max4 = Math.max(max3, Math.min(i15, qz0Var2.f27760b));
                int i26 = iArr4[max3];
                int i27 = iArr4[max4];
                d11.f27376q = i26;
                d11.f27371l = Math.max(0, i27 - i26);
                if (d11.f27365c != null) {
                    d11.g();
                }
                this.O.onLayoutChild(d11.f27364b, d11.b(), d11.c());
            }
        }
        invalidate();
    }
