...
public final class qy0 {
    ...
    public StaticLayout f27454b;
    public final ArrayList f27455c = new ArrayList(2);
    public int d;
    public int e;
    public int f27456f;
    public int f27457g;
    ...
    public final void b(MessageObject messageObject) {
        ...
        this.f27457g = AndroidUtilities.dp(14.0f) * 2;
        ArrayList arrayList = this.f27455c;
        arrayList.clear();
        ...
        while (i16 < size) {
            ...
            i16++;
            py0 py0Var = (py0) obj;
            f10 = Math.max(f10, py0Var.f27162a.l());
            f11 = Math.max(f11, py0Var.f27163b.l());
            int j3 = ((int) py0Var.f27162a.j()) + this.f27457g;
            this.f27457g = j3;
            this.f27457g = AndroidUtilities.dp(7.0f) + j3;
        }
        ...
        this.f27454b = new StaticLayout(AndroidUtilities.replaceTags(spannableStringBuilder), textPaint, max, Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
        int i30 = 0;
        for (int i31 = 0; i31 < this.f27454b.getLineCount(); i31++) {
            i30 = (int) Math.max(i30, this.f27454b.getLineWidth(i31));
        }
        int height = this.f27454b.getHeight() + this.f27457g;
        this.f27457g = height;
        this.f27457g = AndroidUtilities.dp(5.0f) + height;
        int D = org.telegram.messenger.w1.D(24.0f, 2, Math.max(dp, i30));
        this.h = D;
        this.d = (D - max) / 2;
        this.e = (D - dp) / 2;
        this.f27456f = (int) (AndroidUtilities.dp(f7) + i15 + f10);
    }
}
