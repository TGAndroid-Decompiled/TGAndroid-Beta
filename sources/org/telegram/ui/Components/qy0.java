...
public final class qy0 extends Drawable {
    ...
    public final c6 f27473b;
    public final Drawable f27474c;
    public final Drawable d;
    public int e = 255;

    public qy0(org.telegram.ui.Cells.t1 t1Var) {
        this.f27473b = new c6(t1Var, 420L, qr.h);
        this.f27474c = t1Var.getContext().getResources().getDrawable(R.drawable.summary_arrow);
    ...
    public final void draw(Canvas canvas) {
        ...
        float e = this.f27473b.e(this.f27472a);
        ...
        Drawable drawable2 = this.f27474c;
    ...
    public final int getIntrinsicHeight() {
        return this.f27474c.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f27474c.getIntrinsicWidth();
    }
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f27474c.setColorFilter(colorFilter);
