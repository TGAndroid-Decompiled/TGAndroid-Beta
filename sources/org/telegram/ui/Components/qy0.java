...
public final class qy0 extends Drawable {
    ...
    public final c6 f27470b;
    public final Drawable f27471c;
    public final Drawable d;
    public int e = 255;

    public qy0(org.telegram.ui.Cells.t1 t1Var) {
        this.f27470b = new c6(t1Var, 420L, qr.h);
        this.f27471c = t1Var.getContext().getResources().getDrawable(R.drawable.summary_arrow);
    ...
    public final void draw(Canvas canvas) {
        ...
        float e = this.f27470b.e(this.f27469a);
        ...
        Drawable drawable2 = this.f27471c;
    ...
    public final int getIntrinsicHeight() {
        return this.f27471c.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f27471c.getIntrinsicWidth();
    }
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f27471c.setColorFilter(colorFilter);
