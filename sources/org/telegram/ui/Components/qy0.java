...
public final class qy0 {
    public final org.telegram.ui.ActionBar.f6 f27450a;
    public StaticLayout f27451b;
    public final ArrayList f27452c = new ArrayList(2);
    public int d;
    public int e;
    public int f27453f;
    public int f27454g;
    ...
    public final void b(MessageObject messageObject) {
        ...
        org.telegram.ui.ActionBar.f6 f6Var = this.f27450a;
        if (f6Var != null) {
        ...
        this.f27454g = AndroidUtilities.dp(14.0f) * 2;
        ...
        while (i16 < size) {
            ...
            i16++;
            py0 py0Var = (py0) obj;
            f10 = Math.max(f10, py0Var.f27159a.l());
            f11 = Math.max(f11, py0Var.f27160b.l());
            int j3 = ((int) py0Var.f27159a.j()) + this.f27454g;
            this.f27454g = j3;
            this.f27454g = AndroidUtilities.dp(7.0f) + j3;
        }
        ...
        this.f27451b = new StaticLayout(AndroidUtilities.replaceTags(spannableStringBuilder), textPaint, max, Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
        int i30 = 0;
        for (int i31 = 0; i31 < this.f27451b.getLineCount(); i31++) {
            i30 = (int) Math.max(i30, this.f27451b.getLineWidth(i31));
        }
        int height = this.f27451b.getHeight() + this.f27454g;
        this.f27454g = height;
        this.f27454g = AndroidUtilities.dp(5.0f) + height;
        int D = org.telegram.messenger.w1.D(24.0f, 2, Math.max(dp, i30));
        this.h = D;
        this.d = (D - max) / 2;
        this.e = (D - dp) / 2;
        this.f27453f = (int) (AndroidUtilities.dp(f7) + i15 + f10);
    }
}
