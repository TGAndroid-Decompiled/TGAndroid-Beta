...
public abstract class ub extends FrameLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (qcVar != null && qcVar.f27551k) {
            ...
            if (bVar.f44003c == null) {
                bVar.a(getMeasuredWidth(), getMeasuredHeight(), 6.0f, AndroidUtilities.dp(10.0f));
            }
            this.blurVisibilityDrawable.f44006i = w7.q.b((int) org.telegram.messenger.wh.x(this.inOutOffset, getMeasuredHeight(), 1.0f, 255.0f), 0, 255);
    ...
    public void dispatchDrawImpl(Canvas canvas, boolean z10, int i10) {
        ...
        if (this.bulletin != null && i10 != 0) {
            ...
            if (isTransitionRunning() && (obVar = this.delegate) != null) {
                float h = obVar.h(this.bulletin.f27544a) - getY();
                float measuredHeight = (((View) getParent()).getMeasuredHeight() - getBottomOffset()) - getY();
                if (!z10 && this.delegate.g(this.bulletin.f27544a)) {
                    z11 = true;
                } else {
                    z11 = false;
                }
    ...
    public float getBottomOffset() {
        ...
        qc qcVar;
        o1.k kVar;
        if (this.bulletin != null && (((obVar = this.delegate) == null || obVar.e()) && (kVar = (qcVar = this.bulletin).d) != null && kVar.f15483f)) {
            f7 = qcVar.f27555o;
        } else {
    ...
    public void onDetach() {
        ...
        uh.b bVar = this.blurVisibilityDrawable;
        if (bVar != null && (bitmap = bVar.f44003c) != null) {
            bitmap.recycle();
            bVar.f44003c = null;
        }
    }
