...
public final class th0 extends FrameLayout {
    public final Paint f28099a;
    public final Path f28100b;
    public final sh0 f28101c;
    public float d;
    public float e;
    public float f28102f;
    public boolean h;
    public NotchInfoUtils.NotchInfo f28103n;
    ...
    public th0(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 31 && SharedConfig.getDevicePerformanceClass() >= 1) {
            ...
            this.f28101c = new rh0(this, f7);
        } else {
            this.f28101c = new qh0(this);
        }
        setIntensity(15.0f);
    ...
    public final void draw(Canvas canvas) {
        ...
        this.f28101c.c(new lv(this, 12), canvas);
    }

    public float getAvatarEndScale() {
        float min;
        int dp;
        NotchInfoUtils.NotchInfo notchInfo = this.f28103n;
        if (notchInfo == null) {
            return 0.8f;
        }
        if (notchInfo.isLikelyCircle) {
            ...
            min = Math.min(notchInfo.bounds.width(), this.f28103n.bounds.height());
            dp = AndroidUtilities.dp(100.0f);
        }
