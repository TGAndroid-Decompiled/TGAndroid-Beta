...
public final class th0 extends w9 implements xv0 {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Path path = zh0Var.M0;
        ArrayList arrayList = zh0Var.f30875b1;
        RectF rectF = zh0Var.N0;
        org.telegram.ui.hv0 hv0Var = zh0Var.f30881h1;
        if (hv0Var == null || !hv0Var.f34292n) {
            if (this.H != null) {
                ...
                if (k10 >= arrayList.size() || arrayList.get(k10) == null ? !(drawable == null || (this.L && (!(drawable instanceof d6) || ((d6) drawable).d[4] <= 0))) : ((Float) arrayList.get(k10)).floatValue() >= 1.0f) {
                    ...
                    if (this.K < 0) {
                        ...
                        if (currentTimeMillis <= 250 + j3 && currentTimeMillis > j3) {
                            this.H.E = rr.f28022f.getInterpolation(((float) (currentTimeMillis - j3)) / 250.0f);
                        }
                    }
                    if (zh0Var.f30880g1) {
                        invalidate();
                ...
                int i10 = zh0Var.f30885m1;
                if (i10 == 0 && zh0Var.f30886n1 == 0) {
                    canvas.drawRect(0.0f, 0.0f, getWidth(), getHeight(), this.N);
                    canvas2 = canvas;
                } else {
                    canvas2 = canvas;
                    int i11 = zh0Var.f30886n1;
                    Paint paint = this.N;
                    if (i10 == i11) {
                        rectF.set(0.0f, 0.0f, getWidth(), getHeight());
                        float f7 = zh0Var.f30885m1;
                        canvas2.drawRoundRect(rectF, f7, f7, paint);
                    } else {
                        path.reset();
                        rectF.set(0.0f, 0.0f, getWidth(), getHeight());
                        for (int i12 = 0; i12 < 4; i12++) {
                            fArr[i12] = zh0Var.f30885m1;
                            fArr[i12 + 4] = zh0Var.f30886n1;
                        }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        if (this.H != null) {
            if (this.P.f30893z0.getOccupyStatusBar()) {
