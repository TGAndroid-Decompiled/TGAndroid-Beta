...
public final class th0 extends FrameLayout {
    public final Paint f28102a;
    public final Path f28103b;
    public final sh0 f28104c;
    public float d;
    public float e;
    public float f28105f;
    public boolean h;
    public NotchInfoUtils.NotchInfo f28106n;
    ...
    public th0(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 31 && SharedConfig.getDevicePerformanceClass() >= 1) {
            ...
            this.f28104c = new rh0(this, f7);
        } else {
            this.f28104c = new qh0(this);
        }
        setIntensity(15.0f);
    ...
    public final void draw(Canvas canvas) {
        ...
        this.f28104c.c(new lv(this, 12), canvas);
    }

    public float getAvatarEndScale() {
        float min;
        int dp;
        NotchInfoUtils.NotchInfo notchInfo = this.f28106n;
        if (notchInfo == null) {
            return 0.8f;
        }
        if (notchInfo.isLikelyCircle) {
            ...
            min = Math.min(notchInfo.bounds.width(), this.f28106n.bounds.height());
            dp = AndroidUtilities.dp(100.0f);
        }
