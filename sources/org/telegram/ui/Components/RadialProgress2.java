...
public class RadialProgress2 {
    ...
    public final t90 f24077i;
    public final t90 f24078j;
    public float f24079k;
    public int f24080l;
    public int f24081m;
    public int f24082n;
    public int f24083o;
    ...
    public int f24089u;
    public int v;
    public final ImageReceiver f24090w;
    public int f24091x;
    public boolean f24092y;
    public boolean f24093z;
    public final RectF f24071a = new RectF();
    public int d = -1;

    public RadialProgress2(View view, org.telegram.ui.ActionBar.f6 f6Var) {
        Paint paint = new Paint(1);
        this.f24075f = paint;
        this.f24076g = new Paint(1);
        this.h = new Paint(1);
        this.f24079k = 1.0f;
        this.f24084p = -1;
        this.f24085q = -1;
        ...
        this.I = 1.0f;
        this.F = f6Var;
        this.f24074e = new Paint(1);
        this.f24072b = view;
        ImageReceiver imageReceiver = new ImageReceiver(view);
        this.f24090w = imageReceiver;
        imageReceiver.setInvalidateAll(true);
        t90 t90Var = new t90();
        this.f24077i = t90Var;
        t90 t90Var2 = new t90();
        this.f24078j = t90Var2;
        t90Var2.f30567j = true;
        t90Var2.f30561b.setStrokeWidth(AndroidUtilities.dp(2.0f));
        t90Var2.d(4, false);
    ...
    public final int a() {
        return this.f24077i.f30574q;
    }

    public final float b() {
        t90 t90Var = this.f24077i;
        int i10 = t90Var.f30574q;
        int i11 = t90Var.f30573p;
    ...
    public final void d() {
        ...
        View view = this.f24072b;
        RectF rectF = this.f24071a;
    ...
    public void draw(Canvas canvas) {
        ...
        int i14;
        t90 t90Var = this.f24077i;
        int i15 = t90Var.f30574q;
        Paint paint2 = t90Var.f30562c;
        if (i15 != 4 || t90Var.b() < 1.0f) {
            RectF rectF = this.f24071a;
            if (!rectF.isEmpty()) {
                int i16 = t90Var.f30574q;
                float b11 = b();
                boolean z10 = this.f24093z;
                t90 t90Var2 = this.f24078j;
                Paint paint3 = this.h;
                if (z10 && this.f24085q < 0) {
                    int i17 = this.v;
                    if (i17 >= 0) {
                        t90Var2.c(org.telegram.ui.ActionBar.j6.v0(i17, this.F));
                    } else {
                        t90Var2.c(this.f24083o);
                    }
                    int i18 = this.f24088t;
                    if (i18 >= 0) {
                        paint3.setColor(org.telegram.ui.ActionBar.j6.v0(i18, this.F));
                    } else {
                        paint3.setColor(this.f24081m);
                    }
                } else {
                    int i19 = this.f24089u;
                    if (i19 >= 0) {
                        t90Var2.c(org.telegram.ui.ActionBar.j6.v0(i19, this.F));
                    } else {
                        t90Var2.c(this.f24082n);
                    }
                    int i20 = this.f24084p;
                    if (i20 >= 0) {
                        if (this.f24085q >= 0) {
                            paint3.setColor(AndroidUtilities.getOffsetColor(org.telegram.ui.ActionBar.j6.v0(i20, this.F), org.telegram.ui.ActionBar.j6.v0(this.f24085q, this.F), this.f24086r, this.f24087s));
                        } else {
                            paint3.setColor(org.telegram.ui.ActionBar.j6.v0(i20, this.F));
                        }
                    } else {
                        paint3.setColor(this.f24080l);
                    }
                }
                boolean z11 = this.f24092y;
                Paint paint4 = this.f24076g;
                if (z11) {
                    int i21 = this.v;
                    if (i21 >= 0) {
                        i10 = org.telegram.ui.ActionBar.j6.v0(i21, this.F);
                        t90Var.c(i10);
                        paint2.setColor((-16777216) | org.telegram.ui.ActionBar.j6.v0(this.f24088t, this.F));
                    } else {
                        i10 = this.f24083o;
                        t90Var.c(i10);
                        paint2.setColor((-16777216) | this.f24081m);
                    }
                    int i22 = this.f24088t;
                    if (i22 >= 0) {
                        paint4.setColor(org.telegram.ui.ActionBar.j6.v0(i22, this.F));
                    } else {
                        paint4.setColor(this.f24081m);
                    }
                } else {
                    int i23 = this.f24089u;
                    if (i23 >= 0) {
                        i10 = org.telegram.ui.ActionBar.j6.v0(i23, this.F);
                        t90Var.c(i10);
                        paint2.setColor((-16777216) | org.telegram.ui.ActionBar.j6.v0(this.f24084p, this.F));
                    } else {
                        i10 = this.f24082n;
                        t90Var.c(i10);
                        paint2.setColor((-16777216) | this.f24080l);
                    }
                    int i24 = this.f24084p;
                    if (i24 >= 0) {
                        paint4.setColor(org.telegram.ui.ActionBar.j6.v0(i24, this.F));
                    } else {
                        paint4.setColor(this.f24080l);
                    }
                }
                if ((this.f24073c || this.f24085q >= 0) && this.D != null) {
                    this.C.eraseColor(0);
                }
                ...
                ImageReceiver imageReceiver = this.f24090w;
                boolean hasBitmapImage = imageReceiver.hasBitmapImage();
                boolean z12 = true;
                Paint paint5 = this.f24075f;
                int i25 = 2;
                if (hasBitmapImage) {
                ...
                if (canvas5 != null && this.f24085q >= 0 && this.f24087s != f10) {
                    i11 = canvas5.save();
                    float b12 = com.google.android.gms.internal.vision.e2.b(1.0f, this.f24087s, 0.1f, 1.0f);
                    this.D.scale(b12, b12, ceil, ceil2);
                } else {
                    i11 = Integer.MIN_VALUE;
                }
                if (z12 && this.B) {
                    if ((this.f24073c || this.f24085q >= 0) && (canvas4 = this.D) != null) {
                        canvas4.drawCircle(ceil, ceil2, this.f24091x, paint4);
                    } else if (i16 != 4 || f7 != 0.0f) {
                        canvas.drawCircle(ceil, ceil2, this.f24091x, paint4);
                    }
                }
                if (imageReceiver.hasBitmapImage()) {
                    imageReceiver.setAlpha(f7 * this.E * this.H);
                    if ((this.f24073c || this.f24085q >= 0) && (canvas3 = this.D) != null) {
                        imageReceiver.draw(canvas3);
                        this.D.drawCircle(ceil, ceil2, this.f24091x, paint5);
                    } else {
                        imageReceiver.draw(canvas);
                        canvas.drawCircle(ceil, ceil2, this.f24091x, paint5);
                    }
                }
                int i26 = this.f24091x;
                int i27 = this.G;
                if (i27 > 0 && i26 > i27) {
                    i26 = i27;
                }
                ...
                if (!this.f24073c && this.f24085q < 0) {
                    t90Var.f30572o = this.E;
                    t90Var.draw(canvas);
                } else {
                ...
                if (this.f24073c || this.f24085q >= 0) {
                    ...
                    if (canvas7 != null) {
                        ...
                        canvas7.drawCircle(AndroidUtilities.dp(f15), AndroidUtilities.dp(f15), AndroidUtilities.dp(i28 + 1) * f11 * this.f24079k, org.telegram.ui.ActionBar.j6.f20841n0);
                    } else {
                        int i29 = this.d;
                        Paint paint6 = this.f24074e;
                        paint6.setColor(i29);
                    ...
                    if (this.f24079k < 1.0f) {
                        i13 = canvas.save();
                        float f16 = this.f24079k;
                        canvas.scale(f16, f16, centerX, centerY);
                    } else {
                        i13 = Integer.MIN_VALUE;
                    }
                    float f17 = i28;
                    canvas.drawCircle(centerX, centerY, com.google.android.gms.internal.vision.e2.z(1.0f, this.f24087s, AndroidUtilities.dp(1.0f), AndroidUtilities.dp(f17) * f11), paint);
                    if (this.f24073c) {
    ...
    public final void e() {
        this.f24090w.onAttachedToWindow();
    }

    public final void f() {
        this.f24090w.onDetachedFromWindow();
    }
    ...
    public final void h(String str) {
        ...
        if (str != null) {
            ...
            str2 = a4.a.k(this.f24091x * 2, this.f24091x * 2, "_");
        } else {
            str2 = null;
        }
        this.f24090w.setImage(str, str2, null, null, -1L);
    }
    ...
    public final void i(TLRPC.PhotoSize photoSize, TLRPC.Document document, MessageObject messageObject) {
        ...
        int i10 = this.f24091x;
        this.f24090w.setImage(forDocument, a4.a.k(i10 * 2, i10 * 2, "_"), null, null, messageObject, 1);
    }

    public final void j(TLRPC.PhotoSize photoSize, TLRPC.PhotoSize photoSize2, TLRPC.Document document, Object obj) {
        ImageLocation forDocument;
        Locale locale = Locale.US;
        String k10 = a4.a.k(this.f24091x * 2, this.f24091x * 2, "_");
        ...
        this.f24090w.setImage(forDocument, k10, imageLocation, k10, null, 0L, null, obj, 1);
    }

    public final void k(int i10, boolean z10, boolean z11) {
        boolean z12;
        if (i10 == 2 || i10 == 3 || i10 == 4) {
            t90 t90Var = this.f24078j;
            if (z10 && i10 == t90Var.f30574q) {
                return;
            }
            t90Var.d(i10, z11);
    ...
    public final void m(View view) {
        this.f24072b = view;
        this.f24090w.setParentView(view);
        Objects.requireNonNull(view);
        this.f24077i.A = new kv(view, 13);
        this.f24078j.A = new kv(view, 13);
    }
    ...
    public final void o(float f7, boolean z10) {
        if (this.f24073c) {
            this.f24078j.e(f7, z10);
        } else {
            this.f24077i.e(f7, z10);
        }
    }
    ...
    public final void q(int i10, int i11, int i12, int i13) {
        this.f24071a.set(i10, i11, i12, i13);
    }

    public void setAsMini() {
        t90 t90Var = this.f24077i;
        t90Var.f30567j = true;
        t90Var.f30561b.setStrokeWidth(AndroidUtilities.dp(2.0f));
    }
    ...
    public void setCircleRadius(int i10) {
        this.f24091x = i10;
        this.f24090w.setRoundRadius(i10);
    }
