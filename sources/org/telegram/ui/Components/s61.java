...
public final class s61 extends View {
    public final m6 f27787a;
    public final m6 f27788b;
    public final Paint f27789c;
    ...
    public s61(Context context) {
        ...
        this.f27791n = new int[]{144, 240, 360, 480, 720, 1080, 1440, 2160};
        ...
        m6Var2.f26084a.setXfermode(new PorterDuffXfermode(mode));
    ...
    public final void a(int i10, boolean z10, boolean z11) {
        ...
        this.f27790f = z12;
        m6 m6Var = this.f27787a;
        m6 m6Var2 = this.f27788b;
        if (z11) {
            ...
            if (length < 0) {
                ...
                m6Var2.q("2K", TextUtils.isEmpty(m6Var2.f26088g), true);
            } else if (length == 7) {
                m6Var2.q("4K", TextUtils.isEmpty(m6Var2.f26088g), true);
            } else {
                m6Var2.q("" + iArr[length], TextUtils.isEmpty(m6Var2.f26088g), true);
            }
        }
        setClickable(!this.f27790f);
        invalidate();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float e = (1.0f - (this.h.e(this.f27790f) * 0.35f)) * 255.0f;
        int i10 = (int) e;
        Paint paint = this.f27789c;
        paint.setAlpha(i10);
    ...
    public void setPhotoState(boolean z10) {
        ...
        this.f27787a.q(str, true, true);
        this.f27788b.q("", false, true);
    }

    @Override
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.f27787a != drawable && this.f27788b != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
