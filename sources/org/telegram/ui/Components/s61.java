...
public final class s61 extends View {
    public final p6 f30206a;
    public final p6 f30207b;
    public final Paint f30208c;
    public final Paint d;
    public final Paint f30209e;
    ...
    public s61(Context context) {
        ...
        this.f30211n = new int[]{144, 240, 360, 480, 720, 1080, 1440, 2160};
        ...
        p6Var2.f29285a.setXfermode(new PorterDuffXfermode(mode));
    ...
    public final void a(int i10, boolean z10, boolean z11) {
        ...
        this.f30210f = z12;
        p6 p6Var = this.f30206a;
        p6 p6Var2 = this.f30207b;
        if (z11) {
            ...
            if (length < 0) {
                ...
                p6Var2.q("2K", TextUtils.isEmpty(p6Var2.f29290g), true);
            } else if (length == 7) {
                p6Var2.q("4K", TextUtils.isEmpty(p6Var2.f29290g), true);
            } else {
                p6Var2.q("" + iArr[length], TextUtils.isEmpty(p6Var2.f29290g), true);
            }
        }
        setClickable(!this.f30210f);
        invalidate();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float e7 = (1.0f - (this.h.e(this.f30210f) * 0.35f)) * 255.0f;
        int i10 = (int) e7;
        Paint paint = this.f30208c;
        paint.setAlpha(i10);
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.dpf2(1.66f), AndroidUtilities.dpf2(1.66f), this.f30209e);
        canvas.saveLayerAlpha(0.0f, 0.0f, getWidth(), getHeight(), 255, 31);
        rectF.set(rect);
        Paint paint2 = this.d;
    ...
    public void setPhotoState(boolean z10) {
        ...
        this.f30206a.q(str, true, true);
        this.f30207b.q("", false, true);
    }

    @Override
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.f30206a != drawable && this.f30207b != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
