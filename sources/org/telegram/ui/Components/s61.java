...
public final class s61 extends Drawable implements r5, s6, NotificationCenter.NotificationCenterDelegate {
    public final q20 f28675a;
    public final int f28676b;
    public float f28677c;
    public final boolean d;
    public ImageReceiver e;
    public final HashSet f28678f;
    public final l5 h;
    public final r61 f28679n;
    public final ImageReceiver f28680r;
    public final int f28681s;
    public boolean v;
    public final TLRPC.TL_videoSizeStickerMarkup f28682w;
    ...
    public s61(TLRPC.VideoSize videoSize, boolean z4, int i10) {
        ...
        q20 q20Var = new q20();
        this.f28675a = q20Var;
        this.f28678f = new HashSet();
        this.f28680r = new ImageReceiver();
        this.f28681s = UserConfig.selectedAccount;
        this.f28676b = i10;
        this.d = z4;
        ...
        if (videoSize instanceof TLRPC.TL_videoSizeEmojiMarkup) {
            ...
            this.f28682w = (TLRPC.TL_videoSizeStickerMarkup) videoSize;
    ...
    public final void b(ImageReceiver imageReceiver) {
        ...
        if (hashSet.isEmpty()) {
            ...
            r61 r61Var = this.f28679n;
            if (r61Var != null) {
                r61Var.onDetachedFromWindow();
            }
            ImageReceiver imageReceiver2 = this.f28680r;
            if (imageReceiver2 != null) {
                imageReceiver2.onDetachedFromWindow();
            }
        }
        if (this.f28682w != null) {
            NotificationCenter.getInstance(this.f28681s).removeObserver(this, NotificationCenter.groupStickersDidLoad);
        }
    }
    ...
    public final void c(ImageReceiver imageReceiver) {
        if (imageReceiver != null) {
            this.f28677c = imageReceiver.getRoundRadius()[0];
            HashSet hashSet = this.f28678f;
            if (hashSet.isEmpty()) {
                l5 l5Var = this.h;
                if (l5Var != null) {
            ...
            if (this.f28682w != null) {
                NotificationCenter.getInstance(this.f28681s).addObserver(this, NotificationCenter.groupStickersDidLoad);
            }
        }
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && s61.class == obj.getClass()) {
            s61 s61Var = (s61) obj;
            l5 l5Var = s61Var.h;
            if (this.f28676b == s61Var.f28676b) {
                q20 q20Var = this.f28675a;
                int i10 = q20Var.d;
                q20 q20Var2 = s61Var.f28675a;
                if (i10 == q20Var2.d && q20Var.e == q20Var2.e && q20Var.f28051f == q20Var2.f28051f && q20Var.f28052g == q20Var2.f28052g) {
                    l5 l5Var2 = this.h;
                    ...
                    TLRPC.TL_videoSizeStickerMarkup tL_videoSizeStickerMarkup2 = this.f28682w;
                    if (tL_videoSizeStickerMarkup2 != null && (tL_videoSizeStickerMarkup = s61Var.f28682w) != null && tL_videoSizeStickerMarkup2.stickerset.f19179id == tL_videoSizeStickerMarkup.stickerset.f19179id && tL_videoSizeStickerMarkup2.sticker_id == tL_videoSizeStickerMarkup.sticker_id) {
                        return true;
                    }
                }
            }
    ...
    public final void invalidate() {
        Iterator it = this.f28678f.iterator();
        while (it.hasNext()) {
    ...
    public final void setAlpha(int i10) {
        this.f28675a.f28050c.setAlpha(i10);
        l5 l5Var = this.h;
        if (l5Var != null) {
            l5Var.setAlpha(i10);
        }
