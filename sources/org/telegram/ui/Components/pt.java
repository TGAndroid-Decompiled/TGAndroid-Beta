...
public class pt extends View {
    public final v01 f27316a;
    public final Drawable f27317b;
    public final ImageReceiver f27318c;
    public final Rect d;
    ...
    public pt(Context context, CharSequence charSequence) {
        ...
        this.f27318c = imageReceiver;
        imageReceiver.setRoundRadius(AndroidUtilities.dp(22.66f));
        this.f27316a = new v01(charSequence, 14.0f, AndroidUtilities.bold());
    ...
    public final void a(TLRPC.Photo photo, Object obj) {
        ...
        this.f27318c.setImage(ImageLocation.getForPhoto(closestPhotoSizeWithSize, photo), "24_24", ImageLocation.getForPhoto(closestPhotoSizeWithSize2, photo), "24_24", 0L, null, obj, 0);
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.f27318c.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f27318c.onDetachedFromWindow();
    }
    ...
    public final void onDraw(Canvas canvas) {
        float f7;
        int dp;
        ImageReceiver imageReceiver = this.f27318c;
        ...
        int dp2 = AndroidUtilities.dp(19.0f) + ((int) Math.ceil(this.f27316a.f28868c)) + AndroidUtilities.dp(f7);
        ...
        ch.d dVar = this.f27319f;
        if (dVar != null) {
            dVar.setBounds(rect);
            this.f27319f.draw(canvas);
        }
        if (hasBitmapImage) {
            float f10 = height;
        ...
        this.f27316a.c(width + dp, height, 1.0f, -1, canvas);
        Drawable drawable = this.f27317b;
    ...
    public void setImage(Bitmap bitmap) {
        this.f27318c.setImageBitmap(bitmap);
        invalidate();
    }
