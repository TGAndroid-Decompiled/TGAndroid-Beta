...
public class pt extends View {
    public final g01 f27138a;
    public final Drawable f27139b;
    public final ImageReceiver f27140c;
    public final Rect d;
    ...
    public pt(Context context, CharSequence charSequence) {
        ...
        this.f27140c = imageReceiver;
        imageReceiver.setRoundRadius(AndroidUtilities.dp(22.66f));
        this.f27138a = new g01(charSequence, 14.0f, AndroidUtilities.bold());
    ...
    public final void a(TLRPC.Photo photo, Object obj) {
        ...
        this.f27140c.setImage(ImageLocation.getForPhoto(closestPhotoSizeWithSize, photo), "24_24", ImageLocation.getForPhoto(closestPhotoSizeWithSize2, photo), "24_24", 0L, null, obj, 0);
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.f27140c.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f27140c.onDetachedFromWindow();
    }
    ...
    public final void onDraw(Canvas canvas) {
        float f7;
        int dp;
        ImageReceiver imageReceiver = this.f27140c;
        ...
        int dp2 = AndroidUtilities.dp(19.0f) + ((int) Math.ceil(this.f27138a.f24149c)) + AndroidUtilities.dp(f7);
        ...
        ch.d dVar = this.f27141f;
        if (dVar != null) {
            dVar.setBounds(rect);
            this.f27141f.draw(canvas);
        }
        if (hasBitmapImage) {
            float f10 = height;
        ...
        this.f27138a.c(width + dp, height, 1.0f, -1, canvas);
        Drawable drawable = this.f27139b;
    ...
    public void setImage(Bitmap bitmap) {
        this.f27140c.setImageBitmap(bitmap);
        invalidate();
    }
