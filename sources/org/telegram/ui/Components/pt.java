...
public class pt extends View {
    public final h01 f27124a;
    public final Drawable f27125b;
    public final ImageReceiver f27126c;
    public final Rect d;
    ...
    public pt(Context context, CharSequence charSequence) {
        ...
        this.f27126c = imageReceiver;
        imageReceiver.setRoundRadius(AndroidUtilities.dp(22.66f));
        this.f27124a = new h01(charSequence, 14.0f, AndroidUtilities.bold());
    ...
    public final void a(TLRPC.Photo photo, Object obj) {
        ...
        this.f27126c.setImage(ImageLocation.getForPhoto(closestPhotoSizeWithSize, photo), "24_24", ImageLocation.getForPhoto(closestPhotoSizeWithSize2, photo), "24_24", 0L, null, obj, 0);
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.f27126c.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f27126c.onDetachedFromWindow();
    }
    ...
    public final void onDraw(Canvas canvas) {
        float f7;
        int dp;
        ImageReceiver imageReceiver = this.f27126c;
        ...
        int dp2 = AndroidUtilities.dp(19.0f) + ((int) Math.ceil(this.f27124a.f24439c)) + AndroidUtilities.dp(f7);
        ...
        ch.d dVar = this.f27127f;
        if (dVar != null) {
            dVar.setBounds(rect);
            this.f27127f.draw(canvas);
        }
        if (hasBitmapImage) {
            float f10 = height;
        ...
        this.f27124a.c(width + dp, height, 1.0f, -1, canvas);
        Drawable drawable = this.f27125b;
    ...
    public void setImage(Bitmap bitmap) {
        this.f27126c.setImageBitmap(bitmap);
        invalidate();
    }
