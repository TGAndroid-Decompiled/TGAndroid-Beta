...
public class pt extends View {
    public final h01 f27127a;
    public final Drawable f27128b;
    public final ImageReceiver f27129c;
    public final Rect d;
    ...
    public pt(Context context, CharSequence charSequence) {
        ...
        this.f27129c = imageReceiver;
        imageReceiver.setRoundRadius(AndroidUtilities.dp(22.66f));
        this.f27127a = new h01(charSequence, 14.0f, AndroidUtilities.bold());
    ...
    public final void a(TLRPC.Photo photo, Object obj) {
        ...
        this.f27129c.setImage(ImageLocation.getForPhoto(closestPhotoSizeWithSize, photo), "24_24", ImageLocation.getForPhoto(closestPhotoSizeWithSize2, photo), "24_24", 0L, null, obj, 0);
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.f27129c.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f27129c.onDetachedFromWindow();
    }
    ...
    public final void onDraw(Canvas canvas) {
        float f7;
        int dp;
        ImageReceiver imageReceiver = this.f27129c;
        ...
        int dp2 = AndroidUtilities.dp(19.0f) + ((int) Math.ceil(this.f27127a.f24442c)) + AndroidUtilities.dp(f7);
        ...
        ch.d dVar = this.f27130f;
        if (dVar != null) {
            dVar.setBounds(rect);
            this.f27130f.draw(canvas);
        }
        if (hasBitmapImage) {
            float f10 = height;
        ...
        this.f27127a.c(width + dp, height, 1.0f, -1, canvas);
        Drawable drawable = this.f27128b;
    ...
    public void setImage(Bitmap bitmap) {
        this.f27129c.setImageBitmap(bitmap);
        invalidate();
    }
