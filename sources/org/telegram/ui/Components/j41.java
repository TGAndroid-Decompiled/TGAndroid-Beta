...
public abstract class j41 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final RichMessageLayout.PreviewView f25227n;
    public final RichMessageLayout.PreviewView f25228r;
    public final String f25229s;
    public String v;
    public String f25230w;
    public final h41 f25231x;
    public final bi.o f25232y;
    ...
    public j41(Context context, String str, String str2, CharSequence charSequence, TLRPC.InputPeer inputPeer, int i10, boolean z10, TL_iv.RichMessage richMessage) {
        ...
        k90Var.setHighlightColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19416uf));
        int themedColor = getThemedColor(org.telegram.ui.ActionBar.j6.f19433vf);
        try {
        ...
        RichMessageLayout.PreviewView previewView3 = this.f25228r;
        ...
        frameLayout.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19165h5));
    ...
    public static void m(j41 j41Var, TLRPC.TL_textWithEntities tL_textWithEntities, TLRPC.TL_textWithEntities tL_textWithEntities2, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && "TRANSLATIONS_DISABLED_ALT".equalsIgnoreCase(tL_error.text)) {
            ...
            f41 f41Var = j41Var.f25231x.e;
            String str = j41Var.f25230w;
            j41Var.v = str;
    ...
    public static void o(j41 j41Var, TLObject tLObject) {
        RichMessageLayout.PreviewView previewView = j41Var.f25228r;
        j41Var.f25224b = null;
    ...
    public final void M() {
        ...
        if (this.f25224b != null) {
            ConnectionsManager.getInstance(this.currentAccount).cancelRequest(this.f25224b.intValue(), true);
            this.f25224b = null;
        }
        ...
        if (richMessage != null && inputPeer != null) {
            ...
            tL_messages_translateRichMessage.f18449id.add(Integer.valueOf(i10));
            tL_messages_translateRichMessage.to_lang = TranslateController.normalizeLanguage(str);
            this.f25224b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_translateRichMessage, new x1(this, 16)));
            return;
        }
        TLRPC.TL_textWithEntities tL_textWithEntities = new TLRPC.TL_textWithEntities();
        CharSequence charSequence2 = this.f25225c;
        ...
        if (this.f25226f && inputPeer != null) {
            ...
            tL_messages_summarizeText.f18448id = i10;
            tL_messages_summarizeText.to_lang = TranslateController.normalizeLanguage(str);
            this.f25224b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequestTyped(tL_messages_summarizeText, new Object(), new ai.m0(13, this, tL_textWithEntities)));
            return;
        }
        ...
        if (inputPeer != null) {
            ...
            tL_messages_translateText.f18450id.add(Integer.valueOf(i10));
        } else {
            tL_messages_translateText.flags |= 2;
            tL_messages_translateText.text.add(tL_textWithEntities);
        }
        tL_messages_translateText.to_lang = TranslateController.normalizeLanguage(str);
        this.f25224b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_translateText, new org.telegram.ui.oo(17, this, tL_textWithEntities)));
    }
