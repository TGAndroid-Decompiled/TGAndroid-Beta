...
public abstract class j41 extends org.telegram.ui.ActionBar.e3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final CharSequence f25254c;
    public final TLRPC.InputPeer d;
    public final int e;
    public final boolean f25255f;
    public final TL_iv.RichMessage h;
    public final RichMessageLayout.PreviewView f25256n;
    public final RichMessageLayout.PreviewView f25257r;
    public final String f25258s;
    public String v;
    public String f25259w;
    public final h41 f25260x;
    public final bi.o f25261y;
    ...
    public j41(Context context, String str, String str2, CharSequence charSequence, TLRPC.InputPeer inputPeer, int i10, boolean z10, TL_iv.RichMessage richMessage) {
        ...
        o90Var.setPadding(AndroidUtilities.dp(22.0f), AndroidUtilities.dp(12.0f), AndroidUtilities.dp(22.0f), AndroidUtilities.dp(6.0f));
        o90Var.setTextSize(1, SharedConfig.fontSize);
        o90Var.setTextColor(getThemedColor(i11));
        o90Var.setLinkTextColor(getThemedColor(org.telegram.ui.ActionBar.h6.gc));
        o90Var.setTextIsSelectable(true);
        o90Var.setHighlightColor(getThemedColor(org.telegram.ui.ActionBar.h6.f19381uf));
        int themedColor = getThemedColor(org.telegram.ui.ActionBar.h6.f19398vf);
        try {
            if (Build.VERSION.SDK_INT >= 29 && !XiaomiUtilities.isMIUI()) {
                Drawable textSelectHandleLeft = o90Var.getTextSelectHandleLeft();
                PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
                textSelectHandleLeft.setColorFilter(themedColor, mode);
                o90Var.setTextSelectHandleLeft(textSelectHandleLeft);
                Drawable textSelectHandleRight = o90Var.getTextSelectHandleRight();
                textSelectHandleRight.setColorFilter(themedColor, mode);
                o90Var.setTextSelectHandleRight(textSelectHandleRight);
            }
        ...
        ?? h0Var = new s4.h0();
        h0Var.e = 1;
        h0Var.f24978c = context;
        h0Var.d = view;
        this.I = h0Var;
        w31Var.setAdapter(h0Var);
        ...
        RichMessageLayout.PreviewView previewView3 = this.f25257r;
        ...
        textView.setOnClickListener(new j80(this, 23));
    ...
    public static b41 J(Activity activity, org.telegram.ui.wn wnVar, TLRPC.InputPeer inputPeer, int i10, boolean z10, String str, String str2, CharSequence charSequence, boolean z11, org.telegram.ui.tf tfVar, Runnable runnable) {
        b41 b41Var = new b41(activity, str, str2, charSequence, inputPeer, i10, z10, runnable);
        b41Var.H(z11);
        b41Var.M = wnVar;
        b41Var.N = tfVar;
        if (wnVar.getParentActivity() != null) {
            wnVar.showDialog(b41Var);
        }
        return b41Var;
    }
    ...
    public static void m(j41 j41Var, TLRPC.TL_textWithEntities tL_textWithEntities, TLRPC.TL_textWithEntities tL_textWithEntities2, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && "TRANSLATIONS_DISABLED_ALT".equalsIgnoreCase(tL_error.text)) {
            ...
            org.telegram.messenger.ok.p(R.string.TranslationFailedAlert2, new xc((FrameLayout) j41Var.containerView, j41Var.resourcesProvider), null);
            f41 f41Var = j41Var.f25260x.e;
            String str = j41Var.f25259w;
            j41Var.v = str;
    ...
    public static void o(j41 j41Var, TLObject tLObject) {
        RichMessageLayout.PreviewView previewView = j41Var.f25257r;
        j41Var.f25253b = null;
    ...
    public static void p(j41 j41Var, String str, Boolean bool) {
        ...
        if (str != null) {
            ...
            xc xcVar = new xc((FrameLayout) j41Var.containerView, j41Var.resourcesProvider);
            if (bool.booleanValue()) {
    ...
    public static boolean u(j41 j41Var) {
        ...
        for (int i10 = 0; i10 < w31Var.getChildCount(); i10++) {
            View childAt = w31Var.getChildAt(i10);
            if (RecyclerView.R(childAt) == 1) {
                f7 += childAt.getHeight();
            }
        }
        if (f7 < (w31Var.getHeight() - w31Var.getPaddingTop()) - w31Var.getPaddingBottom()) {
            return false;
        }
        return true;
    }
    ...
    public final void H(boolean z10) {
        o90 o90Var = this.F;
        if (o90Var != null) {
            o90Var.setTextIsSelectable(!z10);
        }
        if (z10) {
    ...
    public final void M() {
        ...
        if (this.f25253b != null) {
            ConnectionsManager.getInstance(this.currentAccount).cancelRequest(this.f25253b.intValue(), true);
            this.f25253b = null;
        }
        ...
        if (richMessage != null && inputPeer != null) {
            ...
            this.f25253b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_translateRichMessage, new y1(this, 16)));
            return;
        }
        TLRPC.TL_textWithEntities tL_textWithEntities = new TLRPC.TL_textWithEntities();
        CharSequence charSequence2 = this.f25254c;
        ...
        if (this.f25255f && inputPeer != null) {
            ...
            this.f25253b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequestTyped(tL_messages_summarizeText, new Object(), new ai.m0(13, this, tL_textWithEntities)));
            return;
        }
        ...
        this.f25253b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_translateText, new org.telegram.ui.lo(17, this, tL_textWithEntities)));
    }
