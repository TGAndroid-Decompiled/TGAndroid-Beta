...
public final class x90 extends v7.i0 {
    ...
    public static int B(bf.p pVar) {
        bf.s sVar;
        String str;
        bf.p pVar2 = (bf.p) pVar.f3552c;
        if (pVar2 instanceof bf.r) {
            bf.p pVar3 = (bf.p) pVar2.f3552c;
            if ((pVar3 instanceof bf.s) && (str = (sVar = (bf.s) pVar3).f3555g) != null) {
                int i10 = 3;
                if (str.length() >= 3) {
                    int i11 = 0;
    ...
    public static void C(w90 w90Var, List list, int i10) {
        ...
        boolean z10;
        TL_iv.RichText j3;
        ad.a aVar = w90Var.f29986a;
        ArrayList arrayList = w90Var.f29988c;
        String str2 = aVar.f386a;
        if (str2 == null) {
            lowerCase = "";
        } else {
            ...
            case 1557721666:
                if (lowerCase.equals("details")) {
                    ...
                    while (i11 < size) {
                        ...
                        if (z11) {
                            w90 w90Var2 = (w90) obj;
                            if ("summary".equalsIgnoreCase(w90Var2.f29986a.f386a)) {
                                StringBuilder sb2 = new StringBuilder();
                                w(w90Var2.f29988c, sb2);
                        ...
                        if (obj instanceof v90) {
                            arrayList2.add(((v90) obj).f29044a);
                        } else if (z11) {
    ...
    public static void w(List list, StringBuilder sb2) {
        for (Object obj : list) {
            if (obj instanceof v90) {
                TL_iv.PageBlock pageBlock = ((v90) obj).f29044a;
    ...
    public static void z(ArrayList arrayList, List list) {
        ...
        while (it.hasNext()) {
            ...
            arrayList.add(aVar);
            ArrayList arrayList2 = aVar.f385f;
            if (arrayList2 == null) {
    ...
    public final void b(bf.c cVar) {
        ...
        for (bf.p pVar = (bf.p) cVar.f3552c; pVar != null; pVar = (bf.p) pVar.f3553f) {
    ...
    public final void f(bf.h hVar) {
        ...
        pageblockpreformatted.text = ba0.d(ba0.j(hVar.f3542k));
        String str = hVar.f3541j;
        if (str == null) {
            str = "";
        }
    ...
    public final void j(bf.l lVar) {
        TL_iv.pageBlockPreformatted pageblockpreformatted = new TL_iv.pageBlockPreformatted();
        pageblockpreformatted.text = ba0.d(ba0.j(lVar.f3547g));
    ...
    public final void k(bf.n nVar) {
        ...
        if (nVar instanceof we.a) {
            ...
            for (bf.p pVar = (bf.p) ((we.a) nVar).f3552c; pVar != null; pVar = (bf.p) pVar.f3553f) {
                boolean z11 = pVar instanceof we.e;
                if (z11 || (pVar instanceof we.b)) {
                    for (bf.p pVar2 = (bf.p) pVar.f3552c; pVar2 != null; pVar2 = (bf.p) pVar2.f3553f) {
                        if (pVar2 instanceof we.f) {
                            ArrayList<TL_iv.pageTableRow> arrayList = pageblocktable.rows;
                            TL_iv.pageTableRow pagetablerow = new TL_iv.pageTableRow();
                            for (bf.p pVar3 = (bf.p) ((we.f) pVar2).f3552c; pVar3 != null; pVar3 = (bf.p) pVar3.f3553f) {
                                if (pVar3 instanceof we.d) {
                                    ...
                                    we.c cVar = dVar.h;
                                    if (cVar == we.c.f45337b) {
                                        pagetablecell.align_center = true;
                                    } else if (cVar == we.c.f45338c) {
            ...
            pageblockparagraph.text = ba0.c(((zc.a) nVar).f49180g);
    ...
    public final void m(bf.q r9) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.x90.m(bf.q):void");
    }
    ...
    public final void x(TL_iv.PageBlock pageBlock) {
        ...
        sb2.append((char) 1);
        sb2.length();
        this.f30292c.add(new v90(length, pageBlock));
    }
    ...
    public final void y() {
        ...
        ArrayList arrayList4 = this.f30292c;
        ...
        while (i10 < size) {
            ...
            i10++;
            v90 v90Var = (v90) obj;
            hashMap.put(Integer.valueOf(v90Var.f29045b), v90Var);
        }
        ...
        while (i11 < size2) {
            ...
            treeSet.add(Integer.valueOf(aVar3.f387b));
        ...
        w90 w90Var = new w90(null, Integer.MAX_VALUE);
        ...
        while (i13 < size3) {
            ...
            while (i12 < arrayList3.size() && ((ad.a) arrayList3.get(i12)).f387b <= v90Var2.f29045b) {
                int i14 = i12 + 1;
                ad.a aVar4 = (ad.a) arrayList3.get(i12);
                int i15 = aVar4.d;
                int i16 = aVar4.f387b;
                if (i15 >= v90Var2.f29045b) {
                    while (arrayDeque.peek() != w90Var && ((w90) arrayDeque.peek()).f29987b <= i16) {
                        arrayDeque.pop();
                    }
                    w90 w90Var2 = new w90(aVar4, aVar4.d);
                    ((w90) arrayDeque.peek()).f29988c.add(w90Var2);
                    arrayDeque.push(w90Var2);
                }
                i12 = i14;
            }
            while (arrayDeque.peek() != w90Var && ((w90) arrayDeque.peek()).f29987b <= v90Var2.f29045b) {
                arrayDeque.pop();
            }
            TL_iv.PageBlock pageBlock = v90Var2.f29044a;
            ((w90) arrayDeque.peek()).f29988c.add(v90Var2);
        }
        A(0, w90Var.f29988c, this.f30290a);
    }
}
