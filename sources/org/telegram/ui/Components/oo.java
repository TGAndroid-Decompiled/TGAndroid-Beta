...
public abstract class oo extends FrameLayout {
    ...
    public int getCurrentHeight() {
        return (int) (getMeasuredHeight() * this.f27620b);
    }
    ...
    public void setShown(float f10) {
        this.f27620b = f10;
        k81 k81Var = this.f27619a;
        if (k81Var != null) {
            k81Var.setPivotX(k81Var.getWidth() / 2.0f);
            this.f27619a.setPivotY(0.0f);
            this.f27619a.setScaleX(AndroidUtilities.lerp(0.8f, 1.0f, f10));
            this.f27619a.setScaleY(AndroidUtilities.lerp(0.8f, 1.0f, f10));
        }
        setAlpha(f10);
        invalidate();
    }
