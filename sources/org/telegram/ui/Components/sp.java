...
public final class sp extends ww0 {
        ...
        switch (this.f28301a) {
            case 0:
                if (this.f28304f != i10) {
                    ...
                    this.f28305g.setColor(i10);
                }
                this.f28304f = i10;
                return;
            default:
                Paint paint = this.f28305g;
                if (paint != null) {
                    paint.setColor(i10);
                    return;
                }
    ...
    public final void d() {
        switch (this.f28301a) {
            case 0:
                this.f28303c = System.currentTimeMillis();
                this.f28302b = true;
                invalidateSelf();
                return;
            default:
    ...
    public final void draw(Canvas canvas) {
        ...
        switch (this.f28301a) {
            case 0:
                ...
                float interpolation2 = rrVar2.getInterpolation(f10);
                if (this.d) {
                    ...
                    dpf2 = (1.0f - rrVar2.getInterpolation(this.e / 2.0f)) * AndroidUtilities.dpf2(1.5f);
                } else {
                ...
                if (paint2 == null) {
                    paint2 = org.telegram.ui.ActionBar.h6.f19038c2;
                }
                ...
                if (this.f28302b) {
                    ...
                    long j3 = currentTimeMillis - this.f28303c;
                    this.f28303c = currentTimeMillis;
                    if (j3 > 50) {
                        j3 = 50;
                    }
            ...
            default:
                ...
                Paint paint3 = this.f28305g;
                if (paint3 == null) {
                    paint3 = org.telegram.ui.ActionBar.h6.f19056d2;
                }
                Paint paint4 = paint3;
                float f12 = 2.0f;
                ...
                for (int i12 = 0; i12 < 4; i12++) {
                    if (i12 == 0) {
                        paint4.setAlpha((int) (this.f28304f * this.e));
                    } else if (i12 == 3) {
                        paint4.setAlpha((int) ((1.0f - this.e) * this.f28304f));
                    } else {
                        paint4.setAlpha(this.f28304f);
                    }
                ...
                if (this.d) {
                    ...
                    long j10 = currentTimeMillis2 - this.f28303c;
                    this.f28303c = currentTimeMillis2;
                    if (j10 > 50) {
                        j10 = 50;
                    }
