...
public final class pd0 extends HorizontalScrollView {
    ...
    public final e6 J;
    public final e6 K;
    public final LinearLayout.LayoutParams f27331a;
    public final ai.n7 f27332b;
    public z4.e f27333c;
    public final LinearLayout d;
    public z4.g e;
    public int f27334f;
    public int h;
    public float f27335n;
    ...
    public pd0(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f27332b = new ai.n7(this, 2);
        this.h = 0;
        this.f27335n = 0.0f;
        this.f27337s = -10066330;
        this.v = 436207616;
        this.f27338w = false;
        this.f27339x = AndroidUtilities.dp(52.0f);
        this.f27340y = AndroidUtilities.dp(8.0f);
        ...
        this.f27331a = new LinearLayout.LayoutParams(-2, -1);
    }

    public static void a(pd0 pd0Var, int i10, int i11) {
        View childAt;
        if (pd0Var.f27334f != 0 && (childAt = pd0Var.d.getChildAt(i10)) != null) {
    ...
    public final void b(int i10, CharSequence charSequence) {
        ...
        od0Var.setOnClickListener(new ci.n4(this, i10, 11));
    ...
    public final void d() {
        ...
        this.f27334f = this.e.getAdapter().b();
        for (int i10 = 0; i10 < this.f27334f; i10++) {
    ...
    public final void e() {
        ...
        for (int i10 = 0; i10 < this.f27334f; i10++) {
            ...
            childAt.setLayoutParams(this.f27331a);
            if (this.f27338w) {
                childAt.setPadding(0, 0, 0, 0);
                childAt.setLayoutParams(new LinearLayout.LayoutParams(-1, -1, 1.0f));
            } else if (this.e.getAdapter() instanceof nd0) {
                ((gy) ((nd0) this.e.getAdapter())).getClass();
                if (i10 == 1) {
                    f7 = 12.0f;
                } else {
                    f7 = 18.0f;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float d10;
        int i10;
        if (!isInEditMode() && this.f27334f != 0) {
            ...
            if (childAt != null) {
                ...
                if (f10 > 0.0f && (i10 = this.h) < this.f27334f - 1) {
                    ...
                    if (childAt instanceof od0) {
                        ...
                        od0Var.setTextColor(od0Var.f27032a.c(AndroidUtilities.lerp(0.6f, 0.8f, 1.0f - this.f27335n)));
                    }
                    if (childAt2 instanceof od0) {
                        od0 od0Var2 = (od0) childAt2;
                        od0Var2.setTextColor(od0Var2.f27032a.c(AndroidUtilities.lerp(0.6f, 0.8f, this.f27335n)));
                    }
                } else {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f27338w && View.MeasureSpec.getMode(i10) != 0) {
    ...
    public void setIndicatorColorResource(int i10) {
        this.f27337s = getResources().getColor(i10);
        invalidate();
    }
    ...
    public void setViewPager(z4.g gVar) {
        ...
        if (gVar.getAdapter() != null) {
            gVar.setOnPageChangeListener(this.f27332b);
            d();
            return;
        }
