...
public final class by0 extends vl0 {
    ...
    public final SparseArray f23093f = new SparseArray();
    public int h;
    public int f23094n;
    public final fy0 f23095r;
    ...
    public final void l() {
        ...
        if (fy0Var.W != null) {
            ...
            sparseArray.clear();
            SparseArray sparseArray2 = this.f23093f;
            sparseArray2.clear();
            this.h = 0;
            this.f23094n = 0;
    ...
    public final void u(int i10) {
        ArrayList arrayList = this.f23095r.Y;
        if (arrayList != null) {
            this.h = arrayList.size();
        }
        super.u(i10);
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (arrayList != null) {
            ...
            ((org.telegram.ui.Cells.f8) view).d((TLRPC.Document) sparseArray.get(i10), null, this.f23093f.get(i10), null, false, false);
        } else if (fy0Var.X != null) {
            ((org.telegram.ui.Cells.f8) view).setSticker((SendMessagesHelper.ImportingSticker) fy0Var.Y.get(i10));
        } else if (c1Var.f42949f != 3) {
            org.telegram.ui.Cells.f8 f8Var = (org.telegram.ui.Cells.f8) view;
            TLRPC.TL_messages_stickerSet tL_messages_stickerSet = fy0Var.S;
            if (tL_messages_stickerSet != null) {
                f8Var.d(tL_messages_stickerSet.documents.get(i10), null, fy0Var.S, null, fy0Var.f24278h0, fy0Var.R);
        ...
        if (i10 == 0) {
            ...
            if (i10 != 1) {
                if (i10 == 2) {
                    ...
                    frameLayout2 = new org.telegram.ui.Cells.s3(8, this.f23092c, d6Var2, true, false);
                } else if (i10 == 3) {
