...
public final class v21 implements Runnable {
    ...
    public final TLObject f28909n;

    public v21(l31 l31Var, boolean z10, org.telegram.ui.ActionBar.f1 f1Var, v70 v70Var, long j3, TLRPC.User user, TLRPC.Chat chat) {
        this.d = l31Var;
        this.f28906b = z10;
        this.e = f1Var;
        this.f28908f = v70Var;
    ...
    public final void run() {
        ...
        switch (this.f28905a) {
            case 0:
                ...
                final v70 v70Var = (v70) this.f28908f;
                final TLRPC.User user = (TLRPC.User) this.h;
                final TLRPC.Chat chat = (TLRPC.Chat) this.f28909n;
                ...
                f1Var.setOnClickListener(new View.OnClickListener() {
                    ...
                    public final void onClick(View view) {
                        ...
                        ConnectionsManager.getInstance(i11).sendRequest(tL_channels_editBanned, new x1(l31Var2, 15));
                    }
                });
                return;
            default:
                yh.g.Z((yh.g) this.d, (TLRPC.TL_error) this.e, (TwoStepVerificationActivity) this.f28908f, (Activity) this.h, this.f28906b, this.f28907c, this.f28909n);
                return;
        }
    }
    ...
    public v21(yh.g gVar, TLRPC.TL_error tL_error, TwoStepVerificationActivity twoStepVerificationActivity, Activity activity, boolean z10, long j3, TLObject tLObject) {
        this.d = gVar;
        this.e = tL_error;
        this.f28908f = twoStepVerificationActivity;
        this.h = activity;
        this.f28906b = z10;
        this.f28907c = j3;
        this.f28909n = tLObject;
    }
}
