...
public final class ma0 extends ml0 {
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (!na0Var.f26429c.f42695t ? this.Y2 || q1Var == null || q1Var.e == null || !q1Var.f9903f || motionEvent.getY() >= q1Var.e.getBottom() : this.Y2 || q1Var == null || q1Var.e == null || !q1Var.f9903f || motionEvent.getY() <= q1Var.e.getTop()) {
            if (!this.X2 && org.telegram.ui.ut.q().r(motionEvent, na0Var.f26428b, null, this.f26194p2)) {
                z10 = true;
            } else {
                z10 = false;
            }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (na0Var.H) {
            ...
            na0Var.G = false;
            na0Var.H = false;
        } else if (N0 != -1 && i16 == this.Z2 && i17 - this.f26123a3 != 0) {
            na0Var.G = true;
