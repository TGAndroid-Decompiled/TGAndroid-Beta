...
public final class hs {
    public final org.telegram.ui.Cells.s2 f24723a;
    public final ArrayList f24724b = new ArrayList();
    public final ArrayList f24725c = new ArrayList();
    public gs d = null;
    ...
    public final void a(Canvas canvas, int i10) {
        ...
        if (i11 < arrayList.size()) {
            ...
            gs gsVar2 = this.d;
            if (gsVar2 == null || gsVar2.f24483a != size) {
                ?? obj = new Object();
                obj.f24483a = size;
                v01 v01Var = new v01(hg.k0.h(size, "+"), 10.0f, AndroidUtilities.bold());
                v01Var.s(this.f24723a);
                obj.f24485c = v01Var;
                int dp2 = AndroidUtilities.dp(9.32f);
                v01 v01Var2 = obj.f24485c;
                obj.e = dp2 + ((int) v01Var2.f28868c);
                v01Var2.j();
                obj.d = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19249n8, false);
                this.d = obj;
            }
            if (LocaleController.isRTL) {
