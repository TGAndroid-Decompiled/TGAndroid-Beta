...
public final class v6 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void b() {
        boolean z10;
        String str;
        TLRPC.GlobalPrivacySettings globalPrivacySettings = ContactsController.getInstance(this.f28667a).getGlobalPrivacySettings();
        ...
        SpannableStringBuilder replaceSingleTag = AndroidUtilities.replaceSingleTag(string, i10, 0, this.f28669c);
        ...
        this.f28668b.setText(AndroidUtilities.replaceCharSequence(">", replaceSingleTag, spannableString));
    }
    ...
    public final void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f28667a).addObserver(this, NotificationCenter.privacyRulesUpdated);
        b();
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        NotificationCenter.getInstance(this.f28667a).removeObserver(this, NotificationCenter.privacyRulesUpdated);
    }
