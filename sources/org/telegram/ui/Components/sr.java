...
public final class sr implements Interpolator {
    public static final sr f28339f = new sr(0.25d, 0.1d, 0.25d, 1.0d);
    public static final sr f28340g = new sr(0.0d, 0.0d, 0.58d, 1.0d);
    public static final sr h = new sr(0.23d, 1.0d, 0.32d, 1.0d);
    public static final sr f28341i = new sr(0.42d, 0.0d, 1.0d, 1.0d);
    public static final sr f28342j = new sr(0.42d, 0.0d, 0.58d, 1.0d);
    public static final sr f28343k = new sr(0.34d, 1.56d, 0.64d, 1.0d);
    public static final PathInterpolator f28344l;
    public final PointF f28345a;
    public final PointF f28346b;
    public final PointF f28347c;
    ...
    public final float getInterpolation(float f7) {
        ...
        while (true) {
            pointF = this.f28346b;
            pointF2 = this.f28345a;
            pointF3 = this.f28347c;
            pointF4 = this.d;
            pointF5 = this.e;
            if (i10 >= 14) {
                break;
    ...
    public sr(double d, double d10, double d11, double d12) {
