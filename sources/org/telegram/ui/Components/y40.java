...
public final class y40 extends org.telegram.ui.ActionBar.g3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final jj0 f30844f;
    public final x40 h;
    public boolean f30845n;
    public final gj0 f30846r;
    public final TextView[] f30847s;
    ...
    public y40(Context context, String str, org.telegram.ui.xn xnVar, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f30842b = new TextView[2];
        this.f30847s = new TextView[2];
        ...
        gj0 gj0Var = new gj0(i11, "" + R.raw.import_finish, AndroidUtilities.dp(120.0f), AndroidUtilities.dp(120.0f), false, null);
        this.f30846r = gj0Var;
        gj0Var.H(true);
        ?? imageView = new ImageView(context);
        this.f30844f = imageView;
        ...
        imageView.getAnimatedDrawable().P(178, vpVar);
        TextView textView2 = new TextView(context);
        this.f30843c = textView2;
        ...
        o80Var.setProgressColor(getThemedColor(i12));
        ...
        frameLayout2.f30542c = imageView2;
        int dp2 = AndroidUtilities.dp(20.0f);
        int i13 = org.telegram.ui.ActionBar.j6.Sh;
        imageView2.setBackground(org.telegram.ui.ActionBar.j6.K(dp2, org.telegram.ui.ActionBar.j6.v0(i13, f6Var)));
        imageView2.setScaleType(ImageView.ScaleType.CENTER);
        imageView2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i12, f6Var), PorterDuff.Mode.MULTIPLY));
        imageView2.f(R.raw.import_check, 26, 26, null);
        imageView2.setScaleX(0.8f);
        imageView2.setScaleY(0.8f);
        linearLayout.addView((View) imageView2, k7.b6.q(20, 20, 16));
        TextView textView3 = new TextView(context);
        frameLayout2.f30541b = textView3;
        textView3.setLines(1);
        textView3.setSingleLine(true);
        textView3.setGravity(1);
        textView3.setEllipsize(truncateAt);
        textView3.setGravity(17);
        textView3.setTextColor(org.telegram.ui.ActionBar.j6.v0(i13, f6Var));
        ...
        for (int i14 = 0; i14 < 2; i14++) {
            this.f30842b[i14] = new TextView(context);
            this.f30842b[i14].setTextSize(1, 16.0f);
            this.f30842b[i14].setTypeface(AndroidUtilities.bold());
            this.f30842b[i14].setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f20012j5));
            frameLayout.addView(this.f30842b[i14], k7.b6.d(-2, -2.0f, 49, 17.0f, 340.0f, 17.0f, 0.0f));
            this.f30847s[i14] = new TextView(context);
            this.f30847s[i14].setTextSize(1, 14.0f);
            this.f30847s[i14].setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f20157r5));
            this.f30847s[i14].setGravity(1);
            frameLayout.addView(this.f30847s[i14], k7.b6.d(-2, -2.0f, 49, 30.0f, 368.0f, 30.0f, 44.0f));
            if (i14 == 0) {
                this.f30847s[i14].setText(LocaleController.getString(R.string.ImportImportingInfo));
            } else {
                this.f30847s[i14].setAlpha(0.0f);
                this.f30847s[i14].setTranslationY(AndroidUtilities.dp(10.0f));
                this.f30842b[i14].setAlpha(0.0f);
                this.f30842b[i14].setTranslationY(AndroidUtilities.dp(10.0f));
            }
        }
        if (this.e != null) {
            ...
            this.f30843c.setText(String.format("%d%%", Integer.valueOf(importingHistory.uploadProgress)));
            this.d.a(importingHistory.uploadProgress / 100.0f, false);
            this.f30842b[0].setText(LocaleController.formatString("ImportCount", R.string.ImportCount, AndroidUtilities.formatFileSize(importingHistory.getUploadedCount()), AndroidUtilities.formatFileSize(importingHistory.getTotalCount())));
            this.f30847s[1].setText(LocaleController.getString(R.string.ImportDoneInfo));
            this.f30842b[1].setText(LocaleController.getString(R.string.ImportDoneTitle));
        ...
        this.f30843c.setText(String.format("%d%%", Integer.valueOf(importingStickers.uploadProgress)));
        this.d.a(importingStickers.uploadProgress / 100.0f, false);
        this.f30842b[0].setText(LocaleController.formatString("ImportCount", R.string.ImportCount, AndroidUtilities.formatFileSize(importingStickers.getUploadedCount()), AndroidUtilities.formatFileSize(importingStickers.getTotalCount())));
        this.f30847s[1].setText(LocaleController.getString(R.string.ImportStickersDoneInfo));
        this.f30842b[1].setText(LocaleController.getString(R.string.ImportStickersDoneTitle));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        o80 o80Var = this.d;
        TextView[] textViewArr = this.f30842b;
        TextView textView = this.f30843c;
        jj0 jj0Var = this.f30844f;
        if (i10 == i12) {
            if (objArr.length > 1) {
                dismiss();
                return;
            ...
            if (!this.f30845n && ((180 - jj0Var.getAnimatedDrawable().Y) * 16.6d) + 3000.0d >= importingHistory.timeUntilFinish) {
            ...
            if (!this.f30845n && ((180 - jj0Var.getAnimatedDrawable().Y) * 16.6d) + 3000.0d >= importingStickers.timeUntilFinish) {
                jj0Var.setAutoRepeat(false);
                this.f30845n = true;
            }
    ...
    public final void m() {
        this.f30845n = true;
        this.f30844f.setAutoRepeat(false);
        x40 x40Var = this.h;
        ...
        TextView[] textViewArr = this.f30847s;
        ...
        TextView[] textViewArr2 = this.f30842b;
        ...
        x40Var.f30540a.animate().scaleY(1.0f).setInterpolator(new OvershootInterpolator(1.02f)).setDuration(250L).start();
        x40Var.f30542c.animate().scaleY(1.0f).scaleX(1.0f).setInterpolator(new OvershootInterpolator(1.02f)).setDuration(250L).start();
        x40Var.f30542c.d();
        animatorSet.start();
    }
}
