...
public final class u01 extends ReplacementSpan {
    public static final int f28664f = 0;
    public ImageReceiver f28665a;
    public int f28666b;
    public int f28667c;
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        int i15 = this.f28666b;
        int i16 = this.f28667c;
        ImageReceiver imageReceiver = this.f28665a;
        canvas.save();
        if (this.d) {
