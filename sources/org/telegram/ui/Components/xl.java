...
public final class xl extends cm {
    public final ChatAttachAlertPhotoLayout f29933b;

    public xl(ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout) {
        super(chatAttachAlertPhotoLayout);
        this.f29933b = chatAttachAlertPhotoLayout;
    }

    @Override
    public final boolean A() {
        vi viVar = this.f29933b.f26463b;
        if (viVar != null && viVar.f28735c0) {
            return true;
        }
        return false;
    }
    ...
    public final void D() {
        ...
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.f29933b;
    ...
    public final org.telegram.ui.fv0 E(MessageObject messageObject, TLRPC.FileLocation fileLocation, int i10, boolean z10, boolean z11) {
        ...
        if (z11 && (qtVar = viVar.R0) != null && (closeIntoObject = ((t40) qtVar.f27402b).getCloseIntoObject()) != null) {
        ...
        if (L != null) {
            ...
            fv0Var.f33774k = L.getScale();
            fv0Var.f33772i = (int) viVar.l1();
            L.g(false);
            return fv0Var;
        }
        return null;
    ...
    public final void F(boolean z10) {
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.f29933b;
        vi viVar = chatAttachAlertPhotoLayout.f26463b;
        if (viVar != null && viVar.f28735c0 != z10) {
            viVar.H1(z10, true);
            chatAttachAlertPhotoLayout.f21923d1.a(!chatAttachAlertPhotoLayout.f26463b.f28735c0, true);
        }
    }

    @Override
    public final void G() {
        tl tlVar = this.f29933b.E;
    ...
    public final void Z(int i10) {
        org.telegram.ui.Cells.s5 L = ChatAttachAlertPhotoLayout.L(this.f29933b, i10);
        if (L != null) {
            L.g(true);
        }
    }
    ...
    @Override
    public final long a() {
        org.telegram.ui.ActionBar.o2 o2Var = this.f29933b.f26463b.f28745f0;
    ...
    public final void e(CharSequence charSequence) {
        ...
        if (hashMap.size() > 0) {
            ...
            if (arrayList2.size() > 0) {
                ...
                this.f29933b.f26463b.m1().setText(x5.cloneSpans(charSequence2, 3));
            }
        }
    }
    ...
    public final void o(int i10, VideoEditedInfo videoEditedInfo, boolean z10, int i11, int i12, boolean z11) {
        ...
        if (!viVar.b1(viVar.m1().getText())) {
                ...
                if (!hashMap.isEmpty()) {
                    for (int i13 = 0; i13 < arrayList.size(); i13++) {
                        ...
                        if (obj instanceof MediaController.PhotoEntry) {
                            MediaController.PhotoEntry photoEntry = (MediaController.PhotoEntry) obj;
                            if (i13 == 0) {
                                CharSequence[] charSequenceArr = {PhotoViewer.t1().f31063q7};
            ...
            c5.a0(viVar.J1, viVar.j1() + ChatAttachAlertPhotoLayout.f21913s1.size(), viVar.n1(), new pl(this, z10, i11, z11));
        }
    }
