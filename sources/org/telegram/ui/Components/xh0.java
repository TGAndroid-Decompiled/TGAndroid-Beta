...
public final class xh0 extends Button {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Paint paint = this.f29937b;
        paint.setAlpha(min);
        canvas.drawArc(rectF, this.f29939f, 220.0f, false, paint);
        long currentTimeMillis = System.currentTimeMillis();
        if (Math.abs(this.e - System.currentTimeMillis()) < 1000) {
            long j3 = currentTimeMillis - this.e;
            int i10 = (int) (this.f29939f + (((float) (360 * j3)) / 2000.0f));
            this.f29939f = i10 - ((i10 / 360) * 360);
            if (this.f29938c) {
                float f7 = this.d;
                if (f7 < 1.0f) {
