...
public final class xh0 extends vp {
    public final ArrayList f30266c = new ArrayList();
    public final ArrayList d = new ArrayList();
    public final Context e;
    public final Paint f30267f;
    public v9 f30268g;
    public final yh0 h;
    ...
    public final int c(Object obj) {
        int indexOf = this.f30266c.indexOf((uh0) obj);
        if (indexOf == -1) {
            return -2;
        }
        return indexOf;
    ...
    public final boolean f(View view, Object obj) {
        uh0 uh0Var = (uh0) obj;
        if (uh0Var.f28681a) {
            if (view == uh0Var.f28682b) {
                return true;
            }
            return false;
        } else if (view == uh0Var.f28683c) {
            return true;
        } else {
            return false;
        }
    ...
    public final void g() {
        ...
        ArrayList arrayList2 = this.f30266c;
        arrayList2.clear();
        arrayList.clear();
        yh0 yh0Var = this.h;
