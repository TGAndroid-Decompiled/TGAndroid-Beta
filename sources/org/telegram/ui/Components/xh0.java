...
public final class xh0 extends Button {
    public final RectF f32571a;
    public final Paint f32572b;
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        if (this.f32573c != z10) {
            ...
            this.f32574e = System.currentTimeMillis();
            invalidate();
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        paint.setAlpha(min);
        canvas.drawArc(rectF, this.f32575f, 220.0f, false, paint);
        long currentTimeMillis = System.currentTimeMillis();
        if (Math.abs(this.f32574e - System.currentTimeMillis()) < 1000) {
            long j3 = currentTimeMillis - this.f32574e;
            int i10 = (int) (this.f32575f + (((float) (360 * j3)) / 2000.0f));
            this.f32575f = i10 - ((i10 / 360) * 360);
            if (this.f32573c) {
                float f7 = this.d;
                if (f7 < 1.0f) {
