...
public final class ya0 implements org.telegram.ui.Cells.j1 {
    ...
    public final CharacterStyle F1(org.telegram.ui.Cells.s1 s1Var) {
        ab0 ab0Var = this.f34874a.f35217c;
        if (ab0Var.f26712a != 2) {
            return null;
        }
    ...
    public final void R0(org.telegram.ui.Cells.s1 s1Var, CharacterStyle characterStyle, boolean z10) {
        za0 za0Var = this.f34874a;
        ab0 ab0Var = za0Var.f35217c;
        if (ab0Var.f26712a != 2 || ab0Var.V.d.currentLink == characterStyle || s1Var.getMessageObject() == null || !(characterStyle instanceof URLSpan)) {
            return;
        }
        String url = ((URLSpan) characterStyle).getURL();
        gb0 gb0Var = za0Var.f35217c.V;
        ...
        org.telegram.ui.rn rnVar = gb0Var.f28582c;
        if (rnVar != null && url != null) {
            rnVar.Ya(url, true);
        }
        ab0.b(za0Var.f35217c, s1Var);
    }
    ...
    public final org.telegram.ui.Cells.k9 o2() {
        return this.f34874a.f35217c.f26715e;
    }
