...
public final class rl0 extends Drawable implements Animator.AnimatorListener {
    ...
    public ColorFilter f27645b;
    public Drawable d;
    public Drawable e;
    public ValueAnimator f27647f;
    public boolean f27649r;
    public int f27646c = 0;
    public float h = 1.0f;
    public final ArrayList f27648n = new ArrayList();
    ...
    public final void a(int i10, boolean z10) {
        ...
        b(this.f27644a.getDrawable(i10).mutate(), z10);
        this.f27646c = i10;
    }
    ...
    public final void b(Drawable drawable, boolean z10) {
        ...
        if (drawable == drawable2) {
            drawable2.setColorFilter(this.f27645b);
            return;
        }
        this.f27646c = 0;
        this.e = drawable2;
        this.d = drawable;
        drawable.setColorFilter(this.f27645b);
        c(this.d, getBounds());
        c(this.e, getBounds());
        ValueAnimator valueAnimator = this.f27647f;
        ...
        this.f27647f = ofFloat;
        ofFloat.addUpdateListener(new h70(this, 10));
        this.f27647f.addListener(this);
        this.f27647f.setDuration(150L);
        this.f27647f.start();
    }
    ...
    public final void invalidateSelf() {
        ...
        ArrayList arrayList = this.f27648n;
        if (arrayList != null) {
