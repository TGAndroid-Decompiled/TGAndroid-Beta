...
public final class rl0 extends Drawable implements Animator.AnimatorListener {
    ...
    public ColorFilter f27642b;
    public Drawable d;
    public Drawable e;
    public ValueAnimator f27644f;
    public boolean f27646r;
    public int f27643c = 0;
    public float h = 1.0f;
    public final ArrayList f27645n = new ArrayList();
    ...
    public final void a(int i10, boolean z10) {
        ...
        b(this.f27641a.getDrawable(i10).mutate(), z10);
        this.f27643c = i10;
    }
    ...
    public final void b(Drawable drawable, boolean z10) {
        ...
        if (drawable == drawable2) {
            drawable2.setColorFilter(this.f27642b);
            return;
        }
        this.f27643c = 0;
        this.e = drawable2;
        this.d = drawable;
        drawable.setColorFilter(this.f27642b);
        c(this.d, getBounds());
        c(this.e, getBounds());
        ValueAnimator valueAnimator = this.f27644f;
        ...
        this.f27644f = ofFloat;
        ofFloat.addUpdateListener(new h70(this, 10));
        this.f27644f.addListener(this);
        this.f27644f.setDuration(150L);
        this.f27644f.start();
    }
