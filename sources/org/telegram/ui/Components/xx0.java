...
public final class xx0 extends FrameLayout {
    ...
    public xx0(fy0 fy0Var, Context context) {
        super(context);
        this.e = fy0Var;
        this.f30415b = new RectF();
    }

    @Override
    public final void onDraw(android.graphics.Canvas r14) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.xx0.onDraw(android.graphics.Canvas):void");
    }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            fy0 fy0Var = this.e;
            if (fy0Var.f24274e0 != 0 && motionEvent.getY() < fy0Var.f24274e0) {
                fy0Var.dismiss();
                return true;
            }
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        fy0Var.f24277g0 = false;
        if (fy0Var.s0()) {
            int measuredWidth = fy0Var.f24271c.getMeasuredWidth();
            if (measuredWidth == 0) {
        ...
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) fy0Var.f24271c.getLayoutParams();
        int i23 = 3;
        if (arrayList != null) {
            ...
            if (fy0Var.W != null) {
                ...
                i17 = i19 + (fy0Var.d.f23094n * fy0Var.P) + size3;
                ...
                int max2 = (Math.max(i23, i14) * fy0Var.P) + dp;
                i15 = ((org.telegram.ui.ActionBar.e3) fy0Var).backgroundPaddingTop;
                i16 = i15 + max2;
        ...
        if (fy0Var.f24271c.getPaddingTop() != i20) {
            fy0Var.f24277g0 = true;
            fy0Var.f24271c.setPadding(AndroidUtilities.dp(10.0f), i20, AndroidUtilities.dp(10.0f), AndroidUtilities.dp(8.0f));
