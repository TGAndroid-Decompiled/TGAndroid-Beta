...
public final class s implements org.telegram.ui.ActionBar.a2, kl0, yc0, zc0, ad0, le.f, ImageReceiver.ImageReceiverDelegate, c5, r0.n, uh.a, t0.e, ll0, CameraController.VideoTakeCallback, org.telegram.ui.Cells.s5, ai.fc, org.telegram.ui.ActionBar.r0, org.telegram.ui.ActionBar.l1, vh.l {
    ...
    public r0.l1 P0(View view, r0.l1 l1Var) {
        ...
        jb jbVar = ((kb) this.f27987b).f25727a;
        if (jbVar != null) {
    ...
    public void c(float f7, float f10, int i10, View view) {
        g0.P((g0) this.f27987b, view, i10, f7);
    }
    ...
    public void k(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        switch (this.f27986a) {
            case 0:
                y.S((y) this.f27987b, b2Var);
                return;
            case 2:
                ((org.telegram.ui.ActionBar.n5) this.f27987b).run();
                return;
            case 3:
                ((ai.j) this.f27987b).run();
                return;
            case 4:
                ((ai.cb) this.f27987b).run();
                return;
            case 5:
                ((t1) this.f27987b).run();
                return;
            ...
            case 19:
                ...
                return;
            case 23:
                ((un) this.f27987b).f26655b.dismiss();
                return;
            case 24:
                ((xm) this.f27987b).f30307a.E.r();
                return;
            default:
                ((hu) this.f27987b).f24759a.d.r();
                return;
        }
    }
    ...
    public void l(vh.h hVar, float f7, float f10) {
        ((du) this.f27987b).c(hVar, f7, f10);
    }

    @Override
    public void m(int i10) {
        lq lqVar = ((mq) this.f27987b).f26464a;
        boolean z10 = true;
        if (i10 != 1 && i10 != 2) {
            if (i10 == 3) {
                lqVar.y();
    ...
    public void o(KeyEvent keyEvent) {
        org.telegram.ui.ActionBar.n1 n1Var = ((xr) this.f27987b).f30353a;
    ...
    public void onFinishVideoRecording(String str, long j3) {
        ...
        rl rlVar = (rl) this.f27987b;
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = rlVar.e;
        vi viVar = chatAttachAlertPhotoLayout.f26655b;
        if (rlVar.f27916a != null && !viVar.V && chatAttachAlertPhotoLayout.P != null) {
            ChatAttachAlertPhotoLayout.f22119q1 = false;
            try {
            ...
            try {
                ...
                i11 = 0;
                int i12 = i10;
                int i13 = ChatAttachAlertPhotoLayout.f22123u1;
                ChatAttachAlertPhotoLayout.f22123u1 = i13 - 1;
                photoEntry = new MediaController.PhotoEntry(0, i13, 0L, rlVar.f27916a.getAbsolutePath(), 0, true, i12, i11, 0L);
            ...
            int i122 = i10;
            int i132 = ChatAttachAlertPhotoLayout.f22123u1;
            ChatAttachAlertPhotoLayout.f22123u1 = i132 - 1;
            photoEntry = new MediaController.PhotoEntry(0, i132, 0L, rlVar.f27916a.getAbsolutePath(), 0, true, i122, i11, 0L);
            photoEntry.duration = (int) (((float) j3) / 1000.0f);
            photoEntry.thumbPath = str;
    ...
    public void p(Canvas canvas, int i10) {
        ((tb) this.f27987b).dispatchDrawImplBlur(canvas, i10);
    }

    @Override
    public void q(cd0 cd0Var, int i10) {
        org.telegram.ui.Cells.v3 v3Var = (org.telegram.ui.Cells.v3) this.f27987b;
        try {
            if (i10 == 0) {
