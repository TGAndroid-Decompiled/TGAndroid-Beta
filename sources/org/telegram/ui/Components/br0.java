...
public final class br0 extends View {
    public Random f23063a;
    public Paint f23064b;
    public Paint f23065c;
    public Paint d;
    public Paint e;
    ...
    public final void onDraw(Canvas canvas) {
        float f7;
        Paint paint = this.f23065c;
        Paint paint2 = this.f23064b;
        super.onDraw(canvas);
        ...
        float f12 = (this.f23067n * interpolation) + ((1.0f - interpolation) * this.h);
        canvas.save();
        canvas.translate(0.0f, (-org.telegram.messenger.q.B(4.0f, getMeasuredHeight(), dp)) * f12);
        int i11 = 0;
        while (i11 < i10) {
            ...
            rectF.set(AndroidUtilities.dp(1.0f) + measuredWidth, f13, org.telegram.messenger.q.D(1.0f, measuredWidth, measuredWidth), f14);
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f), paint2);
            i11++;
            i10 = 7;
            f10 = 3.0f;
        ...
        float f15 = this.f23066f + 0.016f;
        this.f23066f = f15;
        if (f15 > 1.0f) {
            this.h = this.f23067n;
            float d = org.telegram.ui.Cells.c1.d(this.f23063a, 1001) / 1000.0f;
            this.f23067n = d;
            if (d > this.h) {
                this.f23067n = d + 0.3f;
            } else {
            ...
            this.f23067n = Math.max(0.0f, Math.min(1.0f, this.f23067n));
            this.f23066f = 0.0f;
        }
        invalidate();
    }
