...
public final class br0 implements Runnable {
    ...
    public final void run() {
        switch (this.f22862a) {
            case 0:
                org.telegram.ui.ActionBar.b2[] b2VarArr = this.f22863b;
                org.telegram.ui.ActionBar.b2 b2Var = b2VarArr[0];
                if (b2Var != null) {
                    final int i10 = this.f22864c;
                ...
                return;
            default:
                org.telegram.ui.ActionBar.b2[] b2VarArr2 = this.f22863b;
                org.telegram.ui.ActionBar.b2 b2Var2 = b2VarArr2[0];
                if (b2Var2 != null) {
                    final int i12 = this.f22864c;
