...
public final class br0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public yq0 G;
    public ar0 H;
    public final zq0[] f23078a;
    public int f23079b;
    public int f23080c;
    public long d;
    public ArrayList e;
    public final ArrayList f23081f;
    public boolean h;
    public boolean f23082n;
    public String f23083r;
    public final ArrayList f23084s;
    public final HashMap v;
    public TLRPC.WebPage f23085w;
    public int f23086x;
    public int f23087y;

    public br0(Activity activity, org.telegram.ui.ActionBar.f6 f6Var) {
        super(activity);
        this.f23078a = new zq0[2];
        this.f23079b = 0;
        this.f23081f = new ArrayList();
        this.f23082n = true;
        this.f23084s = new ArrayList();
        this.v = new HashMap();
        int i10 = 0;
        while (true) {
            zq0[] zq0VarArr = this.f23078a;
            if (i10 < zq0VarArr.length) {
                zq0VarArr[i10] = new zq0(this, activity, f6Var);
                addView(this.f23078a[i10], w7.y5.c(-1.0f, -1));
                i10++;
            } else {
                zq0VarArr[0].setVisibility(0);
                this.f23078a[1].setVisibility(8);
                return;
            }
        }
    }
    ...
    public static void a(zq0 zq0Var, TLRPC.WebPage webPage, String str) {
        ImageView imageView = zq0Var.f30939b;
        v9 v9Var = zq0Var.f30942n;
        imageView.setImageResource(R.drawable.msg_link2);
        zq0Var.f30939b.setVisibility(0);
        zq0Var.f30941f.setVisibility(8);
        zq0Var.f30943r.setVisibility(0);
        ...
        zq0Var.f30938a.setClickable(false);
    }
    ...
    public final String c(zq0 zq0Var) {
        int measuredWidth;
        String shortName;
        ArrayList arrayList = this.f23081f;
        ...
        while (i10 < size) {
            ...
            if (longValue == this.d) {
                ...
                if (arrayList.size() == 1) {
                    shortName = DialogObject.getName(this.f23080c, longValue);
                } else {
                    shortName = DialogObject.getShortName(this.f23080c, longValue);
                }
    ...
    public final void d() {
        if (this.f23086x != 0) {
            AccountInstance.getInstance(this.f23080c).getConnectionsManager().cancelRequest(this.f23086x, true);
            this.f23086x = 0;
        }
        this.f23087y++;
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        String str;
        if (i10 == NotificationCenter.didReceivedWebpagesInUpdates && this.f23085w != null && i11 == this.f23080c) {
            a0.i iVar = (a0.i) objArr[0];
            for (int i12 = 0; i12 < iVar.m(); i12++) {
                TLRPC.WebPage webPage = (TLRPC.WebPage) iVar.n(i12);
                if (webPage != null && webPage.f18496id == this.f23085w.f18496id) {
    ...
    public final v9 f(int i10) {
        v9[] v9VarArr;
        if (this.f23079b == 1 && (v9VarArr = this.f23078a[0].h) != null && i10 >= 0 && i10 < v9VarArr.length && v9VarArr[i10].getVisibility() == 0) {
            return v9VarArr[i10];
        }
        return null;
    }
    ...
    public final void h(int i10) {
        if (this.f23080c == i10) {
            ...
            if (isAttachedToWindow()) {
                NotificationCenter.getInstance(this.f23080c).addObserver(this, NotificationCenter.didReceivedWebpagesInUpdates);
                return;
            }
            return;
        }
        if (isAttachedToWindow()) {
            NotificationCenter.getInstance(this.f23080c).removeObserver(this, NotificationCenter.didReceivedWebpagesInUpdates);
        }
        this.f23080c = i10;
        if (isAttachedToWindow()) {
            NotificationCenter.getInstance(this.f23080c).addObserver(this, NotificationCenter.didReceivedWebpagesInUpdates);
    ...
    public final void i(int i10, ArrayList arrayList) {
        ...
        org.telegram.ui.ActionBar.j5 j5Var2 = zq0Var.f30940c;
        imageView.setImageResource(R.drawable.filled_forward);
        zq0Var.f30939b.setVisibility(0);
        zq0Var.f30942n.setVisibility(8);
        zq0Var.f30941f.setVisibility(0);
        zq0Var.f30943r.setVisibility(8);
        zq0Var.f30938a.setClickable(true);
        ...
        int i16 = this.f23079b;
        if (i12 != i16 && (ar0Var = this.H) != null) {
            ((org.telegram.ui.xv) ar0Var).g(i16);
        }
    }
    ...
    public void setLayoutClickListener(View.OnClickListener onClickListener) {
        for (zq0 zq0Var : this.f23078a) {
            zq0Var.f30938a.setOnClickListener(onClickListener);
        }
    }
