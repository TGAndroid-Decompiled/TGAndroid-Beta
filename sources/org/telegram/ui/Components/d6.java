...
public final class d6 extends BitmapDrawable implements Animatable, yf.c {
    ...
    public final RectF f23430a0;
    public boolean f23431b;
    public volatile boolean f23432b0;
    public int f23433c;
    public volatile boolean f23434c0;
    public final int[] d;
    public volatile AnimatedFileNative f23435d0;
    public b6 e;
    public boolean f23436e0;
    public boolean f23437f;
    public DispatchQueue f23438f0;
    public float f23439g0;
    public final ArrayList h;
    public float f23440h0;
    public int f23441i0;
    public int f23442j0;
    public final boolean f23443k0;
    public final boolean f23444l0;
    public float m0;
    public a6 f23445n;
    public boolean f23446n0;
    public final TLRPC.Document f23447o0;
    public final RectF[] f23448p0;
    public final Paint[] f23449q0;
    public a6 f23450r;
    public WeakReference f23451r0;
    public a6 f23452s;
    public final pe.b f23453s0;
    public final pe.b f23454t0;
    public AnimatedFileDrawableStream f23455u0;
    public a6 v;
    public boolean f23456v0;
    public boolean f23457w;
    public boolean f23458w0;
    public boolean f23459x;
    public boolean f23460x0;
    public boolean f23461y;
    public int f23462y0;
    public final yf.e f23463z0;
    ...
    public final void B(int[] iArr) {
        boolean isEmpty = this.f23453s0.isEmpty();
        int[] iArr2 = this.T;
        if (!isEmpty) {
            if (this.U == null) {
                this.U = new int[4];
        ...
        for (int i10 = 0; i10 < 4; i10++) {
            if (!this.f23458w0 && iArr[i10] != iArr2[i10]) {
                this.f23458w0 = true;
            }
            iArr2[i10] = iArr[i10];
        }
    ...
    public final void C(long j3, long j10) {
        this.f23439g0 = ((float) j3) / 1000.0f;
        this.f23440h0 = ((float) j10) / 1000.0f;
        if (j3 >= 0 && o() < j3) {
            y(j3, true, false);
        }
    }
    ...
    public final void D(long j3) {
        ...
        if (!this.T0 && (this.f23432b0 || !this.f23461y)) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (this.f23432b0) {
            a6 a6Var = this.f23445n;
            if (a6Var == null && this.f23450r == null) {
                x(false);
            } else if (this.f23450r != null) {
                if (a6Var == null || (z10 && !this.f23429a && this.M < 0)) {
                    a6 a6Var2 = this.f23445n;
                    if (a6Var2 != null) {
                        this.h.add(a6Var2);
                    }
                    this.f23445n = this.f23450r;
                    this.f23450r = this.f23452s;
                    this.f23452s = null;
                    this.T0 = false;
                    x(false);
                }
            }
        } else if (!this.f23432b0 && this.f23461y && z10 && this.f23450r != null) {
            a6 a6Var3 = this.f23445n;
            if (a6Var3 != null) {
                this.h.add(a6Var3);
            }
            this.f23445n = this.f23450r;
    ...
    public final void E() {
        ...
        int i12;
        int i13;
        if (!this.f23446n0 && (i10 = this.f23441i0) > 0 && (i11 = this.f23442j0) > 0 && (i12 = (iArr = this.d)[0]) > 0 && (i13 = iArr[1]) > 0) {
    ...
    public final int a(Bitmap bitmap) {
        ...
        this.N0.c(this.M0, false, this.f23439g0, this.f23440h0, this.f23443k0);
        long j3 = this.L0;
        ...
        bitmap.eraseColor(0);
        canvas.save();
        float width = this.f23442j0 / this.M0.getWidth();
    ...
    @Override
    public final void b() {
        this.N0 = AnimatedFileNative.a(this.G.getAbsolutePath(), this.d, this.J, this.H, this.f23455u0, false);
    }
    ...
    public final void d() {
        int i10;
        if (this.f23442j0 == 0 && this.f23441i0 == 0) {
            int[] iArr = this.d;
            int i11 = iArr[0];
    ...
    public final void e(ImageReceiver imageReceiver) {
        if (this.f23454t0.add(imageReceiver) && this.f23432b0) {
            x(false);
        }
        h();
    }
    ...
    public final boolean g() {
        if (this.f23444l0) {
            if (this.f23463z0 == null) {
                return false;
            }
            return true;
        } else if (this.f23435d0 == null && this.f23459x) {
            return false;
        } else {
            return true;
        }
    ...
    public final void h() {
        b6 b6Var;
        if (this.f23463z0 != null) {
            boolean isEmpty = this.f23454t0.isEmpty();
    ...
    public final void i() {
        int i10;
        if (this.f23432b0 && !this.R0 && !this.f23437f) {
    ...
    public final void k() {
        if (!g()) {
            a6 a6Var = this.f23445n;
            if (a6Var != null) {
                a6Var.f22506b.recycle();
                Arrays.fill(a6Var.f22505a, (Object) null);
                this.f23445n = null;
            }
            a6 a6Var2 = this.v;
            if (a6Var2 != null) {
                a6Var2.f22506b.recycle();
                Arrays.fill(a6Var2.f22505a, (Object) null);
                this.v = null;
            }
            DispatchQueue dispatchQueue = this.f23438f0;
            ...
            while (true) {
                ...
                if (i10 < arrayList.size()) {
                    ...
                    a6Var3.f22506b.recycle();
                    Arrays.fill(a6Var3.f22505a, (Object) null);
                    i10++;
                } else {
                    arrayList.clear();
                    t();
    ...
    public final Bitmap m() {
        a6 a6Var = this.f23445n;
        if (a6Var != null) {
            return a6Var.f22506b;
        }
        a6 a6Var2 = this.f23450r;
        if (a6Var2 != null) {
            return a6Var2.f22506b;
        }
        a6 a6Var3 = this.f23452s;
        if (a6Var3 != null) {
            return a6Var3.f22506b;
        }
        return null;
    }
    ...
    public final Bitmap p() {
        int i10 = this.f23442j0;
        int i11 = this.f23441i0;
        Bitmap.Config config = Bitmap.Config.ARGB_8888;
        Bitmap createBitmap = Bitmap.createBitmap(i10, i11, config);
        Canvas canvas = new Canvas(createBitmap);
        AnimatedFileNative a2 = AnimatedFileNative.a(this.G.getAbsolutePath(), this.d, this.J, this.H, this.f23455u0, false);
        if (a2 == null) {
            return createBitmap;
        }
        if (this.M0 == null) {
        ...
        a2.c(this.M0, false, this.f23439g0, this.f23440h0, true);
        a2.f();
    ...
    public final Bitmap q(long j3, boolean z10) {
        int c10;
        if (this.f23459x && this.f23435d0 != null) {
            AnimatedFileDrawableStream animatedFileDrawableStream = this.f23455u0;
            if (animatedFileDrawableStream != null) {
                animatedFileDrawableStream.cancel(false);
                this.f23455u0.reset();
            }
            if (!z10) {
                this.f23435d0.g(j3, z10);
            }
            int[] iArr = this.d;
            Bitmap createBitmap = Bitmap.createBitmap(iArr[0], iArr[1], Bitmap.Config.ARGB_8888);
            if (z10) {
                c10 = this.f23435d0.b(createBitmap, j3);
            } else {
                c10 = this.f23435d0.c(createBitmap, true, 0.0f, 0.0f, true);
            }
            if (c10 != 0) {
                return createBitmap;
            }
    ...
    public final Bitmap r(boolean z10) {
        ...
        this.f23435d0.c(this.v.f22506b, false, this.f23439g0, this.f23440h0, z10);
        return this.v.f22506b;
    }

    public final boolean s() {
        if (g()) {
            if (this.f23445n != null || this.f23450r != null) {
                return true;
            }
            return false;
        }
    ...
    public final void start() {
        if (!this.f23432b0 && !this.f23454t0.isEmpty()) {
            this.f23432b0 = true;
            this.R0 = false;
            x(false);
    ...
    public final void t() {
        Iterator it = this.f23454t0.iterator();
        while (it.hasNext()) {
    ...
    public final void u() {
        ...
        if (this.e == null) {
            ...
            a6 a6Var = this.f23445n;
            if (a6Var != null) {
                arrayList.add(a6Var.f22506b);
            }
            a6 a6Var2 = this.f23450r;
            if (a6Var2 != null) {
                arrayList.add(a6Var2.f22506b);
            }
            a6 a6Var3 = this.f23452s;
            if (a6Var3 != null) {
                arrayList.add(a6Var3.f22506b);
            }
            a6 a6Var4 = this.v;
            if (a6Var4 != null) {
                arrayList.add(a6Var4.f22506b);
            }
    ...
    public final void x(boolean z10) {
        ...
        b6 b6Var2;
        if (this.e == null || z10) {
            if ((this.f23431b && (this.f23452s == null || (!this.K0 && this.M >= 0))) || this.f23450r == null) {
                if ((this.f23445n == null || !this.f23437f) && g() && !this.f23457w) {
                    if ((this.f23432b0 || (this.f23461y && !this.E)) && !this.f23454t0.isEmpty() && !this.C0) {
                        if (this.f23456v0) {
                            if (this.f23460x0) {
                                b6 b6Var3 = this.H0;
                                this.e = b6Var3;
                            ...
                            if (this.f23438f0 == null) {
                                this.f23438f0 = new DispatchQueue("decodeQueue" + this);
                            }
                            if (z10 && (b6Var = this.e) != null) {
                                this.f23438f0.cancelRunnable(b6Var);
                            }
                            DispatchQueue dispatchQueue = this.f23438f0;
                            b6 b6Var5 = this.H0;
                            this.e = b6Var5;
    ...
    public final void y(long j3, boolean z10, boolean z11) {
        ...
        synchronized (this.Q) {
            try {
                ...
                if (this.f23459x && (animatedFileDrawableStream = this.f23455u0) != null) {
