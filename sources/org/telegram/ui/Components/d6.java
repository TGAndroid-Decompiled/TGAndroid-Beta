...
public final class d6 extends BitmapDrawable implements Animatable, yf.c {
    ...
    public final RectF f23251a0;
    public boolean f23252b;
    public volatile boolean f23253b0;
    public int f23254c;
    public volatile boolean f23255c0;
    public final int[] d;
    public volatile AnimatedFileNative f23256d0;
    public b6 e;
    public boolean f23257e0;
    public boolean f23258f;
    public DispatchQueue f23259f0;
    public float f23260g0;
    public final ArrayList h;
    public float f23261h0;
    public int f23262i0;
    public int f23263j0;
    public final boolean f23264k0;
    public final boolean f23265l0;
    public float m0;
    public a6 f23266n;
    public boolean f23267n0;
    public final TLRPC.Document f23268o0;
    public final RectF[] f23269p0;
    public final Paint[] f23270q0;
    public a6 f23271r;
    public WeakReference f23272r0;
    public a6 f23273s;
    public final pe.b f23274s0;
    public final pe.b f23275t0;
    public AnimatedFileDrawableStream f23276u0;
    public a6 v;
    public boolean f23277v0;
    public boolean f23278w;
    public boolean f23279w0;
    public boolean f23280x;
    public boolean f23281x0;
    public boolean f23282y;
    public int f23283y0;
    public final yf.e f23284z0;
    ...
    public final void B(int[] iArr) {
        boolean isEmpty = this.f23274s0.isEmpty();
        int[] iArr2 = this.T;
        if (!isEmpty) {
            if (this.U == null) {
                this.U = new int[4];
        ...
        for (int i10 = 0; i10 < 4; i10++) {
            if (!this.f23279w0 && iArr[i10] != iArr2[i10]) {
                this.f23279w0 = true;
            }
            iArr2[i10] = iArr[i10];
        }
    ...
    public final void C(long j3, long j10) {
        this.f23260g0 = ((float) j3) / 1000.0f;
        this.f23261h0 = ((float) j10) / 1000.0f;
        if (j3 >= 0 && o() < j3) {
            y(j3, true, false);
        }
    }
    ...
    public final void D(long j3) {
        ...
        if (!this.T0 && (this.f23253b0 || !this.f23282y)) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (this.f23253b0) {
            a6 a6Var = this.f23266n;
            if (a6Var == null && this.f23271r == null) {
                x(false);
            } else if (this.f23271r != null) {
                if (a6Var == null || (z10 && !this.f23250a && this.M < 0)) {
                    a6 a6Var2 = this.f23266n;
                    if (a6Var2 != null) {
                        this.h.add(a6Var2);
                    }
                    this.f23266n = this.f23271r;
                    this.f23271r = this.f23273s;
                    this.f23273s = null;
                    this.T0 = false;
                    x(false);
                }
            }
        } else if (!this.f23253b0 && this.f23282y && z10 && this.f23271r != null) {
            a6 a6Var3 = this.f23266n;
            if (a6Var3 != null) {
                this.h.add(a6Var3);
            }
            this.f23266n = this.f23271r;
    ...
    public final void E() {
        ...
        int i12;
        int i13;
        if (!this.f23267n0 && (i10 = this.f23262i0) > 0 && (i11 = this.f23263j0) > 0 && (i12 = (iArr = this.d)[0]) > 0 && (i13 = iArr[1]) > 0) {
    ...
    public final int a(Bitmap bitmap) {
        ...
        this.N0.c(this.M0, false, this.f23260g0, this.f23261h0, this.f23264k0);
        long j3 = this.L0;
        ...
        bitmap.eraseColor(0);
        canvas.save();
        float width = this.f23263j0 / this.M0.getWidth();
    ...
    @Override
    public final void b() {
        this.N0 = AnimatedFileNative.a(this.G.getAbsolutePath(), this.d, this.J, this.H, this.f23276u0, false);
    }
    ...
    public final void d() {
        int i10;
        if (this.f23263j0 == 0 && this.f23262i0 == 0) {
            int[] iArr = this.d;
            int i11 = iArr[0];
    ...
    public final void e(ImageReceiver imageReceiver) {
        if (this.f23275t0.add(imageReceiver) && this.f23253b0) {
            x(false);
        }
        h();
    }
    ...
    public final boolean g() {
        if (this.f23265l0) {
            if (this.f23284z0 == null) {
                return false;
            }
            return true;
        } else if (this.f23256d0 == null && this.f23280x) {
            return false;
        } else {
            return true;
        }
    ...
    public final void h() {
        b6 b6Var;
        if (this.f23284z0 != null) {
            boolean isEmpty = this.f23275t0.isEmpty();
    ...
    public final void i() {
        int i10;
        if (this.f23253b0 && !this.R0 && !this.f23258f) {
    ...
    public final void k() {
        if (!g()) {
            a6 a6Var = this.f23266n;
            if (a6Var != null) {
                a6Var.f22368b.recycle();
                Arrays.fill(a6Var.f22367a, (Object) null);
                this.f23266n = null;
            }
            a6 a6Var2 = this.v;
            if (a6Var2 != null) {
                a6Var2.f22368b.recycle();
                Arrays.fill(a6Var2.f22367a, (Object) null);
                this.v = null;
            }
            DispatchQueue dispatchQueue = this.f23259f0;
            ...
            while (true) {
                ...
                if (i10 < arrayList.size()) {
                    ...
                    a6Var3.f22368b.recycle();
                    Arrays.fill(a6Var3.f22367a, (Object) null);
                    i10++;
                } else {
                    arrayList.clear();
                    t();
    ...
    public final Bitmap m() {
        a6 a6Var = this.f23266n;
        if (a6Var != null) {
            return a6Var.f22368b;
        }
        a6 a6Var2 = this.f23271r;
        if (a6Var2 != null) {
            return a6Var2.f22368b;
        }
        a6 a6Var3 = this.f23273s;
        if (a6Var3 != null) {
            return a6Var3.f22368b;
        }
        return null;
    }
    ...
    public final Bitmap p() {
        int i10 = this.f23263j0;
        int i11 = this.f23262i0;
        Bitmap.Config config = Bitmap.Config.ARGB_8888;
        Bitmap createBitmap = Bitmap.createBitmap(i10, i11, config);
        Canvas canvas = new Canvas(createBitmap);
        AnimatedFileNative a2 = AnimatedFileNative.a(this.G.getAbsolutePath(), this.d, this.J, this.H, this.f23276u0, false);
        if (a2 == null) {
            return createBitmap;
        }
        if (this.M0 == null) {
        ...
        a2.c(this.M0, false, this.f23260g0, this.f23261h0, true);
        a2.f();
    ...
    public final Bitmap q(long j3, boolean z10) {
        int c10;
        if (this.f23280x && this.f23256d0 != null) {
            AnimatedFileDrawableStream animatedFileDrawableStream = this.f23276u0;
            if (animatedFileDrawableStream != null) {
                animatedFileDrawableStream.cancel(false);
                this.f23276u0.reset();
            }
            if (!z10) {
                this.f23256d0.g(j3, z10);
            }
            int[] iArr = this.d;
            Bitmap createBitmap = Bitmap.createBitmap(iArr[0], iArr[1], Bitmap.Config.ARGB_8888);
            if (z10) {
                c10 = this.f23256d0.b(createBitmap, j3);
            } else {
                c10 = this.f23256d0.c(createBitmap, true, 0.0f, 0.0f, true);
            }
            if (c10 != 0) {
                return createBitmap;
            }
    ...
    public final Bitmap r(boolean z10) {
        ...
        this.f23256d0.c(this.v.f22368b, false, this.f23260g0, this.f23261h0, z10);
        return this.v.f22368b;
    }

    public final boolean s() {
        if (g()) {
            if (this.f23266n != null || this.f23271r != null) {
                return true;
            }
            return false;
        }
    ...
    public final void start() {
        if (!this.f23253b0 && !this.f23275t0.isEmpty()) {
            this.f23253b0 = true;
            this.R0 = false;
            x(false);
    ...
    public final void t() {
        Iterator it = this.f23275t0.iterator();
        while (it.hasNext()) {
    ...
    public final void u() {
        ...
        if (this.e == null) {
            ...
            a6 a6Var = this.f23266n;
            if (a6Var != null) {
                arrayList.add(a6Var.f22368b);
            }
            a6 a6Var2 = this.f23271r;
            if (a6Var2 != null) {
                arrayList.add(a6Var2.f22368b);
            }
            a6 a6Var3 = this.f23273s;
            if (a6Var3 != null) {
                arrayList.add(a6Var3.f22368b);
            }
            a6 a6Var4 = this.v;
            if (a6Var4 != null) {
                arrayList.add(a6Var4.f22368b);
            }
    ...
    public final void x(boolean z10) {
        ...
        b6 b6Var2;
        if (this.e == null || z10) {
            if ((this.f23252b && (this.f23273s == null || (!this.K0 && this.M >= 0))) || this.f23271r == null) {
                if ((this.f23266n == null || !this.f23258f) && g() && !this.f23278w) {
                    if ((this.f23253b0 || (this.f23282y && !this.E)) && !this.f23275t0.isEmpty() && !this.C0) {
                        if (this.f23277v0) {
                            if (this.f23281x0) {
                                b6 b6Var3 = this.H0;
                                this.e = b6Var3;
                            ...
                            if (this.f23259f0 == null) {
                                this.f23259f0 = new DispatchQueue("decodeQueue" + this);
                            }
                            if (z10 && (b6Var = this.e) != null) {
                                this.f23259f0.cancelRunnable(b6Var);
                            }
                            DispatchQueue dispatchQueue = this.f23259f0;
                            b6 b6Var5 = this.H0;
                            this.e = b6Var5;
    ...
    public final void y(long j3, boolean z10, boolean z11) {
        ...
        synchronized (this.Q) {
            try {
                ...
                if (this.f23280x && (animatedFileDrawableStream = this.f23276u0) != null) {
