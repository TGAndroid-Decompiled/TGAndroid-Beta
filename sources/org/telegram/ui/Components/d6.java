...
public final class d6 extends BitmapDrawable implements Animatable, yf.c {
    ...
    public final RectF f25241a0;
    public boolean f25242b;
    public volatile boolean f25243b0;
    public int f25244c;
    public volatile boolean f25245c0;
    public final int[] d;
    public volatile AnimatedFileNative f25246d0;
    public b6 f25247e;
    public boolean f25248e0;
    public boolean f25249f;
    public DispatchQueue f25250f0;
    public float f25251g0;
    public final ArrayList h;
    public float f25252h0;
    public int f25253i0;
    public int f25254j0;
    public final boolean f25255k0;
    public final boolean f25256l0;
    public float m0;
    public a6 f25257n;
    public boolean f25258n0;
    public final TLRPC.Document f25259o0;
    public final RectF[] f25260p0;
    public final Paint[] f25261q0;
    public a6 f25262r;
    public View f25263r0;
    public a6 f25264s;
    public final ArrayList f25265s0;
    public final ArrayList f25266t0;
    public AnimatedFileDrawableStream f25267u0;
    public a6 v;
    public boolean f25268v0;
    public boolean f25269w;
    public boolean f25270w0;
    public boolean f25271x;
    public boolean f25272x0;
    public boolean f25273y;
    public int f25274y0;
    public final yf.e f25275z0;
    ...
    public final void B(int[] iArr) {
        boolean isEmpty = this.f25265s0.isEmpty();
        int[] iArr2 = this.T;
        if (!isEmpty) {
            if (this.U == null) {
                this.U = new int[4];
        ...
        for (int i10 = 0; i10 < 4; i10++) {
            if (!this.f25270w0 && iArr[i10] != iArr2[i10]) {
                this.f25270w0 = true;
            }
            iArr2[i10] = iArr[i10];
        }
    ...
    public final void C(long j3, long j10) {
        this.f25251g0 = ((float) j3) / 1000.0f;
        this.f25252h0 = ((float) j10) / 1000.0f;
        if (j3 >= 0 && o() < j3) {
            y(j3, true, false);
        }
    }
    ...
    public final void D(long j3) {
        ...
        if (!this.T0 && (this.f25243b0 || !this.f25273y)) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (this.f25243b0) {
            a6 a6Var = this.f25257n;
            if (a6Var == null && this.f25262r == null) {
                x(false);
            } else if (this.f25262r != null) {
                if (a6Var == null || (z10 && !this.f25240a && this.M < 0)) {
                    a6 a6Var2 = this.f25257n;
                    if (a6Var2 != null) {
                        this.h.add(a6Var2);
                    }
                    this.f25257n = this.f25262r;
                    this.f25262r = this.f25264s;
                    this.f25264s = null;
                    this.T0 = false;
                    x(false);
                }
            }
        } else if (!this.f25243b0 && this.f25273y && z10 && this.f25262r != null) {
            a6 a6Var3 = this.f25257n;
            if (a6Var3 != null) {
                this.h.add(a6Var3);
            }
            this.f25257n = this.f25262r;
    ...
    public final void E() {
        ...
        int i12;
        int i13;
        if (!this.f25258n0 && (i10 = this.f25253i0) > 0 && (i11 = this.f25254j0) > 0 && (i12 = (iArr = this.d)[0]) > 0 && (i13 = iArr[1]) > 0) {
    ...
    public final int a(Bitmap bitmap) {
        ...
        this.N0.c(this.M0, false, this.f25251g0, this.f25252h0, this.f25255k0);
        long j3 = this.L0;
        ...
        bitmap.eraseColor(0);
        canvas.save();
        float width = this.f25254j0 / this.M0.getWidth();
    ...
    @Override
    public final void b() {
        this.N0 = AnimatedFileNative.a(this.G.getAbsolutePath(), this.d, this.J, this.H, this.f25267u0, false);
    }
    ...
    public final void d() {
        int i10;
        if (this.f25254j0 == 0 && this.f25253i0 == 0) {
            int[] iArr = this.d;
            int i11 = iArr[0];
    ...
    public final void e(ImageReceiver imageReceiver) {
        if (!this.f25266t0.contains(imageReceiver)) {
            this.f25266t0.add(imageReceiver);
            if (this.f25243b0) {
                x(false);
            }
        }
    ...
    public final void f(View view) {
        if (view != null) {
            ArrayList arrayList = this.f25265s0;
    ...
    public final boolean g() {
        if (this.f25256l0) {
            if (this.f25275z0 == null) {
                return false;
            }
            return true;
        } else if (this.f25246d0 == null && this.f25271x) {
            return false;
        } else {
            return true;
        }
    ...
    public final void h() {
        b6 b6Var;
        if (this.f25275z0 != null) {
            boolean isEmpty = this.f25266t0.isEmpty();
    ...
    public final void i() {
        int i10;
        if (this.f25243b0 && !this.R0 && !this.f25249f) {
    ...
    public final void k() {
        if (!g()) {
            a6 a6Var = this.f25257n;
            if (a6Var != null) {
                a6Var.f24285b.recycle();
                Arrays.fill(a6Var.f24284a, (Object) null);
                this.f25257n = null;
            }
            a6 a6Var2 = this.v;
            if (a6Var2 != null) {
                a6Var2.f24285b.recycle();
                Arrays.fill(a6Var2.f24284a, (Object) null);
                this.v = null;
            }
            DispatchQueue dispatchQueue = this.f25250f0;
            ...
            while (true) {
                ...
                if (i10 < arrayList.size()) {
                    ...
                    a6Var3.f24285b.recycle();
                    Arrays.fill(a6Var3.f24284a, (Object) null);
                    i10++;
                } else {
                    arrayList.clear();
                    t();
    ...
    public final Bitmap m() {
        a6 a6Var = this.f25257n;
        if (a6Var != null) {
            return a6Var.f24285b;
        }
        a6 a6Var2 = this.f25262r;
        if (a6Var2 != null) {
            return a6Var2.f24285b;
        }
        a6 a6Var3 = this.f25264s;
        if (a6Var3 != null) {
            return a6Var3.f24285b;
        }
        return null;
    }
    ...
    public final int o() {
        ...
        a6 a6Var = this.f25262r;
        if (a6Var != null && (i10 = a6Var.f24287e) != 0) {
            return i10;
        }
        a6 a6Var2 = this.f25257n;
        if (a6Var2 != null) {
            return a6Var2.f24287e;
        }
        return 0;
    }
    ...
    public final Bitmap p() {
        int i10 = this.f25254j0;
        int i11 = this.f25253i0;
        Bitmap.Config config = Bitmap.Config.ARGB_8888;
        Bitmap createBitmap = Bitmap.createBitmap(i10, i11, config);
        Canvas canvas = new Canvas(createBitmap);
        AnimatedFileNative a2 = AnimatedFileNative.a(this.G.getAbsolutePath(), this.d, this.J, this.H, this.f25267u0, false);
        if (a2 == null) {
            return createBitmap;
        }
        if (this.M0 == null) {
        ...
        a2.c(this.M0, false, this.f25251g0, this.f25252h0, true);
        a2.f();
    ...
    public final Bitmap q(long j3, boolean z10) {
        int c10;
        if (this.f25271x && this.f25246d0 != null) {
            AnimatedFileDrawableStream animatedFileDrawableStream = this.f25267u0;
            if (animatedFileDrawableStream != null) {
                animatedFileDrawableStream.cancel(false);
                this.f25267u0.reset();
            }
            if (!z10) {
                this.f25246d0.g(j3, z10);
            }
            int[] iArr = this.d;
            Bitmap createBitmap = Bitmap.createBitmap(iArr[0], iArr[1], Bitmap.Config.ARGB_8888);
            if (z10) {
                c10 = this.f25246d0.b(createBitmap, j3);
            } else {
                c10 = this.f25246d0.c(createBitmap, true, 0.0f, 0.0f, true);
            }
            if (c10 != 0) {
                return createBitmap;
            }
    ...
    public final Bitmap r(boolean z10) {
        ...
        this.f25246d0.c(this.v.f24285b, false, this.f25251g0, this.f25252h0, z10);
        return this.v.f24285b;
    }

    public final boolean s() {
        if (g()) {
            if (this.f25257n != null || this.f25262r != null) {
                return true;
            }
            return false;
        }
    ...
    public final void start() {
        if (!this.f25243b0 && !this.f25266t0.isEmpty()) {
            this.f25243b0 = true;
            this.R0 = false;
            x(false);
    ...
    public final void t() {
        int i10 = 0;
        while (true) {
            ArrayList arrayList = this.f25266t0;
            if (i10 < arrayList.size()) {
    ...
    public final void u() {
        ...
        if (this.f25247e == null) {
            ...
            a6 a6Var = this.f25257n;
            if (a6Var != null) {
                arrayList.add(a6Var.f24285b);
            }
            a6 a6Var2 = this.f25262r;
            if (a6Var2 != null) {
                arrayList.add(a6Var2.f24285b);
            }
            a6 a6Var3 = this.f25264s;
            if (a6Var3 != null) {
                arrayList.add(a6Var3.f24285b);
            }
            a6 a6Var4 = this.v;
            if (a6Var4 != null) {
                arrayList.add(a6Var4.f24285b);
            }
    ...
    public final void x(boolean z10) {
        b6 b6Var;
        b6 b6Var2;
        if (this.f25247e == null || z10) {
            if ((this.f25242b && (this.f25264s == null || (!this.K0 && this.M >= 0))) || this.f25262r == null) {
                if ((this.f25257n == null || !this.f25249f) && g() && !this.f25269w) {
                    if ((this.f25243b0 || (this.f25273y && !this.E)) && !this.f25266t0.isEmpty() && !this.C0) {
                        if (this.f25268v0) {
                            if (this.f25272x0) {
                                b6 b6Var3 = this.H0;
                                this.f25247e = b6Var3;
                                ...
                                if (z10 && (b6Var2 = this.f25247e) != null) {
                                    W0.remove(b6Var2);
                                }
                            ...
                            if (this.f25250f0 == null) {
                                this.f25250f0 = new DispatchQueue("decodeQueue" + this);
                            }
                            if (z10 && (b6Var = this.f25247e) != null) {
                                this.f25250f0.cancelRunnable(b6Var);
                            }
                            DispatchQueue dispatchQueue = this.f25250f0;
                            b6 b6Var5 = this.H0;
                            this.f25247e = b6Var5;
    ...
    public final void y(long j3, boolean z10, boolean z11) {
        ...
        synchronized (this.Q) {
            try {
                ...
                if (this.f25271x && (animatedFileDrawableStream = this.f25267u0) != null) {
