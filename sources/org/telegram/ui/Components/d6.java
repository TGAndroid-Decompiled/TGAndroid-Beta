...
public final class d6 extends BitmapDrawable implements Animatable, yf.c {
    ...
    public final RectF f23466a0;
    public boolean f23467b;
    public volatile boolean f23468b0;
    public int f23469c;
    public volatile boolean f23470c0;
    public final int[] d;
    public volatile AnimatedFileNative f23471d0;
    public b6 e;
    public boolean f23472e0;
    public boolean f23473f;
    public DispatchQueue f23474f0;
    public float f23475g0;
    public final ArrayList h;
    public float f23476h0;
    public int f23477i0;
    public int f23478j0;
    public final boolean f23479k0;
    public final boolean f23480l0;
    public float m0;
    public a6 f23481n;
    public boolean f23482n0;
    public final TLRPC.Document f23483o0;
    public final RectF[] f23484p0;
    public final Paint[] f23485q0;
    public a6 f23486r;
    public WeakReference f23487r0;
    public a6 f23488s;
    public final pe.b f23489s0;
    public final pe.b f23490t0;
    public AnimatedFileDrawableStream f23491u0;
    public a6 v;
    public boolean f23492v0;
    public boolean f23493w;
    public boolean f23494w0;
    public boolean f23495x;
    public boolean f23496x0;
    public boolean f23497y;
    public int f23498y0;
    public final yf.e f23499z0;
    ...
    public final void B(int[] iArr) {
        boolean isEmpty = this.f23489s0.isEmpty();
        int[] iArr2 = this.T;
        if (!isEmpty) {
            if (this.U == null) {
                this.U = new int[4];
        ...
        for (int i10 = 0; i10 < 4; i10++) {
            if (!this.f23494w0 && iArr[i10] != iArr2[i10]) {
                this.f23494w0 = true;
            }
            iArr2[i10] = iArr[i10];
        }
    ...
    public final void C(long j3, long j10) {
        this.f23475g0 = ((float) j3) / 1000.0f;
        this.f23476h0 = ((float) j10) / 1000.0f;
        if (j3 >= 0 && o() < j3) {
            y(j3, true, false);
        }
    }
    ...
    public final void D(long j3) {
        ...
        if (!this.T0 && (this.f23468b0 || !this.f23497y)) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (this.f23468b0) {
            a6 a6Var = this.f23481n;
            if (a6Var == null && this.f23486r == null) {
                x(false);
            } else if (this.f23486r != null) {
                if (a6Var == null || (z10 && !this.f23465a && this.M < 0)) {
                    a6 a6Var2 = this.f23481n;
                    if (a6Var2 != null) {
                        this.h.add(a6Var2);
                    }
                    this.f23481n = this.f23486r;
                    this.f23486r = this.f23488s;
                    this.f23488s = null;
                    this.T0 = false;
                    x(false);
                }
            }
        } else if (!this.f23468b0 && this.f23497y && z10 && this.f23486r != null) {
            a6 a6Var3 = this.f23481n;
            if (a6Var3 != null) {
                this.h.add(a6Var3);
            }
            this.f23481n = this.f23486r;
    ...
    public final void E() {
        ...
        int i12;
        int i13;
        if (!this.f23482n0 && (i10 = this.f23477i0) > 0 && (i11 = this.f23478j0) > 0 && (i12 = (iArr = this.d)[0]) > 0 && (i13 = iArr[1]) > 0) {
    ...
    public final int a(Bitmap bitmap) {
        ...
        this.N0.c(this.M0, false, this.f23475g0, this.f23476h0, this.f23479k0);
        long j3 = this.L0;
        ...
        bitmap.eraseColor(0);
        canvas.save();
        float width = this.f23478j0 / this.M0.getWidth();
    ...
    @Override
    public final void b() {
        this.N0 = AnimatedFileNative.a(this.G.getAbsolutePath(), this.d, this.J, this.H, this.f23491u0, false);
    }
    ...
    public final void d() {
        int i10;
        if (this.f23478j0 == 0 && this.f23477i0 == 0) {
            int[] iArr = this.d;
            int i11 = iArr[0];
    ...
    public final void e(ImageReceiver imageReceiver) {
        if (this.f23490t0.add(imageReceiver) && this.f23468b0) {
            x(false);
        }
        h();
    }
    ...
    public final boolean g() {
        if (this.f23480l0) {
            if (this.f23499z0 == null) {
                return false;
            }
            return true;
        } else if (this.f23471d0 == null && this.f23495x) {
            return false;
        } else {
            return true;
        }
    ...
    public final void h() {
        b6 b6Var;
        if (this.f23499z0 != null) {
            boolean isEmpty = this.f23490t0.isEmpty();
    ...
    public final void i() {
        int i10;
        if (this.f23468b0 && !this.R0 && !this.f23473f) {
    ...
    public final void k() {
        if (!g()) {
            a6 a6Var = this.f23481n;
            if (a6Var != null) {
                a6Var.f22586b.recycle();
                Arrays.fill(a6Var.f22585a, (Object) null);
                this.f23481n = null;
            }
            a6 a6Var2 = this.v;
            if (a6Var2 != null) {
                a6Var2.f22586b.recycle();
                Arrays.fill(a6Var2.f22585a, (Object) null);
                this.v = null;
            }
            DispatchQueue dispatchQueue = this.f23474f0;
            ...
            while (true) {
                ...
                if (i10 < arrayList.size()) {
                    ...
                    a6Var3.f22586b.recycle();
                    Arrays.fill(a6Var3.f22585a, (Object) null);
                    i10++;
                } else {
                    arrayList.clear();
                    t();
    ...
    public final Bitmap m() {
        a6 a6Var = this.f23481n;
        if (a6Var != null) {
            return a6Var.f22586b;
        }
        a6 a6Var2 = this.f23486r;
        if (a6Var2 != null) {
            return a6Var2.f22586b;
        }
        a6 a6Var3 = this.f23488s;
        if (a6Var3 != null) {
            return a6Var3.f22586b;
        }
        return null;
    }
    ...
    public final Bitmap p() {
        int i10 = this.f23478j0;
        int i11 = this.f23477i0;
        Bitmap.Config config = Bitmap.Config.ARGB_8888;
        Bitmap createBitmap = Bitmap.createBitmap(i10, i11, config);
        Canvas canvas = new Canvas(createBitmap);
        AnimatedFileNative a2 = AnimatedFileNative.a(this.G.getAbsolutePath(), this.d, this.J, this.H, this.f23491u0, false);
        if (a2 == null) {
            return createBitmap;
        }
        if (this.M0 == null) {
        ...
        a2.c(this.M0, false, this.f23475g0, this.f23476h0, true);
        a2.f();
    ...
    public final Bitmap q(long j3, boolean z10) {
        int c10;
        if (this.f23495x && this.f23471d0 != null) {
            AnimatedFileDrawableStream animatedFileDrawableStream = this.f23491u0;
            if (animatedFileDrawableStream != null) {
                animatedFileDrawableStream.cancel(false);
                this.f23491u0.reset();
            }
            if (!z10) {
                this.f23471d0.g(j3, z10);
            }
            int[] iArr = this.d;
            Bitmap createBitmap = Bitmap.createBitmap(iArr[0], iArr[1], Bitmap.Config.ARGB_8888);
            if (z10) {
                c10 = this.f23471d0.b(createBitmap, j3);
            } else {
                c10 = this.f23471d0.c(createBitmap, true, 0.0f, 0.0f, true);
            }
            if (c10 != 0) {
                return createBitmap;
            }
    ...
    public final Bitmap r(boolean z10) {
        ...
        this.f23471d0.c(this.v.f22586b, false, this.f23475g0, this.f23476h0, z10);
        return this.v.f22586b;
    }

    public final boolean s() {
        if (g()) {
            if (this.f23481n != null || this.f23486r != null) {
                return true;
            }
            return false;
        }
    ...
    public final void start() {
        if (!this.f23468b0 && !this.f23490t0.isEmpty()) {
            this.f23468b0 = true;
            this.R0 = false;
            x(false);
    ...
    public final void t() {
        Iterator it = this.f23490t0.iterator();
        while (it.hasNext()) {
    ...
    public final void u() {
        ...
        if (this.e == null) {
            ...
            a6 a6Var = this.f23481n;
            if (a6Var != null) {
                arrayList.add(a6Var.f22586b);
            }
            a6 a6Var2 = this.f23486r;
            if (a6Var2 != null) {
                arrayList.add(a6Var2.f22586b);
            }
            a6 a6Var3 = this.f23488s;
            if (a6Var3 != null) {
                arrayList.add(a6Var3.f22586b);
            }
            a6 a6Var4 = this.v;
            if (a6Var4 != null) {
                arrayList.add(a6Var4.f22586b);
            }
    ...
    public final void x(boolean z10) {
        ...
        b6 b6Var2;
        if (this.e == null || z10) {
            if ((this.f23467b && (this.f23488s == null || (!this.K0 && this.M >= 0))) || this.f23486r == null) {
                if ((this.f23481n == null || !this.f23473f) && g() && !this.f23493w) {
                    if ((this.f23468b0 || (this.f23497y && !this.E)) && !this.f23490t0.isEmpty() && !this.C0) {
                        if (this.f23492v0) {
                            if (this.f23496x0) {
                                b6 b6Var3 = this.H0;
                                this.e = b6Var3;
                            ...
                            if (this.f23474f0 == null) {
                                this.f23474f0 = new DispatchQueue("decodeQueue" + this);
                            }
                            if (z10 && (b6Var = this.e) != null) {
                                this.f23474f0.cancelRunnable(b6Var);
                            }
                            DispatchQueue dispatchQueue = this.f23474f0;
                            b6 b6Var5 = this.H0;
                            this.e = b6Var5;
    ...
    public final void y(long j3, boolean z10, boolean z11) {
        ...
        synchronized (this.Q) {
            try {
                ...
                if (this.f23495x && (animatedFileDrawableStream = this.f23491u0) != null) {
