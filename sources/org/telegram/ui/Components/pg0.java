...
public final class pg0 extends org.telegram.ui.ActionBar.f3 {
    ...
    public final jg0 f27032b;
    public final lg0 f27033c;
    public final Drawable d;
    public final View e;
    public final w7 f27034f;
    public AnimatorSet h;
    public final MessageObject f27035n;
    public final TLRPC.Poll f27036r;
    public final TLRPC.InputPeer f27037s;
    public final HashSet v;
    public final HashMap f27038w;
    public final ArrayList f27039x;
    public final w5 f27040y;
    ...
    public pg0(Context context, int i10, MessageObject messageObject, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        fixNavigationBar();
        this.f27035n = messageObject;
        TLRPC.TL_messageMediaPoll tL_messageMediaPoll = (TLRPC.TL_messageMediaPoll) messageObject.messageOwner.media;
        this.N = tL_messageMediaPoll;
        this.f27036r = tL_messageMediaPoll.poll;
        this.f27037s = MessagesController.getInstance(this.currentAccount).getInputPeer(messageObject.getDialogId());
        ...
        while (true) {
            ...
            if (pollAnswerVoters.voters != 0) {
                ...
                this.f27039x.add(new og0(tL_messages_votesList, pollAnswerVoters.option));
                TLRPC.TL_messages_getPollVotes tL_messages_getPollVotes = new TLRPC.TL_messages_getPollVotes();
                tL_messages_getPollVotes.peer = this.f27037s;
                tL_messages_getPollVotes.f18206id = this.f27035n.getId();
        ...
        R();
        Collections.sort(this.f27039x, new hg0(this));
        S();
        Drawable mutate = context.getResources().getDrawable(R.drawable.sheet_shadow_round).mutate();
        this.d = mutate;
        mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18922i5, false), PorterDuff.Mode.MULTIPLY));
        ...
        jVar.d = 0L;
        jVar.C = false;
        jVar.f42755i = new OvershootInterpolator(1.1f);
        jVar.f42728o = qr.h;
        ...
        TLRPC.TL_textWithEntities tL_textWithEntities2 = this.f27036r.question;
        if (tL_textWithEntities2 != null) {
            MessageObject messageObject2 = this.f27035n;
        ...
        this.f27034f = w7Var;
        w7Var.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18904h5, false));
    ...
    public static void m(pg0 pg0Var, Integer[] numArr, int i10, TLObject tLObject, ArrayList arrayList, TLRPC.PollAnswerVoters pollAnswerVoters) {
        s4.c1 T;
        lg0 lg0Var = pg0Var.f27033c;
        ArrayList arrayList2 = pg0Var.f27039x;
                    ...
                    while (true) {
                        if (i12 < size2) {
                            ...
                            if (Arrays.equals(og0Var.d, og0Var2.d)) {
                                og0Var2.f26779c = og0Var.f26779c;
                                z10 = (og0Var2.f26777a == og0Var.f26777a && og0Var2.f26778b.size() == og0Var.f26778b.size()) ? true : true;
                                og0Var2.f26777a = og0Var.f26777a;
                                og0Var2.f26778b = og0Var.f26778b;
                            } else {
                                i12++;
                            }
                        }
    ...
    public static void n(pg0 pg0Var, og0 og0Var, TLObject tLObject) {
        if (pg0Var.isShowing()) {
            ...
            if (tLObject != null) {
                TLRPC.TL_messages_votesList tL_messages_votesList = (TLRPC.TL_messages_votesList) tLObject;
                MessagesController.getInstance(pg0Var.currentAccount).putUsers(tL_messages_votesList.users, false);
                og0Var.f26778b.addAll(tL_messages_votesList.votes);
                og0Var.f26779c = tL_messages_votesList.next_offset;
                pg0Var.O(null);
                pg0Var.f27033c.X(true);
            }
        }
    }
        ...
        if (AndroidUtilities.isContextSafe(context)) {
            ...
            if (arrayList == null || arrayList.isEmpty()) {
                ...
                if (view instanceof org.telegram.ui.Cells.r8) {
                    ...
                    if (Q > 0 && S >= 0) {
                        og0 og0Var = (og0) pg0Var.f27039x.get(S);
                        if (Q == og0Var.b() && !hashSet.contains(og0Var)) {
                            if (og0Var.e && og0Var.f26780f < og0Var.f26778b.size()) {
                                int min = Math.min(og0Var.f26780f + 50, og0Var.f26778b.size());
                                og0Var.f26780f = min;
                                if (min == og0Var.f26778b.size()) {
                                    og0Var.e = false;
                                }
                                pg0Var.O(null);
                                lg0Var.X(true);
                            ...
                            hashSet.add(og0Var);
                            TLRPC.TL_messages_getPollVotes tL_messages_getPollVotes = new TLRPC.TL_messages_getPollVotes();
                            tL_messages_getPollVotes.peer = pg0Var.f27037s;
                            tL_messages_getPollVotes.f18206id = pg0Var.f27035n.getId();
                            ...
                            tL_messages_getPollVotes.offset = og0Var.f26779c;
                    ...
                    if (pollVotesAlert$UserCell.h != null || pollVotesAlert$UserCell.f22091n != null) {
                        Bundle bundle = new Bundle();
                        TLRPC.User user = pollVotesAlert$UserCell.h;
                        if (user != null) {
                            bundle.putLong("user_id", user.f18256id);
                        } else {
                            bundle.putLong("chat_id", pollVotesAlert$UserCell.f22091n.f18109id);
                        }
                        pg0Var.dismiss();
                        ...
                        if (U != null) {
                            ...
                            if (U instanceof org.telegram.ui.bo) {
                                if (pollVotesAlert$UserCell.h != null) {
                                    ...
                                    if (i13 != null && i13.f18256id == pollVotesAlert$UserCell.h.f18256id) {
                                        i11 = 1;
                                    }
                                    profileActivity.N4(i11);
                                } else {
                                    TLRPC.Chat chat = ((org.telegram.ui.bo) U).e;
                                    if (chat != null && chat.f18109id == pollVotesAlert$UserCell.f22091n.f18109id) {
                                        i11 = 1;
                                    }
                                    profileActivity.N4(i11);
                                }
    ...
    public final void O(View view) {
        ...
        while (true) {
            ...
            if ((childAt instanceof ng0) && (childAt.getTag(R.id.object_tag) instanceof og0)) {
                ...
                TLRPC.Poll poll = this.f27036r;
                int size = poll.answers.size();
                int i12 = 0;
                while (true) {
                    if (i12 < size) {
                        TLRPC.PollAnswer pollAnswer = poll.answers.get(i12);
                        if (Arrays.equals(pollAnswer.option, og0Var.d) && ((mg0) this.f27038w.get(og0Var)) != null) {
                            TLRPC.TL_textWithEntities tL_textWithEntities = pollAnswer.text;
                            MessageObject messageObject = this.f27035n;
                            ...
                            ng0Var.a(str2, arrayList, P(og0Var.d), og0Var.f26777a, og0Var.a(), true);
        ...
        if (view2 != null) {
            ...
            View view3 = jg0Var.f25972r1;
            view3.layout(0, 0, view3.getMeasuredWidth(), jg0Var.f25972r1.getMeasuredHeight());
            jg0Var.invalidate();
        }
        jg0Var.invalidate();
    }
    ...
    public final int P(byte[] bArr) {
        ...
        int i12 = 0;
        while (true) {
            ArrayList arrayList = this.f27039x;
    ...
    public final void R() {
        HashMap hashMap;
        HashMap hashMap2 = this.f27038w;
        hashMap2.clear();
        TLRPC.TL_messageMediaPoll tL_messageMediaPoll = (TLRPC.TL_messageMediaPoll) this.f27035n.messageOwner.media;
        ArrayList arrayList = new ArrayList();
        ArrayList arrayList2 = this.f27039x;
    ...
    public final void S() {
        ...
        int w02 = org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18904h5, false);
        int w03 = org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18922i5, false);
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f27034f, 1, null, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f27032b, 32768, null, null, null, null, org.telegram.ui.ActionBar.i6.A5));
        int i11 = org.telegram.ui.ActionBar.i6.f18940j5;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f27034f, 64, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f27034f, 128, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f27034f, 1024, null, null, null, null, org.telegram.ui.ActionBar.i6.Pi));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f27034f, 256, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f27040y, 4, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.e, 1, null, null, null, null, org.telegram.ui.ActionBar.i6.V5));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f27032b, 0, new Class[]{View.class}, null, null, null, -1, w6Var, i10));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f27032b, 0, new Class[]{View.class}, null, null, null, -1, w6Var, org.telegram.ui.ActionBar.i6.f18922i5));
        int i12 = org.telegram.ui.ActionBar.i6.f7;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f27032b, 524288, new Class[]{ng0.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f27032b, 524288, new Class[]{ng0.class}, new String[]{"middleTextView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f27032b, 524288, new Class[]{ng0.class}, new String[]{"righTextView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f27032b, 524304, new Class[]{ng0.class}, null, null, null, org.telegram.ui.ActionBar.i6.e7));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f27032b, 0, new Class[]{PollVotesAlert$UserCell.class}, new String[]{"nameTextView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f27032b, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.i6.f18955k0, null, null, org.telegram.ui.ActionBar.i6.f18835d7));
        int i13 = org.telegram.ui.ActionBar.i6.q6;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f27032b, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"textView"}, null, null, -1, null, i13));
        int i14 = org.telegram.ui.ActionBar.i6.N6;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f27032b, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"imageView"}, null, null, -1, null, i14));
        return arrayList;
    }
}
