...
public abstract class w31 extends org.telegram.ui.ActionBar.g3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final RichMessageLayout.PreviewView f29515n;
    public final RichMessageLayout.PreviewView f29516r;
    public final String f29517s;
    public String v;
    public String f29518w;
    public final u31 f29519x;
    public final bi.o f29520y;
    ...
    public w31(Context context, String str, String str2, CharSequence charSequence, TLRPC.InputPeer inputPeer, int i10, boolean z10, TL_iv.RichMessage richMessage) {
        ...
        c90Var.setHighlightColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19184uf));
        int themedColor = getThemedColor(org.telegram.ui.ActionBar.j6.f19201vf);
        try {
        ...
        RichMessageLayout.PreviewView previewView3 = this.f29516r;
        ...
        frameLayout.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f18934h5));
    ...
    public static void m(w31 w31Var, TLRPC.TL_textWithEntities tL_textWithEntities, TLRPC.TL_textWithEntities tL_textWithEntities2, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && "TRANSLATIONS_DISABLED_ALT".equalsIgnoreCase(tL_error.text)) {
            ...
            s31 s31Var = w31Var.f29519x.e;
            String str = w31Var.f29518w;
            w31Var.v = str;
    ...
    public static void o(w31 w31Var, TLObject tLObject) {
        RichMessageLayout.PreviewView previewView = w31Var.f29516r;
        w31Var.f29512b = null;
    ...
    public final void M() {
        ...
        if (this.f29512b != null) {
            ConnectionsManager.getInstance(this.currentAccount).cancelRequest(this.f29512b.intValue(), true);
            this.f29512b = null;
        }
        ...
        if (richMessage != null && inputPeer != null) {
            ...
            this.f29512b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_translateRichMessage, new x1(this, 16)));
            return;
        }
        TLRPC.TL_textWithEntities tL_textWithEntities = new TLRPC.TL_textWithEntities();
        CharSequence charSequence2 = this.f29513c;
        ...
        if (this.f29514f && inputPeer != null) {
            ...
            this.f29512b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequestTyped(tL_messages_summarizeText, new Object(), new ai.m0(13, this, tL_textWithEntities)));
            return;
        }
        ...
        this.f29512b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_translateText, new org.telegram.ui.qo(17, this, tL_textWithEntities)));
    }
