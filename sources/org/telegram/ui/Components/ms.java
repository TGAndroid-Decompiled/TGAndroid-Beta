...
public final class ms implements Runnable {
    public final int f28534a = 1;
    public final Context f28535b;
    public final org.telegram.ui.ActionBar.f6 f28536c;
    ...
    public final void run() {
        switch (this.f28534a) {
            case 0:
                ...
                org.telegram.ui.ActionBar.f6 f6Var = this.f28536c;
            ...
            default:
                new zh.l7(this.f28535b, this.f28536c).show();
                return;
        }
    }
