...
public final class ms implements Runnable {
    public final int f28507a = 1;
    public final Context f28508b;
    public final org.telegram.ui.ActionBar.f6 f28509c;
    ...
    public final void run() {
        switch (this.f28507a) {
            case 0:
                ...
                org.telegram.ui.ActionBar.f6 f6Var = this.f28509c;
            ...
            default:
                new zh.l7(this.f28508b, this.f28509c).show();
                return;
        }
    }
