...
public final class ms extends g6 {
    public boolean E;
    public boolean F;
    public ch.d f26500s;
    public final Path v;
    public final RectF f26501w;
    public int f26502x;
    public FragmentContextView f26503y;

    public ms(Context context) {
        super(context);
        this.v = new Path();
        this.f26501w = new RectF();
        this.f26502x = 24;
        setOrientation(1);
        ch.d dVar = this.f26500s;
        if (dVar != null) {
            dVar.v();
        }
        invalidate();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (getMetadata().f14216c.f14224a != 0.0f) {
            ...
            FragmentContextView fragmentContextView2 = this.f26503y;
            le.k kVar = this.f24410c;
            View view = null;
            if (fragmentContextView2 != null && ((currentStyle = fragmentContextView2.getCurrentStyle()) == 3 || currentStyle == 1)) {
                ...
                for (int i10 = 0; i10 < entriesCount; i10++) {
                    ...
                    View view2 = ((f6) n10.f14210a).f24146a;
                    float c10 = n10.c();
                    if (c10 > 0.0f && (fragmentContextView = this.f26503y) != null && (fragmentContextView == view2 || fragmentContextView.getParent() == view2)) {
                        id capsuleBlobDrawable = this.f26503y.getCapsuleBlobDrawable();
            ...
            while (i12 < entriesCount2) {
                ...
                View view4 = ((f6) n11.f14210a).f24146a;
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (!super.dispatchTouchEvent(motionEvent)) {
            if (motionEvent.getAction() != 0 || (dVar = this.f26500s) == null || !dVar.getBounds().contains((int) motionEvent.getX(), (int) motionEvent.getY())) {
                return false;
            }
            return true;
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        boolean z10;
        FragmentContextView fragmentContextView = this.f26503y;
    ...
    public final void j() {
        ...
        RectF rectF = this.f26501w;
        rectF.set(getPaddingLeft(), getPaddingTop(), getMeasuredWidth() - getPaddingRight(), getPaddingTop() + f7);
        float min = Math.min(AndroidUtilities.dp(this.f26502x), Math.min(rectF.width(), rectF.height()) / 2.0f);
        Path path = this.v;
        path.rewind();
        ...
        if (dVar != null) {
            ...
            this.f26500s.setBounds(AndroidUtilities.dp(4.0f), AndroidUtilities.dp(14.0f), getMeasuredWidth() - AndroidUtilities.dp(4.0f), ((getPaddingBottom() + getPaddingTop()) + ((int) f7)) - AndroidUtilities.dp(14.0f));
            this.f26500s.q(Math.min(AndroidUtilities.dp(this.f26502x), f7 / 2.0f));
        }
    }
    ...
    public void setCallFragmentContextView(FragmentContextView fragmentContextView) {
        this.f26503y = fragmentContextView;
