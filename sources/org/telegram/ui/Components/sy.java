...
public final class sy extends ImageView {
    ...
    public u5 d;
    public vx e;
    public final ImageReceiver.BackgroundThreadDrawHolder[] f28831f;
    public float h;
    public ValueAnimator f28832n;

    public sy(Context context) {
        super(context);
        this.f28831f = new ImageReceiver.BackgroundThreadDrawHolder[2];
    ...
    public void setPressed(boolean z4) {
        ...
        if (isPressed() != z4) {
            super.setPressed(z4);
            invalidate();
            if (z4 && (valueAnimator = this.f28832n) != null) {
            ...
            if (!z4) {
                ...
                if (f10 != 0.0f) {
                    ...
                    this.f28832n = ofFloat;
                    ofFloat.addUpdateListener(new f6(this, 21));
                    this.f28832n.addListener(new a9(this, 19));
                    this.f28832n.setInterpolator(new OvershootInterpolator(5.0f));
                    this.f28832n.setDuration(350L);
                    this.f28832n.start();
                }
            }
        }
