...
public final class sy extends FrameLayout {
    public final ImageView f31196a;
    public final TextView f31197b;
    public final RadialProgressView f31198c;
    public boolean d;
    public final mz f31199e;
    ...
    public sy(mz mzVar, Context context) {
        ...
        this.f31198c = radialProgressView;
        radialProgressView.setVisibility(8);
        radialProgressView.setProgressColor(mzVar.A(org.telegram.ui.ActionBar.k6.f21732h6));
    ...
    public final void a(boolean z4) {
        ...
        if (this.d != z4) {
            ...
            this.f31196a.setVisibility(i10);
            if (z4) {
                i11 = 8;
            } else {
                i11 = 0;
            }
            this.f31197b.setVisibility(i11);
            if (!z4) {
                i12 = 8;
            }
            this.f31198c.setVisibility(i12);
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        int dp;
        mz mzVar = this.f31199e;
        int measuredHeight = mzVar.f29278e0.getMeasuredHeight();
        if (!this.d) {
