...
public final class sy extends FrameLayout {
    public final ImageView f28331a;
    public final TextView f28332b;
    public final RadialProgressView f28333c;
    public boolean d;
    public final lz e;
    ...
    public sy(lz lzVar, Context context) {
        ...
        this.f28333c = radialProgressView;
        radialProgressView.setVisibility(8);
        radialProgressView.setProgressColor(lzVar.z(org.telegram.ui.ActionBar.h6.f19116h6));
    ...
    public final void a(boolean z10) {
        ...
        if (this.d != z10) {
            ...
            this.f28331a.setVisibility(i10);
            if (z10) {
                i11 = 8;
            } else {
                i11 = 0;
            }
            this.f28332b.setVisibility(i11);
            if (!z10) {
                i12 = 8;
            }
            this.f28333c.setVisibility(i12);
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        int dp;
        lz lzVar = this.e;
        int measuredHeight = lzVar.f26244h0.getMeasuredHeight();
        if (!this.d) {
            dp = (int) (org.telegram.messenger.ok.A(8.0f, measuredHeight - lzVar.f26225b1, 3) * 1.7f);
        } else {
