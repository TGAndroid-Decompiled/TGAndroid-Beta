...
public final class wu0 extends el0 {
    ...
    public final String F(int i10) {
        ArrayList arrayList = this.f30173f.f25539t1[this.d].e;
    ...
    public final void J(wl0 wl0Var) {
        if (this.e) {
            ...
            if (i10 == 0) {
                this.f30173f.S(this.d, wl0Var, true);
            }
        }
    }
    ...
    public final int h() {
        int i10;
        int i11;
        yu0[] yu0VarArr = this.f30173f.f25539t1;
        int i12 = this.d;
        yu0 yu0Var = yu0VarArr[i12];
        if (yu0Var.f30693o) {
            return yu0Var.e();
        }
        if (yu0Var.f30682a.size() == 0 && !yu0VarArr[i12].f30686g) {
            return 1;
        }
        if (yu0VarArr[i12].f30682a.size() == 0) {
            yu0 yu0Var2 = yu0VarArr[i12];
            boolean[] zArr = yu0Var2.f30687i;
            if ((!zArr[0] || !zArr[1]) && yu0Var2.f30690l) {
                return 0;
            }
        }
        if (yu0VarArr[i12].e() == 0) {
            ...
            if (size != 0) {
                ...
                boolean[] zArr2 = yu0Var3.f30687i;
                if (!zArr2[0] || !zArr2[1]) {
                    boolean z10 = yu0Var3.f30696r;
                    if (z10) {
                        i10 = yu0Var3.f30699u;
                    } else {
                        i10 = yu0Var3.f30692n;
    ...
    public final int j(int i10) {
        yu0[] yu0VarArr = this.f30173f.f25539t1;
        int i11 = this.d;
        if (yu0VarArr[i11].f30684c.size() == 0 && !yu0VarArr[i11].f30686g) {
            return 9;
        }
        yu0 yu0Var = yu0VarArr[i11];
        int i12 = yu0Var.f30691m;
        if (i10 >= i12 && i10 < yu0Var.f30682a.size() + i12) {
            if (i11 != 2 && i11 != 4) {
                return 7;
            }
            return 10;
    ...
    @Override
    public final int k() {
        return this.f30173f.f25539t1[this.d].e();
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        boolean z11;
        char c11;
        jv0 jv0Var = this.f30173f;
        long j3 = jv0Var.f25518j1;
        SparseArray[] sparseArrayArr = jv0Var.Z0;
        yu0 yu0Var = jv0Var.f25539t1[this.d];
        ArrayList arrayList = yu0Var.f30682a;
        ...
        if (i11 != 7) {
            if (i11 == 10 && (view instanceof org.telegram.ui.Cells.j7)) {
                ...
                MessageObject messageObject = (MessageObject) arrayList.get(i10 - yu0Var.f30691m);
                ...
                if (jv0Var.C1) {
                    ...
                    j7Var.e(z12, !jv0Var.f25498b1);
                    return;
                }
                j7Var.e(false, !jv0Var.f25498b1);
            }
        } else if (!(view instanceof org.telegram.ui.Cells.k7)) {
        } else {
            org.telegram.ui.Cells.k7 k7Var = (org.telegram.ui.Cells.k7) view;
            MessageObject messageObject2 = (MessageObject) arrayList.get(i10 - yu0Var.f30691m);
            if (i10 != arrayList.size() - 1) {
                z10 = true;
            } else {
                z10 = false;
            ...
            if (jv0Var.C1) {
                ...
                k7Var.b(z12, !jv0Var.f25498b1);
                return;
            }
            k7Var.b(false, !jv0Var.f25498b1);
        }
    }
        ...
        if (i10 != 7) {
            ...
            if (i10 != 8) {
                if (i10 != 9) {
                    ...
                    wt0 M = jv0.M(i11, jv0Var.f25518j1, context, d6Var);
