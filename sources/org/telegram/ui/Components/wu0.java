...
public class wu0 extends tu0 {
    ...
    public final ArrayList f29751r;
    public ai.d9 f29752s;
    public final int v;
    public final uu0 f29753w;
    public boolean f29754x;
    public final ArrayList f29755y;
    ...
    public final String F(int i10) {
        ...
        if (d9Var == null || i10 < 0 || i10 >= d9Var.f721i.size() || (messageObject = (MessageObject) this.f29752s.f721i.get(i10)) == null || (storyItem = messageObject.storyItem) == null) {
            return null;
        }
    ...
    public final boolean M(int i10) {
        ai.d9 d9Var;
        if (!this.h && (d9Var = this.f29752s) != null) {
            if (d9Var instanceof ai.t8) {
                zu0 zu0Var = this.F;
                TLRPC.User user = MessagesController.getInstance(zu0Var.f30656v1.getCurrentAccount()).getUser(Long.valueOf(zu0Var.f30631j1));
                if (user != null && user.bot && user.bot_has_main_app && user.bot_can_edit) {
                    return true;
                }
                return false;
            } else if (i10 >= 0 && i10 < d9Var.f721i.size()) {
                MessageObject messageObject = (MessageObject) this.f29752s.f721i.get(i10);
                ai.d9 d9Var2 = this.f29752s;
                if (d9Var2.f719f > 0) {
                    return true;
                }
    ...
    public final void N() {
        ...
        if (d9Var != null && !this.h) {
            ...
            if ((!z10 || (zu0Var.f30633k1 && d9Var.g() > 1)) && this.f29752s.g() > 0 && !zu0Var.v0()) {
                boolean z11 = false;
                if (this.f29752s.g() < 5) {
                    iArr[1] = this.f29752s.g();
                    ...
                    zu0Var.f30633k1 = z11;
                } else if (zu0Var.f30633k1) {
                    zu0Var.f30633k1 = false;
    ...
    public final void P() {
        ...
        int O = O();
        this.f29752s.p(Math.min(100, Math.max(1, O / 2) * O * O), false);
    }
    ...
    public final int h() {
        ...
        int size = this.f29751r.size();
        if (!this.f29752s.l() || !this.F.i0()) {
            i10 = this.f29752s.g();
        }
        return size + i10;
    }
    ...
    public void l() {
        if (this.f29752s != null) {
            zu0 zu0Var = this.F;
            if (zu0Var.r0()) {
                ArrayList arrayList = this.f29751r;
                arrayList.clear();
                ArrayList E = MessagesController.getInstance(this.f29752s.f718c).getStoriesController().E(zu0Var.f30631j1);
                if (E != null) {
                    arrayList.addAll(E);
                }
            }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        char c10;
        boolean z12;
        if (this.f29752s != null && c1Var.f42700f == 19) {
            ...
            if (view instanceof org.telegram.ui.Cells.t7) {
                ...
                if (i10 >= 0 && i10 < arrayList.size()) {
                    ...
                    if (k9Var.K == null) {
                        ...
                        tL_storyItem.f18357id = i11;
                        tL_storyItem.attachPath = k9Var.f1144f;
                        MessageObject messageObject = new MessageObject(this.f29752s.f718c, tL_storyItem);
                ...
                if (size >= 0 && size < this.f29752s.f721i.size()) {
                    MessageObject messageObject2 = (MessageObject) this.f29752s.f721i.get(size);
                    if (messageObject2 != null && this.f29752s.m(messageObject2.getId())) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
                    ...
                    if (zu0Var.C1 && messageObject2 != null) {
                        ...
                        if (messageObject2.getDialogId() == zu0Var.f30631j1) {
                            c10 = 0;
                        } else {
                            c10 = 1;
                        }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (view instanceof org.telegram.ui.Cells.t7) {
            ((org.telegram.ui.Cells.t7) view).f21387d0 = true;
        }
        return x10;
    }
    ...
    public wu0(zu0 zu0Var, Context context, int i10, boolean z10) {
        ...
        if (!TextUtils.isEmpty(zu0Var.getStoriesHashtag())) {
            ...
            if (i10 > 0) {
                this.f29752s = o2Var.getMessagesController().getStoriesController().A(zu0Var.f30631j1, 0, i10, true);
            } else {
                this.f29752s = o2Var.getMessagesController().getStoriesController().A(zu0Var.f30631j1, z11 ? 4 : z10 ? 1 : 0, -1, true);
            }
        }
        ai.d9 d9Var = this.f29752s;
        if (d9Var != null) {
            this.v = d9Var.o();
            this.f29753w = new uu0(this, o2Var.getMessagesController().getStoriesController(), zu0Var.f30631j1, this.f29752s.f718c);
        }
        N();
    }
