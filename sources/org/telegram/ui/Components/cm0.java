...
public final class cm0 extends Drawable implements Animator.AnimatorListener {
    public final Context f23355a;
    public ColorFilter f23356b;
    public Drawable d;
    public Drawable e;
    public ValueAnimator f23358f;
    public boolean f23360r;
    public int f23357c = 0;
    public float h = 1.0f;
    public final ArrayList f23359n = new ArrayList();
    ...
    public final void a(int i10, boolean z10) {
        ...
        b(this.f23355a.getDrawable(i10).mutate(), z10);
        this.f23357c = i10;
    }
    ...
    public final void b(Drawable drawable, boolean z10) {
        ...
        if (drawable == drawable2) {
            drawable2.setColorFilter(this.f23356b);
            return;
        }
        this.f23357c = 0;
        this.e = drawable2;
        this.d = drawable;
        drawable.setColorFilter(this.f23356b);
        c(this.d, getBounds());
        c(this.e, getBounds());
        ValueAnimator valueAnimator = this.f23358f;
        ...
        this.f23358f = ofFloat;
        ofFloat.addUpdateListener(new t70(this, 10));
        this.f23358f.addListener(this);
        this.f23358f.setDuration(150L);
        this.f23358f.start();
    }
    ...
    public final void invalidateSelf() {
        ...
        ArrayList arrayList = this.f23359n;
        if (arrayList != null) {
