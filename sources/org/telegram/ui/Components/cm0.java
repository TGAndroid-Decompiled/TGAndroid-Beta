...
public final class cm0 {
    ...
    public int f23367y;
    public int f23368z;
    public final RectF f23347a = new RectF();
    public final Paint f23348b = new Paint(1);
    public final Paint f23349c = new Paint(3);
    public final Matrix d = new Matrix();
    public final float[] e = new float[8];
    public final Path f23350f = new Path();
    public final Paint f23351g = new Paint();
    public int f23360q = 0;
    public float f23361r = 1.0f;
    ...
    public final int a(MessageObject messageObject, TLRPC.User user, TLRPC.Chat chat, org.telegram.ui.ActionBar.f6 f6Var, int i10) {
        ...
        if (messageObject == null) {
            ...
            this.f23366x = org.telegram.ui.ActionBar.j6.l1(f7, v02);
            this.C = h();
        ...
        if (i10 == 4 && (message4 = messageObject.messageOwner) != null && MessageObject.getMedia(message4) != null && (MessageObject.getMedia(messageObject.messageOwner) instanceof TLRPC.TL_messageMediaContact)) {
            ...
            this.f23366x = org.telegram.ui.ActionBar.j6.l1(0.1f, this.f23368z);
            this.f23367y = this.f23368z;
        } else {
            g5Var = g5Var2;
            if (i10 != 0 && (messageObject.overrideLinkColor >= 0 || (messageObject.messageOwner != null && (((messageObject.isFromUser() || DialogObject.isEncryptedDialog(messageObject.getDialogId())) && user4 != null) || ((messageObject.isFromChannel() && chat != null) || (((message3 = messageObject.messageOwner) != null && (messageFwdHeader3 = message3.fwd_from) != null && messageFwdHeader3.from_id != null) || (messageObject.isSponsored() && (peerColor2 = messageObject.sponsoredColor) != null && peerColor2.color != -1))))))) {
                ...
                this.A = v04;
                this.f23368z = v04;
                this.f23366x = org.telegram.ui.ActionBar.j6.l1(0.1f, v04);
                this.f23367y = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Wc, f6Var);
            }
        }
        if (messageObject.shouldDrawWithoutBackground()) {
            ...
            this.f23368z = -1;
            this.f23366x = 0;
            this.f23367y = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Xc, f6Var);
            ...
            if (i10 == 2 && !messageObject.isOutOwner()) {
                ...
                if (!this.f23352i && !this.f23353j) {
                    i12 = org.telegram.ui.ActionBar.j6.f19042ab;
                } else {
                    i12 = org.telegram.ui.ActionBar.j6.f19062bb;
                }
            ...
            if (this.f23353j) {
                this.R = true;
                this.f23368z = org.telegram.ui.ActionBar.j6.l1(0.2f, this.f23368z);
                this.A = org.telegram.ui.ActionBar.j6.l1(0.5f, this.A);
            } else if (this.f23352i) {
                this.R = true;
                this.f23368z = org.telegram.ui.ActionBar.j6.l1(0.35f, this.f23368z);
            }
            int i16 = this.B;
            if (q6) {
                f10 = 0.12f;
            }
            this.f23366x = org.telegram.ui.ActionBar.j6.l1(f10, i16);
            this.f23367y = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.cb, f6Var);
        }
        ...
        if (this.v != 0 && this.f23363t == null && (view = this.D) != null) {
            this.f23363t = new n5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.u1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.u1) view).M0) {
                this.f23363t.a();
            }
        }
        n5 n5Var = this.f23363t;
        if (n5Var != null) {
            z11 = true;
        ...
        n5 n5Var2 = this.f23364u;
        if (n5Var2 != null) {
            n5Var2.j(this.f23365w, z11);
        }
        this.C = h();
        return g5Var.a(this.f23367y, false);
    }
    ...
    public final void d(Canvas canvas, RectF rectF, float f7, boolean z10, boolean z11) {
        ...
        float f10;
        if (!z11) {
            int l1 = org.telegram.ui.ActionBar.j6.l1(f7, this.E.a(this.f23366x, false));
            Paint paint = this.f23351g;
            paint.setColor(l1);
            float[] fArr = this.e;
            if (yf.e0.c(fArr)) {
                float f11 = fArr[0];
                ...
                Path path = this.f23350f;
                path.rewind();
                path.addRoundRect(rectF, fArr, Path.Direction.CW);
                canvas.drawPath(path, paint);
            }
        }
        n5 n5Var2 = this.f23363t;
        if (n5Var2 != null) {
            if (!this.Y) {
                Drawable drawable = n5Var2.f26565f[0];
                if ((drawable instanceof p5) && (l4Var = ((p5) drawable).f27162k) != null && l4Var.hasImageLoaded()) {
                    this.Y = true;
                } else {
                    z12 = false;
                    e = this.L.e(z12);
                    if (e <= 0.0f && this.f23361r > 0.0f) {
                        if (this.W == null) {
                        ...
                        n5 n5Var3 = this.f23364u;
                        if (n5Var3 != null) {
                            n5Var3.v = (int) (f7 * 255.0f);
                        }
                        this.f23363t.k(Integer.valueOf(this.C));
                        int i10 = 0;
                        while (true) {
                            bm0[] bm0VarArr = this.W;
                            if (i10 < bm0VarArr.length) {
                                if (i10 != 0 || (n5Var = this.f23364u) == null || this.f23365w == 0) {
                                    n5Var = this.f23363t;
                                }
                                bm0 bm0Var = bm0VarArr[i10];
                                if (!bm0Var.e || z10) {
                                    if (n5Var == this.f23364u) {
                                        f10 = 1.0f;
                                    } else {
                                        f10 = 0.3f;
                                    }
                                    n5Var.v = (int) (f10 * 255.0f * bm0Var.d * this.f23361r);
                                    float dp = max - AndroidUtilities.dp(bm0Var.f23019a);
                                    float dp2 = AndroidUtilities.dp(bm0Var.f23020b) + min;
                                    float dp3 = AndroidUtilities.dp(10.0f) * bm0Var.f23021c * e;
    ...
    public final void f(Canvas canvas, RectF rectF, float f7, float f10, float f11, float f12) {
        ...
        if (this.h == null) {
            ...
            this.h = o90Var3;
            o90Var3.C = true;
            o90Var3.f26858t = 3.5f;
            o90Var3.f26859u = 0.5f;
        }
        this.h.f(org.telegram.ui.ActionBar.j6.l1(0.1f, this.f23368z), org.telegram.ui.ActionBar.j6.l1(0.3f, this.f23368z), org.telegram.ui.ActionBar.j6.l1(0.3f, this.f23368z), org.telegram.ui.ActionBar.j6.l1(1.25f, this.f23368z));
        this.h.d(rectF);
        this.h.i(fArr);
        this.h.f26860w.setStrokeWidth(AndroidUtilities.dp(1.0f));
    ...
    public final void k() {
        this.F.a(this.f23368z, true);
        this.G.a(this.A, true);
        this.J.f(this.f23352i, true);
        this.I.a(this.f23367y, true);
        this.E.a(this.f23366x, true);
        n5 n5Var = this.f23363t;
        if (n5Var != null) {
            n5Var.d.d(1.0f, true);
        }
    ...
    public final int l(MessageObject messageObject, TLRPC.TL_peerColorCollectible tL_peerColorCollectible, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.R = false;
        this.f23368z = tL_peerColorCollectible.colors.get(0).intValue() | (-16777216);
        if (arrayList.size() >= 2) {
            z10 = true;
        } else {
            z10 = false;
        ...
        this.f23367y = i12;
        this.f23366x = org.telegram.ui.ActionBar.j6.l1(0.1f, i12);
        long j3 = tL_peerColorCollectible.background_emoji_id;
        this.v = j3;
        this.f23365w = tL_peerColorCollectible.gift_emoji_id;
        View view = this.D;
        if (j3 != 0 && this.f23363t == null && view != null) {
            this.f23363t = new n5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.u1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.u1) view).M0) {
                this.f23363t.a();
            }
        ...
        this.C = this.f23367y;
        if (this.f23365w != 0 && this.f23364u == null && view != null) {
            this.f23364u = new n5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.u1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.u1) view).M0) {
                this.f23364u.a();
            }
        }
        n5 n5Var2 = this.f23364u;
        if (n5Var2 != null) {
            n5Var2.j(this.f23365w, true);
        }
        return this.I.a(this.f23367y, false);
    }
    ...
    public final void m(MessageObject messageObject, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        if (i10 < 7) {
            int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19353r8[i10], f6Var);
            this.B = v02;
            this.A = v02;
            this.f23368z = v02;
            this.f23353j = false;
    ...
    public final int o(org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f23367y = org.telegram.ui.ActionBar.j6.v0(i10, f6Var);
        this.f23368z = org.telegram.ui.ActionBar.j6.v0(i10, f6Var);
        this.f23352i = false;
        this.f23353j = false;
        this.f23366x = org.telegram.ui.ActionBar.j6.l1(0.1f, org.telegram.ui.ActionBar.j6.v0(i10, f6Var));
        if (this.v != 0 && this.f23363t == null && (view = this.D) != null) {
            this.f23363t = new n5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.u1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.u1) view).M0) {
                this.f23363t.a();
    ...
    public final void q(int i10, boolean z10) {
        ...
        this.f23366x = org.telegram.ui.ActionBar.j6.l1(f7, i10);
        this.C = i10;
    }
}
