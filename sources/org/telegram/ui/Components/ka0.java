...
public final class ka0 extends jv0 {
    public AnimatorSet f25737f2;
    public final FrameLayout f25738g2;
    public final ha0 f25739h2;
    public final na0 f25740i2;
    ...
    public ka0(na0 na0Var, Context context, long j3, bv0 bv0Var, TLRPC.ChatFull chatFull, TLRPC.UserFull userFull, int i10, na0 na0Var2, ja0 ja0Var, org.telegram.ui.ActionBar.d6 d6Var, FrameLayout frameLayout, ha0 ha0Var) {
        ...
        this.f25740i2 = na0Var;
        this.f25738g2 = frameLayout;
        this.f25739h2 = ha0Var;
    }

    @Override
    public final boolean D() {
        int i10 = this.f25740i2.f26705a;
        if (i10 != 1 && i10 != 2) {
            return true;
        }
        return false;
    ...
    public final void D0(SparseArray sparseArray) {
        ...
        na0 na0Var = this.f25740i2;
        na0Var.I = sparseArray;
        int i10 = na0Var.f26705a;
        if (i10 == 1 || i10 == 2) {
            na0Var.F.a();
    ...
    public final void K0(boolean z10) {
        ...
        AndroidUtilities.updateViewVisibilityAnimated(this.f25738g2, !z10, 0.95f, true);
    }
    ...
    public final void P(Canvas canvas, float f7, Rect rect, Paint paint) {
        this.f25739h2.J(canvas, getY() + f7, rect, paint, true);
    }
    ...
    public final void b1(boolean z10) {
        ...
        if (na0Var.f26705a == 0) {
            ...
            this.C1 = z10;
            AnimatorSet animatorSet = this.f25737f2;
            if (animatorSet != null) {
                animatorSet.cancel();
            }
            int i10 = na0Var.f26705a;
            ...
            if (z10) {
                ...
                na0Var.f26713s.setVisibility(0);
            }
            ...
            FrameLayout frameLayout2 = na0Var.f26713s;
            if (z10) {
                f11 = 0.0f;
            } else {
                f11 = 1.0f;
            ...
            this.f25737f2.playTogether(arrayList);
            this.f25737f2.setDuration(300L);
            this.f25737f2.setInterpolator(rr.h);
            this.f25737f2.addListener(new org.telegram.ui.ActionBar.g(this, z10, z11, 4));
            this.f25737f2.start();
        }
    }
    ...
    public final int getInitialTab() {
        return this.f25740i2.W;
    }

    @Override
    public final String getStoriesHashtag() {
        return this.f25740i2.h;
    }

    @Override
    public final String getStoriesHashtagUsername() {
        return this.f25740i2.f26711n;
    }

    @Override
    public final boolean l0() {
        na0 na0Var = this.f25740i2;
        if (na0Var.f26705a == 0 && na0Var.e == na0Var.getUserConfig().getClientUserId() && na0Var.f26710f == 0) {
            return true;
        }
        return false;
    }
