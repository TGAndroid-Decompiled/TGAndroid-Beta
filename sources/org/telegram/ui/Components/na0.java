...
public abstract class na0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void b() {
        ...
        gg.k1 k1Var;
        int height;
        ma0 ma0Var = this.f26428b;
        if (ma0Var != null && this.f26429c != null) {
            boolean g10 = g();
            this.f26433s = 0.0f;
            gg.q1 q1Var = this.e;
            if (g10) {
                ...
                float min = Math.min(Math.max(0.0f, ma0Var.getTranslationY() + height) + this.f26433s, (1.0f - this.M) * getHeight());
                this.f26431n = 0.0f;
                this.f26432r = min;
            } else {
                if (q1Var.f9903f) {
                ...
                this.f26431n = Math.max(Math.max(0.0f, ma0Var.getTranslationY() + i10) - this.f26433s, this.M * getHeight());
                this.f26432r = getMeasuredHeight();
            }
            ch.d dVar = this.R;
            if (dVar != null) {
                dVar.setBounds(0, ((int) this.f26431n) - AndroidUtilities.dp(5.0f), getMeasuredWidth(), AndroidUtilities.dp(5.0f) + ((int) this.f26432r));
                Path path = this.S;
                path.rewind();
                Rect rect = this.R.f4288j.f4279m;
                RectF rectF = this.T;
                rectF.set(rect);
                if (ma0Var != null && (ga0Var = this.d) != null && ma0Var.getLayoutManager() == ga0Var && (k1Var = this.f26430f) != null && k1Var.R != null) {
    ...
    public final float d() {
        ...
        return getMeasuredHeight() - this.f26431n;
    }

    @Override
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.emojiLoaded) {
            AndroidUtilities.forEachViews((RecyclerView) this.f26428b, (e2.h) new ai.i(24));
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        boolean g10 = g();
        gg.k1 k1Var = this.f26430f;
        if ((k1Var.N() || k1Var.R != null) && ((k1Var.f9844x0 || k1Var.A0 != null) && k1Var.I() == null && k1Var.U == null)) {
            i10 = 2;
        } else {
            i10 = 0;
        }
        this.f26433s = AndroidUtilities.dp(i10 + 2);
        canvas.save();
        float dp = AndroidUtilities.dp(6.0f);
        float f7 = this.f26431n;
        gg.q1 q1Var = this.e;
        ma0 ma0Var = this.f26428b;
        Rect rect = this.f26436y;
        if (g10) {
            if (q1Var.f9903f) {
                height = q1Var.e.getTop();
            } else {
            ...
            float min2 = Math.min(Math.max(0.0f, ma0Var.getTranslationY() + height) + this.f26433s, (1.0f - this.M) * getHeight());
            this.f26431n = 0.0f;
            int measuredWidth = getMeasuredWidth();
            this.f26432r = min2;
            rect.set(0, (int) 0.0f, measuredWidth, (int) min2);
            min = Math.min(dp, Math.abs(getMeasuredHeight() - this.f26432r));
            if (min > 0.0f) {
            ...
            if (ma0Var.getLayoutManager() == this.d) {
                this.f26433s += AndroidUtilities.dp(2.0f);
            ...
            float max = Math.max(0.0f, ma0Var.getTranslationY() + i11) - this.f26433s;
            this.f26431n = max;
            float max2 = Math.max(max, this.M * getHeight());
            this.f26431n = max2;
            int measuredWidth2 = getMeasuredWidth();
            float measuredHeight = getMeasuredHeight();
            this.f26432r = measuredHeight;
            rect.set(0, (int) max2, measuredWidth2, (int) measuredHeight);
            min = Math.min(dp, Math.abs(this.f26431n));
            if (min > 0.0f) {
                canvas.clipRect(0, 0, getWidth(), getHeight());
                rect.bottom += (int) min;
            }
        }
        if (Math.abs(f7 - this.f26431n) > 0.1f) {
            i();
        }
        if (this.E == null) {
        ...
        if (num != null) {
            ...
            v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Sd, this.f26427a);
        }
        paint2.setColor(v02);
        f(canvas, rect, min);
    ...
    public final boolean g() {
        s4.o0 layoutManager = this.f26428b.getLayoutManager();
        gg.j0 j0Var = this.f26429c;
        if (layoutManager == j0Var && j0Var.f42695t) {
            return true;
        }
        return false;
    }
