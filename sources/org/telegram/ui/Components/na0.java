...
public final class na0 extends ll0 {
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        hg.q1 q1Var = oa0Var.f29021e;
        if (!oa0Var.f29020c.f45732t ? this.Y2 || q1Var == null || q1Var.f11222e == null || !q1Var.f11223f || motionEvent.getY() >= q1Var.f11222e.getBottom() : this.Y2 || q1Var == null || q1Var.f11222e == null || !q1Var.f11223f || motionEvent.getY() <= q1Var.f11222e.getTop()) {
            if (!this.X2 && org.telegram.ui.st.q().r(motionEvent, oa0Var.f29019b, null, this.f28225p2)) {
                z10 = true;
            } else {
                z10 = false;
            }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (oa0Var.H) {
            ...
            oa0Var.G = false;
            oa0Var.H = false;
        } else if (N0 != -1 && i16 == this.Z2 && i17 - this.f28722a3 != 0) {
            oa0Var.G = true;
