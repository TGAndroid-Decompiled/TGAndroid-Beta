...
public final class na0 extends ll0 {
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        hg.q1 q1Var = oa0Var.f29048e;
        if (!oa0Var.f29047c.f45760t ? this.Y2 || q1Var == null || q1Var.f11248e == null || !q1Var.f11249f || motionEvent.getY() >= q1Var.f11248e.getBottom() : this.Y2 || q1Var == null || q1Var.f11248e == null || !q1Var.f11249f || motionEvent.getY() <= q1Var.f11248e.getTop()) {
            if (!this.X2 && org.telegram.ui.st.q().r(motionEvent, oa0Var.f29046b, null, this.f28252p2)) {
                z10 = true;
            } else {
                z10 = false;
            }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (oa0Var.H) {
            ...
            oa0Var.G = false;
            oa0Var.H = false;
        } else if (N0 != -1 && i16 == this.Z2 && i17 - this.f28749a3 != 0) {
            oa0Var.G = true;
