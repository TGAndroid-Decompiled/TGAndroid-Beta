...
public final class jd0 extends Dialog implements org.telegram.ui.ActionBar.a5 {
    public final ActionBarLayout f25305a;
    public final FrameLayout f25306b;
    public final be0 f25307c;

    public jd0(Context context) {
        super(context, R.style.TransparentDialog);
        ActionBarLayout actionBarLayout = new ActionBarLayout(context, false);
        this.f25305a = actionBarLayout;
    ...
    public final void onBackPressed() {
        if (this.f25307c.getVisibility() == 0) {
        ...
        ActionBarLayout actionBarLayout = this.f25305a;
        actionBarLayout.G();
        if (actionBarLayout.getFragmentStack().size() <= 1) {
            dismiss();
        }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (i10 >= 26) {
            if (i0.a.f(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19062d6, true)) < 0.9d) {
                z10 = false;
            }
    ...
    public final void onStart() {
        ...
        if (context instanceof LaunchActivity) {
            ((LaunchActivity) context).B0.add(this.f25307c);
        }
    }
    ...
    public final void onStop() {
        ...
        if (context instanceof LaunchActivity) {
            ((LaunchActivity) context).B0.remove(this.f25307c);
        }
    }
