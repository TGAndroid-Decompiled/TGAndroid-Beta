...
public abstract class e40 extends x51 {
    ...
    public e40(ml0 ml0Var, Context context, int i10) {
        ...
        this.T = 0;
        this.U = -1;
        this.f23484b0 = new boolean[1];
        this.f29855s = new d(this, 16);
        this.N = i10;
    }
    ...
    public final void V() {
        ...
        AndroidUtilities.cancelRunOnUIThread(this.f23483a0);
        this.T++;
        this.S = false;
    }
