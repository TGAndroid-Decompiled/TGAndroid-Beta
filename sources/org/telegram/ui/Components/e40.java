...
public abstract class e40 extends v51 {
    ...
    public String Y;
    public int Z;
    public org.telegram.ui.dm f25548a0;
    public final boolean[] f25549b0;
    ...
    public e40(ll0 ll0Var, Context context, int i10) {
        ...
        this.T = 0;
        this.U = -1;
        this.f25549b0 = new boolean[1];
        this.f31137s = new d(this, 16);
        this.N = i10;
    }
    ...
    public final void V() {
        ...
        AndroidUtilities.cancelRunOnUIThread(this.f25548a0);
        this.T++;
        this.S = false;
    }
