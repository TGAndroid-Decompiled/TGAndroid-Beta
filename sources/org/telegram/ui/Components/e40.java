...
public abstract class e40 extends k61 {
    ...
    public e40(vl0 vl0Var, Context context, int i10) {
        ...
        this.T = 0;
        this.U = -1;
        this.f23735b0 = new boolean[1];
        this.f25679s = new d(this, 16);
        this.N = i10;
    }
    ...
    public final void V() {
        ...
        AndroidUtilities.cancelRunOnUIThread(this.f23734a0);
        this.T++;
        this.S = false;
    }
