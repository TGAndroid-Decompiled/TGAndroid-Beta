...
public abstract class e40 extends m61 {
    ...
    public e40(yl0 yl0Var, Context context, int i10) {
        ...
        this.T = 0;
        this.U = -1;
        this.f23859b0 = new boolean[1];
        this.f26343s = new d(this, 16);
        this.N = i10;
    }
    ...
    public final void V() {
        ...
        AndroidUtilities.cancelRunOnUIThread(this.f23858a0);
        this.T++;
        this.S = false;
    }
