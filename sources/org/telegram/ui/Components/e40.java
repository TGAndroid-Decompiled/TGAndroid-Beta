...
public abstract class e40 extends l61 {
    ...
    public e40(wl0 wl0Var, Context context, int i10) {
        ...
        this.T = 0;
        this.U = -1;
        this.f23784b0 = new boolean[1];
        this.f26043s = new d(this, 16);
        this.N = i10;
    }
    ...
    public final void V() {
        ...
        AndroidUtilities.cancelRunOnUIThread(this.f23783a0);
        this.T++;
        this.S = false;
    }
