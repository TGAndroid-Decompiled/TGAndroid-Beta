...
public final class ig0 extends FrameLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (i10) {
            case 1:
                Paint paint = (Paint) this.f27142c;
                if (this.f27141b) {
                ...
                return;
            case 2:
                Paint paint2 = (Paint) this.f27142c;
                if (this.f27141b) {
            ...
            case 3:
                ...
                if (!this.f27141b && a61Var.f43034r > 0.0f) {
                    if (((Paint) this.f27142c) == null) {
                        ...
                        ((Paint) this.f27142c).setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
                    }
                    canvas.saveLayerAlpha(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), 255, 31);
                    super.dispatchDraw(canvas);
                    ((Paint) this.f27142c).setAlpha((int) (a61Var.f43034r * 255.0f));
                    canvas.drawRect(0.0f, 0.0f, AndroidUtilities.dp(18.0f), getMeasuredHeight(), (Paint) this.f27142c);
                    canvas.restore();
                    return;
                }
                super.dispatchDraw(canvas);
        ...
        switch (this.f27140a) {
            case 4:
                ...
                if (view instanceof TextView) {
                    ...
                    if ((z10 || z12) && limitPreviewView.f24081e0 != null) {
                        canvas.saveLayer(view.getLeft(), view.getTop(), view.getRight(), view.getBottom(), (Paint) this.f27142c, 31);
                        sg.t tVar = limitPreviewView.f24081e0;
                        float x10 = getX() + ((ViewGroup) getParent()).getX();
                        float y3 = ((ViewGroup) getParent()).getY();
                        canvas.drawRect(view.getLeft(), view.getTop(), view.getRight(), view.getBottom(), ((org.telegram.ui.v5) ((org.telegram.ui.z0) tVar).f43279b).t0(x10, getY() + y3));
                        canvas.restore();
                        invalidate();
                        return drawChild;
                    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.f27140a) {
            case 0:
                ...
                if (f7 != 1.0f) {
                    org.telegram.ui.ActionBar.j6.f20976t0.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20762h5, false));
                ...
                if (f7 != 0.0f) {
                    ...
                    org.telegram.ui.ActionBar.j6.f20976t0.setColor(w02);
                    org.telegram.ui.ActionBar.j6.f20976t0.setAlpha((int) (alpha * 1.0f * f7));
                ...
                org.telegram.ui.ActionBar.j6.f20976t0.setColor(Color.argb((int) (pg0Var.f29401f.getAlpha() * 255.0f), Color.red(w03), Color.green(w03), Color.blue(w03)));
                canvas.drawRect(pg0.F(pg0Var), 0.0f, getMeasuredWidth() - pg0.G(pg0Var), AndroidUtilities.statusBarHeight, org.telegram.ui.ActionBar.j6.f20976t0);
                return;
            default:
                super.onDraw(canvas);
                return;
        ...
        switch (this.f27140a) {
            case 0:
                ...
                if (motionEvent.getAction() == 0 && pg0Var.E != 0) {
                    if (motionEvent.getY() < AndroidUtilities.dp(12.0f) + pg0Var.E && pg0Var.f29401f.getAlpha() == 0.0f) {
                        pg0Var.dismiss();
                        return true;
                    }
                }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.f27140a) {
            case 0:
                ...
                ((FrameLayout.LayoutParams) pg0Var.f29400e.getLayoutParams()).topMargin = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight();
