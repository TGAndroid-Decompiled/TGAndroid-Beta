...
public final class ig0 extends FrameLayout {
    public final int f25005a = 4;
    public boolean f25006b;
    public Object f25007c;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (i10) {
            case 1:
                Paint paint = (Paint) this.f25007c;
                if (this.f25006b) {
                ...
                return;
            case 2:
                Paint paint2 = (Paint) this.f25007c;
                if (this.f25006b) {
            ...
            case 3:
                ...
                if (!this.f25006b && x51Var.f38377r > 0.0f) {
                    if (((Paint) this.f25007c) == null) {
                        ...
                        ((Paint) this.f25007c).setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
                    }
                    canvas.saveLayerAlpha(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), 255, 31);
                    super.dispatchDraw(canvas);
                    ((Paint) this.f25007c).setAlpha((int) (x51Var.f38377r * 255.0f));
                    canvas.drawRect(0.0f, 0.0f, AndroidUtilities.dp(18.0f), getMeasuredHeight(), (Paint) this.f25007c);
                    canvas.restore();
                    return;
                }
                super.dispatchDraw(canvas);
        ...
        switch (this.f25005a) {
            case 4:
                ...
                if (view instanceof TextView) {
                    ...
                    if ((z10 || z12) && limitPreviewView.f22108e0 != null) {
                        canvas.saveLayer(view.getLeft(), view.getTop(), view.getRight(), view.getBottom(), (Paint) this.f25007c, 31);
                        rg.t tVar = limitPreviewView.f22108e0;
                        float x10 = getX() + ((ViewGroup) getParent()).getX();
                        float y3 = ((ViewGroup) getParent()).getY();
                        canvas.drawRect(view.getLeft(), view.getTop(), view.getRight(), view.getBottom(), ((org.telegram.ui.v5) ((org.telegram.ui.y0) tVar).f39705b).t0(x10, getY() + y3));
                        canvas.restore();
                        invalidate();
                        return drawChild;
                    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.f25005a) {
            case 0:
                ...
                if (f7 != 1.0f) {
                    org.telegram.ui.ActionBar.i6.f19124t0.setColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18907h5, false));
                    rectF.set(pg0.z(pg0Var), pg0.A(pg0Var) + i10, getMeasuredWidth() - pg0.B(pg0Var), AndroidUtilities.dp(24.0f) + pg0.E(pg0Var) + i10);
                ...
                if (f7 != 0.0f) {
                    ...
                    org.telegram.ui.ActionBar.i6.f19124t0.setColor(w02);
                    org.telegram.ui.ActionBar.i6.f19124t0.setAlpha((int) (alpha * 1.0f * f7));
                ...
                org.telegram.ui.ActionBar.i6.f19124t0.setColor(Color.argb((int) (pg0Var.f27037f.getAlpha() * 255.0f), Color.red(w03), Color.green(w03), Color.blue(w03)));
                canvas.drawRect(pg0.F(pg0Var), 0.0f, getMeasuredWidth() - pg0.G(pg0Var), AndroidUtilities.statusBarHeight, org.telegram.ui.ActionBar.i6.f19124t0);
                return;
            default:
                super.onDraw(canvas);
                return;
        ...
        switch (this.f25005a) {
            case 0:
                ...
                if (motionEvent.getAction() == 0 && pg0Var.E != 0) {
                    if (motionEvent.getY() < AndroidUtilities.dp(12.0f) + pg0Var.E && pg0Var.f27037f.getAlpha() == 0.0f) {
                        pg0Var.dismiss();
                        return true;
                    }
                }
        ...
        switch (this.f25005a) {
            case 0:
                ...
                for (int i13 = 0; i13 < R; i13++) {
                    if (i13 == 0) {
                        w5Var.measure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10 - (pg0.s(pg0Var) * 2)), 1073741824), i11);
    ...
    public ig0(org.telegram.ui.x51 x51Var, Context context, boolean z10) {
        super(context);
        this.d = x51Var;
        this.f25006b = z10;
    }
