...
public final class nz0 extends View {
    ...
    public final lz0 N;
    public final org.telegram.ui.Cells.m9 f27398a;
    public int f27399b;
    public final dz0 f27400c;
    public final dz0 d;
    public int e;
    ...
    public int v;
    public int f27405w;
    public boolean f27406x;
    public int f27407y;

    public nz0(Context context, mz0 mz0Var, org.telegram.ui.Cells.m9 m9Var) {
        super(context);
        this.f27400c = new dz0(this, true);
        this.d = new dz0(this, false);
        this.e = 0;
        this.f27401f = false;
        this.h = 1;
        this.f27402n = 0;
        this.f27403r = AndroidUtilities.dp(8.0f);
        this.f27404s = AndroidUtilities.dp(9.0f);
    ...
    public static void i(iz0 iz0Var, int i10, int i11, int i12, int i13) {
        ...
        kz0 kz0Var = iz0Var.f25805a;
        iz0Var.f25805a = new kz0(kz0Var.f26494a, hz0Var, kz0Var.f26496c, kz0Var.d);
        hz0 hz0Var2 = new hz0(i12, i13 + i12);
        kz0 kz0Var2 = iz0Var.f25806b;
        iz0Var.f25806b = new kz0(kz0Var2.f26494a, hz0Var2, kz0Var2.f26496c, kz0Var2.d);
    }
    ...
    public final void a(int i10, int i11, int i12, int i13) {
        ...
        zy0 zy0Var = R;
        iz0Var.f25805a = new kz0(false, hz0Var, zy0Var, 0.0f);
        iz0Var.f25806b = new kz0(false, new hz0(i10, i12 + i10), zy0Var, 0.0f);
        gz0Var.f25261a = iz0Var;
        gz0Var.f25267j = i11;
    ...
    public final void b(TL_iv.pageTableCell pagetablecell, int i10, int i11, int i12) {
        ...
        zy0 zy0Var = R;
        iz0Var.f25805a = new kz0(false, hz0Var, zy0Var, 0.0f);
        iz0Var.f25806b = new kz0(false, new hz0(i10, i12 + i10), zy0Var, 1.0f);
        gz0Var.f25261a = iz0Var;
        gz0Var.f25267j = i11;
        arrayList.add(gz0Var);
    ...
    public final void c() {
        ...
        if (i11 == 0) {
            ...
            for (int i16 = 0; i16 < childCount; i16++) {
                iz0 iz0Var = d(i16).f25261a;
                if (z4) {
                    kz0Var = iz0Var.f25805a;
                } else {
                    kz0Var = iz0Var.f25806b;
                }
                hz0 hz0Var = kz0Var.f26495b;
                boolean z10 = kz0Var.f26494a;
                int i17 = hz0Var.f25527b;
                int i18 = hz0Var.f25526a;
                int i19 = i17 - i18;
                if (z10) {
                    i14 = i18;
                }
                if (z4) {
                    kz0Var2 = iz0Var.f25806b;
                } else {
                    kz0Var2 = iz0Var.f25805a;
                }
                hz0 hz0Var2 = kz0Var2.f26495b;
                boolean z11 = kz0Var2.f26494a;
                int i20 = hz0Var2.f25527b;
                int i21 = hz0Var2.f25526a;
                int i22 = i20 - i21;
                if (i13 != 0) {
                    if (z11) {
            ...
            for (int i25 = 0; i25 < childCount2; i25++) {
                i12 = (i12 * 31) + d(i25).f25261a.hashCode();
            }
            this.f27402n = i12;
            return;
        }
        ...
        for (int i27 = 0; i27 < childCount3; i27++) {
            i26 = (i26 * 31) + d(i27).f25261a.hashCode();
        }
        if (i11 != i26) {
            g();
            c();
    ...
    public final int e(gz0 gz0Var, boolean z4, boolean z10) {
        ...
        if (z10) {
            if (dz0Var.f24402j == null) {
                dz0Var.f24402j = new int[dz0Var.e() + 1];
            }
            if (!dz0Var.f24403k) {
                dz0Var.b(true);
                dz0Var.f24403k = true;
            ...
            if (dz0Var.f24404l == null) {
                dz0Var.f24404l = new int[dz0Var.e() + 1];
            }
            if (!dz0Var.f24405m) {
                dz0Var.b(false);
                dz0Var.f24405m = true;
    ...
    public final int f(gz0 gz0Var, boolean z4, boolean z10) {
        ...
        if (i10 == Integer.MIN_VALUE) {
            ...
            if (z11 != z10) {
                int i11 = hz0Var.f25526a;
                return 0;
            }
            int i12 = hz0Var.f25527b;
            dz0Var.e();
            return 0;
        }
        return i10;
    ...
    public final void h(int i10, boolean z4) {
        ...
        for (int i14 = 0; i14 < childCount; i14++) {
            ...
            if (z4) {
                ...
                d.e(this.L.createTextLayout(d.f25263c, i12));
                if (d.f25262b != null) {
                    ((ViewGroup.MarginLayoutParams) iz0Var).height = Math.max(this.f27405w, d.f25264f + this.f27403r + this.f27404s);
                    int emojiOnlyCount = d.f25262b.getEmojiOnlyCount();
                    if (emojiOnlyCount > 0) {
                ...
                if (kz0.a(kz0Var, z10) == R) {
                    ...
                    int[] g10 = dz0Var.g();
                    int e = (g10[hz0Var.f25527b] - g10[hz0Var.f25526a]) - (e(d, z10, false) + e(d, z10, true));
                    if (z10) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i16 = 0; i16 < childCount; i16++) {
            nz0Var.f27399b = Math.max(nz0Var.f27399b, nz0Var.d(i16).f25261a.f25806b.f26495b.f25527b);
        }
        nz0Var.h(i10, true);
        if (nz0Var.e == 0) {
            i12 = dz0Var2.i(i10);
            if (nz0Var.f27406x) {
                ...
                dz0Var2.v.f26074a = i12;
                dz0Var2.f24414w.f26074a = -i12;
                dz0Var2.f24409q = false;
                dz0Var2.g();
            }
            nz0Var.h(i10, false);
            i13 = dz0Var.i(i11);
        ...
        dz0Var2.f24409q = false;
        dz0Var2.g();
        dz0Var.v.f26074a = max;
        dz0Var.f24414w.f26074a = -max;
        dz0Var.f24409q = false;
        dz0Var.g();
        int[] g10 = dz0Var2.g();
        int[] g11 = dz0Var.g();
        ...
        while (i19 < childCount2) {
            ...
            gz0 d = nz0Var.d(i20);
            iz0 iz0Var = d.f25261a;
            kz0 kz0Var = iz0Var.f25806b;
            kz0 kz0Var2 = iz0Var.f25805a;
            hz0 hz0Var = kz0Var.f26495b;
            hz0 hz0Var2 = kz0Var2.f26495b;
            int i21 = childCount2;
            int i22 = g10[hz0Var.f25526a];
            int i23 = g11[hz0Var2.f25526a];
            int i24 = g10[hz0Var.f25527b] - i22;
            int i25 = g11[hz0Var2.f25527b] - i23;
            int i26 = d.f25268k;
            dz0 dz0Var3 = dz0Var;
            int i27 = d.f25269l;
            ...
            l7.w0 f10 = dz0Var2.f();
            ez0 ez0Var = (ez0) ((Object[]) f10.d)[((int[]) f10.f11676b)[i20]];
            l7.w0 f11 = dz0Var3.f();
            dz0 dz0Var4 = dz0Var2;
            ez0 ez0Var2 = (ez0) ((Object[]) f11.d)[((int[]) f11.f11676b)[i20]];
            ...
            nz0Var = this;
            int a12 = ez0Var2.a(nz0Var, d, a10, i27 + e11, false);
            int c3 = a2.c(i26, i24 - i28);
            int c10 = a10.c(i27, i25 - e11);
            int i29 = i22 + b10 + a11;
            if (!nz0Var.F) {
                i15 = e + i29;
            } else {
            ...
            int i30 = i15;
            int i31 = i23 + b11 + a12 + e6;
            if (d.f25263c != null) {
                if (c3 != d.f25268k || c10 != d.f25269l) {
                    d.d(c3, c10, false);
                }
                int i32 = d.f25270m;
                if (i32 != 0 && i32 != c10) {
                    hz0 hz0Var3 = d.f25261a.f25805a.f26495b;
                    if (hz0Var3.f25527b - hz0Var3.f25526a <= 1) {
                        ...
                        while (true) {
                            if (i33 < size) {
                                ...
                                float f12 = pointF.x;
                                float f13 = d.f25261a.f25805a.f26495b.f25526a;
        ...
        while (i34 < size2) {
            ...
            int i35 = gz0Var.f25269l;
            int i36 = gz0Var.d;
            int i37 = i35 - gz0Var.f25270m;
            ArrayList arrayList3 = nz0Var.M;
            int size3 = arrayList3.size();
            for (int i38 = i36 + 1; i38 < size3; i38++) {
                gz0 gz0Var2 = (gz0) arrayList3.get(i38);
                if (gz0Var.f25261a.f25805a.f26495b.f25526a != gz0Var2.f25261a.f25805a.f26495b.f25526a) {
                    break;
                }
                int i39 = gz0Var.f25270m;
                int i40 = gz0Var2.f25270m;
                if (i39 < i40) {
                    z4 = true;
                    break;
                }
                int i41 = gz0Var2.f25269l - i40;
                if (i41 > 0) {
            ...
            if (!z4) {
                ...
                while (true) {
                    ...
                    if (gz0Var.f25261a.f25805a.f26495b.f25526a != gz0Var3.f25261a.f25805a.f26495b.f25526a) {
                        break;
                    }
                    int i43 = gz0Var.f25270m;
                    int i44 = gz0Var3.f25270m;
                    if (i43 < i44) {
                        z4 = true;
                        break;
                    }
                    int i45 = gz0Var3.f25269l - i44;
                    if (i45 > 0) {
            ...
            if (!z4) {
                gz0Var.f25269l = gz0Var.f25270m;
                gz0Var.g();
                max -= i37;
                int i46 = gz0Var.f25261a.f25805a.f26495b.f25526a;
                while (true) {
                    i46++;
                ...
                while (i49 < size4) {
                    ...
                    if (gz0Var == gz0Var4) {
                        ...
                        int i50 = gz0Var.f25261a.f25805a.f26495b.f25526a;
                        int i51 = gz0Var4.f25261a.f25805a.f26495b.f25526a;
                        if (i50 == i51) {
                            if (gz0Var4.f25270m != gz0Var4.f25269l) {
                            ...
                            int i52 = gz0Var4.f25269l - i37;
                            gz0Var4.f25269l = i52;
                            i14 = i49;
                            gz0Var4.d(gz0Var4.f25268k, i52, true);
                        } else {
                            i14 = i49;
                            if (i50 < i51) {
                                gz0Var4.f25274q -= i37;
        ...
        for (int i53 = 0; i53 < childCount3; i53++) {
            ...
            nz0Var.L.onLayoutChild(d10.f25262b, d10.b(), d10.c());
            d10.f25271n = d10.f25273p;
            d10.f25272o = d10.f25268k;
        }
        nz0Var.f27407y = i18;
        nz0Var.B = max;
        nz0Var.C = copyOf;
    ...
    public void setRenderWidth(int i10) {
        ...
        this.f27407y = Math.max(measuredWidth, i10);
        for (int i13 = 0; i13 < getChildCount(); i13++) {
            gz0 d = d(i13);
            if (measuredWidth > 0 && (i12 = this.f27407y) != measuredWidth) {
                float f10 = measuredWidth;
                int round = Math.round((d.f25271n * i12) / f10);
                int round2 = Math.round(((d.f25271n + d.f25272o) * this.f27407y) / f10);
                d.f25273p = round;
                d.f25268k = Math.max(0, round2 - round);
                if (d.f25263c != null && d.f25262b != null) {
                    d.f();
                }
            } else {
                int i14 = d.f25271n;
                d.f25273p = i14;
                d.f25268k = Math.max(0, (d.f25272o + i14) - i14);
                if (d.f25263c != null && d.f25262b != null) {
                    d.f();
                }
            }
        ...
        if (iArr.length < 2) {
            ...
            for (int i18 = 0; i18 < getChildCount(); i18++) {
                ...
                if (i11 > 0) {
                    hz0 hz0Var = d10.f25261a.f25805a.f26495b;
                    int max = Math.max(0, hz0Var.f25526a);
                    int min = Math.min(i15, hz0Var.f25527b);
                    if (max < min) {
                        int i19 = 0;
                        for (int i20 = max; i20 < min; i20++) {
                            i19 += iArr2[i20];
                        }
                        int max2 = Math.max(1, Math.round(d10.f25268k / i11)) - i19;
            ...
            for (int i25 = 0; i25 < getChildCount(); i25++) {
                gz0 d11 = d(i25);
                hz0 hz0Var2 = d11.f25261a.f25805a.f26495b;
                int max3 = Math.max(0, Math.min(i15, hz0Var2.f25526a));
                int max4 = Math.max(max3, Math.min(i15, hz0Var2.f25527b));
                int i26 = iArr4[max3];
                int i27 = iArr4[max4];
                d11.f25274q = i26;
                d11.f25269l = Math.max(0, i27 - i26);
                if (d11.f25263c != null) {
                    d11.g();
                }
                this.L.onLayoutChild(d11.f25262b, d11.b(), d11.c());
            }
        }
        invalidate();
    }
