...
public final class c51 extends aw0 {
    ...
    public boolean D0;
    public final d51 E0;
    public final Paint f23204w0;
    public boolean f23205x0;
    public boolean f23206y0;
    public boolean f23207z0;
    ...
    public final float Z() {
        d51 d51Var = this.E0;
        return Math.min(1.0f, Math.max(0.0f, d51Var.f23472f / (d51Var.f23470b * 2.0f)));
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        d51 d51Var = this.E0;
        r51 r51Var = d51Var.e;
        int i12 = d51Var.f23470b;
        GradientDrawable gradientDrawable = d51Var.f23471c;
        float Z = Z();
        boolean z13 = false;
        ...
        if (this.D0 != z11) {
            this.D0 = z11;
            if (AndroidUtilities.computePerceivedBrightness(d51Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19129h5)) > 0.721f) {
                z12 = true;
            } else {
                z12 = false;
            }
            if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.h6.v(d51Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19337s8), 855638016)) > 0.721f) {
                z13 = true;
            }
            if (!z11) {
                z12 = z13;
        ...
        if (this.B0 > 0.0f) {
            int themedColor2 = d51Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19129h5);
            Paint paint = this.f23204w0;
            paint.setColor(themedColor2);
            int max = (int) Math.max(0.0f, r51Var.getTranslationY() + (AndroidUtilities.statusBarHeight - i12) + ((1.0f - Z()) * i12) + d51Var.f23472f + AndroidUtilities.dp(24.0f));
            i10 = ((org.telegram.ui.ActionBar.e3) d51Var).backgroundPaddingLeft;
        ...
        gradientDrawable.setBounds((getWidth() - dp) / 2, org.telegram.messenger.f0.C(10.0f, d51Var.f23472f, i13), (getWidth() + dp) / 2, AndroidUtilities.dp(10.0f) + d51Var.f23472f + i13 + dp2);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (Z > 0.0f && Z < 1.0f) {
            ...
            gradientDrawable.setColor(d51Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19129h5));
            float[] fArr = this.C0;
            fArr[3] = dp;
            fArr[2] = dp;
            fArr[1] = dp;
            ...
            gradientDrawable.setBounds(i12, d51Var.f23472f + i15, width - i13, AndroidUtilities.dp(24.0f) + d51Var.f23472f + i15);
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            d51 d51Var = this.E0;
            if (d51Var.f23472f != 0 && motionEvent.getY() < d51Var.f23472f) {
                d51Var.dismiss();
                return true;
            }
        }
