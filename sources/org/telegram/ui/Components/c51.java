...
public final class c51 extends ll0 {
    ...
    public int f22940w;
    public final d51 f22941x;
    public final SparseArray d = new SparseArray();
    public final ArrayList e = new ArrayList();
    public final SparseArray f22936f = new SparseArray();
    public final HashMap h = new HashMap();
    public final ArrayList f22937n = new ArrayList();
    public int v = 5;
    ...
    public final void E(View view, int i10, boolean z10) {
        ...
        boolean z16;
        boolean z17;
        d51 d51Var = this.f22941x;
        LongSparseArray longSparseArray = d51Var.e;
        LongSparseArray longSparseArray2 = d51Var.d;
        TLRPC.StickerSetCovered[] stickerSetCoveredArr = d51Var.f23242c;
        int i11 = d51Var.f23240a;
        MediaDataController mediaDataController = MediaDataController.getInstance(i11);
        int i12 = this.f22940w;
        ArrayList arrayList = this.e;
        SparseArray sparseArray = this.d;
        if (i10 < i12) {
            stickerSetCovered = (TLRPC.StickerSetCovered) arrayList.get(((Integer) sparseArray.get(i10)).intValue());
            ArrayList<Long> unreadStickerSets = mediaDataController.getUnreadStickerSets();
            if (unreadStickerSets != null && unreadStickerSets.contains(Long.valueOf(stickerSetCovered.set.f18110id))) {
                z17 = true;
            } else {
                z17 = false;
            }
            if (z17) {
                mediaDataController.markFeaturedStickersByIdAsRead(false, stickerSetCovered.set.f18110id);
            }
            z11 = z17;
        } else {
            stickerSetCovered = (TLRPC.StickerSetCovered) arrayList.get(((Integer) sparseArray.get(i10)).intValue());
        ...
        while (true) {
            if (i13 < stickerSetCoveredArr.length) {
                if (stickerSetCoveredArr[i13] != null) {
                    TLRPC.TL_messages_stickerSet stickerSetById = MediaDataController.getInstance(i11).getStickerSetById(stickerSetCoveredArr[i13].set.f18110id);
                    if (stickerSetById != null && !stickerSetById.set.archived) {
                        stickerSetCoveredArr[i13] = null;
                    } else if (stickerSetCoveredArr[i13].set.f18110id == stickerSetCovered2.set.f18110id) {
                        z12 = true;
                        break;
                    }
                }
        ...
        boolean isStickerPackInstalled = mediaDataController.isStickerPackInstalled(stickerSetCovered2.set.f18110id);
        if (longSparseArray2.indexOfKey(stickerSetCovered2.set.f18110id) >= 0) {
            z13 = true;
        } else {
            z13 = false;
        }
        if (longSparseArray.indexOfKey(stickerSetCovered2.set.f18110id) >= 0) {
            z14 = true;
        } else {
            z14 = false;
        }
        if (z13 && isStickerPackInstalled) {
            longSparseArray2.remove(stickerSetCovered2.set.f18110id);
            z13 = false;
        } else if (z14 && !isStickerPackInstalled) {
            longSparseArray.remove(stickerSetCovered2.set.f18110id);
        }
    ...
    public final void G() {
        ...
        SparseArray sparseArray = this.d;
        sparseArray.clear();
        SparseArray sparseArray2 = this.f22936f;
        sparseArray2.clear();
        ...
        arrayList.clear();
        this.f22940w = 0;
        MediaDataController mediaDataController = MediaDataController.getInstance(d51Var.f23240a);
        ArrayList arrayList2 = new ArrayList(mediaDataController.getFeaturedStickerSets());
        int size = arrayList2.size();
        arrayList2.addAll(this.f22937n);
        int i11 = 0;
        int i12 = 0;
        while (true) {
            int i13 = 1;
            ...
            if (!stickerSetCovered.covers.isEmpty() || stickerSetCovered.cover != null) {
                if (i11 == size) {
                    int i14 = this.f22940w;
                    this.f22940w = i14 + 1;
                    sparseArray.put(i14, -1);
                }
                arrayList.add(stickerSetCovered);
                sparseArray2.put(this.f22940w, stickerSetCovered);
                hashMap.put(stickerSetCovered, Integer.valueOf(this.f22940w));
                int i15 = this.f22940w;
                this.f22940w = i15 + 1;
                int i16 = i12 + 1;
                ...
                if (!stickerSetCovered.covers.isEmpty()) {
                    ...
                    for (int i17 = 0; i17 < stickerSetCovered.covers.size(); i17++) {
                        sparseArray.put(this.f22940w + i17, stickerSetCovered.covers.get(i17));
                    }
                } else {
                    sparseArray.put(this.f22940w, stickerSetCovered.cover);
                }
                int i18 = 0;
                while (true) {
                    i10 = this.v * i13;
                    ...
                    sparseArray2.put(this.f22940w + i18, stickerSetCovered);
                    i18++;
                }
                this.f22940w = i10 + this.f22940w;
                i12 = i16;
            }
            i11++;
        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        ((org.telegram.ui.Cells.g8) view).d((TLRPC.Document) this.d.get(i10), null, this.f22936f.get(i10), null, false, false);
    }
                    ...
                    if (i10 != 3) {
                        if (i10 != 4) {
                            if (i10 != 5) {
                                ...
                                org.telegram.ui.Cells.o3 o3Var2 = new org.telegram.ui.Cells.o3(context, d6Var);
                                o3Var2.setAddOnClickListener(new View.OnClickListener(this) {
                                    public final c51 f22581b;
                                    ...
                                    public final void onClick(View view) {
                                        switch (r2) {
                                            case 0:
                                                ...
                                                c51 c51Var = this.f22581b;
                                                d51 d51Var2 = c51Var.f22941x;
                                                LongSparseArray longSparseArray = d51Var2.d;
                                                LongSparseArray longSparseArray2 = d51Var2.e;
                                                if (longSparseArray.indexOfKey(stickerSet.set.f18110id) < 0 && longSparseArray2.indexOfKey(stickerSet.set.f18110id) < 0) {
                                                    if (s3Var.f20913r) {
                                                        longSparseArray2.put(stickerSet.set.f18110id, stickerSet);
                                                        d51Var2.f23241b.h(stickerSet);
                                                        return;
                                                    }
                                                    c51Var.F(stickerSet, s3Var);
                                                    return;
                                                }
                                                return;
                                            default:
                                                ...
                                                c51 c51Var2 = this.f22581b;
                                                d51 d51Var3 = c51Var2.f22941x;
                                                LongSparseArray longSparseArray3 = d51Var3.d;
                                                LongSparseArray longSparseArray4 = d51Var3.e;
                                                if (longSparseArray3.indexOfKey(stickerSet2.set.f18110id) < 0 && longSparseArray4.indexOfKey(stickerSet2.set.f18110id) < 0) {
                                                    if (o3Var3.f20533s) {
                                                        longSparseArray4.put(stickerSet2.set.f18110id, stickerSet2);
                                                        d51Var3.f23241b.h(stickerSet2);
                                                        return;
                                                    }
                            ...
                            o3Var = new org.telegram.ui.Cells.v3(context, d6Var);
                        }
                    } else {
                        o3Var = new View(context);
                    }
                } else {
                    org.telegram.ui.Cells.s3 s3Var = new org.telegram.ui.Cells.s3(17, this.f22935c, d51Var.P, true, true);
