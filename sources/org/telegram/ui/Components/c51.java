...
public final class c51 extends kl0 {
    ...
    public int f24902w;
    public final d51 f24903x;
    public final SparseArray d = new SparseArray();
    public final ArrayList f24897e = new ArrayList();
    public final SparseArray f24898f = new SparseArray();
    public final HashMap h = new HashMap();
    public final ArrayList f24899n = new ArrayList();
    public int v = 5;
    ...
    public final void E(View view, int i10, boolean z10) {
        ...
        boolean z16;
        boolean z17;
        d51 d51Var = this.f24903x;
        LongSparseArray longSparseArray = d51Var.f25233e;
        LongSparseArray longSparseArray2 = d51Var.d;
        TLRPC.StickerSetCovered[] stickerSetCoveredArr = d51Var.f25232c;
        int i11 = d51Var.f25230a;
        MediaDataController mediaDataController = MediaDataController.getInstance(i11);
        int i12 = this.f24902w;
        ArrayList arrayList = this.f24897e;
    ...
    public final void G() {
        ...
        SparseArray sparseArray = this.d;
        sparseArray.clear();
        SparseArray sparseArray2 = this.f24898f;
        sparseArray2.clear();
        ...
        arrayList.clear();
        this.f24902w = 0;
        MediaDataController mediaDataController = MediaDataController.getInstance(d51Var.f25230a);
        ArrayList arrayList2 = new ArrayList(mediaDataController.getFeaturedStickerSets());
        int size = arrayList2.size();
        arrayList2.addAll(this.f24899n);
        int i11 = 0;
        int i12 = 0;
        while (true) {
            int i13 = 1;
            ...
            if (!stickerSetCovered.covers.isEmpty() || stickerSetCovered.cover != null) {
                if (i11 == size) {
                    int i14 = this.f24902w;
                    this.f24902w = i14 + 1;
                    sparseArray.put(i14, -1);
                }
                arrayList.add(stickerSetCovered);
                sparseArray2.put(this.f24902w, stickerSetCovered);
                hashMap.put(stickerSetCovered, Integer.valueOf(this.f24902w));
                int i15 = this.f24902w;
                this.f24902w = i15 + 1;
                int i16 = i12 + 1;
                ...
                if (!stickerSetCovered.covers.isEmpty()) {
                    ...
                    for (int i17 = 0; i17 < stickerSetCovered.covers.size(); i17++) {
                        sparseArray.put(this.f24902w + i17, stickerSetCovered.covers.get(i17));
                    }
                } else {
                    sparseArray.put(this.f24902w, stickerSetCovered.cover);
                }
                int i18 = 0;
                while (true) {
                    i10 = this.v * i13;
                    ...
                    sparseArray2.put(this.f24902w + i18, stickerSetCovered);
                    i18++;
                }
                this.f24902w = i10 + this.f24902w;
                i12 = i16;
            }
            i11++;
        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        ((org.telegram.ui.Cells.f8) view).d((TLRPC.Document) this.d.get(i10), null, this.f24898f.get(i10), null, false, false);
    }
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 != 2) {
                                    ...
                                    public final void onClick(View view) {
                                        switch (r2) {
                                            case 0:
                                                ...
                                                c51 c51Var = this.f24557b;
                                                d51 d51Var2 = c51Var.f24903x;
                                                LongSparseArray longSparseArray = d51Var2.d;
                                                LongSparseArray longSparseArray2 = d51Var2.f25233e;
                                            ...
                                            default:
                                                ...
                                                c51 c51Var2 = this.f24557b;
                                                d51 d51Var3 = c51Var2.f24903x;
                                                LongSparseArray longSparseArray3 = d51Var3.d;
                                                LongSparseArray longSparseArray4 = d51Var3.f25233e;
                    ...
                    org.telegram.ui.Cells.r3 r3Var = new org.telegram.ui.Cells.r3(17, this.f24896c, d51Var.P, true, true);
