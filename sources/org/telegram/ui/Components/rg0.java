...
public final class rg0 extends xw0 {
    ...
    public final Paint f27909b = new Paint(1);
    public final int f27910c = UserConfig.selectedAccount;
    public long d = 0;
    public boolean e = false;
    public final RectF f27911f = new RectF();
    public float f27912g;
    public final boolean h;
    public final org.telegram.ui.ActionBar.d6 f27913i;

    public rg0(org.telegram.ui.ActionBar.d6 d6Var, boolean z10) {
        this.h = z10;
        this.f27913i = d6Var;
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        int v02 = org.telegram.ui.ActionBar.h6.v0(i10, this.f27913i);
        Paint paint = this.f27909b;
        paint.setColor(v02);
        RectF rectF = this.f27911f;
        rectF.set(0.0f, i12, dp, i12 + dp);
        float f10 = this.f27912g;
        if (f10 < 0.5f) {
    ...
    public final void f() {
        if (this.e) {
            if (!NotificationCenter.getInstance(this.f27910c).isAnimationInProgress()) {
                ...
                if (this.f27912g >= 1.0f) {
                    this.f27912g = 0.0f;
                }
                float f7 = (((float) j3) / 300.0f) + this.f27912g;
                this.f27912g = f7;
                if (f7 > 1.0f) {
                    this.f27912g = 1.0f;
                }
