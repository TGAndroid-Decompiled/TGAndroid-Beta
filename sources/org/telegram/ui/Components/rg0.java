...
public final class rg0 extends org.telegram.ui.Cells.a0 implements ao0, DownloadController.FileDownloadProgressListener {
    ...
    public final void onDetachedFromWindow() {
        ...
        DownloadController.getInstance(this.f27627n).removeLoadingFileObserver(this);
    }
    ...
    public final void onDraw(Canvas canvas) {
        if (this.h != null) {
            ...
            org.telegram.ui.ActionBar.h6.f19023q3.n((int) getY(), i11, i10);
            org.telegram.ui.ActionBar.e5 e5Var = org.telegram.ui.ActionBar.h6.f19023q3;
            int measuredWidth2 = getMeasuredWidth();
            int measuredHeight = getMeasuredHeight();
            if (e5Var != null) {
                e5Var.setBounds(0, 0, measuredWidth2, measuredHeight);
            }
            org.telegram.ui.ActionBar.h6.f19023q3.draw(canvas);
            if (this.h == null) {
                return;
            }
            canvas.save();
            int i12 = this.f27632y;
            if (i12 != 0 && i12 != 1) {
                canvas.translate(AndroidUtilities.dp(12.0f) + this.f27630w, this.f27631x);
                zh0 zh0Var = this.v;
                float f7 = zh0Var.e / 2;
                float f10 = zh0Var.f30602f / 2.0f;
                canvas.drawRect(0.0f, f7 - f10, zh0Var.d, f10 + f7, zh0Var.f30599a);
                float f11 = zh0Var.e / 2;
                canvas.drawRect(0.0f, f11 - f10, zh0Var.f30601c * zh0Var.d, f10 + f11, zh0Var.f30600b);
            } else {
                canvas.translate(this.f27630w, this.f27631x);
                this.f27629s.b(canvas);
            }
            canvas.restore();
            int i13 = this.f27632y;
            this.f27628r.setColor(-6182221);
    ...
    public final void r() {
        ...
        if (FileLoader.getInstance(this.f27627n).getPathToMessage(this.h.messageOwner).exists()) {
            DownloadController.getInstance(this.f27627n).removeLoadingFileObserver(this);
            ...
            DownloadController.getInstance(this.f27627n).addLoadingFileObserver(fileName, this);
            if (!FileLoader.getInstance(this.f27627n).isLoadingFile(fileName)) {
                this.f27632y = 2;
                zh0Var.a(0.0f);
            } else {
                this.f27632y = 3;
    ...
    public final void s() {
        int i10;
        TextPaint textPaint = this.f27628r;
        MessageObject messageObject = this.h;
        if (messageObject == null) {
            return;
        }
        bo0 bo0Var = this.f27629s;
        if (!bo0Var.e) {
    ...
    public void setMessageObject(MessageObject messageObject) {
        if (this.h != messageObject) {
            this.f27627n = messageObject.currentAccount;
            bo0 bo0Var = this.f27629s;
            int i10 = org.telegram.ui.ActionBar.h6.f19107ud;
            int w02 = org.telegram.ui.ActionBar.h6.w0(null, i10, false);
            int w03 = org.telegram.ui.ActionBar.h6.w0(null, i10, false);
            int i11 = org.telegram.ui.ActionBar.h6.f19159xd;
            bo0Var.h(w02, w03, org.telegram.ui.ActionBar.h6.w0(null, i11, false), org.telegram.ui.ActionBar.h6.w0(null, i11, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19142wd, false));
            zh0 zh0Var = this.v;
            zh0Var.f30599a.setColor(-2497813);
            zh0Var.f30600b.setColor(-7944712);
