...
public final class vl0 extends lw0 {
    public float d;
    public final Paint f28825f;
    public boolean f28822a = false;
    public long f28823b = 0;
    public boolean f28824c = false;
    public int e = 1;

    public vl0(boolean z10) {
        if (z10) {
            this.f28825f = new Paint(1);
        }
    }

    @Override
    public final void b(int i10) {
        Paint paint = this.f28825f;
        if (paint != null) {
            paint.setColor(i10);
        }
    }
    ...
    @Override
    public final void d() {
        this.f28823b = System.currentTimeMillis();
        this.f28824c = true;
        invalidateSelf();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.f28824c) {
            ...
            long j3 = currentTimeMillis - this.f28823b;
