...
public final class vl0 extends lw0 {
    ...
    public vl0(boolean z10) {
        if (z10) {
            this.f28828f = new Paint(1);
        }
    }

    @Override
    public final void b(int i10) {
        Paint paint = this.f28828f;
        if (paint != null) {
            paint.setColor(i10);
        }
    }
    ...
    @Override
    public final void d() {
        this.f28826b = System.currentTimeMillis();
        this.f28827c = true;
        invalidateSelf();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.f28827c) {
            ...
            long j3 = currentTimeMillis - this.f28826b;
            this.f28826b = currentTimeMillis;
            if (j3 > 50) {
                j3 = 50;
            }
            float f10 = this.d;
