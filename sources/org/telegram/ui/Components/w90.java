...
public final class w90 extends ov0 {
    public final int f32219w0;
    public final FrameLayout f32220x0;
    public final org.telegram.ui.ActionBar.n2 f32221y0;

    public w90(org.telegram.ui.ActionBar.n2 n2Var, Context context, FrameLayout frameLayout, int i10) {
        super(context, null);
        this.f32219w0 = i10;
        this.f32221y0 = n2Var;
        this.f32220x0 = frameLayout;
    }

    @Override
    public void L(Canvas canvas, ArrayList arrayList) {
        switch (this.f32219w0) {
            case 0:
                ((ca0) this.f32221y0).V.Q(canvas, arrayList);
                return;
            default:
                return;
        }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        switch (this.f32219w0) {
            case 0:
                ca0 ca0Var = (ca0) this.f32221y0;
                z90 z90Var = ca0Var.V;
                if (z90Var != null && (qt0Var = (qt0VarArr = z90Var.f32703k0)[0]) != null && qt0Var.h.getFastScroll() != null && qt0VarArr[0].h.getFastScroll().f30343n) {
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        switch (this.f32219w0) {
            case 1:
                PasscodeActivity passcodeActivity = (PasscodeActivity) this.f32221y0;
                int visibility = passcodeActivity.v.getVisibility();
                FrameLayout frameLayout = this.f32220x0;
                ...
                return;
            case 2:
                org.telegram.ui.j0 j0Var = (org.telegram.ui.j0) this.f32220x0;
                hh1 hh1Var = (hh1) this.f32221y0;
                if (hh1Var.f37011e0.getVisibility() != 8 && R() >= AndroidUtilities.dp(20.0f)) {
                    if (hh1Var.v0()) {
                ...
                } else if (hh1Var.f37011e0.getVisibility() != 8) {
                ...
                hh1Var.f37011e0.layout(0, measuredHeight2, getMeasuredWidth(), AndroidUtilities.dp(230.0f) + measuredHeight2);
                return;
            default:
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        switch (this.f32219w0) {
            case 0:
                ca0 ca0Var = (ca0) this.f32221y0;
                q6[] q6VarArr = ca0Var.f24957x;
                org.telegram.ui.ActionBar.j5[] j5VarArr = ca0Var.f24956w;
                ...
                FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) this.f32220x0.getLayoutParams();
                ...
                ((FrameLayout.LayoutParams) ca0Var.f24958y.getLayoutParams()).topMargin = org.telegram.messenger.vl.y(42.0f, org.telegram.ui.ActionBar.k.getCurrentActionBarHeight(), 2);
            ...
            case 1:
                ...
                this.f32220x0.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(size2, 1073741824));
            ...
            default:
                ...
                ((org.telegram.ui.j0) this.f32220x0).measure(View.MeasureSpec.makeMeasureSpec(size3, 1073741824), View.MeasureSpec.makeMeasureSpec(size4, 1073741824));
                hh1Var.f37011e0.measure(View.MeasureSpec.makeMeasureSpec(size3, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(230.0f), 1073741824));
                return;
        }
    }
}
