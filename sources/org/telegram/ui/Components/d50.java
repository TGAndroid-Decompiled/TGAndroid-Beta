...
public final class d50 {
    ...
    public final FloatBuffer f24162g;
    public final FloatBuffer h;
    public final int[] f24165k;
    public final c50 f24160c = new c50(R.raw.round_blur_stage_0_frag);
    public final c50 d = new c50(R.raw.round_blur_stage_3_frag);
    public final a50 e = new a50();
    public final b50 f24161f = new b50();
    public int f24163i = 0;
    public final int[] f24164j = new int[1];
    ...
    public d50(int i10, int i11) {
        ...
        for (int i19 = 5; i18 < i19; i19 = 5) {
            GLES20.glBindTexture(3553, this.f24165k[i18]);
            if (i18 < 2) {
                i12 = 9729;
            } else {
                i12 = 9728;
            ...
            if (i18 == 4) {
                ...
                float c3 = vh.v2.c(i21, this.f24158a, 2.0f, -1.0f);
                ...
                float f10 = (round3 / this.f24158a) * 2.0f;
        ...
        GLES20.glGenFramebuffers(1, this.f24164j, 0);
    ...
    public final void b() {
        ...
        this.f24161f.a();
        this.d.a();
        GLES20.glDeleteTextures(5, this.f24165k, 0);
        GLES20.glDeleteFramebuffers(1, this.f24164j, 0);
    }
}
