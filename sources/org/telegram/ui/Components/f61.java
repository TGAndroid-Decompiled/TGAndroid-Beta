...
public class f61 extends ml0 {
    ...
    public final x51 Y2;
    public s4.y Z2;
    public boolean f23798a3;
    public boolean f23799b3;
    public boolean f23800c3;
    public s4.c1 f23801d3;
    public boolean f23802e3;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (!c1()) {
            ...
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                ...
                int i12 = v51Var.f28637b;
                if (i12 >= 0) {
                    int i13 = v51Var.f28636a;
                    if (x51Var.f29853n) {
                    ...
                    if (i12 >= i13 && i13 >= 0 && i12 >= 0) {
                        ...
                        if (i14 < i15) {
                            if (this.f26204u2 == null) {
                                this.f26204u2 = new Paint(1);
                            }
                            this.f26204u2.setColor(v02);
                            canvas.drawRect(0.0f, i14, getWidth(), i15, this.f26204u2);
                        }
                    }
                }
            }
