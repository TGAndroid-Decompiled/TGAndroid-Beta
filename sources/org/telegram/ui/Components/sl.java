...
public final class sl extends AnimatorListenerAdapter {
    public final ChatAttachAlertPhotoLayout f27906a;

    public sl(ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout) {
        this.f27906a = chatAttachAlertPhotoLayout;
    }

    @Override
    public final void onAnimationEnd(Animator animator) {
        int i10;
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.f27906a;
        ...
        ObjectAnimator.ofFloat(chatAttachAlertPhotoLayout.f21933r0, View.SCALE_X, 1.0f).setDuration(100L).start();
    }
}
