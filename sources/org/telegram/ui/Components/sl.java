...
public final class sl extends AnimatorListenerAdapter {
    public final ChatAttachAlertPhotoLayout f27883a;

    public sl(ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout) {
        this.f27883a = chatAttachAlertPhotoLayout;
    }

    @Override
    public final void onAnimationEnd(Animator animator) {
        int i10;
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.f27883a;
        ...
        ObjectAnimator.ofFloat(chatAttachAlertPhotoLayout.f21949r0, View.SCALE_X, 1.0f).setDuration(100L).start();
    }
}
