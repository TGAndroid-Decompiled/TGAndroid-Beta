...
public final class sl extends AnimatorListenerAdapter {
    public final ChatAttachAlertPhotoLayout f30351a;

    public sl(ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout) {
        this.f30351a = chatAttachAlertPhotoLayout;
    }

    @Override
    public final void onAnimationEnd(Animator animator) {
        int i10;
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.f30351a;
        ...
        ObjectAnimator.ofFloat(chatAttachAlertPhotoLayout.f23870r0, View.SCALE_X, 1.0f).setDuration(100L).start();
    }
}
