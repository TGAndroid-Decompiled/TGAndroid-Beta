...
public final class sl extends AnimatorListenerAdapter {
    public final ChatAttachAlertPhotoLayout f28271a;

    public sl(ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout) {
        this.f28271a = chatAttachAlertPhotoLayout;
    }

    @Override
    public final void onAnimationEnd(Animator animator) {
        int i10;
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.f28271a;
        ...
        ObjectAnimator.ofFloat(chatAttachAlertPhotoLayout.f22173r0, View.SCALE_X, 1.0f).setDuration(100L).start();
    }
}
