...
public final class x20 extends FrameLayout {
    ...
    public final w20 f32443e;
    public final ue f32444f;
    public final float h;
    public final z20 f32445n;

    public x20(z20 z20Var, Context context, float f7) {
        super(context);
        this.f32445n = z20Var;
        this.h = f7;
        this.f32443e = new w20(this);
        this.f32444f = new ue(7);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (i12 != z20Var.I || z20Var.J != point.y) {
            ...
            if (z20Var.K < 0.0f) {
                ...
                this.f32445n.K = sharedPreferences.getFloat("relativeX", 1.0f);
                this.f32445n.L = sharedPreferences.getFloat("relativeY", 0.4f);
            }
            z20 z20Var2 = z20.f33082d0;
            if (z20Var2 != null) {
                z20 z20Var3 = this.f32445n;
                float f7 = z20Var3.K;
                float f10 = z20Var3.L;
                float f11 = -AndroidUtilities.dp(36.0f);
                z20Var2.f33093r.x = (int) com.google.android.gms.internal.vision.e2.z(AndroidUtilities.displaySize.x - (2.0f * f11), AndroidUtilities.dp(105.0f), f7, f11);
                z20Var2.f33093r.y = (int) ((AndroidUtilities.displaySize.y - AndroidUtilities.dp(105.0f)) * f10);
                z20Var2.h();
                x20 x20Var = z20Var2.f33084a;
                if (x20Var.getParent() != null) {
                    z20Var2.f33092n.updateViewLayout(x20Var, z20Var2.f33093r);
                }
            }
        }
    }
        ...
        if (action != 0) {
            if (action != 1) {
                if (action != 2) {
                    ...
                    float f10 = rawX - this.f32440a;
                    float f11 = rawY - this.f32441b;
                    if (!this.f32445n.W) {
                        ...
                        if (f12 > f13 * f13) {
                            ...
                            AndroidUtilities.cancelRunOnUIThread(this.f32443e);
                            z20 z20Var4 = this.f32445n;
                            z20Var4.W = true;
                            z20Var4.f(true);
                            this.f32445n.e(false);
                            this.f32440a = rawX;
                            this.f32441b = rawY;
                            f10 = 0.0f;
                            f11 = 0.0f;
                    ...
                    this.f32441b = rawY;
                    z20Var5.i();
                    float measuredWidth = (getMeasuredWidth() / 2.0f) + this.f32445n.O;
                    float measuredHeight = (getMeasuredHeight() / 2.0f) + this.f32445n.P;
                    float measuredWidth2 = (z20Var2.f33086b.getMeasuredWidth() / 2.0f) + (z20Var2.N - this.f32445n.Q);
                    float measuredHeight2 = (z20Var3.f33086b.getMeasuredHeight() / 2.0f) + (z20Var3.M - this.f32445n.R);
                    ...
                    if (f16 < AndroidUtilities.dp(80.0f) * AndroidUtilities.dp(80.0f)) {
                        ...
                        this.f32445n.U.setRemoveAngle(d - degrees);
                    ...
                    z20 z20Var6 = this.f32445n;
                    if (!z20Var6.F && z20Var6.f33085a0 != z10) {
                        z20Var6.f33085a0 = z10;
                        ValueAnimator valueAnimator = z20Var6.f33089c0;
                        if (valueAnimator != null) {
                            valueAnimator.removeAllListeners();
                            z20Var6.f33089c0.cancel();
                        }
                        float f17 = z20Var6.f33087b0;
                        if (z10) {
                            f7 = 1.0f;
                        } else {
                            f7 = 0.0f;
                        ...
                        z20Var6.f33089c0 = ofFloat;
                        ofFloat.addUpdateListener(new l6(z20Var6, 25));
                        z20Var6.f33089c0.addListener(new org.telegram.ui.to(11, z20Var6, z10));
                        z20Var6.f33089c0.setDuration(250L);
                        z20Var6.f33089c0.setInterpolator(pr.f29494f);
                        z20Var6.f33089c0.start();
                    }
                    z20 z20Var7 = this.f32445n;
                    f30 f30Var = z20Var7.U;
                    if (z20Var7.f33097y != z11) {
                        z20Var7.f33097y = z11;
                        z20Var7.f33088c.invalidate();
                        if (!z20Var7.F) {
            ...
            AndroidUtilities.cancelRunOnUIThread(this.f32444f);
            AndroidUtilities.cancelRunOnUIThread(this.f32443e);
            z20 z20Var8 = this.f32445n;
            if (z20Var8.f33097y) {
                if (this.f32442c && VoIPService.getSharedInstance() != null) {
                    VoIPService.getSharedInstance().setMicMute(true, false, false);
                }
                this.f32442c = false;
                z20 z20Var9 = this.f32445n;
                aj0 aj0Var = z20Var9.V;
                xi0 xi0Var2 = z20Var9.v;
                ah.y yVar = z20Var9.f33086b;
                x20 x20Var2 = z20Var9.f33084a;
                di.r6 r6Var = z20Var9.f33088c;
                z20 z20Var10 = z20.f33082d0;
                if (z20Var10 == null) {
                    return false;
                }
                z20Var9.F = true;
                ...
                z20Var9.U.K = true;
                z20Var10.e(false);
                float measuredWidth3 = (x20Var2.getMeasuredWidth() / 2.0f) + z20Var9.f33093r.x;
                float measuredWidth4 = ((yVar.getMeasuredWidth() / 2.0f) + (z20Var9.N - z20Var9.Q)) - measuredWidth3;
                float measuredHeight3 = ((yVar.getMeasuredHeight() / 2.0f) + (z20Var9.M - z20Var9.R)) - ((x20Var2.getMeasuredHeight() / 2.0f) + z20Var9.f33093r.y);
                z20 z20Var11 = z20.f33082d0;
                WindowManager windowManager = z20Var11.f33092n;
                x20 x20Var3 = z20Var11.f33084a;
                ah.y yVar2 = z20Var11.f33086b;
                FrameLayout frameLayout = z20Var11.d;
                org.telegram.ui.u7 u7Var = z20Var11.f33090e;
                z20Var9.d();
                z20.f33082d0 = null;
                AnimatorSet animatorSet = new AnimatorSet();
                int i11 = xi0Var2.f32581b0;
                if (i11 < 33) {
                    x20Var = x20Var3;
                ...
                float f19 = z20Var9.f33093r.y;
                ValueAnimator ofFloat3 = ValueAnimator.ofFloat(f19, (f19 + measuredHeight3) - AndroidUtilities.dp(30.0f), z20Var9.f33093r.y + measuredHeight3);
            ...
            if (this.f32442c) {
                ...
                this.f32442c = false;
            } else if (motionEvent.getAction() == 1 && !this.f32445n.W) {
                if (VoIPService.getSharedInstance() != null) {
                    this.f32445n.e(!z20Var.f33095w);
                    return false;
                }
                return false;
            } else {
            ...
            if (parent != null && this.f32445n.W) {
                parent.requestDisallowInterceptTouchEvent(z12);
                Point point = AndroidUtilities.displaySize;
                int i12 = point.x;
                int i13 = point.y;
                float f21 = this.f32445n.f33093r.x;
                float measuredWidth5 = getMeasuredWidth() + f21;
                float f22 = this.f32445n.f33093r.y;
                float measuredHeight4 = getMeasuredHeight() + f22;
                this.d = new AnimatorSet();
                float f23 = -AndroidUtilities.dp(36.0f);
                if (f21 < f23) {
                    ValueAnimator ofFloat11 = ValueAnimator.ofFloat(this.f32445n.f33093r.x, f23);
                    ofFloat11.addUpdateListener(this.f32445n.S);
                    this.d.playTogether(ofFloat11);
                    f21 = f23;
                } else if (measuredWidth5 > i12 - f23) {
                    float measuredWidth6 = (i12 - getMeasuredWidth()) - f23;
                    ValueAnimator ofFloat12 = ValueAnimator.ofFloat(this.f32445n.f33093r.x, measuredWidth6);
                    ofFloat12.addUpdateListener(this.f32445n.S);
                ...
                if (f22 < AndroidUtilities.statusBarHeight - AndroidUtilities.dp(36.0f)) {
                    ...
                    ValueAnimator ofFloat13 = ValueAnimator.ofFloat(this.f32445n.f33093r.y, f22);
                    ofFloat13.addUpdateListener(this.f32445n.T);
                    this.d.playTogether(ofFloat13);
                } else if (measuredHeight4 > dp) {
                    f22 = dp - getMeasuredHeight();
                    ValueAnimator ofFloat14 = ValueAnimator.ofFloat(this.f32445n.f33093r.y, f22);
                    ofFloat14.addUpdateListener(this.f32445n.T);
                    this.d.playTogether(ofFloat14);
                }
                this.d.setDuration(150L).setInterpolator(pr.f29494f);
                this.d.start();
                z20 z20Var12 = this.f32445n;
                if (z20Var12.K >= 0.0f) {
                    ...
                    z20 z20Var13 = this.f32445n;
                    float f25 = z20Var13.H[0];
                    z20Var13.K = f25;
                    SharedPreferences.Editor putFloat = edit.putFloat("relativeX", f25);
                    z20 z20Var14 = this.f32445n;
                    float f26 = z20Var14.H[1];
                    z20Var14.L = f26;
                    putFloat.putFloat("relativeY", f26).apply();
                }
            }
            z20 z20Var15 = this.f32445n;
            z20Var15.W = false;
            z20Var15.f(false);
            return true;
        }
        getLocationOnScreen(this.f32445n.G);
        z20 z20Var16 = this.f32445n;
        int i14 = z20Var16.G[0];
        WindowManager.LayoutParams layoutParams = z20Var16.f33093r;
        z20Var16.Q = i14 - layoutParams.x;
        z20Var16.R = iArr[1] - layoutParams.y;
        this.f32440a = rawX;
        this.f32441b = rawY;
        System.currentTimeMillis();
        AndroidUtilities.runOnUIThread(this.f32443e, 300L);
        z20 z20Var17 = this.f32445n;
        WindowManager.LayoutParams layoutParams2 = z20Var17.f33093r;
