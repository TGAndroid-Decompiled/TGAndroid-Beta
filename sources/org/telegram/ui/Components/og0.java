...
public final class og0 implements rf.a {
    public static final tv0 f27044n0 = new tv0(new fa0(10), new fa0(11));
    public static final tv0 f27045o0 = new tv0(new fa0(12), new fa0(13));
    public static final og0 f27046p0 = new og0();
    public boolean E;
    ...
    public boolean Y;
    public float Z;
    public float f27048a0;
    public WindowManager f27049b;
    public ai.n4 f27050b0;
    public WindowManager.LayoutParams f27051c;
    public boolean f27052c0;
    public org.telegram.ui.f d;
    public boolean f27053d0;
    public ng0 e;
    public View f27055f;
    public boolean f27056f0;
    public ng0 h;
    public boolean f27059i0;
    public View f27061k0;
    public TextureView f27062l0;
    public boolean m0;
    public boolean f27063n;
    public ag0 f27064r;
    public ScaleGestureDetector f27065s;
    public ka.c v;
    public boolean f27066w;
    public boolean f27067x;
    public View f27068y;
    public float f27047a = 1.4f;
    public float J = 1.0f;
    public final k71 Q = new k71(false);
    public final jg0 f27054e0 = new jg0(this, 1);
    public float[] f27057g0 = new float[2];
    public final jg0 f27058h0 = new jg0(this, 2);
    public final jg0 f27060j0 = new jg0(this, 3);

    public static void j(boolean z10) {
        f27046p0.k(z10, false);
    }
    ...
    public static sk0 o(float f7, boolean z10) {
        ...
        og0 og0Var = f27046p0;
        if (og0Var.P && !z10) {
            obj.f28265a = og0Var.K;
            obj.f28266b = og0Var.L + AndroidUtilities.statusBarHeight;
            obj.f28267c = og0Var.H;
            obj.d = og0Var.I;
            return obj;
        }
        ...
        obj.f28267c = s(f10) * f13;
        obj.d = ((int) (s(f10) * f10)) * f13;
        if (f11 != -1.0f) {
            float f14 = obj.f28267c;
            ...
            obj.f28265a = (AndroidUtilities.displaySize.x - obj.f28267c) - AndroidUtilities.dp(16.0f);
        }
        if (f12 != -1.0f) {
            obj.f28266b = w7.q.a(f12, AndroidUtilities.dp(16.0f), (AndroidUtilities.displaySize.y - AndroidUtilities.dp(16.0f)) - obj.d) + AndroidUtilities.statusBarHeight;
            return obj;
        }
        obj.f28266b = AndroidUtilities.dp(16.0f) + AndroidUtilities.statusBarHeight;
        return obj;
    }
    ...
    public static void w(PhotoViewer photoViewer) {
        ...
        if (s71Var != null && sf.c.a(photoViewer.f31401y) == 1) {
            pf.d dVar = new pf.d(photoViewer.f31401y, og0Var);
            dVar.f41052c = "photo-viewer-pip-" + s71Var.f28181a;
            dVar.e = 1;
            dVar.d = AndroidUtilities.dp(10.0f);
            dVar.f41056j = og0Var.d;
            dVar.f41057k = og0Var.f27061k0;
            int i10 = og0Var.S;
            int i11 = og0Var.T;
            dVar.h = i10;
            dVar.f41055i = i11;
            dVar.f41054g = s71Var.d;
            dVar.f41053f = true;
            og0Var.W = dVar.a();
        }
        og0Var.z();
    ...
    public final void a(com.google.android.gms.internal.cast.p pVar) {
        ...
        this.f27049b.removeView(this.d);
        this.m0 = true;
        this.d.invalidate();
    }
    ...
    public final void b(com.google.android.gms.internal.cast.p pVar) {
        ...
        if (eVar != null && eVar.h.b()) {
            WindowManager.LayoutParams layoutParams = this.f27051c;
            int width = this.W.h.f43192a.width();
            this.H = width;
            layoutParams.width = width;
            WindowManager.LayoutParams layoutParams2 = this.f27051c;
            int height = this.W.h.f43192a.height();
            this.I = height;
            layoutParams2.height = height;
        }
        this.f27049b.addView(this.d, this.f27051c);
        this.m0 = false;
        this.d.invalidate();
        PhotoViewer photoViewer = this.V;
        if (photoViewer != null) {
    ...
    public final Bitmap c() {
        TextureView textureView = this.f27062l0;
        if (textureView != null && textureView.isAvailable()) {
            return this.f27062l0.getBitmap();
        }
        return null;
    }
    ...
    public final View h() {
        ...
        this.f27062l0 = textureView;
        textureView.setVisibility(4);
        this.f27062l0.setOpaque(false);
        this.f27062l0.setSurfaceTextureListener(new ki.d(this, 2));
        return this.f27062l0;
    }
    ...
    public final void k(boolean z10, boolean z11) {
        ...
        if (this.f27059i0) {
            AndroidUtilities.cancelRunOnUIThread(this.f27060j0);
            this.f27059i0 = false;
        }
        o1.k kVar = this.M;
        if (kVar != null) {
    ...
    public final float q() {
        ...
        if (this.O == null) {
            ...
            Point point = AndroidUtilities.displaySize;
            this.f27047a = (Math.min(point.x, point.y) - AndroidUtilities.dp(32.0f)) / t();
    ...
    public final void u() {
        try {
            ...
            if (fVar != null && fVar.getParent() != null) {
                this.f27049b.removeViewImmediate(this.d);
            }
        ...
        this.f27056f0 = false;
        i();
        AndroidUtilities.cancelRunOnUIThread(this.f27058h0);
    }
