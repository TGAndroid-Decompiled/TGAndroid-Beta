...
public abstract class og0 extends FrameLayout {
    public final w5 f26728a;
    public final TextView f26729b;
    public final org.telegram.ui.Cells.w1 f26730c;
    public final qg0 d;
    ...
    public og0(qg0 qg0Var, Context context) {
        ...
        int i15;
        this.d = qg0Var;
        setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18951i5, false));
    ...
    public final void a(String str, ArrayList arrayList, int i10, int i11, int i12, boolean z10) {
        ...
        this.f26729b.setText(spannableStringBuilder);
        org.telegram.ui.Cells.w1 w1Var = this.f26730c;
        if (i12 == 0) {
            if (this.d.f27302r.quiz) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        measureChildWithMargins(this.f26728a, i10, AndroidUtilities.dp(32.0f) + measuredWidth, makeMeasureSpec, 0);
