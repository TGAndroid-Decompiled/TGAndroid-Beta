...
public abstract class og0 extends FrameLayout {
    public final y5 f26734a;
    public final TextView f26735b;
    public final org.telegram.ui.Cells.w1 f26736c;
    public final qg0 d;
    ...
    public og0(qg0 qg0Var, Context context) {
        ...
        int i15;
        this.d = qg0Var;
        setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18877i5, false));
        ...
        w1Var.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i16, false));
        if (LocaleController.isRTL) {
            i12 = 3;
        } else {
            i12 = 5;
    ...
    public final void a(String str, ArrayList arrayList, int i10, int i11, int i12, boolean z10) {
        ...
        if (LocaleController.isRTL) {
            ...
            spannableStringBuilder = new SpannableStringBuilder(hg.c.j(i10, " – ", "%"));
        }
        spannableStringBuilder.setSpan(new e51(AndroidUtilities.bold()), 3, format.length() + 3, 33);
        this.f26735b.setText(spannableStringBuilder);
        org.telegram.ui.Cells.w1 w1Var = this.f26736c;
        if (i12 == 0) {
            if (this.d.f27344r.quiz) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        measureChildWithMargins(this.f26734a, i10, AndroidUtilities.dp(32.0f) + measuredWidth, makeMeasureSpec, 0);
