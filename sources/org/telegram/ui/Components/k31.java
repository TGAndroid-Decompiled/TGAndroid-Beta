...
public final class k31 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, le.e {
    public static final int f25632f0 = 0;
    ...
    public long V;
    public boolean W;
    public final le.c f25633a;
    public Utilities.Callback2 f25634a0;
    public final int f25635b;
    public Runnable f25636b0;
    public final long f25637c;
    public Utilities.Callback2 f25638c0;
    public final org.telegram.ui.ActionBar.d6 d;
    public boolean f25639d0;
    public final boolean e;
    public final HashSet f25640e0;
    public final boolean f25641f;
    public final org.telegram.ui.wn h;
    public final boolean f25642n;
    public final FrameLayout f25643r;
    public final y21 f25644s;
    public final j31 v;
    public final ImageView f25645w;
    public final ImageView f25646x;
    public final ImageView f25647y;
    ...
    public k31(Activity activity, org.telegram.ui.wn wnVar, int i10, long j3, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        boolean z10;
        rr rrVar = rr.h;
        this.f25633a = new le.c(0, this, rrVar, 380L, true);
        this.J = new le.c(0, new p21(this), rrVar, 320L, false);
        this.R = 0.0f;
        this.f25640e0 = new HashSet();
        this.h = wnVar;
        this.f25635b = i10;
        this.f25637c = j3;
        this.d = d6Var;
        ...
        this.f25641f = isBotForumWithEditableTopics;
        this.f25642n = !org.telegram.messenger.f0.v("topics_end_reached_", j10, UserConfig.getInstance(i10).getPreferences(), false);
        setClipChildren(true);
        setClipToPadding(true);
        setWillNotDraw(false);
        ?? frameLayout2 = new FrameLayout(activity);
        this.f25643r = frameLayout2;
        ...
        y21 y21Var = new y21(this, activity, i10, new Utilities.Callback2(this) {
            ...
            public final void run(Object obj, Object obj2) {
                ...
                boolean z17;
                int i13 = r2;
                k31 k31Var = this.f30253b;
                switch (i13) {
                    case 0:
                        ArrayList arrayList = (ArrayList) obj;
                        j61 j61Var = (j61) obj2;
                        boolean z18 = k31Var.f25641f;
                        int i14 = k31Var.f25635b;
                        MessagesController messagesController = MessagesController.getInstance(i14);
                        long j16 = k31Var.f25637c;
                        long j17 = -j16;
                        ...
                        if (topics != null) {
                            ...
                            while (i16 < size) {
                                ...
                                if (k31Var.f25640e0.contains(Integer.valueOf(tL_forumTopic2.f18388id))) {
                                    size = i18;
                                    i16 = i12;
                                } else {
                                    ...
                                    if (!z21 && z20) {
                                        if (!arrayList.isEmpty()) {
                                            ((v51) hg.c.g(1, arrayList)).f29061y |= 8;
                                        }
                                        j61Var.L();
                                        z20 = false;
                                    } else if (z21 && !z20) {
                        ...
                        if (topics != null && !topics.isEmpty() && !topicsController2.endIsReached(j17) && k31Var.f25642n) {
                    ...
                    default:
                        ...
                        if (topics2 != null) {
                            ...
                            while (i21 < size2) {
                                ...
                                if (k31Var.f25640e0.contains(Integer.valueOf(tL_forumTopic4.f18388id))) {
                                    chat2 = chat3;
                                    size2 = i22;
                                    user3 = user;
                                } else {
                        ...
                        if (topics2 != null && !topics2.isEmpty() && !topicsController.endIsReached(j20) && k31Var.f25642n) {
                            int i24 = i31.f24936a;
                ...
                public final void onClick(View view) {
                    switch (r2) {
                        case 0:
                            ...
                            return;
                        case 1:
                            k31 k31Var2 = this.f28394b;
                            a31 a31Var = k31Var2.G;
                            a31Var.w1(false);
                            y21 y21Var2 = k31Var2.f25644s;
                            y21Var2.w1(false);
                            ...
                            return;
                        default:
                            this.f28394b.f25634a0.run(0, Boolean.FALSE);
                            return;
                    }
                }
            });
    ...
    public static void a(k31 k31Var, v51 v51Var) {
        if (k31Var.e) {
            Utilities.Callback2 callback2 = k31Var.f25638c0;
            if (callback2 != null) {
                callback2.run(Long.valueOf(v51Var.B), Boolean.FALSE);
            }
        } else if (v51Var.B == -2) {
            Runnable runnable = k31Var.f25636b0;
            if (runnable != null) {
                runnable.run();
            }
        } else {
            Utilities.Callback2 callback22 = k31Var.f25634a0;
            if (callback22 != null) {
    ...
    public static void b(k31 k31Var, ArrayList arrayList) {
        long j3 = k31Var.f25637c;
        TopicsController topicsController = MessagesController.getInstance(k31Var.f25635b).getTopicsController();
    ...
    public static boolean c(final k31 k31Var, v51 v51Var, View view) {
        ...
        long j3 = k31Var.f25637c;
        int i18 = k31Var.f25635b;
        if (k31Var.G.f27887c3 || k31Var.f25644s.f27887c3) {
            return false;
        }
        Object obj = v51Var.G;
        ...
        if (ChatObject.isMonoForum(chat)) {
            ...
            if (ChatObject.canManageTopics(chat4) || UserObject.isBotForumWithEditableTopics(user)) {
                I.c(R.drawable.outline_profile_edit_24, LocaleController.getString(R.string.EditTopic), new Runnable(k31Var) {
                    ...
                    public final void run() {
                        boolean z12;
                        int i21 = r4;
                        k31 k31Var2 = this.f28119b;
                        TLRPC.TL_forumTopic tL_forumTopic2 = tL_forumTopic;
                        y70 y70Var3 = I;
                        switch (i21) {
                            case 0:
                                y70Var3.u();
                                k31Var2.h.presentFragment(se1.a0(-k31Var2.f25637c, tL_forumTopic2.f18388id));
                                return;
                            case 1:
                                k31Var2.getClass();
                                y70Var3.u();
                                MessagesController.getInstance(k31Var2.f25635b).getTopicsController().toggleCloseTopic(-k31Var2.f25637c, tL_forumTopic2.f18388id, true ^ tL_forumTopic2.closed);
                                return;
                            default:
                                y70Var3.u();
                                HashSet hashSet = new HashSet();
                                hashSet.add(Integer.valueOf(tL_forumTopic2.f18388id));
                                th thVar = new th(13);
                                k31 k31Var3 = this.f28119b;
                                ...
                                if (hashSet.size() == 1) {
                                    z12 = false;
                                    a2Var.T = LocaleController.formatString(R.string.DeleteSelectedTopic, MessagesController.getInstance(k31Var3.f25635b).getTopicsController().findTopic(-k31Var3.f25637c, ((Integer) arrayList.get(0)).intValue()).title);
                                } else {
                                    z12 = false;
                                ...
                                if (textView != null) {
                                    textView.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19299q7, z12));
                                    return;
                                }
                                return;
                        }
            ...
            long j12 = k31Var.f25637c;
            long j13 = tL_forumTopic.f18388id;
                    ...
                    public final void run() {
                        ...
                        switch (i212) {
                            ...
                            default:
                                ...
                                TextView textView = (TextView) a2Var.d(-1);
                                if (textView != null) {
                                    textView.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19299q7, z122));
                                    return;
                                }
                                return;
                        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i12) {
            ...
            MessagesController.getInstance(this.f25635b).getTopicsController().sortTopics(-j3, false);
            o();
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        FrameLayout frameLayout2 = this.f25643r;
    ...
    public final void f(boolean z10) {
        boolean z11;
        ArrayList<TLRPC.TL_forumTopic> topics = MessagesController.getInstance(this.f25635b).getTopicsController().getTopics(-this.f25637c);
        if (topics != null && !topics.isEmpty() && !this.f25639d0) {
            z11 = true;
        } else {
            z11 = false;
        }
        this.f25633a.a(z11, z10);
    }
    ...
    public final void g() {
        ...
        le.c cVar = this.J;
        float f7 = cVar.e;
        ImageView imageView = this.f25645w;
        ...
        ImageView imageView2 = this.f25646x;
        ...
        ImageView imageView3 = this.f25647y;
    ...
    public float getSideMenuT() {
        return this.R * this.f25633a.e;
    }

    public final void h() {
        int i10;
        float lerp = AndroidUtilities.lerp(1.0f, 0.0f, this.R);
        FrameLayout frameLayout = this.f25643r;
        frameLayout.setAlpha(lerp);
        if ((1.0f - this.R) * this.f25633a.e > 0.0f) {
            i10 = 0;
        } else {
            i10 = 8;
        }
        ...
        if (this.P) {
            frameLayout.setTranslationY(((getMeasuredHeight() - AndroidUtilities.dp(50.0f)) - this.M) + AndroidUtilities.lerp(AndroidUtilities.dp(43.0f), 0, j(g31.f24361c)));
        } else {
            frameLayout.setTranslationY(this.N + AndroidUtilities.lerp(-AndroidUtilities.dp(43.0f), 0, j(g31.f24359a)));
        }
    }

    public final float j(g31 g31Var) {
        float f7;
        float f10 = this.f25633a.e;
        if (g31Var == g31.f24360b) {
            f7 = this.R;
        } else if ((g31Var == g31.f24359a && !this.P) || (g31Var == g31.f24361c && this.P)) {
            f7 = 1.0f - this.R;
        } else {
            return 0.0f;
        }
    ...
    public final void l() {
        TopicsController topicsController = MessagesController.getInstance(this.f25635b).getTopicsController();
        long j3 = this.f25637c;
    ...
    public final void m(long j3, boolean z10) {
        if (this.e) {
            Utilities.Callback2 callback2 = this.f25638c0;
            if (callback2 != null) {
        ...
        Utilities.Callback2 callback22 = this.f25634a0;
        if (callback22 != null) {
    ...
    public final void n() {
        ...
        this.f25647y.setColorFilter(new PorterDuffColorFilter(d, mode));
        ...
        this.f25645w.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(i12, d6Var), mode));
        this.f25646x.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(i12, d6Var), mode));
        invalidate();
    }
