...
public class rx extends vm0 {
    ...
    public final kz D0;
    public final int f27983u0;
    public boolean f27984v0;
    public float f27985w0;
    public boolean f27986x0;
    public float f27987y0;
    public float f27988z0;

    public rx(kz kzVar, Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context, e6Var, kzVar.f25912i2);
        this.D0 = kzVar;
        this.f27986x0 = true;
        this.f27983u0 = ViewConfiguration.get(context).getScaledTouchSlop();
    }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            this.B0 = false;
            this.A0 = false;
            this.f27987y0 = motionEvent.getRawX();
            this.f27988z0 = motionEvent.getRawY();
        } else if (!this.A0 && !this.B0) {
            kz kzVar = this.D0;
            if (kzVar.O0 != null && Math.abs(motionEvent.getRawY() - this.f27988z0) >= this.f27983u0) {
                this.A0 = true;
                this.f27988z0 = motionEvent.getRawY();
                ((c2.a) kzVar.O0).e();
                if (this.f27984v0) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        int i10;
        kz kzVar = this.D0;
        org.telegram.ui.Cells.t6 t6Var = kzVar.f25903f2;
        zw zwVar = kzVar.h;
        if (this.f29131s != null) {
        ...
        if (this.f27986x0) {
            this.f27986x0 = false;
            this.f27985w0 = motionEvent.getX();
        }
        ...
        if (motionEvent.getAction() == 0) {
            ...
            float abs = Math.abs(motionEvent.getRawX() - this.f27987y0);
            float f7 = this.f27983u0;
            if (abs >= f7 && canScrollHorizontally((int) (this.f27987y0 - motionEvent.getRawX()))) {
                this.B0 = true;
                AndroidUtilities.cancelRunOnUIThread(t6Var);
                kzVar.X1 = true;
                kzVar.Y();
            } else if (Math.abs(motionEvent.getRawY() - this.f27988z0) >= f7) {
                this.A0 = true;
                this.f27988z0 = motionEvent.getRawY();
                ((c2.a) kzVar.O0).e();
                if (this.f27984v0) {
        ...
        if (this.A0) {
            ...
            if (motionEvent.getAction() != 1 && motionEvent.getAction() != 3) {
                qx qxVar = kzVar.O0;
                int round = Math.round(motionEvent.getRawY() - this.f27988z0);
                ...
                if (motionEvent.getAction() == 1) {
                    ...
                    if (chatActivityEnterView3.f22046w3) {
        ...
        if (getScrollX() == 0 && translationX == 0.0f) {
            if (!this.f27984v0 && this.f27985w0 - motionEvent.getX() < 0.0f) {
                if (!zwVar.M) {
                    zwVar.f48386e0 = true;
            ...
            } else if (this.f27984v0 && this.f27985w0 - motionEvent.getX() > 0.0f && zwVar.f48386e0) {
                zwVar.i();
                this.f27984v0 = false;
            }
        }
        ...
        if (!this.f27984v0 && !super.onTouchEvent(motionEvent)) {
            return false;
        }
        return true;
    }
