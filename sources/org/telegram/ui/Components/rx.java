...
public class rx extends wm0 {
    ...
    public final kz D0;
    public final int f28060u0;
    public boolean f28061v0;
    public float f28062w0;
    public boolean f28063x0;
    public float f28064y0;
    public float f28065z0;

    public rx(kz kzVar, Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context, f6Var, kzVar.f25878i2);
        this.D0 = kzVar;
        this.f28063x0 = true;
        this.f28060u0 = ViewConfiguration.get(context).getScaledTouchSlop();
    }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            this.B0 = false;
            this.A0 = false;
            this.f28064y0 = motionEvent.getRawX();
            this.f28065z0 = motionEvent.getRawY();
        } else if (!this.A0 && !this.B0) {
            kz kzVar = this.D0;
            if (kzVar.O0 != null && Math.abs(motionEvent.getRawY() - this.f28065z0) >= this.f28060u0) {
                this.A0 = true;
                this.f28065z0 = motionEvent.getRawY();
                ((c2.a) kzVar.O0).e();
                if (this.f28061v0) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        int i10;
        kz kzVar = this.D0;
        org.telegram.ui.Cells.u6 u6Var = kzVar.f25869f2;
        zw zwVar = kzVar.h;
        if (this.f30067s != null) {
        ...
        if (this.f28063x0) {
            this.f28063x0 = false;
            this.f28062w0 = motionEvent.getX();
        }
        ...
        if (motionEvent.getAction() == 0) {
            ...
            float abs = Math.abs(motionEvent.getRawX() - this.f28064y0);
            float f7 = this.f28060u0;
            if (abs >= f7 && canScrollHorizontally((int) (this.f28064y0 - motionEvent.getRawX()))) {
                this.B0 = true;
                AndroidUtilities.cancelRunOnUIThread(u6Var);
                kzVar.X1 = true;
                kzVar.Y();
            } else if (Math.abs(motionEvent.getRawY() - this.f28065z0) >= f7) {
                this.A0 = true;
                this.f28065z0 = motionEvent.getRawY();
                ((c2.a) kzVar.O0).e();
                if (this.f28061v0) {
        ...
        if (this.A0) {
            ...
            if (motionEvent.getAction() != 1 && motionEvent.getAction() != 3) {
                qx qxVar = kzVar.O0;
                int round = Math.round(motionEvent.getRawY() - this.f28065z0);
                ...
                if (motionEvent.getAction() == 1) {
                    ...
                    if (aVar2.d()) {
                        ...
                        if ((aVar2.f3655a && yVelocity >= AndroidUtilities.dp(200.0f)) || ((!aVar2.f3655a && yVelocity <= AndroidUtilities.dp(-200.0f)) || (((z10 = aVar2.f3655a) && chatActivityEnterView2.C3 <= 0.6f) || (!z10 && chatActivityEnterView2.C3 >= 0.4f)))) {
                            chatActivityEnterView2.m1(!aVar2.f3655a, true, true, true);
                        } else {
                    ...
                    if (chatActivityEnterView3.f22103x3) {
                        chatActivityEnterView3.E3 = false;
                        chatActivityEnterView3.m1(aVar3.f3655a, true, false, true);
                    }
                }
                this.f28063x0 = true;
                this.B0 = false;
        ...
        if (getScrollX() == 0 && translationX == 0.0f) {
            if (!this.f28061v0 && this.f28062w0 - motionEvent.getX() < 0.0f) {
                if (!zwVar.M) {
                    zwVar.f48452e0 = true;
            ...
            } else if (this.f28061v0 && this.f28062w0 - motionEvent.getX() > 0.0f && zwVar.f48452e0) {
                zwVar.i();
                this.f28061v0 = false;
            }
        }
        ...
        if (!this.f28061v0 && !super.onTouchEvent(motionEvent)) {
            return false;
        }
        return true;
    }
