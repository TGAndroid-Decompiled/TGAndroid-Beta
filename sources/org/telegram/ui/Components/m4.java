...
public final class m4 extends z51 {
    ...
    public final void onClick(View view) {
        ...
        switch (this.e) {
            case 0:
                ((org.telegram.ui.ActionBar.m2) this.f26352f).dismissCurrentDialog();
                super.onClick(view);
                return;
            case 1:
                fy0 fy0Var = (fy0) this.f26352f;
            ...
            case 2:
                ...
                xc.a0((hg.x) this.f26352f).k(false).j();
                return;
            case 3:
                org.telegram.ui.o70 o70Var = ((org.telegram.ui.m70) this.f26352f).d;
                ...
                return;
            case 4:
                ((org.telegram.ui.om0) this.f26352f).f36270a.dismissCurrentDialog();
                super.onClick(view);
                return;
            default:
                StickersActivity stickersActivity = (StickersActivity) this.f26352f;
