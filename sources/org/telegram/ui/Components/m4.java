...
public final class m4 extends l51 {
    ...
    public final void onClick(View view) {
        ...
        switch (this.f28374e) {
            case 0:
                ((org.telegram.ui.ActionBar.n2) this.f28375f).dismissCurrentDialog();
                super.onClick(view);
                return;
            case 1:
                ux0 ux0Var = (ux0) this.f28375f;
            ...
            case 2:
                ...
                yc.a0((ig.v) this.f28375f).k(false).j();
                return;
            case 3:
                org.telegram.ui.u70 u70Var = ((org.telegram.ui.s70) this.f28375f).d;
                ...
                return;
            case 4:
                ((org.telegram.ui.xm0) this.f28375f).f42764a.dismissCurrentDialog();
                super.onClick(view);
                return;
            default:
                StickersActivity stickersActivity = (StickersActivity) this.f28375f;
