...
public final class sw0 extends bj0 {
    ...
    public long f27943x;
    public float f27944y;

    public sw0(xw0 xw0Var, Context context) {
        super(context);
        int v02;
        org.telegram.ui.ActionBar.f6 f6Var = xw0Var.f26194p2;
        this.H = xw0Var;
        this.f27942w = false;
        this.f27944y = 1.0f;
        if (xw0Var.f30025w3) {
    ...
    public final void c() {
        this.f27942w = true;
        if (this.f27944y < 1.0f) {
            ValueAnimator valueAnimator = this.G;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                this.G = null;
            }
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f27944y, 1.0f);
            this.G = ofFloat;
    ...
    public final void draw(Canvas canvas) {
        ...
        float z10 = com.google.android.gms.internal.vision.e2.z(1.0f, this.E, 0.15f, 0.85f) * this.f27944y;
    ...
    public final void j() {
        if (System.currentTimeMillis() - this.f27943x > 250) {
            this.f27943x = System.currentTimeMillis();
    ...
    public final void l(boolean z10, boolean z11) {
        if (Math.abs(this.f27941s - (z10 ? 1.0f : 0.0f)) > 0.01f) {
    ...
    public final void m(float f7) {
        ...
        if (xw0Var.f30025w3) {
            ...
            k(i0.a.d(this.f27941s, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Me, f6Var), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Oe, f6Var)));
        }
        invalidate();
    }
