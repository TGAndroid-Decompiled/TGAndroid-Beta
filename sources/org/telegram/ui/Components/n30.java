...
public final class n30 extends View {
    ...
    public final RectF f26626f;
    public final ImageReceiver h;
    public final StaticLayout f26627n;
    public final h9 f26628r;
    public final ContactsController.Contact f26629s;
    public final int v;
    public final float f26630w;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f15;
        float f16;
        boolean z10 = this.f26632y;
        if ((z10 && this.f26631x != 1.0f) || (!z10 && this.f26631x != 0.0f)) {
            long currentTimeMillis = System.currentTimeMillis() - this.E;
            if (currentTimeMillis < 0 || currentTimeMillis > 17) {
                currentTimeMillis = 17;
            }
            if (this.f26632y) {
                float f17 = (((float) currentTimeMillis) / 120.0f) + this.f26631x;
                this.f26631x = f17;
                if (f17 >= 1.0f) {
                    this.f26631x = 1.0f;
                }
            } else {
                float f18 = this.f26631x - (((float) currentTimeMillis) / 120.0f);
                this.f26631x = f18;
                if (f18 < 0.0f) {
                    this.f26631x = 0.0f;
                }
        ...
        if (this.f26631x != 1.0f) {
            this.h.draw(canvas);
        }
        if (this.f26631x != 0.0f) {
            paint.setColor(this.f26628r.b());
            paint.setAlpha((int) (this.f26631x * 255.0f * (Color.alpha(b10) / 255.0f)));
            if (z11) {
                f13 = 14.0f;
            } else {
                f13 = 16.0f;
            ...
            canvas.save();
            canvas.rotate((1.0f - this.f26631x) * 45.0f, AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f));
            float f21 = 11.0f;
            if (z11) {
                f15 = 9.0f;
            } else {
            ...
            drawable.setAlpha((int) (this.f26631x * 255.0f));
        ...
        float dp8 = this.f26630w + AndroidUtilities.dp(i13 + 9);
        if (z11) {
            f12 = 6.0f;
        } else {
            f12 = 8.0f;
        ...
        org.telegram.ui.ActionBar.d6 d6Var = this.G;
        J.setColor(i0.a.d(this.f26631x, org.telegram.ui.ActionBar.h6.v0(i15, d6Var), org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.J7, d6Var)));
        this.f26627n.draw(canvas);
        canvas.restore();
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setText(this.f26627n.getText());
        if (this.f26632y) {
