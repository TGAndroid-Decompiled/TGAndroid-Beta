...
public final class n30 extends View {
    ...
    public final RectF f26618f;
    public final ImageReceiver h;
    public final StaticLayout f26619n;
    public final h9 f26620r;
    public final ContactsController.Contact f26621s;
    public final int v;
    public final float f26622w;
    public float f26623x;
    ...
    public final void c() {
        ...
        int v02 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19057di, d6Var);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f15;
        float f16;
        boolean z10 = this.f26624y;
        if ((z10 && this.f26623x != 1.0f) || (!z10 && this.f26623x != 0.0f)) {
            long currentTimeMillis = System.currentTimeMillis() - this.E;
            if (currentTimeMillis < 0 || currentTimeMillis > 17) {
                currentTimeMillis = 17;
            }
            if (this.f26624y) {
                float f17 = (((float) currentTimeMillis) / 120.0f) + this.f26623x;
                this.f26623x = f17;
                if (f17 >= 1.0f) {
                    this.f26623x = 1.0f;
                }
            } else {
                float f18 = this.f26623x - (((float) currentTimeMillis) / 120.0f);
                this.f26623x = f18;
                if (f18 < 0.0f) {
                    this.f26623x = 0.0f;
                }
        ...
        if (this.f26623x != 1.0f) {
            this.h.draw(canvas);
        }
        if (this.f26623x != 0.0f) {
            paint.setColor(this.f26620r.b());
            paint.setAlpha((int) (this.f26623x * 255.0f * (Color.alpha(b10) / 255.0f)));
            if (z11) {
                f13 = 14.0f;
            } else {
                f13 = 16.0f;
            ...
            canvas.save();
            canvas.rotate((1.0f - this.f26623x) * 45.0f, AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f));
            float f21 = 11.0f;
            if (z11) {
                f15 = 9.0f;
            } else {
            ...
            drawable.setAlpha((int) (this.f26623x * 255.0f));
        ...
        float dp8 = this.f26622w + AndroidUtilities.dp(i13 + 9);
        if (z11) {
            f12 = 6.0f;
        } else {
            f12 = 8.0f;
        ...
        int i15 = org.telegram.ui.ActionBar.h6.f19019bi;
        org.telegram.ui.ActionBar.d6 d6Var = this.G;
        J.setColor(i0.a.d(this.f26623x, org.telegram.ui.ActionBar.h6.v0(i15, d6Var), org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.J7, d6Var)));
        this.f26619n.draw(canvas);
        canvas.restore();
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setText(this.f26619n.getText());
        if (this.f26624y) {
    ...
    public n30(android.content.Context r23, java.lang.Object r24, org.telegram.messenger.ContactsController.Contact r25, boolean r26, org.telegram.ui.ActionBar.d6 r27) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.n30.<init>(android.content.Context, java.lang.Object, org.telegram.messenger.ContactsController$Contact, boolean, org.telegram.ui.ActionBar.d6):void");
    }
}
