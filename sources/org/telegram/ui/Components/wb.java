...
public class wb extends lb {
    ...
    public wb(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.f29679b.setSingleLine();
        this.f29679b.setTypeface(Typeface.SANS_SERIF);
        this.f29679b.setTextSize(1, 15.0f);
        this.f29679b.setEllipsize(TextUtils.TruncateAt.END);
        this.f29679b.setPadding(0, AndroidUtilities.dp(8.0f), 0, AndroidUtilities.dp(8.0f));
        addView(this.f29679b, w7.x5.i(-2.0f, -2.0f, 8388627, 56.0f, 0.0f, 16.0f, 0.0f));
        this.f29679b.setLinkTextColor(getThemedColor(org.telegram.ui.ActionBar.i6.Gi));
    ...
    public final void c(int i10, int i11, int i12, String... strArr) {
        aj0 aj0Var = this.f29678a;
        aj0Var.f(i10, i11, i12, null);
        for (String str : strArr) {
            aj0Var.h(this.f29680c, str);
        }
    }
    ...
    public void setIconPaddingBottom(int i10) {
        this.f29678a.setLayoutParams(w7.x5.i(56.0f, 48 - i10, 8388627, 0.0f, 0.0f, 0.0f, i10));
    }

    public void setTextColor(int i10) {
        this.f29680c = i10;
        this.f29679b.setTextColor(i10);
    }
