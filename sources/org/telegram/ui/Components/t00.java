...
public class t00 extends View implements org.telegram.ui.ActionBar.a6 {
    ...
    public float Q;
    public int f28848a;
    public LinearGradient f28849b;
    public final Paint f28850c;
    public final Paint d;
    public long e;
    public int f28851f;
    public final Matrix h;
    public final RectF f28852n;
    public int f28853r;
    public int f28854s;
    public int v;
    ...
    public final void e() {
        ...
        if (this.f28854s == v03 && this.f28853r == v02) {
            return;
        }
        this.f28853r = v02;
        this.f28854s = v03;
        ...
        if (i12 != 34 && i12 != 35 && i12 != 36) {
            if (!this.f28857y && i12 != 13 && i12 != 14 && i12 != 17) {
                this.f28848a = AndroidUtilities.dp(600.0f);
            } else {
                this.f28848a = AndroidUtilities.dp(200.0f);
            }
        } else {
            this.f28848a = AndroidUtilities.displaySize.x;
        }
        if (!this.f28857y && (i10 = this.B) != 13 && i10 != 14 && i10 != 17) {
            this.f28849b = new LinearGradient(0.0f, 0.0f, 0.0f, this.f28848a, new int[]{v03, v02, v02, v03}, new float[]{0.0f, 0.4f, 0.6f, 1.0f}, Shader.TileMode.CLAMP);
        } else {
            this.f28849b = new LinearGradient(0.0f, 0.0f, this.f28848a, 0.0f, new int[]{v03, v02, v02, v03}, new float[]{0.0f, 0.4f, 0.6f, 1.0f}, Shader.TileMode.CLAMP);
        }
        this.f28850c.setShader(this.f28849b);
    }
    ...
    public final void h() {
        ...
        boolean z4 = this.f28857y;
        Matrix matrix = this.h;
        if (!z4 && this.B != 13 && getViewType() != 14 && getViewType() != 17) {
            int i13 = (int) ((((float) (abs * i12)) / 400.0f) + this.f28851f);
            this.f28851f = i13;
            if (i13 >= i12 * 2) {
                this.f28851f = (-this.f28848a) * 2;
            }
            matrix.setTranslate(this.N, this.f28851f);
        } else {
            int i14 = (int) ((((float) (abs * i10)) / 400.0f) + this.f28851f);
            this.f28851f = i14;
            if (i14 >= i10 * 2) {
                this.f28851f = (-this.f28848a) * 2;
            }
            matrix.setTranslate(this.f28851f + this.N, 0.0f);
        }
        LinearGradient linearGradient = this.f28849b;
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (viewType == 7) {
            while (i13 <= getMeasuredHeight()) {
                ...
                i13 = org.telegram.ui.yh.h(this, i13);
                int i17 = i15 + 1;
                if (this.f28857y && i17 >= this.H) {
                    break;
                }
                i15 = i17;
            }
            ...
            while (i19 <= getMeasuredHeight()) {
                ...
                Paint paint5 = paint4;
                canvas3.drawLine(AndroidUtilities.dp(f11), org.telegram.ui.yh.h(this, i19), getMeasuredWidth(), org.telegram.ui.yh.h(this, i19), paint5);
                canvas2 = canvas3;
                i19 = org.telegram.ui.yh.h(this, i19);
                int i20 = i15 + 1;
                if (this.f28857y && i20 >= this.H) {
                    break;
                }
                i15 = i20;
                paint4 = paint5;
            ...
            if (getViewType() == 19) {
                ...
                while (i21 <= getMeasuredHeight()) {
                    ...
                    Paint paint7 = paint6;
                    canvas4.drawLine(AndroidUtilities.dp(f12), org.telegram.ui.yh.h(this, i21), getMeasuredWidth(), org.telegram.ui.yh.h(this, i21), paint7);
                    canvas2 = canvas4;
                    paint6 = paint7;
                    i21 = org.telegram.ui.yh.h(this, i21);
                    int i22 = i15 + 1;
                    if (this.f28857y && i22 >= this.H) {
                        break;
                    }
                    i15 = i22;
                }
                ...
                if (getViewType() == 3) {
                    ...
                    if (getViewType() == 29) {
                        ...
                        while (dp22 <= getMeasuredHeight()) {
                            ...
                            dp22 = org.telegram.ui.yh.h(this, dp22);
                            if (this.f28857y) {
                                break;
                            }
                        }
                        ...
                        while (dp27 < getMeasuredWidth()) {
                            ...
                            this.K.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19977h5, this.I));
                ...
                int i48 = 0;
                while (true) {
                    if (i47 >= getMeasuredHeight() && !this.f28857y) {
                        break;
                    }
                    int i49 = 0;
    ...
    public void setViewType(int i10) {
        ...
        if (i10 == 11) {
            ...
            for (int i11 = 0; i11 < 2; i11++) {
                this.J[i11] = org.telegram.ui.yh.g(random, 1000) / 1000.0f;
            }
        }
        invalidate();
    }
    ...
    public t00(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.d = new Paint();
        this.f28852n = new RectF();
        this.f28855w = true;
        this.E = org.telegram.ui.ActionBar.j6.G8;
        this.F = org.telegram.ui.ActionBar.j6.f19996i6;
        this.G = -1;
        this.H = 1;
        this.I = f6Var;
        this.h = new Matrix();
