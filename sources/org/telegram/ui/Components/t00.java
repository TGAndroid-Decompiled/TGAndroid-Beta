...
public class t00 extends View implements org.telegram.ui.ActionBar.a6 {
    ...
    public float T;
    public int f27972a;
    public LinearGradient f27973b;
    public final Paint f27974c;
    public final Paint d;
    public long e;
    public int f27975f;
    public final Matrix h;
    public final RectF f27976n;
    public int f27977r;
    public int f27978s;
    public int v;
    public boolean f27979w;
    public boolean f27980x;
    public boolean f27981y;
    ...
    public final void e() {
        ...
        if (this.f27978s == v03 && this.f27977r == v02) {
            return;
        }
        this.f27977r = v02;
        this.f27978s = v03;
        ...
        if (i12 != 34 && i12 != 35 && i12 != 36) {
            if (!this.f27981y && i12 != 13 && i12 != 14 && i12 != 17) {
                this.f27972a = AndroidUtilities.dp(600.0f);
            } else {
                this.f27972a = AndroidUtilities.dp(200.0f);
            }
        } else {
            this.f27972a = AndroidUtilities.displaySize.x;
        }
        if (!this.f27981y && (i10 = this.E) != 13 && i10 != 14 && i10 != 17) {
            this.f27973b = new LinearGradient(0.0f, 0.0f, 0.0f, this.f27972a, new int[]{v03, v02, v02, v03}, new float[]{0.0f, 0.4f, 0.6f, 1.0f}, Shader.TileMode.CLAMP);
        } else {
            this.f27973b = new LinearGradient(0.0f, 0.0f, this.f27972a, 0.0f, new int[]{v03, v02, v02, v03}, new float[]{0.0f, 0.4f, 0.6f, 1.0f}, Shader.TileMode.CLAMP);
        }
        this.f27974c.setShader(this.f27973b);
    }
    ...
    public final void h() {
        ...
        if (!z10 && this.E != 13 && getViewType() != 14 && getViewType() != 17) {
            int i13 = (int) ((((float) (abs * i12)) / 400.0f) + this.f27975f);
            this.f27975f = i13;
            if (i13 >= i12 * 2) {
                this.f27975f = (-this.f27972a) * 2;
            }
            matrix.setTranslate(this.Q, this.f27975f);
        } else {
            int i14 = (int) ((((float) (abs * i10)) / 400.0f) + this.f27975f);
            this.f27975f = i14;
            if (i14 >= i10 * 2) {
                this.f27975f = (-this.f27972a) * 2;
            }
            matrix.setTranslate(this.f27975f + this.Q, 0.0f);
        }
        LinearGradient linearGradient = this.f27973b;
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (viewType == 7) {
            ...
            if (getViewType() == 19) {
                ...
                if (getViewType() == 3) {
                    ...
                    if (getViewType() == 29) {
                        ...
                        while (dp27 < getMeasuredWidth()) {
                            ...
                            this.N.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18934h5, this.L));
                ...
                int i48 = 0;
                while (true) {
                    if (i47 >= getMeasuredHeight() && !this.f27981y) {
                        break;
                    }
                    int i49 = 0;
    ...
    public t00(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f27974c = new Paint();
        this.d = new Paint();
        this.f27976n = new RectF();
        this.f27979w = true;
        this.H = org.telegram.ui.ActionBar.j6.G8;
        this.I = org.telegram.ui.ActionBar.j6.f18953i6;
        this.J = -1;
        this.K = 1;
        this.L = f6Var;
        this.h = new Matrix();
