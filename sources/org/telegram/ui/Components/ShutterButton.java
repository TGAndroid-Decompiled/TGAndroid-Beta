...
public class ShutterButton extends View {
    ...
    public DecelerateInterpolator f21275b;
    public Paint f21276c;
    public Paint d;
    public nv0 e;
    public ov0 f21277f;
    public boolean h;
    ...
    public long f21280s;
    public boolean v;
    public org.telegram.ui.Cells.l9 f21281w;
    ...
    private void setHighlighted(boolean z10) {
        ...
        animatorSet.setInterpolator(this.f21275b);
        animatorSet.start();
    }

    public final void a(ov0 ov0Var) {
        if (this.f21277f != ov0Var) {
            this.f21277f = ov0Var;
            this.f21279r = System.currentTimeMillis();
            this.f21280s = 0L;
            if (this.f21277f != ov0.f25922b) {
                this.f21278n = 0.0f;
            }
            invalidate();
        }
    ...
    public final void onDraw(Canvas canvas) {
        Paint paint = this.d;
        Paint paint2 = this.f21276c;
        int measuredWidth = getMeasuredWidth() / 2;
        int measuredHeight = getMeasuredHeight() / 2;
        Drawable drawable = this.f21274a;
        ...
        if (this.f21277f == ov0.f25922b) {
            if (this.f21278n != 1.0f) {
                long abs = Math.abs(System.currentTimeMillis() - this.f21279r);
                if (abs > 17) {
                    abs = 17;
                }
                long j3 = this.f21280s + abs;
                this.f21280s = j3;
                if (j3 > 120) {
                    this.f21280s = 120L;
                }
                this.f21278n = this.f21275b.getInterpolation(((float) this.f21280s) / 120.0f);
                invalidate();
            }
            canvas.drawCircle(f7, f10, AndroidUtilities.dp(26.5f) * scaleX * this.f21278n, paint);
        } else if (this.f21278n != 0.0f) {
