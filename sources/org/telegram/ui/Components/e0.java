...
public final class e0 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.f6 f25497b;
    public final c0 f25498c;
    public int d;
    public boolean f25499e;
    public int f25500f;
    public final e6 h;
    public di.p5 f25501n;
    ...
    public final void a(int i10, String str, Utilities.Callback callback) {
        c0 c0Var = this.f25498c;
        int childCount = c0Var.getChildCount();
        d0 d0Var = new d0(getContext(), this.f25496a, this.f25497b);
        d0Var.f25163c = this.d;
        d0Var.d();
        d0Var.f25165f = false;
        d0Var.h.setImageResource(i10);
        d0Var.f25166n.setText(str);
    ...
    public final void b(TL_aicompose.AiComposeTone aiComposeTone, Utilities.Callback callback) {
        int i10;
        d0 d0Var = new d0(getContext(), this.f25496a, this.f25497b);
        d0Var.f25164e = aiComposeTone;
        d0Var.f25163c = this.d;
        d0Var.d();
        int i11 = 0;
        TextView textView = d0Var.f25166n;
        x9 x9Var = d0Var.h;
        ...
        if (i10 >= 0 && i10 < c0Var.getChildCount()) {
            ...
            if (childAt instanceof d0) {
                ...
                if (x9Var.getAnimatedEmojiDrawable() != null) {
                    bi.y3 y3Var = x9Var.getAnimatedEmojiDrawable().f29585k;
                    if (y3Var != null) {
    ...
    public final void d(TL_aicompose.AiComposeTone aiComposeTone) {
        ...
        while (true) {
            ...
            if (i10 < c0Var.getChildCount()) {
                View childAt = c0Var.getChildAt(i10);
                if ((childAt instanceof d0) && (aiComposeTone2 = ((d0) childAt).f25164e) != null && aiComposeTone2 == aiComposeTone) {
                    c(i10);
                    return;
                }
                i10++;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f25499e) {
            Paint T0 = org.telegram.ui.ActionBar.j6.T0("paintDivider", this.f25497b);
            if (T0 == null) {
    ...
    public TL_aicompose.AiComposeTone getSelectedTone() {
        ...
        if (i10 >= 0) {
            c0 c0Var = this.f25498c;
            if (i10 < c0Var.getChildCount()) {
                View childAt = c0Var.getChildAt(this.f25500f);
                if (childAt instanceof d0) {
                    return ((d0) childAt).f25164e;
                }
                return null;
            }
            return null;
