            ...
            case 0:
                ...
                if (E != null) {
                    ...
                    if (view instanceof zm0) {
                        org.telegram.ui.Cells.i7 i7Var = ((zm0) view).f33977a;
                        ...
                        if (i7Var.D) {
                            ...
                            i7Var.f(true);
                            DownloadController.getInstance(this.f33138b).updateFilesLoadingPriority();
                        } else {
                ...
                return;
            case 1:
                org.telegram.ui.hp0 hp0Var2 = (org.telegram.ui.hp0) this.f33139c;
                org.telegram.ui.np0 np0Var = hp0Var2.m0;
                ArrayList arrayList2 = hp0Var2.f37454i0;
                if (view instanceof org.telegram.ui.gp0) {
                    org.telegram.ui.gp0 gp0Var = (org.telegram.ui.gp0) view;
                    int i15 = hp0Var2.f37455j0;
                    if (hp0Var2.f37457l0 == null) {
                        j5 j5Var = gp0Var.f37151c;
                        ...
                        dp0Var.f42312d1 = true;
                        long j11 = hp0Var2.f37458n;
                        if (j11 == 0) {
                            valueOf = null;
                        } else {
                ...
                int i17 = hp0Var2.S;
                int i18 = this.f33138b;
                if (i10 == i17) {
                    hp0Var2.h = -1;
                    hp0Var2.f37458n = 0L;
                    hp0Var2.f37459r = null;
                    hp0Var2.f37460s = null;
                    hp0Var2.F = null;
                    hp0Var2.i();
                    if (i18 == 0) {
                        np0Var.h.i();
                    }
                    org.telegram.ui.gp0 gp0Var2 = hp0Var2.f37463y;
                    if (gp0Var2 != null) {
                        gp0Var2.b(true);
                    }
                    hp0Var2.j(true);
                    hp0Var2.f(true);
                    org.telegram.ui.hp0 hp0Var3 = np0Var.f39435n;
                    if (hp0Var3 != null && (lp0Var = hp0Var3.f37441a) != null && (hp0Var = np0Var.h) != null) {
                        lp0Var.a(hp0Var.h);
                        return;
                    }
                    return;
                    ...
                    if (hp0Var2.H == null) {
                        if (i20 >= 0 && i20 < arrayList2.size()) {
                            ...
                            if (i18 == 1) {
                                ...
                                if (peerColor instanceof TLRPC.TL_peerColorCollectible) {
                                    ...
                                    hp0Var2.F = null;
                                    hp0Var2.f37459r = null;
                                    hp0Var2.f37460s = (TLRPC.TL_peerColorCollectible) peerColor;
                                } else {
                                    return;
                                }
                            } else {
                                ...
                                hp0Var2.h = -1;
                                hp0Var2.F = null;
                                hp0Var2.f37459r = MessagesController.emojiStatusCollectibleFromGift(tL_starGiftUnique);
                                hp0Var2.f37460s = null;
                            }
                            hp0Var2.j(true);
                            hp0Var2.i();
                            hp0Var2.f(true);
                            org.telegram.ui.gp0 gp0Var3 = hp0Var2.f37463y;
                            if (gp0Var3 != null) {
                                gp0Var3.b(true);
                                return;
                            }
                        ...
                        if (i18 == 1) {
                            ...
                            if (peerColor2 instanceof TLRPC.TL_peerColorCollectible) {
                                ...
                                hp0Var2.h = -1;
                                hp0Var2.f37459r = null;
                                hp0Var2.f37460s = (TLRPC.TL_peerColorCollectible) peerColor2;
                            } else {
                                return;
                            }
                        } else {
                            hp0Var2.f37458n = 0L;
                            hp0Var2.h = -1;
                            hp0Var2.f37459r = MessagesController.emojiStatusCollectibleFromGift(tL_starGiftUnique2);
                            hp0Var2.f37460s = null;
                        }
                        ...
                        hp0Var2.i();
                        hp0Var2.f(true);
                        org.telegram.ui.gp0 gp0Var4 = hp0Var2.f37463y;
                        if (gp0Var4 != null) {
                            gp0Var4.b(true);
                            return;
                        }
                ...
                return;
            default:
                org.telegram.ui.w61 w61Var = (org.telegram.ui.w61) this.f33139c;
                boolean z11 = view instanceof org.telegram.ui.f61;
                int i21 = this.f33138b;
                try {
                    if (z11) {
                        org.telegram.ui.f61 f61Var = (org.telegram.ui.f61) view;
                        if (!f61Var.f36684s && (((q0Var = f61Var.f36686x) == null || !q0Var.f16176a) && i21 != 13 && i21 != 14)) {
                            if (f61Var.N && (document = f61Var.d) != null) {
                                if (w61Var.T == 6) {
                                    w61Var.p(f61Var, Long.valueOf(document.f20851id), document, f61Var.v, null);
                                } else {
                                    w61Var.p(f61Var, null, document, f61Var.v, null);
                                }
                            } else {
                                w61Var.o(f61Var, f61Var.f36680e);
                            }
                        } else {
                            w61Var.l();
                            w61Var.r(f61Var, f61Var.f36686x);
                        }
                        if (i21 != 1 && i21 != 11) {
