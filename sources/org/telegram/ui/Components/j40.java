...
public final class j40 {
    ...
    public static final j40 f25217f;
    public static final j40 h;
    public static final j40 f25218n;
    public static final j40 f25219r;
    public static final j40 f25220s;
    public static final j40 v;
    public static final j40[] f25221w;
    ...
    static {
        ...
        j40 j40Var8 = new j40();
        v = j40Var8;
        f25221w = new j40[]{j40Var, j40Var2, j40Var3, j40Var4, j40Var5, j40Var6, j40Var7, j40Var8};
    }

    public j40() {
        this.f25222a = "hints_controller_" + this;
        this.f25223b = 3;
        this.f25224c = 1.0f;
    }
    ...
    public static j40[] values() {
        return (j40[]) f25221w.clone();
    }

    public final void a() {
        MessagesController.getGlobalMainSettings().edit().putInt(this.f25222a, this.f25223b).apply();
    }
    ...
    public final boolean c() {
        if (MessagesController.getGlobalMainSettings().getInt(this.f25222a, 0) < this.f25223b) {
            float f7 = this.f25224c;
            if (f7 < 1.0f) {
