...
public final class j40 {
    ...
    public static final j40 f25216f;
    public static final j40 h;
    public static final j40 f25217n;
    public static final j40 f25218r;
    public static final j40 f25219s;
    public static final j40 v;
    public static final j40[] f25220w;
    ...
    static {
        ...
        j40 j40Var8 = new j40();
        v = j40Var8;
        f25220w = new j40[]{j40Var, j40Var2, j40Var3, j40Var4, j40Var5, j40Var6, j40Var7, j40Var8};
    }

    public j40() {
        this.f25221a = "hints_controller_" + this;
        this.f25222b = 3;
        this.f25223c = 1.0f;
    }
    ...
    public static j40[] values() {
        return (j40[]) f25220w.clone();
    }

    public final void a() {
        MessagesController.getGlobalMainSettings().edit().putInt(this.f25221a, this.f25222b).apply();
    }
    ...
    public final boolean c() {
        if (MessagesController.getGlobalMainSettings().getInt(this.f25221a, 0) < this.f25222b) {
            float f7 = this.f25223c;
            if (f7 < 1.0f) {
