...
public class j40 extends FrameLayout {
    ...
    public boolean G;
    public boolean H;
    public final ai.p4 f25241a;
    public ImageView f25242b;
    public final ImageView f25243c;
    public org.telegram.ui.Cells.u1 d;
    public View e;
    public AnimatorSet f25244f;
    public Runnable h;
    public final int f25245n;
    public final boolean f25246r;
    public String f25247s;
    public int v;
    public float f25248w;
    ...
    public final void a() {
        float f7;
        float f10;
        this.f25241a.setPadding(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(7.0f), AndroidUtilities.dp(36.0f), AndroidUtilities.dp(8.0f));
        this.H = true;
        ImageView imageView = new ImageView(getContext());
        this.f25242b = imageView;
        imageView.setImageResource(R.drawable.msg_mini_close_tooltip);
        this.f25242b.setScaleType(ImageView.ScaleType.CENTER);
        this.f25242b.setColorFilter(new PorterDuffColorFilter(i0.a.k(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19273pf, this.F), 125), PorterDuff.Mode.MULTIPLY));
        ImageView imageView2 = this.f25242b;
        boolean z10 = this.f25246r;
        if (z10) {
            f7 = 3.0f;
        } else {
            f7 = 0.0f;
    ...
    public final void b(boolean z10) {
        ...
        AnimatorSet animatorSet = this.f25244f;
        if (animatorSet != null) {
            animatorSet.cancel();
            this.f25244f = null;
        }
        if (z10) {
            ...
            if (z11) {
                ...
                this.f25244f.setDuration(150L);
                this.f25244f.setInterpolator(rr.f28022f);
            } else {
                animatorSet2.playTogether(ObjectAnimator.ofFloat(this, property, 0.0f));
                this.f25244f.setDuration(300L);
            }
            this.f25244f.addListener(new h40(this, 2));
            this.f25244f.start();
            return;
        }
        setVisibility(4);
    ...
    public final void d() {
        float f7;
        ai.p4 p4Var = this.f25241a;
        p4Var.setTextColor(-1);
        this.f25243c.setColorFilter(new PorterDuffColorFilter(-366530760, PorterDuff.Mode.MULTIPLY));
        int i10 = this.f25245n;
        if (i10 != 7 && i10 != 8) {
            f7 = 3.0f;
        } else {
            f7 = 6.0f;
    ...
    public final void f(View view, boolean z10) {
        if (this.e != view && getTag() == null) {
            ...
            if (z10) {
                ...
                Property property = View.ALPHA;
                if (z11) {
                    ImageView imageView = this.f25243c;
                    setPivotX((imageView.getMeasuredWidth() / 2.0f) + imageView.getX());
                    setPivotY((imageView.getMeasuredHeight() / 2.0f) + imageView.getY());
                    this.f25244f.playTogether(ObjectAnimator.ofFloat(this, property, 0.0f, 1.0f), ObjectAnimator.ofFloat(this, View.SCALE_Y, 0.5f, 1.0f), ObjectAnimator.ofFloat(this, View.SCALE_X, 0.5f, 1.0f));
                    this.f25244f.setDuration(350L);
                    this.f25244f.setInterpolator(rr.h);
                } else {
                    animatorSet2.playTogether(ObjectAnimator.ofFloat(this, property, 0.0f, 1.0f));
                    this.f25244f.setDuration(300L);
                }
                this.f25244f.addListener(new h40(this, 1));
                this.f25244f.start();
                return;
            }
            setAlpha(1.0f);
    ...
    public void setExtraTranslationY(float f7) {
        this.f25249x = f7;
        setTranslationY(f7 + this.f25248w);
    }

    public void setOverrideText(String str) {
        this.f25247s = str;
        this.f25241a.setText(str);
    ...
    public void setText(CharSequence charSequence) {
        this.f25241a.setText(charSequence);
    }
    ...
    public j40(int i10, Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10) {
        ...
        this.f25241a = p4Var;
        int i11 = org.telegram.ui.ActionBar.h6.f19273pf;
        ...
        if (i10 == 3) {
            p4Var.setGravity(19);
            p4Var.setBackground(org.telegram.ui.ActionBar.h6.b0(AndroidUtilities.dp(5.0f), org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19292qf, d6Var)));
            ...
            p4Var.setGravity(51);
            p4Var.setBackground(org.telegram.ui.ActionBar.h6.b0(AndroidUtilities.dp(10.0f), org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19292qf, d6Var)));
        ...
        if (i10 == 0) {
            ...
            this.f25242b.setScaleType(ImageView.ScaleType.CENTER);
            this.f25242b.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(i11, d6Var), PorterDuff.Mode.MULTIPLY));
            addView(this.f25242b, w7.y5.d(38, 34.0f, 51, 7.0f, 7.0f, 0.0f, 0.0f));
        }
        ImageView imageView2 = new ImageView(context);
        this.f25243c = imageView2;
        imageView2.setImageResource(z10 ? R.drawable.tooltip_arrow_up : R.drawable.tooltip_arrow);
        imageView2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19292qf, d6Var), PorterDuff.Mode.MULTIPLY));
