...
public class j40 extends FrameLayout {
    ...
    public boolean G;
    public boolean H;
    public final ai.p4 f25128a;
    public ImageView f25129b;
    public final ImageView f25130c;
    public org.telegram.ui.Cells.t1 d;
    public View e;
    public AnimatorSet f25131f;
    public Runnable h;
    public final int f25132n;
    ...
    public final void a() {
        float f7;
        float f10;
        this.f25128a.setPadding(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(7.0f), AndroidUtilities.dp(36.0f), AndroidUtilities.dp(8.0f));
        this.H = true;
        ImageView imageView = new ImageView(getContext());
        this.f25129b = imageView;
        imageView.setImageResource(R.drawable.msg_mini_close_tooltip);
        this.f25129b.setScaleType(ImageView.ScaleType.CENTER);
        this.f25129b.setColorFilter(new PorterDuffColorFilter(i0.a.k(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19016pf, this.F), 125), PorterDuff.Mode.MULTIPLY));
        ImageView imageView2 = this.f25129b;
    ...
    public final void b(boolean z10) {
        ...
        AnimatorSet animatorSet = this.f25131f;
        if (animatorSet != null) {
            animatorSet.cancel();
            this.f25131f = null;
        }
        if (z10) {
            ...
            if (z11) {
                ...
                this.f25131f.setDuration(150L);
                this.f25131f.setInterpolator(rr.f27701f);
            } else {
                animatorSet2.playTogether(ObjectAnimator.ofFloat(this, property, 0.0f));
                this.f25131f.setDuration(300L);
            }
            this.f25131f.addListener(new h40(this, 2));
            this.f25131f.start();
            return;
        }
        setVisibility(4);
    ...
    public final void d() {
        float f7;
        ai.p4 p4Var = this.f25128a;
        p4Var.setTextColor(-1);
        this.f25130c.setColorFilter(new PorterDuffColorFilter(-366530760, PorterDuff.Mode.MULTIPLY));
    ...
    public final boolean e(org.telegram.ui.Cells.t1 r21, java.lang.Integer r22, int r23, int r24, boolean r25) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.j40.e(org.telegram.ui.Cells.t1, java.lang.Integer, int, int, boolean):boolean");
    }
    ...
    public final void f(View view, boolean z10) {
        if (this.e != view && getTag() == null) {
            ...
            if (z10) {
                ...
                Property property = View.ALPHA;
                if (z11) {
                    ImageView imageView = this.f25130c;
                    setPivotX((imageView.getMeasuredWidth() / 2.0f) + imageView.getX());
                    setPivotY((imageView.getMeasuredHeight() / 2.0f) + imageView.getY());
                    this.f25131f.playTogether(ObjectAnimator.ofFloat(this, property, 0.0f, 1.0f), ObjectAnimator.ofFloat(this, View.SCALE_Y, 0.5f, 1.0f), ObjectAnimator.ofFloat(this, View.SCALE_X, 0.5f, 1.0f));
                    this.f25131f.setDuration(350L);
                    this.f25131f.setInterpolator(rr.h);
                } else {
                    animatorSet2.playTogether(ObjectAnimator.ofFloat(this, property, 0.0f, 1.0f));
                    this.f25131f.setDuration(300L);
                }
                this.f25131f.addListener(new h40(this, 1));
                this.f25131f.start();
                return;
            }
            setAlpha(1.0f);
    ...
    public void setExtraTranslationY(float f7) {
        this.f25136x = f7;
        setTranslationY(f7 + this.f25135w);
    }
    ...
    public void setText(CharSequence charSequence) {
        this.f25128a.setText(charSequence);
    }
    ...
    public j40(int i10, Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10) {
        ...
        this.f25128a = p4Var;
        int i11 = org.telegram.ui.ActionBar.h6.f19016pf;
        ...
        if (i10 == 3) {
            p4Var.setGravity(19);
            p4Var.setBackground(org.telegram.ui.ActionBar.h6.b0(AndroidUtilities.dp(5.0f), org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19034qf, d6Var)));
            ...
            p4Var.setGravity(51);
            p4Var.setBackground(org.telegram.ui.ActionBar.h6.b0(AndroidUtilities.dp(10.0f), org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19034qf, d6Var)));
        ...
        if (i10 == 0) {
            ...
            this.f25129b.setScaleType(ImageView.ScaleType.CENTER);
            this.f25129b.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(i11, d6Var), PorterDuff.Mode.MULTIPLY));
            addView(this.f25129b, w7.x5.d(38, 34.0f, 51, 7.0f, 7.0f, 0.0f, 0.0f));
        }
        ImageView imageView2 = new ImageView(context);
        this.f25130c = imageView2;
        imageView2.setImageResource(z10 ? R.drawable.tooltip_arrow_up : R.drawable.tooltip_arrow);
        imageView2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19034qf, d6Var), PorterDuff.Mode.MULTIPLY));
