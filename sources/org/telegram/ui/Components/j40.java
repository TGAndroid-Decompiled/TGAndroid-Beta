...
public final class j40 {
    ...
    public static final j40 f25105f;
    public static final j40 h;
    public static final j40 f25106n;
    public static final j40 f25107r;
    public static final j40 f25108s;
    public static final j40 v;
    public static final j40[] f25109w;
    ...
    static {
        ...
        j40 j40Var8 = new j40();
        v = j40Var8;
        f25109w = new j40[]{j40Var, j40Var2, j40Var3, j40Var4, j40Var5, j40Var6, j40Var7, j40Var8};
    }

    public j40() {
        this.f25110a = "hints_controller_" + this;
        this.f25111b = 3;
        this.f25112c = 1.0f;
    }
    ...
    public static j40[] values() {
        return (j40[]) f25109w.clone();
    }

    public final void a() {
        MessagesController.getGlobalMainSettings().edit().putInt(this.f25110a, this.f25111b).apply();
    }
    ...
    public final boolean c() {
        if (MessagesController.getGlobalMainSettings().getInt(this.f25110a, 0) < this.f25111b) {
            float f7 = this.f25112c;
            if (f7 < 1.0f) {
