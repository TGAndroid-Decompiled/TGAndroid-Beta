...
public final class j40 {
    ...
    public static final j40 f25102f;
    public static final j40 h;
    public static final j40 f25103n;
    public static final j40 f25104r;
    public static final j40 f25105s;
    public static final j40 v;
    public static final j40[] f25106w;
    ...
    static {
        ...
        j40 j40Var8 = new j40();
        v = j40Var8;
        f25106w = new j40[]{j40Var, j40Var2, j40Var3, j40Var4, j40Var5, j40Var6, j40Var7, j40Var8};
    }

    public j40() {
        this.f25107a = "hints_controller_" + this;
        this.f25108b = 3;
        this.f25109c = 1.0f;
    }
    ...
    public static j40[] values() {
        return (j40[]) f25106w.clone();
    }

    public final void a() {
        MessagesController.getGlobalMainSettings().edit().putInt(this.f25107a, this.f25108b).apply();
    }
    ...
    public final boolean c() {
        if (MessagesController.getGlobalMainSettings().getInt(this.f25107a, 0) < this.f25108b) {
            float f7 = this.f25109c;
            if (f7 < 1.0f) {
