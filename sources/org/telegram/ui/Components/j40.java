...
public class j40 extends FrameLayout {
    ...
    public final void a() {
        float f7;
        float f10;
        this.f25266a.setPadding(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(7.0f), AndroidUtilities.dp(36.0f), AndroidUtilities.dp(8.0f));
        this.H = true;
        ImageView imageView = new ImageView(getContext());
        this.f25267b = imageView;
        imageView.setImageResource(R.drawable.msg_mini_close_tooltip);
        this.f25267b.setScaleType(ImageView.ScaleType.CENTER);
        this.f25267b.setColorFilter(new PorterDuffColorFilter(i0.a.k(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19287pf, this.F), 125), PorterDuff.Mode.MULTIPLY));
        ImageView imageView2 = this.f25267b;
    ...
    public final void b(boolean z10) {
        ...
        AnimatorSet animatorSet = this.f25269f;
        if (animatorSet != null) {
            animatorSet.cancel();
            this.f25269f = null;
        }
        if (z10) {
            ...
            if (z11) {
                ...
                this.f25269f.setDuration(150L);
                this.f25269f.setInterpolator(rr.f28030f);
            } else {
                animatorSet2.playTogether(ObjectAnimator.ofFloat(this, property, 0.0f));
                this.f25269f.setDuration(300L);
            }
            this.f25269f.addListener(new h40(this, 2));
            this.f25269f.start();
            return;
        }
        setVisibility(4);
    ...
    public final void d() {
        float f7;
        ai.p4 p4Var = this.f25266a;
        p4Var.setTextColor(-1);
        this.f25268c.setColorFilter(new PorterDuffColorFilter(-366530760, PorterDuff.Mode.MULTIPLY));
    ...
    public final void f(View view, boolean z10) {
        if (this.e != view && getTag() == null) {
            ...
            if (z10) {
                ...
                Property property = View.ALPHA;
                if (z11) {
                    ImageView imageView = this.f25268c;
                    setPivotX((imageView.getMeasuredWidth() / 2.0f) + imageView.getX());
                    setPivotY((imageView.getMeasuredHeight() / 2.0f) + imageView.getY());
                    this.f25269f.playTogether(ObjectAnimator.ofFloat(this, property, 0.0f, 1.0f), ObjectAnimator.ofFloat(this, View.SCALE_Y, 0.5f, 1.0f), ObjectAnimator.ofFloat(this, View.SCALE_X, 0.5f, 1.0f));
                    this.f25269f.setDuration(350L);
                    this.f25269f.setInterpolator(rr.h);
                } else {
                    animatorSet2.playTogether(ObjectAnimator.ofFloat(this, property, 0.0f, 1.0f));
                    this.f25269f.setDuration(300L);
                }
                this.f25269f.addListener(new h40(this, 1));
                this.f25269f.start();
                return;
            }
            setAlpha(1.0f);
    ...
    public void setExtraTranslationY(float f7) {
        this.f25274x = f7;
        setTranslationY(f7 + this.f25273w);
    }

    public void setOverrideText(String str) {
        this.f25272s = str;
        this.f25266a.setText(str);
    ...
    public void setText(CharSequence charSequence) {
        this.f25266a.setText(charSequence);
    }
    ...
    public j40(int i10, Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10) {
        ...
        if (i10 == 0) {
            ...
            this.f25267b.setScaleType(ImageView.ScaleType.CENTER);
            this.f25267b.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(i11, d6Var), PorterDuff.Mode.MULTIPLY));
            addView(this.f25267b, w7.y5.d(38, 34.0f, 51, 7.0f, 7.0f, 0.0f, 0.0f));
        }
