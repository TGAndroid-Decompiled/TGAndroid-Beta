...
public abstract class zm0 extends HorizontalScrollView {
    ...
    public final void a(int i10) {
        if (this.e != i10) {
            ...
            ofFloat.addUpdateListener(new t70(this, 14));
            this.f30929f.setInterpolator(sr.h);
            this.f30929f.setDuration(250L);
            this.f30929f.addListener(new gd0(this, 10));
            this.f30929f.start();
        }
    }
    ...
    public final void c() {
        ...
        int childCount = this.f30927b.getChildCount();
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt instanceof aw) {
                ...
                if (this.d && ((valueAnimator = this.f30928c) == null || !valueAnimator.isRunning())) {
                    z11 = true;
                } else {
                    z11 = false;
                }
                if (!awVar.f22777y && z10 && (jj0Var = awVar.e) != null && !jj0Var.f25435k0 && !z11) {
                    awVar.e.T(0.0f, true);
                    awVar.e.start();
                }
                if (awVar.f22777y != z10) {
                    awVar.f22777y = z10;
                    if (z10) {
                        awVar.invalidate();
                        rg.b1 b1Var = awVar.f22771f;
                        if (b1Var != null) {
                            b1Var.invalidate();
                        }
                        rg.b1 b1Var2 = awVar.f22771f;
                        if (b1Var2 != null && (q5Var = awVar.f22775w) != null && (l4Var = q5Var.f27588k) != null) {
    ...
    public final void onScrollChanged(int i10, int i11, int i12, int i13) {
        ...
        if ((Math.abs(i11 - i13) < 2 || i11 >= getMeasuredHeight() || i11 == 0) && !this.f30926a) {
