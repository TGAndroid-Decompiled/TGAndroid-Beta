    ...
    public static class Drawable {
        ...
        public class Particle {
            ...
            public void draw(Canvas canvas, long j) {
                ...
                Drawable.this.paint.setAlpha((int) (this.alpha * (1.0f - (j2 - j < 200 ? Utilities.clamp(1.0f - (((float) (j2 - j)) / 150.0f), 1.0f, 0.0f) : 0.0f))));
            ...
            public void genPosition(long j) {
                ...
                this.x = f;
                this.y = f2;
                double atan2 = Math.atan2(f - Drawable.this.rect.centerX(), this.y - Drawable.this.rect.centerY());
