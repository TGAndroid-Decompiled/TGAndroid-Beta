...
public class GLIconTextureView extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    ValueAnimator.AnimatorUpdateListener xUpdater2 = new ValueAnimator.AnimatorUpdateListener() {
        @Override
        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
            GLIconTextureView.this.lambda$new$1(valueAnimator);
        }
    };
    ValueAnimator.AnimatorUpdateListener xUpdater = new ValueAnimator.AnimatorUpdateListener() {
        @Override
        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
            GLIconTextureView.this.lambda$new$2(valueAnimator);
        }
    };
    ValueAnimator.AnimatorUpdateListener yUpdater = new ValueAnimator.AnimatorUpdateListener() {
        @Override
        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
    ...
    public class RenderThread extends Thread {
        ...
        RenderThread(GLIconTextureView gLIconTextureView, AnonymousClass1 r2) {
            this();
        }
