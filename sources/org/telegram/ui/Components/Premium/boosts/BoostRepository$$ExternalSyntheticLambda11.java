...
public final class BoostRepository$$ExternalSyntheticLambda11 implements Runnable {
    ...
    public BoostRepository$$ExternalSyntheticLambda11(TLRPC.Chat chat, int i, ArrayList arrayList, Utilities.Callback callback, int i2) {
        this.$r8$classId = i2;
        this.f$0 = chat;
        this.f$1 = i;
        this.f$2 = arrayList;
