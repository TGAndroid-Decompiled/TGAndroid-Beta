...
public class StarGiveawayOptionCell extends FrameLayout {
    ...
    public void setOption(TL_stars$TL_starsGiveawayOption tL_stars$TL_starsGiveawayOption, int i, long j, boolean z, boolean z2) {
        boolean z3 = this.currentOption == tL_stars$TL_starsGiveawayOption;
        this.radioButton.setChecked(z, z3);
        this.currentOption = tL_stars$TL_starsGiveawayOption;
        ...
        if (tL_stars$TL_starsGiveawayOption == null) {
            ...
            this.titleView.setText(LocaleController.formatPluralStringComma("GiveawayStars", (int) tL_stars$TL_starsGiveawayOption.stars, ' '), false);
            this.subtitleView.setText(LocaleController.formatPluralStringComma("BoostingStarOptionPerUser", (int) j, ','), z3);
            this.priceView.setText(BillingController.getInstance().formatCurrency(tL_stars$TL_starsGiveawayOption.amount, tL_stars$TL_starsGiveawayOption.currency));
        }
        int i2 = i + 1;
        this.starsCount = i2;
        if (!z3) {
