...
public class LimitReachedBottomSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public class HeaderView extends LinearLayout {
        ...
        public HeaderView(android.content.Context r41) {
    ...
    public void revokeLinks(final ArrayList arrayList) {
        ...
        if (arrayList.size() == 1) {
            ...
            if (this.parentIsChannel) {
                formatString = LocaleController.formatString("RevokeLinkAlertChannel", R.string.RevokeLinkAlertChannel, MessagesController.getInstance(this.currentAccount).linkPrefix + "/" + ChatObject.getPublicUsername(tLRPC$Chat), tLRPC$Chat.title);
            } else {
                formatString = LocaleController.formatString("RevokeLinkAlert", R.string.RevokeLinkAlert, MessagesController.getInstance(this.currentAccount).linkPrefix + "/" + ChatObject.getPublicUsername(tLRPC$Chat), tLRPC$Chat.title);
            }
        } else {
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (lastFragment2 instanceof ChatCustomReactionsEditActivity) {
            ...
            dismiss();
            if (!booleanValue) {
                lastFragment2.lambda$onBackPressed$308();
