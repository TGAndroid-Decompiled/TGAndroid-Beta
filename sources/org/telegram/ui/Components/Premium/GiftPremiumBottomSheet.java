...
public class GiftPremiumBottomSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public class AnonymousClass1 extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 1) {
                ...
                if (i != 2) {
                    view = i != 3 ? new PremiumGiftHeaderCell(GiftPremiumBottomSheet.this.getContext()) : new View(GiftPremiumBottomSheet.this.getContext()) {
                        @Override
    ...
    private void initData() {
        ...
        if (userFull != null) {
            ...
            if (BuildVars.useInvoiceBilling()) {
                ...
                while (it2.hasNext()) {
                    ((GiftTier) it2.next()).setPricePerMonthRegular(j);
                }
    ...
    public void lambda$initData$2(long j) {
    ...
    public void lambda$initData$3(final long j, BillingResult billingResult, List list) {
        ...
        Iterator it3 = this.giftTiers.iterator();
        while (it3.hasNext()) {
            ((GiftTier) it3.next()).setPricePerMonthRegular(j2);
        }
    ...
    public void lambda$new$1(Path path, Canvas canvas) {
        path.rewind();
    ...
    private void updateButtonText(boolean z) {
        ...
        if (BuildVars.useInvoiceBilling() || (BillingController.getInstance().isReady() && ((GiftTier) this.giftTiers.get(this.selectedTierIndex)).googlePlayProductDetails != null)) {
            this.premiumButtonView.setButton(LocaleController.formatString(R.string.GiftSubscriptionFor, ((GiftTier) this.giftTiers.get(this.selectedTierIndex)).getFormattedPrice()), new View.OnClickListener() {
                @Override
