...
public final class oy extends ql0 {
    ...
    public boolean H;
    public final kz I;
    public final Context f27682c;
    public final boolean d;
    public final qy e;
    public final int f27683f;
    public int h;
    public TLRPC.User f27684n;
    public String f27685r;
    public boolean f27686s;
    public boolean v;
    public String f27687w;
    public final ArrayList f27688x = new ArrayList();
    public final HashMap f27689y = new HashMap();
    public int F = -1;
    public int G = -1;
    ...
    public final void E(String str, String str2, boolean z4, boolean z10, boolean z11, String str3, TLObject tLObject) {
        boolean z12;
        if (str != null && str.equals(this.f27687w)) {
            this.h = 0;
            ...
            HashMap hashMap = this.f27689y;
            boolean z13 = this.d;
            ArrayList arrayList = this.f27688x;
            kz kzVar = this.I;
            if (!z13 && TextUtils.isEmpty(str2)) {
                arrayList.clear();
                hashMap.clear();
                kzVar.f26457l0.e(false);
            }
            if (tLObject instanceof TLRPC.messages_BotResults) {
                int size = arrayList.size();
                TLRPC.messages_BotResults messages_botresults = (TLRPC.messages_BotResults) tLObject;
                HashMap hashMap2 = kzVar.f26448i0;
                oy oyVar = kzVar.f26454k0;
                if (!hashMap2.containsKey(str3)) {
                    kzVar.f26448i0.put(str3, messages_botresults);
                }
                if (!z11 && messages_botresults.cache_time != 0) {
                    MessagesStorage.getInstance(kzVar.Z0).saveBotCache(str3, messages_botresults);
                }
                this.f27685r = messages_botresults.next_offset;
                int i10 = 0;
                for (int i11 = 0; i11 < messages_botresults.results.size(); i11++) {
                    ...
                    if (!hashMap.containsKey(botInlineResult.f19157id)) {
                        botInlineResult.query_id = messages_botresults.query_id;
                        arrayList.add(botInlineResult);
                        hashMap.put(botInlineResult.f19157id, botInlineResult);
                        i10++;
                    }
                }
                if (size != arrayList.size() && !TextUtils.isEmpty(this.f27685r)) {
                    z12 = false;
                } else {
                    z12 = true;
                }
            ...
            if (!z13) {
                if (kzVar.f26435e0.getAdapter() != this) {
                    kzVar.f26435e0.setAdapter(this);
                }
    ...
    public final void F(final String str, final String str2, final boolean z4, final boolean z10, final boolean z11) {
        ...
        this.f27684n = (TLRPC.User) userOrChat;
        ...
        if (z11 && hashMap.containsKey(k10)) {
        ...
        } else if (kzVar.f26445h0.f28608a.contains(k10)) {
        } else {
            if (z11) {
                this.h = -1;
            ...
            tL_messages_getInlineBotResults.bot = MessagesController.getInstance(i12).getInputUser(this.f27684n);
    ...
    public final void G(String str, boolean z4) {
        ...
        if (!this.d) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                if (currentPosition != kzVar.f26465o0 && currentPosition != kzVar.f26468p0) {
                    H(MessagesController.getInstance(kzVar.Z0).gifSearchEmojies.get(currentPosition - kzVar.f26471q0));
                    return;
                }
            ...
            if (!TextUtils.isEmpty(lowerCase)) {
                ...
                AndroidUtilities.runOnUIThread(emVar2, j10);
            }
        }
    }

    public final void H(String str) {
        if (this.v && TextUtils.equals(this.f27687w, str)) {
            this.I.f26439f0.h1(0, 0);
        } else {
    ...
    public final void l() {
        int i10;
        if (this.d && (i10 = this.f27683f) != 0) {
            kz kzVar = this.I;
            if (i10 == Integer.MAX_VALUE) {
                this.E = kzVar.f26440f1.size();
            } else {
                jw jwVar = kzVar.f26435e0;
                py pyVar = kzVar.f26439f0;
                if (jwVar.getMeasuredWidth() != 0) {
                    int measuredWidth = kzVar.f26435e0.getMeasuredWidth();
                    int i11 = pyVar.J;
                    int dp = AndroidUtilities.dp(100.0f);
                    this.E = 0;
                    int size = kzVar.f26440f1.size();
                    int i12 = i11;
                    int i13 = 0;
                    int i14 = 0;
                    for (int i15 = 0; i15 < size; i15++) {
                        TLRPC.Document document = (TLRPC.Document) kzVar.f26440f1.get(i15);
                        jv0 C1 = nz.C1(pyVar.F1(document, document.attributes));
                        int min = Math.min(i11, (int) Math.floor((((C1.f26062a / C1.f26063b) * dp) / measuredWidth) * i11));
                        if (i12 < min) {
                            this.E += i13;
                            i14++;
                            if (i14 == i10) {
    ...
    public final void v(f2.l1 l1Var, int i10) {
        ...
        org.telegram.ui.Cells.d2 d2Var = (org.telegram.ui.Cells.d2) l1Var.f5774a;
        int i11 = this.G;
        if (i11 >= 0 && i10 >= i11) {
            d2Var.e((TLRPC.BotInlineResult) this.f27688x.get(i10 - i11), this.f27684n, true, false, false, true);
            return;
        }
        TLRPC.Document document = (TLRPC.Document) this.I.f26440f1.get(i10);
        d2Var.getClass();
        ...
        if (i10 != 0) {
            ...
            if (i10 != 1) {
                if (i10 != 2) {
                    ...
                    org.telegram.ui.Cells.l8 l8Var2 = new org.telegram.ui.Cells.l8(this.f27682c, false, false, kzVar.W1, kzVar.f26441f2);
                    l8Var2.b(0, LocaleController.getString(R.string.FeaturedGifs));
            ...
            org.telegram.ui.Cells.d2 d2Var = new org.telegram.ui.Cells.d2(this.f27682c);
