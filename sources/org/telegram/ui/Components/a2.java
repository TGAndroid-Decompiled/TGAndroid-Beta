...
public final class a2 implements View.OnClickListener {
    public final int f22560a = 0;
    public final int[] f22561b;
    public final Object f22562c;
    public final ViewGroup d;
    public final Object e;
    public final KeyEvent.Callback f22563f;
    public final Object h;
    public final Object f22564n;
    public final Object f22565r;
    ...
    public final void onClick(View view) {
        ...
        switch (this.f22560a) {
            case 0:
                FrameLayout frameLayout = (FrameLayout) this.f22562c;
                org.telegram.ui.ActionBar.d6 d6Var = (org.telegram.ui.ActionBar.d6) this.e;
                org.telegram.ui.ActionBar.e3 e3Var = (org.telegram.ui.ActionBar.e3) this.f22563f;
                FrameLayout frameLayout2 = (FrameLayout) this.d;
                String[] strArr = (String[]) this.f22564n;
                int[] iArr = (int[]) this.h;
                Runnable runnable2 = (Runnable) this.f22565r;
            ...
            default:
                xt xtVar = (xt) this.f22564n;
                ((boolean[]) this.f22562c)[0] = false;
                cu.j((cu) xtVar.f30401c, xtVar.f30399a, xtVar.f30400b, (int) (e5.c(null, (ed0) this.d, (ed0) this.e, (ed0) this.f22563f, (ed0) this.h) / 1000), this.f22561b[0]);
                runnable = ((org.telegram.ui.ActionBar.z2) this.f22565r).f19950a.dismissRunnable;
                runnable.run();
                return;
        }
    }
