...
public final class ch0 extends org.telegram.ui.Cells.a0 implements oo0, DownloadController.FileDownloadProgressListener {
    public int E;
    public int F;
    public int G;
    ...
    public final void onDetachedFromWindow() {
        ...
        DownloadController.getInstance(this.f23321n).removeLoadingFileObserver(this);
    }
    ...
    public final void onDraw(Canvas canvas) {
        if (this.h != null) {
            ...
            canvas.save();
            int i12 = this.f23326y;
            if (i12 != 0 && i12 != 1) {
                canvas.translate(AndroidUtilities.dp(12.0f) + this.f23324w, this.f23325x);
                ki0 ki0Var = this.v;
                float f7 = ki0Var.e / 2;
                float f10 = ki0Var.f25741f / 2.0f;
                canvas.drawRect(0.0f, f7 - f10, ki0Var.d, f10 + f7, ki0Var.f25738a);
                float f11 = ki0Var.e / 2;
                canvas.drawRect(0.0f, f11 - f10, ki0Var.f25740c * ki0Var.d, f10 + f11, ki0Var.f25739b);
            } else {
                canvas.translate(this.f23324w, this.f23325x);
                this.f23323s.b(canvas);
            }
            canvas.restore();
            int i13 = this.f23326y;
            this.f23322r.setColor(-6182221);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ki0 ki0Var = this.v;
        if (this.h != null) {
            this.f23324w = AndroidUtilities.dp(54.0f);
            this.E = AndroidUtilities.dp(10.0f);
            this.I = (getMeasuredWidth() - this.J) - AndroidUtilities.dp(16.0f);
            this.f23323s.j((getMeasuredWidth() - AndroidUtilities.dp(70.0f)) - this.J, AndroidUtilities.dp(30.0f));
            ki0Var.d = (getMeasuredWidth() - AndroidUtilities.dp(94.0f)) - this.J;
            ki0Var.e = AndroidUtilities.dp(30.0f);
            this.f23325x = AndroidUtilities.dp(13.0f);
    ...
    public final void r() {
        ...
        if (FileLoader.getInstance(this.f23321n).getPathToMessage(this.h.messageOwner).exists()) {
            DownloadController.getInstance(this.f23321n).removeLoadingFileObserver(this);
            ...
            DownloadController.getInstance(this.f23321n).addLoadingFileObserver(fileName, this);
            if (!FileLoader.getInstance(this.f23321n).isLoadingFile(fileName)) {
                this.f23326y = 2;
                ki0Var.a(0.0f);
            } else {
                this.f23326y = 3;
                ...
                if (fileProgress != null) {
                    ki0Var.a(fileProgress.floatValue());
                } else {
                    ki0Var.a(0.0f);
                }
            }
    ...
    public final void s() {
        int i10;
        TextPaint textPaint = this.f23322r;
        MessageObject messageObject = this.h;
        if (messageObject == null) {
            return;
        }
        po0 po0Var = this.f23323s;
        if (!po0Var.e) {
    ...
    public void setMessageObject(MessageObject messageObject) {
        if (this.h != messageObject) {
            this.f23321n = messageObject.currentAccount;
            po0 po0Var = this.f23323s;
            ...
            po0Var.h(w02, w03, org.telegram.ui.ActionBar.h6.w0(null, i11, false), org.telegram.ui.ActionBar.h6.w0(null, i11, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19414wd, false));
            ki0 ki0Var = this.v;
            ki0Var.f25738a.setColor(-2497813);
            ki0Var.f25739b.setColor(-7944712);
