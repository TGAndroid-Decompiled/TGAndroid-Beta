...
public final class CustomEmojiReactionsWindow$$ExternalSyntheticLambda0 implements ValueAnimator.AnimatorUpdateListener {
    public final int $r8$classId;
    public final CustomEmojiReactionsWindow f$0;

    public CustomEmojiReactionsWindow$$ExternalSyntheticLambda0(CustomEmojiReactionsWindow customEmojiReactionsWindow, int i) {
        this.$r8$classId = i;
