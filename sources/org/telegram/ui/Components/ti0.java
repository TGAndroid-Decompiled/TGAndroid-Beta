...
public final class ti0 implements LeadingMarginSpan {
    ...
    public final si0 f28210s;
    public ii.a6 v;
    public final Drawable f28211w;
    public final Paint f28212x;
    public final float[] f28213y;

    public ti0(boolean z10, boolean z11, si0 si0Var) {
        Paint paint = new Paint(1);
        this.f28212x = paint;
        this.f28213y = new float[8];
        this.E = new Path();
        ...
        this.f28210s = si0Var;
        this.e = z11;
        this.f28211w = ApplicationLoader.applicationContext.getResources().getDrawable(R.drawable.mini_quote).mutate();
    ...
    public static void a(SpannableStringBuilder spannableStringBuilder) {
        ...
        while (true) {
            ...
            spannableStringBuilder.removeSpan(si0Var.f27938a);
            i13++;
        }
    ...
    public static void b(Spannable spannable, int i10, int i11, boolean z10) {
        ...
        metricAffectingSpan.f27938a = ti0Var;
        ti0Var.f28206c = clamp;
        ti0Var.d = clamp2;
    ...
    public static java.util.ArrayList d(org.telegram.ui.Components.eu r19, android.text.Layout r20, java.util.ArrayList r21, boolean[] r22) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.ti0.d(org.telegram.ui.Components.eu, android.text.Layout, java.util.ArrayList, boolean[]):java.util.ArrayList");
    }
