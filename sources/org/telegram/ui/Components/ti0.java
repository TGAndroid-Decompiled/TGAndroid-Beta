...
public final class ti0 implements LeadingMarginSpan {
    ...
    public final si0 f28110s;
    public ii.z5 v;
    public final Drawable f28111w;
    public final Paint f28112x;
    public final float[] f28113y;

    public ti0(boolean z10, boolean z11, si0 si0Var) {
        Paint paint = new Paint(1);
        this.f28112x = paint;
        this.f28113y = new float[8];
        this.E = new Path();
        ...
        this.f28110s = si0Var;
        this.e = z11;
        this.f28111w = ApplicationLoader.applicationContext.getResources().getDrawable(R.drawable.mini_quote).mutate();
    ...
    public static void a(SpannableStringBuilder spannableStringBuilder) {
        ...
        while (true) {
            ...
            spannableStringBuilder.removeSpan(si0Var.f27870a);
            i13++;
        }
    ...
    public static void b(Spannable spannable, int i10, int i11, boolean z10) {
        ...
        metricAffectingSpan.f27870a = ti0Var;
        ti0Var.f28106c = clamp;
        ti0Var.d = clamp2;
