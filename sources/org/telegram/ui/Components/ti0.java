...
public final class ti0 {
    public final z5 f31358a;
    public final j6 f31359b;
    public final int f31360c;
    public boolean d;
    public final yi0 f31361e;
    public final rc f31362f;
    public final Paint f31363g = new Paint(1);
    public boolean h;

    public ti0(View view) {
        this.f31358a = new z5(view, 350L, pr.h);
        this.f31361e = new yi0(view);
        this.f31362f = new rc(view);
        ...
        this.f31360c = (int) Math.ceil(Math.max(textPaint.measureText(string), textPaint.measureText(LocaleController.getString(R.string.QuoteCollapse))));
    }

    public final void a(Canvas canvas, RectF rectF, float f10, float f11, int i10, boolean z4, boolean z10) {
        int i11;
        boolean z11 = this.d;
        j6 j6Var = this.f31359b;
        if (z4 != z11) {
            this.d = z4;
            if (z4) {
        ...
        float a2 = this.f31362f.a(0.02f) * this.f31358a.e(z10);
        if (a2 > 0.0f) {
            int k10 = i0.a.k(i10, 30);
            Paint paint = this.f31363g;
            paint.setColor(k10);
            canvas.save();
            ...
            Paint paint2 = yi0Var.f33546b;
            paint2.setColor(i10);
            paint2.setAlpha(yi0Var.d);
            boolean z12 = !z4;
            if (yi0Var.f33548e != z12) {
                yi0Var.f33548e = z12;
                yi0Var.f33545a.invalidate();
            }
            yi0Var.draw(canvas);
            canvas.restore();
        }
