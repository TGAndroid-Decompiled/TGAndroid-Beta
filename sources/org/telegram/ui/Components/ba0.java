...
public final class ba0 extends org.telegram.ui.ActionBar.o2 implements su0, mg.b, NotificationCenter.NotificationCenterDelegate {
    ...
    public int f22679a;
    public final boolean[] f22680a0;
    public ru0 f22681b;
    public final ValueAnimator[] f22682b0;
    public TLRPC.ChatFull f22683c;
    ...
    public int f22686r;
    public FrameLayout f22687s;
    public final FrameLayout[] v;
    public final org.telegram.ui.ActionBar.k5[] f22688w;
    public final n6[] f22689x;
    public w90 f22690y;

    public ba0(Bundle bundle, ru0 ru0Var) {
        super(bundle);
        this.v = new FrameLayout[2];
        this.f22688w = new org.telegram.ui.ActionBar.k5[2];
        this.f22689x = new n6[2];
        this.L = true;
        this.M = true;
        this.N = -12;
        this.Y = new boolean[2];
        this.Z = new float[2];
        this.f22680a0 = new boolean[]{true, true};
        this.f22682b0 = new ValueAnimator[2];
        this.f22681b = ru0Var;
    }
    ...
    public final void M() {
        ru0 ru0Var;
        y90 y90Var = this.V;
        if (y90Var != null && (ru0Var = this.f22681b) != null) {
            y90Var.setNewMediaCounts(ru0Var.f27694c);
        }
        a0();
    }

    public final void X(TLRPC.ChatFull chatFull) {
        this.f22683c = chatFull;
    }
    ...
    public final void Y(int i10, boolean z10, boolean z11) {
        ...
        if (i11 != 3) {
            if (i10 != 1 || i11 != 2) {
                ...
                zArr2[i10] = false;
                zArr[i10] = z10;
                ValueAnimator[] valueAnimatorArr = this.f22682b0;
                ...
                fArr[i10] = f7;
                org.telegram.ui.ActionBar.k5[] k5VarArr = this.f22688w;
    ...
    public final void Z() {
        ...
        this.actionBar.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18806a7, false));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, null, null, null, w6Var, org.telegram.ui.ActionBar.j6.f18862d6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, null, null, null, w6Var, org.telegram.ui.ActionBar.j6.f19265z8));
    ...
    public final boolean isLightStatusBar() {
        if (getLastStoryViewer() == null || getLastStoryViewer().H0) {
            ...
            if (this.actionBar.s()) {
                w02 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19212w8, false);
            }
    ...
    public final boolean onFragmentCreate() {
        int i10;
        this.f22679a = getArguments().getInt("type", 0);
        this.e = getArguments().getLong("dialog_id");
        this.f22684f = getArguments().getLong("topic_id", 0L);
        this.h = getArguments().getString("hashtag", "");
        this.f22685n = getArguments().getString("username", "");
        this.f22686r = getArguments().getInt("storiesCount", -1);
        int i11 = this.f22679a;
        if (i11 == 2) {
            i10 = 9;
        } else if (i11 == 1) {
        ...
        if (DialogObject.isUserDialog(this.e) && this.f22684f == 0) {
        ...
        if (this.f22681b == null) {
            this.f22681b = new ru0(this);
        }
        this.f22681b.f27700x.add(this);
