...
public abstract class ba0 {
    public static final Pattern f22951a = Pattern.compile("^\\[\\^([^\\]]+)\\]:[ \\t]*(.*)$");
    public static final Pattern f22952b = Pattern.compile("\\[\\^([^\\]]+)\\]");
    public static final Pattern f22953c = Pattern.compile("^(\\d+)[.)]\\s");

    public static TL_iv.RichText a(bf.p pVar, TL_iv.PageBlock pageBlock) {
        y90 y90Var = new y90(pageBlock);
        pVar.a(y90Var);
        return g(h(y90.x(y90Var.f30576c)));
    }
