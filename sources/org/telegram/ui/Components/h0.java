...
public final class h0 extends bb {
    ...
    public ArrayList Z;
    public a0.i f26571a0;
    public final boolean f26572b0;
    public final org.telegram.ui.o20 f26573c0;
    public boolean f26574d0;
    public boolean f26575e0;
    public boolean f26576f0;
    public org.telegram.ui.ya f26577g0;
    ...
    public final void S(ArrayList arrayList) {
        this.Z = arrayList;
        if (arrayList != null && this.f26571a0 == null) {
            this.f26571a0 = new a0.i();
            ArrayList arrayList2 = this.Z;
            ...
            while (i10 < size) {
                ...
                this.f26571a0.k(MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(peerDialogId)), peerDialogId);
            }
        }
        v51 v51Var = this.X;
        if (v51Var != null) {
    ...
    public final void onSmoothContainerViewLayout(float f7) {
        ...
        this.f26573c0.setTranslationY(-f7);
    }
