...
public final class h0 extends bb {
    ...
    public ArrayList Z;
    public a0.i f26572a0;
    public final boolean f26573b0;
    public final org.telegram.ui.o20 f26574c0;
    public boolean f26575d0;
    public boolean f26576e0;
    public boolean f26577f0;
    public org.telegram.ui.ya f26578g0;
    ...
    public final void S(ArrayList arrayList) {
        this.Z = arrayList;
        if (arrayList != null && this.f26572a0 == null) {
            this.f26572a0 = new a0.i();
            ArrayList arrayList2 = this.Z;
            ...
            while (i10 < size) {
                ...
                this.f26572a0.k(MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(peerDialogId)), peerDialogId);
            }
        }
        v51 v51Var = this.X;
        if (v51Var != null) {
    ...
    public final void onSmoothContainerViewLayout(float f7) {
        ...
        this.f26574c0.setTranslationY(-f7);
    }
