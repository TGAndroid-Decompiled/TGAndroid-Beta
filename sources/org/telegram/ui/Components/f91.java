...
public final class f91 extends FrameLayout {
    public static final int f24055f = 0;
    public final org.telegram.ui.ActionBar.f6 f24056a;
    public final cm0 f24057b;
    public final RectF f24058c;
    ...
    public f91(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        cm0Var.A = v02;
        cm0Var.f23368z = v02;
        cm0Var.f23366x = org.telegram.ui.ActionBar.j6.l1(0.1f, v02);
        cm0Var.f23353j = false;
        cm0Var.f23352i = false;
        cm0Var.k();
    }

    @Override
    public final void onDraw(Canvas canvas) {
        RectF rectF = this.f24058c;
        rectF.set(0.0f, 0.0f, getWidth(), getHeight());
        cm0 cm0Var = this.f24057b;
        float[] fArr = cm0Var.e;
        ...
        this.f24057b.d(canvas, rectF, 1.0f, false, false);
        RectF rectF2 = this.d;
    ...
    public void setWebPage(TLRPC.WebPage webPage) {
        ...
        org.telegram.ui.ActionBar.f6 f6Var = this.f24056a;
        if (str != null) {
        ...
        if (webPage.description != null) {
            ...
            textView3.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19201j5, f6Var));
        ...
        if (z10) {
            ...
            v9Var.setBackground(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(6.0f), org.telegram.ui.ActionBar.j6.l1(0.08f, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19201j5, f6Var))));
