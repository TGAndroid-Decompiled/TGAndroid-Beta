...
public final class f91 extends FrameLayout {
    public static final int f24176f = 0;
    public final org.telegram.ui.ActionBar.d6 f24177a;
    public final em0 f24178b;
    public final RectF f24179c;
    public final RectF d;
    public final Path e;

    public f91(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        em0 em0Var = new em0(this);
        this.f24178b = em0Var;
        this.f24179c = new RectF();
        this.d = new RectF();
        this.e = new Path();
        ...
        em0Var.A = v02;
        em0Var.f24017z = v02;
        em0Var.f24015x = org.telegram.ui.ActionBar.h6.l1(0.1f, v02);
        em0Var.f24002j = false;
        em0Var.f24001i = false;
        em0Var.k();
    }

    @Override
    public final void onDraw(Canvas canvas) {
        RectF rectF = this.f24179c;
        rectF.set(0.0f, 0.0f, getWidth(), getHeight());
        em0 em0Var = this.f24178b;
        float[] fArr = em0Var.e;
        ...
        this.f24178b.d(canvas, rectF, 1.0f, false, false);
        RectF rectF2 = this.d;
        rectF2.set(0.0f, 0.0f, AndroidUtilities.dp(3.0f), getHeight());
        em0Var.e(canvas, rectF2, 1.0f);
        canvas.restore();
    }
    ...
    public void setWebPage(TLRPC.WebPage webPage) {
        ...
        org.telegram.ui.ActionBar.d6 d6Var = this.f24177a;
        if (str != null) {
        ...
        if (webPage.description != null) {
            ...
            textView3.setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19165j5, d6Var));
        ...
        if (z10) {
            ...
            w9Var.setBackground(org.telegram.ui.ActionBar.h6.b0(AndroidUtilities.dp(6.0f), org.telegram.ui.ActionBar.h6.l1(0.08f, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19165j5, d6Var))));
