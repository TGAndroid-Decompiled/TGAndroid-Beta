...
public final class zz {
    ...
    public int f30673a0;
    public final FloatBuffer f30674a1;
    public int f30676b0;
    public final FloatBuffer f30677b1;
    public boolean f30678c;
    public int f30679c0;
    public ByteBuffer f30680c1;
    public boolean d;
    public int f30681d0;
    public ByteBuffer f30682d1;
    public xz e;
    public int f30683e0;
    public ByteBuffer f30684e1;
    public float f30685f;
    public int f30686f0;
    public yz f30687f1;
    public xz f30688g;
    public int f30689g0;
    public final boolean f30690g1;
    public boolean h;
    public int f30691h0;
    public ci.n8 f30692h1;
    public int f30693i;
    public int f30694i0;
    public int f30696j;
    public int f30697j0;
    ...
    public int f30726z;
    public int f30727z0;
    public boolean f30672a = true;
    public boolean f30675b = true;
    ...
    public final boolean a() {
        ...
        if (h != 0 && h10 != 0) {
            ...
            if (iArr3[0] == 0) {
                ...
                this.f30673a0 = GLES20.glGetUniformLocation(this.T, "contrast");
                this.f30676b0 = GLES20.glGetUniformLocation(this.T, "saturation");
                this.f30679c0 = GLES20.glGetUniformLocation(this.T, "warmth");
                this.f30681d0 = GLES20.glGetUniformLocation(this.T, "vignette");
                this.f30683e0 = GLES20.glGetUniformLocation(this.T, "grain");
                this.f30686f0 = GLES20.glGetUniformLocation(this.T, "width");
                this.f30689g0 = GLES20.glGetUniformLocation(this.T, "height");
                this.f30691h0 = GLES20.glGetUniformLocation(this.T, "curvesImage");
                this.f30694i0 = GLES20.glGetUniformLocation(this.T, "skipTone");
                this.f30697j0 = GLES20.glGetUniformLocation(this.T, "fadeAmount");
                this.f30699k0 = GLES20.glGetUniformLocation(this.T, "shadowsTintIntensity");
                this.f30701l0 = GLES20.glGetUniformLocation(this.T, "highlightsTintIntensity");
                this.m0 = GLES20.glGetUniformLocation(this.T, "shadowsTintColor");
                this.f30704n0 = GLES20.glGetUniformLocation(this.T, "highlightsTintColor");
            }
            ...
            if (h11 != 0 && h12 != 0) {
                ...
                if (xzVar.a() && j()) {
                    ...
                    if (h13 != 0 && h14 != 0) {
                        ...
                        this.f30706o0 = glCreateProgram3;
                        GLES20.glAttachShader(glCreateProgram3, h13);
                        GLES20.glAttachShader(this.f30706o0, h14);
                        GLES20.glBindAttribLocation(this.f30706o0, 0, "position");
                        GLES20.glBindAttribLocation(this.f30706o0, 1, "inputTexCoord");
                        GLES20.glLinkProgram(this.f30706o0);
                        GLES20.glGetProgramiv(this.f30706o0, 35714, iArr3, 0);
                        if (iArr3[0] == 0) {
                            GLES20.glDeleteProgram(this.f30706o0);
                            this.f30706o0 = 0;
                        } else {
                            this.f30708p0 = GLES20.glGetAttribLocation(this.f30706o0, "position");
                            this.f30710q0 = GLES20.glGetAttribLocation(this.f30706o0, "inputTexCoord");
                            this.f30712r0 = GLES20.glGetUniformLocation(this.f30706o0, "sTexture");
                            this.f30714s0 = GLES20.glGetUniformLocation(this.f30706o0, "inputImageTexture2");
                            this.f30716t0 = GLES20.glGetUniformLocation(this.f30706o0, "excludeSize");
                            this.f30718u0 = GLES20.glGetUniformLocation(this.f30706o0, "excludePoint");
                            this.f30719v0 = GLES20.glGetUniformLocation(this.f30706o0, "excludeBlurSize");
                            this.f30721w0 = GLES20.glGetUniformLocation(this.f30706o0, "angle");
                            this.f30723x0 = GLES20.glGetUniformLocation(this.f30706o0, "aspectRatio");
                        }
                        ...
                        if (h15 != 0 && h16 != 0) {
                            ...
                            this.f30725y0 = glCreateProgram4;
                            GLES20.glAttachShader(glCreateProgram4, h15);
                            GLES20.glAttachShader(this.f30725y0, h16);
                            GLES20.glBindAttribLocation(this.f30725y0, 0, "position");
                            GLES20.glBindAttribLocation(this.f30725y0, 1, "inputTexCoord");
                            GLES20.glLinkProgram(this.f30725y0);
                            GLES20.glGetProgramiv(this.f30725y0, 35714, iArr3, 0);
                            if (iArr3[0] == 0) {
                                GLES20.glDeleteProgram(this.f30725y0);
                                this.f30725y0 = 0;
                            } else {
                                this.f30727z0 = GLES20.glGetAttribLocation(this.f30725y0, "position");
                                this.A0 = GLES20.glGetAttribLocation(this.f30725y0, "inputTexCoord");
                                this.B0 = GLES20.glGetUniformLocation(this.f30725y0, "sTexture");
                                this.C0 = GLES20.glGetUniformLocation(this.f30725y0, "inputImageTexture2");
                                this.D0 = GLES20.glGetUniformLocation(this.f30725y0, "excludeSize");
                                this.E0 = GLES20.glGetUniformLocation(this.f30725y0, "excludePoint");
                                this.F0 = GLES20.glGetUniformLocation(this.f30725y0, "excludeBlurSize");
                                this.G0 = GLES20.glGetUniformLocation(this.f30725y0, "aspectRatio");
                            }
                            ...
                            if (h17 != 0 && h18 != 0) {
                                ...
                                if (h20 != 0 && h19 != 0) {
                                    ...
                                    this.f30707p = glCreateProgram6;
                                    GLES20.glAttachShader(glCreateProgram6, h20);
                                    GLES20.glAttachShader(this.f30707p, h19);
                                    GLES20.glBindAttribLocation(this.f30707p, 0, "position");
                                    GLES20.glBindAttribLocation(this.f30707p, 1, "inputTexCoord");
                                    GLES20.glLinkProgram(this.f30707p);
                                    GLES20.glGetProgramiv(this.f30707p, 35714, iArr3, 0);
                                    if (iArr3[0] == 0) {
                                        GLES20.glDeleteProgram(this.f30707p);
                                        this.f30707p = 0;
                                    } else {
                                        this.f30709q = GLES20.glGetAttribLocation(this.f30707p, "position");
                                        this.f30711r = GLES20.glGetAttribLocation(this.f30707p, "inputTexCoord");
                                        this.f30713s = GLES20.glGetUniformLocation(this.f30707p, "sTexture");
                                        this.f30715t = GLES20.glGetUniformLocation(this.f30707p, "inputImageTexture2");
                                    }
    ...
    public final boolean b() {
        int i10;
        yz yzVar;
        yz yzVar2 = this.f30687f1;
        if (yzVar2 != null) {
            i10 = yzVar2.getBlurType();
        } else {
            i10 = 0;
        }
        if (this.f30690g1 || (yzVar = this.f30687f1) == null || yzVar.b() || i10 == 0) {
            return false;
        }
        boolean z10 = this.f30672a;
        int[] iArr = this.S0;
        if (z10) {
            if (!this.f30678c) {
            ...
            GLES20.glUseProgram(this.f30688g.f30093c);
            GLES20.glUniform1i(this.f30688g.f30094f, 0);
            GLES20.glEnableVertexAttribArray(this.f30688g.e);
            GLES20.glVertexAttribPointer(this.f30688g.e, 2, 5126, false, 8, (Buffer) this.f30674a1);
            GLES20.glEnableVertexAttribArray(this.f30688g.d);
            GLES20.glVertexAttribPointer(this.f30688g.d, 2, 5126, false, 8, (Buffer) this.f30677b1);
            GLES20.glBindFramebuffer(36160, this.U0[0]);
            GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr[0], 0);
            GLES20.glActiveTexture(33984);
            GLES20.glBindTexture(3553, iArr[1]);
            GLES20.glUniform1f(this.f30688g.f30095g, 0.0f);
            GLES20.glUniform1f(this.f30688g.h, 1.0f / this.Y0);
            GLES20.glDrawArrays(5, 0, 4);
            GLES20.glBindFramebuffer(36160, this.U0[2]);
            GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr[2], 0);
            GLES20.glActiveTexture(33984);
            GLES20.glBindTexture(3553, iArr[0]);
            GLES20.glUniform1f(this.f30688g.f30095g, 1.0f / this.X0);
            GLES20.glUniform1f(this.f30688g.h, 0.0f);
            GLES20.glDrawArrays(5, 0, 4);
            this.f30672a = false;
        }
        GLES20.glBindFramebuffer(36160, this.U0[0]);
        GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr[0], 0);
        if (i10 == 1) {
            GLES20.glUseProgram(this.f30725y0);
            GLES20.glUniform1i(this.B0, 0);
            GLES20.glUniform1i(this.C0, 1);
            GLES20.glUniform1f(this.D0, this.f30687f1.getBlurExcludeSize());
            GLES20.glUniform1f(this.F0, this.f30687f1.getBlurExcludeBlurSize());
            PointF blurExcludePoint = this.f30687f1.getBlurExcludePoint();
            ...
            GLES20.glVertexAttribPointer(this.A0, 2, 5126, false, 8, (Buffer) this.f30674a1);
            GLES20.glEnableVertexAttribArray(this.f30727z0);
            GLES20.glVertexAttribPointer(this.f30727z0, 2, 5126, false, 8, (Buffer) this.f30677b1);
        } else if (i10 == 2) {
            GLES20.glUseProgram(this.f30706o0);
            GLES20.glUniform1i(this.f30712r0, 0);
            GLES20.glUniform1i(this.f30714s0, 1);
            GLES20.glUniform1f(this.f30716t0, this.f30687f1.getBlurExcludeSize());
            GLES20.glUniform1f(this.f30719v0, this.f30687f1.getBlurExcludeBlurSize());
            GLES20.glUniform1f(this.f30721w0, this.f30687f1.getBlurAngle());
            PointF blurExcludePoint2 = this.f30687f1.getBlurExcludePoint();
            GLES20.glUniform2f(this.f30718u0, blurExcludePoint2.x, blurExcludePoint2.y);
            GLES20.glUniform1f(this.f30723x0, this.Y0 / this.X0);
            GLES20.glEnableVertexAttribArray(this.f30710q0);
            GLES20.glVertexAttribPointer(this.f30710q0, 2, 5126, false, 8, (Buffer) this.f30674a1);
            GLES20.glEnableVertexAttribArray(this.f30708p0);
            GLES20.glVertexAttribPointer(this.f30708p0, 2, 5126, false, 8, (Buffer) this.f30677b1);
        }
        GLES20.glActiveTexture(33984);
        GLES20.glBindTexture(3553, iArr[1]);
    ...
    public final void c() {
        ...
        yz yzVar = this.f30687f1;
        float f7 = 1.0f;
        if (yzVar != null && !yzVar.b()) {
            GLES20.glUniform1f(this.X, this.f30687f1.getShadowsValue());
            GLES20.glUniform1f(this.Y, this.f30687f1.getHighlightsValue());
            GLES20.glUniform1f(this.Z, this.f30687f1.getExposureValue());
            GLES20.glUniform1f(this.f30673a0, this.f30687f1.getContrastValue());
            GLES20.glUniform1f(this.f30676b0, this.f30687f1.getSaturationValue());
            GLES20.glUniform1f(this.f30679c0, this.f30687f1.getWarmthValue());
            GLES20.glUniform1f(this.f30681d0, this.f30687f1.getVignetteValue());
            GLES20.glUniform1f(this.f30683e0, this.f30687f1.getGrainValue());
            GLES20.glUniform1f(this.f30697j0, this.f30687f1.getFadeValue());
            int tintHighlightsColor = this.f30687f1.getTintHighlightsColor();
            int tintShadowsColor = this.f30687f1.getTintShadowsColor();
            GLES20.glUniform3f(this.f30704n0, ((tintHighlightsColor >> 16) & 255) / 255.0f, ((tintHighlightsColor >> 8) & 255) / 255.0f, (tintHighlightsColor & 255) / 255.0f);
            GLES20.glUniform1f(this.f30701l0, this.f30687f1.getTintHighlightsIntensityValue());
            GLES20.glUniform3f(this.m0, ((tintShadowsColor >> 16) & 255) / 255.0f, ((tintShadowsColor >> 8) & 255) / 255.0f, (tintShadowsColor & 255) / 255.0f);
            GLES20.glUniform1f(this.f30699k0, this.f30687f1.getTintShadowsIntensityValue());
            boolean c10 = this.f30687f1.c();
            int i11 = this.f30694i0;
            if (c10) {
                f7 = 0.0f;
            }
            GLES20.glUniform1f(i11, f7);
            if (c10) {
                ByteBuffer a2 = this.f30687f1.a();
                GLES20.glActiveTexture(33985);
                GLES20.glBindTexture(3553, this.V0[0]);
                GLES20.glTexImage2D(3553, 0, 6408, 200, 1, 0, 6408, 5121, a2);
                GLES20.glUniform1i(this.f30691h0, 1);
            }
        } else {
            GLES20.glUniform1f(this.X, 1.0f);
            GLES20.glUniform1f(this.Y, 1.0f);
            GLES20.glUniform1f(this.Z, 0.0f);
            GLES20.glUniform1f(this.f30673a0, 1.0f);
            GLES20.glUniform1f(this.f30676b0, 1.0f);
            GLES20.glUniform1f(this.f30679c0, 0.0f);
            GLES20.glUniform1f(this.f30681d0, 0.0f);
            GLES20.glUniform1f(this.f30683e0, 0.0f);
            GLES20.glUniform1f(this.f30697j0, 0.0f);
            GLES20.glUniform3f(this.f30704n0, 0.0f, 0.0f, 0.0f);
            GLES20.glUniform1f(this.f30701l0, 0.0f);
            GLES20.glUniform3f(this.m0, 0.0f, 0.0f, 0.0f);
            GLES20.glUniform1f(this.f30699k0, 0.0f);
            GLES20.glUniform1f(this.f30694i0, 1.0f);
        }
        GLES20.glUniform1f(this.f30686f0, this.X0);
        GLES20.glUniform1f(this.f30689g0, this.Y0);
        GLES20.glEnableVertexAttribArray(this.V);
        GLES20.glVertexAttribPointer(this.V, 2, 5126, false, 8, (Buffer) this.f30674a1);
        GLES20.glEnableVertexAttribArray(this.U);
        GLES20.glVertexAttribPointer(this.U, 2, 5126, false, 8, (Buffer) this.f30677b1);
        GLES20.glDrawArrays(5, 0, 4);
    }
    ...
    public final void d() {
        ...
        if (z10) {
            ...
            GLES20.glVertexAttribPointer(iArr4[c10], 2, 5126, false, 8, (Buffer) this.f30674a1);
            int[] iArr5 = this.I;
            GLES20.glEnableVertexAttribArray(iArr5[c10]);
            int i13 = iArr5[c10];
            if (z11) {
                floatBuffer = this.f30677b1;
            } else {
                floatBuffer = this.Z0;
            }
        ...
        if (!this.W0) {
            ...
            ByteBuffer byteBuffer = this.f30680c1;
            if (byteBuffer == null || i14 > byteBuffer.capacity()) {
                this.f30680c1 = ByteBuffer.allocateDirect(i14);
            }
            if (this.f30682d1 == null) {
                this.f30682d1 = ByteBuffer.allocateDirect(16384);
            }
            if (this.f30684e1 == null) {
                this.f30684e1 = ByteBuffer.allocateDirect(32896);
            }
            GLES20.glReadPixels(0, 0, this.X0, this.Y0, 6408, 5121, this.f30680c1);
            i10 = 33984;
            Utilities.calcCDT(this.f30680c1, this.X0, this.Y0, this.f30682d1, this.f30684e1);
            GLES20.glBindTexture(3553, iArr2[1]);
            GLES20.glTexImage2D(3553, 0, 6408, 256, 16, 0, 6408, 5121, this.f30682d1);
            if (!z11) {
                this.f30680c1 = null;
                this.f30682d1 = null;
                this.f30684e1 = null;
        ...
        yz yzVar = this.f30687f1;
        if (yzVar != null && !yzVar.b()) {
            GLES20.glUniform1f(this.R, this.f30687f1.getEnhanceValue());
        } else {
            GLES20.glUniform1f(this.R, 0.0f);
        }
        GLES20.glEnableVertexAttribArray(this.P);
        GLES20.glVertexAttribPointer(this.P, 2, 5126, false, 8, (Buffer) this.f30674a1);
    ...
    public final void e() {
        ...
        yz yzVar = this.f30687f1;
        if (yzVar != null && !yzVar.b()) {
            GLES20.glUniform1f(this.I0, this.f30687f1.getSharpenValue());
        } else {
        ...
        GLES20.glVertexAttribPointer(this.M0, 2, 5126, false, 8, (Buffer) this.f30674a1);
        GLES20.glEnableVertexAttribArray(this.L0);
        GLES20.glVertexAttribPointer(this.L0, 2, 5126, false, 8, (Buffer) this.f30677b1);
        GLES20.glDrawArrays(5, 0, 4);
    }
    ...
    public final void f() {
        ...
        int i11;
        yz yzVar = this.f30687f1;
        if (yzVar != null && !yzVar.b() && this.f30687f1.getSoftenSkinValue() > 0.0f && (i10 = this.X0) > 0 && this.Y0 > 0) {
            boolean z10 = this.f30675b;
            int[] iArr = this.T0;
            boolean z11 = this.f30690g1;
            int[] iArr2 = this.S0;
            if (z10 || z11) {
                float f7 = i10 * 0.006f;
                if (this.e == null || Math.abs(this.f30685f - f7) > 1.0E-4d) {
                    xz xzVar = this.e;
                    if (xzVar != null && (i11 = xzVar.f30093c) != 0) {
                ...
                GLES20.glUseProgram(this.f30693i);
                GLES20.glUniform1i(this.f30700l, 0);
                GLES20.glEnableVertexAttribArray(this.f30698k);
                GLES20.glVertexAttribPointer(this.f30698k, 2, 5126, false, 8, (Buffer) this.f30674a1);
                GLES20.glEnableVertexAttribArray(this.f30696j);
                if (z11) {
                    GLES20.glUniformMatrix4fv(this.f30702m, 1, false, this.P0, 0);
                    int i12 = this.f30703n;
                    if (i12 != -1) {
                        GLES20.glUniform2f(i12, this.X0, this.Y0);
                    }
                }
                GLES20.glVertexAttribPointer(this.f30696j, 2, 5126, false, 8, (Buffer) this.f30677b1);
                GLES20.glBindFramebuffer(36160, this.U0[0]);
                GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr2[0], 0);
                GLES20.glActiveTexture(33984);
                if (z11) {
                ...
                GLES20.glDrawArrays(5, 0, 4);
                GLES20.glUseProgram(this.e.f30093c);
                GLES20.glUniform1i(this.e.f30094f, 0);
                GLES20.glEnableVertexAttribArray(this.e.e);
                GLES20.glVertexAttribPointer(this.e.e, 2, 5126, false, 8, (Buffer) this.f30674a1);
                GLES20.glEnableVertexAttribArray(this.e.d);
                GLES20.glVertexAttribPointer(this.e.d, 2, 5126, false, 8, (Buffer) this.f30677b1);
                GLES20.glBindFramebuffer(36160, this.U0[1]);
                GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr2[1], 0);
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, iArr2[0]);
                GLES20.glUniform1f(this.e.f30095g, 0.0f);
                ...
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, iArr2[1]);
                GLES20.glUniform1f(this.e.f30095g, 1.0f / this.X0);
                GLES20.glUniform1f(this.e.h, 0.0f);
                GLES20.glDrawArrays(5, 0, 4);
                GLES20.glUseProgram(this.f30707p);
                GLES20.glUniform1i(this.f30713s, 0);
                GLES20.glUniform1i(this.f30715t, 1);
                GLES20.glEnableVertexAttribArray(this.f30711r);
                GLES20.glVertexAttribPointer(this.f30711r, 2, 5126, false, 8, (Buffer) this.f30674a1);
                GLES20.glEnableVertexAttribArray(this.f30709q);
                GLES20.glVertexAttribPointer(this.f30709q, 2, 5126, false, 8, (Buffer) this.f30677b1);
                GLES20.glBindFramebuffer(36160, this.U0[1]);
                GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr2[1], 0);
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, iArr2[0]);
                ...
                GLES20.glVertexAttribPointer(this.F, 2, 5126, false, 8, (Buffer) this.f30674a1);
                GLES20.glEnableVertexAttribArray(this.E);
                GLES20.glVertexAttribPointer(this.E, 2, 5126, false, 8, (Buffer) this.f30677b1);
                GLES20.glBindFramebuffer(36160, this.U0[3]);
                GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr2[3], 0);
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, iArr2[1]);
            ...
            this.h = true;
            this.W0 = false;
            GLES20.glUseProgram(this.f30717u);
            GLES20.glUniform1i(this.f30722x, 0);
            GLES20.glUniform1i(this.f30724y, 1);
            GLES20.glUniform1i(this.f30726z, 2);
            GLES20.glUniform1f(this.A, this.f30687f1.getSoftenSkinValue());
            GLES20.glEnableVertexAttribArray(this.f30720w);
            GLES20.glVertexAttribPointer(this.f30720w, 2, 5126, false, 8, (Buffer) this.f30674a1);
            GLES20.glEnableVertexAttribArray(this.v);
            GLES20.glVertexAttribPointer(this.v, 2, 5126, false, 8, (Buffer) this.f30677b1);
            if (z11) {
            ...
            GLES20.glBindTexture(3553, ((int[]) this.f30705o.f13236b)[0]);
            GLES20.glDrawArrays(5, 0, 4);
        } else if (this.h) {
            this.W0 = false;
            this.h = false;
        ...
        while (true) {
            ...
            if (i14 < i11) {
                ...
                if (z12) {
                    ...
                    GLES20.glDeleteProgram(this.f30693i);
                    if (i12 == 0 && i13 != 0) {
                        int glCreateProgram2 = GLES20.glCreateProgram();
                        this.f30693i = glCreateProgram2;
                        GLES20.glAttachShader(glCreateProgram2, i12);
                        GLES20.glAttachShader(this.f30693i, i13);
                        GLES20.glBindAttribLocation(this.f30693i, 0, "position");
                        GLES20.glBindAttribLocation(this.f30693i, 1, "inputTexCoord");
                        GLES20.glLinkProgram(this.f30693i);
                        GLES20.glGetProgramiv(this.f30693i, 35714, iArr, 0);
                        if (iArr[0] == 0) {
                            GLES20.glDeleteProgram(this.f30693i);
                            this.f30693i = 0;
                        } else {
                            this.f30696j = GLES20.glGetAttribLocation(this.f30693i, "position");
                            this.f30698k = GLES20.glGetAttribLocation(this.f30693i, "inputTexCoord");
                            this.f30700l = GLES20.glGetUniformLocation(this.f30693i, "sTexture");
                            if (z12) {
                                this.f30702m = GLES20.glGetUniformLocation(this.f30693i, "videoMatrix");
                                this.f30703n = GLES20.glGetUniformLocation(this.f30693i, "texSize");
                            }
                        }
                        if (z12) {
                            if (i15 != 0) {
                        ...
                        GLES20.glDeleteProgram(this.f30717u);
                        if (h11 == 0 || h12 == 0) {
                            return false;
                        }
                        int glCreateProgram3 = GLES20.glCreateProgram();
                        this.f30717u = glCreateProgram3;
                        GLES20.glAttachShader(glCreateProgram3, h11);
                        GLES20.glAttachShader(this.f30717u, h12);
                        GLES20.glBindAttribLocation(this.f30717u, 0, "position");
                        GLES20.glBindAttribLocation(this.f30717u, 1, "inputTexCoord");
                        GLES20.glLinkProgram(this.f30717u);
                        GLES20.glGetProgramiv(this.f30717u, 35714, iArr, 0);
                        if (iArr[0] == 0) {
                            GLES20.glDeleteProgram(this.f30717u);
                            this.f30717u = 0;
                            return true;
                        }
                        this.v = GLES20.glGetAttribLocation(this.f30717u, "position");
                        this.f30720w = GLES20.glGetAttribLocation(this.f30717u, "inputTexCoord");
                        this.f30722x = GLES20.glGetUniformLocation(this.f30717u, "sTexture");
                        this.f30724y = GLES20.glGetUniformLocation(this.f30717u, "inputImageTexture3");
                        this.f30726z = GLES20.glGetUniformLocation(this.f30717u, "toneCurveTexture");
                        this.A = GLES20.glGetUniformLocation(this.f30717u, "mixturePercent");
                        if (z12) {
                            this.B = GLES20.glGetUniformLocation(this.f30717u, "videoMatrix");
                            this.C = GLES20.glGetUniformLocation(this.f30717u, "texSize");
                            return true;
                        }
                        return true;
                    }
