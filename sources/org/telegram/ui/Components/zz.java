...
public final class zz {
    ...
    public int f30691a0;
    public final FloatBuffer f30692a1;
    public int f30694b0;
    public final FloatBuffer f30695b1;
    public boolean f30696c;
    public int f30697c0;
    public ByteBuffer f30698c1;
    public boolean d;
    public int f30699d0;
    public ByteBuffer f30700d1;
    public xz e;
    public int f30701e0;
    public ByteBuffer f30702e1;
    public float f30703f;
    public int f30704f0;
    public yz f30705f1;
    public xz f30706g;
    public int f30707g0;
    public final boolean f30708g1;
    public boolean h;
    public int f30709h0;
    public ci.n8 f30710h1;
    public int f30711i;
    public int f30712i0;
    public int f30714j;
    public int f30715j0;
    ...
    public int f30744z;
    public int f30745z0;
    public boolean f30690a = true;
    public boolean f30693b = true;
    ...
    public final boolean a() {
        ...
        if (h != 0 && h10 != 0) {
            ...
            if (iArr3[0] == 0) {
                ...
                this.f30691a0 = GLES20.glGetUniformLocation(this.T, "contrast");
                this.f30694b0 = GLES20.glGetUniformLocation(this.T, "saturation");
                this.f30697c0 = GLES20.glGetUniformLocation(this.T, "warmth");
                this.f30699d0 = GLES20.glGetUniformLocation(this.T, "vignette");
                this.f30701e0 = GLES20.glGetUniformLocation(this.T, "grain");
                this.f30704f0 = GLES20.glGetUniformLocation(this.T, "width");
                this.f30707g0 = GLES20.glGetUniformLocation(this.T, "height");
                this.f30709h0 = GLES20.glGetUniformLocation(this.T, "curvesImage");
                this.f30712i0 = GLES20.glGetUniformLocation(this.T, "skipTone");
                this.f30715j0 = GLES20.glGetUniformLocation(this.T, "fadeAmount");
                this.f30717k0 = GLES20.glGetUniformLocation(this.T, "shadowsTintIntensity");
                this.f30719l0 = GLES20.glGetUniformLocation(this.T, "highlightsTintIntensity");
                this.m0 = GLES20.glGetUniformLocation(this.T, "shadowsTintColor");
                this.f30722n0 = GLES20.glGetUniformLocation(this.T, "highlightsTintColor");
            }
            ...
            if (h11 != 0 && h12 != 0) {
                ...
                if (xzVar.a() && j()) {
                    ...
                    if (h13 != 0 && h14 != 0) {
                        ...
                        this.f30724o0 = glCreateProgram3;
                        GLES20.glAttachShader(glCreateProgram3, h13);
                        GLES20.glAttachShader(this.f30724o0, h14);
                        GLES20.glBindAttribLocation(this.f30724o0, 0, "position");
                        GLES20.glBindAttribLocation(this.f30724o0, 1, "inputTexCoord");
                        GLES20.glLinkProgram(this.f30724o0);
                        GLES20.glGetProgramiv(this.f30724o0, 35714, iArr3, 0);
                        if (iArr3[0] == 0) {
                            GLES20.glDeleteProgram(this.f30724o0);
                            this.f30724o0 = 0;
                        } else {
                            this.f30726p0 = GLES20.glGetAttribLocation(this.f30724o0, "position");
                            this.f30728q0 = GLES20.glGetAttribLocation(this.f30724o0, "inputTexCoord");
                            this.f30730r0 = GLES20.glGetUniformLocation(this.f30724o0, "sTexture");
                            this.f30732s0 = GLES20.glGetUniformLocation(this.f30724o0, "inputImageTexture2");
                            this.f30734t0 = GLES20.glGetUniformLocation(this.f30724o0, "excludeSize");
                            this.f30736u0 = GLES20.glGetUniformLocation(this.f30724o0, "excludePoint");
                            this.f30737v0 = GLES20.glGetUniformLocation(this.f30724o0, "excludeBlurSize");
                            this.f30739w0 = GLES20.glGetUniformLocation(this.f30724o0, "angle");
                            this.f30741x0 = GLES20.glGetUniformLocation(this.f30724o0, "aspectRatio");
                        }
                        ...
                        if (h15 != 0 && h16 != 0) {
                            ...
                            this.f30743y0 = glCreateProgram4;
                            GLES20.glAttachShader(glCreateProgram4, h15);
                            GLES20.glAttachShader(this.f30743y0, h16);
                            GLES20.glBindAttribLocation(this.f30743y0, 0, "position");
                            GLES20.glBindAttribLocation(this.f30743y0, 1, "inputTexCoord");
                            GLES20.glLinkProgram(this.f30743y0);
                            GLES20.glGetProgramiv(this.f30743y0, 35714, iArr3, 0);
                            if (iArr3[0] == 0) {
                                GLES20.glDeleteProgram(this.f30743y0);
                                this.f30743y0 = 0;
                            } else {
                                this.f30745z0 = GLES20.glGetAttribLocation(this.f30743y0, "position");
                                this.A0 = GLES20.glGetAttribLocation(this.f30743y0, "inputTexCoord");
                                this.B0 = GLES20.glGetUniformLocation(this.f30743y0, "sTexture");
                                this.C0 = GLES20.glGetUniformLocation(this.f30743y0, "inputImageTexture2");
                                this.D0 = GLES20.glGetUniformLocation(this.f30743y0, "excludeSize");
                                this.E0 = GLES20.glGetUniformLocation(this.f30743y0, "excludePoint");
                                this.F0 = GLES20.glGetUniformLocation(this.f30743y0, "excludeBlurSize");
                                this.G0 = GLES20.glGetUniformLocation(this.f30743y0, "aspectRatio");
                            }
                            ...
                            if (h17 != 0 && h18 != 0) {
                                ...
                                if (h20 != 0 && h19 != 0) {
                                    ...
                                    this.f30725p = glCreateProgram6;
                                    GLES20.glAttachShader(glCreateProgram6, h20);
                                    GLES20.glAttachShader(this.f30725p, h19);
                                    GLES20.glBindAttribLocation(this.f30725p, 0, "position");
                                    GLES20.glBindAttribLocation(this.f30725p, 1, "inputTexCoord");
                                    GLES20.glLinkProgram(this.f30725p);
                                    GLES20.glGetProgramiv(this.f30725p, 35714, iArr3, 0);
                                    if (iArr3[0] == 0) {
                                        GLES20.glDeleteProgram(this.f30725p);
                                        this.f30725p = 0;
                                    } else {
                                        this.f30727q = GLES20.glGetAttribLocation(this.f30725p, "position");
                                        this.f30729r = GLES20.glGetAttribLocation(this.f30725p, "inputTexCoord");
                                        this.f30731s = GLES20.glGetUniformLocation(this.f30725p, "sTexture");
                                        this.f30733t = GLES20.glGetUniformLocation(this.f30725p, "inputImageTexture2");
                                    }
    ...
    public final boolean b() {
        int i10;
        yz yzVar;
        yz yzVar2 = this.f30705f1;
        if (yzVar2 != null) {
            i10 = yzVar2.getBlurType();
        } else {
            i10 = 0;
        }
        if (this.f30708g1 || (yzVar = this.f30705f1) == null || yzVar.b() || i10 == 0) {
            return false;
        }
        boolean z10 = this.f30690a;
        int[] iArr = this.S0;
        if (z10) {
            if (!this.f30696c) {
            ...
            GLES20.glUseProgram(this.f30706g.f30037c);
            GLES20.glUniform1i(this.f30706g.f30038f, 0);
            GLES20.glEnableVertexAttribArray(this.f30706g.e);
            GLES20.glVertexAttribPointer(this.f30706g.e, 2, 5126, false, 8, (Buffer) this.f30692a1);
            GLES20.glEnableVertexAttribArray(this.f30706g.d);
            GLES20.glVertexAttribPointer(this.f30706g.d, 2, 5126, false, 8, (Buffer) this.f30695b1);
            GLES20.glBindFramebuffer(36160, this.U0[0]);
            GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr[0], 0);
            GLES20.glActiveTexture(33984);
            GLES20.glBindTexture(3553, iArr[1]);
            GLES20.glUniform1f(this.f30706g.f30039g, 0.0f);
            GLES20.glUniform1f(this.f30706g.h, 1.0f / this.Y0);
            GLES20.glDrawArrays(5, 0, 4);
            GLES20.glBindFramebuffer(36160, this.U0[2]);
            GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr[2], 0);
            GLES20.glActiveTexture(33984);
            GLES20.glBindTexture(3553, iArr[0]);
            GLES20.glUniform1f(this.f30706g.f30039g, 1.0f / this.X0);
            GLES20.glUniform1f(this.f30706g.h, 0.0f);
            GLES20.glDrawArrays(5, 0, 4);
            this.f30690a = false;
        }
        GLES20.glBindFramebuffer(36160, this.U0[0]);
        GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr[0], 0);
        if (i10 == 1) {
            GLES20.glUseProgram(this.f30743y0);
            GLES20.glUniform1i(this.B0, 0);
            GLES20.glUniform1i(this.C0, 1);
            GLES20.glUniform1f(this.D0, this.f30705f1.getBlurExcludeSize());
            GLES20.glUniform1f(this.F0, this.f30705f1.getBlurExcludeBlurSize());
            PointF blurExcludePoint = this.f30705f1.getBlurExcludePoint();
            ...
            GLES20.glVertexAttribPointer(this.A0, 2, 5126, false, 8, (Buffer) this.f30692a1);
            GLES20.glEnableVertexAttribArray(this.f30745z0);
            GLES20.glVertexAttribPointer(this.f30745z0, 2, 5126, false, 8, (Buffer) this.f30695b1);
        } else if (i10 == 2) {
            GLES20.glUseProgram(this.f30724o0);
            GLES20.glUniform1i(this.f30730r0, 0);
            GLES20.glUniform1i(this.f30732s0, 1);
            GLES20.glUniform1f(this.f30734t0, this.f30705f1.getBlurExcludeSize());
            GLES20.glUniform1f(this.f30737v0, this.f30705f1.getBlurExcludeBlurSize());
            GLES20.glUniform1f(this.f30739w0, this.f30705f1.getBlurAngle());
            PointF blurExcludePoint2 = this.f30705f1.getBlurExcludePoint();
            GLES20.glUniform2f(this.f30736u0, blurExcludePoint2.x, blurExcludePoint2.y);
            GLES20.glUniform1f(this.f30741x0, this.Y0 / this.X0);
            GLES20.glEnableVertexAttribArray(this.f30728q0);
            GLES20.glVertexAttribPointer(this.f30728q0, 2, 5126, false, 8, (Buffer) this.f30692a1);
            GLES20.glEnableVertexAttribArray(this.f30726p0);
            GLES20.glVertexAttribPointer(this.f30726p0, 2, 5126, false, 8, (Buffer) this.f30695b1);
        }
        GLES20.glActiveTexture(33984);
        GLES20.glBindTexture(3553, iArr[1]);
    ...
    public final void c() {
        ...
        yz yzVar = this.f30705f1;
        float f7 = 1.0f;
        if (yzVar != null && !yzVar.b()) {
            GLES20.glUniform1f(this.X, this.f30705f1.getShadowsValue());
            GLES20.glUniform1f(this.Y, this.f30705f1.getHighlightsValue());
            GLES20.glUniform1f(this.Z, this.f30705f1.getExposureValue());
            GLES20.glUniform1f(this.f30691a0, this.f30705f1.getContrastValue());
            GLES20.glUniform1f(this.f30694b0, this.f30705f1.getSaturationValue());
            GLES20.glUniform1f(this.f30697c0, this.f30705f1.getWarmthValue());
            GLES20.glUniform1f(this.f30699d0, this.f30705f1.getVignetteValue());
            GLES20.glUniform1f(this.f30701e0, this.f30705f1.getGrainValue());
            GLES20.glUniform1f(this.f30715j0, this.f30705f1.getFadeValue());
            int tintHighlightsColor = this.f30705f1.getTintHighlightsColor();
            int tintShadowsColor = this.f30705f1.getTintShadowsColor();
            GLES20.glUniform3f(this.f30722n0, ((tintHighlightsColor >> 16) & 255) / 255.0f, ((tintHighlightsColor >> 8) & 255) / 255.0f, (tintHighlightsColor & 255) / 255.0f);
            GLES20.glUniform1f(this.f30719l0, this.f30705f1.getTintHighlightsIntensityValue());
            GLES20.glUniform3f(this.m0, ((tintShadowsColor >> 16) & 255) / 255.0f, ((tintShadowsColor >> 8) & 255) / 255.0f, (tintShadowsColor & 255) / 255.0f);
            GLES20.glUniform1f(this.f30717k0, this.f30705f1.getTintShadowsIntensityValue());
            boolean c10 = this.f30705f1.c();
            int i11 = this.f30712i0;
            if (c10) {
                f7 = 0.0f;
            }
            GLES20.glUniform1f(i11, f7);
            if (c10) {
                ByteBuffer a2 = this.f30705f1.a();
                GLES20.glActiveTexture(33985);
                GLES20.glBindTexture(3553, this.V0[0]);
                GLES20.glTexImage2D(3553, 0, 6408, 200, 1, 0, 6408, 5121, a2);
                GLES20.glUniform1i(this.f30709h0, 1);
            }
        } else {
            GLES20.glUniform1f(this.X, 1.0f);
            GLES20.glUniform1f(this.Y, 1.0f);
            GLES20.glUniform1f(this.Z, 0.0f);
            GLES20.glUniform1f(this.f30691a0, 1.0f);
            GLES20.glUniform1f(this.f30694b0, 1.0f);
            GLES20.glUniform1f(this.f30697c0, 0.0f);
            GLES20.glUniform1f(this.f30699d0, 0.0f);
            GLES20.glUniform1f(this.f30701e0, 0.0f);
            GLES20.glUniform1f(this.f30715j0, 0.0f);
            GLES20.glUniform3f(this.f30722n0, 0.0f, 0.0f, 0.0f);
            GLES20.glUniform1f(this.f30719l0, 0.0f);
            GLES20.glUniform3f(this.m0, 0.0f, 0.0f, 0.0f);
            GLES20.glUniform1f(this.f30717k0, 0.0f);
            GLES20.glUniform1f(this.f30712i0, 1.0f);
        }
        GLES20.glUniform1f(this.f30704f0, this.X0);
        GLES20.glUniform1f(this.f30707g0, this.Y0);
        GLES20.glEnableVertexAttribArray(this.V);
        GLES20.glVertexAttribPointer(this.V, 2, 5126, false, 8, (Buffer) this.f30692a1);
        GLES20.glEnableVertexAttribArray(this.U);
        GLES20.glVertexAttribPointer(this.U, 2, 5126, false, 8, (Buffer) this.f30695b1);
        GLES20.glDrawArrays(5, 0, 4);
    }
    ...
    public final void d() {
        ...
        if (z10) {
            ...
            GLES20.glVertexAttribPointer(iArr4[c10], 2, 5126, false, 8, (Buffer) this.f30692a1);
            int[] iArr5 = this.I;
            GLES20.glEnableVertexAttribArray(iArr5[c10]);
            int i13 = iArr5[c10];
            if (z11) {
                floatBuffer = this.f30695b1;
            } else {
                floatBuffer = this.Z0;
            }
        ...
        if (!this.W0) {
            ...
            ByteBuffer byteBuffer = this.f30698c1;
            if (byteBuffer == null || i14 > byteBuffer.capacity()) {
                this.f30698c1 = ByteBuffer.allocateDirect(i14);
            }
            if (this.f30700d1 == null) {
                this.f30700d1 = ByteBuffer.allocateDirect(16384);
            }
            if (this.f30702e1 == null) {
                this.f30702e1 = ByteBuffer.allocateDirect(32896);
            }
            GLES20.glReadPixels(0, 0, this.X0, this.Y0, 6408, 5121, this.f30698c1);
            i10 = 33984;
            Utilities.calcCDT(this.f30698c1, this.X0, this.Y0, this.f30700d1, this.f30702e1);
            GLES20.glBindTexture(3553, iArr2[1]);
            GLES20.glTexImage2D(3553, 0, 6408, 256, 16, 0, 6408, 5121, this.f30700d1);
            if (!z11) {
                this.f30698c1 = null;
                this.f30700d1 = null;
                this.f30702e1 = null;
        ...
        yz yzVar = this.f30705f1;
        if (yzVar != null && !yzVar.b()) {
            GLES20.glUniform1f(this.R, this.f30705f1.getEnhanceValue());
        } else {
            GLES20.glUniform1f(this.R, 0.0f);
        }
        GLES20.glEnableVertexAttribArray(this.P);
        GLES20.glVertexAttribPointer(this.P, 2, 5126, false, 8, (Buffer) this.f30692a1);
    ...
    public final void e() {
        ...
        yz yzVar = this.f30705f1;
        if (yzVar != null && !yzVar.b()) {
            GLES20.glUniform1f(this.I0, this.f30705f1.getSharpenValue());
        } else {
        ...
        GLES20.glVertexAttribPointer(this.M0, 2, 5126, false, 8, (Buffer) this.f30692a1);
        GLES20.glEnableVertexAttribArray(this.L0);
        GLES20.glVertexAttribPointer(this.L0, 2, 5126, false, 8, (Buffer) this.f30695b1);
        GLES20.glDrawArrays(5, 0, 4);
    }
    ...
    public final void f() {
        ...
        int i11;
        yz yzVar = this.f30705f1;
        if (yzVar != null && !yzVar.b() && this.f30705f1.getSoftenSkinValue() > 0.0f && (i10 = this.X0) > 0 && this.Y0 > 0) {
            ...
            if (z10 || z11) {
                float f7 = i10 * 0.006f;
                if (this.e == null || Math.abs(this.f30703f - f7) > 1.0E-4d) {
                    xz xzVar = this.e;
                    if (xzVar != null && (i11 = xzVar.f30037c) != 0) {
                ...
                GLES20.glUseProgram(this.f30711i);
                GLES20.glUniform1i(this.f30718l, 0);
                GLES20.glEnableVertexAttribArray(this.f30716k);
                GLES20.glVertexAttribPointer(this.f30716k, 2, 5126, false, 8, (Buffer) this.f30692a1);
                GLES20.glEnableVertexAttribArray(this.f30714j);
                if (z11) {
                    GLES20.glUniformMatrix4fv(this.f30720m, 1, false, this.P0, 0);
                    int i12 = this.f30721n;
                    if (i12 != -1) {
                        GLES20.glUniform2f(i12, this.X0, this.Y0);
                    }
                }
                GLES20.glVertexAttribPointer(this.f30714j, 2, 5126, false, 8, (Buffer) this.f30695b1);
                GLES20.glBindFramebuffer(36160, this.U0[0]);
                GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr2[0], 0);
                GLES20.glActiveTexture(33984);
                if (z11) {
                ...
                GLES20.glDrawArrays(5, 0, 4);
                GLES20.glUseProgram(this.e.f30037c);
                GLES20.glUniform1i(this.e.f30038f, 0);
                GLES20.glEnableVertexAttribArray(this.e.e);
                GLES20.glVertexAttribPointer(this.e.e, 2, 5126, false, 8, (Buffer) this.f30692a1);
                GLES20.glEnableVertexAttribArray(this.e.d);
                GLES20.glVertexAttribPointer(this.e.d, 2, 5126, false, 8, (Buffer) this.f30695b1);
                GLES20.glBindFramebuffer(36160, this.U0[1]);
                GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr2[1], 0);
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, iArr2[0]);
                GLES20.glUniform1f(this.e.f30039g, 0.0f);
                ...
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, iArr2[1]);
                GLES20.glUniform1f(this.e.f30039g, 1.0f / this.X0);
                GLES20.glUniform1f(this.e.h, 0.0f);
                GLES20.glDrawArrays(5, 0, 4);
                GLES20.glUseProgram(this.f30725p);
                GLES20.glUniform1i(this.f30731s, 0);
                GLES20.glUniform1i(this.f30733t, 1);
                GLES20.glEnableVertexAttribArray(this.f30729r);
                GLES20.glVertexAttribPointer(this.f30729r, 2, 5126, false, 8, (Buffer) this.f30692a1);
                GLES20.glEnableVertexAttribArray(this.f30727q);
                GLES20.glVertexAttribPointer(this.f30727q, 2, 5126, false, 8, (Buffer) this.f30695b1);
                GLES20.glBindFramebuffer(36160, this.U0[1]);
                GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr2[1], 0);
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, iArr2[0]);
                ...
                GLES20.glVertexAttribPointer(this.F, 2, 5126, false, 8, (Buffer) this.f30692a1);
                GLES20.glEnableVertexAttribArray(this.E);
                GLES20.glVertexAttribPointer(this.E, 2, 5126, false, 8, (Buffer) this.f30695b1);
                GLES20.glBindFramebuffer(36160, this.U0[3]);
                GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr2[3], 0);
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, iArr2[1]);
            ...
            this.h = true;
            this.W0 = false;
            GLES20.glUseProgram(this.f30735u);
            GLES20.glUniform1i(this.f30740x, 0);
            GLES20.glUniform1i(this.f30742y, 1);
            GLES20.glUniform1i(this.f30744z, 2);
            GLES20.glUniform1f(this.A, this.f30705f1.getSoftenSkinValue());
            GLES20.glEnableVertexAttribArray(this.f30738w);
            GLES20.glVertexAttribPointer(this.f30738w, 2, 5126, false, 8, (Buffer) this.f30692a1);
            GLES20.glEnableVertexAttribArray(this.v);
            GLES20.glVertexAttribPointer(this.v, 2, 5126, false, 8, (Buffer) this.f30695b1);
            if (z11) {
            ...
            GLES20.glBindTexture(3553, ((int[]) this.f30723o.f13237b)[0]);
            GLES20.glDrawArrays(5, 0, 4);
        } else if (this.h) {
            this.W0 = false;
            this.h = false;
        ...
        while (true) {
            ...
            if (i14 < i11) {
                ...
                if (z12) {
                    ...
                    GLES20.glDeleteProgram(this.f30711i);
                    if (i12 == 0 && i13 != 0) {
                        int glCreateProgram2 = GLES20.glCreateProgram();
                        this.f30711i = glCreateProgram2;
                        GLES20.glAttachShader(glCreateProgram2, i12);
                        GLES20.glAttachShader(this.f30711i, i13);
                        GLES20.glBindAttribLocation(this.f30711i, 0, "position");
                        GLES20.glBindAttribLocation(this.f30711i, 1, "inputTexCoord");
                        GLES20.glLinkProgram(this.f30711i);
                        GLES20.glGetProgramiv(this.f30711i, 35714, iArr, 0);
                        if (iArr[0] == 0) {
                            GLES20.glDeleteProgram(this.f30711i);
                            this.f30711i = 0;
                        } else {
                            this.f30714j = GLES20.glGetAttribLocation(this.f30711i, "position");
                            this.f30716k = GLES20.glGetAttribLocation(this.f30711i, "inputTexCoord");
                            this.f30718l = GLES20.glGetUniformLocation(this.f30711i, "sTexture");
                            if (z12) {
                                this.f30720m = GLES20.glGetUniformLocation(this.f30711i, "videoMatrix");
                                this.f30721n = GLES20.glGetUniformLocation(this.f30711i, "texSize");
                            }
                        }
                        if (z12) {
                            if (i15 != 0) {
                        ...
                        GLES20.glDeleteProgram(this.f30735u);
                        if (h11 == 0 || h12 == 0) {
                            return false;
                        }
                        int glCreateProgram3 = GLES20.glCreateProgram();
                        this.f30735u = glCreateProgram3;
                        GLES20.glAttachShader(glCreateProgram3, h11);
                        GLES20.glAttachShader(this.f30735u, h12);
                        GLES20.glBindAttribLocation(this.f30735u, 0, "position");
                        GLES20.glBindAttribLocation(this.f30735u, 1, "inputTexCoord");
                        GLES20.glLinkProgram(this.f30735u);
                        GLES20.glGetProgramiv(this.f30735u, 35714, iArr, 0);
                        if (iArr[0] == 0) {
                            GLES20.glDeleteProgram(this.f30735u);
                            this.f30735u = 0;
                            return true;
                        }
                        this.v = GLES20.glGetAttribLocation(this.f30735u, "position");
                        this.f30738w = GLES20.glGetAttribLocation(this.f30735u, "inputTexCoord");
                        this.f30740x = GLES20.glGetUniformLocation(this.f30735u, "sTexture");
                        this.f30742y = GLES20.glGetUniformLocation(this.f30735u, "inputImageTexture3");
                        this.f30744z = GLES20.glGetUniformLocation(this.f30735u, "toneCurveTexture");
                        this.A = GLES20.glGetUniformLocation(this.f30735u, "mixturePercent");
                        if (z12) {
                            this.B = GLES20.glGetUniformLocation(this.f30735u, "videoMatrix");
                            this.C = GLES20.glGetUniformLocation(this.f30735u, "texSize");
                            return true;
                        }
                        return true;
                    }
