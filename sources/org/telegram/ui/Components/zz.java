...
public final class zz {
    ...
    public int f31480a0;
    public final FloatBuffer f31481a1;
    public int f31483b0;
    public final FloatBuffer f31484b1;
    public boolean f31485c;
    public int f31486c0;
    public ByteBuffer f31487c1;
    public boolean d;
    public int f31488d0;
    public ByteBuffer f31489d1;
    public xz e;
    public int f31490e0;
    public ByteBuffer f31491e1;
    public float f31492f;
    public int f31493f0;
    public yz f31494f1;
    public xz f31495g;
    public int f31496g0;
    public final boolean f31497g1;
    public boolean h;
    public int f31498h0;
    public ph.t6 f31499h1;
    public int f31500i;
    public int f31501i0;
    public int f31503j;
    public int f31504j0;
    ...
    public int f31510n;
    public int f31511n0;
    public org.telegram.ui.Cells.f1 f31512o;
    public int f31513o0;
    public int f31514p;
    public int f31515p0;
    public int f31516q;
    ...
    public final boolean a() {
        ...
        if (h != 0 && h9 != 0) {
            ...
            if (iArr3[0] == 0) {
                ...
                this.f31480a0 = GLES20.glGetUniformLocation(this.T, "contrast");
                this.f31483b0 = GLES20.glGetUniformLocation(this.T, "saturation");
                this.f31486c0 = GLES20.glGetUniformLocation(this.T, "warmth");
                this.f31488d0 = GLES20.glGetUniformLocation(this.T, "vignette");
                this.f31490e0 = GLES20.glGetUniformLocation(this.T, "grain");
                this.f31493f0 = GLES20.glGetUniformLocation(this.T, "width");
                this.f31496g0 = GLES20.glGetUniformLocation(this.T, "height");
                this.f31498h0 = GLES20.glGetUniformLocation(this.T, "curvesImage");
                this.f31501i0 = GLES20.glGetUniformLocation(this.T, "skipTone");
                this.f31504j0 = GLES20.glGetUniformLocation(this.T, "fadeAmount");
                this.f31506k0 = GLES20.glGetUniformLocation(this.T, "shadowsTintIntensity");
                this.f31508l0 = GLES20.glGetUniformLocation(this.T, "highlightsTintIntensity");
                this.m0 = GLES20.glGetUniformLocation(this.T, "shadowsTintColor");
                this.f31511n0 = GLES20.glGetUniformLocation(this.T, "highlightsTintColor");
            }
            ...
            if (h10 != 0 && h11 != 0) {
                ...
                if (xzVar.a() && j()) {
                    ...
                    if (h12 != 0 && h13 != 0) {
                        ...
                        this.f31513o0 = glCreateProgram3;
                        GLES20.glAttachShader(glCreateProgram3, h12);
                        GLES20.glAttachShader(this.f31513o0, h13);
                        GLES20.glBindAttribLocation(this.f31513o0, 0, "position");
                        GLES20.glBindAttribLocation(this.f31513o0, 1, "inputTexCoord");
                        GLES20.glLinkProgram(this.f31513o0);
                        GLES20.glGetProgramiv(this.f31513o0, 35714, iArr3, 0);
                        if (iArr3[0] == 0) {
                            GLES20.glDeleteProgram(this.f31513o0);
                            this.f31513o0 = 0;
                        } else {
                            this.f31515p0 = GLES20.glGetAttribLocation(this.f31513o0, "position");
                            this.f31517q0 = GLES20.glGetAttribLocation(this.f31513o0, "inputTexCoord");
                            this.f31519r0 = GLES20.glGetUniformLocation(this.f31513o0, "sTexture");
                            this.f31521s0 = GLES20.glGetUniformLocation(this.f31513o0, "inputImageTexture2");
                            this.f31523t0 = GLES20.glGetUniformLocation(this.f31513o0, "excludeSize");
                            this.f31525u0 = GLES20.glGetUniformLocation(this.f31513o0, "excludePoint");
                            this.f31526v0 = GLES20.glGetUniformLocation(this.f31513o0, "excludeBlurSize");
                            this.f31528w0 = GLES20.glGetUniformLocation(this.f31513o0, "angle");
                            this.f31530x0 = GLES20.glGetUniformLocation(this.f31513o0, "aspectRatio");
                        }
                        ...
                        if (h14 != 0 && h15 != 0) {
                            ...
                            this.f31532y0 = glCreateProgram4;
                            GLES20.glAttachShader(glCreateProgram4, h14);
                            GLES20.glAttachShader(this.f31532y0, h15);
                            GLES20.glBindAttribLocation(this.f31532y0, 0, "position");
                            GLES20.glBindAttribLocation(this.f31532y0, 1, "inputTexCoord");
                            GLES20.glLinkProgram(this.f31532y0);
                            GLES20.glGetProgramiv(this.f31532y0, 35714, iArr3, 0);
                            if (iArr3[0] == 0) {
                                GLES20.glDeleteProgram(this.f31532y0);
                                this.f31532y0 = 0;
                            } else {
                                this.f31534z0 = GLES20.glGetAttribLocation(this.f31532y0, "position");
                                this.A0 = GLES20.glGetAttribLocation(this.f31532y0, "inputTexCoord");
                                this.B0 = GLES20.glGetUniformLocation(this.f31532y0, "sTexture");
                                this.C0 = GLES20.glGetUniformLocation(this.f31532y0, "inputImageTexture2");
                                this.D0 = GLES20.glGetUniformLocation(this.f31532y0, "excludeSize");
                                this.E0 = GLES20.glGetUniformLocation(this.f31532y0, "excludePoint");
                                this.F0 = GLES20.glGetUniformLocation(this.f31532y0, "excludeBlurSize");
                                this.G0 = GLES20.glGetUniformLocation(this.f31532y0, "aspectRatio");
                            }
                            ...
                            if (h16 != 0 && h17 != 0) {
                                ...
                                if (h19 != 0 && h18 != 0) {
                                    ...
                                    this.f31514p = glCreateProgram6;
                                    GLES20.glAttachShader(glCreateProgram6, h19);
                                    GLES20.glAttachShader(this.f31514p, h18);
                                    GLES20.glBindAttribLocation(this.f31514p, 0, "position");
                                    GLES20.glBindAttribLocation(this.f31514p, 1, "inputTexCoord");
                                    GLES20.glLinkProgram(this.f31514p);
                                    GLES20.glGetProgramiv(this.f31514p, 35714, iArr3, 0);
                                    if (iArr3[0] == 0) {
                                        GLES20.glDeleteProgram(this.f31514p);
                                        this.f31514p = 0;
                                    } else {
                                        this.f31516q = GLES20.glGetAttribLocation(this.f31514p, "position");
                                        this.f31518r = GLES20.glGetAttribLocation(this.f31514p, "inputTexCoord");
                                        this.f31520s = GLES20.glGetUniformLocation(this.f31514p, "sTexture");
                                        this.f31522t = GLES20.glGetUniformLocation(this.f31514p, "inputImageTexture2");
                                    }
    ...
    public final boolean b() {
        int i10;
        yz yzVar;
        yz yzVar2 = this.f31494f1;
        if (yzVar2 != null) {
            i10 = yzVar2.getBlurType();
        } else {
            i10 = 0;
        }
        if (this.f31497g1 || (yzVar = this.f31494f1) == null || yzVar.b() || i10 == 0) {
            return false;
        }
        ...
        if (z4) {
            ...
            GLES20.glUseProgram(this.f31495g.f30796c);
            GLES20.glUniform1i(this.f31495g.f30797f, 0);
            GLES20.glEnableVertexAttribArray(this.f31495g.e);
            GLES20.glVertexAttribPointer(this.f31495g.e, 2, 5126, false, 8, (Buffer) this.f31481a1);
            GLES20.glEnableVertexAttribArray(this.f31495g.d);
            GLES20.glVertexAttribPointer(this.f31495g.d, 2, 5126, false, 8, (Buffer) this.f31484b1);
            GLES20.glBindFramebuffer(36160, this.U0[0]);
            GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr[0], 0);
            GLES20.glActiveTexture(33984);
            GLES20.glBindTexture(3553, iArr[1]);
            GLES20.glUniform1f(this.f31495g.f30798g, 0.0f);
            GLES20.glUniform1f(this.f31495g.h, 1.0f / this.Y0);
            GLES20.glDrawArrays(5, 0, 4);
            GLES20.glBindFramebuffer(36160, this.U0[2]);
            GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr[2], 0);
            GLES20.glActiveTexture(33984);
            GLES20.glBindTexture(3553, iArr[0]);
            GLES20.glUniform1f(this.f31495g.f30798g, 1.0f / this.X0);
            GLES20.glUniform1f(this.f31495g.h, 0.0f);
            GLES20.glDrawArrays(5, 0, 4);
            this.f31479a = false;
        }
        GLES20.glBindFramebuffer(36160, this.U0[0]);
        GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr[0], 0);
        if (i10 == 1) {
            GLES20.glUseProgram(this.f31532y0);
            GLES20.glUniform1i(this.B0, 0);
            GLES20.glUniform1i(this.C0, 1);
            GLES20.glUniform1f(this.D0, this.f31494f1.getBlurExcludeSize());
            GLES20.glUniform1f(this.F0, this.f31494f1.getBlurExcludeBlurSize());
            PointF blurExcludePoint = this.f31494f1.getBlurExcludePoint();
            ...
            GLES20.glVertexAttribPointer(this.A0, 2, 5126, false, 8, (Buffer) this.f31481a1);
            GLES20.glEnableVertexAttribArray(this.f31534z0);
            GLES20.glVertexAttribPointer(this.f31534z0, 2, 5126, false, 8, (Buffer) this.f31484b1);
        } else if (i10 == 2) {
            GLES20.glUseProgram(this.f31513o0);
            GLES20.glUniform1i(this.f31519r0, 0);
            GLES20.glUniform1i(this.f31521s0, 1);
            GLES20.glUniform1f(this.f31523t0, this.f31494f1.getBlurExcludeSize());
            GLES20.glUniform1f(this.f31526v0, this.f31494f1.getBlurExcludeBlurSize());
            GLES20.glUniform1f(this.f31528w0, this.f31494f1.getBlurAngle());
            PointF blurExcludePoint2 = this.f31494f1.getBlurExcludePoint();
            GLES20.glUniform2f(this.f31525u0, blurExcludePoint2.x, blurExcludePoint2.y);
            GLES20.glUniform1f(this.f31530x0, this.Y0 / this.X0);
            GLES20.glEnableVertexAttribArray(this.f31517q0);
            GLES20.glVertexAttribPointer(this.f31517q0, 2, 5126, false, 8, (Buffer) this.f31481a1);
            GLES20.glEnableVertexAttribArray(this.f31515p0);
            GLES20.glVertexAttribPointer(this.f31515p0, 2, 5126, false, 8, (Buffer) this.f31484b1);
        }
        GLES20.glActiveTexture(33984);
        GLES20.glBindTexture(3553, iArr[1]);
    ...
    public final void c() {
        ...
        yz yzVar = this.f31494f1;
        float f10 = 1.0f;
        if (yzVar != null && !yzVar.b()) {
            GLES20.glUniform1f(this.X, this.f31494f1.getShadowsValue());
            GLES20.glUniform1f(this.Y, this.f31494f1.getHighlightsValue());
            GLES20.glUniform1f(this.Z, this.f31494f1.getExposureValue());
            GLES20.glUniform1f(this.f31480a0, this.f31494f1.getContrastValue());
            GLES20.glUniform1f(this.f31483b0, this.f31494f1.getSaturationValue());
            GLES20.glUniform1f(this.f31486c0, this.f31494f1.getWarmthValue());
            GLES20.glUniform1f(this.f31488d0, this.f31494f1.getVignetteValue());
            GLES20.glUniform1f(this.f31490e0, this.f31494f1.getGrainValue());
            GLES20.glUniform1f(this.f31504j0, this.f31494f1.getFadeValue());
            int tintHighlightsColor = this.f31494f1.getTintHighlightsColor();
            int tintShadowsColor = this.f31494f1.getTintShadowsColor();
            GLES20.glUniform3f(this.f31511n0, ((tintHighlightsColor >> 16) & 255) / 255.0f, ((tintHighlightsColor >> 8) & 255) / 255.0f, (tintHighlightsColor & 255) / 255.0f);
            GLES20.glUniform1f(this.f31508l0, this.f31494f1.getTintHighlightsIntensityValue());
            GLES20.glUniform3f(this.m0, ((tintShadowsColor >> 16) & 255) / 255.0f, ((tintShadowsColor >> 8) & 255) / 255.0f, (tintShadowsColor & 255) / 255.0f);
            GLES20.glUniform1f(this.f31506k0, this.f31494f1.getTintShadowsIntensityValue());
            boolean c3 = this.f31494f1.c();
            int i11 = this.f31501i0;
            if (c3) {
                f10 = 0.0f;
            }
            GLES20.glUniform1f(i11, f10);
            if (c3) {
                ByteBuffer a2 = this.f31494f1.a();
                GLES20.glActiveTexture(33985);
                GLES20.glBindTexture(3553, this.V0[0]);
                GLES20.glTexImage2D(3553, 0, 6408, 200, 1, 0, 6408, 5121, a2);
                GLES20.glUniform1i(this.f31498h0, 1);
            }
        } else {
            GLES20.glUniform1f(this.X, 1.0f);
            GLES20.glUniform1f(this.Y, 1.0f);
            GLES20.glUniform1f(this.Z, 0.0f);
            GLES20.glUniform1f(this.f31480a0, 1.0f);
            GLES20.glUniform1f(this.f31483b0, 1.0f);
            GLES20.glUniform1f(this.f31486c0, 0.0f);
            GLES20.glUniform1f(this.f31488d0, 0.0f);
            GLES20.glUniform1f(this.f31490e0, 0.0f);
            GLES20.glUniform1f(this.f31504j0, 0.0f);
            GLES20.glUniform3f(this.f31511n0, 0.0f, 0.0f, 0.0f);
            GLES20.glUniform1f(this.f31508l0, 0.0f);
            GLES20.glUniform3f(this.m0, 0.0f, 0.0f, 0.0f);
            GLES20.glUniform1f(this.f31506k0, 0.0f);
            GLES20.glUniform1f(this.f31501i0, 1.0f);
        }
        GLES20.glUniform1f(this.f31493f0, this.X0);
        GLES20.glUniform1f(this.f31496g0, this.Y0);
        GLES20.glEnableVertexAttribArray(this.V);
        GLES20.glVertexAttribPointer(this.V, 2, 5126, false, 8, (Buffer) this.f31481a1);
        GLES20.glEnableVertexAttribArray(this.U);
        GLES20.glVertexAttribPointer(this.U, 2, 5126, false, 8, (Buffer) this.f31484b1);
        GLES20.glDrawArrays(5, 0, 4);
    }
    ...
    public final void d() {
        ...
        if (z4) {
            ...
            GLES20.glVertexAttribPointer(iArr4[c3], 2, 5126, false, 8, (Buffer) this.f31481a1);
            int[] iArr5 = this.I;
            GLES20.glEnableVertexAttribArray(iArr5[c3]);
            int i13 = iArr5[c3];
            if (z10) {
                floatBuffer = this.f31484b1;
            } else {
                floatBuffer = this.Z0;
            }
        ...
        if (!this.W0) {
            ...
            ByteBuffer byteBuffer = this.f31487c1;
            if (byteBuffer == null || i14 > byteBuffer.capacity()) {
                this.f31487c1 = ByteBuffer.allocateDirect(i14);
            }
            if (this.f31489d1 == null) {
                this.f31489d1 = ByteBuffer.allocateDirect(16384);
            }
            if (this.f31491e1 == null) {
                this.f31491e1 = ByteBuffer.allocateDirect(32896);
            }
            GLES20.glReadPixels(0, 0, this.X0, this.Y0, 6408, 5121, this.f31487c1);
            i10 = 33984;
            Utilities.calcCDT(this.f31487c1, this.X0, this.Y0, this.f31489d1, this.f31491e1);
            GLES20.glBindTexture(3553, iArr2[1]);
            GLES20.glTexImage2D(3553, 0, 6408, 256, 16, 0, 6408, 5121, this.f31489d1);
            if (!z10) {
                this.f31487c1 = null;
                this.f31489d1 = null;
                this.f31491e1 = null;
        ...
        yz yzVar = this.f31494f1;
        if (yzVar != null && !yzVar.b()) {
            GLES20.glUniform1f(this.R, this.f31494f1.getEnhanceValue());
        } else {
            GLES20.glUniform1f(this.R, 0.0f);
        }
        GLES20.glEnableVertexAttribArray(this.P);
        GLES20.glVertexAttribPointer(this.P, 2, 5126, false, 8, (Buffer) this.f31481a1);
    ...
    public final void e() {
        ...
        yz yzVar = this.f31494f1;
        if (yzVar != null && !yzVar.b()) {
            GLES20.glUniform1f(this.I0, this.f31494f1.getSharpenValue());
        } else {
        ...
        GLES20.glVertexAttribPointer(this.M0, 2, 5126, false, 8, (Buffer) this.f31481a1);
        GLES20.glEnableVertexAttribArray(this.L0);
        GLES20.glVertexAttribPointer(this.L0, 2, 5126, false, 8, (Buffer) this.f31484b1);
        GLES20.glDrawArrays(5, 0, 4);
    }
    ...
    public final void f() {
        ...
        int i11;
        yz yzVar = this.f31494f1;
        if (yzVar != null && !yzVar.b() && this.f31494f1.getSoftenSkinValue() > 0.0f && (i10 = this.X0) > 0 && this.Y0 > 0) {
            boolean z4 = this.f31482b;
            int[] iArr = this.T0;
            boolean z10 = this.f31497g1;
            int[] iArr2 = this.S0;
            if (z4 || z10) {
                float f10 = i10 * 0.006f;
                if (this.e == null || Math.abs(this.f31492f - f10) > 1.0E-4d) {
                    xz xzVar = this.e;
                    if (xzVar != null && (i11 = xzVar.f30796c) != 0) {
                ...
                GLES20.glUseProgram(this.f31500i);
                GLES20.glUniform1i(this.f31507l, 0);
                GLES20.glEnableVertexAttribArray(this.f31505k);
                GLES20.glVertexAttribPointer(this.f31505k, 2, 5126, false, 8, (Buffer) this.f31481a1);
                GLES20.glEnableVertexAttribArray(this.f31503j);
                if (z10) {
                    GLES20.glUniformMatrix4fv(this.f31509m, 1, false, this.P0, 0);
                    int i12 = this.f31510n;
                    if (i12 != -1) {
                        GLES20.glUniform2f(i12, this.X0, this.Y0);
                    }
                }
                GLES20.glVertexAttribPointer(this.f31503j, 2, 5126, false, 8, (Buffer) this.f31484b1);
                GLES20.glBindFramebuffer(36160, this.U0[0]);
                GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr2[0], 0);
                GLES20.glActiveTexture(33984);
                if (z10) {
                ...
                GLES20.glDrawArrays(5, 0, 4);
                GLES20.glUseProgram(this.e.f30796c);
                GLES20.glUniform1i(this.e.f30797f, 0);
                GLES20.glEnableVertexAttribArray(this.e.e);
                GLES20.glVertexAttribPointer(this.e.e, 2, 5126, false, 8, (Buffer) this.f31481a1);
                GLES20.glEnableVertexAttribArray(this.e.d);
                GLES20.glVertexAttribPointer(this.e.d, 2, 5126, false, 8, (Buffer) this.f31484b1);
                GLES20.glBindFramebuffer(36160, this.U0[1]);
                GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr2[1], 0);
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, iArr2[0]);
                GLES20.glUniform1f(this.e.f30798g, 0.0f);
                ...
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, iArr2[1]);
                GLES20.glUniform1f(this.e.f30798g, 1.0f / this.X0);
                GLES20.glUniform1f(this.e.h, 0.0f);
                GLES20.glDrawArrays(5, 0, 4);
                GLES20.glUseProgram(this.f31514p);
                GLES20.glUniform1i(this.f31520s, 0);
                GLES20.glUniform1i(this.f31522t, 1);
                GLES20.glEnableVertexAttribArray(this.f31518r);
                GLES20.glVertexAttribPointer(this.f31518r, 2, 5126, false, 8, (Buffer) this.f31481a1);
                GLES20.glEnableVertexAttribArray(this.f31516q);
                GLES20.glVertexAttribPointer(this.f31516q, 2, 5126, false, 8, (Buffer) this.f31484b1);
                GLES20.glBindFramebuffer(36160, this.U0[1]);
                GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr2[1], 0);
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, iArr2[0]);
                ...
                GLES20.glVertexAttribPointer(this.F, 2, 5126, false, 8, (Buffer) this.f31481a1);
                GLES20.glEnableVertexAttribArray(this.E);
                GLES20.glVertexAttribPointer(this.E, 2, 5126, false, 8, (Buffer) this.f31484b1);
                GLES20.glBindFramebuffer(36160, this.U0[3]);
                GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr2[3], 0);
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, iArr2[1]);
            ...
            this.h = true;
            this.W0 = false;
            GLES20.glUseProgram(this.f31524u);
            GLES20.glUniform1i(this.f31529x, 0);
            GLES20.glUniform1i(this.f31531y, 1);
            GLES20.glUniform1i(this.f31533z, 2);
            GLES20.glUniform1f(this.A, this.f31494f1.getSoftenSkinValue());
            GLES20.glEnableVertexAttribArray(this.f31527w);
            GLES20.glVertexAttribPointer(this.f31527w, 2, 5126, false, 8, (Buffer) this.f31481a1);
            GLES20.glEnableVertexAttribArray(this.v);
            GLES20.glVertexAttribPointer(this.v, 2, 5126, false, 8, (Buffer) this.f31484b1);
            if (z10) {
            ...
            GLES20.glBindTexture(3553, ((int[]) this.f31512o.f21045b)[0]);
            GLES20.glDrawArrays(5, 0, 4);
        } else if (this.h) {
            this.W0 = false;
            this.h = false;
        ...
        while (true) {
            ...
            if (i14 < i11) {
                ...
                if (z11) {
                    ...
                    GLES20.glDeleteProgram(this.f31500i);
                    if (i12 == 0 && i13 != 0) {
                        int glCreateProgram2 = GLES20.glCreateProgram();
                        this.f31500i = glCreateProgram2;
                        GLES20.glAttachShader(glCreateProgram2, i12);
                        GLES20.glAttachShader(this.f31500i, i13);
                        GLES20.glBindAttribLocation(this.f31500i, 0, "position");
                        GLES20.glBindAttribLocation(this.f31500i, 1, "inputTexCoord");
                        GLES20.glLinkProgram(this.f31500i);
                        GLES20.glGetProgramiv(this.f31500i, 35714, iArr, 0);
                        if (iArr[0] == 0) {
                            GLES20.glDeleteProgram(this.f31500i);
                            this.f31500i = 0;
                        } else {
                            this.f31503j = GLES20.glGetAttribLocation(this.f31500i, "position");
                            this.f31505k = GLES20.glGetAttribLocation(this.f31500i, "inputTexCoord");
                            this.f31507l = GLES20.glGetUniformLocation(this.f31500i, "sTexture");
                            if (z11) {
                                this.f31509m = GLES20.glGetUniformLocation(this.f31500i, "videoMatrix");
                                this.f31510n = GLES20.glGetUniformLocation(this.f31500i, "texSize");
                            }
                        }
                        if (z11) {
                            if (i15 != 0) {
                        ...
                        GLES20.glDeleteProgram(this.f31524u);
                        if (h10 == 0 || h11 == 0) {
                            return false;
                        }
                        int glCreateProgram3 = GLES20.glCreateProgram();
                        this.f31524u = glCreateProgram3;
                        GLES20.glAttachShader(glCreateProgram3, h10);
                        GLES20.glAttachShader(this.f31524u, h11);
                        GLES20.glBindAttribLocation(this.f31524u, 0, "position");
                        GLES20.glBindAttribLocation(this.f31524u, 1, "inputTexCoord");
                        GLES20.glLinkProgram(this.f31524u);
                        GLES20.glGetProgramiv(this.f31524u, 35714, iArr, 0);
                        if (iArr[0] == 0) {
                            GLES20.glDeleteProgram(this.f31524u);
                            this.f31524u = 0;
                            return true;
                        }
                        this.v = GLES20.glGetAttribLocation(this.f31524u, "position");
                        this.f31527w = GLES20.glGetAttribLocation(this.f31524u, "inputTexCoord");
                        this.f31529x = GLES20.glGetUniformLocation(this.f31524u, "sTexture");
                        this.f31531y = GLES20.glGetUniformLocation(this.f31524u, "inputImageTexture3");
                        this.f31533z = GLES20.glGetUniformLocation(this.f31524u, "toneCurveTexture");
                        this.A = GLES20.glGetUniformLocation(this.f31524u, "mixturePercent");
                        if (z11) {
                            this.B = GLES20.glGetUniformLocation(this.f31524u, "videoMatrix");
                            this.C = GLES20.glGetUniformLocation(this.f31524u, "texSize");
                            return true;
                        }
                        return true;
                    }
