...
public final class pu0 implements org.telegram.ui.Cells.l1 {
    ...
    public final org.telegram.ui.ActionBar.d6 f27500b;
    public final ru0 f27501c;

    public pu0(ru0 ru0Var, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        this.f27501c = ru0Var;
        this.f27499a = i10;
        this.f27500b = d6Var;
    }
    ...
    public final void P0(int i10, org.telegram.ui.Cells.u1 u1Var) {
        if (i10 == 80) {
            org.telegram.ui.ActionBar.m2 m2Var = this.f27501c.f28065s.f25866v1;
            MessageObject messageObject = u1Var.getMessageObject();
            org.telegram.ui.Cells.t8 t8Var = bh0.O;
            if (m2Var != null && m2Var.getParentActivity() != null) {
                m2Var.showDialog(new bh0(m2Var.getContext(), m2Var.getCurrentAccount(), messageObject, m2Var.getResourceProvider()));
            }
        }
    }
    ...
    public final void j(org.telegram.ui.Cells.u1 u1Var, ArrayList arrayList, int i10, int i11, int i12) {
        SendMessagesHelper.getInstance(this.f27499a).sendVote(u1Var.getMessageObject(), arrayList, null);
    }
    ...
    public final void n(org.telegram.ui.Cells.u1 u1Var, TLRPC.PollAnswer pollAnswer, TLRPC.MessageMedia messageMedia, int i10) {
        ...
        kv0 kv0Var = this.f27501c.f28065s;
        MessageObject messageObject = u1Var.getMessageObject();
        TLRPC.MessageMedia media = MessageObject.getMedia(messageObject);
        if (messageMedia != null && messageObject != null && (media instanceof TLRPC.TL_messageMediaPoll)) {
            TLRPC.TL_messageMediaPoll tL_messageMediaPoll = (TLRPC.TL_messageMediaPoll) media;
            TLRPC.GeoPoint geoPoint = messageMedia.geo;
            org.telegram.ui.ActionBar.d6 d6Var = this.f27500b;
            int i14 = this.f27499a;
            if (geoPoint != null) {
                if (AndroidUtilities.isMapsInstalled(kv0Var.f25866v1)) {
                    org.telegram.ui.cd0 cd0Var = new org.telegram.ui.cd0(3);
                    cd0Var.setResourceProvider(d6Var);
                    TLRPC.TL_message tL_message = new TLRPC.TL_message();
                    tL_message.local_id = -1;
                    tL_message.peer_id = MessagesController.getInstance(i14).getPeer(kv0Var.f25841j1);
                    ...
                    kv0Var.f25866v1.presentFragment(cd0Var);
                }
            } else if (MessageObject.isAnyKindOfStickerOrEmoji(messageMedia.document)) {
                org.telegram.ui.nt.q().w(kv0Var.f25866v1.getParentActivity());
                org.telegram.ui.nt.q().v(new ku0(this, tL_messageMediaPoll, pollAnswer, u1Var));
                ...
                q6.t(document4, null, "", null, null, i13, false, u1Var.getMessageObject(), this.f27500b, 200);
            } else {
                ...
                if (i11 > -1 && !arrayList2.isEmpty()) {
                    ...
                    PhotoViewer.t1().J2(null, kv0Var.f25866v1, d6Var);
                    PhotoViewer.t1().a2(arrayList2, i11, kv0Var.f25841j1, 0L, 0L, new ou0(this));
                }
            }
        }
    }
