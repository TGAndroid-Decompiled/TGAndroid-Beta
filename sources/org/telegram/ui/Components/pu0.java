...
public final class pu0 implements org.telegram.ui.Cells.l1 {
    ...
    public final org.telegram.ui.ActionBar.e6 f27324b;
    public final ru0 f27325c;
    ...
    public final void P0(int i10, org.telegram.ui.Cells.u1 u1Var) {
        if (i10 == 80) {
            org.telegram.ui.ActionBar.n2 n2Var = this.f27325c.f27974s.f25848v1;
    ...
    public final void j(org.telegram.ui.Cells.u1 u1Var, ArrayList arrayList, int i10, int i11, int i12) {
        SendMessagesHelper.getInstance(this.f27323a).sendVote(u1Var.getMessageObject(), arrayList, null);
    }
    ...
    public final void n(org.telegram.ui.Cells.u1 u1Var, TLRPC.PollAnswer pollAnswer, TLRPC.MessageMedia messageMedia, int i10) {
        ...
        kv0 kv0Var = this.f27325c.f27974s;
        MessageObject messageObject = u1Var.getMessageObject();
        TLRPC.MessageMedia media = MessageObject.getMedia(messageObject);
        if (messageMedia != null && messageObject != null && (media instanceof TLRPC.TL_messageMediaPoll)) {
            TLRPC.TL_messageMediaPoll tL_messageMediaPoll = (TLRPC.TL_messageMediaPoll) media;
            TLRPC.GeoPoint geoPoint = messageMedia.geo;
            org.telegram.ui.ActionBar.e6 e6Var = this.f27324b;
            int i14 = this.f27323a;
            if (geoPoint != null) {
                if (AndroidUtilities.isMapsInstalled(kv0Var.f25848v1)) {
                    org.telegram.ui.jd0 jd0Var = new org.telegram.ui.jd0(3);
                    jd0Var.setResourceProvider(e6Var);
                    TLRPC.TL_message tL_message = new TLRPC.TL_message();
                    tL_message.local_id = -1;
                    tL_message.peer_id = MessagesController.getInstance(i14).getPeer(kv0Var.f25823j1);
                    ...
                    kv0Var.f25848v1.presentFragment(jd0Var);
                }
            } else if (MessageObject.isAnyKindOfStickerOrEmoji(messageMedia.document)) {
                org.telegram.ui.st.q().w(kv0Var.f25848v1.getParentActivity());
                ...
                q6.t(document4, null, "", null, null, i13, false, u1Var.getMessageObject(), this.f27324b, 200);
            } else {
                ...
                if (i11 > -1 && !arrayList2.isEmpty()) {
                    ...
                    PhotoViewer.t1().J2(null, kv0Var.f25848v1, e6Var);
                    PhotoViewer.t1().a2(arrayList2, i11, kv0Var.f25823j1, 0L, 0L, new ou0(this));
                }
            }
        }
    }
