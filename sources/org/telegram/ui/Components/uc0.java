...
public final class uc0 extends Drawable {
    ...
    public final void a(int i10) {
        if (i10 != this.f28762f) {
            ...
            this.d = alpha;
            this.f28760b.setColor(i0.a.k(i10, (int) ((alpha / 255.0f) * this.f28761c)));
        }
        this.f28762f = i10;
    }
    ...
    public final Drawable.ConstantState getConstantState() {
        if (this.f28759a == null) {
            this.f28759a = new Drawable.ConstantState();
        }
        return this.f28759a;
    }
    ...
    public final void setAlpha(int i10) {
        if (this.f28761c != i10) {
            this.f28761c = i10;
            this.f28760b.setAlpha((int) ((this.d / 255.0f) * i10));
        }
    }
