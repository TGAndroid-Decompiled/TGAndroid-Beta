...
public final class uc0 extends Drawable {
    ...
    public final Paint f28757b;
    public final Paint f28758c;
    public final e6 d;
    public boolean e;
    ...
    public uc0(Context context) {
        ...
        this.f28758c = paint2;
        this.d = new e6(new ic0(this, 3), 200L, rr.f28023g, 0);
        this.f28756a = context.getResources().getDrawable(R.drawable.filled_sound_on).mutate();
    ...
    public final void draw(Canvas canvas) {
        ...
        if (e > 0.0f) {
            ...
            float f11 = centerY;
            float f12 = dp;
            canvas.drawLine(f10, f11, f12, f7, this.f28758c);
            Paint paint = this.f28757b;
