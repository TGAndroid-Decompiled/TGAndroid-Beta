        ...
        addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            private void checkCurrentItem() {
                if (CircularViewPager.this.adapter != null) {
                    ...
                    int realPosition = CircularViewPager.this.adapter.getRealPosition(currentItem) + CircularViewPager.this.adapter.getExtraCount();
                    if (currentItem != realPosition) {
                        CircularViewPager.this.setCurrentItem(realPosition, false);
                    }
                }
            }
