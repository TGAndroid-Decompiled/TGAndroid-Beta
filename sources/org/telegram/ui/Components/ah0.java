...
public class ah0 extends AccessibilityNodeProvider {
            ...
            case 0:
                ...
                if (i10 == -1) {
                    ...
                    for (int i11 = 0; i11 < arrayList.size(); i11++) {
                        obtain.addChild(eh0Var, ((bh0) arrayList.get(i11)).f22731a);
                    }
                    return obtain;
                }
                int i12 = 0;
                while (true) {
                    if (i12 < arrayList.size()) {
                        if (((bh0) arrayList.get(i12)).f22731a == i10) {
                ...
                if (bh0Var != null) {
                    ...
                    if (!rectF.isEmpty()) {
                        ...
                        obtain2.setText(bh0Var.f22739l.k());
                ...
                return null;
            default:
                s0.c Z = ((k2.u) this.f22415b).Z(i10);
                if (Z == null) {
                    return null;
                }
                return Z.f42651a;
    ...
    public AccessibilityNodeInfo findFocus(int i10) {
        switch (this.f22414a) {
            case 1:
                s0.c a02 = ((k2.u) this.f22415b).a0(i10);
                if (a02 == null) {
                    return null;
                }
                return a02.f42651a;
            ...
            case 0:
                ...
                if (bh0Var != null) {
                    if (i11 == 64) {
                        ...
                        dh0 dh0Var = eh0Var.F;
                        if (dh0Var != null) {
                            ProfileActivity.Y(((org.telegram.ui.my0) dh0Var).f35912b, i10, 0.0f, 0.0f);
                        }
                    }
                    return true;
                }
                return false;
            default:
                return ((k2.u) this.f22415b).c0(i10, i11, bundle);
        }
    }
