...
public class SharedMediaFastScrollTooltip extends FrameLayout {
    ...
    public class TooltipDrawableView extends View {
        ...
        public TooltipDrawableView(Context context) {
            ...
            this.paint2.setColor(Theme.getColor(null, i, false));
        ...
        public void onDraw(Canvas canvas) {
            ...
            for (int i2 = 7; i < i2; i2 = 7) {
                ...
                rectF.set(AndroidUtilities.dp(1.0f) + measuredWidth, f3, RichMessageLayout$RichDetailsEndBlock$$ExternalSyntheticOutline0.m(1.0f, measuredWidth, measuredWidth), f4);
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f), this.paint);
                i++;
            }
            canvas.restore();
            ...
            if (f5 > 1.0f) {
                ...
                float fM = FlickerLoadingView$$ExternalSyntheticOutline0.m(this.random, 1001) / 1000.0f;
                this.toProgress = fM;
    ...
    public SharedMediaFastScrollTooltip(Context context) {
        ...
        setBackground(Theme.createRoundRectDrawable(AndroidUtilities.dp(6.0f), Theme.getColor(null, Theme.key_chat_gifSaveHintBackground, false)));
