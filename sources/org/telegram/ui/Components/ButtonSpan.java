...
public class ButtonSpan extends ReplacementSpan {
    ...
    public static CharSequence make(CharSequence charSequence, Runnable runnable) {
        return make(charSequence, runnable, null);
    }
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
        ...
        this.backgroundPaint.setColor(Theme.multAlpha(0.15f, iIntValue));
