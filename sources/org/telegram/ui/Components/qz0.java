...
public final class qz0 extends TableLayout {
    ...
    public final oz0 a(CharSequence charSequence) {
        ...
        org.telegram.ui.ActionBar.f6 f6Var = this.f27465a;
    ...
    public final void b(CharSequence charSequence, ArrayList arrayList) {
        ...
        w5Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, this.f27465a));
    ...
    public final TableRow c(CharSequence charSequence, CharSequence charSequence2, pz0[] pz0VarArr, xc[] xcVarArr) {
        ...
        c90Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, this.f27465a));
    ...
    public final void h(String str, CharSequence charSequence, int i10, uh.i iVar) {
        ...
        int i12 = org.telegram.ui.ActionBar.j6.f19193v6;
    ...
    public final TableRow j(CharSequence charSequence, int i10, long j3, Runnable runnable, String str, Runnable runnable2) {
        ...
        ImageReceiver imageReceiver = g5Var.f33853b;
        if (j3 == 2666000) {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        paint.setStrokeWidth(this.f27468f);
        int i14 = org.telegram.ui.ActionBar.j6.f19111qh;
        org.telegram.ui.ActionBar.f6 f6Var = this.f27465a;
        paint.setColor(org.telegram.ui.ActionBar.j6.v0(i14, f6Var));
        Paint.Style style2 = Paint.Style.FILL;
        Paint paint2 = this.d;
        paint2.setStyle(style2);
        paint2.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19093ph, f6Var));
            ...
            if (getChildAt(i15) instanceof TableRow) {
                ...
                for (int i16 = 0; i16 < childCount2; i16++) {
                    ...
                    if (childAt instanceof pz0) {
                        ...
                        if (pz0Var.f27165b != z15 || pz0Var.f27166c != z16) {
                            pz0Var.f27165b = z15;
                            pz0Var.f27166c = z16;
                            pz0Var.invalidate();
                        }
                        ...
                        if (nz0Var.f26567b != z12 || nz0Var.f26568c != z13) {
                            nz0Var.f26567b = z12;
                            nz0Var.f26568c = z13;
                            nz0Var.invalidate();
                        }
                        ...
                        if (oz0Var.f26901c != z11 || oz0Var.d != z16) {
                            oz0Var.f26901c = z11;
                            oz0Var.d = z16;
                            oz0Var.invalidate();
                        }
