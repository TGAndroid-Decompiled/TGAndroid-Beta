...
public final class sj extends hl0 {
    public final int f30320r = UserConfig.selectedAccount;
    ...
    @Override
    public final int R() {
        return ContactsController.getInstance(this.f30320r).phoneBookSectionsArray.size() + 2;
    }
    ...
    public final void W(int i10, int i11, s4.c1 c1Var) {
        ...
        if (c1Var.f45743f == 0) {
            ...
            boolean containsKey = this.v.f32935w.containsKey(oj.a(O));
            mp mpVar = xjVar.d;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            ...
            xjVar = new xj(context, this.v.f28753a);
        }
