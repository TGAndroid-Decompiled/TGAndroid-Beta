...
public final class sj extends il0 {
    public final int f27874r = UserConfig.selectedAccount;
    public final Context f27875s;
    public final yj v;

    public sj(yj yjVar, Context context) {
        this.v = yjVar;
        this.f27875s = context;
    }
    ...
    @Override
    public final int R() {
        return ContactsController.getInstance(this.f27874r).phoneBookSectionsArray.size() + 2;
    }
    ...
    public final void W(int i10, int i11, s4.c1 c1Var) {
        ...
        if (c1Var.f42705f == 0) {
            ...
            boolean containsKey = this.v.f30259w.containsKey(oj.a(O));
            np npVar = xjVar.d;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            ...
            xjVar = new xj(context, this.v.f26462a);
        }
