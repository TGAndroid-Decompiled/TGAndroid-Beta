...
public final class lm0 extends Transition {
    ...
    public final void captureEndValues(TransitionValues transitionValues) {
        ...
        switch (this.f26802a) {
            ...
            case 1:
                ...
                xx0 xx0Var = (xx0) this.f26803b;
                viewGroup = ((org.telegram.ui.ActionBar.g3) xx0Var).containerView;
                map.put("offset", Integer.valueOf(viewGroup.getTop() + xx0Var.f30751b0));
                return;
            case 2:
                View view = transitionValues.view;
                PhotoViewer photoViewer = (PhotoViewer) this.f26803b;
            ...
            default:
                ...
                SecretMediaViewer secretMediaViewer = (SecretMediaViewer) this.f26803b;
    ...
    public final void captureStartValues(TransitionValues transitionValues) {
        ...
        switch (this.f26802a) {
            ...
            case 2:
                View view = transitionValues.view;
                org.telegram.ui.nt0 nt0Var = ((PhotoViewer) this.f26803b).Q1;
                if (view == nt0Var) {
            ...
            default:
                View view2 = transitionValues.view;
                org.telegram.ui.nt0 nt0Var2 = ((SecretMediaViewer) this.f26803b).X;
                if (view2 == nt0Var2) {
