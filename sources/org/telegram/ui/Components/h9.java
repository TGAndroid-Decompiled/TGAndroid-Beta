    ...
    public static void a(org.telegram.ui.xn xnVar, int i10, TLRPC.Chat chat, TLRPC.User user, TLRPC.TL_forumTopic tL_forumTopic, long j10, int i11, int i12) {
        ...
        if ((chat != null || user != null) && (parentLayout = xnVar.getParentLayout()) != null) {
            ...
            for (g9 g9Var : parentLayout.getPulledDialogs()) {
                if (tL_forumTopic != null || g9Var.f27140f != j10) {
                    if (tL_forumTopic != null && (tL_forumTopic2 = g9Var.f27139e) != null && tL_forumTopic2.f20895id == tL_forumTopic.f20895id) {
                        return;
                    }
                } else {
                    return;
            ...
            ?? obj = new Object();
            obj.f27136a = org.telegram.ui.xn.class;
            obj.f27137b = i10;
            obj.f27140f = j10;
            obj.h = i12;
            obj.f27141g = i11;
