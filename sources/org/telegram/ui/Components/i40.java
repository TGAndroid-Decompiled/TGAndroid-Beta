...
public class i40 extends FrameLayout {
    ...
    public boolean G;
    public boolean H;
    public final ai.p4 f24872a;
    public ImageView f24873b;
    public final ImageView f24874c;
    public org.telegram.ui.Cells.t1 d;
    public View e;
    public AnimatorSet f24875f;
    public Runnable h;
    public final int f24876n;
    public final boolean f24877r;
    public String f24878s;
    public int v;
    public float f24879w;
    public float f24880x;
    public int f24881y;
    ...
    public final void a() {
        float f7;
        float f10;
        this.f24872a.setPadding(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(7.0f), AndroidUtilities.dp(36.0f), AndroidUtilities.dp(8.0f));
        this.H = true;
        ImageView imageView = new ImageView(getContext());
        this.f24873b = imageView;
        imageView.setImageResource(R.drawable.msg_mini_close_tooltip);
        this.f24873b.setScaleType(ImageView.ScaleType.CENTER);
        this.f24873b.setColorFilter(new PorterDuffColorFilter(i0.a.k(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19064pf, this.F), 125), PorterDuff.Mode.MULTIPLY));
        ImageView imageView2 = this.f24873b;
        boolean z10 = this.f24877r;
        if (z10) {
            f7 = 3.0f;
        } else {
            f7 = 0.0f;
    ...
    public final void b(boolean z10) {
        ...
        AnimatorSet animatorSet = this.f24875f;
        if (animatorSet != null) {
            animatorSet.cancel();
            this.f24875f = null;
        }
        if (z10) {
            ...
            if (z11) {
                ...
                this.f24875f.setDuration(150L);
                this.f24875f.setInterpolator(qr.f27423f);
            } else {
                animatorSet2.playTogether(ObjectAnimator.ofFloat(this, property, 0.0f));
                this.f24875f.setDuration(300L);
            }
            this.f24875f.addListener(new g40(this, 2));
            this.f24875f.start();
            return;
        }
        setVisibility(4);
    ...
    public final void d() {
        float f7;
        ai.p4 p4Var = this.f24872a;
        p4Var.setTextColor(-1);
        this.f24874c.setColorFilter(new PorterDuffColorFilter(-366530760, PorterDuff.Mode.MULTIPLY));
    ...
    public final void f(View view, boolean z10) {
        if (this.e != view && getTag() == null) {
            ...
            if (z10) {
                ...
                Property property = View.ALPHA;
                if (z11) {
                    ImageView imageView = this.f24874c;
                    setPivotX((imageView.getMeasuredWidth() / 2.0f) + imageView.getX());
                    setPivotY((imageView.getMeasuredHeight() / 2.0f) + imageView.getY());
                    this.f24875f.playTogether(ObjectAnimator.ofFloat(this, property, 0.0f, 1.0f), ObjectAnimator.ofFloat(this, View.SCALE_Y, 0.5f, 1.0f), ObjectAnimator.ofFloat(this, View.SCALE_X, 0.5f, 1.0f));
                    this.f24875f.setDuration(350L);
                    this.f24875f.setInterpolator(qr.h);
                } else {
                    animatorSet2.playTogether(ObjectAnimator.ofFloat(this, property, 0.0f, 1.0f));
                    this.f24875f.setDuration(300L);
                }
                this.f24875f.addListener(new g40(this, 1));
                this.f24875f.start();
                return;
            }
            setAlpha(1.0f);
    ...
    public void setExtraTranslationY(float f7) {
        this.f24880x = f7;
        setTranslationY(f7 + this.f24879w);
    }
    ...
    public void setText(CharSequence charSequence) {
        this.f24872a.setText(charSequence);
    }
    ...
    public i40(int i10, Context context, org.telegram.ui.ActionBar.e6 e6Var, boolean z10) {
        ...
        this.f24872a = p4Var;
        int i11 = org.telegram.ui.ActionBar.i6.f19064pf;
        ...
        if (i10 == 3) {
            p4Var.setGravity(19);
            p4Var.setBackground(org.telegram.ui.ActionBar.i6.b0(AndroidUtilities.dp(5.0f), org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19082qf, e6Var)));
            ...
            p4Var.setGravity(51);
            p4Var.setBackground(org.telegram.ui.ActionBar.i6.b0(AndroidUtilities.dp(10.0f), org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19082qf, e6Var)));
        ...
        if (i10 == 0) {
            ...
            this.f24873b.setScaleType(ImageView.ScaleType.CENTER);
            this.f24873b.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.v0(i11, e6Var), PorterDuff.Mode.MULTIPLY));
            addView(this.f24873b, w7.x5.d(38, 34.0f, 51, 7.0f, 7.0f, 0.0f, 0.0f));
        }
        ImageView imageView2 = new ImageView(context);
        this.f24874c = imageView2;
        imageView2.setImageResource(z10 ? R.drawable.tooltip_arrow_up : R.drawable.tooltip_arrow);
        imageView2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19082qf, e6Var), PorterDuff.Mode.MULTIPLY));
