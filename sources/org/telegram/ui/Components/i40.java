...
public class i40 extends FrameLayout {
    ...
    public final void a() {
        float f7;
        float f10;
        this.f24873a.setPadding(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(7.0f), AndroidUtilities.dp(36.0f), AndroidUtilities.dp(8.0f));
        this.H = true;
        ImageView imageView = new ImageView(getContext());
        this.f24874b = imageView;
        imageView.setImageResource(R.drawable.msg_mini_close_tooltip);
        this.f24874b.setScaleType(ImageView.ScaleType.CENTER);
        this.f24874b.setColorFilter(new PorterDuffColorFilter(i0.a.k(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19323pf, this.F), 125), PorterDuff.Mode.MULTIPLY));
        ImageView imageView2 = this.f24874b;
        boolean z10 = this.f24878r;
        if (z10) {
            f7 = 3.0f;
        } else {
            f7 = 0.0f;
    ...
    public final void b(boolean z10) {
        ...
        AnimatorSet animatorSet = this.f24876f;
        if (animatorSet != null) {
            animatorSet.cancel();
            this.f24876f = null;
        }
        if (z10) {
            ...
            if (z11) {
                ...
                this.f24876f.setDuration(150L);
                this.f24876f.setInterpolator(qr.f27642f);
            } else {
                animatorSet2.playTogether(ObjectAnimator.ofFloat(this, property, 0.0f));
                this.f24876f.setDuration(300L);
            }
            this.f24876f.addListener(new g40(this, 2));
            this.f24876f.start();
            return;
        }
        setVisibility(4);
    ...
    public final void d() {
        float f7;
        ai.p4 p4Var = this.f24873a;
        p4Var.setTextColor(-1);
        this.f24875c.setColorFilter(new PorterDuffColorFilter(-366530760, PorterDuff.Mode.MULTIPLY));
        int i10 = this.f24877n;
        if (i10 != 7 && i10 != 8) {
            f7 = 3.0f;
        } else {
            f7 = 6.0f;
    ...
    public final void f(View view, boolean z10) {
        if (this.e != view && getTag() == null) {
            ...
            if (z10) {
                ...
                Property property = View.ALPHA;
                if (z11) {
                    ImageView imageView = this.f24875c;
                    setPivotX((imageView.getMeasuredWidth() / 2.0f) + imageView.getX());
                    setPivotY((imageView.getMeasuredHeight() / 2.0f) + imageView.getY());
                    this.f24876f.playTogether(ObjectAnimator.ofFloat(this, property, 0.0f, 1.0f), ObjectAnimator.ofFloat(this, View.SCALE_Y, 0.5f, 1.0f), ObjectAnimator.ofFloat(this, View.SCALE_X, 0.5f, 1.0f));
                    this.f24876f.setDuration(350L);
                    this.f24876f.setInterpolator(qr.h);
                } else {
                    animatorSet2.playTogether(ObjectAnimator.ofFloat(this, property, 0.0f, 1.0f));
                    this.f24876f.setDuration(300L);
                }
                this.f24876f.addListener(new g40(this, 1));
                this.f24876f.start();
                return;
            }
            setAlpha(1.0f);
    ...
    public void setExtraTranslationY(float f7) {
        this.f24881x = f7;
        setTranslationY(f7 + this.f24880w);
    }

    public void setOverrideText(String str) {
        this.f24879s = str;
        this.f24873a.setText(str);
    ...
    public void setText(CharSequence charSequence) {
        this.f24873a.setText(charSequence);
    }
    ...
    public i40(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        ...
        this.f24873a = p4Var;
        int i11 = org.telegram.ui.ActionBar.j6.f19323pf;
        ...
        if (i10 == 3) {
            p4Var.setGravity(19);
            p4Var.setBackground(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(5.0f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19341qf, f6Var)));
            ...
            p4Var.setGravity(51);
            p4Var.setBackground(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(10.0f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19341qf, f6Var)));
        ...
        if (i10 == 0) {
            ...
            this.f24874b.setScaleType(ImageView.ScaleType.CENTER);
            this.f24874b.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i11, f6Var), PorterDuff.Mode.MULTIPLY));
            addView(this.f24874b, w7.y5.d(38, 34.0f, 51, 7.0f, 7.0f, 0.0f, 0.0f));
        }
        ImageView imageView2 = new ImageView(context);
        this.f24875c = imageView2;
        imageView2.setImageResource(z10 ? R.drawable.tooltip_arrow_up : R.drawable.tooltip_arrow);
        imageView2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19341qf, f6Var), PorterDuff.Mode.MULTIPLY));
