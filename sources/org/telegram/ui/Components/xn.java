...
public final class xn implements Runnable {
    ...
    public final void run() {
        switch (this.f30360a) {
            case 0:
                fo foVar = this.f30361b;
                AtomicReference atomicReference = foVar.f24237n;
            ...
            case 1:
                ...
                return;
            default:
                fo foVar3 = this.f30361b;
                foVar3.f24234j0 = false;
                foVar3.f24232h0.c(false);
                if (foVar3.a()) {
                    foVar3.f();
                    return;
                }
