...
public class z81 extends FrameLayout {
    ...
    public float S;
    public final org.telegram.ui.ActionBar.f6 f30848a;
    public int f30849b;
    ...
    public final boolean B(android.view.MotionEvent r12) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.z81.B(android.view.MotionEvent):boolean");
    }

    public final boolean C(MotionEvent motionEvent, boolean z10) {
        int i10;
        if (!z10 && this.f30849b == 0) {
            this.S = 0.0f;
            return false;
        } else if ((z10 && this.f30849b == this.L.e() - 1) || this.R != null || !i(motionEvent) || ((z10 && !k(motionEvent)) || (!z10 && !j(motionEvent)))) {
            return false;
        } else {
            ...
            this.H = true;
            v();
            this.f30853r = (int) (motionEvent.getX() + this.E);
            o81 o81Var = this.M;
            if (o81Var != null) {
    ...
    public final void D(boolean z10) {
        ...
        AnimatorSet animatorSet = this.f30855w;
        if (animatorSet != null) {
            animatorSet.cancel();
            this.f30855w = null;
        }
        ...
        if (this.f30849b > this.L.e() - 1) {
            this.f30849b = this.L.e() - 1;
        }
        if (this.f30849b < 0) {
            this.f30849b = 0;
        }
        int h = this.L.h(this.f30849b);
        int[] iArr = this.f30851f;
        iArr[0] = h;
        View d = this.L.d(h);
        viewArr[0] = d;
        this.L.b(d, this.f30849b, iArr[0]);
        addView(viewArr[0]);
        ...
        if (z10) {
            ...
            if (view7 != null) {
                this.f30855w.playTogether(I(view7, getMeasuredWidth()));
            }
            View view8 = viewArr[0];
            if (view8 != null) {
                this.f30855w.playTogether(I(view8, 0.0f));
            }
            x(true);
            o81 o81Var = this.M;
            o81Var.f30583a = 0.0f;
            ...
            ofFloat.addUpdateListener(new m81(this, 2));
            this.f30855w.playTogether(ofFloat);
            this.f30855w.setInterpolator(T);
            this.f30855w.setDuration(220L);
            this.f30855w.addListener(new n81(this, 2));
    ...
    public final void E(int i10) {
        ...
        if (i10 != this.f30849b) {
            ...
            if (valueAnimator == null || this.d != i10) {
                ...
                ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                this.R = ofFloat;
                ofFloat.addUpdateListener(new m81(this, 0));
                this.R.addListener(new n81(this, 0));
    ...
    public void G() {
        ...
        this.f30849b = i11;
        this.d = i10;
        this.f30850c = 1.0f - this.f30850c;
        int[] iArr = this.f30851f;
        int i12 = iArr[0];
        iArr[0] = iArr[1];
        iArr[1] = i12;
    ...
    public final boolean canScrollHorizontally(int i10) {
        boolean z10;
        if (i10 != 0) {
            if (!this.f30856x && !this.H) {
                if (i10 > 0) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                if ((z10 || this.f30849b != 0) && (!z10 || this.f30849b != this.L.e() - 1)) {
                }
            }
            return true;
        }
    ...
    public float getPositionAnimated() {
        ...
        View view = viewArr[0];
        if (view != null && view.getVisibility() == 0) {
            f7 = (this.f30849b * Utilities.clamp(1.0f - Math.abs(viewArr[0].getTranslationX() / getAvailableTranslationX()), 1.0f, 0.0f)) + 0.0f;
        } else {
            f7 = 0.0f;
        }
        View view2 = viewArr[1];
    ...
    public final void l() {
        ...
        if (this.H) {
            ...
            if (this.F) {
                f7 = Math.abs(x10);
                if (this.f30857y) {
                    this.f30855w.playTogether(I(viewArr[0], 0.0f));
                    View view4 = viewArr[1];
                    if (view4 != null) {
                        this.f30855w.playTogether(I(view4, view4.getMeasuredWidth()));
                    }
                } else {
                    this.f30855w.playTogether(I(viewArr[0], 0.0f));
                    View view5 = viewArr[1];
                    if (view5 != null) {
                        this.f30855w.playTogether(I(view5, -view5.getMeasuredWidth()));
                    }
                }
            } else if (this.d >= 0) {
                f7 = viewArr[0].getMeasuredWidth() - Math.abs(x10);
                if (this.f30857y) {
                    this.f30855w.playTogether(I(viewArr[0], -view2.getMeasuredWidth()));
                    View view6 = viewArr[1];
                    if (view6 != null) {
                        this.f30855w.playTogether(I(view6, 0.0f));
                    }
                } else {
                    this.f30855w.playTogether(I(viewArr[0], view.getMeasuredWidth()));
                    View view7 = viewArr[1];
                    if (view7 != null) {
                        this.f30855w.playTogether(I(view7, 0.0f));
                    }
                }
            } else {
                f7 = 0.0f;
            ...
            if (this.d < 0) {
                ...
                ofFloat.addUpdateListener(new m81(this, 3));
                this.f30855w.playTogether(ofFloat);
            }
            ValueAnimator ofFloat2 = ValueAnimator.ofFloat(0.0f, 1.0f);
            ofFloat2.addUpdateListener(this.N);
            this.f30855w.playTogether(ofFloat2);
            this.f30855w.setInterpolator(T);
            ...
            this.f30855w.setDuration(Math.max(150, Math.min(measuredWidth2, 600)));
            this.f30855w.addListener(new n81(this, 3));
            this.f30855w.start();
            this.f30856x = true;
            this.H = false;
            x(false);
    ...
    public final y81 n(int i10, boolean z10) {
        o81 o81Var = new o81(this, getContext(), z10, i10, this.f30848a);
        this.M = o81Var;
        o81Var.f30604r = H();
    ...
    public final void o(boolean z10) {
        ...
        if (this.L != null && (o81Var = this.M) != null) {
            o81Var.h.clear();
            o81Var.f30586b0.clear();
            o81Var.f30588c0.clear();
            o81Var.f30589d0.clear();
            o81Var.f30590e0.clear();
            o81Var.H = 0;
    ...
    public void setAdapter(q81 q81Var) {
        this.L = q81Var;
        int h = q81Var.h(this.f30849b);
        int[] iArr = this.f30851f;
        iArr[0] = h;
        View d = q81Var.d(h);
        View[] viewArr = this.e;
        viewArr[0] = d;
        if (d == null && this.f30849b != 0) {
            this.f30849b = 0;
            int h10 = q81Var.h(0);
            iArr[0] = h10;
            viewArr[0] = q81Var.d(h10);
        }
        q81Var.b(viewArr[0], this.f30849b, iArr[0]);
        addView(viewArr[0]);
        viewArr[0].setVisibility(0);
        o(false);
    }
    ...
    public void setPosition(int i10) {
        ...
        View view = viewArr[1];
        if (view != null) {
            this.h.put(this.f30851f[1], view);
        ...
        if (i11 != i10) {
            ...
            View view2 = viewArr[0];
            J(0);
            t(viewArr[0], view2, this.f30849b, i11);
            F(viewArr[0], 0.0f);
            o81 o81Var = this.M;
            if (o81Var != null) {
                o81Var.e(this.f30850c, this.f30849b, this.d);
            }
            x(true);
        }
    }
