...
public final class z81 implements SensorEventListener {
    public final float[] f30806a = new float[3];
    public final float[] f30807b = new float[3];
    public int f30808c;
    public final WindowManager d;
    public final SensorManager e;
    public final Sensor f30809f;
    public boolean h;
    public y81 f30810n;
    ...
    public z81(Context context) {
        ...
        this.f30809f = sensorManager.getDefaultSensor(1);
    }
