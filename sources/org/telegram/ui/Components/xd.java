...
public final class xd implements org.telegram.ui.hj0, org.telegram.ui.jy {
    public final ChatActivityEnterView f33039a;
    public final MessageObject f33040b;
    public final TL_keyboard.TL_buttonTypeRequestPeer f33041c;
    ...
    public xd(ChatActivityEnterView chatActivityEnterView, MessageObject messageObject, TL_keyboard.TL_buttonTypeRequestPeer tL_buttonTypeRequestPeer) {
        this.f33039a = chatActivityEnterView;
        this.f33040b = messageObject;
        this.f33041c = tL_buttonTypeRequestPeer;
    }
    ...
    public void a(ArrayList arrayList) {
        ...
        if (!arrayList.isEmpty()) {
            ...
            ChatActivityEnterView chatActivityEnterView = this.f33039a;
            MessagesController messagesController = MessagesController.getInstance(chatActivityEnterView.N);
            MessageObject messageObject = this.f33040b;
            ...
            tL_messages_sendBotRequestedPeer.button_id = this.f33041c.button_id;
