...
public final class an0 implements al0 {
    ...
    public final org.telegram.ui.ActionBar.o2 f22445c;
        ...
        switch (this.f22443a) {
            case 0:
                ...
                if (i10 >= 0 && i10 < arrayList.size()) {
                    if (!UserConfig.getInstance(this.f22444b).isPremium()) {
                        new rg.x0(this.f22445c, 24, true).show();
                        return;
                    }
                    long j3 = ((gn0) arrayList.get(i10)).f24349a.h;
                    if (jn0Var.h == j3) {
                        p0Var = null;
                    } else {
                        p0Var = ((gn0) arrayList.get(i10)).f24349a;
                    }
                    if (jn0Var.f(p0Var)) {
            ...
            default:
                ...
                if (view instanceof org.telegram.ui.ww0) {
                    ...
                    PremiumPreviewFragment.q0(this.f22444b, ww0Var.f39183f.f35903a);
                    k1Var.showDialog(new rg.x0(this.f22445c, ww0Var.f39183f.f35903a, false));
                    return;
                }
                return;
        }
