...
public final class cz0 {
    public final org.telegram.ui.ActionBar.f6 f23502a;
    public StaticLayout f23503b;
    public final ArrayList f23504c = new ArrayList(2);
    public int d;
    public int e;
    public int f23505f;
    public int f23506g;
    ...
    public final void b(MessageObject messageObject) {
        ...
        org.telegram.ui.ActionBar.f6 f6Var = this.f23502a;
        if (f6Var != null) {
        ...
        this.f23506g = AndroidUtilities.dp(14.0f) * 2;
        ArrayList arrayList = this.f23504c;
        arrayList.clear();
        ...
        while (i16 < size) {
            ...
            i16++;
            bz0 bz0Var = (bz0) obj;
            f10 = Math.max(f10, bz0Var.f23122a.l());
            f11 = Math.max(f11, bz0Var.f23123b.l());
            int j3 = ((int) bz0Var.f23122a.j()) + this.f23506g;
            this.f23506g = j3;
            this.f23506g = AndroidUtilities.dp(7.0f) + j3;
        }
        ...
        this.f23503b = new StaticLayout(AndroidUtilities.replaceTags(spannableStringBuilder), textPaint, max, Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
        int i30 = 0;
        for (int i31 = 0; i31 < this.f23503b.getLineCount(); i31++) {
            i30 = (int) Math.max(i30, this.f23503b.getLineWidth(i31));
        }
        int height = this.f23503b.getHeight() + this.f23506g;
        this.f23506g = height;
        this.f23506g = AndroidUtilities.dp(5.0f) + height;
        int D = org.telegram.messenger.l0.D(24.0f, 2, Math.max(dp, i30));
        this.h = D;
        this.d = (D - max) / 2;
        this.e = (D - dp) / 2;
        this.f23505f = (int) (AndroidUtilities.dp(f7) + i15 + f10);
    }
}
