...
public final class he implements org.telegram.ui.kj0, org.telegram.ui.ly {
    public final ChatActivityEnterView f24654a;
    public final MessageObject f24655b;
    public final TL_keyboard.TL_buttonTypeRequestPeer f24656c;
    ...
    public he(ChatActivityEnterView chatActivityEnterView, MessageObject messageObject, TL_keyboard.TL_buttonTypeRequestPeer tL_buttonTypeRequestPeer) {
        this.f24654a = chatActivityEnterView;
        this.f24655b = messageObject;
        this.f24656c = tL_buttonTypeRequestPeer;
    }
    ...
    public void a(ArrayList arrayList) {
        ...
        if (!arrayList.isEmpty()) {
            ...
            ChatActivityEnterView chatActivityEnterView = this.f24654a;
            MessagesController messagesController = MessagesController.getInstance(chatActivityEnterView.Q);
            MessageObject messageObject = this.f24655b;
            ...
            tL_messages_sendBotRequestedPeer.button_id = this.f24656c.button_id;
