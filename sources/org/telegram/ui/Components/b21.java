...
public abstract class b21 extends View {
    public final c21 f22548a;
    public Utilities.Callback f22549b;
    public final org.telegram.ui.ActionBar.f6 f22550c;
    public int d;
    ...
    public b21(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f22548a = c21Var;
        c21Var.f22915r = new kq0(this, 18);
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        super.dispatchDraw(canvas);
        org.telegram.ui.ActionBar.f6 f6Var = this.f22550c;
        if (f6Var != null) {
            f6Var.m(0.0f, 0.0f, getMeasuredWidth(), this.d);
        } else {
            org.telegram.ui.ActionBar.j6.q(0.0f, 0.0f, getMeasuredWidth(), this.d);
        }
        this.f22548a.c(canvas, getWidth(), 0.0f, 0.0f, 0.75f, 1.0f, true);
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        if (!this.f22548a.d(motionEvent, false) && !super.onTouchEvent(motionEvent)) {
            return false;
        }
        return true;
    }
