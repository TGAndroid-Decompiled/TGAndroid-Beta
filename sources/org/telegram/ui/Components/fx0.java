...
public final class fx0 extends FrameLayout {
    ...
    public float f24970b;
    public boolean f24971c;
    public boolean d;
    public final p9 e;
    public final ImageView f24972f;
    public final gg.q h;
    public final View f24973n;
    public boolean f24974r;
    public final int f24975s;
    public SvgHelper.SvgDrawable v;
    public boolean f24976w;
    public ValueAnimator f24977x;
    public float f24978y;
    ...
    public fx0(Context context, int i10) {
        ...
        if (i10 == 2) {
            ...
            this.f24972f = imageView;
            imageView.setScaleType(ImageView.ScaleType.CENTER_CROP);
            addView(imageView, k7.b6.e(24, 24, 17));
            this.f24973n = imageView;
        } else {
    ...
    public final void a(float f10) {
        ...
        boolean z4 = this.f24974r;
        View view = this.f24973n;
        if (z4) {
            if (i10 == 1) {
                f11 = 24.0f;
            } else {
