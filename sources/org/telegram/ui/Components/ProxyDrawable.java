...
public class ProxyDrawable extends Drawable {
    ...
    private void setBounds(Drawable drawable) {
        ...
        drawable.setBounds(zzkn.m(bounds.centerX(), drawable), bounds.centerY() - (drawable.getIntrinsicHeight() / 2), (drawable.getIntrinsicWidth() / 2) + bounds.centerX(), (drawable.getIntrinsicHeight() / 2) + bounds.centerY());
    }
