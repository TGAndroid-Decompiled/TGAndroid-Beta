...
public class uq extends Path {
    public static ArrayList f28465g;
    public int e;
    public int f28469f;
    public boolean f28467b = false;
    public boolean f28468c = true;
    public float d = 0.0f;
    public final ArrayList f28466a = new ArrayList(1);

    public uq() {
    }

    public final void a() {
        if (Build.VERSION.SDK_INT >= 34 && this.f28468c && !this.f28467b) {
            b(this.f28466a);
            this.f28467b = true;
        }
    }
    ...
    public final void addRect(RectF rectF, Path.Direction direction) {
        RectF rectF2;
        if (Build.VERSION.SDK_INT >= 34 && this.f28468c) {
            ...
            if (arrayList.size() <= 0 || !((RectF) hg.k0.h(1, arrayList)).contains(rectF)) {
                if (arrayList.size() > 0 && Math.abs(rectF.top - ((RectF) hg.k0.h(1, arrayList)).top) <= this.d && Math.abs(rectF.bottom - ((RectF) hg.k0.h(1, arrayList)).bottom) <= this.d) {
                    ...
                    ArrayList arrayList2 = f28465g;
                    if (arrayList2 != null && arrayList2.size() > 0) {
                        rectF2 = (RectF) f28465g.remove(0);
                    } else {
                        rectF2 = new RectF();
                    }
                    rectF2.set(rectF);
    ...
    public final void b(List list) {
        if (!list.isEmpty()) {
            boolean z10 = false;
            if (list.size() == 1) {
                super.addRect(((RectF) list.get(0)).left - this.e, ((RectF) list.get(0)).top - this.f28469f, ((RectF) list.get(0)).right + this.e, ((RectF) list.get(0)).bottom + this.f28469f, Path.Direction.CW);
                return;
            }
            RectF rectF = (RectF) list.get(0);
            int size = list.size() - 1;
            super.moveTo(rectF.left - this.e, rectF.top - this.f28469f);
            ...
            super.lineTo(rectF.left - this.e, rectF.bottom + this.f28469f);
            super.lineTo(rectF.right + this.e, rectF.bottom + this.f28469f);
            ...
            super.lineTo(rectF.right + this.e, rectF.top - this.f28469f);
            super.close();
            if (z10) {
    ...
    public void reset() {
        super.reset();
        if (Build.VERSION.SDK_INT >= 34 && this.f28468c) {
            ArrayList arrayList = f28465g;
            ArrayList arrayList2 = this.f28466a;
            if (arrayList == null) {
                f28465g = new ArrayList(arrayList2.size());
            }
            f28465g.addAll(arrayList2);
            arrayList2.clear();
            this.f28467b = false;
        }
    }
