...
public final class uq extends View {
    public final Paint f28866a;
    public final Paint f28867b;
    public final RectF f28868c;
    public int d;
    public long e;
    public int f28869f;
    public int h;
    ...
    public uq(Context context, int i10) {
        ...
        if (i10 == 0) {
            this.f28869f = org.telegram.ui.ActionBar.h6.B7;
            this.h = org.telegram.ui.ActionBar.h6.C7;
        } else if (i10 == 1) {
            this.f28869f = org.telegram.ui.ActionBar.h6.D7;
            this.h = org.telegram.ui.ActionBar.h6.E7;
        } else if (i10 == 2) {
            this.f28869f = org.telegram.ui.ActionBar.h6.F7;
            this.h = org.telegram.ui.ActionBar.h6.G7;
        } else if (i10 == 3) {
            this.f28869f = org.telegram.ui.ActionBar.h6.H7;
    ...
    public final void b() {
        ...
        if (i10 >= 0) {
            ...
            paint.setColor(this.f28870n);
        }
        int i11 = this.h;
        Paint paint2 = this.f28867b;
        if (i11 >= 0) {
            paint2.setColor(org.telegram.ui.ActionBar.h6.w0(null, i11, false));
        } else {
            paint2.setColor(this.f28871r);
        }
        invalidate();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        RectF rectF = this.f28868c;
        rectF.set(measuredWidth, measuredHeight, AndroidUtilities.dp(18.0f) + measuredWidth, AndroidUtilities.dp(18.0f) + measuredHeight);
        canvas.drawCircle(getMeasuredWidth() / 2, getMeasuredHeight() / 2, AndroidUtilities.dp(9.0f), this.f28866a);
        canvas.drawArc(rectF, this.d - 90, 90.0f, false, this.f28867b);
        invalidate();
    }
