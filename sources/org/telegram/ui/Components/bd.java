...
public final class bd extends ReplacementSpan {
    public final org.telegram.ui.ActionBar.f6 f24694a;
    public final Paint f24695b = new Paint(1);
    public final f01 f24696c;
    public final Runnable d;
    public zc f24697e;
    public Integer f24698f;

    public bd(CharSequence charSequence, Runnable runnable, org.telegram.ui.ActionBar.f6 f6Var) {
        this.f24694a = f6Var;
        this.d = runnable;
        this.f24696c = new f01(charSequence, 12.0f, null);
    }
    ...
    public final int a() {
        return (int) (this.f24696c.f25874c + AndroidUtilities.dp(14.0f));
    }

    public final void c(ad adVar, boolean z10) {
        if (this.f24697e == null) {
            this.f24697e = new zc(adVar);
        }
        this.f24697e.c(z10);
    }
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        ...
        if (num != null) {
            ...
            v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Oh, this.f24694a);
        }
        int i15 = v02;
        int l1 = org.telegram.ui.ActionBar.j6.l1(0.15f, i15);
        Paint paint2 = this.f24695b;
        paint2.setColor(l1);
        canvas.drawRoundRect(rectF, f11, f11, paint2);
        this.f24696c.c(f7 + AndroidUtilities.dp(7.0f), f10, 1.0f, i15, canvas);
        canvas.restore();
    }
