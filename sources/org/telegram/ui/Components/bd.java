...
public final class bd {
    ...
    public float D;
    public final dd E;
    public final Paint f22972a;
    public Bitmap f22973b;
    public float f22974c;
    public float d;
    public final e6 e;
    public final e6 f22975f;
    public float f22976g;
    public final e6 h;
    public float f22977i;
    public final e6 f22978j;
    public final o6 f22979k;
    public float f22980l;
    public final e6 f22981m;
    public boolean f22982n;
    public final e6 f22983o;
    public final Path f22984p;
    public final Paint f22985q;
    public final RectF f22986r;
    public final Paint f22987s;
    public final Paint f22988t;
    public final RectF f22989u;
    public RadialGradient v;
    public Matrix f22990w;
    public float f22991x;
    public float f22992y;
    public float f22993z;
    ...
    public bd(dd ddVar) {
        ...
        this.f22975f = new e6(ddVar, 650L, srVar);
        sr srVar2 = sr.f28340g;
        this.h = new e6(ddVar, 0L, 150L, srVar2);
        this.f22977i = 1.0f;
        this.f22978j = new e6(ddVar, 0L, 150L, srVar2);
        o6 o6Var = new o6(false, true, true, false);
        this.f22979k = o6Var;
        this.f22981m = new e6(ddVar, 0L, 150L, srVar2);
        this.f22983o = new e6(ddVar, 0L, 200L, srVar);
        o6Var.r(-1);
        ...
        this.f22985q = paint2;
        this.f22986r = new RectF();
        this.f22987s = new Paint(1);
        Paint paint3 = new Paint(1);
        this.f22988t = paint3;
        paint3.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
        paint2.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.SRC_IN));
        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.SRC_ATOP));
        this.f22989u = new RectF();
    }
    ...
    public final void a(Canvas canvas, float f7, float f10, float f11, float f12, float f13, float f14, float f15, float f16, float f17, float f18) {
        ...
        if (f18 > 0.0f && LiteMode.isEnabled(360928)) {
            ...
            if (dd.f23664b0 < 0) {
                dd.f23664b0 = currentTimeMillis;
            }
            float f19 = ((float) (currentTimeMillis - dd.f23664b0)) / 10000.0f;
            Bitmap bitmap = this.f22973b;
            if (bitmap != null) {
                ...
                while (floor <= ceil) {
                    ...
                    float f26 = -(i10 >> 1);
                    canvas.drawBitmap(this.f22973b, f26, f26, paint);
                    canvas.restore();
                    floor++;
                    sqrt = sqrt;
                    width = i10;
