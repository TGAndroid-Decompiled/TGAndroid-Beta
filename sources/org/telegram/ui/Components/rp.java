...
public final class rp {
    ...
    public final Path f30090a = new Path();
    public final float[] f30091b = new float[4];
    public final float[] f30092c = new float[4];
    public final Matrix d = new Matrix();
    public final float h = 1.0f;
    public final Random f30096i = new Random();
    public final int f30094f = 6;
    public final float f30093e = (float) (Math.tan(3.141592653589793d / 12) * 1.3333333333333333d);
    public final float[] f30097j = new float[6];

    public rp() {
        for (int i10 = 0; i10 < this.f30094f; i10++) {
            this.f30097j[i10] = (this.f30096i.nextInt() % 100) / 100.0f;
        }
    }
    ...
    public final void a(float f7, float f10, Canvas canvas, Paint paint) {
        ...
        while (true) {
            ...
            if (i11 < i12) {
                ...
                float f19 = rpVar.f30098k;
                float[] fArr = rpVar.f30097j;
                float f20 = (fArr[i11] * f19) + f11;
                float[] fArr2 = rpVar.f30091b;
                fArr2[0] = f7;
                float f21 = f10 - f20;
                fArr2[1] = f21;
                float f22 = f15;
                ...
                float f23 = rpVar.f30098k;
                float[] fArr3 = rpVar.f30092c;
                fArr3[0] = f7;
