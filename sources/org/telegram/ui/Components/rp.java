        ...
        switch (this.f27937a) {
            case 0:
                if (this.f27940f != i10) {
                    ...
                    this.f27941g.setColor(i10);
                }
                this.f27940f = i10;
                return;
            default:
                Paint paint = this.f27941g;
                if (paint != null) {
                    paint.setColor(i10);
                    return;
                }
    ...
    public final void draw(Canvas canvas) {
        ...
        switch (this.f27937a) {
            case 0:
                ...
                Paint paint = this.f27941g;
                if (paint == null) {
                    paint = org.telegram.ui.ActionBar.j6.f19058d2;
                }
                Paint paint2 = (Paint) this.h;
                if (paint2 == null) {
                    paint2 = org.telegram.ui.ActionBar.j6.f19040c2;
                }
                ...
                if (this.f27938b) {
                    ...
                    long j3 = currentTimeMillis - this.f27939c;
            ...
            default:
                ...
                Paint paint3 = this.f27941g;
                if (paint3 == null) {
                    paint3 = org.telegram.ui.ActionBar.j6.f19058d2;
                }
                Paint paint4 = paint3;
                float f12 = 2.0f;
                ...
                for (int i12 = 0; i12 < 4; i12++) {
                    if (i12 == 0) {
                        paint4.setAlpha((int) (this.f27940f * this.e));
                    } else if (i12 == 3) {
                        paint4.setAlpha((int) ((1.0f - this.e) * this.f27940f));
                    } else {
                        paint4.setAlpha(this.f27940f);
                    }
                ...
                if (this.d) {
                    ...
                    long j10 = currentTimeMillis2 - this.f27939c;
                    this.f27939c = currentTimeMillis2;
                    if (j10 > 50) {
                        j10 = 50;
                    }
