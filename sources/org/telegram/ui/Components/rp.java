        ...
        switch (this.f27665a) {
            case 0:
                if (this.f27668f != i10) {
                    ...
                    this.f27669g.setColor(i10);
                }
                this.f27668f = i10;
                return;
            default:
                Paint paint = this.f27669g;
                if (paint != null) {
                    paint.setColor(i10);
                    return;
                }
    ...
    public final void draw(Canvas canvas) {
        ...
        switch (this.f27665a) {
            case 0:
                ...
                if (paint2 == null) {
                    paint2 = org.telegram.ui.ActionBar.j6.f18841c2;
                }
                ...
                if (this.f27666b) {
                    ...
                    long j3 = currentTimeMillis - this.f27667c;
                    this.f27667c = currentTimeMillis;
                    if (j3 > 50) {
                        j3 = 50;
                    }
            ...
            default:
                ...
                Paint paint3 = this.f27669g;
                if (paint3 == null) {
                    paint3 = org.telegram.ui.ActionBar.j6.f18859d2;
                }
                Paint paint4 = paint3;
                float f12 = 2.0f;
                ...
                for (int i12 = 0; i12 < 4; i12++) {
                    if (i12 == 0) {
                        paint4.setAlpha((int) (this.f27668f * this.e));
                    } else if (i12 == 3) {
                        paint4.setAlpha((int) ((1.0f - this.e) * this.f27668f));
                    } else {
                        paint4.setAlpha(this.f27668f);
                    }
                ...
                if (this.d) {
                    ...
                    long j10 = currentTimeMillis2 - this.f27667c;
                    this.f27667c = currentTimeMillis2;
                    if (j10 > 50) {
                        j10 = 50;
                    }
