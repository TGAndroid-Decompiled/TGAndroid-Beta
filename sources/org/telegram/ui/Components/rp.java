...
public final class rp extends lw0 {
        ...
        switch (this.f27655a) {
            case 0:
                if (this.f27658f != i10) {
                    ...
                    this.f27659g.setColor(i10);
                }
                this.f27658f = i10;
                return;
            default:
                Paint paint = this.f27659g;
                if (paint != null) {
                    paint.setColor(i10);
                    return;
                }
    ...
    public final void d() {
        switch (this.f27655a) {
            case 0:
                this.f27657c = System.currentTimeMillis();
                this.f27656b = true;
                invalidateSelf();
                return;
            default:
    ...
    public final void draw(Canvas canvas) {
        ...
        switch (this.f27655a) {
            case 0:
                ...
                if (paint2 == null) {
                    paint2 = org.telegram.ui.ActionBar.i6.f18812c2;
                }
                ...
                if (this.f27656b) {
                    ...
                    long j3 = currentTimeMillis - this.f27657c;
                    this.f27657c = currentTimeMillis;
                    if (j3 > 50) {
                        j3 = 50;
                    }
            ...
            default:
                ...
                Paint paint3 = this.f27659g;
                if (paint3 == null) {
                    paint3 = org.telegram.ui.ActionBar.i6.f18830d2;
                }
                Paint paint4 = paint3;
                float f12 = 2.0f;
                ...
                for (int i12 = 0; i12 < 4; i12++) {
                    if (i12 == 0) {
                        paint4.setAlpha((int) (this.f27658f * this.e));
                    } else if (i12 == 3) {
                        paint4.setAlpha((int) ((1.0f - this.e) * this.f27658f));
                    } else {
                        paint4.setAlpha(this.f27658f);
                    }
                ...
                if (this.d) {
                    ...
                    long j10 = currentTimeMillis2 - this.f27657c;
                    this.f27657c = currentTimeMillis2;
                    if (j10 > 50) {
                        j10 = 50;
                    }
