...
public final class rp extends ww0 {
        ...
        switch (this.f27932a) {
            case 0:
                if (this.f27935f != i10) {
                    ...
                    this.f27936g.setColor(i10);
                }
                this.f27935f = i10;
                return;
            default:
                Paint paint = this.f27936g;
                if (paint != null) {
                    paint.setColor(i10);
                    return;
                }
    ...
    public final void d() {
        switch (this.f27932a) {
            case 0:
                this.f27934c = System.currentTimeMillis();
                this.f27933b = true;
                invalidateSelf();
                return;
            default:
    ...
    public final void draw(Canvas canvas) {
        ...
        switch (this.f27932a) {
            case 0:
                ...
                float interpolation2 = qrVar2.getInterpolation(f10);
                if (this.d) {
                    ...
                    dpf2 = (1.0f - qrVar2.getInterpolation(this.e / 2.0f)) * AndroidUtilities.dpf2(1.5f);
                } else {
                ...
                Paint paint = this.f27936g;
                if (paint == null) {
                    paint = org.telegram.ui.ActionBar.j6.f19090d2;
                }
                Paint paint2 = (Paint) this.h;
                if (paint2 == null) {
                    paint2 = org.telegram.ui.ActionBar.j6.f19072c2;
                }
                ...
                if (this.f27933b) {
                    ...
                    long j3 = currentTimeMillis - this.f27934c;
                    this.f27934c = currentTimeMillis;
                    if (j3 > 50) {
                        j3 = 50;
                    }
            ...
            default:
                ...
                Paint paint3 = this.f27936g;
                if (paint3 == null) {
                    paint3 = org.telegram.ui.ActionBar.j6.f19090d2;
                }
                Paint paint4 = paint3;
                float f12 = 2.0f;
                ...
                for (int i12 = 0; i12 < 4; i12++) {
                    if (i12 == 0) {
                        paint4.setAlpha((int) (this.f27935f * this.e));
                    } else if (i12 == 3) {
                        paint4.setAlpha((int) ((1.0f - this.e) * this.f27935f));
                    } else {
                        paint4.setAlpha(this.f27935f);
                    }
                ...
                if (this.d) {
                    ...
                    long j10 = currentTimeMillis2 - this.f27934c;
                    this.f27934c = currentTimeMillis2;
                    if (j10 > 50) {
                        j10 = 50;
                    }
