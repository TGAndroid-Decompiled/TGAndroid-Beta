        ...
        switch (this.f28023a) {
            case 0:
                if (this.f28026f != i10) {
                    ...
                    this.f28027g.setColor(i10);
                }
                this.f28026f = i10;
                return;
            default:
                Paint paint = this.f28027g;
                if (paint != null) {
                    paint.setColor(i10);
                    return;
                }
    ...
    public final void draw(Canvas canvas) {
        ...
        switch (this.f28023a) {
            case 0:
                ...
                if (paint2 == null) {
                    paint2 = org.telegram.ui.ActionBar.j6.f19087c2;
                }
                ...
                if (this.f28024b) {
                    ...
                    long j3 = currentTimeMillis - this.f28025c;
                    this.f28025c = currentTimeMillis;
                    if (j3 > 50) {
                        j3 = 50;
                    }
            ...
            default:
                ...
                Paint paint3 = this.f28027g;
                if (paint3 == null) {
                    paint3 = org.telegram.ui.ActionBar.j6.f19105d2;
                }
                Paint paint4 = paint3;
                float f12 = 2.0f;
                ...
                for (int i12 = 0; i12 < 4; i12++) {
                    if (i12 == 0) {
                        paint4.setAlpha((int) (this.f28026f * this.e));
                    } else if (i12 == 3) {
                        paint4.setAlpha((int) ((1.0f - this.e) * this.f28026f));
                    } else {
                        paint4.setAlpha(this.f28026f);
                    }
                ...
                if (this.d) {
                    ...
                    long j10 = currentTimeMillis2 - this.f28025c;
                    this.f28025c = currentTimeMillis2;
                    if (j10 > 50) {
                        j10 = 50;
                    }
