        ...
        switch (this.f23979l0) {
            case 0:
                ...
                if (!messageObject.isVoice() && !messageObject.isRoundVideo()) {
                    ...
                    return MediaController.getInstance().setPlaylist(fu0Var.d, messageObject, fu0Var.v.f25502c1);
                }
            ...
            default:
                ...
                int i10 = wu0Var.d;
                jv0 jv0Var = wu0Var.f30173f;
                if (!messageObject.isVoice() && !messageObject.isRoundVideo()) {
                    if (!messageObject.isMusic()) {
                        return false;
                    }
                    return MediaController.getInstance().setPlaylist(jv0Var.f25539t1[i10].f30682a, messageObject, jv0Var.f25502c1);
                }
                boolean playMessage2 = MediaController.getInstance().playMessage(messageObject);
                MediaController mediaController2 = MediaController.getInstance();
                if (playMessage2) {
                    arrayList2 = jv0Var.f25539t1[i10].f30682a;
                } else {
                    arrayList2 = null;
                }
