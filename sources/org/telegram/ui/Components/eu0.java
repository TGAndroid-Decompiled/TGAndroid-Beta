...
public final class eu0 implements org.telegram.ui.Cells.k1 {
    ...
    public final org.telegram.ui.ActionBar.f6 f23672b;
    public final gu0 f23673c;
    ...
    public final void P0(int i10, org.telegram.ui.Cells.t1 t1Var) {
        if (i10 == 80) {
            org.telegram.ui.ActionBar.o2 o2Var = this.f23673c.f24402s.f30656v1;
    ...
    public final void j(org.telegram.ui.Cells.t1 t1Var, ArrayList arrayList, int i10, int i11, int i12) {
        SendMessagesHelper.getInstance(this.f23671a).sendVote(t1Var.getMessageObject(), arrayList, null);
    }
    ...
    public final void n(org.telegram.ui.Cells.t1 t1Var, TLRPC.PollAnswer pollAnswer, TLRPC.MessageMedia messageMedia, int i10) {
        ...
        zu0 zu0Var = this.f23673c.f24402s;
        MessageObject messageObject = t1Var.getMessageObject();
        TLRPC.MessageMedia media = MessageObject.getMedia(messageObject);
        if (messageMedia != null && messageObject != null && (media instanceof TLRPC.TL_messageMediaPoll)) {
            TLRPC.TL_messageMediaPoll tL_messageMediaPoll = (TLRPC.TL_messageMediaPoll) media;
            TLRPC.GeoPoint geoPoint = messageMedia.geo;
            org.telegram.ui.ActionBar.f6 f6Var = this.f23672b;
            int i14 = this.f23671a;
            if (geoPoint != null) {
                if (AndroidUtilities.isMapsInstalled(zu0Var.f30656v1)) {
                    org.telegram.ui.kd0 kd0Var = new org.telegram.ui.kd0(3);
                    kd0Var.setResourceProvider(f6Var);
                    TLRPC.TL_message tL_message = new TLRPC.TL_message();
                    tL_message.local_id = -1;
                    tL_message.peer_id = MessagesController.getInstance(i14).getPeer(zu0Var.f30631j1);
                    ...
                    zu0Var.f30656v1.presentFragment(kd0Var);
                }
            } else if (MessageObject.isAnyKindOfStickerOrEmoji(messageMedia.document)) {
                org.telegram.ui.ut.q().w(zu0Var.f30656v1.getParentActivity());
                ...
                q6.t(document4, null, "", null, null, i13, false, t1Var.getMessageObject(), this.f23672b, 200);
            } else {
                ...
                if (i11 > -1 && !arrayList2.isEmpty()) {
                    ...
                    PhotoViewer.t1().K2(null, zu0Var.f30656v1, f6Var);
                    PhotoViewer.t1().a2(arrayList2, i11, zu0Var.f30631j1, 0L, 0L, new du0(this));
                }
            }
        }
    }
