...
public abstract class lg extends bu {
    ...
    public final void n(File file, ArrayList arrayList) {
        ...
        if (boVar != null && boVar.getParentActivity() != null) {
            ...
            if (chatActivityEnterView.f21884y2) {
    ...
    public final InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        try {
            ...
            if (!z10 && !chatActivityEnterView.f21815l5) {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!chatActivityEnterView.D3 && chatActivityEnterView.A3 == null) {
            if (!chatActivityEnterView.f21886z0 && !chatActivityEnterView.s0()) {
                if (this.f25902c == null) {
                    dd ddVar = new dd(this);
                    this.f25902c = ddVar;
                    ddVar.h = new Runnable(this) {
                        public final lg f25271b;
                        ...
                        public final void run() {
                            ...
                            switch (i11) {
                                ...
                                default:
                                    ...
                                    chatActivityEnterView3.f21809k3 = false;
                ...
                ddVar2.f23320i = false;
                ddVar2.f23317c = 0;
                ddVar2.a(rectF);
                return this.f25902c.b(motionEvent);
