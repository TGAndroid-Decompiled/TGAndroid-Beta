...
public final class he0 extends NestedScrollView {
    public View W;
    public final pe0 f24685a0;

    public he0(pe0 pe0Var, Activity activity) {
        super(activity);
        this.f24685a0 = pe0Var;
    }

    @Override
    public final int f(Rect rect) {
        if (this.W != null && this.f24685a0.d.getTop() == getPaddingTop()) {
            int f7 = super.f(rect);
            ...
            if (currentActionBarHeight > 0) {
                return org.telegram.messenger.vl.w(10.0f, currentActionBarHeight, f7);
            }
            return f7;
        }
        return 0;
