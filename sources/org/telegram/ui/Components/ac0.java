...
public final class ac0 extends Drawable {
    ...
    public void b(int i10, int i11) {
        ((Paint) this.f22641c).setShader(new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.dp(28.0f), new int[]{i10, i11}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP));
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        switch (this.f22639a) {
            ...
            default:
                ...
                canvas.drawRoundRect(rectF, dp, dp, (Paint) this.f22641c);
                if (this.f22640b) {
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        switch (this.f22639a) {
            case 0:
                ((ij0) this.f22641c).setColorFilter(colorFilter);
