...
public final class vz extends DispatchQueue {
    ...
    public boolean Z;
    public final SurfaceTexture f32050a;
    public long f32051a0;
    public EGL10 f32052b;
    public final kv f32053b0;
    public EGLDisplay f32054c;
    public boolean f32055c0;
    public EGLContext d;
    public final Runnable f32056d0;
    public EGLSurface f32057e;
    public boolean f32058f;
    public final boolean h;
    public volatile int f32059n;
    public volatile int f32060r;
    public Bitmap f32061s;
    public final int v;
    public SurfaceTexture f32062w;
    public boolean f32063x;
    public final float[] f32064y;

    public vz(SurfaceTexture surfaceTexture, Bitmap bitmap, int i10, boolean z10, boolean z11, ja jaVar, int i11, int i12) {
        super("PhotoFilterGLThread", false);
        this.f32064y = new float[16];
        this.E = new int[1];
        this.f32056d0 = new sz(this, 1);
        this.f32050a = surfaceTexture;
        this.f32059n = i11;
        this.f32060r = i12;
        this.f32061s = bitmap;
        this.v = i10;
    ...
    public static void b(vz vzVar) {
        ...
        if (vzVar.f32058f) {
            vzVar.c();
            if (vzVar.f32063x) {
                vzVar.f32062w.updateTexImage();
                vzVar.f32062w.getTransformMatrix(vzVar.f32064y);
                vzVar.g();
                vzVar.f32063x = false;
                zz zzVar = vzVar.J;
                zzVar.P0 = vzVar.f32064y;
                zzVar.W0 = false;
                vzVar.F = true;
            }
            if (vzVar.Z) {
                if (vzVar.h && ((yzVar = vzVar.J.f33320f1) == null || yzVar.b())) {
                    GLES20.glViewport(0, 0, vzVar.f32059n, vzVar.f32060r);
                    ...
                    if (floatBuffer == null) {
                        floatBuffer = vzVar.J.f33306a1;
                    }
                    GLES20.glVertexAttribPointer(i10, 2, 5126, false, 8, (Buffer) floatBuffer);
                    GLES20.glEnableVertexAttribArray(vzVar.P);
                    GLES20.glVertexAttribPointer(vzVar.P, 2, 5126, false, 8, (Buffer) vzVar.J.f33309b1);
                    GLES20.glUniformMatrix4fv(vzVar.Q, 1, false, vzVar.f32064y, 0);
                    GLES20.glDrawArrays(5, 0, 4);
                    vzVar.f32052b.eglSwapBuffers(vzVar.f32054c, vzVar.f32057e);
                    pa paVar = vzVar.I;
                    if (paVar != null) {
                        paVar.a(vzVar.f32064y, vzVar.E[0], vzVar.W, vzVar.X);
                        return;
                    }
                    return;
                }
                if (vzVar.f32053b0 == null || vzVar.F) {
                    GLES20.glViewport(0, 0, vzVar.U, vzVar.V);
                    vzVar.J.f();
                    vzVar.J.d();
                    if (vzVar.f32053b0 == null) {
                        vzVar.J.e();
                    }
                    vzVar.J.c();
                    vzVar.T = vzVar.J.b();
    ...
    public final void c() {
        if (!this.d.equals(this.f32052b.eglGetCurrentContext()) || !this.f32057e.equals(this.f32052b.eglGetCurrentSurface(12377))) {
            EGL10 egl10 = this.f32052b;
            EGLDisplay eGLDisplay = this.f32054c;
            EGLSurface eGLSurface = this.f32057e;
            if (!egl10.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, this.d) && BuildVars.LOGS_ENABLED) {
                org.telegram.messenger.wl.s(this.f32052b, new StringBuilder("eglMakeCurrent failed "));
            }
        }
    }
    ...
    public final void finish() {
        ...
        if (this.f32057e != null) {
            ...
            this.f32052b.eglDestroySurface(this.f32054c, this.f32057e);
            this.f32057e = null;
        }
        ...
        if (eGLContext != null) {
            ja jaVar = this.H;
            if (jaVar != null) {
                synchronized (jaVar.f27438f) {
                    try {
                        if (jaVar.f27439g == eGLContext) {
                            jaVar.f27439g = null;
                        }
                    } finally {
                    }
            ...
            this.f32052b.eglDestroyContext(this.f32054c, this.d);
            this.d = null;
        }
        EGLDisplay eGLDisplay2 = this.f32054c;
        if (eGLDisplay2 != null) {
            this.f32052b.eglTerminate(eGLDisplay2);
            this.f32054c = null;
        }
        SurfaceTexture surfaceTexture = this.f32050a;
    ...
    public final void g() {
        ...
        if (!this.Z && (i10 = this.W) > 0 && (i11 = this.X) > 0) {
            this.J.i(this.f32061s, this.v, this.E[0], i10, i11);
            this.Z = true;
            zz zzVar = this.J;
            this.U = zzVar.X0;
            this.V = zzVar.Y0;
    ...
    public final void run() {
        ...
        this.f32054c = eglGetDisplay;
        boolean z10 = false;
        if (eglGetDisplay == EGL10.EGL_NO_DISPLAY) {
            if (BuildVars.LOGS_ENABLED) {
                org.telegram.messenger.wl.s(this.f32052b, new StringBuilder("eglGetDisplay failed "));
            }
            finish();
        } else if (!this.f32052b.eglInitialize(eglGetDisplay, new int[2])) {
            if (BuildVars.LOGS_ENABLED) {
                org.telegram.messenger.wl.s(this.f32052b, new StringBuilder("eglInitialize failed "));
            }
            finish();
        } else {
            int[] iArr = new int[1];
            EGLConfig[] eGLConfigArr = new EGLConfig[1];
            if (!this.f32052b.eglChooseConfig(this.f32054c, new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 0, 12326, 0, 12344}, eGLConfigArr, 1, iArr)) {
                if (BuildVars.LOGS_ENABLED) {
                    org.telegram.messenger.wl.s(this.f32052b, new StringBuilder("eglChooseConfig failed "));
                }
                finish();
            } else if (iArr[0] > 0) {
                ...
                EGLContext eglCreateContext = this.f32052b.eglCreateContext(this.f32054c, eGLConfig, eGLContext, iArr2);
                this.d = eglCreateContext;
                if (eglCreateContext == null) {
                    if (BuildVars.LOGS_ENABLED) {
                        org.telegram.messenger.wl.s(this.f32052b, new StringBuilder("eglCreateContext failed "));
                    }
                    finish();
                } else {
                    ja jaVar2 = this.H;
                    ...
                    SurfaceTexture surfaceTexture = this.f32050a;
                    if (surfaceTexture != null) {
                        EGLSurface eglCreateWindowSurface = this.f32052b.eglCreateWindowSurface(this.f32054c, eGLConfig, surfaceTexture, null);
                        this.f32057e = eglCreateWindowSurface;
                        if (eglCreateWindowSurface != null && eglCreateWindowSurface != EGL10.EGL_NO_SURFACE) {
                            if (!this.f32052b.eglMakeCurrent(this.f32054c, eglCreateWindowSurface, eglCreateWindowSurface, this.d)) {
                                if (BuildVars.LOGS_ENABLED) {
                                    org.telegram.messenger.wl.s(this.f32052b, new StringBuilder("eglMakeCurrent failed "));
                                }
                                finish();
                                ...
                                if (h != 0 && h10 != 0) {
                                    ...
                                    if (h(null)) {
                                        Bitmap bitmap = this.f32061s;
                                        if (bitmap != null) {
                                            i10 = bitmap.getWidth();
                                            i11 = this.f32061s.getHeight();
                                        } else {
                                            i10 = this.W;
                                            i11 = this.X;
                                        }
                                        int i12 = i10;
                                        int i13 = i11;
                                        if (this.f32053b0 != null) {
                                            GLES20.glGenTextures(1, this.E, 0);
                                            Matrix.setIdentityM(this.f32064y, 0);
                                            SurfaceTexture surfaceTexture2 = new SurfaceTexture(this.E[0]);
                                            this.f32062w = surfaceTexture2;
                                        ...
                                        if (this.G && (paVar = this.I) != null && !paVar.b(this.f32059n / this.f32060r, this.H.f27434a)) {
                                        ...
                                        if (!this.J.a()) {
                                            ...
                                            if (i12 != 0 && i13 != 0) {
                                                this.J.i(this.f32061s, this.v, this.E[0], i12, i13);
                                                this.Z = true;
                                                zz zzVar = this.J;
                                                this.U = zzVar.X0;
                                                this.V = zzVar.Y0;
                            ...
                            if (BuildVars.LOGS_ENABLED) {
                                org.telegram.messenger.wl.s(this.f32052b, new StringBuilder("createWindowSurface failed "));
                            }
                            finish();
                        }
                    } else {
