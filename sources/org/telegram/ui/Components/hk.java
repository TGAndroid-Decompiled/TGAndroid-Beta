...
public final class hk extends kl0 {
    ...
    public final ArrayList f26741e = new ArrayList();
    public final Context f26742f;
    public final ok h;

    public hk(ok okVar, Context context) {
        this.h = okVar;
        this.f26742f = context;
    }
    ...
    public final ik E(int i10) {
        ...
        if (this.d.isEmpty()) {
            ArrayList arrayList2 = this.f26741e;
    ...
    @Override
    public final int h() {
        int size = this.f26740c.size();
        if (this.d.isEmpty()) {
            ArrayList arrayList = this.f26741e;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 != 0) {
            ...
            int i12 = E.f27151a;
            if (i12 != 0) {
                String str = E.f27152b;
                String str2 = E.f27153c;
                if (i10 != this.f26740c.size() - 1) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                ...
                j7Var.d(E.f27152b, E.f27153c, E.d.toUpperCase().substring(0, Math.min(E.d.length(), 4)), E.f27154e, 0, false);
            }
            File file = E.f27155f;
            if (file != null) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        View l4Var;
        View view;
        org.telegram.ui.ActionBar.f6 f6Var = this.h.f28752a;
        Context context = this.f26742f;
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 != 2) {
