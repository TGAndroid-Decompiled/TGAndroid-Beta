...
public final class k90 extends View {
    ...
    public k90(Context context) {
        ...
        this.d = new Rect();
        this.f25563c = LocaleController.getString(R.string.LoginOrSingInWithGoogle);
        textPaint.setTextSize(AndroidUtilities.dp(14.0f));
        a();
    }

    public final void a() {
        this.f25561a.setColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19170y6, false));
        this.f25562b.setColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.Ii, false));
        invalidate();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawText(this.f25563c, (getWidth() - rect.width()) / 2.0f, (rect.height() + height) / 2.0f, this.f25561a);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f25561a.getTextBounds(str, 0, str.length(), this.d);
    }
