...
public final class k90 {
    public View f25695a;
    public org.telegram.ui.Cells.b1 f25696b;
    public final ArrayList f25697c = new ArrayList();
    public int d = 0;
    public final ArrayList e = new ArrayList();
    public int f25698f = 0;
    ...
    public final void a(o90 o90Var, Object obj) {
        this.f25697c.add(new Pair(o90Var, obj));
        this.d++;
        h(obj, true);
    }
    ...
    public final void d(boolean z10) {
        if (z10) {
            ...
            while (true) {
                int i12 = this.d;
                ArrayList arrayList = this.f25697c;
                if (i11 < i12) {
    ...
    public final void e() {
        for (int i10 = 0; i10 < this.f25698f; i10++) {
            m(i10, true);
        }
    }
    ...
    public final boolean f(Canvas canvas) {
        int i10 = 0;
        boolean z10 = false;
        while (i10 < this.f25698f) {
            ((r90) ((Pair) this.e.get(i10)).first).draw(canvas);
            i10++;
            z10 = true;
        }
        for (int i11 = 0; i11 < this.d; i11++) {
            if (!((o90) ((Pair) this.f25697c.get(i11)).first).a(canvas) && !z10) {
                z10 = false;
            } else {
                z10 = true;
            }
    ...
    public final boolean g(Canvas canvas, Object obj) {
        ...
        for (int i11 = 0; i11 < this.d; i11++) {
            ArrayList arrayList2 = this.f25697c;
    ...
    public final void h(Object obj, boolean z10) {
        ...
        if (obj instanceof View) {
            ...
            if (!b3Var.f32287c && (view2 = b3Var.f32286b) != null) {
                view2.invalidate();
            }
        } else if (z10 && (view = this.f25695a) != null) {
            view.invalidate();
        }
        org.telegram.ui.Cells.b1 b1Var = this.f25696b;
        if (b1Var != null) {
            b1Var.run();
        }
    }
    ...
    public final void j(int i10) {
        if (i10 >= 0 && i10 < this.d) {
            Pair pair = (Pair) this.f25697c.get(i10);
            o90 o90Var = (o90) pair.first;
            if (o90Var.f26974p < 0) {
                o90Var.f26974p = Math.max(o90Var.f26973o + o90Var.f26975q, SystemClock.elapsedRealtime());
                h(pair.second, true);
                AndroidUtilities.runOnUIThread(new j90(this, o90Var, 1), Math.max(0L, (o90Var.f26974p - SystemClock.elapsedRealtime()) + 175));
            }
        }
    }
            ...
            if (pair != null) {
                if (z10) {
                    if (o90Var.f26974p < 0) {
                        o90Var.f26974p = Math.max(o90Var.f26973o + o90Var.f26975q, SystemClock.elapsedRealtime());
                        h(pair.second, true);
                        AndroidUtilities.runOnUIThread(new j90(this, o90Var, 0), Math.max(0L, (o90Var.f26974p - SystemClock.elapsedRealtime()) + 175));
                        return;
                    }
                    return;
                }
            ...
            if (pair != null) {
                ...
                if (z10) {
                    if (!r90Var.b()) {
                        ...
                        cv cvVar = new cv(20, this, r90Var);
                        long j3 = 0;
                        if (r90Var.f27905c > 0) {
                            j3 = 320 - (SystemClock.elapsedRealtime() - r90Var.f27905c);
                        }
