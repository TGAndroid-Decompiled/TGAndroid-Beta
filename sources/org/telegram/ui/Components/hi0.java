...
public final class hi0 extends Button {
    public final RectF f24672a;
    public final Paint f24673b;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Paint paint = this.f24673b;
        paint.setAlpha(min);
        canvas.drawArc(rectF, this.f24675f, 220.0f, false, paint);
        long currentTimeMillis = System.currentTimeMillis();
        if (Math.abs(this.e - System.currentTimeMillis()) < 1000) {
            long j3 = currentTimeMillis - this.e;
            int i10 = (int) (this.f24675f + (((float) (360 * j3)) / 2000.0f));
            this.f24675f = i10 - ((i10 / 360) * 360);
            if (this.f24674c) {
                float f7 = this.d;
                if (f7 < 1.0f) {
