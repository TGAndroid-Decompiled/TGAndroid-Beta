...
public final class hi0 extends View {
    ...
    public float K;
    public float L;
    public final org.telegram.ui.ActionBar.d6 f24800a;
    public final PorterDuffColorFilter f24801b;
    public final PorterDuffColorFilter f24802c;
    public u01 d;
    public u01 e;
    public final Paint f24803f;
    public final Paint h;
    public final Path f24804n;
    public final Drawable f24805r;
    public final RectF f24806s;
    public final Paint v;
    public final Paint f24807w;
    public final Path f24808x;
    public final yc f24809y;

    public hi0(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.f24801b = new PorterDuffColorFilter(-1, mode);
        this.f24802c = new PorterDuffColorFilter(-16777216, mode);
        this.f24803f = new Paint();
        Paint paint = new Paint();
        this.h = paint;
        Path path = new Path();
        this.f24804n = path;
        this.f24806s = new RectF();
        this.v = new Paint(1);
        this.f24807w = new Paint(1);
        this.f24808x = new Path();
        this.f24809y = new yc(this);
        this.E = -1;
        this.f24800a = d6Var;
        this.f24805r = context.getResources().getDrawable(R.drawable.files_music).mutate();
    ...
    public final void a() {
        ...
        this.E = i10;
        if (z10) {
            porterDuffColorFilter = this.f24802c;
        } else {
            porterDuffColorFilter = this.f24801b;
        }
        this.f24805r.setColorFilter(porterDuffColorFilter);
        this.f24803f.setColor(this.E);
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        RectF rectF = this.f24806s;
        yc ycVar = this.f24809y;
        if (action == 0) {
    ...
    public final void onDraw(Canvas canvas) {
        if (this.d != null && this.e != null) {
            ...
            float a2 = this.f24809y.a(0.02f);
            if (clamp01 > 0.0f) {
                int width = getWidth() - (AndroidUtilities.dp(12.0f) * 2);
                this.d.f28659p = (width - AndroidUtilities.dp(35.0f)) / 2.0f;
                this.e.f28659p = (width - this.d.l()) - AndroidUtilities.dp(35.0f);
                ...
                int i12 = i10 - i11;
                int i13 = i10 + i11;
                Drawable drawable = this.f24805r;
                ...
                canvas.drawPath(this.f24804n, paint3);
                canvas.restore();
                canvas.restore();
            }
        }
    ...
    public void setColor(MessagesController.PeerColor peerColor) {
        int bgColor1;
        int bgColor2;
        org.telegram.ui.ActionBar.d6 d6Var = this.f24800a;
        if (peerColor == null) {
