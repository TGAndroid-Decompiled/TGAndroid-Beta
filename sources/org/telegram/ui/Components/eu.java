...
public abstract class eu extends EditText {
    ...
    public static void a(eu euVar) {
        ...
        if (!euVar.spoilers.isEmpty()) {
            euVar.spoilers.get(0).f44697q = new du(euVar, 3);
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (arrayList == null) {
            ...
            while (i10 < size) {
                ...
                if (zi0Var2.b() && zi0Var2.f30905g.contains(motionEvent.getX(), motionEvent.getY() - paddingTop)) {
                    z11 = true;
                } else {
                    z11 = false;
                }
    ...
    public void invalidateSpoilers() {
        ...
        if (layout != null && (layout.getText() instanceof Spannable)) {
            ...
            if (this.drawAnimatedEmojiDrawables && (v5Var = this.animatedEmojiDrawables) != null) {
                ArrayList arrayList3 = v5Var.f29004a;
