...
public final class ek0 extends FrameLayout {
    ...
    public boolean O;
    public final gk0 P;
    public final dk0 f23580a;
    public final dk0 f23581b;
    public final dk0 f23582c;
    public final ImageReceiver d;
    public zg.p0 e;
    public rg.b1 f23583f;
    public float h;
    ...
    public ek0(gk0 gk0Var, Context context) {
        ...
        dk0Var2.f28301a.setAutoRepeat(0);
        dk0Var2.f28301a.setAllowStartAnimation(false);
        dk0Var2.f28301a.setAllowStartLottieAnimation(false);
    ...
    public static void a(ek0 ek0Var, zg.p0 p0Var, int i10) {
        ...
        boolean z11;
        int i11;
        dk0 dk0Var = ek0Var.f23582c;
        dk0 dk0Var2 = ek0Var.f23580a;
        dk0 dk0Var3 = ek0Var.f23581b;
        gk0 gk0Var = ek0Var.P;
        ...
        int i12 = gk0Var.J;
        org.telegram.ui.ActionBar.f6 f6Var = gk0Var.f24289k0;
        int i13 = gk0Var.M0;
        ...
        ek0Var.H = z10;
        if (z10 && ek0Var.f23583f == null) {
            rg.b1 b1Var = new rg.b1(ek0Var.getContext(), 1, null);
            ek0Var.f23583f = b1Var;
            b1Var.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
            ek0Var.f23583f.setImageReceiver(dk0Var3.getImageReceiver());
            ek0Var.addView(ek0Var.f23583f, w7.x5.d(18, 18.0f, 17, 8.0f, 8.0f, 0.0f, 0.0f));
        }
        rg.b1 b1Var2 = ek0Var.f23583f;
        if (b1Var2 != null) {
            if (ek0Var.H) {
                i11 = 0;
            } else {
        ...
        ek0Var.d();
        ek0Var.e = p0Var;
        if (!p0Var.f49147a && (p0Var.f49150f == null || ((!gk0Var.q() && !gk0Var.G0) || !LiteMode.isEnabled(8200)))) {
            z11 = false;
        } else {
            z11 = true;
        }
        ek0Var.f23585r = z11;
        if (i13 == 4 || ek0Var.e.f49148b) {
            ek0Var.f23585r = false;
        }
        zg.p0 p0Var3 = ek0Var.e;
        if (!p0Var3.f49147a && p0Var3.f49150f == null) {
            dk0Var.getImageReceiver().clearImage();
            dk0Var3.getImageReceiver().clearImage();
            o5 o5Var = new o5(4, gk0Var.J, ek0Var.e.f49151g);
            o5 o5Var2 = new o5(3, gk0Var.J, ek0Var.e.f49151g);
            if (i13 != 1 && i13 != 2 && i13 != 4) {
                int i14 = org.telegram.ui.ActionBar.j6.f19192v6;
    ...
    public final void b() {
        ...
        dk0 dk0Var = this.f23581b;
        o5 o5Var = dk0Var.e;
        if (o5Var != null) {
            imageReceiver = o5Var.f26636k;
        } else {
            imageReceiver = dk0Var.f28301a;
        }
        if (imageReceiver != null && imageReceiver.getLottieAnimation() != null) {
            gk0 gk0Var = this.P;
            if (gk0Var.f24306x0 == null && !this.N && gk0Var.G0) {
                if (imageReceiver.getLottieAnimation().f30221b0 <= 2) {
    ...
    public final void c(int i10) {
        ...
        if (this.f23585r) {
            if (this.f23580a.getImageReceiver().getLottieAnimation() != null && !this.f23580a.getImageReceiver().getLottieAnimation().y() && !this.f23584n) {
                this.f23584n = true;
                if (i10 == 0) {
                    this.E = false;
                    this.f23580a.getImageReceiver().getLottieAnimation().stop();
                    this.f23580a.getImageReceiver().getLottieAnimation().N(0, false, false);
                    this.G.run();
                    return;
                }
                this.E = true;
            ...
            if (this.f23580a.getImageReceiver().getLottieAnimation() != null && this.f23584n && !this.f23580a.getImageReceiver().getLottieAnimation().f30233l0 && !this.f23580a.getImageReceiver().getLottieAnimation().y()) {
                this.f23580a.getImageReceiver().getLottieAnimation().N(this.f23580a.getImageReceiver().getLottieAnimation().e[0] - 1, false, false);
            }
            dk0 dk0Var3 = this.f23581b;
            float f14 = this.I;
            if (this.f23587w) {
                f7 = 0.76f;
            } else {
            ...
            dk0 dk0Var4 = this.f23581b;
            float f15 = this.I;
            if (!this.f23587w) {
                f11 = 1.0f;
            }
            dk0Var4.setScaleX(f15 * f11);
        } else if (!this.f23584n) {
            this.I = 0.0f;
            this.f23581b.setScaleX(0.0f);
            this.f23581b.setScaleY(0.0f);
            ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
            this.J = ofFloat;
            ofFloat.addUpdateListener(new h70(this, 9));
            this.J.setDuration(150L);
            this.J.setInterpolator(qr.h);
            this.J.setStartDelay(i10 * this.P.f24271c);
            this.J.start();
            this.f23584n = true;
        }
    }
    ...
    public final void d() {
        float f7;
        float f10;
        boolean z10 = this.f23585r;
        gk0 gk0Var = this.P;
        float f11 = 1.0f;
        dk0 dk0Var = this.f23581b;
        if (z10) {
            AndroidUtilities.cancelRunOnUIThread(this.G);
            dk0 dk0Var2 = this.f23580a;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        zg.p0 p0Var2 = this.e;
        if (p0Var2 != null && p0Var2.f49147a && this.F != null && LiteMode.isEnabled(8200) && LiteMode.isEnabled(131072)) {
            ...
            yi0 lottieAnimation = this.f23580a.getImageReceiver().getLottieAnimation();
            yh.k8 k8Var = this.F;
            if (lottieAnimation != null && (i10 = lottieAnimation.f30221b0) > 30) {
                f7 = Utilities.clamp01((i10 - 30) / 30.0f);
            } else {
                f7 = 0.0f;
            }
            k8Var.f47407j = (int) (k8Var.f47402b.size() * f7);
            this.F.g(rectF);
            this.F.d();
    ...
    public final void e(zg.p0 p0Var) {
        ...
        } else if (i11 == 4 && p0Var != null && p0Var.f49150f != null) {
            dk0Var.getImageReceiver().setImageBitmap(Emoji.getEmojiDrawable(p0Var.f49150f));
            dk0Var2.getImageReceiver().setImageBitmap(Emoji.getEmojiDrawable(p0Var.f49150f));
        } else {
            zg.p0 p0Var2 = this.e;
            if (p0Var2.f49148b) {
                TLRPC.Document effectDocument = MessagesController.getInstance(gk0Var.J).getEffectDocument(this.e.f49151g);
                SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(effectDocument, org.telegram.ui.ActionBar.j6.f19027m6, 0.2f);
                ...
                TLRPC.TL_availableReaction tL_availableReaction2 = MediaDataController.getInstance(gk0Var.J).getReactionsMap().get(this.e.f49150f);
                if (tL_availableReaction2 != null) {
                    SvgHelper.SvgDrawable svgThumb2 = DocumentObject.getSvgThumb(tL_availableReaction2.activate_animation, org.telegram.ui.ActionBar.j6.f19027m6, 0.2f);
                    ...
                    this.f23582c.getImageReceiver().setImage(ImageLocation.getForDocument(tL_availableReaction.select_animation), "60_60_pcache", null, null, svgThumb2, 0L, "tgs", p0Var, 0);
    ...
    public final void f(zg.p0 p0Var, boolean z10) {
        ...
        float f13;
        float f14;
        boolean z11 = this.f23587w;
        boolean contains = this.P.f24274d0.contains(p0Var);
        this.f23587w = contains;
        if (contains != z11) {
            dk0 dk0Var = this.f23580a;
            dk0 dk0Var2 = this.f23581b;
            float f15 = 1.0f;
        ...
        if (this.O) {
            ...
            if (gk0Var.Q == null) {
                ...
                if (action == 0) {
                    ...
                    if (this.h == 1.0f && !this.H && (i10 = gk0Var.M0) != 3 && i10 != 4 && i10 != 5 && ((fk0Var = gk0Var.f24281g0) == null || fk0Var.j())) {
                ...
                if (motionEvent.getAction() == 1 && this.N && ((gk0Var.f24290l0 == null || gk0Var.f24292n0 > 0.8f) && gk0Var.f24281g0 != null)) {
                    gk0Var.f24297r0 = true;
                    if (System.currentTimeMillis() - gk0Var.f24299s0 > 300) {
                        gk0Var.f24299s0 = System.currentTimeMillis();
                        fk0 fk0Var2 = gk0Var.f24281g0;
                        zg.p0 p0Var = this.e;
                        if (gk0Var.f24292n0 > 0.8f) {
                            z10 = true;
                        } else {
                            z10 = false;
                        }
                ...
                if (!gk0Var.f24297r0 && gk0Var.f24290l0 != null) {
                    gk0Var.f24293o0 = 0.0f;
                    float f7 = gk0Var.f24292n0;
                    ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                    gk0Var.Q = ofFloat;
                    ofFloat.addUpdateListener(new uj0(gk0Var, f7));
                    gk0Var.Q.addListener(new ci.v5(gk0Var, 2));
                    gk0Var.Q.setDuration(150L);
                    gk0Var.Q.setInterpolator(qr.f27380f);
                    gk0Var.Q.start();
                }
