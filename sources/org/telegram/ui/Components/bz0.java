...
public final class bz0 {
    public final org.telegram.ui.ActionBar.e6 f23126a;
    public StaticLayout f23127b;
    public final ArrayList f23128c = new ArrayList(2);
    public int d;
    public int e;
    public int f23129f;
    public int f23130g;
    ...
    public final void b(MessageObject messageObject) {
        ...
        org.telegram.ui.ActionBar.e6 e6Var = this.f23126a;
        if (e6Var != null) {
            paint = e6Var.G("paintChatActionText3");
        }
        if (paint == null) {
            paint = org.telegram.ui.ActionBar.j6.S0("paintChatActionText3");
        }
        TextPaint textPaint = (TextPaint) paint;
        this.f23130g = AndroidUtilities.dp(14.0f) * 2;
        ...
        while (i16 < size) {
            ...
            i16++;
            az0 az0Var = (az0) obj;
            f10 = Math.max(f10, az0Var.f22759a.l());
            f11 = Math.max(f11, az0Var.f22760b.l());
            int j3 = ((int) az0Var.f22759a.j()) + this.f23130g;
            this.f23130g = j3;
            this.f23130g = AndroidUtilities.dp(7.0f) + j3;
        }
        ...
        this.f23127b = new StaticLayout(AndroidUtilities.replaceTags(spannableStringBuilder), textPaint, max, Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
        int i30 = 0;
        for (int i31 = 0; i31 < this.f23127b.getLineCount(); i31++) {
            i30 = (int) Math.max(i30, this.f23127b.getLineWidth(i31));
        }
        int height = this.f23127b.getHeight() + this.f23130g;
        this.f23130g = height;
        this.f23130g = AndroidUtilities.dp(5.0f) + height;
        int c11 = org.telegram.messenger.wh.c(24.0f, 2, Math.max(dp, i30));
        this.h = c11;
        this.d = (c11 - max) / 2;
        this.e = (c11 - dp) / 2;
        this.f23129f = (int) (AndroidUtilities.dp(f7) + i15 + f10);
    }
}
