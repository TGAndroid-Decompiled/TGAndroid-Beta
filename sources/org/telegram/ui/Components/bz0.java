...
public final class bz0 extends Drawable {
    ...
    public final d6 f23082b;
    public final Drawable f23083c;
    public final Drawable d;
    public int e = 255;

    public bz0(org.telegram.ui.Cells.u1 u1Var) {
        this.f23082b = new d6(u1Var, 420L, qr.h);
        this.f23083c = u1Var.getContext().getResources().getDrawable(R.drawable.summary_arrow);
    ...
    public final void draw(Canvas canvas) {
        ...
        float e = this.f23082b.e(this.f23081a);
        ...
        Drawable drawable2 = this.f23083c;
    ...
    public final int getIntrinsicHeight() {
        return this.f23083c.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f23083c.getIntrinsicWidth();
    }
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f23083c.setColorFilter(colorFilter);
