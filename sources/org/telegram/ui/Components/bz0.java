...
public final class bz0 {
    public final org.telegram.ui.ActionBar.f6 f21921a;
    public StaticLayout f21922b;
    public final ArrayList f21923c = new ArrayList(2);
    public int d;
    public int e;
    public int f21924f;
    public int f21925g;
    ...
    public final void b(MessageObject messageObject) {
        ...
        org.telegram.ui.ActionBar.f6 f6Var = this.f21921a;
        if (f6Var != null) {
            paint = f6Var.F("paintChatActionText3");
        }
        if (paint == null) {
            paint = org.telegram.ui.ActionBar.j6.S0("paintChatActionText3");
        }
        TextPaint textPaint = (TextPaint) paint;
        this.f21925g = AndroidUtilities.dp(14.0f) * 2;
        ...
        while (i16 < size) {
            ...
            i16++;
            az0 az0Var = (az0) obj;
            f10 = Math.max(f10, az0Var.f21663a.l());
            f11 = Math.max(f11, az0Var.f21664b.l());
            int j3 = ((int) az0Var.f21663a.j()) + this.f21925g;
            this.f21925g = j3;
            this.f21925g = AndroidUtilities.dp(7.0f) + j3;
        }
        ...
        this.f21922b = new StaticLayout(AndroidUtilities.replaceTags(spannableStringBuilder), textPaint, max, Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
        int i30 = 0;
        for (int i31 = 0; i31 < this.f21922b.getLineCount(); i31++) {
            i30 = (int) Math.max(i30, this.f21922b.getLineWidth(i31));
        }
        int height = this.f21922b.getHeight() + this.f21925g;
        this.f21925g = height;
        this.f21925g = AndroidUtilities.dp(5.0f) + height;
        int D = org.telegram.messenger.a2.D(24.0f, 2, Math.max(dp, i30));
        this.h = D;
        this.d = (D - max) / 2;
        this.e = (D - dp) / 2;
        this.f21924f = (int) (AndroidUtilities.dp(f7) + i15 + f10);
    }
}
