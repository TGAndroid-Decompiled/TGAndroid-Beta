...
public final class bz0 extends Drawable {
    ...
    public final e6 f23154b;
    public final Drawable f23155c;
    public final Drawable d;
    public int e = 255;

    public bz0(org.telegram.ui.Cells.u1 u1Var) {
        this.f23154b = new e6(u1Var, 420L, sr.h);
        this.f23155c = u1Var.getContext().getResources().getDrawable(R.drawable.summary_arrow);
    ...
    public final void draw(Canvas canvas) {
        ...
        float e = this.f23154b.e(this.f23153a);
        ...
        Drawable drawable2 = this.f23155c;
    ...
    public final int getIntrinsicHeight() {
        return this.f23155c.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f23155c.getIntrinsicWidth();
    }
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f23155c.setColorFilter(colorFilter);
