...
public class tu0 extends uk0 {
    ...
    public final boolean E(ml0 ml0Var) {
        int i10;
        zu0 zu0Var = this.f28208f;
        if (!zu0Var.t0()) {
            if (this != zu0Var.H && zu0.u(zu0Var, this) == -1) {
                i10 = zu0Var.f30644q1;
            } else {
                i10 = zu0Var.f30635m1[0];
            }
    ...
    public String F(int i10) {
        ArrayList arrayList = this.f28208f.f30652t1[0].e;
    ...
    public int L(int i10) {
        return this.f28208f.f30652t1[0].f26858m + i10;
    }
    ...
    public int j(int i10) {
        ou0[] ou0VarArr = this.f28208f.f30652t1;
        if (!this.d && ou0VarArr[0].c().size() == 0) {
            ou0 ou0Var = ou0VarArr[0];
            if (!ou0Var.f26853g && ou0Var.f26857l) {
                return 2;
            }
        }
    ...
    @Override
    public int k() {
        return this.f28208f.f30652t1[0].e();
    }
    ...
    public s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0 && i10 != 19) {
            mt0 M = zu0.M(0, zu0Var.f30631j1, context, f6Var);
        ...
        org.telegram.ui.Cells.t7 t7Var = new org.telegram.ui.Cells.t7(context, this.e, zu0Var.f30656v1.getCurrentAccount());
        if (i10 == 19) {
            t7Var.f21410w0 = true;
        }
        t7Var.setGradientView(zu0Var.f30663y);
        if (zu0.u(zu0Var, this) != -1) {
            t7Var.f21387d0 = true;
        }
