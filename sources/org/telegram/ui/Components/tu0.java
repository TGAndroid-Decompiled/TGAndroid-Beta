...
public final class tu0 extends vl0 {
    ...
    public boolean h;
    public bu0 f28620s;
    public final jv0 f28622x;
    public final ArrayList e = new ArrayList();
    public final ArrayList f28617f = new ArrayList();
    public final wq0 f28618n = new wq0(this, 6);
    public final s4.u0 f28619r = new s4.u0();
    public final s4.y v = new s4.y(new ru0(this));
    public final HashSet f28621w = new HashSet();

    public tu0(jv0 jv0Var, Context context) {
        this.f28622x = jv0Var;
        this.f28616c = context;
        SavedMessagesController savedMessagesController = jv0Var.f25559v1.getMessagesController().getSavedMessagesController();
    ...
    public final void E(View view) {
        ...
        if (view instanceof org.telegram.ui.Cells.s2) {
            ...
            HashSet hashSet = this.f28621w;
            boolean contains = hashSet.contains(valueOf);
            jv0 jv0Var = this.f28622x;
            if (contains) {
                ...
                if (hashSet.size() > 0 && !jv0Var.C1) {
                    jv0Var.b1(true);
                    org.telegram.ui.ActionBar.u0 u0Var = jv0Var.f25556u0;
                    if (u0Var != null) {
                        u0Var.setVisibility(8);
                    }
                    org.telegram.ui.ActionBar.u0 u0Var2 = jv0Var.f25554t0;
                    if (u0Var2 != null) {
            ...
            org.telegram.ui.ActionBar.u0 u0Var3 = jv0Var.f25558v0;
            if (u0Var3 != null) {
                if (z10) {
                    i10 = 8;
                } else {
            ...
            org.telegram.ui.ActionBar.u0 u0Var4 = jv0Var.f25561w0;
            if (u0Var4 != null) {
                if (!z10) {
                    i11 = 8;
                }
    ...
    public final void F(boolean z10) {
        ...
        arrayList.clear();
        ArrayList arrayList2 = this.f28617f;
    ...
    @Override
    public final int h() {
        return this.f28617f.size();
    }

    @Override
    public final long i(int i10) {
        if (i10 >= 0) {
            ArrayList arrayList = this.f28617f;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        boolean z10 = true;
        s2Var.f21010s0 = true;
        s2Var.V(this.f28621w.contains(Long.valueOf(savedDialog.dialogId)), false);
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        su0 su0Var = new su0(this, this.f28616c);
        jv0 jv0Var = this.f28622x;
        su0Var.setDialogCellDelegate(jv0Var);
        su0Var.f21004r0 = true;
        su0Var.setBackgroundColor(jv0Var.h0(org.telegram.ui.ActionBar.h6.f19059d6));
