...
public final class g8 extends kl0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        if (this.f24248n.f24577v0 && c1Var.b() == 0) {
            return false;
        }
        return true;
    }
    ...
    public final void E(String str) {
        if (this.f24247f != null) {
            Utilities.searchQueue.cancelRunnable(this.f24247f);
            this.f24247f = null;
        }
        if (str == null) {
            this.e = null;
    ...
    public final int h() {
        int size;
        h8 h8Var = this.f24248n;
        boolean z10 = h8Var.f24577v0;
        if (h8Var.f24558f) {
            size = this.d.size();
        } else if (h8Var.f24581x0.size() > 1) {
            size = h8Var.f24581x0.size();
        } else {
            return 0;
        }
        return size + (z10 ? 1 : 0);
    ...
    public final int j(int i10) {
        if (this.f24248n.f24577v0 && i10 == 0) {
            return 1;
        }
        return 0;
    }
    ...
    public final void l() {
            ...
            if (z11) {
                ...
                s7Var.animate().translationY(0.0f).setUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        ...
                        switch (r2) {
                            case 0:
                                viewGroup = ((org.telegram.ui.ActionBar.f3) this.f23237b.f24248n).containerView;
                                viewGroup.invalidate();
                                return;
                            default:
                                viewGroup2 = ((org.telegram.ui.ActionBar.f3) this.f23237b.f24248n).containerView;
        ...
        h8Var.v.setVisibility((h8Var.h && h8Var.f24573s.h() == 0) ? 8 : 8);
        h8Var.E0();
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        e6Var = ((org.telegram.ui.ActionBar.f3) this.f24248n).resourcesProvider;
