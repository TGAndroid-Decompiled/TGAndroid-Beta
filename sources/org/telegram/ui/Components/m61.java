...
public class m61 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (!o61Var.S) {
            if (f7 != 1.0f) {
                org.telegram.ui.ActionBar.i6.f19124t0.setColor(o61Var.F);
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(12.0f) * f7, AndroidUtilities.dp(12.0f) * f7, org.telegram.ui.ActionBar.i6.f19124t0);
            }
            int dp4 = AndroidUtilities.dp(36.0f);
            rectF.set((getMeasuredWidth() - dp4) / 2, i29, (getMeasuredWidth() + dp4) / 2, AndroidUtilities.dp(4.0f) + i29);
            org.telegram.ui.ActionBar.i6.f19124t0.setColor(org.telegram.ui.ActionBar.i6.w0(null, o61Var.I, false));
        ...
        if (bool == null || bool.booleanValue() != z10) {
            if (AndroidUtilities.computePerceivedBrightness(o61Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18907h5)) > 0.721f) {
                z11 = true;
            } else {
                z11 = false;
            }
            if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.i6.v(o61Var.getThemedColor(org.telegram.ui.ActionBar.i6.f19113s8), 855638016)) > 0.721f) {
                z12 = true;
            }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (z10) {
            ...
            int i15 = o61Var.f26712y;
            if (i15 != 0) {
                float f7 = i15;
                this.f26109b = f7;
                setTranslationY(f7);
                ValueAnimator valueAnimator = this.f26108a;
                if (valueAnimator != null) {
                    valueAnimator.removeAllListeners();
                    this.f26108a.cancel();
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f26109b, 0.0f);
                this.f26108a = ofFloat;
                ofFloat.addUpdateListener(new f61(1, this));
                this.f26108a.setDuration(250L);
                this.f26108a.setInterpolator(org.telegram.ui.ActionBar.p1.f19480w);
                this.f26108a.addListener(new jd0(this, 28));
                this.f26108a.start();
            } else if (this.f26108a != null) {
                setTranslationY(this.f26109b);
            }
        } else {
