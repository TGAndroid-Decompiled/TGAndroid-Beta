...
public class m61 extends FrameLayout {
    public ValueAnimator f28395a;
    public float f28396b;
    public boolean f28397c;
    public Boolean d;
    public final o61 f28398e;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (!o61Var.S) {
            if (f7 != 1.0f) {
                org.telegram.ui.ActionBar.j6.f20949t0.setColor(o61Var.F);
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(12.0f) * f7, AndroidUtilities.dp(12.0f) * f7, org.telegram.ui.ActionBar.j6.f20949t0);
            }
            int dp4 = AndroidUtilities.dp(36.0f);
            rectF.set((getMeasuredWidth() - dp4) / 2, i29, (getMeasuredWidth() + dp4) / 2, AndroidUtilities.dp(4.0f) + i29);
            org.telegram.ui.ActionBar.j6.f20949t0.setColor(org.telegram.ui.ActionBar.j6.w0(null, o61Var.I, false));
        ...
        if (bool == null || bool.booleanValue() != z10) {
            if (AndroidUtilities.computePerceivedBrightness(o61Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20735h5)) > 0.721f) {
                z11 = true;
            } else {
                z11 = false;
            }
            if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v(o61Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20938s8), 855638016)) > 0.721f) {
                z12 = true;
            }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (z10) {
            ...
            int i15 = o61Var.f28985y;
            if (i15 != 0) {
                float f7 = i15;
                this.f28396b = f7;
                setTranslationY(f7);
                ValueAnimator valueAnimator = this.f28395a;
                if (valueAnimator != null) {
                    valueAnimator.removeAllListeners();
                    this.f28395a.cancel();
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f28396b, 0.0f);
                this.f28395a = ofFloat;
                ofFloat.addUpdateListener(new e61(1, this));
                this.f28395a.setDuration(250L);
                this.f28395a.setInterpolator(org.telegram.ui.ActionBar.p1.f21276w);
                this.f28395a.addListener(new k61(this, 1));
                this.f28395a.start();
            } else if (this.f28395a != null) {
                setTranslationY(this.f28396b);
            }
        } else {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (!this.f28398e.isDismissed() && super.onTouchEvent(motionEvent)) {
            return true;
        }
        return false;
    }
