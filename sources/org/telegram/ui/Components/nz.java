...
public class nz extends s4.s {
    ...
    public static iv0 C1(iv0 iv0Var) {
        ...
        if (iv0Var.f27272a == 0.0f) {
            iv0Var.f27272a = 100.0f;
        }
        if (iv0Var.f27273b == 0.0f) {
    ...
    public final void B1() {
        ...
        if (sparseIntArray.size() != A() || this.W != this.f45852m || this.T != this.J) {
            int i11 = this.f45852m;
            this.W = i11;
            float f10 = i11;
            if (f10 == 0.0f) {
                f10 = 100.0f;
            ...
            while (i15 < i13) {
                ...
                if (iv0Var == null) {
                    ...
                    i10 = dp;
                    min = Math.min(i12, (int) Math.floor((((iv0Var.f27272a / iv0Var.f27273b) * dp) / f10) * i12));
