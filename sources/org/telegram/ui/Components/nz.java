...
public final class nz extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.d6 f26835a;
    public final TextView f26836b;
    public final View f26837c;
    public final lj0 d;
    public boolean e;
    public int f26838f;
    ...
    public nz(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        this.f26837c = radialProgressView;
        ...
        textView.setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19043c7, d6Var));
    ...
    public final void b() {
        AndroidUtilities.updateViewVisibilityAnimated(this.f26836b, false, 0.9f, true);
        AndroidUtilities.updateViewVisibilityAnimated(this.f26837c, true, 1.0f, true);
    }

    public final void c() {
        AndroidUtilities.updateViewVisibilityAnimated(this.f26836b, true, 0.9f, true);
        AndroidUtilities.updateViewVisibilityAnimated(this.f26837c, false, 1.0f, true);
    }
    ...
    public void setTextColor(int i10) {
        this.f26836b.setTextColor(i10);
    }

    public void setTextSize(int i10) {
        this.f26836b.setTextSize(1, i10);
    }

    public void setTopImage(int i10) {
        TextView textView = this.f26836b;
        if (i10 == 0) {
        ...
        if (mutate != null) {
            mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19043c7, this.f26835a), PorterDuff.Mode.MULTIPLY));
        }
