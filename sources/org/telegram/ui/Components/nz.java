...
public class nz extends f2.w {
    ...
    public static jv0 C1(jv0 jv0Var) {
        ...
        if (jv0Var.f26052a == 0.0f) {
            jv0Var.f26052a = 100.0f;
        }
        if (jv0Var.f26053b == 0.0f) {
    ...
    public final void B1() {
        ...
        if (sparseIntArray.size() != A() || this.W != this.f5856m || this.T != this.J) {
            int i11 = this.f5856m;
            this.W = i11;
            float f11 = i11;
            if (f11 == 0.0f) {
            ...
            while (i15 < i13) {
                ...
                if (jv0Var == null) {
                    ...
                    i10 = dp;
                    min = Math.min(i12, (int) Math.floor((((jv0Var.f26052a / jv0Var.f26053b) * dp) / f11) * i12));
