...
public final class nz extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.d6 f26830a;
    public final TextView f26831b;
    ...
    public nz(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        this.f26832c = radialProgressView;
        ...
        textView.setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19028c7, d6Var));
    ...
    public final void b() {
        AndroidUtilities.updateViewVisibilityAnimated(this.f26831b, false, 0.9f, true);
        AndroidUtilities.updateViewVisibilityAnimated(this.f26832c, true, 1.0f, true);
    }

    public final void c() {
        AndroidUtilities.updateViewVisibilityAnimated(this.f26831b, true, 0.9f, true);
        AndroidUtilities.updateViewVisibilityAnimated(this.f26832c, false, 1.0f, true);
    }
    ...
    public void setText(String str) {
        this.f26831b.setText(str);
    }

    public void setTextColor(int i10) {
        this.f26831b.setTextColor(i10);
    }

    public void setTextSize(int i10) {
        this.f26831b.setTextSize(1, i10);
    }

    public void setTopImage(int i10) {
        TextView textView = this.f26831b;
        if (i10 == 0) {
        ...
        if (mutate != null) {
            mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19028c7, this.f26830a), PorterDuff.Mode.MULTIPLY));
        }
