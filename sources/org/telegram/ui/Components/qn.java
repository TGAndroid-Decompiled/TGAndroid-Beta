...
public final class qn extends org.telegram.ui.Cells.c6 {
    ...
    public final boolean d() {
        ...
        if (T != null) {
            int b10 = T.b();
            int i10 = tnVar.M;
            if (i10 == tnVar.J && b10 == (tnVar.f30684t0 + i10) - 1) {
                return false;
            }
        }
        return true;
    ...
    public final boolean f(org.telegram.ui.Cells.c6 c6Var) {
        ...
        if (T != null && (b10 = T.b()) != -1) {
            return tnVar.L[b10 - tnVar.f30684t0];
        }
        return false;
    }
    ...
    public final void g(org.telegram.ui.Cells.b6 b6Var, ActionMode actionMode) {
        tn tnVar = this.F.d;
        if (tnVar.f30675n && b6Var.isFocused() && b6Var.hasSelection()) {
            Menu menu = actionMode.getMenu();
            if (menu.findItem(16908321) != null) {
                org.telegram.ui.co.k8(menu, ((org.telegram.ui.co) tnVar.f28781b.f31307f0).h, false, true, true, true);
            }
        }
    }
    ...
    public final void h(org.telegram.ui.Cells.c6 c6Var, boolean z10) {
        ...
        int b10;
        tn tnVar = this.F.d;
        if (z10 && tnVar.f30656c0 && !tnVar.f30654b0) {
            Arrays.fill(tnVar.L, false);
            tnVar.f30682s.getChildCount();
            for (int i10 = tnVar.f30684t0; i10 < tnVar.f30684t0 + tnVar.M; i10++) {
                s4.c1 K = tnVar.f30682s.K(i10);
                if (K != null) {
                    View view = K.f45767a;
                    if (view instanceof org.telegram.ui.Cells.c6) {
                        ((org.telegram.ui.Cells.c6) view).f21716r.a(false, true);
                    }
                }
            }
        }
        ...
        if (T != null && (b10 = T.b()) != -1) {
            tnVar.L[b10 - tnVar.f30684t0] = z10;
        }
        tnVar.T();
    }
    ...
    public final void k(org.telegram.ui.Cells.b6 b6Var) {
        this.F.d.f28781b.t1(b6Var, true);
    }
    ...
    public final boolean l(ArrayList arrayList) {
        ...
        if (!arrayList.isEmpty()) {
            tnVar.f30682s.getClass();
            int R = RecyclerView.R(this) - tnVar.f30684t0;
            if (R >= 0) {
                ...
                tnVar.h0();
                tnVar.f30672k0 = (tnVar.f30684t0 + i10) - 1;
                tnVar.f30682s.setItemAnimator(tnVar.v);
                tnVar.f30680r.l();
                return true;
            }
        }
