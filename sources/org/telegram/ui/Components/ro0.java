...
public final class ro0 extends ll0 {
    public final org.telegram.ui.ActionBar.f6 f27660c;
    public final List d;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (j3 < 0) {
            ...
            if (chat != null) {
                if (tL_sendAsPeer.premium_required) {
                    ...
                    TextView textView = vo0Var.f28836b;
                    sb2.append((Object) TextUtils.ellipsize(str2, textView.getPaint(), this.f27661f - AndroidUtilities.dp(100.0f), TextUtils.TruncateAt.END));
                    sb2.append(" d");
                    ...
                    vo0Var.f28836b.setEllipsize(TextUtils.TruncateAt.END);
                    vo0Var.f28836b.setText(chat.title);
                }
                TextView textView2 = vo0Var.f28837c;
        ...
        if (user != null) {
            vo0Var.f28836b.setText(UserObject.getUserName(user));
            vo0Var.f28837c.setText(LocaleController.getString(R.string.VoipGroupPersonalAccount));
            vo0Var.f28835a.setAvatar(user);
        }
        gv0 gv0Var2 = vo0Var.f28835a;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        return new s4.c1(new vo0(viewGroup.getContext(), this.f27660c));
    }
}
