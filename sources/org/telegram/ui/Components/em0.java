...
public final class em0 extends Transition {
    ...
    public final void captureEndValues(TransitionValues transitionValues) {
        ...
        switch (this.f23690a) {
            ...
            case 1:
                ...
                vx0 vx0Var = (vx0) this.f23691b;
                viewGroup = ((org.telegram.ui.ActionBar.f3) vx0Var).containerView;
                map.put("offset", Integer.valueOf(viewGroup.getTop() + vx0Var.f29457e0));
                return;
            case 2:
                View view = transitionValues.view;
                PhotoViewer photoViewer = (PhotoViewer) this.f23691b;
            ...
            default:
                ...
                SecretMediaViewer secretMediaViewer = (SecretMediaViewer) this.f23691b;
                if (view2 == secretMediaViewer.Z) {
                    transitionValues.values.put("translationY", Integer.valueOf(secretMediaViewer.f31434a0.getPendingMarginTopDiff()));
                    return;
                }
                return;
        }
    ...
    public final void captureStartValues(TransitionValues transitionValues) {
        ...
        switch (this.f23690a) {
            ...
            case 2:
                View view = transitionValues.view;
                org.telegram.ui.bu0 bu0Var = ((PhotoViewer) this.f23691b).T1;
                if (view == bu0Var) {
            ...
            default:
                View view2 = transitionValues.view;
                org.telegram.ui.bu0 bu0Var2 = ((SecretMediaViewer) this.f23691b).f31434a0;
                if (view2 == bu0Var2) {
    ...
    public final Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        switch (i10) {
            ...
            default:
                ...
                if (transitionValues.view == secretMediaViewer.f31434a0) {
