...
public final class yj extends ni implements NotificationCenter.NotificationCenterDelegate, le.d {
    ...
    public pj J;
    public boolean K;
    public final le.b f30601n;
    public final FrameLayout f30602r;
    public final ai.w0 f30603s;
    public final hg.e0 v;
    public final HashMap f30604w;
    public final ArrayList f30605x;
    public boolean f30606y;

    public yj(Context context, org.telegram.ui.ActionBar.e6 e6Var, vi viVar) {
        super(context, e6Var, viVar);
        this.f30601n = new le.b(0, this, qr.h, 380L, false);
        this.f30604w = new HashMap();
        this.f30605x = new ArrayList();
        this.f30606y = false;
        this.F = new uj(this, context);
        ui uiVar = new ui(context, org.telegram.ui.ActionBar.j6.f19062d6, e6Var);
        this.H = uiVar;
        uiVar.setVisibility(4);
        FrameLayout frameLayout = new FrameLayout(context);
        this.f30602r = frameLayout;
        ...
        w0Var.setGlowColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.A5, this.f26687a));
        ...
        NotificationCenter.getInstance(this.f26688b.J1).addObserver(this, NotificationCenter.contactsDidLoad);
        N();
    }

    public int getCurrentTop() {
        ai.w0 w0Var = this.f30603s;
    ...
    public final boolean I(final int i10, final boolean z10, int i11, final boolean z11, final long j3) {
        HashMap hashMap = this.f30604w;
        int i12 = 0;
        if ((hashMap.size() == 0 && this.J == null) || this.f30606y) {
            return false;
        }
        this.f30606y = true;
        final ArrayList arrayList = new ArrayList(hashMap.size());
        ArrayList arrayList2 = this.f30605x;
    ...
    public final void L(xj xjVar, Object obj) {
        ...
        ArrayList arrayList = this.f30605x;
        int i10 = 1;
        if (containsKey) {
            hashMap.remove(a2);
            arrayList.remove(a2);
    ...
    public final void N() {
        boolean z10;
        int i10 = 0;
        if (this.f30603s.getAdapter().h() == 2) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final void O() {
        View childAt;
        mz mzVar = this.G;
        if (mzVar.getVisibility() != 0 || (childAt = this.f30603s.getChildAt(0)) == null) {
            return;
        }
    ...
    public int getCurrentItemTop() {
        ...
        this.f30602r.setTranslationY(top);
    ...
    public int getListTopPadding() {
        return this.f30603s.getPaddingTop();
    }
    ...
    public ArrayList<org.telegram.ui.ActionBar.l6> getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.G, 4, null, null, null, null, org.telegram.ui.ActionBar.j6.f19045c7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.G, 2048, null, null, null, null, org.telegram.ui.ActionBar.j6.f19134h6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(w0Var, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f19152i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(w0Var, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f19184k0, null, null, org.telegram.ui.ActionBar.j6.f19063d7));
        int i11 = org.telegram.ui.ActionBar.j6.f19300q5;
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(w0Var, 0, new Class[]{xj.class}, null, org.telegram.ui.ActionBar.j6.f19313r0, null, org.telegram.ui.ActionBar.j6.J7));
    ...
    @Override
    public final void m() {
        NotificationCenter.getInstance(this.f26688b.J1).removeObserver(this, NotificationCenter.contactsDidLoad);
    }
    ...
    public final void y(int i10, int i11) {
        ...
        this.f30603s.p1(0, i12 + AndroidUtilities.statusBarHeight, 0, this.e);
    }
