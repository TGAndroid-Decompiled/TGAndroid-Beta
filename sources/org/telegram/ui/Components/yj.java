...
public final class yj extends ni implements NotificationCenter.NotificationCenterDelegate, le.d {
    ...
    public pj J;
    public boolean K;
    public final le.b f32932n;
    public final FrameLayout f32933r;
    public final bi.o0 f32934s;
    public final ig.e0 v;
    public final HashMap f32935w;
    public final ArrayList f32936x;
    public boolean f32937y;

    public yj(Context context, org.telegram.ui.ActionBar.f6 f6Var, vi viVar) {
        super(context, f6Var, viVar);
        this.f32932n = new le.b(0, this, pr.h, 380L, false);
        this.f32935w = new HashMap();
        this.f32936x = new ArrayList();
        this.f32937y = false;
        this.F = new uj(this, context);
        ui uiVar = new ui(context, org.telegram.ui.ActionBar.j6.f20664d6, f6Var);
        this.H = uiVar;
        uiVar.setVisibility(4);
        FrameLayout frameLayout = new FrameLayout(context);
        this.f32933r = frameLayout;
        ...
        o0Var.setGlowColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.A5, this.f28753a));
        ...
        NotificationCenter.getInstance(this.f28754b.J1).addObserver(this, NotificationCenter.contactsDidLoad);
        N();
    }

    public int getCurrentTop() {
        bi.o0 o0Var = this.f32934s;
    ...
    public final boolean I(final int i10, final boolean z10, int i11, final boolean z11, final long j3) {
        HashMap hashMap = this.f32935w;
        int i12 = 0;
        if ((hashMap.size() == 0 && this.J == null) || this.f32937y) {
            return false;
        }
        this.f32937y = true;
        final ArrayList arrayList = new ArrayList(hashMap.size());
        ArrayList arrayList2 = this.f32936x;
    ...
    public final void L(xj xjVar, Object obj) {
        ...
        ArrayList arrayList = this.f32936x;
        int i10 = 1;
        if (containsKey) {
            hashMap.remove(a2);
            arrayList.remove(a2);
    ...
    public final void N() {
        boolean z10;
        int i10 = 0;
        if (this.f32934s.getAdapter().h() == 2) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final void O() {
        View childAt;
        mz mzVar = this.G;
        if (mzVar.getVisibility() != 0 || (childAt = this.f32934s.getChildAt(0)) == null) {
            return;
        }
    ...
    public int getCurrentItemTop() {
        ...
        this.f32933r.setTranslationY(top);
    ...
    public int getListTopPadding() {
        return this.f32934s.getPaddingTop();
    }
    ...
    public ArrayList<org.telegram.ui.ActionBar.l6> getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.G, 4, null, null, null, null, org.telegram.ui.ActionBar.j6.f20647c7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.G, 2048, null, null, null, null, org.telegram.ui.ActionBar.j6.f20736h6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(o0Var, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f20754i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(o0Var, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f20786k0, null, null, org.telegram.ui.ActionBar.j6.f20665d7));
        int i11 = org.telegram.ui.ActionBar.j6.f20898q5;
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(o0Var, 0, new Class[]{xj.class}, null, org.telegram.ui.ActionBar.j6.f20911r0, null, org.telegram.ui.ActionBar.j6.J7));
    ...
    @Override
    public final void m() {
        NotificationCenter.getInstance(this.f28754b.J1).removeObserver(this, NotificationCenter.contactsDidLoad);
    }
    ...
    public final void y(int i10, int i11) {
        ...
        this.f32934s.n1(0, i12 + AndroidUtilities.statusBarHeight, 0, this.f28756e);
    }
