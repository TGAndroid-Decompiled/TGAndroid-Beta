...
public final class yj extends ni implements NotificationCenter.NotificationCenterDelegate, le.d {
    ...
    public pj J;
    public boolean K;
    public final le.b f30256n;
    public final FrameLayout f30257r;
    public final ai.w0 f30258s;
    public final hg.e0 v;
    public final HashMap f30259w;
    public final ArrayList f30260x;
    public boolean f30261y;

    public yj(Context context, org.telegram.ui.ActionBar.f6 f6Var, vi viVar) {
        super(context, f6Var, viVar);
        this.f30256n = new le.b(0, this, qr.h, 380L, false);
        this.f30259w = new HashMap();
        this.f30260x = new ArrayList();
        this.f30261y = false;
        this.F = new uj(this, context);
        ui uiVar = new ui(context, org.telegram.ui.ActionBar.j6.f18863d6, f6Var);
        this.H = uiVar;
        uiVar.setVisibility(4);
        FrameLayout frameLayout = new FrameLayout(context);
        this.f30257r = frameLayout;
        ...
        w0Var.setGlowColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.A5, this.f26462a));
        ...
        NotificationCenter.getInstance(this.f26463b.J1).addObserver(this, NotificationCenter.contactsDidLoad);
        N();
    }

    public int getCurrentTop() {
        ai.w0 w0Var = this.f30258s;
    ...
    public final boolean I(final int i10, final boolean z10, int i11, final boolean z11, final long j3) {
        HashMap hashMap = this.f30259w;
        int i12 = 0;
        if ((hashMap.size() == 0 && this.J == null) || this.f30261y) {
            return false;
        }
        this.f30261y = true;
        final ArrayList arrayList = new ArrayList(hashMap.size());
        ArrayList arrayList2 = this.f30260x;
    ...
    public final void N() {
        boolean z10;
        int i10 = 0;
        if (this.f30258s.getAdapter().h() == 2) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final void O() {
        View childAt;
        mz mzVar = this.G;
        if (mzVar.getVisibility() != 0 || (childAt = this.f30258s.getChildAt(0)) == null) {
            return;
        }
    ...
    public int getCurrentItemTop() {
        ...
        this.f30257r.setTranslationY(top);
    ...
    public int getListTopPadding() {
        return this.f30258s.getPaddingTop();
    }
    ...
    public ArrayList<org.telegram.ui.ActionBar.l6> getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.G, 4, null, null, null, null, org.telegram.ui.ActionBar.j6.f18846c7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.G, 2048, null, null, null, null, org.telegram.ui.ActionBar.j6.f18935h6));
        ...
        int i11 = org.telegram.ui.ActionBar.j6.f19100q5;
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(w0Var, 0, new Class[]{xj.class}, null, org.telegram.ui.ActionBar.j6.f19113r0, null, org.telegram.ui.ActionBar.j6.J7));
    ...
    @Override
    public final void m() {
        NotificationCenter.getInstance(this.f26463b.J1).removeObserver(this, NotificationCenter.contactsDidLoad);
    }
    ...
    public final void y(int i10, int i11) {
        ...
        this.f30258s.p1(0, i12 + AndroidUtilities.statusBarHeight, 0, this.e);
    }
