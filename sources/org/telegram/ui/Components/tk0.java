...
public final class tk0 extends View {
    ...
    public boolean f28126a0;
    public final RectF f28127b;
    public final float f28128b0;
    public final Paint f28129c;
    public final Drawable f28130c0;
    public final Paint d;
    public final Drawable f28131d0;
    public float e;
    public ch.d f28132e0;
    public float f28133f;
    public ch.d f28134f0;
    public final boolean f28135g0;
    public float h;
    public int f28136h0;
    public final org.telegram.ui.Cells.l7 f28137i0;
    public float f28138j0;
    public boolean f28139k0;
    public long f28140l0;
    public float m0;
    public boolean f28141n;
    public float f28142n0;
    public final ml0 f28143o0;
    public StaticLayout f28144r;
    public StaticLayout f28145s;
    public StaticLayout v;
    public StaticLayout f28146w;
    public StaticLayout f28147x;
    public float f28148y;
    ...
    public tk0(ml0 ml0Var, Context context, int i10) {
        ...
        float f7;
        float f10;
        org.telegram.ui.ActionBar.f6 f6Var = ml0Var.f26194p2;
        this.f28143o0 = ml0Var;
        this.f28125a = true;
        this.f28127b = new RectF();
        this.f28129c = new Paint(1);
        ...
        this.L = new float[8];
        this.W = new int[2];
        this.f28137i0 = new org.telegram.ui.Cells.l7(this, 20);
        this.f28142n0 = 1.0f;
        this.R = i10;
        if (i10 == 0) {
            textPaint.setTextSize(AndroidUtilities.dp(45.0f));
            this.f28135g0 = LocaleController.isRTL;
        } else {
            this.f28135g0 = false;
        ...
        this.f28128b0 = ViewConfiguration.get(context).getScaledTouchSlop();
        this.f28130c0 = context.getDrawable(R.drawable.fast_scroll_shadow);
    }

    public final void a(boolean z10) {
        ml0 ml0Var = this.f28143o0;
        ...
        if (layoutManager instanceof s4.c0) {
            ...
            if (c0Var.f42690o == 1) {
                ...
                if (adapter instanceof uk0) {
                    ...
                    if (z10) {
                        c0Var.h1(iArr[0], (-iArr[1]) + ml0Var.f26207w1);
                    }
                    String F = uk0Var.F(iArr[0]);
                    if (F == null) {
                        StaticLayout staticLayout = this.f28144r;
                        if (staticLayout != null) {
                            this.f28145s = staticLayout;
                        }
                        this.f28144r = null;
                        ...
                        if (i10 == 0) {
                            this.f28144r = new StaticLayout(F, textPaint, 1000, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                        } else {
                            this.v = this.f28144r;
                            int measureText = ((int) textPaint.measureText(F)) + 1;
                            Layout.Alignment alignment = Layout.Alignment.ALIGN_NORMAL;
                            this.f28144r = new StaticLayout(F, textPaint, measureText, alignment, 1.0f, 0.0f, false);
                            if (this.v != null) {
                                ...
                                if (split != null && split2 != null && split.length == 2 && split2.length == 2 && split[1].equals(split2[1])) {
                                    ...
                                    this.f28146w = new StaticLayout(spannableStringBuilder2, textPaint, measureText, alignment, 1.0f, 0.0f, false);
                                    ...
                                    this.f28147x = new StaticLayout(spannableStringBuilder3, textPaint, measureText, alignment, 1.0f, 0.0f, false);
                                } else {
                                    this.f28146w = this.f28144r;
                                    this.f28147x = null;
                                }
                        ...
                        this.f28145s = null;
                        if (this.f28144r.getLineCount() > 0) {
                            this.f28144r.getLineWidth(0);
                            this.f28144r.getLineLeft(0);
                            if (this.f28135g0) {
                                this.M = (((AndroidUtilities.dp(88.0f) - this.f28144r.getLineWidth(0)) / 2.0f) + AndroidUtilities.dp(10.0f)) - this.f28144r.getLineLeft(0);
                            } else {
                                this.M = ((AndroidUtilities.dp(88.0f) - this.f28144r.getLineWidth(0)) / 2.0f) - this.f28144r.getLineLeft(0);
                            }
                            this.N = (AndroidUtilities.dp(88.0f) - this.f28144r.getHeight()) / 2;
                        }
                    }
                }
            }
    ...
    public final void b() {
        ...
        org.telegram.ui.Cells.l7 l7Var = this.f28137i0;
    ...
    public final void c() {
        ...
        int i10 = this.R;
        if (i10 == 0) {
            k10 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19029m7, ml0Var.f26194p2);
        } else {
            k10 = i0.a.k(-16777216, 102);
        }
        this.S = k10;
        this.T = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19010l7, ml0Var.f26194p2);
        this.f28129c.setColor(this.S);
        TextPaint textPaint = this.H;
        if (i10 == 0) {
            textPaint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19049n7, ml0Var.f26194p2));
        } else {
            textPaint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, ml0Var.f26194p2));
        }
        invalidate();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (i14 == 0) {
            ...
            ml0 ml0Var = this.f28143o0;
            f11 = 8.0f;
            paint.setColor(i0.a.d(0.1f, org.telegram.ui.ActionBar.j6.v0(i15, ml0Var.f26194p2), -1));
            float dp3 = AndroidUtilities.dp(27.0f) + ceil;
            ch.d dVar = this.f28132e0;
            if (dVar != null) {
                c10 = 2;
                f12 = 24.0f;
                ...
                this.f28132e0.draw(canvas);
                f13 = 4.0f;
            } else {
                c10 = 2;
                f12 = 24.0f;
                int measuredWidth = getMeasuredWidth();
                Drawable drawable = this.f28130c0;
                f13 = 4.0f;
            ...
            paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, ml0Var.f26194p2));
            canvas.save();
        ...
        if (i14 == 0) {
        ...
        } else if (i14 == 1 && this.f28144r != null && this.V != 0.0f) {
            canvas.save();
            ...
            this.f28144r.getHeight();
            AndroidUtilities.dp(6.0f);
            rectF.set((dp6 - (((1.0f - this.f28148y) * this.G) + (this.f28148y * this.f28144r.getWidth()))) - AndroidUtilities.dp(f10), (centerY - (this.f28144r.getHeight() / 2.0f)) - AndroidUtilities.dp(f11), dp6 - AndroidUtilities.dp(f7), (this.f28144r.getHeight() / 2.0f) + centerY + AndroidUtilities.dp(f11));
            Paint paint2 = this.d;
            ...
            if (this.f28134f0 != null) {
                ...
                this.f28134f0.setBounds(rect);
                this.f28134f0.draw(canvas);
            } else {
                Drawable drawable2 = this.f28131d0;
                drawable2.setBounds((int) rectF.left, (int) rectF.top, (int) rectF.right, (int) rectF.bottom);
                drawable2.setAlpha((int) (this.V * 255.0f));
                drawable2.draw(canvas);
            }
            float f20 = this.f28148y;
            if (f20 != 1.0f) {
            ...
            if (this.f28148y != 1.0f) {
                canvas.save();
                rectF.inset(AndroidUtilities.dp(f13), AndroidUtilities.dp(2.0f));
                canvas.clipRect(rectF);
                if (this.v != null) {
                    textPaint.setAlpha((int) ((1.0f - this.f28148y) * alpha2 * this.V));
                    canvas.save();
                    ...
                    canvas.translate(width, (AndroidUtilities.dp(15.0f) * i12 * this.f28148y) + height);
                    this.v.draw(canvas);
                    canvas.restore();
                }
                if (this.f28146w != null) {
                    textPaint.setAlpha((int) (alpha2 * this.V * this.f28148y));
                    canvas.save();
                    float width2 = (dp6 - this.f28146w.getWidth()) - AndroidUtilities.dp(f12);
                    float height2 = centerY - (this.f28146w.getHeight() / 2.0f);
                    if (this.E) {
                        i11 = 1;
                    } else {
                        i11 = -1;
                    }
                    canvas.translate(width2, com.google.android.gms.internal.vision.e2.z(1.0f, this.f28148y, AndroidUtilities.dp(15.0f) * i11, height2));
                    this.f28146w.draw(canvas);
                    canvas.restore();
                }
                if (this.f28147x != null) {
                    textPaint.setAlpha((int) (alpha2 * this.V));
                    canvas.save();
                    canvas.translate((dp6 - this.f28147x.getWidth()) - AndroidUtilities.dp(f12), centerY - (this.f28147x.getHeight() / 2.0f));
                    this.f28147x.draw(canvas);
                    canvas.restore();
                }
                canvas.restore();
            } else {
                textPaint.setAlpha((int) (alpha2 * this.V));
                canvas.save();
                canvas.translate((dp6 - this.f28144r.getWidth()) - AndroidUtilities.dp(f12), com.google.android.gms.internal.vision.e2.z(1.0f, this.f28148y, AndroidUtilities.dp(15.0f), centerY - (this.f28144r.getHeight() / 2.0f)));
                this.f28144r.draw(canvas);
                canvas.restore();
            }
        ...
        boolean z11 = this.f28139k0;
        if ((z11 && this.f28144r != null && this.O < 1.0f) || ((!z11 || this.f28144r == null) && this.O > 0.0f)) {
            this.P = currentTimeMillis;
            invalidate();
            if (this.f28139k0 && this.f28144r != null) {
    ...
    public void setIsVisible(boolean z10) {
        ...
        if (this.f28126a0 != z10) {
            ...
            this.m0 = f7;
            super.setAlpha(this.f28142n0 * f7);
        }
    }
