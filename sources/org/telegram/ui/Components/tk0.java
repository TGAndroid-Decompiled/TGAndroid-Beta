...
public final class tk0 extends View {
    ...
    public boolean U;
    public float V;
    public final org.telegram.ui.ActionBar.f6 f28485a;
    public final Paint f28486b;
    public final Paint f28487c;
    public final Paint d;
    public final Paint e;
    public final sg0 f28488f;
    public final n6 h;
    public v71 f28489n;
    public float f28490r;
    public float f28491s;
    public float v;
    public boolean f28492w;
    public final jc0 f28493x;
    public final RectF f28494y;

    public tk0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f28486b = new Paint(1);
        this.f28487c = new Paint(1);
        this.d = new Paint(1);
        this.e = new Paint(1);
        this.f28491s = 0.0f;
        this.v = 1.0f;
        this.f28492w = false;
        this.f28493x = new jc0(this, 19);
        this.f28494y = new RectF();
        this.E = new RectF();
        this.F = new RectF();
        this.G = new Path();
        this.H = new RectF();
    ...
    public final void a(Canvas canvas, RectF rectF) {
        ...
        float clamp;
        boolean z10;
        int i14 = org.telegram.ui.ActionBar.j6.f19246kf;
        org.telegram.ui.ActionBar.f6 f6Var = this.f28485a;
        int v02 = org.telegram.ui.ActionBar.j6.v0(i14, f6Var);
        Paint paint4 = this.f28486b;
        paint4.setColor(v02);
        int v03 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19264lf, f6Var);
        Paint paint5 = this.f28487c;
        paint5.setColor(v03);
        int i15 = org.telegram.ui.ActionBar.j6.hf;
        int v04 = org.telegram.ui.ActionBar.j6.v0(i15, f6Var);
        n6 n6Var2 = this.h;
        n6Var2.r(v04);
        int v05 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19152ff, f6Var);
        sg0 sg0Var2 = this.f28488f;
        sg0Var2.f28183a.setColor(v05);
        int v06 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19171gf, f6Var);
        Paint paint6 = this.d;
        paint6.setColor(v06);
        int v07 = org.telegram.ui.ActionBar.j6.v0(i15, f6Var);
        Paint paint7 = this.e;
        paint7.setColor(v07);
        int lerp = (int) AndroidUtilities.lerp(rectF.left + AndroidUtilities.dp(11.33f), rectF.right - AndroidUtilities.dp(11.33f), Utilities.clamp01(this.f28491s));
        ...
        int i19 = org.telegram.ui.ActionBar.j6.f19171gf;
        ...
        if (this.U) {
            ...
            v71 v71Var = this.f28489n;
            if (v71Var != null) {
                f7 = ((float) v71Var.n()) / ((float) this.f28489n.p());
            } else {
                f7 = 1.0f;
            }
            clamp = Utilities.clamp(f7, this.v, this.f28491s);
        }
        ...
        if (clamp2 < f11) {
            ...
            canvas.translate(rectF.left + AndroidUtilities.dp(14.0f), rectF.centerY());
            if (this.f28492w && clamp < this.f28491s && !this.U) {
        ...
        if (e > 0.0f) {
            ...
            if (e7 > 0.0f) {
                ...
                n6Var3.f26660w = (int) (e7 * 255.0f * e);
                n6Var3.draw(canvas);
                canvas.restore();
            }
        }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            boolean z13 = this.R;
            RectF rectF3 = this.f28494y;
            if (z13) {
                this.f28491s = Utilities.clamp(AndroidUtilities.ilerp(motionEvent.getX(), rectF3.left + AndroidUtilities.dp(11.33f), rectF3.right - AndroidUtilities.dp(11.33f)), Utilities.clamp01(this.v - Math.max(1.0f / this.f28490r, AndroidUtilities.dp(30.0f) / (rectF3.width() - AndroidUtilities.dp(22.66f)))), 0.0f);
                invalidate();
            } else if (this.S) {
                this.v = Utilities.clamp(AndroidUtilities.ilerp(motionEvent.getX(), rectF3.left + AndroidUtilities.dp(11.33f), rectF3.right - AndroidUtilities.dp(11.33f)), 1.0f, Utilities.clamp01(Math.max(1.0f / this.f28490r, AndroidUtilities.dp(30.0f) / (rectF3.width() - AndroidUtilities.dp(22.66f))) + this.f28491s));
                invalidate();
            } else if (this.U) {
                v71 v71Var2 = this.f28489n;
                if (v71Var2 != null) {
                    float clamp = Utilities.clamp(AndroidUtilities.ilerp(motionEvent.getX(), rectF3.left + AndroidUtilities.dp(11.33f), rectF3.right - AndroidUtilities.dp(11.33f)), this.v, this.f28491s);
                    this.V = clamp;
                    v71Var2.L(clamp * ((float) this.f28489n.p()), false);
                }
                invalidate();
            }
            this.h.q(AndroidUtilities.formatDuration(Math.round(Math.max(1.0f, (this.v - this.f28491s) * this.f28490r)), false), true, true);
        } else if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
            if (motionEvent.getAction() == 1 && this.T) {
                setPlaying(!b());
            } else if (this.R && this.f28492w) {
                v71 v71Var3 = this.f28489n;
                if (v71Var3 != null) {
                    v71Var3.L(this.f28491s * ((float) v71Var3.p()), false);
                }
                setPlaying(true);
            } else if (this.S && this.f28492w) {
                v71 v71Var4 = this.f28489n;
                if (v71Var4 != null) {
                    v71Var4.L(Math.max(this.f28491s * ((float) v71Var4.p()), (this.v * ((float) this.f28489n.p())) - 1500), false);
                }
                setPlaying(true);
            } else if (this.U && !b()) {
                setPlaying(true);
    ...
    public long getAudioLeftMs() {
        return this.f28491s * ((float) getDuration());
    }
    ...
    public double getNewDuration() {
        return ((this.v - this.f28491s) * ((float) getDuration())) / 1000.0d;
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        this.f28494y.set(0.0f, (getHeight() - dp) / 2.0f, getWidth(), (getHeight() + dp) / 2.0f);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        float dp = AndroidUtilities.dp(32.0f);
        this.f28494y.set(0.0f, (getMeasuredHeight() - dp) / 2.0f, getMeasuredWidth(), (getMeasuredHeight() + dp) / 2.0f);
    }
    ...
    public void setPlaying(boolean z10) {
        ...
        v71 v71Var = this.f28489n;
        if (v71Var != null) {
            float n10 = ((float) v71Var.n()) / ((float) this.f28489n.p());
            float f7 = this.f28491s;
        ...
        this.f28488f.a(z10, true);
        jc0 jc0Var = this.f28493x;
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.h != drawable && this.f28488f != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
