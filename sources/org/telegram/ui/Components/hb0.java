...
public final class hb0 extends ml0 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        pb0 pb0Var2 = this.X2;
        org.telegram.ui.y8 y8Var = pb0Var2.f26988b;
        boolean z12 = false;
        ...
        int i12 = 0;
        while (i12 < 3) {
            vb0 vb0Var = pb0Var2.f26991c0;
            ArrayList arrayList = vb0Var.E;
            hb0 hb0Var = pb0Var2.f26992f;
            vb0Var.E.clear();
            if (i12 != 2 || hb0Var.X1) {
                int i13 = 0;
                ?? r32 = z12;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (view instanceof org.telegram.ui.Cells.t1) {
            ...
            t1Var.u3(true);
            t1Var.V1(canvas);
            if (t1Var.getCurrentMessagesGroup() == null || ((t1Var.getCurrentPosition() != null && (((t1Var.getCurrentPosition().flags & t1Var.t0()) != 0 && (t1Var.getCurrentPosition().flags & 1) != 0) || (t1Var.getCurrentMessagesGroup() != null && t1Var.getCurrentMessagesGroup().isDocuments))) || t1Var.getTransitionParams().f20932w0)) {
                t1Var.I1(t1Var.getAlpha(), canvas, false);
                t1Var.d2(canvas, t1Var.getAlpha(), null);
                t1Var.N1(canvas, t1Var.getAlpha());
            }
            if (t1Var.getCurrentMessagesGroup() != null || t1Var.getTransitionParams().f20932w0) {
                t1Var.W1(canvas, t1Var.getAlpha());
            }
            if ((t1Var.getCurrentPosition() != null && t1Var.getCurrentPosition().last) || t1Var.getTransitionParams().f20932w0) {
