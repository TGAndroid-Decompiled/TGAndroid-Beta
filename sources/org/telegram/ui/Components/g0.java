...
public final class g0 extends bb {
    ...
    public ArrayList Z;
    public a0.i f24299a0;
    public final boolean f24300b0;
    public final org.telegram.ui.j20 f24301c0;
    public boolean f24302d0;
    public boolean f24303e0;
    public boolean f24304f0;
    public org.telegram.ui.ya f24305g0;
    ...
    public g0(org.telegram.ui.ActionBar.m2 m2Var, TLRPC.TL_channelAdminLogEventsFilter tL_channelAdminLogEventsFilter, a0.i iVar, boolean z10) {
        ...
        this.v = 0.35f;
        fixNavigationBar();
        int i10 = org.telegram.ui.ActionBar.h6.f19133i5;
    ...
    public final void S(ArrayList arrayList) {
        this.Z = arrayList;
        if (arrayList != null && this.f24299a0 == null) {
            this.f24299a0 = new a0.i();
            ArrayList arrayList2 = this.Z;
            ...
            while (i10 < size) {
                ...
                this.f24299a0.k(MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(peerDialogId)), peerDialogId);
            }
        }
        j61 j61Var = this.X;
        if (j61Var != null) {
    ...
    public final void onSmoothContainerViewLayout(float f7) {
        ...
        this.f24301c0.setTranslationY(-f7);
    }
