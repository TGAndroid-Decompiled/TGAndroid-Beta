...
public final class g0 extends bb {
    ...
    public ArrayList Z;
    public a0.i f24317a0;
    public final boolean f24318b0;
    public final org.telegram.ui.j20 f24319c0;
    public boolean f24320d0;
    public boolean f24321e0;
    public boolean f24322f0;
    public org.telegram.ui.ya f24323g0;
    ...
    public g0(org.telegram.ui.ActionBar.m2 m2Var, TLRPC.TL_channelAdminLogEventsFilter tL_channelAdminLogEventsFilter, a0.i iVar, boolean z10) {
        ...
        this.v = 0.35f;
        fixNavigationBar();
        int i10 = org.telegram.ui.ActionBar.h6.f19148i5;
    ...
    public final void S(ArrayList arrayList) {
        this.Z = arrayList;
        if (arrayList != null && this.f24317a0 == null) {
            this.f24317a0 = new a0.i();
            ArrayList arrayList2 = this.Z;
            ...
            while (i10 < size) {
                ...
                this.f24317a0.k(MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(peerDialogId)), peerDialogId);
            }
        }
        j61 j61Var = this.X;
        if (j61Var != null) {
    ...
    public final void onSmoothContainerViewLayout(float f7) {
        ...
        this.f24319c0.setTranslationY(-f7);
    }
