...
public class jw0 extends s4.d0 {
    public final rr f25576r;
    public int f25577s;
    public float f25578t;

    public jw0(Context context) {
        super(context);
        this.f25576r = rr.f28031f;
        this.f25578t = 1.0f;
    }
    ...
    public final void g(View view, s4.x0 x0Var) {
        ...
        if (m10 > 0) {
            x0Var.b(-j3, -k10, m10, this.f25576r);
        }
    ...
    public final int k(int i10, View view) {
        return super.k(i10, view) - this.f25577s;
    }

    @Override
    public final int m(int i10) {
        return Math.round(Math.min(super.m(i10), 500) * this.f25578t);
    }

    @Override
    public final int n(int i10) {
        return Math.round(Math.min(super.n(i10), 150) * this.f25578t);
    }
    ...
    public final void q(s4.x0 x0Var) {
        ...
        if (a2 != null && (a2.x != 0.0f || a2.y != 0.0f)) {
            ...
            x0Var.b((int) (this.f42988o * 1.2f), (int) (this.f42989p * 1.2f), (int) (n(10000) * 1.2f), this.f25576r);
            return;
        }
