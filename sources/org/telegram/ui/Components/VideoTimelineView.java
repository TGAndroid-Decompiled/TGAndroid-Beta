...
public class VideoTimelineView extends View {
    ...
    public static class TimeHintView extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            this.tooltipBackgroundArrow.setBounds(zzkn.m(this.tooltipLayout.getWidth() / 2, this.tooltipBackgroundArrow), (int) (AndroidUtilities.dpf2(4.0f) + this.tooltipLayout.getHeight()), zzkq.m(this.tooltipLayout.getWidth() / 2, this.tooltipBackgroundArrow), this.tooltipBackgroundArrow.getIntrinsicHeight() + ((int) (AndroidUtilities.dpf2(4.0f) + this.tooltipLayout.getHeight())));
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawLine(iDp - AndroidUtilities.dp(4.0f), AndroidUtilities.dp(10.0f) + measuredHeight, iDp - AndroidUtilities.dp(4.0f), RichMessageLayout$$ExternalSyntheticOutline1.m(10.0f, getMeasuredHeight(), measuredHeight), this.thumbPaint);
        canvas.drawLine(AndroidUtilities.dp(4.0f) + iDp2, AndroidUtilities.dp(10.0f) + measuredHeight, AndroidUtilities.dp(4.0f) + iDp2, RichMessageLayout$$ExternalSyntheticOutline1.m(10.0f, getMeasuredHeight(), measuredHeight), this.thumbPaint);
        if (this.useClip) {
            canvas.restore();
        } else {
    ...
    public void updateColors() {
        this.backgroundGrayPaint.setColor(Theme.getColor(null, Theme.key_windowBackgroundGray, false));
