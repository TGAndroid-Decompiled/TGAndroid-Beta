...
public final class gh0 extends View {
    ...
    public gh0(Context context) {
        ...
        this.f24219a = z10;
        this.f24220b = new Object();
        this.f24221c = new uh0[3];
        this.d = new uh0[3];
        this.e = false;
        Paint[] paintArr = {new Paint(), new Paint()};
        this.f24222f = paintArr;
        this.f24225s = new fh0(this, 0);
        ...
        this.H = false;
        this.N = new nv0[3];
        c6 c6Var = new c6(this, 0L, 350L, qr.f27383f);
        this.O = c6Var;
        this.P = new ai.m7(this, 3);
        c6Var.d(1.0f, true);
        boolean z11 = this.f24219a & SharedConfig.useNewBlur;
        this.f24219a = z11;
        if (z11) {
            setLayerType(2, null);
            return;
    ...
    public static void a(gh0 gh0Var, int i10, int i11, int i12) {
        synchronized (gh0Var.f24220b) {
            try {
                uh0[] uh0VarArr = gh0Var.f24221c;
                ...
                if (i10 == 2) {
                    if (uh0Var2.f28393f) {
                        gh0Var.b(uh0Var2.f28391b, i11);
                    }
                } else {
                    Paint[] paintArr = gh0Var.f24222f;
                    Paint paint = paintArr[i10];
                    paintArr[i10] = paintArr[i11];
                    paintArr[i11] = paint;
                }
                if (i12 != -1) {
                    gh0Var.f24222f[i12].setShader(null);
                    uh0 uh0Var3 = gh0Var.f24221c[i12];
                    if (uh0Var3 != null && !uh0Var3.e && !uh0Var3.d) {
                        uh0Var3.f28393f = false;
                        uh0Var3.f28391b.eraseColor(0);
                    }
                }
            } finally {
            }
    ...
    public final void b(Bitmap bitmap, int i10) {
        if (i10 < 2 && bitmap != null && !bitmap.isRecycled()) {
            LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, 0.0f, this.f24224r / 6.0f, new int[]{0, -1}, new float[]{0.0f, AndroidUtilities.dpf2(56.0f) / this.f24224r}, Shader.TileMode.CLAMP);
            Shader.TileMode tileMode = Shader.TileMode.MIRROR;
            this.f24222f[i10].setShader(new ComposeShader(new BitmapShader(bitmap, tileMode, tileMode), linearGradient, PorterDuff.Mode.DST_IN));
        }
    }
    ...
    public final void c(float f7, org.telegram.ui.o01 o01Var, float f10, float f11) {
        ...
        this.M.setPosition(0, 0, (int) Math.ceil(f7 / renderNodeScale), (int) ((this.f24223n + f11) / renderNodeScale));
        ...
        if (eh0Var2 != null) {
            if (o01Var != null) {
                eh0Var2.f23569w = this.M;
                eh0Var2.f23567r = o01Var;
                eh0Var2.f23568s = renderNodeScale / f10;
                eh0Var2.v = -f11;
                eh0Var2.invalidate();
            } else {
                eh0Var2.f23569w = this.M;
                eh0Var2.f23567r = null;
                eh0Var2.f23568s = renderNodeScale;
                eh0Var2.v = -f11;
                eh0Var2.invalidate();
            }
        }
    ...
    public final void e() {
        ...
        if (ph0Var != null) {
            ai.m7 m7Var = this.P;
            ArrayList arrayList = ph0Var.f48167k0;
            if (arrayList != null) {
        ...
        this.e = false;
        vh0.f28727a.cancelRunnable(this.f24225s);
        ...
        synchronized (this.f24220b) {
            for (int i10 = 0; i10 < 3; i10++) {
                try {
                    uh0 uh0Var = this.f24221c[i10];
                    if (uh0Var != null) {
                        uh0Var.a();
                        this.f24221c[i10] = null;
                    }
            ...
            this.f24222f[0].setShader(null);
            this.f24222f[1].setShader(null);
        }
    }
    ...
    public final void f(Canvas canvas, org.telegram.ui.o01 o01Var, float f7, float f10, boolean z10, float f11, float f12) {
        ...
        if (ph0Var != null && ph0Var.isAttachedToWindow() && this.h.getVisibility() != 8) {
            if (this.f24219a && Build.VERSION.SDK_INT >= 31) {
                if (canvas2.isHardwareAccelerated()) {
                    if (o01Var == null && getVisibility() == 0 && getAlpha() > 0.0f) {
                        ...
                        this.L.setPosition(0, 0, (int) (f7 / renderNodeScale), (int) ((this.f24224r + this.f24223n) / renderNodeScale));
                        RecordingCanvas beginRecording = this.L.beginRecording();
                        float f14 = 1.0f / renderNodeScale;
                        beginRecording.scale(f14, f14);
                        beginRecording.save();
                        beginRecording.translate(-this.f24227x, 0.0f);
                        i(beginRecording, 0);
                        beginRecording.restore();
                        if (this.f24227x != 0) {
                            beginRecording.save();
                            beginRecording.translate((-this.f24227x) + f7, 0.0f);
                            i(beginRecording, 1);
                            beginRecording.restore();
                        }
                        this.L.endRecording();
                        ...
                        if (getVisibility() == 0 && getAlpha() > 0.0f) {
                            c(f7, null, 1.0f, this.f24224r);
                            return;
                        }
                        return;
                    } else if (o01Var != null) {
                        float measuredWidth = f7 / this.h.getMeasuredWidth();
                        float f15 = this.f24224r * (1.0f - f11);
                        float f16 = f15 * measuredWidth;
                        float renderNodeScale2 = getRenderNodeScale() * measuredWidth;
                        j();
                        this.L.setPosition(0, 0, (int) (f7 / renderNodeScale2), (int) ((this.f24223n + f15) / renderNodeScale2));
                        ...
                        if (o5Var != null) {
                            ...
                            imageReceiver = o01Var.f28304a;
                        }
                        g(imageReceiver, beginRecording2, f16, f10);
                        if (o01Var.f36198a0 && o01Var.V > 0.0f) {
                    ...
                    this.f24219a = false;
                    setLayerType(1, this.f24222f[0]);
                    setLayerType(1, this.f24222f[1]);
                } else {
                    return;
                }
            }
            ...
            if (this.H || this.G || this.F || (this.f24222f[0].getShader() == null && this.f24222f[1].getShader() == null && !this.e)) {
                boolean d = d();
                if (!this.e && d) {
                    this.e = true;
                    DispatchQueue dispatchQueue = vh0.f28727a;
                    dispatchQueue.cancelRunnable(this.f24225s);
                    dispatchQueue.postRunnable(this.f24225s);
                }
            }
            if (this.f24222f[0].getShader() != null || this.f24222f[1].getShader() != null) {
                synchronized (this.f24220b) {
                    try {
                        float f18 = f7 / this.f24228y;
                        if (z10) {
                            canvas2.translate(0.0f, (-f18) * this.E);
                        }
                        canvas2.scale(f18, f18);
                        float f19 = this.f24223n / f18;
                        if (this.f24222f[0].getShader() != null) {
                            canvas2.save();
                            canvas2.translate((-this.f24227x) / f18, 0.0f);
                            canvas2.save();
                            ...
                            f13 = 2.0f;
                            c10 = 1;
                            canvas2.drawRect(0.0f, f20, this.f24228y, f20 + f19, this.f24222f[0]);
                            canvas.restore();
                            this.f24222f[0].setAlpha((int) (f12 * 255.0f));
                            float f21 = this.E;
                            canvas2 = canvas;
                            canvas2.drawRect(0.0f, f21 * f11, this.f24228y, f21, this.f24222f[0]);
                            this.f24222f[0].setAlpha(255);
                            canvas2.restore();
                        } else {
                            i10 = 255;
                            f13 = 2.0f;
                        ...
                        if (this.f24227x != 0 && this.f24222f[c10].getShader() != null) {
                            canvas2.save();
                            canvas2.translate(((-this.f24227x) + f7) / f18, 0.0f);
                            canvas2.save();
                            canvas2.scale(1.0f, f13, 0.0f, this.E);
                            float f22 = this.E;
                            canvas2.drawRect(0.0f, f22, this.f24228y, f22 + f19, this.f24222f[c10]);
                            canvas.restore();
                            this.f24222f[c10].setAlpha((int) (f12 * 255.0f));
                            float f23 = this.E;
                            canvas.drawRect(0.0f, f23 * f11, this.f24228y, f23, this.f24222f[c10]);
                            this.f24222f[c10].setAlpha(i10);
                            canvas.restore();
                        }
                    } catch (Throwable th2) {
                        throw th2;
    ...
    public final void h(int i10, View view) {
        ...
        if (view != null && !uh0Var.e) {
            Canvas canvas = uh0Var.f28390a;
            canvas.save();
            canvas.scale(0.16666667f, 0.16666667f);
            canvas.translate(0.0f, this.f24224r - view.getMeasuredHeight());
            view.draw(canvas);
            canvas.restore();
            uh0Var.f28393f = true;
        }
        if (i10 != 0 && (this.f24227x == 0 || i10 != 1)) {
            return;
        }
    ...
    public final void i(Canvas canvas, int i10) {
        View E = this.h.E(this.f24226w + i10);
        if (E != null) {
            int measuredHeight = E.getMeasuredHeight();
            canvas.save();
            canvas.translate(0.0f, this.f24224r - measuredHeight);
            E.draw(canvas);
            canvas.restore();
            canvas.save();
            canvas.scale(1.0f, -1.0f);
            canvas.translate(0.0f, (-measuredHeight) - this.f24224r);
    ...
    public final void j() {
        if (this.L == null) {
            ...
            float[] fArr = {0.0f, AndroidUtilities.dpf2(56.0f) / this.f24224r};
            Shader.TileMode tileMode = Shader.TileMode.CLAMP;
            LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, 0.0f, this.f24224r / renderNodeScale, new int[]{0, -1}, fArr, tileMode);
    ...
    public final void onMeasure(int i10, int i11) {
        setMeasuredDimension(View.MeasureSpec.getSize(i10), this.f24224r + this.f24223n);
    }
    ...
    public void setSize(int i10) {
        ...
        this.f24223n = i10;
        this.f24224r = (int) (AndroidUtilities.dp(64.0f) * 1.5f);
    }

    public void setView(ph0 ph0Var) {
        e();
        this.h = ph0Var;
        this.f24226w = ph0Var.getCurrentItem();
        this.f24227x = 0;
        ph0Var.b(this.P);
    }
