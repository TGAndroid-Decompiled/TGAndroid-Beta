...
public class xl0 extends RecyclerView implements bh.a {
    ...
    public boolean Z0;
    public int Z1;
    public s4.s0 f30370a1;
    public int a2;
    public kl0 f30371b1;
    public int f30372b2;
    public View f30373c1;
    public int f30374c2;
    public ai.f0 f30375d1;
    public boolean f30376d2;
    public pl0 f30377e1;
    public boolean f30378e2;
    public el0 f30379f1;
    public int f30380f2;
    public tl0 f30381g1;
    public int f30382g2;
    public boolean f30383h1;
    public org.telegram.ui.ni f30384h2;
    public boolean f30385i1;
    public boolean f30386i2;
    public boolean f30387j1;
    public boolean f30388j2;
    public boolean f30389k1;
    public float f30390k2;
    public Drawable l1;
    public float f30391l2;
    public float f30392m1;
    public int[] f30393m2;
    public float f30394n1;
    public cl0 f30395n2;
    public long f30396o1;
    public q0.a f30397o2;
    public ArrayList f30398p1;
    public final org.telegram.ui.ActionBar.d6 f30399p2;
    public ArrayList f30400q1;
    public boolean f30401q2;
    public View f30402r1;
    public final qe f30403r2;
    public int f30404s1;
    public boolean f30405s2;
    public int f30406t1;
    public final gg.p1 f30407t2;
    public int f30408u1;
    public Paint f30409u2;
    public int f30410v1;
    public boolean f30411v2;
    public int f30412w1;
    public GenericProvider f30413w2;
    public boolean f30414x1;
    public int f30415x2;
    public int f30416y1;
    public int f30417y2;
    public boolean f30418z1;
    public boolean f30419z2;
    ...
    public final void C0(Runnable runnable) {
        this.E2.f27764b.add(new nt(runnable, 1));
    }

    public final void D0(ClippingImageView clippingImageView, FrameLayout.LayoutParams layoutParams) {
        if (this.f30375d1 == null) {
            this.f30375d1 = new ai.f0(this, getContext(), 16);
        }
        this.f30375d1.addView(clippingImageView, layoutParams);
    }
    ...
    public final void K0(boolean z10) {
        ...
        if (!this.f30385i1) {
            int i11 = 0;
            if (getAdapter() != null && this.f30373c1 != null) {
                boolean S0 = S0();
                if (S0) {
                    i10 = 0;
                } else {
                ...
                if ((this.Y1 && SharedConfig.animationsEnabled()) ? false : false) {
                    if (this.A2 != i10) {
                        this.A2 = i10;
                        if (i10 == 0) {
                            this.f30373c1.animate().setListener(null).cancel();
                            if (this.f30373c1.getVisibility() == 8) {
                                this.f30373c1.setVisibility(0);
                                this.f30373c1.setAlpha(0.0f);
                                if (this.Z1 == 1) {
                                    this.f30373c1.setScaleX(0.7f);
                                    this.f30373c1.setScaleY(0.7f);
                                }
                            }
                            this.f30373c1.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setDuration(150L).start();
                        } else if (this.f30373c1.getVisibility() != 8) {
                            ViewPropertyAnimator alpha = this.f30373c1.animate().alpha(0.0f);
                            if (this.Z1 == 1) {
                    ...
                    this.A2 = i10;
                    this.f30373c1.setVisibility(i10);
                    this.f30373c1.setAlpha(1.0f);
                }
                if (this.A1) {
                    if (S0) {
                        i11 = 4;
    ...
    public final void L0(boolean z10) {
        ...
        int i11;
        int i12;
        if (((this.K1 || z10) && this.f30379f1 != null) || (this.f30416y1 != 0 && this.f30381g1 != null)) {
            s4.o0 layoutManager = getLayoutManager();
            if (layoutManager instanceof s4.c0) {
                s4.c0 c0Var = (s4.c0) layoutManager;
                if (c0Var.f42947o == 1) {
                    if (this.f30381g1 != null) {
                        if (this.f30416y1 == 1) {
                            paddingTop = 0;
                        } else {
                            paddingTop = getPaddingTop();
                        }
                        int i13 = this.f30416y1;
                        int i14 = Integer.MAX_VALUE;
                        if (i13 != 1 && i13 != 3) {
                            if (i13 == 2) {
                                this.f30394n1 = 0.0f;
                                if (this.f30381g1.h() != 0) {
                                    int childCount = getChildCount();
                                    View view2 = null;
                                    ...
                                    for (int i17 = 0; i17 < childCount; i17++) {
                                        ...
                                        if (bottom > this.f30412w1 + paddingTop) {
                                            if (bottom < i14) {
                                                view3 = childAt;
                                                i14 = bottom;
                                            }
                                            i16 = Math.max(i16, bottom);
                                            if (bottom >= AndroidUtilities.dp(32.0f) + this.f30412w1 + paddingTop && bottom < i15) {
                                                view2 = childAt;
                                                i15 = bottom;
                                            }
                                        }
                                    }
                                    if (view3 != null && (T3 = T(view3)) != null && (S = this.f30381g1.S((b10 = T3.b()))) >= 0) {
                                        if (this.f30404s1 != S || this.f30402r1 == null) {
                                            View view4 = this.f30402r1;
                                            if (view4 == null) {
                                                z12 = true;
                                            } else {
                                                z12 = false;
                                            }
                                            View T4 = this.f30381g1.T(S, view4);
                                            if (z12) {
                                                T0(T4, false);
                                            }
                                            this.f30402r1 = T4;
                                            ...
                                            View view5 = this.f30402r1;
                                            view5.layout(0, 0, view5.getMeasuredWidth(), this.f30402r1.getMeasuredHeight());
                                            this.f30404s1 = S;
                                        }
                                        if (this.f30402r1 != null && view2 != null && view2.getClass() != this.f30402r1.getClass()) {
                                            this.f30394n1 = 1.0f;
                                        }
                                        int M = this.f30381g1.M(S);
                                        int Q = this.f30381g1.Q(b10);
                                        ...
                                        if (Q == M - 1) {
                                            int height = this.f30402r1.getHeight();
                                            int height2 = view3.getHeight() + ((view3.getTop() - paddingTop) - this.f30412w1);
                                            if (height2 < height) {
                                                i12 = height2 - height;
                                            } else {
                                                i12 = paddingTop;
                                            ...
                                            if (i12 < 0) {
                                                this.f30402r1.setTag(Integer.valueOf(paddingTop + i11 + i12));
                                            } else {
                                                this.f30402r1.setTag(Integer.valueOf(paddingTop + i11));
                                            }
                                        } else {
                                            this.f30402r1.setTag(Integer.valueOf(paddingTop + i11));
                                        }
                        ...
                        for (int i20 = 0; i20 < childCount2; i20++) {
                            ...
                            if (bottom2 > this.f30412w1 + paddingTop) {
                                if (bottom2 < i14) {
                                    i14 = bottom2;
                                    view6 = childAt2;
                                }
                                i19 = Math.max(i19, bottom2);
                                if (bottom2 >= AndroidUtilities.dp(32.0f) + this.f30412w1 + paddingTop && bottom2 < i18) {
                                    i18 = bottom2;
                                }
                            }
                        }
                        if (view6 != null && (T = T(view6)) != null) {
                            ...
                            if ((this.K1 || z10) && (el0Var2 = this.f30379f1) != null && !el0Var2.f23987n && (getAdapter() instanceof fl0)) {
                                this.f30379f1.setProgress(Math.min(1.0f, b11 / ((this.f30381g1.h() - abs) + 1)));
                            }
                            this.f30400q1.addAll(this.f30398p1);
                            this.f30398p1.clear();
                            if (this.f30381g1.h() != 0) {
                                if (this.f30404s1 != b11 || this.f30406t1 != abs) {
                                    this.f30404s1 = b11;
                                    this.f30406t1 = abs;
                                    this.f30410v1 = 1;
                                    int S3 = this.f30381g1.S(b11);
                                    this.f30408u1 = S3;
                                    int M2 = (this.f30381g1.M(S3) + b11) - this.f30381g1.Q(b11);
                                    while (M2 < b11 + abs) {
                                        M2 += this.f30381g1.M(this.f30408u1 + this.f30410v1);
                                        this.f30410v1++;
                                    }
                                }
                                if (this.f30416y1 != 3) {
                                    int i21 = b11;
                                    for (int i22 = this.f30408u1; i22 < this.f30408u1 + this.f30410v1; i22++) {
                                        if (!this.f30400q1.isEmpty()) {
                                            view = (View) this.f30400q1.get(0);
                                            this.f30400q1.remove(0);
                                        } else {
                                            view = null;
                                        }
                                        if (view == null) {
                                        ...
                                        View T5 = this.f30381g1.T(i22, view);
                                        if (z11) {
                                            T0(T5, false);
                                        }
                                        this.f30398p1.add(T5);
                                        int M3 = this.f30381g1.M(i22);
                                        if (i22 == this.f30408u1) {
                                            int Q3 = this.f30381g1.Q(i21);
                                            if (Q3 == M3 - 1) {
                                            ...
                                            i21 = (M3 - this.f30381g1.Q(b11)) + i21;
                                        } else {
                    ...
                    if (L0 != -1) {
                        if ((this.K1 || z10) && (el0Var = this.f30379f1) != null && !el0Var.f23987n) {
                            s4.h0 adapter = getAdapter();
                            if (adapter instanceof fl0) {
                                fl0 fl0Var = (fl0) adapter;
                                float H = fl0Var.H(this);
                                this.f30379f1.setIsVisible(fl0Var.E(this));
                                this.f30379f1.setProgress(Math.min(1.0f, H));
                                this.f30379f1.a(false);
                            }
                        }
                    }
                }
    ...
    public final void M0(float f7, float f10) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (rectF.contains(min2, min)) {
                ...
                int i11 = this.f30382g2;
                if (i11 != S) {
                    int i12 = this.f30380f2;
                    if (i11 <= i12 && S <= i12) {
                        z10 = false;
                    } else {
                        z10 = true;
                    }
                    org.telegram.ui.wn wnVar2 = this.f30384h2.d;
                    org.telegram.ui.jm jmVar = wnVar2.A0;
                    ArrayList arrayList = wnVar2.f39661u6;
                    int i13 = S - jmVar.J;
                    if (i13 >= 0 && i13 < arrayList.size()) {
                        MessageObject messageObject = (MessageObject) arrayList.get(i13);
                        if (messageObject.contentType == 0 && messageObject.hasValidGroupId() && (groupedMessages = (MessageObject.GroupedMessages) wnVar2.f39700x6.f(messageObject.getGroupId())) != null) {
                    ...
                    if (z10) {
                        int i14 = this.f30382g2;
                        if (S > i14) {
                            if (!this.f30384h2.f35889a) {
                                for (int i15 = i14 + 1; i15 <= S; i15++) {
                                    if (i15 != this.f30380f2 && this.f30384h2.a(i15)) {
                                        this.f30384h2.b(i15, true, min2, min);
                                    }
                                }
                            }
                        } else {
                            while (i14 > S) {
                                if (i14 != this.f30380f2 && this.f30384h2.a(i14)) {
                                    this.f30384h2.b(i14, false, min2, min);
                                }
                                i14--;
                            }
                        }
                    } else {
                        int i16 = this.f30382g2;
                        if (S > i16) {
                            while (i16 < S) {
                                if (i16 != this.f30380f2 && this.f30384h2.a(i16)) {
                                    this.f30384h2.b(i16, false, min2, min);
                                }
                                i16++;
                            }
                        } else if (!this.f30384h2.f35889a) {
                            for (int i17 = i16 - 1; i17 >= S; i17--) {
                                if (i17 != this.f30380f2 && this.f30384h2.a(i17)) {
                                    this.f30384h2.b(i17, true, min2, min);
                                }
                            }
                        }
                    }
    ...
    public final void N0(Canvas canvas, View view) {
        boolean z10;
        boolean z11;
        if (view != null && ((Boolean) this.H2.f25462a.run(view)).booleanValue()) {
            ...
            if (R == -1) {
                ...
                View U0 = U0(R - 1);
                View U02 = U0(R + 1);
                if (U0 != null && ((Boolean) this.H2.f25462a.run(U0)).booleanValue()) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                if (U02 != null && ((Boolean) this.H2.f25462a.run(U02)).booleanValue()) {
                    z11 = true;
                } else {
                    z11 = false;
                }
    ...
    public final void P0(Canvas canvas, View view, View view2, boolean z10, boolean z11) {
        ...
        if (view != null && view2 != null) {
            ...
            if (view2 instanceof w80) {
                f7 = ((w80) view2).getBottomInfoMargin();
            } else {
                f7 = 0.0f;
            }
            RectF rectF = AndroidUtilities.rectTmp;
    ...
    public final void Q0(android.graphics.Canvas r30) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.xl0.Q0(android.graphics.Canvas):void");
    }
    ...
    public final void R0(Canvas canvas) {
        ...
        if (!rect.isEmpty() && (zVar = this.D1) != null) {
            ...
            if ((i10 == -2 || i10 == this.E1) && this.F1 != null) {
                if (getAdapter() instanceof wl0) {
                    ((wl0) getAdapter()).getClass();
                }
            ...
            canvas.save();
            int i11 = this.I1;
            if ((i11 == -2 || i11 == this.E1) && (aVar = this.f30397o2) != null) {
                aVar.accept(canvas);
            }
            int i12 = this.I1;
    ...
    public final Drawable V0(View view, boolean z10) {
        boolean z11;
        boolean z12;
        if (view.getParent() == this && b1() && ((Boolean) this.H2.f25462a.run(view)).booleanValue()) {
            int R = RecyclerView.R(view);
            boolean z13 = true;
            if (R == -1) {
                z12 = false;
            ...
            if (z11 && z12 && !z10) {
                ...
                if (z11 && z13) {
                    return org.telegram.ui.ActionBar.h6.b0(0, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19059d6, this.f30399p2));
                }
                z12 = z13;
            }
            Path path = new Path();
            ...
            return new dl0(this, view, path, rectF);
        }
        return null;
    }

    public Integer W0(int i10) {
        GenericProvider genericProvider = this.f30413w2;
    ...
    public final void c1() {
        if (!this.f30385i1) {
            ...
            View view = this.f30373c1;
            if (view != null && view.getVisibility() != 8) {
                this.f30373c1.setVisibility(8);
            }
        }
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        View view;
        float f7;
        cl0 cl0Var = this.f30395n2;
        if (cl0Var != null) {
            xl0 xl0Var = cl0Var.f23349a;
            if (cl0Var.d || cl0Var.e) {
                for (int i10 = 0; i10 < xl0Var.getChildCount(); i10++) {
                    View childAt = xl0Var.getChildAt(i10);
                    int R = RecyclerView.R(childAt);
                    if (R >= 0 && !cl0Var.f23351c.contains(childAt)) {
                        Float f10 = (Float) cl0Var.f23350b.get(R, null);
                        if (f10 == null) {
        ...
        ai.f0 f0Var = this.f30375d1;
        if (f0Var != null) {
            f0Var.draw(canvas);
        }
        if (!this.f30418z1) {
            int i11 = this.f30416y1;
            float f11 = 0.0f;
            if (i11 == 1) {
                if (this.f30381g1 != null && !this.f30398p1.isEmpty()) {
                    for (int i12 = 0; i12 < this.f30398p1.size(); i12++) {
                        View view2 = (View) this.f30398p1.get(i12);
            ...
            } else if (i11 == 2 && this.f30381g1 != null && (view = this.f30402r1) != null && view.getAlpha() != 0.0f) {
                int save2 = canvas.save();
                int intValue2 = ((Integer) this.f30402r1.getTag()).intValue();
                if (LocaleController.isRTL) {
                    f11 = getWidth() - this.f30402r1.getWidth();
                }
                canvas.translate(f11, intValue2);
                Drawable drawable = this.l1;
                if (drawable != null) {
                    drawable.setBounds(0, this.f30402r1.getMeasuredHeight(), getWidth(), this.l1.getIntrinsicHeight() + this.f30402r1.getMeasuredHeight());
                    this.l1.setAlpha((int) (this.f30392m1 * 255.0f));
                    this.l1.draw(canvas);
                    long elapsedRealtime = SystemClock.elapsedRealtime();
                    long min = Math.min(20L, elapsedRealtime - this.f30396o1);
                    this.f30396o1 = elapsedRealtime;
                    float f12 = this.f30392m1;
                    float f13 = this.f30394n1;
                    if (f12 < f13) {
                ...
                canvas.clipRect(0, 0, getWidth(), this.f30402r1.getMeasuredHeight());
                this.f30402r1.draw(canvas);
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            if (this.f30417y2 == 0 && this.f30419z2) {
                setOverScrollMode(0);
            }
            this.f30417y2++;
        } else if (action == 1 || action == 3) {
            int i10 = this.f30417y2 - 1;
            this.f30417y2 = i10;
            if (i10 == 0 && this.f30419z2) {
                setOverScrollMode(2);
            }
        }
        el0 fastScroll = getFastScroll();
        if ((fastScroll != null && fastScroll.f23972a0 && fastScroll.f23985k0 && motionEvent.getActionMasked() != 1 && motionEvent.getActionMasked() != 3) || (this.f30381g1 != null && (view = this.f30402r1) != null && view.getAlpha() != 0.0f && this.f30402r1.dispatchTouchEvent(motionEvent))) {
            return true;
        }
    ...
    public final void e1(il0 il0Var, int i10, boolean z10) {
        jc0 jc0Var = this.V1;
        if (jc0Var != null) {
            AndroidUtilities.cancelRunOnUIThread(jc0Var);
            this.V1 = null;
        }
        s4.c1 K = K(il0Var.run());
        if (K != null) {
            View view = K.f42959a;
            int c10 = K.c();
            this.f30415x2 = c10;
    ...
    public final void f0(View view) {
        if (getAdapter() instanceof wl0) {
            s4.c1 G = G(view);
            if (G != null) {
                view.setEnabled(((wl0) getAdapter()).D(G));
                if (this.f30401q2) {
                    view.setAccessibilityDelegate(this.f30403r2);
                    return;
                }
                return;
            }
    ...
    public View getEmptyView() {
        return this.f30373c1;
    }

    public el0 getFastScroll() {
        return this.f30379f1;
    }

    public ArrayList<View> getHeaders() {
        return this.f30398p1;
    }

    public ArrayList<View> getHeadersCache() {
        return this.f30400q1;
    }

    public ll0 getOnItemClickListener() {
        return this.V0;
    }

    public s4.s0 getOnScrollListener() {
        return this.f30370a1;
    }

    public View getPinnedHeader() {
        return this.f30402r1;
    }
    ...
    public final void i1(int i10, View view) {
        ...
        if (this.D1 != null) {
            ...
            } else if (this.f30372b2 > 0 && getAdapter() != null) {
                org.telegram.ui.Cells.z zVar = this.D1;
                if (i10 == 0) {
                    i11 = this.f30372b2;
                } else {
    ...
    public final void j1() {
        ...
        this.U1 = null;
        View view = this.F1;
        if (view != null && (i10 = this.f30415x2) != -1) {
            i1(i10, view);
            org.telegram.ui.Cells.z zVar = this.D1;
            if (zVar != null) {
    ...
    public final void l1(xl0 xl0Var, boolean z10) {
        ViewParent parent;
        if (xl0Var != null && (parent = xl0Var.getParent()) != null) {
    ...
    public final void n1(ol0 ol0Var, long j3) {
        boolean z10;
        this.Y0 = ol0Var;
        ka.c cVar = this.M1;
        if (ol0Var != null) {
    ...
    public void onAttachedToWindow() {
        ...
        el0 el0Var = this.f30379f1;
        if (el0Var != null && el0Var.getParent() != getParent()) {
            ViewGroup viewGroup = (ViewGroup) this.f30379f1.getParent();
            if (viewGroup != null) {
                viewGroup.removeView(this.f30379f1);
            }
            ((ViewGroup) getParent()).addView(this.f30379f1);
        }
    }
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (el0Var != null) {
            ...
            int i15 = i11 + i14;
            el0 el0Var2 = this.f30379f1;
            if (el0Var2.f23981g0) {
                el0Var2.layout(0, i15, el0Var2.getMeasuredWidth(), this.f30379f1.getMeasuredHeight() + i15);
            } else {
                int measuredWidth = getMeasuredWidth() - this.f30379f1.getMeasuredWidth();
                el0 el0Var3 = this.f30379f1;
                el0Var3.layout(measuredWidth, i15, el0Var3.getMeasuredWidth() + measuredWidth, this.f30379f1.getMeasuredHeight() + i15);
            }
            this.J1 = false;
        }
        L0(false);
    ...
    public void onMeasure(int i10, int i11) {
        ...
        el0 el0Var = this.f30379f1;
        if (el0Var != null && el0Var.getLayoutParams() != null) {
            el0 el0Var2 = this.f30379f1;
            if (el0Var2.f23971a) {
                i12 = getPaddingTop();
            } else {
                i12 = el0Var2.f23982h0;
            }
            int measuredHeight = (getMeasuredHeight() - i12) - getPaddingBottom();
            this.f30379f1.getLayoutParams().height = measuredHeight;
            this.f30379f1.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(132.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(measuredHeight, 1073741824));
        }
        this.f30374c2 = ViewConfiguration.get(getContext()).getScaledTouchSlop();
    }
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        int i14 = this.f30416y1;
        if (i14 == 1) {
            if (this.f30381g1 != null && !this.f30398p1.isEmpty()) {
                for (int i15 = 0; i15 < this.f30398p1.size(); i15++) {
                    T0((View) this.f30398p1.get(i15), true);
                }
            }
        } else if (i14 == 2 && this.f30381g1 != null && (view = this.f30402r1) != null) {
            T0(view, true);
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        el0 el0Var = this.f30379f1;
        if (el0Var != null && el0Var.f23987n) {
            return false;
        }
        boolean z10 = this.f30376d2;
        org.telegram.ui.Cells.t6 t6Var = this.D2;
        if (z10 && motionEvent.getAction() != 0 && motionEvent.getAction() != 1 && motionEvent.getAction() != 3) {
            if (this.f30390k2 == Float.MAX_VALUE && this.f30391l2 == Float.MAX_VALUE) {
                this.f30390k2 = motionEvent.getX();
                this.f30391l2 = motionEvent.getY();
            }
            if (!this.f30378e2 && Math.abs(motionEvent.getY() - this.f30391l2) > this.f30374c2) {
                this.f30378e2 = true;
                l1(this, true);
            }
            if (this.f30378e2) {
                ...
                int[] iArr = this.f30393m2;
                org.telegram.ui.wn wnVar = niVar.d;
                iArr[0] = (int) wnVar.f39639s9;
                iArr[1] = wnVar.Aa;
                if (motionEvent.getY() > (getMeasuredHeight() - AndroidUtilities.dp(56.0f)) - this.f30393m2[1] && (this.f30382g2 >= this.f30380f2 || !this.f30384h2.f35889a)) {
                    this.f30388j2 = false;
                    if (!this.f30386i2) {
                        this.f30386i2 = true;
                ...
                } else if (motionEvent.getY() < AndroidUtilities.dp(56.0f) + this.f30393m2[0] && (this.f30382g2 <= this.f30380f2 || !this.f30384h2.f35889a)) {
                    this.f30388j2 = true;
                    if (!this.f30386i2) {
                        this.f30386i2 = true;
                        AndroidUtilities.cancelRunOnUIThread(t6Var);
        ...
        this.f30390k2 = Float.MAX_VALUE;
        this.f30391l2 = Float.MAX_VALUE;
        this.f30376d2 = false;
        this.f30378e2 = false;
        l1(this, false);
        this.f30386i2 = false;
    ...
    public final void s1(Utilities.CallbackReturn callbackReturn, Utilities.CallbackReturn callbackReturn2, int i10, float f7, Utilities.Callback5 callback5, boolean z10) {
        setSelectorDrawableColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19166j6, this.f30399p2));
        ...
        jl0 jl0Var = new jl0(this, callbackReturn, i10, z10);
        this.H2 = jl0Var;
        i(jl0Var);
    }
    ...
    public void setAdapter(s4.h0 h0Var) {
        s4.h0 adapter = getAdapter();
        gg.p1 p1Var = this.f30407t2;
        if (adapter != null) {
            adapter.f43008a.unregisterObserver(p1Var);
        }
        ArrayList arrayList = this.f30398p1;
        if (arrayList != null) {
            arrayList.clear();
            this.f30400q1.clear();
        }
        ...
        this.G1.setEmpty();
        this.f30402r1 = null;
        if (h0Var instanceof tl0) {
            this.f30381g1 = (tl0) h0Var;
        } else {
            this.f30381g1 = null;
        }
    ...
    public void setFastScrollEnabled(int i10) {
        this.f30379f1 = new el0(this, getContext(), i10);
        if (getParent() != null) {
            ((ViewGroup) getParent()).addView(this.f30379f1);
        }
    }
    ...
    public void setFastScrollVisible(boolean z10) {
        ...
        el0Var.setVisibility(i10);
        this.f30379f1.f23972a0 = z10;
    }
    ...
    public void setItemSelectorColorProvider(GenericProvider<Integer, Integer> genericProvider) {
        this.f30413w2 = genericProvider;
    }

    public void setItemsEnterAnimator(cl0 cl0Var) {
        this.f30395n2 = cl0Var;
    }
    ...
    public void setListSelectorColor(Integer num) {
        ...
        if (num == null) {
            ...
            intValue = org.telegram.ui.ActionBar.h6.v0(i10, this.f30399p2);
        } else {
    ...
    public void setOnInterceptTouchListener(kl0 kl0Var) {
        this.f30371b1 = kl0Var;
    }
    ...
    public void setOnItemLongClickListener(nl0 nl0Var) {
        ...
        this.X0 = nl0Var;
        ka.c cVar = this.M1;
        boolean z10 = nl0Var != null;
        m20 m20Var = (m20) cVar.f13552b;
        m20Var.f26302t = z10;
        m20Var.f26303u = longPressTimeout;
    }
    ...
    public void setSectionsType(int i10) {
        ...
        this.f30398p1 = new ArrayList();
        this.f30400q1 = new ArrayList();
    }
    ...
    public xl0(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.U0 = true;
        this.f30389k1 = true;
        this.f30404s1 = -1;
        ...
        this.f30391l2 = Float.MAX_VALUE;
        this.f30401q2 = true;
        this.f30403r2 = new qe(1);
        this.f30405s2 = true;
        this.f30407t2 = new gg.p1(this, 1);
        ...
        super.setOnScrollListener(new vg0(this, 2));
        this.E.add(new sl0(this, context));
    }
    ...
    public void setOnItemLongClickListener(ol0 ol0Var) {
        n1(ol0Var, ViewConfiguration.getLongPressTimeout());
    }
}
