...
public final class s20 extends FrameLayout implements org.telegram.ui.Components.voip.o0 {
    ...
    public boolean O;
    public final t20 P;
    public final h9 f28100a;
    public TLRPC.User f28101b;
    public TLRPC.Chat f28102c;
    public final w9 d;
    public long e;
    public ChatObject.VideoParticipant f28103f;
    public TLRPC.GroupCallParticipant h;
    public final Paint f28104n;
    public final Paint f28105r;
    public float f28106s;
    public org.telegram.ui.Components.voip.u v;
    public String f28107w;
    public String f28108x;
    public int f28109y;
    ...
    public s20(t20 t20Var, Context context) {
        ...
        paint.setColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19349tg, false));
        paint2.setColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19293qg, false));
    ...
    private void setSelectedProgress(float f7) {
        if (this.G != f7) {
            this.G = f7;
            this.f28105r.setAlpha((int) (f7 * 255.0f));
        }
    }
    ...
    public final void b(boolean z10) {
        t20 t20Var = this.P;
        if (!t20Var.f28384r.isDismissed()) {
            if (z10 && this.v == null) {
                this.v = org.telegram.ui.Components.voip.u.c(t20Var.h, t20Var.f28383n, null, this, null, this.f28103f, t20Var.f28381c, t20Var.f28384r);
            } else if (!z10) {
    ...
    public final void c(Canvas canvas) {
        if (this.f28107w != null) {
            canvas.save();
            int A = org.telegram.messenger.ok.A(24.0f, getMeasuredWidth() - this.f28109y, 2);
            int alpha = (int) (getAlpha() * this.f28106s * 255.0f);
            TextPaint textPaint = this.E;
            textPaint.setAlpha(alpha);
            canvas.drawText(this.f28107w, AndroidUtilities.dp(22.0f) + A, AndroidUtilities.dp(69.0f), textPaint);
            canvas.restore();
            canvas.save();
            canvas.translate(A, AndroidUtilities.dp(53.0f));
            org.telegram.ui.id idVar = this.F;
            if (idVar.getDrawable() != null) {
                idVar.getDrawable().setAlpha((int) (getAlpha() * this.f28106s * 255.0f));
                idVar.draw(canvas);
    ...
    public final void dispatchDraw(Canvas canvas) {
        org.telegram.ui.Components.voip.u uVar = this.v;
        if (uVar != null && !uVar.f29635b && !uVar.f29654r && uVar.v && uVar.f29633a.d.isFirstFrameRendered() && uVar.getAlpha() == 1.0f && !this.P.f28384r.F2) {
            d(canvas);
            return;
        }
        if (this.f28106s > 0.0f) {
            float measuredWidth = (1.0f - this.f28106s) * (getMeasuredWidth() / 2.0f);
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(measuredWidth, measuredWidth, getMeasuredWidth() - measuredWidth, getMeasuredHeight() - measuredWidth);
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(13.0f), AndroidUtilities.dp(13.0f), this.f28104n);
            d(canvas);
        }
        w9 w9Var = this.d;
    ...
    public final void e(ChatObject.VideoParticipant videoParticipant, TLRPC.GroupCallParticipant groupCallParticipant) {
        ...
        boolean z11 = true;
        w9 w9Var = this.d;
        h9 h9Var = this.f28100a;
        if (peerId > 0) {
            TLRPC.User user = AccountInstance.getInstance(i10).getMessagesController().getUser(Long.valueOf(this.e));
            this.f28101b = user;
            this.f28102c = null;
            h9Var.m(i10, user);
            this.f28108x = UserObject.getFirstName(this.f28101b);
            w9Var.getImageReceiver().setCurrentAccount(i10);
            w9Var.h(ImageLocation.getForUser(this.f28101b, 1), "50_50", h9Var, this.f28101b);
        } else {
            TLRPC.Chat chat = AccountInstance.getInstance(i10).getMessagesController().getChat(Long.valueOf(-this.e));
            this.f28102c = chat;
            this.f28101b = null;
            h9Var.k(i10, chat);
            TLRPC.Chat chat2 = this.f28102c;
            if (chat2 != null) {
                this.f28108x = chat2.title;
                w9Var.getImageReceiver().setCurrentAccount(i10);
                w9Var.h(ImageLocation.getForChat(this.f28102c, 1), "50_50", h9Var, this.f28102c);
            }
        }
        if (j3 == this.e) {
            z10 = true;
        ...
        if (videoParticipant == null) {
            if (t20Var.f28383n.d != MessageObject.getPeerId(groupCallParticipant.peer)) {
                z11 = false;
            }
            this.H = z11;
        } else {
            ChatObject.VideoParticipant videoParticipant2 = t20Var.f28383n.e;
    ...
    public final void onAttachedToWindow() {
        ...
        t20 t20Var = this.P;
        org.telegram.ui.d60 d60Var = t20Var.f28384r;
        if (t20Var.f28385s && this.f28103f != null) {
            b(true);
        }
        this.K = true;
        if (d60Var.f32998t2.size() > 0) {
            this.I = (org.telegram.ui.Components.voip.p0) hg.c.x(1, d60Var.f32998t2);
        } else {
            this.I = new org.telegram.ui.Components.voip.p0();
        }
        org.telegram.ui.Components.voip.p0 p0Var = this.I;
        p0Var.f29533g = this;
        p0Var.f29531c = this.F;
        p0Var.c(false);
    ...
    public final void onDetachedFromWindow() {
        ...
        org.telegram.ui.Components.voip.p0 p0Var = this.I;
        if (p0Var != null) {
            this.P.f28384r.f32998t2.add(p0Var);
            org.telegram.ui.Components.voip.p0 p0Var2 = this.I;
            p0Var2.f29531c = null;
            p0Var2.c(false);
            this.I.b();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f28108x != null) {
            int min = (int) Math.min(AndroidUtilities.dp(46.0f), textPaint.measureText(this.f28108x));
            this.f28109y = min;
            this.f28107w = TextUtils.ellipsize(this.f28108x, textPaint, min, TextUtils.TruncateAt.END).toString();
        }
