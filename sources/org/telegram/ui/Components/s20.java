...
public final class s20 extends kl0 {
    public ChatObject.Call f30198c;
    public final int d;
    public ArrayList h;
    public org.telegram.ui.a40 f30201n;
    public final org.telegram.ui.j60 f30202r;
    public final ArrayList f30199e = new ArrayList();
    public final ArrayList f30200f = new ArrayList();
    public boolean f30203s = false;
    ...
    public final void G(ll0 ll0Var, boolean z10) {
        ...
        ArrayList arrayList = this.f30199e;
        ArrayList arrayList2 = this.f30200f;
        if (z10) {
            ArrayList arrayList3 = new ArrayList(arrayList2);
            ArrayList arrayList4 = new ArrayList(arrayList);
            arrayList2.clear();
            ChatObject.Call call = this.f30198c;
            if (!call.call.rtmp_stream) {
                arrayList2.addAll(call.visibleParticipants);
            }
            arrayList.clear();
            ChatObject.Call call2 = this.f30198c;
        ...
        arrayList2.clear();
        ChatObject.Call call3 = this.f30198c;
        if (!call3.call.rtmp_stream) {
            arrayList2.addAll(call3.visibleParticipants);
        }
        arrayList.clear();
        ChatObject.Call call4 = this.f30198c;
    ...
    @Override
    public final int h() {
        return this.f30200f.size() + this.f30199e.size();
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        r20 r20Var = (r20) c1Var.f45767a;
        ChatObject.VideoParticipant videoParticipant2 = r20Var.f29918f;
        ArrayList arrayList = this.f30199e;
        ...
        if (videoParticipant2 != null && !videoParticipant2.equals(videoParticipant) && r20Var.K && r20Var.getRenderer() != null) {
            ...
            if (r20Var.getRenderer() == null && videoParticipant != null && this.f30203s) {
                r20Var.b(true);
