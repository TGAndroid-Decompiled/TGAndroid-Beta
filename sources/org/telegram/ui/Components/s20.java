...
public final class s20 extends kl0 {
    public ChatObject.Call f27746c;
    public final int d;
    public ArrayList h;
    public org.telegram.ui.a40 f27748n;
    public final org.telegram.ui.i60 f27749r;
    public final ArrayList e = new ArrayList();
    public final ArrayList f27747f = new ArrayList();
    public boolean f27750s = false;
    ...
    public final void G(ll0 ll0Var, boolean z10) {
        ...
        ArrayList arrayList2 = this.f27747f;
        if (z10) {
            ArrayList arrayList3 = new ArrayList(arrayList2);
            ArrayList arrayList4 = new ArrayList(arrayList);
            arrayList2.clear();
            ChatObject.Call call = this.f27746c;
            if (!call.call.rtmp_stream) {
                arrayList2.addAll(call.visibleParticipants);
            }
            arrayList.clear();
            ChatObject.Call call2 = this.f27746c;
        ...
        arrayList2.clear();
        ChatObject.Call call3 = this.f27746c;
        if (!call3.call.rtmp_stream) {
            arrayList2.addAll(call3.visibleParticipants);
        }
        arrayList.clear();
        ChatObject.Call call4 = this.f27746c;
    ...
    @Override
    public final int h() {
        return this.f27747f.size() + this.e.size();
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        r20 r20Var = (r20) c1Var.f42671a;
        ChatObject.VideoParticipant videoParticipant2 = r20Var.f27515f;
        ArrayList arrayList = this.e;
        ...
        if (videoParticipant2 != null && !videoParticipant2.equals(videoParticipant) && r20Var.K && r20Var.getRenderer() != null) {
            ...
            if (r20Var.getRenderer() == null && videoParticipant != null && this.f27750s) {
                r20Var.b(true);
