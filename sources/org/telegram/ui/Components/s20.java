...
public final class s20 extends ul0 {
    public ChatObject.Call f28010c;
    public final int d;
    public ArrayList h;
    public org.telegram.ui.a40 f28012n;
    public final org.telegram.ui.i60 f28013r;
    public final ArrayList e = new ArrayList();
    public final ArrayList f28011f = new ArrayList();
    public boolean f28014s = false;
    ...
    public final void G(vl0 vl0Var, boolean z10) {
        ...
        ArrayList arrayList2 = this.f28011f;
        if (z10) {
            ArrayList arrayList3 = new ArrayList(arrayList2);
            ArrayList arrayList4 = new ArrayList(arrayList);
            arrayList2.clear();
            ChatObject.Call call = this.f28010c;
            if (!call.call.rtmp_stream) {
                arrayList2.addAll(call.visibleParticipants);
            }
            arrayList.clear();
            ChatObject.Call call2 = this.f28010c;
        ...
        arrayList2.clear();
        ChatObject.Call call3 = this.f28010c;
        if (!call3.call.rtmp_stream) {
            arrayList2.addAll(call3.visibleParticipants);
        }
        arrayList.clear();
        ChatObject.Call call4 = this.f28010c;
    ...
    @Override
    public final int h() {
        return this.f28011f.size() + this.e.size();
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        r20 r20Var = (r20) c1Var.f42974a;
        ChatObject.VideoParticipant videoParticipant2 = r20Var.f27732f;
        ArrayList arrayList = this.e;
        ...
        if (videoParticipant2 != null && !videoParticipant2.equals(videoParticipant) && r20Var.K && r20Var.getRenderer() != null) {
            ...
            if (r20Var.getRenderer() == null && videoParticipant != null && this.f28014s) {
                r20Var.b(true);
