...
public final class s20 extends vl0 {
    public ChatObject.Call f28033c;
    public final int d;
    public ArrayList h;
    public org.telegram.ui.a40 f28035n;
    public final org.telegram.ui.i60 f28036r;
    public final ArrayList e = new ArrayList();
    public final ArrayList f28034f = new ArrayList();
    ...
    public final void G(wl0 wl0Var, boolean z10) {
        ...
        ArrayList arrayList2 = this.f28034f;
        if (z10) {
            ArrayList arrayList3 = new ArrayList(arrayList2);
            ArrayList arrayList4 = new ArrayList(arrayList);
            arrayList2.clear();
            ChatObject.Call call = this.f28033c;
            if (!call.call.rtmp_stream) {
                arrayList2.addAll(call.visibleParticipants);
            }
            arrayList.clear();
            ChatObject.Call call2 = this.f28033c;
        ...
        arrayList2.clear();
        ChatObject.Call call3 = this.f28033c;
        if (!call3.call.rtmp_stream) {
            arrayList2.addAll(call3.visibleParticipants);
        }
        arrayList.clear();
        ChatObject.Call call4 = this.f28033c;
    ...
    @Override
    public final int h() {
        return this.f28034f.size() + this.e.size();
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        r20 r20Var = (r20) c1Var.f42929a;
        ChatObject.VideoParticipant videoParticipant2 = r20Var.f27797f;
        ArrayList arrayList = this.e;
        ...
        if (videoParticipant2 != null && !videoParticipant2.equals(videoParticipant) && r20Var.K && r20Var.getRenderer() != null) {
            ...
            if (r20Var.getRenderer() == null && videoParticipant != null && this.f28037s) {
                r20Var.b(true);
