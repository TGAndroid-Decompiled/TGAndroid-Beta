...
public final class s20 extends FrameLayout implements org.telegram.ui.Components.voip.o0 {
    ...
    public boolean O;
    public final t20 P;
    public final h9 f28107a;
    public TLRPC.User f28108b;
    public TLRPC.Chat f28109c;
    public final w9 d;
    public long e;
    public ChatObject.VideoParticipant f28110f;
    public TLRPC.GroupCallParticipant h;
    public final Paint f28111n;
    public final Paint f28112r;
    public float f28113s;
    ...
    private void setSelectedProgress(float f7) {
        if (this.G != f7) {
            this.G = f7;
            this.f28112r.setAlpha((int) (f7 * 255.0f));
        }
    }
    ...
    public final void b(boolean z10) {
        t20 t20Var = this.P;
        if (!t20Var.f28390r.isDismissed()) {
            if (z10 && this.v == null) {
                this.v = org.telegram.ui.Components.voip.u.c(t20Var.h, t20Var.f28389n, null, this, null, this.f28110f, t20Var.f28387c, t20Var.f28390r);
            } else if (!z10) {
    ...
    public final void c(Canvas canvas) {
        if (this.f28114w != null) {
            canvas.save();
            int A = org.telegram.messenger.ok.A(24.0f, getMeasuredWidth() - this.f28116y, 2);
            int alpha = (int) (getAlpha() * this.f28113s * 255.0f);
            TextPaint textPaint = this.E;
            textPaint.setAlpha(alpha);
            canvas.drawText(this.f28114w, AndroidUtilities.dp(22.0f) + A, AndroidUtilities.dp(69.0f), textPaint);
            canvas.restore();
            canvas.save();
            canvas.translate(A, AndroidUtilities.dp(53.0f));
            org.telegram.ui.id idVar = this.F;
            if (idVar.getDrawable() != null) {
                idVar.getDrawable().setAlpha((int) (getAlpha() * this.f28113s * 255.0f));
                idVar.draw(canvas);
    ...
    public final void dispatchDraw(Canvas canvas) {
        org.telegram.ui.Components.voip.u uVar = this.v;
        if (uVar != null && !uVar.f29644b && !uVar.f29663r && uVar.v && uVar.f29642a.d.isFirstFrameRendered() && uVar.getAlpha() == 1.0f && !this.P.f28390r.F2) {
            d(canvas);
            return;
        }
        if (this.f28113s > 0.0f) {
            float measuredWidth = (1.0f - this.f28113s) * (getMeasuredWidth() / 2.0f);
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(measuredWidth, measuredWidth, getMeasuredWidth() - measuredWidth, getMeasuredHeight() - measuredWidth);
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(13.0f), AndroidUtilities.dp(13.0f), this.f28111n);
            d(canvas);
        }
        w9 w9Var = this.d;
    ...
    public final void e(ChatObject.VideoParticipant videoParticipant, TLRPC.GroupCallParticipant groupCallParticipant) {
        ...
        boolean z11 = true;
        w9 w9Var = this.d;
        h9 h9Var = this.f28107a;
        if (peerId > 0) {
            TLRPC.User user = AccountInstance.getInstance(i10).getMessagesController().getUser(Long.valueOf(this.e));
            this.f28108b = user;
            this.f28109c = null;
            h9Var.m(i10, user);
            this.f28115x = UserObject.getFirstName(this.f28108b);
            w9Var.getImageReceiver().setCurrentAccount(i10);
            w9Var.h(ImageLocation.getForUser(this.f28108b, 1), "50_50", h9Var, this.f28108b);
        } else {
            TLRPC.Chat chat = AccountInstance.getInstance(i10).getMessagesController().getChat(Long.valueOf(-this.e));
            this.f28109c = chat;
            this.f28108b = null;
            h9Var.k(i10, chat);
            TLRPC.Chat chat2 = this.f28109c;
            if (chat2 != null) {
                this.f28115x = chat2.title;
                w9Var.getImageReceiver().setCurrentAccount(i10);
                w9Var.h(ImageLocation.getForChat(this.f28109c, 1), "50_50", h9Var, this.f28109c);
            }
        }
        if (j3 == this.e) {
            z10 = true;
        ...
        if (videoParticipant == null) {
            if (t20Var.f28389n.d != MessageObject.getPeerId(groupCallParticipant.peer)) {
                z11 = false;
            }
            this.H = z11;
        } else {
            ChatObject.VideoParticipant videoParticipant2 = t20Var.f28389n.e;
    ...
    public final void onAttachedToWindow() {
        ...
        t20 t20Var = this.P;
        org.telegram.ui.d60 d60Var = t20Var.f28390r;
        if (t20Var.f28391s && this.f28110f != null) {
            b(true);
        }
        this.K = true;
    ...
    public final void onDetachedFromWindow() {
        ...
        org.telegram.ui.Components.voip.p0 p0Var = this.I;
        if (p0Var != null) {
            this.P.f28390r.f33014t2.add(p0Var);
            org.telegram.ui.Components.voip.p0 p0Var2 = this.I;
            p0Var2.f29540c = null;
            p0Var2.c(false);
            this.I.b();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f28115x != null) {
            int min = (int) Math.min(AndroidUtilities.dp(46.0f), textPaint.measureText(this.f28115x));
            this.f28116y = min;
            this.f28114w = TextUtils.ellipsize(this.f28115x, textPaint, min, TextUtils.TruncateAt.END).toString();
        }
