...
public class RadialProgress {
    ...
    public void draw(Canvas canvas) {
        ...
        if (Math.abs(this.progressRect.width() - AndroidUtilities.dp(44.0f)) < AndroidUtilities.density) {
            i2 = 20;
            float f4 = 16;
            f2 = this.progressRect.centerX() + AndroidUtilities.dp(f4);
            f = this.progressRect.centerY() + AndroidUtilities.dp(f4);
            i = 0;
        } else {
            i2 = 22;
        ...
        if (canvas2 != null) {
            float f6 = i2 + 18 + i;
            canvas2.drawCircle(AndroidUtilities.dp(f6), AndroidUtilities.dp(f6), AndroidUtilities.dp(i4 + 1) * f5, Theme.checkboxSquare_eraserPaint);
        } else {
        ...
        if (drawable7 != null) {
            ...
            float f7 = i4;
            this.previousMiniDrawable.setBounds((int) (f2 - (AndroidUtilities.dp(f7) * f5)), (int) (f - (AndroidUtilities.dp(f7) * f5)), (int) ((AndroidUtilities.dp(f7) * f5) + f2), (int) ((AndroidUtilities.dp(f7) * f5) + f));
        ...
        if (!this.hideCurrentDrawable && (drawable2 = this.currentMiniDrawable) != null) {
            ...
            float f8 = i4;
            this.currentMiniDrawable.setBounds((int) (f2 - AndroidUtilities.dp(f8)), (int) (f - AndroidUtilities.dp(f8)), (int) (AndroidUtilities.dp(f8) + f2), (int) (AndroidUtilities.dp(f8) + f));
        ...
        if (this.currentMiniWithRound || this.previousMiniWithRound) {
            ...
            float f9 = i4 - 2;
            this.cicleRect.set(f2 - (AndroidUtilities.dp(f9) * f5), f - (AndroidUtilities.dp(f9) * f5), f2 + (AndroidUtilities.dp(f9) * f5), f + (AndroidUtilities.dp(f9) * f5));
