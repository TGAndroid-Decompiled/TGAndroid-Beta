...
public final class q extends za implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final FrameLayout f27206a0;
    public final TextView f27207b0;
    public final TextView f27208c0;
    public final FrameLayout f27209d0;
    public final ci.d f27210e0;
    public w51 f27211f0;
    public int f27212g0;
    public final TL_aicompose.aiComposeToneExample[] f27213h0;
    ...
    public q(Context context, TL_aicompose.AiComposeTone aiComposeTone, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.f27213h0 = aicomposetoneexampleArr;
    ...
    public static void Q(final q qVar) {
        ...
        int i10 = qVar.f27212g0 + 1;
        qVar.f27212g0 = i10;
        TL_aicompose.aiComposeToneExample[] aicomposetoneexampleArr = qVar.f27213h0;
        if (i10 >= aicomposetoneexampleArr.length) {
            qVar.f27212g0 = 0;
        }
        final int i11 = qVar.f27212g0;
            ...
            ConnectionsManager.getInstance(qVar.currentAccount).sendRequestTyped(gettoneexample, new Object(), new Utilities.Callback2() {
                ...
                public final void run(Object obj, Object obj2) {
                    ...
                    if (aicomposetoneexample != null) {
                        qVar2.f27213h0[i11] = aicomposetoneexample;
                        qVar2.f27211f0.N(true);
                        return;
                    }
                    qVar2.getClass();
                }
    ...
    public static void R(q qVar, ArrayList arrayList, w51 w51Var) {
        ...
        FrameLayout frameLayout = qVar.f27206a0;
        ...
        arrayList.add(i51.B(null));
        arrayList.add(i51.l(qVar.f27207b0));
        arrayList.add(i51.C(AndroidUtilities.dp(1.0f)));
        arrayList.add(i51.l(qVar.f27208c0));
        ...
        if (aiComposeTone instanceof TL_aicompose.TL_aiComposeTone) {
            ...
            TL_aicompose.aiComposeToneExample aicomposetoneexample = qVar.f27213h0[qVar.f27212g0];
            w51Var.U();
    ...
    public static void S(q qVar, org.telegram.ui.ActionBar.e6 e6Var, TL_aicompose.AiComposeTone aiComposeTone, TLRPC.TL_error tL_error) {
        FrameLayout frameLayout = qVar.f27209d0;
        qVar.f27210e0.setLoading(false);
        if (tL_error != null) {
    ...
    public final boolean U() {
        ...
        if (aiComposeTone instanceof TL_aicompose.TL_aiComposeTone) {
            ...
            while (true) {
                ...
                if ((aiComposeTone2 instanceof TL_aicompose.TL_aiComposeTone) && ((TL_aicompose.TL_aiComposeTone) aiComposeTone2).f18322id == tL_aiComposeTone.f18322id) {
                    return true;
                }
                i10++;
            }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.loadedAiComposeTones) {
            ...
            this.f27210e0.setText(LocaleController.getString(i12));
        }
    }
