...
public final class bi extends lu {
    ...
    public int W;
    public int f23026a0;
    public ValueAnimator f23027b0;
    public final wi f23028c0;
    ...
    public final void dispatchDraw(Canvas canvas) {
        if (this.V) {
            du editText = this.f23028c0.E0.getEditText();
            editText.setOffsetY(editText.getOffsetY() - ((this.f23026a0 - editText.getScrollY()) + (this.W - editText.getMeasuredHeight())));
            ValueAnimator ofFloat = ValueAnimator.ofFloat(editText.getOffsetY(), 0.0f);
            ofFloat.addUpdateListener(new ai.x(14, this, editText));
            ValueAnimator valueAnimator = this.f23027b0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            this.f23027b0 = ofFloat;
    ...
    public final void i(Menu menu) {
        org.telegram.ui.ActionBar.m2 m2Var = this.f23028c0.f30020f0;
    ...
    public final void q(int i10, int i11) {
        ...
        if (!TextUtils.isEmpty(getEditText().getText())) {
            ...
            this.f23026a0 = getEditText().getScrollY();
            invalidate();
        } else {
