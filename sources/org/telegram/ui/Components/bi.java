...
public final class bi extends qv0 {
    public int f23674t0;
    public final RectF f23675u0;
    public boolean f23676v0;
    public float f23677w0;
    public final ai f23678x0;
    public final li f23679y0;

    public bi(li liVar, Context context) {
        super(context, null);
        this.f23679y0 = liVar;
        this.f23675u0 = new RectF();
        this.f23678x0 = new ai(this, this);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        li liVar = this.f23679y0;
        sg.d dVar = liVar.B2;
        sg.d dVar2 = liVar.A2;
        if (Build.VERSION.SDK_INT >= 31 && liVar.f26765z2 != null) {
            liVar.Z0();
            if (dVar2 != null) {
        ...
        if ((diVar2 == omVar || (diVar = liVar.f26752w0) == omVar || (diVar2 == liVar.f26702g0 && diVar == null)) && diVar2 != null) {
            canvas.save();
            float f16 = liVar.f26710i2;
            boolean z4 = liVar.f26692d0;
            ah.d dVar3 = liVar.L0;
            mh mhVar = liVar.f26700f1;
            ...
            if (dVar3 != null) {
                f11 = dVar3.getAlpha() * dVar3.getMeasuredHeight();
            } else {
                f11 = 0.0f;
            }
            int i27 = dp4 + ((int) f11);
            ...
            if (h == 2) {
                ...
                float f19 = i27;
                f12 = 0.0f;
                if (diVar2 == liVar.f26717l0) {
                    dp = AndroidUtilities.dp(11.0f);
                } else {
                    if (diVar2 == liVar.f26711j0) {
                        dp2 = AndroidUtilities.dp(3.0f);
                    } else if (diVar2 == liVar.f26714k0) {
                        dp2 = AndroidUtilities.dp(3.0f);
                    } else {
            ...
            if (liVar.f26748v0.f()) {
                q12 = liVar.f26748v0.getCustomBackground();
            } else {
                q12 = liVar.q1(true);
            }
            ...
            RectF rectF = this.f23675u0;
            if (h == 2) {
                org.telegram.ui.ActionBar.j6.f20185t0.setColor(q12);
                org.telegram.ui.ActionBar.j6.f20185t0.setAlpha(alpha2);
            ...
            if ((f14 != 1.0f && h != 2) || liVar.f26748v0.e()) {
                Paint paint = org.telegram.ui.ActionBar.j6.f20185t0;
                if (liVar.f26748v0.e()) {
                    q12 = liVar.f26748v0.getCustomActionBarBackground();
                }
                paint.setColor(q12);
                org.telegram.ui.ActionBar.j6.f20185t0.setAlpha(alpha2);
            ...
            if (liVar.f26748v0.e()) {
                org.telegram.ui.ActionBar.j6.f20185t0.setColor(liVar.f26748v0.getCustomActionBarBackground());
                org.telegram.ui.ActionBar.j6.f20185t0.setAlpha(alpha2);
                int p13 = liVar.p1(0);
                if (!z4) {
                ...
                canvas.save();
                canvas.drawRect(rectF, org.telegram.ui.ActionBar.j6.f20185t0);
                canvas.restore();
            }
            if ((mhVar == null || mhVar.getAlpha() != 1.0f) && f14 != f12) {
                ...
                if (h == 2) {
                    ...
                    f17 = f14;
                } else if (liVar.f26748v0.e()) {
                    int customActionBarBackground = liVar.f26748v0.getCustomActionBarBackground();
                ...
                org.telegram.ui.ActionBar.j6.f20185t0.setAlpha((int) (diVar2.getAlpha() * alpha4 * f17 * f14));
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f), org.telegram.ui.ActionBar.j6.f20185t0);
            }
            canvas.restore();
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        int i30;
        li liVar = this.f23679y0;
        boolean z10 = liVar.f26692d0;
        ah.d dVar = liVar.L0;
        pg.b bVar = liVar.f26756x0;
        mh mhVar = liVar.f26700f1;
        eg.l1 l1Var = liVar.U0;
        if ((view instanceof di) && view.getAlpha() > 0.0f) {
            canvas.save();
            canvas.translate(0.0f, liVar.f26710i2);
            ...
            int i31 = dp5 + i14;
            if (dVar != null) {
                f14 = dVar.getAlpha() * dVar.getMeasuredHeight();
            } else {
                f14 = 0.0f;
            }
            int i32 = i31 + ((int) f14);
            if (diVar2 == liVar.f26748v0) {
                i15 = 0;
            } else {
                i15 = 1;
            }
            ...
            om omVar = liVar.f26722n0;
            if (diVar3 != omVar && (diVar = liVar.f26752w0) != omVar && (diVar3 != liVar.f26702g0 || diVar != null)) {
                z4 = true;
            } else {
                z4 = false;
            }
            ...
            if (view != liVar.f26705h0 && view != liVar.f26728p0 && view != liVar.f26708i0) {
                canvas.save();
            ...
            if (z4) {
                ...
                if ((mhVar == null || mhVar.getAlpha() != 1.0f) && f17 != f15) {
                    ...
                    org.telegram.ui.ActionBar.j6.f20185t0.setColor(themedColor);
                    org.telegram.ui.ActionBar.j6.f20185t0.setAlpha((int) (view.getAlpha() * alpha3 * alpha * f17));
                    canvas.drawRoundRect(rectF, AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f), org.telegram.ui.ActionBar.j6.f20185t0);
                }
            }
            canvas.restore();
            ...
            if (diVar4 != null) {
                ...
                if (dVar != null) {
                    f12 = dVar.getAlpha() * dVar.getMeasuredHeight();
                } else {
                    f12 = 0.0f;
                }
                ...
                if (h9 != 2) {
                    ...
                    if (i13 + i40 < i12) {
                        float f19 = i39;
                        if (diVar4 == liVar.f26717l0) {
                            dp = AndroidUtilities.dp(11.0f);
                        } else {
                            if (diVar4 == liVar.f26711j0) {
                                dp2 = AndroidUtilities.dp(3.0f);
                            } else if (diVar4 == liVar.f26714k0) {
                                dp2 = AndroidUtilities.dp(3.0f);
                            } else {
                                dp = AndroidUtilities.dp(4.0f);
                            }
            ...
            canvas.clipPath(bVar.h.f41210k);
            bVar.draw(canvas);
    ...
    public final void onDraw(Canvas canvas) {
        boolean z4 = this.f23679y0.f26692d0;
    }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        li liVar = this.f23679y0;
        int[] iArr = liVar.Y1;
        if (liVar.f26748v0.l(motionEvent)) {
            return true;
        }
        if (motionEvent.getAction() == 0) {
            ...
            if (iArr[0] != 0) {
                ...
                int i14 = i13 - (dp + i11);
                if (dVar != null) {
                    f10 = dVar.getAlpha() * dVar.getMeasuredHeight();
                } else {
                    f10 = 0.0f;
                }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ((FrameLayout.LayoutParams) liVar.f26690c1.getLayoutParams()).height = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight();
        biVar.f23676v0 = true;
        int min = (int) (i20 / Math.min(4.5f, liVar.f26757x1.h()));
        if (liVar.V1 != min) {
            liVar.V1 = min;
        ...
        if (liVar.f26711j0 != null && AndroidUtilities.dp(20.0f) >= 0) {
            qn qnVar3 = liVar.f26711j0;
            if (!qnVar3.D && !qnVar3.X0 && !qnVar3.f28165c1 && !qnVar3.f28169e1) {
                biVar.f23676v0 = true;
                qnVar3.a0();
                biVar.f23676v0 = false;
            }
        }
        if (liVar.f26714k0 != null && AndroidUtilities.dp(20.0f) >= 0) {
            qn qnVar4 = liVar.f26714k0;
            if (!qnVar4.D && !qnVar4.X0 && !qnVar4.f28165c1 && !qnVar4.f28169e1) {
                biVar.f23676v0 = true;
                qnVar4.a0();
                biVar.f23676v0 = false;
            }
        ...
        if (AndroidUtilities.dp(20.0f) >= 0) {
            ...
            if (z4) {
                ...
                qn qnVar5 = liVar.f26711j0;
                if (diVar == qnVar5 && qnVar5.B != null && qnVar5.f28169e1) {
                    o12 = AndroidUtilities.dp(120.0f);
                } else {
                    qn qnVar6 = liVar.f26714k0;
                    if (diVar == qnVar6 && qnVar6.B != null && qnVar6.f28169e1) {
                        o12 = AndroidUtilities.dp(120.0f);
                    } else {
                        o12 = 0;
                    }
            ...
            if (f11 != null) {
                i15 = f11.f43130a.f(8).d;
            } else {
                i15 = 0;
            }
            r0.m1 f12 = r0.j0.f(biVar);
            if (f12 != null) {
                i16 = f12.f43130a.f(527).d;
            } else {
                i16 = 0;
            }
            Math.max(i16, o12);
        ...
        while (i22 < childCount) {
            ...
            if (childAt == null || childAt.getVisibility() == 8) {
                i14 = i23;
            } else if (childAt == liVar.f26740s1) {
                i14 = i23;
                ...
                if (!qhVar.l(childAt) && !thVar.l(childAt) && (((qnVar = liVar.f26711j0) == null || childAt != qnVar.B) && ((qnVar2 = liVar.f26714k0) == null || childAt != qnVar2.B))) {
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        pg.b bVar = this.f23679y0.f26756x0;
        if (bVar != null) {
    ...
    public final void setTranslationY(float f10) {
        ...
        if (i11 == 1) {
            if (f11 < 0.0f) {
                liVar.f26748v0.setTranslationY(f11);
                if (liVar.N0 != 0 || liVar.Q0) {
                    liVar.f26700f1.setTranslationY((liVar.f26719m1 + f11) - liVar.f26710i2);
                }
                mhVar.setTranslationY(0.0f);
                f11 = 0.0f;
            } else {
                liVar.f26748v0.setTranslationY(0.0f);
                mhVar.setTranslationY(((f11 / this.f23677w0) * mhVar.getMeasuredHeight()) + (-f11));
            }
            viewGroup = ((org.telegram.ui.ActionBar.g3) liVar).containerView;
            viewGroup.invalidate();
        }
        super.setTranslationY(f11 - liVar.f26710i2);
