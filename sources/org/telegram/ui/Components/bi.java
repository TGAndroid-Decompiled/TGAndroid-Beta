...
public final class bi implements org.telegram.ui.web.i0 {
    public ValueAnimator f24711a;
    public final fi.r4 f24712b;
    public final String f24713c;
    public final long d;
    public final vi f24714e;
    ...
    public final void i(boolean z10) {
        int i10;
        ImageView backButton = this.f24714e.X0.getBackButton();
        if (z10) {
    ...
    public final void k(boolean z10) {
        this.f24712b.setNeedCloseConfirmation(z10);
    }

    @Override
    public final void m(int i10) {
        this.f24712b.setCustomBackground(i10);
    }
    ...
    public final void q(boolean z10, boolean z11, String str, long j3, int i10, int i11, boolean z12, boolean z13) {
        ...
        if (niVar == r4Var) {
            if (r4Var.P || this.f24713c != null) {
                ...
                if (viVar.D1 != z10) {
                    viVar.D1 = z10;
                    ValueAnimator valueAnimator = this.f24711a;
                    ...
                    this.f24711a = duration;
                    duration.addUpdateListener(new l6(this, 9));
                    this.f24711a.addListener(new th(this, z10, 0));
                    this.f24711a.start();
                }
    ...
    @Override
    public final void s() {
        ni niVar = this.f24714e.f31340y0;
        fi.r4 r4Var = this.f24712b;
        if (niVar == r4Var && !r4Var.J.f9906c) {
            r4Var.G();
        }
    }
    ...
    public final void t(boolean z10) {
        int i10;
        org.telegram.ui.ActionBar.f1 f1Var = this.f24712b.L;
        if (f1Var != null) {
            if (z10) {
                i10 = 0;
            } else {
    ...
    public final void u(int i10, final int i11, boolean z10) {
        ...
        vi viVar = this.f24714e;
        final int color = viVar.F2.f10652a.getColor();
        ...
        duration.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                viVar2.F2.a(d);
                kh.f fVar = viVar2.f31329v1;
                if (fVar != null) {
                    fVar.invalidate();
                }
                r4Var.setCustomActionBarBackground(d);
                viVar2.f31340y0.invalidate();
                viVar2.f31316r1.invalidate();
    ...
    public final void x(boolean z10) {
        this.f24712b.setAllowSwipes(z10);
    }

    @Override
    public final void y() {
        vi viVar = this.f24714e;
        if (viVar.f31340y0 != this.f24712b) {
            return;
        }
