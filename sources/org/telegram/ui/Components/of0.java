...
public final class of0 extends FrameLayout {
    public final ph.oa f27555a;
    public final ph.d f27556b;
    public final lt f27557c;
    public i71 d;
    public long e;
    public float f27558f;
    public ph.d3 h;
    public Utilities.Callback f27559n;
    public Runnable f27560r;
    ...
    public final void a(MediaController.PhotoEntry photoEntry, i71 i71Var, org.telegram.ui.ActionBar.f6 f6Var) {
        int i10;
        ph.d dVar = this.f27556b;
        dVar.f41401a = f6Var;
        dVar.j();
        int i11 = photoEntry.width;
        if (i11 > 0 && (i10 = photoEntry.height) > 0) {
            this.f27558f = Utilities.clamp(i10 / i11, 1.39f, 0.85f);
        } else {
            this.f27558f = 1.39f;
        }
        this.d = i71Var;
