...
public final class jn extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.f27542a) {
            ...
            case 9:
                super.onDraw(canvas);
                canvas.drawLine(0.0f, AndroidUtilities.dp(14.0f), 2.0f, getMeasuredHeight() - AndroidUtilities.dp(14.0f), org.telegram.ui.ActionBar.j6.f20786k0);
                return;
            case 16:
            ...
            case 17:
                ...
                canvas.drawLine(dp2, measuredHeight2, measuredWidth2 - i11, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.j6.f20786k0);
                return;
            case 18:
                if (LocaleController.isRTL) {
                    dp3 = 0.0f;
                ...
                canvas.drawLine(dp3, measuredHeight3, measuredWidth3 - i12, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.j6.f20786k0);
                return;
            case 19:
                if (LocaleController.isRTL) {
                    dp4 = 0.0f;
                ...
                canvas.drawLine(dp4, measuredHeight4, measuredWidth4 - i13, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.j6.f20786k0);
                return;
            case 27:
                if (LocaleController.isRTL) {
                    dp5 = 0.0f;
                ...
                canvas.drawLine(dp5, measuredHeight5, measuredWidth5 - i14, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.j6.f20786k0);
                return;
            default:
                super.onDraw(canvas);
                return;
