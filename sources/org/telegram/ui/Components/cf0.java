...
public final class cf0 extends FrameLayout {
    ...
    public bf0 I;
    public int J;
    public PointF f23982a;
    public float f23983b;
    public float f23984c;
    public jv0 d;
    public PointF e;
    public float f23985f;
    public float h;
    public float f23986n;
    public RectF f23987r;
    public float f23988s;
    public float v;
    public float f23989w;
    public float f23990x;
    ...
    private PointF getActualCenterPoint() {
        ...
        float f12 = jv0Var.f26052a;
        return new PointF(width, (this.e.y * f12) + org.telegram.messenger.y3.a(f12, f11, 2.0f, x10));
    }

    private float getActualInnerRadius() {
        jv0 jv0Var = this.d;
        return Math.min(jv0Var.f26052a, jv0Var.f26053b) * this.f23985f;
    }

    private float getActualOuterRadius() {
        jv0 jv0Var = this.d;
        return Math.min(jv0Var.f26052a, jv0Var.f26053b) * this.h;
    }
    ...
    public final void c(int i10, MotionEvent motionEvent) {
        ...
        jv0 jv0Var = this.d;
        float min = Math.min(jv0Var.f26052a, jv0Var.f26053b);
        float f13 = this.f23985f * min;
        float f14 = this.h * min;
        float abs = (float) Math.abs((Math.sin(a(this.f23986n) + 1.5707963267948966d) * f12) + (Math.cos(a(this.f23986n) + 1.5707963267948966d) * f11));
        float f15 = 0.0f;
        if (i10 != 1) {
            if (i10 != 2) {
            ...
            if (i14 == 0) {
                ...
                if (b10 != 1) {
                    if (b10 != 2) {
                        if (b10 != 3) {
                            if (b10 == 5) {
                                ...
                                this.f23986n = (((((float) Math.sqrt((f17 * f17) + (f16 * f16))) * ((i13 * 2) - 1)) / 3.1415927f) / 1.15f) + this.f23986n;
                                this.f23988s = x10;
                                this.v = y10;
                            }
                        } else {
                            this.h = Math.max(this.f23985f + 0.02f, (this.f23984c + (abs - this.f23983b)) / min);
                        }
                    } else {
                        this.f23985f = Math.min(Math.max(0.1f, (this.f23984c + (abs - this.f23983b)) / min), this.h - 0.02f);
                    }
                } else {
                    float f18 = x10 - this.f23988s;
                    float f19 = y10 - this.v;
                    float width = (getWidth() - jv0Var.f26052a) / 2.0f;
                    if (!z12) {
                    ...
                    float height = getHeight();
                    float f20 = jv0Var.f26053b;
                    float x11 = e2.c.x(height, f20, 2.0f, i12);
                    PointF pointF = new PointF(Math.max(width, Math.min(jv0Var.f26052a + width, this.f23982a.x + f18)), Math.max(x11, Math.min(f20 + x11, this.f23982a.y + f19)));
                    float f21 = pointF.x - width;
                    float f22 = jv0Var.f26052a;
                    this.e = new PointF(f21 / f22, (((f22 - jv0Var.f26053b) / 2.0f) + (pointF.y - x11)) / f22);
                }
            } else if (i14 == 1) {
                ...
                if (b11 != 1) {
                    if (b11 != 2) {
                        if (b11 == 3) {
                            this.h = Math.max(this.f23985f + 0.02f, (this.f23984c + (sqrt - this.f23983b)) / min);
                        }
                    } else {
                        this.f23985f = Math.min(Math.max(0.1f, (this.f23984c + (sqrt - this.f23983b)) / min), this.h - 0.02f);
                    }
                } else {
                    float f23 = x10 - this.f23988s;
                    float f24 = y10 - this.v;
                    float width2 = (getWidth() - jv0Var.f26052a) / 2.0f;
                    if (!z12) {
                    ...
                    float f25 = jv0Var.f26053b;
                    float x12 = e2.c.x(height2, f25, 2.0f, i11);
                    PointF pointF2 = new PointF(Math.max(width2, Math.min(jv0Var.f26052a + width2, this.f23982a.x + f23)), Math.max(x12, Math.min(f25 + x12, this.f23982a.y + f24)));
                    float f26 = pointF2.x - width2;
                    float f27 = jv0Var.f26052a;
                    this.e = new PointF(f26 / f27, (((f27 - jv0Var.f26053b) / 2.0f) + (pointF2.y - x12)) / f27);
                }
            }
            invalidate();
            bf0 bf0Var = this.I;
            if (bf0Var != null) {
                ...
                float f28 = this.f23985f;
                float f29 = this.h;
                nf0 nf0Var = ((ff0) bf0Var).f24871a;
                nf0Var.U = f29;
                nf0Var.V = pointF3;
                nf0Var.W = f28;
                nf0Var.f27237a0 = a(this.f23986n) + 1.5707964f;
        ...
        if (i15 == 0) {
            if (sqrt < f31) {
                this.J = 2;
                this.f23982a = actualCenterPoint;
                return;
            }
            float f32 = f13 - f30;
    ...
    public final void d(int i10, MotionEvent motionEvent) {
        if (i10 != 1) {
            ...
            this.f23989w = b(motionEvent);
            this.f23990x = 1.0f;
            this.J = 5;
        }
        float b10 = b(motionEvent);
        float c3 = vh.v2.c(b10 - this.f23989w, AndroidUtilities.density, 0.01f, this.f23990x);
        this.f23990x = c3;
        float max = Math.max(0.1f, this.f23985f * c3);
        this.f23985f = max;
        this.h = Math.max(max + 0.02f, this.h * this.f23990x);
        this.f23990x = 1.0f;
        this.f23989w = b10;
        invalidate();
        bf0 bf0Var = this.I;
    ...
    public final boolean onTouchEvent(android.view.MotionEvent r21) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.cf0.onTouchEvent(android.view.MotionEvent):boolean");
    }
