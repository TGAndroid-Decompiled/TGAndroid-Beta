...
public final class bc extends yb implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final org.telegram.ui.ActionBar.m2 f22974f;
    public final int h;
    public qc f22975n;
    ...
    public bc(int i10, org.telegram.ui.ActionBar.m2 m2Var) {
        ...
        this.f22974f = m2Var;
        this.h = i10;
        this.f30583b.setLayoutParams(w7.y5.i(-2.0f, -2.0f, 8388659, 56.0f, 6.0f, 8.0f, 0.0f));
        this.f30582a.setLayoutParams(w7.y5.h(56.0f, 48.0f, 8388659));
    ...
    public final void f() {
        if (this.d.getReactionsWindow() != null) {
            this.d.e();
            if (this.d.getReactionsWindow().f49246a != null) {
                this.d.getReactionsWindow().f49246a.animate().alpha(0.0f).setDuration(180L).start();
            }
        }
    }
    ...
    public int getMeasuredBackgroundHeight() {
        return AndroidUtilities.dp(30.0f) + this.f30583b.getMeasuredHeight();
    }
