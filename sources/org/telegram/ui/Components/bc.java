...
public final class bc extends yb implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final org.telegram.ui.ActionBar.n2 f22950f;
    public final int h;
    public qc f22951n;
    ...
    public bc(int i10, org.telegram.ui.ActionBar.n2 n2Var) {
        ...
        this.f22950f = n2Var;
        this.h = i10;
        this.f30530b.setLayoutParams(w7.y5.i(-2.0f, -2.0f, 8388659, 56.0f, 6.0f, 8.0f, 0.0f));
        this.f30529a.setLayoutParams(w7.y5.h(56.0f, 48.0f, 8388659));
    ...
    public final void f() {
        if (this.d.getReactionsWindow() != null) {
            this.d.e();
            if (this.d.getReactionsWindow().f49226a != null) {
                this.d.getReactionsWindow().f49226a.animate().alpha(0.0f).setDuration(180L).start();
            }
        }
    }
    ...
    public int getMeasuredBackgroundHeight() {
        return AndroidUtilities.dp(30.0f) + this.f30530b.getMeasuredHeight();
    }
