...
public final class bc extends yb implements NotificationCenter.NotificationCenterDelegate {
    public final zb d;
    public SparseLongArray f24658e;
    public final org.telegram.ui.ActionBar.n2 f24659f;
    public final int h;
    public qc f24660n;
    ...
    public bc(int i10, org.telegram.ui.ActionBar.n2 n2Var) {
        ...
        this.f24659f = n2Var;
        this.h = i10;
        this.f32877b.setLayoutParams(w7.x5.i(-2.0f, -2.0f, 8388659, 56.0f, 6.0f, 8.0f, 0.0f));
        this.f32876a.setLayoutParams(w7.x5.h(56.0f, 48.0f, 8388659));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.savedMessagesForwarded) {
            this.f24658e = (SparseLongArray) objArr[0];
        }
    }
    ...
    public int getMeasuredBackgroundHeight() {
        return AndroidUtilities.dp(30.0f) + this.f32877b.getMeasuredHeight();
    }
