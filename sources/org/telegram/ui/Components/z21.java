...
public final class z21 extends s61 {
    public final org.telegram.ui.g20 f30776f3;
    public final e6 f30777g3;
    public final e6 f30778h3;
    public final RectF f30779i3;
    public final Paint j3;
    public final e6 f30780k3;
    public Drawable f30781l3;
    public int f30782m3;
    public final Paint f30783n3;
    public final l31 f30784o3;

    public z21(l31 l31Var, Context context, int i10, y21 y21Var, q21 q21Var, q21 q21Var2, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context, i10, 0, false, y21Var, q21Var, q21Var2, d6Var);
        this.f30784o3 = l31Var;
        this.f30776f3 = new org.telegram.ui.g20();
        sr srVar = sr.h;
        this.f30777g3 = new e6(this, 320L, srVar);
        this.f30778h3 = new e6(this, 320L, srVar);
        this.f30779i3 = new RectF();
        this.j3 = new Paint(1);
        this.f30780k3 = new e6(this, 420L, srVar);
        this.f30783n3 = new Paint(1);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f12;
        int i10;
        float e = this.f30777g3.e(canScrollHorizontally(-1));
        float e7 = this.f30778h3.e(canScrollHorizontally(1));
        ...
        if (f13 > width) {
            ...
            if (this.f30781l3 == null) {
                this.f30781l3 = getContext().getResources().getDrawable(R.drawable.msg_limit_pin).mutate();
            }
            int v02 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19025b9, d6Var);
            if (this.f30782m3 != v02) {
                Drawable drawable = this.f30781l3;
                this.f30782m3 = v02;
                drawable.setColorFilter(new PorterDuffColorFilter(v02, PorterDuff.Mode.SRC_IN));
            }
            this.f30781l3.setBounds((int) (AndroidUtilities.dp(-17.0f) + f13), (int) (rectF.top + AndroidUtilities.dp(10.0f)), (int) (f13 + AndroidUtilities.dp(-7.0f)), (int) (rectF.top + AndroidUtilities.dp(20.0f)));
            this.f30781l3.draw(canvas2);
        } else {
            f7 = 14.0f;
            f10 = 1.0f;
        }
        super.dispatchDraw(canvas);
        l31 l31Var = this.f30784o3;
        long j3 = l31Var.H;
        long j10 = l31Var.V;
        e6 e6Var = this.f30780k3;
        if (j3 != j10) {
            l31Var.I = j3;
            e6Var.d(0.0f, true);
        }
        ...
        if (z10) {
            canvas2.save();
            org.telegram.ui.g20 g20Var = this.f30776f3;
            if (i14 > 0) {
