...
public final class iu implements my {
    ...
    public final void n() {
        ...
        if (m2Var != null) {
            m2Var.showDialog(alertDialog$Builder.f18647a);
        } else {
    ...
    @Override
    public final void q() {
        org.telegram.ui.ActionBar.m2 m2Var = this.f25145a.h;
        if (m2Var == null) {
    ...
    public final void x(long j3, TLRPC.Document document, String str, boolean z10) {
        ...
        try {
            ...
            z5Var.cacheType = kuVar.d.f26227c;
