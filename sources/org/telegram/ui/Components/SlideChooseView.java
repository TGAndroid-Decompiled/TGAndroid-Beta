...
public class SlideChooseView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        while (i < this.optionsStr.length) {
            ...
            int iBlendARGB = ColorUtils.blendARGB(fClamp, themedColor, Theme.multAlpha((i6 == Integer.MIN_VALUE || i > i6) ? 1.0f : 0.5f, themedColor2));
            ...
            if (i != 0) {
                ...
                if (i10 == -1 || i - 1 < i10) {
                    ...
                    int iDp2 = (int) (i8 - (AndroidUtilities.dp(3.0f) * MathUtils.clamp(1.0f - Math.min(Math.abs(f8), Math.abs(f10)), 0.0f, 1.0f)));
                    int iDp3 = (int) ((AndroidUtilities.dp(3.0f) * fClamp2) + i9);
                    canvas2 = canvas;
                    canvas2.drawRect(iDp3, iDp - AndroidUtilities.dp(1.0f), iDp2 + iDp3, AndroidUtilities.dp(1.0f) + iDp, this.paint);
                } else {
                    int iDp4 = AndroidUtilities.dp(3.0f) + i9;
                    int iDp5 = i8 - AndroidUtilities.dp(3.0f);
                    int iDp6 = iDp5 / AndroidUtilities.dp(13.0f);
                    if (this.lastDash != iDp6) {
                        this.linePaint.setPathEffect(new DashPathEffect(new float[]{AndroidUtilities.dp(6.0f), OKLCH.m$3(8.0f, iDp6, iDp5) / (iDp6 - 1)}, 0.0f));
                        this.lastDash = iDp6;
                    }
                    f = fMax;
                    canvas2 = canvas;
                    canvas2.drawLine(AndroidUtilities.dp(1.0f) + iDp4, f9, (iDp4 + iDp5) - AndroidUtilities.dp(1.0f), f9, this.linePaint);
                }
            } else {
                f = fMax;
                f2 = 3.0f;
            ...
            this.textPaint.setColor(ColorUtils.blendARGB(f, getThemedColor(Theme.key_windowBackgroundWhiteGrayText), getThemedColor(Theme.key_windowBackgroundWhiteBlueText)));
        ...
        int i12 = (this.gapSize * 2) + this.lineSize;
        int i13 = this.circleSize;
        float f12 = ((i12 + i13) * f3) + f11 + (i13 / 2);
