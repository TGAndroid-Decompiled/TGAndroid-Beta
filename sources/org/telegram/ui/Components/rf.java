...
public final class rf implements TextWatcher {
    ...
    public boolean d;
    public boolean e;
    public final ChatActivityEnterView f27615f;

    public rf(ChatActivityEnterView chatActivityEnterView) {
        this.f27615f = chatActivityEnterView;
    }
    ...
    public final void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
        ...
        boolean z16;
        if (!this.d) {
            ChatActivityEnterView chatActivityEnterView = this.f27615f;
            ...
            if (chatActivityEnterView.Y2 != null && !chatActivityEnterView.Q2) {
                ...
                ngVar.l1(charSequence, z11, false);
            }
            if (chatActivityEnterView.R2 != 2 && i12 - i11 > 1) {
                this.f27612a = true;
            }
            if (chatActivityEnterView.Y1 == null && !chatActivityEnterView.f21743g2 && trimmedString.length() != 0 && chatActivityEnterView.B2 < System.currentTimeMillis() - 5000 && !chatActivityEnterView.Q2) {
