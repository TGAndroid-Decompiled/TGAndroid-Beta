...
public final class hm extends tk0 {
    ...
    public final boolean E(ll0 ll0Var) {
        ...
        boolean isEmpty = ChatAttachAlertPhotoLayout.f23859r1.isEmpty();
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.v;
        if ((!isEmpty || ((albumEntry = chatAttachAlertPhotoLayout.T0) != null && !albumEntry.photos.isEmpty())) && chatAttachAlertPhotoLayout.f28780b.R && h() > 30) {
            return true;
        }
        return false;
    }
    ...
    public final String F(int i10) {
        ...
        if (M == null) {
            ...
            ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.v;
            if (i10 <= i11) {
                ArrayList arrayList2 = ChatAttachAlertPhotoLayout.f23859r1;
    ...
    public final float H(ll0 ll0Var) {
        int i10 = this.v.M0;
        int ceil = (int) Math.ceil(this.f26782n / i10);
    ...
    public final vk0 L() {
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.v;
        org.telegram.ui.Cells.s5 s5Var = new org.telegram.ui.Cells.s5(this.f26779c, chatAttachAlertPhotoLayout.f28779a);
    ...
    public final int h() {
        ...
        if (!chatAttachAlertPhotoLayout.f23901v0) {
            return 1;
        }
        int i10 = 0;
        this.f26780e = false;
        ...
        this.f26783r = i10;
        if (!z10) {
            i10 += ChatAttachAlertPhotoLayout.f23859r1.size();
            MediaController.AlbumEntry albumEntry = chatAttachAlertPhotoLayout.T0;
            if (albumEntry != null) {
                i10 += albumEntry.photos.size();
            }
        }
        if (this.f26780e && i10 > chatAttachAlertPhotoLayout.M0 && !chatAttachAlertPhotoLayout.O0) {
            this.f26781f = true;
            i10++;
        }
        if (this == hmVar) {
    ...
    public final int j(int i10) {
        ...
        if (chatAttachAlertPhotoLayout.f23901v0) {
            ...
            if (chatAttachAlertPhotoLayout.f23876g1 && i11 == 0) {
                return 4;
            }
            if (this == hmVar && i10 == this.f26782n - 1) {
                return 2;
            }
            if (z10) {
                return 3;
    ...
    public final void l() {
        ...
        if (this == chatAttachAlertPhotoLayout.G) {
            ...
            if ((h() == 1 && !chatAttachAlertPhotoLayout.P0 && chatAttachAlertPhotoLayout.T0 == null) || !chatAttachAlertPhotoLayout.f23901v0) {
                i10 = 0;
            } else {
                i10 = 4;
            }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 != 0) {
            if (i11 != 1) {
                if (i11 != 3) {
                    if (i11 == 7) {
                        ((g20) view).setUseAnEmojiVisible(chatAttachAlertPhotoLayout.f23876g1);
                        return;
                    }
                    return;
                }
        ...
        if (this.f26781f && i10 > chatAttachAlertPhotoLayout.M0) {
            i10--;
        }
        ...
        if (this == chatAttachAlertPhotoLayout.G) {
            ...
            if (chatAttachAlertPhotoLayout.f23897s.f45754o == 1) {
                z10 = true;
            } else {
                z10 = false;
            }
        ...
        if ((viVar.f31306f0 instanceof org.telegram.ui.co) && viVar.T1) {
            s5Var.b(ChatAttachAlertPhotoLayout.f23861t1.indexOf(Integer.valueOf(b02.imageId)), hashMap.containsKey(Integer.valueOf(b02.imageId)), false);
        } else {
            s5Var.b(-1, hashMap.containsKey(Integer.valueOf(b02.imageId)), false);
        }
        if (!chatAttachAlertPhotoLayout.f23903w0 && b02.isVideo) {
            s5Var.setAlpha(0.3f);
        } else if (!chatAttachAlertPhotoLayout.f23905x0 && !b02.isVideo) {
            s5Var.setAlpha(0.3f);
        } else {
            s5Var.setAlpha(1.0f);
        }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.v;
        vi viVar = chatAttachAlertPhotoLayout.f28780b;
        org.telegram.ui.ActionBar.f6 f6Var = chatAttachAlertPhotoLayout.f28779a;
        if (i10 != 0) {
                        ...
                        if (i10 != 5) {
                            if (i10 != 7) {
                                if (i10 != 8) {
                                    ...
                                    frameLayout.f22318a = imageView;
                                    ImageView.ScaleType scaleType = ImageView.ScaleType.CENTER;
                                    imageView.setScaleType(scaleType);
                                    int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20637aa, f6Var);
                                    PorterDuff.Mode mode = PorterDuff.Mode.MULTIPLY;
                                    imageView.setColorFilter(new PorterDuffColorFilter(v02, mode));
                                    frameLayout.addView(imageView, w7.x5.d(44, 44.0f, 17, 5.0f, 0.0f, 0.0f, 27.0f));
                                    ImageView imageView2 = new ImageView(context);
                                    frameLayout.f22319b = imageView2;
                                    imageView2.setScaleType(scaleType);
                                    imageView2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20657ba, f6Var), mode));
                                    frameLayout.addView(imageView2, w7.x5.d(44, 44.0f, 17, 5.0f, 0.0f, 0.0f, 27.0f));
                                    TextView textView = new TextView(context);
                                    frameLayout.f22320c = textView;
                                    org.telegram.messenger.wl.n(org.telegram.ui.ActionBar.j6.f20676ca, f6Var, textView, 1, 12.0f);
                            ...
                            g20Var.isClickable();
                            g20Var.f26261b.setOnClickListener(new g0(new ll(chatAttachAlertPhotoLayout, 5), 18));
                            g20Var.f26260a.setOnClickListener(new g0(new ll(chatAttachAlertPhotoLayout, 6), 19));
                            g20Var.f26262c.setOnClickListener(new ct(5, g20Var, new y2(this, 2)));
            ...
            view.f22280a = AndroidUtilities.dp(0.0f);
    ...
    public final void y(s4.c1 c1Var) {
        if (c1Var.f45766a instanceof org.telegram.ui.Cells.l5) {
            this.v.Q.g();
        }
    }
}
