...
public final class hm extends uk0 {
    ...
    public final boolean E(ml0 ml0Var) {
        ...
        boolean isEmpty = ChatAttachAlertPhotoLayout.f21912r1.isEmpty();
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.v;
        if ((!isEmpty || ((albumEntry = chatAttachAlertPhotoLayout.T0) != null && !albumEntry.photos.isEmpty())) && chatAttachAlertPhotoLayout.f26463b.R && h() > 30) {
            return true;
        }
        return false;
    }
    ...
    public final String F(int i10) {
        ...
        if (M == null) {
            int i11 = this.f24700r;
            ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.v;
            if (i10 <= i11) {
                ArrayList arrayList2 = ChatAttachAlertPhotoLayout.f21912r1;
    ...
    public final float H(ml0 ml0Var) {
        int i10 = this.v.M0;
        int ceil = (int) Math.ceil(this.f24699n / i10);
        if (ml0Var.getChildCount() != 0) {
            int measuredHeight = ml0Var.getChildAt(0).getMeasuredHeight();
            View childAt = ml0Var.getChildAt(0);
            int S = RecyclerView.S(childAt);
            if (S >= 0) {
                return Utilities.clamp((((S / i10) * measuredHeight) - childAt.getTop()) / ((ceil * measuredHeight) - (ml0Var.getMeasuredHeight() - org.telegram.ui.ActionBar.k.getCurrentActionBarHeight())), 1.0f, 0.0f);
            }
        }
        return 0.0f;
    }
    ...
    public final wk0 L() {
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.v;
        org.telegram.ui.Cells.s5 s5Var = new org.telegram.ui.Cells.s5(this.f24697c, chatAttachAlertPhotoLayout.f26462a);
    ...
    public final int h() {
        ...
        if (!chatAttachAlertPhotoLayout.f21954v0) {
            return 1;
        }
        int i10 = 0;
        this.e = false;
        ...
        if (chatAttachAlertPhotoLayout.f21929g1) {
            i10++;
        }
        if (z10 && this == hmVar) {
            i10++;
        ...
        this.f24700r = i10;
        if (!z10) {
            i10 += ChatAttachAlertPhotoLayout.f21912r1.size();
            MediaController.AlbumEntry albumEntry = chatAttachAlertPhotoLayout.T0;
            if (albumEntry != null) {
    ...
    public final int j(int i10) {
        ...
        if (chatAttachAlertPhotoLayout.f21954v0) {
            ...
            if (chatAttachAlertPhotoLayout.f21929g1 && i11 == 0) {
                return 4;
            }
            if (this == hmVar && i10 == this.f24699n - 1) {
                return 2;
            }
            if (z10) {
                return 3;
    ...
    public final void l() {
        ...
        if (this == chatAttachAlertPhotoLayout.G) {
            ...
            if ((h() == 1 && !chatAttachAlertPhotoLayout.P0 && chatAttachAlertPhotoLayout.T0 == null) || !chatAttachAlertPhotoLayout.f21954v0) {
                i10 = 0;
            } else {
                i10 = 4;
            }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 != 0) {
            if (i11 != 1) {
                if (i11 != 3) {
                    if (i11 == 7) {
                        ((g20) view).setUseAnEmojiVisible(chatAttachAlertPhotoLayout.f21929g1);
                        return;
                    }
                    return;
                }
        ...
        if (this.f24698f && i10 > chatAttachAlertPhotoLayout.M0) {
            i10--;
        }
        ...
        if (this == chatAttachAlertPhotoLayout.G) {
            ...
            if (chatAttachAlertPhotoLayout.f21950s.f42690o == 1) {
                z10 = true;
            } else {
                z10 = false;
            }
        ...
        if ((viVar.f28745f0 instanceof org.telegram.ui.bo) && viVar.T1) {
            s5Var.b(ChatAttachAlertPhotoLayout.f21914t1.indexOf(Integer.valueOf(b02.imageId)), hashMap.containsKey(Integer.valueOf(b02.imageId)), false);
        } else {
            s5Var.b(-1, hashMap.containsKey(Integer.valueOf(b02.imageId)), false);
        }
        if (!chatAttachAlertPhotoLayout.f21956w0 && b02.isVideo) {
            s5Var.setAlpha(0.3f);
        } else if (!chatAttachAlertPhotoLayout.f21958x0 && !b02.isVideo) {
            s5Var.setAlpha(0.3f);
        } else {
            s5Var.setAlpha(1.0f);
        }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.v;
        vi viVar = chatAttachAlertPhotoLayout.f26463b;
        org.telegram.ui.ActionBar.f6 f6Var = chatAttachAlertPhotoLayout.f26462a;
        if (i10 != 0) {
            Context context = this.f24697c;
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 != 4) {
                        if (i10 != 5) {
                            if (i10 != 7) {
                                if (i10 != 8) {
                                    ...
                                    frameLayout.f20441a = imageView;
                                    ImageView.ScaleType scaleType = ImageView.ScaleType.CENTER;
                                    imageView.setScaleType(scaleType);
                                    int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18810aa, f6Var);
                                    PorterDuff.Mode mode = PorterDuff.Mode.MULTIPLY;
                                    imageView.setColorFilter(new PorterDuffColorFilter(v02, mode));
                                    frameLayout.addView(imageView, w7.x5.d(44, 44.0f, 17, 5.0f, 0.0f, 0.0f, 27.0f));
                                    ImageView imageView2 = new ImageView(context);
                                    frameLayout.f20442b = imageView2;
                                    imageView2.setScaleType(scaleType);
                                    imageView2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18830ba, f6Var), mode));
                                    frameLayout.addView(imageView2, w7.x5.d(44, 44.0f, 17, 5.0f, 0.0f, 0.0f, 27.0f));
                                    TextView textView = new TextView(context);
                                    frameLayout.f20443c = textView;
                                    org.telegram.messenger.wl.n(org.telegram.ui.ActionBar.j6.f18849ca, f6Var, textView, 1, 12.0f);
                            ...
                            g20Var.isClickable();
                            g20Var.f24070b.setOnClickListener(new f0(new ll(chatAttachAlertPhotoLayout, 5), 18));
                            g20Var.f24069a.setOnClickListener(new f0(new ll(chatAttachAlertPhotoLayout, 6), 19));
                            g20Var.f24071c.setOnClickListener(new dt(5, g20Var, new x2(this, 2)));
            ...
            view.f20407a = AndroidUtilities.dp(0.0f);
    ...
    public final void y(s4.c1 c1Var) {
        if (c1Var.f42702a instanceof org.telegram.ui.Cells.l5) {
            this.v.Q.g();
        }
    }
}
