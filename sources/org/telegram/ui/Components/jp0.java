    ...
    public final boolean E0(float f7) {
        ...
        switch (this.X2) {
            case 0:
                ...
                if (f7 >= AndroidUtilities.dp(f10) + hq0Var.G0.f10589b) {
                    return true;
                }
                return false;
            default:
                hq0 hq0Var2 = this.Y2;
                if (hq0Var2.f24758h0 && hq0Var2.f24765o0[1] != null) {
                    f11 = 111.0f;
                } else {
                    f11 = 58.0f;
                }
                if (f7 >= AndroidUtilities.dp(f11) + hq0Var2.G0.f10589b) {
                    return true;
                }
                return false;
        }
