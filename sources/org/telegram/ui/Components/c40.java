...
public final class c40 extends org.telegram.ui.ActionBar.m2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ai.w5 e;
    public org.telegram.ui.fk f23185f;
    public FrameLayout h;
    public z30 f23186n;
    public gg.n1 f23187r;
    public FrameLayout f23188s;
    public TextView v;
    public float f23189w;
    public ValueAnimator f23190x;
    public boolean f23191y;
    ...
    public c40(String str, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        if (indexOf > 0) {
            this.f23183b = trim.substring(0, indexOf);
            this.f23184c = trim.substring(indexOf + 1);
        } else {
            this.f23183b = trim;
            this.f23184c = null;
        }
        ...
        if (!TextUtils.isEmpty(this.f23184c)) {
            str2 = "@" + this.f23184c;
        }
        sb2.append(str2);
        this.f23182a = sb2.toString();
        this.d = new ai.v8(this.currentAccount, this.f23184c, this.f23183b);
    }
    ...
    public final void U(boolean z10, boolean z11) {
        ...
        if (!z11) {
            ...
            org.telegram.ui.fk fkVar = this.f23185f;
            if (fkVar != null && (xnVar = fkVar.f40194a) != null && (w0Var = xnVar.L3) != null) {
                w0Var.setScaleX(AndroidUtilities.lerp(1.0f, 0.95f, this.E));
                this.f23185f.f40194a.L3.setScaleY(AndroidUtilities.lerp(1.0f, 0.95f, this.E));
            }
        } else if (this.f23191y == z10) {
        } else {
            this.f23191y = z10;
    ...
    public final void V(boolean z10, boolean z11) {
        ...
        float f10;
        int i11;
        this.f23187r.animate().cancel();
        ValueAnimator valueAnimator = this.f23190x;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        float f11 = 0.0f;
        if (!z11) {
            gg.n1 n1Var = this.f23187r;
            if (z10) {
                i10 = 0;
            } else {
                i10 = 8;
        ...
        this.f23187r.setVisibility(0);
        ViewPropertyAnimator animate = this.f23187r.animate();
        if (z10) {
            f7 = 0.0f;
        } else {
        ...
        float f12 = this.f23189w;
        if (z10) {
            f11 = 1.0f;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(f12, f11);
        this.f23190x = ofFloat;
        ofFloat.addUpdateListener(new a40(this, 0));
        this.f23190x.addListener(new b40(this, z10, 0));
        this.f23190x.setDuration(320L);
        this.f23190x.setInterpolator(rrVar);
        this.f23190x.start();
    }
    ...
    public final View createView(Context context) {
        ...
        if (z30Var.getSearchOptionsItem() != null) {
            this.f23186n.getSearchOptionsItem().setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(i11, this.resourceProvider), PorterDuff.Mode.SRC_IN));
        }
        this.f23186n.setPinnedToTop(true);
        this.f23186n.f25550r0.setTranslationY(0.0f);
        if (this.f23186n.getSearchOptionsItem() != null) {
            this.f23186n.getSearchOptionsItem().setTranslationY(0.0f);
        }
        this.f23186n.setBackgroundColor(getThemedColor(i10));
        z30 z30Var2 = this.f23186n;
        ai.v8 v8Var = this.d;
        z30Var2.T1 = v8Var;
        rt0 rt0Var = z30Var2.f25518c0;
        rt0Var.f24536s = v8Var;
        rt0Var.l();
        gv0 gv0Var = z30Var2.f25521d0;
        gv0Var.f24536s = v8Var;
        gv0Var.l();
        FrameLayout frameLayout2 = new FrameLayout(context);
        this.h = frameLayout2;
        frameLayout2.setBackgroundColor(getThemedColor(i10));
        this.h.addView(this.f23186n, w7.y5.d(-1, -1.0f, 119, 0.0f, 0.0f, 0.0f, 49.0f));
        FrameLayout frameLayout3 = new FrameLayout(context);
        this.f23188s = frameLayout3;
        ...
        this.f23188s.addView(this.v, w7.y5.d(-1, -2.0f, 19, 18.0f, 0.0f, 18.0f, 0.0f));
        View view = new View(context);
        view.setBackgroundColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19061d7, this.resourceProvider));
        this.f23188s.addView(view, w7.y5.a(-1.0f, 1.0f / AndroidUtilities.density, 55));
        this.h.addView(this.f23188s, w7.y5.e(-1, 49, 87));
        ...
        this.f23187r.setOnClickListener(new f0(this, 25));
        V(this.f23187r.a(v8Var), false);
        this.f23187r.b(HashtagSearchController.getInstance(this.currentAccount).getCount(3), this.f23183b, this.f23184c);
        frameLayout.addView(this.f23187r, w7.y5.e(-1, 48, 55));
        U(false, false);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        } else if (i10 == NotificationCenter.hashtagSearchUpdated && (fkVar = this.f23185f) != null && fkVar.f40194a != null && ((Integer) objArr[0]).intValue() == this.f23185f.f40194a.getClassGuid()) {
            int intValue = ((Integer) objArr[1]).intValue();
            gg.n1 n1Var2 = this.f23187r;
            if (n1Var2 != null) {
                n1Var2.b(intValue, this.f23183b, this.f23184c);
            }
        }
    }
