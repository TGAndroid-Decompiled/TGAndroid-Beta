...
public final class c40 extends org.telegram.ui.ActionBar.m2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ai.w5 e;
    public org.telegram.ui.fk f23155f;
    public FrameLayout h;
    public z30 f23156n;
    public gg.n1 f23157r;
    public FrameLayout f23158s;
    public TextView v;
    public float f23159w;
    public ValueAnimator f23160x;
    ...
    public c40(String str, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        if (indexOf > 0) {
            this.f23153b = trim.substring(0, indexOf);
            this.f23154c = trim.substring(indexOf + 1);
        } else {
            this.f23153b = trim;
            this.f23154c = null;
        }
        ...
        sb2.append(str2);
        this.f23152a = sb2.toString();
        this.d = new ai.v8(this.currentAccount, this.f23154c, this.f23153b);
    }
    ...
    public final void U(boolean z10, boolean z11) {
        ...
        if (!z11) {
            ...
            org.telegram.ui.fk fkVar = this.f23155f;
            if (fkVar != null && (xnVar = fkVar.f40177a) != null && (w0Var = xnVar.L3) != null) {
                w0Var.setScaleX(AndroidUtilities.lerp(1.0f, 0.95f, this.E));
                this.f23155f.f40177a.L3.setScaleY(AndroidUtilities.lerp(1.0f, 0.95f, this.E));
            }
        } else if (this.f23161y == z10) {
        } else {
            this.f23161y = z10;
    ...
    public final void V(boolean z10, boolean z11) {
        ...
        float f10;
        int i11;
        this.f23157r.animate().cancel();
        ValueAnimator valueAnimator = this.f23160x;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        float f11 = 0.0f;
        if (!z11) {
            gg.n1 n1Var = this.f23157r;
            if (z10) {
                i10 = 0;
            } else {
                i10 = 8;
        ...
        this.f23157r.setVisibility(0);
        ViewPropertyAnimator animate = this.f23157r.animate();
        if (z10) {
            f7 = 0.0f;
        } else {
        ...
        float f12 = this.f23159w;
        if (z10) {
            f11 = 1.0f;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(f12, f11);
        this.f23160x = ofFloat;
        ofFloat.addUpdateListener(new a40(this, 0));
        this.f23160x.addListener(new b40(this, z10, 0));
        this.f23160x.setDuration(320L);
        this.f23160x.setInterpolator(rrVar);
        this.f23160x.start();
    }
    ...
    public final View createView(Context context) {
        ...
        this.actionBar.A(getThemedColor(org.telegram.ui.ActionBar.h6.f19360u8), false);
        ...
        if (z30Var.getSearchOptionsItem() != null) {
            this.f23156n.getSearchOptionsItem().setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(i11, this.resourceProvider), PorterDuff.Mode.SRC_IN));
        }
        this.f23156n.setPinnedToTop(true);
        this.f23156n.f25533r0.setTranslationY(0.0f);
        if (this.f23156n.getSearchOptionsItem() != null) {
            this.f23156n.getSearchOptionsItem().setTranslationY(0.0f);
        }
        this.f23156n.setBackgroundColor(getThemedColor(i10));
        z30 z30Var2 = this.f23156n;
        ai.v8 v8Var = this.d;
        z30Var2.T1 = v8Var;
        rt0 rt0Var = z30Var2.f25501c0;
        rt0Var.f24530s = v8Var;
        rt0Var.l();
        gv0 gv0Var = z30Var2.f25504d0;
        gv0Var.f24530s = v8Var;
        gv0Var.l();
        FrameLayout frameLayout2 = new FrameLayout(context);
        this.h = frameLayout2;
        frameLayout2.setBackgroundColor(getThemedColor(i10));
        this.h.addView(this.f23156n, w7.y5.d(-1, -1.0f, 119, 0.0f, 0.0f, 0.0f, 49.0f));
        FrameLayout frameLayout3 = new FrameLayout(context);
        this.f23158s = frameLayout3;
        frameLayout3.setBackgroundColor(getThemedColor(i10));
        TextView textView = new TextView(context);
        this.v = textView;
        textView.setTypeface(AndroidUtilities.bold());
        this.v.setTextSize(1, 15.0f);
        this.v.setTextColor(getThemedColor(org.telegram.ui.ActionBar.h6.f19436ye));
        this.v.setText(LocaleController.formatPluralString("FoundStories", v8Var.J, new Object[0]));
        this.f23158s.addView(this.v, w7.y5.d(-1, -2.0f, 19, 18.0f, 0.0f, 18.0f, 0.0f));
        View view = new View(context);
        view.setBackgroundColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19046d7, this.resourceProvider));
        this.f23158s.addView(view, w7.y5.a(-1.0f, 1.0f / AndroidUtilities.density, 55));
        this.h.addView(this.f23158s, w7.y5.e(-1, 49, 87));
        this.e.addView(this.h, w7.y5.e(-1, -1, 119));
        gg.n1 n1Var = new gg.n1(context, this.resourceProvider);
        this.f23157r = n1Var;
        n1Var.setBackground(org.telegram.ui.ActionBar.h6.g0(getThemedColor(i10), getThemedColor(org.telegram.ui.ActionBar.h6.f19134i6)));
        this.f23157r.setOnClickListener(new f0(this, 25));
        V(this.f23157r.a(v8Var), false);
        this.f23157r.b(HashtagSearchController.getInstance(this.currentAccount).getCount(3), this.f23153b, this.f23154c);
        frameLayout.addView(this.f23157r, w7.y5.e(-1, 48, 55));
        U(false, false);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        } else if (i10 == NotificationCenter.hashtagSearchUpdated && (fkVar = this.f23155f) != null && fkVar.f40177a != null && ((Integer) objArr[0]).intValue() == this.f23155f.f40177a.getClassGuid()) {
            int intValue = ((Integer) objArr[1]).intValue();
            gg.n1 n1Var2 = this.f23157r;
            if (n1Var2 != null) {
                n1Var2.b(intValue, this.f23153b, this.f23154c);
            }
        }
    }
    ...
    public final boolean isLightStatusBar() {
        if (i0.a.f(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19045d6, true)) > 0.699999988079071d) {
            return true;
        }
        return false;
    }
