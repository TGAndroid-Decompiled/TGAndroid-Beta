...
public final class c40 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ai.w5 e;
    public org.telegram.ui.fk f22915f;
    public FrameLayout h;
    public z30 f22916n;
    public gg.n1 f22917r;
    public FrameLayout f22918s;
    public TextView v;
    public float f22919w;
    public ValueAnimator f22920x;
    ...
    public c40(String str, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        if (indexOf > 0) {
            this.f22913b = trim.substring(0, indexOf);
            this.f22914c = trim.substring(indexOf + 1);
        } else {
            this.f22913b = trim;
            this.f22914c = null;
        }
        ...
        if (!TextUtils.isEmpty(this.f22914c)) {
            str2 = "@" + this.f22914c;
        }
        sb2.append(str2);
        this.f22912a = sb2.toString();
        this.d = new ai.v8(this.currentAccount, this.f22914c, this.f22913b);
    }
    ...
    public final void U(boolean z10, boolean z11) {
        ...
        if (!z11) {
            ...
            org.telegram.ui.fk fkVar = this.f22915f;
            if (fkVar != null && (ynVar = fkVar.f40196a) != null && (w0Var = ynVar.L3) != null) {
                w0Var.setScaleX(AndroidUtilities.lerp(1.0f, 0.95f, this.E));
                this.f22915f.f40196a.L3.setScaleY(AndroidUtilities.lerp(1.0f, 0.95f, this.E));
            }
        } else if (this.f22921y == z10) {
        } else {
            this.f22921y = z10;
    ...
    public final void V(boolean z10, boolean z11) {
        ...
        float f10;
        int i11;
        this.f22917r.animate().cancel();
        ValueAnimator valueAnimator = this.f22920x;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        float f11 = 0.0f;
        if (!z11) {
            gg.n1 n1Var = this.f22917r;
            if (z10) {
                i10 = 0;
            } else {
                i10 = 8;
        ...
        ViewPropertyAnimator animate = this.f22917r.animate();
        if (z10) {
            f7 = 0.0f;
        } else {
        ...
        float f12 = this.f22919w;
        if (z10) {
            f11 = 1.0f;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(f12, f11);
        this.f22920x = ofFloat;
        ofFloat.addUpdateListener(new a40(this, 0));
        this.f22920x.addListener(new b40(this, z10, 0));
        this.f22920x.setDuration(320L);
        this.f22920x.setInterpolator(rrVar);
        this.f22920x.start();
    }
    ...
    public final View createView(Context context) {
        ...
        this.actionBar.A(getThemedColor(org.telegram.ui.ActionBar.h6.f19102u8), false);
        ...
        z30 z30Var = new z30(this, context, new qu0(null), this, new Object(), this.resourceProvider);
        this.f22916n = z30Var;
        if (z30Var.getSearchOptionsItem() != null) {
            this.f22916n.getSearchOptionsItem().setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(i11, this.resourceProvider), PorterDuff.Mode.SRC_IN));
        }
        this.f22916n.setPinnedToTop(true);
        this.f22916n.f30440r0.setTranslationY(0.0f);
        if (this.f22916n.getSearchOptionsItem() != null) {
            this.f22916n.getSearchOptionsItem().setTranslationY(0.0f);
        }
        this.f22916n.setBackgroundColor(getThemedColor(i10));
        z30 z30Var2 = this.f22916n;
        ai.v8 v8Var = this.d;
        z30Var2.T1 = v8Var;
        gt0 gt0Var = z30Var2.f30408c0;
        gt0Var.f29394s = v8Var;
        gt0Var.l();
        vu0 vu0Var = z30Var2.f30411d0;
        vu0Var.f29394s = v8Var;
        vu0Var.l();
        FrameLayout frameLayout2 = new FrameLayout(context);
        this.h = frameLayout2;
        frameLayout2.setBackgroundColor(getThemedColor(i10));
        this.h.addView(this.f22916n, w7.x5.d(-1, -1.0f, 119, 0.0f, 0.0f, 0.0f, 49.0f));
        FrameLayout frameLayout3 = new FrameLayout(context);
        this.f22918s = frameLayout3;
        frameLayout3.setBackgroundColor(getThemedColor(i10));
        TextView textView = new TextView(context);
        this.v = textView;
        textView.setTypeface(AndroidUtilities.bold());
        this.v.setTextSize(1, 15.0f);
        this.v.setTextColor(getThemedColor(org.telegram.ui.ActionBar.h6.f19178ye));
        this.v.setText(LocaleController.formatPluralString("FoundStories", v8Var.J, new Object[0]));
        this.f22918s.addView(this.v, w7.x5.d(-1, -2.0f, 19, 18.0f, 0.0f, 18.0f, 0.0f));
        View view = new View(context);
        view.setBackgroundColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18790d7, this.resourceProvider));
        this.f22918s.addView(view, w7.x5.a(-1.0f, 1.0f / AndroidUtilities.density, 55));
        this.h.addView(this.f22918s, w7.x5.e(-1, 49, 87));
        this.e.addView(this.h, w7.x5.e(-1, -1, 119));
        gg.n1 n1Var = new gg.n1(context, this.resourceProvider);
        this.f22917r = n1Var;
        n1Var.setBackground(org.telegram.ui.ActionBar.h6.g0(getThemedColor(i10), getThemedColor(org.telegram.ui.ActionBar.h6.f18878i6)));
        this.f22917r.setOnClickListener(new f0(this, 25));
        V(this.f22917r.a(v8Var), false);
        this.f22917r.b(HashtagSearchController.getInstance(this.currentAccount).getCount(3), this.f22913b, this.f22914c);
        frameLayout.addView(this.f22917r, w7.x5.e(-1, 48, 55));
        U(false, false);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        } else if (i10 == NotificationCenter.hashtagSearchUpdated && (fkVar = this.f22915f) != null && fkVar.f40196a != null && ((Integer) objArr[0]).intValue() == this.f22915f.f40196a.getClassGuid()) {
            int intValue = ((Integer) objArr[1]).intValue();
            gg.n1 n1Var2 = this.f22917r;
            if (n1Var2 != null) {
                n1Var2.b(intValue, this.f22913b, this.f22914c);
            }
        }
    }
