...
public final class p41 extends pv0 {
    ...
    public boolean D0;
    public final q41 E0;
    public final Paint f26941w0;
    public boolean f26942x0;
    public boolean f26943y0;
    public boolean f26944z0;
    ...
    public final float Z() {
        q41 q41Var = this.E0;
        return Math.min(1.0f, Math.max(0.0f, q41Var.f27246f / (q41Var.f27244b * 2.0f)));
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        q41 q41Var = this.E0;
        e51 e51Var = q41Var.e;
        int i12 = q41Var.f27244b;
        GradientDrawable gradientDrawable = q41Var.f27245c;
        float Z = Z();
        boolean z13 = false;
        ...
        if (this.D0 != z11) {
            this.D0 = z11;
            if (AndroidUtilities.computePerceivedBrightness(q41Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18904h5)) > 0.721f) {
                z12 = true;
            } else {
                z12 = false;
            }
            if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.i6.v(q41Var.getThemedColor(org.telegram.ui.ActionBar.i6.f19110s8), 855638016)) > 0.721f) {
                z13 = true;
            }
            if (!z11) {
                z12 = z13;
        ...
        if (this.B0 > 0.0f) {
            int themedColor2 = q41Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18904h5);
            Paint paint = this.f26941w0;
            paint.setColor(themedColor2);
            int max = (int) Math.max(0.0f, e51Var.getTranslationY() + (AndroidUtilities.statusBarHeight - i12) + ((1.0f - Z()) * i12) + q41Var.f27246f + AndroidUtilities.dp(24.0f));
            i10 = ((org.telegram.ui.ActionBar.f3) q41Var).backgroundPaddingLeft;
        ...
        gradientDrawable.setBounds((getWidth() - dp) / 2, org.telegram.messenger.y0.C(10.0f, q41Var.f27246f, i13), (getWidth() + dp) / 2, AndroidUtilities.dp(10.0f) + q41Var.f27246f + i13 + dp2);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (Z > 0.0f && Z < 1.0f) {
            ...
            gradientDrawable.setColor(q41Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18904h5));
            float[] fArr = this.C0;
            fArr[3] = dp;
            fArr[2] = dp;
            fArr[1] = dp;
            ...
            gradientDrawable.setBounds(i12, q41Var.f27246f + i15, width - i13, AndroidUtilities.dp(24.0f) + q41Var.f27246f + i15);
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            q41 q41Var = this.E0;
            if (q41Var.f27246f != 0 && motionEvent.getY() < q41Var.f27246f) {
                q41Var.dismiss();
                return true;
            }
        }
