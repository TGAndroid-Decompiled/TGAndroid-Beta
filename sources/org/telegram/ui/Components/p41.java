...
public class p41 extends org.telegram.ui.ActionBar.f3 {
    ...
    public final GradientDrawable f29301c;
    public final o41 d;
    public final d51 f29302e;
    public int f29303f;
    ...
    public p41(Context context, org.telegram.ui.ActionBar.n2 n2Var, d51 d51Var, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f29300b = AndroidUtilities.dp(12.0f);
        this.f29301c = new GradientDrawable();
    ...
    public static void m(p41 p41Var) {
        ...
        if (d51Var.c()) {
            p41Var.f29303f = d51Var.getContentTopOffset();
    ...
    public void dismiss() {
        super.dismiss();
        d51 d51Var = this.f29302e;
        NotificationCenter notificationCenter = NotificationCenter.getInstance(d51Var.f25257a);
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        s41 s41Var = d51Var.h;
        arrayList.add(new org.telegram.ui.ActionBar.l6(s41Var.f32320a, 32, null, null, null, null, org.telegram.ui.ActionBar.j6.O5));
        ImageView imageView = s41Var.f32321b;
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(s41Var.f32322c, 8, null, null, null, null, i10));
        di.h2 h2Var = s41Var.f32323e;
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(t41Var, 4, new Class[]{org.telegram.ui.Cells.p3.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f21089z6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(t41Var, 0, new Class[]{org.telegram.ui.Cells.p3.class}, org.telegram.ui.ActionBar.j6.f20813k0, null, null, org.telegram.ui.ActionBar.j6.f20692d7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(d51Var.f25261f, 1, null, null, null, null, org.telegram.ui.ActionBar.j6.V5));
        FrameLayout frameLayout = d51Var.f25265w;
