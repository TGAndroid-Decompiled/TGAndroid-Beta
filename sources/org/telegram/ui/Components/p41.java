...
public final class p41 extends FrameLayout implements org.telegram.ui.ActionBar.x5 {
    public final org.telegram.ui.ActionBar.d6 f27216a;
    public final LinearLayout f27217b;
    public final TextView f27218c;
    public final TextView d;
    public final TextView e;
    public final ImageView f27219f;
    public final LinearLayout h;
    public final pp f27220n;
    public final LinearLayout f27221r;
    public final ImageView f27222s;
    public final TextView v;

    public p41(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f27216a = d6Var;
        ...
        pp ppVar = new pp(context, 20, d6Var);
        this.f27220n = ppVar;
    ...
    public final void e() {
        ...
        org.telegram.ui.ActionBar.d6 d6Var = this.f27216a;
        this.f27218c.setTextColor(org.telegram.ui.ActionBar.h6.v0(i10, d6Var));
        ...
        this.f27219f.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(i11, d6Var), PorterDuff.Mode.MULTIPLY));
        LinearLayout linearLayout = this.f27217b;
        ...
        this.f27222s.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(i12, d6Var), PorterDuff.Mode.SRC_IN));
        this.v.setTextColor(org.telegram.ui.ActionBar.h6.v0(i12, d6Var));
        this.f27221r.setBackground(org.telegram.ui.ActionBar.h6.Y(org.telegram.ui.ActionBar.h6.l1(0.1f, org.telegram.ui.ActionBar.h6.v0(i12, d6Var)), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f)));
    }
