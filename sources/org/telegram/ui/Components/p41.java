...
public final class p41 extends qv0 {
    public boolean A0;
    public final q41 B0;
    public final Paint f27726t0;
    public boolean f27727u0;
    public boolean f27728v0;
    public boolean f27729w0;
    public ValueAnimator f27730x0;
    public float f27731y0;
    public final float[] f27732z0;
    ...
    public p41(q41 q41Var, Context context) {
        ...
        int i11;
        this.B0 = q41Var;
        this.f27726t0 = new Paint(1);
        this.f27727u0 = false;
        this.f27728v0 = false;
        this.f27729w0 = false;
        this.f27731y0 = 0.0f;
        this.f27732z0 = new float[8];
    ...
    public final float Z() {
        q41 q41Var = this.B0;
        return Math.min(1.0f, Math.max(0.0f, q41Var.f28068f / (q41Var.f28066b * 2.0f)));
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        q41 q41Var = this.B0;
        e51 e51Var = q41Var.e;
        int i12 = q41Var.f28066b;
        GradientDrawable gradientDrawable = q41Var.f28067c;
        float Z = Z();
        boolean z12 = false;
        ...
        if (this.f27729w0 != z4) {
            ValueAnimator valueAnimator = this.f27730x0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            this.f27729w0 = z4;
            ValueAnimator valueAnimator2 = this.f27730x0;
            if (valueAnimator2 == null) {
                float f12 = this.f27731y0;
                if (z4) {
                    f11 = 1.0f;
                } else {
                    f11 = 0.0f;
                ...
                this.f27730x0 = ofFloat;
                ofFloat.addUpdateListener(new j70(this, 29));
                this.f27730x0.setDuration(200L);
            } else {
                float f13 = this.f27731y0;
                if (z4) {
                    f10 = 1.0f;
                } else {
                    f10 = 0.0f;
        ...
        if (this.A0 != z10) {
            this.A0 = z10;
            if (AndroidUtilities.computePerceivedBrightness(q41Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19952h5)) > 0.721f) {
                z11 = true;
            } else {
                z11 = false;
            }
            if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v(q41Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20151s8), 855638016)) > 0.721f) {
                z12 = true;
            }
            if (!z10) {
                z11 = z12;
        ...
        if (this.f27731y0 > 0.0f) {
            int themedColor2 = q41Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19952h5);
            Paint paint = this.f27726t0;
            paint.setColor(themedColor2);
            int max = (int) Math.max(0.0f, e51Var.getTranslationY() + (AndroidUtilities.statusBarHeight - i12) + ((1.0f - Z()) * i12) + q41Var.f28068f + AndroidUtilities.dp(24.0f));
            i10 = ((org.telegram.ui.ActionBar.g3) q41Var).backgroundPaddingLeft;
            int measuredWidth = getMeasuredWidth();
            i11 = ((org.telegram.ui.ActionBar.g3) q41Var).backgroundPaddingLeft;
            float f14 = max;
            canvas2 = canvas;
            canvas2.drawRect(i10, AndroidUtilities.lerp(max, -AndroidUtilities.statusBarHeight, this.f27731y0), measuredWidth - i11, f14, paint);
        } else {
            canvas2 = canvas;
        }
        ...
        gradientDrawable.setBounds((getWidth() - dp) / 2, org.telegram.messenger.y3.C(10.0f, q41Var.f28068f, i13), (getWidth() + dp) / 2, AndroidUtilities.dp(10.0f) + q41Var.f28068f + i13 + dp2);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (Z > 0.0f && Z < 1.0f) {
            ...
            gradientDrawable.setColor(q41Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19952h5));
            float[] fArr = this.f27732z0;
            fArr[3] = dp;
            fArr[2] = dp;
            fArr[1] = dp;
            fArr[0] = dp;
            ...
            gradientDrawable.setBounds(i12, q41Var.f28068f + i15, width - i13, AndroidUtilities.dp(24.0f) + q41Var.f28068f + i15);
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            q41 q41Var = this.B0;
            if (q41Var.f28068f != 0 && motionEvent.getY() < q41Var.f28068f) {
                q41Var.dismiss();
                return true;
            }
        }
