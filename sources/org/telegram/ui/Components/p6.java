...
public class p6 extends Drawable {
    ...
    public Runnable V;
    public final TextPaint f29311a;
    public int f29312b;
    ...
    public m6[] f29318j;
    public CharSequence f29319k;
    public int f29320l;
    public float f29321m;
    public boolean f29322n;
    public ValueAnimator f29323o;
    public CharSequence f29324p;
    public boolean f29325q;
    public long f29326r;
    public TimeInterpolator f29327s;
    public float f29328t;
    public float f29329u;
    public float v;
    public int f29330w;
    public final Rect f29331x;
    ...
    public final void a(float f7) {
        TextPaint textPaint = this.f29311a;
        textPaint.setAlpha((int) (this.f29330w * f7));
        if (this.O) {
    ...
    public final void b() {
        ValueAnimator valueAnimator = this.f29323o;
    ...
    public final void c() {
        if (this.f29318j != null) {
            int i10 = 0;
            while (true) {
                m6[] m6VarArr = this.f29318j;
                if (i10 >= m6VarArr.length) {
                    break;
                }
                m6 m6Var = m6VarArr[i10];
                p6 p6Var = m6Var.f28419g;
                if (p6Var.getCallback() instanceof View) {
                    z5.release((View) p6Var.getCallback(), m6Var.f28414a);
                }
                i10++;
            }
        }
    ...
    public final float d() {
        if (this.f29315f != null && this.f29318j != null) {
            return AndroidUtilities.lerp(this.h, this.d, this.f29321m);
        }
        return this.d;
    }
    ...
    public final float g() {
        float f7;
        CharSequence charSequence = this.f29319k;
        float f10 = 0.0f;
        float f11 = 1.0f;
        ...
        CharSequence charSequence2 = this.f29316g;
    ...
    public final void l(float f7, float f10, float f11, float f12) {
        ...
        this.f29331x.set(i10, i11, i12, i13);
    }
    ...
    public final void p(float f7, float f10, int i10) {
        ...
        this.Q = f10;
        this.R = i10;
        this.f29311a.setShadowLayer(f7, 0.0f, f10, i10);
    }
    ...
    public final void q(CharSequence charSequence, boolean z10, boolean z11) {
        ...
        int i11;
        boolean z16;
        if (this.f29316g != null && charSequence != null) {
            z12 = z10;
        } else {
            z12 = false;
        }
        ...
        int i12 = this.G;
        if (i12 <= 0) {
            i12 = this.f29331x.width();
        }
        boolean z17 = true;
        if (z12) {
            if (!TextUtils.equals(charSequence2, this.f29316g)) {
                if (this.D) {
                    ValueAnimator valueAnimator = this.f29323o;
                    if (valueAnimator != null) {
                        valueAnimator.cancel();
                    ...
                    this.f29324p = charSequence2;
                    this.f29325q = z11;
                    return;
                }
                this.f29319k = this.f29316g;
                this.f29316g = charSequence2;
                ...
                if (this.f29332y) {
                    charSequence3 = new o6(this.f29319k);
                } else {
                    charSequence3 = this.f29319k;
                }
                if (this.f29332y) {
                    charSequence4 = new o6(this.f29316g);
                } else {
                    charSequence4 = this.f29316g;
                }
                if (this.F) {
                    i(n6Var2, charSequence3, 0, charSequence3.length());
                    i(n6Var, charSequence4, 0, charSequence4.length());
                } else if (this.f29333z) {
                ...
                if (this.f29318j != null) {
                    ...
                    while (true) {
                        ...
                        p6 p6Var = m6Var2.f28419g;
                        if (p6Var.getCallback() instanceof View) {
                            z5.release((View) p6Var.getCallback(), m6Var2.f28414a);
                        }
                        i27++;
                    }
                }
                this.f29318j = null;
                m6[] m6VarArr2 = this.f29315f;
                if (m6VarArr2 == null || m6VarArr2.length != arrayList.size()) {
                    this.f29315f = new m6[arrayList.size()];
                }
                arrayList.toArray(this.f29315f);
                c();
                m6[] m6VarArr3 = this.f29318j;
                if (m6VarArr3 == null || m6VarArr3.length != arrayList2.size()) {
                    this.f29318j = new m6[arrayList2.size()];
                }
                arrayList2.toArray(this.f29318j);
                ValueAnimator valueAnimator2 = this.f29323o;
                if (valueAnimator2 != null) {
                    valueAnimator2.cancel();
                }
                this.f29322n = z11;
                this.f29321m = 0.0f;
                this.f29323o = ValueAnimator.ofFloat(0.0f, 1.0f);
                Runnable runnable = this.V;
                if (runnable != null) {
                    runnable.run();
                }
                this.f29323o.addUpdateListener(new l6(this, 0));
                this.f29323o.addListener(new j6(this, 1));
                this.f29323o.setStartDelay(0L);
                this.f29323o.setDuration(this.f29326r);
                this.f29323o.setInterpolator(this.f29327s);
                this.f29323o.start();
                return;
            }
            return;
        }
        ValueAnimator valueAnimator3 = this.f29323o;
        ...
        this.f29325q = false;
        this.f29321m = 0.0f;
        if (!charSequence2.equals(this.f29316g)) {
            if (this.f29318j != null) {
                int i28 = 0;
                while (true) {
                    m6[] m6VarArr4 = this.f29318j;
                    if (i28 >= m6VarArr4.length) {
                        break;
                    }
                    m6 m6Var3 = m6VarArr4[i28];
                    p6 p6Var2 = m6Var3.f28419g;
                    if (p6Var2.getCallback() instanceof View) {
                        z5.release((View) p6Var2.getCallback(), m6Var3.f28414a);
                    }
                    i28++;
                }
            }
            ...
            this.d = this.f29315f[0].f28418f;
            this.f29314e = m6Var.f28415b.getHeight();
            this.f29313c = AndroidUtilities.isRTL(this.f29316g);
        }
        c();
        this.f29319k = null;
    ...
    public final void r(int i10) {
        this.f29311a.setColor(i10);
        this.f29330w = Color.alpha(i10);
    }
    ...
    public final void s(int i10, boolean z10) {
        ...
        int color = this.f29311a.getColor();
    ...
    public final void setBounds(Rect rect) {
        ...
        this.f29331x.set(rect);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f29311a.setColorFilter(colorFilter);
    }
    ...
    public final void t(float f7) {
        ...
        if (Math.abs(textSize - f7) > 0.5f) {
            ...
            if (this.f29315f != null) {
                ...
                int i12 = 0;
                while (true) {
                    m6[] m6VarArr = this.f29315f;
                    if (i12 >= m6VarArr.length) {
                        break;
                    }
                    StaticLayout h = h(i10 - ((int) Math.ceil(Math.min(this.d, this.h))), m6VarArr[i12].f28415b.getText());
                    m6[] m6VarArr2 = this.f29315f;
                    m6 m6Var = m6VarArr2[i12];
                    m6VarArr2[i12] = new m6(this, h, m6Var.f28416c, m6Var.d);
                    float f10 = this.d;
                    m6 m6Var2 = this.f29315f[i12];
                    this.d = f10 + m6Var2.f28418f;
                    this.f29314e = Math.max(this.f29314e, m6Var2.f28415b.getHeight());
                    i12++;
                }
            }
            if (this.f29318j != null) {
                ...
                while (true) {
                    ...
                    StaticLayout h10 = h(i10 - ((int) Math.ceil(Math.min(this.d, this.h))), m6VarArr3[i11].f28415b.getText());
                    m6[] m6VarArr4 = this.f29318j;
                    m6 m6Var3 = m6VarArr4[i11];
                    m6VarArr4[i11] = new m6(this, h10, m6Var3.f28416c, m6Var3.d);
                    float f11 = this.h;
                    m6 m6Var4 = this.f29318j[i11];
                    this.h = f11 + m6Var4.f28418f;
                    this.f29317i = Math.max(this.f29317i, m6Var4.f28415b.getHeight());
                    i11++;
                }
            }
            invalidateSelf();
    ...
    public final void u(Typeface typeface) {
        this.f29311a.setTypeface(typeface);
    }

    public p6(boolean z10, boolean z11, boolean z12, boolean z13) {
        this.f29311a = new TextPaint(1);
        this.f29312b = 0;
        this.f29313c = false;
        this.f29320l = 0;
        this.f29321m = 0.0f;
