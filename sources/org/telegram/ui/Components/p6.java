...
public class p6 extends View {
    ...
    public final void b(float f7, long j3, TimeInterpolator timeInterpolator) {
        this.f26940c.k(f7, j3, timeInterpolator);
    }
    ...
    public final void c(CharSequence charSequence, boolean z10, boolean z11) {
        ...
        this.f26943r = false;
        o6 o6Var = this.f26940c;
        if (z12 && !TextUtils.equals(charSequence, o6Var.f26617g)) {
            if (o6Var.D) {
                ValueAnimator valueAnimator = o6Var.f26624o;
                if (valueAnimator != null) {
                    valueAnimator.cancel();
                    o6Var.f26624o = null;
                }
            } else if (o6Var.f()) {
                this.f26941f = charSequence;
                this.h = z11;
                return;
            }
        }
    ...
    public final int d() {
        return getPaddingRight() + getPaddingLeft() + ((int) Math.ceil(this.f26940c.d()));
    }
    ...
    public TextPaint getPaint() {
        return this.f26940c.f26613a;
    }

    public float getRightPadding() {
        return this.f26940c.H;
    }
    ...
    public CharSequence getText() {
        return this.f26940c.f26617g;
    }

    public int getTextColor() {
        return this.f26940c.f26613a.getColor();
    }
    ...
    public void onDraw(Canvas canvas) {
        Drawable drawable = this.f26939b;
        o6 o6Var = this.f26940c;
        if (drawable != null && (!this.f26938a || o6Var.g() > 0.0f)) {
            int d = (int) (o6Var.d() + getPaddingLeft() + getPaddingRight());
            if ((o6Var.f26614b & 7) == 5) {
                this.f26939b.setBounds(getWidth() - d, 0, getWidth(), getHeight());
            } else {
                this.f26939b.setBounds(0, 0, d, getHeight());
            }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (i13 != size && getLayoutParams().width != 0) {
            ...
            o6Var.q(o6Var.f26617g, false, true);
        }
        this.d = size;
        if (this.f26942n && View.MeasureSpec.getMode(i10) == Integer.MIN_VALUE) {
    ...
    public void setEmojiColorFilter(ColorFilter colorFilter) {
        this.f26940c.U = colorFilter;
        invalidate();
    }

    public void setGravity(int i10) {
        this.f26940c.f26614b = i10;
    }
