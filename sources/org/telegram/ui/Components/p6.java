...
public class p6 extends View {
    ...
    public Drawable f27273b;
    public final o6 f27274c;
    public int d;
    public int e;
    public CharSequence f27275f;
    public boolean h;
    ...
    public final void b(float f7, long j3, TimeInterpolator timeInterpolator) {
        this.f27274c.k(f7, j3, timeInterpolator);
    }
    ...
    public final void c(CharSequence charSequence, boolean z10, boolean z11) {
        ...
        this.f27277r = false;
        o6 o6Var = this.f27274c;
        if (z12 && !TextUtils.equals(charSequence, o6Var.f26932g)) {
            if (o6Var.D) {
                ValueAnimator valueAnimator = o6Var.f26939o;
                if (valueAnimator != null) {
                    valueAnimator.cancel();
                    o6Var.f26939o = null;
                }
            } else if (o6Var.f()) {
                this.f27275f = charSequence;
                this.h = z11;
                return;
            }
        }
    ...
    public final int d() {
        return getPaddingRight() + getPaddingLeft() + ((int) Math.ceil(this.f27274c.d()));
    }
    ...
    public TextPaint getPaint() {
        return this.f27274c.f26928a;
    }

    public float getRightPadding() {
        return this.f27274c.H;
    }
    ...
    public CharSequence getText() {
        return this.f27274c.f26932g;
    }

    public int getTextColor() {
        return this.f27274c.f26928a.getColor();
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        o6 o6Var = this.f27274c;
        if (drawable != null && (!this.f27272a || o6Var.g() > 0.0f)) {
            int d = (int) (o6Var.d() + getPaddingLeft() + getPaddingRight());
            if ((o6Var.f26929b & 7) == 5) {
                this.f27273b.setBounds(getWidth() - d, 0, getWidth(), getHeight());
            } else {
                this.f27273b.setBounds(0, 0, d, getHeight());
            }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (i13 != size && getLayoutParams().width != 0) {
            ...
            o6Var.q(o6Var.f26932g, false, true);
        }
        this.d = size;
        if (this.f27276n && View.MeasureSpec.getMode(i10) == Integer.MIN_VALUE) {
    ...
    public void setEmojiColorFilter(ColorFilter colorFilter) {
        this.f27274c.U = colorFilter;
        invalidate();
    }

    public void setGravity(int i10) {
        this.f27274c.f26929b = i10;
    }
