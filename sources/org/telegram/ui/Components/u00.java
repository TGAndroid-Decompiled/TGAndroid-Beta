...
public abstract class u00 extends co0 {
    ...
    public final void e(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.d) {
            accessibilityNodeInfo.addAction((AccessibilityNodeInfo.AccessibilityAction) s0.b.h.f45711a);
    ...
    public final boolean g(View view, int i10, Bundle bundle) {
        ...
        if (i10 == ((AccessibilityNodeInfo.AccessibilityAction) s0.b.h.f45711a).getId()) {
