...
public class u00 extends View implements org.telegram.ui.ActionBar.x5 {
    ...
    public float T;
    public int f28654a;
    public LinearGradient f28655b;
    public final Paint f28656c;
    public final Paint d;
    public long e;
    public int f28657f;
    public final Matrix h;
    public final RectF f28658n;
    public int f28659r;
    public int f28660s;
    public int v;
    public boolean f28661w;
    ...
    public final void e() {
        ...
        if (this.f28660s == v03 && this.f28659r == v02) {
            return;
        }
        this.f28659r = v02;
        this.f28660s = v03;
        ...
        if (i12 != 34 && i12 != 35 && i12 != 36) {
            if (!this.f28663y && i12 != 13 && i12 != 14 && i12 != 17) {
                this.f28654a = AndroidUtilities.dp(600.0f);
            } else {
                this.f28654a = AndroidUtilities.dp(200.0f);
            }
        } else {
            this.f28654a = AndroidUtilities.displaySize.x;
        }
        if (!this.f28663y && (i10 = this.E) != 13 && i10 != 14 && i10 != 17) {
            this.f28655b = new LinearGradient(0.0f, 0.0f, 0.0f, this.f28654a, new int[]{v03, v02, v02, v03}, new float[]{0.0f, 0.4f, 0.6f, 1.0f}, Shader.TileMode.CLAMP);
        } else {
            this.f28655b = new LinearGradient(0.0f, 0.0f, this.f28654a, 0.0f, new int[]{v03, v02, v02, v03}, new float[]{0.0f, 0.4f, 0.6f, 1.0f}, Shader.TileMode.CLAMP);
        }
        this.f28656c.setShader(this.f28655b);
    }
    ...
    public final void h() {
        ...
        boolean z10 = this.f28663y;
        Matrix matrix = this.h;
        if (!z10 && this.E != 13 && getViewType() != 14 && getViewType() != 17) {
            int i13 = (int) ((((float) (abs * i12)) / 400.0f) + this.f28657f);
            this.f28657f = i13;
            if (i13 >= i12 * 2) {
                this.f28657f = (-this.f28654a) * 2;
            }
            matrix.setTranslate(this.Q, this.f28657f);
        } else {
            int i14 = (int) ((((float) (abs * i10)) / 400.0f) + this.f28657f);
            this.f28657f = i14;
            if (i14 >= i10 * 2) {
                this.f28657f = (-this.f28654a) * 2;
            }
            matrix.setTranslate(this.f28657f + this.Q, 0.0f);
        }
        LinearGradient linearGradient = this.f28655b;
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (viewType == 7) {
            ...
            if (getViewType() == 19) {
                ...
                int i48 = 0;
                while (true) {
                    if (i47 >= getMeasuredHeight() && !this.f28663y) {
                        break;
                    }
                    int i49 = 0;
    ...
    public u00(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f28656c = new Paint();
        this.d = new Paint();
        this.f28658n = new RectF();
        this.f28661w = true;
