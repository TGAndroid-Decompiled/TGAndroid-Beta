...
public class u00 extends View implements org.telegram.ui.ActionBar.x5 {
    ...
    public float T;
    public int f28655a;
    public LinearGradient f28656b;
    public final Paint f28657c;
    public final Paint d;
    public long e;
    public int f28658f;
    public final Matrix h;
    public final RectF f28659n;
    public int f28660r;
    public int f28661s;
    public int v;
    public boolean f28662w;
    public boolean f28663x;
    public boolean f28664y;
    ...
    public final void e() {
        ...
        if (this.f28661s == v03 && this.f28660r == v02) {
            return;
        }
        this.f28660r = v02;
        this.f28661s = v03;
        ...
        if (i12 != 34 && i12 != 35 && i12 != 36) {
            if (!this.f28664y && i12 != 13 && i12 != 14 && i12 != 17) {
                this.f28655a = AndroidUtilities.dp(600.0f);
            } else {
                this.f28655a = AndroidUtilities.dp(200.0f);
            }
        } else {
            this.f28655a = AndroidUtilities.displaySize.x;
        }
        if (!this.f28664y && (i10 = this.E) != 13 && i10 != 14 && i10 != 17) {
            this.f28656b = new LinearGradient(0.0f, 0.0f, 0.0f, this.f28655a, new int[]{v03, v02, v02, v03}, new float[]{0.0f, 0.4f, 0.6f, 1.0f}, Shader.TileMode.CLAMP);
        } else {
            this.f28656b = new LinearGradient(0.0f, 0.0f, this.f28655a, 0.0f, new int[]{v03, v02, v02, v03}, new float[]{0.0f, 0.4f, 0.6f, 1.0f}, Shader.TileMode.CLAMP);
        }
        this.f28657c.setShader(this.f28656b);
    }
    ...
    public final void h() {
        ...
        boolean z10 = this.f28664y;
        Matrix matrix = this.h;
        if (!z10 && this.E != 13 && getViewType() != 14 && getViewType() != 17) {
            int i13 = (int) ((((float) (abs * i12)) / 400.0f) + this.f28658f);
            this.f28658f = i13;
            if (i13 >= i12 * 2) {
                this.f28658f = (-this.f28655a) * 2;
            }
            matrix.setTranslate(this.Q, this.f28658f);
        } else {
            int i14 = (int) ((((float) (abs * i10)) / 400.0f) + this.f28658f);
            this.f28658f = i14;
            if (i14 >= i10 * 2) {
                this.f28658f = (-this.f28655a) * 2;
            }
            matrix.setTranslate(this.f28658f + this.Q, 0.0f);
        }
        LinearGradient linearGradient = this.f28656b;
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (viewType == 7) {
            ...
            if (getViewType() == 19) {
                ...
                if (getViewType() == 3) {
                    ...
                    if (getViewType() == 29) {
                        ...
                        while (dp27 < getMeasuredWidth()) {
                            ...
                            this.N.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19130h5, this.L));
                ...
                int i48 = 0;
                while (true) {
                    if (i47 >= getMeasuredHeight() && !this.f28664y) {
                        break;
                    }
                    int i49 = 0;
    ...
    public u00(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f28657c = new Paint();
        this.d = new Paint();
        this.f28659n = new RectF();
        this.f28662w = true;
        this.H = org.telegram.ui.ActionBar.h6.G8;
        this.I = org.telegram.ui.ActionBar.h6.f19149i6;
        this.J = -1;
        this.K = 1;
        this.L = d6Var;
        this.h = new Matrix();
