...
public final class si extends kl0 {
    ...
    public final int h() {
        int i10 = this.I;
        vi viVar = this.J;
        if (viVar.H1 == null && (viVar.f31279f0 instanceof org.telegram.ui.co) && !viVar.H) {
    ...
    public final int j(int i10) {
        ...
        if (i10 >= this.f30300e && i10 < this.f30301f) {
            return 1;
        }
        return 0;
    }
    ...
    public final void l() {
        ...
        if (viVar.H) {
            ...
            if (n2Var instanceof org.telegram.ui.co) {
                chat = ((org.telegram.ui.co) n2Var).f35237e;
            } else {
                chat = null;
            }
            z10 = (i27 == null || ((org.telegram.ui.co) n2Var).getMessagesController().getSendPaidMessagesStars(i27.f20016id) <= 0) ? false : false;
            int i28 = this.I;
            this.I = i28 + 1;
            this.d = i28;
                ...
                if (coVar.R3 != 5) {
                    ...
                    while (i10 < size) {
                        ...
                        if (tL_attachMenuBot2.show_in_attach_menu) {
                            TLObject tLObject = coVar.f35237e;
                            if (tLObject == null) {
                                tLObject = coVar.i();
                            }
            ...
            if ((n2Var instanceof org.telegram.ui.co) && ((org.telegram.ui.co) n2Var).R3 == 0 && i27 != null && !z10 && !i27.bot && !ig.b2.f(i11).f12007b.isEmpty()) {
                int i35 = this.I;
                this.I = i35 + 1;
                this.f30306x = i35;
            }
