...
public final class mi extends aw0 {
    ...
    public final wi B0;
    public int f26495w0;
    public final RectF f26496x0;
    public boolean f26497y0;
    public float f26498z0;

    public mi(wi wiVar, Context context) {
        super(context, null);
        this.B0 = wiVar;
        this.f26496x0 = new RectF();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if ((oiVar2 == rmVar || (oiVar = wiVar.f30049z0) == rmVar || (oiVar2 == wiVar.f29997j0 && oiVar == null)) && oiVar2 != null) {
            canvas.save();
            float f15 = wiVar.f30004l2;
            boolean z10 = wiVar.f29988g0;
            ci.m6 m6Var = wiVar.O0;
            yh yhVar = wiVar.f29995i1;
            ...
            if (h == 2) {
                ...
                float f18 = i27;
                f11 = 0.0f;
                if (oiVar2 == wiVar.f30011o0) {
                    dp = AndroidUtilities.dp(11.0f);
                } else {
                    if (oiVar2 == wiVar.m0) {
                        dp2 = AndroidUtilities.dp(3.0f);
                    } else if (oiVar2 == wiVar.f30008n0) {
                        dp2 = AndroidUtilities.dp(3.0f);
                    } else {
            ...
            if (wiVar.f30046y0.f()) {
                q12 = wiVar.f30046y0.getCustomBackground();
            } else {
                q12 = wiVar.q1(true);
            }
            ...
            RectF rectF = this.f26496x0;
            if (h == 2) {
                org.telegram.ui.ActionBar.h6.f19334t0.setColor(q12);
                org.telegram.ui.ActionBar.h6.f19334t0.setAlpha(alpha2);
            ...
            if ((f13 != 1.0f && h != 2) || wiVar.f30046y0.e()) {
                Paint paint = org.telegram.ui.ActionBar.h6.f19334t0;
                if (wiVar.f30046y0.e()) {
                    q12 = wiVar.f30046y0.getCustomActionBarBackground();
                }
                paint.setColor(q12);
                org.telegram.ui.ActionBar.h6.f19334t0.setAlpha(alpha2);
            ...
            if (wiVar.f30046y0.e()) {
                org.telegram.ui.ActionBar.h6.f19334t0.setColor(wiVar.f30046y0.getCustomActionBarBackground());
                org.telegram.ui.ActionBar.h6.f19334t0.setAlpha(alpha2);
                int p13 = wiVar.p1(0);
                if (!z10) {
                ...
                canvas.save();
                canvas.drawRect(rectF, org.telegram.ui.ActionBar.h6.f19334t0);
                canvas.restore();
            }
            if ((yhVar == null || yhVar.getAlpha() != 1.0f) && f13 != f11) {
                ...
                if (h == 2) {
                    ...
                    f16 = f13;
                } else if (wiVar.f30046y0.e()) {
                    int customActionBarBackground = wiVar.f30046y0.getCustomActionBarBackground();
                ...
                org.telegram.ui.ActionBar.h6.f19334t0.setAlpha((int) (oiVar2.getAlpha() * alpha4 * f16 * f13));
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if ((view instanceof oi) && view.getAlpha() > 0.0f) {
            canvas.save();
            canvas.translate(0.0f, wiVar.f30004l2);
            ...
            int i35 = i19;
            if (h != 2) {
                i20 = ((org.telegram.ui.ActionBar.e3) wiVar).backgroundPaddingTop;
                f14 = 0.0f;
                if (i20 + i33 < i35) {
                    float f17 = i32;
                    if (oiVar2 == wiVar.f30011o0) {
                ...
                i30 = ((org.telegram.ui.ActionBar.e3) wiVar).backgroundPaddingTop;
            ...
            rm rmVar = wiVar.f30017q0;
            if (oiVar3 != rmVar && (oiVar = wiVar.f30049z0) != rmVar && (oiVar3 != wiVar.f29997j0 || oiVar != null)) {
                z10 = true;
            } else {
                z10 = false;
            }
            ...
            if (z10) {
                ...
                if (h == 2) {
                    ...
                    i28 = ((org.telegram.ui.ActionBar.e3) wiVar).backgroundPaddingLeft;
                    i29 = ((org.telegram.ui.ActionBar.e3) wiVar).backgroundPaddingTop;
                    rectF.set(i26, i27 + i33, measuredWidth - i28, AndroidUtilities.dp(24.0f) + i29 + i33);
                }
            }
            if (view != wiVar.f30000k0 && view != wiVar.f30025s0 && view != wiVar.f30003l0) {
                canvas.save();
            ...
            if (z10) {
                ...
                if ((yhVar == null || yhVar.getAlpha() != 1.0f) && f16 != f14) {
                    ...
                    org.telegram.ui.ActionBar.h6.f19334t0.setColor(themedColor);
                    org.telegram.ui.ActionBar.h6.f19334t0.setAlpha((int) (view.getAlpha() * alpha3 * alpha * f16));
                    canvas.drawRoundRect(rectF, AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f), org.telegram.ui.ActionBar.h6.f19334t0);
                }
            }
            canvas.restore();
            ...
            if (oiVar4 != null) {
                ...
                if (h10 != 2) {
                    ...
                    if (i13 + i40 < i12) {
                        float f18 = i39;
                        if (oiVar4 == wiVar.f30011o0) {
                            dp = AndroidUtilities.dp(11.0f);
                        } else {
                            if (oiVar4 == wiVar.m0) {
                                dp2 = AndroidUtilities.dp(3.0f);
                            } else if (oiVar4 == wiVar.f30008n0) {
                                dp2 = AndroidUtilities.dp(3.0f);
                            } else {
                                dp = AndroidUtilities.dp(4.0f);
                            }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (wiVar.f30046y0.l(motionEvent)) {
            return true;
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ((FrameLayout.LayoutParams) wiVar.f29986f1.getLayoutParams()).height = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight();
        miVar.f26497y0 = true;
        ...
        if (wiVar.m0 != null && AndroidUtilities.dp(20.0f) >= 0) {
            vn vnVar3 = wiVar.m0;
            if (!vnVar3.G && !vnVar3.f29176a1 && !vnVar3.f29186f1 && !vnVar3.f29190h1) {
                miVar.f26497y0 = true;
                vnVar3.a0();
                miVar.f26497y0 = false;
            }
        }
        if (wiVar.f30008n0 != null && AndroidUtilities.dp(20.0f) >= 0) {
            vn vnVar4 = wiVar.f30008n0;
            if (!vnVar4.G && !vnVar4.f29176a1 && !vnVar4.f29186f1 && !vnVar4.f29190h1) {
                miVar.f26497y0 = true;
                vnVar4.a0();
                miVar.f26497y0 = false;
            }
        ...
        if (AndroidUtilities.dp(20.0f) >= 0) {
            ...
            if (z10) {
                ...
                vn vnVar5 = wiVar.m0;
                if (oiVar == vnVar5 && vnVar5.E != null && vnVar5.f29190h1) {
                    o12 = AndroidUtilities.dp(120.0f);
                } else {
                    vn vnVar6 = wiVar.f30008n0;
                    if (oiVar == vnVar6 && vnVar6.E != null && vnVar6.f29190h1) {
                        o12 = AndroidUtilities.dp(120.0f);
                    } else {
                        o12 = 0;
                    }
            ...
            if (f10 != null) {
                i15 = f10.f42126a.f(8).d;
            } else {
                i15 = 0;
            }
            r0.l1 f11 = r0.i0.f(miVar);
            if (f11 != null) {
                i16 = f11.f42126a.f(527).d;
            } else {
                i16 = 0;
            }
            Math.max(i16, o12);
        ...
        while (i22 < childCount) {
            ...
            if (childAt == null || childAt.getVisibility() == 8) {
                i14 = i23;
            } else if (childAt == wiVar.f30035v1) {
                i14 = i23;
                ...
                if (!biVar.l(childAt) && !eiVar.l(childAt) && (((vnVar = wiVar.m0) == null || childAt != vnVar.E) && ((vnVar2 = wiVar.f30008n0) == null || childAt != vnVar2.E))) {
    ...
    public final void setTranslationY(float f7) {
        ...
        if (i11 == 1) {
            if (f10 < 0.0f) {
                wiVar.f30046y0.setTranslationY(f10);
                if (wiVar.Q0 != 0 || wiVar.T0) {
                    wiVar.f29995i1.setTranslationY((wiVar.f30015p1 + f10) - wiVar.f30004l2);
                }
                yhVar.setTranslationY(0.0f);
                f10 = 0.0f;
            } else {
                wiVar.f30046y0.setTranslationY(0.0f);
                yhVar.setTranslationY(((f10 / this.f26498z0) * yhVar.getMeasuredHeight()) + (-f10));
            }
            viewGroup = ((org.telegram.ui.ActionBar.e3) wiVar).containerView;
            viewGroup.invalidate();
        }
        super.setTranslationY(f10 - wiVar.f30004l2);
