...
public final class pg extends j1.b {
    ...
    public final int g(float f7, float f10) {
        qg qgVar = this.f27031o;
        ChatActivityEnterView chatActivityEnterView = qgVar.V;
        if (chatActivityEnterView.f21831r4 && chatActivityEnterView.M1 != null && chatActivityEnterView.R3.contains(f7, f10)) {
            return 2;
        }
        if (chatActivityEnterView.P && chatActivityEnterView.M1 != null && chatActivityEnterView.f21803m4 > 0.1f && qgVar.J.contains(f7, f10)) {
            return 4;
        }
        return -1;
    }
    ...
    public final void h(ArrayList arrayList) {
        ChatActivityEnterView chatActivityEnterView = this.f27031o.V;
    ...
    public final void l(int i10, s0.c cVar) {
        ...
        if (i10 == 2) {
            ...
            if (chatActivityEnterView.f21815o4 > 0.5f) {
