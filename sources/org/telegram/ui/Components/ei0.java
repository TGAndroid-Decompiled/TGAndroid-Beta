...
public final class ei0 extends View {
    ...
    public float H;
    public float I;
    public final org.telegram.ui.ActionBar.g6 f26594a;
    public final PorterDuffColorFilter f26595b;
    public final PorterDuffColorFilter f26596c;
    public k01 d;
    public k01 f26597e;
    public final Paint f26598f;
    public final Paint h;
    public final Path f26599n;
    public final Drawable f26600r;
    public final RectF f26601s;
    public final Paint v;
    public final Paint f26602w;
    public final Path f26603x;
    public final rc f26604y;

    public ei0(Context context, org.telegram.ui.ActionBar.g6 g6Var) {
        super(context);
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.f26595b = new PorterDuffColorFilter(-1, mode);
        this.f26596c = new PorterDuffColorFilter(-16777216, mode);
        this.f26598f = new Paint();
        Paint paint = new Paint();
        this.h = paint;
        Path path = new Path();
        this.f26599n = path;
        this.f26601s = new RectF();
        this.v = new Paint(1);
        this.f26602w = new Paint(1);
        this.f26603x = new Path();
        this.f26604y = new rc(this);
        this.B = -1;
        this.f26594a = g6Var;
        this.f26600r = context.getResources().getDrawable(R.drawable.files_music).mutate();
    ...
    public final void a() {
        ...
        this.B = i10;
        if (z4) {
            porterDuffColorFilter = this.f26596c;
        } else {
            porterDuffColorFilter = this.f26595b;
        }
        this.f26600r.setColorFilter(porterDuffColorFilter);
        this.f26598f.setColor(this.B);
    ...
    public final void c(String str, String str2) {
        ...
        this.f26597e = new k01(str2, 11.0f, null);
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        RectF rectF = this.f26601s;
        rc rcVar = this.f26604y;
        if (action == 0) {
    ...
    public final void onDraw(Canvas canvas) {
        if (this.d != null && this.f26597e != null) {
            float clamp01 = Utilities.clamp01(this.I / AndroidUtilities.dp(21.0f));
            float a2 = this.f26604y.a(0.02f);
            if (clamp01 > 0.0f) {
                int width = getWidth() - (AndroidUtilities.dp(12.0f) * 2);
                this.d.f28238p = (width - AndroidUtilities.dp(35.0f)) / 2.0f;
                this.f26597e.f28238p = (width - this.d.l()) - AndroidUtilities.dp(35.0f);
                float l10 = this.f26597e.l() + this.d.l() + AndroidUtilities.dp(16.6f) + AndroidUtilities.dp(8.0f);
                ...
                int i12 = i10 - i11;
                int i13 = i10 + i11;
                Drawable drawable = this.f26600r;
                ...
                this.f26597e.c(0.0f, height, clamp01 * 0.85f, this.B, canvas);
                canvas.translate(this.f26597e.l(), 0.0f);
                float dpf2 = AndroidUtilities.dpf2(1.16f);
                Paint paint3 = this.h;
                paint3.setStrokeWidth(dpf2);
                canvas.translate(AndroidUtilities.dpf2(4.8f), height);
                canvas.drawPath(this.f26599n, paint3);
                canvas.restore();
                canvas.restore();
            }
        }
    ...
    public void setColor(MessagesController.PeerColor peerColor) {
        int bgColor1;
        int bgColor2;
        org.telegram.ui.ActionBar.g6 g6Var = this.f26594a;
        if (peerColor == null) {
            bgColor1 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21932s8, g6Var);
            bgColor2 = bgColor1;
        } else {
        ...
        if (peerColor == null) {
            this.D = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21661d6, g6Var);
            this.E = true;
        } else {
