...
public final class ei0 extends FrameLayout {
    ...
    public final Path f23945b;
    public final di0 f23946c;
    public float d;
    public float e;
    public float f23947f;
    public boolean h;
    public NotchInfoUtils.NotchInfo f23948n;
    ...
    public ei0(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 31 && SharedConfig.getDevicePerformanceClass() >= 1) {
            ...
            this.f23946c = new ci0(this, f7);
        } else {
            this.f23946c = new bi0(this);
        }
        setIntensity(15.0f);
    ...
    public static void a(ei0 ei0Var, Canvas canvas) {
        canvas.save();
    ...
    public final void draw(Canvas canvas) {
        ...
        this.f23946c.c(new nv(this, 13), canvas);
    }

    public float getAvatarEndScale() {
        float min;
        int dp;
        NotchInfoUtils.NotchInfo notchInfo = this.f23948n;
        if (notchInfo == null) {
            return 0.8f;
        }
        if (notchInfo.isLikelyCircle) {
            ...
            min = Math.min(notchInfo.bounds.width(), this.f23948n.bounds.height());
            dp = AndroidUtilities.dp(100.0f);
        }
