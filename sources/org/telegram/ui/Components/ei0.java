...
public final class ei0 extends Button {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Paint paint = this.f24589b;
        paint.setAlpha(min);
        canvas.drawArc(rectF, this.f24591f, 220.0f, false, paint);
        long currentTimeMillis = System.currentTimeMillis();
        if (Math.abs(this.e - System.currentTimeMillis()) < 1000) {
            long j10 = currentTimeMillis - this.e;
            int i10 = (int) (this.f24591f + (((float) (360 * j10)) / 2000.0f));
            this.f24591f = i10 - ((i10 / 360) * 360);
            if (this.f24590c) {
                float f10 = this.d;
                if (f10 < 1.0f) {
