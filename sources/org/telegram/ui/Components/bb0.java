    ...
    public final void onClick(View view) {
        ...
        switch (i10) {
            ...
            default:
                ...
                n70 n70Var = (n70) obj;
                nr0 nr0Var = ((xh.n2) frameLayout).f46034a;
                if (!z10) {
                    ...
                    vc.a0(nr0Var.f46105a).R(savedStarGift.gift.getDocument(), AndroidUtilities.replaceTags(LocaleController.formatString(R.string.Gift2AddedToCollection, yh.a4.D1(savedStarGift.gift), tL_starGiftCollection.title))).j();
                } else {
                    nr0Var.e.k(tL_starGiftCollection.collection_id, savedStarGift);
                    vc.a0(nr0Var.f46105a).R(savedStarGift.gift.getDocument(), AndroidUtilities.replaceTags(LocaleController.formatString(R.string.Gift2RemovedFromCollection, yh.a4.D1(savedStarGift.gift), tL_starGiftCollection.title))).j();
                }
                n70Var.u();
                nr0Var.n();
                return;
