...
public final class ek extends wl0 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        switch (this.X2) {
            case 0:
                if (this.Z2.f27373n == 2 && getChildCount() > 0) {
                    ...
                    this.Y2.setColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19130h5, false));
                }
                super.dispatchDraw(canvas);
                return;
            default:
                if (this.Z2.f27373n == 1 && getChildCount() > 0) {
