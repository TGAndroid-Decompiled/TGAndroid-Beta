...
public final class tf extends AnimatorListenerAdapter {
    public final ChatActivityEnterView f30623a;

    public tf(ChatActivityEnterView chatActivityEnterView) {
        this.f30623a = chatActivityEnterView;
    }

    @Override
    public final void onAnimationEnd(Animator animator) {
        ChatActivityEnterView chatActivityEnterView = this.f30623a;
        v71 v71Var = chatActivityEnterView.f23725f1;
        if (v71Var != null) {
        ...
        chatActivityEnterView.f23777o4 = 0.0f;
