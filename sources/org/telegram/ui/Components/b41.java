...
public final class b41 extends i51 {
    ...
    public final void bindView(View view, j51 j51Var, boolean z10, x51 x51Var, f61 f61Var) {
        ...
        LinearLayout linearLayout = c41Var.f22929r;
        LinearLayout linearLayout2 = c41Var.h;
        LinearLayout linearLayout3 = c41Var.f22925b;
        c41Var.f22926c.setText(charSequence);
        c41Var.d.setText(charSequence2);
        c41Var.e.setText(charSequence3);
        ImageView imageView = c41Var.f22927f;
        int i12 = 8;
    ...
    public final boolean contentsEquals(j51 j51Var, j51 j51Var2) {
        if (TextUtils.equals(j51Var.f25124l, j51Var2.f25124l) && TextUtils.equals(j51Var.f25125m, j51Var2.f25125m) && TextUtils.equals(j51Var.f25126n, j51Var2.f25126n) && j51Var.E == j51Var2.E) {
            return true;
        }
        return false;
    }
