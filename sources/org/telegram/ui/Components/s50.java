...
public final class s50 implements d5, org.telegram.ui.ActionBar.a2, ImageReceiver.ImageReceiverDelegate, MessagesStorage.BooleanCallback, t5.b, s5.e, x2.m, org.telegram.ui.oy {
    ...
    public void J(int i10, int i11, boolean z10) {
        ...
        int i13;
        long j3;
        v50 v50Var = (v50) this.f30224b;
        q50 q50Var = (q50) this.f30225c;
        ...
        if (!z10 && q50Var != null && !q50Var.f29618a) {
            z11 = false;
        } else {
            z11 = true;
        }
    ...
    public e9.a1 b(int i10, b2.l1 l1Var, int[] iArr) {
        x2.i iVar = (x2.i) this.f30224b;
        String str = (String) this.f30225c;
    ...
    public void g(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        switch (this.f30223a) {
            case 1:
                xu0 xu0Var = (xu0) this.f30224b;
                ArrayList arrayList = (ArrayList) this.d;
                ((bi.b8) this.f30225c).F(arrayList);
                yc.a0(xu0Var.f32754v1).Q(R.raw.ic_delete, 36, LocaleController.formatPluralString("BotPreviewsDeleted", arrayList.size(), new Object[0])).j();
                xu0Var.L(false);
                return;
            case 4:
                boolean[] zArr = (boolean[]) this.f30224b;
                JsPromptResult jsPromptResult = (JsPromptResult) this.f30225c;
                zt ztVar = (zt) this.d;
                if (!zArr[0]) {
                    zArr[0] = true;
                ...
                return;
            default:
                sg.k0.P((sg.k0) this.f30224b, (ArrayList) this.f30225c, (TLRPC.User) this.d);
                return;
        }
    }
    ...
    @Override
    public Object i() {
        q5.a aVar = (q5.a) this.f30224b;
        l5.i iVar = (l5.i) this.f30225c;
        l5.h hVar = (l5.h) this.d;
        s5.g gVar = (s5.g) aVar.d;
        gVar.getClass();
        i5.d dVar = iVar.f15312c;
        String str = hVar.f15305a;
    ...
    public void run(boolean z10) {
        TLRPC.Chat chat = (TLRPC.Chat) this.f30224b;
        org.telegram.ui.ActionBar.n2 n2Var = (org.telegram.ui.ActionBar.n2) this.f30225c;
    ...
    public boolean u(org.telegram.ui.uy uyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, eg1 eg1Var) {
        return zh.w3.X((zh.w3) this.f30224b, (TL_stars.TL_starGiftUnique) this.f30225c, (org.telegram.ui.uy) this.d, arrayList);
    }
}
