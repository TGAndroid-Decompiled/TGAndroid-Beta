...
public final class s50 implements d5, org.telegram.ui.ActionBar.a2, ImageReceiver.ImageReceiverDelegate, MessagesStorage.BooleanCallback, t5.b, s5.e, x2.m, org.telegram.ui.oy {
    ...
    public void J(int i10, int i11, boolean z10) {
        ...
        int i13;
        long j3;
        v50 v50Var = (v50) this.f30223b;
        q50 q50Var = (q50) this.f30224c;
        ...
        if (!z10 && q50Var != null && !q50Var.f29617a) {
            z11 = false;
        } else {
            z11 = true;
        }
    ...
    public void didSetImage(ImageReceiver imageReceiver, boolean z10, boolean z11, boolean z12) {
        Bitmap bitmap;
        int i10;
        t11 t11Var = (t11) this.f30223b;
        kp kpVar = (kp) this.f30224c;
    ...
    public void g(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        switch (this.f30222a) {
            case 1:
                xu0 xu0Var = (xu0) this.f30223b;
                ArrayList arrayList = (ArrayList) this.d;
                ((bi.b8) this.f30224c).F(arrayList);
                yc.a0(xu0Var.f32753v1).Q(R.raw.ic_delete, 36, LocaleController.formatPluralString("BotPreviewsDeleted", arrayList.size(), new Object[0])).j();
                xu0Var.L(false);
                return;
            case 4:
                boolean[] zArr = (boolean[]) this.f30223b;
                JsPromptResult jsPromptResult = (JsPromptResult) this.f30224c;
                zt ztVar = (zt) this.d;
                if (!zArr[0]) {
                    zArr[0] = true;
                ...
                return;
            default:
                sg.k0.P((sg.k0) this.f30223b, (ArrayList) this.f30224c, (TLRPC.User) this.d);
                return;
        }
    }
    ...
    @Override
    public Object i() {
        q5.a aVar = (q5.a) this.f30223b;
        l5.i iVar = (l5.i) this.f30224c;
    ...
    public void run(boolean z10) {
        TLRPC.Chat chat = (TLRPC.Chat) this.f30223b;
        org.telegram.ui.ActionBar.n2 n2Var = (org.telegram.ui.ActionBar.n2) this.f30224c;
    ...
    public boolean u(org.telegram.ui.uy uyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, eg1 eg1Var) {
        return zh.w3.X((zh.w3) this.f30223b, (TL_stars.TL_starGiftUnique) this.f30224c, (org.telegram.ui.uy) this.d, arrayList);
    }
}
