...
public final class s50 implements b5, org.telegram.ui.ActionBar.a2, ImageReceiver.ImageReceiverDelegate, MessagesStorage.BooleanCallback, t5.b, s5.e, x2.m, org.telegram.ui.oy {
    ...
    public void J(int i10, int i11, boolean z10) {
        ...
        int i13;
        long j3;
        v50 v50Var = (v50) this.f27779b;
        q50 q50Var = (q50) this.f27780c;
        ...
        if (!z10 && q50Var != null && !q50Var.f27254a) {
            z11 = false;
        } else {
            z11 = true;
        }
    ...
    public e9.a1 b(int i10, b2.l1 l1Var, int[] iArr) {
        x2.i iVar = (x2.i) this.f27779b;
        String str = (String) this.f27780c;
    ...
    public void didSetImage(ImageReceiver imageReceiver, boolean z10, boolean z11, boolean z12) {
        Bitmap bitmap;
        int i10;
        u11 u11Var = (u11) this.f27779b;
        lp lpVar = (lp) this.f27780c;
    ...
    public void f(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        switch (this.f27778a) {
            case 1:
                yu0 yu0Var = (yu0) this.f27779b;
                ArrayList arrayList = (ArrayList) this.d;
                ((ai.t8) this.f27780c).F(arrayList);
                vc.a0(yu0Var.f30392v1).Q(R.raw.ic_delete, 36, LocaleController.formatPluralString("BotPreviewsDeleted", arrayList.size(), new Object[0])).j();
                yu0Var.L(false);
                return;
            case 4:
                boolean[] zArr = (boolean[]) this.f27779b;
                JsPromptResult jsPromptResult = (JsPromptResult) this.f27780c;
                bu buVar = (bu) this.d;
                if (!zArr[0]) {
                    zArr[0] = true;
                ...
                return;
            default:
                rg.j0.P((rg.j0) this.f27779b, (ArrayList) this.f27780c, (TLRPC.User) this.d);
                return;
        }
    }
    ...
    @Override
    public Object i() {
        q5.a aVar = (q5.a) this.f27779b;
        l5.i iVar = (l5.i) this.f27780c;
        l5.h hVar = (l5.h) this.d;
        s5.g gVar = (s5.g) aVar.d;
        gVar.getClass();
        i5.d dVar = iVar.f13899c;
        String str = hVar.f13893a;
    ...
    public void run(boolean z10) {
        TLRPC.Chat chat = (TLRPC.Chat) this.f27779b;
        org.telegram.ui.ActionBar.n2 n2Var = (org.telegram.ui.ActionBar.n2) this.f27780c;
    ...
    public boolean u(org.telegram.ui.uy uyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, dg1 dg1Var) {
        return yh.a4.X((yh.a4) this.f27779b, (TL_stars.TL_starGiftUnique) this.f27780c, (org.telegram.ui.uy) this.d, arrayList);
    }
}
