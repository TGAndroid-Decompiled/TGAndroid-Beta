...
public final class s50 implements d5, org.telegram.ui.ActionBar.z1, ImageReceiver.ImageReceiverDelegate, MessagesStorage.BooleanCallback, t5.b, s5.f, e2.h, x2.m, org.telegram.ui.ky {
    ...
    public void J(int i10, int i11, boolean z10) {
        ...
        int i13;
        long j3;
        v50 v50Var = (v50) this.f28155b;
        q50 q50Var = (q50) this.f28156c;
        ...
        if (!z10 && q50Var != null && !q50Var.f27510a) {
            z11 = false;
        } else {
            z11 = true;
        }
    ...
    public void accept(Object obj) {
        ((u2.j0) obj).c(((a5.a) this.f28155b).f277b, (u2.f0) this.f28156c, (u2.b0) this.d);
    }
    ...
    public e9.a1 b(int i10, b2.l1 l1Var, int[] iArr) {
        x2.i iVar = (x2.i) this.f28155b;
        String str = (String) this.f28156c;
    ...
    public void didSetImage(ImageReceiver imageReceiver, boolean z10, boolean z11, boolean z12) {
        Bitmap bitmap;
        int i10;
        h21 h21Var = (h21) this.f28155b;
        mp mpVar = (mp) this.f28156c;
    ...
    public void f(org.telegram.ui.ActionBar.a2 a2Var, int i10) {
        switch (this.f28154a) {
            case 1:
                jv0 jv0Var = (jv0) this.f28155b;
                ArrayList arrayList = (ArrayList) this.d;
                ((ai.u8) this.f28156c).F(arrayList);
                xc.a0(jv0Var.f25559v1).Q(R.raw.ic_delete, 36, LocaleController.formatPluralString("BotPreviewsDeleted", arrayList.size(), new Object[0])).j();
                jv0Var.L(false);
                return;
            case 4:
                boolean[] zArr = (boolean[]) this.f28155b;
                JsPromptResult jsPromptResult = (JsPromptResult) this.f28156c;
                cu cuVar = (cu) this.d;
                if (!zArr[0]) {
                    zArr[0] = true;
                ...
                return;
            default:
                rg.j0.P((rg.j0) this.f28155b, (ArrayList) this.f28156c, (TLRPC.User) this.d);
                return;
        }
    }
    ...
    @Override
    public Object i() {
        q5.a aVar = (q5.a) this.f28155b;
        l5.i iVar = (l5.i) this.f28156c;
    ...
    public void run(boolean z10) {
        TLRPC.Chat chat = (TLRPC.Chat) this.f28155b;
        org.telegram.ui.ActionBar.m2 m2Var = (org.telegram.ui.ActionBar.m2) this.f28156c;
    ...
    public boolean u(org.telegram.ui.qy qyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, wf1 wf1Var) {
        return yh.x3.X((yh.x3) this.f28155b, (TL_stars.TL_starGiftUnique) this.f28156c, (org.telegram.ui.qy) this.d, arrayList);
    }
}
