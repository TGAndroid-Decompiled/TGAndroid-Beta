...
public final class xp extends o6 {
    public final Rect f34815s;
    public Drawable v;
    public boolean f34816w;

    public xp(Context context) {
        super(context, false, false, false);
        this.f34815s = new Rect();
    }
    ...
    public final void onDraw(Canvas canvas) {
        if (this.v != null) {
            ...
            Rect rect = this.f34815s;
            rect.set(bounds);
            int ceil = (int) Math.ceil(getDrawable().d());
            if (getDrawable().f30862b == 3) {
                rect.right = rect.left + ceil;
            } else if (getDrawable().f30862b == 5) {
                rect.left = rect.right - ceil;
            } else if (getDrawable().f30862b == 17) {
