...
public final class ew implements ki.c, bl0, gm0, le.d {
    public final int f23757a;
    public final kz f23758b;
    ...
    public void a(int i10) {
        ...
        switch (this.f23757a) {
            case 2:
                kz kzVar = this.f23758b;
                qy qyVar = kzVar.f25718i0;
                int i16 = kzVar.f25700c1;
                py pyVar = kzVar.f25732n0;
                sy syVar = kzVar.f25724k0;
                if (i10 != kzVar.f25749s0 || !pyVar.f27192x.isEmpty()) {
                    kzVar.f25715h0.B0();
                    kzVar.f25738p0.k(i10, 0);
                    if (i10 != kzVar.f25745r0 && i10 != kzVar.f25749s0) {
                        ArrayList<String> arrayList = MessagesController.getInstance(i16).gifSearchEmojies;
                        kzVar.f25721j0.H(arrayList.get(i10 - kzVar.f25752t0));
                        int i17 = i10 - kzVar.f25752t0;
                        if (i17 > 0) {
                            syVar.a(arrayList.get(i17 - 1), true);
                        }
                        if (i10 - kzVar.f25752t0 < arrayList.size() - 1) {
                            syVar.a(arrayList.get((i10 - kzVar.f25752t0) + 1), true);
                        }
                    } else {
                        kzVar.f25735o0.d.setText("");
                        if (i10 == kzVar.f25749s0 && (i12 = pyVar.I) >= 1) {
                ...
                return;
            default:
                kz kzVar2 = this.f23758b;
                vw vwVar = kzVar2.G0;
                ArrayList arrayList3 = kzVar2.f25703d1;
                ww wwVar = kzVar2.B0;
                bz bzVar = kzVar2.f25770y0;
                sw swVar = kzVar2.D0;
                if (!kzVar2.S0) {
                    if (i10 == kzVar2.H1) {
                        kzVar2.f25753t1.o(new e51(kzVar2.getContext(), new ex(kzVar2), kzVar2.f25767x1, kzVar2.f25771y1, kzVar2.f25774z1, null, kzVar2.Z1));
                        return;
                    }
                    if (vwVar != null && (wyVar = vwVar.f30086r) != null && wyVar.getSelectedCategory() != null) {
                        vwVar.c(null, false);
                        wyVar.F1(null);
                    }
                    if (i10 == kzVar2.F1) {
    ...
    public void b(int i10) {
        float f7;
        kz kzVar = this.f23758b;
        ah.h hVar = kzVar.f25723j2;
        RectF rectF = kzVar.f25772y2;
        if (Build.VERSION.SDK_INT >= 31 && hVar != null) {
            hh.k.c(kzVar.f25761w, kzVar, rectF);
            float f10 = 0.0f;
            ...
            hVar.g(!rectF.isEmpty(), kzVar.f25775z2);
            hVar.e(kzVar.f25726k2, kzVar.getWidth(), kzVar.getHeight());
        }
    }
    ...
    public boolean d(int i10, View view) {
        ...
        if (view instanceof ty) {
            ...
            if (tyVar.f28202c) {
                ...
                xuVar.d = z10;
                int i18 = 3;
                Drawable[] drawableArr = wuVar2.f29783b;
                int[] iArr3 = wuVar2.f29786n;
                wuVar2.f29785f = z10;
                wuVar2.e = replace;
                int i19 = 5;
                if (z10) {
