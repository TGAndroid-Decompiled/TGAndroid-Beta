...
public abstract class ew extends ym0 {
    public static final int[] f23980e0 = {R.drawable.msg_emoji_smiles, R.drawable.msg_emoji_cat, R.drawable.msg_emoji_food, R.drawable.msg_emoji_activities, R.drawable.msg_emoji_travel, R.drawable.msg_emoji_objects, R.drawable.msg_emoji_other, R.drawable.msg_emoji_flags};
    public static final int[] f23981f0 = {R.raw.msg_emoji_smiles, R.raw.msg_emoji_cat, R.raw.msg_emoji_food, R.raw.msg_emoji_activities, R.raw.msg_emoji_travel, R.raw.msg_emoji_objects, R.raw.msg_emoji_other, R.raw.msg_emoji_flags};
    public final aw E;
    public final aw F;
    public final cw G;
    ...
    public boolean V;
    public boolean W;
    public boolean f23982a0;
    public boolean f23983b0;
    public boolean f23984c0;
    public float f23985d0;
    public final int h;
    public final boolean f23986n;
    public boolean f23987r;
    public e6 f23988s;
    public final org.telegram.ui.ActionBar.d6 v;
    public final boolean f23989w;
    public final aw f23990x;
    public final aw f23991y;
    ...
    public ew(Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10, boolean z11, boolean z12, boolean z13, int i10, Runnable runnable, int i11, boolean z14) {
        ...
        this.f23986n = !UserConfig.getInstance(UserConfig.selectedAccount).isPremium();
        this.f23987r = true;
        this.H = new HashMap();
        this.K = 0.0f;
        this.L = 0.0f;
        ...
        this.f30640b.setOrientation(0);
        setVerticalScrollBarEnabled(false);
        setHorizontalScrollBarEnabled(false);
        addView(this.f30640b);
        if (i10 == 4) {
            LinearLayout linearLayout = this.f30640b;
        ...
        if (z10) {
            LinearLayout linearLayout2 = this.f30640b;
            ...
            awVar2.f22766a = Long.valueOf(-934918565);
        }
        if (z11) {
            LinearLayout linearLayout3 = this.f30640b;
            ...
            awVar3.f22766a = Long.valueOf(98352451);
        }
        if (!z13) {
            for (int i14 = 0; i14 < 8; i14++) {
                int i15 = f23980e0[i14];
                if (i14 == 0) {
                    z15 = true;
                } else {
                    z15 = false;
                ...
                this.f30640b.addView(awVar4);
            }
            o();
            return;
        }
        if (z12) {
            LinearLayout linearLayout4 = this.f30640b;
            cw cwVar = new cw(this, context);
            this.G = cwVar;
            linearLayout4.addView(cwVar);
            cwVar.h = 3552126;
        }
        this.I = this.f30640b.getChildCount();
        if (runnable != null) {
            LinearLayout linearLayout5 = this.f30640b;
            ...
            awVar5.f22766a = Long.valueOf(1434631203);
    ...
    public final void j(int i10, boolean z10) {
        ...
        boolean z13;
        boolean z14;
        if (z10 && !this.f23984c0) {
            z11 = true;
        } else {
            z11 = false;
        }
        aw awVar = this.f23990x;
        if (awVar != null) {
            i10++;
        }
        ...
        int i13 = 0;
        int i14 = 0;
        while (i13 < this.f30640b.getChildCount()) {
            View childAt = this.f30640b.getChildAt(i13);
            if (childAt instanceof cw) {
                cw cwVar = (cw) childAt;
                int i15 = i14;
                int i16 = 0;
                while (i16 < cwVar.f30640b.getChildCount()) {
                    View childAt2 = cwVar.f30640b.getChildAt(i16);
        ...
        if (i12 != i17) {
            ...
            if (z11) {
                ...
                this.f30640b.invalidate();
            }
            if (cwVar2 != null) {
                if (this.M != 1 && !this.f23986n) {
                    z12 = false;
                } else {
                    z12 = true;
                }
                if (z12 != cwVar2.f23397n) {
                    cwVar2.f23397n = z12;
                    if (!z12) {
                        cwVar2.a(0);
                    }
                    ValueAnimator valueAnimator2 = cwVar2.f30641c;
                    if (valueAnimator2 != null) {
                        valueAnimator2.cancel();
                    }
                    if (z11) {
                        float f12 = cwVar2.f23398r;
                        if (!z12) {
                            f11 = 0.0f;
                        }
                        ValueAnimator ofFloat2 = ValueAnimator.ofFloat(f12, f11);
                        cwVar2.f30641c = ofFloat2;
                        ofFloat2.addUpdateListener(new k6(cwVar2, 20));
                        cwVar2.f30641c.setDuration(475L);
                        cwVar2.f30641c.setInterpolator(rr.h);
                        cwVar2.f30641c.start();
                    } else {
                        if (!z12) {
                            f11 = 0.0f;
                        }
                        ...
                        cwVar2.c();
                        cwVar2.f23399s.f30640b.invalidate();
                    }
                }
            }
            View childAt3 = this.f30640b.getChildAt(this.M);
            if (this.M >= 2) {
        ...
        if (this.N != i10) {
            if (cwVar2 != null && this.M == 1 && i10 >= 1 && i10 <= cwVar2.f30640b.getChildCount() + 1) {
                int i18 = (i10 - 1) * 36;
    ...
    public final void l(boolean z10) {
        ...
        aw awVar = this.E;
        if (awVar != null) {
            boolean z11 = this.f23982a0;
            if (z11 || this.f23983b0 != z10) {
                this.f23983b0 = z10;
                float f7 = 0.0f;
                if (z11) {
                    if (z10) {
    ...
    public final void o() {
        int i10 = 0;
        final int i11 = 0;
        while (i10 < this.f30640b.getChildCount()) {
            View childAt = this.f30640b.getChildAt(i10);
            if (childAt instanceof cw) {
                cw cwVar = (cw) childAt;
                int i12 = 0;
                while (i12 < cwVar.f30640b.getChildCount()) {
                    cwVar.f30640b.getChildAt(i12).setOnClickListener(new View.OnClickListener(this) {
                        public final ew f29806b;
    ...
    public final void onMeasure(int i10, int i11) {
        this.f30640b.setPadding(AndroidUtilities.dp(this.f23985d0), 0, AndroidUtilities.dp(11.0f), 0);
