...
public class d20 extends FrameLayout implements le.e, org.telegram.ui.ActionBar.x5 {
    public final AnimationNotificationsLocker E;
    public final ArrayList F;
    public final ub1 G;
    public c20 H;
    public int I;
    public final le.c f23470a;
    public final le.c f23471b;
    public final le.f f23472c;
    public final org.telegram.ui.ActionBar.d6 d;
    public final ImageView e;
    public final ImageView f23473f;
    public final LinearLayout h;
    public boolean f23474n;
    public final ci.h2 f23475r;
    public ch.d f23476s;
    public Drawable v;
    public boolean f23477w;
    public boolean f23478x;
    public Runnable f23479y;

    public d20(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        int i10;
        int i11;
        int i12;
        int i13;
        sr srVar = sr.h;
        this.f23470a = new le.c(0, this, srVar, 380L, false);
        this.f23471b = new le.c(1, this, srVar, 380L, true);
        this.f23472c = new le.f(2, this, ke.a.f13575a, 280L);
    ...
    public final void D(int i10, float f7, float f10, le.f fVar) {
        if (i10 == 0) {
            ImageView imageView = this.f23473f;
            a20.d(imageView, f7);
    ...
    public final void b() {
        int i10;
        int max = Math.max(AndroidUtilities.dp(6.0f) + ((int) this.f23472c.e), AndroidUtilities.dp(48.0f));
    ...
    public final void g(gg.q0 q0Var) {
        ...
        if (q0Var.h) {
            ...
            f();
            c20 c20Var = this.H;
            if (c20Var != null && (zxVar = ((org.telegram.ui.vx) c20Var).f38844b.C0) != null) {
                zxVar.Q(false);
            }
        }
    }
    ...
    public void setCloseButtonOnClickListener(Runnable runnable) {
        this.f23479y = runnable;
    }

    public void setCloseButtonVisible(boolean z10) {
        boolean z11;
        this.f23474n = z10;
        if (!z10 && this.f23475r.length() <= 0) {
            z11 = false;
        } else {
            z11 = true;
        }
        this.f23470a.a(z11, true);
    }
