...
public final class yh extends ll0 {
    ...
    public boolean f32946a3;
    public boolean f32947b3;
    public final Object f32948c3;
    public final Object f32949d3;
    ...
    public yh(Context context, int i10) {
        ...
        switch (i10) {
            case 1:
                ...
                this.Z2 = paint2;
                this.f32948c3 = new e6(this);
                this.f32949d3 = new e6(this);
            ...
            default:
                pr prVar = pr.h;
                this.f32948c3 = new le.b(this, prVar, 320L);
                this.f32949d3 = new le.b(this, prVar, 320L);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        switch (this.X2) {
            case 0:
                ...
                ((le.b) this.f32948c3).a(this.f32946a3, true);
                ((le.b) this.f32949d3).a(this.f32947b3, true);
                return;
            default:
                super.dispatchDraw(canvas);
                e6 e6Var = (e6) this.f32948c3;
                float f10 = 1.0f;
                if (this.f32946a3) {
                    f7 = 1.0f;
                } else {
        ...
        switch (this.X2) {
            case 0:
                ...
                if (z10) {
                    ...
                    canvas.save();
                    canvas.translate(com.google.android.gms.internal.vision.e2.b(1.0f, ((le.b) this.f32948c3).f15395e, AndroidUtilities.dp(8.0f), dp), 0.0f);
                ...
                if (z11) {
                    ...
                    super.drawChild(canvas, view, j3);
                    canvas.save();
                    canvas.translate(com.google.android.gms.internal.vision.e2.z(1.0f, ((le.b) this.f32949d3).f15395e, AndroidUtilities.dp(8.0f), measuredWidth), 0.0f);
    ...
    public void k0(int i10, int i11) {
        switch (this.X2) {
            case 1:
                ...
                if (canScrollVertically != this.f32946a3 || canScrollVertically2 != this.f32947b3) {
                    this.f32946a3 = canScrollVertically;
                    this.f32947b3 = canScrollVertically2;
                    invalidate();
                    return;
                }
                return;
            ...
            case 0:
                ...
                for (int i14 = 0; i14 < childCount; i14++) {
                    ...
                    if (childAt2 instanceof qi) {
                        ((qi) childAt2).f29768a.setAdditionalWidth(i12);
                    }
                }
