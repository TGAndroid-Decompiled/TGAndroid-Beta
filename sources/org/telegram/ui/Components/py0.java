...
public final class py0 {
    public final org.telegram.ui.ActionBar.e6 f27197a;
    public StaticLayout f27198b;
    public final ArrayList f27199c = new ArrayList(2);
    public int d;
    public int e;
    public int f27200f;
    public int f27201g;
    ...
    public final void b(MessageObject messageObject) {
        ...
        org.telegram.ui.ActionBar.e6 e6Var = this.f27197a;
        if (e6Var != null) {
        ...
        this.f27201g = AndroidUtilities.dp(14.0f) * 2;
        ArrayList arrayList = this.f27199c;
        arrayList.clear();
        ...
        while (i16 < size) {
            ...
            i16++;
            oy0 oy0Var = (oy0) obj;
            f10 = Math.max(f10, oy0Var.f26911a.l());
            f11 = Math.max(f11, oy0Var.f26912b.l());
            int j3 = ((int) oy0Var.f26911a.j()) + this.f27201g;
            this.f27201g = j3;
            this.f27201g = AndroidUtilities.dp(7.0f) + j3;
        }
        ...
        this.f27198b = new StaticLayout(AndroidUtilities.replaceTags(spannableStringBuilder), textPaint, max, Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
        int i30 = 0;
        for (int i31 = 0; i31 < this.f27198b.getLineCount(); i31++) {
            i30 = (int) Math.max(i30, this.f27198b.getLineWidth(i31));
        }
        int height = this.f27198b.getHeight() + this.f27201g;
        this.f27201g = height;
        this.f27201g = AndroidUtilities.dp(5.0f) + height;
        int D = org.telegram.messenger.w1.D(24.0f, 2, Math.max(dp, i30));
        this.h = D;
        this.d = (D - max) / 2;
        this.e = (D - dp) / 2;
        this.f27200f = (int) (AndroidUtilities.dp(f7) + i15 + f10);
    }
}
