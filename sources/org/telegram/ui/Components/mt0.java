...
public final class mt0 extends ll0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        nu0[] nu0VarArr = this.d.f30446t1;
        if (nu0VarArr[5].f26512a.size() == 0 && !nu0VarArr[5].f26516g) {
            return false;
        }
        return true;
    }
    ...
    public final int h() {
        ...
        return nu0VarArr[5].f26512a.size();
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (c1Var.f42630f == 12) {
            yu0 yu0Var = this.d;
            MessageObject messageObject = (MessageObject) yu0Var.f30446t1[5].f26512a.get(i10);
            ...
            if (document != null) {
                ...
                if (view instanceof org.telegram.ui.Cells.e2) {
                    ...
                    if (yu0Var.C1) {
                        ...
                        e2Var.c(z10, !yu0Var.f30405b1);
                        return;
                    }
                    e2Var.c(false, !yu0Var.f30405b1);
                }
            }
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 11) {
            lt0 M = yu0.M(5, yu0Var.f30425j1, context, d6Var);
