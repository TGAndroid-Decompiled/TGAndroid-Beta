...
public final class mt0 implements hg.a2, org.telegram.ui.Cells.z4 {
    ...
    public boolean d(org.telegram.ui.Cells.a5 a5Var, boolean z10) {
        ...
        if (E instanceof TLRPC.ChannelParticipant) {
            ...
            return ot0Var.f29213s.D1.h(tL_chatChannelParticipant, true, !z10, a5Var);
        }
        return false;
    }
    ...
    public void f(int i10) {
        ...
        ot0Var.l();
        if (i10 == 1) {
            int i11 = ot0Var.f29212r - 1;
            ot0Var.f29212r = i11;
            if (i11 == 0) {
                int i12 = 0;
                while (true) {
                    xu0 xu0Var = ot0Var.f29213s;
                    qt0[] qt0VarArr = xu0Var.f32729k0;
                    if (i12 < qt0VarArr.length) {
                        qt0 qt0Var = qt0VarArr[i12];
                        if (qt0Var.F == 7) {
                            if (ot0Var.h == 0) {
                                qt0Var.f29850w.e(false, true);
                            } else {
