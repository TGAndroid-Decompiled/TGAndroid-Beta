...
public class StickerEmptyView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void setSticker() {
        ...
        if (i2 != 0) {
            if (i2 != 1) {
                ...
                this.stickerView.setImage(ImageLocation.getForDocument(emojiAnimatedSticker), str, "tgs", svgThumb, tL_messages_stickerSet);
    ...
    public void createButtonLayout(CharSequence charSequence, Runnable runnable) {
        ...
        frameLayout.setOnClickListener(new ArchiveHelp$$ExternalSyntheticLambda0(6, runnable));
        int iDp = AndroidUtilities.dp(8.0f);
        int color = Theme.getColor(Theme.key_featuredStickers_addButton, this.resourcesProvider);
        int alphaComponent = ColorUtils.setAlphaComponent(Theme.getColor(i, this.resourcesProvider), 30);
    ...
    public StickerEmptyView(Context context, View view, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        backupImageView.setOnClickListener(new SearchField$$ExternalSyntheticLambda0(this, 15));
        ...
        buttonWithCounterViewM.setVisibility(8);
        ...
        this.linearLayout.addView(buttonWithCounterViewM, LayoutHelper.createLinear(-1, 48, 1, 28, 16, 28, 0));
    ...
    private void setVisibility(boolean z, boolean z2, boolean z3) {
        ...
        if (this.visibilityValue != z || z3) {
            ...
            if (!z2) {
                ...
                this.visibilityAnimator.addUpdateListener(new WaveDrawable$$ExternalSyntheticLambda1(this, i));
