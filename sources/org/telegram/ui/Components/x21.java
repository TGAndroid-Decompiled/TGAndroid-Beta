...
public final class x21 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, le.d {
    public static final int f29865f0 = 0;
    ...
    public long V;
    public boolean W;
    public final le.b f29866a;
    public Utilities.Callback2 f29867a0;
    public final int f29868b;
    public Runnable f29869b0;
    public final long f29870c;
    public Utilities.Callback2 f29871c0;
    public final org.telegram.ui.ActionBar.e6 d;
    public boolean f29872d0;
    public final boolean e;
    public final HashSet f29873e0;
    public final boolean f29874f;
    public final org.telegram.ui.bo h;
    public final boolean f29875n;
    public final FrameLayout f29876r;
    public final l21 f29877s;
    public final w21 v;
    public final ImageView f29878w;
    public final ImageView f29879x;
    public final ImageView f29880y;
    ...
    public x21(Activity activity, org.telegram.ui.bo boVar, int i10, long j3, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        boolean z10;
        qr qrVar = qr.h;
        this.f29866a = new le.b(0, this, qrVar, 380L, true);
        this.J = new le.b(0, new c21(this), qrVar, 320L, false);
        this.R = 0.0f;
        this.f29873e0 = new HashSet();
        this.h = boVar;
        this.f29868b = i10;
        this.f29870c = j3;
        this.d = e6Var;
        ...
        this.f29874f = isBotForumWithEditableTopics;
        this.f29875n = !org.telegram.messenger.y0.v("topics_end_reached_", j10, UserConfig.getInstance(i10).getPreferences(), false);
        setClipChildren(true);
        setClipToPadding(true);
        setWillNotDraw(false);
        ?? frameLayout2 = new FrameLayout(activity);
        this.f29876r = frameLayout2;
        ...
        l21 l21Var = new l21(this, activity, i10, new Utilities.Callback2(this) {
            ...
            public final void run(Object obj, Object obj2) {
                ...
                boolean z17;
                int i13 = r2;
                x21 x21Var = this.f25529b;
                switch (i13) {
                    case 0:
                        ArrayList arrayList = (ArrayList) obj;
                        w51 w51Var = (w51) obj2;
                        boolean z18 = x21Var.f29874f;
                        int i14 = x21Var.f29868b;
                        MessagesController messagesController = MessagesController.getInstance(i14);
                        long j16 = x21Var.f29870c;
                        long j17 = -j16;
                        ...
                        if (topics != null) {
                            ...
                            while (i16 < size) {
                                ...
                                if (x21Var.f29873e0.contains(Integer.valueOf(tL_forumTopic2.f18161id))) {
                                    size = i18;
                                    i16 = i12;
                                } else {
                                    ...
                                    if (!z21 && z20) {
                                        if (!arrayList.isEmpty()) {
                                            ((i51) hg.c.h(1, arrayList)).f24912y |= 8;
                                        }
                                        w51Var.L();
                                        z20 = false;
                                    } else if (z21 && !z20) {
                        ...
                        if (topics != null && !topics.isEmpty() && !topicsController2.endIsReached(j17) && x21Var.f29875n) {
                    ...
                    default:
                        ...
                        if (topics2 != null) {
                            ...
                            while (i21 < size2) {
                                ...
                                if (x21Var.f29873e0.contains(Integer.valueOf(tL_forumTopic4.f18161id))) {
                                    chat2 = chat3;
                                    size2 = i22;
                                    user3 = user;
                                } else {
                        ...
                        if (topics2 != null && !topics2.isEmpty() && !topicsController.endIsReached(j20) && x21Var.f29875n) {
                            int i24 = v21.f28572a;
                ...
                public final void onClick(View view) {
                    switch (r2) {
                        case 0:
                            ...
                            return;
                        case 1:
                            x21 x21Var2 = this.f24171b;
                            n21 n21Var = x21Var2.G;
                            n21Var.w1(false);
                            l21 l21Var2 = x21Var2.f29877s;
                            l21Var2.w1(false);
                            ...
                            return;
                        default:
                            this.f24171b.f29867a0.run(0, Boolean.FALSE);
                            return;
                    }
                }
            });
    ...
    public static void a(x21 x21Var, i51 i51Var) {
        if (x21Var.e) {
            Utilities.Callback2 callback2 = x21Var.f29871c0;
            if (callback2 != null) {
                callback2.run(Long.valueOf(i51Var.B), Boolean.FALSE);
            }
        } else if (i51Var.B == -2) {
            Runnable runnable = x21Var.f29869b0;
            if (runnable != null) {
                runnable.run();
            }
        } else {
            Utilities.Callback2 callback22 = x21Var.f29867a0;
            if (callback22 != null) {
    ...
    public static void b(x21 x21Var, ArrayList arrayList) {
        ...
        TopicsController topicsController = MessagesController.getInstance(x21Var.f29868b).getTopicsController();
    ...
    public static boolean c(final x21 x21Var, i51 i51Var, View view) {
        ...
        long j3 = x21Var.f29870c;
        int i18 = x21Var.f29868b;
        if (x21Var.G.f23557c3 || x21Var.f29877s.f23557c3) {
            return false;
        }
        Object obj = i51Var.G;
        ...
        if (ChatObject.isMonoForum(chat)) {
            ...
            if (ChatObject.canManageTopics(chat4) || UserObject.isBotForumWithEditableTopics(user)) {
                I.c(R.drawable.outline_profile_edit_24, LocaleController.getString(R.string.EditTopic), new Runnable(x21Var) {
                    ...
                    public final void run() {
                        boolean z12;
                        int i21 = r4;
                        x21 x21Var2 = this.f23787b;
                        TLRPC.TL_forumTopic tL_forumTopic2 = tL_forumTopic;
                        n70 n70Var3 = I;
                        switch (i21) {
                            case 0:
                                n70Var3.u();
                                x21Var2.h.presentFragment(af1.a0(-x21Var2.f29870c, tL_forumTopic2.f18161id));
                                return;
                            case 1:
                                x21Var2.getClass();
                                n70Var3.u();
                                MessagesController.getInstance(x21Var2.f29868b).getTopicsController().toggleCloseTopic(-x21Var2.f29870c, tL_forumTopic2.f18161id, true ^ tL_forumTopic2.closed);
                                return;
                            default:
                                n70Var3.u();
                                HashSet hashSet = new HashSet();
                                hashSet.add(Integer.valueOf(tL_forumTopic2.f18161id));
                                sh shVar = new sh(11);
                                x21 x21Var3 = this.f23787b;
                                ...
                                if (hashSet.size() == 1) {
                                    z12 = false;
                                    b2Var.T = LocaleController.formatString(R.string.DeleteSelectedTopic, MessagesController.getInstance(x21Var3.f29868b).getTopicsController().findTopic(-x21Var3.f29870c, ((Integer) arrayList.get(0)).intValue()).title);
                                } else {
                                    z12 = false;
                                ...
                                if (textView != null) {
                                    textView.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19071q7, z12));
                                    return;
                                }
                                return;
                        }
            ...
            long j12 = x21Var.f29870c;
            long j13 = tL_forumTopic.f18161id;
                    ...
                    public final void run() {
                        ...
                        switch (i212) {
                            ...
                            default:
                                ...
                                TextView textView = (TextView) b2Var.d(-1);
                                if (textView != null) {
                                    textView.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19071q7, z122));
                                    return;
                                }
                                return;
                        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i12) {
            ...
            MessagesController.getInstance(this.f29868b).getTopicsController().sortTopics(-j3, false);
            o();
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        FrameLayout frameLayout2 = this.f29876r;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        canvas.save();
        if (view == this.F) {
            canvas.clipPath(this.K.f4285j.f4274k);
        }
        if (view == this.f29876r) {
            canvas.clipPath(this.L.f4285j.f4274k);
        }
    ...
    public final void f(boolean z10) {
        boolean z11;
        ArrayList<TLRPC.TL_forumTopic> topics = MessagesController.getInstance(this.f29868b).getTopicsController().getTopics(-this.f29870c);
        if (topics != null && !topics.isEmpty() && !this.f29872d0) {
            z11 = true;
        } else {
            z11 = false;
        }
        this.f29866a.a(z11, z10);
    }
    ...
    public final void g() {
        ...
        le.b bVar = this.J;
        float f7 = bVar.e;
        ImageView imageView = this.f29878w;
        ...
        ImageView imageView2 = this.f29879x;
        ...
        ImageView imageView3 = this.f29880y;
    ...
    public float getSideMenuT() {
        return this.R * this.f29866a.e;
    }

    public final void h() {
        int i10;
        float lerp = AndroidUtilities.lerp(1.0f, 0.0f, this.R);
        FrameLayout frameLayout = this.f29876r;
        frameLayout.setAlpha(lerp);
        if ((1.0f - this.R) * this.f29866a.e > 0.0f) {
            i10 = 0;
        } else {
            i10 = 8;
        }
        ...
        if (this.P) {
            frameLayout.setTranslationY(((getMeasuredHeight() - AndroidUtilities.dp(50.0f)) - this.M) + AndroidUtilities.lerp(AndroidUtilities.dp(43.0f), 0, j(t21.f28041c)));
        } else {
            frameLayout.setTranslationY(this.N + AndroidUtilities.lerp(-AndroidUtilities.dp(43.0f), 0, j(t21.f28039a)));
        }
    }

    public final float j(t21 t21Var) {
        float f7;
        float f10 = this.f29866a.e;
        if (t21Var == t21.f28040b) {
            f7 = this.R;
        } else if ((t21Var == t21.f28039a && !this.P) || (t21Var == t21.f28041c && this.P)) {
            f7 = 1.0f - this.R;
        } else {
            return 0.0f;
        }
    ...
    public final void l() {
        TopicsController topicsController = MessagesController.getInstance(this.f29868b).getTopicsController();
        long j3 = this.f29870c;
    ...
    public final void m(long j3, boolean z10) {
        if (this.e) {
            Utilities.Callback2 callback2 = this.f29871c0;
            if (callback2 != null) {
        ...
        Utilities.Callback2 callback22 = this.f29867a0;
        if (callback22 != null) {
    ...
    public final void n() {
        ...
        this.f29880y.setColorFilter(new PorterDuffColorFilter(d, mode));
        ...
        this.f29878w.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.v0(i12, e6Var), mode));
        this.f29879x.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.v0(i12, e6Var), mode));
        invalidate();
    }
