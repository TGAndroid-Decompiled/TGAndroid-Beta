...
public final class fh0 extends View {
    ...
    public final th0[] f26048c;
    public final th0[] d;
    public volatile boolean f26049e;
    public final Paint[] f26050f;
    public oh0 h;
    public int f26051n;
    public int f26052r;
    public final eh0 f26053s;
    public final eh0 v;
    public int f26054w;
    public int f26055x;
    public int f26056y;
    ...
    public fh0(Context context) {
        ...
        this.f26046a = z10;
        this.f26047b = new Object();
        this.f26048c = new th0[3];
        this.d = new th0[3];
        this.f26049e = false;
        Paint[] paintArr = {new Paint(), new Paint()};
        this.f26050f = paintArr;
        this.f26053s = new eh0(this, 0);
        ...
        this.H = false;
        this.N = new lv0[3];
        e6 e6Var = new e6(this, 0L, 350L, pr.f29467f);
        this.O = e6Var;
        this.P = new bi.v6(2, this);
        e6Var.d(1.0f, true);
        boolean z11 = this.f26046a & SharedConfig.useNewBlur;
        this.f26046a = z11;
        if (z11) {
            setLayerType(2, null);
            return;
    ...
    public static void a(fh0 fh0Var, int i10, int i11, int i12) {
        synchronized (fh0Var.f26047b) {
            try {
                th0[] th0VarArr = fh0Var.f26048c;
                ...
                if (i10 == 2) {
                    if (th0Var2.f30608f) {
                        fh0Var.b(th0Var2.f30605b, i11);
                    }
                } else {
                    Paint[] paintArr = fh0Var.f26050f;
                    Paint paint = paintArr[i10];
                    paintArr[i10] = paintArr[i11];
                    paintArr[i11] = paint;
                }
                if (i12 != -1) {
                    fh0Var.f26050f[i12].setShader(null);
                    th0 th0Var3 = fh0Var.f26048c[i12];
                    if (th0Var3 != null && !th0Var3.f30607e && !th0Var3.d) {
                        th0Var3.f30608f = false;
                        th0Var3.f30605b.eraseColor(0);
                    }
                }
            } finally {
            }
    ...
    public final void b(Bitmap bitmap, int i10) {
        if (i10 < 2 && bitmap != null && !bitmap.isRecycled()) {
            LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, 0.0f, this.f26052r / 6.0f, new int[]{0, -1}, new float[]{0.0f, AndroidUtilities.dpf2(56.0f) / this.f26052r}, Shader.TileMode.CLAMP);
            Shader.TileMode tileMode = Shader.TileMode.MIRROR;
            this.f26050f[i10].setShader(new ComposeShader(new BitmapShader(bitmap, tileMode, tileMode), linearGradient, PorterDuff.Mode.DST_IN));
        }
    }
    ...
    public final void c(float f7, org.telegram.ui.n01 n01Var, float f10, float f11) {
        ...
        this.M.setPosition(0, 0, (int) Math.ceil(f7 / renderNodeScale), (int) ((this.f26051n + f11) / renderNodeScale));
        ...
        if (dh0Var2 != null) {
            if (n01Var != null) {
                dh0Var2.f25398w = this.M;
                dh0Var2.f25396r = n01Var;
                dh0Var2.f25397s = renderNodeScale / f10;
                dh0Var2.v = -f11;
                dh0Var2.invalidate();
            } else {
                dh0Var2.f25398w = this.M;
                dh0Var2.f25396r = null;
                dh0Var2.f25397s = renderNodeScale;
                dh0Var2.v = -f11;
                dh0Var2.invalidate();
            }
        }
    ...
    public final void e() {
        ...
        if (oh0Var != null) {
            bi.v6 v6Var = this.P;
            ArrayList arrayList = oh0Var.f50746k0;
            if (arrayList != null) {
        ...
        this.f26049e = false;
        uh0.f30902a.cancelRunnable(this.f26053s);
        ...
        synchronized (this.f26047b) {
            for (int i10 = 0; i10 < 3; i10++) {
                try {
                    th0 th0Var = this.f26048c[i10];
                    if (th0Var != null) {
                        th0Var.a();
                        this.f26048c[i10] = null;
                    }
            ...
            this.f26050f[0].setShader(null);
            this.f26050f[1].setShader(null);
        }
    }
    ...
    public final void f(Canvas canvas, org.telegram.ui.n01 n01Var, float f7, float f10, boolean z10, float f11, float f12) {
        ...
        if (oh0Var != null && oh0Var.isAttachedToWindow() && this.h.getVisibility() != 8) {
            if (this.f26046a && Build.VERSION.SDK_INT >= 31) {
                if (canvas2.isHardwareAccelerated()) {
                    if (n01Var == null && getVisibility() == 0 && getAlpha() > 0.0f) {
                        ...
                        this.L.setPosition(0, 0, (int) (f7 / renderNodeScale), (int) ((this.f26052r + this.f26051n) / renderNodeScale));
                        RecordingCanvas beginRecording = this.L.beginRecording();
                        float f14 = 1.0f / renderNodeScale;
                        beginRecording.scale(f14, f14);
                        beginRecording.save();
                        beginRecording.translate(-this.f26055x, 0.0f);
                        i(beginRecording, 0);
                        beginRecording.restore();
                        if (this.f26055x != 0) {
                            beginRecording.save();
                            beginRecording.translate((-this.f26055x) + f7, 0.0f);
                            i(beginRecording, 1);
                            beginRecording.restore();
                        }
                        this.L.endRecording();
                    ...
                    this.f26046a = false;
                    setLayerType(1, this.f26050f[0]);
                    setLayerType(1, this.f26050f[1]);
                } else {
                    return;
                }
            }
            ...
            if (this.H || this.G || this.F || (this.f26050f[0].getShader() == null && this.f26050f[1].getShader() == null && !this.f26049e)) {
                boolean d = d();
                if (!this.f26049e && d) {
                    this.f26049e = true;
                    DispatchQueue dispatchQueue = uh0.f30902a;
                    dispatchQueue.cancelRunnable(this.f26053s);
                    dispatchQueue.postRunnable(this.f26053s);
                }
            }
            if (this.f26050f[0].getShader() != null || this.f26050f[1].getShader() != null) {
                synchronized (this.f26047b) {
                    try {
                        float f18 = f7 / this.f26056y;
                        if (z10) {
                            canvas2.translate(0.0f, (-f18) * this.E);
                        }
                        canvas2.scale(f18, f18);
                        float f19 = this.f26051n / f18;
                        if (this.f26050f[0].getShader() != null) {
                            canvas2.save();
                            canvas2.translate((-this.f26055x) / f18, 0.0f);
                            canvas2.save();
                            ...
                            f13 = 2.0f;
                            c10 = 1;
                            canvas2.drawRect(0.0f, f20, this.f26056y, f20 + f19, this.f26050f[0]);
                            canvas.restore();
                            this.f26050f[0].setAlpha((int) (f12 * 255.0f));
                            float f21 = this.E;
                            canvas2 = canvas;
                            canvas2.drawRect(0.0f, f21 * f11, this.f26056y, f21, this.f26050f[0]);
                            this.f26050f[0].setAlpha(255);
                            canvas2.restore();
                        } else {
                            i10 = 255;
                            f13 = 2.0f;
                        ...
                        if (this.f26055x != 0 && this.f26050f[c10].getShader() != null) {
                            canvas2.save();
                            canvas2.translate(((-this.f26055x) + f7) / f18, 0.0f);
                            canvas2.save();
                            canvas2.scale(1.0f, f13, 0.0f, this.E);
                            float f22 = this.E;
                            canvas2.drawRect(0.0f, f22, this.f26056y, f22 + f19, this.f26050f[c10]);
                            canvas.restore();
                            this.f26050f[c10].setAlpha((int) (f12 * 255.0f));
                            float f23 = this.E;
                            canvas.drawRect(0.0f, f23 * f11, this.f26056y, f23, this.f26050f[c10]);
                            this.f26050f[c10].setAlpha(i10);
                            canvas.restore();
                        }
                    } catch (Throwable th2) {
                        throw th2;
    ...
    public final void h(int i10, View view) {
        th0 th0Var = this.f26048c[i10];
        if (view != null && !th0Var.f30607e) {
            Canvas canvas = th0Var.f30604a;
            canvas.save();
            canvas.scale(0.16666667f, 0.16666667f);
            canvas.translate(0.0f, this.f26052r - view.getMeasuredHeight());
            view.draw(canvas);
            canvas.restore();
            th0Var.f30608f = true;
        }
        if (i10 != 0 && (this.f26055x == 0 || i10 != 1)) {
            return;
        }
    ...
    public final void i(Canvas canvas, int i10) {
        View E = this.h.E(this.f26054w + i10);
        if (E != null) {
            int measuredHeight = E.getMeasuredHeight();
            canvas.save();
            canvas.translate(0.0f, this.f26052r - measuredHeight);
            E.draw(canvas);
            canvas.restore();
            canvas.save();
            canvas.scale(1.0f, -1.0f);
            canvas.translate(0.0f, (-measuredHeight) - this.f26052r);
    ...
    public final void j() {
        if (this.L == null) {
            ...
            float[] fArr = {0.0f, AndroidUtilities.dpf2(56.0f) / this.f26052r};
            Shader.TileMode tileMode = Shader.TileMode.CLAMP;
            LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, 0.0f, this.f26052r / renderNodeScale, new int[]{0, -1}, fArr, tileMode);
    ...
    public final void onMeasure(int i10, int i11) {
        setMeasuredDimension(View.MeasureSpec.getSize(i10), this.f26052r + this.f26051n);
    }
    ...
    public void setSize(int i10) {
        ...
        this.f26051n = i10;
        this.f26052r = (int) (AndroidUtilities.dp(64.0f) * 1.5f);
    }

    public void setView(oh0 oh0Var) {
        e();
        this.h = oh0Var;
        this.f26054w = oh0Var.getCurrentItem();
        this.f26055x = 0;
        oh0Var.b(this.P);
    }
