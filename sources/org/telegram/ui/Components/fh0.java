...
public final class fh0 extends View {
    ...
    public final th0[] f23939c;
    public final th0[] d;
    public volatile boolean e;
    public final Paint[] f23940f;
    public oh0 h;
    public int f23941n;
    public int f23942r;
    public final eh0 f23943s;
    public final eh0 v;
    public int f23944w;
    public int f23945x;
    public int f23946y;
    ...
    public fh0(Context context) {
        ...
        this.f23937a = z10;
        this.f23938b = new Object();
        this.f23939c = new th0[3];
        this.d = new th0[3];
        this.e = false;
        Paint[] paintArr = {new Paint(), new Paint()};
        this.f23940f = paintArr;
        this.f23943s = new eh0(this, 0);
        ...
        this.H = false;
        this.N = new mv0[3];
        c6 c6Var = new c6(this, 0L, 350L, qr.f27423f);
        this.O = c6Var;
        this.P = new ai.m7(this, 3);
        c6Var.d(1.0f, true);
        boolean z11 = this.f23937a & SharedConfig.useNewBlur;
        this.f23937a = z11;
        if (z11) {
            setLayerType(2, null);
            return;
    ...
    public static void a(fh0 fh0Var, int i10, int i11, int i12) {
        synchronized (fh0Var.f23938b) {
            try {
                th0[] th0VarArr = fh0Var.f23939c;
                ...
                if (i10 == 2) {
                    if (th0Var2.f28137f) {
                        fh0Var.b(th0Var2.f28135b, i11);
                    }
                } else {
                    Paint[] paintArr = fh0Var.f23940f;
                    Paint paint = paintArr[i10];
                    paintArr[i10] = paintArr[i11];
                    paintArr[i11] = paint;
                }
                if (i12 != -1) {
                    fh0Var.f23940f[i12].setShader(null);
                    th0 th0Var3 = fh0Var.f23939c[i12];
                    if (th0Var3 != null && !th0Var3.e && !th0Var3.d) {
                        th0Var3.f28137f = false;
                        th0Var3.f28135b.eraseColor(0);
                    }
                }
            } finally {
            }
    ...
    public final void b(Bitmap bitmap, int i10) {
        if (i10 < 2 && bitmap != null && !bitmap.isRecycled()) {
            LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, 0.0f, this.f23942r / 6.0f, new int[]{0, -1}, new float[]{0.0f, AndroidUtilities.dpf2(56.0f) / this.f23942r}, Shader.TileMode.CLAMP);
            Shader.TileMode tileMode = Shader.TileMode.MIRROR;
            this.f23940f[i10].setShader(new ComposeShader(new BitmapShader(bitmap, tileMode, tileMode), linearGradient, PorterDuff.Mode.DST_IN));
        }
    }
    ...
    public final void c(float f7, org.telegram.ui.m01 m01Var, float f10, float f11) {
        ...
        this.M.setPosition(0, 0, (int) Math.ceil(f7 / renderNodeScale), (int) ((this.f23941n + f11) / renderNodeScale));
        ...
        if (dh0Var2 != null) {
            if (m01Var != null) {
                dh0Var2.f23336w = this.M;
                dh0Var2.f23334r = m01Var;
                dh0Var2.f23335s = renderNodeScale / f10;
                dh0Var2.v = -f11;
                dh0Var2.invalidate();
            } else {
                dh0Var2.f23336w = this.M;
                dh0Var2.f23334r = null;
                dh0Var2.f23335s = renderNodeScale;
                dh0Var2.v = -f11;
                dh0Var2.invalidate();
            }
        }
    ...
    public final void e() {
        ...
        if (oh0Var != null) {
            ai.m7 m7Var = this.P;
            ArrayList arrayList = oh0Var.f48139k0;
            if (arrayList != null) {
        ...
        this.e = false;
        uh0.f28410a.cancelRunnable(this.f23943s);
        ...
        synchronized (this.f23938b) {
            for (int i10 = 0; i10 < 3; i10++) {
                try {
                    th0 th0Var = this.f23939c[i10];
                    if (th0Var != null) {
                        th0Var.a();
                        this.f23939c[i10] = null;
                    }
            ...
            this.f23940f[0].setShader(null);
            this.f23940f[1].setShader(null);
        }
    }
    ...
    public final void f(Canvas canvas, org.telegram.ui.m01 m01Var, float f7, float f10, boolean z10, float f11, float f12) {
        ...
        if (oh0Var != null && oh0Var.isAttachedToWindow() && this.h.getVisibility() != 8) {
            if (this.f23937a && Build.VERSION.SDK_INT >= 31) {
                if (canvas2.isHardwareAccelerated()) {
                    if (m01Var == null && getVisibility() == 0 && getAlpha() > 0.0f) {
                        ...
                        this.L.setPosition(0, 0, (int) (f7 / renderNodeScale), (int) ((this.f23942r + this.f23941n) / renderNodeScale));
                        RecordingCanvas beginRecording = this.L.beginRecording();
                        float f14 = 1.0f / renderNodeScale;
                        beginRecording.scale(f14, f14);
                        beginRecording.save();
                        beginRecording.translate(-this.f23945x, 0.0f);
                        i(beginRecording, 0);
                        beginRecording.restore();
                        if (this.f23945x != 0) {
                            beginRecording.save();
                            beginRecording.translate((-this.f23945x) + f7, 0.0f);
                            i(beginRecording, 1);
                            beginRecording.restore();
                        }
                        this.L.endRecording();
                        ...
                        if (getVisibility() == 0 && getAlpha() > 0.0f) {
                            c(f7, null, 1.0f, this.f23942r);
                            return;
                        }
                        return;
                    } else if (m01Var != null) {
                        float measuredWidth = f7 / this.h.getMeasuredWidth();
                        float f15 = this.f23942r * (1.0f - f11);
                        float f16 = f15 * measuredWidth;
                        float renderNodeScale2 = getRenderNodeScale() * measuredWidth;
                        j();
                        this.L.setPosition(0, 0, (int) (f7 / renderNodeScale2), (int) ((this.f23941n + f15) / renderNodeScale2));
                        ...
                        if (o5Var != null) {
                            ...
                            imageReceiver = m01Var.f28314a;
                        }
                        g(imageReceiver, beginRecording2, f16, f10);
                        if (m01Var.f35597a0 && m01Var.V > 0.0f) {
                    ...
                    this.f23937a = false;
                    setLayerType(1, this.f23940f[0]);
                    setLayerType(1, this.f23940f[1]);
                } else {
                    return;
                }
            }
            ...
            if (this.H || this.G || this.F || (this.f23940f[0].getShader() == null && this.f23940f[1].getShader() == null && !this.e)) {
                boolean d = d();
                if (!this.e && d) {
                    this.e = true;
                    DispatchQueue dispatchQueue = uh0.f28410a;
                    dispatchQueue.cancelRunnable(this.f23943s);
                    dispatchQueue.postRunnable(this.f23943s);
                }
            }
            if (this.f23940f[0].getShader() != null || this.f23940f[1].getShader() != null) {
                synchronized (this.f23938b) {
                    try {
                        float f18 = f7 / this.f23946y;
                        if (z10) {
                            canvas2.translate(0.0f, (-f18) * this.E);
                        }
                        canvas2.scale(f18, f18);
                        float f19 = this.f23941n / f18;
                        if (this.f23940f[0].getShader() != null) {
                            canvas2.save();
                            canvas2.translate((-this.f23945x) / f18, 0.0f);
                            canvas2.save();
                            ...
                            f13 = 2.0f;
                            c10 = 1;
                            canvas2.drawRect(0.0f, f20, this.f23946y, f20 + f19, this.f23940f[0]);
                            canvas.restore();
                            this.f23940f[0].setAlpha((int) (f12 * 255.0f));
                            float f21 = this.E;
                            canvas2 = canvas;
                            canvas2.drawRect(0.0f, f21 * f11, this.f23946y, f21, this.f23940f[0]);
                            this.f23940f[0].setAlpha(255);
                            canvas2.restore();
                        } else {
                            i10 = 255;
                            f13 = 2.0f;
                        ...
                        if (this.f23945x != 0 && this.f23940f[c10].getShader() != null) {
                            canvas2.save();
                            canvas2.translate(((-this.f23945x) + f7) / f18, 0.0f);
                            canvas2.save();
                            canvas2.scale(1.0f, f13, 0.0f, this.E);
                            float f22 = this.E;
                            canvas2.drawRect(0.0f, f22, this.f23946y, f22 + f19, this.f23940f[c10]);
                            canvas.restore();
                            this.f23940f[c10].setAlpha((int) (f12 * 255.0f));
                            float f23 = this.E;
                            canvas.drawRect(0.0f, f23 * f11, this.f23946y, f23, this.f23940f[c10]);
                            this.f23940f[c10].setAlpha(i10);
                            canvas.restore();
                        }
                    } catch (Throwable th2) {
                        throw th2;
    ...
    public final void h(int i10, View view) {
        ...
        if (view != null && !th0Var.e) {
            Canvas canvas = th0Var.f28134a;
            canvas.save();
            canvas.scale(0.16666667f, 0.16666667f);
            canvas.translate(0.0f, this.f23942r - view.getMeasuredHeight());
            view.draw(canvas);
            canvas.restore();
            th0Var.f28137f = true;
        }
        if (i10 != 0 && (this.f23945x == 0 || i10 != 1)) {
            return;
        }
    ...
    public final void i(Canvas canvas, int i10) {
        View E = this.h.E(this.f23944w + i10);
        if (E != null) {
            int measuredHeight = E.getMeasuredHeight();
            canvas.save();
            canvas.translate(0.0f, this.f23942r - measuredHeight);
            E.draw(canvas);
            canvas.restore();
            canvas.save();
            canvas.scale(1.0f, -1.0f);
            canvas.translate(0.0f, (-measuredHeight) - this.f23942r);
    ...
    public final void j() {
        if (this.L == null) {
            ...
            float[] fArr = {0.0f, AndroidUtilities.dpf2(56.0f) / this.f23942r};
            Shader.TileMode tileMode = Shader.TileMode.CLAMP;
            LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, 0.0f, this.f23942r / renderNodeScale, new int[]{0, -1}, fArr, tileMode);
    ...
    public final void onMeasure(int i10, int i11) {
        setMeasuredDimension(View.MeasureSpec.getSize(i10), this.f23942r + this.f23941n);
    }
    ...
    public void setSize(int i10) {
        ...
        this.f23941n = i10;
        this.f23942r = (int) (AndroidUtilities.dp(64.0f) * 1.5f);
    }

    public void setView(oh0 oh0Var) {
        e();
        this.h = oh0Var;
        this.f23944w = oh0Var.getCurrentItem();
        this.f23945x = 0;
        oh0Var.b(this.P);
    }
