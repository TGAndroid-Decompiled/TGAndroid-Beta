...
public final class s11 extends FrameLayout {
    ...
    public s11(ThemeEditorView.EditorAlert editorAlert, Context context) {
        ...
        this.d = editorAlert;
        this.f28099a = false;
        this.f28100b = new RectF();
    }

    @Override
    public final void onDraw(android.graphics.Canvas r13) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.s11.onDraw(android.graphics.Canvas):void");
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (t11Var.getPaddingTop() != dp) {
            ...
            if (editorAlert.f22456b.getVisibility() == 0) {
