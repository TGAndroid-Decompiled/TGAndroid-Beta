...
public final class s11 extends FrameLayout {
    ...
    public final q11 f28640b;
    public final ThemeEditorView.EditorAlert f28641c;

    public s11(ThemeEditorView.EditorAlert editorAlert, Context context) {
        super(context);
        this.f28641c = editorAlert;
        ...
        this.f28639a = imageView2;
        imageView2.setScaleType(scaleType);
        cq cqVar = new cq();
        imageView2.setImageDrawable(cqVar);
        cqVar.f24014f = AndroidUtilities.dp(7.0f);
