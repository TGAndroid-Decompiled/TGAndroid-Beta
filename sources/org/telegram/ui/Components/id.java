...
public final class id implements Runnable {
    ...
    public final void run() {
        ...
        String str2;
        int i15;
        int i16 = this.f24928a;
        float f7 = 1.0f;
        int i17 = 0;
        int i18 = this.f24929b;
        Object obj = this.f24930c;
        switch (i16) {
            case 0:
                jd jdVar = (jd) obj;
                ci.f4 f4Var = jdVar.f25213d1;
                if (jdVar.f25211b1 != i18) {
                    jdVar.setTimer(i18);
                    Utilities.Callback callback = jdVar.f25226r1;
                    if (callback != null) {
                    ...
                    AndroidUtilities.cancelRunOnUIThread(jdVar.f25224p1);
                    jdVar.invalidate();
                    return;
                }
                return;
            case 1:
                ...
                if (cgVar != null) {
                    ...
                    chatActivityEnterView.f21816m1.removeView(chatActivityEnterView.U0);
            ...
            case 2:
                pm pmVar = (pm) obj;
                qm qmVar = pmVar.P;
                if (i18 == pmVar.O && qmVar.f27353w.isShown()) {
                    qmVar.f27353w.e(1, true);
                    return;
                }
                return;
            case 3:
                ...
                if (kzVar.P1) {
                    ...
                    if (kyVar != null && kyVar.k()) {
                        try {
                            kzVar.f25781x.performHapticFeedback(3);
                ...
                return;
            case 4:
                ((oa0) obj).f26694b.run(Integer.valueOf(i18));
                return;
            case 5:
                pf0 pf0Var = (pf0) obj;
                org.telegram.ui.ku0 ku0Var = pf0Var.f27023a;
                ...
                ku0Var.f27284f.setVisibility(8);
                LinearLayout linearLayout = ku0Var.f27283c;
            ...
            case 8:
                ...
                return;
            case 9:
                zu0 zu0Var = ((rs0) obj).f27689a;
                org.telegram.ui.ActionBar.o2 o2Var = zu0Var.f30659v1;
                if (o2Var != null) {
                    if (zu0Var.f30621d1 instanceof TLRPC.TL_channelFull) {
                        TLRPC.TL_channels_setMainProfileTab tL_channels_setMainProfileTab = new TLRPC.TL_channels_setMainProfileTab();
                        tL_channels_setMainProfileTab.tab = zu0.d0(i18, true);
                        tL_channels_setMainProfileTab.channel = o2Var.getMessagesController().getInputChannel(zu0Var.f30621d1.f18122id);
                        TLRPC.ChatFull chatFull = zu0Var.f30621d1;
            ...
            case 14:
                ...
                return;
            case 15:
                org.telegram.ui.k60 k60Var2 = ((org.telegram.ui.n50) obj).f35950b;
            ...
            case 16:
                ...
                int childCount = g70Var.f33887n.getChildCount();
                for (int i19 = 0; i19 < childCount; i19++) {
                    View childAt = g70Var.f33887n.getChildAt(i19);
                    g70Var.f33887n.getClass();
                    if (RecyclerView.S(childAt) >= i18) {
                        childAt.setAlpha(0.0f);
                        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(childAt, View.ALPHA, 0.0f, 1.0f);
                        ofFloat.setStartDelay((int) ((Math.min(g70Var.f33887n.getMeasuredHeight(), Math.max(0, childAt.getTop())) / g70Var.f33887n.getMeasuredHeight()) * 100.0f));
            ...
            case 17:
                ...
                return;
            case 18:
                ((org.telegram.ui.ie0) obj).f34546a.f33753f[i18].l(1.0f);
                return;
            case 19:
                ...
                notificationsSettingsActivity.f30893c.m(i18);
                return;
            case 20:
                ((org.telegram.ui.hl0) obj).run(Integer.valueOf(i18));
                return;
            case 21:
                ((org.telegram.ui.pp0) obj).e.f39152p0.I.E(1 - i18);
                return;
            case 22:
                PhotoViewer photoViewer = (PhotoViewer) obj;
                Drawable[] drawableArr = PhotoViewer.U8;
                int i20 = i18 + 1;
                if (i20 < 6 && (xu0Var = photoViewer.f30954e0) != null) {
                    xu0Var.invalidate();
            ...
            case 26:
                ...
                s4.o0 layoutManager = f31Var.f33540y.getLayoutManager();
                if (layoutManager != null) {
                    if (f31Var.R) {
                        if (i18 > f31Var.L) {
                            i15 = Math.min(i18 + 1, f31Var.f33532b.d.size() - 1);
                        } else {
                    ...
                    org.telegram.ui.c31 c31Var = f31Var.f33533c;
                    c31Var.f42852a = i15;
            ...
            case 27:
                ...
                sessionsActivity.m0();
                org.telegram.ui.r81 r81Var = sessionsActivity.f31513a;
                if (r81Var != null) {
                    r81Var.l();
                    return;
                }
