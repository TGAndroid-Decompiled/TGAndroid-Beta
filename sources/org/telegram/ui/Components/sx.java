...
public class sx extends um0 {
    ...
    public final lz D0;
    public final int f28331u0;
    public boolean f28332v0;
    public float f28333w0;
    public boolean f28334x0;
    public float f28335y0;
    public float f28336z0;

    public sx(lz lzVar, Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context, d6Var, lzVar.f26257i2);
        this.D0 = lzVar;
        this.f28334x0 = true;
        this.f28331u0 = ViewConfiguration.get(context).getScaledTouchSlop();
    }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            this.B0 = false;
            this.A0 = false;
            this.f28335y0 = motionEvent.getRawX();
            this.f28336z0 = motionEvent.getRawY();
        } else if (!this.A0 && !this.B0) {
            lz lzVar = this.D0;
            if (lzVar.O0 != null && Math.abs(motionEvent.getRawY() - this.f28336z0) >= this.f28331u0) {
                this.A0 = true;
                this.f28336z0 = motionEvent.getRawY();
                ((c2.a) lzVar.O0).e();
                if (this.f28332v0) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.f28334x0) {
            this.f28334x0 = false;
            this.f28333w0 = motionEvent.getX();
        }
        ...
        if (motionEvent.getAction() == 0) {
            ...
            float abs = Math.abs(motionEvent.getRawX() - this.f28335y0);
            float f7 = this.f28331u0;
            if (abs >= f7 && canScrollHorizontally((int) (this.f28335y0 - motionEvent.getRawX()))) {
                this.B0 = true;
                AndroidUtilities.cancelRunOnUIThread(t6Var);
                lzVar.X1 = true;
                lzVar.Y();
            } else if (Math.abs(motionEvent.getRawY() - this.f28336z0) >= f7) {
                this.A0 = true;
                this.f28336z0 = motionEvent.getRawY();
                ((c2.a) lzVar.O0).e();
                if (this.f28332v0) {
        ...
        if (this.A0) {
            ...
            if (motionEvent.getAction() != 1 && motionEvent.getAction() != 3) {
                rx rxVar = lzVar.O0;
                int round = Math.round(motionEvent.getRawY() - this.f28336z0);
        ...
        if (getScrollX() == 0 && translationX == 0.0f) {
            if (!this.f28332v0 && this.f28333w0 - motionEvent.getX() < 0.0f) {
                if (!axVar.M) {
                    axVar.f48404e0 = true;
            ...
            } else if (this.f28332v0 && this.f28333w0 - motionEvent.getX() > 0.0f && axVar.f48404e0) {
                axVar.i();
                this.f28332v0 = false;
            }
        }
        ...
        if (!this.f28332v0 && !super.onTouchEvent(motionEvent)) {
            return false;
        }
        return true;
    }
