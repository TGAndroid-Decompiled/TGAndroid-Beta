...
public final class sx extends dt {
    ...
    public final void c(Canvas canvas) {
        ...
        while (true) {
            ...
            if (i10 < arrayList.size()) {
                ...
                l5 l5Var = syVar.f28832b;
                if (l5Var != null) {
                    ImageReceiver.BackgroundThreadDrawHolder backgroundThreadDrawHolder = syVar.f28834f[this.H];
                    nh.y2 y2Var = l5Var.f26587k;
                    if (y2Var != null) {
                        y2Var.setAlpha(l5Var.f26588l);
                        l5Var.f26587k.draw(canvas, backgroundThreadDrawHolder);
                    }
                }
                i10++;
            } else {
    ...
    public final void g() {
        ...
        while (true) {
            ArrayList arrayList = this.M;
            if (i10 < arrayList.size()) {
                ImageReceiver.BackgroundThreadDrawHolder[] backgroundThreadDrawHolderArr = ((sy) arrayList.get(i10)).f28834f;
    ...
    public final void i(long j10) {
        ...
        for (int i10 = 0; i10 < this.L.size(); i10++) {
            ...
            ImageReceiver.BackgroundThreadDrawHolder[] backgroundThreadDrawHolderArr = syVar.f28834f;
            if (span != null && (l5Var = (l5) kzVar.a2.get(syVar.d.getDocumentId())) != null && l5Var.f26587k != null) {
                l5Var.t(j10);
                nh.y2 y2Var = l5Var.f26587k;
                int i11 = this.H;
                ...
                if (l5Var.c()) {
                    porterDuffColorFilter = kzVar.f26427b2;
                } else {
