...
public class PollVotesAlert$UserCell extends LinearLayout {
    public ArrayList E;
    public final pg0 F;
    public final u9 f22087a;
    public final org.telegram.ui.ActionBar.j5 f22088b;
    public final TextView f22089c;
    public final TextView d;
    public final f9 e;
    public final kw0 f22090f;
    public TLRPC.User h;
    public TLRPC.Chat f22091n;
    public CharSequence f22092r;
    public final int f22093s;
    public boolean v;
    public int f22094w;
    public boolean f22095x;
    public float f22096y;

    public PollVotesAlert$UserCell(pg0 pg0Var, Context context) {
        super(context);
        this.F = pg0Var;
        this.f22093s = UserConfig.selectedAccount;
        this.f22096y = 1.0f;
        setOrientation(0);
        ...
        textView.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19088r5, false));
    ...
    public final void onAttachedToWindow() {
        ...
        this.f22090f.f25686a.a();
    }

    @Override
    public final void onDetachedFromWindow() {
        this.f22090f.f25686a.b();
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float dp5;
        int i10;
        if (this.f22095x || this.f22096y != 0.0f) {
            pg0 pg0Var = this.F;
            pg0Var.G.setAlpha((int) (this.f22096y * 255.0f));
            u9 u9Var = this.f22087a;
        ...
        if (this.v) {
            ...
            canvas.drawLine(dp5, measuredHeight2, measuredWidth - i10, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.i6.f18955k0);
        }
    }
