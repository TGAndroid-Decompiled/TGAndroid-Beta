...
public final class ql0 extends Drawable {
    public final bw e;
    public final bw f27347f;
    public float h;
    public float f27349i;
    public final Rect f27344a = new Rect();
    public final qr f27345b = kt.f25683b;
    public final int f27346c = AndroidUtilities.dp(24.0f);
    public final int d = AndroidUtilities.dp(24.0f);
    public long f27348g = -1;

    public ql0() {
        bw bwVar = new bw();
        this.e = bwVar;
        bwVar.f22811c.setColor(-2130706433);
        bw bwVar2 = new bw();
        this.f27347f = bwVar2;
        bwVar2.f22811c.setColor(-2130706433);
    }

    public final void a(Canvas canvas, float f7) {
        Rect bounds = getBounds();
        float interpolation = this.f27345b.getInterpolation(f7);
        Rect rect = this.f27344a;
        rect.left = (int) (AndroidUtilities.dp(2.0f) * this.h);
        int dp = bounds.bottom - ((int) (AndroidUtilities.dp(6.0f) * this.f27349i));
        rect.bottom = dp;
        rect.right = bounds.right - rect.left;
        rect.top = dp - ((int) (AndroidUtilities.dp(4.0f) * this.f27349i));
        bw bwVar = this.f27347f;
    ...
    public final void b(Canvas canvas, float f7) {
        ...
        int dpf2 = (int) (AndroidUtilities.dpf2(AndroidUtilities.lerp(5, 6, interpolation)) * this.f27349i);
        rect.top = dpf2;
        rect.right = bounds.right - rect.left;
        rect.bottom = dpf2 + ((int) (AndroidUtilities.dpf2(AndroidUtilities.lerp(6, 4, interpolation)) * this.f27349i));
        rect.offset(0, AndroidUtilities.dp(AndroidUtilities.lerp(0, 8, interpolation)));
        bw bwVar2 = this.e;
        bwVar2.setBounds(rect);
        bwVar2.setAlpha(255);
    ...
    public final void c(Canvas canvas, float f7) {
        ...
        int dpf2 = (int) (AndroidUtilities.dpf2(6.0f) * this.f27349i);
        rect.top = dpf2;
        rect.right = bounds.right - rect.left;
        rect.bottom = dpf2 + ((int) (AndroidUtilities.dpf2(4.0f) * this.f27349i));
        rect.offset(0, AndroidUtilities.dp(8.0f));
        bw bwVar2 = this.e;
        bwVar2.setBounds(rect);
    ...
    public final void draw(Canvas canvas) {
        if (this.f27348g > 0) {
            int currentTimeMillis = (int) (System.currentTimeMillis() - this.f27348g);
    ...
    public final void onBoundsChange(Rect rect) {
        this.h = rect.width() / this.f27346c;
        this.f27349i = rect.height() / this.d;
    }
