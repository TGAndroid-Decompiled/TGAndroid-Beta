...
public final class co extends LinearLayout {
    public final org.telegram.ui.ActionBar.g6 f26059a;
    ...
    public co(Activity activity, View view, int i10, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        int i15 = org.telegram.ui.ActionBar.k6.f21598a;
        ...
        for (int i17 = 0; i17 < 4; i17++) {
            ...
            imageView2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.k6.v0(i18, this.f26059a), PorterDuff.Mode.MULTIPLY));
            if (i10 == 0) {
            ...
            textView4.setTextColor(org.telegram.ui.ActionBar.k6.v0(i18, this.f26059a));
            this.f26061c.add(textView4);
            if (LocaleController.isRTL) {
                i14 = 5;
            } else {
                i14 = 3;
    ...
    public void setStatusText(CharSequence charSequence) {
        this.f26060b.setText(charSequence);
    }
    ...
    public void setTextColor(int i10) {
        ...
        while (true) {
            ...
            if (i11 < arrayList2.size()) {
                ((ImageView) arrayList2.get(i11)).setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.ic, this.f26059a), PorterDuff.Mode.MULTIPLY));
                i11++;
            } else {
                return;
            }
