...
public final class uj extends tl0 {
    public final int f28842r = UserConfig.selectedAccount;
    public final Context f28843s;
    public final ak v;

    public uj(ak akVar, Context context) {
        this.v = akVar;
        this.f28843s = context;
    }
    ...
    @Override
    public final int R() {
        return ContactsController.getInstance(this.f28842r).phoneBookSectionsArray.size() + 2;
    }
    ...
    public final void W(int i10, int i11, s4.c1 c1Var) {
        ...
        if (c1Var.f42962f == 0) {
            ...
            boolean containsKey = this.v.f22680w.containsKey(qj.a(O));
            pp ppVar = zjVar.d;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            ...
            zjVar = new zj(context, this.v.f27042a);
        }
