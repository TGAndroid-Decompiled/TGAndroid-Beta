...
public final class w6 extends View {
    public final ImageReceiver f29901a;
    public final Drawable f29902b;
    public final Paint f29903c;
    ...
    public w6(Context context) {
        ...
        this.f29901a = imageReceiver;
        imageReceiver.setAlpha(0.0f);
        imageReceiver.setDelegate(new s(this, 12));
        this.f29902b = context.getDrawable(R.drawable.input_attach).mutate().getConstantState().newDrawable();
    ...
    public final void onAttachedToWindow() {
        ...
        this.f29901a.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f29901a.onDetachedFromWindow();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        ImageReceiver imageReceiver = this.f29901a;
        ...
        Drawable drawable = this.f29902b;
    ...
    public void setAttachBot(TLRPC.TL_attachMenuBot tL_attachMenuBot) {
        ...
        if (staticAttachMenuBotIcon != null) {
            this.f29901a.setImage(ImageLocation.getForDocument(staticAttachMenuBotIcon.icon), "42_42", DocumentObject.getSvgThumb(staticAttachMenuBotIcon.icon, org.telegram.ui.ActionBar.h6.f19297q5, 1.0f), "svg", tL_attachMenuBot, 0);
        }
    }
    ...
    public void setColor(int i10) {
        ...
        this.f29902b.setColorFilter(i10, mode);
        this.f29903c.setColor(i10);
        this.f29901a.setColorFilter(new PorterDuffColorFilter(i10, mode));
    }
}
