...
public final class w6 extends View {
    public final ImageReceiver f29909a;
    public final Drawable f29910b;
    public final Paint f29911c;
    ...
    public w6(Context context) {
        ...
        this.f29909a = imageReceiver;
        imageReceiver.setAlpha(0.0f);
        imageReceiver.setDelegate(new s(this, 12));
        this.f29910b = context.getDrawable(R.drawable.input_attach).mutate().getConstantState().newDrawable();
    ...
    public final void onAttachedToWindow() {
        ...
        this.f29909a.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f29909a.onDetachedFromWindow();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        ImageReceiver imageReceiver = this.f29909a;
        ...
        Drawable drawable = this.f29910b;
    ...
    public void setAttachBot(TLRPC.TL_attachMenuBot tL_attachMenuBot) {
        ...
        if (staticAttachMenuBotIcon != null) {
            this.f29909a.setImage(ImageLocation.getForDocument(staticAttachMenuBotIcon.icon), "42_42", DocumentObject.getSvgThumb(staticAttachMenuBotIcon.icon, org.telegram.ui.ActionBar.h6.f19297q5, 1.0f), "svg", tL_attachMenuBot, 0);
        }
    }
    ...
    public void setColor(int i10) {
        ...
        this.f29910b.setColorFilter(i10, mode);
        this.f29911c.setColor(i10);
        this.f29909a.setColorFilter(new PorterDuffColorFilter(i10, mode));
    }
}
