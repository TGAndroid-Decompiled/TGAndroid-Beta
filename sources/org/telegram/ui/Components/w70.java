...
public final class w70 extends org.telegram.ui.ActionBar.f3 {
    ...
    public boolean E;
    public u70 F;
    public Drawable f29640b;
    public l00 f29641c;
    public s70 d;
    public TextView e;
    public TextView f29642f;
    public ArrayList h;
    public boolean f29643n;
    public int f29644r;
    public int f29645s;
    public TLRPC.Peer v;
    public TLRPC.Peer f29646w;
    public TLRPC.InputPeer f29647x;
    ...
    public static void m(w70 w70Var, u70 u70Var) {
        ...
        if (w70Var.f29645s == 2) {
            ...
            w70Var.f29647x = inputPeer;
        }
        w70Var.dismiss();
    }

    public static void n(w70 w70Var) {
        w70Var.f29647x = MessagesController.getInstance(w70Var.currentAccount).getInputPeer(MessageObject.getPeerId(w70Var.v));
        w70Var.f29648y = true;
        w70Var.dismiss();
    }
    ...
    public static void o(w70 w70Var) {
        ...
        if (w70Var.f29645s != 0) {
            ...
            if (w70Var.f29644r != i10) {
                w70Var.e.setTranslationY(AndroidUtilities.dp(19.0f) + top);
                w70Var.f29642f.setTranslationY(AndroidUtilities.dp(56.0f) + top);
                w70Var.f29644r = i10;
    ...
    public static void v(Context context, long j3, ArrayList arrayList, org.telegram.ui.ActionBar.n2 n2Var, int i10, TLRPC.Peer peer, u70 u70Var) {
        ...
        if (i10 == 2) {
            ...
            Drawable drawable = f3Var.f29640b;
            i11 = org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18880fg, false);
        ...
        if (i10 == 2) {
            textView.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19028ng, false));
        } else {
        ...
        f3Var.f29642f = textView2;
        if (i10 == 2) {
            textView2.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19047og, false));
        } else {
        ...
        z10 = false;
        f3Var.f29642f.setMovementMethod(new AndroidUtilities.LinkMovementMethodMy());
        f3Var.f29642f.setLinkTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18963k5, false));
        if (i10 == 0) {
            ...
            f3Var.f29642f.setText(sb2);
            f3Var.f29642f.setGravity(49);
            r70Var.addView(f3Var.f29642f, w7.x5.t(-2, -2, 49, 23, 0, 23, 5));
        } else {
            if (z10) {
                f3Var.f29642f.setText(LocaleController.getString(R.string.VoipGroupStartAsInfoGroup));
            } else {
                f3Var.f29642f.setText(LocaleController.getString(R.string.VoipGroupStartAsInfo));
            }
            TextView textView3 = f3Var.f29642f;
            ...
            r70Var.addView(f3Var.f29642f, w7.x5.d(-2, -2.0f, 51, 23.0f, 0.0f, 23.0f, 5.0f));
        }
        if (i10 == 0) {
            s70 s70Var2 = f3Var.d;
            if (f3Var.h.size() < 5) {
        ...
        f3Var.f29641c = l00Var;
        ((View) l00Var.f25795c).setOnClickListener(new dt(9, f3Var, u70Var));
        if (f3Var.f29645s == 0) {
            ...
            ((View) l00Var2.f25795c).setOnClickListener(new f0((Object) f3Var, 29));
    ...
    public final void dismissInternal() {
        ...
        TLRPC.InputPeer inputPeer = this.f29647x;
        if (inputPeer != null) {
            u70 u70Var = this.F;
            boolean z10 = true;
            if (this.h.size() <= 1) {
            ...
            u70Var.a(inputPeer, z10, this.f29648y, false);
        }
    }

    public final void w(TLRPC.Chat chat, boolean z10) {
        String str;
        l00 l00Var = this.f29641c;
        if (this.f29645s == 0) {
            if (ChatObject.isChannelOrGiga(chat)) {
