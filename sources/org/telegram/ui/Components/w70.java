...
public final class w70 extends org.telegram.ui.ActionBar.f3 {
    ...
    public int f32218s;
    public TLRPC.Peer v;
    public TLRPC.Peer f32219w;
    public TLRPC.InputPeer f32220x;
    ...
    public static void m(w70 w70Var, u70 u70Var) {
        ...
        if (w70Var.f32218s == 2) {
            ...
            w70Var.f32220x = inputPeer;
        }
        w70Var.dismiss();
    }

    public static void n(w70 w70Var) {
        w70Var.f32220x = MessagesController.getInstance(w70Var.currentAccount).getInputPeer(MessageObject.getPeerId(w70Var.v));
        w70Var.f32221y = true;
        w70Var.dismiss();
    }
    ...
    public static void o(w70 w70Var) {
        ...
        if (w70Var.f32218s != 0) {
            ...
            if (w70Var.f32217r != i10) {
                w70Var.f32214e.setTranslationY(AndroidUtilities.dp(19.0f) + top);
                w70Var.f32215f.setTranslationY(AndroidUtilities.dp(56.0f) + top);
                w70Var.f32217r = i10;
    ...
    public static void v(Context context, long j3, ArrayList arrayList, org.telegram.ui.ActionBar.n2 n2Var, int i10, TLRPC.Peer peer, u70 u70Var) {
        ...
        if (i10 == 2) {
            ...
            Drawable drawable = f3Var.f32212b;
            i11 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20735fg, false);
        ...
        f3Var.f32214e = textView;
        org.telegram.messenger.wl.j(20.0f, 1, textView);
        if (i10 == 2) {
            textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20880ng, false));
        } else {
        ...
        f3Var.f32215f = textView2;
        if (i10 == 2) {
            textView2.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20898og, false));
        } else {
        ...
        z10 = false;
        f3Var.f32215f.setMovementMethod(new AndroidUtilities.LinkMovementMethodMy());
        f3Var.f32215f.setLinkTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20817k5, false));
        if (i10 == 0) {
            ...
            f3Var.f32215f.setText(sb2);
            f3Var.f32215f.setGravity(49);
            r70Var.addView(f3Var.f32215f, w7.x5.t(-2, -2, 49, 23, 0, 23, 5));
        } else {
            if (z10) {
                f3Var.f32215f.setText(LocaleController.getString(R.string.VoipGroupStartAsInfoGroup));
            } else {
                f3Var.f32215f.setText(LocaleController.getString(R.string.VoipGroupStartAsInfo));
            }
            TextView textView3 = f3Var.f32215f;
            ...
            r70Var.addView(f3Var.f32215f, w7.x5.d(-2, -2.0f, 51, 23.0f, 0.0f, 23.0f, 5.0f));
        }
        if (i10 == 0) {
            s70 s70Var2 = f3Var.d;
            if (f3Var.h.size() < 5) {
        ...
        f3Var.f32213c = l00Var;
        ((View) l00Var.f28047c).setOnClickListener(new ct(9, f3Var, u70Var));
        if (f3Var.f32218s == 0) {
            ...
            ((View) l00Var2.f28047c).setOnClickListener(new g0((Object) f3Var, 29));
    ...
    public final void dismissInternal() {
        ...
        TLRPC.InputPeer inputPeer = this.f32220x;
        if (inputPeer != null) {
            u70 u70Var = this.F;
            boolean z10 = true;
            if (this.h.size() <= 1) {
            ...
            u70Var.a(inputPeer, z10, this.f32221y, false);
        }
    }

    public final void w(TLRPC.Chat chat, boolean z10) {
        String str;
        l00 l00Var = this.f32213c;
        if (this.f32218s == 0) {
            if (ChatObject.isChannelOrGiga(chat)) {
