...
public final class w70 extends org.telegram.ui.ActionBar.g3 {
    ...
    public int f29582s;
    public TLRPC.Peer v;
    public TLRPC.Peer f29583w;
    public TLRPC.InputPeer f29584x;
    ...
    public static void m(w70 w70Var, u70 u70Var) {
        ...
        if (w70Var.f29582s == 2) {
            ...
            w70Var.f29584x = inputPeer;
        }
        w70Var.dismiss();
    }

    public static void n(w70 w70Var) {
        w70Var.f29584x = MessagesController.getInstance(w70Var.currentAccount).getInputPeer(MessageObject.getPeerId(w70Var.v));
        w70Var.f29585y = true;
        w70Var.dismiss();
    }
    ...
    public static void o(w70 w70Var) {
        ...
        if (w70Var.f29582s != 0) {
            ...
            if (w70Var.f29581r != i10) {
                w70Var.e.setTranslationY(AndroidUtilities.dp(19.0f) + top);
                w70Var.f29579f.setTranslationY(AndroidUtilities.dp(56.0f) + top);
                w70Var.f29581r = i10;
    ...
    public static void v(Context context, long j3, ArrayList arrayList, org.telegram.ui.ActionBar.o2 o2Var, int i10, TLRPC.Peer peer, u70 u70Var) {
        ...
        if (i10 == 2) {
            ...
            Drawable drawable = g3Var.f29577b;
            i11 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18907fg, false);
        ...
        if (i10 == 2) {
            textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19055ng, false));
        } else {
        ...
        g3Var.f29579f = textView2;
        if (i10 == 2) {
            textView2.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19074og, false));
        } else {
        ...
        z10 = false;
        g3Var.f29579f.setMovementMethod(new AndroidUtilities.LinkMovementMethodMy());
        g3Var.f29579f.setLinkTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18990k5, false));
        if (i10 == 0) {
            ...
            g3Var.f29579f.setText(sb2);
            g3Var.f29579f.setGravity(49);
            r70Var.addView(g3Var.f29579f, w7.x5.t(-2, -2, 49, 23, 0, 23, 5));
        } else {
            if (z10) {
                g3Var.f29579f.setText(LocaleController.getString(R.string.VoipGroupStartAsInfoGroup));
            } else {
                g3Var.f29579f.setText(LocaleController.getString(R.string.VoipGroupStartAsInfo));
            }
            TextView textView3 = g3Var.f29579f;
            ...
            r70Var.addView(g3Var.f29579f, w7.x5.d(-2, -2.0f, 51, 23.0f, 0.0f, 23.0f, 5.0f));
        }
        if (i10 == 0) {
            s70 s70Var2 = g3Var.d;
            if (g3Var.h.size() < 5) {
        ...
        g3Var.f29578c = l00Var;
        ((View) l00Var.f25798c).setOnClickListener(new dt(9, g3Var, u70Var));
        if (g3Var.f29582s == 0) {
            ...
            ((View) l00Var2.f25798c).setOnClickListener(new f0((Object) g3Var, 29));
    ...
    public final void dismissInternal() {
        ...
        TLRPC.InputPeer inputPeer = this.f29584x;
        if (inputPeer != null) {
            u70 u70Var = this.F;
            boolean z10 = true;
            if (this.h.size() <= 1) {
            ...
            u70Var.a(inputPeer, z10, this.f29585y, false);
        }
    }

    public final void w(TLRPC.Chat chat, boolean z10) {
        String str;
        l00 l00Var = this.f29578c;
        if (this.f29582s == 0) {
            if (ChatObject.isChannelOrGiga(chat)) {
