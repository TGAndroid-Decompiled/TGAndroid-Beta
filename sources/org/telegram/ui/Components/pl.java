...
public final class pl extends AnimatorListenerAdapter {
    public final ChatAttachAlertPhotoLayout f30117a;

    public pl(ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout) {
        this.f30117a = chatAttachAlertPhotoLayout;
    }

    @Override
    public final void onAnimationEnd(Animator animator) {
        int i10;
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.f30117a;
        ...
        ObjectAnimator.ofFloat(chatAttachAlertPhotoLayout.f24769o0, View.SCALE_X, 1.0f).setDuration(100L).start();
    }
}
