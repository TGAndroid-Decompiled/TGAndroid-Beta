...
public final class vq0 extends Drawable {
    public long f29792a = 0;
    public final float[] f29793b = {0.0f, -0.5f};
    public final Drawable f29794c;
    ...
    public vq0(Context context, int i10) {
        this.f29795f = i10;
        if (i10 == 4) {
            this.f29794c = context.getResources().getDrawable(R.drawable.filled_extend_location).mutate();
            ...
            this.f29794c = context.getResources().getDrawable(R.drawable.filled_stop_location).mutate();
            this.d = context.getResources().getDrawable(R.drawable.smallanimationpinleft).mutate();
            this.e = context.getResources().getDrawable(R.drawable.smallanimationpinright).mutate();
        } else if (i10 == 1) {
            this.f29794c = context.getResources().getDrawable(R.drawable.smallanimationpin).mutate();
            this.d = context.getResources().getDrawable(R.drawable.smallanimationpinleft).mutate();
            this.e = context.getResources().getDrawable(R.drawable.smallanimationpinright).mutate();
        } else {
            this.f29794c = context.getResources().getDrawable(R.drawable.animationpin).mutate();
    ...
    public final void draw(Canvas canvas) {
        ...
        int i10;
        float x10;
        Drawable drawable = this.f29794c;
        int intrinsicWidth = drawable.getIntrinsicWidth();
        int intrinsicHeight = drawable.getIntrinsicHeight();
        int i11 = 3;
        int i12 = 5;
        int i13 = 1;
        int i14 = this.f29795f;
        int i15 = 4;
        if (i14 != 4 && i14 != 5) {
            if (i14 == 3) {
        ...
        long j3 = currentTimeMillis - this.f29792a;
        this.f29792a = currentTimeMillis;
        if (j3 > 16) {
            j3 = 16;
        }
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f29794c.setColorFilter(colorFilter);
