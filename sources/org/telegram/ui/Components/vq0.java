...
public abstract class vq0 extends FrameLayout {
    public org.telegram.ui.ActionBar.j5 f29780a;
    public org.telegram.ui.ActionBar.j5 f29781b;
    public ci.eb f29782c;
    public int d;
    public AnimatorSet e;
    public Paint f29783f;
    public RectF h;
    ...
    public final void a(int i10) {
        ...
        this.e.setInterpolator(qr.f27654g);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ((FrameLayout.LayoutParams) this.f29781b.getLayoutParams()).width = size;
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.f29780a.getLayoutParams();
