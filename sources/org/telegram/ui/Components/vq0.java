...
public final class vq0 extends Drawable {
    public long f29817a = 0;
    public final float[] f29818b = {0.0f, -0.5f};
    public final Drawable f29819c;
    ...
    public vq0(Context context, int i10) {
        this.f29820f = i10;
        if (i10 == 4) {
            this.f29819c = context.getResources().getDrawable(R.drawable.filled_extend_location).mutate();
            ...
            this.f29819c = context.getResources().getDrawable(R.drawable.filled_stop_location).mutate();
            this.d = context.getResources().getDrawable(R.drawable.smallanimationpinleft).mutate();
            this.e = context.getResources().getDrawable(R.drawable.smallanimationpinright).mutate();
        } else if (i10 == 1) {
            this.f29819c = context.getResources().getDrawable(R.drawable.smallanimationpin).mutate();
            this.d = context.getResources().getDrawable(R.drawable.smallanimationpinleft).mutate();
            this.e = context.getResources().getDrawable(R.drawable.smallanimationpinright).mutate();
        } else {
            this.f29819c = context.getResources().getDrawable(R.drawable.animationpin).mutate();
    ...
    public final void draw(Canvas canvas) {
        ...
        int i10;
        float x10;
        Drawable drawable = this.f29819c;
        ...
        long j3 = currentTimeMillis - this.f29817a;
        this.f29817a = currentTimeMillis;
        if (j3 > 16) {
            j3 = 16;
        }
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f29819c.setColorFilter(colorFilter);
