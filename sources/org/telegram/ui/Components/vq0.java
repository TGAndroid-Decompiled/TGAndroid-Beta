...
public final class vq0 extends Drawable {
    public long f29793a = 0;
    public final float[] f29794b = {0.0f, -0.5f};
    public final Drawable f29795c;
    ...
    public vq0(Context context, int i10) {
        this.f29796f = i10;
        if (i10 == 4) {
            this.f29795c = context.getResources().getDrawable(R.drawable.filled_extend_location).mutate();
            ...
            this.f29795c = context.getResources().getDrawable(R.drawable.filled_stop_location).mutate();
            this.d = context.getResources().getDrawable(R.drawable.smallanimationpinleft).mutate();
            this.e = context.getResources().getDrawable(R.drawable.smallanimationpinright).mutate();
        } else if (i10 == 1) {
            this.f29795c = context.getResources().getDrawable(R.drawable.smallanimationpin).mutate();
            this.d = context.getResources().getDrawable(R.drawable.smallanimationpinleft).mutate();
            this.e = context.getResources().getDrawable(R.drawable.smallanimationpinright).mutate();
        } else {
            this.f29795c = context.getResources().getDrawable(R.drawable.animationpin).mutate();
    ...
    public final void draw(Canvas canvas) {
        ...
        int i10;
        float x10;
        Drawable drawable = this.f29795c;
        ...
        long j3 = currentTimeMillis - this.f29793a;
        this.f29793a = currentTimeMillis;
        if (j3 > 16) {
            j3 = 16;
        }
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f29795c.setColorFilter(colorFilter);
