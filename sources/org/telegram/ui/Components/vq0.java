    ...
    public final void onClick(View view) {
        switch (this.f29390a) {
            case 0:
                ...
                if (this.f29391b) {
                    zu0Var.O0(o2Var, zu0Var.f30631j1, this.f29392c);
                    return;
                }
            ...
            default:
                ...
                boolean z10 = this.f29391b;
                int i10 = this.f29392c;
                if (z10) {
                    xh.q1 q1Var = new xh.q1(or0Var.getContext(), i10, or0Var.f46130c, null, null);
                    q1Var.V(BirthdayController.getInstance(i10).isToday(or0Var.f46130c));
                    q1Var.show();
                    return;
                }
