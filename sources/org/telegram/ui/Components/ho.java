...
public final class ho extends LinearLayout {
    public final org.telegram.ui.ActionBar.d6 f24825a;
    public final TextView f24826b;
    public final ArrayList f24827c;
    ...
    public ho(Activity activity, View view, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        for (int i17 = 0; i17 < 4; i17++) {
            ...
            imageView2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(i18, this.f24825a), PorterDuff.Mode.MULTIPLY));
            if (i10 == 0) {
            ...
            textView4.setTextColor(org.telegram.ui.ActionBar.h6.v0(i18, this.f24825a));
            this.f24827c.add(textView4);
            if (LocaleController.isRTL) {
                i14 = 5;
            } else {
                i14 = 3;
    ...
    public void setStatusText(CharSequence charSequence) {
        this.f24826b.setText(charSequence);
    }
    ...
    public void setTextColor(int i10) {
        ...
        int i12 = 0;
        while (true) {
            ArrayList arrayList = this.f24827c;
        ...
        while (true) {
            ...
            if (i11 < arrayList2.size()) {
                ((ImageView) arrayList2.get(i11)).setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19154ic, this.f24825a), PorterDuff.Mode.MULTIPLY));
                i11++;
            } else {
                return;
            }
