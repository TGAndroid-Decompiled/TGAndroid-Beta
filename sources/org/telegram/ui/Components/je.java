...
public final class je extends Property {
    ...
    public final Object get(Object obj) {
        switch (this.f27489a) {
            case 0:
                View view = (View) obj;
                return Float.valueOf(this.f27490b.h);
            case 1:
                View view2 = (View) obj;
                return Float.valueOf(this.f27490b.E);
            case 2:
                View view3 = (View) obj;
                return Float.valueOf(this.f27490b.f23767n);
            case 3:
                View view4 = (View) obj;
                return Float.valueOf(this.f27490b.f23821x);
            default:
                View view5 = (View) obj;
                return Float.valueOf(this.f27490b.G);
        }
    }
    ...
    public final void set(Object obj, Object obj2) {
        switch (this.f27489a) {
            ...
            case 1:
                ...
                ChatActivityEnterView chatActivityEnterView2 = this.f27490b;
            ...
            case 2:
                ...
                ChatActivityEnterView chatActivityEnterView3 = this.f27490b;
                chatActivityEnterView3.f23767n = floatValue3;
                chatActivityEnterView3.F1();
                return;
            case 3:
                View view4 = (View) obj;
                float floatValue4 = ((Float) obj2).floatValue();
                ChatActivityEnterView chatActivityEnterView4 = this.f27490b;
                chatActivityEnterView4.f23821x = floatValue4;
                chatActivityEnterView4.A1();
                return;
            default:
                View view5 = (View) obj;
                float floatValue5 = ((Float) obj2).floatValue();
                ChatActivityEnterView chatActivityEnterView5 = this.f27490b;
