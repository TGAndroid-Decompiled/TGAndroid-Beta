...
public final class qj0 extends FrameLayout {
    public final Paint f27364a;
    public final RectF f27365b;
    public final float f27366c;
    public final u9 d;
    public final ImageView e;
    public final TextView f27367f;
    public final View h;
    public float f27368n;
    public final Drawable f27369r;
    public int f27370s;
    public zg.p0 v;
    ...
    public qj0(Context context) {
        ...
        this.f27364a = new Paint(1);
        new Path();
        this.f27365b = new RectF();
        this.f27366c = AndroidUtilities.dp(32.0f);
        ...
        this.f27367f = textView;
        textView.setImportantForAccessibility(2);
        textView.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19023n8, false));
        textView.setTypeface(AndroidUtilities.bold());
        addView(textView, w7.x5.i(-1.0f, -2.0f, 8388627, 40.0f, 0.0f, 8.0f, 0.0f));
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth(AndroidUtilities.dp(1.0f));
        setWillNotDraw(false);
        setOutlineProgress(this.f27368n);
    }
    ...
    public final void a(int i10, TLRPC.ReactionCount reactionCount) {
        ...
        this.f27367f.setText(formatShortNumber);
        ...
        if (str != null) {
            for (TLRPC.TL_availableReaction tL_availableReaction : MediaDataController.getInstance(i10).getReactionsList()) {
                if (tL_availableReaction.reaction.equals(this.v.f49127f)) {
                    u9Var.i(ImageLocation.getForDocument(tL_availableReaction.center_icon), "40_40_lastreactframe", "webp", DocumentObject.getSvgThumb(tL_availableReaction.static_icon, org.telegram.ui.ActionBar.i6.f18780a7, 1.0f), tL_availableReaction);
        ...
        u9Var.setAnimatedEmojiDrawable(new o5(0, i10, this.v.f49128g));
        u9Var.setVisibility(0);
        imageView.setVisibility(8);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f7 = this.f27366c;
        canvas.drawRoundRect(rectF, f7, f7, this.f27364a);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f27368n > 0.5d) {
            accessibilityNodeInfo.setSelected(true);
        }
        zg.p0 p0Var = this.v;
        if (p0Var != null) {
            accessibilityNodeInfo.setText(LocaleController.formatPluralString("AccDescrNumberOfPeopleReactions", this.f27370s, p0Var));
        } else {
            accessibilityNodeInfo.setText(LocaleController.formatPluralString("ReactionsCount", this.f27370s, new Object[0]));
        }
    }
    ...
    public void setOutlineProgress(float f7) {
        ...
        this.f27364a.setColor(i0.a.d(f7, k10, w02));
        this.f27367f.setTextColor(d);
        this.f27369r.setColorFilter(new PorterDuffColorFilter(d, PorterDuff.Mode.MULTIPLY));
        float f10 = this.f27366c;
        View view = this.h;
        if (f7 == 1.0f) {
            int i12 = (int) f10;
