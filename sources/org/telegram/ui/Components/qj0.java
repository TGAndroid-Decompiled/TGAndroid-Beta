...
public final class qj0 extends FrameLayout {
    public final Paint f29770a;
    public final RectF f29771b;
    public final float f29772c;
    public final x9 d;
    public final ImageView f29773e;
    public final TextView f29774f;
    public final View h;
    public float f29775n;
    public final Drawable f29776r;
    public int f29777s;
    public ah.j1 v;
    ...
    public qj0(Context context) {
        ...
        this.f29770a = new Paint(1);
        new Path();
        this.f29771b = new RectF();
        this.f29772c = AndroidUtilities.dp(32.0f);
        View view = new View(context);
        this.h = view;
        addView(view, w7.x5.c(-1.0f, -1));
        ImageView imageView = new ImageView(context);
        this.f29773e = imageView;
        ...
        this.f29774f = textView;
        textView.setImportantForAccessibility(2);
        textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20875n8, false));
        textView.setTypeface(AndroidUtilities.bold());
        addView(textView, w7.x5.i(-1.0f, -2.0f, 8388627, 40.0f, 0.0f, 8.0f, 0.0f));
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth(AndroidUtilities.dp(1.0f));
        setWillNotDraw(false);
        setOutlineProgress(this.f29775n);
    }
    ...
    public final void a(int i10, TLRPC.ReactionCount reactionCount) {
        ...
        this.f29774f.setText(formatShortNumber);
        ah.j1 d = ah.j1.d(reactionCount.reaction);
        this.v = d;
        String str = d.f609f;
        ImageView imageView = this.f29773e;
        x9 x9Var = this.d;
        if (str != null) {
            for (TLRPC.TL_availableReaction tL_availableReaction : MediaDataController.getInstance(i10).getReactionsList()) {
                if (tL_availableReaction.reaction.equals(this.v.f609f)) {
                    x9Var.i(ImageLocation.getForDocument(tL_availableReaction.center_icon), "40_40_lastreactframe", "webp", DocumentObject.getSvgThumb(tL_availableReaction.static_icon, org.telegram.ui.ActionBar.j6.f20634a7, 1.0f), tL_availableReaction);
    ...
    public final void dispatchDraw(Canvas canvas) {
        RectF rectF = this.f29771b;
        rectF.set(0.0f, 0.0f, getWidth(), getHeight());
        float f7 = this.f29772c;
        canvas.drawRoundRect(rectF, f7, f7, this.f29770a);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f29775n > 0.5d) {
            accessibilityNodeInfo.setSelected(true);
        }
        ah.j1 j1Var = this.v;
        if (j1Var != null) {
            accessibilityNodeInfo.setText(LocaleController.formatPluralString("AccDescrNumberOfPeopleReactions", this.f29777s, j1Var));
        } else {
            accessibilityNodeInfo.setText(LocaleController.formatPluralString("ReactionsCount", this.f29777s, new Object[0]));
        }
    }
    ...
    public void setOutlineProgress(float f7) {
        ...
        this.f29770a.setColor(i0.a.d(f7, k10, w02));
        this.f29774f.setTextColor(d);
        this.f29776r.setColorFilter(new PorterDuffColorFilter(d, PorterDuff.Mode.MULTIPLY));
