...
public final class v71 extends View {
    ...
    public MediaMetadataRetriever f28649r;
    public u71 f28650s;
    ...
    public v71(Context context) {
        ...
        paint2.setColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18780a7, false));
        this.L = 0;
        t71 t71Var = this.P;
        if (t71Var != null) {
            t71Var.b();
    ...
    public final void a(boolean z10) {
        synchronized (T) {
            try {
                MediaMetadataRetriever mediaMetadataRetriever = this.f28649r;
        ...
        if (this.f28649r != null) {
            if (i10 == 0) {
                if (this.I) {
                    ...
                    this.f28653y = (int) Math.ceil((getMeasuredWidth() - AndroidUtilities.dp(16.0f)) / this.F);
                }
                this.f28652x = this.f28644a / this.F;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int dp = AndroidUtilities.dp(12.0f) + ((int) (this.f28645b * measuredWidth));
        int dp2 = AndroidUtilities.dp(12.0f) + ((int) (measuredWidth * this.f28646c));
        float f7 = 32.0f;
        int measuredHeight = (getMeasuredHeight() - AndroidUtilities.dp(32.0f)) >> 1;
        ArrayList arrayList = this.v;
        if (arrayList.isEmpty() && this.f28651w == null) {
            b(0);
        }
        if (!arrayList.isEmpty()) {
            if (!this.O) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent != null) {
            ...
            int dp = AndroidUtilities.dp(12.0f) + ((int) (this.f28645b * f7));
            int dp2 = AndroidUtilities.dp(12.0f) + ((int) (this.f28646c * f7));
            if (motionEvent.getAction() == 0) {
                getParent().requestDisallowInterceptTouchEvent(true);
                if (this.f28649r != null) {
                    int dp3 = AndroidUtilities.dp(24.0f);
                    if (dp - dp3 <= x10 && x10 <= dp + dp3 && y3 >= 0.0f && y3 <= getMeasuredHeight()) {
                        u71 u71Var = this.f28650s;
                        if (u71Var != null) {
                            ((bf) u71Var).f22775a.Y2.K(0.0f, 1);
                        }
                        this.f28647f = true;
                        this.f28648n = (int) (x10 - dp);
                        this.P.setTime((int) ((((float) this.f28644a) / 1000.0f) * this.f28645b));
                        this.P.setCx(AndroidUtilities.dp(4.0f) + getLeft() + dp);
                        this.P.a(true);
                        invalidate();
                        return true;
                    } else if (dp2 - dp3 <= x10 && x10 <= dp3 + dp2 && y3 >= 0.0f && y3 <= getMeasuredHeight()) {
                        u71 u71Var2 = this.f28650s;
                        if (u71Var2 != null) {
                            ((bf) u71Var2).f22775a.Y2.K(0.0f, 1);
                        }
                        this.h = true;
                        this.f28648n = (int) (x10 - dp2);
                        this.P.setTime((int) ((((float) this.f28644a) / 1000.0f) * this.f28646c));
                ...
                if (motionEvent.getAction() == 2) {
                    if (this.f28647f) {
                        ...
                        this.f28645b = dp4;
                        float f10 = this.f28646c;
                        float f11 = f10 - dp4;
                        float f12 = this.G;
                        if (f11 > f12) {
                            this.f28646c = dp4 + f12;
                        } else {
                            float f13 = this.H;
                            if (f13 != 0.0f && f11 < f13) {
                                float f14 = f10 - f13;
                        ...
                        this.P.setCx(((AndroidUtilities.dpf2(12.0f) + (f7 * this.f28645b)) + getLeft()) - AndroidUtilities.dp(4.0f));
                        this.P.setTime((int) ((((float) this.f28644a) / 1000.0f) * this.f28645b));
                        this.P.a(true);
                        u71 u71Var3 = this.f28650s;
                        if (u71Var3 != null) {
                            float f15 = this.f28645b;
                            ChatActivityEnterView chatActivityEnterView = ((bf) u71Var3).f22775a;
                            VideoEditedInfo videoEditedInfo = chatActivityEnterView.f21755d3;
                        ...
                        this.f28646c = dp5;
                        float f16 = this.f28645b;
                        float f17 = dp5 - f16;
                        float f18 = this.G;
                        if (f17 > f18) {
                            this.f28645b = dp5 - f18;
                        } else {
                            float f19 = this.H;
                            if (f19 != 0.0f && f17 < f19) {
                                float f20 = f16 + f19;
                        ...
                        this.P.setCx(AndroidUtilities.dpf2(12.0f) + (f7 * this.f28646c) + getLeft() + AndroidUtilities.dp(4.0f));
                        this.P.a(true);
                        this.P.setTime((int) ((((float) this.f28644a) / 1000.0f) * this.f28646c));
                        u71 u71Var4 = this.f28650s;
                        if (u71Var4 != null) {
                            float f21 = this.f28646c;
                            ChatActivityEnterView chatActivityEnterView2 = ((bf) u71Var4).f22775a;
                            VideoEditedInfo videoEditedInfo2 = chatActivityEnterView2.f21755d3;
                ...
                u71 u71Var5 = this.f28650s;
                if (u71Var5 != null) {
                    ((bf) u71Var5).f22775a.Y2.K(0.0f, 0);
                }
                this.f28647f = false;
                invalidate();
                this.P.a(false);
                ...
                u71 u71Var6 = this.f28650s;
                if (u71Var6 != null) {
                    ((bf) u71Var6).f22775a.Y2.K(0.0f, 0);
                }
                this.h = false;
                invalidate();
                this.P.a(false);
    ...
    public void setVideoPath(String str) {
        ...
        this.f28649r = mediaMetadataRetriever;
        this.f28645b = 0.0f;
        this.f28646c = 1.0f;
        try {
            mediaMetadataRetriever.setDataSource(str);
            this.f28644a = Long.parseLong(this.f28649r.extractMetadata(9));
        } catch (Exception e) {
            FileLog.e(e);
        }
        invalidate();
