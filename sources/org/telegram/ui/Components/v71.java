...
public final class v71 extends View {
    ...
    public boolean h;
    public float f28645n;
    public MediaMetadataRetriever f28646r;
    public u71 f28647s;
    ...
    public v71(Context context) {
        ...
        paint2.setColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18778a7, false));
        this.L = 0;
        t71 t71Var = this.P;
        if (t71Var != null) {
            t71Var.b();
    ...
    public final void a(boolean z10) {
        synchronized (T) {
            try {
                MediaMetadataRetriever mediaMetadataRetriever = this.f28646r;
        ...
        if (this.f28646r != null) {
            if (i10 == 0) {
                if (this.I) {
                    ...
                    this.f28650y = (int) Math.ceil((getMeasuredWidth() - AndroidUtilities.dp(16.0f)) / this.F);
                }
                this.f28649x = this.f28641a / this.F;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int dp = AndroidUtilities.dp(12.0f) + ((int) (this.f28642b * measuredWidth));
        int dp2 = AndroidUtilities.dp(12.0f) + ((int) (measuredWidth * this.f28643c));
        float f7 = 32.0f;
        int measuredHeight = (getMeasuredHeight() - AndroidUtilities.dp(32.0f)) >> 1;
        ArrayList arrayList = this.v;
        if (arrayList.isEmpty() && this.f28648w == null) {
            b(0);
        }
        if (!arrayList.isEmpty()) {
            if (!this.O) {
            ...
            Paint paint2 = this.R;
            canvas.drawLine(dp - AndroidUtilities.dp(4.0f), AndroidUtilities.dp(10.0f) + measuredHeight, dp - AndroidUtilities.dp(4.0f), org.telegram.messenger.y0.B(10.0f, getMeasuredHeight(), measuredHeight), paint2);
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent != null) {
            ...
            int dp = AndroidUtilities.dp(12.0f) + ((int) (this.f28642b * f7));
            int dp2 = AndroidUtilities.dp(12.0f) + ((int) (this.f28643c * f7));
            if (motionEvent.getAction() == 0) {
                getParent().requestDisallowInterceptTouchEvent(true);
                if (this.f28646r != null) {
                    int dp3 = AndroidUtilities.dp(24.0f);
                    if (dp - dp3 <= x10 && x10 <= dp + dp3 && y3 >= 0.0f && y3 <= getMeasuredHeight()) {
                        u71 u71Var = this.f28647s;
                        if (u71Var != null) {
                            ((bf) u71Var).f22771a.Y2.K(0.0f, 1);
                        }
                        this.f28644f = true;
                        this.f28645n = (int) (x10 - dp);
                        this.P.setTime((int) ((((float) this.f28641a) / 1000.0f) * this.f28642b));
                        this.P.setCx(AndroidUtilities.dp(4.0f) + getLeft() + dp);
                        this.P.a(true);
                        invalidate();
                        return true;
                    } else if (dp2 - dp3 <= x10 && x10 <= dp3 + dp2 && y3 >= 0.0f && y3 <= getMeasuredHeight()) {
                        u71 u71Var2 = this.f28647s;
                        if (u71Var2 != null) {
                            ((bf) u71Var2).f22771a.Y2.K(0.0f, 1);
                        }
                        this.h = true;
                        this.f28645n = (int) (x10 - dp2);
                        this.P.setTime((int) ((((float) this.f28641a) / 1000.0f) * this.f28643c));
                ...
                if (motionEvent.getAction() == 2) {
                    if (this.f28644f) {
                        ...
                        this.f28642b = dp4;
                        float f10 = this.f28643c;
                        float f11 = f10 - dp4;
                        float f12 = this.G;
                        if (f11 > f12) {
                            this.f28643c = dp4 + f12;
                        } else {
                            float f13 = this.H;
                            if (f13 != 0.0f && f11 < f13) {
                                float f14 = f10 - f13;
                        ...
                        this.P.setCx(((AndroidUtilities.dpf2(12.0f) + (f7 * this.f28642b)) + getLeft()) - AndroidUtilities.dp(4.0f));
                        this.P.setTime((int) ((((float) this.f28641a) / 1000.0f) * this.f28642b));
                        this.P.a(true);
                        u71 u71Var3 = this.f28647s;
                        if (u71Var3 != null) {
                            float f15 = this.f28642b;
                            ChatActivityEnterView chatActivityEnterView = ((bf) u71Var3).f22771a;
                            VideoEditedInfo videoEditedInfo = chatActivityEnterView.f21751d3;
                        ...
                        this.f28643c = dp5;
                        float f16 = this.f28642b;
                        float f17 = dp5 - f16;
                        float f18 = this.G;
                        if (f17 > f18) {
                            this.f28642b = dp5 - f18;
                        } else {
                            float f19 = this.H;
                            if (f19 != 0.0f && f17 < f19) {
                                float f20 = f16 + f19;
                        ...
                        this.P.setCx(AndroidUtilities.dpf2(12.0f) + (f7 * this.f28643c) + getLeft() + AndroidUtilities.dp(4.0f));
                        this.P.a(true);
                        this.P.setTime((int) ((((float) this.f28641a) / 1000.0f) * this.f28643c));
                        u71 u71Var4 = this.f28647s;
                        if (u71Var4 != null) {
                            float f21 = this.f28643c;
                            ChatActivityEnterView chatActivityEnterView2 = ((bf) u71Var4).f22771a;
                            VideoEditedInfo videoEditedInfo2 = chatActivityEnterView2.f21751d3;
            ...
            } else if (this.f28644f) {
                u71 u71Var5 = this.f28647s;
                if (u71Var5 != null) {
                    ((bf) u71Var5).f22771a.Y2.K(0.0f, 0);
                }
                this.f28644f = false;
                invalidate();
                this.P.a(false);
                ...
                u71 u71Var6 = this.f28647s;
                if (u71Var6 != null) {
                    ((bf) u71Var6).f22771a.Y2.K(0.0f, 0);
                }
                this.h = false;
                invalidate();
                this.P.a(false);
    ...
    public void setVideoPath(String str) {
        ...
        this.f28646r = mediaMetadataRetriever;
        this.f28642b = 0.0f;
        this.f28643c = 1.0f;
        try {
            mediaMetadataRetriever.setDataSource(str);
            this.f28641a = Long.parseLong(this.f28646r.extractMetadata(9));
        } catch (Exception e) {
            FileLog.e(e);
        }
        invalidate();
