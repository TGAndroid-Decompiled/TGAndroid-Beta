...
public final class rq0 extends vl0 {
    ...
    public final TLRPC.TL_forumTopic E(int i10) {
        ...
        ArrayList arrayList = this.f28029f;
        if (arrayList != null && i11 >= 0 && i11 < arrayList.size()) {
            return (TLRPC.TL_forumTopic) this.f28029f.get(i11);
        }
        return null;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        int dp;
        if (c1Var.f42963f == 0) {
            org.telegram.ui.Cells.h7 h7Var = (org.telegram.ui.Cells.h7) c1Var.f42960a;
            if (i10 == 1 && this.d) {
                h7Var.setAsNewBotForumTopic(this.e);
            } else if (this.f28029f != null) {
                TLRPC.TL_forumTopic E = E(i10);
                uq0 uq0Var = this.h;
                TLRPC.Dialog dialog = uq0Var.C0;
                if (E != null && uq0Var.U.h(E.f18387id) >= 0) {
                    z10 = true;
                } else {
                    z10 = false;
                }
