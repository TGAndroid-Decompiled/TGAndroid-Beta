...
public class ki0 extends org.telegram.ui.ActionBar.f3 {
    ...
    public ki0(Context context, String str, String str2, String str3, boolean z10) {
        ...
        try {
            ...
            this.f25606f = telegramQRCodeWriter.getImageSize();
            bitmap = encode;
        } catch (Exception e) {
            FileLog.e(e);
        }
        ...
        cm0Var.addView((View) imageView, w7.x5.e(60, 60, 17));
        linearLayout.addView(cm0Var, w7.x5.t(220, 220, 1, 30, 0, 30, 0));
        TextView textView = new TextView(context);
        this.f25605c = textView;
    ...
    public final void n() {
        ...
        if (textView2 != null) {
            ...
            textView2.setBackground(org.telegram.ui.ActionBar.h6.f0(i0.a.k(getThemedColor(i10), Math.min(255, Color.alpha(getThemedColor(org.telegram.ui.ActionBar.h6.f18878i6)) * 2)), 7, -1));
        }
        int i11 = org.telegram.ui.ActionBar.h6.f19170y6;
        int themedColor4 = getThemedColor(i11);
        TextView textView3 = this.f25605c;
        ...
        setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.h6.f18859h5));
    }
}
