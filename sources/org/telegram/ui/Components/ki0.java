...
public final class ki0 {
    public final e6 f27831a;
    public final p6 f27832b;
    public final int f27833c;
    public boolean d;
    public final pi0 f27834e;
    public final zc f27835f;
    public final Paint f27836g = new Paint(1);
    public boolean h;

    public ki0(View view) {
        this.f27831a = new e6(view, 350L, pr.h);
        this.f27834e = new pi0(view);
        this.f27835f = new zc(view);
        ...
        this.f27833c = (int) Math.ceil(Math.max(textPaint.measureText(string), textPaint.measureText(LocaleController.getString(R.string.QuoteCollapse))));
    }

    public final void a(Canvas canvas, RectF rectF, float f7, float f10, int i10, boolean z10, boolean z11) {
        int i11;
        boolean z12 = this.d;
        p6 p6Var = this.f27832b;
        if (z10 != z12) {
            this.d = z10;
            if (z10) {
        ...
        float a2 = this.f27835f.a(0.02f) * this.f27831a.e(z11);
        if (a2 > 0.0f) {
            int k10 = i0.a.k(i10, 30);
            Paint paint = this.f27836g;
            paint.setColor(k10);
            canvas.save();
            ...
            Paint paint2 = pi0Var.f29394b;
            paint2.setColor(i10);
            paint2.setAlpha(pi0Var.d);
            boolean z13 = !z10;
            if (pi0Var.f29396e != z13) {
                pi0Var.f29396e = z13;
                pi0Var.f29393a.invalidate();
            }
            pi0Var.draw(canvas);
            canvas.restore();
        }
