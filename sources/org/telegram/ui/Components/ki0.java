...
public class ki0 extends org.telegram.ui.ActionBar.g3 {
    ...
    public ki0(Context context, String str, String str2, String str3, boolean z10) {
        ...
        try {
            ...
            this.f25635f = telegramQRCodeWriter.getImageSize();
            bitmap = encode;
        } catch (Exception e) {
            FileLog.e(e);
        }
    ...
    public final void n() {
        ...
        if (textView2 != null) {
            ...
            textView2.setBackground(org.telegram.ui.ActionBar.j6.f0(i0.a.k(getThemedColor(i10), Math.min(255, Color.alpha(getThemedColor(org.telegram.ui.ActionBar.j6.f18952i6)) * 2)), 7, -1));
        }
        int i11 = org.telegram.ui.ActionBar.j6.f19244y6;
        int themedColor4 = getThemedColor(i11);
        TextView textView3 = this.f25634c;
        ...
        setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f18933h5));
    }
}
