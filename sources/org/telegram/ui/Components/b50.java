...
public class b50 {
    ...
    public b50(int i10) {
        ...
        this.f22579f = GLES20.glGetUniformLocation(glCreateProgram, "sTexture");
    }

    public final void a() {
        GLES20.glDeleteProgram(this.f22576a);
        GLES20.glDeleteShader(this.f22577b);
        GLES20.glDeleteShader(this.f22578c);
    }
}
