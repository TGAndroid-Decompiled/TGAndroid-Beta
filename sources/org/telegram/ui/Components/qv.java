...
public abstract class qv implements NotificationCenter.NotificationCenterDelegate {
    public final ArrayList f27770a;
    public ArrayList f27771b;
    public ArrayList[] f27772c;
    public final int d;
    public boolean e = false;
    public final tv f27773f;

    public qv(int i10, ArrayList arrayList, tv tvVar) {
        this.f27773f = tvVar;
        this.d = i10;
        this.f27770a = arrayList == null ? new ArrayList() : arrayList;
    }
    ...
    public final void a(int i10, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        ...
        if (i10 >= 0) {
            ArrayList[] arrayListArr = this.f27772c;
                ...
                if (tL_messages_stickerSet != null && tL_messages_stickerSet.documents != null) {
                    ...
                    for (int i12 = 0; i12 < tL_messages_stickerSet.documents.size(); i12++) {
                        ...
                        if (document == null) {
                            ...
                            obj.f27780a = tL_messages_stickerSet;
                            obj.f27781b = document.f18341id;
                            this.f27772c[i10].add(obj);
                            if (this.f27773f.H) {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.groupStickersDidLoad) {
            for (int i12 = 0; i12 < this.f27771b.size(); i12++) {
                if (this.f27771b.get(i12) == null) {
                    TLRPC.TL_messages_stickerSet stickerSet2 = MediaDataController.getInstance(this.d).getStickerSet((TLRPC.InputStickerSet) this.f27770a.get(i12), true);
                    if (this.f27771b.size() == 1 && stickerSet2 != null && (stickerSet = stickerSet2.set) != null && !stickerSet.emojis) {
                        tv tvVar = this.f27773f;
                        tvVar.dismiss();
                        Context context = tvVar.getContext();
                        org.telegram.ui.ActionBar.m2 m2Var = tvVar.f28624c;
                        TLRPC.InputStickerSet inputStickerSet = (TLRPC.InputStickerSet) this.f27770a.get(i12);
                    ...
                    this.f27771b.set(i12, stickerSet2);
                    if (stickerSet2 != null) {
                        a(i12, stickerSet2);
                    }
                }
