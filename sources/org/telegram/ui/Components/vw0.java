...
public abstract class vw0 extends ll0 {
    public static final tw0 f31994x3 = new CacheFetcher();
    public static final uw0 y3 = new CacheFetcher();
    public float X2;
    public rw0[] Y2;
    public final mw0 Z2;
    public final e6 f31995a3;
    public Drawable f31996b3;
    public Drawable f31997c3;
    public Paint f31998d3;
    public final Paint f31999e3;
    public int f32000f3;
    public int f32001g3;
    public Utilities.Callback f32002h3;
    public Utilities.Callback f32003i3;
    public boolean j3;
    public boolean f32004k3;
    public di.eb f32005l3;
    public int f32006m3;
    public Utilities.Callback f32007n3;
    public float f32008o3;
    public ValueAnimator f32009p3;
    public boolean f32010q3;
    public final e6 f32011r3;
    public final e6 f32012s3;
    public final RectF f32013t3;
    public final RectF f32014u3;
    public final RectF f32015v3;
    public boolean f32016w3;
    ...
    public vw0(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.Y2 = null;
        pr prVar = pr.h;
        this.f31995a3 = new e6(this, 360L, prVar);
        Paint paint = new Paint(1);
        this.f31999e3 = paint;
        this.f32006m3 = -1;
        this.f32008o3 = 0.0f;
        this.f32010q3 = true;
        this.f32011r3 = new e6(this, 350L, prVar);
        this.f32012s3 = new e6(this, 350L, prVar);
        this.f32013t3 = new RectF();
        this.f32014u3 = new RectF();
        this.f32015v3 = new RectF();
        ...
        setSelectorDrawableColor(org.telegram.ui.ActionBar.j6.v0(i11, this.f28225p2));
        paint.setColor(org.telegram.ui.ActionBar.j6.v0(i11, this.f28225p2));
        setWillNotDraw(false);
        setOnItemClickListener(new k(this, 15));
        long currentTimeMillis = System.currentTimeMillis();
        f31994x3.fetch(UserConfig.selectedAccount, Integer.valueOf(i10), new di.r9(this, currentTimeMillis, 2));
    }
    ...
    private int getScrollToStartWidth() {
        ...
        if (childAt instanceof qw0) {
            return Math.max(0, getHeight() * (RecyclerView.R(childAt) - 1)) + this.f32000f3 + (-childAt.getLeft());
        }
    ...
    public static void w1(vw0 vw0Var, TLRPC.TL_messages_emojiGroups tL_messages_emojiGroups, long j3) {
        ...
        for (int i10 = 0; i10 < tL_messages_emojiGroups.groups.size(); i10++) {
            ...
            ?? obj = new Object();
            obj.f30108c = emojiGroup.icon_emoji_id;
            if (emojiGroup instanceof TLRPC.TL_emojiGroupPremium) {
                obj.f30106a = "premium";
            } else {
                obj.f30106a = TextUtils.concat((CharSequence[]) emojiGroup.emoticons.toArray(new String[0])).toString();
            }
            obj.f30107b = emojiGroup instanceof TLRPC.TL_emojiGroupGreeting;
    ...
    public static void y1(RectF rectF, View view) {
        ...
        if (view instanceof qw0) {
            qw0 qw0Var = (qw0) view;
            f7 = com.google.android.gms.internal.vision.e2.z(1.0f, qw0Var.E, 0.15f, 0.85f) * qw0Var.f29832y;
        }
        float f10 = width * f7;
    ...
    public final void B1() {
        int dp = (AndroidUtilities.dp(34.0f) * this.f32006m3) + ((-getScrollToStartWidth()) - Math.max(0, this.f32001g3));
        scrollBy(dp, 0);
    ...
    public void D1(int i10) {
        boolean z10;
        if (this.f32006m3 < 0 && i10 >= 0) {
            this.f32012s3.d(i10, true);
        }
        this.f32006m3 = i10;
    ...
    public final void F1(boolean z10, boolean z11) {
        ...
        if (this.f32008o3 == ((float) r52)) {
            return;
        }
        ValueAnimator valueAnimator = this.f32009p3;
        ...
        float f7 = 0.0f;
        if (z11) {
            float f10 = this.f32008o3;
            if (r52 != 0) {
                f7 = 1.0f;
            }
            ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, f7);
            this.f32009p3 = ofFloat;
            ofFloat.addUpdateListener(new h70(this, 23));
            this.f32009p3.addListener(new r80(this, 19));
            this.f32009p3.setInterpolator(pr.h);
            ValueAnimator valueAnimator2 = this.f32009p3;
            rw0[] rw0VarArr = this.Y2;
            if (rw0VarArr == null) {
                length = 5;
            } else {
    ...
    public int getCategoryIndex() {
        return this.f32006m3;
    }

    public rw0 getSelectedCategory() {
        int i10;
        rw0[] rw0VarArr = this.Y2;
        if (rw0VarArr != null && (i10 = this.f32006m3) >= 0 && i10 < rw0VarArr.length) {
    ...
    public final void k0(int i10, int i11) {
        ...
        if (getChildCount() > 0) {
            ...
            if (childAt instanceof qw0) {
                ...
                if (childAt.getRight() > this.f32001g3) {
                    z11 = false;
                }
                z10 = false;
            }
        ...
        if (z12 != z11) {
            this.j3 = z11;
            Utilities.Callback callback2 = this.f32002h3;
            if (callback2 != null) {
                if (z11) {
                    i12 = Math.max(0, getScrollToStartWidth() - (this.f32000f3 - this.f32001g3));
                }
                callback2.run(Integer.valueOf(i12));
            }
            invalidate();
        } else if (z12 && (callback = this.f32002h3) != null) {
            callback.run(Integer.valueOf(Math.max(0, getScrollToStartWidth() - (this.f32000f3 - this.f32001g3))));
        }
        if (this.f32004k3 != z10) {
            this.f32004k3 = z10;
            Utilities.Callback callback3 = this.f32003i3;
            if (callback3 != null) {
    ...
    public final void onAttachedToWindow() {
        ...
        F1(this.f32010q3, false);
    }

    @Override
    public final void onConfigurationChanged(Configuration configuration) {
        super.onConfigurationChanged(configuration);
        di.eb ebVar = this.f32005l3;
        if (ebVar != null) {
            ebVar.requestLayout();
        }
    }
    ...
    public void setBackgroundColor(int i10) {
        if (this.f31998d3 == null) {
            this.f31998d3 = new Paint(1);
        }
        this.f31998d3.setColor(i10);
        Drawable mutate = getContext().getResources().getDrawable(R.drawable.gradient_right).mutate();
        this.f31996b3 = mutate;
