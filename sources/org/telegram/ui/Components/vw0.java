...
public abstract class vw0 extends ll0 {
    public static final tw0 f32020x3 = new CacheFetcher();
    public static final uw0 y3 = new CacheFetcher();
    public float X2;
    public rw0[] Y2;
    public final mw0 Z2;
    public final e6 f32021a3;
    public Drawable f32022b3;
    public Drawable f32023c3;
    public Paint f32024d3;
    public final Paint f32025e3;
    public int f32026f3;
    public int f32027g3;
    public Utilities.Callback f32028h3;
    public Utilities.Callback f32029i3;
    public boolean j3;
    public boolean f32030k3;
    public di.eb f32031l3;
    public int f32032m3;
    public Utilities.Callback f32033n3;
    public float f32034o3;
    public ValueAnimator f32035p3;
    public boolean f32036q3;
    public final e6 f32037r3;
    public final e6 f32038s3;
    public final RectF f32039t3;
    public final RectF f32040u3;
    public final RectF f32041v3;
    public boolean f32042w3;
    ...
    public vw0(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.Y2 = null;
        pr prVar = pr.h;
        this.f32021a3 = new e6(this, 360L, prVar);
        Paint paint = new Paint(1);
        this.f32025e3 = paint;
        this.f32032m3 = -1;
        this.f32034o3 = 0.0f;
        this.f32036q3 = true;
        this.f32037r3 = new e6(this, 350L, prVar);
        this.f32038s3 = new e6(this, 350L, prVar);
        this.f32039t3 = new RectF();
        this.f32040u3 = new RectF();
        this.f32041v3 = new RectF();
        ...
        setSelectorDrawableColor(org.telegram.ui.ActionBar.j6.v0(i11, this.f28251p2));
        paint.setColor(org.telegram.ui.ActionBar.j6.v0(i11, this.f28251p2));
        setWillNotDraw(false);
        setOnItemClickListener(new k(this, 15));
        long currentTimeMillis = System.currentTimeMillis();
        f32020x3.fetch(UserConfig.selectedAccount, Integer.valueOf(i10), new di.r9(this, currentTimeMillis, 2));
    }
    ...
    private int getScrollToStartWidth() {
        ...
        if (childAt instanceof qw0) {
            return Math.max(0, getHeight() * (RecyclerView.R(childAt) - 1)) + this.f32026f3 + (-childAt.getLeft());
        }
    ...
    public static void w1(vw0 vw0Var, TLRPC.TL_messages_emojiGroups tL_messages_emojiGroups, long j3) {
        ...
        for (int i10 = 0; i10 < tL_messages_emojiGroups.groups.size(); i10++) {
            ...
            ?? obj = new Object();
            obj.f30134c = emojiGroup.icon_emoji_id;
            if (emojiGroup instanceof TLRPC.TL_emojiGroupPremium) {
                obj.f30132a = "premium";
            } else {
                obj.f30132a = TextUtils.concat((CharSequence[]) emojiGroup.emoticons.toArray(new String[0])).toString();
            }
            obj.f30133b = emojiGroup instanceof TLRPC.TL_emojiGroupGreeting;
    ...
    public static void y1(RectF rectF, View view) {
        ...
        if (view instanceof qw0) {
            qw0 qw0Var = (qw0) view;
            f7 = com.google.android.gms.internal.vision.e2.z(1.0f, qw0Var.E, 0.15f, 0.85f) * qw0Var.f29858y;
        }
        float f10 = width * f7;
    ...
    public final void B1() {
        int dp = (AndroidUtilities.dp(34.0f) * this.f32032m3) + ((-getScrollToStartWidth()) - Math.max(0, this.f32027g3));
        scrollBy(dp, 0);
    ...
    public void D1(int i10) {
        boolean z10;
        if (this.f32032m3 < 0 && i10 >= 0) {
            this.f32038s3.d(i10, true);
        }
        this.f32032m3 = i10;
    ...
    public final void F1(boolean z10, boolean z11) {
        ...
        if (this.f32034o3 == ((float) r52)) {
            return;
        }
        ValueAnimator valueAnimator = this.f32035p3;
        ...
        float f7 = 0.0f;
        if (z11) {
            float f10 = this.f32034o3;
            if (r52 != 0) {
                f7 = 1.0f;
            }
            ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, f7);
            this.f32035p3 = ofFloat;
            ofFloat.addUpdateListener(new h70(this, 23));
            this.f32035p3.addListener(new r80(this, 19));
            this.f32035p3.setInterpolator(pr.h);
            ValueAnimator valueAnimator2 = this.f32035p3;
            rw0[] rw0VarArr = this.Y2;
            if (rw0VarArr == null) {
                length = 5;
            } else {
    ...
    public int getCategoryIndex() {
        return this.f32032m3;
    }

    public rw0 getSelectedCategory() {
        int i10;
        rw0[] rw0VarArr = this.Y2;
        if (rw0VarArr != null && (i10 = this.f32032m3) >= 0 && i10 < rw0VarArr.length) {
    ...
    public final void k0(int i10, int i11) {
        ...
        if (getChildCount() > 0) {
            ...
            if (childAt instanceof qw0) {
                ...
                if (childAt.getRight() > this.f32027g3) {
                    z11 = false;
                }
                z10 = false;
            }
        ...
        if (z12 != z11) {
            this.j3 = z11;
            Utilities.Callback callback2 = this.f32028h3;
            if (callback2 != null) {
                if (z11) {
                    i12 = Math.max(0, getScrollToStartWidth() - (this.f32026f3 - this.f32027g3));
                }
                callback2.run(Integer.valueOf(i12));
            }
            invalidate();
        } else if (z12 && (callback = this.f32028h3) != null) {
            callback.run(Integer.valueOf(Math.max(0, getScrollToStartWidth() - (this.f32026f3 - this.f32027g3))));
        }
        if (this.f32030k3 != z10) {
            this.f32030k3 = z10;
            Utilities.Callback callback3 = this.f32029i3;
            if (callback3 != null) {
    ...
    public final void onAttachedToWindow() {
        ...
        F1(this.f32036q3, false);
    }

    @Override
    public final void onConfigurationChanged(Configuration configuration) {
        super.onConfigurationChanged(configuration);
        di.eb ebVar = this.f32031l3;
        if (ebVar != null) {
            ebVar.requestLayout();
        }
    }
    ...
    public void setBackgroundColor(int i10) {
        if (this.f32024d3 == null) {
            this.f32024d3 = new Paint(1);
        }
        this.f32024d3.setColor(i10);
        Drawable mutate = getContext().getResources().getDrawable(R.drawable.gradient_right).mutate();
        this.f32022b3 = mutate;
