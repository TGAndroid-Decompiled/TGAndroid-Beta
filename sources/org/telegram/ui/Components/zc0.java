...
public class zc0 extends FrameLayout {
    ...
    public float H;
    public final RectF f33126a;
    public String f33127b;
    public final Paint f33128c;
    public final TextPaint d;
    public final o1.k f33129e;
    public float f33130f;
    public final o1.k h;
    public float f33131n;
    public final o1.k f33132r;
    public float f33133s;
    public final float v;
    public final float f33134w;
    public EditText f33135x;
    ...
    public final void b(float f7, float f10, boolean z10) {
        if (!z10) {
            ...
            this.f33131n = f10;
            if (!this.f33136y) {
                float f11 = this.f33134w;
                float f12 = this.v;
                this.f33128c.setStrokeWidth(((f11 - f12) * f7) + f12);
            }
            f();
            return;
        }
    ...
    public final void e(EditTextBoldCursor editTextBoldCursor) {
        this.f33135x = editTextBoldCursor;
        invalidate();
    }
    ...
    public final void f() {
        ...
        this.d.setColor(i0.a.d(this.f33133s, d, org.telegram.ui.ActionBar.j6.v0(i11, f6Var)));
        int v04 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20792k6, f6Var);
        int v05 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20810l6, f6Var);
        if (!this.f33136y || this.F) {
            f10 = this.f33130f;
        }
        setColor(i0.a.d(this.f33133s, i0.a.d(f10, v04, v05), org.telegram.ui.ActionBar.j6.v0(i11, f6Var)));
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        EditText editText = this.f33135x;
        if ((editText == null || editText.length() != 0 || !TextUtils.isEmpty(this.f33135x.getHint())) && !this.f33136y && !this.E) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (z10) {
            paddingTop = com.google.android.gms.internal.vision.e2.z(1.0f, this.f33131n, textSize - paddingTop, paddingTop);
        }
        float f13 = paddingTop;
        if (z10) {
            f7 = (1.0f - this.f33131n) * this.H;
        } else {
            f7 = 0.0f;
        }
        Paint paint = this.f33128c;
        float strokeWidth = paint.getStrokeWidth();
        if (z10) {
            f10 = com.google.android.gms.internal.vision.e2.z(1.0f, this.f33131n, 0.25f, 0.75f);
        } else {
            f10 = 0.75f;
        }
        float measureText = textPaint.measureText(this.f33127b) * f10;
        canvas.save();
        RectF rectF = this.f33126a;
        ...
        canvas.drawText(this.f33127b, AndroidUtilities.dp(14.0f) + getPaddingLeft() + f7, f13, textPaint);
        canvas.restore();
    }
