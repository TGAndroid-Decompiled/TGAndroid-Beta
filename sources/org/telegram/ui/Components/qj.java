...
public final class qj extends di implements NotificationCenter.NotificationCenterDelegate, xd.b {
    ...
    public gj G;
    public boolean H;
    public final xd.a f28192n;
    public final FrameLayout f28193r;
    public final lh.e1 f28194s;
    public final ej v;
    public final HashMap f28195w;
    public final ArrayList f28196x;
    public boolean f28197y;

    public qj(Context context, org.telegram.ui.ActionBar.f6 f6Var, li liVar) {
        super(context, f6Var, liVar);
        this.f28192n = new xd.a(0, this, mr.h, 380L, false);
        this.f28195w = new HashMap();
        this.f28196x = new ArrayList();
        this.f28197y = false;
        this.C = new mj(this, context);
        ki kiVar = new ki(context, org.telegram.ui.ActionBar.j6.f19881d6, f6Var);
        this.E = kiVar;
        kiVar.setVisibility(4);
        FrameLayout frameLayout = new FrameLayout(context);
        this.f28193r = frameLayout;
        ...
        e1Var.setGlowColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.A5, this.f24281a));
        ...
        NotificationCenter.getInstance(this.f24282b.G1).addObserver(this, NotificationCenter.contactsDidLoad);
        N();
    }

    public int getCurrentTop() {
        lh.e1 e1Var = this.f28194s;
    ...
    public final boolean H(final int i10, final boolean z4, int i11, final boolean z10, final long j10) {
        HashMap hashMap = this.f28195w;
        int i12 = 0;
        if ((hashMap.size() == 0 && this.G == null) || this.f28197y) {
            return false;
        }
        this.f28197y = true;
        final ArrayList arrayList = new ArrayList(hashMap.size());
        ArrayList arrayList2 = this.f28196x;
    ...
    public final void K(pj pjVar, Object obj) {
        ...
        ArrayList arrayList = this.f28196x;
        int i10 = 1;
        if (containsKey) {
            hashMap.remove(a2);
            arrayList.remove(a2);
    ...
    public final void N() {
        boolean z4;
        int i10 = 0;
        if (this.f28194s.getAdapter().h() == 2) {
            z4 = true;
        } else {
            z4 = false;
        }
    ...
    public final void O() {
        View childAt;
        mz mzVar = this.D;
        if (mzVar.getVisibility() != 0 || (childAt = this.f28194s.getChildAt(0)) == null) {
            return;
        }
    ...
    public int getCurrentItemTop() {
        ...
        this.f28193r.setTranslationY(top);
    ...
    public int getListTopPadding() {
        return this.f28194s.getPaddingTop();
    }
    ...
    public ArrayList<org.telegram.ui.ActionBar.l6> getThemeDescriptions() {
        ...
        int i11 = org.telegram.ui.ActionBar.j6.f20114q5;
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(e1Var, 0, new Class[]{pj.class}, null, org.telegram.ui.ActionBar.j6.f20126r0, null, org.telegram.ui.ActionBar.j6.J7));
    ...
    @Override
    public final void m() {
        NotificationCenter.getInstance(this.f24282b.G1).removeObserver(this, NotificationCenter.contactsDidLoad);
    }
    ...
    public final void y(int i10, int i11) {
        ...
        this.f28194s.n1(0, i12 + AndroidUtilities.statusBarHeight, 0, this.e);
    }
