...
public final class yu extends View {
    ...
    public final Drawable[] f30705b;
    public final Drawable f30706c;
    ...
    public final Paint f30710s;
    public final RectF v;
    public final e6 f30711w;
    public final e6 f30712x;
    public final org.telegram.ui.ActionBar.d6 f30713y;
    ...
    public yu(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        this.f30704a = AndroidUtilities.dp(f7);
        this.f30705b = new Drawable[11];
        this.f30708n = new int[]{0, 0};
        this.f30709r = new int[]{0, 0};
        this.f30710s = new Paint(1);
        this.v = new RectF();
        sr srVar = sr.h;
        this.f30711w = new e6(this, 125L, srVar);
        this.f30712x = new e6(this, 125L, srVar);
        this.F = -1;
        this.G = true;
        this.f30713y = d6Var;
        this.f30706c = getResources().getDrawable(R.drawable.stickers_back_all);
    ...
    public final void a() {
        ...
        org.telegram.ui.ActionBar.d6 d6Var = this.f30713y;
        org.telegram.ui.ActionBar.h6.w1(org.telegram.ui.ActionBar.h6.v0(i10, d6Var), this.f30706c);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Drawable drawable = yuVar.f30706c;
        boolean z10 = false;
        drawable.setBounds(0, 0, measuredWidth, measuredHeight);
        drawable.draw(canvas);
        int dp3 = yuVar.h - AndroidUtilities.dp(9.0f);
        int measuredHeight2 = yuVar.getMeasuredHeight() - AndroidUtilities.dp(6.34f);
        int dp4 = AndroidUtilities.dp(9.0f) + yuVar.h;
        int measuredHeight3 = yuVar.getMeasuredHeight();
        Drawable drawable2 = yuVar.d;
        drawable2.setBounds(dp3, measuredHeight2, dp4, measuredHeight3);
        drawable2.draw(canvas);
        if (yuVar.e != null) {
            boolean z11 = yuVar.f30707f;
            org.telegram.ui.ActionBar.d6 d6Var = yuVar.f30713y;
            int[] iArr = yuVar.f30708n;
            e6 e6Var2 = yuVar.f30711w;
            Paint paint = yuVar.f30710s;
            Drawable[] drawableArr = yuVar.f30705b;
            RectF rectF = yuVar.v;
            float f10 = 1.0f;
            int i10 = yuVar.f30704a;
            if (z11) {
                int i11 = 0;
                while (i11 < 2) {
                    if (i11 == 0) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.I) {
            this.I = false;
            return false;
        } else if (!this.f30707f) {
            return super.onTouchEvent(motionEvent);
        } else {
            int i13 = 0;
            while (true) {
                Drawable[] drawableArr = this.f30705b;
