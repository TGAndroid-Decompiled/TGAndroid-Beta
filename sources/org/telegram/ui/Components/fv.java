...
public final class fv extends kl0 {
    ...
    public final int h() {
        ...
        if (!UserConfig.getInstance(i10).isPremium() && (arrayList = bvVar.f29192b) != null && arrayList.size() == 1 && MessageObject.isPremiumEmojiPack((TLRPC.TL_messages_stickerSet) bvVar.f29192b.get(0))) {
            r22 = 1;
        } else {
            r22 = 0;
        }
            ...
            while (true) {
                ...
                if (arrayList2 != null) {
                    if (arrayListArr.length == 1) {
                        ...
                        min = Math.min(bvVar.f29195f.f30103y.J * 2, arrayList2.size());
                    }
                    i11 = min + i11 + 1;
                }
                i13++;
        ...
        return Math.max(0, bvVar.f29193c.length - 1) + i12 + i11;
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            if (i10 == 1) {
                ...
                view3.f27268a = new ImageReceiver.BackgroundThreadDrawHolder[2];
                view2 = view3;
            } else if (i10 == 2) {
                Context context = rvVar.getContext();
                if (rvVar.f30096e.f29193c.length > 1) {
                    z10 = false;
                }
