...
public final class n9 implements Runnable {
    public final int f26397a = 0;
    public final t9 f26398b;
    public final Runnable[] f26399c;
    public final y50 d;
    public final int e;
    public final w7.i0[] f26400f;

    public n9(t9 t9Var, y50 y50Var, Runnable[] runnableArr, int i10, w7.i0[] i0VarArr) {
        this.f26398b = t9Var;
        this.d = y50Var;
        this.f26399c = runnableArr;
        this.e = i10;
        this.f26400f = i0VarArr;
    }
    ...
    public final void run() {
        switch (this.f26397a) {
            case 0:
                t9 t9Var = this.f26398b;
                y50 y50Var = this.d;
                Runnable[] runnableArr = this.f26399c;
                int i10 = this.e;
                w7.i0[] i0VarArr = this.f26400f;
                try {
                    GradientDrawable.Orientation orientation = t9Var.getOrientation();
                    int[] iArr = t9Var.f28071a;
                    int i11 = y50Var.f30161a;
                    int i12 = y50Var.f30162b;
            ...
            default:
                t9.a(this.f26398b, this.f26399c, null, this.d, this.e, this.f26400f);
                return;
        }
    }
