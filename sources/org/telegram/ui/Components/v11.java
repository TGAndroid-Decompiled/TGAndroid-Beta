...
public class v11 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final Paint f28569r;
    public final Paint f28570s;
    public final RectF v;
    public final Path f28571w;
    public final org.telegram.ui.ActionBar.f6 f28572x;
    public ValueAnimator f28573y;

    public v11(int i10, int i11, Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f28564a = AndroidUtilities.dp(8.0f);
        this.f28565b = AndroidUtilities.dp(6.0f);
        this.f28566c = AndroidUtilities.dp(4.0f);
        this.d = AndroidUtilities.dp(21.0f);
        this.e = AndroidUtilities.dp(41.0f);
        this.f28567f = new u11(this);
        this.f28568n = 1.0f;
        Paint paint = new Paint(1);
        this.f28569r = paint;
        this.f28570s = new Paint(1);
        this.v = new RectF();
        this.f28571w = new Path();
    ...
    public StaticLayout getNoThemeStaticLayout() {
        ...
        this.E = textPaint;
        textPaint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.We, this.f28572x));
    ...
    public final void d() {
        if (this.H.getImageReceiver().getLottieAnimation() != null) {
            ...
            if (!this.H.getImageReceiver().getLottieAnimation().f30235k0) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.N != null) {
            canvas.save();
            canvas.clipPath(this.f28571w);
            this.N.setBounds(0, 0, getMeasuredWidth(), getMeasuredHeight());
            this.N.draw(canvas);
            canvas.restore();
        }
        if (this.f28568n != 1.0f && (u11Var2 = this.h) != null) {
            u11Var2.b(canvas, 1.0f);
        }
        float f7 = this.f28568n;
        if (f7 != 0.0f) {
            this.f28567f.b(canvas, f7);
        }
        if (this.f28568n != 1.0f && (u11Var = this.h) != null) {
            u11Var.a(canvas, 1.0f);
        }
        float f10 = this.f28568n;
        if (f10 != 0.0f) {
            this.f28567f.a(canvas, f10);
        }
        float f11 = this.f28568n;
        if (f11 != 1.0f) {
    ...
    public final void f(lp lpVar, long j3, boolean z10) {
        ...
        this.V = i17;
        this.G = lpVar;
        TLRPC.Document f7 = lpVar.f25957a.f();
        org.telegram.ui.ActionBar.e4 e4Var2 = lpVar.f25957a;
        if (e4Var2.d instanceof TLRPC.TL_chatThemeUniqueGift) {
            j10 = ChatThemeController.getInstance(e4Var2.f18622g).getGiftThemeUser(((TLRPC.TL_chatThemeUniqueGift) e4Var2.d).gift.slug);
        } else {
            j10 = 0;
        }
        this.U = j10;
        ...
        if (z11) {
            if (f7 != null) {
                drawable = DocumentObject.getSvgThumb(f7, org.telegram.ui.ActionBar.j6.f18846c7, 0.2f);
            } else {
                drawable = null;
            }
            if (drawable == null) {
                Emoji.preloadEmoji(lpVar.f25957a.e);
                drawable = Emoji.getEmojiDrawable(lpVar.f25957a.e);
            }
            this.H.h(ImageLocation.getForDocument(f7), "50_50", drawable, null);
            lpVar.f25957a.getClass();
        ...
        u9 u9Var = this.H;
        if (lpVar.f25957a.m() && this.T != null) {
            i10 = 8;
        } else {
            i10 = 0;
        }
        ...
        if (z11 || z12) {
            ...
            u11 u11Var = this.f28567f;
            lp lpVar2 = this.G;
            if (lpVar2 == null || (e4Var = lpVar2.f25957a) == null) {
                j11 = 0;
            } else {
                org.telegram.ui.ActionBar.d4 d4Var = (org.telegram.ui.ActionBar.d4) e4Var.f18621f.get(lpVar2.f25959c);
                int i18 = d4Var.h;
                if (this.U != 0) {
                    i18 = d4Var.f18582k;
                }
                Paint paint = u11Var.f28249c;
                Paint paint2 = u11Var.f28247a;
                Paint paint3 = u11Var.f28248b;
                paint.setColor(i18);
                paint3.setColor(d4Var.f18580i);
                if (this.G.f25957a.m()) {
                    i11 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Oh, this.f28572x);
                } else {
                    i11 = d4Var.f18581j;
                }
                ...
                lp lpVar3 = this.G;
                fg.a aVar = (fg.a) lpVar3.f25957a.f18621f.get(lpVar3.f25959c);
                if (aVar != null) {
                    org.telegram.ui.ActionBar.d4 d4Var2 = (org.telegram.ui.ActionBar.d4) aVar;
                    if (d4Var2.a() != 0) {
                        lp lpVar4 = this.G;
                        int i19 = ((org.telegram.ui.ActionBar.d4) lpVar4.f25957a.f18621f.get(lpVar4.f25959c)).d;
                        ...
                        if (arrayList.size() > 1) {
                            ...
                            float dp = this.f28566c + AndroidUtilities.dp(8.0f);
                        ...
                        if (this.G != null) {
                            ...
                            this.G.f25958b = cc0Var;
                        }
                        j11 = 0;
                        u11Var.d = this.G.f25958b;
                        invalidate();
                    }
                }
                lp lpVar5 = this.G;
                org.telegram.ui.ActionBar.d4 d4Var3 = (org.telegram.ui.ActionBar.d4) lpVar5.f25957a.f18621f.get(lpVar5.f25959c);
                if (this.G != null) {
                    int i24 = d4Var3.f18582k;
                    int i25 = d4Var3.f18583l;
                    int i26 = d4Var3.f18584m;
                    int i27 = d4Var3.f18585n;
                    int i28 = d4Var3.f18586o;
                    j11 = 0;
                    if (d4Var3.f18575a.k(false) != null) {
                        if (i25 != 0) {
                        ...
                        org.telegram.ui.ActionBar.i6 i6Var = d4Var3.f18575a;
                        if (i6Var != null && (i6Var.P > 0 || i6Var.f18761c != null)) {
                            org.telegram.ui.ActionBar.i6 i6Var2 = d4Var3.f18575a;
                            Bitmap scaledBitmap = AndroidUtilities.getScaledBitmap(AndroidUtilities.dp(112.0f), AndroidUtilities.dp(134.0f), i6Var2.f18761c, i6Var2.f18759b, i6Var2.P);
                            ...
                            org.telegram.ui.ActionBar.e4 e4Var3 = this.G.f25957a;
            ...
            long i29 = lpVar.f25957a.i(this.V);
            if (i29 != j11) {
                TLRPC.WallPaper k10 = lpVar.f25957a.k(this.V);
                if (k10 != null) {
                    lpVar.f25957a.p(this.V, new ei.u1(this, i29, lpVar, k10.settings.intensity));
                }
            } else {
                SparseArray sparseArray = lpVar.f25957a.j(this.V).f18758a0;
                if (sparseArray != null) {
                    h6Var = (org.telegram.ui.ActionBar.h6) sparseArray.get(((org.telegram.ui.ActionBar.d4) lpVar.f25957a.f18621f.get(this.V)).e);
                } else {
                    h6Var = null;
                }
                if (h6Var != null && (tL_theme = h6Var.f18735r) != null && tL_theme.settings.size() > 0) {
                    TLRPC.WallPaper wallPaper2 = h6Var.f18735r.settings.get(0).wallpaper;
                ...
                } else if (h6Var != null && h6Var.f18735r == null) {
                    int i30 = (int) (h6Var.f18733p * 100.0f);
                    Drawable drawable2 = lpVar.f25958b;
                    if (drawable2 instanceof cc0) {
                        cc0 cc0Var6 = (cc0) drawable2;
                        cc0Var6.t(cc0Var6.f23019u, i30);
                    }
        ...
        org.telegram.ui.ActionBar.e4 e4Var4 = this.G.f25957a;
        if (e4Var4 != null && !e4Var4.m()) {
            fg.b bVar = this.G.f25957a.f18620c;
    ...
    public final void g(boolean z10, boolean z11) {
        float f7 = 0.0f;
        if (!z11) {
            ValueAnimator valueAnimator = this.f28573y;
        ...
        if (this.W != z10) {
            float f10 = this.M;
            ValueAnimator valueAnimator2 = this.f28573y;
            ...
            this.f28573y = ofFloat;
            ofFloat.addUpdateListener(new h70(this, 27));
            this.f28573y.addListener(new aa(20, this, z10));
            this.f28573y.setDuration(250L);
            this.f28573y.start();
        }
        this.W = z10;
    }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        float f7 = this.f28566c;
        RectF rectF = this.v;
        rectF.set(f7, f7, i10 - f7, i11 - f7);
        Path path = this.f28571w;
        path.reset();
        float f10 = this.f28565b;
    ...
    public void setBackgroundColor(int i10) {
        ...
        org.telegram.ui.ActionBar.f6 f6Var = this.f28572x;
        this.f28570s.setColor(org.telegram.ui.ActionBar.j6.v0(i11, f6Var));
