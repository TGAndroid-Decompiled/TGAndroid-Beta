...
public final class h4 extends m51 {
    ...
    public final void onClick(View view) {
        ...
        switch (this.e) {
            case 0:
                ((org.telegram.ui.ActionBar.p2) this.f25310f).dismissCurrentDialog();
                super.onClick(view);
                return;
            case 1:
                xx0 xx0Var = (xx0) this.f25310f;
            ...
            case 2:
                ...
                qc.a0((uf.q) this.f25310f).k(false).j();
                return;
            case 3:
                org.telegram.ui.o70 o70Var = ((org.telegram.ui.m70) this.f25310f).d;
                ...
                return;
            case 4:
                ((org.telegram.ui.nm0) this.f25310f).f36539a.dismissCurrentDialog();
                super.onClick(view);
                return;
            default:
                StickersActivity stickersActivity = (StickersActivity) this.f25310f;
