...
public final class ry extends FrameLayout {
    public final ImageView f30114a;
    public final TextView f30115b;
    public final RadialProgressView f30116c;
    public boolean d;
    public final kz f30117e;

    public ry(kz kzVar, Context context) {
        super(context);
        this.f30117e = kzVar;
        ImageView imageView = new ImageView(getContext());
        this.f30114a = imageView;
        ...
        this.f30116c = radialProgressView;
        radialProgressView.setVisibility(8);
        radialProgressView.setProgressColor(kzVar.A(org.telegram.ui.ActionBar.j6.f20735h6));
    ...
    public final void a(boolean z10) {
        ...
        if (this.d != z10) {
            ...
            this.f30114a.setVisibility(i10);
            if (z10) {
                i11 = 8;
            } else {
                i11 = 0;
            }
            this.f30115b.setVisibility(i11);
            if (!z10) {
                i12 = 8;
            }
            this.f30116c.setVisibility(i12);
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        int dp;
        kz kzVar = this.f30117e;
        int measuredHeight = kzVar.f27948h0.getMeasuredHeight();
        if (!this.d) {
            dp = (int) (org.telegram.messenger.wl.y(8.0f, measuredHeight - kzVar.f27928b1, 3) * 1.7f);
        } else {
