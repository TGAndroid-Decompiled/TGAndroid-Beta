...
public final class ry extends FrameLayout {
    public final ImageView f28068a;
    public final TextView f28069b;
    public final RadialProgressView f28070c;
    public boolean d;
    public final kz e;
    ...
    public ry(kz kzVar, Context context) {
        ...
        this.f28070c = radialProgressView;
        radialProgressView.setVisibility(8);
        radialProgressView.setProgressColor(kzVar.z(org.telegram.ui.ActionBar.j6.f19181h6));
    ...
    public final void a(boolean z10) {
        ...
        if (this.d != z10) {
            ...
            this.f28068a.setVisibility(i10);
            if (z10) {
                i11 = 8;
            } else {
                i11 = 0;
            }
            this.f28069b.setVisibility(i11);
            if (!z10) {
                i12 = 8;
            }
            this.f28070c.setVisibility(i12);
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        int dp;
        kz kzVar = this.e;
        int measuredHeight = kzVar.f25873h0.getMeasuredHeight();
        if (!this.d) {
            dp = (int) (org.telegram.messenger.rk.z(8.0f, measuredHeight - kzVar.f25854b1, 3) * 1.7f);
        } else {
