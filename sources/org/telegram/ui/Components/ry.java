...
public final class ry extends oz {
    ...
    public final uv0 D1(int i10) {
        ...
        if (adapter == qyVar2) {
            int i11 = qyVar2.H;
            if (i10 > i11) {
                TLRPC.BotInlineResult botInlineResult = (TLRPC.BotInlineResult) qyVar2.f27790x.get((i10 - i11) - 1);
                ...
                document2 = (TLRPC.Document) lzVar.f26255i1.get(i10);
                arrayList = document2.attributes;
                return F1(document2, arrayList);
            }
        } else if (!qyVar.f27790x.isEmpty()) {
            TLRPC.BotInlineResult botInlineResult2 = (TLRPC.BotInlineResult) qyVar.f27790x.get(i10);
