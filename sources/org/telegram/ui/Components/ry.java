...
public final class ry extends FrameLayout {
    public final ImageView f30115a;
    public final TextView f30116b;
    public final RadialProgressView f30117c;
    public boolean d;
    public final kz f30118e;

    public ry(kz kzVar, Context context) {
        super(context);
        this.f30118e = kzVar;
        ImageView imageView = new ImageView(getContext());
        this.f30115a = imageView;
        ...
        this.f30117c = radialProgressView;
        radialProgressView.setVisibility(8);
        radialProgressView.setProgressColor(kzVar.A(org.telegram.ui.ActionBar.j6.f20736h6));
    ...
    public final void a(boolean z10) {
        ...
        if (this.d != z10) {
            ...
            this.f30115a.setVisibility(i10);
            if (z10) {
                i11 = 8;
            } else {
                i11 = 0;
            }
            this.f30116b.setVisibility(i11);
            if (!z10) {
                i12 = 8;
            }
            this.f30117c.setVisibility(i12);
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        int dp;
        kz kzVar = this.f30118e;
        int measuredHeight = kzVar.f27949h0.getMeasuredHeight();
        if (!this.d) {
            dp = (int) (org.telegram.messenger.vl.y(8.0f, measuredHeight - kzVar.f27929b1, 3) * 1.7f);
        } else {
