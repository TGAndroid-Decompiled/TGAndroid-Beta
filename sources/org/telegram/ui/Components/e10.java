...
public final class e10 extends Drawable {
    public final Drawable f26415a;
    public final Path f26416b;
    public boolean f26417c = true;
    public final Paint d;
    public final Paint f26418e;

    public e10(Context context, int i10, int i11) {
        this.f26415a = context.getResources().getDrawable(i10);
        if (i11 >= 0) {
            this.f26416b = new Path();
    ...
    public final void draw(Canvas canvas) {
        ...
        if (path != null) {
            ...
            canvas.drawPath(path, this.f26418e);
            canvas.restore();
            return;
        }
        drawable.setBounds(getBounds());
    ...
    public final int getIntrinsicHeight() {
        return this.f26415a.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f26415a.getIntrinsicWidth();
    }

    @Override
    public final int getOpacity() {
        return this.f26415a.getOpacity();
    }

    @Override
    public final void setAlpha(int i10) {
        this.f26415a.setAlpha(i10);
    }
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f26415a.setColorFilter(colorFilter);
    }
}
