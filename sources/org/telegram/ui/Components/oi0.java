...
public final class oi0 extends Path {
    public final org.telegram.ui.Cells.t1 f26742a;
    public final int f26743b;
    public final int f26744c;
    public final int d;
    public final boolean e;
    public final boolean f26745f;
    public final byte[] f26746g;
    public int h;
    public final Paint f26747i;
    public final uq f26748j;
    public final c6 f26749k;
    public final ArrayList f26750l;
    public final ArrayList f26751m;
    public final float f26752n;
    public final float f26753o;
    public final float f26754p;
    public ni0 f26755q;
    ...
    public oi0(final org.telegram.ui.Cells.t1 t1Var, int i10, int i11) {
        ...
        this.f26751m = new ArrayList();
        this.f26742a = t1Var;
        this.f26749k = new c6(0.0f, new Runnable() {
            @Override
    ...
    public final void a(float f7, float f10, float f11, float f12) {
        ...
        float f13 = this.f26754p;
        float max = Math.max(f13, f7);
        float max2 = Math.max(f13, f11);
        float f14 = this.f26752n;
        float f15 = max + f14;
        float f16 = this.f26753o;
        float f17 = f10 + f16;
        float f18 = max2 + f14;
        ?? obj = new Object();
        obj.f26466a = f15 - AndroidUtilities.dp(3.0f);
        obj.f26467b = f18 + AndroidUtilities.dp(3.0f);
        obj.f26468c = f17;
        obj.d = f12 + f16;
        ni0 ni0Var = this.f26755q;
        if (ni0Var != null) {
            float f19 = ni0Var.d;
            ni0Var.h = (f19 + f17) / 2.0f;
            obj.f26470g = (f19 + f17) / 2.0f;
        }
        this.f26750l.add(obj);
        this.f26755q = obj;
    }
    ...
    public final void b(Canvas canvas, float f7, float f10, Rect rect, float f11) {
        ...
        float f13;
        int i10 = 0;
        float d = this.f26749k.d(1.0f, false);
        canvas.save();
        boolean z10 = this.f26745f;
        Paint paint = this.f26747i;
        org.telegram.ui.Cells.t1 t1Var = this.f26742a;
        uq uqVar = this.f26748j;
        if (z10) {
            ...
            uqVar.rewind();
            while (true) {
                ArrayList arrayList = this.f26750l;
                if (i10 >= arrayList.size()) {
                    break;
                }
                ni0 ni0Var = (ni0) arrayList.get(i10);
                float lerp3 = AndroidUtilities.lerp(rect.left - f7, ni0Var.f26466a, d);
                if (ni0Var.e) {
                    f12 = rect.top - f10;
                } else {
                    f12 = ni0Var.f26470g;
                }
                float lerp4 = AndroidUtilities.lerp(f12, ni0Var.f26468c, d);
                float lerp5 = AndroidUtilities.lerp(rect.right - f7, ni0Var.f26467b, d);
                if (ni0Var.f26469f) {
                    f13 = rect.bottom - f10;
                } else {
                    f13 = ni0Var.h;
    ...
    public oi0(org.telegram.ui.Cells.t1 t1Var, ViewParent viewParent, int i10, ArrayList arrayList, int i11, int i12, float f7) {
        ...
        this.f26751m = new ArrayList();
        this.f26742a = null;
        this.f26749k = new c6(0.0f, new ny(21, t1Var, viewParent), 350L, 420L, qr.h);
        this.f26743b = i10;
        this.f26744c = i14;
        this.d = i12;
        int i15 = 0;
        ...
        while (i16 < arrayList2.size()) {
            ...
            if (textLayoutBlock != 0 && i14 <= textLayoutBlock.charactersEnd && i12 >= (i13 = textLayoutBlock.charactersOffset)) {
                ...
                if (textLayoutBlock.code && !textLayoutBlock.quote) {
                    this.f26752n = f10 + AndroidUtilities.dp(10.0f);
                }
                this.f26753o = textLayoutBlock.textYOffset(arrayList2) + textLayoutBlock.padTop;
                this.f26754p = textLayoutBlock.quote ? AndroidUtilities.dp(10.0f) : 0.0f;
                ...
                if (textLayoutBlock.quoteCollapse && textLayoutBlock.collapsed()) {
                    this.f26751m.add(Integer.valueOf(textLayoutBlock.index));
                }
            }
            i16++;
        ...
        if (this.f26750l.size() > 0) {
            ni0 ni0Var = (ni0) this.f26750l.get(0);
            ni0 ni0Var2 = (ni0) hg.k0.h(1, this.f26750l);
            ni0Var.e = true;
            ni0Var.f26468c -= AndroidUtilities.dp(0.66f);
            ni0Var2.f26469f = true;
