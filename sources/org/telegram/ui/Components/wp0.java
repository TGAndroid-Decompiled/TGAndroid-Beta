...
public final class wp0 extends qv0 {
    ...
    public final z5 D0;
    public final lq0 E0;
    public boolean f30399t0;
    public final RectF f30400u0;
    ...
    public wp0(lq0 lq0Var, Context context) {
        ...
        this.E0 = lq0Var;
        this.f30399t0 = false;
        this.f30400u0 = new RectF();
        this.E = new vp0(this, this);
        this.C0 = AndroidUtilities.computePerceivedBrightness(lq0Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19977h5)) > 0.721f;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        canvas.save();
        canvas.clipRect(0.0f, getPaddingTop() + lq0Var.f26861q0, getMeasuredWidth(), getMeasuredHeight() + lq0Var.f26861q0 + AndroidUtilities.dp(50.0f));
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        if (view instanceof kz) {
            ...
            if (lq0Var.S0 != null) {
                ...
                canvas.clipPath(lq0Var.S0.h.f41210k);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        FrameLayout frameLayout = lq0Var.f26869w;
        canvas.translate(0.0f, lq0Var.f26861q0);
        int i17 = lq0Var.m0;
        i10 = ((org.telegram.ui.ActionBar.g3) lq0Var).backgroundPaddingTop;
        int dp2 = AndroidUtilities.dp(6.0f) + (i17 - i10) + this.f30402w0;
        int i18 = lq0Var.m0;
        i11 = ((org.telegram.ui.ActionBar.g3) lq0Var).backgroundPaddingTop;
        int dp3 = ((i18 - i11) - AndroidUtilities.dp(13.0f)) + this.f30402w0;
        lq0Var.U = dp3;
        ...
        boolean z12 = true;
        if (!z4) {
            dp2 += lq0Var.D0.f7214b;
            if (this.f30401v0) {
                i16 = ((org.telegram.ui.ActionBar.g3) lq0Var).backgroundPaddingTop;
                if (i16 + dp3 < lq0Var.D0.f7214b) {
                    z11 = true;
                    int i20 = dp3 + lq0Var.D0.f7214b;
        ...
        if (frameLayout != null) {
            if (dp3 > lq0Var.D0.f7214b || frameLayout.getChildCount() <= 0) {
        ...
        if (f10 < 1.0f) {
            ...
            RectF rectF = this.f30400u0;
            rectF.set((getMeasuredWidth() - dp) / 2, f11, measuredWidth, dp5);
            org.telegram.ui.ActionBar.j6.f20185t0.setColor(lq0Var.getThemedColor(org.telegram.ui.ActionBar.j6.Ii));
            org.telegram.ui.ActionBar.j6.f20185t0.setAlpha((int) ((1.0f - f10) * paint.getAlpha()));
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            if (this.C0 && 0 > lq0Var.D0.f7214b * 0.5f) {
                z10 = true;
            } else {
                z10 = false;
            }
        ...
        canvas.restore();
        this.f30403x0 = this.f30402w0;
    }

    @Override
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        boolean z4 = this.f30401v0;
        lq0 lq0Var = this.E0;
        if (!z4) {
            if (motionEvent.getAction() == 0 && motionEvent.getY() < this.f30402w0 - AndroidUtilities.dp(30.0f)) {
                lq0Var.dismiss();
                return true;
            }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        FrameLayout frameLayout2 = lq0Var.f26862r;
        pp0 pp0Var = lq0Var.d;
        int i27 = size2 - (i16 * 2);
        int R = wp0Var.R();
        lq0Var.K0 = R;
            ...
            if (childAt != null && childAt.getVisibility() != i17) {
                if (pp0Var.l(childAt)) {
                    if (!AndroidUtilities.isInMultiwindow && !AndroidUtilities.isTablet()) {
                        ...
                        childAt.measure(View.MeasureSpec.makeMeasureSpec(i27, 1073741824), View.MeasureSpec.makeMeasureSpec(Math.min(AndroidUtilities.dp(200.0f), wp0Var.getPaddingTop() + (i29 - lq0Var.D0.f7214b)), 1073741824));
                    } else {
                        childAt.measure(View.MeasureSpec.makeMeasureSpec(i27, 1073741824), View.MeasureSpec.makeMeasureSpec(wp0Var.getPaddingTop() + (i29 - lq0Var.D0.f7214b), 1073741824));
                    }
                } else {
