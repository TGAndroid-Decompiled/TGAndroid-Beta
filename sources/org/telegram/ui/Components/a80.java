...
public final class a80 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        int i10;
        f80 f80Var = this.f22560a;
        Drawable drawable = f80Var.f24048b;
        int i11 = f80Var.f24052r;
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            f80 f80Var = this.f22560a;
            if (f80Var.f24052r != 0 && motionEvent.getY() < f80Var.f24052r) {
                f80Var.dismiss();
                return true;
            }
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        f80 f80Var = this.f22560a;
        TextView textView = f80Var.f24050f;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (!this.f22560a.isDismissed() && super.onTouchEvent(motionEvent)) {
            return true;
        }
        return false;
    }
