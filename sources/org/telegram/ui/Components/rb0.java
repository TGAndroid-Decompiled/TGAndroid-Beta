...
public final class rb0 extends Drawable {
    ...
    public rb0(int i10) {
        ...
        switch (i10) {
            case 1:
                this.f30006c = new Paint(1);
                Paint paint = new Paint(1);
                this.d = paint;
                this.f30007e = new Matrix();
    ...
    public void b(int i10, int i11) {
        ((Paint) this.f30006c).setShader(new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.dp(28.0f), new int[]{i10, i11}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP));
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        switch (this.f30004a) {
            case 0:
                ...
                if (((xi0) this.f30007e).y()) {
                    xi0 xi0Var4 = (xi0) this.f30007e;
                    ...
                    if (xi0Var4 != xi0Var) {
                        ...
                        this.f30007e = xi0Var2;
                        xi0Var2.K(xi0Var2.f32557e[0] - 1);
                    }
                }
                ((xi0) this.f30007e).setBounds(rect);
                ((xi0) this.f30007e).draw(canvas);
                return;
            default:
                ...
                rectF.set(getBounds());
                Matrix matrix = (Matrix) this.f30007e;
                matrix.reset();
                matrix.postTranslate(rectF.left, rectF.top);
                canvas.drawRoundRect(rectF, dp, dp, (Paint) this.f30006c);
                if (this.f30005b) {
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        switch (this.f30004a) {
            case 0:
                ((xi0) this.f30006c).setColorFilter(colorFilter);
