...
public final class rb0 extends org.telegram.ui.Cells.r9 {
    ...
    public rb0(zb0 zb0Var) {
        this.B0 = zb0Var;
        this.f20167h0 = zb0Var.f30839c0.F;
    }

    @Override
    public final boolean A(MessageObject messageObject) {
        zb0 zb0Var = this.B0;
        if (zb0Var.f30834a == 0 && !zb0Var.f30839c0.d.isSecret && y()) {
            return true;
        }
        return false;
    }
    ...
    public final void J(int i10, int i11, MessageObject messageObject) {
        ...
        zb0 zb0Var = this.B0;
        rb0 rb0Var = zb0Var.e;
        int i12 = rb0Var.v - rb0Var.f20191u;
        fc0 fc0Var = zb0Var.f30839c0;
        if (i12 > MessagesController.getInstance(fc0Var.f24146w).quoteLengthMax) {
            zb0Var.f();
            return;
        }
        ...
        if (c10 != null && ((mnVar = fc0Var.d.quote) == null || (messageObject2 = mnVar.f35624a) == null || messageObject2.getId() != c10.getId())) {
    ...
    public final boolean b() {
        ...
        zb0 zb0Var = this.B0;
        if (zb0Var.f30834a == 0 && (c10 = zb0Var.c(null)) != null && (message = c10.messageOwner) != null && message.rich_message != null) {
            return false;
        }
    ...
    public final boolean e() {
        ...
        TLRPC.Message message;
        zb0 zb0Var = this.B0;
        int i10 = zb0Var.f30834a;
        if (i10 == 0 && !zb0Var.f30839c0.d.isSecret) {
