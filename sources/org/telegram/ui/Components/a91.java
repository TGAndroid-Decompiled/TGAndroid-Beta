...
public final class a91 extends View {
    ...
    public float I;
    public final org.telegram.ui.ActionBar.f6 f22570a;
    ...
    public int h;
    public int f22574n;
    public final RectF f22575r;
    public boolean f22576s;
    public final Canvas v;
    public final Bitmap f22577w;
    public float f22578x;
    public ObjectAnimator f22579y;
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        if (z11) {
            ...
            this.f22579y = ofFloat;
            ofFloat.setDuration(300L);
            this.f22579y.start();
            return;
        }
        ObjectAnimator objectAnimator = this.f22579y;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        RectF rectF = this.f22575r;
        rectF.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
        View view = this.E;
        org.telegram.ui.ActionBar.f6 f6Var = this.f22570a;
        ...
        canvas2.drawText(this.f22573f, AndroidUtilities.dp(28.0f) + z10, AndroidUtilities.dp(21.0f), textPaint);
        canvas2.save();
        canvas2.translate(z10, AndroidUtilities.dp(7.0f));
        Bitmap bitmap = this.f22577w;
        int i11 = 0;
        Paint paint3 = this.e;
        if (bitmap != null) {
            float f12 = this.f22578x;
            if (f12 <= 0.5f) {
                f7 = f12 / 0.5f;
                f10 = f7;
            } else {
            ...
            if (f10 != 1.0f) {
                ...
                canvas3.drawRoundRect(rectF, rectF.width() / 2.0f, rectF.height() / 2.0f, this.f22571b);
            }
            if (this.f22578x > 0.5f) {
                Paint paint4 = this.f22572c;
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(org.telegram.messenger.rk.C(56.0f, this.f22574n, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(32.0f), 1073741824));
    }
