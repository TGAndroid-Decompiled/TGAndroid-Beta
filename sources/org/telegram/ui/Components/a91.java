...
public final class a91 implements SensorEventListener {
    public final float[] f22576a = new float[3];
    public final float[] f22577b = new float[3];
    public int f22578c;
    public final WindowManager d;
    public final SensorManager e;
    public final Sensor f22579f;
    public boolean h;
    public z81 f22580n;
    ...
    public a91(Context context) {
        ...
        this.f22579f = sensorManager.getDefaultSensor(1);
    }
