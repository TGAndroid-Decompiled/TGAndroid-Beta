...
public final class yy0 extends View {
    ...
    public Drawable f30686b;
    public boolean f30687c;
    public int d;
    public final e6 e;
    public final zy0 f30688f;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f30686b != null) {
            ...
            this.f30686b.setBounds(getPaddingLeft(), getPaddingTop(), getWidth() - getPaddingRight(), getHeight() - getPaddingBottom());
            canvas.scale(d, d, getWidth() / 2, (getPaddingTop() + height) / 2);
            Drawable drawable = this.f30686b;
            if (drawable instanceof q5) {
                ((q5) drawable).q(System.currentTimeMillis());
            }
            this.f30686b.draw(canvas);
        }
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        Drawable drawable2 = this.f30686b;
        if (drawable2 instanceof q5) {
            ((q5) drawable2).o(this);
        }
        this.f30686b = drawable;
        if ((drawable instanceof q5) && this.f30687c) {
            ((q5) drawable).a(this);
        }
    }
