...
public class yy0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public float f30728a0;
    public final org.telegram.ui.ActionBar.d6 f30729b;
    public e6 f30730b0;
    public wy0 f30731c;
    public e6 f30732c0;
    public ai.f0 d;
    ...
    public boolean v;
    public ArrayList f30738w;
    public boolean f30739x;
    public boolean f30740y;

    public yy0(Context context, int i10, org.telegram.ui.jk jkVar, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.h = 0;
        this.f30735n = AndroidUtilities.dp(10.0f);
        this.L = 0L;
        this.f30727a = i10;
        this.f30731c = jkVar;
        this.f30729b = d6Var;
    ...
    public static boolean a(yy0 yy0Var, j jVar, MotionEvent motionEvent) {
        return org.telegram.ui.nt.q().s(motionEvent, yy0Var.e, jVar, yy0Var.getPreviewDelegate(), yy0Var.f30729b);
    }

    public org.telegram.ui.lt getPreviewDelegate() {
        if (this.f30736r == null) {
            this.f30736r = new ty0(this);
        }
        return this.f30736r;
    }
    ...
    public final void c() {
        if (this.e == null) {
            ...
            this.f30730b0 = new e6(this.d, 200L, srVar);
            this.f30732c0 = new e6(this.d, 350L, srVar);
            this.f30733d0 = new e6(this.d, 350L, srVar);
            ...
            this.e.setSelectorDrawableColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19148i6, this.f30729b));
            uy0 uy0Var2 = this.e;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.newEmojiSuggestionsAvailable) {
            ArrayList arrayList = this.f30738w;
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        float f7 = this.f30733d0.f23850c;
        float f10 = this.f30732c0.f23850c;
        ...
        if (this.f30737s && rectF.contains(motionEvent.getX(), motionEvent.getY())) {
            return super.dispatchTouchEvent(motionEvent);
        }
    ...
    public final void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f30727a).addObserver(this, NotificationCenter.newEmojiSuggestionsAvailable);
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        NotificationCenter.getInstance(this.f30727a).removeObserver(this, NotificationCenter.newEmojiSuggestionsAvailable);
    }
