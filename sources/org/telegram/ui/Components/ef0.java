...
public final class ef0 extends View {
    public Paint f23835a;
    public Paint f23836b;
    public int f23837c;
    public int d;
    public float e;
    ...
    public final void a(int i10, boolean z10) {
        ...
        if (i10 < i11) {
            ...
            int i12 = this.f23839n;
            if (i10 > i12) {
                i10 = i12;
            }
        }
        this.e = (i10 - i11) / (this.f23839n - i11);
        invalidate();
        if (z10 && (df0Var = this.f23840r) != null) {
    ...
    public int getProgress() {
        int i10 = this.h;
        return (int) ((this.e * (this.f23839n - i10)) + i10);
    }

    @Override
    public final void onDraw(Canvas canvas) {
        int i10;
        Paint paint = this.f23836b;
        int measuredHeight = getMeasuredHeight();
        int i11 = this.f23837c;
        int i12 = (measuredHeight - i11) / 2;
        int measuredWidth = (int) ((getMeasuredWidth() - i11) * this.e);
        float f7 = i11 / 2;
        canvas.drawRect(f7, (getMeasuredHeight() / 2) - AndroidUtilities.dp(1.0f), getMeasuredWidth() - i10, AndroidUtilities.dp(1.0f) + (getMeasuredHeight() / 2), this.f23835a);
        if (this.h == 0) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent != null) {
            ...
            if (motionEvent.getAction() == 0) {
                ...
                if (motionEvent.getAction() == 2 && this.f23838f) {
