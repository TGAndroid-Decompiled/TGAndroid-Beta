...
public final class ef0 extends FrameLayout {
    ...
    public final bf0 F;
    public df0 f23947a;
    public final lg.p f23948b;
    public final lg.f f23949c;
    public final boolean d;
    public final ImageReceiver e;
    public boolean f23950f;
    public boolean h;
    public float f23951n;
    public float f23952r;
    public AnimatorSet f23953s;
    public AnimatorSet v;
    public float f23954w;
    public final Paint f23955x;
    public final org.telegram.ui.ActionBar.d6 f23956y;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (this.f23950f && view == (pVar = this.f23948b)) {
            RectF actualRect = pVar.getActualRect();
            int dp = AndroidUtilities.dp(32.0f);
            org.telegram.ui.ls0 ls0Var = (org.telegram.ui.ls0) this.f23947a;
            ls0Var.getClass();
            PhotoViewer photoViewer = ls0Var.f35410a;
            float measuredWidth = (photoViewer.S7.getMeasuredWidth() - AndroidUtilities.dp(32.0f)) * photoViewer.f31391w8;
            int i10 = dp / 2;
            int dp2 = AndroidUtilities.dp(2.0f) + (((int) (measuredWidth + AndroidUtilities.dp(16.0f))) - i10);
            int measuredHeight = getMeasuredHeight() - AndroidUtilities.dp(156.0f);
            float f7 = actualRect.left;
            float f10 = this.f23952r;
            ...
            float width = ((dp - actualRect.width()) * this.f23952r) + actualRect.width();
            ImageReceiver imageReceiver = this.e;
            imageReceiver.setRoundRadius((int) (width / 2.0f));
            imageReceiver.setImageCoords(f11, z10, width, width);
            imageReceiver.setAlpha(this.f23951n);
            imageReceiver.draw(canvas);
            float f13 = this.f23954w;
            Paint paint = this.f23955x;
            if (f13 > 0.0f) {
                paint.setColor(-1);
                paint.setAlpha((int) (this.f23954w * 255.0f));
                canvas.drawCircle(actualRect.centerX(), actualRect.centerY(), actualRect.width() / 2.0f, paint);
            }
            paint.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19471zf, this.f23956y));
            paint.setAlpha(Math.min(255, (int) (this.f23952r * 255.0f * this.f23951n)));
    ...
    public float getRectSizeX() {
        return this.f23948b.getCropWidth();
    }

    public float getRectSizeY() {
        return this.f23948b.getCropHeight();
    }

    public float getRectX() {
        return this.f23948b.getCropLeft() - AndroidUtilities.dp(14.0f);
    }

    public float getRectY() {
        int i10;
        float cropTop = this.f23948b.getCropTop() - AndroidUtilities.dp(14.0f);
        if (!this.d) {
    ...
    public final void invalidate() {
        super.invalidate();
        this.f23948b.invalidate();
    }

    @Override
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (this.h && this.f23950f) {
            if (this.e.isInsideImage(motionEvent.getX(), motionEvent.getY())) {
                if (motionEvent.getAction() == 1) {
                    ((org.telegram.ui.ls0) this.f23947a).f();
                }
                return true;
            }
        }
    ...
    public void setAspectRatio(float f7) {
        this.f23948b.setAspectRatio(f7);
    }
    ...
    public void setFreeform(boolean z10) {
        this.f23948b.setFreeform(z10);
    }

    public void setSubtitle(String str) {
        this.f23948b.setSubtitle(str);
    }
