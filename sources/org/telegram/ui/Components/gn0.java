...
public final class gn0 extends View {
    public fn0 f26462a;
    public final e6 f26463b;
    public final dh.d f26464c;
    public ah.j1 d;
    public boolean f26465e;
    public final Path f26466f;
    public final RectF h;
    public final RectF f26467n;
    public boolean f26468r;
    public final hn0 f26469s;

    public gn0(hn0 hn0Var, Context context) {
        super(context);
        this.f26469s = hn0Var;
        this.f26463b = new e6(this, 0L, 260L, pr.h);
        this.f26466f = new Path();
        this.h = new RectF();
        this.f26467n = new RectF();
        w7.z5.a(this);
        bh.b bVar = hn0Var.v;
        if (bVar != null) {
            dh.d c10 = bVar.c(this, null, false);
            c10.n(hn0Var.f26771w);
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        this.f26465e = z10;
        fn0 fn0Var = this.f26462a;
        if (fn0Var != null) {
            fn0Var.f572p = z10;
            e6 e6Var = this.f26463b;
            if (z11) {
    ...
    public final void onDraw(Canvas canvas) {
        int i10;
        hn0 hn0Var = this.f26469s;
        Paint paint = hn0Var.f26772x;
        int width = (getWidth() - this.f26462a.A) / 2;
        int height = getHeight();
        fn0 fn0Var = this.f26462a;
        int i11 = fn0Var.B;
        int i12 = (height - i11) / 2;
        dh.d dVar = this.f26464c;
        if (dVar != null) {
            Rect rect = AndroidUtilities.rectTmp2;
            rect.set(width, i12, fn0Var.A + width, i11 + i12);
            RectF rectF = this.f26467n;
            rectF.set(rect);
            RectF rectF2 = this.h;
            boolean equals = rectF.equals(rectF2);
            Path path = this.f26466f;
            if (!equals) {
                rectF2.set(rectF);
            ...
            dVar.draw(canvas);
            org.telegram.ui.ActionBar.f6 f6Var = hn0Var.f26765c;
        ...
        this.f26462a.d(canvas, width, i12, this.f26463b.d(1.0f, false), 1.0f, false, false, 0.0f);
    }
