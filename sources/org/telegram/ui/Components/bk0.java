...
public final class bk0 extends FrameLayout {
    ...
    public final RectF f23007b;
    public final float f23008c;
    public final w9 d;
    public final ImageView e;
    public final TextView f23009f;
    public final View h;
    public float f23010n;
    public final Drawable f23011r;
    public int f23012s;
    public zg.o0 v;
    ...
    public bk0(Context context) {
        ...
        this.f23006a = new Paint(1);
        new Path();
        this.f23007b = new RectF();
        this.f23008c = AndroidUtilities.dp(32.0f);
        ...
        this.f23009f = textView;
        textView.setImportantForAccessibility(2);
        textView.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19231n8, false));
        textView.setTypeface(AndroidUtilities.bold());
        addView(textView, w7.y5.i(-1.0f, -2.0f, 8388627, 40.0f, 0.0f, 8.0f, 0.0f));
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth(AndroidUtilities.dp(1.0f));
        setWillNotDraw(false);
        setOutlineProgress(this.f23010n);
    }
    ...
    public final void a(int i10, TLRPC.ReactionCount reactionCount) {
        ...
        this.f23009f.setText(formatShortNumber);
        zg.o0 d = zg.o0.d(reactionCount.reaction);
        this.v = d;
        String str = d.f49385f;
        ImageView imageView = this.e;
        w9 w9Var = this.d;
        if (str != null) {
            for (TLRPC.TL_availableReaction tL_availableReaction : MediaDataController.getInstance(i10).getReactionsList()) {
                if (tL_availableReaction.reaction.equals(this.v.f49385f)) {
                    w9Var.i(ImageLocation.getForDocument(tL_availableReaction.center_icon), "40_40_lastreactframe", "webp", DocumentObject.getSvgThumb(tL_availableReaction.static_icon, org.telegram.ui.ActionBar.h6.f18989a7, 1.0f), tL_availableReaction);
        ...
        w9Var.setAnimatedEmojiDrawable(new q5(0, i10, this.v.f49386g));
        w9Var.setVisibility(0);
        imageView.setVisibility(8);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        RectF rectF = this.f23007b;
        rectF.set(0.0f, 0.0f, getWidth(), getHeight());
        float f7 = this.f23008c;
        canvas.drawRoundRect(rectF, f7, f7, this.f23006a);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f23010n > 0.5d) {
            accessibilityNodeInfo.setSelected(true);
        }
        zg.o0 o0Var = this.v;
        if (o0Var != null) {
            accessibilityNodeInfo.setText(LocaleController.formatPluralString("AccDescrNumberOfPeopleReactions", this.f23012s, o0Var));
        } else {
            accessibilityNodeInfo.setText(LocaleController.formatPluralString("ReactionsCount", this.f23012s, new Object[0]));
        }
    }
    ...
    public void setOutlineProgress(float f7) {
        ...
        this.f23006a.setColor(i0.a.d(f7, k10, w02));
        this.f23009f.setTextColor(d);
        this.f23011r.setColorFilter(new PorterDuffColorFilter(d, PorterDuff.Mode.MULTIPLY));
        float f10 = this.f23008c;
        View view = this.h;
        if (f7 == 1.0f) {
            int i12 = (int) f10;
