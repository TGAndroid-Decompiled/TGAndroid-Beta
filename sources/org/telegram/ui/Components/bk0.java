...
public final class bk0 extends FrameLayout {
    public final Paint f23032a;
    public final RectF f23033b;
    ...
    public bk0(Context context) {
        ...
        this.f23032a = new Paint(1);
        new Path();
        this.f23033b = new RectF();
        this.f23034c = AndroidUtilities.dp(32.0f);
        ...
        setOutlineProgress(this.f23036n);
    }
    ...
    public final void a(int i10, TLRPC.ReactionCount reactionCount) {
        ...
        this.f23035f.setText(formatShortNumber);
    ...
    public final void dispatchDraw(Canvas canvas) {
        RectF rectF = this.f23033b;
        rectF.set(0.0f, 0.0f, getWidth(), getHeight());
        float f7 = this.f23034c;
        canvas.drawRoundRect(rectF, f7, f7, this.f23032a);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f23036n > 0.5d) {
            accessibilityNodeInfo.setSelected(true);
        }
        zg.o0 o0Var = this.v;
        if (o0Var != null) {
            accessibilityNodeInfo.setText(LocaleController.formatPluralString("AccDescrNumberOfPeopleReactions", this.f23038s, o0Var));
        } else {
            accessibilityNodeInfo.setText(LocaleController.formatPluralString("ReactionsCount", this.f23038s, new Object[0]));
        }
    }
    ...
    public void setOutlineProgress(float f7) {
        ...
        this.f23032a.setColor(i0.a.d(f7, k10, w02));
        this.f23035f.setTextColor(d);
        this.f23037r.setColorFilter(new PorterDuffColorFilter(d, PorterDuff.Mode.MULTIPLY));
        float f10 = this.f23034c;
        View view = this.h;
        if (f7 == 1.0f) {
            int i12 = (int) f10;
