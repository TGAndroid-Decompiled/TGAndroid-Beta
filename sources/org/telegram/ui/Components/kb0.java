    ...
    public void a(RecyclerView recyclerView, int i10) {
        ...
        switch (i11) {
            ...
            case 3:
                ...
                if (i10 == 0) {
                    if (ll0Var.f25978v2) {
                        ll0Var.f25978v2 = false;
                        NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.startAllHeavyOperations, 512);
                    }
                } else if (!ll0Var.f25978v2 && ll0Var.f25981x1) {
                    ll0Var.f25978v2 = true;
            ...
            case 8:
                ...
                if (i10 == 0 && o61Var.G && AndroidUtilities.dp(13.0f) + o61.m(o61Var) + o61Var.f26712y < AndroidUtilities.statusBarHeight * 2 && w0Var.canScrollVertically(1) && (vk0Var = (vk0) w0Var.K(0)) != null) {
                    View view3 = vk0Var.f42675a;
                    if (view3.getTop() > 0) {
            ...
            case 12:
                ...
                if (i10 == 1) {
                    s0Var2.f42408d3 = true;
                }
                if (i10 == 0) {
                    for (int i12 = 0; i12 < recyclerView.getChildCount(); i12++) {
                        rg.n1 n1Var2 = (rg.n1) s0Var2.getChildAt(i12);
                        if (n1Var == null || n1Var2.f42394a > n1Var.f42394a) {
                            n1Var = n1Var2;
                        }
                    }
                    if (n1Var != null) {
                ...
                AndroidUtilities.cancelRunOnUIThread(s0Var2.f42409e3);
                return;
            case 13:
                if (i10 == 1) {
