    ...
    public void a(RecyclerView recyclerView, int i10) {
        ...
        switch (i11) {
            ...
            case 4:
                ...
                if (i10 == 0) {
                    if (ml0Var.f26203v2) {
                        ml0Var.f26203v2 = false;
                        NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.startAllHeavyOperations, 512);
                    }
                } else if (!ml0Var.f26203v2 && ml0Var.f26206x1) {
                    ml0Var.f26203v2 = true;
            ...
            case 9:
                ...
                if (i10 == 0 && p61Var.G && AndroidUtilities.dp(13.0f) + p61.m(p61Var) + p61Var.f26946y < AndroidUtilities.statusBarHeight * 2 && w0Var.canScrollVertically(1) && (wk0Var = (wk0) w0Var.L(0)) != null) {
                    View view3 = wk0Var.f42697a;
                    if (view3.getTop() > 0) {
            ...
            case 13:
                ...
                if (i10 == 1) {
                    s0Var2.f42430d3 = true;
                }
                if (i10 == 0) {
                    for (int i12 = 0; i12 < recyclerView.getChildCount(); i12++) {
                        rg.n1 n1Var2 = (rg.n1) s0Var2.getChildAt(i12);
                        if (n1Var == null || n1Var2.f42416a > n1Var.f42416a) {
                            n1Var = n1Var2;
                        }
                    }
                    if (n1Var != null) {
                ...
                AndroidUtilities.cancelRunOnUIThread(s0Var2.f42431e3);
                return;
            case 14:
                if (i10 == 1) {
