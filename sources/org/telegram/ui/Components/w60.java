...
public final class w60 implements f90 {
    ...
    @Override
    public final void c() {
        c70 c70Var = this.f29904a.f30271c;
        ...
        if (m2Var instanceof org.telegram.ui.sh0) {
            ...
            org.telegram.ui.rb0 rb0Var = new org.telegram.ui.rb0(1, sh0Var.f37784n);
            rb0Var.T = sh0Var.f37792s0;
            rb0Var.Y(tL_chatInviteExported);
            sh0Var.presentFragment(rb0Var);
        } else {
            org.telegram.ui.rb0 rb0Var2 = new org.telegram.ui.rb0(1, c70Var.f23263g0);
            rb0Var2.Y(c70Var.f23255b);
    ...
    public final void e() {
        ...
        org.telegram.ui.ActionBar.m2 m2Var = c70Var.U;
        if (m2Var instanceof org.telegram.ui.sh0) {
            ((org.telegram.ui.sh0) m2Var).e0(c70Var.f23255b);
        } else {
            TLRPC.TL_messages_editExportedChatInvite tL_messages_editExportedChatInvite = new TLRPC.TL_messages_editExportedChatInvite();
            tL_messages_editExportedChatInvite.link = c70Var.f23255b.link;
            tL_messages_editExportedChatInvite.revoked = true;
            i10 = ((org.telegram.ui.ActionBar.e3) c70Var).currentAccount;
            tL_messages_editExportedChatInvite.peer = MessagesController.getInstance(i10).getInputPeer(-c70Var.f23263g0);
    ...
    public final void k() {
        ...
        org.telegram.ui.ActionBar.m2 m2Var = c70Var.U;
        if (m2Var instanceof org.telegram.ui.sh0) {
            ((org.telegram.ui.sh0) m2Var).b0(c70Var.f23255b);
        } else {
            TLRPC.TL_messages_deleteExportedChatInvite tL_messages_deleteExportedChatInvite = new TLRPC.TL_messages_deleteExportedChatInvite();
            tL_messages_deleteExportedChatInvite.link = c70Var.f23255b.link;
            i10 = ((org.telegram.ui.ActionBar.e3) c70Var).currentAccount;
            tL_messages_deleteExportedChatInvite.peer = MessagesController.getInstance(i10).getInputPeer(-c70Var.f23263g0);
            i11 = ((org.telegram.ui.ActionBar.e3) c70Var).currentAccount;
