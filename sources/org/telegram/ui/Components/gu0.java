...
public final class gu0 extends vl0 {
    ...
    public po0 e;
    public int f24494n;
    public final int f24495r;
    public int f24496s;
    public final kv0 v;
    public ArrayList d = new ArrayList();
    public ArrayList f24493f = new ArrayList();
    public int h = 0;
    ...
    public final boolean D(s4.c1 c1Var) {
        if (this.f24493f.size() + this.d.size() != 0) {
            return true;
        }
        return false;
    }
    ...
    public final MessageObject E(int i10) {
        ...
        return (MessageObject) this.f24493f.get(i10 - this.d.size());
    }

    public final void F(final int i10, final String str, long j3, long j10) {
        org.telegram.ui.ActionBar.n2 n2Var = this.v.f25848v1;
                    ...
                    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                        ...
                        if (tL_error == null) {
                            ...
                            for (int i13 = 0; i13 < messages_messages.messages.size(); i13++) {
                                ...
                                int i14 = i10;
                                if (i14 == 0 || message.f18317id <= i14) {
                                    arrayList.add(new MessageObject(gu0Var.v.f25848v1.getCurrentAccount(), message, false, true));
                                }
                            }
                        }
    ...
    public final void G(String str, boolean z10) {
        ...
        if (!this.d.isEmpty() || !this.f24493f.isEmpty()) {
            this.d.clear();
            this.f24493f.clear();
            l();
        }
        ...
        kv0 kv0Var = this.v;
        if (isEmpty) {
            if (!this.d.isEmpty() || !this.f24493f.isEmpty() || this.f24496s != 0) {
                this.d.clear();
                this.f24493f.clear();
                if (this.h != 0) {
                    kv0Var.f25848v1.getConnectionsManager().cancelRequest(this.h, true);
                    this.h = 0;
                    this.f24496s--;
                    return;
                }
        ...
        while (true) {
            ...
            if (i10 < du0VarArr.length) {
                ...
                if (du0Var.F == this.f24495r) {
                    du0Var.f23687w.e(true, z10);
                }
                i10++;
            } else {
