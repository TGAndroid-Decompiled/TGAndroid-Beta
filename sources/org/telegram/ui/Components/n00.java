...
public final class n00 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    public static final int f26520w = 0;
    public final ai.w0 f26521b;
    public final m00 f26522c;
    public final TextView d;
    public AnimatorSet e;
    public final View f26523f;
    public int h;
    public boolean f26524n;
    public org.telegram.ui.fu f26525r;
    public final ArrayList f26526s;
    ...
    public n00(org.telegram.ui.uy uyVar, ArrayList arrayList) {
        ...
        fixNavigationBar();
        this.v = arrayList;
        this.f26526s = new ArrayList(uyVar.getMessagesController().dialogFilters);
        int i10 = 0;
        while (i10 < this.f26526s.size()) {
            if (((MessagesController.DialogFilter) this.f26526s.get(i10)).isDefault()) {
                this.f26526s.remove(i10);
                i10--;
            }
            i10++;
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.emojiLoaded) {
            AndroidUtilities.forEachViews((RecyclerView) this.f26521b, (e2.h) new ai.i(23));
        }
    }
