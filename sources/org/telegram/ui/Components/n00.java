...
public final class n00 extends org.telegram.ui.ActionBar.g3 implements NotificationCenter.NotificationCenterDelegate {
    public static final int f26294w = 0;
    public final ai.w0 f26295b;
    public final m00 f26296c;
    public final TextView d;
    public AnimatorSet e;
    public final View f26297f;
    public int h;
    public boolean f26298n;
    public org.telegram.ui.gu f26299r;
    public final ArrayList f26300s;
    ...
    public n00(org.telegram.ui.wy wyVar, ArrayList arrayList) {
        ...
        fixNavigationBar();
        this.v = arrayList;
        this.f26300s = new ArrayList(wyVar.getMessagesController().dialogFilters);
        int i10 = 0;
        while (i10 < this.f26300s.size()) {
            if (((MessagesController.DialogFilter) this.f26300s.get(i10)).isDefault()) {
                this.f26300s.remove(i10);
                i10--;
            }
            i10++;
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.emojiLoaded) {
            AndroidUtilities.forEachViews((RecyclerView) this.f26295b, (e2.h) new ai.i(23));
        }
    }
