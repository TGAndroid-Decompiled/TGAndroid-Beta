...
public final class n00 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    public static final int f26572w = 0;
    public final ai.w0 f26573b;
    public final m00 f26574c;
    public final TextView d;
    public AnimatorSet e;
    public final View f26575f;
    public int h;
    public boolean f26576n;
    public org.telegram.ui.fu f26577r;
    public final ArrayList f26578s;
    ...
    public n00(org.telegram.ui.uy uyVar, ArrayList arrayList) {
        ...
        fixNavigationBar();
        this.v = arrayList;
        this.f26578s = new ArrayList(uyVar.getMessagesController().dialogFilters);
        int i10 = 0;
        while (i10 < this.f26578s.size()) {
            if (((MessagesController.DialogFilter) this.f26578s.get(i10)).isDefault()) {
                this.f26578s.remove(i10);
                i10--;
            }
            i10++;
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.emojiLoaded) {
            AndroidUtilities.forEachViews((RecyclerView) this.f26573b, (e2.h) new ai.i(23));
        }
    }
