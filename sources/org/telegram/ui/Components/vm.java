...
public final class vm implements al0 {
    public final int f28828a = 1;
    public final org.telegram.ui.ActionBar.f6 f28829b;
    ...
    public final void d(int i10, View view) {
        ...
        switch (this.f28828a) {
            case 0:
                ...
                c2.a aVar = unVar.N0;
                hn hnVar = unVar.v;
                sn snVar = unVar.f28442r;
                fc1 fc1Var = unVar.f28444s;
                int i11 = unVar.L0;
                org.telegram.ui.ActionBar.f6 f6Var = this.f28829b;
                if (i10 == i11) {
                    th.f fVar = new th.f(unVar.getContext(), f6Var);
                    fVar.f43297k0 = new k2.u(unVar, 12);
                    ArrayList arrayList = unVar.P0;
                    fVar.f43289c0 = null;
                    fVar.f43300o0 = new HashSet(arrayList);
                    fVar.show();
                    return;
                    ...
                    while (true) {
                        ...
                        if (i12 < iArr.length) {
                            ...
                            a2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i14, unVar.f26462a), PorterDuff.Mode.SRC_IN));
                    ...
                    if (z13 || (view instanceof org.telegram.ui.Cells.z5)) {
                        ...
                        while (true) {
                            if (i15 < length) {
                                ...
                                if (i10 == aVar2.f3657b) {
                                    ...
                                    sn snVar2 = unVar2.f28442r;
                                    if (i10 == i16) {
                                        fc1Var.setItemAnimator(hnVar);
                                        int i17 = aVar.f3657b;
                                        if (i17 >= 0) {
                                            s4.c1 L = unVar2.f28444s.L(i17);
                                            if (L != null) {
                        ...
                        if (!z10) {
                            if (i10 == unVar.B0) {
                                ...
                                if (i10 == i18) {
                                    ...
                                    unVar.f28426g0 = z11;
                                    unVar.h0();
                                    int i21 = unVar.f28454y0;
                                    if (i21 >= 0 && i18 < 0) {
                                        fc1Var.setItemAnimator(hnVar);
                                        snVar.o(unVar.f28454y0);
                                    } else if (i18 >= 0 && i21 < 0) {
                                        fc1Var.setItemAnimator(hnVar);
                                        snVar.u(i18);
                                    }
                                } else if (i10 == unVar.F0) {
                                    boolean z16 = unVar.f28416b0;
                                    z11 = !z16;
                                    unVar.f28416b0 = z11;
                                    if (z16 && unVar.f28418c0) {
                                        boolean z17 = false;
                                    ...
                                    for (int i23 = 0; i23 < childCount; i23++) {
                                        ...
                                        if (U.f42705f == 5) {
                                            ((org.telegram.ui.Cells.c6) U.f42702a).f19871a.a(unVar.f28416b0, true);
                                        }
                                    }
                                    ...
                                    if (!unVar.f28422e0) {
                                        ...
                                        z11 = !unVar.f28418c0;
                                        unVar.f28418c0 = z11;
                                        int i24 = unVar.f28439o0;
                                        unVar.h0();
                                        if (unVar.f28418c0) {
                                            snVar.s(unVar.f28439o0, 3);
                                        } else {
                                            snVar.t(i24, 3);
                                        }
                                        snVar.m(unVar.A0);
                                        if (unVar.f28418c0) {
                                            ...
                                            if (i25 >= 0) {
                                                ...
                                                if (L4 != null) {
                                                    ((org.telegram.ui.Cells.z5) L4.f42702a).setChecked(false);
                                                } else {
                                                    snVar.m(unVar.D0);
                                                }
                                            }
                                        ...
                                        unVar.R();
                                        if (unVar.f28418c0 && !unVar.f28416b0) {
                                            boolean z18 = false;
                        ...
                        if (unVar.f28420d0 && !unVar.f28418c0) {
                            i40Var.b(true);
                        }
                        fc1Var.getChildCount();
                        for (int i28 = unVar.f28446t0; i28 < unVar.f28446t0 + unVar.M; i28++) {
                            s4.c1 L5 = fc1Var.L(i28);
                            if (L5 != null) {
                                View view5 = L5.f42702a;
                                if (view5 instanceof org.telegram.ui.Cells.c6) {
                                    org.telegram.ui.Cells.c6 c6Var = (org.telegram.ui.Cells.c6) view5;
                                    c6Var.m(unVar.f28418c0, true);
                                    c6Var.f19876r.a(zArr[i28 - unVar.f28446t0], z14);
                                    if (c6Var.getTop() > AndroidUtilities.dp(40.0f) && i10 == unVar.G0 && !unVar.f28420d0) {
                ...
                break;
            default:
                sv.n((sv) this.f28830c, (ArrayList) this.d, (org.telegram.ui.ActionBar.o2) this.e, this.f28829b, view, i10);
                return;
        }
    }
