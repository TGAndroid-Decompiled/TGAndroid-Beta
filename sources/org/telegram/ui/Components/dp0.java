...
public final class dp0 extends vl0 {
    public final org.telegram.ui.ActionBar.d6 f23689c;
    public final List d;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (j3 < 0) {
            ...
            if (chat != null) {
                if (tL_sendAsPeer.premium_required) {
                    ...
                    TextView textView = hp0Var.f24821b;
                    sb2.append((Object) TextUtils.ellipsize(str2, textView.getPaint(), this.f23690f - AndroidUtilities.dp(100.0f), TextUtils.TruncateAt.END));
                    sb2.append(" d");
                    ...
                    hp0Var.f24821b.setEllipsize(TextUtils.TruncateAt.END);
                    hp0Var.f24821b.setText(chat.title);
                }
                TextView textView2 = hp0Var.f24822c;
        ...
        if (user != null) {
            hp0Var.f24821b.setText(UserObject.getUserName(user));
            hp0Var.f24822c.setText(LocaleController.getString(R.string.VoipGroupPersonalAccount));
            hp0Var.f24820a.setAvatar(user);
        }
        qv0 qv0Var2 = hp0Var.f24820a;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        return new s4.c1(new hp0(viewGroup.getContext(), this.f23689c));
    }
}
