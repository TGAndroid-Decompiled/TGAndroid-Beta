...
public final class t71 extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f30549c != null) {
            ...
            drawable.setBounds(org.telegram.messenger.wl.w(2, this.f30549c.getWidth() / 2, drawable), (int) (AndroidUtilities.dpf2(4.0f) + this.f30549c.getHeight()), org.telegram.messenger.wl.B(2, this.f30549c.getWidth() / 2, drawable), drawable.getIntrinsicHeight() + ((int) (AndroidUtilities.dpf2(4.0f) + this.f30549c.getHeight())));
