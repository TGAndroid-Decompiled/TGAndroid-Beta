...
public abstract class t71 extends View {
    public static final Object f28917c0 = new Object();
    public s71 B;
    ...
    public final z5 W;
    public long f28918a;
    public final Path f28919a0;
    public int f28920b;
    public boolean f28921b0;
    public int f28922c;
    public float d;
    public float e;
    ...
    public ParcelFileDescriptor f28928x;
    public MediaMetadataRetriever f28929y;
    ...
    public t71(Context context) {
        ...
        this.V = paint6;
        this.W = new z5(0.0f, this, 0L, 200L, nr.f27349j);
        this.f28919a0 = new Path();
        paint.setColor(-1);
        paint2.setColor(-256);
    ...
    public final void a() {
        Bitmap bitmap;
        synchronized (f28917c0) {
            try {
                ParcelFileDescriptor parcelFileDescriptor = this.f28928x;
            ...
            try {
                MediaMetadataRetriever mediaMetadataRetriever = this.f28929y;
        ...
        for (int i10 = 0; i10 < this.C.size(); i10++) {
            ...
            if (r71Var != null && (bitmap = r71Var.f28408a) != null) {
                bitmap.recycle();
            }
        }
        this.C.clear();
    ...
    public final void d(int i10) {
        float f10;
        int i11;
        if (this.f28929y == null) {
            return;
        }
        if (i10 == 0) {
            this.G = AndroidUtilities.dp(38.0f);
            int i12 = this.f28920b;
            if (i12 != 0 && (i11 = this.f28922c) != 0) {
                f10 = i12 / i11;
            } else {
                f10 = 1.0f;
            }
    ...
    public long getLength() {
        return Math.max(1L, this.f28918a);
    }
    ...
    public final void onDraw(Canvas canvas) {
            ...
            if (!z4) {
                ...
                while (true) {
                    if (i10 >= arrayList.size()) {
                        break;
                    } else if (((r71) arrayList.get(i10)).f28408a == null) {
                        this.f28921b0 = true;
                        break;
                    } else {
                        i10++;
            ...
            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                ...
                if (bitmap != null) {
                    ...
                    if (f18 != 1.0f) {
                        ...
                        Paint paint = this.N;
                        paint.setAlpha((int) (nr.h.getInterpolation(r71Var.f28409b) * 255.0f));
        ...
        c(this.f28926s, 1.0f - d, canvas2, paint3);
        if (this.f28927w) {
            c(this.f28923f, 1.0f, canvas2, this.R);
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent != null) {
            ...
            int dp2 = AndroidUtilities.dp(22.0f) + ((int) (this.f28926s * f10));
                    ...
                    if (this.f28925r) {
                        ...
                        if (s71Var7 != null) {
                            ...
                            if (i71Var != null) {
                                ...
                                vVar3.j(1);
                                vVar3.i(f19);
                                photoViewer3.f31815n3.h(0.0f, false);
    ...
    public void setProgress(float f10) {
        float f11 = 0.0f;
        if (this.f28927w && (f10 <= 0.0f || f10 >= 1.0f)) {
            f10 = this.f28923f;
        }
        long j10 = this.f28918a;
        if (j10 != 0) {
