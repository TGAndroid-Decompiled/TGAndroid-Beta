...
public final class d implements Utilities.Callback2 {
    ...
    private final void b(Object obj, Object obj2) {
        ky kyVar = (ky) this.f25187b;
        ArrayList arrayList = (ArrayList) obj;
        v51 v51Var = (v51) obj2;
        ArrayList arrayList2 = kyVar.f27947s;
        ...
        while (i10 < size) {
            ...
            i10++;
            dy dyVar = (dy) obj3;
            TLRPC.TL_messages_stickerSet tL_messages_stickerSet = dyVar.f25505b;
            boolean z10 = true;
            if (tL_messages_stickerSet != null) {
                ...
                TLRPC.StickerSetCovered stickerSetCovered = dyVar.f25504a;
    ...
    private final void c(Object obj, Object obj2) {
        ...
        while (i12 < size2) {
            ...
            i12++;
            dy dyVar = (dy) obj4;
            TLRPC.StickerSet stickerSet = dyVar.f25506c;
    ...
    private final void d(Object obj, Object obj2) {
        FragmentContextView fragmentContextView = (FragmentContextView) this.f25187b;
        float[] fArr = FragmentContextView.M0;
        fragmentContextView.f24035z0 = !((Boolean) obj2).booleanValue();
    ...
    private final void e(Object obj, Object obj2) {
        int i10;
        d40 d40Var = (d40) this.f25187b;
        ArrayList arrayList = (ArrayList) obj;
        v51 v51Var = (v51) obj2;
        ArrayList arrayList2 = new ArrayList(0);
        d40Var.f25252c = arrayList2;
        arrayList2.addAll(HashtagSearchController.getInstance(d40Var.f25250a).history);
        if (d40Var.f25252c.isEmpty()) {
            return;
        }
        for (int i11 = 0; i11 < d40Var.f25252c.size(); i11++) {
            String str = (String) d40Var.f25252c.get(i11);
    ...
    private final void g(Object obj, Object obj2) {
        l70 l70Var = (l70) this.f25187b;
        Bitmap bitmap = (Bitmap) obj;
        Bitmap bitmap2 = (Bitmap) obj2;
        n70 n70Var = l70Var.f28111x;
        n70Var.f28665f.setAlpha(1.0f);
        if (n70Var.f28690u) {
            l70Var.f28104c = bitmap;
        }
        gh.b bVar = n70Var.f28679n;
        if (bVar != null) {
            bVar.a(bitmap2);
            hh.d.c(n70Var.f28679n, l70Var);
    ...
    private final void h(Object obj, Object obj2) {
        yg0 yg0Var = (yg0) this.f25187b;
        ArrayList arrayList = (ArrayList) obj;
        v51 v51Var = (v51) obj2;
        ArrayList arrayList2 = yg0Var.f32938e;
        ArrayList arrayList3 = yg0Var.f32940n;
        int i10 = 0;
        if (yg0Var.d == null) {
        ...
        boolean isEmpty = TextUtils.isEmpty(yg0Var.f32943w);
        if (isEmpty) {
        ...
        if (yg0Var.v || ((yg0Var.M && !yg0Var.N) || (!isEmpty && !arrayList3.isEmpty() && !yg0Var.f32942s))) {
    ...
    private final void i(Object obj, Object obj2) {
        am0 am0Var = (am0) this.f25187b;
        am0Var.f24447c = (Bitmap) obj;
        Paint paint = new Paint(1);
        am0Var.f24448e = paint;
        Bitmap bitmap = am0Var.f24447c;
        Shader.TileMode tileMode = Shader.TileMode.CLAMP;
        BitmapShader bitmapShader = new BitmapShader(bitmap, tileMode, tileMode);
        am0Var.d = bitmapShader;
        paint.setShader(bitmapShader);
        am0Var.f24449f = new Matrix();
        gh.b bVar = am0Var.h;
        bVar.a((Bitmap) obj2);
        hh.d.c(bVar, am0Var.f24452s);
