...
public final class d implements Utilities.Callback2 {
    ...
    private final void b(Object obj, Object obj2) {
        jy jyVar = (jy) this.f23165b;
        ArrayList arrayList = (ArrayList) obj;
        x51 x51Var = (x51) obj2;
        ArrayList arrayList2 = jyVar.f25465s;
        ...
        while (i10 < size) {
            ...
            i10++;
            cy cyVar = (cy) obj3;
            TLRPC.TL_messages_stickerSet tL_messages_stickerSet = cyVar.f23157b;
            boolean z10 = true;
            if (tL_messages_stickerSet != null) {
                ...
                TLRPC.StickerSetCovered stickerSetCovered = cyVar.f23156a;
    ...
    private final void c(Object obj, Object obj2) {
        ...
        while (i12 < size2) {
            ...
            i12++;
            cy cyVar = (cy) obj4;
            TLRPC.StickerSet stickerSet = cyVar.f23158c;
    ...
    private final void d(Object obj, Object obj2) {
        FragmentContextView fragmentContextView = (FragmentContextView) this.f23165b;
        float[] fArr = FragmentContextView.O0;
        fragmentContextView.f22080z0 = !((Boolean) obj2).booleanValue();
    ...
    private final void e(Object obj, Object obj2) {
        int i10;
        d40 d40Var = (d40) this.f23165b;
        ArrayList arrayList = (ArrayList) obj;
        x51 x51Var = (x51) obj2;
        ArrayList arrayList2 = new ArrayList(0);
        d40Var.f23209c = arrayList2;
        arrayList2.addAll(HashtagSearchController.getInstance(d40Var.f23207a).history);
        if (d40Var.f23209c.isEmpty()) {
            return;
        }
        for (int i11 = 0; i11 < d40Var.f23209c.size(); i11++) {
            String str = (String) d40Var.f23209c.get(i11);
    ...
    private final void g(Object obj, Object obj2) {
        l70 l70Var = (l70) this.f23165b;
        Bitmap bitmap = (Bitmap) obj;
        Bitmap bitmap2 = (Bitmap) obj2;
        n70 n70Var = l70Var.f25850x;
        n70Var.f26364f.setAlpha(1.0f);
        if (n70Var.f26389u) {
            l70Var.f25844c = bitmap;
        }
        fh.b bVar = n70Var.f26378n;
        if (bVar != null) {
            bVar.a(bitmap2);
            gh.d.c(n70Var.f26378n, l70Var);
    ...
    private final void h(Object obj, Object obj2) {
        zg0 zg0Var = (zg0) this.f23165b;
        ArrayList arrayList = (ArrayList) obj;
        x51 x51Var = (x51) obj2;
        ArrayList arrayList2 = zg0Var.e;
        ArrayList arrayList3 = zg0Var.f30522n;
        int i10 = 0;
        if (zg0Var.d == null) {
        ...
        boolean isEmpty = TextUtils.isEmpty(zg0Var.f30525w);
        if (isEmpty) {
        ...
        if (zg0Var.v || ((zg0Var.M && !zg0Var.N) || (!isEmpty && !arrayList3.isEmpty() && !zg0Var.f30524s))) {
    ...
    private final void i(Object obj, Object obj2) {
        bm0 bm0Var = (bm0) this.f23165b;
        bm0Var.f22770c = (Bitmap) obj;
        Paint paint = new Paint(1);
        bm0Var.e = paint;
        Bitmap bitmap = bm0Var.f22770c;
        Shader.TileMode tileMode = Shader.TileMode.CLAMP;
        BitmapShader bitmapShader = new BitmapShader(bitmap, tileMode, tileMode);
        bm0Var.d = bitmapShader;
        paint.setShader(bitmapShader);
        bm0Var.f22771f = new Matrix();
        fh.b bVar = bm0Var.h;
        bVar.a((Bitmap) obj2);
        gh.d.c(bVar, bm0Var.f22774s);
