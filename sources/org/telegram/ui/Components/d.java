...
public final class d implements Utilities.Callback2 {
    ...
    private final void b(Object obj, Object obj2) {
        ky kyVar = (ky) this.f25160b;
        ArrayList arrayList = (ArrayList) obj;
        v51 v51Var = (v51) obj2;
        ArrayList arrayList2 = kyVar.f27920s;
        ...
        while (i10 < size) {
            ...
            i10++;
            dy dyVar = (dy) obj3;
            TLRPC.TL_messages_stickerSet tL_messages_stickerSet = dyVar.f25478b;
            boolean z10 = true;
            if (tL_messages_stickerSet != null) {
                ...
                TLRPC.StickerSetCovered stickerSetCovered = dyVar.f25477a;
    ...
    private final void c(Object obj, Object obj2) {
        ...
        while (i12 < size2) {
            ...
            i12++;
            dy dyVar = (dy) obj4;
            TLRPC.StickerSet stickerSet = dyVar.f25479c;
    ...
    private final void d(Object obj, Object obj2) {
        FragmentContextView fragmentContextView = (FragmentContextView) this.f25160b;
        float[] fArr = FragmentContextView.M0;
        fragmentContextView.f24008z0 = !((Boolean) obj2).booleanValue();
    ...
    private final void e(Object obj, Object obj2) {
        int i10;
        d40 d40Var = (d40) this.f25160b;
        ArrayList arrayList = (ArrayList) obj;
        v51 v51Var = (v51) obj2;
        ArrayList arrayList2 = new ArrayList(0);
        d40Var.f25225c = arrayList2;
        arrayList2.addAll(HashtagSearchController.getInstance(d40Var.f25223a).history);
        if (d40Var.f25225c.isEmpty()) {
            return;
        }
        for (int i11 = 0; i11 < d40Var.f25225c.size(); i11++) {
            String str = (String) d40Var.f25225c.get(i11);
    ...
    private final void g(Object obj, Object obj2) {
        l70 l70Var = (l70) this.f25160b;
        Bitmap bitmap = (Bitmap) obj;
        Bitmap bitmap2 = (Bitmap) obj2;
        n70 n70Var = l70Var.f28084x;
        n70Var.f28638f.setAlpha(1.0f);
        if (n70Var.f28663u) {
            l70Var.f28077c = bitmap;
        }
        gh.b bVar = n70Var.f28652n;
        if (bVar != null) {
            bVar.a(bitmap2);
            hh.d.c(n70Var.f28652n, l70Var);
    ...
    private final void h(Object obj, Object obj2) {
        yg0 yg0Var = (yg0) this.f25160b;
        ArrayList arrayList = (ArrayList) obj;
        v51 v51Var = (v51) obj2;
        ArrayList arrayList2 = yg0Var.f32911e;
        ArrayList arrayList3 = yg0Var.f32913n;
        int i10 = 0;
        if (yg0Var.d == null) {
        ...
        boolean isEmpty = TextUtils.isEmpty(yg0Var.f32916w);
        if (isEmpty) {
        ...
        if (yg0Var.v || ((yg0Var.M && !yg0Var.N) || (!isEmpty && !arrayList3.isEmpty() && !yg0Var.f32915s))) {
    ...
    private final void i(Object obj, Object obj2) {
        am0 am0Var = (am0) this.f25160b;
        am0Var.f24420c = (Bitmap) obj;
        Paint paint = new Paint(1);
        am0Var.f24421e = paint;
        Bitmap bitmap = am0Var.f24420c;
        Shader.TileMode tileMode = Shader.TileMode.CLAMP;
        BitmapShader bitmapShader = new BitmapShader(bitmap, tileMode, tileMode);
        am0Var.d = bitmapShader;
        paint.setShader(bitmapShader);
        am0Var.f24422f = new Matrix();
        gh.b bVar = am0Var.h;
        bVar.a((Bitmap) obj2);
        hh.d.c(bVar, am0Var.f24425s);
