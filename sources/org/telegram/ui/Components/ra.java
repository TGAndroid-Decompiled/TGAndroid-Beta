...
public abstract class ra extends View {
    public final org.telegram.ui.ActionBar.d6 f27933a;
    public final qa[] f27934b;
    public final Paint f27935c;
    public float d;
    public int e;
    public boolean f27936f;
    public final e6 h;
    public Utilities.Callback f27937n;
    public boolean f27938r;

    public ra(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f27935c = new Paint(1);
        this.h = new e6(this, 0L, 210L, rr.h);
        this.f27933a = d6Var;
        ma0 ma0Var = (ma0) this;
        this.f27934b = new qa[]{new qa(ma0Var, 0, R.raw.msg_stories_saved, 20, 40, LocaleController.getString(R.string.ProfileMyStoriesTab)), new qa(ma0Var, 1, R.raw.msg_stories_archive, 0, 0, LocaleController.getString(R.string.ProfileStoriesArchiveTab))};
    ...
    public final void a(float f7, boolean z10) {
        ...
        for (int i10 = 0; i10 < qaVarArr.length; i10++) {
            ...
            int i11 = qaVar.f27562k;
            int i12 = qaVar.f27561j;
            ij0 ij0Var = qaVar.f27556b;
            if (qaVar.f27563l != z11) {
                if (qaVar.f27565n.f27934b[qaVar.f27555a].f27561j != 0) {
                    if (z11) {
                        ij0Var.P(i12);
                        if (ij0Var.f25068a0 >= i11 - 2) {
                            ij0Var.N(0, false, false);
                        }
                        if (ij0Var.f25068a0 <= i12) {
                            ij0Var.start();
                        } else {
                            ij0Var.M(i12);
                        }
                    } else if (ij0Var.f25068a0 >= i12 - 1) {
                        ij0Var.P(i11 - 1);
                        ij0Var.start();
                    } else {
                        ij0Var.P(0);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        org.telegram.ui.ActionBar.d6 d6Var2 = raVar.f27933a;
        ...
        qa[] qaVarArr = raVar.f27934b;
        int length = width / qaVarArr.length;
        int min = Math.min(AndroidUtilities.dp(64.0f), length);
        float e = raVar.h.e(raVar.f27936f);
        Paint paint = raVar.f27935c;
        float f14 = 0.0f;
        if (e > 0.0f) {
            f7 = 9.0f;
            f10 = 16.0f;
        ...
        while (i11 < qaVarArr.length) {
            ...
            org.telegram.ui.Cells.z zVar = qaVar.f27557c;
            ij0 ij0Var = qaVar.f27556b;
            int i12 = length;
            ...
            ij0Var.draw(canvas);
            canvas.save();
            canvas.translate((rectF2.centerX() - (qaVar.f27558f / 2.0f)) - qaVar.f27559g, AndroidUtilities.dp(50.0f) - (staticLayout.getHeight() / 2.0f));
        ...
        if (action != 1 && motionEvent.getAction() != 2) {
            if (motionEvent.getAction() == 3) {
                for (qa qaVar : qaVarArr) {
                    qaVar.f27557c.setState(new int[0]);
                }
                this.f27938r = false;
                return true;
            }
                ...
                if (i10 < qaVarArr.length) {
                    ...
                    if (rectF.left < x10 && rectF.right > x10) {
                        if (motionEvent.getAction() != 1) {
                            if (this.f27938r) {
                                qaVarArr[i10].f27557c.setState(new int[0]);
                            }
                            qaVarArr[i10].f27557c.setState(new int[]{16842919, 16842910});
                        }
                    } else {
                        i10++;
                    }
            ...
            for (int i11 = 0; i11 < qaVarArr.length; i11++) {
                if (i11 != i10 || motionEvent.getAction() == 1) {
                    qaVarArr[i11].f27557c.setState(new int[0]);
                }
            }
            if (i10 >= 0 && this.e != i10 && (callback = this.f27937n) != null) {
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        ...
        while (true) {
            qa[] qaVarArr = this.f27934b;
            if (i10 < qaVarArr.length) {
                if (qaVarArr[i10].f27557c == drawable) {
                    return true;
                }
                i10++;
            } else {
