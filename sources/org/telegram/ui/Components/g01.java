...
public final class g01 extends FrameLayout {
    ...
    public TextView f24056a;
    public f01 f24057b;
    public TLRPC.TL_help_termsOfService f24058c;
    public int d;

    public final void a() {
        f01 f01Var = this.f24057b;
        int i10 = this.d;
        org.telegram.ui.za0 za0Var = (org.telegram.ui.za0) f01Var;
        za0Var.getClass();
        UserConfig.getInstance(i10).unacceptedTermsOfService = null;
        UserConfig.getInstance(i10).saveConfig(false);
        LaunchActivity launchActivity = za0Var.f40194a;
        ...
        tL_help_acceptTermsOfService.f18176id = this.f24058c.f18178id;
