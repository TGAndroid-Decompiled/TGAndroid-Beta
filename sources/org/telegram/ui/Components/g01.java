...
public final class g01 extends ReplacementSpan {
    public static final int f24125f = 0;
    public ImageReceiver f24126a;
    public int f24127b;
    public int f24128c;
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        ...
        int i16 = this.f24128c;
        ImageReceiver imageReceiver = this.f24126a;
        canvas.save();
        if (this.d) {
