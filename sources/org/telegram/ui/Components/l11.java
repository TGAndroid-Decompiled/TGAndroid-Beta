...
public final class l11 extends kl0 {
    ...
    public ArrayList f25800f = new ArrayList();
    public wm h;
    public String f25801n;
    public final ThemeEditorView.EditorAlert f25802r;

    public l11(ThemeEditorView.EditorAlert editorAlert, Context context) {
        this.f25802r = editorAlert;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (c1Var.f42674f == 0) {
            ...
            if (k6Var.f19352f == org.telegram.ui.ActionBar.i6.Nd) {
                b10 = 0;
            } else {
                b10 = k6Var.b();
            }
            org.telegram.ui.Cells.z8 z8Var = (org.telegram.ui.Cells.z8) c1Var.f42671a;
            z8Var.f21700a.setText((CharSequence) this.f25800f.get(i11));
            z8Var.f21701b = b10;
            if (b10 != 0) {
                z10 = false;
            }
