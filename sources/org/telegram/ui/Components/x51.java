...
public class x51 extends og.b {
    ...
    public Utilities.Callback2 f29852s;
    public final org.telegram.ui.ActionBar.f6 v;
    public ig.f f29855y;
    public boolean f29851r = true;
    public final ArrayList f29853w = new ArrayList();
    public final ArrayList f29854x = new ArrayList();
    public int E = 0;
    ...
    public final void F(int i10) {
        if (i10 >= 0) {
            ...
            if (i10 < arrayList.size()) {
                ...
                this.L.run(Integer.valueOf(i10), new ArrayList(this.f29854x.subList(v51Var.f28633a, v51Var.f28634b + 1)));
                this.K = false;
            }
        }
    }
    ...
    public final j51 G(int i10) {
        if (i10 >= 0) {
            ArrayList arrayList = this.f29854x;
            if (i10 < arrayList.size()) {
    ...
    public final int H(int i10) {
        ...
        while (true) {
            ...
            if (i11 < arrayList.size()) {
                ...
                if (i10 >= v51Var.f28633a && i10 <= v51Var.f28634b) {
                    return i11;
                }
                i11++;
            } else {
    ...
    public final boolean J(int i10) {
        j51 G = G(i10);
        j51 G2 = G(i10 + 1);
        if (G != null && !G.f25122j && G2 != null && K(G2.f15543a) == K(G.f15543a)) {
            return true;
        }
        return false;
    }
    ...
    public final void L() {
        v51 v51Var = this.I;
        if (v51Var != null) {
            v51Var.f28634b = Math.max(0, this.f29854x.size() - 1);
        }
    }
    ...
    public final void P(boolean z10) {
        ml0 ml0Var = this.d;
        if (ml0Var == null || !ml0Var.c0()) {
            ArrayList arrayList = this.f29853w;
            arrayList.clear();
            ArrayList arrayList2 = this.f29854x;
            arrayList.addAll(arrayList2);
            arrayList2.clear();
            this.H = null;
            this.F.clear();
            this.G.clear();
            Utilities.Callback2 callback2 = this.f29852s;
            if (callback2 != null) {
    ...
    public final void R() {
        ...
        if (ml0Var != null) {
            ...
            while (i10 < size) {
                ...
                i10++;
                v51 v51Var = (v51) obj;
                ml0Var.K2.add(Long.valueOf(AndroidUtilities.pack(v51Var.f28633a, v51Var.f28634b)));
            }
        }
    }
    ...
    public final void T() {
        v51 v51Var = this.H;
        if (v51Var != null) {
            v51Var.f28634b = Math.max(0, (this.f29854x.size() + this.E) - 1);
            v51 v51Var2 = this.H;
            if (v51Var2.f28633a == v51Var2.f28634b) {
    ...
    public final void U() {
        ?? obj = new Object();
        this.H = obj;
        obj.f28633a = this.f29854x.size() + this.E;
        v51 v51Var = this.H;
        v51Var.f28634b = -1;
        this.F.add(v51Var);
    }
    ...
    public s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        int i16;
        boolean z10 = this.f29850n;
        if (z10) {
            i11 = org.telegram.ui.ActionBar.j6.f18933h5;
        } else {
            i11 = org.telegram.ui.ActionBar.j6.f18862d6;
        }
        Context context = this.e;
        if (i10 >= 10000) {
            i51 F = j51.F(i10);
            if (F != null) {
                z1Var = F.createView(this.e, this.d, this.f29849f, this.h, this.v);
            } else {
            ...
            switch (i10) {
                ...
                case 9:
                    ...
                    if (i10 == 9) {
                        ...
                        w8Var2.d(org.telegram.ui.ActionBar.j6.f18916g6, org.telegram.ui.ActionBar.j6.O6, org.telegram.ui.ActionBar.j6.P6, org.telegram.ui.ActionBar.j6.Q6, org.telegram.ui.ActionBar.j6.R6);
                ...
                case 10:
                    ...
                    frameLayout2.f21357c = textView2;
                    ...
                    radioButton.b(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18917g7, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18935h7, false));
                    if (!LocaleController.isRTL) {
                        i17 = 5;
                    }
                ...
                case 23:
                    if (this.f29855y == null) {
                        this.f29855y = new ig.f(null);
                    }
                    ig.f fVar = this.f29855y;
                    int i19 = this.h;
                    z1Var = new ya1(this.e, this.f29849f, i10 - 18, fVar, i19);
                    break;
                case 24:
