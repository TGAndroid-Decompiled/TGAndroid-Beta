...
public final class ha0 extends kv0 {
    public AnimatorSet f24623f2;
    public final FrameLayout f24624g2;
    public final ea0 f24625h2;
    public final ka0 f24626i2;
    ...
    public ha0(ka0 ka0Var, Context context, long j3, cv0 cv0Var, TLRPC.ChatFull chatFull, TLRPC.UserFull userFull, int i10, ka0 ka0Var2, ga0 ga0Var, org.telegram.ui.ActionBar.e6 e6Var, FrameLayout frameLayout, ea0 ea0Var) {
        ...
        this.f24626i2 = ka0Var;
        this.f24624g2 = frameLayout;
        this.f24625h2 = ea0Var;
    }

    @Override
    public final boolean D() {
        int i10 = this.f24626i2.f25661a;
        if (i10 != 1 && i10 != 2) {
            return true;
        }
        return false;
    ...
    public final void D0(SparseArray sparseArray) {
        ...
        ka0 ka0Var = this.f24626i2;
        ka0Var.I = sparseArray;
        int i10 = ka0Var.f25661a;
        if (i10 == 1 || i10 == 2) {
            ka0Var.F.a();
    ...
    public final void K0(boolean z10) {
        ...
        AndroidUtilities.updateViewVisibilityAnimated(this.f24624g2, !z10, 0.95f, true);
    }
    ...
    public final void P(Canvas canvas, float f7, Rect rect, Paint paint) {
        this.f24625h2.J(canvas, getY() + f7, rect, paint, true);
    }
    ...
    public final void b1(boolean z10) {
        ...
        if (ka0Var.f25661a == 0) {
            ...
            this.C1 = z10;
            AnimatorSet animatorSet = this.f24623f2;
            if (animatorSet != null) {
                animatorSet.cancel();
            }
            int i10 = ka0Var.f25661a;
            ...
            if (z10) {
                ...
                ka0Var.f25669s.setVisibility(0);
            }
            org.telegram.ui.ActionBar.g2 g2Var = ka0Var.E;
            float f14 = 0.0f;
            float f15 = 1.0f;
            if (z10) {
                f7 = 1.0f;
            ...
            FrameLayout frameLayout2 = ka0Var.f25669s;
            if (z10) {
                f11 = 0.0f;
            } else {
                f11 = 1.0f;
            ...
            FrameLayout frameLayout3 = ka0Var.S;
            if (frameLayout3 != null) {
                ...
                FrameLayout frameLayout4 = ka0Var.S;
                if (z10) {
                    measuredHeight = 0.0f;
                } else {
            ...
            if (v0Var != null) {
                ...
                org.telegram.ui.ActionBar.v0 v0Var2 = ka0Var.H;
                if (z10) {
                    f12 = 1.0f;
                } else {
                    f12 = 0.0f;
            ...
            if (v0Var3 != null) {
                ...
                org.telegram.ui.ActionBar.v0 v0Var4 = ka0Var.G;
                if (!z10 && !z11) {
                    f14 = 1.0f;
                }
            ...
            if (ja0Var != null) {
                ...
                arrayList.add(ObjectAnimator.ofFloat(ja0Var, property, f15));
            }
            this.f24623f2.playTogether(arrayList);
            this.f24623f2.setDuration(300L);
            this.f24623f2.setInterpolator(qr.h);
            this.f24623f2.addListener(new org.telegram.ui.ActionBar.g(this, z10, z11, 4));
            this.f24623f2.start();
        }
    }
    ...
    public final int getInitialTab() {
        return this.f24626i2.W;
    }

    @Override
    public final String getStoriesHashtag() {
        return this.f24626i2.h;
    }

    @Override
    public final String getStoriesHashtagUsername() {
        return this.f24626i2.f25667n;
    }

    @Override
    public final boolean l0() {
        ka0 ka0Var = this.f24626i2;
        if (ka0Var.f25661a == 0 && ka0Var.e == ka0Var.getUserConfig().getClientUserId() && ka0Var.f25666f == 0) {
            return true;
        }
        return false;
    }
