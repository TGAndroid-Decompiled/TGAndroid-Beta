...
public final class qs0 implements lm0 {
    ...
    public final void C() {
        ...
        if (rt0Var.F == 0) {
            L0 = (rt0Var.f27688x.L0() / yu0Var.f30368m1[0]) * a2;
        } else {
            L0 = rt0Var.f27688x.L0() * a2;
        }
    ...
    public final boolean n1(int i10, View view) {
        ...
        if (n2Var != null && yu0.d0(i10, yu0Var.f30351d1 instanceof TLRPC.TL_channelFull) != null) {
            if (yu0Var.f30351d1 instanceof TLRPC.TL_channelFull) {
                if (ChatObject.canUserDoAction(n2Var.getMessagesController().getChat(Long.valueOf(yu0Var.f30351d1.f18110id)), 5)) {
                    profileTab = yu0Var.f30351d1.main_tab;
                    if (profileTab != null || (i10 != yu0.e0(profileTab) && yu0Var.R1 != i10)) {
                        n70 H = n70.H(n2Var, view);
                        H.W(org.telegram.ui.ActionBar.i6.b0(AndroidUtilities.dp(24.0f), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18834d6, false)));
                        H.c(R.drawable.tabs_reorder, LocaleController.getString(R.string.ProfileTabSetAsMain), new id(this, i10, 9), false);
                        H.Z();
                        return true;
                    }
                }
            } else if (yu0Var.f30364j1 == n2Var.getUserConfig().getClientUserId() && (userFull = yu0Var.f30353e1) != null) {
                profileTab = userFull.main_tab;
                if (profileTab != null) {
                }
                n70 H2 = n70.H(n2Var, view);
                H2.W(org.telegram.ui.ActionBar.i6.b0(AndroidUtilities.dp(24.0f), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18834d6, false)));
