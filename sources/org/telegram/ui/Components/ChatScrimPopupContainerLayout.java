...
public abstract class ChatScrimPopupContainerLayout extends LinearLayout {
    ...
    public void setPopupWindowLayout(final ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout) {
        ...
        actionBarPopupWindowLayout.setOnSizeChangedListener(new ActionBarPopupWindow.onSizeChangedListener() {
            ...
            public final void onSizeChanged() {
                ChatScrimPopupContainerLayout.$r8$lambda$qzeQ8pfVpqQG2bHXK04XS8AizNY(this.f$0, actionBarPopupWindowLayout);
            }
        });
        if (actionBarPopupWindowLayout.getSwipeBack() != null) {
            actionBarPopupWindowLayout.getSwipeBack().addOnSwipeBackProgressListener(new PopupSwipeBackLayout.OnSwipeBackProgressListener() {
                ...
                public final void onSwipeBackProgress(PopupSwipeBackLayout popupSwipeBackLayout, float f, float f2) {
                    ChatScrimPopupContainerLayout.$r8$lambda$iAF2DY1XnHmzg5rOLv_8viKWf84(this.f$0, popupSwipeBackLayout, f, f2);
                }
            });
        }
    }

    public static void $r8$lambda$qzeQ8pfVpqQG2bHXK04XS8AizNY(ChatScrimPopupContainerLayout chatScrimPopupContainerLayout, ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout) {
    ...
    public static void $r8$lambda$iAF2DY1XnHmzg5rOLv_8viKWf84(ChatScrimPopupContainerLayout chatScrimPopupContainerLayout, PopupSwipeBackLayout popupSwipeBackLayout, float f, float f2) {
