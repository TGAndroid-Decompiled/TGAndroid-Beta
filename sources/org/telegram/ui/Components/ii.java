...
public final class ii implements qj {
    ...
    public final void a(TLRPC.User user, boolean z10, int i10, long j3) {
        org.telegram.ui.wn wnVar = (org.telegram.ui.wn) this.f25061a.f30005f0;
        if (wnVar.f7()) {
            SendMessagesHelper.SendMessageParams of2 = SendMessagesHelper.SendMessageParams.of(user, wnVar.T5, wnVar.f39574n5, wnVar.X3, (TLRPC.ReplyMarkup) null, (HashMap<String, String>) null, z10, i10, 0);
    ...
    public final void b(ArrayList arrayList, String str, boolean z10, int i10, long j3, boolean z11) {
        ((org.telegram.ui.wn) this.f25061a.f30005f0).db(arrayList, str, z10, i10, j3, z11);
    }
}
