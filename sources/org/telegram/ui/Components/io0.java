...
public final class io0 {
    ...
    public int f25098i;
    public int f25099j;
    public org.telegram.ui.Cells.t1 f25100k;
    public byte[] f25101l;
    public MessageObject f25102m;
    public org.telegram.ui.Cells.t1 f25103n;
    public boolean f25104o;
    public int f25105p;
    public int f25106q;
    public int f25107r;
    public float f25108s;
    public float f25109t;
    public boolean f25110u;
    public c6 v;
    public float f25111w;
    public Path f25112x;
    public Path f25113y;
        ...
        if (bArr != null && i10 > 0) {
            ...
            loop0: while (i12 < length) {
                if (i12 == i13) {
                    ...
                    int i20 = 8 - i19;
                    int i21 = 5 - i20;
                    byte min = (byte) ((this.f25101l[i18] >> i19) & ((2 << (Math.min(i11, i20) - 1)) - 1));
                    if (i21 > 0) {
                        int i22 = i18 + 1;
                        byte[] bArr2 = this.f25101l;
                        if (i22 < bArr2.length) {
    ...
    public final void d(Canvas canvas, float f7) {
        ...
        c6 c6Var = this.B;
        float dpf2 = AndroidUtilities.dpf2(2.0f);
        MessageObject messageObject = this.f25102m;
        if (messageObject != null && messageObject.isContentUnread() && !this.f25102m.isOut() && this.f25095c <= 0.0f) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        if (z10) {
            i10 = this.f25106q;
        } else if (this.f25104o) {
            i10 = this.f25107r;
        } else {
            i10 = this.f25105p;
        }
        paint3.setColor(i10);
        O.setColor(this.f25106q);
        c6Var.f22951a = this.f25103n;
        boolean isPlayingMessage = MediaController.getInstance().isPlayingMessage(this.f25102m);
        if (this.f25114z && !isPlayingMessage) {
            f10 = 1.0f;
        } else {
            f10 = 0.0f;
        }
        ...
        Paint paint4 = N;
        paint4.setColor(i0.a.d(d, paint4.getColor(), this.f25105p));
        float f11 = 1.0f - d;
        O.setAlpha((int) (paint.getAlpha() * f11 * f7));
        N.setAlpha((int) (paint2.getAlpha() * f7));
        canvas.drawRect(0.0f, 0.0f, this.f25097g + dpf2, this.h, N);
        if (d < 1.0f) {
            canvas.drawRect(0.0f, 0.0f, (this.f25097g + dpf2) * this.f25095c * f11, this.h, O);
        }
        if (d > 0.0f) {
            if (this.C == null || Math.abs(this.D - this.f25097g) > AndroidUtilities.dp(8.0f) || this.E != this.f25105p || this.F != this.f25106q) {
                if (this.C == null) {
                    this.C = new Paint(1);
                }
                this.E = this.f25105p;
            ...
            canvas.drawRect(-pow, 0.0f, (this.f25097g + 5) - pow, this.h, this.C);
            canvas.restore();
            org.telegram.ui.Cells.t1 t1Var = this.f25103n;
            if (t1Var != null) {
                t1Var.invalidate();
            }
        }
    ...
    public final void g(float f7, boolean z10) {
        ...
        int ceil = (int) Math.ceil(this.f25097g * f7);
        this.f25093a = ceil;
        if (ceil < 0) {
            this.f25093a = 0;
            return;
    ...
    public final void h(int i10, int i11, int i12, int i13) {
        ...
        if (fArr == null || fArr.length != ((int) (i10 / AndroidUtilities.dpf2(3.0f)))) {
            this.G = b((int) (this.f25097g / AndroidUtilities.dpf2(3.0f)));
        }
        if (i12 != i13 && (this.f25098i != i12 || this.f25099j != i13)) {
            this.f25098i = i12;
            this.f25099j = i13;
            this.H = b((int) (i12 / AndroidUtilities.dpf2(3.0f)));
            this.I = b((int) (this.f25099j / AndroidUtilities.dpf2(3.0f)));
        } else if (i12 == i13) {
            this.I = null;
            this.H = null;
        }
