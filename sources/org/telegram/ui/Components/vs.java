...
public abstract class vs extends k61 {
    public final int N;
    public final int O;
    ...
    public final zp f29755c0;

    public vs(xl0 xl0Var, Context context, int i10, int i11) {
        ...
        ho0 ho0Var = (ho0) this;
        this.f29755c0 = new zp(ho0Var, 6);
        this.f25645s = new d(ho0Var, 9);
        this.N = i10;
        this.O = i11;
        N(false);
    }
    ...
    public final void V(boolean r9) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.vs.V(boolean):void");
    }
