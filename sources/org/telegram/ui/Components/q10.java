...
public final class q10 implements Runnable {
    public final FragmentContextView f28042a;

    public q10(FragmentContextView fragmentContextView) {
        this.f28042a = fragmentContextView;
    }

    @Override
    public final void run() {
        String formatFullDuration;
        FragmentContextView fragmentContextView = this.f28042a;
        org.telegram.ui.ActionBar.p2 p2Var = fragmentContextView.h;
        if (fragmentContextView.f23001c0 != null && (p2Var instanceof org.telegram.ui.zn)) {
            ...
            if (groupCall != null && groupCall.isScheduled()) {
                ...
                if (!fragmentContextView.f23003e0) {
                    formatFullDuration = LocaleController.getString(R.string.VoipChatNotify);
                }
                j6Var.q(formatFullDuration, true, true);
                AndroidUtilities.runOnUIThread(fragmentContextView.f23008i0, 1000L);
                fragmentContextView.f23017r.invalidate();
                return;
            }
            fragmentContextView.f23002d0 = false;
