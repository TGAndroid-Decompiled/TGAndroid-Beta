...
public final class q10 extends FrameLayout {
    public final RectF f27191a;
    public final FragmentContextView f27192b;

    public q10(FragmentContextView fragmentContextView, Context context) {
        super(context);
        this.f27192b = fragmentContextView;
        this.f27191a = new RectF();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (fragmentContextView.T == 4 && fragmentContextView.f22056g0) {
            ...
            if (dp != fragmentContextView.f22053e0) {
                ...
                fragmentContextView.f22051c0 = linearGradient;
                fragmentContextView.f22049b0.setShader(linearGradient);
                fragmentContextView.f22053e0 = dp;
            }
            ...
            fragmentContextView.f22052d0.reset();
            fragmentContextView.f22052d0.postTranslate((-fragmentContextView.f22053e0) * 0.7f * f7, 0.0f);
            fragmentContextView.f22051c0.setLocalMatrix(fragmentContextView.f22052d0);
            int measuredWidth = (getMeasuredWidth() - dp) - AndroidUtilities.dp(10.0f);
            int dp2 = AndroidUtilities.dp(10.0f);
            float f10 = measuredWidth;
            float f11 = dp2;
            float dp3 = AndroidUtilities.dp(28.0f) + dp2;
            RectF rectF = this.f27191a;
            rectF.set(f10, f11, measuredWidth + dp, dp3);
            canvas.save();
            float a2 = fragmentContextView.f22059j0.a(0.1f);
            canvas.scale(a2, a2, rectF.centerX(), rectF.centerY());
            canvas.translate(f10, f11);
            RectF rectF2 = AndroidUtilities.rectTmp;
            rectF2.set(0.0f, 0.0f, dp, AndroidUtilities.dp(28.0f));
            canvas.drawRoundRect(rectF2, AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f), fragmentContextView.f22049b0);
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        int i11;
        FragmentContextView fragmentContextView = this.f27192b;
        if (fragmentContextView.T == 4 && fragmentContextView.f22056g0 && fragmentContextView.f22059j0 != null) {
            boolean contains = this.f27191a.contains(motionEvent.getX(), motionEvent.getY());
            if (motionEvent.getAction() == 0) {
                fragmentContextView.f22059j0.c(contains);
            } else if (motionEvent.getAction() == 2) {
                if (!contains) {
                    fragmentContextView.f22059j0.c(false);
                }
            } else if (motionEvent.getAction() == 1) {
                if (contains) {
                    p10 p10Var = fragmentContextView.f22061l0;
                    org.telegram.ui.ActionBar.o2 o2Var = fragmentContextView.h;
                    if (o2Var != null && (ahVar = fragmentContextView.f22062n) != null && (groupCall = ahVar.getGroupCall()) != null && groupCall.call != null) {
                        ...
                        boolean z10 = !fragmentContextView.f22057h0;
                        fragmentContextView.f22057h0 = z10;
            ...
            wc wcVar = fragmentContextView.f22059j0;
            if (wcVar != null) {
                wcVar.c(false);
            }
        }
        wc wcVar2 = fragmentContextView.f22059j0;
    ...
    public final void invalidate() {
        super.invalidate();
        FragmentContextView fragmentContextView = this.f27192b;
        i9 i9Var = fragmentContextView.f22047a0;
        if (i9Var != null && i9Var.getVisibility() == 0) {
            fragmentContextView.f22047a0.invalidate();
        }
    }

    @Override
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f27192b.f22058i0 && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
