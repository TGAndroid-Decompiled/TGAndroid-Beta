...
public class GestureDetector2 {
    ...
    public interface OnDoubleTapListener {
        ...
        public abstract class CC {
            public static boolean $default$canDoubleTap(OnDoubleTapListener onDoubleTapListener, MotionEvent motionEvent) {
                return true;
            }
        }
    ...
    @Deprecated
    public GestureDetector2(OnGestureListener onGestureListener, Handler handler) {
    ...
    public GestureDetector2(Context context, OnGestureListener onGestureListener, Handler handler, boolean z) {
