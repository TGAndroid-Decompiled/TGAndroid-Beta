...
public final class h6 {
    ...
    public final TextPaint f26610c;
    public ObjectAnimator d;
    public final org.telegram.ui.Cells.t1 f26613g;
    public final ArrayList f26608a = new ArrayList();
    public final ArrayList f26609b = new ArrayList();
    public float f26611e = 0.0f;
    public int f26612f = 1;

    public h6(org.telegram.ui.Cells.t1 t1Var, TextPaint textPaint) {
        this.f26610c = textPaint;
        this.f26613g = t1Var;
    }
    ...
    public final void b(int i10, boolean z10) {
        ...
        ArrayList arrayList2 = this.f26608a;
        ...
        ArrayList arrayList3 = this.f26609b;
        arrayList3.clear();
        ...
        while (i13 < sb5.length()) {
            ...
            if (str != null && str.equals(substring)) {
                ...
                arrayList = arrayList3;
                arrayList2.add(new StaticLayout(substring, this.f26610c, (int) Math.ceil(textPaint.measureText(substring)), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false));
            }
            i13 = i14;
