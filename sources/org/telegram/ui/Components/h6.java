...
public final class h6 {
    ...
    public final TextPaint f24643c;
    public ObjectAnimator d;
    public final org.telegram.ui.Cells.u1 f24645g;
    public final ArrayList f24641a = new ArrayList();
    public final ArrayList f24642b = new ArrayList();
    public float e = 0.0f;
    public int f24644f = 1;

    public h6(org.telegram.ui.Cells.u1 u1Var, TextPaint textPaint) {
        this.f24643c = textPaint;
        this.f24645g = u1Var;
    }
    ...
    public final void b(int i10, boolean z10) {
        ...
        ArrayList arrayList2 = this.f24641a;
        ...
        ArrayList arrayList3 = this.f24642b;
        arrayList3.clear();
        ...
        while (i13 < sb5.length()) {
            ...
            if (str != null && str.equals(substring)) {
                ...
                arrayList = arrayList3;
                arrayList2.add(new StaticLayout(substring, this.f24643c, (int) Math.ceil(textPaint.measureText(substring)), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false));
            }
            i13 = i14;
