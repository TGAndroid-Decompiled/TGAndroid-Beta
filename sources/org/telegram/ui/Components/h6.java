...
public final class h6 {
    ...
    public final TextPaint f24562c;
    public ObjectAnimator d;
    public final org.telegram.ui.Cells.u1 f24564g;
    public final ArrayList f24560a = new ArrayList();
    public final ArrayList f24561b = new ArrayList();
    public float e = 0.0f;
    public int f24563f = 1;

    public h6(org.telegram.ui.Cells.u1 u1Var, TextPaint textPaint) {
        this.f24562c = textPaint;
        this.f24564g = u1Var;
    }

    public final int a() {
        ArrayList arrayList = this.f24560a;
    ...
    public final void b(int i10, boolean z10) {
        ...
        ArrayList arrayList2 = this.f24560a;
        ...
        ArrayList arrayList3 = this.f24561b;
        arrayList3.clear();
        ...
        while (i13 < sb5.length()) {
            ...
            if (str != null && str.equals(substring)) {
                ...
                arrayList = arrayList3;
                arrayList2.add(new StaticLayout(substring, this.f24562c, (int) Math.ceil(textPaint.measureText(substring)), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false));
            }
            i13 = i14;
