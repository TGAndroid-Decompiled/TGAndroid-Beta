...
public final class h6 {
    ...
    public final TextPaint f24644c;
    public ObjectAnimator d;
    public final org.telegram.ui.Cells.u1 f24646g;
    public final ArrayList f24642a = new ArrayList();
    public final ArrayList f24643b = new ArrayList();
    public float e = 0.0f;
    public int f24645f = 1;

    public h6(org.telegram.ui.Cells.u1 u1Var, TextPaint textPaint) {
        this.f24644c = textPaint;
        this.f24646g = u1Var;
    }
    ...
    public final void b(int i10, boolean z10) {
        ...
        ArrayList arrayList2 = this.f24642a;
        ...
        ArrayList arrayList3 = this.f24643b;
        arrayList3.clear();
        arrayList3.addAll(arrayList2);
        arrayList2.clear();
        Locale locale = Locale.US;
        int i12 = this.f24645f;
        ...
        while (i13 < sb5.length()) {
            ...
            if (str != null && str.equals(substring)) {
                ...
                arrayList = arrayList3;
                arrayList2.add(new StaticLayout(substring, this.f24644c, (int) Math.ceil(textPaint.measureText(substring)), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false));
            }
            i13 = i14;
