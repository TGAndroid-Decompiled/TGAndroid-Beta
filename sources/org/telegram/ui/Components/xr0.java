        ...
        if (messageObject != null) {
            ...
            if (sparseArrayArr[c10].indexOfKey(messageObject.getId()) < 0) {
                if (sparseArrayArr[1].size() + sparseArrayArr[0].size() < 100) {
                    ...
                    if (!jv0Var.C1) {
                        AndroidUtilities.hideKeyboard(jv0Var.f25559v1.getParentActivity().getCurrentFocus());
                        org.telegram.ui.ActionBar.u0 u0Var = jv0Var.f25537l0;
                        int i12 = 8;
                        if (jv0Var.f25511a1 == 0) {
                            i10 = 0;
                        } else {
                            i10 = 8;
                        }
                        u0Var.setVisibility(i10);
                        org.telegram.ui.ActionBar.u0 u0Var2 = jv0Var.f25556u0;
                        if (u0Var2 != null) {
                        ...
                        org.telegram.ui.ActionBar.u0 u0Var5 = jv0Var.f25554t0;
                        if (u0Var5 != null) {
                            if (jv0Var.getClosestTab() != 8 && jv0Var.getClosestTab() != 13) {
                                i12 = 0;
                            }
