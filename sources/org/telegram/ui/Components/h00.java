...
public final class h00 extends sl0 {
    ...
    public final long i(int i10) {
        return this.d.f28498h0.get(i10);
    }
    ...
    public final void v(f2.m1 m1Var, int i10) {
        ...
        if (j00Var.f27944b != null) {
            i11 = j00Var.getId();
        } else {
            i11 = -1;
        }
        i00 i00Var = (i00) this.d.h.get(i10);
        j00Var.f27944b = i00Var;
        j00Var.f27949e = i10;
        j00Var.setContentDescription(i00Var.f27635b);
        j00Var.requestLayout();
        boolean z10 = j00Var.f27957n;
        i00 i00Var2 = j00Var.f27944b;
        if (i00Var2 != null && i00Var2.f27639g) {
            z4 = true;
        } else {
            z4 = false;
        }
        if (z10 != z4) {
            u5.release(j00Var, j00Var.f27958r);
            ...
            if (j00Var.f27955i0) {
                ...
                j00Var.f27958r = u5.update(i12, j00Var, j00Var.f27958r, j00Var.f27959s);
                if (j00Var.f27944b.f27639g) {
                    i13 = 26;
                } else {
                    i13 = 0;
            ...
            j00Var.f27957n = j00Var.f27944b.f27639g;
        }
        if (i11 != j00Var.getId()) {
            if (j00Var.f27944b.f27638f) {
                f10 = 1.0f;
            } else {
                f10 = 0.0f;
            }
    ...
    public final f2.m1 x(ViewGroup viewGroup, int i10) {
        return new f2.m1(new j00(this.d, this.f27342c));
    }
}
