...
public final class dd {
    public static final int[] f23314p = {16842910, 16842919};
    public uq f23315a;
    public final ArrayList f23316b = new ArrayList();
    public int f23317c;
    public boolean d;
    public final org.telegram.ui.Cells.z e;
    public final View f23318f;
    public final Paint f23319g;
    public Runnable h;
    public boolean f23320i;
    public Runnable f23321j;
    public final org.telegram.ui.Cells.l7 f23322k;
    public boolean f23323l;
    public final CornerPathEffect f23324m;
    public boolean f23325n;
    public final Paint f23326o;

    public dd(View view) {
        Paint paint = new Paint(1);
        this.f23319g = paint;
        this.f23322k = new org.telegram.ui.Cells.l7(this, 5);
        this.f23318f = view;
        CornerPathEffect cornerPathEffect = new CornerPathEffect(AndroidUtilities.dp(12.0f));
        this.f23324m = cornerPathEffect;
        ...
        paint3.setColor(-1);
        ?? rippleDrawable = new RippleDrawable(new ColorStateList(new int[][]{StateSet.WILD_CARD}, new int[]{org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18953i6, false) & 436207615}), null, new cd(this, paint3));
        this.e = rippleDrawable;
        rippleDrawable.setCallback(view);
    }

    public final void a(RectF rectF) {
        int i10 = this.f23317c + 1;
        this.f23317c = i10;
        ArrayList arrayList = this.f23316b;
        if (i10 > arrayList.size()) {
            arrayList.add(new RectF());
        }
        ((RectF) arrayList.get(this.f23317c - 1)).set(rectF);
    }
    ...
    public final boolean b(MotionEvent motionEvent) {
        ...
        View view = this.f23318f;
        org.telegram.ui.Cells.l7 l7Var = this.f23322k;
        org.telegram.ui.Cells.z zVar = this.e;
        if (action == 0) {
            for (int i10 = 0; i10 < this.f23317c; i10++) {
                float f7 = x10;
                float f10 = y3;
                if (((RectF) this.f23316b.get(i10)).contains(f7, f10)) {
                    this.d = true;
                    if (zVar != null) {
                        zVar.setHotspot(f7, f10);
                        zVar.setState(f23314p);
                    }
    ...
    public final void c(Canvas canvas, Paint paint) {
        ...
        CornerPathEffect cornerPathEffect = this.f23324m;
        org.telegram.ui.Cells.z zVar = this.e;
        int i11 = 0;
        ArrayList arrayList = this.f23316b;
        if (i10 > 1) {
            if (!this.f23320i) {
                uq uqVar = this.f23315a;
                if (uqVar == null) {
                    this.f23315a = new uq(0);
                } else {
                    uqVar.rewind();
                }
                int i12 = 0;
                ...
                while (true) {
                    ...
                    this.f23315a.addRect((RectF) arrayList.get(i11), Path.Direction.CCW);
                    if (zVar != null) {
