...
public final class m01 extends ReplacementSpan {
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f10, int i12, int i13, int i14, Paint paint) {
        int i15 = this.f28878b;
        int i16 = this.f28879c;
        ImageReceiver imageReceiver = this.f28877a;
        canvas.save();
        if (this.d) {
            imageReceiver.setImageCoords((int) f10, i13 - (i16 - this.f28880e), i15, i16);
        } else {
    ...
    public final int getSize(Paint paint, CharSequence charSequence, int i10, int i11, Paint.FontMetricsInt fontMetricsInt) {
        int i12 = this.f28879c;
        if (fontMetricsInt != null) {
            if (this.d) {
                int i13 = this.f28880e;
                int i14 = -(i12 - i13);
