...
public abstract class oe0 {
    public static int f27061a = 1500;
    ...
    public static void g(String[] strArr, Utilities.Callback callback) {
        ...
        if (activity != null) {
            if (Build.VERSION.SDK_INT >= 23) {
                int i11 = f27061a;
                f27061a = i11 + 1;
                NotificationCenter.NotificationCenterDelegate[] notificationCenterDelegateArr = {new ne0(i11, callback, notificationCenterDelegateArr)};
