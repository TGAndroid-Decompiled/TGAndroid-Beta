...
public final class fs extends za {
    ...
    public final boolean f23984a0;
    public final ArrayList f23985b0;
    public final long f23986c0;
    public final int f23987d0;
    public final int f23988e0;
    public final Runnable f23989f0;
    public boolean f23990g0;
    public final boolean f23991h0;
    public final es f23992i0;
    public final es f23993j0;
    public final es f23994k0;
    public final es f23995l0;
    public final boolean[] m0;
    public final boolean[] f23996n0;
    public final boolean f23997o0;
    public boolean f23998p0;
    public final long f23999q0;
    public TL_communities.ParticipantJoinedChats f24000r0;
    public int[] f24001s0;
    public boolean f24002t0;
    public boolean f24003u0;
    public final TLRPC.TL_chatBannedRights f24004v0;
    public final TLRPC.TL_chatBannedRights f24005w0;
    public final ArrayList f24006x0;
    public boolean f24007y0;
    public final boolean f24008z0;
    ...
    public static void P(fs fsVar, TLObject tLObject, TLRPC.InputPeer inputPeer, int i10, int[] iArr) {
        if (tLObject instanceof TLRPC.TL_messages_channelMessages) {
            fsVar.f24001s0[i10] = ((TLRPC.TL_messages_channelMessages) tLObject).count - ((int) Collection.EL.stream(fsVar.f23985b0).filter(new cs(0, inputPeer)).count());
        }
        int i11 = iArr[0] - 1;
        iArr[0] = i11;
        if (i11 == 0) {
            fsVar.f24002t0 = false;
            fsVar.f24003u0 = true;
            fsVar.O();
        }
    }
    ...
    public static void Q(fs fsVar) {
        ...
        long j3 = fsVar.f23999q0;
        ArrayList<Long> arrayList = fsVar.f24000r0.joined_chat_ids;
        boolean z11 = false;
    ...
    public final boolean S() {
        TLRPC.TL_chatBannedRights tL_chatBannedRights = this.f24004v0;
    ...
    public final void T(ArrayList arrayList, es esVar) {
        boolean z10;
        boolean c10 = esVar.c();
        int i10 = esVar.f23664g;
        int i11 = esVar.f23660a;
        if (c10) {
            boolean z11 = false;
            if (!esVar.b()) {
                j51 y3 = j51.y(i11, esVar.f23661b);
                if (esVar.f23665i > 0) {
                    z11 = true;
                }
                y3.K(z11);
            ...
            String str = esVar.f23661b;
            int i12 = esVar.f23665i;
            if (i12 <= 0) {
                if (esVar.e != null) {
                    i12 = esVar.h;
                } else {
            ...
            if (!esVar.f23663f) {
                for (int i13 = 0; i13 < i10; i13++) {
                    ...
                    if (zArr == null || zArr[i13]) {
                        ...
                        j51Var2.G = (TLObject) esVar.f23662c.get(i13);
    ...
    public final void U() {
        if (this.f24003u0) {
            O();
        } else if (!this.f24002t0) {
            this.f24002t0 = true;
            es esVar = this.f23993j0;
            int i10 = esVar.f23664g;
            this.f24001s0 = new int[i10];
            int[] iArr = {i10};
            for (int i11 = 0; i11 < esVar.f23664g; i11++) {
                TLRPC.TL_messages_search tL_messages_search = new TLRPC.TL_messages_search();
                tL_messages_search.peer = MessagesController.getInputPeer(this.Y);
                tL_messages_search.f18230q = "";
                TLRPC.InputPeer inputPeer = MessagesController.getInputPeer((TLObject) esVar.f23662c.get(i11));
    ...
    public final void V() {
        boolean z10;
        boolean z11;
        boolean z12 = this.f23990g0;
        boolean z13 = false;
        es esVar = this.f23995l0;
        if (z12 && esVar.c()) {
            if (esVar.f23665i > 0) {
                z11 = true;
            } else {
        ...
        if (this.f23990g0 && esVar.c() && esVar.f23665i == 0) {
            esVar.d();
        } else if (!this.f23990g0 && esVar.c()) {
            boolean z14 = this.E0;
            if (esVar.f23665i > 0) {
                z10 = true;
            } else {
    ...
    public final void dismiss() {
        ...
        edit.putBoolean("delete_report", this.f23992i0.a());
        edit.putBoolean("delete_deleteAll", this.f23993j0.a());
        if (!this.f23990g0 && this.f23995l0.a()) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final ll0 v(ml0 ml0Var) {
        x51 x51Var = new x51(ml0Var, getContext(), this.currentAccount, this.f30451n.getClassGuid(), true, new yr(this, 0), this.resourcesProvider);
        this.X = x51Var;
    ...
    public final CharSequence y() {
        ...
        ArrayList arrayList = this.f23985b0;
        if (arrayList != null) {
            i10 = arrayList.size();
        } else {
            i10 = 0;
        ...
        int[] iArr = {i10};
        if (this.f24001s0 != null && this.f24003u0) {
            int i11 = 0;
            while (true) {
                es esVar = this.f23993j0;
                if (i11 >= esVar.f23664g) {
                    break;
                }
                if (esVar.d[i11] && ((zArr = esVar.e) == null || zArr[i11])) {
                    TLObject tLObject = (TLObject) esVar.f23662c.get(i11);
                    iArr[0] = iArr[0] + this.f24001s0[i11];
                }
                i11++;
            }
        }
