...
public final class fs {
    ...
    public final boolean a() {
        boolean[] zArr;
        for (int i10 = 0; i10 < this.f24085g; i10++) {
    ...
    public final void g() {
        ...
        int i10 = this.f24085g;
        if (i10 != 0) {
            for (int i11 = 0; i11 < i10; i11++) {
                boolean[] zArr = this.e;
                if (zArr == null || zArr[i11]) {
                    tLObject = (TLObject) this.f24083c.get(i11);
                    break;
                }
            }
            tLObject = null;
            ...
            if (i12 == 0) {
                this.f24082b = LocaleController.getString(R.string.DeleteReportSpam);
            } else if (i12 == 1) {
                if (b()) {
                ...
                this.f24082b = formatString3;
            } else if (i12 == 2) {
                if (this.f24087j.f24405g0) {
                    if (b()) {
