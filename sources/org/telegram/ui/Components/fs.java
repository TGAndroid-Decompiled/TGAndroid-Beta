...
public final class fs extends za {
    ...
    public final boolean f24060a0;
    public final ArrayList f24061b0;
    public final long f24062c0;
    public final int f24063d0;
    public final int f24064e0;
    public final Runnable f24065f0;
    public boolean f24066g0;
    public final boolean f24067h0;
    public final es f24068i0;
    public final es f24069j0;
    public final es f24070k0;
    public final es f24071l0;
    public final boolean[] m0;
    public final boolean[] f24072n0;
    public final boolean f24073o0;
    public boolean f24074p0;
    public final long f24075q0;
    public TL_communities.ParticipantJoinedChats f24076r0;
    public int[] f24077s0;
    public boolean f24078t0;
    public boolean f24079u0;
    public final TLRPC.TL_chatBannedRights f24080v0;
    public final TLRPC.TL_chatBannedRights f24081w0;
    public final ArrayList f24082x0;
    public boolean f24083y0;
    public final boolean f24084z0;
    ...
    public static void P(fs fsVar, TLObject tLObject, TLRPC.InputPeer inputPeer, int i10, int[] iArr) {
        if (tLObject instanceof TLRPC.TL_messages_channelMessages) {
            fsVar.f24077s0[i10] = ((TLRPC.TL_messages_channelMessages) tLObject).count - ((int) Collection.EL.stream(fsVar.f24061b0).filter(new cs(0, inputPeer)).count());
        }
        int i11 = iArr[0] - 1;
        iArr[0] = i11;
        if (i11 == 0) {
            fsVar.f24078t0 = false;
            fsVar.f24079u0 = true;
            fsVar.O();
        }
    }
    ...
    public static void Q(fs fsVar) {
        ...
        long j3 = fsVar.f24075q0;
        ArrayList<Long> arrayList = fsVar.f24076r0.joined_chat_ids;
        boolean z11 = false;
    ...
    public final boolean S() {
        TLRPC.TL_chatBannedRights tL_chatBannedRights = this.f24080v0;
    ...
    public final void T(ArrayList arrayList, es esVar) {
        boolean z10;
        boolean c10 = esVar.c();
        int i10 = esVar.f23746g;
        int i11 = esVar.f23742a;
        if (c10) {
            boolean z11 = false;
            if (!esVar.b()) {
                i51 y3 = i51.y(i11, esVar.f23743b);
                if (esVar.f23747i > 0) {
                    z11 = true;
                }
                y3.K(z11);
            ...
            String str = esVar.f23743b;
            int i12 = esVar.f23747i;
            if (i12 <= 0) {
                if (esVar.e != null) {
                    i12 = esVar.h;
                } else {
            ...
            if (!esVar.f23745f) {
                for (int i13 = 0; i13 < i10; i13++) {
                    ...
                    if (zArr == null || zArr[i13]) {
                        ...
                        i51Var2.G = (TLObject) esVar.f23744c.get(i13);
    ...
    public final void U() {
        if (this.f24079u0) {
            O();
        } else if (!this.f24078t0) {
            this.f24078t0 = true;
            es esVar = this.f24069j0;
            int i10 = esVar.f23746g;
            this.f24077s0 = new int[i10];
            int[] iArr = {i10};
            for (int i11 = 0; i11 < esVar.f23746g; i11++) {
                TLRPC.TL_messages_search tL_messages_search = new TLRPC.TL_messages_search();
                tL_messages_search.peer = MessagesController.getInputPeer(this.Y);
                tL_messages_search.f18218q = "";
                TLRPC.InputPeer inputPeer = MessagesController.getInputPeer((TLObject) esVar.f23744c.get(i11));
    ...
    public final void V() {
        boolean z10;
        boolean z11;
        boolean z12 = this.f24066g0;
        boolean z13 = false;
        es esVar = this.f24071l0;
        if (z12 && esVar.c()) {
            if (esVar.f23747i > 0) {
                z11 = true;
            } else {
        ...
        if (this.f24066g0 && esVar.c() && esVar.f23747i == 0) {
            esVar.d();
        } else if (!this.f24066g0 && esVar.c()) {
            boolean z14 = this.E0;
            if (esVar.f23747i > 0) {
                z10 = true;
            } else {
    ...
    public final void dismiss() {
        ...
        edit.putBoolean("delete_report", this.f24068i0.a());
        edit.putBoolean("delete_deleteAll", this.f24069j0.a());
        if (!this.f24066g0 && this.f24071l0.a()) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final kl0 v(ll0 ll0Var) {
        w51 w51Var = new w51(ll0Var, getContext(), this.currentAccount, this.f30525n.getClassGuid(), true, new yr(this, 0), this.resourcesProvider);
        this.X = w51Var;
    ...
    public final CharSequence y() {
        ...
        ArrayList arrayList = this.f24061b0;
        if (arrayList != null) {
            i10 = arrayList.size();
        } else {
            i10 = 0;
        ...
        int[] iArr = {i10};
        if (this.f24077s0 != null && this.f24079u0) {
            int i11 = 0;
            while (true) {
                es esVar = this.f24069j0;
                if (i11 >= esVar.f23746g) {
                    break;
                }
                if (esVar.d[i11] && ((zArr = esVar.e) == null || zArr[i11])) {
                    TLObject tLObject = (TLObject) esVar.f23744c.get(i11);
                    iArr[0] = iArr[0] + this.f24077s0[i11];
                }
                i11++;
            }
        }
