...
public final class fs {
    ...
    public final boolean a() {
        boolean[] zArr;
        for (int i10 = 0; i10 < this.f24267g; i10++) {
        ...
        if (i10 != 0) {
            for (int i11 = 0; i11 < i10; i11++) {
                ...
                if (zArr == null || zArr[i11]) {
                    tLObject = (TLObject) this.f24265c.get(i11);
                    break;
                }
            }
            tLObject = null;
            ...
            int i12 = this.f24263a;
            if (i12 == 0) {
                this.f24264b = LocaleController.getString(R.string.DeleteReportSpam);
            } else if (i12 == 1) {
                if (b()) {
                ...
                this.f24264b = formatString3;
            } else if (i12 == 2) {
                if (this.f24269j.f24509g0) {
                    if (b()) {
