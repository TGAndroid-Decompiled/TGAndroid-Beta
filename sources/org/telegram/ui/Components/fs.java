...
public final class fs extends ab {
    ...
    public final boolean f24158a0;
    public final ArrayList f24159b0;
    public final long f24160c0;
    public final int f24161d0;
    public final int f24162e0;
    public final Runnable f24163f0;
    public boolean f24164g0;
    public final boolean f24165h0;
    public final es f24166i0;
    public final es f24167j0;
    public final es f24168k0;
    public final es f24169l0;
    public final boolean[] m0;
    public final boolean[] f24170n0;
    public final boolean f24171o0;
    public boolean f24172p0;
    public final long f24173q0;
    public TL_communities.ParticipantJoinedChats f24174r0;
    public int[] f24175s0;
    public boolean f24176t0;
    public boolean f24177u0;
    public final TLRPC.TL_chatBannedRights f24178v0;
    public final TLRPC.TL_chatBannedRights f24179w0;
    public final ArrayList f24180x0;
    public boolean f24181y0;
    public final boolean f24182z0;
    ...
    public static void P(fs fsVar, TLObject tLObject, TLRPC.InputPeer inputPeer, int i10, int[] iArr) {
        if (tLObject instanceof TLRPC.TL_messages_channelMessages) {
            fsVar.f24175s0[i10] = ((TLRPC.TL_messages_channelMessages) tLObject).count - ((int) Collection.EL.stream(fsVar.f24159b0).filter(new cs(0, inputPeer)).count());
        }
        int i11 = iArr[0] - 1;
        iArr[0] = i11;
        if (i11 == 0) {
            fsVar.f24176t0 = false;
            fsVar.f24177u0 = true;
            fsVar.O();
        }
    }
    ...
    public static void Q(fs fsVar) {
        ...
        long j3 = fsVar.f24173q0;
        ArrayList<Long> arrayList = fsVar.f24174r0.joined_chat_ids;
        boolean z11 = false;
    ...
    public final boolean S() {
        TLRPC.TL_chatBannedRights tL_chatBannedRights = this.f24178v0;
    ...
    public final void T(ArrayList arrayList, es esVar) {
        boolean z10;
        boolean c10 = esVar.c();
        int i10 = esVar.f23928g;
        int i11 = esVar.f23924a;
        if (c10) {
            boolean z11 = false;
            if (!esVar.b()) {
                w51 y3 = w51.y(i11, esVar.f23925b);
                if (esVar.f23929i > 0) {
                    z11 = true;
                }
                y3.K(z11);
            ...
            String str = esVar.f23925b;
            int i12 = esVar.f23929i;
            if (i12 <= 0) {
                if (esVar.e != null) {
                    i12 = esVar.h;
                } else {
            ...
            if (!esVar.f23927f) {
                for (int i13 = 0; i13 < i10; i13++) {
                    ...
                    if (zArr == null || zArr[i13]) {
                        ...
                        w51Var2.G = (TLObject) esVar.f23926c.get(i13);
    ...
    public final void U() {
        if (this.f24177u0) {
            O();
        } else if (!this.f24176t0) {
            this.f24176t0 = true;
            es esVar = this.f24167j0;
            int i10 = esVar.f23928g;
            this.f24175s0 = new int[i10];
            int[] iArr = {i10};
            for (int i11 = 0; i11 < esVar.f23928g; i11++) {
                TLRPC.TL_messages_search tL_messages_search = new TLRPC.TL_messages_search();
                tL_messages_search.peer = MessagesController.getInputPeer(this.Y);
                tL_messages_search.f18437q = "";
                TLRPC.InputPeer inputPeer = MessagesController.getInputPeer((TLObject) esVar.f23926c.get(i11));
    ...
    public final void V() {
        boolean z10;
        boolean z11;
        boolean z12 = this.f24164g0;
        boolean z13 = false;
        es esVar = this.f24169l0;
        if (z12 && esVar.c()) {
            if (esVar.f23929i > 0) {
                z11 = true;
            } else {
        ...
        if (this.f24164g0 && esVar.c() && esVar.f23929i == 0) {
            esVar.d();
        } else if (!this.f24164g0 && esVar.c()) {
            boolean z14 = this.E0;
            if (esVar.f23929i > 0) {
                z10 = true;
            } else {
    ...
    public final void dismiss() {
        ...
        edit.putBoolean("delete_report", this.f24166i0.a());
        edit.putBoolean("delete_deleteAll", this.f24167j0.a());
        if (!this.f24164g0 && this.f24169l0.a()) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final ul0 v(vl0 vl0Var) {
        k61 k61Var = new k61(vl0Var, getContext(), this.currentAccount, this.f22638n.getClassGuid(), true, new yr(this, 0), this.resourcesProvider);
        this.X = k61Var;
    ...
    public final CharSequence y() {
        ...
        ArrayList arrayList = this.f24159b0;
        if (arrayList != null) {
            i10 = arrayList.size();
        } else {
            i10 = 0;
        ...
        int[] iArr = {i10};
        if (this.f24175s0 != null && this.f24177u0) {
            int i11 = 0;
            while (true) {
                es esVar = this.f24167j0;
                if (i11 >= esVar.f23928g) {
                    break;
                }
                if (esVar.d[i11] && ((zArr = esVar.e) == null || zArr[i11])) {
                    TLObject tLObject = (TLObject) esVar.f23926c.get(i11);
                    iArr[0] = iArr[0] + this.f24175s0[i11];
                }
                i11++;
            }
        }
