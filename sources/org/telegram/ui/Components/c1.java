...
public final class c1 implements View.OnClickListener {
    ...
    public final org.telegram.ui.Cells.a2[] f23098b;

    public c1(org.telegram.ui.Cells.a2[] a2VarArr, int i10) {
        this.f23097a = i10;
        this.f23098b = a2VarArr;
    }
    ...
    public final void onClick(View view) {
        switch (this.f23097a) {
            case 0:
                ...
                org.telegram.ui.Cells.a2[] a2VarArr = this.f23098b;
                a2VarArr[intValue].c(!a2VarArr[num.intValue()].b(), true);
                return;
            default:
                Integer num2 = (Integer) view.getTag();
                int intValue2 = num2.intValue();
                org.telegram.ui.Cells.a2[] a2VarArr2 = this.f23098b;
