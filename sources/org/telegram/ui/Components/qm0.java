...
public final class qm0 implements al0 {
    ...
    public final FrameLayout f27358c;

    public qm0(FrameLayout frameLayout, int i10, int i11) {
        this.f27356a = i11;
        this.f27358c = frameLayout;
        this.f27357b = i10;
    }
            ...
            case 0:
                ...
                if (E != null) {
                    ...
                    if (view instanceof sm0) {
                        org.telegram.ui.Cells.j7 j7Var = ((sm0) view).f27890a;
                        ...
                        if (j7Var.G) {
                            ...
                            j7Var.f(true);
                            DownloadController.getInstance(this.f27357b).updateFilesLoadingPriority();
                        } else {
                ...
                return;
            case 1:
                org.telegram.ui.wp0 wp0Var2 = (org.telegram.ui.wp0) this.f27358c;
                org.telegram.ui.cq0 cq0Var = wp0Var2.f39152p0;
                ArrayList arrayList2 = wp0Var2.f39148l0;
                if (view instanceof org.telegram.ui.vp0) {
                    org.telegram.ui.vp0 vp0Var = (org.telegram.ui.vp0) view;
                    int i15 = wp0Var2.m0;
                    if (wp0Var2.f39151o0 == null) {
                        m5 m5Var = vp0Var.f38492c;
                        ...
                        sp0Var.f34465g1 = true;
                        long j10 = wp0Var2.f39149n;
                        if (j10 == 0) {
                            valueOf = null;
                        } else {
                ...
                int i17 = wp0Var2.V;
                int i18 = this.f27357b;
                if (i10 == i17) {
                    wp0Var2.h = -1;
                    wp0Var2.f39149n = 0L;
                    wp0Var2.f39153r = null;
                    wp0Var2.f39154s = null;
                    wp0Var2.I = null;
                    wp0Var2.i();
                    if (i18 == 0) {
                        cq0Var.h.i();
                    }
                    org.telegram.ui.vp0 vp0Var2 = wp0Var2.f39157y;
                    if (vp0Var2 != null) {
                        vp0Var2.b(true);
                    }
                    wp0Var2.j(true);
                    wp0Var2.f(true);
                    org.telegram.ui.wp0 wp0Var3 = cq0Var.f32866n;
                    if (wp0Var3 != null && (aq0Var = wp0Var3.f39133a) != null && (wp0Var = cq0Var.h) != null) {
                        aq0Var.a(wp0Var.h);
                        return;
                    }
                    return;
                }
                int i19 = wp0Var2.f39136b0;
                if (i10 >= i19 && i10 < wp0Var2.f39138c0) {
                    int i20 = i10 - i19;
                    if (wp0Var2.K == null) {
                        if (i20 >= 0 && i20 < arrayList2.size()) {
                            ...
                            if (i18 == 1) {
                                ...
                                if (peerColor instanceof TLRPC.TL_peerColorCollectible) {
                                    ...
                                    wp0Var2.I = null;
                                    wp0Var2.f39153r = null;
                                    wp0Var2.f39154s = (TLRPC.TL_peerColorCollectible) peerColor;
                                } else {
                                    return;
                                }
                            } else {
                                ...
                                wp0Var2.h = -1;
                                wp0Var2.I = null;
                                wp0Var2.f39153r = MessagesController.emojiStatusCollectibleFromGift(tL_starGiftUnique);
                                wp0Var2.f39154s = null;
                            }
                            wp0Var2.j(true);
                            wp0Var2.i();
                            wp0Var2.f(true);
                            org.telegram.ui.vp0 vp0Var3 = wp0Var2.f39157y;
                            if (vp0Var3 != null) {
                                vp0Var3.b(true);
                                return;
                            }
                        ...
                        if (i18 == 1) {
                            ...
                            if (peerColor2 instanceof TLRPC.TL_peerColorCollectible) {
                                ...
                                wp0Var2.h = -1;
                                wp0Var2.f39153r = null;
                                wp0Var2.f39154s = (TLRPC.TL_peerColorCollectible) peerColor2;
                            } else {
                                return;
                            }
                        } else {
                            wp0Var2.f39149n = 0L;
                            wp0Var2.h = -1;
                            wp0Var2.f39153r = MessagesController.emojiStatusCollectibleFromGift(tL_starGiftUnique2);
                            wp0Var2.f39154s = null;
                        }
                        ...
                        wp0Var2.i();
                        wp0Var2.f(true);
                        org.telegram.ui.vp0 vp0Var4 = wp0Var2.f39157y;
                        if (vp0Var4 != null) {
                            vp0Var4.b(true);
                            return;
                        }
                ...
                return;
            default:
                org.telegram.ui.i71 i71Var = (org.telegram.ui.i71) this.f27358c;
                boolean z12 = view instanceof org.telegram.ui.r61;
                int i21 = this.f27357b;
                try {
                    if (z12) {
                        org.telegram.ui.r61 r61Var = (org.telegram.ui.r61) view;
                        if (!r61Var.f37104s && (((p0Var = r61Var.f37106x) == null || !p0Var.f49152a) && i21 != 13 && i21 != 14)) {
                            ...
                            i71Var.l();
                            i71Var.r(r61Var, r61Var.f37106x);
                        }
                        if (i21 != 1 && i21 != 11) {
