...
public final class qm0 extends Transition {
    ...
    public final void captureEndValues(TransitionValues transitionValues) {
        ...
        switch (this.f27706a) {
            ...
            case 1:
                ...
                fy0 fy0Var = (fy0) this.f27707b;
                viewGroup = ((org.telegram.ui.ActionBar.e3) fy0Var).containerView;
                map.put("offset", Integer.valueOf(viewGroup.getTop() + fy0Var.f24274e0));
                return;
            case 2:
                View view = transitionValues.view;
                PhotoViewer photoViewer = (PhotoViewer) this.f27707b;
            ...
            default:
                ...
                SecretMediaViewer secretMediaViewer = (SecretMediaViewer) this.f27707b;
                if (view2 == secretMediaViewer.Z) {
                    transitionValues.values.put("translationY", Integer.valueOf(secretMediaViewer.f31709a0.getPendingMarginTopDiff()));
                    return;
                }
                return;
        }
    ...
    public final void captureStartValues(TransitionValues transitionValues) {
        ...
        switch (this.f27706a) {
            ...
            case 2:
                View view = transitionValues.view;
                org.telegram.ui.tt0 tt0Var = ((PhotoViewer) this.f27707b).T1;
                if (view == tt0Var) {
            ...
            default:
                View view2 = transitionValues.view;
                org.telegram.ui.tt0 tt0Var2 = ((SecretMediaViewer) this.f27707b).f31709a0;
                if (view2 == tt0Var2) {
    ...
    public final Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        switch (i10) {
            ...
            default:
                ...
                if (transitionValues.view == secretMediaViewer.f31709a0) {
