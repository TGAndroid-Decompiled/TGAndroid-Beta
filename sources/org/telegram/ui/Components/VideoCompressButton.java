...
public class VideoCompressButton extends View {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        float fMax = Math.max(AndroidUtilities.dpf2(21.33f), this.textDrawable.getCurrentWidth() + AndroidUtilities.dpf2(6.0f));
        ...
        rect.set((int) ((AndroidUtilities.dpf2(16.0f) + (getWidth() / 2.0f)) - (this.sizeTextDrawable.getCurrentWidth() + (AndroidUtilities.dpf2(2.0f) * this.sizeTextDrawable.isNotEmpty()))), (int) ((getHeight() / 2.0f) - AndroidUtilities.dpf2(14.0f)), (int) (AndroidUtilities.dpf2(16.0f) + (getWidth() / 2.0f)), (int) (((getHeight() / 2.0f) - AndroidUtilities.dpf2(14.0f)) + AndroidUtilities.dpf2(8.33f)));
        rectF.set(rect);
        ...
        canvas.saveLayerAlpha(0.0f, 0.0f, getWidth(), getHeight(), 255, 31);
        rectF.set(rect);
        this.fillPaint.setAlpha((int) (this.sizeTextDrawable.isNotEmpty() * f));
