...
public final class lu0 extends tk0 {
    public final Context f26008c;
    public final int d;
    public boolean e;
    public final yu0 f26009f;
    ...
    public final String F(int i10) {
        ArrayList arrayList = this.f26009f.f30388t1[this.d].e;
    ...
    public final void J(ll0 ll0Var) {
        if (this.e) {
            ...
            if (i10 == 0) {
                this.f26009f.S(this.d, ll0Var, true);
            }
        }
    }
    ...
    public final int h() {
        int i10;
        int i11;
        nu0[] nu0VarArr = this.f26009f.f30388t1;
        int i12 = this.d;
        nu0 nu0Var = nu0VarArr[i12];
        if (nu0Var.f26587o) {
            return nu0Var.e();
        }
        if (nu0Var.f26576a.size() == 0 && !nu0VarArr[i12].f26580g) {
            return 1;
        }
        if (nu0VarArr[i12].f26576a.size() == 0) {
            nu0 nu0Var2 = nu0VarArr[i12];
            boolean[] zArr = nu0Var2.f26581i;
            if ((!zArr[0] || !zArr[1]) && nu0Var2.f26584l) {
                return 0;
            }
        }
        if (nu0VarArr[i12].e() == 0) {
            ...
            if (size != 0) {
                ...
                boolean[] zArr2 = nu0Var3.f26581i;
                if (!zArr2[0] || !zArr2[1]) {
                    boolean z10 = nu0Var3.f26590r;
                    if (z10) {
                        i10 = nu0Var3.f26593u;
                    } else {
                        i10 = nu0Var3.f26586n;
    ...
    public final int j(int i10) {
        nu0[] nu0VarArr = this.f26009f.f30388t1;
        int i11 = this.d;
        if (nu0VarArr[i11].f26578c.size() == 0 && !nu0VarArr[i11].f26580g) {
            return 9;
        }
        nu0 nu0Var = nu0VarArr[i11];
        int i12 = nu0Var.f26585m;
        if (i10 >= i12 && i10 < nu0Var.f26576a.size() + i12) {
            if (i11 != 2 && i11 != 4) {
                return 7;
            }
            return 10;
    ...
    @Override
    public final int k() {
        return this.f26009f.f30388t1[this.d].e();
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        boolean z11;
        char c11;
        yu0 yu0Var = this.f26009f;
        long j3 = yu0Var.f30367j1;
        SparseArray[] sparseArrayArr = yu0Var.Z0;
        nu0 nu0Var = yu0Var.f30388t1[this.d];
        ArrayList arrayList = nu0Var.f26576a;
        ...
        if (i11 != 7) {
            if (i11 == 10 && (view instanceof org.telegram.ui.Cells.i7)) {
                ...
                MessageObject messageObject = (MessageObject) arrayList.get(i10 - nu0Var.f26585m);
            ...
            MessageObject messageObject2 = (MessageObject) arrayList.get(i10 - nu0Var.f26585m);
            if (i10 != arrayList.size() - 1) {
                z10 = true;
            } else {
                z10 = false;
        ...
        if (i10 != 7) {
            ...
            if (i10 != 8) {
                if (i10 != 9) {
                    ...
                    lt0 M = yu0.M(i11, yu0Var.f30367j1, context, e6Var);
