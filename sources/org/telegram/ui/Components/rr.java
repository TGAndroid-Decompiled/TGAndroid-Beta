...
public final class rr implements Interpolator {
    public static final rr f28022f = new rr(0.25d, 0.1d, 0.25d, 1.0d);
    public static final rr f28023g = new rr(0.0d, 0.0d, 0.58d, 1.0d);
    public static final rr h = new rr(0.23d, 1.0d, 0.32d, 1.0d);
    public static final rr f28024i = new rr(0.42d, 0.0d, 1.0d, 1.0d);
    public static final rr f28025j = new rr(0.42d, 0.0d, 0.58d, 1.0d);
    public static final rr f28026k = new rr(0.34d, 1.56d, 0.64d, 1.0d);
    public static final PathInterpolator f28027l;
    public final PointF f28028a;
    public final PointF f28029b;
    public final PointF f28030c;
    ...
    public final float getInterpolation(float f7) {
        ...
        while (true) {
            pointF = this.f28029b;
            pointF2 = this.f28028a;
            pointF3 = this.f28030c;
            pointF4 = this.d;
            pointF5 = this.e;
            if (i10 >= 14) {
                break;
