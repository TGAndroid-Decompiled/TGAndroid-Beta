...
public final class rr extends ViewGroup {
    public static final int f28567s = 0;
    public final or f28568a;
    public EditText f28569b;
    ...
    public final nr f28573r;

    public rr(Context context) {
        super(context);
        String str;
        int i10;
        this.f28570c = new View[12];
        this.h = new nr(this, 0);
        this.f28573r = new nr(this, 1);
        int i11 = 0;
        for (int i12 = 0; i12 < 11; i12++) {
            if (i12 != 9) {
                ...
                this.f28570c[i12] = new qr(context, valueOf, str);
                this.f28570c[i12].setOnClickListener(new w2(12, this, valueOf));
                addView(this.f28570c[i12]);
            }
        }
        ...
        this.f28570c[11] = orVar;
        addView(orVar);
        while (true) {
            View[] viewArr = this.f28570c;
