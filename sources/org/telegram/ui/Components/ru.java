...
public final class ru implements n91 {
    ...
    public final TextureView a(View view, boolean z10, float f7, int i10, boolean z11) {
        ...
        vu vuVar = this.f27969a;
        FrameLayout frameLayout = vuVar.e;
        Activity activity = vuVar.f29763r;
        if (z10) {
            frameLayout.setVisibility(0);
            frameLayout.setAlpha(1.0f);
            frameLayout.addView(vuVar.f29760c.getAspectRatioView());
            vuVar.N = false;
            vuVar.M = z11;
            if (activity != null) {
                try {
    ...
    public final void e(q91 q91Var, boolean z10) {
        Activity activity = this.f27969a.f29763r;
        if (z10) {
            try {
    ...
    public final TextureView f(View view, boolean z10, int i10, int i11, boolean z11) {
        ...
        if (z10) {
            ...
            TextureView textureView = new TextureView(vuVar.f29763r);
            if (!pg0.x(false, vuVar.f29763r, null, textureView, i10, i11, false)) {
                return null;
            }
            pg0.f27209p0.U = vuVar;
            return textureView;
        } else if (!z11) {
            viewGroup = ((org.telegram.ui.ActionBar.f3) vuVar).containerView;
    ...
    public final void i(boolean z10, i91 i91Var, float f7, boolean z11) {
        ...
        if (z10) {
            vu vuVar = this.f27969a;
            if (vuVar.f29763r != null) {
                try {
                    viewGroup3 = ((org.telegram.ui.ActionBar.f3) vuVar).containerView;
                    viewGroup3.setSystemUiVisibility(0);
                    vu vuVar2 = this.f27969a;
                    int i10 = vuVar2.L;
                    if (i10 != -2) {
                        vuVar2.f29763r.setRequestedOrientation(i10);
                    }
                } catch (Exception e) {
                    FileLog.e(e);
                }
            }
            if (this.f27969a.e.getVisibility() == 0) {
                viewGroup6 = ((org.telegram.ui.ActionBar.f3) this.f27969a).containerView;
                viewGroup7 = ((org.telegram.ui.ActionBar.f3) this.f27969a).containerView;
                viewGroup6.setTranslationY(AndroidUtilities.dp(10.0f) + viewGroup7.getMeasuredHeight());
                e3Var3 = ((org.telegram.ui.ActionBar.f3) this.f27969a).backDrawable;
                e3Var3.setAlpha(0);
            }
            this.f27969a.setOnShowListener(null);
            if (z11) {
                TextureView textureView = this.f27969a.f29760c.getTextureView();
                View controlsView = this.f27969a.f29760c.getControlsView();
                ImageView textureImageView = this.f27969a.f29760c.getTextureImageView();
                sk0 o9 = pg0.o(f7, true);
                float width = o9.f28188c / textureView.getWidth();
                AnimatorSet animatorSet = new AnimatorSet();
                Property property = View.SCALE_X;
                ...
                Property property3 = View.TRANSLATION_X;
                ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(textureImageView, property3, o9.f28186a);
                Property property4 = View.TRANSLATION_Y;
                ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(textureImageView, property4, o9.f28187b);
                ...
                ObjectAnimator ofFloat7 = ObjectAnimator.ofFloat(textureView, property3, o9.f28186a);
                ObjectAnimator ofFloat8 = ObjectAnimator.ofFloat(textureView, property4, o9.f28187b);
                viewGroup4 = ((org.telegram.ui.ActionBar.f3) this.f27969a).containerView;
                viewGroup5 = ((org.telegram.ui.ActionBar.f3) this.f27969a).containerView;
                ...
                e3Var2 = ((org.telegram.ui.ActionBar.f3) this.f27969a).backDrawable;
                ObjectAnimator ofInt = ObjectAnimator.ofInt(e3Var2, s6.d, 0);
                FrameLayout frameLayout = this.f27969a.e;
            ...
            if (this.f27969a.e.getVisibility() == 0) {
                this.f27969a.e.setAlpha(1.0f);
                this.f27969a.e.setVisibility(4);
            }
            i91Var.run();
            this.f27969a.dismissInternal();
            return;
        }
        if (ApplicationLoader.mainInterfacePaused) {
            try {
                this.f27969a.f29763r.startService(new Intent(ApplicationLoader.applicationContext, BringAppForegroundService.class));
            } catch (Throwable th2) {
                FileLog.e(th2);
            }
        }
        if (z11) {
            vu vuVar3 = this.f27969a;
            vuVar3.setOnShowListener(vuVar3.R);
            sk0 o10 = pg0.o(f7, false);
            TextureView textureView2 = this.f27969a.f29760c.getTextureView();
            ImageView textureImageView2 = this.f27969a.f29760c.getTextureImageView();
            float f10 = o10.f28188c / textureView2.getLayoutParams().width;
            textureImageView2.setScaleX(f10);
            textureImageView2.setScaleY(f10);
            textureImageView2.setTranslationX(o10.f28186a);
            textureImageView2.setTranslationY(o10.f28187b);
            textureView2.setScaleX(f10);
            textureView2.setScaleY(f10);
            textureView2.setTranslationX(o10.f28186a);
            textureView2.setTranslationY(o10.f28187b);
        } else {
            pg0.j(false);
        }
        this.f27969a.setShowWithoutAnimation(true);
        this.f27969a.show();
        if (z11) {
            vu vuVar4 = this.f27969a;
            vuVar4.P = 4;
            e3Var = ((org.telegram.ui.ActionBar.f3) vuVar4).backDrawable;
            e3Var.setAlpha(1);
            viewGroup = ((org.telegram.ui.ActionBar.f3) this.f27969a).containerView;
            viewGroup2 = ((org.telegram.ui.ActionBar.f3) this.f27969a).containerView;
