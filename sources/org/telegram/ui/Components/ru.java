...
public final class ru implements z81 {
    ...
    public final TextureView a(View view, boolean z10, float f7, int i10, boolean z11) {
        ...
        vu vuVar = this.f27690a;
        FrameLayout frameLayout = vuVar.e;
        Activity activity = vuVar.f29431r;
        if (z10) {
            frameLayout.setVisibility(0);
            frameLayout.setAlpha(1.0f);
            frameLayout.addView(vuVar.f29428c.getAspectRatioView());
            vuVar.N = false;
            vuVar.M = z11;
            if (activity != null) {
                try {
    ...
    public final void d() {
        ...
        vuVar.f29428c.g(null, null, null, null, false);
    ...
    public final void e(c91 c91Var, boolean z10) {
        Activity activity = this.f27690a.f29431r;
        if (z10) {
            try {
    ...
    public final TextureView f(View view, boolean z10, int i10, int i11, boolean z11) {
        ...
        if (z10) {
            ...
            TextureView textureView = new TextureView(vuVar.f29431r);
            if (!eg0.x(false, vuVar.f29431r, null, textureView, i10, i11, false)) {
                return null;
            }
            eg0.f23635p0.U = vuVar;
            return textureView;
        } else if (!z11) {
            viewGroup = ((org.telegram.ui.ActionBar.f3) vuVar).containerView;
    ...
    public final ViewGroup g() {
        return this.f27690a.container;
    }

    @Override
    public final boolean h() {
        return this.f27690a.G();
    }
    ...
    public final void i(boolean z10, t81 t81Var, float f7, boolean z11) {
        ...
        if (z10) {
            vu vuVar = this.f27690a;
            if (vuVar.f29431r != null) {
                try {
                    viewGroup3 = ((org.telegram.ui.ActionBar.f3) vuVar).containerView;
                    viewGroup3.setSystemUiVisibility(0);
                    vu vuVar2 = this.f27690a;
                    int i10 = vuVar2.L;
                    if (i10 != -2) {
                        vuVar2.f29431r.setRequestedOrientation(i10);
                    }
                } catch (Exception e) {
                    FileLog.e(e);
                }
            }
            if (this.f27690a.e.getVisibility() == 0) {
                viewGroup6 = ((org.telegram.ui.ActionBar.f3) this.f27690a).containerView;
                viewGroup7 = ((org.telegram.ui.ActionBar.f3) this.f27690a).containerView;
                viewGroup6.setTranslationY(AndroidUtilities.dp(10.0f) + viewGroup7.getMeasuredHeight());
                e3Var3 = ((org.telegram.ui.ActionBar.f3) this.f27690a).backDrawable;
                e3Var3.setAlpha(0);
            }
            this.f27690a.setOnShowListener(null);
            if (z11) {
                TextureView textureView = this.f27690a.f29428c.getTextureView();
                View controlsView = this.f27690a.f29428c.getControlsView();
                ImageView textureImageView = this.f27690a.f29428c.getTextureImageView();
                hk0 o9 = eg0.o(f7, true);
                float width = o9.f24714c / textureView.getWidth();
                AnimatorSet animatorSet = new AnimatorSet();
                Property property = View.SCALE_X;
                ...
                Property property3 = View.TRANSLATION_X;
                ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(textureImageView, property3, o9.f24712a);
                Property property4 = View.TRANSLATION_Y;
                ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(textureImageView, property4, o9.f24713b);
                ...
                ObjectAnimator ofFloat7 = ObjectAnimator.ofFloat(textureView, property3, o9.f24712a);
                ObjectAnimator ofFloat8 = ObjectAnimator.ofFloat(textureView, property4, o9.f24713b);
                viewGroup4 = ((org.telegram.ui.ActionBar.f3) this.f27690a).containerView;
                viewGroup5 = ((org.telegram.ui.ActionBar.f3) this.f27690a).containerView;
                ...
                e3Var2 = ((org.telegram.ui.ActionBar.f3) this.f27690a).backDrawable;
                ObjectAnimator ofInt = ObjectAnimator.ofInt(e3Var2, q6.d, 0);
                FrameLayout frameLayout = this.f27690a.e;
            ...
            if (this.f27690a.e.getVisibility() == 0) {
                this.f27690a.e.setAlpha(1.0f);
                this.f27690a.e.setVisibility(4);
            }
            t81Var.run();
            this.f27690a.dismissInternal();
            return;
        }
        if (ApplicationLoader.mainInterfacePaused) {
            try {
                this.f27690a.f29431r.startService(new Intent(ApplicationLoader.applicationContext, BringAppForegroundService.class));
            } catch (Throwable th2) {
                FileLog.e(th2);
            }
        }
        if (z11) {
            vu vuVar3 = this.f27690a;
            vuVar3.setOnShowListener(vuVar3.R);
            hk0 o10 = eg0.o(f7, false);
            TextureView textureView2 = this.f27690a.f29428c.getTextureView();
            ImageView textureImageView2 = this.f27690a.f29428c.getTextureImageView();
            float f10 = o10.f24714c / textureView2.getLayoutParams().width;
            textureImageView2.setScaleX(f10);
            textureImageView2.setScaleY(f10);
            textureImageView2.setTranslationX(o10.f24712a);
            textureImageView2.setTranslationY(o10.f24713b);
            textureView2.setScaleX(f10);
            textureView2.setScaleY(f10);
            textureView2.setTranslationX(o10.f24712a);
            textureView2.setTranslationY(o10.f24713b);
        } else {
            eg0.j(false);
        }
        this.f27690a.setShowWithoutAnimation(true);
        this.f27690a.show();
        if (z11) {
            vu vuVar4 = this.f27690a;
            vuVar4.P = 4;
            e3Var = ((org.telegram.ui.ActionBar.f3) vuVar4).backDrawable;
            e3Var.setAlpha(1);
            viewGroup = ((org.telegram.ui.ActionBar.f3) this.f27690a).containerView;
            viewGroup2 = ((org.telegram.ui.ActionBar.f3) this.f27690a).containerView;
