...
public final class ru implements o91 {
    ...
    public final TextureView a(View view, boolean z10, float f7, int i10, boolean z11) {
        ...
        vu vuVar = this.f28053a;
        FrameLayout frameLayout = vuVar.e;
        Activity activity = vuVar.f29801r;
        if (z10) {
            frameLayout.setVisibility(0);
            frameLayout.setAlpha(1.0f);
            frameLayout.addView(vuVar.f29798c.getAspectRatioView());
            vuVar.N = false;
            vuVar.M = z11;
            if (activity != null) {
                try {
    ...
    public final void d() {
        ...
        vuVar.f29798c.g(null, null, null, null, false);
    ...
    public final void e(r91 r91Var, boolean z10) {
        Activity activity = this.f28053a.f29801r;
        if (z10) {
            try {
    ...
    public final TextureView f(View view, boolean z10, int i10, int i11, boolean z11) {
        ...
        if (z10) {
            ...
            TextureView textureView = new TextureView(vuVar.f29801r);
            if (!rg0.x(false, vuVar.f29801r, null, textureView, i10, i11, false)) {
                return null;
            }
            rg0.f27960p0.U = vuVar;
            return textureView;
        } else if (!z11) {
            viewGroup = ((org.telegram.ui.ActionBar.f3) vuVar).containerView;
    ...
    public final void i(boolean z10, j91 j91Var, float f7, boolean z11) {
        ...
        if (z10) {
            vu vuVar = this.f28053a;
            if (vuVar.f29801r != null) {
                try {
                    viewGroup3 = ((org.telegram.ui.ActionBar.f3) vuVar).containerView;
                    viewGroup3.setSystemUiVisibility(0);
                    vu vuVar2 = this.f28053a;
                    int i10 = vuVar2.L;
                    if (i10 != -2) {
                        vuVar2.f29801r.setRequestedOrientation(i10);
                    }
                } catch (Exception e) {
                    FileLog.e(e);
                }
            }
            if (this.f28053a.e.getVisibility() == 0) {
                viewGroup6 = ((org.telegram.ui.ActionBar.f3) this.f28053a).containerView;
                viewGroup7 = ((org.telegram.ui.ActionBar.f3) this.f28053a).containerView;
                viewGroup6.setTranslationY(AndroidUtilities.dp(10.0f) + viewGroup7.getMeasuredHeight());
                e3Var3 = ((org.telegram.ui.ActionBar.f3) this.f28053a).backDrawable;
                e3Var3.setAlpha(0);
            }
            this.f28053a.setOnShowListener(null);
            if (z11) {
                TextureView textureView = this.f28053a.f29798c.getTextureView();
                View controlsView = this.f28053a.f29798c.getControlsView();
                ImageView textureImageView = this.f28053a.f29798c.getTextureImageView();
                uk0 o9 = rg0.o(f7, true);
                float width = o9.f28796c / textureView.getWidth();
                AnimatorSet animatorSet = new AnimatorSet();
                Property property = View.SCALE_X;
                ...
                Property property3 = View.TRANSLATION_X;
                ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(textureImageView, property3, o9.f28794a);
                Property property4 = View.TRANSLATION_Y;
                ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(textureImageView, property4, o9.f28795b);
                ...
                ObjectAnimator ofFloat7 = ObjectAnimator.ofFloat(textureView, property3, o9.f28794a);
                ObjectAnimator ofFloat8 = ObjectAnimator.ofFloat(textureView, property4, o9.f28795b);
                viewGroup4 = ((org.telegram.ui.ActionBar.f3) this.f28053a).containerView;
                viewGroup5 = ((org.telegram.ui.ActionBar.f3) this.f28053a).containerView;
                ...
                e3Var2 = ((org.telegram.ui.ActionBar.f3) this.f28053a).backDrawable;
                ObjectAnimator ofInt = ObjectAnimator.ofInt(e3Var2, r6.d, 0);
                FrameLayout frameLayout = this.f28053a.e;
            ...
            if (this.f28053a.e.getVisibility() == 0) {
                this.f28053a.e.setAlpha(1.0f);
                this.f28053a.e.setVisibility(4);
            }
            j91Var.run();
            this.f28053a.dismissInternal();
            return;
        }
        if (ApplicationLoader.mainInterfacePaused) {
            try {
                this.f28053a.f29801r.startService(new Intent(ApplicationLoader.applicationContext, BringAppForegroundService.class));
            } catch (Throwable th2) {
                FileLog.e(th2);
            }
        }
        if (z11) {
            vu vuVar3 = this.f28053a;
            vuVar3.setOnShowListener(vuVar3.R);
            uk0 o10 = rg0.o(f7, false);
            TextureView textureView2 = this.f28053a.f29798c.getTextureView();
            ImageView textureImageView2 = this.f28053a.f29798c.getTextureImageView();
            float f10 = o10.f28796c / textureView2.getLayoutParams().width;
            textureImageView2.setScaleX(f10);
            textureImageView2.setScaleY(f10);
            textureImageView2.setTranslationX(o10.f28794a);
            textureImageView2.setTranslationY(o10.f28795b);
            textureView2.setScaleX(f10);
            textureView2.setScaleY(f10);
            textureView2.setTranslationX(o10.f28794a);
            textureView2.setTranslationY(o10.f28795b);
        } else {
            rg0.j(false);
        }
        this.f28053a.setShowWithoutAnimation(true);
        this.f28053a.show();
        if (z11) {
            vu vuVar4 = this.f28053a;
            vuVar4.P = 4;
            e3Var = ((org.telegram.ui.ActionBar.f3) vuVar4).backDrawable;
            e3Var.setAlpha(1);
            viewGroup = ((org.telegram.ui.ActionBar.f3) this.f28053a).containerView;
            viewGroup2 = ((org.telegram.ui.ActionBar.f3) this.f28053a).containerView;
