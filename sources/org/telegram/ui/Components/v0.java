...
public final class v0 implements View.OnClickListener {
    ...
    public final TLRPC.User f31055b;
    public final org.telegram.ui.ActionBar.n2 f31056c;
    ...
    public final void onClick(View view) {
        switch (this.f31054a) {
            case 0:
                ...
                bundle.putLong("user_id", this.f31055b.f20043id);
                org.telegram.ui.ActionBar.n2 n2Var = this.f31056c;
                if (n2Var.getMessagesController().checkCanOpenChat(bundle, n2Var)) {
                    n2Var.presentFragment(new ProfileActivity(bundle, null));
                }
                this.d.f20226a.L0.run();
                return;
            default:
                Bundle bundle2 = new Bundle();
                bundle2.putLong("user_id", this.f31055b.f20043id);
                org.telegram.ui.ActionBar.n2 n2Var2 = this.f31056c;
