...
public final class dj0 implements LeadingMarginSpan {
    ...
    public boolean f23630b = true;
    public int f23631c;
    public int d;
    public boolean e;
    public boolean f23632f;
    public boolean h;
    public boolean f23633n;
    public boolean f23634r;
    public final cj0 f23635s;
    public ii.a6 v;
    public final Drawable f23636w;
    public final Paint f23637x;
    public final float[] f23638y;

    public dj0(boolean z10, boolean z11, cj0 cj0Var) {
        Paint paint = new Paint(1);
        this.f23637x = paint;
        this.f23638y = new float[8];
        this.E = new Path();
        ...
        this.f23635s = cj0Var;
        this.e = z11;
        this.f23636w = ApplicationLoader.applicationContext.getResources().getDrawable(R.drawable.mini_quote).mutate();
    ...
    public static void a(SpannableStringBuilder spannableStringBuilder) {
        ...
        while (true) {
            ...
            spannableStringBuilder.removeSpan(cj0Var.f23347a);
            i13++;
        }
    ...
    public static void b(Spannable spannable, int i10, int i11, boolean z10) {
        ...
        metricAffectingSpan.f23347a = dj0Var;
        dj0Var.f23631c = clamp;
        dj0Var.d = clamp2;
