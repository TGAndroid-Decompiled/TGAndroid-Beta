...
public final class dj0 implements LeadingMarginSpan {
    ...
    public final cj0 f23595s;
    public ii.z5 v;
    public final Drawable f23596w;
    public final Paint f23597x;
    public final float[] f23598y;

    public dj0(boolean z10, boolean z11, cj0 cj0Var) {
        Paint paint = new Paint(1);
        this.f23597x = paint;
        this.f23598y = new float[8];
        this.E = new Path();
        ...
        this.f23595s = cj0Var;
        this.e = z11;
        this.f23596w = ApplicationLoader.applicationContext.getResources().getDrawable(R.drawable.mini_quote).mutate();
    ...
    public static void a(SpannableStringBuilder spannableStringBuilder) {
        ...
        while (true) {
            ...
            spannableStringBuilder.removeSpan(cj0Var.f23278a);
            i13++;
        }
    ...
    public static void b(Spannable spannable, int i10, int i11, boolean z10) {
        ...
        metricAffectingSpan.f23278a = dj0Var;
        dj0Var.f23591c = clamp;
        dj0Var.d = clamp2;
    ...
    public static java.util.ArrayList d(org.telegram.ui.Components.du r19, android.text.Layout r20, java.util.ArrayList r21, boolean[] r22) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.dj0.d(org.telegram.ui.Components.du, android.text.Layout, java.util.ArrayList, boolean[]):java.util.ArrayList");
    }
