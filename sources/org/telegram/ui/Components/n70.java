...
public final class n70 {
    ...
    public float f26337a0;
    public ViewGroup f26338b;
    public float f26339b0;
    public final org.telegram.ui.ActionBar.n2 f26340c;
    public boolean f26341c0;
    public final org.telegram.ui.ActionBar.e6 d;
    public boolean f26342d0;
    public final Context e;
    public View f26343e0;
    public final View f26344f;
    public d70 f26345f0;
    public Drawable f26346g;
    public e70 f26347g0;
    public int h;
    public final int[] f26348h0;
    public int f26349i;
    public Integer f26350i0;
    public boolean f26351j;
    public Integer f26352j0;
    public int f26353k;
    public Integer f26354k0;
    public int f26355l;
    public Integer f26356l0;
    public i70 f26357m;
    public ValueAnimator m0;
    public fh.b f26358n;
    public boolean f26359n0;
    public final float[] f26360o;
    public vr f26361o0;
    public Runnable f26362p;
    public View f26363p0;
    public float f26364q;
    public final int[] f26365q0;
    ...
    public n70(org.telegram.ui.ActionBar.n2 n2Var, View view, boolean z10, boolean z11) {
        ...
        this.f26344f = view;
        this.f26367s = ((double) AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18834d6, resourceProvider))) > 0.705d ? 102 : 51;
        this.E = z10;
        this.G = z11;
        this.F = false;
        B();
    ...
    public static void a(n70 n70Var, ViewGroup viewGroup) {
        ...
        ValueAnimator ofFloat = ValueAnimator.ofFloat(l70Var.f25857w, 0.0f);
        n70Var.m0 = ofFloat;
    ...
    public final void C() {
        N();
        View view = this.f26344f;
        if (view == null) {
            return;
        }
        this.f26343e0 = view;
        view.getLocationOnScreen(this.f26348h0);
        this.f26345f0 = new ViewTreeObserver.OnScrollChangedListener() {
            @Override
            public final void onScrollChanged() {
                i70 i70Var;
                n70 n70Var = n70.this;
                if (n70Var.f26343e0 != null && (i70Var = n70Var.f26357m) != null && i70Var.isShowing()) {
                    int[] iArr = new int[2];
                    n70Var.f26343e0.getLocationOnScreen(iArr);
                    int i10 = iArr[0];
                    int[] iArr2 = n70Var.f26348h0;
        ...
        this.f26343e0.getViewTreeObserver().addOnScrollChangedListener(this.f26345f0);
        e70 e70Var = new e70(this, 0);
        this.f26347g0 = e70Var;
        this.f26343e0.addOnLayoutChangeListener(e70Var);
    }

    public final boolean D() {
        i70 i70Var = this.f26357m;
    ...
    public final void N() {
        View view = this.f26343e0;
        if (view != null) {
            if (this.f26345f0 != null) {
                ViewTreeObserver viewTreeObserver = view.getViewTreeObserver();
                if (viewTreeObserver.isAlive()) {
                    viewTreeObserver.removeOnScrollChangedListener(this.f26345f0);
                }
            }
            e70 e70Var = this.f26347g0;
            if (e70Var != null) {
                this.f26343e0.removeOnLayoutChangeListener(e70Var);
            }
        }
        this.f26345f0 = null;
        this.f26347g0 = null;
    ...
    public final void O() {
        ...
        int y3;
        i70 i70Var = this.f26357m;
        if (i70Var != null && i70Var.isShowing() && (view = this.f26344f) != null && (viewGroup = this.f26338b) != null && this.A != null && this.D != null) {
            float[] fArr = this.f26360o;
            ...
            float f14 = x10 + this.f26364q;
            this.f26337a0 = f14;
            float f15 = y3 + this.f26366r;
            this.f26339b0 = f15;
            this.f26357m.update((int) f14, (int) f15, -1, -1);
        }
    }
    ...
    public final void R(ha haVar, float f7, float f10) {
        ...
        if (viewGroup instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
            viewGroup.setBackground(new ka(new la(haVar, viewGroup, 5, false), this.A.getX() + this.f26337a0 + f7, this.A.getY() + this.f26339b0 + f10, mutate, AndroidUtilities.dp(12.0f)));
            return;
        }
        for (int i10 = 0; i10 < this.A.getChildCount(); i10++) {
            View childAt = this.A.getChildAt(i10);
            if (childAt instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                childAt.setBackground(new ka(new la(haVar, childAt, 5, false), this.A.getX() + this.f26337a0 + f7 + childAt.getX(), this.A.getY() + this.f26339b0 + f10 + childAt.getY(), mutate, AndroidUtilities.dp(12.0f)));
            }
        }
    }
    ...
    public final void S(int i10, int i11) {
        View childAt;
        this.f26352j0 = Integer.valueOf(i10);
        this.f26354k0 = Integer.valueOf(i11);
    ...
    public final void T(int i10) {
        View childAt;
        this.f26350i0 = Integer.valueOf(i10);
        if (this.A != null) {
            for (int i11 = 0; i11 < this.A.getChildCount(); i11++) {
                if (i11 == this.A.getChildCount() - 1) {
                    childAt = this.D;
    ...
    public final void V(int i10) {
        ...
        if (i10 == 5 && this.E) {
            ViewGroup viewGroup = this.A;
            if (viewGroup instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                ((ActionBarPopupWindow$ActionBarPopupWindowLayout) viewGroup).f18427c = true;
            }
        }
    }
    ...
    public final void X(float f7) {
        i70 i70Var = this.f26357m;
        if (i70Var != null) {
            i70Var.update((int) this.f26337a0, (int) (this.f26339b0 + f7), -1, -1);
        }
    }
    ...
    public final void b0(int i10, int i11) {
        ...
        View view2 = this.f26363p0;
        if (view2 != null) {
            int[] iArr = this.f26365q0;
            view2.getLocationOnScreen(iArr);
            this.f26363p0.drawableHotspotChanged(i10 - iArr[0], i11 - iArr[1]);
        }
    }
    ...
    public final void d(org.telegram.ui.ActionBar.f1 f1Var) {
        ...
        f1Var.c(v02, v03);
        f1Var.setSelectorColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18789ai, e6Var));
        Integer num3 = this.f26356l0;
        if (num3 != null) {
            l1 = num3.intValue();
        } else {
    ...
    public final void e(int i10, boolean z10, Runnable runnable) {
        ...
        f1Var.f18621a.setPadding(dp, 0, i11, 0);
    ...
    public final void g(TLObject tLObject, boolean z10, Runnable runnable) {
        ...
        if (tLObject instanceof TLRPC.Chat) {
            ...
            if (user.f18256id == UserConfig.getInstance(UserConfig.selectedAccount).getClientUserId()) {
        ...
        f1Var.f18621a.setPadding(dp, 0, i10, 0);
        u9 u9Var = new u9(context);
        f9 f9Var = new f9((org.telegram.ui.ActionBar.e6) null);
        f9Var.p(tLObject);
        u9Var.setRoundRadius(AndroidUtilities.dp(34.0f));
    ...
    public final void n(TLObject tLObject, String str, Runnable runnable) {
        ...
        org.telegram.messenger.vl.o(org.telegram.ui.ActionBar.i6.f19070q5, e6Var, f7, 1, 13.0f);
    ...
    public final void p(int i10, int i11, CharSequence charSequence) {
        ...
        p4Var.setTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18940j5, this.d));
    ...
    public final void u() {
        ...
        Runnable runnable = this.f26362p;
        if (runnable != null) {
            runnable.run();
        }
    }
    ...
    public n70(ViewGroup viewGroup, org.telegram.ui.ActionBar.e6 e6Var, View view, boolean z10, boolean z11, boolean z12) {
        ...
        this.f26344f = view;
        this.f26367s = ((double) AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18834d6, e6Var))) > 0.705d ? 102 : 51;
        this.E = z10;
        this.F = z11;
        this.G = z12;
        B();
