...
public final class n70 {
    ...
    public boolean Y;
    public boolean Z;
    public final ViewGroup f28655a;
    public float f28656a0;
    public ViewGroup f28657b;
    public float f28658b0;
    public final org.telegram.ui.ActionBar.n2 f28659c;
    public boolean f28660c0;
    public final org.telegram.ui.ActionBar.f6 d;
    public boolean f28661d0;
    public final Context f28662e;
    public View f28663e0;
    public final View f28664f;
    public d70 f28665f0;
    public Drawable f28666g;
    public e70 f28667g0;
    public int h;
    public final int[] f28668h0;
    public int f28669i;
    public Integer f28670i0;
    public boolean f28671j;
    public Integer f28672j0;
    public int f28673k;
    public Integer f28674k0;
    public int f28675l;
    public Integer f28676l0;
    public i70 f28677m;
    public ValueAnimator m0;
    public gh.b f28678n;
    public boolean f28679n0;
    public final float[] f28680o;
    public ur f28681o0;
    public Runnable f28682p;
    public View f28683p0;
    public float f28684q;
    public final int[] f28685q0;
    ...
    public n70(org.telegram.ui.ActionBar.n2 n2Var, View view, boolean z10, boolean z11) {
        ...
        this.f28662e = n2Var.getContext();
        this.f28664f = view;
        this.f28687s = ((double) AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20690d6, resourceProvider))) > 0.705d ? 102 : 51;
        this.E = z10;
        this.G = z11;
        this.F = false;
        B();
    ...
    public static void a(n70 n70Var, ViewGroup viewGroup) {
        ...
        ValueAnimator ofFloat = ValueAnimator.ofFloat(l70Var.f28109w, 0.0f);
        n70Var.m0 = ofFloat;
    ...
    public static void f(n70 n70Var, bi.f8 f8Var, final HashSet hashSet, boolean z10, Runnable runnable, final Utilities.Callback callback) {
        ...
        Context context = n70Var.f28662e;
        ...
        if (z10 && runnable != null) {
            org.telegram.ui.ActionBar.f1 f1Var = new org.telegram.ui.ActionBar.f1(2, n70Var.f28662e, n70Var.d, false, false);
        ...
        while (i11 < size) {
            ...
            org.telegram.ui.ActionBar.f1 f1Var2 = new org.telegram.ui.ActionBar.f1(2, n70Var.f28662e, n70Var.d, false, false);
    ...
    public final void B() {
        ...
        mo moVar = new mo(this, this.f28662e, i11, this.d, i13 | i12);
        this.D = moVar;
    ...
    public final void C() {
        ...
        this.f28663e0 = view;
        view.getLocationOnScreen(this.f28668h0);
        this.f28665f0 = new ViewTreeObserver.OnScrollChangedListener() {
            @Override
            public final void onScrollChanged() {
                i70 i70Var;
                n70 n70Var = n70.this;
                if (n70Var.f28663e0 != null && (i70Var = n70Var.f28677m) != null && i70Var.isShowing()) {
                    int[] iArr = new int[2];
                    n70Var.f28663e0.getLocationOnScreen(iArr);
                    int i10 = iArr[0];
                    int[] iArr2 = n70Var.f28668h0;
        ...
        this.f28663e0.getViewTreeObserver().addOnScrollChangedListener(this.f28665f0);
        e70 e70Var = new e70(this, 0);
        this.f28667g0 = e70Var;
        this.f28663e0.addOnLayoutChangeListener(e70Var);
    }

    public final boolean D() {
        i70 i70Var = this.f28677m;
    ...
    public final void E() {
        if (this.f28662e != null && this.D.getItemsCount() > 0) {
    ...
    public final void M(Runnable runnable) {
        if (runnable != null && this.f28662e != null && this.D.getItemsCount() > 0) {
            ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout = this.D;
            View childAt = actionBarPopupWindow$ActionBarPopupWindowLayout.L.getChildAt(actionBarPopupWindow$ActionBarPopupWindowLayout.getItemsCount() - 1);
            if (childAt instanceof org.telegram.ui.ActionBar.f1) {
                org.telegram.ui.ActionBar.f1 f1Var = (org.telegram.ui.ActionBar.f1) childAt;
    ...
    public final void N() {
        View view = this.f28663e0;
        if (view != null) {
            if (this.f28665f0 != null) {
                ViewTreeObserver viewTreeObserver = view.getViewTreeObserver();
                if (viewTreeObserver.isAlive()) {
                    viewTreeObserver.removeOnScrollChangedListener(this.f28665f0);
                }
            }
            e70 e70Var = this.f28667g0;
            if (e70Var != null) {
                this.f28663e0.removeOnLayoutChangeListener(e70Var);
            }
        }
        this.f28665f0 = null;
        this.f28667g0 = null;
    ...
    public final void O() {
        ...
        int y3;
        i70 i70Var = this.f28677m;
        if (i70Var != null && i70Var.isShowing() && (view = this.f28664f) != null && (viewGroup = this.f28657b) != null && this.A != null && this.D != null) {
            float[] fArr = this.f28680o;
            ...
            float f14 = x10 + this.f28684q;
            this.f28656a0 = f14;
            float f15 = y3 + this.f28686r;
            this.f28658b0 = f15;
            this.f28677m.update((int) f14, (int) f15, -1, -1);
        }
    }
    ...
    public final void R(ja jaVar, float f7, float f10) {
        Drawable mutate = this.f28662e.getResources().getDrawable(R.drawable.popup_fixed_alert4).mutate();
        ViewGroup viewGroup = this.A;
        if (viewGroup instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
            viewGroup.setBackground(new ma(new na(jaVar, viewGroup, 5, false), this.A.getX() + this.f28656a0 + f7, this.A.getY() + this.f28658b0 + f10, mutate, AndroidUtilities.dp(12.0f)));
            return;
        }
        for (int i10 = 0; i10 < this.A.getChildCount(); i10++) {
            View childAt = this.A.getChildAt(i10);
            if (childAt instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                childAt.setBackground(new ma(new na(jaVar, childAt, 5, false), this.A.getX() + this.f28656a0 + f7 + childAt.getX(), this.A.getY() + this.f28658b0 + f10 + childAt.getY(), mutate, AndroidUtilities.dp(12.0f)));
            }
        }
    }
    ...
    public final void S(int i10, int i11) {
        View childAt;
        this.f28672j0 = Integer.valueOf(i10);
        this.f28674k0 = Integer.valueOf(i11);
    ...
    public final void T(int i10) {
        View childAt;
        this.f28670i0 = Integer.valueOf(i10);
        if (this.A != null) {
            for (int i11 = 0; i11 < this.A.getChildCount(); i11++) {
                if (i11 == this.A.getChildCount() - 1) {
                    childAt = this.D;
    ...
    public final void V(int i10) {
        ...
        if (i10 == 5 && this.E) {
            ViewGroup viewGroup = this.A;
            if (viewGroup instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                ((ActionBarPopupWindow$ActionBarPopupWindowLayout) viewGroup).f20216c = true;
            }
        }
    }

    public final void W(Drawable drawable) {
        this.f28666g = drawable;
        this.h = 0;
    ...
    public final void X(float f7) {
        i70 i70Var = this.f28677m;
        if (i70Var != null) {
            i70Var.update((int) this.f28656a0, (int) (this.f28658b0 + f7), -1, -1);
        }
    }
    ...
    public final void b(int i10, Drawable drawable, CharSequence charSequence, int i11, int i12, Runnable runnable) {
        ...
        org.telegram.ui.ActionBar.f1 f1Var = new org.telegram.ui.ActionBar.f1(0, this.f28662e, this.d, false, false);
        f1Var.setPadding(AndroidUtilities.dp(18.0f), 0, AndroidUtilities.dp(18.0f), 0);
    ...
    public final void b0(int i10, int i11) {
        ...
        View view2 = this.f28683p0;
        if (view2 != null) {
            int[] iArr = this.f28685q0;
            view2.getLocationOnScreen(iArr);
            this.f28683p0.drawableHotspotChanged(i10 - iArr[0], i11 - iArr[1]);
        }
    }
    ...
    public final void d(org.telegram.ui.ActionBar.f1 f1Var) {
        ...
        f1Var.c(v02, v03);
        f1Var.setSelectorColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20645ai, f6Var));
        Integer num3 = this.f28676l0;
        if (num3 != null) {
            l1 = num3.intValue();
        } else {
    ...
    public final void e(int i10, boolean z10, Runnable runnable) {
        ...
        f1Var.f20428a.setPadding(dp, 0, i11, 0);
    ...
    public final void g(TLObject tLObject, boolean z10, Runnable runnable) {
        ...
        f1Var.f20428a.setPadding(dp, 0, i10, 0);
        x9 x9Var = new x9(context);
        i9 i9Var = new i9((org.telegram.ui.ActionBar.f6) null);
        i9Var.p(tLObject);
        x9Var.setRoundRadius(AndroidUtilities.dp(34.0f));
    ...
    public final org.telegram.ui.ActionBar.f1 h() {
        ...
        org.telegram.ui.ActionBar.f1 f1Var = new org.telegram.ui.ActionBar.f1(1, this.f28662e, this.d, false, false);
        f1Var.setPadding(AndroidUtilities.dp(18.0f), 0, AndroidUtilities.dp(18.0f), 0);
        Integer num = this.f28672j0;
        org.telegram.ui.ActionBar.f6 f6Var = this.d;
        if (num != null) {
    ...
    public final void j(boolean z10, int i10, ji.a2 a2Var, CharSequence charSequence, Runnable runnable) {
        ...
        org.telegram.ui.ActionBar.f1 f1Var = new org.telegram.ui.ActionBar.f1(i11, this.f28662e, this.d, false, false);
        f1Var.setPadding(AndroidUtilities.dp(18.0f), 0, AndroidUtilities.dp(18.0f), 0);
        if (a2Var != null) {
    ...
    public final void k() {
        org.telegram.ui.ActionBar.k1 k1Var = new org.telegram.ui.ActionBar.k1(this.f28662e, this.d);
        k1Var.setTag(R.id.fit_width_tag, 1);
        Integer num = this.f28670i0;
        if (num != null) {
    ...
    public final void n(TLObject tLObject, String str, Runnable runnable) {
        ...
        org.telegram.messenger.wl.n(org.telegram.ui.ActionBar.j6.f20797j5, f6Var, textView, 1, 16.0f);
        ...
        org.telegram.messenger.wl.n(org.telegram.ui.ActionBar.j6.f20924q5, f6Var, f7, 1, 13.0f);
    ...
    public final void p(int i10, int i11, CharSequence charSequence) {
        bi.c4 c4Var = new bi.c4(this.f28662e, 23);
        c4Var.setTextSize(1, i10);
        c4Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20797j5, this.d));
    ...
    public final void u() {
        ...
        Runnable runnable = this.f28682p;
        if (runnable != null) {
            runnable.run();
        }
    }
    ...
    public n70(ViewGroup viewGroup, org.telegram.ui.ActionBar.f6 f6Var, View view, boolean z10, boolean z11, boolean z12) {
        ...
        this.f28655a = viewGroup;
        this.d = f6Var;
        this.f28662e = viewGroup.getContext();
        this.f28664f = view;
        this.f28687s = ((double) AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20690d6, f6Var))) > 0.705d ? 102 : 51;
        this.E = z10;
        this.F = z11;
        this.G = z12;
        B();
