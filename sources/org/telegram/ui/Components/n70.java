...
public final class n70 {
    ...
    public boolean Y;
    public boolean Z;
    public final ViewGroup f28656a;
    public float f28657a0;
    public ViewGroup f28658b;
    public float f28659b0;
    public final org.telegram.ui.ActionBar.n2 f28660c;
    public boolean f28661c0;
    public final org.telegram.ui.ActionBar.f6 d;
    public boolean f28662d0;
    public final Context f28663e;
    public View f28664e0;
    public final View f28665f;
    public d70 f28666f0;
    public Drawable f28667g;
    public e70 f28668g0;
    public int h;
    public final int[] f28669h0;
    public int f28670i;
    public Integer f28671i0;
    public boolean f28672j;
    public Integer f28673j0;
    public int f28674k;
    public Integer f28675k0;
    public int f28676l;
    public Integer f28677l0;
    public i70 f28678m;
    public ValueAnimator m0;
    public gh.b f28679n;
    public boolean f28680n0;
    public final float[] f28681o;
    public ur f28682o0;
    public Runnable f28683p;
    public View f28684p0;
    public float f28685q;
    public final int[] f28686q0;
    public float f28687r;
    public int f28688s;
    public boolean f28689t;
    public boolean f28690u;
    public boolean v;
    public boolean f28691w;
    public l70 f28692x;
    public pt f28693y;
    public final Rect f28694z;

    public n70(org.telegram.ui.ActionBar.n2 n2Var, View view, boolean z10, boolean z11) {
        org.telegram.ui.ActionBar.d5 parentLayout;
        this.f28670i = 5;
        this.f28681o = new float[2];
        this.f28689t = true;
        this.f28691w = true;
        this.f28694z = new Rect();
        this.J = true;
        this.K = -4;
        this.f28669h0 = new int[2];
        this.f28686q0 = new int[2];
        ...
        this.f28663e = n2Var.getContext();
        this.f28665f = view;
        this.f28688s = ((double) AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20691d6, resourceProvider))) > 0.705d ? 102 : 51;
        this.E = z10;
        this.G = z11;
        this.F = false;
        B();
    ...
    public static void a(n70 n70Var, ViewGroup viewGroup) {
        ...
        ValueAnimator ofFloat = ValueAnimator.ofFloat(l70Var.f28110w, 0.0f);
        n70Var.m0 = ofFloat;
    ...
    public static void f(n70 n70Var, bi.f8 f8Var, final HashSet hashSet, boolean z10, Runnable runnable, final Utilities.Callback callback) {
        ...
        Context context = n70Var.f28663e;
        ...
        if (z10 && runnable != null) {
            org.telegram.ui.ActionBar.f1 f1Var = new org.telegram.ui.ActionBar.f1(2, n70Var.f28663e, n70Var.d, false, false);
        ...
        while (i11 < size) {
            ...
            final int i12 = m8Var.f3348a;
            final boolean contains = hashSet.contains(Integer.valueOf(i12));
            org.telegram.ui.ActionBar.f1 f1Var2 = new org.telegram.ui.ActionBar.f1(2, n70Var.f28663e, n70Var.d, false, false);
            ...
            TLRPC.Photo photo = m8Var.f3350c;
            if (photo != null && (arrayList = photo.sizes) != null) {
                f1Var2.h(m8Var.f3349b, ImageLocation.getForObject(FileLoader.getClosestPhotoSizeWithSize(m8Var.f3350c.sizes, AndroidUtilities.dp(24.0f), false, FileLoader.getClosestPhotoSizeWithSize(arrayList, 50), true), m8Var.f3350c), "50_50", null, null);
                obj = null;
            } else {
                obj = null;
                f1Var2.g(m8Var.f3349b, R.drawable.msg_folders, null);
            }
    ...
    public final void B() {
        ...
        mo moVar = new mo(this, this.f28663e, i11, this.d, i13 | i12);
        this.D = moVar;
    ...
    public final void C() {
        N();
        View view = this.f28665f;
        if (view == null) {
            return;
        }
        this.f28664e0 = view;
        view.getLocationOnScreen(this.f28669h0);
        this.f28666f0 = new ViewTreeObserver.OnScrollChangedListener() {
            @Override
            public final void onScrollChanged() {
                i70 i70Var;
                n70 n70Var = n70.this;
                if (n70Var.f28664e0 != null && (i70Var = n70Var.f28678m) != null && i70Var.isShowing()) {
                    int[] iArr = new int[2];
                    n70Var.f28664e0.getLocationOnScreen(iArr);
                    int i10 = iArr[0];
                    int[] iArr2 = n70Var.f28669h0;
        ...
        this.f28664e0.getViewTreeObserver().addOnScrollChangedListener(this.f28666f0);
        e70 e70Var = new e70(this, 0);
        this.f28668g0 = e70Var;
        this.f28664e0.addOnLayoutChangeListener(e70Var);
    }

    public final boolean D() {
        i70 i70Var = this.f28678m;
    ...
    public final void E() {
        if (this.f28663e != null && this.D.getItemsCount() > 0) {
    ...
    public final void M(Runnable runnable) {
        if (runnable != null && this.f28663e != null && this.D.getItemsCount() > 0) {
            ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout = this.D;
            View childAt = actionBarPopupWindow$ActionBarPopupWindowLayout.L.getChildAt(actionBarPopupWindow$ActionBarPopupWindowLayout.getItemsCount() - 1);
            if (childAt instanceof org.telegram.ui.ActionBar.f1) {
                org.telegram.ui.ActionBar.f1 f1Var = (org.telegram.ui.ActionBar.f1) childAt;
    ...
    public final void N() {
        View view = this.f28664e0;
        if (view != null) {
            if (this.f28666f0 != null) {
                ViewTreeObserver viewTreeObserver = view.getViewTreeObserver();
                if (viewTreeObserver.isAlive()) {
                    viewTreeObserver.removeOnScrollChangedListener(this.f28666f0);
                }
            }
            e70 e70Var = this.f28668g0;
            if (e70Var != null) {
                this.f28664e0.removeOnLayoutChangeListener(e70Var);
            }
        }
        this.f28666f0 = null;
        this.f28668g0 = null;
    ...
    public final void O() {
        ...
        int y3;
        i70 i70Var = this.f28678m;
        if (i70Var != null && i70Var.isShowing() && (view = this.f28665f) != null && (viewGroup = this.f28658b) != null && this.A != null && this.D != null) {
            float[] fArr = this.f28681o;
            ...
            float f14 = x10 + this.f28685q;
            this.f28657a0 = f14;
            float f15 = y3 + this.f28687r;
            this.f28659b0 = f15;
            this.f28678m.update((int) f14, (int) f15, -1, -1);
        }
    }
    ...
    public final void R(ja jaVar, float f7, float f10) {
        Drawable mutate = this.f28663e.getResources().getDrawable(R.drawable.popup_fixed_alert4).mutate();
        ViewGroup viewGroup = this.A;
        if (viewGroup instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
            viewGroup.setBackground(new ma(new na(jaVar, viewGroup, 5, false), this.A.getX() + this.f28657a0 + f7, this.A.getY() + this.f28659b0 + f10, mutate, AndroidUtilities.dp(12.0f)));
            return;
        }
        for (int i10 = 0; i10 < this.A.getChildCount(); i10++) {
            View childAt = this.A.getChildAt(i10);
            if (childAt instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                childAt.setBackground(new ma(new na(jaVar, childAt, 5, false), this.A.getX() + this.f28657a0 + f7 + childAt.getX(), this.A.getY() + this.f28659b0 + f10 + childAt.getY(), mutate, AndroidUtilities.dp(12.0f)));
            }
        }
    }
    ...
    public final void S(int i10, int i11) {
        View childAt;
        this.f28673j0 = Integer.valueOf(i10);
        this.f28675k0 = Integer.valueOf(i11);
    ...
    public final void T(int i10) {
        View childAt;
        this.f28671i0 = Integer.valueOf(i10);
        if (this.A != null) {
            for (int i11 = 0; i11 < this.A.getChildCount(); i11++) {
                if (i11 == this.A.getChildCount() - 1) {
                    childAt = this.D;
    ...
    public final void V(int i10) {
        ...
        if (i10 == 5 && this.E) {
            ViewGroup viewGroup = this.A;
            if (viewGroup instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                ((ActionBarPopupWindow$ActionBarPopupWindowLayout) viewGroup).f20217c = true;
            }
        }
    }

    public final void W(Drawable drawable) {
        this.f28667g = drawable;
        this.h = 0;
    ...
    public final void X(float f7) {
        i70 i70Var = this.f28678m;
        if (i70Var != null) {
            i70Var.update((int) this.f28657a0, (int) (this.f28659b0 + f7), -1, -1);
        }
    }
    ...
    public final void b(int i10, Drawable drawable, CharSequence charSequence, int i11, int i12, Runnable runnable) {
        ...
        org.telegram.ui.ActionBar.f1 f1Var = new org.telegram.ui.ActionBar.f1(0, this.f28663e, this.d, false, false);
        f1Var.setPadding(AndroidUtilities.dp(18.0f), 0, AndroidUtilities.dp(18.0f), 0);
    ...
    public final void b0(int i10, int i11) {
        ...
        View view2 = this.f28684p0;
        if (view2 != null) {
            int[] iArr = this.f28686q0;
            view2.getLocationOnScreen(iArr);
            this.f28684p0.drawableHotspotChanged(i10 - iArr[0], i11 - iArr[1]);
        }
    }
    ...
    public final void d(org.telegram.ui.ActionBar.f1 f1Var) {
        ...
        f1Var.c(v02, v03);
        f1Var.setSelectorColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20646ai, f6Var));
        Integer num3 = this.f28677l0;
        if (num3 != null) {
            l1 = num3.intValue();
        } else {
    ...
    public final void e(int i10, boolean z10, Runnable runnable) {
        ...
        f1Var.f20429a.setPadding(dp, 0, i11, 0);
    ...
    public final void g(TLObject tLObject, boolean z10, Runnable runnable) {
        ...
        f1Var.f20429a.setPadding(dp, 0, i10, 0);
        x9 x9Var = new x9(context);
        i9 i9Var = new i9((org.telegram.ui.ActionBar.f6) null);
        i9Var.p(tLObject);
        x9Var.setRoundRadius(AndroidUtilities.dp(34.0f));
    ...
    public final org.telegram.ui.ActionBar.f1 h() {
        ...
        org.telegram.ui.ActionBar.f1 f1Var = new org.telegram.ui.ActionBar.f1(1, this.f28663e, this.d, false, false);
        f1Var.setPadding(AndroidUtilities.dp(18.0f), 0, AndroidUtilities.dp(18.0f), 0);
        Integer num = this.f28673j0;
        org.telegram.ui.ActionBar.f6 f6Var = this.d;
        if (num != null) {
    ...
    public final void j(boolean z10, int i10, ji.a2 a2Var, CharSequence charSequence, Runnable runnable) {
        ...
        org.telegram.ui.ActionBar.f1 f1Var = new org.telegram.ui.ActionBar.f1(i11, this.f28663e, this.d, false, false);
        f1Var.setPadding(AndroidUtilities.dp(18.0f), 0, AndroidUtilities.dp(18.0f), 0);
        if (a2Var != null) {
    ...
    public final void k() {
        org.telegram.ui.ActionBar.k1 k1Var = new org.telegram.ui.ActionBar.k1(this.f28663e, this.d);
        k1Var.setTag(R.id.fit_width_tag, 1);
        Integer num = this.f28671i0;
        if (num != null) {
    ...
    public final void n(TLObject tLObject, String str, Runnable runnable) {
        ...
        org.telegram.messenger.vl.n(org.telegram.ui.ActionBar.j6.f20798j5, f6Var, textView, 1, 16.0f);
        ...
        org.telegram.messenger.vl.n(org.telegram.ui.ActionBar.j6.f20925q5, f6Var, f7, 1, 13.0f);
    ...
    public final void p(int i10, int i11, CharSequence charSequence) {
        bi.c4 c4Var = new bi.c4(this.f28663e, 23);
        c4Var.setTextSize(1, i10);
        c4Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20798j5, this.d));
    ...
    public final void u() {
        ...
        Runnable runnable = this.f28683p;
        if (runnable != null) {
            runnable.run();
        }
    }
    ...
    public n70(ViewGroup viewGroup, org.telegram.ui.ActionBar.f6 f6Var, View view, boolean z10, boolean z11, boolean z12) {
        ...
        this.d = f6Var;
        this.f28663e = viewGroup.getContext();
        this.f28665f = view;
        this.f28688s = ((double) AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20691d6, f6Var))) > 0.705d ? 102 : 51;
        this.E = z10;
        this.F = z11;
        this.G = z12;
        B();
