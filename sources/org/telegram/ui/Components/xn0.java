...
public final class xn0 extends a81 {
    ...
    public final org.telegram.ui.ey f30023b;
    ...
    public final void b(View view, int i10, int i11) {
        org.telegram.ui.ey eyVar = this.f30023b;
    ...
    public final View d(int i10) {
        ...
        if (i10 == 3) {
            return eyVar.f30291f0;
        }
        if (i10 == 4) {
            return eyVar.f30296k0;
        }
        if (i10 == 5) {
            return eyVar.f30302r0;
        }
        if (i10 == 2) {
            vm0 vm0Var = new vm0(eyVar.H0, uyVar);
            eyVar.G0 = vm0Var;
            vm0Var.b(eyVar.U0, eyVar.V0, false);
            eyVar.G0.f28833b.setClipToPadding(false);
            eyVar.G0.f28833b.j(new vn0(this, 0));
            eyVar.G0.f28833b.C0(new bc0(eyVar, 23));
            eyVar.G0.setUiCallback(eyVar);
            return eyVar.G0;
        } else if (i10 == 6) {
            return eyVar.f30300p0;
        } else {
    ...
    public final CharSequence g(int i10) {
        ArrayList arrayList = this.f30022a;
        if (((wn0) arrayList.get(i10)).f29757a == 0) {
            return LocaleController.getString(R.string.SearchAllChatsShort);
        }
        if (((wn0) arrayList.get(i10)).f29757a == 1) {
            return LocaleController.getString(R.string.ChannelsTab);
        }
        if (((wn0) arrayList.get(i10)).f29757a == 4) {
            return LocaleController.getString(R.string.AppsTab);
        }
        if (((wn0) arrayList.get(i10)).f29757a == 6) {
            return LocaleController.getString(R.string.SearchPosts);
        }
        if (((wn0) arrayList.get(i10)).f29757a == 2) {
            return LocaleController.getString(R.string.DownloadsTabs);
        }
        if (((wn0) arrayList.get(i10)).f29757a == 5) {
            return LocaleController.getString(R.string.PublicPostsTabs);
        }
        gg.q0 q0Var = gg.s0.f9910c3[((wn0) arrayList.get(i10)).f29758b];
    ...
    public final int h(int i10) {
        ...
        return ((wn0) arrayList.get(i10)).f29757a + i10;
    }
    ...
    public final void i() {
        ...
        if (eyVar.T0 == 0) {
            ...
            if (!eyVar.O0) {
                ...
                org.telegram.ui.ox oxVar = eyVar.f33424a1.F3;
