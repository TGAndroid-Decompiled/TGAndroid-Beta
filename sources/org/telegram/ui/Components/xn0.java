...
public final class xn0 extends a81 {
    public final ArrayList f32632a = new ArrayList();
    public final org.telegram.ui.ey f32633b;
    ...
    public final void b(View view, int i10, int i11) {
        org.telegram.ui.ey eyVar = this.f32633b;
    ...
    public final View d(int i10) {
        ...
        if (i10 == 3) {
            return eyVar.f32955f0;
        }
        if (i10 == 4) {
            return eyVar.f32960k0;
        }
        if (i10 == 5) {
            return eyVar.f32966r0;
        }
        if (i10 == 2) {
            vm0 vm0Var = new vm0(eyVar.H0, uyVar);
            eyVar.G0 = vm0Var;
            vm0Var.b(eyVar.U0, eyVar.V0, false);
            eyVar.G0.f31365b.setClipToPadding(false);
            eyVar.G0.f31365b.j(new vn0(this, 0));
            eyVar.G0.f31365b.C0(new cc0(eyVar, 23));
            eyVar.G0.setUiCallback(eyVar);
            return eyVar.G0;
        } else if (i10 == 6) {
            return eyVar.f32964p0;
        } else {
    ...
    @Override
    public final int e() {
        return this.f32632a.size();
    }

    @Override
    public final CharSequence g(int i10) {
        ArrayList arrayList = this.f32632a;
        if (((wn0) arrayList.get(i10)).f32301a == 0) {
            return LocaleController.getString(R.string.SearchAllChatsShort);
        }
        if (((wn0) arrayList.get(i10)).f32301a == 1) {
            return LocaleController.getString(R.string.ChannelsTab);
        }
        if (((wn0) arrayList.get(i10)).f32301a == 4) {
            return LocaleController.getString(R.string.AppsTab);
        }
        if (((wn0) arrayList.get(i10)).f32301a == 6) {
            return LocaleController.getString(R.string.SearchPosts);
        }
        if (((wn0) arrayList.get(i10)).f32301a == 2) {
            return LocaleController.getString(R.string.DownloadsTabs);
        }
        if (((wn0) arrayList.get(i10)).f32301a == 5) {
            return LocaleController.getString(R.string.PublicPostsTabs);
        }
        hg.q0 q0Var = hg.s0.f11237c3[((wn0) arrayList.get(i10)).f32302b];
    ...
    public final int h(int i10) {
        ...
        return ((wn0) arrayList.get(i10)).f32301a + i10;
    }
    ...
    public final void i() {
        ...
        if (eyVar.T0 == 0) {
            ...
            if (!eyVar.O0) {
                ...
                org.telegram.ui.ox oxVar = eyVar.f36206a1.F3;
