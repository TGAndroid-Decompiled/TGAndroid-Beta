...
public final class tc0 extends Drawable {
    ...
    public final void a(int i10) {
        if (i10 != this.f28466f) {
            ...
            this.d = alpha;
            this.f28464b.setColor(i0.a.k(i10, (int) ((alpha / 255.0f) * this.f28465c)));
        }
        this.f28466f = i10;
    }
    ...
    public final Drawable.ConstantState getConstantState() {
        if (this.f28463a == null) {
            this.f28463a = new Drawable.ConstantState();
        }
        return this.f28463a;
    }
    ...
    public final void setAlpha(int i10) {
        if (this.f28465c != i10) {
            this.f28465c = i10;
            this.f28464b.setAlpha((int) ((this.d / 255.0f) * i10));
        }
    }
