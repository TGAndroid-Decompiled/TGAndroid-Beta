...
public final class ky extends ll0 {
    public boolean E;
    public final lz F;
    public final fy f25714c;
    public long d;
    public TLRPC.StickerSet e;
    public ArrayList f25715f;
    public final ArrayList h = new ArrayList();
    public final ArrayList f25716n = new ArrayList();
    public final ArrayList f25717r = new ArrayList();
    public final ArrayList f25718s = new ArrayList();
    public String v;
    ...
    public ky(lz lzVar, Context context) {
        this.F = lzVar;
        ?? aVar = new nh.a(context, lzVar.f25968c1, new d(this, 11), new mv(this, 1), lzVar.Z1);
        this.f25714c = aVar;
    ...
    public static void E(ky kyVar, Runnable runnable, ArrayList arrayList, boolean z10) {
        ...
        MediaDataController.getInstance(lzVar.f25968c1).searchStickers(true, str2, str3, new ai.e4((Object) kyVar, str3, arrayList, (Object) runnable, 9), z10);
    }
    ...
    public final void F(String str, boolean z10) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            this.d = 0L;
            lzVar.f25962b.a(false, true);
            l();
        } else {
            this.v = str.toLowerCase();
        }
        jy jyVar = this.f25720x;
        if (jyVar != null) {
    ...
    public final int h() {
        if (this.d != 0) {
            return this.f25715f.size() + 4;
        }
        ArrayList arrayList = this.h;
        boolean isEmpty = arrayList.isEmpty();
        ArrayList arrayList2 = this.f25718s;
        ArrayList arrayList3 = this.f25717r;
        if (isEmpty && arrayList3.isEmpty() && arrayList2.isEmpty() && !this.f25721y) {
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 != 3) {
                    ...
                    f0Var = new org.telegram.ui.Cells.p8(lzVar.getContext(), true, false, lzVar.Z1, lzVar.f25988i2);
                }
            } else {
                View view3 = new View(lzVar.getContext());
                view3.setLayoutParams(new s4.p0(-1, lzVar.f25964b1));
                f0Var = view3;
            }
        } else {
