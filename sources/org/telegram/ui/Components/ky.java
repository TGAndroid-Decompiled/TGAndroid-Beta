...
public final class ky extends kl0 {
    public boolean E;
    public final kz F;
    public final fy f27915c;
    public long d;
    public TLRPC.StickerSet f27916e;
    public ArrayList f27917f;
    public final ArrayList h = new ArrayList();
    public final ArrayList f27918n = new ArrayList();
    public final ArrayList f27919r = new ArrayList();
    public final ArrayList f27920s = new ArrayList();
    public String v;
    public String f27921w;
    public jy f27922x;
    public boolean f27923y;

    public ky(kz kzVar, Context context) {
        this.F = kzVar;
        ?? aVar = new oh.a(context, kzVar.f27933c1, new d(this, 11), new kv(this, 1), kzVar.Z1);
        this.f27915c = aVar;
    ...
    public static void E(ky kyVar, Runnable runnable, ArrayList arrayList, boolean z10) {
        ...
        MediaDataController.getInstance(kzVar.f27933c1).searchStickers(true, str2, str3, new bi.r3((Object) kyVar, str3, arrayList, (Object) runnable, 8), z10);
    }
    ...
    public final void F(String str, boolean z10) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            this.d = 0L;
            kzVar.f27927b.a(false, true);
            l();
        } else {
            this.v = str.toLowerCase();
        }
        jy jyVar = this.f27922x;
        if (jyVar != null) {
    ...
    public final int h() {
        if (this.d != 0) {
            return this.f27917f.size() + 4;
        }
        ArrayList arrayList = this.h;
        boolean isEmpty = arrayList.isEmpty();
        ArrayList arrayList2 = this.f27920s;
        ArrayList arrayList3 = this.f27919r;
        if (isEmpty && arrayList3.isEmpty() && arrayList2.isEmpty() && !this.f27923y) {
            ...
            if (i10 != 1) {
                if (i10 != 3) {
                    if (i10 != 4) {
                        ...
                        View view2 = this.f27915c;
                        view2.setLayoutParams(p0Var);
                        yVar = view2;
                    }
                } else {
                    yVar = new org.telegram.ui.Cells.o8(kzVar.getContext(), true, false, kzVar.Z1, kzVar.f27954i2);
                }
            } else {
                View view3 = new View(kzVar.getContext());
                view3.setLayoutParams(new s4.p0(-1, kzVar.f27929b1));
                yVar = view3;
            }
        } else {
