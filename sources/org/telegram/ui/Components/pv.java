...
public abstract class pv implements NotificationCenter.NotificationCenterDelegate {
    public final ArrayList f27149a;
    public ArrayList f27150b;
    public ArrayList[] f27151c;
    public final int d;
    public boolean e = false;
    public final sv f27152f;

    public pv(int i10, ArrayList arrayList, sv svVar) {
        this.f27152f = svVar;
        this.d = i10;
        this.f27149a = arrayList == null ? new ArrayList() : arrayList;
    }
    ...
    public final void a(int i10, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        ...
        if (i10 >= 0) {
            ArrayList[] arrayListArr = this.f27151c;
                ...
                if (tL_messages_stickerSet != null && tL_messages_stickerSet.documents != null) {
                    ...
                    for (int i12 = 0; i12 < tL_messages_stickerSet.documents.size(); i12++) {
                        ...
                        if (document == null) {
                            ...
                            obj.f26900a = tL_messages_stickerSet;
                            obj.f26901b = document.f18115id;
                            this.f27151c[i10].add(obj);
                            if (this.f27152f.H) {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.groupStickersDidLoad) {
            for (int i12 = 0; i12 < this.f27150b.size(); i12++) {
                if (this.f27150b.get(i12) == null) {
                    TLRPC.TL_messages_stickerSet stickerSet2 = MediaDataController.getInstance(this.d).getStickerSet((TLRPC.InputStickerSet) this.f27149a.get(i12), true);
                    if (this.f27150b.size() == 1 && stickerSet2 != null && (stickerSet = stickerSet2.set) != null && !stickerSet.emojis) {
                        sv svVar = this.f27152f;
                        svVar.dismiss();
                        Context context = svVar.getContext();
                        org.telegram.ui.ActionBar.n2 n2Var = svVar.f27972c;
                        TLRPC.InputStickerSet inputStickerSet = (TLRPC.InputStickerSet) this.f27149a.get(i12);
                    ...
                    this.f27150b.set(i12, stickerSet2);
                    if (stickerSet2 != null) {
                        a(i12, stickerSet2);
                    }
                }
