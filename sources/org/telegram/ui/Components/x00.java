...
public final class x00 extends vl0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        if (c1Var.f42964f == 2) {
            int b10 = c1Var.b();
            d10 d10Var = this.f30226c;
            if (b10 >= d10Var.f23447r0 && c1Var.b() <= d10Var.f23448s0) {
                return true;
            }
            return false;
        }
    ...
    public final int j(int i10) {
        ...
        if (i10 != d10Var.f23445p0 && i10 != d10Var.f23449t0 && i10 != d10Var.f23453x0) {
            if (i10 != d10Var.f23446q0 && i10 != d10Var.f23450u0) {
                return 2;
            }
            return 3;
        }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            boolean z10 = false;
            c10Var = new c10(d10Var, d10Var.getContext(), ((d10Var.Z instanceof TL_chatlists.TL_chatlists_chatlistInviteAlready) || d10Var.f23431a0 != null) ? true : true, d10Var.f23436f0, d10Var.f23434d0, d10Var.f23435e0);
            d10Var.f23443n0 = c10Var;
        } else {
            c10Var = null;
            if (i10 == 1) {
