...
public class ScrollSlidingTextTabStrip extends HorizontalScrollView implements org.telegram.ui.ActionBar.z5 {
    public static final int f22402o0 = 0;
    public int E;
    public int F;
    public int G;
    public boolean H;
    ...
    public int V;
    public float W;
    public final dc1 f22403a;
    public float f22404a0;
    public zm0 f22405b;
    public long f22406b0;
    public final org.telegram.ui.ActionBar.f6 f22407c;
    public View f22408c0;
    public boolean d;
    public final org.telegram.ui.Cells.u6 f22409d0;
    public boolean e;
    public ch.d f22410e0;
    public boolean f22411f;
    public final Path f22412f0;
    public final RectF f22413g0;
    public int h;
    public final RectF f22414h0;
    public final d6 f22415i0;
    public final d6 f22416j0;
    public final d6 f22417k0;
    ...
    public ScrollSlidingTextTabStrip(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f22406b0 = 200L;
        this.f22409d0 = new org.telegram.ui.Cells.u6(this, 23);
        this.f22412f0 = new Path();
        this.f22413g0 = new RectF();
        this.f22414h0 = new RectF();
        this.f22415i0 = new d6(this, 420L, qrVar);
        this.f22416j0 = new d6(this, 420L, qrVar);
        this.f22417k0 = new d6(this, 420L, qrVar);
        this.m0 = true;
        this.f22407c = f6Var;
    ...
    public final void a(int i10, CharSequence charSequence, SparseArray sparseArray) {
        ...
        int i11 = this.h;
        this.h = i11 + 1;
        if (i11 == 0 && this.f22421r == -1) {
            this.f22421r = i10;
        }
        this.O.put(i11, i10);
        this.P.put(i10, i11);
        int i12 = this.f22421r;
        if (i12 != -1 && i12 == i10) {
            this.f22419n = i11;
            this.f22424x = 0;
        }
        ...
        this.f22403a.addView(textView, w7.y5.n(0, -1));
        this.f22422s += dp;
        this.R.put(i11, dp);
        e();
    }
    ...
    public final void b() {
        ...
        Path path = this.f22412f0;
        path.rewind();
        path.addRoundRect(rectF, height, height, Path.Direction.CW);
        ch.d dVar = this.f22410e0;
        if (dVar != null) {
            dVar.setAlpha(255);
            this.f22410e0.setBounds(((int) rectF.left) - AndroidUtilities.dp(7.0f), 0, AndroidUtilities.dp(7.0f) + ((int) rectF.right), getMeasuredHeight());
            this.f22410e0.q(height);
        }
    }
    ...
    public final void c() {
        ...
        while (true) {
            ...
            textView.setTextColor(f(org.telegram.ui.ActionBar.j6.v0(i11, this.f22407c)));
            if (this.e) {
    ...
    public void dispatchDraw(Canvas canvas) {
        canvas.save();
        if (this.f22410e0 != null) {
            if (this.f22415i0.d(1.0f, false) < 1.0f) {
                b();
            }
            canvas.translate(getScrollX(), 0.0f);
            this.f22410e0.f4293p = this.f22417k0.e(this.m0);
            this.f22410e0.draw(canvas);
            canvas.clipPath(this.f22412f0);
            canvas.translate(-getScrollX(), 0.0f);
            canvas.translate(this.f22416j0.d(0.0f, false), 0.0f);
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (view == dc1Var) {
            ...
            float f10 = this.f22423w + f7 + this.f22404a0;
            View childAt = dc1Var.getChildAt(this.f22419n);
            if (this.f22420n0 && childAt != null) {
    ...
    public final void e() {
        ...
        int i11 = 0;
        while (true) {
            org.telegram.ui.ActionBar.f6 f6Var = this.f22407c;
            if (i11 < childCount) {
    ...
    public ArrayList<Integer> getTabIds() {
        ...
        for (int i10 = 0; i10 < this.f22403a.getChildCount(); i10++) {
    ...
    public final void h(View view, int i10, int i11) {
        ...
        if (i11 >= 0) {
            if (view != null || !this.H) {
                int i12 = this.f22419n;
                if (i11 == i12 && (zm0Var = this.f22405b) != null) {
                    zm0Var.C();
                    return;
                }
                if (i12 < i11) {
                ...
                this.f22421r = i10;
                boolean z11 = this.H;
                org.telegram.ui.Cells.u6 u6Var = this.f22409d0;
                if (z11) {
    ...
    public final void i(int i10, boolean z10) {
        if (this.h != 0 && this.J != i10) {
            this.J = i10;
            TextView textView = (TextView) this.f22403a.getChildAt(i10);
            if (textView != null) {
    ...
    public final void j(float f7, int i10) {
        ...
        if (i12 >= 0 && (i11 = this.f22419n) != i12) {
            ...
            if (textView != null && textView2 != null) {
                ...
                this.f22425y = hg.k0.z(textView.getMeasuredWidth(), this.E, 2, textView.getLeft());
                textView2.getLayout();
    ...
    public final void k(TextView textView, TextView textView2, float f7) {
        ...
        int i11 = this.f22425y;
        this.v = (int) (((this.F - i11) * f7) + i11);
        int i12 = this.E;
        this.f22423w = (int) (((this.G - i12) * f7) + i12);
        invalidate();
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (this.f22424x != i15) {
            ...
            this.J = -1;
            if (this.H) {
                AndroidUtilities.cancelRunOnUIThread(this.f22409d0);
                this.H = false;
                setEnabled(true);
                zm0 zm0Var = this.f22405b;
                if (zm0Var != null) {
                    zm0Var.y0(1.0f);
                }
            }
            TextView textView = (TextView) this.f22403a.getChildAt(this.f22419n);
            if (textView != null) {
                textView.getLayout();
                this.f22423w = textView.getMeasuredWidth();
                int left = textView.getLeft();
                int measuredWidth = textView.getMeasuredWidth();
                int i16 = this.f22423w;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (childCount != 1 && this.f22422s <= size) {
    ...
    public void setInitialTabId(int i10) {
        ...
        if (((TextView) this.f22403a.getChildAt(i11)) != null) {
            this.f22419n = i11;
            this.f22424x = 0;
            c();
            requestLayout();
    ...
    public void setOpen(boolean z10) {
        ...
        invalidate();
        if (!this.f22411f) {
            this.f22413g0.set(this.f22414h0);
            this.f22415i0.d(0.0f, true);
            if (!this.m0) {
                f11 = -6.0f;
            }
            this.f22416j0.d(AndroidUtilities.dp(f11), true);
        }
        b();
    }

    public void setReordering(boolean z10) {
        if (this.f22420n0 == z10) {
            return;
        }
        this.f22420n0 = z10;
        AndroidUtilities.forEachViews(this.f22403a, new ai.i(18));
    }
    ...
    public void setUseMinimalWidth(boolean z10) {
        ...
        this.f22403a.setLayoutParams(new FrameLayout.LayoutParams(i10, -1));
    }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f22410e0 && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
