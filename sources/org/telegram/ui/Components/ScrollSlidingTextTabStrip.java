...
public class ScrollSlidingTextTabStrip extends HorizontalScrollView implements org.telegram.ui.ActionBar.a6 {
    public static final int f22175o0 = 0;
    public int E;
    public int F;
    public int G;
    public boolean H;
    ...
    public int V;
    public float W;
    public final dc1 f22176a;
    public float f22177a0;
    public mm0 f22178b;
    public long f22179b0;
    public final org.telegram.ui.ActionBar.f6 f22180c;
    public View f22181c0;
    public boolean d;
    public final org.telegram.ui.Cells.l7 f22182d0;
    public boolean e;
    public ch.d f22183e0;
    public boolean f22184f;
    public final Path f22185f0;
    public final RectF f22186g0;
    public int h;
    public final RectF f22187h0;
    public final c6 f22188i0;
    public final c6 f22189j0;
    public final c6 f22190k0;
    public boolean f22191l0;
    public boolean m0;
    public int f22192n;
    public boolean f22193n0;
    public int f22194r;
    public int f22195s;
    public int v;
    public int f22196w;
    ...
    public ScrollSlidingTextTabStrip(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f22179b0 = 200L;
        this.f22182d0 = new org.telegram.ui.Cells.l7(this, 22);
        this.f22185f0 = new Path();
        this.f22186g0 = new RectF();
        this.f22187h0 = new RectF();
        this.f22188i0 = new c6(this, 420L, qrVar);
        this.f22189j0 = new c6(this, 420L, qrVar);
        this.f22190k0 = new c6(this, 420L, qrVar);
        this.m0 = true;
        this.f22180c = f6Var;
    ...
    public final void a(int i10, CharSequence charSequence, SparseArray sparseArray) {
        ...
        int i11 = this.h;
        this.h = i11 + 1;
        if (i11 == 0 && this.f22194r == -1) {
            this.f22194r = i10;
        }
        this.O.put(i11, i10);
        this.P.put(i10, i11);
        int i12 = this.f22194r;
        if (i12 != -1 && i12 == i10) {
            this.f22192n = i11;
            this.f22197x = 0;
        }
        ...
        this.f22176a.addView(textView, w7.x5.n(0, -1));
        this.f22195s += dp;
        this.R.put(i11, dp);
        e();
    }
    ...
    public final void b() {
        ...
        Path path = this.f22185f0;
        path.rewind();
        path.addRoundRect(rectF, height, height, Path.Direction.CW);
        ch.d dVar = this.f22183e0;
        if (dVar != null) {
            dVar.setAlpha(255);
            this.f22183e0.setBounds(((int) rectF.left) - AndroidUtilities.dp(7.0f), 0, AndroidUtilities.dp(7.0f) + ((int) rectF.right), getMeasuredHeight());
            this.f22183e0.q(height);
        }
    }
    ...
    public final void c() {
        ...
        while (true) {
            ...
            textView.setTextColor(f(org.telegram.ui.ActionBar.j6.v0(i11, this.f22180c)));
            if (this.e) {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.f22183e0 != null) {
            if (this.f22188i0.d(1.0f, false) < 1.0f) {
                b();
            }
            canvas.translate(getScrollX(), 0.0f);
            this.f22183e0.f4294p = this.f22190k0.e(this.m0);
            this.f22183e0.draw(canvas);
            canvas.clipPath(this.f22185f0);
            canvas.translate(-getScrollX(), 0.0f);
            canvas.translate(this.f22189j0.d(0.0f, false), 0.0f);
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (view == dc1Var) {
            ...
            float f10 = this.f22196w + f7 + this.f22177a0;
            View childAt = dc1Var.getChildAt(this.f22192n);
            if (this.f22193n0 && childAt != null) {
    ...
    public final void e() {
        ...
        int i11 = 0;
        while (true) {
            org.telegram.ui.ActionBar.f6 f6Var = this.f22180c;
            if (i11 < childCount) {
    ...
    public ArrayList<Integer> getTabIds() {
        ...
        for (int i10 = 0; i10 < this.f22176a.getChildCount(); i10++) {
    ...
    public final void h(View view, int i10, int i11) {
        ...
        if (i11 >= 0) {
            if (view != null || !this.H) {
                int i12 = this.f22192n;
                if (i11 == i12 && (mm0Var = this.f22178b) != null) {
                    mm0Var.C();
                    return;
                }
                if (i12 < i11) {
                ...
                this.f22194r = i10;
                boolean z11 = this.H;
                org.telegram.ui.Cells.l7 l7Var = this.f22182d0;
                if (z11) {
    ...
    public final void i(int i10, boolean z10) {
        if (this.h != 0 && this.J != i10) {
            this.J = i10;
            TextView textView = (TextView) this.f22176a.getChildAt(i10);
            if (textView != null) {
    ...
    public final void j(float f7, int i10) {
        ...
        if (i12 >= 0 && (i11 = this.f22192n) != i12) {
            ...
            if (textView != null && textView2 != null) {
                ...
                this.f22198y = hg.k0.C(textView.getMeasuredWidth(), this.E, 2, textView.getLeft());
                textView2.getLayout();
    ...
    public final void k(TextView textView, TextView textView2, float f7) {
        ...
        int i11 = this.f22198y;
        this.v = (int) (((this.F - i11) * f7) + i11);
        int i12 = this.E;
        this.f22196w = (int) (((this.G - i12) * f7) + i12);
        invalidate();
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (this.f22197x != i15) {
            ...
            this.J = -1;
            if (this.H) {
                AndroidUtilities.cancelRunOnUIThread(this.f22182d0);
                this.H = false;
                setEnabled(true);
                mm0 mm0Var = this.f22178b;
                if (mm0Var != null) {
                    mm0Var.C0(1.0f);
                }
            }
            TextView textView = (TextView) this.f22176a.getChildAt(this.f22192n);
            if (textView != null) {
                textView.getLayout();
                this.f22196w = textView.getMeasuredWidth();
                int left = textView.getLeft();
                int measuredWidth = textView.getMeasuredWidth();
                int i16 = this.f22196w;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (childCount != 1 && this.f22195s <= size) {
    ...
    public void setInitialTabId(int i10) {
        ...
        if (((TextView) this.f22176a.getChildAt(i11)) != null) {
            this.f22192n = i11;
            this.f22197x = 0;
            c();
            requestLayout();
    ...
    public void setOpen(boolean z10) {
        ...
        invalidate();
        if (!this.f22184f) {
            this.f22186g0.set(this.f22187h0);
            this.f22188i0.d(0.0f, true);
            if (!this.m0) {
                f11 = -6.0f;
            }
            this.f22189j0.d(AndroidUtilities.dp(f11), true);
        }
        b();
    }

    public void setReordering(boolean z10) {
        if (this.f22193n0 == z10) {
            return;
        }
        this.f22193n0 = z10;
        AndroidUtilities.forEachViews(this.f22176a, new ai.i(18));
    }
    ...
    public void setUseMinimalWidth(boolean z10) {
        ...
        this.f22176a.setLayoutParams(new FrameLayout.LayoutParams(i10, -1));
    }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f22183e0 && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
