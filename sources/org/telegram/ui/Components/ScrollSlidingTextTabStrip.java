...
public class ScrollSlidingTextTabStrip extends HorizontalScrollView implements org.telegram.ui.ActionBar.b6 {
    public static final int f25011l0 = 0;
    public int B;
    public int C;
    public int D;
    public boolean E;
    ...
    public long V;
    public View W;
    public final ob1 f25012a;
    public final tl0 f25013a0;
    public tm0 f25014b;
    public qg.b f25015b0;
    public final org.telegram.ui.ActionBar.g6 f25016c;
    public final Path f25017c0;
    public boolean d;
    public final RectF f25018d0;
    public boolean f25019e;
    public final RectF f25020e0;
    public boolean f25021f;
    public final z5 f25022f0;
    public final z5 f25023g0;
    public int h;
    public final z5 f25024h0;
    public boolean f25025i0;
    public boolean f25026j0;
    public boolean f25027k0;
    public int f25028n;
    public int f25029r;
    public int f25030s;
    public int v;
    ...
    public ScrollSlidingTextTabStrip(Context context, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        this.V = 200L;
        this.f25013a0 = new tl0(this, 1);
        this.f25017c0 = new Path();
        this.f25018d0 = new RectF();
        this.f25020e0 = new RectF();
        this.f25022f0 = new z5(this, 420L, prVar);
        this.f25023g0 = new z5(this, 420L, prVar);
        this.f25024h0 = new z5(this, 420L, prVar);
        this.f25026j0 = true;
        this.f25016c = g6Var;
    ...
    public final void a(int i10, CharSequence charSequence, SparseArray sparseArray) {
        ...
        int i11 = this.h;
        this.h = i11 + 1;
        if (i11 == 0 && this.f25029r == -1) {
            this.f25029r = i10;
        }
        this.L.put(i11, i10);
        this.M.put(i10, i11);
        int i12 = this.f25029r;
        if (i12 != -1 && i12 == i10) {
            this.f25028n = i11;
            this.f25032x = 0;
        }
        ...
        int dp = AndroidUtilities.dp(32.0f) + ((int) Math.ceil(qh.e3.g(replaceEmoji, textView.getPaint())));
        this.f25012a.addView(textView, k7.c6.n(0, -1));
        this.f25030s += dp;
        this.O.put(i11, dp);
        e();
    }
    ...
    public final void b() {
        ...
        Path path = this.f25017c0;
        path.rewind();
        path.addRoundRect(rectF, height, height, Path.Direction.CW);
        qg.b bVar = this.f25015b0;
        if (bVar != null) {
            bVar.setAlpha(255);
            this.f25015b0.setBounds(((int) rectF.left) - AndroidUtilities.dp(7.0f), 0, AndroidUtilities.dp(7.0f) + ((int) rectF.right), getMeasuredHeight());
            this.f25015b0.p(height);
        }
    }
    ...
    public final void c() {
        ...
        while (true) {
            ...
            TextView textView = (TextView) ob1Var.getChildAt(i13);
            if (this.f25028n == i13) {
                i10 = this.I;
            } else {
                i10 = this.J;
            ...
            textView.setTextColor(f(org.telegram.ui.ActionBar.k6.v0(i11, this.f25016c)));
            if (this.f25019e) {
    ...
    public void dispatchDraw(Canvas canvas) {
        canvas.save();
        if (this.f25015b0 != null) {
            if (this.f25022f0.d(1.0f, false) < 1.0f) {
                b();
            }
            canvas.translate(getScrollX(), 0.0f);
            this.f25015b0.f44891n = this.f25024h0.e(this.f25026j0);
            this.f25015b0.draw(canvas);
            canvas.clipPath(this.f25017c0);
            canvas.translate(-getScrollX(), 0.0f);
            canvas.translate(this.f25023g0.d(0.0f, false), 0.0f);
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        if (view == ob1Var) {
            ...
            float f11 = this.f25031w + f10 + this.U;
            View childAt = ob1Var.getChildAt(this.f25028n);
            if (this.f25027k0 && childAt != null) {
    ...
    public final void e() {
        ...
        int i11 = 0;
        while (true) {
            org.telegram.ui.ActionBar.g6 g6Var = this.f25016c;
            if (i11 < childCount) {
    ...
    public ArrayList<Integer> getTabIds() {
        ...
        for (int i10 = 0; i10 < this.f25012a.getChildCount(); i10++) {
    ...
    public final void h(View view, int i10, int i11) {
        ...
        if (i11 >= 0) {
            if (view != null || !this.E) {
                int i12 = this.f25028n;
                if (i11 == i12 && (tm0Var = this.f25014b) != null) {
                    tm0Var.B();
                    return;
                }
                if (i12 < i11) {
    ...
    public final void i(int i10, boolean z4) {
        if (this.h != 0 && this.G != i10) {
            this.G = i10;
            TextView textView = (TextView) this.f25012a.getChildAt(i10);
            if (textView != null) {
    ...
    public final void j(float f10, int i10) {
        ...
        if (i12 >= 0 && (i11 = this.f25028n) != i12) {
            ...
            if (textView != null && textView2 != null) {
                ...
                this.f25033y = l.d.d(textView.getMeasuredWidth(), this.B, 2, textView.getLeft());
                textView2.getLayout();
    ...
    public final void k(TextView textView, TextView textView2, float f10) {
        ...
        int i11 = this.f25033y;
        this.v = (int) (((this.C - i11) * f10) + i11);
        int i12 = this.B;
        this.f25031w = (int) (((this.D - i12) * f10) + i12);
        invalidate();
    }
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        if (this.f25032x != i15) {
            ...
            this.G = -1;
            if (this.E) {
                AndroidUtilities.cancelRunOnUIThread(this.f25013a0);
                this.E = false;
                setEnabled(true);
                tm0 tm0Var = this.f25014b;
                if (tm0Var != null) {
                    tm0Var.w0(1.0f);
                }
            }
            TextView textView = (TextView) this.f25012a.getChildAt(this.f25028n);
            if (textView != null) {
                textView.getLayout();
                this.f25031w = textView.getMeasuredWidth();
                int left = textView.getLeft();
                int measuredWidth = textView.getMeasuredWidth();
                int i16 = this.f25031w;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (childCount != 1 && this.f25030s <= size) {
    ...
    public void setInitialTabId(int i10) {
        ...
        if (((TextView) this.f25012a.getChildAt(i11)) != null) {
            this.f25028n = i11;
            this.f25032x = 0;
            c();
            requestLayout();
    ...
    public void setOpen(boolean z4) {
        ...
        invalidate();
        if (!this.f25021f) {
            this.f25018d0.set(this.f25020e0);
            this.f25022f0.d(0.0f, true);
            if (!this.f25026j0) {
                f12 = -6.0f;
            }
            this.f25023g0.d(AndroidUtilities.dp(f12), true);
        }
        b();
    }
    ...
    public void setReordering(boolean z4) {
        ...
        this.f25027k0 = z4;
        AndroidUtilities.forEachViews(this.f25012a, new ag.d(0));
    }
    ...
    public void setUseMinimalWidth(boolean z4) {
        ...
        this.f25012a.setLayoutParams(new FrameLayout.LayoutParams(i10, -1));
    }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f25015b0 && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
