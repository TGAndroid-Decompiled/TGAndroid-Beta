...
public class ScrollSlidingTextTabStrip extends HorizontalScrollView implements org.telegram.ui.ActionBar.x5 {
    ...
    public ScrollSlidingTextTabStrip(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        this.f22400i0 = new e6(this, 420L, rrVar);
        this.f22401j0 = new e6(this, 420L, rrVar);
        this.f22402k0 = new e6(this, 420L, rrVar);
        this.m0 = true;
        this.f22392c = d6Var;
    ...
    public final void h(View view, int i10, int i11) {
        ...
        if (i11 >= 0) {
            if (view != null || !this.H) {
                ...
                if (i11 == i12 && (xm0Var = this.f22390b) != null) {
                    xm0Var.C();
                    return;
                }
                if (i12 < i11) {
