...
public final class mk0 implements View.OnLayoutChangeListener {
    public final s4.h0 f26188a;
    public final ArrayList f26189b;
    ...
    public final void onLayoutChange(View view, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17) {
        ...
        View view2;
        pk0 pk0Var = this.e;
        HashMap hashMap = (HashMap) pk0Var.f27080k;
        ...
        while (true) {
            ...
            s4.h0 h0Var = this.f26188a;
            if (h0Var != null && (h0Var.f42677b || pk0Var.f27075c)) {
                ml0Var.getClass();
        ...
        ValueAnimator valueAnimator = (ValueAnimator) pk0Var.f27077g;
        if (valueAnimator != null) {
            valueAnimator.removeAllListeners();
            ((ValueAnimator) pk0Var.f27077g).cancel();
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        pk0Var.f27077g = ofFloat;
        final boolean z12 = this.f26190c;
        final int i28 = i19;
        ...
        ((ValueAnimator) pk0Var.f27077g).addListener(new ai.z(28, this, arrayList2));
        long j3 = 300;
        if (pk0Var.d) {
            if (z10) {
                ((ValueAnimator) pk0Var.f27077g).setDuration(150L);
                ((ValueAnimator) pk0Var.f27077g).setInterpolator(rr.f27702g);
            } else {
                long measuredHeight = ((i28 / ml0Var.getMeasuredHeight()) + 1.0f) * 200.0f;
                if (measuredHeight >= 300) {
                    j3 = measuredHeight;
                }
                ((ValueAnimator) pk0Var.f27077g).setDuration(Math.min(j3, 1300L));
                ((ValueAnimator) pk0Var.f27077g).setInterpolator(rr.h);
            }
        } else {
            if (z10) {
                min = 600;
            ...
            ((ValueAnimator) pk0Var.f27077g).setDuration(min);
            ((ValueAnimator) pk0Var.f27077g).setInterpolator(rr.h);
        }
        ((ValueAnimator) pk0Var.f27077g).start();
    }
}
