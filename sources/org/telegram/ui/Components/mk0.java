...
public final class mk0 implements View.OnLayoutChangeListener {
    ...
    public final void onLayoutChange(View view, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17) {
        ...
        View view2;
        pk0 pk0Var = this.e;
        HashMap hashMap = (HashMap) pk0Var.f27070k;
        ...
        while (true) {
            ...
            s4.h0 h0Var = this.f26159a;
            if (h0Var != null && (h0Var.f42752b || pk0Var.f27065c)) {
                ml0Var.getClass();
        ...
        ValueAnimator valueAnimator = (ValueAnimator) pk0Var.f27067g;
        if (valueAnimator != null) {
            valueAnimator.removeAllListeners();
            ((ValueAnimator) pk0Var.f27067g).cancel();
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        pk0Var.f27067g = ofFloat;
        final boolean z12 = this.f26161c;
        final int i28 = i19;
        ...
        ((ValueAnimator) pk0Var.f27067g).addListener(new ai.z(28, this, arrayList2));
        long j3 = 300;
        if (pk0Var.d) {
            if (z10) {
                ((ValueAnimator) pk0Var.f27067g).setDuration(150L);
                ((ValueAnimator) pk0Var.f27067g).setInterpolator(qr.f27384g);
            } else {
                long measuredHeight = ((i28 / ml0Var.getMeasuredHeight()) + 1.0f) * 200.0f;
                if (measuredHeight >= 300) {
                    j3 = measuredHeight;
                }
                ((ValueAnimator) pk0Var.f27067g).setDuration(Math.min(j3, 1300L));
                ((ValueAnimator) pk0Var.f27067g).setInterpolator(qr.h);
            }
        } else {
            if (z10) {
                min = 600;
            ...
            ((ValueAnimator) pk0Var.f27067g).setDuration(min);
            ((ValueAnimator) pk0Var.f27067g).setInterpolator(qr.h);
        }
        ((ValueAnimator) pk0Var.f27067g).start();
    }
}
