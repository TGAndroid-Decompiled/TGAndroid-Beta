...
public final class r11 extends FrameLayout {
    ...
    public r11(ThemeEditorView.EditorAlert editorAlert, Context context) {
        ...
        this.d = editorAlert;
        this.f27790a = false;
        this.f27791b = new RectF();
    }

    @Override
    public final void onDraw(android.graphics.Canvas r13) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.r11.onDraw(android.graphics.Canvas):void");
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ThemeEditorView.EditorAlert editorAlert = this.d;
        s11 s11Var = editorAlert.f22406c;
        ...
        if (s11Var.getPaddingTop() != dp) {
            ...
            if (editorAlert.f22405b.getVisibility() == 0) {
