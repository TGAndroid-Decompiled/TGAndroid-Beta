...
public class ArchiveHelp extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ArchiveHelp(Context context, int i, Theme.ResourcesProvider resourcesProvider, Runnable runnable, Runnable runnable2) {
        super(context);
        ...
        if (runnable2 != null) {
            ...
            buttonWithCounterViewM.setText(LocaleController.getString("GotIt"), false);
            buttonWithCounterViewM.setOnClickListener(new ArchiveHelp$$ExternalSyntheticLambda0(0, runnable2));
            linearLayout.addView(buttonWithCounterViewM, LayoutHelper.createLinear(-1, 48, 14.0f, 18.0f, 14.0f, 0.0f));
        }
    }
