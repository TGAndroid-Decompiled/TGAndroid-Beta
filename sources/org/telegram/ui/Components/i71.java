...
public final class i71 {
    ...
    public static i71 d(int i10, TLRPC.Document document, TLRPC.Document document2, int i11, boolean z4) {
        ...
        if (tL_documentAttributeVideo != null) {
            ...
            obj.f27691i = tL_documentAttributeVideo.f20850w;
            obj.f27692j = tL_documentAttributeVideo.h;
            obj.f27694l = j10 / d;
        }
    ...
    public final void e(boolean z4) {
        if (!b() && this.f27690g != null) {
            File pathToAttach = FileLoader.getInstance(this.f27685a).getPathToAttach(this.f27690g, null, false, z4);
            if (pathToAttach != null && pathToAttach.exists()) {
                this.d = Uri.fromFile(pathToAttach);
            } else {
                File pathToAttach2 = FileLoader.getInstance(this.f27685a).getPathToAttach(this.f27690g, null, true, z4);
                if (pathToAttach2 != null && pathToAttach2.exists()) {
        ...
        if (!c() && this.h != null) {
            File pathToAttach3 = FileLoader.getInstance(this.f27685a).getPathToAttach(this.h, null, false, z4);
            if (pathToAttach3 != null && pathToAttach3.exists()) {
                this.f27689f = Uri.fromFile(pathToAttach3);
                return;
            }
            File pathToAttach4 = FileLoader.getInstance(this.f27685a).getPathToAttach(this.h, null, true, z4);
            if (pathToAttach4 != null && pathToAttach4.exists()) {
                this.f27689f = Uri.fromFile(pathToAttach4);
            }
        }
    }
}
