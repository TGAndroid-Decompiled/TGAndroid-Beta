...
public final class cc0 extends Drawable {
    public static final boolean f22996e0;
    public static final boolean f22997f0;
    public Matrix A;
    public boolean B;
    ...
    public int f22999a0;
    public long f23000b;
    public final gh.a f23001b0;
    public WeakReference f23002c;
    public Bitmap f23003c0;
    public boolean d;
    public int f23004d0;
    public final qr e;
    public int f23005f;
    ...
    public float h;
    public int f23007i;
    public final RectF f23008j;
    public Bitmap f23009k;
    public Bitmap f23010l;
    public final Bitmap[] f23011m;
    public final Paint f23012n;
    public final Paint f23013o;
    public final Paint f23014p;
    public int f23015q;
    public Canvas f23016r;
    public Canvas f23017s;
    public boolean f23018t;
    public Bitmap f23019u;
    public BitmapShader v;
    public BitmapShader f23020w;
    public Bitmap f23021x;
    public ImageReceiver f23022y;
    ...
    public cc0() {
        this.f22998a = new int[]{-12423849, -531317, -7888252, -133430};
        this.e = new qr(0.33d, 0.0d, 0.0d, 1.0d);
        this.h = 1.0f;
        this.f23008j = new RectF();
        this.f23011m = new Bitmap[3];
        this.f23012n = new Paint(2);
        this.f23013o = new Paint(2);
        this.f23014p = new Paint();
        this.f23015q = 100;
        ...
        this.V = new gh.a();
        this.W = new gh.a();
        this.f23001b0 = new gh.a();
        h();
    }

    public static int g(int i10, int i11, int i12, int i13) {
        boolean j3 = j(i10, i11, i12, i13);
        boolean z10 = f22997f0;
        if (j3) {
            if (!z10) {
    ...
    public final void a(Canvas canvas, int i10, float f7, float f10, float f11, float f12) {
        List list = this.R;
        if (list != null && this.f23022y != null && i10 >= 0 && i10 < list.size()) {
            dg.c cVar = (dg.c) this.R.get(i10);
            canvas.save();
            canvas.translate(f7, f10);
            canvas.scale(f11, f12);
            canvas.concat(cVar.f7731b);
            this.f23022y.setImageCoords(cVar.f7730a);
            this.f23022y.draw(canvas);
            canvas.restore();
        }
    }

    public final void b(Canvas canvas, RectF rectF, int i10) {
        if (this.R != null && this.f23019u != null) {
            a(canvas, i10, rectF.left, rectF.top, rectF.width() / this.f23019u.getWidth(), rectF.height() / this.f23019u.getHeight());
        }
    }
    ...
    public final void c() {
        ...
        while (i10 < 3) {
            ...
            if (i10 < 0) {
                ...
                bitmap = this.f23011m[i10];
            }
            Utilities.generateGradient(bitmap, this.f23007i, f7, this.f22998a);
            i10 = i11;
        }
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        float f7 = i10;
        int width = this.f23009k.getWidth();
        int height = this.f23009k.getHeight();
        ...
        if (Build.VERSION.SDK_INT >= 28 && this.Q != null && this.f23009k != null && e != null) {
            z10 = true;
        } else {
            z10 = false;
        }
        int i13 = this.f23015q;
        float f16 = 1.0f;
        Paint paint = this.f23012n;
        Paint paint2 = this.f23013o;
        RectF rectF = this.f23008j;
        if (i13 < 0) {
            boolean z11 = f22996e0;
            if (!z10 && (!z11 || e == null)) {
                canvas.drawColor(i0.a.k(-16777216, (int) (this.L * this.K)));
            }
            if (e != null) {
                if (z11) {
                    int i14 = (((int) (this.L * this.J)) * (-this.f23015q)) / 100;
                    if (this.f23019u != null) {
                        Bitmap e7 = e();
                        gh.a aVar = this.f23001b0;
                        if (aVar.a(e7) || this.f23003c0 == null || this.f23004d0 != i14) {
                            int width3 = this.f23019u.getWidth();
                            int height3 = this.f23019u.getHeight();
                            this.f23004d0 = i14;
                            Bitmap bitmap = this.f23003c0;
                            if (bitmap == null || bitmap.getWidth() != width3 || this.f23003c0.getHeight() != height3) {
                                this.f23003c0 = Bitmap.createBitmap(width3, height3, Bitmap.Config.ARGB_8888);
                            }
                            Utilities.applyAlphaInvert(e7, this.f23003c0, i14);
                        }
                        aVar.b(e7);
                    }
                    ...
                    if (this.f23003c0 != null) {
                        canvas.drawBitmap(this.f23009k, (Rect) null, rectF, paint);
                        canvas.drawBitmap(this.f23003c0, (Rect) null, rectF, paint);
                    } else {
                        canvas.drawColor(i0.a.k(-16777216, (int) (this.L * this.K)));
                    }
                    ...
                    float min = 1.0f / Math.min(this.f23009k.getWidth() / bounds.width(), this.f23009k.getHeight() / bounds.height());
                    ...
                    if (!this.f23023z || max3 > 1.4f || max3 < 0.8f) {
                        this.A.preScale(max3, max3);
                        f16 = max3;
                    }
                    this.f23020w.setLocalMatrix(this.A);
                    paint2.setColorFilter(null);
                    paint2.setAlpha((int) ((Math.abs(this.f23015q) / 100.0f) * this.L * this.J));
                    rectF.set(bounds.left, bounds.top, bounds.right, bounds.bottom);
                    if (z10) {
                        Paint e10 = this.Q.e(this.f23009k, e, this.U, (int) (this.L * this.J), this.f23015q, canvas.isHardwareAccelerated());
                        this.Q.d(this.A);
                        this.Q.c(rectF);
                        float f23 = this.I;
            ...
            if (this.I != 0) {
                ...
                float min2 = 1.0f / Math.min(this.f23009k.getWidth() / bounds.width(), this.f23009k.getHeight() / bounds.height());
            ...
            if (e != null) {
                ...
                paint2.setAlpha((int) ((Math.abs(this.f23015q) / 100.0f) * this.L * this.J));
                if (z12) {
                    Paint e11 = this.Q.e(this.f23009k, e, this.U, (int) (this.L * this.J), this.f23015q, canvas.isHardwareAccelerated());
                    hc0 hc0Var = this.Q;
                    RectF rectF2 = hc0Var.f24641j;
                    rectF2.set(0.0f, 0.0f, hc0Var.f24639g, hc0Var.h);
                    Matrix matrix = hc0Var.f24640i;
                ...
                paint2.setAlpha((int) ((Math.abs(this.f23015q) / 100.0f) * this.L * this.J * 0.8f));
                b(canvas, rectF, this.S);
            }
        }
        canvas.restore();
    ...
    public final Bitmap e() {
        ...
        Bitmap bitmap2 = this.f23021x;
        gh.a aVar2 = this.W;
        boolean a10 = aVar2.a(bitmap2);
        boolean z11 = true;
        if (this.f22999a0 != this.S) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        int width = this.f23019u.getWidth();
        int height = this.f23019u.getHeight();
        ...
        Bitmap.Config config = this.f23019u.getConfig();
        if (config == Bitmap.Config.ARGB_8888) {
            Utilities.copyBitmaps(this.f23019u, this.X);
        } else if (config == Bitmap.Config.ALPHA_8) {
            Utilities.expandAlphaToBlack(this.f23019u, this.X);
        }
        if (this.Z == null) {
        ...
        Paint paint2 = this.Z;
        int i10 = this.S;
        if (this.f23021x != null && this.R != null) {
            for (int i11 = 0; i11 < this.R.size(); i11++) {
                if (i11 != i10) {
                    dg.c cVar = (dg.c) this.R.get(i11);
                    canvas.save();
                    canvas.concat(cVar.f7731b);
                    canvas.drawBitmap(this.f23021x, (Rect) null, cVar.f7730a, paint2);
                    canvas.restore();
                }
            }
        }
        this.f22999a0 = this.S;
        aVar.b(this.f23019u);
        aVar2.b(this.f23021x);
        return this.X;
    }
    ...
    public final void h() {
        ...
        this.f23009k = createBitmap;
        createBitmap.setHasAlpha(false);
        for (int i12 = 0; i12 < 3; i12++) {
            Bitmap createBitmap2 = Bitmap.createBitmap(i10, i11, Bitmap.Config.ARGB_8888);
            this.f23011m[i12] = createBitmap2;
            createBitmap2.setHasAlpha(false);
        }
        this.f23016r = new Canvas(this.f23009k);
        Bitmap createBitmap3 = Bitmap.createBitmap(i10, i11, Bitmap.Config.ARGB_8888);
        this.f23010l = createBitmap3;
        createBitmap3.setHasAlpha(false);
        this.f23017s = new Canvas(this.f23010l);
        Utilities.generateGradient(this.f23009k, this.f23007i, this.e.getInterpolation(this.h), this.f22998a);
        if (f22997f0) {
            this.f23013o.setBlendMode(m4.u0.c());
        }
    }

    public final void i() {
        invalidateSelf();
        WeakReference weakReference = this.f23002c;
        if (weakReference != null && weakReference.get() != null) {
            ((View) this.f23002c.get()).invalidate();
        }
        if (this.f23018t) {
    ...
    public final void k() {
        this.T = true;
        ImageReceiver imageReceiver = this.f23022y;
    ...
    public final void o(int i10, int i11, int i12, int i13, int i14, boolean z10) {
        ...
        if (iArr[0] != i10 || iArr[1] != i11 || iArr[2] != i12 || iArr[3] != i13) {
            ...
            iArr[2] = i12;
            iArr[3] = i13;
            Bitmap bitmap = this.f23009k;
            if (bitmap != null) {
                Utilities.generateGradient(bitmap, this.f23007i, this.e.getInterpolation(this.h), iArr);
                if (z10) {
                    i();
                }
            }
    ...
    public final void r(View view) {
        this.f23002c = new WeakReference(view);
        ImageReceiver imageReceiver = this.f23022y;
        if (imageReceiver != null) {
    ...
    public final void setAlpha(int i10) {
        this.L = i10;
        this.f23012n.setAlpha(i10);
        this.f23013o.setAlpha(i10);
    }
    ...
    public final void t(Bitmap bitmap, int i10) {
        ...
        if (bitmap != null) {
            ...
            if (i10 < 0) {
                if (!z11) {
                    Bitmap bitmap2 = this.f23009k;
                    Shader.TileMode tileMode = Shader.TileMode.CLAMP;
                    this.v = new BitmapShader(bitmap2, tileMode, tileMode);
                    Bitmap bitmap3 = this.f23019u;
                    Shader.TileMode tileMode2 = Shader.TileMode.REPEAT;
                    this.f23020w = new BitmapShader(bitmap3, tileMode2, tileMode2);
                    this.f23023z = true;
                    paint.setShader(new ComposeShader(this.v, this.f23020w, PorterDuff.Mode.DST_IN));
    ...
    public final void w(int i10) {
        ...
        this.v = bitmapShader;
        this.f23012n.setShader(bitmapShader);
        i();
    }
    ...
    public final void x(boolean z10) {
        if (this.h >= 1.0f && LiteMode.isEnabled(32)) {
            ...
            this.B = z10;
            this.h = 0.0f;
            int i10 = this.f23007i - 1;
            this.f23007i = i10;
            if (i10 < 0) {
                this.f23007i = 7;
            }
            i();
            this.f23017s.drawBitmap(this.f23009k, 0.0f, 0.0f, (Paint) null);
            c();
            return;
        }
        i();
    ...
    public final void y() {
        ...
        this.h = 0.0f;
        i();
        Utilities.generateGradient(this.f23010l, this.f23007i, 0.0f, this.f22998a);
        c();
    }
    ...
    public final void z() {
        ...
        long j3 = elapsedRealtime - this.f23000b;
        if (j3 > 20) {
            j3 = 17;
        }
        this.f23000b = elapsedRealtime;
        if (j3 > 1) {
            boolean z11 = this.N;
            if (z11 && this.h == 1.0f) {
                this.h = 0.0f;
            ...
            if (f13 < 1.0f) {
                ...
                if (z11) {
                    ...
                    if (z13) {
                        ...
                        if ((c10 == 0 && f12 > 0.25f) || ((c10 == 1 && f12 > 0.5f) || (c10 == 2 && f12 > 0.75f))) {
                            if (this.E) {
                                int i11 = this.f23007i + 1;
                                this.f23007i = i11;
                                if (i11 > 7) {
                                    this.f23007i = 0;
                                }
                            } else {
                                int i12 = this.f23007i - 1;
                                this.f23007i = i12;
                                if (i12 < 0) {
                                    this.f23007i = 7;
                                }
                ...
                if (z12) {
                    Utilities.generateGradient(this.f23009k, this.f23007i, f10, this.f22998a);
                } else {
                    Paint paint = this.f23014p;
                    Bitmap[] bitmapArr = this.f23011m;
                    if (f10 != 1.0f) {
                        int i15 = (int) (f10 / 0.33333334f);
                        if (i15 == 0) {
                            this.f23016r.drawBitmap(this.f23010l, 0.0f, 0.0f, (Paint) null);
                        } else {
                            this.f23016r.drawBitmap(bitmapArr[i15 - 1], 0.0f, 0.0f, (Paint) null);
                        }
                        paint.setAlpha((int) (((f10 - (i15 * 0.33333334f)) / 0.33333334f) * 255.0f));
                        this.f23016r.drawBitmap(bitmapArr[i15], 0.0f, 0.0f, paint);
                    } else {
                        this.f23016r.drawBitmap(bitmapArr[2], 0.0f, 0.0f, paint);
                    }
                }
                i();
            }
