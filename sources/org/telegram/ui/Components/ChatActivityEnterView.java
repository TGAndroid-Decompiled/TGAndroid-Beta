...
public class ChatActivityEnterView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, ov0, sx0, ly0, le.d, org.telegram.ui.ActionBar.z5 {
    public static final int f21731m5 = 0;
    public boolean A0;
    ...
    public int f21732a;
    public boolean f21733a0;
    public boolean f21734a1;
    public TL_account.TL_businessChatLink a2;
    public TLRPC.TL_document f21735a3;
    public final he f21736a4;
    public final c6 f21737a5;
    public boolean f21738b;
    public NumberTextView f21739b0;
    public final te f21740b1;
    public ig f21741b2;
    public String f21742b3;
    public final he f21743b4;
    public final c6 f21744b5;
    public org.telegram.ui.ActionBar.f1 f21745c;
    public int f21746c0;
    public boolean f21747c1;
    public TLRPC.ChatFull f21748c2;
    public MessageObject f21749c3;
    public final he f21750c4;
    public ph.f f21751c5;
    public LinearLayout d;
    public int f21752d0;
    public ai.x5 f21753d1;
    public boolean f21754d2;
    public VideoEditedInfo f21755d3;
    public boolean f21756d4;
    public jh.h f21757d5;
    public CharSequence e;
    public nr f21758e0;
    public ie f21759e1;
    public int f21760e2;
    public boolean f21761e3;
    public long f21762e4;
    public final le.e f21763e5;
    public String f21764f;
    public Runnable f21765f0;
    public v71 f21766f1;
    public boolean f21767f2;
    public boolean f21768f3;
    public float f21769f4;
    public final le.b f21770f5;
    public boolean f21771g0;
    public aj0 f21772g1;
    public boolean f21773g2;
    public boolean f21774g3;
    public float f21775g4;
    public final le.b f21776g5;
    public float h;
    public boolean f21777h0;
    public gk0 f21778h1;
    public boolean f21779h2;
    public MessageObject f21780h3;
    public float f21781h4;
    public final le.b f21782h5;
    public String f21783i0;
    public long f21784i1;
    public boolean f21785i2;
    public TL_keyboard.KeyboardButtonProto f21786i3;
    public float f21787i4;
    public float f21788i5;
    public String f21789j0;
    public SlideTextView f21790j1;
    public boolean f21791j2;
    public boolean j3;
    public float f21792j4;
    public float f21793j5;
    public ei.f4 f21794k0;
    public sg f21795k1;
    public boolean f21796k2;
    public boolean f21797k3;
    public float f21798k4;
    public boolean f21799k5;
    public ei.c0 f21800l0;
    public final pv0 l1;
    public MessageObject f21801l2;
    public boolean f21802l3;
    public float l4;
    public int f21803l5;
    public lf m0;
    public ViewGroup f21804m1;
    public TLRPC.TL_replyKeyboardMarkup f21805m2;
    public boolean f21806m3;
    public float f21807m4;
    public float f21808n;
    public ei.b0 f21809n0;
    public int f21810n1;
    public int f21811n2;
    public int f21812n3;
    public float f21813n4;
    public boolean f21814o0;
    public final org.telegram.ui.xd f21815o1;
    public boolean f21816o2;
    public boolean f21817o3;
    public float f21818o4;
    public wo0 f21819p0;
    public ViewPropertyAnimator f21820p1;
    public PowerManager.WakeLock f21821p2;
    public boolean f21822p3;
    public float f21823p4;
    public cf f21824q0;
    public final hg.k f21825q1;
    public AnimatorSet f21826q2;
    public final ye f21827q3;
    public boolean f21828q4;
    public float f21829r;
    public ge f21830r0;
    public final i0 f21831r1;
    public AnimatorSet f21832r2;
    public final ff f21833r3;
    public boolean f21834r4;
    public float f21835s;
    public int f21836s0;
    public final ImageView f21837s1;
    public AnimatorSet f21838s2;
    public final org.telegram.ui.Cells.c1 f21839s3;
    public int f21840s4;
    public int f21841t0;
    public final ImageView f21842t1;
    public AnimatorSet f21843t2;
    public final sf f21844t3;
    public long f21845t4;
    public ge f21846u0;
    public float f21847u1;
    public int f21848u2;
    public final vf f21849u3;
    public boolean f21850u4;
    public boolean v;
    public ValueAnimator f21851v0;
    public ImageView f21852v1;
    public int f21853v2;
    public final Paint f21854v3;
    public ValueAnimator f21855v4;
    public Runnable f21856w;
    public float f21857w0;
    public ze f21858w1;
    public int f21859w2;
    public boolean f21860w3;
    public boolean f21861w4;
    public float f21862x;
    public boolean f21863x0;
    public final ke f21864x1;
    public int f21865x2;
    public boolean f21866x3;
    public boolean f21867x4;
    public float f21868y;
    public boolean f21869y0;
    public final ie f21870y1;
    public boolean f21871y2;
    public boolean y3;
    public boolean f21872y4;
    public boolean f21873z0;
    public final ie f21874z1;
    public int f21875z2;
    public boolean f21876z3;
    public boolean f21877z4;
    ...
    public class RecordCircle extends View {
        ...
        public final z9 h;
        public final z9 f21882n;
        public final float f21883r;
        public final float f21884s;
        public final RectF v;
        public boolean f21885w;
        public final rg f21886x;
        public int f21887y;
        ...
        public RecordCircle(Context context) {
            ...
            this.f21882n = z9Var2;
            this.f21883r = AndroidUtilities.dpf2(41.0f);
            this.f21884s = AndroidUtilities.dp(30.0f);
            this.v = new RectF();
            this.H = 0.0f;
            this.I = true;
        ...
        public final void a() {
            ...
            int i10 = org.telegram.ui.ActionBar.i6.f18807bf;
        ...
        public final void b(Canvas canvas, Drawable drawable, Drawable drawable2, float f7, int i10) {
            ...
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            boolean z10 = chatActivityEnterView.f21828q4;
            if (z10 && chatActivityEnterView.f21787i4 == 1.0f) {
                chatActivityEnterView.f21740b1.setAlpha(1.0f);
                setVisibility(8);
            } else if (z10 && chatActivityEnterView.f21787i4 < 1.0f) {
        ...
        public final void c(boolean z10) {
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            if (!z10) {
                chatActivityEnterView.f21834r4 = false;
                chatActivityEnterView.f21798k4 = -1.0f;
                chatActivityEnterView.f21792j4 = -1.0f;
                chatActivityEnterView.f21787i4 = 1.0f;
                chatActivityEnterView.f21823p4 = 1.0f;
                chatActivityEnterView.f21807m4 = 0.0f;
                chatActivityEnterView.f21781h4 = 0.0f;
            }
            invalidate();
            chatActivityEnterView.f21818o4 = 0.0f;
            chatActivityEnterView.x0();
            chatActivityEnterView.l4 = 0.0f;
            chatActivityEnterView.f21775g4 = 0.0f;
            chatActivityEnterView.f21769f4 = 0.0f;
            chatActivityEnterView.f21756d4 = false;
            this.f21881f = 0.0f;
            chatActivityEnterView.f21828q4 = false;
        ...
        public final boolean dispatchHoverEvent(MotionEvent motionEvent) {
            if (!super.dispatchHoverEvent(motionEvent) && !this.f21886x.f(motionEvent)) {
                return false;
            }
            return true;
        }
        ...
        public final void e() {
            ...
            int i10 = org.telegram.ui.ActionBar.i6.f18826cf;
            paint.setColor(chatActivityEnterView.i0(i10));
            this.h.d.setColor(i0.a.k(chatActivityEnterView.i0(i10), 38));
            this.f21882n.d.setColor(i0.a.k(chatActivityEnterView.i0(i10), 76));
            this.f21887y = chatActivityEnterView.L3.getAlpha();
        }

        public float getControlsScale() {
            return ChatActivityEnterView.this.f21781h4;
        }

        public float getScale() {
            return ChatActivityEnterView.this.f21775g4;
        }
        ...
        public final void onMeasure(int i10, int i11) {
            ...
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            chatActivityEnterView.f21840s4 = (int) ((1.0f - chatActivityEnterView.f21787i4) * (-measuredWidth));
        }

        public void setAmplitude(double d) {
            this.f21882n.d((float) (Math.min(1800.0d, d) / 1800.0d), true);
            this.h.d((float) (Math.min(1800.0d, d) / 1800.0d), false);
            float min = (float) (Math.min(1800.0d, d) / 1800.0d);
            this.f21879b = min;
            this.f21880c = (min - this.f21878a) / 375.0f;
            invalidate();
        }

        public void setControlsScale(float f7) {
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            chatActivityEnterView.f21781h4 = f7;
            qg qgVar = chatActivityEnterView.N1;
            if (qgVar != null) {
                qgVar.invalidate();
            }
        ...
        public void setScale(float f7) {
            ChatActivityEnterView.this.f21775g4 = f7;
            invalidate();
        }

        public void setTransformToSeekbar(float f7) {
            ChatActivityEnterView.this.f21818o4 = f7;
            invalidate();
        }
    }
    ...
    public class SlideTextView extends View {
        ...
        public final TextPaint f21888a;
        public final TextPaint f21889b;
        public final Paint f21890c;
        public final String d;
        public final String e;
        public float f21891f;
        public float h;
        public float f21892n;
        public float f21893r;
        public float f21894s;
        public float v;
        public float f21895w;
        public boolean f21896x;
        public long f21897y;
        ...
        public final void a() {
            int i10 = org.telegram.ui.ActionBar.i6.f19027nf;
            int i11 = ChatActivityEnterView.f21731m5;
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            int i02 = chatActivityEnterView.i0(i10);
            TextPaint textPaint = this.f21888a;
            textPaint.setColor(i02);
            int i12 = org.telegram.ui.ActionBar.i6.f19010mf;
            int i03 = chatActivityEnterView.i0(i12);
            TextPaint textPaint2 = this.f21889b;
            textPaint2.setColor(i03);
            this.f21894s = textPaint.getAlpha();
        ...
        public final void onDraw(Canvas canvas) {
            ...
            if (this.G != null && (staticLayout = this.H) != null) {
                ...
                if (chatActivityEnterView.M1 != null) {
                    ...
                    int i02 = chatActivityEnterView.i0(org.telegram.ui.ActionBar.i6.f19027nf);
                    TextPaint textPaint = this.f21888a;
                    textPaint.setColor(i02);
                    textPaint.setAlpha((int) ((1.0f - this.f21892n) * this.f21894s * this.f21893r));
                    this.f21889b.setAlpha((int) (this.v * this.f21892n));
                    int color = textPaint.getColor();
                    Paint paint = this.f21890c;
                    paint.setColor(color);
                    boolean z10 = true;
                    boolean z11 = this.M;
                    if (z11) {
                        this.f21895w = AndroidUtilities.dp(16.0f);
                    } else {
                        long currentTimeMillis = System.currentTimeMillis() - this.f21897y;
                        this.f21897y = System.currentTimeMillis();
                        if (this.f21892n == 0.0f && this.f21893r > 0.8f) {
                            if (this.f21896x) {
                                float dp3 = ((AndroidUtilities.dp(3.0f) / 250.0f) * ((float) currentTimeMillis)) + this.f21895w;
                                this.f21895w = dp3;
                                if (dp3 > AndroidUtilities.dp(6.0f)) {
                                    this.f21895w = AndroidUtilities.dp(6.0f);
                                    this.f21896x = false;
                                }
                            } else {
                                float dp4 = this.f21895w - ((AndroidUtilities.dp(3.0f) / 250.0f) * ((float) currentTimeMillis));
                                this.f21895w = dp4;
                    ...
                    int dp5 = AndroidUtilities.dp(5.0f) + ((int) ((getMeasuredWidth() - this.f21891f) / 2.0f));
                    ...
                    float f16 = dp5;
                    float f17 = this.f21895w;
                    float f18 = this.f21892n;
                    float dp6 = (((((1.0f - f18) * f17) * this.f21893r) + f16) - (f11 * f18)) + AndroidUtilities.dp(f10);
                    if (z10) {
                        dp = 0.0f;
                    } else {
                        dp = this.f21892n * AndroidUtilities.dp(12.0f);
                    }
                    if (this.f21892n != 1.0f) {
                        f12 = 12.0f;
                        int translationX = (int) ((chatActivityEnterView.M1.getTranslationX() * 0.3f) + ((1.0f - this.f21893r) * ((-getMeasuredWidth()) / 4)));
                        canvas.save();
        ...
        public final void onMeasure(int i10, int i11) {
            ...
            if (this.L != measuredHeight) {
                ...
                String str = this.d;
                TextPaint textPaint = this.f21888a;
                this.f21891f = textPaint.measureText(str);
                String str2 = this.e;
                TextPaint textPaint2 = this.f21889b;
                ...
                this.G = new StaticLayout(this.d, textPaint, (int) this.f21891f, alignment, 1.0f, 0.0f, false);
        ...
        public final boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (this.f21892n == 0.0f || !isEnabled()) {
                return false;
            }
            ...
            if (z10) {
                ...
                if (motionEvent.getAction() == 1 && rect.contains(x10, y3)) {
                    ...
                    chatActivityEnterView.f21749c3 = null;
                    chatActivityEnterView.f21755d3 = null;
    ...
    public ChatActivityEnterView(Activity activity, pv0 pv0Var, org.telegram.ui.bo boVar, boolean z10, final org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.f21812n3 = -1;
        this.f21822p3 = true;
        this.f21827q3 = new ye(this, 0);
        this.f21833r3 = new ff(this);
        this.f21839s3 = new org.telegram.ui.Cells.c1(Integer.class, "translationY", 1);
        this.f21844t3 = new Property(Float.class, "scale");
        this.f21849u3 = new Property(Float.class, "controlsScale");
        this.f21854v3 = new Paint(1);
        ...
        this.f21736a4 = new he(this, 2);
        this.f21743b4 = new he(this, 3);
        this.f21750c4 = new he(this, 4);
        this.f21861w4 = true;
        this.f21867x4 = true;
        this.A4 = new Paint();
        this.B4 = 1.0f;
        ...
        this.Z4 = new Matrix();
        qr qrVar = qr.h;
        this.f21737a5 = new c6(this, 0L, 280L, qrVar);
        this.f21744b5 = new c6(this, 0L, 280L, qrVar);
        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
        paint.setShader(linearGradient);
        qr qrVar2 = ji.n.V;
        this.f21763e5 = new le.e(0, this, qrVar2, 250L);
        this.f21770f5 = new le.b(1, this, qrVar2, 250L, false);
        this.f21776g5 = new le.b(2, this, qrVar, 320L, false);
        this.f21782h5 = new le.b(3, this, qrVar, 320L, false);
        this.V3 = e6Var;
        this.W3 = z10;
        this.f21779h2 = z10 && !AndroidUtilities.isInMultiwindow && (boVar == null || !boVar.isInBubbleMode());
        Paint paint2 = new Paint(1);
        this.P1 = paint2;
        paint2.setColor(i0(org.telegram.ui.ActionBar.i6.f18788af));
        setFocusable(true);
        ...
        leVar.setBackground(org.telegram.ui.ActionBar.i6.W(AndroidUtilities.dp(19.0f), i03, dp2, dp3, dp2, dp3));
        ...
        imageView.setBackground(org.telegram.ui.ActionBar.i6.W(AndroidUtilities.dp(19.0f), i04, dp4, dp5, dp4, dp5));
        imageView.setVisibility(8);
        imageView.setContentDescription(LocaleController.getString(R.string.ArticleDeleteDraft));
        imageView.setOnClickListener(new View.OnClickListener(this) {
            public final ChatActivityEnterView f23076b;
            ...
            public final void onClick(View view) {
                ...
                switch (r3) {
                    case 0:
                        ...
                        ChatActivityEnterView chatActivityEnterView = this.f23076b;
                    ...
                    default:
                        ...
                        ChatActivityEnterView chatActivityEnterView2 = this.f23076b;
                        ...
                        if (z12) {
                            if (chatActivityEnterView2.D1 != null) {
                                ...
                                e0Var.f23464k0 = new ae(chatActivityEnterView2, 0);
                                be beVar = new be(chatActivityEnterView2, j3, e6Var2, 0);
                                e0Var.f23465l0 = j3;
                                e0Var.f23467o0 = beVar;
                                e0Var.show();
                                return;
                            }
                            return;
                            ...
                            e0Var2.f23463j0 = new ae(chatActivityEnterView2, 1);
        ...
        if (z10) {
            ...
            if (i14 != 9) {
                ...
                this.f21758e0.a(this.f21767f2, false);
                if (this.f21767f2) {
                ...
                imageView2.setVisibility((!this.f21773g2 || ((mgVar = this.Y2) != null && mgVar.C0())) ? 8 : 0);
            ...
            kVar.setBackground(org.telegram.ui.ActionBar.i6.f0(i0(i13), 1, -1));
        ...
        imageView3.setBackground(org.telegram.ui.ActionBar.i6.f0(i0(i13), 1, AndroidUtilities.dp(16.0f)));
        ...
        imageView3.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                ...
                switch (r3) {
                    case 0:
                        int i142 = ChatActivityEnterView.f21731m5;
                        ChatActivityEnterView chatActivityEnterView = this.f23076b;
                        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(chatActivityEnterView.getContext(), 0, e6Var);
                        String string = LocaleController.getString(R.string.ArticleDeleteDraftTitle);
                        org.telegram.ui.ActionBar.b2 b2Var = alertDialog$Builder.f18437a;
        ...
        imageView4.setBackground(org.telegram.ui.ActionBar.i6.f0(i0(i13), 1, AndroidUtilities.dp(16.0f)));
        ...
        imageView6.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.f0(i0(i13), 1, -1));
        ...
        this.F0 = ugVar;
        org.telegram.ui.ActionBar.j5 j5Var = ugVar.f28394a;
        ...
        this.f21859w2 = globalEmojiSettings.getInt("kbd_height", AndroidUtilities.dp(200.0f));
        this.f21865x2 = globalEmojiSettings.getInt("kbd_height_land3", AndroidUtilities.dp(200.0f));
        j1(false, false);
        K(false);
        F();
        W();
    ...
    public static void f(final ChatActivityEnterView chatActivityEnterView, final fv0 fv0Var, int[] iArr, uo0 uo0Var) {
        ...
        if (org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19113s8, true) == -1) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        if (i10 >= 26) {
            if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18780a7, true)) >= 0.721f) {
                z11 = true;
            } else {
                z11 = false;
            }
        ...
        if (i10 >= 23) {
            chatActivityEnterView.f21836s0 = chatActivityEnterView.getRootWindowInsets().getSystemWindowInsetLeft() + chatActivityEnterView.f21836s0;
        }
        chatActivityEnterView.f21819p0.getLocationInWindow(iArr2);
        final float f10 = iArr2[0];
        final float f11 = iArr2[1];
        float dp = AndroidUtilities.dp(5.0f);
        float dp2 = iArr[0] + chatActivityEnterView.f21836s0 + dp + AndroidUtilities.dp(4.0f) + 0.0f;
        float f12 = iArr[1] + chatActivityEnterView.f21841t0 + dp + 0.0f;
        fv0Var.setTranslationX(dp2);
        fv0Var.setTranslationY(f12);
        float f13 = chatActivityEnterView.f21819p0.getLayoutParams().width;
        if (chatActivityEnterView.f21799k5) {
            f7 = chatActivityEnterView.f21819p0.getScaleX();
        } else {
            f7 = 1.0f;
        }
        ...
        dialog2.show();
        if (!chatActivityEnterView.f21799k5) {
            chatActivityEnterView.f21819p0.setScaleX(1.0f);
            chatActivityEnterView.f21819p0.setScaleY(1.0f);
        }
        chatActivityEnterView.f21819p0.setAlpha(1.0f);
        cf cfVar = chatActivityEnterView.f21824q0;
        boolean z12 = chatActivityEnterView.f21799k5;
        o1.c cVar = o1.h.f15335o;
        if (z12) {
            kVar = null;
        } else {
            o1.k kVar3 = new o1.k(chatActivityEnterView.f21819p0, cVar);
            kVar3.f15351u = org.telegram.ui.Cells.p6.l(0.5f, 750.0f, 1.0f);
            kVar = kVar3;
        }
        boolean z13 = chatActivityEnterView.f21799k5;
        o1.c cVar2 = o1.h.f15336p;
        if (z13) {
            dialog = dialog2;
            kVar2 = null;
        } else {
            dialog = dialog2;
            o1.k kVar4 = new o1.k(chatActivityEnterView.f21819p0, cVar2);
            kVar4.f15351u = org.telegram.ui.Cells.p6.l(0.5f, 750.0f, 1.0f);
            kVar2 = kVar4;
        }
        o1.k kVar5 = new o1.k(chatActivityEnterView.f21819p0, o1.h.f15340t);
        kVar5.f15351u = org.telegram.ui.Cells.p6.l(0.0f, 750.0f, 1.0f);
        final Dialog dialog3 = dialog;
        kVar5.a(new o1.f(chatActivityEnterView) {
            public final ChatActivityEnterView f28376b;

            {
                this.f28376b = chatActivityEnterView;
            }
            ...
            public final void a(o1.h hVar, boolean z14, float f14, float f15) {
                ...
                ChatActivityEnterView chatActivityEnterView2 = this.f28376b;
                switch (i11) {
                    case 0:
                        ...
                        if (dialog4.isShowing()) {
                            ...
                            wo0 wo0Var = chatActivityEnterView2.f21819p0;
                            wo0Var.getClass();
                            wo0Var.a(false, false, 0.0f);
                            if (!chatActivityEnterView2.f21799k5) {
                                chatActivityEnterView2.f21819p0.setScaleX(1.0f);
                                chatActivityEnterView2.f21819p0.setScaleY(1.0f);
                            }
                            chatActivityEnterView2.f21819p0.setAlpha(1.0f);
                            chatActivityEnterView2.f21819p0.getViewTreeObserver().addOnPreDrawListener(new ef(chatActivityEnterView2, dialog4, 0));
                            return;
                        }
                        return;
                    default:
                        ...
                        if (dialog4.isShowing()) {
                            fv0Var2.setTranslationX(f17);
                            fv0Var2.setTranslationY(f16);
                            wo0 wo0Var2 = chatActivityEnterView2.f21819p0;
                            wo0Var2.getClass();
                            ...
                            chatActivityEnterView2.f21819p0.setAlpha(1.0f);
                            chatActivityEnterView2.f21819p0.getViewTreeObserver().addOnPreDrawListener(new ef(chatActivityEnterView2, dialog4, 1));
                            return;
                        }
                        return;
                }
        ...
        o1.k kVar6 = new o1.k(fv0Var, o1.h.f15333m);
        kVar6.f15342b = w7.p.a(dp2, f10 - AndroidUtilities.dp(6.0f), dp2);
        kVar6.f15343c = true;
        kVar6.f15351u = org.telegram.ui.Cells.p6.l(f10, 700.0f, 0.75f);
        kVar6.h = f10 - AndroidUtilities.dp(6.0f);
        o1.k kVar7 = new o1.k(fv0Var, o1.h.f15334n);
        kVar7.f15342b = w7.p.a(f12, f12, AndroidUtilities.dp(6.0f) + f11);
        kVar7.f15343c = true;
        kVar7.f15351u = org.telegram.ui.Cells.p6.l(f11, 700.0f, 0.75f);
        kVar7.f15345g = AndroidUtilities.dp(6.0f) + f11;
        ...
        kVar8.f15351u = org.telegram.ui.Cells.p6.l(dp3, 1000.0f, 1.0f);
        o1.k kVar9 = new o1.k(fv0Var, cVar2);
        kVar9.f15351u = org.telegram.ui.Cells.p6.l(dp3, 1000.0f, 1.0f);
    ...
    public static void g(ChatActivityEnterView chatActivityEnterView, TLRPC.Document document, String str, MessageObject.SendAnimationData sendAnimationData, boolean z10, int i10, int i11, Object obj, Long l4, boolean z11) {
        ...
        if (chatActivityEnterView.G0 > 0 && !chatActivityEnterView.c()) {
            ...
            if (mgVar != null) {
                ...
                mgVar.t1(ugVar, ugVar.f28394a.getText(), true);
                return;
            }
            return;
        }
    ...
    public static void h(ChatActivityEnterView chatActivityEnterView, TL_keyboard.KeyboardButton keyboardButton) {
        ...
        if (chatActivityEnterView.S2 != null && (boVar = chatActivityEnterView.O2) != null && boVar.f32328h4 && boVar.d() == chatActivityEnterView.S2.getId()) {
            z10 = true;
        } else {
            z10 = false;
        }
        if ((chatActivityEnterView.S2 != null && !z10) || BotForumHelper.isBotForum(chatActivityEnterView.Q, chatActivityEnterView.P2)) {
            ...
            messageObject = chatActivityEnterView.f21801l2;
        } else {
            messageObject = null;
        }
        MessageObject messageObject2 = chatActivityEnterView.S2;
        if (messageObject2 == null || z10) {
            messageObject2 = chatActivityEnterView.f21801l2;
        }
        ...
        if (chatActivityEnterView.S2 != null && !z10) {
            ...
            MessageObject messageObject3 = chatActivityEnterView.f21801l2;
            if (messageObject3 != null && messageObject3.messageOwner.reply_markup.single_use) {
                ...
                MessagesController.getMainSettings(chatActivityEnterView.Q).edit().putInt("answered_" + chatActivityEnterView.getTopicKeyString(), chatActivityEnterView.f21801l2.getId()).commit();
            }
        }
        mg mgVar = chatActivityEnterView.Y2;
        if (mgVar != null) {
    ...
    public static void i(ChatActivityEnterView chatActivityEnterView, MessageObject messageObject, TL_keyboard.KeyboardButtonProto keyboardButtonProto) {
        ...
        if (Build.VERSION.SDK_INT >= 23 && activity.checkSelfPermission("android.permission.ACCESS_COARSE_LOCATION") != 0) {
            ...
            chatActivityEnterView.f21780h3 = messageObject;
            chatActivityEnterView.f21786i3 = keyboardButtonProto;
            return;
        }
    ...
    public static void m(ChatActivityEnterView chatActivityEnterView) {
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(chatActivityEnterView, "lockAnimatedTranslation", chatActivityEnterView.f21792j4);
        ...
        animatorSet.playTogether(ofFloat2, ofFloat, ObjectAnimator.ofFloat(chatActivityEnterView, "slideToCancelProgress", 1.0f).setDuration(200L), ObjectAnimator.ofFloat(chatActivityEnterView.f21790j1, "cancelToProgress", 1.0f));
        animatorSet.start();
    }
                    ...
                    if (messageEntity.offset + messageEntity.length <= spannableStringBuilder.length()) {
                        if (messageEntity instanceof TLRPC.TL_inputMessageEntityMentionName) {
                            ...
                            if (messageEntity instanceof TLRPC.TL_messageEntityBold) {
                                ...
                                obj7.f26644b = i22;
                                obj7.f26645c = i22 + messageEntity.length;
    ...
    public final void A() {
        int i10;
        if (this.f21754d2 && this.f21747c1) {
    ...
    public final void B() {
        ze zeVar;
        org.telegram.ui.bo boVar;
        if (this.L == null && (zeVar = this.J1) != null && zeVar.getRight() != 0 && (boVar = this.O2) != null && BirthdayController.isToday(boVar.f32243a8)) {
            ...
            if (mainSettings.getBoolean(Calendar.getInstance().get(1) + "bdayhint_" + boVar.a(), true)) {
                ...
                this.L.m(1.0f, -((getWidth() - AndroidUtilities.dp(12.0f)) - ((this.J1.getMeasuredWidth() / 2.0f) + (this.J1.getX() + (this.f21815o1.getX() + this.f21864x1.getX())))));
                addView(this.L, w7.x5.d(-1, 200.0f, 48, 0.0f, -192.0f, 0.0f, 0.0f));
                ci.f4 f4Var2 = this.L;
                f4Var2.f4633l0 = new qd(this, 12);
                f4Var2.d = 8000L;
                f4Var2.u();
            }
        }
    ...
    public final void B0() {
        ...
        float audioLeft;
        float audioRight;
        gk0 gk0Var = this.f21778h1;
        if (gk0Var != null) {
            gk0Var.Q = true;
            g71 g71Var = gk0Var.f24382n;
            if (g71Var != null) {
                g71Var.P(false);
                gk0Var.f24382n.H();
                gk0Var.f24382n = null;
        ...
        if (this.f21778h1 != null && this.f21735a3 != null) {
            ...
            gk0 gk0Var2 = this.f21778h1;
            if (gk0Var2 == null) {
                audioLeft = 0.0f;
            } else {
                audioLeft = gk0Var2.getAudioLeft();
            }
            gk0 gk0Var3 = this.f21778h1;
            if (gk0Var3 == null) {
                audioRight = 1.0f;
            } else {
        ...
        PowerManager.WakeLock wakeLock = this.f21821p2;
        if (wakeLock != null) {
            try {
                wakeLock.release();
                this.f21821p2 = null;
    ...
    public final void B1() {
        ...
        lf lfVar = this.m0;
        if (lfVar != null) {
            int childCount = lfVar.f8735c.getChildCount();
            int i10 = 0;
            for (int i11 = 0; i11 < childCount; i11++) {
                View childAt = this.m0.f8735c.getChildAt(i11);
                if (i11 < 4) {
            ...
            } else if (this.f21809n0.f8237c.size() > 4) {
                f7 = hg.k0.f(162.8f, pv0Var.getMeasuredHeight(), 0);
            } else {
                f7 = hg.k0.f((Math.max(1, Math.min(4, this.f21809n0.f8237c.size())) * 36) + 8, pv0Var.getMeasuredHeight(), 0);
            }
            if (this.m0.f8735c.getPaddingTop() != f7) {
                this.m0.f8735c.setTopGlowOffset(f7);
                if (this.U4 == -1 && this.m0.getVisibility() == 0 && this.m0.f8735c.getLayoutManager() != null && (L0 = (c0Var = (s4.c0) this.m0.f8735c.getLayoutManager()).L0()) >= 0 && (m10 = c0Var.m(L0)) != null) {
                    this.U4 = L0;
                    this.V4 = m10.getTop() - this.m0.f8735c.getPaddingTop();
                }
                this.m0.f8735c.setPadding(0, f7, 0, AndroidUtilities.dp(8.0f));
            }
        }
    }

    public final void C1(boolean z10) {
        if (this.f21803l5 != 1 && this.P2 > 0) {
            R();
        }
        ei.c0 c0Var = this.f21800l0;
        if (c0Var != null) {
            c0Var.setWebView(j0());
        }
        A1(z10);
    ...
    public final void E() {
        boolean z10;
        of ofVar = this.E0;
        if ((ofVar == null || TextUtils.isEmpty(ofVar.getText())) && !this.f21871y2 && !this.j3 && !t0()) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        ei.c0 c0Var = this.f21800l0;
        if (c0Var != null) {
            boolean z11 = c0Var.f8266f;
            if (z11 != z10) {
                c0Var.f8266f = z10;
                c0Var.requestLayout();
                c0Var.invalidate();
            }
            if (z11 != this.f21800l0.f8266f) {
                le leVar = this.Q0;
    ...
    public final void E0() {
        ...
        if (!j0() || !v()) {
            getVisibility();
            if (this.f21796k2 && !org.telegram.ui.ActionBar.n2.hasSheets(this.O2)) {
                this.f21796k2 = false;
                mg mgVar = this.Y2;
                if (mgVar != null) {
                    mgVar.r1();
                ...
                if (!AndroidUtilities.usingHardwareInput && !this.f21871y2 && !AndroidUtilities.isInMultiwindow) {
                    this.j3 = true;
                    ye yeVar = this.f21827q3;
    ...
    public final void E1() {
        float f7 = this.f21829r * this.h;
        le leVar = this.Q0;
        leVar.setScaleX(f7);
        leVar.setScaleY(this.f21829r * this.h);
        leVar.setAlpha(this.f21835s * this.f21808n);
    }
    ...
    public final void F1(boolean z10) {
        ...
        if (ofVar != null) {
            ...
            if (charSequence != null) {
                ...
                this.E0.setHintText2(this.f21764f, z10);
                return;
            }
            boolean z13 = true;
            boolean z14 = false;
            ...
            if (i10 == 9) {
                ...
                if (z11) {
                    ...
                    if (messageObject2 != null && (replyMarkup2 = messageObject2.messageOwner.reply_markup) != null && !TextUtils.isEmpty(replyMarkup2.placeholder)) {
                    ...
                    } else if (this.X0 && (messageObject = this.f21801l2) != null && (replyMarkup = messageObject.messageOwner.reply_markup) != null && !TextUtils.isEmpty(replyMarkup.placeholder)) {
                        this.E0.setHintText(this.f21801l2.messageOwner.reply_markup.placeholder, z10);
                        ...
                        TLRPC.TL_forumTopic findTopic = MessagesController.getInstance(this.Q).getTopicsController().findTopic(boVar.e.f18112id, 1L);
                        ...
                        if (user != null && user.bot_forum_view && !user.bot_forum_can_manage_topics && boVar != null && !boVar.f32328h4) {
                            this.E0.setHintText(LocaleController.getString(R.string.SendBotNoThread));
                        } else if (boVar != null && boVar.F9() && !boVar.f32328h4) {
                            if (boVar.X3 != null && boVar.f32316g4) {
    ...
    public final void G1(int i10) {
        ...
        if (this.E0 != null) {
            ...
            if (messageObject == null || messageObject.needResendWhenEdit()) {
                ...
                boolean z10 = this.f21877z4;
                float f7 = 2.0f;
                ve veVar = this.J0;
                int i12 = 0;
                if (z10 && this.f21799k5) {
                    if (this.f21850u4) {
                        f7 = 50.0f;
                    }
                    ...
                    ze zeVar = this.f21858w1;
                    if (zeVar != null && zeVar.getVisibility() == 0 && (xeVar2 = this.I1) != null && xeVar2.getVisibility() == 0 && (kVar = this.f21825q1) != null && kVar.getVisibility() == 0) {
                        layoutParams.rightMargin = AndroidUtilities.dp(146.0f);
                    } else {
                        ze zeVar2 = this.f21858w1;
                ...
                if (ieVar != null) {
                    ...
                    this.f21759e1.setLayoutParams(layoutParams2);
                }
            }
        }
    }
    ...
    public final void H(int i10, boolean z10) {
        ...
        if (i10 > AndroidUtilities.dp(50.0f) && this.f21871y2 && !AndroidUtilities.isInMultiwindow) {
            if (z10) {
                this.f21865x2 = i10;
                MessagesController.getGlobalEmojiSettings().edit().putInt("kbd_height_land3", this.f21865x2).commit();
            } else {
                this.f21859w2 = i10;
                MessagesController.getGlobalEmojiSettings().edit().putInt("kbd_height", this.f21859w2).commit();
            }
        }
        if (this.f21871y2 && this.W0 && this.U0 == null) {
            this.W0 = false;
        }
        boolean t02 = t0();
        pv0 pv0Var = this.l1;
        ...
        if (t02) {
            ...
            if (zfVar2 != null) {
                ...
                ph.f fVar2 = this.f21751c5;
                if (fVar2 != null && i11 > 0 && this.f21760e2 == 1) {
                    ((ph.i) fVar2).g(i11);
                }
            }
            if (view != null) {
                FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) view.getLayoutParams();
                if (!this.f21876z3 && !this.y3 && (((i12 = layoutParams.width) != (i13 = AndroidUtilities.displaySize.x) || layoutParams.height != i11) && ((fVar = this.f21751c5) == null || i12 != -1 || layoutParams.height != -1))) {
                    if (fVar == null) {
                    ...
                    if (pv0Var != null) {
                        int i15 = this.f21875z2;
                        this.f21875z2 = layoutParams.height;
                        pv0Var.requestLayout();
                        G0();
                        if (this.f21779h2 && !this.f21871y2 && i15 != this.f21875z2 && N0()) {
                            AnimatorSet animatorSet = new AnimatorSet();
                            this.V0 = animatorSet;
                            if (this.f21751c5 != null) {
                                animatorSet.playTogether(ValueAnimator.ofFloat(this.f21875z2 - i15, 0.0f));
                            } else {
                                animatorSet.playTogether(ObjectAnimator.ofFloat(view, View.TRANSLATION_Y, this.f21875z2 - i15, 0.0f));
                            }
                            this.V0.setInterpolator(org.telegram.ui.ActionBar.p1.f19480w);
        ...
        this.f21871y2 = z11;
        E();
        if (this.f21871y2 && t0() && this.A3 == null) {
            s1(0, this.f21760e2, true, true);
        } else if (!this.f21871y2 && !t0() && (messageObject = this.f21801l2) != null && this.S2 != messageObject && !j0() && !v() && !org.telegram.ui.ActionBar.n2.hasSheets(boVar) && (((ofVar = this.E0) == null || TextUtils.isEmpty(ofVar.getText())) && (tL_replyKeyboardMarkup = this.f21805m2) != null && !tL_replyKeyboardMarkup.rows.isEmpty())) {
        ...
        if (this.f21875z2 != 0 && !(z12 = this.f21871y2) && z12 != z14 && !t0()) {
            this.f21875z2 = 0;
            pv0Var.requestLayout();
        }
        if (this.f21871y2 && this.j3) {
            this.j3 = false;
            if (this.f21817o3) {
                this.f21817o3 = false;
                this.G1.setButtons(this.f21805m2);
            }
            AndroidUtilities.cancelRunOnUIThread(this.f21827q3);
        }
        G0();
    }
    ...
    public final void I0() {
        ...
        if (!j0() || !v()) {
            ...
            if (!org.telegram.ui.ActionBar.n2.hasSheets(boVar)) {
                if (!AndroidUtilities.usingHardwareInput && !AndroidUtilities.isInMultiwindow && ((boVar == null || !boVar.isInBubbleMode()) && !this.f21785i2)) {
                    i10 = 2;
                } else {
                    i10 = 0;
                }
                ...
                if (this.f21785i2) {
                    this.f21796k2 = true;
                } else if (!AndroidUtilities.usingHardwareInput && !this.f21871y2 && !AndroidUtilities.isInMultiwindow) {
    ...
    public final void J() {
        ...
        if (DialogObject.isChatDialog(this.P2)) {
            ...
            this.f21863x0 = ChatObject.canSendRoundVideo(chat);
            this.f21869y0 = ChatObject.canSendVoice(chat);
        } else {
            z10 = false;
        }
        ...
        if (!this.f21863x0 && z11) {
            z11 = false;
        }
        if (!this.f21869y0 && !z11) {
            if (!this.f21754d2) {
                z12 = false;
            }
        } else {
    ...
    public final void J1(TLRPC.Chat chat, TLRPC.UserFull userFull) {
        ...
        float f10 = 1.0f;
        if (chat != null) {
            if (!ChatObject.canSendVoice(chat) && (!ChatObject.canSendRoundVideo(chat) || !this.f21754d2)) {
                z10 = true;
            } else {
                z10 = false;
            }
            this.f21734a1 = z10;
            this.f21738b = ChatObject.canSendStickers(chat);
            boolean canSendPlain = ChatObject.canSendPlain(chat);
            this.f21873z0 = canSendPlain;
            if (!this.f21738b && !canSendPlain) {
                z11 = true;
            } else {
                z11 = false;
            }
            ...
            if (!this.A0 && (cgVar = this.U0) != null) {
                cgVar.L(-this.P2, !this.f21873z0, !this.f21738b);
            }
            this.f21863x0 = ChatObject.canSendRoundVideo(chat);
            this.f21869y0 = ChatObject.canSendVoice(chat);
        } else if (userFull != null) {
            this.f21734a1 = userFull.voice_messages_forbidden;
            this.K = userFull;
        }
        if (this.f21734a1) {
            f10 = 0.5f;
        ...
        te teVar = this.f21740b1;
        teVar.setColorFilter(porterDuffColorFilter);
        teVar.invalidate();
        F1(false);
        boolean z13 = this.f21747c1;
        if (!this.f21863x0 && z13) {
            z13 = false;
        }
        if (!this.f21869y0 && !z13) {
            if (!this.f21754d2) {
                z12 = false;
            }
        } else {
    ...
    public final void K0(CharSequence charSequence, String str, CharSequence charSequence2) {
        ...
        if (this.E0 != null && (boVar = this.O2) != null && MessagesController.getInstance(this.Q).richEditorAvailable()) {
            ...
            d2Var.f11311n = charSequence2;
            d2Var.setResourceProvider(this.V3);
            d2Var.J = boVar;
            d2Var.f11318s = boVar.S;
            d2Var.v = boVar.Y;
    ...
    public void K1(int i10, boolean z10) {
        ...
        char c12;
        Property property;
        xg xgVar3 = xg.f29927a;
        xg xgVar4 = xg.f29928b;
        Float valueOf = Float.valueOf(0.0f);
        Runnable runnable = this.f21765f0;
        if (runnable != null) {
        ...
        if (z13) {
            ...
            if (z14) {
                ...
                qg qgVar = this.N1;
                if (qgVar != null) {
                    qgVar.f27341y.d(1, false, false);
                }
                MediaDataController mediaDataController = MediaDataController.getInstance(this.Q);
                long j11 = this.P2;
                org.telegram.ui.bo boVar = this.O2;
                property = property3;
                mediaDataController.toggleDraftVoiceOnce(j11, (boVar == null || !boVar.f32328h4) ? 0L : boVar.d(), this.O);
                this.f21784i1 = 0L;
            }
            X();
            this.f21853v2 = 1;
            ...
            AnimatorSet animatorSet = this.f21838s2;
            if (animatorSet != null) {
                animatorSet.cancel();
            }
            AnimatorSet animatorSet2 = this.f21843t2;
            if (animatorSet2 != null) {
                animatorSet2.cancel();
            }
            Z();
            ai.x5 x5Var = this.f21753d1;
            if (x5Var != null) {
            ...
            sg sgVar = this.f21795k1;
            if (sgVar != null) {
                sgVar.f27850a = 1.0f;
                sgVar.f27851b = System.currentTimeMillis();
                sgVar.f27852c = false;
                sgVar.e = false;
                sgVar.f27853f.stop();
                sgVar.invalidate();
                this.f21795k1.setScaleX(0.0f);
                this.f21795k1.setScaleY(0.0f);
                this.f21795k1.h = true;
            }
            this.f21838s2 = new AnimatorSet();
            this.Y0.setTranslationX(AndroidUtilities.dp(20.0f));
            this.Y0.setAlpha(0.0f);
            if (this.P4 != 3) {
                this.f21790j1.setTranslationX(AndroidUtilities.dp(20.0f));
                this.f21790j1.setAlpha(0.0f);
                this.f21790j1.setCancelToProgress(0.0f);
                SlideTextView slideTextView = this.f21790j1;
                slideTextView.f21893r = 1.0f;
                slideTextView.setEnabled(true);
            } else {
                this.f21790j1.setTranslationX(0.0f);
                this.f21790j1.setAlpha(0.0f);
                this.f21790j1.setCancelToProgress(1.0f);
                this.f21790j1.setEnabled(true);
            }
            this.M1.c(this.P4 == 3);
            this.f21791j2 = false;
            x0();
            ...
            animatorSet3.playTogether(ObjectAnimator.ofFloat(this.Q0, this.Y3, 0.0f), ObjectAnimator.ofFloat(this.Q0, this.f21736a4, 0.0f), ObjectAnimator.ofFloat(this.f21795k1, property4, 1.0f), ObjectAnimator.ofFloat(this.f21795k1, property6, 1.0f), ObjectAnimator.ofFloat(this.Y0, property2, 0.0f), ObjectAnimator.ofFloat(this.Y0, property5, 1.0f));
            animatorSet3.playTogether(ObjectAnimator.ofFloat(this.f21790j1, property2, 0.0f));
            animatorSet3.playTogether(ObjectAnimator.ofFloat(this.f21790j1, property5, 1.0f));
            qg qgVar3 = this.N1;
            if (qgVar3 != null) {
                animatorSet3.playTogether(ObjectAnimator.ofFloat(qgVar3, property5, 1.0f));
            }
            if (this.f21740b1 != null) {
                animatorSet3.playTogether(ObjectAnimator.ofFloat(this.Z0, property5, 0.0f));
            }
            ei.c0 c0Var = this.f21800l0;
            if (c0Var != null) {
                animatorSet3.playTogether(ObjectAnimator.ofFloat(c0Var, property4, 0.0f), ObjectAnimator.ofFloat(this.f21800l0, property6, 0.0f), ObjectAnimator.ofFloat(this.f21800l0, property5, 0.0f));
            }
            AnimatorSet animatorSet4 = new AnimatorSet();
            animatorSet4.playTogether(ObjectAnimator.ofFloat(this.E0, this.f21750c4, AndroidUtilities.dp(20.0f)), ObjectAnimator.ofFloat(this.E0, property5, 0.0f), ObjectAnimator.ofFloat(this.f21759e1, property5, 1.0f));
            if (z14) {
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.f21778h1, property5, 0.0f));
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.f21772g1, property5, 0.0f));
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.f21772g1, property6, 0.0f));
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.f21772g1, property4, 0.0f));
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.f21766f1, property5, 0.0f));
            }
            if (this.I1 != null) {
                animatorSet4.playTogether(p(AndroidUtilities.dp(30.0f)), ObjectAnimator.ofFloat(this.I1, property5, 0.0f));
            }
            org.telegram.ui.xd xdVar = this.f21815o1;
            if (xdVar != null) {
                animatorSet4.playTogether(ObjectAnimator.ofFloat(xdVar, this.f21743b4, AndroidUtilities.dp(30.0f)), ObjectAnimator.ofFloat(this.f21815o1, this.Z3, 0.0f));
                ViewPropertyAnimator viewPropertyAnimator = this.f21820p1;
                if (viewPropertyAnimator != null) {
                    viewPropertyAnimator.cancel();
                    this.f21820p1 = null;
                }
                hg.k kVar = this.f21825q1;
                this.f21847u1 = 0.0f;
                animatorSet4.playTogether(ObjectAnimator.ofFloat(kVar, property5, 0.0f), ObjectAnimator.ofFloat(this.f21825q1, property6, 0.5f), ObjectAnimator.ofFloat(this.f21825q1, property4, 0.5f));
            }
            jh.h hVar = this.f21757d5;
            if (hVar != null) {
                hVar.e(0, false, true);
            }
            this.f21838s2.playTogether(animatorSet3.setDuration(150L), animatorSet4.setDuration(150L), ObjectAnimator.ofFloat(this.M1, this.f21844t3, 1.0f).setDuration(300L));
            if (!z14) {
                this.f21838s2.playTogether(ObjectAnimator.ofFloat(this.M1, this.f21849u3, 1.0f).setDuration(300L));
            }
            this.f21838s2.addListener(new tf(this, z14));
            this.f21838s2.setInterpolator(new DecelerateInterpolator());
            this.f21838s2.start();
            this.Y0.a(this.f21784i1);
        } else if (this.f21791j2 && i10 == 3) {
            return;
        } else {
            PowerManager.WakeLock wakeLock = this.f21821p2;
            if (wakeLock != null) {
            ...
            AnimatorSet animatorSet5 = this.f21838s2;
            if (animatorSet5 != null) {
                z11 = animatorSet5.isRunning();
                te teVar = this.f21740b1;
                if (teVar != null) {
                    teVar.setScaleX(1.0f);
                    this.f21740b1.setScaleY(1.0f);
                }
                this.f21838s2.removeAllListeners();
                this.f21838s2.cancel();
            } else {
                z11 = false;
            }
            AnimatorSet animatorSet6 = this.f21843t2;
            ...
            this.f21838s2 = new AnimatorSet();
            if (z11 || i10 == 4) {
                te teVar2 = this.f21740b1;
                if (teVar2 != null) {
                    teVar2.setVisibility(0);
                }
                this.f21838s2.playTogether(ObjectAnimator.ofFloat(this.Q0, this.Y3, 1.0f), ObjectAnimator.ofFloat(this.Q0, this.f21736a4, this.A0 ? 0.5f : 1.0f), ObjectAnimator.ofFloat(this.f21795k1, property4, 0.0f), ObjectAnimator.ofFloat(this.f21795k1, property3, 0.0f), ObjectAnimator.ofFloat(this.M1, this.f21844t3, 0.0f), ObjectAnimator.ofFloat(this.M1, this.f21849u3, 0.0f), ObjectAnimator.ofFloat(this.Z0, property5, 1.0f), ObjectAnimator.ofFloat(this.Y0, property5, 0.0f), ObjectAnimator.ofFloat(this.Z0, property5, 1.0f), ObjectAnimator.ofFloat(this.E0, property5, 1.0f), ObjectAnimator.ofFloat(this.E0, this.f21750c4, 0.0f), ObjectAnimator.ofFloat(this, "slideToCancelProgress", 1.0f));
                qg qgVar4 = this.N1;
                if (qgVar4 != null) {
                    i11 = 1;
                    c10 = 0;
                    this.f21838s2.playTogether(ObjectAnimator.ofFloat(qgVar4, property5, 0.0f));
                    this.N1.a();
                } else {
                    i11 = 1;
                    c10 = 0;
                }
                ei.c0 c0Var2 = this.f21800l0;
                if (c0Var2 != null) {
                    AnimatorSet animatorSet7 = this.f21838s2;
                    float[] fArr = new float[i11];
                    f7 = 1.0f;
                    fArr[c10] = 1.0f;
                    ObjectAnimator ofFloat = ObjectAnimator.ofFloat(c0Var2, property4, fArr);
                    ei.c0 c0Var3 = this.f21800l0;
                    float[] fArr2 = new float[i11];
                    fArr2[c10] = 1.0f;
                    ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(c0Var3, property3, fArr2);
                    ei.c0 c0Var4 = this.f21800l0;
                ...
                te teVar3 = this.f21740b1;
                if (teVar3 != null) {
                    teVar3.setScaleX(f7);
                    this.f21740b1.setScaleY(f7);
                    i12 = 1;
                    this.f21838s2.playTogether(ObjectAnimator.ofFloat(this.Z0, property5, f7));
                    this.f21740b1.j(s0() ? xgVar4 : xgVar3, true);
                } else {
                    i12 = 1;
                }
                if (this.I1 != null) {
                    AnimatorSet animatorSet8 = this.f21838s2;
                ...
                if (this.f21815o1 != null) {
                    ViewPropertyAnimator viewPropertyAnimator2 = this.f21820p1;
                    ...
                    z12 = true;
                    r12 = 0;
                    this.f21838s2.playTogether(ObjectAnimator.ofFloat(this.f21815o1, this.f21743b4, 0.0f), ObjectAnimator.ofFloat(this.f21815o1, this.Z3, 1.0f));
                    AnimatorSet animatorSet9 = this.f21838s2;
                    hg.k kVar2 = this.f21825q1;
                    this.f21847u1 = 1.0f;
                    animatorSet9.playTogether(ObjectAnimator.ofFloat(kVar2, property5, 1.0f), ObjectAnimator.ofFloat(this.f21825q1, property3, 1.0f), ObjectAnimator.ofFloat(this.f21825q1, property4, 1.0f));
                } else {
                    r12 = 0;
                    z12 = true;
                }
                jh.h hVar2 = this.f21757d5;
                if (hVar2 != 0) {
                    hVar2.e(r12, r12, z12);
                }
                this.f21791j2 = z12;
                x0();
                this.f21838s2.setDuration(150L);
            } else if (i10 == 3) {
                X();
                Y();
                SlideTextView slideTextView2 = this.f21790j1;
                ...
                if (this.f21747c1) {
                    ...
                    if (ieVar != null) {
                        ieVar.setAlpha(1.0f);
                        this.f21759e1.setVisibility(0);
                    }
                    aj0 aj0Var = this.f21772g1;
                    if (aj0Var != null) {
                    ...
                    v71 v71Var = this.f21766f1;
                    if (v71Var != null) {
                        v71Var.setVisibility(8);
                        x0();
                    }
                    ie ieVar2 = this.f21759e1;
                    if (ieVar2 != null) {
                        i16 = 0;
                        ieVar2.setVisibility(0);
                        f11 = 1.0f;
                        this.f21759e1.setAlpha(1.0f);
                    } else {
                        f11 = 1.0f;
                        i16 = 0;
                    }
                    gk0 gk0Var2 = this.f21778h1;
                    if (gk0Var2 != null) {
                        gk0Var2.setVisibility(i16);
                        this.f21778h1.setAlpha(0.0f);
                    }
                }
                this.f21834r4 = true;
                this.f21807m4 = f11;
                this.f21798k4 = this.f21792j4;
                this.f21787i4 = f11;
                SlideTextView slideTextView3 = this.f21790j1;
                ...
                aj0 aj0Var2 = this.f21772g1;
                if (aj0Var2 != null) {
                    aj0Var2.setAlpha(0.0f);
                    this.f21772g1.setScaleX(0.0f);
                    this.f21772g1.setScaleY(0.0f);
                    this.f21772g1.setProgress(0.0f);
                    this.f21772g1.i();
                }
                if (!this.f21747c1 && !this.f21872y4) {
                    viewGroup = (ViewGroup) this.f21759e1.getParent();
                    layoutParams = this.f21759e1.getLayoutParams();
                    viewGroup.removeView(this.f21759e1);
                    ...
                    this.l1.addView(this.f21759e1, layoutParams2);
                    this.f21766f1.setVisibility(8);
                } else {
                    this.f21766f1.setVisibility(0);
                    viewGroup = null;
                    layoutParams = null;
                }
                x0();
                ...
                if (!z10) {
                    Z();
                    this.f21844t3.set(this.M1, Float.valueOf(1.0f));
                    this.M1.setTransformToSeekbar(1.0f);
                    if (!this.f21747c1) {
                        float f12 = this.f21818o4;
                        if (f12 != 0.0f && this.f21778h1 != null) {
                            this.f21778h1.setAlpha(qr.f27426j.getInterpolation(Math.max(0.0f, ((f12 - 0.38f) - 0.25f) / 0.37f)));
                            this.f21778h1.invalidate();
                        }
                    }
                    this.f21795k1.setScaleY(0.0f);
                    this.f21795k1.setScaleX(0.0f);
                    ...
                    this.Y0.setTranslationX(-AndroidUtilities.dp(20.0f));
                    this.f21790j1.setAlpha(0.0f);
                    this.f21772g1.setAlpha(1.0f);
                    this.f21772g1.setScaleY(1.0f);
                    this.f21772g1.setScaleX(1.0f);
                    this.Y3.set(this.Q0, valueOf);
                    this.f21736a4.set(this.Q0, valueOf);
                    this.E0.setAlpha(0.0f);
                    te teVar4 = this.f21740b1;
                    if (teVar4 != null) {
                        if (s0()) {
                            xgVar3 = xgVar4;
                        }
                    ...
                    ei.c0 c0Var5 = this.f21800l0;
                    if (c0Var5 != null) {
                        c0Var5.setAlpha(0.0f);
                        this.f21800l0.setScaleX(0.0f);
                        this.f21800l0.setScaleY(0.0f);
                    }
                    if (s0()) {
                        this.f21766f1.setAlpha(1.0f);
                    }
                    if (viewGroup != null) {
                        this.l1.removeView(this.f21759e1);
                        viewGroup.addView(this.f21759e1, layoutParams);
                    }
                    this.f21759e1.setAlpha(1.0f);
                    this.f21778h1.setAlpha(1.0f);
                    this.h = 0.0f;
                    this.f21808n = 0.0f;
                    E1();
                    x0();
                } else {
                    this.f21778h1.setAllowDraw(false);
                    ...
                    animatorSet11.playTogether(ObjectAnimator.ofFloat(this.f21795k1, property4, 0.0f), ObjectAnimator.ofFloat(this.f21795k1, property3, 0.0f), ObjectAnimator.ofFloat(this.Y0, property5, 0.0f), ObjectAnimator.ofFloat(this.Y0, property2, -AndroidUtilities.dp(20.0f)), ObjectAnimator.ofFloat(this.f21790j1, property5, 0.0f), ObjectAnimator.ofFloat(this.f21772g1, property5, 1.0f), ObjectAnimator.ofFloat(this.f21772g1, property4, 1.0f), ObjectAnimator.ofFloat(this.f21772g1, property3, 1.0f), ObjectAnimator.ofFloat(this.Q0, this.Y3, 0.0f), ObjectAnimator.ofFloat(this.Q0, this.f21736a4, 0.0f), ObjectAnimator.ofFloat(this.E0, property5, 0.0f));
                    aj0 aj0Var3 = this.f21772g1;
                    if (aj0Var3 != null) {
                    ...
                    if (s0()) {
                        this.f21766f1.setAlpha(0.0f);
                        c11 = 1;
                        c12 = 0;
                        animatorSet10.playTogether(ObjectAnimator.ofFloat(this.f21766f1, property5, 1.0f));
                    ...
                    AnimatorSet animatorSet12 = this.f21838s2;
                    ...
                    this.f21838s2.addListener(new ai.y4(this, viewGroup, layoutParams, 2));
                }
            } else {
                xg xgVar5 = xgVar3;
                xg xgVar6 = xgVar4;
                if (i10 != 2 && i10 != 5) {
                    te teVar6 = this.f21740b1;
                    if (teVar6 != null) {
                        teVar6.setVisibility(0);
                    }
                    AnimatorSet animatorSet13 = new AnimatorSet();
                    animatorSet13.playTogether(ObjectAnimator.ofFloat(this.Q0, this.Y3, 1.0f), ObjectAnimator.ofFloat(this.Q0, this.f21736a4, this.A0 ? 0.5f : 1.0f), ObjectAnimator.ofFloat(this.f21795k1, property4, 0.0f), ObjectAnimator.ofFloat(this.f21795k1, property3, 0.0f), ObjectAnimator.ofFloat(this.Z0, property5, 1.0f));
                    qg qgVar6 = this.N1;
                    if (qgVar6 != null) {
                        animatorSet13.playTogether(ObjectAnimator.ofFloat(qgVar6, property5, 0.0f));
                        this.N1.a();
                    }
                    ei.c0 c0Var9 = this.f21800l0;
                    if (c0Var9 != null) {
                        f10 = 1.0f;
                        animatorSet13.playTogether(ObjectAnimator.ofFloat(c0Var9, property4, 1.0f), ObjectAnimator.ofFloat(this.f21800l0, property3, 1.0f), ObjectAnimator.ofFloat(this.f21800l0, property5, 1.0f));
                    } else {
                        f10 = 1.0f;
                    }
                    te teVar7 = this.f21740b1;
                    if (teVar7 != null) {
                        teVar7.setScaleX(f10);
                        this.f21740b1.setScaleY(f10);
                        animatorSet13.playTogether(ObjectAnimator.ofFloat(this.Z0, property5, f10));
                        te teVar8 = this.f21740b1;
                        if (s0()) {
                            xgVar5 = xgVar6;
                        }
                    ...
                    if (this.f21815o1 != null) {
                        ViewPropertyAnimator viewPropertyAnimator3 = this.f21820p1;
                        ...
                        i15 = 1;
                        r92 = 0;
                        animatorSet13.playTogether(ObjectAnimator.ofFloat(this.f21815o1, this.Z3, 1.0f));
                        hg.k kVar3 = this.f21825q1;
                        this.f21847u1 = 1.0f;
                        animatorSet13.playTogether(ObjectAnimator.ofFloat(kVar3, property5, 1.0f), ObjectAnimator.ofFloat(this.f21825q1, property3, 1.0f), ObjectAnimator.ofFloat(this.f21825q1, property4, 1.0f));
                    } else {
                        r92 = 0;
                        i15 = 1;
                    }
                    jh.h hVar3 = this.f21757d5;
                    if (hVar3 != 0) {
                        hVar3.e(r92, r92, i15);
                    }
                    xe xeVar2 = this.I1;
                    ...
                    ofFloat14.setDuration(this.f21771g0 ? 220L : 360L);
                    this.G = 0.0f;
                    I1();
                    ObjectAnimator ofFloat15 = ObjectAnimator.ofFloat(this.E0, property5, 1.0f);
                    ofFloat15.setStartDelay(this.f21835s == 1.0f ? 150L : 450L);
                    ofFloat15.setDuration(200L);
                    this.f21838s2.playTogether(animatorSet13, animatorSet14, ofFloat15, ofFloat14);
                } else {
                    te teVar9 = this.f21740b1;
                    if (teVar9 != null) {
                    ...
                    animatorSet15.playTogether(ObjectAnimator.ofFloat(this.Q0, this.Y3, 1.0f), ObjectAnimator.ofFloat(this.Q0, this.f21736a4, this.A0 ? 0.5f : 1.0f), ObjectAnimator.ofFloat(this.f21795k1, property4, 0.0f), ObjectAnimator.ofFloat(this.f21795k1, property3, 0.0f));
                    qg qgVar7 = this.N1;
                    if (qgVar7 != null) {
                        animatorSet15.playTogether(ObjectAnimator.ofFloat(qgVar7, property5, 0.0f));
                        this.N1.a();
                    }
                    ei.c0 c0Var10 = this.f21800l0;
                    if (c0Var10 != null) {
                        animatorSet15.playTogether(ObjectAnimator.ofFloat(c0Var10, property4, 1.0f), ObjectAnimator.ofFloat(this.f21800l0, property3, 1.0f), ObjectAnimator.ofFloat(this.f21800l0, property5, 1.0f));
                    }
                    AnimatorSet animatorSet16 = new AnimatorSet();
                    animatorSet16.playTogether(ObjectAnimator.ofFloat(this.Y0, property5, 0.0f), ObjectAnimator.ofFloat(this.Y0, property2, -AndroidUtilities.dp(20.0f)), ObjectAnimator.ofFloat(this.f21790j1, property5, 0.0f), ObjectAnimator.ofFloat(this.f21790j1, property2, -AndroidUtilities.dp(20.0f)));
                    if (i10 != 5) {
                        this.Z0.setScaleX(0.0f);
                        this.Z0.setScaleY(0.0f);
                        hg.k kVar4 = this.f21825q1;
                        if (kVar4 != null && kVar4.getVisibility() == 0) {
                            this.f21825q1.setScaleX(0.5f);
                            this.f21825q1.setScaleY(0.5f);
                        }
                        ze zeVar = this.f21858w1;
                        if (zeVar != null && zeVar.getVisibility() == 0) {
                            this.f21858w1.setScaleX(0.0f);
                            this.f21858w1.setScaleY(0.0f);
                        }
                        ...
                        if (this.f21815o1 != null) {
                            ViewPropertyAnimator viewPropertyAnimator4 = this.f21820p1;
                            if (viewPropertyAnimator4 != null) {
                                viewPropertyAnimator4.cancel();
                                this.f21820p1 = null;
                            }
                            i14 = 1;
                            animatorSet15.playTogether(ObjectAnimator.ofFloat(this.f21815o1, this.Z3, 1.0f), ObjectAnimator.ofFloat(this.f21815o1, this.f21743b4, 0.0f));
                            hg.k kVar5 = this.f21825q1;
                            this.f21847u1 = 1.0f;
                            animatorSet15.playTogether(ObjectAnimator.ofFloat(kVar5, property5, 1.0f), ObjectAnimator.ofFloat(this.f21825q1, property3, 1.0f), ObjectAnimator.ofFloat(this.f21825q1, property4, 1.0f));
                        } else {
                            i14 = 1;
                        }
                        jh.h hVar4 = this.f21757d5;
                        if (hVar4 != null) {
                            hVar4.e(0, false, i14);
                        }
                        ze zeVar2 = this.f21858w1;
                        ...
                        if (this.f21815o1 != null) {
                            ViewPropertyAnimator viewPropertyAnimator5 = this.f21820p1;
                            if (viewPropertyAnimator5 != null) {
                                viewPropertyAnimator5.cancel();
                                this.f21820p1 = null;
                            }
                            i13 = 1;
                            animatorSet17.playTogether(ObjectAnimator.ofFloat(this.f21815o1, this.f21743b4, 0.0f), ObjectAnimator.ofFloat(this.f21815o1, this.Z3, 1.0f));
                            hg.k kVar6 = this.f21825q1;
                            this.f21847u1 = 1.0f;
                            animatorSet17.playTogether(ObjectAnimator.ofFloat(kVar6, property5, 1.0f), ObjectAnimator.ofFloat(this.f21825q1, property3, 1.0f), ObjectAnimator.ofFloat(this.f21825q1, property4, 1.0f));
                        } else {
                            i13 = 1;
                        }
                        jh.h hVar5 = this.f21757d5;
                        if (hVar5 != null) {
                            hVar5.e(0, false, i13);
                        }
                        xe xeVar4 = this.I1;
                        ...
                        AnimatorSet animatorSet18 = this.f21838s2;
                    ...
                    ofFloat23.setStartDelay(this.f21835s == 1.0f ? 300L : 700L);
                    ofFloat23.setDuration(200L);
                    this.f21838s2.playTogether(animatorSet15, animatorSet16, ofFloat23, ObjectAnimator.ofFloat(this, "lockAnimatedTranslation", this.f21792j4).setDuration(200L));
                    if (i10 != 5) {
                        ...
                        this.f21838s2.playTogether(ofFloat24);
                    } else {
                        ChatActivityEnterView.this.f21828q4 = true;
                        ...
                        this.f21838s2.playTogether(duration);
                    }
                    sg sgVar2 = this.f21795k1;
                    if (sgVar2 != null) {
                        sgVar2.e = true;
                        xi0 xi0Var = sgVar2.f27853f;
                        xi0Var.S(0.0f, true);
                        if (sgVar2.d) {
                            xi0Var.start();
                        }
            ...
            this.f21838s2.addListener(new wf(this, i10));
            this.f21838s2.start();
            vg vgVar3 = this.Y0;
            if (vgVar3 != null) {
                vgVar3.b();
    ...
    public final void L() {
        ...
        if (this.U0 != null) {
            ...
            int dp = ((((this.f21810n1 - AndroidUtilities.statusBarHeight) - AndroidUtilities.navigationBarHeight) - AndroidUtilities.dp(6.0f)) - org.telegram.ui.ActionBar.k.getCurrentActionBarHeight()) - getHeight();
            if (this.Q1 == 2) {
            ...
            if (i11 != dp) {
                ...
                this.C3 = dp;
                org.telegram.ui.Cells.c1 c1Var = this.f21839s3;
                if (i11 > dp) {
                    ...
                    if (this.v) {
                        ...
                        animatorSet2.setInterpolator(qr.f27423f);
                    ...
                    animatorSet3.setInterpolator(qr.f27423f);
                    animatorSet3.addListener(new we(this, 11));
                    this.A3 = animatorSet3;
                    this.U0.setLayerType(2, null);
                    animatorSet3.start();
                }
                ph.f fVar = this.f21751c5;
                if (fVar != null) {
                    ((ph.i) fVar).g(dp);
                }
            }
    ...
    public final void L1() {
        int i02 = i0(org.telegram.ui.ActionBar.i6.f18953jf);
        int i03 = i0(org.telegram.ui.ActionBar.i6.Sd);
        int i04 = i0(org.telegram.ui.ActionBar.i6.f18845df);
        aj0 aj0Var = this.f21772g1;
        if (aj0Var != null) {
            aj0Var.h(i02, "Cup Red");
            this.f21772g1.h(i02, "Box Red");
            this.f21772g1.h(i04, "Cup Grey");
            this.f21772g1.h(i04, "Box Grey");
            this.f21772g1.h(i03, "Line 1");
            this.f21772g1.h(i03, "Line 2");
            this.f21772g1.h(i03, "Line 3");
        }
    }

    public final void M() {
        this.f21793j5 = y(true);
        float y3 = y(false);
        if (this.f21788i5 != y3) {
            this.f21788i5 = y3;
            A0(y3);
    ...
    public final void N() {
        ...
        int i11;
        int i12;
        float f7 = this.f21770f5.e;
        if (this.F1 != null) {
            float measuredHeight = getMeasuredHeight() - this.f21763e5.e;
            View view = this.F1;
    ...
    public final void N1(boolean z10) {
        ...
        if (isChatDialog) {
            TLRPC.Chat chat = this.R.getMessagesController().getChat(Long.valueOf(-this.P2));
            this.f21767f2 = MessagesController.getNotificationsSettings(this.Q).getBoolean("silent_" + this.P2, false);
            ...
            this.f21773g2 = z11;
            if (imageView != null) {
                if (this.f21758e0 == null) {
                    this.f21758e0 = new nr(getContext(), R.drawable.input_notify_on, org.telegram.ui.ActionBar.i6.Wk);
                }
                this.f21758e0.a(this.f21767f2, false);
                imageView.setImageDrawable(this.f21758e0);
            } else {
                z11 = false;
            }
            org.telegram.ui.xd xdVar = this.f21815o1;
    ...
    public final void O() {
        org.telegram.ui.bo boVar = this.O2;
        if (boVar != null) {
            MediaDataController.getInstance(this.Q).saveDraft(boVar.a(), boVar.B7(boVar.f32403n5), "", null, null, null, null, 0L, false, true, null);
        }
    ...
    public final void Q() {
        ...
        this.T1.setColorFilter(new PorterDuffColorFilter(i0(org.telegram.ui.ActionBar.i6.Wk), PorterDuff.Mode.MULTIPLY));
        this.T1.a(R.drawable.input_bot2, false);
        this.f21858w1.setScaleType(ImageView.ScaleType.CENTER);
        this.f21858w1.setBackground(org.telegram.ui.ActionBar.i6.f0(i0(org.telegram.ui.ActionBar.i6.f18926i6), 1, -1));
        this.f21858w1.setVisibility(8);
        AndroidUtilities.updateViewVisibilityAnimated(this.f21858w1, false, 0.1f, false);
        this.f21815o1.addView(this.f21858w1, 0, w7.x5.n(44, 44));
        this.f21858w1.setOnClickListener(new sd(this, 15));
    }

    public final void Q0(TL_iv.RichMessage richMessage) {
        org.telegram.ui.bo boVar = this.O2;
        if (boVar != null) {
            MediaDataController.getInstance(this.Q).saveDraft(boVar.a(), boVar.B7(boVar.f32403n5), "", null, null, null, null, 0L, false, false, richMessage);
        }
    ...
    public final void Q1(boolean z10, boolean z11) {
        ...
        if (this.Y2 != null) {
            ...
            org.telegram.ui.bo boVar = this.O2;
            boolean z13 = true;
            if (!z10 && peer2 != null && ((this.Y2.J() == null || this.Y2.J().peers.size() > 1) && !r0() && !w0() && (((ieVar = this.f21759e1) == null || ieVar.getVisibility() != 0) && ((this.f21799k5 || ((!ChatObject.isChannelAndNotMegaGroup(chat) || ChatObject.canSendAsPeers(chat)) && !ChatObject.isMonoForum(chat))) && (boVar == null || boVar.R3 != 9))))) {
                z12 = true;
            } else {
                z12 = false;
            }
            ...
            if (peer2 != null) {
                if (peer2.channel_id != 0) {
                    ...
                    if (chat3 != null && (wo0Var2 = this.f21819p0) != null) {
                        wo0Var2.setAvatar(chat3);
                        this.f21819p0.setContentDescription(LocaleController.formatString(R.string.AccDescrSendAs, chat3.title));
                    }
                } else {
                    TLRPC.User user = MessagesController.getInstance(this.Q).getUser(Long.valueOf(peer2.user_id));
                    if (user != null && (wo0Var = this.f21819p0) != null) {
                        wo0Var.setAvatar(user);
                        this.f21819p0.setContentDescription(LocaleController.formatString(R.string.AccDescrSendAs, ContactsController.formatName(user.first_name, user.last_name)));
                    }
                }
            }
            wo0 wo0Var3 = this.f21819p0;
            ...
            if (wo0Var4 != null) {
                ...
                if (z12) {
                    ...
                    f10 = ((-this.f21819p0.getLayoutParams().width) - marginLayoutParams.leftMargin) - dp;
                }
            } else {
                f10 = 0.0f;
                f11 = 0.0f;
            ...
            if (z13 != z12) {
                ...
                if (valueAnimator != null) {
                    ...
                    this.f21819p0.setTag(null);
                }
                if ((!this.f21799k5 && (boVar == null || boVar.F8() != 0 || !boVar.O5)) || !z11) {
                    float f14 = f10;
                    float f15 = f12;
                    boolean z14 = z12;
                    if (z14) {
                    ...
                    if (wo0Var6 != null) {
                        ...
                        this.f21819p0.setTranslationX(f14);
                    }
                    if (z14) {
                        f13 = f14;
                    }
    ...
    public final void R() {
        if (this.f21800l0 == null) {
            ei.c0 c0Var = new ei.c0(getContext());
            this.f21800l0 = c0Var;
            c0Var.setOnClickListener(new sd(this, 7));
            this.f21864x1.addView(this.f21800l0, w7.x5.d(-2, 32.0f, 83, 8.0f, 6.0f, 8.0f, 6.0f));
            AndroidUtilities.updateViewVisibilityAnimated(this.f21800l0, false, 1.0f, false);
            ei.c0 c0Var2 = this.f21800l0;
            if (!c0Var2.f8266f) {
                c0Var2.f8266f = true;
                c0Var2.h = 1.0f;
    ...
    public final void R1() {
        ...
        boolean z10 = true;
        if (this.f21845t4 != starsPrice) {
            View sendButtonInternal = getSendButtonInternal();
            this.f21845t4 = starsPrice;
        ...
        if (this.f21799k5) {
            ...
            if (this.f21746c0 != b10) {
                this.f21746c0 = b10;
                if (b10 > 0) {
                    int i12 = b10 - this.f21752d0;
                    if (this.f21799k5) {
                        i10 = 5;
                    } else {
                        i10 = 100;
                    ...
                    if (i12 <= i10) {
                        ...
                        if (this.f21739b0.getVisibility() != 0) {
                            this.f21739b0.setVisibility(0);
                            this.f21739b0.setAlpha(0.0f);
                            this.f21739b0.setScaleX(0.5f);
                            this.f21739b0.setScaleY(0.5f);
                        }
                        this.f21739b0.animate().setListener(null).cancel();
                        this.f21739b0.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setDuration(100L).start();
                        NumberTextView numberTextView2 = this.f21739b0;
                        if (i12 < 0) {
                ...
                NumberTextView numberTextView3 = this.f21739b0;
    ...
    public final void S() {
        ...
        this.f21739b0 = numberTextView;
        numberTextView.setVisibility(8);
        this.f21739b0.setTextSize(15);
        this.f21739b0.setTextColor(i0(org.telegram.ui.ActionBar.i6.f19218y6));
        this.f21739b0.setTypeface(AndroidUtilities.bold());
        this.f21739b0.setCenterAlign(true);
        addView(this.f21739b0, Math.min(2, getChildCount()), w7.x5.d(44, 20.0f, 85, 3.0f, 0.0f, 0.0f, 44.0f));
    }
    ...
    public final void S1() {
        ...
        this.H0 = null;
        TLRPC.ChatFull chatFull = this.f21748c2;
        int i11 = 2147483646;
        if (chatFull != null && chatFull.slowmode_seconds != 0 && chatFull.slowmode_next_send_date <= currentTime && ((isUploadingMessageIdDialog = SendMessagesHelper.getInstance(this.Q).isUploadingMessageIdDialog(this.P2)) || SendMessagesHelper.getInstance(this.Q).isSendingMessageIdDialog(this.P2))) {
            if (!ChatObject.hasAdminRights(this.R.getMessagesController().getChat(Long.valueOf(this.f21748c2.f18113id))) && !ChatObject.isIgnoredChatRestrictionsForBoosters(this.f21748c2)) {
                i10 = this.f21748c2.slowmode_seconds;
            ...
            int i12 = this.G0;
            if (i12 >= 2147483646) {
                if (this.f21748c2 != null) {
                    this.R.getMessagesController().loadFullChat(this.f21748c2.f18113id, 0, true);
                }
                i10 = 0;
            } else {
                i10 = i12 - currentTime;
        ...
        if (this.G0 != 0 && i10 > 0) {
            ...
            ug ugVar = this.F0;
            ugVar.f28394a.l(formatDurationNoHours, false);
            ugVar.invalidate();
            mg mgVar = this.Y2;
            if (mgVar != null) {
                mgVar.t1(ugVar, ugVar.f28394a.getText(), false);
            }
    ...
    public final void T(boolean z10) {
        ...
        this.f21870y1.addView(this.E1, w7.x5.e(44, 44, 85));
    }
    ...
    public final void U() {
        boolean z10;
        cg cgVar = this.U0;
        if (cgVar != null && cgVar.f25703c1 != UserConfig.selectedAccount) {
            this.f21804m1.removeView(cgVar);
            this.U0 = null;
        }
        if (this.U0 != null) {
            return;
        ...
        cg cgVar4 = this.U0;
        if (cgVar4 != null) {
            cgVar4.L(-this.P2, !this.f21873z0, !this.f21738b);
        }
        u();
        F();
    }
    ...
    public final void V() {
        ...
        this.S0.setBackground(org.telegram.ui.ActionBar.i6.f0(i0(org.telegram.ui.ActionBar.i6.f18926i6), 1, -1));
        this.f21874z1.addView(this.S0, w7.x5.e(44, 44, 85));
    ...
    public final void W() {
        ...
        org.telegram.ui.bo boVar = this.O2;
        if (boVar != null && boVar.getParentLayout() != null && ((ActionBarLayout) boVar.getParentLayout()).f18381b) {
        ...
        this.E0.setLinkTextColor(i0(org.telegram.ui.ActionBar.i6.f18913hc));
        this.E0.setHighlightColor(i0(org.telegram.ui.ActionBar.i6.f19157uf));
        of ofVar3 = this.E0;
        ...
        this.E0.setHandlesColor(i0(org.telegram.ui.ActionBar.i6.f19174vf));
        of ofVar4 = this.E0;
        boolean z11 = this.W3;
        if (z11) {
            f7 = 50.0f;
    ...
    public final void W0(a0.i iVar, boolean z10) {
        ...
        if (iVar.m() == 1 && ((TL_bots.BotInfo) iVar.n(0)).user_id == this.P2) {
            ...
            if (botMenuButton instanceof TL_bots.TL_botMenuButton) {
                ...
                this.f21783i0 = tL_botMenuButton.text;
                this.f21789j0 = tL_botMenuButton.url;
                this.f21803l5 = 3;
    ...
    public final void X() {
        ...
        this.f21759e1.setFocusable(true);
        this.f21759e1.setFocusableInTouchMode(true);
        this.f21759e1.setClickable(true);
        this.f21864x1.addView(this.f21759e1, w7.x5.e(-1, 44, 80));
        ?? imageView = new ImageView(getContext());
        this.f21772g1 = imageView;
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        this.f21772g1.f(R.raw.chat_audio_record_delete_2, 28, 28, null);
        this.f21772g1.getAnimatedDrawable().f29964p0 = true;
        L1();
        this.f21772g1.setContentDescription(LocaleController.getString("Delete", R.string.Delete));
        this.f21772g1.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.f0(i0(org.telegram.ui.ActionBar.i6.f18926i6), 1, -1));
        this.f21759e1.addView(this.f21772g1, w7.x5.c(44.0f, 44));
        this.f21772g1.setOnClickListener(new sd(this, 6));
        v71 v71Var = new v71(getContext());
        this.f21766f1 = v71Var;
        v71Var.setVisibility(4);
        v71 v71Var2 = this.f21766f1;
        v71Var2.S = !this.f21867x4;
        v71Var2.setRoundFrames(true);
        this.f21766f1.setDelegate(new bf(this));
        this.f21759e1.addView(this.f21766f1, w7.x5.d(-1, -1.0f, 19, 56.0f, 0.0f, 8.0f, 0.0f));
        Context context = getContext();
        ...
        view.f28063b = context.getDrawable(R.drawable.tooltip_arrow);
        view.f28062a = org.telegram.ui.ActionBar.i6.b0(AndroidUtilities.dp(5.0f), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19082qf, false));
        view.b();
        view.setTime(0);
        this.f21766f1.setTimeHintView(view);
        this.l1.addView((View) view, w7.x5.d(-1, -2.0f, 80, 0.0f, 0.0f, 0.0f, 52.0f));
        gk0 gk0Var = new gk0(getContext(), this.V3);
        this.f21778h1 = gk0Var;
        this.f21759e1.addView(gk0Var, w7.x5.d(-1, 32.0f, 19, 44.0f, 0.0f, 4.0f, 0.0f));
        G1(this.O4);
    }

    public final void X0(int i10, boolean z10, boolean z11) {
        this.f21811n2 = i10;
        if (this.f21816o2 == z10) {
            return;
        }
        this.f21816o2 = z10;
        A1(z11);
    ...
    public final void Z() {
        if (this.f21753d1 == null && getContext() != null) {
            ai.x5 x5Var = new ai.x5(getContext(), 14);
            this.f21753d1 = x5Var;
            x5Var.setClipChildren(false);
            this.f21753d1.setVisibility(8);
            this.f21864x1.addView(this.f21753d1, w7.x5.c(44.0f, -1));
            this.f21753d1.setOnTouchListener(new bi.d(12));
            ai.x5 x5Var2 = this.f21753d1;
            SlideTextView slideTextView = new SlideTextView(getContext());
            this.f21790j1 = slideTextView;
            ...
            this.f21753d1.addView(this.d, w7.x5.e(-1, -1, 16));
        }
    }
    ...
    public final void Z0(MessageObject messageObject, String str, boolean z10, boolean z11) {
        ...
        if (str != null && getVisibility() == 0 && (ofVar = this.E0) != null) {
            ...
            if (z10) {
                ...
                if ((this.f21811n2 != 1 || z11) && user3 != null && user3.bot && !str.contains("@")) {
                ...
                if (!this.f21871y2 && this.f21760e2 == -1) {
                    H0();
                }
            } else if (this.G0 > 0 && !c()) {
                mg mgVar2 = this.Y2;
                if (mgVar2 != null) {
                    ug ugVar = this.F0;
                    mgVar2.t1(ugVar, ugVar.f28394a.getText(), true);
                }
            } else {
                if (messageObject != null && DialogObject.isChatDialog(this.P2)) {
                ...
                if ((this.f21811n2 != 1 || z11) && user != null && user.bot && !str.contains("@")) {
    ...
    public final void a0() {
        if (this.I1 == null && this.O2 != null) {
            ...
            mutate2.setColorFilter(new PorterDuffColorFilter(i0(org.telegram.ui.ActionBar.i6.f18953jf), mode));
            ...
            this.I1.setBackground(org.telegram.ui.ActionBar.i6.f0(i0(org.telegram.ui.ActionBar.i6.f18926i6), 1, -1));
            this.f21864x1.addView(this.I1, 2, w7.x5.e(44, 44, 85));
    ...
    public final void a1(int i10, long j3) {
        ...
        this.f21873z0 = true;
        if (DialogObject.isChatDialog(this.P2)) {
            this.f21873z0 = ChatObject.canSendPlain(this.R.getMessagesController().getChat(Long.valueOf(-this.P2)));
        }
        N1(false);
        H1(false);
        J();
    ...
    public final void b0() {
        if (this.f21819p0 == null && getContext() != null) {
            ?? view = new View(getContext());
            ImageReceiver imageReceiver = new ImageReceiver(view);
            view.f29761a = imageReceiver;
            view.f29762b = new f9((org.telegram.ui.ActionBar.e6) null);
            Paint paint = new Paint(1);
            view.d = paint;
            Paint paint2 = new Paint(1);
            view.e = paint2;
            ...
            paint.setColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18826cf, false));
            paint2.setColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18807bf, false));
            int dp = AndroidUtilities.dp(18.0f);
            int l1 = org.telegram.ui.ActionBar.i6.l1(0.2f, org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18836d6, false));
            ...
            this.f21819p0.setVisibility(8);
            this.f21864x1.addView(this.f21819p0, w7.x5.d(36, 36.0f, 83, 4.66f, 4.0f, 4.66f, 4.0f));
        }
    }
    ...
    public final boolean c0(TL_keyboard.KeyboardButtonProto keyboardButtonProto, MessageObject messageObject, MessageObject messageObject2, org.telegram.ui.zi ziVar) {
        ...
        if (keyboardButtonProto != null && messageObject2 != null && ((boVar = this.O2) == null || boVar.R3 != 5)) {
            ...
            if (tL_inlineButtonTypeUrl != null) {
                ...
                if (g4Var != null) {
                    g4Var.S0 = false;
                    g4Var.f28808x1.setVisibility(8);
                    g4Var.S1(false, bool);
                    return false;
                }
                ...
                if (tL_inlineButtonTypeSwitchInline != null) {
                    ...
                    if (requestPeerType != null && messageObject2.messageOwner != null) {
                        if (requestPeerType instanceof TLRPC.TL_requestPeerTypeCreateBot) {
                            ...
                            org.telegram.ui.rj0 rj0Var = org.telegram.ui.rj0.f37125u0;
                            org.telegram.ui.ActionBar.n2 R = LaunchActivity.R();
                            if (R == null || org.telegram.ui.rj0.f37125u0 != null) {
                                return false;
                            }
                            org.telegram.ui.rj0 rj0Var2 = new org.telegram.ui.rj0(R, i10, bool2, bool3, feVar);
                            rj0Var2.show();
                            org.telegram.ui.rj0.f37125u0 = rj0Var2;
                            return false;
                        } else {
    ...
    public final void c1(boolean z10, boolean z11) {
        ...
        le leVar = this.Q0;
        if (leVar != null) {
            if (this.f21853v2 == 1 || ((ieVar = this.f21759e1) != null && ieVar.getVisibility() == 0)) {
                this.h = 0.0f;
                this.f21808n = 0.0f;
                E1();
                z11 = false;
            }
            xg xgVar2 = xg.f29930f;
            xg xgVar3 = xg.e;
            if (z10 && this.f21760e2 == 0) {
                if (this.f21873z0) {
                    xgVar = xg.d;
                } else {
                    return;
            ...
            if (!this.f21873z0 && xgVar == xgVar3) {
                xgVar3 = xgVar2;
            } else if (this.f21738b || xgVar == xgVar3) {
                xgVar3 = xgVar;
            }
            leVar.j(xgVar3, z11);
    ...
    public final void d0() {
        ...
        if (messageObject != null) {
            ...
            if (needResendWhenEdit && !ChatObject.canManageMonoForum(this.Q, this.Y1.getDialogId())) {
                if (boVar == null || (of3 = boVar.f32317g5) == null) {
            ...
            if (this.f21746c0 - this.f21752d0 < 0) {
                NumberTextView numberTextView = this.f21739b0;
                ...
                if (!MessagesController.getInstance(this.Q).premiumFeaturesBlocked() && MessagesController.getInstance(this.Q).captionLengthLimitPremium > this.f21752d0) {
                    p1();
                    return;
                }
                return;
            ...
            if (!TextUtils.equals(charSequenceArr[0], this.Y1.messageText) || ((entities != null && !entities.isEmpty()) || !this.Y1.messageOwner.entities.isEmpty() || (this.Y1.messageOwner.media instanceof TLRPC.TL_messageMediaWebPage))) {
                ...
                if (boVar != null && (chat = boVar.e) != null && (((i10 = messageObject3.type) == 0 || i10 == 19) && !ChatObject.canSendEmbed(chat))) {
                    ...
                    message.flags &= -513;
                    message.media = null;
                } else if (boVar != null && (messagePreviewParams = boVar.f32305f5) != null) {
                    if (boVar.G5 instanceof TLRPC.TL_webPagePending) {
                        ...
                        this.Y1.messageOwner.media.webpage = boVar.f32305f5.webpage;
                    } else {
                ...
                if (this.Y1.needResendWhenEdit()) {
                    ...
                    if (boVar == null || (of2 = boVar.f32317g5) == null) {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.emojiLoaded) {
            ...
            zf zfVar = this.G1;
            if (zfVar != null) {
                ArrayList arrayList = zfVar.f8526n;
            ...
            if (((Integer) objArr[0]).intValue() == this.F2) {
                if (this.f21853v2 != 0 && !this.f21802l3 && !c()) {
                    this.f21802l3 = true;
            ...
            if (i10 != NotificationCenter.recordStartError && i10 != NotificationCenter.recordStopped) {
                ...
                if (i10 == NotificationCenter.recordPaused) {
                    ...
                    if (((Integer) objArr[0]).intValue() == this.F2) {
                        ...
                        if (obj instanceof VideoEditedInfo) {
                            ...
                            this.f21755d3 = videoEditedInfo;
                            String str = (String) objArr[2];
                            this.f21742b3 = str;
                            ArrayList<Bitmap> arrayList2 = (ArrayList) objArr[3];
                            this.f21784i1 = videoEditedInfo.estimatedDuration;
                            v71 v71Var = this.f21766f1;
                            if (v71Var != null) {
                                v71Var.setVideoPath(str);
                                this.f21766f1.setKeyframes(arrayList2);
                                this.f21766f1.setVisibility(0);
                                this.f21766f1.setMinProgressDiff(1000.0f / ((float) this.f21755d3.estimatedDuration));
                                x0();
                            }
                            K1(3, true);
                            K(false);
                        ...
                        this.f21735a3 = (TLRPC.TL_document) obj;
                        this.f21742b3 = (String) objArr[2];
                        ...
                        if (this.f21735a3 != null) {
                            ...
                            if (this.f21759e1 != null) {
                                ...
                                tL_message.message = "";
                                tL_message.attachPath = this.f21742b3;
                                TLRPC.TL_messageMediaDocument tL_messageMediaDocument = new TLRPC.TL_messageMediaDocument();
                                tL_message.media = tL_messageMediaDocument;
                                tL_messageMediaDocument.flags |= 3;
                                tL_messageMediaDocument.document = this.f21735a3;
                                tL_message.flags |= 768;
                                this.f21749c3 = new MessageObject(UserConfig.selectedAccount, tL_message, false, true);
                                this.f21759e1.setAlpha(1.0f);
                                this.f21759e1.setVisibility(0);
                                this.f21772g1.setVisibility(0);
                                this.f21772g1.setAlpha(0.0f);
                                this.f21772g1.setScaleY(0.0f);
                                this.f21772g1.setScaleX(0.0f);
                                int i15 = 0;
                                while (true) {
                                    if (i15 < this.f21735a3.attributes.size()) {
                                        TLRPC.DocumentAttribute documentAttribute = this.f21735a3.attributes.get(i15);
                                ...
                                int i16 = 0;
                                while (true) {
                                    if (i16 >= this.f21735a3.attributes.size()) {
                                        break;
                                    }
                                    TLRPC.DocumentAttribute documentAttribute2 = this.f21735a3.attributes.get(i16);
                                    if (documentAttribute2 instanceof TLRPC.TL_documentAttributeAudio) {
                                        byte[] bArr2 = documentAttribute2.waveform;
                                        if (bArr2 == null || bArr2.length == 0) {
                                            documentAttribute2.waveform = MediaController.getWaveform(this.f21742b3);
                                        }
                                ...
                                if (z10 && (kVar = this.f21825q1) != null) {
                                    this.f21847u1 = 0.0f;
                                    kVar.setAlpha(0.0f);
                                    kVar.setScaleX(0.0f);
                                    kVar.setScaleY(0.0f);
                                }
                                this.f21784i1 = (long) (1000.0d * d);
                                gk0 gk0Var = this.f21778h1;
                                String str2 = this.f21742b3;
                                if (!gk0Var.Q) {
                                    gk0Var.f24383r = (float) d;
                                    gk0Var.f24384s = f7;
                                    gk0Var.v = f10;
                                    gk0Var.f24385w = false;
                                    gk0Var.h.q(AndroidUtilities.formatDuration((int) Math.round(Math.max(1.0d, d)), false), false, true);
                                    gk0Var.f24381f.a(false, false);
                                    if (gk0Var.f24382n == null) {
                                        g71 g71Var = new g71();
                                        gk0Var.f24382n = g71Var;
                                        g71Var.J = new k2.u(gk0Var, 14);
                                    }
                                    gk0Var.f24382n.D(Uri.fromFile(new File(str2)), "other");
                                    gk0Var.K = 0;
                                    gk0Var.L = bArr;
                                    gk0Var.invalidate();
                                }
                                ...
                                if (z10) {
                                    ...
                                    this.f21853v2 = 1;
                                    this.M1.c(false);
                                    this.f21849u3.set(this.M1, Float.valueOf(1.0f));
                                    qg qgVar = this.N1;
                                    if (qgVar != null) {
                    ...
                    if (this.f21749c3 != null && MediaController.getInstance().isPlayingMessage(this.f21749c3)) {
                        MessageObject playingMessageObject = MediaController.getInstance().getPlayingMessageObject();
                        MessageObject messageObject = this.f21749c3;
                    ...
                    if (!((Boolean) objArr[6]).booleanValue()) {
                        ...
                        if (longValue == this.P2 && (chatFull = this.f21748c2) != null && chatFull.slowmode_seconds != 0 && !MessageObject.isEphemeralMessageId(num2.intValue()) && (chat = this.R.getMessagesController().getChat(Long.valueOf(this.f21748c2.f18113id))) != null && !ChatObject.hasAdminRights(chat) && !ChatObject.isIgnoredChatRestrictionsForBoosters(chat)) {
                            TLRPC.ChatFull chatFull2 = this.f21748c2;
                            int currentTime = ConnectionsManager.getInstance(this.Q).getCurrentTime();
                            TLRPC.ChatFull chatFull3 = this.f21748c2;
                ...
                if (i10 == NotificationCenter.recordStopped) {
                    ...
                    if (num3.intValue() == 4) {
                        i14 = 4;
                    } else if (this.f21747c1 && num3.intValue() == 5) {
                        i14 = 1;
    ...
    public final void e() {
        ...
        vg vgVar = this.Y0;
        if (vgVar != null && (textPaint = vgVar.f28716x) != null) {
            textPaint.setColor(vgVar.F.i0(org.telegram.ui.ActionBar.i6.f19027nf));
        }
        v71 v71Var = this.f21766f1;
        if (v71Var != null) {
            v71Var.e.setColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18780a7, false));
            v71Var.L = 0;
            t71 t71Var = v71Var.P;
            if (t71Var != null) {
                t71Var.b();
        ...
        if (numberTextView != null && this.E0 != null) {
            if (this.f21752d0 - this.f21746c0 < 0) {
                numberTextView.setTextColor(i0(org.telegram.ui.ActionBar.i6.f19056p7));
            } else {
                numberTextView.setTextColor(i0(org.telegram.ui.ActionBar.i6.f19218y6));
            }
        }
        Color.alpha(i0(org.telegram.ui.ActionBar.i6.f18807bf));
        lf lfVar = this.m0;
        if (lfVar != null) {
            lfVar.d.setColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.Ii, false));
            ch.d dVar = lfVar.f8738r;
            if (dVar != null) {
                dVar.v();
            }
            lfVar.invalidate();
        ...
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.f21740b1.setColorFilter(new PorterDuffColorFilter(i10, mode));
        int i11 = org.telegram.ui.ActionBar.i6.Wk;
        ...
        leVar.setBackground(org.telegram.ui.ActionBar.i6.f0(i0(i12), 1, -1));
        ...
        imageView.setBackground(org.telegram.ui.ActionBar.i6.W(AndroidUtilities.dp(19.0f), i02, dp, dp2, dp, dp2));
        this.A1.setColorFilter(i0(org.telegram.ui.ActionBar.i6.hl), mode);
    }
    ...
    public final void e0(Canvas canvas, boolean z10) {
        ...
        int z11 = (int) com.google.android.gms.internal.vision.e2.z(1.0f, this.B4, org.telegram.ui.ActionBar.i6.f18923i3.getIntrinsicHeight(), this.S1);
        View view = this.F1;
        if (view != null && view.getVisibility() == 0) {
            z11 = (int) (((1.0f - getTopViewEnterProgress()) * this.F1.getLayoutParams().height) + z11);
        }
        int intrinsicHeight = org.telegram.ui.ActionBar.i6.f18923i3.getIntrinsicHeight() + z11;
        if (z10) {
            org.telegram.ui.ActionBar.i6.f18923i3.setAlpha((int) (this.B4 * 255.0f));
            org.telegram.ui.ActionBar.i6.f18923i3.setBounds(0, z11, getMeasuredWidth(), intrinsicHeight);
    ...
    public final boolean f0(Canvas canvas, Utilities.Callback0Return callback0Return) {
        ...
        float f11;
        float f12;
        float e = this.f21737a5.e(this.E0.canScrollVertically(-1));
        float e7 = this.f21744b5.e(this.E0.canScrollVertically(1));
        if (e <= 0.0f && e7 <= 0.0f) {
    ...
    public final xf g0(MessageObject messageObject, boolean z10) {
        ...
        if (z10) {
            ...
            messageObject2.caption = MessageObject.replaceAnimatedEmoji(Emoji.replaceEmoji((CharSequence) spannableStringBuilder, org.telegram.ui.ActionBar.i6.f19034o2.getFontMetricsInt(), false, (int[]) null), entities, org.telegram.ui.ActionBar.i6.f19034o2.getFontMetricsInt());
        }
    ...
    public void g1(float f7, float f10, float f11, boolean z10) {
        ...
        ieVar.setAlpha(f11);
        ImageView imageView = this.f21852v1;
        if (imageView != null) {
    ...
    public ei.f4 getBotWebViewButton() {
        if (this.f21794k0 == null) {
            Context context = getContext();
            ?? frameLayout = new FrameLayout(context);
            frameLayout.f8331a = new Path();
            frameLayout.f8333c = org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.Oh, false);
            ...
            this.f21794k0 = frameLayout;
            frameLayout.setVisibility(8);
            R();
            this.f21794k0.setBotMenuButton(this.f21800l0);
            this.f21864x1.addView(this.f21794k0, w7.x5.e(-1, -1, 80));
        }
    ...
    public float getSlideToCancelProgress() {
        return this.f21787i4;
    }

    public CharSequence getSlowModeTimer() {
        if (this.G0 > 0) {
            return this.F0.f28394a.getText();
        }
        return null;
    }
    ...
    public final void h1(boolean z10) {
        ...
        this.f21825q1.setVisibility(i10);
        if (z10) {
            AndroidUtilities.removeFromParent(this.H1);
        }
        if (z10) {
            this.f21740b1.setVisibility(8);
        } else {
            P0();
        }
        if (!z10) {
    ...
    public final void k1(MessageObject messageObject, org.telegram.ui.rn rnVar, MessageObject messageObject2) {
        ...
        if (messageObject != null) {
            if (this.V2 == null && (messageObject3 = this.f21801l2) != this.S2) {
                this.V2 = messageObject3;
            }
            this.S2 = messageObject;
            this.U2 = rnVar;
            this.T2 = messageObject2;
            if (boVar == null || !boVar.f32328h4 || boVar.X3 != messageObject) {
                Y0(messageObject, true, true);
            }
        } else if (this.S2 == this.f21801l2) {
            this.S2 = null;
            this.T2 = null;
            this.U2 = null;
    ...
    public final void l1(int i10, boolean z10) {
        ...
        if (z11 != z12) {
            ValueAnimator valueAnimator = this.f21851v0;
            if (valueAnimator != null) {
                valueAnimator.removeAllListeners();
                this.f21851v0.cancel();
            }
            float f7 = 0.0f;
            if (!z10) {
                if (z11) {
                ...
                float f10 = this.f21857w0;
                if (z11) {
                    f7 = 1.0f;
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, f7);
                this.f21851v0 = ofFloat;
                ofFloat.addUpdateListener(new od(this, 4));
                this.f21851v0.addListener(new af(this, z11, 3));
                this.f21851v0.setDuration(220L);
                this.f21851v0.setInterpolator(qr.f27423f);
                this.f21851v0.start();
            }
        }
        this.Q1 = i10;
    ...
    public final void m1(boolean z10, boolean z11, boolean z12, boolean z13) {
        ...
        if ((p1Var == null || !p1Var.f19484f) && !this.f21797k3 && this.U0 != null) {
            if (z12 || this.y3 != z10) {
                this.y3 = z10;
                mg mgVar = this.Y2;
                if (mgVar != null) {
                    ...
                    if (z11) {
                        ...
                        if (this.f21751c5 == null) {
                            ((ObjectAnimator) animatorSet2.getChildAnimations().get(0)).addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                                public final ChatActivityEnterView f29705b;
                                ...
                                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                    int i11 = r3;
                                    int i12 = i10;
                                    ChatActivityEnterView chatActivityEnterView = this.f29705b;
                                    switch (i11) {
                                        case 0:
                                            int i13 = ChatActivityEnterView.f21731m5;
    ...
    public final void n(TLRPC.Document document) {
        ...
        if (cgVar != null && document != null) {
            boolean isEmpty = cgVar.f25722i1.isEmpty();
            cgVar.X();
            if (isEmpty) {
                cgVar.Y(false);
            }
    ...
    public final boolean n0(boolean z10, boolean z11, boolean z12) {
        ...
        TLRPC.TL_replyKeyboardMarkup tL_replyKeyboardMarkup;
        if (t0()) {
            if (this.f21760e2 == 1 && (tL_replyKeyboardMarkup = this.f21805m2) != null && z10 && this.f21801l2 != null) {
                if (!tL_replyKeyboardMarkup.is_persistent) {
                    SharedPreferences.Editor edit = MessagesController.getMainSettings(this.Q).edit();
                    edit.putInt("closed_botkeyboard_" + getTopicKeyString(), this.f21801l2.getId()).apply();
                }
            }
    ...
    public final void n1(boolean z10, boolean z11) {
        ...
        if (this.f21850u4 != z10 || !z11) {
            ...
            if (imageView == null) {
                if (z10 || this.f21799k5) {
                    if (imageView == null) {
                        ...
                        this.f21852v1 = imageView2;
                        imageView2.setScaleType(ImageView.ScaleType.CENTER);
                        this.f21852v1.setColorFilter(new PorterDuffColorFilter(i0(org.telegram.ui.ActionBar.i6.Wk), PorterDuff.Mode.MULTIPLY));
                        this.f21852v1.setImageResource(R.drawable.input_suggest_paid_24);
                        this.f21852v1.setBackground(org.telegram.ui.ActionBar.i6.f0(i0(org.telegram.ui.ActionBar.i6.f18926i6), 1, -1));
                        if (this.f21799k5) {
                            this.f21852v1.setTranslationX(AndroidUtilities.dp(42.0f));
                            this.f21870y1.addView(this.f21852v1, w7.x5.d(44, 44.0f, 85, 0.0f, 0.0f, 50.0f, 0.0f));
                        } else {
                            this.f21815o1.addView(this.f21852v1, 0, w7.x5.n(44, 44));
                        }
                        this.f21852v1.setOnClickListener(new sd(this, 19));
                        this.f21852v1.setContentDescription(LocaleController.getString(R.string.AccDescrAttachButton));
                    }
                } else {
                    return;
                }
            }
            if (this.f21850u4 != z10) {
                z12 = true;
            } else {
                z12 = false;
            }
            ...
            this.f21852v1.setEnabled(z10);
            this.f21852v1.setClickable(z10);
            ValueAnimator valueAnimator = this.f21855v4;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                this.f21855v4 = null;
            }
            if (z11) {
                if (this.f21799k5) {
                    this.f21852v1.setVisibility(0);
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f21852v1.getAlpha(), f10);
                this.f21855v4 = ofFloat;
                ofFloat.addUpdateListener(new od(this, 7));
                this.f21855v4.addListener(new af(this, z10, 0));
                this.f21855v4.setDuration(220L);
                this.f21855v4.setInterpolator(qr.h);
                this.f21855v4.start();
            } else {
                this.f21852v1.setScaleX(f7);
                this.f21852v1.setScaleY(f7);
                this.f21852v1.setAlpha(f10);
                if (this.f21799k5) {
                    ImageView imageView3 = this.f21852v1;
                    if (!z10) {
                        i10 = 8;
                    }
    ...
    public final void o(TLRPC.Document document) {
        U();
        cg cgVar = this.U0;
        int i10 = cgVar.f25703c1;
        MediaDataController.getInstance(i10).addRecentSticker(0, null, document, (int) (System.currentTimeMillis() / 1000), false);
        boolean isEmpty = cgVar.f25725j1.isEmpty();
        cgVar.f25725j1 = MediaDataController.getInstance(i10).getRecentStickers(0, true);
        bz bzVar = cgVar.f25773y0;
        if (bzVar != null) {
            bzVar.l();
        }
        if (isEmpty) {
    ...
    public final void o0(boolean z10) {
        ...
        if (animatorSet2 == null || !animatorSet2.isRunning()) {
            ...
            he heVar = this.f21750c4;
            he heVar2 = this.Y3;
            he heVar3 = this.f21736a4;
            ...
            if (z10) {
                ...
                arrayList.add(ObjectAnimator.ofFloat(this.f21772g1, property3, 0.0f));
                arrayList.add(ObjectAnimator.ofFloat(this.f21772g1, property2, 0.0f));
                arrayList.add(ObjectAnimator.ofFloat(this.f21772g1, property, 0.0f));
                arrayList.add(ObjectAnimator.ofFloat(this.f21759e1, property3, 0.0f));
                if (kVar != null) {
                    ViewPropertyAnimator viewPropertyAnimator = this.f21820p1;
                    if (viewPropertyAnimator != null) {
                        viewPropertyAnimator.cancel();
                ...
                this.f21843t2.playTogether(arrayList);
                ei.c0 c0Var = this.f21800l0;
                if (c0Var != null) {
                    c0Var.setAlpha(0.0f);
                    this.f21800l0.setScaleY(0.0f);
                    this.f21800l0.setScaleX(0.0f);
                    this.f21843t2.playTogether(ObjectAnimator.ofFloat(this.f21800l0, property3, 1.0f), ObjectAnimator.ofFloat(this.f21800l0, property2, 1.0f), ObjectAnimator.ofFloat(this.f21800l0, property, 1.0f));
                }
                this.f21843t2.setDuration(150L);
                this.f21843t2.addListener(new we(this, 1));
            } else {
                aj0 aj0Var = this.f21772g1;
                if (aj0Var != null) {
                    aj0Var.d();
                ...
                boolean z11 = this.f21747c1;
                Property property4 = View.TRANSLATION_X;
                if (z11) {
                    arrayList2.add(ObjectAnimator.ofFloat(this.f21766f1, property3, 0.0f));
                    arrayList2.add(ObjectAnimator.ofFloat(this.f21766f1, property4, -AndroidUtilities.dp(20.0f)));
                    ...
                    of ofVar = this.E0;
                    if (ofVar != null && this.f21835s == 1.0f) {
                        ofVar.setAlpha(1.0f);
                        this.G = 0.0f;
                        I1();
                    } else {
                    ...
                    arrayList2.add(ObjectAnimator.ofFloat(this.f21778h1, property3, 0.0f));
                    arrayList2.add(ObjectAnimator.ofFloat(this.f21778h1, property4, -AndroidUtilities.dp(20.0f)));
                    qg qgVar3 = this.N1;
                    if (qgVar3 != null) {
                ...
                ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(this.f21772g1, property3, 0.0f);
                ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(this.f21772g1, property2, 0.0f);
                ObjectAnimator ofFloat5 = ObjectAnimator.ofFloat(this.f21772g1, property, 0.0f);
                ObjectAnimator ofFloat6 = ObjectAnimator.ofFloat(this.f21772g1, property3, 0.0f);
                if (this.A0) {
                    f7 = 0.5f;
                } else {
                    f7 = 1.0f;
                ...
                if (c0Var2 != null) {
                    ...
                    this.f21800l0.setScaleY(0.0f);
                    this.f21800l0.setScaleX(0.0f);
                    animatorSet5.playTogether(ObjectAnimator.ofFloat(this.f21800l0, property3, 1.0f), ObjectAnimator.ofFloat(this.f21800l0, property2, 1.0f), ObjectAnimator.ofFloat(this.f21800l0, property, 1.0f));
                }
                animatorSet5.setDuration(150L);
                animatorSet5.setStartDelay(600L);
                AnimatorSet animatorSet6 = new AnimatorSet();
                this.f21843t2 = animatorSet6;
                if (animatorSet != null) {
                    animatorSet6.playTogether(animatorSet3, animatorSet, animatorSet5);
                } else {
                    animatorSet6.playTogether(animatorSet3, animatorSet5);
                }
                this.f21843t2.addListener(new rf(this));
            }
            AnimatorSet animatorSet7 = this.f21843t2;
    ...
    public final void o1(boolean z10) {
        ...
        if (this.J4 != z11) {
            ...
            this.J4 = z11;
            ImageView imageView = this.f21837s1;
            imageView.setVisibility(0);
            ...
            if (z11) {
                ...
                if (MessagesController.getGlobalMainSettings().getInt("aihintshown", 0) < 3) {
                    ...
                    ci.f4 f4Var3 = this.M;
                    f4Var3.f4633l0 = new org.telegram.ui.uh(26, this, f4Var2);
                    f4Var3.d = 4000L;
                    f4Var3.u();
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (this.U4 != -1 && (lfVar = this.m0) != null) {
            s4.c0 c0Var = (s4.c0) lfVar.f8735c.getLayoutManager();
            if (c0Var != null) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (c0Var != null && c0Var.getTag() != null) {
            ...
            wo0 wo0Var = this.f21819p0;
            if (wo0Var != null && wo0Var.getVisibility() == 0) {
                int i12 = this.f21819p0.getLayoutParams().width;
                this.f21819p0.measure(View.MeasureSpec.makeMeasureSpec(i12, 1073741824), View.MeasureSpec.makeMeasureSpec(this.f21819p0.getLayoutParams().height, 1073741824));
        ...
        B1();
        super.onMeasure(i10, i11);
        ei.f4 f4Var = this.f21794k0;
        if (f4Var != null) {
            ei.c0 c0Var6 = this.f21800l0;
            if (c0Var6 != null) {
                f4Var.setMeasuredButtonWidth(c0Var6.getMeasuredWidth());
            }
            this.f21794k0.getLayoutParams().height = getMeasuredHeight() - AndroidUtilities.dp(2.0f);
            measureChild(this.f21794k0, i10, i11);
        }
        M();
        N();
        if (measuredHeight > 0 && ieVar.getMeasuredHeight() != measuredHeight) {
            for (int i13 = 0; i13 < 2; i13++) {
                if (i13 == 0) {
                    imageView = this.f21837s1;
                } else {
                    imageView = this.f21842t1;
                }
    ...
    public final ValueAnimator p(float f7) {
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.I1.f29924a, f7);
    ...
    public final void p0() {
        ...
        if (gk0Var != null) {
            ...
            this.f21778h1.setTranslationX(0.0f);
        }
        v71 v71Var2 = this.f21766f1;
        if (v71Var2 != null) {
            v71Var2.setAlpha(1.0f);
            this.f21766f1.setTranslationX(0.0f);
        }
        of ofVar = this.E0;
        if (ofVar != null) {
            ofVar.setAlpha(1.0f);
    ...
    public final void s1(int i10, int i11, boolean z10, boolean z11) {
        ...
        if (i10 != 2) {
            ...
            if (i10 == 1) {
                ...
                if (i11 == 0) {
                    ...
                    if (cgVar2 != null && cgVar2.getVisibility() != 8) {
                        this.f21804m1.removeView(this.U0);
                        this.U0.setVisibility(8);
                        this.U0.setShowing(false);
                        this.W0 = false;
                ...
                if (this.f21859w2 <= 0) {
                    f7 = 200.0f;
                    this.f21859w2 = MessagesController.getGlobalEmojiSettings().getInt("kbd_height", AndroidUtilities.dp(200.0f));
                } else {
                    f7 = 200.0f;
                }
                if (this.f21865x2 <= 0) {
                    this.f21865x2 = MessagesController.getGlobalEmojiSettings().getInt("kbd_height_land3", AndroidUtilities.dp(f7));
                }
                Point point = AndroidUtilities.displaySize;
                if (point.x > point.y) {
                    i15 = this.f21865x2;
                ...
                if (viewGroup != null && this.f21751c5 == null) {
                ...
                if (pv0Var != null) {
                    ...
                    A1(true);
                    G0();
                    if (this.f21779h2 && !this.f21871y2 && i15 != i13 && z10) {
                ...
                if (cgVar3 != null) {
                    if (i10 == 2 && !AndroidUtilities.usingHardwareInput && !AndroidUtilities.isInMultiwindow) {
                        ...
                        this.f21804m1.removeView(this.U0);
                        this.U0 = null;
                    } else if (this.f21779h2 && !this.f21871y2 && !this.y3) {
                        this.W0 = true;
                        this.f21812n3 = 0;
                ...
                if (zfVar4 != null && zfVar4.getVisibility() == 0) {
                    if (i10 != 2 || AndroidUtilities.usingHardwareInput || AndroidUtilities.isInMultiwindow) {
                        if (this.f21779h2 && !this.f21871y2) {
                            if (this.X0) {
                                this.f21812n3 = 1;
                            }
                            AnimatorSet animatorSet3 = new AnimatorSet();
                ...
                if (i11 == 1 && this.f21801l2 != null) {
                    MessagesController.getMainSettings(this.Q).edit().putInt("closed_botkeyboard_" + getTopicKeyString(), this.f21801l2.getId()).apply();
                }
                A1(true);
                ph.f fVar2 = this.f21751c5;
                if (fVar2 != null) {
            ...
            if (this.f21860w3 || this.f21866x3) {
                K(true);
            }
            if (this.y3 && i10 != 1) {
                z12 = false;
    ...
    public void setBotWebViewButtonOffsetX(float f7) {
        ...
        this.f21825q1.setTranslationX(this.f21868y + this.f21862x + f7);
        this.f21740b1.setTranslationX(f7);
        ze zeVar = this.f21858w1;
        if (zeVar != null) {
    ...
    public void setEditingBusinessLink(TL_account.TL_businessChatLink tL_businessChatLink) {
        ...
        if (this.a2 != null) {
            ...
            this.E1.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setDuration(150L).setInterpolator(qr.f27423f).start();
            this.f21746c0 = this.R.getMessagesController().getMaxMessageLength();
            of ofVar = this.E0;
            if (ofVar != null) {
    ...
    public void setFieldFocused(boolean z10) {
        ...
        if (this.E0 != null && !accessibilityManager.isTouchExplorationEnabled()) {
            ...
            if (ofVar != null && ofVar.isFocused()) {
                if (!this.f21871y2 || this.f21785i2) {
                    this.E0.clearFocus();
                }
            }
        }
    ...
    public void setSlideToCancelProgress(float f7) {
        ...
        this.f21840s4 = (int) ((1.0f - this.f21787i4) * (-measuredWidth));
        RecordCircle recordCircle = this.M1;
        if (recordCircle != null) {
            recordCircle.invalidate();
        }
    ...
    public final void u() {
        if (this.U0.getParent() == null) {
            if (this.f21751c5 == null) {
                this.f21804m1.addView(this.U0);
            } else {
                this.f21804m1.addView(this.U0, w7.x5.c(-1.0f, -1));
            }
        }
    }
    ...
    public final void u1(boolean z10) {
        ...
        this.K4 = z11;
        ImageView imageView = this.f21842t1;
        imageView.setVisibility(0);
        ViewPropertyAnimator animate = imageView.animate();
        float f11 = 1.0f;
        if (z11) {
    ...
    public final boolean v0() {
        if (this.E2 && ChatActivityEnterView.this.f21834r4) {
            return true;
        }
        return false;
    }
    ...
    public final boolean w() {
        ig x10 = x();
        if (!TextUtils.equals(x10.f25003a, this.f21741b2.f25003a) || !MediaDataController.entitiesEqual(this.f21741b2.f25004b, x10.f25004b)) {
            return true;
        }
        return false;
    }
    ...
    public final boolean w0() {
        if (!this.E2) {
            AnimatorSet animatorSet = this.f21838s2;
            if (animatorSet == null || !animatorSet.isRunning() || this.f21791j2) {
                return false;
            }
            return true;
        }
    ...
    public final void w1(boolean z10, boolean z11) {
        boolean z12;
        if (this.F1 != null && !this.f21761e3 && getVisibility() == 0) {
            ie ieVar = this.f21759e1;
            if ((ieVar == null || ieVar.getVisibility() != 0) && !this.G2 && this.U2 == null && (this.f21805m2 == null || this.Y1 != null)) {
                z12 = true;
            } else {
                z12 = false;
            }
            if (!z11 && z10 && z12 && !this.f21871y2 && !t0()) {
                H0();
                qd qdVar = this.V;
                if (qdVar != null) {
                    AndroidUtilities.cancelRunOnUIThread(qdVar);
    ...
    public final ig x() {
        ...
        ?? obj = new Object();
        obj.f25003a = charSequence.toString();
        obj.f25004b = entities;
        return obj;
    }
    ...
    public final void y1() {
        ...
        float f10 = this.f21868y + this.f21862x;
        ve veVar = this.J0;
        if (veVar != null) {
    ...
    public final void z1() {
        ...
        org.telegram.ui.xd xdVar = this.f21815o1;
        if (xdVar != null) {
            xdVar.setTranslationX(this.f21868y + this.f21862x);
            ...
            hg.k kVar = this.f21825q1;
            if (kVar != null && this.f21877z4) {
                kVar.setAlpha(this.f21847u1 * this.F);
            }
        }
        xe xeVar = this.I1;
        if (xeVar != null) {
