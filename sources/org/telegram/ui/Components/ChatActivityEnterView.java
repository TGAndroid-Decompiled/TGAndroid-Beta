...
import org.telegram.messenger.MessagesStorage$$ExternalSyntheticLambda169;
...
public class ChatActivityEnterView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, SizeNotifierFrameLayout.SizeNotifierFrameLayoutDelegate, StickersAlert.StickersAlertDelegate, SuggestEmojiView.AnchorViewDelegate, FactorAnimator.Target, Theme.Colorable {
    ...
    private static final int POPUP_CONTENT_EMOJI_KEYBOARD = 0;
    ...
    private float progressToSeekbarStep1;
    private float progressToSeekbarStep2;
    ...
    public class AnonymousClass16 extends FrameLayout {
        ...
        public void onMeasure(int i, int i2) {
            ...
            if (ChatActivityEnterView.this.animatorInputFieldHeight.factor > 0.0f) {
    ...
    public class AnonymousClass24 extends FrameLayout {
        ...
        public AnonymousClass24(Context context, Theme.ResourcesProvider resourcesProvider) {
            super(context);
            ...
            if (!ChatActivityEnterView.this.isLiveComment) {
                    ...
                    if (!ChatActivityEnterView.this.hasRecordVideo || ChatActivityEnterView.this.calledRecordRunnable) {
                        ...
                        if (!ChatActivityEnterView.this.hasRecordVideo || !ChatActivityEnterView.this.isInVideoMode()) {
                            if (ChatActivityEnterView.this.recordingAudioVideo && ChatActivityEnterView.this.isInScheduleMode()) {
                                AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.parentFragment.getDialogId(), new AIEditorAlert$$ExternalSyntheticLambda20(1), new UndoView$$ExternalSyntheticLambda7(1), this.val$resourcesProvider);
                            }
                            if (AlertsCreator.needsPaidMessageAlert(ChatActivityEnterView.this.currentAccount, ChatActivityEnterView.this.dialog_id)) {
                                ...
                                final int i = 1;
                                AlertsCreator.ensurePaidMessageConfirmation(ChatActivityEnterView.this.currentAccount, ChatActivityEnterView.this.dialog_id, 1, new Utilities.Callback(this) {
                        ...
                        final int i3 = 0;
                        AndroidUtilities.runOnUIThread(chatActivityEnterView2.moveToSendStateRunnable = new Runnable(this) {
                            public final ChatActivityEnterView.AnonymousClass24 f$0;
                    ...
                    if (motionEvent.getAction() == 2 && ChatActivityEnterView.this.recordingAudioVideo) {
                        ...
                        if (!ChatActivityEnterView.this.recordCircle.isSendButtonVisible()) {
                            ...
                            if (ChatActivityEnterView.this.startedDraggingX == -1.0f) {
                                ...
                                chatActivityEnterView3.distCanMove = (float) (((double) chatActivityEnterView3.sizeNotifierLayout.getMeasuredWidth()) * 0.35d);
                            ...
                            float x2 = (((ChatActivityEnterView.this.audioVideoButtonContainer.getX() + x) - ChatActivityEnterView.this.startedDraggingX) / ChatActivityEnterView.this.distCanMove) + 1.0f;
                            if (ChatActivityEnterView.this.startedDraggingX != -1.0f) {
                                if (x2 <= 1.0f) {
                                    f = x2 < 0.0f ? 0.0f : x2;
                                }
                            ...
                            if (x2 == 0.0f) {
                                if (ChatActivityEnterView.this.hasRecordVideo && ChatActivityEnterView.this.isInVideoMode()) {
                                    ...
                                    chatActivityEnterViewDelegate2.needStartRecordVideo(2, true, 0, 0, chatActivityEnterView4.voiceOnce ? Integer.MAX_VALUE : 0, chatActivityEnterView4.effectId, 0L);
                                    ChatActivityEnterView.this.sendButton.setEffect(ChatActivityEnterView.this.effectId = 0L);
                                } else {
                                    ChatActivityEnterView.this.delegate.needStartRecordAudio(0);
                ...
                if (motionEvent.getAction() == 3 && ChatActivityEnterView.this.recordingAudioVideo) {
                    ...
                    if (ChatActivityEnterView.this.hasRecordVideo && ChatActivityEnterView.this.isInVideoMode()) {
                        ...
                        chatActivityEnterViewDelegate3.needStartRecordVideo(2, true, 0, 0, chatActivityEnterView5.voiceOnce ? Integer.MAX_VALUE : 0, chatActivityEnterView5.effectId, 0L);
                        ChatActivityEnterView.this.sendButton.setEffect(ChatActivityEnterView.this.effectId = 0L);
                    } else {
                        ChatActivityEnterView.this.delegate.needStartRecordAudio(0);
                        MediaController.getInstance().stopRecording(0, false, 0, ChatActivityEnterView.this.voiceOnce, 0L);
                ...
                if ((ChatActivityEnterView.this.recordCircle == null || !ChatActivityEnterView.this.recordCircle.isSendButtonVisible()) && ((frameLayout = ChatActivityEnterView.this.recordedAudioPanel) == null || frameLayout.getVisibility() != 0)) {
                    if ((((ChatActivityEnterView.this.audioVideoButtonContainer.getX() + motionEvent.getX()) - ChatActivityEnterView.this.startedDraggingX) / ChatActivityEnterView.this.distCanMove) + 1.0f < 0.45d) {
                        if (ChatActivityEnterView.this.hasRecordVideo && ChatActivityEnterView.this.isInVideoMode()) {
                            CameraController.getInstance().cancelOnInitRunnable(ChatActivityEnterView.this.onFinishInitCameraRunnable);
                            ...
                            chatActivityEnterViewDelegate4.needStartRecordVideo(2, true, 0, 0, chatActivityEnterView6.voiceOnce ? Integer.MAX_VALUE : 0, chatActivityEnterView6.effectId, 0L);
                            ChatActivityEnterView.this.sendButton.setEffect(ChatActivityEnterView.this.effectId = 0L);
                        } else {
                            ChatActivityEnterView.this.delegate.needStartRecordAudio(0);
                            MediaController.getInstance().stopRecording(0, false, 0, ChatActivityEnterView.this.voiceOnce, 0L);
                    ...
                    if (ChatActivityEnterView.this.recordAudioVideoRunnableStarted) {
                        ...
                        if (ChatActivityEnterView.this.sendVoiceEnabled && ChatActivityEnterView.this.sendRoundEnabled) {
                            ...
                            chatActivityEnterView7.setRecordVideoButtonVisible(!chatActivityEnterView7.isInVideoMode(), true);
                        } else {
                            ChatActivityEnterView.this.delegate.needShowMediaBanHint();
                        }
                    ...
                    if (!ChatActivityEnterView.this.hasRecordVideo || ChatActivityEnterView.this.calledRecordRunnable) {
                        ...
                        if (ChatActivityEnterView.this.hasRecordVideo && ChatActivityEnterView.this.isInVideoMode()) {
                            ...
                            chatActivityEnterViewDelegate5.needStartRecordVideo(1, true, 0, 0, chatActivityEnterView8.voiceOnce ? Integer.MAX_VALUE : 0, chatActivityEnterView8.effectId, 0L);
                            ChatActivityEnterView.this.sendButton.setEffect(ChatActivityEnterView.this.effectId = 0L);
                            ...
                            if (ChatActivityEnterView.this.recordingAudioVideo && ChatActivityEnterView.this.isInScheduleMode()) {
                                AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.parentFragment.getDialogId(), new AIEditorAlert$$ExternalSyntheticLambda20(2), new UndoView$$ExternalSyntheticLambda7(2), this.val$resourcesProvider);
                            }
                            ChatActivityEnterView.this.delegate.needStartRecordAudio(0);
                            MediaController.getInstance().stopRecording(ChatActivityEnterView.this.isInScheduleMode() ? 3 : 1, true, 0, ChatActivityEnterView.this.voiceOnce, 0L);
                        }
                        ...
                        chatActivityEnterView9.messageTransitionIsRunning = false;
                        final int i6 = 1;
                        AndroidUtilities.runOnUIThread(chatActivityEnterView9.moveToSendStateRunnable = new Runnable(this) {
                            public final ChatActivityEnterView.AnonymousClass24 f$0;
    ...
    public class AnonymousClass30 extends ImageView {
        ...
        public void onLayout(boolean z, int i, int i2, int i3, int i4) {
            super.onLayout(z, i, i2, i3, i4);
            post(new ChatActivityEnterView$$ExternalSyntheticLambda3(ChatActivityEnterView.this, 1));
        }
    ...
    public class AnonymousClass38 implements ViewTreeObserver.OnDrawListener {
        final SimpleAvatarView val$avatar;
        final SenderSelectPopup.SenderView val$senderView;

        public AnonymousClass38(SimpleAvatarView simpleAvatarView, SenderSelectPopup.SenderView senderView) {
        ...
        public void onDraw() {
            ...
            simpleAvatarView.post(new ImageUpdater$$ExternalSyntheticLambda1(this, simpleAvatarView, this.val$senderView, 1));
        }
    }

    public class AnonymousClass48 implements RecyclerListView.OnItemClickListener {
        ...
        public void onItemClick(View view, int i) {
            if (view instanceof BotCommandsMenuView.BotCommandView) {
                ...
                if (ChatActivityEnterView.this.isInScheduleMode()) {
                    AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.dialog_id, new AIEditorAlert$$ExternalSyntheticLambda34(1, this, command), ChatActivityEnterView.this.resourcesProvider);
                } else if (ChatActivityEnterView.this.parentFragment == null || !ChatActivityEnterView.this.parentFragment.checkSlowMode(view)) {
                    AlertsCreator.ensurePaidMessageConfirmation(ChatActivityEnterView.this.currentAccount, ChatActivityEnterView.this.dialog_id, 1, new ScrimOptions$$ExternalSyntheticLambda8(1, this, command));
                }
            }
        }
    }
        ...
        public void afterTextChanged(Editable editable) {
            ...
            if (ChatActivityEnterView.this.editingCaption && !ChatActivityEnterView.this.captionLimitBulletinShown && !MessagesController.getInstance(ChatActivityEnterView.this.currentAccount).premiumFeaturesBlocked() && !UserConfig.getInstance(ChatActivityEnterView.this.currentAccount).isPremium() && ChatActivityEnterView.this.codePointCount > MessagesController.getInstance(ChatActivityEnterView.this.currentAccount).captionLengthLimitDefault && ChatActivityEnterView.this.codePointCount < MessagesController.getInstance(ChatActivityEnterView.this.currentAccount).captionLengthLimitPremium) {
                ...
                if (this.heightShouldBeChanged) {
                    AndroidUtilities.runOnUIThread(new Bulletin$2$$ExternalSyntheticLambda1(this, 3), 300L);
                } else {
                    ChatActivityEnterView.this.showCaptionLimitBulletin();
                }
            }
    ...
    public class AnonymousClass77 extends ChatActivity {
        private boolean shownToast;
        final TLRPC.User val$bot;
        final long val$managerId;
        final TLRPC.User val$newBot;

        public AnonymousClass77(Bundle bundle, TLRPC.User user, TLRPC.User user2, long j) {
            super(bundle);
    ...
    public class AnonymousClass79 implements EmojiView.EmojiViewDelegate {
        ...
        public void lambda$onCustomEmojiSelected$0(EditTextBoldCursor editTextBoldCursor, String str, TLRPC.Document document, long j, boolean z) {
            ...
            try {
                ...
                AnimatedEmojiSpan animatedEmojiSpan = document != null ? new AnimatedEmojiSpan(document, editTextBoldCursor.getPaint().getFontMetricsInt()) : new AnimatedEmojiSpan(j, editTextBoldCursor.getPaint().getFontMetricsInt());
                if (!z) {
        ...
        public void lambda$onGifSelected$3(Object obj, MediaController.PhotoEntry photoEntry, boolean z, int i, int i2, boolean z2, String str, Object obj2, Long l) {
            ChatActivityEnterView$$ExternalSyntheticLambda38 chatActivityEnterView$$ExternalSyntheticLambda38 = new ChatActivityEnterView$$ExternalSyntheticLambda38(i, i2, l, obj, obj2, str, photoEntry, this, z, z2);
            if (ChatActivityEnterView.this.showConfirmAlert(chatActivityEnterView$$ExternalSyntheticLambda38)) {
                return;
            }
            chatActivityEnterView$$ExternalSyntheticLambda38.run();
        }
        ...
        public void onClearEmojiRecent() {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(ChatActivityEnterView.this.parentActivity, 0, ChatActivityEnterView.this.resourcesProvider);
            builder.setTitle(LocaleController.getString(R.string.ClearRecentEmojiTitle));
            builder.setMessage(LocaleController.getString(R.string.ClearRecentEmojiText));
            builder.setPositiveButton(LocaleController.getString(R.string.ClearButton), new EmojiView$$ExternalSyntheticLambda21(this, 1));
        ...
        public void onGifSelectedForAddCaption(final View view, final Object obj, final String str, final Object obj2, boolean z, int i, int i2) {
            ...
            PhotoViewer.getInstance().openPhotoForSelect(arrayList, 0, 12, false, new PhotoViewer.PhotoViewerProvider() {
                ...
                @Override
                public final boolean onDeletePhoto(int i3) {
                    return PhotoViewer.PhotoViewerProvider.CC.$default$onDeletePhoto(this, i3);
                }

                @Override
                public final void onEditModeChanged(boolean z2) {
                ...
                @Override
                public final void onReleasePlayerBeforeClose(int i3) {
                ...
                public void sendButtonPressed(int i3, VideoEditedInfo videoEditedInfo, boolean z2, int i4, int i5, boolean z3) {
                    AnonymousClass79.this.lambda$onGifSelected$1(view, obj, str, obj2, z2, i4, i5, photoEntry, this.isCaptionAbove);
                }
        ...
        public void onStickerSelected(View view, TLRPC.Document document, String str, Object obj, MessageObject.SendAnimationData sendAnimationData, boolean z, int i, int i2) {
            ...
            if (ChatActivityEnterView.this.trendingStickersAlert != null) {
                ChatActivityEnterView.this.trendingStickersAlert.lambda$showGiftOfferSheet$15();
        ...
        public void lambda$onGifSelected$1(final View view, final Object obj, final String str, final Object obj2, boolean z, int i, int i2, final MediaController.PhotoEntry photoEntry, final boolean z2) {
            ...
            if (ChatActivityEnterView.this.slowModeTimer <= 0 || isInScheduleMode()) {
                AlertsCreator.ensurePaidMessageConfirmation(ChatActivityEnterView.this.currentAccount, ChatActivityEnterView.this.dialog_id, 1, new ChatActivityEnterView$$ExternalSyntheticLambda41(this, obj, photoEntry, z, i, i2, z2, str, obj2));
    ...
    public class ChatActivityEditTextCaption extends EditTextCaption {
        ...
        private void editPhoto(Uri uri, String str) {
            Utilities.globalQueue.postRunnable(new ImageUpdater$$ExternalSyntheticLambda1(this, uri, AndroidUtilities.generatePicturePath(ChatActivityEnterView.this.parentFragment != null && ChatActivityEnterView.this.parentFragment.isSecretChat(), MimeTypeMap.getSingleton().getExtensionFromMimeType(str))));
        }
        ...
        public void lambda$editPhoto$5(Uri uri, File file) {
            try {
                ...
                while (true) {
                    ...
                    if (i <= 0) {
                        ...
                        ArrayList arrayList = new ArrayList();
                        arrayList.add(photoEntry);
                        AndroidUtilities.runOnUIThread(new ImageUpdater$$ExternalSyntheticLambda1(this, arrayList, file, 3));
                        return;
                    }
        ...
        public boolean lambda$onCreateInputConnection$1(InputContentInfoCompat inputContentInfoCompat, int i, Bundle bundle) {
            if (ChatActivityEnterView.this.isLiveComment) {
                return true;
            }
            ...
            if (!inputContentInfoCompat.mImpl.getDescription().hasMimeType("image/gif")) {
                ...
                if (!SendMessagesHelper.shouldSendWebPAsSticker(null, inputContentInfoCompatImpl.getContentUri())) {
                    editPhoto(inputContentInfoCompatImpl.getContentUri(), inputContentInfoCompatImpl.getDescription().getMimeType(0));
                    return true;
                }
            }
            if (ChatActivityEnterView.this.isInScheduleMode()) {
                AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.parentFragment.getDialogId(), new AIEditorAlert$$ExternalSyntheticLambda34(2, this, inputContentInfoCompat), ChatActivityEnterView.this.resourcesProvider);
                return true;
            }
        ...
        public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
            ...
            try {
                ...
                return EditorInfoCompat.createWrapper(inputConnectionOnCreateInputConnection, editorInfo, new EmojiView$$ExternalSyntheticLambda21(this, 2));
            } catch (Throwable th) {
                FileLog.e(th);
            ...
            if (!ChatActivityEnterView.this.stickersDragging && ChatActivityEnterView.this.stickersExpansionAnim == null) {
                ...
                if (!chatActivityEnterView.sendPlainEnabled && !chatActivityEnterView.isEditingMessage()) {
                    if (this.canvasButton == null) {
                        ...
                        final int i = 0;
                        canvasButton.setDelegate(new Runnable(this) {
    ...
    public class ControlsView extends FrameLayout {
        ...
        public void hideHintView() {
            ...
            if (hintView2 != null) {
                hintView2.setOnHiddenListener(new ChatActivityEnterView$ControlsView$$ExternalSyntheticLambda0(this, hintView2, 2));
                hintView2.hide();
                this.pauseHint = null;
            }
            HintView2 hintView3 = this.onceHint;
            if (hintView3 != null) {
                hintView3.setOnHiddenListener(new ChatActivityEnterView$ControlsView$$ExternalSyntheticLambda0(this, hintView3, 3));
                hintView3.hide();
                this.onceHint = null;
            }
        }
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (ChatActivityEnterView.this.sendButtonVisible) {
                ...
                f3 = 26.0f;
                fM = BotFullscreenButtons$$ExternalSyntheticOutline0.m(1.0f, fDp3 > 0.4f ? 1.0f : fDp3 / 0.4f, ChatActivityEnterView.this.snapAnimationProgress * 15.0f, (1.0f - ChatActivityEnterView.this.snapAnimationProgress) * (1.0f - fDp3) * 9.0f);
                f4 = fDp3;
            } else {
                f2 = 0.25f;
                f3 = 26.0f;
                fDp = AndroidUtilities.dp(36.0f) + ((int) (AndroidUtilities.dp(14.0f) * fDp3));
                fDp2 = (((AndroidUtilities.dp(60.0f) + measuredHeight) + ((int) ((1.0f - f) * AndroidUtilities.dp(30.0f)))) - ((int) fMax)) + (ChatActivityEnterView.this.idleProgress * fDp3 * (-AndroidUtilities.dp(8.0f)));
            ...
            if ((!ChatActivityEnterView.this.showTooltip || System.currentTimeMillis() - ChatActivityEnterView.this.showTooltipStartTime <= 200) && ChatActivityEnterView.this.tooltipAlpha == 0.0f) {
                ...
                if (fDp3 < 0.8f || ChatActivityEnterView.this.sendButtonVisible || ChatActivityEnterView.this.exitTransition != 0.0f || ChatActivityEnterView.this.transformToSeekbar != 0.0f) {
                ...
                if (this.tooltipLayout != null) {
                    ...
                    canvas.restore();
                    canvas.save();
                    canvas.translate(getMeasuredWidth() - AndroidUtilities.dp(f3), ((this.tooltipLayout.getHeight() / 2.0f) + (AndroidUtilities.dpf2(17.0f) + measuredHeight)) - (AndroidUtilities.dpf2(3.0f) * ChatActivityEnterView.this.idleProgress));
                    this.path.reset();
                    ...
                    drawable2.setBounds(zzkn.m(measuredWidth, drawable2), (int) (AndroidUtilities.dpf2(20.0f) + this.tooltipLayout.getHeight() + measuredHeight), zzkq.m(measuredWidth, this.tooltipBackgroundArrow), this.tooltipBackgroundArrow.getIntrinsicHeight() + ((int) (AndroidUtilities.dpf2(20.0f) + this.tooltipLayout.getHeight() + measuredHeight)));
            ...
            if (ChatActivityEnterView.this.transformToSeekbar != 0.0f) {
                ...
                if (chatActivityEnterView2.audioTimelineView != null) {
                    float f12 = chatActivityEnterView2.transformToSeekbar > 0.38f ? 1.0f : ChatActivityEnterView.this.transformToSeekbar / 0.38f;
                    if (ChatActivityEnterView.this.transformToSeekbar > 0.63f) {
                        interpolation = 0.0f;
                        fMax3 = 1.0f;
                    } else {
                        interpolation = 0.0f;
                        fMax3 = Math.max(0.0f, (ChatActivityEnterView.this.transformToSeekbar - 0.38f) / f2);
                    }
                    ...
                    if (ChatActivityEnterView.this.exitTransition > 0.6f) {
                        ...
                        f7 = ChatActivityEnterView.this.exitTransition / 0.6f;
                    }
                    ...
                    if (chatActivityEnterView.messageTransitionIsRunning) {
                        ...
                        fMax2 = Math.max(0.0f, (chatActivityEnterView.exitTransition - 0.6f) / 0.4f);
                    }
                    CubicBezierInterpolator cubicBezierInterpolator2 = CubicBezierInterpolator.EASE_BOTH;
                    float interpolation3 = cubicBezierInterpolator2.getInterpolation(f7);
                ...
                float interpolation4 = cubicBezierInterpolator3.getInterpolation(f7);
            ...
            if (f5 - ChatActivityEnterView.this.controlsScale != 0.0f) {
                f8 = f5 - ChatActivityEnterView.this.controlsScale;
            } else {
                f8 = interpolation != 0.0f ? interpolation : 0.0f;
            }
            ...
            } else if (ChatActivityEnterView.this.slideToCancelLockProgress != f5) {
                ChatActivityEnterView.access$5516(ChatActivityEnterView.this, 0.12f);
                if (ChatActivityEnterView.this.slideToCancelLockProgress > f5) {
                    ChatActivityEnterView.this.slideToCancelLockProgress = 1.0f;
                }
            }
            float fDpf3 = AndroidUtilities.dpf2(72.0f);
            float f13 = f4;
            float fM2 = ((1.0f - ChatActivityEnterView.this.slideToCancelLockProgress) * fDpf3) + DiffUtil.m(1.0f, f8, AndroidUtilities.dpf2(24.0f) * f6, fDpf3 * f8);
            if (fM2 > fDpf3) {
                fM2 = fDpf3;
            }
            float f14 = ChatActivityEnterView.this.slideToCancelLockProgress * (1.0f - interpolation) * ChatActivityEnterView.this.controlsScale * (1.0f - f11);
            float f15 = measuredWidth;
            float f16 = fDpf2 + fM2;
            canvas.scale(f14, f14, f15, f16);
            float f17 = f10 + fM2;
            this.rectF.set(f15 - AndroidUtilities.dpf2(18.0f), f17, AndroidUtilities.dpf2(18.0f) + f15, f17 + f9);
            BlurredBackgroundDrawable blurredBackgroundDrawable = this.lockBackgroundDrawable;
            if (blurredBackgroundDrawable != null) {
                blurredBackgroundDrawable.setBounds((int) (this.rectF.left - AndroidUtilities.dpf2(3.0f)), (int) (this.rectF.top - AndroidUtilities.dpf2(3.0f)), (int) (AndroidUtilities.dpf2(3.0f) + this.rectF.right), (int) (AndroidUtilities.dpf2(3.0f) + this.rectF.bottom));
                this.lockBackgroundDrawable.draw(canvas);
            } else {
                ChatActivityEnterView.this.lockShadowDrawable.setBounds((int) (this.rectF.left - AndroidUtilities.dpf2(3.0f)), (int) (this.rectF.top - AndroidUtilities.dpf2(3.0f)), (int) (AndroidUtilities.dpf2(3.0f) + this.rectF.right), (int) (AndroidUtilities.dpf2(3.0f) + this.rectF.bottom));
            ...
            float f18 = 1.0f - f13;
            this.rectF.set((f15 - AndroidUtilities.dpf2(6.0f)) - (AndroidUtilities.dpf2(2.0f) * f18), f16 - (AndroidUtilities.dpf2(2.0f) * f18), (AndroidUtilities.dpf2(2.0f) * f18) + AndroidUtilities.dp(6.0f) + measuredWidth, (AndroidUtilities.dpf2(2.0f) * f18) + f16 + AndroidUtilities.dp(12.0f));
            ...
            float f21 = 1.0f - fDp3;
            canvas2.translate(0.0f, AndroidUtilities.dpf2(2.0f) * f21);
            canvas2.rotate(fM, fCenterX, fCenterY);
            if (f13 != 1.0f) {
                RectF rectF2 = AndroidUtilities.rectTmp;
                rectF2.set(0.0f, 0.0f, AndroidUtilities.dpf2(8.0f), AndroidUtilities.dpf2(8.0f));
                canvas2.save();
                canvas2.clipRect(0.0f, 0.0f, getMeasuredWidth(), (AndroidUtilities.dpf2(2.0f) * f21) + f20 + f19);
                canvas2.translate(f15 - AndroidUtilities.dpf2(4.0f), (ChatActivityEnterView.this.snapAnimationProgress * AndroidUtilities.dpf2(2.0f)) + (AndroidUtilities.dpf2(12.0f) * f13) + ((this.rectF.top - AndroidUtilities.dp(6.0f)) - AndroidUtilities.lerp(AndroidUtilities.dpf2(2.0f), (1.0f - ChatActivityEnterView.this.idleProgress) * AndroidUtilities.dpf2(1.5f), fDp3)));
                if (fM > 0.0f) {
                    canvas2.rotate(fM, AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f));
                }
                canvas2.drawLine(AndroidUtilities.dpf2(8.0f), AndroidUtilities.dpf2(4.0f), AndroidUtilities.dpf2(8.0f), AndroidUtilities.dpf2(6.0f) + (AndroidUtilities.dpf2(4.0f) * f18), this.lockOutlinePaint);
                canvas.drawArc(rectF2, 0.0f, -180.0f, false, this.lockOutlinePaint);
                float fDpf4 = AndroidUtilities.dpf2(4.0f);
                float fDpf5 = AndroidUtilities.dpf2(4.0f);
                float fDpf6 = AndroidUtilities.dpf2(4.0f);
                ChatActivityEnterView chatActivityEnterView3 = ChatActivityEnterView.this;
                canvas2 = canvas;
                canvas2.drawLine(0.0f, fDpf4, 0.0f, (ChatActivityEnterView.this.snapAnimationProgress * AndroidUtilities.dpf2(4.0f) * f21) + (fDpf6 * chatActivityEnterView3.idleProgress * fDp3 * (!chatActivityEnterView3.sendButtonVisible ? 1 : 0)) + fDpf5, this.lockOutlinePaint);
                canvas2.restore();
            }
            if (fClamp > 0.0f) {
            ...
            if (f13 > 0.0f) {
                ...
                rectF3.right = this.rectF.centerX() - (AndroidUtilities.dp(1.66f) * f13);
                float[] fArr = this.radiiLeft;
                float fLerp = AndroidUtilities.lerp(AndroidUtilities.dp(3.0f), AndroidUtilities.dp(1.5f), f13);
                fArr[7] = fLerp;
                fArr[6] = fLerp;
                fArr[1] = fLerp;
                fArr[0] = fLerp;
                float[] fArr2 = this.radiiLeft;
                float fDp4 = AndroidUtilities.dp(1.5f) * f13;
                fArr2[5] = fDp4;
                fArr2[4] = fDp4;
                fArr2[3] = fDp4;
                fArr2[2] = fDp4;
                ...
                rectF3.set(this.rectF);
                rectF3.left = (AndroidUtilities.dp(1.66f) * f13) + this.rectF.centerX();
                float[] fArr4 = this.radiiRight;
                float fLerp2 = AndroidUtilities.lerp(AndroidUtilities.dp(3.0f), AndroidUtilities.dp(1.5f), f13);
                fArr4[5] = fLerp2;
                fArr4[4] = fLerp2;
                fArr4[3] = fLerp2;
                fArr4[2] = fLerp2;
                float[] fArr5 = this.radiiRight;
                float fDp5 = AndroidUtilities.dp(1.5f) * f13;
                fArr5[7] = fDp5;
                fArr5[6] = fDp5;
                fArr5[1] = fDp5;
                fArr5[0] = fDp5;
            ...
            if (drawable != null) {
                ...
                rect.set((int) (this.rectF.centerX() - ((drawable.getIntrinsicWidth() / 2) * 0.9285f)), (int) (this.rectF.centerY() - ((drawable.getIntrinsicHeight() / 2) * 0.9285f)), (int) (((drawable.getIntrinsicWidth() / 2) * 0.9285f) + this.rectF.centerX()), (int) (((drawable.getIntrinsicHeight() / 2) * 0.9285f) + this.rectF.centerY()));
                drawable.setBounds(rect);
                drawable.setAlpha((int) (fClamp * 255.0f));
                drawable.draw(canvas2);
            }
            if (f13 != 1.0f) {
                canvas2.drawCircle(fCenterX, fCenterY, AndroidUtilities.dpf2(2.0f) * f18, this.lockBackgroundPaint);
            }
            canvas2.restore();
            canvas2.restore();
            float fDp6 = (AndroidUtilities.dp(38.0f) * f11) + AndroidUtilities.lerp(f10, getMeasuredHeight() - AndroidUtilities.dp(118.0f), Math.max(ChatActivityEnterView.this.exitTransition, Math.min(f6, ChatActivityEnterView.this.slideToCancelLockProgress))) + f20;
            this.rectF.set(f15 - AndroidUtilities.dpf2(18.0f), fDp6, AndroidUtilities.dpf2(18.0f) + f15, fDp6 + f9);
            ChatActivityEnterView chatActivityEnterView4 = ChatActivityEnterView.this;
            ...
            if (ChatActivityEnterView.this.onceVisible) {
                float fDpf7 = AndroidUtilities.dpf2(12.0f);
                RectF rectF4 = this.rectF;
                float f22 = rectF4.left;
                float fDpf8 = (rectF4.top - AndroidUtilities.dpf2(36.0f)) - fDpf7;
                RectF rectF5 = this.rectF;
                rectF4.set(f22, fDpf8, rectF5.right, rectF5.top - fDpf7);
                HintView2 hintView3 = this.onceHint;
                if (hintView3 != null) {
                ...
                canvas2.save();
                float f23 = ChatActivityEnterView.this.snapAnimationProgress * ChatActivityEnterView.this.slideToCancelLockProgress * (1.0f - ChatActivityEnterView.this.exitTransition) * ChatActivityEnterView.this.controlsScale;
                canvas2.scale(f23, f23, this.rectF.centerX(), this.rectF.centerY());
                BlurredBackgroundDrawable blurredBackgroundDrawable2 = this.periodBackgroundDrawable;
                if (blurredBackgroundDrawable2 != null) {
                    blurredBackgroundDrawable2.setBounds((int) (this.rectF.left - AndroidUtilities.dpf2(3.0f)), (int) (this.rectF.top - AndroidUtilities.dpf2(3.0f)), (int) (AndroidUtilities.dpf2(3.0f) + this.rectF.right), (int) (AndroidUtilities.dpf2(3.0f) + this.rectF.bottom));
            ...
            if (motionEvent.getAction() == 0) {
                ...
                if (this.pausePressed && ChatActivityEnterView.this.pauseRect.contains(x, y)) {
                    if (ChatActivityEnterView.this.isInVideoMode()) {
                        ...
                        ShareAlert$23$$ExternalSyntheticLambda0 shareAlert$23$$ExternalSyntheticLambda0 = new ShareAlert$23$$ExternalSyntheticLambda0(this, 29);
                        HintView2 hintView2 = this.pauseHint;
                        ...
                        if (!MediaController.getInstance().isRecordingPaused() || (ChatActivityEnterView.this.audioTimelineView.getAudioLeft() <= 0.01f && ChatActivityEnterView.this.audioTimelineView.getAudioRight() >= 0.99f)) {
                            shareAlert$23$$ExternalSyntheticLambda0.run();
                        } else {
                            FilterGLThread$$ExternalSyntheticLambda7 filterGLThread$$ExternalSyntheticLambda7 = new FilterGLThread$$ExternalSyntheticLambda7(5, this, shareAlert$23$$ExternalSyntheticLambda0);
                            if (MessagesController.getGlobalMainSettings().getBoolean("trimvoicehint", true)) {
                                new AlertDialog.Builder(getContext(), 0, ChatActivityEnterView.this.resourcesProvider).setTitle(LocaleController.getString(R.string.RecordingTrimTitle)).setMessage(LocaleController.getString(R.string.RecordingTrimText)).setPositiveButton(LocaleController.getString(R.string.OK), new EmojiView$$ExternalSyntheticLambda21(filterGLThread$$ExternalSyntheticLambda7, 27)).setNegativeButton(LocaleController.getString(R.string.Cancel), null).show();
                            } else {
                                filterGLThread$$ExternalSyntheticLambda7.run();
                            }
                        }
                    }
        ...
        public void showOnceHint() {
            ...
            hintView4.setOnHiddenListener(new ChatActivityEnterView$ControlsView$$ExternalSyntheticLambda0(this, hintView4, 1));
            this.onceHint.show();
        }
        ...
        public void showPauseHint() {
            ...
            HintView2 hintView3 = this.pauseHint;
            hintView3.setOnHiddenListener(new ChatActivityEnterView$ControlsView$$ExternalSyntheticLambda0(this, hintView3, 0));
            this.pauseHint.show();
        }
        ...
        public void updateColors() {
            ...
            CaptionContainerView.PeriodDrawable periodDrawable = this.periodDrawable;
            int themedColor = ChatActivityEnterView.this.getThemedColor(this.useGlassDesign ? Theme.key_glass_defaultIcon : Theme.key_chat_messagePanelVoiceLock);
            int themedColor2 = ChatActivityEnterView.this.getThemedColor(Theme.key_chat_messagePanelVoiceBackground);
            periodDrawable.strokeColor = themedColor;
            periodDrawable.strokePaint.setColor(themedColor);
            periodDrawable.textDrawable.setTextColor(themedColor);
            periodDrawable.activeTextDrawable.setTextColor(-1);
            periodDrawable.fillPaint.setColor(themedColor2);
            ...
            int themedColor3 = ChatActivityEnterView.this.getThemedColor(i);
            PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
            drawable.setColorFilter(new PorterDuffColorFilter(themedColor3, mode));
    ...
    public class RecordCircle extends View {
        ...
        public void drawIcon(Canvas canvas, int i, int i2, float f) {
            ...
            if (isSendButtonVisible()) {
                ...
                ChatActivityEnterView.this.sendRect.set(zzkn.m(i, drawable), i2 - (drawable.getIntrinsicHeight() / 2), (drawable.getIntrinsicWidth() / 2) + i, (drawable.getIntrinsicHeight() / 2) + i2);
                if (drawable2 != null) {
        ...
        public void drawWaves(Canvas canvas, float f, float f2, float f3) {
            ...
            canvas.save();
            float f5 = ((this.bigWaveDrawable.amplitude * 1.4f) + BlobDrawable.SCALE_BIG_MIN) * ChatActivityEnterView.this.scale * f4 * interpolation * f3;
            canvas.scale(f5, f5, f, f2);
            BlobDrawable blobDrawable = this.bigWaveDrawable;
            blobDrawable.draw(f, f2, canvas, blobDrawable.paint);
            canvas.restore();
            float f6 = ((this.tinyWaveDrawable.amplitude * 1.4f) + BlobDrawable.SCALE_SMALL_MIN) * ChatActivityEnterView.this.scale * f4 * interpolation * f3;
            canvas.save();
        ...
        public void onDraw(Canvas canvas) {
            ...
            float f19 = iDp;
            this.drawingCy = f19;
            float f20 = ChatActivityEnterView.this.scale <= 0.5f ? ChatActivityEnterView.this.scale / 0.5f : ChatActivityEnterView.this.scale <= 0.75f ? 1.0f - (((ChatActivityEnterView.this.scale - 0.5f) / 0.25f) * 0.1f) : (((ChatActivityEnterView.this.scale - 0.75f) / 0.25f) * 0.1f) + 0.9f;
            long jCurrentTimeMillis = System.currentTimeMillis() - this.lastUpdateTime;
            float f21 = this.animateToAmplitude;
            float f22 = this.amplitude;
            if (f21 != f22) {
                float f23 = this.animateAmplitudeDiff;
                float f24 = (jCurrentTimeMillis * f23) + f22;
                this.amplitude = f24;
                if (f23 > 0.0f) {
                    if (f24 > f21) {
                        this.amplitude = f21;
            ...
            float interpolation3 = ((this.circleRadiusAmplitude * this.amplitude) + this.circleRadius) * f20 * (ChatActivityEnterView.this.canceledByGesture ? CubicBezierInterpolator.EASE_OUT.getInterpolation(1.0f - ChatActivityEnterView.this.slideToCancelProgress) * 0.7f : (ChatActivityEnterView.this.slideToCancelProgress * 0.3f) + 0.7f);
            this.progressToSeekbarStep3 = 0.0f;
            if (ChatActivityEnterView.this.transformToSeekbar != 0.0f) {
                ChatActivityEnterView chatActivityEnterView3 = ChatActivityEnterView.this;
                f = 16.0f;
                if (chatActivityEnterView3.audioTimelineView != null) {
                    float f25 = chatActivityEnterView3.transformToSeekbar > 0.38f ? 1.0f : ChatActivityEnterView.this.transformToSeekbar / 0.38f;
                    ...
                    CubicBezierInterpolator cubicBezierInterpolator = CubicBezierInterpolator.EASE_BOTH;
                    interpolation = cubicBezierInterpolator.getInterpolation(f25);
                    ...
                    float fDp = (AndroidUtilities.dp(16.0f) * interpolation) + interpolation3;
                    float fDp2 = AndroidUtilities.dp(8.0f);
                    interpolation3 = DiffUtil.m(1.0f, interpolation4, fDp - fDp2, fDp2);
                    f3 = interpolation4;
                    fMax = 1.0f;
                }
                interpolation2 = 0.0f;
                ...
                if (this.progressToSeekbarStep3 > 0.0f) {
                    ...
                    f5 = 0.0f;
                    f6 = 1.0f;
                    ChatActivityEnterView.this.paint.setColor(ColorUtils.blendARGB(this.progressToSeekbarStep3, ChatActivityEnterView.this.getThemedColor(Theme.key_chat_messagePanelVoiceBackground), ChatActivityEnterView.this.getThemedColor(Theme.key_chat_recordedVoiceBackground)));
                } else {
                    f4 = 0.4f;
                    f5 = 0.0f;
                    f6 = 1.0f;
                ...
                drawable = null;
                if (isSendButtonVisible()) {
                    f17 = this.progressToSendButton;
                    if (f17 != f6) {
                        f18 = (jCurrentTimeMillis / 150.0f) + f17;
                        this.progressToSendButton = f18;
                        if (f18 > f6) {
                    ...
                    f7 = interpolation;
                    f8 = fMax;
                    ChatActivityEnterView.this.sendRect.set(zzkn.m(measuredWidth, drawable3), iDp - (drawable3.getIntrinsicHeight() / 2), (drawable3.getIntrinsicWidth() / 2) + measuredWidth, (drawable3.getIntrinsicHeight() / 2) + iDp);
                    if (drawable != null) {
                        drawable.setBounds(measuredWidth - (drawable.getIntrinsicWidth() / 2), iDp - (drawable.getIntrinsicHeight() / 2), (drawable.getIntrinsicWidth() / 2) + measuredWidth, (drawable.getIntrinsicHeight() / 2) + iDp);
                    }
                } else {
                    f7 = interpolation;
                    f8 = fMax;
                    ...
                    drawable3 = drawable2;
                    ChatActivityEnterView.this.sendRect.set(measuredWidth - AndroidUtilities.dp(12.0f), iDp - AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + measuredWidth, AndroidUtilities.dp(12.0f) + iDp);
                }
                drawable4 = drawable3;
                drawable5 = drawable;
                ...
                if (this.incIdle) {
                    ...
                    f16 = chatActivityEnterView2.idleProgress + 0.01f;
                    chatActivityEnterView2.idleProgress = f16;
                    if (f16 > 1.0f) {
                        this.incIdle = false;
                ...
                if (LiteMode.isEnabled(i)) {
                    ...
                    this.bigWaveDrawable.maxRadius = (AndroidUtilities.dp(f9) * BlobDrawable.FORM_BIG_MAX) + AndroidUtilities.dp(50.0f);
                ...
                if (LiteMode.isEnabled(i) && f3 != 1.0f && interpolation2 < f4 && f11 > 0.0f && !ChatActivityEnterView.this.canceledByGesture) {
                    if (this.showWaves) {
                        f14 = this.wavesEnterAnimation;
                        if (f14 != 1.0f) {
                            f15 = f14 + 0.04f;
                            this.wavesEnterAnimation = f15;
                            if (f15 > 1.0f) {
                    ...
                    if (!this.voiceEnterTransitionInProgress) {
                        ...
                        canvas.save();
                        float f26 = 1.0f - f7;
                        float fM = AndroidUtilities$$ExternalSyntheticOutline0.m(this.bigWaveDrawable.amplitude, 1.4f, BlobDrawable.SCALE_BIG_MIN, MediaController$$ExternalSyntheticOutline0.m(ChatActivityEnterView.this.scale, f26, f11, interpolation5));
                        canvas.scale(fM, fM, ChatActivityEnterView.this.slideDelta + measuredWidth, f19);
                        this.bigWaveDrawable.draw(ChatActivityEnterView.this.slideDelta + measuredWidth, f19, canvas, this.bigWaveDrawable.paint);
                        canvas.restore();
                        float f27 = ((this.tinyWaveDrawable.amplitude * 1.4f) + BlobDrawable.SCALE_SMALL_MIN) * ChatActivityEnterView.this.scale * f26 * f11 * interpolation5;
                        canvas.save();
                        canvas.scale(f27, f27, ChatActivityEnterView.this.slideDelta + measuredWidth, f19);
                        this.tinyWaveDrawable.draw(ChatActivityEnterView.this.slideDelta + measuredWidth, f19, canvas, this.tinyWaveDrawable.paint);
                        canvas.restore();
                    }
                }
                if (ChatActivityEnterView.this.canceledByGesture && ChatActivityEnterView.this.slideToCancelProgress < 1.0f) {
                ...
                if (this.voiceEnterTransitionInProgress) {
                    ...
                    if (ChatActivityEnterView.this.scale == 1.0f) {
                        if (ChatActivityEnterView.this.transformToSeekbar != 0.0f) {
                            i2 = measuredWidth;
                            canvas.drawCircle(ChatActivityEnterView.this.slideDelta + i2, f19, interpolation3, ChatActivityEnterView.this.paint);
                        } else if (!ChatActivityEnterView.this.isInVideoMode || this.progressToSeekbarStep3 <= 0.0f) {
                            i2 = measuredWidth;
                            canvas.drawCircle(ChatActivityEnterView.this.slideDelta + i2, f19, (1.0f - this.progressToSeekbarStep3) * interpolation3, ChatActivityEnterView.this.paint);
                        } else {
                            ChatActivityEnterView chatActivityEnterView4 = ChatActivityEnterView.this;
                            if (chatActivityEnterView4.audioTimelineView != null) {
                                float f28 = f19 + interpolation3;
                                float f29 = f19 - interpolation3;
                                float f30 = chatActivityEnterView4.slideDelta + measuredWidth + interpolation3;
                                float f31 = (ChatActivityEnterView.this.slideDelta + measuredWidth) - interpolation3;
                                RecordedAudioPlayerView recordedAudioPlayerView = ChatActivityEnterView.this.audioTimelineView;
                                int x = 0;
                                int y = 0;
                                ...
                                float f32 = y;
                                float y2 = (recordedAudioPlayerView.getY() + f32) - getY();
                                float y3 = ((recordedAudioPlayerView.getY() + recordedAudioPlayerView.getMeasuredHeight()) + f32) - getY();
                                float f33 = x;
                                float x2 = (((recordedAudioPlayerView.getX() + recordedAudioPlayerView.getMeasuredWidth()) + f33) - getX()) - ChatActivityEnterView.this.horizontalPadding;
                                float x3 = ChatActivityEnterView.this.horizontalPadding + ((recordedAudioPlayerView.getX() + f33) - getX());
                                i2 = measuredWidth;
                                float measuredHeight = ChatActivityEnterView.this.isInVideoMode() ? 0.0f : recordedAudioPlayerView.getMeasuredHeight() / 2.0f;
                                float fLerp = AndroidUtilities.lerp(f29, y2, this.progressToSeekbarStep3);
                                float fLerp2 = AndroidUtilities.lerp(f28, y3, this.progressToSeekbarStep3);
                                float fLerp3 = AndroidUtilities.lerp(f31, x3, this.progressToSeekbarStep3);
                                float fLerp4 = AndroidUtilities.lerp(f30, x2, this.progressToSeekbarStep3);
                        ...
                        drawable4 = drawable4;
                        drawable5 = drawable5;
                        drawIconInternal(canvas, drawable4, drawable5, this.progressToSendButton, (int) ImageReceiver$$ExternalSyntheticOutline2.m(1.0f, f3, 1.0f - interpolation2, 255.0f));
                        canvas.restore();
                    } else {
                        i2 = measuredWidth;
                        f12 = 1.0f;
                ...
                if (ChatActivityEnterView.this.scale != f12) {
                    canvas.drawCircle(ChatActivityEnterView.this.slideDelta + i2, f19, interpolation3, ChatActivityEnterView.this.paint);
                    if (ChatActivityEnterView.this.canceledByGesture) {
                        f13 = 1.0f - ChatActivityEnterView.this.slideToCancelProgress;
                    } else {
                        f13 = 1.0f;
                    }
                    canvas.save();
                    canvas.translate(ChatActivityEnterView.this.slideDelta, 0.0f);
                    drawIconInternal(canvas, drawable4, drawable5, this.progressToSendButton, (int) (f13 * 255.0f));
                    canvas.restore();
                }
            ...
            if (ChatActivityEnterView.this.exitTransition != 0.0f) {
                float f34 = ChatActivityEnterView.this.exitTransition > 0.6f ? 1.0f : ChatActivityEnterView.this.exitTransition / 0.6f;
                ChatActivityEnterView chatActivityEnterView5 = ChatActivityEnterView.this;
                ...
                CubicBezierInterpolator cubicBezierInterpolator2 = CubicBezierInterpolator.EASE_BOTH;
                interpolation = cubicBezierInterpolator2.getInterpolation(f34);
                interpolation2 = cubicBezierInterpolator2.getInterpolation(fMax3);
                interpolation3 = (1.0f - interpolation2) * ((AndroidUtilities.dp(f) * interpolation) + interpolation3);
            ...
            if (LiteMode.isEnabled(i)) {
                ...
                if (!this.voiceEnterTransitionInProgress) {
                    ...
                    canvas.save();
                    float f210 = 1.0f - f7;
                    float fM2 = AndroidUtilities$$ExternalSyntheticOutline0.m(this.bigWaveDrawable.amplitude, 1.4f, BlobDrawable.SCALE_BIG_MIN, MediaController$$ExternalSyntheticOutline0.m(ChatActivityEnterView.this.scale, f210, f11, interpolation6));
                    canvas.scale(fM2, fM2, ChatActivityEnterView.this.slideDelta + measuredWidth, f19);
                    this.bigWaveDrawable.draw(ChatActivityEnterView.this.slideDelta + measuredWidth, f19, canvas, this.bigWaveDrawable.paint);
                    canvas.restore();
                    float f211 = ((this.tinyWaveDrawable.amplitude * 1.4f) + BlobDrawable.SCALE_SMALL_MIN) * ChatActivityEnterView.this.scale * f210 * f11 * interpolation6;
                    canvas.save();
                    canvas.scale(f211, f211, ChatActivityEnterView.this.slideDelta + measuredWidth, f19);
                    this.tinyWaveDrawable.draw(ChatActivityEnterView.this.slideDelta + measuredWidth, f19, canvas, this.tinyWaveDrawable.paint);
                    canvas.restore();
                }
            }
            ...
            if (this.voiceEnterTransitionInProgress) {
                ...
                if (ChatActivityEnterView.this.scale == 1.0f) {
                    if (ChatActivityEnterView.this.transformToSeekbar != 0.0f) {
                        i2 = measuredWidth;
                        canvas.drawCircle(ChatActivityEnterView.this.slideDelta + i2, f19, interpolation3, ChatActivityEnterView.this.paint);
                    } else if (ChatActivityEnterView.this.isInVideoMode) {
                        i2 = measuredWidth;
                        canvas.drawCircle(ChatActivityEnterView.this.slideDelta + i2, f19, (1.0f - this.progressToSeekbarStep3) * interpolation3, ChatActivityEnterView.this.paint);
                    } else {
                        i2 = measuredWidth;
        ...
        public void setMovingCords(float f, float f2) {
            ...
            float f4 = this.lastMovingY;
            float fM = DiffUtil.m(f2, f4, f2 - f4, f3 * f3);
            this.lastMovingY = f2;
            this.lastMovingX = f;
            if (ChatActivityEnterView.this.showTooltip && ChatActivityEnterView.this.tooltipAlpha == 0.0f && fM > this.touchSlop) {
                ChatActivityEnterView.this.showTooltipStartTime = System.currentTimeMillis();
            }
        }
    ...
    public static class SendButton extends View implements ItemOptions.ScrimView {
        public static final float INFINITE_LOADING = -3.0f;
        ...
        private void checkBackgroundRect() {
            ...
            this.backgroundRect.set((getMeasuredWidth() - AndroidUtilities.lerp(Math.max(fDpf3, this.priceText.getCurrentWidth() + AndroidUtilities.dpf2(20.0f)), fDpf3, this.sameWidthFactor)) - fDpf2, (getMeasuredHeight() - fDpf3) - fDpf2, getMeasuredWidth() - fDpf2, getMeasuredHeight() - fDpf2);
        }
        ...
        public void bounceCount() {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ButtonBounce$$ExternalSyntheticLambda0(this, 28));
        ...
        public void drawScrim(Canvas canvas, float f) {
            ...
            if (i != 0) {
                ...
                float fIsNotEmpty = (1.0f - f3) * this.count.isNotEmpty();
                if (fIsNotEmpty > 0.0f) {
                    float fMax = Math.max(this.count.getCurrentWidth() + AndroidUtilities.dp(9.0f), AndroidUtilities.dp(18.0f));
                    if (this.newCounterPos) {
                    ...
                    canvas.drawCircle(fDp, circleHeight, ((fMax / 2.0f) + AndroidUtilities.dp(2.0f)) * fIsNotEmpty * this.countBounceScale, this.scrimViewBackgroundPaint);
                }
            }
            draw(canvas);
        }
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (this.isNewDesignSendButton) {
                ...
                measuredHeight = Math.round(((rectF2.height() / 2.0f) + rectF2.top) - (drawable.getIntrinsicHeight() / 2.0f));
            } else {
                iM = zzkn.m(getMeasuredWidth() - (getMeasuredHeight() / 2), drawable);
            ...
            float f8 = (1.0f - this.ephemeralFactor) * this.animatedPriceVisible.set(this.starsPrice > 0 && !this.hidePrice);
            ...
            if (f7 < 1.0f) {
                ...
                canvas2.rotate(60.0f * f10, (drawable.getIntrinsicWidth() / 2.0f) + f11, (drawable.getIntrinsicHeight() / 2.0f) + f12);
            ...
            float f13 = fLerp2;
            float fLerp5 = AndroidUtilities.lerp(getCircleWidth(), this.priceText.getCurrentWidth() + AndroidUtilities.dp(this.isNewDesignSendButton ? 20.0f : 22.0f), f8);
            ...
            if (f7 > 0.0f) {
                ...
                if (f8 > f4) {
                    ...
                    f5 = 1.0f;
                    this.priceText.setAlpha((int) ((1.0f - f6) * f8 * 255.0f));
                    this.priceText.draw(canvas2);
                } else {
                    f5 = 1.0f;
                }
                this.drawableInverse.setAlpha((int) ((f5 - f8) * (f5 - f6) * 255.0f));
                if (this.circleWidth > 0) {
                    Drawable drawable2 = this.drawableInverse;
                    drawable2.setBounds((int) (f15 - (drawable2.getIntrinsicWidth() / f2)), (int) (f16 - (this.drawableInverse.getIntrinsicHeight() / f2)), (int) ((this.drawableInverse.getIntrinsicWidth() / f2) + f15), (int) ((this.drawableInverse.getIntrinsicHeight() / f2) + f16));
                } else {
            ...
            float fIsNotEmpty = (1.0f - f8) * this.count.isNotEmpty();
            if (!this.locked) {
                float fMax2 = Math.max(this.count.getCurrentWidth() + AndroidUtilities.dp(9.0f), AndroidUtilities.dp(18.0f));
                if (this.newCounterPos) {
                    measuredWidth = (f3 - AndroidUtilities.dp(50.0f)) + f14;
                    measuredHeight2 = (fMax2 / f2) + (f16 - (getCircleHeight() / f2));
                    fDp = AndroidUtilities.dp(0.66f);
                } else {
                    float f21 = fMax2 / f2;
                    measuredWidth = (getMeasuredWidth() - this.circlePadX) - f21;
                    measuredHeight2 = (getMeasuredHeight() - this.circlePadY) - f21;
                    fDp = 0.0f;
                }
                float f22 = fMax2 / f2;
                this.count.setBounds((int) (measuredWidth - f22), (int) ((measuredHeight2 - f22) - fDp), (int) (measuredWidth + f22), (int) ((measuredHeight2 + f22) - fDp));
                if (fIsNotEmpty > f4) {
                    ...
                    if (!this.isNewDesignSendButton) {
                        canvas2.drawCircle(measuredWidth, measuredHeight2, (AndroidUtilities.dp(f2) + f22) * fIsNotEmpty * this.countBounceScale, Theme.PAINT_CLEAR);
                        canvas2.drawCircle(measuredWidth, measuredHeight2, f22 * fIsNotEmpty * this.countBounceScale, this.backgroundPaint);
                    }
        ...
        public void setCount(int i, boolean z) {
            this.count.setText(i > 0 ? DiffUtil.m(i, "") : "", z);
            invalidate();
        }
        ...
        public void setStarsPrice(long j, int i, boolean z) {
            ...
            if (j > 0) {
                this.priceText.setText(StarsIntroActivity.replaceStars(false, BillingController$$ExternalSyntheticOutline0.m(j * ((long) Math.max(1, this.messagesCount)), ',', new StringBuilder("⭐️")), this.spans), z);
            } else {
        ...
        public int width(int i) {
            return (int) AndroidUtilities.lerp(this.circlePadX + getCircleWidth() + this.circlePadX, this.priceText.getAnimateToWidth() + AndroidUtilities.dp(this.isNewDesignSendButton ? 20.0f : 22.0f) + AndroidUtilities.dp(18.0f), (this.starsPrice > 0 ? 1.0f : 0.0f) * (isOpen() ? 1.0f : 0.0f));
        }
    ...
    public class SlideTextView extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            int iDp = AndroidUtilities.dp(16.0f) + this.cancelLayout.getWidth();
            ...
            float f3 = z ? (iDp2 + primaryHorizontal) - measuredWidth : 0.0f;
            float f4 = this.xOffset;
            float f5 = this.cancelToProgress;
            float fDp3 = (((((1.0f - f5) * f4) * this.slideProgress) + iDp2) - (f3 * f5)) + AndroidUtilities.dp(16.0f);
            ...
            float f6 = z ? fDp3 + primaryHorizontal : measuredWidth;
        ...
        public void updateColors() {
            ...
            BaseCell.RippleDrawableSafe rippleDrawableSafeCreateSimpleSelectorCircleDrawable = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.dp(60.0f), 0, ColorUtils.setAlphaComponent(ChatActivityEnterView.this.getThemedColor(i), 26));
    ...
    public static class SlowModeBtn extends FrameLayout {
        ...
        public SlowModeBtn(Context context) {
            ...
            setWillNotDraw(false);
            Drawable drawable = context.getDrawable(R.drawable.msg_mini_close_tooltip);
    ...
    public class TimerView extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (timerDurationFast.length() < 3 || (str = this.oldString) == null || str.length() < 3 || timerDurationFast.length() != this.oldString.length() || timerDurationFast.charAt(timerDurationFast.length() - 3) == this.oldString.charAt(timerDurationFast.length() - 3)) {
                ...
                Layout.Alignment alignment = Layout.Alignment.ALIGN_NORMAL;
                this.inLayout = new StaticLayout(spannableStringBuilder2, textPaint2, measuredWidth, alignment, 1.0f, 0.0f, false);
            ...
            if (this.replaceTransition == 0.0f) {
                ...
                if (this.outLayout != null) {
                    ...
                    canvas.translate(0.0f, DiffUtil.m(1.0f, this.replaceTransition, this.replaceDistance, measuredHeight - (this.outLayout.getHeight() / 2.0f)));
    ...
    public static float access$4816(ChatActivityEnterView chatActivityEnterView, float f) {
        float f2 = chatActivityEnterView.tooltipAlpha + f;
        chatActivityEnterView.tooltipAlpha = f2;
        return f2;
    }

    public static float access$4824(ChatActivityEnterView chatActivityEnterView, float f) {
        float f2 = chatActivityEnterView.tooltipAlpha - f;
        chatActivityEnterView.tooltipAlpha = f2;
        return f2;
    }

    public static float access$5516(ChatActivityEnterView chatActivityEnterView, float f) {
        float f2 = chatActivityEnterView.slideToCancelLockProgress + f;
        chatActivityEnterView.slideToCancelLockProgress = f2;
        return f2;
    }

    public static float access$5524(ChatActivityEnterView chatActivityEnterView, float f) {
        float f2 = chatActivityEnterView.slideToCancelLockProgress - f;
        chatActivityEnterView.slideToCancelLockProgress = f2;
        return f2;
    }
    ...
    private ValueAnimator animateScheduledTranslationX(float f) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ChatActivityEnterView$$ExternalSyntheticLambda5(this, 1));
    ...
    private float calculateIslandTotalHeight(boolean z) {
        ...
        if (z) {
            ...
            f = factorAnimator.isAnimating ? factorAnimator.toFactor : factorAnimator.factor;
        } else {
            f = this.animatorInputFieldHeight.factor;
        }
        float f2 = z ? this.animatorTopViewVisibility.value ? 1.0f : 0.0f : this.animatorTopViewVisibility.floatValue;
        View view = this.topView;
        return ((view != null ? view.getMeasuredHeight() : 0) * f2) + f;
    }
    ...
    public void checkBirthdayHint() {
        ...
        if (MessagesController.getInstance(this.currentAccount).getMainSettings().getBoolean(Calendar.getInstance().get(1) + "bdayhint_" + this.parentFragment.getDialogId(), true)) {
            ...
            this.birthdayHint.setJointPx(1.0f, -((getWidth() - AndroidUtilities.dp(12.0f)) - ((this.giftButton.getMeasuredWidth() / 2.0f) + (this.giftButton.getX() + (this.attachLayout.getX() + this.messageEditTextContainer.getX())))));
            addView(this.birthdayHint, LayoutHelper.createFrame(-1, 200.0f, 48, 0.0f, -192.0f, 0.0f, 0.0f));
            this.birthdayHint.setOnHiddenListener(new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 12));
    ...
    public void checkUi_TopViewVisibility() {
        ...
        if (this.topView != null) {
            ...
            View view = this.topView;
            view.setTranslationY(measuredHeight - (view.getMeasuredHeight() * f));
            this.topView.setVisibility(f > 0.0f ? 0 : 8);
        }
        resizeForTopView(f > 0.0f);
    }
    ...
    private void createBotButton() {
        ...
        this.botButton.setBackground(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, -1));
        ...
        this.botButton.setOnClickListener(new ChatActivityEnterView$$ExternalSyntheticLambda7(this, 19));
    }
    ...
    private void createBotCommandsMenuButton() {
        ...
        botCommandsMenuView.setOnClickListener(new ChatActivityEnterView$$ExternalSyntheticLambda7(this, 2));
    ...
    private void createBotCommandsMenuContainer() {
        ...
        RecyclerListView recyclerListView = botCommandsMenuContainer.listView;
        getContext();
        recyclerListView.setLayoutManager(new LinearLayoutManager(1, false));
        RecyclerListView recyclerListView2 = this.botCommandsMenuContainer.listView;
        ...
        recyclerListView2.setAdapter(botCommandsAdapter);
    ...
    private void createExpandStickersButton() {
        ...
        this.expandStickersButton.setBackground(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, -1));
        this.sendButtonContainer.addView(this.expandStickersButton, LayoutHelper.createFrame(44, 44, 85));
        this.expandStickersButton.setOnClickListener(new ChatActivityEnterView$$ExternalSyntheticLambda7(this, 16));
    ...
    private void createGiftButton() {
        ...
        this.giftButton.setBackground(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, -1));
        this.attachLayout.addView(this.giftButton, 0, LayoutHelper.createFrame(44, 44, 21));
        this.giftButton.setOnClickListener(new ChatActivityEnterView$$ExternalSyntheticLambda7(this, 8));
    }
    ...
    private void createMessageEditText() {
        ...
        ChatActivityEditTextCaption chatActivityEditTextCaption = new ChatActivityEditTextCaption(getContext(), this.resourcesProvider) {
            ...
            public void onAttachedToWindow() {
                ...
                } else if (ChatActivityEnterView.this.parentFragment == null || ChatActivityEnterView.this.parentFragment.getParentLayout() == null || !((ActionBarLayout) ChatActivityEnterView.this.parentFragment.getParentLayout()).isSheet) {
                    setWindowView(ChatActivityEnterView.this.parentActivity.getWindow().getDecorView());
                } else {
                    setWindowView(((ActionBarLayout) ChatActivityEnterView.this.parentFragment.getParentLayout()).getWindow().getDecorView());
                }
            }
        ...
        this.messageEditText.setDelegate(new ChatActivityEnterView$$ExternalSyntheticLambda18(this));
        ChatActivity chatActivity = this.parentFragment;
        if (chatActivity == null || chatActivity.getParentLayout() == null || !((ActionBarLayout) this.parentFragment.getParentLayout()).isSheet) {
            this.messageEditText.setWindowView(this.parentActivity.getWindow().getDecorView());
        } else {
            this.messageEditText.setWindowView(((ActionBarLayout) this.parentFragment.getParentLayout()).getWindow().getDecorView());
        }
        ...
        this.richDraftPreview.setOnClickListener(new ChatActivityEnterView$$ExternalSyntheticLambda7(this, 11));
        ...
        if (arrayList != null) {
            ...
            int i4 = 0;
            while (i4 < size) {
                TextWatcher textWatcher = arrayList.get(i4);
                i4++;
    ...
    private void createRecordAudioPanel() {
        ...
        this.recordDeleteImageView.setBackgroundDrawable(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, -1));
        this.recordedAudioPanel.addView(this.recordDeleteImageView, LayoutHelper.createFrame(44, 44.0f));
        this.recordDeleteImageView.setOnClickListener(new ChatActivityEnterView$$ExternalSyntheticLambda7(this, 18));
    ...
    private void createRecordPanel() {
        ...
        this.recordPanel.setOnTouchListener(new ShareAlert$$ExternalSyntheticLambda19(17));
    ...
    private void createScheduledButton() {
        ...
        ImageView imageView = new ImageView(getContext()) {
            ...
            public void setTranslationX(float f) {
                ...
                ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
                super.setTranslationX((AndroidUtilities.dp((ChatActivityEnterView.this.botButton == null || ChatActivityEnterView.this.botButton.getVisibility() != 0) ? 0.0f : -44.0f) * (ChatActivityEnterView.this.botButton != null ? ChatActivityEnterView.this.botButton.getAlpha() : 0.0f)) + (AndroidUtilities.dp((ChatActivityEnterView.this.giftButton == null || ChatActivityEnterView.this.giftButton.getVisibility() != 0) ? 0.0f : -44.0f) * (ChatActivityEnterView.this.giftButton == null ? 0.0f : ChatActivityEnterView.this.giftButton.getAlpha())) + chatActivityEnterView.attachLayoutTranslationX + fDp + chatActivityEnterView.attachLayoutPaddingTranslationX);
            }
        };
        ...
        this.scheduledButton.setBackground(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, -1));
        this.messageEditTextContainer.addView(this.scheduledButton, 2, LayoutHelper.createFrame(44, 44, 85));
        this.scheduledButton.setOnClickListener(new ChatActivityEnterView$$ExternalSyntheticLambda7(this, 10));
    ...
    public void createSenderSelectView() {
        ...
        senderSelectView.setOnClickListener(new ChatActivityEnterView$$ExternalSyntheticLambda7(this, 1));
    ...
    public static void disableNewLines(EditText editText) {
        ChatActivityEnterView$$ExternalSyntheticLambda74 chatActivityEnterView$$ExternalSyntheticLambda74 = new ChatActivityEnterView$$ExternalSyntheticLambda74();
        InputFilter[] filters = editText.getFilters();
        if (filters == null) {
            editText.setFilters(new InputFilter[]{chatActivityEnterView$$ExternalSyntheticLambda74});
            return;
        }
        InputFilter[] inputFilterArr = (InputFilter[]) Arrays.copyOf(filters, filters.length + 1);
        inputFilterArr[filters.length] = chatActivityEnterView$$ExternalSyntheticLambda74;
    ...
    public boolean handleRichHtmlPaste() {
        ...
        try {
            ...
            if (primaryClip != null && primaryClip.getItemCount() >= 1 && primaryClip.getDescription() != null && primaryClip.getDescription().hasMimeType("text/html")) {
                ...
                HashMap map = new HashMap();
                ArrayList arrayList = RichHtml.parse(map, htmlText);
    ...
    private boolean isSlowModeIgnored() {
        return isInScheduleMode() || this.animatorEphemeralMessageVisibility.value;
    }

    public void lambda$animateScheduledTranslationX$16(ValueAnimator valueAnimator) {
        this.scheduledButton.setTranslationX(((Float) valueAnimator.getAnimatedValue()).floatValue());
    }

    public void lambda$animateSendButton$77(float f, float f2, float f3, float f4, float f5, float f6, ValueAnimator valueAnimator) {
    ...
    public void lambda$checkBirthdayHint$86() {
        removeView(this.birthdayHint);
    }

    public static void lambda$checkPremiumAnimatedEmoji$65(BaseFragment baseFragment) {
        if (baseFragment != null) {
    ...
    public void lambda$checkStickresExpandHeight$103() {
    ...
    public void lambda$checkStickresExpandHeight$104(ValueAnimator valueAnimator) {
        this.sizeNotifierLayout.invalidate();
    }

    public void lambda$checkStickresExpandHeight$105(ValueAnimator valueAnimator) {
        this.sizeNotifierLayout.invalidate();
    }

    public void lambda$createBotButton$22(View view) {
    ...
    public void lambda$createBotCommandsMenuButton$32(View view) {
        BotCommandsMenuView botCommandsMenuView = this.botCommandsMenuButton;
        boolean z = botCommandsMenuView.isOpened;
        botCommandsMenuView.setOpened(!z);
        try {
        ...
        if (hasBotWebView()) {
            ...
            if (!this.emojiViewVisible && !this.botKeyboardViewVisible) {
                ...
                AndroidUtilities.runOnUIThread(new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 14), 275L);
                hidePopup(false);
                return;
            }
        }
    ...
    public void lambda$createGiftButton$17(AlertDialog alertDialog, TLRPC.User user, boolean z, List list) {
        alertDialog.dismiss();
        GiftSheet giftSheet = new GiftSheet(getContext(), this.currentAccount, user.id, BoostRepository.filterGiftOptionsByBilling(BoostRepository.filterGiftOptions(1, list)), null);
        giftSheet.birthday = z;
        giftSheet.adapter.update(false);
        giftSheet.show();
    }

    public void lambda$createGiftButton$18(int i, DialogInterface dialogInterface) {
        this.parentFragment.getConnectionsManager().cancelRequest(i, true);
    }

    public void lambda$createGiftButton$19(View view) {
        ...
        final AlertDialog alertDialog = new AlertDialog(getContext(), 3, null);
        ...
        alertDialog.setOnCancelListener(new ChatActivityEnterView$$ExternalSyntheticLambda108(this, BoostRepository.loadGiftOptions(this.currentAccount, null, new Utilities.Callback() {
            @Override
            public final void run(Object obj) {
                this.f$0.lambda$createGiftButton$17(alertDialog, currentUser, z, (List) obj);
            }
        }), 0));
    }

    public void lambda$createMessageEditText$51() {
    ...
    public void lambda$createMessageEditText$52(View view) {
        openRichEditor();
    }

    public void lambda$createRecordAudioPanel$24(View view) {
    ...
    public static boolean lambda$createRecordPanel$70(View view, MotionEvent motionEvent) {
        return true;
    }

    public void lambda$createScheduledButton$15(View view) {
        ChatActivityEnterViewDelegate chatActivityEnterViewDelegate = this.delegate;
        if (chatActivityEnterViewDelegate != null) {
    ...
    public void lambda$createSenderSelectView$25() {
        this.senderSelectView.callOnClick();
    }

    public void lambda$createSenderSelectView$26() {
        this.senderSelectView.callOnClick();
    }

    public void lambda$createSenderSelectView$27(final Dialog dialog, SimpleAvatarView simpleAvatarView, float f, float f2, DynamicAnimation dynamicAnimation, boolean z, float f3, float f4) {
        if (dialog.isShowing()) {
            ...
            this.senderSelectView.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                ...
                public boolean onPreDraw() {
                    ...
                    senderSelectView.postDelayed(new ShareAlert$23$$ExternalSyntheticLambda0(dialog2, 28), 100L);
                    return true;
                }
            });
        }
    ...
    public void lambda$createSenderSelectView$28(final Dialog dialog, SimpleAvatarView simpleAvatarView, float f, float f2, DynamicAnimation dynamicAnimation, boolean z, float f3, float f4) {
        if (dialog.isShowing()) {
            simpleAvatarView.setTranslationX(f);
            simpleAvatarView.setTranslationY(f2);
            this.senderSelectView.setProgress(0.0f, false);
    ...
    public void lambda$createSenderSelectView$29(final SimpleAvatarView simpleAvatarView, int[] iArr, SenderSelectPopup.SenderView senderView) {
        ...
        if (i >= 23) {
            this.popupX = getRootWindowInsets().getSystemWindowInsetLeft() + this.popupX;
        }
        ...
        simpleAvatarView.getViewTreeObserver().addOnDrawListener(new AnonymousClass38(simpleAvatarView, senderView));
        dialog.show();
        if (!this.isLiveComment) {
            this.senderSelectView.setScaleX(1.0f);
            this.senderSelectView.setScaleY(1.0f);
        ...
        boolean z = this.isLiveComment;
        DynamicAnimation.AnonymousClass1 anonymousClass1 = DynamicAnimation.SCALE_X;
        SpringAnimation springAnimationM = z ? null : ChatActivity$21$$ExternalSyntheticOutline0.m(0.5f, 750.0f, 1.0f, new SpringAnimation(this.senderSelectView, anonymousClass1));
        boolean z2 = this.isLiveComment;
        DynamicAnimation.AnonymousClass1 anonymousClass2 = DynamicAnimation.SCALE_Y;
        SpringAnimation springAnimationM2 = z2 ? null : ChatActivity$21$$ExternalSyntheticOutline0.m(0.5f, 750.0f, 1.0f, new SpringAnimation(this.senderSelectView, anonymousClass2));
        SpringAnimation springAnimationM3 = ChatActivity$21$$ExternalSyntheticOutline0.m(0.0f, 750.0f, 1.0f, new SpringAnimation(this.senderSelectView, DynamicAnimation.ALPHA));
        final int i2 = 0;
        springAnimationM3.addEndListener(new DynamicAnimation.OnAnimationEndListener(this) {
            ...
            public final void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z3, float f4, float f5) {
                switch (i2) {
                    case 0:
                        this.f$0.lambda$createSenderSelectView$27(dialog, simpleAvatarView, f, f2, dynamicAnimation, z3, f4, f5);
                        break;
                    default:
                        this.f$0.lambda$createSenderSelectView$28(dialog, simpleAvatarView, f, f2, dynamicAnimation, z3, f4, f5);
                        break;
                }
            }
        });
        SpringAnimation springAnimation = new SpringAnimation(simpleAvatarView, DynamicAnimation.TRANSLATION_X);
        springAnimation.mValue = MathUtils.clamp(fDp2, f - AndroidUtilities.dp(6.0f), fDp2);
        springAnimation.mStartValueIsSet = true;
        SpringAnimation springAnimationM4 = ChatActivity$21$$ExternalSyntheticOutline0.m(f, 700.0f, 0.75f, springAnimation);
        springAnimationM4.mMinValue = f - AndroidUtilities.dp(6.0f);
        SpringAnimation springAnimation2 = new SpringAnimation(simpleAvatarView, DynamicAnimation.TRANSLATION_Y);
        springAnimation2.mValue = MathUtils.clamp(f3, f3, AndroidUtilities.dp(6.0f) + f2);
        springAnimation2.mStartValueIsSet = true;
        SpringAnimation springAnimationM5 = ChatActivity$21$$ExternalSyntheticOutline0.m(f2, 700.0f, 0.75f, springAnimation2);
        springAnimationM5.mMaxValue = AndroidUtilities.dp(6.0f) + f2;
        springAnimationM5.addUpdateListener(new DynamicAnimation.OnAnimationUpdateListener() {
        ...
        final int i3 = 1;
        springAnimationM5.addEndListener(new DynamicAnimation.OnAnimationEndListener(this) {
            public final ChatActivityEnterView f$0;
        ...
        senderSelectPopup.startDismissAnimation(springAnimationM, springAnimationM2, springAnimationM3, springAnimationM4, springAnimationM5, ChatActivity$21$$ExternalSyntheticOutline0.m(scaleX, 1000.0f, 1.0f, new SpringAnimation(simpleAvatarView, anonymousClass1)), ChatActivity$21$$ExternalSyntheticOutline0.m(scaleX, 1000.0f, 1.0f, new SpringAnimation(simpleAvatarView, anonymousClass2)));
    }

    public void lambda$createSenderSelectView$30(TLRPC.ChatFull chatFull, MessagesController messagesController, RecyclerView recyclerView, SenderSelectPopup.SenderView senderView, TLRPC.Peer peer) {
        TLRPC.User user;
        if (this.senderSelectPopupWindow == null) {
            return;
        }
        ...
        AndroidUtilities.runOnUIThread(new ShareAlert$$ExternalSyntheticLambda1(8, this, simpleAvatarView, iArr, senderView), zIsSelected ? 0L : 200L);
    }

    public void lambda$createSenderSelectView$31(View view) {
        TLRPC.ChatFull chatFull;
        int i;
        int iDp;
        ChatActivity chatActivity;
        if (!this.isLiveComment ? getTranslationY() == 0.0f : !isPopupShowing()) {
            this.onEmojiSearchClosed = new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 6);
            if (this.isLiveComment) {
        ...
        if (this.delegate.measureKeyboardHeight() > AndroidUtilities.dp(20.0f)) {
            ...
            if (contentViewHeight < AndroidUtilities.dp(200.0f)) {
                this.onKeyboardClosed = new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 7);
                closeKeyboard();
                return;
            }
        }
        if (this.delegate.getSendAsPeers() != null) {
            ...
            if (this.isLiveComment) {
                ...
                ((ActionBarLayout) this.parentFragment.getParentLayout()).getOverlayContainerView();
            }
            SenderSelectPopup senderSelectPopup2 = new SenderSelectPopup(getContext(), this.parentFragment, messagesController, zIsChannelAndNotMegaGroup, peer, this.delegate.getSendAsPeers(), new AlertsCreator$$ExternalSyntheticLambda201(this, chatFull, messagesController, 5), this.resourcesProvider) {
                @Override
                public void dismiss() {
    ...
    public void lambda$createSuggestionButton$20(View view) {
    ...
    public void lambda$didPressedBotButton$91(Runnable runnable, long j) {
        runnable.run();
        SharedPrefsHelper.setWebViewConfirmShown(this.currentAccount, j, true);
    }

    public void lambda$didPressedBotButton$92(MessageObject messageObject, TL_keyboard.KeyboardButtonProto keyboardButtonProto, AlertDialog alertDialog, int i) {
        if (Build.VERSION.SDK_INT < 23 || this.parentActivity.checkSelfPermission("android.permission.ACCESS_COARSE_LOCATION") == 0) {
            SendMessagesHelper.getInstance(this.currentAccount).sendCurrentLocation(messageObject, keyboardButtonProto);
            return;
        }
        ...
        this.pendingLocationButton = keyboardButtonProto;
    }

    public boolean lambda$didPressedBotButton$93(MessageObject messageObject, TL_keyboard.TL_inlineButtonTypeSwitchInline tL_inlineButtonTypeSwitchInline, DialogsActivity dialogsActivity, ArrayList arrayList, CharSequence charSequence, boolean z, boolean z2, int i, int i2, TopicsFragment topicsFragment) {
        ...
        MediaDataController.getInstance(this.currentAccount).saveDraft(j3, 0, "@" + UserObject.getPublicUsername(user) + " " + tL_inlineButtonTypeSwitchInline.query, null, null, true, 0L);
    ...
    public void lambda$didPressedBotButton$94(MessageObject messageObject, TL_keyboard.TL_buttonTypeRequestPeer tL_buttonTypeRequestPeer, TLRPC.User user, TLRPC.User user2) {
        if (user2 != null) {
            ...
            AnonymousClass77 anonymousClass77 = new AnonymousClass77(bundle, user2, user, j);
            ChatActivity chatActivity = this.parentFragment;
            if (chatActivity != null) {
    ...
    public void lambda$didPressedBotButton$95(MessageObject messageObject, TL_keyboard.TL_buttonTypeRequestPeer tL_buttonTypeRequestPeer, List list) {
    ...
    public boolean lambda$didPressedBotButton$96(MessageObject messageObject, TL_keyboard.TL_buttonTypeRequestPeer tL_buttonTypeRequestPeer, DialogsActivity dialogsActivity, ArrayList arrayList, CharSequence charSequence, boolean z, boolean z2, int i, int i2, TopicsFragment topicsFragment) {
    ...
    public void lambda$doneEditingMessage$68() {
    ...
    public void lambda$new$1(View view) {
        ...
        if (adjustPanLayoutHelper == null || !adjustPanLayoutHelper.animationInProgress()) {
            ...
            AndroidUtilities.runOnUIThread(new ChatActivityEnterView$$ExternalSyntheticLambda88(this, 2), 200L);
        }
    }
    ...
    public void lambda$new$12(View view) {
        ...
        if (this.streamingState != BotForumHelper.SteamingSendButtonState.STOP || (chatActivityEnterViewDelegate = this.delegate) == null) {
            return;
        }
    ...
    public boolean lambda$new$14(View view) {
        EditTextCaption editTextCaption = this.messageEditText;
    ...
    public void lambda$new$3(Theme.ResourcesProvider resourcesProvider, View view) {
        new AlertDialog.Builder(getContext(), 0, resourcesProvider).setTitle(LocaleController.getString(R.string.ArticleDeleteDraftTitle)).setMessage(LocaleController.getString(R.string.ArticleDeleteDraftMessage)).setNegativeButton(LocaleController.getString(R.string.Cancel), null).setPositiveButton(LocaleController.getString(R.string.Delete), new ChatActivityEnterView$$ExternalSyntheticLambda18(this)).makeRed(-1).show();
    }
    ...
    public void lambda$new$5(long j, Theme.ResourcesProvider resourcesProvider, TL_iv.RichMessage richMessage, Integer num, Integer num2, Boolean bool) {
    ...
    public void lambda$new$6(CharSequence charSequence) {
        this.messageEditText.setText(charSequence);
        this.messageEditText.setSelection(charSequence.length(), charSequence.length());
    }

    public void lambda$new$7(long j, Theme.ResourcesProvider resourcesProvider, CharSequence charSequence, Integer num, Integer num2, Boolean bool) {
        this.messageEditText.setText(charSequence);
    ...
    public void lambda$new$8(final Theme.ResourcesProvider resourcesProvider, View view) {
        ...
        if (this.richDraftActive) {
            if (this.richDraftMessage == null) {
                return;
            }
            final int i = 0;
            new AIEditorAlert(getContext(), resourcesProvider).setText(this.richDraftMessage).setOnUseRich(new ChatActivityEnterView$$ExternalSyntheticLambda55(this, 0)).setOnSendRich(dialogId, new Utilities.Callback4(this) {
                public final ChatActivityEnterView f$0;
                ...
                public final void run(Object obj, Object obj2, Object obj3, Object obj4) {
                    switch (i) {
                        case 0:
                            this.f$0.lambda$new$5(dialogId, resourcesProvider, (TL_iv.RichMessage) obj, (Integer) obj2, (Integer) obj3, (Boolean) obj4);
                            break;
                        default:
                            this.f$0.lambda$new$7(dialogId, resourcesProvider, (CharSequence) obj, (Integer) obj2, (Integer) obj3, (Boolean) obj4);
                            break;
                    }
                }
            }).show();
        ...
        final int i2 = 1;
        new AIEditorAlert(getContext(), resourcesProvider).setText(this.messageEditText.getText()).setOnUse(new ChatActivityEnterView$$ExternalSyntheticLambda55(this, 1)).setOnSend(dialogId, this.editingMessageObject != null, new Utilities.Callback4(this) {
            public final ChatActivityEnterView f$0;
    ...
    public void lambda$onSendLongClick$39(KeyEvent keyEvent) {
    ...
    public void lambda$onSendLongClick$40(View view) {
    ...
    public void lambda$onSendLongClick$41(View view) {
        ActionBarPopupWindow actionBarPopupWindow = this.sendPopupWindow;
        if (actionBarPopupWindow != null && actionBarPopupWindow.isShowing()) {
            this.sendPopupWindow.dismiss();
        }
    ...
    public void lambda$onSendLongClick$42(View view) {
        ActionBarPopupWindow actionBarPopupWindow = this.sendPopupWindow;
        if (actionBarPopupWindow != null && actionBarPopupWindow.isShowing()) {
            this.sendPopupWindow.dismiss();
        }
    ...
    public void lambda$onSendLongClick$43(DialogInterface dialogInterface) {
        this.messageSendPreview = null;
    }

    public void lambda$onSendLongClick$44(Canvas canvas) {
        drawBackground(canvas, false);
    }

    public void lambda$onSendLongClick$45(boolean z, View view) {
    ...
    public void lambda$onSendLongClick$46() {
        AlertsCreator.createScheduleDatePickerDialog(this.parentActivity, this.parentFragment.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() {
            @Override
            public void didSelectDate(boolean z, int i, int i2) {
                ChatActivityEnterView.this.sendMessageInternal(z, i, i2, 0L, true);
    ...
    public void lambda$onSendLongClick$48() {
        ChatActivityEnterViewDelegate chatActivityEnterViewDelegate = this.delegate;
        if (chatActivityEnterViewDelegate != null) {
    ...
    public void lambda$onSendLongClick$49() {
        ...
        AndroidUtilities.runOnUIThread(new ChatActivityEnterView$$ExternalSyntheticLambda88(this, 4), 600L);
    }

    public void lambda$onSendLongClick$50(boolean z) {
        MessageSendPreview messageSendPreview;
        this.sentFromPreview = System.currentTimeMillis();
    ...
    public void lambda$onStickerSelected$98(TLRPC.Document document, String str, MessageObject.SendAnimationData sendAnimationData, boolean z, int i, int i2, Object obj, Long l, boolean z2) {
    ...
    public void lambda$onStickerSelected$99(TLRPC.Document document, String str, MessageObject.SendAnimationData sendAnimationData, boolean z, int i, int i2, Object obj, boolean z2, Long l) {
        ChatActivityEnterView$$ExternalSyntheticLambda38 chatActivityEnterView$$ExternalSyntheticLambda38 = new ChatActivityEnterView$$ExternalSyntheticLambda38(i, i2, l, obj, str, sendAnimationData, document, this, z, z2);
        if (showConfirmAlert(chatActivityEnterView$$ExternalSyntheticLambda38)) {
            return;
        }
        chatActivityEnterView$$ExternalSyntheticLambda38.run();
    }

    public void lambda$openRichEditor$79() {
        EditTextCaption editTextCaption = this.messageEditText;
        if (editTextCaption != null) {
            editTextCaption.setText("");
        }
    ...
    public void lambda$openRichEditor$80() {
        EditTextCaption editTextCaption = this.messageEditText;
        if (editTextCaption != null) {
            editTextCaption.setText("");
        }
    ...
    public void lambda$openRichEditorWithHtml$81() {
        EditTextCaption editTextCaption = this.messageEditText;
        if (editTextCaption != null) {
            editTextCaption.setText("");
        }
    ...
    public void lambda$openRichEditorWithHtml$82() {
        EditTextCaption editTextCaption = this.messageEditText;
        if (editTextCaption != null) {
            editTextCaption.setText("");
        }
    ...
    public void lambda$openRichEditorWithoutFormatting$83() {
        EditTextCaption editTextCaption = this.messageEditText;
        if (editTextCaption != null) {
            editTextCaption.setText("");
        }
    ...
    public void lambda$openRichEditorWithoutFormatting$84() {
        EditTextCaption editTextCaption = this.messageEditText;
        if (editTextCaption != null) {
            editTextCaption.setText("");
        }
    ...
    public void lambda$openWebViewMenu$33() {
        BotCommandsMenuView botCommandsMenuView = this.botCommandsMenuButton;
        if (botCommandsMenuView != null) {
    ...
    public void lambda$openWebViewMenu$34() {
        AndroidUtilities.runOnUIThread(new ChatActivityEnterView$$ExternalSyntheticLambda88(this, 1));
    }

    public void lambda$openWebViewMenu$35() {
        AndroidUtilities.hideKeyboard(this);
        ...
        if (LinkManager.isWebAppLink(this.botMenuWebViewUrl)) {
            ...
            progress.onEnd(new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 21));
        ...
        botWebViewSheet.parentActivity = this.parentActivity;
    ...
    public void lambda$openWebViewMenu$36(Runnable runnable) {
        runnable.run();
        SharedPrefsHelper.setWebViewConfirmShown(this.currentAccount, this.dialog_id, true);
    }

    public void lambda$openWebViewMenu$37() {
    ...
    public void lambda$saveBusinessLink$67() {
        BulletinFactory.of(this.parentFragment).createSuccessBulletin(LocaleController.getString(R.string.BusinessLinkSaved)).show();
    }

    public void lambda$sendMessage$58() {
        ChatActivity chatActivity = this.parentFragment;
        if (chatActivity != null) {
            chatActivity.showDialog(new PremiumFeatureBottomSheet((BaseFragment) this.parentFragment, 43, true));
        }
    }

    public void lambda$sendMessageInternal$59(boolean z, int i, int i2, long j) {
        sendMessageInternal(z, i, i2, j, false);
    }

    public void lambda$sendMessageInternal$60() {
        RecordCircle recordCircle = this.recordCircle;
        if (recordCircle != null) {
    ...
    public void lambda$sendMessageInternal$61() {
        RecordCircle recordCircle = this.recordCircle;
        if (recordCircle != null) {
            recordCircle.setSendButtonInvisible();
        }
    ...
    public void lambda$sendMessageInternal$62(CharSequence charSequence, boolean z, int i, int i2, long j) {
    ...
    private void lambda$sendMessageInternal$63(boolean z, boolean z2, int i, int i2, long j) {
        ChatActivityEnterView chatActivityEnterView;
        ChatActivityEnterViewDelegate chatActivityEnterViewDelegate;
        ...
        if (z2 && showConfirmAlert(new MessagesController$$ExternalSyntheticLambda527(this, z, i, i2, j))) {
            return;
        }
        ...
        if (this.videoToSendMessageObject != null) {
            ...
            checkSendButton(true);
            AndroidUtilities.runOnUIThread(new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 3), 100L);
        ...
        if (this.audioToSend == null) {
            ...
            if (chatActivity2 != null && (currentChat = chatActivity2.getCurrentChat()) != null && currentChat.slowmode_enabled && !ChatObject.hasAdminRights(currentChat)) {
                if (textToUse.length() > this.accountInstance.getMessagesController().getMaxMessageLength()) {
            ...
            CharSequence charSequence = textToUse;
            if (checkPremiumAnimatedEmoji(this.currentAccount, this.dialog_id, this.parentFragment, null, charSequence)) {
                return;
            }
            if (processSendingText(charSequence, z, i, i2, j)) {
                if (this.delegate.hasForwardingMessages() || (!(i == 0 || isInScheduleMode()) || isInScheduleMode())) {
                    ...
                    if (chatActivityEnterViewDelegate3 != null) {
                        chatActivityEnterViewDelegate3.onMessageSend(charSequence, z, i, i2, j);
                    }
                } else {
                    this.messageTransitionIsRunning = false;
                    MessagesStorage$$ExternalSyntheticLambda169 messagesStorage$$ExternalSyntheticLambda169 = new MessagesStorage$$ExternalSyntheticLambda169(this, charSequence, z, i, i2, j);
                    chatActivityEnterView = this;
                    chatActivityEnterView.moveToSendStateRunnable = messagesStorage$$ExternalSyntheticLambda169;
                    AndroidUtilities.runOnUIThread(messagesStorage$$ExternalSyntheticLambda169, 200L);
                }
        ...
        if (recordedAudioPlayerView != null && recordedAudioPlayerView.needsCut()) {
            ...
            String strM = MediaSessionConnector$DefaultMediaMetadataProvider$$ExternalSyntheticOutline0.m(new StringBuilder(), this.audioToSendPath, ".ogg");
            if (MediaController.cropOpusFile(this.audioToSendPath, strM, this.audioTimelineView.getAudioLeftMs(), this.audioTimelineView.getAudioRightMs())) {
                try {
                ...
                try {
                    new File(strM).renameTo(new File(this.audioToSendPath));
                } catch (Exception e2) {
                    FileLog.e(e2);
                }
                for (int i3 = 0; i3 < this.audioToSend.attributes.size(); i3++) {
        ...
        ChatActivity chatActivity4 = this.parentFragment;
        sendMessageParamsOf.sendMessageChatArguments = chatActivity4 != null ? chatActivity4.getMessageChatSendParams() : null;
        ...
        if (chatActivityEnterViewDelegate4 != null) {
            chatActivityEnterViewDelegate4.onMessageSend(null, z, i, i2, j);
        }
        hideRecordedAudioPanel(true);
        checkSendButton(true);
        AndroidUtilities.runOnUIThread(new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 4), 100L);
        this.millisecondsRecorded = 0L;
    }

    public void lambda$sendMessageInternal$64(boolean z, int i, int i2, Long l) {
        sendMessageInternal(z, i, i2, l.longValue(), false);
    }

    public void lambda$setButtons$90(TL_keyboard.KeyboardButton keyboardButton) {
        MessageObject messageObject;
        ChatActivity chatActivity;
    ...
    public void lambda$setEditingBusinessLink$71(View view) {
        saveBusinessLink();
    }

    public void lambda$setEditingMessageObject$72(View view) {
        doneEditingMessage();
    }

    public void lambda$setEditingMessageObject$73(ArrayList arrayList, MessagePreviewView.ToggleButton toggleButton, MessageSendPreview messageSendPreview, View view) {
    ...
    public void lambda$setEditingMessageObject$74(MessageObject.GroupedMessages groupedMessages, MessageObject messageObject, MessageSendPreview messageSendPreview, View view) {
    ...
    public boolean lambda$setEditingMessageObject$75(MessageObject messageObject, MessageObject.GroupedMessages groupedMessages, View view) {
        EditTextCaption editTextCaption;
        int i;
        if (messageObject.isMediaEmpty() || (editTextCaption = this.messageEditText) == null || TextUtils.isEmpty(editTextCaption.getTextToUse()) || ((groupedMessages != null && (!groupedMessages.hasCaption || groupedMessages.isDocuments)) || ((i = messageObject.type) != 1 && i != 3 && i != 8))) {
            return false;
        }
        MessageSendPreview messageSendPreview = new MessageSendPreview(getContext(), this.resourcesProvider);
        ...
        MessagePreviewView.ToggleButton toggleButton = new MessagePreviewView.ToggleButton(getContext(), R.raw.position_below, LocaleController.getString(R.string.CaptionAbove), R.raw.position_above, LocaleController.getString(R.string.CaptionBelow), this.resourcesProvider);
        toggleButton.setState(!this.captionAbove, false);
        toggleButton.setOnClickListener(new LinkActionView$$ExternalSyntheticLambda4(this, arrayList, toggleButton, messageSendPreview, 2));
        ...
        messageSendPreview.setSendButton(this.doneButton, false, new LinkActionView$$ExternalSyntheticLambda4(this, groupedMessages, messageObject, messageSendPreview, 3));
        messageSendPreview.show();
        return true;
    }

    public void lambda$setEditingMessageObject$76(CharSequence charSequence) {
        setFieldText(charSequence);
        this.setTextFieldRunnable = null;
    }

    public void lambda$setFieldFocused$78() {
        boolean z;
        EditTextCaption editTextCaption;
        ViewGroup view = null;
        ...
        if (AndroidUtilities.isTablet()) {
            ...
            if (activity instanceof LaunchActivity) {
                ...
                if (launchActivity != null && launchActivity.getLayersActionBarLayout() != null) {
                    view = ((ActionBarLayout) launchActivity.getLayersActionBarLayout()).getView();
                }
    ...
    public void lambda$setSearchingTypeInternal$102(ValueAnimator valueAnimator) {
    ...
    public void lambda$setStickersExpanded$106(int i, ValueAnimator valueAnimator) {
        this.stickersExpansionProgress = Math.abs(getTranslationY() / (-(this.stickersExpandedHeight - i)));
        this.sizeNotifierLayout.invalidate();
    }

    public void lambda$setStickersExpanded$107(int i, ValueAnimator valueAnimator) {
        this.stickersExpansionProgress = getTranslationY() / (-(this.stickersExpandedHeight - i));
        this.sizeNotifierLayout.invalidate();
    }

    public void lambda$setSuggestionButtonVisible$21(ValueAnimator valueAnimator) {
        float fFloatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
    ...
    public void lambda$showAiButton$53(boolean z) {
        if (z) {
            return;
        }
    ...
    public void lambda$showAiButton$54(HintView2 hintView2) {
        removeView(hintView2);
    }

    public void lambda$showCaptionLimitBulletin$66() {
        ChatActivity chatActivity = this.parentFragment;
        if (chatActivity != null) {
    ...
    public void lambda$showPopup$100() {
        ChatActivityEnterViewDelegate chatActivityEnterViewDelegate = this.delegate;
        if (chatActivityEnterViewDelegate != null) {
    ...
    public void lambda$showPopup$101(int i) {
        if (i == 0) {
            this.emojiPadding = 0;
        }
    ...
    public void lambda$showRichButton$55(boolean z) {
        if (z) {
            return;
        }
    ...
    public void lambda$showSendSuggestionHint$87() {
        AndroidUtilities.removeFromParent(this.sendSuggestHintView);
    }

    public void lambda$showTopView$56() {
        showTopView(true, false, true);
        this.showTopViewRunnable = null;
    }

    public void lambda$updateBotButton$89(ValueAnimator valueAnimator) {
    ...
    public void lambda$updateGiftButton$85(ValueAnimator valueAnimator) {
        ImageView imageView = this.scheduledButton;
        if (imageView != null) {
            imageView.setTranslationX(imageView.getTranslationX());
        }
    ...
    public void lambda$updateRecordInterface$69(ValueAnimator valueAnimator) {
    ...
    public void lambda$updateSendAsButton$88(float f, float f2, float f3, float f4, ValueAnimator valueAnimator) {
        float fFloatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        float fM = DiffUtil.m(f2, f, fFloatValue, f);
        SenderSelectView senderSelectView = this.senderSelectView;
        if (senderSelectView != null) {
            senderSelectView.setAlpha(((f4 - f3) * fFloatValue) + f3);
            this.senderSelectView.setTranslationX(fM);
        }
        this.emojiButton.setTranslationX(fM);
        this.messageTextTranslationX = fM;
        updateMessageTextParams();
    }
    ...
    public boolean onSendLongClick(View view) {
        ...
        int i2 = 2;
        int i3 = 1;
        if (!isInScheduleMode() && (((chatActivity = this.parentFragment) == null || chatActivity.getChatMode() != 5) && !this.animatorEphemeralMessageVisibility.value)) {
            if (this.isStories || !(((editTextCaption = this.messageEditText) != null && !TextUtils.isEmpty(editTextCaption.getText())) || (chatActivity2 = this.parentFragment) == null || (messagePreviewParams = chatActivity2.messagePreviewParams) == null || (messages = messagePreviewParams.forwardMessages) == null || (arrayList = messages.messages) == null || arrayList.isEmpty())) {
                ...
                boolean z4 = chatActivity6 != null && UserObject.isUserSelf(chatActivity6.getCurrentUser());
                if (this.sendPopupLayout == null) {
                    ...
                    this.sendPopupLayout.setDispatchKeyEventListener(new ChatActivityEnterView$$ExternalSyntheticLambda18(this));
                    this.sendPopupLayout.setShownFromBottom(false);
                    ChatActivity chatActivity7 = this.parentFragment;
                    boolean z5 = chatActivity7 != null && chatActivity7.canScheduleMessage();
                    boolean z6 = !z4 && (this.slowModeTimer <= 0 || isInScheduleMode());
                    if (z5) {
                        boolean z7 = !z6;
                        ActionBarMenuSubItem actionBarMenuSubItem = new ActionBarMenuSubItem(0, getContext(), this.resourcesProvider, true, z7);
                        ...
                        this.actionScheduleButton.setOnClickListener(new ChatActivityEnterView$$ExternalSyntheticLambda7(this, 14));
                        ...
                        if (!z4 && this.dialog_id > 0) {
                            ActionBarMenuSubItem actionBarMenuSubItem2 = new ActionBarMenuSubItem(0, getContext(), this.resourcesProvider, true, z7);
                            ...
                            this.sendWhenOnlineButton.setOnClickListener(new ChatActivityEnterView$$ExternalSyntheticLambda7(this, 12));
                            this.sendPopupLayout.addView((View) this.sendWhenOnlineButton, LayoutHelper.createLinear(-1, 44));
                        }
                    }
                    if (z6) {
                        ActionBarMenuSubItem actionBarMenuSubItem3 = new ActionBarMenuSubItem(0, getContext(), this.resourcesProvider, !z5, true);
                        ...
                        actionBarMenuSubItem3.setOnClickListener(new ChatActivityEnterView$$ExternalSyntheticLambda7(this, 13));
                    ...
                    int i4 = -2;
                    ActionBarPopupWindow actionBarPopupWindow = new ActionBarPopupWindow(this.sendPopupLayout, i4, i4) {
                        @Override
                        public void dismiss() {
                            dismiss(true);
                ...
                if (this.keyboardVisible) {
                    ...
                    if (measuredHeight2 > AndroidUtilities.dp((view2 == null || view2.getVisibility() != 0) ? 58.0f : 102.0f)) {
                        measuredHeight = view.getMeasuredHeight() + this.location[1];
                    } else {
                ...
                this.sendPopupWindow.showAtLocation(view, 51, AndroidUtilities.dp(8.0f) + ((view.getMeasuredWidth() + this.location[0]) - this.sendPopupLayout.getMeasuredWidth()), measuredHeight);
            ...
            messageSendPreview2.setOnDismissListener(new SearchTagsList$$ExternalSyntheticLambda5(this, i2));
            boolean z8 = (this.audioToSendMessageObject == null && ((editTextCaption2 = this.messageEditText) == null || TextUtils.isEmpty(editTextCaption2.getText()))) ? false : true;
            ...
            try {
                if (this.richDraftMessage != null) {
                    ...
                    if (!z8) {
                        ...
                        if (chatActivity9 != null && (instantCameraView = chatActivity9.instantCameraView) != null && instantCameraView.getTextureView() != null) {
                        ...
                        if (z8 && this.audioToSend == null) {
                            this.messageSendPreview.setEditText(this.messageEditText, new EmojiView$$ExternalSyntheticLambda18(this, 7), new ChatActivityEnterView$$ExternalSyntheticLambda55(this, i2));
                        }
                        this.messageSendPreview.setSendButton(this.sendButton, true, new PipVideoOverlay$$ExternalSyntheticLambda5(this, z8, i3));
                        if ((z8 || z) && this.dialog_id >= 0) {
                        ...
                        if (z3) {
                            ...
                            itemOptionsMakeOptions.add(i5, LocaleController.getString(i), new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 22));
                            if (!z2 && this.dialog_id > 0) {
                                itemOptionsMakeOptions.add(R.drawable.msg_online, LocaleController.getString(R.string.SendWhenOnline), new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 23));
                        ...
                        if (chatActivity5 != null && this.delegate != null && ChatObject.isMonoForum(chatActivity5.getCurrentChat())) {
                            itemOptionsMakeOptions.add(R.drawable.input_suggest_paid_24, LocaleController.getString(R.string.PostSuggestionsSendWithOffer), new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 24));
                        }
                        if (i3 != 0) {
                            itemOptionsMakeOptions.add(R.drawable.input_notify_off, LocaleController.getString(R.string.SendWithoutSound), new ChatActivityEnterView$$ExternalSyntheticLambda23(this, i2, z8));
                        }
                        itemOptionsMakeOptions.setupSelectors();
                        if (this.sendWhenOnlineButton != null) {
                            ChatActivity chatActivity10 = this.parentFragment;
                            currentUser = chatActivity10 != null ? chatActivity10.getCurrentUser() : null;
                    ...
                    if (this.messageWebPage != null) {
                        ...
                        if (chatActivity11 != null && (messagePreviewParams2 = chatActivity11.messagePreviewParams) != null && messagePreviewParams2.hasMedia) {
                            ...
                            tL_messageMediaWebPage.force_small_media = z9;
                            tL_messageMediaWebPage.force_large_media = !z9;
            ...
            if (z3) {
                ...
                itemOptionsMakeOptions.add(i6, LocaleController.getString(i), new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 22));
                if (!z2) {
                    itemOptionsMakeOptions.add(R.drawable.msg_online, LocaleController.getString(R.string.SendWhenOnline), new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 23));
                    this.sendWhenOnlineButton = itemOptionsMakeOptions.getLast();
                }
    ...
    private void onWindowSizeChanged() {
        ...
        if (this.topView != null) {
            if (height < ActionBar.getCurrentActionBarHeight() + AndroidUtilities.dp(72.0f)) {
    ...
    public void openRichEditorWithoutFormatting() {
        ...
        richEditor.animateEnterView = chatActivity.getChatActivityEnterView();
        richEditor.onClearedCallback = new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 0);
        richEditor.onSentCallback = new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 15);
        this.parentFragment.presentFragment(richEditor);
    }

    public void openWebViewMenu() {
        createBotWebViewMenuContainer();
        ChatActivityEnterView$$ExternalSyntheticLambda3 chatActivityEnterView$$ExternalSyntheticLambda3 = new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 26);
        if (SharedPrefsHelper.isWebViewConfirmShown(this.currentAccount, this.dialog_id) || MessagesController.getInstance(this.currentAccount).whitelistedBots.contains(Long.valueOf(this.dialog_id))) {
            ...
            AlertsCreator.createBotLaunchAlert(this.parentFragment, MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(this.dialog_id)), new FilterGLThread$$ExternalSyntheticLambda7(4, this, chatActivityEnterView$$ExternalSyntheticLambda3), new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 27));
        }
    }
    ...
    private void resetRecordedState() {
        ...
        if (this.audioToSendPath != null) {
            if (BuildVars.LOGS_ENABLED) {
                SQLitePreparedStatement$$ExternalSyntheticOutline0.m(this.audioToSendPath, new StringBuilder("delete file "));
            }
            new File(this.audioToSendPath).delete();
        }
    ...
    private void saveBusinessLink() {
        if (isEditingBusinessLink()) {
            ...
            String str = this.editingBusinessLink.link;
            String str2 = businessLinkPresetMessageCalculateBusinessLinkPresetMessage.text;
            ArrayList<TLRPC.MessageEntity> arrayList = businessLinkPresetMessageCalculateBusinessLinkPresetMessage.entities;
            ChatActivityEnterView$$ExternalSyntheticLambda3 chatActivityEnterView$$ExternalSyntheticLambda3 = new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 17);
            ...
            businessLinksController.editLink(tL_businessChatLinkFindLink, tL_inputBusinessChatLink, chatActivityEnterView$$ExternalSyntheticLambda3);
        }
    }
        ...
        if (!z || this.currentPopupContentType != 0) {
            ...
            if (i == 0 || !(this.allowStickers || this.allowGifs)) {
                ...
                if (editTextCaption == null || TextUtils.isEmpty(editTextCaption.getText())) {
                    state = i == 1 ? ChatActivityEnterViewAnimatedIconView.State.STICKER : ChatActivityEnterViewAnimatedIconView.State.GIF;
                } else {
                    state = ChatActivityEnterViewAnimatedIconView.State.SMILE;
                }
            }
    ...
    public void setSearchingTypeInternal(int i, boolean z) {
        ...
        if (z2 != (this.searchingType != 0)) {
            ...
            if (z) {
                ...
                valueAnimatorOfFloat.addUpdateListener(new ChatActivityEnterView$$ExternalSyntheticLambda5(this, 7));
    ...
    public void showAiButton(boolean z) {
        ...
        this.aiButton.animate().alpha(z2 ? 1.0f : 0.0f).scaleX(z2 ? 1.0f : 0.6f).scaleY(z2 ? 1.0f : 0.6f).setInterpolator(CubicBezierInterpolator.EASE_OUT_QUINT).setDuration(420L).withEndAction(new ChatActivityEnterView$$ExternalSyntheticLambda23(this, 0, z2)).start();
        if (!z2) {
        ...
        if (MessagesController.getGlobalMainSettings().getInt("aihintshown", 0) < 3) {
            ...
            this.aiHint.setOnHiddenListener(new FilterGLThread$$ExternalSyntheticLambda7(2, this, hintView4));
    ...
    public void showCaptionLimitBulletin() {
        ...
        BulletinFactory.of(this.parentFragment).createCaptionLimitBulletin(MessagesController.getInstance(this.currentAccount).captionLengthLimitPremium, new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 16)).show();
    }
    ...
    public void showRichButton(boolean z) {
        ...
        this.richButton.animate().alpha(z2 ? 1.0f : 0.0f).scaleX(z2 ? 1.0f : 0.6f).scaleY(z2 ? 1.0f : 0.6f).setInterpolator(CubicBezierInterpolator.EASE_OUT_QUINT).setDuration(420L).withEndAction(new ChatActivityEnterView$$ExternalSyntheticLambda23(this, 1, z2)).start();
    }
    ...
    public void updateAttachButtonTranslationX() {
        ...
        SendButton sendButton = this.sendButton;
        if (sendButton != null) {
            alpha = this.sendButton.getAlpha() * (-BotFullscreenButtons$$ExternalSyntheticOutline1.m(56.0f, sendButton.width(), 0));
        } else {
            alpha = 0.0f;
        }
        imageView.setTranslationX(f + alpha);
    }
    ...
    private void updateBotButton(boolean z) {
        ...
        if (this.isChat) {
            ...
            if (botCommandsMenuView != null) {
                ...
                BotCommandsMenuView botCommandsMenuView2 = this.botCommandsMenuButton;
                String string = this.botMenuButtonType == BotMenuButtonType.COMMANDS ? LocaleController.getString(R.string.BotsMenuTitle) : this.botMenuWebViewTitle;
                if (string == null) {
            ...
            if (z4 && z) {
                ...
                boolean z7 = imageView7 != null && imageView7.getVisibility() == 0;
                if (z7 != z3 && (imageView = this.botButton) != null) {
                    ...
                    AndroidUtilities.updateViewVisibilityAnimated(this.botButton, z7, 0.1f, true, 1.0f, true, new ChatActivityEnterView$$ExternalSyntheticLambda5(this, 4));
                }
            }
    ...
    public void updateBotCommandsMenuContainerTopPadding() {
        ...
        if (measuredHeight > 0) {
            iM = BotFullscreenButtons$$ExternalSyntheticOutline1.m(childCount > 4 ? 12.0f : 0.0f, (this.sizeNotifierLayout.getMeasuredHeight() - measuredHeight) - AndroidUtilities.dp(8.0f), 0);
        } else {
            iM = this.botCommandsAdapter.newResult.size() > 4 ? BotFullscreenButtons$$ExternalSyntheticOutline1.m(162.8f, this.sizeNotifierLayout.getMeasuredHeight(), 0) : BotFullscreenButtons$$ExternalSyntheticOutline1.m((Math.max(1, Math.min(4, this.botCommandsAdapter.newResult.size())) * 36) + 8, this.sizeNotifierLayout.getMeasuredHeight(), 0);
        }
        ...
        if (this.messageEditText != null) {
            ...
            if (messageObject == null || messageObject.needResendWhenEdit()) {
                ...
                if (this.isStories && this.isLiveComment) {
                    layoutParams.rightMargin = Math.max(0, this.sendButton.width() - AndroidUtilities.dp(44.0f)) + AndroidUtilities.dp(this.suggestButtonVisible ? 50.0f : 2.0f);
                } else if (i == 1 || i == 2) {
                    ImageView imageView5 = this.botButton;
                ...
                if (frameLayout != null) {
                    ...
                    layoutParams2.rightMargin = this.editingMessageObject == null ? BotFullscreenButtons$$ExternalSyntheticOutline1.m(44.0f, this.sendButton.width(), 0) : 0;
    ...
    public void updateSlowModeText() {
        ...
        if (this.slowModeTimer == 0 || i <= 0) {
            ...
            ChatActivityEnterView$$ExternalSyntheticLambda3 chatActivityEnterView$$ExternalSyntheticLambda3 = new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 28);
            this.updateSlowModeRunnable = chatActivityEnterView$$ExternalSyntheticLambda3;
            AndroidUtilities.runOnUIThread(chatActivityEnterView$$ExternalSyntheticLambda3, 100L);
        }
        if (isInScheduleMode()) {
            return;
        }
    ...
    public ValueAnimator animateSendButton(boolean z) {
        float alpha = getSendButtonInternal().getAlpha();
        float f = z ? 1.0f : 0.0f;
        float scaleX = getSendButtonInternal().getScaleX();
        float f2 = z ? 1.0f : 0.1f;
        float scaleY = getSendButtonInternal().getScaleY();
        float f3 = z ? 1.0f : 0.1f;
        if (z && alpha < 0.25f && (getSendButtonInternal() instanceof SendButton)) {
            ((SendButton) getSendButtonInternal()).appear();
        }
        ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        valueAnimatorOfFloat.addUpdateListener(new WaveDrawable$$ExternalSyntheticLambda0(this, alpha, f, scaleX, f2, scaleY, f3, 1));
        return valueAnimatorOfFloat;
    }
    ...
    public boolean businessLinkHasChanges() {
        BusinessLinkPresetMessage businessLinkPresetMessageCalculateBusinessLinkPresetMessage = calculateBusinessLinkPresetMessage();
        return (TextUtils.equals(businessLinkPresetMessageCalculateBusinessLinkPresetMessage.text, this.lastSavedBusinessLinkMessage.text) && MediaDataController.entitiesEqual(this.lastSavedBusinessLinkMessage.entities, businessLinkPresetMessageCalculateBusinessLinkPresetMessage.entities)) ? false : true;
    }
    ...
    public void checkSendButton(boolean z) {
        ...
        if (i3 <= 0 || i3 == Integer.MAX_VALUE || isSlowModeIgnored()) {
            if (trimmedString.length() > 0 || this.forceShowSendButton || this.richDraftActive || this.audioToSend != null || this.videoToSendMessageObject != null || ((this.slowModeTimer == Integer.MAX_VALUE && !isSlowModeIgnored()) || ((this.isLiveComment && getStarsPrice() > 0) || this.animatorIsBlockedByStreaming.value))) {
                EditTextCaption editTextCaption2 = this.messageEditText;
                ...
                int themedColor = (this.slowModeTimer != Integer.MAX_VALUE || isSlowModeIgnored()) ? getThemedColor(Theme.key_chat_messagePanelSend) : getThemedColor(Theme.key_glass_defaultIcon);
                EditTextCaption editTextCaption3 = this.messageEditText;
                boolean z6 = (editTextCaption3 != null && (!TextUtils.isEmpty(editTextCaption3.getCaption()) || this.messageEditText.isNearRightCaption(AndroidUtilities.dp(44.0f)))) || LocaleController.isRTL;
                ...
                if (this.audioVideoButtonContainer.getVisibility() != 0 && this.slowModeButton.getVisibility() != 0 && !z4 && !z5 && !this.animatorIsBlockedByStreaming.value) {
                    ...
                    if (chatActivitySideControlsButtonsLayout != null) {
                        chatActivitySideControlsButtonsLayout.showButton(0, z6, true);
                        if (this.attachButton != null) {
                            ViewPropertyAnimator viewPropertyAnimator = this.attachButtonAnimator;
                            if (viewPropertyAnimator != null) {
                                viewPropertyAnimator.cancel();
                    ...
                    if (this.attachLayout != null) {
                        ...
                        ArrayList arrayList = new ArrayList();
                        arrayList.add(ObjectAnimator.ofFloat(this.attachLayout, (Property<LinearLayout, Float>) this.ATTACH_LAYOUT_ALPHA, f));
                        ...
                        if (chatActivitySideControlsButtonsLayout2 != null) {
                            chatActivitySideControlsButtonsLayout2.showButton(0, z6, true);
                            ImageView imageView5 = this.attachButton;
                            if (imageView5 != null) {
                                float f3 = z6 ? 0.0f : 1.0f;
                                this.attachButtonAlpha = f3;
                                arrayList.add(ObjectAnimator.ofFloat(imageView5, (Property<ImageView, Float>) property3, f3));
                                arrayList.add(ObjectAnimator.ofFloat(this.attachButton, (Property<ImageView, Float>) property, z6 ? 0.5f : 1.0f));
                                arrayList.add(ObjectAnimator.ofFloat(this.attachButton, (Property<ImageView, Float>) property2, z6 ? 0.5f : 1.0f));
                            }
                        } else {
                            ImageView imageView6 = this.attachButton;
                            if (imageView6 != null) {
                                this.attachButtonAlpha = 0.0f;
                                arrayList.add(ObjectAnimator.ofFloat(imageView6, (Property<ImageView, Float>) property3, 0.0f));
                        ...
                        ChatActivityEnterViewDelegate chatActivityEnterViewDelegate = this.delegate;
                        final boolean z7 = chatActivityEnterViewDelegate != null && chatActivityEnterViewDelegate.hasScheduledMessages();
                        ...
                        if (imageView7 != null) {
                            ...
                            if (z7) {
                                ...
                                arrayList.add(ObjectAnimator.ofFloat(this.scheduledButton, (Property<ImageView, Float>) property3, 0.0f));
                    ...
                    if (this.slowModeButton.getVisibility() == 0) {
                        arrayList2.add(ObjectAnimator.ofFloat(this.slowModeButton, (Property<SlowModeBtn, Float>) property, 0.1f));
                        arrayList2.add(ObjectAnimator.ofFloat(this.slowModeButton, (Property<SlowModeBtn, Float>) property2, 0.1f));
                        arrayList2.add(ObjectAnimator.ofFloat(this.slowModeButton, (Property<SlowModeBtn, Float>) property3, 0.0f));
                    }
                    if (z4) {
                    ...
                    if (caption != null) {
                        ...
                        arrayList2.add(ObjectAnimator.ofFloat(this.cancelBotButton, (Property<ImageView, Float>) property, 1.0f));
                        arrayList2.add(ObjectAnimator.ofFloat(this.cancelBotButton, (Property<ImageView, Float>) property2, 1.0f));
                        arrayList2.add(ObjectAnimator.ofFloat(this.cancelBotButton, (Property<ImageView, Float>) property3, 1.0f));
                ...
                if (getSendButtonInternal().getVisibility() == 0 || this.cancelBotButton.getVisibility() == 0 || (((imageView3 = this.expandStickersButton) != null && imageView3.getVisibility() == 0) || this.slowModeButton.getVisibility() == 0)) {
                    if (!z3) {
                        ...
                        if (linearLayout2 != null) {
                            ...
                            arrayList3.add(ObjectAnimator.ofFloat(this.attachLayout, (Property<LinearLayout, Float>) property, 1.0f));
                            ...
                            if (chatActivitySideControlsButtonsLayout4 != null) {
                                chatActivitySideControlsButtonsLayout4.showButton(0, false, true);
                            }
                            if (this.attachButton != null) {
                                ...
                                this.attachButtonAlpha = 1.0f;
                                arrayList3.add(ObjectAnimator.ofFloat(imageView14, (Property<ImageView, Float>) property3, 1.0f));
                                arrayList3.add(ObjectAnimator.ofFloat(this.attachButton, (Property<ImageView, Float>) property, 1.0f));
                                arrayList3.add(ObjectAnimator.ofFloat(this.attachButton, (Property<ImageView, Float>) property2, 1.0f));
                            }
                            ...
                            if (imageView15 != null) {
                                if (z8) {
                                    ...
                                    arrayList3.add(ObjectAnimator.ofFloat(this.scheduledButton, (Property<ImageView, Float>) property, 1.0f));
                                    arrayList3.add(animateScheduledTranslationX(0.0f));
                                    ImageView imageView16 = this.notifyButton;
                        ...
                        arrayList4.add(ObjectAnimator.ofFloat(this.audioVideoSendButton, (Property<ChatActivityEnterViewAnimatedIconView, Float>) property, 1.0f));
                        arrayList4.add(ObjectAnimator.ofFloat(this.audioVideoSendButton, (Property<ChatActivityEnterViewAnimatedIconView, Float>) property2, 1.0f));
                        arrayList4.add(ObjectAnimator.ofFloat(this.audioVideoSendButton, (Property<ChatActivityEnterViewAnimatedIconView, Float>) property3, f5));
                ...
                if (linearLayout3 != null && this.recordInterfaceState == 0) {
                    ...
                    if (chatActivitySideControlsButtonsLayout5 != null) {
                        chatActivitySideControlsButtonsLayout5.showButton(0, false, true);
                    }
                    if (this.attachButton != null) {
                        ...
                        ImageView imageView19 = this.attachButton;
                        this.attachButtonAlpha = 1.0f;
                        arrayList5.add(ObjectAnimator.ofFloat(imageView19, (Property<ImageView, Float>) property3, 1.0f));
                ...
                arrayList6.add(ObjectAnimator.ofFloat(this.expandStickersButton, (Property<ImageView, Float>) property, 1.0f));
                arrayList6.add(ObjectAnimator.ofFloat(this.expandStickersButton, (Property<ImageView, Float>) property2, 1.0f));
                arrayList6.add(ObjectAnimator.ofFloat(this.expandStickersButton, (Property<ImageView, Float>) property3, 1.0f));
                if (this.cancelBotButton.getVisibility() == 0) {
                    ...
                    arrayList6.add(ObjectAnimator.ofFloat(this.audioVideoSendButton, (Property<ChatActivityEnterViewAnimatedIconView, Float>) property, 0.1f));
                    arrayList6.add(ObjectAnimator.ofFloat(this.audioVideoSendButton, (Property<ChatActivityEnterViewAnimatedIconView, Float>) property2, 0.1f));
                    arrayList6.add(ObjectAnimator.ofFloat(this.audioVideoSendButton, (Property<ChatActivityEnterViewAnimatedIconView, Float>) property3, 0.0f));
                } else if (this.slowModeButton.getVisibility() == 0) {
            ...
            if (z3) {
                imageView4.animate().translationX(z2 ? -BotFullscreenButtons$$ExternalSyntheticOutline1.m(64.0f, this.sendButton.width(), 0) : AndroidUtilities.dp(42.0f)).setDuration(320L).setInterpolator(CubicBezierInterpolator.EASE_OUT_QUINT).start();
                return;
            } else {
                imageView4.setTranslationX(z2 ? -BotFullscreenButtons$$ExternalSyntheticOutline1.m(64.0f, this.sendButton.width(), 0) : AndroidUtilities.dp(42.0f));
                return;
            }
        }
        if (this.slowModeButton.getVisibility() != 0) {
            if (!z3) {
                ...
                if (linearLayout4 != null) {
                    ...
                    if (chatActivitySideControlsButtonsLayout6 != null) {
                        chatActivitySideControlsButtonsLayout6.showButton(0, false, false);
                    }
                    ImageView imageView22 = this.attachButton;
                    if (imageView22 != null) {
                        this.attachButtonAlpha = 0.0f;
                ...
                if (this.attachLayout != null) {
                    ...
                    arrayList7.add(ObjectAnimator.ofFloat(this.attachLayout, (Property<LinearLayout, Float>) property, 0.5f));
                    this.scheduleButtonHidden = false;
                    ...
                    if (imageView24 != null) {
                        this.attachButtonAlpha = 0.0f;
                        arrayList7.add(ObjectAnimator.ofFloat(imageView24, (Property<ImageView, Float>) property3, 0.0f));
                        arrayList7.add(ObjectAnimator.ofFloat(this.attachButton, (Property<ImageView, Float>) property, 0.5f));
                        arrayList7.add(ObjectAnimator.ofFloat(this.attachButton, (Property<ImageView, Float>) property2, 0.5f));
                    }
                ...
                if (imageView26 != null && imageView26.getVisibility() == 0) {
                    arrayList8.add(ObjectAnimator.ofFloat(this.expandStickersButton, (Property<ImageView, Float>) property, 0.1f));
                    arrayList8.add(ObjectAnimator.ofFloat(this.expandStickersButton, (Property<ImageView, Float>) property2, 0.1f));
                    arrayList8.add(ObjectAnimator.ofFloat(this.expandStickersButton, (Property<ImageView, Float>) property3, 0.0f));
                }
                ...
                arrayList8.add(ObjectAnimator.ofFloat(this.slowModeButton, (Property<SlowModeBtn, Float>) property, 1.0f));
                arrayList8.add(ObjectAnimator.ofFloat(this.slowModeButton, (Property<SlowModeBtn, Float>) property2, 1.0f));
                arrayList8.add(ObjectAnimator.ofFloat(this.slowModeButton, (Property<SlowModeBtn, Float>) property3, 1.0f));
                setSlowModeButtonVisible(true);
    ...
    public void checkStickresExpandHeight() {
        ...
        if (i2 > iDp) {
            final ChatActivityEnterView$$ExternalSyntheticLambda3 chatActivityEnterView$$ExternalSyntheticLambda3 = new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 11);
            this.emojiView.setLayerType(2, null);
            if (this.overrideKeyboardAnimation) {
                this.animationEndRunnable = chatActivityEnterView$$ExternalSyntheticLambda3;
            } else {
                AnimatorSet animatorSet = new AnimatorSet();
                if (this.windowInsetsInAppController != null) {
                    ...
                    ((ObjectAnimator) animatorSet.getChildAnimations().get(0)).addUpdateListener(new ChatActivityEnterView$$ExternalSyntheticLambda5(this, 5));
                }
            ...
            if (this.windowInsetsInAppController != null) {
                ...
                ((ObjectAnimator) animatorSet2.getChildAnimations().get(0)).addUpdateListener(new ChatActivityEnterView$$ExternalSyntheticLambda5(this, 6));
            }
        ...
        if (windowInsetsInAppController != null) {
            ...
            int i3 = iDp + AndroidUtilities.navigationBarHeight;
            WindowInsetsStateHolder windowInsetsStateHolder = (WindowInsetsStateHolder) windowInsetsInAppController;
            if (windowInsetsStateHolder.inAppKeyboardHeight == i3 && windowInsetsStateHolder.inAppKeyboardState == 0) {
                return;
            }
            AndroidUtilities.cancelRunOnUIThread(windowInsetsStateHolder.closeInAppKeyboard);
            windowInsetsStateHolder.inAppKeyboardViewHeight = Math.max(windowInsetsStateHolder.inAppKeyboardHeight, i3);
            windowInsetsStateHolder.inAppKeyboardHeight = i3;
    ...
    public void createSuggestionButton() {
        ...
        this.suggestButton.setBackground(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, -1));
        if (this.isLiveComment) {
        ...
        this.suggestButton.setOnClickListener(new ChatActivityEnterView$$ExternalSyntheticLambda7(this, 20));
        ...
        if (i != NotificationCenter.audioDidSent) {
            ...
            if (i != NotificationCenter.updateBotMenuButton) {
                if (i == NotificationCenter.didUpdatePremiumGiftFieldIcon) {
                    ...
                    if (i == NotificationCenter.currentUserPremiumStatusChanged && this.richDraftActive && (sendButton = this.sendButton) != null) {
    ...
    public void doneEditingMessage() {
        ...
        if (this.searchingType != 0) {
            ...
            if (this.stickersExpanded) {
                setStickersExpanded(false, true, false);
                this.waitingForKeyboardOpenAfterAnimation = true;
                AndroidUtilities.runOnUIThread(new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 13), 200L);
            }
        }
        EditTextCaption editTextCaption = this.messageEditText;
        CharSequence textToUse = editTextCaption == null ? "" : editTextCaption.getTextToUse();
    ...
    public void drawBackground(Canvas canvas, boolean z) {
        if (this.shouldDrawBackground) {
            ...
            if (!this.allowBlur) {
                canvas.drawRect(0.0f, intrinsicHeight, getWidth(), getHeight(), getThemedPaint("paintChatComposeBackground"));
                return;
            }
    ...
    public float getIslandTotalHeight(boolean z) {
        return z ? this.currentIslandTotalHeightTarget : this.currentIslandTotalHeight;
    }
    ...
    public long getStarsPrice() {
        ChatActivity chatActivity = this.parentFragment;
        return chatActivity != null ? chatActivity.getMessagesController().getSendPaidMessagesStars(this.parentFragment.getDialogId()) : MessagesController.getInstance(this.currentAccount).getSendPaidMessagesStars(this.dialog_id);
    }
    ...
    public boolean isEphemeralMessageVisible() {
        return this.animatorEphemeralMessageVisibility.value;
    }
    ...
    public boolean isInTopViewVisibilityAnimating() {
        FactorAnimator factorAnimator = this.animatorTopViewVisibility.animator;
    ...
    public boolean isRtlText() {
        try {
            EditTextCaption editTextCaption = this.messageEditText;
            return editTextCaption != null && editTextCaption.getLayout().getParagraphDirection(0) == -1;
        } catch (Throwable unused) {
            return false;
        }
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (botCommandsMenuView == null || botCommandsMenuView.getTag() == null) {
            ...
            if (senderSelectView == null || senderSelectView.getVisibility() != 0) {
                ...
                EditTextCaption editTextCaption = this.messageEditText;
                if (editTextCaption != null) {
                    ((ViewGroup.MarginLayoutParams) editTextCaption.getLayoutParams()).leftMargin = AndroidUtilities.dp(50.0f);
                }
                RichMessageLayout.PreviewView previewView = this.richDraftPreview;
                if (previewView != null) {
            ...
            if (editTextCaption3 != null) {
                ViewGroup.MarginLayoutParams marginLayoutParams3 = (ViewGroup.MarginLayoutParams) editTextCaption3.getLayoutParams();
    ...
    public void onPause() {
        ...
        ChatActivityEnterView$$ExternalSyntheticLambda3 chatActivityEnterView$$ExternalSyntheticLambda3 = new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 20);
        this.hideKeyboardRunnable = chatActivityEnterView$$ExternalSyntheticLambda3;
        AndroidUtilities.runOnUIThread(chatActivityEnterView$$ExternalSyntheticLambda3, 500L);
    }
    ...
    @Override
    public void lambda$onStickerSelected$97(final TLRPC.Document document, final String str, final Object obj, final MessageObject.SendAnimationData sendAnimationData, final boolean z, boolean z2, int i, int i2) {
        ChatActivity chatActivity;
        if (this.isLiveComment) {
            return;
        }
        ...
        if (replyQuote != null && (chatActivity = this.parentFragment) != null && replyQuote.outdated) {
            ...
            AlertsCreator.ensurePaidMessageConfirmation(this.currentAccount, this.dialog_id, 1, new ChatActivityEnterView$$ExternalSyntheticLambda41(i, i2, obj, str, sendAnimationData, document, this, z2, z));
        }
    }
    ...
    public void openRichEditor() {
        ...
        if (richMessage != null) {
            ...
            if (fieldMarkdown == text) {
                ...
                richEditor2.initialSelectionStart = selectionStart;
                richEditor2.initialSelectionEnd = selectionEnd;
            }
            richEditor2.onClearedCallback = new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 18);
        ...
        richEditor.animateInputView = chatActivity.chatInputViewsContainer;
        richEditor.animateEnterView = chatActivity.getChatActivityEnterView();
        richEditor.onSentCallback = new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 19);
        this.parentFragment.presentFragment(richEditor);
    }
    ...
    public void openRichEditorWithHtml(CharSequence charSequence, String str, CharSequence charSequence2) {
        ...
        richEditor.animateInputView = chatActivity.chatInputViewsContainer;
        richEditor.animateEnterView = chatActivity.getChatActivityEnterView();
        richEditor.onClearedCallback = new ChatActivityEnterView$$ExternalSyntheticLambda88(this, 5);
        richEditor.onSentCallback = new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 2);
        this.parentFragment.presentFragment(richEditor);
    }
        ...
        do {
            ...
            if (this.delegate.hasForwardingMessages()) {
                ...
                if (editTextCaption != null) {
                    ...
                    sendAnimationData2.x = AndroidUtilities.dp(11.0f) + this.location[c];
                    sendAnimationData2.y = AndroidUtilities.dp(19.0f) + this.location[1];
                } else {
    ...
    public boolean sendMessage() {
        if (this.richDraftActive && !UserConfig.getInstance(this.currentAccount).isPremium()) {
            RichEditor.openConversionSheet(getContext(), new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 29), new ChatActivityEnterView$$ExternalSyntheticLambda88(this, 0), this.resourcesProvider);
            return true;
        }
        if (!isInScheduleMode()) {
    ...
    public boolean sendMessageInternal(final boolean z, final int i, final int i2, long j, boolean z2) {
        boolean z3 = z2 && !this.animatorEphemeralMessageVisibility.value;
        if (!z3) {
            lambda$sendMessageInternal$63(z, z3, i, i2, j);
            return false;
        }
        boolean zEnsurePaidMessageConfirmation = AlertsCreator.ensurePaidMessageConfirmation(this.currentAccount, this.dialog_id, getMessagesCount(), new Utilities.Callback() {
            @Override
            public final void run(Object obj) {
                this.f$0.lambda$sendMessageInternal$64(z, i, i2, (Long) obj);
            }
        }, j);
    ...
    public void setBlockedByStreaming(BotForumHelper.SteamingSendButtonState steamingSendButtonState, boolean z) {
        ...
        this.sendButtonBlockedByTypingView.animatorStopAllowed.setValue(z3, z && this.animatorIsBlockedByStreaming.floatValue > 0.0f);
        this.sendButtonBlockedByTypingView.setClickable(z3);
        this.sendButtonBlockedByTypingView.setEnabled(z3);
        BoolAnimator boolAnimator = this.animatorIsBlockedByStreaming;
        boolean z4 = boolAnimator.value != z2;
        boolAnimator.setValue(z2, z);
    ...
    public void setCommand(MessageObject messageObject, String str, boolean z, boolean z2) {
        ...
        if (!z) {
            ...
            if ((this.botCount != 1 || z2) && user2 != null && user2.bot && !str.contains("@")) {
                ...
                sendMessageParamsOf = SendMessagesHelper.SendMessageParams.of(zzjx.m(str, "@", UserObject.getPublicUsername(user2)), this.dialog_id, this.replyingMessageObject, getThreadMessage(), null, false, null, null, null, true, 0, 0, null, false);
            } else {
        ...
        String string2 = editTextCaption.getText().toString();
    ...
    public void setEditingBusinessLink(TL_account.TL_businessChatLink tL_businessChatLink) {
        ...
        if (this.editingBusinessLink != null) {
            ...
            this.doneButton.setOnClickListener(new ChatActivityEnterView$$ExternalSyntheticLambda7(this, 15));
    ...
    public void setEditingMessageObject(MessageObject messageObject, MessageObject.GroupedMessages groupedMessages, boolean z) {
        float f;
        ...
        if (this.audioToSend == null && this.videoToSendMessageObject == null && this.editingMessageObject != messageObject) {
            ...
            if (messageObject != null) {
                ...
                this.doneButton.setOnClickListener(new ChatActivityEnterView$$ExternalSyntheticLambda7(this, 9));
                if (this.editingMessageObject.needResendWhenEdit()) {
                ...
                this.doneButton.setOnLongClickListener(new AIEditorAlert$$ExternalSyntheticLambda15(this, messageObject, groupedMessages, 1));
                this.doneButton.setVisibility(0);
                this.doneButton.setScaleX(0.1f);
                this.doneButton.setScaleY(0.1f);
                this.doneButton.setAlpha(0.0f);
                ...
                if (this.keyboardVisible) {
                    ...
                    FilterGLThread$$ExternalSyntheticLambda7 filterGLThread$$ExternalSyntheticLambda7 = new FilterGLThread$$ExternalSyntheticLambda7(3, this, charSequenceApplyMessageEntities);
                    this.setTextFieldRunnable = filterGLThread$$ExternalSyntheticLambda7;
                    AndroidUtilities.runOnUIThread(filterGLThread$$ExternalSyntheticLambda7, 200L);
                }
                EditTextCaption editTextCaption3 = this.messageEditText;
                if (editTextCaption3 != null) {
    ...
    public void setOnSendButtonLongClick(View.OnLongClickListener onLongClickListener) {
        ...
        if (onLongClickListener == null) {
            onLongClickListener = new ChatActivityEnterView$$ExternalSyntheticLambda9(this, 1);
        }
    ...
    public void setSuggestionButtonVisible(final boolean z, boolean z2) {
        ...
        if (z2) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ChatActivityEnterView$$ExternalSyntheticLambda5(this, 3));
    ...
    public boolean showSendSuggestionHint() {
        ...
        this.sendSuggestHintView.setText(LocaleController.formatString(R.string.SuggestAPostBelowHint, ForumUtilities.getMonoForumTitle(this.currentAccount, this.dialog_id)));
        this.sendSuggestHintView.setPadding(AndroidUtilities.dp(12.0f), 0, AndroidUtilities.dp(12.0f), 0);
        this.sendSuggestHintView.setJointPx(1.0f, -((getWidth() - AndroidUtilities.dp(12.0f)) - ((this.suggestButton.getMeasuredWidth() / 2.0f) + (this.suggestButton.getX() + (this.attachLayout.getX() + this.messageEditTextContainer.getX())))));
        addView(this.sendSuggestHintView, LayoutHelper.createFrame(-1, 200.0f, 48, 0.0f, -192.0f, 0.0f, 0.0f));
        this.sendSuggestHintView.setOnHiddenListener(new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 8));
    ...
    public void updateColors() {
        ...
        if (drawable != null) {
            drawable.setColorFilter(new PorterDuffColorFilter(ColorUtils.setAlphaComponent(themedColor, (int) AndroidUtilities$$ExternalSyntheticOutline0.m(this.doneButtonEnabledProgress, 0.42f, 0.58f, iAlpha)), PorterDuff.Mode.MULTIPLY));
        }
        BotCommandsMenuContainer botCommandsMenuContainer = this.botCommandsMenuContainer;
        if (botCommandsMenuContainer != null) {
        ...
        chatActivityEnterViewAnimatedIconView3.setBackground(Theme.createSelectorDrawable(getThemedColor(i2), 1, -1));
        this.deleteRichDraftButton.setColorFilter(new PorterDuffColorFilter(getThemedColor(i), mode));
        ImageView imageView = this.deleteRichDraftButton;
        int themedColor3 = getThemedColor(i2);
        float fDp = AndroidUtilities.dp(19.0f);
        int iDp = AndroidUtilities.dp(1.0f);
        int iDp2 = AndroidUtilities.dp(3.0f);
        imageView.setBackground(Theme.createInsetRoundRectDrawable(themedColor3, fDp, iDp, iDp2, iDp, iDp2));
    ...
    public void updateFieldHint(boolean z) {
        ...
        if (z3) {
            this.messageEditText.setHintText(sendPaidMessagesStars > 0 ? StarsIntroActivity.replaceStars(LocaleController.formatString(R.string.SuggestPostForStars, LocaleController.formatNumber((int) sendPaidMessagesStars, ','), this.spans), 1.13f, (ColoredImageSpan[]) null) : LocaleController.formatString(R.string.SuggestPostForFree, new Object[0]));
        ...
        if (sendPaidMessagesStars > 0) {
            this.messageEditText.setHintText(StarsIntroActivity.replaceStars(false, LocaleController.formatString(R.string.TypeMessageForStars, LocaleController.formatNumber((int) sendPaidMessagesStars, ',')), this.spans));
    ...
    public void updateGiftButton(boolean z) {
        ...
        if (z2 || this.giftButton != null) {
            createGiftButton();
            AndroidUtilities.updateViewVisibilityAnimated(this.giftButton, z2, 1.0f, true, 1.0f, z, new ChatActivityEnterView$$ExternalSyntheticLambda5(this, 0));
            if (z2) {
                checkBirthdayHint();
            }
        }
    ...
    public void updateRecordInterface(final int i, boolean z) {
        boolean zIsRunning;
        int i2;
        char c;
        float f;
        ...
        if (z3) {
            ...
            if (zIsRunning || i == 4) {
                ...
                this.runningAnimationAudio.playTogether(ObjectAnimator.ofFloat(this.emojiButton, (Property<ChatActivityEnterViewAnimatedIconView, Float>) this.EMOJI_BUTTON_SCALE, 1.0f), ObjectAnimator.ofFloat(this.emojiButton, (Property<ChatActivityEnterViewAnimatedIconView, Float>) this.EMOJI_BUTTON_ALPHA, this.emojiButtonRestricted ? 0.5f : 1.0f), ObjectAnimator.ofFloat(this.recordDot, (Property<RecordDot, Float>) property3, 0.0f), ObjectAnimator.ofFloat(this.recordDot, (Property<RecordDot, Float>) property2, 0.0f), ObjectAnimator.ofFloat(this.recordCircle, this.recordCircleScale, 0.0f), ObjectAnimator.ofFloat(this.recordCircle, this.recordControlsCircleScale, 0.0f), ObjectAnimator.ofFloat(this.audioVideoButtonContainer, (Property<FrameLayout, Float>) property4, 1.0f), ObjectAnimator.ofFloat(this.recordTimerView, (Property<TimerView, Float>) property4, 0.0f), ObjectAnimator.ofFloat(this.audioVideoButtonContainer, (Property<FrameLayout, Float>) property4, 1.0f), ObjectAnimator.ofFloat(this.messageEditText, (Property<EditTextCaption, Float>) property4, 1.0f), ObjectAnimator.ofFloat(this.messageEditText, (Property<EditTextCaption, Float>) this.MESSAGE_TEXT_TRANSLATION_X, 0.0f), ObjectAnimator.ofFloat(this, "slideToCancelProgress", 1.0f));
                ControlsView controlsView4 = this.controlsView;
                if (controlsView4 != null) {
                    i2 = 1;
                    c = 0;
                ...
                if (chatActivitySideControlsButtonsLayout2 != 0) {
                    chatActivitySideControlsButtonsLayout2.showButton(r6, r6, z2);
                }
                ...
                if (isInVideoMode() || this.shouldDrawRecordedAudioPanelInParent) {
                    ...
                    FrameLayout.LayoutParams layoutParams2 = new FrameLayout.LayoutParams(viewGroup.getMeasuredWidth() - (this.editingMessageObject == null ? BotFullscreenButtons$$ExternalSyntheticOutline1.m(44.0f, this.sendButton.width(), 0) : 0), AndroidUtilities.dp(44.0f));
                ...
                if (z) {
                    ...
                    ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                    valueAnimatorOfFloat.addUpdateListener(new ChatActivityEnterView$$ExternalSyntheticLambda5(this, 2));
                    ...
                    if (botCommandsMenuView5 != null) {
                        ...
                        fArr5[0] = 0.0f;
                        ObjectAnimator objectAnimatorOfFloat5 = ObjectAnimator.ofFloat(botCommandsMenuView5, (Property<BotCommandsMenuView, Float>) property4, fArr5);
                        BotCommandsMenuView botCommandsMenuView6 = this.botCommandsMenuButton;
                        float[] fArr6 = new float[i7];
                        fArr6[0] = 0.0f;
                        ObjectAnimator objectAnimatorOfFloat6 = ObjectAnimator.ofFloat(botCommandsMenuView6, (Property<BotCommandsMenuView, Float>) property2, fArr6);
                        BotCommandsMenuView botCommandsMenuView7 = this.botCommandsMenuButton;
                        float[] fArr7 = new float[i7];
                        fArr7[0] = 0.0f;
                        ObjectAnimator objectAnimatorOfFloat7 = ObjectAnimator.ofFloat(botCommandsMenuView7, (Property<BotCommandsMenuView, Float>) property3, fArr7);
                    ...
                    animatorArr4[c3] = animatorSet11;
                    animatorArr4[c2] = valueAnimatorOfFloat;
                ...
                if (i != 5) {
                    ...
                    if (chatActivitySideControlsButtonsLayout3 != 0) {
                        chatActivitySideControlsButtonsLayout3.showButton(r12, r12, i5);
                    }
                    ImageView imageView7 = this.botButton;
                    if (imageView7 != null) {
                        ...
                        animatorArr5[i5] = objectAnimatorOfFloat9;
                    ...
                    if (this.audioVideoSendButton != null) {
                        ...
                        Animator[] animatorArr6 = new Animator[i5];
                        ...
                        Animator[] animatorArr7 = new Animator[i5];
                        ...
                        Animator[] animatorArr8 = new Animator[i5];
                        animatorArr8[r12] = objectAnimatorOfFloat12;
                        animatorSet13.playTogether(animatorArr8);
                        this.audioVideoSendButton.setState(isInVideoMode() ? ChatActivityEnterViewAnimatedIconView.State.VIDEO : ChatActivityEnterViewAnimatedIconView.State.VOICE, i5);
                    }
                    ...
                    if (imageView9 != null) {
                        ...
                        animatorArr9[i5] = valueAnimatorAnimateScheduledTranslationX2;
                ...
                this.messageTextTranslationX = 0.0f;
                updateMessageTextParams();
                ObjectAnimator objectAnimatorOfFloat15 = ObjectAnimator.ofFloat(this.messageEditText, (Property<EditTextCaption, Float>) property4, 1.0f);
                ...
                if (chatActivitySideControlsButtonsLayout5 != 0) {
                    chatActivitySideControlsButtonsLayout5.showButton(r10, r10, i6);
                }
                ImageView imageView13 = this.scheduledButton;
                if (imageView13 != null) {
                    float[] fArr15 = new float[i6];
                    fArr15[r10] = 1.0f;
                    ObjectAnimator objectAnimatorOfFloat17 = ObjectAnimator.ofFloat(imageView13, (Property<ImageView, Float>) property4, fArr15);
                    ...
                    animatorArr12[r10] = objectAnimatorOfFloat17;
                    animatorArr12[i6] = valueAnimatorAnimateScheduledTranslationX4;
                ...
                fArr16[r10] = 0.0f;
                ObjectAnimator objectAnimatorOfFloat18 = ObjectAnimator.ofFloat(timerView, (Property<TimerView, Float>) property4, fArr16);
                TimerView timerView2 = this.recordTimerView;
                float[] fArr17 = new float[i6];
                fArr17[r10] = AndroidUtilities.dp(40.0f);
                ObjectAnimator objectAnimatorOfFloat19 = ObjectAnimator.ofFloat(timerView2, (Property<TimerView, Float>) property, fArr17);
                SlideTextView slideTextView3 = this.slideText;
                float[] fArr18 = new float[i6];
                fArr18[r10] = 0.0f;
                ObjectAnimator objectAnimatorOfFloat20 = ObjectAnimator.ofFloat(slideTextView3, (Property<SlideTextView, Float>) property4, fArr18);
                SlideTextView slideTextView4 = this.slideText;
                float[] fArr19 = new float[i6];
                fArr19[r10] = AndroidUtilities.dp(40.0f);
                ObjectAnimator objectAnimatorOfFloat21 = ObjectAnimator.ofFloat(slideTextView4, (Property<SlideTextView, Float>) property, fArr19);
                Animator[] animatorArr13 = new Animator[4];
                animatorArr13[r10] = objectAnimatorOfFloat18;
                animatorArr13[i6] = objectAnimatorOfFloat19;
    ...
    public ChatActivityEnterView(final Activity activity, SizeNotifierFrameLayout sizeNotifierFrameLayout, final ChatActivity chatActivity, boolean z, final Theme.ResourcesProvider resourcesProvider) {
        ...
        this.recordCircleScale = new Property<RecordCircle, Float>(cls, "scale") {
            @Override
        ...
        this.recordControlsCircleScale = new Property<RecordCircle, Float>(cls, "controlsScale") {
            @Override
            public Float get(RecordCircle recordCircle) {
        ...
        this.recordAudioVideoRunnable = new Runnable() {
            ...
            public void run() {
                ...
                if (!ChatActivityEnterView.this.isInVideoMode()) {
                    ...
                    TL_stories.StoryItem replyToStory = ChatActivityEnterView.this.delegate != null ? ChatActivityEnterView.this.delegate.getReplyToStory() : null;
                    MediaController mediaController = MediaController.getInstance();
                    int i4 = ChatActivityEnterView.this.currentAccount;
                    long j = ChatActivityEnterView.this.dialog_id;
        ...
        this.dismissSendPreview = new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 25);
        ...
        this.animatorTopViewVisibility = new BoolAnimator(1, this, interpolator, 250L, false);
        ...
        ChatActivityEnterViewAnimatedIconView chatActivityEnterViewAnimatedIconView = new ChatActivityEnterViewAnimatedIconView(activity) {
            ...
            public void onDraw(Canvas canvas) {
                ...
                canvas.drawCircle(AndroidUtilities.dp(9.0f) + (getWidth() / 2), (getHeight() / 2) - AndroidUtilities.dp(8.0f), AndroidUtilities.dp(5.0f), ChatActivityEnterView.this.dotPaint);
            }
        };
        ...
        chatActivityEnterViewAnimatedIconView3.setBackground(Theme.createInsetRoundRectDrawable(themedColor2, fDp, iDp2, iDp3, iDp2, iDp3));
        this.emojiButton.setOnClickListener(new ChatActivityEnterView$$ExternalSyntheticLambda7(this, 3));
        ...
        this.deleteRichDraftButton.setColorFilter(new PorterDuffColorFilter(getThemedColor(i5), mode));
        ImageView imageView2 = this.deleteRichDraftButton;
        int themedColor3 = getThemedColor(i6);
        float fDp2 = AndroidUtilities.dp(19.0f);
        int iDp4 = AndroidUtilities.dp(1.0f);
        int iDp5 = AndroidUtilities.dp(3.0f);
        imageView2.setBackground(Theme.createInsetRoundRectDrawable(themedColor3, fDp2, iDp4, iDp5, iDp4, iDp5));
        this.deleteRichDraftButton.setVisibility(8);
        this.deleteRichDraftButton.setContentDescription(LocaleController.getString(R.string.ArticleDeleteDraft));
        this.deleteRichDraftButton.setOnClickListener(new View.OnClickListener(this) {
            public final ChatActivityEnterView f$0;
            ...
            public final void onClick(View view) {
                switch (i4) {
                    case 0:
                        this.f$0.lambda$new$3(resourcesProvider, view);
                        break;
                    default:
        ...
        if (z) {
            ...
            if (chatMode != 9) {
                ...
                CrossOutDrawable crossOutDrawable = new CrossOutDrawable(activity, R.drawable.input_notify_on, i5);
                ...
                this.notifyButton.setColorFilter(new PorterDuffColorFilter(getThemedColor(i5), PorterDuff.Mode.MULTIPLY));
                this.notifyButton.setScaleType(scaleType);
                this.notifyButton.setBackgroundDrawable(Theme.createSelectorDrawable(getThemedColor(i6), 1, -1));
                ...
                this.notifyButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (ChatActivityEnterView.this.silent) {
                            i7 = R.string.AccDescrChanSilentOn;
                            str2 = "AccDescrChanSilentOn";
                        } else {
                            i7 = R.string.AccDescrChanSilentOff;
                            str2 = "AccDescrChanSilentOff";
                        }
                        imageView4.setContentDescription(LocaleController.getString(str2, i7));
            ...
            this.attachButton.setColorFilter(new PorterDuffColorFilter(getThemedColor(i5), PorterDuff.Mode.MULTIPLY));
            this.attachButton.setImageResource(R.drawable.msg_input_attach2);
            this.attachButton.setBackground(Theme.createSelectorDrawable(getThemedColor(i6), 1, -1));
            this.messageEditTextContainer.addView(this.attachButton, LayoutHelper.createFrame(44, 44, 85));
            this.attachButton.setOnClickListener(new ChatActivityEnterView$$ExternalSyntheticLambda7(this, 4));
        ...
        imageView6.setColorFilter(new PorterDuffColorFilter(themedColor4, mode2));
        this.aiButton.setBackground(Theme.createSelectorDrawable(getThemedColor(i6), 1, AndroidUtilities.dp(16.0f)));
        ...
        this.aiButton.setOnClickListener(new View.OnClickListener(this) {
            public final ChatActivityEnterView f$0;
        ...
        this.richButton.setColorFilter(new PorterDuffColorFilter(getThemedColor(i5), mode2));
        this.richButton.setBackground(Theme.createSelectorDrawable(getThemedColor(i6), 1, AndroidUtilities.dp(16.0f)));
        ...
        this.richButton.setOnClickListener(new ChatActivityEnterView$$ExternalSyntheticLambda7(this, 5));
        this.richButton.setVisibility(8);
        ...
        drawableMutate.setColorFilter(new PorterDuffColorFilter(getThemedColor(i5), mode2));
        Drawable drawableMutate2 = getResources().getDrawable(R.drawable.input_video).mutate();
        this.cameraOutline = drawableMutate2;
        drawableMutate2.setColorFilter(new PorterDuffColorFilter(getThemedColor(i5), mode2));
        ...
        this.audioVideoSendButton.setPadding(iDp6, iDp6, iDp6, iDp6);
        ...
        this.cancelBotButton.setScaleY(0.1f);
        this.cancelBotButton.setAlpha(0.0f);
        this.cancelBotButton.setBackgroundDrawable(Theme.createSelectorDrawable(getThemedColor(i6), 1, -1));
        this.sendButtonContainer.addView(this.cancelBotButton, LayoutHelper.createFrame(44, 44, 85));
        this.cancelBotButton.setOnClickListener(new ChatActivityEnterView$$ExternalSyntheticLambda7(this, 6));
        ...
        this.sendButton.setOnClickListener(new ChatActivityEnterView$$ExternalSyntheticLambda7(this, 7));
        this.sendButton.setOnLongClickListener(new ChatActivityEnterView$$ExternalSyntheticLambda9(this, i2));
        if (AndroidUtilities.isAccessibilityScreenReaderEnabled()) {
            this.sendButtonContainer.setOnLongClickListener(new ChatActivityEnterView$$ExternalSyntheticLambda9(this, i2));
        }
        ...
        this.sendButtonBlockedByTypingView.setOnClickListener(new ChatActivityEnterView$$ExternalSyntheticLambda7(this, i4));
        ...
        this.slowModeButton.setTextColor(getThemedColor(i5));
        this.sendButtonContainer.addView(this.slowModeButton, LayoutHelper.createFrame(74, 44, 85));
        this.slowModeButton.setOnClickListener(new ChatActivityEnterView$$ExternalSyntheticLambda7(this, 17));
        this.slowModeButton.setOnLongClickListener(new ChatActivityEnterView$$ExternalSyntheticLambda9(this, i4));
    ...
    private void showTopView(boolean z, boolean z2, boolean z3) {
        ...
        if (!z3 && z && z4 && !this.keyboardVisible && !isPopupShowing()) {
            ...
            ChatActivityEnterView$$ExternalSyntheticLambda3 chatActivityEnterView$$ExternalSyntheticLambda3 = new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 5);
            this.showTopViewRunnable = chatActivityEnterView$$ExternalSyntheticLambda3;
            AndroidUtilities.runOnUIThread(chatActivityEnterView$$ExternalSyntheticLambda3, 200L);
            return;
        }
    ...
    public boolean didPressedBotButton(final TL_keyboard.KeyboardButtonProto keyboardButtonProto, final MessageObject messageObject, final MessageObject messageObject2, Browser.Progress progress) {
        ...
        int i;
        int i2 = 0;
        if (keyboardButtonProto != null && messageObject2 != null && ((chatActivity = this.parentFragment) == null || chatActivity.getChatMode() != 5)) {
            ...
            if (TLKeyboardHelper.isType(keyboardButtonProto, TL_keyboard.TL_inlineButtonTypeWebView.class) || TLKeyboardHelper.isType(keyboardButtonProto, TL_keyboard.TL_buttonTypeSimpleWebView.class)) {
                ...
                Runnable runnable = new Runnable() {
                    ...
                    public void run() {
                        ...
                        WebViewRequestProps webViewRequestPropsOf = WebViewRequestProps.of(i3, j2, j3, text, url, zIsType ? 1 : 0, messageObject3 != null ? messageObject3.messageOwner.id : 0, ChatActivityEnterView.this.parentFragment == null ? 0L : ChatActivityEnterView.this.parentFragment.getSendMonoForumPeerId(), null, false, null, null, 0, false, false);
                        LaunchActivity launchActivity = LaunchActivity.instance;
                        if (launchActivity != null && launchActivity.getBottomSheetTabs() != null && LaunchActivity.instance.getBottomSheetTabs().tryReopenTab(webViewRequestPropsOf) != null) {
                            if (ChatActivityEnterView.this.botCommandsMenuButton != null) {
                                ChatActivityEnterView.this.botCommandsMenuButton.setOpened(false);
                        ...
                        if (!TextUtils.isEmpty(restrictionReason)) {
                            ...
                            botWebViewSheet.parentActivity = ChatActivityEnterView.this.parentActivity;
                ...
                AlertsCreator.createBotLaunchAlert(this.parentFragment, MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(this.dialog_id)), new BulletinFactory$$ExternalSyntheticLambda5(this, runnable, j, 3), (Runnable) null);
                return true;
            }
            if (TLKeyboardHelper.isType(keyboardButtonProto, TL_keyboard.TL_buttonTypeRequestGeoLocation.class)) {
                ...
                builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new AlertsCreator$$ExternalSyntheticLambda201(this, messageObject2, keyboardButtonProto, 6));
            ...
            if (tL_inlineButtonTypeSwitchInline != null) {
                if (!this.parentFragment.processSwitchButton(tL_inlineButtonTypeSwitchInline)) {
                    if (!tL_inlineButtonTypeSwitchInline.same_peer) {
                        Bundle bundleM = TelegramMediaSession$$ExternalSyntheticOutline0.m("onlySelect", "dialogsType", 1, true);
                        ...
                        dialogsActivity.setDelegate(new AlertsCreator$$ExternalSyntheticLambda201(this, messageObject2, tL_inlineButtonTypeSwitchInline, 7));
                ...
                if (requestPeerType == null || messageObject2.messageOwner == null) {
                    ...
                    if (!(requestPeerType instanceof TLRPC.TL_requestPeerTypeCreateBot)) {
                        if ((requestPeerType instanceof TLRPC.TL_requestPeerTypeUser) && (i = tL_buttonTypeRequestPeer.max_quantity) > 1) {
                            ...
                            MultiContactsSelectorBottomSheet.open(tL_requestPeerTypeUser.bot, tL_requestPeerTypeUser.premium, i, new ChatActivityEnterView$$ExternalSyntheticLambda84(this, messageObject2, tL_buttonTypeRequestPeer));
                            return false;
                        }
                        Bundle bundleM2 = TelegramMediaSession$$ExternalSyntheticOutline0.m("onlySelect", "dialogsType", 15, true);
                        ...
                        dialogsActivity2.setDelegate(new ChatActivityEnterView$$ExternalSyntheticLambda84(this, messageObject2, tL_buttonTypeRequestPeer));
                    ...
                    if (currentUser != null) {
                        CreateBotAlert.show(getContext(), this.currentAccount, currentUser, (TLRPC.TL_requestPeerTypeCreateBot) tL_buttonTypeRequestPeer.peer_type, false, new SharedMediaLayout$$ExternalSyntheticLambda15(2, this, messageObject2, tL_buttonTypeRequestPeer, currentUser), this.resourcesProvider, null, false);
                        return false;
                    }
                }
            }
        ...
        if (z3 || this.stickersExpanded != z) {
            ...
            if (this.stickersExpanded) {
                ...
                if (z2) {
                    AnimatorSet animatorSet = new AnimatorSet();
                    if (this.windowInsetsInAppController != null) {
                        animatorSet.playTogether(ValueAnimator.ofInt(-(this.stickersExpandedHeight - i3)), ValueAnimator.ofInt(-(this.stickersExpandedHeight - i3)), ObjectAnimator.ofFloat(this.stickersArrow, "animationProgress", 1.0f));
                    } else {
                        animatorSet.playTogether(ObjectAnimator.ofInt(this, (Property<ChatActivityEnterView, Integer>) this.roundedTranslationYProperty, -(this.stickersExpandedHeight - i3)), ObjectAnimator.ofInt(this.emojiView, (Property<EmojiView, Integer>) this.roundedTranslationYProperty, -(this.stickersExpandedHeight - i3)), ObjectAnimator.ofFloat(this.stickersArrow, "animationProgress", 1.0f));
                    }
                    animatorSet.setDuration(300L);
                    animatorSet.setInterpolator(CubicBezierInterpolator.DEFAULT);
                    if (this.windowInsetsInAppController == null) {
                        ((ObjectAnimator) animatorSet.getChildAnimations().get(0)).addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                            public final ChatActivityEnterView f$0;
                            ...
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                switch (i) {
                                    case 0:
                                        this.f$0.lambda$setStickersExpanded$106(i3, valueAnimator);
                                        break;
                                    default:
                                        this.f$0.lambda$setStickersExpanded$107(i3, valueAnimator);
                                        break;
                                }
                            }
                        });
                ...
                if (z2) {
                    ...
                    animatorSet2.addListener(new AnimatorListenerAdapter() {
                        ...
                        public void onAnimationEnd(Animator animator2) {
                            ...
                            if (ChatActivityEnterView.this.emojiView != null) {
                                if (ChatActivityEnterView.this.windowInsetsInAppController == null) {
                                    ChatActivityEnterView.this.emojiView.getLayoutParams().height = i3;
                                }
                                ChatActivityEnterView.this.emojiView.setLayerType(0, null);
                            }
    ...
    public void showPopup(final int i, int i2, boolean z, boolean z2) {
        ...
        if (i == 1) {
            ...
            if (chatActivity != null && chatActivity.getParentLayout() != null) {
                iMin -= ((ActionBarLayout) this.parentFragment.getParentLayout()).getBottomTabsHeight(false);
            }
            if (i2 == 1) {
            ...
            if (sizeNotifierFrameLayout != null) {
                ...
                if (this.smoothKeyboard && !this.keyboardVisible && iMin != measuredHeight && z) {
                    final ChatActivityEnterView$$ExternalSyntheticLambda88 chatActivityEnterView$$ExternalSyntheticLambda88 = new ChatActivityEnterView$$ExternalSyntheticLambda88(this, 3);
                    if (this.overrideKeyboardAnimation) {
                        this.animationEndRunnable = chatActivityEnterView$$ExternalSyntheticLambda88;
                    } else {
                        AnimatorSet animatorSet = new AnimatorSet();
                        ...
                        this.panelAnimation.addListener(new AnimatorListenerAdapter() {
                            ...
                            public void onAnimationEnd(Animator animator) {
                                ...
                                ChatActivityEnterView.this.notificationsLocker.unlock();
                                chatActivityEnterView$$ExternalSyntheticLambda88.run();
                            }
                        });
            ...
            if (windowInsetsInAppController != null) {
                if (iMin > 0) {
                    int i3 = iMin + AndroidUtilities.navigationBarHeight;
                    WindowInsetsStateHolder windowInsetsStateHolder = (WindowInsetsStateHolder) windowInsetsInAppController;
                    if (windowInsetsStateHolder.inAppKeyboardHeight != i3 || windowInsetsStateHolder.inAppKeyboardState != 0) {
                        AndroidUtilities.cancelRunOnUIThread(windowInsetsStateHolder.closeInAppKeyboard);
                        windowInsetsStateHolder.inAppKeyboardViewHeight = Math.max(windowInsetsStateHolder.inAppKeyboardHeight, i3);
            ...
            if (emojiView2 != null) {
                if (i == 2 && !AndroidUtilities.usingHardwareInput && !AndroidUtilities.isInMultiwindow) {
                    ...
                    final EmojiView$$ExternalSyntheticLambda9 emojiView$$ExternalSyntheticLambda9 = new EmojiView$$ExternalSyntheticLambda9(this, i, 9);
                    if (!this.overrideKeyboardAnimation) {
                        AnimatorSet animatorSet2 = new AnimatorSet();
                        ...
                        this.animationEndRunnable = emojiView$$ExternalSyntheticLambda9;
                    }
                    AndroidUtilities.runOnUIThread(this.runEmojiPanelAnimation, 50L);
                    requestLayout();
                    z4 = false;
    ...
    public void setButtons(MessageObject messageObject, boolean z, boolean z2) {
        ...
        if (messageObject3 == null || messageObject3 != messageObject) {
            ...
            if (this.botKeyboardView == null) {
                ...
                this.botKeyboardViewVisible = false;
                this.botKeyboardView.setDelegate(new ChatActivityEnterView$$ExternalSyntheticLambda18(this));
    ...
    public void setFieldFocused(boolean z) {
        ...
        if (z) {
            ...
            ChatActivityEnterView$$ExternalSyntheticLambda3 chatActivityEnterView$$ExternalSyntheticLambda3 = new ChatActivityEnterView$$ExternalSyntheticLambda3(this, 10);
            this.focusRunnable = chatActivityEnterView$$ExternalSyntheticLambda3;
            AndroidUtilities.runOnUIThread(chatActivityEnterView$$ExternalSyntheticLambda3, 600L);
            return;
        }
        EditTextCaption editTextCaption = this.messageEditText;
