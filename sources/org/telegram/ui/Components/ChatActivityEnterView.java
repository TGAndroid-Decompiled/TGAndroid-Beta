...
public class ChatActivityEnterView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, ov0, ux0, oy0, xd.b, org.telegram.ui.ActionBar.b6 {
    public static final int f24570j5 = 0;
    public boolean A0;
    ...
    public int f24571a;
    public int f24572a0;
    public eh.d f24573a1;
    public boolean a2;
    public VideoEditedInfo f24574a3;
    public boolean f24575a4;
    public xg.g f24576a5;
    public boolean f24577b;
    public mr f24578b0;
    public ae f24579b1;
    public int f24580b2;
    public boolean f24581b3;
    public long f24582b4;
    public final xd.c f24583b5;
    public org.telegram.ui.ActionBar.g1 f24584c;
    public Runnable f24585c0;
    public y71 f24586c1;
    public boolean f24587c2;
    public boolean c3;
    public float f24588c4;
    public final xd.a f24589c5;
    public LinearLayout d;
    public boolean f24590d0;
    public kj0 f24591d1;
    public boolean f24592d2;
    public boolean f24593d3;
    public float f24594d4;
    public final xd.a f24595d5;
    public CharSequence f24596e;
    public boolean f24597e0;
    public rk0 f24598e1;
    public boolean f24599e2;
    public MessageObject f24600e3;
    public float f24601e4;
    public final xd.a f24602e5;
    public String f24603f;
    public String f24604f0;
    public long f24605f1;
    public boolean f24606f2;
    public TL_keyboard.KeyboardButtonProto f24607f3;
    public float f24608f4;
    public float f24609f5;
    public String f24610g0;
    public SlideTextView f24611g1;
    public boolean f24612g2;
    public boolean f24613g3;
    public float f24614g4;
    public float f24615g5;
    public float h;
    public sh.e3 f24616h0;
    public kg f24617h1;
    public boolean f24618h2;
    public boolean f24619h3;
    public float f24620h4;
    public boolean f24621h5;
    public sh.z f24622i0;
    public final pv0 f24623i1;
    public MessageObject f24624i2;
    public boolean f24625i3;
    public float f24626i4;
    public int f24627i5;
    public df f24628j0;
    public ViewGroup f24629j1;
    public TLRPC.TL_replyKeyboardMarkup f24630j2;
    public boolean f24631j3;
    public float f24632j4;
    public sh.y f24633k0;
    public int f24634k1;
    public int f24635k2;
    public int f24636k3;
    public float f24637k4;
    public boolean f24638l0;
    public final eg.s3 l1;
    public boolean f24639l2;
    public boolean f24640l3;
    public float f24641l4;
    public ap0 m0;
    public ViewPropertyAnimator f24642m1;
    public PowerManager.WakeLock f24643m2;
    public boolean f24644m3;
    public float f24645m4;
    public float f24646n;
    public ve f24647n0;
    public final ge f24648n1;
    public AnimatorSet f24649n2;
    public final re f24650n3;
    public boolean f24651n4;
    public yd f24652o0;
    public final j0 f24653o1;
    public AnimatorSet f24654o2;
    public final ye f24655o3;
    public boolean f24656o4;
    public int f24657p0;
    public final ImageView f24658p1;
    public AnimatorSet f24659p2;
    public final org.telegram.ui.Cells.b1 f24660p3;
    public int f24661p4;
    public int f24662q0;
    public final ImageView f24663q1;
    public AnimatorSet f24664q2;
    public final kf f24665q3;
    public long f24666q4;
    public float f24667r;
    public yd f24668r0;
    public float f24669r1;
    public int f24670r2;
    public final nf f24671r3;
    public boolean f24672r4;
    public float f24673s;
    public ValueAnimator f24674s0;
    public ImageView f24675s1;
    public int f24676s2;
    public final Paint f24677s3;
    public ValueAnimator f24678s4;
    public float f24679t0;
    public se f24680t1;
    public int f24681t2;
    public boolean f24682t3;
    public boolean f24683t4;
    public boolean f24684u0;
    public final ce f24685u1;
    public int f24686u2;
    public boolean f24687u3;
    public boolean f24688u4;
    public boolean v;
    public boolean f24689v0;
    public final ae f24690v1;
    public boolean f24691v2;
    public boolean f24692v3;
    public boolean f24693v4;
    public Runnable f24694w;
    public boolean f24695w0;
    public final ae f24696w1;
    public int f24697w2;
    public boolean f24698w3;
    public boolean f24699w4;
    public float f24700x;
    public boolean f24701x0;
    public final ImageView f24702x1;
    public final boolean f24703x2;
    public AnimatorSet f24704x3;
    public final Paint f24705x4;
    public float f24706y;
    public final HashMap f24707y0;
    public RichMessageLayout.PreviewView f24708y1;
    public long f24709y2;
    public float f24710y3;
    public float f24711y4;
    public boolean f24712z0;
    public boolean f24713z1;
    public float f24714z2;
    public int f24715z3;
    ...
    public class RecordCircle extends View {
        ...
        public final u9 h;
        public final u9 f24721n;
        public final float f24722r;
        public final float f24723s;
        public final RectF v;
        public boolean f24724w;
        public final jg f24725x;
        public int f24726y;
        ...
        public RecordCircle(Context context) {
            ...
            this.f24721n = u9Var2;
            this.f24722r = AndroidUtilities.dpf2(41.0f);
            this.f24723s = AndroidUtilities.dp(30.0f);
            this.v = new RectF();
            this.E = 0.0f;
            this.F = true;
        ...
        public final void a() {
            ...
            int i10 = org.telegram.ui.ActionBar.k6.f21634bf;
        ...
        public final void b(Canvas canvas, Drawable drawable, Drawable drawable2, float f10, int i10) {
            ...
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            boolean z4 = chatActivityEnterView.f24651n4;
            if (z4 && chatActivityEnterView.f24608f4 == 1.0f) {
                chatActivityEnterView.Y0.setAlpha(1.0f);
                setVisibility(8);
            } else if (z4 && chatActivityEnterView.f24608f4 < 1.0f) {
        ...
        public final void c(boolean z4) {
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            if (!z4) {
                chatActivityEnterView.f24656o4 = false;
                chatActivityEnterView.f24620h4 = -1.0f;
                chatActivityEnterView.f24614g4 = -1.0f;
                chatActivityEnterView.f24608f4 = 1.0f;
                chatActivityEnterView.f24645m4 = 1.0f;
                chatActivityEnterView.f24632j4 = 0.0f;
                chatActivityEnterView.f24601e4 = 0.0f;
            }
            invalidate();
            chatActivityEnterView.f24641l4 = 0.0f;
            chatActivityEnterView.x0();
            chatActivityEnterView.f24626i4 = 0.0f;
            chatActivityEnterView.f24594d4 = 0.0f;
            chatActivityEnterView.f24588c4 = 0.0f;
            chatActivityEnterView.f24575a4 = false;
            this.f24720f = 0.0f;
            chatActivityEnterView.f24651n4 = false;
        ...
        public final boolean dispatchHoverEvent(MotionEvent motionEvent) {
            if (!super.dispatchHoverEvent(motionEvent) && !this.f24725x.f(motionEvent)) {
                return false;
            }
            return true;
        }
        ...
        public final void e() {
            ...
            int i10 = org.telegram.ui.ActionBar.k6.f21652cf;
            paint.setColor(chatActivityEnterView.i0(i10));
            this.h.d.setColor(i0.a.k(chatActivityEnterView.i0(i10), 38));
            this.f24721n.d.setColor(i0.a.k(chatActivityEnterView.i0(i10), 76));
            this.f24726y = chatActivityEnterView.I3.getAlpha();
        }

        public float getControlsScale() {
            return ChatActivityEnterView.this.f24601e4;
        }

        public float getScale() {
            return ChatActivityEnterView.this.f24594d4;
        }
        ...
        public final void onMeasure(int i10, int i11) {
            ...
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            chatActivityEnterView.f24661p4 = (int) ((1.0f - chatActivityEnterView.f24608f4) * (-measuredWidth));
        }

        public void setAmplitude(double d) {
            this.f24721n.d((float) (Math.min(1800.0d, d) / 1800.0d), true);
            this.h.d((float) (Math.min(1800.0d, d) / 1800.0d), false);
            float min = (float) (Math.min(1800.0d, d) / 1800.0d);
            this.f24717b = min;
            this.f24718c = (min - this.f24716a) / 375.0f;
            invalidate();
        }

        public void setControlsScale(float f10) {
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            chatActivityEnterView.f24601e4 = f10;
            ig igVar = chatActivityEnterView.K1;
            if (igVar != null) {
                igVar.invalidate();
            }
        ...
        public void setScale(float f10) {
            ChatActivityEnterView.this.f24594d4 = f10;
            invalidate();
        }

        public void setTransformToSeekbar(float f10) {
            ChatActivityEnterView.this.f24641l4 = f10;
            invalidate();
        }
    }
    ...
    public class SlideTextView extends View {
        ...
        public final TextPaint f24727a;
        public final TextPaint f24728b;
        public final Paint f24729c;
        public final String d;
        public final String f24730e;
        public float f24731f;
        public float h;
        public float f24732n;
        public float f24733r;
        public float f24734s;
        public float v;
        public float f24735w;
        ...
        public SlideTextView(Context context) {
            ...
            this.f24730e = upperCase;
            this.B = string.indexOf(upperCase);
            a();
        }

        public final void a() {
            int i10 = org.telegram.ui.ActionBar.k6.f21849nf;
            int i11 = ChatActivityEnterView.f24570j5;
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            int i02 = chatActivityEnterView.i0(i10);
            TextPaint textPaint = this.f24727a;
            textPaint.setColor(i02);
            int i12 = org.telegram.ui.ActionBar.k6.f21831mf;
            int i03 = chatActivityEnterView.i0(i12);
            TextPaint textPaint2 = this.f24728b;
            textPaint2.setColor(i03);
            this.f24734s = textPaint.getAlpha();
        ...
        public final void onDraw(Canvas canvas) {
            ...
            if (this.D != null && (staticLayout = this.E) != null) {
                ...
                if (chatActivityEnterView.J1 != null) {
                    ...
                    int i02 = chatActivityEnterView.i0(org.telegram.ui.ActionBar.k6.f21849nf);
                    TextPaint textPaint = this.f24727a;
                    textPaint.setColor(i02);
                    textPaint.setAlpha((int) ((1.0f - this.f24732n) * this.f24734s * this.f24733r));
                    this.f24728b.setAlpha((int) (this.v * this.f24732n));
                    int color = textPaint.getColor();
                    Paint paint = this.f24729c;
                    paint.setColor(color);
                    boolean z4 = true;
                    boolean z10 = this.J;
                    if (z10) {
                        this.f24735w = AndroidUtilities.dp(16.0f);
                    } else {
                        long currentTimeMillis = System.currentTimeMillis() - this.f24737y;
                        this.f24737y = System.currentTimeMillis();
                        if (this.f24732n == 0.0f && this.f24733r > 0.8f) {
                            if (this.f24736x) {
                                float dp3 = ((AndroidUtilities.dp(3.0f) / 250.0f) * ((float) currentTimeMillis)) + this.f24735w;
                                this.f24735w = dp3;
                                if (dp3 > AndroidUtilities.dp(6.0f)) {
                                    this.f24735w = AndroidUtilities.dp(6.0f);
                                    this.f24736x = false;
                                }
                            } else {
                                float dp4 = this.f24735w - ((AndroidUtilities.dp(3.0f) / 250.0f) * ((float) currentTimeMillis));
                                this.f24735w = dp4;
                    ...
                    int dp5 = AndroidUtilities.dp(5.0f) + ((int) ((getMeasuredWidth() - this.f24731f) / 2.0f));
                    ...
                    float f17 = dp5;
                    float f18 = this.f24735w;
                    float f19 = this.f24732n;
                    float dp6 = (((((1.0f - f19) * f18) * this.f24733r) + f17) - (f12 * f19)) + AndroidUtilities.dp(f11);
                    if (z4) {
                        dp = 0.0f;
                    } else {
                        dp = this.f24732n * AndroidUtilities.dp(12.0f);
                    }
                    if (this.f24732n != 1.0f) {
                        f13 = 12.0f;
                        int translationX = (int) ((chatActivityEnterView.J1.getTranslationX() * 0.3f) + ((1.0f - this.f24733r) * ((-getMeasuredWidth()) / 4)));
                        canvas.save();
        ...
        public final void onMeasure(int i10, int i11) {
            ...
            if (this.I != measuredHeight) {
                ...
                String str = this.d;
                TextPaint textPaint = this.f24727a;
                this.f24731f = textPaint.measureText(str);
                String str2 = this.f24730e;
                TextPaint textPaint2 = this.f24728b;
                ...
                this.D = new StaticLayout(this.d, textPaint, (int) this.f24731f, alignment, 1.0f, 0.0f, false);
                this.E = new StaticLayout(this.f24730e, textPaint2, (int) this.h, alignment, 1.0f, 0.0f, false);
            }
        }
        ...
        public final boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (this.f24732n == 0.0f || !isEnabled()) {
                return false;
            }
            ...
            if (z4) {
                ...
                if (motionEvent.getAction() == 1 && rect.contains(x10, y10)) {
                    ...
                    chatActivityEnterView.f24574a3 = null;
                    chatActivityEnterView.f24605f1 = 0L;
    ...
    public ChatActivityEnterView(Activity activity, pv0 pv0Var, org.telegram.ui.xn xnVar, boolean z4, final org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        this.f24636k3 = -1;
        this.f24644m3 = true;
        this.f24650n3 = new re(this, 0);
        this.f24655o3 = new ye(this);
        this.f24660p3 = new org.telegram.ui.Cells.b1(Integer.class, "translationY", 1);
        this.f24665q3 = new Property(Float.class, "scale");
        this.f24671r3 = new Property(Float.class, "controlsScale");
        this.f24677s3 = new Paint(1);
        ...
        pr prVar2 = xh.n.V;
        this.f24583b5 = new xd.c(0, this, prVar2, 250L);
        this.f24589c5 = new xd.a(1, this, prVar2, 250L, false);
        this.f24595d5 = new xd.a(2, this, prVar, 320L, false);
        this.f24602e5 = new xd.a(3, this, prVar, 320L, false);
        this.S3 = g6Var;
        this.T3 = z4;
        this.f24599e2 = z4 && !AndroidUtilities.isInMultiwindow && (xnVar == null || !xnVar.isInBubbleMode());
        Paint paint2 = new Paint(1);
        this.M1 = paint2;
        paint2.setColor(i0(org.telegram.ui.ActionBar.k6.f21615af));
        setFocusable(true);
        ...
        this.f24623i1 = pv0Var;
        this.f24629j1 = pv0Var;
        pv0Var.setDelegate(this);
        this.f24703x2 = MessagesController.getGlobalMainSettings().getBoolean("send_by_enter", false);
        ...
        int i13 = org.telegram.ui.ActionBar.k6.f21752i6;
        int i03 = i0(i13);
        ...
        imageView.setOnClickListener(new View.OnClickListener(this) {
            public final ChatActivityEnterView f31611b;
            ...
            public final void onClick(View view) {
                ...
                switch (r3) {
                    case 0:
                        ...
                        ChatActivityEnterView chatActivityEnterView = this.f31611b;
                    ...
                    default:
                        ...
                        ChatActivityEnterView chatActivityEnterView2 = this.f31611b;
                        ...
                        boolean z11 = chatActivityEnterView2.f24713z1;
                        ...
                        if (z11) {
                            if (chatActivityEnterView2.A1 != null) {
                                ...
                                f0Var.f26713h0 = new sd(chatActivityEnterView2, 0);
                                td tdVar = new td(chatActivityEnterView2, j10, g6Var2, 0);
                                f0Var.f26714i0 = j10;
                                f0Var.f26717l0 = tdVar;
                                f0Var.show();
                                return;
                            }
                            return;
                            ...
                            f0Var2.f26712g0 = new sd(chatActivityEnterView2, 1);
        ...
        if (z4) {
            ...
            if (i14 != 9) {
                ...
                this.f24578b0.a(this.f24587c2, false);
                if (this.f24587c2) {
                ...
                imageView2.setVisibility((!this.f24592d2 || ((egVar = this.V2) != null && egVar.H0())) ? 8 : 0);
        ...
        imageView3.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                ...
                switch (r3) {
                    case 0:
                        int i142 = ChatActivityEnterView.f24570j5;
                        ChatActivityEnterView chatActivityEnterView = this.f31611b;
                        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(chatActivityEnterView.getContext(), 0, g6Var);
                        String string = LocaleController.getString(R.string.ArticleDeleteDraftTitle);
                        org.telegram.ui.ActionBar.d2 d2Var = alertDialog$Builder.f21168a;
        ...
        this.C0 = mgVar;
        org.telegram.ui.ActionBar.l5 l5Var = mgVar.f29042a;
        ...
        this.f24681t2 = globalEmojiSettings.getInt("kbd_height", AndroidUtilities.dp(200.0f));
        this.f24686u2 = globalEmojiSettings.getInt("kbd_height_land3", AndroidUtilities.dp(200.0f));
        k1(false, false);
        J(false);
        E();
        W();
    ...
    public static void f(final ChatActivityEnterView chatActivityEnterView, final fv0 fv0Var, int[] iArr, yo0 yo0Var) {
        ...
        if (org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21932s8, true) == -1) {
            z4 = true;
        } else {
            z4 = false;
        }
        ...
        if (i10 >= 26) {
            if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21607a7, true)) >= 0.721f) {
                z10 = true;
            } else {
                z10 = false;
            }
        ...
        if (i10 >= 23) {
            chatActivityEnterView.f24657p0 = chatActivityEnterView.getRootWindowInsets().getSystemWindowInsetLeft() + chatActivityEnterView.f24657p0;
        }
        chatActivityEnterView.m0.getLocationInWindow(iArr2);
        final float f11 = iArr2[0];
        final float f12 = iArr2[1];
        float dp = AndroidUtilities.dp(5.0f);
        float dp2 = iArr[0] + chatActivityEnterView.f24657p0 + dp + AndroidUtilities.dp(4.0f) + 0.0f;
        float f13 = iArr[1] + chatActivityEnterView.f24662q0 + dp + 0.0f;
        ...
        ve veVar = chatActivityEnterView.f24647n0;
        boolean z11 = chatActivityEnterView.f24621h5;
        o1.c cVar = o1.h.f16322o;
        if (z11) {
            jVar = null;
        } else {
            o1.j jVar3 = new o1.j(chatActivityEnterView.m0, cVar);
            jVar3.f16338u = org.telegram.ui.yh.n(0.5f, 750.0f, 1.0f);
            jVar = jVar3;
        }
        boolean z12 = chatActivityEnterView.f24621h5;
        o1.c cVar2 = o1.h.f16323p;
        if (z12) {
            dialog = dialog2;
            jVar2 = null;
        } else {
            ...
            jVar4.f16338u = org.telegram.ui.yh.n(0.5f, 750.0f, 1.0f);
            jVar2 = jVar4;
        }
        o1.j jVar5 = new o1.j(chatActivityEnterView.m0, o1.h.f16327t);
        jVar5.f16338u = org.telegram.ui.yh.n(0.0f, 750.0f, 1.0f);
        final Dialog dialog3 = dialog;
        jVar5.a(new o1.f(chatActivityEnterView) {
            public final ChatActivityEnterView f29028b;

            {
                this.f29028b = chatActivityEnterView;
            }
            ...
            public final void a(o1.h hVar, boolean z13, float f15, float f16) {
                ...
                ChatActivityEnterView chatActivityEnterView2 = this.f29028b;
                switch (i11) {
                    case 0:
                        ...
                        if (dialog4.isShowing()) {
                            ...
                            if (!chatActivityEnterView2.f24621h5) {
        ...
        o1.j jVar6 = new o1.j(fv0Var, o1.h.f16320m);
        jVar6.f16329b = k7.o.a(dp2, f11 - AndroidUtilities.dp(6.0f), dp2);
        jVar6.f16330c = true;
        jVar6.f16338u = org.telegram.ui.yh.n(f11, 700.0f, 0.75f);
        jVar6.h = f11 - AndroidUtilities.dp(6.0f);
        o1.j jVar7 = new o1.j(fv0Var, o1.h.f16321n);
        jVar7.f16329b = k7.o.a(f13, f13, AndroidUtilities.dp(6.0f) + f12);
        jVar7.f16330c = true;
        jVar7.f16338u = org.telegram.ui.yh.n(f12, 700.0f, 0.75f);
        jVar7.f16333g = AndroidUtilities.dp(6.0f) + f12;
        ...
        jVar8.f16338u = org.telegram.ui.yh.n(dp3, 1000.0f, 1.0f);
        o1.j jVar9 = new o1.j(fv0Var, cVar2);
        jVar9.f16338u = org.telegram.ui.yh.n(dp3, 1000.0f, 1.0f);
    ...
    public static void g(ChatActivityEnterView chatActivityEnterView, TLRPC.Document document, String str, MessageObject.SendAnimationData sendAnimationData, boolean z4, int i10, int i11, Object obj, Long l10, boolean z10) {
        ...
        if (chatActivityEnterView.D0 > 0 && !chatActivityEnterView.c()) {
            ...
            if (egVar != null) {
                ...
                egVar.z1(mgVar, mgVar.f29042a.getText(), true);
                return;
            }
            return;
        }
    ...
    public static void h(ChatActivityEnterView chatActivityEnterView, TL_keyboard.KeyboardButton keyboardButton) {
        ...
        if (chatActivityEnterView.P2 != null && (xnVar = chatActivityEnterView.L2) != null && xnVar.f43148e4 && xnVar.b() == chatActivityEnterView.P2.getId()) {
            z4 = true;
        } else {
            z4 = false;
        }
        if ((chatActivityEnterView.P2 != null && !z4) || BotForumHelper.isBotForum(chatActivityEnterView.N, chatActivityEnterView.M2)) {
            ...
            messageObject = chatActivityEnterView.f24624i2;
        } else {
            messageObject = null;
        }
        MessageObject messageObject2 = chatActivityEnterView.P2;
        if (messageObject2 == null || z4) {
            messageObject2 = chatActivityEnterView.f24624i2;
        }
        ...
        if (chatActivityEnterView.P2 != null && !z4) {
            ...
            MessageObject messageObject3 = chatActivityEnterView.f24624i2;
            if (messageObject3 != null && messageObject3.messageOwner.reply_markup.single_use) {
                ...
                MessagesController.getMainSettings(chatActivityEnterView.N).edit().putInt("answered_" + chatActivityEnterView.getTopicKeyString(), chatActivityEnterView.f24624i2.getId()).commit();
            }
        }
        eg egVar = chatActivityEnterView.V2;
        if (egVar != null) {
    ...
    public static void i(ChatActivityEnterView chatActivityEnterView, MessageObject messageObject, TL_keyboard.KeyboardButtonProto keyboardButtonProto) {
        ...
        if (Build.VERSION.SDK_INT >= 23 && activity.checkSelfPermission("android.permission.ACCESS_COARSE_LOCATION") != 0) {
            ...
            chatActivityEnterView.f24600e3 = messageObject;
            chatActivityEnterView.f24607f3 = keyboardButtonProto;
            return;
        }
    ...
    public static void m(ChatActivityEnterView chatActivityEnterView) {
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(chatActivityEnterView, "lockAnimatedTranslation", chatActivityEnterView.f24614g4);
        ...
        animatorSet.playTogether(ofFloat2, ofFloat, ObjectAnimator.ofFloat(chatActivityEnterView, "slideToCancelProgress", 1.0f).setDuration(200L), ObjectAnimator.ofFloat(chatActivityEnterView.f24611g1, "cancelToProgress", 1.0f));
        animatorSet.start();
    }
                    ...
                    if (messageEntity.offset + messageEntity.length <= spannableStringBuilder.length()) {
                        if (messageEntity instanceof TLRPC.TL_inputMessageEntityMentionName) {
                            ...
                            if (messageEntity instanceof TLRPC.TL_messageEntityBold) {
                                ...
                                obj7.f30950b = i22;
                                obj7.f30951c = i22 + messageEntity.length;
    ...
    public final void A() {
        ...
        SlideTextView slideTextView = this.f24611g1;
    ...
    public final void A1() {
        ...
        eg.s3 s3Var = this.l1;
        if (s3Var != null) {
            s3Var.setTranslationX(this.f24706y + this.f24700x);
            ...
            ge geVar = this.f24648n1;
            if (geVar != null && this.f24699w4) {
                geVar.setAlpha(this.f24669r1 * this.C);
            }
        }
        qe qeVar = this.F1;
        if (qeVar != null) {
    ...
    public final void B0() {
        ...
        float audioLeft;
        float audioRight;
        rk0 rk0Var = this.f24598e1;
        if (rk0Var != null) {
            rk0Var.N = true;
            j71 j71Var = rk0Var.f30800n;
            if (j71Var != null) {
                j71Var.P(false);
                rk0Var.f30800n.H();
                rk0Var.f30800n = null;
        ...
        if (this.f24598e1 != null && this.X2 != null) {
            ...
            rk0 rk0Var2 = this.f24598e1;
            if (rk0Var2 == null) {
                audioLeft = 0.0f;
            } else {
                audioLeft = rk0Var2.getAudioLeft();
            }
            rk0 rk0Var3 = this.f24598e1;
            if (rk0Var3 == null) {
                audioRight = 1.0f;
            } else {
        ...
        PowerManager.WakeLock wakeLock = this.f24643m2;
        if (wakeLock != null) {
            try {
                wakeLock.release();
                this.f24643m2 = null;
        ...
        pv0 pv0Var = this.f24623i1;
        if (pv0Var != null) {
            pv0Var.setDelegate(null);
        }
        ve veVar = this.f24647n0;
        if (veVar != null) {
            veVar.f22220e = false;
            veVar.dismiss();
        }
    ...
    public final void C() {
        ...
        if (this.I == null && (seVar = this.G1) != null && seVar.getRight() != 0 && (xnVar = this.L2) != null && BirthdayController.isToday(xnVar.X7)) {
            ...
            if (mainSettings.getBoolean(Calendar.getInstance().get(1) + "bdayhint_" + xnVar.a(), true)) {
                ...
                this.I.m(1.0f, -((getWidth() - AndroidUtilities.dp(12.0f)) - ((this.G1.getMeasuredWidth() / 2.0f) + (this.G1.getX() + (this.l1.getX() + this.f24685u1.getX())))));
                addView(this.I, k7.c6.d(-1, 200.0f, 48, 0.0f, -192.0f, 0.0f, 0.0f));
                qh.e3 e3Var2 = this.I;
                e3Var2.f45272i0 = new id(this, 12);
                e3Var2.d = 8000L;
                e3Var2.u();
            }
        }
    ...
    public final void C1() {
        ...
        View m9;
        float f10;
        df dfVar = this.f24628j0;
        if (dfVar != null) {
            int childCount = dfVar.f47773c.getChildCount();
            int i10 = 0;
            for (int i11 = 0; i11 < childCount; i11++) {
                View childAt = this.f24628j0.f47773c.getChildAt(i11);
                if (i11 < 4) {
            ...
            } else if (this.f24633k0.f47820c.size() > 4) {
                c3 = l.d.c(162.8f, pv0Var.getMeasuredHeight(), 0);
            } else {
                c3 = l.d.c((Math.max(1, Math.min(4, this.f24633k0.f47820c.size())) * 36) + 8, pv0Var.getMeasuredHeight(), 0);
            }
            if (this.f24628j0.f47773c.getPaddingTop() != c3) {
                this.f24628j0.f47773c.setTopGlowOffset(c3);
                if (this.R4 == -1 && this.f24628j0.getVisibility() == 0 && this.f24628j0.f47773c.getLayoutManager() != null && (L0 = (j0Var = (f2.j0) this.f24628j0.f47773c.getLayoutManager()).L0()) >= 0 && (m9 = j0Var.m(L0)) != null) {
                    this.R4 = L0;
                    this.S4 = m9.getTop() - this.f24628j0.f47773c.getPaddingTop();
                }
                this.f24628j0.f47773c.setPadding(0, c3, 0, AndroidUtilities.dp(8.0f));
            }
        }
    }
    ...
    public final void D() {
        boolean z4;
        ff ffVar = this.B0;
        if ((ffVar == null || TextUtils.isEmpty(ffVar.getText())) && !this.f24691v2 && !this.f24613g3 && !t0()) {
            z4 = true;
        } else {
            z4 = false;
        }
        ...
        sh.z zVar = this.f24622i0;
        if (zVar != null) {
            boolean z10 = zVar.f47844f;
            if (z10 != z4) {
                zVar.f47844f = z4;
                zVar.requestLayout();
                zVar.invalidate();
            }
            if (z10 != this.f24622i0.f47844f) {
                de deVar = this.N0;
                Float valueOf = Float.valueOf(deVar.getX());
                HashMap hashMap = this.f24707y0;
    ...
    public final void E0() {
        ...
        if (!j0() || !v()) {
            getVisibility();
            if (this.f24618h2 && !org.telegram.ui.ActionBar.p2.hasSheets(this.L2)) {
                this.f24618h2 = false;
                eg egVar = this.V2;
                if (egVar != null) {
                    egVar.x1();
                ...
                if (!AndroidUtilities.usingHardwareInput && !this.f24691v2 && !AndroidUtilities.isInMultiwindow) {
                    this.f24613g3 = true;
                    re reVar = this.f24650n3;
    ...
    public final void F1() {
        float f10 = this.f24667r * this.h;
        de deVar = this.N0;
        deVar.setScaleX(f10);
        deVar.setScaleY(this.f24667r * this.h);
        deVar.setAlpha(this.f24673s * this.f24646n);
    }
    ...
    public final void G(int i10, boolean z4) {
        ...
        if (i10 > AndroidUtilities.dp(50.0f) && this.f24691v2 && !AndroidUtilities.isInMultiwindow) {
            if (z4) {
                this.f24686u2 = i10;
                MessagesController.getGlobalEmojiSettings().edit().putInt("kbd_height_land3", this.f24686u2).commit();
            } else {
                this.f24681t2 = i10;
                MessagesController.getGlobalEmojiSettings().edit().putInt("kbd_height", this.f24681t2).commit();
            }
        }
        if (this.f24691v2 && this.T0 && this.R0 == null) {
            this.T0 = false;
        }
        boolean t02 = t0();
        pv0 pv0Var = this.f24623i1;
        ...
        if (t02) {
            ...
            if (rfVar2 != null) {
                ...
                dh.f fVar2 = this.Z4;
                if (fVar2 != null && i11 > 0 && this.f24580b2 == 1) {
                    ((dh.i) fVar2).g(i11);
                }
            }
            if (view != null) {
                FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) view.getLayoutParams();
                if (!this.f24698w3 && !this.f24692v3 && (((i12 = layoutParams.width) != (i13 = AndroidUtilities.displaySize.x) || layoutParams.height != i11) && ((fVar = this.Z4) == null || i12 != -1 || layoutParams.height != -1))) {
                    if (fVar == null) {
                    ...
                    if (pv0Var != null) {
                        int i15 = this.f24697w2;
                        this.f24697w2 = layoutParams.height;
                        pv0Var.requestLayout();
                        G0();
                        if (this.f24599e2 && !this.f24691v2 && i15 != this.f24697w2 && N0()) {
                            AnimatorSet animatorSet = new AnimatorSet();
                            this.S0 = animatorSet;
                            if (this.Z4 != null) {
                                animatorSet.playTogether(ValueAnimator.ofFloat(this.f24697w2 - i15, 0.0f));
                            } else {
                                animatorSet.playTogether(ObjectAnimator.ofFloat(view, View.TRANSLATION_Y, this.f24697w2 - i15, 0.0f));
                            }
                            this.S0.setInterpolator(org.telegram.ui.ActionBar.r1.f22251w);
        ...
        this.f24691v2 = z10;
        D();
        if (this.f24691v2 && t0() && this.f24704x3 == null) {
            t1(0, this.f24580b2, true, true);
        } else if (!this.f24691v2 && !t0() && (messageObject = this.f24624i2) != null && this.P2 != messageObject && !j0() && !v() && !org.telegram.ui.ActionBar.p2.hasSheets(xnVar) && (((ffVar = this.B0) == null || TextUtils.isEmpty(ffVar.getText())) && (tL_replyKeyboardMarkup = this.f24630j2) != null && !tL_replyKeyboardMarkup.rows.isEmpty())) {
        ...
        if (this.f24697w2 != 0 && !(z11 = this.f24691v2) && z11 != z13 && !t0()) {
            this.f24697w2 = 0;
            pv0Var.requestLayout();
        }
        if (this.f24691v2 && this.f24613g3) {
            this.f24613g3 = false;
            if (this.f24640l3) {
                this.f24640l3 = false;
                this.D1.setButtons(this.f24630j2);
            }
            AndroidUtilities.cancelRunOnUIThread(this.f24650n3);
        }
        G0();
    }

    public final void G0() {
        int height = this.f24623i1.getHeight();
        if (!this.f24691v2) {
            height -= this.f24697w2;
        }
        eg egVar = this.V2;
        if (egVar != null) {
            egVar.p2(height);
    ...
    public final void G1(boolean z4) {
        ...
        ff ffVar = this.B0;
        if (ffVar != null) {
            CharSequence charSequence = this.f24596e;
            if (charSequence != null) {
                ffVar.setHintText(charSequence, z4);
                this.B0.setHintText2(this.f24603f, z4);
                return;
            }
            boolean z12 = true;
            boolean z13 = false;
            ...
            if (i10 == 9) {
                ...
                if (z10) {
                    ...
                    if (messageObject2 != null && (replyMarkup2 = messageObject2.messageOwner.reply_markup) != null && !TextUtils.isEmpty(replyMarkup2.placeholder)) {
                    ...
                    } else if (this.U0 && (messageObject = this.f24624i2) != null && (replyMarkup = messageObject.messageOwner.reply_markup) != null && !TextUtils.isEmpty(replyMarkup.placeholder)) {
                        this.B0.setHintText(this.f24624i2.messageOwner.reply_markup.placeholder, z4);
                        ...
                        TLRPC.TL_forumTopic findTopic = MessagesController.getInstance(this.N).getTopicsController().findTopic(xnVar.f43143e.f20845id, 1L);
                        ...
                        if (user != null && user.bot_forum_view && !user.bot_forum_can_manage_topics && xnVar != null && !xnVar.f43148e4) {
                            this.B0.setHintText(LocaleController.getString(R.string.SendBotNoThread));
                        } else if (xnVar != null && xnVar.F9() && !xnVar.f43148e4) {
                            if (xnVar.U3 != null && xnVar.f43134d4) {
        ...
        if (this.B0 != null) {
            ...
            if (messageObject == null || messageObject.needResendWhenEdit()) {
                ...
                if (z4 && this.f24621h5) {
                    ...
                    se seVar = this.f24680t1;
                    if (seVar != null && seVar.getVisibility() == 0 && (qeVar2 = this.F1) != null && qeVar2.getVisibility() == 0 && (geVar = this.f24648n1) != null && geVar.getVisibility() == 0) {
                        layoutParams.rightMargin = AndroidUtilities.dp(146.0f);
                    } else {
                        se seVar2 = this.f24680t1;
                ...
                if (aeVar != null) {
                    ...
                    this.f24579b1.setLayoutParams(layoutParams2);
                }
            }
        }
    }
    ...
    public final void I() {
        ...
        if (DialogObject.isChatDialog(this.M2)) {
            ...
            this.f24684u0 = ChatObject.canSendRoundVideo(chat);
            this.f24689v0 = ChatObject.canSendVoice(chat);
        } else {
            z4 = false;
        }
        ...
        if (!this.f24684u0 && z10) {
            z10 = false;
        }
        if (!this.f24689v0 && !z10) {
            if (!this.a2) {
                z11 = false;
            }
        } else {
    ...
    public final void I0() {
        ...
        if (!j0() || !v()) {
            ...
            if (!org.telegram.ui.ActionBar.p2.hasSheets(xnVar)) {
                if (!AndroidUtilities.usingHardwareInput && !AndroidUtilities.isInMultiwindow && ((xnVar == null || !xnVar.isInBubbleMode()) && !this.f24606f2)) {
                    i10 = 2;
                } else {
                    i10 = 0;
                }
                ...
                if (this.f24606f2) {
                    this.f24618h2 = true;
                } else if (!AndroidUtilities.usingHardwareInput && !this.f24691v2 && !AndroidUtilities.isInMultiwindow) {
    ...
    public final void K() {
        ...
        if (this.R0 != null) {
            ...
            int dp = ((((this.f24634k1 - AndroidUtilities.statusBarHeight) - AndroidUtilities.navigationBarHeight) - AndroidUtilities.dp(6.0f)) - org.telegram.ui.ActionBar.k.getCurrentActionBarHeight()) - getHeight();
            if (this.N1 == 2) {
                dp = Math.min(dp, AndroidUtilities.dp(175.0f) + i10);
            }
            int i11 = this.R0.getLayoutParams().height;
            if (i11 != dp) {
                AnimatorSet animatorSet = this.f24704x3;
                if (animatorSet != null) {
                    animatorSet.cancel();
                    this.f24704x3 = null;
                }
                this.f24715z3 = dp;
                org.telegram.ui.Cells.b1 b1Var = this.f24660p3;
                if (i11 > dp) {
                    ...
                    if (this.v) {
                        ...
                        if (this.Z4 != null) {
                            animatorSet2.playTogether(ValueAnimator.ofInt(-(this.f24715z3 - i10)), ValueAnimator.ofInt(-(this.f24715z3 - i10)));
                        } else {
                            animatorSet2.playTogether(ObjectAnimator.ofInt(this, b1Var, -(this.f24715z3 - i10)), ObjectAnimator.ofInt(this.R0, b1Var, -(this.f24715z3 - i10)));
                        ...
                        this.f24704x3 = animatorSet2;
                        animatorSet2.start();
                    }
                } else {
                    if (this.Z4 == null) {
                        this.R0.getLayoutParams().height = this.f24715z3;
                    }
                    this.f24623i1.requestLayout();
                    ff ffVar = this.B0;
                    if (ffVar != null) {
                    ...
                    if (this.Z4 != null) {
                        animatorSet3.playTogether(ValueAnimator.ofInt(-(this.f24715z3 - i10)), ValueAnimator.ofInt(-(this.f24715z3 - i10)));
                    } else {
                        animatorSet3.playTogether(ObjectAnimator.ofInt(this, b1Var, -(this.f24715z3 - i10)), ObjectAnimator.ofInt(this.R0, b1Var, -(this.f24715z3 - i10)));
    ...
    public final void K0(CharSequence charSequence, String str, CharSequence charSequence2) {
        ...
        if (this.B0 != null && (xnVar = this.L2) != null && MessagesController.getInstance(this.N).richEditorAvailable()) {
            ...
            z1Var.f50235n = charSequence2;
            z1Var.setResourceProvider(this.S3);
            z1Var.G = xnVar;
            z1Var.f50242s = xnVar.P;
            z1Var.v = xnVar.V;
    ...
    public final void K1(TLRPC.Chat chat, TLRPC.UserFull userFull) {
        ...
        if (chat != null) {
            ...
            this.X0 = z4;
            this.f24577b = ChatObject.canSendStickers(chat);
            boolean canSendPlain = ChatObject.canSendPlain(chat);
            this.f24695w0 = canSendPlain;
            if (!this.f24577b && !canSendPlain) {
                z10 = true;
            } else {
                z10 = false;
            }
            ...
            this.f24646n = f10;
            F1();
            if (!this.f24701x0 && (ufVar = this.R0) != null) {
                ufVar.M(-this.M2, !this.f24695w0, !this.f24577b);
            }
            this.f24684u0 = ChatObject.canSendRoundVideo(chat);
            this.f24689v0 = ChatObject.canSendVoice(chat);
        ...
        G1(false);
        boolean z12 = this.Z0;
        if (!this.f24684u0 && z12) {
            z12 = false;
        }
        if (!this.f24689v0 && !z12) {
            if (!this.a2) {
                z11 = false;
            }
        } else {
    ...
    public void L1(int i10, boolean z4) {
        ...
        Runnable runnable = this.f24585c0;
        if (runnable != null) {
        ...
        if (z13) {
            ...
            if (z14) {
                ...
                ig igVar = this.K1;
                if (igVar != null) {
                    igVar.f27813y.d(1, false, false);
                }
                MediaDataController mediaDataController = MediaDataController.getInstance(this.N);
                long j11 = this.M2;
                org.telegram.ui.xn xnVar = this.L2;
                property = property3;
                mediaDataController.toggleDraftVoiceOnce(j11, (xnVar == null || !xnVar.f43148e4) ? 0L : xnVar.b(), this.L);
                this.f24605f1 = 0L;
            }
            X();
            this.f24676s2 = 1;
            ...
            AnimatorSet animatorSet = this.f24659p2;
            if (animatorSet != null) {
                animatorSet.cancel();
            }
            AnimatorSet animatorSet2 = this.f24664q2;
            ...
            kg kgVar = this.f24617h1;
            if (kgVar != null) {
                kgVar.f28407a = 1.0f;
                kgVar.f28408b = System.currentTimeMillis();
                kgVar.f28409c = false;
                kgVar.f28410e = false;
                kgVar.f28411f.stop();
                kgVar.invalidate();
                this.f24617h1.setScaleX(0.0f);
                this.f24617h1.setScaleY(0.0f);
                this.f24617h1.h = true;
            }
            this.f24659p2 = new AnimatorSet();
            this.V0.setTranslationX(AndroidUtilities.dp(20.0f));
            this.V0.setAlpha(0.0f);
            if (this.M4 != 3) {
                this.f24611g1.setTranslationX(AndroidUtilities.dp(20.0f));
                this.f24611g1.setAlpha(0.0f);
                this.f24611g1.setCancelToProgress(0.0f);
                SlideTextView slideTextView = this.f24611g1;
                slideTextView.f24733r = 1.0f;
                slideTextView.setEnabled(true);
            } else {
                this.f24611g1.setTranslationX(0.0f);
                this.f24611g1.setAlpha(0.0f);
                this.f24611g1.setCancelToProgress(1.0f);
                this.f24611g1.setEnabled(true);
            }
            this.J1.c(this.M4 == 3);
            this.f24612g2 = false;
            x0();
            ...
            animatorSet3.playTogether(ObjectAnimator.ofFloat(this.N0, this.V3, 0.0f), ObjectAnimator.ofFloat(this.N0, this.X3, 0.0f), ObjectAnimator.ofFloat(this.f24617h1, property4, 1.0f), ObjectAnimator.ofFloat(this.f24617h1, property6, 1.0f), ObjectAnimator.ofFloat(this.V0, property2, 0.0f), ObjectAnimator.ofFloat(this.V0, property5, 1.0f));
            animatorSet3.playTogether(ObjectAnimator.ofFloat(this.f24611g1, property2, 0.0f));
            animatorSet3.playTogether(ObjectAnimator.ofFloat(this.f24611g1, property5, 1.0f));
            ig igVar3 = this.K1;
            if (igVar3 != null) {
            ...
            sh.z zVar = this.f24622i0;
            if (zVar != null) {
                animatorSet3.playTogether(ObjectAnimator.ofFloat(zVar, property4, 0.0f), ObjectAnimator.ofFloat(this.f24622i0, property6, 0.0f), ObjectAnimator.ofFloat(this.f24622i0, property5, 0.0f));
            }
            AnimatorSet animatorSet4 = new AnimatorSet();
            animatorSet4.playTogether(ObjectAnimator.ofFloat(this.B0, this.Z3, AndroidUtilities.dp(20.0f)), ObjectAnimator.ofFloat(this.B0, property5, 0.0f), ObjectAnimator.ofFloat(this.f24579b1, property5, 1.0f));
            if (z14) {
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.f24598e1, property5, 0.0f));
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.f24591d1, property5, 0.0f));
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.f24591d1, property6, 0.0f));
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.f24591d1, property4, 0.0f));
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.f24586c1, property5, 0.0f));
            }
            if (this.F1 != null) {
            ...
            if (s3Var != null) {
                ...
                ViewPropertyAnimator viewPropertyAnimator = this.f24642m1;
                ...
                ge geVar = this.f24648n1;
                this.f24669r1 = 0.0f;
                animatorSet4.playTogether(ObjectAnimator.ofFloat(geVar, property5, 0.0f), ObjectAnimator.ofFloat(this.f24648n1, property6, 0.5f), ObjectAnimator.ofFloat(this.f24648n1, property4, 0.5f));
            }
            xg.g gVar = this.f24576a5;
            if (gVar != null) {
                gVar.e(0, false, true);
            }
            this.f24659p2.playTogether(animatorSet3.setDuration(150L), animatorSet4.setDuration(150L), ObjectAnimator.ofFloat(this.J1, this.f24665q3, 1.0f).setDuration(300L));
            if (!z14) {
                this.f24659p2.playTogether(ObjectAnimator.ofFloat(this.J1, this.f24671r3, 1.0f).setDuration(300L));
            }
            this.f24659p2.addListener(new lf(this, z14));
            this.f24659p2.setInterpolator(new DecelerateInterpolator());
            this.f24659p2.start();
            this.V0.a(this.f24605f1);
        } else if (this.f24612g2 && i10 == 3) {
            return;
        } else {
            PowerManager.WakeLock wakeLock = this.f24643m2;
            if (wakeLock != null) {
            ...
            AnimatorSet animatorSet5 = this.f24659p2;
            if (animatorSet5 != null) {
                ...
                this.f24659p2.removeAllListeners();
                this.f24659p2.cancel();
            } else {
                z10 = false;
            }
            AnimatorSet animatorSet6 = this.f24664q2;
            ...
            if (z10 || i10 == 4) {
                ...
                this.f24659p2.playTogether(ObjectAnimator.ofFloat(this.N0, this.V3, 1.0f), ObjectAnimator.ofFloat(this.N0, this.X3, this.f24701x0 ? 0.5f : 1.0f), ObjectAnimator.ofFloat(this.f24617h1, property4, 0.0f), ObjectAnimator.ofFloat(this.f24617h1, property3, 0.0f), ObjectAnimator.ofFloat(this.J1, this.f24665q3, 0.0f), ObjectAnimator.ofFloat(this.J1, this.f24671r3, 0.0f), ObjectAnimator.ofFloat(this.W0, property5, 1.0f), ObjectAnimator.ofFloat(this.V0, property5, 0.0f), ObjectAnimator.ofFloat(this.W0, property5, 1.0f), ObjectAnimator.ofFloat(this.B0, property5, 1.0f), ObjectAnimator.ofFloat(this.B0, this.Z3, 0.0f), ObjectAnimator.ofFloat(this, "slideToCancelProgress", 1.0f));
                ig igVar4 = this.K1;
                if (igVar4 != null) {
                    i11 = 1;
                    c3 = 0;
                    this.f24659p2.playTogether(ObjectAnimator.ofFloat(igVar4, property5, 0.0f));
                    this.K1.a();
                } else {
                    i11 = 1;
                    c3 = 0;
                }
                sh.z zVar2 = this.f24622i0;
                if (zVar2 != null) {
                    AnimatorSet animatorSet7 = this.f24659p2;
                    float[] fArr = new float[i11];
                    f10 = 1.0f;
                    fArr[c3] = 1.0f;
                    ObjectAnimator ofFloat = ObjectAnimator.ofFloat(zVar2, property4, fArr);
                    sh.z zVar3 = this.f24622i0;
                    float[] fArr2 = new float[i11];
                    fArr2[c3] = 1.0f;
                    ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(zVar3, property3, fArr2);
                    sh.z zVar4 = this.f24622i0;
                ...
                if (meVar3 != null) {
                    ...
                    i12 = 1;
                    this.f24659p2.playTogether(ObjectAnimator.ofFloat(this.W0, property5, f10));
                    this.Y0.j(s0() ? ogVar2 : ogVar, true);
                } else {
                    i12 = 1;
                }
                if (this.F1 != null) {
                    AnimatorSet animatorSet8 = this.f24659p2;
                ...
                if (this.l1 != null) {
                    ViewPropertyAnimator viewPropertyAnimator2 = this.f24642m1;
                    ...
                    z11 = true;
                    r10 = 0;
                    this.f24659p2.playTogether(ObjectAnimator.ofFloat(this.l1, this.Y3, 0.0f), ObjectAnimator.ofFloat(this.l1, this.W3, 1.0f));
                    AnimatorSet animatorSet9 = this.f24659p2;
                    ge geVar2 = this.f24648n1;
                    this.f24669r1 = 1.0f;
                    animatorSet9.playTogether(ObjectAnimator.ofFloat(geVar2, property5, 1.0f), ObjectAnimator.ofFloat(this.f24648n1, property3, 1.0f), ObjectAnimator.ofFloat(this.f24648n1, property4, 1.0f));
                } else {
                    r10 = 0;
                    z11 = true;
                }
                xg.g gVar2 = this.f24576a5;
                if (gVar2 != 0) {
                    gVar2.e(r10, r10, z11);
                }
                this.f24612g2 = z11;
                x0();
                this.f24659p2.setDuration(150L);
            } else if (i10 == 3) {
                X();
                Y();
                SlideTextView slideTextView2 = this.f24611g1;
                ...
                if (this.Z0) {
                    ...
                    if (aeVar != null) {
                        aeVar.setAlpha(1.0f);
                        this.f24579b1.setVisibility(0);
                    }
                    kj0 kj0Var = this.f24591d1;
                    if (kj0Var != null) {
                    ...
                    y71 y71Var = this.f24586c1;
                    if (y71Var != null) {
                        y71Var.setVisibility(8);
                        x0();
                    }
                    ae aeVar2 = this.f24579b1;
                    if (aeVar2 != null) {
                        aeVar2.setVisibility(0);
                        f12 = 1.0f;
                        this.f24579b1.setAlpha(1.0f);
                    } else {
                        f12 = 1.0f;
                    }
                    rk0 rk0Var2 = this.f24598e1;
                    if (rk0Var2 != null) {
                        ...
                        this.f24598e1.setAlpha(0.0f);
                    }
                    z12 = true;
                }
                this.f24656o4 = z12;
                this.f24632j4 = f12;
                this.f24620h4 = this.f24614g4;
                this.f24608f4 = f12;
                SlideTextView slideTextView3 = this.f24611g1;
                ...
                kj0 kj0Var2 = this.f24591d1;
                if (kj0Var2 != null) {
                    kj0Var2.setAlpha(0.0f);
                    this.f24591d1.setScaleX(0.0f);
                    this.f24591d1.setScaleY(0.0f);
                    this.f24591d1.setProgress(0.0f);
                    this.f24591d1.i();
                }
                if (!this.Z0 && !this.f24693v4) {
                    viewGroup = (ViewGroup) this.f24579b1.getParent();
                    layoutParams = this.f24579b1.getLayoutParams();
                    viewGroup.removeView(this.f24579b1);
                    ...
                    this.f24623i1.addView(this.f24579b1, layoutParams2);
                    this.f24586c1.setVisibility(8);
                } else {
                    this.f24586c1.setVisibility(0);
                    viewGroup = null;
                    layoutParams = null;
                }
                x0();
                ...
                if (!z4) {
                    Z();
                    this.f24665q3.set(this.J1, Float.valueOf(1.0f));
                    this.J1.setTransformToSeekbar(1.0f);
                    if (!this.Z0) {
                        float f13 = this.f24641l4;
                        if (f13 != 0.0f && this.f24598e1 != null) {
                            this.f24598e1.setAlpha(pr.f30171j.getInterpolation(Math.max(0.0f, ((f13 - 0.38f) - 0.25f) / 0.37f)));
                            this.f24598e1.invalidate();
                        }
                    }
                    this.f24617h1.setScaleY(0.0f);
                    this.f24617h1.setScaleX(0.0f);
                    ...
                    this.V0.setTranslationX(-AndroidUtilities.dp(20.0f));
                    this.f24611g1.setAlpha(0.0f);
                    this.f24591d1.setAlpha(1.0f);
                    this.f24591d1.setScaleY(1.0f);
                    this.f24591d1.setScaleX(1.0f);
                    ...
                    sh.z zVar5 = this.f24622i0;
                    if (zVar5 != null) {
                        zVar5.setAlpha(0.0f);
                        this.f24622i0.setScaleX(0.0f);
                        this.f24622i0.setScaleY(0.0f);
                    }
                    if (s0()) {
                        this.f24586c1.setAlpha(1.0f);
                    }
                    if (viewGroup != null) {
                        this.f24623i1.removeView(this.f24579b1);
                        viewGroup.addView(this.f24579b1, layoutParams);
                    }
                    this.f24579b1.setAlpha(1.0f);
                    this.f24598e1.setAlpha(1.0f);
                    this.h = 0.0f;
                    this.f24646n = 0.0f;
                    F1();
                    x0();
                } else {
                    this.f24598e1.setAllowDraw(false);
                    ...
                    animatorSet11.playTogether(ObjectAnimator.ofFloat(this.f24617h1, property4, 0.0f), ObjectAnimator.ofFloat(this.f24617h1, property3, 0.0f), ObjectAnimator.ofFloat(this.V0, property5, 0.0f), ObjectAnimator.ofFloat(this.V0, property2, -AndroidUtilities.dp(20.0f)), ObjectAnimator.ofFloat(this.f24611g1, property5, 0.0f), ObjectAnimator.ofFloat(this.f24591d1, property5, 1.0f), ObjectAnimator.ofFloat(this.f24591d1, property4, 1.0f), ObjectAnimator.ofFloat(this.f24591d1, property3, 1.0f), ObjectAnimator.ofFloat(this.N0, this.V3, 0.0f), ObjectAnimator.ofFloat(this.N0, this.X3, 0.0f), ObjectAnimator.ofFloat(this.B0, property5, 0.0f));
                    kj0 kj0Var3 = this.f24591d1;
                    if (kj0Var3 != null) {
                    ...
                    if (s0()) {
                        this.f24586c1.setAlpha(0.0f);
                        c10 = 1;
                        c11 = 0;
                        animatorSet10.playTogether(ObjectAnimator.ofFloat(this.f24586c1, property5, 1.0f));
                    ...
                    AnimatorSet animatorSet12 = this.f24659p2;
                    ...
                    this.f24659p2.addListener(new oh.h3(this, viewGroup, layoutParams, 2));
                }
            } else if (i10 != 2 && i10 != 5) {
                me meVar5 = this.Y0;
                if (meVar5 != null) {
                ...
                animatorSet13.playTogether(ObjectAnimator.ofFloat(this.N0, this.V3, 1.0f), ObjectAnimator.ofFloat(this.N0, this.X3, this.f24701x0 ? 0.5f : 1.0f), ObjectAnimator.ofFloat(this.f24617h1, property4, 0.0f), ObjectAnimator.ofFloat(this.f24617h1, property3, 0.0f), ObjectAnimator.ofFloat(this.W0, property5, 1.0f));
                ig igVar6 = this.K1;
                if (igVar6 != null) {
                    animatorSet13.playTogether(ObjectAnimator.ofFloat(igVar6, property5, 0.0f));
                    this.K1.a();
                }
                sh.z zVar9 = this.f24622i0;
                if (zVar9 != null) {
                    f11 = 1.0f;
                    animatorSet13.playTogether(ObjectAnimator.ofFloat(zVar9, property4, 1.0f), ObjectAnimator.ofFloat(this.f24622i0, property3, 1.0f), ObjectAnimator.ofFloat(this.f24622i0, property5, 1.0f));
                } else {
                    f11 = 1.0f;
                }
                me meVar6 = this.Y0;
                ...
                if (this.l1 != null) {
                    ViewPropertyAnimator viewPropertyAnimator3 = this.f24642m1;
                    ...
                    ge geVar3 = this.f24648n1;
                    this.f24669r1 = 1.0f;
                    animatorSet13.playTogether(ObjectAnimator.ofFloat(geVar3, property5, 1.0f), ObjectAnimator.ofFloat(this.f24648n1, property3, 1.0f), ObjectAnimator.ofFloat(this.f24648n1, property4, 1.0f));
                } else {
                    r103 = 0;
                    i15 = 1;
                }
                xg.g gVar3 = this.f24576a5;
                if (gVar3 != 0) {
                ...
                ofFloat14.setDuration(this.f24590d0 ? 220L : 360L);
                this.D = 0.0f;
                J1();
                ObjectAnimator ofFloat15 = ObjectAnimator.ofFloat(this.B0, property5, 1.0f);
                ofFloat15.setStartDelay(this.f24673s == 1.0f ? 150L : 450L);
                ofFloat15.setDuration(200L);
                this.f24659p2.playTogether(animatorSet13, animatorSet14, ofFloat15, ofFloat14);
            } else {
                me meVar7 = this.Y0;
                if (meVar7 != null) {
                ...
                animatorSet15.playTogether(ObjectAnimator.ofFloat(this.N0, this.V3, 1.0f), ObjectAnimator.ofFloat(this.N0, this.X3, this.f24701x0 ? 0.5f : 1.0f), ObjectAnimator.ofFloat(this.f24617h1, property4, 0.0f), ObjectAnimator.ofFloat(this.f24617h1, property3, 0.0f));
                ig igVar7 = this.K1;
                if (igVar7 != null) {
                    animatorSet15.playTogether(ObjectAnimator.ofFloat(igVar7, property5, 0.0f));
                    this.K1.a();
                }
                sh.z zVar10 = this.f24622i0;
                if (zVar10 != null) {
                    animatorSet15.playTogether(ObjectAnimator.ofFloat(zVar10, property4, 1.0f), ObjectAnimator.ofFloat(this.f24622i0, property3, 1.0f), ObjectAnimator.ofFloat(this.f24622i0, property5, 1.0f));
                }
                AnimatorSet animatorSet16 = new AnimatorSet();
                animatorSet16.playTogether(ObjectAnimator.ofFloat(this.V0, property5, 0.0f), ObjectAnimator.ofFloat(this.V0, property2, -AndroidUtilities.dp(20.0f)), ObjectAnimator.ofFloat(this.f24611g1, property5, 0.0f), ObjectAnimator.ofFloat(this.f24611g1, property2, -AndroidUtilities.dp(20.0f)));
                if (i10 != 5) {
                    this.W0.setScaleX(0.0f);
                    this.W0.setScaleY(0.0f);
                    ge geVar4 = this.f24648n1;
                    if (geVar4 != null && geVar4.getVisibility() == 0) {
                        this.f24648n1.setScaleX(0.5f);
                        this.f24648n1.setScaleY(0.5f);
                    }
                    se seVar = this.f24680t1;
                    if (seVar != null && seVar.getVisibility() == 0) {
                        this.f24680t1.setScaleX(0.0f);
                        this.f24680t1.setScaleY(0.0f);
                    }
                    ...
                    if (this.l1 != null) {
                        ViewPropertyAnimator viewPropertyAnimator4 = this.f24642m1;
                        ...
                        ge geVar5 = this.f24648n1;
                        this.f24669r1 = 1.0f;
                        animatorSet15.playTogether(ObjectAnimator.ofFloat(geVar5, property5, 1.0f), ObjectAnimator.ofFloat(this.f24648n1, property3, 1.0f), ObjectAnimator.ofFloat(this.f24648n1, property4, 1.0f));
                    } else {
                        r102 = 0;
                        i14 = 1;
                    }
                    xg.g gVar4 = this.f24576a5;
                    if (gVar4 != 0) {
                    ...
                    if (this.l1 != null) {
                        ViewPropertyAnimator viewPropertyAnimator5 = this.f24642m1;
                        ...
                        ge geVar6 = this.f24648n1;
                        this.f24669r1 = 1.0f;
                        animatorSet17.playTogether(ObjectAnimator.ofFloat(geVar6, property5, 1.0f), ObjectAnimator.ofFloat(this.f24648n1, property3, 1.0f), ObjectAnimator.ofFloat(this.f24648n1, property4, 1.0f));
                    } else {
                        i13 = 1;
                    }
                    xg.g gVar5 = this.f24576a5;
                    if (gVar5 != null) {
                        gVar5.e(0, false, i13);
                    }
                    qe qeVar4 = this.F1;
                    ...
                    AnimatorSet animatorSet18 = this.f24659p2;
                ...
                ofFloat23.setStartDelay(this.f24673s == 1.0f ? 300L : 700L);
                ofFloat23.setDuration(200L);
                this.f24659p2.playTogether(animatorSet15, animatorSet16, ofFloat23, ObjectAnimator.ofFloat(this, "lockAnimatedTranslation", this.f24614g4).setDuration(200L));
                if (i10 != 5) {
                    ...
                    this.f24659p2.playTogether(ofFloat24);
                } else {
                    ChatActivityEnterView.this.f24651n4 = true;
                    ...
                    this.f24659p2.playTogether(duration);
                }
                kg kgVar2 = this.f24617h1;
                if (kgVar2 != null) {
                    kgVar2.f28410e = true;
                    hj0 hj0Var = kgVar2.f28411f;
                    hj0Var.Q(0.0f, true);
                    if (kgVar2.d) {
                        hj0Var.start();
                    }
            ...
            this.f24659p2.addListener(new of(this, i10));
            this.f24659p2.start();
            ng ngVar3 = this.V0;
            if (ngVar3 != null) {
                ngVar3.b();
    ...
    public final void M() {
        this.f24615g5 = y(true);
        float y10 = y(false);
        if (this.f24609f5 != y10) {
            this.f24609f5 = y10;
            A0(y10);
        }
    }
    ...
    public final void M1() {
        int i02 = i0(org.telegram.ui.ActionBar.k6.f21777jf);
        int i03 = i0(org.telegram.ui.ActionBar.k6.Sd);
        int i04 = i0(org.telegram.ui.ActionBar.k6.f21670df);
        kj0 kj0Var = this.f24591d1;
        if (kj0Var != null) {
            kj0Var.h(i02, "Cup Red");
            this.f24591d1.h(i02, "Box Red");
            this.f24591d1.h(i04, "Cup Grey");
            this.f24591d1.h(i04, "Box Grey");
            this.f24591d1.h(i03, "Line 1");
            this.f24591d1.h(i03, "Line 2");
            this.f24591d1.h(i03, "Line 3");
        }
    }
    ...
    public final void N() {
        ...
        int i11;
        int i12;
        float f10 = this.f24589c5.f50541e;
        if (this.C1 != null) {
            float measuredHeight = getMeasuredHeight() - this.f24583b5.f50546e;
            View view = this.C1;
    ...
    public final void N1() {
        boolean z4;
        RichMessageLayout.PreviewView previewView = this.f24708y1;
        if (previewView != null) {
            boolean z10 = this.f24713z1;
            ...
            if (z4) {
                ...
                this.f24708y1.set(this.A1);
                this.f24708y1.setVisibility(0);
                ff ffVar = this.B0;
                if (ffVar != null) {
    ...
    public final void O() {
        org.telegram.ui.xn xnVar = this.L2;
        if (xnVar != null) {
            MediaDataController.getInstance(this.N).saveDraft(xnVar.a(), xnVar.B7(xnVar.f43223k5), "", null, null, null, null, 0L, false, true, null);
        }
    ...
    public final void O1(boolean z4) {
        ...
        if (isChatDialog) {
            TLRPC.Chat chat = this.O.getMessagesController().getChat(Long.valueOf(-this.M2));
            this.f24587c2 = MessagesController.getNotificationsSettings(this.N).getBoolean("silent_" + this.M2, false);
            ...
            this.f24592d2 = z10;
            if (imageView != null) {
                if (this.f24578b0 == null) {
                    this.f24578b0 = new mr(getContext(), R.drawable.input_notify_on, org.telegram.ui.ActionBar.k6.Wk);
                }
                this.f24578b0.a(this.f24587c2, false);
                imageView.setImageDrawable(this.f24578b0);
            } else {
                z10 = false;
            }
            eg.s3 s3Var = this.l1;
    ...
    public final void Q() {
        ...
        this.f24680t1.setScaleType(ImageView.ScaleType.CENTER);
        this.f24680t1.setBackground(org.telegram.ui.ActionBar.k6.f0(i0(org.telegram.ui.ActionBar.k6.f21752i6), 1, -1));
        this.f24680t1.setVisibility(8);
        AndroidUtilities.updateViewVisibilityAnimated(this.f24680t1, false, 0.1f, false);
        this.l1.addView(this.f24680t1, 0, k7.c6.n(44, 44));
        this.f24680t1.setOnClickListener(new kd(this, 15));
    }

    public final void Q0(TL_iv.RichMessage richMessage) {
        org.telegram.ui.xn xnVar = this.L2;
        if (xnVar != null) {
            MediaDataController.getInstance(this.N).saveDraft(xnVar.a(), xnVar.B7(xnVar.f43223k5), "", null, null, null, null, 0L, false, false, richMessage);
        }
    ...
    public final void Q1(boolean z4, boolean z10) {
        ...
        if (this.V2 != null) {
            ...
            org.telegram.ui.xn xnVar = this.L2;
            boolean z12 = true;
            if (!z4 && peer2 != null && ((this.V2.F() == null || this.V2.F().peers.size() > 1) && !r0() && !w0() && (((aeVar = this.f24579b1) == null || aeVar.getVisibility() != 0) && ((this.f24621h5 || ((!ChatObject.isChannelAndNotMegaGroup(chat) || ChatObject.canSendAsPeers(chat)) && !ChatObject.isMonoForum(chat))) && (xnVar == null || xnVar.O3 != 9))))) {
                z11 = true;
            } else {
                z11 = false;
            }
            ...
            if (z12 != z11) {
                ...
                if ((!this.f24621h5 && (xnVar == null || xnVar.F8() != 0 || !xnVar.L5)) || !z10) {
                    float f15 = f11;
                    float f16 = f13;
                    boolean z13 = z11;
                    if (z13) {
    ...
    public final void R() {
        if (this.f24622i0 == null) {
            ...
            this.f24685u1.addView(this.f24622i0, k7.c6.d(-2, 32.0f, 83, 8.0f, 6.0f, 8.0f, 6.0f));
            AndroidUtilities.updateViewVisibilityAnimated(this.f24622i0, false, 1.0f, false);
            sh.z zVar2 = this.f24622i0;
            if (!zVar2.f47844f) {
                zVar2.f47844f = true;
                zVar2.h = 1.0f;
    ...
    public final void R1() {
        ...
        boolean z4 = true;
        if (this.f24666q4 != starsPrice) {
            View sendButtonInternal = getSendButtonInternal();
            this.f24666q4 = starsPrice;
    ...
    public final void S() {
        ...
        this.V.setTextColor(i0(org.telegram.ui.ActionBar.k6.f22038y6));
    ...
    public final void S1() {
        ...
        if (chatFull != null && chatFull.slowmode_seconds != 0 && chatFull.slowmode_next_send_date <= currentTime && ((isUploadingMessageIdDialog = SendMessagesHelper.getInstance(this.N).isUploadingMessageIdDialog(this.M2)) || SendMessagesHelper.getInstance(this.N).isSendingMessageIdDialog(this.M2))) {
            if (!ChatObject.hasAdminRights(this.O.getMessagesController().getChat(Long.valueOf(this.Z1.f20846id))) && !ChatObject.isIgnoredChatRestrictionsForBoosters(this.Z1)) {
            ...
            if (i12 >= 2147483646) {
                if (this.Z1 != null) {
                    this.O.getMessagesController().loadFullChat(this.Z1.f20846id, 0, true);
                }
                i10 = 0;
            } else {
                i10 = i12 - currentTime;
        ...
        if (this.D0 != 0 && i10 > 0) {
            ...
            mg mgVar = this.C0;
            mgVar.f29042a.l(formatDurationNoHours, false);
            mgVar.invalidate();
            eg egVar = this.V2;
            if (egVar != null) {
                egVar.z1(mgVar, mgVar.f29042a.getText(), false);
            }
    ...
    public final void T(boolean z4) {
        ...
        this.f24690v1.addView(this.B1, k7.c6.e(44, 44, 85));
    }
    ...
    public final void U() {
        ...
        if (ufVar != null && ufVar.Z0 != UserConfig.selectedAccount) {
            this.f24629j1.removeView(ufVar);
            this.R0 = null;
        }
        if (this.R0 != null) {
            return;
        ...
        uf ufVar2 = new uf(this, this.L2, z10, context, chatFull, this.f24623i1, z11, this.S3, z12, z4);
        this.R0 = ufVar2;
        ufVar2.f29324s0 = true;
        if (!this.f24688u4) {
            ufVar2.U();
        }
        ...
        uf ufVar4 = this.R0;
        if (ufVar4 != null) {
            ufVar4.M(-this.M2, !this.f24695w0, !this.f24577b);
        }
        u();
        E();
    }
    ...
    public final void V() {
        ...
        this.P0.setBackground(org.telegram.ui.ActionBar.k6.f0(i0(org.telegram.ui.ActionBar.k6.f21752i6), 1, -1));
        this.f24696w1.addView(this.P0, k7.c6.e(44, 44, 85));
    ...
    public final void W() {
        ...
        org.telegram.ui.xn xnVar = this.L2;
        if (xnVar != null && xnVar.getParentLayout() != null && ((ActionBarLayout) xnVar.getParentLayout()).f21113b) {
        ...
        this.B0.setLinkTextColor(i0(org.telegram.ui.ActionBar.k6.f21739hc));
        this.B0.setHighlightColor(i0(org.telegram.ui.ActionBar.k6.f21972uf));
        ff ffVar3 = this.B0;
        ...
        this.B0.setHandlesColor(i0(org.telegram.ui.ActionBar.k6.f21990vf));
        ff ffVar4 = this.B0;
        boolean z10 = this.T3;
        if (z10) {
            f10 = 50.0f;
        ...
        this.f24708y1 = previewView;
        previewView.setAllowActions(false);
        this.f24708y1.setMaxHeight(AndroidUtilities.dp(150.0f));
        this.f24708y1.setMinHeight(AndroidUtilities.dp(88.0f));
        this.f24708y1.setVisibility(8);
        this.f24708y1.setPadding(AndroidUtilities.dp(8.0f), AndroidUtilities.dp(9.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(10.0f));
        this.f24708y1.setOnClickListener(new kd(this, 10));
        RichMessageLayout.PreviewView previewView2 = this.f24708y1;
        if (z10) {
            i11 = 50;
        } else {
            i11 = 2;
    ...
    public final void X() {
        ...
        this.f24579b1.setFocusable(true);
        this.f24579b1.setFocusableInTouchMode(true);
        this.f24579b1.setClickable(true);
        this.f24685u1.addView(this.f24579b1, k7.c6.e(-1, 44, 80));
        ?? imageView = new ImageView(getContext());
        this.f24591d1 = imageView;
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        this.f24591d1.f(R.raw.chat_audio_record_delete_2, 28, 28, null);
        this.f24591d1.getAnimatedDrawable().m0 = true;
        M1();
        this.f24591d1.setContentDescription(LocaleController.getString("Delete", R.string.Delete));
        this.f24591d1.setBackgroundDrawable(org.telegram.ui.ActionBar.k6.f0(i0(org.telegram.ui.ActionBar.k6.f21752i6), 1, -1));
        this.f24579b1.addView(this.f24591d1, k7.c6.c(44.0f, 44));
        this.f24591d1.setOnClickListener(new kd(this, 6));
        y71 y71Var = new y71(getContext());
        this.f24586c1 = y71Var;
        y71Var.setVisibility(4);
        y71 y71Var2 = this.f24586c1;
        y71Var2.P = !this.f24688u4;
        y71Var2.setRoundFrames(true);
        this.f24586c1.setDelegate(new ue(this));
        this.f24579b1.addView(this.f24586c1, k7.c6.d(-1, -1.0f, 19, 56.0f, 0.0f, 8.0f, 0.0f));
        Context context = getContext();
        ...
        view.f32669b = context.getDrawable(R.drawable.tooltip_arrow);
        view.f32668a = org.telegram.ui.ActionBar.k6.b0(AndroidUtilities.dp(5.0f), org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21904qf, false));
        view.b();
        view.setTime(0);
        this.f24586c1.setTimeHintView(view);
        this.f24623i1.addView((View) view, k7.c6.d(-1, -2.0f, 80, 0.0f, 0.0f, 0.0f, 52.0f));
        rk0 rk0Var = new rk0(getContext(), this.S3);
        this.f24598e1 = rk0Var;
        this.f24579b1.addView(rk0Var, k7.c6.d(-1, 32.0f, 19, 44.0f, 0.0f, 4.0f, 0.0f));
        H1(this.L4);
    }
    ...
    public final void X0(a0.h hVar, boolean z4) {
        ...
        if (hVar.m() == 1 && ((TL_bots.BotInfo) hVar.n(0)).user_id == this.M2) {
            ...
            if (botMenuButton instanceof TL_bots.TL_botMenuButton) {
                ...
                this.f24604f0 = tL_botMenuButton.text;
                this.f24610g0 = tL_botMenuButton.url;
                this.f24627i5 = 3;
    ...
    public final void Z() {
        if (this.f24573a1 == null && getContext() != null) {
            eh.d dVar = new eh.d(getContext(), 14);
            this.f24573a1 = dVar;
            dVar.setClipChildren(false);
            this.f24573a1.setVisibility(8);
            this.f24685u1.addView(this.f24573a1, k7.c6.c(44.0f, -1));
            this.f24573a1.setOnTouchListener(new org.telegram.ui.ActionBar.s2(11));
            eh.d dVar2 = this.f24573a1;
            SlideTextView slideTextView = new SlideTextView(getContext());
            this.f24611g1 = slideTextView;
            ...
            this.f24573a1.addView(this.d, k7.c6.e(-1, -1, 16));
        }
    }
    ...
    public final void a0() {
        if (this.F1 == null && this.L2 != null) {
            ...
            mutate2.setColorFilter(new PorterDuffColorFilter(i0(org.telegram.ui.ActionBar.k6.f21777jf), mode));
            ...
            this.F1.setBackground(org.telegram.ui.ActionBar.k6.f0(i0(org.telegram.ui.ActionBar.k6.f21752i6), 1, -1));
            this.f24685u1.addView(this.F1, 2, k7.c6.e(44, 44, 85));
    ...
    public final void a1(MessageObject messageObject, String str, boolean z4, boolean z10) {
        ...
        if (str != null && getVisibility() == 0 && (ffVar = this.B0) != null) {
            ...
            if (z4) {
                ...
                if ((this.f24635k2 != 1 || z10) && user3 != null && user3.bot && !str.contains("@")) {
                ...
                if (!this.f24691v2 && this.f24580b2 == -1) {
                    H0();
                }
            } else if (this.D0 > 0 && !c()) {
                eg egVar2 = this.V2;
                if (egVar2 != null) {
                    mg mgVar = this.C0;
                    egVar2.z1(mgVar, mgVar.f29042a.getText(), true);
                }
            } else {
                if (messageObject != null && DialogObject.isChatDialog(this.M2)) {
                ...
                if ((this.f24635k2 != 1 || z10) && user != null && user.bot && !str.contains("@")) {
    ...
    public final void b0() {
        if (this.m0 == null && getContext() != null) {
            ...
            view.f25337a = imageReceiver;
            view.f25338b = new z8((org.telegram.ui.ActionBar.g6) null);
            Paint paint = new Paint(1);
            view.d = paint;
            Paint paint2 = new Paint(1);
            view.f25340e = paint2;
            ...
            paint.setColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21652cf, false));
            paint2.setColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21634bf, false));
            int dp = AndroidUtilities.dp(18.0f);
            int l1 = org.telegram.ui.ActionBar.k6.l1(0.2f, org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21661d6, false));
            ...
            this.f24685u1.addView(this.m0, k7.c6.d(36, 36.0f, 83, 4.66f, 4.0f, 4.66f, 4.0f));
        }
    }
    ...
    public final void b1(int i10, long j10) {
        ...
        this.f24695w0 = true;
        if (DialogObject.isChatDialog(this.M2)) {
            this.f24695w0 = ChatObject.canSendPlain(this.O.getMessagesController().getChat(Long.valueOf(-this.M2)));
        }
        O1(false);
        I1(false);
        I();
    ...
    public final boolean c0(TL_keyboard.KeyboardButtonProto keyboardButtonProto, MessageObject messageObject, MessageObject messageObject2, org.telegram.ui.vi viVar) {
        ...
        if (keyboardButtonProto != null && messageObject2 != null && ((xnVar = this.L2) == null || xnVar.O3 != 5)) {
            ...
            if (tL_inlineButtonTypeUrl != null) {
                ...
                if (u2Var != null) {
                    u2Var.P0 = false;
                    u2Var.f29116u1.setVisibility(8);
                    u2Var.S1(false, bool);
                    return false;
                }
                ...
                if (tL_inlineButtonTypeSwitchInline != null) {
                    if (!xnVar.Ca(tL_inlineButtonTypeSwitchInline)) {
                        if (tL_inlineButtonTypeSwitchInline.same_peer) {
                            ...
                            pyVar.f40278z2 = new androidx.car.app.utils.a(this, messageObject2, tL_inlineButtonTypeSwitchInline, 16);
                    ...
                    if (requestPeerType != null && messageObject2.messageOwner != null) {
                        if (requestPeerType instanceof TLRPC.TL_requestPeerTypeCreateBot) {
                            ...
                            org.telegram.ui.ij0 ij0Var = org.telegram.ui.ij0.f37718r0;
                            org.telegram.ui.ActionBar.p2 R = LaunchActivity.R();
                            if (R == null || org.telegram.ui.ij0.f37718r0 != null) {
                                return false;
                            }
                            org.telegram.ui.ij0 ij0Var2 = new org.telegram.ui.ij0(R, i10, bool2, bool3, xdVar);
                            ij0Var2.show();
                            org.telegram.ui.ij0.f37718r0 = ij0Var2;
                            return false;
                        } else {
                            ...
                            pyVar2.f40278z2 = new xd(this, messageObject2, tL_buttonTypeRequestPeer);
    ...
    public final void d0() {
        ...
        if (messageObject != null) {
            ...
            if (needResendWhenEdit && !ChatObject.canManageMonoForum(this.N, this.V1.getDialogId())) {
                if (xnVar == null || (of3 = xnVar.f43135d5) == null) {
            ...
            if (this.W - this.f24572a0 < 0) {
                ...
                if (!MessagesController.getInstance(this.N).premiumFeaturesBlocked() && MessagesController.getInstance(this.N).captionLengthLimitPremium > this.f24572a0) {
                    q1();
                    return;
                }
                return;
            ...
            if (!TextUtils.equals(charSequenceArr[0], this.V1.messageText) || ((entities != null && !entities.isEmpty()) || !this.V1.messageOwner.entities.isEmpty() || (this.V1.messageOwner.media instanceof TLRPC.TL_messageMediaWebPage))) {
                ...
                if (xnVar != null && (chat = xnVar.f43143e) != null && (((i10 = messageObject3.type) == 0 || i10 == 19) && !ChatObject.canSendEmbed(chat))) {
                    MessageObject messageObject4 = this.V1;
                    messageObject4.editingMessageSearchWebPage = false;
                    TLRPC.Message message = messageObject4.messageOwner;
                    message.flags &= -513;
                    message.media = null;
                } else if (xnVar != null && (messagePreviewParams = xnVar.f43122c5) != null) {
                    if (xnVar.D5 instanceof TLRPC.TL_webPagePending) {
                        ...
                        this.V1.messageOwner.media.webpage = xnVar.f43122c5.webpage;
                    } else {
                ...
                if (this.V1.needResendWhenEdit()) {
                    ...
                    if (xnVar == null || (of2 = xnVar.f43135d5) == null) {
    ...
    public final void d1(boolean z4, boolean z10) {
        ...
        de deVar = this.N0;
        if (deVar != null) {
            if (this.f24676s2 == 1 || ((aeVar = this.f24579b1) != null && aeVar.getVisibility() == 0)) {
                this.h = 0.0f;
                this.f24646n = 0.0f;
                F1();
                z10 = false;
            }
            og ogVar2 = og.f29752f;
            og ogVar3 = og.f29751e;
            if (z4 && this.f24580b2 == 0) {
                if (this.f24695w0) {
                    ogVar = og.d;
                } else {
                    return;
            ...
            if (!this.f24695w0 && ogVar == ogVar3) {
                ogVar3 = ogVar2;
            } else if (this.f24577b || ogVar == ogVar3) {
                ogVar3 = ogVar;
            }
            deVar.j(ogVar3, z10);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.emojiLoaded) {
            ...
            rf rfVar = this.D1;
            if (rfVar != null) {
                ArrayList arrayList = rfVar.f47544n;
            ...
            if (((Integer) objArr[0]).intValue() == this.C2) {
                if (this.f24676s2 != 0 && !this.f24625i3 && !c()) {
                    this.f24625i3 = true;
                ...
                if (i10 == NotificationCenter.recordPaused) {
                    ...
                    if (((Integer) objArr[0]).intValue() == this.C2) {
                        ...
                        if (obj instanceof VideoEditedInfo) {
                            ...
                            this.f24574a3 = videoEditedInfo;
                            String str = (String) objArr[2];
                            this.Y2 = str;
                            ArrayList<Bitmap> arrayList2 = (ArrayList) objArr[3];
                            this.f24605f1 = videoEditedInfo.estimatedDuration;
                            y71 y71Var = this.f24586c1;
                            if (y71Var != null) {
                                y71Var.setVideoPath(str);
                                this.f24586c1.setKeyframes(arrayList2);
                                this.f24586c1.setVisibility(0);
                                this.f24586c1.setMinProgressDiff(1000.0f / ((float) this.f24574a3.estimatedDuration));
                                x0();
                            }
                            L1(3, true);
                            J(false);
                        ...
                        if (this.X2 != null) {
                            ...
                            if (this.f24579b1 != null) {
                                ...
                                this.f24579b1.setAlpha(1.0f);
                                this.f24579b1.setVisibility(0);
                                this.f24591d1.setVisibility(0);
                                this.f24591d1.setAlpha(0.0f);
                                this.f24591d1.setScaleY(0.0f);
                                this.f24591d1.setScaleX(0.0f);
                                int i15 = 0;
                                while (true) {
                                ...
                                if (z4 && (geVar = this.f24648n1) != null) {
                                    this.f24669r1 = 0.0f;
                                    geVar.setAlpha(0.0f);
                                    geVar.setScaleX(0.0f);
                                    geVar.setScaleY(0.0f);
                                }
                                this.f24605f1 = (long) (1000.0d * d);
                                rk0 rk0Var = this.f24598e1;
                                String str2 = this.Y2;
                                if (!rk0Var.N) {
                                    rk0Var.f30801r = (float) d;
                                    rk0Var.f30802s = f10;
                                    rk0Var.v = f11;
                                    rk0Var.f30803w = false;
                                    rk0Var.h.q(AndroidUtilities.formatDuration((int) Math.round(Math.max(1.0d, d)), false), false, true);
                                    rk0Var.f30799f.a(false, false);
                                    if (rk0Var.f30800n == null) {
                                        j71 j71Var = new j71();
                                        rk0Var.f30800n = j71Var;
                                        j71Var.G = new androidx.biometric.f0(rk0Var, 28);
                                    }
                                    rk0Var.f30800n.D(Uri.fromFile(new File(str2)), "other");
                                    rk0Var.H = 0;
                                    rk0Var.I = bArr;
                                    rk0Var.invalidate();
                                }
                                ...
                                if (z4) {
                                    ...
                                    this.f24676s2 = 1;
                                    this.J1.c(false);
                                    this.f24671r3.set(this.J1, Float.valueOf(1.0f));
                                    ig igVar = this.K1;
                                    if (igVar != null) {
                    ...
                    if (!((Boolean) objArr[6]).booleanValue()) {
                        ...
                        if (longValue == this.M2 && (chatFull = this.Z1) != null && chatFull.slowmode_seconds != 0 && !MessageObject.isEphemeralMessageId(num2.intValue()) && (chat = this.O.getMessagesController().getChat(Long.valueOf(this.Z1.f20846id))) != null && !ChatObject.hasAdminRights(chat) && !ChatObject.isIgnoredChatRestrictionsForBoosters(chat)) {
                    ...
                    I1(true);
                } else if (i10 == NotificationCenter.currentUserPremiumStatusChanged && this.f24713z1 && (oeVar = this.G0) != null) {
                    oeVar.setLocked(!UserConfig.getInstance(this.N).isPremium());
                }
    ...
    public final void e() {
        ...
        ng ngVar = this.V0;
        if (ngVar != null && (textPaint = ngVar.f29459x) != null) {
            textPaint.setColor(ngVar.C.i0(org.telegram.ui.ActionBar.k6.f21849nf));
        }
        y71 y71Var = this.f24586c1;
        if (y71Var != null) {
            y71Var.f33405e.setColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21607a7, false));
            y71Var.I = 0;
            w71 w71Var = y71Var.M;
            if (w71Var != null) {
                w71Var.b();
        ...
        if (numberTextView != null && this.B0 != null) {
            if (this.f24572a0 - this.W < 0) {
                numberTextView.setTextColor(i0(org.telegram.ui.ActionBar.k6.f21878p7));
            } else {
                numberTextView.setTextColor(i0(org.telegram.ui.ActionBar.k6.f22038y6));
            }
        }
        Color.alpha(i0(org.telegram.ui.ActionBar.k6.f21634bf));
        df dfVar = this.f24628j0;
        if (dfVar != null) {
        ...
        this.f24702x1.setColorFilter(i0(org.telegram.ui.ActionBar.k6.hl), mode);
    }
    ...
    public final void e0(Canvas canvas, boolean z4) {
        ...
        int w10 = (int) e2.c.w(1.0f, this.f24711y4, org.telegram.ui.ActionBar.k6.f21749i3.getIntrinsicHeight(), this.P1);
        View view = this.C1;
        if (view != null && view.getVisibility() == 0) {
            w10 = (int) (((1.0f - getTopViewEnterProgress()) * this.C1.getLayoutParams().height) + w10);
        }
        int intrinsicHeight = org.telegram.ui.ActionBar.k6.f21749i3.getIntrinsicHeight() + w10;
        if (z4) {
            org.telegram.ui.ActionBar.k6.f21749i3.setAlpha((int) (this.f24711y4 * 255.0f));
            org.telegram.ui.ActionBar.k6.f21749i3.setBounds(0, w10, getMeasuredWidth(), intrinsicHeight);
            org.telegram.ui.ActionBar.k6.f21749i3.draw(canvas);
        }
        if (this.f24683t4) {
            int i02 = i0(org.telegram.ui.ActionBar.k6.Sd);
            Paint paint2 = this.f24705x4;
            paint2.setColor(i02);
            if (SharedConfig.chatBlurEnabled() && this.f24623i1 != null) {
                this.z4.set(0, intrinsicHeight, getWidth(), getHeight());
                this.f24623i1.J(canvas, getTop(), this.z4, paint2, false);
                return;
            }
    ...
    public final pf g0(MessageObject messageObject, boolean z4) {
        ...
        if (z4) {
            ...
            messageObject2.caption = MessageObject.replaceAnimatedEmoji(Emoji.replaceEmoji((CharSequence) spannableStringBuilder, org.telegram.ui.ActionBar.k6.f21855o2.getFontMetricsInt(), false, (int[]) null), entities, org.telegram.ui.ActionBar.k6.f21855o2.getFontMetricsInt());
        }
    ...
    public sh.e3 getBotWebViewButton() {
        if (this.f24616h0 == null) {
            Context context = getContext();
            ?? frameLayout = new FrameLayout(context);
            frameLayout.f47441a = new Path();
            frameLayout.f47443c = org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.Oh, false);
            ...
            this.f24616h0 = frameLayout;
            frameLayout.setVisibility(8);
            R();
            this.f24616h0.setBotMenuButton(this.f24622i0);
            this.f24685u1.addView(this.f24616h0, k7.c6.e(-1, -1, 80));
        }
    ...
    public pv0 getSizeNotifierLayout() {
        return this.f24623i1;
    }

    public float getSlideToCancelProgress() {
        return this.f24608f4;
    }

    public CharSequence getSlowModeTimer() {
        if (this.D0 > 0) {
            return this.C0.f29042a.getText();
        }
        return null;
    }
    ...
    public int getStickersExpandedHeight() {
        return this.f24715z3;
    }

    public ImageView getSuggestButton() {
        return this.f24675s1;
    }
    ...
    public void h1(float f10, float f11, float f12, boolean z4) {
        ...
        aeVar.setAlpha(f12);
        ImageView imageView = this.f24675s1;
        if (imageView != null) {
    ...
    public final void i1(boolean z4) {
        ...
        this.f24648n1.setVisibility(i10);
        if (z4) {
    ...
    public final void l1(MessageObject messageObject, org.telegram.ui.nn nnVar, MessageObject messageObject2) {
        ...
        if (messageObject != null) {
            if (this.S2 == null && (messageObject3 = this.f24624i2) != this.P2) {
                this.S2 = messageObject3;
            }
            this.P2 = messageObject;
            this.R2 = nnVar;
            this.Q2 = messageObject2;
            if (xnVar == null || !xnVar.f43148e4 || xnVar.U3 != messageObject) {
                Z0(messageObject, true, true);
            }
        } else if (this.P2 == this.f24624i2) {
            this.P2 = null;
            this.Q2 = null;
            this.R2 = null;
    ...
    public final void m1(int i10, boolean z4) {
        ...
        if (z10 != z11) {
            ValueAnimator valueAnimator = this.f24674s0;
            if (valueAnimator != null) {
                valueAnimator.removeAllListeners();
                this.f24674s0.cancel();
            }
            float f10 = 0.0f;
            if (!z4) {
                if (z10) {
                ...
                float f11 = this.f24679t0;
                if (z10) {
                    f10 = 1.0f;
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(f11, f10);
                this.f24674s0 = ofFloat;
                ofFloat.addUpdateListener(new gd(this, 4));
                this.f24674s0.addListener(new te(this, z10, 3));
                this.f24674s0.setDuration(220L);
                this.f24674s0.setInterpolator(pr.f30168f);
                this.f24674s0.start();
            }
        }
        this.N1 = i10;
    ...
    public final void n(TLRPC.Document document) {
        ...
        if (ufVar != null && document != null) {
            boolean isEmpty = ufVar.f29285f1.isEmpty();
            ufVar.Y();
            if (isEmpty) {
                ufVar.Z(false);
            }
    ...
    public final boolean n0(boolean z4, boolean z10, boolean z11) {
        ...
        TLRPC.TL_replyKeyboardMarkup tL_replyKeyboardMarkup;
        if (t0()) {
            if (this.f24580b2 == 1 && (tL_replyKeyboardMarkup = this.f24630j2) != null && z4 && this.f24624i2 != null) {
                if (!tL_replyKeyboardMarkup.is_persistent) {
                    SharedPreferences.Editor edit = MessagesController.getMainSettings(this.N).edit();
                    edit.putInt("closed_botkeyboard_" + getTopicKeyString(), this.f24624i2.getId()).apply();
                }
            }
            if ((z4 && this.N1 != 0) || z10) {
                m1(0, true);
    ...
    public final void n1(boolean z4, boolean z10, boolean z11, boolean z12) {
        ...
        if ((r1Var == null || !r1Var.f22256f) && !this.f24619h3 && this.R0 != null) {
            if (z11 || this.f24692v3 != z4) {
                this.f24692v3 = z4;
                eg egVar = this.V2;
                if (egVar != null) {
                    egVar.y1();
                ...
                if (z13) {
                    ...
                    this.f24715z3 = dp;
                    if (this.N1 == 2) {
                        this.f24715z3 = Math.min(dp, AndroidUtilities.dp(175.0f) + i10);
                    }
                    if (this.Z4 == null) {
                        this.R0.getLayoutParams().height = this.f24715z3;
                    }
                    ...
                    if (z10) {
                        AnimatorSet animatorSet2 = new AnimatorSet();
                        if (this.Z4 != null) {
                            animatorSet2.playTogether(ValueAnimator.ofInt(-(this.f24715z3 - i10)), ValueAnimator.ofInt(-(this.f24715z3 - i10)), ObjectAnimator.ofFloat(this.B3, "animationProgress", 1.0f));
                        } else {
                            animatorSet2.playTogether(ObjectAnimator.ofInt(this, b1Var, -(this.f24715z3 - i10)), ObjectAnimator.ofInt(this.R0, b1Var, -(this.f24715z3 - i10)), ObjectAnimator.ofFloat(this.B3, "animationProgress", 1.0f));
                        }
                        animatorSet2.setDuration(300L);
                        animatorSet2.setInterpolator(pr.f30168f);
                        if (this.Z4 == null) {
                            ((ObjectAnimator) animatorSet2.getChildAnimations().get(0)).addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                                public final ChatActivityEnterView f29738b;
                                ...
                                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                    int i11 = r3;
                                    int i12 = i10;
                                    ChatActivityEnterView chatActivityEnterView = this.f29738b;
                                    switch (i11) {
                                        case 0:
                                            int i13 = ChatActivityEnterView.f24570j5;
                                            chatActivityEnterView.f24710y3 = Math.abs(chatActivityEnterView.getTranslationY() / (-(chatActivityEnterView.f24715z3 - i12)));
                                            chatActivityEnterView.f24623i1.invalidate();
                                            return;
                                        default:
                                            int i14 = ChatActivityEnterView.f24570j5;
                                            chatActivityEnterView.f24710y3 = chatActivityEnterView.getTranslationY() / (-(chatActivityEnterView.f24715z3 - i12));
                                            chatActivityEnterView.f24623i1.invalidate();
                                            return;
                                    }
                                }
                        ...
                        this.f24710y3 = 1.0f;
                        if (this.Z4 == null) {
                            setTranslationY(-(this.f24715z3 - i10));
                            this.R0.setTranslationY(-(this.f24715z3 - i10));
                        }
    ...
    public final void o(TLRPC.Document document) {
        ...
        boolean isEmpty = ufVar.f29288g1.isEmpty();
        ufVar.f29288g1 = MediaDataController.getInstance(i10).getRecentStickers(0, true);
        dz dzVar = ufVar.f29333v0;
        if (dzVar != null) {
            dzVar.l();
        }
        if (isEmpty) {
    ...
    public final void o0(boolean z4) {
        ...
        if (animatorSet2 == null || !animatorSet2.isRunning()) {
            ...
            if (z4) {
                ...
                arrayList.add(ObjectAnimator.ofFloat(this.f24591d1, property3, 0.0f));
                arrayList.add(ObjectAnimator.ofFloat(this.f24591d1, property2, 0.0f));
                arrayList.add(ObjectAnimator.ofFloat(this.f24591d1, property, 0.0f));
                arrayList.add(ObjectAnimator.ofFloat(this.f24579b1, property3, 0.0f));
                if (geVar != null) {
                    ViewPropertyAnimator viewPropertyAnimator = this.f24642m1;
                    if (viewPropertyAnimator != null) {
                        viewPropertyAnimator.cancel();
                ...
                this.f24664q2.playTogether(arrayList);
                sh.z zVar = this.f24622i0;
                if (zVar != null) {
                    zVar.setAlpha(0.0f);
                    this.f24622i0.setScaleY(0.0f);
                    this.f24622i0.setScaleX(0.0f);
                    this.f24664q2.playTogether(ObjectAnimator.ofFloat(this.f24622i0, property3, 1.0f), ObjectAnimator.ofFloat(this.f24622i0, property2, 1.0f), ObjectAnimator.ofFloat(this.f24622i0, property, 1.0f));
                }
                this.f24664q2.setDuration(150L);
                this.f24664q2.addListener(new pe(this, 1));
            } else {
                kj0 kj0Var = this.f24591d1;
                if (kj0Var != null) {
                    kj0Var.d();
                ...
                if (z10) {
                    arrayList2.add(ObjectAnimator.ofFloat(this.f24586c1, property3, 0.0f));
                    arrayList2.add(ObjectAnimator.ofFloat(this.f24586c1, property4, -AndroidUtilities.dp(20.0f)));
                    ...
                    ff ffVar = this.B0;
                    if (ffVar != null && this.f24673s == 1.0f) {
                        ffVar.setAlpha(1.0f);
                        this.D = 0.0f;
                        J1();
                    } else {
                    ...
                    arrayList2.add(ObjectAnimator.ofFloat(this.f24598e1, property3, 0.0f));
                    arrayList2.add(ObjectAnimator.ofFloat(this.f24598e1, property4, -AndroidUtilities.dp(20.0f)));
                    ig igVar3 = this.K1;
                    if (igVar3 != null) {
                ...
                ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(this.f24591d1, property3, 0.0f);
                ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(this.f24591d1, property2, 0.0f);
                ObjectAnimator ofFloat5 = ObjectAnimator.ofFloat(this.f24591d1, property, 0.0f);
                ObjectAnimator ofFloat6 = ObjectAnimator.ofFloat(this.f24591d1, property3, 0.0f);
                if (this.f24701x0) {
                    f10 = 0.5f;
                } else {
                    f10 = 1.0f;
                ...
                if (zVar2 != null) {
                    ...
                    this.f24622i0.setScaleY(0.0f);
                    this.f24622i0.setScaleX(0.0f);
                    animatorSet5.playTogether(ObjectAnimator.ofFloat(this.f24622i0, property3, 1.0f), ObjectAnimator.ofFloat(this.f24622i0, property2, 1.0f), ObjectAnimator.ofFloat(this.f24622i0, property, 1.0f));
                }
                animatorSet5.setDuration(150L);
                animatorSet5.setStartDelay(600L);
                AnimatorSet animatorSet6 = new AnimatorSet();
                this.f24664q2 = animatorSet6;
                if (animatorSet != null) {
                    animatorSet6.playTogether(animatorSet3, animatorSet, animatorSet5);
                } else {
                    animatorSet6.playTogether(animatorSet3, animatorSet5);
                }
                this.f24664q2.addListener(new jf(this));
            }
            AnimatorSet animatorSet7 = this.f24664q2;
    ...
    public final void o1(boolean z4, boolean z10) {
        ...
        if (this.f24672r4 != z4 || !z10) {
            ...
            if (imageView == null) {
                if (z4 || this.f24621h5) {
                    if (imageView == null) {
                        ...
                        this.f24675s1 = imageView2;
                        imageView2.setScaleType(ImageView.ScaleType.CENTER);
                        this.f24675s1.setColorFilter(new PorterDuffColorFilter(i0(org.telegram.ui.ActionBar.k6.Wk), PorterDuff.Mode.MULTIPLY));
                        this.f24675s1.setImageResource(R.drawable.input_suggest_paid_24);
                        this.f24675s1.setBackground(org.telegram.ui.ActionBar.k6.f0(i0(org.telegram.ui.ActionBar.k6.f21752i6), 1, -1));
                        if (this.f24621h5) {
                            this.f24675s1.setTranslationX(AndroidUtilities.dp(42.0f));
                            this.f24690v1.addView(this.f24675s1, k7.c6.d(44, 44.0f, 85, 0.0f, 0.0f, 50.0f, 0.0f));
                        } else {
                            this.l1.addView(this.f24675s1, 0, k7.c6.n(44, 44));
                        }
                        this.f24675s1.setOnClickListener(new kd(this, 19));
                        this.f24675s1.setContentDescription(LocaleController.getString(R.string.AccDescrAttachButton));
                    }
                } else {
                    return;
                }
            ...
            this.f24675s1.setEnabled(z4);
            this.f24675s1.setClickable(z4);
            ValueAnimator valueAnimator = this.f24678s4;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                this.f24678s4 = null;
            }
            if (z10) {
                if (this.f24621h5) {
                    this.f24675s1.setVisibility(0);
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f24675s1.getAlpha(), f11);
                this.f24678s4 = ofFloat;
                ofFloat.addUpdateListener(new gd(this, 7));
                this.f24678s4.addListener(new te(this, z4, 0));
                this.f24678s4.setDuration(220L);
                this.f24678s4.setInterpolator(pr.h);
                this.f24678s4.start();
            } else {
                this.f24675s1.setScaleX(f10);
                this.f24675s1.setScaleY(f10);
                this.f24675s1.setAlpha(f11);
                if (this.f24621h5) {
                    ImageView imageView3 = this.f24675s1;
                    if (!z4) {
                        i10 = 8;
                    }
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        if (this.R4 != -1 && (dfVar = this.f24628j0) != null) {
            f2.j0 j0Var = (f2.j0) dfVar.f47773c.getLayoutManager();
            if (j0Var != null) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (zVar != null && zVar.getTag() != null) {
            ...
            if (ap0Var != null && ap0Var.getVisibility() == 0) {
                ...
                RichMessageLayout.PreviewView previewView3 = this.f24708y1;
        ...
        C1();
        super.onMeasure(i10, i11);
        sh.e3 e3Var = this.f24616h0;
        if (e3Var != null) {
            sh.z zVar6 = this.f24622i0;
            if (zVar6 != null) {
                e3Var.setMeasuredButtonWidth(zVar6.getMeasuredWidth());
            }
            this.f24616h0.getLayoutParams().height = getMeasuredHeight() - AndroidUtilities.dp(2.0f);
            measureChild(this.f24616h0, i10, i11);
        }
        M();
        N();
        if (measuredHeight > 0 && aeVar.getMeasuredHeight() != measuredHeight) {
            for (int i13 = 0; i13 < 2; i13++) {
                if (i13 == 0) {
                    imageView = this.f24658p1;
                } else {
                    imageView = this.f24663q1;
                }
    ...
    public final ValueAnimator p(float f10) {
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.F1.f30391a, f10);
    ...
    public final void p0() {
        ...
        if (rk0Var != null) {
            ...
            this.f24598e1.setTranslationX(0.0f);
        }
        y71 y71Var2 = this.f24586c1;
        if (y71Var2 != null) {
            y71Var2.setAlpha(1.0f);
            this.f24586c1.setTranslationX(0.0f);
        }
        ff ffVar = this.B0;
        if (ffVar != null) {
            ffVar.setAlpha(1.0f);
    ...
    public final void p1(boolean z4) {
        ...
        float f10;
        float f11;
        if ((z4 || this.f24713z1) && (xnVar = this.L2) != null && !xnVar.w()) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (this.G4 != z10) {
            ...
            this.G4 = z10;
            ImageView imageView = this.f24658p1;
            imageView.setVisibility(0);
            ...
            if (z10) {
                ...
                if (MessagesController.getGlobalMainSettings().getInt("aihintshown", 0) < 3) {
                    ...
                    qh.e3 e3Var3 = this.J;
                    e3Var3.f45272i0 = new org.telegram.ui.mp(12, this, e3Var2);
                    e3Var3.d = 4000L;
                    e3Var3.u();
    ...
    public final void q1() {
        org.telegram.ui.xn xnVar = this.L2;
        if (xnVar != null && ChatObject.isChannelAndNotMegaGroup(xnVar.f43143e)) {
    ...
    public void setBotWebViewButtonOffsetX(float f10) {
        ...
        this.f24648n1.setTranslationX(this.f24706y + this.f24700x + f10);
    ...
    public void setChatInfo(TLRPC.ChatFull chatFull) {
        ...
        mg mgVar = this.C0;
        if (mgVar != null) {
            mgVar.f29045e = ChatObject.isPossibleRemoveChatRestrictionsByBoosts(chatFull);
            mgVar.invalidate();
        }
    ...
    public void setEditingBusinessLink(TL_account.TL_businessChatLink tL_businessChatLink) {
        ...
        if (this.X1 != null) {
            ...
            this.B1.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setDuration(150L).setInterpolator(pr.f30168f).start();
    ...
    public void setFieldFocused(boolean z4) {
        ...
        if (this.B0 != null && !accessibilityManager.isTouchExplorationEnabled()) {
            ...
            if (ffVar != null && ffVar.isFocused()) {
                if (!this.f24691v2 || this.f24606f2) {
                    this.B0.clearFocus();
                }
            }
        }
    ...
    public void setSlideToCancelProgress(float f10) {
        ...
        this.f24661p4 = (int) ((1.0f - this.f24608f4) * (-measuredWidth));
        RecordCircle recordCircle = this.J1;
        if (recordCircle != null) {
            recordCircle.invalidate();
        }
    ...
    public final void t1(int i10, int i11, boolean z4, boolean z10) {
        ...
        if (i10 != 2) {
            ...
            if (i10 == 1) {
                ...
                if (i11 == 0) {
                    ...
                    if (ufVar2 != null && ufVar2.getVisibility() != 8) {
                        this.f24629j1.removeView(this.R0);
                        this.R0.setVisibility(8);
                        this.R0.setShowing(false);
                        this.T0 = false;
                ...
                if (this.f24681t2 <= 0) {
                    f10 = 200.0f;
                    this.f24681t2 = MessagesController.getGlobalEmojiSettings().getInt("kbd_height", AndroidUtilities.dp(200.0f));
                } else {
                    f10 = 200.0f;
                }
                if (this.f24686u2 <= 0) {
                    this.f24686u2 = MessagesController.getGlobalEmojiSettings().getInt("kbd_height_land3", AndroidUtilities.dp(f10));
                }
                Point point = AndroidUtilities.displaySize;
                if (point.x > point.y) {
                    i15 = this.f24686u2;
                ...
                if (pv0Var != null) {
                    ...
                    B1(true);
                    G0();
                    if (this.f24599e2 && !this.f24691v2 && i15 != i13 && z4) {
                ...
                if (ufVar3 != null) {
                    if (i10 == 2 && !AndroidUtilities.usingHardwareInput && !AndroidUtilities.isInMultiwindow) {
                        ...
                        this.f24629j1.removeView(this.R0);
                        this.R0 = null;
                    } else if (this.f24599e2 && !this.f24691v2 && !this.f24692v3) {
                        this.T0 = true;
                        this.f24636k3 = 0;
                ...
                if (rfVar4 != null && rfVar4.getVisibility() == 0) {
                    if (i10 != 2 || AndroidUtilities.usingHardwareInput || AndroidUtilities.isInMultiwindow) {
                        if (this.f24599e2 && !this.f24691v2) {
                            if (this.U0) {
                                this.f24636k3 = 1;
                            }
                            AnimatorSet animatorSet3 = new AnimatorSet();
                            ...
                            AndroidUtilities.runOnUIThread(reVar, 50L);
                            requestLayout();
                        } else if (!this.f24613g3) {
                            this.D1.setVisibility(8);
                        }
                    }
                    this.U0 = false;
                }
                if (i11 == 1 && this.f24624i2 != null) {
                    MessagesController.getMainSettings(this.N).edit().putInt("closed_botkeyboard_" + getTopicKeyString(), this.f24624i2.getId()).apply();
                }
                B1(true);
                dh.f fVar2 = this.Z4;
                if (fVar2 != null) {
            ...
            if (this.f24682t3 || this.f24687u3) {
                J(true);
            }
            if (this.f24692v3 && i10 != 1) {
                z11 = false;
                n1(false, false, false, true);
            } else {
                z11 = false;
    ...
    public final void u() {
        if (this.R0.getParent() == null) {
            if (this.Z4 == null) {
                this.f24629j1.addView(this.R0);
            } else {
                this.f24629j1.addView(this.R0, k7.c6.c(-1.0f, -1));
            }
        }
    }
    ...
    public final boolean v0() {
        if (this.B2 && ChatActivityEnterView.this.f24656o4) {
            return true;
        }
        return false;
    }
    ...
    public final void v1(boolean z4) {
        ...
        float f10;
        float f11;
        if ((this.f24713z1 || z4) && (xnVar = this.L2) != null && !xnVar.w() && this.V1 == null && MessagesController.getInstance(this.N).richEditorAvailable()) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        this.H4 = z10;
        ImageView imageView = this.f24663q1;
        imageView.setVisibility(0);
        ViewPropertyAnimator animate = imageView.animate();
        float f12 = 1.0f;
        if (z10) {
    ...
    public final boolean w() {
        ag x10 = x();
        if (!TextUtils.equals(x10.f25250a, this.Y1.f25250a) || !MediaDataController.entitiesEqual(this.Y1.f25251b, x10.f25251b)) {
            return true;
        }
        return false;
    }
    ...
    public final boolean w0() {
        if (!this.B2) {
            AnimatorSet animatorSet = this.f24659p2;
            if (animatorSet == null || !animatorSet.isRunning() || this.f24612g2) {
                return false;
            }
            return true;
        }
    ...
    public final ag x() {
        ...
        ?? obj = new Object();
        obj.f25250a = charSequence.toString();
        obj.f25251b = entities;
        return obj;
    }

    public final void x1(boolean z4, boolean z10) {
        boolean z11;
        if (this.C1 != null && !this.f24581b3 && getVisibility() == 0) {
            ae aeVar = this.f24579b1;
            if ((aeVar == null || aeVar.getVisibility() != 0) && !this.D2 && this.R2 == null && (this.f24630j2 == null || this.V1 != null)) {
                z11 = true;
            } else {
                z11 = false;
            }
            if (!z10 && z4 && z11 && !this.f24691v2 && !t0()) {
                H0();
                id idVar = this.S;
                if (idVar != null) {
                    AndroidUtilities.cancelRunOnUIThread(idVar);
    ...
    public final void z1() {
        ...
        float f11 = this.f24706y + this.f24700x;
        oe oeVar = this.G0;
        if (oeVar != null) {
