...
public class ChatActivityEnterView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, nv0, rx0, ky0, le.d, org.telegram.ui.ActionBar.z5 {
    public static final int f23689m5 = 0;
    public boolean A0;
    ...
    public int f23690a;
    public boolean f23691a0;
    public boolean f23692a1;
    public TL_account.TL_businessChatLink a2;
    public TLRPC.TL_document f23693a3;
    public final je f23694a4;
    public final e6 f23695a5;
    public boolean f23696b;
    public NumberTextView f23697b0;
    public final we f23698b1;
    public kg f23699b2;
    public String f23700b3;
    public final je f23701b4;
    public final e6 f23702b5;
    public org.telegram.ui.ActionBar.f1 f23703c;
    public int f23704c0;
    public boolean f23705c1;
    public TLRPC.ChatFull f23706c2;
    public MessageObject f23707c3;
    public final je f23708c4;
    public qh.f f23709c5;
    public LinearLayout d;
    public int f23710d0;
    public bi.g5 f23711d1;
    public boolean f23712d2;
    public VideoEditedInfo f23713d3;
    public boolean f23714d4;
    public kh.h f23715d5;
    public CharSequence f23716e;
    public mr f23717e0;
    public ke f23718e1;
    public int f23719e2;
    public boolean f23720e3;
    public long f23721e4;
    public final le.e f23722e5;
    public String f23723f;
    public Runnable f23724f0;
    public v71 f23725f1;
    public boolean f23726f2;
    public boolean f23727f3;
    public float f23728f4;
    public final le.b f23729f5;
    public boolean f23730g0;
    public aj0 f23731g1;
    public boolean f23732g2;
    public boolean f23733g3;
    public float f23734g4;
    public final le.b f23735g5;
    public float h;
    public boolean f23736h0;
    public gk0 f23737h1;
    public boolean f23738h2;
    public MessageObject f23739h3;
    public float f23740h4;
    public final le.b f23741h5;
    public String f23742i0;
    public long f23743i1;
    public boolean f23744i2;
    public TL_keyboard.KeyboardButtonProto f23745i3;
    public float f23746i4;
    public float f23747i5;
    public String f23748j0;
    public SlideTextView f23749j1;
    public boolean f23750j2;
    public boolean j3;
    public float f23751j4;
    public float f23752j5;
    public fi.f4 f23753k0;
    public ug f23754k1;
    public boolean f23755k2;
    public boolean f23756k3;
    public float f23757k4;
    public boolean f23758k5;
    public fi.c0 f23759l0;
    public final ov0 l1;
    public MessageObject f23760l2;
    public boolean f23761l3;
    public float l4;
    public int f23762l5;
    public of m0;
    public ViewGroup f23763m1;
    public TLRPC.TL_replyKeyboardMarkup f23764m2;
    public boolean f23765m3;
    public float f23766m4;
    public float f23767n;
    public fi.b0 f23768n0;
    public int f23769n1;
    public int f23770n2;
    public int f23771n3;
    public float f23772n4;
    public boolean f23773o0;
    public final org.telegram.ui.yd f23774o1;
    public boolean f23775o2;
    public boolean f23776o3;
    public float f23777o4;
    public xo0 f23778p0;
    public ViewPropertyAnimator f23779p1;
    public PowerManager.WakeLock f23780p2;
    public boolean f23781p3;
    public float f23782p4;
    public ff f23783q0;
    public final ig.k f23784q1;
    public AnimatorSet f23785q2;
    public final bf f23786q3;
    public boolean f23787q4;
    public float f23788r;
    public ie f23789r0;
    public final j0 f23790r1;
    public AnimatorSet f23791r2;
    public final jf f23792r3;
    public boolean f23793r4;
    public float f23794s;
    public int f23795s0;
    public final ImageView f23796s1;
    public AnimatorSet f23797s2;
    public final org.telegram.ui.Cells.c1 f23798s3;
    public int f23799s4;
    public int f23800t0;
    public final ImageView f23801t1;
    public AnimatorSet f23802t2;
    public final uf f23803t3;
    public long f23804t4;
    public ie f23805u0;
    public float f23806u1;
    public int f23807u2;
    public final xf f23808u3;
    public boolean f23809u4;
    public boolean v;
    public ValueAnimator f23810v0;
    public ImageView f23811v1;
    public int f23812v2;
    public final Paint f23813v3;
    public ValueAnimator f23814v4;
    public Runnable f23815w;
    public float f23816w0;
    public cf f23817w1;
    public int f23818w2;
    public boolean f23819w3;
    public boolean f23820w4;
    public float f23821x;
    public boolean f23822x0;
    public final me f23823x1;
    public int f23824x2;
    public boolean f23825x3;
    public boolean f23826x4;
    public float f23827y;
    public boolean f23828y0;
    public final ke f23829y1;
    public boolean f23830y2;
    public boolean y3;
    public boolean f23831y4;
    public boolean f23832z0;
    public final ke f23833z1;
    public int f23834z2;
    public boolean f23835z3;
    public boolean f23836z4;
    ...
    public class RecordCircle extends View {
        ...
        public final ca h;
        public final ca f23842n;
        public final float f23843r;
        public final float f23844s;
        public final RectF v;
        public boolean f23845w;
        public final tg f23846x;
        public int f23847y;
        ...
        public RecordCircle(Context context) {
            ...
            this.f23842n = caVar2;
            this.f23843r = AndroidUtilities.dpf2(41.0f);
            this.f23844s = AndroidUtilities.dp(30.0f);
            this.v = new RectF();
            this.H = 0.0f;
            this.I = true;
        ...
        public final void a() {
            ...
            int i10 = org.telegram.ui.ActionBar.j6.f20662bf;
        ...
        public final void b(Canvas canvas, Drawable drawable, Drawable drawable2, float f7, int i10) {
            ...
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            boolean z10 = chatActivityEnterView.f23787q4;
            if (z10 && chatActivityEnterView.f23746i4 == 1.0f) {
                chatActivityEnterView.f23698b1.setAlpha(1.0f);
                setVisibility(8);
            } else if (z10 && chatActivityEnterView.f23746i4 < 1.0f) {
        ...
        public final void c(boolean z10) {
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            if (!z10) {
                chatActivityEnterView.f23793r4 = false;
                chatActivityEnterView.f23757k4 = -1.0f;
                chatActivityEnterView.f23751j4 = -1.0f;
                chatActivityEnterView.f23746i4 = 1.0f;
                chatActivityEnterView.f23782p4 = 1.0f;
                chatActivityEnterView.f23766m4 = 0.0f;
                chatActivityEnterView.f23740h4 = 0.0f;
            }
            invalidate();
            chatActivityEnterView.f23777o4 = 0.0f;
            chatActivityEnterView.x0();
            chatActivityEnterView.l4 = 0.0f;
            chatActivityEnterView.f23734g4 = 0.0f;
            chatActivityEnterView.f23728f4 = 0.0f;
            chatActivityEnterView.f23714d4 = false;
            this.f23841f = 0.0f;
            chatActivityEnterView.f23787q4 = false;
        ...
        public final boolean dispatchHoverEvent(MotionEvent motionEvent) {
            if (!super.dispatchHoverEvent(motionEvent) && !this.f23846x.f(motionEvent)) {
                return false;
            }
            return true;
        }
        ...
        public final void e() {
            ...
            int i10 = org.telegram.ui.ActionBar.j6.f20681cf;
            paint.setColor(chatActivityEnterView.i0(i10));
            this.h.d.setColor(i0.a.k(chatActivityEnterView.i0(i10), 38));
            this.f23842n.d.setColor(i0.a.k(chatActivityEnterView.i0(i10), 76));
            this.f23847y = chatActivityEnterView.L3.getAlpha();
        }

        public float getControlsScale() {
            return ChatActivityEnterView.this.f23740h4;
        }

        public float getScale() {
            return ChatActivityEnterView.this.f23734g4;
        }
        ...
        public final void onMeasure(int i10, int i11) {
            ...
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            chatActivityEnterView.f23799s4 = (int) ((1.0f - chatActivityEnterView.f23746i4) * (-measuredWidth));
        }

        public void setAmplitude(double d) {
            this.f23842n.d((float) (Math.min(1800.0d, d) / 1800.0d), true);
            this.h.d((float) (Math.min(1800.0d, d) / 1800.0d), false);
            float min = (float) (Math.min(1800.0d, d) / 1800.0d);
            this.f23838b = min;
            this.f23839c = (min - this.f23837a) / 375.0f;
            invalidate();
        }

        public void setControlsScale(float f7) {
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            chatActivityEnterView.f23740h4 = f7;
            sg sgVar = chatActivityEnterView.N1;
            if (sgVar != null) {
                sgVar.invalidate();
            }
        ...
        public void setScale(float f7) {
            ChatActivityEnterView.this.f23734g4 = f7;
            invalidate();
        }

        public void setTransformToSeekbar(float f7) {
            ChatActivityEnterView.this.f23777o4 = f7;
            invalidate();
        }
    }
    ...
    public class SlideTextView extends View {
        ...
        public final TextPaint f23848a;
        public final TextPaint f23849b;
        public final Paint f23850c;
        public final String d;
        public final String f23851e;
        public float f23852f;
        public float h;
        public float f23853n;
        public float f23854r;
        public float f23855s;
        public float v;
        public float f23856w;
        ...
        public SlideTextView(Context context) {
            ...
            this.f23851e = upperCase;
            this.E = string.indexOf(upperCase);
            a();
        }

        public final void a() {
            int i10 = org.telegram.ui.ActionBar.j6.f20880nf;
            int i11 = ChatActivityEnterView.f23689m5;
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            int i02 = chatActivityEnterView.i0(i10);
            TextPaint textPaint = this.f23848a;
            textPaint.setColor(i02);
            int i12 = org.telegram.ui.ActionBar.j6.f20864mf;
            int i03 = chatActivityEnterView.i0(i12);
            TextPaint textPaint2 = this.f23849b;
            textPaint2.setColor(i03);
            this.f23855s = textPaint.getAlpha();
        ...
        public final void onDraw(Canvas canvas) {
            ...
            if (this.G != null && (staticLayout = this.H) != null) {
                ...
                if (chatActivityEnterView.M1 != null) {
                    ...
                    int i02 = chatActivityEnterView.i0(org.telegram.ui.ActionBar.j6.f20880nf);
                    TextPaint textPaint = this.f23848a;
                    textPaint.setColor(i02);
                    textPaint.setAlpha((int) ((1.0f - this.f23853n) * this.f23855s * this.f23854r));
                    this.f23849b.setAlpha((int) (this.v * this.f23853n));
                    int color = textPaint.getColor();
                    Paint paint = this.f23850c;
                    paint.setColor(color);
                    boolean z10 = true;
                    boolean z11 = this.M;
                    if (z11) {
                        this.f23856w = AndroidUtilities.dp(16.0f);
                    } else {
                        long currentTimeMillis = System.currentTimeMillis() - this.f23858y;
                        this.f23858y = System.currentTimeMillis();
                        if (this.f23853n == 0.0f && this.f23854r > 0.8f) {
                            if (this.f23857x) {
                                float dp3 = ((AndroidUtilities.dp(3.0f) / 250.0f) * ((float) currentTimeMillis)) + this.f23856w;
                                this.f23856w = dp3;
                                if (dp3 > AndroidUtilities.dp(6.0f)) {
                                    this.f23856w = AndroidUtilities.dp(6.0f);
                                    this.f23857x = false;
                                }
                            } else {
                                float dp4 = this.f23856w - ((AndroidUtilities.dp(3.0f) / 250.0f) * ((float) currentTimeMillis));
                                this.f23856w = dp4;
                    ...
                    int dp5 = AndroidUtilities.dp(5.0f) + ((int) ((getMeasuredWidth() - this.f23852f) / 2.0f));
                    ...
                    float f16 = dp5;
                    float f17 = this.f23856w;
                    float f18 = this.f23853n;
                    float dp6 = (((((1.0f - f18) * f17) * this.f23854r) + f16) - (f11 * f18)) + AndroidUtilities.dp(f10);
                    if (z10) {
                        dp = 0.0f;
                    } else {
                        dp = this.f23853n * AndroidUtilities.dp(12.0f);
                    }
                    if (this.f23853n != 1.0f) {
                        f12 = 12.0f;
                        int translationX = (int) ((chatActivityEnterView.M1.getTranslationX() * 0.3f) + ((1.0f - this.f23854r) * ((-getMeasuredWidth()) / 4)));
                        canvas.save();
        ...
        public final void onMeasure(int i10, int i11) {
            ...
            if (this.L != measuredHeight) {
                ...
                String str = this.d;
                TextPaint textPaint = this.f23848a;
                this.f23852f = textPaint.measureText(str);
                ...
                this.G = new StaticLayout(this.d, textPaint, (int) this.f23852f, alignment, 1.0f, 0.0f, false);
                this.H = new StaticLayout(this.f23851e, textPaint2, (int) this.h, alignment, 1.0f, 0.0f, false);
            }
        }
        ...
        public final boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (this.f23853n == 0.0f || !isEnabled()) {
                return false;
            }
            ...
            if (z10) {
                ...
                if (motionEvent.getAction() == 1 && rect.contains(x10, y3)) {
                    ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
                    long j3 = 0;
                    if (chatActivityEnterView.f23712d2 && chatActivityEnterView.f23705c1) {
                    ...
                    chatActivityEnterView.f23707c3 = null;
                    chatActivityEnterView.f23713d3 = null;
    ...
    public ChatActivityEnterView(Activity activity, ov0 ov0Var, org.telegram.ui.co coVar, boolean z10, final org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f23771n3 = -1;
        this.f23781p3 = true;
        this.f23786q3 = new bf(this, 0);
        this.f23792r3 = new jf(this);
        this.f23798s3 = new org.telegram.ui.Cells.c1(Integer.class, "translationY", 1);
        this.f23803t3 = new Property(Float.class, "scale");
        this.f23808u3 = new Property(Float.class, "controlsScale");
        this.f23813v3 = new Paint(1);
        ...
        this.f23694a4 = new je(this, 2);
        this.f23701b4 = new je(this, 3);
        this.f23708c4 = new je(this, 4);
        this.f23820w4 = true;
        this.f23826x4 = true;
        this.A4 = new Paint();
        this.B4 = 1.0f;
        ...
        this.Z4 = new Matrix();
        pr prVar = pr.h;
        this.f23695a5 = new e6(this, 0L, 280L, prVar);
        this.f23702b5 = new e6(this, 0L, 280L, prVar);
        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
        paint.setShader(linearGradient);
        pr prVar2 = ki.o.V;
        this.f23722e5 = new le.e(0, this, prVar2, 250L);
        this.f23729f5 = new le.b(1, this, prVar2, 250L, false);
        this.f23735g5 = new le.b(2, this, prVar, 320L, false);
        this.f23741h5 = new le.b(3, this, prVar, 320L, false);
        this.V3 = f6Var;
        this.W3 = z10;
        this.f23738h2 = z10 && !AndroidUtilities.isInMultiwindow && (coVar == null || !coVar.isInBubbleMode());
        Paint paint2 = new Paint(1);
        this.P1 = paint2;
        paint2.setColor(i0(org.telegram.ui.ActionBar.j6.f20643af));
        setFocusable(true);
                    ...
                    default:
                        ...
                        if (z12) {
                            if (chatActivityEnterView2.D1 != null) {
                                ...
                                f0Var.f25857k0 = new ce(chatActivityEnterView2, 0);
                                de deVar = new de(chatActivityEnterView2, j3, f6Var2, 0);
                                f0Var.f25858l0 = j3;
                                f0Var.f25860o0 = deVar;
                                f0Var.show();
                                return;
                            }
                            return;
                            ...
                            f0Var2.f25856j0 = new ce(chatActivityEnterView2, 1);
        ...
        if (z10) {
            ...
            if (i14 != 9) {
                ...
                this.f23717e0.a(this.f23726f2, false);
                if (this.f23726f2) {
                ...
                imageView2.setVisibility((!this.f23732g2 || ((ogVar = this.Y2) != null && ogVar.z0())) ? 8 : 0);
        ...
        imageView3.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                ...
                switch (r3) {
                    case 0:
                        int i142 = ChatActivityEnterView.f23689m5;
                        ChatActivityEnterView chatActivityEnterView = this.f25694b;
                        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(chatActivityEnterView.getContext(), 0, f6Var);
                        String string = LocaleController.getString(R.string.ArticleDeleteDraftTitle);
                        org.telegram.ui.ActionBar.b2 b2Var = alertDialog$Builder.f20226a;
        ...
        this.F0 = wgVar;
        org.telegram.ui.ActionBar.j5 j5Var = wgVar.f32290a;
        ...
        this.f23818w2 = globalEmojiSettings.getInt("kbd_height", AndroidUtilities.dp(200.0f));
        this.f23824x2 = globalEmojiSettings.getInt("kbd_height_land3", AndroidUtilities.dp(200.0f));
        k1(false, false);
        K(false);
        F();
        W();
    ...
    public static void f(final ChatActivityEnterView chatActivityEnterView, final ev0 ev0Var, int[] iArr, uo0 uo0Var) {
        ...
        if (org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20965s8, true) == -1) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        if (i10 >= 26) {
            if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20635a7, true)) >= 0.721f) {
                z11 = true;
            } else {
                z11 = false;
            }
        ...
        if (i10 >= 23) {
            chatActivityEnterView.f23795s0 = chatActivityEnterView.getRootWindowInsets().getSystemWindowInsetLeft() + chatActivityEnterView.f23795s0;
        }
        chatActivityEnterView.f23778p0.getLocationInWindow(iArr2);
        final float f10 = iArr2[0];
        final float f11 = iArr2[1];
        float dp = AndroidUtilities.dp(5.0f);
        float dp2 = iArr[0] + chatActivityEnterView.f23795s0 + dp + AndroidUtilities.dp(4.0f) + 0.0f;
        float f12 = iArr[1] + chatActivityEnterView.f23800t0 + dp + 0.0f;
        ev0Var.setTranslationX(dp2);
        ev0Var.setTranslationY(f12);
        float f13 = chatActivityEnterView.f23778p0.getLayoutParams().width;
        if (chatActivityEnterView.f23758k5) {
            f7 = chatActivityEnterView.f23778p0.getScaleX();
        } else {
            f7 = 1.0f;
        }
        ...
        dialog2.show();
        if (!chatActivityEnterView.f23758k5) {
            chatActivityEnterView.f23778p0.setScaleX(1.0f);
            chatActivityEnterView.f23778p0.setScaleY(1.0f);
        }
        chatActivityEnterView.f23778p0.setAlpha(1.0f);
        ff ffVar = chatActivityEnterView.f23783q0;
        boolean z12 = chatActivityEnterView.f23758k5;
        o1.c cVar = o1.h.f16835o;
        if (z12) {
            kVar = null;
        } else {
            o1.k kVar3 = new o1.k(chatActivityEnterView.f23778p0, cVar);
            kVar3.f16852u = org.telegram.ui.Cells.p6.l(0.5f, 750.0f, 1.0f);
            kVar = kVar3;
        }
        boolean z13 = chatActivityEnterView.f23758k5;
        o1.c cVar2 = o1.h.f16836p;
        if (z13) {
            dialog = dialog2;
            kVar2 = null;
        } else {
            dialog = dialog2;
            o1.k kVar4 = new o1.k(chatActivityEnterView.f23778p0, cVar2);
            kVar4.f16852u = org.telegram.ui.Cells.p6.l(0.5f, 750.0f, 1.0f);
            kVar2 = kVar4;
        }
        o1.k kVar5 = new o1.k(chatActivityEnterView.f23778p0, o1.h.f16840t);
        kVar5.f16852u = org.telegram.ui.Cells.p6.l(0.0f, 750.0f, 1.0f);
        final Dialog dialog3 = dialog;
        kVar5.a(new o1.f(chatActivityEnterView) {
            public final ChatActivityEnterView f32270b;

            {
                this.f32270b = chatActivityEnterView;
            }
            ...
            public final void a(o1.h hVar, boolean z14, float f14, float f15) {
                ...
                ChatActivityEnterView chatActivityEnterView2 = this.f32270b;
                switch (i11) {
                    case 0:
                        ...
                        if (dialog4.isShowing()) {
                            ...
                            xo0 xo0Var = chatActivityEnterView2.f23778p0;
                            xo0Var.getClass();
                            xo0Var.a(false, false, 0.0f);
                            if (!chatActivityEnterView2.f23758k5) {
                                chatActivityEnterView2.f23778p0.setScaleX(1.0f);
                                chatActivityEnterView2.f23778p0.setScaleY(1.0f);
                            }
                            chatActivityEnterView2.f23778p0.setAlpha(1.0f);
                            chatActivityEnterView2.f23778p0.getViewTreeObserver().addOnPreDrawListener(new hf(chatActivityEnterView2, dialog4, 0));
                            return;
                        }
                        return;
                    default:
                        ...
                        if (dialog4.isShowing()) {
                            ev0Var2.setTranslationX(f17);
                            ev0Var2.setTranslationY(f16);
                            xo0 xo0Var2 = chatActivityEnterView2.f23778p0;
                            xo0Var2.getClass();
                            ...
                            chatActivityEnterView2.f23778p0.setAlpha(1.0f);
                            chatActivityEnterView2.f23778p0.getViewTreeObserver().addOnPreDrawListener(new hf(chatActivityEnterView2, dialog4, 1));
                            return;
                        }
                        return;
                }
        ...
        o1.k kVar6 = new o1.k(ev0Var, o1.h.f16833m);
        kVar6.f16842b = w7.p.a(dp2, f10 - AndroidUtilities.dp(6.0f), dp2);
        kVar6.f16843c = true;
        kVar6.f16852u = org.telegram.ui.Cells.p6.l(f10, 700.0f, 0.75f);
        kVar6.h = f10 - AndroidUtilities.dp(6.0f);
        o1.k kVar7 = new o1.k(ev0Var, o1.h.f16834n);
        kVar7.f16842b = w7.p.a(f12, f12, AndroidUtilities.dp(6.0f) + f11);
        kVar7.f16843c = true;
        kVar7.f16852u = org.telegram.ui.Cells.p6.l(f11, 700.0f, 0.75f);
        kVar7.f16846g = AndroidUtilities.dp(6.0f) + f11;
        ...
        kVar8.f16852u = org.telegram.ui.Cells.p6.l(dp3, 1000.0f, 1.0f);
        o1.k kVar9 = new o1.k(ev0Var, cVar2);
        kVar9.f16852u = org.telegram.ui.Cells.p6.l(dp3, 1000.0f, 1.0f);
    ...
    public static void g(ChatActivityEnterView chatActivityEnterView, TLRPC.Document document, String str, MessageObject.SendAnimationData sendAnimationData, boolean z10, int i10, int i11, Object obj, Long l4, boolean z11) {
        ...
        if (chatActivityEnterView.G0 > 0 && !chatActivityEnterView.c()) {
            ...
            if (ogVar != null) {
                ...
                ogVar.n1(wgVar, wgVar.f32290a.getText(), true);
                return;
            }
            return;
        }
    ...
    public static void h(ChatActivityEnterView chatActivityEnterView, TL_keyboard.KeyboardButton keyboardButton) {
        ...
        if (chatActivityEnterView.S2 != null && (coVar = chatActivityEnterView.O2) != null && coVar.f35305h4 && coVar.d() == chatActivityEnterView.S2.getId()) {
            z10 = true;
        } else {
            z10 = false;
        }
        if ((chatActivityEnterView.S2 != null && !z10) || BotForumHelper.isBotForum(chatActivityEnterView.Q, chatActivityEnterView.P2)) {
            ...
            messageObject = chatActivityEnterView.f23760l2;
        } else {
            messageObject = null;
        }
        MessageObject messageObject2 = chatActivityEnterView.S2;
        if (messageObject2 == null || z10) {
            messageObject2 = chatActivityEnterView.f23760l2;
        }
        ...
        if (chatActivityEnterView.S2 != null && !z10) {
            ...
            MessageObject messageObject3 = chatActivityEnterView.f23760l2;
            if (messageObject3 != null && messageObject3.messageOwner.reply_markup.single_use) {
                ...
                MessagesController.getMainSettings(chatActivityEnterView.Q).edit().putInt("answered_" + chatActivityEnterView.getTopicKeyString(), chatActivityEnterView.f23760l2.getId()).commit();
            }
        }
        og ogVar = chatActivityEnterView.Y2;
        if (ogVar != null) {
    ...
    public static void i(ChatActivityEnterView chatActivityEnterView, MessageObject messageObject, TL_keyboard.KeyboardButtonProto keyboardButtonProto) {
        ...
        if (Build.VERSION.SDK_INT >= 23 && activity.checkSelfPermission("android.permission.ACCESS_COARSE_LOCATION") != 0) {
            ...
            chatActivityEnterView.f23739h3 = messageObject;
            chatActivityEnterView.f23745i3 = keyboardButtonProto;
            return;
        }
    ...
    public static void m(ChatActivityEnterView chatActivityEnterView) {
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(chatActivityEnterView, "lockAnimatedTranslation", chatActivityEnterView.f23751j4);
        ...
        animatorSet.playTogether(ofFloat2, ofFloat, ObjectAnimator.ofFloat(chatActivityEnterView, "slideToCancelProgress", 1.0f).setDuration(200L), ObjectAnimator.ofFloat(chatActivityEnterView.f23749j1, "cancelToProgress", 1.0f));
        animatorSet.start();
    }
                    ...
                    if (messageEntity.offset + messageEntity.length <= spannableStringBuilder.length()) {
                        if (messageEntity instanceof TLRPC.TL_inputMessageEntityMentionName) {
                            ...
                            if (messageEntity instanceof TLRPC.TL_messageEntityBold) {
                                ...
                                obj7.f28620b = i22;
                                obj7.f28621c = i22 + messageEntity.length;
    ...
    public final void A() {
        ...
        this.f23797s2 = null;
        x0();
        if (this.f23774o1 != null) {
            this.f23821x = 0.0f;
            A1();
        }
        SlideTextView slideTextView = this.f23749j1;
    ...
    public final void A1() {
        int i10;
        z1();
        org.telegram.ui.yd ydVar = this.f23774o1;
        if (ydVar != null) {
            ydVar.setTranslationX(this.f23827y + this.f23821x);
            ...
            ig.k kVar = this.f23784q1;
            if (kVar != null && this.f23836z4) {
                kVar.setAlpha(this.f23806u1 * this.F);
            }
        }
        af afVar = this.I1;
        if (afVar != null) {
    ...
    public final void B() {
        int i10;
        if (this.f23712d2 && this.f23705c1) {
    ...
    public final void B0() {
        ...
        float audioLeft;
        float audioRight;
        gk0 gk0Var = this.f23737h1;
        if (gk0Var != null) {
            gk0Var.Q = true;
            g71 g71Var = gk0Var.f26450n;
            if (g71Var != null) {
                g71Var.P(false);
                gk0Var.f26450n.H();
                gk0Var.f26450n = null;
        ...
        if (this.f23737h1 != null && this.f23693a3 != null) {
            ...
            gk0 gk0Var2 = this.f23737h1;
            if (gk0Var2 == null) {
                audioLeft = 0.0f;
            } else {
                audioLeft = gk0Var2.getAudioLeft();
            }
            gk0 gk0Var3 = this.f23737h1;
            if (gk0Var3 == null) {
                audioRight = 1.0f;
            } else {
        ...
        PowerManager.WakeLock wakeLock = this.f23780p2;
        if (wakeLock != null) {
            try {
                wakeLock.release();
                this.f23780p2 = null;
    ...
    public final void C() {
        cf cfVar;
        org.telegram.ui.co coVar;
        if (this.L == null && (cfVar = this.J1) != null && cfVar.getRight() != 0 && (coVar = this.O2) != null && BirthdayController.isToday(coVar.f35220a8)) {
            ...
            if (mainSettings.getBoolean(Calendar.getInstance().get(1) + "bdayhint_" + coVar.a(), true)) {
                ...
                this.L.m(1.0f, -((getWidth() - AndroidUtilities.dp(12.0f)) - ((this.J1.getMeasuredWidth() / 2.0f) + (this.J1.getX() + (this.f23774o1.getX() + this.f23823x1.getX())))));
                addView(this.L, w7.x5.d(-1, 200.0f, 48, 0.0f, -192.0f, 0.0f, 0.0f));
                di.f4 f4Var2 = this.L;
                f4Var2.f7238l0 = new sd(this, 12);
                f4Var2.d = 8000L;
                f4Var2.u();
            }
        }
    ...
    public final void C1() {
        ...
        of ofVar = this.m0;
        if (ofVar != null) {
            int childCount = ofVar.f10128c.getChildCount();
            int i10 = 0;
            for (int i11 = 0; i11 < childCount; i11++) {
                View childAt = this.m0.f10128c.getChildAt(i11);
                if (i11 < 4) {
            ...
            } else if (this.f23768n0.f9581c.size() > 4) {
                f7 = i2.g.f(162.8f, ov0Var.getMeasuredHeight(), 0);
            } else {
                f7 = i2.g.f((Math.max(1, Math.min(4, this.f23768n0.f9581c.size())) * 36) + 8, ov0Var.getMeasuredHeight(), 0);
            }
            if (this.m0.f10128c.getPaddingTop() != f7) {
                this.m0.f10128c.setTopGlowOffset(f7);
                if (this.U4 == -1 && this.m0.getVisibility() == 0 && this.m0.f10128c.getLayoutManager() != null && (L0 = (c0Var = (s4.c0) this.m0.f10128c.getLayoutManager()).L0()) >= 0 && (m10 = c0Var.m(L0)) != null) {
                    this.U4 = L0;
                    this.V4 = m10.getTop() - this.m0.f10128c.getPaddingTop();
                }
                this.m0.f10128c.setPadding(0, f7, 0, AndroidUtilities.dp(8.0f));
            }
        }
    }
    ...
    public final void D() {
        boolean z10;
        qf qfVar = this.E0;
        if ((qfVar == null || TextUtils.isEmpty(qfVar.getText())) && !this.f23830y2 && !this.j3 && !t0()) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        fi.c0 c0Var = this.f23759l0;
        if (c0Var != null) {
            boolean z11 = c0Var.f9607f;
            if (z11 != z10) {
                c0Var.f9607f = z10;
                c0Var.requestLayout();
                c0Var.invalidate();
            }
            if (z11 != this.f23759l0.f9607f) {
                ne neVar = this.Q0;
    ...
    public final void E0() {
        ...
        if (!j0() || !v()) {
            getVisibility();
            if (this.f23755k2 && !org.telegram.ui.ActionBar.n2.hasSheets(this.O2)) {
                this.f23755k2 = false;
                og ogVar = this.Y2;
                if (ogVar != null) {
                    ogVar.l1();
                ...
                if (!AndroidUtilities.usingHardwareInput && !this.f23830y2 && !AndroidUtilities.isInMultiwindow) {
                    this.j3 = true;
                    bf bfVar = this.f23786q3;
    ...
    public final void F() {
        ...
        K1(coVar.f35265e, coVar.f35220a8);
    }
    ...
    public final void F1() {
        float f7 = this.f23788r * this.h;
        ne neVar = this.Q0;
        neVar.setScaleX(f7);
        neVar.setScaleY(this.f23788r * this.h);
        neVar.setAlpha(this.f23794s * this.f23767n);
    }
    ...
    public final void G1(boolean z10) {
        ...
        qf qfVar = this.E0;
        if (qfVar != null) {
            CharSequence charSequence = this.f23716e;
            if (charSequence != null) {
                qfVar.setHintText(charSequence, z10);
                this.E0.setHintText2(this.f23723f, z10);
                return;
            }
            boolean z13 = true;
            boolean z14 = false;
            ...
            if (i10 == 9) {
                ...
                if (z11) {
                    ...
                    if (messageObject2 != null && (replyMarkup2 = messageObject2.messageOwner.reply_markup) != null && !TextUtils.isEmpty(replyMarkup2.placeholder)) {
                    ...
                    } else if (this.X0 && (messageObject = this.f23760l2) != null && (replyMarkup = messageObject.messageOwner.reply_markup) != null && !TextUtils.isEmpty(replyMarkup.placeholder)) {
                        this.E0.setHintText(this.f23760l2.messageOwner.reply_markup.placeholder, z10);
                        ...
                        TLRPC.TL_forumTopic findTopic = MessagesController.getInstance(this.Q).getTopicsController().findTopic(coVar.f35265e.f19896id, 1L);
                        ...
                        if (user != null && user.bot_forum_view && !user.bot_forum_can_manage_topics && coVar != null && !coVar.f35305h4) {
                            this.E0.setHintText(LocaleController.getString(R.string.SendBotNoThread));
                        } else if (coVar != null && coVar.F9() && !coVar.f35305h4) {
                            if (coVar.X3 != null && coVar.f35294g4) {
    ...
    public final void H(int i10, boolean z10) {
        ...
        if (i10 > AndroidUtilities.dp(50.0f) && this.f23830y2 && !AndroidUtilities.isInMultiwindow) {
            if (z10) {
                this.f23824x2 = i10;
                MessagesController.getGlobalEmojiSettings().edit().putInt("kbd_height_land3", this.f23824x2).commit();
            } else {
                this.f23818w2 = i10;
                MessagesController.getGlobalEmojiSettings().edit().putInt("kbd_height", this.f23818w2).commit();
            }
        }
        if (this.f23830y2 && this.W0 && this.U0 == null) {
            this.W0 = false;
        }
        boolean t02 = t0();
        ov0 ov0Var = this.l1;
        ...
        if (t02) {
            ...
            if (bgVar2 != null) {
                ...
                qh.f fVar2 = this.f23709c5;
                if (fVar2 != null && i11 > 0 && this.f23719e2 == 1) {
                    ((qh.i) fVar2).g(i11);
                }
            }
            if (view != null) {
                FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) view.getLayoutParams();
                if (!this.f23835z3 && !this.y3 && (((i12 = layoutParams.width) != (i13 = AndroidUtilities.displaySize.x) || layoutParams.height != i11) && ((fVar = this.f23709c5) == null || i12 != -1 || layoutParams.height != -1))) {
                    if (fVar == null) {
                    ...
                    if (ov0Var != null) {
                        int i15 = this.f23834z2;
                        this.f23834z2 = layoutParams.height;
                        ov0Var.requestLayout();
                        G0();
                        if (this.f23738h2 && !this.f23830y2 && i15 != this.f23834z2 && N0()) {
                            AnimatorSet animatorSet = new AnimatorSet();
                            this.V0 = animatorSet;
                            if (this.f23709c5 != null) {
                                animatorSet.playTogether(ValueAnimator.ofFloat(this.f23834z2 - i15, 0.0f));
                            } else {
                                animatorSet.playTogether(ObjectAnimator.ofFloat(view, View.TRANSLATION_Y, this.f23834z2 - i15, 0.0f));
                            }
                            this.V0.setInterpolator(org.telegram.ui.ActionBar.p1.f21303w);
        ...
        this.f23830y2 = z11;
        D();
        if (this.f23830y2 && t0() && this.A3 == null) {
            t1(0, this.f23719e2, true, true);
        } else if (!this.f23830y2 && !t0() && (messageObject = this.f23760l2) != null && this.S2 != messageObject && !j0() && !v() && !org.telegram.ui.ActionBar.n2.hasSheets(coVar) && (((qfVar = this.E0) == null || TextUtils.isEmpty(qfVar.getText())) && (tL_replyKeyboardMarkup = this.f23764m2) != null && !tL_replyKeyboardMarkup.rows.isEmpty())) {
        ...
        if (this.f23834z2 != 0 && !(z12 = this.f23830y2) && z12 != z14 && !t0()) {
            this.f23834z2 = 0;
            ov0Var.requestLayout();
        }
        if (this.f23830y2 && this.j3) {
            this.j3 = false;
            if (this.f23776o3) {
                this.f23776o3 = false;
                this.G1.setButtons(this.f23764m2);
            }
            AndroidUtilities.cancelRunOnUIThread(this.f23786q3);
        }
        G0();
    }
    ...
    public final void H1(int i10) {
        ...
        if (this.E0 != null) {
            ...
            if (messageObject == null || messageObject.needResendWhenEdit()) {
                ...
                boolean z10 = this.f23836z4;
                float f7 = 2.0f;
                ye yeVar = this.J0;
                int i12 = 0;
                if (z10 && this.f23758k5) {
                    if (this.f23809u4) {
                        f7 = 50.0f;
                    }
                    ...
                    cf cfVar = this.f23817w1;
                    if (cfVar != null && cfVar.getVisibility() == 0 && (afVar2 = this.I1) != null && afVar2.getVisibility() == 0 && (kVar = this.f23784q1) != null && kVar.getVisibility() == 0) {
                        layoutParams.rightMargin = AndroidUtilities.dp(146.0f);
                    } else {
                        cf cfVar2 = this.f23817w1;
                ...
                if (keVar != null) {
                    ...
                    this.f23718e1.setLayoutParams(layoutParams2);
                }
            }
        }
    }
    ...
    public final void I0() {
        ...
        if (!j0() || !v()) {
            ...
            if (!org.telegram.ui.ActionBar.n2.hasSheets(coVar)) {
                if (!AndroidUtilities.usingHardwareInput && !AndroidUtilities.isInMultiwindow && ((coVar == null || !coVar.isInBubbleMode()) && !this.f23744i2)) {
                    i10 = 2;
                } else {
                    i10 = 0;
                }
                ...
                if (this.f23744i2) {
                    this.f23755k2 = true;
                } else if (!AndroidUtilities.usingHardwareInput && !this.f23830y2 && !AndroidUtilities.isInMultiwindow) {
    ...
    public final void J() {
        ...
        if (DialogObject.isChatDialog(this.P2)) {
            ...
            this.f23822x0 = ChatObject.canSendRoundVideo(chat);
            this.f23828y0 = ChatObject.canSendVoice(chat);
        } else {
            z10 = false;
        }
        ...
        if (!this.f23822x0 && z11) {
            z11 = false;
        }
        if (!this.f23828y0 && !z11) {
            if (!this.f23712d2) {
                z12 = false;
            }
        } else {
    ...
    public final void K0(CharSequence charSequence, String str, CharSequence charSequence2) {
        ...
        if (this.E0 != null && (coVar = this.O2) != null && MessagesController.getInstance(this.Q).richEditorAvailable()) {
            ...
            c2Var.f13849n = charSequence2;
            c2Var.setResourceProvider(this.V3);
            c2Var.J = coVar;
            c2Var.f13856s = coVar.S;
            c2Var.v = coVar.Y;
    ...
    public final void K1(TLRPC.Chat chat, TLRPC.UserFull userFull) {
        ...
        float f10 = 1.0f;
        if (chat != null) {
            if (!ChatObject.canSendVoice(chat) && (!ChatObject.canSendRoundVideo(chat) || !this.f23712d2)) {
                z10 = true;
            } else {
                z10 = false;
            }
            this.f23692a1 = z10;
            this.f23696b = ChatObject.canSendStickers(chat);
            boolean canSendPlain = ChatObject.canSendPlain(chat);
            this.f23832z0 = canSendPlain;
            if (!this.f23696b && !canSendPlain) {
                z11 = true;
            } else {
                z11 = false;
            }
            ...
            if (!this.A0 && (egVar = this.U0) != null) {
                egVar.M(-this.P2, !this.f23832z0, !this.f23696b);
            }
            this.f23822x0 = ChatObject.canSendRoundVideo(chat);
            this.f23828y0 = ChatObject.canSendVoice(chat);
        } else if (userFull != null) {
            this.f23692a1 = userFull.voice_messages_forbidden;
            this.K = userFull;
        }
        if (this.f23692a1) {
            f10 = 0.5f;
        ...
        we weVar = this.f23698b1;
        weVar.setColorFilter(porterDuffColorFilter);
        weVar.invalidate();
        G1(false);
        boolean z13 = this.f23705c1;
        if (!this.f23822x0 && z13) {
            z13 = false;
        }
        if (!this.f23828y0 && !z13) {
            if (!this.f23712d2) {
                z12 = false;
            }
        } else {
    ...
    public final void L() {
        ...
        if (this.U0 != null) {
            ...
            int dp = ((((this.f23769n1 - AndroidUtilities.statusBarHeight) - AndroidUtilities.navigationBarHeight) - AndroidUtilities.dp(6.0f)) - org.telegram.ui.ActionBar.k.getCurrentActionBarHeight()) - getHeight();
            if (this.Q1 == 2) {
            ...
            if (i11 != dp) {
                ...
                this.C3 = dp;
                org.telegram.ui.Cells.c1 c1Var = this.f23798s3;
                if (i11 > dp) {
                    ...
                    if (this.v) {
                        ...
                        animatorSet2.setInterpolator(pr.f29494f);
                    ...
                    animatorSet3.setInterpolator(pr.f29494f);
                    animatorSet3.addListener(new ze(this, 11));
                    this.A3 = animatorSet3;
                    this.U0.setLayerType(2, null);
                    animatorSet3.start();
                }
                qh.f fVar = this.f23709c5;
                if (fVar != null) {
                    ((qh.i) fVar).g(dp);
                }
            }
    ...
    public void L1(int i10, boolean z10) {
        ...
        Runnable runnable = this.f23724f0;
        if (runnable != null) {
        ...
        if (z14) {
            ...
            if (z15) {
                ...
                sg sgVar = this.N1;
                if (sgVar != null) {
                    sgVar.f30316y.d(1, false, false);
                }
                MediaDataController mediaDataController = MediaDataController.getInstance(this.Q);
                long j10 = this.P2;
                org.telegram.ui.co coVar = this.O2;
                property = property3;
                mediaDataController.toggleDraftVoiceOnce(j10, (coVar == null || !coVar.f35305h4) ? 0L : coVar.d(), this.O);
                this.f23743i1 = 0L;
            }
            X();
            this.f23812v2 = 1;
            ...
            AnimatorSet animatorSet = this.f23797s2;
            if (animatorSet != null) {
                animatorSet.cancel();
            }
            AnimatorSet animatorSet2 = this.f23802t2;
            ...
            ug ugVar = this.f23754k1;
            if (ugVar != null) {
                ugVar.f30909a = 1.0f;
                ugVar.f30910b = System.currentTimeMillis();
                ugVar.f30911c = false;
                ugVar.f30912e = false;
                ugVar.f30913f.stop();
                ugVar.invalidate();
                this.f23754k1.setScaleX(0.0f);
                this.f23754k1.setScaleY(0.0f);
                this.f23754k1.h = true;
            }
            this.f23797s2 = new AnimatorSet();
            this.Y0.setTranslationX(AndroidUtilities.dp(20.0f));
            this.Y0.setAlpha(0.0f);
            if (this.P4 != 3) {
                this.f23749j1.setTranslationX(AndroidUtilities.dp(20.0f));
                this.f23749j1.setAlpha(0.0f);
                this.f23749j1.setCancelToProgress(0.0f);
                SlideTextView slideTextView = this.f23749j1;
                slideTextView.f23854r = 1.0f;
                slideTextView.setEnabled(true);
            } else {
                this.f23749j1.setTranslationX(0.0f);
                this.f23749j1.setAlpha(0.0f);
                this.f23749j1.setCancelToProgress(1.0f);
                this.f23749j1.setEnabled(true);
            }
            this.M1.c(this.P4 == 3);
            this.f23750j2 = false;
            x0();
            ...
            animatorSet3.playTogether(ObjectAnimator.ofFloat(this.Q0, this.Y3, 0.0f), ObjectAnimator.ofFloat(this.Q0, this.f23694a4, 0.0f), ObjectAnimator.ofFloat(this.f23754k1, property4, 1.0f), ObjectAnimator.ofFloat(this.f23754k1, property6, 1.0f), ObjectAnimator.ofFloat(this.Y0, property2, 0.0f), ObjectAnimator.ofFloat(this.Y0, property5, 1.0f));
            animatorSet3.playTogether(ObjectAnimator.ofFloat(this.f23749j1, property2, 0.0f));
            animatorSet3.playTogether(ObjectAnimator.ofFloat(this.f23749j1, property5, 1.0f));
            sg sgVar3 = this.N1;
            if (sgVar3 != null) {
                animatorSet3.playTogether(ObjectAnimator.ofFloat(sgVar3, property5, 1.0f));
            }
            if (this.f23698b1 != null) {
                animatorSet3.playTogether(ObjectAnimator.ofFloat(this.Z0, property5, 0.0f));
            }
            fi.c0 c0Var = this.f23759l0;
            if (c0Var != null) {
                animatorSet3.playTogether(ObjectAnimator.ofFloat(c0Var, property4, 0.0f), ObjectAnimator.ofFloat(this.f23759l0, property6, 0.0f), ObjectAnimator.ofFloat(this.f23759l0, property5, 0.0f));
            }
            AnimatorSet animatorSet4 = new AnimatorSet();
            animatorSet4.playTogether(ObjectAnimator.ofFloat(this.E0, this.f23708c4, AndroidUtilities.dp(20.0f)), ObjectAnimator.ofFloat(this.E0, property5, 0.0f), ObjectAnimator.ofFloat(this.f23718e1, property5, 1.0f));
            if (z15) {
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.f23737h1, property5, 0.0f));
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.f23731g1, property5, 0.0f));
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.f23731g1, property6, 0.0f));
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.f23731g1, property4, 0.0f));
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.f23725f1, property5, 0.0f));
            }
            if (this.I1 != null) {
            ...
            org.telegram.ui.yd ydVar = this.f23774o1;
            if (ydVar != null) {
                animatorSet4.playTogether(ObjectAnimator.ofFloat(ydVar, this.f23701b4, AndroidUtilities.dp(30.0f)), ObjectAnimator.ofFloat(this.f23774o1, this.Z3, 0.0f));
                ViewPropertyAnimator viewPropertyAnimator = this.f23779p1;
                ...
                ig.k kVar = this.f23784q1;
                this.f23806u1 = 0.0f;
                animatorSet4.playTogether(ObjectAnimator.ofFloat(kVar, property5, 0.0f), ObjectAnimator.ofFloat(this.f23784q1, property6, 0.5f), ObjectAnimator.ofFloat(this.f23784q1, property4, 0.5f));
            }
            kh.h hVar = this.f23715d5;
            if (hVar != null) {
                hVar.e(0, false, true);
            }
            this.f23797s2.playTogether(animatorSet3.setDuration(150L), animatorSet4.setDuration(150L), ObjectAnimator.ofFloat(this.M1, this.f23803t3, 1.0f).setDuration(300L));
            if (!z15) {
                this.f23797s2.playTogether(ObjectAnimator.ofFloat(this.M1, this.f23808u3, 1.0f).setDuration(300L));
            }
            this.f23797s2.addListener(new vf(this, z15));
            this.f23797s2.setInterpolator(new DecelerateInterpolator());
            this.f23797s2.start();
            this.Y0.a(this.f23743i1);
        } else if (this.f23750j2 && i10 == 3) {
            return;
        } else {
            PowerManager.WakeLock wakeLock = this.f23780p2;
            if (wakeLock != null) {
            ...
            AnimatorSet animatorSet5 = this.f23797s2;
            if (animatorSet5 != null) {
                z11 = animatorSet5.isRunning();
                we weVar = this.f23698b1;
                if (weVar != null) {
                    weVar.setScaleX(1.0f);
                    this.f23698b1.setScaleY(1.0f);
                }
                this.f23797s2.removeAllListeners();
                this.f23797s2.cancel();
            } else {
                z11 = false;
            }
            AnimatorSet animatorSet6 = this.f23802t2;
            ...
            this.f23797s2 = new AnimatorSet();
            if (z11 || i10 == 4) {
                we weVar2 = this.f23698b1;
                if (weVar2 != null) {
                    weVar2.setVisibility(0);
                }
                this.f23797s2.playTogether(ObjectAnimator.ofFloat(this.Q0, this.Y3, 1.0f), ObjectAnimator.ofFloat(this.Q0, this.f23694a4, this.A0 ? 0.5f : 1.0f), ObjectAnimator.ofFloat(this.f23754k1, property4, 0.0f), ObjectAnimator.ofFloat(this.f23754k1, property3, 0.0f), ObjectAnimator.ofFloat(this.M1, this.f23803t3, 0.0f), ObjectAnimator.ofFloat(this.M1, this.f23808u3, 0.0f), ObjectAnimator.ofFloat(this.Z0, property5, 1.0f), ObjectAnimator.ofFloat(this.Y0, property5, 0.0f), ObjectAnimator.ofFloat(this.Z0, property5, 1.0f), ObjectAnimator.ofFloat(this.E0, property5, 1.0f), ObjectAnimator.ofFloat(this.E0, this.f23708c4, 0.0f), ObjectAnimator.ofFloat(this, "slideToCancelProgress", 1.0f));
                sg sgVar4 = this.N1;
                if (sgVar4 != null) {
                    i11 = 1;
                    c10 = 0;
                    this.f23797s2.playTogether(ObjectAnimator.ofFloat(sgVar4, property5, 0.0f));
                    this.N1.a();
                } else {
                    i11 = 1;
                    c10 = 0;
                }
                fi.c0 c0Var2 = this.f23759l0;
                if (c0Var2 != null) {
                    AnimatorSet animatorSet7 = this.f23797s2;
                    float[] fArr = new float[i11];
                    f7 = 1.0f;
                    fArr[c10] = 1.0f;
                    ObjectAnimator ofFloat = ObjectAnimator.ofFloat(c0Var2, property4, fArr);
                    fi.c0 c0Var3 = this.f23759l0;
                    float[] fArr2 = new float[i11];
                    fArr2[c10] = 1.0f;
                    ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(c0Var3, property3, fArr2);
                    fi.c0 c0Var4 = this.f23759l0;
                ...
                we weVar3 = this.f23698b1;
                if (weVar3 != null) {
                    weVar3.setScaleX(f7);
                    this.f23698b1.setScaleY(f7);
                    i12 = 1;
                    this.f23797s2.playTogether(ObjectAnimator.ofFloat(this.Z0, property5, f7));
                    this.f23698b1.j(s0() ? zgVar2 : zgVar, true);
                } else {
                    i12 = 1;
                }
                if (this.I1 != null) {
                    AnimatorSet animatorSet8 = this.f23797s2;
                ...
                if (this.f23774o1 != null) {
                    ViewPropertyAnimator viewPropertyAnimator2 = this.f23779p1;
                    ...
                    z12 = true;
                    r10 = 0;
                    this.f23797s2.playTogether(ObjectAnimator.ofFloat(this.f23774o1, this.f23701b4, 0.0f), ObjectAnimator.ofFloat(this.f23774o1, this.Z3, 1.0f));
                    AnimatorSet animatorSet9 = this.f23797s2;
                    ig.k kVar2 = this.f23784q1;
                    this.f23806u1 = 1.0f;
                    animatorSet9.playTogether(ObjectAnimator.ofFloat(kVar2, property5, 1.0f), ObjectAnimator.ofFloat(this.f23784q1, property3, 1.0f), ObjectAnimator.ofFloat(this.f23784q1, property4, 1.0f));
                } else {
                    r10 = 0;
                    z12 = true;
                }
                kh.h hVar2 = this.f23715d5;
                if (hVar2 != 0) {
                    hVar2.e(r10, r10, z12);
                }
                this.f23750j2 = z12;
                x0();
                this.f23797s2.setDuration(150L);
            } else if (i10 == 3) {
                X();
                Y();
                SlideTextView slideTextView2 = this.f23749j1;
                ...
                if (this.f23705c1) {
                    ...
                    if (keVar != null) {
                        keVar.setAlpha(1.0f);
                        this.f23718e1.setVisibility(0);
                    }
                    aj0 aj0Var = this.f23731g1;
                    if (aj0Var != null) {
                    ...
                    v71 v71Var = this.f23725f1;
                    if (v71Var != null) {
                        v71Var.setVisibility(8);
                        x0();
                    }
                    ke keVar2 = this.f23718e1;
                    if (keVar2 != null) {
                        keVar2.setVisibility(0);
                        f11 = 1.0f;
                        this.f23718e1.setAlpha(1.0f);
                    } else {
                        f11 = 1.0f;
                    }
                    gk0 gk0Var2 = this.f23737h1;
                    if (gk0Var2 != null) {
                        ...
                        this.f23737h1.setAlpha(0.0f);
                    }
                    z13 = true;
                }
                this.f23793r4 = z13;
                this.f23766m4 = f11;
                this.f23757k4 = this.f23751j4;
                this.f23746i4 = f11;
                SlideTextView slideTextView3 = this.f23749j1;
                ...
                aj0 aj0Var2 = this.f23731g1;
                if (aj0Var2 != null) {
                    aj0Var2.setAlpha(0.0f);
                    this.f23731g1.setScaleX(0.0f);
                    this.f23731g1.setScaleY(0.0f);
                    this.f23731g1.setProgress(0.0f);
                    this.f23731g1.i();
                }
                if (!this.f23705c1 && !this.f23831y4) {
                    viewGroup = (ViewGroup) this.f23718e1.getParent();
                    layoutParams = this.f23718e1.getLayoutParams();
                    viewGroup.removeView(this.f23718e1);
                    ...
                    this.l1.addView(this.f23718e1, layoutParams2);
                    this.f23725f1.setVisibility(8);
                } else {
                    this.f23725f1.setVisibility(0);
                    viewGroup = null;
                    layoutParams = null;
                }
                x0();
                ...
                if (!z10) {
                    Z();
                    this.f23803t3.set(this.M1, Float.valueOf(1.0f));
                    this.M1.setTransformToSeekbar(1.0f);
                    if (!this.f23705c1) {
                        float f12 = this.f23777o4;
                        if (f12 != 0.0f && this.f23737h1 != null) {
                            this.f23737h1.setAlpha(pr.f29497j.getInterpolation(Math.max(0.0f, ((f12 - 0.38f) - 0.25f) / 0.37f)));
                            this.f23737h1.invalidate();
                        }
                    }
                    this.f23754k1.setScaleY(0.0f);
                    this.f23754k1.setScaleX(0.0f);
                    ...
                    this.Y0.setTranslationX(-AndroidUtilities.dp(20.0f));
                    this.f23749j1.setAlpha(0.0f);
                    this.f23731g1.setAlpha(1.0f);
                    this.f23731g1.setScaleY(1.0f);
                    this.f23731g1.setScaleX(1.0f);
                    this.Y3.set(this.Q0, valueOf);
                    this.f23694a4.set(this.Q0, valueOf);
                    this.E0.setAlpha(0.0f);
                    we weVar4 = this.f23698b1;
                    if (weVar4 != null) {
                        if (s0()) {
                            zgVar = zgVar2;
                        }
                    ...
                    fi.c0 c0Var5 = this.f23759l0;
                    if (c0Var5 != null) {
                        c0Var5.setAlpha(0.0f);
                        this.f23759l0.setScaleX(0.0f);
                        this.f23759l0.setScaleY(0.0f);
                    }
                    if (s0()) {
                        this.f23725f1.setAlpha(1.0f);
                    }
                    if (viewGroup != null) {
                        this.l1.removeView(this.f23718e1);
                        viewGroup.addView(this.f23718e1, layoutParams);
                    }
                    this.f23718e1.setAlpha(1.0f);
                    this.f23737h1.setAlpha(1.0f);
                    this.h = 0.0f;
                    this.f23767n = 0.0f;
                    F1();
                    x0();
                } else {
                    this.f23737h1.setAllowDraw(false);
                    ...
                    animatorSet11.playTogether(ObjectAnimator.ofFloat(this.f23754k1, property4, 0.0f), ObjectAnimator.ofFloat(this.f23754k1, property3, 0.0f), ObjectAnimator.ofFloat(this.Y0, property5, 0.0f), ObjectAnimator.ofFloat(this.Y0, property2, -AndroidUtilities.dp(20.0f)), ObjectAnimator.ofFloat(this.f23749j1, property5, 0.0f), ObjectAnimator.ofFloat(this.f23731g1, property5, 1.0f), ObjectAnimator.ofFloat(this.f23731g1, property4, 1.0f), ObjectAnimator.ofFloat(this.f23731g1, property3, 1.0f), ObjectAnimator.ofFloat(this.Q0, this.Y3, 0.0f), ObjectAnimator.ofFloat(this.Q0, this.f23694a4, 0.0f), ObjectAnimator.ofFloat(this.E0, property5, 0.0f));
                    aj0 aj0Var3 = this.f23731g1;
                    if (aj0Var3 != null) {
                    ...
                    if (s0()) {
                        this.f23725f1.setAlpha(0.0f);
                        c11 = 1;
                        c12 = 0;
                        animatorSet10.playTogether(ObjectAnimator.ofFloat(this.f23725f1, property5, 1.0f));
                    ...
                    AnimatorSet animatorSet12 = this.f23797s2;
                    ...
                    this.f23797s2.addListener(new bi.j4(this, viewGroup, layoutParams, 2));
                }
            } else if (i10 != 2 && i10 != 5) {
                we weVar5 = this.f23698b1;
                if (weVar5 != null) {
                    weVar5.setVisibility(0);
                }
                AnimatorSet animatorSet13 = new AnimatorSet();
                animatorSet13.playTogether(ObjectAnimator.ofFloat(this.Q0, this.Y3, 1.0f), ObjectAnimator.ofFloat(this.Q0, this.f23694a4, this.A0 ? 0.5f : 1.0f), ObjectAnimator.ofFloat(this.f23754k1, property4, 0.0f), ObjectAnimator.ofFloat(this.f23754k1, property3, 0.0f), ObjectAnimator.ofFloat(this.Z0, property5, 1.0f));
                sg sgVar6 = this.N1;
                if (sgVar6 != null) {
                    animatorSet13.playTogether(ObjectAnimator.ofFloat(sgVar6, property5, 0.0f));
                    this.N1.a();
                }
                fi.c0 c0Var9 = this.f23759l0;
                if (c0Var9 != null) {
                    f10 = 1.0f;
                    animatorSet13.playTogether(ObjectAnimator.ofFloat(c0Var9, property4, 1.0f), ObjectAnimator.ofFloat(this.f23759l0, property3, 1.0f), ObjectAnimator.ofFloat(this.f23759l0, property5, 1.0f));
                } else {
                    f10 = 1.0f;
                }
                we weVar6 = this.f23698b1;
                if (weVar6 != null) {
                    weVar6.setScaleX(f10);
                    this.f23698b1.setScaleY(f10);
                    animatorSet13.playTogether(ObjectAnimator.ofFloat(this.Z0, property5, f10));
                    this.f23698b1.j(s0() ? zgVar2 : zgVar, true);
                }
                if (this.f23774o1 != null) {
                    ViewPropertyAnimator viewPropertyAnimator3 = this.f23779p1;
                    ...
                    i15 = 1;
                    r103 = 0;
                    animatorSet13.playTogether(ObjectAnimator.ofFloat(this.f23774o1, this.Z3, 1.0f));
                    ig.k kVar3 = this.f23784q1;
                    this.f23806u1 = 1.0f;
                    animatorSet13.playTogether(ObjectAnimator.ofFloat(kVar3, property5, 1.0f), ObjectAnimator.ofFloat(this.f23784q1, property3, 1.0f), ObjectAnimator.ofFloat(this.f23784q1, property4, 1.0f));
                } else {
                    r103 = 0;
                    i15 = 1;
                }
                kh.h hVar3 = this.f23715d5;
                if (hVar3 != 0) {
                ...
                ofFloat14.setDuration(this.f23730g0 ? 220L : 360L);
                this.G = 0.0f;
                J1();
                ObjectAnimator ofFloat15 = ObjectAnimator.ofFloat(this.E0, property5, 1.0f);
                ofFloat15.setStartDelay(this.f23794s == 1.0f ? 150L : 450L);
                ofFloat15.setDuration(200L);
                this.f23797s2.playTogether(animatorSet13, animatorSet14, ofFloat15, ofFloat14);
            } else {
                we weVar7 = this.f23698b1;
                if (weVar7 != null) {
                ...
                animatorSet15.playTogether(ObjectAnimator.ofFloat(this.Q0, this.Y3, 1.0f), ObjectAnimator.ofFloat(this.Q0, this.f23694a4, this.A0 ? 0.5f : 1.0f), ObjectAnimator.ofFloat(this.f23754k1, property4, 0.0f), ObjectAnimator.ofFloat(this.f23754k1, property3, 0.0f));
                sg sgVar7 = this.N1;
                if (sgVar7 != null) {
                    animatorSet15.playTogether(ObjectAnimator.ofFloat(sgVar7, property5, 0.0f));
                    this.N1.a();
                }
                fi.c0 c0Var10 = this.f23759l0;
                if (c0Var10 != null) {
                    animatorSet15.playTogether(ObjectAnimator.ofFloat(c0Var10, property4, 1.0f), ObjectAnimator.ofFloat(this.f23759l0, property3, 1.0f), ObjectAnimator.ofFloat(this.f23759l0, property5, 1.0f));
                }
                AnimatorSet animatorSet16 = new AnimatorSet();
                animatorSet16.playTogether(ObjectAnimator.ofFloat(this.Y0, property5, 0.0f), ObjectAnimator.ofFloat(this.Y0, property2, -AndroidUtilities.dp(20.0f)), ObjectAnimator.ofFloat(this.f23749j1, property5, 0.0f), ObjectAnimator.ofFloat(this.f23749j1, property2, -AndroidUtilities.dp(20.0f)));
                if (i10 != 5) {
                    this.Z0.setScaleX(0.0f);
                    this.Z0.setScaleY(0.0f);
                    ig.k kVar4 = this.f23784q1;
                    if (kVar4 != null && kVar4.getVisibility() == 0) {
                        this.f23784q1.setScaleX(0.5f);
                        this.f23784q1.setScaleY(0.5f);
                    }
                    cf cfVar = this.f23817w1;
                    if (cfVar != null && cfVar.getVisibility() == 0) {
                        this.f23817w1.setScaleX(0.0f);
                        this.f23817w1.setScaleY(0.0f);
                    }
                    ...
                    if (this.f23774o1 != null) {
                        ViewPropertyAnimator viewPropertyAnimator4 = this.f23779p1;
                        ...
                        i14 = 1;
                        r102 = 0;
                        animatorSet15.playTogether(ObjectAnimator.ofFloat(this.f23774o1, this.Z3, 1.0f), ObjectAnimator.ofFloat(this.f23774o1, this.f23701b4, 0.0f));
                        ig.k kVar5 = this.f23784q1;
                        this.f23806u1 = 1.0f;
                        animatorSet15.playTogether(ObjectAnimator.ofFloat(kVar5, property5, 1.0f), ObjectAnimator.ofFloat(this.f23784q1, property3, 1.0f), ObjectAnimator.ofFloat(this.f23784q1, property4, 1.0f));
                    } else {
                        r102 = 0;
                        i14 = 1;
                    }
                    kh.h hVar4 = this.f23715d5;
                    if (hVar4 != 0) {
                    ...
                    if (this.f23698b1 != null) {
                        ...
                        this.f23698b1.j(s0() ? zgVar2 : zgVar, i14);
                    }
                    af afVar3 = this.I1;
                    if (afVar3 != null) {
                    ...
                    if (this.f23774o1 != null) {
                        ViewPropertyAnimator viewPropertyAnimator5 = this.f23779p1;
                        if (viewPropertyAnimator5 != null) {
                            viewPropertyAnimator5.cancel();
                            this.f23779p1 = null;
                        }
                        i13 = 1;
                        animatorSet17.playTogether(ObjectAnimator.ofFloat(this.f23774o1, this.f23701b4, 0.0f), ObjectAnimator.ofFloat(this.f23774o1, this.Z3, 1.0f));
                        ig.k kVar6 = this.f23784q1;
                        this.f23806u1 = 1.0f;
                        animatorSet17.playTogether(ObjectAnimator.ofFloat(kVar6, property5, 1.0f), ObjectAnimator.ofFloat(this.f23784q1, property3, 1.0f), ObjectAnimator.ofFloat(this.f23784q1, property4, 1.0f));
                    } else {
                        i13 = 1;
                    }
                    kh.h hVar5 = this.f23715d5;
                    if (hVar5 != null) {
                        hVar5.e(0, false, i13);
                    }
                    af afVar4 = this.I1;
                    ...
                    AnimatorSet animatorSet18 = this.f23797s2;
                ...
                ofFloat23.setStartDelay(this.f23794s == 1.0f ? 300L : 700L);
                ofFloat23.setDuration(200L);
                this.f23797s2.playTogether(animatorSet15, animatorSet16, ofFloat23, ObjectAnimator.ofFloat(this, "lockAnimatedTranslation", this.f23751j4).setDuration(200L));
                if (i10 != 5) {
                    ...
                    this.f23797s2.playTogether(ofFloat24);
                } else {
                    ChatActivityEnterView.this.f23787q4 = true;
                    ...
                    this.f23797s2.playTogether(duration);
                }
                ug ugVar2 = this.f23754k1;
                if (ugVar2 != null) {
                    ugVar2.f30912e = true;
                    xi0 xi0Var = ugVar2.f30913f;
                    xi0Var.Q(0.0f, true);
                    if (ugVar2.d) {
                        xi0Var.start();
                    }
            ...
            this.f23797s2.addListener(new yf(this, i10));
            this.f23797s2.start();
            xg xgVar3 = this.Y0;
            if (xgVar3 != null) {
                xgVar3.b();
    ...
    public final void M1() {
        int i02 = i0(org.telegram.ui.ActionBar.j6.f20808jf);
        int i03 = i0(org.telegram.ui.ActionBar.j6.Sd);
        int i04 = i0(org.telegram.ui.ActionBar.j6.f20700df);
        aj0 aj0Var = this.f23731g1;
        if (aj0Var != null) {
            aj0Var.h(i02, "Cup Red");
            this.f23731g1.h(i02, "Box Red");
            this.f23731g1.h(i04, "Cup Grey");
            this.f23731g1.h(i04, "Box Grey");
            this.f23731g1.h(i03, "Line 1");
            this.f23731g1.h(i03, "Line 2");
            this.f23731g1.h(i03, "Line 3");
        }
    }
    ...
    public final void N() {
        ...
        int i11;
        int i12;
        float f7 = this.f23729f5.f15395e;
        if (this.F1 != null) {
            float measuredHeight = getMeasuredHeight() - this.f23722e5.f15403e;
            View view = this.F1;
    ...
    public final void O() {
        org.telegram.ui.co coVar = this.O2;
        if (coVar != null) {
            MediaDataController.getInstance(this.Q).saveDraft(coVar.a(), coVar.B7(coVar.f35380n5), "", null, null, null, null, 0L, false, true, null);
        }
    ...
    public final void O1(boolean z10) {
        ...
        if (isChatDialog) {
            TLRPC.Chat chat = this.R.getMessagesController().getChat(Long.valueOf(-this.P2));
            this.f23726f2 = MessagesController.getNotificationsSettings(this.Q).getBoolean("silent_" + this.P2, false);
            ...
            this.f23732g2 = z11;
            if (imageView != null) {
                if (this.f23717e0 == null) {
                    this.f23717e0 = new mr(getContext(), R.drawable.input_notify_on, org.telegram.ui.ActionBar.j6.Wk);
                }
                this.f23717e0.a(this.f23726f2, false);
                imageView.setImageDrawable(this.f23717e0);
            } else {
                z11 = false;
            }
            org.telegram.ui.yd ydVar = this.f23774o1;
    ...
    public final void Q() {
        ...
        this.f23817w1.setScaleType(ImageView.ScaleType.CENTER);
        this.f23817w1.setBackground(org.telegram.ui.ActionBar.j6.f0(i0(org.telegram.ui.ActionBar.j6.f20781i6), 1, -1));
        this.f23817w1.setVisibility(8);
        AndroidUtilities.updateViewVisibilityAnimated(this.f23817w1, false, 0.1f, false);
        this.f23774o1.addView(this.f23817w1, 0, w7.x5.n(44, 44));
        this.f23817w1.setOnClickListener(new ud(this, 15));
    }

    public final void Q0(TL_iv.RichMessage richMessage) {
        org.telegram.ui.co coVar = this.O2;
        if (coVar != null) {
            MediaDataController.getInstance(this.Q).saveDraft(coVar.a(), coVar.B7(coVar.f35380n5), "", null, null, null, null, 0L, false, false, richMessage);
        }
    ...
    public final void Q1(boolean z10, boolean z11) {
        ...
        if (this.Y2 != null) {
            ...
            org.telegram.ui.co coVar = this.O2;
            boolean z13 = true;
            if (!z10 && peer2 != null && ((this.Y2.H() == null || this.Y2.H().peers.size() > 1) && !r0() && !w0() && (((keVar = this.f23718e1) == null || keVar.getVisibility() != 0) && ((this.f23758k5 || ((!ChatObject.isChannelAndNotMegaGroup(chat) || ChatObject.canSendAsPeers(chat)) && !ChatObject.isMonoForum(chat))) && (coVar == null || coVar.R3 != 9))))) {
                z12 = true;
            } else {
                z12 = false;
            }
            ...
            if (peer2 != null) {
                if (peer2.channel_id != 0) {
                    ...
                    if (chat3 != null && (xo0Var2 = this.f23778p0) != null) {
                        xo0Var2.setAvatar(chat3);
                        this.f23778p0.setContentDescription(LocaleController.formatString(R.string.AccDescrSendAs, chat3.title));
                    }
                } else {
                    TLRPC.User user = MessagesController.getInstance(this.Q).getUser(Long.valueOf(peer2.user_id));
                    if (user != null && (xo0Var = this.f23778p0) != null) {
                        xo0Var.setAvatar(user);
                        this.f23778p0.setContentDescription(LocaleController.formatString(R.string.AccDescrSendAs, ContactsController.formatName(user.first_name, user.last_name)));
                    }
                }
            }
            xo0 xo0Var3 = this.f23778p0;
            ...
            if (xo0Var4 != null) {
                ...
                if (z12) {
                    ...
                    f10 = ((-this.f23778p0.getLayoutParams().width) - marginLayoutParams.leftMargin) - dp;
                }
            } else {
                f10 = 0.0f;
                f11 = 0.0f;
            ...
            if (z13 != z12) {
                ...
                if (valueAnimator != null) {
                    ...
                    this.f23778p0.setTag(null);
                }
                if ((!this.f23758k5 && (coVar == null || coVar.F8() != 0 || !coVar.O5)) || !z11) {
                    float f14 = f10;
                    float f15 = f12;
                    boolean z14 = z12;
                    if (z14) {
                    ...
                    if (xo0Var6 != null) {
                        ...
                        this.f23778p0.setTranslationX(f14);
                    }
                    if (z14) {
                        f13 = f14;
                    }
    ...
    public final void R() {
        if (this.f23759l0 == null) {
            fi.c0 c0Var = new fi.c0(getContext());
            this.f23759l0 = c0Var;
            c0Var.setOnClickListener(new ud(this, 7));
            this.f23823x1.addView(this.f23759l0, w7.x5.d(-2, 32.0f, 83, 8.0f, 6.0f, 8.0f, 6.0f));
            AndroidUtilities.updateViewVisibilityAnimated(this.f23759l0, false, 1.0f, false);
            fi.c0 c0Var2 = this.f23759l0;
            if (!c0Var2.f9607f) {
                c0Var2.f9607f = true;
                c0Var2.h = 1.0f;
    ...
    public final void R1() {
        ...
        boolean z10 = true;
        if (this.f23804t4 != starsPrice) {
            View sendButtonInternal = getSendButtonInternal();
            this.f23804t4 = starsPrice;
        ...
        if (this.f23758k5) {
            ...
            if (this.f23704c0 != b10) {
                this.f23704c0 = b10;
                if (b10 > 0) {
                    int i12 = b10 - this.f23710d0;
                    if (this.f23758k5) {
                        i10 = 5;
                    } else {
                        i10 = 100;
                    ...
                    if (i12 <= i10) {
                        ...
                        if (this.f23697b0.getVisibility() != 0) {
                            this.f23697b0.setVisibility(0);
                            this.f23697b0.setAlpha(0.0f);
                            this.f23697b0.setScaleX(0.5f);
                            this.f23697b0.setScaleY(0.5f);
                        }
                        this.f23697b0.animate().setListener(null).cancel();
                        this.f23697b0.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setDuration(100L).start();
                        NumberTextView numberTextView2 = this.f23697b0;
                        if (i12 < 0) {
                ...
                NumberTextView numberTextView3 = this.f23697b0;
    ...
    public final void S() {
        if (this.f23697b0 != null) {
            return;
        }
        NumberTextView numberTextView = new NumberTextView(getContext());
        this.f23697b0 = numberTextView;
        numberTextView.setVisibility(8);
        this.f23697b0.setTextSize(15);
        this.f23697b0.setTextColor(i0(org.telegram.ui.ActionBar.j6.f21070y6));
        this.f23697b0.setTypeface(AndroidUtilities.bold());
        this.f23697b0.setCenterAlign(true);
        addView(this.f23697b0, Math.min(2, getChildCount()), w7.x5.d(44, 20.0f, 85, 3.0f, 0.0f, 0.0f, 44.0f));
    }
    ...
    public final void S1() {
        ...
        this.H0 = null;
        TLRPC.ChatFull chatFull = this.f23706c2;
        int i11 = 2147483646;
        if (chatFull != null && chatFull.slowmode_seconds != 0 && chatFull.slowmode_next_send_date <= currentTime && ((isUploadingMessageIdDialog = SendMessagesHelper.getInstance(this.Q).isUploadingMessageIdDialog(this.P2)) || SendMessagesHelper.getInstance(this.Q).isSendingMessageIdDialog(this.P2))) {
            if (!ChatObject.hasAdminRights(this.R.getMessagesController().getChat(Long.valueOf(this.f23706c2.f19897id))) && !ChatObject.isIgnoredChatRestrictionsForBoosters(this.f23706c2)) {
                i10 = this.f23706c2.slowmode_seconds;
            ...
            int i12 = this.G0;
            if (i12 >= 2147483646) {
                if (this.f23706c2 != null) {
                    this.R.getMessagesController().loadFullChat(this.f23706c2.f19897id, 0, true);
                }
                i10 = 0;
            } else {
                i10 = i12 - currentTime;
        ...
        if (this.G0 != 0 && i10 > 0) {
            ...
            wg wgVar = this.F0;
            wgVar.f32290a.l(formatDurationNoHours, false);
            wgVar.invalidate();
            og ogVar = this.Y2;
            if (ogVar != null) {
                ogVar.n1(wgVar, wgVar.f32290a.getText(), false);
            }
    ...
    public final void T(boolean z10) {
        ...
        this.f23829y1.addView(this.E1, w7.x5.e(44, 44, 85));
    }
    ...
    public final void U() {
        boolean z10;
        eg egVar = this.U0;
        if (egVar != null && egVar.f27960c1 != UserConfig.selectedAccount) {
            this.f23763m1.removeView(egVar);
            this.U0 = null;
        }
        if (this.U0 != null) {
            return;
        ...
        eg egVar4 = this.U0;
        if (egVar4 != null) {
            egVar4.M(-this.P2, !this.f23832z0, !this.f23696b);
        }
        u();
        F();
    }
    ...
    public final void V() {
        ...
        this.S0.setBackground(org.telegram.ui.ActionBar.j6.f0(i0(org.telegram.ui.ActionBar.j6.f20781i6), 1, -1));
        this.f23833z1.addView(this.S0, w7.x5.e(44, 44, 85));
    ...
    public final void W() {
        ...
        org.telegram.ui.co coVar = this.O2;
        if (coVar != null && coVar.getParentLayout() != null && ((ActionBarLayout) coVar.getParentLayout()).f20168b) {
        ...
        this.E0.setLinkTextColor(i0(org.telegram.ui.ActionBar.j6.f20768hc));
        this.E0.setHighlightColor(i0(org.telegram.ui.ActionBar.j6.f21009uf));
        qf qfVar3 = this.E0;
        ...
        this.E0.setHandlesColor(i0(org.telegram.ui.ActionBar.j6.f21026vf));
        qf qfVar4 = this.E0;
        boolean z11 = this.W3;
        if (z11) {
            f7 = 50.0f;
    ...
    public final void X() {
        ...
        this.f23718e1.setFocusable(true);
        this.f23718e1.setFocusableInTouchMode(true);
        this.f23718e1.setClickable(true);
        this.f23823x1.addView(this.f23718e1, w7.x5.e(-1, 44, 80));
        ?? imageView = new ImageView(getContext());
        this.f23731g1 = imageView;
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        this.f23731g1.f(R.raw.chat_audio_record_delete_2, 28, 28, null);
        this.f23731g1.getAnimatedDrawable().f32598p0 = true;
        M1();
        this.f23731g1.setContentDescription(LocaleController.getString("Delete", R.string.Delete));
        this.f23731g1.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.f0(i0(org.telegram.ui.ActionBar.j6.f20781i6), 1, -1));
        this.f23718e1.addView(this.f23731g1, w7.x5.c(44.0f, 44));
        this.f23731g1.setOnClickListener(new ud(this, 6));
        v71 v71Var = new v71(getContext());
        this.f23725f1 = v71Var;
        v71Var.setVisibility(4);
        v71 v71Var2 = this.f23725f1;
        v71Var2.S = !this.f23826x4;
        v71Var2.setRoundFrames(true);
        this.f23725f1.setDelegate(new ef(this));
        this.f23718e1.addView(this.f23725f1, w7.x5.d(-1, -1.0f, 19, 56.0f, 0.0f, 8.0f, 0.0f));
        Context context = getContext();
        ...
        view.f30576b = context.getDrawable(R.drawable.tooltip_arrow);
        view.f30575a = org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(5.0f), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20934qf, false));
        view.b();
        view.setTime(0);
        this.f23725f1.setTimeHintView(view);
        this.l1.addView((View) view, w7.x5.d(-1, -2.0f, 80, 0.0f, 0.0f, 0.0f, 52.0f));
        gk0 gk0Var = new gk0(getContext(), this.V3);
        this.f23737h1 = gk0Var;
        this.f23718e1.addView(gk0Var, w7.x5.d(-1, 32.0f, 19, 44.0f, 0.0f, 4.0f, 0.0f));
        H1(this.O4);
    }
    ...
    public final void X0(a0.i iVar, boolean z10) {
        ...
        if (iVar.m() == 1 && ((TL_bots.BotInfo) iVar.n(0)).user_id == this.P2) {
            ...
            if (botMenuButton instanceof TL_bots.TL_botMenuButton) {
                ...
                this.f23742i0 = tL_botMenuButton.text;
                this.f23748j0 = tL_botMenuButton.url;
                this.f23762l5 = 3;
    ...
    public final void Z() {
        if (this.f23711d1 == null && getContext() != null) {
            bi.g5 g5Var = new bi.g5(getContext(), 14);
            this.f23711d1 = g5Var;
            g5Var.setClipChildren(false);
            this.f23711d1.setVisibility(8);
            this.f23823x1.addView(this.f23711d1, w7.x5.c(44.0f, -1));
            this.f23711d1.setOnTouchListener(new ci.d(12));
            bi.g5 g5Var2 = this.f23711d1;
            SlideTextView slideTextView = new SlideTextView(getContext());
            this.f23749j1 = slideTextView;
            ...
            this.f23711d1.addView(this.d, w7.x5.e(-1, -1, 16));
        }
    }
    ...
    public final void a0() {
        if (this.I1 == null && this.O2 != null) {
            ...
            mutate2.setColorFilter(new PorterDuffColorFilter(i0(org.telegram.ui.ActionBar.j6.f20808jf), mode));
            ...
            this.I1.setBackground(org.telegram.ui.ActionBar.j6.f0(i0(org.telegram.ui.ActionBar.j6.f20781i6), 1, -1));
            this.f23823x1.addView(this.I1, 2, w7.x5.e(44, 44, 85));
    ...
    public final void a1(MessageObject messageObject, String str, boolean z10, boolean z11) {
        ...
        if (str != null && getVisibility() == 0 && (qfVar = this.E0) != null) {
            ...
            if (z10) {
                ...
                if ((this.f23770n2 != 1 || z11) && user3 != null && user3.bot && !str.contains("@")) {
                ...
                if (!this.f23830y2 && this.f23719e2 == -1) {
                    H0();
                }
            } else if (this.G0 > 0 && !c()) {
                og ogVar2 = this.Y2;
                if (ogVar2 != null) {
                    wg wgVar = this.F0;
                    ogVar2.n1(wgVar, wgVar.f32290a.getText(), true);
                }
            } else {
                if (messageObject != null && DialogObject.isChatDialog(this.P2)) {
                ...
                if ((this.f23770n2 != 1 || z11) && user != null && user.bot && !str.contains("@")) {
    ...
    public final void b0() {
        if (this.f23778p0 == null && getContext() != null) {
            ?? view = new View(getContext());
            ImageReceiver imageReceiver = new ImageReceiver(view);
            view.f32663a = imageReceiver;
            view.f32664b = new i9((org.telegram.ui.ActionBar.f6) null);
            Paint paint = new Paint(1);
            view.d = paint;
            Paint paint2 = new Paint(1);
            view.f32666e = paint2;
            ...
            paint.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20681cf, false));
            paint2.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20662bf, false));
            int dp = AndroidUtilities.dp(18.0f);
            int l1 = org.telegram.ui.ActionBar.j6.l1(0.2f, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20691d6, false));
            ...
            this.f23778p0.setVisibility(8);
            this.f23823x1.addView(this.f23778p0, w7.x5.d(36, 36.0f, 83, 4.66f, 4.0f, 4.66f, 4.0f));
        }
    }
    ...
    public final void b1(int i10, long j3) {
        ...
        this.f23832z0 = true;
        if (DialogObject.isChatDialog(this.P2)) {
            this.f23832z0 = ChatObject.canSendPlain(this.R.getMessagesController().getChat(Long.valueOf(-this.P2)));
        }
        O1(false);
        I1(false);
        J();
    ...
    public final boolean c0(TL_keyboard.KeyboardButtonProto keyboardButtonProto, MessageObject messageObject, MessageObject messageObject2, org.telegram.ui.zi ziVar) {
        ...
        if (keyboardButtonProto != null && messageObject2 != null && ((coVar = this.O2) == null || coVar.R3 != 5)) {
            ...
            if (tL_inlineButtonTypeUrl != null) {
                ...
                if (t3Var != null) {
                    t3Var.S0 = false;
                    t3Var.f31365x1.setVisibility(8);
                    t3Var.S1(false, bool);
                    return false;
                }
                ...
                if (tL_inlineButtonTypeSwitchInline != null) {
                    ...
                    if (requestPeerType != null && messageObject2.messageOwner != null) {
                        if (requestPeerType instanceof TLRPC.TL_requestPeerTypeCreateBot) {
                            ...
                            org.telegram.ui.tj0 tj0Var = org.telegram.ui.tj0.f40795u0;
                            org.telegram.ui.ActionBar.n2 R = LaunchActivity.R();
                            if (R == null || org.telegram.ui.tj0.f40795u0 != null) {
                                return false;
                            }
                            org.telegram.ui.tj0 tj0Var2 = new org.telegram.ui.tj0(R, i10, bool2, bool3, heVar);
                            tj0Var2.show();
                            org.telegram.ui.tj0.f40795u0 = tj0Var2;
                            return false;
                        } else {
    ...
    public final void d() {
        ...
        xg xgVar = this.Y0;
        if (xgVar != null && (textPaint = xgVar.f32560x) != null) {
            textPaint.setColor(xgVar.F.i0(org.telegram.ui.ActionBar.j6.f20880nf));
        }
        v71 v71Var = this.f23725f1;
        if (v71Var != null) {
            v71Var.f31175e.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20635a7, false));
            v71Var.L = 0;
            t71 t71Var = v71Var.P;
            if (t71Var != null) {
                t71Var.b();
        ...
        if (numberTextView != null && this.E0 != null) {
            if (this.f23710d0 - this.f23704c0 < 0) {
                numberTextView.setTextColor(i0(org.telegram.ui.ActionBar.j6.f20908p7));
            } else {
                numberTextView.setTextColor(i0(org.telegram.ui.ActionBar.j6.f21070y6));
            }
        }
        Color.alpha(i0(org.telegram.ui.ActionBar.j6.f20662bf));
        of ofVar = this.m0;
        if (ofVar != null) {
            ofVar.d.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.Ii, false));
            dh.d dVar = ofVar.f10132r;
            if (dVar != null) {
                dVar.u();
            }
            ofVar.invalidate();
        ...
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.f23698b1.setColorFilter(new PorterDuffColorFilter(i10, mode));
        int i11 = org.telegram.ui.ActionBar.j6.Wk;
    ...
    public final void d0() {
        ...
        if (messageObject != null) {
            ...
            if (needResendWhenEdit && !ChatObject.canManageMonoForum(this.Q, this.Y1.getDialogId())) {
                if (coVar == null || (of3 = coVar.f35295g5) == null) {
            ...
            if (this.f23704c0 - this.f23710d0 < 0) {
                NumberTextView numberTextView = this.f23697b0;
                ...
                if (!MessagesController.getInstance(this.Q).premiumFeaturesBlocked() && MessagesController.getInstance(this.Q).captionLengthLimitPremium > this.f23710d0) {
                    q1();
                    return;
                }
                return;
            ...
            if (!TextUtils.equals(charSequenceArr[0], this.Y1.messageText) || ((entities != null && !entities.isEmpty()) || !this.Y1.messageOwner.entities.isEmpty() || (this.Y1.messageOwner.media instanceof TLRPC.TL_messageMediaWebPage))) {
                ...
                if (coVar != null && (chat = coVar.f35265e) != null && (((i10 = messageObject3.type) == 0 || i10 == 19) && !ChatObject.canSendEmbed(chat))) {
                    MessageObject messageObject4 = this.Y1;
                    messageObject4.editingMessageSearchWebPage = false;
                    TLRPC.Message message = messageObject4.messageOwner;
                    message.flags &= -513;
                    message.media = null;
                } else if (coVar != null && (messagePreviewParams = coVar.f35283f5) != null) {
                    if (coVar.G5 instanceof TLRPC.TL_webPagePending) {
                        ...
                        this.Y1.messageOwner.media.webpage = coVar.f35283f5.webpage;
                    } else {
                ...
                if (this.Y1.needResendWhenEdit()) {
                    ...
                    if (coVar == null || (of2 = coVar.f35295g5) == null) {
    ...
    public final void d1(boolean z10, boolean z11) {
        ...
        ne neVar = this.Q0;
        if (neVar != null) {
            if (this.f23812v2 == 1 || ((keVar = this.f23718e1) != null && keVar.getVisibility() == 0)) {
                this.h = 0.0f;
                this.f23767n = 0.0f;
                F1();
                z11 = false;
            }
            zg zgVar2 = zg.f33181f;
            zg zgVar3 = zg.f33180e;
            if (z10 && this.f23719e2 == 0) {
                if (this.f23832z0) {
                    zgVar = zg.d;
                } else {
                    return;
            ...
            if (!this.f23832z0 && zgVar == zgVar3) {
                zgVar3 = zgVar2;
            } else if (this.f23696b || zgVar == zgVar3) {
                zgVar3 = zgVar;
            }
            neVar.j(zgVar3, z11);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.emojiLoaded) {
            ...
            bg bgVar = this.G1;
            if (bgVar != null) {
                ArrayList arrayList = bgVar.f9902n;
            ...
            if (((Integer) objArr[0]).intValue() == this.F2) {
                if (this.f23812v2 != 0 && !this.f23761l3 && !c()) {
                    this.f23761l3 = true;
            ...
            if (i10 != NotificationCenter.recordStartError && i10 != NotificationCenter.recordStopped) {
                ...
                if (i10 == NotificationCenter.recordPaused) {
                    ...
                    if (((Integer) objArr[0]).intValue() == this.F2) {
                        ...
                        if (obj instanceof VideoEditedInfo) {
                            ...
                            this.f23713d3 = videoEditedInfo;
                            String str = (String) objArr[2];
                            this.f23700b3 = str;
                            ArrayList<Bitmap> arrayList2 = (ArrayList) objArr[3];
                            this.f23743i1 = videoEditedInfo.estimatedDuration;
                            v71 v71Var = this.f23725f1;
                            if (v71Var != null) {
                                v71Var.setVideoPath(str);
                                this.f23725f1.setKeyframes(arrayList2);
                                this.f23725f1.setVisibility(0);
                                this.f23725f1.setMinProgressDiff(1000.0f / ((float) this.f23713d3.estimatedDuration));
                                x0();
                            }
                            L1(3, true);
                            K(false);
                        ...
                        this.f23693a3 = (TLRPC.TL_document) obj;
                        this.f23700b3 = (String) objArr[2];
                        ...
                        if (this.f23693a3 != null) {
                            ...
                            if (this.f23718e1 != null) {
                                ...
                                tL_message.message = "";
                                tL_message.attachPath = this.f23700b3;
                                TLRPC.TL_messageMediaDocument tL_messageMediaDocument = new TLRPC.TL_messageMediaDocument();
                                tL_message.media = tL_messageMediaDocument;
                                tL_messageMediaDocument.flags |= 3;
                                tL_messageMediaDocument.document = this.f23693a3;
                                tL_message.flags |= 768;
                                this.f23707c3 = new MessageObject(UserConfig.selectedAccount, tL_message, false, true);
                                this.f23718e1.setAlpha(1.0f);
                                this.f23718e1.setVisibility(0);
                                this.f23731g1.setVisibility(0);
                                this.f23731g1.setAlpha(0.0f);
                                this.f23731g1.setScaleY(0.0f);
                                this.f23731g1.setScaleX(0.0f);
                                int i15 = 0;
                                while (true) {
                                    if (i15 < this.f23693a3.attributes.size()) {
                                        TLRPC.DocumentAttribute documentAttribute = this.f23693a3.attributes.get(i15);
                                ...
                                int i16 = 0;
                                while (true) {
                                    if (i16 >= this.f23693a3.attributes.size()) {
                                        break;
                                    }
                                    TLRPC.DocumentAttribute documentAttribute2 = this.f23693a3.attributes.get(i16);
                                    if (documentAttribute2 instanceof TLRPC.TL_documentAttributeAudio) {
                                        byte[] bArr2 = documentAttribute2.waveform;
                                        if (bArr2 == null || bArr2.length == 0) {
                                            documentAttribute2.waveform = MediaController.getWaveform(this.f23700b3);
                                        }
                                ...
                                if (z10 && (kVar = this.f23784q1) != null) {
                                    this.f23806u1 = 0.0f;
                                    kVar.setAlpha(0.0f);
                                    kVar.setScaleX(0.0f);
                                    kVar.setScaleY(0.0f);
                                }
                                this.f23743i1 = (long) (1000.0d * d);
                                gk0 gk0Var = this.f23737h1;
                                String str2 = this.f23700b3;
                                if (!gk0Var.Q) {
                                    gk0Var.f26451r = (float) d;
                                    gk0Var.f26452s = f7;
                                    gk0Var.v = f10;
                                    gk0Var.f26453w = false;
                                    gk0Var.h.q(AndroidUtilities.formatDuration((int) Math.round(Math.max(1.0d, d)), false), false, true);
                                    gk0Var.f26449f.a(false, false);
                                    if (gk0Var.f26450n == null) {
                                        g71 g71Var = new g71();
                                        gk0Var.f26450n = g71Var;
                                        g71Var.J = new ji.u4(gk0Var, 13);
                                    }
                                    gk0Var.f26450n.D(Uri.fromFile(new File(str2)), "other");
                                    gk0Var.K = 0;
                                    gk0Var.L = bArr;
                                    gk0Var.invalidate();
                                }
                                ...
                                if (z10) {
                                    ...
                                    this.f23812v2 = 1;
                                    this.M1.c(false);
                                    this.f23808u3.set(this.M1, Float.valueOf(1.0f));
                                    sg sgVar = this.N1;
                                    if (sgVar != null) {
                    ...
                    if (this.f23707c3 != null && MediaController.getInstance().isPlayingMessage(this.f23707c3)) {
                        MessageObject playingMessageObject = MediaController.getInstance().getPlayingMessageObject();
                        MessageObject messageObject = this.f23707c3;
                    ...
                    if (!((Boolean) objArr[6]).booleanValue()) {
                        ...
                        if (longValue == this.P2 && (chatFull = this.f23706c2) != null && chatFull.slowmode_seconds != 0 && !MessageObject.isEphemeralMessageId(num2.intValue()) && (chat = this.R.getMessagesController().getChat(Long.valueOf(this.f23706c2.f19897id))) != null && !ChatObject.hasAdminRights(chat) && !ChatObject.isIgnoredChatRestrictionsForBoosters(chat)) {
                            TLRPC.ChatFull chatFull2 = this.f23706c2;
                            int currentTime = ConnectionsManager.getInstance(this.Q).getCurrentTime();
                            TLRPC.ChatFull chatFull3 = this.f23706c2;
                ...
                if (i10 == NotificationCenter.recordStopped) {
                    ...
                    if (num3.intValue() == 4) {
                        i14 = 4;
                    } else if (this.f23705c1 && num3.intValue() == 5) {
                        i14 = 1;
    ...
    public final void e0(Canvas canvas, boolean z10) {
        ...
        int z11 = (int) com.google.android.gms.internal.vision.e2.z(1.0f, this.B4, org.telegram.ui.ActionBar.j6.f20778i3.getIntrinsicHeight(), this.S1);
        View view = this.F1;
        if (view != null && view.getVisibility() == 0) {
            z11 = (int) (((1.0f - getTopViewEnterProgress()) * this.F1.getLayoutParams().height) + z11);
        }
        int intrinsicHeight = org.telegram.ui.ActionBar.j6.f20778i3.getIntrinsicHeight() + z11;
        if (z10) {
            org.telegram.ui.ActionBar.j6.f20778i3.setAlpha((int) (this.B4 * 255.0f));
            org.telegram.ui.ActionBar.j6.f20778i3.setBounds(0, z11, getMeasuredWidth(), intrinsicHeight);
            org.telegram.ui.ActionBar.j6.f20778i3.draw(canvas);
        }
        if (this.f23820w4) {
    ...
    public final boolean f0(Canvas canvas, Utilities.Callback0Return callback0Return) {
        ...
        float f11;
        float f12;
        float e7 = this.f23695a5.e(this.E0.canScrollVertically(-1));
        float e10 = this.f23702b5.e(this.E0.canScrollVertically(1));
        if (e7 <= 0.0f && e10 <= 0.0f) {
    ...
    public final zf g0(MessageObject messageObject, boolean z10) {
        ...
        if (z10) {
            ...
            messageObject2.caption = MessageObject.replaceAnimatedEmoji(Emoji.replaceEmoji((CharSequence) spannableStringBuilder, org.telegram.ui.ActionBar.j6.f20886o2.getFontMetricsInt(), false, (int[]) null), entities, org.telegram.ui.ActionBar.j6.f20886o2.getFontMetricsInt());
        }
    ...
    public fi.f4 getBotWebViewButton() {
        if (this.f23753k0 == null) {
            Context context = getContext();
            ?? frameLayout = new FrameLayout(context);
            frameLayout.f9686a = new Path();
            frameLayout.f9688c = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.Oh, false);
            ...
            this.f23753k0 = frameLayout;
            frameLayout.setVisibility(8);
            R();
            this.f23753k0.setBotMenuButton(this.f23759l0);
            this.f23823x1.addView(this.f23753k0, w7.x5.e(-1, -1, 80));
        }
    ...
    public float getSlideToCancelProgress() {
        return this.f23746i4;
    }

    public CharSequence getSlowModeTimer() {
        if (this.G0 > 0) {
            return this.F0.f32290a.getText();
        }
        return null;
    }
    ...
    public void h1(float f7, float f10, float f11, boolean z10) {
        ...
        keVar.setAlpha(f11);
        ImageView imageView = this.f23811v1;
        if (imageView != null) {
    ...
    public final void i1(boolean z10) {
        ...
        this.f23784q1.setVisibility(i10);
        if (z10) {
            AndroidUtilities.removeFromParent(this.H1);
        }
        if (z10) {
            this.f23698b1.setVisibility(8);
        } else {
            P0();
        }
        if (!z10) {
    ...
    public final void l1(MessageObject messageObject, org.telegram.ui.sn snVar, MessageObject messageObject2) {
        ...
        if (messageObject != null) {
            if (this.V2 == null && (messageObject3 = this.f23760l2) != this.S2) {
                this.V2 = messageObject3;
            }
            this.S2 = messageObject;
            this.U2 = snVar;
            this.T2 = messageObject2;
            if (coVar == null || !coVar.f35305h4 || coVar.X3 != messageObject) {
                Z0(messageObject, true, true);
            }
        } else if (this.S2 == this.f23760l2) {
            this.S2 = null;
            this.T2 = null;
            this.U2 = null;
    ...
    public final void m1(int i10, boolean z10) {
        ...
        if (z11 != z12) {
            ValueAnimator valueAnimator = this.f23810v0;
            if (valueAnimator != null) {
                valueAnimator.removeAllListeners();
                this.f23810v0.cancel();
            }
            float f7 = 0.0f;
            if (!z10) {
                if (z11) {
                ...
                float f10 = this.f23816w0;
                if (z11) {
                    f7 = 1.0f;
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, f7);
                this.f23810v0 = ofFloat;
                ofFloat.addUpdateListener(new qd(this, 4));
                this.f23810v0.addListener(new df(this, z11, 3));
                this.f23810v0.setDuration(220L);
                this.f23810v0.setInterpolator(pr.f29494f);
                this.f23810v0.start();
            }
        }
        this.Q1 = i10;
    ...
    public final void n(TLRPC.Document document) {
        ...
        if (egVar != null && document != null) {
            boolean isEmpty = egVar.f27980i1.isEmpty();
            egVar.Y();
            if (isEmpty) {
                egVar.Z(false);
            }
    ...
    public final boolean n0(boolean z10, boolean z11, boolean z12) {
        ...
        TLRPC.TL_replyKeyboardMarkup tL_replyKeyboardMarkup;
        if (t0()) {
            if (this.f23719e2 == 1 && (tL_replyKeyboardMarkup = this.f23764m2) != null && z10 && this.f23760l2 != null) {
                if (!tL_replyKeyboardMarkup.is_persistent) {
                    SharedPreferences.Editor edit = MessagesController.getMainSettings(this.Q).edit();
                    edit.putInt("closed_botkeyboard_" + getTopicKeyString(), this.f23760l2.getId()).apply();
                }
            }
    ...
    public final void n1(boolean z10, boolean z11, boolean z12, boolean z13) {
        ...
        if ((p1Var == null || !p1Var.f21308f) && !this.f23756k3 && this.U0 != null) {
            if (z12 || this.y3 != z10) {
                this.y3 = z10;
                og ogVar = this.Y2;
                if (ogVar != null) {
                    ...
                    if (z11) {
                        ...
                        if (this.f23709c5 == null) {
                            ((ObjectAnimator) animatorSet2.getChildAnimations().get(0)).addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                                public final ChatActivityEnterView f32913b;
                                ...
                                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                    int i11 = r3;
                                    int i12 = i10;
                                    ChatActivityEnterView chatActivityEnterView = this.f32913b;
                                    switch (i11) {
                                        case 0:
                                            int i13 = ChatActivityEnterView.f23689m5;
    ...
    public final void o(TLRPC.Document document) {
        U();
        eg egVar = this.U0;
        int i10 = egVar.f27960c1;
        MediaDataController.getInstance(i10).addRecentSticker(0, null, document, (int) (System.currentTimeMillis() / 1000), false);
        boolean isEmpty = egVar.f27983j1.isEmpty();
        egVar.f27983j1 = MediaDataController.getInstance(i10).getRecentStickers(0, true);
        bz bzVar = egVar.f28031y0;
        if (bzVar != null) {
            bzVar.l();
        }
        if (isEmpty) {
    ...
    public final void o0(boolean z10) {
        ...
        if (animatorSet2 == null || !animatorSet2.isRunning()) {
            ...
            je jeVar = this.f23708c4;
            je jeVar2 = this.Y3;
            je jeVar3 = this.f23694a4;
            ...
            if (z10) {
                ...
                arrayList.add(ObjectAnimator.ofFloat(this.f23731g1, property3, 0.0f));
                arrayList.add(ObjectAnimator.ofFloat(this.f23731g1, property2, 0.0f));
                arrayList.add(ObjectAnimator.ofFloat(this.f23731g1, property, 0.0f));
                arrayList.add(ObjectAnimator.ofFloat(this.f23718e1, property3, 0.0f));
                if (kVar != null) {
                    ViewPropertyAnimator viewPropertyAnimator = this.f23779p1;
                    if (viewPropertyAnimator != null) {
                        viewPropertyAnimator.cancel();
                ...
                this.f23802t2.playTogether(arrayList);
                fi.c0 c0Var = this.f23759l0;
                if (c0Var != null) {
                    c0Var.setAlpha(0.0f);
                    this.f23759l0.setScaleY(0.0f);
                    this.f23759l0.setScaleX(0.0f);
                    this.f23802t2.playTogether(ObjectAnimator.ofFloat(this.f23759l0, property3, 1.0f), ObjectAnimator.ofFloat(this.f23759l0, property2, 1.0f), ObjectAnimator.ofFloat(this.f23759l0, property, 1.0f));
                }
                this.f23802t2.setDuration(150L);
                this.f23802t2.addListener(new ze(this, 1));
            } else {
                aj0 aj0Var = this.f23731g1;
                if (aj0Var != null) {
                    aj0Var.d();
                ...
                boolean z11 = this.f23705c1;
                Property property4 = View.TRANSLATION_X;
                if (z11) {
                    arrayList2.add(ObjectAnimator.ofFloat(this.f23725f1, property3, 0.0f));
                    arrayList2.add(ObjectAnimator.ofFloat(this.f23725f1, property4, -AndroidUtilities.dp(20.0f)));
                    ...
                    qf qfVar = this.E0;
                    if (qfVar != null && this.f23794s == 1.0f) {
                        qfVar.setAlpha(1.0f);
                        this.G = 0.0f;
                        J1();
                    } else {
                    ...
                    arrayList2.add(ObjectAnimator.ofFloat(this.f23737h1, property3, 0.0f));
                    arrayList2.add(ObjectAnimator.ofFloat(this.f23737h1, property4, -AndroidUtilities.dp(20.0f)));
                    sg sgVar3 = this.N1;
                    if (sgVar3 != null) {
                ...
                ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(this.f23731g1, property3, 0.0f);
                ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(this.f23731g1, property2, 0.0f);
                ObjectAnimator ofFloat5 = ObjectAnimator.ofFloat(this.f23731g1, property, 0.0f);
                ObjectAnimator ofFloat6 = ObjectAnimator.ofFloat(this.f23731g1, property3, 0.0f);
                if (this.A0) {
                    f7 = 0.5f;
                } else {
                    f7 = 1.0f;
                ...
                if (c0Var2 != null) {
                    ...
                    this.f23759l0.setScaleY(0.0f);
                    this.f23759l0.setScaleX(0.0f);
                    animatorSet5.playTogether(ObjectAnimator.ofFloat(this.f23759l0, property3, 1.0f), ObjectAnimator.ofFloat(this.f23759l0, property2, 1.0f), ObjectAnimator.ofFloat(this.f23759l0, property, 1.0f));
                }
                animatorSet5.setDuration(150L);
                animatorSet5.setStartDelay(600L);
                AnimatorSet animatorSet6 = new AnimatorSet();
                this.f23802t2 = animatorSet6;
                if (animatorSet != null) {
                    animatorSet6.playTogether(animatorSet3, animatorSet, animatorSet5);
                } else {
                    animatorSet6.playTogether(animatorSet3, animatorSet5);
                }
                this.f23802t2.addListener(new tf(this));
            }
            AnimatorSet animatorSet7 = this.f23802t2;
    ...
    public final void o1(boolean z10, boolean z11) {
        ...
        if (this.f23809u4 != z10 || !z11) {
            ...
            if (imageView == null) {
                if (z10 || this.f23758k5) {
                    if (imageView == null) {
                        ...
                        this.f23811v1 = imageView2;
                        imageView2.setScaleType(ImageView.ScaleType.CENTER);
                        this.f23811v1.setColorFilter(new PorterDuffColorFilter(i0(org.telegram.ui.ActionBar.j6.Wk), PorterDuff.Mode.MULTIPLY));
                        this.f23811v1.setImageResource(R.drawable.input_suggest_paid_24);
                        this.f23811v1.setBackground(org.telegram.ui.ActionBar.j6.f0(i0(org.telegram.ui.ActionBar.j6.f20781i6), 1, -1));
                        if (this.f23758k5) {
                            this.f23811v1.setTranslationX(AndroidUtilities.dp(42.0f));
                            this.f23829y1.addView(this.f23811v1, w7.x5.d(44, 44.0f, 85, 0.0f, 0.0f, 50.0f, 0.0f));
                        } else {
                            this.f23774o1.addView(this.f23811v1, 0, w7.x5.n(44, 44));
                        }
                        this.f23811v1.setOnClickListener(new ud(this, 19));
                        this.f23811v1.setContentDescription(LocaleController.getString(R.string.AccDescrAttachButton));
                    }
                } else {
                    return;
                }
            }
            if (this.f23809u4 != z10) {
                z12 = true;
            } else {
                z12 = false;
            }
            ...
            this.f23811v1.setEnabled(z10);
            this.f23811v1.setClickable(z10);
            ValueAnimator valueAnimator = this.f23814v4;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                this.f23814v4 = null;
            }
            if (z11) {
                if (this.f23758k5) {
                    this.f23811v1.setVisibility(0);
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f23811v1.getAlpha(), f10);
                this.f23814v4 = ofFloat;
                ofFloat.addUpdateListener(new qd(this, 7));
                this.f23814v4.addListener(new df(this, z10, 0));
                this.f23814v4.setDuration(220L);
                this.f23814v4.setInterpolator(pr.h);
                this.f23814v4.start();
            } else {
                this.f23811v1.setScaleX(f7);
                this.f23811v1.setScaleY(f7);
                this.f23811v1.setAlpha(f10);
                if (this.f23758k5) {
                    ImageView imageView3 = this.f23811v1;
                    if (!z10) {
                        i10 = 8;
                    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (this.U4 != -1 && (ofVar = this.m0) != null) {
            s4.c0 c0Var = (s4.c0) ofVar.f10128c.getLayoutManager();
            if (c0Var != null) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (c0Var != null && c0Var.getTag() != null) {
            ...
            xo0 xo0Var = this.f23778p0;
            if (xo0Var != null && xo0Var.getVisibility() == 0) {
                int i12 = this.f23778p0.getLayoutParams().width;
                this.f23778p0.measure(View.MeasureSpec.makeMeasureSpec(i12, 1073741824), View.MeasureSpec.makeMeasureSpec(this.f23778p0.getLayoutParams().height, 1073741824));
        ...
        C1();
        super.onMeasure(i10, i11);
        fi.f4 f4Var = this.f23753k0;
        if (f4Var != null) {
            fi.c0 c0Var6 = this.f23759l0;
            if (c0Var6 != null) {
                f4Var.setMeasuredButtonWidth(c0Var6.getMeasuredWidth());
            }
            this.f23753k0.getLayoutParams().height = getMeasuredHeight() - AndroidUtilities.dp(2.0f);
            measureChild(this.f23753k0, i10, i11);
        }
        M();
        N();
        if (measuredHeight > 0 && keVar.getMeasuredHeight() != measuredHeight) {
            for (int i13 = 0; i13 < 2; i13++) {
                if (i13 == 0) {
                    imageView = this.f23796s1;
                } else {
                    imageView = this.f23801t1;
                }
    ...
    public final ValueAnimator p(float f7) {
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.I1.f24379a, f7);
    ...
    public final void p0() {
        ...
        if (gk0Var != null) {
            ...
            this.f23737h1.setTranslationX(0.0f);
        }
        v71 v71Var2 = this.f23725f1;
        if (v71Var2 != null) {
            v71Var2.setAlpha(1.0f);
            this.f23725f1.setTranslationX(0.0f);
        }
        qf qfVar = this.E0;
        if (qfVar != null) {
            qfVar.setAlpha(1.0f);
    ...
    public final void p1(boolean z10) {
        ...
        if (this.J4 != z11) {
            ...
            this.J4 = z11;
            ImageView imageView = this.f23796s1;
            imageView.setVisibility(0);
            ...
            if (z11) {
                ...
                if (MessagesController.getGlobalMainSettings().getInt("aihintshown", 0) < 3) {
                    ...
                    di.f4 f4Var3 = this.M;
                    f4Var3.f7238l0 = new uc(2, this, f4Var2);
                    f4Var3.d = 4000L;
                    f4Var3.u();
    ...
    public final void q1() {
        org.telegram.ui.co coVar = this.O2;
        if (coVar != null && ChatObject.isChannelAndNotMegaGroup(coVar.f35265e)) {
    ...
    public void setBotWebViewButtonOffsetX(float f7) {
        ...
        this.f23784q1.setTranslationX(this.f23827y + this.f23821x + f7);
        this.f23698b1.setTranslationX(f7);
        cf cfVar = this.f23817w1;
        if (cfVar != null) {
    ...
    public void setChatInfo(TLRPC.ChatFull chatFull) {
        ...
        wg wgVar = this.F0;
        if (wgVar != null) {
            wgVar.f32293e = ChatObject.isPossibleRemoveChatRestrictionsByBoosts(chatFull);
            wgVar.invalidate();
        }
    ...
    public void setEditingBusinessLink(TL_account.TL_businessChatLink tL_businessChatLink) {
        ...
        if (this.a2 != null) {
            ...
            this.E1.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setDuration(150L).setInterpolator(pr.f29494f).start();
            this.f23704c0 = this.R.getMessagesController().getMaxMessageLength();
            qf qfVar = this.E0;
            if (qfVar != null) {
    ...
    public void setFieldFocused(boolean z10) {
        ...
        if (this.E0 != null && !accessibilityManager.isTouchExplorationEnabled()) {
            ...
            if (qfVar != null && qfVar.isFocused()) {
                if (!this.f23830y2 || this.f23744i2) {
                    this.E0.clearFocus();
                }
            }
        }
    ...
    public void setSlideToCancelProgress(float f7) {
        ...
        this.f23799s4 = (int) ((1.0f - this.f23746i4) * (-measuredWidth));
        RecordCircle recordCircle = this.M1;
        if (recordCircle != null) {
            recordCircle.invalidate();
        }
    ...
    public final void t1(int i10, int i11, boolean z10, boolean z11) {
        ...
        if (i10 != 2) {
            ...
            if (i10 == 1) {
                ...
                if (i11 == 0) {
                    ...
                    if (egVar2 != null && egVar2.getVisibility() != 8) {
                        this.f23763m1.removeView(this.U0);
                        this.U0.setVisibility(8);
                        this.U0.setShowing(false);
                        this.W0 = false;
                ...
                if (this.f23818w2 <= 0) {
                    f7 = 200.0f;
                    this.f23818w2 = MessagesController.getGlobalEmojiSettings().getInt("kbd_height", AndroidUtilities.dp(200.0f));
                } else {
                    f7 = 200.0f;
                }
                if (this.f23824x2 <= 0) {
                    this.f23824x2 = MessagesController.getGlobalEmojiSettings().getInt("kbd_height_land3", AndroidUtilities.dp(f7));
                }
                Point point = AndroidUtilities.displaySize;
                if (point.x > point.y) {
                    i15 = this.f23824x2;
                ...
                if (viewGroup != null && this.f23709c5 == null) {
                ...
                if (ov0Var != null) {
                    ...
                    B1(true);
                    G0();
                    if (this.f23738h2 && !this.f23830y2 && i15 != i13 && z10) {
                ...
                if (egVar3 != null) {
                    if (i10 == 2 && !AndroidUtilities.usingHardwareInput && !AndroidUtilities.isInMultiwindow) {
                        ...
                        this.f23763m1.removeView(this.U0);
                        this.U0 = null;
                    } else if (this.f23738h2 && !this.f23830y2 && !this.y3) {
                        this.W0 = true;
                        this.f23771n3 = 0;
                ...
                if (bgVar4 != null && bgVar4.getVisibility() == 0) {
                    if (i10 != 2 || AndroidUtilities.usingHardwareInput || AndroidUtilities.isInMultiwindow) {
                        if (this.f23738h2 && !this.f23830y2) {
                            if (this.X0) {
                                this.f23771n3 = 1;
                            }
                            AnimatorSet animatorSet3 = new AnimatorSet();
                ...
                if (i11 == 1 && this.f23760l2 != null) {
                    MessagesController.getMainSettings(this.Q).edit().putInt("closed_botkeyboard_" + getTopicKeyString(), this.f23760l2.getId()).apply();
                }
                B1(true);
                qh.f fVar2 = this.f23709c5;
                if (fVar2 != null) {
            ...
            if (this.f23819w3 || this.f23825x3) {
                K(true);
            }
            if (this.y3 && i10 != 1) {
                z12 = false;
    ...
    public final void u() {
        if (this.U0.getParent() == null) {
            if (this.f23709c5 == null) {
                this.f23763m1.addView(this.U0);
            } else {
                this.f23763m1.addView(this.U0, w7.x5.c(-1.0f, -1));
            }
        }
    }
    ...
    public final boolean v0() {
        if (this.E2 && ChatActivityEnterView.this.f23793r4) {
            return true;
        }
        return false;
    }
    ...
    public final void v1(boolean z10) {
        ...
        this.K4 = z11;
        ImageView imageView = this.f23801t1;
        imageView.setVisibility(0);
        ViewPropertyAnimator animate = imageView.animate();
        float f11 = 1.0f;
        if (z11) {
    ...
    public final boolean w() {
        kg x10 = x();
        if (!TextUtils.equals(x10.f27849a, this.f23699b2.f27849a) || !MediaDataController.entitiesEqual(this.f23699b2.f27850b, x10.f27850b)) {
            return true;
        }
        return false;
    }
    ...
    public final boolean w0() {
        if (!this.E2) {
            AnimatorSet animatorSet = this.f23797s2;
            if (animatorSet == null || !animatorSet.isRunning() || this.f23750j2) {
                return false;
            }
            return true;
        }
    ...
    public final kg x() {
        ...
        ?? obj = new Object();
        obj.f27849a = charSequence.toString();
        obj.f27850b = entities;
        return obj;
    }

    public final void x1(boolean z10, boolean z11) {
        boolean z12;
        if (this.F1 != null && !this.f23720e3 && getVisibility() == 0) {
            ke keVar = this.f23718e1;
            if ((keVar == null || keVar.getVisibility() != 0) && !this.G2 && this.U2 == null && (this.f23764m2 == null || this.Y1 != null)) {
                z12 = true;
            } else {
                z12 = false;
            }
            if (!z11 && z10 && z12 && !this.f23830y2 && !t0()) {
                H0();
                sd sdVar = this.V;
                if (sdVar != null) {
                    AndroidUtilities.cancelRunOnUIThread(sdVar);
    ...
    public final void z1() {
        ...
        float f10 = this.f23827y + this.f23821x;
        ye yeVar = this.J0;
        if (yeVar != null) {
