...
public class ChatActivityEnterView extends BlurredFrameLayout implements NotificationCenter.NotificationCenterDelegate, SizeNotifierFrameLayout.SizeNotifierFrameLayoutDelegate, StickersAlert.StickersAlertDelegate {
    ...
    public static boolean lambda$createRecordPanel$38(View view, MotionEvent motionEvent) {
        return true;
    }
    ...
    public class RecordCircle extends View {
        ...
        public RecordCircle(Context context) {
            ...
            this.tooltipBackground = Theme.createRoundRectDrawable(AndroidUtilities.dp(5.0f), r5.getThemedColor("chat_gifSaveHintBackground"));
    ...
    public ChatActivityEnterView(final Activity activity, SizeNotifierFrameLayout sizeNotifierFrameLayout, final ChatActivity chatActivity, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.topViewUpdateListener = new ValueAnimator.AnimatorUpdateListener() {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ChatActivityEnterView.this.lambda$new$30(valueAnimator);
            }
        };
                    ...
                    if (!ChatActivityEnterView.this.hasRecordVideo || ChatActivityEnterView.this.calledRecordRunnable) {
                        ...
                        if (!ChatActivityEnterView.this.hasRecordVideo || !ChatActivityEnterView.this.isInVideoMode()) {
                            if (ChatActivityEnterView.this.recordingAudioVideo && ChatActivityEnterView.this.isInScheduleMode()) {
                                AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.parentFragment.getDialogId(), ChatActivityEnterView$14$$ExternalSyntheticLambda5.INSTANCE, ChatActivityEnterView$14$$ExternalSyntheticLambda2.INSTANCE, this.val$resourcesProvider);
                            }
                        ...
                        if ((((motionEvent.getX() + ChatActivityEnterView.this.audioVideoButtonContainer.getX()) - ChatActivityEnterView.this.startedDraggingX) / ChatActivityEnterView.this.distCanMove) + 1.0f < 0.45d) {
                            ...
                            if (!ChatActivityEnterView.this.hasRecordVideo || !ChatActivityEnterView.this.isInVideoMode()) {
                                if (!ChatActivityEnterView.this.sendVoiceEnabled) {
                                    ...
                                    if (ChatActivityEnterView.this.recordingAudioVideo && ChatActivityEnterView.this.isInScheduleMode()) {
                                        AlertsCreator.createScheduleDatePickerDialog(ChatActivityEnterView.this.parentActivity, ChatActivityEnterView.this.parentFragment.getDialogId(), ChatActivityEnterView$14$$ExternalSyntheticLambda4.INSTANCE, ChatActivityEnterView$14$$ExternalSyntheticLambda3.INSTANCE, this.val$resourcesProvider);
                                    }
                                    ChatActivityEnterView.this.delegate.needStartRecordAudio(0);
                                    MediaController.getInstance().stopRecording(ChatActivityEnterView.this.isInScheduleMode() ? 3 : 1, true, 0);
                                }
    ...
    public class AnonymousClass21 implements ViewTreeObserver.OnDrawListener {
    ...
    public void openWebViewMenu() {
        ...
        if (SharedPrefsHelper.isWebViewConfirmShown(this.currentAccount, this.dialog_id)) {
            ...
            new AlertDialog.Builder(this.parentFragment.getParentActivity()).setTitle(LocaleController.getString(R.string.BotOpenPageTitle)).setMessage(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.BotOpenPageMessage, UserObject.getUserName(MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(this.dialog_id)))))).setPositiveButton(LocaleController.getString(R.string.OK), new DialogInterface.OnClickListener() {
                @Override
                public final void onClick(DialogInterface dialogInterface, int i) {
                    ChatActivityEnterView.this.lambda$openWebViewMenu$23(runnable, dialogInterface, i);
                }
                ...
                public final void onDismiss(DialogInterface dialogInterface) {
                    ChatActivityEnterView.this.lambda$openWebViewMenu$24(dialogInterface);
                }
            }).show();
        }
    }
    ...
    public void lambda$openWebViewMenu$23(Runnable runnable, DialogInterface dialogInterface, int i) {
        runnable.run();
        SharedPrefsHelper.setWebViewConfirmShown(this.currentAccount, this.dialog_id, true);
    }

    public void lambda$openWebViewMenu$24(DialogInterface dialogInterface) {
    ...
    public void lambda$onSendLongClick$26(View view) {
        ...
        AlertsCreator.createScheduleDatePickerDialog(this.parentActivity, this.parentFragment.getDialogId(), new ChatActivityEnterView$$ExternalSyntheticLambda51(this), this.resourcesProvider);
    }
    ...
    public class AnonymousClass28 implements RecyclerListView.OnItemClickListener {
        AnonymousClass28() {
            ChatActivityEnterView.this = r1;
        }
    ...
    private void createBotWebViewMenuContainer() {
        ...
        this.botWebViewMenuContainer.setOnDismissGlobalListener(new Runnable() {
            @Override
            public final void run() {
                ChatActivityEnterView.this.lambda$createBotWebViewMenuContainer$28();
            }
        });
    }

    public void lambda$createBotWebViewMenuContainer$28() {
    ...
    private void createMessageEditText() {
        ...
        this.messageEditText.setDelegate(new EditTextCaption.EditTextCaptionDelegate() {
            ...
            public final void onSpansChanged() {
                ChatActivityEnterView.this.lambda$createMessageEditText$29();
            }
        });
    ...
    public void lambda$createMessageEditText$29() {
    ...
    public void lambda$new$30(ValueAnimator valueAnimator) {
    ...
    private void showTopView(boolean z, boolean z2, boolean z3) {
        ...
        if (!z3 && z && z4 && !this.keyboardVisible && !isPopupShowing()) {
            ...
            Runnable runnable2 = new Runnable() {
                @Override
                public final void run() {
                    ChatActivityEnterView.this.lambda$showTopView$31();
                }
            };
    ...
    public void lambda$showTopView$31() {
    ...
    public void onPause() {
        ...
        Runnable runnable = new Runnable() {
            @Override
            public final void run() {
                ChatActivityEnterView.this.lambda$onPause$32();
            }
        };
    ...
    private void hideRecordedAudioPanel(boolean z) {
        ...
        if (animatorSet2 == null || !animatorSet2.isRunning()) {
            ...
            if (z) {
                ...
                animatorArr[4] = ObjectAnimator.ofFloat(this.recordDeleteImageView, View.SCALE_X, 0.0f);
                animatorArr[5] = ObjectAnimator.ofFloat(this.recordDeleteImageView, View.SCALE_Y, 0.0f);
                animatorArr[6] = ObjectAnimator.ofFloat(this.recordedAudioPanel, View.ALPHA, 0.0f);
                ...
                animatorArr[11] = ObjectAnimator.ofFloat(this.messageEditText, View.TRANSLATION_X, 0.0f);
            ...
            if (processSendingText(text, z, i)) {
                if (this.delegate.hasForwardingMessages() || ((i != 0 && !isInScheduleMode()) || isInScheduleMode())) {
                    ...
                    Runnable runnable = new Runnable() {
                        @Override
                        public final void run() {
                            ChatActivityEnterView.this.lambda$sendMessageInternal$33(text, z, i);
                        }
                    };
    ...
    public void lambda$sendMessageInternal$33(CharSequence charSequence, boolean z, int i) {
    ...
    public static void lambda$checkPremiumAnimatedEmoji$34(BaseFragment baseFragment) {
    ...
    public void showCaptionLimitBulletin() {
        ...
        BulletinFactory.of(this.parentFragment).createCaptionLimitBulletin(MessagesController.getInstance(this.currentAccount).captionLengthLimitPremium, new Runnable() {
            @Override
            public final void run() {
                ChatActivityEnterView.this.lambda$showCaptionLimitBulletin$35();
            }
        }).show();
    }

    public void lambda$showCaptionLimitBulletin$35() {
        ChatActivity chatActivity = this.parentFragment;
        if (chatActivity != null) {
        ...
        if (this.searchingType != 0) {
            ...
            if (this.stickersExpanded) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        ChatActivityEnterView.this.lambda$doneEditingMessage$36();
                    }
                }, 200L);
            }
        }
    ...
    public void lambda$doneEditingMessage$36() {
        this.waitingForKeyboardOpenAfterAnimation = false;
        openKeyboardInternal();
    }
    ...
    public void lambda$updateRecordInterface$37(ValueAnimator valueAnimator) {
        float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        if (!isInVideoMode()) {
    ...
    public void lambda$setEditingMessageObject$39(CharSequence charSequence) {
        ...
        if (z) {
            ...
            if (botWebViewMenuContainer == null || botWebViewMenuContainer.getVisibility() == 8) {
                Runnable runnable = new Runnable() {
                    @Override
                    public final void run() {
                        ChatActivityEnterView.this.lambda$setFieldFocused$40();
                    }
                };
    ...
    public void lambda$setFieldFocused$40() {
        EditTextCaption editTextCaption;
            ...
            if (this.parentFragment.getOtherSameChatsDiff() == 0 && this.parentFragment.fragmentOpened && z) {
                ...
                duration.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        ChatActivityEnterView.this.lambda$updateSendAsButton$41(f5, f6, f7, f8, valueAnimator2);
                    }
                });
                final boolean z4 = z3;
                final float f9 = f3;
    ...
    public void lambda$updateSendAsButton$41(float f, float f2, float f3, float f4, ValueAnimator valueAnimator) {
        float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
    ...
    public void lambda$setButtons$42(TLRPC$KeyboardButton tLRPC$KeyboardButton) {
        ChatActivity chatActivity;
        ...
        if (tLRPC$KeyboardButton instanceof TLRPC$TL_keyboardButton) {
            ...
            if (tLRPC$KeyboardButton instanceof TLRPC$TL_keyboardButtonRequestPoll) {
                ...
                if (SharedPrefsHelper.isWebViewConfirmShown(this.currentAccount, j2)) {
                    ...
                    new AlertDialog.Builder(this.parentFragment.getParentActivity()).setTitle(LocaleController.getString(R.string.BotOpenPageTitle)).setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("BotOpenPageMessage", R.string.BotOpenPageMessage, UserObject.getUserName(user)))).setPositiveButton(LocaleController.getString(R.string.OK), new DialogInterface.OnClickListener() {
                        @Override
                        public final void onClick(DialogInterface dialogInterface, int i) {
                            ChatActivityEnterView.this.lambda$didPressedBotButton$43(runnable, j2, dialogInterface, i);
                        }
                ...
                builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new DialogInterface.OnClickListener() {
                    @Override
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        ChatActivityEnterView.this.lambda$didPressedBotButton$44(messageObject2, tLRPC$KeyboardButton, dialogInterface, i);
                    }
                });
                ...
                if (tLRPC$KeyboardButton.same_peer) {
                    ...
                    dialogsActivity.setDelegate(new DialogsActivity.DialogsActivityDelegate() {
                        ...
                        public final boolean didSelectDialogs(DialogsActivity dialogsActivity2, ArrayList arrayList, CharSequence charSequence, boolean z, TopicsFragment topicsFragment) {
                            ...
                            lambda$didPressedBotButton$45 = ChatActivityEnterView.this.lambda$didPressedBotButton$45(messageObject2, tLRPC$KeyboardButton, dialogsActivity2, arrayList, charSequence, z, topicsFragment);
    ...
    public void lambda$didPressedBotButton$43(Runnable runnable, long j, DialogInterface dialogInterface, int i) {
        runnable.run();
        SharedPrefsHelper.setWebViewConfirmShown(this.currentAccount, j, true);
    }

    public void lambda$didPressedBotButton$44(MessageObject messageObject, TLRPC$KeyboardButton tLRPC$KeyboardButton, DialogInterface dialogInterface, int i) {
    ...
    public boolean lambda$didPressedBotButton$45(MessageObject messageObject, TLRPC$KeyboardButton tLRPC$KeyboardButton, DialogsActivity dialogsActivity, ArrayList arrayList, CharSequence charSequence, boolean z, TopicsFragment topicsFragment) {
    ...
    public class AnonymousClass58 implements EmojiView.EmojiViewDelegate {
        ...
        public void onStickerSelected(View view, TLRPC$Document tLRPC$Document, String str, Object obj, MessageObject.SendAnimationData sendAnimationData, boolean z, int i) {
            ...
            if (ChatActivityEnterView.this.slowModeTimer <= 0 || isInScheduleMode()) {
                ...
                ChatActivityEnterView.this.lambda$onStickerSelected$46(tLRPC$Document, str, obj, sendAnimationData, false, z, i);
    ...
    @Override
    public void lambda$onStickerSelected$46(final TLRPC$Document tLRPC$Document, final String str, final Object obj, final MessageObject.SendAnimationData sendAnimationData, final boolean z, boolean z2, int i) {
        if (isInScheduleMode() && i == 0) {
            AlertsCreator.createScheduleDatePickerDialog(this.parentActivity, this.parentFragment.getDialogId(), new AlertsCreator.ScheduleDatePickerDelegate() {
                ...
                public final void didSelectDate(boolean z3, int i2) {
                    ChatActivityEnterView.this.lambda$onStickerSelected$46(tLRPC$Document, str, obj, sendAnimationData, z, z3, i2);
                }
    ...
    public void lambda$setSearchingTypeInternal$47(ValueAnimator valueAnimator) {
    ...
    public void lambda$checkStickresExpandHeight$48(ValueAnimator valueAnimator) {
        this.sizeNotifierLayout.invalidate();
    }

    public void lambda$checkStickresExpandHeight$49(ValueAnimator valueAnimator) {
        this.sizeNotifierLayout.invalidate();
    }
            ...
            if (this.stickersExpanded) {
                ...
                if (z2) {
                    ...
                    ((ObjectAnimator) animatorSet.getChildAnimations().get(0)).addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                        @Override
                        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                            ChatActivityEnterView.this.lambda$setStickersExpanded$50(i, valueAnimator);
                        }
                    });
                    animatorSet.addListener(new AnimatorListenerAdapter() {
                        {
                ...
                if (z2) {
                    ...
                    ((ObjectAnimator) animatorSet2.getChildAnimations().get(0)).addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                        @Override
                        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                            ChatActivityEnterView.this.lambda$setStickersExpanded$51(i, valueAnimator);
                        }
                    });
                    animatorSet2.addListener(new AnimatorListenerAdapter() {
                        {
    ...
    public void lambda$setStickersExpanded$50(int i, ValueAnimator valueAnimator) {
        this.stickersExpansionProgress = Math.abs(getTranslationY() / (-(this.stickersExpandedHeight - i)));
        this.sizeNotifierLayout.invalidate();
    }

    public void lambda$setStickersExpanded$51(int i, ValueAnimator valueAnimator) {
