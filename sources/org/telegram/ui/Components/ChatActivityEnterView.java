...
public class ChatActivityEnterView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, pv0, tx0, my0, le.d, org.telegram.ui.ActionBar.a6 {
    public static final int f21743n5 = 0;
    public boolean A0;
    ...
    public boolean f21746a1;
    public TL_account.TL_businessChatLink a2;
    public TLRPC.TL_document f21747a3;
    public final he f21748a4;
    public final Matrix f21749a5;
    public boolean f21750b;
    public NumberTextView f21751b0;
    public final te f21752b1;
    public ig f21753b2;
    public String f21754b3;
    public final he f21755b4;
    public final c6 f21756b5;
    public org.telegram.ui.ActionBar.g1 f21757c;
    public int f21758c0;
    public boolean f21759c1;
    public TLRPC.ChatFull f21760c2;
    public MessageObject f21761c3;
    public final he f21762c4;
    public final c6 f21763c5;
    public LinearLayout d;
    public int f21764d0;
    public ai.x5 f21765d1;
    public boolean f21766d2;
    public VideoEditedInfo f21767d3;
    public boolean f21768d4;
    public ph.f f21769d5;
    public CharSequence e;
    public nr f21770e0;
    public ie f21771e1;
    public int f21772e2;
    public boolean f21773e3;
    public long f21774e4;
    public jh.h f21775e5;
    public String f21776f;
    public Runnable f21777f0;
    public w71 f21778f1;
    public boolean f21779f2;
    public boolean f21780f3;
    public float f21781f4;
    public final le.e f21782f5;
    public boolean f21783g0;
    public bj0 f21784g1;
    public boolean f21785g2;
    public boolean f21786g3;
    public float f21787g4;
    public final le.b f21788g5;
    public float h;
    public boolean f21789h0;
    public hk0 f21790h1;
    public boolean f21791h2;
    public MessageObject f21792h3;
    public float f21793h4;
    public final le.b f21794h5;
    public String f21795i0;
    public long f21796i1;
    public boolean f21797i2;
    public TL_keyboard.KeyboardButtonProto f21798i3;
    public float f21799i4;
    public final le.b f21800i5;
    public String f21801j0;
    public SlideTextView f21802j1;
    public boolean f21803j2;
    public boolean j3;
    public float f21804j4;
    public float f21805j5;
    public ei.f4 f21806k0;
    public sg f21807k1;
    public boolean f21808k2;
    public boolean f21809k3;
    public float f21810k4;
    public float f21811k5;
    public ei.c0 f21812l0;
    public final qv0 l1;
    public MessageObject f21813l2;
    public boolean f21814l3;
    public float l4;
    public boolean f21815l5;
    public lf m0;
    public ViewGroup f21816m1;
    public TLRPC.TL_replyKeyboardMarkup f21817m2;
    public boolean f21818m3;
    public float f21819m4;
    public int f21820m5;
    public float f21821n;
    public ei.b0 f21822n0;
    public int f21823n1;
    public int f21824n2;
    public int f21825n3;
    public float f21826n4;
    public boolean f21827o0;
    public final org.telegram.ui.zd f21828o1;
    public boolean f21829o2;
    public boolean f21830o3;
    public float f21831o4;
    public xo0 f21832p0;
    public ViewPropertyAnimator f21833p1;
    public PowerManager.WakeLock f21834p2;
    public boolean f21835p3;
    public float f21836p4;
    public cf f21837q0;
    public final hg.k f21838q1;
    public AnimatorSet f21839q2;
    public final ye f21840q3;
    public boolean f21841q4;
    public float f21842r;
    public ge f21843r0;
    public final i0 f21844r1;
    public AnimatorSet f21845r2;
    public final ff f21846r3;
    public boolean f21847r4;
    public float f21848s;
    public int f21849s0;
    public final ImageView f21850s1;
    public AnimatorSet f21851s2;
    public final org.telegram.ui.Cells.c1 f21852s3;
    public int f21853s4;
    public int f21854t0;
    public final ImageView f21855t1;
    public AnimatorSet f21856t2;
    public final sf f21857t3;
    public NotificationCenter.ObserversGroup f21858t4;
    public ge f21859u0;
    public float f21860u1;
    public int f21861u2;
    public final vf f21862u3;
    public long f21863u4;
    public boolean v;
    public ValueAnimator f21864v0;
    public ImageView f21865v1;
    public int f21866v2;
    public final Paint f21867v3;
    public boolean f21868v4;
    public Runnable f21869w;
    public float f21870w0;
    public ze f21871w1;
    public int f21872w2;
    public boolean f21873w3;
    public ValueAnimator f21874w4;
    public float f21875x;
    public boolean f21876x0;
    public final ke f21877x1;
    public int f21878x2;
    public boolean f21879x3;
    public boolean f21880x4;
    public float f21881y;
    public boolean f21882y0;
    public final ie f21883y1;
    public boolean f21884y2;
    public boolean y3;
    public boolean f21885y4;
    public boolean f21886z0;
    public final ie f21887z1;
    public int f21888z2;
    public boolean f21889z3;
    public boolean f21890z4;
    ...
    public class RecordCircle extends View {
        ...
        public final z9 h;
        public final z9 f21895n;
        public final float f21896r;
        public final float f21897s;
        public final RectF v;
        public boolean f21898w;
        public final rg f21899x;
        public int f21900y;
        ...
        public RecordCircle(Context context) {
            ...
            this.f21895n = z9Var2;
            this.f21896r = AndroidUtilities.dpf2(41.0f);
            this.f21897s = AndroidUtilities.dp(30.0f);
            this.v = new RectF();
            this.H = 0.0f;
            this.I = true;
        ...
        public final void a() {
            ...
            int i10 = org.telegram.ui.ActionBar.j6.f18834bf;
        ...
        public final void b(Canvas canvas, Drawable drawable, Drawable drawable2, float f7, int i10) {
            ...
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            boolean z10 = chatActivityEnterView.f21841q4;
            if (z10 && chatActivityEnterView.f21799i4 == 1.0f) {
                chatActivityEnterView.f21752b1.setAlpha(1.0f);
                setVisibility(8);
            } else if (z10 && chatActivityEnterView.f21799i4 < 1.0f) {
        ...
        public final void c(boolean z10) {
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            if (!z10) {
                chatActivityEnterView.f21847r4 = false;
                chatActivityEnterView.f21810k4 = -1.0f;
                chatActivityEnterView.f21804j4 = -1.0f;
                chatActivityEnterView.f21799i4 = 1.0f;
                chatActivityEnterView.f21836p4 = 1.0f;
                chatActivityEnterView.f21819m4 = 0.0f;
                chatActivityEnterView.f21793h4 = 0.0f;
            }
            invalidate();
            chatActivityEnterView.f21831o4 = 0.0f;
            chatActivityEnterView.y0();
            chatActivityEnterView.l4 = 0.0f;
            chatActivityEnterView.f21787g4 = 0.0f;
            chatActivityEnterView.f21781f4 = 0.0f;
            chatActivityEnterView.f21768d4 = false;
            this.f21894f = 0.0f;
            chatActivityEnterView.f21841q4 = false;
        ...
        public final boolean dispatchHoverEvent(MotionEvent motionEvent) {
            if (!super.dispatchHoverEvent(motionEvent) && !this.f21899x.f(motionEvent)) {
                return false;
            }
            return true;
        }
        ...
        public final void e() {
            ...
            int i10 = org.telegram.ui.ActionBar.j6.f18853cf;
            paint.setColor(chatActivityEnterView.j0(i10));
            this.h.d.setColor(i0.a.k(chatActivityEnterView.j0(i10), 38));
            this.f21895n.d.setColor(i0.a.k(chatActivityEnterView.j0(i10), 76));
            this.f21900y = chatActivityEnterView.L3.getAlpha();
        }

        public float getControlsScale() {
            return ChatActivityEnterView.this.f21793h4;
        }

        public float getScale() {
            return ChatActivityEnterView.this.f21787g4;
        }
        ...
        public final void onMeasure(int i10, int i11) {
            ...
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            chatActivityEnterView.f21853s4 = (int) ((1.0f - chatActivityEnterView.f21799i4) * (-measuredWidth));
        }

        public void setAmplitude(double d) {
            this.f21895n.d((float) (Math.min(1800.0d, d) / 1800.0d), true);
            this.h.d((float) (Math.min(1800.0d, d) / 1800.0d), false);
            float min = (float) (Math.min(1800.0d, d) / 1800.0d);
            this.f21892b = min;
            this.f21893c = (min - this.f21891a) / 375.0f;
            invalidate();
        }

        public void setControlsScale(float f7) {
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            chatActivityEnterView.f21793h4 = f7;
            qg qgVar = chatActivityEnterView.N1;
            if (qgVar != null) {
                qgVar.invalidate();
            }
        ...
        public void setScale(float f7) {
            ChatActivityEnterView.this.f21787g4 = f7;
            invalidate();
        }

        public void setTransformToSeekbar(float f7) {
            ChatActivityEnterView.this.f21831o4 = f7;
            invalidate();
        }
    }
    ...
    public class SlideTextView extends View {
        ...
        public final TextPaint f21901a;
        public final TextPaint f21902b;
        public final Paint f21903c;
        public final String d;
        public final String e;
        public float f21904f;
        public float h;
        public float f21905n;
        public float f21906r;
        public float f21907s;
        public float v;
        public float f21908w;
        ...
        public final void a() {
            int i10 = org.telegram.ui.ActionBar.j6.f19054nf;
            int i11 = ChatActivityEnterView.f21743n5;
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            int j02 = chatActivityEnterView.j0(i10);
            TextPaint textPaint = this.f21901a;
            textPaint.setColor(j02);
            int i12 = org.telegram.ui.ActionBar.j6.f19037mf;
            int j03 = chatActivityEnterView.j0(i12);
            TextPaint textPaint2 = this.f21902b;
            textPaint2.setColor(j03);
            this.f21907s = textPaint.getAlpha();
        ...
        public final void onDraw(Canvas canvas) {
            ...
            if (this.G != null && (staticLayout = this.H) != null) {
                ...
                if (chatActivityEnterView.M1 != null) {
                    ...
                    int j02 = chatActivityEnterView.j0(org.telegram.ui.ActionBar.j6.f19054nf);
                    TextPaint textPaint = this.f21901a;
                    textPaint.setColor(j02);
                    textPaint.setAlpha((int) ((1.0f - this.f21905n) * this.f21907s * this.f21906r));
                    this.f21902b.setAlpha((int) (this.v * this.f21905n));
                    int color = textPaint.getColor();
                    Paint paint = this.f21903c;
                    paint.setColor(color);
                    boolean z10 = true;
                    boolean z11 = this.M;
                    if (z11) {
                        this.f21908w = AndroidUtilities.dp(16.0f);
                    } else {
                        long currentTimeMillis = System.currentTimeMillis() - this.f21910y;
                        this.f21910y = System.currentTimeMillis();
                        if (this.f21905n == 0.0f && this.f21906r > 0.8f) {
                            if (this.f21909x) {
                                float dp3 = ((AndroidUtilities.dp(3.0f) / 250.0f) * ((float) currentTimeMillis)) + this.f21908w;
                                this.f21908w = dp3;
                                if (dp3 > AndroidUtilities.dp(6.0f)) {
                                    this.f21908w = AndroidUtilities.dp(6.0f);
                                    this.f21909x = false;
                                }
                            } else {
                                float dp4 = this.f21908w - ((AndroidUtilities.dp(3.0f) / 250.0f) * ((float) currentTimeMillis));
                                this.f21908w = dp4;
                    ...
                    int dp5 = AndroidUtilities.dp(5.0f) + ((int) ((getMeasuredWidth() - this.f21904f) / 2.0f));
                    ...
                    float f16 = dp5;
                    float f17 = this.f21908w;
                    float f18 = this.f21905n;
                    float dp6 = (((((1.0f - f18) * f17) * this.f21906r) + f16) - (f11 * f18)) + AndroidUtilities.dp(f10);
                    if (z10) {
                        dp = 0.0f;
                    } else {
                        dp = this.f21905n * AndroidUtilities.dp(12.0f);
                    }
                    if (this.f21905n != 1.0f) {
                        f12 = 12.0f;
                        int translationX = (int) ((chatActivityEnterView.M1.getTranslationX() * 0.3f) + ((1.0f - this.f21906r) * ((-getMeasuredWidth()) / 4)));
                        canvas.save();
        ...
        public final void onMeasure(int i10, int i11) {
            ...
            if (this.L != measuredHeight) {
                ...
                String str = this.d;
                TextPaint textPaint = this.f21901a;
                this.f21904f = textPaint.measureText(str);
                String str2 = this.e;
                TextPaint textPaint2 = this.f21902b;
                ...
                this.G = new StaticLayout(this.d, textPaint, (int) this.f21904f, alignment, 1.0f, 0.0f, false);
        ...
        public final boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (this.f21905n == 0.0f || !isEnabled()) {
                return false;
            }
            ...
            if (z10) {
                ...
                if (motionEvent.getAction() == 1 && rect.contains(x10, y3)) {
                    ...
                    chatActivityEnterView.f21761c3 = null;
                    chatActivityEnterView.f21767d3 = null;
    ...
    public ChatActivityEnterView(Activity activity, qv0 qv0Var, org.telegram.ui.bo boVar, boolean z10, final org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f21825n3 = -1;
        this.f21835p3 = true;
        this.f21840q3 = new ye(this, 0);
        this.f21846r3 = new ff(this);
        this.f21852s3 = new org.telegram.ui.Cells.c1(Integer.class, "translationY", 1);
        this.f21857t3 = new Property(Float.class, "scale");
        this.f21862u3 = new Property(Float.class, "controlsScale");
        this.f21867v3 = new Paint(1);
        ...
        this.f21748a4 = new he(this, 2);
        this.f21755b4 = new he(this, 3);
        this.f21762c4 = new he(this, 4);
        this.f21880x4 = true;
        this.f21885y4 = true;
        this.B4 = new Paint();
        this.C4 = 1.0f;
        ...
        this.f21749a5 = new Matrix();
        qr qrVar = qr.h;
        this.f21756b5 = new c6(this, 0L, 280L, qrVar);
        this.f21763c5 = new c6(this, 0L, 280L, qrVar);
        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
        paint.setShader(linearGradient);
        qr qrVar2 = ji.n.V;
        this.f21782f5 = new le.e(0, this, qrVar2, 250L);
        this.f21788g5 = new le.b(1, this, qrVar2, 250L, false);
        this.f21794h5 = new le.b(2, this, qrVar, 320L, false);
        this.f21800i5 = new le.b(3, this, qrVar, 320L, false);
        this.V3 = f6Var;
        this.W3 = z10;
        ...
        this.P1 = paint2;
        paint2.setColor(j0(org.telegram.ui.ActionBar.j6.f18815af));
        setFocusable(true);
        ...
        leVar.setBackground(org.telegram.ui.ActionBar.j6.W(AndroidUtilities.dp(19.0f), j03, dp2, dp3, dp2, dp3));
        ...
        imageView.setBackground(org.telegram.ui.ActionBar.j6.W(AndroidUtilities.dp(19.0f), j04, dp4, dp5, dp4, dp5));
        imageView.setVisibility(8);
        imageView.setContentDescription(LocaleController.getString(R.string.ArticleDeleteDraft));
        imageView.setOnClickListener(new View.OnClickListener(this) {
            public final ChatActivityEnterView f23029b;
            ...
            public final void onClick(View view) {
                ...
                switch (r3) {
                    case 0:
                        ...
                        ChatActivityEnterView chatActivityEnterView = this.f23029b;
                        ...
                        return;
                    default:
                        int i18 = ChatActivityEnterView.f21743n5;
                        MessagesController.getGlobalMainSettings().edit().putInt("aihintshown", 3).apply();
                        ChatActivityEnterView chatActivityEnterView2 = this.f23029b;
                        ...
                        if (z13) {
                            if (chatActivityEnterView2.D1 != null) {
                                ...
                                e0Var.f23428k0 = new ae(chatActivityEnterView2, 0);
                                be beVar = new be(chatActivityEnterView2, j3, f6Var2, 0);
                                e0Var.f23429l0 = j3;
                                e0Var.f23431o0 = beVar;
                                e0Var.show();
                                return;
                            }
                            return;
                            ...
                            e0Var2.f23427j0 = new ae(chatActivityEnterView2, 1);
        ...
        if (z10) {
            ...
            if (i11 != 9) {
                ...
                this.f21770e0.a(this.f21779f2, false);
                if (this.f21779f2) {
                ...
                imageView2.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.f0(j0(i16), 1, -1));
                if (this.f21785g2 && ((mgVar = this.Y2) == null || !mgVar.C0())) {
                    i13 = 0;
                } else {
                    i13 = 8;
                }
            ...
            kVar.setColorFilter(new PorterDuffColorFilter(j0(i15), PorterDuff.Mode.MULTIPLY));
            kVar.setImageResource(R.drawable.msg_input_attach2);
            kVar.setBackground(org.telegram.ui.ActionBar.j6.f0(j0(i16), 1, -1));
        ...
        imageView3.setBackground(org.telegram.ui.ActionBar.j6.f0(j0(i16), 1, AndroidUtilities.dp(16.0f)));
        ...
        imageView4.setBackground(org.telegram.ui.ActionBar.j6.f0(j0(i16), 1, AndroidUtilities.dp(16.0f)));
        ...
        imageView6.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.f0(j0(i16), 1, -1));
        ...
        ve veVar = new ve(this, activity, i10, f6Var, 0);
        this.J0 = veVar;
        ...
        this.F0 = ugVar;
        org.telegram.ui.ActionBar.k5 k5Var = ugVar.f28384a;
        ...
        this.f21872w2 = globalEmojiSettings.getInt("kbd_height", AndroidUtilities.dp(200.0f));
        this.f21878x2 = globalEmojiSettings.getInt("kbd_height_land3", AndroidUtilities.dp(200.0f));
        k1(false, false);
        L(false);
        G();
        X();
    ...
    public static boolean J(int r21, long r22, org.telegram.ui.ActionBar.o2 r24, java.lang.CharSequence r25) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.ChatActivityEnterView.J(int, long, org.telegram.ui.ActionBar.o2, java.lang.CharSequence):boolean");
    }
    ...
    public static void f(final ChatActivityEnterView chatActivityEnterView, final gv0 gv0Var, int[] iArr, vo0 vo0Var) {
        ...
        if (org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19140s8, true) == -1) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        if (i10 >= 26) {
            if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18807a7, true)) >= 0.721f) {
                z11 = true;
            } else {
                z11 = false;
            }
        ...
        if (i10 >= 23) {
            chatActivityEnterView.f21849s0 = chatActivityEnterView.getRootWindowInsets().getSystemWindowInsetLeft() + chatActivityEnterView.f21849s0;
        }
        chatActivityEnterView.f21832p0.getLocationInWindow(iArr2);
        final float f10 = iArr2[0];
        final float f11 = iArr2[1];
        float dp = AndroidUtilities.dp(5.0f);
        float dp2 = iArr[0] + chatActivityEnterView.f21849s0 + dp + AndroidUtilities.dp(4.0f) + 0.0f;
        float f12 = iArr[1] + chatActivityEnterView.f21854t0 + dp + 0.0f;
        gv0Var.setTranslationX(dp2);
        gv0Var.setTranslationY(f12);
        float f13 = chatActivityEnterView.f21832p0.getLayoutParams().width;
        if (chatActivityEnterView.f21815l5) {
            f7 = chatActivityEnterView.f21832p0.getScaleX();
        } else {
            f7 = 1.0f;
        }
        ...
        dialog2.show();
        if (!chatActivityEnterView.f21815l5) {
            chatActivityEnterView.f21832p0.setScaleX(1.0f);
            chatActivityEnterView.f21832p0.setScaleY(1.0f);
        }
        chatActivityEnterView.f21832p0.setAlpha(1.0f);
        cf cfVar = chatActivityEnterView.f21837q0;
        boolean z12 = chatActivityEnterView.f21815l5;
        o1.c cVar = o1.h.f15345o;
        if (z12) {
            kVar = null;
        } else {
            o1.k kVar3 = new o1.k(chatActivityEnterView.f21832p0, cVar);
            kVar3.f15361u = org.telegram.ui.Cells.p6.l(0.5f, 750.0f, 1.0f);
            kVar = kVar3;
        }
        boolean z13 = chatActivityEnterView.f21815l5;
        ...
        if (z13) {
            ...
            dialog = dialog2;
            o1.k kVar4 = new o1.k(chatActivityEnterView.f21832p0, cVar2);
            kVar4.f15361u = org.telegram.ui.Cells.p6.l(0.5f, 750.0f, 1.0f);
            kVar2 = kVar4;
        }
        o1.k kVar5 = new o1.k(chatActivityEnterView.f21832p0, o1.h.f15350t);
        kVar5.f15361u = org.telegram.ui.Cells.p6.l(0.0f, 750.0f, 1.0f);
        final Dialog dialog3 = dialog;
        kVar5.a(new o1.f(chatActivityEnterView) {
            public final ChatActivityEnterView f28366b;

            {
                this.f28366b = chatActivityEnterView;
            }
            ...
            public final void a(o1.h hVar, boolean z14, float f14, float f15) {
                ...
                ChatActivityEnterView chatActivityEnterView2 = this.f28366b;
                switch (i11) {
                    case 0:
                        ...
                        if (dialog4.isShowing()) {
                            ...
                            xo0 xo0Var = chatActivityEnterView2.f21832p0;
                            xo0Var.getClass();
                            xo0Var.a(false, false, 0.0f);
                            if (!chatActivityEnterView2.f21815l5) {
                                chatActivityEnterView2.f21832p0.setScaleX(1.0f);
                                chatActivityEnterView2.f21832p0.setScaleY(1.0f);
                            }
                            chatActivityEnterView2.f21832p0.setAlpha(1.0f);
                            chatActivityEnterView2.f21832p0.getViewTreeObserver().addOnPreDrawListener(new ef(chatActivityEnterView2, dialog4, 0));
                            return;
                        }
                        return;
                    default:
                        ...
                        if (dialog4.isShowing()) {
                            gv0Var2.setTranslationX(f17);
                            gv0Var2.setTranslationY(f16);
                            xo0 xo0Var2 = chatActivityEnterView2.f21832p0;
                            xo0Var2.getClass();
                            ...
                            chatActivityEnterView2.f21832p0.setAlpha(1.0f);
                            chatActivityEnterView2.f21832p0.getViewTreeObserver().addOnPreDrawListener(new ef(chatActivityEnterView2, dialog4, 1));
                            return;
                        }
                        return;
                }
    ...
    public static void g(ChatActivityEnterView chatActivityEnterView, TLRPC.Document document, String str, MessageObject.SendAnimationData sendAnimationData, boolean z10, int i10, int i11, Object obj, Long l4, boolean z11) {
        ...
        if (chatActivityEnterView.G0 > 0 && !chatActivityEnterView.c()) {
            ...
            if (mgVar != null) {
                ...
                mgVar.t1(ugVar, ugVar.f28384a.getText(), true);
                return;
            }
            return;
        }
    ...
    public static void h(ChatActivityEnterView chatActivityEnterView, TL_keyboard.KeyboardButton keyboardButton) {
        ...
        if (chatActivityEnterView.S2 != null && (boVar = chatActivityEnterView.O2) != null && boVar.f32310h4 && boVar.d() == chatActivityEnterView.S2.getId()) {
            z10 = true;
        } else {
            z10 = false;
        }
        if ((chatActivityEnterView.S2 != null && !z10) || BotForumHelper.isBotForum(chatActivityEnterView.Q, chatActivityEnterView.P2)) {
            ...
            messageObject = chatActivityEnterView.f21813l2;
        } else {
            messageObject = null;
        }
        MessageObject messageObject2 = chatActivityEnterView.S2;
        if (messageObject2 == null || z10) {
            messageObject2 = chatActivityEnterView.f21813l2;
        }
        ...
        if (chatActivityEnterView.S2 != null && !z10) {
            ...
            MessageObject messageObject3 = chatActivityEnterView.f21813l2;
            if (messageObject3 != null && messageObject3.messageOwner.reply_markup.single_use) {
                ...
                MessagesController.getMainSettings(chatActivityEnterView.Q).edit().putInt("answered_" + chatActivityEnterView.getTopicKeyString(), chatActivityEnterView.f21813l2.getId()).commit();
            }
        }
        mg mgVar = chatActivityEnterView.Y2;
        if (mgVar != null) {
    ...
    public static void i(ChatActivityEnterView chatActivityEnterView, MessageObject messageObject, TL_keyboard.KeyboardButtonProto keyboardButtonProto) {
        ...
        if (Build.VERSION.SDK_INT >= 23 && activity.checkSelfPermission("android.permission.ACCESS_COARSE_LOCATION") != 0) {
            ...
            chatActivityEnterView.f21792h3 = messageObject;
            chatActivityEnterView.f21798i3 = keyboardButtonProto;
            return;
        }
    ...
    public static void m(ChatActivityEnterView chatActivityEnterView) {
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(chatActivityEnterView, "lockAnimatedTranslation", chatActivityEnterView.f21804j4);
        ...
        animatorSet.playTogether(ofFloat2, ofFloat, ObjectAnimator.ofFloat(chatActivityEnterView, "slideToCancelProgress", 1.0f).setDuration(200L), ObjectAnimator.ofFloat(chatActivityEnterView.f21802j1, "cancelToProgress", 1.0f));
        animatorSet.start();
    }
                    ...
                    if (messageEntity.offset + messageEntity.length <= spannableStringBuilder.length()) {
                        if (messageEntity instanceof TLRPC.TL_inputMessageEntityMentionName) {
                            ...
                            if (messageEntity instanceof TLRPC.TL_messageEntityBold) {
                                ...
                                obj7.f26909b = i22;
                                obj7.f26910c = i22 + messageEntity.length;
    ...
    public final void A() {
        ...
        this.f21851s2 = null;
        y0();
        if (this.f21828o1 != null) {
            this.f21875x = 0.0f;
            A1();
        }
        SlideTextView slideTextView = this.f21802j1;
    ...
    public final void A1() {
        int i10;
        z1();
        org.telegram.ui.zd zdVar = this.f21828o1;
        if (zdVar != null) {
            zdVar.setTranslationX(this.f21881y + this.f21875x);
            ...
            hg.k kVar = this.f21838q1;
            if (kVar != null && this.A4) {
                kVar.setAlpha(this.f21860u1 * this.F);
            }
        }
        xe xeVar = this.I1;
        if (xeVar != null) {
    ...
    public final void B() {
        int i10;
        if (this.f21766d2 && this.f21759c1) {
    ...
    public final void C0() {
        ...
        float audioLeft;
        float audioRight;
        hk0 hk0Var = this.f21790h1;
        if (hk0Var != null) {
            hk0Var.Q = true;
            h71 h71Var = hk0Var.f24687n;
            if (h71Var != null) {
                h71Var.P(false);
                hk0Var.f24687n.H();
                hk0Var.f24687n = null;
        ...
        if (this.f21790h1 != null && this.f21747a3 != null) {
            ...
            hk0 hk0Var2 = this.f21790h1;
            if (hk0Var2 == null) {
                audioLeft = 0.0f;
            } else {
                audioLeft = hk0Var2.getAudioLeft();
            }
            hk0 hk0Var3 = this.f21790h1;
            if (hk0Var3 == null) {
                audioRight = 1.0f;
            } else {
        ...
        this.X1 = true;
        NotificationCenter.ObserversGroup observersGroup2 = this.f21858t4;
        ...
        PowerManager.WakeLock wakeLock = this.f21834p2;
        if (wakeLock != null) {
            try {
                wakeLock.release();
                this.f21834p2 = null;
    ...
    public final void C1() {
        ...
        if (lfVar != null) {
            ...
            } else if (this.f21822n0.f8242c.size() > 4) {
                f7 = hg.k0.f(162.8f, qv0Var.getMeasuredHeight(), 0);
            } else {
                f7 = hg.k0.f((Math.max(1, Math.min(4, this.f21822n0.f8242c.size())) * 36) + 8, qv0Var.getMeasuredHeight(), 0);
            }
            if (this.m0.f8740c.getPaddingTop() != f7) {
                this.m0.f8740c.setTopGlowOffset(f7);
                if (this.V4 == -1 && this.m0.getVisibility() == 0 && this.m0.f8740c.getLayoutManager() != null && (L0 = (c0Var = (s4.c0) this.m0.f8740c.getLayoutManager()).L0()) >= 0 && (m10 = c0Var.m(L0)) != null) {
                    this.V4 = L0;
                    this.W4 = m10.getTop() - this.m0.f8740c.getPaddingTop();
                }
    ...
    public final void D1(boolean z10) {
        if (this.f21820m5 != 1 && this.P2 > 0) {
            S();
        }
        ei.c0 c0Var = this.f21812l0;
        if (c0Var != null) {
            c0Var.setWebView(k0());
        }
        B1(z10);
    ...
    public final void E() {
        ze zeVar;
        org.telegram.ui.bo boVar;
        if (this.L == null && (zeVar = this.J1) != null && zeVar.getRight() != 0 && (boVar = this.O2) != null && BirthdayController.isToday(boVar.f32225a8)) {
            ...
            if (mainSettings.getBoolean(Calendar.getInstance().get(1) + "bdayhint_" + boVar.a(), true)) {
                ...
                this.L.m(1.0f, -((getWidth() - AndroidUtilities.dp(12.0f)) - ((this.J1.getMeasuredWidth() / 2.0f) + (this.J1.getX() + (this.f21828o1.getX() + this.f21877x1.getX())))));
    ...
    public final void F() {
        boolean z10;
        of ofVar = this.E0;
        if ((ofVar == null || TextUtils.isEmpty(ofVar.getText())) && !this.f21884y2 && !this.j3 && !u0()) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final void F0() {
        ...
        if (!k0() || !w()) {
            getVisibility();
            if (this.f21808k2 && !org.telegram.ui.ActionBar.o2.hasSheets(this.O2)) {
                this.f21808k2 = false;
                mg mgVar = this.Y2;
                if (mgVar != null) {
                    mgVar.r1();
                ...
                if (!AndroidUtilities.usingHardwareInput && !this.f21884y2 && !AndroidUtilities.isInMultiwindow) {
                    this.j3 = true;
                    ye yeVar = this.f21840q3;
    ...
    public final void F1() {
        float f7 = this.f21842r * this.h;
        le leVar = this.Q0;
        leVar.setScaleX(f7);
        leVar.setScaleY(this.f21842r * this.h);
        leVar.setAlpha(this.f21848s * this.f21821n);
    }
    ...
    public final void G1(boolean z10) {
        ...
        if (ofVar != null) {
            ...
            if (charSequence != null) {
                ...
                this.E0.setHintText2(this.f21776f, z10);
                return;
            }
            boolean z13 = true;
            boolean z14 = false;
            ...
            if (i10 == 9) {
                ...
                if (z11) {
                    ...
                    if (messageObject2 != null && (replyMarkup2 = messageObject2.messageOwner.reply_markup) != null && !TextUtils.isEmpty(replyMarkup2.placeholder)) {
                    ...
                    } else if (this.X0 && (messageObject = this.f21813l2) != null && (replyMarkup = messageObject.messageOwner.reply_markup) != null && !TextUtils.isEmpty(replyMarkup.placeholder)) {
                        this.E0.setHintText(this.f21813l2.messageOwner.reply_markup.placeholder, z10);
                        ...
                        if (user != null && user.bot_forum_view && !user.bot_forum_can_manage_topics && boVar != null && !boVar.f32310h4) {
                            this.E0.setHintText(LocaleController.getString(R.string.SendBotNoThread));
                        } else if (boVar != null && boVar.F9() && !boVar.f32310h4) {
                            if (boVar.X3 != null && boVar.f32298g4) {
    ...
    public final void H(int i10, boolean z10) {
        ...
        if (i10 > AndroidUtilities.dp(50.0f) && this.f21884y2 && !AndroidUtilities.isInMultiwindow) {
            if (z10) {
                this.f21878x2 = i10;
                MessagesController.getGlobalEmojiSettings().edit().putInt("kbd_height_land3", this.f21878x2).commit();
            } else {
                this.f21872w2 = i10;
                MessagesController.getGlobalEmojiSettings().edit().putInt("kbd_height", this.f21872w2).commit();
            }
        }
        if (this.f21884y2 && this.W0 && this.U0 == null) {
            this.W0 = false;
        }
        boolean u02 = u0();
        qv0 qv0Var = this.l1;
        ...
        if (u02) {
            ...
            if (zfVar2 != null) {
                ...
                ph.f fVar2 = this.f21769d5;
                if (fVar2 != null && i11 > 0 && this.f21772e2 == 1) {
                    ((ph.i) fVar2).g(i11);
                }
            }
            if (view != null) {
                FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) view.getLayoutParams();
                if (!this.f21889z3 && !this.y3 && (((i12 = layoutParams.width) != (i13 = AndroidUtilities.displaySize.x) || layoutParams.height != i11) && ((fVar = this.f21769d5) == null || i12 != -1 || layoutParams.height != -1))) {
                    if (fVar == null) {
                    ...
                    if (qv0Var != null) {
                        int i15 = this.f21888z2;
                        this.f21888z2 = layoutParams.height;
                        qv0Var.requestLayout();
                        H0();
                        if (this.f21791h2 && !this.f21884y2 && i15 != this.f21888z2 && O0()) {
                            AnimatorSet animatorSet = new AnimatorSet();
                            this.V0 = animatorSet;
                            if (this.f21769d5 != null) {
                                animatorSet.playTogether(ValueAnimator.ofFloat(this.f21888z2 - i15, 0.0f));
                            } else {
                                animatorSet.playTogether(ObjectAnimator.ofFloat(view, View.TRANSLATION_Y, this.f21888z2 - i15, 0.0f));
                            }
                            this.V0.setInterpolator(org.telegram.ui.ActionBar.q1.f19508w);
        ...
        this.f21884y2 = z11;
        F();
        if (this.f21884y2 && u0() && this.A3 == null) {
            t1(0, this.f21772e2, true, true);
        } else if (!this.f21884y2 && !u0() && (messageObject = this.f21813l2) != null && this.S2 != messageObject && !k0() && !w() && !org.telegram.ui.ActionBar.o2.hasSheets(boVar) && (((ofVar = this.E0) == null || TextUtils.isEmpty(ofVar.getText())) && (tL_replyKeyboardMarkup = this.f21817m2) != null && !tL_replyKeyboardMarkup.rows.isEmpty())) {
        ...
        if (this.f21888z2 != 0 && !(z12 = this.f21884y2) && z12 != z14 && !u0()) {
            this.f21888z2 = 0;
            qv0Var.requestLayout();
        }
        if (this.f21884y2 && this.j3) {
            this.j3 = false;
            if (this.f21830o3) {
                this.f21830o3 = false;
                this.G1.setButtons(this.f21817m2);
            }
            AndroidUtilities.cancelRunOnUIThread(this.f21840q3);
        }
        H0();
    }
        ...
        if (this.E0 != null) {
            ...
            if (messageObject == null || messageObject.needResendWhenEdit()) {
                ...
                if (z10 && this.f21815l5) {
                    ...
                    ze zeVar = this.f21871w1;
                    if (zeVar != null && zeVar.getVisibility() == 0 && (xeVar2 = this.I1) != null && xeVar2.getVisibility() == 0 && (kVar = this.f21838q1) != null && kVar.getVisibility() == 0) {
                        layoutParams.rightMargin = AndroidUtilities.dp(146.0f);
                    } else {
                        ze zeVar2 = this.f21871w1;
                ...
                if (ieVar != null) {
                    ...
                    this.f21771e1.setLayoutParams(layoutParams2);
                }
            }
        }
    }
    ...
    public final void J0() {
        ...
        if (!k0() || !w()) {
            ...
            if (!org.telegram.ui.ActionBar.o2.hasSheets(boVar)) {
                if (!AndroidUtilities.usingHardwareInput && !AndroidUtilities.isInMultiwindow && ((boVar == null || !boVar.isInBubbleMode()) && !this.f21797i2)) {
                    i10 = 2;
                } else {
                    i10 = 0;
                }
                ...
                if (this.f21797i2) {
                    this.f21808k2 = true;
                } else if (!AndroidUtilities.usingHardwareInput && !this.f21884y2 && !AndroidUtilities.isInMultiwindow) {
    ...
    public final void K() {
        ...
        if (DialogObject.isChatDialog(this.P2)) {
            ...
            this.f21876x0 = ChatObject.canSendRoundVideo(chat);
            this.f21882y0 = ChatObject.canSendVoice(chat);
        } else {
            z10 = false;
        }
        ...
        if (!this.f21876x0 && z11) {
            z11 = false;
        }
        if (!this.f21882y0 && !z11) {
            if (!this.f21766d2) {
                z12 = false;
            }
        } else {
    ...
    public final void K1(TLRPC.Chat chat, TLRPC.UserFull userFull) {
        ...
        float f10 = 1.0f;
        if (chat != null) {
            if (!ChatObject.canSendVoice(chat) && (!ChatObject.canSendRoundVideo(chat) || !this.f21766d2)) {
                z10 = true;
            } else {
                z10 = false;
            }
            this.f21746a1 = z10;
            this.f21750b = ChatObject.canSendStickers(chat);
            boolean canSendPlain = ChatObject.canSendPlain(chat);
            this.f21886z0 = canSendPlain;
            if (!this.f21750b && !canSendPlain) {
                z11 = true;
            } else {
                z11 = false;
            }
            ...
            if (!this.A0 && (cgVar = this.U0) != null) {
                cgVar.K(-this.P2, !this.f21886z0, !this.f21750b);
            }
            this.f21876x0 = ChatObject.canSendRoundVideo(chat);
            this.f21882y0 = ChatObject.canSendVoice(chat);
        } else if (userFull != null) {
            this.f21746a1 = userFull.voice_messages_forbidden;
            this.K = userFull;
        }
        if (this.f21746a1) {
            f10 = 0.5f;
        ...
        seVar.invalidate();
        if (this.f21746a1) {
            i10 = j0(org.telegram.ui.ActionBar.j6.Wk);
        } else {
            i10 = -1;
        }
        PorterDuffColorFilter porterDuffColorFilter = new PorterDuffColorFilter(i10, PorterDuff.Mode.SRC_IN);
        te teVar = this.f21752b1;
        teVar.setColorFilter(porterDuffColorFilter);
        teVar.invalidate();
        G1(false);
        boolean z13 = this.f21759c1;
        if (!this.f21876x0 && z13) {
            z13 = false;
        }
        if (!this.f21882y0 && !z13) {
            if (!this.f21766d2) {
                z12 = false;
            }
        } else {
    ...
    public void L1(int i10, boolean z10) {
        ...
        char c12;
        Property property;
        xg xgVar3 = xg.f29908a;
        xg xgVar4 = xg.f29909b;
        Float valueOf = Float.valueOf(0.0f);
        Runnable runnable = this.f21777f0;
        if (runnable != null) {
        ...
        if (z13) {
            ...
            if (z14) {
                ...
                qg qgVar = this.N1;
                if (qgVar != null) {
                    qgVar.f27300y.d(1, false, false);
                }
                MediaDataController mediaDataController = MediaDataController.getInstance(this.Q);
                long j11 = this.P2;
                org.telegram.ui.bo boVar = this.O2;
                property = property3;
                mediaDataController.toggleDraftVoiceOnce(j11, (boVar == null || !boVar.f32310h4) ? 0L : boVar.d(), this.O);
                this.f21796i1 = 0L;
            }
            Y();
            this.f21866v2 = 1;
            ...
            AnimatorSet animatorSet = this.f21851s2;
            if (animatorSet != null) {
                animatorSet.cancel();
            }
            AnimatorSet animatorSet2 = this.f21856t2;
            ...
            sg sgVar = this.f21807k1;
            if (sgVar != null) {
                sgVar.f27857a = 1.0f;
                sgVar.f27858b = System.currentTimeMillis();
                sgVar.f27859c = false;
                sgVar.e = false;
                sgVar.f27860f.stop();
                sgVar.invalidate();
                this.f21807k1.setScaleX(0.0f);
                this.f21807k1.setScaleY(0.0f);
                this.f21807k1.h = true;
            }
            this.f21851s2 = new AnimatorSet();
            this.Y0.setTranslationX(AndroidUtilities.dp(20.0f));
            this.Y0.setAlpha(0.0f);
            if (this.Q4 != 3) {
                this.f21802j1.setTranslationX(AndroidUtilities.dp(20.0f));
                this.f21802j1.setAlpha(0.0f);
                this.f21802j1.setCancelToProgress(0.0f);
                SlideTextView slideTextView = this.f21802j1;
                slideTextView.f21906r = 1.0f;
                slideTextView.setEnabled(true);
            } else {
                this.f21802j1.setTranslationX(0.0f);
                this.f21802j1.setAlpha(0.0f);
                this.f21802j1.setCancelToProgress(1.0f);
                this.f21802j1.setEnabled(true);
            }
            this.M1.c(this.Q4 == 3);
            this.f21803j2 = false;
            y0();
            ...
            animatorSet3.playTogether(ObjectAnimator.ofFloat(this.Q0, this.Y3, 0.0f), ObjectAnimator.ofFloat(this.Q0, this.f21748a4, 0.0f), ObjectAnimator.ofFloat(this.f21807k1, property4, 1.0f), ObjectAnimator.ofFloat(this.f21807k1, property6, 1.0f), ObjectAnimator.ofFloat(this.Y0, property2, 0.0f), ObjectAnimator.ofFloat(this.Y0, property5, 1.0f));
            animatorSet3.playTogether(ObjectAnimator.ofFloat(this.f21802j1, property2, 0.0f));
            animatorSet3.playTogether(ObjectAnimator.ofFloat(this.f21802j1, property5, 1.0f));
            qg qgVar3 = this.N1;
            if (qgVar3 != null) {
                animatorSet3.playTogether(ObjectAnimator.ofFloat(qgVar3, property5, 1.0f));
            }
            if (this.f21752b1 != null) {
                animatorSet3.playTogether(ObjectAnimator.ofFloat(this.Z0, property5, 0.0f));
            }
            ei.c0 c0Var = this.f21812l0;
            if (c0Var != null) {
                animatorSet3.playTogether(ObjectAnimator.ofFloat(c0Var, property4, 0.0f), ObjectAnimator.ofFloat(this.f21812l0, property6, 0.0f), ObjectAnimator.ofFloat(this.f21812l0, property5, 0.0f));
            }
            AnimatorSet animatorSet4 = new AnimatorSet();
            animatorSet4.playTogether(ObjectAnimator.ofFloat(this.E0, this.f21762c4, AndroidUtilities.dp(20.0f)), ObjectAnimator.ofFloat(this.E0, property5, 0.0f), ObjectAnimator.ofFloat(this.f21771e1, property5, 1.0f));
            if (z14) {
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.f21790h1, property5, 0.0f));
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.f21784g1, property5, 0.0f));
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.f21784g1, property6, 0.0f));
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.f21784g1, property4, 0.0f));
                animatorSet4.playTogether(ObjectAnimator.ofFloat(this.f21778f1, property5, 0.0f));
            }
            if (this.I1 != null) {
            ...
            org.telegram.ui.zd zdVar = this.f21828o1;
            if (zdVar != null) {
                animatorSet4.playTogether(ObjectAnimator.ofFloat(zdVar, this.f21755b4, AndroidUtilities.dp(30.0f)), ObjectAnimator.ofFloat(this.f21828o1, this.Z3, 0.0f));
                ViewPropertyAnimator viewPropertyAnimator = this.f21833p1;
                ...
                hg.k kVar = this.f21838q1;
                this.f21860u1 = 0.0f;
                animatorSet4.playTogether(ObjectAnimator.ofFloat(kVar, property5, 0.0f), ObjectAnimator.ofFloat(this.f21838q1, property6, 0.5f), ObjectAnimator.ofFloat(this.f21838q1, property4, 0.5f));
            }
            jh.h hVar = this.f21775e5;
            if (hVar != null) {
                hVar.e(0, false, true);
            }
            this.f21851s2.playTogether(animatorSet3.setDuration(150L), animatorSet4.setDuration(150L), ObjectAnimator.ofFloat(this.M1, this.f21857t3, 1.0f).setDuration(300L));
            if (!z14) {
                this.f21851s2.playTogether(ObjectAnimator.ofFloat(this.M1, this.f21862u3, 1.0f).setDuration(300L));
            }
            this.f21851s2.addListener(new tf(this, z14));
            this.f21851s2.setInterpolator(new DecelerateInterpolator());
            this.f21851s2.start();
            this.Y0.a(this.f21796i1);
        } else if (this.f21803j2 && i10 == 3) {
            return;
        } else {
            PowerManager.WakeLock wakeLock = this.f21834p2;
            if (wakeLock != null) {
            ...
            AnimatorSet animatorSet5 = this.f21851s2;
            if (animatorSet5 != null) {
                z11 = animatorSet5.isRunning();
                te teVar = this.f21752b1;
                if (teVar != null) {
                    teVar.setScaleX(1.0f);
                    this.f21752b1.setScaleY(1.0f);
                }
                this.f21851s2.removeAllListeners();
                this.f21851s2.cancel();
            } else {
                z11 = false;
            }
            AnimatorSet animatorSet6 = this.f21856t2;
            ...
            this.f21851s2 = new AnimatorSet();
            if (z11 || i10 == 4) {
                te teVar2 = this.f21752b1;
                if (teVar2 != null) {
                    teVar2.setVisibility(0);
                }
                this.f21851s2.playTogether(ObjectAnimator.ofFloat(this.Q0, this.Y3, 1.0f), ObjectAnimator.ofFloat(this.Q0, this.f21748a4, this.A0 ? 0.5f : 1.0f), ObjectAnimator.ofFloat(this.f21807k1, property4, 0.0f), ObjectAnimator.ofFloat(this.f21807k1, property3, 0.0f), ObjectAnimator.ofFloat(this.M1, this.f21857t3, 0.0f), ObjectAnimator.ofFloat(this.M1, this.f21862u3, 0.0f), ObjectAnimator.ofFloat(this.Z0, property5, 1.0f), ObjectAnimator.ofFloat(this.Y0, property5, 0.0f), ObjectAnimator.ofFloat(this.Z0, property5, 1.0f), ObjectAnimator.ofFloat(this.E0, property5, 1.0f), ObjectAnimator.ofFloat(this.E0, this.f21762c4, 0.0f), ObjectAnimator.ofFloat(this, "slideToCancelProgress", 1.0f));
                qg qgVar4 = this.N1;
                if (qgVar4 != null) {
                    i11 = 1;
                    c10 = 0;
                    this.f21851s2.playTogether(ObjectAnimator.ofFloat(qgVar4, property5, 0.0f));
                    this.N1.a();
                } else {
                    i11 = 1;
                    c10 = 0;
                }
                ei.c0 c0Var2 = this.f21812l0;
                if (c0Var2 != null) {
                    AnimatorSet animatorSet7 = this.f21851s2;
                    float[] fArr = new float[i11];
                    f7 = 1.0f;
                    fArr[c10] = 1.0f;
                    ObjectAnimator ofFloat = ObjectAnimator.ofFloat(c0Var2, property4, fArr);
                    ei.c0 c0Var3 = this.f21812l0;
                    float[] fArr2 = new float[i11];
                    fArr2[c10] = 1.0f;
                    ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(c0Var3, property3, fArr2);
                    ei.c0 c0Var4 = this.f21812l0;
                ...
                te teVar3 = this.f21752b1;
                if (teVar3 != null) {
                    teVar3.setScaleX(f7);
                    this.f21752b1.setScaleY(f7);
                    i12 = 1;
                    this.f21851s2.playTogether(ObjectAnimator.ofFloat(this.Z0, property5, f7));
                    this.f21752b1.j(t0() ? xgVar4 : xgVar3, true);
                } else {
                    i12 = 1;
                }
                if (this.I1 != null) {
                    AnimatorSet animatorSet8 = this.f21851s2;
                ...
                if (this.f21828o1 != null) {
                    ViewPropertyAnimator viewPropertyAnimator2 = this.f21833p1;
                    ...
                    z12 = true;
                    r12 = 0;
                    this.f21851s2.playTogether(ObjectAnimator.ofFloat(this.f21828o1, this.f21755b4, 0.0f), ObjectAnimator.ofFloat(this.f21828o1, this.Z3, 1.0f));
                    AnimatorSet animatorSet9 = this.f21851s2;
                    hg.k kVar2 = this.f21838q1;
                    this.f21860u1 = 1.0f;
                    animatorSet9.playTogether(ObjectAnimator.ofFloat(kVar2, property5, 1.0f), ObjectAnimator.ofFloat(this.f21838q1, property3, 1.0f), ObjectAnimator.ofFloat(this.f21838q1, property4, 1.0f));
                } else {
                    r12 = 0;
                    z12 = true;
                }
                jh.h hVar2 = this.f21775e5;
                if (hVar2 != 0) {
                    hVar2.e(r12, r12, z12);
                }
                this.f21803j2 = z12;
                y0();
                this.f21851s2.setDuration(150L);
            } else if (i10 == 3) {
                Y();
                Z();
                SlideTextView slideTextView2 = this.f21802j1;
                ...
                if (this.f21759c1) {
                    ...
                    if (ieVar != null) {
                        ieVar.setAlpha(1.0f);
                        this.f21771e1.setVisibility(0);
                    }
                    bj0 bj0Var = this.f21784g1;
                    if (bj0Var != null) {
                    ...
                    w71 w71Var = this.f21778f1;
                    if (w71Var != null) {
                        w71Var.setVisibility(8);
                        y0();
                    }
                    ie ieVar2 = this.f21771e1;
                    if (ieVar2 != null) {
                        i16 = 0;
                        ieVar2.setVisibility(0);
                        f11 = 1.0f;
                        this.f21771e1.setAlpha(1.0f);
                    } else {
                        f11 = 1.0f;
                        i16 = 0;
                    }
                    ...
                    if (hk0Var2 != null) {
                        ...
                        this.f21790h1.setAlpha(0.0f);
                    }
                }
                this.f21847r4 = true;
                this.f21819m4 = f11;
                this.f21810k4 = this.f21804j4;
                this.f21799i4 = f11;
                SlideTextView slideTextView3 = this.f21802j1;
                ...
                bj0 bj0Var2 = this.f21784g1;
                if (bj0Var2 != null) {
                    bj0Var2.setAlpha(0.0f);
                    this.f21784g1.setScaleX(0.0f);
                    this.f21784g1.setScaleY(0.0f);
                    this.f21784g1.setProgress(0.0f);
                    this.f21784g1.i();
                }
                if (!this.f21759c1 && !this.f21890z4) {
                    viewGroup = (ViewGroup) this.f21771e1.getParent();
                    layoutParams = this.f21771e1.getLayoutParams();
                    viewGroup.removeView(this.f21771e1);
                    ...
                    this.l1.addView(this.f21771e1, layoutParams2);
                    this.f21778f1.setVisibility(8);
                } else {
                    this.f21778f1.setVisibility(0);
                    viewGroup = null;
                    layoutParams = null;
                }
                y0();
                ...
                if (!z10) {
                    a0();
                    this.f21857t3.set(this.M1, Float.valueOf(1.0f));
                    this.M1.setTransformToSeekbar(1.0f);
                    if (!this.f21759c1) {
                        float f12 = this.f21831o4;
                        if (f12 != 0.0f && this.f21790h1 != null) {
                            this.f21790h1.setAlpha(qr.f27386j.getInterpolation(Math.max(0.0f, ((f12 - 0.38f) - 0.25f) / 0.37f)));
                            this.f21790h1.invalidate();
                        }
                    }
                    this.f21807k1.setScaleY(0.0f);
                    this.f21807k1.setScaleX(0.0f);
                    ...
                    this.Y0.setTranslationX(-AndroidUtilities.dp(20.0f));
                    this.f21802j1.setAlpha(0.0f);
                    this.f21784g1.setAlpha(1.0f);
                    this.f21784g1.setScaleY(1.0f);
                    this.f21784g1.setScaleX(1.0f);
                    this.Y3.set(this.Q0, valueOf);
                    this.f21748a4.set(this.Q0, valueOf);
                    this.E0.setAlpha(0.0f);
                    te teVar4 = this.f21752b1;
                    if (teVar4 != null) {
                        if (t0()) {
                            xgVar3 = xgVar4;
                        }
                    ...
                    ei.c0 c0Var5 = this.f21812l0;
                    if (c0Var5 != null) {
                        c0Var5.setAlpha(0.0f);
                        this.f21812l0.setScaleX(0.0f);
                        this.f21812l0.setScaleY(0.0f);
                    }
                    if (t0()) {
                        this.f21778f1.setAlpha(1.0f);
                    }
                    if (viewGroup != null) {
                        this.l1.removeView(this.f21771e1);
                        viewGroup.addView(this.f21771e1, layoutParams);
                    }
                    this.f21771e1.setAlpha(1.0f);
                    this.f21790h1.setAlpha(1.0f);
                    this.h = 0.0f;
                    this.f21821n = 0.0f;
                    F1();
                    y0();
                } else {
                    this.f21790h1.setAllowDraw(false);
                    ...
                    animatorSet11.playTogether(ObjectAnimator.ofFloat(this.f21807k1, property4, 0.0f), ObjectAnimator.ofFloat(this.f21807k1, property3, 0.0f), ObjectAnimator.ofFloat(this.Y0, property5, 0.0f), ObjectAnimator.ofFloat(this.Y0, property2, -AndroidUtilities.dp(20.0f)), ObjectAnimator.ofFloat(this.f21802j1, property5, 0.0f), ObjectAnimator.ofFloat(this.f21784g1, property5, 1.0f), ObjectAnimator.ofFloat(this.f21784g1, property4, 1.0f), ObjectAnimator.ofFloat(this.f21784g1, property3, 1.0f), ObjectAnimator.ofFloat(this.Q0, this.Y3, 0.0f), ObjectAnimator.ofFloat(this.Q0, this.f21748a4, 0.0f), ObjectAnimator.ofFloat(this.E0, property5, 0.0f));
                    bj0 bj0Var3 = this.f21784g1;
                    if (bj0Var3 != null) {
                    ...
                    if (t0()) {
                        this.f21778f1.setAlpha(0.0f);
                        c11 = 1;
                        c12 = 0;
                        animatorSet10.playTogether(ObjectAnimator.ofFloat(this.f21778f1, property5, 1.0f));
                    ...
                    AnimatorSet animatorSet12 = this.f21851s2;
                    ...
                    this.f21851s2.addListener(new ai.y4(this, viewGroup, layoutParams, 2));
                }
            } else {
                xg xgVar5 = xgVar3;
                xg xgVar6 = xgVar4;
                if (i10 != 2 && i10 != 5) {
                    te teVar6 = this.f21752b1;
                    if (teVar6 != null) {
                        teVar6.setVisibility(0);
                    }
                    AnimatorSet animatorSet13 = new AnimatorSet();
                    animatorSet13.playTogether(ObjectAnimator.ofFloat(this.Q0, this.Y3, 1.0f), ObjectAnimator.ofFloat(this.Q0, this.f21748a4, this.A0 ? 0.5f : 1.0f), ObjectAnimator.ofFloat(this.f21807k1, property4, 0.0f), ObjectAnimator.ofFloat(this.f21807k1, property3, 0.0f), ObjectAnimator.ofFloat(this.Z0, property5, 1.0f));
                    qg qgVar6 = this.N1;
                    if (qgVar6 != null) {
                        animatorSet13.playTogether(ObjectAnimator.ofFloat(qgVar6, property5, 0.0f));
                        this.N1.a();
                    }
                    ei.c0 c0Var9 = this.f21812l0;
                    if (c0Var9 != null) {
                        f10 = 1.0f;
                        animatorSet13.playTogether(ObjectAnimator.ofFloat(c0Var9, property4, 1.0f), ObjectAnimator.ofFloat(this.f21812l0, property3, 1.0f), ObjectAnimator.ofFloat(this.f21812l0, property5, 1.0f));
                    } else {
                        f10 = 1.0f;
                    }
                    te teVar7 = this.f21752b1;
                    if (teVar7 != null) {
                        teVar7.setScaleX(f10);
                        this.f21752b1.setScaleY(f10);
                        animatorSet13.playTogether(ObjectAnimator.ofFloat(this.Z0, property5, f10));
                        te teVar8 = this.f21752b1;
                        if (t0()) {
                            xgVar5 = xgVar6;
                        }
                    ...
                    if (this.f21828o1 != null) {
                        ViewPropertyAnimator viewPropertyAnimator3 = this.f21833p1;
                        ...
                        i15 = 1;
                        r92 = 0;
                        animatorSet13.playTogether(ObjectAnimator.ofFloat(this.f21828o1, this.Z3, 1.0f));
                        hg.k kVar3 = this.f21838q1;
                        this.f21860u1 = 1.0f;
                        animatorSet13.playTogether(ObjectAnimator.ofFloat(kVar3, property5, 1.0f), ObjectAnimator.ofFloat(this.f21838q1, property3, 1.0f), ObjectAnimator.ofFloat(this.f21838q1, property4, 1.0f));
                    } else {
                        r92 = 0;
                        i15 = 1;
                    }
                    jh.h hVar3 = this.f21775e5;
                    if (hVar3 != 0) {
                        hVar3.e(r92, r92, i15);
                    }
                    xe xeVar2 = this.I1;
                    ...
                    ofFloat14.setDuration(this.f21783g0 ? 220L : 360L);
                    this.G = 0.0f;
                    J1();
                    ObjectAnimator ofFloat15 = ObjectAnimator.ofFloat(this.E0, property5, 1.0f);
                    ofFloat15.setStartDelay(this.f21848s == 1.0f ? 150L : 450L);
                    ofFloat15.setDuration(200L);
                    this.f21851s2.playTogether(animatorSet13, animatorSet14, ofFloat15, ofFloat14);
                } else {
                    te teVar9 = this.f21752b1;
                    if (teVar9 != null) {
                    ...
                    animatorSet15.playTogether(ObjectAnimator.ofFloat(this.Q0, this.Y3, 1.0f), ObjectAnimator.ofFloat(this.Q0, this.f21748a4, this.A0 ? 0.5f : 1.0f), ObjectAnimator.ofFloat(this.f21807k1, property4, 0.0f), ObjectAnimator.ofFloat(this.f21807k1, property3, 0.0f));
                    qg qgVar7 = this.N1;
                    if (qgVar7 != null) {
                        animatorSet15.playTogether(ObjectAnimator.ofFloat(qgVar7, property5, 0.0f));
                        this.N1.a();
                    }
                    ei.c0 c0Var10 = this.f21812l0;
                    if (c0Var10 != null) {
                        animatorSet15.playTogether(ObjectAnimator.ofFloat(c0Var10, property4, 1.0f), ObjectAnimator.ofFloat(this.f21812l0, property3, 1.0f), ObjectAnimator.ofFloat(this.f21812l0, property5, 1.0f));
                    }
                    AnimatorSet animatorSet16 = new AnimatorSet();
                    animatorSet16.playTogether(ObjectAnimator.ofFloat(this.Y0, property5, 0.0f), ObjectAnimator.ofFloat(this.Y0, property2, -AndroidUtilities.dp(20.0f)), ObjectAnimator.ofFloat(this.f21802j1, property5, 0.0f), ObjectAnimator.ofFloat(this.f21802j1, property2, -AndroidUtilities.dp(20.0f)));
                    if (i10 != 5) {
                        this.Z0.setScaleX(0.0f);
                        this.Z0.setScaleY(0.0f);
                        hg.k kVar4 = this.f21838q1;
                        if (kVar4 != null && kVar4.getVisibility() == 0) {
                            this.f21838q1.setScaleX(0.5f);
                            this.f21838q1.setScaleY(0.5f);
                        }
                        ze zeVar = this.f21871w1;
                        if (zeVar != null && zeVar.getVisibility() == 0) {
                            this.f21871w1.setScaleX(0.0f);
                            this.f21871w1.setScaleY(0.0f);
                        }
                        ...
                        if (this.f21828o1 != null) {
                            ViewPropertyAnimator viewPropertyAnimator4 = this.f21833p1;
                            if (viewPropertyAnimator4 != null) {
                                viewPropertyAnimator4.cancel();
                                this.f21833p1 = null;
                            }
                            i14 = 1;
                            animatorSet15.playTogether(ObjectAnimator.ofFloat(this.f21828o1, this.Z3, 1.0f), ObjectAnimator.ofFloat(this.f21828o1, this.f21755b4, 0.0f));
                            hg.k kVar5 = this.f21838q1;
                            this.f21860u1 = 1.0f;
                            animatorSet15.playTogether(ObjectAnimator.ofFloat(kVar5, property5, 1.0f), ObjectAnimator.ofFloat(this.f21838q1, property3, 1.0f), ObjectAnimator.ofFloat(this.f21838q1, property4, 1.0f));
                        } else {
                            i14 = 1;
                        }
                        jh.h hVar4 = this.f21775e5;
                        if (hVar4 != null) {
                            hVar4.e(0, false, i14);
                        }
                        ze zeVar2 = this.f21871w1;
                        ...
                        if (this.f21828o1 != null) {
                            ViewPropertyAnimator viewPropertyAnimator5 = this.f21833p1;
                            if (viewPropertyAnimator5 != null) {
                                viewPropertyAnimator5.cancel();
                                this.f21833p1 = null;
                            }
                            i13 = 1;
                            animatorSet17.playTogether(ObjectAnimator.ofFloat(this.f21828o1, this.f21755b4, 0.0f), ObjectAnimator.ofFloat(this.f21828o1, this.Z3, 1.0f));
                            hg.k kVar6 = this.f21838q1;
                            this.f21860u1 = 1.0f;
                            animatorSet17.playTogether(ObjectAnimator.ofFloat(kVar6, property5, 1.0f), ObjectAnimator.ofFloat(this.f21838q1, property3, 1.0f), ObjectAnimator.ofFloat(this.f21838q1, property4, 1.0f));
                        } else {
                            i13 = 1;
                        }
                        jh.h hVar5 = this.f21775e5;
                        if (hVar5 != null) {
                            hVar5.e(0, false, i13);
                        }
                        xe xeVar4 = this.I1;
                        ...
                        AnimatorSet animatorSet18 = this.f21851s2;
                    ...
                    ofFloat23.setStartDelay(this.f21848s == 1.0f ? 300L : 700L);
                    ofFloat23.setDuration(200L);
                    this.f21851s2.playTogether(animatorSet15, animatorSet16, ofFloat23, ObjectAnimator.ofFloat(this, "lockAnimatedTranslation", this.f21804j4).setDuration(200L));
                    if (i10 != 5) {
                        ...
                        this.f21851s2.playTogether(ofFloat24);
                    } else {
                        ChatActivityEnterView.this.f21841q4 = true;
                        ...
                        this.f21851s2.playTogether(duration);
                    }
                    sg sgVar2 = this.f21807k1;
                    if (sgVar2 != null) {
                        sgVar2.e = true;
                        yi0 yi0Var = sgVar2.f27860f;
                        yi0Var.T(0.0f, true);
                        if (sgVar2.d) {
                            yi0Var.start();
                        }
            ...
            this.f21851s2.addListener(new wf(this, i10));
            this.f21851s2.start();
            vg vgVar3 = this.Y0;
            if (vgVar3 != null) {
                vgVar3.b();
    ...
    public final void M() {
        ...
        if (this.U0 != null) {
            ...
            int dp = ((((this.f21823n1 - AndroidUtilities.statusBarHeight) - AndroidUtilities.navigationBarHeight) - AndroidUtilities.dp(6.0f)) - org.telegram.ui.ActionBar.k.getCurrentActionBarHeight()) - getHeight();
            if (this.Q1 == 2) {
            ...
            if (i11 != dp) {
                ...
                this.C3 = dp;
                org.telegram.ui.Cells.c1 c1Var = this.f21852s3;
                if (i11 > dp) {
                    ...
                    if (this.v) {
                        ...
                        animatorSet2.setInterpolator(qr.f27383f);
                    ...
                    animatorSet3.setInterpolator(qr.f27383f);
                    animatorSet3.addListener(new we(this, 11));
                    this.A3 = animatorSet3;
                    this.U0.setLayerType(2, null);
                    animatorSet3.start();
                }
                ph.f fVar = this.f21769d5;
                if (fVar != null) {
                    ((ph.i) fVar).g(dp);
                }
            }
    ...
    public final void M1() {
        int j02 = j0(org.telegram.ui.ActionBar.j6.f18980jf);
        int j03 = j0(org.telegram.ui.ActionBar.j6.Sd);
        int j04 = j0(org.telegram.ui.ActionBar.j6.f18872df);
        bj0 bj0Var = this.f21784g1;
        if (bj0Var != null) {
            bj0Var.h(j02, "Cup Red");
            this.f21784g1.h(j02, "Box Red");
            this.f21784g1.h(j04, "Cup Grey");
            this.f21784g1.h(j04, "Box Grey");
            this.f21784g1.h(j03, "Line 1");
            this.f21784g1.h(j03, "Line 2");
            this.f21784g1.h(j03, "Line 3");
        }
    }

    public final void N() {
        this.f21811k5 = z(true);
        float z10 = z(false);
        if (this.f21805j5 != z10) {
            this.f21805j5 = z10;
            B0(z10);
        }
    }
    ...
    public final void O() {
        ...
        int i11;
        int i12;
        float f7 = this.f21788g5.e;
        if (this.F1 != null) {
            float measuredHeight = getMeasuredHeight() - this.f21782f5.e;
            View view = this.F1;
    ...
    public final void O1(boolean z10) {
        ...
        if (isChatDialog) {
            TLRPC.Chat chat = this.R.getMessagesController().getChat(Long.valueOf(-this.P2));
            this.f21779f2 = MessagesController.getNotificationsSettings(this.Q).getBoolean("silent_" + this.P2, false);
            ...
            this.f21785g2 = z11;
            if (imageView != null) {
                if (this.f21770e0 == null) {
                    this.f21770e0 = new nr(getContext(), R.drawable.input_notify_on, org.telegram.ui.ActionBar.j6.Wk);
                }
                this.f21770e0.a(this.f21779f2, false);
                imageView.setImageDrawable(this.f21770e0);
            } else {
                z11 = false;
            }
            org.telegram.ui.zd zdVar = this.f21828o1;
    ...
    public final void P() {
        org.telegram.ui.bo boVar = this.O2;
        if (boVar != null) {
            MediaDataController.getInstance(this.Q).saveDraft(boVar.a(), boVar.B7(boVar.f32385n5), "", null, null, null, null, 0L, false, true, null);
        }
    ...
    public final void R() {
        ...
        this.f21871w1.setScaleType(ImageView.ScaleType.CENTER);
        this.f21871w1.setBackground(org.telegram.ui.ActionBar.j6.f0(j0(org.telegram.ui.ActionBar.j6.f18953i6), 1, -1));
        this.f21871w1.setVisibility(8);
        AndroidUtilities.updateViewVisibilityAnimated(this.f21871w1, false, 0.1f, false);
        this.f21828o1.addView(this.f21871w1, 0, w7.x5.n(44, 44));
        this.f21871w1.setOnClickListener(new sd(this, 15));
    }

    public final void R0(TL_iv.RichMessage richMessage) {
        org.telegram.ui.bo boVar = this.O2;
        if (boVar != null) {
            MediaDataController.getInstance(this.Q).saveDraft(boVar.a(), boVar.B7(boVar.f32385n5), "", null, null, null, null, 0L, false, false, richMessage);
        }
    ...
    public final void R1(boolean z10, boolean z11) {
        ...
        if (this.Y2 != null) {
            ...
            org.telegram.ui.bo boVar = this.O2;
            boolean z13 = true;
            if (!z10 && peer2 != null && ((this.Y2.J() == null || this.Y2.J().peers.size() > 1) && !s0() && !x0() && (((ieVar = this.f21771e1) == null || ieVar.getVisibility() != 0) && ((this.f21815l5 || ((!ChatObject.isChannelAndNotMegaGroup(chat) || ChatObject.canSendAsPeers(chat)) && !ChatObject.isMonoForum(chat))) && (boVar == null || boVar.R3 != 9))))) {
                z12 = true;
            } else {
                z12 = false;
            }
            ...
            if (peer2 != null) {
                if (peer2.channel_id != 0) {
                    ...
                    if (chat3 != null && (xo0Var2 = this.f21832p0) != null) {
                        xo0Var2.setAvatar(chat3);
                        this.f21832p0.setContentDescription(LocaleController.formatString(R.string.AccDescrSendAs, chat3.title));
                    }
                } else {
                    TLRPC.User user = MessagesController.getInstance(this.Q).getUser(Long.valueOf(peer2.user_id));
                    if (user != null && (xo0Var = this.f21832p0) != null) {
                        xo0Var.setAvatar(user);
                        this.f21832p0.setContentDescription(LocaleController.formatString(R.string.AccDescrSendAs, ContactsController.formatName(user.first_name, user.last_name)));
                    }
                }
            }
            xo0 xo0Var3 = this.f21832p0;
            ...
            if (xo0Var4 != null) {
                ...
                if (z12) {
                    ...
                    f10 = ((-this.f21832p0.getLayoutParams().width) - marginLayoutParams.leftMargin) - dp;
                }
            } else {
                f10 = 0.0f;
                f11 = 0.0f;
            ...
            if (z13 != z12) {
                ...
                if (valueAnimator != null) {
                    ...
                    this.f21832p0.setTag(null);
                }
                if ((!this.f21815l5 && (boVar == null || boVar.F8() != 0 || !boVar.O5)) || !z11) {
                    float f14 = f10;
                    float f15 = f12;
                    boolean z14 = z12;
                    if (z14) {
                    ...
                    if (xo0Var6 != null) {
                        ...
                        this.f21832p0.setTranslationX(f14);
                    }
                    if (z14) {
                        f13 = f14;
                    }
    ...
    public final void S() {
        if (this.f21812l0 == null) {
            ...
            this.f21877x1.addView(this.f21812l0, w7.x5.d(-2, 32.0f, 83, 8.0f, 6.0f, 8.0f, 6.0f));
            AndroidUtilities.updateViewVisibilityAnimated(this.f21812l0, false, 1.0f, false);
            ei.c0 c0Var2 = this.f21812l0;
            if (!c0Var2.f8271f) {
                c0Var2.f8271f = true;
                c0Var2.h = 1.0f;
    ...
    public final void S1() {
        ...
        boolean z10 = true;
        if (this.f21863u4 != starsPrice) {
            View sendButtonInternal = getSendButtonInternal();
            this.f21863u4 = starsPrice;
        ...
        if (this.f21815l5) {
            ...
            if (this.f21758c0 != b10) {
                this.f21758c0 = b10;
                if (b10 > 0) {
                    int i12 = b10 - this.f21764d0;
                    if (this.f21815l5) {
                        i10 = 5;
                    } else {
                        i10 = 100;
                    ...
                    if (i12 <= i10) {
                        ...
                        if (this.f21751b0.getVisibility() != 0) {
                            this.f21751b0.setVisibility(0);
                            this.f21751b0.setAlpha(0.0f);
                            this.f21751b0.setScaleX(0.5f);
                            this.f21751b0.setScaleY(0.5f);
                        }
                        this.f21751b0.animate().setListener(null).cancel();
                        this.f21751b0.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setDuration(100L).start();
                        NumberTextView numberTextView2 = this.f21751b0;
                        if (i12 < 0) {
                ...
                NumberTextView numberTextView3 = this.f21751b0;
    ...
    public final void T() {
        ...
        this.f21751b0 = numberTextView;
        numberTextView.setVisibility(8);
        this.f21751b0.setTextSize(15);
        this.f21751b0.setTextColor(j0(org.telegram.ui.ActionBar.j6.f19245y6));
        this.f21751b0.setTypeface(AndroidUtilities.bold());
        this.f21751b0.setCenterAlign(true);
        addView(this.f21751b0, Math.min(2, getChildCount()), w7.x5.d(44, 20.0f, 85, 3.0f, 0.0f, 0.0f, 44.0f));
    }
    ...
    public final void T1() {
        ...
        this.H0 = null;
        TLRPC.ChatFull chatFull = this.f21760c2;
        int i11 = 2147483646;
        if (chatFull != null && chatFull.slowmode_seconds != 0 && chatFull.slowmode_next_send_date <= currentTime && ((isUploadingMessageIdDialog = SendMessagesHelper.getInstance(this.Q).isUploadingMessageIdDialog(this.P2)) || SendMessagesHelper.getInstance(this.Q).isSendingMessageIdDialog(this.P2))) {
            if (!ChatObject.hasAdminRights(this.R.getMessagesController().getChat(Long.valueOf(this.f21760c2.f18122id))) && !ChatObject.isIgnoredChatRestrictionsForBoosters(this.f21760c2)) {
                i10 = this.f21760c2.slowmode_seconds;
            ...
            int i12 = this.G0;
            if (i12 >= 2147483646) {
                if (this.f21760c2 != null) {
                    this.R.getMessagesController().loadFullChat(this.f21760c2.f18122id, 0, true);
                }
                i10 = 0;
            } else {
                i10 = i12 - currentTime;
        ...
        if (this.G0 != 0 && i10 > 0) {
            ...
            ug ugVar = this.F0;
            ugVar.f28384a.l(formatDurationNoHours, false);
            ugVar.invalidate();
            mg mgVar = this.Y2;
            if (mgVar != null) {
                mgVar.t1(ugVar, ugVar.f28384a.getText(), false);
            }
    ...
    public final void U(boolean z10) {
        ...
        this.f21883y1.addView(this.E1, w7.x5.e(44, 44, 85));
    }
    ...
    public final void V() {
        boolean z10;
        cg cgVar = this.U0;
        if (cgVar != null && cgVar.f25716c1 != UserConfig.selectedAccount) {
            this.f21816m1.removeView(cgVar);
            this.U0 = null;
        }
        if (this.U0 != null) {
            return;
        ...
        cg cgVar4 = this.U0;
        if (cgVar4 != null) {
            cgVar4.K(-this.P2, !this.f21886z0, !this.f21750b);
        }
        v();
        G();
    }
    ...
    public final void W() {
        ...
        this.S0.setBackground(org.telegram.ui.ActionBar.j6.f0(j0(org.telegram.ui.ActionBar.j6.f18953i6), 1, -1));
        this.f21887z1.addView(this.S0, w7.x5.e(44, 44, 85));
    ...
    public final void X() {
        ...
        org.telegram.ui.bo boVar = this.O2;
        if (boVar != null && boVar.getParentLayout() != null && ((ActionBarLayout) boVar.getParentLayout()).f18391b) {
        ...
        this.E0.setLinkTextColor(j0(org.telegram.ui.ActionBar.j6.f18940hc));
        this.E0.setHighlightColor(j0(org.telegram.ui.ActionBar.j6.f19184uf));
        of ofVar3 = this.E0;
        ...
        this.E0.setHandlesColor(j0(org.telegram.ui.ActionBar.j6.f19201vf));
        of ofVar4 = this.E0;
        boolean z11 = this.W3;
        if (z11) {
            f7 = 50.0f;
    ...
    public final void X0(a0.i iVar, boolean z10) {
        ...
        if (iVar.m() == 1 && ((TL_bots.BotInfo) iVar.n(0)).user_id == this.P2) {
            ...
            if (botMenuButton instanceof TL_bots.TL_botMenuButton) {
                ...
                this.f21795i0 = tL_botMenuButton.text;
                this.f21801j0 = tL_botMenuButton.url;
                this.f21820m5 = 3;
    ...
    public final void Y() {
        ...
        this.f21771e1.setFocusable(true);
        this.f21771e1.setFocusableInTouchMode(true);
        this.f21771e1.setClickable(true);
        this.f21877x1.addView(this.f21771e1, w7.x5.e(-1, 44, 80));
        ?? imageView = new ImageView(getContext());
        this.f21784g1 = imageView;
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        this.f21784g1.f(R.raw.chat_audio_record_delete_2, 28, 28, null);
        this.f21784g1.getAnimatedDrawable().f30239o0 = true;
        M1();
        this.f21784g1.setContentDescription(LocaleController.getString("Delete", R.string.Delete));
        this.f21784g1.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.f0(j0(org.telegram.ui.ActionBar.j6.f18953i6), 1, -1));
        this.f21771e1.addView(this.f21784g1, w7.x5.c(44.0f, 44));
        this.f21784g1.setOnClickListener(new sd(this, 6));
        w71 w71Var = new w71(getContext());
        this.f21778f1 = w71Var;
        w71Var.setVisibility(4);
        w71 w71Var2 = this.f21778f1;
        w71Var2.S = !this.f21885y4;
        w71Var2.setRoundFrames(true);
        this.f21778f1.setDelegate(new bf(this));
        this.f21771e1.addView(this.f21778f1, w7.x5.d(-1, -1.0f, 19, 56.0f, 0.0f, 8.0f, 0.0f));
        Context context = getContext();
        ...
        view.f28294b = context.getDrawable(R.drawable.tooltip_arrow);
        view.f28293a = org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(5.0f), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19109qf, false));
        view.b();
        view.setTime(0);
        this.f21778f1.setTimeHintView(view);
        this.l1.addView((View) view, w7.x5.d(-1, -2.0f, 80, 0.0f, 0.0f, 0.0f, 52.0f));
        hk0 hk0Var = new hk0(getContext(), this.V3);
        this.f21790h1 = hk0Var;
        this.f21771e1.addView(hk0Var, w7.x5.d(-1, 32.0f, 19, 44.0f, 0.0f, 4.0f, 0.0f));
        H1(this.P4);
    }

    public final void Y0(int i10, boolean z10, boolean z11) {
        this.f21824n2 = i10;
        if (this.f21829o2 == z10) {
            return;
        }
        this.f21829o2 = z10;
        B1(z11);
    ...
    public final void a0() {
        if (this.f21765d1 == null && getContext() != null) {
            ai.x5 x5Var = new ai.x5(getContext(), 14);
            this.f21765d1 = x5Var;
            x5Var.setClipChildren(false);
            this.f21765d1.setVisibility(8);
            this.f21877x1.addView(this.f21765d1, w7.x5.c(44.0f, -1));
            this.f21765d1.setOnTouchListener(new bi.d(12));
            ai.x5 x5Var2 = this.f21765d1;
            SlideTextView slideTextView = new SlideTextView(getContext());
            this.f21802j1 = slideTextView;
            ...
            this.f21765d1.addView(this.d, w7.x5.e(-1, -1, 16));
        }
    }
    ...
    public final void a1(MessageObject messageObject, String str, boolean z10, boolean z11) {
        ...
        if (str != null && getVisibility() == 0 && (ofVar = this.E0) != null) {
            ...
            if (z10) {
                ...
                if ((this.f21824n2 != 1 || z11) && user3 != null && user3.bot && !str.contains("@")) {
                ...
                if (!this.f21884y2 && this.f21772e2 == -1) {
                    I0();
                }
            } else if (this.G0 > 0 && !c()) {
                mg mgVar2 = this.Y2;
                if (mgVar2 != null) {
                    ug ugVar = this.F0;
                    mgVar2.t1(ugVar, ugVar.f28384a.getText(), true);
                }
            } else {
                if (messageObject != null && DialogObject.isChatDialog(this.P2)) {
                ...
                if ((this.f21824n2 != 1 || z11) && user != null && user.bot && !str.contains("@")) {
    ...
    public final void b0() {
        if (this.I1 == null && this.O2 != null) {
            ...
            mutate2.setColorFilter(new PorterDuffColorFilter(j0(org.telegram.ui.ActionBar.j6.f18980jf), mode));
            ...
            this.I1.setBackground(org.telegram.ui.ActionBar.j6.f0(j0(org.telegram.ui.ActionBar.j6.f18953i6), 1, -1));
            this.f21877x1.addView(this.I1, 2, w7.x5.e(44, 44, 85));
    ...
    public final void b1(int i10, long j3) {
        ...
        if (this.Q != i10) {
            this.K3.unlock();
            NotificationCenter.ObserversGroup observersGroup = this.f21858t4;
        ...
        this.f21886z0 = true;
        if (DialogObject.isChatDialog(this.P2)) {
            this.f21886z0 = ChatObject.canSendPlain(this.R.getMessagesController().getChat(Long.valueOf(-this.P2)));
        }
        O1(false);
        I1(false);
        K();
    ...
    public final void c0() {
        if (this.f21832p0 == null && getContext() != null) {
            ?? view = new View(getContext());
            ImageReceiver imageReceiver = new ImageReceiver(view);
            view.f29957a = imageReceiver;
            view.f29958b = new f9((org.telegram.ui.ActionBar.f6) null);
            Paint paint = new Paint(1);
            view.d = paint;
            Paint paint2 = new Paint(1);
            view.e = paint2;
            ...
            paint.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18853cf, false));
            paint2.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18834bf, false));
            int dp = AndroidUtilities.dp(18.0f);
            int l1 = org.telegram.ui.ActionBar.j6.l1(0.2f, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18863d6, false));
            ...
            this.f21832p0.setVisibility(8);
            this.f21877x1.addView(this.f21832p0, w7.x5.d(36, 36.0f, 83, 4.66f, 4.0f, 4.66f, 4.0f));
        }
    }
    ...
    public final boolean d0(TL_keyboard.KeyboardButtonProto keyboardButtonProto, MessageObject messageObject, MessageObject messageObject2, org.telegram.ui.aj ajVar) {
        ...
        if (keyboardButtonProto != null && messageObject2 != null && ((boVar = this.O2) == null || boVar.R3 != 5)) {
            ...
            if (tL_inlineButtonTypeUrl != null) {
                ...
                if (g4Var != null) {
                    g4Var.S0 = false;
                    g4Var.f28803x1.setVisibility(8);
                    g4Var.S1(false, bool);
                    return false;
                }
                ...
                if (tL_inlineButtonTypeSwitchInline != null) {
                    ...
                    if (requestPeerType != null && messageObject2.messageOwner != null) {
                        if (requestPeerType instanceof TLRPC.TL_requestPeerTypeCreateBot) {
                            ...
                            org.telegram.ui.tj0 tj0Var = org.telegram.ui.tj0.f37810u0;
                            org.telegram.ui.ActionBar.o2 R = LaunchActivity.R();
                            if (R == null || org.telegram.ui.tj0.f37810u0 != null) {
                                return false;
                            }
                            org.telegram.ui.tj0 tj0Var2 = new org.telegram.ui.tj0(R, i10, bool2, bool3, feVar);
                            tj0Var2.show();
                            org.telegram.ui.tj0.f37810u0 = tj0Var2;
                            return false;
                        } else {
    ...
    public final void d1(boolean z10, boolean z11) {
        ...
        le leVar = this.Q0;
        if (leVar != null) {
            if (this.f21866v2 == 1 || ((ieVar = this.f21771e1) != null && ieVar.getVisibility() == 0)) {
                this.h = 0.0f;
                this.f21821n = 0.0f;
                F1();
                z11 = false;
            }
            xg xgVar2 = xg.f29911f;
            xg xgVar3 = xg.e;
            if (z10 && this.f21772e2 == 0) {
                if (this.f21886z0) {
                    xgVar = xg.d;
                } else {
                    return;
            ...
            if (!this.f21886z0 && xgVar == xgVar3) {
                xgVar3 = xgVar2;
            } else if (this.f21750b || xgVar == xgVar3) {
                xgVar3 = xgVar;
            }
            leVar.j(xgVar3, z11);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.emojiLoaded) {
            ...
            if (((Integer) objArr[0]).intValue() == this.F2) {
                if (this.f21866v2 != 0 && !this.f21814l3 && !c()) {
                    this.f21814l3 = true;
            ...
            if (i10 != NotificationCenter.recordStartError && i10 != NotificationCenter.recordStopped) {
                ...
                if (i10 == NotificationCenter.recordPaused) {
                    ...
                    if (((Integer) objArr[0]).intValue() == this.F2) {
                        ...
                        if (obj instanceof VideoEditedInfo) {
                            ...
                            this.f21767d3 = videoEditedInfo;
                            String str = (String) objArr[2];
                            this.f21754b3 = str;
                            ArrayList<Bitmap> arrayList2 = (ArrayList) objArr[3];
                            this.f21796i1 = videoEditedInfo.estimatedDuration;
                            w71 w71Var = this.f21778f1;
                            if (w71Var != null) {
                                w71Var.setVideoPath(str);
                                this.f21778f1.setKeyframes(arrayList2);
                                this.f21778f1.setVisibility(0);
                                this.f21778f1.setMinProgressDiff(1000.0f / ((float) this.f21767d3.estimatedDuration));
                                y0();
                            }
                            L1(3, true);
                            L(false);
                        ...
                        this.f21747a3 = (TLRPC.TL_document) obj;
                        this.f21754b3 = (String) objArr[2];
                        ...
                        if (this.f21747a3 != null) {
                            ...
                            if (this.f21771e1 != null) {
                                ...
                                tL_message.message = "";
                                tL_message.attachPath = this.f21754b3;
                                TLRPC.TL_messageMediaDocument tL_messageMediaDocument = new TLRPC.TL_messageMediaDocument();
                                tL_message.media = tL_messageMediaDocument;
                                tL_messageMediaDocument.flags |= 3;
                                tL_messageMediaDocument.document = this.f21747a3;
                                tL_message.flags |= 768;
                                this.f21761c3 = new MessageObject(UserConfig.selectedAccount, tL_message, false, true);
                                this.f21771e1.setAlpha(1.0f);
                                this.f21771e1.setVisibility(0);
                                this.f21784g1.setVisibility(0);
                                this.f21784g1.setAlpha(0.0f);
                                this.f21784g1.setScaleY(0.0f);
                                this.f21784g1.setScaleX(0.0f);
                                int i15 = 0;
                                while (true) {
                                    if (i15 < this.f21747a3.attributes.size()) {
                                        TLRPC.DocumentAttribute documentAttribute = this.f21747a3.attributes.get(i15);
                                ...
                                int i16 = 0;
                                while (true) {
                                    if (i16 >= this.f21747a3.attributes.size()) {
                                        break;
                                    }
                                    TLRPC.DocumentAttribute documentAttribute2 = this.f21747a3.attributes.get(i16);
                                    if (documentAttribute2 instanceof TLRPC.TL_documentAttributeAudio) {
                                        byte[] bArr2 = documentAttribute2.waveform;
                                        if (bArr2 == null || bArr2.length == 0) {
                                            documentAttribute2.waveform = MediaController.getWaveform(this.f21754b3);
                                        }
                                ...
                                if (z10 && (kVar = this.f21838q1) != null) {
                                    this.f21860u1 = 0.0f;
                                    kVar.setAlpha(0.0f);
                                    kVar.setScaleX(0.0f);
                                    kVar.setScaleY(0.0f);
                                }
                                this.f21796i1 = (long) (1000.0d * d);
                                hk0 hk0Var = this.f21790h1;
                                String str2 = this.f21754b3;
                                if (!hk0Var.Q) {
                                    hk0Var.f24688r = (float) d;
                                    hk0Var.f24689s = f7;
                                    hk0Var.v = f10;
                                    hk0Var.f24690w = false;
                                    hk0Var.h.q(AndroidUtilities.formatDuration((int) Math.round(Math.max(1.0d, d)), false), false, true);
                                    hk0Var.f24686f.a(false, false);
                                    if (hk0Var.f24687n == null) {
                                        h71 h71Var = new h71();
                                        hk0Var.f24687n = h71Var;
                                        h71Var.J = new k2.u(hk0Var, 14);
                                    }
                                    hk0Var.f24687n.D(Uri.fromFile(new File(str2)), "other");
                                    hk0Var.K = 0;
                                    hk0Var.L = bArr;
                                    hk0Var.invalidate();
                                }
                                ...
                                if (z10) {
                                    ...
                                    this.f21866v2 = 1;
                                    this.M1.c(false);
                                    this.f21862u3.set(this.M1, Float.valueOf(1.0f));
                                    qg qgVar = this.N1;
                                    if (qgVar != null) {
                    ...
                    if (this.f21761c3 != null && MediaController.getInstance().isPlayingMessage(this.f21761c3)) {
                        MessageObject playingMessageObject = MediaController.getInstance().getPlayingMessageObject();
                        MessageObject messageObject = this.f21761c3;
                    ...
                    if (!((Boolean) objArr[6]).booleanValue()) {
                        ...
                        if (longValue == this.P2 && (chatFull = this.f21760c2) != null && chatFull.slowmode_seconds != 0 && !MessageObject.isEphemeralMessageId(num2.intValue()) && (chat = this.R.getMessagesController().getChat(Long.valueOf(this.f21760c2.f18122id))) != null && !ChatObject.hasAdminRights(chat) && !ChatObject.isIgnoredChatRestrictionsForBoosters(chat)) {
                            TLRPC.ChatFull chatFull2 = this.f21760c2;
                            int currentTime = ConnectionsManager.getInstance(this.Q).getCurrentTime();
                            TLRPC.ChatFull chatFull3 = this.f21760c2;
                ...
                if (i10 == NotificationCenter.recordStopped) {
                    ...
                    if (num3.intValue() == 4) {
                        i14 = 4;
                    } else if (this.f21759c1 && num3.intValue() == 5) {
                        i14 = 1;
    ...
    public final void e() {
        ...
        vg vgVar = this.Y0;
        if (vgVar != null && (textPaint = vgVar.f28712x) != null) {
            textPaint.setColor(vgVar.F.j0(org.telegram.ui.ActionBar.j6.f19054nf));
        }
        w71 w71Var = this.f21778f1;
        if (w71Var != null) {
            w71Var.e.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18807a7, false));
            w71Var.L = 0;
            u71 u71Var = w71Var.P;
            if (u71Var != null) {
                u71Var.b();
        ...
        if (numberTextView != null && this.E0 != null) {
            if (this.f21764d0 - this.f21758c0 < 0) {
                numberTextView.setTextColor(j0(org.telegram.ui.ActionBar.j6.f19083p7));
            } else {
                numberTextView.setTextColor(j0(org.telegram.ui.ActionBar.j6.f19245y6));
            }
        }
        Color.alpha(j0(org.telegram.ui.ActionBar.j6.f18834bf));
        lf lfVar = this.m0;
        if (lfVar != null) {
        ...
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.f21752b1.setColorFilter(new PorterDuffColorFilter(i10, mode));
        int i11 = org.telegram.ui.ActionBar.j6.Wk;
        ...
        leVar.setBackground(org.telegram.ui.ActionBar.j6.f0(j0(i12), 1, -1));
        ...
        imageView.setBackground(org.telegram.ui.ActionBar.j6.W(AndroidUtilities.dp(19.0f), j02, dp, dp2, dp, dp2));
    ...
    public final void e0() {
        ...
        if (messageObject != null) {
            ...
            if (needResendWhenEdit && !ChatObject.canManageMonoForum(this.Q, this.Y1.getDialogId())) {
                if (boVar == null || (of3 = boVar.f32299g5) == null) {
            ...
            if (this.f21758c0 - this.f21764d0 < 0) {
                NumberTextView numberTextView = this.f21751b0;
                ...
                if (!MessagesController.getInstance(this.Q).premiumFeaturesBlocked() && MessagesController.getInstance(this.Q).captionLengthLimitPremium > this.f21764d0) {
                    q1();
                    return;
                }
                return;
            ...
            if (!TextUtils.equals(charSequenceArr[0], this.Y1.messageText) || ((entities != null && !entities.isEmpty()) || !this.Y1.messageOwner.entities.isEmpty() || (this.Y1.messageOwner.media instanceof TLRPC.TL_messageMediaWebPage))) {
                ...
                if (boVar != null && (chat = boVar.e) != null && (((i10 = messageObject3.type) == 0 || i10 == 19) && !ChatObject.canSendEmbed(chat))) {
                    ...
                    message.flags &= -513;
                    message.media = null;
                } else if (boVar != null && (messagePreviewParams = boVar.f32287f5) != null) {
                    if (boVar.G5 instanceof TLRPC.TL_webPagePending) {
                        ...
                        this.Y1.messageOwner.media.webpage = boVar.f32287f5.webpage;
                    } else {
                ...
                if (this.Y1.needResendWhenEdit()) {
                    ...
                    if (boVar == null || (of2 = boVar.f32299g5) == null) {
    ...
    public final void f0(Canvas canvas, boolean z10) {
        ...
        int z11 = (int) com.google.android.gms.internal.vision.e2.z(1.0f, this.C4, org.telegram.ui.ActionBar.j6.f18950i3.getIntrinsicHeight(), this.S1);
        View view = this.F1;
        if (view != null && view.getVisibility() == 0) {
            z11 = (int) (((1.0f - getTopViewEnterProgress()) * this.F1.getLayoutParams().height) + z11);
        }
        int intrinsicHeight = org.telegram.ui.ActionBar.j6.f18950i3.getIntrinsicHeight() + z11;
        if (z10) {
            org.telegram.ui.ActionBar.j6.f18950i3.setAlpha((int) (this.C4 * 255.0f));
            org.telegram.ui.ActionBar.j6.f18950i3.setBounds(0, z11, getMeasuredWidth(), intrinsicHeight);
    ...
    public final boolean g0(Canvas canvas, Utilities.Callback0Return callback0Return) {
        ...
        float f11;
        float f12;
        float e = this.f21756b5.e(this.E0.canScrollVertically(-1));
        float e7 = this.f21763c5.e(this.E0.canScrollVertically(1));
        if (e <= 0.0f && e7 <= 0.0f) {
    ...
    public ei.f4 getBotWebViewButton() {
        if (this.f21806k0 == null) {
            ...
            this.f21806k0 = frameLayout;
            frameLayout.setVisibility(8);
            S();
            this.f21806k0.setBotMenuButton(this.f21812l0);
            this.f21877x1.addView(this.f21806k0, w7.x5.e(-1, -1, 80));
        }
        return this.f21806k0;
    }
    ...
    public float getSlideToCancelProgress() {
        return this.f21799i4;
    }

    public CharSequence getSlowModeTimer() {
        if (this.G0 > 0) {
            return this.F0.f28384a.getText();
        }
        return null;
    }
    ...
    public final xf h0(MessageObject messageObject, boolean z10) {
        ...
        if (z10) {
            ...
            messageObject2.caption = MessageObject.replaceAnimatedEmoji(Emoji.replaceEmoji((CharSequence) spannableStringBuilder, org.telegram.ui.ActionBar.j6.f19061o2.getFontMetricsInt(), false, (int[]) null), entities, org.telegram.ui.ActionBar.j6.f19061o2.getFontMetricsInt());
        }
    ...
    public void h1(float f7, float f10, float f11, boolean z10) {
        ...
        ieVar.setAlpha(f11);
        ImageView imageView = this.f21865v1;
        if (imageView != null) {
    ...
    public final void i1(boolean z10) {
        ...
        this.f21838q1.setVisibility(i10);
        if (z10) {
            AndroidUtilities.removeFromParent(this.H1);
        }
        if (z10) {
            this.f21752b1.setVisibility(8);
        } else {
            Q0();
        }
        if (!z10) {
    ...
    public final void l1(MessageObject messageObject, org.telegram.ui.rn rnVar, MessageObject messageObject2) {
        ...
        if (messageObject != null) {
            if (this.V2 == null && (messageObject3 = this.f21813l2) != this.S2) {
                this.V2 = messageObject3;
            }
            this.S2 = messageObject;
            this.U2 = rnVar;
            this.T2 = messageObject2;
            if (boVar == null || !boVar.f32310h4 || boVar.X3 != messageObject) {
                Z0(messageObject, true, true);
            }
        } else if (this.S2 == this.f21813l2) {
            this.S2 = null;
            this.T2 = null;
            this.U2 = null;
    ...
    public final void m1(int i10, boolean z10) {
        ...
        if (z11 != z12) {
            ValueAnimator valueAnimator = this.f21864v0;
            if (valueAnimator != null) {
                valueAnimator.removeAllListeners();
                this.f21864v0.cancel();
            }
            float f7 = 0.0f;
            if (!z10) {
                if (z11) {
                ...
                float f10 = this.f21870w0;
                if (z11) {
                    f7 = 1.0f;
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, f7);
                this.f21864v0 = ofFloat;
                ofFloat.addUpdateListener(new od(this, 4));
                this.f21864v0.addListener(new af(this, z11, 3));
                this.f21864v0.setDuration(220L);
                this.f21864v0.setInterpolator(qr.f27383f);
                this.f21864v0.start();
            }
        }
        this.Q1 = i10;
    ...
    public final void n() {
        ...
        this.f21858t4 = NotificationCenter.getInstance(this.Q).createWeakObserversGroup(this).addGlobal(NotificationCenter.emojiLoaded).add(NotificationCenter.recordStarted).add(NotificationCenter.recordPaused).add(NotificationCenter.recordResumed).add(NotificationCenter.recordStartError).add(NotificationCenter.recordStopped).add(NotificationCenter.recordProgressChanged).add(NotificationCenter.closeChats).add(NotificationCenter.audioDidSent).add(NotificationCenter.audioRouteChanged).add(NotificationCenter.messagePlayingProgressDidChanged).add(NotificationCenter.featuredStickersDidLoad).add(NotificationCenter.messageReceivedByServer2).add(NotificationCenter.sendingMessagesChanged).add(NotificationCenter.audioRecordTooShort).add(NotificationCenter.updateBotMenuButton).add(NotificationCenter.didUpdatePremiumGiftFieldIcon).add(NotificationCenter.currentUserPremiumStatusChanged);
    }
    ...
    public final void n1(boolean z10, boolean z11, boolean z12, boolean z13) {
        ...
        if ((q1Var == null || !q1Var.f19512f) && !this.f21809k3 && this.U0 != null) {
            if (z12 || this.y3 != z10) {
                this.y3 = z10;
                mg mgVar = this.Y2;
                if (mgVar != null) {
                    ...
                    if (z11) {
                        ...
                        if (this.f21769d5 == null) {
                            ((ObjectAnimator) animatorSet2.getChildAnimations().get(0)).addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                                public final ChatActivityEnterView f29649b;
                                ...
                                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                    int i11 = r3;
                                    int i12 = i10;
                                    ChatActivityEnterView chatActivityEnterView = this.f29649b;
                                    switch (i11) {
                                        case 0:
                                            int i13 = ChatActivityEnterView.f21743n5;
    ...
    public final void o(TLRPC.Document document) {
        ...
        if (cgVar != null && document != null) {
            boolean isEmpty = cgVar.f25735i1.isEmpty();
            cgVar.W();
            if (isEmpty) {
                cgVar.X(false);
            }
    ...
    public final boolean o0(boolean z10, boolean z11, boolean z12) {
        ...
        TLRPC.TL_replyKeyboardMarkup tL_replyKeyboardMarkup;
        if (u0()) {
            if (this.f21772e2 == 1 && (tL_replyKeyboardMarkup = this.f21817m2) != null && z10 && this.f21813l2 != null) {
                if (!tL_replyKeyboardMarkup.is_persistent) {
                    SharedPreferences.Editor edit = MessagesController.getMainSettings(this.Q).edit();
                    edit.putInt("closed_botkeyboard_" + getTopicKeyString(), this.f21813l2.getId()).apply();
                }
            }
    ...
    public final void o1(boolean z10, boolean z11) {
        ...
        if (this.f21868v4 != z10 || !z11) {
            ...
            if (imageView == null) {
                if (z10 || this.f21815l5) {
                    if (imageView == null) {
                        ...
                        this.f21865v1 = imageView2;
                        imageView2.setScaleType(ImageView.ScaleType.CENTER);
                        this.f21865v1.setColorFilter(new PorterDuffColorFilter(j0(org.telegram.ui.ActionBar.j6.Wk), PorterDuff.Mode.MULTIPLY));
                        this.f21865v1.setImageResource(R.drawable.input_suggest_paid_24);
                        this.f21865v1.setBackground(org.telegram.ui.ActionBar.j6.f0(j0(org.telegram.ui.ActionBar.j6.f18953i6), 1, -1));
                        if (this.f21815l5) {
                            this.f21865v1.setTranslationX(AndroidUtilities.dp(42.0f));
                            this.f21883y1.addView(this.f21865v1, w7.x5.d(44, 44.0f, 85, 0.0f, 0.0f, 50.0f, 0.0f));
                        } else {
                            this.f21828o1.addView(this.f21865v1, 0, w7.x5.n(44, 44));
                        }
                        this.f21865v1.setOnClickListener(new sd(this, 19));
                        this.f21865v1.setContentDescription(LocaleController.getString(R.string.AccDescrAttachButton));
                    }
                } else {
                    return;
                }
            }
            if (this.f21868v4 != z10) {
                z12 = true;
            } else {
                z12 = false;
            }
            ...
            this.f21865v1.setEnabled(z10);
            this.f21865v1.setClickable(z10);
            ValueAnimator valueAnimator = this.f21874w4;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                this.f21874w4 = null;
            }
            if (z11) {
                if (this.f21815l5) {
                    this.f21865v1.setVisibility(0);
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f21865v1.getAlpha(), f10);
                this.f21874w4 = ofFloat;
                ofFloat.addUpdateListener(new od(this, 7));
                this.f21874w4.addListener(new af(this, z10, 0));
                this.f21874w4.setDuration(220L);
                this.f21874w4.setInterpolator(qr.h);
                this.f21874w4.start();
            } else {
                this.f21865v1.setScaleX(f7);
                this.f21865v1.setScaleY(f7);
                this.f21865v1.setAlpha(f10);
                if (this.f21815l5) {
                    ImageView imageView3 = this.f21865v1;
                    if (!z10) {
                        i10 = 8;
                    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (c0Var != null && c0Var.getTag() != null) {
            ...
            xo0 xo0Var = this.f21832p0;
            if (xo0Var != null && xo0Var.getVisibility() == 0) {
                int i12 = this.f21832p0.getLayoutParams().width;
                this.f21832p0.measure(View.MeasureSpec.makeMeasureSpec(i12, 1073741824), View.MeasureSpec.makeMeasureSpec(this.f21832p0.getLayoutParams().height, 1073741824));
        ...
        C1();
        super.onMeasure(i10, i11);
        ei.f4 f4Var = this.f21806k0;
        if (f4Var != null) {
            ei.c0 c0Var6 = this.f21812l0;
            if (c0Var6 != null) {
                f4Var.setMeasuredButtonWidth(c0Var6.getMeasuredWidth());
            }
            this.f21806k0.getLayoutParams().height = getMeasuredHeight() - AndroidUtilities.dp(2.0f);
            measureChild(this.f21806k0, i10, i11);
        }
        N();
        O();
        if (measuredHeight > 0 && ieVar.getMeasuredHeight() != measuredHeight) {
            for (int i13 = 0; i13 < 2; i13++) {
                if (i13 == 0) {
                    imageView = this.f21850s1;
                } else {
                    imageView = this.f21855t1;
                }
    ...
    public final void p(TLRPC.Document document) {
        V();
        cg cgVar = this.U0;
        int i10 = cgVar.f25716c1;
        MediaDataController.getInstance(i10).addRecentSticker(0, null, document, (int) (System.currentTimeMillis() / 1000), false);
        boolean isEmpty = cgVar.f25738j1.isEmpty();
        cgVar.f25738j1 = MediaDataController.getInstance(i10).getRecentStickers(0, true);
        bz bzVar = cgVar.f25786y0;
        if (bzVar != null) {
            bzVar.l();
        }
        if (isEmpty) {
    ...
    public final void p0(boolean z10) {
        ...
        if (animatorSet2 == null || !animatorSet2.isRunning()) {
            ...
            he heVar = this.f21762c4;
            he heVar2 = this.Y3;
            he heVar3 = this.f21748a4;
            ...
            if (z10) {
                ...
                arrayList.add(ObjectAnimator.ofFloat(this.f21784g1, property3, 0.0f));
                arrayList.add(ObjectAnimator.ofFloat(this.f21784g1, property2, 0.0f));
                arrayList.add(ObjectAnimator.ofFloat(this.f21784g1, property, 0.0f));
                arrayList.add(ObjectAnimator.ofFloat(this.f21771e1, property3, 0.0f));
                if (kVar != null) {
                    ViewPropertyAnimator viewPropertyAnimator = this.f21833p1;
                    if (viewPropertyAnimator != null) {
                        viewPropertyAnimator.cancel();
                ...
                this.f21856t2.playTogether(arrayList);
                ei.c0 c0Var = this.f21812l0;
                if (c0Var != null) {
                    c0Var.setAlpha(0.0f);
                    this.f21812l0.setScaleY(0.0f);
                    this.f21812l0.setScaleX(0.0f);
                    this.f21856t2.playTogether(ObjectAnimator.ofFloat(this.f21812l0, property3, 1.0f), ObjectAnimator.ofFloat(this.f21812l0, property2, 1.0f), ObjectAnimator.ofFloat(this.f21812l0, property, 1.0f));
                }
                this.f21856t2.setDuration(150L);
                this.f21856t2.addListener(new we(this, 1));
            } else {
                bj0 bj0Var = this.f21784g1;
                if (bj0Var != null) {
                    bj0Var.d();
                ...
                boolean z11 = this.f21759c1;
                Property property4 = View.TRANSLATION_X;
                if (z11) {
                    arrayList2.add(ObjectAnimator.ofFloat(this.f21778f1, property3, 0.0f));
                    arrayList2.add(ObjectAnimator.ofFloat(this.f21778f1, property4, -AndroidUtilities.dp(20.0f)));
                    ...
                    of ofVar = this.E0;
                    if (ofVar != null && this.f21848s == 1.0f) {
                        ofVar.setAlpha(1.0f);
                        this.G = 0.0f;
                        J1();
                    } else {
                    ...
                    arrayList2.add(ObjectAnimator.ofFloat(this.f21790h1, property3, 0.0f));
                    arrayList2.add(ObjectAnimator.ofFloat(this.f21790h1, property4, -AndroidUtilities.dp(20.0f)));
                    qg qgVar3 = this.N1;
                    if (qgVar3 != null) {
                ...
                ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(this.f21784g1, property3, 0.0f);
                ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(this.f21784g1, property2, 0.0f);
                ObjectAnimator ofFloat5 = ObjectAnimator.ofFloat(this.f21784g1, property, 0.0f);
                ObjectAnimator ofFloat6 = ObjectAnimator.ofFloat(this.f21784g1, property3, 0.0f);
                if (this.A0) {
                    f7 = 0.5f;
                } else {
                    f7 = 1.0f;
                ...
                if (c0Var2 != null) {
                    ...
                    this.f21812l0.setScaleY(0.0f);
                    this.f21812l0.setScaleX(0.0f);
                    animatorSet5.playTogether(ObjectAnimator.ofFloat(this.f21812l0, property3, 1.0f), ObjectAnimator.ofFloat(this.f21812l0, property2, 1.0f), ObjectAnimator.ofFloat(this.f21812l0, property, 1.0f));
                }
                animatorSet5.setDuration(150L);
                animatorSet5.setStartDelay(600L);
                AnimatorSet animatorSet6 = new AnimatorSet();
                this.f21856t2 = animatorSet6;
                if (animatorSet != null) {
                    animatorSet6.playTogether(animatorSet3, animatorSet, animatorSet5);
                } else {
                    animatorSet6.playTogether(animatorSet3, animatorSet5);
                }
                this.f21856t2.addListener(new rf(this));
            }
            AnimatorSet animatorSet7 = this.f21856t2;
    ...
    public final void p1(boolean z10) {
        ...
        if (this.K4 != z11) {
            ...
            this.K4 = z11;
            ImageView imageView = this.f21850s1;
            imageView.setVisibility(0);
    ...
    public final ValueAnimator q(float f7) {
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.I1.f29903a, f7);
    ...
    public final void q0() {
        ...
        if (hk0Var != null) {
            ...
            this.f21790h1.setTranslationX(0.0f);
        }
        w71 w71Var2 = this.f21778f1;
        if (w71Var2 != null) {
            w71Var2.setAlpha(1.0f);
            this.f21778f1.setTranslationX(0.0f);
        }
        of ofVar = this.E0;
        if (ofVar != null) {
            ofVar.setAlpha(1.0f);
    ...
    public void setBotWebViewButtonOffsetX(float f7) {
        ...
        this.f21838q1.setTranslationX(this.f21881y + this.f21875x + f7);
        this.f21752b1.setTranslationX(f7);
        ze zeVar = this.f21871w1;
        if (zeVar != null) {
    ...
    public void setEditingBusinessLink(TL_account.TL_businessChatLink tL_businessChatLink) {
        ...
        if (this.a2 != null) {
            ...
            this.E1.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setDuration(150L).setInterpolator(qr.f27383f).start();
            this.f21758c0 = this.R.getMessagesController().getMaxMessageLength();
            of ofVar = this.E0;
            if (ofVar != null) {
    ...
    public void setFieldFocused(boolean z10) {
        ...
        if (this.E0 != null && !accessibilityManager.isTouchExplorationEnabled()) {
            ...
            if (ofVar != null && ofVar.isFocused()) {
                if (!this.f21884y2 || this.f21797i2) {
                    this.E0.clearFocus();
                }
            }
        }
    ...
    public void setSlideToCancelProgress(float f7) {
        ...
        this.f21853s4 = (int) ((1.0f - this.f21799i4) * (-measuredWidth));
        RecordCircle recordCircle = this.M1;
        if (recordCircle != null) {
            recordCircle.invalidate();
        }
    ...
    public final void t1(int i10, int i11, boolean z10, boolean z11) {
        ...
        if (i10 != 2) {
            ...
            if (i10 == 1) {
                ...
                if (i11 == 0) {
                    ...
                    if (cgVar2 != null && cgVar2.getVisibility() != 8) {
                        this.f21816m1.removeView(this.U0);
                        this.U0.setVisibility(8);
                        this.U0.setShowing(false);
                        this.W0 = false;
                ...
                if (this.f21872w2 <= 0) {
                    f7 = 200.0f;
                    this.f21872w2 = MessagesController.getGlobalEmojiSettings().getInt("kbd_height", AndroidUtilities.dp(200.0f));
                } else {
                    f7 = 200.0f;
                }
                if (this.f21878x2 <= 0) {
                    this.f21878x2 = MessagesController.getGlobalEmojiSettings().getInt("kbd_height_land3", AndroidUtilities.dp(f7));
                }
                Point point = AndroidUtilities.displaySize;
                if (point.x > point.y) {
                    i15 = this.f21878x2;
                ...
                if (viewGroup != null && this.f21769d5 == null) {
                ...
                if (qv0Var != null) {
                    ...
                    B1(true);
                    H0();
                    if (this.f21791h2 && !this.f21884y2 && i15 != i13 && z10) {
                ...
                if (cgVar3 != null) {
                    if (i10 == 2 && !AndroidUtilities.usingHardwareInput && !AndroidUtilities.isInMultiwindow) {
                        ...
                        this.f21816m1.removeView(this.U0);
                        this.U0 = null;
                    } else if (this.f21791h2 && !this.f21884y2 && !this.y3) {
                        this.W0 = true;
                        this.f21825n3 = 0;
                ...
                if (zfVar4 != null && zfVar4.getVisibility() == 0) {
                    if (i10 != 2 || AndroidUtilities.usingHardwareInput || AndroidUtilities.isInMultiwindow) {
                        if (this.f21791h2 && !this.f21884y2) {
                            if (this.X0) {
                                this.f21825n3 = 1;
                            }
                            AnimatorSet animatorSet3 = new AnimatorSet();
                ...
                if (i11 == 1 && this.f21813l2 != null) {
                    MessagesController.getMainSettings(this.Q).edit().putInt("closed_botkeyboard_" + getTopicKeyString(), this.f21813l2.getId()).apply();
                }
                B1(true);
                ph.f fVar2 = this.f21769d5;
                if (fVar2 != null) {
            ...
            if (this.f21873w3 || this.f21879x3) {
                L(true);
            }
            if (this.y3 && i10 != 1) {
                z12 = false;
    ...
    public final void v() {
        if (this.U0.getParent() == null) {
            if (this.f21769d5 == null) {
                this.f21816m1.addView(this.U0);
            } else {
                this.f21816m1.addView(this.U0, w7.x5.c(-1.0f, -1));
            }
        }
    }
    ...
    public final void v1(boolean z10) {
        ...
        this.L4 = z11;
        ImageView imageView = this.f21855t1;
        imageView.setVisibility(0);
        ViewPropertyAnimator animate = imageView.animate();
        float f11 = 1.0f;
        if (z11) {
    ...
    public final boolean w0() {
        if (this.E2 && ChatActivityEnterView.this.f21847r4) {
            return true;
        }
        return false;
    }
    ...
    public final boolean x() {
        ig y3 = y();
        if (!TextUtils.equals(y3.f24937a, this.f21753b2.f24937a) || !MediaDataController.entitiesEqual(this.f21753b2.f24938b, y3.f24938b)) {
            return true;
        }
        return false;
    }
    ...
    public final boolean x0() {
        if (!this.E2) {
            AnimatorSet animatorSet = this.f21851s2;
            if (animatorSet == null || !animatorSet.isRunning() || this.f21803j2) {
                return false;
            }
            return true;
        }
    ...
    public final void x1(boolean z10, boolean z11) {
        boolean z12;
        if (this.F1 != null && !this.f21773e3 && getVisibility() == 0) {
            ie ieVar = this.f21771e1;
            if ((ieVar == null || ieVar.getVisibility() != 0) && !this.G2 && this.U2 == null && (this.f21817m2 == null || this.Y1 != null)) {
                z12 = true;
            } else {
                z12 = false;
            }
            if (!z11 && z10 && z12 && !this.f21884y2 && !u0()) {
                I0();
                qd qdVar = this.V;
                if (qdVar != null) {
                    AndroidUtilities.cancelRunOnUIThread(qdVar);
    ...
    public final ig y() {
        ...
        ?? obj = new Object();
        obj.f24937a = charSequence.toString();
        obj.f24938b = entities;
        return obj;
    }
    ...
    public final void z1() {
        ...
        float f10 = this.f21881y + this.f21875x;
        ve veVar = this.J0;
        if (veVar != null) {
