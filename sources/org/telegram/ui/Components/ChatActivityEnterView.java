...
public class ChatActivityEnterView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, aw0, dy0, wy0, le.e, org.telegram.ui.ActionBar.x5 {
    public static final int f21952n5 = 0;
    public boolean A0;
    public final le A1;
    public int A2;
    public boolean A3;
    ...
    public boolean a2;
    public gg f21956a3;
    public final ke f21957a4;
    public final Matrix f21958a5;
    public boolean f21959b;
    public NumberTextView f21960b0;
    public final we f21961b1;
    public TL_account.TL_businessChatLink f21962b2;
    public TLRPC.TL_document f21963b3;
    public final ke f21964b4;
    public final e6 f21965b5;
    public org.telegram.ui.ActionBar.e1 f21966c;
    public int f21967c0;
    public boolean f21968c1;
    public kg f21969c2;
    public String f21970c3;
    public final ke f21971c4;
    public final e6 f21972c5;
    public LinearLayout d;
    public int f21973d0;
    public ai.w5 f21974d1;
    public TLRPC.ChatFull f21975d2;
    public MessageObject f21976d3;
    public final ke f21977d4;
    public ph.f f21978d5;
    public CharSequence e;
    public pr f21979e0;
    public le f21980e1;
    public boolean f21981e2;
    public VideoEditedInfo f21982e3;
    public boolean f21983e4;
    public jh.h f21984e5;
    public String f21985f;
    public Runnable f21986f0;
    public j81 f21987f1;
    public int f21988f2;
    public boolean f21989f3;
    public long f21990f4;
    public final le.f f21991f5;
    public boolean f21992g0;
    public mj0 f21993g1;
    public boolean f21994g2;
    public boolean f21995g3;
    public float f21996g4;
    public final le.c f21997g5;
    public float h;
    public boolean f21998h0;
    public sk0 f21999h1;
    public boolean f22000h2;
    public boolean f22001h3;
    public float f22002h4;
    public final le.c f22003h5;
    public String f22004i0;
    public long f22005i1;
    public boolean f22006i2;
    public MessageObject f22007i3;
    public float f22008i4;
    public final le.c f22009i5;
    public String f22010j0;
    public boolean f22011j1;
    ...
    public SlideTextView f22016k1;
    public boolean f22017k2;
    public boolean f22018k3;
    public float f22019k4;
    public float f22020k5;
    public ei.c0 f22021l0;
    public ug l1;
    public boolean f22022l2;
    public boolean f22023l3;
    public float l4;
    public boolean f22024l5;
    public of m0;
    public final bw0 f22025m1;
    public MessageObject f22026m2;
    public boolean f22027m3;
    public float f22028m4;
    public int f22029m5;
    public float f22030n;
    public ei.b0 f22031n0;
    public ViewGroup f22032n1;
    public TLRPC.TL_replyKeyboardMarkup f22033n2;
    public boolean f22034n3;
    public float f22035n4;
    public boolean f22036o0;
    public int f22037o1;
    public int f22038o2;
    public int f22039o3;
    public float f22040o4;
    public kp0 f22041p0;
    public final org.telegram.ui.xd f22042p1;
    public boolean f22043p2;
    public boolean f22044p3;
    public float f22045p4;
    public ff f22046q0;
    public ViewPropertyAnimator f22047q1;
    public PowerManager.WakeLock f22048q2;
    public boolean f22049q3;
    public float f22050q4;
    public float f22051r;
    public je f22052r0;
    public final hg.l f22053r1;
    public AnimatorSet f22054r2;
    public final bf f22055r3;
    public boolean f22056r4;
    public float f22057s;
    public int f22058s0;
    public final i0 f22059s1;
    public AnimatorSet f22060s2;
    public final jf f22061s3;
    public boolean f22062s4;
    public int f22063t0;
    public final ImageView f22064t1;
    public AnimatorSet f22065t2;
    public final org.telegram.ui.Cells.d1 f22066t3;
    public int f22067t4;
    public je f22068u0;
    public final ImageView f22069u1;
    public AnimatorSet f22070u2;
    public final uf f22071u3;
    public long f22072u4;
    public boolean v;
    public ValueAnimator f22073v0;
    public float f22074v1;
    public int f22075v2;
    public final xf f22076v3;
    public boolean f22077v4;
    public Runnable f22078w;
    public float f22079w0;
    public ImageView f22080w1;
    public int f22081w2;
    public final Paint f22082w3;
    public ValueAnimator f22083w4;
    public float f22084x;
    public boolean f22085x0;
    public cf f22086x1;
    public int f22087x2;
    public boolean f22088x3;
    public boolean f22089x4;
    public float f22090y;
    public boolean f22091y0;
    public final ne f22092y1;
    public int f22093y2;
    public boolean y3;
    public boolean f22094y4;
    public boolean f22095z0;
    public final le f22096z1;
    public boolean f22097z2;
    public boolean f22098z3;
    public boolean f22099z4;
    ...
    public class RecordCircle extends View {
        ...
        public final ba h;
        public final ba f22104n;
        public final float f22105r;
        public final float f22106s;
        public final RectF v;
        public boolean f22107w;
        public final tg f22108x;
        public int f22109y;
        ...
        public RecordCircle(Context context) {
            ...
            this.f22104n = baVar2;
            this.f22105r = AndroidUtilities.dpf2(41.0f);
            this.f22106s = AndroidUtilities.dp(30.0f);
            this.v = new RectF();
            this.H = 0.0f;
            this.I = true;
        ...
        public final void a() {
            ...
            int i10 = org.telegram.ui.ActionBar.h6.f19030bf;
        ...
        public final void b(Canvas canvas, Drawable drawable, Drawable drawable2, float f7, int i10) {
            ...
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            boolean z10 = chatActivityEnterView.f22056r4;
            if (z10 && chatActivityEnterView.f22013j4 == 1.0f) {
                chatActivityEnterView.f21961b1.setAlpha(1.0f);
                setVisibility(8);
            } else if (z10 && chatActivityEnterView.f22013j4 < 1.0f) {
        ...
        public final void c(boolean z10) {
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            if (!z10) {
                chatActivityEnterView.f22062s4 = false;
                chatActivityEnterView.l4 = -1.0f;
                chatActivityEnterView.f22019k4 = -1.0f;
                chatActivityEnterView.f22013j4 = 1.0f;
                chatActivityEnterView.f22050q4 = 1.0f;
                chatActivityEnterView.f22035n4 = 0.0f;
                chatActivityEnterView.f22008i4 = 0.0f;
            }
            invalidate();
            ...
            chatActivityEnterView.f21983e4 = false;
            this.f22103f = 0.0f;
            chatActivityEnterView.f22056r4 = false;
        ...
        public final boolean dispatchHoverEvent(MotionEvent motionEvent) {
            if (!super.dispatchHoverEvent(motionEvent) && !this.f22108x.f(motionEvent)) {
                return false;
            }
            return true;
        }
        ...
        public final void e() {
            ...
            int i10 = org.telegram.ui.ActionBar.h6.f19049cf;
            paint.setColor(chatActivityEnterView.i0(i10));
            this.h.d.setColor(i0.a.k(chatActivityEnterView.i0(i10), 38));
            this.f22104n.d.setColor(i0.a.k(chatActivityEnterView.i0(i10), 76));
            this.f22109y = chatActivityEnterView.M3.getAlpha();
        }

        public float getControlsScale() {
            return ChatActivityEnterView.this.f22008i4;
        }
        ...
        public final void onMeasure(int i10, int i11) {
            ...
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            chatActivityEnterView.f22067t4 = (int) ((1.0f - chatActivityEnterView.f22013j4) * (-measuredWidth));
        }

        public void setAmplitude(double d) {
            this.f22104n.d((float) (Math.min(1800.0d, d) / 1800.0d), true);
            this.h.d((float) (Math.min(1800.0d, d) / 1800.0d), false);
            float min = (float) (Math.min(1800.0d, d) / 1800.0d);
            this.f22101b = min;
            this.f22102c = (min - this.f22100a) / 375.0f;
            invalidate();
        }

        public void setControlsScale(float f7) {
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            chatActivityEnterView.f22008i4 = f7;
            sg sgVar = chatActivityEnterView.O1;
            if (sgVar != null) {
                sgVar.invalidate();
            }
        ...
        public void setScale(float f7) {
            ChatActivityEnterView.this.f22002h4 = f7;
            invalidate();
        }

        public void setTransformToSeekbar(float f7) {
            ChatActivityEnterView.this.f22045p4 = f7;
            invalidate();
        }
    }
    ...
    public class SlideTextView extends View {
        ...
        public final TextPaint f22110a;
        public final TextPaint f22111b;
        public final Paint f22112c;
        public final String d;
        public final String e;
        public float f22113f;
        public float h;
        public float f22114n;
        public float f22115r;
        public float f22116s;
        public float v;
        public float f22117w;
        ...
        public final void a() {
            int i10 = org.telegram.ui.ActionBar.h6.f19249nf;
            int i11 = ChatActivityEnterView.f21952n5;
            ChatActivityEnterView chatActivityEnterView = ChatActivityEnterView.this;
            int i02 = chatActivityEnterView.i0(i10);
            TextPaint textPaint = this.f22110a;
            textPaint.setColor(i02);
            int i12 = org.telegram.ui.ActionBar.h6.f19232mf;
            int i03 = chatActivityEnterView.i0(i12);
            TextPaint textPaint2 = this.f22111b;
            textPaint2.setColor(i03);
            this.f22116s = textPaint.getAlpha();
        ...
        public final void onDraw(Canvas canvas) {
            ...
            if (this.G != null && (staticLayout = this.H) != null) {
                ...
                if (chatActivityEnterView.N1 != null) {
                    ...
                    int i02 = chatActivityEnterView.i0(org.telegram.ui.ActionBar.h6.f19249nf);
                    TextPaint textPaint = this.f22110a;
                    textPaint.setColor(i02);
                    textPaint.setAlpha((int) ((1.0f - this.f22114n) * this.f22116s * this.f22115r));
                    this.f22111b.setAlpha((int) (this.v * this.f22114n));
                    int color = textPaint.getColor();
                    Paint paint = this.f22112c;
                    paint.setColor(color);
                    boolean z10 = true;
                    boolean z11 = this.N;
                    if (z11) {
                        this.f22117w = AndroidUtilities.dp(16.0f);
                    } else {
                        long currentTimeMillis = System.currentTimeMillis() - this.f22119y;
                        this.f22119y = System.currentTimeMillis();
                        if (this.f22114n == 0.0f && this.f22115r > 0.8f) {
                            if (this.f22118x) {
                                float dp3 = ((AndroidUtilities.dp(3.0f) / 250.0f) * ((float) currentTimeMillis)) + this.f22117w;
                                this.f22117w = dp3;
                                if (dp3 > AndroidUtilities.dp(6.0f)) {
                                    this.f22117w = AndroidUtilities.dp(6.0f);
                                    this.f22118x = false;
                                }
                            } else {
                                float dp4 = this.f22117w - ((AndroidUtilities.dp(3.0f) / 250.0f) * ((float) currentTimeMillis));
                                this.f22117w = dp4;
                    ...
                    int dp5 = AndroidUtilities.dp(5.0f) + ((int) ((getMeasuredWidth() - this.f22113f) / 2.0f));
                    ...
                    float f16 = dp5;
                    float f17 = this.f22117w;
                    float f18 = this.f22114n;
                    float dp6 = (((((1.0f - f18) * f17) * this.f22115r) + f16) - (f11 * f18)) + AndroidUtilities.dp(f10);
                    if (z10) {
                        dp = 0.0f;
                    } else {
                        dp = this.f22114n * AndroidUtilities.dp(12.0f);
                    }
                    if (this.f22114n != 1.0f) {
                        f12 = 12.0f;
                        int translationX = (int) ((chatActivityEnterView.N1.getTranslationX() * 0.3f) + ((1.0f - this.f22115r) * ((-getMeasuredWidth()) / 4)));
                        canvas.save();
        ...
        public final void onMeasure(int i10, int i11) {
            ...
            if (this.M != measuredHeight) {
                ...
                String str = this.d;
                TextPaint textPaint = this.f22110a;
                this.f22113f = textPaint.measureText(str);
                String str2 = this.e;
                TextPaint textPaint2 = this.f22111b;
                ...
                this.G = new StaticLayout(this.d, textPaint, (int) this.f22113f, alignment, 1.0f, 0.0f, false);
        ...
        public final boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (this.f22114n == 0.0f || !isEnabled()) {
                return false;
            }
            ...
            if (z10) {
                ...
                if (motionEvent.getAction() == 1 && rect.contains(x10, y3)) {
                    ...
                    chatActivityEnterView.f21982e3 = null;
    ...
    public ChatActivityEnterView(Activity activity, bw0 bw0Var, org.telegram.ui.wn wnVar, boolean z10, final org.telegram.ui.ActionBar.d6 d6Var) {
        super(activity);
        int i10;
        String str;
        og ogVar;
        ...
        this.f22039o3 = -1;
        this.f22049q3 = true;
        this.f22055r3 = new bf(this, 0);
        this.f22061s3 = new jf(this);
        this.f22066t3 = new org.telegram.ui.Cells.d1(Integer.class, "translationY", 1);
        this.f22071u3 = new Property(Float.class, "scale");
        this.f22076v3 = new Property(Float.class, "controlsScale");
        this.f22082w3 = new Paint(1);
        ...
        this.f21957a4 = new ke(this, 1);
        this.f21964b4 = new ke(this, 2);
        this.f21971c4 = new ke(this, 3);
        this.f21977d4 = new ke(this, 4);
        this.f22089x4 = true;
        this.f22094y4 = true;
        this.B4 = new Paint();
        this.C4 = 1.0f;
        ...
        this.f21958a5 = new Matrix();
        sr srVar = sr.h;
        this.f21965b5 = new e6(this, 0L, 280L, srVar);
        this.f21972c5 = new e6(this, 0L, 280L, srVar);
        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
        paint.setShader(linearGradient);
        sr srVar2 = ji.n.V;
        this.f21991f5 = new le.f(0, this, srVar2, 250L);
        this.f21997g5 = new le.c(1, this, srVar2, 250L, false);
        this.f22003h5 = new le.c(2, this, srVar, 320L, false);
        this.f22009i5 = new le.c(3, this, srVar, 320L, false);
        this.W3 = d6Var;
        this.X3 = z10;
        this.f22006i2 = z10 && !AndroidUtilities.isInMultiwindow && (wnVar == null || !wnVar.isInBubbleMode());
        Paint paint2 = new Paint(1);
        this.Q1 = paint2;
        paint2.setColor(i0(org.telegram.ui.ActionBar.h6.f19011af));
        setFocusable(true);
        ...
        this.f22025m1 = bw0Var;
        this.f22032n1 = bw0Var;
        ...
        imageView.setOnClickListener(new View.OnClickListener(this) {
            public final ChatActivityEnterView f24257b;
            ...
            public final void onClick(View view) {
                ...
                switch (r3) {
                    case 0:
                        ...
                        ChatActivityEnterView chatActivityEnterView = this.f24257b;
                    ...
                    default:
                        ...
                        ChatActivityEnterView chatActivityEnterView2 = this.f24257b;
                        ...
                        if (z12) {
                            if (chatActivityEnterView2.E1 != null) {
                                ...
                                e0Var.f23789k0 = new de(chatActivityEnterView2, 0);
                                ee eeVar = new ee(chatActivityEnterView2, j3, d6Var2, 0);
                                e0Var.f23790l0 = j3;
                                e0Var.f23792o0 = eeVar;
                                e0Var.show();
                                return;
                            }
                            return;
                            ...
                            e0Var2.f23788j0 = new de(chatActivityEnterView2, 1);
        ...
        if (z10) {
            ...
            if (i14 != 9) {
                ...
                this.I1 = imageView2;
                pr prVar = new pr(activity, R.drawable.input_notify_on, i12);
                this.f21979e0 = prVar;
                imageView2.setImageDrawable(prVar);
                this.f21979e0.a(this.f21994g2, false);
                if (this.f21994g2) {
                ...
                imageView2.setVisibility((!this.f22000h2 || ((ogVar = this.Z2) != null && ogVar.C0())) ? 8 : 0);
        ...
        imageView3.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                ...
                switch (r3) {
                    case 0:
                        int i142 = ChatActivityEnterView.f21952n5;
                        ChatActivityEnterView chatActivityEnterView = this.f24257b;
                        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(chatActivityEnterView.getContext(), 0, d6Var);
                        String string = LocaleController.getString(R.string.ArticleDeleteDraftTitle);
                        org.telegram.ui.ActionBar.a2 a2Var = alertDialog$Builder.f18661a;
        ...
        ?? hqVar = new hq();
        this.P1 = hqVar;
        imageView6.setImageDrawable(hqVar);
        ...
        this.F0 = wgVar;
        org.telegram.ui.ActionBar.h5 h5Var = wgVar.f29994a;
        ...
        this.f22087x2 = globalEmojiSettings.getInt("kbd_height", AndroidUtilities.dp(200.0f));
        this.f22093y2 = globalEmojiSettings.getInt("kbd_height_land3", AndroidUtilities.dp(200.0f));
        k1(false, false);
        K(false);
        F();
        W();
    ...
    public static void f(final ChatActivityEnterView chatActivityEnterView, final rv0 rv0Var, int[] iArr, ip0 ip0Var) {
        ...
        if (org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19337s8, true) == -1) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        if (i10 >= 26) {
            if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19003a7, true)) >= 0.721f) {
                z11 = true;
            } else {
                z11 = false;
            }
        ...
        if (i10 >= 23) {
            chatActivityEnterView.f22058s0 = chatActivityEnterView.getRootWindowInsets().getSystemWindowInsetLeft() + chatActivityEnterView.f22058s0;
        }
        chatActivityEnterView.f22041p0.getLocationInWindow(iArr2);
        final float f10 = iArr2[0];
        final float f11 = iArr2[1];
        float dp = AndroidUtilities.dp(5.0f);
        float dp2 = iArr[0] + chatActivityEnterView.f22058s0 + dp + AndroidUtilities.dp(4.0f) + 0.0f;
        float f12 = iArr[1] + chatActivityEnterView.f22063t0 + dp + 0.0f;
        rv0Var.setTranslationX(dp2);
        rv0Var.setTranslationY(f12);
        float f13 = chatActivityEnterView.f22041p0.getLayoutParams().width;
        if (chatActivityEnterView.f22024l5) {
            f7 = chatActivityEnterView.f22041p0.getScaleX();
        } else {
            f7 = 1.0f;
        }
        ...
        rv0Var.getViewTreeObserver().addOnDrawListener(new gf(rv0Var, ip0Var));
        dialog2.show();
        if (!chatActivityEnterView.f22024l5) {
            chatActivityEnterView.f22041p0.setScaleX(1.0f);
            chatActivityEnterView.f22041p0.setScaleY(1.0f);
        }
        chatActivityEnterView.f22041p0.setAlpha(1.0f);
        ff ffVar = chatActivityEnterView.f22046q0;
        boolean z12 = chatActivityEnterView.f22024l5;
        o1.c cVar = o1.h.f15517o;
        if (z12) {
            kVar = null;
        } else {
            o1.k kVar3 = new o1.k(chatActivityEnterView.f22041p0, cVar);
            kVar3.f15533u = org.telegram.ui.Cells.c1.l(0.5f, 750.0f, 1.0f);
            kVar = kVar3;
        }
        boolean z13 = chatActivityEnterView.f22024l5;
        ...
        if (z13) {
            ...
            dialog = dialog2;
            o1.k kVar4 = new o1.k(chatActivityEnterView.f22041p0, cVar2);
            kVar4.f15533u = org.telegram.ui.Cells.c1.l(0.5f, 750.0f, 1.0f);
            kVar2 = kVar4;
        }
        o1.k kVar5 = new o1.k(chatActivityEnterView.f22041p0, o1.h.f15522t);
        kVar5.f15533u = org.telegram.ui.Cells.c1.l(0.0f, 750.0f, 1.0f);
        final Dialog dialog3 = dialog;
        kVar5.a(new o1.f(chatActivityEnterView) {
            public final ChatActivityEnterView f30333b;

            {
                this.f30333b = chatActivityEnterView;
            }
            ...
            public final void a(o1.h hVar, boolean z14, float f14, float f15) {
                ...
                ChatActivityEnterView chatActivityEnterView2 = this.f30333b;
                switch (i11) {
                    case 0:
                        ...
                        if (dialog4.isShowing()) {
                            ...
                            kp0 kp0Var = chatActivityEnterView2.f22041p0;
                            kp0Var.getClass();
                            kp0Var.a(false, false, 0.0f);
                            if (!chatActivityEnterView2.f22024l5) {
                                chatActivityEnterView2.f22041p0.setScaleX(1.0f);
                                chatActivityEnterView2.f22041p0.setScaleY(1.0f);
                            }
                            chatActivityEnterView2.f22041p0.setAlpha(1.0f);
                            chatActivityEnterView2.f22041p0.getViewTreeObserver().addOnPreDrawListener(new hf(chatActivityEnterView2, dialog4, 0));
                            return;
                        }
                        return;
                    default:
                        ...
                        if (dialog4.isShowing()) {
                            rv0Var2.setTranslationX(f17);
                            rv0Var2.setTranslationY(f16);
                            kp0 kp0Var2 = chatActivityEnterView2.f22041p0;
                            kp0Var2.getClass();
                            ...
                            chatActivityEnterView2.f22041p0.setAlpha(1.0f);
                            chatActivityEnterView2.f22041p0.getViewTreeObserver().addOnPreDrawListener(new hf(chatActivityEnterView2, dialog4, 1));
                            return;
                        }
                        return;
                }
        ...
        o1.k kVar6 = new o1.k(rv0Var, o1.h.f15515m);
        ...
        o1.k kVar7 = new o1.k(rv0Var, o1.h.f15516n);
    ...
    public static void g(ChatActivityEnterView chatActivityEnterView, TLRPC.Document document, String str, MessageObject.SendAnimationData sendAnimationData, boolean z10, int i10, int i11, Object obj, Long l4, boolean z11) {
        ...
        if (chatActivityEnterView.G0 > 0 && !chatActivityEnterView.c()) {
            ...
            if (ogVar != null) {
                ...
                ogVar.t1(wgVar, wgVar.f29994a.getText(), true);
                return;
            }
            return;
        }
    ...
    public static void h(ChatActivityEnterView chatActivityEnterView, TL_keyboard.KeyboardButton keyboardButton) {
        ...
        if (chatActivityEnterView.T2 != null && (wnVar = chatActivityEnterView.P2) != null && wnVar.f39498h4 && wnVar.d() == chatActivityEnterView.T2.getId()) {
            z10 = true;
        } else {
            z10 = false;
        }
        if ((chatActivityEnterView.T2 != null && !z10) || BotForumHelper.isBotForum(chatActivityEnterView.Q, chatActivityEnterView.Q2)) {
            ...
            messageObject = chatActivityEnterView.f22026m2;
        } else {
            messageObject = null;
        }
        MessageObject messageObject2 = chatActivityEnterView.T2;
        if (messageObject2 == null || z10) {
            messageObject2 = chatActivityEnterView.f22026m2;
        }
        ...
        if (chatActivityEnterView.T2 != null && !z10) {
            ...
            MessageObject messageObject3 = chatActivityEnterView.f22026m2;
            if (messageObject3 != null && messageObject3.messageOwner.reply_markup.single_use) {
                ...
                MessagesController.getMainSettings(chatActivityEnterView.Q).edit().putInt("answered_" + chatActivityEnterView.getTopicKeyString(), chatActivityEnterView.f22026m2.getId()).commit();
            }
        }
        og ogVar = chatActivityEnterView.Z2;
        if (ogVar != null) {
    ...
    public static void i(ChatActivityEnterView chatActivityEnterView, MessageObject messageObject, TL_keyboard.KeyboardButtonProto keyboardButtonProto) {
        ...
        if (Build.VERSION.SDK_INT >= 23 && activity.checkSelfPermission("android.permission.ACCESS_COARSE_LOCATION") != 0) {
            ...
            chatActivityEnterView.f22007i3 = messageObject;
    ...
    public static void m(ChatActivityEnterView chatActivityEnterView) {
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(chatActivityEnterView, "lockAnimatedTranslation", chatActivityEnterView.f22019k4);
        ...
        animatorSet.playTogether(ofFloat2, ofFloat, ObjectAnimator.ofFloat(chatActivityEnterView, "slideToCancelProgress", 1.0f).setDuration(200L), ObjectAnimator.ofFloat(chatActivityEnterView.f22016k1, "cancelToProgress", 1.0f));
        animatorSet.start();
    }
                    ...
                    if (messageEntity.offset + messageEntity.length <= spannableStringBuilder.length()) {
                        if (messageEntity instanceof TLRPC.TL_inputMessageEntityMentionName) {
                            ...
                            if (messageEntity instanceof TLRPC.TL_messageEntityBold) {
                                ...
                                obj7.f23183b = i22;
                                obj7.f23184c = i22 + messageEntity.length;
                                obj7.d = messageEntity;
                                int i23 = messageEntity.offset;
                                j10 j10Var = new j10(spannableStringBuilder.subSequence(i23, messageEntity.length + i23).toString(), obj7, (TLRPC.TL_messageEntityFormattedDate) messageEntity);
                                int i24 = messageEntity.offset;
                                spannableStringBuilder.setSpan(j10Var, i24, messageEntity.length + i24, 33);
        ...
        if (arrayList != null) {
            ...
            while (it.hasNext()) {
                ...
                if (i30 != intValue) {
                    ...
                    if (i31 > 0) {
                        ej0.c(spannableStringBuilder, i30, i33, z10);
                    }
                    i30 = intValue + 1;
            ...
            if (i30 < spannableStringBuilder.length() && i31 > 0) {
                ej0.c(spannableStringBuilder, i30, spannableStringBuilder.length(), z10);
            }
        }
    ...
    public final void A() {
        int i10;
        if (this.f21981e2 && this.f21968c1) {
    ...
    public final void A1() {
        int i10;
        z1();
        org.telegram.ui.xd xdVar = this.f22042p1;
        if (xdVar != null) {
            xdVar.setTranslationX(this.f22090y + this.f22084x);
            ...
            hg.l lVar = this.f22053r1;
            if (lVar != null && this.A4) {
                lVar.setAlpha(this.f22074v1 * this.F);
            }
        }
        af afVar = this.J1;
        if (afVar != null) {
    ...
    public final void B() {
        cf cfVar;
        org.telegram.ui.wn wnVar;
        if (this.L == null && (cfVar = this.K1) != null && cfVar.getRight() != 0 && (wnVar = this.P2) != null && BirthdayController.isToday(wnVar.f39414a8)) {
            ...
            if (mainSettings.getBoolean(Calendar.getInstance().get(1) + "bdayhint_" + wnVar.a(), true)) {
                ...
                this.L.m(1.0f, -((getWidth() - AndroidUtilities.dp(12.0f)) - ((this.K1.getMeasuredWidth() / 2.0f) + (this.K1.getX() + (this.f22042p1.getX() + this.f22092y1.getX())))));
    ...
    public final void B0() {
        ...
        if (this.f21999h1 != null && this.f21963b3 != null) {
            ...
            sk0 sk0Var2 = this.f21999h1;
            if (sk0Var2 == null) {
                audioLeft = 0.0f;
            } else {
                audioLeft = sk0Var2.getAudioLeft();
            }
            sk0 sk0Var3 = this.f21999h1;
            if (sk0Var3 == null) {
                audioRight = 1.0f;
            } else {
        ...
        PowerManager.WakeLock wakeLock = this.f22048q2;
        if (wakeLock != null) {
            try {
                wakeLock.release();
                this.f22048q2 = null;
        ...
        bw0 bw0Var = this.f22025m1;
        if (bw0Var != null) {
            bw0Var.setDelegate(null);
        }
        ff ffVar = this.f22046q0;
        if (ffVar != null) {
            ffVar.e = false;
            ffVar.dismiss();
        }
    ...
    public final void C1() {
        ...
        if (ofVar != null) {
            ...
            } else if (this.f22031n0.f8224c.size() > 4) {
                b10 = org.telegram.messenger.f0.b(162.8f, bw0Var.getMeasuredHeight(), 0);
            } else {
                b10 = org.telegram.messenger.f0.b((Math.max(1, Math.min(4, this.f22031n0.f8224c.size())) * 36) + 8, bw0Var.getMeasuredHeight(), 0);
            }
    ...
    public final void E() {
        boolean z10;
        qf qfVar = this.E0;
        if ((qfVar == null || TextUtils.isEmpty(qfVar.getText())) && !this.f22097z2 && !this.f22018k3 && !t0()) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final void E0() {
        ...
        if (!j0() || !v()) {
            getVisibility();
            if (this.f22022l2 && !org.telegram.ui.ActionBar.m2.hasSheets(this.P2)) {
                this.f22022l2 = false;
                og ogVar = this.Z2;
                if (ogVar != null) {
                    ogVar.r1();
                ...
                if (!AndroidUtilities.usingHardwareInput && !this.f22097z2 && !AndroidUtilities.isInMultiwindow) {
                    this.f22018k3 = true;
                    bf bfVar = this.f22055r3;
    ...
    public final void F1() {
        float f7 = this.f22051r * this.h;
        oe oeVar = this.Q0;
        oeVar.setScaleX(f7);
        oeVar.setScaleY(this.f22051r * this.h);
        oeVar.setAlpha(this.f22057s * this.f22030n);
    }
    ...
    public final void G0() {
        int height = this.f22025m1.getHeight();
        if (!this.f22097z2) {
            height -= this.A2;
        }
        og ogVar = this.Z2;
    ...
    public final void G1(boolean z10) {
        ...
        if (qfVar != null) {
            ...
            if (i10 == 9) {
                ...
                if (z11) {
                    if (j3 > 0) {
                        formatString = yh.w7.Q0(LocaleController.formatString(R.string.SuggestPostForStars, LocaleController.formatNumber((int) j3, ','), qqVarArr));
                    } else {
                    ...
                    if (messageObject2 != null && (replyMarkup2 = messageObject2.messageOwner.reply_markup) != null && !TextUtils.isEmpty(replyMarkup2.placeholder)) {
                        ...
                        this.E0.setHintText(yh.w7.V0(false, LocaleController.formatString(R.string.TypeMessageForStars, LocaleController.formatNumber((int) j3, ',')), qqVarArr));
                        qq qqVar2 = qqVarArr[0];
                        if (qqVar2 != null) {
                            qqVar2.spaceScaleX = 0.9f;
                        }
                    } else if (this.X0 && (messageObject = this.f22026m2) != null && (replyMarkup = messageObject.messageOwner.reply_markup) != null && !TextUtils.isEmpty(replyMarkup.placeholder)) {
                        this.E0.setHintText(this.f22026m2.messageOwner.reply_markup.placeholder, z10);
                        ...
                        TLRPC.TL_forumTopic findTopic = MessagesController.getInstance(this.Q).getTopicsController().findTopic(wnVar.e.f18335id, 1L);
                        ...
                        if (user != null && user.bot_forum_view && !user.bot_forum_can_manage_topics && wnVar != null && !wnVar.f39498h4) {
                            this.E0.setHintText(LocaleController.getString(R.string.SendBotNoThread));
                        } else if (wnVar != null && wnVar.F9() && !wnVar.f39498h4) {
                            if (wnVar.X3 != null && wnVar.f39487g4) {
    ...
    public final void H(int i10, boolean z10) {
        ...
        if (i10 > AndroidUtilities.dp(50.0f) && this.f22097z2 && !AndroidUtilities.isInMultiwindow) {
            if (z10) {
                this.f22093y2 = i10;
                MessagesController.getGlobalEmojiSettings().edit().putInt("kbd_height_land3", this.f22093y2).commit();
            } else {
                this.f22087x2 = i10;
                MessagesController.getGlobalEmojiSettings().edit().putInt("kbd_height", this.f22087x2).commit();
            }
        }
        if (this.f22097z2 && this.W0 && this.U0 == null) {
            this.W0 = false;
        }
        boolean t02 = t0();
        bw0 bw0Var = this.f22025m1;
        ...
        if (t02) {
            ...
            if (bgVar2 != null) {
                ...
                ph.f fVar2 = this.f21978d5;
                if (fVar2 != null && i11 > 0 && this.f21988f2 == 1) {
                    ((ph.i) fVar2).g(i11);
                }
            }
            if (view != null) {
                FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) view.getLayoutParams();
                if (!this.A3 && !this.f22098z3 && (((i12 = layoutParams.width) != (i13 = AndroidUtilities.displaySize.x) || layoutParams.height != i11) && ((fVar = this.f21978d5) == null || i12 != -1 || layoutParams.height != -1))) {
                    if (fVar == null) {
                    ...
                    if (bw0Var != null) {
                        ...
                        G0();
                        if (this.f22006i2 && !this.f22097z2 && i15 != this.A2 && N0()) {
                            AnimatorSet animatorSet = new AnimatorSet();
                            this.V0 = animatorSet;
                            if (this.f21978d5 != null) {
                            ...
                            this.V0.setInterpolator(org.telegram.ui.ActionBar.o1.f19668w);
        ...
        this.f22097z2 = z11;
        E();
        if (this.f22097z2 && t0() && this.B3 == null) {
            t1(0, this.f21988f2, true, true);
        } else if (!this.f22097z2 && !t0() && (messageObject = this.f22026m2) != null && this.T2 != messageObject && !j0() && !v() && !org.telegram.ui.ActionBar.m2.hasSheets(wnVar) && (((qfVar = this.E0) == null || TextUtils.isEmpty(qfVar.getText())) && (tL_replyKeyboardMarkup = this.f22033n2) != null && !tL_replyKeyboardMarkup.rows.isEmpty())) {
            org.telegram.ui.ActionBar.o1 o1Var = bw0Var.H;
            if (o1Var.f19672f) {
                o1Var.j();
            } else {
                o1Var.v = true;
        ...
        if (this.A2 != 0 && !(z12 = this.f22097z2) && z12 != z14 && !t0()) {
            this.A2 = 0;
            bw0Var.requestLayout();
        }
        if (this.f22097z2 && this.f22018k3) {
            this.f22018k3 = false;
            if (this.f22044p3) {
                this.f22044p3 = false;
                this.H1.setButtons(this.f22033n2);
            }
            AndroidUtilities.cancelRunOnUIThread(this.f22055r3);
        }
        G0();
    }
        ...
        if (this.E0 != null) {
            ...
            if (messageObject == null || messageObject.needResendWhenEdit()) {
                ...
                if (z10 && this.f22024l5) {
                    ...
                    cf cfVar = this.f22086x1;
                    if (cfVar != null && cfVar.getVisibility() == 0 && (afVar2 = this.J1) != null && afVar2.getVisibility() == 0 && (lVar = this.f22053r1) != null && lVar.getVisibility() == 0) {
                        layoutParams.rightMargin = AndroidUtilities.dp(146.0f);
                    } else {
                        cf cfVar2 = this.f22086x1;
    ...
    public final void I0() {
        ...
        if (!j0() || !v()) {
            ...
            if (!org.telegram.ui.ActionBar.m2.hasSheets(wnVar)) {
                if (!AndroidUtilities.usingHardwareInput && !AndroidUtilities.isInMultiwindow && ((wnVar == null || !wnVar.isInBubbleMode()) && !this.f22012j2)) {
                    i10 = 2;
                } else {
                    i10 = 0;
                }
                ...
                if (this.f22012j2) {
                    this.f22022l2 = true;
                } else if (!AndroidUtilities.usingHardwareInput && !this.f22097z2 && !AndroidUtilities.isInMultiwindow) {
    ...
    public final void J() {
        ...
        if (DialogObject.isChatDialog(this.Q2)) {
            ...
            this.f22085x0 = ChatObject.canSendRoundVideo(chat);
            this.f22091y0 = ChatObject.canSendVoice(chat);
        } else {
            z10 = false;
        }
        ...
        if (!this.f22085x0 && z11) {
            z11 = false;
        }
        if (!this.f22091y0 && !z11) {
            if (!this.f21981e2) {
                z12 = false;
            }
        } else {
    ...
    public final void K1(TLRPC.Chat chat, TLRPC.UserFull userFull) {
        ...
        float f10 = 1.0f;
        if (chat != null) {
            if (!ChatObject.canSendVoice(chat) && (!ChatObject.canSendRoundVideo(chat) || !this.f21981e2)) {
                z10 = true;
            } else {
                z10 = false;
            }
            ...
            if (!this.A0 && (egVar = this.U0) != null) {
                egVar.K(-this.Q2, !this.f22095z0, !this.f21959b);
            }
            this.f22085x0 = ChatObject.canSendRoundVideo(chat);
            this.f22091y0 = ChatObject.canSendVoice(chat);
    ...
    public final void L() {
        ...
        if (this.U0 != null) {
            ...
            int dp = ((((this.f22037o1 - AndroidUtilities.statusBarHeight) - AndroidUtilities.navigationBarHeight) - AndroidUtilities.dp(6.0f)) - org.telegram.ui.ActionBar.k.getCurrentActionBarHeight()) - getHeight();
            if (this.R1 == 2) {
            ...
            if (i11 != dp) {
                ...
                this.D3 = dp;
                org.telegram.ui.Cells.d1 d1Var = this.f22066t3;
                if (i11 > dp) {
                    ...
                    if (this.v) {
                        ...
                        animatorSet2.setInterpolator(sr.f28339f);
                    ...
                    animatorSet3.setInterpolator(sr.f28339f);
                    animatorSet3.addListener(new ze(this, 11));
                    this.B3 = animatorSet3;
                    this.U0.setLayerType(2, null);
                    animatorSet3.start();
                }
                ph.f fVar = this.f21978d5;
                if (fVar != null) {
                    ((ph.i) fVar).g(dp);
                }
            }
    ...
    public void L1(int i10, boolean z10) {
        ...
        if (z14) {
            ...
            if (z15) {
                ...
                sg sgVar = this.O1;
                if (sgVar != null) {
                    sgVar.f28279y.d(1, false, false);
                }
                MediaDataController mediaDataController = MediaDataController.getInstance(this.Q);
                long j10 = this.Q2;
                org.telegram.ui.wn wnVar = this.P2;
                property = property3;
                mediaDataController.toggleDraftVoiceOnce(j10, (wnVar == null || !wnVar.f39498h4) ? 0L : wnVar.d(), this.O);
                this.f22005i1 = 0L;
            }
            X();
            this.f22081w2 = 1;
            ...
            AnimatorSet animatorSet = this.f22065t2;
            if (animatorSet != null) {
                animatorSet.cancel();
            }
            AnimatorSet animatorSet2 = this.f22070u2;
            if (animatorSet2 != null) {
                animatorSet2.cancel();
            }
            Z();
            ai.w5 w5Var = this.f21974d1;
            if (w5Var != null) {
            ...
            if (ugVar != null) {
                ugVar.f28805a = 1.0f;
                ugVar.f28806b = System.currentTimeMillis();
                ugVar.f28810r = -1L;
                ugVar.f28807c = false;
                ugVar.e = false;
                ugVar.f28808f.stop();
            ...
            this.f22065t2 = new AnimatorSet();
            this.Y0.setTranslationX(AndroidUtilities.dp(20.0f));
            this.Y0.setAlpha(0.0f);
            if (this.Q4 != 3) {
                this.f22016k1.setTranslationX(AndroidUtilities.dp(20.0f));
                this.f22016k1.setAlpha(0.0f);
                this.f22016k1.setCancelToProgress(0.0f);
                SlideTextView slideTextView = this.f22016k1;
                slideTextView.f22115r = 1.0f;
                slideTextView.setEnabled(true);
            } else {
                this.f22016k1.setTranslationX(0.0f);
                this.f22016k1.setAlpha(0.0f);
                this.f22016k1.setCancelToProgress(1.0f);
                this.f22016k1.setEnabled(true);
            }
            this.N1.c(this.Q4 == 3);
            this.f22017k2 = false;
            x0();
            ...
            animatorSet3.playTogether(ObjectAnimator.ofFloat(this.Q0, this.Z3, 0.0f), ObjectAnimator.ofFloat(this.Q0, this.f21964b4, 0.0f), ObjectAnimator.ofFloat(this.l1, property4, 1.0f), ObjectAnimator.ofFloat(this.l1, property6, 1.0f), ObjectAnimator.ofFloat(this.Y0, property2, 0.0f), ObjectAnimator.ofFloat(this.Y0, property5, 1.0f));
            animatorSet3.playTogether(ObjectAnimator.ofFloat(this.f22016k1, property2, 0.0f));
            animatorSet3.playTogether(ObjectAnimator.ofFloat(this.f22016k1, property5, 1.0f));
            sg sgVar3 = this.O1;
            if (sgVar3 != null) {
            ...
            animatorSet4.playTogether(ObjectAnimator.ofFloat(this.E0, this.f21977d4, AndroidUtilities.dp(20.0f)), ObjectAnimator.ofFloat(this.E0, property5, 0.0f), ObjectAnimator.ofFloat(this.f21980e1, property5, 1.0f));
            if (z15) {
            ...
            org.telegram.ui.xd xdVar = this.f22042p1;
            if (xdVar != null) {
                animatorSet4.playTogether(ObjectAnimator.ofFloat(xdVar, this.f21971c4, AndroidUtilities.dp(30.0f)), ObjectAnimator.ofFloat(this.f22042p1, this.f21957a4, 0.0f));
                ViewPropertyAnimator viewPropertyAnimator = this.f22047q1;
                ...
                hg.l lVar = this.f22053r1;
                this.f22074v1 = 0.0f;
                animatorSet4.playTogether(ObjectAnimator.ofFloat(lVar, property5, 0.0f), ObjectAnimator.ofFloat(this.f22053r1, property6, 0.5f), ObjectAnimator.ofFloat(this.f22053r1, property4, 0.5f));
            }
            jh.h hVar = this.f21984e5;
            if (hVar != null) {
                hVar.e(0, false, true);
            }
            this.f22065t2.playTogether(animatorSet3.setDuration(150L), animatorSet4.setDuration(150L), ObjectAnimator.ofFloat(this.N1, this.f22071u3, 1.0f).setDuration(300L));
            if (!z15) {
                this.f22065t2.playTogether(ObjectAnimator.ofFloat(this.N1, this.f22076v3, 1.0f).setDuration(300L));
            }
            this.f22065t2.addListener(new vf(this, z15));
            this.f22065t2.setInterpolator(new DecelerateInterpolator());
            this.f22065t2.start();
            this.Y0.a(this.f22005i1);
        } else if (this.f22017k2 && i10 == 3) {
            return;
        } else {
            PowerManager.WakeLock wakeLock = this.f22048q2;
            if (wakeLock != null) {
            ...
            AnimatorSet animatorSet5 = this.f22065t2;
            if (animatorSet5 != null) {
                ...
                this.f22065t2.removeAllListeners();
                this.f22065t2.cancel();
            } else {
                z11 = false;
            }
            AnimatorSet animatorSet6 = this.f22070u2;
            ...
            this.f22065t2 = new AnimatorSet();
            if (z11 || i10 == 4) {
                we weVar2 = this.f21961b1;
                if (weVar2 != null) {
                    weVar2.setVisibility(0);
                }
                this.f22065t2.playTogether(ObjectAnimator.ofFloat(this.Q0, this.Z3, 1.0f), ObjectAnimator.ofFloat(this.Q0, this.f21964b4, this.A0 ? 0.5f : 1.0f), ObjectAnimator.ofFloat(this.l1, property4, 0.0f), ObjectAnimator.ofFloat(this.l1, property3, 0.0f), ObjectAnimator.ofFloat(this.N1, this.f22071u3, 0.0f), ObjectAnimator.ofFloat(this.N1, this.f22076v3, 0.0f), ObjectAnimator.ofFloat(this.Z0, property5, 1.0f), ObjectAnimator.ofFloat(this.Y0, property5, 0.0f), ObjectAnimator.ofFloat(this.Z0, property5, 1.0f), ObjectAnimator.ofFloat(this.E0, property5, 1.0f), ObjectAnimator.ofFloat(this.E0, this.f21977d4, 0.0f), ObjectAnimator.ofFloat(this, "slideToCancelProgress", 1.0f));
                sg sgVar4 = this.O1;
                if (sgVar4 != null) {
                    i11 = 1;
                    c10 = 0;
                    this.f22065t2.playTogether(ObjectAnimator.ofFloat(sgVar4, property5, 0.0f));
                    this.O1.a();
                } else {
                    i11 = 1;
                    c10 = 0;
                ...
                if (c0Var2 != null) {
                    AnimatorSet animatorSet7 = this.f22065t2;
                ...
                we weVar3 = this.f21961b1;
                if (weVar3 != null) {
                    weVar3.setScaleX(f7);
                    this.f21961b1.setScaleY(f7);
                    i12 = 1;
                    this.f22065t2.playTogether(ObjectAnimator.ofFloat(this.Z0, property5, f7));
                    this.f21961b1.j(s0() ? zgVar2 : zgVar, true);
                } else {
                    i12 = 1;
                }
                if (this.J1 != null) {
                    AnimatorSet animatorSet8 = this.f22065t2;
                ...
                if (this.f22042p1 != null) {
                    ViewPropertyAnimator viewPropertyAnimator2 = this.f22047q1;
                    ...
                    z12 = true;
                    r10 = 0;
                    this.f22065t2.playTogether(ObjectAnimator.ofFloat(this.f22042p1, this.f21971c4, 0.0f), ObjectAnimator.ofFloat(this.f22042p1, this.f21957a4, 1.0f));
                    AnimatorSet animatorSet9 = this.f22065t2;
                    hg.l lVar2 = this.f22053r1;
                    this.f22074v1 = 1.0f;
                    animatorSet9.playTogether(ObjectAnimator.ofFloat(lVar2, property5, 1.0f), ObjectAnimator.ofFloat(this.f22053r1, property3, 1.0f), ObjectAnimator.ofFloat(this.f22053r1, property4, 1.0f));
                } else {
                    r10 = 0;
                    z12 = true;
                }
                jh.h hVar2 = this.f21984e5;
                if (hVar2 != 0) {
                    hVar2.e(r10, r10, z12);
                }
                this.f22017k2 = z12;
                x0();
                this.f22065t2.setDuration(150L);
            } else if (i10 == 3) {
                X();
                Y();
                SlideTextView slideTextView2 = this.f22016k1;
                ...
                this.f22062s4 = z13;
                this.f22035n4 = f11;
                this.l4 = this.f22019k4;
                this.f22013j4 = f11;
                SlideTextView slideTextView3 = this.f22016k1;
                ...
                mj0 mj0Var2 = this.f21993g1;
                if (mj0Var2 != null) {
                    mj0Var2.setAlpha(0.0f);
                ...
                if (!s0() && !this.f22099z4) {
                    ...
                    this.f22025m1.addView(this.f21980e1, layoutParams2);
                ...
                if (!z10) {
                    Z();
                    this.f22071u3.set(this.N1, Float.valueOf(1.0f));
                    this.N1.setTransformToSeekbar(1.0f);
                    if (!s0()) {
                        float f12 = this.f22045p4;
                        if (f12 != 0.0f && this.f21999h1 != null) {
                            this.f21999h1.setAlpha(sr.f28342j.getInterpolation(Math.max(0.0f, ((f12 - 0.38f) - 0.25f) / 0.37f)));
                    ...
                    this.f21964b4.set(this.Q0, valueOf);
                    this.E0.setAlpha(0.0f);
                    we weVar4 = this.f21961b1;
                    if (weVar4 != null) {
                        if (s0()) {
                            zgVar = zgVar2;
                        }
                    ...
                    if (viewGroup != null) {
                        this.f22025m1.removeView(this.f21980e1);
                    ...
                    animatorSet11.playTogether(ObjectAnimator.ofFloat(this.l1, property4, 0.0f), ObjectAnimator.ofFloat(this.l1, property3, 0.0f), ObjectAnimator.ofFloat(this.Y0, property5, 0.0f), ObjectAnimator.ofFloat(this.Y0, property2, -AndroidUtilities.dp(20.0f)), ObjectAnimator.ofFloat(this.f22016k1, property5, 0.0f), ObjectAnimator.ofFloat(this.f21993g1, property5, 1.0f), ObjectAnimator.ofFloat(this.f21993g1, property4, 1.0f), ObjectAnimator.ofFloat(this.f21993g1, property3, 1.0f), ObjectAnimator.ofFloat(this.Q0, this.Z3, 0.0f), ObjectAnimator.ofFloat(this.Q0, this.f21964b4, 0.0f), ObjectAnimator.ofFloat(this.E0, property5, 0.0f));
                    mj0 mj0Var3 = this.f21993g1;
                    if (mj0Var3 != null) {
                        mj0Var3.setAlpha(0.0f);
                        this.f21993g1.setScaleX(0.0f);
                        this.f21993g1.setScaleY(0.0f);
                    }
                    if (this.f21961b1 != null) {
                    ...
                    AnimatorSet animatorSet12 = this.f22065t2;
                    ...
                    this.f22065t2.addListener(new ai.y4(this, viewGroup, layoutParams, 2));
                }
            } else if (i10 != 2 && i10 != 5) {
                we weVar5 = this.f21961b1;
                if (weVar5 != null) {
                    weVar5.setVisibility(0);
                }
                AnimatorSet animatorSet13 = new AnimatorSet();
                animatorSet13.playTogether(ObjectAnimator.ofFloat(this.Q0, this.Z3, 1.0f), ObjectAnimator.ofFloat(this.Q0, this.f21964b4, this.A0 ? 0.5f : 1.0f), ObjectAnimator.ofFloat(this.l1, property4, 0.0f), ObjectAnimator.ofFloat(this.l1, property3, 0.0f), ObjectAnimator.ofFloat(this.Z0, property5, 1.0f));
                sg sgVar6 = this.O1;
                if (sgVar6 != null) {
                ...
                if (this.f22042p1 != null) {
                    ViewPropertyAnimator viewPropertyAnimator3 = this.f22047q1;
                    ...
                    i15 = 1;
                    r103 = 0;
                    animatorSet13.playTogether(ObjectAnimator.ofFloat(this.f22042p1, this.f21957a4, 1.0f));
                    hg.l lVar3 = this.f22053r1;
                    this.f22074v1 = 1.0f;
                    animatorSet13.playTogether(ObjectAnimator.ofFloat(lVar3, property5, 1.0f), ObjectAnimator.ofFloat(this.f22053r1, property3, 1.0f), ObjectAnimator.ofFloat(this.f22053r1, property4, 1.0f));
                } else {
                    r103 = 0;
                    i15 = 1;
                }
                jh.h hVar3 = this.f21984e5;
                if (hVar3 != 0) {
                ...
                ofFloat15.setStartDelay(this.f22057s == 1.0f ? 150L : 450L);
                ofFloat15.setDuration(200L);
                this.f22065t2.playTogether(animatorSet13, animatorSet14, ofFloat15, ofFloat14);
            } else {
                we weVar7 = this.f21961b1;
                if (weVar7 != null) {
                ...
                animatorSet15.playTogether(ObjectAnimator.ofFloat(this.Q0, this.Z3, 1.0f), ObjectAnimator.ofFloat(this.Q0, this.f21964b4, this.A0 ? 0.5f : 1.0f), ObjectAnimator.ofFloat(this.l1, property4, 0.0f), ObjectAnimator.ofFloat(this.l1, property3, 0.0f));
                sg sgVar7 = this.O1;
                if (sgVar7 != null) {
                ...
                animatorSet16.playTogether(ObjectAnimator.ofFloat(this.Y0, property5, 0.0f), ObjectAnimator.ofFloat(this.Y0, property2, -AndroidUtilities.dp(20.0f)), ObjectAnimator.ofFloat(this.f22016k1, property5, 0.0f), ObjectAnimator.ofFloat(this.f22016k1, property2, -AndroidUtilities.dp(20.0f)));
                if (i10 != 5) {
                    this.Z0.setScaleX(0.0f);
                    this.Z0.setScaleY(0.0f);
                    hg.l lVar4 = this.f22053r1;
                    if (lVar4 != null && lVar4.getVisibility() == 0) {
                        this.f22053r1.setScaleX(0.5f);
                        this.f22053r1.setScaleY(0.5f);
                    }
                    cf cfVar = this.f22086x1;
                    if (cfVar != null && cfVar.getVisibility() == 0) {
                        this.f22086x1.setScaleX(0.0f);
                        this.f22086x1.setScaleY(0.0f);
                    }
                    ...
                    if (this.f22042p1 != null) {
                        ViewPropertyAnimator viewPropertyAnimator4 = this.f22047q1;
                        ...
                        i14 = 1;
                        r102 = 0;
                        animatorSet15.playTogether(ObjectAnimator.ofFloat(this.f22042p1, this.f21957a4, 1.0f), ObjectAnimator.ofFloat(this.f22042p1, this.f21971c4, 0.0f));
                        hg.l lVar5 = this.f22053r1;
                        this.f22074v1 = 1.0f;
                        animatorSet15.playTogether(ObjectAnimator.ofFloat(lVar5, property5, 1.0f), ObjectAnimator.ofFloat(this.f22053r1, property3, 1.0f), ObjectAnimator.ofFloat(this.f22053r1, property4, 1.0f));
                    } else {
                        r102 = 0;
                        i14 = 1;
                    }
                    jh.h hVar4 = this.f21984e5;
                    if (hVar4 != 0) {
                    ...
                    if (this.f21961b1 != null) {
                        ...
                        this.f21961b1.j(s0() ? zgVar2 : zgVar, i14);
                    }
                    af afVar3 = this.J1;
                    if (afVar3 != null) {
                    ...
                    if (this.f22042p1 != null) {
                        ViewPropertyAnimator viewPropertyAnimator5 = this.f22047q1;
                        if (viewPropertyAnimator5 != null) {
                            viewPropertyAnimator5.cancel();
                            this.f22047q1 = null;
                        }
                        i13 = 1;
                        animatorSet17.playTogether(ObjectAnimator.ofFloat(this.f22042p1, this.f21971c4, 0.0f), ObjectAnimator.ofFloat(this.f22042p1, this.f21957a4, 1.0f));
                        hg.l lVar6 = this.f22053r1;
                        this.f22074v1 = 1.0f;
                        animatorSet17.playTogether(ObjectAnimator.ofFloat(lVar6, property5, 1.0f), ObjectAnimator.ofFloat(this.f22053r1, property3, 1.0f), ObjectAnimator.ofFloat(this.f22053r1, property4, 1.0f));
                    } else {
                        i13 = 1;
                    }
                    jh.h hVar5 = this.f21984e5;
                    if (hVar5 != null) {
                        hVar5.e(0, false, i13);
                    }
                    af afVar4 = this.J1;
                    ...
                    AnimatorSet animatorSet18 = this.f22065t2;
                ...
                ofFloat23.setStartDelay(this.f22057s == 1.0f ? 300L : 700L);
                ofFloat23.setDuration(200L);
                this.f22065t2.playTogether(animatorSet15, animatorSet16, ofFloat23, ObjectAnimator.ofFloat(this, "lockAnimatedTranslation", this.f22019k4).setDuration(200L));
                if (i10 != 5) {
                    ...
                    this.f22065t2.playTogether(ofFloat24);
                } else {
                    ChatActivityEnterView.this.f22056r4 = true;
                    ...
                    this.f22065t2.playTogether(duration);
                }
                ug ugVar2 = this.l1;
                if (ugVar2 != null) {
                    ugVar2.e = true;
                    jj0 jj0Var = ugVar2.f28808f;
                    jj0Var.T(0.0f, true);
                    if (ugVar2.d) {
                        jj0Var.start();
                    }
            ...
            this.f22065t2.addListener(new yf(this, i10));
            this.f22065t2.start();
            xg xgVar3 = this.Y0;
            if (xgVar3 != null) {
                xgVar3.b();
    ...
    public final void M1() {
        int i02 = i0(org.telegram.ui.ActionBar.h6.f19175jf);
        int i03 = i0(org.telegram.ui.ActionBar.h6.Sd);
        int i04 = i0(org.telegram.ui.ActionBar.h6.f19068df);
        mj0 mj0Var = this.f21993g1;
        if (mj0Var != null) {
            mj0Var.h(i02, "Cup Red");
            this.f21993g1.h(i02, "Box Red");
            this.f21993g1.h(i04, "Cup Grey");
            this.f21993g1.h(i04, "Box Grey");
            this.f21993g1.h(i04, "Box_Grey 2");
            this.f21993g1.h(i04, "Line 1");
            this.f21993g1.h(i04, "Line 2");
            this.f21993g1.h(i04, "Line 3");
            this.f21993g1.h(i03, "Line 1 Dup");
            this.f21993g1.h(i03, "Line 2 Dup");
            this.f21993g1.h(i03, "Line 3 Dup");
        }
    }
    ...
    public final void N() {
        ...
        int i11;
        int i12;
        float f7 = this.f21997g5.e;
        if (this.G1 != null) {
            float measuredHeight = getMeasuredHeight() - this.f21991f5.e;
            View view = this.G1;
    ...
    public final void O() {
        org.telegram.ui.wn wnVar = this.P2;
        if (wnVar != null) {
            MediaDataController.getInstance(this.Q).saveDraft(wnVar.a(), wnVar.B7(wnVar.f39573n5), "", null, null, null, null, 0L, false, true, null);
        }
    ...
    public final void O1(boolean z10) {
        ...
        if (isChatDialog) {
            TLRPC.Chat chat = this.R.getMessagesController().getChat(Long.valueOf(-this.Q2));
            this.f21994g2 = MessagesController.getNotificationsSettings(this.Q).getBoolean("silent_" + this.Q2, false);
            ...
            if (imageView != null) {
                if (this.f21979e0 == null) {
                    this.f21979e0 = new pr(getContext(), R.drawable.input_notify_on, org.telegram.ui.ActionBar.h6.Wk);
                }
                this.f21979e0.a(this.f21994g2, false);
    ...
    public final void Q() {
        ...
        this.f22086x1.setScaleType(ImageView.ScaleType.CENTER);
        this.f22086x1.setBackground(org.telegram.ui.ActionBar.h6.f0(i0(org.telegram.ui.ActionBar.h6.f19148i6), 1, -1));
        this.f22086x1.setVisibility(8);
        AndroidUtilities.updateViewVisibilityAnimated(this.f22086x1, false, 0.1f, false);
        this.f22042p1.addView(this.f22086x1, 0, w7.y5.n(44, 44));
        this.f22086x1.setOnClickListener(new vd(this, 15));
    }

    public final void Q0(TL_iv.RichMessage richMessage) {
        org.telegram.ui.wn wnVar = this.P2;
        if (wnVar != null) {
            MediaDataController.getInstance(this.Q).saveDraft(wnVar.a(), wnVar.B7(wnVar.f39573n5), "", null, null, null, null, 0L, false, false, richMessage);
        }
    ...
    public final void Q1(boolean z10, boolean z11) {
        ...
        if (this.Z2 != null) {
            ...
            org.telegram.ui.wn wnVar = this.P2;
            boolean z13 = true;
            if (!z10 && peer2 != null && ((this.Z2.J() == null || this.Z2.J().peers.size() > 1) && !r0() && !w0() && (((leVar = this.f21980e1) == null || leVar.getVisibility() != 0) && ((this.f22024l5 || ((!ChatObject.isChannelAndNotMegaGroup(chat) || ChatObject.canSendAsPeers(chat)) && !ChatObject.isMonoForum(chat))) && (wnVar == null || wnVar.R3 != 9))))) {
                z12 = true;
            } else {
                z12 = false;
            }
            ...
            if (peer2 != null) {
                if (peer2.channel_id != 0) {
                    ...
                    if (chat3 != null && (kp0Var2 = this.f22041p0) != null) {
                        kp0Var2.setAvatar(chat3);
                        this.f22041p0.setContentDescription(LocaleController.formatString(R.string.AccDescrSendAs, chat3.title));
                    }
                } else {
                    TLRPC.User user = MessagesController.getInstance(this.Q).getUser(Long.valueOf(peer2.user_id));
                    if (user != null && (kp0Var = this.f22041p0) != null) {
                        kp0Var.setAvatar(user);
                        this.f22041p0.setContentDescription(LocaleController.formatString(R.string.AccDescrSendAs, ContactsController.formatName(user.first_name, user.last_name)));
                    }
                }
            }
            kp0 kp0Var3 = this.f22041p0;
            ...
            if (kp0Var4 != null) {
                ...
                if (z12) {
                    ...
                    f10 = ((-this.f22041p0.getLayoutParams().width) - marginLayoutParams.leftMargin) - dp;
                }
            } else {
                f10 = 0.0f;
                f11 = 0.0f;
            ...
            if (z13 != z12) {
                ...
                if (valueAnimator != null) {
                    ...
                    this.f22041p0.setTag(null);
                }
                if ((!this.f22024l5 && (wnVar == null || wnVar.F8() != 0 || !wnVar.O5)) || !z11) {
                    float f14 = f10;
                    float f15 = f12;
                    boolean z14 = z12;
                    if (z14) {
                    ...
                    if (kp0Var6 != null) {
                        ...
                        this.f22041p0.setTranslationX(f14);
                    }
                    if (z14) {
                        f13 = f14;
                    }
    ...
    public final void R() {
        if (this.f22021l0 == null) {
            ...
            this.f22092y1.addView(this.f22021l0, w7.y5.d(-2, 32.0f, 83, 8.0f, 6.0f, 8.0f, 6.0f));
    ...
    public final void R1() {
        ...
        boolean z10 = true;
        if (this.f22072u4 != starsPrice) {
            View sendButtonInternal = getSendButtonInternal();
            this.f22072u4 = starsPrice;
    ...
    public final void S() {
        ...
        this.f21960b0.setTextColor(i0(org.telegram.ui.ActionBar.h6.f19442y6));
    ...
    public final void S1() {
        ...
        this.H0 = null;
        TLRPC.ChatFull chatFull = this.f21975d2;
        int i11 = 2147483646;
        if (chatFull != null && chatFull.slowmode_seconds != 0 && chatFull.slowmode_next_send_date <= currentTime && ((isUploadingMessageIdDialog = SendMessagesHelper.getInstance(this.Q).isUploadingMessageIdDialog(this.Q2)) || SendMessagesHelper.getInstance(this.Q).isSendingMessageIdDialog(this.Q2))) {
            if (!ChatObject.hasAdminRights(this.R.getMessagesController().getChat(Long.valueOf(this.f21975d2.f18336id))) && !ChatObject.isIgnoredChatRestrictionsForBoosters(this.f21975d2)) {
                i10 = this.f21975d2.slowmode_seconds;
            ...
            int i12 = this.G0;
            if (i12 >= 2147483646) {
                if (this.f21975d2 != null) {
                    this.R.getMessagesController().loadFullChat(this.f21975d2.f18336id, 0, true);
                }
                i10 = 0;
            } else {
                i10 = i12 - currentTime;
        ...
        if (this.G0 != 0 && i10 > 0) {
            ...
            wg wgVar = this.F0;
            wgVar.f29994a.l(formatDurationNoHours, false);
            wgVar.invalidate();
            og ogVar = this.Z2;
            if (ogVar != null) {
                ogVar.t1(wgVar, wgVar.f29994a.getText(), false);
            }
    ...
    public final void T(boolean z10) {
        ...
        this.f22096z1.addView(this.F1, w7.y5.e(44, 44, 85));
    }
    ...
    public final void U() {
        boolean z10;
        eg egVar = this.U0;
        if (egVar != null && egVar.f26548c1 != UserConfig.selectedAccount) {
            this.f22032n1.removeView(egVar);
            this.U0 = null;
        }
        if (this.U0 != null) {
            return;
        ...
        eg egVar2 = new eg(this, this.P2, z11, context, chatFull, this.f22025m1, z12, this.W3, z13, z10);
        this.U0 = egVar2;
        egVar2.f26606v0 = true;
        if (!this.f22094y4) {
            egVar2.S();
        }
        ...
        eg egVar4 = this.U0;
        if (egVar4 != null) {
            egVar4.K(-this.Q2, !this.f22095z0, !this.f21959b);
        }
        u();
        F();
    }
    ...
    public final void V() {
        ...
        this.S0.setBackground(org.telegram.ui.ActionBar.h6.f0(i0(org.telegram.ui.ActionBar.h6.f19148i6), 1, -1));
    ...
    public final void W() {
        ...
        org.telegram.ui.wn wnVar = this.P2;
        if (wnVar != null && wnVar.getParentLayout() != null && ((ActionBarLayout) wnVar.getParentLayout()).f18605b) {
        ...
        this.E0.setLinkTextColor(i0(org.telegram.ui.ActionBar.h6.f19135hc));
        this.E0.setHighlightColor(i0(org.telegram.ui.ActionBar.h6.f19381uf));
        qf qfVar3 = this.E0;
        ...
        this.E0.setHandlesColor(i0(org.telegram.ui.ActionBar.h6.f19398vf));
        qf qfVar4 = this.E0;
        boolean z11 = this.X3;
        if (z11) {
            f7 = 50.0f;
    ...
    public final void X() {
        ...
        view.f24700b = context.getDrawable(R.drawable.tooltip_arrow);
        view.f24699a = org.telegram.ui.ActionBar.h6.b0(AndroidUtilities.dp(5.0f), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19306qf, false));
        view.b();
        view.setTime(0);
        this.f21987f1.setTimeHintView(view);
        this.f22025m1.addView((View) view, w7.y5.d(-1, -2.0f, 80, 0.0f, 0.0f, 0.0f, 52.0f));
        sk0 sk0Var = new sk0(getContext(), this.W3);
        this.f21999h1 = sk0Var;
        this.f21980e1.addView(sk0Var, w7.y5.d(-1, 32.0f, 19, 44.0f, 0.0f, 4.0f, 0.0f));
        H1(this.P4);
    }
    ...
    public final void Y() {
        ...
        if (sgVar == null) {
            ...
            bw0Var.addView(this.O1, w7.y5.e(-1, -2, 80));
        }
        if (this.N1 != null) {
            return;
        }
    ...
    public final void Z() {
        if (this.f21974d1 == null && getContext() != null) {
            ...
            this.f22092y1.addView(this.f21974d1, w7.y5.c(44.0f, -1));
            this.f21974d1.setOnTouchListener(new bi.d(12));
            ai.w5 w5Var2 = this.f21974d1;
            SlideTextView slideTextView = new SlideTextView(getContext());
            this.f22016k1 = slideTextView;
    ...
    public final void a0() {
        if (this.J1 == null && this.P2 != null) {
            ...
            mutate2.setColorFilter(new PorterDuffColorFilter(i0(org.telegram.ui.ActionBar.h6.f19175jf), mode));
            ...
            this.J1.setBackground(org.telegram.ui.ActionBar.h6.f0(i0(org.telegram.ui.ActionBar.h6.f19148i6), 1, -1));
            this.f22092y1.addView(this.J1, 2, w7.y5.e(44, 44, 85));
    ...
    public final void a1(MessageObject messageObject, String str, boolean z10, boolean z11) {
        ...
        if (str != null && getVisibility() == 0 && (qfVar = this.E0) != null) {
            ...
            if (z10) {
                ...
                if ((this.f22038o2 != 1 || z11) && user3 != null && user3.bot && !str.contains("@")) {
                ...
                if (!this.f22097z2 && this.f21988f2 == -1) {
                    H0();
                }
            } else if (this.G0 > 0 && !c()) {
                og ogVar2 = this.Z2;
                if (ogVar2 != null) {
                    wg wgVar = this.F0;
                    ogVar2.t1(wgVar, wgVar.f29994a.getText(), true);
                }
            } else {
                if (messageObject != null && DialogObject.isChatDialog(this.Q2)) {
                ...
                if ((this.f22038o2 != 1 || z11) && user != null && user.bot && !str.contains("@")) {
    ...
    public final void b0() {
        if (this.f22041p0 == null && getContext() != null) {
            ?? view = new View(getContext());
            ImageReceiver imageReceiver = new ImageReceiver(view);
            view.f25769a = imageReceiver;
            view.f25770b = new h9((org.telegram.ui.ActionBar.d6) null);
            Paint paint = new Paint(1);
            view.d = paint;
            Paint paint2 = new Paint(1);
            view.e = paint2;
            ...
            paint.setColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19049cf, false));
            paint2.setColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19030bf, false));
            int dp = AndroidUtilities.dp(18.0f);
            int l1 = org.telegram.ui.ActionBar.h6.l1(0.2f, org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19059d6, false));
            ...
            this.f22041p0.setVisibility(8);
            this.f22092y1.addView(this.f22041p0, w7.y5.d(36, 36.0f, 83, 4.66f, 4.0f, 4.66f, 4.0f));
        }
    }
    ...
    public final void b1(int i10, long j3) {
        ...
        this.f22095z0 = true;
        if (DialogObject.isChatDialog(this.Q2)) {
            this.f22095z0 = ChatObject.canSendPlain(this.R.getMessagesController().getChat(Long.valueOf(-this.Q2)));
        }
        O1(false);
        I1(false);
        J();
    ...
    public final boolean c0(TL_keyboard.KeyboardButtonProto keyboardButtonProto, MessageObject messageObject, MessageObject messageObject2, org.telegram.ui.wi wiVar) {
        ...
        if (keyboardButtonProto != null && messageObject2 != null && ((wnVar = this.P2) == null || wnVar.R3 != 5)) {
            ...
            if (tL_inlineButtonTypeUrl != null) {
                ...
                if (g4Var != null) {
                    g4Var.S0 = false;
                    g4Var.f30078x1.setVisibility(8);
                    g4Var.S1(false, bool);
                    return false;
                }
                ...
                if (tL_inlineButtonTypeSwitchInline != null) {
                    ...
                    if (requestPeerType != null && messageObject2.messageOwner != null) {
                        if (requestPeerType instanceof TLRPC.TL_requestPeerTypeCreateBot) {
                            ...
                            if (user3 != null) {
                                er.a(getContext(), this.Q, user3, (TLRPC.TL_requestPeerTypeCreateBot) tL_buttonTypeRequestPeer.peer_type, false, new ai.e4(this, messageObject2, tL_buttonTypeRequestPeer, user3, 5), this.W3, null);
                                return false;
                            }
                            ...
                            org.telegram.ui.kj0 kj0Var = org.telegram.ui.kj0.f35077u0;
                            org.telegram.ui.ActionBar.m2 R = LaunchActivity.R();
                            if (R == null || org.telegram.ui.kj0.f35077u0 != null) {
                                return false;
                            }
                            org.telegram.ui.kj0 kj0Var2 = new org.telegram.ui.kj0(R, i10, bool2, bool3, ieVar);
                            kj0Var2.show();
                            org.telegram.ui.kj0.f35077u0 = kj0Var2;
                            return false;
                        } else {
    ...
    public final void d0() {
        ...
        if (messageObject != null) {
            ...
            if (needResendWhenEdit && !ChatObject.canManageMonoForum(this.Q, this.Z1.getDialogId())) {
                if (wnVar == null || (of3 = wnVar.f39488g5) == null) {
            ...
            if (!TextUtils.equals(charSequenceArr[0], this.Z1.messageText) || ((entities != null && !entities.isEmpty()) || !this.Z1.messageOwner.entities.isEmpty() || (this.Z1.messageOwner.media instanceof TLRPC.TL_messageMediaWebPage))) {
                ...
                if (wnVar != null && (chat = wnVar.e) != null && (((i10 = messageObject3.type) == 0 || i10 == 19) && !ChatObject.canSendEmbed(chat))) {
                    ...
                    message.flags &= -513;
                    message.media = null;
                } else if (wnVar != null && (messagePreviewParams = wnVar.f39476f5) != null) {
                    if (wnVar.G5 instanceof TLRPC.TL_webPagePending) {
                        ...
                        this.Z1.messageOwner.media.webpage = wnVar.f39476f5.webpage;
                    } else {
                ...
                if (this.Z1.needResendWhenEdit()) {
                    ...
                    if (wnVar == null || (of2 = wnVar.f39488g5) == null) {
    ...
    public final void d1(boolean z10, boolean z11) {
        ...
        oe oeVar = this.Q0;
        if (oeVar != null) {
            if (this.f22081w2 == 1 || ((leVar = this.f21980e1) != null && leVar.getVisibility() == 0)) {
                this.h = 0.0f;
                this.f22030n = 0.0f;
                F1();
                z11 = false;
            }
            zg zgVar2 = zg.f30875f;
            zg zgVar3 = zg.e;
            if (z10 && this.f21988f2 == 0) {
                if (this.f22095z0) {
                    zgVar = zg.d;
                } else {
                    return;
            ...
            if (!this.f22095z0 && zgVar == zgVar3) {
                zgVar3 = zgVar2;
            } else if (this.f21959b || zgVar == zgVar3) {
                zgVar3 = zgVar;
            }
            oeVar.j(zgVar3, z11);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.emojiLoaded) {
            ...
            if (((Integer) objArr[0]).intValue() == this.G2) {
                if (this.f22081w2 != 0 && !this.f22027m3 && !c()) {
                    this.f22027m3 = true;
            ...
            if (i10 != NotificationCenter.recordStartError && i10 != NotificationCenter.recordStopped) {
                ...
                if (i10 == NotificationCenter.recordPaused) {
                    ...
                    if (((Integer) objArr[0]).intValue() == this.G2) {
                        ...
                        if (obj instanceof VideoEditedInfo) {
                            ...
                            if (j81Var != null) {
                                ...
                                this.f21987f1.setVisibility(0);
                                this.f21987f1.setMinProgressDiff(1000.0f / ((float) this.f21982e3.estimatedDuration));
                                x0();
                            }
                            L1(3, true);
                            K(false);
                        ...
                        this.f21963b3 = (TLRPC.TL_document) obj;
                        this.f21970c3 = (String) objArr[2];
                        ...
                        if (this.f21963b3 != null) {
                            ...
                            if (this.f21980e1 != null) {
                                ...
                                tL_message.message = "";
                                tL_message.attachPath = this.f21970c3;
                                TLRPC.TL_messageMediaDocument tL_messageMediaDocument = new TLRPC.TL_messageMediaDocument();
                                tL_message.media = tL_messageMediaDocument;
                                tL_messageMediaDocument.flags |= 3;
                                tL_messageMediaDocument.document = this.f21963b3;
                                tL_message.flags |= 768;
                                this.f21976d3 = new MessageObject(UserConfig.selectedAccount, tL_message, false, true);
                                this.f21980e1.setAlpha(1.0f);
                                this.f21980e1.setVisibility(0);
                                ...
                                int i15 = 0;
                                while (true) {
                                    if (i15 < this.f21963b3.attributes.size()) {
                                        TLRPC.DocumentAttribute documentAttribute = this.f21963b3.attributes.get(i15);
                                ...
                                int i16 = 0;
                                while (true) {
                                    if (i16 >= this.f21963b3.attributes.size()) {
                                        break;
                                    }
                                    TLRPC.DocumentAttribute documentAttribute2 = this.f21963b3.attributes.get(i16);
                                    if (documentAttribute2 instanceof TLRPC.TL_documentAttributeAudio) {
                                        byte[] bArr2 = documentAttribute2.waveform;
                                        if (bArr2 == null || bArr2.length == 0) {
                                            documentAttribute2.waveform = MediaController.getWaveform(this.f21970c3);
                                        }
                                ...
                                if (z10 && (lVar = this.f22053r1) != null) {
                                    this.f22074v1 = 0.0f;
                                    lVar.setAlpha(0.0f);
                                    lVar.setScaleX(0.0f);
                                    lVar.setScaleY(0.0f);
                                ...
                                sk0 sk0Var = this.f21999h1;
                                String str2 = this.f21970c3;
                                if (!sk0Var.Q) {
                                    sk0Var.f28299r = (float) d;
                                    sk0Var.f28300s = f7;
                                    sk0Var.v = f10;
                                    sk0Var.f28301w = false;
                                    sk0Var.h.q(AndroidUtilities.formatDuration((int) Math.round(Math.max(1.0d, d)), false), false, true);
                                    sk0Var.f28297f.a(false, false);
                                    if (sk0Var.f28298n == null) {
                                        t71 t71Var = new t71();
                                        sk0Var.f28298n = t71Var;
                                        t71Var.J = new n2.e(sk0Var, 9);
                                    }
                                    sk0Var.f28298n.D(Uri.fromFile(new File(str2)), "other");
                                    sk0Var.K = 0;
                                    sk0Var.L = bArr;
                                    sk0Var.invalidate();
                                }
                                ...
                                if (z10) {
                                    ...
                                    this.f22081w2 = 1;
                                    this.N1.c(false);
                                    this.f22076v3.set(this.N1, Float.valueOf(1.0f));
                                    sg sgVar = this.O1;
                                    if (sgVar != null) {
                    ...
                    if (this.f21976d3 != null && MediaController.getInstance().isPlayingMessage(this.f21976d3)) {
                        MessageObject playingMessageObject = MediaController.getInstance().getPlayingMessageObject();
                        MessageObject messageObject = this.f21976d3;
                    ...
                    if (!((Boolean) objArr[6]).booleanValue()) {
                        ...
                        if (longValue == this.Q2 && (chatFull = this.f21975d2) != null && chatFull.slowmode_seconds != 0 && !MessageObject.isEphemeralMessageId(num2.intValue()) && (chat = this.R.getMessagesController().getChat(Long.valueOf(this.f21975d2.f18336id))) != null && !ChatObject.hasAdminRights(chat) && !ChatObject.isIgnoredChatRestrictionsForBoosters(chat)) {
                            TLRPC.ChatFull chatFull2 = this.f21975d2;
                            int currentTime = ConnectionsManager.getInstance(this.Q).getCurrentTime();
                            TLRPC.ChatFull chatFull3 = this.f21975d2;
    ...
    public final void e() {
        ...
        if (xgVar != null && (textPaint = xgVar.F) != null) {
            textPaint.setColor(xgVar.I.i0(org.telegram.ui.ActionBar.h6.f19249nf));
        }
        j81 j81Var = this.f21987f1;
        if (j81Var != null) {
            j81Var.e.setColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19003a7, false));
            j81Var.L = 0;
            h81 h81Var = j81Var.P;
            if (h81Var != null) {
                h81Var.b();
        ...
        if (numberTextView != null && this.E0 != null) {
            if (this.f21973d0 - this.f21967c0 < 0) {
                numberTextView.setTextColor(i0(org.telegram.ui.ActionBar.h6.f19279p7));
            } else {
                numberTextView.setTextColor(i0(org.telegram.ui.ActionBar.h6.f19442y6));
            }
        }
        Color.alpha(i0(org.telegram.ui.ActionBar.h6.f19030bf));
        of ofVar = this.m0;
        if (ofVar != null) {
    ...
    public final void e0(Canvas canvas, boolean z10) {
        ...
        int z11 = (int) com.google.android.gms.internal.vision.e2.z(1.0f, this.C4, org.telegram.ui.ActionBar.h6.f19145i3.getIntrinsicHeight(), this.T1);
        View view = this.G1;
        if (view != null && view.getVisibility() == 0) {
            z11 = (int) (((1.0f - getTopViewEnterProgress()) * this.G1.getLayoutParams().height) + z11);
        }
        int intrinsicHeight = org.telegram.ui.ActionBar.h6.f19145i3.getIntrinsicHeight() + z11;
        if (z10) {
            org.telegram.ui.ActionBar.h6.f19145i3.setAlpha((int) (this.C4 * 255.0f));
            org.telegram.ui.ActionBar.h6.f19145i3.setBounds(0, z11, getMeasuredWidth(), intrinsicHeight);
            org.telegram.ui.ActionBar.h6.f19145i3.draw(canvas);
        }
        if (this.f22089x4) {
            int i02 = i0(org.telegram.ui.ActionBar.h6.Sd);
            Paint paint2 = this.B4;
            paint2.setColor(i02);
            if (SharedConfig.chatBlurEnabled() && this.f22025m1 != null) {
                this.D4.set(0, intrinsicHeight, getWidth(), getHeight());
                this.f22025m1.J(canvas, getTop(), this.D4, paint2, false);
                return;
            }
    ...
    public final boolean f0(Canvas canvas, Utilities.Callback0Return callback0Return) {
        ...
        float f11;
        float f12;
        float e = this.f21965b5.e(this.E0.canScrollVertically(-1));
        float e7 = this.f21972c5.e(this.E0.canScrollVertically(1));
        if (e <= 0.0f && e7 <= 0.0f) {
    ...
    public final zf g0(MessageObject messageObject, boolean z10) {
        ...
        if (z10) {
            ...
            messageObject2.caption = MessageObject.replaceAnimatedEmoji(Emoji.replaceEmoji((CharSequence) spannableStringBuilder, org.telegram.ui.ActionBar.h6.f19256o2.getFontMetricsInt(), false, (int[]) null), entities, org.telegram.ui.ActionBar.h6.f19256o2.getFontMetricsInt());
        }
    ...
    public ei.f4 getBotWebViewButton() {
        if (this.f22015k0 == null) {
            ...
            this.f22092y1.addView(this.f22015k0, w7.y5.e(-1, -1, 80));
        }
    ...
    public kp0 getSenderSelectView() {
        return this.f22041p0;
    }

    public bw0 getSizeNotifierLayout() {
        return this.f22025m1;
    }

    public float getSlideToCancelProgress() {
        return this.f22013j4;
    }

    public CharSequence getSlowModeTimer() {
        if (this.G0 > 0) {
            return this.F0.f29994a.getText();
        }
        return null;
    }
    ...
    public void h1(float f7, float f10, float f11, boolean z10) {
        ...
        leVar.setAlpha(f11);
        ImageView imageView = this.f22080w1;
        if (imageView != null) {
    ...
    public final void i1(boolean z10) {
        ...
        this.f22053r1.setVisibility(i10);
        if (z10) {
    ...
    public final void l1(MessageObject messageObject, org.telegram.ui.mn mnVar, MessageObject messageObject2) {
        ...
        if (messageObject != null) {
            if (this.W2 == null && (messageObject3 = this.f22026m2) != this.T2) {
                this.W2 = messageObject3;
            }
            this.T2 = messageObject;
            this.V2 = mnVar;
            this.U2 = messageObject2;
            if (wnVar == null || !wnVar.f39498h4 || wnVar.X3 != messageObject) {
                Z0(messageObject, true, true);
            }
        } else if (this.T2 == this.f22026m2) {
            this.T2 = null;
            this.U2 = null;
            this.V2 = null;
    ...
    public final void m1(int i10, boolean z10) {
        ...
        if (z11 != z12) {
            ValueAnimator valueAnimator = this.f22073v0;
            if (valueAnimator != null) {
                valueAnimator.removeAllListeners();
                this.f22073v0.cancel();
            }
            float f7 = 0.0f;
            if (!z10) {
                if (z11) {
                ...
                float f10 = this.f22079w0;
                if (z11) {
                    f7 = 1.0f;
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, f7);
                this.f22073v0 = ofFloat;
                ofFloat.addUpdateListener(new rd(this, 4));
                this.f22073v0.addListener(new df(this, z11, 3));
                this.f22073v0.setDuration(220L);
                this.f22073v0.setInterpolator(sr.f28339f);
                this.f22073v0.start();
            }
        }
        this.R1 = i10;
    ...
    public final void n(TLRPC.Document document) {
        ...
        if (egVar != null && document != null) {
            boolean isEmpty = egVar.f26567i1.isEmpty();
            egVar.W();
            if (isEmpty) {
                egVar.X(false);
            }
    ...
    public final boolean n0(boolean z10, boolean z11, boolean z12) {
        ...
        TLRPC.TL_replyKeyboardMarkup tL_replyKeyboardMarkup;
        if (t0()) {
            if (this.f21988f2 == 1 && (tL_replyKeyboardMarkup = this.f22033n2) != null && z10 && this.f22026m2 != null) {
                if (!tL_replyKeyboardMarkup.is_persistent) {
                    SharedPreferences.Editor edit = MessagesController.getMainSettings(this.Q).edit();
                    edit.putInt("closed_botkeyboard_" + getTopicKeyString(), this.f22026m2.getId()).apply();
                }
            }
    ...
    public final void n1(boolean z10, boolean z11, boolean z12, boolean z13) {
        ...
        if ((o1Var == null || !o1Var.f19672f) && !this.f22023l3 && this.U0 != null) {
            if (z12 || this.f22098z3 != z10) {
                this.f22098z3 = z10;
                og ogVar = this.Z2;
                if (ogVar != null) {
                    ogVar.s1();
    ...
    public final void o(TLRPC.Document document) {
        U();
        eg egVar = this.U0;
        int i10 = egVar.f26548c1;
        MediaDataController.getInstance(i10).addRecentSticker(0, null, document, (int) (System.currentTimeMillis() / 1000), false);
        boolean isEmpty = egVar.f26570j1.isEmpty();
        egVar.f26570j1 = MediaDataController.getInstance(i10).getRecentStickers(0, true);
        dz dzVar = egVar.f26618y0;
        if (dzVar != null) {
            dzVar.l();
        }
        if (isEmpty) {
    ...
    public final void o0(boolean z10) {
        ...
        if (animatorSet2 == null || !animatorSet2.isRunning()) {
            ...
            ke keVar = this.f21977d4;
            ke keVar2 = this.Z3;
            ke keVar3 = this.f21964b4;
            ...
            if (z10) {
                ...
                this.f22070u2.playTogether(arrayList);
                ei.c0 c0Var = this.f22021l0;
                if (c0Var != null) {
                    c0Var.setAlpha(0.0f);
                    this.f22021l0.setScaleY(0.0f);
                    this.f22021l0.setScaleX(0.0f);
                    this.f22070u2.playTogether(ObjectAnimator.ofFloat(this.f22021l0, property3, 1.0f), ObjectAnimator.ofFloat(this.f22021l0, property2, 1.0f), ObjectAnimator.ofFloat(this.f22021l0, property, 1.0f));
                }
                this.f22070u2.setDuration(150L);
                this.f22070u2.addListener(new ze(this, 1));
            } else {
                mj0 mj0Var = this.f21993g1;
                if (mj0Var != null) {
                    mj0Var.d();
                ...
                if (z11) {
                    ...
                    qf qfVar = this.E0;
                    if (qfVar != null && this.f22057s == 1.0f) {
                        qfVar.setAlpha(1.0f);
                        this.G = 0.0f;
                        J1();
                    } else {
    ...
    public final void o1(boolean z10, boolean z11) {
        ...
        if (this.f22077v4 != z10 || !z11) {
            ...
            if (imageView == null) {
                if (z10 || this.f22024l5) {
                    if (imageView == null) {
                        ...
                        this.f22080w1 = imageView2;
                        imageView2.setScaleType(ImageView.ScaleType.CENTER);
                        this.f22080w1.setColorFilter(new PorterDuffColorFilter(i0(org.telegram.ui.ActionBar.h6.Wk), PorterDuff.Mode.MULTIPLY));
                        this.f22080w1.setImageResource(R.drawable.input_suggest_paid_24);
                        this.f22080w1.setBackground(org.telegram.ui.ActionBar.h6.f0(i0(org.telegram.ui.ActionBar.h6.f19148i6), 1, -1));
                        if (this.f22024l5) {
                            this.f22080w1.setTranslationX(AndroidUtilities.dp(42.0f));
                            this.f22096z1.addView(this.f22080w1, w7.y5.d(44, 44.0f, 85, 0.0f, 0.0f, 50.0f, 0.0f));
                        } else {
                            this.f22042p1.addView(this.f22080w1, 0, w7.y5.n(44, 44));
                        }
                        this.f22080w1.setOnClickListener(new vd(this, 19));
                        this.f22080w1.setContentDescription(LocaleController.getString(R.string.AccDescrAttachButton));
                    }
                } else {
                    return;
                }
            }
            if (this.f22077v4 != z10) {
                z12 = true;
            } else {
                z12 = false;
            }
            ...
            this.f22080w1.setEnabled(z10);
            this.f22080w1.setClickable(z10);
            ValueAnimator valueAnimator = this.f22083w4;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                this.f22083w4 = null;
            }
            if (z11) {
                if (this.f22024l5) {
                    this.f22080w1.setVisibility(0);
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f22080w1.getAlpha(), f10);
                this.f22083w4 = ofFloat;
                ofFloat.addUpdateListener(new rd(this, 7));
                this.f22083w4.addListener(new df(this, z10, 0));
                this.f22083w4.setDuration(220L);
                this.f22083w4.setInterpolator(sr.h);
                this.f22083w4.start();
            } else {
                this.f22080w1.setScaleX(f7);
                this.f22080w1.setScaleY(f7);
                this.f22080w1.setAlpha(f10);
                if (this.f22024l5) {
                    ImageView imageView3 = this.f22080w1;
                    if (!z10) {
                        i10 = 8;
                    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (c0Var != null && c0Var.getTag() != null) {
            ...
            kp0 kp0Var = this.f22041p0;
            if (kp0Var != null && kp0Var.getVisibility() == 0) {
                int i12 = this.f22041p0.getLayoutParams().width;
                this.f22041p0.measure(View.MeasureSpec.makeMeasureSpec(i12, 1073741824), View.MeasureSpec.makeMeasureSpec(this.f22041p0.getLayoutParams().height, 1073741824));
        ...
        if (measuredHeight > 0 && leVar.getMeasuredHeight() != measuredHeight) {
            for (int i13 = 0; i13 < 2; i13++) {
                if (i13 == 0) {
                    imageView = this.f22064t1;
                } else {
                    imageView = this.f22069u1;
                }
                imageView.setTranslationY((imageView.getTranslationY() + leVar.getMeasuredHeight()) - measuredHeight);
                imageView.animate().translationY(0.0f).setInterpolator(sr.h).setDuration(420L).start();
            }
            ci.e4 e4Var = this.M;
            if (e4Var != null) {
    ...
    public final ValueAnimator p(float f7) {
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.J1.f22625a, f7);
    ...
    public final void p1(boolean z10) {
        ...
        if (this.K4 != z11) {
            ...
            this.K4 = z11;
            ImageView imageView = this.f22064t1;
            imageView.setVisibility(0);
            ...
            scaleX.scaleY(f11).setInterpolator(sr.h).setDuration(420L).withEndAction(new ae(this, z11, 0)).start();
            if (z11) {
                i0 i0Var = this.f22059s1;
    ...
    public void setBotWebViewButtonOffsetX(float f7) {
        ...
        this.f22053r1.setTranslationX(this.f22090y + this.f22084x + f7);
    ...
    public void setEditingBusinessLink(TL_account.TL_businessChatLink tL_businessChatLink) {
        TextPaint textPaint;
        String str;
        this.f21962b2 = tL_businessChatLink;
        G1(false);
        if (this.f21962b2 != null) {
            T(true);
            ...
            this.F1.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setDuration(150L).setInterpolator(sr.f28339f).start();
            ...
            ArrayList<TLRPC.MessageEntity> arrayList = this.f21962b2.entities;
    ...
    public void setFieldFocused(boolean z10) {
        ...
        if (this.E0 != null && !accessibilityManager.isTouchExplorationEnabled()) {
            ...
            if (qfVar != null && qfVar.isFocused()) {
                if (!this.f22097z2 || this.f22012j2) {
                    this.E0.clearFocus();
                }
            }
        }
    ...
    public void setRoundVideoUiFrameClockActive(boolean z10) {
        if (this.f22011j1 != z10) {
            ...
            if (slideTextView != null) {
                slideTextView.J = z10;
                slideTextView.f22119y = System.currentTimeMillis();
    ...
    public void setSlideToCancelProgress(float f7) {
        ...
        this.f22067t4 = (int) ((1.0f - this.f22013j4) * (-measuredWidth));
        RecordCircle recordCircle = this.N1;
        if (recordCircle != null) {
            recordCircle.invalidate();
        }
    ...
    public final void t1(int i10, int i11, boolean z10, boolean z11) {
        ...
        if (i10 != 2) {
            ...
            if (i10 == 1) {
                ...
                if (i11 == 0) {
                    ...
                    if (egVar2 != null && egVar2.getVisibility() != 8) {
                        this.f22032n1.removeView(this.U0);
                        this.U0.setVisibility(8);
                        this.U0.setShowing(false);
                        this.W0 = false;
                ...
                if (this.f22087x2 <= 0) {
                    f7 = 200.0f;
                    this.f22087x2 = MessagesController.getGlobalEmojiSettings().getInt("kbd_height", AndroidUtilities.dp(200.0f));
                } else {
                    f7 = 200.0f;
                }
                if (this.f22093y2 <= 0) {
                    this.f22093y2 = MessagesController.getGlobalEmojiSettings().getInt("kbd_height_land3", AndroidUtilities.dp(f7));
                }
                Point point = AndroidUtilities.displaySize;
                if (point.x > point.y) {
                    i15 = this.f22093y2;
                ...
                if (viewGroup != null && this.f21978d5 == null) {
                ...
                if (bw0Var != null) {
                    ...
                    B1(true);
                    G0();
                    if (this.f22006i2 && !this.f22097z2 && i15 != i13 && z10) {
                ...
                if (egVar3 != null) {
                    if (i10 == 2 && !AndroidUtilities.usingHardwareInput && !AndroidUtilities.isInMultiwindow) {
                        ...
                        this.f22032n1.removeView(this.U0);
                        this.U0 = null;
                    } else if (this.f22006i2 && !this.f22097z2 && !this.f22098z3) {
                        this.W0 = true;
                        this.f22039o3 = 0;
                ...
                if (bgVar4 != null && bgVar4.getVisibility() == 0) {
                    if (i10 != 2 || AndroidUtilities.usingHardwareInput || AndroidUtilities.isInMultiwindow) {
                        if (this.f22006i2 && !this.f22097z2) {
                            if (this.X0) {
                                this.f22039o3 = 1;
                            }
                            AnimatorSet animatorSet3 = new AnimatorSet();
                            ...
                            AndroidUtilities.runOnUIThread(bfVar, 50L);
                            requestLayout();
                        } else if (!this.f22018k3) {
                            this.H1.setVisibility(8);
                        }
                    }
                    this.X0 = false;
                }
                if (i11 == 1 && this.f22026m2 != null) {
                    MessagesController.getMainSettings(this.Q).edit().putInt("closed_botkeyboard_" + getTopicKeyString(), this.f22026m2.getId()).apply();
                }
                B1(true);
                ph.f fVar2 = this.f21978d5;
                if (fVar2 != null) {
            ...
            if (this.f22088x3 || this.y3) {
                K(true);
            }
            if (this.f22098z3 && i10 != 1) {
                z12 = false;
                n1(false, false, false, true);
            } else {
                z12 = false;
    ...
    public final void u() {
        if (this.U0.getParent() == null) {
            if (this.f21978d5 == null) {
                this.f22032n1.addView(this.U0);
            } else {
                this.f22032n1.addView(this.U0, w7.y5.c(-1.0f, -1));
            }
        }
    }
    ...
    public final boolean v0() {
        if (this.F2 && ChatActivityEnterView.this.f22062s4) {
            return true;
        }
        return false;
    }
    ...
    public final void v1(boolean z10) {
        ...
        this.L4 = z11;
        ImageView imageView = this.f22069u1;
        imageView.setVisibility(0);
        ViewPropertyAnimator animate = imageView.animate();
        float f11 = 1.0f;
        if (z11) {
        ...
        scaleX.scaleY(f11).setInterpolator(sr.h).setDuration(420L).withEndAction(new ae(this, z11, 1)).start();
    }

    public final boolean w() {
        kg x10 = x();
        if (!TextUtils.equals(x10.f25720a, this.f21969c2.f25720a) || !MediaDataController.entitiesEqual(this.f21969c2.f25721b, x10.f25721b)) {
            return true;
        }
        return false;
    }
    ...
    public final boolean w0() {
        if (!this.F2) {
            AnimatorSet animatorSet = this.f22065t2;
            if (animatorSet == null || !animatorSet.isRunning() || this.f22017k2) {
                return false;
            }
            return true;
        }
    ...
    public final kg x() {
        ...
        ?? obj = new Object();
        obj.f25720a = charSequence.toString();
        obj.f25721b = entities;
        return obj;
    }

    public final void x1(boolean z10, boolean z11) {
        boolean z12;
        if (this.G1 != null && !this.f21989f3 && getVisibility() == 0) {
            le leVar = this.f21980e1;
            if ((leVar == null || leVar.getVisibility() != 0) && !this.H2 && this.V2 == null && (this.f22033n2 == null || this.Z1 != null)) {
                z12 = true;
            } else {
                z12 = false;
            }
            if (!z11 && z10 && z12 && !this.f22097z2 && !t0()) {
                H0();
                td tdVar = this.V;
                if (tdVar != null) {
                    AndroidUtilities.cancelRunOnUIThread(tdVar);
    ...
    public final void z1() {
        ...
        float f10 = this.f22090y + this.f22084x;
        ye yeVar = this.J0;
        if (yeVar != null) {
