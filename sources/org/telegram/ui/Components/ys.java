...
public final class ys extends AnimatorListenerAdapter {
    ...
    public final s4.c1 f30383b;
    public final int f30384c;
    public final View d;
    public final int e;
    public final ViewPropertyAnimator f30385f;
    ...
    public ys(s4.f1 f1Var, s4.c1 c1Var, int i10, View view, int i11, ViewPropertyAnimator viewPropertyAnimator, int i12) {
        ...
        this.d = view;
        this.e = i11;
        this.f30385f = viewPropertyAnimator;
    }
    ...
    public final void onAnimationEnd(Animator animator) {
        switch (this.f30382a) {
            case 0:
                this.f30385f.setListener(null);
                bt btVar = (bt) this.h;
                s4.c1 c1Var = this.f30383b;
                btVar.v(c1Var);
                btVar.f22842w.remove(c1Var);
                btVar.A();
                View view = c1Var.f42627a;
                if (view instanceof org.telegram.ui.Cells.r2) {
                    ((org.telegram.ui.Cells.r2) view).setMoving(false);
                } else if (view instanceof gg.l) {
                    ((gg.l) view).f9830a = false;
                }
                View view2 = this.d;
            ...
            default:
                ...
                s4.c1 c1Var2 = this.f30383b;
                jVar.P(c1Var2);
                jVar.v(c1Var2);
                jVar.f42694z.remove(c1Var2);
                jVar.G();
                jVar.z(c1Var2);
                return;
        }
