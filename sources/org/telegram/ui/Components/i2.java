...
public final class i2 implements Utilities.Callback {
    public final int f26942a = 0;
    public final int f26943b;
    public final int f26944c;
    public final int d;
    public final KeyEvent.Callback f26945e;
    ...
    public final void run(Object obj) {
        ...
        switch (this.f26942a) {
            case 0:
                q3 q3Var = (q3) this.f26945e;
                s3 s3Var = (s3) this.f26946f;
                r3 r3Var = (r3) this.f26947g;
                Boolean bool = (Boolean) obj;
                int i12 = this.f26943b;
                int i13 = i12 % 60;
                int i14 = (i12 - i13) / 60;
                int i15 = this.f26944c;
                int i16 = i15 % 60;
                int i17 = (i15 - i16) / 60;
                int i18 = 59;
                if (i16 == 0 && i17 > 0) {
                ...
                return;
            default:
                zh.w3.E0((zh.w3) this.f26945e, this.f26943b, this.f26944c, this.d, (TL_stars.TL_starGiftUnique) this.f26946f, (ug.n1[]) this.f26947g, (Long) obj);
                return;
        }
    }
    ...
    public i2(zh.w3 w3Var, int i10, int i11, int i12, TL_stars.TL_starGiftUnique tL_starGiftUnique, ug.n1[] n1VarArr) {
        ...
        this.f26944c = i11;
        this.d = i12;
        this.f26946f = tL_starGiftUnique;
        this.f26947g = n1VarArr;
    }
}
