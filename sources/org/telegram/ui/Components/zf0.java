...
public abstract class zf0 extends FrameLayout {
    ...
    public kc0 L;
    public int f30783a;
    public PhotoViewer f30784b;
    public LinearLayout f30785c;
    public TextView d;
    public TextView e;
    public pu f30786f;
    public ci.eb h;
    ...
    public final boolean e() {
        boolean z10;
        if (this.f30791x && "inapp".equals(MessagesController.getInstance(this.f30783a).youtubePipType)) {
            z10 = true;
        } else {
            z10 = false;
        }
