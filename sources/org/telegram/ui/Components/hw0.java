...
public final class hw0 extends View {
    public final y9 f26910a;
    public final fw0 f26911b;
    public final e6 f26912c;
    public boolean d;
    public gw0 f26913e;
    ...
    public final void b(MessagesController.PeerColor peerColor) {
        this.f26911b.a(peerColor);
        invalidate();
    }

    public float getVisibilityFactor() {
        return this.f26912c.f25593c;
    }
    ...
    public final void onDraw(Canvas canvas) {
        float e7 = this.f26912c.e(this.d);
        ...
        y9 y9Var = this.f26910a;
        y9Var.setBounds(0, 0, dp, dp2);
        fw0 fw0Var = this.f26911b;
        int i10 = fw0Var.f26217c;
        if (y9Var.f32895f != i10) {
            y9Var.f32895f = i10;
            if (y9Var.f32893c != null) {
                y9Var.d.setColorFilter(i10, PorterDuff.Mode.MULTIPLY);
                y9Var.invalidateSelf();
            }
        }
        int i11 = fw0Var.d;
        if (y9Var.f32894e != i11) {
            y9Var.f32894e = i11;
            Drawable drawable = y9Var.f32893c;
            if (drawable != null) {
                drawable.setColorFilter(i11, PorterDuff.Mode.MULTIPLY);
                y9Var.invalidateSelf();
            }
        }
        int i12 = fw0Var.f26217c | (-16777216);
        if (y9Var.h != i12) {
            y9Var.h = i12;
            y9Var.f32892b.s(i12, false);
            y9Var.invalidateSelf();
        }
        y9Var.draw(canvas);
        canvas.restore();
    ...
    public void set(TL_stars.Tl_starsRating tl_starsRating) {
        ...
        y9 y9Var = this.f26910a;
        if (y9Var.f32897r != i11 || y9Var.f32893c == null || y9Var.d == null) {
            p6 p6Var = y9Var.f32892b;
            if (i11 >= 0) {
            ...
            Context context = y9Var.f32891a;
            if (y9Var.f32896n != b10 || y9Var.f32893c == null || y9Var.d == null) {
                int i12 = b10 * 2;
                Drawable mutate = context.getResources().getDrawable(y9.f32890s[i12]).mutate();
                y9Var.f32893c = mutate;
                int i13 = y9Var.f32894e;
                PorterDuff.Mode mode = PorterDuff.Mode.MULTIPLY;
                mutate.setColorFilter(i13, mode);
                Drawable mutate2 = context.getResources().getDrawable(y9.f32890s[i12 + 1]).mutate();
                y9Var.d = mutate2;
                mutate2.setColorFilter(y9Var.f32895f, mode);
                y9Var.f32896n = b10;
                Drawable drawable = y9Var.f32893c;
                if (drawable != null) {
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (!super.verifyDrawable(drawable) && drawable != this.f26910a) {
            return false;
        }
        return true;
    }
