...
public final class dl0 implements Runnable {
    ...
    public final void run() {
        ...
        float f7 = this.f23359c;
        float f10 = this.f23358b;
        Object obj = this.d;
        switch (i10) {
            case 0:
                ll0 ll0Var = (ll0) ((gl0) obj).f24420b;
                if (ll0Var.f25944e1 != null && (view = ll0Var.N1) != null) {
            ...
            default:
                ...
                sg.e eVar = (sg.e) k6Var.f1131b;
                ValueAnimator valueAnimator = eVar.S;
                sg.b bVar = eVar.f42936a0;
                sg.b bVar2 = eVar.W;
                ...
                if (Math.abs(eVar.f42937b.d) > 10.0f) {
                    eVar.i();
                    return;
                }
                AndroidUtilities.cancelRunOnUIThread(eVar.U);
                eVar.T = new AnimatorSet();
                ValueAnimator ofFloat = ValueAnimator.ofFloat(eVar.f42937b.d, f10);
                ...
                ValueAnimator ofFloat3 = ValueAnimator.ofFloat(eVar.f42937b.f42911g, f7);
