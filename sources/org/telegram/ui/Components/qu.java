...
public final class qu extends org.telegram.ui.ActionBar.g5 {
    ...
    public final boolean g() {
        ...
        try {
            tuVar.f30739r.getWindow().clearFlags(128);
            return true;
        } catch (Exception e7) {
            FileLog.e(e7);
            return true;
    ...
    public final void onOpenAnimationEnd() {
        ...
        tu tuVar = this.h;
        int i10 = tuVar.Q;
        RadialProgressView radialProgressView = tuVar.f30738n;
        nu nuVar = tuVar.f30734b;
        b91 b91Var = tuVar.f30735c;
        if (this.f29853f && tuVar.f30735c.g(tuVar.K, null, null, tuVar.I, true)) {
