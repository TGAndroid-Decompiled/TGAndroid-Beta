...
public final class vc0 extends Drawable {
    ...
    public final Paint f29057b;
    public final Paint f29058c;
    public final d6 d;
    public boolean e;
    ...
    public vc0(Context context) {
        ...
        this.f29058c = paint2;
        this.d = new d6(new jc0(this, 3), 200L, qr.f27654g, 0);
        this.f29056a = context.getResources().getDrawable(R.drawable.filled_sound_on).mutate();
    ...
    public final void draw(Canvas canvas) {
        ...
        if (e > 0.0f) {
            ...
            float f11 = centerY;
            float f12 = dp;
            canvas.drawLine(f10, f11, f12, f7, this.f29058c);
            Paint paint = this.f29057b;
