...
public class vc0 extends LinearLayout {
    public static final pr f31196v0 = new pr(0.0f, 0.5f, 0.5f, 1.0f);
    public int E;
    public boolean F;
    public int G;
    public int H;
    ...
    public float W;
    public int f31197a;
    public long f31198a0;
    public int f31199b;
    public float f31200b0;
    public int f31201c;
    public VelocityTracker f31202c0;
    public final TextView d;
    public final int f31203d0;
    public final int f31204e;
    public final int f31205e0;
    public final int f31206f;
    public final int f31207f0;
    public boolean f31208g0;
    public final int h;
    public boolean f31209h0;
    public final Paint f31210i0;
    public final int f31211j0;
    public int f31212k0;
    public int f31213l0;
    public int m0;
    public int f31214n;
    public boolean f31215n0;
    public boolean f31216o0;
    public final uc0 f31217p0;
    public int f31218q0;
    public final boolean f31219r;
    public boolean f31220r0;
    public final int f31221s;
    public Utilities.CallbackReturn f31222s0;
    public Integer f31223t0;
    public int f31224u0;
    public int v;
    public String[] f31225w;
    public int f31226x;
    ...
    public final void b(int i10) {
        ...
        int i11 = this.f31226x;
        if (i10 >= i11 && i10 <= this.E) {
            String[] strArr = this.f31225w;
            if (strArr != null) {
                str = strArr[i10 - i11];
            } else {
                rc0 rc0Var = this.K;
    ...
    public final void computeScroll() {
        ...
        nm0Var.b();
        int i10 = nm0Var.f28853k;
        if (this.U == 0) {
            this.U = nm0Var.f28847c;
        }
    ...
    public final int computeVerticalScrollRange() {
        return ((this.E - this.f31226x) + 1) * this.P;
    }
    ...
    public final int e(int i10) {
        ...
        int i15;
        int i16;
        if (this.F && i10 > (i14 = this.E) && (i16 = i14 - (i15 = this.f31226x)) != 0) {
            return (((i10 - i14) % i16) + i15) - 1;
        }
        if (this.f31227y && i10 < (i11 = this.f31226x) && (i13 = (i12 = this.E) - i11) != 0) {
    ...
    public final void f() {
        ...
        for (int i10 = 0; i10 < this.N.length; i10++) {
            int i11 = (i10 - this.f31199b) + value;
            if (this.f31208g0) {
                i11 = e(i11);
            }
            iArr[i10] = i11;
    ...
    public final boolean h(nm0 nm0Var) {
        nm0Var.f28859q = true;
        int i10 = nm0Var.f28848e - nm0Var.f28853k;
            ...
            if (i10 == 0) {
                ...
                if (accessibilityManager.isTouchExplorationEnabled()) {
                    ...
                    if (strArr == null) {
                        ...
                        str = strArr[this.G - this.f31226x];
                    }
    ...
    public final void l(int i10, boolean z10) {
        ...
        if (this.G != i10) {
            if (this.f31208g0) {
                ...
                min = Math.min(Math.max(i10, this.f31226x), this.E);
            }
            int i11 = this.G;
            this.H = min;
            this.G = min;
            ...
            f();
            invalidate();
            if (this.f31212k0 == 0 && (sc0Var = this.J) != null) {
                sc0Var.b(0);
            }
        }
    }
    ...
    public final void m() {
        ...
        if (this.f31219r) {
            ...
            if (this.f31214n != paddingRight) {
                int i15 = this.h;
                if (paddingRight > i15) {
                    this.f31214n = paddingRight;
                } else {
                    this.f31214n = i15;
                }
                invalidate();
    ...
    public void onDraw(Canvas canvas) {
        ...
        float f7 = width + this.f31201c;
        float f10 = this.R;
        int[] iArr = this.N;
        for (int i14 = 0; i14 < iArr.length; i14++) {
            String str = (String) this.M.get(iArr[i14]);
            if (str != null && (i14 != this.f31199b || this.d.getVisibility() != 0)) {
                if (this.f31197a > 3) {
                    ...
                    float interpolation = f31196v0.getInterpolation(Utilities.clamp(measuredHeight, 1.0f, 0.0f));
        ...
        if (this.f31220r0) {
            canvas.drawRect(0.0f, this.f31213l0, getRight(), this.f31211j0 + i10, this.f31210i0);
            canvas.drawRect(0.0f, i11 - this.f31211j0, getRight(), this.m0, this.f31210i0);
        }
    }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        this.W = y3;
        this.f31200b0 = y3;
        this.f31198a0 = motionEvent.getEventTime();
        float f7 = this.W;
        if (f7 < this.f31213l0) {
            if (this.f31212k0 == 0) {
                uc0 uc0Var = this.f31217p0;
                uc0Var.a();
                uc0Var.f30889c = 1;
                uc0Var.f30888b = 2;
                ((vc0) uc0Var.d).postDelayed(uc0Var, ViewConfiguration.getTapTimeout());
            }
        } else if (f7 > this.m0 && this.f31212k0 == 0) {
            uc0 uc0Var2 = this.f31217p0;
            uc0Var2.a();
            uc0Var2.f30889c = 1;
            uc0Var2.f30888b = 1;
        ...
        if (!nm0Var2.f28859q) {
            nm0Var.f28859q = true;
            nm0Var2.f28859q = true;
            return true;
        }
        float f10 = this.W;
        if (f10 < this.f31213l0) {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (z10) {
            ...
            int i16 = this.f31221s;
            int bottom = (int) (((((getBottom() - getTop()) + i16) - (length * i16)) / iArr.length) + 0.5f);
            this.v = bottom;
            this.P = bottom + i16;
            int top = (this.d.getTop() + this.d.getBaseline()) - (this.P * this.f31199b);
            this.Q = top;
            this.R = top;
            n();
            setVerticalFadingEdgeEnabled(true);
            setFadingEdgeLength(((getBottom() - getTop()) - i16) / 2);
            this.f31213l0 = ((getHeight() - i16) - this.v) / 2;
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(g(i10, this.f31214n), g(i11, this.f31206f));
        setMeasuredDimension(k(this.h, getMeasuredWidth(), i10), k(this.f31204e, getMeasuredHeight(), i11));
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.f31202c0 == null) {
            this.f31202c0 = VelocityTracker.obtain();
        }
        this.f31202c0.addMovement(motionEvent);
        int actionMasked = motionEvent.getActionMasked();
        if (actionMasked != 1) {
            if (actionMasked != 2) {
                return true;
            ...
            float y3 = motionEvent.getY();
            if (this.f31212k0 != 1) {
                if (((int) Math.abs(y3 - this.W)) > this.f31203d0) {
                    j();
                    i(1);
                }
            } else {
                scrollBy(0, (int) (y3 - this.f31200b0));
                invalidate();
            }
            this.f31200b0 = y3;
            return true;
        ...
        this.f31217p0.a();
        VelocityTracker velocityTracker = this.f31202c0;
        velocityTracker.computeCurrentVelocity(1000, this.f31207f0);
        int yVelocity = (int) velocityTracker.getYVelocity();
        if (Math.abs(yVelocity) > this.f31205e0) {
            this.U = 0;
            if (yVelocity > 0) {
            ...
            long eventTime = motionEvent.getEventTime() - this.f31198a0;
            if (abs <= this.f31203d0 && eventTime < ViewConfiguration.getTapTimeout()) {
                int i10 = (y10 / this.P) - this.f31199b;
                if (i10 > 0) {
                    a(true);
                    uc0 uc0Var = this.f31217p0;
                    uc0Var.a();
    ...
    public final void scrollBy(int i10, int i11) {
        int[] iArr = this.N;
        boolean z10 = this.f31208g0;
        if (!z10 && i11 > 0 && iArr[this.f31199b] <= this.f31226x) {
            int i12 = this.R + i11;
            int i13 = this.Q;
            if (i12 > i13) {
                this.R = i13;
        ...
        if (!z10 && i11 < 0 && iArr[this.f31199b] >= this.E) {
            int i14 = this.R + i11;
            int i15 = this.Q;
            if (i14 < i15) {
                this.R = i15;
        ...
        while (true) {
            ...
            int i17 = iArr[1] - 1;
            if (this.f31208g0 && i17 < this.f31226x) {
                i17 = this.E;
            }
            iArr[0] = i17;
            b(i17);
            if (!this.f31208g0 && iArr[this.f31199b] <= this.f31226x) {
                int i18 = this.R;
                int i19 = this.Q;
                if (i18 > i19) {
                    this.R = i19;
        ...
        while (true) {
            ...
            if (i20 - this.Q < (-this.v)) {
                ...
                if (this.f31208g0 && i21 > this.E) {
                    i21 = this.f31226x;
                }
                iArr[iArr.length - 1] = i21;
                b(i21);
                if (!this.f31208g0 && iArr[this.f31199b] >= this.E) {
                    int i22 = this.R;
                    int i23 = this.Q;
                    if (i22 < i23) {
                        this.R = i23;
    ...
    public void setAllItemsCount(int i10) {
        this.f31223t0 = Integer.valueOf(i10);
        setWrapSelectorWheel(this.f31209h0);
    }

    public void setContentDescriptionCallback(Utilities.CallbackReturn<Integer, CharSequence> callbackReturn) {
        this.f31222s0 = callbackReturn;
    }

    public void setDisplayedValues(String[] strArr) {
        if (this.f31225w == strArr) {
            return;
        }
        this.f31225w = strArr;
        n();
    ...
    public vc0(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f31211j0 = (int) TypedValue.applyDimension(1, 2.0f, getResources().getDisplayMetrics());
        TypedValue.applyDimension(1, 48.0f, getResources().getDisplayMetrics());
        this.f31204e = -1;
        int applyDimension = (int) TypedValue.applyDimension(1, 180.0f, getResources().getDisplayMetrics());
        this.f31206f = applyDimension;
        int i11 = this.f31204e;
        ...
        this.f31214n = -1;
        this.f31219r = true;
        this.f31217p0 = new uc0(this);
        setWillNotDraw(false);
        TextView textView = new TextView(getContext());
        this.d = textView;
        textView.setGravity(17);
        this.d.setSingleLine(true);
        this.d.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20797j5, f6Var));
        ...
        this.f31203d0 = viewConfiguration.getScaledTouchSlop();
        this.f31205e0 = viewConfiguration.getScaledMinimumFlingVelocity();
        this.f31207f0 = viewConfiguration.getScaledMaximumFlingVelocity() / 8;
