...
public abstract class l30 extends org.telegram.ui.ActionBar.f3 {
    public final z4.g f28064b;
    public final i30 f28065c;
    ...
    public l30(Context context, TLRPC.Chat chat, boolean z10) {
        ...
        int i11;
        int i12;
        int w02 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20736fg, false);
        ...
        int i14 = org.telegram.ui.ActionBar.j6.f20881ng;
        ...
        int i15 = 0;
        while (true) {
            TextView[] textViewArr = this.f28066e;
            if (i15 >= textViewArr.length) {
                break;
            }
            textViewArr[i15] = new TextView(context);
            this.f28066e[i15].setTextSize(1, 12.0f);
            this.f28066e[i15].setTextColor(-1);
            this.f28066e[i15].setTypeface(AndroidUtilities.bold());
            this.f28066e[i15].setPadding(AndroidUtilities.dp(10.0f), 0, AndroidUtilities.dp(10.0f), 0);
            this.f28066e[i15].setGravity(16);
            this.f28066e[i15].setSingleLine(true);
            this.d.addView(this.f28066e[i15], w7.x5.n(-2, -1));
            if (i15 == 0) {
                this.f28066e[i15].setText(LocaleController.getString(R.string.VoipRecordAudio));
            } else if (i15 == 1) {
                this.f28066e[i15].setText(LocaleController.getString(R.string.VoipRecordPortrait));
            } else {
                this.f28066e[i15].setText(LocaleController.getString(R.string.VoipRecordLandscape));
            }
            this.f28066e[i15].setOnClickListener(new di.o4(this, i15, 9));
            i15++;
        }
        if (z10) {
            this.f28064b.setCurrentItem(1);
        }
    }

    public static void m(l30 l30Var) {
        TextView textView;
        TextView[] textViewArr = l30Var.f28066e;
        int i10 = l30Var.h;
        ...
        if (textView != null) {
            measuredWidth2 -= (((textView.getMeasuredWidth() / 2) + textView.getLeft()) - measuredWidth) * l30Var.f28067f;
        }
        for (int i11 = 0; i11 < textViewArr.length; i11++) {
            ...
            if (i11 >= i12 && i11 <= i12 + 1) {
                if (i11 == i12) {
                    float f11 = l30Var.f28067f;
                    f10 = 1.0f - (0.3f * f11);
                    f7 = 1.0f - (f11 * 0.1f);
                } else {
                    float f12 = l30Var.f28067f;
                    f10 = 0.7f + (0.3f * f12);
                    f7 = 0.9f + (f12 * 0.1f);
                }
            }
