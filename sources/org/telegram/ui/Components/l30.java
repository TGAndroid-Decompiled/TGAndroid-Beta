...
public final class l30 extends TextView {
    public final Paint[] f28612a;
    public final o30 f28613b;

    public l30(o30 o30Var, Context context) {
        super(context);
        this.f28613b = o30Var;
        this.f28612a = new Paint[o30Var.f29652e.length];
        int i10 = 0;
        while (true) {
            Paint[] paintArr = this.f28612a;
