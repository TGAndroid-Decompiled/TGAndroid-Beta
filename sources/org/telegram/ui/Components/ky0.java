...
public final class ky0 extends kl0 {
    public final ny0 f25690c;
    public final ny0 d;

    public ky0(ny0 ny0Var, ny0 ny0Var2) {
        this.d = ny0Var;
        this.f25690c = ny0Var2;
    }
    ...
    @Override
    public final int h() {
        ArrayList arrayList = this.f25690c.f26624w;
        if (arrayList == null) {
            return 0;
        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        String str;
        my0 my0Var = (my0) c1Var.f42671a;
        ny0 ny0Var = this.f25690c;
        ArrayList arrayList = ny0Var.f26624w;
        if (arrayList == null) {
            str = null;
        } else {
        ...
        if (str != null && str.startsWith("animated_")) {
            try {
                ...
                if (!(drawable instanceof o5) || ((o5) drawable).i() != parseLong) {
                    my0Var.setImageDrawable(o5.n(UserConfig.selectedAccount, parseLong, null, my0Var.f26261f.d()));
                }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        return new s4.c1(new my0(this.d, this.f25690c.getContext()));
    }
}
