...
public final class oe implements b5 {
    ...
    public final ChatActivityEnterView f26719b;

    public oe(ChatActivityEnterView chatActivityEnterView, int i10) {
        this.f26718a = i10;
        this.f26719b = chatActivityEnterView;
    }
    ...
    public final void J(int i10, int i11, boolean z10) {
        switch (this.f26718a) {
            case 0:
                this.f26719b.T0(i10, z10, i11, true, 0L);
                return;
            default:
                ChatActivityEnterView chatActivityEnterView = this.f26719b;
