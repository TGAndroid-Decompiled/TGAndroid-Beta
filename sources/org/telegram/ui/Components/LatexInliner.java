...
public class LatexInliner {
    ...
    private static String readCommand(String str, int[] iArr) {
        ...
        String strSubstring = str.substring(i2, iArr[0]);
        ...
        switch (strSubstring) {
            ...
            case "dot":
                return MediaSessionConnector$DefaultMediaMetadataProvider$$ExternalSyntheticOutline0.m(new StringBuilder(), readArgument(str, iArr), "̇");
            case "end":
            case "begin":
                readArgument(str, iArr);
                return "";
            case "hat":
                return MediaSessionConnector$DefaultMediaMetadataProvider$$ExternalSyntheticOutline0.m(new StringBuilder(), readArgument(str, iArr), "̂");
            case "vec":
                return MediaSessionConnector$DefaultMediaMetadataProvider$$ExternalSyntheticOutline0.m(new StringBuilder(), readArgument(str, iArr), "⃗");
            case "frac":
            case "dfrac":
            case "tfrac":
            ...
            case "sqrt":
                ...
                StringBuilder sbM = Log.m(strInlineLatex != null ? superscriptOrRaw(strInlineLatex) : "", "√");
                sbM.append(wrapIfNeeded(argument2));
                return sbM.toString();
            case "tilde":
                return MediaSessionConnector$DefaultMediaMetadataProvider$$ExternalSyntheticOutline0.m(new StringBuilder(), readArgument(str, iArr), "̃");
            default:
