...
public abstract class v00 extends ho0 {
    ...
    public final void e(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.d) {
            accessibilityNodeInfo.addAction((AccessibilityNodeInfo.AccessibilityAction) s0.c.h.f46878a);
    ...
    public final boolean g(View view, int i10, Bundle bundle) {
        ...
        if (i10 == ((AccessibilityNodeInfo.AccessibilityAction) s0.c.h.f46878a).getId()) {
