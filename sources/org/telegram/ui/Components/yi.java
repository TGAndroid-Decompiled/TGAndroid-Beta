...
public final class yi implements Utilities.Callback2 {
    ...
    public final gj f30556b;
    public final MessagesController f30557c;
    public final int d;

    public yi(gj gjVar, MessagesController messagesController, int i10, int i11) {
        this.f30555a = i11;
        this.f30556b = gjVar;
        this.f30557c = messagesController;
        this.d = i10;
    }
    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (this.f30555a) {
            case 0:
                ...
                gj gjVar = this.f30556b;
                gjVar.f24364e0 = -1;
                gjVar.f24373n0 = false;
                if (messages_botresults != null) {
                    this.f30557c.putUsers(messages_botresults.users, false);
                    ...
                    gjVar.f24371l0 = messages_botresults.next_offset;
                    gjVar.f24367h0 = !TextUtils.isEmpty(str);
                    gjVar.P();
                    return;
                }
                return;
            default:
                ...
                gj gjVar2 = this.f30556b;
                ArrayList arrayList2 = gjVar2.M;
                gjVar2.V = -1;
                boolean z10 = false;
                gjVar2.f24360a0 = false;
                if (messages_messages != null) {
                    ArrayList<TLRPC.User> arrayList3 = messages_messages.users;
                    MessagesController messagesController = this.f30557c;
