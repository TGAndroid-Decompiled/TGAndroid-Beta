...
public final class yi implements Utilities.CallbackReturn {
    ...
    public final Object run(Object obj) {
        ...
        switch (this.f30600a) {
            case 0:
                return Boolean.valueOf(hj.K((hj) this.f30601b, (MessageObject) obj));
            case 1:
                rh.f fVar = (rh.f) this.f30601b;
                View view = (View) obj;
                ...
                svgThumb.setColorKey(org.telegram.ui.ActionBar.h6.f19291qe);
                imageReceiver.setImage(ImageLocation.getForWebFile(WebFile.createWithGeoPoint(fVar.f42869b.geo, 300, 168, 15, Math.min(2, (int) Math.ceil(AndroidUtilities.density)))), (String) null, (ImageLocation) null, (String) null, new fq(svgThumb), (Object) null, 0);
            ...
            case 2:
                int i13 = ((SparseIntArray) this.f30601b).get(((Integer) obj).intValue(), -1);
                if (i13 == -1) {
                    return Boolean.TRUE;
                }
                boolean z10 = true;
            ...
            default:
                r61 r61Var = (r61) this.f30601b;
                View view2 = (View) obj;
                r61Var.getClass();
                if (view2.getParent() != r61Var) {
                    return Boolean.FALSE;
                }
                return Boolean.valueOf(!j61.K(r61Var.T(view2).f42949f));
        }
    }
}
