...
public final class yi implements Utilities.CallbackReturn {
    ...
    public final Object run(Object obj) {
        ...
        switch (this.f30645a) {
            case 0:
                return Boolean.valueOf(ij.K((ij) this.f30646b, (MessageObject) obj));
            case 1:
                rh.f fVar = (rh.f) this.f30646b;
                View view = (View) obj;
                ...
                imageReceiver.setImage(ImageLocation.getForWebFile(WebFile.createWithGeoPoint(fVar.f42882b.geo, 300, 168, 15, Math.min(2, (int) Math.ceil(AndroidUtilities.density)))), (String) null, (ImageLocation) null, (String) null, new gq(svgThumb), (Object) null, 0);
            ...
            case 2:
                int i13 = ((SparseIntArray) this.f30646b).get(((Integer) obj).intValue(), -1);
                if (i13 == -1) {
                    return Boolean.TRUE;
                }
                boolean z10 = true;
            ...
            default:
                s61 s61Var = (s61) this.f30646b;
                View view2 = (View) obj;
                s61Var.getClass();
                if (view2.getParent() != s61Var) {
                    return Boolean.FALSE;
                }
                return Boolean.valueOf(!k61.K(s61Var.T(view2).f42962f));
        }
    }
}
