...
public final class yi implements Utilities.Callback2 {
    ...
    public final gj f32956b;
    public final MessagesController f32957c;
    public final int d;

    public yi(gj gjVar, MessagesController messagesController, int i10, int i11) {
        this.f32955a = i11;
        this.f32956b = gjVar;
        this.f32957c = messagesController;
        this.d = i10;
    }
    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (this.f32955a) {
            case 0:
                ...
                gj gjVar = this.f32956b;
                gjVar.f26425e0 = -1;
                gjVar.f26434n0 = false;
                if (messages_botresults != null) {
                    this.f32957c.putUsers(messages_botresults.users, false);
                    ...
                    gjVar.f26432l0 = messages_botresults.next_offset;
                    gjVar.f26428h0 = !TextUtils.isEmpty(str);
                    gjVar.P();
                    return;
                }
                return;
            default:
                ...
                gj gjVar2 = this.f32956b;
                ArrayList arrayList2 = gjVar2.M;
                gjVar2.V = -1;
                boolean z10 = false;
                gjVar2.f26421a0 = false;
                if (messages_messages != null) {
                    ArrayList<TLRPC.User> arrayList3 = messages_messages.users;
                    MessagesController messagesController = this.f32957c;
