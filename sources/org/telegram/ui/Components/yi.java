...
public final class yi implements Utilities.Callback2 {
    ...
    public final gj f30658b;
    public final MessagesController f30659c;
    public final int d;

    public yi(gj gjVar, MessagesController messagesController, int i10, int i11) {
        this.f30657a = i11;
        this.f30658b = gjVar;
        this.f30659c = messagesController;
        this.d = i10;
    }
    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (this.f30657a) {
            case 0:
                ...
                gj gjVar = this.f30658b;
                gjVar.f24541e0 = -1;
                gjVar.f24550n0 = false;
                if (messages_botresults != null) {
                    this.f30659c.putUsers(messages_botresults.users, false);
                    ...
                    gjVar.f24548l0 = messages_botresults.next_offset;
                    gjVar.f24544h0 = !TextUtils.isEmpty(str);
                    gjVar.P();
                    return;
                }
                return;
            default:
                ...
                gj gjVar2 = this.f30658b;
                ArrayList arrayList2 = gjVar2.M;
                gjVar2.V = -1;
                boolean z10 = false;
                gjVar2.f24537a0 = false;
                if (messages_messages != null) {
                    ArrayList<TLRPC.User> arrayList3 = messages_messages.users;
                    MessagesController messagesController = this.f30659c;
