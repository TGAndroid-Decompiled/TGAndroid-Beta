...
public class ji0 extends org.telegram.ui.ActionBar.f3 {
    public final Bitmap f25348b;
    public final TextView f25349c;
    ...
    public ji0(Context context, String str, String str2, String str3, boolean z10) {
        ...
        Bitmap bitmap2 = this.f25348b;
        try {
            HashMap hashMap = new HashMap();
            hashMap.put(cc.b.f4194a, hc.c.M);
            hashMap.put(cc.b.f4196c, 0);
            ...
            this.f25350f = telegramQRCodeWriter.getImageSize();
            bitmap = encode;
        } catch (Exception e) {
            FileLog.e(e);
        }
    ...
    public final void n() {
        ...
        if (textView2 != null) {
            ...
            textView2.setBackground(org.telegram.ui.ActionBar.i6.f0(i0.a.k(getThemedColor(i10), Math.min(255, Color.alpha(getThemedColor(org.telegram.ui.ActionBar.i6.f18923i6)) * 2)), 7, -1));
        }
        int i11 = org.telegram.ui.ActionBar.i6.f19215y6;
        int themedColor4 = getThemedColor(i11);
        TextView textView3 = this.f25349c;
        ...
        setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.i6.f18904h5));
    }
}
