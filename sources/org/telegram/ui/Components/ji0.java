...
public final class ji0 extends Button {
    public final RectF f25416a;
    public final Paint f25417b;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Paint paint = this.f25417b;
        paint.setAlpha(min);
        canvas.drawArc(rectF, this.f25419f, 220.0f, false, paint);
        long currentTimeMillis = System.currentTimeMillis();
        if (Math.abs(this.e - System.currentTimeMillis()) < 1000) {
            long j3 = currentTimeMillis - this.e;
            int i10 = (int) (this.f25419f + (((float) (360 * j3)) / 2000.0f));
            this.f25419f = i10 - ((i10 / 360) * 360);
            if (this.f25418c) {
                float f7 = this.d;
                if (f7 < 1.0f) {
