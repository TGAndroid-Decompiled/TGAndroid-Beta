...
public class ji0 extends org.telegram.ui.ActionBar.f3 {
    ...
    public ji0(Context context, String str, String str2, String str3, boolean z10) {
        ...
        try {
            ...
            this.f27513f = telegramQRCodeWriter.getImageSize();
            bitmap = encode;
        } catch (Exception e7) {
            FileLog.e(e7);
        }
    ...
    public final void n() {
        ...
        TextView textView2 = this.f27512e;
        if (textView2 != null) {
            textView2.setTextColor(getThemedColor(i10));
            textView2.setBackground(org.telegram.ui.ActionBar.j6.f0(i0.a.k(getThemedColor(i10), Math.min(255, Color.alpha(getThemedColor(org.telegram.ui.ActionBar.j6.f20754i6)) * 2)), 7, -1));
        }
        int i11 = org.telegram.ui.ActionBar.j6.f21043y6;
        int themedColor4 = getThemedColor(i11);
        TextView textView3 = this.f27511c;
        ...
        setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f20735h5));
    }
}
