...
public final class az0 {
    public final org.telegram.ui.ActionBar.f6 f22818a;
    public StaticLayout f22819b;
    public final ArrayList f22820c = new ArrayList(2);
    public int d;
    public int e;
    public int f22821f;
    public int f22822g;
    ...
    public final void b(MessageObject messageObject) {
        ...
        org.telegram.ui.ActionBar.f6 f6Var = this.f22818a;
        if (f6Var != null) {
        ...
        this.f22822g = AndroidUtilities.dp(14.0f) * 2;
        ArrayList arrayList = this.f22820c;
        arrayList.clear();
        ...
        while (i16 < size) {
            ...
            i16++;
            zy0 zy0Var = (zy0) obj;
            f10 = Math.max(f10, zy0Var.f30957a.l());
            f11 = Math.max(f11, zy0Var.f30958b.l());
            int j3 = ((int) zy0Var.f30957a.j()) + this.f22822g;
            this.f22822g = j3;
            this.f22822g = AndroidUtilities.dp(7.0f) + j3;
        }
        ...
        this.f22819b = new StaticLayout(AndroidUtilities.replaceTags(spannableStringBuilder), textPaint, max, Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
        int i30 = 0;
        for (int i31 = 0; i31 < this.f22819b.getLineCount(); i31++) {
            i30 = (int) Math.max(i30, this.f22819b.getLineWidth(i31));
        }
        int height = this.f22819b.getHeight() + this.f22822g;
        this.f22822g = height;
        this.f22822g = AndroidUtilities.dp(5.0f) + height;
        int D = org.telegram.messenger.l0.D(24.0f, 2, Math.max(dp, i30));
        this.h = D;
        this.d = (D - max) / 2;
        this.e = (D - dp) / 2;
        this.f22821f = (int) (AndroidUtilities.dp(f7) + i15 + f10);
    }
}
