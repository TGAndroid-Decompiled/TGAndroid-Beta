...
public final class az0 {
    public final org.telegram.ui.ActionBar.d6 f22782a;
    public StaticLayout f22783b;
    public final ArrayList f22784c = new ArrayList(2);
    public int d;
    public int e;
    public int f22785f;
    public int f22786g;
    ...
    public az0(org.telegram.ui.ActionBar.d6 d6Var) {
        this.f22782a = d6Var;
    }
    ...
    public final void b(MessageObject messageObject) {
        ...
        org.telegram.ui.ActionBar.d6 d6Var = this.f22782a;
        if (d6Var != null) {
        ...
        this.f22786g = AndroidUtilities.dp(14.0f) * 2;
        ArrayList arrayList = this.f22784c;
        arrayList.clear();
        ...
        while (i16 < size) {
            ...
            i16++;
            zy0 zy0Var = (zy0) obj;
            f10 = Math.max(f10, zy0Var.f31009a.l());
            f11 = Math.max(f11, zy0Var.f31010b.l());
            int j3 = ((int) zy0Var.f31009a.j()) + this.f22786g;
            this.f22786g = j3;
            this.f22786g = AndroidUtilities.dp(7.0f) + j3;
        }
        ...
        this.f22783b = new StaticLayout(AndroidUtilities.replaceTags(spannableStringBuilder), textPaint, max, Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
        int i30 = 0;
        for (int i31 = 0; i31 < this.f22783b.getLineCount(); i31++) {
            i30 = (int) Math.max(i30, this.f22783b.getLineWidth(i31));
        }
        int height = this.f22783b.getHeight() + this.f22786g;
        this.f22786g = height;
        this.f22786g = AndroidUtilities.dp(5.0f) + height;
        int D = org.telegram.messenger.f0.D(24.0f, 2, Math.max(dp, i30));
        this.h = D;
        this.d = (D - max) / 2;
        this.e = (D - dp) / 2;
        this.f22785f = (int) (AndroidUtilities.dp(f7) + i15 + f10);
    }
}
