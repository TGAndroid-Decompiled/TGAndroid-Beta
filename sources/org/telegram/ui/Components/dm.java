...
public abstract class dm extends org.telegram.ui.lu0 {
    public final ChatAttachAlertPhotoLayout f23674a;

    public dm(ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout) {
        this.f23674a = chatAttachAlertPhotoLayout;
    }
    ...
    public final int R(int i10) {
        ...
        MediaController.PhotoEntry b02 = this.f23674a.b0(i10);
        if (b02 == null) {
            return -1;
        }
    ...
    public final int k(int i10, VideoEditedInfo videoEditedInfo) {
        boolean z10;
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.f23674a;
