...
public final class dm extends CameraView {
    public final ai.w4 f23360a;
    public boolean f23361b;
    public final ChatAttachAlertPhotoLayout f23362c;

    public dm(ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout, Context context, boolean z10, boolean z11) {
        super(context, z10, z11);
        this.f23362c = chatAttachAlertPhotoLayout;
        this.f23360a = new ai.w4(this, 7);
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        float f7;
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.f23362c;
        vi viVar = chatAttachAlertPhotoLayout.f26462b;
        if (AndroidUtilities.makingGlobalBlurBitmap) {
            return;
        }
        if (!this.f23361b && (chatAttachAlertPhotoLayout.f21909d0 || !chatAttachAlertPhotoLayout.f21905b0)) {
            ...
            if (z10) {
                ...
                float f10 = chatAttachAlertPhotoLayout.f21929n1;
                boolean z11 = ChatAttachAlertPhotoLayout.f21898q1;
                float f11 = 1.0f - chatAttachAlertPhotoLayout.f21911e0;
                rectF.set((0.0f * f11) + f10, (f11 * chatAttachAlertPhotoLayout.W) + chatAttachAlertPhotoLayout.f21924k1, chatAttachAlertPhotoLayout.f21926m1, AndroidUtilities.lerp(Math.min(min, chatAttachAlertPhotoLayout.l1), getMeasuredHeight(), chatAttachAlertPhotoLayout.f21911e0));
    ...
    public final void onAttachedToWindow() {
        ...
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.f23362c;
        oc.a(chatAttachAlertPhotoLayout.P, this.f23360a);
