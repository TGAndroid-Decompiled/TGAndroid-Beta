...
public final class jy0 implements Runnable {
    ...
    public final void run() {
        ...
        String o10;
        int i18 = this.f28214a;
        TLRPC.TL_wallPaper tL_wallPaper = null;
        int i19 = 0;
        Object obj = this.f28218f;
        Object obj2 = this.f28217e;
        Object obj3 = this.d;
        Object obj4 = this.f28216c;
        Object obj5 = this.f28215b;
        switch (i18) {
            case 0:
                ky0 ky0Var = (ky0) obj5;
                ...
                if (U != null) {
                    ...
                    if (userFull != null) {
                        ...
                        MessagesStorage.getInstance(ky0Var.f28514a).updateUserInfo(userFull, false);
                    }
                    if (tL_error != null && (str = tL_error.text) != null && str.startsWith("FLOOD_WAIT_")) {
                        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(ky0Var.f28515b.getContext());
            ...
            case 1:
                ...
                if (((MessagesController) obj4).isDialogMuted(w21Var.f32622c, tL_forumTopic.f20897id)) {
                    q70Var.u();
                    NotificationsController.getInstance(w21Var.f32620b).muteDialog(w21Var.f32622c, tL_forumTopic.f20897id, false);
                    if (qc.a(xnVar)) {
                ...
                if (((TLRPC.TL_error) obj) == null && (tLObject2 instanceof TLRPC.TL_messages_myStickers)) {
                    ...
                    while (i19 < size) {
                        ...
                        if (!stickerSet.emojis && !stickerSet.masks) {
                            ...
                            tL_inputStickerSetID.f20865id = stickerSetCovered2.set.f20872id;
                            TLRPC.TL_messages_stickerSet stickerSet2 = MediaDataController.getInstance(qtVar.f40663r).getStickerSet((TLRPC.InputStickerSet) tL_inputStickerSetID, true);
                    ...
                    if (tL_messages_myStickers.sets.size() == tL_messages_getMyStickers.limit) {
                        tL_messages_getMyStickers.offset_id = ((TLRPC.StickerSetCovered) l.d.i(1, tL_messages_myStickers.sets)).set.f20872id;
                        ConnectionsManager.getInstance(qtVar.f40663r).sendRequest(tL_messages_getMyStickers, new org.telegram.ui.ba(qtVar, arrayList, tL_messages_getMyStickers, 7));
                        return;
                    }
                    return;
                }
            ...
            case 6:
                ...
                if (tLObject3 instanceof TLRPC.TL_wallPaper) {
                    ...
                    jd1Var.C1 = z4;
                    jd1Var.B1 = z10;
                    jd1Var.f37993k1 = wallPaperSettings3.intensity;
            ...
            case 7:
                ...
                if (pyVar != null) {
                    ...
                    ((org.telegram.ui.xn) p2Var).W9(user.f20992id, str4, true);
                    return;
                } else {
                    return;
                }
            ...
            case 10:
                ...
                int i20 = xb0Var.f43001b;
                LaunchActivity launchActivity5 = xb0Var.f43000a;
                if (tL_error5 != null) {
                ...
                if (str7 != null) {
                    if (str7.contains("EMAIL_INVALID")) {
                        ...
                        if (tL_error7.text.contains("PHONE_CODE_EXPIRED")) {
                            ...
                            z4.f0(i13, tL_error7, og0Var2, sendverifyemailcode, ef0Var.f36482w);
                            return;
                        } else {
                            return;
                        }
            ...
            case 15:
                ...
                if (tLObject10 instanceof TLRPC.PaymentForm) {
                                        ...
                                        public final void run() {
                                            switch (r4) {
                                                case 0:
                                                    ...
                                                    xf0 xf0Var3 = xf0Var2;
                                                    if (!xf0Var3.f43029f) {
                                                        xf0Var3.f43029f = true;
                                                        xf0Var3.h = str8;
                                                        xf0Var3.f43030n = str9;
                                                        xf0Var3.f43031r = j10;
                                                        xf0Var3.f43026b.setLoading(true);
                                                        xf0Var3.p();
                                                        return;
                                                    }
                                                    return;
                                                default:
                                                    ...
                                                    xf0 xf0Var4 = xf0Var2;
                                                    if (!xf0Var4.f43029f) {
                                                        xf0Var4.f43029f = true;
                                                        xf0Var4.h = str10;
                                                        xf0Var4.f43030n = str11;
                                                        xf0Var4.f43031r = j11;
                                                        xf0Var4.f43026b.setLoading(true);
                                                        xf0Var4.p();
                                                        return;
                                                    }
                                                    return;
                                        ...
                                        public final void run() {
                                            switch (r4) {
                                                case 0:
                                                    ...
                                                    if (!xf0Var32.f43029f) {
                                                        xf0Var32.f43029f = true;
                                                        xf0Var32.h = str8;
                                                        xf0Var32.f43030n = str9;
                                                        xf0Var32.f43031r = j10;
                                                        xf0Var32.f43026b.setLoading(true);
                                                        xf0Var32.p();
                                                        return;
                                                    }
                                                    return;
                    ...
                    lo0Var2.f38709a1 = new Utilities.Callback() {
                        @Override
                        public final void run(Object obj6) {
                            switch (r4) {
                                case 0:
                    ...
                    lo0Var2.f38712b1 = new org.telegram.ui.i20(xf0Var, 1);
            ...
            case 16:
                ...
                if (tL_error10 == null && bVar != null) {
                    ...
                    z91Var.f43862e = bVar;
                    z91Var.f43861c = tL_loadAsyncGraph.f21076x;
                    bj0Var.g0();
                    return;
                }
                bj0Var.g0();
            ...
            case 18:
                ...
                org.telegram.ui.fn0 fn0Var = ((org.telegram.ui.nm0) obj5).f39404a;
                if (tL_error11 != null) {
                ...
                ((org.telegram.ui.im0) fn0Var.f36878y1).c(fn0Var.B, (String) fn0Var.f36855p1.get("email"), null, null, null, null, null, null, null, null, gl0Var, qaVar);
                return;
            case 19:
                ...
                if (tL_error12 != null) {
                    ...
                    if (f02 != null && tL_error12.text.contains("PHONE_CODE_EXPIRED")) {
                        f02.f21251j0 = new org.telegram.ui.wm0(bn0Var, 0);
                    }
                } else {
            ...
            case 21:
                ...
                PhotoViewer photoViewer = ((org.telegram.ui.rt0) obj5).f40943r;
                photoViewer.f34332m4 = null;
                org.telegram.ui.iu0 iu0Var = photoViewer.f34230b0;
                if (iu0Var != null && photoViewer.f34248d0 != null) {
                    iu0Var.setLayerType(0, null);
                    photoViewer.f34316k4 = 0;
                    photoViewer.F1();
                    photoViewer.f34324l4 = 0L;
                    photoViewer.D1 = null;
                    photoViewer.B1.f51159a = false;
                    photoViewer.E1 = null;
                    photoViewer.C1.f51159a = false;
                    photoViewer.D2();
                    photoViewer.z2();
                    ...
                    org.telegram.ui.qu0 qu0Var = photoViewer.f34342n4;
                    if (qu0Var != null) {
                        qu0Var.f40678a.setVisible(true, true);
                    }
                    org.telegram.ui.qu0 qu0Var2 = photoViewer.f34351o4;
                    ...
                    if (j71Var != null && j71Var.y() && photoViewer.f34348o1 && !photoViewer.f34255d7.isEmpty()) {
            ...
            case 25:
                ...
                if (tLObject12 instanceof TL_fragment.TL_collectibleInfo) {
                    ...
                    qc qcVar = new qc(mz0Var.f28853w, profileActivity2.f34714w0);
                    ...
                    ic w10 = qcVar.w(i22, AndroidUtilities.withLearnMore(AndroidUtilities.replaceTags(LocaleController.formatString(i23, str10, format, formatCurrency, o10)), new org.telegram.ui.pr0(18, profileActivity2, tL_collectibleInfo)));
                    org.telegram.ui.hb0 hb0Var = new org.telegram.ui.hb0(14, profileActivity2, tL_collectibleInfo);
                    nb nbVar = w10.f27774e;
                    if (nbVar != null) {
            ...
            case 28:
                ...
                if (((String) obj4).equals(x01Var.f42893y)) {
                    if (!x01Var.f42891w && (p2Var2 instanceof ProfileActivity)) {
                        try {
                            ((ProfileActivity) p2Var2).M.f34031b.getImageReceiver().startAnimation();
                    ...
                    x01Var.f42891w = true;
                    x01Var.f42889r = arrayList5;
                    x01Var.f42890s = arrayList6;
                    x01Var.f42888n = arrayList7;
                    x01Var.l();
    ...
    public jy0(KeyEvent.Callback callback, TLObject tLObject, Object obj, TLRPC.TL_error tL_error, TLObject tLObject2, int i10) {
        this.f28214a = i10;
        this.f28215b = callback;
        this.f28216c = tLObject;
        this.d = obj;
        this.f28218f = tL_error;
        this.f28217e = tLObject2;
    }
    ...
    public jy0(org.telegram.ui.bn0 bn0Var, TLRPC.TL_error tL_error, Bundle bundle, TLObject tLObject, TLRPC.TL_auth_resendCode tL_auth_resendCode) {
        ...
        this.d = bundle;
        this.f28216c = tLObject;
        this.f28217e = tL_auth_resendCode;
    }
}
