...
public final class mp extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    public static final int f26192i0 = 0;
    ...
    public boolean f26195b0;
    public final org.telegram.ui.ActionBar.g2 f26196c;
    public oq f26197c0;
    public final TextView d;
    public boolean f26198d0;
    public final TextView e;
    public boolean f26199e0;
    public TLRPC.WallPaper f26200f;
    public TL_stories.TL_premium_boostsStatus f26201f0;
    public float f26202g0;
    public final kp h;
    public ValueAnimator f26203h0;
    public final org.telegram.ui.zn f26204n;
    public final org.telegram.ui.ActionBar.d4 f26205r;
    public final boolean f26206s;
    public final org.telegram.ui.bo v;
    public final ll0 f26207w;
    public final s4.c0 f26208x;
    public final t00 f26209y;
    ...
    public mp(org.telegram.ui.bo boVar, org.telegram.ui.zn znVar) {
        ...
        this.v = boVar;
        this.f26204n = znVar;
        this.f26205r = znVar.f40244f;
        this.f26200f = znVar.h;
        this.f26206s = org.telegram.ui.ActionBar.i6.I.q();
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            int i10 = org.telegram.ui.ActionBar.i6.f18925i5;
            ...
            fixNavigationBar(getThemedColor(org.telegram.ui.ActionBar.i6.f18925i5));
        }
    ...
    public static void o(mp mpVar, View view, int i10) {
        ...
        if (kpVar.d.get(i10) != mpVar.M && mpVar.R == null) {
            ...
            if (!((lp) kpVar.d.get(i10)).f25994a.f18589a) {
                ((u11) view).d();
            }
            mpVar.F(true);
        }
    ...
    public static void q(mp mpVar, vd1 vd1Var) {
        ...
        obj.f19368a = true;
        org.telegram.ui.bo boVar = mpVar.v;
        vd1Var.f38513a.f38499a = boVar.getResourceProvider();
        vd1Var.f38556p1 = new ep(mpVar);
        obj.f19370c = new sh(3);
        obj.d = new uo(mpVar, 5);
        obj.f19369b = new uo(mpVar, 6);
        obj.e = true;
        mpVar.X = vd1Var;
        boVar.showAsSheet(vd1Var, obj);
    }
    ...
    public final void E() {
        ...
        ImageView imageView = this.f26194b;
        imageView.setBackground(f02);
        int themedColor = getThemedColor(i11);
        org.telegram.ui.ActionBar.g2 g2Var = this.f26196c;
        g2Var.a(themedColor);
        ...
        int themedColor2 = getThemedColor(org.telegram.ui.ActionBar.i6.f19000m5);
    ...
    public final void dismiss() {
        ...
        this.v.getClass();
        if (!this.O) {
            org.telegram.ui.zn znVar = this.f26204n;
            TLRPC.WallPaper wallPaper = znVar.h;
            if (wallPaper == null) {
                wallPaper = this.f26200f;
            }
            znVar.i(this.f26205r, wallPaper, true, Boolean.valueOf(this.f26206s), false);
        }
        if (this.N != this.f26206s) {
            if (org.telegram.ui.ActionBar.i6.I.q() == this.f26206s) {
            ...
            org.telegram.ui.ActionBar.i6.t(N0, false, this.f26206s);
        }
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        int i10 = 0;
        arrayList.add(new org.telegram.ui.ActionBar.k6(null, 32, null, null, new Drawable[]{this.shadowDrawable}, jpVar, org.telegram.ui.ActionBar.i6.f18907h5));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.E, 4, null, null, null, null, org.telegram.ui.ActionBar.i6.f18943j5));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f26207w, 16, new Class[]{u11.class}, null, null, null, org.telegram.ui.ActionBar.i6.f18925i5));
        int i11 = org.telegram.ui.ActionBar.i6.Oh;
        View view = this.I;
        ...
        while (i10 < size) {
            ...
            i10++;
            ((org.telegram.ui.ActionBar.k6) obj).f19364o = this.f26204n;
        }
        return arrayList;
    }
    ...
    public final void t() {
        if (v()) {
            ...
            alertDialog$Builder.f18437a.R = LocaleController.getString(R.string.ChatThemeSaveDialogTitle);
            alertDialog$Builder.f18437a.T = LocaleController.getString(R.string.ChatThemeSaveDialogText);
            alertDialog$Builder.k(LocaleController.getString(R.string.ChatThemeSaveDialogApply), new org.telegram.ui.ActionBar.a2(this) {
                public final mp f30025b;
                ...
                public final void f(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
                    switch (r2) {
                        case 0:
                            this.f30025b.s(false);
                            return;
                        default:
                            this.f30025b.dismiss();
                            return;
                    }
                }
            });
    ...
    public final void u() {
        ...
        if (!isDismissed() && !this.O) {
            ...
            if (v()) {
                ...
                wallPaper = this.f26204n.h;
            }
            TLRPC.WallPaper wallPaper2 = wallPaper;
            org.telegram.ui.ActionBar.d4 d4Var = this.M.f25994a;
            if (d4Var.f18589a) {
                this.f26204n.i(null, wallPaper2, false, Boolean.valueOf(this.N), true);
            } else {
                this.f26204n.i(d4Var, wallPaper2, false, Boolean.valueOf(this.N), true);
            }
            vi viVar = this.Y;
            if (viVar != null) {
                jj jjVar = viVar.f28786r0;
                if (jjVar != null) {
                    boolean z10 = this.N;
                    xa xaVar = jjVar.v;
            ...
            if (kpVar != null && kpVar.d != null) {
                for (int i10 = 0; i10 < kpVar.d.size(); i10++) {
                    ((lp) kpVar.d.get(i10)).f25996c = this.N ? 1 : 0;
                }
                kpVar.l();
            }
        }
    ...
    public final boolean v() {
        ...
        org.telegram.ui.ActionBar.d4 d4Var2 = this.M.f25994a;
        if (d4Var2 != null) {
    ...
    public final void x(List list) {
        ...
        if (list != null && !list.isEmpty()) {
            ...
            if (!this.V) {
                org.telegram.ui.ActionBar.d4 d4Var = this.f26204n.f40244f;
                this.W = d4Var;
                if (d4Var != null) {
                    d4Var.l();
                }
            ...
            for (int i10 = 1; i10 < list.size(); i10++) {
                ...
                lpVar2.f25996c = this.N ? 1 : 0;
                if (fg.b.a(d4Var3.f18591c, bVar)) {
            ...
            if (!this.V) {
                z(false);
                this.f26207w.animate().alpha(1.0f).setDuration(150L).start();
            }
            this.V = true;
            F(true);
        }
    ...
    public final void y() {
        ...
        if (!isDismissed() && !this.O) {
            ...
            org.telegram.ui.ActionBar.d4 d4Var = this.M.f25994a;
            if (d4Var.f18589a) {
                this.f26204n.i(null, wallPaper2, true, Boolean.valueOf(this.N), false);
                return;
            }
            this.f26204n.i(d4Var, wallPaper2, true, Boolean.valueOf(this.N), false);
        }
    }
    ...
    public final void z(boolean z10) {
        ...
        org.telegram.ui.ActionBar.d4 d4Var = this.W;
        s4.c0 c0Var = this.f26208x;
        ll0 ll0Var = this.f26207w;
        if (d4Var != null) {
            int i10 = 0;
            while (true) {
                if (i10 != arrayList.size()) {
                    if (fg.b.a(((lp) arrayList.get(i10)).f25994a.f18591c, this.W.f18591c)) {
