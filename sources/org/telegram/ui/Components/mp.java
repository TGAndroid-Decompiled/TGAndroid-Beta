...
public final class mp extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    public static final int f26191i0 = 0;
    ...
    public boolean f26194b0;
    public final org.telegram.ui.ActionBar.g2 f26195c;
    public oq f26196c0;
    public final TextView d;
    public boolean f26197d0;
    public final TextView e;
    public boolean f26198e0;
    public TLRPC.WallPaper f26199f;
    public TL_stories.TL_premium_boostsStatus f26200f0;
    public float f26201g0;
    public final kp h;
    public ValueAnimator f26202h0;
    public final org.telegram.ui.zn f26203n;
    public final org.telegram.ui.ActionBar.d4 f26204r;
    public final boolean f26205s;
    public final org.telegram.ui.bo v;
    public final ll0 f26206w;
    public final s4.c0 f26207x;
    public final t00 f26208y;
    ...
    public mp(org.telegram.ui.bo boVar, org.telegram.ui.zn znVar) {
        ...
        this.v = boVar;
        this.f26203n = znVar;
        this.f26204r = znVar.f40237f;
        this.f26199f = znVar.h;
        this.f26205s = org.telegram.ui.ActionBar.i6.I.q();
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            int i10 = org.telegram.ui.ActionBar.i6.f18922i5;
            ...
            fixNavigationBar(getThemedColor(org.telegram.ui.ActionBar.i6.f18922i5));
        }
        ...
        ll0Var.setOnItemClickListener(new j(this, 3));
        ...
        n6Var.setTextColor(getThemedColor(i12));
        ...
        n6Var2.setTextColor(getThemedColor(i12));
    ...
    public static void m(mp mpVar, ChannelBoostsController.CanApplyBoost canApplyBoost) {
        ...
        j0Var.F1(mpVar.f26200f0, true);
        j0Var.H1(mpVar.v.a());
        j0Var.Q0 = new uo(mpVar, 2);
        j0Var.show();
    }

    public static void n(mp mpVar, org.telegram.ui.bo boVar) {
        if (mpVar.f26199f != null) {
            mpVar.f26199f = null;
            mpVar.dismiss();
    ...
    public static void o(mp mpVar, View view, int i10) {
        ...
        if (kpVar.d.get(i10) != mpVar.M && mpVar.R == null) {
            ...
            if (!((lp) kpVar.d.get(i10)).f25997a.f18587a) {
                ((u11) view).d();
            }
            mpVar.F(true);
        }
    ...
    public static void q(mp mpVar, wd1 wd1Var) {
        ...
        obj.f19364a = true;
        org.telegram.ui.bo boVar = mpVar.v;
        wd1Var.f38786a.f38773a = boVar.getResourceProvider();
        wd1Var.f38829p1 = new ep(mpVar);
        obj.f19366c = new sh(3);
        obj.d = new uo(mpVar, 5);
        obj.f19365b = new uo(mpVar, 6);
        obj.e = true;
        mpVar.X = wd1Var;
        boVar.showAsSheet(wd1Var, obj);
    }
    ...
    public final void E() {
        ...
        ImageView imageView = this.f26193b;
        imageView.setBackground(f02);
        int themedColor = getThemedColor(i11);
        org.telegram.ui.ActionBar.g2 g2Var = this.f26195c;
        g2Var.a(themedColor);
        ...
        int themedColor2 = getThemedColor(org.telegram.ui.ActionBar.i6.f18997m5);
    ...
    public final void F(boolean r19) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.mp.F(boolean):void");
    }
    ...
    public final void dismiss() {
        ...
        this.v.getClass();
        if (!this.O) {
            org.telegram.ui.zn znVar = this.f26203n;
            TLRPC.WallPaper wallPaper = znVar.h;
            if (wallPaper == null) {
                wallPaper = this.f26199f;
            }
            znVar.i(this.f26204r, wallPaper, true, Boolean.valueOf(this.f26205s), false);
        }
        if (this.N != this.f26205s) {
            if (org.telegram.ui.ActionBar.i6.I.q() == this.f26205s) {
            ...
            org.telegram.ui.ActionBar.i6.t(N0, false, this.f26205s);
        }
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        int i10 = 0;
        arrayList.add(new org.telegram.ui.ActionBar.k6(null, 32, null, null, new Drawable[]{this.shadowDrawable}, jpVar, org.telegram.ui.ActionBar.i6.f18904h5));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.E, 4, null, null, null, null, org.telegram.ui.ActionBar.i6.f18940j5));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f26206w, 16, new Class[]{u11.class}, null, null, null, org.telegram.ui.ActionBar.i6.f18922i5));
        int i11 = org.telegram.ui.ActionBar.i6.Oh;
        View view = this.I;
        ...
        while (i10 < size) {
            ...
            i10++;
            ((org.telegram.ui.ActionBar.k6) obj).f19360o = this.f26203n;
        }
        return arrayList;
    }
    ...
    public final void t() {
        if (v()) {
            ...
            alertDialog$Builder.f18435a.R = LocaleController.getString(R.string.ChatThemeSaveDialogTitle);
            alertDialog$Builder.f18435a.T = LocaleController.getString(R.string.ChatThemeSaveDialogText);
            alertDialog$Builder.k(LocaleController.getString(R.string.ChatThemeSaveDialogApply), new org.telegram.ui.ActionBar.a2(this) {
                public final mp f30022b;
                ...
                public final void f(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
                    switch (r2) {
                        case 0:
                            this.f30022b.s(false);
                            return;
                        default:
                            this.f30022b.dismiss();
                            return;
                    }
                }
            });
    ...
    public final void u() {
        ...
        if (!isDismissed() && !this.O) {
            ...
            if (v()) {
                ...
                wallPaper = this.f26203n.h;
            }
            TLRPC.WallPaper wallPaper2 = wallPaper;
            org.telegram.ui.ActionBar.d4 d4Var = this.M.f25997a;
            if (d4Var.f18587a) {
                this.f26203n.i(null, wallPaper2, false, Boolean.valueOf(this.N), true);
            } else {
                this.f26203n.i(d4Var, wallPaper2, false, Boolean.valueOf(this.N), true);
            }
            vi viVar = this.Y;
            if (viVar != null) {
                jj jjVar = viVar.f28783r0;
                if (jjVar != null) {
                    boolean z10 = this.N;
                    xa xaVar = jjVar.v;
            ...
            if (kpVar != null && kpVar.d != null) {
                for (int i10 = 0; i10 < kpVar.d.size(); i10++) {
                    ((lp) kpVar.d.get(i10)).f25999c = this.N ? 1 : 0;
                }
                kpVar.l();
            }
        }
    ...
    public final boolean v() {
        ...
        org.telegram.ui.ActionBar.d4 d4Var2 = this.M.f25997a;
        if (d4Var2 != null) {
    ...
    public final void x(List list) {
        ...
        if (list != null && !list.isEmpty()) {
            ...
            if (!this.V) {
                org.telegram.ui.ActionBar.d4 d4Var = this.f26203n.f40237f;
                this.W = d4Var;
                if (d4Var != null) {
                    d4Var.l();
                }
            ...
            for (int i10 = 1; i10 < list.size(); i10++) {
                ...
                lpVar2.f25999c = this.N ? 1 : 0;
                if (fg.b.a(d4Var3.f18589c, bVar)) {
            ...
            if (!this.V) {
                z(false);
                this.f26206w.animate().alpha(1.0f).setDuration(150L).start();
            }
            this.V = true;
            F(true);
        }
    ...
    public final void y() {
        ...
        if (!isDismissed() && !this.O) {
            ...
            org.telegram.ui.ActionBar.d4 d4Var = this.M.f25997a;
            if (d4Var.f18587a) {
                this.f26203n.i(null, wallPaper2, true, Boolean.valueOf(this.N), false);
                return;
            }
            this.f26203n.i(d4Var, wallPaper2, true, Boolean.valueOf(this.N), false);
        }
    }
    ...
    public final void z(boolean z10) {
        ...
        org.telegram.ui.ActionBar.d4 d4Var = this.W;
        s4.c0 c0Var = this.f26207x;
        ll0 ll0Var = this.f26206w;
        if (d4Var != null) {
            int i10 = 0;
            while (true) {
                if (i10 != arrayList.size()) {
                    if (fg.b.a(((lp) arrayList.get(i10)).f25997a.f18589c, this.W.f18589c)) {
