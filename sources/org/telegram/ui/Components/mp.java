...
public final class mp extends org.telegram.ui.ActionBar.g3 implements NotificationCenter.NotificationCenterDelegate {
    public static final int f26219i0 = 0;
    ...
    public boolean f26222b0;
    public final org.telegram.ui.ActionBar.h2 f26223c;
    public oq f26224c0;
    public final TextView d;
    public boolean f26225d0;
    public final TextView e;
    public boolean f26226e0;
    public TLRPC.WallPaper f26227f;
    public TL_stories.TL_premium_boostsStatus f26228f0;
    public float f26229g0;
    public final kp h;
    public ValueAnimator f26230h0;
    public final org.telegram.ui.zn f26231n;
    public final org.telegram.ui.ActionBar.e4 f26232r;
    public final boolean f26233s;
    public final org.telegram.ui.bo v;
    public final ml0 f26234w;
    public final s4.c0 f26235x;
    public final t00 f26236y;
    ...
    public mp(org.telegram.ui.bo boVar, org.telegram.ui.zn znVar) {
        ...
        this.v = boVar;
        this.f26231n = znVar;
        this.f26232r = znVar.f40280f;
        this.f26227f = znVar.h;
        this.f26233s = org.telegram.ui.ActionBar.j6.I.q();
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            int i10 = org.telegram.ui.ActionBar.j6.f18951i5;
            ...
            fixNavigationBar(getThemedColor(org.telegram.ui.ActionBar.j6.f18951i5));
        }
        ...
        ml0Var.setOnItemClickListener(new j(this, 3));
    ...
    public static void o(mp mpVar, View view, int i10) {
        ...
        if (kpVar.d.get(i10) != mpVar.M && mpVar.R == null) {
            ...
            if (!((lp) kpVar.d.get(i10)).f25954a.f18617a) {
                ((v11) view).d();
            }
            mpVar.F(true);
        }
    ...
    public static void q(mp mpVar, xd1 xd1Var) {
        ...
        obj.f19397a = true;
        org.telegram.ui.bo boVar = mpVar.v;
        xd1Var.f39531a.f39517a = boVar.getResourceProvider();
        xd1Var.f39574p1 = new ep(mpVar);
        obj.f19399c = new sh(3);
        obj.d = new uo(mpVar, 5);
        obj.f19398b = new uo(mpVar, 6);
        obj.e = true;
        mpVar.X = xd1Var;
        boVar.showAsSheet(xd1Var, obj);
    }
    ...
    public final void E() {
        ...
        ImageView imageView = this.f26221b;
        imageView.setBackground(f02);
        int themedColor = getThemedColor(i11);
        org.telegram.ui.ActionBar.h2 h2Var = this.f26223c;
        h2Var.a(themedColor);
        ...
        int themedColor2 = getThemedColor(org.telegram.ui.ActionBar.j6.f19026m5);
    ...
    public final void dismiss() {
        ...
        this.v.getClass();
        if (!this.O) {
            org.telegram.ui.zn znVar = this.f26231n;
            TLRPC.WallPaper wallPaper = znVar.h;
            if (wallPaper == null) {
                wallPaper = this.f26227f;
            }
            znVar.i(this.f26232r, wallPaper, true, Boolean.valueOf(this.f26233s), false);
        }
        if (this.N != this.f26233s) {
            if (org.telegram.ui.ActionBar.j6.I.q() == this.f26233s) {
            ...
            org.telegram.ui.ActionBar.j6.t(N0, false, this.f26233s);
        }
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        int i10 = 0;
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 32, null, null, new Drawable[]{this.shadowDrawable}, jpVar, org.telegram.ui.ActionBar.j6.f18933h5));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.E, 4, null, null, null, null, org.telegram.ui.ActionBar.j6.f18969j5));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f26234w, 16, new Class[]{v11.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18951i5));
        int i11 = org.telegram.ui.ActionBar.j6.Oh;
        View view = this.I;
        ...
        while (i10 < size) {
            ...
            i10++;
            ((org.telegram.ui.ActionBar.l6) obj).f19391o = this.f26231n;
        }
        return arrayList;
    }
    ...
    public final void t() {
        if (v()) {
            ...
            alertDialog$Builder.f18446a.R = LocaleController.getString(R.string.ChatThemeSaveDialogTitle);
            alertDialog$Builder.f18446a.T = LocaleController.getString(R.string.ChatThemeSaveDialogText);
            alertDialog$Builder.k(LocaleController.getString(R.string.ChatThemeSaveDialogApply), new org.telegram.ui.ActionBar.b2(this) {
                public final mp f29953b;
    ...
    public final void u() {
        ...
        if (!isDismissed() && !this.O) {
            ...
            if (v()) {
                ...
                wallPaper = this.f26231n.h;
            }
            TLRPC.WallPaper wallPaper2 = wallPaper;
            org.telegram.ui.ActionBar.e4 e4Var = this.M.f25954a;
            if (e4Var.f18617a) {
                this.f26231n.i(null, wallPaper2, false, Boolean.valueOf(this.N), true);
            } else {
                this.f26231n.i(e4Var, wallPaper2, false, Boolean.valueOf(this.N), true);
            }
            vi viVar = this.Y;
            if (viVar != null) {
                jj jjVar = viVar.f28778r0;
                if (jjVar != null) {
                    boolean z10 = this.N;
                    xa xaVar = jjVar.v;
            ...
            if (kpVar != null && kpVar.d != null) {
                for (int i10 = 0; i10 < kpVar.d.size(); i10++) {
                    ((lp) kpVar.d.get(i10)).f25956c = this.N ? 1 : 0;
                }
                kpVar.l();
            }
        }
    ...
    public final boolean v() {
        ...
        org.telegram.ui.ActionBar.e4 e4Var2 = this.M.f25954a;
        if (e4Var2 != null) {
    ...
    public final void x(List list) {
        ...
        if (list != null && !list.isEmpty()) {
            ...
            if (!this.V) {
                org.telegram.ui.ActionBar.e4 e4Var = this.f26231n.f40280f;
                this.W = e4Var;
                if (e4Var != null) {
                    e4Var.l();
                }
            ...
            for (int i10 = 1; i10 < list.size(); i10++) {
                ...
                lpVar2.f25956c = this.N ? 1 : 0;
                if (fg.b.a(e4Var3.f18619c, bVar)) {
            ...
            if (!this.V) {
                z(false);
                this.f26234w.animate().alpha(1.0f).setDuration(150L).start();
            }
            this.V = true;
            F(true);
        }
    ...
    public final void y() {
        ...
        if (!isDismissed() && !this.O) {
            ...
            org.telegram.ui.ActionBar.e4 e4Var = this.M.f25954a;
            if (e4Var.f18617a) {
                this.f26231n.i(null, wallPaper2, true, Boolean.valueOf(this.N), false);
                return;
            }
            this.f26231n.i(e4Var, wallPaper2, true, Boolean.valueOf(this.N), false);
        }
    }
    ...
    public final void z(boolean z10) {
        ...
        org.telegram.ui.ActionBar.e4 e4Var = this.W;
        s4.c0 c0Var = this.f26235x;
        ml0 ml0Var = this.f26234w;
        if (e4Var != null) {
            int i10 = 0;
            while (true) {
                if (i10 != arrayList.size()) {
                    if (fg.b.a(((lp) arrayList.get(i10)).f25954a.f18619c, this.W.f18619c)) {
