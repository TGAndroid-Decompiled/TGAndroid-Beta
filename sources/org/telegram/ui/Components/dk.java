...
public final class dk extends ll0 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        switch (this.X2) {
            case 0:
                if (this.Z2.f26820n == 2 && getChildCount() > 0) {
                    ...
                    this.Y2.setColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18904h5, false));
                }
                super.dispatchDraw(canvas);
                return;
            default:
                if (this.Z2.f26820n == 1 && getChildCount() > 0) {
