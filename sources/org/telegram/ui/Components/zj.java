...
public final class zj extends oi implements NotificationCenter.NotificationCenterDelegate, le.e {
    ...
    public qj J;
    public boolean K;
    public final le.c f30907n;
    public final FrameLayout f30908r;
    public final ai.w0 f30909s;
    public final hg.g0 v;
    public final HashMap f30910w;
    public final ArrayList f30911x;
    public boolean f30912y;

    public zj(Context context, org.telegram.ui.ActionBar.d6 d6Var, wi wiVar) {
        super(context, d6Var, wiVar);
        this.f30907n = new le.c(0, this, rr.h, 380L, false);
        this.f30910w = new HashMap();
        this.f30911x = new ArrayList();
        this.f30912y = false;
        ...
        w0Var.setGlowColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.A5, this.f27087a));
        ...
        NotificationCenter.getInstance(this.f27088b.J1).addObserver(this, NotificationCenter.contactsDidLoad);
        N();
    }

    public int getCurrentTop() {
        ai.w0 w0Var = this.f30909s;
    ...
    public final boolean I(final int i10, final boolean z10, int i11, final boolean z11, final long j3) {
        HashMap hashMap = this.f30910w;
        int i12 = 0;
        if ((hashMap.size() == 0 && this.J == null) || this.f30912y) {
            return false;
        }
        this.f30912y = true;
        final ArrayList arrayList = new ArrayList(hashMap.size());
        ArrayList arrayList2 = this.f30911x;
    ...
    public final void L(yj yjVar, Object obj) {
        ...
        ArrayList arrayList = this.f30911x;
        int i10 = 1;
        if (containsKey) {
            hashMap.remove(a2);
            arrayList.remove(a2);
    ...
    public final void N() {
        boolean z10;
        int i10 = 0;
        if (this.f30909s.getAdapter().h() == 2) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final void O() {
        View childAt;
        nz nzVar = this.G;
        if (nzVar.getVisibility() != 0 || (childAt = this.f30909s.getChildAt(0)) == null) {
            return;
        }
    ...
    public int getCurrentItemTop() {
        ...
        this.f30908r.setTranslationY(top);
    ...
    public int getListTopPadding() {
        return this.f30909s.getPaddingTop();
    }
    ...
    public ArrayList<org.telegram.ui.ActionBar.j6> getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(w0Var, 0, new Class[]{yj.class}, null, org.telegram.ui.ActionBar.h6.f19311r0, null, org.telegram.ui.ActionBar.h6.J7));
    ...
    @Override
    public final void m() {
        NotificationCenter.getInstance(this.f27088b.J1).removeObserver(this, NotificationCenter.contactsDidLoad);
    }
    ...
    public final void y(int i10, int i11) {
        ...
        this.f30909s.o1(0, i12 + AndroidUtilities.statusBarHeight, 0, this.e);
    }
