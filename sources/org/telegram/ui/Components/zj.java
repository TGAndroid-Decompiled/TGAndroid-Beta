...
public final class zj extends oi implements NotificationCenter.NotificationCenterDelegate, le.e {
    ...
    public qj J;
    public boolean K;
    public final le.c f30906n;
    public final FrameLayout f30907r;
    public final ai.w0 f30908s;
    public final hg.g0 v;
    public final HashMap f30909w;
    public final ArrayList f30910x;
    public boolean f30911y;

    public zj(Context context, org.telegram.ui.ActionBar.d6 d6Var, wi wiVar) {
        super(context, d6Var, wiVar);
        this.f30906n = new le.c(0, this, rr.h, 380L, false);
        this.f30909w = new HashMap();
        this.f30910x = new ArrayList();
        this.f30911y = false;
        ...
        w0Var.setGlowColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.A5, this.f27086a));
        ...
        NotificationCenter.getInstance(this.f27087b.J1).addObserver(this, NotificationCenter.contactsDidLoad);
        N();
    }

    public int getCurrentTop() {
        ai.w0 w0Var = this.f30908s;
    ...
    public final boolean I(final int i10, final boolean z10, int i11, final boolean z11, final long j3) {
        HashMap hashMap = this.f30909w;
        int i12 = 0;
        if ((hashMap.size() == 0 && this.J == null) || this.f30911y) {
            return false;
        }
        this.f30911y = true;
        final ArrayList arrayList = new ArrayList(hashMap.size());
        ArrayList arrayList2 = this.f30910x;
    ...
    public final void L(yj yjVar, Object obj) {
        ...
        ArrayList arrayList = this.f30910x;
        int i10 = 1;
        if (containsKey) {
            hashMap.remove(a2);
            arrayList.remove(a2);
    ...
    public final void N() {
        boolean z10;
        int i10 = 0;
        if (this.f30908s.getAdapter().h() == 2) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final void O() {
        View childAt;
        nz nzVar = this.G;
        if (nzVar.getVisibility() != 0 || (childAt = this.f30908s.getChildAt(0)) == null) {
            return;
        }
    ...
    public int getCurrentItemTop() {
        ...
        this.f30907r.setTranslationY(top);
    ...
    public int getListTopPadding() {
        return this.f30908s.getPaddingTop();
    }
    ...
    public ArrayList<org.telegram.ui.ActionBar.j6> getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(w0Var, 0, new Class[]{yj.class}, null, org.telegram.ui.ActionBar.h6.f19310r0, null, org.telegram.ui.ActionBar.h6.J7));
    ...
    @Override
    public final void m() {
        NotificationCenter.getInstance(this.f27087b.J1).removeObserver(this, NotificationCenter.contactsDidLoad);
    }
    ...
    public final void y(int i10, int i11) {
        ...
        this.f30908s.o1(0, i12 + AndroidUtilities.statusBarHeight, 0, this.e);
    }
