...
public final class o8 implements org.telegram.ui.ActionBar.a2, lq {
    ...
    public void x0(int i10, int i11, boolean z10) {
        c9 c9Var = this.f26725b;
        if (i11 != 0) {
            if (i11 != 1) {
                if (i11 != 2) {
                    if (i11 == 3) {
                        y8 y8Var = c9Var.Y;
                        int i12 = y8Var.f30176f;
                        if (i12 != i10 && (i12 == 0 || i10 == 0)) {
                            y8 a2 = y8Var.a();
                            c9Var.Y = a2;
                            c9Var.f22981a.b(a2, true);
                            c9Var.n0();
                        }
                        c9Var.Y.f30176f = i10;
                    }
            ...
            y8 y8Var4 = c9Var.Y;
            int i15 = y8Var4.f30175c;
            if (i15 != i10 && (i15 == 0 || i10 == 0)) {
                y8 a12 = y8Var4.a();
                c9Var.Y = a12;
                c9Var.f22981a.b(a12, true);
                c9Var.n0();
            }
            c9Var.Y.f30175c = i10;
        }
