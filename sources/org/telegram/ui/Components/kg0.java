...
public final class kg0 extends s4.s0 {
    ...
    public void a(RecyclerView recyclerView, int i10) {
        ...
        rg.n1 n1Var = null;
        boolean z10 = false;
        Object obj = this.f25599b;
        switch (i11) {
            case 0:
                qg0 qg0Var = (qg0) obj;
                jg0 jg0Var = qg0Var.f27340b;
                if (i10 == 0 && qg0.I(qg0Var) + ((qg0Var.E - qg0.H(qg0Var)) - AndroidUtilities.dp(13.0f)) < org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() && jg0Var.canScrollVertically(1)) {
                    jg0Var.getChildAt(0);
                    wk0 wk0Var2 = (wk0) jg0Var.K(0);
                    if (wk0Var2 != null) {
                        View view = wk0Var2.f42627a;
            ...
            case 2:
                ...
                if (i10 == 0) {
                    if (ml0Var.f26234v2) {
                        ml0Var.f26234v2 = false;
                        NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.startAllHeavyOperations, 512);
                    }
                } else if (!ml0Var.f26234v2 && ml0Var.f26237x1) {
                    ml0Var.f26234v2 = true;
            ...
            case 7:
                ...
                if (i10 == 0 && n61Var.G && AndroidUtilities.dp(13.0f) + n61.m(n61Var) + n61Var.f26362y < AndroidUtilities.statusBarHeight * 2 && w0Var.canScrollVertically(1) && (wk0Var = (wk0) w0Var.K(0)) != null) {
                    View view3 = wk0Var.f42627a;
                    if (view3.getTop() > 0) {
    ...
    public void b(androidx.recyclerview.widget.RecyclerView r12, int r13, int r14) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.kg0.b(androidx.recyclerview.widget.RecyclerView, int, int):void");
    }
}
