...
public final class t11 {
    public final Paint f28030a;
    public final Paint f28031b;
    public final Paint f28032c;
    public Drawable d;
    public Drawable e;
    public final u11 f28033f;

    public t11(u11 u11Var) {
        this.f28033f = u11Var;
        Paint paint = new Paint(1);
        this.f28030a = paint;
        this.f28031b = new Paint(1);
        this.f28032c = new Paint(1);
    ...
    public final void a(Canvas canvas, float f7) {
        ...
        float f20 = u11Var.d;
        float f21 = u11Var.f28255c;
        int i12 = u11Var.K;
        RectF rectF = u11Var.v;
        if (!u11Var.W && u11Var.f28262y == null) {
            f10 = 255.0f;
            f11 = 4.0f;
            f12 = 0.5f;
        } else {
            lp lpVar = u11Var.G;
            f10 = 255.0f;
            org.telegram.ui.ActionBar.c4 c4Var = (org.telegram.ui.ActionBar.c4) lpVar.f25994a.f18592f.get(lpVar.f25996c);
            if (u11Var.G.f25994a.m()) {
                i10 = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Oh, u11Var.f28261x);
            } else {
                i10 = c4Var.f18554j;
            }
            ...
            float f22 = u11Var.f28253a;
            canvas.drawRoundRect(rectF, f22, f22, paint);
        }
        int i13 = (int) (f7 * f10);
        Paint paint2 = this.f28031b;
        paint2.setAlpha(i13);
        Paint paint3 = this.f28032c;
        paint3.setAlpha(i13);
        rectF.set(f21, f21, u11Var.getWidth() - f21, u11Var.getHeight() - f21);
        org.telegram.ui.ActionBar.d4 d4Var = u11Var.G.f25994a;
        if (d4Var != null) {
            if (d4Var.m()) {
                u11Var.G.f25994a.getClass();
            } else if (i12 != 4) {
                if (i12 == 2) {
                    if (u11Var.G.e != null) {
        ...
        if (u11Var.T == null) {
            float f23 = u11Var.f28254b;
            canvas.drawRoundRect(rectF, f23, f23, u11Var.f28259s);
            canvas.save();
    ...
    public final void b(Canvas canvas, float f7) {
        ...
        if (drawable != null) {
            canvas.save();
            canvas.clipPath(u11Var.f28260w);
            ...
            if ((drawable3 instanceof ColorDrawable) || ((drawable3 instanceof cc0) && (i10 = (iArr = ((cc0) drawable3).f23045a)[0]) == iArr[1] && i10 == iArr[2] && i10 == iArr[3])) {
                int alpha = u11Var.f28258r.getAlpha();
                u11Var.f28258r.setAlpha((int) (alpha * f7));
                float f10 = u11Var.f28255c;
                RectF rectF = AndroidUtilities.rectTmp;
                rectF.set(f10, f10, u11Var.getWidth() - f10, u11Var.getHeight() - f10);
                float f11 = u11Var.f28254b;
                canvas.drawRoundRect(rectF, f11, f11, u11Var.f28258r);
                u11Var.f28258r.setAlpha(alpha);
            }
            canvas.restore();
            return;
        }
        lp lpVar = u11Var.G;
        if (lpVar != null && (d4Var = lpVar.f25994a) != null && d4Var.m() && u11Var.N != null) {
            return;
        }
        RectF rectF2 = u11Var.v;
        float f12 = u11Var.f28254b;
        canvas.drawRoundRect(rectF2, f12, f12, u11Var.f28259s);
    }
}
