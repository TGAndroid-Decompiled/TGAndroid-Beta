...
public final class x71 extends View {
    ...
    public boolean P;
    public long f30522a;
    public float f30523b;
    public float f30524c;
    public final Paint d;
    public final Paint e;
    public boolean f30525f;
    public boolean h;
    public float f30526n;
    public MediaMetadataRetriever f30527r;
    public w71 f30528s;
    ...
    public x71(Context context) {
        ...
        paint2.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19827a7, false));
        this.I = 0;
        v71 v71Var = this.M;
        if (v71Var != null) {
            v71Var.b();
    ...
    public final void a(boolean z4) {
        synchronized (Q) {
            try {
                MediaMetadataRetriever mediaMetadataRetriever = this.f30527r;
        ...
        if (this.f30527r != null) {
            if (i10 == 0) {
                if (this.F) {
                    ...
                    this.f30531y = (int) Math.ceil((getMeasuredWidth() - AndroidUtilities.dp(16.0f)) / this.C);
                }
                this.f30530x = this.f30522a / this.C;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int dp = AndroidUtilities.dp(12.0f) + ((int) (this.f30523b * measuredWidth));
        int dp2 = AndroidUtilities.dp(12.0f) + ((int) (measuredWidth * this.f30524c));
        float f10 = 32.0f;
        int measuredHeight = (getMeasuredHeight() - AndroidUtilities.dp(32.0f)) >> 1;
        ArrayList arrayList = this.v;
        if (arrayList.isEmpty() && this.f30529w == null) {
            b(0);
        }
        if (!arrayList.isEmpty()) {
            if (!this.L) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent != null) {
            ...
            int dp = AndroidUtilities.dp(12.0f) + ((int) (this.f30523b * f10));
            int dp2 = AndroidUtilities.dp(12.0f) + ((int) (this.f30524c * f10));
            if (motionEvent.getAction() == 0) {
                getParent().requestDisallowInterceptTouchEvent(true);
                if (this.f30527r != null) {
                    int dp3 = AndroidUtilities.dp(24.0f);
                    if (dp - dp3 <= x10 && x10 <= dp + dp3 && y10 >= 0.0f && y10 <= getMeasuredHeight()) {
                        w71 w71Var = this.f30528s;
                        if (w71Var != null) {
                            ((ue) w71Var).f29200a.V2.K(0.0f, 1);
                        }
                        this.f30525f = true;
                        this.f30526n = (int) (x10 - dp);
                        this.M.setTime((int) ((((float) this.f30522a) / 1000.0f) * this.f30523b));
                        this.M.setCx(AndroidUtilities.dp(4.0f) + getLeft() + dp);
                        this.M.a(true);
                        invalidate();
                        return true;
                    } else if (dp2 - dp3 <= x10 && x10 <= dp3 + dp2 && y10 >= 0.0f && y10 <= getMeasuredHeight()) {
                        w71 w71Var2 = this.f30528s;
                        if (w71Var2 != null) {
                            ((ue) w71Var2).f29200a.V2.K(0.0f, 1);
                        }
                        this.h = true;
                        this.f30526n = (int) (x10 - dp2);
                        this.M.setTime((int) ((((float) this.f30522a) / 1000.0f) * this.f30524c));
                ...
                if (motionEvent.getAction() == 2) {
                    if (this.f30525f) {
                        ...
                        this.f30523b = dp4;
                        float f11 = this.f30524c;
                        float f12 = f11 - dp4;
                        float f13 = this.D;
                        if (f12 > f13) {
                            this.f30524c = dp4 + f13;
                        } else {
                            float f14 = this.E;
                            if (f14 != 0.0f && f12 < f14) {
                                float f15 = f11 - f14;
                        ...
                        this.M.setCx(((AndroidUtilities.dpf2(12.0f) + (f10 * this.f30523b)) + getLeft()) - AndroidUtilities.dp(4.0f));
                        this.M.setTime((int) ((((float) this.f30522a) / 1000.0f) * this.f30523b));
                        this.M.a(true);
                        w71 w71Var3 = this.f30528s;
                        if (w71Var3 != null) {
                            float f16 = this.f30523b;
                            ChatActivityEnterView chatActivityEnterView = ((ue) w71Var3).f29200a;
                            VideoEditedInfo videoEditedInfo = chatActivityEnterView.f22706a3;
                        ...
                        this.f30524c = dp5;
                        float f17 = this.f30523b;
                        float f18 = dp5 - f17;
                        float f19 = this.D;
                        if (f18 > f19) {
                            this.f30523b = dp5 - f19;
                        } else {
                            float f20 = this.E;
                            if (f20 != 0.0f && f18 < f20) {
                                float f21 = f17 + f20;
                        ...
                        this.M.setCx(AndroidUtilities.dpf2(12.0f) + (f10 * this.f30524c) + getLeft() + AndroidUtilities.dp(4.0f));
                        this.M.a(true);
                        this.M.setTime((int) ((((float) this.f30522a) / 1000.0f) * this.f30524c));
                        w71 w71Var4 = this.f30528s;
                        if (w71Var4 != null) {
                            float f22 = this.f30524c;
                            ChatActivityEnterView chatActivityEnterView2 = ((ue) w71Var4).f29200a;
                            VideoEditedInfo videoEditedInfo2 = chatActivityEnterView2.f22706a3;
                ...
                w71 w71Var5 = this.f30528s;
                if (w71Var5 != null) {
                    ((ue) w71Var5).f29200a.V2.K(0.0f, 0);
                }
                this.f30525f = false;
                invalidate();
                this.M.a(false);
                ...
                w71 w71Var6 = this.f30528s;
                if (w71Var6 != null) {
                    ((ue) w71Var6).f29200a.V2.K(0.0f, 0);
                }
                this.h = false;
                invalidate();
                this.M.a(false);
    ...
    public void setMaxProgressDiff(float f10) {
        this.D = f10;
        float f11 = this.f30524c;
        float f12 = this.f30523b;
        if (f11 - f12 > f10) {
            this.f30524c = f12 + f10;
            invalidate();
        }
    }
    ...
    public void setVideoPath(String str) {
        ...
        this.f30527r = mediaMetadataRetriever;
        this.f30523b = 0.0f;
        this.f30524c = 1.0f;
        try {
            mediaMetadataRetriever.setDataSource(str);
            this.f30522a = Long.parseLong(this.f30527r.extractMetadata(9));
        } catch (Exception e) {
            FileLog.e(e);
        }
        invalidate();
