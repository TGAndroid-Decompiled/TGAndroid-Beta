...
public final class x71 implements ImageReceiver.ImageReceiverDelegate {
    ...
    public void didSetImage(ImageReceiver imageReceiver, boolean z10, boolean z11, boolean z12) {
        ...
        int ceil;
        double ceil2;
        a81 a81Var = (a81) this.f30279a;
        ImageReceiver imageReceiver2 = a81Var.Q;
        if (z10) {
            if (a81Var.N != null || a81Var.f22620d0 != null) {
                ...
                if (au0Var != null) {
                    ...
                    int i13 = 0;
                    while (true) {
                        if (i13 < a81Var.f22620d0.size()) {
                            z71Var = (z71) a81Var.f22620d0.get(i13);
                            if (i13 == 0) {
                                d = 0.0d;
                            } else {
                                d = z71Var.f30808a;
                            }
                            if (i13 == a81Var.f22620d0.size() - 1) {
                                d10 = 9.9999999E7d;
                            } else {
                                d10 = ((z71) a81Var.f22620d0.get(i13 + 1)).f30808a;
                            }
                            double d11 = a81Var.O;
                            if (d11 >= d && d11 <= d10) {
                                break;
                    ...
                    if (z71Var != null) {
                        a81Var.R = z71Var.f30809b;
                        a81Var.S = z71Var.f30810c;
                        a81Var.T = a81Var.f22617b0;
                        a81Var.U = a81Var.f22619c0;
                    } else {
                        return;
                    }
                }
