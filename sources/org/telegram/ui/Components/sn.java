...
public final class sn extends kl0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        int b10 = c1Var.b();
        un unVar = this.d;
        if (b10 != unVar.f28463u0 && b10 != unVar.G0 && b10 != unVar.B0 && b10 != unVar.F0 && b10 != unVar.C0 && b10 != unVar.H0 && b10 != unVar.D0 && b10 != unVar.E0 && b10 != unVar.I0 && b10 != unVar.J0 && b10 != unVar.N0.f3654b && b10 != unVar.M0.f3654b && b10 != unVar.L0) {
            return false;
        }
        return true;
    }
    ...
    public final int j(int i10) {
        un unVar = this.d;
        if (i10 != unVar.B0 && i10 != unVar.F0 && i10 != unVar.G0 && i10 != unVar.C0 && i10 != unVar.D0 && i10 != unVar.E0 && i10 != unVar.H0 && i10 != unVar.M0.f3654b && i10 != unVar.N0.f3654b) {
            if (i10 != unVar.f28452l0 && i10 != unVar.f28461s0 && i10 != unVar.f28466w0 && i10 != unVar.f28455o0) {
                if (i10 == unVar.f28459r0) {
                    return 1;
                }
                if (i10 != unVar.f28464v0 && i10 != unVar.f28468x0 && i10 != unVar.f28457q0 && i10 != unVar.K0) {
                    if (i10 != unVar.f28463u0 && i10 != unVar.I0 && i10 != unVar.L0) {
                        if (i10 == unVar.m0) {
                            return 4;
                        }
                        if (i10 == unVar.f28454n0) {
                            return 11;
                        }
                        if (i10 == unVar.f28456p0) {
                            return 7;
                        }
                        if (i10 != unVar.f28470y0 && i10 != unVar.f28471z0 && i10 != unVar.J0) {
                            if (i10 == unVar.A0) {
                                return 8;
                            }
                            if (i10 == 0) {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        boolean z11;
        un unVar = this.d;
        boolean z12 = unVar.f28438e0;
        c2.a aVar = unVar.M0;
        c2.a aVar2 = unVar.N0;
        org.telegram.ui.ActionBar.e6 e6Var = unVar.f26460a;
        boolean z13 = unVar.f28453n;
        ...
        if (i15 != 0) {
            ...
            if (i15 != 6) {
                    ...
                    if (i15 != 3) {
                        if (i15 != 9) {
                            if (i15 == 10) {
                                ...
                                if (i10 == unVar.B0) {
                                    a6Var.a(LocaleController.getString(R.string.PollV2ShowWhoVoted), LocaleController.getString(R.string.PollV2ShowWhoVotedInfo), 1, R.drawable.filled_poll_view_24, !unVar.f28430a0);
                                } else {
                                    if (i10 == unVar.F0) {
                                        a6Var.a(LocaleController.getString(R.string.PollV2AllowMultipleAnswers), LocaleController.getString(R.string.PollV2AllowMultipleAnswersInfo), 5, R.drawable.filled_poll_multiple_24, unVar.f28432b0);
                                        ...
                                        a6Var.a(LocaleController.getString(R.string.PollV2SetCorrectAnswer), LocaleController.getString(R.string.PollV2SetCorrectAnswerInfo), 7, R.drawable.filled_poll_correct_24, unVar.f28434c0);
                                    } else if (i10 == aVar2.f3654b) {
                                        a6Var.a(LocaleController.getString(R.string.PollV2LimitByCountry), LocaleController.getString(R.string.PollV2LimitByCountryInfo), 4, R.drawable.filled_location, aVar2.f3653a);
                                    } else if (i10 == aVar.f3654b) {
                                        a6Var.a(LocaleController.getString(R.string.PollV2RestrictToSubscribers), LocaleController.getString(R.string.PollV2RestrictToSubscribersInfo), 3, R.drawable.msg_folders_groups, aVar.f3653a);
                                ...
                                if (i10 == unVar.G0) {
                                    a6Var.getCheckBox().f22194a.a(z12, false);
                                    return;
                                } else if (i10 == unVar.C0) {
                                    ...
                                    checkBox.f22194a.a(z14, false);
                                    return;
                                } else {
                                    a6Var.getCheckBox().f22194a.a(false, false);
                                    return;
                                }
                            }
                            return;
                ...
                new pq(new ColorDrawable(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18778a7, e6Var)), org.telegram.ui.ActionBar.i6.V0(context, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.i6.f18798b7)).f27122w = true;
                if (i10 == unVar.f28457q0) {
                    e9Var.setText(LocaleController.getString(R.string.AddAnExplanationInfo));
                    return;
                } else if (i10 == unVar.f28468x0) {
            ...
            if (i10 == unVar.f28470y0) {
                ...
                w8Var.f(LocaleController.getString(R.string.TodoAllowMarkingDone), unVar.f28442g0, false);
                w8Var.e(null, true);
                return;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        View view;
        un unVar = this.d;
        boolean z10 = unVar.f28453n;
        org.telegram.ui.ActionBar.e6 e6Var = unVar.f26460a;
        Context context = this.f27932c;
        switch (i10) {
            case 0:
                m4Var = new org.telegram.ui.Cells.m4(this.f27932c, org.telegram.ui.ActionBar.i6.L6, 21, 15, false, unVar.f26460a);
                break;
            case 1:
                View a7Var = new org.telegram.ui.Cells.a7(context, (org.telegram.ui.Cells.q3) null);
                new pq(new ColorDrawable(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18778a7, e6Var)), org.telegram.ui.ActionBar.i6.V0(context, R.drawable.greydivider, org.telegram.ui.ActionBar.i6.f18798b7)).f27122w = true;
                m4Var = a7Var;
                break;
            case 2:
            ...
            case 11:
                boolean z11 = unVar.I;
                nn nnVar = new nn(this, this.f27932c, z11 ? 1 : 0, unVar.f26460a, i10);
                if (i10 == 11 && !z10) {
                    nnVar.setTextRight(98);
                    nnVar.b().setOnClickListener(new View.OnClickListener(this) {
                        public final sn f25993b;
                        ...
                        public final void onClick(View view2) {
                            switch (r2) {
                                case 0:
                                    un.O(this.f25993b.d, -2);
                                    return;
                                case 1:
                                    un.O(this.f25993b.d, -3);
                                    return;
                                default:
                                    this.f25993b.d.X(view2, (org.telegram.ui.Cells.d6) view2.getParent(), true);
                                    return;
                            }
                        }
                    });
                ...
                nnVar.d();
                nnVar.setIconsColor(org.telegram.ui.ActionBar.i6.f19036o7);
            ...
            default:
                boolean z12 = unVar.I;
                rn rnVar = new rn(this, this.f27932c, z12 ? 1 : 0, new View.OnClickListener(this) {
                    public final sn f25993b;
                ...
                int i11 = org.telegram.ui.ActionBar.i6.f19036o7;
                rnVar.setIconsColor(i11);
                np npVar = rnVar.f19903r;
                if (npVar != null) {
                    npVar.getCheckBoxBase().i(AndroidUtilities.dp(6.0f));
                    CheckBoxBase checkBoxBase = npVar.getCheckBoxBase();
                    float f7 = rnVar.f19898a.e;
                    if (checkBoxBase.f21974w != f7) {
                        checkBoxBase.f21974w = f7;
                        checkBoxBase.b();
                    }
                }
                rnVar.getCheckBox().b(-1, i11, org.telegram.ui.ActionBar.i6.f18962k7);
            ...
            case 7:
                ...
                pnVar.setIconsColor(org.telegram.ui.ActionBar.i6.f19036o7);
    ...
    public final void y(s4.c1 c1Var) {
        ...
        if (i12 == 4) {
            ...
            d6Var3.setTag(1);
            d6Var3.f19898a.a(unVar.f28432b0, false);
            int i13 = b10 - unVar.f28462t0;
