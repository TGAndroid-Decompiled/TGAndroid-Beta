...
public final class sn extends ll0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        int b10 = c1Var.b();
        un unVar = this.d;
        if (b10 != unVar.f28444u0 && b10 != unVar.G0 && b10 != unVar.B0 && b10 != unVar.F0 && b10 != unVar.C0 && b10 != unVar.H0 && b10 != unVar.D0 && b10 != unVar.E0 && b10 != unVar.I0 && b10 != unVar.J0 && b10 != unVar.N0.f3657b && b10 != unVar.M0.f3657b && b10 != unVar.L0) {
            return false;
        }
        return true;
    }
    ...
    public final int j(int i10) {
        ...
        if (i10 != unVar.B0 && i10 != unVar.F0 && i10 != unVar.G0 && i10 != unVar.C0 && i10 != unVar.D0 && i10 != unVar.E0 && i10 != unVar.H0 && i10 != unVar.M0.f3657b && i10 != unVar.N0.f3657b) {
            if (i10 != unVar.f28433l0 && i10 != unVar.f28442s0 && i10 != unVar.f28447w0 && i10 != unVar.f28436o0) {
                if (i10 == unVar.f28440r0) {
                    return 1;
                }
                if (i10 != unVar.f28445v0 && i10 != unVar.f28449x0 && i10 != unVar.f28438q0 && i10 != unVar.K0) {
                    if (i10 != unVar.f28444u0 && i10 != unVar.I0 && i10 != unVar.L0) {
                        if (i10 == unVar.m0) {
                            return 4;
                        }
                        if (i10 == unVar.f28435n0) {
                            return 11;
                        }
                        if (i10 == unVar.f28437p0) {
                            return 7;
                        }
                        if (i10 != unVar.f28451y0 && i10 != unVar.f28452z0 && i10 != unVar.J0) {
                            if (i10 == unVar.A0) {
                                return 8;
                            }
                            if (i10 == 0) {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        boolean z11;
        un unVar = this.d;
        boolean z12 = unVar.f28419e0;
        c2.a aVar = unVar.M0;
        c2.a aVar2 = unVar.N0;
        org.telegram.ui.ActionBar.f6 f6Var = unVar.f26459a;
        boolean z13 = unVar.f28434n;
        ...
        if (i15 != 0) {
            ...
            if (i15 != 6) {
                ...
                if (i15 != 2) {
                    if (i15 != 3) {
                        if (i15 != 9) {
                            if (i15 == 10) {
                                ...
                                if (i10 == unVar.B0) {
                                    z5Var.a(LocaleController.getString(R.string.PollV2ShowWhoVoted), LocaleController.getString(R.string.PollV2ShowWhoVotedInfo), 1, R.drawable.filled_poll_view_24, !unVar.f28411a0);
                                } else {
                                    if (i10 == unVar.F0) {
                                        z5Var.a(LocaleController.getString(R.string.PollV2AllowMultipleAnswers), LocaleController.getString(R.string.PollV2AllowMultipleAnswersInfo), 5, R.drawable.filled_poll_multiple_24, unVar.f28413b0);
                                        ...
                                        z5Var.a(LocaleController.getString(R.string.PollV2SetCorrectAnswer), LocaleController.getString(R.string.PollV2SetCorrectAnswerInfo), 7, R.drawable.filled_poll_correct_24, unVar.f28415c0);
                                ...
                                if (i10 == unVar.G0) {
                                    z5Var.getCheckBox().f22207a.a(z12, false);
                                    return;
                                } else if (i10 == unVar.C0) {
                                    ...
                                    checkBox.f22207a.a(z14, false);
                                    return;
                                } else {
                                    z5Var.getCheckBox().f22207a.a(false, false);
                                    return;
                                }
                            }
                            return;
                    ...
                    if (i10 == unVar.L0) {
                        ...
                        drawable2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18991k7, f6Var), mode));
                ...
                new pq(new ColorDrawable(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18806a7, f6Var)), org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.j6.f18826b7)).f27113w = true;
                if (i10 == unVar.f28438q0) {
                    e9Var.setText(LocaleController.getString(R.string.AddAnExplanationInfo));
                    return;
                } else if (i10 == unVar.f28449x0) {
            ...
            if (i10 == unVar.f28451y0) {
                ...
                w8Var.f(LocaleController.getString(R.string.TodoAllowMarkingDone), unVar.f28423g0, false);
                w8Var.e(null, true);
                return;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        View view;
        un unVar = this.d;
        boolean z10 = unVar.f28434n;
        org.telegram.ui.ActionBar.f6 f6Var = unVar.f26459a;
        Context context = this.f27888c;
        switch (i10) {
            case 0:
                l4Var = new org.telegram.ui.Cells.l4(this.f27888c, org.telegram.ui.ActionBar.j6.L6, 21, 15, false, unVar.f26459a);
                break;
            case 1:
                View a7Var = new org.telegram.ui.Cells.a7(context, (org.telegram.ui.Cells.p6) null);
                new pq(new ColorDrawable(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18806a7, f6Var)), org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider, org.telegram.ui.ActionBar.j6.f18826b7)).f27113w = true;
                l4Var = a7Var;
                break;
            case 2:
            ...
            case 11:
                boolean z11 = unVar.I;
                nn nnVar = new nn(this, this.f27888c, z11 ? 1 : 0, unVar.f26459a, i10);
                if (i10 == 11 && !z10) {
                    nnVar.setTextRight(98);
                    nnVar.b().setOnClickListener(new View.OnClickListener(this) {
                        public final sn f25930b;
                        ...
                        public final void onClick(View view2) {
                            switch (r2) {
                                case 0:
                                    un.O(this.f25930b.d, -2);
                                    return;
                                case 1:
                                    un.O(this.f25930b.d, -3);
                                    return;
                                default:
                                    this.f25930b.d.X(view2, (org.telegram.ui.Cells.c6) view2.getParent(), true);
                                    return;
                            }
                        }
                    });
                ...
                nnVar.d();
                nnVar.setIconsColor(org.telegram.ui.ActionBar.j6.f19065o7);
            ...
            default:
                boolean z12 = unVar.I;
                rn rnVar = new rn(this, this.f27888c, z12 ? 1 : 0, new View.OnClickListener(this) {
                    public final sn f25930b;
                ...
                int i11 = org.telegram.ui.ActionBar.j6.f19065o7;
                rnVar.setIconsColor(i11);
                np npVar = rnVar.f19875r;
                if (npVar != null) {
                    npVar.getCheckBoxBase().i(AndroidUtilities.dp(6.0f));
                    CheckBoxBase checkBoxBase = npVar.getCheckBoxBase();
                    float f7 = rnVar.f19870a.e;
                    if (checkBoxBase.f21987w != f7) {
                        checkBoxBase.f21987w = f7;
                        checkBoxBase.b();
                    }
                }
                rnVar.getCheckBox().b(-1, i11, org.telegram.ui.ActionBar.j6.f18991k7);
            ...
            case 7:
                ...
                pnVar.setIconsColor(org.telegram.ui.ActionBar.j6.f19065o7);
    ...
    public final void y(s4.c1 c1Var) {
        ...
        if (i12 == 4) {
            ...
            c6Var3.setTag(1);
            c6Var3.f19870a.a(unVar.f28413b0, false);
            int i13 = b10 - unVar.f28443t0;
