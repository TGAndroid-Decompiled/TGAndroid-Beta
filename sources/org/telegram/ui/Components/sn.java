...
public final class sn extends xl0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        int b10 = c1Var.b();
        un unVar = this.d;
        if (b10 != unVar.f28838u0 && b10 != unVar.G0 && b10 != unVar.B0 && b10 != unVar.F0 && b10 != unVar.C0 && b10 != unVar.H0 && b10 != unVar.D0 && b10 != unVar.E0 && b10 != unVar.I0 && b10 != unVar.J0 && b10 != unVar.N0.f3656b && b10 != unVar.M0.f3656b && b10 != unVar.L0) {
            return false;
        }
        return true;
    }
    ...
    public final int j(int i10) {
        un unVar = this.d;
        if (i10 != unVar.B0 && i10 != unVar.F0 && i10 != unVar.G0 && i10 != unVar.C0 && i10 != unVar.D0 && i10 != unVar.E0 && i10 != unVar.H0 && i10 != unVar.M0.f3656b && i10 != unVar.N0.f3656b) {
            if (i10 != unVar.f28827l0 && i10 != unVar.f28836s0 && i10 != unVar.f28841w0 && i10 != unVar.f28830o0) {
                if (i10 == unVar.f28834r0) {
                    return 1;
                }
                if (i10 != unVar.f28839v0 && i10 != unVar.f28843x0 && i10 != unVar.f28832q0 && i10 != unVar.K0) {
                    if (i10 != unVar.f28838u0 && i10 != unVar.I0 && i10 != unVar.L0) {
                        if (i10 == unVar.m0) {
                            return 4;
                        }
                        if (i10 == unVar.f28829n0) {
                            return 11;
                        }
                        if (i10 == unVar.f28831p0) {
                            return 7;
                        }
                        if (i10 != unVar.f28845y0 && i10 != unVar.f28846z0 && i10 != unVar.J0) {
                            if (i10 == unVar.A0) {
                                return 8;
                            }
                            if (i10 == 0) {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        boolean z11;
        un unVar = this.d;
        boolean z12 = unVar.f28813e0;
        c2.a aVar = unVar.M0;
        c2.a aVar2 = unVar.N0;
        org.telegram.ui.ActionBar.f6 f6Var = unVar.f26785a;
        boolean z13 = unVar.f28828n;
        ...
        if (i15 != 0) {
            ...
            if (i15 != 6) {
                ...
                if (i15 != 2) {
                    if (i15 != 3) {
                        if (i15 != 9) {
                            if (i15 == 10) {
                                ...
                                if (i10 == unVar.B0) {
                                    b6Var.a(LocaleController.getString(R.string.PollV2ShowWhoVoted), LocaleController.getString(R.string.PollV2ShowWhoVotedInfo), 1, R.drawable.filled_poll_view_24, !unVar.f28805a0);
                                } else {
                                    if (i10 == unVar.F0) {
                                        b6Var.a(LocaleController.getString(R.string.PollV2AllowMultipleAnswers), LocaleController.getString(R.string.PollV2AllowMultipleAnswersInfo), 5, R.drawable.filled_poll_multiple_24, unVar.f28807b0);
                                        ...
                                        b6Var.a(LocaleController.getString(R.string.PollV2SetCorrectAnswer), LocaleController.getString(R.string.PollV2SetCorrectAnswerInfo), 7, R.drawable.filled_poll_correct_24, unVar.f28809c0);
                                    } else if (i10 == aVar2.f3656b) {
                                        b6Var.a(LocaleController.getString(R.string.PollV2LimitByCountry), LocaleController.getString(R.string.PollV2LimitByCountryInfo), 4, R.drawable.filled_location, aVar2.f3655a);
                                    } else if (i10 == aVar.f3656b) {
                                        b6Var.a(LocaleController.getString(R.string.PollV2RestrictToSubscribers), LocaleController.getString(R.string.PollV2RestrictToSubscribersInfo), 3, R.drawable.msg_folders_groups, aVar.f3655a);
                                ...
                                if (i10 == unVar.G0) {
                                    b6Var.getCheckBox().f22434a.a(z12, false);
                                    return;
                                } else if (i10 == unVar.C0) {
                                    ...
                                    checkBox.f22434a.a(z14, false);
                                    return;
                                } else {
                                    b6Var.getCheckBox().f22434a.a(false, false);
                                    return;
                                }
                            }
                            return;
                    ...
                    if (i10 == unVar.L0) {
                        ...
                        drawable2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19238k7, f6Var), mode));
                ...
                new pq(new ColorDrawable(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19053a7, f6Var)), org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.j6.f19073b7)).f27404w = true;
                if (i10 == unVar.f28832q0) {
                    f9Var.setText(LocaleController.getString(R.string.AddAnExplanationInfo));
                    return;
                } else if (i10 == unVar.f28843x0) {
            ...
            if (i10 == unVar.f28845y0) {
                ...
                x8Var.f(LocaleController.getString(R.string.TodoAllowMarkingDone), unVar.f28817g0, false);
                x8Var.e(null, true);
                return;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        View view;
        un unVar = this.d;
        boolean z10 = unVar.f28828n;
        org.telegram.ui.ActionBar.f6 f6Var = unVar.f26785a;
        Context context = this.f28279c;
        switch (i10) {
            case 0:
                n4Var = new org.telegram.ui.Cells.n4(this.f28279c, org.telegram.ui.ActionBar.j6.L6, 21, 15, false, unVar.f26785a);
                break;
            case 1:
                View c7Var = new org.telegram.ui.Cells.c7(context, (org.telegram.ui.Cells.c1) null);
                new pq(new ColorDrawable(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19053a7, f6Var)), org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider, org.telegram.ui.ActionBar.j6.f19073b7)).f27404w = true;
                n4Var = c7Var;
                break;
            case 2:
            ...
            case 11:
                boolean z11 = unVar.I;
                nn nnVar = new nn(this, this.f28279c, z11 ? 1 : 0, unVar.f26785a, i10);
                if (i10 == 11 && !z10) {
                    nnVar.setTextRight(98);
                    nnVar.b().setOnClickListener(new View.OnClickListener(this) {
                        public final sn f26145b;
                        ...
                        public final void onClick(View view2) {
                            switch (r2) {
                                case 0:
                                    un.O(this.f26145b.d, -2);
                                    return;
                                case 1:
                                    un.O(this.f26145b.d, -3);
                                    return;
                                default:
                                    this.f26145b.d.X(view2, (org.telegram.ui.Cells.e6) view2.getParent(), true);
                                    return;
                            }
                        }
                    });
                ...
                nnVar.d();
                nnVar.setIconsColor(org.telegram.ui.ActionBar.j6.f19312o7);
            ...
            default:
                boolean z12 = unVar.I;
                rn rnVar = new rn(this, this.f28279c, z12 ? 1 : 0, new View.OnClickListener(this) {
                    public final sn f26145b;
                ...
                int i11 = org.telegram.ui.ActionBar.j6.f19312o7;
                rnVar.setIconsColor(i11);
                np npVar = rnVar.f20202r;
                if (npVar != null) {
                    npVar.getCheckBoxBase().i(AndroidUtilities.dp(6.0f));
                    CheckBoxBase checkBoxBase = npVar.getCheckBoxBase();
                    float f7 = rnVar.f20197a.e;
                    if (checkBoxBase.f22214w != f7) {
                        checkBoxBase.f22214w = f7;
                        checkBoxBase.b();
                    }
                }
                rnVar.getCheckBox().b(-1, i11, org.telegram.ui.ActionBar.j6.f19238k7);
            ...
            case 7:
                ...
                pnVar.setIconsColor(org.telegram.ui.ActionBar.j6.f19312o7);
    ...
    public final void y(s4.c1 c1Var) {
        ...
        if (i12 == 4) {
            ...
            e6Var3.setTag(1);
            e6Var3.f20197a.a(unVar.f28807b0, false);
            int i13 = b10 - unVar.f28837t0;
    ...
    public final void z(s4.c1 c1Var) {
        ...
        if (i10 == 4 || i10 == 11 || i10 == 5) {
            EditTextBoldCursor textView = ((org.telegram.ui.Cells.e6) c1Var.f42995a).getTextView();
