...
public final class sn extends org.telegram.ui.Cells.d6 {
    ...
    public final boolean e() {
        ...
        if (T != null) {
            int b10 = T.b();
            int i10 = vnVar.M;
            if (i10 == vnVar.J && b10 == (vnVar.f29216t0 + i10) - 1) {
                return false;
            }
        }
        return true;
    ...
    public final boolean f(org.telegram.ui.Cells.d6 d6Var) {
        ...
        if (T != null && (b10 = T.b()) != -1) {
            return vnVar.L[b10 - vnVar.f29216t0];
        }
        return false;
    }
    ...
    public final void g(org.telegram.ui.Cells.c6 c6Var, ActionMode actionMode) {
        vn vnVar = this.F.d;
        if (vnVar.f29207n && c6Var.isFocused() && c6Var.hasSelection()) {
            Menu menu = actionMode.getMenu();
            if (menu.findItem(16908321) != null) {
                org.telegram.ui.wn.k8(menu, ((org.telegram.ui.wn) vnVar.f27087b.f30005f0).h, false, true, true, true);
            }
        }
    }
    ...
    public final void h(org.telegram.ui.Cells.d6 d6Var, boolean z10) {
        ...
        int b10;
        vn vnVar = this.F.d;
        if (z10 && vnVar.f29188c0 && !vnVar.f29186b0) {
            Arrays.fill(vnVar.L, false);
            vnVar.f29214s.getChildCount();
            for (int i10 = vnVar.f29216t0; i10 < vnVar.f29216t0 + vnVar.M; i10++) {
        ...
        if (T != null && (b10 = T.b()) != -1) {
            vnVar.L[b10 - vnVar.f29216t0] = z10;
        }
        vnVar.T();
    }
    ...
    public final boolean l(ArrayList arrayList) {
        ...
        if (!arrayList.isEmpty()) {
            vnVar.f29214s.getClass();
            int R = RecyclerView.R(this) - vnVar.f29216t0;
            if (R >= 0) {
                ...
                vnVar.h0();
                vnVar.f29204k0 = (vnVar.f29216t0 + i10) - 1;
                vnVar.f29214s.setItemAnimator(vnVar.v);
                vnVar.f29212r.l();
                return true;
            }
        }
