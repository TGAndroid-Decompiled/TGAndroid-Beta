...
public final class la {
    public final ha f25885a;
    public final View f25886b;
    public final ColorMatrix f25887c;
    public final boolean d;
    public boolean e;
    public float f25888f;
    public Paint f25889g;
    public Paint h;
    public final int f25890i;
    public final Integer f25891j;
    public final Path f25892k;
    public int f25893l;
    public int f25894m;
    public Bitmap f25895n;
    public BitmapShader f25896o;
    public final Matrix f25897p;
    public final RectF f25898q;
    public boolean f25899r;
    public Paint[] f25900s;
    public ValueAnimator f25901t;
    public final int[] f25902u;
    public final int[] v;
    ...
    public final void b(Canvas canvas, boolean z10) {
        ...
        if (haVar.c() && Build.VERSION.SDK_INT >= 31) {
            ...
            RenderNode renderNode = (RenderNode) haVar.f24653l;
            if (!renderNode.hasDisplayList()) {
                RenderNode renderNode2 = (RenderNode) haVar.f24652k;
            ...
            if (renderNode.hasDisplayList()) {
                Matrix matrix = this.f25897p;
                matrix.postTranslate(-0.0f, -0.0f);
                this.h.setAlpha((int) 255.0f);
                canvas.saveLayer(null, this.h);
                canvas.concat(matrix);
                if (z10) {
                    int i14 = this.f25893l;
                    int width = renderNode.getWidth();
                    Path path = this.f25892k;
                    if (i14 != width || this.f25894m != renderNode.getHeight()) {
                        path.rewind();
    ...
    public final Paint c(float f7) {
        ...
        BitmapShader bitmapShader = this.f25896o;
        if (bitmapShader == null || this.f25895n != b10) {
            if (this.d && bitmapShader != null && (bitmap = this.f25895n) != null && !bitmap.isRecycled() && !b10.isRecycled()) {
                Paint paint = this.h;
                this.h = this.f25889g;
                this.f25889g = paint;
                this.e = true;
                ValueAnimator valueAnimator = this.f25901t;
    ...
    public final Paint[] d() {
        ...
        if (c10 != null && z10) {
            c10.setAlpha((int) org.telegram.messenger.y0.A(1.0f, this.f25888f, 255.0f, 1.0f));
        }
        if (paint != null) {
            paint.setAlpha((int) 255.0f);
        }
        if (this.f25900s == null) {
            this.f25900s = new Paint[2];
        }
        Paint[] paintArr = this.f25900s;
        paintArr[0] = paint;
        paintArr[1] = c10;
        return paintArr;
    }
    ...
    public final void e(float f7, float f10, float f11, float f12) {
        ...
        RectF rectF2 = this.f25898q;
        if (rectF2.top != rectF.top || rectF2.bottom != rectF.bottom || rectF2.left != rectF.left || rectF2.right != rectF.right) {
            rectF2.set(rectF);
            Bitmap b10 = this.f25885a.b();
            if (b10 == null) {
                return;
            }
            if (this.f25896o == null || this.f25895n != b10) {
                this.f25895n = b10;
                Shader.TileMode tileMode = Shader.TileMode.CLAMP;
                BitmapShader bitmapShader = new BitmapShader(b10, tileMode, tileMode);
                this.f25896o = bitmapShader;
                this.h.setShader(bitmapShader);
            }
            float width = rectF2.width() / this.f25895n.getWidth();
            float height = rectF2.height() / this.f25895n.getHeight();
            Matrix matrix = this.f25897p;
            matrix.reset();
    ...
    public la(ha haVar, View view, int i10, boolean z10) {
        this.f25889g = new Paint(3);
        this.h = new Paint(3);
        this.f25892k = new Path();
        this.f25897p = new Matrix();
        this.f25898q = new RectF();
        this.f25899r = false;
        this.f25902u = new int[2];
        this.v = new int[2];
        this.f25885a = haVar;
        this.f25886b = view;
        this.f25890i = i10;
        ...
        if (i10 == 0) {
            ...
            this.f25889g.setXfermode(new PorterDuffXfermode(mode));
            AndroidUtilities.adjustSaturationColorMatrix(colorMatrix, 0.3f);
        } else if (i10 == 2) {
            Paint paint2 = this.h;
            PorterDuff.Mode mode2 = PorterDuff.Mode.SRC_IN;
            paint2.setXfermode(new PorterDuffXfermode(mode2));
            this.f25889g.setXfermode(new PorterDuffXfermode(mode2));
            ...
            this.f25889g.setXfermode(new PorterDuffXfermode(mode3));
            AndroidUtilities.adjustBrightnessColorMatrix(colorMatrix, 0.4f);
            AndroidUtilities.adjustSaturationColorMatrix(colorMatrix, 0.45f);
        } else if (i10 == 10) {
            colorMatrix.setSaturation(1.6f);
            AndroidUtilities.multiplyBrightnessColorMatrix(colorMatrix, this.f25899r ? 0.97f : 0.92f);
            AndroidUtilities.adjustBrightnessColorMatrix(colorMatrix, this.f25899r ? 0.12f : -0.06f);
        }
        this.h.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
        this.f25889g.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
