...
public abstract class so extends LinearLayout {
    public fk0 f27933a;
    public ActionBarPopupWindow$ActionBarPopupWindowLayout f27934b;
    public FrameLayout f27935c;
    public int d;
    public float e;
    public float f27936f;
    public float h;
    public float f27937n;
    public float f27938r;

    public final void a() {
        FrameLayout frameLayout = this.f27935c;
        if (frameLayout != null) {
            frameLayout.setTranslationY(this.h + this.f27937n + this.f27938r);
        }
    }

    public final void b() {
        float f7 = (1.0f - this.f27936f) * this.e;
        this.f27934b.setTranslationX(f7);
        FrameLayout frameLayout = this.f27935c;
        if (frameLayout != null) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        fk0 fk0Var = this.f27933a;
        if (fk0Var != null && this.f27934b != null) {
            fk0Var.getLayoutParams().width = -2;
            int i16 = 0;
            ((LinearLayout.LayoutParams) this.f27933a.getLayoutParams()).rightMargin = 0;
            this.e = 0.0f;
            super.onMeasure(i14, i12);
            int measuredWidth = this.f27933a.getMeasuredWidth();
            if (this.f27934b.getSwipeBack() != null && this.f27934b.getSwipeBack().getMeasuredWidth() > measuredWidth) {
                measuredWidth = this.f27934b.getSwipeBack().getMeasuredWidth();
            }
            if (this.f27934b.getMeasuredWidth() > measuredWidth) {
                measuredWidth = this.f27934b.getMeasuredWidth();
            }
            if (this.f27933a.q()) {
                i14 = View.MeasureSpec.makeMeasureSpec(measuredWidth, 1073741824);
            }
            fk0 fk0Var2 = this.f27933a;
            if (!fk0Var2.f23977e1 && fk0Var2.Q0 && fk0Var2.getMeasuredWidth() > 0) {
                ...
                ((FrameLayout.LayoutParams) fk0Var2.f24009z0.getLayoutParams()).topMargin = max;
                ((FrameLayout.LayoutParams) fk0Var2.f23968b.getLayoutParams()).topMargin = max;
                fk0Var2.f23977e1 = true;
            }
            int totalWidth = this.f27933a.getTotalWidth();
            if (this.f27934b.getSwipeBack() != null) {
                viewGroup = this.f27934b.getSwipeBack();
            } else {
                viewGroup = this.f27934b;
            }
            ...
            int hintTextWidth = this.f27933a.getHintTextWidth();
            if (hintTextWidth > dp2) {
                dp2 = hintTextWidth;
            } else if (dp2 > measuredWidth) {
                dp2 = measuredWidth;
            }
            this.f27933a.G = AndroidUtilities.dp(36.0f);
            if (this.f27933a.q()) {
                this.f27933a.getLayoutParams().width = totalWidth;
                this.f27933a.G = Math.max((totalWidth - childAt.getMeasuredWidth()) - AndroidUtilities.dp(36.0f), AndroidUtilities.dp(36.0f));
                ...
                if (dp4 <= totalWidth && dp3 != this.f27933a.getItemsCount()) {
                    totalWidth = dp4;
                }
                this.f27933a.getLayoutParams().width = totalWidth;
            } else {
                this.f27933a.getLayoutParams().width = -2;
            }
            if (this.f27933a.getMeasuredWidth() == measuredWidth && this.f27933a.q()) {
                float measuredWidth2 = (measuredWidth - childAt.getMeasuredWidth()) * 0.25f;
                this.e = measuredWidth2;
                fk0 fk0Var3 = this.f27933a;
                ...
                if (this.f27934b.getSwipeBack() != null) {
                    i13 = this.f27934b.getSwipeBack().getMeasuredWidth() - this.f27934b.getSwipeBack().getChildAt(0).getMeasuredWidth();
                } else {
                    i13 = 0;
                }
                if (this.f27933a.getLayoutParams().width != -2 && this.f27933a.getLayoutParams().width + i13 > measuredWidth) {
                    i13 = AndroidUtilities.dp(8.0f) + (measuredWidth - this.f27933a.getLayoutParams().width);
                }
                if (i13 >= 0) {
                    i16 = i13;
                }
                ((LinearLayout.LayoutParams) this.f27933a.getLayoutParams()).rightMargin = i16;
                this.e = 0.0f;
                b();
            }
            if (this.f27935c != null) {
                if (this.f27933a.q()) {
                    this.f27935c.getLayoutParams().width = AndroidUtilities.dp(16.0f) + childAt.getMeasuredWidth();
                    b();
                } else {
                    this.f27935c.getLayoutParams().width = -1;
                }
                if (this.f27934b.getSwipeBack() != null) {
                    ((LinearLayout.LayoutParams) this.f27935c.getLayoutParams()).rightMargin = AndroidUtilities.dp(36.0f) + i16;
                } else {
                    ((LinearLayout.LayoutParams) this.f27935c.getLayoutParams()).rightMargin = AndroidUtilities.dp(36.0f);
                }
            }
            super.onMeasure(i14, i12);
        } else {
    ...
    public void setExpandSize(float f7) {
        this.f27934b.setTranslationY(f7);
        this.f27937n = f7;
        a();
    }
    ...
    public void setPopupWindowLayout(ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout) {
        this.f27934b = actionBarPopupWindow$ActionBarPopupWindowLayout;
        ...
        if (actionBarPopupWindow$ActionBarPopupWindowLayout.getSwipeBack() != null) {
            ...
            swipeBack.f28402x.add(new tg0() {
                @Override
                public final void a(float f7, float f10) {
                    so soVar = so.this;
                    FrameLayout frameLayout = soVar.f27935c;
                    if (frameLayout != null) {
    ...
    public void setReactionsTransitionProgress(float f7) {
        this.f27934b.setReactionsTransitionProgress(f7);
        FrameLayout frameLayout = this.f27935c;
        if (frameLayout != null) {
            frameLayout.setAlpha(f7);
            float f10 = (f7 * 0.5f) + 0.5f;
            FrameLayout frameLayout2 = this.f27935c;
            frameLayout2.setPivotX(frameLayout2.getMeasuredWidth());
            this.f27935c.setPivotY(0.0f);
            this.f27938r = (1.0f - f7) * (-this.f27934b.getMeasuredHeight());
            a();
            this.f27935c.setScaleX(f10);
            this.f27935c.setScaleY(f10);
        }
    }
}
