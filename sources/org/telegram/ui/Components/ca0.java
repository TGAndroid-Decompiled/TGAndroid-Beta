...
public final class ca0 extends org.telegram.ui.ActionBar.n2 implements qu0, ng.b, NotificationCenter.NotificationCenterDelegate {
    ...
    public int f24946a;
    public final boolean[] f24947a0;
    public pu0 f24948b;
    public final ValueAnimator[] f24949b0;
    public TLRPC.ChatFull f24950c;
    ...
    public int f24954r;
    public FrameLayout f24955s;
    public final FrameLayout[] v;
    public final org.telegram.ui.ActionBar.j5[] f24956w;
    public final q6[] f24957x;
    public x90 f24958y;

    public ca0(Bundle bundle, pu0 pu0Var) {
        super(bundle);
        this.v = new FrameLayout[2];
        this.f24956w = new org.telegram.ui.ActionBar.j5[2];
        this.f24957x = new q6[2];
        this.L = true;
        this.M = true;
        this.N = -12;
        this.Y = new boolean[2];
        this.Z = new float[2];
        this.f24947a0 = new boolean[]{true, true};
        this.f24949b0 = new ValueAnimator[2];
        this.f24948b = pu0Var;
    }
    ...
    public final void M() {
        pu0 pu0Var;
        z90 z90Var = this.V;
        if (z90Var != null && (pu0Var = this.f24948b) != null) {
            z90Var.setNewMediaCounts(pu0Var.f29494c);
        }
        a0();
    }

    public final void X(TLRPC.ChatFull chatFull) {
        this.f24950c = chatFull;
    }
    ...
    public final void Y(int i10, boolean z10, boolean z11) {
        ...
        if (i11 != 3) {
            if (i10 != 1 || i11 != 2) {
                ...
                zArr2[i10] = false;
                zArr[i10] = z10;
                ValueAnimator[] valueAnimatorArr = this.f24949b0;
                ...
                fArr[i10] = f7;
                org.telegram.ui.ActionBar.j5[] j5VarArr = this.f24956w;
    ...
    public final void Z() {
        ...
        this.actionBar.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20608a7, false));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.userInfoDidLoad && ((Long) objArr[0]).longValue() == this.f24951e) {
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, null, null, null, z6Var, org.telegram.ui.ActionBar.j6.f20664d6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, null, null, null, z6Var, org.telegram.ui.ActionBar.j6.f21064z8));
    ...
    public final boolean onFragmentCreate() {
        int i10;
        this.f24946a = getArguments().getInt("type", 0);
        this.f24951e = getArguments().getLong("dialog_id");
        this.f24952f = getArguments().getLong("topic_id", 0L);
        this.h = getArguments().getString("hashtag", "");
        this.f24953n = getArguments().getString("username", "");
        this.f24954r = getArguments().getInt("storiesCount", -1);
        int i11 = this.f24946a;
        if (i11 == 2) {
            i10 = 9;
        } else if (i11 == 1) {
        ...
        if (DialogObject.isUserDialog(this.f24951e) && this.f24952f == 0) {
            TLRPC.User user = getMessagesController().getUser(Long.valueOf(this.f24951e));
            if (UserObject.isUserSelf(user)) {
                getMessagesController().loadUserInfo(user, false, this.classGuid);
                this.d = getMessagesController().getUserFull(this.f24951e);
            }
        }
        if (this.f24948b == null) {
            this.f24948b = new pu0(this);
        }
        this.f24948b.f29501x.add(this);
