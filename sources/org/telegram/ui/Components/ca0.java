...
public final class ca0 extends org.telegram.ui.ActionBar.n2 implements qu0, ng.b, NotificationCenter.NotificationCenterDelegate {
    ...
    public int f24973a;
    public final boolean[] f24974a0;
    public pu0 f24975b;
    public final ValueAnimator[] f24976b0;
    public TLRPC.ChatFull f24977c;
    public TLRPC.UserFull d;
    public long f24978e;
    public long f24979f;
    public String h;
    public String f24980n;
    public int f24981r;
    public FrameLayout f24982s;
    public final FrameLayout[] v;
    public final org.telegram.ui.ActionBar.j5[] f24983w;
    public final q6[] f24984x;
    public x90 f24985y;

    public ca0(Bundle bundle, pu0 pu0Var) {
        super(bundle);
        this.v = new FrameLayout[2];
        this.f24983w = new org.telegram.ui.ActionBar.j5[2];
        this.f24984x = new q6[2];
        this.L = true;
        this.M = true;
        this.N = -12;
        this.Y = new boolean[2];
        this.Z = new float[2];
        this.f24974a0 = new boolean[]{true, true};
        this.f24976b0 = new ValueAnimator[2];
        this.f24975b = pu0Var;
    }
    ...
    public final void M() {
        pu0 pu0Var;
        z90 z90Var = this.V;
        if (z90Var != null && (pu0Var = this.f24975b) != null) {
            z90Var.setNewMediaCounts(pu0Var.f29521c);
        }
        a0();
    }

    public final void X(TLRPC.ChatFull chatFull) {
        this.f24977c = chatFull;
    }
    ...
    public final void Y(int i10, boolean z10, boolean z11) {
        ...
        if (i11 != 3) {
            if (i10 != 1 || i11 != 2) {
                ...
                zArr2[i10] = false;
                zArr[i10] = z10;
                ValueAnimator[] valueAnimatorArr = this.f24976b0;
                ...
                fArr[i10] = f7;
                org.telegram.ui.ActionBar.j5[] j5VarArr = this.f24983w;
    ...
    public final void Z() {
        ...
        this.actionBar.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20635a7, false));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.userInfoDidLoad && ((Long) objArr[0]).longValue() == this.f24978e) {
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, null, null, null, z6Var, org.telegram.ui.ActionBar.j6.f20691d6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, null, null, null, z6Var, org.telegram.ui.ActionBar.j6.f21091z8));
    ...
    public final boolean onFragmentCreate() {
        int i10;
        this.f24973a = getArguments().getInt("type", 0);
        this.f24978e = getArguments().getLong("dialog_id");
        this.f24979f = getArguments().getLong("topic_id", 0L);
        this.h = getArguments().getString("hashtag", "");
        this.f24980n = getArguments().getString("username", "");
        this.f24981r = getArguments().getInt("storiesCount", -1);
        int i11 = this.f24973a;
        if (i11 == 2) {
            i10 = 9;
        } else if (i11 == 1) {
        ...
        if (DialogObject.isUserDialog(this.f24978e) && this.f24979f == 0) {
            TLRPC.User user = getMessagesController().getUser(Long.valueOf(this.f24978e));
            if (UserObject.isUserSelf(user)) {
                getMessagesController().loadUserInfo(user, false, this.classGuid);
                this.d = getMessagesController().getUserFull(this.f24978e);
            }
        }
        if (this.f24975b == null) {
            this.f24975b = new pu0(this);
        }
        this.f24975b.f29528x.add(this);
