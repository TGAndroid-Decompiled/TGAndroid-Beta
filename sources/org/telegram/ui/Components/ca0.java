...
public abstract class ca0 {
    public static final Pattern f23287a = Pattern.compile("^\\[\\^([^\\]]+)\\]:[ \\t]*(.*)$");
    public static final Pattern f23288b = Pattern.compile("\\[\\^([^\\]]+)\\]");
    public static final Pattern f23289c = Pattern.compile("^(\\d+)[.)]\\s");

    public static TL_iv.RichText a(bf.p pVar, TL_iv.PageBlock pageBlock) {
        z90 z90Var = new z90(pageBlock);
        pVar.a(z90Var);
        return g(h(z90.x(z90Var.f30856c)));
    }
    ...
    public static TL_iv.RichText g(TL_iv.RichText richText) {
        ...
        if (richText instanceof TL_iv.textConcat) {
            ...
            return textconcat;
        } else if (richText instanceof ba0) {
            ba0 ba0Var = (ba0) richText;
            TL_iv.textStrike g10 = g(ba0Var.text);
            int i11 = ba0Var.f22954a;
            if ((i11 & 4) != 0) {
    ...
    public static org.telegram.tgnet.tl.TL_iv.RichText h(org.telegram.tgnet.tl.TL_iv.RichText r17) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.ca0.h(org.telegram.tgnet.tl.TL_iv$RichText):org.telegram.tgnet.tl.TL_iv$RichText");
    }

    public static java.lang.String i(java.lang.String r23, java.util.ArrayList r24) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.ca0.i(java.lang.String, java.util.ArrayList):java.lang.String");
    }
