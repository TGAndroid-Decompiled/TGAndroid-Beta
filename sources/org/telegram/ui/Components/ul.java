...
public final class ul extends cm {
    ...
    public final void D() {
        ...
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.f28701c;
        chatAttachAlertPhotoLayout.m0();
        chatAttachAlertPhotoLayout.A(ChatAttachAlertPhotoLayout.f22121s1.size());
    }

    @Override
    public final void G() {
        tl tlVar = this.f28701c.E;
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt instanceof org.telegram.ui.Cells.u5) {
                ...
                u5Var.f21607a.getImageReceiver().setVisible(true, true);
                u5Var.g(true);
            }
        }
    }
    ...
    public final boolean J() {
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.f28701c;
        if (!chatAttachAlertPhotoLayout.f26655b.V) {
    ...
    public final void n() {
        ...
        chatAttachAlertPhotoLayout.f22160t0 = false;
        if (ChatAttachAlertPhotoLayout.f22119q1) {
        ...
        chatAttachAlertPhotoLayout.f22156r.setVisibility(0);
    ...
    public final void o(int i10, VideoEditedInfo videoEditedInfo, boolean z10, int i11, int i12, boolean z11) {
        vi viVar = this.f28701c.f26655b;
        ArrayList arrayList = ChatAttachAlertPhotoLayout.f22120r1;
        if (!arrayList.isEmpty() && !viVar.V) {
            ...
            if (!(n2Var instanceof org.telegram.ui.zn) || !((org.telegram.ui.zn) n2Var).v()) {
                ...
                for (int i13 = 0; i13 < size; i13++) {
                    MediaController.PhotoEntry photoEntry = (MediaController.PhotoEntry) ChatAttachAlertPhotoLayout.f22120r1.get(i13);
                    if (photoEntry.ttl <= 0) {
            ...
            d5.a0(viVar.J1, viVar.j1() + ChatAttachAlertPhotoLayout.f22121s1.size(), viVar.n1(), new pl(this, z11, z10, i11));
        }
    }
    ...
    public final boolean u() {
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.f28701c;
        if (chatAttachAlertPhotoLayout.f22126b0 && chatAttachAlertPhotoLayout.P != null) {
            AndroidUtilities.runOnUIThread(new og(this, 24), 1000L);
            chatAttachAlertPhotoLayout.f22146l0.b(0.0f, false);
        ...
        if (chatAttachAlertPhotoLayout.f22160t0) {
            ArrayList arrayList = ChatAttachAlertPhotoLayout.f22120r1;
            if (arrayList.size() == 1) {
                int size = arrayList.size();
                for (int i10 = 0; i10 < size; i10++) {
                    MediaController.PhotoEntry photoEntry = (MediaController.PhotoEntry) ChatAttachAlertPhotoLayout.f22120r1.get(i10);
                ...
                chatAttachAlertPhotoLayout.f22153p0.setVisibility(4);
                chatAttachAlertPhotoLayout.f22156r.setVisibility(8);
                chatAttachAlertPhotoLayout.G.l();
                chatAttachAlertPhotoLayout.v.l();
                chatAttachAlertPhotoLayout.f26655b.V1(0);
            }
        }
        return true;
    }
