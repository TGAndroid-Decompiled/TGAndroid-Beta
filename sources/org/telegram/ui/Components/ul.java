...
public final class ul extends cm {
    ...
    public final void D() {
        ...
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.f28423c;
        chatAttachAlertPhotoLayout.m0();
        chatAttachAlertPhotoLayout.A(ChatAttachAlertPhotoLayout.f21897s1.size());
    }

    @Override
    public final void G() {
        tl tlVar = this.f28423c.E;
        int childCount = tlVar.getChildCount();
        for (int i10 = 0; i10 < childCount; i10++) {
            View childAt = tlVar.getChildAt(i10);
            if (childAt instanceof org.telegram.ui.Cells.t5) {
                org.telegram.ui.Cells.t5 t5Var = (org.telegram.ui.Cells.t5) childAt;
                t5Var.f21337a.getImageReceiver().setVisible(true, true);
                t5Var.g(true);
            }
        }
    }
    ...
    public final void n() {
        ...
        chatAttachAlertPhotoLayout.f21936t0 = false;
        if (ChatAttachAlertPhotoLayout.f21895q1) {
        ...
        chatAttachAlertPhotoLayout.f21932r.setVisibility(0);
    ...
    public final void o(int i10, VideoEditedInfo videoEditedInfo, boolean z10, int i11, int i12, boolean z11) {
        vi viVar = this.f28423c.f26461b;
        ArrayList arrayList = ChatAttachAlertPhotoLayout.f21896r1;
        if (!arrayList.isEmpty() && !viVar.V) {
            ...
            if (!(n2Var instanceof org.telegram.ui.bo) || !((org.telegram.ui.bo) n2Var).v()) {
                ...
                for (int i13 = 0; i13 < size; i13++) {
                    MediaController.PhotoEntry photoEntry = (MediaController.PhotoEntry) ChatAttachAlertPhotoLayout.f21896r1.get(i13);
                    if (photoEntry.ttl <= 0) {
            ...
            c5.a0(viVar.J1, viVar.j1() + ChatAttachAlertPhotoLayout.f21897s1.size(), viVar.n1(), new pl(this, z11, z10, i11));
        }
    }
    ...
    public final boolean u() {
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.f28423c;
        if (chatAttachAlertPhotoLayout.f21902b0 && chatAttachAlertPhotoLayout.P != null) {
            AndroidUtilities.runOnUIThread(new ng(this, 24), 1000L);
            chatAttachAlertPhotoLayout.f21922l0.b(0.0f, false);
        ...
        if (chatAttachAlertPhotoLayout.f21936t0) {
            ArrayList arrayList = ChatAttachAlertPhotoLayout.f21896r1;
            if (arrayList.size() == 1) {
                int size = arrayList.size();
                for (int i10 = 0; i10 < size; i10++) {
                    MediaController.PhotoEntry photoEntry = (MediaController.PhotoEntry) ChatAttachAlertPhotoLayout.f21896r1.get(i10);
                ...
                chatAttachAlertPhotoLayout.f21929p0.setVisibility(4);
                chatAttachAlertPhotoLayout.f21932r.setVisibility(8);
                chatAttachAlertPhotoLayout.G.l();
                chatAttachAlertPhotoLayout.v.l();
                chatAttachAlertPhotoLayout.f26461b.V1(0);
            }
        }
        return true;
    }
