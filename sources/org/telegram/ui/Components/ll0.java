...
public class ll0 extends RecyclerView implements ch.a {
    ...
    public boolean Z0;
    public int Z1;
    public s4.s0 f28223a1;
    public int a2;
    public yk0 f28224b1;
    public int f28225b2;
    public View f28226c1;
    public int f28227c2;
    public ah.y f28228d1;
    public boolean f28229d2;
    public dl0 f28230e1;
    public boolean f28231e2;
    public sk0 f28232f1;
    public int f28233f2;
    public hl0 f28234g1;
    public int f28235g2;
    public boolean f28236h1;
    public org.telegram.ui.qi f28237h2;
    public boolean f28238i1;
    public boolean f28239i2;
    public boolean f28240j1;
    public boolean f28241j2;
    public boolean f28242k1;
    public float f28243k2;
    public Drawable l1;
    public float f28244l2;
    public float f28245m1;
    public int[] f28246m2;
    public float f28247n1;
    public qk0 f28248n2;
    public long f28249o1;
    public q0.a f28250o2;
    public ArrayList f28251p1;
    public final org.telegram.ui.ActionBar.f6 f28252p2;
    public ArrayList f28253q1;
    public boolean f28254q2;
    public View f28255r1;
    public final pe f28256r2;
    public int f28257s1;
    public boolean f28258s2;
    public int f28259t1;
    public final hg.p1 f28260t2;
    public int f28261u1;
    public Paint f28262u2;
    public int f28263v1;
    public boolean f28264v2;
    public int f28265w1;
    public GenericProvider f28266w2;
    public boolean f28267x1;
    public int f28268x2;
    public int f28269y1;
    public int f28270y2;
    public boolean f28271z1;
    public boolean f28272z2;
    ...
    public static void N0(Canvas canvas, RectF rectF, float f7, float f10, float f11, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        paint.setColor(org.telegram.ui.ActionBar.j6.l1(f11, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20691d6, f6Var)));
        if (f7 == f10) {
    ...
    public final void C0(Runnable runnable) {
        this.E2.f28541b.add(new kt(runnable, 1));
    }

    public final void D0(ClippingImageView clippingImageView, FrameLayout.LayoutParams layoutParams) {
        if (this.f28228d1 == null) {
            this.f28228d1 = new ah.y(this, getContext(), 17);
        }
        this.f28228d1.addView(clippingImageView, layoutParams);
    }
    ...
    public final void J0(boolean z10) {
        ...
        if (!this.f28238i1) {
            int i11 = 0;
            if (getAdapter() != null && this.f28226c1 != null) {
                boolean R0 = R0();
                if (R0) {
                    i10 = 0;
                } else {
                ...
                if ((this.Y1 && SharedConfig.animationsEnabled()) ? false : false) {
                    if (this.A2 != i10) {
                        this.A2 = i10;
                        if (i10 == 0) {
                            this.f28226c1.animate().setListener(null).cancel();
                            if (this.f28226c1.getVisibility() == 8) {
                                this.f28226c1.setVisibility(0);
                                this.f28226c1.setAlpha(0.0f);
                                if (this.Z1 == 1) {
                                    this.f28226c1.setScaleX(0.7f);
                                    this.f28226c1.setScaleY(0.7f);
                                }
                            }
                            this.f28226c1.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setDuration(150L).start();
                        } else if (this.f28226c1.getVisibility() != 8) {
                            ViewPropertyAnimator alpha = this.f28226c1.animate().alpha(0.0f);
                            if (this.Z1 == 1) {
                    ...
                    this.A2 = i10;
                    this.f28226c1.setVisibility(i10);
                    this.f28226c1.setAlpha(1.0f);
                }
                if (this.A1) {
                    if (R0) {
                        i11 = 4;
    ...
    public final void K0(boolean z10) {
        ...
        int i11;
        int i12;
        if (((this.K1 || z10) && this.f28232f1 != null) || (this.f28269y1 != 0 && this.f28234g1 != null)) {
            s4.o0 layoutManager = getLayoutManager();
            if (layoutManager instanceof s4.c0) {
                s4.c0 c0Var = (s4.c0) layoutManager;
                if (c0Var.f45755o == 1) {
                    if (this.f28234g1 != null) {
                        if (this.f28269y1 == 1) {
                            paddingTop = 0;
                        } else {
                            paddingTop = getPaddingTop();
                        }
                        int i13 = this.f28269y1;
                        int i14 = Integer.MAX_VALUE;
                        if (i13 != 1 && i13 != 3) {
                            if (i13 == 2) {
                                this.f28247n1 = 0.0f;
                                if (this.f28234g1.h() != 0) {
                                    int childCount = getChildCount();
                                    View view2 = null;
                                    ...
                                    for (int i17 = 0; i17 < childCount; i17++) {
                                        ...
                                        if (bottom > this.f28265w1 + paddingTop) {
                                            if (bottom < i14) {
                                                view3 = childAt;
                                                i14 = bottom;
                                            }
                                            i16 = Math.max(i16, bottom);
                                            if (bottom >= AndroidUtilities.dp(32.0f) + this.f28265w1 + paddingTop && bottom < i15) {
                                                view2 = childAt;
                                                i15 = bottom;
                                            }
                                        }
                                    }
                                    if (view3 != null && (T3 = T(view3)) != null && (S = this.f28234g1.S((b10 = T3.b()))) >= 0) {
                                        if (this.f28257s1 != S || this.f28255r1 == null) {
                                            View view4 = this.f28255r1;
                                            if (view4 == null) {
                                                z12 = true;
                                            } else {
                                                z12 = false;
                                            }
                                            View T4 = this.f28234g1.T(S, view4);
                                            if (z12) {
                                                S0(T4, false);
                                            }
                                            this.f28255r1 = T4;
                                            ...
                                            View view5 = this.f28255r1;
                                            view5.layout(0, 0, view5.getMeasuredWidth(), this.f28255r1.getMeasuredHeight());
                                            this.f28257s1 = S;
                                        }
                                        if (this.f28255r1 != null && view2 != null && view2.getClass() != this.f28255r1.getClass()) {
                                            this.f28247n1 = 1.0f;
                                        }
                                        int M = this.f28234g1.M(S);
                                        int Q = this.f28234g1.Q(b10);
                                        ...
                                        if (Q == M - 1) {
                                            int height = this.f28255r1.getHeight();
                                            int height2 = view3.getHeight() + ((view3.getTop() - paddingTop) - this.f28265w1);
                                            if (height2 < height) {
                                                i12 = height2 - height;
                                            } else {
                                                i12 = paddingTop;
                                            ...
                                            if (i12 < 0) {
                                                this.f28255r1.setTag(Integer.valueOf(paddingTop + i11 + i12));
                                            } else {
                                                this.f28255r1.setTag(Integer.valueOf(paddingTop + i11));
                                            }
                                        } else {
                                            this.f28255r1.setTag(Integer.valueOf(paddingTop + i11));
                                        }
                        ...
                        for (int i20 = 0; i20 < childCount2; i20++) {
                            ...
                            if (bottom2 > this.f28265w1 + paddingTop) {
                                if (bottom2 < i14) {
                                    i14 = bottom2;
                                    view6 = childAt2;
                                }
                                i19 = Math.max(i19, bottom2);
                                if (bottom2 >= AndroidUtilities.dp(32.0f) + this.f28265w1 + paddingTop && bottom2 < i18) {
                                    i18 = bottom2;
                                }
                            }
                        }
                        if (view6 != null && (T = T(view6)) != null) {
                            ...
                            if ((this.K1 || z10) && (sk0Var2 = this.f28232f1) != null && !sk0Var2.f30370n && (getAdapter() instanceof tk0)) {
                                this.f28232f1.setProgress(Math.min(1.0f, b11 / ((this.f28234g1.h() - abs) + 1)));
                            }
                            this.f28253q1.addAll(this.f28251p1);
                            this.f28251p1.clear();
                            if (this.f28234g1.h() != 0) {
                                if (this.f28257s1 != b11 || this.f28259t1 != abs) {
                                    this.f28257s1 = b11;
                                    this.f28259t1 = abs;
                                    this.f28263v1 = 1;
                                    int S3 = this.f28234g1.S(b11);
                                    this.f28261u1 = S3;
                                    int M2 = (this.f28234g1.M(S3) + b11) - this.f28234g1.Q(b11);
                                    while (M2 < b11 + abs) {
                                        M2 += this.f28234g1.M(this.f28261u1 + this.f28263v1);
                                        this.f28263v1++;
                                    }
                                }
                                if (this.f28269y1 != 3) {
                                    int i21 = b11;
                                    for (int i22 = this.f28261u1; i22 < this.f28261u1 + this.f28263v1; i22++) {
                                        if (!this.f28253q1.isEmpty()) {
                                            view = (View) this.f28253q1.get(0);
                                            this.f28253q1.remove(0);
                                        } else {
                                            view = null;
                                        }
                                        if (view == null) {
                                        ...
                                        View T5 = this.f28234g1.T(i22, view);
                                        if (z11) {
                                            S0(T5, false);
                                        }
                                        this.f28251p1.add(T5);
                                        int M3 = this.f28234g1.M(i22);
                                        if (i22 == this.f28261u1) {
                                            int Q3 = this.f28234g1.Q(i21);
                                            if (Q3 == M3 - 1) {
                                            ...
                                            i21 = (M3 - this.f28234g1.Q(b11)) + i21;
                                        } else {
                    ...
                    if (L0 != -1) {
                        if ((this.K1 || z10) && (sk0Var = this.f28232f1) != null && !sk0Var.f30370n) {
                            s4.h0 adapter = getAdapter();
                            if (adapter instanceof tk0) {
                                tk0 tk0Var = (tk0) adapter;
                                float H = tk0Var.H(this);
                                this.f28232f1.setIsVisible(tk0Var.E(this));
                                this.f28232f1.setProgress(Math.min(1.0f, H));
                                this.f28232f1.a(false);
                            }
                        }
                    }
                }
    ...
    public final void L0(float f7, float f10) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (rectF.contains(min2, min)) {
                ...
                int i11 = this.f28235g2;
                if (i11 != S) {
                    int i12 = this.f28233f2;
                    if (i11 <= i12 && S <= i12) {
                        z10 = false;
                    } else {
                        z10 = true;
                    }
                    org.telegram.ui.co coVar2 = this.f28237h2.d;
                    org.telegram.ui.om omVar = coVar2.A0;
                    ArrayList arrayList = coVar2.f35468u6;
                    int i13 = S - omVar.J;
                    if (i13 >= 0 && i13 < arrayList.size()) {
                        MessageObject messageObject = (MessageObject) arrayList.get(i13);
                        if (messageObject.contentType == 0 && messageObject.hasValidGroupId() && (groupedMessages = (MessageObject.GroupedMessages) coVar2.f35507x6.f(messageObject.getGroupId())) != null) {
                    ...
                    if (z10) {
                        int i14 = this.f28235g2;
                        if (S > i14) {
                            if (!this.f28237h2.f39910a) {
                                for (int i15 = i14 + 1; i15 <= S; i15++) {
                                    if (i15 != this.f28233f2 && this.f28237h2.a(i15)) {
                                        this.f28237h2.b(i15, true, min2, min);
                                    }
                                }
                            }
                        } else {
                            while (i14 > S) {
                                if (i14 != this.f28233f2 && this.f28237h2.a(i14)) {
                                    this.f28237h2.b(i14, false, min2, min);
                                }
                                i14--;
                            }
                        }
                    } else {
                        int i16 = this.f28235g2;
                        if (S > i16) {
                            while (i16 < S) {
                                if (i16 != this.f28233f2 && this.f28237h2.a(i16)) {
                                    this.f28237h2.b(i16, false, min2, min);
                                }
                                i16++;
                            }
                        } else if (!this.f28237h2.f39910a) {
                            for (int i17 = i16 - 1; i17 >= S; i17--) {
                                if (i17 != this.f28233f2 && this.f28237h2.a(i17)) {
                                    this.f28237h2.b(i17, true, min2, min);
                                }
                            }
                        }
                    }
    ...
    public final void M0(Canvas canvas, View view) {
        boolean z10;
        boolean z11;
        if (view != null && ((Boolean) this.H2.f32629a.run(view)).booleanValue()) {
            ...
            if (R == -1) {
                ...
                View T0 = T0(R - 1);
                View T02 = T0(R + 1);
                if (T0 != null && ((Boolean) this.H2.f32629a.run(T0)).booleanValue()) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                if (T02 != null && ((Boolean) this.H2.f32629a.run(T02)).booleanValue()) {
                    z11 = true;
                } else {
                    z11 = false;
                }
    ...
    public final void Q0(Canvas canvas) {
        ...
        if (!rect.isEmpty() && (zVar = this.D1) != null) {
            ...
            canvas.save();
            int i11 = this.I1;
            if ((i11 == -2 || i11 == this.E1) && (aVar = this.f28250o2) != null) {
                aVar.accept(canvas);
            }
            int i12 = this.I1;
    ...
    public final Drawable U0(View view, boolean z10) {
        boolean z11;
        boolean z12;
        if (view.getParent() == this && a1() && ((Boolean) this.H2.f32629a.run(view)).booleanValue()) {
            int R = RecyclerView.R(view);
            boolean z13 = true;
            if (R == -1) {
                z12 = false;
            ...
            if (z11 && z12 && !z10) {
                ...
                if (z11 && z13) {
                    return org.telegram.ui.ActionBar.j6.b0(0, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20691d6, this.f28252p2));
                }
                z12 = z13;
            }
            Path path = new Path();
    ...
    public Integer V0(int i10) {
        GenericProvider genericProvider = this.f28266w2;
    ...
    public final void b1() {
        if (!this.f28238i1) {
            ...
            View view = this.f28226c1;
            if (view != null && view.getVisibility() != 8) {
                this.f28226c1.setVisibility(8);
            }
        }
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        View view;
        float f7;
        qk0 qk0Var = this.f28248n2;
        if (qk0Var != null) {
            ll0 ll0Var = qk0Var.f29781a;
            if (qk0Var.d || qk0Var.f29784e) {
                for (int i10 = 0; i10 < ll0Var.getChildCount(); i10++) {
                    View childAt = ll0Var.getChildAt(i10);
                    int R = RecyclerView.R(childAt);
                    if (R >= 0 && !qk0Var.f29783c.contains(childAt)) {
                        Float f10 = (Float) qk0Var.f29782b.get(R, null);
                        if (f10 == null) {
        ...
        ah.y yVar = this.f28228d1;
        if (yVar != null) {
            yVar.draw(canvas);
        }
        if (!this.f28271z1) {
            int i11 = this.f28269y1;
            float f11 = 0.0f;
            if (i11 == 1) {
                if (this.f28234g1 != null && !this.f28251p1.isEmpty()) {
                    for (int i12 = 0; i12 < this.f28251p1.size(); i12++) {
                        View view2 = (View) this.f28251p1.get(i12);
            ...
            } else if (i11 == 2 && this.f28234g1 != null && (view = this.f28255r1) != null && view.getAlpha() != 0.0f) {
                int save2 = canvas.save();
                int intValue2 = ((Integer) this.f28255r1.getTag()).intValue();
                if (LocaleController.isRTL) {
                    f11 = getWidth() - this.f28255r1.getWidth();
                }
                canvas.translate(f11, intValue2);
                Drawable drawable = this.l1;
                if (drawable != null) {
                    drawable.setBounds(0, this.f28255r1.getMeasuredHeight(), getWidth(), this.l1.getIntrinsicHeight() + this.f28255r1.getMeasuredHeight());
                    this.l1.setAlpha((int) (this.f28245m1 * 255.0f));
                    this.l1.draw(canvas);
                    long elapsedRealtime = SystemClock.elapsedRealtime();
                    long min = Math.min(20L, elapsedRealtime - this.f28249o1);
                    this.f28249o1 = elapsedRealtime;
                    float f12 = this.f28245m1;
                    float f13 = this.f28247n1;
                    if (f12 < f13) {
                ...
                canvas.clipRect(0, 0, getWidth(), this.f28255r1.getMeasuredHeight());
                this.f28255r1.draw(canvas);
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            if (this.f28270y2 == 0 && this.f28272z2) {
                setOverScrollMode(0);
            }
            this.f28270y2++;
        } else if (action == 1 || action == 3) {
            int i10 = this.f28270y2 - 1;
            this.f28270y2 = i10;
            if (i10 == 0 && this.f28272z2) {
                setOverScrollMode(2);
            }
        }
        sk0 fastScroll = getFastScroll();
        if ((fastScroll != null && fastScroll.f30354a0 && fastScroll.f30368k0 && motionEvent.getActionMasked() != 1 && motionEvent.getActionMasked() != 3) || (this.f28234g1 != null && (view = this.f28255r1) != null && view.getAlpha() != 0.0f && this.f28255r1.dispatchTouchEvent(motionEvent))) {
            return true;
        }
    ...
    public final void f0(View view) {
        if (getAdapter() instanceof kl0) {
            ...
            if (G != null) {
                ...
                if (this.f28254q2) {
                    view.setAccessibilityDelegate(this.f28256r2);
                    return;
                }
                return;
            }
    ...
    public void g1(View view, float f7, float f10, boolean z10) {
        if (!this.f28240j1 && view != null) {
            view.setPressed(z10);
        }
    }

    public View getEmptyView() {
        return this.f28226c1;
    }

    public sk0 getFastScroll() {
        return this.f28232f1;
    }

    public ArrayList<View> getHeaders() {
        return this.f28251p1;
    }

    public ArrayList<View> getHeadersCache() {
        return this.f28253q1;
    }
    ...
    public s4.s0 getOnScrollListener() {
        return this.f28223a1;
    }

    public View getPinnedHeader() {
        return this.f28255r1;
    }
    ...
    public final void h1(int i10, View view) {
        ...
        if (this.D1 != null) {
            ...
            } else if (this.f28225b2 > 0 && getAdapter() != null) {
                org.telegram.ui.Cells.z zVar = this.D1;
                if (i10 == 0) {
                    i11 = this.f28225b2;
                } else {
    ...
    public final void i1() {
        ...
        this.U1 = null;
        View view = this.F1;
        if (view != null && (i10 = this.f28268x2) != -1) {
            h1(i10, view);
            org.telegram.ui.Cells.z zVar = this.D1;
            if (zVar != null) {
    ...
    public void onAttachedToWindow() {
        ...
        sk0 sk0Var = this.f28232f1;
        if (sk0Var != null && sk0Var.getParent() != getParent()) {
            ViewGroup viewGroup = (ViewGroup) this.f28232f1.getParent();
            if (viewGroup != null) {
                viewGroup.removeView(this.f28232f1);
            }
            ((ViewGroup) getParent()).addView(this.f28232f1);
        }
    }
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (sk0Var != null) {
            ...
            int i15 = i11 + i14;
            sk0 sk0Var2 = this.f28232f1;
            if (sk0Var2.f30364g0) {
                sk0Var2.layout(0, i15, sk0Var2.getMeasuredWidth(), this.f28232f1.getMeasuredHeight() + i15);
            } else {
                int measuredWidth = getMeasuredWidth() - this.f28232f1.getMeasuredWidth();
                sk0 sk0Var3 = this.f28232f1;
                sk0Var3.layout(measuredWidth, i15, sk0Var3.getMeasuredWidth() + measuredWidth, this.f28232f1.getMeasuredHeight() + i15);
            }
            this.J1 = false;
        }
        K0(false);
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (sk0Var != null && sk0Var.getLayoutParams() != null) {
            ...
            if (sk0Var2.f30353a) {
                ...
                i12 = sk0Var2.f30365h0;
            }
            int measuredHeight = (getMeasuredHeight() - i12) - getPaddingBottom();
            this.f28232f1.getLayoutParams().height = measuredHeight;
            this.f28232f1.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(132.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(measuredHeight, 1073741824));
        }
        this.f28227c2 = ViewConfiguration.get(getContext()).getScaledTouchSlop();
    }
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        int i14 = this.f28269y1;
        if (i14 == 1) {
            if (this.f28234g1 != null && !this.f28251p1.isEmpty()) {
                for (int i15 = 0; i15 < this.f28251p1.size(); i15++) {
                    S0((View) this.f28251p1.get(i15), true);
                }
            }
        } else if (i14 == 2 && this.f28234g1 != null && (view = this.f28255r1) != null) {
            S0(view, true);
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        sk0 sk0Var = this.f28232f1;
        if (sk0Var != null && sk0Var.f30370n) {
            return false;
        }
        boolean z10 = this.f28229d2;
        org.telegram.ui.Cells.l7 l7Var = this.D2;
        if (z10 && motionEvent.getAction() != 0 && motionEvent.getAction() != 1 && motionEvent.getAction() != 3) {
            if (this.f28243k2 == Float.MAX_VALUE && this.f28244l2 == Float.MAX_VALUE) {
                this.f28243k2 = motionEvent.getX();
                this.f28244l2 = motionEvent.getY();
            }
            if (!this.f28231e2 && Math.abs(motionEvent.getY() - this.f28244l2) > this.f28227c2) {
                this.f28231e2 = true;
                k1(this, true);
            }
            if (this.f28231e2) {
                ...
                int[] iArr = this.f28246m2;
                org.telegram.ui.co coVar = qiVar.d;
                iArr[0] = (int) coVar.f35446s9;
                iArr[1] = coVar.Aa;
                if (motionEvent.getY() > (getMeasuredHeight() - AndroidUtilities.dp(56.0f)) - this.f28246m2[1] && (this.f28235g2 >= this.f28233f2 || !this.f28237h2.f39910a)) {
                    this.f28241j2 = false;
                    if (!this.f28239i2) {
                        this.f28239i2 = true;
                ...
                } else if (motionEvent.getY() < AndroidUtilities.dp(56.0f) + this.f28246m2[0] && (this.f28235g2 <= this.f28233f2 || !this.f28237h2.f39910a)) {
                    this.f28241j2 = true;
                    if (!this.f28239i2) {
                        this.f28239i2 = true;
                        AndroidUtilities.cancelRunOnUIThread(l7Var);
        ...
        this.f28243k2 = Float.MAX_VALUE;
        this.f28244l2 = Float.MAX_VALUE;
        this.f28229d2 = false;
        this.f28231e2 = false;
        k1(this, false);
        this.f28239i2 = false;
    ...
    public final void r1(Utilities.CallbackReturn callbackReturn, Utilities.CallbackReturn callbackReturn2, int i10, float f7, Utilities.Callback5 callback5, boolean z10) {
        setSelectorDrawableColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20799j6, this.f28252p2));
    ...
    public void setAdapter(s4.h0 h0Var) {
        s4.h0 adapter = getAdapter();
        hg.p1 p1Var = this.f28260t2;
        if (adapter != null) {
            adapter.f45823a.unregisterObserver(p1Var);
        }
        ArrayList arrayList = this.f28251p1;
        if (arrayList != null) {
            arrayList.clear();
            this.f28253q1.clear();
        }
    ...
    public void setFastScrollEnabled(int i10) {
        this.f28232f1 = new sk0(this, getContext(), i10);
        if (getParent() != null) {
            ((ViewGroup) getParent()).addView(this.f28232f1);
        }
    }
    ...
    public void setItemSelectorColorProvider(GenericProvider<Integer, Integer> genericProvider) {
        this.f28266w2 = genericProvider;
    }

    public void setItemsEnterAnimator(qk0 qk0Var) {
        this.f28248n2 = qk0Var;
    }
    ...
    public void setListSelectorColor(Integer num) {
        ...
        if (num == null) {
            if (a1()) {
                i10 = org.telegram.ui.ActionBar.j6.f20799j6;
            } else {
                i10 = org.telegram.ui.ActionBar.j6.f20781i6;
            }
            intValue = org.telegram.ui.ActionBar.j6.v0(i10, this.f28252p2);
        } else {
    ...
    public void setOnItemLongClickListener(bl0 bl0Var) {
        ...
        k20 k20Var = (k20) nVar.f16319b;
        k20Var.f27697t = z10;
        k20Var.f27698u = longPressTimeout;
    }
    ...
    public void setSectionsType(int i10) {
        ...
        this.f28251p1 = new ArrayList();
        this.f28253q1 = new ArrayList();
    }
    ...
    public ll0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f28244l2 = Float.MAX_VALUE;
        this.f28254q2 = true;
        this.f28256r2 = new pe(1);
        this.f28258s2 = true;
        this.f28260t2 = new hg.p1(this, 1);
        ...
        setGlowColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20965s8, f6Var));
        org.telegram.ui.Cells.z f02 = org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20781i6, f6Var), 2, -1);
        this.D1 = f02;
