...
public class ll0 extends RecyclerView implements bh.a {
    ...
    public boolean Z0;
    public int Z1;
    public s4.s0 f25940a1;
    public int a2;
    public yk0 f25941b1;
    public int f25942b2;
    public View f25943c1;
    public int f25944c2;
    public ai.f0 f25945d1;
    public boolean f25946d2;
    public dl0 f25947e1;
    public boolean f25948e2;
    public sk0 f25949f1;
    public int f25950f2;
    public hl0 f25951g1;
    public int f25952g2;
    public boolean f25953h1;
    public org.telegram.ui.qi f25954h2;
    public boolean f25955i1;
    public boolean f25956i2;
    public boolean f25957j1;
    public boolean f25958j2;
    public boolean f25959k1;
    public float f25960k2;
    public Drawable l1;
    public float f25961l2;
    public float f25962m1;
    public int[] f25963m2;
    public float f25964n1;
    public qk0 f25965n2;
    public long f25966o1;
    public q0.a f25967o2;
    public ArrayList f25968p1;
    public final org.telegram.ui.ActionBar.e6 f25969p2;
    public ArrayList f25970q1;
    public boolean f25971q2;
    public View f25972r1;
    public final ne f25973r2;
    public int f25974s1;
    public boolean f25975s2;
    public int f25976t1;
    public final gg.p1 f25977t2;
    public int f25978u1;
    public Paint f25979u2;
    public int f25980v1;
    public boolean f25981v2;
    public int f25982w1;
    public GenericProvider f25983w2;
    public boolean f25984x1;
    public int f25985x2;
    public int f25986y1;
    public int f25987y2;
    public boolean f25988z1;
    public boolean f25989z2;
    ...
    public static void O0(Canvas canvas, RectF rectF, float f7, float f10, float f11, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        paint.setColor(org.telegram.ui.ActionBar.i6.l1(f11, org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18834d6, e6Var)));
        if (f7 == f10) {
    ...
    public final void C0(Runnable runnable) {
        this.E2.f26881b.add(new lt(runnable, 1));
    }

    public final void D0(ClippingImageView clippingImageView, FrameLayout.LayoutParams layoutParams) {
        if (this.f25945d1 == null) {
            this.f25945d1 = new ai.f0(this, getContext(), 16);
        }
        this.f25945d1.addView(clippingImageView, layoutParams);
    }
    ...
    public final void K0(boolean z10) {
        ...
        if (!this.f25955i1) {
            int i11 = 0;
            if (getAdapter() != null && this.f25943c1 != null) {
                boolean S0 = S0();
                if (S0) {
                    i10 = 0;
                } else {
                ...
                if ((this.Y1 && SharedConfig.animationsEnabled()) ? false : false) {
                    if (this.A2 != i10) {
                        this.A2 = i10;
                        if (i10 == 0) {
                            this.f25943c1.animate().setListener(null).cancel();
                            if (this.f25943c1.getVisibility() == 8) {
                                this.f25943c1.setVisibility(0);
                                this.f25943c1.setAlpha(0.0f);
                                if (this.Z1 == 1) {
                                    this.f25943c1.setScaleX(0.7f);
                                    this.f25943c1.setScaleY(0.7f);
                                }
                            }
                            this.f25943c1.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setDuration(150L).start();
                        } else if (this.f25943c1.getVisibility() != 8) {
                            ViewPropertyAnimator alpha = this.f25943c1.animate().alpha(0.0f);
                            if (this.Z1 == 1) {
                    ...
                    this.A2 = i10;
                    this.f25943c1.setVisibility(i10);
                    this.f25943c1.setAlpha(1.0f);
                }
                if (this.A1) {
                    if (S0) {
                        i11 = 4;
    ...
    public final void L0(boolean z10) {
        ...
        int i11;
        int i12;
        if (((this.K1 || z10) && this.f25949f1 != null) || (this.f25986y1 != 0 && this.f25951g1 != null)) {
            s4.o0 layoutManager = getLayoutManager();
            if (layoutManager instanceof s4.c0) {
                s4.c0 c0Var = (s4.c0) layoutManager;
                if (c0Var.f42659o == 1) {
                    if (this.f25951g1 != null) {
                        if (this.f25986y1 == 1) {
                            paddingTop = 0;
                        } else {
                            paddingTop = getPaddingTop();
                        }
                        int i13 = this.f25986y1;
                        int i14 = Integer.MAX_VALUE;
                        if (i13 != 1 && i13 != 3) {
                            if (i13 == 2) {
                                this.f25964n1 = 0.0f;
                                if (this.f25951g1.h() != 0) {
                                    int childCount = getChildCount();
                                    View view2 = null;
                                    ...
                                    for (int i17 = 0; i17 < childCount; i17++) {
                                        ...
                                        if (bottom > this.f25982w1 + paddingTop) {
                                            if (bottom < i14) {
                                                view3 = childAt;
                                                i14 = bottom;
                                            }
                                            i16 = Math.max(i16, bottom);
                                            if (bottom >= AndroidUtilities.dp(32.0f) + this.f25982w1 + paddingTop && bottom < i15) {
                                                view2 = childAt;
                                                i15 = bottom;
                                            }
                                        }
                                    }
                                    if (view3 != null && (T3 = T(view3)) != null && (S = this.f25951g1.S((b10 = T3.b()))) >= 0) {
                                        if (this.f25974s1 != S || this.f25972r1 == null) {
                                            View view4 = this.f25972r1;
                                            if (view4 == null) {
                                                z12 = true;
                                            } else {
                                                z12 = false;
                                            }
                                            View T4 = this.f25951g1.T(S, view4);
                                            if (z12) {
                                                T0(T4, false);
                                            }
                                            this.f25972r1 = T4;
                                            ...
                                            View view5 = this.f25972r1;
                                            view5.layout(0, 0, view5.getMeasuredWidth(), this.f25972r1.getMeasuredHeight());
                                            this.f25974s1 = S;
                                        }
                                        if (this.f25972r1 != null && view2 != null && view2.getClass() != this.f25972r1.getClass()) {
                                            this.f25964n1 = 1.0f;
                                        }
                                        int M = this.f25951g1.M(S);
                                        int Q = this.f25951g1.Q(b10);
                                        ...
                                        if (Q == M - 1) {
                                            int height = this.f25972r1.getHeight();
                                            int height2 = view3.getHeight() + ((view3.getTop() - paddingTop) - this.f25982w1);
                                            if (height2 < height) {
                                                i12 = height2 - height;
                                            } else {
                                                i12 = paddingTop;
                                            ...
                                            if (i12 < 0) {
                                                this.f25972r1.setTag(Integer.valueOf(paddingTop + i11 + i12));
                                            } else {
                                                this.f25972r1.setTag(Integer.valueOf(paddingTop + i11));
                                            }
                                        } else {
                                            this.f25972r1.setTag(Integer.valueOf(paddingTop + i11));
                                        }
                        ...
                        for (int i20 = 0; i20 < childCount2; i20++) {
                            ...
                            if (bottom2 > this.f25982w1 + paddingTop) {
                                if (bottom2 < i14) {
                                    i14 = bottom2;
                                    view6 = childAt2;
                                }
                                i19 = Math.max(i19, bottom2);
                                if (bottom2 >= AndroidUtilities.dp(32.0f) + this.f25982w1 + paddingTop && bottom2 < i18) {
                                    i18 = bottom2;
                                }
                            }
                        }
                        if (view6 != null && (T = T(view6)) != null) {
                            ...
                            if ((this.K1 || z10) && (sk0Var2 = this.f25949f1) != null && !sk0Var2.f27898n && (getAdapter() instanceof tk0)) {
                                this.f25949f1.setProgress(Math.min(1.0f, b11 / ((this.f25951g1.h() - abs) + 1)));
                            }
                            this.f25970q1.addAll(this.f25968p1);
                            this.f25968p1.clear();
                            if (this.f25951g1.h() != 0) {
                                if (this.f25974s1 != b11 || this.f25976t1 != abs) {
                                    this.f25974s1 = b11;
                                    this.f25976t1 = abs;
                                    this.f25980v1 = 1;
                                    int S3 = this.f25951g1.S(b11);
                                    this.f25978u1 = S3;
                                    int M2 = (this.f25951g1.M(S3) + b11) - this.f25951g1.Q(b11);
                                    while (M2 < b11 + abs) {
                                        M2 += this.f25951g1.M(this.f25978u1 + this.f25980v1);
                                        this.f25980v1++;
                                    }
                                }
                                if (this.f25986y1 != 3) {
                                    int i21 = b11;
                                    for (int i22 = this.f25978u1; i22 < this.f25978u1 + this.f25980v1; i22++) {
                                        if (!this.f25970q1.isEmpty()) {
                                            view = (View) this.f25970q1.get(0);
                                            this.f25970q1.remove(0);
                                        } else {
                                            view = null;
                                        }
                                        if (view == null) {
                                        ...
                                        View T5 = this.f25951g1.T(i22, view);
                                        if (z11) {
                                            T0(T5, false);
                                        }
                                        this.f25968p1.add(T5);
                                        int M3 = this.f25951g1.M(i22);
                                        if (i22 == this.f25978u1) {
                                            int Q3 = this.f25951g1.Q(i21);
                                            if (Q3 == M3 - 1) {
                                            ...
                                            i21 = (M3 - this.f25951g1.Q(b11)) + i21;
                                        } else {
                    ...
                    if (L0 != -1) {
                        if ((this.K1 || z10) && (sk0Var = this.f25949f1) != null && !sk0Var.f27898n) {
                            s4.h0 adapter = getAdapter();
                            if (adapter instanceof tk0) {
                                tk0 tk0Var = (tk0) adapter;
                                float H = tk0Var.H(this);
                                this.f25949f1.setIsVisible(tk0Var.E(this));
                                this.f25949f1.setProgress(Math.min(1.0f, H));
                                this.f25949f1.a(false);
                            }
                        }
                    }
                }
    ...
    public final void M0(float f7, float f10) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (rectF.contains(min2, min)) {
                ...
                int i11 = this.f25952g2;
                if (i11 != S) {
                    int i12 = this.f25950f2;
                    if (i11 <= i12 && S <= i12) {
                        z10 = false;
                    } else {
                        z10 = true;
                    }
                    org.telegram.ui.bo boVar2 = this.f25954h2.d;
                    org.telegram.ui.nm nmVar = boVar2.A0;
                    ArrayList arrayList = boVar2.f32486u6;
                    int i13 = S - nmVar.J;
                    if (i13 >= 0 && i13 < arrayList.size()) {
                        MessageObject messageObject = (MessageObject) arrayList.get(i13);
                        if (messageObject.contentType == 0 && messageObject.hasValidGroupId() && (groupedMessages = (MessageObject.GroupedMessages) boVar2.f32525x6.f(messageObject.getGroupId())) != null) {
                    ...
                    if (z10) {
                        int i14 = this.f25952g2;
                        if (S > i14) {
                            if (!this.f25954h2.f36887a) {
                                for (int i15 = i14 + 1; i15 <= S; i15++) {
                                    if (i15 != this.f25950f2 && this.f25954h2.a(i15)) {
                                        this.f25954h2.b(i15, true, min2, min);
                                    }
                                }
                            }
                        } else {
                            while (i14 > S) {
                                if (i14 != this.f25950f2 && this.f25954h2.a(i14)) {
                                    this.f25954h2.b(i14, false, min2, min);
                                }
                                i14--;
                            }
                        }
                    } else {
                        int i16 = this.f25952g2;
                        if (S > i16) {
                            while (i16 < S) {
                                if (i16 != this.f25950f2 && this.f25954h2.a(i16)) {
                                    this.f25954h2.b(i16, false, min2, min);
                                }
                                i16++;
                            }
                        } else if (!this.f25954h2.f36887a) {
                            for (int i17 = i16 - 1; i17 >= S; i17--) {
                                if (i17 != this.f25950f2 && this.f25954h2.a(i17)) {
                                    this.f25954h2.b(i17, true, min2, min);
                                }
                            }
                        }
                    }
    ...
    public final void N0(Canvas canvas, View view) {
        boolean z10;
        boolean z11;
        if (view != null && ((Boolean) this.H2.f29991a.run(view)).booleanValue()) {
            ...
            if (R == -1) {
                ...
                View U0 = U0(R - 1);
                View U02 = U0(R + 1);
                if (U0 != null && ((Boolean) this.H2.f29991a.run(U0)).booleanValue()) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                if (U02 != null && ((Boolean) this.H2.f29991a.run(U02)).booleanValue()) {
                    z11 = true;
                } else {
                    z11 = false;
                }
    ...
    public final void R0(Canvas canvas) {
        ...
        if (!rect.isEmpty() && (zVar = this.D1) != null) {
            ...
            canvas.save();
            int i11 = this.I1;
            if ((i11 == -2 || i11 == this.E1) && (aVar = this.f25967o2) != null) {
                aVar.accept(canvas);
            }
            int i12 = this.I1;
    ...
    public final Drawable V0(View view, boolean z10) {
        boolean z11;
        boolean z12;
        if (view.getParent() == this && b1() && ((Boolean) this.H2.f29991a.run(view)).booleanValue()) {
            int R = RecyclerView.R(view);
            boolean z13 = true;
            if (R == -1) {
                z12 = false;
            ...
            if (z11 && z12 && !z10) {
                ...
                if (z11 && z13) {
                    return org.telegram.ui.ActionBar.i6.b0(0, org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18834d6, this.f25969p2));
                }
                z12 = z13;
            }
            Path path = new Path();
    ...
    public Integer W0(int i10) {
        GenericProvider genericProvider = this.f25983w2;
    ...
    public final void c1() {
        if (!this.f25955i1) {
            ...
            View view = this.f25943c1;
            if (view != null && view.getVisibility() != 8) {
                this.f25943c1.setVisibility(8);
            }
        }
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        View view;
        float f7;
        qk0 qk0Var = this.f25965n2;
        if (qk0Var != null) {
            ll0 ll0Var = qk0Var.f27370a;
            if (qk0Var.d || qk0Var.e) {
                for (int i10 = 0; i10 < ll0Var.getChildCount(); i10++) {
                    View childAt = ll0Var.getChildAt(i10);
                    int R = RecyclerView.R(childAt);
                    if (R >= 0 && !qk0Var.f27372c.contains(childAt)) {
                        Float f10 = (Float) qk0Var.f27371b.get(R, null);
                        if (f10 == null) {
        ...
        ai.f0 f0Var = this.f25945d1;
        if (f0Var != null) {
            f0Var.draw(canvas);
        }
        if (!this.f25988z1) {
            int i11 = this.f25986y1;
            float f11 = 0.0f;
            if (i11 == 1) {
                if (this.f25951g1 != null && !this.f25968p1.isEmpty()) {
                    for (int i12 = 0; i12 < this.f25968p1.size(); i12++) {
                        View view2 = (View) this.f25968p1.get(i12);
            ...
            } else if (i11 == 2 && this.f25951g1 != null && (view = this.f25972r1) != null && view.getAlpha() != 0.0f) {
                int save2 = canvas.save();
                int intValue2 = ((Integer) this.f25972r1.getTag()).intValue();
                if (LocaleController.isRTL) {
                    f11 = getWidth() - this.f25972r1.getWidth();
                }
                canvas.translate(f11, intValue2);
                Drawable drawable = this.l1;
                if (drawable != null) {
                    drawable.setBounds(0, this.f25972r1.getMeasuredHeight(), getWidth(), this.l1.getIntrinsicHeight() + this.f25972r1.getMeasuredHeight());
                    this.l1.setAlpha((int) (this.f25962m1 * 255.0f));
                    this.l1.draw(canvas);
                    long elapsedRealtime = SystemClock.elapsedRealtime();
                    long min = Math.min(20L, elapsedRealtime - this.f25966o1);
                    this.f25966o1 = elapsedRealtime;
                    float f12 = this.f25962m1;
                    float f13 = this.f25964n1;
                    if (f12 < f13) {
                ...
                canvas.clipRect(0, 0, getWidth(), this.f25972r1.getMeasuredHeight());
                this.f25972r1.draw(canvas);
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            if (this.f25987y2 == 0 && this.f25989z2) {
                setOverScrollMode(0);
            }
            this.f25987y2++;
        } else if (action == 1 || action == 3) {
            int i10 = this.f25987y2 - 1;
            this.f25987y2 = i10;
            if (i10 == 0 && this.f25989z2) {
                setOverScrollMode(2);
            }
        }
        sk0 fastScroll = getFastScroll();
        if ((fastScroll != null && fastScroll.f27883a0 && fastScroll.f27896k0 && motionEvent.getActionMasked() != 1 && motionEvent.getActionMasked() != 3) || (this.f25951g1 != null && (view = this.f25972r1) != null && view.getAlpha() != 0.0f && this.f25972r1.dispatchTouchEvent(motionEvent))) {
            return true;
        }
    ...
    public final void f0(View view) {
        if (getAdapter() instanceof kl0) {
            ...
            if (G != null) {
                ...
                if (this.f25971q2) {
                    view.setAccessibilityDelegate(this.f25973r2);
                    return;
                }
                return;
            }
    ...
    public View getEmptyView() {
        return this.f25943c1;
    }

    public sk0 getFastScroll() {
        return this.f25949f1;
    }

    public ArrayList<View> getHeaders() {
        return this.f25968p1;
    }

    public ArrayList<View> getHeadersCache() {
        return this.f25970q1;
    }
    ...
    public s4.s0 getOnScrollListener() {
        return this.f25940a1;
    }

    public View getPinnedHeader() {
        return this.f25972r1;
    }
    ...
    public final void i1(int i10, View view) {
        ...
        if (this.D1 != null) {
            ...
            } else if (this.f25942b2 > 0 && getAdapter() != null) {
                org.telegram.ui.Cells.z zVar = this.D1;
                if (i10 == 0) {
                    i11 = this.f25942b2;
                } else {
    ...
    public final void j1() {
        ...
        this.U1 = null;
        View view = this.F1;
        if (view != null && (i10 = this.f25985x2) != -1) {
            i1(i10, view);
            org.telegram.ui.Cells.z zVar = this.D1;
            if (zVar != null) {
    ...
    public void onAttachedToWindow() {
        ...
        sk0 sk0Var = this.f25949f1;
        if (sk0Var != null && sk0Var.getParent() != getParent()) {
            ViewGroup viewGroup = (ViewGroup) this.f25949f1.getParent();
            if (viewGroup != null) {
                viewGroup.removeView(this.f25949f1);
            }
            ((ViewGroup) getParent()).addView(this.f25949f1);
        }
    }
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (sk0Var != null) {
            ...
            int i15 = i11 + i14;
            sk0 sk0Var2 = this.f25949f1;
            if (sk0Var2.f27892g0) {
                sk0Var2.layout(0, i15, sk0Var2.getMeasuredWidth(), this.f25949f1.getMeasuredHeight() + i15);
            } else {
                int measuredWidth = getMeasuredWidth() - this.f25949f1.getMeasuredWidth();
                sk0 sk0Var3 = this.f25949f1;
                sk0Var3.layout(measuredWidth, i15, sk0Var3.getMeasuredWidth() + measuredWidth, this.f25949f1.getMeasuredHeight() + i15);
            }
            this.J1 = false;
        }
        L0(false);
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (sk0Var != null && sk0Var.getLayoutParams() != null) {
            ...
            if (sk0Var2.f27882a) {
                ...
                i12 = sk0Var2.f27893h0;
            }
            int measuredHeight = (getMeasuredHeight() - i12) - getPaddingBottom();
            this.f25949f1.getLayoutParams().height = measuredHeight;
            this.f25949f1.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(132.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(measuredHeight, 1073741824));
        }
        this.f25944c2 = ViewConfiguration.get(getContext()).getScaledTouchSlop();
    }
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        int i14 = this.f25986y1;
        if (i14 == 1) {
            if (this.f25951g1 != null && !this.f25968p1.isEmpty()) {
                for (int i15 = 0; i15 < this.f25968p1.size(); i15++) {
                    T0((View) this.f25968p1.get(i15), true);
                }
            }
        } else if (i14 == 2 && this.f25951g1 != null && (view = this.f25972r1) != null) {
            T0(view, true);
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        sk0 sk0Var = this.f25949f1;
        if (sk0Var != null && sk0Var.f27898n) {
            return false;
        }
        boolean z10 = this.f25946d2;
        org.telegram.ui.Cells.l7 l7Var = this.D2;
        if (z10 && motionEvent.getAction() != 0 && motionEvent.getAction() != 1 && motionEvent.getAction() != 3) {
            if (this.f25960k2 == Float.MAX_VALUE && this.f25961l2 == Float.MAX_VALUE) {
                this.f25960k2 = motionEvent.getX();
                this.f25961l2 = motionEvent.getY();
            }
            if (!this.f25948e2 && Math.abs(motionEvent.getY() - this.f25961l2) > this.f25944c2) {
                this.f25948e2 = true;
                l1(this, true);
            }
            if (this.f25948e2) {
                ...
                iArr[1] = boVar.Aa;
                if (motionEvent.getY() > (getMeasuredHeight() - AndroidUtilities.dp(56.0f)) - this.f25963m2[1] && (this.f25952g2 >= this.f25950f2 || !this.f25954h2.f36887a)) {
                    this.f25958j2 = false;
                    if (!this.f25956i2) {
                        this.f25956i2 = true;
                ...
                } else if (motionEvent.getY() < AndroidUtilities.dp(56.0f) + this.f25963m2[0] && (this.f25952g2 <= this.f25950f2 || !this.f25954h2.f36887a)) {
                    this.f25958j2 = true;
                    if (!this.f25956i2) {
                        this.f25956i2 = true;
                        AndroidUtilities.cancelRunOnUIThread(l7Var);
        ...
        this.f25960k2 = Float.MAX_VALUE;
        this.f25961l2 = Float.MAX_VALUE;
        this.f25946d2 = false;
        this.f25948e2 = false;
        l1(this, false);
        this.f25956i2 = false;
    ...
    public final void s1(Utilities.CallbackReturn callbackReturn, Utilities.CallbackReturn callbackReturn2, int i10, float f7, Utilities.Callback5 callback5, boolean z10) {
        setSelectorDrawableColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18941j6, this.f25969p2));
    ...
    public void setAdapter(s4.h0 h0Var) {
        s4.h0 adapter = getAdapter();
        gg.p1 p1Var = this.f25977t2;
        if (adapter != null) {
            adapter.f42720a.unregisterObserver(p1Var);
        }
        ArrayList arrayList = this.f25968p1;
        if (arrayList != null) {
            arrayList.clear();
            this.f25970q1.clear();
        }
    ...
    public void setFastScrollEnabled(int i10) {
        this.f25949f1 = new sk0(this, getContext(), i10);
        if (getParent() != null) {
            ((ViewGroup) getParent()).addView(this.f25949f1);
        }
    }
    ...
    public void setItemSelectorColorProvider(GenericProvider<Integer, Integer> genericProvider) {
        this.f25983w2 = genericProvider;
    }

    public void setItemsEnterAnimator(qk0 qk0Var) {
        this.f25965n2 = qk0Var;
    }
    ...
    public void setListSelectorColor(Integer num) {
        ...
        if (num == null) {
            if (b1()) {
                i10 = org.telegram.ui.ActionBar.i6.f18941j6;
            } else {
                i10 = org.telegram.ui.ActionBar.i6.f18923i6;
            }
            intValue = org.telegram.ui.ActionBar.i6.v0(i10, this.f25969p2);
        } else {
    ...
    public void setOnItemLongClickListener(bl0 bl0Var) {
        ...
        k20 k20Var = (k20) iaVar.f20260b;
        k20Var.f25526t = z10;
        k20Var.f25527u = longPressTimeout;
    }
    ...
    public void setSectionsType(int i10) {
        ...
        this.f25968p1 = new ArrayList();
        this.f25970q1 = new ArrayList();
    }
    ...
    public ll0(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.f25961l2 = Float.MAX_VALUE;
        this.f25971q2 = true;
        this.f25973r2 = new ne(1);
        this.f25975s2 = true;
        this.f25977t2 = new gg.p1(this, 1);
        ...
        setGlowColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19110s8, e6Var));
        org.telegram.ui.Cells.z f02 = org.telegram.ui.ActionBar.i6.f0(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18923i6, e6Var), 2, -1);
        this.D1 = f02;
