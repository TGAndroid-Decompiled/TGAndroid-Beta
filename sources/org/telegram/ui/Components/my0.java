...
public final class my0 extends View {
    ...
    public Drawable f26260b;
    public boolean f26261c;
    public int d;
    public final c6 e;
    public final ny0 f26262f;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f26260b != null) {
            ...
            this.f26260b.setBounds(getPaddingLeft(), getPaddingTop(), getWidth() - getPaddingRight(), getHeight() - getPaddingBottom());
            canvas.scale(d, d, getWidth() / 2, (getPaddingTop() + height) / 2);
            Drawable drawable = this.f26260b;
            if (drawable instanceof o5) {
                ((o5) drawable).q(System.currentTimeMillis());
            }
            this.f26260b.draw(canvas);
        }
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        Drawable drawable2 = this.f26260b;
        if (drawable2 instanceof o5) {
            ((o5) drawable2).o(this);
        }
        this.f26260b = drawable;
        if ((drawable instanceof o5) && this.f26261c) {
            ((o5) drawable).a(this);
        }
    }
