...
public class pq extends Drawable implements Drawable.Callback {
    public Drawable f27419a;
    public final Drawable f27420b;
    ...
    public pq(Drawable drawable, Drawable drawable2, int i10, int i11) {
        this.f27419a = drawable;
        this.f27420b = drawable2;
        this.f27421c = i10;
        this.d = i11;
        if (drawable2 != null) {
    ...
    public void draw(Canvas canvas) {
        canvas.save();
        canvas.translate(this.f27427x, 0.0f);
        if (this.f27424r) {
        ...
        Drawable drawable = this.f27419a;
        if (drawable != null) {
            drawable.setBounds(getBounds());
            this.f27419a.draw(canvas);
        }
        Drawable drawable2 = this.f27420b;
        if (drawable2 != null) {
            boolean z10 = this.f27426w;
            int i10 = this.d;
            ...
            if (z10) {
                ...
                int centerX = (getBounds().centerX() - (this.e / 2)) + i11 + this.f27425s;
                int centerY = getBounds().centerY();
                int i12 = this.f27422f;
    ...
    public final Drawable.ConstantState getConstantState() {
        return this.f27420b.getConstantState();
    }
    ...
    public final int getIntrinsicHeight() {
        ...
        return this.f27419a.getIntrinsicHeight();
    }
    ...
    public final int getIntrinsicWidth() {
        ...
        return this.f27419a.getIntrinsicWidth();
    }
    ...
    public final int getMinimumHeight() {
        ...
        return this.f27419a.getMinimumHeight();
    }
    ...
    public final int getMinimumWidth() {
        ...
        return this.f27419a.getMinimumWidth();
    }

    @Override
    public final int getOpacity() {
        return this.f27420b.getOpacity();
    }

    @Override
    public final int[] getState() {
        return this.f27420b.getState();
    }
    ...
    public final boolean isStateful() {
        return this.f27420b.isStateful();
    }

    @Override
    public final void jumpToCurrentState() {
        this.f27420b.jumpToCurrentState();
    }
    ...
    public final void setAlpha(int i10) {
        this.f27420b.setAlpha(i10);
        this.f27419a.setAlpha(i10);
    }

    @Override
    public void setColorFilter(ColorFilter colorFilter) {
        this.f27420b.setColorFilter(colorFilter);
    }

    @Override
    public final boolean setState(int[] iArr) {
        this.f27420b.setState(iArr);
        return true;
    }
