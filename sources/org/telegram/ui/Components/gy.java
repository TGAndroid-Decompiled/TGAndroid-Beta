...
public final class gy implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        int i12 = org.telegram.ui.ActionBar.j6.f20059n5;
        int i13 = kz.L2;
        ...
        textView2.setTextColor(kzVar.A(org.telegram.ui.ActionBar.j6.f19987j5));
        if (LocaleController.isRTL) {
            i11 = 5;
        } else {
            i11 = 3;
        ...
        Object obj = jyVar.f26074w;
        if (obj == null) {
            obj = kzVar.T0;
        }
        textView3.setText(LocaleController.formatString("EmojiSuggestionsUrl", i15, obj));
        textView3.setTextSize(1, 15.0f);
        textView3.setTextColor(kzVar.A(org.telegram.ui.ActionBar.j6.f20005k5));
        if (LocaleController.isRTL) {
            i14 = 5;
        }
