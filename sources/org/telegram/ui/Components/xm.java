...
public final class xm implements Runnable {
    ...
    private final void a() {
        MessageObject messageObject = (MessageObject) this.f30351c;
    ...
    private final void b() {
        ...
        org.telegram.ui.qy qyVar = ((org.telegram.ui.ux) this.f30351c).f38554f0;
        ArrayList arrayList = qyVar.R1;
        if (arrayList != null && (i10 = this.f30350b) >= 0 && i10 < arrayList.size()) {
    ...
    private final void c() {
        org.telegram.ui.oy oyVar = (org.telegram.ui.oy) this.f30351c;
        TLRPC.Dialog dialog = (TLRPC.Dialog) this.d;
        org.telegram.ui.py pyVar = oyVar.f36352g;
        org.telegram.ui.qy qyVar = oyVar.h;
        qyVar.S1 = true;
        qyVar.getMessagesController().addDialogToFolder(dialog.f18325id, 0, this.f30350b, 0L);
        qyVar.S1 = false;
    ...
    private final void e() {
        org.telegram.ui.d60 d60Var = (org.telegram.ui.d60) this.f30351c;
        org.telegram.ui.ActionBar.a2[] a2VarArr = (org.telegram.ui.ActionBar.a2[]) this.d;
        org.telegram.ui.ActionBar.a2 a2Var = a2VarArr[0];
        if (a2Var == null) {
            return;
        }
        a2Var.setOnCancelListener(new org.telegram.ui.ba(d60Var, this.f30350b, 5));
        a2VarArr[0].show();
    }

    private final void f() {
        LaunchActivity launchActivity = (LaunchActivity) this.f30351c;
