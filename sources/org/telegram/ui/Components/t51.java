...
public final class t51 extends xl0 {
    ...
    public int f28403w;
    public final u51 f28404x;
    public final SparseArray d = new SparseArray();
    public final ArrayList e = new ArrayList();
    public final SparseArray f28399f = new SparseArray();
    public final HashMap h = new HashMap();
    public final ArrayList f28400n = new ArrayList();
    public int v = 5;
    ...
    public final void E(View view, int i10, boolean z10) {
        ...
        boolean z16;
        boolean z17;
        u51 u51Var = this.f28404x;
        LongSparseArray longSparseArray = u51Var.e;
        LongSparseArray longSparseArray2 = u51Var.d;
        TLRPC.StickerSetCovered[] stickerSetCoveredArr = u51Var.f28669c;
        int i11 = u51Var.f28667a;
        MediaDataController mediaDataController = MediaDataController.getInstance(i11);
        int i12 = this.f28403w;
        ...
        while (true) {
            if (i13 < stickerSetCoveredArr.length) {
                if (stickerSetCoveredArr[i13] != null) {
                    TLRPC.TL_messages_stickerSet stickerSetById = MediaDataController.getInstance(i11).getStickerSetById(stickerSetCoveredArr[i13].set.f18370id);
                    if (stickerSetById != null && !stickerSetById.set.archived) {
                        stickerSetCoveredArr[i13] = null;
                    } else if (stickerSetCoveredArr[i13].set.f18370id == stickerSetCovered2.set.f18370id) {
                        z12 = true;
                        break;
                    }
                }
        ...
        boolean isStickerPackInstalled = mediaDataController.isStickerPackInstalled(stickerSetCovered2.set.f18370id);
        if (longSparseArray2.indexOfKey(stickerSetCovered2.set.f18370id) >= 0) {
            z13 = true;
        } else {
            z13 = false;
        }
        if (longSparseArray.indexOfKey(stickerSetCovered2.set.f18370id) >= 0) {
            z14 = true;
        } else {
            z14 = false;
        }
        if (z13 && isStickerPackInstalled) {
            longSparseArray2.remove(stickerSetCovered2.set.f18370id);
            z13 = false;
        } else if (z14 && !isStickerPackInstalled) {
            longSparseArray.remove(stickerSetCovered2.set.f18370id);
        }
    ...
    public final void G() {
        ...
        SparseArray sparseArray = this.d;
        sparseArray.clear();
        SparseArray sparseArray2 = this.f28399f;
        sparseArray2.clear();
        ...
        arrayList.clear();
        this.f28403w = 0;
        MediaDataController mediaDataController = MediaDataController.getInstance(u51Var.f28667a);
        ArrayList arrayList2 = new ArrayList(mediaDataController.getFeaturedStickerSets());
        int size = arrayList2.size();
        arrayList2.addAll(this.f28400n);
        int i11 = 0;
        int i12 = 0;
        while (true) {
            int i13 = 1;
            ...
            if (!stickerSetCovered.covers.isEmpty() || stickerSetCovered.cover != null) {
                if (i11 == size) {
                    int i14 = this.f28403w;
                    this.f28403w = i14 + 1;
                    sparseArray.put(i14, -1);
                }
                arrayList.add(stickerSetCovered);
                sparseArray2.put(this.f28403w, stickerSetCovered);
                hashMap.put(stickerSetCovered, Integer.valueOf(this.f28403w));
                int i15 = this.f28403w;
                this.f28403w = i15 + 1;
                int i16 = i12 + 1;
                ...
                if (!stickerSetCovered.covers.isEmpty()) {
                    ...
                    for (int i17 = 0; i17 < stickerSetCovered.covers.size(); i17++) {
                        sparseArray.put(this.f28403w + i17, stickerSetCovered.covers.get(i17));
                    }
                } else {
                    sparseArray.put(this.f28403w, stickerSetCovered.cover);
                }
                int i18 = 0;
                while (true) {
                    i10 = this.v * i13;
                    ...
                    sparseArray2.put(this.f28403w + i18, stickerSetCovered);
                    i18++;
                }
                this.f28403w = i10 + this.f28403w;
                i12 = i16;
            }
            i11++;
        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        ((org.telegram.ui.Cells.g8) view).d((TLRPC.Document) this.d.get(i10), null, this.f28399f.get(i10), null, false, false);
    }
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 != 2) {
                                    ...
                                    public final void onClick(View view) {
                                        switch (r2) {
                                            case 0:
                                                ...
                                                t51 t51Var = this.f28128b;
                                                u51 u51Var2 = t51Var.f28404x;
                                                LongSparseArray longSparseArray = u51Var2.d;
                                                LongSparseArray longSparseArray2 = u51Var2.e;
                                                if (longSparseArray.indexOfKey(stickerSet.set.f18370id) < 0 && longSparseArray2.indexOfKey(stickerSet.set.f18370id) < 0) {
                                                    if (t3Var.f21215r) {
                                                        longSparseArray2.put(stickerSet.set.f18370id, stickerSet);
                                                        u51Var2.f28668b.h(stickerSet);
                                                        return;
                                                    }
                                                    t51Var.F(stickerSet, t3Var);
                                                    return;
                                                }
                                                return;
                                            default:
                                                ...
                                                t51 t51Var2 = this.f28128b;
                                                u51 u51Var3 = t51Var2.f28404x;
                                                LongSparseArray longSparseArray3 = u51Var3.d;
                                                LongSparseArray longSparseArray4 = u51Var3.e;
                                                if (longSparseArray3.indexOfKey(stickerSet2.set.f18370id) < 0 && longSparseArray4.indexOfKey(stickerSet2.set.f18370id) < 0) {
                                                    if (q3Var3.f20856s) {
                                                        longSparseArray4.put(stickerSet2.set.f18370id, stickerSet2);
                                                        u51Var3.f28668b.h(stickerSet2);
                                                        return;
                                                    }
                                                    t51Var2.F(stickerSet2, q3Var3);
                                                    return;
                                                }
                                                return;
                                        }
                    ...
                    org.telegram.ui.Cells.t3 t3Var = new org.telegram.ui.Cells.t3(17, this.f28398c, u51Var.P, true, true);
