...
public final class t51 extends ww0 {
    public final int f28422a = UserConfig.selectedAccount;
    public boolean f28423b = false;
    public final float[] f28424c = new float[3];
    public final float[] d = {0.0f, 150.0f, 300.0f};
    public final float[] e = {0.0f, 0.0f, 0.0f};
    public long f28425f = 0;
    public boolean f28426g = false;
    public final DecelerateInterpolator h = new DecelerateInterpolator();
    public boolean f28427i;
    public final Paint f28428j;

    public t51(boolean z10) {
        if (z10) {
            this.f28428j = new Paint(1);
        }
    }

    @Override
    public final void b(int i10) {
        Paint paint = this.f28428j;
        if (paint != null) {
            paint.setColor(i10);
        }
    }
    ...
    @Override
    public final void d() {
        this.f28425f = System.currentTimeMillis();
        this.f28426g = true;
        invalidateSelf();
    }
    ...
    public final void f() {
        if (this.f28426g) {
            if (NotificationCenter.getInstance(this.f28422a).isAnimationInProgress() && !this.f28427i) {
                AndroidUtilities.runOnUIThread(new wq0(this, 27), 100L);
                return;
            }
            long currentTimeMillis = System.currentTimeMillis();
            long j3 = currentTimeMillis - this.f28425f;
