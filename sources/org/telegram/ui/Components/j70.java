...
public final class j70 extends wl0 {
    public ArrayList f25275c = new ArrayList();
    public ArrayList d = new ArrayList();
    public final gg.c2 e;
    public int f25276f;
    public Runnable h;
    public final n70 f25277n;
    ...
    public final int j(int i10) {
        ...
        if (i10 == this.f25276f - 1) {
            return 4;
        }
        if (i10 - 1 != this.e.d.size() + this.f25275c.size()) {
            return 1;
        }
        return 0;
    }
    ...
    public final void v(s4.c1 r12, int r13) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.j70.v(s4.c1, int):void");
    }
