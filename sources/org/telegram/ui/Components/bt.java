...
public abstract class bt extends s4.f1 {
    ...
    public int B;
    public final wl0 C;
    public final ArrayList f23080o = new ArrayList();
    public final ArrayList f23081p = new ArrayList();
    public final ArrayList f23082q = new ArrayList();
    public final ArrayList f23083r = new ArrayList();
    public final ArrayList f23084s = new ArrayList();
    public final ArrayList f23085t = new ArrayList();
    public final ArrayList f23086u = new ArrayList();
    public final ArrayList v = new ArrayList();
    public final ArrayList f23087w = new ArrayList();
    public final ArrayList f23088x = new ArrayList();
    public final ArrayList f23089y = new ArrayList();
    public org.telegram.ui.Cells.s2 f23090z;
    ...
    public final void B(ArrayList arrayList, s4.c1 c1Var) {
        for (int size = arrayList.size() - 1; size >= 0; size--) {
            ...
            if (C(zsVar, c1Var) && zsVar.f30975a == null && zsVar.f30976b == null) {
    ...
    public final boolean C(zs zsVar, s4.c1 c1Var) {
        if (zsVar.f30976b == c1Var) {
            zsVar.f30976b = null;
        } else if (zsVar.f30975a == c1Var) {
            zsVar.f30975a = null;
        } else {
            return false;
        }
    ...
    public final void f(s4.c1 c1Var) {
        View view = c1Var.f42961a;
        view.animate().cancel();
        ArrayList arrayList = this.f23082q;
        int size = arrayList.size();
        while (true) {
            size--;
            if (size < 0) {
                break;
            } else if (((at) arrayList.get(size)).f22767a == c1Var) {
                view.setTranslationY(0.0f);
                view.setTranslationX(0.0f);
                v(c1Var);
        ...
        B(this.f23083r, c1Var);
        if (this.f23080o.remove(c1Var)) {
        ...
        ArrayList arrayList2 = this.f23086u;
        ...
        ArrayList arrayList4 = this.f23085t;
        for (int size3 = arrayList4.size() - 1; size3 >= 0; size3--) {
            ...
            while (true) {
                if (size4 < 0) {
                    break;
                } else if (((at) arrayList5.get(size4)).f22767a == c1Var) {
                    view.setTranslationY(0.0f);
                    view.setTranslationX(0.0f);
                    v(c1Var);
        ...
        ArrayList arrayList6 = this.f23084s;
        ...
        this.f23088x.remove(c1Var);
        this.v.remove(c1Var);
        this.f23089y.remove(c1Var);
        this.f23087w.remove(c1Var);
        A();
    }
    ...
    public final void g() {
        ...
        while (true) {
            ...
            View view = atVar.f22767a.f42961a;
            view.setTranslationY(0.0f);
            view.setTranslationX(0.0f);
            v(atVar.f22767a);
            arrayList.remove(size);
        }
        ArrayList arrayList2 = this.f23080o;
        for (int size2 = arrayList2.size() - 1; size2 >= 0; size2--) {
        ...
        ArrayList arrayList3 = this.f23081p;
        ...
        ArrayList arrayList4 = this.f23083r;
        for (int size4 = arrayList4.size() - 1; size4 >= 0; size4--) {
            zs zsVar = (zs) arrayList4.get(size4);
            s4.c1 c1Var3 = zsVar.f30975a;
            if (c1Var3 != null) {
                C(zsVar, c1Var3);
            }
            s4.c1 c1Var4 = zsVar.f30976b;
            if (c1Var4 != null) {
                C(zsVar, c1Var4);
            }
        }
        ...
        ArrayList arrayList5 = this.f23085t;
        for (int size5 = arrayList5.size() - 1; size5 >= 0; size5--) {
            ArrayList arrayList6 = (ArrayList) arrayList5.get(size5);
            for (int size6 = arrayList6.size() - 1; size6 >= 0; size6--) {
                at atVar2 = (at) arrayList6.get(size6);
                View view4 = atVar2.f22767a.f42961a;
        ...
        ArrayList arrayList7 = this.f23084s;
        ...
        ArrayList arrayList9 = this.f23086u;
        for (int size9 = arrayList9.size() - 1; size9 >= 0; size9--) {
            ArrayList arrayList10 = (ArrayList) arrayList9.get(size9);
            for (int size10 = arrayList10.size() - 1; size10 >= 0; size10--) {
                zs zsVar2 = (zs) arrayList10.get(size10);
                s4.c1 c1Var6 = zsVar2.f30975a;
                if (c1Var6 != null) {
                    C(zsVar2, c1Var6);
                }
                s4.c1 c1Var7 = zsVar2.f30976b;
                if (c1Var7 != null) {
                    C(zsVar2, c1Var7);
                }
    ...
    public final boolean k() {
        if (this.f23081p.isEmpty()) {
            ArrayList arrayList = this.f23083r;
            if (arrayList.isEmpty() && this.f23082q.isEmpty() && arrayList.isEmpty() && this.f23087w.isEmpty() && this.f23088x.isEmpty() && this.v.isEmpty() && this.f23089y.isEmpty() && this.f23085t.isEmpty() && this.f23084s.isEmpty() && this.f23086u.isEmpty()) {
                return false;
            }
            return true;
        }
    ...
    public final void m() {
        ...
        ArrayList arrayList3 = this.f23082q;
        boolean isEmpty2 = arrayList3.isEmpty();
        ArrayList arrayList4 = this.f23083r;
        boolean isEmpty3 = arrayList4.isEmpty();
        ArrayList arrayList5 = this.f23081p;
        ...
        if (!isEmpty || !isEmpty2 || !isEmpty4 || !isEmpty3) {
            ...
            while (i11 < size) {
                ...
                View view = c1Var.f42961a;
                this.f23088x.add(c1Var);
                if (view instanceof org.telegram.ui.Cells.s2) {
                    org.telegram.ui.Cells.s2 s2Var = (org.telegram.ui.Cells.s2) view;
                    org.telegram.ui.Cells.s2 s2Var2 = this.f23090z;
                    ...
                    if (view == s2Var2) {
                        if (this.A != Integer.MAX_VALUE) {
                            ...
                            this.f23090z.setTopClip(i12);
                            this.f23090z.setBottomClip(this.B);
                        } else if (this.B != Integer.MAX_VALUE) {
                            int measuredHeight2 = s2Var2.getMeasuredHeight() - this.B;
                            this.A = measuredHeight2;
                            this.f23090z.setTopClip(measuredHeight2);
                            this.f23090z.setBottomClip(this.B);
                        }
            ...
            if (!isEmpty2) {
                ...
                this.f23085t.add(arrayList6);
                arrayList3.clear();
                new Runnable(this) {
                    public final bt f29805b;
                    ...
                    public final void run() {
                        ...
                        switch (i13) {
                            case 0:
                                ...
                                int i14 = 0;
                                while (true) {
                                    bt btVar = this.f29805b;
                                    if (i14 < size2) {
                                        Object obj2 = arrayList7.get(i14);
                                        i14++;
                                        at atVar = (at) obj2;
                                        s4.c1 c1Var2 = atVar.f22767a;
                                        int i15 = atVar.f22768b;
                                        int i16 = atVar.f22769c;
                                        int i17 = atVar.d;
                                        int i18 = atVar.e;
                            ...
                            default:
                                ...
                                int i22 = 0;
                                while (true) {
                                    bt btVar2 = this.f29805b;
                                    if (i22 < size3) {
                                        Object obj3 = arrayList7.get(i22);
                                        i22++;
                                        zs zsVar = (zs) obj3;
                                        ArrayList arrayList8 = btVar2.f23089y;
                                        s4.c1 c1Var3 = zsVar.f30975a;
                                        s4.c1 c1Var4 = zsVar.f30976b;
                                        if (c1Var3 != null && c1Var4 != null) {
                                            ...
                                            arrayList8.add(zsVar.f30975a);
                                            arrayList8.add(zsVar.f30976b);
                                        ...
                                        arrayList7.clear();
                                        btVar2.f23086u.remove(arrayList7);
                                        return;
                                    }
                                }
                        }
                            ...
                            case 0:
                                ...
                                while (true) {
                                    ...
                                    if (i14 < size2) {
                                        ...
                                        arrayList72.clear();
                                        btVar.f23085t.remove(arrayList72);
                                        return;
                                    }
                                }
                            default:
                                ...
                                while (true) {
                                    ...
                                    if (i22 < size3) {
                                        ...
                                        arrayList72.clear();
                                        btVar2.f23086u.remove(arrayList72);
                                        return;
                                    }
                                }
                        }
            ...
            if (!isEmpty4) {
                ...
                ArrayList arrayList9 = this.f23084s;
    ...
    public final void p(s4.c1 c1Var) {
        ...
        ArrayList arrayList = this.f23081p;
        arrayList.add(c1Var);
        if (arrayList.size() > 2) {
    ...
    public final boolean r(s4.c1 c1Var, b2.q0 q0Var, int i10, int i11, int i12, int i13) {
        ...
        ?? obj = new Object();
        obj.f22767a = c1Var;
        obj.f22768b = translationX;
        obj.f22769c = translationY;
        obj.d = i12;
        obj.e = i13;
        this.f23082q.add(obj);
        return true;
    }
