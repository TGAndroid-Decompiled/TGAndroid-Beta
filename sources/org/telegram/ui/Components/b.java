    ...
    public final void onClick(View view) {
        switch (this.f22824a) {
            ...
            case 1:
                ...
                return;
            case 2:
                e0 e0Var2 = this.f22825b;
                if (e0Var2.f23787k0 != null) {
                    TL_iv.RichMessage g02 = e0Var2.g0();
                    if (g02 != null) {
                        e0Var2.f23787k0.run(g02);
                    }
                } else if (e0Var2.f23786j0 != null && e0Var2.h0() != null) {
                    e0Var2.f23786j0.run(e0Var2.h0());
                }
                e0Var2.dismiss();
                return;
            case 3:
            ...
            case 4:
                ...
                return;
            case 5:
                e0.Y(this.f22825b, view);
                return;
            case 6:
                e0.R(this.f22825b, view);
                return;
            case 7:
                e0 e0Var4 = this.f22825b;
                if (!e0Var4.R0) {
