...
public final class zx0 extends FrameLayout {
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            hy0 hy0Var = this.e;
            if (hy0Var.f24758e0 != 0 && motionEvent.getY() < hy0Var.f24758e0) {
                hy0Var.dismiss();
                return true;
            }
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) hy0Var.f24755c.getLayoutParams();
        int i23 = 3;
        if (arrayList != null) {
            ...
            if (hy0Var.W != null) {
                ...
                i17 = i19 + (hy0Var.d.f23702n * hy0Var.P) + size3;
                ...
                i15 = ((org.telegram.ui.ActionBar.f3) hy0Var).backgroundPaddingTop;
                i16 = i15 + max2;
        ...
        if (hy0Var.f24755c.getPaddingTop() != i20) {
            hy0Var.f24761g0 = true;
            hy0Var.f24755c.setPadding(AndroidUtilities.dp(10.0f), i20, AndroidUtilities.dp(10.0f), AndroidUtilities.dp(8.0f));
