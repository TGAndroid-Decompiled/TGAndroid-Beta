...
public final class kk implements org.telegram.ui.ActionBar.s0, tf.b, IMapsProvider.ITouchInterceptor, IMapsProvider.OnCameraMoveStartedListener, IMapsProvider.OnMarkerClickListener, org.telegram.ui.ActionBar.c2 {
    ...
    public void a(ArrayList arrayList) {
        switch (this.f26323a) {
            case 1:
                al alVar = this.f26324b;
                ArrayList arrayList2 = alVar.f23400b0;
                if (arrayList != null) {
                    int size = arrayList2.size();
                    for (int i10 = 0; i10 < size; i10++) {
                        ((zk) arrayList2.get(i10)).f31402b.remove();
                    }
                    arrayList2.clear();
                    ...
                    for (int i11 = 0; i11 < size2; i11++) {
                        ...
                        try {
                            ...
                            obj.f31402b = addMarker;
                            obj.f31403c = tL_messageMediaVenue;
                ...
                return;
            default:
                al alVar2 = this.f26324b;
                alVar2.f23409k0 = false;
                alVar2.f0();
                return;
        }
    }
    ...
    public void m(int i10) {
        IMapsProvider.IMap iMap = this.f26324b.E;
        if (iMap != null) {
            if (i10 == 2) {
                iMap.setMapType(0);
            } else if (i10 == 3) {
    ...
    public boolean onClick(IMapsProvider.IMarker iMarker) {
        ...
        if (iMarker.getTag() instanceof zk) {
            ...
            if (!alVar.f23417r0) {
                ...
                imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i14, alVar.f24281a), PorterDuff.Mode.MULTIPLY));
            ...
            zk zkVar2 = alVar2.f23403e0;
            org.telegram.ui.ActionBar.f6 f6Var = alVar2.f24281a;
            if (zkVar2 != zkVar) {
                alVar2.d0(false);
                IMapsProvider.IMarker iMarker2 = alVar2.f23402d0;
                if (iMarker2 != null) {
                    ...
                    alVar2.f23402d0 = null;
                }
                alVar2.f23403e0 = zkVar;
                alVar2.f23402d0 = iMarker;
                Context context = xkVar.getContext();
                FrameLayout frameLayout = new FrameLayout(context);
                xkVar.addView(frameLayout, k7.b6.c(114.0f, -2));
                FrameLayout frameLayout2 = new FrameLayout(context);
                alVar2.f23404f0 = frameLayout2;
                frameLayout2.setBackgroundResource(R.drawable.venue_tooltip);
                alVar2.f23404f0.getBackground().setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19952h5, f6Var), PorterDuff.Mode.MULTIPLY));
                frameLayout.addView(alVar2.f23404f0, k7.b6.c(71.0f, -2));
                alVar2.f23404f0.setAlpha(0.0f);
                alVar2.f23404f0.setOnClickListener(new w2(7, xkVar, zkVar));
                ...
                FrameLayout frameLayout3 = alVar2.f23404f0;
                if (LocaleController.isRTL) {
                    i11 = 5;
                } else {
                    i11 = 3;
                }
                TextView h = org.telegram.ui.ai.h(frameLayout3, textView, k7.b6.d(-2, -2.0f, i11 | 48, 18.0f, 10.0f, 18.0f, 0.0f), context);
                ...
                h.setGravity(i12);
                FrameLayout frameLayout4 = alVar2.f23404f0;
                if (LocaleController.isRTL) {
                    i13 = 5;
                } else {
                    i13 = 3;
                }
                frameLayout4.addView(h, k7.b6.d(-2, -2.0f, i13 | 48, 18.0f, 32.0f, 18.0f, 0.0f));
                textView.setText(zkVar.f31403c.title);
                h.setText(LocaleController.getString(R.string.TapToSendLocation));
                FrameLayout frameLayout5 = new FrameLayout(context);
                frameLayout5.setBackground(org.telegram.ui.ActionBar.j6.K(AndroidUtilities.dp(36.0f), org.telegram.ui.Cells.t4.a(zkVar.f31401a)));
                frameLayout.addView(frameLayout5, k7.b6.d(36, 36.0f, 81, 0.0f, 0.0f, 0.0f, 4.0f));
                p9 p9Var = new p9(context);
                p9Var.f(android.support.v4.media.a.r(new StringBuilder("https://ss3.4sqi.net/img/categories_v2/"), zkVar.f31403c.venue_type, "_64.png"), null, null);
        ...
        switch (i10) {
            ...
            default:
                ...
                if (motionEvent.getAction() == 0) {
                    AnimatorSet animatorSet = alVar.f23401c0;
                    if (animatorSet != null) {
                        animatorSet.cancel();
                    }
                    AnimatorSet animatorSet2 = new AnimatorSet();
                    alVar.f23401c0 = animatorSet2;
                    animatorSet2.setDuration(200L);
                    alVar.f23401c0.playTogether(ObjectAnimator.ofFloat(imageView2, property, alVar.f23414p0 - AndroidUtilities.dp(10.0f)));
                    alVar.f23401c0.start();
                } else if (motionEvent.getAction() == 1) {
                    AnimatorSet animatorSet3 = alVar.f23401c0;
                    if (animatorSet3 != null) {
                        animatorSet3.cancel();
                    }
                    alVar.H = 0.0f;
                    AnimatorSet animatorSet4 = new AnimatorSet();
                    alVar.f23401c0 = animatorSet4;
                    animatorSet4.setDuration(200L);
                    alVar.f23401c0.playTogether(ObjectAnimator.ofFloat(imageView2, property, alVar.f23414p0));
                    alVar.f23401c0.start();
                }
                if (motionEvent.getAction() == 2) {
                    if (!alVar.f23417r0) {
                        int i11 = org.telegram.ui.ActionBar.j6.ui;
                        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i11, alVar.f24281a), PorterDuff.Mode.MULTIPLY));
                        imageView.setTag(Integer.valueOf(i11));
                        alVar.f23417r0 = true;
                    }
                    IMapsProvider.IMap iMap = alVar.E;
                    if (iMap != null && (location = alVar.f23413o0) != null) {
                        location.setLatitude(iMap.getCameraPosition().target.latitude);
                        alVar.f23413o0.setLongitude(alVar.E.getCameraPosition().target.longitude);
                    }
                    alVar.L.L(alVar.f23413o0);
                }
