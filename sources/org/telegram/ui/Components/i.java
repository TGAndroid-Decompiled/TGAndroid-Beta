...
public final class i implements View.OnLongClickListener {
    ...
    public final boolean onLongClick(View view) {
        ...
        switch (this.f24890a) {
            case 0:
                return e0.X((e0) this.f24891b, (org.telegram.ui.ActionBar.d6) this.f24892c, (Context) this.d);
            default:
                ChatActivityEnterView chatActivityEnterView = (ChatActivityEnterView) this.f24891b;
                MessageObject messageObject = (MessageObject) this.f24892c;
                ...
                vi0Var.q(arrayList);
                y70 F = y70.F(chatActivityEnterView.f22025m1, d6Var, chatActivityEnterView.F1);
