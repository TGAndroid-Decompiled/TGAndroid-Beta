...
public final class i implements View.OnLongClickListener {
    ...
    public final boolean onLongClick(View view) {
        ...
        switch (this.f24891a) {
            case 0:
                return e0.X((e0) this.f24892b, (org.telegram.ui.ActionBar.d6) this.f24893c, (Context) this.d);
            default:
                ChatActivityEnterView chatActivityEnterView = (ChatActivityEnterView) this.f24892b;
                MessageObject messageObject = (MessageObject) this.f24893c;
                ...
                vi0Var.q(arrayList);
                y70 F = y70.F(chatActivityEnterView.f22026m1, d6Var, chatActivityEnterView.F1);
