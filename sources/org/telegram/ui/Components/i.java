...
public final class i implements View.OnLongClickListener {
    ...
    public final boolean onLongClick(View view) {
        ...
        switch (this.f24760a) {
            case 0:
                return e0.X((e0) this.f24761b, (org.telegram.ui.ActionBar.f6) this.f24762c, (Context) this.d);
            default:
                ChatActivityEnterView chatActivityEnterView = (ChatActivityEnterView) this.f24761b;
                MessageObject messageObject = (MessageObject) this.f24762c;
