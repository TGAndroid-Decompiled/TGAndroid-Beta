...
public final class re implements Runnable {
    ...
    public final ChatActivityEnterView f30691b;

    public re(ChatActivityEnterView chatActivityEnterView, int i10) {
        this.f30690a = i10;
        this.f30691b = chatActivityEnterView;
    }
    ...
    public final void run() {
        switch (this.f30690a) {
            case 0:
                ChatActivityEnterView chatActivityEnterView = this.f30691b;
                re reVar = chatActivityEnterView.f24648n3;
                if ((!chatActivityEnterView.j0() || !chatActivityEnterView.v()) && !org.telegram.ui.ActionBar.p2.hasSheets(chatActivityEnterView.L2) && !chatActivityEnterView.U1 && chatActivityEnterView.B0 != null && chatActivityEnterView.f24611g3 && !chatActivityEnterView.f24689v2 && !AndroidUtilities.usingHardwareInput && !AndroidUtilities.isInMultiwindow) {
            ...
            case 1:
                ...
                return;
            default:
                ChatActivityEnterView chatActivityEnterView2 = this.f30691b;
