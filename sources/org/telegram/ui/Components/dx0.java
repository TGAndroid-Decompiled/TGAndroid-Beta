    ...
    public final void onClick(View view) {
        ...
        switch (this.f25475a) {
            ...
            case 3:
                ...
                ux0Var2.f30994b0.a(ux0Var2.T, null, ux0Var2.S, null, ux0Var2.f31004i0, true, 0, 0);
                ux0Var2.dismiss();
                return;
            case 4:
                this.f25476b.f31008n.getPopupLayout().getSwipeBack().b(true);
                return;
            case 5:
                ux0 ux0Var3 = this.f25476b;
                org.telegram.ui.p70 p70Var = ux0Var3.f30997d0;
                org.telegram.ui.u70 u70Var = p70Var.f39421c;
                s4.c0 c0Var = u70Var.h;
                boolean z10 = u70Var.N;
                int L0 = c0Var.L0();
                vk0 vk0Var = (vk0) u70Var.d.K(L0);
                if (vk0Var != null) {
                    i10 = vk0Var.f45739a.getTop();
                } else {
                    i10 = Integer.MAX_VALUE;
                }
                int i11 = u70Var.f40960n;
                if (p70Var.f39419a) {
                    u70Var.f40961r = null;
                    u70Var.f40962s = true;
                } else {
                    u70Var.f40961r = p70Var.f39420b;
                ...
                if (u70Var.f40960n != -1) {
                    ...
                    u70Var.f40958e.m(u70Var.f40960n);
                }
            ...
            case 12:
                ...
                return;
            case 13:
                ux0 ux0Var6 = this.f25476b;
                Context context = ux0Var6.getContext();
                int[] iArr = {0};
                FrameLayout frameLayout = new FrameLayout(context);
                AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(context);
                alertDialog$Builder.f20199a.R = LocaleController.getString(R.string.ImportStickersEnterName);
                ...
                g10.setTextColor(ux0Var6.getThemedColor(org.telegram.ui.ActionBar.j6.f20954t5));
                g10.setMaxLines(1);
                g10.setLines(1);
                ...
                editTextBoldCursor.setLineColors(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20972u5, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20990v5, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20899q7, false));
                editTextBoldCursor.setTextSize(1, 16.0f);
                editTextBoldCursor.setTextColor(ux0Var6.getThemedColor(org.telegram.ui.ActionBar.j6.f20771j5));
                ...
                textView.setTextColor(ux0Var6.getThemedColor(org.telegram.ui.ActionBar.j6.f20898q5));
