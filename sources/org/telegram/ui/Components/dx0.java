...
public final class dx0 extends Drawable {
    ...
    public final l5[] f26335c;
    public final boolean f26336e;
    public int d = 255;
    public final RectF f26337f = new RectF();
    ...
    public dx0(int i10, ArrayList arrayList, boolean z4) {
        ...
        for (int i12 = 0; i12 < this.f26334b; i12++) {
            this.f26335c[i12] = l5.m(i10, i11, (TLRPC.Document) arrayList.get(i12));
        }
    }

    public final void a(org.telegram.ui.Cells.t1 t1Var) {
        for (int i10 = 0; i10 < this.f26334b; i10++) {
            this.f26335c[i10].o(t1Var);
        }
    }
    ...
    public final boolean c(ArrayList arrayList) {
        long j10;
        l5[] l5VarArr = this.f26335c;
        if (l5VarArr.length == arrayList.size()) {
            for (int i10 = 0; i10 < l5VarArr.length; i10++) {
                TLRPC.Document document = l5VarArr[i10].f28599e;
                if (document == null) {
                    j10 = 0;
                } else {
                    j10 = document.f20849id;
                }
                if (j10 == ((TLRPC.Document) arrayList.get(i10)).f20849id) {
                }
            }
            return true;
        }
            ...
            for (int i12 = 0; i12 < i10; i12++) {
                ...
                if (i13 >= 0) {
                    ...
                    if (i13 < l5VarArr.length && (l5Var = l5VarArr[i13]) != null) {
                        ...
                        if (this.f26336e) {
                            porterDuffColorFilter = org.telegram.ui.ActionBar.k6.f21995w3;
                        } else {
                            porterDuffColorFilter = org.telegram.ui.ActionBar.k6.f21976v3;
                        }
