    ...
    public final void onClick(View view) {
        ...
        switch (this.f25502a) {
            ...
            case 3:
                ...
                ux0Var2.f31021b0.a(ux0Var2.T, null, ux0Var2.S, null, ux0Var2.f31031i0, true, 0, 0);
                ux0Var2.dismiss();
                return;
            case 4:
                this.f25503b.f31035n.getPopupLayout().getSwipeBack().b(true);
                return;
            case 5:
                ux0 ux0Var3 = this.f25503b;
                org.telegram.ui.p70 p70Var = ux0Var3.f31024d0;
                org.telegram.ui.u70 u70Var = p70Var.f39448c;
                s4.c0 c0Var = u70Var.h;
                boolean z10 = u70Var.N;
                int L0 = c0Var.L0();
                vk0 vk0Var = (vk0) u70Var.d.K(L0);
                if (vk0Var != null) {
                    i10 = vk0Var.f45767a.getTop();
                } else {
                    i10 = Integer.MAX_VALUE;
                }
                int i11 = u70Var.f40987n;
                if (p70Var.f39446a) {
                    u70Var.f40988r = null;
                    u70Var.f40989s = true;
                } else {
                    u70Var.f40988r = p70Var.f39447b;
                ...
                if (u70Var.f40987n != -1) {
                    ...
                    u70Var.f40985e.m(u70Var.f40987n);
                }
            ...
            case 12:
                ...
                return;
            case 13:
                ux0 ux0Var6 = this.f25503b;
                Context context = ux0Var6.getContext();
                int[] iArr = {0};
                FrameLayout frameLayout = new FrameLayout(context);
                AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(context);
                alertDialog$Builder.f20226a.R = LocaleController.getString(R.string.ImportStickersEnterName);
                ...
                g10.setTextColor(ux0Var6.getThemedColor(org.telegram.ui.ActionBar.j6.f20981t5));
                g10.setMaxLines(1);
                g10.setLines(1);
                ...
                editTextBoldCursor.setLineColors(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20999u5, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f21017v5, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20926q7, false));
                editTextBoldCursor.setTextSize(1, 16.0f);
                editTextBoldCursor.setTextColor(ux0Var6.getThemedColor(org.telegram.ui.ActionBar.j6.f20798j5));
                ...
                textView.setTextColor(ux0Var6.getThemedColor(org.telegram.ui.ActionBar.j6.f20925q5));
