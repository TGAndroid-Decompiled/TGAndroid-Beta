...
public final class zq implements Runnable {
    ...
    public final org.telegram.messenger.jb f30940b;
    public final org.telegram.ui.Cells.j3 f30941c;
    public final int[] d;
    public final ci.d e;
    public final boolean f30942f;
    public final int h;
    public final TLRPC.User f30943n;
    public final int[] f30944r;
    public final boolean[] f30945s;
    public final Utilities.Callback v;
    public final org.telegram.ui.ActionBar.e3 f30946w;
    public final org.telegram.ui.ActionBar.d6 f30947x;
    public final Context f30948y;
    ...
    public zq(String[] strArr, org.telegram.messenger.jb jbVar, org.telegram.ui.Cells.j3 j3Var, int[] iArr, ci.d dVar, boolean z10, int i10, TLRPC.User user, int[] iArr2, boolean[] zArr, Utilities.Callback callback, org.telegram.ui.ActionBar.e3 e3Var, org.telegram.ui.ActionBar.d6 d6Var, Context context) {
        ...
        this.f30946w = e3Var;
        this.f30947x = d6Var;
        this.f30948y = context;
    }

    @Override
    public final void run() {
        String[] strArr = this.f30939a;
        if (strArr[0] == null) {
            this.f30940b.run();
            return;
        }
        org.telegram.ui.Cells.j3 j3Var = this.f30941c;
        ...
        createbot.via_deeplink = this.f30942f;
        createbot.username = strArr[0];
        createbot.name = trim;
        final int i11 = this.h;
        MessagesController messagesController = MessagesController.getInstance(i11);
        final TLRPC.User user = this.f30943n;
        createbot.manager_id = messagesController.getInputUser(user);
        ConnectionsManager connectionsManager = ConnectionsManager.getInstance(i11);
        ?? obj = new Object();
        final int[] iArr2 = this.f30944r;
        final boolean[] zArr = this.f30945s;
        final Utilities.Callback callback = this.v;
        final org.telegram.ui.ActionBar.e3 e3Var = this.f30946w;
        final org.telegram.ui.ActionBar.d6 d6Var = this.f30947x;
        final Context context = this.f30948y;
            ...
            public final void run(Object obj2, Object obj3) {
                ...
                if (user2 != null) {
                    ...
                    if (equalsIgnoreCase) {
                        ...
                        SpannableStringBuilder replaceSingleLink = AndroidUtilities.replaceSingleLink(formatString, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Gi, d6Var2), new zp(e3Var2, 2));
