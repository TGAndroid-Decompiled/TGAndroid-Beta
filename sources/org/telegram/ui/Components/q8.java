...
public final class q8 implements org.telegram.ui.ActionBar.z1, mq {
    ...
    public void x0(int i10, int i11, boolean z10) {
        e9 e9Var = this.f27539b;
        if (i11 != 0) {
            if (i11 != 1) {
                if (i11 != 2) {
                    if (i11 == 3) {
                        a9 a9Var = e9Var.Y;
                        int i12 = a9Var.f22634f;
                        if (i12 != i10 && (i12 == 0 || i10 == 0)) {
                            a9 a2 = a9Var.a();
                            e9Var.Y = a2;
                            e9Var.f23878a.b(a2, true);
                            e9Var.n0();
                        }
                        e9Var.Y.f22634f = i10;
                    }
            ...
            a9 a9Var4 = e9Var.Y;
            int i15 = a9Var4.f22633c;
            if (i15 != i10 && (i15 == 0 || i10 == 0)) {
                a9 a12 = a9Var4.a();
                e9Var.Y = a12;
                e9Var.f23878a.b(a12, true);
                e9Var.n0();
            }
            e9Var.Y.f22633c = i10;
        }
