...
public final class lc0 extends Drawable {
    public final Drawable f28135a;
    public final Paint f28136b;
    ...
    public lc0(Context context) {
        ...
        this.f28137c = paint2;
        this.d = new e6(new cc0(this, 2), 200L, pr.f29467g, 0);
        this.f28135a = context.getResources().getDrawable(R.drawable.filled_sound_on).mutate();
    ...
    public final void draw(Canvas canvas) {
        ...
        Drawable drawable = this.f28135a;
        drawable.setBounds(bounds);
        drawable.draw(canvas);
        float e7 = this.d.e(this.f28138e);
        if (e7 > 0.0f) {
            ...
            float f11 = centerY;
            float f12 = dp;
            canvas.drawLine(f10, f11, f12, f7, this.f28137c);
            Paint paint = this.f28136b;
