...
public final class lc0 {
    public SpannableStringBuilder f26063a;
    public int f26064b;
    public Drawable f26065c;
    public float d;
    public final int e;
    public final int f26066f;
    public int f26067g = -1;
    public int h = -1;
    public float f26068i = 4.66f;
    ...
    public final CharSequence a(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        int dp;
        int dp2;
        SpannableStringBuilder spannableStringBuilder = this.f26063a;
        int i10 = this.f26066f;
        if (spannableStringBuilder != null && this.f26065c != null && AndroidUtilities.density == this.d) {
            if (this.f26064b != org.telegram.ui.ActionBar.h6.v0(i10, d6Var)) {
                Drawable drawable = this.f26065c;
            ...
            if (i11 <= 0) {
                dp = this.f26065c.getIntrinsicWidth();
            } else {
                dp = AndroidUtilities.dp(i11);
            }
            int i12 = this.h;
            if (i12 <= 0) {
                dp2 = this.f26065c.getIntrinsicHeight();
            } else {
                dp2 = AndroidUtilities.dp(i12);
            }
            int dp3 = AndroidUtilities.dp(this.f26068i);
            this.f26065c.setBounds(0, dp3, dp, dp2 + dp3);
            spannableStringBuilder2.setSpan(new ImageSpan(this.f26065c, 2), 0, 1, 33);
            spannableStringBuilder2.setSpan(new org.telegram.ui.Cells.q2(AndroidUtilities.dp(2.0f)), 1, 2, 33);
            this.f26063a = spannableStringBuilder2;
