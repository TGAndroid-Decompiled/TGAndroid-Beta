...
public final class eo extends LinearLayout {
    public final org.telegram.ui.ActionBar.f6 f25767a;
    public final TextView f25768b;
    public final ArrayList f25769c;
    ...
    public eo(Activity activity, View view, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        int i15 = org.telegram.ui.ActionBar.j6.f20627a;
        ...
        if (i10 == 0) {
            ...
            this.f25768b = textView;
            textView.setTextSize(1, 15.0f);
            textView.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20786ic, f6Var));
            ...
            this.f25768b = textView2;
            textView2.setTextSize(1, 15.0f);
            textView2.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20786ic, f6Var));
        ...
        textView3.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20786ic, f6Var));
        ...
        for (int i17 = 0; i17 < 4; i17++) {
            ...
            int i18 = org.telegram.ui.ActionBar.j6.f20786ic;
            imageView2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i18, this.f25767a), PorterDuff.Mode.MULTIPLY));
            if (i10 == 0) {
            ...
            textView4.setTextColor(org.telegram.ui.ActionBar.j6.v0(i18, this.f25767a));
            this.f25769c.add(textView4);
            if (LocaleController.isRTL) {
                i14 = 5;
            } else {
                i14 = 3;
            ...
            if (LocaleController.isRTL) {
                ...
                if (i10 == 0) {
                    f7.addView(imageView2, w7.x5.k(8.0f, 3.0f, 0.0f, 0.0f, -2, -2));
                } else if (i10 == 2) {
                ...
                if (i10 == 0) {
                    f7.addView(imageView2, w7.x5.k(0.0f, 4.0f, 8.0f, 0.0f, -2, -2));
                } else if (i10 == 2) {
    ...
    public void setStatusText(CharSequence charSequence) {
        this.f25768b.setText(charSequence);
    }
    ...
    public void setTextColor(int i10) {
        ...
        int i12 = 0;
        while (true) {
            ArrayList arrayList = this.f25769c;
        ...
        while (true) {
            ...
            if (i11 < arrayList2.size()) {
                ((ImageView) arrayList2.get(i11)).setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20786ic, this.f25767a), PorterDuff.Mode.MULTIPLY));
                i11++;
            } else {
                return;
            }
