...
public final class f90 extends View {
    public final Drawable f23905a;
    public final Paint f23906b;
    public final Paint f23907c;
    public final e6 d;
    public boolean e;
    ...
    public f90(Context context) {
        ...
        w7.z5.a(this);
        this.f23905a = context.getResources().getDrawable(R.drawable.media_live_on).mutate();
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int width = getWidth();
        Drawable drawable = this.f23905a;
