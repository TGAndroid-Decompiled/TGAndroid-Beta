...
public abstract class w80 extends LinearLayout {
    public final org.telegram.ui.Cells.m4 f29923a;
    public final org.telegram.ui.Cells.w8 f29924b;
    public final org.telegram.ui.Cells.w8 f29925c;
    public final org.telegram.ui.Cells.e9 d;
    public final org.telegram.ui.Cells.e9 e;
    public boolean f29926f;
    public boolean h;
    public TLRPC.Chat f29927n;
    public ValueAnimator f29928r;
    public float f29929s;
    public final int v;

    public w80(Context context, TLRPC.Chat chat) {
        super(context);
        boolean z10;
        ...
        this.f29927n = chat;
        this.f29926f = chat.join_to_send;
        ...
        w8Var.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        w80 w80Var = this.f28506b;
                        boolean z13 = w80Var.f29926f;
                        boolean z14 = !z13;
                        if (w80Var.b(z14, new v80(w80Var, w80Var.h, z13, 0))) {
                            w80Var.setJoinRequest(false);
                            w80Var.setJoinToSend(z14);
                            return;
                        }
                        return;
                    default:
                        w80 w80Var2 = this.f28506b;
                        boolean z15 = w80Var2.h;
                        boolean z16 = !z15;
                        if (w80Var2.a(z16, new u80(w80Var2, z15, 0))) {
                            w80Var2.setJoinRequest(z16);
                            return;
                        }
                        return;
                }
        ...
        addView(e9Var2);
        boolean z13 = this.f29926f;
        this.f29929s = z13 ? 1.0f : 0.0f;
        w8Var2.setVisibility(z13 ? 0 : 8);
        d(this.f29929s);
    }

    public abstract boolean a(boolean z10, u80 u80Var);

    public boolean b(boolean z10, v80 v80Var) {
        return true;
    }
    ...
    public final void c(boolean z10) {
        ...
        this.f29923a.setVisibility(i10);
        if (z10) {
            i11 = 0;
        }
        this.f29924b.setVisibility(i11);
        if (!z10) {
            this.f29926f = true;
    ...
    public final void d(float f7) {
        int measuredHeight;
        this.f29929s = f7;
        org.telegram.ui.Cells.w8 w8Var = this.f29925c;
        w8Var.setAlpha(f7);
        float f10 = 1.0f - f7;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        int i14;
        org.telegram.ui.Cells.w8 w8Var = this.f29924b;
        if (w8Var.getVisibility() == 0) {
            int i15 = i12 - i10;
            org.telegram.ui.Cells.m4 m4Var = this.f29923a;
        ...
        int i16 = i12 - i10;
        org.telegram.ui.Cells.w8 w8Var2 = this.f29925c;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (w8Var.getVisibility() == 0) {
            measuredHeight = (w8Var2.getMeasuredHeight() * this.f29929s) + w8Var.getMeasuredHeight() + m4Var.getMeasuredHeight();
        } else {
            measuredHeight = w8Var2.getMeasuredHeight();
        }
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec((int) (measuredHeight + AndroidUtilities.lerp(e9Var.getMeasuredHeight(), e9Var2.getMeasuredHeight(), this.f29929s)), 1073741824));
    }
    ...
    public void setJoinToSend(boolean z10) {
        ...
        w8Var.setDivider(this.f29926f);
        boolean z11 = this.h;
        org.telegram.ui.Cells.w8 w8Var2 = this.f29925c;
        w8Var2.setChecked(z11);
        ValueAnimator valueAnimator = this.f29928r;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        float f10 = this.f29929s;
        if (this.f29926f) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        ...
        this.f29928r = ofFloat;
        ofFloat.setDuration(200L);
        this.f29928r.setInterpolator(sr.f28339f);
        this.f29928r.addUpdateListener(new t70(this, 1));
        this.f29928r.addListener(new r8(this, 27));
