...
public final class h80 extends org.telegram.ui.ActionBar.e3 {
    ...
    public int f24667s;
    public TLRPC.Peer v;
    public TLRPC.Peer f24668w;
    public TLRPC.InputPeer f24669x;
    ...
    public static void m(h80 h80Var, f80 f80Var) {
        ...
        if (h80Var.f24667s == 2) {
            ...
            h80Var.f24669x = inputPeer;
        }
        h80Var.dismiss();
    }

    public static void n(h80 h80Var) {
        h80Var.f24669x = MessagesController.getInstance(h80Var.currentAccount).getInputPeer(MessageObject.getPeerId(h80Var.v));
        h80Var.f24670y = true;
        h80Var.dismiss();
    }
    ...
    public static void o(h80 h80Var) {
        ...
        if (h80Var.f24667s != 0) {
            ...
            if (h80Var.f24666r != i10) {
                h80Var.e.setTranslationY(AndroidUtilities.dp(19.0f) + top);
                h80Var.f24664f.setTranslationY(AndroidUtilities.dp(56.0f) + top);
                h80Var.f24666r = i10;
    ...
    public static void v(Context context, long j3, ArrayList arrayList, org.telegram.ui.ActionBar.m2 m2Var, int i10, TLRPC.Peer peer, f80 f80Var) {
        ...
        if (i10 == 2) {
            ...
            Drawable drawable = e3Var.f24662b;
        ...
        z10 = false;
        e3Var.f24664f.setMovementMethod(new AndroidUtilities.LinkMovementMethodMy());
        e3Var.f24664f.setLinkTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19185k5, false));
        if (i10 == 0) {
            ...
            e3Var.f24664f.setText(sb2);
            e3Var.f24664f.setGravity(49);
            c80Var.addView(e3Var.f24664f, w7.y5.t(-2, -2, 49, 23, 0, 23, 5));
        } else {
            if (z10) {
                e3Var.f24664f.setText(LocaleController.getString(R.string.VoipGroupStartAsInfoGroup));
            } else {
                e3Var.f24664f.setText(LocaleController.getString(R.string.VoipGroupStartAsInfo));
            }
            TextView textView3 = e3Var.f24664f;
            ...
            c80Var.addView(e3Var.f24664f, w7.y5.d(-2, -2.0f, 51, 23.0f, 0.0f, 23.0f, 5.0f));
        }
        if (i10 == 0) {
            d80 d80Var2 = e3Var.d;
            if (e3Var.h.size() < 5) {
        ...
        e3Var.f24663c = m00Var;
        ((View) m00Var.f26321c).setOnClickListener(new et(9, e3Var, f80Var));
        if (e3Var.f24667s == 0) {
            ...
            ((View) m00Var2.f26321c).setOnClickListener(new f0((Object) e3Var, 29));
    ...
    public final void dismissInternal() {
        ...
        TLRPC.InputPeer inputPeer = this.f24669x;
        if (inputPeer != null) {
            f80 f80Var = this.F;
            boolean z10 = true;
            if (this.h.size() <= 1) {
            ...
            f80Var.a(inputPeer, z10, this.f24670y, false);
        }
    }

    public final void w(TLRPC.Chat chat, boolean z10) {
        String str;
        m00 m00Var = this.f24663c;
        if (this.f24667s == 0) {
            if (ChatObject.isChannelOrGiga(chat)) {
