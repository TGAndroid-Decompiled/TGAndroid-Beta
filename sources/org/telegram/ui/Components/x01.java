...
public final class x01 extends TextureView {
    ...
    public static boolean c() {
        if (f29839f == null) {
            f29839f = Boolean.valueOf(MessagesController.getGlobalMainSettings().getBoolean("nothanos", false));
        }
        Boolean bool = f29839f;
