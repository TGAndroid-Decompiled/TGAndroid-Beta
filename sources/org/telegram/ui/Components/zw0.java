...
public class zw0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public float I;
    public boolean J;
    public final dc1 f30672a;
    public final u9 f30673b;
    public final RadialProgressView f30674c;
    public final vh.o d;
    public final c90 e;
    public final ci.d f30675f;
    public boolean h;
    public final org.telegram.ui.ActionBar.f6 f30676n;
    public int f30677r;
    public final View f30678s;
    public int v;
    public final int f30679w;
    public boolean f30680x;
    public final org.telegram.ui.Cells.l7 f30681y;
    ...
    public final void b(int i10, boolean z10) {
        if (this.v != i10) {
            ...
            float f7 = i12 + i11;
            RadialProgressView radialProgressView = this.f30674c;
            dc1 dc1Var = this.f30672a;
            if (z10) {
    ...
    public final void c() {
        ...
        int i10;
        int i11 = this.f30677r;
        u9 u9Var = this.f30673b;
        if (i11 != 0) {
            boolean z10 = true;
            if (i11 != 1) {
                ...
                if (i11 == 16) {
                    ...
                    if (stickerSetByName != null && (i10 = this.f30677r) >= 0 && i10 < stickerSetByName.documents.size()) {
                        document2 = stickerSetByName.documents.get(this.f30677r);
                    }
    ...
    public void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f30679w).addObserver(this, NotificationCenter.diceStickersDidLoad);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f30679w).removeObserver(this, NotificationCenter.diceStickersDidLoad);
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if ((this.E || this.f30680x) && (i14 = this.F) > 0 && i14 != getMeasuredHeight()) {
            float measuredHeight = (this.F - getMeasuredHeight()) / 2.0f;
            dc1 dc1Var = this.f30672a;
            dc1Var.setTranslationY(dc1Var.getTranslationY() + measuredHeight);
            if (!this.f30680x) {
                dc1Var.animate().translationY(0.0f).setInterpolator(qr.f27380f).setDuration(250L);
            }
            RadialProgressView radialProgressView = this.f30674c;
            if (radialProgressView != null) {
                radialProgressView.setTranslationY(radialProgressView.getTranslationY() + measuredHeight);
                if (!this.f30680x) {
                    radialProgressView.animate().translationY(0.0f).setInterpolator(qr.f27380f).setDuration(250L);
                }
            }
        }
    ...
    public void setPreventMoving(boolean z10) {
        this.f30680x = z10;
        if (!z10) {
            this.f30672a.setTranslationY(0.0f);
            RadialProgressView radialProgressView = this.f30674c;
            if (radialProgressView != null) {
    ...
    public zw0(Context context, View view, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f30679w = UserConfig.selectedAccount;
        this.f30681y = new org.telegram.ui.Cells.l7(this, 24);
        this.G = org.telegram.ui.ActionBar.j6.f18845c7;
        this.f30676n = f6Var;
        this.f30678s = view;
        this.f30677r = i10;
        ...
        if (view == null) {
            ...
            this.f30674c = radialProgressView;
            radialProgressView.setAlpha(0.0f);
            radialProgressView.setScaleY(0.5f);
            radialProgressView.setScaleX(0.5f);
