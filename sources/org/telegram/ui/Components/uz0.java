...
public final class uz0 extends View {
    ...
    public final sz0 Q;
    public final org.telegram.ui.Cells.q9 f28948a;
    public int f28949b;
    public final kz0 f28950c;
    public final kz0 d;
    public int e;
    ...
    public uz0(Context context, tz0 tz0Var, org.telegram.ui.Cells.q9 q9Var) {
        super(context);
        this.f28950c = new kz0(this, true);
        this.d = new kz0(this, false);
        this.e = 0;
        this.f28951f = false;
        this.h = 1;
        this.f28952n = 0;
        this.f28953r = AndroidUtilities.dp(8.0f);
        this.f28954s = AndroidUtilities.dp(9.0f);
    ...
    public static void i(pz0 pz0Var, int i10, int i11, int i12, int i13) {
        ...
        rz0 rz0Var = pz0Var.f27451a;
        pz0Var.f27451a = new rz0(rz0Var.f28070a, oz0Var, rz0Var.f28072c, rz0Var.d);
        oz0 oz0Var2 = new oz0(i12, i13 + i12);
        rz0 rz0Var2 = pz0Var.f27452b;
        pz0Var.f27452b = new rz0(rz0Var2.f28070a, oz0Var2, rz0Var2.f28072c, rz0Var2.d);
    }
    ...
    public final void a(int i10, int i11, int i12, int i13) {
        ...
        gz0 gz0Var = U;
        pz0Var.f27451a = new rz0(false, oz0Var, gz0Var, 0.0f);
        pz0Var.f27452b = new rz0(false, new oz0(i10, i12 + i10), gz0Var, 0.0f);
        nz0Var.f26834a = pz0Var;
        nz0Var.f26840j = i11;
    ...
    public final void b(TL_iv.pageTableCell pagetablecell, int i10, int i11, int i12) {
        ...
        gz0 gz0Var = U;
        pz0Var.f27451a = new rz0(false, oz0Var, gz0Var, 0.0f);
        pz0Var.f27452b = new rz0(false, new oz0(i10, i12 + i10), gz0Var, 1.0f);
        nz0Var.f26834a = pz0Var;
        nz0Var.f26840j = i11;
        arrayList.add(nz0Var);
    ...
    public final void c() {
        ...
        if (i11 == 0) {
            ...
            for (int i16 = 0; i16 < childCount; i16++) {
                ...
                boolean z11 = rz0Var.f28070a;
                int i17 = oz0Var.f27206b;
                int i18 = oz0Var.f27205a;
                int i19 = i17 - i18;
                if (z11) {
                    i14 = i18;
                }
                ...
                oz0 oz0Var2 = rz0Var2.f28071b;
                boolean z12 = rz0Var2.f28070a;
                int i20 = oz0Var2.f27206b;
                int i21 = oz0Var2.f27205a;
                int i22 = i20 - i21;
                if (i13 != 0) {
                    if (z12) {
            ...
            for (int i25 = 0; i25 < childCount2; i25++) {
                i12 = (i12 * 31) + d(i25).f26834a.hashCode();
            }
            this.f28952n = i12;
            return;
        }
        ...
        for (int i27 = 0; i27 < childCount3; i27++) {
            i26 = (i26 * 31) + d(i27).f26834a.hashCode();
        }
        if (i11 != i26) {
            g();
            c();
    ...
    public final int e(nz0 nz0Var, boolean z10, boolean z11) {
        ...
        if (z11) {
            if (kz0Var.f25909j == null) {
                kz0Var.f25909j = new int[kz0Var.e() + 1];
            }
            if (!kz0Var.f25910k) {
                kz0Var.b(true);
                kz0Var.f25910k = true;
            ...
            if (kz0Var.f25911l == null) {
                kz0Var.f25911l = new int[kz0Var.e() + 1];
            }
            if (!kz0Var.f25912m) {
                kz0Var.b(false);
                kz0Var.f25912m = true;
    ...
    public final int f(nz0 nz0Var, boolean z10, boolean z11) {
        ...
        if (i10 == Integer.MIN_VALUE) {
            ...
            if (z12 != z11) {
                int i11 = oz0Var.f27205a;
                return 0;
            }
            int i12 = oz0Var.f27206b;
            kz0Var.e();
            return 0;
        }
        return i10;
    ...
    public final void h(int i10, boolean z10) {
        ...
        for (int i14 = 0; i14 < childCount; i14++) {
            ...
            if (z10) {
                ...
                d.e(this.O.createTextLayout(d.f26836c, i12));
                if (d.f26835b != null) {
                    ((ViewGroup.MarginLayoutParams) pz0Var).height = Math.max(this.f28955w, d.f26837f + this.f28953r + this.f28954s);
                    int emojiOnlyCount = d.f26835b.getEmojiOnlyCount();
                    if (emojiOnlyCount > 0) {
                ...
                if (rz0.a(rz0Var, z11) == U) {
                    ...
                    int[] g10 = kz0Var.g();
                    int e = (g10[oz0Var.f27206b] - g10[oz0Var.f27205a]) - (e(d, z11, false) + e(d, z11, true));
                    if (z11) {
                        mz0 mz0Var = d.f26835b;
                        if (mz0Var != null) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i16 = 0; i16 < childCount; i16++) {
            uz0Var.f28949b = Math.max(uz0Var.f28949b, uz0Var.d(i16).f26834a.f27452b.f28071b.f27206b);
        }
        uz0Var.h(i10, true);
        if (uz0Var.e == 0) {
            i12 = kz0Var2.i(i10);
            if (uz0Var.f28956x) {
                ...
                kz0Var2.v.f27791a = i12;
                kz0Var2.f25921w.f27791a = -i12;
                kz0Var2.f25916q = false;
                kz0Var2.g();
            }
            uz0Var.h(i10, false);
            i13 = kz0Var.i(i11);
        ...
        kz0Var2.f25916q = false;
        kz0Var2.g();
        kz0Var.v.f27791a = max;
        kz0Var.f25921w.f27791a = -max;
        kz0Var.f25916q = false;
        kz0Var.g();
        int[] g10 = kz0Var2.g();
        int[] g11 = kz0Var.g();
        ...
        while (i19 < childCount2) {
            ...
            nz0 d = uz0Var.d(i20);
            pz0 pz0Var = d.f26834a;
            rz0 rz0Var = pz0Var.f27452b;
            rz0 rz0Var2 = pz0Var.f27451a;
            oz0 oz0Var = rz0Var.f28071b;
            oz0 oz0Var2 = rz0Var2.f28071b;
            int i21 = childCount2;
            int i22 = g10[oz0Var.f27205a];
            int i23 = g11[oz0Var2.f27205a];
            int i24 = g10[oz0Var.f27206b] - i22;
            int i25 = g11[oz0Var2.f27206b] - i23;
            int i26 = d.f26841k;
            kz0 kz0Var3 = kz0Var;
            int i27 = d.f26842l;
            ...
            la.h f7 = kz0Var2.f();
            lz0 lz0Var = (lz0) ((Object[]) f7.d)[((int[]) f7.f14151b)[i20]];
            la.h f10 = kz0Var3.f();
            kz0 kz0Var4 = kz0Var2;
            lz0 lz0Var2 = (lz0) ((Object[]) f10.d)[((int[]) f10.f14151b)[i20]];
            ...
            if (d.f26836c != null) {
                if (c10 != d.f26841k || c11 != d.f26842l) {
                    d.d(c10, c11, false);
                }
                int i32 = d.f26843m;
                if (i32 != 0 && i32 != c11) {
                    oz0 oz0Var3 = d.f26834a.f27451a.f28071b;
                    if (oz0Var3.f27206b - oz0Var3.f27205a <= 1) {
                        ...
                        while (true) {
                            if (i33 < size) {
                                ...
                                float f11 = pointF.x;
                                float f12 = d.f26834a.f27451a.f28071b.f27205a;
        ...
        while (i34 < size2) {
            ...
            int i35 = nz0Var.f26842l;
            int i36 = nz0Var.d;
            int i37 = i35 - nz0Var.f26843m;
            ArrayList arrayList3 = uz0Var.P;
            int size3 = arrayList3.size();
            for (int i38 = i36 + 1; i38 < size3; i38++) {
                nz0 nz0Var2 = (nz0) arrayList3.get(i38);
                if (nz0Var.f26834a.f27451a.f28071b.f27205a != nz0Var2.f26834a.f27451a.f28071b.f27205a) {
                    break;
                }
                int i39 = nz0Var.f26843m;
                int i40 = nz0Var2.f26843m;
                if (i39 < i40) {
                    z10 = true;
                    break;
                }
                int i41 = nz0Var2.f26842l - i40;
                if (i41 > 0) {
            ...
            if (!z10) {
                ...
                while (true) {
                    ...
                    if (nz0Var.f26834a.f27451a.f28071b.f27205a != nz0Var3.f26834a.f27451a.f28071b.f27205a) {
                        break;
                    }
                    int i43 = nz0Var.f26843m;
                    int i44 = nz0Var3.f26843m;
                    if (i43 < i44) {
                        z10 = true;
                        break;
                    }
                    int i45 = nz0Var3.f26842l - i44;
                    if (i45 > 0) {
            ...
            if (!z10) {
                nz0Var.f26842l = nz0Var.f26843m;
                nz0Var.g();
                max -= i37;
                int i46 = nz0Var.f26834a.f27451a.f28071b.f27205a;
                while (true) {
                    i46++;
                ...
                while (i49 < size4) {
                    ...
                    if (nz0Var == nz0Var4) {
                        ...
                        int i50 = nz0Var.f26834a.f27451a.f28071b.f27205a;
                        int i51 = nz0Var4.f26834a.f27451a.f28071b.f27205a;
                        if (i50 == i51) {
                            if (nz0Var4.f26843m != nz0Var4.f26842l) {
                            ...
                            int i52 = nz0Var4.f26842l - i37;
                            nz0Var4.f26842l = i52;
                            i14 = i49;
                            nz0Var4.d(nz0Var4.f26841k, i52, true);
                        } else {
                            i14 = i49;
                            if (i50 < i51) {
                                nz0Var4.f26847q -= i37;
        ...
        for (int i53 = 0; i53 < childCount3; i53++) {
            ...
            uz0Var.O.onLayoutChild(d10.f26835b, d10.b(), d10.c());
            d10.f26844n = d10.f26846p;
            d10.f26845o = d10.f26841k;
        }
        uz0Var.f28957y = i18;
        uz0Var.E = max;
        uz0Var.F = copyOf;
    ...
    public void setRenderWidth(int i10) {
        ...
        this.f28957y = Math.max(measuredWidth, i10);
        for (int i13 = 0; i13 < getChildCount(); i13++) {
            nz0 d = d(i13);
            if (measuredWidth > 0 && (i12 = this.f28957y) != measuredWidth) {
                float f7 = measuredWidth;
                int round = Math.round((d.f26844n * i12) / f7);
                int round2 = Math.round(((d.f26844n + d.f26845o) * this.f28957y) / f7);
                d.f26846p = round;
                d.f26841k = Math.max(0, round2 - round);
                if (d.f26836c != null && d.f26835b != null) {
                    d.f();
                }
            } else {
                int i14 = d.f26844n;
                d.f26846p = i14;
                d.f26841k = Math.max(0, (d.f26845o + i14) - i14);
                if (d.f26836c != null && d.f26835b != null) {
                    d.f();
                }
            }
        ...
        if (iArr.length < 2) {
            ...
            for (int i18 = 0; i18 < getChildCount(); i18++) {
                ...
                if (i11 > 0) {
                    oz0 oz0Var = d10.f26834a.f27451a.f28071b;
                    int max = Math.max(0, oz0Var.f27205a);
                    int min = Math.min(i15, oz0Var.f27206b);
                    if (max < min) {
                        int i19 = 0;
                        for (int i20 = max; i20 < min; i20++) {
                            i19 += iArr2[i20];
                        }
                        int max2 = Math.max(1, Math.round(d10.f26841k / i11)) - i19;
            ...
            for (int i25 = 0; i25 < getChildCount(); i25++) {
                nz0 d11 = d(i25);
                oz0 oz0Var2 = d11.f26834a.f27451a.f28071b;
                int max3 = Math.max(0, Math.min(i15, oz0Var2.f27205a));
                int max4 = Math.max(max3, Math.min(i15, oz0Var2.f27206b));
                int i26 = iArr4[max3];
                int i27 = iArr4[max4];
                d11.f26847q = i26;
                d11.f26842l = Math.max(0, i27 - i26);
                if (d11.f26836c != null) {
                    d11.g();
                }
                this.O.onLayoutChild(d11.f26835b, d11.b(), d11.c());
            }
        }
        invalidate();
    }
