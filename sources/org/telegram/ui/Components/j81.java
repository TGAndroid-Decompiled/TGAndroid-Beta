    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f25311a) {
            case 0:
                ...
                return;
            case 1:
                w81 w81Var2 = this.f25312b;
                w81Var2.getClass();
                w81Var2.R = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                return;
            case 2:
                w81 w81Var3 = this.f25312b;
                w81Var3.N.onAnimationUpdate(valueAnimator);
                w81Var3.M.f29074a = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                w81Var3.M.v.f1();
                w81Var3.M.invalidate();
                return;
            default:
                w81 w81Var4 = this.f25312b;
                w81Var4.getClass();
