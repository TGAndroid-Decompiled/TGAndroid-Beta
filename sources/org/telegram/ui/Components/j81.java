...
public final class j81 extends View {
    ...
    public float I;
    public final org.telegram.ui.ActionBar.f6 f27408a;
    public final Paint f27409b;
    public final Paint f27410c;
    public final TextPaint d;
    public final Paint f27411e;
    public String f27412f;
    public int h;
    public int f27413n;
    public final RectF f27414r;
    public boolean f27415s;
    public final Canvas v;
    public final Bitmap f27416w;
    public float f27417x;
    public ObjectAnimator f27418y;
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        if (z11) {
            ...
            this.f27418y = ofFloat;
            ofFloat.setDuration(300L);
            this.f27418y.start();
            return;
        }
        ObjectAnimator objectAnimator = this.f27418y;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        RectF rectF = this.f27414r;
        rectF.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
        View view = this.E;
        org.telegram.ui.ActionBar.f6 f6Var = this.f27408a;
        ...
        canvas2.drawText(this.f27412f, AndroidUtilities.dp(28.0f) + y3, AndroidUtilities.dp(21.0f), textPaint);
        canvas2.save();
        canvas2.translate(y3, AndroidUtilities.dp(7.0f));
        Bitmap bitmap = this.f27416w;
        int i11 = 0;
        Paint paint3 = this.f27411e;
        if (bitmap != null) {
            float f12 = this.f27417x;
            if (f12 <= 0.5f) {
                f7 = f12 / 0.5f;
                f10 = f7;
            } else {
            ...
            if (f10 != 1.0f) {
                ...
                canvas3.drawRoundRect(rectF, rectF.width() / 2.0f, rectF.height() / 2.0f, this.f27409b);
            }
            if (this.f27417x > 0.5f) {
                Paint paint4 = this.f27410c;
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(org.telegram.messenger.vl.C(56.0f, this.f27413n, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(32.0f), 1073741824));
    }
