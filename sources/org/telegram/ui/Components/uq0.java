...
public abstract class uq0 extends FrameLayout {
    public org.telegram.ui.ActionBar.j5 f28801a;
    public org.telegram.ui.ActionBar.j5 f28802b;
    public ci.eb f28803c;
    public int d;
    public AnimatorSet e;
    public Paint f28804f;
    public RectF h;
    ...
    public final void a(int i10) {
        ...
        this.e.setInterpolator(qr.f27716g);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ((FrameLayout.LayoutParams) this.f28802b.getLayoutParams()).width = size;
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.f28801a.getLayoutParams();
