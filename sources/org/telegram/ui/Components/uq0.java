    ...
    public final void onClick(View view) {
        switch (this.f30959a) {
            case 0:
                ...
                if (this.f30960b) {
                    xu0Var.O0(n2Var, xu0Var.f32702j1, this.f30961c);
                    return;
                }
            ...
            default:
                ...
                if (nr0Var.f50519e.h() && nr0Var.h.getCurrentPosition() != 0) {
                    nr0Var.a();
                    return;
                }
                ...
                if (z10) {
                    yh.p1 p1Var = new yh.p1(nr0Var.getContext(), i10, nr0Var.f50518c, null, null);
                    p1Var.V(BirthdayController.getInstance(i10).isToday(nr0Var.f50518c));
                    p1Var.show();
                    return;
                }
