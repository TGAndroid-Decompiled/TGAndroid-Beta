...
public final class kz0 {
    ...
    public int[] f25927t;
    public final uz0 f25930x;
    public int f25912b = Integer.MIN_VALUE;
    public int f25913c = Integer.MIN_VALUE;
    public boolean e = false;
    public boolean f25915g = false;
    public boolean f25916i = false;
    public boolean f25918k = false;
    public boolean f25920m = false;
    public boolean f25922o = false;
    public boolean f25924q = false;
    public boolean f25926s = false;
    public boolean f25928u = true;
    public final qz0 v = new qz0(0);
    public final qz0 f25929w = new qz0(-100000);
    ...
    public static void j(ArrayList arrayList, oz0 oz0Var, qz0 qz0Var, boolean z10) {
        if (oz0Var.f27221b - oz0Var.f27220a != 0) {
            if (z10) {
                ...
                while (i10 < size) {
                    ...
                    i10++;
                    if (((iz0) obj).f25201a.equals(oz0Var)) {
                        return;
                    }
                }
            }
    ...
    public static boolean m(int[] iArr, iz0 iz0Var) {
        if (iz0Var.f25203c) {
            oz0 oz0Var = iz0Var.f25201a;
            int i10 = oz0Var.f27220a;
            int i11 = oz0Var.f27221b;
            int i12 = iArr[i10] + iz0Var.f25202b.f27800a;
            if (i12 > iArr[i11]) {
                iArr[i11] = i12;
                return true;
            }
    ...
    public final void a(la.h hVar, boolean z10) {
        for (qz0 qz0Var : (qz0[]) ((Object[]) hVar.d)) {
            qz0Var.f27800a = Integer.MIN_VALUE;
        }
        ...
        for (int i10 = 0; i10 < lz0VarArr.length; i10++) {
            ...
            int i11 = qz0Var2.f27800a;
            if (!z10) {
                d = -d;
            }
            qz0Var2.f27800a = Math.max(i11, d);
        }
    }
    ...
    public final la.h c(boolean z10) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            if (z10) {
                oz0Var = rz0VarArr[i10].f28079b;
            } else {
                oz0 oz0Var2 = rz0VarArr[i10].f28079b;
                oz0Var = new oz0(oz0Var2.f27221b, oz0Var2.f27220a);
            }
            ?? obj = new Object();
            obj.f27800a = Integer.MIN_VALUE;
    ...
    public final iz0[] d() {
        if (this.f25921n == null) {
            ...
            j(arrayList2, new oz0(e, 0), this.f25929w, false);
            iz0[] q6 = q(arrayList);
    ...
    public final int e() {
        return Math.max(this.f25912b, h());
    }
    ...
    public final la.h f() {
        ...
        if (hVar == null) {
            ...
            for (int i13 = 0; i13 < childCount; i13++) {
                pz0 pz0Var = uz0Var.d(i13).f26839a;
                if (z10) {
                    rz0Var2 = pz0Var.f27459b;
                } else {
                    rz0Var2 = pz0Var.f27458a;
                }
                switch (rz0.a(rz0Var2, z10).f24578a) {
                    case 3:
                        lz0Var = new lz0();
                        break;
                    default:
        ...
        if (!this.e) {
            ...
            for (int i14 = 0; i14 < childCount2; i14++) {
                nz0 d = uz0Var.d(i14);
                pz0 pz0Var2 = d.f26839a;
                if (z10) {
                    rz0Var = pz0Var2.f27459b;
                } else {
                    rz0Var = pz0Var2.f27458a;
                }
                if (z10) {
                    i10 = d.f26846k;
                } else {
                ...
                if (f7 == 0.0f) {
                    ...
                    i11 = this.f25927t[i14];
                }
                int i15 = e + i11;
                la.h hVar2 = this.d;
                lz0 lz0Var3 = (lz0) ((Object[]) hVar2.d)[((int[]) hVar2.f14166b)[i14]];
                int i16 = lz0Var3.f26315c;
                if (rz0Var.f28080c == uz0.R && f7 == 0.0f) {
                    i12 = 0;
                } else {
                    i12 = 2;
                }
                lz0Var3.f26315c = i12 & i16;
    ...
    public final int[] g() {
        ...
        if (this.f25923p == null) {
            this.f25923p = new int[e() + 1];
        }
        if (!this.f25924q) {
            int[] iArr = this.f25923p;
            boolean z11 = this.f25926s;
            float f7 = 0.0f;
            boolean z12 = this.f25911a;
            uz0 uz0Var = this.f25930x;
            if (!z11) {
                int childCount = uz0Var.getChildCount();
                int i10 = 0;
                while (true) {
                    if (i10 < childCount) {
                        pz0 pz0Var = uz0Var.d(i10).f26839a;
                        if (z12) {
                            rz0Var2 = pz0Var.f27459b;
                        } else {
                            rz0Var2 = pz0Var.f27458a;
            ...
            if (!this.f25925r) {
                ...
                if (this.f25927t == null) {
                    this.f25927t = new int[uz0Var.getChildCount()];
                }
                Arrays.fill(this.f25927t, 0);
                p(d(), iArr, true);
                int childCount2 = (uz0Var.getChildCount() * this.v.f27800a) + 1;
                if (childCount2 >= 2) {
                    int childCount3 = uz0Var.getChildCount();
                    for (int i11 = 0; i11 < childCount3; i11++) {
                        pz0 pz0Var2 = uz0Var.d(i11).f26839a;
                        if (z12) {
                            rz0Var = pz0Var2.f27459b;
                        } else {
                            rz0Var = pz0Var2.f27458a;
    ...
    public final int h() {
        ...
        if (this.f25913c == Integer.MIN_VALUE) {
            uz0 uz0Var = this.f25930x;
            int childCount = uz0Var.getChildCount();
            int i11 = -1;
            for (int i12 = 0; i12 < childCount; i12++) {
                pz0 pz0Var = uz0Var.d(i12).f26839a;
                if (this.f25911a) {
                    rz0Var = pz0Var.f27459b;
                } else {
                    rz0Var = pz0Var.f27458a;
                ...
                oz0 oz0Var = rz0Var.f28079b;
                int i13 = oz0Var.f27220a;
                int i14 = oz0Var.f27221b;
                i11 = Math.max(Math.max(Math.max(i11, i13), i14), i14 - oz0Var.f27220a);
            }
            if (i11 != -1) {
                i10 = i11;
            }
            this.f25913c = Math.max(0, i10);
        }
        return this.f25913c;
    }
    ...
    public final int i(int i10) {
        ...
        if (mode != Integer.MIN_VALUE) {
            if (mode != 0) {
                ...
                qz0Var2.f27800a = size;
                qz0Var.f27800a = -size;
                this.f25924q = false;
                return g()[e()];
            }
            qz0Var2.f27800a = 0;
            qz0Var.f27800a = -100000;
            this.f25924q = false;
            return g()[e()];
        }
        qz0Var2.f27800a = 0;
    ...
    public final void k() {
        this.f25913c = Integer.MIN_VALUE;
        this.d = null;
        this.f25914f = null;
        this.h = null;
        this.f25917j = null;
    ...
    public final void o(float f7, int i10) {
        ...
        int childCount = uz0Var.getChildCount();
        for (int i11 = 0; i11 < childCount; i11++) {
            pz0 pz0Var = uz0Var.d(i11).f26839a;
            if (this.f25911a) {
                rz0Var = pz0Var.f27459b;
            } else {
                rz0Var = pz0Var.f27458a;
        ...
        loop0: for (int i10 = 0; i10 < iz0VarArr.length; i10++) {
            ...
            while (true) {
                ...
                if (zArr[i14]) {
                    ...
                    oz0 oz0Var = iz0Var2.f25201a;
                    if (oz0Var.f27220a >= oz0Var.f27221b) {
                        iz0Var2.f25203c = false;
                        break;
                    }
                }
                i14++;
