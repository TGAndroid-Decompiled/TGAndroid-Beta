...
public final class kg extends org.telegram.ui.tu0 {
    ...
    public final void o(int i10, VideoEditedInfo videoEditedInfo, boolean z10, int i11, int i12, boolean z11) {
        ...
        if (rnVar != null && (boVar = chatActivityEnterView.O2) != null && rnVar.f37174f) {
            boVar.Rb();
            return;
        }
        ArrayList arrayList = new ArrayList();
        SendMessagesHelper.SendingMediaInfo sendingMediaInfo = new SendMessagesHelper.SendingMediaInfo();
        MediaController.PhotoEntry photoEntry = this.f25600b;
        ...
        if (boVar3 != null) {
            messageSuggestionParams = boVar3.f32313g5;
        }
