...
public final class tb0 extends Drawable {
    ...
    public void b(int i10, int i11) {
        ((Paint) this.f31329c).setShader(new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.dp(28.0f), new int[]{i10, i11}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP));
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        switch (this.f31327a) {
            case 0:
                ...
                if (((hj0) this.f31330e).y()) {
                    hj0 hj0Var4 = (hj0) this.f31330e;
                    boolean z4 = this.f31328b;
                    if (z4) {
                        hj0Var = hj0Var3;
                    } else {
                        hj0Var = hj0Var2;
                    ...
                    if (hj0Var4 != hj0Var) {
                        ...
                        this.f31330e = hj0Var2;
                        hj0Var2.K(hj0Var2.f27524e[0] - 1);
                    }
                }
                ((hj0) this.f31330e).setBounds(rect);
                ((hj0) this.f31330e).draw(canvas);
                return;
            default:
                ...
                rectF.set(getBounds());
                Matrix matrix = (Matrix) this.f31330e;
                matrix.reset();
                matrix.postTranslate(rectF.left, rectF.top);
                canvas.drawRoundRect(rectF, dp, dp, (Paint) this.f31329c);
                if (this.f31328b) {
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        switch (this.f31327a) {
            case 0:
                ((hj0) this.f31329c).setColorFilter(colorFilter);
