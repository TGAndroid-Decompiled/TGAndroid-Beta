...
public final class o70 {
    ...
    public boolean Y;
    public boolean Z;
    public final ViewGroup f26638a;
    public float f26639a0;
    public ViewGroup f26640b;
    public float f26641b0;
    public final org.telegram.ui.ActionBar.n2 f26642c;
    public boolean f26643c0;
    public final org.telegram.ui.ActionBar.d6 d;
    public boolean f26644d0;
    public final Context e;
    public View f26645e0;
    public final View f26646f;
    public e70 f26647f0;
    public Drawable f26648g;
    public f70 f26649g0;
    public int h;
    public final int[] f26650h0;
    public int f26651i;
    public Integer f26652i0;
    public boolean f26653j;
    public Integer f26654j0;
    public int f26655k;
    public Integer f26656k0;
    public int f26657l;
    public Integer f26658l0;
    public j70 f26659m;
    public ValueAnimator m0;
    public fh.b f26660n;
    public boolean f26661n0;
    public final float[] f26662o;
    public wr f26663o0;
    public Runnable f26664p;
    public View f26665p0;
    public float f26666q;
    public final int[] f26667q0;
    public float f26668r;
    public int f26669s;
    ...
    public o70(org.telegram.ui.ActionBar.n2 n2Var, View view, boolean z10, boolean z11) {
        ...
        this.f26646f = view;
        this.f26669s = ((double) AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18789d6, resourceProvider))) > 0.705d ? 102 : 51;
        this.E = z10;
        this.G = z11;
        this.F = false;
        B();
    ...
    public static void a(o70 o70Var, ViewGroup viewGroup) {
        ...
        ValueAnimator ofFloat = ValueAnimator.ofFloat(m70Var.f26109w, 0.0f);
        o70Var.m0 = ofFloat;
    ...
    public static void f(o70 o70Var, ai.x8 x8Var, final HashSet hashSet, boolean z10, Runnable runnable, final Utilities.Callback callback) {
        ...
        o70Var.r(scrollView, w7.x5.n(-1, -2));
        float f7 = 0.12f;
        ...
        while (i11 < size) {
            ...
            if (photo != null && (arrayList = photo.sizes) != null) {
                f1Var2.h(e9Var.f855b, ImageLocation.getForObject(FileLoader.getClosestPhotoSizeWithSize(e9Var.f856c.sizes, AndroidUtilities.dp(24.0f), false, FileLoader.getClosestPhotoSizeWithSize(arrayList, 50), true), e9Var.f856c), "50_50", null, null);
                obj = null;
            } else {
                obj = null;
                f1Var2.g(e9Var.f855b, R.drawable.msg_folders, null);
            }
    ...
    public final void C() {
        ...
        this.f26645e0 = view;
        view.getLocationOnScreen(this.f26650h0);
        this.f26647f0 = new ViewTreeObserver.OnScrollChangedListener() {
            @Override
            public final void onScrollChanged() {
                j70 j70Var;
                o70 o70Var = o70.this;
                if (o70Var.f26645e0 != null && (j70Var = o70Var.f26659m) != null && j70Var.isShowing()) {
                    int[] iArr = new int[2];
                    o70Var.f26645e0.getLocationOnScreen(iArr);
                    int i10 = iArr[0];
                    int[] iArr2 = o70Var.f26650h0;
        ...
        this.f26645e0.getViewTreeObserver().addOnScrollChangedListener(this.f26647f0);
        f70 f70Var = new f70(this, 0);
        this.f26649g0 = f70Var;
        this.f26645e0.addOnLayoutChangeListener(f70Var);
    }

    public final boolean D() {
        j70 j70Var = this.f26659m;
        if (j70Var != null && j70Var.isShowing()) {
            return true;
        }
        return false;
    }
    ...
    public final void N() {
        View view = this.f26645e0;
        if (view != null) {
            if (this.f26647f0 != null) {
                ViewTreeObserver viewTreeObserver = view.getViewTreeObserver();
                if (viewTreeObserver.isAlive()) {
                    viewTreeObserver.removeOnScrollChangedListener(this.f26647f0);
                }
            }
            f70 f70Var = this.f26649g0;
            if (f70Var != null) {
                this.f26645e0.removeOnLayoutChangeListener(f70Var);
            }
        }
        this.f26647f0 = null;
        this.f26649g0 = null;
    ...
    public final void O() {
        ...
        int y3;
        j70 j70Var = this.f26659m;
        if (j70Var != null && j70Var.isShowing() && (view = this.f26646f) != null && (viewGroup = this.f26640b) != null && this.A != null && this.D != null) {
            float[] fArr = this.f26662o;
            ...
            float f14 = x10 + this.f26666q;
            this.f26639a0 = f14;
            float f15 = y3 + this.f26668r;
            this.f26641b0 = f15;
            this.f26659m.update((int) f14, (int) f15, -1, -1);
        }
    }
    ...
    public final void R(ja jaVar, float f7, float f10) {
        ...
        if (viewGroup instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
            viewGroup.setBackground(new ma(new na(jaVar, viewGroup, 5, false), this.A.getX() + this.f26639a0 + f7, this.A.getY() + this.f26641b0 + f10, mutate, AndroidUtilities.dp(12.0f)));
            return;
        }
        for (int i10 = 0; i10 < this.A.getChildCount(); i10++) {
            View childAt = this.A.getChildAt(i10);
            if (childAt instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                childAt.setBackground(new ma(new na(jaVar, childAt, 5, false), this.A.getX() + this.f26639a0 + f7 + childAt.getX(), this.A.getY() + this.f26641b0 + f10 + childAt.getY(), mutate, AndroidUtilities.dp(12.0f)));
            }
        }
    }
    ...
    public final void S(int i10, int i11) {
        View childAt;
        this.f26654j0 = Integer.valueOf(i10);
        this.f26656k0 = Integer.valueOf(i11);
    ...
    public final void T(int i10) {
        View childAt;
        this.f26652i0 = Integer.valueOf(i10);
        if (this.A != null) {
            for (int i11 = 0; i11 < this.A.getChildCount(); i11++) {
                if (i11 == this.A.getChildCount() - 1) {
                    childAt = this.D;
    ...
    public final void V(int i10) {
        ...
        if (i10 == 5 && this.E) {
            ViewGroup viewGroup = this.A;
            if (viewGroup instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                ((ActionBarPopupWindow$ActionBarPopupWindowLayout) viewGroup).f18401c = true;
            }
        }
    }
    ...
    public final void X(float f7) {
        j70 j70Var = this.f26659m;
        if (j70Var != null) {
            j70Var.update((int) this.f26639a0, (int) (this.f26641b0 + f7), -1, -1);
        }
    }
    ...
    public final void Z() {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.o70.Z():void");
    }
    ...
    public final void b0(int i10, int i11) {
        ...
        View view2 = this.f26665p0;
        if (view2 != null) {
            int[] iArr = this.f26667q0;
            view2.getLocationOnScreen(iArr);
            this.f26665p0.drawableHotspotChanged(i10 - iArr[0], i11 - iArr[1]);
        }
    }
    ...
    public final void d(org.telegram.ui.ActionBar.f1 f1Var) {
        ...
        f1Var.c(v02, v03);
        f1Var.setSelectorColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18744ai, d6Var));
        Integer num3 = this.f26658l0;
        if (num3 != null) {
            l1 = num3.intValue();
        } else {
    ...
    public final void e(int i10, boolean z10, Runnable runnable) {
        ...
        f1Var.f18610a.setPadding(dp, 0, i11, 0);
        ...
        f1Var.addView(w9Var, w7.x5.d(34, 34.0f, i12 | 16, -5.0f, 0.0f, -5.0f, 0.0f));
        org.telegram.ui.ActionBar.d6 d6Var = this.d;
        if (z10) {
    ...
    public final void g(TLObject tLObject, boolean z10, Runnable runnable) {
        ...
        if (tLObject instanceof TLRPC.Chat) {
            ...
            if (user.f18230id == UserConfig.getInstance(UserConfig.selectedAccount).getClientUserId()) {
        ...
        f1Var.f18610a.setPadding(dp, 0, i10, 0);
        w9 w9Var = new w9(context);
        h9 h9Var = new h9((org.telegram.ui.ActionBar.d6) null);
        h9Var.p(tLObject);
        w9Var.setRoundRadius(AndroidUtilities.dp(34.0f));
        ...
        f1Var.addView(w9Var, w7.x5.d(34, 34.0f, i11 | 16, -5.0f, 0.0f, -5.0f, 0.0f));
        org.telegram.ui.ActionBar.d6 d6Var = this.d;
        if (z10) {
            View view = new View(context);
            int dp2 = AndroidUtilities.dp(34.0f);
    ...
    public final void n(TLObject tLObject, String str, Runnable runnable) {
        ...
        org.telegram.messenger.ul.o(org.telegram.ui.ActionBar.h6.f19025q5, d6Var, f7, 1, 13.0f);
    ...
    public final void p(int i10, int i11, CharSequence charSequence) {
        ...
        p4Var.setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18895j5, this.d));
    ...
    public final void u() {
        ...
        Runnable runnable = this.f26664p;
        if (runnable != null) {
            runnable.run();
        }
    }
    ...
    public o70(ViewGroup viewGroup, org.telegram.ui.ActionBar.d6 d6Var, View view, boolean z10, boolean z11, boolean z12) {
        ...
        this.f26638a = viewGroup;
        this.d = d6Var;
        this.e = viewGroup.getContext();
        this.f26646f = view;
        this.f26669s = ((double) AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18789d6, d6Var))) > 0.705d ? 102 : 51;
        this.E = z10;
        this.F = z11;
        this.G = z12;
        B();
