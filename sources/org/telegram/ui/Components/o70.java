...
public final class o70 {
    ...
    public boolean Y;
    public boolean Z;
    public final ViewGroup f27458a;
    public float f27459a0;
    public ViewGroup f27460b;
    public float f27461b0;
    public final org.telegram.ui.ActionBar.p2 f27462c;
    public boolean f27463c0;
    public final org.telegram.ui.ActionBar.f6 d;
    public boolean f27464d0;
    public final Context e;
    public View f27465e0;
    public final View f27466f;
    public e70 f27467f0;
    public Drawable f27468g;
    public f70 f27469g0;
    public int h;
    public final int[] f27470h0;
    public int f27471i;
    public Integer f27472i0;
    public boolean f27473j;
    public Integer f27474j0;
    public int f27475k;
    public Integer f27476k0;
    public int f27477l;
    public Integer f27478l0;
    public j70 f27479m;
    public ValueAnimator m0;
    public sg.b f27480n;
    public boolean f27481n0;
    public final float[] f27482o;
    public tr f27483o0;
    public Runnable f27484p;
    public View f27485p0;
    public float f27486q;
    public final int[] f27487q0;
    public float f27488r;
    public int f27489s;
    ...
    public o70(org.telegram.ui.ActionBar.p2 p2Var, View view, boolean z4, boolean z10) {
        ...
        this.f27466f = view;
        this.f27489s = ((double) AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19906d6, resourceProvider))) > 0.705d ? 102 : 51;
        this.E = z4;
        this.G = z10;
        this.F = false;
        B();
    ...
    public static void a(o70 o70Var, ViewGroup viewGroup) {
        ...
        ValueAnimator ofFloat = ValueAnimator.ofFloat(m70Var.f26968w, 0.0f);
        o70Var.m0 = ofFloat;
    ...
    public static void f(o70 o70Var, nh.h6 h6Var, final HashSet hashSet, boolean z4, Runnable runnable, final Utilities.Callback callback) {
        ...
        o70Var.r(scrollView, k7.b6.n(-1, -2));
        float f10 = 0.12f;
        if (z4 && runnable != null) {
        ...
        while (i11 < size) {
            ...
            TLRPC.Photo photo = m6Var.f15620c;
            if (photo != null && (arrayList = photo.sizes) != null) {
                g1Var2.h(m6Var.f15619b, ImageLocation.getForObject(FileLoader.getClosestPhotoSizeWithSize(m6Var.f15620c.sizes, AndroidUtilities.dp(24.0f), false, FileLoader.getClosestPhotoSizeWithSize(arrayList, 50), true), m6Var.f15620c), "50_50", null, null);
                obj = null;
            } else {
                obj = null;
                g1Var2.g(m6Var.f15619b, R.drawable.msg_folders, null);
            }
    ...
    public final void B() {
        ...
        jo joVar = new jo(this, this.e, i11, this.d, i13 | i12);
        this.D = joVar;
    ...
    public final void C() {
        N();
        View view = this.f27466f;
        if (view == null) {
            return;
        }
        this.f27465e0 = view;
        view.getLocationOnScreen(this.f27470h0);
        this.f27467f0 = new ViewTreeObserver.OnScrollChangedListener() {
            @Override
            public final void onScrollChanged() {
                j70 j70Var;
                o70 o70Var = o70.this;
                if (o70Var.f27465e0 != null && (j70Var = o70Var.f27479m) != null && j70Var.isShowing()) {
                    int[] iArr = new int[2];
                    o70Var.f27465e0.getLocationOnScreen(iArr);
                    int i10 = iArr[0];
                    int[] iArr2 = o70Var.f27470h0;
        ...
        this.f27465e0.getViewTreeObserver().addOnScrollChangedListener(this.f27467f0);
        f70 f70Var = new f70(this, 0);
        this.f27469g0 = f70Var;
        this.f27465e0.addOnLayoutChangeListener(f70Var);
    }

    public final boolean D() {
        j70 j70Var = this.f27479m;
    ...
    public final void N() {
        View view = this.f27465e0;
        if (view != null) {
            if (this.f27467f0 != null) {
                ViewTreeObserver viewTreeObserver = view.getViewTreeObserver();
                if (viewTreeObserver.isAlive()) {
                    viewTreeObserver.removeOnScrollChangedListener(this.f27467f0);
                }
            }
            f70 f70Var = this.f27469g0;
            if (f70Var != null) {
                this.f27465e0.removeOnLayoutChangeListener(f70Var);
            }
        }
        this.f27467f0 = null;
        this.f27469g0 = null;
    ...
    public final void O() {
        ...
        int y10;
        j70 j70Var = this.f27479m;
        if (j70Var != null && j70Var.isShowing() && (view = this.f27466f) != null && (viewGroup = this.f27460b) != null && this.A != null && this.D != null) {
            float[] fArr = this.f27482o;
            ...
            float f15 = x10 + this.f27486q;
            this.f27459a0 = f15;
            float f16 = y10 + this.f27488r;
            this.f27461b0 = f16;
            this.f27479m.update((int) f15, (int) f16, -1, -1);
        }
    }
    ...
    public final void R(ba baVar, float f10, float f11) {
        ...
        if (viewGroup instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
            viewGroup.setBackground(new ea(new fa(baVar, viewGroup, 5, false), this.A.getX() + this.f27459a0 + f10, this.A.getY() + this.f27461b0 + f11, mutate, AndroidUtilities.dp(12.0f)));
            return;
        }
        for (int i10 = 0; i10 < this.A.getChildCount(); i10++) {
            View childAt = this.A.getChildAt(i10);
            if (childAt instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                childAt.setBackground(new ea(new fa(baVar, childAt, 5, false), this.A.getX() + this.f27459a0 + f10 + childAt.getX(), this.A.getY() + this.f27461b0 + f11 + childAt.getY(), mutate, AndroidUtilities.dp(12.0f)));
            }
        }
    }
    ...
    public final void S(int i10, int i11) {
        View childAt;
        this.f27474j0 = Integer.valueOf(i10);
        this.f27476k0 = Integer.valueOf(i11);
    ...
    public final void T(int i10) {
        View childAt;
        this.f27472i0 = Integer.valueOf(i10);
        if (this.A != null) {
            for (int i11 = 0; i11 < this.A.getChildCount(); i11++) {
                if (i11 == this.A.getChildCount() - 1) {
                    childAt = this.D;
    ...
    public final void V(int i10) {
        ...
        if (i10 == 5 && this.E) {
            ViewGroup viewGroup = this.A;
            if (viewGroup instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                ((ActionBarPopupWindow$ActionBarPopupWindowLayout) viewGroup).f19495c = true;
            }
        }
    }

    public final void W(Drawable drawable) {
        this.f27468g = drawable;
        this.h = 0;
    ...
    public final void X(float f10) {
        j70 j70Var = this.f27479m;
        if (j70Var != null) {
            j70Var.update((int) this.f27459a0, (int) (this.f27461b0 + f10), -1, -1);
        }
    }
    ...
    public final void b0(int i10, int i11) {
        ...
        View view2 = this.f27485p0;
        if (view2 != null) {
            int[] iArr = this.f27487q0;
            view2.getLocationOnScreen(iArr);
            this.f27485p0.drawableHotspotChanged(i10 - iArr[0], i11 - iArr[1]);
        }
    }
    ...
    public final void e(int i10, boolean z4, Runnable runnable) {
        ...
        g1Var.f19702a.setPadding(dp, 0, i11, 0);
    ...
    public final void g(TLObject tLObject, boolean z4, Runnable runnable) {
        ...
        g1Var.f19702a.setPadding(dp, 0, i10, 0);
        p9 p9Var = new p9(context);
        z8 z8Var = new z8((org.telegram.ui.ActionBar.f6) null);
        z8Var.p(tLObject);
        p9Var.setRoundRadius(AndroidUtilities.dp(34.0f));
    ...
    public final void n(TLObject tLObject, String str, Runnable runnable) {
        ...
        org.telegram.ui.b.l(org.telegram.ui.ActionBar.j6.f20139q5, f6Var, i11, 1, 13.0f);
    ...
    public final void p(int i10, int i11, CharSequence charSequence) {
        ...
        qVar.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20012j5, this.d));
    ...
    public final void u() {
        ...
        Runnable runnable = this.f27484p;
        if (runnable != null) {
            runnable.run();
        }
    }
    ...
    public o70(ViewGroup viewGroup, org.telegram.ui.ActionBar.f6 f6Var, View view, boolean z4, boolean z10, boolean z11) {
        ...
        this.f27458a = viewGroup;
        this.d = f6Var;
        this.e = viewGroup.getContext();
        this.f27466f = view;
        this.f27489s = ((double) AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19906d6, f6Var))) > 0.705d ? 102 : 51;
        this.E = z4;
        this.F = z10;
        this.G = z11;
        B();
