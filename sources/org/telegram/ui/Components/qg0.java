...
public final class qg0 extends ww0 {
    public boolean f27572a = false;
    public final Paint f27573b = new Paint(1);
    public final int f27574c = UserConfig.selectedAccount;
    public long d = 0;
    public boolean e = false;
    public final RectF f27575f = new RectF();
    public float f27576g;
    public final boolean h;
    public final org.telegram.ui.ActionBar.f6 f27577i;
    ...
    public final void draw(Canvas canvas) {
        ...
        boolean z10 = this.h;
        if (z10) {
            i10 = org.telegram.ui.ActionBar.j6.f19317p9;
        } else {
            i10 = org.telegram.ui.ActionBar.j6.f19318pa;
        }
        int v02 = org.telegram.ui.ActionBar.j6.v0(i10, this.f27577i);
        Paint paint = this.f27573b;
        paint.setColor(v02);
        RectF rectF = this.f27575f;
        rectF.set(0.0f, i12, dp, i12 + dp);
        float f10 = this.f27576g;
        if (f10 < 0.5f) {
            f7 = org.telegram.messenger.rk.w(f10, 0.5f, 1.0f, 35.0f);
        } else {
        ...
        if (z10) {
            ...
            i11 = org.telegram.ui.ActionBar.j6.f19372s8;
        }
    ...
    public final void f() {
        if (this.e) {
            if (!NotificationCenter.getInstance(this.f27574c).isAnimationInProgress()) {
                ...
                float f7 = (((float) j3) / 300.0f) + this.f27576g;
                this.f27576g = f7;
                if (f7 > 1.0f) {
                    this.f27576g = 1.0f;
                }
