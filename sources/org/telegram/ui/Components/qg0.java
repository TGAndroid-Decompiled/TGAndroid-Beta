...
public final class qg0 extends org.telegram.ui.ActionBar.g3 {
    ...
    public final kg0 f27298b;
    public final mg0 f27299c;
    public final Drawable d;
    public final View e;
    public final w7 f27300f;
    public AnimatorSet h;
    public final MessageObject f27301n;
    public final TLRPC.Poll f27302r;
    public final TLRPC.InputPeer f27303s;
    public final HashSet v;
    public final HashMap f27304w;
    public final ArrayList f27305x;
    public final w5 f27306y;
    ...
    public qg0(Context context, int i10, MessageObject messageObject, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        int i11;
        this.v = new HashSet();
        this.f27304w = new HashMap();
        this.f27305x = new ArrayList();
        ...
        fixNavigationBar();
        this.f27301n = messageObject;
        TLRPC.TL_messageMediaPoll tL_messageMediaPoll = (TLRPC.TL_messageMediaPoll) messageObject.messageOwner.media;
        this.N = tL_messageMediaPoll;
        this.f27302r = tL_messageMediaPoll.poll;
        this.f27303s = MessagesController.getInstance(this.currentAccount).getInputPeer(messageObject.getDialogId());
        ...
        while (true) {
            ...
            if (pollAnswerVoters.voters != 0) {
                ...
                this.f27305x.add(new pg0(tL_messages_votesList, pollAnswerVoters.option));
                TLRPC.TL_messages_getPollVotes tL_messages_getPollVotes = new TLRPC.TL_messages_getPollVotes();
                tL_messages_getPollVotes.peer = this.f27303s;
                tL_messages_getPollVotes.f18218id = this.f27301n.getId();
        ...
        R();
        Collections.sort(this.f27305x, new ig0(this));
        S();
        Drawable mutate = context.getResources().getDrawable(R.drawable.sheet_shadow_round).mutate();
        this.d = mutate;
        mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18951i5, false), PorterDuff.Mode.MULTIPLY));
        ...
        TLRPC.TL_textWithEntities tL_textWithEntities2 = this.f27302r.question;
        if (tL_textWithEntities2 != null) {
            MessageObject messageObject2 = this.f27301n;
        ...
        this.f27300f = w7Var;
        w7Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18933h5, false));
    ...
    public static void m(qg0 qg0Var, Integer[] numArr, int i10, TLObject tLObject, ArrayList arrayList, TLRPC.PollAnswerVoters pollAnswerVoters) {
        ...
        ArrayList arrayList2 = qg0Var.f27305x;
                    ...
                    while (true) {
                        if (i12 < size2) {
                            ...
                            if (Arrays.equals(pg0Var.d, pg0Var2.d)) {
                                pg0Var2.f27024c = pg0Var.f27024c;
                                z10 = (pg0Var2.f27022a == pg0Var.f27022a && pg0Var2.f27023b.size() == pg0Var.f27023b.size()) ? true : true;
                                pg0Var2.f27022a = pg0Var.f27022a;
                                pg0Var2.f27023b = pg0Var.f27023b;
                            } else {
                                i12++;
                            }
                        }
    ...
    public static void n(qg0 qg0Var, pg0 pg0Var, TLObject tLObject) {
        if (qg0Var.isShowing()) {
            ...
            if (tLObject != null) {
                TLRPC.TL_messages_votesList tL_messages_votesList = (TLRPC.TL_messages_votesList) tLObject;
                MessagesController.getInstance(qg0Var.currentAccount).putUsers(tL_messages_votesList.users, false);
                pg0Var.f27023b.addAll(tL_messages_votesList.votes);
                pg0Var.f27024c = tL_messages_votesList.next_offset;
                qg0Var.O(null);
                qg0Var.f27299c.X(true);
            }
        }
    }
        ...
        if (AndroidUtilities.isContextSafe(context)) {
            ...
            if (arrayList == null || arrayList.isEmpty()) {
                ...
                if (view instanceof org.telegram.ui.Cells.r8) {
                    ...
                    if (Q > 0 && S >= 0) {
                        pg0 pg0Var = (pg0) qg0Var.f27305x.get(S);
                        if (Q == pg0Var.b() && !hashSet.contains(pg0Var)) {
                            if (pg0Var.e && pg0Var.f27025f < pg0Var.f27023b.size()) {
                                int min = Math.min(pg0Var.f27025f + 50, pg0Var.f27023b.size());
                                pg0Var.f27025f = min;
                                if (min == pg0Var.f27023b.size()) {
                                    pg0Var.e = false;
                                }
                                qg0Var.O(null);
                                mg0Var.X(true);
                            ...
                            hashSet.add(pg0Var);
                            TLRPC.TL_messages_getPollVotes tL_messages_getPollVotes = new TLRPC.TL_messages_getPollVotes();
                            tL_messages_getPollVotes.peer = qg0Var.f27303s;
                            tL_messages_getPollVotes.f18218id = qg0Var.f27301n.getId();
                            ...
                            tL_messages_getPollVotes.offset = pg0Var.f27024c;
                    ...
                    if (pollVotesAlert$UserCell.h != null || pollVotesAlert$UserCell.f22104n != null) {
                        Bundle bundle = new Bundle();
                        TLRPC.User user = pollVotesAlert$UserCell.h;
                        if (user != null) {
                            bundle.putLong("user_id", user.f18268id);
                        } else {
                            bundle.putLong("chat_id", pollVotesAlert$UserCell.f22104n.f18121id);
                        }
                        qg0Var.dismiss();
                        ...
                        if (U != null) {
                            ...
                            if (U instanceof org.telegram.ui.bo) {
                                if (pollVotesAlert$UserCell.h != null) {
                                    ...
                                    if (chat != null && chat.f18121id == pollVotesAlert$UserCell.f22104n.f18121id) {
                                        i11 = 1;
                                    }
                                    profileActivity.N4(i11);
                                }
    ...
    public final void O(View view) {
        ...
        while (true) {
            ...
            if ((childAt instanceof og0) && (childAt.getTag(R.id.object_tag) instanceof pg0)) {
                ...
                TLRPC.Poll poll = this.f27302r;
                int size = poll.answers.size();
                int i12 = 0;
                while (true) {
                    if (i12 < size) {
                        TLRPC.PollAnswer pollAnswer = poll.answers.get(i12);
                        if (Arrays.equals(pollAnswer.option, pg0Var.d) && ((ng0) this.f27304w.get(pg0Var)) != null) {
                            TLRPC.TL_textWithEntities tL_textWithEntities = pollAnswer.text;
                            MessageObject messageObject = this.f27301n;
                            ...
                            og0Var.a(str2, arrayList, P(pg0Var.d), pg0Var.f27022a, pg0Var.a(), true);
        ...
        if (view2 != null) {
            ...
            View view3 = kg0Var.f26194r1;
            view3.layout(0, 0, view3.getMeasuredWidth(), kg0Var.f26194r1.getMeasuredHeight());
            kg0Var.invalidate();
        }
        kg0Var.invalidate();
    }
    ...
    public final int P(byte[] bArr) {
        ...
        int i12 = 0;
        while (true) {
            ArrayList arrayList = this.f27305x;
    ...
    public final void R() {
        HashMap hashMap;
        HashMap hashMap2 = this.f27304w;
        hashMap2.clear();
        TLRPC.TL_messageMediaPoll tL_messageMediaPoll = (TLRPC.TL_messageMediaPoll) this.f27301n.messageOwner.media;
        ArrayList arrayList = new ArrayList();
        ArrayList arrayList2 = this.f27305x;
    ...
    public final void S() {
        ...
        int w03 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18951i5, false);
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f27300f, 1, null, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f27298b, 32768, null, null, null, null, org.telegram.ui.ActionBar.j6.A5));
        int i11 = org.telegram.ui.ActionBar.j6.f18969j5;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f27300f, 64, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f27300f, 128, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f27300f, 1024, null, null, null, null, org.telegram.ui.ActionBar.j6.Pi));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f27300f, 256, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f27306y, 4, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.e, 1, null, null, null, null, org.telegram.ui.ActionBar.j6.V5));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f27298b, 0, new Class[]{View.class}, null, null, null, -1, w6Var, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f27298b, 0, new Class[]{View.class}, null, null, null, -1, w6Var, org.telegram.ui.ActionBar.j6.f18951i5));
        int i12 = org.telegram.ui.ActionBar.j6.f7;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f27298b, 524288, new Class[]{og0.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f27298b, 524288, new Class[]{og0.class}, new String[]{"middleTextView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f27298b, 524288, new Class[]{og0.class}, new String[]{"righTextView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f27298b, 524304, new Class[]{og0.class}, null, null, null, org.telegram.ui.ActionBar.j6.e7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f27298b, 0, new Class[]{PollVotesAlert$UserCell.class}, new String[]{"nameTextView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f27298b, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f18984k0, null, null, org.telegram.ui.ActionBar.j6.f18863d7));
        int i13 = org.telegram.ui.ActionBar.j6.q6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f27298b, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"textView"}, null, null, -1, null, i13));
        int i14 = org.telegram.ui.ActionBar.j6.N6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f27298b, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"imageView"}, null, null, -1, null, i14));
        return arrayList;
    }
}
