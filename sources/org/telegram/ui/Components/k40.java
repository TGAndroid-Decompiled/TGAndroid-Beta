...
public class k40 extends FrameLayout {
    ...
    public final void a() {
        float f10;
        float f11;
        this.f26145a.setPadding(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(7.0f), AndroidUtilities.dp(36.0f), AndroidUtilities.dp(8.0f));
        this.E = true;
        ImageView imageView = new ImageView(getContext());
        this.f26146b = imageView;
        imageView.setImageResource(R.drawable.msg_mini_close_tooltip);
        this.f26146b.setScaleType(ImageView.ScaleType.CENTER);
        this.f26146b.setColorFilter(new PorterDuffColorFilter(i0.a.k(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20130pf, this.C), 125), PorterDuff.Mode.MULTIPLY));
        ImageView imageView2 = this.f26146b;
        boolean z4 = this.f26150r;
        if (z4) {
            f10 = 3.0f;
        } else {
            f10 = 0.0f;
    ...
    public final void b(boolean z4) {
        ...
        if (z4) {
            ...
            if (z10) {
                ...
                this.f26148f.setDuration(150L);
                this.f26148f.setInterpolator(nr.f27346f);
            } else {
                animatorSet2.playTogether(ObjectAnimator.ofFloat(this, property, 0.0f));
                this.f26148f.setDuration(300L);
            }
            this.f26148f.addListener(new i40(this, 2));
            this.f26148f.start();
            return;
        }
        setVisibility(4);
    ...
    public final void d() {
        float f10;
        gg.q qVar = this.f26145a;
        qVar.setTextColor(-1);
        this.f26147c.setColorFilter(new PorterDuffColorFilter(-366530760, PorterDuff.Mode.MULTIPLY));
    ...
    public final boolean e(org.telegram.ui.Cells.t1 r21, java.lang.Integer r22, int r23, int r24, boolean r25) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.k40.e(org.telegram.ui.Cells.t1, java.lang.Integer, int, int, boolean):boolean");
    }
    ...
    public final void f(View view, boolean z4) {
        if (this.e != view && getTag() == null) {
            ...
            if (z4) {
                ...
                Property property = View.ALPHA;
                if (z10) {
                    ImageView imageView = this.f26147c;
                    setPivotX((imageView.getMeasuredWidth() / 2.0f) + imageView.getX());
                    setPivotY((imageView.getMeasuredHeight() / 2.0f) + imageView.getY());
                    this.f26148f.playTogether(ObjectAnimator.ofFloat(this, property, 0.0f, 1.0f), ObjectAnimator.ofFloat(this, View.SCALE_Y, 0.5f, 1.0f), ObjectAnimator.ofFloat(this, View.SCALE_X, 0.5f, 1.0f));
                    this.f26148f.setDuration(350L);
                    this.f26148f.setInterpolator(nr.h);
                } else {
                    animatorSet2.playTogether(ObjectAnimator.ofFloat(this, property, 0.0f, 1.0f));
                    this.f26148f.setDuration(300L);
                }
                this.f26148f.addListener(new i40(this, 1));
                this.f26148f.start();
                return;
            }
            setAlpha(1.0f);
    ...
    public void setExtraTranslationY(float f10) {
        this.f26153x = f10;
        setTranslationY(f10 + this.f26152w);
    }

    public void setOverrideText(String str) {
        this.f26151s = str;
        this.f26145a.setText(str);
    ...
    public void setText(CharSequence charSequence) {
        this.f26145a.setText(charSequence);
    }
    ...
    public k40(int i10, Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z4) {
        ...
        this.f26145a = qVar;
        int i11 = org.telegram.ui.ActionBar.j6.f20130pf;
        ...
        if (i10 == 3) {
            qVar.setGravity(19);
            qVar.setBackground(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(5.0f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20148qf, f6Var)));
            ...
            qVar.setGravity(51);
            qVar.setBackground(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(10.0f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20148qf, f6Var)));
        ...
        if (i10 == 0) {
            ...
            this.f26146b.setScaleType(ImageView.ScaleType.CENTER);
            this.f26146b.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i11, f6Var), PorterDuff.Mode.MULTIPLY));
            addView(this.f26146b, k7.b6.d(38, 34.0f, 51, 7.0f, 7.0f, 0.0f, 0.0f));
        }
        ImageView imageView2 = new ImageView(context);
        this.f26147c = imageView2;
        imageView2.setImageResource(z4 ? R.drawable.tooltip_arrow_up : R.drawable.tooltip_arrow);
        imageView2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20148qf, f6Var), PorterDuff.Mode.MULTIPLY));
