    ...
    public final void run() {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                return;
            case 2:
                ((xs0) obj).f29983f.m1(false);
                return;
            case 3:
                org.telegram.ui.ActionBar.o2 o2Var = ((it0) obj).f25028f.f30656v1;
                if (o2Var != null) {
            ...
            case 5:
                ju0 ju0Var = (ju0) obj;
                ArrayList arrayList3 = ju0Var.f25441f;
                if (ju0Var.h) {
                    ju0Var.h = false;
                    ...
                    ju0Var.f25446x.f30656v1.getMessagesController().getSavedMessagesController().updatePinnedOrder(arrayList4);
                    return;
                }
                return;
            case 6:
            ...
            case 11:
                oy0 oy0Var = (oy0) obj;
                int i12 = oy0Var.f26882a;
                oy0Var.F = null;
                my0 my0Var = oy0Var.f26886c;
                if (my0Var != null && my0Var.getEditField() != null && oy0Var.f26886c.getFieldText() != null) {
                    int selectionStart = oy0Var.f26886c.getEditField().getSelectionStart();
                    int selectionEnd = oy0Var.f26886c.getEditField().getSelectionEnd();
                    if (selectionStart != selectionEnd) {
                        oy0Var.f26892s = false;
                    ...
                    CharSequence fieldText = oy0Var.f26886c.getFieldText();
                    ...
                    if (emojiSpanArr != null && emojiSpanArr.length > 0 && SharedConfig.suggestAnimatedEmoji && UserConfig.getInstance(i12).isPremium()) {
                        ...
                        if (emojiSpan != null) {
                            ...
                            if (selectionStart == spanEnd) {
                                ...
                                if (substring != null) {
                                    String str = oy0Var.H;
                                    if (str != null && oy0Var.G == 2 && str.equals(substring) && !oy0Var.f26894x && (arrayList2 = oy0Var.f26893w) != null && !arrayList2.isEmpty()) {
                                        oy0Var.v = false;
                                        oy0Var.c();
                                        ...
                                        ArrayList arrayList5 = oy0Var.f26893w;
                        ...
                        if ((x5VarArr == null || x5VarArr.length == 0) && selectionEnd < 52) {
                            ...
                            if (substring2 != null) {
                                ...
                                if (str2 != null && oy0Var.G == 1 && str2.equals(substring2) && !oy0Var.f26894x && (arrayList = oy0Var.f26893w) != null && !arrayList.isEmpty()) {
                                    oy0Var.v = false;
                                    oy0Var.c();
                                    ...
                                    ArrayList arrayList6 = oy0Var.f26893w;
            ...
            case 14:
                ...
                return;
            case 15:
                ArrayList arrayList7 = ((v01) obj).f28535a;
            ...
            case 16:
                v11 v11Var = (v11) obj;
                v11Var.J = null;
                v11Var.H.animate().scaleX(1.0f).scaleY(1.0f).setDuration(150L).setInterpolator(qr.f27380f).start();
                return;
            case 17:
                z11 z11Var = (z11) obj;
                ViewPropertyAnimator duration = z11Var.animate().alpha(0.0f).setListener(new jd0(z11Var, 22)).setDuration(300L);
                z11Var.f30368b = duration;
                duration.start();
                return;
            case 18:
                b21 b21Var = (b21) obj;
                Utilities.Callback callback = b21Var.f22549b;
                if (callback != null) {
                    callback.run(Long.valueOf(b21Var.f22548a.f22916s));
                    return;
                }
                return;
            case 19:
                y21 y21Var = ((p21) obj).f26919b;
                if (y21Var.k()) {
                    y21Var.l();
                    return;
                }
            ...
            case 22:
                ...
                return;
            case 23:
                ((g41) obj).f24083c.setVisibility(8);
                return;
            case 24:
                ((org.telegram.ui.al) obj).f26321c.presentFragment(new org.telegram.ui.g41());
                return;
            case 25:
            ...
            case 27:
                ...
                int i16 = UndoView.f22238e0;
                undoView.getClass();
                try {
                    undoView.f22246f.performHapticFeedback(3, 2);
                    return;
