...
public final class ew0 extends View {
    ...
    public final cw0 f23938a;
    public final Paint f23939b;
    public final Paint f23940c;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            Paint paint = this.f23939b;
            if (i13 < length) {
                int i14 = this.f23942n;
                int i15 = (this.h * 2) + this.f23943r;
                int i16 = this.f23941f;
                ...
                paint.setColor(d11);
                Paint paint2 = this.f23940c;
                paint2.setColor(d11);
                float f16 = dp3;
                canvas2.drawCircle(i17, f16, AndroidUtilities.lerp(this.f23941f / 2, AndroidUtilities.dp(6.0f), max), paint);
                if (i13 != 0) {
                    int i19 = (i17 - (this.f23941f / 2)) - this.h;
                    int i20 = this.f23943r;
                    int i21 = i19 - i20;
                    int i22 = this.f23944s;
                    if (i22 != -1 && i13 - 1 >= i22) {
                        ...
                        if (this.e != dp5) {
                            i11 = dp4;
                            i10 = i17;
                            paint2.setPathEffect(new DashPathEffect(new float[]{AndroidUtilities.dp(6.0f), org.telegram.messenger.rk.B(8.0f, dp5, dp2) / ((float) (dp5 - 1))}, 0.0f));
                            this.e = dp5;
                        } else {
                            i11 = dp4;
                            i10 = i17;
                ...
                int d12 = i0.a.d(max, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19477y6, f6Var), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19279n6, f6Var));
                ...
                int i24 = (this.h * 2) + this.f23943r;
                int i25 = this.f23941f;
                float f18 = ((i24 + i25) * d) + this.f23942n + (i25 / 2);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        this.f23938a.e(this, accessibilityNodeInfo);
    }

    @Override
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(74.0f), 1073741824));
        this.f23941f = AndroidUtilities.dp(6.0f);
        this.h = AndroidUtilities.dp(2.0f);
        this.f23942n = AndroidUtilities.dp(22.0f);
        int measuredWidth = getMeasuredWidth();
        int i12 = this.f23941f;
        String[] strArr = this.F;
        this.f23943r = (((measuredWidth - (i12 * strArr.length)) - ((strArr.length - 1) * (this.h * 2))) - (this.f23942n * 2)) / Math.max(1, strArr.length - 1);
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        float a2 = w7.q.a(((this.f23941f / 2.0f) + (x10 - this.f23942n)) / (((this.h * 2) + this.f23943r) + i10), 0.0f, this.F.length - 1);
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (!this.v && Math.abs(this.f23946x - x10) > Math.abs(this.f23947y - y3)) {
                getParent().requestDisallowInterceptTouchEvent(true);
            }
            if (this.f23945w && Math.abs(this.f23946x - x10) >= AndroidUtilities.touchSlop) {
                this.v = true;
                this.f23945w = false;
            }
            if (this.v) {
    ...
    public final boolean performAccessibilityAction(int i10, Bundle bundle) {
        if (!super.performAccessibilityAction(i10, bundle) && !this.f23938a.g(this, i10, bundle)) {
            return false;
        }
        return true;
    }
