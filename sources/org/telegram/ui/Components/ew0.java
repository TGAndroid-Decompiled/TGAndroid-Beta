...
public final class ew0 extends TimeAnimator {
    public int f24689a;
    public int f24690b;
    public ValueAnimator.AnimatorUpdateListener f24691c;
    public Float d;
    public float[] e;

    @Override
    public final void addUpdateListener(ValueAnimator.AnimatorUpdateListener animatorUpdateListener) {
        this.f24691c = animatorUpdateListener;
    }
    ...
    public final void start() {
        setTimeListener(new TimeAnimator.TimeListener() {
            ...
            public final void onTimeUpdate(TimeAnimator timeAnimator, long j10, long j11) {
                int i10;
                ew0 ew0Var = ew0.this;
                int i11 = ew0Var.f24689a;
                if (i11 > 0 && (i10 = ew0Var.f24690b) > 0) {
                    int i12 = i11 - 1;
                    ew0Var.f24689a = i12;
                    if (ew0Var.f24691c != null) {
                        float[] fArr = ew0Var.e;
                        if (fArr != null && fArr.length == 2) {
                            ...
                            ew0Var.f24691c.onAnimationUpdate(ew0Var);
                            return;
                        }
                        ew0Var.end();
                        return;
