...
public final class ew0 extends View {
    ...
    public final cw0 f23998a;
    public final Paint f23999b;
    public final Paint f24000c;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            Paint paint = this.f23999b;
            if (i13 < length) {
                int i14 = this.f24002n;
                int i15 = (this.h * 2) + this.f24003r;
                int i16 = this.f24001f;
                ...
                paint.setColor(d11);
                Paint paint2 = this.f24000c;
                paint2.setColor(d11);
                float f16 = dp3;
                canvas2.drawCircle(i17, f16, AndroidUtilities.lerp(this.f24001f / 2, AndroidUtilities.dp(6.0f), max), paint);
                if (i13 != 0) {
                    int i19 = (i17 - (this.f24001f / 2)) - this.h;
                    int i20 = this.f24003r;
                    int i21 = i19 - i20;
                    int i22 = this.f24004s;
                    if (i22 != -1 && i13 - 1 >= i22) {
                ...
                int i24 = (this.h * 2) + this.f24003r;
                int i25 = this.f24001f;
                float f18 = ((i24 + i25) * d) + this.f24002n + (i25 / 2);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        this.f23998a.e(this, accessibilityNodeInfo);
    }

    @Override
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(74.0f), 1073741824));
        this.f24001f = AndroidUtilities.dp(6.0f);
        this.h = AndroidUtilities.dp(2.0f);
        this.f24002n = AndroidUtilities.dp(22.0f);
        int measuredWidth = getMeasuredWidth();
        int i12 = this.f24001f;
        String[] strArr = this.F;
        this.f24003r = (((measuredWidth - (i12 * strArr.length)) - ((strArr.length - 1) * (this.h * 2))) - (this.f24002n * 2)) / Math.max(1, strArr.length - 1);
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        float a2 = w7.q.a(((this.f24001f / 2.0f) + (x10 - this.f24002n)) / (((this.h * 2) + this.f24003r) + i10), 0.0f, this.F.length - 1);
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (!this.v && Math.abs(this.f24006x - x10) > Math.abs(this.f24007y - y3)) {
                getParent().requestDisallowInterceptTouchEvent(true);
            }
            if (this.f24005w && Math.abs(this.f24006x - x10) >= AndroidUtilities.touchSlop) {
                this.v = true;
                this.f24005w = false;
            }
            if (this.v) {
    ...
    public final boolean performAccessibilityAction(int i10, Bundle bundle) {
        if (!super.performAccessibilityAction(i10, bundle) && !this.f23998a.g(this, i10, bundle)) {
            return false;
        }
        return true;
    }
