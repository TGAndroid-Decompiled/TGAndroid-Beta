...
public final class e91 extends FrameLayout {
    public static final int f23891f = 0;
    public final org.telegram.ui.ActionBar.d6 f23892a;
    public final dm0 f23893b;
    public final RectF f23894c;
    ...
    public e91(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        dm0Var.A = v02;
        dm0Var.f23697z = v02;
        dm0Var.f23695x = org.telegram.ui.ActionBar.h6.l1(0.1f, v02);
        dm0Var.f23682j = false;
        dm0Var.f23681i = false;
        dm0Var.k();
    }

    @Override
    public final void onDraw(Canvas canvas) {
        RectF rectF = this.f23894c;
        rectF.set(0.0f, 0.0f, getWidth(), getHeight());
        dm0 dm0Var = this.f23893b;
        float[] fArr = dm0Var.e;
        ...
        this.f23893b.d(canvas, rectF, 1.0f, false, false);
        RectF rectF2 = this.d;
    ...
    public void setWebPage(TLRPC.WebPage webPage) {
        ...
        org.telegram.ui.ActionBar.d6 d6Var = this.f23892a;
        if (str != null) {
