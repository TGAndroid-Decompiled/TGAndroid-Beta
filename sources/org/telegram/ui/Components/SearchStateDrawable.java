...
public class SearchStateDrawable extends Drawable {
    ...
    private AnimatedFloat progress = new AnimatedFloat(1.0f, new Tooltip$$ExternalSyntheticLambda0(this, 8), 0, 350, CubicBezierInterpolator.EASE_OUT_QUINT);
    ...
    private void setIconState(int i, boolean z, boolean z2) {
        if (getIconState() == i) {
            if (i != 2) {
        ...
        if (!z2 && i == 2) {
            if (this.delaySetProgress == null) {
                SearchStateDrawable$$ExternalSyntheticLambda1 searchStateDrawable$$ExternalSyntheticLambda1 = new SearchStateDrawable$$ExternalSyntheticLambda1(this, i, z);
                this.delaySetProgress = searchStateDrawable$$ExternalSyntheticLambda1;
                AndroidUtilities.runOnUIThread(searchStateDrawable$$ExternalSyntheticLambda1, 65L);
                return;
            }
            return;
        }
