...
public final class mg extends org.telegram.ui.lu0 {
    ...
    public final MediaController.PhotoEntry f26478b;
    public final File f26479c;
    public final ng d;

    public mg(ng ngVar, MediaController.PhotoEntry photoEntry, File file) {
        this.d = ngVar;
        this.f26478b = photoEntry;
        this.f26479c = file;
    }
    ...
    public final void o(int i10, VideoEditedInfo videoEditedInfo, boolean z10, int i11, int i12, boolean z11) {
        ...
        if (mnVar != null && (wnVar = chatActivityEnterView.P2) != null && mnVar.f35615f) {
            wnVar.Rb();
            return;
        }
        ArrayList arrayList = new ArrayList();
        SendMessagesHelper.SendingMediaInfo sendingMediaInfo = new SendMessagesHelper.SendingMediaInfo();
        MediaController.PhotoEntry photoEntry = this.f26478b;
        ...
        if (wnVar3 != null) {
            messageSuggestionParams = wnVar3.f39474g5;
        }
