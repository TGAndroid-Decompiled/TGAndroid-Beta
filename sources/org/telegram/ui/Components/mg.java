...
public final class mg extends FrameLayout {
    public final org.telegram.ui.ActionBar.k5 f27032a;
    public final RectF f27033b;
    ...
    public mg(Activity activity) {
        super(activity);
        this.f27033b = new RectF();
        this.f27034c = new Paint(1);
        this.e = false;
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        this.f27034c.setShader(new LinearGradient(0.0f, 0.0f, getMeasuredWidth(), 0.0f, new int[]{-9071617, -5999873}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP));
    }
}
