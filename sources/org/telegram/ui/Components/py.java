...
public final class py extends kl0 {
    ...
    public final ry f29540e;
    public final int f29541f;
    public int h;
    public TLRPC.User f29542n;
    public String f29543r;
    public boolean f29544s;
    public boolean v;
    public String f29545w;
    public final ArrayList f29546x = new ArrayList();
    public final HashMap f29547y = new HashMap();
    public int I = -1;
    public int J = -1;
    ...
    public final void E(String str, String str2, boolean z10, boolean z11, boolean z12, String str3, TLObject tLObject) {
        boolean z13;
        if (str != null && str.equals(this.f29545w)) {
            this.h = 0;
            ...
            HashMap hashMap = this.f29547y;
            boolean z14 = this.d;
            ArrayList arrayList = this.f29546x;
            kz kzVar = this.L;
            if (!z14 && TextUtils.isEmpty(str2)) {
                arrayList.clear();
                hashMap.clear();
                kzVar.f27996o0.e(false);
            }
            if (tLObject instanceof TLRPC.messages_BotResults) {
                int size = arrayList.size();
                TLRPC.messages_BotResults messages_botresults = (TLRPC.messages_BotResults) tLObject;
                HashMap hashMap2 = kzVar.f27988l0;
                py pyVar = kzVar.f27993n0;
                if (!hashMap2.containsKey(str3)) {
                    kzVar.f27988l0.put(str3, messages_botresults);
                }
                if (!z12 && messages_botresults.cache_time != 0) {
                    MessagesStorage.getInstance(kzVar.f27960c1).saveBotCache(str3, messages_botresults);
                }
                this.f29543r = messages_botresults.next_offset;
                int i10 = 0;
                ...
                if (size != arrayList.size() && !TextUtils.isEmpty(this.f29543r)) {
                    z13 = false;
                } else {
                    z13 = true;
                }
            ...
            if (!z14) {
                if (kzVar.f27976h0.getAdapter() != this) {
                    kzVar.f27976h0.setAdapter(this);
                }
    ...
    public final void F(final String str, final String str2, final boolean z10, final boolean z11, final boolean z12) {
        ...
        if (i10 != 0) {
            if (i10 >= 0) {
                ConnectionsManager.getInstance(kzVar.f27960c1).cancelRequest(this.h, true);
            }
            this.h = 0;
        }
        this.f29545w = str;
        this.v = z11;
        ry ryVar = this.f29540e;
        if (ryVar != null) {
            ryVar.a(z11);
        }
        int i11 = kzVar.f27960c1;
        HashMap hashMap = kzVar.f27988l0;
        nw nwVar = kzVar.f27976h0;
        qw qwVar = kzVar.f27996o0;
        int i12 = kzVar.f27960c1;
        ...
        this.f29542n = (TLRPC.User) userOrChat;
        ...
        if (z12 && hashMap.containsKey(j3)) {
        ...
        } else if (kzVar.f27985k0.f30466a.contains(j3)) {
        } else {
            if (z12) {
                this.h = -1;
            ...
            tL_messages_getInlineBotResults.bot = MessagesController.getInstance(i12).getInputUser(this.f29542n);
    ...
    public final void G(String str, boolean z10) {
        ...
        if (!this.d) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                if (currentPosition != kzVar.f28006r0 && currentPosition != kzVar.f28010s0) {
                    H(MessagesController.getInstance(kzVar.f27960c1).gifSearchEmojies.get(currentPosition - kzVar.f28013t0));
                    return;
                }
    ...
    public final void H(String str) {
        if (this.v && TextUtils.equals(this.f29545w, str)) {
            this.L.f27979i0.h1(0, 0);
        } else {
    ...
    public final void l() {
        int i10;
        if (this.d && (i10 = this.f29541f) != 0) {
            kz kzVar = this.L;
            if (i10 == Integer.MAX_VALUE) {
                this.H = kzVar.f27980i1.size();
            } else {
                nw nwVar = kzVar.f27976h0;
                qy qyVar = kzVar.f27979i0;
                if (nwVar.getMeasuredWidth() != 0) {
                    int measuredWidth = kzVar.f27976h0.getMeasuredWidth();
                    int i11 = qyVar.J;
                    int dp = AndroidUtilities.dp(100.0f);
                    this.H = 0;
                    int size = kzVar.f27980i1.size();
                    int i12 = i11;
                    int i13 = 0;
                    int i14 = 0;
                    for (int i15 = 0; i15 < size; i15++) {
                        TLRPC.Document document = (TLRPC.Document) kzVar.f27980i1.get(i15);
                        iv0 C1 = nz.C1(qyVar.F1(document, document.attributes));
                        int min = Math.min(i11, (int) Math.floor((((C1.f27299a / C1.f27300b) * dp) / measuredWidth) * i11));
                        if (i12 < min) {
                            this.H += i13;
                            i14++;
                            if (i14 == i10) {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        org.telegram.ui.Cells.e2 e2Var = (org.telegram.ui.Cells.e2) c1Var.f45767a;
        int i11 = this.J;
        if (i11 >= 0 && i10 >= i11) {
            e2Var.e((TLRPC.BotInlineResult) this.f29546x.get(i10 - i11), this.f29542n, true, false, false, true);
            return;
        }
        TLRPC.Document document = (TLRPC.Document) this.L.f27980i1.get(i10);
        e2Var.getClass();
        ...
        if (i10 != 0) {
            ...
            if (i10 != 1) {
                if (i10 != 2) {
                    ...
                    View view = this.f29540e;
                    view.setLayoutParams(p0Var);
                    o8Var = view;
                } else {
                    org.telegram.ui.Cells.o8 o8Var2 = new org.telegram.ui.Cells.o8(this.f29539c, false, false, kzVar.Z1, kzVar.f27981i2);
                ...
                view2.setLayoutParams(new s4.p0(-1, kzVar.f27956b1));
                o8Var = view2;
            }
        } else {
            org.telegram.ui.Cells.e2 e2Var = new org.telegram.ui.Cells.e2(this.f29539c);
