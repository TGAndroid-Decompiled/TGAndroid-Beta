...
public final class cf extends wo0 {
    ...
    public cf(ChatActivityEnterView chatActivityEnterView, final Context context, final org.telegram.ui.bo boVar, MessagesController messagesController, final boolean z10, TLRPC.Peer peer, TLRPC.TL_channels_sendAsPeers tL_channels_sendAsPeers, final ai.r5 r5Var, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        e();
        this.f29720z = new ArrayList();
        this.G = new ArrayList();
        this.f29713r = peer;
        this.f29714s = tL_channels_sendAsPeers;
        ...
        this.f29711p = textView;
        org.telegram.messenger.wl.n(org.telegram.ui.ActionBar.j6.f19026m5, f6Var, textView, 1, 16.0f);
    ...
    public final void dismiss() {
        ...
        if (chatActivityEnterView.f21834q0 != this) {
            super.dismiss();
            return;
        }
        chatActivityEnterView.f21834q0 = null;
        int i10 = 0;
        if (!this.f29712q) {
            l(new o1.k[0]);
            chatActivityEnterView.f21829p0.a(true, true, 0.0f);
            return;
        }
