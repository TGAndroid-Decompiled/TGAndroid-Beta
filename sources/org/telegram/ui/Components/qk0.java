...
public final class qk0 extends AnimatorListenerAdapter {
    ...
    public void onAnimationCancel(Animator animator) {
        switch (this.f27336a) {
            case 11:
                ((ProfileActivity) this.f27338c).C5 = null;
                return;
            case 12:
                org.telegram.ui.g31 g31Var = (org.telegram.ui.g31) this.f27338c;
                super.onAnimationCancel(animator);
                float floatValue = ((Float) ((ValueAnimator) animator).getAnimatedValue()).floatValue();
                int[] iArr = (int[]) this.f27337b;
                if (iArr != null) {
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        switch (i10) {
            case 0:
                ...
                ((rk0) brVar.d).f27637g.remove((AnimatorSet) obj);
                if (((rk0) brVar.d).f27637g.isEmpty()) {
                    ((rk0) brVar.d).f27634b.clear();
            ...
            case 2:
                ...
                qv0Var.f27420f0 = 1.0f;
                qv0Var.S.add((mv0) obj);
                ((qv0) gVar.f1890c).f27412a0.setShader(null);
                ((qv0) gVar.f1890c).f27416c0.setShader(null);
                ((qv0) gVar.f1890c).N();
                super.onAnimationEnd(animator);
                return;
            case 3:
            ...
            case 9:
                ...
                AnimatorSet animatorSet = ue0Var.f28374s;
                if (animatorSet != null) {
                    animatorSet.cancel();
                }
                ...
                ue0Var.f28374s = animatorSet3;
                animatorSet3.playTogether(ObjectAnimator.ofFloat(ue0Var, ue0Var.E, 0.0f, 1.0f));
                ue0Var.f28374s.setDuration(250L);
                ue0Var.f28374s.setInterpolator(new OvershootInterpolator(1.01f));
                ue0Var.f28374s.addListener(new se0(ue0Var, 0));
                ue0Var.f28374s.start();
                AnimatorSet animatorSet4 = new AnimatorSet();
                photoViewer.A2 = animatorSet4;
                animatorSet4.playTogether(ObjectAnimator.ofFloat(photoViewer.f31139z2, photoViewer.f30945d4, 0.0f));
                photoViewer.A2.setDuration(85L);
                photoViewer.A2.setInterpolator(qr.f27381g);
            ...
            case 11:
                ...
                if (profileActivity.C5 != null) {
                    if (profileActivity.F5) {
                        ...
                        profileActivity.O.f30646r0.setVisibility(4);
                        AnimatorSet animatorSet5 = new AnimatorSet();
                        profileActivity.D5 = animatorSet5;
                        animatorSet5.playTogether(ObjectAnimator.ofFloat(profileActivity, profileActivity.f31321j5, 1.0f));
            ...
            case 14:
                ...
                ((SecretMediaViewer) obj2).f31489s = false;
            ...
            case 16:
                ...
                UsersSelectActivity usersSelectActivity = xh1Var.f39644f;
                usersSelectActivity.f31623c.setAllowDrawCursor(true);
                if (usersSelectActivity.O.isEmpty()) {
                    usersSelectActivity.f31623c.setHintVisible(true, true);
                    return;
                }
                return;
            case 17:
                ((Runnable) obj).run();
                ti1 ti1Var = (ti1) obj2;
                ti1Var.f37767e0.setScaleX(1.15f);
                ti1Var.f37767e0.setScaleY(1.15f);
                ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) ti1Var.f37767e0.getLayoutParams();
                marginLayoutParams.leftMargin = AndroidUtilities.dp(10.0f);
                marginLayoutParams.rightMargin = AndroidUtilities.dp(10.0f);
                ti1Var.f37767e0.setVisibility(8);
                return;
            case 18:
                ...
                if (!zArr[0]) {
                    zArr[0] = true;
                    d2Var.f41354r0.b(d2Var.f41361y0, false);
                }
            ...
            case 19:
                ...
                v0Var.f41900a.d(1.0f);
                r0.q0.e((View) obj2, v0Var);
                return;
            case 20:
                ((rg.x0) obj2).f42565w = false;
            ...
            case 22:
                ...
                eaVar.f4608b = null;
                eaVar.f4609c = false;
                ((xg.i) eaVar.f4611n).f45796b.setAllowDrawCursor(true);
                return;
            default:
                yh.s8 s8Var = (yh.s8) obj2;
                s8Var.f47823b.remove((yh.r8) obj);
                s8Var.a1();
                return;
        }
    }
    ...
    public void onAnimationStart(Animator animator) {
        switch (this.f27336a) {
            case 8:
                ((vv0) this.f27337b).setVisibility(0);
                return;
            default:
