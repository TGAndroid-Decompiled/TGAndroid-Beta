...
public final class s41 extends FrameLayout implements org.telegram.ui.ActionBar.x5 {
    public final org.telegram.ui.ActionBar.d6 f28144a;
    public boolean f28145b;
    public final p41 f28146c;
    public final TextView d;
    public final FrameLayout.LayoutParams e;
    public final q41 f28147f;
    public boolean h;
    public final ImageView f28148n;
    public int f28149r;
    public final e6 f28150s;

    public s41(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f28149r = -1;
        this.f28150s = new e6(this, 0L, 320L, rr.h);
        this.f28144a = d6Var;
    ...
    public final void dispatchDraw(Canvas canvas) {
        canvas.save();
        canvas.clipRect(0.0f, 0.0f, getWidth(), this.f28150s.d(this.f28149r, false));
    ...
    public final void e() {
        ...
        org.telegram.ui.ActionBar.d6 d6Var = this.f28144a;
        this.f28146c.setTextColor(org.telegram.ui.ActionBar.h6.v0(i10, d6Var));
        ...
        q41 q41Var = this.f28147f;
        q41Var.setTextColor(v03);
        q41Var.setLinkTextColor(org.telegram.ui.ActionBar.h6.v0(i11, d6Var));
        q41Var.setHighlightColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19382uf, d6Var));
        setHandlesColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19399vf, d6Var));
        ...
        ImageView imageView = this.f28148n;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f28145b) {
            ...
            Paint T0 = org.telegram.ui.ActionBar.h6.T0("paintDivider", this.f28144a);
            if (T0 == null) {
    ...
    public final void onMeasure(int i10, int i11) {
        this.f28149r = getMeasuredHeight();
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824);
        FrameLayout.LayoutParams layoutParams = this.e;
        layoutParams.bottomMargin = 0;
        super.onMeasure(makeMeasureSpec, i11);
        if (this.f28148n.getVisibility() == 0) {
            Layout layout = this.f28147f.getLayout();
        ...
        if (getMeasuredHeight() > this.f28149r && !this.h) {
            this.f28149r = getMeasuredHeight();
            invalidate();
            return;
        }
        int measuredHeight = getMeasuredHeight();
        this.f28149r = measuredHeight;
        this.f28150s.d(measuredHeight, true);
    }
