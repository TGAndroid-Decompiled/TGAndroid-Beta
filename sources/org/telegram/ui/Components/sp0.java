...
public final class sp0 extends pv0 {
    ...
    public final c6 G0;
    public final hq0 H0;
    public boolean f27948w0;
    public final RectF f27949x0;
    ...
    public sp0(hq0 hq0Var, Context context) {
        ...
        this.H0 = hq0Var;
        this.f27948w0 = false;
        this.f27949x0 = new RectF();
        this.H = new rp0(this, this);
        this.F0 = AndroidUtilities.computePerceivedBrightness(hq0Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18904h5)) > 0.721f;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        canvas.save();
        canvas.clipRect(0.0f, getPaddingTop() + hq0Var.f24778t0, getMeasuredWidth(), getMeasuredHeight() + hq0Var.f24778t0 + AndroidUtilities.dp(50.0f));
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (view instanceof kz) {
            ...
            if (hq0Var.V0 != null) {
                ...
                canvas.clipPath(hq0Var.V0.f4285j.f4274k);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        FrameLayout frameLayout = hq0Var.f24781w;
        canvas.translate(0.0f, hq0Var.f24778t0);
        int i17 = hq0Var.f24772p0;
        i10 = ((org.telegram.ui.ActionBar.f3) hq0Var).backgroundPaddingTop;
        int dp2 = AndroidUtilities.dp(6.0f) + (i17 - i10) + this.f27951z0;
        int i18 = hq0Var.f24772p0;
        i11 = ((org.telegram.ui.ActionBar.f3) hq0Var).backgroundPaddingTop;
        int dp3 = ((i18 - i11) - AndroidUtilities.dp(13.0f)) + this.f27951z0;
        hq0Var.X = dp3;
        ...
        boolean z13 = true;
        if (!z10) {
            dp2 += hq0Var.G0.f10591b;
            if (this.f27950y0) {
                i16 = ((org.telegram.ui.ActionBar.f3) hq0Var).backgroundPaddingTop;
                if (i16 + dp3 < hq0Var.G0.f10591b) {
                    z12 = true;
                    int i20 = dp3 + hq0Var.G0.f10591b;
            ...
            z12 = false;
            int i202 = dp3 + hq0Var.G0.f10591b;
            i15 = ((org.telegram.ui.ActionBar.f3) hq0Var).backgroundPaddingTop;
            f7 = this.G0.e(z12);
        ...
        if (frameLayout != null) {
            if (dp3 > hq0Var.G0.f10591b || frameLayout.getChildCount() <= 0) {
        ...
        if (f7 < 1.0f) {
            ...
            RectF rectF = this.f27949x0;
            rectF.set((getMeasuredWidth() - dp) / 2, f10, measuredWidth, dp5);
            org.telegram.ui.ActionBar.i6.f19121t0.setColor(hq0Var.getThemedColor(org.telegram.ui.ActionBar.i6.Ii));
            org.telegram.ui.ActionBar.i6.f19121t0.setAlpha((int) ((1.0f - f7) * paint.getAlpha()));
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            if (this.F0 && 0 > hq0Var.G0.f10591b * 0.5f) {
                z11 = true;
            } else {
                z11 = false;
            }
        ...
        canvas.restore();
        this.A0 = this.f27951z0;
    }

    @Override
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        boolean z10 = this.f27950y0;
        hq0 hq0Var = this.H0;
        if (!z10) {
            if (motionEvent.getAction() == 0 && motionEvent.getY() < this.f27951z0 - AndroidUtilities.dp(30.0f)) {
                hq0Var.dismiss();
                return true;
            }
        } else if (motionEvent.getAction() == 0 && hq0Var.f24772p0 != 0 && motionEvent.getY() < hq0Var.f24772p0 - AndroidUtilities.dp(30.0f)) {
            hq0Var.dismiss();
            return true;
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (!z12) {
            sp0Var.f27948w0 = true;
            i20 = ((org.telegram.ui.ActionBar.f3) hq0Var).backgroundPaddingLeft;
            int i23 = hq0Var.G0.f10591b;
            i21 = ((org.telegram.ui.ActionBar.f3) hq0Var).backgroundPaddingLeft;
            sp0Var.setPadding(i20, i23, i21, 0);
            sp0Var.f27948w0 = false;
        }
        int paddingTop = size - sp0Var.getPaddingTop();
        int max = Math.max(hq0Var.M.h(), hq0Var.K.h() - 1);
        int D = org.telegram.messenger.y0.D(103.0f, Math.max(2, (int) Math.ceil(max / 4.0f)), AndroidUtilities.dp(48.0f) + AndroidUtilities.dp(103.0f));
        i12 = ((org.telegram.ui.ActionBar.f3) hq0Var).backgroundPaddingTop;
        int i24 = i12 + D;
        if (ll0Var.getVisibility() != 8) {
            int dp = AndroidUtilities.dp(103.0f);
            int D2 = org.telegram.messenger.y0.D(103.0f, Math.max(2, (int) Math.ceil((hq0Var.L.h() - 1) / 4.0f)), AndroidUtilities.dp(48.0f) + dp);
        ...
        FrameLayout frameLayout2 = hq0Var.f24774r;
        mp0 mp0Var = hq0Var.d;
        int i27 = size2 - (i16 * 2);
        int R = sp0Var.R();
        hq0Var.N0 = R;
            ...
            if (childAt != null && childAt.getVisibility() != i17) {
                if (mp0Var.l(childAt)) {
                    if (!AndroidUtilities.isInMultiwindow && !AndroidUtilities.isTablet()) {
                        ...
                        childAt.measure(View.MeasureSpec.makeMeasureSpec(i27, 1073741824), View.MeasureSpec.makeMeasureSpec(Math.min(AndroidUtilities.dp(200.0f), sp0Var.getPaddingTop() + (i29 - hq0Var.G0.f10591b)), 1073741824));
                    } else {
                        childAt.measure(View.MeasureSpec.makeMeasureSpec(i27, 1073741824), View.MeasureSpec.makeMeasureSpec(sp0Var.getPaddingTop() + (i29 - hq0Var.G0.f10591b), 1073741824));
                    }
                } else {
