...
public final class pb0 extends vl0 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        xb0 xb0Var2 = this.X2;
        org.telegram.ui.x8 x8Var = xb0Var2.f30226b;
        boolean z12 = false;
        ...
        int i12 = 0;
        while (i12 < 3) {
            dc0 dc0Var = xb0Var2.f30229c0;
            ArrayList arrayList = dc0Var.E;
            pb0 pb0Var = xb0Var2.f30230f;
            dc0Var.E.clear();
            if (i12 != 2 || pb0Var.X1) {
                int i13 = 0;
                ?? r32 = z12;
                while (true) {
                    ...
                    if (childAt3 instanceof org.telegram.ui.Cells.u1) {
                        ...
                        if (childAt3.getY() <= pb0Var.getHeight() && childAt3.getY() + childAt3.getHeight() >= 0.0f && (currentMessagesGroup = u1Var.getCurrentMessagesGroup()) != null && ((i12 != 0 || currentMessagesGroup.messages.size() != 1) && ((i12 != 1 || currentMessagesGroup.transitionParams.drawBackgroundForDeletedItems) && ((i12 != 0 || !u1Var.getMessageObject().deleted) && ((i12 != 1 || u1Var.getMessageObject().deleted) && ((i12 != 2 || u1Var.f21432oc) && (i12 == 2 || !u1Var.f21432oc))))))) {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (view instanceof org.telegram.ui.Cells.u1) {
            ...
            u1Var.u3(true);
            u1Var.V1(canvas);
            if (u1Var.getCurrentMessagesGroup() == null || ((u1Var.getCurrentPosition() != null && (((u1Var.getCurrentPosition().flags & u1Var.t0()) != 0 && (u1Var.getCurrentPosition().flags & 1) != 0) || (u1Var.getCurrentMessagesGroup() != null && u1Var.getCurrentMessagesGroup().isDocuments))) || u1Var.getTransitionParams().f21173w0)) {
                u1Var.I1(u1Var.getAlpha(), canvas, false);
                u1Var.d2(canvas, u1Var.getAlpha(), null);
                u1Var.N1(canvas, u1Var.getAlpha());
            }
            if (u1Var.getCurrentMessagesGroup() != null || u1Var.getTransitionParams().f21173w0) {
                u1Var.W1(canvas, u1Var.getAlpha());
            }
            if ((u1Var.getCurrentPosition() != null && u1Var.getCurrentPosition().last) || u1Var.getTransitionParams().f21173w0) {
