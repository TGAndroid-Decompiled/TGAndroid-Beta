...
public final class pb0 extends FrameLayout {
    ...
    public int f26994a0;
    public final org.telegram.ui.w8 f26995b;
    public boolean f26996b0;
    public final ci.n6 f26997c;
    public final vb0 f26998c0;
    public final org.telegram.ui.Cells.ca d;
    public final gb0 e;
    public final hb0 f26999f;
    public final jb0 h;
    public final ob0 f27000n;
    public MessagePreviewParams.Messages f27001r;
    public final ActionBarPopupWindow$ActionBarPopupWindowLayout f27002s;
    public final fb0 v;
    public final fb0 f27003w;
    public final org.telegram.ui.ActionBar.f1 f27004x;
    public final org.telegram.ui.ActionBar.f1 f27005y;
    ...
    public static MessageObject.GroupedMessages a(pb0 pb0Var, MessageObject messageObject) {
        if (messageObject.getGroupId() != 0) {
            MessageObject.GroupedMessages groupedMessages = pb0Var.f27001r.groupedMessagesMap.get(messageObject.getGroupId());
    ...
    public static void b(pb0 pb0Var, org.telegram.ui.Cells.t1 t1Var) {
        ...
        if (pb0Var.f26993a == 2) {
            MessagePreviewParams messagePreviewParams = pb0Var.f26998c0.d;
    ...
    public final void e(float f7, int i10) {
        boolean z10 = this.f26998c0.v;
        ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout = this.f27002s;
        ci.n6 n6Var = this.f26997c;
        org.telegram.ui.w8 w8Var = this.f26995b;
        if (z10) {
    ...
    public final void g(boolean z10, boolean z11) {
        ...
        if (!z11 || this.O != z10) {
            ...
            org.telegram.ui.ActionBar.f1 f1Var = this.f27005y;
            org.telegram.ui.ActionBar.f1 f1Var2 = this.f27004x;
            fb0 fb0Var = this.f27003w;
            fb0 fb0Var2 = this.v;
            float f15 = 0.0f;
            if (z11) {
    ...
    public final void h() {
        ...
        for (int i11 = 0; i11 < this.f27001r.previewMessages.size(); i11++) {
            MessageObject messageObject = this.f27001r.previewMessages.get(i11);
            messageObject.forceUpdate = true;
            messageObject.sendAsPeer = vb0Var.f28675a;
        ...
        for (int i12 = 0; i12 < this.f27001r.pollChosenAnswers.size(); i12++) {
            this.f27001r.pollChosenAnswers.get(i12).chosen = !messagePreviewParams.hideForwardSendersName;
        }
        for (int i13 = 0; i13 < this.f27001r.groupedMessagesMap.size(); i13++) {
            jb0Var.V(this.f27001r.groupedMessagesMap.valueAt(i13));
        }
        this.f27000n.q(0, this.f27001r.previewMessages.size());
    }
    ...
    public final void i() {
        ...
        if (!z10) {
            ...
            MessagePreviewParams.Messages messages = this.f27001r;
            ...
            float A = com.google.android.gms.internal.vision.e2.A(getMeasuredHeight() - AndroidUtilities.dp(16.0f), (this.f26995b.getMeasuredHeight() - this.R) + (this.W - AndroidUtilities.dp(8.0f)), 2.0f, AndroidUtilities.dp(8.0f)) - this.R;
            this.S = A;
        ...
        if (!z11 && (this.R != i10 || this.S != f7)) {
            ...
            AndroidUtilities.runOnUIThread(vb0Var.f28684y, 50L);
            this.T = i10;
            e(f7, i10);
        } else if (z11) {
            float f11 = this.S;
    ...
    public final void j() {
        ...
        if (this.f26993a == 0) {
            gb0 gb0Var = this.e;
            if (gb0Var.v - gb0Var.f19954u <= MessagesController.getInstance(vb0Var.f28682w).quoteLengthMax) {
                ...
                if (messagePreviewParams.quote != null && gb0Var.y()) {
                    messagePreviewParams.quoteStart = gb0Var.f19954u;
                    messagePreviewParams.quoteEnd = gb0Var.v;
                    if (c10 != null && ((messageObject2 = messagePreviewParams.quote.f37171a) == null || messageObject2.getId() != c10.getId())) {
    ...
    public final void k(boolean z10) {
        ...
        String string;
        vb0 vb0Var = this.f26998c0;
        TLRPC.User user = vb0Var.f28679n;
        MessagePreviewParams messagePreviewParams = vb0Var.d;
        TLRPC.Chat chat = vb0Var.f28680r;
        ci.n6 n6Var = this.f26997c;
    ...
    public final void onAttachedToWindow() {
        ...
        if (this.f26993a == 0) {
            AndroidUtilities.forEachViews((RecyclerView) this.f26999f, (e2.h) new ya0(this, 0));
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ((ViewGroup.MarginLayoutParams) this.f26999f.getLayoutParams()).topMargin = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight();
        ...
        if (this.f26994a0 != size2) {
            for (int i13 = 0; i13 < this.f27001r.previewMessages.size(); i13++) {
                MessageObject messageObject = this.f27001r.previewMessages.get(i13);
                if (vb0Var.v) {
