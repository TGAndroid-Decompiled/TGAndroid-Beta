...
public final class gg0 extends lw0 {
    ...
    public final Paint f24282b = new Paint(1);
    public final int f24283c = UserConfig.selectedAccount;
    public long d = 0;
    public boolean e = false;
    public final RectF f24284f = new RectF();
    public float f24285g;
    public final boolean h;
    public final org.telegram.ui.ActionBar.d6 f24286i;
    ...
    public final void draw(Canvas canvas) {
        ...
        boolean z10 = this.h;
        if (z10) {
            i10 = org.telegram.ui.ActionBar.h6.f19010p9;
        } else {
            i10 = org.telegram.ui.ActionBar.h6.f19011pa;
        }
        int v02 = org.telegram.ui.ActionBar.h6.v0(i10, this.f24286i);
        Paint paint = this.f24282b;
        paint.setColor(v02);
        RectF rectF = this.f24284f;
        rectF.set(0.0f, i12, dp, i12 + dp);
        float f10 = this.f24285g;
        if (f10 < 0.5f) {
            f7 = org.telegram.messenger.ul.v(f10, 0.5f, 1.0f, 35.0f);
        } else {
        ...
        if (z10) {
            ...
            i11 = org.telegram.ui.ActionBar.h6.f19065s8;
        }
    ...
    public final void f() {
        if (this.e) {
            if (!NotificationCenter.getInstance(this.f24283c).isAnimationInProgress()) {
                ...
                if (this.f24285g >= 1.0f) {
                    this.f24285g = 0.0f;
                }
                float f7 = (((float) j3) / 300.0f) + this.f24285g;
                this.f24285g = f7;
                if (f7 > 1.0f) {
                    this.f24285g = 1.0f;
                }
