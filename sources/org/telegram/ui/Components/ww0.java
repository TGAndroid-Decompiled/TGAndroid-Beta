...
public final class ww0 {
    ...
    public final o5 a(TLRPC.User user, TLRPC.Chat chat, int i10, boolean z10) {
        o5 o5Var = this.f30176a;
        if (chat != null && chat.verified) {
            Drawable drawable = this.f30177b;
            if (drawable == null) {
                drawable = new pq(org.telegram.ui.ActionBar.j6.f19093f1, org.telegram.ui.ActionBar.j6.f19147i1);
            }
            ...
            Drawable drawable2 = this.f30177b;
            if (drawable2 == null) {
                drawable2 = new pq(org.telegram.ui.ActionBar.j6.f19093f1, org.telegram.ui.ActionBar.j6.f19147i1);
            }
            this.f30177b = drawable2;
    ...
    public ww0(int i10, View view) {
        this.f30176a = new o5(AndroidUtilities.dp(i10), view);
    }
}
