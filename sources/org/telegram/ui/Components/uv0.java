...
public final class uv0 extends View {
    ...
    public final sv0 f29286a;
    public final Paint f29287b;
    ...
    public float f29294x;
    public float f29295y;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            Paint paint = this.f29287b;
            if (i13 < length) {
                int i14 = this.f29290n;
                int i15 = (this.h * 2) + this.f29291r;
                int i16 = this.f29289f;
                int i17 = (i16 / i12) + ((i15 + i16) * i13) + i14;
                float f15 = i13;
                float f16 = f15 - d;
                float max = Math.max(f13, f14 - Math.abs(f16));
                float a2 = k7.n.a((d - f15) + f14, f13, f14);
                ...
                int d11 = i0.a.d(a2, v02, org.telegram.ui.ActionBar.j6.l1(f11, v03));
                paint.setColor(d11);
                Paint paint2 = this.f29288c;
                paint2.setColor(d11);
                float f17 = dp3;
                canvas2.drawCircle(i17, f17, AndroidUtilities.lerp(this.f29289f / 2, AndroidUtilities.dp(6.0f), max), paint);
                if (i13 != 0) {
                    int i19 = (i17 - (this.f29289f / 2)) - this.h;
                    int i20 = this.f29291r;
                    int i21 = i19 - i20;
                    int i22 = this.f29292s;
                    if (i22 != -1 && i13 - 1 >= i22) {
                        ...
                        int dp6 = (int) (i20 - (AndroidUtilities.dp(3.0f) * k7.n.a(1.0f - Math.min(Math.abs(f16), Math.abs(f18)), 0.0f, 1.0f)));
                        canvas2 = canvas;
                ...
                int d12 = i0.a.d(max, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20281y6, f6Var), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20085n6, f6Var));
                ...
                int i24 = (this.h * 2) + this.f29291r;
                int i25 = this.f29289f;
                float f19 = ((i24 + i25) * d) + this.f29290n + (i25 / 2);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        this.f29286a.e(this, accessibilityNodeInfo);
    }

    @Override
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(74.0f), 1073741824));
        this.f29289f = AndroidUtilities.dp(6.0f);
        this.h = AndroidUtilities.dp(2.0f);
        this.f29290n = AndroidUtilities.dp(22.0f);
        int measuredWidth = getMeasuredWidth();
        int i12 = this.f29289f;
        String[] strArr = this.C;
        this.f29291r = (((measuredWidth - (i12 * strArr.length)) - ((strArr.length - 1) * (this.h * 2))) - (this.f29290n * 2)) / Math.max(1, strArr.length - 1);
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        float a2 = k7.n.a(((this.f29289f / 2.0f) + (x10 - this.f29290n)) / (((this.h * 2) + this.f29291r) + i10), 0.0f, this.C.length - 1);
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (!this.v && Math.abs(this.f29294x - x10) > Math.abs(this.f29295y - y10)) {
                getParent().requestDisallowInterceptTouchEvent(true);
            }
            if (this.f29293w && Math.abs(this.f29294x - x10) >= AndroidUtilities.touchSlop) {
                this.v = true;
                this.f29293w = false;
            }
            if (this.v) {
    ...
    public final boolean performAccessibilityAction(int i10, Bundle bundle) {
        if (!super.performAccessibilityAction(i10, bundle) && !this.f29286a.g(this, i10, bundle)) {
            return false;
        }
        return true;
    }
