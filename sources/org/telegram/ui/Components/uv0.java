...
public final class uv0 extends View {
    ...
    public final sv0 f28494a;
    public final Paint f28495b;
    ...
    public float f28502x;
    public float f28503y;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            Paint paint = this.f28495b;
            if (i13 < length) {
                int i14 = this.f28498n;
                int i15 = (this.h * 2) + this.f28499r;
                int i16 = this.f28497f;
                ...
                paint.setColor(d11);
                Paint paint2 = this.f28496c;
                paint2.setColor(d11);
                float f16 = dp3;
                canvas2.drawCircle(i17, f16, AndroidUtilities.lerp(this.f28497f / 2, AndroidUtilities.dp(6.0f), max), paint);
                if (i13 != 0) {
                    int i19 = (i17 - (this.f28497f / 2)) - this.h;
                    int i20 = this.f28499r;
                    int i21 = i19 - i20;
                    int i22 = this.f28500s;
                    if (i22 != -1 && i13 - 1 >= i22) {
                ...
                int d12 = i0.a.d(max, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19244y6, f6Var), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19047n6, f6Var));
                ...
                int i24 = (this.h * 2) + this.f28499r;
                int i25 = this.f28497f;
                float f18 = ((i24 + i25) * d) + this.f28498n + (i25 / 2);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        this.f28494a.e(this, accessibilityNodeInfo);
    }

    @Override
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(74.0f), 1073741824));
        this.f28497f = AndroidUtilities.dp(6.0f);
        this.h = AndroidUtilities.dp(2.0f);
        this.f28498n = AndroidUtilities.dp(22.0f);
        int measuredWidth = getMeasuredWidth();
        int i12 = this.f28497f;
        String[] strArr = this.F;
        this.f28499r = (((measuredWidth - (i12 * strArr.length)) - ((strArr.length - 1) * (this.h * 2))) - (this.f28498n * 2)) / Math.max(1, strArr.length - 1);
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        float a2 = w7.p.a(((this.f28497f / 2.0f) + (x10 - this.f28498n)) / (((this.h * 2) + this.f28499r) + i10), 0.0f, this.F.length - 1);
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (!this.v && Math.abs(this.f28502x - x10) > Math.abs(this.f28503y - y3)) {
                getParent().requestDisallowInterceptTouchEvent(true);
            }
            if (this.f28501w && Math.abs(this.f28502x - x10) >= AndroidUtilities.touchSlop) {
                this.v = true;
                this.f28501w = false;
            }
            if (this.v) {
    ...
    public final boolean performAccessibilityAction(int i10, Bundle bundle) {
        if (!super.performAccessibilityAction(i10, bundle) && !this.f28494a.g(this, i10, bundle)) {
            return false;
        }
        return true;
    }
