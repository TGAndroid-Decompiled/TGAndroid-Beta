...
public final class y extends bb {
    ...
    public final w9 Z;
    public final org.telegram.ui.Cells.j3 f30443a0;
    public final org.telegram.ui.Cells.j3 f30444b0;
    public final FrameLayout f30445c0;
    public final op f30446d0;
    public final FrameLayout f30447e0;
    public final FrameLayout f30448f0;
    public final ci.d f30449g0;
    public Long f30450h0;
    public x f30451i0;
    public TL_aicompose.TL_aiComposeTone f30452j0;
    public e f30453k0;
    public e f30454l0;
    public j61 m0;
            ...
            public final void onClick(View view) {
                switch (r2) {
                    ...
                    case 1:
                        ...
                        return;
                    default:
                        op opVar = this.f27801b.f30446d0;
            ...
            public final void onClick(View view) {
                switch (r2) {
                    ...
                    case 1:
                        ...
                        return;
                    default:
                        op opVar2 = this.f27801b.f30446d0;
    ...
    public static void P(y yVar, nf.e eVar, org.telegram.ui.ActionBar.a2 a2Var) {
        ...
        a2Var.dismiss();
        yVar.dismiss();
        MessagesController.getInstance(yVar.currentAccount).getTonesController().remove(yVar.f30452j0);
    }

    public static void Q(final y yVar, final org.telegram.ui.ActionBar.d6 d6Var) {
        org.telegram.ui.Cells.j3 j3Var = yVar.f30444b0;
        org.telegram.ui.Cells.j3 j3Var2 = yVar.f30443a0;
        op opVar = yVar.f30446d0;
        ci.d dVar = yVar.f30449g0;
        if (!dVar.N) {
            if (!dVar.W) {
                if (yVar.f30450h0 == null) {
                    yVar.V();
                    return;
                }
                return;
            ...
            if (yVar.f30452j0 != null) {
                TL_aicompose.updateTone updatetone = new TL_aicompose.updateTone();
                updatetone.flags = 1 | updatetone.flags;
                updatetone.display_author = opVar.f27167a.f22194q;
                updatetone.tone = TL_aicompose.InputAiComposeTone.from(yVar.f30452j0);
                updatetone.flags |= 2;
                updatetone.emoji_id = yVar.f30450h0.longValue();
                updatetone.flags |= 4;
                ...
                ConnectionsManager.getInstance(yVar.currentAccount).sendRequestTyped(updatetone, new Object(), new Utilities.Callback2(yVar) {
                    ...
                    public final void run(Object obj, Object obj2) {
                        ...
                        switch (r3) {
                            case 0:
                                y yVar2 = this.f28347b;
                                yVar2.f30449g0.setLoading(false);
                                if (aiComposeTone != null) {
                                    e eVar = yVar2.f30454l0;
                                    if (eVar != null) {
                                    ...
                                    org.telegram.ui.Cells.c1.r(yVar2.f30448f0, d6Var, tL_error, false);
                                    return;
                                } else {
                                    return;
                                }
                            default:
                                y.R(this.f28347b, d6Var, aiComposeTone, tL_error);
                                return;
                        }
                    }
                });
            ...
            createtone.display_author = opVar.f27167a.f22194q;
            createtone.emoji_id = yVar.f30450h0.longValue();
    ...
    public static void R(y yVar, org.telegram.ui.ActionBar.d6 d6Var, TL_aicompose.AiComposeTone aiComposeTone, TLRPC.TL_error tL_error) {
        FrameLayout frameLayout = yVar.f30448f0;
        yVar.f30449g0.setLoading(false);
        if (aiComposeTone != null) {
            yVar.dismiss();
            e eVar = yVar.f30453k0;
            if (eVar != null) {
                eVar.run(aiComposeTone);
            }
        } else if (tL_error != null) {
    ...
    public static void S(y yVar, org.telegram.ui.ActionBar.a2 a2Var) {
        ...
        deletetone.tone = TL_aicompose.InputAiComposeTone.from(yVar.f30452j0);
    ...
    public final void W() {
        boolean z10;
        if (this.f30450h0 != null && this.f30443a0.getText().length() > 0 && this.f30444b0.getText().length() > 0) {
            z10 = true;
        } else {
            z10 = false;
        }
        this.f30449g0.setEnabled(z10);
    }

    public final void X() {
        Long l4 = this.f30450h0;
        w9 w9Var = this.Z;
        if (l4 == null) {
        ...
        w9Var.setAnimatedEmojiDrawable(new q5(4, this.currentAccount, this.f30450h0.longValue()));
    ...
    public final void onSmoothContainerViewLayout(float f7) {
        ...
        this.f30447e0.setTranslationY(f7);
    }
