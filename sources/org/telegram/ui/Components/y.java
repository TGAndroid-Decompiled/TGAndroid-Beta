...
public final class y extends bb {
    ...
    public final w9 Z;
    public final org.telegram.ui.Cells.j3 f30509a0;
    public final org.telegram.ui.Cells.j3 f30510b0;
    public final FrameLayout f30511c0;
    public final pp f30512d0;
    public final FrameLayout f30513e0;
    public final FrameLayout f30514f0;
    public final ci.d f30515g0;
    public Long f30516h0;
    public x f30517i0;
    public TL_aicompose.TL_aiComposeTone f30518j0;
    public e f30519k0;
    public e f30520l0;
    public k61 m0;
    ...
    public y(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    ...
                    case 1:
                        ...
                        return;
                    default:
                        pp ppVar = this.f27792b.f30512d0;
            ...
            public final void onClick(View view) {
                switch (r2) {
                    ...
                    case 1:
                        ...
                        return;
                    default:
                        pp ppVar2 = this.f27792b.f30512d0;
        ...
        xl0Var.setPadding(i12, 0, i12, AndroidUtilities.dp(66.0f));
    ...
    public static void P(y yVar, nf.e eVar, org.telegram.ui.ActionBar.a2 a2Var) {
        ...
        a2Var.dismiss();
        yVar.dismiss();
        MessagesController.getInstance(yVar.currentAccount).getTonesController().remove(yVar.f30518j0);
    }

    public static void Q(final y yVar, final org.telegram.ui.ActionBar.d6 d6Var) {
        org.telegram.ui.Cells.j3 j3Var = yVar.f30510b0;
        org.telegram.ui.Cells.j3 j3Var2 = yVar.f30509a0;
        pp ppVar = yVar.f30512d0;
        ci.d dVar = yVar.f30515g0;
        if (!dVar.N) {
            if (!dVar.W) {
                if (yVar.f30516h0 == null) {
                    yVar.V();
                    return;
                }
                return;
            ...
            if (yVar.f30518j0 != null) {
                TL_aicompose.updateTone updatetone = new TL_aicompose.updateTone();
                updatetone.flags = 1 | updatetone.flags;
                updatetone.display_author = ppVar.f27472a.f22194q;
                updatetone.tone = TL_aicompose.InputAiComposeTone.from(yVar.f30518j0);
                updatetone.flags |= 2;
                updatetone.emoji_id = yVar.f30516h0.longValue();
                updatetone.flags |= 4;
                ...
                ConnectionsManager.getInstance(yVar.currentAccount).sendRequestTyped(updatetone, new Object(), new Utilities.Callback2(yVar) {
                    ...
                    public final void run(Object obj, Object obj2) {
                        ...
                        switch (r3) {
                            case 0:
                                y yVar2 = this.f28390b;
                                yVar2.f30515g0.setLoading(false);
                                if (aiComposeTone != null) {
                                    e eVar = yVar2.f30520l0;
                                    if (eVar != null) {
                                    ...
                                    org.telegram.ui.Cells.c1.r(yVar2.f30514f0, d6Var, tL_error, false);
                                    return;
                                } else {
                                    return;
                                }
                            default:
                                y.R(this.f28390b, d6Var, aiComposeTone, tL_error);
                                return;
                        }
                    }
                });
            ...
            createtone.display_author = ppVar.f27472a.f22194q;
            createtone.emoji_id = yVar.f30516h0.longValue();
    ...
    public static void R(y yVar, org.telegram.ui.ActionBar.d6 d6Var, TL_aicompose.AiComposeTone aiComposeTone, TLRPC.TL_error tL_error) {
        FrameLayout frameLayout = yVar.f30514f0;
        yVar.f30515g0.setLoading(false);
        if (aiComposeTone != null) {
            yVar.dismiss();
            e eVar = yVar.f30519k0;
            if (eVar != null) {
                eVar.run(aiComposeTone);
            }
        } else if (tL_error != null) {
    ...
    public static void S(y yVar, org.telegram.ui.ActionBar.a2 a2Var) {
        ...
        deletetone.tone = TL_aicompose.InputAiComposeTone.from(yVar.f30518j0);
    ...
    public final void W() {
        boolean z10;
        if (this.f30516h0 != null && this.f30509a0.getText().length() > 0 && this.f30510b0.getText().length() > 0) {
            z10 = true;
        } else {
            z10 = false;
        }
        this.f30515g0.setEnabled(z10);
    }

    public final void X() {
        Long l4 = this.f30516h0;
        w9 w9Var = this.Z;
        if (l4 == null) {
        ...
        w9Var.setAnimatedEmojiDrawable(new q5(4, this.currentAccount, this.f30516h0.longValue()));
    ...
    public final void onSmoothContainerViewLayout(float f7) {
        ...
        this.f30513e0.setTranslationY(f7);
    }

    @Override
    public final wl0 v(xl0 xl0Var) {
        k61 k61Var = new k61(xl0Var, getContext(), this.currentAccount, 0, true, new d(this, 2), this.resourcesProvider);
        this.m0 = k61Var;
