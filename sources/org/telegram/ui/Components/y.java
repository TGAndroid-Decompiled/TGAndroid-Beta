...
public final class y extends za {
    ...
    public final u9 Z;
    public final org.telegram.ui.Cells.i3 f30046a0;
    public final org.telegram.ui.Cells.i3 f30047b0;
    public final FrameLayout f30048c0;
    public final np f30049d0;
    public final FrameLayout f30050e0;
    public final FrameLayout f30051f0;
    public final ci.d f30052g0;
    public Long f30053h0;
    public x f30054i0;
    public TL_aicompose.TL_aiComposeTone f30055j0;
    public e f30056k0;
    public e f30057l0;
    public x51 m0;
    ...
    public y(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    ...
                    case 1:
                        ...
                        return;
                    default:
                        np npVar = this.f27470b.f30049d0;
        ...
        this.Y = frameLayout2;
        frameLayout2.setBackground(org.telegram.ui.ActionBar.j6.K(AndroidUtilities.dp(100.0f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18863d6, f6Var)));
        ...
        this.f30046a0 = i3Var;
        i3Var.f20240b.addTextChangedListener(new u(this, 0));
        ...
        i3Var2.f20240b.addTextChangedListener(new u(this, 1));
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setPadding(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(12.0f), AndroidUtilities.dp(8.0f));
        linearLayout.setClipToPadding(false);
        linearLayout.setOrientation(0);
        linearLayout.setBackground(org.telegram.ui.ActionBar.j6.Y(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18953i6, f6Var), 24, 24));
        ...
        org.telegram.messenger.wl.n(org.telegram.ui.ActionBar.j6.f19100q5, f6Var, textView, 1, 14.0f);
            ...
            public final void onClick(View view) {
                switch (r2) {
                    ...
                    case 1:
                        ...
                        return;
                    default:
                        np npVar2 = this.f27470b.f30049d0;
    ...
    public static void P(y yVar, nf.e eVar, org.telegram.ui.ActionBar.c2 c2Var) {
        ...
        c2Var.dismiss();
        yVar.dismiss();
        MessagesController.getInstance(yVar.currentAccount).getTonesController().remove(yVar.f30055j0);
    }

    public static void Q(final y yVar, final org.telegram.ui.ActionBar.f6 f6Var) {
        org.telegram.ui.Cells.i3 i3Var = yVar.f30047b0;
        org.telegram.ui.Cells.i3 i3Var2 = yVar.f30046a0;
        np npVar = yVar.f30049d0;
        ci.d dVar = yVar.f30052g0;
        if (!dVar.N) {
            if (!dVar.W) {
                if (yVar.f30053h0 == null) {
                    yVar.V();
                    return;
                }
                return;
            ...
            if (yVar.f30055j0 != null) {
                TL_aicompose.updateTone updatetone = new TL_aicompose.updateTone();
                updatetone.flags = 1 | updatetone.flags;
                updatetone.display_author = npVar.f26511a.f21985q;
                updatetone.tone = TL_aicompose.InputAiComposeTone.from(yVar.f30055j0);
                updatetone.flags |= 2;
                updatetone.emoji_id = yVar.f30053h0.longValue();
                updatetone.flags |= 4;
                ...
                ConnectionsManager.getInstance(yVar.currentAccount).sendRequestTyped(updatetone, new Object(), new Utilities.Callback2(yVar) {
                    ...
                    public final void run(Object obj, Object obj2) {
                        ...
                        switch (r3) {
                            case 0:
                                y yVar2 = this.f27968b;
                                yVar2.f30052g0.setLoading(false);
                                if (aiComposeTone != null) {
                                    e eVar = yVar2.f30057l0;
                                    if (eVar != null) {
                                    ...
                                    org.telegram.ui.Cells.p6.q(yVar2.f30051f0, f6Var, tL_error, false);
                                    return;
                                } else {
                                    return;
                                }
                            default:
                                y.R(this.f27968b, f6Var, aiComposeTone, tL_error);
                                return;
                        }
                    }
                });
            ...
            createtone.display_author = npVar.f26511a.f21985q;
            createtone.emoji_id = yVar.f30053h0.longValue();
    ...
    public static void R(y yVar, org.telegram.ui.ActionBar.f6 f6Var, TL_aicompose.AiComposeTone aiComposeTone, TLRPC.TL_error tL_error) {
        FrameLayout frameLayout = yVar.f30051f0;
        yVar.f30052g0.setLoading(false);
        if (aiComposeTone != null) {
            yVar.dismiss();
            e eVar = yVar.f30056k0;
            if (eVar != null) {
                eVar.run(aiComposeTone);
            }
        } else if (tL_error != null) {
    ...
    public static void S(y yVar, org.telegram.ui.ActionBar.c2 c2Var) {
        ...
        deletetone.tone = TL_aicompose.InputAiComposeTone.from(yVar.f30055j0);
    ...
    public final void W() {
        boolean z10;
        if (this.f30053h0 != null && this.f30046a0.getText().length() > 0 && this.f30047b0.getText().length() > 0) {
            z10 = true;
        } else {
            z10 = false;
        }
        this.f30052g0.setEnabled(z10);
    }

    public final void X() {
        Long l4 = this.f30053h0;
        u9 u9Var = this.Z;
        if (l4 == null) {
        ...
        u9Var.setAnimatedEmojiDrawable(new o5(4, this.currentAccount, this.f30053h0.longValue()));
        u9Var.setColorFilter(null);
        u9Var.setEmojiColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18970j5, this.resourcesProvider), PorterDuff.Mode.SRC_IN));
    }

    @Override
    public final void onSmoothContainerViewLayout(float f7) {
        super.onSmoothContainerViewLayout(f7);
        this.f30050e0.setTranslationY(f7);
    }
