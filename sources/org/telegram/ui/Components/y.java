...
public final class y extends bb {
    ...
    public final w9 Z;
    public final org.telegram.ui.Cells.j3 f30436a0;
    public final org.telegram.ui.Cells.j3 f30437b0;
    public final FrameLayout f30438c0;
    public final op f30439d0;
    public final FrameLayout f30440e0;
    public final FrameLayout f30441f0;
    public final ci.d f30442g0;
    public Long f30443h0;
    public x f30444i0;
    public TL_aicompose.TL_aiComposeTone f30445j0;
    public e f30446k0;
    public e f30447l0;
    public j61 m0;
    ...
    public y(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    ...
                    case 1:
                        ...
                        return;
                    default:
                        op opVar = this.f27793b.f30439d0;
        ...
        this.f30436a0 = j3Var;
        j3Var.f20477b.addTextChangedListener(new u(this, 0));
        ...
        j3Var2.f20477b.addTextChangedListener(new u(this, 1));
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setPadding(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(12.0f), AndroidUtilities.dp(8.0f));
        linearLayout.setClipToPadding(false);
        linearLayout.setOrientation(0);
        linearLayout.setBackground(org.telegram.ui.ActionBar.h6.Y(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19134i6, d6Var), 24, 24));
        ...
        org.telegram.messenger.ok.n(org.telegram.ui.ActionBar.h6.f19283q5, d6Var, textView, 1, 14.0f);
            ...
            public final void onClick(View view) {
                switch (r2) {
                    ...
                    case 1:
                        ...
                        return;
                    default:
                        op opVar2 = this.f27793b.f30439d0;
    ...
    public static void P(y yVar, nf.e eVar, org.telegram.ui.ActionBar.a2 a2Var) {
        ...
        a2Var.dismiss();
        yVar.dismiss();
        MessagesController.getInstance(yVar.currentAccount).getTonesController().remove(yVar.f30445j0);
    }

    public static void Q(final y yVar, final org.telegram.ui.ActionBar.d6 d6Var) {
        org.telegram.ui.Cells.j3 j3Var = yVar.f30437b0;
        org.telegram.ui.Cells.j3 j3Var2 = yVar.f30436a0;
        op opVar = yVar.f30439d0;
        ci.d dVar = yVar.f30442g0;
        if (!dVar.N) {
            if (!dVar.W) {
                if (yVar.f30443h0 == null) {
                    yVar.V();
                    return;
                }
                return;
            ...
            if (yVar.f30445j0 != null) {
                TL_aicompose.updateTone updatetone = new TL_aicompose.updateTone();
                updatetone.flags = 1 | updatetone.flags;
                updatetone.display_author = opVar.f27163a.f22180q;
                updatetone.tone = TL_aicompose.InputAiComposeTone.from(yVar.f30445j0);
                updatetone.flags |= 2;
                updatetone.emoji_id = yVar.f30443h0.longValue();
                updatetone.flags |= 4;
                ...
                ConnectionsManager.getInstance(yVar.currentAccount).sendRequestTyped(updatetone, new Object(), new Utilities.Callback2(yVar) {
                    ...
                    public final void run(Object obj, Object obj2) {
                        ...
                        switch (r3) {
                            case 0:
                                y yVar2 = this.f28341b;
                                yVar2.f30442g0.setLoading(false);
                                if (aiComposeTone != null) {
                                    e eVar = yVar2.f30447l0;
                                    if (eVar != null) {
                                    ...
                                    org.telegram.ui.Cells.c1.r(yVar2.f30441f0, d6Var, tL_error, false);
                                    return;
                                } else {
                                    return;
                                }
                            default:
                                y.R(this.f28341b, d6Var, aiComposeTone, tL_error);
                                return;
                        }
                    }
                });
            ...
            createtone.display_author = opVar.f27163a.f22180q;
            createtone.emoji_id = yVar.f30443h0.longValue();
    ...
    public static void R(y yVar, org.telegram.ui.ActionBar.d6 d6Var, TL_aicompose.AiComposeTone aiComposeTone, TLRPC.TL_error tL_error) {
        FrameLayout frameLayout = yVar.f30441f0;
        yVar.f30442g0.setLoading(false);
        if (aiComposeTone != null) {
            yVar.dismiss();
            e eVar = yVar.f30446k0;
            if (eVar != null) {
                eVar.run(aiComposeTone);
            }
        } else if (tL_error != null) {
    ...
    public static void S(y yVar, org.telegram.ui.ActionBar.a2 a2Var) {
        ...
        deletetone.tone = TL_aicompose.InputAiComposeTone.from(yVar.f30445j0);
    ...
    public final void W() {
        boolean z10;
        if (this.f30443h0 != null && this.f30436a0.getText().length() > 0 && this.f30437b0.getText().length() > 0) {
            z10 = true;
        } else {
            z10 = false;
        }
        this.f30442g0.setEnabled(z10);
    }

    public final void X() {
        Long l4 = this.f30443h0;
        w9 w9Var = this.Z;
        if (l4 == null) {
        ...
        w9Var.setAnimatedEmojiDrawable(new q5(4, this.currentAccount, this.f30443h0.longValue()));
        w9Var.setColorFilter(null);
        w9Var.setEmojiColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19151j5, this.resourcesProvider), PorterDuff.Mode.SRC_IN));
    }

    @Override
    public final void onSmoothContainerViewLayout(float f7) {
        super.onSmoothContainerViewLayout(f7);
        this.f30440e0.setTranslationY(f7);
    }
