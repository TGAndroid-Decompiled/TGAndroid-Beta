...
public final class pn implements TextWatcher {
    ...
    public final void afterTextChanged(Editable editable) {
        ...
        switch (i10) {
            case 0:
                tn tnVar = ((rn) obj).d;
                on onVar = (on) this.f29470c;
                if (onVar.getTag() == null) {
                    s4.c1 K = tnVar.f30682s.K(tnVar.f30678p0);
                    if (K != null && tnVar.f30689x != null) {
                        ...
                        tnVar.f30689x.setDelegate(onVar);
                        tnVar.f30689x.setTranslationY(K.f45767a.getY());
                        tnVar.f30689x.e();
                    }
                    tnVar.P = editable;
                    if (K != null) {
                        tn.L(tnVar, K.f45767a, tnVar.f30678p0);
                    }
                    tnVar.T();
                    return;
                }
            ...
            case 1:
                tn tnVar2 = ((rn) obj).d;
                ec1 ec1Var = tnVar2.f30682s;
                qn qnVar = (qn) this.f29470c;
                ...
                if (c1Var != null) {
                    ...
                    int b10 = c1Var.b();
                    int i11 = b10 - tnVar2.f30684t0;
                    if (i11 >= 0 && i11 < tnVar2.K.length) {
                        if (tnVar2.f30689x != null) {
                            ...
                            if (y3 > 0.0f) {
                                tnVar2.f30689x.setDirection(0);
                                tnVar2.f30689x.setTranslationY(y3);
                            } else {
                                tnVar2.f30689x.setDirection(1);
                                tnVar2.f30689x.setTranslationY(view.getY());
                            }
                            tnVar2.f30689x.setDelegate(qnVar);
                            tnVar2.f30689x.e();
                        }
            ...
            case 3:
                ...
                if (passcodeActivity.f33532x == 1 && passcodeActivity.E == 0) {
                    if (TextUtils.isEmpty(editable) && passcodeActivity.f33530s.getVisibility() != 8) {
                        if (((AtomicBoolean) this.f29470c).get()) {
                            passcodeActivity.f33530s.callOnClick();
                        }
                        AndroidUtilities.updateViewVisibilityAnimated(passcodeActivity.f33530s, false, 0.1f, true);
                        return;
                    } else if (!TextUtils.isEmpty(editable) && passcodeActivity.f33530s.getVisibility() != 0) {
                        AndroidUtilities.updateViewVisibilityAnimated(passcodeActivity.f33530s, true, 0.1f, true);
                        return;
                    } else {
                        return;
                    }
            ...
            case 4:
                ...
                org.telegram.ui.uv0 uv0Var = (org.telegram.ui.uv0) this.f29470c;
                if (uv0Var.getTag() == null) {
                    s4.c1 K2 = zv0Var.f43559c.K(zv0Var.f43568i0);
                    if (K2 != null && zv0Var.Q != null) {
                        ...
                        zv0Var.Q.setTranslationY(K2.f45767a.getY());
                        zv0Var.Q.e();
                    }
                    zv0Var.E = editable;
                    if (K2 != null) {
                        org.telegram.ui.zv0.c0(zv0Var, K2.f45767a, zv0Var.f43568i0);
                    }
                    zv0Var.i0();
                    return;
                }
            ...
            case 5:
                ...
                org.telegram.ui.vv0 vv0Var = (org.telegram.ui.vv0) this.f29470c;
                if (vv0Var.getTag() == null) {
                    s4.c1 K3 = zv0Var2.f43559c.K(zv0Var2.f43568i0);
                    if (K3 != null && zv0Var2.Q != null) {
                        ...
                        zv0Var2.Q.setTranslationY(K3.f45767a.getY());
                        zv0Var2.Q.e();
                    }
                    zv0Var2.F = editable;
                    if (K3 != null) {
                        org.telegram.ui.zv0.c0(zv0Var2, K3.f45767a, zv0Var2.f43569j0);
                    }
                    zv0Var2.i0();
                    return;
                }
            ...
            case 6:
                ...
                ec1 ec1Var2 = zv0Var3.f43559c;
                org.telegram.ui.wv0 wv0Var = (org.telegram.ui.wv0) this.f29470c;
                ...
                if (c1Var != null) {
                    ...
                    int b11 = c1Var.b() - zv0Var3.f43573n0;
            ...
            case 7:
                qg.v vVar = (qg.v) obj;
                qg.x xVar = vVar.f44628f;
                if (!vVar.f44627e && ((String) this.f29470c) != null && editable != null && !TextUtils.isEmpty(editable) && !Objects.equals(((String) this.f29470c).toString(), editable.toString())) {
                    int b12 = w7.p.b(Integer.parseInt(editable.toString()), 0, 255);
                    int i12 = vVar.d;
                    if (i12 != 1) {
                        if (i12 != 2) {
                            argb = Color.argb(Color.alpha(xVar.f44648f), b12, Color.green(xVar.f44648f), Color.blue(xVar.f44648f));
                        } else {
                            argb = Color.argb(Color.alpha(xVar.f44648f), Color.red(xVar.f44648f), Color.green(xVar.f44648f), b12);
                        }
                    } else {
                        argb = Color.argb(Color.alpha(xVar.f44648f), Color.red(xVar.f44648f), b12, Color.blue(xVar.f44648f));
                    }
                    int i13 = qg.x.f44644s;
                    xVar.m(argb, 5);
                    return;
                }
                return;
            case 8:
                ((String[]) this.f29470c)[0] = editable.toString();
                ((yh.f3) obj).Y2.N(true);
                return;
            case 9:
                ((String[]) this.f29470c)[0] = editable.toString();
    ...
    public final void beforeTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
        switch (this.f29468a) {
            ...
            case 1:
                return;
            case 2:
                EditText editText = (EditText) this.f29470c;
                editText.post(new org.telegram.ui.yq(this, editText, (AtomicReference) this.f29469b, 25));
                return;
            case 3:
            case 4:
            case 5:
            case 6:
                return;
            case 7:
                this.f29470c = charSequence.toString();
                return;
            case 8:
            case 9:
            case 10:
