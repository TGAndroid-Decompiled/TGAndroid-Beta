...
public final class EmojiView$$ExternalSyntheticLambda10 implements Runnable {
    public final int $r8$classId;
    public final Object f$0;
    public final boolean f$1;
    public final boolean f$2;

    public EmojiView$$ExternalSyntheticLambda10(Object obj, boolean z, boolean z2, int i) {
        this.$r8$classId = i;
        this.f$0 = obj;
        this.f$1 = z;
        this.f$2 = z2;
    ...
    public final void run() {
        switch (this.$r8$classId) {
            case 0:
                ((EmojiView) this.f$0).lambda$showStickerBanHint$27(this.f$1, this.f$2);
                break;
            case 1:
