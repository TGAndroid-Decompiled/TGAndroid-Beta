...
public final class jb0 extends rl0 {
            ...
            if (i12 != 2 || jb0Var.U1) {
                ...
                while (true) {
                    ...
                    if (childAt3 instanceof org.telegram.ui.Cells.s1) {
                        ...
                        if (childAt3.getY() <= jb0Var.getHeight() && childAt3.getY() + childAt3.getHeight() >= 0.0f && (currentMessagesGroup = s1Var.getCurrentMessagesGroup()) != null && ((i12 != 0 || currentMessagesGroup.messages.size() != 1) && ((i12 != 1 || currentMessagesGroup.transitionParams.drawBackgroundForDeletedItems) && ((i12 != 0 || !s1Var.getMessageObject().deleted) && ((i12 != 1 || s1Var.getMessageObject().deleted) && ((i12 != 2 || s1Var.f22074lc) && (i12 == 2 || !s1Var.f22074lc))))))) {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        if (view instanceof org.telegram.ui.Cells.s1) {
            ...
            s1Var.u3(true);
            s1Var.V1(canvas);
            if (s1Var.getCurrentMessagesGroup() == null || ((s1Var.getCurrentPosition() != null && (((s1Var.getCurrentPosition().flags & s1Var.t0()) != 0 && (s1Var.getCurrentPosition().flags & 1) != 0) || (s1Var.getCurrentMessagesGroup() != null && s1Var.getCurrentMessagesGroup().isDocuments))) || s1Var.getTransitionParams().f21841w0)) {
                s1Var.I1(s1Var.getAlpha(), canvas, false);
                s1Var.d2(canvas, s1Var.getAlpha(), null);
                s1Var.N1(canvas, s1Var.getAlpha());
            }
            if (s1Var.getCurrentMessagesGroup() != null || s1Var.getTransitionParams().f21841w0) {
                s1Var.W1(canvas, s1Var.getAlpha());
            }
            if ((s1Var.getCurrentPosition() != null && s1Var.getCurrentPosition().last) || s1Var.getTransitionParams().f21841w0) {
