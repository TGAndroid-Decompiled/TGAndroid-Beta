...
public class SpeedIconDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        if (paint != null) {
            ...
            rectF.set(((getIntrinsicWidth() - this.textDrawable.getCurrentWidth()) / 2.0f) - AndroidUtilities.dpf2(3.0f), AndroidUtilities.dpf2(0.2f) + ((getIntrinsicHeight() - this.textDrawable.getHeight()) / 2.0f), AndroidUtilities.dpf2(3.0f) + ((this.textDrawable.getCurrentWidth() + getIntrinsicWidth()) / 2.0f), (this.textDrawable.getHeight() + getIntrinsicHeight()) / 2.0f);
        ...
        this.textDrawable.setBounds(0, (int) ((getIntrinsicHeight() - this.textDrawable.getHeight()) / 2.0f), getIntrinsicWidth(), (int) ((this.textDrawable.getHeight() + getIntrinsicHeight()) / 2.0f));
