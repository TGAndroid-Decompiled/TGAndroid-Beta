...
public final class cs implements Predicate {
    ...
    public final TLObject f23126b;

    public cs(int i10, TLObject tLObject) {
        this.f23125a = i10;
        this.f23126b = tLObject;
    }
    ...
    public final boolean test(Object obj) {
        switch (this.f23125a) {
            case 0:
                return MessageObject.peersEqual((TLRPC.InputPeer) this.f23126b, ((MessageObject) obj).messageOwner.from_id);
            default:
                MessageObject messageObject = (MessageObject) obj;
                TLObject tLObject = this.f23126b;
