...
public abstract class bb extends org.telegram.ui.ActionBar.f3 {
    ...
    public int V;
    public int W;
    public final Drawable f22940b;
    public final gg.b0 f22941c;
    public final wl0 d;
    public final xa e;
    public boolean f22942f;
    public int h;
    public final org.telegram.ui.ActionBar.n2 f22943n;
    public final boolean f22944r;
    public final va f22945s;
    public float v;
    public boolean f22946w;
    public float f22947x;
    public boolean f22948y;
    ...
    public void I(Canvas canvas, View view) {
        ...
        if (!this.f22944r) {
            ...
            if (i15 == 1) {
                ...
                AndroidUtilities.updateViewVisibilityAnimated(xaVar, z11, 1.0f, this.f22942f);
            } else if (i15 == 2) {
            ...
            if (L()) {
                ...
                if (this.f22948y && f12 > 0.0f) {
                    ...
                    org.telegram.ui.ActionBar.j6.f19351t0.setColor(getThemedColor(org.telegram.ui.ActionBar.j6.Ii));
                    org.telegram.ui.ActionBar.j6.f19351t0.setAlpha((int) (paint.getAlpha() * f12));
    ...
    public final void J() {
        wl0 wl0Var = this.d;
        if (wl0Var != null && this.f22941c != null && wl0Var.getChildCount() > 0) {
            View view = null;
            int i10 = -1;
    ...
    public final void u() {
        if (this.backDrawable != null && this.containerView != null && this.shadowDrawable != null && L() && !this.f22944r) {
    ...
    public final boolean z() {
        if (i0.a.f(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19133h5, this.resourcesProvider)) > 0.699999988079071d) {
            return true;
        }
        return false;
    }

    public bb(org.telegram.ui.ActionBar.n2 r3, boolean r4, boolean r5, org.telegram.ui.ActionBar.e6 r6) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.bb.<init>(org.telegram.ui.ActionBar.n2, boolean, boolean, org.telegram.ui.ActionBar.e6):void");
    }

    public bb(android.content.Context r2, org.telegram.ui.ActionBar.n2 r3, boolean r4, boolean r5, org.telegram.ui.ActionBar.e6 r6) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.bb.<init>(android.content.Context, org.telegram.ui.ActionBar.n2, boolean, boolean, org.telegram.ui.ActionBar.e6):void");
    }
    ...
    public bb(android.content.Context r2, org.telegram.ui.ActionBar.n2 r3, boolean r4, boolean r5, int r6, org.telegram.ui.ActionBar.e6 r7) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.bb.<init>(android.content.Context, org.telegram.ui.ActionBar.n2, boolean, boolean, int, org.telegram.ui.ActionBar.e6):void");
    }
    ...
    public bb(Context context, org.telegram.ui.ActionBar.n2 n2Var, ab abVar) {
        super(abVar.f22588b, context, abVar.f22591g, abVar.f22587a);
        va vaVar;
        this.v = 0.4f;
        this.f22946w = true;
        this.f22947x = 1.0f;
        ...
        this.O = false;
        this.U = -1;
        boolean z10 = abVar.f22589c;
        boolean z11 = abVar.d;
        boolean z12 = abVar.e;
        int i10 = abVar.f22590f;
        this.f22943n = n2Var;
        this.f22944r = z10;
        this.f22940b = context.getDrawable(R.drawable.header_shadow).mutate();
        if (z11) {
        ...
        va vaVar3 = this.f22945s;
        if (vaVar3 != null) {
            vaVar3.setBottomSheetContainerView(getContainer());
            this.f22945s.setTargetListView(w10);
        }
        if (z10) {
            ...
            this.e = xaVar;
            xaVar.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19133h5));
            xaVar.setTitleColor(getThemedColor(org.telegram.ui.ActionBar.j6.G6));
            xaVar.A(getThemedColor(org.telegram.ui.ActionBar.j6.f19466z8), false);
            xaVar.setBackButtonImage(R.drawable.ic_ab_back);
            xaVar.B(getThemedColor(org.telegram.ui.ActionBar.j6.f19447y8), false);
