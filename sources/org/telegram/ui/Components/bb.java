...
public abstract class bb extends org.telegram.ui.ActionBar.f3 {
    ...
    public int V;
    public int W;
    public final Drawable f24673b;
    public final hg.b0 f24674c;
    public final ll0 d;
    public final xa f24675e;
    public boolean f24676f;
    public int h;
    public final org.telegram.ui.ActionBar.n2 f24677n;
    public final boolean f24678r;
    public final va f24679s;
    public float v;
    public boolean f24680w;
    public float f24681x;
    ...
    public final boolean A() {
        if (i0.a.f(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20762h5, this.resourcesProvider)) > 0.699999988079071d) {
            return true;
        }
        return false;
    }
    ...
    public void I(Canvas canvas, View view) {
        ...
        if (!this.f24678r) {
            ...
            if (i15 == 1) {
                ...
                AndroidUtilities.updateViewVisibilityAnimated(xaVar, z11, 1.0f, this.f24676f);
            } else if (i15 == 2) {
                ...
                xaVar.f21112e.setAlpha(d);
                B(d);
                xaVar.f21112e.setScaleX(d);
                xaVar.f21112e.setPivotY(imageView.getMeasuredHeight() / 2.0f);
                xaVar.f21112e.setScaleY(d);
            ...
            if (L()) {
                ...
                if (this.f24682y && f12 > 0.0f) {
                    ...
                    org.telegram.ui.ActionBar.j6.f20976t0.setColor(getThemedColor(org.telegram.ui.ActionBar.j6.Ii));
                    org.telegram.ui.ActionBar.j6.f20976t0.setAlpha((int) (paint.getAlpha() * f12));
    ...
    public final void J() {
        ll0 ll0Var = this.d;
        if (ll0Var != null && this.f24674c != null && ll0Var.getChildCount() > 0) {
            View view = null;
            int i10 = -1;
    ...
    public final void K() {
        ...
        this.f24675e.f21112e.setPivotX(0.0f);
    ...
    public final void u() {
        if (this.backDrawable != null && this.containerView != null && this.shadowDrawable != null && L() && !this.f24678r) {
    ...
    public bb(Context context, org.telegram.ui.ActionBar.n2 n2Var, ab abVar) {
        super(abVar.f24348b, context, abVar.f24352g, abVar.f24347a);
        va vaVar;
        this.v = 0.4f;
        this.f24680w = true;
        this.f24681x = 1.0f;
        ...
        this.O = false;
        this.U = -1;
        boolean z10 = abVar.f24349c;
        boolean z11 = abVar.d;
        boolean z12 = abVar.f24350e;
        int i10 = abVar.f24351f;
        this.f24677n = n2Var;
        this.f24678r = z10;
        this.f24673b = context.getDrawable(R.drawable.header_shadow).mutate();
        if (z11) {
        ...
        va vaVar3 = this.f24679s;
        if (vaVar3 != null) {
            vaVar3.setBottomSheetContainerView(getContainer());
            this.f24679s.setTargetListView(w10);
        }
        if (z10) {
            ...
            this.f24675e = xaVar;
            xaVar.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f20762h5));
            xaVar.setTitleColor(getThemedColor(org.telegram.ui.ActionBar.j6.G6));
            xaVar.B(getThemedColor(org.telegram.ui.ActionBar.j6.f21091z8), false);
            xaVar.setBackButtonImage(R.drawable.ic_ab_back);
            xaVar.C(getThemedColor(org.telegram.ui.ActionBar.j6.f21072y8), false);
