...
public abstract class bb extends org.telegram.ui.ActionBar.f3 {
    ...
    public int V;
    public int W;
    public final Drawable f24646b;
    public final hg.b0 f24647c;
    public final ll0 d;
    public final xa f24648e;
    public boolean f24649f;
    public int h;
    public final org.telegram.ui.ActionBar.n2 f24650n;
    public final boolean f24651r;
    public final va f24652s;
    public float v;
    public boolean f24653w;
    public float f24654x;
    ...
    public final boolean A() {
        if (i0.a.f(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20735h5, this.resourcesProvider)) > 0.699999988079071d) {
            return true;
        }
        return false;
    }
    ...
    public void I(Canvas canvas, View view) {
        ...
        if (!this.f24651r) {
            ...
            if (i15 == 1) {
                ...
                AndroidUtilities.updateViewVisibilityAnimated(xaVar, z11, 1.0f, this.f24649f);
            } else if (i15 == 2) {
                ...
                xaVar.f21085e.setAlpha(d);
                B(d);
                xaVar.f21085e.setScaleX(d);
                xaVar.f21085e.setPivotY(imageView.getMeasuredHeight() / 2.0f);
                xaVar.f21085e.setScaleY(d);
            ...
            if (L()) {
                ...
                if (this.f24655y && f12 > 0.0f) {
                    ...
                    org.telegram.ui.ActionBar.j6.f20949t0.setColor(getThemedColor(org.telegram.ui.ActionBar.j6.Ii));
                    org.telegram.ui.ActionBar.j6.f20949t0.setAlpha((int) (paint.getAlpha() * f12));
    ...
    public final void J() {
        ll0 ll0Var = this.d;
        if (ll0Var != null && this.f24647c != null && ll0Var.getChildCount() > 0) {
            View view = null;
            int i10 = -1;
    ...
    public final void K() {
        ...
        this.f24648e.f21085e.setPivotX(0.0f);
    ...
    public final void u() {
        if (this.backDrawable != null && this.containerView != null && this.shadowDrawable != null && L() && !this.f24651r) {
    ...
    public bb(Context context, org.telegram.ui.ActionBar.n2 n2Var, ab abVar) {
        super(abVar.f24321b, context, abVar.f24325g, abVar.f24320a);
        va vaVar;
        this.v = 0.4f;
        this.f24653w = true;
        this.f24654x = 1.0f;
        ...
        this.O = false;
        this.U = -1;
        boolean z10 = abVar.f24322c;
        boolean z11 = abVar.d;
        boolean z12 = abVar.f24323e;
        int i10 = abVar.f24324f;
        this.f24650n = n2Var;
        this.f24651r = z10;
        this.f24646b = context.getDrawable(R.drawable.header_shadow).mutate();
        if (z11) {
        ...
        va vaVar3 = this.f24652s;
        if (vaVar3 != null) {
            vaVar3.setBottomSheetContainerView(getContainer());
            this.f24652s.setTargetListView(w10);
        }
        if (z10) {
            ...
            this.f24648e = xaVar;
            xaVar.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f20735h5));
            xaVar.setTitleColor(getThemedColor(org.telegram.ui.ActionBar.j6.G6));
            xaVar.B(getThemedColor(org.telegram.ui.ActionBar.j6.f21064z8), false);
            xaVar.setBackButtonImage(R.drawable.ic_ab_back);
            xaVar.C(getThemedColor(org.telegram.ui.ActionBar.j6.f21045y8), false);
