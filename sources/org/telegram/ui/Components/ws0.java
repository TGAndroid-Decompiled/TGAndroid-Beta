...
public final class ws0 extends org.telegram.ui.ActionBar.g5 {
    ...
    @Override
    public final void l() {
        org.telegram.ui.ActionBar.v0 v0Var = this.f29778f.f30373n0;
        v0Var.setTranslationX(((View) v0Var.getParent()).getMeasuredWidth() - v0Var.getRight());
    }

    @Override
    public final void m() {
        yu0 yu0Var = this.f29778f;
        ...
        if (et0Var != null) {
            ...
            org.telegram.ui.tn tnVar = coVar.f32420oc;
            if (tnVar != null) {
                tnVar.m();
            }
            coVar.f32463s3 = false;
            coVar.f32409o0 = false;
            coVar.hc(false);
            coVar.Ic();
        }
        yu0Var.U0 = false;
        yu0Var.f30373n0.setVisibility(0);
        yu0Var.f30360g0.G(null, true);
        yu0Var.f30364i0.G(null, true);
        yu0Var.f30362h0.G(null, true);
        yu0Var.f30366j0.F(null, true);
        ju0 ju0Var = yu0Var.S;
        if (ju0Var != null) {
            ju0Var.E(null, null);
        }
        yu0Var.K0(false);
        aj0 aj0Var = yu0Var.f30385s0;
        if (aj0Var != null) {
            aj0Var.animate().scaleX(1.0f).scaleY(1.0f).alpha(1.0f).setDuration(320L).setInterpolator(qr.h).start();
        }
        if (yu0Var.f30402z0) {
            yu0Var.f30402z0 = false;
        } else {
            yu0Var.m1(false);
        }
    }
    ...
    public final void n() {
        ...
        yu0Var.f30373n0.setVisibility(8);
        yu0Var.K0(true);
        aj0 aj0Var = yu0Var.f30385s0;
        if (aj0Var != null) {
    ...
    public final void q(EditText editText) {
        ...
        if (et0Var != null) {
            org.telegram.ui.co coVar = et0Var.f33375a;
            org.telegram.ui.ActionBar.v0 v0Var = coVar.f32349j0;
            if (v0Var != null) {
                coVar.f32476t3 = obj;
                v0Var.H(obj, false);
            }
            if (TextUtils.isEmpty(obj) && yu0Var.W0 == null) {
                org.telegram.ui.co coVar2 = et0Var.f33375a;
                org.telegram.ui.tn tnVar = coVar2.f32420oc;
                if (tnVar != null) {
                    tnVar.m();
                }
                coVar2.f32463s3 = false;
                coVar2.f32409o0 = false;
                coVar2.hc(false);
                coVar2.Ic();
            }
        }
        ...
        if (i10 == 1) {
            ut0 ut0Var = yu0Var.f30360g0;
            if (ut0Var != null) {
                ut0Var.G(obj, true);
            }
        } else if (i10 == 3) {
            ut0 ut0Var2 = yu0Var.f30364i0;
            if (ut0Var2 != null) {
                ut0Var2.G(obj, true);
            }
        } else if (i10 == 4) {
            ut0 ut0Var3 = yu0Var.f30362h0;
            if (ut0Var3 != null) {
                ut0Var3.G(obj, true);
            }
        } else if (i10 == 7) {
            pt0 pt0Var = yu0Var.f30366j0;
            if (pt0Var != null) {
                pt0Var.F(obj, true);
            }
