...
public final class mu extends org.telegram.ui.ActionBar.h5 {
    ...
    public final boolean g() {
        ...
        try {
            puVar.f27988r.getWindow().clearFlags(128);
            return true;
        } catch (Exception e) {
            FileLog.e(e);
            return true;
    ...
    public final void onOpenAnimationEnd() {
        ...
        pu puVar = this.h;
        int i10 = puVar.N;
        RadialProgressView radialProgressView = puVar.f27987n;
        ju juVar = puVar.f27984b;
        e91 e91Var = puVar.f27985c;
        if (this.f27120f && puVar.f27985c.g(puVar.H, null, null, puVar.F, true)) {
