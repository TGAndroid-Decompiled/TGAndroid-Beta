...
public class RecyclerAnimationScrollHelper {
    ...
    public class AnonymousClass1 implements View.OnLayoutChangeListener {
        ...
        public void lambda$onLayoutChange$0(ArrayList arrayList, boolean z, int i, int i2, ArrayList arrayList2, ValueAnimator valueAnimator) {
            ...
            for (int i4 = 0; i4 < size2; i4++) {
                ...
                if (z) {
                    view2.setTranslationY(((1.0f - fFloatValue) * i) + paddingBottom);
                } else {
                    view2.setTranslationY((1.0f - fFloatValue) * (-i));
                }
            }
        ...
        public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
            ...
            valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    ...
                    this.f$0.lambda$onLayoutChange$0(arrayList3, z2, i14, paddingBottom, arrayList4, valueAnimator2);
                }
            });
            RecyclerAnimationScrollHelper.this.animator.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    if (BuildVars.DEBUG_PRIVATE_VERSION) {
                        ...
                        if (RecyclerAnimationScrollHelper.this.recyclerView.mChildHelper.mHiddenViews.size() != 0) {
    ...
    public void scrollToPosition(int i, int i2, boolean z, boolean z2, boolean z3) {
        ...
        if (recyclerListView.getItemAnimator() == null) {
            ...
            z4 = z;
            z5 = z2;
            if (this.recyclerView.getItemAnimator().isRunning(new RecyclerAnimationScrollHelper$$ExternalSyntheticLambda0(recyclerAnimationScrollHelper, i3, i4, z4, z5))) {
                return;
            }
        } else {
            recyclerAnimationScrollHelper = this;
