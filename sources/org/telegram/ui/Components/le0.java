...
public abstract class le0 {
    public static int f26121a = 1500;
    ...
    public static void g(String[] strArr, Utilities.Callback callback) {
        ...
        if (activity != null) {
            if (Build.VERSION.SDK_INT >= 23) {
                int i11 = f26121a;
                f26121a = i11 + 1;
                NotificationCenter.NotificationCenterDelegate[] notificationCenterDelegateArr = {new ke0(i11, callback, notificationCenterDelegateArr)};
