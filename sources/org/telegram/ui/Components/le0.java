...
public final class le0 extends FrameLayout {
    ...
    public le0(ue0 ue0Var, Activity activity, Activity activity2) {
        super(activity);
        this.d = ue0Var;
        this.f28726c = activity2;
        this.f28724a = new RectF();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (f10 != 1.0f) {
            paint.setColor(ue0Var.getThemedColor(org.telegram.ui.ActionBar.k6.f21733h5));
            ...
            int i26 = i18 + i24;
            RectF rectF = this.f28724a;
            rectF.set(i15, i16 + i24, measuredWidth - i17, AndroidUtilities.dp(24.0f) + i26);
            float f11 = dp2 * f10;
            canvas.drawRoundRect(rectF, f11, f11, paint);
        }
        int themedColor = ue0Var.getThemedColor(org.telegram.ui.ActionBar.k6.f21733h5);
        paint.setColor(Color.argb((int) (ue0Var.f31618e.getAlpha() * 255.0f), (int) (Color.red(themedColor) * 0.8f), (int) (Color.green(themedColor) * 0.8f), (int) (Color.blue(themedColor) * 0.8f)));
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            ue0 ue0Var = this.d;
            if (ue0Var.f31623w != 0 && motionEvent.getY() < ue0Var.f31623w && ue0Var.f31618e.getAlpha() == 0.0f) {
                ue0Var.dismiss();
                return true;
            }
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ((FrameLayout.LayoutParams) ue0Var.f31619f.getLayoutParams()).topMargin = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight();
        this.f28725b = true;
        int dp = AndroidUtilities.dp(80.0f);
        re0 re0Var = ue0Var.f31616b;
        int i16 = re0Var.f30739a.B;
        for (int i17 = 0; i17 < i16; i17++) {
            ViewGroup a2 = re0Var.a(this.f28726c, i17);
