...
public class c90 extends TextView {
    ...
    public final z80 f22979b;
    public final org.telegram.ui.ActionBar.f6 f22980c;
    public t5 d;
    public d90 e;
    public b90 f22981f;
    public b90 h;
    ...
    public int c() {
        return org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Ld, this.f22980c);
    }
            ...
            try {
                if (K != null) {
                    if (this.f22987y == null) {
                        this.f22987y = I.get(this);
                    }
                    Object obj = this.f22987y;
                    if (obj != null) {
                        K.invoke(obj, null);
                    }
                }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (z80Var != null) {
            ...
            if (motionEvent.getAction() == 1) {
                z80Var.d(true);
                d90 d90Var2 = this.e;
                if (d90Var2 != null && (characterStyle = d90Var2.f23243i) == b10) {
                    b90 b90Var = this.f22981f;
                    if (b90Var != null) {
    ...
    public void setLoading(CharacterStyle characterStyle) {
        if (this.v != characterStyle) {
            ...
            if (i10 != null) {
                int d = d(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Ld, this.f22980c));
