...
public final class c90 implements PopupWindow.OnDismissListener {
    ...
    public final FrameLayout f23262b;
    public final View f23263c;
    ...
    public final void onDismiss() {
        switch (this.f23261a) {
            case 0:
                ((g90) this.e).f24394s = null;
                ci.r6 r6Var = (ci.r6) this.f23263c;
                r6Var.animate().cancel();
                r6Var.animate().alpha(0.0f).setDuration(150L).setListener(new r8(this, 28));
                return;
            default:
                ((org.telegram.ui.wz) this.e).f37534x = null;
                ci.r6 r6Var2 = (ci.r6) this.f23263c;
