...
public abstract class oa0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final org.telegram.ui.ActionBar.f6 f29044a;
    public final na0 f29045b;
    public final hg.j0 f29046c;
    public final ha0 d;
    public final hg.q1 f29047e;
    public final hg.k1 f29048f;
    public final org.telegram.ui.ActionBar.n2 h;
    public float f29049n;
    public float f29050r;
    public float f29051s;
    public float v;
    public bi.x5 f29052w;
    public la0 f29053x;
    ...
    public final void b() {
        ...
        hg.k1 k1Var;
        int height;
        na0 na0Var = this.f29045b;
        if (na0Var != null && this.f29046c != null) {
            boolean g10 = g();
            this.f29051s = 0.0f;
            hg.q1 q1Var = this.f29047e;
            if (g10) {
                if (q1Var.f11249f) {
                ...
                float min = Math.min(Math.max(0.0f, na0Var.getTranslationY() + height) + this.f29051s, (1.0f - this.M) * getHeight());
                this.f29049n = 0.0f;
                this.f29050r = min;
            } else {
                if (q1Var.f11249f) {
                ...
                this.f29049n = Math.max(Math.max(0.0f, na0Var.getTranslationY() + i10) - this.f29051s, this.M * getHeight());
            ...
            if (dVar != null) {
                ...
                RectF rectF = this.T;
                rectF.set(rect);
                if (na0Var != null && (ha0Var = this.d) != null && na0Var.getLayoutManager() == ha0Var && (k1Var = this.f29048f) != null && k1Var.R != null) {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.emojiLoaded) {
            AndroidUtilities.forEachViews((RecyclerView) this.f29045b, (e2.h) new bi.f(24));
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (g10) {
            ...
            float min2 = Math.min(Math.max(0.0f, na0Var.getTranslationY() + height) + this.f29051s, (1.0f - this.M) * getHeight());
            this.f29049n = 0.0f;
            ...
            float max = Math.max(0.0f, na0Var.getTranslationY() + i11) - this.f29051s;
            this.f29049n = max;
        ...
        if (num != null) {
            ...
            v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Sd, this.f29044a);
        }
        paint2.setColor(v02);
        f(canvas, rect, min);
    ...
    public final boolean g() {
        s4.o0 layoutManager = this.f29045b.getLayoutManager();
        hg.j0 j0Var = this.f29046c;
        if (layoutManager == j0Var && j0Var.f45759t) {
            return true;
        }
        return false;
    }
