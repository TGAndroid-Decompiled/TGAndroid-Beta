...
public abstract class oa0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final org.telegram.ui.ActionBar.f6 f29018a;
    public final na0 f29019b;
    public final hg.j0 f29020c;
    public final ha0 d;
    public final hg.q1 f29021e;
    public final hg.k1 f29022f;
    public final org.telegram.ui.ActionBar.n2 h;
    public float f29023n;
    public float f29024r;
    public float f29025s;
    public float v;
    public bi.x5 f29026w;
    public la0 f29027x;
    public final Rect f29028y;

    public oa0(Context context, long j3, long j10, org.telegram.ui.ActionBar.n2 n2Var, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f29028y = new Rect();
        this.G = false;
        this.H = false;
        this.I = false;
    ...
    public final void b() {
        ...
        hg.k1 k1Var;
        int height;
        na0 na0Var = this.f29019b;
        if (na0Var != null && this.f29020c != null) {
            boolean g10 = g();
            this.f29025s = 0.0f;
            hg.q1 q1Var = this.f29021e;
            if (g10) {
                if (q1Var.f11223f) {
                ...
                float min = Math.min(Math.max(0.0f, na0Var.getTranslationY() + height) + this.f29025s, (1.0f - this.M) * getHeight());
                this.f29023n = 0.0f;
                this.f29024r = min;
            } else {
                if (q1Var.f11223f) {
                ...
                this.f29023n = Math.max(Math.max(0.0f, na0Var.getTranslationY() + i10) - this.f29025s, this.M * getHeight());
                this.f29024r = getMeasuredHeight();
            }
            dh.d dVar = this.R;
            if (dVar != null) {
                dVar.setBounds(0, ((int) this.f29023n) - AndroidUtilities.dp(5.0f), getMeasuredWidth(), AndroidUtilities.dp(5.0f) + ((int) this.f29024r));
                Path path = this.S;
                path.rewind();
                Rect rect = this.R.h.f6828m;
                RectF rectF = this.T;
                rectF.set(rect);
                if (na0Var != null && (ha0Var = this.d) != null && na0Var.getLayoutManager() == ha0Var && (k1Var = this.f29022f) != null && k1Var.R != null) {
    ...
    public final float d() {
        ...
        return getMeasuredHeight() - this.f29023n;
    }

    @Override
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.emojiLoaded) {
            AndroidUtilities.forEachViews((RecyclerView) this.f29019b, (e2.h) new bi.f(24));
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        boolean g10 = g();
        hg.k1 k1Var = this.f29022f;
        if ((k1Var.N() || k1Var.R != null) && ((k1Var.f11158x0 || k1Var.A0 != null) && k1Var.I() == null && k1Var.U == null)) {
            i10 = 2;
        } else {
            i10 = 0;
        }
        this.f29025s = AndroidUtilities.dp(i10 + 2);
        canvas.save();
        float dp = AndroidUtilities.dp(6.0f);
        float f7 = this.f29023n;
        hg.q1 q1Var = this.f29021e;
        na0 na0Var = this.f29019b;
        Rect rect = this.f29028y;
        if (g10) {
            if (q1Var.f11223f) {
                height = q1Var.f11222e.getTop();
            } else {
            ...
            float min2 = Math.min(Math.max(0.0f, na0Var.getTranslationY() + height) + this.f29025s, (1.0f - this.M) * getHeight());
            this.f29023n = 0.0f;
            int measuredWidth = getMeasuredWidth();
            this.f29024r = min2;
            rect.set(0, (int) 0.0f, measuredWidth, (int) min2);
            min = Math.min(dp, Math.abs(getMeasuredHeight() - this.f29024r));
            if (min > 0.0f) {
            ...
            if (na0Var.getLayoutManager() == this.d) {
                this.f29025s += AndroidUtilities.dp(2.0f);
            ...
            float max = Math.max(0.0f, na0Var.getTranslationY() + i11) - this.f29025s;
            this.f29023n = max;
            float max2 = Math.max(max, this.M * getHeight());
            this.f29023n = max2;
            int measuredWidth2 = getMeasuredWidth();
            float measuredHeight = getMeasuredHeight();
            this.f29024r = measuredHeight;
            rect.set(0, (int) max2, measuredWidth2, (int) measuredHeight);
            min = Math.min(dp, Math.abs(this.f29023n));
            if (min > 0.0f) {
                canvas.clipRect(0, 0, getWidth(), getHeight());
                rect.bottom += (int) min;
            }
        }
        if (Math.abs(f7 - this.f29023n) > 0.1f) {
            i();
        }
        if (this.E == null) {
        ...
        if (num != null) {
            ...
            v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Sd, this.f29018a);
        }
        paint2.setColor(v02);
        f(canvas, rect, min);
    ...
    public final boolean g() {
        s4.o0 layoutManager = this.f29019b.getLayoutManager();
        hg.j0 j0Var = this.f29020c;
        if (layoutManager == j0Var && j0Var.f45732t) {
            return true;
        }
        return false;
    }
