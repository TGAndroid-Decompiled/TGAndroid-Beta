...
public abstract class oa0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void b() {
        ...
        hg.k1 k1Var;
        int height;
        na0 na0Var = this.f29046b;
        if (na0Var != null && this.f29047c != null) {
            boolean g10 = g();
            this.f29052s = 0.0f;
            hg.q1 q1Var = this.f29048e;
            if (g10) {
                if (q1Var.f11249f) {
                    height = q1Var.f11248e.getTop();
                } else {
                    height = getHeight();
                }
                float min = Math.min(Math.max(0.0f, na0Var.getTranslationY() + height) + this.f29052s, (1.0f - this.M) * getHeight());
                this.f29050n = 0.0f;
                this.f29051r = min;
            } else {
                if (q1Var.f11249f) {
                    i10 = q1Var.f11248e.getBottom();
                } else {
                    i10 = 0;
                }
                this.f29050n = Math.max(Math.max(0.0f, na0Var.getTranslationY() + i10) - this.f29052s, this.M * getHeight());
                this.f29051r = getMeasuredHeight();
            }
            dh.d dVar = this.R;
            if (dVar != null) {
                dVar.setBounds(0, ((int) this.f29050n) - AndroidUtilities.dp(5.0f), getMeasuredWidth(), AndroidUtilities.dp(5.0f) + ((int) this.f29051r));
                Path path = this.S;
                path.rewind();
                Rect rect = this.R.h.f6856m;
                RectF rectF = this.T;
                rectF.set(rect);
                if (na0Var != null && (ha0Var = this.d) != null && na0Var.getLayoutManager() == ha0Var && (k1Var = this.f29049f) != null && k1Var.R != null) {
    ...
    public final float d() {
        ...
        return getMeasuredHeight() - this.f29050n;
    }

    @Override
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.emojiLoaded) {
            AndroidUtilities.forEachViews((RecyclerView) this.f29046b, (e2.h) new bi.f(24));
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        boolean g10 = g();
        hg.k1 k1Var = this.f29049f;
        if ((k1Var.N() || k1Var.R != null) && ((k1Var.f11184x0 || k1Var.A0 != null) && k1Var.I() == null && k1Var.U == null)) {
            i10 = 2;
        } else {
            i10 = 0;
        }
        this.f29052s = AndroidUtilities.dp(i10 + 2);
        canvas.save();
        float dp = AndroidUtilities.dp(6.0f);
        float f7 = this.f29050n;
        hg.q1 q1Var = this.f29048e;
        na0 na0Var = this.f29046b;
        Rect rect = this.f29055y;
        if (g10) {
            if (q1Var.f11249f) {
                height = q1Var.f11248e.getTop();
            } else {
            ...
            float min2 = Math.min(Math.max(0.0f, na0Var.getTranslationY() + height) + this.f29052s, (1.0f - this.M) * getHeight());
            this.f29050n = 0.0f;
            int measuredWidth = getMeasuredWidth();
            this.f29051r = min2;
            rect.set(0, (int) 0.0f, measuredWidth, (int) min2);
            min = Math.min(dp, Math.abs(getMeasuredHeight() - this.f29051r));
            if (min > 0.0f) {
            ...
            if (na0Var.getLayoutManager() == this.d) {
                this.f29052s += AndroidUtilities.dp(2.0f);
                dp += AndroidUtilities.dp(2.0f);
            }
            if (q1Var.f11249f) {
                i11 = q1Var.f11248e.getBottom();
            } else {
                i11 = 0;
            }
            float max = Math.max(0.0f, na0Var.getTranslationY() + i11) - this.f29052s;
            this.f29050n = max;
            float max2 = Math.max(max, this.M * getHeight());
            this.f29050n = max2;
            int measuredWidth2 = getMeasuredWidth();
            float measuredHeight = getMeasuredHeight();
            this.f29051r = measuredHeight;
            rect.set(0, (int) max2, measuredWidth2, (int) measuredHeight);
            min = Math.min(dp, Math.abs(this.f29050n));
            if (min > 0.0f) {
                canvas.clipRect(0, 0, getWidth(), getHeight());
                rect.bottom += (int) min;
            }
        }
        if (Math.abs(f7 - this.f29050n) > 0.1f) {
            i();
        }
        if (this.E == null) {
    ...
    public final boolean g() {
        ...
        hg.j0 j0Var = this.f29047c;
        if (layoutManager == j0Var && j0Var.f45760t) {
            return true;
        }
        return false;
    }
    ...
    public s4.c0 getNeededLayoutManager() {
        hg.k1 k1Var = this.f29049f;
        if ((!k1Var.N() && k1Var.R == null) || (!k1Var.f11184x0 && k1Var.A0 == null)) {
            return this.f29047c;
        }
        return this.d;
    }
