...
public final class mn0 implements jl0 {
    public final int f26430a;
    public final int f26431b;
    public final org.telegram.ui.ActionBar.n2 f26432c;
    public final Object d;

    public mn0(Object obj, int i10, org.telegram.ui.ActionBar.n2 n2Var, int i11) {
        this.f26430a = i11;
        this.d = obj;
        this.f26431b = i10;
        this.f26432c = n2Var;
        ...
        switch (this.f26430a) {
            case 0:
                ...
                if (i10 >= 0 && i10 < arrayList.size()) {
                    if (!UserConfig.getInstance(this.f26431b).isPremium()) {
                        new rg.x0(this.f26432c, 24, true).show();
                        return;
                    }
                    long j3 = ((rn0) arrayList.get(i10)).f27928a.h;
                    if (un0Var.h == j3) {
                        o0Var = null;
                    } else {
                        o0Var = ((rn0) arrayList.get(i10)).f27928a;
                    }
                    if (un0Var.f(o0Var)) {
            ...
            default:
                ...
                if (view instanceof org.telegram.ui.uw0) {
                    ...
                    PremiumPreviewFragment.q0(this.f26431b, uw0Var.f38225f.f35260a);
                    k1Var.showDialog(new rg.x0(this.f26432c, uw0Var.f38225f.f35260a, false));
                    return;
                }
                return;
        }
