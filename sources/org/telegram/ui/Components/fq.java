...
public final class fq extends p6 {
    public final Rect f24304s;
    public Drawable v;
    public boolean f24305w;

    public fq(Context context) {
        super(context, false, false, false);
        this.f24304s = new Rect();
    }
    ...
    public final void onDraw(Canvas canvas) {
        if (this.v != null) {
            ...
            Rect rect = this.f24304s;
            rect.set(bounds);
            int ceil = (int) Math.ceil(getDrawable().d());
            if (getDrawable().f26962b == 3) {
                rect.right = rect.left + ceil;
            } else if (getDrawable().f26962b == 5) {
                rect.left = rect.right - ceil;
            } else if (getDrawable().f26962b == 17) {
