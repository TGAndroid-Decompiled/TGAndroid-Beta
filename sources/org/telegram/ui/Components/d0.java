...
public final class d0 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.d6 f23443b;
    public final b0 f23444c;
    public int d;
    public boolean e;
    public int f23445f;
    public final e6 h;
    public ci.o5 f23446n;
    ...
    public final void a(int i10, String str, Utilities.Callback callback) {
        ...
        c0Var.f23160c = this.d;
        c0Var.e();
        c0Var.f23161f = false;
        c0Var.h.setImageResource(i10);
        c0Var.f23162n.setText(str);
    ...
    public final void b(TL_aicompose.AiComposeTone aiComposeTone, Utilities.Callback callback) {
        ...
        c0Var.e();
        int i11 = 0;
        TextView textView = c0Var.f23162n;
        w9 w9Var = c0Var.h;
        ...
        if (i10 >= 0 && i10 < b0Var.getChildCount()) {
            ...
            if (childAt instanceof c0) {
                ...
                if (w9Var.getAnimatedEmojiDrawable() != null) {
                    ai.l4 l4Var = w9Var.getAnimatedEmojiDrawable().f27588k;
                    if (l4Var != null) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.e) {
            Paint T0 = org.telegram.ui.ActionBar.h6.T0("paintDivider", this.f23443b);
            if (T0 == null) {
