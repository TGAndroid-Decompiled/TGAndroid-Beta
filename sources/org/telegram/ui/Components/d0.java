...
public final class d0 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.e6 f23171b;
    public final b0 f23172c;
    public int d;
    public boolean e;
    public int f23173f;
    public final c6 h;
    public ci.p5 f23174n;
    ...
    public final void a(int i10, String str, Utilities.Callback callback) {
        ...
        c0Var.f22899c = this.d;
        c0Var.e();
        c0Var.f22900f = false;
        c0Var.h.setImageResource(i10);
        c0Var.f22901n.setText(str);
    ...
    public final void b(TL_aicompose.AiComposeTone aiComposeTone, Utilities.Callback callback) {
        ...
        c0Var.e();
        int i11 = 0;
        TextView textView = c0Var.f22901n;
        u9 u9Var = c0Var.h;
        ...
        if (i10 >= 0 && i10 < b0Var.getChildCount()) {
            ...
            if (childAt instanceof c0) {
                ...
                if (u9Var.getAnimatedEmojiDrawable() != null) {
                    ai.l4 l4Var = u9Var.getAnimatedEmojiDrawable().f26692k;
                    if (l4Var != null) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.e) {
            Paint T0 = org.telegram.ui.ActionBar.i6.T0("paintDivider", this.f23171b);
            if (T0 == null) {
