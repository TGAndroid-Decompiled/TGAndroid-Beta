...
public final class d0 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.d6 f23422b;
    public final b0 f23423c;
    public int d;
    public boolean e;
    public int f23424f;
    public final e6 h;
    public ci.o5 f23425n;
    ...
    public final void a(int i10, String str, Utilities.Callback callback) {
        b0 b0Var = this.f23423c;
        int childCount = b0Var.getChildCount();
        c0 c0Var = new c0(getContext(), this.f23421a, this.f23422b);
        c0Var.f23133c = this.d;
        c0Var.e();
        c0Var.f23134f = false;
        c0Var.h.setImageResource(i10);
        c0Var.f23135n.setText(str);
    ...
    public final void b(TL_aicompose.AiComposeTone aiComposeTone, Utilities.Callback callback) {
        ...
        c0Var.e();
        int i11 = 0;
        TextView textView = c0Var.f23135n;
        w9 w9Var = c0Var.h;
        ...
        if (i10 >= 0 && i10 < b0Var.getChildCount()) {
            ...
            if (childAt instanceof c0) {
                ...
                if (w9Var.getAnimatedEmojiDrawable() != null) {
                    ai.l4 l4Var = w9Var.getAnimatedEmojiDrawable().f27504k;
                    if (l4Var != null) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.e) {
            Paint T0 = org.telegram.ui.ActionBar.h6.T0("paintDivider", this.f23422b);
            if (T0 == null) {
    ...
    public TL_aicompose.AiComposeTone getSelectedTone() {
        ...
        if (i10 >= 0) {
            b0 b0Var = this.f23423c;
            if (i10 < b0Var.getChildCount()) {
                View childAt = b0Var.getChildAt(this.f23424f);
                if (childAt instanceof c0) {
                    return ((c0) childAt).e;
                }
                return null;
    ...
    public final void setPadding(int i10, int i11, int i12, int i13) {
        this.f23423c.setPadding(i10, i11, i12, i13);
    }
