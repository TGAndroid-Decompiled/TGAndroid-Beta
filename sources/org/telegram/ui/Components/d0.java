...
public final class d0 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.d6 f23414b;
    public final b0 f23415c;
    public int d;
    public boolean e;
    public int f23416f;
    public final e6 h;
    public ci.o5 f23417n;
    ...
    public final void a(int i10, String str, Utilities.Callback callback) {
        b0 b0Var = this.f23415c;
        int childCount = b0Var.getChildCount();
        c0 c0Var = new c0(getContext(), this.f23413a, this.f23414b);
        c0Var.f23104c = this.d;
        c0Var.e();
        c0Var.f23105f = false;
        c0Var.h.setImageResource(i10);
        c0Var.f23106n.setText(str);
    ...
    public final void b(TL_aicompose.AiComposeTone aiComposeTone, Utilities.Callback callback) {
        ...
        c0Var.e();
        int i11 = 0;
        TextView textView = c0Var.f23106n;
        w9 w9Var = c0Var.h;
        ...
        if (i10 >= 0 && i10 < b0Var.getChildCount()) {
            ...
            if (childAt instanceof c0) {
                ...
                if (w9Var.getAnimatedEmojiDrawable() != null) {
                    ai.l4 l4Var = w9Var.getAnimatedEmojiDrawable().f27498k;
                    if (l4Var != null) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.e) {
            Paint T0 = org.telegram.ui.ActionBar.h6.T0("paintDivider", this.f23414b);
            if (T0 == null) {
    ...
    public TL_aicompose.AiComposeTone getSelectedTone() {
        ...
        if (i10 >= 0) {
            b0 b0Var = this.f23415c;
            if (i10 < b0Var.getChildCount()) {
                View childAt = b0Var.getChildAt(this.f23416f);
                if (childAt instanceof c0) {
                    return ((c0) childAt).e;
                }
                return null;
    ...
    public final void setPadding(int i10, int i11, int i12, int i13) {
        this.f23415c.setPadding(i10, i11, i12, i13);
    }
