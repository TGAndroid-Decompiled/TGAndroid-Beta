        ...
        switch (i11) {
            ...
            case 1:
                ...
                if (textView2 != null && textView2.getVisibility() == 0 && textView2.isEnabled()) {
                    ...
                    return;
                } else if (p0Var != null && p0Var.getVisibility() == 0 && p0Var.f42453r.isEnabled()) {
                    p0Var.performClick();
                    return;
                } else {
                    return;
            ...
            case 2:
                kz kzVar2 = ayVar.E;
                ArrayList arrayList2 = kzVar2.f25755p1;
                wx wxVar2 = ayVar.f22512s;
                if (wxVar2 != null && (stickerSet2 = wxVar2.f29762b) != null) {
                    wxVar2.f29764f = true;
                    sx sxVar = kzVar2.R;
                    int i12 = kzVar2.f25716c1;
                    ArrayList arrayList3 = kzVar2.f25758q1;
                    vx vxVar = kzVar2.P;
                    if (!arrayList2.contains(Long.valueOf(stickerSet2.f18148id))) {
                        arrayList2.add(Long.valueOf(ayVar.f22512s.f29762b.f18148id));
                    }
                    ayVar.a(true);
                    int i13 = 0;
                    while (true) {
                        if (i13 < vxVar.getChildCount()) {
                            if ((vxVar.getChildAt(i13) instanceof yx) && (S = RecyclerView.S((view2 = vxVar.getChildAt(i13)))) >= 0 && (i10 = sxVar.f27950w.get(S)) >= 0 && i10 < arrayList3.size() && arrayList3.get(i10) != null && ayVar.f22512s != null && ((wx) arrayList3.get(i10)).f29762b.f18148id == ayVar.f22512s.f29762b.f18148id) {
                    ...
                    if (ayVar.f22510n == null) {
                        ...
                        TLRPC.StickerSet stickerSet4 = ayVar.f22512s.f29762b;
            ...
            case 3:
                ...
                if (wxVar3 != null && (stickerSet3 = wxVar3.f29762b) != null) {
                    wxVar3.f29764f = false;
                    ArrayList arrayList4 = kzVar3.f25755p1;
                    int i14 = kzVar3.f25716c1;
                    ...
                    if (ayVar.f22511r == null) {
                        ...
                        TLRPC.StickerSet stickerSet6 = ayVar.f22512s.f29762b;
