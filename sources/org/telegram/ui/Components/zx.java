...
public final class zx implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        ay ayVar = this.f30683b;
        switch (i11) {
            case 0:
                wx wxVar = ayVar.f22509s;
            ...
            case 1:
                rg.p0 p0Var = ayVar.h;
                TextView textView = ayVar.f22506f;
                ...
                if (textView2 != null && textView2.getVisibility() == 0 && textView2.isEnabled()) {
                    ...
                    return;
                } else if (p0Var != null && p0Var.getVisibility() == 0 && p0Var.f42448r.isEnabled()) {
                    p0Var.performClick();
                    return;
                } else {
                    return;
            ...
            case 2:
                kz kzVar2 = ayVar.E;
                ArrayList arrayList2 = kzVar2.f25752p1;
                wx wxVar2 = ayVar.f22509s;
                if (wxVar2 != null && (stickerSet2 = wxVar2.f29759b) != null) {
                    wxVar2.f29761f = true;
                    sx sxVar = kzVar2.R;
                    int i12 = kzVar2.f25713c1;
                    ArrayList arrayList3 = kzVar2.f25755q1;
                    vx vxVar = kzVar2.P;
                    if (!arrayList2.contains(Long.valueOf(stickerSet2.f18148id))) {
                        arrayList2.add(Long.valueOf(ayVar.f22509s.f29759b.f18148id));
                    }
                    ayVar.a(true);
                    int i13 = 0;
                    while (true) {
                        if (i13 < vxVar.getChildCount()) {
                            if ((vxVar.getChildAt(i13) instanceof yx) && (S = RecyclerView.S((view2 = vxVar.getChildAt(i13)))) >= 0 && (i10 = sxVar.f27947w.get(S)) >= 0 && i10 < arrayList3.size() && arrayList3.get(i10) != null && ayVar.f22509s != null && ((wx) arrayList3.get(i10)).f29759b.f18148id == ayVar.f22509s.f29759b.f18148id) {
                    ...
                    if (ayVar.f22507n == null) {
                        TLRPC.TL_inputStickerSetID tL_inputStickerSetID2 = new TLRPC.TL_inputStickerSetID();
                        TLRPC.StickerSet stickerSet4 = ayVar.f22509s.f29759b;
                        tL_inputStickerSetID2.f18141id = stickerSet4.f18148id;
                        ...
                        ayVar.f22507n = tL_inputStickerSetID2;
            ...
            case 3:
                kz kzVar3 = ayVar.E;
                wx wxVar3 = ayVar.f22509s;
                if (wxVar3 != null && (stickerSet3 = wxVar3.f29759b) != null) {
                    wxVar3.f29761f = false;
                    ArrayList arrayList4 = kzVar3.f25752p1;
                    int i14 = kzVar3.f25713c1;
                    arrayList4.remove(Long.valueOf(stickerSet3.f18148id));
                    ayVar.a(true);
                    nx nxVar = kzVar3.I;
                    if (nxVar != null) {
                    ...
                    if (ayVar.f22508r == null) {
                        TLRPC.TL_inputStickerSetID tL_inputStickerSetID3 = new TLRPC.TL_inputStickerSetID();
                        TLRPC.StickerSet stickerSet6 = ayVar.f22509s.f29759b;
                        tL_inputStickerSetID3.f18141id = stickerSet6.f18148id;
                        ...
                        ayVar.f22508r = tL_inputStickerSetID3;
