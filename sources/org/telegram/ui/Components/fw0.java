...
public final class fw0 extends View {
    ...
    public final dw0 f24319a;
    public final Paint f24320b;
    public final Paint f24321c;
    ...
    public int f24325s;
    public boolean v;
    public boolean f24326w;
    public float f24327x;
    public float f24328y;

    public fw0(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f24325s = -1;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            Paint paint = this.f24320b;
            if (i13 < length) {
                int i14 = this.f24323n;
                int i15 = (this.h * 2) + this.f24324r;
                int i16 = this.f24322f;
                ...
                paint.setColor(d11);
                Paint paint2 = this.f24321c;
                paint2.setColor(d11);
                float f16 = dp3;
                canvas2.drawCircle(i17, f16, AndroidUtilities.lerp(this.f24322f / 2, AndroidUtilities.dp(6.0f), max), paint);
                if (i13 != 0) {
                    int i19 = (i17 - (this.f24322f / 2)) - this.h;
                    int i20 = this.f24324r;
                    int i21 = i19 - i20;
                    int i22 = this.f24325s;
                    if (i22 != -1 && i13 - 1 >= i22) {
                        ...
                        if (this.e != dp5) {
                            i11 = dp4;
                            i10 = i17;
                            paint2.setPathEffect(new DashPathEffect(new float[]{AndroidUtilities.dp(6.0f), org.telegram.messenger.ok.B(8.0f, dp5, dp2) / ((float) (dp5 - 1))}, 0.0f));
                            this.e = dp5;
                        } else {
                            i11 = dp4;
                            i10 = i17;
                ...
                int i24 = (this.h * 2) + this.f24324r;
                int i25 = this.f24322f;
                float f18 = ((i24 + i25) * d) + this.f24323n + (i25 / 2);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        this.f24319a.e(this, accessibilityNodeInfo);
    }

    @Override
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(74.0f), 1073741824));
        this.f24322f = AndroidUtilities.dp(6.0f);
        this.h = AndroidUtilities.dp(2.0f);
        this.f24323n = AndroidUtilities.dp(22.0f);
        int measuredWidth = getMeasuredWidth();
        int i12 = this.f24322f;
        String[] strArr = this.F;
        this.f24324r = (((measuredWidth - (i12 * strArr.length)) - ((strArr.length - 1) * (this.h * 2))) - (this.f24323n * 2)) / Math.max(1, strArr.length - 1);
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        float a2 = w7.q.a(((this.f24322f / 2.0f) + (x10 - this.f24323n)) / (((this.h * 2) + this.f24324r) + i10), 0.0f, this.F.length - 1);
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (!this.v && Math.abs(this.f24327x - x10) > Math.abs(this.f24328y - y3)) {
                getParent().requestDisallowInterceptTouchEvent(true);
            }
            if (this.f24326w && Math.abs(this.f24327x - x10) >= AndroidUtilities.touchSlop) {
                this.v = true;
                this.f24326w = false;
            }
            if (this.v) {
    ...
    public final boolean performAccessibilityAction(int i10, Bundle bundle) {
        if (!super.performAccessibilityAction(i10, bundle) && !this.f24319a.g(this, i10, bundle)) {
            return false;
        }
        return true;
    }
