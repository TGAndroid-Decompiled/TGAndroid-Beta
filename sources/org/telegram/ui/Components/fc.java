...
public final class fc extends GestureDetector.SimpleOnGestureListener {
    public final ub f26037a;
    public final ib f26038b;
    ...
    public final boolean onDown(MotionEvent motionEvent) {
        ib ibVar = this.f26038b;
        if (ibVar.f27093s) {
            return false;
        }
        ub ubVar = this.f26037a;
        ibVar.v = ub.access$1400(ubVar, true);
        ibVar.f27094w = ub.access$1400(ubVar, false);
        return true;
    }
    ...
    public final boolean onFling(MotionEvent motionEvent, MotionEvent motionEvent2, float f7, float f10) {
        ...
        ib ibVar = this.f26038b;
        if ((f7 < 0.0f && ibVar.v) || (f7 > 0.0f && ibVar.f27094w)) {
            z10 = true;
        }
        ...
        if (!z10) {
            kVar.a(new o1.f(this) {
                ...
                public final void a(o1.h hVar, boolean z11, float f11, float f12) {
                    switch (r2) {
                        case 0:
                            this.f25366b.f26038b.f27096y.b();
                            return;
                        default:
                            this.f25366b.f26038b.f27096y.b();
                            return;
    ...
    public final boolean onScroll(MotionEvent motionEvent, MotionEvent motionEvent2, float f7, float f10) {
        ...
        float f13 = ibVar.f27090f - f7;
        ibVar.f27090f = f13;
        ub ubVar = this.f26037a;
        ubVar.setTranslationX(f13);
        float f14 = ibVar.f27090f;
        if (f14 == 0.0f || ((f14 < 0.0f && ibVar.v) || (f14 > 0.0f && ibVar.f27094w))) {
