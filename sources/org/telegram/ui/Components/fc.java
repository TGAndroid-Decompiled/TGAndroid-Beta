...
public final class fc extends eb {
    public final kj0 f26860a;
    public final g90 f26861b;
    public final g90 f26862c;
    ...
    public final void c(int i10, int i11, int i12, String... strArr) {
        kj0 kj0Var = this.f26860a;
        kj0Var.f(i10, i11, i12, null);
        for (String str : strArr) {
            kj0Var.h(this.f26863e, str);
        }
    }

    @Override
    public CharSequence getAccessibilityText() {
        return ((Object) this.f26861b.getText()) + ".\n" + ((Object) this.f26862c.getText());
    }
