...
public final class r20 extends f2.q {
    ...
    public final boolean b(int i10, int i11) {
        ...
        ArrayList arrayList2 = this.f28384c;
        if (size3 >= 0 && size3 < u20Var.f29085f.size() && size2 >= 0 && size2 < arrayList2.size()) {
            if (MessageObject.getPeerId(((TLRPC.GroupCallParticipant) arrayList2.get(size2)).peer) != MessageObject.getPeerId(((TLRPC.GroupCallParticipant) u20Var.f29085f.get(size3)).peer)) {
                return false;
            }
            return true;
        }
        ...
        if (i11 < u20Var.e.size()) {
            ...
            groupCallParticipant2 = (TLRPC.GroupCallParticipant) u20Var.f29085f.get(size3);
        }
    ...
    public final int d() {
        u20 u20Var = this.d;
        return u20Var.f29085f.size() + u20Var.e.size();
    }

    @Override
    public final int e() {
        return this.f28384c.size() + this.f28383b.size();
    }
}
