...
public final class z extends sa {
    ...
    public final lp f31183a0;
    public final FrameLayout f31184b0;
    public final FrameLayout f31185c0;
    public final ph.d f31186d0;
    public Long f31187e0;
    public y f31188f0;
    public TL_aicompose.TL_aiComposeTone f31189g0;
    public e f31190h0;
    public e f31191i0;
    public w51 f31192j0;
    ...
    public z(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    ...
                    case 1:
                        ...
                        return;
                    default:
                        lp lpVar = this.f28570b.f31183a0;
        ...
        this.V = frameLayout2;
        frameLayout2.setBackground(org.telegram.ui.ActionBar.j6.K(AndroidUtilities.dp(100.0f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19906d6, f6Var)));
        ...
        this.X = i3Var;
        i3Var.f21199b.addTextChangedListener(new v(this, 0));
        ...
        i3Var2.f21199b.addTextChangedListener(new v(this, 1));
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setPadding(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(12.0f), AndroidUtilities.dp(8.0f));
        linearLayout.setClipToPadding(false);
        linearLayout.setOrientation(0);
        linearLayout.setBackground(org.telegram.ui.ActionBar.j6.Y(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19996i6, f6Var), 24, 24));
        ...
        org.telegram.ui.b.l(org.telegram.ui.ActionBar.j6.f20139q5, f6Var, textView, 1, 14.0f);
            ...
            public final void onClick(View view) {
                switch (r2) {
                    ...
                    case 1:
                        ...
                        return;
                    default:
                        lp lpVar2 = this.f28570b.f31183a0;
    ...
    public static void P(z zVar, af.f fVar, org.telegram.ui.ActionBar.d2 d2Var) {
        ...
        d2Var.dismiss();
        zVar.dismiss();
        MessagesController.getInstance(zVar.currentAccount).getTonesController().remove(zVar.f31189g0);
    }
    ...
    public static void Q(final z zVar, final org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        lp lpVar = zVar.f31183a0;
        ph.d dVar = zVar.f31186d0;
        if (!dVar.K) {
            if (!dVar.T) {
                if (zVar.f31187e0 == null) {
                    zVar.V();
                    return;
                }
                return;
            ...
            if (zVar.f31189g0 != null) {
                TL_aicompose.updateTone updatetone = new TL_aicompose.updateTone();
                updatetone.flags = 1 | updatetone.flags;
                updatetone.display_author = lpVar.f26837a.f22965q;
                updatetone.tone = TL_aicompose.InputAiComposeTone.from(zVar.f31189g0);
                updatetone.flags |= 2;
                updatetone.emoji_id = zVar.f31187e0.longValue();
                updatetone.flags |= 4;
                ...
                ConnectionsManager.getInstance(zVar.currentAccount).sendRequestTyped(updatetone, new Object(), new Utilities.Callback2(zVar) {
                    ...
                    public final void run(Object obj, Object obj2) {
                        ...
                        switch (r3) {
                            case 0:
                                z zVar2 = this.f29080b;
                                zVar2.f31186d0.setLoading(false);
                                if (aiComposeTone != null) {
                                    e eVar = zVar2.f31191i0;
                                    if (eVar != null) {
                                    ...
                                    org.telegram.ui.yh.u(zVar2.f31185c0, f6Var, tL_error, false);
                                    return;
                                } else {
                                    return;
                                }
                            default:
                                z.R(this.f29080b, f6Var, aiComposeTone, tL_error);
                                return;
                        }
                    }
                });
            ...
            createtone.display_author = lpVar.f26837a.f22965q;
            createtone.emoji_id = zVar.f31187e0.longValue();
    ...
    public static void R(z zVar, org.telegram.ui.ActionBar.f6 f6Var, TL_aicompose.AiComposeTone aiComposeTone, TLRPC.TL_error tL_error) {
        FrameLayout frameLayout = zVar.f31185c0;
        zVar.f31186d0.setLoading(false);
        if (aiComposeTone != null) {
            zVar.dismiss();
            e eVar = zVar.f31190h0;
            if (eVar != null) {
                eVar.run(aiComposeTone);
            }
        } else if (tL_error != null) {
    ...
    public final void W() {
        boolean z4;
        if (this.f31187e0 != null && this.X.getText().length() > 0 && this.Y.getText().length() > 0) {
            z4 = true;
        } else {
            z4 = false;
        }
        this.f31186d0.setEnabled(z4);
    }

    public final void X() {
        Long l10 = this.f31187e0;
        p9 p9Var = this.W;
        if (l10 == null) {
        ...
        p9Var.setAnimatedEmojiDrawable(new l5(4, this.currentAccount, this.f31187e0.longValue()));
        p9Var.setColorFilter(null);
        p9Var.setEmojiColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20012j5, this.resourcesProvider), PorterDuff.Mode.SRC_IN));
    }

    @Override
    public final void onSmoothContainerViewLayout(float f10) {
        super.onSmoothContainerViewLayout(f10);
        this.f31184b0.setTranslationY(f10);
    }

    @Override
    public final rl0 v(sl0 sl0Var) {
        w51 w51Var = new w51(sl0Var, getContext(), this.currentAccount, 0, true, new d(this, 2), this.resourcesProvider);
        this.f31192j0 = w51Var;
