...
public final class z extends sa {
    ...
    public final np f33696a0;
    public final FrameLayout f33697b0;
    public final FrameLayout f33698c0;
    public final qh.d f33699d0;
    public Long f33700e0;
    public y f33701f0;
    public TL_aicompose.TL_aiComposeTone f33702g0;
    public e f33703h0;
    public e f33704i0;
    public w51 f33705j0;
    ...
    public z(Context context, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        imageView.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        this.f30935b.dismiss();
                        return;
                    case 1:
                        this.f30935b.V();
                        return;
                    default:
                        np npVar = this.f30935b.f33696a0;
        ...
        this.X = i3Var;
        i3Var.f22957b.addTextChangedListener(new v(this, 0));
        ...
        i3Var2.f22957b.addTextChangedListener(new v(this, 1));
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setPadding(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(12.0f), AndroidUtilities.dp(8.0f));
        linearLayout.setClipToPadding(false);
        linearLayout.setOrientation(0);
        linearLayout.setBackground(org.telegram.ui.ActionBar.k6.Y(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21752i6, g6Var), 24, 24));
        ...
        org.telegram.ui.b.l(org.telegram.ui.ActionBar.k6.f21895q5, g6Var, textView, 1, 14.0f);
            ...
            public final void onClick(View view) {
                switch (r2) {
                    ...
                    case 1:
                        ...
                        return;
                    default:
                        np npVar2 = this.f30935b.f33696a0;
                        npVar2.a(!npVar2.f29560a.f24811q, true);
                        return;
                }
            }
        });
    ...
    public static void P(z zVar, af.f fVar, org.telegram.ui.ActionBar.d2 d2Var) {
        ...
        d2Var.dismiss();
        zVar.dismiss();
        MessagesController.getInstance(zVar.currentAccount).getTonesController().remove(zVar.f33702g0);
    }
    ...
    public static void Q(final z zVar, final org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        np npVar = zVar.f33696a0;
        qh.d dVar = zVar.f33699d0;
        if (!dVar.K) {
            if (!dVar.T) {
                if (zVar.f33700e0 == null) {
                    zVar.V();
                    return;
                }
                return;
            ...
            if (zVar.f33702g0 != null) {
                TL_aicompose.updateTone updatetone = new TL_aicompose.updateTone();
                updatetone.flags = 1 | updatetone.flags;
                updatetone.display_author = npVar.f29560a.f24811q;
                updatetone.tone = TL_aicompose.InputAiComposeTone.from(zVar.f33702g0);
                updatetone.flags |= 2;
                updatetone.emoji_id = zVar.f33700e0.longValue();
                updatetone.flags |= 4;
                ...
                ConnectionsManager.getInstance(zVar.currentAccount).sendRequestTyped(updatetone, new Object(), new Utilities.Callback2(zVar) {
                    ...
                    public final void run(Object obj, Object obj2) {
                        ...
                        switch (r3) {
                            case 0:
                                z zVar2 = this.f31452b;
                                zVar2.f33699d0.setLoading(false);
                                if (aiComposeTone != null) {
                                    e eVar = zVar2.f33704i0;
                                    if (eVar != null) {
                                    ...
                                    org.telegram.ui.yh.u(zVar2.f33698c0, g6Var, tL_error, false);
                                    return;
                                } else {
                                    return;
                                }
                            default:
                                z.R(this.f31452b, g6Var, aiComposeTone, tL_error);
                                return;
                        }
                    }
                });
            ...
            createtone.display_author = npVar.f29560a.f24811q;
            createtone.emoji_id = zVar.f33700e0.longValue();
    ...
    public static void R(z zVar, org.telegram.ui.ActionBar.g6 g6Var, TL_aicompose.AiComposeTone aiComposeTone, TLRPC.TL_error tL_error) {
        FrameLayout frameLayout = zVar.f33698c0;
        zVar.f33699d0.setLoading(false);
        if (aiComposeTone != null) {
            zVar.dismiss();
            e eVar = zVar.f33703h0;
            if (eVar != null) {
                eVar.run(aiComposeTone);
            }
        } else if (tL_error != null) {
    ...
    public final void W() {
        boolean z4;
        if (this.f33700e0 != null && this.X.getText().length() > 0 && this.Y.getText().length() > 0) {
            z4 = true;
        } else {
            z4 = false;
        }
        this.f33699d0.setEnabled(z4);
    }

    public final void X() {
        Long l10 = this.f33700e0;
        p9 p9Var = this.W;
        if (l10 == null) {
        ...
        p9Var.setAnimatedEmojiDrawable(new l5(4, this.currentAccount, this.f33700e0.longValue()));
        p9Var.setColorFilter(null);
        p9Var.setEmojiColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21768j5, this.resourcesProvider), PorterDuff.Mode.SRC_IN));
    }

    @Override
    public final void onSmoothContainerViewLayout(float f10) {
        super.onSmoothContainerViewLayout(f10);
        this.f33697b0.setTranslationY(f10);
    }

    @Override
    public final rl0 v(sl0 sl0Var) {
        w51 w51Var = new w51(sl0Var, getContext(), this.currentAccount, 0, true, new d(this, 2), this.resourcesProvider);
        this.f33705j0 = w51Var;
