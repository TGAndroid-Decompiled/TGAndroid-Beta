...
public final class z extends bb {
    ...
    public final x9 Z;
    public final org.telegram.ui.Cells.i3 f33025a0;
    public final org.telegram.ui.Cells.i3 f33026b0;
    public final FrameLayout f33027c0;
    public final mp f33028d0;
    public final FrameLayout f33029e0;
    public final FrameLayout f33030f0;
    public final di.d f33031g0;
    public Long f33032h0;
    public y f33033i0;
    public TL_aicompose.TL_aiComposeTone f33034j0;
    public e f33035k0;
    public e f33036l0;
    public v51 m0;
    ...
    public z(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        imageView.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        this.f30131b.dismiss();
                        return;
                    case 1:
                        this.f30131b.V();
                        return;
                    default:
                        mp mpVar = this.f30131b.f33028d0;
        ...
        this.f33025a0 = i3Var;
        i3Var.f22074b.addTextChangedListener(new v(this, 0));
        ...
        i3Var2.f22074b.addTextChangedListener(new v(this, 1));
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setPadding(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(12.0f), AndroidUtilities.dp(8.0f));
        linearLayout.setClipToPadding(false);
        linearLayout.setOrientation(0);
        linearLayout.setBackground(org.telegram.ui.ActionBar.j6.Y(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20753i6, f6Var), 24, 24));
        ...
        org.telegram.messenger.wl.n(org.telegram.ui.ActionBar.j6.f20897q5, f6Var, textView, 1, 14.0f);
            ...
            public final void onClick(View view) {
                switch (r2) {
                    ...
                    case 1:
                        ...
                        return;
                    default:
                        mp mpVar2 = this.f30131b.f33028d0;
    ...
    public static void P(z zVar, of.e eVar, org.telegram.ui.ActionBar.b2 b2Var) {
        ...
        b2Var.dismiss();
        zVar.dismiss();
        MessagesController.getInstance(zVar.currentAccount).getTonesController().remove(zVar.f33034j0);
    }

    public static void Q(final z zVar, final org.telegram.ui.ActionBar.f6 f6Var) {
        org.telegram.ui.Cells.i3 i3Var = zVar.f33026b0;
        org.telegram.ui.Cells.i3 i3Var2 = zVar.f33025a0;
        mp mpVar = zVar.f33028d0;
        di.d dVar = zVar.f33031g0;
        if (!dVar.N) {
            if (!dVar.W) {
                if (zVar.f33032h0 == null) {
                    zVar.V();
                    return;
                }
                return;
            ...
            if (zVar.f33034j0 != null) {
                TL_aicompose.updateTone updatetone = new TL_aicompose.updateTone();
                updatetone.flags = 1 | updatetone.flags;
                updatetone.display_author = mpVar.f28477a.f23907q;
                updatetone.tone = TL_aicompose.InputAiComposeTone.from(zVar.f33034j0);
                updatetone.flags |= 2;
                updatetone.emoji_id = zVar.f33032h0.longValue();
                updatetone.flags |= 4;
                ...
                ConnectionsManager.getInstance(zVar.currentAccount).sendRequestTyped(updatetone, new Object(), new Utilities.Callback2(zVar) {
                    ...
                    public final void run(Object obj, Object obj2) {
                        ...
                        switch (r3) {
                            case 0:
                                z zVar2 = this.f30750b;
                                zVar2.f33031g0.setLoading(false);
                                if (aiComposeTone != null) {
                                    e eVar = zVar2.f33036l0;
                                    if (eVar != null) {
                                    ...
                                    org.telegram.ui.Cells.p6.q(zVar2.f33030f0, f6Var, tL_error, false);
                                    return;
                                } else {
                                    return;
                                }
                            default:
                                z.R(this.f30750b, f6Var, aiComposeTone, tL_error);
                                return;
                        }
                    }
                });
            ...
            createtone.display_author = mpVar.f28477a.f23907q;
            createtone.emoji_id = zVar.f33032h0.longValue();
    ...
    public static void R(z zVar, org.telegram.ui.ActionBar.f6 f6Var, TL_aicompose.AiComposeTone aiComposeTone, TLRPC.TL_error tL_error) {
        FrameLayout frameLayout = zVar.f33030f0;
        zVar.f33031g0.setLoading(false);
        if (aiComposeTone != null) {
            zVar.dismiss();
            e eVar = zVar.f33035k0;
            if (eVar != null) {
                eVar.run(aiComposeTone);
            }
        } else if (tL_error != null) {
    ...
    public static void S(z zVar, org.telegram.ui.ActionBar.b2 b2Var) {
        ...
        deletetone.tone = TL_aicompose.InputAiComposeTone.from(zVar.f33034j0);
    ...
    public final void W() {
        boolean z10;
        if (this.f33032h0 != null && this.f33025a0.getText().length() > 0 && this.f33026b0.getText().length() > 0) {
            z10 = true;
        } else {
            z10 = false;
        }
        this.f33031g0.setEnabled(z10);
    }

    public final void X() {
        Long l4 = this.f33032h0;
        x9 x9Var = this.Z;
        if (l4 == null) {
        ...
        x9Var.setAnimatedEmojiDrawable(new q5(4, this.currentAccount, this.f33032h0.longValue()));
        x9Var.setColorFilter(null);
        x9Var.setEmojiColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20770j5, this.resourcesProvider), PorterDuff.Mode.SRC_IN));
    }

    @Override
    public final void onSmoothContainerViewLayout(float f7) {
        super.onSmoothContainerViewLayout(f7);
        this.f33029e0.setTranslationY(f7);
    }
