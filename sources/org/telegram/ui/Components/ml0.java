...
public class ml0 extends RecyclerView implements bh.a {
    ...
    public boolean Z0;
    public int Z1;
    public s4.s0 f26193a1;
    public int a2;
    public zk0 f26194b1;
    public int f26195b2;
    public View f26196c1;
    public int f26197c2;
    public ai.f0 f26198d1;
    public boolean f26199d2;
    public el0 f26200e1;
    public boolean f26201e2;
    public tk0 f26202f1;
    public int f26203f2;
    public il0 f26204g1;
    public int f26205g2;
    public boolean f26206h1;
    public org.telegram.ui.ni f26207h2;
    public boolean f26208i1;
    public boolean f26209i2;
    public boolean f26210j1;
    public boolean f26211j2;
    public boolean f26212k1;
    public float f26213k2;
    public Drawable l1;
    public float f26214l2;
    public float f26215m1;
    public int[] f26216m2;
    public float f26217n1;
    public rk0 f26218n2;
    public long f26219o1;
    public q0.a f26220o2;
    public ArrayList f26221p1;
    public final org.telegram.ui.ActionBar.d6 f26222p2;
    public ArrayList f26223q1;
    public boolean f26224q2;
    public View f26225r1;
    public final pe f26226r2;
    public int f26227s1;
    public boolean f26228s2;
    public int f26229t1;
    public final gg.p1 f26230t2;
    public int f26231u1;
    public Paint f26232u2;
    public int f26233v1;
    public boolean f26234v2;
    public int f26235w1;
    public GenericProvider f26236w2;
    public boolean f26237x1;
    public int f26238x2;
    public int f26239y1;
    public int f26240y2;
    public boolean f26241z1;
    public boolean f26242z2;
    ...
    public static void O0(Canvas canvas, RectF rectF, float f7, float f10, float f11, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        paint.setColor(org.telegram.ui.ActionBar.h6.l1(f11, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18789d6, d6Var)));
        if (f7 == f10) {
    ...
    public final void C0(Runnable runnable) {
        this.E2.f27129b.add(new mt(runnable, 1));
    }

    public final void D0(ClippingImageView clippingImageView, FrameLayout.LayoutParams layoutParams) {
        if (this.f26198d1 == null) {
            this.f26198d1 = new ai.f0(this, getContext(), 16);
        }
        this.f26198d1.addView(clippingImageView, layoutParams);
    }
    ...
    public final void K0(boolean z10) {
        ...
        if (!this.f26208i1) {
            int i11 = 0;
            if (getAdapter() != null && this.f26196c1 != null) {
                boolean S0 = S0();
                if (S0) {
                    i10 = 0;
                } else {
                ...
                if ((this.Y1 && SharedConfig.animationsEnabled()) ? false : false) {
                    if (this.A2 != i10) {
                        this.A2 = i10;
                        if (i10 == 0) {
                            this.f26196c1.animate().setListener(null).cancel();
                            if (this.f26196c1.getVisibility() == 8) {
                                this.f26196c1.setVisibility(0);
                                this.f26196c1.setAlpha(0.0f);
                                if (this.Z1 == 1) {
                                    this.f26196c1.setScaleX(0.7f);
                                    this.f26196c1.setScaleY(0.7f);
                                }
                            }
                            this.f26196c1.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setDuration(150L).start();
                        } else if (this.f26196c1.getVisibility() != 8) {
                            ViewPropertyAnimator alpha = this.f26196c1.animate().alpha(0.0f);
                            if (this.Z1 == 1) {
                    ...
                    this.A2 = i10;
                    this.f26196c1.setVisibility(i10);
                    this.f26196c1.setAlpha(1.0f);
                }
                if (this.A1) {
                    if (S0) {
                        i11 = 4;
    ...
    public final void L0(boolean z10) {
        ...
        int i11;
        int i12;
        if (((this.K1 || z10) && this.f26202f1 != null) || (this.f26239y1 != 0 && this.f26204g1 != null)) {
            s4.o0 layoutManager = getLayoutManager();
            if (layoutManager instanceof s4.c0) {
                s4.c0 c0Var = (s4.c0) layoutManager;
                if (c0Var.f42615o == 1) {
                    if (this.f26204g1 != null) {
                        if (this.f26239y1 == 1) {
                            paddingTop = 0;
                        } else {
                            paddingTop = getPaddingTop();
                        }
                        int i13 = this.f26239y1;
                        int i14 = Integer.MAX_VALUE;
                        if (i13 != 1 && i13 != 3) {
                            if (i13 == 2) {
                                this.f26217n1 = 0.0f;
                                if (this.f26204g1.h() != 0) {
                                    int childCount = getChildCount();
                                    View view2 = null;
                                    ...
                                    for (int i17 = 0; i17 < childCount; i17++) {
                                        ...
                                        if (bottom > this.f26235w1 + paddingTop) {
                                            if (bottom < i14) {
                                                view3 = childAt;
                                                i14 = bottom;
                                            }
                                            i16 = Math.max(i16, bottom);
                                            if (bottom >= AndroidUtilities.dp(32.0f) + this.f26235w1 + paddingTop && bottom < i15) {
                                                view2 = childAt;
                                                i15 = bottom;
                                            }
                                        }
                                    }
                                    if (view3 != null && (T3 = T(view3)) != null && (S = this.f26204g1.S((b10 = T3.b()))) >= 0) {
                                        if (this.f26227s1 != S || this.f26225r1 == null) {
                                            View view4 = this.f26225r1;
                                            if (view4 == null) {
                                                z12 = true;
                                            } else {
                                                z12 = false;
                                            }
                                            View T4 = this.f26204g1.T(S, view4);
                                            if (z12) {
                                                T0(T4, false);
                                            }
                                            this.f26225r1 = T4;
                                            ...
                                            View view5 = this.f26225r1;
                                            view5.layout(0, 0, view5.getMeasuredWidth(), this.f26225r1.getMeasuredHeight());
                                            this.f26227s1 = S;
                                        }
                                        if (this.f26225r1 != null && view2 != null && view2.getClass() != this.f26225r1.getClass()) {
                                            this.f26217n1 = 1.0f;
                                        }
                                        int M = this.f26204g1.M(S);
                                        int Q = this.f26204g1.Q(b10);
                                        ...
                                        if (Q == M - 1) {
                                            int height = this.f26225r1.getHeight();
                                            int height2 = view3.getHeight() + ((view3.getTop() - paddingTop) - this.f26235w1);
                                            if (height2 < height) {
                                                i12 = height2 - height;
                                            } else {
                                                i12 = paddingTop;
                                            ...
                                            if (i12 < 0) {
                                                this.f26225r1.setTag(Integer.valueOf(paddingTop + i11 + i12));
                                            } else {
                                                this.f26225r1.setTag(Integer.valueOf(paddingTop + i11));
                                            }
                                        } else {
                                            this.f26225r1.setTag(Integer.valueOf(paddingTop + i11));
                                        }
                        ...
                        for (int i20 = 0; i20 < childCount2; i20++) {
                            ...
                            if (bottom2 > this.f26235w1 + paddingTop) {
                                if (bottom2 < i14) {
                                    i14 = bottom2;
                                    view6 = childAt2;
                                }
                                i19 = Math.max(i19, bottom2);
                                if (bottom2 >= AndroidUtilities.dp(32.0f) + this.f26235w1 + paddingTop && bottom2 < i18) {
                                    i18 = bottom2;
                                }
                            }
                        }
                        if (view6 != null && (T = T(view6)) != null) {
                            ...
                            if ((this.K1 || z10) && (tk0Var2 = this.f26202f1) != null && !tk0Var2.f28236n && (getAdapter() instanceof uk0)) {
                                this.f26202f1.setProgress(Math.min(1.0f, b11 / ((this.f26204g1.h() - abs) + 1)));
                            }
                            this.f26223q1.addAll(this.f26221p1);
                            this.f26221p1.clear();
                            if (this.f26204g1.h() != 0) {
                                if (this.f26227s1 != b11 || this.f26229t1 != abs) {
                                    this.f26227s1 = b11;
                                    this.f26229t1 = abs;
                                    this.f26233v1 = 1;
                                    int S3 = this.f26204g1.S(b11);
                                    this.f26231u1 = S3;
                                    int M2 = (this.f26204g1.M(S3) + b11) - this.f26204g1.Q(b11);
                                    while (M2 < b11 + abs) {
                                        M2 += this.f26204g1.M(this.f26231u1 + this.f26233v1);
                                        this.f26233v1++;
                                    }
                                }
                                if (this.f26239y1 != 3) {
                                    int i21 = b11;
                                    for (int i22 = this.f26231u1; i22 < this.f26231u1 + this.f26233v1; i22++) {
                                        if (!this.f26223q1.isEmpty()) {
                                            view = (View) this.f26223q1.get(0);
                                            this.f26223q1.remove(0);
                                        } else {
                                            view = null;
                                        }
                                        if (view == null) {
                                        ...
                                        View T5 = this.f26204g1.T(i22, view);
                                        if (z11) {
                                            T0(T5, false);
                                        }
                                        this.f26221p1.add(T5);
                                        int M3 = this.f26204g1.M(i22);
                                        if (i22 == this.f26231u1) {
                                            int Q3 = this.f26204g1.Q(i21);
                                            if (Q3 == M3 - 1) {
                                            ...
                                            i21 = (M3 - this.f26204g1.Q(b11)) + i21;
                                        } else {
                    ...
                    if (L0 != -1) {
                        if ((this.K1 || z10) && (tk0Var = this.f26202f1) != null && !tk0Var.f28236n) {
                            s4.h0 adapter = getAdapter();
                            if (adapter instanceof uk0) {
                                uk0 uk0Var = (uk0) adapter;
                                float H = uk0Var.H(this);
                                this.f26202f1.setIsVisible(uk0Var.E(this));
                                this.f26202f1.setProgress(Math.min(1.0f, H));
                                this.f26202f1.a(false);
                            }
                        }
                    }
                }
    ...
    public final void M0(float f7, float f10) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (rectF.contains(min2, min)) {
                ...
                if (i11 != S) {
                    int i12 = this.f26203f2;
                    if (i11 <= i12 && S <= i12) {
                        z10 = false;
                    } else {
                        z10 = true;
                    }
                    org.telegram.ui.xn xnVar2 = this.f26207h2.d;
                    org.telegram.ui.km kmVar = xnVar2.A0;
                    ArrayList arrayList = xnVar2.f39563u6;
                    int i13 = S - kmVar.J;
                    if (i13 >= 0 && i13 < arrayList.size()) {
                        MessageObject messageObject = (MessageObject) arrayList.get(i13);
                        if (messageObject.contentType == 0 && messageObject.hasValidGroupId() && (groupedMessages = (MessageObject.GroupedMessages) xnVar2.f39602x6.f(messageObject.getGroupId())) != null) {
                            ...
                            S = arrayList.indexOf(arrayList2.get(size)) + xnVar2.A0.J;
                        }
                    }
                    if (z10) {
                        int i14 = this.f26205g2;
                        if (S > i14) {
                            if (!this.f26207h2.f35530a) {
                                for (int i15 = i14 + 1; i15 <= S; i15++) {
                                    if (i15 != this.f26203f2 && this.f26207h2.a(i15)) {
                                        this.f26207h2.b(i15, true, min2, min);
                                    }
                                }
                            }
                        } else {
                            while (i14 > S) {
                                if (i14 != this.f26203f2 && this.f26207h2.a(i14)) {
                                    this.f26207h2.b(i14, false, min2, min);
                                }
                                i14--;
                            }
                        }
                    } else {
                        int i16 = this.f26205g2;
                        if (S > i16) {
                            while (i16 < S) {
                                if (i16 != this.f26203f2 && this.f26207h2.a(i16)) {
                                    this.f26207h2.b(i16, false, min2, min);
                                }
                                i16++;
                            }
                        } else if (!this.f26207h2.f35530a) {
                            for (int i17 = i16 - 1; i17 >= S; i17--) {
                                if (i17 != this.f26203f2 && this.f26207h2.a(i17)) {
                                    this.f26207h2.b(i17, true, min2, min);
                                }
                            }
                        }
                    }
    ...
    public final void N0(Canvas canvas, View view) {
        boolean z10;
        boolean z11;
        if (view != null && ((Boolean) this.H2.f30306a.run(view)).booleanValue()) {
            ...
            if (R == -1) {
                ...
                View U0 = U0(R - 1);
                View U02 = U0(R + 1);
                if (U0 != null && ((Boolean) this.H2.f30306a.run(U0)).booleanValue()) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                if (U02 != null && ((Boolean) this.H2.f30306a.run(U02)).booleanValue()) {
                    z11 = true;
                } else {
                    z11 = false;
                }
    ...
    public final void P0(Canvas canvas, View view, View view2, boolean z10, boolean z11) {
        ...
        if (view != null && view2 != null) {
            float f11 = 0.0f;
            if (view2 instanceof l80) {
                f7 = ((l80) view2).getBottomInfoMargin();
            } else {
                f7 = 0.0f;
            }
            RectF rectF = AndroidUtilities.rectTmp;
    ...
    public final void Q0(android.graphics.Canvas r30) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.ml0.Q0(android.graphics.Canvas):void");
    }
    ...
    public final void R0(Canvas canvas) {
        ...
        if (!rect.isEmpty() && (zVar = this.D1) != null) {
            ...
            canvas.save();
            int i11 = this.I1;
            if ((i11 == -2 || i11 == this.E1) && (aVar = this.f26220o2) != null) {
                aVar.accept(canvas);
            }
            int i12 = this.I1;
    ...
    public final Drawable V0(View view, boolean z10) {
        boolean z11;
        boolean z12;
        if (view.getParent() == this && b1() && ((Boolean) this.H2.f30306a.run(view)).booleanValue()) {
            int R = RecyclerView.R(view);
            boolean z13 = true;
            if (R == -1) {
                z12 = false;
            ...
            if (z11 && z12 && !z10) {
                ...
                if (z11 && z13) {
                    return org.telegram.ui.ActionBar.h6.b0(0, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18789d6, this.f26222p2));
                }
                z12 = z13;
            }
            Path path = new Path();
    ...
    public Integer W0(int i10) {
        GenericProvider genericProvider = this.f26236w2;
    ...
    public final void c1() {
        if (!this.f26208i1) {
            ...
            View view = this.f26196c1;
            if (view != null && view.getVisibility() != 8) {
                this.f26196c1.setVisibility(8);
            }
        }
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        View view;
        float f7;
        rk0 rk0Var = this.f26218n2;
        if (rk0Var != null) {
            ml0 ml0Var = rk0Var.f27657a;
            if (rk0Var.d || rk0Var.e) {
                for (int i10 = 0; i10 < ml0Var.getChildCount(); i10++) {
                    View childAt = ml0Var.getChildAt(i10);
                    int R = RecyclerView.R(childAt);
                    if (R >= 0 && !rk0Var.f27659c.contains(childAt)) {
                        Float f10 = (Float) rk0Var.f27658b.get(R, null);
                        if (f10 == null) {
        ...
        ai.f0 f0Var = this.f26198d1;
        if (f0Var != null) {
            f0Var.draw(canvas);
        }
        if (!this.f26241z1) {
            int i11 = this.f26239y1;
            float f11 = 0.0f;
            if (i11 == 1) {
                if (this.f26204g1 != null && !this.f26221p1.isEmpty()) {
                    for (int i12 = 0; i12 < this.f26221p1.size(); i12++) {
                        View view2 = (View) this.f26221p1.get(i12);
            ...
            } else if (i11 == 2 && this.f26204g1 != null && (view = this.f26225r1) != null && view.getAlpha() != 0.0f) {
                int save2 = canvas.save();
                int intValue2 = ((Integer) this.f26225r1.getTag()).intValue();
                if (LocaleController.isRTL) {
                    f11 = getWidth() - this.f26225r1.getWidth();
                }
                canvas.translate(f11, intValue2);
                Drawable drawable = this.l1;
                if (drawable != null) {
                    drawable.setBounds(0, this.f26225r1.getMeasuredHeight(), getWidth(), this.l1.getIntrinsicHeight() + this.f26225r1.getMeasuredHeight());
                    this.l1.setAlpha((int) (this.f26215m1 * 255.0f));
                    this.l1.draw(canvas);
                    long elapsedRealtime = SystemClock.elapsedRealtime();
                    long min = Math.min(20L, elapsedRealtime - this.f26219o1);
                    this.f26219o1 = elapsedRealtime;
                    float f12 = this.f26215m1;
                    float f13 = this.f26217n1;
                    if (f12 < f13) {
                ...
                canvas.clipRect(0, 0, getWidth(), this.f26225r1.getMeasuredHeight());
                this.f26225r1.draw(canvas);
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            if (this.f26240y2 == 0 && this.f26242z2) {
                setOverScrollMode(0);
            }
            this.f26240y2++;
        } else if (action == 1 || action == 3) {
            int i10 = this.f26240y2 - 1;
            this.f26240y2 = i10;
            if (i10 == 0 && this.f26242z2) {
                setOverScrollMode(2);
            }
        }
        tk0 fastScroll = getFastScroll();
        if ((fastScroll != null && fastScroll.f28221a0 && fastScroll.f28234k0 && motionEvent.getActionMasked() != 1 && motionEvent.getActionMasked() != 3) || (this.f26204g1 != null && (view = this.f26225r1) != null && view.getAlpha() != 0.0f && this.f26225r1.dispatchTouchEvent(motionEvent))) {
            return true;
        }
    ...
    public final void f0(View view) {
        if (getAdapter() instanceof ll0) {
            ...
            if (G != null) {
                ...
                if (this.f26224q2) {
                    view.setAccessibilityDelegate(this.f26226r2);
                    return;
                }
                return;
            }
    ...
    public View getEmptyView() {
        return this.f26196c1;
    }

    public tk0 getFastScroll() {
        return this.f26202f1;
    }

    public ArrayList<View> getHeaders() {
        return this.f26221p1;
    }

    public ArrayList<View> getHeadersCache() {
        return this.f26223q1;
    }
    ...
    public final void i1(int i10, View view) {
        ...
        if (this.D1 != null) {
            ...
            } else if (this.f26195b2 > 0 && getAdapter() != null) {
                org.telegram.ui.Cells.z zVar = this.D1;
                if (i10 == 0) {
                    i11 = this.f26195b2;
                } else {
    ...
    public final void j1() {
        ...
        this.U1 = null;
        View view = this.F1;
        if (view != null && (i10 = this.f26238x2) != -1) {
            i1(i10, view);
            org.telegram.ui.Cells.z zVar = this.D1;
            if (zVar != null) {
    ...
    public void onAttachedToWindow() {
        ...
        tk0 tk0Var = this.f26202f1;
        if (tk0Var != null && tk0Var.getParent() != getParent()) {
            ViewGroup viewGroup = (ViewGroup) this.f26202f1.getParent();
            if (viewGroup != null) {
                viewGroup.removeView(this.f26202f1);
            }
            ((ViewGroup) getParent()).addView(this.f26202f1);
        }
    }
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (tk0Var != null) {
            ...
            int i15 = i11 + i14;
            tk0 tk0Var2 = this.f26202f1;
            if (tk0Var2.f28230g0) {
                tk0Var2.layout(0, i15, tk0Var2.getMeasuredWidth(), this.f26202f1.getMeasuredHeight() + i15);
            } else {
                int measuredWidth = getMeasuredWidth() - this.f26202f1.getMeasuredWidth();
                tk0 tk0Var3 = this.f26202f1;
                tk0Var3.layout(measuredWidth, i15, tk0Var3.getMeasuredWidth() + measuredWidth, this.f26202f1.getMeasuredHeight() + i15);
            }
            this.J1 = false;
        }
        L0(false);
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (tk0Var != null && tk0Var.getLayoutParams() != null) {
            ...
            if (tk0Var2.f28220a) {
                ...
                i12 = tk0Var2.f28231h0;
            }
            int measuredHeight = (getMeasuredHeight() - i12) - getPaddingBottom();
            this.f26202f1.getLayoutParams().height = measuredHeight;
            this.f26202f1.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(132.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(measuredHeight, 1073741824));
        }
        this.f26197c2 = ViewConfiguration.get(getContext()).getScaledTouchSlop();
    }
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        int i14 = this.f26239y1;
        if (i14 == 1) {
            if (this.f26204g1 != null && !this.f26221p1.isEmpty()) {
                for (int i15 = 0; i15 < this.f26221p1.size(); i15++) {
                    T0((View) this.f26221p1.get(i15), true);
                }
            }
        } else if (i14 == 2 && this.f26204g1 != null && (view = this.f26225r1) != null) {
            T0(view, true);
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        tk0 tk0Var = this.f26202f1;
        if (tk0Var != null && tk0Var.f28236n) {
            return false;
        }
        boolean z10 = this.f26199d2;
        org.telegram.ui.Cells.l7 l7Var = this.D2;
        if (z10 && motionEvent.getAction() != 0 && motionEvent.getAction() != 1 && motionEvent.getAction() != 3) {
            if (this.f26213k2 == Float.MAX_VALUE && this.f26214l2 == Float.MAX_VALUE) {
                this.f26213k2 = motionEvent.getX();
                this.f26214l2 = motionEvent.getY();
            }
            if (!this.f26201e2 && Math.abs(motionEvent.getY() - this.f26214l2) > this.f26197c2) {
                this.f26201e2 = true;
                l1(this, true);
            }
            if (this.f26201e2) {
                ...
                iArr[1] = xnVar.Aa;
                if (motionEvent.getY() > (getMeasuredHeight() - AndroidUtilities.dp(56.0f)) - this.f26216m2[1] && (this.f26205g2 >= this.f26203f2 || !this.f26207h2.f35530a)) {
                    this.f26211j2 = false;
                    if (!this.f26209i2) {
                        this.f26209i2 = true;
                ...
                } else if (motionEvent.getY() < AndroidUtilities.dp(56.0f) + this.f26216m2[0] && (this.f26205g2 <= this.f26203f2 || !this.f26207h2.f35530a)) {
                    this.f26211j2 = true;
                    if (!this.f26209i2) {
                        this.f26209i2 = true;
                        AndroidUtilities.cancelRunOnUIThread(l7Var);
        ...
        this.f26213k2 = Float.MAX_VALUE;
        this.f26214l2 = Float.MAX_VALUE;
        this.f26199d2 = false;
        this.f26201e2 = false;
        l1(this, false);
        this.f26209i2 = false;
    ...
    public final void s1(Utilities.CallbackReturn callbackReturn, Utilities.CallbackReturn callbackReturn2, int i10, float f7, Utilities.Callback5 callback5, boolean z10) {
        setSelectorDrawableColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18896j6, this.f26222p2));
    ...
    public void setAdapter(s4.h0 h0Var) {
        s4.h0 adapter = getAdapter();
        gg.p1 p1Var = this.f26230t2;
        if (adapter != null) {
            adapter.f42676a.unregisterObserver(p1Var);
        }
        ArrayList arrayList = this.f26221p1;
        if (arrayList != null) {
            arrayList.clear();
            this.f26223q1.clear();
        }
    ...
    public void setFastScrollEnabled(int i10) {
        this.f26202f1 = new tk0(this, getContext(), i10);
        if (getParent() != null) {
            ((ViewGroup) getParent()).addView(this.f26202f1);
        }
    }
    ...
    public void setFastScrollVisible(boolean z10) {
        ...
        tk0Var.setVisibility(i10);
        this.f26202f1.f28221a0 = z10;
    }
    ...
    public void setItemSelectorColorProvider(GenericProvider<Integer, Integer> genericProvider) {
        this.f26236w2 = genericProvider;
    }

    public void setItemsEnterAnimator(rk0 rk0Var) {
        this.f26218n2 = rk0Var;
    }
    ...
    public void setListSelectorColor(Integer num) {
        ...
        if (num == null) {
            if (b1()) {
                i10 = org.telegram.ui.ActionBar.h6.f18896j6;
            } else {
                i10 = org.telegram.ui.ActionBar.h6.f18878i6;
            }
            intValue = org.telegram.ui.ActionBar.h6.v0(i10, this.f26222p2);
        } else {
    ...
    public void setOnItemLongClickListener(cl0 cl0Var) {
        ...
        l20 l20Var = (l20) jaVar.f20300b;
        l20Var.f25797t = z10;
        l20Var.f25798u = longPressTimeout;
    }
    ...
    public void setSectionsType(int i10) {
        ...
        this.f26221p1 = new ArrayList();
        this.f26223q1 = new ArrayList();
    }
    ...
    public ml0(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        this.f26214l2 = Float.MAX_VALUE;
        this.f26224q2 = true;
        this.f26226r2 = new pe(1);
        this.f26228s2 = true;
        this.f26230t2 = new gg.p1(this, 1);
        ...
        setGlowColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19065s8, d6Var));
        org.telegram.ui.Cells.z f02 = org.telegram.ui.ActionBar.h6.f0(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18878i6, d6Var), 2, -1);
        this.D1 = f02;
        ...
        super.setOnScrollListener(new kg0(this, 2));
