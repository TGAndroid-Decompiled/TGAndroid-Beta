...
public final class jz0 extends View {
    ...
    public final hz0 Q;
    public final org.telegram.ui.Cells.q9 f27589a;
    public int f27590b;
    public final zy0 f27591c;
    public final zy0 d;
    public int f27592e;
    ...
    public int v;
    public int f27597w;
    public boolean f27598x;
    public int f27599y;

    public jz0(Context context, iz0 iz0Var, org.telegram.ui.Cells.q9 q9Var) {
        super(context);
        this.f27591c = new zy0(this, true);
        this.d = new zy0(this, false);
        this.f27592e = 0;
        this.f27593f = false;
        this.h = 1;
        this.f27594n = 0;
        this.f27595r = AndroidUtilities.dp(8.0f);
        this.f27596s = AndroidUtilities.dp(9.0f);
    ...
    public static void i(ez0 ez0Var, int i10, int i11, int i12, int i13) {
        ...
        gz0 gz0Var = ez0Var.f25816a;
        ez0Var.f25816a = new gz0(gz0Var.f26538a, dz0Var, gz0Var.f26540c, gz0Var.d);
        dz0 dz0Var2 = new dz0(i12, i13 + i12);
        gz0 gz0Var2 = ez0Var.f25817b;
        ez0Var.f25817b = new gz0(gz0Var2.f26538a, dz0Var2, gz0Var2.f26540c, gz0Var2.d);
    }
    ...
    public final void a(int i10, int i11, int i12, int i13) {
        ...
        vy0 vy0Var = U;
        ez0Var.f25816a = new gz0(false, dz0Var, vy0Var, 0.0f);
        ez0Var.f25817b = new gz0(false, new dz0(i10, i12 + i10), vy0Var, 0.0f);
        cz0Var.f25141a = ez0Var;
        cz0Var.f25148j = i11;
    ...
    public final void b(TL_iv.pageTableCell pagetablecell, int i10, int i11, int i12) {
        ...
        vy0 vy0Var = U;
        ez0Var.f25816a = new gz0(false, dz0Var, vy0Var, 0.0f);
        ez0Var.f25817b = new gz0(false, new dz0(i10, i12 + i10), vy0Var, 1.0f);
        cz0Var.f25141a = ez0Var;
        cz0Var.f25148j = i11;
        arrayList.add(cz0Var);
    ...
    public final void c() {
        ...
        if (i11 == 0) {
            ...
            for (int i16 = 0; i16 < childCount; i16++) {
                ...
                boolean z11 = gz0Var.f26538a;
                int i17 = dz0Var.f25492b;
                int i18 = dz0Var.f25491a;
                int i19 = i17 - i18;
                if (z11) {
                    i14 = i18;
                }
                ...
                dz0 dz0Var2 = gz0Var2.f26539b;
                boolean z12 = gz0Var2.f26538a;
                int i20 = dz0Var2.f25492b;
                int i21 = dz0Var2.f25491a;
                int i22 = i20 - i21;
                if (i13 != 0) {
                    if (z12) {
            ...
            for (int i25 = 0; i25 < childCount2; i25++) {
                i12 = (i12 * 31) + d(i25).f25141a.hashCode();
            }
            this.f27594n = i12;
            return;
        }
        ...
        for (int i27 = 0; i27 < childCount3; i27++) {
            i26 = (i26 * 31) + d(i27).f25141a.hashCode();
        }
        if (i11 != i26) {
            g();
            c();
    ...
    public final int e(cz0 cz0Var, boolean z10, boolean z11) {
        ...
        if (z11) {
            if (zy0Var.f33263j == null) {
                zy0Var.f33263j = new int[zy0Var.e() + 1];
            }
            if (!zy0Var.f33264k) {
                zy0Var.b(true);
                zy0Var.f33264k = true;
            ...
            if (zy0Var.f33265l == null) {
                zy0Var.f33265l = new int[zy0Var.e() + 1];
            }
            if (!zy0Var.f33266m) {
                zy0Var.b(false);
                zy0Var.f33266m = true;
    ...
    public final int f(cz0 cz0Var, boolean z10, boolean z11) {
        ...
        if (i10 == Integer.MIN_VALUE) {
            ...
            if (z12 != z11) {
                int i11 = dz0Var.f25491a;
                return 0;
            }
            int i12 = dz0Var.f25492b;
            zy0Var.e();
            return 0;
        }
        return i10;
    ...
    public final void h(int i10, boolean z10) {
        ...
        for (int i14 = 0; i14 < childCount; i14++) {
            ...
            if (z10) {
                ...
                d.e(this.O.createTextLayout(d.f25143c, i12));
                if (d.f25142b != null) {
                    ((ViewGroup.MarginLayoutParams) ez0Var).height = Math.max(this.f27597w, d.f25145f + this.f27595r + this.f27596s);
                    int emojiOnlyCount = d.f25142b.getEmojiOnlyCount();
                    if (emojiOnlyCount > 0) {
                        i13 = ((ViewGroup.MarginLayoutParams) ez0Var).height * emojiOnlyCount;
                    } else {
                        i13 = (this.v * 2) + d.f25144e;
                    }
                ...
                if (gz0.a(gz0Var, z11) == U) {
                    ...
                    int[] g10 = zy0Var.g();
                    int e7 = (g10[dz0Var.f25492b] - g10[dz0Var.f25491a]) - (e(d, z11, false) + e(d, z11, true));
                    if (z11) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i16 = 0; i16 < childCount; i16++) {
            jz0Var.f27590b = Math.max(jz0Var.f27590b, jz0Var.d(i16).f25141a.f25817b.f26539b.f25492b);
        }
        jz0Var.h(i10, true);
        if (jz0Var.f27592e == 0) {
            i12 = zy0Var2.i(i10);
            if (jz0Var.f27598x) {
                ...
                zy0Var2.v.f26211a = i12;
                zy0Var2.f33275w.f26211a = -i12;
                zy0Var2.f33270q = false;
                zy0Var2.g();
            }
            jz0Var.h(i10, false);
            i13 = zy0Var.i(i11);
        ...
        zy0Var2.f33270q = false;
        zy0Var2.g();
        zy0Var.v.f26211a = max;
        zy0Var.f33275w.f26211a = -max;
        zy0Var.f33270q = false;
        zy0Var.g();
        int[] g10 = zy0Var2.g();
        int[] g11 = zy0Var.g();
        ...
        while (i19 < childCount2) {
            ...
            cz0 d = jz0Var.d(i20);
            ez0 ez0Var = d.f25141a;
            gz0 gz0Var = ez0Var.f25817b;
            gz0 gz0Var2 = ez0Var.f25816a;
            dz0 dz0Var = gz0Var.f26539b;
            dz0 dz0Var2 = gz0Var2.f26539b;
            int i21 = childCount2;
            int i22 = g10[dz0Var.f25491a];
            int i23 = g11[dz0Var2.f25491a];
            int i24 = g10[dz0Var.f25492b] - i22;
            int i25 = g11[dz0Var2.f25492b] - i23;
            int i26 = d.f25149k;
            zy0 zy0Var3 = zy0Var;
            int i27 = d.f25150l;
            ...
            if (d.f25143c != null) {
                if (c10 != d.f25149k || c11 != d.f25150l) {
                    d.d(c10, c11, false);
                }
                int i32 = d.f25151m;
                if (i32 != 0 && i32 != c11) {
                    dz0 dz0Var3 = d.f25141a.f25816a.f26539b;
                    if (dz0Var3.f25492b - dz0Var3.f25491a <= 1) {
                        ...
                        while (true) {
                            if (i33 < size) {
                                ...
                                float f11 = pointF.x;
                                float f12 = d.f25141a.f25816a.f26539b.f25491a;
        ...
        while (i34 < size2) {
            ...
            int i35 = cz0Var.f25150l;
            int i36 = cz0Var.d;
            int i37 = i35 - cz0Var.f25151m;
            ArrayList arrayList3 = jz0Var.P;
            int size3 = arrayList3.size();
            for (int i38 = i36 + 1; i38 < size3; i38++) {
                cz0 cz0Var2 = (cz0) arrayList3.get(i38);
                if (cz0Var.f25141a.f25816a.f26539b.f25491a != cz0Var2.f25141a.f25816a.f26539b.f25491a) {
                    break;
                }
                int i39 = cz0Var.f25151m;
                int i40 = cz0Var2.f25151m;
                if (i39 < i40) {
                    z10 = true;
                    break;
                }
                int i41 = cz0Var2.f25150l - i40;
                if (i41 > 0) {
            ...
            if (!z10) {
                ...
                while (true) {
                    ...
                    if (cz0Var.f25141a.f25816a.f26539b.f25491a != cz0Var3.f25141a.f25816a.f26539b.f25491a) {
                        break;
                    }
                    int i43 = cz0Var.f25151m;
                    int i44 = cz0Var3.f25151m;
                    if (i43 < i44) {
                        z10 = true;
                        break;
                    }
                    int i45 = cz0Var3.f25150l - i44;
                    if (i45 > 0) {
            ...
            if (!z10) {
                cz0Var.f25150l = cz0Var.f25151m;
                cz0Var.g();
                max -= i37;
                int i46 = cz0Var.f25141a.f25816a.f26539b.f25491a;
                while (true) {
                    i46++;
                ...
                while (i49 < size4) {
                    ...
                    if (cz0Var == cz0Var4) {
                        ...
                        int i50 = cz0Var.f25141a.f25816a.f26539b.f25491a;
                        int i51 = cz0Var4.f25141a.f25816a.f26539b.f25491a;
                        if (i50 == i51) {
                            if (cz0Var4.f25151m != cz0Var4.f25150l) {
                            ...
                            int i52 = cz0Var4.f25150l - i37;
                            cz0Var4.f25150l = i52;
                            i14 = i49;
                            cz0Var4.d(cz0Var4.f25149k, i52, true);
                        } else {
                            i14 = i49;
                            if (i50 < i51) {
                                cz0Var4.f25155q -= i37;
        ...
        for (int i53 = 0; i53 < childCount3; i53++) {
            ...
            jz0Var.O.onLayoutChild(d10.f25142b, d10.b(), d10.c());
            d10.f25152n = d10.f25154p;
            d10.f25153o = d10.f25149k;
        }
        jz0Var.f27599y = i18;
        jz0Var.E = max;
        jz0Var.F = copyOf;
    ...
    public void setRenderWidth(int i10) {
        ...
        this.f27599y = Math.max(measuredWidth, i10);
        for (int i13 = 0; i13 < getChildCount(); i13++) {
            cz0 d = d(i13);
            if (measuredWidth > 0 && (i12 = this.f27599y) != measuredWidth) {
                float f7 = measuredWidth;
                int round = Math.round((d.f25152n * i12) / f7);
                int round2 = Math.round(((d.f25152n + d.f25153o) * this.f27599y) / f7);
                d.f25154p = round;
                d.f25149k = Math.max(0, round2 - round);
                if (d.f25143c != null && d.f25142b != null) {
                    d.f();
                }
            } else {
                int i14 = d.f25152n;
                d.f25154p = i14;
                d.f25149k = Math.max(0, (d.f25153o + i14) - i14);
                if (d.f25143c != null && d.f25142b != null) {
                    d.f();
                }
            }
        ...
        if (iArr.length < 2) {
            ...
            for (int i18 = 0; i18 < getChildCount(); i18++) {
                ...
                if (i11 > 0) {
                    dz0 dz0Var = d10.f25141a.f25816a.f26539b;
                    int max = Math.max(0, dz0Var.f25491a);
                    int min = Math.min(i15, dz0Var.f25492b);
                    if (max < min) {
                        int i19 = 0;
                        for (int i20 = max; i20 < min; i20++) {
                            i19 += iArr2[i20];
                        }
                        int max2 = Math.max(1, Math.round(d10.f25149k / i11)) - i19;
            ...
            for (int i25 = 0; i25 < getChildCount(); i25++) {
                cz0 d11 = d(i25);
                dz0 dz0Var2 = d11.f25141a.f25816a.f26539b;
                int max3 = Math.max(0, Math.min(i15, dz0Var2.f25491a));
                int max4 = Math.max(max3, Math.min(i15, dz0Var2.f25492b));
                int i26 = iArr4[max3];
                int i27 = iArr4[max4];
                d11.f25155q = i26;
                d11.f25150l = Math.max(0, i27 - i26);
                if (d11.f25143c != null) {
                    d11.g();
                }
                this.O.onLayoutChild(d11.f25142b, d11.b(), d11.c());
            }
        }
        invalidate();
    }
