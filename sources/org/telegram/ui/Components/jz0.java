...
public final class jz0 extends j1.b {
    public final Rect f25473o;
    public final lz0 f25474p;

    public jz0(lz0 lz0Var, lz0 lz0Var2) {
        super(lz0Var2);
        this.f25474p = lz0Var;
        this.f25473o = new Rect();
    }

    @Override
    public final int g(float f7, float f10) {
        int i10;
        lz0 lz0Var = this.f25474p;
        int childCount = lz0Var.getChildCount();
        for (int i11 = 0; i11 < childCount; i11++) {
            ez0 d = lz0Var.d(i11);
            int i12 = d.f23711k;
            if (i12 > 0 && (i10 = d.f23712l) > 0) {
                int i13 = d.f23716p;
    ...
    public final void l(int i10, s0.c cVar) {
        ...
        if (i10 >= 0) {
            ...
            if (i10 < lz0Var.getChildCount()) {
                ...
                int i11 = d.f23716p;
                int i12 = d.f23717q;
                rect.set(i11, i12, d.f23711k + i11, d.f23712l + i12);
                cVar.h(rect);
                cVar.i("android.widget.TextView");
                cVar.f42651a.setEnabled(true);
                ...
                TL_iv.pageTableCell pagetablecell = d.f23706c;
