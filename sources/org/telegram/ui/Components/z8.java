...
public final class z8 implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        e9 e9Var = this.d;
        e9Var.N = floatValue;
        float lerp = AndroidUtilities.lerp(this.f30812a, this.f30813b, floatValue);
        kVar = ((org.telegram.ui.ActionBar.m2) e9Var).actionBar;
        kVar.getTitleTextView().setAlpha(e9Var.N);
        if (e9Var.F && !this.f30814c) {
            e9Var.i0(1.0f - e9Var.N, false);
        }
        e9Var.f23886r.setTranslationY(lerp);
        e9Var.f23889x.setTranslationY(lerp);
