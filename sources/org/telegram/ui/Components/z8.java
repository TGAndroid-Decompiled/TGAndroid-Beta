...
public final class z8 extends ml0 {
    ...
    public final int Y2;
    public int Z2;
    public final org.telegram.ui.y7 f30413a3;
    public y8 f30414b3;
    public final c9 f30415c3;
    ...
    public z8(c9 c9Var, Activity activity) {
        ...
        for (int i12 = 0; i12 < 30; i12++) {
            ...
            this.Y2 = i13 + 1;
            obj2.f30141a = i13;
            int[] iArr2 = c9.f22965d0[i12];
            obj2.f30143c = iArr2[0];
            obj2.d = iArr2[1];
            obj2.e = 0;
            obj2.f30144f = 0;
            obj2.f30142b = true;
    ...
    public final void onMeasure(int i10, int i11) {
        int size = View.MeasureSpec.getSize(i10) / this.f30413a3.h();
        c9 c9Var = this.f30415c3;
        c9Var.P = size;
        ...
        while (true) {
            ...
            if (i10 < arrayList.size()) {
                if (((y8) arrayList.get(i10)).equals(y8Var)) {
                    this.Z2 = ((y8) arrayList.get(i10)).f30141a;
                    break;
                }
                i10++;
            } else {
