...
public final class z8 implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        e9 e9Var = this.d;
        e9Var.N = floatValue;
        float lerp = AndroidUtilities.lerp(this.f30849a, this.f30850b, floatValue);
        kVar = ((org.telegram.ui.ActionBar.m2) e9Var).actionBar;
        kVar.getTitleTextView().setAlpha(e9Var.N);
        if (e9Var.F && !this.f30851c) {
            e9Var.i0(1.0f - e9Var.N, false);
        }
        e9Var.f23884r.setTranslationY(lerp);
        e9Var.f23887x.setTranslationY(lerp);
