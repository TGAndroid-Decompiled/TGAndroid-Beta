...
public final class ci0 extends FrameLayout {
    public final Paint f23295a;
    public final Path f23296b;
    public final bi0 f23297c;
    public float d;
    public float e;
    public float f23298f;
    public boolean h;
    public NotchInfoUtils.NotchInfo f23299n;
    ...
    public ci0(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 31 && SharedConfig.getDevicePerformanceClass() >= 1) {
            ...
            this.f23297c = new ai0(this, f7);
        } else {
            this.f23297c = new zh0(this);
        }
        setIntensity(15.0f);
    ...
    public final void draw(Canvas canvas) {
        ...
        this.f23297c.c(new mv(this, 13), canvas);
    }

    public float getAvatarEndScale() {
        float min;
        int dp;
        NotchInfoUtils.NotchInfo notchInfo = this.f23299n;
        if (notchInfo == null) {
            return 0.8f;
        }
        if (notchInfo.isLikelyCircle) {
            ...
            min = Math.min(notchInfo.bounds.width(), this.f23299n.bounds.height());
            dp = AndroidUtilities.dp(100.0f);
        }
