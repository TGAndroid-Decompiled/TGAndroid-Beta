...
public abstract class ScrollSlidingTabStrip extends HorizontalScrollView {
        ...
        if (this.expanded != z) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    ScrollSlidingTabStrip.$r8$lambda$mnZJ4dErPPhjyzg5XUMnykmTZAg(this.f$0, z, f, valueAnimator2);
                }
            });
    ...
    public static void $r8$lambda$mnZJ4dErPPhjyzg5XUMnykmTZAg(ScrollSlidingTabStrip scrollSlidingTabStrip, boolean z, float f, ValueAnimator valueAnimator) {
        if (z) {
        ...
        if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
            ...
            if (this.draggingView != null) {
                ...
                valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    @Override
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        ScrollSlidingTabStrip.$r8$lambda$o0Zet1LC8U1Sh9WHuMZuD9gk6zE(this.f$0, valueAnimator);
                    }
                });
    ...
    public static void $r8$lambda$o0Zet1LC8U1Sh9WHuMZuD9gk6zE(ScrollSlidingTabStrip scrollSlidingTabStrip, ValueAnimator valueAnimator) {
        scrollSlidingTabStrip.getClass();
