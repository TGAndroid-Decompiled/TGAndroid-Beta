...
public final class bt0 implements xm0 {
    ...
    public final void C() {
        ...
        if (cu0Var.F == 0) {
            L0 = (cu0Var.f23402x.L0() / jv0Var.f25538m1[0]) * a2;
        } else {
            L0 = cu0Var.f23402x.L0() * a2;
        }
    ...
    public final boolean n1(int i10, View view) {
        ...
        if (m2Var != null && jv0.d0(i10, jv0Var.f25521d1 instanceof TLRPC.TL_channelFull) != null) {
            if (jv0Var.f25521d1 instanceof TLRPC.TL_channelFull) {
                if (ChatObject.canUserDoAction(m2Var.getMessagesController().getChat(Long.valueOf(jv0Var.f25521d1.f18336id)), 5)) {
                    profileTab = jv0Var.f25521d1.main_tab;
            ...
            } else if (jv0Var.f25534j1 == m2Var.getUserConfig().getClientUserId() && (userFull = jv0Var.f25523e1) != null) {
