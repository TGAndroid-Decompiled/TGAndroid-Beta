...
public final class yo0 extends kw0 {
    ...
    public long f33005b = 0;
    public boolean f33006c = false;
    public float d;
    public final Paint f33007e;
    ...
    @Override
    public final void d() {
        this.f33005b = System.currentTimeMillis();
        this.f33006c = true;
        invalidateSelf();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.f33006c) {
            ...
            long j3 = currentTimeMillis - this.f33005b;
            this.f33005b = currentTimeMillis;
            if (j3 > 50) {
                j3 = 50;
            }
