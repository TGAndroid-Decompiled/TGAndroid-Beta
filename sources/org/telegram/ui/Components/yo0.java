...
public final class yo0 extends mw0 {
    ...
    @Override
    public final void d() {
        this.f30296b = System.currentTimeMillis();
        this.f30297c = true;
        invalidateSelf();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        Paint paint = this.e;
        if (paint == null) {
            paint = org.telegram.ui.ActionBar.j6.f18858d2;
        }
        Paint paint2 = paint;
        int i10 = 0;
        while (i10 < 3) {
        ...
        if (this.f30297c) {
            ...
            long j3 = currentTimeMillis - this.f30296b;
            this.f30296b = currentTimeMillis;
            if (j3 > 50) {
                j3 = 50;
            }
