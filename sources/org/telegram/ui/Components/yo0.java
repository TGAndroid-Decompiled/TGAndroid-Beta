...
public final class yo0 {
    public final ou f30361a;
    public final long f30362b;
    public final float f30363c;
    public final float d;
    public final float e;

    public yo0(View view) {
        ou ouVar = new ou(1, view);
        this.f30362b = System.currentTimeMillis();
        this.f30361a = ouVar;
        this.f30363c = AndroidUtilities.lerp(5.0f, 9.0f, Utilities.clamp01(Utilities.fastRandom.nextFloat()));
    ...
    public final void a(Canvas canvas, float f7) {
        ou ouVar;
        float currentTimeMillis = ((float) (System.currentTimeMillis() - this.f30362b)) / 1000.0f;
        canvas.translate(0.0f, 0.0f);
        canvas.rotate(((float) Math.sin(this.f30363c * currentTimeMillis * 3.141592653589793d)) * 1.0f * f7);
        ...
        canvas.translate(-0.0f, -0.0f);
        if (f7 > 0.0f && (ouVar = this.f30361a) != null) {
            ouVar.run();
        }
    }
}
