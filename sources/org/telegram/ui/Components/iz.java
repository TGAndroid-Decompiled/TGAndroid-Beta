...
public final class iz extends kl0 {
    ...
    public final int h() {
        ...
        kz kzVar = this.d;
        if (z10) {
            arrayList = kzVar.f27967n1;
        } else {
            arrayList = kzVar.f27963m1;
        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (stickerSetCovered instanceof TLRPC.TL_stickerSetFullCovered) {
            ...
            TLRPC.TL_messages_stickerSet stickerSet = MediaDataController.getInstance(kzVar.f27933c1).getStickerSet(MediaDataController.getInputStickerSet(stickerSetCovered.set), false);
            if (stickerSet == null) {
                arrayList2 = null;
            } else {
        ...
        if (document != null) {
            ...
            SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(stickerSetCovered.set.thumbs, org.telegram.ui.ActionBar.j6.f20647c7, 0.2f);
            if (svgThumb != null) {
