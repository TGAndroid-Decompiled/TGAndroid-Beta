            ...
            case 0:
                ...
                if (E != null) {
                    ...
                    if (in0Var.I.g()) {
                        ...
                        hn0Var.m(i10);
                        if (!in0Var.I.g()) {
                            hn0Var.q(0, hn0Var.f24843c.f25125r);
                            return;
                        }
                        return;
                    }
                    if (view instanceof en0) {
                        org.telegram.ui.Cells.k7 k7Var = ((en0) view).f23979a;
                        ...
                        if (k7Var.G) {
                            ...
                            k7Var.f(true);
                            DownloadController.getInstance(this.f23056b).updateFilesLoadingPriority();
                        } else {
                ...
                return;
            case 1:
                org.telegram.ui.np0 np0Var2 = (org.telegram.ui.np0) this.f23057c;
                org.telegram.ui.tp0 tp0Var = np0Var2.f35956p0;
                ArrayList arrayList2 = np0Var2.f35952l0;
                if (view instanceof org.telegram.ui.mp0) {
                    org.telegram.ui.mp0 mp0Var = (org.telegram.ui.mp0) view;
                    int i15 = np0Var2.m0;
                    if (np0Var2.f35955o0 == null) {
                        o5 o5Var = mp0Var.f35643c;
                        ...
                        jp0Var.f32027g1 = true;
                        long j10 = np0Var2.f35953n;
                        if (j10 == 0) {
                            valueOf = null;
                        } else {
                ...
                int i17 = np0Var2.V;
                int i18 = this.f23056b;
                if (i10 == i17) {
                    np0Var2.h = -1;
                    np0Var2.f35953n = 0L;
                    np0Var2.f35957r = null;
                    np0Var2.f35958s = null;
                    np0Var2.I = null;
                    np0Var2.i();
                    if (i18 == 0) {
                        tp0Var.h.i();
                    }
                    org.telegram.ui.mp0 mp0Var2 = np0Var2.f35961y;
                    if (mp0Var2 != null) {
                        mp0Var2.b(true);
                    }
                    np0Var2.j(true);
                    np0Var2.f(true);
                    org.telegram.ui.np0 np0Var3 = tp0Var.f38180n;
                    if (np0Var3 != null && (rp0Var = np0Var3.f35937a) != null && (np0Var = tp0Var.h) != null) {
                        rp0Var.a(np0Var.h);
                        return;
                    }
                    return;
                }
                int i19 = np0Var2.f35940b0;
                if (i10 >= i19 && i10 < np0Var2.f35942c0) {
                    int i20 = i10 - i19;
                    if (np0Var2.K == null) {
                        if (i20 >= 0 && i20 < arrayList2.size()) {
                            ...
                            if (i18 == 1) {
                                ...
                                if (peerColor instanceof TLRPC.TL_peerColorCollectible) {
                                    ...
                                    np0Var2.I = null;
                                    np0Var2.f35957r = null;
                                    np0Var2.f35958s = (TLRPC.TL_peerColorCollectible) peerColor;
                                } else {
                                    return;
                                }
                            } else {
                                ...
                                np0Var2.h = -1;
                                np0Var2.I = null;
                                np0Var2.f35957r = MessagesController.emojiStatusCollectibleFromGift(tL_starGiftUnique);
                                np0Var2.f35958s = null;
                            }
                            np0Var2.j(true);
                            np0Var2.i();
                            np0Var2.f(true);
                            org.telegram.ui.mp0 mp0Var3 = np0Var2.f35961y;
                            if (mp0Var3 != null) {
                                mp0Var3.b(true);
                                return;
                            }
                        ...
                        if (i18 == 1) {
                            ...
                            if (peerColor2 instanceof TLRPC.TL_peerColorCollectible) {
                                ...
                                np0Var2.h = -1;
                                np0Var2.f35957r = null;
                                np0Var2.f35958s = (TLRPC.TL_peerColorCollectible) peerColor2;
                            } else {
                                return;
                            }
                        } else {
                            np0Var2.f35953n = 0L;
                            np0Var2.h = -1;
                            np0Var2.f35957r = MessagesController.emojiStatusCollectibleFromGift(tL_starGiftUnique2);
                            np0Var2.f35958s = null;
                        }
                        ...
                        np0Var2.i();
                        np0Var2.f(true);
                        org.telegram.ui.mp0 mp0Var4 = np0Var2.f35961y;
                        if (mp0Var4 != null) {
                            mp0Var4.b(true);
                            return;
                        }
                ...
                return;
            default:
                org.telegram.ui.a71 a71Var = (org.telegram.ui.a71) this.f23057c;
                boolean z12 = view instanceof org.telegram.ui.j61;
                int i21 = this.f23056b;
                try {
                    if (z12) {
                        org.telegram.ui.j61 j61Var = (org.telegram.ui.j61) view;
                        if (!j61Var.f34669s && (((o0Var = j61Var.f34671x) == null || !o0Var.f49394a) && i21 != 13 && i21 != 14)) {
                            if (j61Var.Q && (document = j61Var.d) != null) {
                                if (a71Var.W == 6) {
                                    a71Var.p(j61Var, Long.valueOf(document.f18342id), document, j61Var.v, null);
                                } else {
                            ...
                            a71Var.l();
                            a71Var.r(j61Var, j61Var.f34671x);
                        }
                        if (i21 != 1 && i21 != 11) {
