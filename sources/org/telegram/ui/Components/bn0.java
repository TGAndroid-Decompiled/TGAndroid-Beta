...
public final class bn0 implements Runnable {
    public final int f23048a = 1;
    public final jn0 f23049b;
    ...
    public final void run() {
        switch (this.f23048a) {
            case 0:
                ...
                break;
            default:
                jn0 jn0Var2 = this.f23049b;
                kx0 kx0Var = jn0Var2.f25379a;
                if (this.f23050c.equals(jn0Var2.L)) {
                    if (jn0Var2.f25384r == 0) {
                        jn0Var2.N.b(0);
                    }
