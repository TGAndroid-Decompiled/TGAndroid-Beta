...
public final class ne0 extends FrameLayout {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int dp = AndroidUtilities.dp(13.0f) + this.f26415a.getMeasuredHeight();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        TextView textView2 = this.f26416b;
        measureChildWithMargins(textView2, i10, 0, i11, 0);
        measureChildWithMargins(this.f26417c, i10, 0, i11, 0);
        Switch r72 = this.d;
        if (r72 != null) {
