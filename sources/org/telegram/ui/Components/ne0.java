...
public final class ne0 extends FrameLayout {
    public TextView f26443a;
    public TextView f26444b;
    public ImageView f26445c;
    public Switch d;
    public boolean e;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int dp = AndroidUtilities.dp(13.0f) + this.f26443a.getMeasuredHeight();
    ...
    public final void onMeasure(int i10, int i11) {
        TextView textView = this.f26443a;
        measureChildWithMargins(textView, i10, 0, i11, 0);
        TextView textView2 = this.f26444b;
        measureChildWithMargins(textView2, i10, 0, i11, 0);
        measureChildWithMargins(this.f26445c, i10, 0, i11, 0);
        Switch r72 = this.d;
        if (r72 != null) {
