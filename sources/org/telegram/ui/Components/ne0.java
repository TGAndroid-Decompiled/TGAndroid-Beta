...
public final class ne0 extends FrameLayout {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int dp = AndroidUtilities.dp(13.0f) + this.f28737a.getMeasuredHeight();
        TextView textView = this.f28738b;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        TextView textView2 = this.f28738b;
        measureChildWithMargins(textView2, i10, 0, i11, 0);
        measureChildWithMargins(this.f28739c, i10, 0, i11, 0);
        Switch r72 = this.d;
        if (r72 != null) {
            measureChildWithMargins(r72, i10, 0, i11, 0);
        }
        setMeasuredDimension(View.MeasureSpec.getSize(i10), org.telegram.messenger.w1.b(20.0f, textView2.getMeasuredHeight() + textView.getMeasuredHeight(), AndroidUtilities.dp(64.0f)) + (this.f28740e ? 1 : 0));
    }
