...
public final class eq extends p6 {
    public final Rect f23984s;
    public Drawable v;
    public boolean f23985w;

    public eq(Context context) {
        super(context, false, false, false);
        this.f23984s = new Rect();
    }
    ...
    public final void onDraw(Canvas canvas) {
        if (this.v != null) {
            ...
            Rect rect = this.f23984s;
            rect.set(bounds);
            int ceil = (int) Math.ceil(getDrawable().d());
            if (getDrawable().f26930b == 3) {
                rect.right = rect.left + ceil;
            } else if (getDrawable().f26930b == 5) {
                rect.left = rect.right - ceil;
            } else if (getDrawable().f26930b == 17) {
