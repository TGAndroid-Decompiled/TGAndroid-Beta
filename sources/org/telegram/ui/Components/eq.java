...
public final class eq extends p6 {
    public final Rect f23734s;
    public Drawable v;
    public boolean f23735w;

    public eq(Context context) {
        super(context, false, false, false);
        this.f23734s = new Rect();
    }
    ...
    public final void onDraw(Canvas canvas) {
        if (this.v != null) {
            ...
            Rect rect = this.f23734s;
            rect.set(bounds);
            int ceil = (int) Math.ceil(getDrawable().d());
            if (getDrawable().f26614b == 3) {
                rect.right = rect.left + ceil;
            } else if (getDrawable().f26614b == 5) {
                rect.left = rect.right - ceil;
            } else if (getDrawable().f26614b == 17) {
