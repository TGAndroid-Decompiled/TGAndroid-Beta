...
public final class VerticalPositionAutoAnimator {
    ...
    public class AnimatorLayoutChangeListener implements View.OnLayoutChangeListener {
        ...
        public AnimatorLayoutChangeListener(View view, float f) {
            ...
            VerticalPositionAutoAnimator.this.floatingButtonAnimator.mSpring.setDampingRatio(1.0f);
            VerticalPositionAutoAnimator.this.floatingButtonAnimator.mSpring.setStiffness(f);
        }
        ...
        public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
            ...
            VerticalPositionAutoAnimator.this.floatingButtonAnimator.mSpring.mFinalPosition = VerticalPositionAutoAnimator.this.offsetY;
            view.setTranslationY(VerticalPositionAutoAnimator.this.offsetY + (i6 - i2));
    ...
    public void setOffsetY(float f) {
        this.offsetY = f;
        SpringAnimation springAnimation = this.floatingButtonAnimator;
