...
public final class nx0 extends FrameLayout {
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            vx0 vx0Var = this.e;
            if (vx0Var.f29460e0 != 0 && motionEvent.getY() < vx0Var.f29460e0) {
                vx0Var.dismiss();
                return true;
            }
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) vx0Var.f29457c.getLayoutParams();
        int i23 = 3;
        if (arrayList != null) {
            ...
            if (vx0Var.W != null) {
                ...
                i17 = i19 + (vx0Var.d.f27706n * vx0Var.P) + size3;
        ...
        if (vx0Var.f29457c.getPaddingTop() != i20) {
            vx0Var.f29463g0 = true;
            vx0Var.f29457c.setPadding(AndroidUtilities.dp(10.0f), i20, AndroidUtilities.dp(10.0f), AndroidUtilities.dp(8.0f));
