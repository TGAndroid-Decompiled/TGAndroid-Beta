...
public final class i91 extends AsyncTask {
    ...
    public i91(o91 o91Var, String str, int i10) {
        ...
        switch (i10) {
            case 1:
                this.d = o91Var;
                this.f24966c = new String[4];
                this.f24965b = str;
                return;
            case 2:
                this.d = o91Var;
                this.f24966c = new String[2];
                this.f24965b = str;
                return;
            case 3:
                this.d = o91Var;
    ...
    public final Object doInBackground(Object[] objArr) {
        switch (this.f24964a) {
            case 0:
                ...
                this.d.getClass();
                String c10 = o91.c(this, "http://www.aparat.com/video/video/embed/vt/frame/showvideo/yes/videohash/" + this.f24965b, null, true);
                if (isCancelled()) {
                    return null;
                }
                try {
                    Matcher matcher = o91.f26982r0.matcher(c10);
                    if (matcher.find()) {
            ...
            case 1:
                ...
                this.d.getClass();
                String c11 = o91.c(this, "https://coub.com/api/v2/coubs/" + this.f24965b + ".json", null, true);
                if (isCancelled()) {
                    return null;
                }
                try {
            ...
            case 2:
                ...
                try {
                    Matcher matcher2 = o91.f26983s0.matcher(c12);
                    if (matcher2.find()) {
            ...
            case 3:
                ...
                String[] strArr4 = this.f24966c;
                HashMap hashMap = new HashMap();
                hashMap.put("Client-ID", "jzkbprff40iqj646a697cyrvl0zt2m6");
                int indexOf = this.f24965b.indexOf(38);
                if (indexOf > 0) {
                    this.f24965b = this.f24965b.substring(0, indexOf);
                }
                Locale locale3 = Locale.US;
                this.d.getClass();
                String c13 = o91.c(this, "https://api.twitch.tv/kraken/streams/" + this.f24965b + "?stream_type=all", hashMap, false);
                if (isCancelled()) {
                    return null;
                }
                try {
                    new JSONObject(c13).getJSONObject("stream");
                    JSONObject jSONObject3 = new JSONObject(o91.c(this, "https://api.twitch.tv/api/channels/" + this.f24965b + "/access_token", hashMap, false));
                    ...
                    URLEncoder.encode("https://youtube.googleapis.com/v/" + this.f24965b, "UTF-8");
            ...
            default:
                ...
                String[] strArr5 = this.f24966c;
                Locale locale4 = Locale.US;
                this.d.getClass();
                String c14 = o91.c(this, "https://player.vimeo.com/video/" + this.f24965b + "/config", null, true);
                if (isCancelled()) {
                    return null;
                }
                try {
    ...
    public final void onPostExecute(Object obj) {
        switch (this.f24964a) {
            ...
            case 1:
                ...
                o91 o91Var2 = this.d;
                if (str2 != null) {
                    o91Var2.f27009w = true;
                    o91Var2.f27010x = str2;
                    String[] strArr = this.f24966c;
                    o91Var2.f27011y = strArr[1];
                    o91Var2.E = strArr[2];
                    o91Var2.F = strArr[3];
                    if (o91Var2.f27008s) {
                        o91Var2.i();
            ...
            case 2:
                ...
                o91 o91Var3 = this.d;
                if (str3 != null) {
                    o91Var3.f27009w = true;
                    o91Var3.f27010x = str3;
                    o91Var3.f27011y = this.f24966c[1];
                    if (o91Var3.f27008s) {
                        o91Var3.i();
                    }
                    o91Var3.j(false, true);
                    o91Var3.f27000f0.d(true, true);
                    return;
                } else if (!isCancelled()) {
                    o91Var3.h();
                    return;
            ...
            case 3:
                ...
                o91 o91Var4 = this.d;
                if (str4 != null) {
                    o91Var4.f27009w = true;
                    o91Var4.f27010x = str4;
                    o91Var4.f27011y = this.f24966c[1];
                    if (o91Var4.f27008s) {
                        o91Var4.i();
                    }
                    o91Var4.j(false, true);
                    o91Var4.f27000f0.d(true, true);
                    return;
                } else if (!isCancelled()) {
                    o91Var4.h();
                    return;
            ...
            default:
                ...
                o91 o91Var5 = this.d;
                if (str5 != null) {
                    o91Var5.f27009w = true;
                    o91Var5.f27010x = str5;
                    o91Var5.f27011y = this.f24966c[1];
                    if (o91Var5.f27008s) {
                        o91Var5.i();
                    }
                    o91Var5.j(false, true);
                    o91Var5.f27000f0.d(true, true);
                    return;
                } else if (!isCancelled()) {
                    o91Var5.h();
                    return;
