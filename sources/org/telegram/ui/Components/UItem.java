...
public class UItem extends AdapterWithDiffUtils.Item {
    ...
    public static abstract class UItemFactory<V extends View> {
        ...
        public void precache(Context context, int i, int i2, Theme.ResourcesProvider resourcesProvider, int i3) {
            ...
            while (i4 < this.cache.size() - i3) {
                ...
                this.cache.add((V) createView(context2, null, i, i2, resourcesProvider));
                i4++;
                context = context2;
            }
        }
    ...
    public static UItem asCheck(CharSequence charSequence) {
    ...
    public static UItem asIntSlideView(int i, int i2, int i3, int i4, Utilities.CallbackReturn<Integer, CharSequence> callbackReturn, Utilities.Callback<Integer> callback) {
        ...
        options.min = i2;
        options.max = i4;
        options.toString = new WindowVisibilityManager$$ExternalSyntheticLambda0(callbackReturn, 22);
        uItem.object = options;
        uItem.longValue = -1L;
        return uItem;
    }
    ...
    public static UItem asRoundCheckbox(CharSequence charSequence) {
    ...
    public static UItem asTopViewStatic(CharSequence charSequence, int i) {
        UItem uItem = new UItem(2, false);
        uItem.text = charSequence;
        uItem.accent = true;
        uItem.iconResId = i;
    ...
    public boolean contentsEquals(AdapterWithDiffUtils.Item item) {
        ...
        if (item != null && getClass() == item.getClass()) {
            ...
            if (i != 35 && i != 37) {
                return (i < factoryViewTypeStartsWith || (uItemFactoryFindFactory = findFactory(i)) == null) ? itemContentEquals(uItem) : uItemFactoryFindFactory.contentsEquals(this, uItem);
            }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            ...
            if (i != 36 && i != 35) {
                ...
                return (i < factoryViewTypeStartsWith || (uItemFactoryFindFactory = findFactory(i)) == null) ? itemEquals(uItem) : uItemFactoryFindFactory.equals(this, uItem);
            }
            if (this.id == uItem.id) {
                return true;
            }
    ...
    public static UItem asSpace(int i, int i2, int i3) {
        UItem uItem = new UItem(28, false);
        uItem.id = i;
        uItem.intValue = i2;
        uItem.iconResId = i3;
