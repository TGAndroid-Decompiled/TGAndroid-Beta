...
public final class ok0 extends FrameLayout {
    ...
    public boolean O;
    public final qk0 P;
    public final nk0 f27103a;
    public final nk0 f27104b;
    public final nk0 f27105c;
    public final ImageReceiver d;
    public zg.o0 e;
    public rg.b1 f27106f;
    public float h;
    public boolean f27107n;
    public boolean f27108r;
    public boolean f27109s;
    public boolean v;
    ...
    public ok0(qk0 qk0Var, Context context) {
        ...
        nk0Var2.f29943a.setAutoRepeat(0);
        nk0Var2.f29943a.setAllowStartAnimation(false);
        nk0Var2.f29943a.setAllowStartLottieAnimation(false);
    ...
    public static void a(ok0 ok0Var, zg.o0 o0Var, int i10) {
        ...
        boolean z11;
        int i11;
        nk0 nk0Var = ok0Var.f27105c;
        nk0 nk0Var2 = ok0Var.f27103a;
        nk0 nk0Var3 = ok0Var.f27104b;
        qk0 qk0Var = ok0Var.P;
        ...
        int i12 = qk0Var.J;
        org.telegram.ui.ActionBar.d6 d6Var = qk0Var.f27677k0;
        int i13 = qk0Var.M0;
        ...
        ok0Var.H = z10;
        if (z10 && ok0Var.f27106f == null) {
            rg.b1 b1Var = new rg.b1(ok0Var.getContext(), 1, null);
            ok0Var.f27106f = b1Var;
            b1Var.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
            ok0Var.f27106f.setImageReceiver(nk0Var3.getImageReceiver());
            ok0Var.addView(ok0Var.f27106f, w7.y5.d(18, 18.0f, 17, 8.0f, 8.0f, 0.0f, 0.0f));
        }
        rg.b1 b1Var2 = ok0Var.f27106f;
        if (b1Var2 != null) {
            if (ok0Var.H) {
                i11 = 0;
            } else {
        ...
        ok0Var.d();
        ok0Var.e = o0Var;
        if (!o0Var.f49394a && (o0Var.f49397f == null || ((!qk0Var.q() && !qk0Var.G0) || !LiteMode.isEnabled(8200)))) {
            z11 = false;
        } else {
            z11 = true;
        }
        ok0Var.f27108r = z11;
        if (i13 == 4 || ok0Var.e.f49395b) {
            ok0Var.f27108r = false;
        }
        ...
        if (!o0Var3.f49394a && o0Var3.f49397f == null) {
            ...
            q5 q5Var = new q5(4, qk0Var.J, ok0Var.e.f49398g);
            q5 q5Var2 = new q5(3, qk0Var.J, ok0Var.e.f49398g);
    ...
    public final void b() {
        ...
        nk0 nk0Var = this.f27104b;
        q5 q5Var = nk0Var.e;
        if (q5Var != null) {
            imageReceiver = q5Var.f27505k;
        } else {
            imageReceiver = nk0Var.f29943a;
        }
        if (imageReceiver != null && imageReceiver.getLottieAnimation() != null) {
            qk0 qk0Var = this.P;
            if (qk0Var.f27694x0 == null && !this.N && qk0Var.G0) {
                if (imageReceiver.getLottieAnimation().f25069a0 <= 2) {
    ...
    public final void c(int i10) {
        ...
        if (this.f27108r) {
            if (this.f27103a.getImageReceiver().getLottieAnimation() != null && !this.f27103a.getImageReceiver().getLottieAnimation().y() && !this.f27107n) {
                this.f27107n = true;
                if (i10 == 0) {
                    this.E = false;
                    this.f27103a.getImageReceiver().getLottieAnimation().stop();
                    this.f27103a.getImageReceiver().getLottieAnimation().N(0, false, false);
                    this.G.run();
                    return;
                }
                this.E = true;
            ...
            if (this.f27103a.getImageReceiver().getLottieAnimation() != null && this.f27107n && !this.f27103a.getImageReceiver().getLottieAnimation().f25082k0 && !this.f27103a.getImageReceiver().getLottieAnimation().y()) {
                this.f27103a.getImageReceiver().getLottieAnimation().N(this.f27103a.getImageReceiver().getLottieAnimation().e[0] - 1, false, false);
            }
            nk0 nk0Var3 = this.f27104b;
            float f14 = this.I;
            if (this.f27110w) {
                f7 = 0.76f;
            } else {
            ...
            nk0 nk0Var4 = this.f27104b;
            float f15 = this.I;
            if (!this.f27110w) {
                f11 = 1.0f;
            }
            nk0Var4.setScaleX(f15 * f11);
        } else if (!this.f27107n) {
            this.I = 0.0f;
            this.f27104b.setScaleX(0.0f);
            this.f27104b.setScaleY(0.0f);
            ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
            this.J = ofFloat;
            ofFloat.addUpdateListener(new s70(this, 9));
            this.J.setDuration(150L);
            this.J.setInterpolator(rr.h);
            this.J.setStartDelay(i10 * this.P.f27659c);
            this.J.start();
            this.f27107n = true;
        }
    }
    ...
    public final void d() {
        float f7;
        float f10;
        boolean z10 = this.f27108r;
        qk0 qk0Var = this.P;
        float f11 = 1.0f;
        nk0 nk0Var = this.f27104b;
        if (z10) {
            AndroidUtilities.cancelRunOnUIThread(this.G);
            nk0 nk0Var2 = this.f27103a;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (o0Var2 != null && o0Var2.f49394a && this.F != null && LiteMode.isEnabled(8200) && LiteMode.isEnabled(131072)) {
            ...
            ij0 lottieAnimation = this.f27103a.getImageReceiver().getLottieAnimation();
            yh.i8 i8Var = this.F;
            if (lottieAnimation != null && (i10 = lottieAnimation.f25069a0) > 30) {
    ...
    public final void e(zg.o0 o0Var) {
        ...
        if (o0Var != null && o0Var.f49394a) {
            ...
            nk0Var.getImageReceiver().setImageBitmap(Emoji.getEmojiDrawable(o0Var.f49397f));
            nk0Var2.getImageReceiver().setImageBitmap(Emoji.getEmojiDrawable(o0Var.f49397f));
        } else {
            zg.o0 o0Var2 = this.e;
            if (o0Var2.f49395b) {
                TLRPC.Document effectDocument = MessagesController.getInstance(qk0Var.J).getEffectDocument(this.e.f49398g);
                ...
                TLRPC.TL_availableReaction tL_availableReaction2 = MediaDataController.getInstance(qk0Var.J).getReactionsMap().get(this.e.f49397f);
                if (tL_availableReaction2 != null) {
                    ...
                    this.f27105c.getImageReceiver().setImage(ImageLocation.getForDocument(tL_availableReaction.select_animation), "60_60_pcache", null, null, svgThumb2, 0L, "tgs", o0Var, 0);
    ...
    public final void f(zg.o0 o0Var, boolean z10) {
        ...
        float f13;
        float f14;
        boolean z11 = this.f27110w;
        boolean contains = this.P.f27662d0.contains(o0Var);
        this.f27110w = contains;
        if (contains != z11) {
            nk0 nk0Var = this.f27103a;
            nk0 nk0Var2 = this.f27104b;
            float f15 = 1.0f;
        ...
        if (this.O) {
            ...
            if (qk0Var.Q == null) {
                ...
                if (action == 0) {
                    ...
                    if (this.h == 1.0f && !this.H && (i10 = qk0Var.M0) != 3 && i10 != 4 && i10 != 5 && ((pk0Var = qk0Var.f27669g0) == null || pk0Var.j())) {
                ...
                if (motionEvent.getAction() == 1 && this.N && ((qk0Var.f27678l0 == null || qk0Var.f27680n0 > 0.8f) && qk0Var.f27669g0 != null)) {
                    qk0Var.f27685r0 = true;
                    if (System.currentTimeMillis() - qk0Var.f27687s0 > 300) {
                        qk0Var.f27687s0 = System.currentTimeMillis();
                        pk0 pk0Var2 = qk0Var.f27669g0;
                        zg.o0 o0Var = this.e;
                        if (qk0Var.f27680n0 > 0.8f) {
                            z10 = true;
                        } else {
                            z10 = false;
                        }
                ...
                if (!qk0Var.f27685r0 && qk0Var.f27678l0 != null) {
                    qk0Var.f27681o0 = 0.0f;
                    float f7 = qk0Var.f27680n0;
                    ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                    qk0Var.Q = ofFloat;
                    ofFloat.addUpdateListener(new ek0(qk0Var, f7));
                    qk0Var.Q.addListener(new ci.u5(qk0Var, 2));
                    qk0Var.Q.setDuration(150L);
                    qk0Var.Q.setInterpolator(rr.f28031f);
                    qk0Var.Q.start();
                }
