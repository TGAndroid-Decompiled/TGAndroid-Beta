...
public abstract class p71 extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ArrayList f27785a0;
    public y5 f27786b;
    public TLRPC.Document f27787b0;
    public long f27788c;
    public String f27789c0;
    public Uri d;
    public int f27790d0;
    public Runnable e;
    public n71 f27791f;
    ...
    public int f27792n;
    public int f27793r;
    public boolean f27794s;
    public Bitmap v;
    public Bitmap f27795w;
    public final Drawable f27796x;
    ...
    public p71(Context context, org.telegram.ui.br0 br0Var) {
        ...
        this.f27790d0 = -1;
        setVisibility(4);
        this.f27796x = context.getResources().getDrawable(R.drawable.videopreview);
    ...
    public final void a() {
        ...
        if (this.f27791f != null) {
            Utilities.globalQueue.cancelRunnable(this.f27791f);
            this.f27791f = null;
        }
        y5 y5Var = this.f27786b;
        if (y5Var != null) {
            AnimatedFileDrawableStream animatedFileDrawableStream = y5Var.f30858r0;
            if (animatedFileDrawableStream != null) {
                animatedFileDrawableStream.cancel(true);
            }
            if (y5Var.f30837a0 != null) {
                y5Var.f30837a0.h();
            }
        }
    ...
    public final void b(int i10) {
        int i11 = this.f27790d0;
        if (i11 == i10) {
            return;
        }
        if (i10 == -1) {
            NotificationCenter.getInstance(i11).removeObserver(this, NotificationCenter.fileLoaded);
            NotificationCenter.getInstance(this.f27790d0).removeObserver(this, NotificationCenter.fileLoadFailed);
        } else {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.fileLoaded) {
            if (((String) objArr[0]).equals(this.f27789c0)) {
                File pathToAttach = FileLoader.getInstance(i11).getPathToAttach(this.f27787b0);
        ...
        } else if (i10 == NotificationCenter.fileLoadFailed && ((String) objArr[0]).equals(this.f27789c0)) {
            this.f27789c0 = null;
            this.f27787b0 = null;
            b(-1);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Drawable drawable = this.f27796x;
        if (z4) {
            canvas.save();
            Path path = this.S;
            path.rewind();
            ...
            canvas.drawText(this.f27797y, (getMeasuredWidth() - this.B) / 2.0f, getMeasuredHeight() - AndroidUtilities.dp(9.0f), textPaint);
        } else if (this.f27795w != null && this.D != null) {
            Matrix matrix = this.I;
            matrix.reset();
            float measuredWidth = getMeasuredWidth() / this.f27795w.getWidth();
