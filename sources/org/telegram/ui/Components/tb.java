...
public final class tb extends qb implements NotificationCenter.NotificationCenterDelegate {
    public final rb d;
    public SparseLongArray f31309e;
    public final org.telegram.ui.ActionBar.p2 f31310f;
    public final int h;
    public ic f31311n;
    ...
    public tb(int i10, org.telegram.ui.ActionBar.p2 p2Var) {
        ...
        this.f31310f = p2Var;
        this.h = i10;
        this.f30359b.setLayoutParams(k7.c6.i(-2.0f, -2.0f, 8388659, 56.0f, 6.0f, 8.0f, 0.0f));
        this.f30358a.setLayoutParams(k7.c6.h(56.0f, 48.0f, 8388659));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.savedMessagesForwarded) {
            this.f31309e = (SparseLongArray) objArr[0];
        }
    }
    ...
    public final void f() {
        if (this.d.getReactionsWindow() != null) {
            this.d.e();
            if (this.d.getReactionsWindow().f16033a != null) {
                this.d.getReactionsWindow().f16033a.animate().alpha(0.0f).setDuration(180L).start();
            }
        }
    }
    ...
    public int getMeasuredBackgroundHeight() {
        return AndroidUtilities.dp(30.0f) + this.f30359b.getMeasuredHeight();
    }
