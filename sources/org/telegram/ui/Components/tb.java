...
public final class tb extends qb implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final org.telegram.ui.ActionBar.p2 f28951f;
    public final int h;
    public ic f28952n;
    ...
    public tb(int i10, org.telegram.ui.ActionBar.p2 p2Var) {
        ...
        this.f28951f = p2Var;
        this.h = i10;
        this.f28100b.setLayoutParams(k7.b6.i(-2.0f, -2.0f, 8388659, 56.0f, 6.0f, 8.0f, 0.0f));
        this.f28099a.setLayoutParams(k7.b6.h(56.0f, 48.0f, 8388659));
    ...
    public final void f() {
        if (this.d.getReactionsWindow() != null) {
            this.d.e();
            if (this.d.getReactionsWindow().f13972a != null) {
                this.d.getReactionsWindow().f13972a.animate().alpha(0.0f).setDuration(180L).start();
            }
        }
    }
    ...
    public int getMeasuredBackgroundHeight() {
        return AndroidUtilities.dp(30.0f) + this.f28100b.getMeasuredHeight();
    }
