...
public final class tj0 extends s4.h0 {
    ...
    public final int h() {
        int i10;
        ak0 ak0Var = this.h;
        int size = ak0Var.f22642n.size();
        if (!ak0Var.H.isEmpty() && !MessagesController.getInstance(this.f28422c).premiumFeaturesBlocked()) {
            i10 = 1;
        } else {
            i10 = 0;
        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        if (c1Var.f42932f == 0) {
            ((org.telegram.ui.Cells.o6) c1Var.f42929a).setUserReaction((TLRPC.MessagePeerReaction) this.h.f22642n.get(i10));
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            ...
            o6Var = new org.telegram.ui.Cells.o6(0, this.f28422c, this.d, this.e, true, this.f28423f);
        }
