...
public final class ko0 extends n81 {
    ...
    public final org.telegram.ui.zx f25847b;
    ...
    public final void b(View view, int i10, int i11) {
        org.telegram.ui.zx zxVar = this.f25847b;
    ...
    public final View d(int i10) {
        ...
        if (i10 == 3) {
            return zxVar.f26155f0;
        }
        if (i10 == 4) {
            return zxVar.f26160k0;
        }
        if (i10 == 5) {
            return zxVar.f26166r0;
        }
        if (i10 == 2) {
            in0 in0Var = new in0(zxVar.H0, qyVar);
            zxVar.G0 = in0Var;
            in0Var.b(zxVar.U0, zxVar.V0, false);
            zxVar.G0.f25120b.setClipToPadding(false);
            zxVar.G0.f25120b.j(new io0(this, 0));
            zxVar.G0.f25120b.C0(new ic0(zxVar, 24));
            zxVar.G0.setUiCallback(zxVar);
            return zxVar.G0;
        } else if (i10 == 6) {
            return zxVar.f26164p0;
        } else {
    ...
    public final int h(int i10) {
        ...
        return ((jo0) arrayList.get(i10)).f25458a + i10;
    }
    ...
    public final void i() {
        ...
        if (zxVar.T0 == 0) {
            ...
            if (!zxVar.O0) {
                ...
                org.telegram.ui.kx kxVar = zxVar.f40590b1.F3;
