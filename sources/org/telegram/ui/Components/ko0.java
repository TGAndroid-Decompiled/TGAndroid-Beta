...
public class ko0 extends FrameLayout {
    public static float[] f28453g0;
    public static Path f28454h0;
    ...
    public TextPaint V;
    public float W;
    public final org.telegram.ui.Cells.e1 f28455a;
    public int f28456a0;
    public final Paint f28457b;
    public long f28458b0;
    public final Paint f28459c;
    public float f28460c0;
    public final int d;
    public final RectF f28461d0;
    ...
    private void setTimestampIndex(int i10) {
        if (this.f28463e0 != i10) {
            this.f28463e0 = i10;
            if (i10 >= 0 && i10 < this.P.size()) {
                this.K.setText((CharSequence) ((Pair) this.P.get(this.f28463e0)).second);
            }
        }
    }
    ...
    public final int c() {
        return Math.max((int) (this.f28468s * (getMeasuredWidth() - this.f28462e)), 0);
    }
        ...
        if (action != 1 && motionEvent.getAction() != 3) {
                ...
                if (!this.L) {
                    ...
                    if (Math.abs(motionEvent.getY() - this.N) <= viewConfiguration.getScaledTouchSlop() && Math.abs(motionEvent.getX() - this.M) > viewConfiguration.getScaledTouchSlop()) {
                        ...
                        if (motionEvent.getY() >= 0.0f && motionEvent.getY() <= getMeasuredHeight()) {
                            if (this.f28464f - measuredHeight > motionEvent.getX() || motionEvent.getX() > this.f28464f + i10 + measuredHeight) {
                                int x10 = ((int) motionEvent.getX()) - (i10 / 2);
                                this.f28464f = x10;
                                if (x10 < c()) {
                                    this.f28464f = c();
                                } else if (this.f28464f > getMeasuredWidth() - i11) {
                                    this.f28464f = getMeasuredWidth() - i11;
                                }
                            }
                            this.f28466n = (int) (motionEvent.getX() - this.f28464f);
                            this.v = true;
                            this.f28469w.A();
                            if (zVar != null) {
                    ...
                    int x11 = (int) (motionEvent.getX() - this.f28466n);
                    this.f28464f = x11;
                    if (x11 < c()) {
                        this.f28464f = c();
                    } else if (this.f28464f > getMeasuredWidth() - i11) {
                    ...
                    if (this.f28470x) {
                        if (this.I) {
                            ...
                            f(this.f28464f / (getMeasuredWidth() - i11), false);
                        }
                    }
                    if (zVar != null) {
                        zVar.setHotspot(motionEvent.getX(), motionEvent.getY());
            ...
            if (motionEvent.getAction() == 1) {
                if (Math.abs(motionEvent.getY() - this.N) < ViewConfiguration.get(getContext()).getScaledTouchSlop()) {
                    ...
                    if (this.f28464f - measuredHeight2 > motionEvent.getX() || motionEvent.getX() > this.f28464f + i10 + measuredHeight2) {
            ...
            if (this.v) {
                if (motionEvent.getAction() == 1) {
                    if (this.I) {
                        ...
                        f(this.f28464f / (getMeasuredWidth() - i11), true);
                    }
                }
                if (zVar != null) {
    ...
    public final void e(float f10, boolean z4) {
        ...
        if (i12 != i11) {
            ...
            if (i11 < c()) {
                this.f28464f = c();
            } else if (this.f28464f > getMeasuredWidth() - i10) {
                this.f28464f = getMeasuredWidth() - i10;
            }
            invalidate();
        }
    }
    ...
    public final void g(MessageObject messageObject) {
        ...
        if (z4 || this.R != valueOf.longValue()) {
            ...
            if (getTimestampLabelWidth() != this.f28465f0) {
                requestLayout();
            }
    ...
    public float getProgress() {
        ...
        return this.f28464f / (getMeasuredWidth() - this.f28462e);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f24 = this.E;
        if (f24 < 1.0f) {
            float interpolation = 1.0f - jt.f28178c.getInterpolation(Math.min(1.0f, f24 * 3.0f));
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            if (this.W < 1.0f) {
                long min = Math.min(17L, Math.abs(SystemClock.elapsedRealtime() - this.f28458b0));
                if (this.P.size() > 8) {
                    f15 = 160.0f;
                } else {
                    f15 = 220.0f;
                ...
                invalidate();
                this.f28458b0 = SystemClock.elapsedRealtime();
            }
            if (this.S < 1.0f) {
                this.S = Math.min((((float) Math.min(17L, Math.abs(SystemClock.elapsedRealtime() - this.f28458b0))) / 200.0f) + this.S, 1.0f);
                invalidate();
                SystemClock.elapsedRealtime();
            }
            float interpolation3 = pr.f30168f.getInterpolation(this.W);
            canvas2.save();
            ...
            if (this.U[1] != null) {
                ...
                if (this.f28456a0 != 0) {
                    f14 = 0.0f;
                    canvas2.translate((AndroidUtilities.dp(f11) * (-this.f28456a0) * interpolation3) + AndroidUtilities.dp(f12), 0.0f);
                } else {
                    f14 = 0.0f;
                }
            ...
            if (this.U[0] != null) {
                ...
                if (this.f28456a0 != 0) {
                    f13 = 0.0f;
                    canvas2.translate(e2.c.w(1.0f, interpolation3, AndroidUtilities.dp(f11) * this.f28456a0, AndroidUtilities.dp(f12)), 0.0f);
                } else {
                    f13 = 0.0f;
                }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f28465f0 = timestampLabelWidth;
        this.K.measure(View.MeasureSpec.makeMeasureSpec(timestampLabelWidth, 1073741824), 0);
        if (this.f28467r != -100.0f && getMeasuredWidth() > 0) {
            setProgress(this.f28467r);
            this.f28467r = -100.0f;
        }
    }
    ...
    public ko0(Context context, org.telegram.ui.ActionBar.g6 g6Var, boolean z4) {
        super(context);
        this.h = new z5(this, 0L, 60L, pr.f30169g);
        this.f28467r = -100.0f;
        this.f28468s = -1.0f;
        ...
        this.f28462e = AndroidUtilities.dp(32.0f);
