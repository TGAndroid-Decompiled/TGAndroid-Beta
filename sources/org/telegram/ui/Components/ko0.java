...
public final class ko0 extends n81 {
    public final ArrayList f25828a = new ArrayList();
    public final org.telegram.ui.zx f25829b;
    ...
    public final void b(View view, int i10, int i11) {
        org.telegram.ui.zx zxVar = this.f25829b;
    ...
    public final View d(int i10) {
        ...
        if (i10 == 3) {
            return zxVar.f26148f0;
        }
        if (i10 == 4) {
            return zxVar.f26153k0;
        }
        if (i10 == 5) {
            return zxVar.f26159r0;
        }
        if (i10 == 2) {
            in0 in0Var = new in0(zxVar.H0, qyVar);
            zxVar.G0 = in0Var;
            in0Var.b(zxVar.U0, zxVar.V0, false);
            zxVar.G0.f25094b.setClipToPadding(false);
            zxVar.G0.f25094b.j(new io0(this, 0));
            zxVar.G0.f25094b.C0(new ic0(zxVar, 24));
            zxVar.G0.setUiCallback(zxVar);
            return zxVar.G0;
        } else if (i10 == 6) {
            return zxVar.f26157p0;
        } else {
    ...
    public final CharSequence g(int i10) {
        ArrayList arrayList = this.f25828a;
        if (((jo0) arrayList.get(i10)).f25452a == 0) {
            return LocaleController.getString(R.string.SearchAllChatsShort);
        }
        if (((jo0) arrayList.get(i10)).f25452a == 1) {
            return LocaleController.getString(R.string.ChannelsTab);
        }
        if (((jo0) arrayList.get(i10)).f25452a == 4) {
            return LocaleController.getString(R.string.AppsTab);
        }
        if (((jo0) arrayList.get(i10)).f25452a == 6) {
            return LocaleController.getString(R.string.SearchPosts);
        }
        if (((jo0) arrayList.get(i10)).f25452a == 2) {
            return LocaleController.getString(R.string.DownloadsTabs);
        }
        if (((jo0) arrayList.get(i10)).f25452a == 5) {
            return LocaleController.getString(R.string.PublicPostsTabs);
        }
        gg.q0 q0Var = gg.s0.f9896c3[((jo0) arrayList.get(i10)).f25453b];
    ...
    public final int h(int i10) {
        ...
        return ((jo0) arrayList.get(i10)).f25452a + i10;
    }
    ...
    public final void i() {
        ...
        if (zxVar.T0 == 0) {
            ...
            if (!zxVar.O0) {
                ...
                org.telegram.ui.kx kxVar = zxVar.f40576b1.F3;
