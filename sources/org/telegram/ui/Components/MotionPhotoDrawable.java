...
public class MotionPhotoDrawable extends Drawable {
    ...
    public MotionPhotoDrawable() {
        ...
        this.animatedDisabled = new AnimatedFloat(new Runnable() {
            @Override
    ...
    public void draw(Canvas canvas) {
        ...
        if (f > 0.0f) {
            if (this.disabled) {
                ...
                canvas.drawLine(fCenterX - AndroidUtilities.dpf2(8.33f), fCenterY - AndroidUtilities.dpf2(8.33f), (fCenterX - AndroidUtilities.dpf2(8.33f)) + (AndroidUtilities.dpf2(16.66f) * f), (fCenterY - AndroidUtilities.dpf2(8.33f)) + (AndroidUtilities.dpf2(16.66f) * f), this.strokePaint);
            } else {
