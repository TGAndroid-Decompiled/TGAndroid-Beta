...
public class CropAreaView extends ViewGroup {
    ...
    public float W;
    public int f22225a;
    public boolean f22226a0;
    public float f22227b;
    public float f22228b0;
    public float f22229c;
    public ObjectAnimator f22230c0;
    public RectF d;
    public a f22231d0;
    public RectF e;
    public boolean f22232e0;
    public RectF f22233f;
    public boolean f22234f0;
    public Bitmap f22235g0;
    public RectF h;
    public Paint f22236h0;
    public String f22237i0;
    public StaticLayout f22238j0;
    public AnimatorSet f22239k0;
    public RectF f22240l0;
    public TextPaint m0;
    public RectF f22241n;
    public float f22242n0;
    public float f22243o0;
    public float f22244p0;
    public float f22245q0;
    public RectF f22246r;
    public int f22247r0;
    public RectF f22248s;
    public int f22249s0;
    public int f22250t0;
    public RectF v;
    public float f22251w;
    public RectF f22252x;
    public RectF f22253y;
    ...
    public final void g(int i10, boolean z10) {
        float f7;
        ObjectAnimator objectAnimator = this.f22230c0;
        if (objectAnimator != null && (!z10 || this.f22250t0 != i10)) {
            objectAnimator.cancel();
            this.f22230c0 = null;
        }
        int i11 = this.f22250t0;
        if (i11 == i10) {
            return;
        }
        this.f22249s0 = i11;
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this, "gridProgress", this.f22228b0, f7);
        this.f22230c0 = ofFloat;
        ofFloat.setDuration(200L);
        this.f22230c0.addListener(new b(this, 25));
        if (i10 == 1) {
            this.f22230c0.setStartDelay(200L);
        }
        this.f22230c0.start();
    }

    public float getAspectRatio() {
        RectF rectF = this.f22252x;
        return (rectF.right - rectF.left) / (rectF.bottom - rectF.top);
    }

    public float getCropBottom() {
        return this.f22252x.bottom;
    }
    ...
    public float getCropLeft() {
        return this.f22252x.left;
    }

    public float getCropRight() {
        return this.f22252x.right;
    }

    public float getCropTop() {
        return this.f22252x.top;
    }
    ...
    public final void i() {
        if (this.f22237i0 != null) {
            ...
            this.f22238j0 = new StaticLayout(this.f22237i0, this.m0, getMeasuredWidth() - AndroidUtilities.dp(120.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            return;
        }
        this.f22238j0 = null;
    }
    ...
    public final void j() {
        ...
        this.f22241n.set(rectF2.left + f10, f18 - f10, rectF2.right - f10, f18 + f10);
        RectF rectF6 = this.f22246r;
        ...
        this.f22248s.set(rectF2.left + f10, f21 - f10, rectF2.right - f10, f21 + f10);
    }
        ...
        if (actionMasked == 0) {
            if (this.f22234f0) {
                ...
                if (this.d.contains(f11, f12)) {
                    ...
                    this.f22247r0 = 3;
                } else if (this.f22233f.contains(f11, f12)) {
                    this.f22247r0 = 4;
                } else if (this.h.contains(f11, f12)) {
                    this.f22247r0 = 5;
                } else if (this.f22246r.contains(f11, f12)) {
                    this.f22247r0 = 7;
                } else if (this.f22241n.contains(f11, f12)) {
                    this.f22247r0 = 6;
                } else if (this.v.contains(f11, f12)) {
                    this.f22247r0 = 9;
                } else if (this.f22248s.contains(f11, f12)) {
                    this.f22247r0 = 8;
                } else {
                    this.f22247r0 = 1;
                    return false;
                ...
                this.f22232e0 = true;
                h(true);
                a aVar = this.f22231d0;
                if (aVar != null) {
                    p pVar = (p) aVar;
                    pVar.f14323a.d(pVar.f14326f);
                    pVar.f14327n = 0.0f;
                    o oVar = pVar.M;
                    if (oVar != null) {
                        oVar.e0(false);
            ...
            if (actionMasked == 2 && this.f22247r0 != 1) {
                rectF.set(this.f22252x);
                ...
                switch (j.c(this.f22247r0)) {
                    case 1:
                        rectF.left += f13;
                        rectF.top += f14;
                        if (this.f22251w > 0.0f) {
                            float width = rectF.width();
                            float height = rectF.height();
                            if (z10) {
                                c(rectF, this.f22251w);
                            } else {
                                b(rectF, this.f22251w);
                            }
                ...
                if (rectF.left < f7) {
                    ...
                    if (this.f22251w > 0.0f) {
                        rectF.bottom = (rectF.width() / this.f22251w) + rectF.top;
                    }
                }
                float f21 = f10 + this.H + f7;
                float f22 = this.G + f7;
                if (rectF.top < f21) {
                    float f23 = this.f22251w;
                    if (f23 > 0.0f) {
                    ...
                    if (this.f22251w > 0.0f) {
                        rectF.right = (rectF.height() * this.f22251w) + rectF.left;
                    }
                }
                ...
                setActualRect(rectF);
                a aVar2 = this.f22231d0;
                if (aVar2 != null) {
                    p pVar2 = (p) aVar2;
                    CropAreaView cropAreaView = pVar2.f14323a;
                    cropAreaView.g(3, false);
                    RectF rectF2 = pVar2.f14326f;
                    ...
                    pVar2.r(false);
                    rectF2.set(cropAreaView.f22252x);
            ...
            if (this.f22247r0 != 1) {
                this.f22247r0 = 1;
                a aVar3 = this.f22231d0;
                if (aVar3 != null) {
                    p pVar3 = (p) aVar3;
                    CropAreaView cropAreaView2 = pVar3.f14323a;
