...
public class CropAreaView extends ViewGroup {
    ...
    public float W;
    public int f22003a;
    public boolean f22004a0;
    public float f22005b;
    public float f22006b0;
    public float f22007c;
    public ObjectAnimator f22008c0;
    public RectF d;
    public a f22009d0;
    public RectF e;
    public boolean f22010e0;
    public RectF f22011f;
    public boolean f22012f0;
    public Bitmap f22013g0;
    public RectF h;
    public Paint f22014h0;
    public String f22015i0;
    public StaticLayout f22016j0;
    public AnimatorSet f22017k0;
    public RectF f22018l0;
    public TextPaint m0;
    public RectF f22019n;
    public float f22020n0;
    public float f22021o0;
    public float f22022p0;
    public float f22023q0;
    public RectF f22024r;
    public int f22025r0;
    public RectF f22026s;
    public int f22027s0;
    public int f22028t0;
    public RectF v;
    public float f22029w;
    public RectF f22030x;
    public RectF f22031y;
    ...
    public final void g(int i10, boolean z10) {
        float f7;
        ObjectAnimator objectAnimator = this.f22008c0;
        if (objectAnimator != null && (!z10 || this.f22028t0 != i10)) {
            objectAnimator.cancel();
            this.f22008c0 = null;
        }
        int i11 = this.f22028t0;
        if (i11 == i10) {
            return;
        }
        this.f22027s0 = i11;
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this, "gridProgress", this.f22006b0, f7);
        this.f22008c0 = ofFloat;
        ofFloat.setDuration(200L);
        this.f22008c0.addListener(new b(this, 25));
        if (i10 == 1) {
            this.f22008c0.setStartDelay(200L);
        }
        this.f22008c0.start();
    }

    public float getAspectRatio() {
        RectF rectF = this.f22030x;
        return (rectF.right - rectF.left) / (rectF.bottom - rectF.top);
    }

    public float getCropBottom() {
        return this.f22030x.bottom;
    }
    ...
    public float getCropLeft() {
        return this.f22030x.left;
    }

    public float getCropRight() {
        return this.f22030x.right;
    }

    public float getCropTop() {
        return this.f22030x.top;
    }
    ...
    public final void i() {
        if (this.f22015i0 != null) {
            ...
            this.f22016j0 = new StaticLayout(this.f22015i0, this.m0, getMeasuredWidth() - AndroidUtilities.dp(120.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            return;
        }
        this.f22016j0 = null;
    }
    ...
    public final void j() {
        ...
        this.f22019n.set(rectF2.left + f10, f18 - f10, rectF2.right - f10, f18 + f10);
        RectF rectF6 = this.f22024r;
        ...
        this.f22026s.set(rectF2.left + f10, f21 - f10, rectF2.right - f10, f21 + f10);
    }
        ...
        if (actionMasked == 0) {
            if (this.f22012f0) {
                ...
                if (this.d.contains(f11, f12)) {
                    ...
                    this.f22025r0 = 3;
                } else if (this.f22011f.contains(f11, f12)) {
                    this.f22025r0 = 4;
                } else if (this.h.contains(f11, f12)) {
                    this.f22025r0 = 5;
                } else if (this.f22024r.contains(f11, f12)) {
                    this.f22025r0 = 7;
                } else if (this.f22019n.contains(f11, f12)) {
                    this.f22025r0 = 6;
                } else if (this.v.contains(f11, f12)) {
                    this.f22025r0 = 9;
                } else if (this.f22026s.contains(f11, f12)) {
                    this.f22025r0 = 8;
                } else {
                    this.f22025r0 = 1;
                    return false;
                ...
                this.f22010e0 = true;
                h(true);
                a aVar = this.f22009d0;
                if (aVar != null) {
                    p pVar = (p) aVar;
                    pVar.f14097a.d(pVar.f14100f);
                    pVar.f14101n = 0.0f;
                    o oVar = pVar.M;
                    if (oVar != null) {
                        oVar.g0(false);
            ...
            if (actionMasked == 2 && this.f22025r0 != 1) {
                rectF.set(this.f22030x);
                ...
                switch (j.c(this.f22025r0)) {
                    case 1:
                        rectF.left += f13;
                        rectF.top += f14;
                        if (this.f22029w > 0.0f) {
                            float width = rectF.width();
                            float height = rectF.height();
                            if (z10) {
                                c(rectF, this.f22029w);
                            } else {
                                b(rectF, this.f22029w);
                            }
                ...
                if (rectF.left < f7) {
                    ...
                    if (this.f22029w > 0.0f) {
                        rectF.bottom = (rectF.width() / this.f22029w) + rectF.top;
                    }
                }
                float f21 = f10 + this.H + f7;
                float f22 = this.G + f7;
                if (rectF.top < f21) {
                    float f23 = this.f22029w;
                    if (f23 > 0.0f) {
                    ...
                    if (this.f22029w > 0.0f) {
                        rectF.right = (rectF.height() * this.f22029w) + rectF.left;
                    }
                }
                ...
                setActualRect(rectF);
                a aVar2 = this.f22009d0;
                if (aVar2 != null) {
                    p pVar2 = (p) aVar2;
                    CropAreaView cropAreaView = pVar2.f14097a;
                    cropAreaView.g(3, false);
                    RectF rectF2 = pVar2.f14100f;
                    ...
                    pVar2.r(false);
                    rectF2.set(cropAreaView.f22030x);
            ...
            if (this.f22025r0 != 1) {
                this.f22025r0 = 1;
                a aVar3 = this.f22009d0;
                if (aVar3 != null) {
                    p pVar3 = (p) aVar3;
                    CropAreaView cropAreaView2 = pVar3.f14097a;
