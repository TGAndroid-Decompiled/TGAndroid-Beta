...
public class CropAreaView extends ViewGroup {
    ...
    public boolean f24846b0;
    public float f24847c;
    public boolean f24848c0;
    public RectF d;
    public Bitmap f24849d0;
    public RectF f24850e;
    public Paint f24851e0;
    public RectF f24852f;
    public String f24853f0;
    public StaticLayout f24854g0;
    public RectF h;
    public AnimatorSet f24855h0;
    public RectF f24856i0;
    public TextPaint f24857j0;
    public float f24858k0;
    public float f24859l0;
    public float m0;
    public RectF f24860n;
    public float f24861n0;
    public int f24862o0;
    public int f24863p0;
    public int f24864q0;
    ...
    public RectF v;
    public float f24867w;
    public RectF f24868x;
    public RectF f24869y;
    ...
    public final void g(int i10, boolean z4) {
        ...
        if (objectAnimator != null && (!z4 || this.f24864q0 != i10)) {
            objectAnimator.cancel();
            this.W = null;
        }
        int i11 = this.f24864q0;
        if (i11 == i10) {
            return;
        }
        this.f24863p0 = i11;
    ...
    public float getAspectRatio() {
        RectF rectF = this.f24868x;
        return (rectF.right - rectF.left) / (rectF.bottom - rectF.top);
    }

    public float getCropBottom() {
        return this.f24868x.bottom;
    }
    ...
    public float getCropLeft() {
        return this.f24868x.left;
    }

    public float getCropRight() {
        return this.f24868x.right;
    }

    public float getCropTop() {
        return this.f24868x.top;
    }
    ...
    public final void i() {
        if (this.f24853f0 != null) {
            if (this.f24857j0 == null) {
                TextPaint textPaint = new TextPaint();
                this.f24857j0 = textPaint;
                textPaint.setColor(i0.a.k(-1, 120));
                this.f24857j0.setTextSize(AndroidUtilities.dp(13.0f));
                this.f24857j0.setTextAlign(Paint.Align.CENTER);
            }
            this.f24854g0 = new StaticLayout(this.f24853f0, this.f24857j0, getMeasuredWidth() - AndroidUtilities.dp(120.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            return;
        }
        this.f24854g0 = null;
    }
    ...
    public final void j() {
        ...
        RectF rectF = this.d;
        RectF rectF2 = this.f24868x;
        float f10 = rectF2.left;
        float f11 = dp;
        float f12 = rectF2.top;
        rectF.set(f10 - f11, f12 - f11, f10 + f11, f12 + f11);
        RectF rectF3 = this.f24850e;
        float f13 = rectF2.right;
        float f14 = rectF2.top;
        rectF3.set(f13 - f11, f14 - f11, f13 + f11, f14 + f11);
        RectF rectF4 = this.f24852f;
        ...
        this.f24860n.set(rectF2.left + f11, f19 - f11, rectF2.right - f11, f19 + f11);
        RectF rectF6 = this.f24865r;
        ...
        this.f24866s.set(rectF2.left + f11, f22 - f11, rectF2.right - f11, f22 + f11);
    }
        ...
        if (actionMasked == 0) {
            if (this.f24848c0) {
                ...
                if (this.d.contains(f12, f13)) {
                    this.f24862o0 = 2;
                } else if (this.f24850e.contains(f12, f13)) {
                    this.f24862o0 = 3;
                } else if (this.f24852f.contains(f12, f13)) {
                    this.f24862o0 = 4;
                } else if (this.h.contains(f12, f13)) {
                    this.f24862o0 = 5;
                } else if (this.f24865r.contains(f12, f13)) {
                    this.f24862o0 = 7;
                } else if (this.f24860n.contains(f12, f13)) {
                    this.f24862o0 = 6;
                } else if (this.v.contains(f12, f13)) {
                    this.f24862o0 = 9;
                } else if (this.f24866s.contains(f12, f13)) {
                    this.f24862o0 = 8;
                } else {
                    this.f24862o0 = 1;
                    return false;
            ...
            if (actionMasked == 2 && this.f24862o0 != 1) {
                rectF.set(this.f24868x);
                ...
                switch (j.c(this.f24862o0)) {
                    case 1:
                        rectF.left += f14;
                        rectF.top += f15;
                        if (this.f24867w > 0.0f) {
                            float width = rectF.width();
                            float height = rectF.height();
                            if (z4) {
                                c(rectF, this.f24867w);
                            } else {
                                b(rectF, this.f24867w);
                            }
                ...
                if (rectF.left < f10) {
                    ...
                    if (this.f24867w > 0.0f) {
                        rectF.bottom = (rectF.width() / this.f24867w) + rectF.top;
                    }
                }
                float f22 = f11 + this.E + f10;
                float f23 = this.D + f10;
                if (rectF.top < f22) {
                    float f24 = this.f24867w;
                    if (f24 > 0.0f) {
                    ...
                    if (this.f24867w > 0.0f) {
                        rectF.right = (rectF.height() * this.f24867w) + rectF.left;
                    }
                }
                ...
                if (aVar2 != null) {
                    ...
                    nVar2.r(false);
                    rectF2.set(cropAreaView.f24868x);
