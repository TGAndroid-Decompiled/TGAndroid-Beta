...
public class CropAreaView extends ViewGroup {
    ...
    public float W;
    public int f22013a;
    public boolean f22014a0;
    public float f22015b;
    public float f22016b0;
    public float f22017c;
    public ObjectAnimator f22018c0;
    public RectF d;
    public a f22019d0;
    public RectF e;
    public boolean f22020e0;
    public RectF f22021f;
    public boolean f22022f0;
    public Bitmap f22023g0;
    public RectF h;
    public Paint f22024h0;
    public String f22025i0;
    public StaticLayout f22026j0;
    public AnimatorSet f22027k0;
    public RectF f22028l0;
    public TextPaint m0;
    public RectF f22029n;
    public float f22030n0;
    public float f22031o0;
    public float f22032p0;
    public float f22033q0;
    public RectF f22034r;
    public int f22035r0;
    public RectF f22036s;
    public int f22037s0;
    public int f22038t0;
    public RectF v;
    public float f22039w;
    public RectF f22040x;
    public RectF f22041y;
    ...
    public final void g(int i10, boolean z10) {
        float f7;
        ObjectAnimator objectAnimator = this.f22018c0;
        if (objectAnimator != null && (!z10 || this.f22038t0 != i10)) {
            objectAnimator.cancel();
            this.f22018c0 = null;
        }
        int i11 = this.f22038t0;
        if (i11 == i10) {
            return;
        }
        this.f22037s0 = i11;
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this, "gridProgress", this.f22016b0, f7);
        this.f22018c0 = ofFloat;
        ofFloat.setDuration(200L);
        this.f22018c0.addListener(new b(this, 25));
        if (i10 == 1) {
            this.f22018c0.setStartDelay(200L);
        }
        this.f22018c0.start();
    }

    public float getAspectRatio() {
        RectF rectF = this.f22040x;
        return (rectF.right - rectF.left) / (rectF.bottom - rectF.top);
    }

    public float getCropBottom() {
        return this.f22040x.bottom;
    }
    ...
    public float getCropLeft() {
        return this.f22040x.left;
    }

    public float getCropRight() {
        return this.f22040x.right;
    }

    public float getCropTop() {
        return this.f22040x.top;
    }
    ...
    public final void i() {
        if (this.f22025i0 != null) {
            ...
            this.f22026j0 = new StaticLayout(this.f22025i0, this.m0, getMeasuredWidth() - AndroidUtilities.dp(120.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            return;
        }
        this.f22026j0 = null;
    }
    ...
    public final void j() {
        ...
        this.f22029n.set(rectF2.left + f10, f18 - f10, rectF2.right - f10, f18 + f10);
        RectF rectF6 = this.f22034r;
        ...
        this.f22036s.set(rectF2.left + f10, f21 - f10, rectF2.right - f10, f21 + f10);
    }
        ...
        if (actionMasked == 0) {
            if (this.f22022f0) {
                ...
                if (this.d.contains(f11, f12)) {
                    ...
                    this.f22035r0 = 3;
                } else if (this.f22021f.contains(f11, f12)) {
                    this.f22035r0 = 4;
                } else if (this.h.contains(f11, f12)) {
                    this.f22035r0 = 5;
                } else if (this.f22034r.contains(f11, f12)) {
                    this.f22035r0 = 7;
                } else if (this.f22029n.contains(f11, f12)) {
                    this.f22035r0 = 6;
                } else if (this.v.contains(f11, f12)) {
                    this.f22035r0 = 9;
                } else if (this.f22036s.contains(f11, f12)) {
                    this.f22035r0 = 8;
                } else {
                    this.f22035r0 = 1;
                    return false;
                ...
                this.f22020e0 = true;
                h(true);
                a aVar = this.f22019d0;
                if (aVar != null) {
                    p pVar = (p) aVar;
                    pVar.f14110a.d(pVar.f14113f);
                    pVar.f14114n = 0.0f;
                    o oVar = pVar.M;
                    if (oVar != null) {
                        oVar.g0(false);
            ...
            if (actionMasked == 2 && this.f22035r0 != 1) {
                rectF.set(this.f22040x);
                ...
                switch (j.c(this.f22035r0)) {
                    case 1:
                        rectF.left += f13;
                        rectF.top += f14;
                        if (this.f22039w > 0.0f) {
                            float width = rectF.width();
                            float height = rectF.height();
                            if (z10) {
                                c(rectF, this.f22039w);
                            } else {
                                b(rectF, this.f22039w);
                            }
                ...
                if (rectF.left < f7) {
                    ...
                    if (this.f22039w > 0.0f) {
                        rectF.bottom = (rectF.width() / this.f22039w) + rectF.top;
                    }
                }
                float f21 = f10 + this.H + f7;
                float f22 = this.G + f7;
                if (rectF.top < f21) {
                    float f23 = this.f22039w;
                    if (f23 > 0.0f) {
                    ...
                    if (this.f22039w > 0.0f) {
                        rectF.right = (rectF.height() * this.f22039w) + rectF.left;
                    }
                }
                ...
                setActualRect(rectF);
                a aVar2 = this.f22019d0;
                if (aVar2 != null) {
                    p pVar2 = (p) aVar2;
                    CropAreaView cropAreaView = pVar2.f14110a;
                    cropAreaView.g(3, false);
                    RectF rectF2 = pVar2.f14113f;
                    ...
                    pVar2.r(false);
                    rectF2.set(cropAreaView.f22040x);
            ...
            if (this.f22035r0 != 1) {
                this.f22035r0 = 1;
                a aVar3 = this.f22019d0;
                if (aVar3 != null) {
                    p pVar3 = (p) aVar3;
                    CropAreaView cropAreaView2 = pVar3.f14110a;
