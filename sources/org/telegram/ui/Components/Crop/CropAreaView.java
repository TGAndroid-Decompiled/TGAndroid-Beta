...
public class CropAreaView extends ViewGroup {
    ...
    public float W;
    public int f21974a;
    public boolean f21975a0;
    public float f21976b;
    public float f21977b0;
    public float f21978c;
    public ObjectAnimator f21979c0;
    public RectF d;
    public a f21980d0;
    public RectF e;
    public boolean f21981e0;
    public RectF f21982f;
    public boolean f21983f0;
    public Bitmap f21984g0;
    public RectF h;
    public Paint f21985h0;
    public String f21986i0;
    public StaticLayout f21987j0;
    public AnimatorSet f21988k0;
    public RectF f21989l0;
    public TextPaint m0;
    public RectF f21990n;
    public float f21991n0;
    public float f21992o0;
    public float f21993p0;
    public float f21994q0;
    public RectF f21995r;
    public int f21996r0;
    public RectF f21997s;
    public int f21998s0;
    public int f21999t0;
    public RectF v;
    public float f22000w;
    public RectF f22001x;
    public RectF f22002y;
    ...
    public final void g(int i10, boolean z10) {
        float f7;
        ObjectAnimator objectAnimator = this.f21979c0;
        if (objectAnimator != null && (!z10 || this.f21999t0 != i10)) {
            objectAnimator.cancel();
            this.f21979c0 = null;
        }
        int i11 = this.f21999t0;
        if (i11 == i10) {
            return;
        }
        this.f21998s0 = i11;
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this, "gridProgress", this.f21977b0, f7);
        this.f21979c0 = ofFloat;
        ofFloat.setDuration(200L);
        this.f21979c0.addListener(new b(this, 25));
        if (i10 == 1) {
            this.f21979c0.setStartDelay(200L);
        }
        this.f21979c0.start();
    }

    public float getAspectRatio() {
        RectF rectF = this.f22001x;
        return (rectF.right - rectF.left) / (rectF.bottom - rectF.top);
    }

    public float getCropBottom() {
        return this.f22001x.bottom;
    }
    ...
    public float getCropLeft() {
        return this.f22001x.left;
    }

    public float getCropRight() {
        return this.f22001x.right;
    }

    public float getCropTop() {
        return this.f22001x.top;
    }
    ...
    public final void i() {
        if (this.f21986i0 != null) {
            ...
            this.f21987j0 = new StaticLayout(this.f21986i0, this.m0, getMeasuredWidth() - AndroidUtilities.dp(120.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            return;
        }
        this.f21987j0 = null;
    }
    ...
    public final void j() {
        ...
        this.f21990n.set(rectF2.left + f10, f18 - f10, rectF2.right - f10, f18 + f10);
        RectF rectF6 = this.f21995r;
        ...
        this.f21997s.set(rectF2.left + f10, f21 - f10, rectF2.right - f10, f21 + f10);
    }
        ...
        if (actionMasked == 0) {
            if (this.f21983f0) {
                ...
                if (this.d.contains(f11, f12)) {
                    ...
                    this.f21996r0 = 3;
                } else if (this.f21982f.contains(f11, f12)) {
                    this.f21996r0 = 4;
                } else if (this.h.contains(f11, f12)) {
                    this.f21996r0 = 5;
                } else if (this.f21995r.contains(f11, f12)) {
                    this.f21996r0 = 7;
                } else if (this.f21990n.contains(f11, f12)) {
                    this.f21996r0 = 6;
                } else if (this.v.contains(f11, f12)) {
                    this.f21996r0 = 9;
                } else if (this.f21997s.contains(f11, f12)) {
                    this.f21996r0 = 8;
                } else {
                    this.f21996r0 = 1;
                    return false;
                ...
                this.f21981e0 = true;
                h(true);
                a aVar = this.f21980d0;
                if (aVar != null) {
                    p pVar = (p) aVar;
                    pVar.f14088a.d(pVar.f14091f);
                    pVar.f14092n = 0.0f;
                    o oVar = pVar.M;
                    if (oVar != null) {
                        oVar.g0(false);
            ...
            if (actionMasked == 2 && this.f21996r0 != 1) {
                rectF.set(this.f22001x);
                ...
                switch (j.c(this.f21996r0)) {
                    case 1:
                        rectF.left += f13;
                        rectF.top += f14;
                        if (this.f22000w > 0.0f) {
                            float width = rectF.width();
                            float height = rectF.height();
                            if (z10) {
                                c(rectF, this.f22000w);
                            } else {
                                b(rectF, this.f22000w);
                            }
                ...
                if (rectF.left < f7) {
                    ...
                    if (this.f22000w > 0.0f) {
                        rectF.bottom = (rectF.width() / this.f22000w) + rectF.top;
                    }
                }
                float f21 = f10 + this.H + f7;
                float f22 = this.G + f7;
                if (rectF.top < f21) {
                    float f23 = this.f22000w;
                    if (f23 > 0.0f) {
                    ...
                    if (this.f22000w > 0.0f) {
                        rectF.right = (rectF.height() * this.f22000w) + rectF.left;
                    }
                }
                ...
                setActualRect(rectF);
                a aVar2 = this.f21980d0;
                if (aVar2 != null) {
                    p pVar2 = (p) aVar2;
                    CropAreaView cropAreaView = pVar2.f14088a;
                    cropAreaView.g(3, false);
                    RectF rectF2 = pVar2.f14091f;
                    ...
                    pVar2.r(false);
                    rectF2.set(cropAreaView.f22001x);
            ...
            if (this.f21996r0 != 1) {
                this.f21996r0 = 1;
                a aVar3 = this.f21980d0;
                if (aVar3 != null) {
                    p pVar3 = (p) aVar3;
                    CropAreaView cropAreaView2 = pVar3.f14088a;
