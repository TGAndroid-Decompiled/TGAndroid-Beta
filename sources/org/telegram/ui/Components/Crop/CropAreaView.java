...
public class CropAreaView extends ViewGroup {
    ...
    public float f23971b0;
    public float f23972c;
    public ObjectAnimator f23973c0;
    public RectF d;
    public a f23974d0;
    public RectF f23975e;
    public boolean f23976e0;
    public RectF f23977f;
    public boolean f23978f0;
    public Bitmap f23979g0;
    public RectF h;
    public Paint f23980h0;
    public String f23981i0;
    public StaticLayout f23982j0;
    public AnimatorSet f23983k0;
    public RectF f23984l0;
    public TextPaint m0;
    public RectF f23985n;
    public float f23986n0;
    public float f23987o0;
    public float f23988p0;
    public float f23989q0;
    public RectF f23990r;
    public int f23991r0;
    public RectF f23992s;
    public int f23993s0;
    public int f23994t0;
    public RectF v;
    public float f23995w;
    public RectF f23996x;
    public RectF f23997y;
    ...
    public final void g(int i10, boolean z10) {
        float f7;
        ObjectAnimator objectAnimator = this.f23973c0;
        if (objectAnimator != null && (!z10 || this.f23994t0 != i10)) {
            objectAnimator.cancel();
            this.f23973c0 = null;
        }
        int i11 = this.f23994t0;
        if (i11 == i10) {
            return;
        }
        this.f23993s0 = i11;
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this, "gridProgress", this.f23971b0, f7);
        this.f23973c0 = ofFloat;
        ofFloat.setDuration(200L);
        this.f23973c0.addListener(new b(this, 29));
        if (i10 == 1) {
            this.f23973c0.setStartDelay(200L);
        }
        this.f23973c0.start();
    }

    public float getAspectRatio() {
        RectF rectF = this.f23996x;
        return (rectF.right - rectF.left) / (rectF.bottom - rectF.top);
    }

    public float getCropBottom() {
        return this.f23996x.bottom;
    }
    ...
    public float getCropLeft() {
        return this.f23996x.left;
    }

    public float getCropRight() {
        return this.f23996x.right;
    }

    public float getCropTop() {
        return this.f23996x.top;
    }
    ...
    public final void i() {
        if (this.f23981i0 != null) {
            ...
            this.f23982j0 = new StaticLayout(this.f23981i0, this.m0, getMeasuredWidth() - AndroidUtilities.dp(120.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            return;
        }
        this.f23982j0 = null;
    }
    ...
    public final void j() {
        ...
        this.f23985n.set(rectF2.left + f10, f18 - f10, rectF2.right - f10, f18 + f10);
        RectF rectF6 = this.f23990r;
        ...
        this.f23992s.set(rectF2.left + f10, f21 - f10, rectF2.right - f10, f21 + f10);
    }
        ...
        if (actionMasked == 0) {
            if (this.f23978f0) {
                ...
                if (this.d.contains(f11, f12)) {
                    this.f23991r0 = 2;
                } else if (this.f23975e.contains(f11, f12)) {
                    this.f23991r0 = 3;
                } else if (this.f23977f.contains(f11, f12)) {
                    this.f23991r0 = 4;
                } else if (this.h.contains(f11, f12)) {
                    this.f23991r0 = 5;
                } else if (this.f23990r.contains(f11, f12)) {
                    this.f23991r0 = 7;
                } else if (this.f23985n.contains(f11, f12)) {
                    this.f23991r0 = 6;
                } else if (this.v.contains(f11, f12)) {
                    this.f23991r0 = 9;
                } else if (this.f23992s.contains(f11, f12)) {
                    this.f23991r0 = 8;
                } else {
                    this.f23991r0 = 1;
                    return false;
            ...
            if (actionMasked == 2 && this.f23991r0 != 1) {
                rectF.set(this.f23996x);
                ...
                switch (j.c(this.f23991r0)) {
                    case 1:
                        rectF.left += f13;
                        rectF.top += f14;
                        if (this.f23995w > 0.0f) {
                            float width = rectF.width();
                            float height = rectF.height();
                            if (z10) {
                                c(rectF, this.f23995w);
                            } else {
                                b(rectF, this.f23995w);
                            }
                ...
                if (rectF.left < f7) {
                    ...
                    if (this.f23995w > 0.0f) {
                        rectF.bottom = (rectF.width() / this.f23995w) + rectF.top;
                    }
                }
                float f21 = f10 + this.H + f7;
                float f22 = this.G + f7;
                if (rectF.top < f21) {
                    float f23 = this.f23995w;
                    if (f23 > 0.0f) {
                    ...
                    if (this.f23995w > 0.0f) {
                        rectF.right = (rectF.height() * this.f23995w) + rectF.left;
                    }
                }
                ...
                if (aVar2 != null) {
                    ...
                    qVar2.r(false);
                    rectF2.set(cropAreaView.f23996x);
