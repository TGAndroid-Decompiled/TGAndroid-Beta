...
public class CropAreaView extends ViewGroup {
    ...
    public boolean f22972b0;
    public float f22973c;
    public boolean f22974c0;
    public RectF d;
    public Bitmap f22975d0;
    public RectF e;
    public Paint f22976e0;
    public RectF f22977f;
    public String f22978f0;
    public StaticLayout f22979g0;
    public RectF h;
    public AnimatorSet f22980h0;
    public RectF f22981i0;
    public TextPaint f22982j0;
    public float f22983k0;
    public float f22984l0;
    public float m0;
    public RectF f22985n;
    public float f22986n0;
    public int f22987o0;
    public int f22988p0;
    public int f22989q0;
    public RectF f22990r;
    public RectF f22991s;
    public RectF v;
    public float f22992w;
    public RectF f22993x;
    public RectF f22994y;
    ...
    public final void g(int i10, boolean z4) {
        ...
        if (objectAnimator != null && (!z4 || this.f22989q0 != i10)) {
            objectAnimator.cancel();
            this.W = null;
        }
        int i11 = this.f22989q0;
        if (i11 == i10) {
            return;
        }
        this.f22988p0 = i11;
    ...
    public float getAspectRatio() {
        RectF rectF = this.f22993x;
        return (rectF.right - rectF.left) / (rectF.bottom - rectF.top);
    }

    public float getCropBottom() {
        return this.f22993x.bottom;
    }
    ...
    public float getCropLeft() {
        return this.f22993x.left;
    }

    public float getCropRight() {
        return this.f22993x.right;
    }

    public float getCropTop() {
        return this.f22993x.top;
    }
    ...
    public final void i() {
        if (this.f22978f0 != null) {
            if (this.f22982j0 == null) {
                TextPaint textPaint = new TextPaint();
                this.f22982j0 = textPaint;
                textPaint.setColor(i0.a.k(-1, 120));
                this.f22982j0.setTextSize(AndroidUtilities.dp(13.0f));
                this.f22982j0.setTextAlign(Paint.Align.CENTER);
            }
            this.f22979g0 = new StaticLayout(this.f22978f0, this.f22982j0, getMeasuredWidth() - AndroidUtilities.dp(120.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            return;
        }
        this.f22979g0 = null;
    }
    ...
    public final void j() {
        ...
        this.f22985n.set(rectF2.left + f11, f19 - f11, rectF2.right - f11, f19 + f11);
        RectF rectF6 = this.f22990r;
        ...
        this.f22991s.set(rectF2.left + f11, f22 - f11, rectF2.right - f11, f22 + f11);
    }
        ...
        if (actionMasked == 0) {
            if (this.f22974c0) {
                ...
                if (this.d.contains(f12, f13)) {
                    this.f22987o0 = 2;
                } else if (this.e.contains(f12, f13)) {
                    this.f22987o0 = 3;
                } else if (this.f22977f.contains(f12, f13)) {
                    this.f22987o0 = 4;
                } else if (this.h.contains(f12, f13)) {
                    this.f22987o0 = 5;
                } else if (this.f22990r.contains(f12, f13)) {
                    this.f22987o0 = 7;
                } else if (this.f22985n.contains(f12, f13)) {
                    this.f22987o0 = 6;
                } else if (this.v.contains(f12, f13)) {
                    this.f22987o0 = 9;
                } else if (this.f22991s.contains(f12, f13)) {
                    this.f22987o0 = 8;
                } else {
                    this.f22987o0 = 1;
                    return false;
                ...
                this.f22972b0 = true;
                h(true);
                a aVar = this.f22970a0;
                if (aVar != null) {
                    n nVar = (n) aVar;
                    nVar.f47310a.d(nVar.f47313f);
                    nVar.f47314n = 0.0f;
                    m mVar = nVar.J;
                    if (mVar != null) {
                        mVar.G1(false);
            ...
            if (actionMasked == 2 && this.f22987o0 != 1) {
                rectF.set(this.f22993x);
                ...
                switch (j.c(this.f22987o0)) {
                    case 1:
                        rectF.left += f14;
                        rectF.top += f15;
                        if (this.f22992w > 0.0f) {
                            float width = rectF.width();
                            float height = rectF.height();
                            if (z4) {
                                c(rectF, this.f22992w);
                            } else {
                                b(rectF, this.f22992w);
                            }
                ...
                if (rectF.left < f10) {
                    ...
                    if (this.f22992w > 0.0f) {
                        rectF.bottom = (rectF.width() / this.f22992w) + rectF.top;
                    }
                }
                float f22 = f11 + this.E + f10;
                float f23 = this.D + f10;
                if (rectF.top < f22) {
                    float f24 = this.f22992w;
                    if (f24 > 0.0f) {
                    ...
                    if (this.f22992w > 0.0f) {
                        rectF.right = (rectF.height() * this.f22992w) + rectF.left;
                    }
                }
                ...
                setActualRect(rectF);
                a aVar2 = this.f22970a0;
                if (aVar2 != null) {
                    n nVar2 = (n) aVar2;
                    CropAreaView cropAreaView = nVar2.f47310a;
                    cropAreaView.g(3, false);
                    RectF rectF2 = nVar2.f47313f;
                    ...
                    nVar2.r(false);
                    rectF2.set(cropAreaView.f22993x);
            ...
            if (this.f22987o0 != 1) {
                this.f22987o0 = 1;
                a aVar3 = this.f22970a0;
                if (aVar3 != null) {
                    n nVar3 = (n) aVar3;
                    CropAreaView cropAreaView2 = nVar3.f47310a;
