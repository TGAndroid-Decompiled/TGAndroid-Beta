...
public final class vg extends FrameLayout {
    public final org.telegram.ui.ActionBar.j5 f29070a;
    public final RectF f29071b;
    public final Paint f29072c;
    public final Drawable d;
    public boolean e;

    public vg(Activity activity) {
        super(activity);
        this.f29071b = new RectF();
        this.f29072c = new Paint(1);
        this.e = false;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        this.f29072c.setShader(new LinearGradient(0.0f, 0.0f, getMeasuredWidth(), 0.0f, new int[]{-9071617, -5999873}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP));
    }
}
