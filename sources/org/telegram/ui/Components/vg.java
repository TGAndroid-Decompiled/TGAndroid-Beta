...
public final class vg extends FrameLayout {
    public final org.telegram.ui.ActionBar.i5 f28736a;
    public final RectF f28737b;
    ...
    public vg(Activity activity) {
        super(activity);
        this.f28737b = new RectF();
        this.f28738c = new Paint(1);
        this.e = false;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        this.f28738c.setShader(new LinearGradient(0.0f, 0.0f, getMeasuredWidth(), 0.0f, new int[]{-9071617, -5999873}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP));
    }
}
