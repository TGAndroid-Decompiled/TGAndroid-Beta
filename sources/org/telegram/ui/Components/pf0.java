...
public final class pf0 {
    public float f26113a = 0.0f;
    public float f26114b = 25.0f;
    public float f26115c = 50.0f;
    public float d = 75.0f;
    public float e = 100.0f;
    public float[] f26116f;

    public final float[] a() {
        float f7 = this.f26113a;
        float f10 = this.e;
        int i10 = 5;
        float[] fArr = {-0.001f, f7 / 100.0f, 0.0f, f7 / 100.0f, 0.25f, this.f26114b / 100.0f, 0.5f, this.f26115c / 100.0f, 0.75f, this.d / 100.0f, 1.0f, f10 / 100.0f, 1.001f, f10 / 100.0f};
        int i11 = 100;
        ...
        this.f26116f = new float[arrayList.size()];
        int i19 = 0;
        while (true) {
            float[] fArr2 = this.f26116f;
            if (i19 >= fArr2.length) {
                break;
            }
    ...
    public final boolean b() {
        if (Math.abs(this.f26113a - 0.0f) < 1.0E-5d && Math.abs(this.f26114b - 25.0f) < 1.0E-5d && Math.abs(this.f26115c - 50.0f) < 1.0E-5d && Math.abs(this.d - 75.0f) < 1.0E-5d && Math.abs(this.e - 100.0f) < 1.0E-5d) {
            return true;
        }
        return false;
    }
    ...
    public final void c(InputSerializedData inputSerializedData, boolean z10) {
        this.f26113a = inputSerializedData.readFloat(z10);
        this.f26114b = inputSerializedData.readFloat(z10);
        this.f26115c = inputSerializedData.readFloat(z10);
    ...
    public final void d(OutputSerializedData outputSerializedData) {
        outputSerializedData.writeFloat(this.f26113a);
        outputSerializedData.writeFloat(this.f26114b);
        outputSerializedData.writeFloat(this.f26115c);
