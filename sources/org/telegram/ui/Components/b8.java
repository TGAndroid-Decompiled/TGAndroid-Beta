...
public abstract class b8 extends FrameLayout {
    public final TextView[] f22694a;
    public final float[] f22695b;
    public final int f22696c;
    public final Matrix d;
    public final Paint e;
    public final Paint f22697f;
    public int h;
    public AnimatorSet f22698n;
    public LinearGradient f22699r;
    public int f22700s;
    ...
    public b8(Context context) {
        super(context);
        this.f22694a = new TextView[2];
        this.f22695b = new float[]{0.0f, 0.75f};
        this.f22696c = AndroidUtilities.dp(24.0f);
        this.f22700s = -1;
        this.v = new RectF();
        for (int i10 = 0; i10 < 2; i10++) {
            this.f22694a[i10] = a();
            if (i10 == 1) {
                this.f22694a[i10].setAlpha(0.0f);
                this.f22694a[i10].setVisibility(8);
            }
            addView(this.f22694a[i10], w7.x5.c(-1.0f, -2));
        }
        this.d = new Matrix();
    ...
    public final void b(CharSequence charSequence, boolean z10) {
        final int i10;
        int i11 = this.h;
        TextView[] textViewArr = this.f22694a;
        ...
        if (!TextUtils.isEmpty(text) && z10) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    switch (r3) {
                        case 0:
                            b8 b8Var = this.f22327b;
                            b8Var.f22695b[i13] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            b8Var.invalidate();
                            return;
                        default:
                            b8 b8Var2 = this.f22327b;
                            b8Var2.f22695b[i13] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            b8Var2.invalidate();
                            return;
                    }
                }
            ...
            ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    switch (r3) {
                        case 0:
                            b8 b8Var = this.f22327b;
                            b8Var.f22695b[i10] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            b8Var.invalidate();
                            return;
                        default:
                            b8 b8Var2 = this.f22327b;
                            b8Var2.f22695b[i10] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            b8Var2.invalidate();
                            return;
                    }
                }
            ...
            this.f22698n.playTogether(ofFloat, ofFloat2, ofFloat3, ofFloat4);
            this.f22698n.start();
            return;
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (i12 > 0 && textViewArr[this.h].getAlpha() != 1.0f && textViewArr[this.h].getLayout() != null) {
            ...
            float primaryHorizontal2 = textViewArr[this.h].getLayout().getPrimaryHorizontal(this.f22700s);
        ...
        float f10 = f7 + this.f22696c;
        Matrix matrix = this.d;
        matrix.setTranslate(f7, 0.0f);
        this.f22699r.setLocalMatrix(matrix);
        canvas.drawRect(f7, 0.0f, f10, min2, this.e);
        Paint paint = this.f22697f;
        if (min > f10) {
            canvas2 = canvas;
    ...
    public TextView getNextTextView() {
        ...
        return this.f22694a[c10];
    }

    public TextView getTextView() {
        return this.f22694a[this.h];
    }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        LinearGradient linearGradient = new LinearGradient(this.f22696c, 0.0f, 0.0f, 0.0f, 0, -16777216, Shader.TileMode.CLAMP);
        this.f22699r = linearGradient;
    ...
    public void setCustomPaddingRight(int i10) {
        ...
        this.f22701w = i10;
        for (TextView textView : this.f22694a) {
