...
public abstract class b8 extends FrameLayout {
    ...
    public final Paint f22653f;
    public int h;
    public AnimatorSet f22654n;
    public LinearGradient f22655r;
    public int f22656s;
    ...
    public b8(Context context) {
        super(context);
        this.f22650a = new TextView[2];
        this.f22651b = new float[]{0.0f, 0.75f};
        this.f22652c = AndroidUtilities.dp(24.0f);
        this.f22656s = -1;
        this.v = new RectF();
        for (int i10 = 0; i10 < 2; i10++) {
            this.f22650a[i10] = a();
            if (i10 == 1) {
                this.f22650a[i10].setAlpha(0.0f);
                this.f22650a[i10].setVisibility(8);
            }
            addView(this.f22650a[i10], w7.x5.c(-1.0f, -2));
        }
        this.d = new Matrix();
    ...
    public final void b(CharSequence charSequence, boolean z10) {
        final int i10;
        int i11 = this.h;
        TextView[] textViewArr = this.f22650a;
        ...
        if (!TextUtils.isEmpty(text) && z10) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    switch (r3) {
                        case 0:
                            b8 b8Var = this.f22346b;
                            b8Var.f22651b[i13] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            b8Var.invalidate();
                            return;
                        default:
                            b8 b8Var2 = this.f22346b;
                            b8Var2.f22651b[i13] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            b8Var2.invalidate();
                            return;
                    }
                }
            ...
            ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    switch (r3) {
                        case 0:
                            b8 b8Var = this.f22346b;
                            b8Var.f22651b[i10] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            b8Var.invalidate();
                            return;
                        default:
                            b8 b8Var2 = this.f22346b;
                            b8Var2.f22651b[i10] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                            b8Var2.invalidate();
                            return;
                    }
                }
            ...
            this.f22654n.playTogether(ofFloat, ofFloat2, ofFloat3, ofFloat4);
            this.f22654n.start();
            return;
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (i12 > 0 && textViewArr[this.h].getAlpha() != 1.0f && textViewArr[this.h].getLayout() != null) {
            ...
            float primaryHorizontal2 = textViewArr[this.h].getLayout().getPrimaryHorizontal(this.f22656s);
        ...
        float f10 = f7 + this.f22652c;
        Matrix matrix = this.d;
        matrix.setTranslate(f7, 0.0f);
        this.f22655r.setLocalMatrix(matrix);
        canvas.drawRect(f7, 0.0f, f10, min2, this.e);
        Paint paint = this.f22653f;
        if (min > f10) {
            canvas2 = canvas;
    ...
    public TextView getNextTextView() {
        ...
        return this.f22650a[c10];
    }

    public TextView getTextView() {
        return this.f22650a[this.h];
    }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        LinearGradient linearGradient = new LinearGradient(this.f22652c, 0.0f, 0.0f, 0.0f, 0, -16777216, Shader.TileMode.CLAMP);
        this.f22655r = linearGradient;
    ...
    public void setCustomPaddingRight(int i10) {
        ...
        this.f22657w = i10;
        for (TextView textView : this.f22650a) {
