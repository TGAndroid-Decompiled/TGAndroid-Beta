...
public final class d51 extends rl0 {
    ...
    public int f24171w;
    public final e51 f24172x;
    public final SparseArray d = new SparseArray();
    public final ArrayList e = new ArrayList();
    public final SparseArray f24167f = new SparseArray();
    public final HashMap h = new HashMap();
    public final ArrayList f24168n = new ArrayList();
    public int v = 5;
    ...
    public final void E(View view, int i10, boolean z4) {
        ...
        boolean z15;
        boolean z16;
        e51 e51Var = this.f24172x;
        LongSparseArray longSparseArray = e51Var.e;
        LongSparseArray longSparseArray2 = e51Var.d;
        TLRPC.StickerSetCovered[] stickerSetCoveredArr = e51Var.f24468c;
        int i11 = e51Var.f24466a;
        MediaDataController mediaDataController = MediaDataController.getInstance(i11);
        int i12 = this.f24171w;
        ...
        while (true) {
            if (i13 < stickerSetCoveredArr.length) {
                if (stickerSetCoveredArr[i13] != null) {
                    TLRPC.TL_messages_stickerSet stickerSetById = MediaDataController.getInstance(i11).getStickerSetById(stickerSetCoveredArr[i13].set.f19211id);
                    if (stickerSetById != null && !stickerSetById.set.archived) {
                        stickerSetCoveredArr[i13] = null;
                    } else if (stickerSetCoveredArr[i13].set.f19211id == stickerSetCovered2.set.f19211id) {
                        z11 = true;
                        break;
                    }
                }
        ...
        boolean isStickerPackInstalled = mediaDataController.isStickerPackInstalled(stickerSetCovered2.set.f19211id);
        if (longSparseArray2.indexOfKey(stickerSetCovered2.set.f19211id) >= 0) {
            z12 = true;
        } else {
            z12 = false;
        }
        if (longSparseArray.indexOfKey(stickerSetCovered2.set.f19211id) >= 0) {
            z13 = true;
        } else {
            z13 = false;
        }
        if (z12 && isStickerPackInstalled) {
            longSparseArray2.remove(stickerSetCovered2.set.f19211id);
            z12 = false;
        } else if (z13 && !isStickerPackInstalled) {
            longSparseArray.remove(stickerSetCovered2.set.f19211id);
        }
    ...
    public final void G() {
        ...
        SparseArray sparseArray = this.d;
        sparseArray.clear();
        SparseArray sparseArray2 = this.f24167f;
        sparseArray2.clear();
        ...
        arrayList.clear();
        this.f24171w = 0;
        MediaDataController mediaDataController = MediaDataController.getInstance(e51Var.f24466a);
        ArrayList arrayList2 = new ArrayList(mediaDataController.getFeaturedStickerSets());
        int size = arrayList2.size();
        arrayList2.addAll(this.f24168n);
        int i11 = 0;
        int i12 = 0;
        while (true) {
            int i13 = 1;
            ...
            if (!stickerSetCovered.covers.isEmpty() || stickerSetCovered.cover != null) {
                if (i11 == size) {
                    int i14 = this.f24171w;
                    this.f24171w = i14 + 1;
                    sparseArray.put(i14, -1);
                }
                arrayList.add(stickerSetCovered);
                sparseArray2.put(this.f24171w, stickerSetCovered);
                hashMap.put(stickerSetCovered, Integer.valueOf(this.f24171w));
                int i15 = this.f24171w;
                this.f24171w = i15 + 1;
                int i16 = i12 + 1;
                ...
                if (!stickerSetCovered.covers.isEmpty()) {
                    ...
                    for (int i17 = 0; i17 < stickerSetCovered.covers.size(); i17++) {
                        sparseArray.put(this.f24171w + i17, stickerSetCovered.covers.get(i17));
                    }
                } else {
                    sparseArray.put(this.f24171w, stickerSetCovered.cover);
                }
                int i18 = 0;
                while (true) {
                    i10 = this.v * i13;
                    ...
                    sparseArray2.put(this.f24171w + i18, stickerSetCovered);
                    i18++;
                }
                this.f24171w = i10 + this.f24171w;
                i12 = i16;
            }
            i11++;
        }
    ...
    public final void v(f2.l1 l1Var, int i10) {
        ...
        ((org.telegram.ui.Cells.d8) view).d((TLRPC.Document) this.d.get(i10), null, this.f24167f.get(i10), null, false, false);
    }
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 != 2) {
                                    ...
                                    public final void onClick(View view) {
                                        switch (r2) {
                                            case 0:
                                                ...
                                                d51 d51Var = this.f23848b;
                                                e51 e51Var2 = d51Var.f24172x;
                                                LongSparseArray longSparseArray = e51Var2.d;
                                                LongSparseArray longSparseArray2 = e51Var2.e;
                                                if (longSparseArray.indexOfKey(stickerSet.set.f19211id) < 0 && longSparseArray2.indexOfKey(stickerSet.set.f19211id) < 0) {
                                                    if (r3Var.f21757r) {
                                                        longSparseArray2.put(stickerSet.set.f19211id, stickerSet);
                                                        e51Var2.f24467b.h(stickerSet);
                                                        return;
                                                    }
                                            ...
                                            default:
                                                ...
                                                d51 d51Var2 = this.f23848b;
                                                e51 e51Var3 = d51Var2.f24172x;
                                                LongSparseArray longSparseArray3 = e51Var3.d;
                                                LongSparseArray longSparseArray4 = e51Var3.e;
                                                if (longSparseArray3.indexOfKey(stickerSet2.set.f19211id) < 0 && longSparseArray4.indexOfKey(stickerSet2.set.f19211id) < 0) {
                                                    if (o3Var3.f21513s) {
                                                        longSparseArray4.put(stickerSet2.set.f19211id, stickerSet2);
                                                        e51Var3.f24467b.h(stickerSet2);
                                                        return;
                                                    }
                    ...
                    org.telegram.ui.Cells.r3 r3Var = new org.telegram.ui.Cells.r3(17, this.f24166c, e51Var.M, true, true);
