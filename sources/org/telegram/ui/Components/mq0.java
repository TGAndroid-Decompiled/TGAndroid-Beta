...
public final class mq0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public bc0 G;
    public lq0 H;
    public final kq0[] f26227a;
    public int f26228b;
    public int f26229c;
    public long d;
    public ArrayList e;
    public final ArrayList f26230f;
    public boolean h;
    public boolean f26231n;
    public String f26232r;
    public final ArrayList f26233s;
    public final HashMap v;
    public TLRPC.WebPage f26234w;
    public int f26235x;
    public int f26236y;

    public mq0(Activity activity, org.telegram.ui.ActionBar.e6 e6Var) {
        super(activity);
        this.f26227a = new kq0[2];
        this.f26228b = 0;
        this.f26230f = new ArrayList();
        this.f26231n = true;
        this.f26233s = new ArrayList();
        this.v = new HashMap();
        int i10 = 0;
        while (true) {
            kq0[] kq0VarArr = this.f26227a;
            if (i10 < kq0VarArr.length) {
                kq0VarArr[i10] = new kq0(this, activity, e6Var);
                addView(this.f26227a[i10], w7.x5.c(-1.0f, -1));
                i10++;
            } else {
                kq0VarArr[0].setVisibility(0);
                this.f26227a[1].setVisibility(8);
                return;
            }
        }
    }
    ...
    public static void a(kq0 kq0Var, TLRPC.WebPage webPage, String str) {
        ImageView imageView = kq0Var.f25663b;
        u9 u9Var = kq0Var.f25666n;
        imageView.setImageResource(R.drawable.msg_link2);
        kq0Var.f25663b.setVisibility(0);
        kq0Var.f25665f.setVisibility(8);
        kq0Var.f25667r.setVisibility(0);
        ...
        kq0Var.f25662a.setClickable(false);
    }
    ...
    public final String c(kq0 kq0Var) {
        int measuredWidth;
        String shortName;
        ArrayList arrayList = this.f26230f;
        ...
        while (i10 < size) {
            ...
            if (longValue == this.d) {
                ...
                if (arrayList.size() == 1) {
                    shortName = DialogObject.getName(this.f26229c, longValue);
                } else {
                    shortName = DialogObject.getShortName(this.f26229c, longValue);
                }
    ...
    public final void d() {
        if (this.f26235x != 0) {
            AccountInstance.getInstance(this.f26229c).getConnectionsManager().cancelRequest(this.f26235x, true);
            this.f26235x = 0;
        }
        this.f26236y++;
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        String str;
        if (i10 == NotificationCenter.didReceivedWebpagesInUpdates && this.f26234w != null && i11 == this.f26229c) {
            a0.i iVar = (a0.i) objArr[0];
            for (int i12 = 0; i12 < iVar.m(); i12++) {
                TLRPC.WebPage webPage = (TLRPC.WebPage) iVar.n(i12);
                if (webPage != null && webPage.f18262id == this.f26234w.f18262id) {
                    if (webPage instanceof TLRPC.TL_webPageEmpty) {
                        ...
                        this.f26234w = webPage;
                        ArrayList arrayList = this.f26233s;
                        if (arrayList.isEmpty()) {
                            str = "";
                        } else {
    ...
    public final u9 f(int i10) {
        u9[] u9VarArr;
        if (this.f26228b == 1 && (u9VarArr = this.f26227a[0].h) != null && i10 >= 0 && i10 < u9VarArr.length && u9VarArr[i10].getVisibility() == 0) {
            return u9VarArr[i10];
        }
        return null;
    }
    ...
    public final void h(int i10) {
        if (this.f26229c == i10) {
            ...
            if (isAttachedToWindow()) {
                NotificationCenter.getInstance(this.f26229c).addObserver(this, NotificationCenter.didReceivedWebpagesInUpdates);
                return;
            }
            return;
        }
        if (isAttachedToWindow()) {
            NotificationCenter.getInstance(this.f26229c).removeObserver(this, NotificationCenter.didReceivedWebpagesInUpdates);
        }
        this.f26229c = i10;
        if (isAttachedToWindow()) {
            NotificationCenter.getInstance(this.f26229c).addObserver(this, NotificationCenter.didReceivedWebpagesInUpdates);
    ...
    public final void i(int i10, ArrayList arrayList) {
        ...
        org.telegram.ui.ActionBar.j5 j5Var2 = kq0Var.f25664c;
        imageView.setImageResource(R.drawable.filled_forward);
        kq0Var.f25663b.setVisibility(0);
        kq0Var.f25666n.setVisibility(8);
        kq0Var.f25665f.setVisibility(0);
        kq0Var.f25667r.setVisibility(8);
        kq0Var.f25662a.setClickable(true);
        ...
        int i16 = this.f26228b;
        if (i12 != i16 && (lq0Var = this.H) != null) {
            ((org.telegram.ui.wv) lq0Var).h(i16);
        }
    }
    ...
    public void setLayoutClickListener(View.OnClickListener onClickListener) {
        for (kq0 kq0Var : this.f26227a) {
            kq0Var.f25662a.setOnClickListener(onClickListener);
        }
    }
