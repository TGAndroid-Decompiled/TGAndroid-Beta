...
public final class mq0 extends ul0 {
    ...
    public final void E() {
        ...
        if (uq0Var.Z) {
            ...
            dialog.f18332id = Long.MAX_VALUE;
        ...
        for (int i15 = 0; i15 < allDialogs.size(); i15++) {
            ...
            if (dialog3 instanceof TLRPC.TL_dialog) {
                long j10 = dialog3.f18332id;
                if (j10 != j3 && !DialogObject.isEncryptedDialog(j10)) {
                    if (!DialogObject.isUserDialog(dialog3.f18332id)) {
                        i13 = ((org.telegram.ui.ActionBar.f3) uq0Var).currentAccount;
                        TLRPC.Chat chat = MessagesController.getInstance(i13).getChat(Long.valueOf(-dialog3.f18332id));
                        if (chat != null && !ChatObject.isNotInChat(chat) && ((!chat.gigagroup || ChatObject.hasAdminRights(chat)) && (!ChatObject.isChannel(chat) || chat.creator || (((tL_chatAdminRights = chat.admin_rights) != null && tL_chatAdminRights.post_messages) || chat.megagroup)))) {
                            ...
                            iVar.k(dialog3, dialog3.f18332id);
                        }
                    } else {
                        if (dialog3.folder_id == 1) {
                            arrayList2.add(dialog3);
        ...
        org.telegram.ui.zn znVar = uq0Var.f28812f0;
        if (znVar != null) {
            int i16 = znVar.f40241a;
            if (i16 != 1) {
                if (i16 == 2) {
    ...
    public final void v(s4.c1 r7, int r8) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.mq0.v(s4.c1, int):void");
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            kq0Var.setLayoutParams(new s4.p0(-1, AndroidUtilities.dp(f7)));
        }
        return new s4.c1(kq0Var);
    }
}
