...
public final class fe0 extends Dialog {
    ...
    public fe0(LaunchActivity launchActivity) {
        ...
        ga0 ga0Var = new ga0(9);
        WeakHashMap weakHashMap = r0.i0.f42127a;
        r0.a0.j(frameLayout, ga0Var);
    ...
    public final void dismiss() {
        ...
        if (this.f24260b.g() && (launchActivity = LaunchActivity.G1) != null) {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        FrameLayout frameLayout = this.f24259a;
