...
public final class cr0 extends View {
    public Random f23429a;
    public Paint f23430b;
    public Paint f23431c;
    public Paint d;
    public Paint e;
    ...
    public final void onDraw(Canvas canvas) {
        float f7;
        Paint paint = this.f23431c;
        Paint paint2 = this.f23430b;
        super.onDraw(canvas);
        ...
        float f12 = (this.f23433n * interpolation) + ((1.0f - interpolation) * this.h);
        canvas.save();
        ...
        float f15 = this.f23432f + 0.016f;
        this.f23432f = f15;
        if (f15 > 1.0f) {
            this.h = this.f23433n;
            float e = org.telegram.ui.Cells.c1.e(this.f23429a, 1001) / 1000.0f;
            this.f23433n = e;
            if (e > this.h) {
                this.f23433n = e + 0.3f;
            } else {
            ...
            this.f23433n = Math.max(0.0f, Math.min(1.0f, this.f23433n));
            this.f23432f = 0.0f;
        }
        invalidate();
    }
