...
public final class g11 extends FrameLayout {
    ...
    public g11(ThemeEditorView.EditorAlert editorAlert, Context context) {
        ...
        this.d = editorAlert;
        this.f27070a = false;
        this.f27071b = new RectF();
    }

    @Override
    public final void onDraw(android.graphics.Canvas r13) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.g11.onDraw(android.graphics.Canvas):void");
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ThemeEditorView.EditorAlert editorAlert = this.d;
        h11 h11Var = editorAlert.f25065c;
        ...
        if (h11Var.getPaddingTop() != dp) {
            ...
            if (editorAlert.f25064b.getVisibility() == 0) {
