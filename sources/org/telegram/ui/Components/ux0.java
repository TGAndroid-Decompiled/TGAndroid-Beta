...
public final class ux0 extends sl0 {
    ...
    public int d;
    public final SparseArray f31742e = new SparseArray();
    public final SparseArray f31743f = new SparseArray();
    public int h;
    public int f31744n;
    public final yx0 f31745r;
    ...
    public final int j(int i10) {
        yx0 yx0Var = this.f31745r;
        if (yx0Var.T != null) {
            Object obj = this.f31742e.get(i10);
            if (obj != null) {
    ...
    public final void l() {
        ...
        if (yx0Var.T != null) {
            ...
            this.d = dp;
            yx0Var.J.y1(dp);
            SparseArray sparseArray = this.f31742e;
            sparseArray.clear();
            SparseArray sparseArray2 = this.f31743f;
            sparseArray2.clear();
            this.h = 0;
            this.f31744n = 0;
            for (int i13 = 0; i13 < yx0Var.T.size(); i13++) {
                TLRPC.StickerSetCovered stickerSetCovered = (TLRPC.StickerSetCovered) yx0Var.T.get(i13);
    ...
    public final void u(int i10) {
        ArrayList arrayList = this.f31745r.V;
        if (arrayList != null) {
            this.h = arrayList.size();
        }
        super.u(i10);
    ...
    public final void v(f2.m1 m1Var, int i10) {
        ...
        if (arrayList != null) {
            ...
            ((org.telegram.ui.Cells.d8) view).d((TLRPC.Document) sparseArray.get(i10), null, this.f31743f.get(i10), null, false, false);
        } else if (yx0Var.U != null) {
            ...
            TLRPC.TL_messages_stickerSet tL_messages_stickerSet = yx0Var.P;
            if (tL_messages_stickerSet != null) {
                d8Var.d(tL_messages_stickerSet.documents.get(i10), null, yx0Var.P, null, yx0Var.f33621e0, yx0Var.O);
        ...
        if (i10 == 0) {
            ...
            if (i10 != 1) {
                if (i10 == 2) {
                    ...
                    frameLayout2 = new org.telegram.ui.Cells.r3(8, this.f31741c, g6Var2, true, false);
                } else if (i10 == 3) {
