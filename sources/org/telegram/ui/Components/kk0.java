...
public final class kk0 extends s4.s0 {
    ...
    public final void b(RecyclerView recyclerView, int i10, int i11) {
        ...
        float f10 = 0.0f;
        if (z10 != this.f25791a) {
            ValueAnimator valueAnimator = this.f25793c;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            float f11 = qk0Var.f27677r;
            if (z10) {
                f7 = 1.0f;
            } else {
                f7 = 0.0f;
            }
            this.f25793c = c(f11, f7, new q0.a(this) {
                public final kk0 f25079b;
                ...
                public final void accept(Object obj) {
                    ...
                    switch (r2) {
                        case 0:
                            qk0 qk0Var2 = this.f25079b.e;
                            Paint paint = qk0Var2.h;
                            float floatValue = f12.floatValue();
                            qk0Var2.f27677r = floatValue;
                            paint.setAlpha((int) (floatValue * 255.0f));
                            qk0Var2.invalidate();
                            return;
                        default:
                            qk0 qk0Var3 = this.f25079b.e;
                            Paint paint2 = qk0Var3.f27672n;
                            float floatValue2 = f12.floatValue();
                            qk0Var3.f27679s = floatValue2;
        ...
        if (j0Var.N0() != qk0Var.f27647a0.h() - 1) {
            z11 = true;
        }
        if (z11 != this.f25792b) {
