...
public class x81 extends FrameLayout {
    public static final vr0 S = new vr0(1);
    public float E;
    public boolean F;
    public final int G;
    public boolean H;
    ...
    public float R;
    public final org.telegram.ui.ActionBar.d6 f30303a;
    public int f30304b;
    ...
    public x81(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        this.f30306f = new int[2];
        this.e = new View[2];
        setClipChildren(true);
    }

    public static xl0 p(View view) {
        if (view instanceof ViewGroup) {
            ViewGroup viewGroup = (ViewGroup) view;
            for (int i10 = 0; i10 < viewGroup.getChildCount(); i10++) {
                View childAt = viewGroup.getChildAt(i10);
                if (childAt instanceof xl0) {
                    return (xl0) childAt;
                }
    ...
    public final boolean A(android.view.MotionEvent r12) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.x81.A(android.view.MotionEvent):boolean");
    }

    public final boolean B(MotionEvent motionEvent, boolean z10) {
        int i10;
        if (!z10 && this.f30304b == 0) {
            this.R = 0.0f;
            return false;
        } else if ((z10 && this.f30304b == this.L.e() - 1) || this.Q != null || !i(motionEvent) || ((z10 && !k(motionEvent)) || (!z10 && !j(motionEvent)))) {
            return false;
        } else {
            ...
            this.H = true;
            v();
            this.f30308r = (int) (motionEvent.getX() + this.E);
            m81 m81Var = this.M;
            if (m81Var != null) {
    ...
    public final void C(boolean z10) {
        ...
        AnimatorSet animatorSet = this.f30310w;
        if (animatorSet != null) {
            animatorSet.cancel();
            this.f30310w = null;
        }
        ...
        if (this.f30304b > this.L.e() - 1) {
            this.f30304b = this.L.e() - 1;
        }
        if (this.f30304b < 0) {
            this.f30304b = 0;
        }
        int h = this.L.h(this.f30304b);
        int[] iArr = this.f30306f;
        iArr[0] = h;
        View d = this.L.d(h);
        viewArr[0] = d;
        this.L.b(d, this.f30304b, iArr[0]);
        addView(viewArr[0]);
        ...
        if (z10) {
            ...
            if (view7 != null) {
                this.f30310w.playTogether(H(view7, getMeasuredWidth()));
            }
            View view8 = viewArr[0];
            if (view8 != null) {
                this.f30310w.playTogether(H(view8, 0.0f));
            }
            w(true);
            m81 m81Var = this.M;
            m81Var.f29931a = 0.0f;
            ...
            ofFloat.addUpdateListener(new k81(this, 2));
            this.f30310w.playTogether(ofFloat);
            this.f30310w.setInterpolator(S);
            this.f30310w.setDuration(220L);
            this.f30310w.addListener(new l81(this, 2));
    ...
    public final void D(int i10) {
        ...
        if (i10 != this.f30304b) {
            ...
            if (valueAnimator == null || this.d != i10) {
                ...
                ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                this.Q = ofFloat;
                ofFloat.addUpdateListener(new k81(this, 0));
                this.Q.addListener(new l81(this, 0));
    ...
    public void F() {
        ...
        this.f30304b = i11;
        this.d = i10;
        this.f30305c = 1.0f - this.f30305c;
        int[] iArr = this.f30306f;
        int i12 = iArr[0];
        iArr[0] = iArr[1];
        iArr[1] = i12;
    ...
    public final boolean canScrollHorizontally(int i10) {
        boolean z10;
        if (i10 != 0) {
            if (!this.f30311x && !this.H) {
                if (i10 > 0) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                if ((z10 || this.f30304b != 0) && (!z10 || this.f30304b != this.L.e() - 1)) {
                }
            }
            return true;
        }
    ...
    public float getPositionAnimated() {
        ...
        View view = viewArr[0];
        if (view != null && view.getVisibility() == 0) {
            f7 = (this.f30304b * Utilities.clamp(1.0f - Math.abs(viewArr[0].getTranslationX() / getAvailableTranslationX()), 1.0f, 0.0f)) + 0.0f;
        } else {
            f7 = 0.0f;
        }
        View view2 = viewArr[1];
    ...
    public final void l() {
        ...
        if (this.H) {
            ...
            if (this.F) {
                f7 = Math.abs(x10);
                if (this.f30312y) {
                    this.f30310w.playTogether(H(viewArr[0], 0.0f));
                    View view4 = viewArr[1];
                    if (view4 != null) {
                        this.f30310w.playTogether(H(view4, view4.getMeasuredWidth()));
                    }
                } else {
                    this.f30310w.playTogether(H(viewArr[0], 0.0f));
                    View view5 = viewArr[1];
                    if (view5 != null) {
                        this.f30310w.playTogether(H(view5, -view5.getMeasuredWidth()));
                    }
                }
            } else if (this.d >= 0) {
                f7 = viewArr[0].getMeasuredWidth() - Math.abs(x10);
                if (this.f30312y) {
                    this.f30310w.playTogether(H(viewArr[0], -view2.getMeasuredWidth()));
                    View view6 = viewArr[1];
                    if (view6 != null) {
                        this.f30310w.playTogether(H(view6, 0.0f));
                    }
                } else {
                    this.f30310w.playTogether(H(viewArr[0], view.getMeasuredWidth()));
                    View view7 = viewArr[1];
                    if (view7 != null) {
                        this.f30310w.playTogether(H(view7, 0.0f));
                    }
                }
            } else {
                f7 = 0.0f;
            ...
            if (this.d < 0) {
                ...
                ofFloat.addUpdateListener(new k81(this, 3));
                this.f30310w.playTogether(ofFloat);
            }
            ValueAnimator ofFloat2 = ValueAnimator.ofFloat(0.0f, 1.0f);
            ofFloat2.addUpdateListener(this.N);
            this.f30310w.playTogether(ofFloat2);
            this.f30310w.setInterpolator(S);
            ...
            this.f30310w.setDuration(Math.max(150, Math.min(measuredWidth2, 600)));
            this.f30310w.addListener(new l81(this, 3));
            this.f30310w.start();
            this.f30311x = true;
            this.H = false;
            w(false);
    ...
    public final w81 n(int i10, boolean z10) {
        m81 m81Var = new m81(this, getContext(), z10, i10, this.f30303a);
        this.M = m81Var;
        m81Var.f29952r = G();
    ...
    public final void o(boolean z10) {
        ...
        if (this.L != null && (m81Var = this.M) != null) {
            m81Var.h.clear();
            m81Var.f29934b0.clear();
            m81Var.f29936c0.clear();
            m81Var.f29937d0.clear();
            m81Var.f29938e0.clear();
            m81Var.H = 0;
    ...
    public void setAdapter(o81 o81Var) {
        this.L = o81Var;
        int h = o81Var.h(this.f30304b);
        int[] iArr = this.f30306f;
        iArr[0] = h;
        View d = o81Var.d(h);
        View[] viewArr = this.e;
        viewArr[0] = d;
        if (d == null && this.f30304b != 0) {
            this.f30304b = 0;
            int h10 = o81Var.h(0);
            iArr[0] = h10;
            viewArr[0] = o81Var.d(h10);
        }
        o81Var.b(viewArr[0], this.f30304b, iArr[0]);
        addView(viewArr[0]);
        viewArr[0].setVisibility(0);
        o(false);
    }
    ...
    public void setPosition(int i10) {
        ...
        View view = viewArr[1];
        if (view != null) {
            this.h.put(this.f30306f[1], view);
        ...
        if (i11 != i10) {
            ...
            View view2 = viewArr[0];
            I(0);
            t(viewArr[0], view2, this.f30304b, i11);
            E(viewArr[0], 0.0f);
            m81 m81Var = this.M;
            if (m81Var != null) {
                m81Var.e(this.f30305c, this.f30304b, this.d);
            }
            w(true);
        }
    }
