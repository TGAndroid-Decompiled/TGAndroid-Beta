...
public final class x81 extends AsyncTask {
    ...
    public x81(d91 d91Var, String str, int i10) {
        ...
        switch (i10) {
            case 1:
                this.d = d91Var;
                this.f29885c = new String[4];
                this.f29884b = str;
                return;
            case 2:
                this.d = d91Var;
                this.f29885c = new String[2];
                this.f29884b = str;
                return;
            case 3:
                this.d = d91Var;
    ...
    public final Object doInBackground(Object[] objArr) {
        switch (this.f29883a) {
            case 0:
                ...
                String[] strArr = this.f29885c;
                Locale locale = Locale.US;
                this.d.getClass();
                String c10 = d91.c(this, "http://www.aparat.com/video/video/embed/vt/frame/showvideo/yes/videohash/" + this.f29884b, null, true);
                if (isCancelled()) {
                    return null;
                }
                try {
                    Matcher matcher = d91.f23255r0.matcher(c10);
                    if (matcher.find()) {
            ...
            case 1:
                ...
                String[] strArr2 = this.f29885c;
                Locale locale2 = Locale.US;
                this.d.getClass();
                String c11 = d91.c(this, "https://coub.com/api/v2/coubs/" + this.f29884b + ".json", null, true);
                if (isCancelled()) {
                    return null;
                }
                try {
            ...
            case 2:
                ...
                try {
                    Matcher matcher2 = d91.f23256s0.matcher(c12);
                    if (matcher2.find()) {
            ...
            case 3:
                ...
                String[] strArr4 = this.f29885c;
                HashMap hashMap = new HashMap();
                hashMap.put("Client-ID", "jzkbprff40iqj646a697cyrvl0zt2m6");
                int indexOf = this.f29884b.indexOf(38);
                if (indexOf > 0) {
                    this.f29884b = this.f29884b.substring(0, indexOf);
                }
                Locale locale3 = Locale.US;
                this.d.getClass();
                String c13 = d91.c(this, "https://api.twitch.tv/kraken/streams/" + this.f29884b + "?stream_type=all", hashMap, false);
                if (isCancelled()) {
                    return null;
                }
                try {
                    new JSONObject(c13).getJSONObject("stream");
                    JSONObject jSONObject3 = new JSONObject(d91.c(this, "https://api.twitch.tv/api/channels/" + this.f29884b + "/access_token", hashMap, false));
                    ...
                    URLEncoder.encode("https://youtube.googleapis.com/v/" + this.f29884b, "UTF-8");
            ...
            default:
                ...
                String[] strArr5 = this.f29885c;
                Locale locale4 = Locale.US;
                this.d.getClass();
                String c14 = d91.c(this, "https://player.vimeo.com/video/" + this.f29884b + "/config", null, true);
                if (isCancelled()) {
                    return null;
                }
                try {
    ...
    public final void onPostExecute(Object obj) {
        switch (this.f29883a) {
            ...
            case 1:
                ...
                d91 d91Var2 = this.d;
                if (str2 != null) {
                    d91Var2.f23282w = true;
                    d91Var2.f23283x = str2;
                    String[] strArr = this.f29885c;
                    d91Var2.f23284y = strArr[1];
                    d91Var2.E = strArr[2];
                    d91Var2.F = strArr[3];
                    if (d91Var2.f23281s) {
                        d91Var2.i();
            ...
            case 2:
                ...
                d91 d91Var3 = this.d;
                if (str3 != null) {
                    d91Var3.f23282w = true;
                    d91Var3.f23283x = str3;
                    d91Var3.f23284y = this.f29885c[1];
                    if (d91Var3.f23281s) {
                        d91Var3.i();
                    }
                    d91Var3.j(false, true);
                    d91Var3.f23273f0.d(true, true);
                    return;
                } else if (!isCancelled()) {
                    d91Var3.h();
                    return;
            ...
            case 3:
                ...
                d91 d91Var4 = this.d;
                if (str4 != null) {
                    d91Var4.f23282w = true;
                    d91Var4.f23283x = str4;
                    d91Var4.f23284y = this.f29885c[1];
                    if (d91Var4.f23281s) {
                        d91Var4.i();
                    }
                    d91Var4.j(false, true);
                    d91Var4.f23273f0.d(true, true);
                    return;
                } else if (!isCancelled()) {
                    d91Var4.h();
                    return;
            ...
            default:
                ...
                d91 d91Var5 = this.d;
                if (str5 != null) {
                    d91Var5.f23282w = true;
                    d91Var5.f23283x = str5;
                    d91Var5.f23284y = this.f29885c[1];
                    if (d91Var5.f23281s) {
                        d91Var5.i();
                    }
                    d91Var5.j(false, true);
                    d91Var5.f23273f0.d(true, true);
                    return;
                } else if (!isCancelled()) {
                    d91Var5.h();
                    return;
