...
public final class x81 extends View {
    ...
    public float I;
    public final org.telegram.ui.ActionBar.d6 f30289a;
    public final Paint f30290b;
    public final Paint f30291c;
    public final TextPaint d;
    public final Paint e;
    public String f30292f;
    public int h;
    public int f30293n;
    public final RectF f30294r;
    public boolean f30295s;
    public final Canvas v;
    public final Bitmap f30296w;
    public float f30297x;
    public ObjectAnimator f30298y;
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        if (z11) {
            ...
            this.f30298y = ofFloat;
            ofFloat.setDuration(300L);
            this.f30298y.start();
            return;
        }
        ObjectAnimator objectAnimator = this.f30298y;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        RectF rectF = this.f30294r;
        rectF.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
        View view = this.E;
        org.telegram.ui.ActionBar.d6 d6Var = this.f30289a;
        ...
        canvas2.drawText(this.f30292f, AndroidUtilities.dp(28.0f) + A, AndroidUtilities.dp(21.0f), textPaint);
        canvas2.save();
        canvas2.translate(A, AndroidUtilities.dp(7.0f));
        Bitmap bitmap = this.f30296w;
        int i11 = 0;
        Paint paint3 = this.e;
        if (bitmap != null) {
            float f12 = this.f30297x;
            if (f12 <= 0.5f) {
                f7 = f12 / 0.5f;
                f10 = f7;
            } else {
            ...
            if (f10 != 1.0f) {
                ...
                canvas3.drawRoundRect(rectF, rectF.width() / 2.0f, rectF.height() / 2.0f, this.f30290b);
            }
            if (this.f30297x > 0.5f) {
                Paint paint4 = this.f30291c;
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(org.telegram.messenger.ok.C(56.0f, this.f30293n, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(32.0f), 1073741824));
    }
