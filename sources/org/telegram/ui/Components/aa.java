...
public final class aa extends View {
    ...
    public final void onDraw(Canvas canvas) {
        int i10;
        Bitmap bitmap;
        Paint paint = this.f21444c;
        for (int i11 = 0; i11 < this.d; i11++) {
            if (i11 < this.e) {
                i10 = org.telegram.ui.ActionBar.j6.f18090m5;
            } else {
                i10 = org.telegram.ui.ActionBar.j6.f18217t5;
            }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        for (int i12 = 0; i12 < this.d; i12++) {
            if (motionEvent.getX() > dp && motionEvent.getX() < AndroidUtilities.dp(48.0f) + dp && this.e != (i10 = i12 + 1)) {
                this.e = i10;
                z9 z9Var = this.f21445f;
                if (z9Var != null) {
                    View view = ((le.a) z9Var).f12866a;
                    if (i10 > 0) {
                        z10 = true;
                    }
                    view.setEnabled(z10);
