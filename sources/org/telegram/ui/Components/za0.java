...
public abstract class za0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final org.telegram.ui.ActionBar.d6 f30813a;
    public final ya0 f30814b;
    public final gg.j0 f30815c;
    public final sa0 d;
    public final gg.q1 e;
    public final gg.k1 f30816f;
    public final org.telegram.ui.ActionBar.m2 h;
    public float f30817n;
    public float f30818r;
    public float f30819s;
    public float v;
    public ai.n6 f30820w;
    public wa0 f30821x;
    public final Rect f30822y;

    public za0(Context context, long j3, long j10, org.telegram.ui.ActionBar.m2 m2Var, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f30822y = new Rect();
        this.G = false;
        this.H = false;
        this.I = false;
    ...
    public final void b() {
        ...
        gg.k1 k1Var;
        int height;
        ya0 ya0Var = this.f30814b;
        if (ya0Var != null && this.f30815c != null) {
            boolean g10 = g();
            this.f30819s = 0.0f;
            gg.q1 q1Var = this.e;
            if (g10) {
                ...
                float min = Math.min(Math.max(0.0f, ya0Var.getTranslationY() + height) + this.f30819s, (1.0f - this.M) * getHeight());
                this.f30817n = 0.0f;
                this.f30818r = min;
            } else {
                if (q1Var.f9884f) {
                ...
                this.f30817n = Math.max(Math.max(0.0f, ya0Var.getTranslationY() + i10) - this.f30819s, this.M * getHeight());
                this.f30818r = getMeasuredHeight();
            }
            ch.d dVar = this.R;
            if (dVar != null) {
                dVar.setBounds(0, ((int) this.f30817n) - AndroidUtilities.dp(5.0f), getMeasuredWidth(), AndroidUtilities.dp(5.0f) + ((int) this.f30818r));
                Path path = this.S;
                path.rewind();
                Rect rect = this.R.f4280j.f4271m;
                RectF rectF = this.T;
                rectF.set(rect);
                if (ya0Var != null && (sa0Var = this.d) != null && ya0Var.getLayoutManager() == sa0Var && (k1Var = this.f30816f) != null && k1Var.R != null) {
    ...
    public final float d() {
        ...
        return getMeasuredHeight() - this.f30817n;
    }

    @Override
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.emojiLoaded) {
            AndroidUtilities.forEachViews((RecyclerView) this.f30814b, (Utilities.Callback<View>) new ai.i(13));
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (g10) {
            ...
            float min2 = Math.min(Math.max(0.0f, ya0Var.getTranslationY() + height) + this.f30819s, (1.0f - this.M) * getHeight());
            this.f30817n = 0.0f;
            int measuredWidth = getMeasuredWidth();
            this.f30818r = min2;
            rect.set(0, (int) 0.0f, measuredWidth, (int) min2);
            min = Math.min(dp, Math.abs(getMeasuredHeight() - this.f30818r));
            if (min > 0.0f) {
            ...
            if (ya0Var.getLayoutManager() == this.d) {
                this.f30819s += AndroidUtilities.dp(2.0f);
            ...
            float max = Math.max(0.0f, ya0Var.getTranslationY() + i11) - this.f30819s;
            this.f30817n = max;
            float max2 = Math.max(max, this.M * getHeight());
            this.f30817n = max2;
            int measuredWidth2 = getMeasuredWidth();
            float measuredHeight = getMeasuredHeight();
            this.f30818r = measuredHeight;
            rect.set(0, (int) max2, measuredWidth2, (int) measuredHeight);
            min = Math.min(dp, Math.abs(this.f30817n));
            if (min > 0.0f) {
                canvas.clipRect(0, 0, getWidth(), getHeight());
                rect.bottom += (int) min;
            }
        }
        if (Math.abs(f7 - this.f30817n) > 0.1f) {
            i();
        }
        if (this.E == null) {
        ...
        if (num != null) {
            ...
            v02 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Sd, this.f30813a);
        }
        paint2.setColor(v02);
        f(canvas, rect, min);
    ...
    public final boolean g() {
        s4.o0 layoutManager = this.f30814b.getLayoutManager();
        gg.j0 j0Var = this.f30815c;
        if (layoutManager == j0Var && j0Var.f42939t) {
            return true;
        }
        return false;
    }
