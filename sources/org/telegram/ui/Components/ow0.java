...
public final class ow0 extends ll0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        tw0[] tw0VarArr;
        boolean z10 = true;
        if (c1Var.f42700f == 1 && (tw0VarArr = (xw0Var = this.d).Y2) != null) {
            int i11 = i10 - 1;
            tw0 tw0Var = tw0VarArr[i11];
            final sw0 sw0Var = (sw0) c1Var.f42697a;
            if (xw0Var.f30012m3 != i11) {
                z10 = false;
            }
            sw0Var.getClass();
            if (!TextUtils.isEmpty(tw0Var.d)) {
                sw0Var.setContentDescription(tw0Var.d);
            } else if (!TextUtils.isEmpty(tw0Var.f28212a)) {
                sw0Var.setContentDescription(tw0Var.f28212a);
            } else {
            ...
            sw0Var.f27939w = false;
            sw0Var.f27941y = 1.0f;
            o5.h(UserConfig.selectedAccount).b(tw0Var.f28214c, new l5() {
                @Override
            ...
            sw0Var.l(z10, false);
            sw0Var.setAlpha(xw0Var.f30014o3);
            sw0Var.setScaleX(xw0Var.f30014o3);
            sw0Var.setScaleY(xw0Var.f30014o3);
            sw0Var.j();
        }
    }
    ...
    public final void y(s4.c1 c1Var) {
        boolean z10 = true;
        if (c1Var.f42700f == 1) {
            sw0 sw0Var = (sw0) c1Var.f42697a;
            if (this.d.f30012m3 != c1Var.b() - 1) {
                z10 = false;
            }
            sw0Var.l(z10, false);
            sw0Var.j();
