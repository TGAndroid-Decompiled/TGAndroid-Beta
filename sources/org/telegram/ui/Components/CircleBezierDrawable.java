...
public class CircleBezierDrawable {
    ...
    public void draw(float f, float f2, Canvas canvas, Paint paint) {
        ...
        float f6 = (f3 - f4) - f5;
        float f7 = f5 + f3 + f4;
        float fMax = Math.max(f6, f7) * this.L * this.cubicBezierK;
        this.path.reset();
        char c = 0;
        int i = 0;
        while (i < this.N) {
            ...
            float f10 = (fArr[i] * f9) + f8;
            float[] fArr2 = this.pointStart;
            fArr2[c] = f;
            float f11 = f2 - f10;
            fArr2[1] = f11;
            fArr2[2] = (f9 * fArr[i] * this.L) + f + fMax;
            fArr2[3] = f11;
            ...
            float f14 = (fArr3[i3] * f13) + f12;
            float[] fArr4 = this.pointEnd;
            fArr4[0] = f;
            float f15 = f2 - f14;
            fArr4[1] = f15;
            fArr4[2] = (f13 * fArr3[i3] * this.L) + (f - fMax);
            fArr4[3] = f15;
            this.m.reset();
