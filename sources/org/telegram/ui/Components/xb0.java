...
public final class xb0 extends org.telegram.ui.Cells.u1 {
    ...
    public xb0(zb0 zb0Var, Context context, int i10, ChatMessageSharedResources chatMessageSharedResources, org.telegram.ui.ActionBar.d6 d6Var) {
    ...
    public final void X3(MessageObject messageObject, MessageObject.GroupedMessages groupedMessages, boolean z10, boolean z11, boolean z12, boolean z13) {
        ...
        ac0.b(this.Ge.f30862c, this);
    }

    @Override
    public final void invalidate() {
        super.invalidate();
        this.Ge.f30862c.f22607f.invalidate();
    }
