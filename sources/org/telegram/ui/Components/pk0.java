...
public final class pk0 extends AnimatorListenerAdapter {
    ...
    public void onAnimationCancel(Animator animator) {
        switch (this.f29439a) {
            case 11:
                ((ProfileActivity) this.f29441c).C5 = null;
                return;
            case 12:
                org.telegram.ui.g31 g31Var = (org.telegram.ui.g31) this.f29441c;
                super.onAnimationCancel(animator);
                float floatValue = ((Float) ((ValueAnimator) animator).getAnimatedValue()).floatValue();
                int[] iArr = (int[]) this.f29440b;
                if (iArr != null) {
                    System.arraycopy(new int[]{i0.a.d(floatValue, g31Var.f36568e[0], iArr[0]), i0.a.d(floatValue, g31Var.f36568e[1], iArr[1]), i0.a.d(floatValue, g31Var.f36568e[2], iArr[2]), i0.a.d(floatValue, g31Var.f36568e[3], iArr[3])}, 0, g31Var.f36568e, 0, 4);
                    return;
                }
                return;
            default:
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        Object obj2 = this.f29441c;
        switch (i10) {
            case 0:
                super.onAnimationEnd(animator);
                org.telegram.ui.cr crVar = (org.telegram.ui.cr) obj2;
                ((qk0) crVar.d).f29785g.remove((AnimatorSet) obj);
                if (((qk0) crVar.d).f29785g.isEmpty()) {
                    ((qk0) crVar.d).f29781b.clear();
            ...
            case 2:
                ...
                ov0Var.f29234f0 = 1.0f;
                ov0Var.S.add((kv0) obj);
                ((ov0) gVar.f874c).f29225a0.setShader(null);
                ((ov0) gVar.f874c).f29229c0.setShader(null);
                ((ov0) gVar.f874c).N();
                super.onAnimationEnd(animator);
                return;
            case 3:
            ...
            case 9:
                ...
                ImageReceiver imageReceiver = ue0Var.f30898e;
                if (bitmap != null) {
                    z10 = true;
                } else {
                    z10 = false;
                ...
                AnimatorSet animatorSet = ue0Var.f30902s;
                if (animatorSet != null) {
                    animatorSet.cancel();
                }
                ...
                ue0Var.f30902s = animatorSet3;
                animatorSet3.playTogether(ObjectAnimator.ofFloat(ue0Var, ue0Var.E, 0.0f, 1.0f));
                ue0Var.f30902s.setDuration(250L);
                ue0Var.f30902s.setInterpolator(new OvershootInterpolator(1.01f));
                ue0Var.f30902s.addListener(new se0(ue0Var, 0));
                ue0Var.f30902s.start();
                AnimatorSet animatorSet4 = new AnimatorSet();
                photoViewer.A2 = animatorSet4;
                animatorSet4.playTogether(ObjectAnimator.ofFloat(photoViewer.f33765z2, photoViewer.f33570d4, 0.0f));
                photoViewer.A2.setDuration(85L);
                photoViewer.A2.setInterpolator(pr.f29494g);
            ...
            case 11:
                ...
                if (profileActivity.C5 != null) {
                    if (profileActivity.F5) {
                        ...
                        profileActivity.O.f32743r0.setVisibility(4);
                        AnimatorSet animatorSet5 = new AnimatorSet();
                        profileActivity.D5 = animatorSet5;
                        animatorSet5.playTogether(ObjectAnimator.ofFloat(profileActivity, profileActivity.f33954j5, 1.0f));
            ...
            case 12:
                ...
                int[] iArr = (int[]) obj;
                if (iArr != null) {
                    System.arraycopy(iArr, 0, g31Var.f36568e, 0, 4);
                }
                g31Var.f36570n = null;
                g31Var.f36572s = null;
                dc0 dc0Var = g31Var.h;
            ...
            case 14:
                ...
                ((SecretMediaViewer) obj2).f34125s = false;
            ...
            case 16:
                ...
                UsersSelectActivity usersSelectActivity = yh1Var.f43180f;
                usersSelectActivity.f34266c.setAllowDrawCursor(true);
                if (usersSelectActivity.O.isEmpty()) {
                    usersSelectActivity.f34266c.setHintVisible(true, true);
                    return;
                }
                return;
            case 17:
                ((Runnable) obj).run();
                ui1 ui1Var = (ui1) obj2;
                ui1Var.f41146e0.setScaleX(1.15f);
                ui1Var.f41146e0.setScaleY(1.15f);
                ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) ui1Var.f41146e0.getLayoutParams();
                marginLayoutParams.leftMargin = AndroidUtilities.dp(10.0f);
                marginLayoutParams.rightMargin = AndroidUtilities.dp(10.0f);
                ui1Var.f41146e0.setVisibility(8);
                return;
            case 18:
                r0.v0 v0Var = (r0.v0) obj;
                v0Var.f44766a.d(1.0f);
            ...
            case 22:
                ...
                eaVar.f7203b = null;
                eaVar.f7204c = false;
                ((yg.i) eaVar.f7207n).f50209b.setAllowDrawCursor(true);
                return;
            default:
                zh.q8 q8Var = (zh.q8) obj2;
                q8Var.f52517b.remove((zh.p8) obj);
                q8Var.a1();
                return;
        }
    }
    ...
    public void onAnimationStart(Animator animator) {
        switch (this.f29439a) {
            case 8:
                ((tv0) this.f29440b).setVisibility(0);
                return;
            default:
