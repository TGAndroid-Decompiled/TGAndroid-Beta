...
public final class v51 extends xw0 {
    ...
    @Override
    public final void d() {
        this.f28935f = System.currentTimeMillis();
        this.f28936g = true;
        invalidateSelf();
    }
    ...
    public final void f() {
        if (this.f28936g) {
            if (NotificationCenter.getInstance(this.f28932a).isAnimationInProgress() && !this.f28937i) {
                AndroidUtilities.runOnUIThread(new xq0(this, 26), 100L);
                return;
            }
            long currentTimeMillis = System.currentTimeMillis();
            long j3 = currentTimeMillis - this.f28935f;
            this.f28935f = currentTimeMillis;
            if (j3 > 50) {
                j3 = 50;
            }
            for (int i10 = 0; i10 < 3; i10++) {
