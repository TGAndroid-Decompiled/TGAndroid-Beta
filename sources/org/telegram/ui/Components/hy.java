...
public final class hy implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        int i12 = org.telegram.ui.ActionBar.j6.f19246n5;
        int i13 = kz.O2;
        ...
        textView2.setTextColor(kzVar.z(org.telegram.ui.ActionBar.j6.f19169j5));
        if (LocaleController.isRTL) {
            i11 = 5;
        } else {
            i11 = 3;
        ...
        Object obj = kyVar.f25879w;
        if (obj == null) {
            obj = kzVar.W0;
        }
        textView3.setText(LocaleController.formatString("EmojiSuggestionsUrl", i15, obj));
        textView3.setTextSize(1, 15.0f);
        textView3.setTextColor(kzVar.z(org.telegram.ui.ActionBar.j6.f19189k5));
        if (LocaleController.isRTL) {
            i14 = 5;
        }
