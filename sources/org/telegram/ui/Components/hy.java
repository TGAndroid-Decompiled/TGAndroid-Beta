...
public final class hy implements View.OnClickListener {
    ...
    public final org.telegram.ui.ActionBar.z2 f24885b;
    public final iy f24886c;
    ...
    public final void onClick(View view) {
        ...
        lz lzVar = lyVar.F;
        String str = lyVar.f26224w;
        if (str == null) {
            str = lzVar.W0[0];
        }
        tL_messages_getEmojiURL.lang_code = str;
        AndroidUtilities.runOnUIThread(new xm(this, a2VarArr, ConnectionsManager.getInstance(lzVar.f26236c1).sendRequest(tL_messages_getEmojiURL, new ai.s5(this, a2VarArr, this.f24885b, 8)), 2), 1000L);
    }
}
