...
public final class lb0 extends s4.s0 {
    ...
    public void a(RecyclerView recyclerView, int i10) {
        ...
        switch (i11) {
            ...
            case 3:
                ...
                if (i10 == 0) {
                    if (ll0Var.f28237v2) {
                        ll0Var.f28237v2 = false;
                        NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.startAllHeavyOperations, 512);
                    }
                } else if (!ll0Var.f28237v2 && ll0Var.f28240x1) {
                    ll0Var.f28237v2 = true;
                    NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.stopAllHeavyOperations, 512);
                }
                if (i10 != 0 && ll0Var.N1 != null) {
                    dl0 dl0Var = ll0Var.f28203e1;
                    if (dl0Var != null) {
                        AndroidUtilities.cancelRunOnUIThread(dl0Var);
                        ll0Var.f28203e1 = null;
                    }
            ...
            case 8:
                ...
                if (i10 == 0 && o61Var.G && AndroidUtilities.dp(13.0f) + o61.m(o61Var) + o61Var.f28985y < AndroidUtilities.statusBarHeight * 2 && o0Var.canScrollVertically(1) && (vk0Var = (vk0) o0Var.K(0)) != null) {
                    View view3 = vk0Var.f45739a;
                    if (view3.getTop() > 0) {
            ...
            case 12:
                ...
                if (i10 == 0) {
                    for (int i12 = 0; i12 < recyclerView.getChildCount(); i12++) {
                        ...
                        if (r1Var == null || r1Var2.f46247a > r1Var.f46247a) {
                            r1Var = r1Var2;
                        }
                    }
                    if (r1Var != null) {
                        u0Var.v1(r1Var, true);
                        u0Var.f46271d3 = false;
                        u0Var.v0(0, r1Var.getTop() - ((u0Var.getMeasuredHeight() - r1Var.getMeasuredHeight()) / 2), AndroidUtilities.overshootInterpolator);
                    }
                    u0Var.w1();
                    return;
                }
                AndroidUtilities.cancelRunOnUIThread(u0Var.f46272e3);
                return;
            case 13:
                if (i10 == 1) {
    ...
    public void b(RecyclerView recyclerView, int i10, int i11) {
        ...
        switch (this.f28131a) {
            case 0:
                qb0 qb0Var = (qb0) this.f28132b;
                org.telegram.ui.w8 w8Var = qb0Var.f29660b;
                ...
                return;
            case 1:
                pg0 pg0Var = (pg0) this.f28132b;
                if (pg0Var.f29371b.getChildCount() > 0) {
                    pg0.t(pg0Var);
                    return;
                }
                return;
            case 2:
                fk0 fk0Var = (fk0) this.f28132b;
                bi.o0 o0Var = fk0Var.f26081b;
                int[] iArr = fk0Var.f26093f0;
            ...
            case 3:
                ...
                ll0Var.K0(false);
                if (i11 != 0 && (sk0Var = ll0Var.f28205f1) != null) {
                    sk0Var.b();
                }
            ...
            default:
                return;
            case 5:
                bv0.m((bv0) this.f28132b);
                return;
            case 6:
                ((dw0) this.f28132b).X.V();
                return;
            case 7:
                ux0.O((ux0) this.f28132b);
                return;
            case 8:
                ((o61) this.f28132b).L();
                return;
            case 9:
                ((h81) this.f28132b).invalidate();
                return;
            case 10:
                org.telegram.ui.web.q qVar = (org.telegram.ui.web.q) this.f28132b;
                if (!qVar.f32850a.canScrollVertically(1)) {
                    if (TextUtils.isEmpty(qVar.f42216s)) {
                        qVar.d.d();
                    } else {
                        org.telegram.ui.web.j jVar = qVar.f42212e;
                        if (jVar != null) {
                            jVar.d();
                        }
                    }
                ...
                return;
            case 11:
                org.telegram.ui.web.i1 i1Var = (org.telegram.ui.web.i1) this.f28132b;
                if (i1Var.f32850a.K1) {
                ...
                return;
            case 12:
                sg.u0 u0Var = (sg.u0) this.f28132b;
            ...
            case 15:
                ...
                xh.n nVar = (xh.n) this.f28132b;
                xh.e eVar = nVar.C;
                if (nVar.f49463x && !nVar.f49462w && c0Var != null) {
                    if (nVar.f49447f.h() - c0Var.N0() < 10) {
                ...
                return;
            case 16:
                yh.g4 g4Var = (yh.g4) this.f28132b;
                int i16 = 0;
                while (true) {
                    if (i16 < g4Var.f50298n.getChildCount()) {
                        if (g4Var.f50298n.getChildAt(i16) instanceof t00) {
                            g4Var.d.g(false);
                        } else {
                            i16++;
                        }
                ...
                if (g4Var.K && g4Var.f50298n.canScrollVertically(-1)) {
                    f7 = 1.0f;
                } else {
                    f7 = 0.0f;
                }
                ...
                return;
            case 17:
                ((yh.f4) this.f28132b).Z();
                return;
            case 18:
                zh.g gVar = (zh.g) this.f28132b;
                if (gVar.f51902a == 1) {
                    if (gVar.f51909e.canScrollVertically(1)) {
                        for (int i17 = 0; i17 < gVar.f51909e.getChildCount(); i17++) {
                            if (!(gVar.f51909e.getChildAt(i17) instanceof t00)) {
                            }
                        }
                        return;
                    }
                ...
                return;
            case 19:
                zh.s0 s0Var2 = (zh.s0) this.f28132b;
                bh.f fVar = s0Var2.f52548s0;
                View view = s0Var2.f52546q0;
                FrameLayout frameLayout = s0Var2.f52542l0;
                ...
                return;
            case 20:
                ((zh.w3) this.f28132b).Y.e();
                return;
            case 21:
                zh.s7 s7Var = (zh.s7) this.f28132b;
                d61 d61Var = s7Var.f52592a;
