...
public final class lb0 extends s4.s0 {
    ...
    public void a(RecyclerView recyclerView, int i10) {
        ...
        switch (i11) {
            ...
            case 3:
                ...
                if (i10 == 0) {
                    if (ll0Var.f28263v2) {
                        ll0Var.f28263v2 = false;
                        NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.startAllHeavyOperations, 512);
                    }
                } else if (!ll0Var.f28263v2 && ll0Var.f28266x1) {
                    ll0Var.f28263v2 = true;
            ...
            case 8:
                ...
                if (i10 == 0 && o61Var.G && AndroidUtilities.dp(13.0f) + o61.m(o61Var) + o61Var.f29011y < AndroidUtilities.statusBarHeight * 2 && o0Var.canScrollVertically(1) && (vk0Var = (vk0) o0Var.K(0)) != null) {
                    View view3 = vk0Var.f45766a;
                    if (view3.getTop() > 0) {
            ...
            case 12:
                ...
                if (i10 == 0) {
                    for (int i12 = 0; i12 < recyclerView.getChildCount(); i12++) {
                        ...
                        if (r1Var == null || r1Var2.f46274a > r1Var.f46274a) {
                            r1Var = r1Var2;
                        }
                    }
                    if (r1Var != null) {
                ...
                AndroidUtilities.cancelRunOnUIThread(u0Var.f46299e3);
                return;
            case 13:
                if (i10 == 1) {
    ...
    public void b(RecyclerView recyclerView, int i10, int i11) {
        ...
        switch (this.f28157a) {
            case 0:
                qb0 qb0Var = (qb0) this.f28158b;
                org.telegram.ui.w8 w8Var = qb0Var.f29686b;
                ...
                return;
            case 1:
                pg0 pg0Var = (pg0) this.f28158b;
                if (pg0Var.f29397b.getChildCount() > 0) {
                    pg0.t(pg0Var);
                    return;
                }
                return;
            case 2:
                fk0 fk0Var = (fk0) this.f28158b;
                bi.o0 o0Var = fk0Var.f26107b;
                int[] iArr = fk0Var.f26119f0;
            ...
            case 3:
                ...
                ll0Var.K0(false);
                if (i11 != 0 && (sk0Var = ll0Var.f28231f1) != null) {
                    sk0Var.b();
                }
            ...
            default:
                return;
            case 5:
                bv0.m((bv0) this.f28158b);
                return;
            case 6:
                ((dw0) this.f28158b).X.V();
                return;
            case 7:
                ux0.O((ux0) this.f28158b);
                return;
            case 8:
                ((o61) this.f28158b).L();
                return;
            case 9:
                ((h81) this.f28158b).invalidate();
                return;
            case 10:
                org.telegram.ui.web.q qVar = (org.telegram.ui.web.q) this.f28158b;
                if (!qVar.f32876a.canScrollVertically(1)) {
                    if (TextUtils.isEmpty(qVar.f42242s)) {
                        qVar.d.d();
                    } else {
                        org.telegram.ui.web.j jVar = qVar.f42238e;
                        if (jVar != null) {
                            jVar.d();
                        }
                    }
                ...
                return;
            case 11:
                org.telegram.ui.web.i1 i1Var = (org.telegram.ui.web.i1) this.f28158b;
                if (i1Var.f32876a.K1) {
                ...
                return;
            case 12:
                sg.u0 u0Var = (sg.u0) this.f28158b;
            ...
            case 15:
                ...
                xh.n nVar = (xh.n) this.f28158b;
                xh.e eVar = nVar.C;
                if (nVar.f49491x && !nVar.f49490w && c0Var != null) {
                    if (nVar.f49475f.h() - c0Var.N0() < 10) {
                ...
                return;
            case 16:
                yh.g4 g4Var = (yh.g4) this.f28158b;
                int i16 = 0;
                while (true) {
                    if (i16 < g4Var.f50326n.getChildCount()) {
                        if (g4Var.f50326n.getChildAt(i16) instanceof t00) {
                            g4Var.d.g(false);
                        } else {
                            i16++;
                        }
                ...
                if (g4Var.K && g4Var.f50326n.canScrollVertically(-1)) {
                    f7 = 1.0f;
                } else {
                    f7 = 0.0f;
                }
                org.telegram.messenger.wl.q(animate.alpha(f7), pr.h, 320L);
                return;
            case 17:
                ((yh.f4) this.f28158b).Z();
                return;
            case 18:
                zh.g gVar = (zh.g) this.f28158b;
                if (gVar.f51932a == 1) {
                    if (gVar.f51939e.canScrollVertically(1)) {
                        for (int i17 = 0; i17 < gVar.f51939e.getChildCount(); i17++) {
                            if (!(gVar.f51939e.getChildAt(i17) instanceof t00)) {
                            }
                        }
                        return;
                    }
                ...
                return;
            case 19:
                zh.s0 s0Var2 = (zh.s0) this.f28158b;
                bh.f fVar = s0Var2.f52578s0;
                View view = s0Var2.f52576q0;
                FrameLayout frameLayout = s0Var2.f52572l0;
                ...
                return;
            case 20:
                ((zh.w3) this.f28158b).Y.e();
                return;
            case 21:
                zh.s7 s7Var = (zh.s7) this.f28158b;
                d61 d61Var = s7Var.f52622a;
