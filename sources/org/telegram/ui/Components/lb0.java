...
public final class lb0 extends s4.s0 {
    ...
    public void a(RecyclerView recyclerView, int i10) {
        ...
        switch (i11) {
            ...
            case 3:
                ...
                if (i10 == 0) {
                    if (ll0Var.f28264v2) {
                        ll0Var.f28264v2 = false;
                        NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.startAllHeavyOperations, 512);
                    }
                } else if (!ll0Var.f28264v2 && ll0Var.f28267x1) {
                    ll0Var.f28264v2 = true;
                    NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.stopAllHeavyOperations, 512);
                }
                if (i10 != 0 && ll0Var.N1 != null) {
                    dl0 dl0Var = ll0Var.f28230e1;
                    if (dl0Var != null) {
                        AndroidUtilities.cancelRunOnUIThread(dl0Var);
                        ll0Var.f28230e1 = null;
                    }
            ...
            case 8:
                ...
                if (i10 == 0 && o61Var.G && AndroidUtilities.dp(13.0f) + o61.m(o61Var) + o61Var.f29012y < AndroidUtilities.statusBarHeight * 2 && o0Var.canScrollVertically(1) && (vk0Var = (vk0) o0Var.K(0)) != null) {
                    View view3 = vk0Var.f45767a;
                    if (view3.getTop() > 0) {
            ...
            case 12:
                ...
                if (i10 == 0) {
                    for (int i12 = 0; i12 < recyclerView.getChildCount(); i12++) {
                        ...
                        if (r1Var == null || r1Var2.f46275a > r1Var.f46275a) {
                            r1Var = r1Var2;
                        }
                    }
                    if (r1Var != null) {
                ...
                AndroidUtilities.cancelRunOnUIThread(u0Var.f46300e3);
                return;
            case 13:
                if (i10 == 1) {
    ...
    public void b(RecyclerView recyclerView, int i10, int i11) {
        ...
        switch (this.f28158a) {
            case 0:
                qb0 qb0Var = (qb0) this.f28159b;
                org.telegram.ui.w8 w8Var = qb0Var.f29687b;
                ...
                return;
            case 1:
                pg0 pg0Var = (pg0) this.f28159b;
                if (pg0Var.f29398b.getChildCount() > 0) {
                    pg0.t(pg0Var);
                    return;
                }
                return;
            case 2:
                fk0 fk0Var = (fk0) this.f28159b;
                bi.o0 o0Var = fk0Var.f26108b;
                int[] iArr = fk0Var.f26120f0;
            ...
            case 3:
                ...
                ll0Var.K0(false);
                if (i11 != 0 && (sk0Var = ll0Var.f28232f1) != null) {
                    sk0Var.b();
                }
            ...
            default:
                return;
            case 5:
                bv0.m((bv0) this.f28159b);
                return;
            case 6:
                ((dw0) this.f28159b).X.V();
                return;
            case 7:
                ux0.O((ux0) this.f28159b);
                return;
            case 8:
                ((o61) this.f28159b).L();
                return;
            case 9:
                ((h81) this.f28159b).invalidate();
                return;
            case 10:
                org.telegram.ui.web.q qVar = (org.telegram.ui.web.q) this.f28159b;
                if (!qVar.f32877a.canScrollVertically(1)) {
                    if (TextUtils.isEmpty(qVar.f42243s)) {
                        qVar.d.d();
                    } else {
                        org.telegram.ui.web.j jVar = qVar.f42239e;
                        if (jVar != null) {
                            jVar.d();
                        }
                    }
                ...
                return;
            case 11:
                org.telegram.ui.web.i1 i1Var = (org.telegram.ui.web.i1) this.f28159b;
                if (i1Var.f32877a.K1) {
                ...
                return;
            case 12:
                sg.u0 u0Var = (sg.u0) this.f28159b;
            ...
            case 15:
                ...
                xh.n nVar = (xh.n) this.f28159b;
                xh.e eVar = nVar.C;
                if (nVar.f49492x && !nVar.f49491w && c0Var != null) {
                    if (nVar.f49476f.h() - c0Var.N0() < 10) {
                ...
                return;
            case 16:
                yh.g4 g4Var = (yh.g4) this.f28159b;
                int i16 = 0;
                while (true) {
                    if (i16 < g4Var.f50327n.getChildCount()) {
                        if (g4Var.f50327n.getChildAt(i16) instanceof t00) {
                            g4Var.d.g(false);
                        } else {
                            i16++;
                        }
                ...
                if (g4Var.K && g4Var.f50327n.canScrollVertically(-1)) {
                    f7 = 1.0f;
                } else {
                    f7 = 0.0f;
                }
                ...
                return;
            case 17:
                ((yh.f4) this.f28159b).Z();
                return;
            case 18:
                zh.g gVar = (zh.g) this.f28159b;
                if (gVar.f51933a == 1) {
                    if (gVar.f51940e.canScrollVertically(1)) {
                        for (int i17 = 0; i17 < gVar.f51940e.getChildCount(); i17++) {
                            if (!(gVar.f51940e.getChildAt(i17) instanceof t00)) {
                            }
                        }
                        return;
                    }
                ...
                return;
            case 19:
                zh.s0 s0Var2 = (zh.s0) this.f28159b;
                bh.f fVar = s0Var2.f52579s0;
                View view = s0Var2.f52577q0;
                FrameLayout frameLayout = s0Var2.f52573l0;
                ...
                return;
            case 20:
                ((zh.w3) this.f28159b).Y.e();
                return;
            case 21:
                zh.s7 s7Var = (zh.s7) this.f28159b;
                d61 d61Var = s7Var.f52623a;
