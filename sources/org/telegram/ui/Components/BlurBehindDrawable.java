...
public class BlurBehindDrawable {
    ...
    public class BlurBackgroundTask implements Runnable {
        ...
        public void run() {
            ...
            AndroidUtilities.runOnUIThread(new ShareAlert$23$$ExternalSyntheticLambda0(this, 23));
        }
    }
    ...
    public void lambda$clear$2() {
        ...
        this.skipDraw = false;
        AndroidUtilities.runOnUIThread(new BlurBehindDrawable$$ExternalSyntheticLambda0(this, 1));
    }
    ...
    public void clear() {
        ...
        if (dispatchQueue != null) {
            dispatchQueue.cleanupQueue();
            this.queue.postRunnable(new BlurBehindDrawable$$ExternalSyntheticLambda0(this, 2));
        }
    }
                ...
                for (int i = 0; i < 2; i++) {
                    if (this.blurredBitmapTmp[i] != null && this.parentView.getMeasuredWidth() == this.lastW && this.parentView.getMeasuredHeight() == this.lastH) {
                        ...
                        try {
                            ...
                            FileLog.e(e);
                            AndroidUtilities.runOnUIThread(new BlurBehindDrawable$$ExternalSyntheticLambda0(this, 0));
                            return;
                        }
                    }
                    if (i == 1) {
