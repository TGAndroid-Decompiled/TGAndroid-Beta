...
public final class zh extends View {
    ...
    public void draw(Canvas canvas) {
        switch (this.f30525a) {
            case 0:
                super.draw(canvas);
                this.f30526b.f28728b0.draw(canvas);
                return;
            default:
                super.draw(canvas);
                return;
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f30525a) {
            case 1:
                vi viVar = this.f30526b;
                String format = String.format("%d", Integer.valueOf(Math.max(1, viVar.f28803y0.getSelectedItemsCount())));
                ...
                viVar.L0.setColor(viVar.getThemedColor(org.telegram.ui.ActionBar.j6.f18933h5));
                int i10 = max / 2;
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        switch (this.f30525a) {
            case 0:
                ...
                this.f30526b.f28728b0.setBounds(0, (i11 - AndroidUtilities.navigationBarHeight) - AndroidUtilities.dp(48.0f), i10, i11);
                return;
            default:
                super.onSizeChanged(i10, i11, i12, i13);
                return;
