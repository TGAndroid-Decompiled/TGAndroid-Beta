...
public final class b00 implements ll0, ml0 {
    ...
    public void c(float f7, float f10, int i10, View view) {
        l00 l00Var = this.f22831a;
        f00 f00Var = l00Var.J;
        if (!((org.telegram.ui.pw) f00Var).f36687b.f37062j2) {
            j00 j00Var = (j00) view;
            if (l00Var.f25951n) {
                if (i10 != 0) {
                    int dp = AndroidUtilities.dp(6.0f);
                    RectF rectF = j00Var.f25216f;
                    float f11 = dp;
                    if (rectF.left - f11 < f7 && rectF.right + f11 > f7) {
                        org.telegram.ui.pw pwVar = (org.telegram.ui.pw) l00Var.J;
                        pwVar.d(pwVar.f36687b.getMessagesController().getDialogFilters().get(j00Var.f25210b.f24584a));
                    }
                }
            } else if (i10 == l00Var.K && f00Var != null) {
                ((org.telegram.ui.pw) f00Var).f36687b.x4(true, false);
            } else {
                l00Var.f(j00Var.f25210b, i10);
            }
        }
    }
