...
public final class y21 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, le.d {
    public static final int f30095f0 = 0;
    ...
    public long V;
    public boolean W;
    public final le.b f30096a;
    public Utilities.Callback2 f30097a0;
    public final int f30098b;
    public Runnable f30099b0;
    public final long f30100c;
    public Utilities.Callback2 f30101c0;
    public final org.telegram.ui.ActionBar.f6 d;
    public boolean f30102d0;
    public final boolean e;
    public final HashSet f30103e0;
    public final boolean f30104f;
    public final org.telegram.ui.bo h;
    public final boolean f30105n;
    public final FrameLayout f30106r;
    public final m21 f30107s;
    public final x21 v;
    public final ImageView f30108w;
    public final ImageView f30109x;
    ...
    public y21(Activity activity, org.telegram.ui.bo boVar, int i10, long j3, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        boolean z10;
        qr qrVar = qr.h;
        this.f30096a = new le.b(0, this, qrVar, 380L, true);
        this.J = new le.b(0, new d21(this), qrVar, 320L, false);
        this.R = 0.0f;
        this.f30103e0 = new HashSet();
        this.h = boVar;
        this.f30098b = i10;
        this.f30100c = j3;
        this.d = f6Var;
        ...
        this.f30104f = isBotForumWithEditableTopics;
        this.f30105n = !org.telegram.messenger.w1.v("topics_end_reached_", j10, UserConfig.getInstance(i10).getPreferences(), false);
        setClipChildren(true);
        setClipToPadding(true);
        setWillNotDraw(false);
        ?? frameLayout2 = new FrameLayout(activity);
        this.f30106r = frameLayout2;
        ...
        m21 m21Var = new m21(this, activity, i10, new Utilities.Callback2(this) {
            ...
            public final void run(Object obj, Object obj2) {
                ...
                boolean z17;
                int i13 = r2;
                y21 y21Var = this.f25807b;
                switch (i13) {
                    case 0:
                        ArrayList arrayList = (ArrayList) obj;
                        x51 x51Var = (x51) obj2;
                        boolean z18 = y21Var.f30104f;
                        int i14 = y21Var.f30098b;
                        MessagesController messagesController = MessagesController.getInstance(i14);
                        long j16 = y21Var.f30100c;
                        long j17 = -j16;
                        ...
                        if (topics != null) {
                            ...
                            while (i16 < size) {
                                ...
                                if (y21Var.f30103e0.contains(Integer.valueOf(tL_forumTopic2.f18173id))) {
                                    size = i18;
                                    i16 = i12;
                                } else {
                                    ...
                                    if (!z21 && z20) {
                                        if (!arrayList.isEmpty()) {
                                            ((j51) hg.k0.h(1, arrayList)).f25136y |= 8;
                                        }
                                        x51Var.L();
                                        z20 = false;
                                    } else if (z21 && !z20) {
                        ...
                        if (topics != null && !topics.isEmpty() && !topicsController2.endIsReached(j17) && y21Var.f30105n) {
                    ...
                    default:
                        ...
                        if (topics2 != null) {
                            ...
                            while (i21 < size2) {
                                ...
                                if (y21Var.f30103e0.contains(Integer.valueOf(tL_forumTopic4.f18173id))) {
                                    chat2 = chat3;
                                    size2 = i22;
                                    user3 = user;
                                } else {
                        ...
                        if (topics2 != null && !topics2.isEmpty() && !topicsController.endIsReached(j20) && y21Var.f30105n) {
                            int i24 = w21.f29505a;
                ...
                public final void onClick(View view) {
                    switch (r2) {
                        case 0:
                            ...
                            return;
                        case 1:
                            y21 y21Var2 = this.f24466b;
                            o21 o21Var = y21Var2.G;
                            o21Var.x1(false);
                            m21 m21Var2 = y21Var2.f30107s;
                            m21Var2.x1(false);
                            ...
                            return;
                        default:
                            this.f24466b.f30097a0.run(0, Boolean.FALSE);
                            return;
                    }
                }
            });
    ...
    public static void a(y21 y21Var, j51 j51Var) {
        if (y21Var.e) {
            Utilities.Callback2 callback2 = y21Var.f30101c0;
            if (callback2 != null) {
                callback2.run(Long.valueOf(j51Var.B), Boolean.FALSE);
            }
        } else if (j51Var.B == -2) {
            Runnable runnable = y21Var.f30099b0;
            if (runnable != null) {
                runnable.run();
            }
        } else {
            Utilities.Callback2 callback22 = y21Var.f30097a0;
            if (callback22 != null) {
    ...
    public static void b(y21 y21Var, ArrayList arrayList) {
        ...
        TopicsController topicsController = MessagesController.getInstance(y21Var.f30098b).getTopicsController();
    ...
    public static boolean c(final y21 y21Var, j51 j51Var, View view) {
        ...
        long j3 = y21Var.f30100c;
        int i18 = y21Var.f30098b;
        if (y21Var.G.f23797c3 || y21Var.f30107s.f23797c3) {
            return false;
        }
        Object obj = j51Var.G;
            ...
            if (ChatObject.canManageTopics(chat4) || UserObject.isBotForumWithEditableTopics(user)) {
                I.c(R.drawable.outline_profile_edit_24, LocaleController.getString(R.string.EditTopic), new Runnable(y21Var) {
                    ...
                    public final void run() {
                        ...
                        int i21 = r4;
                        y21 y21Var2 = this.f24070b;
                        TLRPC.TL_forumTopic tL_forumTopic2 = tL_forumTopic;
                        n70 n70Var3 = I;
                        switch (i21) {
                            case 0:
                                n70Var3.u();
                                y21Var2.h.presentFragment(bf1.a0(-y21Var2.f30100c, tL_forumTopic2.f18173id));
                                return;
                            case 1:
                                y21Var2.getClass();
                                n70Var3.u();
                                MessagesController.getInstance(y21Var2.f30098b).getTopicsController().toggleCloseTopic(-y21Var2.f30100c, tL_forumTopic2.f18173id, true ^ tL_forumTopic2.closed);
                                return;
                            default:
                                n70Var3.u();
                                ...
                                if (hashSet.size() == 1) {
                                    ...
                                    c2Var.T = LocaleController.formatString(R.string.DeleteSelectedTopic, MessagesController.getInstance(y21Var3.f30098b).getTopicsController().findTopic(-y21Var3.f30100c, ((Integer) arrayList.get(0)).intValue()).title);
                                } else {
                                    alertDialog$Builder = alertDialog$Builder2;
        ...
        if (view instanceof t21) {
            ...
            int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18862d6, f6Var);
            float f7 = b10;
            float f10 = dp;
            float f11 = dp2;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i12) {
            ...
            MessagesController.getInstance(this.f30098b).getTopicsController().sortTopics(-j3, false);
            o();
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        FrameLayout frameLayout2 = this.f30106r;
    ...
    public final void f(boolean z10) {
        boolean z11;
        ArrayList<TLRPC.TL_forumTopic> topics = MessagesController.getInstance(this.f30098b).getTopicsController().getTopics(-this.f30100c);
        if (topics != null && !topics.isEmpty() && !this.f30102d0) {
            z11 = true;
        } else {
            z11 = false;
        }
        this.f30096a.a(z11, z10);
    }
    ...
    public final void g() {
        ...
        le.b bVar = this.J;
        float f7 = bVar.e;
        ImageView imageView = this.f30108w;
        ...
        ImageView imageView2 = this.f30109x;
        ...
        ImageView imageView3 = this.f30110y;
    ...
    public float getSideMenuT() {
        return this.R * this.f30096a.e;
    }

    public final void h() {
        int i10;
        float lerp = AndroidUtilities.lerp(1.0f, 0.0f, this.R);
        FrameLayout frameLayout = this.f30106r;
        frameLayout.setAlpha(lerp);
        if ((1.0f - this.R) * this.f30096a.e > 0.0f) {
            i10 = 0;
        } else {
            i10 = 8;
        }
        ...
        if (this.P) {
            frameLayout.setTranslationY(((getMeasuredHeight() - AndroidUtilities.dp(50.0f)) - this.M) + AndroidUtilities.lerp(AndroidUtilities.dp(43.0f), 0, j(u21.f28262c)));
        } else {
            frameLayout.setTranslationY(this.N + AndroidUtilities.lerp(-AndroidUtilities.dp(43.0f), 0, j(u21.f28260a)));
        }
    }

    public final float j(u21 u21Var) {
        float f7;
        float f10 = this.f30096a.e;
        if (u21Var == u21.f28261b) {
            f7 = this.R;
        } else if ((u21Var == u21.f28260a && !this.P) || (u21Var == u21.f28262c && this.P)) {
            f7 = 1.0f - this.R;
        } else {
            return 0.0f;
        }
    ...
    public final void l() {
        TopicsController topicsController = MessagesController.getInstance(this.f30098b).getTopicsController();
        long j3 = this.f30100c;
    ...
    public final void m(long j3, boolean z10) {
        if (this.e) {
            Utilities.Callback2 callback2 = this.f30101c0;
            if (callback2 != null) {
        ...
        Utilities.Callback2 callback22 = this.f30097a0;
        if (callback22 != null) {
    ...
    public final void n() {
        ...
        this.f30110y.setColorFilter(new PorterDuffColorFilter(d, mode));
        ...
        this.f30108w.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i12, f6Var), mode));
        this.f30109x.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i12, f6Var), mode));
        invalidate();
    }
