...
public class a50 {
    ...
    public a50(int i10) {
        ...
        this.f22310f = GLES20.glGetUniformLocation(glCreateProgram, "sTexture");
    }

    public final void a() {
        GLES20.glDeleteProgram(this.f22307a);
        GLES20.glDeleteShader(this.f22308b);
        GLES20.glDeleteShader(this.f22309c);
    }
}
