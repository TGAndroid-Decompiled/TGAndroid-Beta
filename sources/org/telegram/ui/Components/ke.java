...
public final class ke extends FrameLayout {
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        switch (this.f27836a) {
            case 0:
                ...
                fi.f4 f4Var = chatActivityEnterView.f23753k0;
                if (f4Var != null && f4Var.getVisibility() == 0) {
                    return chatActivityEnterView.f23753k0.dispatchTouchEvent(motionEvent);
                }
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        switch (this.f27836a) {
            case 1:
                ChatActivityEnterView chatActivityEnterView = this.f27837b;
                if (view == chatActivityEnterView.J0 && chatActivityEnterView.f23736h0) {
                    return true;
                }
