...
public final class ke extends FrameLayout {
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        switch (this.f27809a) {
            case 0:
                ChatActivityEnterView chatActivityEnterView = this.f27810b;
                fi.f4 f4Var = chatActivityEnterView.f23726k0;
                if (f4Var != null && f4Var.getVisibility() == 0) {
                    return chatActivityEnterView.f23726k0.dispatchTouchEvent(motionEvent);
                }
                return super.dispatchTouchEvent(motionEvent);
            case 1:
                ChatActivityEnterView chatActivityEnterView2 = this.f27810b;
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        switch (this.f27809a) {
            case 1:
                ChatActivityEnterView chatActivityEnterView = this.f27810b;
                if (view == chatActivityEnterView.J0 && chatActivityEnterView.f23709h0) {
                    return true;
                }
