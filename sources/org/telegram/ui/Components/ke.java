...
public final class ke extends FrameLayout {
    public final ChatActivityEnterView f25622a;

    public ke(ChatActivityEnterView chatActivityEnterView, Activity activity) {
        super(activity);
        this.f25622a = chatActivityEnterView;
    }

    @Override
    public final boolean drawChild(final Canvas canvas, final View view, final long j3) {
        ChatActivityEnterView chatActivityEnterView = this.f25622a;
        if (view != null && view == chatActivityEnterView.E0) {
            return chatActivityEnterView.g0(canvas, new Utilities.Callback0Return() {
                @Override
        ...
        if (chatActivityEnterView.f21890z4 && view == chatActivityEnterView.f21771e1) {
            return true;
        }
        ...
        if (!chatActivityEnterView.B0.isEmpty()) {
            for (int i14 = 0; i14 < getChildCount(); i14++) {
                ...
                if (f7 != null) {
                    ...
                    childAt.animate().translationX(0.0f).setDuration(150L).setInterpolator(qr.f27383f).start();
                }
            }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ChatActivityEnterView chatActivityEnterView = this.f25622a;
        le.e eVar = chatActivityEnterView.f21782f5;
        if (eVar.e > 0.0f) {
            eVar.a(max);
        } else {
            eVar.c(max);
