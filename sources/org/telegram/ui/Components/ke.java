...
public final class ke extends Property {
    ...
    public final Object get(Object obj) {
        switch (this.f25710a) {
            case 0:
                View view = (View) obj;
                return Float.valueOf(this.f25711b.h);
            case 1:
                View view2 = (View) obj;
                return Float.valueOf(this.f25711b.E);
            case 2:
                View view3 = (View) obj;
                return Float.valueOf(this.f25711b.f22030n);
            case 3:
                View view4 = (View) obj;
                return Float.valueOf(this.f25711b.f22084x);
            default:
                View view5 = (View) obj;
                return Float.valueOf(this.f25711b.G);
        }
    }
    ...
    public final void set(Object obj, Object obj2) {
        switch (this.f25710a) {
            ...
            case 2:
                ...
                ChatActivityEnterView chatActivityEnterView3 = this.f25711b;
            ...
            case 3:
                ...
                ChatActivityEnterView chatActivityEnterView4 = this.f25711b;
            ...
            default:
                ...
                ChatActivityEnterView chatActivityEnterView5 = this.f25711b;
