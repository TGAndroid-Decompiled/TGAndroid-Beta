...
public final class ke extends FrameLayout {
    ...
    public final boolean drawChild(final Canvas canvas, final View view, final long j3) {
        ...
        if (chatActivityEnterView.f21874z4 && view == chatActivityEnterView.f21755e1) {
            return true;
        }
        ...
        if (!chatActivityEnterView.B0.isEmpty()) {
            for (int i14 = 0; i14 < getChildCount(); i14++) {
                ...
                if (f7 != null) {
                    ...
                    childAt.animate().translationX(0.0f).setDuration(150L).setInterpolator(qr.f27420f).start();
                }
            }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ChatActivityEnterView chatActivityEnterView = this.f25591a;
        le.e eVar = chatActivityEnterView.f21766f5;
        if (eVar.e > 0.0f) {
            eVar.a(max);
        } else {
            eVar.c(max);
