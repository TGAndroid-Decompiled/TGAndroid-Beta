...
public final class f31 extends View {
    ...
    public final Paint f26730b;
    public final Paint f26731c;
    public Drawable d;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f26732e) {
            ...
            canvas2.drawRoundRect(rectF, dp, dp, this.f26730b);
        }
        int i10 = this.f26733f;
        Paint paint = this.f26731c;
        if (i10 != 0) {
            if (i10 == 1) {
                ...
                canvas2.save();
                canvas2.translate((-AndroidUtilities.dp(2.0f)) * this.f26729a, 0.0f);
                canvas2.rotate(this.f26729a * 90.0f, getWidth() / 2.0f, getHeight() / 2.0f);
                canvas2.drawLine(dp2 + ((width - dp2) * this.f26729a), height, width, height, paint);
                int dp3 = AndroidUtilities.dp((this.f26729a * (-1.0f)) + 9.0f);
                int dp4 = AndroidUtilities.dp((this.f26729a * 7.0f) + 9.0f);
                double d = width;
                double d10 = dp3;
                double d11 = height;
            ...
            float max = (Math.max(0.4f, this.f26729a) - 0.4f) / 0.6f;
            if (max != 0.0f) {
    ...
    public void setBackgroundColor(int i10) {
        this.f26730b.setColor(i10);
        invalidate();
    }

    public void setColor(int i10) {
        this.f26731c.setColor(i10);
        invalidate();
    }
