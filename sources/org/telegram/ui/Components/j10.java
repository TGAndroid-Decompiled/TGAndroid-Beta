...
public final class j10 implements org.telegram.ui.ActionBar.r0, le.k, org.telegram.ui.ActionBar.a2, av0 {
    public final FragmentContextView f27301a;

    public j10(FragmentContextView fragmentContextView) {
        this.f27301a = fragmentContextView;
    }

    @Override
    public void b(LocationController.SharingLocationInfo sharingLocationInfo) {
        float[] fArr = FragmentContextView.M0;
        this.f27301a.k(sharingLocationInfo);
    }

    @Override
    public void e(le.l lVar) {
        FragmentContextView fragmentContextView = this.f27301a;
    ...
    public void g(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        ...
        LocationController.getInstance(n2Var.getCurrentAccount()).removeSharingLocation(fragmentContextView.f23990n.a());
    }
