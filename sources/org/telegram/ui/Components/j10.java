...
public final class j10 implements org.telegram.ui.ActionBar.r0, le.k, org.telegram.ui.ActionBar.a2, ov0 {
    public final FragmentContextView f25234a;

    public j10(FragmentContextView fragmentContextView) {
        this.f25234a = fragmentContextView;
    }

    @Override
    public void b(LocationController.SharingLocationInfo sharingLocationInfo) {
        float[] fArr = FragmentContextView.O0;
        this.f25234a.k(sharingLocationInfo);
    }

    @Override
    public void c(le.l lVar) {
        FragmentContextView fragmentContextView = this.f25234a;
        le.l lVar2 = fragmentContextView.M0;
        float f7 = 1.0f - lVar2.f14207a.d.f14200c.f14208a;
    ...
    public void k(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        ...
        LocationController.getInstance(n2Var.getCurrentAccount()).removeSharingLocation(fragmentContextView.f22286n.a());
    }
