...
public final class wh0 extends View {
    ...
    public float K;
    public float L;
    public final org.telegram.ui.ActionBar.f6 f29670a;
    public final PorterDuffColorFilter f29671b;
    public final PorterDuffColorFilter f29672c;
    public h01 d;
    public h01 e;
    public final Paint f29673f;
    public final Paint h;
    public final Path f29674n;
    public final Drawable f29675r;
    public final RectF f29676s;
    public final Paint v;
    public final Paint f29677w;
    public final Path f29678x;
    public final wc f29679y;

    public wh0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.f29671b = new PorterDuffColorFilter(-1, mode);
        this.f29672c = new PorterDuffColorFilter(-16777216, mode);
        this.f29673f = new Paint();
        Paint paint = new Paint();
        this.h = paint;
        Path path = new Path();
        this.f29674n = path;
        this.f29676s = new RectF();
        this.v = new Paint(1);
        this.f29677w = new Paint(1);
        this.f29678x = new Path();
        this.f29679y = new wc(this);
        this.E = -1;
        this.f29670a = f6Var;
        this.f29675r = context.getResources().getDrawable(R.drawable.files_music).mutate();
    ...
    public final void a() {
        ...
        this.E = i10;
        if (z10) {
            porterDuffColorFilter = this.f29672c;
        } else {
            porterDuffColorFilter = this.f29671b;
        }
        this.f29675r.setColorFilter(porterDuffColorFilter);
        this.f29673f.setColor(this.E);
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        RectF rectF = this.f29676s;
        wc wcVar = this.f29679y;
        if (action == 0) {
    ...
    public final void onDraw(Canvas canvas) {
        if (this.d != null && this.e != null) {
            ...
            float a2 = this.f29679y.a(0.02f);
            if (clamp01 > 0.0f) {
                int width = getWidth() - (AndroidUtilities.dp(12.0f) * 2);
                this.d.f24449p = (width - AndroidUtilities.dp(35.0f)) / 2.0f;
                this.e.f24449p = (width - this.d.l()) - AndroidUtilities.dp(35.0f);
                ...
                int i12 = i10 - i11;
                int i13 = i10 + i11;
                Drawable drawable = this.f29675r;
                ...
                canvas.drawPath(this.f29674n, paint3);
                canvas.restore();
                canvas.restore();
            }
        }
    ...
    public void setColor(MessagesController.PeerColor peerColor) {
        int bgColor1;
        int bgColor2;
        org.telegram.ui.ActionBar.f6 f6Var = this.f29670a;
        if (peerColor == null) {
            bgColor1 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19139s8, f6Var);
            bgColor2 = bgColor1;
        } else {
        ...
        if (peerColor == null) {
            this.G = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18862d6, f6Var);
            this.H = true;
        } else {
