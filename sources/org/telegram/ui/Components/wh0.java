...
public class wh0 extends tp implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int Z0;
    public final SparseArray f30259a1;
    public boolean f30260b1;
    public boolean f30261c1;
    public boolean f30262d1;
    public org.telegram.ui.cv0 f30263e1;
    public boolean f30264f1;
    public int f30265g1;
    public int f30266h1;
    public int f30267i1;
    public int f30268j1;
    ...
    public int l1;
    public nh0 f30270m1;
    public ImageLocation f30271n1;
    public ImageLocation f30272o1;
    public final PointF f30273u0;
    public final int f30274v0;
    public final org.telegram.ui.ActionBar.k f30275w0;
    public boolean f30276x0;
    public boolean f30277y0;
    public final rl0 f30278z0;

    public wh0(Context context, org.telegram.ui.ActionBar.k kVar, rl0 rl0Var, org.telegram.ui.v4 v4Var) {
        super(context);
        this.f30273u0 = new PointF();
        this.f30276x0 = true;
        this.f30277y0 = true;
        ...
        this.f30270m1 = null;
        this.G0 = false;
        this.f30278z0 = rl0Var;
        ConnectionsManager.generateClassGuid();
        this.f30275w0 = kVar;
        this.f30274v0 = ViewConfiguration.get(context).getScaledTouchSlop();
        this.D0 = v4Var;
        b(new oh0(this));
    ...
    public final void A(ImageLocation imageLocation, ImageLocation imageLocation2) {
        ...
        this.A0.g();
        L();
        this.f30271n1 = imageLocation;
        this.f30272o1 = imageLocation2;
    }

    public final void B(float f10, int i10) {
        float f11;
        int i11 = this.f30265g1;
        float f12 = 0.0f;
        if (i11 >= 0 || this.f30266h1 >= 0) {
            if (i11 < 0) {
                i11 = this.f30266h1;
            }
    ...
    public final View E(int i10) {
        vh0 vh0Var = this.A0;
        if (vh0Var != null) {
            ArrayList arrayList = vh0Var.f29478c;
            if (arrayList.size() > i10 && i10 >= 0) {
                sh0 sh0Var = (sh0) arrayList.get(i10);
                th0 th0Var = sh0Var.f28746b;
                if (th0Var == null) {
                    return sh0Var.f28747c;
                }
                return th0Var;
            }
            return null;
    ...
    public final void N(int i10, int i11) {
        ...
        vh0 vh0Var = this.A0;
        if (vh0Var != null) {
            for (int i12 = 0; i12 < vh0Var.f29478c.size(); i12++) {
                if (((sh0) vh0Var.f29478c.get(i12)).f28747c != null) {
                    qh0 qh0Var = ((sh0) vh0Var.f29478c.get(i12)).f28747c;
                    int i13 = this.f30268j1;
                    int i14 = this.f30269k1;
        ...
        if (imageLocation != null) {
            ...
            while (true) {
                ...
                if (i10 >= arrayList.size()) {
                    ...
                    SparseArray sparseArray = this.f30259a1;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i16) {
            ...
            if (wh0Var2.P0 == dialogPhotos2) {
                ArrayList arrayList7 = new ArrayList(dialogPhotos2.photos);
                if (!arrayList7.isEmpty() || !dialogPhotos2.fromCache) {
                    wh0Var2.f30265g1 = -1;
                    wh0Var2.f30266h1 = -1;
                    int i17 = wh0Var2.I0;
                    TLRPC.User user4 = MessagesController.getInstance(i17).getUser(Long.valueOf(wh0Var2.B0));
                    TLRPC.UserFull userFull = MessagesController.getInstance(i17).getUserFull(wh0Var2.B0);
                    ...
                    if (user4 != null && user4.self && UserObject.hasFallbackPhoto(userFull)) {
                        ...
                        wh0Var2.f30266h1 = arrayList7.size() - 1;
                    }
                    arrayList5.clear();
                    arrayList6.clear();
                    ...
                    if (DialogObject.isChatDialog(wh0Var2.B0)) {
                        TLRPC.Chat chat = MessagesController.getInstance(i17).getChat(Long.valueOf(-wh0Var2.B0));
                        ...
                        if (imageLocation != null) {
                            ...
                            if (chatFull != null && FileLoader.isSamePhoto((TLRPC.FileLocation) imageLocation.location, chatFull.chat_photo)) {
                                ...
                                if (!wh0Var2.C0.chat_photo.video_sizes.isEmpty()) {
                                    TLRPC.VideoSize closestVideoSizeWithSize = FileLoader.getClosestVideoSizeWithSize(wh0Var2.C0.chat_photo.video_sizes, 1000);
                            ...
                            if (closestPhotoSizeWithSize2 != null) {
                                ...
                                if (forPhoto != null) {
                                    ...
                                    if (imageLocation3 != null) {
                                        if (imageLocation3.photoId == forPhoto.photoId && !z4 && wh0Var2.B0 != UserConfig.getInstance(i13).getClientUserId()) {
                                            arrayList5.add(null);
                    ...
                    if (wh0Var.f30266h1 < 0 && wh0Var.f30265g1 < 0) {
                        z10 = false;
                        wh0Var.B(0.0f, 0);
                    } else {
                        z10 = false;
                    ...
                    ImageLocation imageLocation5 = wh0Var.f30271n1;
                    if (imageLocation5 != null) {
                        wh0Var.A(imageLocation5, wh0Var.f30272o1);
                        return;
                    }
                    return;
                }
        ...
        SparseArray sparseArray = wh0Var2.f30259a1;
        if (i10 == i28) {
        ...
        } else if (i10 == NotificationCenter.reloadDialogPhotos && wh0Var2.Z0 == 0 && (dialogPhotos = wh0Var2.P0) != null) {
            dialogPhotos.reset();
            MessagesController.DialogPhotos dialogPhotos3 = wh0Var2.P0;
    ...
    public p9 getCurrentItemView() {
        vh0 vh0Var = this.A0;
        if (vh0Var != null && !vh0Var.f29478c.isEmpty()) {
            return ((sh0) vh0Var.f29478c.get(getCurrentItem())).f28747c;
        }
        return null;
    }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (this.f30278z0.getScrollState() != 0) {
            return false;
        }
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        nh0 nh0Var = this.f30270m1;
        if (nh0Var != null) {
            nh0Var.setTranslationY(getHeight() - this.f30270m1.getMeasuredHeight());
        }
    }
    ...
    public final boolean onTouchEvent(android.view.MotionEvent r22) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.wh0.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public wh0(Context context, long j10, org.telegram.ui.ActionBar.k kVar, rl0 rl0Var, org.telegram.ui.a01 a01Var, rh0 rh0Var, nh0 nh0Var) {
        ...
        this.f30265g1 = -1;
        this.f30266h1 = -1;
        this.f30270m1 = nh0Var;
        setPadding(0, 0, 0, nh0Var == null ? 0 : nh0Var.f27264n);
        if (nh0Var != null) {
            nh0Var.setView(this);
        }
        setVisibility(8);
