...
public final class wh0 extends View {
    ...
    public float K;
    public float L;
    public final org.telegram.ui.ActionBar.f6 f29673a;
    public final PorterDuffColorFilter f29674b;
    public final PorterDuffColorFilter f29675c;
    public h01 d;
    public h01 e;
    public final Paint f29676f;
    public final Paint h;
    public final Path f29677n;
    public final Drawable f29678r;
    public final RectF f29679s;
    public final Paint v;
    public final Paint f29680w;
    public final Path f29681x;
    public final wc f29682y;

    public wh0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.f29674b = new PorterDuffColorFilter(-1, mode);
        this.f29675c = new PorterDuffColorFilter(-16777216, mode);
        this.f29676f = new Paint();
        Paint paint = new Paint();
        this.h = paint;
        Path path = new Path();
        this.f29677n = path;
        this.f29679s = new RectF();
        this.v = new Paint(1);
        this.f29680w = new Paint(1);
        this.f29681x = new Path();
        this.f29682y = new wc(this);
        this.E = -1;
        this.f29673a = f6Var;
        this.f29678r = context.getResources().getDrawable(R.drawable.files_music).mutate();
    ...
    public final void a() {
        ...
        this.E = i10;
        if (z10) {
            porterDuffColorFilter = this.f29675c;
        } else {
            porterDuffColorFilter = this.f29674b;
        }
        this.f29678r.setColorFilter(porterDuffColorFilter);
        this.f29676f.setColor(this.E);
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        RectF rectF = this.f29679s;
        wc wcVar = this.f29682y;
        if (action == 0) {
    ...
    public final void onDraw(Canvas canvas) {
        if (this.d != null && this.e != null) {
            ...
            float a2 = this.f29682y.a(0.02f);
            if (clamp01 > 0.0f) {
                int width = getWidth() - (AndroidUtilities.dp(12.0f) * 2);
                this.d.f24452p = (width - AndroidUtilities.dp(35.0f)) / 2.0f;
                this.e.f24452p = (width - this.d.l()) - AndroidUtilities.dp(35.0f);
                ...
                canvas.drawPath(this.f29677n, paint3);
                canvas.restore();
                canvas.restore();
            }
        }
    ...
    public void setColor(MessagesController.PeerColor peerColor) {
        int bgColor1;
        int bgColor2;
        org.telegram.ui.ActionBar.f6 f6Var = this.f29673a;
        if (peerColor == null) {
            bgColor1 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19140s8, f6Var);
            bgColor2 = bgColor1;
        } else {
        ...
        if (peerColor == null) {
            this.G = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18863d6, f6Var);
            this.H = true;
        } else {
