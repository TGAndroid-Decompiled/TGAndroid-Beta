...
public final class wh0 extends View {
    ...
    public float K;
    public float L;
    public final org.telegram.ui.ActionBar.d6 f29638a;
    public final PorterDuffColorFilter f29639b;
    public final PorterDuffColorFilter f29640c;
    public f01 d;
    public f01 e;
    public final Paint f29641f;
    public final Paint h;
    public final Path f29642n;
    public final Drawable f29643r;
    public final RectF f29644s;
    public final Paint v;
    public final Paint f29645w;
    public final Path f29646x;
    public final yc f29647y;

    public wh0(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.f29639b = new PorterDuffColorFilter(-1, mode);
        this.f29640c = new PorterDuffColorFilter(-16777216, mode);
        this.f29641f = new Paint();
        Paint paint = new Paint();
        this.h = paint;
        Path path = new Path();
        this.f29642n = path;
        this.f29644s = new RectF();
        this.v = new Paint(1);
        this.f29645w = new Paint(1);
        this.f29646x = new Path();
        this.f29647y = new yc(this);
        this.E = -1;
        this.f29638a = d6Var;
        this.f29643r = context.getResources().getDrawable(R.drawable.files_music).mutate();
    ...
    public final void a() {
        ...
        this.E = i10;
        if (z10) {
            porterDuffColorFilter = this.f29640c;
        } else {
            porterDuffColorFilter = this.f29639b;
        }
        this.f29643r.setColorFilter(porterDuffColorFilter);
        this.f29641f.setColor(this.E);
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        RectF rectF = this.f29644s;
        yc ycVar = this.f29647y;
        if (action == 0) {
    ...
    public final void onDraw(Canvas canvas) {
        if (this.d != null && this.e != null) {
            ...
            float a2 = this.f29647y.a(0.02f);
            if (clamp01 > 0.0f) {
                int width = getWidth() - (AndroidUtilities.dp(12.0f) * 2);
                this.d.f23795p = (width - AndroidUtilities.dp(35.0f)) / 2.0f;
                this.e.f23795p = (width - this.d.l()) - AndroidUtilities.dp(35.0f);
                ...
                int i12 = i10 - i11;
                int i13 = i10 + i11;
                Drawable drawable = this.f29643r;
                ...
                canvas.drawPath(this.f29642n, paint3);
                canvas.restore();
                canvas.restore();
            }
        }
    ...
    public void setColor(MessagesController.PeerColor peerColor) {
        int bgColor1;
        int bgColor2;
        org.telegram.ui.ActionBar.d6 d6Var = this.f29638a;
        if (peerColor == null) {
            bgColor1 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19065s8, d6Var);
            bgColor2 = bgColor1;
        } else {
        ...
        if (peerColor == null) {
            this.G = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18789d6, d6Var);
            this.H = true;
        } else {
