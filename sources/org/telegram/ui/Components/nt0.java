...
public final class nt0 extends ll0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        ou0[] ou0VarArr = this.d.f30655t1;
        if (ou0VarArr[5].f26852a.size() == 0 && !ou0VarArr[5].f26856g) {
            return false;
        }
        return true;
    }
    ...
    public final int h() {
        ...
        return ou0VarArr[5].f26852a.size();
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (c1Var.f42705f == 12) {
            zu0 zu0Var = this.d;
            MessageObject messageObject = (MessageObject) zu0Var.f30655t1[5].f26852a.get(i10);
            ...
            if (document != null) {
                ...
                if (view instanceof org.telegram.ui.Cells.e2) {
                    ...
                    if (zu0Var.C1) {
                        ...
                        e2Var.c(z10, !zu0Var.f30614b1);
                        return;
                    }
                    e2Var.c(false, !zu0Var.f30614b1);
                }
            }
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 11) {
            mt0 M = zu0.M(5, zu0Var.f30634j1, context, f6Var);
