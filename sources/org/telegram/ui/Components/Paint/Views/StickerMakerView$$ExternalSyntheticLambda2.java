...
public final class StickerMakerView$$ExternalSyntheticLambda2 implements Runnable {
    public final int $r8$classId;
    public final StickerMakerView f$0;

    public StickerMakerView$$ExternalSyntheticLambda2(StickerMakerView stickerMakerView, int i) {
        this.$r8$classId = i;
