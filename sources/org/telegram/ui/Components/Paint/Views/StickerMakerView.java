...
public class StickerMakerView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void lambda$segment$10(Exception exc) {
    }
    ...
    public void lambda$segmentImage$4(int i, List list, int i2, int i3, final ArrayList arrayList) {
        ...
        for (int i4 = 0; i4 < list.size(); i4++) {
            ...
            Bitmap createSmoothEdgesSegmentedImage = createSmoothEdgesSegmentedImage(subjectMock.startX, subjectMock.startY, subjectMock.bitmap, false);
    ...
    private void segment(final Bitmap bitmap, final int i, final Utilities.Callback<List<SubjectMock>> callback) {
        ...
        client.process(fromBitmap).addOnSuccessListener(new OnSuccessListener() {
            ...
            public final void onSuccess(Object obj) {
                StickerMakerView.lambda$segment$6(Utilities.Callback.this, (SubjectSegmentationResult) obj);
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public final void onFailure(Exception exc) {
                StickerMakerView.this.lambda$segment$8(bitmap, i, exc);
            }
        });
        if (this.detectedEmoji == null) {
            ImageLabeling.getClient(ImageLabelerOptions.DEFAULT_OPTIONS).process(fromBitmap).addOnSuccessListener(new OnSuccessListener() {
                @Override
                public final void onSuccess(Object obj) {
                    StickerMakerView.this.lambda$segment$9((List) obj);
                }
            }).addOnFailureListener(new OnFailureListener() {
                @Override
                public final void onFailure(Exception exc) {
                    StickerMakerView.lambda$segment$10(exc);
                }
            });
        }
    ...
    public static void lambda$segment$6(Utilities.Callback callback, SubjectSegmentationResult subjectSegmentationResult) {
        ArrayList arrayList = new ArrayList();
    ...
    public void lambda$segment$8(final Bitmap bitmap, final int i, Exception exc) {
        this.segmentingLoading = false;
        FileLog.e(exc);
        if (isWaitingMlKitError(exc) && isAttachedToWindow()) {
            AndroidUtilities.runOnUIThread(new Runnable() {
                @Override
                public final void run() {
                    StickerMakerView.this.lambda$segment$7(bitmap, i);
                }
            }, 2000L);
        } else {
            this.segmentingLoaded = true;
    ...
    public void lambda$segment$7(Bitmap bitmap, int i) {
        segmentImage(bitmap, i, this.containerWidth, this.containerHeight);
    }

    public void lambda$segment$9(List list) {
        if (list.size() <= 0) {
    ...
    private void createSegmentImagePath(SegmentedObject segmentedObject, int i, int i2) {
        ...
        float max = Math.max(width, height) / 384.0f;
        if ((segmentedObject.orientation / 90) % 2 != 0) {
        ...
        while (true) {
            ...
            boolean z5 = width4 == 0;
            if (z4) {
                Point point4 = z ? new Point(width4, width3, min) : point3;
                if (point2 != null) {
        ...
        while (i7 < width2) {
            ...
            if (z6) {
                ...
                if (point5 == null && z8 && iArr[width6] != 0) {
                    point5 = new Point(height3, height4, min);
                }
            }
        ...
        for (int i8 = 0; i8 < removeUnnecessaryPoints2.size(); i8 += 2) {
            Point point8 = removeUnnecessaryPoints2.get(i8);
            if (path.isEmpty()) {
                path.moveTo(((android.graphics.Point) point8).x, ((android.graphics.Point) point8).y);
            } else {
                path.lineTo(((android.graphics.Point) point8).x, ((android.graphics.Point) point8).y);
            }
        }
        Path path2 = new Path();
        for (int i9 = 0; i9 < removeUnnecessaryPoints.size(); i9 += 2) {
            Point point9 = removeUnnecessaryPoints.get(i9);
            if (path2.isEmpty()) {
                path2.moveTo(((android.graphics.Point) point9).x, ((android.graphics.Point) point9).y);
            } else {
                path2.lineTo(((android.graphics.Point) point9).x, ((android.graphics.Point) point9).y);
            }
        }
    ...
    public void uploadStickerFile(final String str, final VideoEditedInfo videoEditedInfo, final String str2, final CharSequence charSequence, final boolean z, final TLRPC$StickerSet tLRPC$StickerSet, final TLRPC$Document tLRPC$Document, final String str3, final Utilities.Callback<Boolean> callback) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                StickerMakerView.this.lambda$uploadStickerFile$11(callback, str2, str, charSequence, z, tLRPC$StickerSet, tLRPC$Document, videoEditedInfo, str3);
            }
        }, 300L);
    }

    public void lambda$uploadStickerFile$11(Utilities.Callback callback, String str, String str2, CharSequence charSequence, boolean z, TLRPC$StickerSet tLRPC$StickerSet, TLRPC$Document tLRPC$Document, VideoEditedInfo videoEditedInfo, String str3) {
        StickerUploader stickerUploader;
    ...
    private void showLoadingDialog() {
        ...
        this.loadingToast.setOnCancelListener(new Runnable() {
            @Override
            public final void run() {
                StickerMakerView.this.lambda$showLoadingDialog$12();
            }
        });
    ...
    public void lambda$showLoadingDialog$12() {
        StickerUploader stickerUploader = this.stickerUploader;
        if (stickerUploader != null) {
    ...
    private void uploadMedia() {
        ...
        ConnectionsManager.getInstance(UserConfig.selectedAccount).sendRequest(tLRPC$TL_messages_uploadMedia, new RequestDelegate() {
            ...
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                StickerMakerView.this.lambda$uploadMedia$14(tLObject, tLRPC$TL_error);
            }
        }, 2);
    }

    public void lambda$uploadMedia$14(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                StickerMakerView.this.lambda$uploadMedia$13(tLObject, tLRPC$TL_error);
            }
        });
    }

    public void lambda$uploadMedia$13(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    private void afterUploadingMedia() {
        ...
        if (stickerUploader.replacedSticker != null) {
            ...
            ConnectionsManager.getInstance(i).sendRequest(tLRPC$TL_stickers_replaceSticker, new RequestDelegate() {
                @Override
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                    StickerMakerView.this.lambda$afterUploadingMedia$17(i, stickerUploader, tLObject, tLRPC$TL_error);
                }
            });
            ...
            ConnectionsManager.getInstance(i).sendRequest(tLRPC$TL_stickers_createStickerSet, new RequestDelegate() {
                @Override
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                    StickerMakerView.this.lambda$afterUploadingMedia$20(i, stickerUploader, tLObject, tLRPC$TL_error);
                }
            });
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                @Override
                public final void run() {
                    StickerMakerView.lambda$afterUploadingMedia$21(StickerMakerView.StickerUploader.this);
                }
            }, 350L);
            ...
            ConnectionsManager.getInstance(i).sendRequest(tLRPC$TL_stickers_addStickerToSet, new RequestDelegate() {
                @Override
                public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                    StickerMakerView.this.lambda$afterUploadingMedia$24(i, stickerUploader, tLObject, tLRPC$TL_error);
                }
            });
        }
    }

    public void lambda$afterUploadingMedia$17(final int i, final StickerUploader stickerUploader, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                StickerMakerView.this.lambda$afterUploadingMedia$16(tLObject, i, stickerUploader, tLRPC$TL_error);
            }
        });
    }

    public void lambda$afterUploadingMedia$16(final TLObject tLObject, int i, final StickerUploader stickerUploader, TLRPC$TL_error tLRPC$TL_error) {
        boolean z;
        if (tLObject instanceof TLRPC$TL_messages_stickerSet) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                @Override
                public final void run() {
                    StickerMakerView.this.lambda$afterUploadingMedia$15(tLObject, stickerUploader);
                }
            }, 450L);
            z = true;
        } else {
    ...
    public void lambda$afterUploadingMedia$15(TLObject tLObject, StickerUploader stickerUploader) {
    ...
    public void lambda$afterUploadingMedia$20(final int i, final StickerUploader stickerUploader, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                StickerMakerView.this.lambda$afterUploadingMedia$19(tLObject, i, stickerUploader, tLRPC$TL_error);
            }
        });
    }

    public void lambda$afterUploadingMedia$19(final TLObject tLObject, int i, final StickerUploader stickerUploader, TLRPC$TL_error tLRPC$TL_error) {
        boolean z;
        if (tLObject instanceof TLRPC$TL_messages_stickerSet) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                @Override
                public final void run() {
                    StickerMakerView.this.lambda$afterUploadingMedia$18(tLObject, stickerUploader);
                }
            }, 250L);
            z = true;
        } else {
    ...
    public void lambda$afterUploadingMedia$18(TLObject tLObject, StickerUploader stickerUploader) {
    ...
    public static void lambda$afterUploadingMedia$21(StickerUploader stickerUploader) {
    ...
    public void lambda$afterUploadingMedia$24(final int i, final StickerUploader stickerUploader, final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                StickerMakerView.this.lambda$afterUploadingMedia$23(tLObject, i, stickerUploader, tLRPC$TL_error);
            }
        });
    }

    public void lambda$afterUploadingMedia$23(final TLObject tLObject, int i, final StickerUploader stickerUploader, TLRPC$TL_error tLRPC$TL_error) {
        boolean z;
        if (tLObject instanceof TLRPC$TL_messages_stickerSet) {
            TLRPC$TL_messages_stickerSet tLRPC$TL_messages_stickerSet = (TLRPC$TL_messages_stickerSet) tLObject;
            MediaDataController.getInstance(i).putStickerSet(tLRPC$TL_messages_stickerSet);
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                @Override
                public final void run() {
                    StickerMakerView.this.lambda$afterUploadingMedia$22(tLObject, stickerUploader);
                }
            }, 450L);
            z = true;
        } else {
    ...
    public void lambda$afterUploadingMedia$22(TLObject tLObject, StickerUploader stickerUploader) {
        NotificationCenter notificationCenter = NotificationCenter.getInstance(UserConfig.selectedAccount);
        int i = NotificationCenter.customStickerCreated;
        Boolean bool = Boolean.FALSE;
        notificationCenter.postNotificationNameOnUIThread(i, bool, tLObject, stickerUploader.mediaDocument.document, stickerUploader.thumbPath, bool);
    ...
    public static class StickerUploader {
        ...
        private float convertingProgress;
        public String emoji;
        public TLRPC$InputFile file;
        public ArrayList<File> files;
        public ArrayList<File> finalFiles;
        ...
        public float getProgress() {
            if (this.videoEditedInfo == null) {
                return this.uploadProgress * 0.9f;
            }
            return (this.convertingProgress * 0.45f) + (this.uploadProgress * 0.45f);
        }
