...
public class StickerMakerView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void $r8$lambda$PsSSzhFuRFQ0x9gxKeb7mkeR1CM(Exception exc) {
    }
    ...
    public class SegmentedObject {
        ...
        public void drawAnimationBorders(Canvas canvas, float f, float f2, View view) {
            ...
            if (this.points != null) {
                ...
                int i = (int) (f * f8);
                int iMin = Math.min(500, (int) (f8 * 0.6f)) + i;
                if (this.pointsCount > 0) {
                    while (i <= iMin) {
                        float f9 = 1.0f - ((iMin - i) / this.pointsCount);
                        if (f9 > 0.0f) {
            ...
            if (this.points == null) {
                ...
                int i2 = (int) (f * f11);
                int iMin2 = Math.min(500, (int) (f11 * 0.6f)) + i2;
                if (this.pointsCount > 0) {
                    for (int i3 = i2; i3 <= iMin2; i3++) {
                        float f12 = (i3 - i2) / (iMin2 - i2);
    ...
    public void enableClippingMode(final Utilities.Callback callback) {
        setOnClickListener(new View.OnClickListener() {
            ...
            public final void onClick(View view) {
                StickerMakerView.$r8$lambda$vszHogd9VRsRtaFjIZ4GlghrdjQ(this.f$0, callback, view);
            }
        });
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                StickerMakerView.$r8$lambda$jhvcJlFdSyo77ozWHv8oxyGg1hU(this.f$0, valueAnimator2);
            }
        });
    ...
    public static void $r8$lambda$vszHogd9VRsRtaFjIZ4GlghrdjQ(StickerMakerView stickerMakerView, Utilities.Callback callback, View view) {
    ...
    public static void $r8$lambda$jhvcJlFdSyo77ozWHv8oxyGg1hU(StickerMakerView stickerMakerView, ValueAnimator valueAnimator) {
    ...
    public static void m2529$r8$lambda$s1HbOjn6hS84B_arOtyiC21DUg(final StickerMakerView stickerMakerView, int i, List list, final ArrayList arrayList, final Utilities.Callback callback) {
        ...
        if (list.isEmpty()) {
            ...
            Bitmap bitmapCreateSmoothEdgesSegmentedImage = stickerMakerView.createSmoothEdgesSegmentedImage(0, 0, stickerMakerView.sourceBitmap, false);
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                @Override
                public final void run() {
                    StickerMakerView.$r8$lambda$DIbwM80FK1mVJueMqy7ZmBJraiY(this.f$0, arrayList, callback, segmentedObject);
                }
            });
        ...
        for (int i2 = 0; i2 < list.size(); i2++) {
            ...
            Bitmap bitmapCreateSmoothEdgesSegmentedImage2 = stickerMakerView.createSmoothEdgesSegmentedImage(subjectMock.startX, subjectMock.startY, subjectMock.bitmap, false);
    ...
    public static void $r8$lambda$DIbwM80FK1mVJueMqy7ZmBJraiY(StickerMakerView stickerMakerView, ArrayList arrayList, Utilities.Callback callback, SegmentedObject segmentedObject) {
    ...
    private void segment(final Bitmap bitmap, final int i, final Utilities.Callback callback, final Utilities.Callback callback2) {
        ...
        client.process(inputImageFromBitmap).addOnSuccessListener(new OnSuccessListener() {
            @Override
    ...
    public static void $r8$lambda$N34q7RjOP0nAX0Rvuf8jtIHGY0g(Utilities.Callback callback, SubjectSegmentationResult subjectSegmentationResult) {
        ArrayList arrayList = new ArrayList();
        ...
        if (isWaitingMlKitError(exc) && stickerMakerView.isAttachedToWindow()) {
            AndroidUtilities.runOnUIThread(new Runnable() {
                ...
                public final void run() {
                    ...
                    stickerMakerView2.segmentImage(bitmap, i, stickerMakerView2.containerWidth, stickerMakerView2.containerHeight, callback);
                }
            }, 2000L);
        } else {
    ...
    private void afterUploadingMedia() {
        ...
        if (stickerUploader.replacedSticker != null) {
            ...
            ConnectionsManager.getInstance(i).sendRequest(tL_stickers_replaceSticker, new RequestDelegate() {
                @Override
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    StickerMakerView.$r8$lambda$iwxZOlkXGyrVaVEaUpf2ylfG3xU(this.f$0, i, stickerUploader, tLObject, tL_error);
                }
            });
            return;
        }
        if (stickerUploader.stickerPackName != null) {
            ...
            ConnectionsManager.getInstance(i).sendRequest(tL_stickers_createStickerSet, new RequestDelegate() {
                @Override
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    StickerMakerView.$r8$lambda$Uy0jSYV4zlXBA8zo1wcqaRau4mo(this.f$0, i, stickerUploader, tLObject, tL_error);
                }
            });
            return;
        }
        ...
        if (stickerUploader.sendToDialogId != 0) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                @Override
                public final void run() {
                    StickerMakerView.$r8$lambda$fWjCevAiJQ7Ohv2jzocVqOtitt8(this.f$0, i);
                }
            }, 450L);
        ...
        if (stickerUploader.stickerSet != null) {
            ...
            ConnectionsManager.getInstance(i).sendRequest(tL_stickers_addStickerToSet, new RequestDelegate() {
                @Override
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    StickerMakerView.$r8$lambda$6bAjTn0omTJm6aVkCbrS6KVYVwA(this.f$0, i, stickerUploader, tLObject, tL_error);
                }
            });
        }
    }

    public static void $r8$lambda$iwxZOlkXGyrVaVEaUpf2ylfG3xU(final StickerMakerView stickerMakerView, final int i, final StickerUploader stickerUploader, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        stickerMakerView.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                StickerMakerView.$r8$lambda$8hgkhcQ2PhtZDpDSiwLF05K6pGE(this.f$0, tLObject, i, stickerUploader, tL_error);
            }
        });
    }

    public static void $r8$lambda$8hgkhcQ2PhtZDpDSiwLF05K6pGE(final StickerMakerView stickerMakerView, TLObject tLObject, int i, final StickerUploader stickerUploader, TLRPC.TL_error tL_error) {
        boolean z;
        ...
        if (tLObject instanceof TLRPC.TL_messages_stickerSet) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                @Override
                public final void run() {
                    StickerMakerView.$r8$lambda$Unmyu6wtdXQJ2jRY6gTPDNDnIBU(this.f$0, tLObject2, stickerUploader);
                }
            }, 450L);
            z = true;
        } else {
    ...
    public static void $r8$lambda$Unmyu6wtdXQJ2jRY6gTPDNDnIBU(StickerMakerView stickerMakerView, TLObject tLObject, StickerUploader stickerUploader) {
        stickerMakerView.getClass();
    ...
    public static void $r8$lambda$Uy0jSYV4zlXBA8zo1wcqaRau4mo(final StickerMakerView stickerMakerView, final int i, final StickerUploader stickerUploader, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        stickerMakerView.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
    ...
    public static void $r8$lambda$fWjCevAiJQ7Ohv2jzocVqOtitt8(StickerMakerView stickerMakerView, int i) {
        stickerMakerView.getClass();
        NotificationCenter.getInstance(i).postNotificationName(NotificationCenter.customStickerCreated, Boolean.FALSE);
        stickerMakerView.hideLoadingDialog();
    }

    public static void $r8$lambda$6bAjTn0omTJm6aVkCbrS6KVYVwA(final StickerMakerView stickerMakerView, final int i, final StickerUploader stickerUploader, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        stickerMakerView.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
                StickerMakerView.$r8$lambda$FVkcPsPHpEowpd7L1yTpVzwPTPk(this.f$0, tLObject, i, stickerUploader, tL_error);
            }
        });
    }

    public static void $r8$lambda$FVkcPsPHpEowpd7L1yTpVzwPTPk(final StickerMakerView stickerMakerView, TLObject tLObject, int i, final StickerUploader stickerUploader, TLRPC.TL_error tL_error) {
        boolean z;
        final TLObject tLObject2;
        stickerMakerView.getClass();
        if (tLObject instanceof TLRPC.TL_messages_stickerSet) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                @Override
                public final void run() {
                    StickerMakerView.$r8$lambda$Ok8WYFvXXQKvVNqn84VtwsAdqlg(this.f$0, tLObject2, stickerUploader);
                }
            }, 450L);
            z = true;
        } else {
    ...
    public static void $r8$lambda$Ok8WYFvXXQKvVNqn84VtwsAdqlg(StickerMakerView stickerMakerView, TLObject tLObject, StickerUploader stickerUploader) {
        stickerMakerView.getClass();
        NotificationCenter notificationCenter = NotificationCenter.getInstance(UserConfig.selectedAccount);
        int i = NotificationCenter.customStickerCreated;
        TLRPC.Document document = stickerUploader.mediaDocument.document;
