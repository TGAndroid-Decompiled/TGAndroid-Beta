...
public final class EntityView$$ExternalSyntheticLambda5 implements ValueAnimator.AnimatorUpdateListener {
    public final int $r8$classId;
    public final EntityView f$0;

    public EntityView$$ExternalSyntheticLambda5(EntityView entityView, int i) {
        this.$r8$classId = i;
        this.f$0 = entityView;
    }
