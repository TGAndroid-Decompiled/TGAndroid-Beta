...
public abstract class MaskPaintView extends FrameLayout {
    ...
    public MaskPaintView(Context context, int i, Bitmap bitmap, Bitmap bitmap2, int i2, MediaController.CropState cropState) {
        super(context);
        this.weightDefaultValueOverride = new RichMapCell.AnonymousClass1(this, 13);
        ...
        renderView.setDelegate(new RenderView.RenderViewDelegate() {
            ...
            public final void onFinishedDrawing() {
                ...
                maskPaintView.onDrawn();
            }

            @Override
            public final void onFirstDraw() {
                MaskPaintView maskPaintView = MaskPaintView.this;
                maskPaintView.renderView.animate().alpha(1.0f).setDuration(320L).setUpdateListener(new BotButton$$ExternalSyntheticLambda0(maskPaintView, 11)).setInterpolator(CubicBezierInterpolator.EASE_OUT_QUINT);
            }
    ...
    public abstract void onRenderViewAlphaUpdate(ValueAnimator valueAnimator);
    ...
    public boolean onTouch(MotionEvent motionEvent) {
        ...
        motionEventObtain.setLocation(fCos, measuredHeight);
    ...
    public void setTransform(float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        if (cropState != null) {
            ...
            float fM = MediaController$$ExternalSyntheticOutline0.m(cropState3.cropPx, f10, f, fMax);
            float f12 = cropState3.cropScale;
            f2 += fM * f12;
            f8 += cropState3.cropPy * f11 * f * fMax * f12;
    ...
    public void shutdown() {
        ...
        this.queue.postRunnable(new GiftSheet$$ExternalSyntheticLambda2(10));
    }
