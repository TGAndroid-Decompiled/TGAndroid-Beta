...
public class sd0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final int[] f27912a0 = {R.id.passcode_btn_0, R.id.passcode_btn_1, R.id.passcode_btn_2, R.id.passcode_btn_3, R.id.passcode_btn_4, R.id.passcode_btn_5, R.id.passcode_btn_6, R.id.passcode_btn_7, R.id.passcode_btn_8, R.id.passcode_btn_9, R.id.passcode_btn_backspace, R.id.passcode_btn_fingerprint};
    ...
    public final int[] W;
    public Drawable f27913a;
    public final FrameLayout f27914b;
    public final TextView f27915c;
    public final FrameLayout d;
    public final ai.w5 e;
    public final ArrayList f27916f;
    public final FrameLayout h;
    public final qd0 f27917n;
    public final EditTextBoldCursor f27918r;
    public final ci.j9 f27919s;
    public final ci.m6 v;
    public final TextView f27920w;
    public final TextView f27921x;
    public final ImageView f27922y;
    ...
    public sd0(Context context) {
        ...
        this.f27918r = editTextBoldCursor;
        ...
        while (true) {
            ...
            this.f27916f.add(qd0Var);
            i11++;
        }
        for (i10 = 11; i10 >= 0; i10--) {
            this.e.addView((FrameLayout) this.f27916f.get(i10), w7.x5.e(60, 60, 51));
        }
        d();
    }
    ...
    public static void a(sd0 sd0Var) {
        ...
        float f7;
        float f10;
        FrameLayout frameLayout = sd0Var.f27914b;
        ci.j9 j9Var = sd0Var.f27919s;
        ...
        if (frameLayout != null) {
            ...
            org.telegram.messenger.ul.r(scaleX.scaleY(f11), rr.h, 320L);
        }
    }
    ...
    public final void b(bc0 bc0Var) {
        ...
        kVar2.f15326u = org.telegram.ui.Cells.q3.l(100.0f, 300.0f, 1.0f);
        this.L = kVar2;
        kVar2.a(new ei.m4(4, this, bc0Var));
        this.L.b(new k7(bc0Var, 4));
        this.L.f();
    }
    ...
    public final void c() {
        ...
        ud0 ud0Var;
        if (Build.VERSION.SDK_INT >= 23 && (findActivity = AndroidUtilities.findActivity(getContext())) != null && this.f27917n.getVisibility() == 0 && !ApplicationLoader.mainInterfacePaused) {
            if (findActivity instanceof LaunchActivity) {
                LaunchActivity launchActivity = (LaunchActivity) findActivity;
                ArrayList arrayList = launchActivity.B0;
                if (arrayList.isEmpty() && (ud0Var = launchActivity.A0) != null) {
                    if (this != ud0Var.f28463b) {
                        return;
                    }
    ...
    public final void e() {
        ...
        EditTextBoldCursor editTextBoldCursor = this.f27918r;
        FrameLayout frameLayout = this.h;
        org.telegram.ui.Cells.l7 l7Var = this.R;
        TextView textView = this.f27921x;
        if (j10 > 0) {
    ...
    public final boolean g() {
        ...
        if (i4Var != null && i4Var.c()) {
            AndroidUtilities.hideKeyboard(this.f27918r);
            return false;
        }
        return true;
    }
    ...
    public final void i() {
        e();
        if (this.f27921x.getVisibility() != 0) {
            if (SharedConfig.passcodeType == 1) {
                EditTextBoldCursor editTextBoldCursor = this.f27918r;
    ...
    public final void j(boolean z10, int i10, int i11, org.telegram.ui.ia0 ia0Var) {
        ...
        if (z12) {
            ...
            this.f27913a = org.telegram.ui.ActionBar.h6.r0();
            ...
            if (org.telegram.ui.ActionBar.h6.W && !"CJz3BZ6YGEYBAAAABboWp6SAv04".equals(org.telegram.ui.ActionBar.h6.H0()) && !"qeZWES8rGVIEAAAARfWlK1lnfiI".equals(org.telegram.ui.ActionBar.h6.H0())) {
                org.telegram.ui.ActionBar.a6 a6Var = org.telegram.ui.ActionBar.h6.I.f18694i0;
                ...
                if (!"d".equals(org.telegram.ui.ActionBar.h6.H0())) {
                    ...
                    if (!org.telegram.ui.ActionBar.h6.f18891j0 && !"CJz3BZ6YGEYBAAAABboWp6SAv04".equals(H0) && !"qeZWES8rGVIEAAAARfWlK1lnfiI".equals(H0)) {
        ...
        Drawable drawable = this.f27913a;
        if (drawable instanceof bc0) {
            bc0 bc0Var = (bc0) drawable;
            int[] iArr = bc0Var.f22675a;
            if (z11) {
            ...
            this.f27913a = new bc0(false, iArr[0], iArr[1], iArr[2], iArr[3]);
            if (bc0Var.f22696u != null && bc0Var.f22692q < 0) {
                m6Var.setBackgroundColor(2130706432);
            } else {
                m6Var.setBackgroundColor(570425344);
            }
            ((bc0) this.f27913a).r(m6Var);
        }
        this.f27920w.setText(LocaleController.getString(R.string.AppLocked));
        int i16 = SharedConfig.passcodeType;
        ImageView imageView = this.E;
        ImageView imageView2 = this.f27922y;
        ai.w5 w5Var = this.e;
        ci.j9 j9Var = this.f27919s;
        if (i16 == 0) {
            if (textView.getVisibility() != 0) {
            ...
            imageView.setVisibility(this.f27917n.getVisibility());
        }
        setVisibility(0);
    ...
    public final void k(boolean z10) {
        ...
        if (!z10) {
            if (SharedConfig.passcodeRetryInMs <= 0) {
                ...
                FrameLayout frameLayout = this.f27914b;
                if (length == 0) {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        TextView textView = this.f27920w;
        int[] iArr = this.W;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (z10) {
            ...
            int y3 = org.telegram.messenger.ul.y(140.0f, i17, 2);
            if (SharedConfig.passcodeType == 0) {
            ...
            if (AndroidUtilities.isTablet()) {
                ...
                if (i17 > AndroidUtilities.dp(528.0f)) {
                    i19 = org.telegram.messenger.ul.y(528.0f, i17, 2);
        ...
        for (int i23 = 0; i23 < 12; i23++) {
            ...
            FrameLayout frameLayout3 = (FrameLayout) this.f27916f.get(i23);
