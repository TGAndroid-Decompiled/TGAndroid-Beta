...
public class sd0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final int[] f27838a0 = {R.id.passcode_btn_0, R.id.passcode_btn_1, R.id.passcode_btn_2, R.id.passcode_btn_3, R.id.passcode_btn_4, R.id.passcode_btn_5, R.id.passcode_btn_6, R.id.passcode_btn_7, R.id.passcode_btn_8, R.id.passcode_btn_9, R.id.passcode_btn_backspace, R.id.passcode_btn_fingerprint};
    ...
    public final int[] W;
    public Drawable f27839a;
    public final FrameLayout f27840b;
    public final TextView f27841c;
    public final FrameLayout d;
    public final ai.x5 e;
    public final ArrayList f27842f;
    public final FrameLayout h;
    public final qd0 f27843n;
    public final EditTextBoldCursor f27844r;
    public final ci.m9 f27845s;
    public final ci.n6 v;
    public final TextView f27846w;
    public final TextView f27847x;
    public final ImageView f27848y;
    ...
    public sd0(Context context) {
        ...
        this.f27844r = editTextBoldCursor;
        ...
        while (true) {
            ...
            this.f27842f.add(qd0Var);
            i11++;
        }
        for (i10 = 11; i10 >= 0; i10--) {
            this.e.addView((FrameLayout) this.f27842f.get(i10), w7.x5.e(60, 60, 51));
        }
        d();
    }
    ...
    public static void a(sd0 sd0Var) {
        ...
        float f7;
        float f10;
        FrameLayout frameLayout = sd0Var.f27840b;
        ci.m9 m9Var = sd0Var.f27845s;
        ...
        if (frameLayout != null) {
            ...
            org.telegram.messenger.wl.q(scaleX.scaleY(f11), qr.h, 320L);
        }
    }
    ...
    public final void c() {
        ...
        ud0 ud0Var;
        if (Build.VERSION.SDK_INT >= 23 && (findActivity = AndroidUtilities.findActivity(getContext())) != null && this.f27843n.getVisibility() == 0 && !ApplicationLoader.mainInterfacePaused) {
            if (findActivity instanceof LaunchActivity) {
                LaunchActivity launchActivity = (LaunchActivity) findActivity;
                ArrayList arrayList = launchActivity.B0;
                if (arrayList.isEmpty() && (ud0Var = launchActivity.A0) != null) {
                    if (this != ud0Var.f28370b) {
                        return;
                    }
    ...
    public final void e() {
        ...
        EditTextBoldCursor editTextBoldCursor = this.f27844r;
        FrameLayout frameLayout = this.h;
        org.telegram.ui.Cells.l7 l7Var = this.R;
        TextView textView = this.f27847x;
        if (j10 > 0) {
    ...
    public final boolean g() {
        ...
        if (j4Var != null && j4Var.c()) {
            AndroidUtilities.hideKeyboard(this.f27844r);
            return false;
        }
        return true;
    }
    ...
    public final void i() {
        e();
        if (this.f27847x.getVisibility() != 0) {
            if (SharedConfig.passcodeType == 1) {
                EditTextBoldCursor editTextBoldCursor = this.f27844r;
    ...
    public final void j(boolean z10, int i10, int i11, org.telegram.ui.oa0 oa0Var) {
        ...
        if (z12) {
            ...
            this.f27839a = org.telegram.ui.ActionBar.j6.r0();
            ...
            if (org.telegram.ui.ActionBar.j6.W && !"CJz3BZ6YGEYBAAAABboWp6SAv04".equals(org.telegram.ui.ActionBar.j6.H0()) && !"qeZWES8rGVIEAAAARfWlK1lnfiI".equals(org.telegram.ui.ActionBar.j6.H0())) {
                org.telegram.ui.ActionBar.c6 c6Var = org.telegram.ui.ActionBar.j6.I.f18769i0;
                ...
                if (!"d".equals(org.telegram.ui.ActionBar.j6.H0())) {
                    ...
                    if (!org.telegram.ui.ActionBar.j6.f18966j0 && !"CJz3BZ6YGEYBAAAABboWp6SAv04".equals(H0) && !"qeZWES8rGVIEAAAARfWlK1lnfiI".equals(H0)) {
        ...
        Drawable drawable = this.f27839a;
        if (drawable instanceof cc0) {
            cc0 cc0Var = (cc0) drawable;
            int[] iArr = cc0Var.f22998a;
            if (z11) {
            ...
            this.f27839a = new cc0(false, iArr[0], iArr[1], iArr[2], iArr[3]);
            if (cc0Var.f23019u != null && cc0Var.f23015q < 0) {
                n6Var.setBackgroundColor(2130706432);
            } else {
                n6Var.setBackgroundColor(570425344);
            }
            ((cc0) this.f27839a).r(n6Var);
        }
        this.f27846w.setText(LocaleController.getString(R.string.AppLocked));
        int i16 = SharedConfig.passcodeType;
        ImageView imageView = this.E;
        ImageView imageView2 = this.f27848y;
        ai.x5 x5Var = this.e;
        ci.m9 m9Var = this.f27845s;
        if (i16 == 0) {
            if (textView.getVisibility() != 0) {
            ...
            imageView.setVisibility(this.f27843n.getVisibility());
        }
        setVisibility(0);
    ...
    public final void k(boolean z10) {
        ...
        if (!z10) {
            if (SharedConfig.passcodeRetryInMs <= 0) {
                ...
                FrameLayout frameLayout = this.f27840b;
                if (length == 0) {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        TextView textView = this.f27846w;
        int[] iArr = this.W;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i23 = 0; i23 < 12; i23++) {
            ...
            FrameLayout frameLayout3 = (FrameLayout) this.f27842f.get(i23);
