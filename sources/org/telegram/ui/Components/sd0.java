...
public class sd0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final int[] f30282a0 = {R.id.passcode_btn_0, R.id.passcode_btn_1, R.id.passcode_btn_2, R.id.passcode_btn_3, R.id.passcode_btn_4, R.id.passcode_btn_5, R.id.passcode_btn_6, R.id.passcode_btn_7, R.id.passcode_btn_8, R.id.passcode_btn_9, R.id.passcode_btn_backspace, R.id.passcode_btn_fingerprint};
    ...
    public final int[] W;
    public Drawable f30283a;
    public final FrameLayout f30284b;
    public final TextView f30285c;
    public final FrameLayout d;
    public final bi.g5 f30286e;
    public final ArrayList f30287f;
    public final FrameLayout h;
    public final qd0 f30288n;
    public final EditTextBoldCursor f30289r;
    public final di.l9 f30290s;
    public final ah.w v;
    public final TextView f30291w;
    public final TextView f30292x;
    public final ImageView f30293y;
    ...
    public sd0(Context context) {
        ...
        this.f30289r = editTextBoldCursor;
        ...
        while (true) {
            ...
            this.f30287f.add(qd0Var);
            i11++;
        }
        for (i10 = 11; i10 >= 0; i10--) {
            this.f30286e.addView((FrameLayout) this.f30287f.get(i10), w7.x5.e(60, 60, 51));
        }
        d();
    }
    ...
    public static void a(sd0 sd0Var) {
        ...
        float f7;
        float f10;
        FrameLayout frameLayout = sd0Var.f30284b;
        di.l9 l9Var = sd0Var.f30290s;
    ...
    public final void c() {
        ...
        ud0 ud0Var;
        if (Build.VERSION.SDK_INT >= 23 && (findActivity = AndroidUtilities.findActivity(getContext())) != null && this.f30288n.getVisibility() == 0 && !ApplicationLoader.mainInterfacePaused) {
            if (findActivity instanceof LaunchActivity) {
                LaunchActivity launchActivity = (LaunchActivity) findActivity;
                ArrayList arrayList = launchActivity.B0;
                if (arrayList.isEmpty() && (ud0Var = launchActivity.A0) != null) {
                    if (this != ud0Var.f30894b) {
                        return;
                    }
    ...
    public final void e() {
        ...
        EditTextBoldCursor editTextBoldCursor = this.f30289r;
        FrameLayout frameLayout = this.h;
        org.telegram.ui.Cells.l7 l7Var = this.R;
        TextView textView = this.f30292x;
        if (j10 > 0) {
    ...
    public final boolean g() {
        ...
        if (j4Var != null && j4Var.c()) {
            AndroidUtilities.hideKeyboard(this.f30289r);
            return false;
        }
        return true;
    }
    ...
    public final void i() {
        e();
        if (this.f30292x.getVisibility() != 0) {
            if (SharedConfig.passcodeType == 1) {
                EditTextBoldCursor editTextBoldCursor = this.f30289r;
    ...
    public final void j(boolean z10, int i10, int i11, org.telegram.ui.r80 r80Var) {
        ...
        if (z12) {
            ...
            this.f30283a = org.telegram.ui.ActionBar.j6.r0();
            ...
            if (org.telegram.ui.ActionBar.j6.W && !"CJz3BZ6YGEYBAAAABboWp6SAv04".equals(org.telegram.ui.ActionBar.j6.H0()) && !"qeZWES8rGVIEAAAARfWlK1lnfiI".equals(org.telegram.ui.ActionBar.j6.H0())) {
                org.telegram.ui.ActionBar.b6 b6Var = org.telegram.ui.ActionBar.j6.I.f20581i0;
                if (b6Var != null && (i12 = b6Var.d) != 0 && (i13 = b6Var.f20305e) != 0) {
                ...
                if (!"d".equals(org.telegram.ui.ActionBar.j6.H0())) {
                    ...
                    if (!org.telegram.ui.ActionBar.j6.f20794j0 && !"CJz3BZ6YGEYBAAAABboWp6SAv04".equals(H0) && !"qeZWES8rGVIEAAAARfWlK1lnfiI".equals(H0)) {
        ...
        Drawable drawable = this.f30283a;
        if (drawable instanceof dc0) {
            dc0 dc0Var = (dc0) drawable;
            int[] iArr = dc0Var.f25369a;
            if (z11) {
            ...
            this.f30283a = new dc0(false, iArr[0], iArr[1], iArr[2], iArr[3]);
            if (dc0Var.f25391u != null && dc0Var.f25387q < 0) {
                wVar.setBackgroundColor(2130706432);
            } else {
                wVar.setBackgroundColor(570425344);
            }
            ((dc0) this.f30283a).r(wVar);
        }
        this.f30291w.setText(LocaleController.getString(R.string.AppLocked));
        int i16 = SharedConfig.passcodeType;
        ImageView imageView = this.E;
        ImageView imageView2 = this.f30293y;
        bi.g5 g5Var = this.f30286e;
        di.l9 l9Var = this.f30290s;
        if (i16 == 0) {
            if (textView.getVisibility() != 0) {
            ...
            imageView.setVisibility(this.f30288n.getVisibility());
        }
        setVisibility(0);
    ...
    public final void m(boolean z10) {
        ...
        this.U = z10;
        float alpha = this.f30286e.getAlpha();
        if (z10) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        TextView textView = this.f30291w;
        int[] iArr = this.W;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i23 = 0; i23 < 12; i23++) {
            ...
            FrameLayout frameLayout3 = (FrameLayout) this.f30287f.get(i23);
