...
public final class tl0 {
    ...
    public int f28166y;
    public int f28167z;
    public final RectF f28146a = new RectF();
    public final Paint f28147b = new Paint(1);
    public final Paint f28148c = new Paint(3);
    public final Matrix d = new Matrix();
    public final float[] e = new float[8];
    public final Path f28149f = new Path();
    public final Paint f28150g = new Paint();
    public int f28159q = 0;
    public float f28160r = 1.0f;
    ...
    public final int a(MessageObject messageObject, TLRPC.User user, TLRPC.Chat chat, org.telegram.ui.ActionBar.f6 f6Var, int i10) {
        ...
        if (messageObject == null) {
            ...
            this.f28165x = org.telegram.ui.ActionBar.j6.l1(f7, v02);
            this.C = h();
        ...
        if (i10 == 4 && (message4 = messageObject.messageOwner) != null && MessageObject.getMedia(message4) != null && (MessageObject.getMedia(messageObject.messageOwner) instanceof TLRPC.TL_messageMediaContact)) {
            ...
            this.f28165x = org.telegram.ui.ActionBar.j6.l1(0.1f, this.f28167z);
            this.f28166y = this.f28167z;
        } else {
            f5Var = f5Var2;
            if (i10 != 0 && (messageObject.overrideLinkColor >= 0 || (messageObject.messageOwner != null && (((messageObject.isFromUser() || DialogObject.isEncryptedDialog(messageObject.getDialogId())) && user4 != null) || ((messageObject.isFromChannel() && chat != null) || (((message3 = messageObject.messageOwner) != null && (messageFwdHeader3 = message3.fwd_from) != null && messageFwdHeader3.from_id != null) || (messageObject.isSponsored() && (peerColor2 = messageObject.sponsoredColor) != null && peerColor2.color != -1))))))) {
                ...
                this.A = v04;
                this.f28167z = v04;
                this.f28165x = org.telegram.ui.ActionBar.j6.l1(0.1f, v04);
                this.f28166y = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Wc, f6Var);
            }
        }
        if (messageObject.shouldDrawWithoutBackground()) {
            ...
            this.f28167z = -1;
            this.f28165x = 0;
            this.f28166y = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Xc, f6Var);
            ...
            if (i10 == 2 && !messageObject.isOutOwner()) {
                ...
                if (!this.f28151i && !this.f28152j) {
                    i12 = org.telegram.ui.ActionBar.j6.f18810ab;
                } else {
                    i12 = org.telegram.ui.ActionBar.j6.f18830bb;
                }
            ...
            if (this.f28152j) {
                this.R = true;
                this.f28167z = org.telegram.ui.ActionBar.j6.l1(0.2f, this.f28167z);
                this.A = org.telegram.ui.ActionBar.j6.l1(0.5f, this.A);
            } else if (this.f28151i) {
                this.R = true;
                this.f28167z = org.telegram.ui.ActionBar.j6.l1(0.35f, this.f28167z);
            }
            int i16 = this.B;
            if (q6) {
                f10 = 0.12f;
            }
            this.f28165x = org.telegram.ui.ActionBar.j6.l1(f10, i16);
            this.f28166y = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.cb, f6Var);
        }
        ...
        if (this.v != 0 && this.f28162t == null && (view = this.D) != null) {
            this.f28162t = new m5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.t1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.t1) view).M0) {
                this.f28162t.a();
            }
        }
        m5 m5Var = this.f28162t;
        if (m5Var != null) {
            z11 = true;
        ...
        m5 m5Var2 = this.f28163u;
        if (m5Var2 != null) {
            m5Var2.j(this.f28164w, z11);
        }
        this.C = h();
        return f5Var.a(this.f28166y, false);
    }
    ...
    public final void d(Canvas canvas, RectF rectF, float f7, boolean z10, boolean z11) {
        ...
        float f10;
        if (!z11) {
            int l1 = org.telegram.ui.ActionBar.j6.l1(f7, this.E.a(this.f28165x, false));
            Paint paint = this.f28150g;
            paint.setColor(l1);
            float[] fArr = this.e;
            if (yf.e0.c(fArr)) {
                float f11 = fArr[0];
                ...
                Path path = this.f28149f;
                path.rewind();
                path.addRoundRect(rectF, fArr, Path.Direction.CW);
                canvas.drawPath(path, paint);
            }
        }
        m5 m5Var2 = this.f28162t;
        if (m5Var2 != null) {
            if (!this.Y) {
                Drawable drawable = m5Var2.f26054f[0];
                if ((drawable instanceof o5) && (l4Var = ((o5) drawable).f26636k) != null && l4Var.hasImageLoaded()) {
                    this.Y = true;
                } else {
                    z12 = false;
                    e = this.L.e(z12);
                    if (e <= 0.0f && this.f28160r > 0.0f) {
                        if (this.W == null) {
                        ...
                        m5 m5Var3 = this.f28163u;
                        if (m5Var3 != null) {
                            m5Var3.v = (int) (f7 * 255.0f);
                        }
                        this.f28162t.k(Integer.valueOf(this.C));
                        int i10 = 0;
                        while (true) {
                            sl0[] sl0VarArr = this.W;
                            if (i10 < sl0VarArr.length) {
                                if (i10 != 0 || (m5Var = this.f28163u) == null || this.f28164w == 0) {
                                    m5Var = this.f28162t;
                                }
                                sl0 sl0Var = sl0VarArr[i10];
                                if (!sl0Var.e || z10) {
                                    if (m5Var == this.f28163u) {
                                        f10 = 1.0f;
                                    } else {
                                        f10 = 0.3f;
                                    }
                                    m5Var.v = (int) (f10 * 255.0f * sl0Var.d * this.f28160r);
                                    float dp = max - AndroidUtilities.dp(sl0Var.f27881a);
                                    float dp2 = AndroidUtilities.dp(sl0Var.f27882b) + min;
                                    float dp3 = AndroidUtilities.dp(10.0f) * sl0Var.f27883c * e;
    ...
    public final void f(Canvas canvas, RectF rectF, float f7, float f10, float f11, float f12) {
        ...
        if (this.h == null) {
            ...
            this.h = g90Var3;
            g90Var3.C = true;
            g90Var3.f24146t = 3.5f;
            g90Var3.f24147u = 0.5f;
        }
        this.h.f(org.telegram.ui.ActionBar.j6.l1(0.1f, this.f28167z), org.telegram.ui.ActionBar.j6.l1(0.3f, this.f28167z), org.telegram.ui.ActionBar.j6.l1(0.3f, this.f28167z), org.telegram.ui.ActionBar.j6.l1(1.25f, this.f28167z));
        this.h.d(rectF);
        this.h.i(fArr);
        this.h.f24148w.setStrokeWidth(AndroidUtilities.dp(1.0f));
    ...
    public final void k() {
        this.F.a(this.f28167z, true);
        this.G.a(this.A, true);
        this.J.f(this.f28151i, true);
        this.I.a(this.f28166y, true);
        this.E.a(this.f28165x, true);
        m5 m5Var = this.f28162t;
        if (m5Var != null) {
            m5Var.d.d(1.0f, true);
        }
    ...
    public final int l(MessageObject messageObject, TLRPC.TL_peerColorCollectible tL_peerColorCollectible, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.R = false;
        this.f28167z = tL_peerColorCollectible.colors.get(0).intValue() | (-16777216);
        if (arrayList.size() >= 2) {
            z10 = true;
        } else {
            z10 = false;
        ...
        this.f28166y = i12;
        this.f28165x = org.telegram.ui.ActionBar.j6.l1(0.1f, i12);
        long j3 = tL_peerColorCollectible.background_emoji_id;
        this.v = j3;
        this.f28164w = tL_peerColorCollectible.gift_emoji_id;
        View view = this.D;
        if (j3 != 0 && this.f28162t == null && view != null) {
            this.f28162t = new m5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.t1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.t1) view).M0) {
                this.f28162t.a();
            }
        ...
        this.C = this.f28166y;
        if (this.f28164w != 0 && this.f28163u == null && view != null) {
            this.f28163u = new m5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.t1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.t1) view).M0) {
                this.f28163u.a();
            }
        }
        m5 m5Var2 = this.f28163u;
        if (m5Var2 != null) {
            m5Var2.j(this.f28164w, true);
        }
        return this.I.a(this.f28166y, false);
    }
    ...
    public final void m(MessageObject messageObject, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        if (i10 < 7) {
            int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19120r8[i10], f6Var);
            this.B = v02;
            this.A = v02;
            this.f28167z = v02;
            this.f28152j = false;
    ...
    public final int o(org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f28166y = org.telegram.ui.ActionBar.j6.v0(i10, f6Var);
        this.f28167z = org.telegram.ui.ActionBar.j6.v0(i10, f6Var);
        this.f28151i = false;
        this.f28152j = false;
        this.f28165x = org.telegram.ui.ActionBar.j6.l1(0.1f, org.telegram.ui.ActionBar.j6.v0(i10, f6Var));
        if (this.v != 0 && this.f28162t == null && (view = this.D) != null) {
            this.f28162t = new m5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.t1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.t1) view).M0) {
                this.f28162t.a();
    ...
    public final void q(int i10, boolean z10) {
        ...
        this.f28165x = org.telegram.ui.ActionBar.j6.l1(f7, i10);
        this.C = i10;
    }
}
