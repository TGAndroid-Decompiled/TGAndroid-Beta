...
public final class tp extends xw0 {
        ...
        switch (this.f28586a) {
            case 0:
                if (this.f28589f != i10) {
                    ...
                    this.f28590g.setColor(i10);
                }
                this.f28589f = i10;
                return;
            default:
                Paint paint = this.f28590g;
                if (paint != null) {
                    paint.setColor(i10);
                    return;
                }
    ...
    public final void draw(Canvas canvas) {
        ...
        switch (this.f28586a) {
            case 0:
                ...
                sr srVar2 = sr.f28340g;
                if (i10 < 0) {
                    f10 = 0.0f;
                } else {
                    f10 = (min - 0.3f) / 0.7f;
                }
                float interpolation2 = srVar2.getInterpolation(f10);
                if (this.d) {
                    ...
                    dpf2 = (1.0f - srVar2.getInterpolation(this.e / 2.0f)) * AndroidUtilities.dpf2(1.5f);
                } else {
                    dp = ((AndroidUtilities.dp(7.0f) - AndroidUtilities.dp(2.1f)) * interpolation) + ((1.0f - interpolation) * AndroidUtilities.dp(2.1f));
                    dpf2 = AndroidUtilities.dpf2(1.5f) * sr.h.getInterpolation(this.e / 2.0f);
                }
                ...
                if (this.f28587b) {
                    ...
                    long j3 = currentTimeMillis - this.f28588c;
                    this.f28588c = currentTimeMillis;
                    if (j3 > 50) {
                        j3 = 50;
                    }
            ...
            default:
                ...
                for (int i12 = 0; i12 < 4; i12++) {
                    if (i12 == 0) {
                        paint4.setAlpha((int) (this.f28589f * this.e));
                    } else if (i12 == 3) {
                        paint4.setAlpha((int) ((1.0f - this.e) * this.f28589f));
                    } else {
                        paint4.setAlpha(this.f28589f);
                    }
                ...
                if (this.d) {
                    ...
                    long j10 = currentTimeMillis2 - this.f28588c;
                    this.f28588c = currentTimeMillis2;
                    if (j10 > 50) {
                        j10 = 50;
                    }
