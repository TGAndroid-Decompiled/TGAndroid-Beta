...
public abstract class yg0 extends FrameLayout {
    public final y5 f30574a;
    public final TextView f30575b;
    public final org.telegram.ui.Cells.x1 f30576c;
    public final ah0 d;
    ...
    public yg0(ah0 ah0Var, Context context) {
        ...
        int i15;
        this.d = ah0Var;
        setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19151i5, false));
    ...
    public final void a(String str, ArrayList arrayList, int i10, int i11, int i12, boolean z10) {
        ...
        this.f30575b.setText(spannableStringBuilder);
        org.telegram.ui.Cells.x1 x1Var = this.f30576c;
        if (i12 == 0) {
            if (this.d.f22612r.quiz) {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        y5 y5Var = this.f30574a;
        TextView textView = this.f30575b;
        if (z11) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        measureChildWithMargins(this.f30574a, i10, AndroidUtilities.dp(32.0f) + measuredWidth, makeMeasureSpec, 0);
