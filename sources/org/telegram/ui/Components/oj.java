...
public final class oj {
    ...
    public static oj a(Object obj) {
        ...
        if (obj instanceof TLRPC.User) {
            return new oj(1, ((TLRPC.User) obj).f18259id);
        }
        return null;
    }
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj != null && oj.class == obj.getClass()) {
                oj ojVar = (oj) obj;
                if (this.f26815b == ojVar.f26815b && this.f26814a == ojVar.f26814a) {
                    return true;
                }
                return false;
            }
    ...
    public final int hashCode() {
        return Objects.hash(m1.j.a(this.f26814a), Long.valueOf(this.f26815b));
    }
}
