...
public final class g70 extends vl0 {
    public ArrayList f24323c = new ArrayList();
    public ArrayList d = new ArrayList();
    public final gg.c2 e;
    public int f24324f;
    public Runnable h;
    public final k70 f24325n;

    public g70(k70 k70Var) {
        this.f24325n = k70Var;
        gg.c2 c2Var = new gg.c2(false);
        this.e = c2Var;
        c2Var.f9689a = new lv(this, 7);
    }
    ...
    public final int j(int i10) {
        ...
        if (i10 == this.f24324f - 1) {
            return 4;
        }
        if (i10 - 1 != this.e.d.size() + this.f24323c.size()) {
            return 1;
        }
        return 0;
    }
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 != 4) {
                    ...
                    frameLayout.f20259b = textView;
                    com.google.android.gms.internal.vision.e2.l(14.0f, 1, textView);
                    textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19017ai, false));
                    int i12 = 3;
