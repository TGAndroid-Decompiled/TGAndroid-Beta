...
public final class g70 extends vl0 {
    ...
    public final TLObject E(int i10) {
        int i11;
        int i12;
        m70 m70Var = this.f24366c;
        if (m70Var.m0 != null) {
            TLRPC.Dialog dialog = (TLRPC.Dialog) m70Var.f26380n0.get(i10 - m70Var.Y);
            if (DialogObject.isUserDialog(dialog.f18325id)) {
                i12 = ((org.telegram.ui.ActionBar.e3) m70Var).currentAccount;
                return MessagesController.getInstance(i12).getUser(Long.valueOf(dialog.f18325id));
            }
            i11 = ((org.telegram.ui.ActionBar.e3) m70Var).currentAccount;
            return MessagesController.getInstance(i11).getChat(Long.valueOf(-dialog.f18325id));
        }
        return (TLObject) m70Var.f26372e0.get(i10 - m70Var.Y);
    }

    @Override
    public final int h() {
        return this.f24366c.f26370c0;
    }
    ...
    public final int j(int i10) {
        ...
        if (i10 == m70Var.f26369b0) {
            return 4;
        }
        if (i10 == m70Var.f26368a0) {
            return 5;
        }
        return 0;
    }
        ...
        if (i11 != 2) {
            if (i11 == 3) {
                ...
                if (E instanceof TLRPC.User) {
                    j10 = ((TLRPC.User) E).f18468id;
                } else if (E instanceof TLRPC.Chat) {
                    j10 = -((TLRPC.Chat) E).f18321id;
                } else {
                    j10 = 0;
                }
                if (j10 != 0) {
            ...
            if (i10 != 3) {
                if (i10 != 4) {
                    if (i10 != 5) {
                        ...
                        int i11 = org.telegram.ui.ActionBar.h6.f19228n5;
                        y4Var2.a(i11, i11);
                        y4Var = y4Var2;
                    } else {
