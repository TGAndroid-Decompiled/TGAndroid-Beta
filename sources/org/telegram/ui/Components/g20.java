...
public final class g20 extends ViewGroup {
    public AnimatorSet f27076a;
    public boolean f27077b;
    public final ArrayList f27078c;
    public p30 d;
    public final ArrayList f27079e;
    public int f27080f;
    public int h;
    public int f27081n;
    public final h20 f27082r;

    public g20(h20 h20Var, Context context) {
        super(context);
        this.f27082r = h20Var;
        this.f27078c = new ArrayList();
        this.f27079e = new ArrayList();
        this.f27080f = -1;
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        while (true) {
            ...
            if (childAt instanceof p30) {
                ...
                ArrayList arrayList2 = this.f27079e;
                ...
                if (!this.f27077b) {
                    if (contains) {
                        ...
                        this.f27081n = Math.max(this.f27081n, dp2);
                    } else {
        ...
        boolean z4 = this.f27077b;
        h20 h20Var = this.f27082r;
        if (!z4) {
            int dp5 = AndroidUtilities.dp(42.0f) + dp3;
            h20Var.f27355n = dp2;
            if (this.f27076a != null) {
                this.h = AndroidUtilities.dp(42.0f) + dp2;
                this.f27076a.playTogether(arrayList);
                this.f27076a.addListener(new f20(this, 0));
                this.f27080f = NotificationCenter.getInstance(h20Var.f27350a).setAnimationInProgress(this.f27080f, null);
                this.f27076a.start();
                this.f27077b = true;
            } else {
                this.h = dp5;
        ...
        e20 e20Var = h20Var.f27354f;
        if (e20Var != null) {
            e20Var.a(h20Var.f27353e);
        }
    }
}
