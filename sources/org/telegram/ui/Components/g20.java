...
public class g20 extends ScrollView {
    ...
    public void a(n30 n30Var) {
        f20 f20Var = this.d;
        ArrayList arrayList = f20Var.f24046c;
        g20 g20Var = f20Var.f24049r;
        g20Var.f24337c.add(n30Var);
        if (!n30Var.d) {
            g20Var.f24336b.k(n30Var, n30Var.getUid());
        }
        ...
        f20Var.f24044a = animatorSet2;
        animatorSet2.addListener(new e20(f20Var, 1));
        f20Var.f24044a.setDuration(150L);
        f20Var.d = n30Var;
        arrayList.clear();
    ...
    public void b() {
        ...
        g20 g20Var = f20Var.f24049r;
        g20Var.h = true;
        ArrayList arrayList2 = g20Var.f24337c;
    ...
    public void c(n30 n30Var) {
        ...
        ArrayList arrayList2 = f20Var.f24046c;
        g20 g20Var = f20Var.f24049r;
        g20Var.h = true;
        if (!n30Var.d) {
            g20Var.f24336b.l(n30Var.getUid());
        }
        g20Var.f24337c.remove(n30Var);
    ...
    public final boolean requestChildRectangleOnScreen(View view, Rect rect, boolean z10) {
        ...
        rect.top = org.telegram.messenger.f0.C(20.0f, this.f24339n, rect.top);
        rect.bottom = org.telegram.messenger.f0.C(50.0f, this.f24339n, rect.bottom);
