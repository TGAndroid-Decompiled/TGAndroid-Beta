...
public class EllipsizeSpanAnimator {
    ...
    private Animator createEllipsizeAnimator(final TextAlphaSpan textAlphaSpan, int i, int i2, int i3, int i4) {
        ...
        valueAnimatorOfInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                EllipsizeSpanAnimator.m2286$r8$lambda$iHwWtVX_42rEiWcqkESIxAFijs(this.f$0, textAlphaSpan, valueAnimator);
            }
        });
    ...
    public static void m2286$r8$lambda$iHwWtVX_42rEiWcqkESIxAFijs(EllipsizeSpanAnimator ellipsizeSpanAnimator, TextAlphaSpan textAlphaSpan, ValueAnimator valueAnimator) {
