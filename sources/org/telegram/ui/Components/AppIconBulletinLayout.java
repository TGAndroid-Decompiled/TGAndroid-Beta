...
public class AppIconBulletinLayout extends Bulletin.ButtonLayout {
    ...
    public AppIconBulletinLayout(Context context, LauncherIconController.LauncherIcon launcherIcon, Theme.ResourcesProvider resourcesProvider) {
        ...
        adaptiveIconImageView.setImageDrawable(context.getDrawable(launcherIcon.background));
        ...
        ArticleViewer$ErrorContainer$$ExternalSyntheticOutline0.m(R.string.AppIconChangedTo, new Object[]{LocaleController.getString(launcherIcon.title)}, textView);
    }
}
