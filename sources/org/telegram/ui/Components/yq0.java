...
public final class yq0 extends View {
    public Random f29478a;
    public Paint f29479b;
    public Paint f29480c;
    public Paint d;
    public Paint e;
    ...
    public final void onDraw(Canvas canvas) {
        float f7;
        Paint paint = this.f29480c;
        Paint paint2 = this.f29479b;
        super.onDraw(canvas);
        ...
        float f12 = (this.f29482n * interpolation) + ((1.0f - interpolation) * this.h);
        canvas.save();
        canvas.translate(0.0f, (-org.telegram.messenger.a2.z(4.0f, getMeasuredHeight(), dp)) * f12);
        int i11 = 0;
        while (i11 < i10) {
            ...
            rectF.set(AndroidUtilities.dp(1.0f) + measuredWidth, f13, org.telegram.messenger.a2.C(1.0f, measuredWidth, measuredWidth), f14);
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f), paint2);
            i11++;
            i10 = 7;
            f10 = 3.0f;
        ...
        float f15 = this.f29481f + 0.016f;
        this.f29481f = f15;
        if (f15 > 1.0f) {
            this.h = this.f29482n;
            float c10 = org.telegram.ui.Cells.r6.c(this.f29478a, 1001) / 1000.0f;
            this.f29482n = c10;
            if (c10 > this.h) {
                this.f29482n = c10 + 0.3f;
            } else {
                this.f29482n = c10 - 0.3f;
            }
            this.f29482n = Math.max(0.0f, Math.min(1.0f, this.f29482n));
            this.f29481f = 0.0f;
        }
        invalidate();
    }
