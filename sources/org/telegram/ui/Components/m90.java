...
public final class m90 extends v7.i0 {
    public final ArrayList f26126a;
    public TL_iv.RichText f26127b;
    ...
    public static int B(bf.p pVar) {
        bf.s sVar;
        String str;
        bf.p pVar2 = (bf.p) pVar.f3550c;
        if (pVar2 instanceof bf.r) {
            bf.p pVar3 = (bf.p) pVar2.f3550c;
            if ((pVar3 instanceof bf.s) && (str = (sVar = (bf.s) pVar3).f3553g) != null) {
                int i10 = 3;
                if (str.length() >= 3) {
                    int i11 = 0;
    ...
    public static void C(l90 l90Var, List list, int i10) {
        ...
        boolean z10;
        TL_iv.RichText j3;
        ad.a aVar = l90Var.f25882a;
        ArrayList arrayList = l90Var.f25884c;
            ...
            case 1557721666:
                if (lowerCase.equals("details")) {
                    ...
                    while (i11 < size) {
                        ...
                        if (z11) {
                            l90 l90Var2 = (l90) obj;
                            if ("summary".equalsIgnoreCase(l90Var2.f25882a.f389a)) {
                                StringBuilder sb2 = new StringBuilder();
                                w(l90Var2.f25884c, sb2);
                        ...
                        if (obj instanceof k90) {
                            arrayList2.add(((k90) obj).f25573a);
                        } else if (z11) {
    ...
    public static void w(List list, StringBuilder sb2) {
        for (Object obj : list) {
            if (obj instanceof k90) {
                TL_iv.PageBlock pageBlock = ((k90) obj).f25573a;
    ...
    public final void b(bf.c cVar) {
        ...
        for (bf.p pVar = (bf.p) cVar.f3550c; pVar != null; pVar = (bf.p) pVar.f3551f) {
    ...
    public final void f(bf.h hVar) {
        ...
        pageblockpreformatted.text = q90.d(q90.j(hVar.f3540k));
        String str = hVar.f3539j;
        if (str == null) {
            str = "";
        }
    ...
    public final void j(bf.l lVar) {
        TL_iv.pageBlockPreformatted pageblockpreformatted = new TL_iv.pageBlockPreformatted();
        pageblockpreformatted.text = q90.d(q90.j(lVar.f3545g));
    ...
    public final void k(bf.n nVar) {
        ...
        if (nVar instanceof we.a) {
            ...
            for (bf.p pVar = (bf.p) ((we.a) nVar).f3550c; pVar != null; pVar = (bf.p) pVar.f3551f) {
                boolean z11 = pVar instanceof we.e;
                if (z11 || (pVar instanceof we.b)) {
                    for (bf.p pVar2 = (bf.p) pVar.f3550c; pVar2 != null; pVar2 = (bf.p) pVar2.f3551f) {
                        if (pVar2 instanceof we.f) {
                            ArrayList<TL_iv.pageTableRow> arrayList = pageblocktable.rows;
                            TL_iv.pageTableRow pagetablerow = new TL_iv.pageTableRow();
                            for (bf.p pVar3 = (bf.p) ((we.f) pVar2).f3550c; pVar3 != null; pVar3 = (bf.p) pVar3.f3551f) {
                                if (pVar3 instanceof we.d) {
                                    ...
                                    we.c cVar = dVar.h;
                                    if (cVar == we.c.f45017b) {
                                        pagetablecell.align_center = true;
                                    } else if (cVar == we.c.f45018c) {
            ...
            pageblockparagraph.text = q90.c(((zc.a) nVar).f48853g);
    ...
    public final void x(TL_iv.PageBlock pageBlock) {
        ...
        sb2.append((char) 1);
        sb2.length();
        this.f26128c.add(new k90(length, pageBlock));
    }
    ...
    public final void y() {
        ...
        ArrayList arrayList4 = this.f26128c;
        ...
        while (i10 < size) {
            ...
            i10++;
            k90 k90Var = (k90) obj;
            hashMap.put(Integer.valueOf(k90Var.f25574b), k90Var);
        }
        ...
        while (i13 < size3) {
            ...
            while (i12 < arrayList3.size() && ((ad.a) arrayList3.get(i12)).f390b <= k90Var2.f25574b) {
                int i14 = i12 + 1;
                ad.a aVar4 = (ad.a) arrayList3.get(i12);
                int i15 = aVar4.d;
                int i16 = aVar4.f390b;
                if (i15 >= k90Var2.f25574b) {
                    while (arrayDeque.peek() != l90Var && ((l90) arrayDeque.peek()).f25883b <= i16) {
                        arrayDeque.pop();
                    }
                    l90 l90Var2 = new l90(aVar4, aVar4.d);
                    ((l90) arrayDeque.peek()).f25884c.add(l90Var2);
                    arrayDeque.push(l90Var2);
                }
                i12 = i14;
            }
            while (arrayDeque.peek() != l90Var && ((l90) arrayDeque.peek()).f25883b <= k90Var2.f25574b) {
                arrayDeque.pop();
            }
            TL_iv.PageBlock pageBlock = k90Var2.f25573a;
            ((l90) arrayDeque.peek()).f25884c.add(k90Var2);
        }
        A(0, l90Var.f25884c, this.f26126a);
    }
}
