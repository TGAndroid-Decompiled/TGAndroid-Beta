...
public final class m90 extends View {
    ...
    public final Paint f26354b;
    public final Paint f26355c;
    public final d6 d;
    public boolean e;
    ...
    public m90(Context context) {
        ...
        w7.b6.a(this);
        this.f26353a = context.getResources().getDrawable(R.drawable.media_live_on).mutate();
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int width = getWidth();
        Drawable drawable = this.f26353a;
