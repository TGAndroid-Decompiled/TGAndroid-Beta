...
public abstract class m90 {
    public static final Pattern f30606a = Pattern.compile("^\\[\\^([^\\]]+)\\]:[ \\t]*(.*)$");
    public static final Pattern f30607b = Pattern.compile("\\[\\^([^\\]]+)\\]");
    public static final Pattern f30608c = Pattern.compile("^(\\d+)[.)]\\s");

    public static TL_iv.RichText a(le.p pVar, TL_iv.PageBlock pageBlock) {
        j90 j90Var = new j90(pageBlock);
        pVar.a(j90Var);
        return g(h(j90.x(j90Var.f29628c)));
    }
    ...
    public static TL_iv.RichText g(TL_iv.RichText richText) {
        ...
        if (richText instanceof TL_iv.textConcat) {
            ...
            return textconcat;
        } else if (richText instanceof l90) {
            l90 l90Var = (l90) richText;
            TL_iv.textStrike g10 = g(l90Var.text);
            int i11 = l90Var.f30264a;
            if ((i11 & 4) != 0) {
    ...
    public static org.telegram.tgnet.tl.TL_iv.RichText h(org.telegram.tgnet.tl.TL_iv.RichText r17) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.m90.h(org.telegram.tgnet.tl.TL_iv$RichText):org.telegram.tgnet.tl.TL_iv$RichText");
    }

    public static java.lang.String i(java.lang.String r23, java.util.ArrayList r24) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.m90.i(java.lang.String, java.util.ArrayList):java.lang.String");
    }
