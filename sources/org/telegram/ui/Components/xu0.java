...
public final class xu0 extends sl0 {
    public final Context f30405r;
    public final jv0 f30406s;

    public xu0(jv0 jv0Var, Context context) {
        this.f30406s = jv0Var;
        this.f30405r = context;
    }
    ...
    public final int M(int i10) {
        yu0[] yu0VarArr = this.f30406s.f25539t1;
        int i11 = 1;
        if ((yu0VarArr[3].f30684c.size() == 0 && !yu0VarArr[3].f30686g) || i10 >= yu0VarArr[3].f30684c.size()) {
            return 1;
        }
        yu0 yu0Var = yu0VarArr[3];
        int size = ((ArrayList) yu0Var.d.get(yu0Var.f30684c.get(i10))).size();
        if (i10 == 0) {
            i11 = 0;
        }
        return size + i11;
    ...
    public final int P(int i10, int i11) {
        yu0[] yu0VarArr = this.f30406s.f25539t1;
        if (yu0VarArr[3].f30684c.size() == 0 && !yu0VarArr[3].f30686g) {
            return 5;
        }
        if (i10 < yu0VarArr[3].f30684c.size()) {
            if (i10 != 0 && i11 == 0) {
                return 3;
            }
            return 4;
    ...
    public final View T(int i10, View view) {
        jv0 jv0Var = this.f30406s;
        if (view == null) {
            view = new org.telegram.ui.Cells.v3(this.f30405r, 28, jv0Var.F1);
        }
        if (i10 == 0) {
            view.setAlpha(0.0f);
            return view;
        }
        if (i10 < jv0Var.f25539t1[3].f30684c.size()) {
            view.setAlpha(1.0f);
            ((org.telegram.ui.Cells.v3) view).setText(LocaleController.formatSectionDate(((MessageObject) ((ArrayList) jv0Var.f25539t1[3].d.get((String) jv0Var.f25539t1[3].f30684c.get(i10))).get(0)).messageOwner.date));
        }
        return view;
    }
    ...
    public final void W(int i10, int i11, s4.c1 c1Var) {
        ...
        if (i12 != 6 && i12 != 5) {
            ArrayList arrayList = (ArrayList) yu0VarArr[3].d.get((String) yu0VarArr[3].f30684c.get(i10));
            ...
            if (i13 != 3) {
                if (i13 == 4) {
                    ...
                    if ((view instanceof org.telegram.ui.Cells.n7) && i11 >= 0 && i11 < arrayList.size()) {
                        ...
                        if (i11 == arrayList.size() - 1 && (i10 != yu0VarArr[3].f30684c.size() - 1 || !yu0VarArr[3].f30686g)) {
                            z10 = false;
                        } else {
                            z10 = true;
                        }
                        ...
                        if (jv0Var.C1) {
                            ...
                            n7Var.f(z11, !jv0Var.f25498b1);
                            return;
                        }
                        n7Var.f(false, !jv0Var.f25498b1);
                        return;
                    }
                    return;
                }
        ...
        if (i10 != 3) {
            if (i10 != 4) {
                if (i10 != 5) {
                    ...
                    wt0 M = jv0.M(3, jv0Var.f25518j1, context, d6Var);
