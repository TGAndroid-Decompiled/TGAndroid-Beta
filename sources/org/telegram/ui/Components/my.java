...
public final class my extends g51 {
    public static final int f28554a = 0;
    ...
    public final void bindView(View view, h51 h51Var, boolean z10, v51 v51Var, d61 d61Var) {
        ...
        if (obj instanceof TLRPC.TL_messages_stickerSet) {
            ...
            TLRPC.Document document = ((dy) h51Var.H).f25479e;
            cVar.d.setText(((TLRPC.StickerSetCovered) obj).set.short_name);
            cVar.f17031c.d(document, null, null, null, false, false);
        }
        cVar.a(h51Var.f26588e, false);
    }

    @Override
    public final boolean contentsEquals(h51 h51Var, h51 h51Var2) {
        if (h51Var.B == h51Var2.B && h51Var.f26588e == h51Var2.f26588e) {
            return true;
        }
        return false;
    }
