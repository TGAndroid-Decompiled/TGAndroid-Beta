...
public final class my extends wl0 {
    ...
    public static void E(my myVar, Runnable runnable, ArrayList arrayList, boolean z10) {
        String str;
        mz mzVar = myVar.F;
    ...
    public final void F(String str, boolean z10) {
        ...
        if (!TextUtils.isEmpty(this.v)) {
            ...
            AndroidUtilities.runOnUIThread(lyVar2, j3);
        }
    }
    ...
    public final int j(int r9) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.my.j(int):int");
    }
    ...
    public final void v(s4.c1 r11, int r12) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.my.v(s4.c1, int):void");
    }
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 != 3) {
                    if (i10 != 4) {
                        if (i10 != 5) {
                            ai.f0 f0Var2 = new ai.f0(this, mzVar.getContext(), 13);
