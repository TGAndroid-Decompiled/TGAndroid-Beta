...
public final class ej0 implements LeadingMarginSpan {
    public final Path E;
    ...
    public boolean h;
    public boolean f23954n;
    public boolean f23955r;
    public final dj0 f23956s;
    public ii.a6 v;
    public final Drawable f23957w;
    public final Paint f23958x;
    public final float[] f23959y;

    public ej0(boolean z10, boolean z11, dj0 dj0Var) {
        Paint paint = new Paint(1);
        this.f23958x = paint;
        this.f23959y = new float[8];
        this.E = new Path();
        ...
        this.f23956s = dj0Var;
        this.e = z11;
        this.f23957w = ApplicationLoader.applicationContext.getResources().getDrawable(R.drawable.mini_quote).mutate();
    ...
    public static void a(SpannableStringBuilder spannableStringBuilder) {
        ...
        while (true) {
            int i14 = 1;
            if (i13 >= dj0VarArr.length) {
                break;
            }
            dj0 dj0Var = dj0VarArr[i13];
            ...
            spannableStringBuilder.removeSpan(dj0Var.f23706a);
            i13++;
        }
    ...
    public static void b(Spannable spannable, int i10, int i11, boolean z10) {
        ej0[] ej0VarArr = (ej0[]) spannable.getSpans(i10, i11, ej0.class);
        ...
        ej0 ej0Var = new ej0(false, z10, metricAffectingSpan);
        metricAffectingSpan.f23706a = ej0Var;
        ej0Var.f23952c = clamp;
        ej0Var.d = clamp2;
    ...
    public static int c(Editable editable, int i10, int i11, boolean z10) {
        ...
        ?? metricAffectingSpan = new MetricAffectingSpan();
        ej0 ej0Var = new ej0(true, z10, metricAffectingSpan);
        metricAffectingSpan.f23706a = ej0Var;
        ej0Var.f23952c = clamp;
        ej0Var.d = clamp2;
    ...
    public static java.util.ArrayList d(org.telegram.ui.Components.fu r19, android.text.Layout r20, java.util.ArrayList r21, boolean[] r22) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.ej0.d(org.telegram.ui.Components.fu, android.text.Layout, java.util.ArrayList, boolean[]):java.util.ArrayList");
    }
    ...
    public static ArrayList e(Layout layout, ArrayList arrayList) {
        ...
        if (layout == null) {
            ...
            if (text != null && (text instanceof Spanned)) {
                ...
                for (ej0 ej0Var : (ej0[]) spanned.getSpans(0, spanned.length(), ej0.class)) {
                    boolean z10 = ej0Var.f23954n;
                    aj0 aj0Var = new aj0(null, layout, spanned, ej0Var);
                    if (arrayList == null) {
