...
public final class tr0 implements Runnable {
    ...
    public final void run() {
        ...
        boolean z10;
        int i11;
        int i12 = this.f28193a;
        wh.e eVar = null;
        int i13 = 0;
        boolean z11 = this.f28194b;
        Object obj = this.f28195c;
        switch (i12) {
            case 0:
                ur0 ur0Var = (ur0) obj;
                if (!z11) {
                    ur0Var.H.f30643q0.setVisibility(0);
                    return;
                } else {
                    ur0Var.getClass();
                    return;
            ...
            case 1:
                qv0 qv0Var = (qv0) obj;
                ArrayList arrayList = qv0Var.f27432r;
                pv0 pv0Var = qv0Var.f27427n;
                if (pv0Var != null) {
                    pv0Var.H(qv0Var.f27419f, z11);
                }
                while (i13 < arrayList.size()) {
                    ((pv0) arrayList.get(i13)).H(qv0Var.f27419f, z11);
                    i13++;
                }
                return;
            case 2:
                rv0 rv0Var = (rv0) obj;
                ArrayList arrayList2 = rv0Var.f27432r;
                pv0 pv0Var2 = rv0Var.f27427n;
                if (pv0Var2 != null) {
                    pv0Var2.H(rv0Var.f27704y0, z11);
                }
                while (i13 < arrayList2.size()) {
                    ((pv0) arrayList2.get(i13)).H(rv0Var.f27704y0, z11);
                    i13++;
                }
                return;
            case 3:
                ...
                if (kpVar != null && kpVar.d != null) {
                    ...
                    if (kpVar.d != null) {
                        while (i13 < kpVar.d.size()) {
                            ((lp) kpVar.d.get(i13)).f25956c = z11 ? 1 : 0;
                            ((lp) kpVar.d.get(i13)).e = g31Var.b0(((lp) kpVar.d.get(i13)).f25954a, z11);
                            i13++;
                        }
                        g31Var.f33833r = null;
                        kpVar.l();
            ...
            case 11:
                ...
                if (t1Var != null) {
                    ...
                    if (!z11) {
                        ...
                        if (checkBoxBaseArr2 != null && O2 >= 0 && O2 < checkBoxBaseArr2.length && (checkBoxBase = checkBoxBaseArr2[O2]) != null && ke1Var != null && (checkBoxBaseArr = ke1Var.R8) != null && O2 >= 0 && O2 < checkBoxBaseArr.length && (checkBoxBase2 = checkBoxBaseArr[O2]) != null) {
                            ObjectAnimator objectAnimator = checkBoxBase.f21981p;
                            if (objectAnimator != null) {
                                objectAnimator.cancel();
                                checkBoxBase.f21981p = null;
                            }
                            checkBoxBase.setProgress(checkBoxBase2.getProgress());
                            checkBoxBase.f(-1, checkBoxBase2.f21982q, true);
                        }
                    }
                ...
                org.telegram.ui.ym ymVar = me1Var.f35778c0;
                if (ymVar != null) {
                    AndroidUtilities.runOnUIThread(ymVar);
                    me1Var.f35778c0 = null;
                    return;
                }
                return;
            case 12:
                wh.n nVar = (wh.n) obj;
                ArrayList arrayList3 = nVar.f45136c;
                boolean isEmpty = TextUtils.isEmpty(nVar.f45150t);
                String str = nVar.f45150t;
                nVar.f45152w = true;
                nVar.A = false;
                ...
                nVar.v = nVar.f45139i.getImporters(nVar.f45140j, str, tL_chatInviteImporter, nVar.d, new wh.f(nVar, isEmpty, eVar2, str, z10));
                return;
            case 13:
                yh.s0 s0Var = (yh.s0) obj;
                if (!z11) {
                    s0Var.f47775q0.setVisibility(8);
                    return;
                } else {
                    s0Var.getClass();
                    return;
            ...
            case 14:
                ...
                a4Var.o2(a4Var.f46973c1, AndroidUtilities.replaceTags(LocaleController.formatString(i11, a4Var.C1())), true);
                return;
            case 15:
                yh.a4 a4Var2 = ((yh.j2) obj).U;
                TL_stars.SavedStarGift H1 = a4Var2.H1(z11);
                if (H1 != null) {
                    a4Var2.f46971b1 = true;
            ...
            default:
                zg.n nVar2 = (zg.n) obj;
                if (z11) {
                    ((zg.q) nVar2.f49114x.f47959c).f49159w.setVisibility(4);
                    return;
                } else {
                    nVar2.getClass();
                    return;
