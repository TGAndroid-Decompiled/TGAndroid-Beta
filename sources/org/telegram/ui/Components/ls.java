...
public final class ls extends g6 {
    ...
    public ch.d f26188s;
    public final Path v;
    public final RectF f26189w;
    public int f26190x;
    public FragmentContextView f26191y;

    public ls(Context context) {
        super(context);
        this.v = new Path();
        this.f26189w = new RectF();
        this.f26190x = 24;
        setOrientation(1);
        ch.d dVar = this.f26188s;
        if (dVar != null) {
            dVar.v();
        }
        invalidate();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (getMetadata().f14216c.f14224a != 0.0f) {
            ...
            FragmentContextView fragmentContextView2 = this.f26191y;
            le.k kVar = this.f24375c;
            View view = null;
            if (fragmentContextView2 != null && ((currentStyle = fragmentContextView2.getCurrentStyle()) == 3 || currentStyle == 1)) {
                ...
                for (int i10 = 0; i10 < entriesCount; i10++) {
                    ...
                    View view2 = ((f6) n10.f14210a).f24082a;
                    float c10 = n10.c();
                    if (c10 > 0.0f && (fragmentContextView = this.f26191y) != null && (fragmentContextView == view2 || fragmentContextView.getParent() == view2)) {
                        id capsuleBlobDrawable = this.f26191y.getCapsuleBlobDrawable();
            ...
            while (i12 < entriesCount2) {
                ...
                View view4 = ((f6) n11.f14210a).f24082a;
                ...
                if (min > 0.0f && view3 != view4) {
                    ...
                    org.telegram.ui.ActionBar.h6.f19180k0.setAlpha((int) (alpha * min));
                    float f7 = 1.0f - min;
                    canvas2.drawLine(getPaddingLeft() + (AndroidUtilities.dp(16.0f) * f7), paddingTop2, getWidth() - ((AndroidUtilities.dp(16.0f) * f7) + getPaddingRight()), paddingTop2, org.telegram.ui.ActionBar.h6.f19180k0);
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (!super.dispatchTouchEvent(motionEvent)) {
            if (motionEvent.getAction() != 0 || (dVar = this.f26188s) == null || !dVar.getBounds().contains((int) motionEvent.getX(), (int) motionEvent.getY())) {
                return false;
            }
            return true;
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        boolean z10;
        FragmentContextView fragmentContextView = this.f26191y;
    ...
    public final void j() {
        ...
        RectF rectF = this.f26189w;
        rectF.set(getPaddingLeft(), getPaddingTop(), getMeasuredWidth() - getPaddingRight(), getPaddingTop() + f7);
        float min = Math.min(AndroidUtilities.dp(this.f26190x), Math.min(rectF.width(), rectF.height()) / 2.0f);
        Path path = this.v;
        path.rewind();
        ...
        if (dVar != null) {
            ...
            this.f26188s.setBounds(AndroidUtilities.dp(4.0f), AndroidUtilities.dp(14.0f), getMeasuredWidth() - AndroidUtilities.dp(4.0f), ((getPaddingBottom() + getPaddingTop()) + ((int) f7)) - AndroidUtilities.dp(14.0f));
            this.f26188s.q(Math.min(AndroidUtilities.dp(this.f26190x), f7 / 2.0f));
        }
    }
    ...
    public void setCallFragmentContextView(FragmentContextView fragmentContextView) {
        this.f26191y = fragmentContextView;
