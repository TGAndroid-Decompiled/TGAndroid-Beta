...
public final class sk0 extends View {
    ...
    public boolean U;
    public float V;
    public final org.telegram.ui.ActionBar.d6 f28294a;
    public final Paint f28295b;
    public final Paint f28296c;
    public final Paint d;
    public final Paint e;
    public final qg0 f28297f;
    public final o6 h;
    public t71 f28298n;
    ...
    public final jc0 f28302x;
    public final RectF f28303y;

    public sk0(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f28295b = new Paint(1);
        this.f28296c = new Paint(1);
        this.d = new Paint(1);
        this.e = new Paint(1);
        this.f28300s = 0.0f;
        this.v = 1.0f;
        this.f28301w = false;
        this.f28302x = new jc0(this, 19);
        this.f28303y = new RectF();
        this.E = new RectF();
        this.F = new RectF();
        this.G = new Path();
        this.H = new RectF();
    ...
    public final void a(Canvas canvas, RectF rectF) {
        ...
        qg0 qg0Var2 = this.f28297f;
        qg0Var2.f27670a.setColor(v05);
        ...
        Paint paint7 = this.e;
        paint7.setColor(v07);
        int lerp = (int) AndroidUtilities.lerp(rectF.left + AndroidUtilities.dp(11.33f), rectF.right - AndroidUtilities.dp(11.33f), Utilities.clamp01(this.f28300s));
        ...
        if (this.U) {
            ...
            t71 t71Var = this.f28298n;
            if (t71Var != null) {
                f7 = ((float) t71Var.n()) / ((float) this.f28298n.p());
            } else {
                f7 = 1.0f;
            }
            clamp = Utilities.clamp(f7, this.v, this.f28300s);
        }
        ...
        if (clamp2 < f11) {
            ...
            canvas.translate(rectF.left + AndroidUtilities.dp(14.0f), rectF.centerY());
            if (this.f28301w && clamp < this.f28300s && !this.U) {
        ...
        if (e > 0.0f) {
            ...
            if (e7 > 0.0f) {
                ...
                o6Var3.f26979w = (int) (e7 * 255.0f * e);
                o6Var3.draw(canvas);
                canvas.restore();
            }
        }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            boolean z13 = this.R;
            RectF rectF3 = this.f28303y;
            if (z13) {
                this.f28300s = Utilities.clamp(AndroidUtilities.ilerp(motionEvent.getX(), rectF3.left + AndroidUtilities.dp(11.33f), rectF3.right - AndroidUtilities.dp(11.33f)), Utilities.clamp01(this.v - Math.max(1.0f / this.f28299r, AndroidUtilities.dp(30.0f) / (rectF3.width() - AndroidUtilities.dp(22.66f)))), 0.0f);
                invalidate();
            } else if (this.S) {
                this.v = Utilities.clamp(AndroidUtilities.ilerp(motionEvent.getX(), rectF3.left + AndroidUtilities.dp(11.33f), rectF3.right - AndroidUtilities.dp(11.33f)), 1.0f, Utilities.clamp01(Math.max(1.0f / this.f28299r, AndroidUtilities.dp(30.0f) / (rectF3.width() - AndroidUtilities.dp(22.66f))) + this.f28300s));
                invalidate();
            } else if (this.U) {
                t71 t71Var2 = this.f28298n;
                if (t71Var2 != null) {
                    float clamp = Utilities.clamp(AndroidUtilities.ilerp(motionEvent.getX(), rectF3.left + AndroidUtilities.dp(11.33f), rectF3.right - AndroidUtilities.dp(11.33f)), this.v, this.f28300s);
                    this.V = clamp;
                    t71Var2.L(clamp * ((float) this.f28298n.p()), false);
                }
                invalidate();
            }
            this.h.q(AndroidUtilities.formatDuration(Math.round(Math.max(1.0f, (this.v - this.f28300s) * this.f28299r)), false), true, true);
        } else if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
            if (motionEvent.getAction() == 1 && this.T) {
                setPlaying(!b());
            } else if (this.R && this.f28301w) {
                t71 t71Var3 = this.f28298n;
                if (t71Var3 != null) {
                    t71Var3.L(this.f28300s * ((float) t71Var3.p()), false);
                }
                setPlaying(true);
            } else if (this.S && this.f28301w) {
                t71 t71Var4 = this.f28298n;
                if (t71Var4 != null) {
                    t71Var4.L(Math.max(this.f28300s * ((float) t71Var4.p()), (this.v * ((float) this.f28298n.p())) - 1500), false);
                }
                setPlaying(true);
            } else if (this.U && !b()) {
                setPlaying(true);
    ...
    public long getAudioLeftMs() {
        return this.f28300s * ((float) getDuration());
    }
    ...
    public double getNewDuration() {
        return ((this.v - this.f28300s) * ((float) getDuration())) / 1000.0d;
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        this.f28303y.set(0.0f, (getHeight() - dp) / 2.0f, getWidth(), (getHeight() + dp) / 2.0f);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        float dp = AndroidUtilities.dp(32.0f);
        this.f28303y.set(0.0f, (getMeasuredHeight() - dp) / 2.0f, getMeasuredWidth(), (getMeasuredHeight() + dp) / 2.0f);
    }
    ...
    public void setPlaying(boolean z10) {
        ...
        t71 t71Var = this.f28298n;
        if (t71Var != null) {
            float n10 = ((float) t71Var.n()) / ((float) this.f28298n.p());
            float f7 = this.f28300s;
        ...
        this.f28297f.a(z10, true);
        jc0 jc0Var = this.f28302x;
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.h != drawable && this.f28297f != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
