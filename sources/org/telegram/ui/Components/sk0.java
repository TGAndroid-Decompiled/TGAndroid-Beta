...
public final class sk0 extends View {
    ...
    public boolean f27886a0;
    public final RectF f27887b;
    public final float f27888b0;
    public final Paint f27889c;
    public final Drawable f27890c0;
    public final Paint d;
    public final Drawable f27891d0;
    public float e;
    public ch.d f27892e0;
    public float f27893f;
    public ch.d f27894f0;
    public final boolean f27895g0;
    public float h;
    public int f27896h0;
    public final org.telegram.ui.Cells.l7 f27897i0;
    public float f27898j0;
    public boolean f27899k0;
    public long f27900l0;
    public float m0;
    public boolean f27901n;
    public float f27902n0;
    public final ll0 f27903o0;
    public StaticLayout f27904r;
    public StaticLayout f27905s;
    public StaticLayout v;
    public StaticLayout f27906w;
    public StaticLayout f27907x;
    public float f27908y;
    ...
    public sk0(ll0 ll0Var, Context context, int i10) {
        ...
        float f7;
        float f10;
        org.telegram.ui.ActionBar.e6 e6Var = ll0Var.f25966p2;
        this.f27903o0 = ll0Var;
        this.f27885a = true;
        this.f27887b = new RectF();
        this.f27889c = new Paint(1);
        ...
        this.L = new float[8];
        this.W = new int[2];
        this.f27897i0 = new org.telegram.ui.Cells.l7(this, 20);
        this.f27902n0 = 1.0f;
        this.R = i10;
        if (i10 == 0) {
            textPaint.setTextSize(AndroidUtilities.dp(45.0f));
            this.f27895g0 = LocaleController.isRTL;
        } else {
            this.f27895g0 = false;
            textPaint.setTextSize(AndroidUtilities.dp(13.0f));
            textPaint.setTypeface(AndroidUtilities.bold());
            int i12 = org.telegram.ui.ActionBar.i6.f18836d6;
            paint.setColor(org.telegram.ui.ActionBar.i6.v0(i12, e6Var));
            Drawable mutate = context.getDrawable(R.drawable.calendar_date).mutate();
            this.f27891d0 = mutate;
            mutate.setColorFilter(new PorterDuffColorFilter(i0.a.d(0.1f, org.telegram.ui.ActionBar.i6.v0(i12, e6Var), -1), PorterDuff.Mode.MULTIPLY));
        }
        ...
        this.f27888b0 = ViewConfiguration.get(context).getScaledTouchSlop();
        this.f27890c0 = context.getDrawable(R.drawable.fast_scroll_shadow);
    }

    public final void a(boolean z10) {
        ll0 ll0Var = this.f27903o0;
        ...
        if (layoutManager instanceof s4.c0) {
            ...
            if (c0Var.f42663o == 1) {
                ...
                if (adapter instanceof tk0) {
                    ...
                    if (z10) {
                        c0Var.h1(iArr[0], (-iArr[1]) + ll0Var.f25979w1);
                    }
                    String F = tk0Var.F(iArr[0]);
                    if (F == null) {
                        StaticLayout staticLayout = this.f27904r;
                        if (staticLayout != null) {
                            this.f27905s = staticLayout;
                        }
                        this.f27904r = null;
                        ...
                        if (i10 == 0) {
                            this.f27904r = new StaticLayout(F, textPaint, 1000, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                        } else {
                            this.v = this.f27904r;
                            int measureText = ((int) textPaint.measureText(F)) + 1;
                            Layout.Alignment alignment = Layout.Alignment.ALIGN_NORMAL;
                            this.f27904r = new StaticLayout(F, textPaint, measureText, alignment, 1.0f, 0.0f, false);
                            if (this.v != null) {
                                ...
                                if (split != null && split2 != null && split.length == 2 && split2.length == 2 && split[1].equals(split2[1])) {
                                    ...
                                    this.f27906w = new StaticLayout(spannableStringBuilder2, textPaint, measureText, alignment, 1.0f, 0.0f, false);
                                    ...
                                    this.f27907x = new StaticLayout(spannableStringBuilder3, textPaint, measureText, alignment, 1.0f, 0.0f, false);
                                } else {
                                    this.f27906w = this.f27904r;
                                    this.f27907x = null;
                                }
                        ...
                        this.f27905s = null;
                        if (this.f27904r.getLineCount() > 0) {
                            this.f27904r.getLineWidth(0);
                            this.f27904r.getLineLeft(0);
                            if (this.f27895g0) {
                                this.M = (((AndroidUtilities.dp(88.0f) - this.f27904r.getLineWidth(0)) / 2.0f) + AndroidUtilities.dp(10.0f)) - this.f27904r.getLineLeft(0);
                            } else {
                                this.M = ((AndroidUtilities.dp(88.0f) - this.f27904r.getLineWidth(0)) / 2.0f) - this.f27904r.getLineLeft(0);
                            }
                            this.N = (AndroidUtilities.dp(88.0f) - this.f27904r.getHeight()) / 2;
                        }
                    }
                }
            }
    ...
    public final void b() {
        ...
        org.telegram.ui.Cells.l7 l7Var = this.f27897i0;
    ...
    public final void c() {
        ...
        int i10 = this.R;
        if (i10 == 0) {
            k10 = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19002m7, ll0Var.f25966p2);
        } else {
            k10 = i0.a.k(-16777216, 102);
        }
        this.S = k10;
        this.T = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18983l7, ll0Var.f25966p2);
        this.f27889c.setColor(this.S);
        TextPaint textPaint = this.H;
        if (i10 == 0) {
            textPaint.setColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19022n7, ll0Var.f25966p2));
        } else {
            textPaint.setColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.G6, ll0Var.f25966p2));
        }
        invalidate();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (i14 == 0) {
            ...
            ll0 ll0Var = this.f27903o0;
            f11 = 8.0f;
            paint.setColor(i0.a.d(0.1f, org.telegram.ui.ActionBar.i6.v0(i15, ll0Var.f25966p2), -1));
            float dp3 = AndroidUtilities.dp(27.0f) + ceil;
            ch.d dVar = this.f27892e0;
            if (dVar != null) {
                c10 = 2;
                f12 = 24.0f;
                ...
                this.f27892e0.draw(canvas);
                f13 = 4.0f;
            } else {
                c10 = 2;
                f12 = 24.0f;
                int measuredWidth = getMeasuredWidth();
                Drawable drawable = this.f27890c0;
                f13 = 4.0f;
            ...
            paint.setColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.G6, ll0Var.f25966p2));
            canvas.save();
        ...
        if (i14 == 0) {
        ...
        } else if (i14 == 1 && this.f27904r != null && this.V != 0.0f) {
            canvas.save();
            ...
            this.f27904r.getHeight();
            AndroidUtilities.dp(6.0f);
            rectF.set((dp6 - (((1.0f - this.f27908y) * this.G) + (this.f27908y * this.f27904r.getWidth()))) - AndroidUtilities.dp(f10), (centerY - (this.f27904r.getHeight() / 2.0f)) - AndroidUtilities.dp(f11), dp6 - AndroidUtilities.dp(f7), (this.f27904r.getHeight() / 2.0f) + centerY + AndroidUtilities.dp(f11));
            Paint paint2 = this.d;
            ...
            if (this.f27894f0 != null) {
                ...
                this.f27894f0.setBounds(rect);
                this.f27894f0.draw(canvas);
            } else {
                Drawable drawable2 = this.f27891d0;
                drawable2.setBounds((int) rectF.left, (int) rectF.top, (int) rectF.right, (int) rectF.bottom);
                drawable2.setAlpha((int) (this.V * 255.0f));
                drawable2.draw(canvas);
            }
            float f20 = this.f27908y;
            if (f20 != 1.0f) {
            ...
            if (this.f27908y != 1.0f) {
                canvas.save();
                rectF.inset(AndroidUtilities.dp(f13), AndroidUtilities.dp(2.0f));
                canvas.clipRect(rectF);
                if (this.v != null) {
                    textPaint.setAlpha((int) ((1.0f - this.f27908y) * alpha2 * this.V));
                    canvas.save();
                    ...
                    canvas.translate(width, (AndroidUtilities.dp(15.0f) * i12 * this.f27908y) + height);
                    this.v.draw(canvas);
                    canvas.restore();
                }
                if (this.f27906w != null) {
                    textPaint.setAlpha((int) (alpha2 * this.V * this.f27908y));
                    canvas.save();
                    float width2 = (dp6 - this.f27906w.getWidth()) - AndroidUtilities.dp(f12);
                    float height2 = centerY - (this.f27906w.getHeight() / 2.0f);
                    if (this.E) {
                        i11 = 1;
                    } else {
                        i11 = -1;
                    }
                    canvas.translate(width2, com.google.android.gms.internal.vision.e2.z(1.0f, this.f27908y, AndroidUtilities.dp(15.0f) * i11, height2));
                    this.f27906w.draw(canvas);
                    canvas.restore();
                }
                if (this.f27907x != null) {
                    textPaint.setAlpha((int) (alpha2 * this.V));
                    canvas.save();
                    canvas.translate((dp6 - this.f27907x.getWidth()) - AndroidUtilities.dp(f12), centerY - (this.f27907x.getHeight() / 2.0f));
                    this.f27907x.draw(canvas);
                    canvas.restore();
                }
                canvas.restore();
            } else {
                textPaint.setAlpha((int) (alpha2 * this.V));
                canvas.save();
                canvas.translate((dp6 - this.f27904r.getWidth()) - AndroidUtilities.dp(f12), com.google.android.gms.internal.vision.e2.z(1.0f, this.f27908y, AndroidUtilities.dp(15.0f), centerY - (this.f27904r.getHeight() / 2.0f)));
                this.f27904r.draw(canvas);
                canvas.restore();
            }
        ...
        boolean z11 = this.f27899k0;
        if ((z11 && this.f27904r != null && this.O < 1.0f) || ((!z11 || this.f27904r == null) && this.O > 0.0f)) {
            this.P = currentTimeMillis;
            invalidate();
            if (this.f27899k0 && this.f27904r != null) {
    ...
    public void setIsVisible(boolean z10) {
        ...
        if (this.f27886a0 != z10) {
            ...
            this.m0 = f7;
            super.setAlpha(this.f27902n0 * f7);
        }
    }
