...
public final class sk0 extends View {
    ...
    public boolean f27883a0;
    public final RectF f27884b;
    public final float f27885b0;
    public final Paint f27886c;
    public final Drawable f27887c0;
    public final Paint d;
    public final Drawable f27888d0;
    public float e;
    public ch.d f27889e0;
    public float f27890f;
    public ch.d f27891f0;
    public final boolean f27892g0;
    public float h;
    public int f27893h0;
    public final org.telegram.ui.Cells.l7 f27894i0;
    public float f27895j0;
    public boolean f27896k0;
    public long f27897l0;
    public float m0;
    public boolean f27898n;
    public float f27899n0;
    public final ll0 f27900o0;
    public StaticLayout f27901r;
    public StaticLayout f27902s;
    public StaticLayout v;
    public StaticLayout f27903w;
    public StaticLayout f27904x;
    ...
    public sk0(ll0 ll0Var, Context context, int i10) {
        ...
        float f7;
        float f10;
        org.telegram.ui.ActionBar.e6 e6Var = ll0Var.f25969p2;
        this.f27900o0 = ll0Var;
        this.f27882a = true;
        this.f27884b = new RectF();
        this.f27886c = new Paint(1);
        ...
        this.L = new float[8];
        this.W = new int[2];
        this.f27894i0 = new org.telegram.ui.Cells.l7(this, 20);
        this.f27899n0 = 1.0f;
        this.R = i10;
        if (i10 == 0) {
            textPaint.setTextSize(AndroidUtilities.dp(45.0f));
            this.f27892g0 = LocaleController.isRTL;
        } else {
            this.f27892g0 = false;
        ...
        this.f27885b0 = ViewConfiguration.get(context).getScaledTouchSlop();
        this.f27887c0 = context.getDrawable(R.drawable.fast_scroll_shadow);
    }

    public final void a(boolean z10) {
        ll0 ll0Var = this.f27900o0;
        ...
        if (layoutManager instanceof s4.c0) {
            ...
            if (c0Var.f42659o == 1) {
                ...
                if (adapter instanceof tk0) {
                    ...
                    if (z10) {
                        c0Var.h1(iArr[0], (-iArr[1]) + ll0Var.f25982w1);
                    }
                    String F = tk0Var.F(iArr[0]);
                    if (F == null) {
                        StaticLayout staticLayout = this.f27901r;
                        if (staticLayout != null) {
                            this.f27902s = staticLayout;
                        }
                        this.f27901r = null;
                        ...
                        if (i10 == 0) {
                            this.f27901r = new StaticLayout(F, textPaint, 1000, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                        } else {
                            this.v = this.f27901r;
                            int measureText = ((int) textPaint.measureText(F)) + 1;
                            Layout.Alignment alignment = Layout.Alignment.ALIGN_NORMAL;
                            this.f27901r = new StaticLayout(F, textPaint, measureText, alignment, 1.0f, 0.0f, false);
                            if (this.v != null) {
                                ...
                                if (split != null && split2 != null && split.length == 2 && split2.length == 2 && split[1].equals(split2[1])) {
                                    ...
                                    this.f27903w = new StaticLayout(spannableStringBuilder2, textPaint, measureText, alignment, 1.0f, 0.0f, false);
                                    ...
                                    this.f27904x = new StaticLayout(spannableStringBuilder3, textPaint, measureText, alignment, 1.0f, 0.0f, false);
                                } else {
                                    this.f27903w = this.f27901r;
                                    this.f27904x = null;
                                }
                        ...
                        this.f27902s = null;
                        if (this.f27901r.getLineCount() > 0) {
                            this.f27901r.getLineWidth(0);
                            this.f27901r.getLineLeft(0);
                            if (this.f27892g0) {
                                this.M = (((AndroidUtilities.dp(88.0f) - this.f27901r.getLineWidth(0)) / 2.0f) + AndroidUtilities.dp(10.0f)) - this.f27901r.getLineLeft(0);
                            } else {
                                this.M = ((AndroidUtilities.dp(88.0f) - this.f27901r.getLineWidth(0)) / 2.0f) - this.f27901r.getLineLeft(0);
                            }
                            this.N = (AndroidUtilities.dp(88.0f) - this.f27901r.getHeight()) / 2;
                        }
                    }
                }
            }
    ...
    public final void b() {
        ...
        org.telegram.ui.Cells.l7 l7Var = this.f27894i0;
    ...
    public final void c() {
        ...
        int i10 = this.R;
        if (i10 == 0) {
            k10 = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18999m7, ll0Var.f25969p2);
        } else {
            k10 = i0.a.k(-16777216, 102);
        }
        this.S = k10;
        this.T = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18980l7, ll0Var.f25969p2);
        this.f27886c.setColor(this.S);
        TextPaint textPaint = this.H;
        if (i10 == 0) {
            textPaint.setColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19019n7, ll0Var.f25969p2));
        } else {
            textPaint.setColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.G6, ll0Var.f25969p2));
        }
        invalidate();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (i14 == 0) {
            ...
            ll0 ll0Var = this.f27900o0;
            f11 = 8.0f;
            paint.setColor(i0.a.d(0.1f, org.telegram.ui.ActionBar.i6.v0(i15, ll0Var.f25969p2), -1));
            float dp3 = AndroidUtilities.dp(27.0f) + ceil;
            ch.d dVar = this.f27889e0;
            if (dVar != null) {
                c10 = 2;
                f12 = 24.0f;
                ...
                this.f27889e0.draw(canvas);
                f13 = 4.0f;
            } else {
                c10 = 2;
                f12 = 24.0f;
                int measuredWidth = getMeasuredWidth();
                Drawable drawable = this.f27887c0;
                f13 = 4.0f;
            ...
            paint.setColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.G6, ll0Var.f25969p2));
            canvas.save();
        ...
        if (i14 == 0) {
        ...
        } else if (i14 == 1 && this.f27901r != null && this.V != 0.0f) {
            canvas.save();
            ...
            this.f27901r.getHeight();
            AndroidUtilities.dp(6.0f);
            rectF.set((dp6 - (((1.0f - this.f27905y) * this.G) + (this.f27905y * this.f27901r.getWidth()))) - AndroidUtilities.dp(f10), (centerY - (this.f27901r.getHeight() / 2.0f)) - AndroidUtilities.dp(f11), dp6 - AndroidUtilities.dp(f7), (this.f27901r.getHeight() / 2.0f) + centerY + AndroidUtilities.dp(f11));
            Paint paint2 = this.d;
            int alpha = paint2.getAlpha();
            TextPaint textPaint = this.H;
            int alpha2 = textPaint.getAlpha();
            paint2.setAlpha((int) (alpha * this.V));
            if (this.f27891f0 != null) {
                Rect rect = AndroidUtilities.rectTmp2;
                rectF.round(rect);
                rect.inset(-AndroidUtilities.dp(f13), -AndroidUtilities.dp(f13));
                this.f27891f0.setBounds(rect);
                this.f27891f0.draw(canvas);
            } else {
                Drawable drawable2 = this.f27888d0;
                drawable2.setBounds((int) rectF.left, (int) rectF.top, (int) rectF.right, (int) rectF.bottom);
                drawable2.setAlpha((int) (this.V * 255.0f));
                drawable2.draw(canvas);
            }
            float f20 = this.f27905y;
            if (f20 != 1.0f) {
            ...
            if (this.f27905y != 1.0f) {
                canvas.save();
                rectF.inset(AndroidUtilities.dp(f13), AndroidUtilities.dp(2.0f));
                canvas.clipRect(rectF);
                if (this.v != null) {
                    textPaint.setAlpha((int) ((1.0f - this.f27905y) * alpha2 * this.V));
                    canvas.save();
                    ...
                    canvas.translate(width, (AndroidUtilities.dp(15.0f) * i12 * this.f27905y) + height);
                    this.v.draw(canvas);
                    canvas.restore();
                }
                if (this.f27903w != null) {
                    textPaint.setAlpha((int) (alpha2 * this.V * this.f27905y));
                    canvas.save();
                    float width2 = (dp6 - this.f27903w.getWidth()) - AndroidUtilities.dp(f12);
                    float height2 = centerY - (this.f27903w.getHeight() / 2.0f);
                    if (this.E) {
                        i11 = 1;
                    } else {
                        i11 = -1;
                    }
                    canvas.translate(width2, com.google.android.gms.internal.vision.e2.z(1.0f, this.f27905y, AndroidUtilities.dp(15.0f) * i11, height2));
                    this.f27903w.draw(canvas);
                    canvas.restore();
                }
                if (this.f27904x != null) {
                    textPaint.setAlpha((int) (alpha2 * this.V));
                    canvas.save();
                    canvas.translate((dp6 - this.f27904x.getWidth()) - AndroidUtilities.dp(f12), centerY - (this.f27904x.getHeight() / 2.0f));
                    this.f27904x.draw(canvas);
                    canvas.restore();
                }
                canvas.restore();
            } else {
                textPaint.setAlpha((int) (alpha2 * this.V));
                canvas.save();
                canvas.translate((dp6 - this.f27901r.getWidth()) - AndroidUtilities.dp(f12), com.google.android.gms.internal.vision.e2.z(1.0f, this.f27905y, AndroidUtilities.dp(15.0f), centerY - (this.f27901r.getHeight() / 2.0f)));
                this.f27901r.draw(canvas);
                canvas.restore();
            }
        ...
        boolean z11 = this.f27896k0;
        if ((z11 && this.f27901r != null && this.O < 1.0f) || ((!z11 || this.f27901r == null) && this.O > 0.0f)) {
            this.P = currentTimeMillis;
            invalidate();
            if (this.f27896k0 && this.f27901r != null) {
    ...
    public void setIsVisible(boolean z10) {
        ...
        if (this.f27883a0 != z10) {
            ...
            this.m0 = f7;
            super.setAlpha(this.f27899n0 * f7);
        }
    }
