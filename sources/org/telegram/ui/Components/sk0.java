...
public final class sk0 extends View {
    ...
    public final void a(Canvas canvas, RectF rectF) {
        ...
        float clamp;
        boolean z4;
        int i14 = org.telegram.ui.ActionBar.k6.f21794kf;
        org.telegram.ui.ActionBar.g6 g6Var = this.f31075a;
        int v02 = org.telegram.ui.ActionBar.k6.v0(i14, g6Var);
        Paint paint4 = this.f31076b;
        paint4.setColor(v02);
        int v03 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21812lf, g6Var);
        Paint paint5 = this.f31077c;
        paint5.setColor(v03);
        int i15 = org.telegram.ui.ActionBar.k6.f21740hf;
        int v04 = org.telegram.ui.ActionBar.k6.v0(i15, g6Var);
        j6 j6Var2 = this.h;
        j6Var2.r(v04);
        int v05 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21704ff, g6Var);
        og0 og0Var2 = this.f31079f;
        og0Var2.f29752a.setColor(v05);
        int v06 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21723gf, g6Var);
        Paint paint6 = this.d;
        paint6.setColor(v06);
        ...
        int i19 = org.telegram.ui.ActionBar.k6.f21723gf;
        ...
        if (this.R) {
            ...
            k71 k71Var = this.f31080n;
            if (k71Var != null) {
                f10 = ((float) k71Var.n()) / ((float) this.f31080n.p());
            } else {
                f10 = 1.0f;
            }
            clamp = Utilities.clamp(f10, this.v, this.f31082s);
        }
        ...
        if (clamp2 < f12) {
            ...
            canvas.translate(rectF.left + AndroidUtilities.dp(14.0f), rectF.centerY());
            if (this.f31083w && clamp < this.f31082s && !this.R) {
                paint6.setColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21740hf, g6Var));
            } else {
        ...
        if (e6 > 0.0f) {
            ...
            if (e10 > 0.0f) {
                ...
                j6Var3.f28047w = (int) (e10 * 255.0f * e6);
                j6Var3.draw(canvas);
                canvas.restore();
            }
        }
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (z12) {
                ...
                if (k71Var2 != null) {
                    ...
                    this.S = clamp;
                    k71Var2.L(clamp * ((float) this.f31080n.p()), false);
                }
                invalidate();
            }
            ...
            if (motionEvent.getAction() == 1 && this.Q) {
                setPlaying(!b());
            } else if (this.O && this.f31083w) {
                k71 k71Var3 = this.f31080n;
                if (k71Var3 != null) {
                    k71Var3.L(this.f31082s * ((float) k71Var3.p()), false);
                }
                setPlaying(true);
            } else if (this.P && this.f31083w) {
                k71 k71Var4 = this.f31080n;
                if (k71Var4 != null) {
                    k71Var4.L(Math.max(this.f31082s * ((float) k71Var4.p()), (this.v * ((float) this.f31080n.p())) - 1500), false);
                }
                setPlaying(true);
            } else if (this.R && !b()) {
                setPlaying(true);
    ...
    public void setPlaying(boolean z4) {
        ...
        k71 k71Var = this.f31080n;
        if (k71Var != null) {
            float n10 = ((float) k71Var.n()) / ((float) this.f31080n.p());
            float f10 = this.f31082s;
            if (n10 < f10 || n10 > this.v) {
                k71 k71Var2 = this.f31080n;
                k71Var2.L(f10 * ((float) k71Var2.p()), false);
            }
            this.f31080n.P(z4);
        }
        this.f31079f.a(z4, true);
        ec0 ec0Var = this.f31084x;
