...
public final class tx extends ht {
    ...
    public final void a(Canvas canvas, long j3, int i10, int i11, float f7) {
        ...
        if (!z10) {
            if (kzVar.f25773u2 > 0 && SystemClock.elapsedRealtime() - kzVar.f25773u2 < vxVar.x1()) {
                z11 = true;
            } else {
                z11 = false;
            }
            for (int i13 = 0; i13 < this.O.size(); i13++) {
                ...
                if (tyVar.h != 0.0f || tyVar.f28222n != null || ((i12 = tyVar.f28218a) > kzVar.f25767s2 && i12 < kzVar.f25770t2 && z11)) {
                    break;
                }
            }
        }
    ...
    public final void c(Canvas canvas) {
        ...
        while (true) {
            ...
            if (i10 < arrayList.size()) {
                ...
                o5 o5Var = tyVar.f28219b;
                if (o5Var != null) {
                    ImageReceiver.BackgroundThreadDrawHolder backgroundThreadDrawHolder = tyVar.f28221f[this.K];
                    ai.l4 l4Var = o5Var.f26639k;
                    if (l4Var != null) {
                        l4Var.setAlpha(o5Var.f26640l);
                        o5Var.f26639k.draw(canvas, backgroundThreadDrawHolder);
                    }
                }
                i10++;
            } else {
    ...
    public final void g() {
        ...
        while (true) {
            ArrayList arrayList = this.P;
            if (i10 < arrayList.size()) {
                ImageReceiver.BackgroundThreadDrawHolder[] backgroundThreadDrawHolderArr = ((ty) arrayList.get(i10)).f28221f;
                if (backgroundThreadDrawHolderArr != null) {
                    backgroundThreadDrawHolderArr[this.K].release();
                }
                i10++;
            } else {
                this.R.f29426f3.P.invalidate();
                return;
            }
        }
    }
    ...
    public final void i(long j3) {
        ...
        kz kzVar = this.R.f29426f3;
        ArrayList arrayList = this.P;
        arrayList.clear();
        for (int i10 = 0; i10 < this.O.size(); i10++) {
            ty tyVar = (ty) this.O.get(i10);
            x5 span = tyVar.getSpan();
            ImageReceiver.BackgroundThreadDrawHolder[] backgroundThreadDrawHolderArr = tyVar.f28221f;
            if (span != null && (o5Var = (o5) kzVar.f25720d2.get(tyVar.d.getDocumentId())) != null && o5Var.f26639k != null) {
                o5Var.t(j3);
                ai.l4 l4Var = o5Var.f26639k;
                int i11 = this.K;
                ...
                if (o5Var.c()) {
                    porterDuffColorFilter = kzVar.f25723e2;
                } else {
