...
public final class yi0 extends Path {
    public final org.telegram.ui.Cells.u1 f30602a;
    public final int f30603b;
    public final int f30604c;
    public final int d;
    public final boolean e;
    public final boolean f30605f;
    public final byte[] f30606g;
    public int h;
    public final Paint f30607i;
    public final vq f30608j;
    public final e6 f30609k;
    public final ArrayList f30610l;
    public final ArrayList f30611m;
    public final float f30612n;
    public final float f30613o;
    public final float f30614p;
    public xi0 f30615q;
    ...
    public yi0(final org.telegram.ui.Cells.u1 u1Var, int i10, int i11) {
        ...
        this.f30607i = paint;
        this.f30608j = new vq();
        this.f30610l = new ArrayList();
        this.f30611m = new ArrayList();
        this.f30602a = u1Var;
        this.f30609k = new e6(0.0f, new Runnable() {
            @Override
    ...
    public final void a(float f7, float f10, float f11, float f12) {
        ...
        float f13 = this.f30614p;
        float max = Math.max(f13, f7);
        float max2 = Math.max(f13, f11);
        float f14 = this.f30612n;
        float f15 = max + f14;
        float f16 = this.f30613o;
        float f17 = f10 + f16;
        float f18 = max2 + f14;
        ?? obj = new Object();
        obj.f30338a = f15 - AndroidUtilities.dp(3.0f);
        obj.f30339b = f18 + AndroidUtilities.dp(3.0f);
        obj.f30340c = f17;
        obj.d = f12 + f16;
        xi0 xi0Var = this.f30615q;
        if (xi0Var != null) {
            float f19 = xi0Var.d;
            xi0Var.h = (f19 + f17) / 2.0f;
            obj.f30342g = (f19 + f17) / 2.0f;
        }
        this.f30610l.add(obj);
        this.f30615q = obj;
    }
    ...
    public final void b(Canvas canvas, float f7, float f10, Rect rect, float f11) {
        ...
        float f13;
        int i10 = 0;
        float d = this.f30609k.d(1.0f, false);
        canvas.save();
        boolean z10 = this.f30605f;
        Paint paint = this.f30607i;
        org.telegram.ui.Cells.u1 u1Var = this.f30602a;
        vq vqVar = this.f30608j;
        if (z10) {
            ...
            vqVar.rewind();
            while (true) {
                ArrayList arrayList = this.f30610l;
                if (i10 >= arrayList.size()) {
                    break;
                }
                xi0 xi0Var = (xi0) arrayList.get(i10);
                float lerp3 = AndroidUtilities.lerp(rect.left - f7, xi0Var.f30338a, d);
                if (xi0Var.e) {
                    f12 = rect.top - f10;
                } else {
                    f12 = xi0Var.f30342g;
                }
                float lerp4 = AndroidUtilities.lerp(f12, xi0Var.f30340c, d);
                float lerp5 = AndroidUtilities.lerp(rect.right - f7, xi0Var.f30339b, d);
                if (xi0Var.f30341f) {
                    f13 = rect.bottom - f10;
                } else {
                    f13 = xi0Var.h;
    ...
    public yi0(org.telegram.ui.Cells.u1 u1Var, ViewParent viewParent, int i10, ArrayList arrayList, int i11, int i12, float f7) {
        ...
        this.f30611m = new ArrayList();
        this.f30602a = null;
        this.f30609k = new e6(0.0f, new cv(27, u1Var, viewParent), 350L, 420L, rr.h);
        this.f30603b = i10;
        this.f30604c = i14;
        this.d = i12;
        int i15 = 0;
        ...
        while (i16 < arrayList2.size()) {
            ...
            if (textLayoutBlock != 0 && i14 <= textLayoutBlock.charactersEnd && i12 >= (i13 = textLayoutBlock.charactersOffset)) {
                ...
                if (textLayoutBlock.code && !textLayoutBlock.quote) {
                    this.f30612n = f10 + AndroidUtilities.dp(10.0f);
                }
                this.f30613o = textLayoutBlock.textYOffset(arrayList2) + textLayoutBlock.padTop;
                this.f30614p = textLayoutBlock.quote ? AndroidUtilities.dp(10.0f) : 0.0f;
                ...
                if (textLayoutBlock.quoteCollapse && textLayoutBlock.collapsed()) {
                    this.f30611m.add(Integer.valueOf(textLayoutBlock.index));
                }
            }
            i16++;
        ...
        if (this.f30610l.size() > 0) {
            xi0 xi0Var = (xi0) this.f30610l.get(0);
            xi0 xi0Var2 = (xi0) hg.c.g(1, this.f30610l);
            xi0Var.e = true;
            xi0Var.f30340c -= AndroidUtilities.dp(0.66f);
            xi0Var2.f30341f = true;
