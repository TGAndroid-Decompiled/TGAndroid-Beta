...
public class e61 extends ll0 {
    ...
    public final w51 Y2;
    public s4.y Z2;
    public boolean f23558a3;
    public boolean f23559b3;
    public boolean f23560c3;
    public s4.c1 f23561d3;
    public boolean f23562e3;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (!b1()) {
            ...
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                ...
                int i12 = u51Var.f28295b;
                if (i12 >= 0) {
                    int i13 = u51Var.f28294a;
                    if (w51Var.f29612n) {
                    ...
                    if (i12 >= i13 && i13 >= 0 && i12 >= 0) {
                        ...
                        if (i14 < i15) {
                            if (this.f25976u2 == null) {
                                this.f25976u2 = new Paint(1);
                            }
                            this.f25976u2.setColor(v02);
                            canvas.drawRect(0.0f, i14, getWidth(), i15, this.f25976u2);
                        }
                    }
                }
            }
