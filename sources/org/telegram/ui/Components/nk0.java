...
public final class nk0 extends FrameLayout {
    ...
    public boolean L;
    public final pk0 M;
    public final mk0 f27299a;
    public final mk0 f27300b;
    public final mk0 f27301c;
    public final ImageReceiver d;
    public mg.q0 e;
    public eg.s1 f27302f;
    public float h;
    public boolean f27303n;
    ...
    public nk0(pk0 pk0Var, Context context) {
        ...
        mk0Var2.f27785a.setAutoRepeat(0);
        mk0Var2.f27785a.setAllowStartAnimation(false);
        mk0Var2.f27785a.setAllowStartLottieAnimation(false);
    ...
    public static void a(nk0 nk0Var, mg.q0 q0Var, int i10) {
        ...
        boolean z10;
        int i11;
        mk0 mk0Var = nk0Var.f27301c;
        mk0 mk0Var2 = nk0Var.f27299a;
        mk0 mk0Var3 = nk0Var.f27300b;
        pk0 pk0Var = nk0Var.M;
        ...
        int i12 = pk0Var.G;
        org.telegram.ui.ActionBar.f6 f6Var = pk0Var.f27903h0;
        int i13 = pk0Var.J0;
        ...
        nk0Var.E = z4;
        if (z4 && nk0Var.f27302f == null) {
            eg.s1 s1Var = new eg.s1(nk0Var.getContext(), 1, null);
            nk0Var.f27302f = s1Var;
            s1Var.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
            nk0Var.f27302f.setImageReceiver(mk0Var3.getImageReceiver());
            nk0Var.addView(nk0Var.f27302f, k7.b6.d(18, 18.0f, 17, 8.0f, 8.0f, 0.0f, 0.0f));
        }
        eg.s1 s1Var2 = nk0Var.f27302f;
        if (s1Var2 != null) {
            if (nk0Var.E) {
                i11 = 0;
            } else {
        ...
        nk0Var.d();
        nk0Var.e = q0Var;
        if (!q0Var.f14104a && (q0Var.f14107f == null || ((!pk0Var.q() && !pk0Var.D0) || !LiteMode.isEnabled(8200)))) {
            z10 = false;
        } else {
            z10 = true;
        }
        nk0Var.f27304r = z10;
        if (i13 == 4 || nk0Var.e.f14105b) {
            nk0Var.f27304r = false;
        }
        mg.q0 q0Var3 = nk0Var.e;
        if (!q0Var3.f14104a && q0Var3.f14107f == null) {
            mk0Var.getImageReceiver().clearImage();
            mk0Var3.getImageReceiver().clearImage();
            l5 l5Var = new l5(4, pk0Var.G, nk0Var.e.f14108g);
            l5 l5Var2 = new l5(3, pk0Var.G, nk0Var.e.f14108g);
            if (i13 != 1 && i13 != 2 && i13 != 4) {
                int i14 = org.telegram.ui.ActionBar.j6.f20225v6;
    ...
    public final void b() {
        ...
        mk0 mk0Var = this.f27300b;
        l5 l5Var = mk0Var.e;
        if (l5Var != null) {
            imageReceiver = l5Var.f26569k;
        } else {
            imageReceiver = mk0Var.f27785a;
        }
        if (imageReceiver != null && imageReceiver.getLottieAnimation() != null) {
            pk0 pk0Var = this.M;
            if (pk0Var.f27918u0 == null && !this.K && pk0Var.D0) {
    ...
    public final void c(int i10) {
        ...
        if (this.f27304r) {
            if (this.f27299a.getImageReceiver().getLottieAnimation() != null && !this.f27299a.getImageReceiver().getLottieAnimation().w() && !this.f27303n) {
                this.f27303n = true;
                if (i10 == 0) {
                    this.B = false;
                    this.f27299a.getImageReceiver().getLottieAnimation().stop();
                    this.f27299a.getImageReceiver().getLottieAnimation().L(0, false, false);
                    this.D.run();
                    return;
                }
                this.B = true;
            ...
            if (this.f27299a.getImageReceiver().getLottieAnimation() != null && this.f27303n && !this.f27299a.getImageReceiver().getLottieAnimation().f25158i0 && !this.f27299a.getImageReceiver().getLottieAnimation().w()) {
                this.f27299a.getImageReceiver().getLottieAnimation().L(this.f27299a.getImageReceiver().getLottieAnimation().e[0] - 1, false, false);
            }
            mk0 mk0Var3 = this.f27300b;
            float f15 = this.F;
            if (this.f27306w) {
                f10 = 0.76f;
            } else {
            ...
            mk0 mk0Var4 = this.f27300b;
            float f16 = this.F;
            if (!this.f27306w) {
                f12 = 1.0f;
            }
            mk0Var4.setScaleX(f16 * f12);
        } else if (!this.f27303n) {
            this.F = 0.0f;
            this.f27300b.setScaleX(0.0f);
            this.f27300b.setScaleY(0.0f);
            ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
            this.G = ofFloat;
            ofFloat.addUpdateListener(new i70(this, 9));
            this.G.setDuration(150L);
            this.G.setInterpolator(nr.h);
            this.G.setStartDelay(i10 * this.M.f27891c);
            this.G.start();
            this.f27303n = true;
        }
    }
    ...
    public final void d() {
        float f10;
        float f11;
        boolean z4 = this.f27304r;
        pk0 pk0Var = this.M;
        float f12 = 1.0f;
        mk0 mk0Var = this.f27300b;
        if (z4) {
            AndroidUtilities.cancelRunOnUIThread(this.D);
            mk0 mk0Var2 = this.f27299a;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        mg.q0 q0Var2 = this.e;
        if (q0Var2 != null && q0Var2.f14104a && this.C != null && LiteMode.isEnabled(8200) && LiteMode.isEnabled(131072)) {
            ...
            gj0 lottieAnimation = this.f27299a.getImageReceiver().getLottieAnimation();
            lh.wa waVar = this.C;
            ...
            waVar.f13318j = (int) (waVar.f13313b.size() * f10);
            this.C.g(rectF);
            this.C.d();
    ...
    public final void e(mg.q0 q0Var) {
        ...
        } else if (i11 == 4 && q0Var != null && q0Var.f14107f != null) {
            mk0Var.getImageReceiver().setImageBitmap(Emoji.getEmojiDrawable(q0Var.f14107f));
            mk0Var2.getImageReceiver().setImageBitmap(Emoji.getEmojiDrawable(q0Var.f14107f));
        } else {
            mg.q0 q0Var2 = this.e;
            if (q0Var2.f14105b) {
                TLRPC.Document effectDocument = MessagesController.getInstance(pk0Var.G).getEffectDocument(this.e.f14108g);
                SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(effectDocument, org.telegram.ui.ActionBar.j6.f20067m6, 0.2f);
                ...
                TLRPC.TL_availableReaction tL_availableReaction2 = MediaDataController.getInstance(pk0Var.G).getReactionsMap().get(this.e.f14107f);
                if (tL_availableReaction2 != null) {
                    SvgHelper.SvgDrawable svgThumb2 = DocumentObject.getSvgThumb(tL_availableReaction2.activate_animation, org.telegram.ui.ActionBar.j6.f20067m6, 0.2f);
                    ...
                    this.f27301c.getImageReceiver().setImage(ImageLocation.getForDocument(tL_availableReaction.select_animation), "60_60_pcache", null, null, svgThumb2, 0L, "tgs", q0Var, 0);
    ...
    public final void f(mg.q0 q0Var, boolean z4) {
        ...
        boolean contains = this.M.f27886a0.contains(q0Var);
        this.f27306w = contains;
        if (contains != z10) {
            mk0 mk0Var = this.f27299a;
            mk0 mk0Var2 = this.f27300b;
            float f16 = 1.0f;
            if (!z4) {
                ...
                scaleX2.scaleY(f24 * f16).setDuration(240L).setInterpolator(nrVar).start();
            }
            requestLayout();
            invalidate();
        }
        ...
        if (this.L) {
            ...
            if (pk0Var.N == null) {
                ...
                if (action == 0) {
                    ...
                    if (this.h == 1.0f && !this.E && (i10 = pk0Var.J0) != 3 && i10 != 4 && i10 != 5 && ((ok0Var = pk0Var.f27894d0) == null || ok0Var.h())) {
                ...
                if (motionEvent.getAction() == 1 && this.K && ((pk0Var.f27904i0 == null || pk0Var.f27906k0 > 0.8f) && pk0Var.f27894d0 != null)) {
                    pk0Var.f27910o0 = true;
                    if (System.currentTimeMillis() - pk0Var.f27911p0 > 300) {
                        pk0Var.f27911p0 = System.currentTimeMillis();
                        ok0 ok0Var2 = pk0Var.f27894d0;
                        mg.q0 q0Var = this.e;
                        if (pk0Var.f27906k0 > 0.8f) {
                            z4 = true;
                        } else {
                            z4 = false;
                        }
                        ok0Var2.i(this, q0Var, z4, false);
                    }
                }
                if (!pk0Var.f27910o0 && pk0Var.f27904i0 != null) {
                    pk0Var.f27907l0 = 0.0f;
                    float f10 = pk0Var.f27906k0;
                    ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                    pk0Var.N = ofFloat;
                    ofFloat.addUpdateListener(new dk0(pk0Var, f10));
                    pk0Var.N.addListener(new ck0(pk0Var, 1));
                    pk0Var.N.setDuration(150L);
                    pk0Var.N.setInterpolator(nr.f27346f);
                    pk0Var.N.start();
                }
