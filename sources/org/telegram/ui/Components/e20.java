...
public final class e20 extends ViewGroup {
    ...
    public final void onMeasure(int i10, int i11) {
            ...
            if (childAt instanceof m30) {
                ...
                if (!this.f23714b) {
                    if (contains) {
                        ...
                        this.f23717n = Math.max(this.f23717n, dp2);
                    } else {
        ...
        boolean z11 = this.f23714b;
        f20 f20Var = this.f23718r;
        if (!z11) {
            int dp5 = AndroidUtilities.dp(42.0f) + dp3;
            f20Var.f23979n = dp2;
            if (this.f23713a != null) {
                this.h = AndroidUtilities.dp(42.0f) + dp2;
                this.f23713a.playTogether(arrayList);
                this.f23713a.addListener(new d20(this, 0));
                this.f23716f = NotificationCenter.getInstance(f20Var.f23975a).setAnimationInProgress(this.f23716f, null);
                this.f23713a.start();
                this.f23714b = true;
            } else {
                this.h = dp5;
