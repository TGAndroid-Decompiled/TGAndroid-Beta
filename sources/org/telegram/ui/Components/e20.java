...
public final class e20 extends ViewGroup {
    ...
    public final void onMeasure(int i10, int i11) {
            ...
            if (childAt instanceof m30) {
                ...
                if (!this.f23489b) {
                    if (contains) {
                        ...
                        this.f23492n = Math.max(this.f23492n, dp2);
                    } else {
        ...
        f20 f20Var = this.f23493r;
        if (!z10) {
            int dp5 = AndroidUtilities.dp(42.0f) + dp3;
            f20Var.f23785n = dp2;
            if (this.f23488a != null) {
                this.h = AndroidUtilities.dp(42.0f) + dp2;
                this.f23488a.playTogether(arrayList);
                this.f23488a.addListener(new d20(this, 0));
                this.f23491f = NotificationCenter.getInstance(f20Var.f23781a).setAnimationInProgress(this.f23491f, null);
                this.f23488a.start();
                this.f23489b = true;
            } else {
                this.h = dp5;
