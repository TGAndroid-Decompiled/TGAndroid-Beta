...
public final class e20 extends ViewGroup {
    public AnimatorSet f25547a;
    public boolean f25548b;
    public final ArrayList f25549c;
    public m30 d;
    public final ArrayList f25550e;
    public int f25551f;
    public int h;
    public int f25552n;
    public final f20 f25553r;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        while (true) {
            ...
            if (childAt instanceof m30) {
                ...
                ArrayList arrayList2 = this.f25550e;
                ...
                if (!this.f25548b) {
                    if (contains) {
                        ...
                        this.f25552n = Math.max(this.f25552n, dp2);
                    } else {
        ...
        boolean z10 = this.f25548b;
        f20 f20Var = this.f25553r;
        if (!z10) {
            int dp5 = AndroidUtilities.dp(42.0f) + dp3;
            f20Var.f25905n = dp2;
            if (this.f25547a != null) {
                this.h = AndroidUtilities.dp(42.0f) + dp2;
                this.f25547a.playTogether(arrayList);
                this.f25547a.addListener(new d20(this, 0));
                this.f25551f = NotificationCenter.getInstance(f20Var.f25900a).setAnimationInProgress(this.f25551f, null);
                this.f25547a.start();
                this.f25548b = true;
            } else {
                this.h = dp5;
        ...
        c20 c20Var = f20Var.f25904f;
        if (c20Var != null) {
            c20Var.a(f20Var.f25903e);
        }
    }
}
