...
public abstract class q90 {
    public static final Pattern f27248a = Pattern.compile("^\\[\\^([^\\]]+)\\]:[ \\t]*(.*)$");
    public static final Pattern f27249b = Pattern.compile("\\[\\^([^\\]]+)\\]");
    public static final Pattern f27250c = Pattern.compile("^(\\d+)[.)]\\s");

    public static TL_iv.RichText a(bf.p pVar, TL_iv.PageBlock pageBlock) {
        n90 n90Var = new n90(pageBlock);
        pVar.a(n90Var);
        return g(h(n90.x(n90Var.f26408c)));
    }
