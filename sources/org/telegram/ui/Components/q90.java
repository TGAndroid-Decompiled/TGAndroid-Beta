...
public abstract class q90 {
    public static final Pattern f27286a = Pattern.compile("^\\[\\^([^\\]]+)\\]:[ \\t]*(.*)$");
    public static final Pattern f27287b = Pattern.compile("\\[\\^([^\\]]+)\\]");
    public static final Pattern f27288c = Pattern.compile("^(\\d+)[.)]\\s");

    public static TL_iv.RichText a(bf.p pVar, TL_iv.PageBlock pageBlock) {
        n90 n90Var = new n90(pageBlock);
        pVar.a(n90Var);
        return g(h(n90.x(n90Var.f26402c)));
    }
    ...
    public static TL_iv.textMath c(String str) {
        ...
        if (a2 != null) {
            textmath.f18332w = a2.f11608b;
            textmath.h = a2.f11609c;
            textmath.depth = a2.d;
            textmath.bitmap = a2.f11607a;
        }
        return textmath;
    }
