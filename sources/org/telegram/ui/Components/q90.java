...
public abstract class q90 {
    public static final Pattern f27289a = Pattern.compile("^\\[\\^([^\\]]+)\\]:[ \\t]*(.*)$");
    public static final Pattern f27290b = Pattern.compile("\\[\\^([^\\]]+)\\]");
    public static final Pattern f27291c = Pattern.compile("^(\\d+)[.)]\\s");

    public static TL_iv.RichText a(bf.p pVar, TL_iv.PageBlock pageBlock) {
        n90 n90Var = new n90(pageBlock);
        pVar.a(n90Var);
        return g(h(n90.x(n90Var.f26403c)));
    }
    ...
    public static TL_iv.textMath c(String str) {
        ...
        if (a2 != null) {
            textmath.f18336w = a2.f11606b;
            textmath.h = a2.f11607c;
            textmath.depth = a2.d;
            textmath.bitmap = a2.f11605a;
        }
        return textmath;
    }
    ...
    public static TL_iv.RichText g(TL_iv.RichText richText) {
        ...
        if (richText instanceof TL_iv.textConcat) {
            ...
            return textconcat;
        } else if (richText instanceof p90) {
            p90 p90Var = (p90) richText;
            TL_iv.textStrike g10 = g(p90Var.text);
            int i11 = p90Var.f26979a;
            if ((i11 & 4) != 0) {
    ...
    public static org.telegram.tgnet.tl.TL_iv.RichText h(org.telegram.tgnet.tl.TL_iv.RichText r17) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.q90.h(org.telegram.tgnet.tl.TL_iv$RichText):org.telegram.tgnet.tl.TL_iv$RichText");
    }

    public static java.lang.String i(java.lang.String r23, java.util.ArrayList r24) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.q90.i(java.lang.String, java.util.ArrayList):java.lang.String");
    }
