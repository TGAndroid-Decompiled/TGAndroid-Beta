...
public class QuoteHighlight extends Path {
    ...
    public QuoteHighlight(View view, ViewParent viewParent, int i, ArrayList<MessageObject.TextLayoutBlock> arrayList, int i2, int i3, float f) {
        int i4;
        Paint paint = new Paint(1);
        this.paint = paint;
        this.path = new CornerPath();
        ...
        this.quotesToExpand = new ArrayList<>();
        this.cell = null;
        this.t = new AnimatedFloat(0.0f, new UndoView$$ExternalSyntheticLambda3(8, view, viewParent), 350L, 420L, CubicBezierInterpolator.EASE_OUT_QUINT);
        this.id = i;
        this.start = i2;
        this.end = i3;
        this.todo = false;
        ...
        if (this.rectangles.size() > 0) {
            ...
            Rect rect2 = (Rect) zzin.m(1, this.rectangles);
            rect.first = true;
