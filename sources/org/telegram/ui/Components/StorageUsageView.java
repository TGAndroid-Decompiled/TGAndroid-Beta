...
public class StorageUsageView extends FrameLayout {
    ...
    public class ProgressView extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            StorageUsageView.this.bgPaint.setColor(Theme.getColor(null, Theme.key_windowBackgroundWhite, false));
            ...
            if (StorageUsageView.this.calculating || StorageUsageView.this.calculatingProgress != 0.0f) {
                ...
                StorageUsageView.this.cellFlickerDrawable.parentWidth = getMeasuredWidth();
                canvas2 = canvas;
                StorageUsageView.this.cellFlickerDrawable.draw(null, canvas2, rectF, AndroidUtilities.dp(3.0f));
            } else {
                canvas2 = canvas;
            }
            int iDp = AndroidUtilities.dp(24.0f);
            if (!StorageUsageView.this.calculating) {
                int iM$3 = (int) (OKLCH.m$3(24.0f, 2, getMeasuredWidth()) * StorageUsageView.this.progress2);
                int iDp2 = AndroidUtilities.dp(24.0f) + iM$3;
                canvas2.drawLine(iDp, AndroidUtilities.dp(20.0f), AndroidUtilities.dp(24.0f) + iM$3, AndroidUtilities.dp(20.0f), StorageUsageView.this.paintProgress2);
                canvas.drawRect(iDp2, AndroidUtilities.dp(20.0f) - AndroidUtilities.dp(3.0f), AndroidUtilities.dp(3.0f) + iDp2, AndroidUtilities.dp(3.0f) + AndroidUtilities.dp(20.0f), StorageUsageView.this.bgPaint);
            }
            if (StorageUsageView.this.calculating) {
                return;
            }
            int iM$4 = (int) (OKLCH.m$3(24.0f, 2, getMeasuredWidth()) * StorageUsageView.this.progress);
            if (iM$4 < AndroidUtilities.dp(1.0f)) {
                iM$4 = AndroidUtilities.dp(1.0f);
            }
            int iDp3 = AndroidUtilities.dp(24.0f) + iM$4;
            canvas.drawLine(iDp, AndroidUtilities.dp(20.0f), AndroidUtilities.dp(24.0f) + iM$4, AndroidUtilities.dp(20.0f), StorageUsageView.this.paintProgress);
            canvas.drawRect(iDp3, AndroidUtilities.dp(20.0f) - AndroidUtilities.dp(3.0f), AndroidUtilities.dp(3.0f) + iDp3, AndroidUtilities.dp(3.0f) + AndroidUtilities.dp(20.0f), StorageUsageView.this.bgPaint);
        }
    ...
    public StorageUsageView(Context context) {
        ...
        this.cellFlickerDrawable = new CellFlickerDrawable(220, 255, 160);
            ...
            public void onLayout(boolean z, int i, int i2, int i3, int i4) {
                ...
                for (int i5 = 0; i5 < childCount; i5++) {
                    if (getChildAt(i5).getVisibility() != 8) {
                        if (getChildAt(i5).getMeasuredWidth() + iM > getMeasuredWidth()) {
                            iM2 = RichMessageLayout$RichDetailsEndBlock$$ExternalSyntheticOutline0.m(8.0f, getChildAt(i5).getMeasuredHeight(), iM2);
                            iM = 0;
                        }
                        getChildAt(i5).layout(iM, iM2, getChildAt(i5).getMeasuredWidth() + iM, getChildAt(i5).getMeasuredHeight() + iM2);
                        iM = RichMessageLayout$RichDetailsEndBlock$$ExternalSyntheticOutline0.m(16.0f, getChildAt(i5).getMeasuredWidth(), iM);
                    }
                }
            }
            ...
            public void onMeasure(int i, int i2) {
                ...
                for (int i3 = 0; i3 < childCount; i3++) {
                    if (getChildAt(i3).getVisibility() != 8) {
                        if (getChildAt(i3).getMeasuredWidth() + iM > View.MeasureSpec.getSize(i)) {
                            iM2 = RichMessageLayout$RichDetailsEndBlock$$ExternalSyntheticOutline0.m(8.0f, getChildAt(i3).getMeasuredHeight(), iM2);
                            iM = 0;
                        }
                        iM = RichMessageLayout$RichDetailsEndBlock$$ExternalSyntheticOutline0.m(16.0f, getChildAt(i3).getMeasuredWidth(), iM);
                        measuredHeight = getChildAt(i3).getMeasuredHeight() + iM2;
                    }
                }
        ...
        this.telegramCacheTextView.setTextColor(Theme.getColor(null, i, false));
        TextView textView3 = new TextView(context);
        this.telegramDatabaseTextView = textView3;
        textView3.setCompoundDrawablePadding(AndroidUtilities.dp(6.0f));
        this.telegramDatabaseTextView.setTextColor(Theme.getColor(null, i, false));
        TextView textView4 = new TextView(context);
        this.freeSizeTextView = textView4;
        textView4.setCompoundDrawablePadding(AndroidUtilities.dp(6.0f));
        this.freeSizeTextView.setTextColor(Theme.getColor(null, i, false));
        TextView textView5 = new TextView(context);
        this.totlaSizeTextView = textView5;
        textView5.setCompoundDrawablePadding(AndroidUtilities.dp(6.0f));
        this.totlaSizeTextView.setTextColor(Theme.getColor(null, i, false));
        ...
        TextSettingsCell textSettingsCell = new TextSettingsCell(getContext(), null, 0);
    ...
    public void setStorageUsage(boolean z, long j, long j2, long j3, long j4) {
        ...
        if (z) {
            ...
            if (j2 > 0) {
                ...
                this.telegramDatabaseTextView.setVisibility(8);
                this.textSettingsCell.setTextAndValue(LocaleController.getString(R.string.ClearTelegramCache), AndroidUtilities.formatFileSize(j2), false, true);
            ...
            if (this.progress != f2) {
                ...
                valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                    public final StorageUsageView f$0;
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        switch (i2) {
                            case 0:
                                ...
                                break;
                            default:
                                this.f$0.lambda$setStorageUsage$1(valueAnimator2);
                                break;
                        }
                    }
                });
            ...
            if (this.progress2 != f3) {
                ...
                valueAnimatorOfFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                        switch (i) {
                            case 0:
                                this.f$0.lambda$setStorageUsage$0(valueAnimator3);
                                break;
                            default:
