...
public final class vd0 implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public final void onGlobalLayout() {
        ...
        int i13 = this.f29062a;
        int i14 = i11 - i13;
        int i15 = i14 * i14;
        int i16 = this.f29063b;
        int i17 = i12 - i16;
        int i18 = i17 * i17;
        ...
        while (i21 < childCount) {
            ...
            obj.f30245b = ((float) Math.sqrt(i22)) - AndroidUtilities.dp(40.0f);
            if (i21 != -1) {
            ...
            obj.f30244a.addListener(new dd0(animatorSet, 2));
            AnimatorSet animatorSet4 = obj.f30244a;
            if (i21 == -1) {
                j3 = 232;
            } else {
                j3 = 200;
            ...
            obj.f30244a.setInterpolator(new DecelerateInterpolator());
            arrayList3.add(obj);
            i21++;
        ...
        arrayList.add(ObjectAnimator.ofFloat(ae0Var.v, View.ALPHA, 0.0f, 1.0f));
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                while (true) {
                    ...
                    if (i23 < arrayList4.size()) {
                        xd0 xd0Var = (xd0) arrayList4.get(i23);
                        if (xd0Var.f30245b <= animatedFraction) {
                            xd0Var.f30244a.start();
        ...
        ValueAnimator ofFloat3 = ValueAnimator.ofFloat(ae0Var.P, 1.0f);
        ofFloat3.addUpdateListener(new p70(this, 2));
        ofFloat3.addListener(new ud0(this, 0));
