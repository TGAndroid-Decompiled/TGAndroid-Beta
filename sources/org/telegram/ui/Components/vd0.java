...
public final class vd0 extends FrameLayout {
    ...
    public void setNum(int i10) {
        ...
        TextView textView = this.f31892b;
        textView.setVisibility(0);
        TextView textView2 = this.f31893c;
