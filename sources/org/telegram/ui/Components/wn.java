...
public final class wn implements Runnable {
    ...
    public final void run() {
        switch (this.f29755a) {
            case 0:
                eo eoVar = this.f29756b;
                AtomicReference atomicReference = eoVar.f23715n;
            ...
            case 1:
                ...
                return;
            default:
                eo eoVar3 = this.f29756b;
                eoVar3.f23712j0 = false;
                eoVar3.f23710h0.c(false);
                if (eoVar3.a()) {
                    eoVar3.f();
                    return;
                }
