...
public final class wn extends oi {
    public final nz f30119n;
    public final wl0 f30120r;
    ...
    public wn(int i10, Context context, org.telegram.ui.ActionBar.d6 d6Var, wi wiVar) {
        ...
        TLRPC.Chat k12 = this.f27083b.k1();
        if (i10 == 1) {
    ...
    public int getListTopPadding() {
        return this.f30120r.getPaddingTop();
    }
