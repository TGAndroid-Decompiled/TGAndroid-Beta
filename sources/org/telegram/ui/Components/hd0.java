...
public final class hd0 implements Runnable {
    ...
    public final void run() {
        ...
        sd0 sd0Var = this.f26739b;
        switch (i10) {
            case 0:
                EditTextBoldCursor editTextBoldCursor = sd0Var.f30289r;
                if (sd0Var.f30292x.getVisibility() != 0 && editTextBoldCursor != null) {
