...
public class hd0 extends FrameLayout {
    ...
    public final o1.k f24642r;
    public float f24643s;
    public final float v;
    public final float f24644w;
    public EditText f24645x;
    public boolean f24646y;
    ...
    public hd0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f24642r = new o1.k(this, K);
        float max = Math.max(2, AndroidUtilities.dp(0.5f));
        this.v = max;
        this.f24644w = AndroidUtilities.dp(1.6667f);
        this.G = f6Var;
    ...
    public static void d(o1.k kVar, float f7) {
        ...
        if (lVar != null && f10 == ((float) lVar.f15528i)) {
            return;
        }
        kVar.c();
    ...
    public final void b(float f7, float f10, boolean z10) {
        if (!z10) {
            ...
            this.f24641n = f10;
            if (!this.f24646y) {
                float f11 = this.f24644w;
                float f12 = this.v;
                this.f24639c.setStrokeWidth(((f11 - f12) * f7) + f12);
            }
            f();
            return;
        }
    ...
    public final void e(EditTextBoldCursor editTextBoldCursor) {
        this.f24645x = editTextBoldCursor;
        invalidate();
    }
    ...
    public final void f() {
        ...
        this.d.setColor(i0.a.d(this.f24643s, d, org.telegram.ui.ActionBar.j6.v0(i11, f6Var)));
        int v04 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19222k6, f6Var);
        int v05 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19240l6, f6Var);
        if (!this.f24646y || this.F) {
            f10 = this.f24640f;
        }
        setColor(i0.a.d(this.f24643s, i0.a.d(f10, v04, v05), org.telegram.ui.ActionBar.j6.v0(i11, f6Var)));
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        EditText editText = this.f24645x;
        if ((editText == null || editText.length() != 0 || !TextUtils.isEmpty(this.f24645x.getHint())) && !this.f24646y && !this.E) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (z10) {
            paddingTop = com.google.android.gms.internal.vision.e2.z(1.0f, this.f24641n, textSize - paddingTop, paddingTop);
        }
        float f13 = paddingTop;
        if (z10) {
            f7 = (1.0f - this.f24641n) * this.H;
        } else {
            f7 = 0.0f;
        }
        ...
        if (z10) {
            f10 = com.google.android.gms.internal.vision.e2.z(1.0f, this.f24641n, 0.25f, 0.75f);
        } else {
            f10 = 0.75f;
        }
        float measureText = textPaint.measureText(this.f24638b) * f10;
        canvas.save();
        RectF rectF = this.f24637a;
        ...
        canvas.drawText(this.f24638b, AndroidUtilities.dp(14.0f) + getPaddingLeft() + f7, f13, textPaint);
        canvas.restore();
    }
