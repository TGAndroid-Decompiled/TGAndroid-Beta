    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f24681a) {
            ...
            default:
                ...
                TextView textView = sd0Var2.f27836w;
                ...
                sd0Var2.f27835s.setAlpha(AndroidUtilities.lerp(0.0f, 1.0f, floatValue2));
                return;
        }
    }
}
