    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f24678a) {
            ...
            default:
                ...
                TextView textView = sd0Var2.f27839w;
                ...
                sd0Var2.f27838s.setAlpha(AndroidUtilities.lerp(0.0f, 1.0f, floatValue2));
                return;
        }
    }
}
