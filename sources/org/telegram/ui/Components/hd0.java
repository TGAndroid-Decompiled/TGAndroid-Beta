    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f24642a) {
            ...
            default:
                ...
                TextView textView = sd0Var2.f27843w;
                ...
                sd0Var2.f27842s.setAlpha(AndroidUtilities.lerp(0.0f, 1.0f, floatValue2));
                return;
        }
    }
}
