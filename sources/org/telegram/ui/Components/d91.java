...
public final class d91 extends ViewGroup implements e71, AudioManager.OnAudioFocusChangeListener {
    ...
    public boolean V;
    public boolean W;
    public final h71 f23267a;
    public final RadialProgressView f23268a0;
    public final v81 f23269b;
    public final ImageView f23270b0;
    public final yf0 f23271c;
    public final ImageView f23272c0;
    public final TextureView d;
    public final ImageView f23273d0;
    public final ImageView e;
    public AnimatorSet f23274e0;
    public final ViewGroup f23275f;
    public final z81 f23276f0;
    public int f23277g0;
    public Bitmap h;
    public int f23278h0;
    public final u81 f23279i0;
    public final j50 f23280j0;
    public final u81 f23281k0;
    public TextureView f23282n;
    public int f23283r;
    ...
    public static final Pattern f23253l0 = Pattern.compile("(?:youtube(?:-nocookie)?\\.com/(?:[^/\\n\\s]+/\\S+/|(?:v|e(?:mbed)?)/|\\S*?[?&]v=)|youtu\\.be/)([a-zA-Z0-9_-]{11})");
    ...
    public static final Pattern f23254n0 = Pattern.compile("(?:coub:|https?://(?:coub\\.com/(?:view|embed|coubs)/|c-cdn\\.coub\\.com/fb-player\\.swf\\?.*\\bcoub(?:ID|id)=))([\\da-z]+)");
    public static final Pattern f23255o0 = Pattern.compile("^https?://(?:www\\.)?aparat\\.com/(?:v/|video/video/embed/videohash/)([a-zA-Z0-9]+)");
    public static final Pattern f23256p0 = Pattern.compile("https?://clips\\.twitch\\.tv/(?:[^/]+/)*([^/?#&]+)");
    public static final Pattern f23257q0 = Pattern.compile("https?://(?:(?:www\\.)?twitch\\.tv/|player\\.twitch\\.tv/\\?.*?\\bchannel=)([^/#?]+)");
    public static final Pattern f23258r0 = Pattern.compile("fileList\\s*=\\s*JSON\\.parse\\('([^']+)'\\)");
    public static final Pattern f23259s0 = Pattern.compile("clipInfo\\s*=\\s*(\\{[^']+\\});");
    public static final Pattern f23260t0 = Pattern.compile("\"sts\"\\s*:\\s*(\\d+)");
    public static final Pattern f23261u0 = Pattern.compile("\"assets\":.+?\"js\":\\s*(\"[^\"]+\")");
    public static final Pattern f23262v0 = Pattern.compile("\\.sig\\|\\|([a-zA-Z0-9$]+)\\(");
    public static final Pattern f23263w0 = Pattern.compile("[\"']signature[\"']\\s*,\\s*([a-zA-Z0-9$]+)\\(");
    public static final Pattern f23264x0 = Pattern.compile("var\\s");
    public static final Pattern f23265y0 = Pattern.compile("return(?:\\s+|$)");
    public static final Pattern f23266z0 = Pattern.compile("[()]");
    ...
    public d91(Context context, boolean z10, a91 a91Var) {
        ...
        this.Q = paint;
        this.f23279i0 = new u81(this, 0);
        this.f23280j0 = new j50(this, 3);
        this.f23281k0 = new u81(this, 1);
        ...
        imageView2.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        d91 d91Var = this.f28038b;
                        if (d91Var.f23285w && !d91Var.S && !d91Var.W && d91Var.M) {
                            d91Var.T = !d91Var.T;
                            d91Var.l(true);
                            return;
                        }
                        return;
                    case 1:
                        d91 d91Var2 = this.f28038b;
                        h71 h71Var2 = d91Var2.f23267a;
                        if (d91Var2.f23285w && d91Var2.f23286x != null) {
                            if (h71Var2.d == null) {
                                d91Var2.i();
                            }
                            if (h71Var2.y()) {
                        ...
                        return;
                    default:
                        d91 d91Var3 = this.f28038b;
                        ViewGroup viewGroup = d91Var3.f23275f;
                        boolean z11 = d91Var3.I;
                        a91 a91Var2 = d91Var3.v;
                        z81 z81Var2 = d91Var3.f23276f0;
                        yf0 yf0Var2 = d91Var3.f23271c;
                        TextureView textureView2 = d91Var3.d;
                        if (textureView2 != null && a91Var2.h() && !d91Var3.S && !d91Var3.W && d91Var3.M) {
                            d91Var3.W = true;
                            if (!d91Var3.U) {
                                d91Var3.T = false;
                                a91Var2.i(true, d91Var3.f23281k0, yf0Var2.getAspectRatio(), z11);
                                return;
                            }
    ...
    public static String d(String str) {
        ...
        if (!TextUtils.isEmpty(str)) {
            try {
                Matcher matcher = f23254n0.matcher(str);
                if (matcher.find()) {
    ...
    public static String e(String str) {
        ...
        Matcher matcher = f23253l0.matcher(str);
        if (!matcher.find()) {
            return null;
        }
    ...
    public final void i() {
        String str = this.f23286x;
        if (str != null) {
            String str2 = this.E;
            h71 h71Var = this.f23267a;
            if (str2 != null) {
                h71Var.G(Uri.parse(str), this.f23287y, Uri.parse(this.E), this.F);
            } else {
                h71Var.D(Uri.parse(str), this.f23287y);
            }
            h71Var.P(this.f23284s);
            long p5 = h71Var.p();
            z81 z81Var = this.f23276f0;
    ...
    public final void j(boolean z10, boolean z11) {
        float f7 = 0.0f;
        RadialProgressView radialProgressView = this.f23268a0;
        if (z11) {
            AnimatorSet animatorSet = this.f23274e0;
            if (animatorSet != null) {
                animatorSet.cancel();
            }
            AnimatorSet animatorSet2 = new AnimatorSet();
            this.f23274e0 = animatorSet2;
            if (z10) {
                f7 = 1.0f;
            }
            animatorSet2.playTogether(ObjectAnimator.ofFloat(radialProgressView, "alpha", f7));
            this.f23274e0.setDuration(150L);
            this.f23274e0.addListener(new w81(this, 0));
            this.f23274e0.start();
            return;
        }
        if (z10) {
    ...
    public final void k() {
        i2.e0 e0Var = this.f23267a.d;
        ImageView imageView = this.f23270b0;
    ...
    public final void l(boolean z10) {
        ...
        k();
        ViewGroup viewGroup2 = this.f23275f;
        yf0 yf0Var = this.f23271c;
        if (viewGroup2 == null) {
            this.S = true;
            if (!this.T) {
                if (viewGroup2 != null) {
            ...
            TextureView a2 = this.v.a(this.f23276f0, this.T, yf0Var.getAspectRatio(), yf0Var.getVideoRotation(), z10);
            this.f23282n = a2;
            a2.setVisibility(4);
            if (this.T && this.f23282n != null && (viewGroup = (ViewGroup) textureView.getParent()) != null) {
        ...
        this.v.a(this.f23276f0, this.T, yf0Var.getAspectRatio(), yf0Var.getVideoRotation(), z10);
    }

    public final void m() {
        int i10;
        int i11;
        ImageView imageView = this.f23273d0;
        if (imageView == null) {
            return;
        }
        if (this.U) {
    ...
    public final void n() {
        ...
        int i13 = z81.I;
        z81Var.a();
        AndroidUtilities.cancelRunOnUIThread(this.f23279i0);
        if (!this.f23267a.y()) {
            if (this.V) {
                ImageView imageView = this.f23272c0;
                if (this.U) {
            ...
            ImageView imageView2 = this.f23272c0;
            if (this.U) {
        ...
        ImageView imageView3 = this.f23272c0;
        if (this.U) {
        ...
        AndroidUtilities.runOnUIThread(this.f23279i0, 500L);
        if (!this.J) {
            this.J = true;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        z81Var.f30420a.setImageCoords(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight() - AndroidUtilities.dp(10.0f));
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f23271c.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(size2 - AndroidUtilities.dp(10.0f), 1073741824));
        z81 z81Var = this.f23276f0;
        if (z81Var.getParent() == this) {
            z81Var.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(size2, 1073741824));
        }
        this.f23268a0.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(44.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(44.0f), 1073741824));
    ...
    public final boolean onSurfaceDestroyed(SurfaceTexture surfaceTexture) {
        if (this.S) {
            ...
            if (this.T || this.U) {
                ...
                this.f23282n.setSurfaceTexture(surfaceTexture);
                this.f23282n.setSurfaceTextureListener(this.f23280j0);
                this.f23282n.setVisibility(0);
                return true;
            }
        }
        return false;
    ...
    public final void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        if (this.f23283r == 2) {
            ...
            this.W = false;
            int i10 = this.f23277g0;
            int i11 = this.f23278h0;
            this.f23271c.getVideoRotation();
            this.v.f(this.f23276f0, false, i10, i11, this.I);
            this.f23283r = 0;
        }
    }
