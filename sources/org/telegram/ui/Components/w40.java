...
public final class w40 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final nj0 f29913f;
    public final v40 h;
    public boolean f29914n;
    public final kj0 f29915r;
    ...
    public w40(Context context, String str, org.telegram.ui.zn znVar, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f29911b = new TextView[2];
        this.f29916s = new TextView[2];
        ...
        frameLayout2.f28977c = imageView2;
        ...
        frameLayout2.f28976b = textView3;
        ...
        for (int i13 = 0; i13 < 2; i13++) {
            this.f29911b[i13] = new TextView(context);
            this.f29911b[i13].setTextSize(1, 16.0f);
            this.f29911b[i13].setTypeface(AndroidUtilities.bold());
            this.f29911b[i13].setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19216j5));
            frameLayout.addView(this.f29911b[i13], w7.y5.d(-2, -2.0f, 49, 17.0f, 340.0f, 17.0f, 0.0f));
            this.f29916s[i13] = new TextView(context);
            this.f29916s[i13].setTextSize(1, 14.0f);
            this.f29916s[i13].setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19365r5));
            this.f29916s[i13].setGravity(1);
            frameLayout.addView(this.f29916s[i13], w7.y5.d(-2, -2.0f, 49, 30.0f, 368.0f, 30.0f, 44.0f));
            if (i13 == 0) {
                this.f29916s[i13].setText(LocaleController.getString(R.string.ImportImportingInfo));
            } else {
                this.f29916s[i13].setAlpha(0.0f);
                this.f29916s[i13].setTranslationY(AndroidUtilities.dp(10.0f));
                this.f29911b[i13].setAlpha(0.0f);
                this.f29911b[i13].setTranslationY(AndroidUtilities.dp(10.0f));
            }
        }
        if (this.e != null) {
            ...
            this.f29912c.setText(String.format("%d%%", Integer.valueOf(importingHistory.uploadProgress)));
            this.d.a(importingHistory.uploadProgress / 100.0f, false);
            this.f29911b[0].setText(LocaleController.formatString("ImportCount", R.string.ImportCount, AndroidUtilities.formatFileSize(importingHistory.getUploadedCount()), AndroidUtilities.formatFileSize(importingHistory.getTotalCount())));
            this.f29916s[1].setText(LocaleController.getString(R.string.ImportDoneInfo));
            this.f29911b[1].setText(LocaleController.getString(R.string.ImportDoneTitle));
        ...
        this.f29912c.setText(String.format("%d%%", Integer.valueOf(importingStickers.uploadProgress)));
        this.d.a(importingStickers.uploadProgress / 100.0f, false);
        this.f29911b[0].setText(LocaleController.formatString("ImportCount", R.string.ImportCount, AndroidUtilities.formatFileSize(importingStickers.getUploadedCount()), AndroidUtilities.formatFileSize(importingStickers.getTotalCount())));
        this.f29916s[1].setText(LocaleController.getString(R.string.ImportStickersDoneInfo));
        this.f29911b[1].setText(LocaleController.getString(R.string.ImportStickersDoneTitle));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        x80 x80Var = this.d;
        TextView[] textViewArr = this.f29911b;
        TextView textView = this.f29912c;
        nj0 nj0Var = this.f29913f;
        if (i10 == i12) {
            if (objArr.length > 1) {
                dismiss();
                return;
            ...
            if (!this.f29914n && ((180 - nj0Var.getAnimatedDrawable().f25711a0) * 16.6d) + 3000.0d >= importingHistory.timeUntilFinish) {
            ...
            if (!this.f29914n && ((180 - nj0Var.getAnimatedDrawable().f25711a0) * 16.6d) + 3000.0d >= importingStickers.timeUntilFinish) {
                nj0Var.setAutoRepeat(false);
                this.f29914n = true;
            }
    ...
    public final void m() {
        this.f29914n = true;
        this.f29913f.setAutoRepeat(false);
        v40 v40Var = this.h;
        ...
        TextView[] textViewArr = this.f29916s;
        ...
        TextView[] textViewArr2 = this.f29911b;
        ...
        v40Var.f28975a.animate().scaleY(1.0f).setInterpolator(new OvershootInterpolator(1.02f)).setDuration(250L).start();
        v40Var.f28977c.animate().scaleY(1.0f).scaleX(1.0f).setInterpolator(new OvershootInterpolator(1.02f)).setDuration(250L).start();
        v40Var.f28977c.d();
        animatorSet.start();
    }
}
