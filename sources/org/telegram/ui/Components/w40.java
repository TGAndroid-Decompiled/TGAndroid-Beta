...
public final class w40 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final TextView f29564c;
    public final m80 d;
    public final org.telegram.ui.bo e;
    public final aj0 f29565f;
    public final v40 h;
    public boolean f29566n;
    public final xi0 f29567r;
    public final TextView[] f29568s;
    ...
    public w40(Context context, String str, org.telegram.ui.bo boVar, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.f29563b = new TextView[2];
        this.f29568s = new TextView[2];
        ...
        imageView.getAnimatedDrawable().R(178, xpVar);
        ...
        frameLayout2.f28600c = imageView2;
        ...
        frameLayout2.f28599b = textView3;
        ...
        for (int i13 = 0; i13 < 2; i13++) {
            this.f29563b[i13] = new TextView(context);
            this.f29563b[i13].setTextSize(1, 16.0f);
            this.f29563b[i13].setTypeface(AndroidUtilities.bold());
            this.f29563b[i13].setTextColor(getThemedColor(org.telegram.ui.ActionBar.i6.f18943j5));
            frameLayout.addView(this.f29563b[i13], w7.x5.d(-2, -2.0f, 49, 17.0f, 340.0f, 17.0f, 0.0f));
            this.f29568s[i13] = new TextView(context);
            this.f29568s[i13].setTextSize(1, 14.0f);
            this.f29568s[i13].setTextColor(getThemedColor(org.telegram.ui.ActionBar.i6.f19091r5));
            this.f29568s[i13].setGravity(1);
            frameLayout.addView(this.f29568s[i13], w7.x5.d(-2, -2.0f, 49, 30.0f, 368.0f, 30.0f, 44.0f));
            if (i13 == 0) {
                this.f29568s[i13].setText(LocaleController.getString(R.string.ImportImportingInfo));
            } else {
                this.f29568s[i13].setAlpha(0.0f);
                this.f29568s[i13].setTranslationY(AndroidUtilities.dp(10.0f));
                this.f29563b[i13].setAlpha(0.0f);
                this.f29563b[i13].setTranslationY(AndroidUtilities.dp(10.0f));
            }
        }
        if (this.e != null) {
            ...
            this.f29564c.setText(String.format("%d%%", Integer.valueOf(importingHistory.uploadProgress)));
            this.d.a(importingHistory.uploadProgress / 100.0f, false);
            this.f29563b[0].setText(LocaleController.formatString("ImportCount", R.string.ImportCount, AndroidUtilities.formatFileSize(importingHistory.getUploadedCount()), AndroidUtilities.formatFileSize(importingHistory.getTotalCount())));
            this.f29568s[1].setText(LocaleController.getString(R.string.ImportDoneInfo));
            this.f29563b[1].setText(LocaleController.getString(R.string.ImportDoneTitle));
        ...
        this.f29564c.setText(String.format("%d%%", Integer.valueOf(importingStickers.uploadProgress)));
        this.d.a(importingStickers.uploadProgress / 100.0f, false);
        this.f29563b[0].setText(LocaleController.formatString("ImportCount", R.string.ImportCount, AndroidUtilities.formatFileSize(importingStickers.getUploadedCount()), AndroidUtilities.formatFileSize(importingStickers.getTotalCount())));
        this.f29568s[1].setText(LocaleController.getString(R.string.ImportStickersDoneInfo));
        this.f29563b[1].setText(LocaleController.getString(R.string.ImportStickersDoneTitle));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        m80 m80Var = this.d;
        TextView[] textViewArr = this.f29563b;
        TextView textView = this.f29564c;
        aj0 aj0Var = this.f29565f;
        if (i10 == i12) {
            if (objArr.length > 1) {
                dismiss();
                return;
            ...
            if (!this.f29566n && ((180 - aj0Var.getAnimatedDrawable().f29948b0) * 16.6d) + 3000.0d >= importingHistory.timeUntilFinish) {
            ...
            if (!this.f29566n && ((180 - aj0Var.getAnimatedDrawable().f29948b0) * 16.6d) + 3000.0d >= importingStickers.timeUntilFinish) {
                aj0Var.setAutoRepeat(false);
                this.f29566n = true;
            }
    ...
    public final void m() {
        this.f29566n = true;
        this.f29565f.setAutoRepeat(false);
        v40 v40Var = this.h;
        ...
        TextView[] textViewArr = this.f29568s;
        ...
        TextView[] textViewArr2 = this.f29563b;
        ...
        v40Var.f28598a.animate().scaleY(1.0f).setInterpolator(new OvershootInterpolator(1.02f)).setDuration(250L).start();
        v40Var.f28600c.animate().scaleY(1.0f).scaleX(1.0f).setInterpolator(new OvershootInterpolator(1.02f)).setDuration(250L).start();
        v40Var.f28600c.d();
        animatorSet.start();
    }
}
