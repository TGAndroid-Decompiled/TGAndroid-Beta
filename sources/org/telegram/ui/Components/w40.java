...
public final class w40 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public w40(Context context, String str, org.telegram.ui.zn znVar, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.f29856b = new TextView[2];
        this.f29861s = new TextView[2];
        ...
        frameLayout2.f28914c = imageView2;
        int dp2 = AndroidUtilities.dp(20.0f);
        int i12 = org.telegram.ui.ActionBar.j6.Sh;
        imageView2.setBackground(org.telegram.ui.ActionBar.j6.K(dp2, org.telegram.ui.ActionBar.j6.v0(i12, e6Var)));
        ...
        frameLayout2.f28913b = textView3;
        ...
        for (int i13 = 0; i13 < 2; i13++) {
            this.f29856b[i13] = new TextView(context);
            this.f29856b[i13].setTextSize(1, 16.0f);
            this.f29856b[i13].setTypeface(AndroidUtilities.bold());
            this.f29856b[i13].setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19169j5));
            frameLayout.addView(this.f29856b[i13], w7.y5.d(-2, -2.0f, 49, 17.0f, 340.0f, 17.0f, 0.0f));
            this.f29861s[i13] = new TextView(context);
            this.f29861s[i13].setTextSize(1, 14.0f);
            this.f29861s[i13].setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19318r5));
            this.f29861s[i13].setGravity(1);
            frameLayout.addView(this.f29861s[i13], w7.y5.d(-2, -2.0f, 49, 30.0f, 368.0f, 30.0f, 44.0f));
            if (i13 == 0) {
                this.f29861s[i13].setText(LocaleController.getString(R.string.ImportImportingInfo));
            } else {
                this.f29861s[i13].setAlpha(0.0f);
                this.f29861s[i13].setTranslationY(AndroidUtilities.dp(10.0f));
                this.f29856b[i13].setAlpha(0.0f);
                this.f29856b[i13].setTranslationY(AndroidUtilities.dp(10.0f));
            }
        }
        if (this.e != null) {
            ...
            this.f29857c.setText(String.format("%d%%", Integer.valueOf(importingHistory.uploadProgress)));
            this.d.a(importingHistory.uploadProgress / 100.0f, false);
            this.f29856b[0].setText(LocaleController.formatString("ImportCount", R.string.ImportCount, AndroidUtilities.formatFileSize(importingHistory.getUploadedCount()), AndroidUtilities.formatFileSize(importingHistory.getTotalCount())));
            this.f29861s[1].setText(LocaleController.getString(R.string.ImportDoneInfo));
            this.f29856b[1].setText(LocaleController.getString(R.string.ImportDoneTitle));
        ...
        this.f29857c.setText(String.format("%d%%", Integer.valueOf(importingStickers.uploadProgress)));
        this.d.a(importingStickers.uploadProgress / 100.0f, false);
        this.f29856b[0].setText(LocaleController.formatString("ImportCount", R.string.ImportCount, AndroidUtilities.formatFileSize(importingStickers.getUploadedCount()), AndroidUtilities.formatFileSize(importingStickers.getTotalCount())));
        this.f29861s[1].setText(LocaleController.getString(R.string.ImportStickersDoneInfo));
        this.f29856b[1].setText(LocaleController.getString(R.string.ImportStickersDoneTitle));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        v80 v80Var = this.d;
        TextView[] textViewArr = this.f29856b;
        TextView textView = this.f29857c;
        lj0 lj0Var = this.f29858f;
        if (i10 == i12) {
            if (objArr.length > 1) {
                dismiss();
                return;
            ...
            if (!this.f29859n && ((180 - lj0Var.getAnimatedDrawable().f24972a0) * 16.6d) + 3000.0d >= importingHistory.timeUntilFinish) {
            ...
            if (!this.f29859n && ((180 - lj0Var.getAnimatedDrawable().f24972a0) * 16.6d) + 3000.0d >= importingStickers.timeUntilFinish) {
                lj0Var.setAutoRepeat(false);
                this.f29859n = true;
            }
    ...
    public final void m() {
        this.f29859n = true;
        this.f29858f.setAutoRepeat(false);
        v40 v40Var = this.h;
        ...
        TextView[] textViewArr = this.f29861s;
        ...
        TextView[] textViewArr2 = this.f29856b;
        ...
        v40Var.f28912a.animate().scaleY(1.0f).setInterpolator(new OvershootInterpolator(1.02f)).setDuration(250L).start();
        v40Var.f28914c.animate().scaleY(1.0f).scaleX(1.0f).setInterpolator(new OvershootInterpolator(1.02f)).setDuration(250L).start();
        v40Var.f28914c.d();
        animatorSet.start();
    }
}
