...
public final class w40 extends org.telegram.ui.ActionBar.g3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final bj0 f29524f;
    public final v40 h;
    public boolean f29525n;
    public final yi0 f29526r;
    public final TextView[] f29527s;
    public final String v;

    public w40(Context context, String str, org.telegram.ui.bo boVar, org.telegram.ui.ActionBar.f6 f6Var) {
        super(1, context, f6Var, false);
        this.f29522b = new TextView[2];
        this.f29527s = new TextView[2];
        ...
        frameLayout2.f28598c = imageView2;
        ...
        frameLayout2.f28597b = textView3;
        ...
        for (int i13 = 0; i13 < 2; i13++) {
            this.f29522b[i13] = new TextView(context);
            this.f29522b[i13].setTextSize(1, 16.0f);
            this.f29522b[i13].setTypeface(AndroidUtilities.bold());
            this.f29522b[i13].setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f18970j5));
            frameLayout.addView(this.f29522b[i13], w7.x5.d(-2, -2.0f, 49, 17.0f, 340.0f, 17.0f, 0.0f));
            this.f29527s[i13] = new TextView(context);
            this.f29527s[i13].setTextSize(1, 14.0f);
            this.f29527s[i13].setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19118r5));
            this.f29527s[i13].setGravity(1);
            frameLayout.addView(this.f29527s[i13], w7.x5.d(-2, -2.0f, 49, 30.0f, 368.0f, 30.0f, 44.0f));
            if (i13 == 0) {
                this.f29527s[i13].setText(LocaleController.getString(R.string.ImportImportingInfo));
            } else {
                this.f29527s[i13].setAlpha(0.0f);
                this.f29527s[i13].setTranslationY(AndroidUtilities.dp(10.0f));
                this.f29522b[i13].setAlpha(0.0f);
                this.f29522b[i13].setTranslationY(AndroidUtilities.dp(10.0f));
            }
        }
        if (this.e != null) {
            ...
            this.f29523c.setText(String.format("%d%%", Integer.valueOf(importingHistory.uploadProgress)));
            this.d.a(importingHistory.uploadProgress / 100.0f, false);
            this.f29522b[0].setText(LocaleController.formatString("ImportCount", R.string.ImportCount, AndroidUtilities.formatFileSize(importingHistory.getUploadedCount()), AndroidUtilities.formatFileSize(importingHistory.getTotalCount())));
            this.f29527s[1].setText(LocaleController.getString(R.string.ImportDoneInfo));
            this.f29522b[1].setText(LocaleController.getString(R.string.ImportDoneTitle));
        ...
        this.f29523c.setText(String.format("%d%%", Integer.valueOf(importingStickers.uploadProgress)));
        this.d.a(importingStickers.uploadProgress / 100.0f, false);
        this.f29522b[0].setText(LocaleController.formatString("ImportCount", R.string.ImportCount, AndroidUtilities.formatFileSize(importingStickers.getUploadedCount()), AndroidUtilities.formatFileSize(importingStickers.getTotalCount())));
        this.f29527s[1].setText(LocaleController.getString(R.string.ImportStickersDoneInfo));
        this.f29522b[1].setText(LocaleController.getString(R.string.ImportStickersDoneTitle));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        m80 m80Var = this.d;
        TextView[] textViewArr = this.f29522b;
        TextView textView = this.f29523c;
        bj0 bj0Var = this.f29524f;
        if (i10 == i12) {
            if (objArr.length > 1) {
                dismiss();
                return;
            ...
            if (!this.f29525n && ((180 - bj0Var.getAnimatedDrawable().f30222a0) * 16.6d) + 3000.0d >= importingHistory.timeUntilFinish) {
            ...
            if (!this.f29525n && ((180 - bj0Var.getAnimatedDrawable().f30222a0) * 16.6d) + 3000.0d >= importingStickers.timeUntilFinish) {
                bj0Var.setAutoRepeat(false);
                this.f29525n = true;
            }
    ...
    public final void m() {
        this.f29525n = true;
        this.f29524f.setAutoRepeat(false);
        v40 v40Var = this.h;
        ...
        TextView[] textViewArr = this.f29527s;
        ...
        TextView[] textViewArr2 = this.f29522b;
        ...
        v40Var.f28596a.animate().scaleY(1.0f).setInterpolator(new OvershootInterpolator(1.02f)).setDuration(250L).start();
        v40Var.f28598c.animate().scaleY(1.0f).scaleX(1.0f).setInterpolator(new OvershootInterpolator(1.02f)).setDuration(250L).start();
        v40Var.f28598c.d();
        animatorSet.start();
    }
}
