...
public final class c91 extends ViewGroup implements d71, AudioManager.OnAudioFocusChangeListener {
    ...
    public boolean V;
    public boolean W;
    public final g71 f23015a;
    public final RadialProgressView f23016a0;
    public final u81 f23017b;
    public final ImageView f23018b0;
    public final xf0 f23019c;
    public final ImageView f23020c0;
    public final TextureView d;
    public final ImageView f23021d0;
    public final ImageView e;
    public AnimatorSet f23022e0;
    public final ViewGroup f23023f;
    public final y81 f23024f0;
    public int f23025g0;
    public Bitmap h;
    public int f23026h0;
    public final t81 f23027i0;
    public final j50 f23028j0;
    public final t81 f23029k0;
    public TextureView f23030n;
    public int f23031r;
    ...
    public static final Pattern f23001l0 = Pattern.compile("(?:youtube(?:-nocookie)?\\.com/(?:[^/\\n\\s]+/\\S+/|(?:v|e(?:mbed)?)/|\\S*?[?&]v=)|youtu\\.be/)([a-zA-Z0-9_-]{11})");
    ...
    public static final Pattern f23002n0 = Pattern.compile("(?:coub:|https?://(?:coub\\.com/(?:view|embed|coubs)/|c-cdn\\.coub\\.com/fb-player\\.swf\\?.*\\bcoub(?:ID|id)=))([\\da-z]+)");
    public static final Pattern f23003o0 = Pattern.compile("^https?://(?:www\\.)?aparat\\.com/(?:v/|video/video/embed/videohash/)([a-zA-Z0-9]+)");
    public static final Pattern f23004p0 = Pattern.compile("https?://clips\\.twitch\\.tv/(?:[^/]+/)*([^/?#&]+)");
    public static final Pattern f23005q0 = Pattern.compile("https?://(?:(?:www\\.)?twitch\\.tv/|player\\.twitch\\.tv/\\?.*?\\bchannel=)([^/#?]+)");
    public static final Pattern f23006r0 = Pattern.compile("fileList\\s*=\\s*JSON\\.parse\\('([^']+)'\\)");
    public static final Pattern f23007s0 = Pattern.compile("clipInfo\\s*=\\s*(\\{[^']+\\});");
    public static final Pattern f23008t0 = Pattern.compile("\"sts\"\\s*:\\s*(\\d+)");
    public static final Pattern f23009u0 = Pattern.compile("\"assets\":.+?\"js\":\\s*(\"[^\"]+\")");
    public static final Pattern f23010v0 = Pattern.compile("\\.sig\\|\\|([a-zA-Z0-9$]+)\\(");
    public static final Pattern f23011w0 = Pattern.compile("[\"']signature[\"']\\s*,\\s*([a-zA-Z0-9$]+)\\(");
    public static final Pattern f23012x0 = Pattern.compile("var\\s");
    public static final Pattern f23013y0 = Pattern.compile("return(?:\\s+|$)");
    public static final Pattern f23014z0 = Pattern.compile("[()]");
    ...
    public c91(Context context, boolean z10, z81 z81Var) {
        ...
        this.Q = paint;
        this.f23027i0 = new t81(this, 0);
        this.f23028j0 = new j50(this, 3);
        this.f23029k0 = new t81(this, 1);
        ...
        imageView2.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        c91 c91Var = this.f27797b;
                        if (c91Var.f23033w && !c91Var.S && !c91Var.W && c91Var.M) {
                            c91Var.T = !c91Var.T;
                            c91Var.l(true);
                            return;
                        }
                        return;
                    case 1:
                        c91 c91Var2 = this.f27797b;
                        g71 g71Var2 = c91Var2.f23015a;
                        if (c91Var2.f23033w && c91Var2.f23034x != null) {
                            if (g71Var2.d == null) {
                                c91Var2.i();
                            }
                            if (g71Var2.y()) {
                        ...
                        return;
                    default:
                        c91 c91Var3 = this.f27797b;
                        ViewGroup viewGroup = c91Var3.f23023f;
                        boolean z11 = c91Var3.I;
                        z81 z81Var2 = c91Var3.v;
                        y81 y81Var2 = c91Var3.f23024f0;
                        xf0 xf0Var2 = c91Var3.f23019c;
                        TextureView textureView2 = c91Var3.d;
                        if (textureView2 != null && z81Var2.h() && !c91Var3.S && !c91Var3.W && c91Var3.M) {
                            c91Var3.W = true;
                            if (!c91Var3.U) {
                                c91Var3.T = false;
                                z81Var2.i(true, c91Var3.f23029k0, xf0Var2.getAspectRatio(), z11);
                                return;
                            }
    ...
    public static String d(String str) {
        ...
        if (!TextUtils.isEmpty(str)) {
            try {
                Matcher matcher = f23002n0.matcher(str);
                if (matcher.find()) {
    ...
    public static String e(String str) {
        ...
        Matcher matcher = f23001l0.matcher(str);
        if (!matcher.find()) {
            return null;
        }
    ...
    private View getControlView() {
        return this.f23024f0;
    }

    private View getProgressView() {
        return this.f23016a0;
    }
    ...
    public final void i() {
        String str = this.f23034x;
        if (str != null) {
            String str2 = this.E;
            g71 g71Var = this.f23015a;
            if (str2 != null) {
                g71Var.G(Uri.parse(str), this.f23035y, Uri.parse(this.E), this.F);
            } else {
                g71Var.D(Uri.parse(str), this.f23035y);
            }
            g71Var.P(this.f23032s);
            long p5 = g71Var.p();
            y81 y81Var = this.f23024f0;
    ...
    public final void j(boolean z10, boolean z11) {
        float f7 = 0.0f;
        RadialProgressView radialProgressView = this.f23016a0;
        if (z11) {
            AnimatorSet animatorSet = this.f23022e0;
            if (animatorSet != null) {
                animatorSet.cancel();
            }
            AnimatorSet animatorSet2 = new AnimatorSet();
            this.f23022e0 = animatorSet2;
            if (z10) {
                f7 = 1.0f;
            }
            animatorSet2.playTogether(ObjectAnimator.ofFloat(radialProgressView, "alpha", f7));
            this.f23022e0.setDuration(150L);
            this.f23022e0.addListener(new v81(this, 0));
            this.f23022e0.start();
            return;
        }
        if (z10) {
    ...
    public final void k() {
        i2.e0 e0Var = this.f23015a.d;
        ImageView imageView = this.f23018b0;
    ...
    public final void l(boolean z10) {
        ...
        k();
        ViewGroup viewGroup2 = this.f23023f;
        xf0 xf0Var = this.f23019c;
        if (viewGroup2 == null) {
            this.S = true;
            if (!this.T) {
                if (viewGroup2 != null) {
            ...
            TextureView a2 = this.v.a(this.f23024f0, this.T, xf0Var.getAspectRatio(), xf0Var.getVideoRotation(), z10);
            this.f23030n = a2;
            a2.setVisibility(4);
            if (this.T && this.f23030n != null && (viewGroup = (ViewGroup) textureView.getParent()) != null) {
        ...
        this.v.a(this.f23024f0, this.T, xf0Var.getAspectRatio(), xf0Var.getVideoRotation(), z10);
    }

    public final void m() {
        int i10;
        int i11;
        ImageView imageView = this.f23021d0;
        if (imageView == null) {
            return;
        }
        if (this.U) {
    ...
    public final void n() {
        ...
        int i13 = y81.I;
        y81Var.a();
        AndroidUtilities.cancelRunOnUIThread(this.f23027i0);
        if (!this.f23015a.y()) {
            if (this.V) {
                ImageView imageView = this.f23020c0;
                if (this.U) {
            ...
            ImageView imageView2 = this.f23020c0;
            if (this.U) {
        ...
        ImageView imageView3 = this.f23020c0;
        if (this.U) {
        ...
        AndroidUtilities.runOnUIThread(this.f23027i0, 500L);
        if (!this.J) {
            this.J = true;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        y81Var.f30177a.setImageCoords(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight() - AndroidUtilities.dp(10.0f));
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f23019c.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(size2 - AndroidUtilities.dp(10.0f), 1073741824));
        y81 y81Var = this.f23024f0;
        if (y81Var.getParent() == this) {
            y81Var.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(size2, 1073741824));
        }
        this.f23016a0.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(44.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(44.0f), 1073741824));
    ...
    public final boolean onSurfaceDestroyed(SurfaceTexture surfaceTexture) {
        if (this.S) {
            ...
            if (this.T || this.U) {
                ...
                this.f23030n.setSurfaceTexture(surfaceTexture);
                this.f23030n.setSurfaceTextureListener(this.f23028j0);
                this.f23030n.setVisibility(0);
                return true;
            }
        }
        return false;
    ...
    public final void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        if (this.f23031r == 2) {
            ...
            this.W = false;
            int i10 = this.f23025g0;
            int i11 = this.f23026h0;
            this.f23019c.getVideoRotation();
            this.v.f(this.f23024f0, false, i10, i11, this.I);
            this.f23031r = 0;
        }
    }
