...
public final class sf0 extends View {
    ...
    public float H;
    public jc0 I;
    public TextPaint f28260a;
    public TextPaint f28261b;
    public StaticLayout f28262c;
    public float d;
    public float e;
    public StaticLayout f28263f;
    public float h;
    ...
    public boolean v;
    public uf0 f28267w;
    public ci.ha f28268x;
    public boolean f28269y;

    @Override
    public final void onDraw(Canvas canvas) {
        float e = this.f28266s.e(this.f28265r);
        if (e > 0.0f && this.f28262c != null && this.f28263f != null) {
            ...
            this.f28262c.draw(canvas);
            canvas.restore();
            canvas.save();
            canvas.translate(((getWidth() - this.h) / 2.0f) - this.f28264n, (getHeight() * 0.22f) + AndroidUtilities.dp(60.0f));
            this.f28263f.draw(canvas);
            canvas.restore();
            canvas.restore();
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f28262c == null) {
            ...
            this.f28262c = staticLayout;
            if (staticLayout.getLineCount() > 0) {
                f7 = this.f28262c.getLineWidth(0);
            } else {
                f7 = 0.0f;
            }
            this.d = f7;
            if (this.f28262c.getLineCount() > 0) {
                f10 = this.f28262c.getLineLeft(0);
            }
            this.e = f10;
        }
    }
