...
public final class tn0 extends ss {
    public final org.telegram.ui.uy f30667d0;
    public final org.telegram.ui.ey f30668e0;
    ...
    public final void N(boolean z10) {
        ...
        super.N(z10);
        ln0 ln0Var = this.f30668e0.f32956g0;
        ...
        ln0Var.e(z11, z10);
        if (TextUtils.isEmpty(this.f30407b0)) {
            ln0Var.d.setText(LocaleController.getString(R.string.NoChannelsTitle));
            ln0Var.f32756e.setVisibility(0);
            ln0Var.f32756e.setText(LocaleController.getString(R.string.NoChannelsMessage));
            return;
        }
