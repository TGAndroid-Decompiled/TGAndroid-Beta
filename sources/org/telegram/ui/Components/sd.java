...
public final class sd implements Runnable {
    ...
    public final ChatActivityEnterView f30254b;

    public sd(ChatActivityEnterView chatActivityEnterView, int i10) {
        this.f30253a = i10;
        this.f30254b = chatActivityEnterView;
    }
    ...
    public final void run() {
        ...
        boolean z10 = true;
        ChatActivityEnterView chatActivityEnterView = this.f30254b;
        switch (i10) {
            case 0:
            ...
            case 5:
                ...
                if (AndroidUtilities.isTablet()) {
                    ...
                    if (activity instanceof LaunchActivity) {
                        ActionBarLayout actionBarLayout = ((LaunchActivity) activity).f33456r0;
                ...
                if (!chatActivityEnterView.f23717i2 && z10 && (qfVar = chatActivityEnterView.E0) != null) {
                    try {
                        qfVar.requestFocus();
                        return;
                    } catch (Exception e7) {
            ...
            case 18:
                ...
                return;
            case 19:
                int i14 = ChatActivityEnterView.f23662m5;
                ChatActivityEnterView chatActivityEnterView2 = this.f30254b;
            ...
            case 21:
                ...
                return;
            case 22:
                chatActivityEnterView.f23729k3 = false;
                chatActivityEnterView.I0();
                return;
            case 23:
                int i15 = ChatActivityEnterView.f23662m5;
            ...
            case 28:
                ...
                String str = chatActivityEnterView.f23715i0;
                String str2 = chatActivityEnterView.f23721j0;
                ...
                if (launchActivity != null && launchActivity.P() != null && LaunchActivity.G1.P().k(b10) != null) {
                    fi.c0 c0Var2 = chatActivityEnterView.f23732l0;
                    if (c0Var2 != null) {
                        c0Var2.setOpened(false);
                        return;
                    }
                    return;
                } else if (org.telegram.ui.fc0.l(chatActivityEnterView.f23721j0)) {
                    ?? obj = new Object();
                    obj.f17005c = new sd(chatActivityEnterView, 1);
                    of.f.k(chatActivityEnterView.getContext(), chatActivityEnterView.f23721j0, false, false, obj);
                    return;
                } else {
                    ...
                    k3Var.s(coVar5, b10);
                    k3Var.show();
                    fi.c0 c0Var3 = chatActivityEnterView.f23732l0;
                    if (c0Var3 != null) {
            ...
            default:
                if (chatActivityEnterView.f23732l0 != null && !SharedPrefsHelper.isWebViewConfirmShown(chatActivityEnterView.Q, chatActivityEnterView.P2)) {
                    chatActivityEnterView.f23732l0.setOpened(false);
                    return;
                }
                return;
        }
