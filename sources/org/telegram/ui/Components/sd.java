...
public final class sd implements View.OnClickListener {
    ...
    public final ChatActivityEnterView f27827b;

    public sd(ChatActivityEnterView chatActivityEnterView, int i10) {
        this.f27826a = i10;
        this.f27827b = chatActivityEnterView;
    }
    ...
    public final void onClick(View view) {
        ...
        int i14;
        int i15;
        int i16 = this.f27826a;
        ChatActivityEnterView chatActivityEnterView = this.f27827b;
        switch (i16) {
            case 0:
            ...
            case 1:
                ...
                if (kfVar == null || kfVar.f32193q0) {
                    AnimatorSet animatorSet = chatActivityEnterView.f21835s2;
                    if ((animatorSet == null || !animatorSet.isRunning()) && chatActivityEnterView.f21761f0 == null) {
            ...
            case 2:
                ...
                return;
            case 3:
                int i17 = ChatActivityEnterView.f21727n5;
                if (chatActivityEnterView.a2 != null) {
                    if (chatActivityEnterView.f21742c0 - chatActivityEnterView.f21748d0 < 0) {
                        NumberTextView numberTextView = chatActivityEnterView.f21735b0;
                        if (numberTextView != null) {
                            AndroidUtilities.shakeViewSpring(numberTextView, 3.5f);
                            try {
                                chatActivityEnterView.f21735b0.performHapticFeedback(3, 2);
                                return;
                    ...
                    chatActivityEnterView.f21737b2 = y3;
                    hg.a0 d = hg.a0.d(chatActivityEnterView.Q);
                    String str2 = chatActivityEnterView.a2.link;
                    String str3 = y3.f25009a;
                    ArrayList<TLRPC.MessageEntity> arrayList = y3.f25010b;
            ...
            case 5:
                if (chatActivityEnterView.S0.getVisibility() == 0 && chatActivityEnterView.S0.getAlpha() == 1.0f && !chatActivityEnterView.j3) {
                    if (!chatActivityEnterView.f21868y2 || (ofVar = chatActivityEnterView.E0) == null || !ofVar.isFocused()) {
                        if (chatActivityEnterView.y3) {
                            if (chatActivityEnterView.Q1 != 0) {
                                ...
                                if (chatActivityEnterView.f21863x3) {
                ...
                return;
            case 6:
                AnimatorSet animatorSet2 = chatActivityEnterView.f21835s2;
                if (animatorSet2 == null || !animatorSet2.isRunning()) {
                    gk0 gk0Var = chatActivityEnterView.f21774h1;
                    if (gk0Var != null) {
                        gk0Var.setPlaying(false);
                    }
                    if (chatActivityEnterView.f21751d3 != null) {
                        ...
                        if (playingMessageObject != null && playingMessageObject == chatActivityEnterView.f21745c3) {
                            MediaController.getInstance().cleanupPlayer(true, true);
                        }
                    }
                    if (chatActivityEnterView.f21738b3 != null) {
                        if (BuildVars.LOGS_ENABLED) {
                            com.google.android.gms.internal.vision.e2.t(chatActivityEnterView.f21738b3, new StringBuilder("delete file "));
                        }
                        new File(chatActivityEnterView.f21738b3).delete();
                    }
                    ...
                    chatActivityEnterView.f21780i1 = 0L;
            ...
            case 7:
                ...
                if (chatActivityEnterView.k0()) {
                    ...
                    if (chatActivityEnterView.m0 == null) {
                        ...
                        ai.w0 w0Var = lfVar.f8737c;
                        chatActivityEnterView.getContext();
                        w0Var.setLayoutManager(new s4.c0());
                        ai.w0 w0Var2 = chatActivityEnterView.m0.f8737c;
                        ?? h0Var = new s4.h0();
                        h0Var.f8239c = new ArrayList();
                        h0Var.d = new ArrayList();
                        h0Var.e = new ArrayList();
                        chatActivityEnterView.f21806n0 = h0Var;
                        w0Var2.setAdapter(h0Var);
                        chatActivityEnterView.m0.f8737c.setOnItemClickListener(new nf(chatActivityEnterView));
                        chatActivityEnterView.m0.f8737c.setOnItemLongClickListener(new pe(chatActivityEnterView));
                        ...
                        if (iVar != null) {
                            chatActivityEnterView.f21806n0.E(iVar);
                        }
            ...
            case 8:
                ...
                if (mgVar4 != null && !mgVar4.m()) {
                    ...
                    mgVar5.t1(ugVar, ugVar.f28391a.getText(), true);
                    return;
                }
                return;
            case 9:
                ...
                if (BirthdayController.isToday(boVar2.f32239a8)) {
                ...
                if ((chatActivityEnterView.getParentFragment().f32239a8 == null || !chatActivityEnterView.getParentFragment().f32239a8.display_gifts_button) && (userFull == null || !userFull.display_gifts_button)) {
                ...
                if (i18 != null) {
                    if (chatActivityEnterView.getParentFragment().f32239a8 != null && BirthdayController.isToday(chatActivityEnterView.getParentFragment().f32239a8.birthday)) {
                        z11 = true;
                    } else {
                        z11 = false;
                    }
                ...
                return;
            case 10:
                int i19 = ChatActivityEnterView.f21727n5;
            ...
            case 11:
                ...
                return;
            case 12:
                ChatActivityEnterView chatActivityEnterView2 = this.f27827b;
                ...
                return;
            case 13:
                ChatActivityEnterView chatActivityEnterView3 = this.f27827b;
            ...
            case 14:
                ...
                if (p1Var == null || !p1Var.f19480f) {
                    if (chatActivityEnterView.A0) {
                        chatActivityEnterView.v1();
                        return;
                    } else if (chatActivityEnterView.u0() && chatActivityEnterView.f21756e2 == 0) {
                        if (chatActivityEnterView.Q1 != 0) {
                            z15 = false;
                            chatActivityEnterView.n1(0, true);
                        ...
                        if (chatActivityEnterView.y3) {
                            ...
                            chatActivityEnterView.f21793k3 = true;
            ...
            case 15:
                ...
                if (chatActivityEnterView.f21801m2 != null) {
                    if (chatActivityEnterView.u0()) {
                        r92 = 1;
                        if (chatActivityEnterView.f21756e2 == 1) {
                            if (chatActivityEnterView.u0() && chatActivityEnterView.f21756e2 == 1) {
                ...
                } else if (chatActivityEnterView.f21813o2) {
                    chatActivityEnterView.setFieldText("/");
                ...
                return;
            case 16:
                ChatActivityEnterView chatActivityEnterView4 = this.f27827b;
                org.telegram.ui.bo boVar4 = chatActivityEnterView4.O2;
                if (!chatActivityEnterView4.f21799l5 ? chatActivityEnterView4.getTranslationY() != 0.0f : chatActivityEnterView4.u0()) {
                    chatActivityEnterView4.f21827r0 = new ge(chatActivityEnterView4, 3);
                    if (chatActivityEnterView4.f21799l5) {
                ...
                if (chatActivityEnterView4.Y2.q() > AndroidUtilities.dp(20.0f)) {
                    ...
                    if (b12 < AndroidUtilities.dp(200.0f)) {
                        chatActivityEnterView4.f21843u0 = new ge(chatActivityEnterView4, 4);
                ...
                if (chatActivityEnterView4.Y2.J() != null) {
                    ...
                    cf cfVar = chatActivityEnterView4.f21821q0;
                    if (cfVar != null) {
                        cfVar.e = false;
                        cfVar.l(new o1.k[0]);
                        return;
                    ...
                    chatActivityEnterView4.f21821q0 = cfVar2;
                    cfVar2.e = true;
                    cfVar2.f19417c = 220;
                    cfVar2.setOutsideTouchable(true);
                    chatActivityEnterView4.f21821q0.setClippingEnabled(true);
                    chatActivityEnterView4.f21821q0.setFocusable(true);
                    chatActivityEnterView4.f21821q0.getContentView().measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(1000.0f), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(1000.0f), Integer.MIN_VALUE));
                    chatActivityEnterView4.f21821q0.setInputMethodMode(2);
                    chatActivityEnterView4.f21821q0.setSoftInputMode(0);
                    chatActivityEnterView4.f21821q0.getContentView().setFocusableInTouchMode(true);
                    chatActivityEnterView4.f21821q0.f19416b = false;
                    ...
                    int measuredHeight = chatActivityEnterView4.f21821q0.getContentView().getMeasuredHeight();
                    ...
                    if (measuredHeight < (i21 - i12) - chatActivityEnterView4.f21821q0.f28848p.getMeasuredHeight()) {
                        ...
                        chatActivityEnterView4.f21821q0.f28847o.getLayoutParams().height = ((b13 - i13) - AndroidUtilities.dp(14.0f)) - chatActivityEnterView4.getHeightWithTopView();
                        i14 = i13;
                    }
                    cf cfVar3 = chatActivityEnterView4.f21821q0;
                    View view2 = cfVar3.f28853u;
                    ll0 ll0Var = cfVar3.v;
                    TLRPC.Peer peer5 = cfVar3.f28850r;
                    po0 po0Var = cfVar3.f28847o;
                    ai.f0 f0Var = cfVar3.f28852t;
                    ArrayList arrayList2 = cfVar3.f28857z;
                    ...
                    ArrayList<TLRPC.TL_sendAsPeer> arrayList3 = cfVar3.f28851s.peers;
                    if (peer5 != null) {
                        ...
                        while (i23 < arrayList3.size()) {
                            ...
                            cfVar3.f28854w.h1(i23, (size2 - ((arrayList4.size() - 2) * dp)) + AndroidUtilities.dp(7.0f) + i15);
                    ...
                    kVar.f15349u = org.telegram.ui.Cells.q3.l(1.0f, 750.0f, 1.0f);
                    kVar.b(new mo0(cfVar3, 2));
                    o1.k kVar2 = new o1.k(f0Var, o1.h.f15334p);
                    kVar2.f15349u = org.telegram.ui.Cells.q3.l(1.0f, 750.0f, 1.0f);
                    kVar2.b(new mo0(cfVar3, 3));
                    o1.c cVar = o1.h.f15338t;
                    o1.k kVar3 = new o1.k(f0Var, cVar);
                    kVar3.f15349u = org.telegram.ui.Cells.q3.l(1.0f, 750.0f, 1.0f);
                    o1.k kVar4 = new o1.k(po0Var, cVar);
                    kVar4.f15349u = org.telegram.ui.Cells.q3.l(1.0f, 750.0f, 1.0f);
                    for (o1.k kVar5 : Arrays.asList(kVar, kVar2, kVar3, kVar4)) {
                        arrayList2.add(kVar5);
                        kVar5.a(new no0(cfVar3, kVar5, 1));
                        kVar5.f();
                    }
                    cf cfVar4 = chatActivityEnterView4.f21821q0;
                    chatActivityEnterView4.f21833s0 = i11;
                    chatActivityEnterView4.f21838t0 = i14;
                    cfVar4.showAtLocation(view, 51, i11, i14);
                    chatActivityEnterView4.f21816p0.setProgress(1.0f);
                    return;
                }
                return;
            case 17:
                int i24 = ChatActivityEnterView.f21727n5;
                chatActivityEnterView.e0();
                return;
            case 18:
                org.telegram.ui.ActionBar.p1 p1Var2 = chatActivityEnterView.U;
                if ((p1Var2 == null || !p1Var2.f19480f) && chatActivityEnterView.F != 0.0f) {
            ...
            case 19:
                ...
                if ((p1Var3 == null || !p1Var3.f19480f) && chatActivityEnterView.F != 0.0f) {
                    chatActivityEnterView.Y2.q1();
                    return;
                }
                return;
            default:
                int i25 = ChatActivityEnterView.f21727n5;
                chatActivityEnterView.K0();
                return;
        }
    }
