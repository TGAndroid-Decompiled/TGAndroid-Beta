...
public class GuardBotReplaceSheet extends BottomSheetWithRecyclerListView {
    ...
    private GuardBotReplaceSheet(Context context, Theme.ResourcesProvider resourcesProvider, int i, TLObject tLObject, TLObject tLObject2, Runnable runnable) {
        ...
        buttonWithCounterView.setOnClickListener(new UndoView$$ExternalSyntheticLambda6(1, this, runnable));
        ...
        buttonWithCounterView2.setOnClickListener(new HintView$$ExternalSyntheticLambda0(this, 27));
    ...
    public RecyclerListView.SelectionAdapter createAdapter(RecyclerListView recyclerListView) {
        UniversalAdapter universalAdapter = new UniversalAdapter(this.recyclerListView, getContext(), this.currentAccount, 0, true, new EmojiView$$ExternalSyntheticLambda18(this, 14), this.resourcesProvider);
