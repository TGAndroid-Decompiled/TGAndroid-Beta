...
public abstract class ux extends rl0 {
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (z4 || z10 || z11) {
            ...
            if (this.f29316b3 == null) {
                this.f29316b3 = new SparseArray();
            }
            ...
            if (z4) {
                if (E != null) {
                    ...
                    obj.f29040a = x10;
                    obj.f29041b = y10;
                    obj.f29042c = SystemClock.elapsedRealtime();
                    obj.d = E;
                    if (E.getBackground() instanceof RippleDrawable) {
                        E.getBackground().setState(new int[]{16842919, 16842910});
                    }
                    obj.d.setPressed(true);
                    this.f29316b3.put(pointerId, obj);
                    B0();
                }
            } else {
                tx txVar = (tx) this.f29316b3.get(pointerId);
                this.f29316b3.remove(pointerId);
                if (E != null && txVar != null) {
                    if (Math.sqrt(Math.pow(y10 - txVar.f29041b, 2.0d) + Math.pow(x10 - txVar.f29040a, 2.0d)) < AndroidUtilities.touchSlop * 3.0f && !z11) {
                        kz kzVar = this.c3;
                        if (!kzVar.f26501y1.isShowing() || SystemClock.elapsedRealtime() - txVar.f29042c < ViewConfiguration.getLongPressTimeout()) {
                            View view = txVar.d;
        ...
        if (!super.dispatchTouchEvent(motionEvent) && (z11 || this.f29316b3.size() <= 0)) {
            return false;
        }
        return true;
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        boolean r10 = org.telegram.ui.rt.q().r(motionEvent, this, this.c3.f26434d2, this.f28511m2);
        ...
        if (kzVar.O1 != null && quVar != null) {
            if (motionEvent.getAction() != 1 && motionEvent.getAction() != 3) {
                if (motionEvent.getAction() == 2) {
                    ...
                    quVar.f28270c.getLocationOnScreen(iArr);
                ...
                if (quVar != null && quVar.isShowing() && !quVar.d) {
                    quVar.dismiss();
                    int i10 = quVar.f28270c.f28005n[0];
                    if (i10 >= 1 && i10 <= 5) {
                    ...
                    if (!kzVar.O1.f28833c) {
                        ...
                        kzVar.O1.a(Emoji.getEmojiBigDrawable(str2), kzVar.O1.f28833c);
    ...
    public final void v1(View view) {
        if (this.f29316b3 != null) {
            int i10 = 0;
            while (i10 < this.f29316b3.size()) {
                tx txVar = (tx) this.f29316b3.valueAt(i10);
                if (txVar.d == view) {
                    this.f29316b3.removeAt(i10);
                    i10--;
                    View view2 = txVar.d;
