...
public final class wg0 extends sl0 {
    public final Context f29983r;
    public final ah0 f29984s;

    public wg0(ah0 ah0Var, Context context) {
        this.f29984s = ah0Var;
        this.f29983r = context;
    }
    ...
    public final int M(int i10) {
        ...
        zg0 zg0Var = (zg0) this.f29984s.f22696x.get(i10 - 1);
        int b10 = zg0Var.b() + 1;
        if (TextUtils.isEmpty(zg0Var.f30872c) && !zg0Var.e) {
            i11 = 0;
        }
        return b10 + i11;
    }
    ...
    public final Object O(int i10, int i11) {
        ...
        if (i13 >= 0) {
            ah0 ah0Var = this.f29984s;
            if (i13 < ah0Var.f22696x.size() && (i12 = i11 - 1) < ((zg0) ah0Var.f22696x.get(i13)).b()) {
                return Integer.valueOf(Objects.hash(Long.valueOf(DialogObject.getPeerDialogId(((TLRPC.MessagePeerVote) ((zg0) ah0Var.f22696x.get(i13)).f30871b.get(i12)).peer))));
            }
        }
        return -182734;
    }
    ...
    public final int P(int i10, int i11) {
        ...
        if (i11 - 1 < ((zg0) this.f29984s.f22696x.get(i10 - 1)).b()) {
            return 0;
        }
        return 3;
    }
    ...
    @Override
    public final int R() {
        return this.f29984s.f22696x.size() + 1;
    }
    ...
    public final View T(int i10, View view) {
        ...
        ah0 ah0Var = this.f29984s;
        TLRPC.Poll poll = ah0Var.f22693r;
        MessageObject messageObject = ah0Var.f22692n;
        if (view == null) {
            view = new vg0(this, this.f29983r);
        }
        yg0 yg0Var = (yg0) view;
        if (i10 == 0) {
        ...
        view.setAlpha(1.0f);
        zg0 zg0Var = (zg0) ah0Var.f22696x.get(i10 - 1);
        int size = poll.answers.size();
        int i11 = 0;
        for (int i12 = 0; i12 < size; i12++) {
            TLRPC.PollAnswer pollAnswer = poll.answers.get(i12);
            if (Arrays.equals(pollAnswer.option, zg0Var.d) && ((xg0) ah0Var.f22695w.get(zg0Var)) != null) {
                ...
                yg0Var.a(str2, arrayList, ah0Var.P(zg0Var.d), zg0Var.f30870a, zg0Var.a(), false);
    ...
    public final boolean V(int i10, int i11, s4.c1 c1Var) {
        if (i10 != 0 && i11 != 0) {
            ArrayList arrayList = this.f29984s.F;
    ...
    public final void W(int i10, int i11, s4.c1 c1Var) {
        ...
        if (i12 != 2) {
            if (i12 == 3) {
                ...
                ((org.telegram.ui.Cells.r8) view).m(R.drawable.arrow_more, LocaleController.formatPluralString("ShowVotes", zg0Var.f30870a - zg0Var.b(), new Object[0]), false);
                return;
            }
            return;
        }
        ...
        ArrayList arrayList3 = zg0Var2.f30871b;
        byte[] bArr = zg0Var2.d;
        ...
        for (int i14 = 0; i14 < size; i14++) {
            ...
            if (Arrays.equals(pollAnswer.option, bArr) && ((xg0) ah0Var.f22695w.get(zg0Var2)) != null) {
                TLRPC.TL_textWithEntities tL_textWithEntities = pollAnswer.text;
                if (messageObject != null && messageObject.translated && (message = messageObject.messageOwner) != null && message.translatedPoll != null) {
                    while (true) {
                ...
                yg0Var.a(str2, arrayList, ah0Var.P(bArr), zg0Var2.f30870a, zg0Var2.a(), false);
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        ah0 ah0Var = this.f29984s;
        View view = ah0Var.f22697y;
        Context context = this.f29983r;
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 != 2) {
                    org.telegram.ui.Cells.r8 r8Var2 = new org.telegram.ui.Cells.r8(23, context, true);
                    r8Var2.setOffsetFromImage(65);
                    r8Var2.setBackgroundColor(ah0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19129h5));
    ...
    public final void y(s4.c1 c1Var) {
        ...
        if (c1Var.f42963f == 0) {
            ...
            ah0 ah0Var = this.f29984s;
            zg0 zg0Var = (zg0) ah0Var.f22696x.get(S - 1);
            TLRPC.MessagePeerVote messagePeerVote = (TLRPC.MessagePeerVote) zg0Var.f30871b.get(Q);
            TLObject userOrChat = ah0Var.Q().getUserOrChat(DialogObject.getPeerDialogId(messagePeerVote.peer));
            int i10 = messagePeerVote.date;
            boolean z12 = true;
            if (Q == zg0Var.b() - 1 && TextUtils.isEmpty(zg0Var.f30872c) && !zg0Var.e) {
                z10 = false;
            } else {
                z10 = true;
            }
            ...
            if (userOrChat == null) {
                ...
                vw0 vw0Var = pollVotesAlert$UserCell.f22315f;
