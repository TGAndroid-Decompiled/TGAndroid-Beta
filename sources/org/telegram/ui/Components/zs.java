...
public abstract class zs extends j61 {
    ...
    public int Z;
    public int f29801a0;
    public String f29802b0;
    public final dq f29803c0;
    ...
    public zs(vl0 vl0Var, Context context, int i10, int i11) {
        ...
        co0 co0Var = (co0) this;
        this.f29803c0 = new dq(co0Var, 6);
        this.f24251s = new e(co0Var, 9);
        this.N = i10;
        this.O = i11;
        N(false);
    }
    ...
    public final void V(boolean r9) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.zs.V(boolean):void");
    }
