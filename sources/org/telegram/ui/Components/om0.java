...
public final class om0 implements Runnable {
    public final int f26859a = 1;
    public final vm0 f26860b;
    ...
    public final void run() {
        switch (this.f26859a) {
            case 0:
                ...
                break;
            default:
                vm0 vm0Var2 = this.f26860b;
                yw0 yw0Var = vm0Var2.f28829a;
                if (this.f26861c.equals(vm0Var2.L)) {
                    if (vm0Var2.f28834r == 0) {
                        vm0Var2.N.b(0);
                    }
