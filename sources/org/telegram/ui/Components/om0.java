            ...
            case 0:
                ...
                while (true) {
                    ...
                    if (i11 < size) {
                        ...
                        int i12 = 0;
                        while (true) {
                            ArrayList arrayList4 = this.f29162e;
                ...
                break;
            default:
                vm0 vm0Var2 = this.f29160b;
                xw0 xw0Var = vm0Var2.f31390a;
                if (this.f29161c.equals(vm0Var2.L)) {
                    if (vm0Var2.f31396r == 0) {
                        vm0Var2.N.b(0);
                    }
                    vm0Var2.e(this.d, this.f29162e, true);
                    if (vm0Var2.f31396r == 0) {
                        xw0Var.e(false, true);
