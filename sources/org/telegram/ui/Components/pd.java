...
public final class pd implements Runnable {
    ...
    public final Object f27015r;
    public final Object f27016s;
    ...
    public final void run() {
        ...
        switch (this.f27010a) {
            case 0:
                ChatActivityEnterView.g((ChatActivityEnterView) this.f27015r, (TLRPC.Document) this.f27016s, this.f27014n, (MessageObject.SendAnimationData) this.v, this.f27012c, this.d, this.e, this.f27011b, this.h, this.f27013f);
                return;
            default:
                MediaController.PhotoEntry photoEntry = (MediaController.PhotoEntry) this.f27016s;
                ChatActivityEnterView chatActivityEnterView = ((fg) this.f27015r).f23928a;
                ...
                Object obj = this.f27011b;
                boolean z13 = obj instanceof TLRPC.Document;
                boolean z14 = this.f27012c;
                int i10 = this.d;
                int i11 = this.e;
                Long l4 = this.h;
                int i12 = i10;
                String str3 = this.f27014n;
                Object obj2 = this.v;
                if (z13) {
    ...
    public pd(ChatActivityEnterView chatActivityEnterView, TLRPC.Document document, String str, MessageObject.SendAnimationData sendAnimationData, boolean z10, int i10, int i11, Object obj, Long l4, boolean z11) {
        this.f27015r = chatActivityEnterView;
        this.f27016s = document;
        this.f27014n = str;
