...
public final class m6 implements CharSequence {
    ...
    public m6(CharSequence charSequence) {
        ...
        if (charSequence == null) {
            this.f26337a = new CharSequence[0];
            this.f26338b = 0;
            return;
        }
        this.f26338b = charSequence.length();
        int i11 = 0;
        for (int i12 = 0; i12 < this.f26338b; i12++) {
            if (charSequence.charAt(i12) == ' ') {
                i11++;
            }
        }
        this.f26337a = new CharSequence[i11 + 1];
        int i13 = 0;
        int i14 = 0;
        int i15 = 0;
        while (true) {
            int i16 = this.f26338b;
            if (i13 <= i16) {
                if (i13 == i16 || charSequence.charAt(i13) == ' ') {
                    CharSequence[] charSequenceArr = this.f26337a;
                    int i17 = i14 + 1;
                    if (i13 < this.f26338b) {
                        i10 = 1;
                    } else {
    ...
    public final int length() {
        return this.f26337a.length;
    }

    @Override
    public final CharSequence subSequence(int i10, int i11) {
        return TextUtils.concat((CharSequence[]) Arrays.copyOfRange(this.f26337a, i10, i11));
    }
    ...
    public final j$.util.stream.IntStream chars() {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            convert = IntStream.VivifiedWrapper.convert(TextUtils.concat(this.f26337a).chars());
            return convert;
        }
        return null;
    }
    ...
    public final j$.util.stream.IntStream codePoints() {
        j$.util.stream.IntStream convert;
        if (Build.VERSION.SDK_INT >= 24) {
            convert = IntStream.VivifiedWrapper.convert(TextUtils.concat(this.f26337a).codePoints());
            return convert;
        }
        return null;
    }
