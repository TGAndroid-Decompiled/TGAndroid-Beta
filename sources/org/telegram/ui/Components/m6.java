...
public class m6 extends Drawable {
    ...
    public Runnable V;
    public final TextPaint f26069a;
    public int f26070b;
    public boolean f26071c;
    public float d;
    public float e;
    public j6[] f26072f;
    public CharSequence f26073g;
    public float h;
    public float f26074i;
    public j6[] f26075j;
    public CharSequence f26076k;
    public int f26077l;
    public float f26078m;
    public boolean f26079n;
    public ValueAnimator f26080o;
    public CharSequence f26081p;
    public boolean f26082q;
    public long f26083r;
    public TimeInterpolator f26084s;
    public float f26085t;
    public float f26086u;
    public float v;
    public int f26087w;
    public final Rect f26088x;
    ...
    public final void a(float f7) {
        TextPaint textPaint = this.f26069a;
        textPaint.setAlpha((int) (this.f26087w * f7));
        if (this.O) {
    ...
    public final void b() {
        ValueAnimator valueAnimator = this.f26080o;
    ...
    public final void c() {
        if (this.f26075j != null) {
            int i10 = 0;
            while (true) {
                j6[] j6VarArr = this.f26075j;
                if (i10 >= j6VarArr.length) {
                    break;
                }
                j6 j6Var = j6VarArr[i10];
                m6 m6Var = j6Var.f25145g;
                if (m6Var.getCallback() instanceof View) {
                    x5.release((View) m6Var.getCallback(), j6Var.f25141a);
                }
                i10++;
            }
        }
    ...
    public final float d() {
        if (this.f26072f != null && this.f26075j != null) {
            return AndroidUtilities.lerp(this.h, this.d, this.f26078m);
        }
        return this.d;
    }
    ...
    public final float g() {
        float f7;
        CharSequence charSequence = this.f26076k;
        float f10 = 0.0f;
        float f11 = 1.0f;
        ...
        CharSequence charSequence2 = this.f26073g;
    ...
    public final void l(float f7, float f10, float f11, float f12) {
        ...
        this.f26088x.set(i10, i11, i12, i13);
    }
    ...
    public final void p(float f7, float f10, int i10) {
        ...
        this.Q = f10;
        this.R = i10;
        this.f26069a.setShadowLayer(f7, 0.0f, f10, i10);
    }
    ...
    public final void q(CharSequence charSequence, boolean z10, boolean z11) {
        ...
        int i11;
        boolean z16;
        if (this.f26073g != null && charSequence != null) {
            z12 = z10;
        } else {
            z12 = false;
        }
        ...
        int i12 = this.G;
        if (i12 <= 0) {
            i12 = this.f26088x.width();
        }
        boolean z17 = true;
        if (z12) {
            if (!TextUtils.equals(charSequence2, this.f26073g)) {
                if (this.D) {
                    ValueAnimator valueAnimator = this.f26080o;
                    if (valueAnimator != null) {
                        valueAnimator.cancel();
                    ...
                    this.f26081p = charSequence2;
                    this.f26082q = z11;
                    return;
                }
                this.f26076k = this.f26073g;
                this.f26073g = charSequence2;
                ...
                if (this.f26089y) {
                    charSequence3 = new l6(this.f26076k);
                } else {
                    charSequence3 = this.f26076k;
                }
                if (this.f26089y) {
                    charSequence4 = new l6(this.f26073g);
                } else {
                    charSequence4 = this.f26073g;
                }
                if (this.F) {
                    i(k6Var2, charSequence3, 0, charSequence3.length());
                    i(k6Var, charSequence4, 0, charSequence4.length());
                } else if (this.f26090z) {
                ...
                if (this.f26075j != null) {
                    ...
                    while (true) {
                        ...
                        m6 m6Var = j6Var2.f25145g;
                        if (m6Var.getCallback() instanceof View) {
                            x5.release((View) m6Var.getCallback(), j6Var2.f25141a);
                        }
                        i27++;
                    }
                }
                this.f26075j = null;
                j6[] j6VarArr2 = this.f26072f;
                if (j6VarArr2 == null || j6VarArr2.length != arrayList.size()) {
                    this.f26072f = new j6[arrayList.size()];
                }
                arrayList.toArray(this.f26072f);
                c();
                j6[] j6VarArr3 = this.f26075j;
                if (j6VarArr3 == null || j6VarArr3.length != arrayList2.size()) {
                    this.f26075j = new j6[arrayList2.size()];
                }
                arrayList2.toArray(this.f26075j);
                ValueAnimator valueAnimator2 = this.f26080o;
                if (valueAnimator2 != null) {
                    valueAnimator2.cancel();
                }
                this.f26079n = z11;
                this.f26078m = 0.0f;
                this.f26080o = ValueAnimator.ofFloat(0.0f, 1.0f);
                Runnable runnable = this.V;
                if (runnable != null) {
                    runnable.run();
                }
                this.f26080o.addUpdateListener(new i6(this, 0));
                this.f26080o.addListener(new org.telegram.ui.t4(this, 28));
                this.f26080o.setStartDelay(0L);
                this.f26080o.setDuration(this.f26083r);
                this.f26080o.setInterpolator(this.f26084s);
                this.f26080o.start();
                return;
            }
            return;
        }
        ValueAnimator valueAnimator3 = this.f26080o;
        ...
        this.f26082q = false;
        this.f26078m = 0.0f;
        if (!charSequence2.equals(this.f26073g)) {
            if (this.f26075j != null) {
                int i28 = 0;
                while (true) {
                    j6[] j6VarArr4 = this.f26075j;
                    if (i28 >= j6VarArr4.length) {
                        break;
                    }
                    j6 j6Var3 = j6VarArr4[i28];
                    m6 m6Var2 = j6Var3.f25145g;
                    if (m6Var2.getCallback() instanceof View) {
                        x5.release((View) m6Var2.getCallback(), j6Var3.f25141a);
                    }
                    i28++;
                }
            }
            ...
            this.d = this.f26072f[0].f25144f;
            this.e = j6Var.f25142b.getHeight();
            this.f26071c = AndroidUtilities.isRTL(this.f26073g);
        }
        c();
        this.f26076k = null;
    ...
    public final void r(int i10) {
        this.f26069a.setColor(i10);
        this.f26087w = Color.alpha(i10);
    }
    ...
    public final void s(int i10, boolean z10) {
        ...
        int color = this.f26069a.getColor();
    ...
    public final void setBounds(Rect rect) {
        ...
        this.f26088x.set(rect);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f26069a.setColorFilter(colorFilter);
    }
    ...
    public final void t(float f7) {
        ...
        if (Math.abs(textSize - f7) > 0.5f) {
            ...
            if (this.f26072f != null) {
                ...
                int i12 = 0;
                while (true) {
                    j6[] j6VarArr = this.f26072f;
                    if (i12 >= j6VarArr.length) {
                        break;
                    }
                    StaticLayout h = h(i10 - ((int) Math.ceil(Math.min(this.d, this.h))), j6VarArr[i12].f25142b.getText());
                    j6[] j6VarArr2 = this.f26072f;
                    j6 j6Var = j6VarArr2[i12];
                    j6VarArr2[i12] = new j6(this, h, j6Var.f25143c, j6Var.d);
                    float f10 = this.d;
                    j6 j6Var2 = this.f26072f[i12];
                    this.d = f10 + j6Var2.f25144f;
                    this.e = Math.max(this.e, j6Var2.f25142b.getHeight());
                    i12++;
                }
            }
            if (this.f26075j != null) {
                ...
                while (true) {
                    ...
                    StaticLayout h10 = h(i10 - ((int) Math.ceil(Math.min(this.d, this.h))), j6VarArr3[i11].f25142b.getText());
                    j6[] j6VarArr4 = this.f26075j;
                    j6 j6Var3 = j6VarArr4[i11];
                    j6VarArr4[i11] = new j6(this, h10, j6Var3.f25143c, j6Var3.d);
                    float f11 = this.h;
                    j6 j6Var4 = this.f26075j[i11];
                    this.h = f11 + j6Var4.f25144f;
                    this.f26074i = Math.max(this.f26074i, j6Var4.f25142b.getHeight());
                    i11++;
                }
            }
            invalidateSelf();
    ...
    public final void u(Typeface typeface) {
        this.f26069a.setTypeface(typeface);
    }

    public m6(boolean z10, boolean z11, boolean z12, boolean z13) {
        this.f26069a = new TextPaint(1);
        this.f26070b = 0;
        this.f26071c = false;
        this.f26077l = 0;
        this.f26078m = 0.0f;
