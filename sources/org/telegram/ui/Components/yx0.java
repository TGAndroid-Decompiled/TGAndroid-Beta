...
public final class yx0 extends s4.x {
    ...
    public final void p(s4.c1 c1Var, int i10) {
        fy0 fy0Var = this.f30722f;
        if (i10 == 0 && fy0Var.f24293f != null && this.e > 0) {
            ...
            tL_stickers_changeStickerPosition.sticker = MediaDataController.getInputStickerSetItem(fy0Var.f24293f, "").document;
            this.e = -1;
            fy0Var.f24293f = null;
        } else if (i10 == 2) {
            fy0Var.f24293f = ((org.telegram.ui.Cells.f8) c1Var.f42961a).getSticker();
        }
    }
