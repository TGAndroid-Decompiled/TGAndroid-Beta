...
public final class n50 extends DispatchQueue {
    ...
    public final void handleMessage(Message message) {
        ...
        if (i12 != 0) {
            ...
            if (i12 != 1) {
                if (i12 != 2) {
                    if (i12 != 3) {
                        if (i12 == 4) {
                            ...
                            float f13 = f7 + 0.5f;
                            float f14 = f10 + 0.5f;
                            w50Var2.f32161z0 = org.telegram.messenger.vl.h(ByteBuffer.allocateDirect(32));
                ...
                float f19 = f15 + 0.5f;
                float f20 = f16 + 0.5f;
                w50Var5.f32161z0 = org.telegram.messenger.vl.h(ByteBuffer.allocateDirect(32));
        ...
        if (this.f28617f) {
            if (!this.d.equals(this.f28614b.eglGetCurrentContext()) || !this.f28616e.equals(this.f28614b.eglGetCurrentSurface(12377))) {
                ...
                if (!egl102.eglMakeCurrent(eGLDisplay2, eGLSurface2, eGLSurface2, this.d)) {
                    if (BuildVars.LOGS_ENABLED) {
                        org.telegram.messenger.vl.s(this.f28614b, new StringBuilder("eglMakeCurrent failed "));
                        return;
                    }
                    return;
                }
    ...
    public final void run() {
        ...
        if (eglGetDisplay == EGL10.EGL_NO_DISPLAY) {
            if (BuildVars.LOGS_ENABLED) {
                org.telegram.messenger.vl.s(this.f28614b, new StringBuilder("InstantCamera eglGetDisplay failed "));
            }
            finish();
        } else if (!this.f28614b.eglInitialize(eglGetDisplay, new int[2])) {
            if (BuildVars.LOGS_ENABLED) {
                org.telegram.messenger.vl.s(this.f28614b, new StringBuilder("InstantCamera eglInitialize failed "));
            }
            finish();
        } else {
            int[] iArr = new int[1];
            ...
            if (!this.f28614b.eglChooseConfig(this.f28615c, new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 0, 12325, 0, 12326, 0, 12344}, eGLConfigArr, 1, iArr)) {
                if (BuildVars.LOGS_ENABLED) {
                    org.telegram.messenger.vl.s(this.f28614b, new StringBuilder("InstantCamera eglChooseConfig failed "));
                }
                finish();
            } else if (iArr[0] > 0) {
                ...
                if (eglCreateContext == null) {
                    if (BuildVars.LOGS_ENABLED) {
                        org.telegram.messenger.vl.s(this.f28614b, new StringBuilder("InstantCamera eglCreateContext failed "));
                    }
                    finish();
                } else {
                    ...
                    if (surfaceTexture != null) {
                        ...
                        if (eglCreateWindowSurface != null && eglCreateWindowSurface != EGL10.EGL_NO_SURFACE) {
                            if (!this.f28614b.eglMakeCurrent(this.f28615c, eglCreateWindowSurface, eglCreateWindowSurface, this.d)) {
                                if (BuildVars.LOGS_ENABLED) {
                                    org.telegram.messenger.vl.s(this.f28614b, new StringBuilder("InstantCamera eglMakeCurrent failed "));
                                }
                                finish();
                            } else {
                                c();
                            ...
                            if (BuildVars.LOGS_ENABLED) {
                                org.telegram.messenger.vl.s(this.f28614b, new StringBuilder("InstantCamera createWindowSurface failed "));
                            }
                            finish();
                        }
                    } else {
