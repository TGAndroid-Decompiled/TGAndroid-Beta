...
public final class n50 extends DispatchQueue {
    ...
    public final void c() {
        w50 w50Var = this.H;
        if (w50Var.f29546i0[w50Var.f29534a1] != null) {
            w50 w50Var2 = this.H;
            int width = w50Var2.f29546i0[w50Var2.f29534a1].getWidth();
            w50 w50Var3 = this.H;
            int height = w50Var3.f29546i0[w50Var3.f29534a1].getHeight();
            ...
            if (i12 != 1) {
                if (i12 != 2) {
                    if (i12 != 3) {
                        if (i12 == 4) {
                            w50 w50Var = this.H;
                            w50Var.f29534a1 = 1 - w50Var.f29534a1;
                            c();
                            w50 w50Var2 = this.H;
                            ...
                            float f13 = f7 + 0.5f;
                            float f14 = f10 + 0.5f;
                            w50Var2.f29568z0 = org.telegram.messenger.wl.h(ByteBuffer.allocateDirect(32));
                            this.H.f29568z0.put(new float[]{f11, f12, f13, f12, f11, f14, f13, f14}).position(0);
                            return;
                        }
                        return;
                    }
                    ...
                    if (obj3 == obj2) {
                        ...
                        Matrix.setIdentityM(this.H.f29561v0, 0);
                        if (i11 != 0) {
                            Matrix.rotateM(this.H.f29561v0, 0, i11, 0.0f, 0.0f, 1.0f);
                            return;
                        }
                        return;
                    }
                ...
                if (surfaceTexture != null) {
                    surfaceTexture.getTransformMatrix(this.H.f29565x0);
                    ...
                    w50Var3.V = 0.0f;
                    iArr2[0] = 0;
                    w50Var3.A0 = w50Var3.f29568z0.duplicate();
                    w50 w50Var4 = this.H;
                    w50Var4.D0 = w50Var4.f29546i0[0];
                }
                ...
                this.f26335n[0] = new SurfaceTexture(this.H.T[0]);
                ...
                float f19 = f15 + 0.5f;
                float f20 = f16 + 0.5f;
                w50Var5.f29568z0 = org.telegram.messenger.wl.h(ByteBuffer.allocateDirect(32));
                this.H.f29568z0.put(new float[]{f17, f18, f19, f18, f17, f20, f19, f20}).position(0);
                return;
            }
            finish();
            if (this.f26340y && ((!((z13 = (obj = message.obj) instanceof q50)) || ((q50) obj).f27222c != -2) && (v50Var = this.H.Y0) != null)) {
        ...
        if (this.f26334f) {
            if (!this.d.equals(this.f26332b.eglGetCurrentContext()) || !this.e.equals(this.f26332b.eglGetCurrentSurface(12377))) {
                ...
                if (!egl102.eglMakeCurrent(eGLDisplay2, eGLSurface2, eGLSurface2, this.d)) {
                    if (BuildVars.LOGS_ENABLED) {
                        org.telegram.messenger.wl.s(this.f26332b, new StringBuilder("eglMakeCurrent failed "));
                        return;
                    }
                    return;
                }
            ...
            if (!this.f26340y) {
                    ...
                    if (!w50Var7.F) {
                        ...
                        AndroidUtilities.runOnUIThread(new Runnable(this) {
                            ...
                            public final void run() {
                                switch (r2) {
                                    case 0:
                                        this.f26065b.H.m0.animate().setDuration(120L).alpha(0.0f).setInterpolator(new DecelerateInterpolator()).start();
                                        return;
                                    default:
                                        w50 w50Var8 = this.f26065b.H;
                                        if (w50Var8.f29549l0 != null) {
                                            Bitmap bitmap = w50Var8.Z0;
                                            if (bitmap != null) {
                                                bitmap.recycle();
                                                w50Var8.Z0 = null;
                                            }
                                            w50Var8.Z0 = w50Var8.f29549l0.getBitmap();
                                            return;
                                        }
                                        return;
                                }
                ...
                if (v50Var2.F0 && v50Var2.T != null && v50Var2.T.getLooper() != null && v50Var2.T.getLooper().getThread() != null && v50Var2.T.getLooper().getThread().isAlive()) {
                    v50Var2.f28629w = eglGetCurrentContext;
                    v50Var2.T.sendMessage(v50Var2.T.obtainMessage(0, 1, 0));
                }
                v50Var2.F0 = true;
                int i16 = MessagesController.getInstance(v50Var2.H0.f29532a).roundVideoSize;
                AndroidUtilities.runOnUIThread(new r50(v50Var2, 1));
                v50Var2.f28601a = i50Var;
                v50Var2.d = i16;
                v50Var2.e = i16;
                v50Var2.f28609f = MessagesController.getInstance(v50Var2.H0.f29532a).roundVideoBitrate * 1024;
                v50Var2.f28629w = eglGetCurrentContext;
            ...
            w50 w50Var10 = this.H;
            if (w50Var10.Y0 != null && ((w50Var10.f29534a1 == 0 && z10) || (this.H.f29534a1 == 1 && z11))) {
                w50 w50Var11 = this.H;
                v50 v50Var3 = w50Var11.Y0;
                SurfaceTexture surfaceTexture2 = this.f26335n[w50Var11.f29534a1];
                w50 w50Var12 = this.H;
                if (w50Var12.f29553p0) {
                    i14 = w50Var12.f29534a1;
                }
                v50Var3.f(surfaceTexture2, Integer.valueOf(i14), System.nanoTime());
            }
            this.f26335n[this.H.f29534a1].getTransformMatrix(this.H.f29563w0);
            GLES20.glUseProgram(this.f26336r);
            GLES20.glActiveTexture(33984);
            w50 w50Var13 = this.H;
            GLES20.glBindTexture(36197, w50Var13.T[w50Var13.f29534a1]);
            GLES20.glVertexAttribPointer(this.f26338w, 3, 5126, false, 12, (Buffer) this.H.f29567y0);
            GLES20.glEnableVertexAttribArray(this.f26338w);
            GLES20.glVertexAttribPointer(this.f26339x, 2, 5126, false, 8, (Buffer) this.H.f29568z0);
            GLES20.glEnableVertexAttribArray(this.f26339x);
            GLES20.glUniformMatrix4fv(this.v, 1, false, this.H.f29563w0, 0);
            GLES20.glUniformMatrix4fv(this.f26337s, 1, false, this.H.f29561v0, 0);
                    ...
                    public final void run() {
                        switch (r2) {
                            case 0:
                                ...
                                return;
                            default:
                                w50 w50Var82 = this.f26065b.H;
                                if (w50Var82.f29549l0 != null) {
                                    Bitmap bitmap = w50Var82.Z0;
                                    if (bitmap != null) {
                                        bitmap.recycle();
                                        w50Var82.Z0 = null;
                                    }
                                    w50Var82.Z0 = w50Var82.f29549l0.getBitmap();
                                    return;
                                }
                                return;
                        }
    ...
    public final void run() {
        ...
        if (eglGetDisplay == EGL10.EGL_NO_DISPLAY) {
            if (BuildVars.LOGS_ENABLED) {
                org.telegram.messenger.wl.s(this.f26332b, new StringBuilder("InstantCamera eglGetDisplay failed "));
            }
            finish();
        } else if (!this.f26332b.eglInitialize(eglGetDisplay, new int[2])) {
            if (BuildVars.LOGS_ENABLED) {
                org.telegram.messenger.wl.s(this.f26332b, new StringBuilder("InstantCamera eglInitialize failed "));
            }
            finish();
        } else {
            int[] iArr = new int[1];
            ...
            if (!this.f26332b.eglChooseConfig(this.f26333c, new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 0, 12325, 0, 12326, 0, 12344}, eGLConfigArr, 1, iArr)) {
                if (BuildVars.LOGS_ENABLED) {
                    org.telegram.messenger.wl.s(this.f26332b, new StringBuilder("InstantCamera eglChooseConfig failed "));
                }
                finish();
            } else if (iArr[0] > 0) {
                ...
                if (eglCreateContext == null) {
                    if (BuildVars.LOGS_ENABLED) {
                        org.telegram.messenger.wl.s(this.f26332b, new StringBuilder("InstantCamera eglCreateContext failed "));
                    }
                    finish();
                } else {
                    ...
                    if (surfaceTexture != null) {
                        ...
                        if (eglCreateWindowSurface != null && eglCreateWindowSurface != EGL10.EGL_NO_SURFACE) {
                            if (!this.f26332b.eglMakeCurrent(this.f26333c, eglCreateWindowSurface, eglCreateWindowSurface, this.d)) {
                                if (BuildVars.LOGS_ENABLED) {
                                    org.telegram.messenger.wl.s(this.f26332b, new StringBuilder("InstantCamera eglMakeCurrent failed "));
                                }
                                finish();
                            } else {
                                c();
                                ...
                                Matrix.setIdentityM(w50Var.f29563w0, 0);
                                ...
                                if (a2 != 0 && a10 != 0) {
                                    ...
                                    GLES20.glAttachShader(this.f26336r, a10);
                                    ...
                                    Matrix.setIdentityM(w50Var.f29561v0, 0);
                            ...
                            if (BuildVars.LOGS_ENABLED) {
                                org.telegram.messenger.wl.s(this.f26332b, new StringBuilder("InstantCamera createWindowSurface failed "));
                            }
                            finish();
                        }
                    } else {
