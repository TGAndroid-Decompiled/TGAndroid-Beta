...
public final class h10 extends URLSpan {
    ...
    public final TLRPC.TL_messageEntityFormattedDate f24524b;
    public final d11 f24525c;
    public final boolean d;

    public h10(String str, d11 d11Var, TLRPC.TL_messageEntityFormattedDate tL_messageEntityFormattedDate) {
        super(str);
        this.f24523a = str;
        this.f24524b = tL_messageEntityFormattedDate;
        this.f24525c = d11Var;
        this.d = false;
    }
    ...
    public static CharSequence a(CharSequence charSequence, boolean z10) {
        ...
        if (charSequence instanceof Spanned) {
            ...
            while (i10 < length) {
                ...
                TLRPC.TL_messageEntityFormattedDate tL_messageEntityFormattedDate = h10Var.f24524b;
                if (tL_messageEntityFormattedDate.flags != 0 && (h10Var.d != z10 || (z10 && tL_messageEntityFormattedDate.relative))) {
                    ...
                    if (z10) {
                        str = LocaleController.formatEntityFormattedDate(h10Var.f24524b);
                    } else {
                        str = h10Var.f24523a;
                    }
    ...
    public h10(h10 h10Var, boolean z10) {
        super(h10Var.f24523a);
        this.f24523a = h10Var.f24523a;
        this.f24524b = h10Var.f24524b;
        this.f24525c = h10Var.f24525c;
        this.d = z10;
    }
