...
public final class ca extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ai.f0 f23218c;
    public ai.f0 d;
    public lj0 e;
    public ScrollView f23219f;
    public AnimatorSet h;
    public TLRPC.TL_help_appUpdate f23220n;
    public String f23221r;
    public int f23222s;
    public int v;
    public GradientDrawable f23223w;
    public GradientDrawable f23224x;

    public final void a(boolean z10) {
        ai.f0 f0Var = this.d;
        TextView textView = this.f23217b;
        ai.f0 f0Var2 = this.f23218c;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.fileLoaded) {
            ...
            String str2 = this.f23221r;
            if (str2 != null && str2.equals(str)) {
                a(false);
                ApplicationLoader.applicationLoaderInstance.openApkInstall((Activity) getContext(), this.f23220n.document);
            }
        } else if (i10 == NotificationCenter.fileLoadFailed) {
            String str3 = (String) objArr[0];
            String str4 = this.f23221r;
            if (str4 != null && str4.equals(str3)) {
                a(false);
            }
        } else if (i10 == NotificationCenter.fileLoadProgressChanged) {
            String str5 = (String) objArr[0];
            String str6 = this.f23221r;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        GradientDrawable gradientDrawable = this.f23223w;
        ScrollView scrollView = this.f23219f;
        ...
        GradientDrawable gradientDrawable2 = this.f23224x;
    ...
    public void setVisibility(int i10) {
        ...
        if (i10 == 8) {
            NotificationCenter.getInstance(this.f23222s).removeObserver(this, NotificationCenter.fileLoaded);
            NotificationCenter.getInstance(this.f23222s).removeObserver(this, NotificationCenter.fileLoadFailed);
            NotificationCenter.getInstance(this.f23222s).removeObserver(this, NotificationCenter.fileLoadProgressChanged);
        }
    }
}
