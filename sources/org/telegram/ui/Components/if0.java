...
public final class if0 extends kl0 {
    ...
    public final int j(int i10) {
        jf0 jf0Var = this.d;
        if (i10 != jf0Var.f27501y && i10 != jf0Var.E) {
            return 0;
        }
        return 1;
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            frameLayout.f23326e = new androidx.activity.i((Object) frameLayout, 28);
            TextView textView = new TextView(context);
            frameLayout.f23323a = textView;
            ...
            frameLayout.f23324b = textView2;
            org.telegram.messenger.vl.n(org.telegram.ui.ActionBar.j6.f21071zf, f6Var, textView2, 1, 12.0f);
            ...
            view.f32252b = paint2;
            view.f32253c = AndroidUtilities.dp(16.0f);
            view.d = 0;
            view.f32254e = 0.0f;
            view.f32255f = false;
            paint.setColor(-11711155);
            paint2.setColor(-1);
            frameLayout.f23325c = view;
