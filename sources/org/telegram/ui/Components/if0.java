...
public final class if0 extends FrameLayout {
    ...
    public hf0 L;
    public int M;
    public PointF f25038a;
    public float f25039b;
    ...
    public RectF f25043r;
    public float f25044s;
    public float v;
    public float f25045w;
    public float f25046x;
    ...
    private PointF getActualCenterPoint() {
        ...
        float f11 = uv0Var.f28932a;
        return new PointF(width, (this.e.y * f11) + org.telegram.messenger.f0.x(f11, f10, 2.0f, A));
    }

    private float getActualInnerRadius() {
        uv0 uv0Var = this.d;
        return Math.min(uv0Var.f28932a, uv0Var.f28933b) * this.f25041f;
    }

    private float getActualOuterRadius() {
        uv0 uv0Var = this.d;
        return Math.min(uv0Var.f28932a, uv0Var.f28933b) * this.h;
    }
    ...
    public final void c(int i10, MotionEvent motionEvent) {
        ...
        uv0 uv0Var = this.d;
        float min = Math.min(uv0Var.f28932a, uv0Var.f28933b);
        float f12 = this.f25041f * min;
        float f13 = this.h * min;
        float abs = (float) Math.abs((Math.sin(a(this.f25042n) + 1.5707963267948966d) * f11) + (Math.cos(a(this.f25042n) + 1.5707963267948966d) * f10));
        float f14 = 0.0f;
        if (i10 != 1) {
            if (i10 != 2) {
            ...
            if (i14 == 0) {
                ...
                if (c10 != 1) {
                    if (c10 != 2) {
                        if (c10 != 3) {
                            if (c10 == 5) {
                                ...
                                this.f25042n = (((((float) Math.sqrt((f16 * f16) + (f15 * f15))) * ((i13 * 2) - 1)) / 3.1415927f) / 1.15f) + this.f25042n;
                                this.f25044s = x10;
                                this.v = y3;
                            }
                        } else {
                            this.h = Math.max(this.f25041f + 0.02f, (this.f25040c + (abs - this.f25039b)) / min);
                        }
                    } else {
                        this.f25041f = Math.min(Math.max(0.1f, (this.f25040c + (abs - this.f25039b)) / min), this.h - 0.02f);
                    }
                } else {
                    float f17 = x10 - this.f25044s;
                    float f18 = y3 - this.v;
                    float width = (getWidth() - uv0Var.f28932a) / 2.0f;
                    if (!z13) {
                    ...
                    float height = getHeight();
                    float f19 = uv0Var.f28933b;
                    float A = com.google.android.gms.internal.vision.e2.A(height, f19, 2.0f, i12);
                    PointF pointF = new PointF(Math.max(width, Math.min(uv0Var.f28932a + width, this.f25038a.x + f17)), Math.max(A, Math.min(f19 + A, this.f25038a.y + f18)));
                    float f20 = pointF.x - width;
                    float f21 = uv0Var.f28932a;
                    this.e = new PointF(f20 / f21, (((f21 - uv0Var.f28933b) / 2.0f) + (pointF.y - A)) / f21);
                }
            } else if (i14 == 1) {
                ...
                if (c11 != 1) {
                    if (c11 != 2) {
                        if (c11 == 3) {
                            this.h = Math.max(this.f25041f + 0.02f, (this.f25040c + (sqrt - this.f25039b)) / min);
                        }
                    } else {
                        this.f25041f = Math.min(Math.max(0.1f, (this.f25040c + (sqrt - this.f25039b)) / min), this.h - 0.02f);
                    }
                } else {
                    float f22 = x10 - this.f25044s;
                    float f23 = y3 - this.v;
                    float width2 = (getWidth() - uv0Var.f28932a) / 2.0f;
                    if (!z13) {
                    ...
                    float f24 = uv0Var.f28933b;
                    float A2 = com.google.android.gms.internal.vision.e2.A(height2, f24, 2.0f, i11);
                    PointF pointF2 = new PointF(Math.max(width2, Math.min(uv0Var.f28932a + width2, this.f25038a.x + f22)), Math.max(A2, Math.min(f24 + A2, this.f25038a.y + f23)));
                    float f25 = pointF2.x - width2;
                    float f26 = uv0Var.f28932a;
                    this.e = new PointF(f25 / f26, (((f26 - uv0Var.f28933b) / 2.0f) + (pointF2.y - A2)) / f26);
                }
            }
            invalidate();
            hf0 hf0Var = this.L;
            if (hf0Var != null) {
                ...
                float f27 = this.f25041f;
                float f28 = this.h;
                tf0 tf0Var = ((lf0) hf0Var).f26088a;
                tf0Var.f28482a0 = f28;
                tf0Var.f28484b0 = pointF3;
                tf0Var.f28486c0 = f27;
                tf0Var.f28487d0 = a(this.f25042n) + 1.5707964f;
        ...
        if (i15 == 0) {
            if (sqrt < f30) {
                this.M = 2;
                this.f25038a = actualCenterPoint;
                return;
            }
            float f31 = f12 - f29;
    ...
    public final void d(int i10, MotionEvent motionEvent) {
        if (i10 != 1) {
            ...
            this.f25045w = b(motionEvent);
            this.f25046x = 1.0f;
            this.M = 5;
        }
        float b10 = b(motionEvent);
        float e = a4.a.e(b10 - this.f25045w, AndroidUtilities.density, 0.01f, this.f25046x);
        this.f25046x = e;
        float max = Math.max(0.1f, this.f25041f * e);
        this.f25041f = max;
        this.h = Math.max(max + 0.02f, this.h * this.f25046x);
        this.f25046x = 1.0f;
        this.f25045w = b10;
        invalidate();
        hf0 hf0Var = this.L;
        if (hf0Var != null) {
            ...
            float f7 = this.f25041f;
            float f10 = this.h;
            tf0 tf0Var = ((lf0) hf0Var).f26088a;
            tf0Var.f28482a0 = f10;
            tf0Var.f28484b0 = pointF;
            tf0Var.f28486c0 = f7;
            tf0Var.f28487d0 = a(this.f25042n) + 1.5707964f;
            wz wzVar = tf0Var.f28496l0;
            if (wzVar != null) {
