...
public final class yh0 extends Button {
    public final RectF f30251a;
    public final Paint f30252b;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Paint paint = this.f30252b;
        paint.setAlpha(min);
        canvas.drawArc(rectF, this.f30254f, 220.0f, false, paint);
        long currentTimeMillis = System.currentTimeMillis();
        if (Math.abs(this.e - System.currentTimeMillis()) < 1000) {
            long j3 = currentTimeMillis - this.e;
            int i10 = (int) (this.f30254f + (((float) (360 * j3)) / 2000.0f));
            this.f30254f = i10 - ((i10 / 360) * 360);
            if (this.f30253c) {
                float f7 = this.d;
                if (f7 < 1.0f) {
