...
public class yh0 extends wp implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final ArrayList f30535a1;
    public final ArrayList f30536b1;
    public int f30537c1;
    public final SparseArray f30538d1;
    public boolean f30539e1;
    public boolean f30540f1;
    public boolean f30541g1;
    public org.telegram.ui.pv0 f30542h1;
    public boolean f30543i1;
    public int f30544j1;
    public int f30545k1;
    public int l1;
    public int f30546m1;
    ...
    public int f30548o1;
    public ph0 f30549p1;
    public ImageLocation f30550q1;
    public ImageLocation f30551r1;
    public final PointF f30552x0;
    public final int f30553y0;
    public final org.telegram.ui.ActionBar.k f30554z0;

    public yh0(Context context, org.telegram.ui.ActionBar.k kVar, vl0 vl0Var, org.telegram.ui.q4 q4Var) {
        super(context);
        this.f30552x0 = new PointF();
        this.A0 = true;
        this.B0 = true;
        ...
        this.f30535a1 = new ArrayList();
        this.f30536b1 = new ArrayList();
        this.f30538d1 = new SparseArray();
        this.f30539e1 = true;
        this.f30544j1 = -1;
        this.f30545k1 = -1;
        ...
        this.f30554z0 = kVar;
        this.f30553y0 = ViewConfiguration.get(context).getScaledTouchSlop();
        this.G0 = q4Var;
        b(new qh0(this));
    ...
    public final void A(ImageLocation imageLocation, ImageLocation imageLocation2) {
        ...
        this.W0.add(0, null);
        this.V0.add(0, null);
        this.f30535a1.add(0, -1);
        this.f30536b1.add(0, Float.valueOf(0.0f));
        this.D0.g();
        L();
        this.f30550q1 = imageLocation;
        this.f30551r1 = imageLocation2;
    }

    public final void B(float f7, int i10) {
        float f10;
        int i11 = this.f30544j1;
        float f11 = 0.0f;
        if (i11 >= 0 || this.f30545k1 >= 0) {
            if (i11 < 0) {
                i11 = this.f30545k1;
            }
    ...
    public final View E(int i10) {
        xh0 xh0Var = this.D0;
        if (xh0Var != null) {
            ArrayList arrayList = xh0Var.f30266c;
            if (arrayList.size() > i10 && i10 >= 0) {
                uh0 uh0Var = (uh0) arrayList.get(i10);
                vh0 vh0Var = uh0Var.f28682b;
                if (vh0Var == null) {
                    return uh0Var.f28683c;
                }
                return vh0Var;
            }
            return null;
    ...
    public final boolean H(e71 e71Var, ImageLocation imageLocation, ImageLocation imageLocation2, boolean z10) {
        ...
        int i11 = 0;
        if (imageLocation != null && imageLocation2 != null && this.f30537c1 == 0) {
    ...
    public final void N(int i10, int i11) {
        ...
        xh0 xh0Var = this.D0;
        if (xh0Var != null) {
            for (int i12 = 0; i12 < xh0Var.f30266c.size(); i12++) {
                if (((uh0) xh0Var.f30266c.get(i12)).f28683c != null) {
                    sh0 sh0Var = ((uh0) xh0Var.f30266c.get(i12)).f28683c;
                    int i13 = this.f30546m1;
                    int i14 = this.f30547n1;
        ...
        if (imageLocation != null) {
            ...
            while (true) {
                ...
                if (i10 >= arrayList.size()) {
                    ...
                    this.f30536b1.set(i10, Float.valueOf(f7));
                    SparseArray sparseArray = this.f30538d1;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
            ...
            if (yh0Var2.S0 == dialogPhotos2) {
                ...
                if (!arrayList7.isEmpty() || !dialogPhotos2.fromCache) {
                    ...
                    if (user4 != null && user4.self && UserObject.hasFallbackPhoto(userFull)) {
                        ...
                        yh0Var2.f30545k1 = arrayList7.size() - 1;
                    }
                    arrayList5.clear();
                    arrayList6.clear();
                    ...
                    arrayList12.clear();
                    ArrayList arrayList13 = yh0Var2.f30535a1;
                    arrayList13.clear();
                    ArrayList arrayList14 = yh0Var2.f30536b1;
                    arrayList14.clear();
                    ...
                    if (yh0Var.f30545k1 < 0 && yh0Var.f30544j1 < 0) {
                        z11 = false;
                        yh0Var.B(0.0f, 0);
                    } else {
                        z11 = false;
                    ...
                    ImageLocation imageLocation5 = yh0Var.f30550q1;
                    if (imageLocation5 != null) {
                        yh0Var.A(imageLocation5, yh0Var.f30551r1);
                        return;
                    }
                    return;
                }
        ...
        SparseArray sparseArray = yh0Var2.f30538d1;
        if (i10 == i28) {
        ...
        } else if (i10 == NotificationCenter.reloadDialogPhotos && yh0Var2.f30537c1 == 0 && (dialogPhotos = yh0Var2.S0) != null) {
            dialogPhotos.reset();
    ...
    public v9 getCurrentItemView() {
        xh0 xh0Var = this.D0;
        if (xh0Var != null && !xh0Var.f30266c.isEmpty()) {
            return ((uh0) xh0Var.f30266c.get(getCurrentItem())).f28683c;
        }
        return null;
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        ph0 ph0Var = this.f30549p1;
        if (ph0Var != null) {
            ph0Var.setTranslationY(getHeight() - this.f30549p1.getMeasuredHeight());
        }
    }
    ...
    public yh0(Context context, long j3, org.telegram.ui.ActionBar.k kVar, vl0 vl0Var, org.telegram.ui.m01 m01Var, th0 th0Var, ph0 ph0Var) {
        ...
        this.f30544j1 = -1;
        this.f30545k1 = -1;
        this.f30549p1 = ph0Var;
        setPadding(0, 0, 0, ph0Var == null ? 0 : ph0Var.f27308n);
        if (ph0Var != null) {
            ph0Var.setView(this);
        }
        setVisibility(8);
