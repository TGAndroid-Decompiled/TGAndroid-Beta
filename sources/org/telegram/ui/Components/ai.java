...
public final class ai extends ju {
    ...
    public int W;
    public int f22684a0;
    public ValueAnimator f22685b0;
    public final vi f22686c0;
    ...
    public final void dispatchDraw(Canvas canvas) {
        if (this.V) {
            bu editText = this.f22686c0.E0.getEditText();
            editText.setOffsetY(editText.getOffsetY() - ((this.f22684a0 - editText.getScrollY()) + (this.W - editText.getMeasuredHeight())));
            ValueAnimator ofFloat = ValueAnimator.ofFloat(editText.getOffsetY(), 0.0f);
            ofFloat.addUpdateListener(new ai.x(14, this, editText));
            ValueAnimator valueAnimator = this.f22685b0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            this.f22685b0 = ofFloat;
    ...
    public final void i(Menu menu) {
        org.telegram.ui.ActionBar.n2 n2Var = this.f22686c0.f29098f0;
    ...
    public final void q(int i10, int i11) {
        ...
        if (!TextUtils.isEmpty(getEditText().getText())) {
            ...
            this.f22684a0 = getEditText().getScrollY();
            invalidate();
        } else {
