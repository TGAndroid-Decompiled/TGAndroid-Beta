...
public final class ai extends View {
    ...
    public void draw(Canvas canvas) {
        switch (this.f22699a) {
            case 0:
                super.draw(canvas);
                this.f22700b.f29992b0.draw(canvas);
                return;
            default:
                super.draw(canvas);
                return;
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f22699a) {
            case 1:
                wi wiVar = this.f22700b;
                String format = String.format("%d", Integer.valueOf(Math.max(1, wiVar.f30067y0.getSelectedItemsCount())));
                ...
                wiVar.L0.setColor(wiVar.getThemedColor(org.telegram.ui.ActionBar.h6.f19130h5));
                int i10 = max / 2;
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        switch (this.f22699a) {
            case 0:
                ...
                this.f22700b.f29992b0.setBounds(0, (i11 - AndroidUtilities.navigationBarHeight) - AndroidUtilities.dp(48.0f), i10, i11);
                return;
            default:
                super.onSizeChanged(i10, i11, i12, i13);
                return;
