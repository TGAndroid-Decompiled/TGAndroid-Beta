...
public final class ai implements og.g, yd.a, androidx.activity.result.b, oa0, g71, g5.h0, OnSuccessListener, ra.m, r4.h, com.google.android.gms.common.api.internal.s, uf.j1, OnCompleteListener, wh.h0, wh.d1 {
    ...
    public void B(CharSequence charSequence) {
        wh.m3 m3Var = ((wh.x0) this.f25257b).P;
        if (m3Var != null) {
            m3Var.getClass();
            if (charSequence != null && charSequence.length() > 0) {
                m3Var.f49913a.s4(charSequence.toString());
            }
        }
    }
    ...
    @Override
    public wh.a G() {
        return ((wh.x0) this.f25257b).f50211a;
    }
    ...
    @Override
    public boolean L() {
        wh.x0 x0Var = (wh.x0) this.f25257b;
        wh.m3 m3Var = x0Var.P;
        if (m3Var != null) {
            wh.a aVar = x0Var.f50211a;
            if (m3Var.f49913a.R4()) {
                return true;
            }
            return false;
    ...
    public void P(g.x xVar) {
        switch (this.f25256a) {
            case 0:
                xVar.a(((mi) this.f25257b).getThemedColor(org.telegram.ui.ActionBar.k6.f21661d6));
                xVar.b(SharedConfig.chatBlurEnabled());
                return;
            default:
                xVar.a(((lq0) this.f25257b).getThemedColor(org.telegram.ui.ActionBar.k6.f21661d6));
                xVar.b(SharedConfig.chatBlurEnabled());
                return;
        }
    }
    ...
    public boolean R(int i10) {
        if (i10 == ((wn0) this.f25257b).f48787a0) {
            return true;
        }
        return false;
    }
    ...
    public byte S() {
        int read = ((com.google.firebase.messaging.d) this.f25257b).read();
        if (read >= 0) {
            return (byte) read;
        }
    ...
    public void U(int i10, int i11, CharSequence charSequence, boolean z4) {
        qh.f fVar = ((qh.k) this.f25257b).f45574f;
        if (fVar == null) {
            return;
        }
        try {
    ...
    public void V(ArrayList arrayList) {
        boolean z4;
        wn0 wn0Var = (wn0) this.f25257b;
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            wn0Var.G.add(((uf.i1) arrayList.get(i10)).f48639a);
        }
    ...
    public void a0(long j10) {
        long j11 = 0;
        while (j11 < j10) {
            long skip = ((com.google.firebase.messaging.d) this.f25257b).skip(j10 - j11);
            if (skip > 0) {
                j11 += skip;
            } else {
                throw new EOFException();
    ...
    public void accept(Object obj, Object obj2) {
        ...
        M0.writeStringArray((String[]) this.f25257b);
        iVar.R0(M0, 6);
    }
    ...
    public void c(wh.e1 e1Var) {
        switch (this.f25256a) {
            case 20:
                ...
                return;
            default:
                wh.y4 y4Var = ((wh.a5) this.f25257b).f49682s;
                if (y4Var != null) {
                    wh.r3 r3Var2 = ((wh.x2) y4Var).f50190a;
    ...
    public String d(Object obj) {
        ...
        try {
            w9.d dVar = (w9.d) this.f25257b;
            w9.e eVar = new w9.e(stringWriter, dVar.f49512a, dVar.f49513b, dVar.f49514c, dVar.d);
            eVar.h(obj);
            eVar.j();
            eVar.f49516b.flush();
    ...
    public void f() {
        ...
        wh.m3 m3Var = x0Var.P;
        if (m3Var != null) {
            wh.r3.O1(m3Var.f49913a, x0Var.f50211a);
        }
    }
    ...
    public void g(int i10) {
        ...
        wn0Var.A0--;
        wn0Var.f48788b0 = i10;
        if (wn0Var.f48790c0 != i10) {
            wn0Var.f48809s.clear();
        }
        if (wn0Var.f48791d0 != i10) {
            wn0Var.F.clear();
        }
        wn0Var.K = true;
        org.telegram.ui.ay ayVar = wn0Var.R;
    ...
    public void k(Object obj) {
        Bundle extras;
        ProxyBillingActivityV2 proxyBillingActivityV2 = (ProxyBillingActivityV2) this.f25257b;
    ...
    public boolean needClickAt(View view, float f10, float f11) {
        ...
        k61 k61Var = (k61) this.f25257b;
        float f12 = -dp;
        k61Var.f28297g.inset(f12, f12);
        boolean contains = k61Var.f28297g.contains(f10, f11);
        float f13 = dp;
        k61Var.f28297g.inset(f13, f13);
        return contains;
    }
    ...
    public void o(wh.e1 e1Var) {
        wh.a aVar;
        wh.a5 a5Var = (wh.a5) this.f25257b;
        wh.y4 y4Var = a5Var.f49682s;
        if (y4Var != null && (aVar = a5Var.f50211a) != null) {
            wh.r3 r3Var = ((wh.x2) y4Var).f50190a;
            ArrayList arrayList = r3Var.f50024i3;
            long j10 = aVar.f49669t;
            if (j10 != 0) {
                int i10 = -1;
                for (int i11 = 0; i11 < arrayList.size(); i11++) {
                    if (((wh.a) arrayList.get(i11)).f49660k.contains(Long.valueOf(j10))) {
                        i10 = i11;
                    }
                }
                if (i10 >= 0) {
    ...
    public void onClickAt(View view, float f10, float f11) {
        Runnable runnable = ((k61) this.f25257b).f28299j;
        if (runnable != null) {
            runnable.run();
        }
    }
    ...
    public void onClickTouchDown(View view, float f10, float f11) {
        ((k61) this.f25257b).h.c(true);
    }

    @Override
    public void onClickTouchUp(View view, float f10, float f11) {
        ((k61) this.f25257b).h.c(false);
    }

    @Override
    public void onComplete(Task task) {
        ld.m mVar = (ld.m) this.f25257b;
    ...
    public void onStateChanged(boolean z4, int i10) {
        qh.i5 i5Var = (qh.i5) this.f25257b;
        qh.g5 g5Var = i5Var.I;
        AndroidUtilities.cancelRunOnUIThread(g5Var);
        j71 j71Var = i5Var.f45465y;
    ...
    public void onSuccess(Object obj) {
        ...
        r5.a aVar = (r5.a) this.f25257b;
        Bundle bundle = (Bundle) obj;
        if (com.google.android.gms.internal.cast.n0.f3063j) {
            Context context = aVar.f46711a;
            u5.s sVar = aVar.f46715f;
            com.google.android.gms.internal.cast.n0 n0Var = new com.google.android.gms.internal.cast.n0(context, sVar, aVar.f46713c, aVar.f46718j, aVar.f46716g);
            ...
            n0Var.h = i11;
            y2.q.b(context);
            n0Var.f3069g = y2.q.a().c(w2.a.f49361e).a("CAST_SENDER_SDK", new v2.c("proto"), com.google.android.gms.internal.cast.y.f3180a);
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        ((qh.i5) this.f25257b).i();
    }

    @Override
    public s4.j p(long j10) {
        return (s4.j) this.f25257b;
    }
    ...
    public void s(wh.e1 e1Var, int i10, int i11) {
        ...
        wh.a5 a5Var = (wh.a5) this.f25257b;
        if (!a5Var.f49683w && i10 != i11 && (y4Var = a5Var.f49682s) != null && (textSelectionHelper = ((wh.x2) y4Var).f50190a.getTextSelectionHelper()) != null) {
    ...
    public Paint.FontMetricsInt w() {
        return ((qh.k) this.f25257b).f45574f.getEditText().getPaint().getFontMetricsInt();
    }
    ...
    public void x(g5.j0 j0Var, long j10, long j11) {
        ...
        if (cVar2 == null) {
            ...
            size = cVar2.f46989m.size();
        }
        long j13 = cVar.b(0).f47007b;
        int i10 = 0;
        while (i10 < size && gVar.I.b(i10).f47007b < j13) {
            i10++;
        }
        if (cVar.d) {
            if (size - i10 > cVar.f46989m.size()) {
            ...
            int i11 = gVar.N;
            gVar.N = i11 + 1;
            if (i11 < gVar.f46661n.n3(p0Var.f6893c)) {
                gVar.E.postDelayed(gVar.f46669w, Math.min((gVar.N - 1) * 1000, 5000));
                return;
            }
        ...
        gVar.K = j10 - j11;
        gVar.L = j10;
        synchronized (gVar.f46668u) {
            try {
                if (p0Var.f6892b.f6885a == gVar.G) {
                    Uri uri2 = gVar.I.f46987k;
                    if (uri2 == null) {
                        uri2 = p0Var.d.f6950c;
                    }
                    gVar.G = uri2;
                ...
                if (hVar != null) {
                    ...
                    if (!h5.d0.a(str, "urn:mpeg:dash:utc:direct:2014") && !h5.d0.a(str, "urn:mpeg:dash:utc:direct:2012")) {
                        if (!h5.d0.a(str, "urn:mpeg:dash:utc:http-iso:2014") && !h5.d0.a(str, "urn:mpeg:dash:utc:http-iso:2012")) {
                            ...
                            gVar.f46665r.u(new o4.j(p0Var2.f6892b), p0Var2.f6893c, -1, null, 0, null, -9223372036854775807L, -9223372036854775807L);
                            return;
                        }
                        g5.p0 p0Var3 = new g5.p0(gVar.A, Uri.parse(hVar.f1729c), 5, new Object());
                        gVar.B.f(p0Var3, new r4.d(gVar), 1);
                        gVar.f46665r.u(new o4.j(p0Var3.f6892b), p0Var3.f6893c, -1, null, 0, null, -9223372036854775807L, -9223372036854775807L);
                        return;
                    }
                    try {
    ...
    @Override
    public Object y2() {
        Constructor constructor = (Constructor) this.f25257b;
        try {
            return constructor.newInstance(null);
        } catch (IllegalAccessException e6) {
            k7.a8 a8Var = ua.c.f48499a;
    ...
    public org.telegram.ui.Cells.m9 z() {
        ...
        return m3Var.f49913a.getTextSelectionHelper();
    }
    ...
    public ai(int i10) {
        ...
        switch (i10) {
            case 14:
                this.f25257b = new org.telegram.ui.Cells.f1(20);
                return;
            case 15:
                this.f25257b = new SparseArray();
                return;
            default:
                this.f25257b = new h5.w(10);
                return;
        }
    }
    ...
    public ai(TextView textView) {
        this.f25256a = 6;
        this.f25257b = new q1.g(textView);
    }

    public ai(Context context, n20 n20Var) {
        this.f25256a = 1;
        this.f25257b = new m20(context, n20Var);
    }

    public ai(int i10, int i11) {
        this.f25256a = 2;
        this.f25257b = ApplicationLoader.applicationContext.getSharedPreferences(android.support.v4.media.a.k(i10, i11, "pip_layout_", "_"), 0);
    }
