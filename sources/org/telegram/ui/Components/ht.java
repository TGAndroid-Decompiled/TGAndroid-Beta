...
public final class ht implements SensorEventListener {
    ...
    public boolean J;
    public float L;
    public final SensorManager f26861a;
    public final AudioManager f26862b;
    public final Sensor f26863c;
    public final Sensor d;
    public final Sensor f26864e;
    public final Sensor f26865f;
    ...
    public ht() {
        ...
        this.f26861a = sensorManager;
        this.f26863c = sensorManager.getDefaultSensor(8);
        Sensor defaultSensor = sensorManager.getDefaultSensor(10);
        this.f26864e = defaultSensor;
        Sensor defaultSensor2 = sensorManager.getDefaultSensor(9);
        this.f26865f = defaultSensor2;
        ...
        this.f26862b = (AudioManager) ApplicationLoader.applicationContext.getSystemService("audio");
    }

    public final void a() {
        int i10;
        g71 g71Var = this.f26868s;
        if (g71Var == null) {
            return;
        }
        if (this.f26867r) {
