...
public final class ht implements SensorEventListener {
    ...
    public boolean J;
    public float L;
    public final SensorManager f26834a;
    public final AudioManager f26835b;
    public final Sensor f26836c;
    public final Sensor d;
    public final Sensor f26837e;
    public final Sensor f26838f;
    ...
    public ht() {
        ...
        this.f26834a = sensorManager;
        this.f26836c = sensorManager.getDefaultSensor(8);
        Sensor defaultSensor = sensorManager.getDefaultSensor(10);
        this.f26837e = defaultSensor;
        Sensor defaultSensor2 = sensorManager.getDefaultSensor(9);
        this.f26838f = defaultSensor2;
        ...
        this.f26835b = (AudioManager) ApplicationLoader.applicationContext.getSystemService("audio");
    }

    public final void a() {
        int i10;
        g71 g71Var = this.f26841s;
        if (g71Var == null) {
            return;
        }
        if (this.f26840r) {
