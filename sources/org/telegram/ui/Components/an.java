...
public final class an implements fy {
    public final Utilities.Callback f26804a;
    public final xm f26805b;

    public an(Utilities.Callback callback, xm xmVar) {
        this.f26804a = callback;
        this.f26805b = xmVar;
    }
    ...
    public final void m(View view, TLRPC.Document document, String str, Object obj, MessageObject.SendAnimationData sendAnimationData, boolean z10, int i10) {
        this.f26804a.run(new ch.i(document, obj));
        this.f26805b.dismiss(true);
    }
    ...
    public final void x(long j10, TLRPC.Document document, String str, boolean z10) {
        this.f26804a.run(new ch.i(document, null));
        this.f26805b.dismiss(true);
    }
