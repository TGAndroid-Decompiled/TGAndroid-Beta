...
public final class xw extends rx {
    ...
    public final void o(int i10, int i11) {
        ...
        for (int i16 = kzVar.f27938e0; i16 < arrayList.size(); i16 = com.google.android.gms.internal.vision.e2.g(((TLRPC.TL_messages_stickerSet) arrayList.get(i16)).set.f19896id, tL_messages_reorderStickerSets.order, i16, 1)) {
        }
