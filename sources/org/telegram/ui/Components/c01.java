    ...
    public final void g(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        switch (this.f24864a) {
            case 0:
                ...
                return;
            case 1:
                e01 e01Var = this.f24865b;
                AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(e01Var.getContext());
                alertDialog$Builder.f20225a.T = LocaleController.getString(R.string.TosDeclineDeleteAccount);
