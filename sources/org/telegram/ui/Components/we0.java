...
public final class we0 extends FrameLayout {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int dp = AndroidUtilities.dp(13.0f) + this.f30030a.getMeasuredHeight();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        TextView textView2 = this.f30031b;
        measureChildWithMargins(textView2, i10, 0, i11, 0);
        measureChildWithMargins(this.f30032c, i10, 0, i11, 0);
        Switch r72 = this.d;
        if (r72 != null) {
