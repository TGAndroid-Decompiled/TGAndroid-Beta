...
public final class we0 extends View {
    public Paint f32251a;
    public Paint f32252b;
    public int f32253c;
    public int d;
    public float f32254e;
    ...
    public final void a(int i10, boolean z10) {
        ...
        this.f32254e = (i10 - i11) / (this.f32256n - i11);
        invalidate();
        if (z10 && (ve0Var = this.f32257r) != null) {
    ...
    public int getProgress() {
        int i10 = this.h;
        return (int) ((this.f32254e * (this.f32256n - i10)) + i10);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int measuredWidth = (int) ((getMeasuredWidth() - i11) * this.f32254e);
        float f7 = i11 / 2;
        canvas.drawRect(f7, (getMeasuredHeight() / 2) - AndroidUtilities.dp(1.0f), getMeasuredWidth() - i10, AndroidUtilities.dp(1.0f) + (getMeasuredHeight() / 2), this.f32251a);
        if (this.h == 0) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent != null) {
            ...
            float measuredWidth = (int) ((getMeasuredWidth() - i10) * this.f32254e);
            float f7 = 0.0f;
            if (motionEvent.getAction() == 0) {
                ...
                if (motionEvent.getAction() == 2 && this.f32255f) {
                    ...
                    this.f32254e = f7 / (getMeasuredWidth() - i10);
                    ve0 ve0Var = this.f32257r;
                    if (ve0Var != null) {
                        ve0Var.k(((Integer) getTag()).intValue(), getProgress());
                    }
                    invalidate();
