...
public final class we0 extends View {
    public Paint f32278a;
    public Paint f32279b;
    public int f32280c;
    public int d;
    ...
    public final void a(int i10, boolean z10) {
        ...
        if (i10 < i11) {
            ...
            int i12 = this.f32283n;
            if (i10 > i12) {
                i10 = i12;
            }
        }
        this.f32281e = (i10 - i11) / (this.f32283n - i11);
        invalidate();
        if (z10 && (ve0Var = this.f32284r) != null) {
    ...
    public int getProgress() {
        int i10 = this.h;
        return (int) ((this.f32281e * (this.f32283n - i10)) + i10);
    }

    @Override
    public final void onDraw(Canvas canvas) {
        int i10;
        Paint paint = this.f32279b;
        int measuredHeight = getMeasuredHeight();
        int i11 = this.f32280c;
        int i12 = (measuredHeight - i11) / 2;
        int measuredWidth = (int) ((getMeasuredWidth() - i11) * this.f32281e);
        float f7 = i11 / 2;
        canvas.drawRect(f7, (getMeasuredHeight() / 2) - AndroidUtilities.dp(1.0f), getMeasuredWidth() - i10, AndroidUtilities.dp(1.0f) + (getMeasuredHeight() / 2), this.f32278a);
        if (this.h == 0) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent != null) {
            ...
            float measuredWidth = (int) ((getMeasuredWidth() - i10) * this.f32281e);
            float f7 = 0.0f;
            if (motionEvent.getAction() == 0) {
                ...
                if (motionEvent.getAction() == 2 && this.f32282f) {
                    ...
                    this.f32281e = f7 / (getMeasuredWidth() - i10);
                    ve0 ve0Var = this.f32284r;
                    if (ve0Var != null) {
                        ve0Var.k(((Integer) getTag()).intValue(), getProgress());
                    }
                    invalidate();
