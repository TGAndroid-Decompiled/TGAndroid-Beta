...
public final class we0 {
    ...
    public final ViewGroup a(Context context, int i10) {
        ...
        if (z10) {
            ...
            frameLayout.f30325b = textView2;
            textView2.setTextColor(ze0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19461z6));
            ...
            frameLayout.f30326c = imageView;
            imageView.setScaleType(ImageView.ScaleType.CENTER);
            imageView.setColorFilter(new PorterDuffColorFilter(ze0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19223m6), PorterDuff.Mode.MULTIPLY));
            ...
            textView3.setTextColor(ze0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19165j5));
            ...
            if (str != null) {
                ...
                f15.setTextColor(ze0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19315r5));
        ...
        if (z10) {
            xe0 xe0Var = (xe0) linearLayout;
            int i33 = ze0Var.F;
            if (i10 >= i33 && i10 < ze0Var.G) {
            ...
            ImageView imageView2 = xe0Var.f30326c;
            xe0Var.f30324a.setText(vcardItem.getValue(true));
            xe0Var.f30325b.setText(vcardItem.getType());
            Switch r82 = xe0Var.d;
            if (r82 != null) {
