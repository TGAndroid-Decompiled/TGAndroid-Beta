...
public final class kv extends FrameLayout {
    ...
    public final Path f25805b;
    public Boolean f25806c;
    public boolean d;
    public final SparseArray e;
    public final ArrayList f25807f;
    public final ArrayList h;
    public final ArrayList f25808n;
    public final ArrayList f25809r;
    public final e6 f25810s;
    public ImageReceiver v;
    public boolean f25811w;
    public final e6 f25812x;
    public final uv f25813y;
    ...
    public kv(uv uvVar, Context context) {
        ...
        this.f25807f = new ArrayList();
        this.h = new ArrayList();
        this.f25808n = new ArrayList();
        this.f25809r = new ArrayList();
        sr srVar = sr.h;
        this.f25810s = new e6(this, 0L, 350L, srVar);
        this.f25812x = new e6(this, 0L, 320L, srVar);
    }

    public final void a() {
        z5[] z5VarArr;
        uv uvVar = this.f25813y;
        ci.v vVar = uvVar.h;
        if (vVar == null) {
            z5VarArr = new z5[0];
        } else {
            ...
            for (int i10 = 0; i10 < vVar.getChildCount(); i10++) {
                ...
                if (childAt instanceof lv) {
                    z5VarArr2[i10] = ((lv) childAt).f26184c;
                }
            }
            z5VarArr = z5VarArr2;
        }
        uvVar.f28911b = z5.update(3, this, z5VarArr, uvVar.f28911b);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        Paint paint = this.f25804a;
        paint.setColor(themedColor);
        org.telegram.ui.ActionBar.h6.m(paint);
        Path path = this.f25805b;
        path.reset();
        float V = uvVar.V();
        ...
        if (this.v != null) {
            ...
            this.v.setAlpha(this.f25812x.e(this.f25811w));
        ...
        if (bool == null || z11 != bool.booleanValue()) {
            this.f25806c = Boolean.valueOf(z11);
        ...
        View view = uvVar.f28915r;
        if (!vVar.canScrollVertically(1) && uvVar.f28917w.getVisibility() != 0) {
            i10 = 4;
        } else {
            i10 = 0;
        }
        ...
        if (vVar != null) {
            ...
            while (i13 < vVar.getChildCount()) {
                ...
                if (childAt instanceof lv) {
                    ...
                    if (uvVar.f28911b != null && (z5Var = lvVar.f26184c) != null) {
                        q5 q5Var = (q5) uvVar.f28911b.get(z5Var.getDocumentId());
                        if (q5Var != null) {
            ...
            arrayList5.clear();
            ArrayList arrayList6 = this.f25807f;
    ...
    public final void onDetachedFromWindow() {
        ...
        while (true) {
            ArrayList arrayList2 = this.f25809r;
        ...
        arrayList.clear();
        z5.release(this, this.f25813y.f28911b);
        ImageReceiver imageReceiver = this.v;
        if (imageReceiver != null) {
