...
public final class mx0 extends FrameLayout {
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            ux0 ux0Var = this.e;
            if (ux0Var.f28572e0 != 0 && motionEvent.getY() < ux0Var.f28572e0) {
                ux0Var.dismiss();
                return true;
            }
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) ux0Var.f28569c.getLayoutParams();
        int i23 = 3;
        if (arrayList != null) {
            ...
            if (ux0Var.W != null) {
                ...
                i17 = i19 + (ux0Var.d.f27478n * ux0Var.P) + size3;
        ...
        if (ux0Var.f28569c.getPaddingTop() != i20) {
            ux0Var.f28575g0 = true;
            ux0Var.f28569c.setPadding(AndroidUtilities.dp(10.0f), i20, AndroidUtilities.dp(10.0f), AndroidUtilities.dp(8.0f));
