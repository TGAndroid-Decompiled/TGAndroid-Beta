...
public final class nf0 extends FrameLayout implements yz, ph.z9 {
    ...
    public MediaController.SavedFilterState f27239b0;
    public final int f27240c;
    public final FrameLayout f27241c0;
    public final int d;
    public final TextView f27242d0;
    public final int e;
    public final TextView f27243e0;
    public final int f27244f;
    public final TextureView f27245f0;
    public final boolean f27246g0;
    public final int h;
    public final boolean f27247h0;
    public vz f27248i0;
    public final nh f27249j0;
    public final FrameLayout f27250k0;
    public final cf0 f27251l0;
    public final ef0 m0;
    public final int f27252n;
    public final TextView f27253n0;
    public final TextView f27254o0;
    public final TextView f27255p0;
    public final FrameLayout f27256q0;
    public final int f27257r;
    public final RadioButton[] f27258r0;
    public final int f27259s;
    public final hd0 f27260s0;
    public final boolean f27261t0;
    public final boolean f27262u0;
    public final int v;
    public int f27263v0;
    public final int f27264w;
    public final ImageView f27265w0;
    public final int f27266x;
    public final ImageView f27267x0;
    public final int f27268y;
    public final ImageView f27269y0;
    public final Bitmap f27270z0;

    public nf0(android.content.Context r26, org.telegram.ui.Components.w61 r27, android.graphics.Bitmap r28, android.graphics.Bitmap r29, int r30, org.telegram.messenger.MediaController.SavedFilterState r31, org.telegram.ui.Components.hd0 r32, int r33, boolean r34, boolean r35, org.telegram.ui.Components.ba r36, org.telegram.ui.ActionBar.f6 r37) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.nf0.<init>(android.content.Context, org.telegram.ui.Components.w61, android.graphics.Bitmap, android.graphics.Bitmap, int, org.telegram.messenger.MediaController$SavedFilterState, org.telegram.ui.Components.hd0, int, boolean, boolean, org.telegram.ui.Components.ba, org.telegram.ui.ActionBar.f6):void");
    }

    private void setShowOriginal(boolean z4) {
        if (this.f27236a != z4) {
            this.f27236a = z4;
            vz vzVar = this.f27248i0;
            if (vzVar != null) {
    ...
    public final boolean d() {
        MediaController.SavedFilterState savedFilterState = this.f27239b0;
        jf0 jf0Var = this.T;
        if (savedFilterState != null) {
            if (this.D != savedFilterState.enhanceValue || this.F != savedFilterState.contrastValue || this.M != savedFilterState.highlightsValue || this.E != savedFilterState.exposureValue || this.G != savedFilterState.warmthValue || this.H != savedFilterState.saturationValue || this.O != savedFilterState.vignetteValue || this.N != savedFilterState.shadowsValue || this.P != savedFilterState.grainValue || this.R != savedFilterState.sharpenValue || this.I != savedFilterState.fadeValue || this.J != savedFilterState.softenSkinValue || this.L != savedFilterState.tintHighlightsColor || this.K != savedFilterState.tintShadowsColor || !jf0Var.b()) {
                return true;
            }
            return false;
        } else if (this.D != 0.0f || this.F != 0.0f || this.M != 0.0f || this.E != 0.0f || this.G != 0.0f || this.H != 0.0f || this.O != 0.0f || this.N != 0.0f || this.P != 0.0f || this.R != 0.0f || this.I != 0.0f || this.J != 0.0f || this.L != 0 || this.K != 0 || !jf0Var.b()) {
            return true;
        } else {
            return false;
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        hd0 hd0Var = this.f27260s0;
        if (hd0Var != null && view == (textureView = this.f27245f0)) {
            canvas.save();
    ...
    public final void e() {
        boolean z4 = this.f27246g0;
        TextureView textureView = this.f27245f0;
        if (z4) {
            vz vzVar = this.f27248i0;
            if (vzVar != null) {
    ...
    public final void f() {
        boolean z4;
        int i10 = this.f27263v0;
        nh nhVar = this.f27249j0;
        ef0 ef0Var = this.m0;
        FrameLayout frameLayout = this.f27256q0;
        FrameLayout frameLayout2 = this.f27250k0;
        cf0 cf0Var = this.f27251l0;
        if (i10 == 0) {
            ...
            for (int i11 = 0; i11 < 4; i11++) {
                RadioButton radioButton = this.f27258r0[i11];
                if (i11 == 0) {
                    z4 = true;
                } else {
                    z4 = false;
    ...
    public Bitmap getBitmap() {
        vz vzVar = this.f27248i0;
        if (vzVar != null && vzVar.f30113f && vzVar.isAlive()) {
    ...
    public TextureView getMyTextureView() {
        if (this.f27246g0 && !this.f27247h0) {
            return this.f27245f0;
        }
        return null;
    }
    ...
    public MediaController.SavedFilterState getSavedFilterState() {
        ...
        savedFilterState.blurAngle = this.f27237a0;
        this.f27239b0 = savedFilterState;
    ...
    public final void h() {
        int i10 = this.Q;
        TextView textView = this.f27255p0;
        TextView textView2 = this.f27254o0;
        org.telegram.ui.ActionBar.f6 f6Var = this.F0;
        TextView textView3 = this.f27253n0;
        if (i10 == 0) {
            ...
            int i12 = org.telegram.ui.ActionBar.j6.f20304zf;
            ...
            int i13 = org.telegram.ui.ActionBar.j6.f20304zf;
    ...
    public final boolean l(MotionEvent motionEvent) {
        if (motionEvent.getActionMasked() != 0 && motionEvent.getActionMasked() != 5) {
            ...
            if (textureView instanceof w61) {
                ...
                sk0 sk0Var = ((w61) textureView).f30250c;
                float f10 = sk0Var.f28722a;
                if (x10 >= f10 && x10 <= f10 + sk0Var.f28724c) {
                    float f11 = sk0Var.f28723b;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f27247h0) {
            ...
            jv0Var.f26052a = f18;
            jv0Var.f26053b = f19;
            ((FrameLayout.LayoutParams) cf0Var.getLayoutParams()).height = AndroidUtilities.dp(38.0f) + i15;
            ((FrameLayout.LayoutParams) ef0Var.getLayoutParams()).height = AndroidUtilities.dp(28.0f) + i15;
            if (AndroidUtilities.isTablet()) {
                int dp4 = AndroidUtilities.dp(86.0f) * 10;
                FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) this.f27249j0.getLayoutParams();
                if (dp4 < dp) {
    ...
    public void setEnhanceValue(float f10) {
        ...
        while (true) {
            ...
            if ((childAt instanceof org.telegram.ui.Cells.v5) && RecyclerView.R(childAt) == this.f27238b) {
