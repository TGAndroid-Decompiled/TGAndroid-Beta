...
public final class yn0 extends b81 {
    public final ArrayList f30291a = new ArrayList();
    public final org.telegram.ui.gy f30292b;
    ...
    public final void b(View view, int i10, int i11) {
        org.telegram.ui.gy gyVar = this.f30292b;
    ...
    public final View d(int i10) {
        ...
        if (i10 == 3) {
            return gyVar.f30552g0;
        }
        if (i10 == 4) {
            return gyVar.f30557l0;
        }
        if (i10 == 5) {
            return gyVar.f30563s0;
        }
        if (i10 == 2) {
            wm0 wm0Var = new wm0(gyVar.I0, wyVar);
            gyVar.H0 = wm0Var;
            wm0Var.b(gyVar.V0, gyVar.W0, false);
            gyVar.H0.f29695b.setClipToPadding(false);
            gyVar.H0.f29695b.j(new wn0(this, 0));
            gyVar.H0.f29695b.D0(new bc0(gyVar, 23));
            gyVar.H0.setUiCallback(gyVar);
            return gyVar.H0;
        } else if (i10 == 6) {
            return gyVar.f30561q0;
        } else {
    ...
    public final CharSequence g(int i10) {
        ArrayList arrayList = this.f30291a;
        if (((xn0) arrayList.get(i10)).f29950a == 0) {
            return LocaleController.getString(R.string.SearchAllChatsShort);
        }
        if (((xn0) arrayList.get(i10)).f29950a == 1) {
            return LocaleController.getString(R.string.ChannelsTab);
        }
        if (((xn0) arrayList.get(i10)).f29950a == 4) {
            return LocaleController.getString(R.string.AppsTab);
        }
        if (((xn0) arrayList.get(i10)).f29950a == 6) {
            return LocaleController.getString(R.string.SearchPosts);
        }
        if (((xn0) arrayList.get(i10)).f29950a == 2) {
            return LocaleController.getString(R.string.DownloadsTabs);
        }
        if (((xn0) arrayList.get(i10)).f29950a == 5) {
            return LocaleController.getString(R.string.PublicPostsTabs);
        }
        gg.q0 q0Var = gg.s0.f9915c3[((xn0) arrayList.get(i10)).f29951b];
    ...
    public final int h(int i10) {
        ...
        return ((xn0) arrayList.get(i10)).f29950a + i10;
    }
    ...
    public final void i() {
        ...
        if (gyVar.U0 == 0) {
            ...
            if (!gyVar.P0) {
                ...
                org.telegram.ui.qx qxVar = gyVar.f34063b1.F3;
