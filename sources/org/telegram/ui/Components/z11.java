...
public final class z11 extends wl0 {
    public final Context f30763c;
    public int d;
    public ArrayList e = new ArrayList();
    public ArrayList f30764f = new ArrayList();
    public ym h;
    public String f30765n;
    public final ThemeEditorView.EditorAlert f30766r;

    public z11(ThemeEditorView.EditorAlert editorAlert, Context context) {
        this.f30766r = editorAlert;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (c1Var.f42962f == 0) {
            ...
            z8Var.f21923a.setText((CharSequence) this.f30764f.get(i11));
            z8Var.f21924b = c10;
            if (c10 != 0) {
                z10 = false;
            }
