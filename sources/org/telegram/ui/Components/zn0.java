...
public class zn0 extends ScrollView {
    ...
    public final void a(Canvas canvas, View view, View view2) {
        ...
        if (view != null && view2 != null) {
            ...
            float f10 = 0.0f;
            LinearLayout linearLayout = this.f30620b;
            ...
            if (rectF.bottom >= rectF.top) {
                ll0.O0(canvas, rectF, AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f), view.getAlpha(), this.f30619a);
            }
        }
    }
            ...
            if (childAt.getVisibility() == 0) {
                if (childAt instanceof LinearLayout) {
                    ...
                    if (linearLayout.getOrientation() == 1) {
                        LinearLayout linearLayout2 = this.f30620b;
    ...
    public final float c(View view) {
        if (view != this.f30620b && (view.getParent() instanceof View)) {
    ...
    public final void onScrollChanged(int i10, int i11, int i12, int i13) {
        ...
        ArrayList arrayList = this.f30622f;
        int size = arrayList.size();
        int i14 = 0;
        while (i14 < size) {
