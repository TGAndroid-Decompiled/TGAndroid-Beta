...
public class zn0 extends ScrollView {
    ...
    public static boolean e(View view) {
        if (!Objects.equals(view.getTag(), -33024) && !(view instanceof org.telegram.ui.Cells.e9) && !(view instanceof org.telegram.ui.Cells.a7) && !(view instanceof org.telegram.ui.a20)) {
            return true;
        }
        return false;
    }
    ...
    public final void a(Canvas canvas, View view, View view2) {
        ...
        if (view != null && view2 != null) {
            ...
            float f10 = 0.0f;
            LinearLayout linearLayout = this.f30623b;
            ...
            if (rectF.bottom >= rectF.top) {
                ll0.O0(canvas, rectF, AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f), view.getAlpha(), this.f30622a);
            }
        }
    }
            ...
            if (childAt.getVisibility() == 0) {
                if (childAt instanceof LinearLayout) {
                    ...
                    if (linearLayout.getOrientation() == 1) {
                        LinearLayout linearLayout2 = this.f30623b;
    ...
    public final float c(View view) {
        if (view != this.f30623b && (view.getParent() instanceof View)) {
    ...
    public final void onScrollChanged(int i10, int i11, int i12, int i13) {
        ...
        ArrayList arrayList = this.f30625f;
        int size = arrayList.size();
        int i14 = 0;
        while (i14 < size) {
