...
public class zn0 extends ScrollView {
    ...
    public static boolean e(View view) {
        if (!Objects.equals(view.getTag(), -33024) && !(view instanceof org.telegram.ui.Cells.f9) && !(view instanceof org.telegram.ui.Cells.a7) && !(view instanceof org.telegram.ui.y10)) {
            return true;
        }
        return false;
    }
    ...
    public final void a(Canvas canvas, View view, View view2) {
        ...
        if (view != null && view2 != null) {
            ...
            float f10 = 0.0f;
            LinearLayout linearLayout = this.f30627b;
            ...
            if (rectF.bottom >= rectF.top) {
                ml0.O0(canvas, rectF, AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f), view.getAlpha(), this.f30626a);
            }
        }
    }
            ...
            if (childAt.getVisibility() == 0) {
                if (childAt instanceof LinearLayout) {
                    ...
                    if (linearLayout.getOrientation() == 1) {
                        LinearLayout linearLayout2 = this.f30627b;
    ...
    public final float c(View view) {
        if (view != this.f30627b && (view.getParent() instanceof View)) {
