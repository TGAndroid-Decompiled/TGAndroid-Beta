...
public final class tt0 extends kl0 {
    ...
    public jn0 f30703e;
    public int f30705n;
    public final int f30706r;
    public int f30707s;
    public final xu0 v;
    public ArrayList d = new ArrayList();
    public ArrayList f30704f = new ArrayList();
    public int h = 0;
    ...
    public final boolean D(s4.c1 c1Var) {
        if (this.f30704f.size() + this.d.size() != 0) {
            return true;
        }
        return false;
    }
    ...
    public final MessageObject E(int i10) {
        ...
        return (MessageObject) this.f30704f.get(i10 - this.d.size());
    }

    public final void F(final int i10, final String str, long j3, long j10) {
        org.telegram.ui.ActionBar.n2 n2Var = this.v.f32727v1;
                        ...
                        if (tL_error == null) {
                            ...
                            for (int i13 = 0; i13 < messages_messages.messages.size(); i13++) {
                                ...
                                if (i14 == 0 || message.f19890id <= i14) {
                                    arrayList.add(new MessageObject(tt0Var.v.f32727v1.getCurrentAccount(), message, false, true));
                                }
                            }
                        }
    ...
    public final void G(String str, boolean z10) {
        jn0 jn0Var = this.f30703e;
        if (jn0Var != null) {
            AndroidUtilities.cancelRunOnUIThread(jn0Var);
            this.f30703e = null;
        }
        if (!this.d.isEmpty() || !this.f30704f.isEmpty()) {
            this.d.clear();
            this.f30704f.clear();
            l();
        }
        ...
        xu0 xu0Var = this.v;
        if (isEmpty) {
            if (!this.d.isEmpty() || !this.f30704f.isEmpty() || this.f30707s != 0) {
                this.d.clear();
                this.f30704f.clear();
                if (this.h != 0) {
                    xu0Var.f32727v1.getConnectionsManager().cancelRequest(this.h, true);
                    this.h = 0;
                    this.f30707s--;
                    return;
                }
        ...
        while (true) {
            ...
            if (i10 < qt0VarArr.length) {
                ...
                if (qt0Var.F == this.f30706r) {
                    qt0Var.f29824w.e(true, z10);
                }
                i10++;
            } else {
                jn0 jn0Var2 = new jn0(9, this, str);
                this.f30703e = jn0Var2;
