...
public final class tt0 extends rl0 {
    ...
    public final boolean D(f2.l1 l1Var) {
        if (this.f29037f.size() + this.d.size() != 0) {
            return true;
        }
        return false;
    }
    ...
    public final MessageObject E(int i10) {
        ...
        return (MessageObject) this.f29037f.get(i10 - this.d.size());
    }

    public final void F(final int i10, final String str, long j10, long j11) {
        org.telegram.ui.ActionBar.p2 p2Var = this.v.f31144s1;
                    ...
                    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                        ...
                        if (tL_error == null) {
                            ...
                            for (int i13 = 0; i13 < messages_messages.messages.size(); i13++) {
                                ...
                                int i14 = i10;
                                if (i14 == 0 || message.f19205id <= i14) {
                                    arrayList.add(new MessageObject(tt0Var.v.f31144s1.getCurrentAccount(), message, false, true));
                                }
                            }
                        }
    ...
    public final void G(String str, boolean z4) {
        ...
        if (!this.d.isEmpty() || !this.f29037f.isEmpty()) {
            this.d.clear();
            this.f29037f.clear();
            l();
        }
        ...
        yu0 yu0Var = this.v;
        if (isEmpty) {
            if (!this.d.isEmpty() || !this.f29037f.isEmpty() || this.f29040s != 0) {
                this.d.clear();
                this.f29037f.clear();
                if (this.h != 0) {
                    yu0Var.f31144s1.getConnectionsManager().cancelRequest(this.h, true);
                    this.h = 0;
                    this.f29040s--;
                    return;
                }
        ...
        while (true) {
            ...
            if (i10 < qt0VarArr.length) {
                ...
                if (qt0Var.C == this.f29039r) {
                    qt0Var.f28244w.e(true, z4);
                }
                i10++;
            } else {
