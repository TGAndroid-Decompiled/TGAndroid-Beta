...
public final class gd {
    public static final int[] f24417p = {16842910, 16842919};
    public vq f24418a;
    public final ArrayList f24419b = new ArrayList();
    public int f24420c;
    public boolean d;
    public final org.telegram.ui.Cells.z e;
    public final View f24421f;
    public final Paint f24422g;
    public Runnable h;
    public boolean f24423i;
    public Runnable f24424j;
    public final org.telegram.ui.Cells.t6 f24425k;
    public boolean f24426l;
    public final CornerPathEffect f24427m;
    public boolean f24428n;
    public final Paint f24429o;

    public gd(View view) {
        Paint paint = new Paint(1);
        this.f24422g = paint;
        this.f24425k = new org.telegram.ui.Cells.t6(this, 6);
        this.f24421f = view;
        CornerPathEffect cornerPathEffect = new CornerPathEffect(AndroidUtilities.dp(12.0f));
        this.f24427m = cornerPathEffect;
        ...
        paint3.setColor(-1);
        ?? rippleDrawable = new RippleDrawable(new ColorStateList(new int[][]{StateSet.WILD_CARD}, new int[]{org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19134i6, false) & 436207615}), null, new fd(this, paint3));
        this.e = rippleDrawable;
        rippleDrawable.setCallback(view);
    }

    public final void a(RectF rectF) {
        int i10 = this.f24420c + 1;
        this.f24420c = i10;
        ArrayList arrayList = this.f24419b;
        if (i10 > arrayList.size()) {
            arrayList.add(new RectF());
        }
        ((RectF) arrayList.get(this.f24420c - 1)).set(rectF);
    }
    ...
    public final boolean b(MotionEvent motionEvent) {
        ...
        View view = this.f24421f;
        org.telegram.ui.Cells.t6 t6Var = this.f24425k;
        org.telegram.ui.Cells.z zVar = this.e;
        if (action == 0) {
            for (int i10 = 0; i10 < this.f24420c; i10++) {
                float f7 = x10;
                float f10 = y3;
                if (((RectF) this.f24419b.get(i10)).contains(f7, f10)) {
                    this.d = true;
                    if (zVar != null) {
                        zVar.setHotspot(f7, f10);
                        zVar.setState(f24417p);
                    }
    ...
    public final void c(Canvas canvas, Paint paint) {
        ...
        CornerPathEffect cornerPathEffect = this.f24427m;
        org.telegram.ui.Cells.z zVar = this.e;
        int i11 = 0;
        ArrayList arrayList = this.f24419b;
        if (i10 > 1) {
            if (!this.f24423i) {
                vq vqVar = this.f24418a;
                if (vqVar == null) {
                    this.f24418a = new vq(0);
                } else {
                    vqVar.rewind();
                }
                int i12 = 0;
                ...
                while (true) {
                    ...
                    this.f24418a.addRect((RectF) arrayList.get(i11), Path.Direction.CCW);
                    if (zVar != null) {
