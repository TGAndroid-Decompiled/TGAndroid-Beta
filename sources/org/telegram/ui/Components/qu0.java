...
public final class qu0 extends ul0 {
    public final Context f27664c;
    public final int d;
    public final org.telegram.ui.ActionBar.f6 e;
    public final ou0 f27665f;
    public final ArrayList h = new ArrayList(10);
    public final ArrayList f27666n = new ArrayList();
    public bu0 f27667r;
    public final jv0 f27668s;
    ...
    public qu0(jv0 jv0Var, Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.d = i10;
        this.e = f6Var;
        this.f27665f = new ou0(this, i10, f6Var);
        E();
    }
    ...
    public final void E() {
        ArrayList arrayList = this.f27666n;
        arrayList.clear();
        ArrayList c10 = this.f27668s.f25524t1[8].c();
        int i10 = 0;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        if (i10 == 0) {
            pu0 pu0Var = new pu0(this.f27664c, this.d, false, null, this.e);
            pu0Var.setDelegate(this.f27665f);
            return new s4.c1(pu0Var);
        }
        return new s4.c1(new org.telegram.ui.Cells.w0(this.f27664c, this.e, false));
    }
}
