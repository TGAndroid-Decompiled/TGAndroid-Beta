...
public final class fn implements ui {
    public final org.telegram.ui.ActionBar.m2 f24217a;
    public final Utilities.Callback f24218b;
    public final dn f24219c;

    public fn(Utilities.Callback callback, org.telegram.ui.ActionBar.m2 m2Var, dn dnVar) {
        this.f24217a = m2Var;
        this.f24218b = callback;
        this.f24219c = dnVar;
    }

    @Override
    public final void B1(int i10, boolean z10, boolean z11, int i11, int i12, long j3, boolean z12, boolean z13, long j10) {
        dn dnVar = this.f24219c;
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = dnVar.f30017j0;
        Utilities.Callback callback = this.f24218b;
        if (i10 == 15) {
            org.telegram.ui.ActionBar.m2 m2Var = this.f24217a;
    ...
    public final void x0(hh hhVar) {
        NotificationCenter.getInstance(this.f24217a.getCurrentAccount()).doOnIdle(hhVar);
    }
