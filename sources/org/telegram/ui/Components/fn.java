...
public final class fn extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.f28508a) {
            ...
            case 7:
                super.onDraw(canvas);
                canvas.drawLine(0.0f, AndroidUtilities.dp(14.0f), 2.0f, getMeasuredHeight() - AndroidUtilities.dp(14.0f), org.telegram.ui.ActionBar.g6.f23183k0);
                return;
            case 14:
            ...
            case 15:
                ...
                canvas.drawLine(dp2, measuredHeight2, measuredWidth2 - i11, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.g6.f23183k0);
                return;
            case 16:
                if (LocaleController.isRTL) {
                    dp3 = 0.0f;
                ...
                canvas.drawLine(dp3, measuredHeight3, measuredWidth3 - i12, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.g6.f23183k0);
                return;
            case 17:
                if (LocaleController.isRTL) {
                    dp4 = 0.0f;
                ...
                canvas.drawLine(dp4, measuredHeight4, measuredWidth4 - i13, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.g6.f23183k0);
                return;
            case 25:
                if (LocaleController.isRTL) {
                    dp5 = 0.0f;
                ...
                canvas.drawLine(dp5, measuredHeight5, measuredWidth5 - i14, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.g6.f23183k0);
                return;
            default:
                super.onDraw(canvas);
                return;
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.f28508a) {
            ...
            case 9:
                ...
                super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec((int) (f11 * f9), 1073741824));
                return;
            case 10:
