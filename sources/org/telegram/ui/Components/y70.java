...
public final class y70 {
    ...
    public boolean Y;
    public boolean Z;
    public final ViewGroup f30523a;
    public float f30524a0;
    public ViewGroup f30525b;
    public float f30526b0;
    public final org.telegram.ui.ActionBar.m2 f30527c;
    public boolean f30528c0;
    public final org.telegram.ui.ActionBar.d6 d;
    public boolean f30529d0;
    public final Context e;
    public View f30530e0;
    public final View f30531f;
    public o70 f30532f0;
    public Drawable f30533g;
    public p70 f30534g0;
    public int h;
    public final int[] f30535h0;
    public int f30536i;
    public Integer f30537i0;
    public boolean f30538j;
    public Integer f30539j0;
    public int f30540k;
    public Integer f30541k0;
    public int f30542l;
    public Integer f30543l0;
    public t70 f30544m;
    public ValueAnimator m0;
    public fh.b f30545n;
    public boolean f30546n0;
    public final float[] f30547o;
    public wr f30548o0;
    public Runnable f30549p;
    public View f30550p0;
    public float f30551q;
    public final int[] f30552q0;
    public float f30553r;
    public int f30554s;
    public boolean f30555t;
    public boolean f30556u;
    public boolean v;
    public boolean f30557w;
    public w70 f30558x;
    public st f30559y;
    public final Rect f30560z;

    public y70(org.telegram.ui.ActionBar.m2 m2Var, View view, boolean z10, boolean z11) {
        org.telegram.ui.ActionBar.b5 parentLayout;
        this.f30536i = 5;
        this.f30547o = new float[2];
        this.f30555t = true;
        this.f30557w = true;
        this.f30560z = new Rect();
        this.J = true;
        this.K = -4;
        this.f30535h0 = new int[2];
        this.f30552q0 = new int[2];
        ...
        this.f30531f = view;
        this.f30554s = ((double) AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19059d6, resourceProvider))) > 0.705d ? 102 : 51;
        this.E = z10;
        this.G = z11;
        this.F = false;
        B();
    ...
    public static void a(y70 y70Var, ViewGroup viewGroup) {
        ...
        ValueAnimator ofFloat = ValueAnimator.ofFloat(w70Var.f29915w, 0.0f);
        y70Var.m0 = ofFloat;
    ...
    public final void C() {
        N();
        View view = this.f30531f;
        if (view == null) {
            return;
        }
        this.f30530e0 = view;
        view.getLocationOnScreen(this.f30535h0);
        this.f30532f0 = new ViewTreeObserver.OnScrollChangedListener() {
            @Override
            public final void onScrollChanged() {
                t70 t70Var;
                y70 y70Var = y70.this;
                if (y70Var.f30530e0 != null && (t70Var = y70Var.f30544m) != null && t70Var.isShowing()) {
                    int[] iArr = new int[2];
                    y70Var.f30530e0.getLocationOnScreen(iArr);
                    int i10 = iArr[0];
                    int[] iArr2 = y70Var.f30535h0;
        ...
        this.f30530e0.getViewTreeObserver().addOnScrollChangedListener(this.f30532f0);
        p70 p70Var = new p70(this, 0);
        this.f30534g0 = p70Var;
        this.f30530e0.addOnLayoutChangeListener(p70Var);
    }

    public final boolean D() {
        t70 t70Var = this.f30544m;
    ...
    public final void N() {
        View view = this.f30530e0;
        if (view != null) {
            if (this.f30532f0 != null) {
                ViewTreeObserver viewTreeObserver = view.getViewTreeObserver();
                if (viewTreeObserver.isAlive()) {
                    viewTreeObserver.removeOnScrollChangedListener(this.f30532f0);
                }
            }
            p70 p70Var = this.f30534g0;
            if (p70Var != null) {
                this.f30530e0.removeOnLayoutChangeListener(p70Var);
            }
        }
        this.f30532f0 = null;
        this.f30534g0 = null;
    ...
    public final void O() {
        ...
        int y3;
        t70 t70Var = this.f30544m;
        if (t70Var != null && t70Var.isShowing() && (view = this.f30531f) != null && (viewGroup = this.f30525b) != null && this.A != null && this.D != null) {
            float[] fArr = this.f30547o;
            ...
            float f14 = x10 + this.f30551q;
            this.f30524a0 = f14;
            float f15 = y3 + this.f30553r;
            this.f30526b0 = f15;
            this.f30544m.update((int) f14, (int) f15, -1, -1);
        }
    }
    ...
    public final void R(ja jaVar, float f7, float f10) {
        ...
        if (viewGroup instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
            viewGroup.setBackground(new ma(new na(jaVar, viewGroup, 5, false), this.A.getX() + this.f30524a0 + f7, this.A.getY() + this.f30526b0 + f10, mutate, AndroidUtilities.dp(12.0f)));
            return;
        }
        for (int i10 = 0; i10 < this.A.getChildCount(); i10++) {
            View childAt = this.A.getChildAt(i10);
            if (childAt instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                childAt.setBackground(new ma(new na(jaVar, childAt, 5, false), this.A.getX() + this.f30524a0 + f7 + childAt.getX(), this.A.getY() + this.f30526b0 + f10 + childAt.getY(), mutate, AndroidUtilities.dp(12.0f)));
            }
        }
    }
    ...
    public final void S(int i10, int i11) {
        View childAt;
        this.f30539j0 = Integer.valueOf(i10);
        this.f30541k0 = Integer.valueOf(i11);
    ...
    public final void T(int i10) {
        View childAt;
        this.f30537i0 = Integer.valueOf(i10);
        if (this.A != null) {
            for (int i11 = 0; i11 < this.A.getChildCount(); i11++) {
                if (i11 == this.A.getChildCount() - 1) {
                    childAt = this.D;
    ...
    public final void X(float f7) {
        t70 t70Var = this.f30544m;
        if (t70Var != null) {
            t70Var.update((int) this.f30524a0, (int) (this.f30526b0 + f7), -1, -1);
        }
    }
    ...
    public final void b0(int i10, int i11) {
        ...
        View view2 = this.f30550p0;
        if (view2 != null) {
            int[] iArr = this.f30552q0;
            view2.getLocationOnScreen(iArr);
            this.f30550p0.drawableHotspotChanged(i10 - iArr[0], i11 - iArr[1]);
        }
    }
    ...
    public final void u() {
        ...
        Runnable runnable = this.f30549p;
        if (runnable != null) {
            runnable.run();
        }
    }
    ...
    public y70(ViewGroup viewGroup, org.telegram.ui.ActionBar.d6 d6Var, View view, boolean z10, boolean z11, boolean z12) {
        ...
        this.f30523a = viewGroup;
        this.d = d6Var;
        this.e = viewGroup.getContext();
        this.f30531f = view;
        this.f30554s = ((double) AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19059d6, d6Var))) > 0.705d ? 102 : 51;
        this.E = z10;
        this.F = z11;
        this.G = z12;
        B();
