...
public final class y70 {
    ...
    public boolean Y;
    public boolean Z;
    public final ViewGroup f30537a;
    public float f30538a0;
    public ViewGroup f30539b;
    public float f30540b0;
    public final org.telegram.ui.ActionBar.n2 f30541c;
    public boolean f30542c0;
    public final org.telegram.ui.ActionBar.f6 d;
    public boolean f30543d0;
    public final Context e;
    public View f30544e0;
    public final View f30545f;
    public o70 f30546f0;
    public Drawable f30547g;
    public p70 f30548g0;
    public int h;
    public final int[] f30549h0;
    public int f30550i;
    public Integer f30551i0;
    public boolean f30552j;
    public Integer f30553j0;
    public int f30554k;
    public Integer f30555k0;
    public int f30556l;
    public Integer f30557l0;
    public t70 f30558m;
    public ValueAnimator m0;
    public fh.b f30559n;
    public boolean f30560n0;
    public final float[] f30561o;
    public vr f30562o0;
    public Runnable f30563p;
    public View f30564p0;
    public float f30565q;
    public final int[] f30566q0;
    public float f30567r;
    public int f30568s;
    public boolean f30569t;
    public boolean f30570u;
    public boolean v;
    public boolean f30571w;
    public w70 f30572x;
    public rt f30573y;
    public final Rect f30574z;

    public y70(org.telegram.ui.ActionBar.n2 n2Var, View view, boolean z10, boolean z11) {
        org.telegram.ui.ActionBar.d5 parentLayout;
        this.f30550i = 5;
        this.f30561o = new float[2];
        this.f30569t = true;
        this.f30571w = true;
        this.f30574z = new Rect();
        this.J = true;
        this.K = -4;
        this.f30549h0 = new int[2];
        this.f30566q0 = new int[2];
        ...
        this.f30545f = view;
        this.f30568s = ((double) AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19109d6, resourceProvider))) > 0.705d ? 102 : 51;
        this.E = z10;
        this.G = z11;
        this.F = false;
        B();
    ...
    public static void a(y70 y70Var, ViewGroup viewGroup) {
        ...
        ValueAnimator ofFloat = ValueAnimator.ofFloat(w70Var.f29961w, 0.0f);
        y70Var.m0 = ofFloat;
    ...
    public static void f(y70 y70Var, ai.x8 x8Var, final HashSet hashSet, boolean z10, Runnable runnable, final Utilities.Callback callback) {
        ...
        while (i11 < size) {
            ...
            TLRPC.Photo photo = e9Var.f772c;
            if (photo != null && (arrayList = photo.sizes) != null) {
                f1Var2.h(e9Var.f771b, ImageLocation.getForObject(FileLoader.getClosestPhotoSizeWithSize(e9Var.f772c.sizes, AndroidUtilities.dp(24.0f), false, FileLoader.getClosestPhotoSizeWithSize(arrayList, 50), true), e9Var.f772c), "50_50", null, null);
                obj = null;
            } else {
                obj = null;
                f1Var2.g(e9Var.f771b, R.drawable.msg_folders, null);
            }
    ...
    public final void C() {
        N();
        View view = this.f30545f;
        if (view == null) {
            return;
        }
        this.f30544e0 = view;
        view.getLocationOnScreen(this.f30549h0);
        this.f30546f0 = new ViewTreeObserver.OnScrollChangedListener() {
            @Override
            public final void onScrollChanged() {
                t70 t70Var;
                y70 y70Var = y70.this;
                if (y70Var.f30544e0 != null && (t70Var = y70Var.f30558m) != null && t70Var.isShowing()) {
                    int[] iArr = new int[2];
                    y70Var.f30544e0.getLocationOnScreen(iArr);
                    int i10 = iArr[0];
                    int[] iArr2 = y70Var.f30549h0;
        ...
        this.f30544e0.getViewTreeObserver().addOnScrollChangedListener(this.f30546f0);
        p70 p70Var = new p70(this, 0);
        this.f30548g0 = p70Var;
        this.f30544e0.addOnLayoutChangeListener(p70Var);
    }

    public final boolean D() {
        t70 t70Var = this.f30558m;
    ...
    public final void N() {
        View view = this.f30544e0;
        if (view != null) {
            if (this.f30546f0 != null) {
                ViewTreeObserver viewTreeObserver = view.getViewTreeObserver();
                if (viewTreeObserver.isAlive()) {
                    viewTreeObserver.removeOnScrollChangedListener(this.f30546f0);
                }
            }
            p70 p70Var = this.f30548g0;
            if (p70Var != null) {
                this.f30544e0.removeOnLayoutChangeListener(p70Var);
            }
        }
        this.f30546f0 = null;
        this.f30548g0 = null;
    ...
    public final void O() {
        ...
        int y3;
        t70 t70Var = this.f30558m;
        if (t70Var != null && t70Var.isShowing() && (view = this.f30545f) != null && (viewGroup = this.f30539b) != null && this.A != null && this.D != null) {
            float[] fArr = this.f30561o;
            ...
            float f14 = x10 + this.f30565q;
            this.f30538a0 = f14;
            float f15 = y3 + this.f30567r;
            this.f30540b0 = f15;
            this.f30558m.update((int) f14, (int) f15, -1, -1);
        }
    }
    ...
    public final void R(ia iaVar, float f7, float f10) {
        ...
        if (viewGroup instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
            viewGroup.setBackground(new la(new ma(iaVar, viewGroup, 5, false), this.A.getX() + this.f30538a0 + f7, this.A.getY() + this.f30540b0 + f10, mutate, AndroidUtilities.dp(12.0f)));
            return;
        }
        for (int i10 = 0; i10 < this.A.getChildCount(); i10++) {
            View childAt = this.A.getChildAt(i10);
            if (childAt instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                childAt.setBackground(new la(new ma(iaVar, childAt, 5, false), this.A.getX() + this.f30538a0 + f7 + childAt.getX(), this.A.getY() + this.f30540b0 + f10 + childAt.getY(), mutate, AndroidUtilities.dp(12.0f)));
            }
        }
    }
    ...
    public final void S(int i10, int i11) {
        View childAt;
        this.f30553j0 = Integer.valueOf(i10);
        this.f30555k0 = Integer.valueOf(i11);
    ...
    public final void T(int i10) {
        View childAt;
        this.f30551i0 = Integer.valueOf(i10);
        if (this.A != null) {
            for (int i11 = 0; i11 < this.A.getChildCount(); i11++) {
                if (i11 == this.A.getChildCount() - 1) {
                    childAt = this.D;
    ...
    public final void V(int i10) {
        ...
        if (i10 == 5 && this.E) {
            ViewGroup viewGroup = this.A;
            if (viewGroup instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                ((ActionBarPopupWindow$ActionBarPopupWindowLayout) viewGroup).f18661c = true;
            }
        }
    }

    public final void W(Drawable drawable) {
        this.f30547g = drawable;
        this.h = 0;
    ...
    public final void X(float f7) {
        t70 t70Var = this.f30558m;
        if (t70Var != null) {
            t70Var.update((int) this.f30538a0, (int) (this.f30540b0 + f7), -1, -1);
        }
    }
    ...
    public final void b0(int i10, int i11) {
        ...
        View view2 = this.f30564p0;
        if (view2 != null) {
            int[] iArr = this.f30566q0;
            view2.getLocationOnScreen(iArr);
            this.f30564p0.drawableHotspotChanged(i10 - iArr[0], i11 - iArr[1]);
        }
    }
    ...
    public final void d(org.telegram.ui.ActionBar.f1 f1Var) {
        ...
        f1Var.c(v02, v03);
        f1Var.setSelectorColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19064ai, f6Var));
        Integer num3 = this.f30557l0;
        if (num3 != null) {
            l1 = num3.intValue();
        } else {
    ...
    public final void e(int i10, boolean z10, Runnable runnable) {
        ...
        f1Var.f18858a.setPadding(dp, 0, i11, 0);
        ...
        f1Var.addView(v9Var, w7.y5.d(34, 34.0f, i12 | 16, -5.0f, 0.0f, -5.0f, 0.0f));
        org.telegram.ui.ActionBar.f6 f6Var = this.d;
        if (z10) {
    ...
    public final void g(TLObject tLObject, boolean z10, Runnable runnable) {
        ...
        if (tLObject instanceof TLRPC.Chat) {
            ...
            if (user.f18490id == UserConfig.getInstance(UserConfig.selectedAccount).getClientUserId()) {
        ...
        f1Var.f18858a.setPadding(dp, 0, i10, 0);
        v9 v9Var = new v9(context);
        g9 g9Var = new g9((org.telegram.ui.ActionBar.f6) null);
        g9Var.p(tLObject);
        v9Var.setRoundRadius(AndroidUtilities.dp(34.0f));
        ...
        f1Var.addView(v9Var, w7.y5.d(34, 34.0f, i11 | 16, -5.0f, 0.0f, -5.0f, 0.0f));
        org.telegram.ui.ActionBar.f6 f6Var = this.d;
        if (z10) {
            View view = new View(context);
            int dp2 = AndroidUtilities.dp(34.0f);
    ...
    public final void n(TLObject tLObject, String str, Runnable runnable) {
        ...
        org.telegram.messenger.rk.n(org.telegram.ui.ActionBar.j6.f19347q5, f6Var, h, 1, 13.0f);
    ...
    public final void p(int i10, int i11, CharSequence charSequence) {
        ...
        p4Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19216j5, this.d));
    ...
    public final void u() {
        ...
        Runnable runnable = this.f30563p;
        if (runnable != null) {
            runnable.run();
        }
    }
    ...
    public y70(ViewGroup viewGroup, org.telegram.ui.ActionBar.f6 f6Var, View view, boolean z10, boolean z11, boolean z12) {
        ...
        this.f30537a = viewGroup;
        this.d = f6Var;
        this.e = viewGroup.getContext();
        this.f30545f = view;
        this.f30568s = ((double) AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19109d6, f6Var))) > 0.705d ? 102 : 51;
        this.E = z10;
        this.F = z11;
        this.G = z12;
        B();
