...
public class m5 extends Drawable implements u5 {
    ...
    public final Rect K;
    public final ng L;
    public boolean f26054a;
    public final int f26055b;
    public final OvershootInterpolator f26056c;
    public final c6 d;
    public final c6 e;
    public final Drawable[] f26057f;
    public View h;
    public org.telegram.ui.i71 f26058n;
    public final boolean f26059r;
    public final int f26060s;
    public int v;
    public boolean f26061w;
    public Integer f26062x;
    public boolean f26063y;
    ...
    public final void a() {
        if (!this.f26061w) {
            this.f26061w = true;
            Drawable[] drawableArr = this.f26057f;
    ...
    public final Drawable c() {
        return this.f26057f[0];
    }

    public final boolean d() {
        if (this.f26057f[0] != null) {
            return false;
        }
        return true;
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        float e = this.e.e(this.f26063y);
        ng ngVar = this.L;
        if (e > 0.0f) {
            yh.k8 k8Var = this.E;
            k8Var.f47408c.set(rect);
            k8Var.e();
            this.E.d();
            yh.k8 k8Var2 = this.E;
            Integer num = this.F;
        ...
        if (drawableArr[0] != null) {
            ...
            OvershootInterpolator overshootInterpolator = this.f26056c;
            if (z10) {
                ai.l4 l4Var = ((o5) drawable3).f26639k;
                if (l4Var != null) {
    ...
    public final void f() {
        o5 o5Var;
        ai.l4 l4Var;
        Drawable drawable = this.f26057f[0];
        if ((drawable instanceof o5) && (l4Var = (o5Var = (o5) drawable).f26639k) != null) {
            o5Var.w(l4Var);
    ...
    public final void g(Drawable drawable, boolean z10) {
        ...
        if (z10) {
            ...
            Drawable drawable2 = drawableArr[1];
            if (drawable2 != null) {
                if (this.f26061w && (drawable2 instanceof o5)) {
                    ((o5) drawable2).p(this);
                }
                drawableArr[1] = null;
            }
    ...
    public void invalidate() {
        View view = this.h;
        if (view != null) {
            if (this.f26059r && (view.getParent() instanceof View)) {
                ((View) this.h.getParent()).invalidate();
            } else {
                this.h.invalidate();
            }
        }
        org.telegram.ui.i71 i71Var = this.f26058n;
        if (i71Var != null) {
            i71Var.invalidate();
        }
        invalidateSelf();
