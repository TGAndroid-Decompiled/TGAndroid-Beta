...
public final class m5 {
    public HashMap f26328a;
    public HashMap f26329b;
    public HashSet f26330c;
    public og d;
    public final int e;
                ...
                try {
                    ...
                    if (hashMap != null && (document = (TLRPC.Document) hashMap.get(Long.valueOf(j3))) != null) {
                        ...
                        if (this.f26329b == null) {
                            this.f26329b = new HashMap();
                        }
                        ArrayList arrayList = (ArrayList) this.f26329b.get(Long.valueOf(j3));
                        if (arrayList != null) {
                            arrayList.add(n5Var);
                            return;
                        }
                        ...
                        this.f26329b.put(Long.valueOf(j3), arrayList2);
                        if (this.f26330c == null) {
                            this.f26330c = new HashSet();
                        }
                        this.f26330c.add(Long.valueOf(j3));
                        if (this.d != null) {
                            return;
                        }
        ...
        if (a()) {
            ...
            for (int i10 = 0; i10 < arrayList.size(); i10++) {
                if (arrayList.get(i10) instanceof TLRPC.Document) {
                    ...
                    e(document);
                    HashMap hashMap = this.f26329b;
                    if (hashMap != null && (arrayList2 = (ArrayList) hashMap.remove(Long.valueOf(document.f18302id))) != null) {
        ...
        synchronized (this) {
            try {
                if (this.f26328a == null) {
                    this.f26328a = new HashMap();
                }
                this.f26328a.put(Long.valueOf(document.f18302id), document);
            } catch (Throwable th2) {
                throw th2;
            }
        }
