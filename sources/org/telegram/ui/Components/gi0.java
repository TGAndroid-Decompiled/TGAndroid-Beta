...
public final class gi0 extends View {
    ...
    public float K;
    public float L;
    public final org.telegram.ui.ActionBar.e6 f24393a;
    public final PorterDuffColorFilter f24394b;
    public final PorterDuffColorFilter f24395c;
    public v01 d;
    public v01 e;
    public final Paint f24396f;
    public final Paint h;
    public final Path f24397n;
    public final Drawable f24398r;
    public final RectF f24399s;
    public final Paint v;
    public final Paint f24400w;
    public final Path f24401x;
    public final yc f24402y;

    public gi0(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.f24394b = new PorterDuffColorFilter(-1, mode);
        this.f24395c = new PorterDuffColorFilter(-16777216, mode);
        this.f24396f = new Paint();
        Paint paint = new Paint();
        this.h = paint;
        Path path = new Path();
        this.f24397n = path;
        this.f24399s = new RectF();
        this.v = new Paint(1);
        this.f24400w = new Paint(1);
        this.f24401x = new Path();
        this.f24402y = new yc(this);
        this.E = -1;
        this.f24393a = e6Var;
        this.f24398r = context.getResources().getDrawable(R.drawable.files_music).mutate();
    ...
    public final void a() {
        ...
        this.E = i10;
        if (z10) {
            porterDuffColorFilter = this.f24395c;
        } else {
            porterDuffColorFilter = this.f24394b;
        }
        this.f24398r.setColorFilter(porterDuffColorFilter);
        this.f24396f.setColor(this.E);
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        RectF rectF = this.f24399s;
        yc ycVar = this.f24402y;
        if (action == 0) {
    ...
    public final void onDraw(Canvas canvas) {
        if (this.d != null && this.e != null) {
            ...
            float a2 = this.f24402y.a(0.02f);
            if (clamp01 > 0.0f) {
                int width = getWidth() - (AndroidUtilities.dp(12.0f) * 2);
                this.d.f28878p = (width - AndroidUtilities.dp(35.0f)) / 2.0f;
                this.e.f28878p = (width - this.d.l()) - AndroidUtilities.dp(35.0f);
                ...
                int i12 = i10 - i11;
                int i13 = i10 + i11;
                Drawable drawable = this.f24398r;
                ...
                canvas.drawPath(this.f24397n, paint3);
                canvas.restore();
                canvas.restore();
            }
        }
    ...
    public void setColor(MessagesController.PeerColor peerColor) {
        int bgColor1;
        int bgColor2;
        org.telegram.ui.ActionBar.e6 e6Var = this.f24393a;
        if (peerColor == null) {
            bgColor1 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19340s8, e6Var);
            bgColor2 = bgColor1;
        } else {
        ...
        if (peerColor == null) {
            this.G = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19062d6, e6Var);
            this.H = true;
        } else {
