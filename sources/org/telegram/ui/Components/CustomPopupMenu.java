...
public abstract class CustomPopupMenu {
    ...
    public CustomPopupMenu(Context context, Theme.ResourcesProvider resourcesProvider, boolean z) {
        ...
        this.popupLayout.setOnTouchListener(new ItemOptions$$ExternalSyntheticLambda1(this, 2));
        this.popupLayout.setDispatchKeyEventListener(new ColorPicker$$ExternalSyntheticLambda5(this, 1));
