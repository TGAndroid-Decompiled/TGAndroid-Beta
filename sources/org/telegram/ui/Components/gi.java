...
public final class gi extends AnimatorListenerAdapter {
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        switch (this.f24349a) {
            case 0:
                vi viVar = (vi) this.d;
                viVar.f28811y0.setAlpha(0.0f);
                viVar.f28811y0.setTranslationY(AndroidUtilities.dp(78.0f) + this.f24350b);
                ...
                o1.k kVar = new o1.k(viVar.f28814z0, o1.h.f15334n, 0.0f);
                kVar.f15351u.a(0.75f);
                kVar.f15351u.b(500.0f);
                kVar.b(new i7(this, 3));
                kVar.a(new ei.m4(3, this, (fh) this.f24351c));
                viVar.f28794t1 = kVar;
                kVar.f();
                return;
            case 1:
                a5.a aVar = (a5.a) this.d;
                ((ll0) aVar.d).scrollBy(0, this.f24350b - ((int[]) this.f24351c)[0]);
                aVar.f276c = null;
                return;
            default:
                yh.a4 a4Var = (yh.a4) this.d;
                a4Var.T1();
                yh.k2 k2Var = a4Var.f46955f0;
                int i13 = 8;
                int i14 = this.f24350b;
                if (i14 == 0) {
                    i10 = 0;
                } else {
                    i10 = 8;
                ...
                a4Var.s2();
                a4Var.Z0 = null;
                Runnable runnable = (Runnable) this.f24351c;
                if (runnable != null) {
                    runnable.run();
                    return;
                }
