...
public final class rs0 implements mm0 {
    ...
    public final void C() {
        ...
        if (st0Var.F == 0) {
            L0 = (st0Var.f27928x.L0() / zu0Var.f30638m1[0]) * a2;
        } else {
            L0 = st0Var.f27928x.L0() * a2;
        }
    ...
    public final boolean n1(int i10, View view) {
        ...
        if (o2Var != null && zu0.d0(i10, zu0Var.f30621d1 instanceof TLRPC.TL_channelFull) != null) {
            if (zu0Var.f30621d1 instanceof TLRPC.TL_channelFull) {
                if (ChatObject.canUserDoAction(o2Var.getMessagesController().getChat(Long.valueOf(zu0Var.f30621d1.f18122id)), 5)) {
                    profileTab = zu0Var.f30621d1.main_tab;
                    if (profileTab != null || (i10 != zu0.e0(profileTab) && zu0Var.R1 != i10)) {
                        n70 H = n70.H(o2Var, view);
                        H.W(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(24.0f), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18863d6, false)));
                        H.c(R.drawable.tabs_reorder, LocaleController.getString(R.string.ProfileTabSetAsMain), new id(this, i10, 9), false);
                        H.Z();
                        return true;
                    }
                }
            } else if (zu0Var.f30634j1 == o2Var.getUserConfig().getClientUserId() && (userFull = zu0Var.f30623e1) != null) {
                profileTab = userFull.main_tab;
                if (profileTab != null) {
                }
                n70 H2 = n70.H(o2Var, view);
                H2.W(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(24.0f), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18863d6, false)));
