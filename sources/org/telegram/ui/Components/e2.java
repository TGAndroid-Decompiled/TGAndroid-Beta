...
public final class e2 implements cd0, MediaDataController.KeywordResultCallback, BillingController.ProductDetailsResponseListenerLegacy, org.telegram.ui.ActionBar.z1, OnFailureListener, Utilities.Callback2Return {
    ...
    public final Object f23786c;
    public final Object d;
    public final Object e;
    public final Object f23787f;
    ...
    public void f(org.telegram.ui.ActionBar.a2 a2Var, int i10) {
        ...
        switch (this.f23784a) {
            case 3:
                ...
                org.telegram.ui.gn0.Z(this.f23785b, (String) this.f23787f, secureDocument, en0Var, (org.telegram.ui.gn0) this.f23786c);
                return;
            default:
                yh.c3 c3Var = (yh.c3) this.f23786c;
                Context context = (Context) this.d;
                org.telegram.ui.ActionBar.d6 d6Var = (org.telegram.ui.ActionBar.d6) this.e;
                Utilities.Callback2 callback2 = (Utilities.Callback2) this.f23787f;
                yh.a3 a3Var = (yh.a3) c3Var.f47254o.get(c3Var.f47256q);
                if (a3Var != null) {
                    zf.a aVar2 = a3Var.f47191c;
                    yh.t5 x10 = yh.t5.x(this.f23785b, c3Var.f47256q);
                    if (x10.e) {
                        aVar = zf.a.l(x10.p());
                    } else {
                        aVar = null;
                    }
                    if (aVar != null && aVar2.f49215b > aVar.f49215b) {
                        zf.b bVar = c3Var.f47256q;
                        if (bVar == zf.b.f49216a) {
                            new yh.l7(context, d6Var, aVar2.a(), 14, null, null, 0L).show();
                            return;
                        } else if (bVar == zf.b.f49217b) {
                            new di.h(context, d6Var, a3Var.f47191c, true, null).show();
                            return;
                        } else {
                            return;
                        }
    ...
    public void onProductDetailsResponse(c5.h hVar, List list) {
        AndroidUtilities.runOnUIThread(new gg.e1((org.telegram.ui.zf0) this.f23786c, (String) this.d, hVar, list, (String) this.e, (String) this.f23787f, this.f23785b));
    }

    @Override
    public void q(ed0 ed0Var, int i10) {
        ed0 ed0Var2 = (ed0) this.f23786c;
        d4 d4Var = (d4) this.d;
        e4 e4Var = (e4) this.e;
        e5.g(null, null, 0L, this.f23785b, 3, ed0Var2, d4Var, e4Var);
        e5.e((TextView) this.f23787f, ed0Var2, d4Var, e4Var);
    }

    @Override
    public void run(ArrayList arrayList, String str) {
        xy0 xy0Var = (xy0) this.f23786c;
        String str2 = (String) this.d;
        HashSet hashSet = (HashSet) this.e;
        ArrayList arrayList2 = (ArrayList) this.f23787f;
        if (this.f23785b != xy0Var.I) {
            return;
        }
        xy0Var.G = 1;
        xy0Var.H = str2;
    ...
    public e2(NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, Object obj, int i10, Object obj2, Object obj3, int i11) {
        this.f23784a = i11;
        this.f23786c = notificationCenterDelegate;
        this.d = obj;
        this.f23785b = i10;
        this.e = obj2;
        this.f23787f = obj3;
    ...
    public Object run(Object obj, Object obj2) {
        ...
        int i10;
        zr0 zr0Var = (zr0) this.f23786c;
        org.telegram.ui.ActionBar.m2 m2Var = (org.telegram.ui.ActionBar.m2) this.d;
        Context context = (Context) this.e;
        org.telegram.ui.ActionBar.d6 d6Var = (org.telegram.ui.ActionBar.d6) this.f23787f;
        ...
        if (num.intValue() != -1 && num.intValue() != -2 && num.intValue() != 0 && !zr0Var.L) {
            ...
            String publicUsername = DialogObject.getPublicUsername(MessagesController.getInstance(i12).getUserOrChat(zr0Var.f46384c));
            boolean h = j5Var.h();
