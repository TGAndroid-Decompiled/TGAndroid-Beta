...
public final class rn implements TextWatcher {
    ...
    public final void afterTextChanged(Editable editable) {
        ...
        switch (i10) {
            case 0:
                vn vnVar = ((tn) obj).d;
                qn qnVar = (qn) this.f28011c;
                if (qnVar.getTag() == null) {
                    s4.c1 K = vnVar.f29215s.K(vnVar.f29211p0);
                    if (K != null && vnVar.f29222x != null) {
                        ...
                        vnVar.f29222x.setDelegate(qnVar);
                        vnVar.f29222x.setTranslationY(K.f42961a.getY());
                        vnVar.f29222x.e();
                    }
                    vnVar.P = editable;
                    if (K != null) {
                        vn.L(vnVar, K.f42961a, vnVar.f29211p0);
                    }
                    vnVar.T();
                    return;
                }
            ...
            case 1:
                vn vnVar2 = ((tn) obj).d;
                wb1 wb1Var = vnVar2.f29215s;
                sn snVar = (sn) this.f28011c;
                ...
                if (c1Var != null) {
                    ...
                    int b10 = c1Var.b();
                    int i11 = b10 - vnVar2.f29217t0;
                    if (i11 >= 0 && i11 < vnVar2.K.length) {
                        if (vnVar2.f29222x != null) {
                            ...
                            if (y3 > 0.0f) {
                                vnVar2.f29222x.setDirection(0);
                                vnVar2.f29222x.setTranslationY(y3);
                            } else {
                                vnVar2.f29222x.setDirection(1);
                                vnVar2.f29222x.setTranslationY(view.getY());
                            }
                            vnVar2.f29222x.setDelegate(snVar);
                            vnVar2.f29222x.e();
                        }
            ...
            case 3:
                ...
                if (passcodeActivity.f31179x == 1 && passcodeActivity.E == 0) {
                    if (TextUtils.isEmpty(editable) && passcodeActivity.f31177s.getVisibility() != 8) {
                        if (((AtomicBoolean) this.f28011c).get()) {
            ...
            case 4:
                ...
                org.telegram.ui.mv0 mv0Var = (org.telegram.ui.mv0) this.f28011c;
            ...
            case 5:
                ...
                org.telegram.ui.nv0 nv0Var = (org.telegram.ui.nv0) this.f28011c;
            ...
            case 6:
                ...
                org.telegram.ui.ov0 ov0Var = (org.telegram.ui.ov0) this.f28011c;
            ...
            case 7:
                ...
                if (!vVar.e && ((String) this.f28011c) != null && editable != null && !TextUtils.isEmpty(editable) && !Objects.equals(((String) this.f28011c).toString(), editable.toString())) {
                ...
                return;
            case 8:
                ((String[]) this.f28011c)[0] = editable.toString();
                ((xh.h3) obj).Y2.N(true);
                return;
            case 9:
                ((String[]) this.f28011c)[0] = editable.toString();
    ...
    public final void beforeTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
        switch (this.f28009a) {
            ...
            case 1:
                return;
            case 2:
                EditText editText = (EditText) this.f28011c;
                editText.post(new org.telegram.ui.sq(this, editText, (AtomicReference) this.f28010b, 25));
                return;
            case 3:
            case 4:
            case 5:
            case 6:
                return;
            case 7:
                this.f28011c = charSequence.toString();
                return;
            case 8:
            case 9:
            case 10:
