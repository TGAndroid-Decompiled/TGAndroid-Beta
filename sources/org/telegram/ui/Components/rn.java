...
public final class rn extends org.telegram.ui.Cells.d6 {
    ...
    public final boolean e() {
        ...
        if (T != null) {
            int b10 = T.b();
            int i10 = unVar.M;
            if (i10 == unVar.J && b10 == (unVar.f28462t0 + i10) - 1) {
                return false;
            }
        }
        return true;
    ...
    public final boolean f(org.telegram.ui.Cells.d6 d6Var) {
        ...
        if (T != null && (b10 = T.b()) != -1) {
            return unVar.L[b10 - unVar.f28462t0];
        }
        return false;
    }
    ...
    public final void g(org.telegram.ui.Cells.c6 c6Var, ActionMode actionMode) {
        un unVar = this.F.d;
        if (unVar.f28453n && c6Var.isFocused() && c6Var.hasSelection()) {
    ...
    public final void h(org.telegram.ui.Cells.d6 d6Var, boolean z10) {
        ...
        int b10;
        un unVar = this.F.d;
        if (z10 && unVar.f28434c0 && !unVar.f28432b0) {
            Arrays.fill(unVar.L, false);
            unVar.f28460s.getChildCount();
            for (int i10 = unVar.f28462t0; i10 < unVar.f28462t0 + unVar.M; i10++) {
        ...
        if (T != null && (b10 = T.b()) != -1) {
            unVar.L[b10 - unVar.f28462t0] = z10;
        }
        unVar.T();
    }
    ...
    public final void k(org.telegram.ui.Cells.c6 c6Var) {
        this.F.d.f26461b.t1(c6Var, true);
    }
    ...
    public final boolean l(ArrayList arrayList) {
        ...
        if (!arrayList.isEmpty()) {
            unVar.f28460s.getClass();
            int R = RecyclerView.R(this) - unVar.f28462t0;
            if (R >= 0) {
