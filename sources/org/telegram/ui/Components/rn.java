...
public final class rn implements TextWatcher {
    ...
    public final Object f28001b;
    public Object f28002c;
    ...
    public final void afterTextChanged(Editable editable) {
        ...
        switch (i10) {
            case 0:
                vn vnVar = ((tn) obj).d;
                qn qnVar = (qn) this.f28002c;
                if (qnVar.getTag() == null) {
                    s4.c1 K = vnVar.f29205s.K(vnVar.f29201p0);
                    if (K != null && vnVar.f29212x != null) {
                        ...
                        vnVar.f29212x.setDelegate(qnVar);
                        vnVar.f29212x.setTranslationY(K.f42946a.getY());
                        vnVar.f29212x.e();
                    }
                    vnVar.P = editable;
                    if (K != null) {
                        vn.L(vnVar, K.f42946a, vnVar.f29201p0);
                    }
                    vnVar.T();
                    return;
                }
            ...
            case 1:
                vn vnVar2 = ((tn) obj).d;
                wb1 wb1Var = vnVar2.f29205s;
                sn snVar = (sn) this.f28002c;
                ...
                if (c1Var != null) {
                    ...
                    int b10 = c1Var.b();
                    int i11 = b10 - vnVar2.f29207t0;
                    if (i11 >= 0 && i11 < vnVar2.K.length) {
                        if (vnVar2.f29212x != null) {
                            ...
                            if (y3 > 0.0f) {
                                vnVar2.f29212x.setDirection(0);
                                vnVar2.f29212x.setTranslationY(y3);
                            } else {
                                vnVar2.f29212x.setDirection(1);
                                vnVar2.f29212x.setTranslationY(view.getY());
                            }
                            vnVar2.f29212x.setDelegate(snVar);
                            vnVar2.f29212x.e();
                        }
            ...
            case 3:
                ...
                if (passcodeActivity.f31164x == 1 && passcodeActivity.E == 0) {
                    if (TextUtils.isEmpty(editable) && passcodeActivity.f31162s.getVisibility() != 8) {
                        if (((AtomicBoolean) this.f28002c).get()) {
                            passcodeActivity.f31162s.callOnClick();
                        }
                        AndroidUtilities.updateViewVisibilityAnimated(passcodeActivity.f31162s, false, 0.1f, true);
                        return;
                    } else if (!TextUtils.isEmpty(editable) && passcodeActivity.f31162s.getVisibility() != 0) {
                        AndroidUtilities.updateViewVisibilityAnimated(passcodeActivity.f31162s, true, 0.1f, true);
                        return;
                    } else {
                        return;
                    }
            ...
            case 4:
                ...
                org.telegram.ui.mv0 mv0Var = (org.telegram.ui.mv0) this.f28002c;
                if (mv0Var.getTag() == null) {
                    s4.c1 K2 = rv0Var.f37485c.K(rv0Var.f37493i0);
                    if (K2 != null && rv0Var.Q != null) {
                        ...
                        rv0Var.Q.setTranslationY(K2.f42946a.getY());
                        rv0Var.Q.e();
                    }
                    rv0Var.E = editable;
                    if (K2 != null) {
                        org.telegram.ui.rv0.c0(rv0Var, K2.f42946a, rv0Var.f37493i0);
                    }
                    rv0Var.i0();
                    return;
                }
            ...
            case 5:
                ...
                org.telegram.ui.nv0 nv0Var = (org.telegram.ui.nv0) this.f28002c;
                if (nv0Var.getTag() == null) {
                    s4.c1 K3 = rv0Var2.f37485c.K(rv0Var2.f37493i0);
                    if (K3 != null && rv0Var2.Q != null) {
                        ...
                        rv0Var2.Q.setTranslationY(K3.f42946a.getY());
                        rv0Var2.Q.e();
                    }
                    rv0Var2.F = editable;
                    if (K3 != null) {
                        org.telegram.ui.rv0.c0(rv0Var2, K3.f42946a, rv0Var2.f37494j0);
                    }
                    rv0Var2.i0();
                    return;
                }
            ...
            case 6:
                ...
                wb1 wb1Var2 = rv0Var3.f37485c;
                org.telegram.ui.ov0 ov0Var = (org.telegram.ui.ov0) this.f28002c;
                ...
                if (c1Var != null) {
                    ...
                    int b11 = c1Var.b() - rv0Var3.f37498n0;
            ...
            case 7:
                ...
                if (!vVar.e && ((String) this.f28002c) != null && editable != null && !TextUtils.isEmpty(editable) && !Objects.equals(((String) this.f28002c).toString(), editable.toString())) {
                ...
                return;
            case 8:
                ((String[]) this.f28002c)[0] = editable.toString();
                ((xh.h3) obj).Y2.N(true);
                return;
            case 9:
                ((String[]) this.f28002c)[0] = editable.toString();
    ...
    public final void beforeTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
        switch (this.f28000a) {
            ...
            case 1:
                return;
            case 2:
                EditText editText = (EditText) this.f28002c;
                editText.post(new org.telegram.ui.sq(this, editText, (AtomicReference) this.f28001b, 25));
                return;
            case 3:
            case 4:
            case 5:
            case 6:
                return;
            case 7:
                this.f28002c = charSequence.toString();
                return;
            case 8:
            case 9:
            case 10:
