...
public final class wl implements CameraView.CameraViewDelegate {
    public final ChatAttachAlertPhotoLayout f30060a;

    public wl(ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout) {
        this.f30060a = chatAttachAlertPhotoLayout;
    }
    ...
    public final void onCameraInit() {
        ...
        float f7;
        int i11;
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.f30060a;
        ...
        if (currentFlashMode != null && nextFlashMode != null) {
            ...
            if (currentFlashMode.equals(nextFlashMode)) {
                ...
                for (int i14 = 0; i14 < 2; i14++) {
                    ...
                    if (i14 == 0 && chatAttachAlertPhotoLayout.f22091b0) {
                        f7 = 1.0f;
                    } else {
                        f7 = 0.0f;
                    }
