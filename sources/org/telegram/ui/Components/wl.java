...
public final class wl extends em {
    ...
    public final void D() {
        ...
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = this.f30101c;
    ...
    public final void o(int i10, VideoEditedInfo videoEditedInfo, boolean z10, int i11, int i12, boolean z11) {
        ...
        if (!arrayList.isEmpty() && !wiVar.V) {
            ...
            e5.a0(wiVar.J1, wiVar.j1() + ChatAttachAlertPhotoLayout.f22122s1.size(), wiVar.n1(), new rl(this, z11, z10, i11));
        }
    }
    ...
    public final boolean u() {
        ...
        if (chatAttachAlertPhotoLayout.f22161t0) {
            ...
            if (arrayList.size() == 1) {
                ...
                chatAttachAlertPhotoLayout.f27043b.V1(0);
            }
        }
        return true;
    }
