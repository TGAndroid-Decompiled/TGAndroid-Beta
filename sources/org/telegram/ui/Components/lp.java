...
public final class lp extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    public static final int f28281i0 = 0;
    ...
    public ah.w Z;
    public q6 f28282a0;
    public final ImageView f28283b;
    public boolean f28284b0;
    public final org.telegram.ui.ActionBar.g2 f28285c;
    public nq f28286c0;
    public final TextView d;
    public boolean f28287d0;
    public final TextView f28288e;
    public boolean f28289e0;
    public TLRPC.WallPaper f28290f;
    public TL_stories.TL_premium_boostsStatus f28291f0;
    public float f28292g0;
    public final jp h;
    public ValueAnimator f28293h0;
    public final org.telegram.ui.ao f28294n;
    public final org.telegram.ui.ActionBar.d4 f28295r;
    public final boolean f28296s;
    public final org.telegram.ui.co v;
    public final ll0 f28297w;
    public final s4.c0 f28298x;
    public final t00 f28299y;
    ...
    public lp(org.telegram.ui.co coVar, org.telegram.ui.ao aoVar) {
        ...
        this.v = coVar;
        this.f28294n = aoVar;
        this.f28295r = aoVar.f34517f;
        this.f28290f = aoVar.h;
        this.f28296s = org.telegram.ui.ActionBar.j6.I.q();
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            int i10 = org.telegram.ui.ActionBar.j6.f20779i5;
            ...
            fixNavigationBar(getThemedColor(org.telegram.ui.ActionBar.j6.f20779i5));
        }
    ...
    public static void o(lp lpVar, View view, int i10) {
        ...
        if (jpVar.d.get(i10) != lpVar.M && lpVar.R == null) {
            ...
            if (!((kp) jpVar.d.get(i10)).f27909a.f20388a) {
                ((t11) view).d();
            }
            lpVar.F(true);
        }
    ...
    public static void q(lp lpVar, wd1 wd1Var) {
        ...
        obj.f21169a = true;
        org.telegram.ui.co coVar = lpVar.v;
        wd1Var.f41941a.f41925a = coVar.getResourceProvider();
        wd1Var.f41985p1 = new dp(lpVar);
        obj.f21171c = new ue(4);
        obj.d = new to(lpVar, 5);
        obj.f21170b = new to(lpVar, 6);
        obj.f21172e = true;
        lpVar.X = wd1Var;
    ...
    public final void A(boolean z10) {
        ...
        s4.c0 c0Var = this.f28298x;
        ll0 ll0Var = this.f28297w;
        if (d4Var != null) {
            int i10 = 0;
            while (true) {
                if (i10 != arrayList.size()) {
                    if (gg.b.a(((kp) arrayList.get(i10)).f27909a.f20390c, this.W.f20390c)) {
    ...
    public final void C(boolean z10) {
        ...
        this.T.setInterpolator(jt.f27595e);
        this.T.start();
    ...
    public final void D() {
        TextView textView = this.f28288e;
        if (textView != null) {
        ...
        ImageView imageView = this.f28283b;
        imageView.setBackground(f02);
        int themedColor = getThemedColor(i11);
        org.telegram.ui.ActionBar.g2 g2Var = this.f28285c;
        g2Var.a(themedColor);
        ...
        int themedColor2 = getThemedColor(org.telegram.ui.ActionBar.j6.f20853m5);
    ...
    public final void dismiss() {
        ...
        this.v.getClass();
        if (!this.O) {
            org.telegram.ui.ao aoVar = this.f28294n;
            TLRPC.WallPaper wallPaper = aoVar.h;
            if (wallPaper == null) {
                wallPaper = this.f28290f;
            }
            aoVar.i(this.f28295r, wallPaper, true, Boolean.valueOf(this.f28296s), false);
        }
        if (this.N != this.f28296s) {
            if (org.telegram.ui.ActionBar.j6.I.q() == this.f28296s) {
            ...
            org.telegram.ui.ActionBar.j6.t(N0, false, this.f28296s);
        }
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        int i10 = 0;
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 32, null, null, new Drawable[]{this.shadowDrawable}, ipVar, org.telegram.ui.ActionBar.j6.f20761h5));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.E, 4, null, null, null, null, org.telegram.ui.ActionBar.j6.f20797j5));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f28297w, 16, new Class[]{t11.class}, null, null, null, org.telegram.ui.ActionBar.j6.f20779i5));
        int i11 = org.telegram.ui.ActionBar.j6.Oh;
        View view = this.I;
        ...
        while (i10 < size) {
            ...
            i10++;
            ((org.telegram.ui.ActionBar.l6) obj).f21212o = this.f28294n;
        }
        return arrayList;
    }
    ...
    public final void t() {
        if (v()) {
            ...
            alertDialog$Builder.f20225a.R = LocaleController.getString(R.string.ChatThemeSaveDialogTitle);
            alertDialog$Builder.f20225a.T = LocaleController.getString(R.string.ChatThemeSaveDialogText);
            alertDialog$Builder.k(LocaleController.getString(R.string.ChatThemeSaveDialogApply), new org.telegram.ui.ActionBar.a2(this) {
                public final lp f32330b;
                ...
                public final void g(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
                    switch (r2) {
                        case 0:
                            this.f32330b.s(false);
                            return;
                        default:
                            this.f32330b.dismiss();
                            return;
                    }
                }
            });
    ...
    public final void u() {
        ...
        if (!isDismissed() && !this.O) {
            ...
            if (v()) {
                ...
                wallPaper = this.f28294n.h;
            }
            TLRPC.WallPaper wallPaper2 = wallPaper;
            org.telegram.ui.ActionBar.d4 d4Var = this.M.f27909a;
            if (d4Var.f20388a) {
                this.f28294n.i(null, wallPaper2, false, Boolean.valueOf(this.N), true);
            } else {
                this.f28294n.i(d4Var, wallPaper2, false, Boolean.valueOf(this.N), true);
            }
            vi viVar = this.Y;
            if (viVar != null) {
                jj jjVar = viVar.f31342r0;
                if (jjVar != null) {
                    boolean z10 = this.N;
                    za zaVar = jjVar.v;
            ...
            if (jpVar != null && jpVar.d != null) {
                for (int i10 = 0; i10 < jpVar.d.size(); i10++) {
                    ((kp) jpVar.d.get(i10)).f27911c = this.N ? 1 : 0;
                }
                jpVar.l();
            }
        }
    ...
    public final boolean v() {
        ...
        org.telegram.ui.ActionBar.d4 d4Var2 = this.M.f27909a;
        if (d4Var2 != null) {
    ...
    public final void x(List list) {
        ...
        if (list != null && !list.isEmpty()) {
            ...
            if (!this.V) {
                org.telegram.ui.ActionBar.d4 d4Var = this.f28294n.f34517f;
                this.W = d4Var;
                if (d4Var != null) {
                    d4Var.l();
                }
            ...
            for (int i10 = 1; i10 < list.size(); i10++) {
                ...
                kpVar2.f27911c = this.N ? 1 : 0;
                if (gg.b.a(d4Var3.f20390c, bVar)) {
            ...
            if (!this.V) {
                A(false);
                this.f28297w.animate().alpha(1.0f).setDuration(150L).start();
            }
            this.V = true;
            F(true);
        }
    ...
    public final void y() {
        ...
        if (!isDismissed() && !this.O) {
            ...
            org.telegram.ui.ActionBar.d4 d4Var = this.M.f27909a;
            if (d4Var.f20388a) {
                this.f28294n.i(null, wallPaper2, true, Boolean.valueOf(this.N), false);
                return;
            }
            this.f28294n.i(d4Var, wallPaper2, true, Boolean.valueOf(this.N), false);
        }
    }
}
