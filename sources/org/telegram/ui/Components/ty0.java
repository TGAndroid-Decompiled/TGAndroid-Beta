...
public final class ty0 extends Drawable {
    ...
    public final z5 f31442b;
    public final Drawable f31443c;
    public final Drawable d;
    public int f31444e = 255;

    public ty0(org.telegram.ui.Cells.t1 t1Var) {
        this.f31442b = new z5(t1Var, 420L, pr.h);
        this.f31443c = t1Var.getContext().getResources().getDrawable(R.drawable.summary_arrow);
    ...
    public final void draw(Canvas canvas) {
        ...
        drawable.setAlpha(this.f31444e);
        drawable.draw(canvas);
        float e6 = this.f31442b.e(this.f31441a);
        ...
        Drawable drawable2 = this.f31443c;
        drawable2.setBounds(bounds2);
        drawable2.setAlpha(this.f31444e);
    ...
    public final int getIntrinsicHeight() {
        return this.f31443c.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f31443c.getIntrinsicWidth();
    }
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f31443c.setColorFilter(colorFilter);
