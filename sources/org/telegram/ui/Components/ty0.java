...
public final class ty0 {
    public final org.telegram.ui.ActionBar.g6 f31481a;
    public StaticLayout f31482b;
    public final ArrayList f31483c = new ArrayList(2);
    public int d;
    public int f31484e;
    public int f31485f;
    public int f31486g;
    ...
    public final void b(MessageObject messageObject) {
        ...
        org.telegram.ui.ActionBar.g6 g6Var = this.f31481a;
        if (g6Var != null) {
        ...
        this.f31486g = AndroidUtilities.dp(14.0f) * 2;
        ...
        while (i16 < size) {
            ...
            i16++;
            sy0 sy0Var = (sy0) obj;
            f11 = Math.max(f11, sy0Var.f31200a.l());
            f12 = Math.max(f12, sy0Var.f31201b.l());
            int j10 = ((int) sy0Var.f31200a.j()) + this.f31486g;
            this.f31486g = j10;
            this.f31486g = AndroidUtilities.dp(7.0f) + j10;
        }
        ...
        this.f31482b = new StaticLayout(AndroidUtilities.replaceTags(spannableStringBuilder), textPaint, max, Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
        int i30 = 0;
        for (int i31 = 0; i31 < this.f31482b.getLineCount(); i31++) {
            i30 = (int) Math.max(i30, this.f31482b.getLineWidth(i31));
        }
        int height = this.f31482b.getHeight() + this.f31486g;
        this.f31486g = height;
        this.f31486g = AndroidUtilities.dp(5.0f) + height;
        int D = org.telegram.messenger.y3.D(24.0f, 2, Math.max(dp, i30));
        this.h = D;
        this.d = (D - max) / 2;
        this.f31484e = (D - dp) / 2;
        this.f31485f = (int) (AndroidUtilities.dp(f10) + i15 + f11);
    }
}
