...
public final class e31 extends View {
    ...
    public final Paint f24454b;
    public final Paint f24455c;
    public Drawable d;
    public boolean e;
    public int f24456f;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.e) {
            ...
            canvas2.drawRoundRect(rectF, dp, dp, this.f24454b);
        }
        int i10 = this.f24456f;
        Paint paint = this.f24455c;
        if (i10 != 0) {
            if (i10 == 1) {
                ...
                canvas2.save();
                canvas2.translate((-AndroidUtilities.dp(2.0f)) * this.f24453a, 0.0f);
                canvas2.rotate(this.f24453a * 90.0f, getWidth() / 2.0f, getHeight() / 2.0f);
                canvas2.drawLine(dp2 + ((width - dp2) * this.f24453a), height, width, height, paint);
                int dp3 = AndroidUtilities.dp((this.f24453a * (-1.0f)) + 9.0f);
                int dp4 = AndroidUtilities.dp((this.f24453a * 7.0f) + 9.0f);
                double d = width;
                double d10 = dp3;
                double d11 = height;
            ...
            float max = (Math.max(0.4f, this.f24453a) - 0.4f) / 0.6f;
            if (max != 0.0f) {
    ...
    public void setBackgroundColor(int i10) {
        this.f24454b.setColor(i10);
        invalidate();
    }

    public void setColor(int i10) {
        this.f24455c.setColor(i10);
        invalidate();
    }
