        ...
        switch (this.f27601a) {
            case 0:
                ...
                if (i10 == 1) {
                    ...
                    r7Var.f27845w = System.currentTimeMillis();
            ...
            default:
                r7 r7Var2 = this.f27602b;
                j8 j8Var2 = r7Var2.H;
                long duration = MediaController.getInstance().getDuration();
                if (duration != 0 && duration != -9223372036854775807L) {
                    float f7 = j8Var2.I0;
                    long currentTimeMillis = System.currentTimeMillis();
                    long j10 = currentTimeMillis - r7Var2.f27845w;
                    r7Var2.f27845w = currentTimeMillis;
                    long j11 = currentTimeMillis - r7Var2.f27846x;
                    int i11 = r7Var2.v;
                    if (i11 == 1) {
                        j3 = 3;
                    } else if (i11 == 2) {
                    ...
                    if (j8Var2.H0 == -1 && r7Var2.v > 0) {
                        if (j11 > 200 || j8Var2.I0 == 0.0f) {
                            r7Var2.f27846x = currentTimeMillis;
                            if (j8Var2.I0 == 0.0f) {
                ...
                r7Var2.f27845w = System.currentTimeMillis();
                return;
        }
    }
}
