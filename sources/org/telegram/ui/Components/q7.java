        ...
        switch (this.f29613a) {
            case 0:
                ...
                for (int i14 = 0; i14 < 5; i14++) {
                    ...
                    k8 k8Var = this.f29614b;
                    View view = k8Var.f27730n0[i14];
                    view.layout(dp, dp2, view.getMeasuredWidth() + dp, k8Var.f27730n0[i14].getMeasuredHeight() + dp2);
                }
                return;
            case 1:
            default:
            ...
            case 2:
                super.onLayout(z10, i10, i11, i12, i13);
                k8 k8Var2 = this.f29614b;
                if (k8Var2.V != null && (textView = k8Var2.f27713a0) != null) {
