...
public final class en implements ti {
    public final org.telegram.ui.ActionBar.n2 f23903a;
    public final Utilities.Callback f23904b;
    public final cn f23905c;

    public en(Utilities.Callback callback, org.telegram.ui.ActionBar.n2 n2Var, cn cnVar) {
        this.f23903a = n2Var;
        this.f23904b = callback;
        this.f23905c = cnVar;
    }

    @Override
    public final void B1(int i10, boolean z10, boolean z11, int i11, int i12, long j3, boolean z12, boolean z13, long j10) {
        cn cnVar = this.f23905c;
        ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = cnVar.f29033j0;
        Utilities.Callback callback = this.f23904b;
        if (i10 == 15) {
            org.telegram.ui.ActionBar.n2 n2Var = this.f23903a;
    ...
    public final void x0(gh ghVar) {
        NotificationCenter.getInstance(this.f23903a.getCurrentAccount()).doOnIdle(ghVar);
    }
