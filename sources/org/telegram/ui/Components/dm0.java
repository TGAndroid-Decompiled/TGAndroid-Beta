...
public final class dm0 extends Drawable implements Animator.AnimatorListener {
    ...
    public ColorFilter f23718b;
    public Drawable d;
    public Drawable e;
    public ValueAnimator f23720f;
    public boolean f23722r;
    public int f23719c = 0;
    public float h = 1.0f;
    public final ArrayList f23721n = new ArrayList();
    ...
    public final void a(int i10, boolean z10) {
        ...
        b(this.f23717a.getDrawable(i10).mutate(), z10);
        this.f23719c = i10;
    }
    ...
    public final void b(Drawable drawable, boolean z10) {
        ...
        if (drawable == drawable2) {
            drawable2.setColorFilter(this.f23718b);
            return;
        }
        this.f23719c = 0;
        this.e = drawable2;
        this.d = drawable;
        drawable.setColorFilter(this.f23718b);
        c(this.d, getBounds());
        c(this.e, getBounds());
        ValueAnimator valueAnimator = this.f23720f;
        ...
        this.f23720f = ofFloat;
        ofFloat.addUpdateListener(new s70(this, 10));
        this.f23720f.addListener(this);
        this.f23720f.setDuration(150L);
        this.f23720f.start();
    }
    ...
    public final void invalidateSelf() {
        ...
        ArrayList arrayList = this.f23721n;
        if (arrayList != null) {
