...
public class oh0 extends wp implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final ArrayList f26784a1;
    public final ArrayList f26785b1;
    public int f26786c1;
    public final SparseArray f26787d1;
    public boolean f26788e1;
    public boolean f26789f1;
    public boolean f26790g1;
    public org.telegram.ui.pv0 f26791h1;
    public boolean f26792i1;
    public int f26793j1;
    public int f26794k1;
    public int l1;
    public int f26795m1;
    ...
    public int f26797o1;
    public fh0 f26798p1;
    public ImageLocation f26799q1;
    public ImageLocation f26800r1;
    public final PointF f26801x0;
    public final int f26802y0;
    public final org.telegram.ui.ActionBar.k f26803z0;

    public oh0(Context context, org.telegram.ui.ActionBar.k kVar, ll0 ll0Var, org.telegram.ui.q4 q4Var) {
        super(context);
        this.f26801x0 = new PointF();
        this.A0 = true;
        this.B0 = true;
        ...
        this.f26784a1 = new ArrayList();
        this.f26785b1 = new ArrayList();
        this.f26787d1 = new SparseArray();
        this.f26788e1 = true;
        this.f26793j1 = -1;
        this.f26794k1 = -1;
        ...
        this.f26803z0 = kVar;
        this.f26802y0 = ViewConfiguration.get(context).getScaledTouchSlop();
        this.G0 = q4Var;
        b(new gh0(this));
    ...
    public final void A(ImageLocation imageLocation, ImageLocation imageLocation2) {
        ...
        this.W0.add(0, null);
        this.V0.add(0, null);
        this.f26784a1.add(0, -1);
        this.f26785b1.add(0, Float.valueOf(0.0f));
        this.D0.g();
        L();
        this.f26799q1 = imageLocation;
        this.f26800r1 = imageLocation2;
    }

    public final void B(float f7, int i10) {
        float f10;
        int i11 = this.f26793j1;
        float f11 = 0.0f;
        if (i11 >= 0 || this.f26794k1 >= 0) {
            if (i11 < 0) {
                i11 = this.f26794k1;
            }
    ...
    public final View E(int i10) {
        nh0 nh0Var = this.D0;
        if (nh0Var != null) {
            ArrayList arrayList = nh0Var.f26457c;
            if (arrayList.size() > i10 && i10 >= 0) {
                kh0 kh0Var = (kh0) arrayList.get(i10);
                lh0 lh0Var = kh0Var.f25605b;
                if (lh0Var == null) {
                    return kh0Var.f25606c;
                }
                return lh0Var;
            }
            return null;
    ...
    public final boolean H(q61 q61Var, ImageLocation imageLocation, ImageLocation imageLocation2, boolean z10) {
        ...
        int i11 = 0;
        if (imageLocation != null && imageLocation2 != null && this.f26786c1 == 0) {
    ...
    public final void N(int i10, int i11) {
        ...
        nh0 nh0Var = this.D0;
        if (nh0Var != null) {
            for (int i12 = 0; i12 < nh0Var.f26457c.size(); i12++) {
                if (((kh0) nh0Var.f26457c.get(i12)).f25606c != null) {
                    ih0 ih0Var = ((kh0) nh0Var.f26457c.get(i12)).f25606c;
                    int i13 = this.f26795m1;
                    int i14 = this.f26796n1;
        ...
        if (imageLocation != null) {
            ...
            while (true) {
                ...
                if (i10 >= arrayList.size()) {
                    ...
                    this.f26785b1.set(i10, Float.valueOf(f7));
                    SparseArray sparseArray = this.f26787d1;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
            ...
            if (oh0Var2.S0 == dialogPhotos2) {
                ...
                if (!arrayList7.isEmpty() || !dialogPhotos2.fromCache) {
                    ...
                    if (user4 != null && user4.self && UserObject.hasFallbackPhoto(userFull)) {
                        ...
                        oh0Var2.f26794k1 = arrayList7.size() - 1;
                    }
                    arrayList5.clear();
                    arrayList6.clear();
                    ...
                    arrayList12.clear();
                    ArrayList arrayList13 = oh0Var2.f26784a1;
                    arrayList13.clear();
                    ArrayList arrayList14 = oh0Var2.f26785b1;
                    arrayList14.clear();
                    ...
                    if (oh0Var.f26794k1 < 0 && oh0Var.f26793j1 < 0) {
                        z11 = false;
                        oh0Var.B(0.0f, 0);
                    } else {
                        z11 = false;
                    ...
                    ImageLocation imageLocation5 = oh0Var.f26799q1;
                    if (imageLocation5 != null) {
                        oh0Var.A(imageLocation5, oh0Var.f26800r1);
                        return;
                    }
                    return;
                }
        ...
        SparseArray sparseArray = oh0Var2.f26787d1;
        if (i10 == i28) {
        ...
        } else if (i10 == NotificationCenter.reloadDialogPhotos && oh0Var2.f26786c1 == 0 && (dialogPhotos = oh0Var2.S0) != null) {
            dialogPhotos.reset();
    ...
    public u9 getCurrentItemView() {
        nh0 nh0Var = this.D0;
        if (nh0Var != null && !nh0Var.f26457c.isEmpty()) {
            return ((kh0) nh0Var.f26457c.get(getCurrentItem())).f25606c;
        }
        return null;
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        fh0 fh0Var = this.f26798p1;
        if (fh0Var != null) {
            fh0Var.setTranslationY(getHeight() - this.f26798p1.getMeasuredHeight());
        }
    }
    ...
    public oh0(Context context, long j3, org.telegram.ui.ActionBar.k kVar, ll0 ll0Var, org.telegram.ui.n01 n01Var, jh0 jh0Var, fh0 fh0Var) {
        ...
        this.f26793j1 = -1;
        this.f26794k1 = -1;
        this.f26798p1 = fh0Var;
        setPadding(0, 0, 0, fh0Var == null ? 0 : fh0Var.f23940n);
        if (fh0Var != null) {
            fh0Var.setView(this);
        }
        setVisibility(8);
