...
public final class hl0 implements s4.r0 {
        ...
        switch (this.f24695a) {
            ...
            default:
                ...
                if (yVar.f42849w != -1) {
                    ...
                    int findPointerIndex = motionEvent.findPointerIndex(yVar.f42849w);
                    if (findPointerIndex >= 0) {
                        yVar.h(actionMasked, findPointerIndex, motionEvent);
                    }
                    s4.c1 c1Var = yVar.f42844c;
                    if (c1Var != null) {
                        int i10 = 0;
                        if (actionMasked != 1) {
                            if (actionMasked != 2) {
                                if (actionMasked != 3) {
                                    if (actionMasked == 6) {
                                        ...
                                        if (motionEvent.getPointerId(actionIndex) == yVar.f42849w) {
                                            if (actionIndex == 0) {
                                                i10 = 1;
                                            }
                                            yVar.f42849w = motionEvent.getPointerId(i10);
        ...
        switch (this.f24695a) {
            case 0:
                ...
                if ((actionMasked == 0 || actionMasked == 5) && ml0Var.N1 == null && z10) {
                    ...
                    if ((ml0Var.f26184k1 || itemAnimator == null || !itemAnimator.k()) && ml0Var.F0(y3) && (F = ml0Var.F(x10, y3)) != null && ml0Var.G0(F)) {
                        ml0Var.N1 = F;
                    }
            ...
            default:
                ...
                s4.u uVar = null;
                if (actionMasked2 == 0) {
                    yVar.f42849w = motionEvent.getPointerId(0);
                    ...
                    if (yVar.f42844c == null) {
                        ...
                        if (uVar != null) {
                            ...
                            yVar.e -= uVar.f42825s;
                            yVar.j(c1Var, true);
                            if (yVar.f42842a.remove(c1Var.f42702a)) {
                                yVar.f42850x.a(yVar.H, c1Var);
                            }
                            yVar.p(c1Var, uVar.f42822f);
    ...
    public final void c(boolean z10) {
        switch (this.f24695a) {
            case 0:
                ((ml0) this.f24696b).J0(true);
                return;
            default:
                if (z10) {
                    ((s4.y) this.f24696b).p(null, 0);
                    return;
                }
                return;
        }
    ...
    public hl0(ml0 ml0Var, Context context) {
        ...
        ml0Var.M1 = iaVar;
        ((k20) iaVar.f20291b).f25551t = false;
    }
