...
public final class pm0 implements zk0 {
    ...
    public final FrameLayout f29467c;

    public pm0(FrameLayout frameLayout, int i10, int i11) {
        this.f29465a = i11;
        this.f29467c = frameLayout;
        this.f29466b = i10;
    }
            ...
            case 0:
                ...
                if (E != null) {
                    ...
                    if (view instanceof rm0) {
                        org.telegram.ui.Cells.j7 j7Var = ((rm0) view).f30080a;
                        ...
                        if (j7Var.G) {
                            ...
                            j7Var.f(true);
                            DownloadController.getInstance(this.f29466b).updateFilesLoadingPriority();
                        } else {
                ...
                return;
            case 1:
                org.telegram.ui.vp0 vp0Var2 = (org.telegram.ui.vp0) this.f29467c;
                org.telegram.ui.bq0 bq0Var = vp0Var2.f41647p0;
                ArrayList arrayList2 = vp0Var2.f41643l0;
                if (view instanceof org.telegram.ui.up0) {
                    org.telegram.ui.up0 up0Var = (org.telegram.ui.up0) view;
                    int i15 = vp0Var2.m0;
                    if (vp0Var2.f41646o0 == null) {
                        o5 o5Var = up0Var.f41226c;
                        ...
                        rp0Var.f37673g1 = true;
                        long j10 = vp0Var2.f41644n;
                        if (j10 == 0) {
                            valueOf = null;
                        } else {
                ...
                int i17 = vp0Var2.V;
                int i18 = this.f29466b;
                if (i10 == i17) {
                    vp0Var2.h = -1;
                    vp0Var2.f41644n = 0L;
                    vp0Var2.f41648r = null;
                    vp0Var2.f41649s = null;
                    vp0Var2.I = null;
                    vp0Var2.i();
                    if (i18 == 0) {
                        bq0Var.h.i();
                    }
                    org.telegram.ui.up0 up0Var2 = vp0Var2.f41652y;
                    if (up0Var2 != null) {
                        up0Var2.b(true);
                    }
                    vp0Var2.j(true);
                    vp0Var2.f(true);
                    org.telegram.ui.vp0 vp0Var3 = bq0Var.f34901n;
                    if (vp0Var3 != null && (zp0Var = vp0Var3.f41627a) != null && (vp0Var = bq0Var.h) != null) {
                        zp0Var.a(vp0Var.h);
                        return;
                    }
                    return;
                }
                int i19 = vp0Var2.f41630b0;
                if (i10 >= i19 && i10 < vp0Var2.f41632c0) {
                    int i20 = i10 - i19;
                    if (vp0Var2.K == null) {
                        if (i20 >= 0 && i20 < arrayList2.size()) {
                            ...
                            if (i18 == 1) {
                                ...
                                if (peerColor instanceof TLRPC.TL_peerColorCollectible) {
                                    ...
                                    vp0Var2.I = null;
                                    vp0Var2.f41648r = null;
                                    vp0Var2.f41649s = (TLRPC.TL_peerColorCollectible) peerColor;
                                } else {
                                    return;
                                }
                            } else {
                                ...
                                vp0Var2.h = -1;
                                vp0Var2.I = null;
                                vp0Var2.f41648r = MessagesController.emojiStatusCollectibleFromGift(tL_starGiftUnique);
                                vp0Var2.f41649s = null;
                            }
                            vp0Var2.j(true);
                            vp0Var2.i();
                            vp0Var2.f(true);
                            org.telegram.ui.up0 up0Var3 = vp0Var2.f41652y;
                            if (up0Var3 != null) {
                                up0Var3.b(true);
                                return;
                            }
                        ...
                        if (i18 == 1) {
                            ...
                            if (peerColor2 instanceof TLRPC.TL_peerColorCollectible) {
                                ...
                                vp0Var2.h = -1;
                                vp0Var2.f41648r = null;
                                vp0Var2.f41649s = (TLRPC.TL_peerColorCollectible) peerColor2;
                            } else {
                                return;
                            }
                        } else {
                            vp0Var2.f41644n = 0L;
                            vp0Var2.h = -1;
                            vp0Var2.f41648r = MessagesController.emojiStatusCollectibleFromGift(tL_starGiftUnique2);
                            vp0Var2.f41649s = null;
                        }
                        ...
                        vp0Var2.i();
                        vp0Var2.f(true);
                        org.telegram.ui.up0 up0Var4 = vp0Var2.f41652y;
                        if (up0Var4 != null) {
                            up0Var4.b(true);
                            return;
                        }
                ...
                return;
            default:
                org.telegram.ui.j71 j71Var = (org.telegram.ui.j71) this.f29467c;
                boolean z12 = view instanceof org.telegram.ui.s61;
                int i21 = this.f29466b;
                try {
                    if (z12) {
                        org.telegram.ui.s61 s61Var = (org.telegram.ui.s61) view;
                        if (!s61Var.f40350s && (((j1Var = s61Var.f40352x) == null || !j1Var.f605a) && i21 != 13 && i21 != 14)) {
                            if (s61Var.Q && (document = s61Var.d) != null) {
                                if (j71Var.W == 6) {
                                    j71Var.p(s61Var, Long.valueOf(document.f19902id), document, s61Var.v, null);
                                } else {
                                    j71Var.p(s61Var, null, document, s61Var.v, null);
                                }
                            } else {
                                j71Var.o(s61Var, s61Var.f40346e);
                            }
                        } else {
                            j71Var.l();
                            j71Var.r(s61Var, s61Var.f40352x);
                        }
                        if (i21 != 1 && i21 != 11) {
