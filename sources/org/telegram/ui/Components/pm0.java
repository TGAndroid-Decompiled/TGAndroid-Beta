...
public final class pm0 implements Runnable {
    public final int f27085a = 1;
    public final wm0 f27086b;
    ...
    public final void run() {
        switch (this.f27085a) {
            case 0:
                ...
                break;
            default:
                wm0 wm0Var2 = this.f27086b;
                zw0 zw0Var = wm0Var2.f29697a;
                if (this.f27087c.equals(wm0Var2.L)) {
                    if (wm0Var2.f29702r == 0) {
                        wm0Var2.N.b(0);
                    }
