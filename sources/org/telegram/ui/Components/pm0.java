...
public final class pm0 implements Runnable {
    public final int f27106a = 1;
    public final wm0 f27107b;
    ...
    public final void run() {
        switch (this.f27106a) {
            case 0:
                ...
                break;
            default:
                wm0 wm0Var2 = this.f27107b;
                xw0 xw0Var = wm0Var2.f29747a;
                if (this.f27108c.equals(wm0Var2.L)) {
                    if (wm0Var2.f29752r == 0) {
                        wm0Var2.N.b(0);
                    }
