...
public final class cg0 extends l20 {
    ...
    public final boolean a() {
        ...
        if (photoViewer != null) {
            if ((photoViewer.F2 != null || eg0Var.f25722r != null) && !eg0Var.f25709c0 && !eg0Var.Y && !eg0Var.f25724w && !eg0Var.f25723s.isInProgress() && eg0Var.f25714f0) {
                long l4 = eg0Var.l();
                long m10 = eg0Var.m();
    ...
    public final boolean onDown(MotionEvent motionEvent) {
        eg0 eg0Var = this.d;
        if (eg0Var.E) {
            for (int i10 = 1; i10 < eg0Var.f25711e.getChildCount(); i10++) {
                View childAt = eg0Var.f25711e.getChildAt(i10);
                if (childAt.dispatchTouchEvent(motionEvent)) {
                    eg0Var.f25726y = childAt;
                    return true;
                }
            }
        }
        this.f25034a = eg0Var.K;
        this.f25035b = eg0Var.L;
        return true;
    }
    ...
    public final boolean onFling(MotionEvent motionEvent, MotionEvent motionEvent2, float f7, float f10) {
        ...
        float f11;
        eg0 eg0Var = this.d;
        if (eg0Var.f25724w && !eg0Var.f25725x) {
            o1.k kVar = eg0Var.M;
            kVar.f16841a = f7;
            float f12 = eg0Var.K;
            kVar.f16842b = f12;
    ...
    public final boolean onScroll(MotionEvent motionEvent, MotionEvent motionEvent2, float f7, float f10) {
        float dp;
        eg0 eg0Var = this.d;
        if (!eg0Var.f25724w && eg0Var.F == null && !eg0Var.f25725x) {
        ...
        if (eg0Var.f25724w) {
            float f12 = eg0Var.K;
            float rawX = (motionEvent2.getRawX() + this.f25034a) - motionEvent.getRawX();
            eg0Var.L = (motionEvent2.getRawY() + this.f25035b) - motionEvent.getRawY();
            int i10 = eg0Var.H;
            if (rawX > (-i10) * 0.25f && rawX < AndroidUtilities.displaySize.x - (i10 * 0.75f)) {
                boolean z10 = eg0Var.f25710d0;
                if (z10) {
                    if (z10) {
