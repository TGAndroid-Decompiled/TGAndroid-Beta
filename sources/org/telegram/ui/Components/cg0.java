...
public final class cg0 extends l20 {
    ...
    public final boolean a() {
        ...
        if (photoViewer != null) {
            if ((photoViewer.F2 != null || eg0Var.f23656r != null) && !eg0Var.f23644c0 && !eg0Var.Y && !eg0Var.f23658w && !eg0Var.f23657s.isInProgress() && eg0Var.f23648f0) {
                long l4 = eg0Var.l();
                long m10 = eg0Var.m();
        ...
        if (eg0Var.E) {
            for (int i10 = 1; i10 < eg0Var.e.getChildCount(); i10++) {
                ...
                if (childAt.dispatchTouchEvent(motionEvent)) {
                    eg0Var.f23660y = childAt;
                    return true;
                }
            }
        }
        this.f23083a = eg0Var.K;
        this.f23084b = eg0Var.L;
        return true;
    }
    ...
    public final boolean onFling(MotionEvent motionEvent, MotionEvent motionEvent2, float f7, float f10) {
        ...
        float f11;
        eg0 eg0Var = this.d;
        if (eg0Var.f23658w && !eg0Var.f23659x) {
            o1.k kVar = eg0Var.M;
            kVar.f15341a = f7;
            float f12 = eg0Var.K;
            kVar.f15342b = f12;
            ...
            kVar2.f15343c = true;
            kVar2.f15351u.f15357i = w7.p.a((f10 / 10.0f) + f11, AndroidUtilities.dp(16.0f), (AndroidUtilities.displaySize.y - eg0Var.I) - AndroidUtilities.dp(16.0f));
            eg0Var.N.f();
            return true;
        }
        return false;
    ...
    public final boolean onScroll(MotionEvent motionEvent, MotionEvent motionEvent2, float f7, float f10) {
        float dp;
        eg0 eg0Var = this.d;
        if (!eg0Var.f23658w && eg0Var.F == null && !eg0Var.f23659x) {
            float abs = Math.abs(f7);
            float f11 = this.f23085c;
        ...
        if (eg0Var.f23658w) {
            float f12 = eg0Var.K;
            float rawX = (motionEvent2.getRawX() + this.f23083a) - motionEvent.getRawX();
            eg0Var.L = (motionEvent2.getRawY() + this.f23084b) - motionEvent.getRawY();
            int i10 = eg0Var.H;
            if (rawX > (-i10) * 0.25f && rawX < AndroidUtilities.displaySize.x - (i10 * 0.75f)) {
                boolean z10 = eg0Var.f23645d0;
                if (z10) {
                    if (z10) {
                ...
                o1.k kVar2 = eg0Var.M;
                if (kVar2.f15344f) {
                    kVar2.f15351u.f15357i = rawX;
                } else {
                    WindowManager.LayoutParams layoutParams = eg0Var.f23643c;
                    eg0Var.K = rawX;
                    layoutParams.x = (int) rawX;
                    eg0Var.n().f7352a.edit().putFloat("x", rawX).apply();
                }
                eg0Var.f23643c.y = (int) eg0Var.L;
                eg0Var.n().f7352a.edit().putFloat("y", eg0Var.L).apply();
