...
public final class xz {
    ...
    public xz(float f10, float f11, boolean z4) {
        ...
        sb2.append("}");
        this.f30776a = sb2.toString();
    }

    public final boolean a() {
        int h = a00.h(35633, this.f30776a);
        int h9 = a00.h(35632, this.f30777b);
        if (h == 0 || h9 == 0) {
            return false;
        }
        int glCreateProgram = GLES20.glCreateProgram();
        this.f30778c = glCreateProgram;
        GLES20.glAttachShader(glCreateProgram, h);
        GLES20.glAttachShader(this.f30778c, h9);
        GLES20.glBindAttribLocation(this.f30778c, 0, "position");
        GLES20.glBindAttribLocation(this.f30778c, 1, "inputTexCoord");
        GLES20.glLinkProgram(this.f30778c);
        int[] iArr = new int[1];
        GLES20.glGetProgramiv(this.f30778c, 35714, iArr, 0);
        if (iArr[0] == 0) {
            GLES20.glDeleteProgram(this.f30778c);
            this.f30778c = 0;
        } else {
            this.d = GLES20.glGetAttribLocation(this.f30778c, "position");
            this.e = GLES20.glGetAttribLocation(this.f30778c, "inputTexCoord");
            this.f30779f = GLES20.glGetUniformLocation(this.f30778c, "sTexture");
            this.f30780g = GLES20.glGetUniformLocation(this.f30778c, "texelWidthOffset");
            this.h = GLES20.glGetUniformLocation(this.f30778c, "texelHeightOffset");
        }
        return true;
    }
}
