...
public final class xz {
    ...
    public xz(float f7, float f10, boolean z10) {
        ...
        sb3.append("}");
        this.f30091a = sb3.toString();
    }

    public final boolean a() {
        int h = zz.h(35633, this.f30091a);
        int h10 = zz.h(35632, this.f30092b);
        if (h == 0 || h10 == 0) {
            return false;
        }
        int glCreateProgram = GLES20.glCreateProgram();
        this.f30093c = glCreateProgram;
        GLES20.glAttachShader(glCreateProgram, h);
        GLES20.glAttachShader(this.f30093c, h10);
        GLES20.glBindAttribLocation(this.f30093c, 0, "position");
        GLES20.glBindAttribLocation(this.f30093c, 1, "inputTexCoord");
        GLES20.glLinkProgram(this.f30093c);
        int[] iArr = new int[1];
        GLES20.glGetProgramiv(this.f30093c, 35714, iArr, 0);
        if (iArr[0] == 0) {
            GLES20.glDeleteProgram(this.f30093c);
            this.f30093c = 0;
        } else {
            this.d = GLES20.glGetAttribLocation(this.f30093c, "position");
            this.e = GLES20.glGetAttribLocation(this.f30093c, "inputTexCoord");
            this.f30094f = GLES20.glGetUniformLocation(this.f30093c, "sTexture");
            this.f30095g = GLES20.glGetUniformLocation(this.f30093c, "texelWidthOffset");
            this.h = GLES20.glGetUniformLocation(this.f30093c, "texelHeightOffset");
        }
        return true;
    }
}
