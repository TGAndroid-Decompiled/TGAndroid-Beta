...
public final class e implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        switch (this.f23449a) {
            case 0:
                e0.U(this.f23450b, (TL_aicompose.AiComposeTone) obj);
                return;
            case 1:
                e0.T(this.f23450b, (TL_aicompose.AiComposeTone) obj);
                return;
            case 2:
                ...
                e0 e0Var = this.f23450b;
                if (z10) {
                    e0Var.f23470u0.edit((TL_aicompose.TL_aiComposeTone) aiComposeTone);
                }
                e0Var.s0();
                return;
            default:
                e0.S(this.f23450b, ((Integer) obj).intValue());
                return;
        }
    }
}
