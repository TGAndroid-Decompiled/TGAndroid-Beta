...
public final class li extends qv0 {
    ...
    public final vi B0;
    public int f25908w0;
    public final RectF f25909x0;
    public boolean f25910y0;
    public float f25911z0;

    public li(vi viVar, Context context) {
        super(context, null);
        this.B0 = viVar;
        this.f25909x0 = new RectF();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if ((niVar2 == qmVar || (niVar = viVar.f28809z0) == qmVar || (niVar2 == viVar.f28757j0 && niVar == null)) && niVar2 != null) {
            canvas.save();
            float f15 = viVar.f28764l2;
            boolean z10 = viVar.f28748g0;
            ci.n6 n6Var = viVar.O0;
            xh xhVar = viVar.f28755i1;
            ...
            if (n6Var != null) {
                f10 = n6Var.getAlpha() * n6Var.getMeasuredHeight();
            } else {
                f10 = 0.0f;
            }
            int i27 = dp4 + ((int) f10);
            ...
            if (h == 2) {
                ...
                float f18 = i27;
                f11 = 0.0f;
                if (niVar2 == viVar.f28771o0) {
                    dp = AndroidUtilities.dp(11.0f);
                } else {
                    if (niVar2 == viVar.m0) {
                        dp2 = AndroidUtilities.dp(3.0f);
                    } else if (niVar2 == viVar.f28768n0) {
                        dp2 = AndroidUtilities.dp(3.0f);
                    } else {
            ...
            if (viVar.f28806y0.f()) {
                q12 = viVar.f28806y0.getCustomBackground();
            } else {
                q12 = viVar.q1(true);
            }
            ...
            RectF rectF = this.f25909x0;
            if (h == 2) {
                org.telegram.ui.ActionBar.j6.f19151t0.setColor(q12);
                org.telegram.ui.ActionBar.j6.f19151t0.setAlpha(alpha2);
            ...
            if ((f13 != 1.0f && h != 2) || viVar.f28806y0.e()) {
                Paint paint = org.telegram.ui.ActionBar.j6.f19151t0;
                if (viVar.f28806y0.e()) {
                    q12 = viVar.f28806y0.getCustomActionBarBackground();
                }
                paint.setColor(q12);
                org.telegram.ui.ActionBar.j6.f19151t0.setAlpha(alpha2);
            ...
            if (viVar.f28806y0.e()) {
                org.telegram.ui.ActionBar.j6.f19151t0.setColor(viVar.f28806y0.getCustomActionBarBackground());
                org.telegram.ui.ActionBar.j6.f19151t0.setAlpha(alpha2);
                int p13 = viVar.p1(0);
                if (!z10) {
                ...
                i17 = ((org.telegram.ui.ActionBar.g3) viVar).backgroundPaddingLeft;
                rectF.set(i15, (dp7 + i16 + i28) * f13, measuredWidth6 - i17, AndroidUtilities.dp(12.0f) + p13);
                canvas.save();
                canvas.drawRect(rectF, org.telegram.ui.ActionBar.j6.f19151t0);
                canvas.restore();
            }
            if ((xhVar == null || xhVar.getAlpha() != 1.0f) && f13 != f11) {
                ...
                if (h == 2) {
                    ...
                    f16 = f13;
                } else if (viVar.f28806y0.e()) {
                    int customActionBarBackground = viVar.f28806y0.getCustomActionBarBackground();
                ...
                org.telegram.ui.ActionBar.j6.f19151t0.setColor(themedColor);
                org.telegram.ui.ActionBar.j6.f19151t0.setAlpha((int) (niVar2.getAlpha() * alpha4 * f16 * f13));
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if ((view instanceof ni) && view.getAlpha() > 0.0f) {
            canvas.save();
            canvas.translate(0.0f, viVar.f28764l2);
            ...
            int i31 = dp5 + i14;
            if (n6Var != null) {
                f13 = n6Var.getAlpha() * n6Var.getMeasuredHeight();
            } else {
                f13 = 0.0f;
            }
            int i32 = i31 + ((int) f13);
            if (niVar2 == viVar.f28806y0) {
                i15 = 0;
            } else {
                i15 = 1;
            }
            ...
            i16 = ((org.telegram.ui.ActionBar.g3) viVar).backgroundPaddingTop;
            int i33 = (p12 - i16) - i32;
            i17 = ((org.telegram.ui.ActionBar.g3) viVar).currentSheetAnimationType;
            if (i17 == 1 || viVar.f28789t1 != null) {
                i33 = (int) (view.getTranslationY() + i33);
            }
            int dp6 = AndroidUtilities.dp(20.0f) + i33;
            int dp7 = AndroidUtilities.dp(45.0f) + getMeasuredHeight();
            i18 = ((org.telegram.ui.ActionBar.g3) viVar).backgroundPaddingTop;
            int i34 = i18 + dp7;
            if (h == 0) {
                i19 = ((org.telegram.ui.ActionBar.g3) viVar).backgroundPaddingTop;
            } else {
            ...
            int i35 = i19;
            if (h != 2) {
                i20 = ((org.telegram.ui.ActionBar.g3) viVar).backgroundPaddingTop;
                f14 = 0.0f;
                if (i20 + i33 < i35) {
                    float f17 = i32;
                    if (niVar2 == viVar.f28771o0) {
                ...
                i30 = ((org.telegram.ui.ActionBar.g3) viVar).backgroundPaddingTop;
            ...
            qm qmVar = viVar.f28777q0;
            if (niVar3 != qmVar && (niVar = viVar.f28809z0) != qmVar && (niVar3 != viVar.f28757j0 || niVar != null)) {
                z10 = true;
            } else {
                z10 = false;
            }
            ...
            if (z10) {
                ...
                if (h == 2) {
                    org.telegram.ui.ActionBar.j6.f19151t0.setColor(q12);
                    org.telegram.ui.ActionBar.j6.f19151t0.setAlpha(alpha2);
                    i26 = ((org.telegram.ui.ActionBar.g3) viVar).backgroundPaddingLeft;
                    i27 = ((org.telegram.ui.ActionBar.g3) viVar).backgroundPaddingTop;
                    int measuredWidth = getMeasuredWidth();
                    i28 = ((org.telegram.ui.ActionBar.g3) viVar).backgroundPaddingLeft;
                    i29 = ((org.telegram.ui.ActionBar.g3) viVar).backgroundPaddingTop;
                    rectF.set(i26, i27 + i33, measuredWidth - i28, AndroidUtilities.dp(24.0f) + i29 + i33);
                }
            }
            if (view != viVar.f28760k0 && view != viVar.f28785s0 && view != viVar.f28763l0) {
                canvas.save();
            ...
            if (z10) {
                ...
                if ((xhVar == null || xhVar.getAlpha() != 1.0f) && f16 != f14) {
                    ...
                    org.telegram.ui.ActionBar.j6.f19151t0.setColor(themedColor);
                    org.telegram.ui.ActionBar.j6.f19151t0.setAlpha((int) (view.getAlpha() * alpha3 * alpha * f16));
                    canvas.drawRoundRect(rectF, AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f), org.telegram.ui.ActionBar.j6.f19151t0);
                }
            }
            canvas.restore();
            ...
            if (niVar4 != null) {
                ...
                if (n6Var != null) {
                    f11 = n6Var.getAlpha() * n6Var.getMeasuredHeight();
                } else {
                    f11 = 0.0f;
                }
                ...
                if (h10 != 2) {
                    ...
                    if (i13 + i40 < i12) {
                        float f18 = i39;
                        if (niVar4 == viVar.f28771o0) {
                            dp = AndroidUtilities.dp(11.0f);
                        } else {
                            if (niVar4 == viVar.m0) {
                                dp2 = AndroidUtilities.dp(3.0f);
                            } else if (niVar4 == viVar.f28768n0) {
                                dp2 = AndroidUtilities.dp(3.0f);
                            } else {
                                dp = AndroidUtilities.dp(4.0f);
                            }
                            f12 = f18 - dp2;
                            dp11 -= (int) (w7Var.getAlpha() * ((i12 - f12) + AndroidUtilities.statusBarHeight));
                        }
                        f12 = f18 + dp;
                        dp11 -= (int) (w7Var.getAlpha() * ((i12 - f12) + AndroidUtilities.statusBarHeight));
                    }
            ...
            canvas.clipPath(dVar.f4288j.f4277k);
            dVar.draw(canvas);
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (viVar.f28806y0.l(motionEvent)) {
            return true;
        }
        if (motionEvent.getAction() == 0) {
            ...
            if (iArr[0] != 0) {
                ...
                int i14 = i13 - (dp + i11);
                if (n6Var != null) {
                    f7 = n6Var.getAlpha() * n6Var.getMeasuredHeight();
                } else {
                    f7 = 0.0f;
                }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (!z11) {
            liVar.f25910y0 = true;
            i18 = ((org.telegram.ui.ActionBar.g3) viVar).backgroundPaddingLeft;
            i19 = ((org.telegram.ui.ActionBar.g3) viVar).backgroundPaddingLeft;
            liVar.setPadding(i18, 0, i19, 0);
            liVar.f25910y0 = false;
        }
        ...
        ((FrameLayout.LayoutParams) viVar.f28746f1.getLayoutParams()).height = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight();
        liVar.f25910y0 = true;
        ...
        if (viVar.m0 != null && AndroidUtilities.dp(20.0f) >= 0) {
            un unVar3 = viVar.m0;
            if (!unVar3.G && !unVar3.f28415a1 && !unVar3.f28425f1 && !unVar3.f28429h1) {
                liVar.f25910y0 = true;
                unVar3.a0();
                liVar.f25910y0 = false;
            }
        }
        if (viVar.f28768n0 != null && AndroidUtilities.dp(20.0f) >= 0) {
            un unVar4 = viVar.f28768n0;
            if (!unVar4.G && !unVar4.f28415a1 && !unVar4.f28425f1 && !unVar4.f28429h1) {
                liVar.f25910y0 = true;
                unVar4.a0();
                liVar.f25910y0 = false;
            }
        ...
        if (AndroidUtilities.dp(20.0f) >= 0) {
            ...
            if (z10) {
                ...
                un unVar5 = viVar.m0;
                if (niVar == unVar5 && unVar5.E != null && unVar5.f28429h1) {
                    o12 = AndroidUtilities.dp(120.0f);
                } else {
                    un unVar6 = viVar.f28768n0;
                    if (niVar == unVar6 && unVar6.E != null && unVar6.f28429h1) {
                        o12 = AndroidUtilities.dp(120.0f);
                    } else {
                        o12 = 0;
                    }
            ...
            if (f10 != null) {
                i15 = f10.f41882a.f(8).d;
            } else {
                i15 = 0;
            }
            r0.l1 f11 = r0.i0.f(liVar);
            if (f11 != null) {
                i16 = f11.f41882a.f(527).d;
            } else {
                i16 = 0;
            }
            Math.max(i16, o12);
        ...
        while (i22 < childCount) {
            ...
            if (childAt == null || childAt.getVisibility() == 8) {
                i14 = i23;
            } else if (childAt == viVar.f28795v1) {
                i14 = i23;
                ...
                if (!aiVar.l(childAt) && !diVar.l(childAt) && (((unVar = viVar.m0) == null || childAt != unVar.E) && ((unVar2 = viVar.f28768n0) == null || childAt != unVar2.E))) {
    ...
    public final void setTranslationY(float f7) {
        ...
        if (i11 == 1) {
            if (f10 < 0.0f) {
                viVar.f28806y0.setTranslationY(f10);
                if (viVar.Q0 != 0 || viVar.T0) {
                    viVar.f28755i1.setTranslationY((viVar.f28775p1 + f10) - viVar.f28764l2);
                }
                xhVar.setTranslationY(0.0f);
                f10 = 0.0f;
            } else {
                viVar.f28806y0.setTranslationY(0.0f);
                xhVar.setTranslationY(((f10 / this.f25911z0) * xhVar.getMeasuredHeight()) + (-f10));
            }
            viewGroup = ((org.telegram.ui.ActionBar.g3) viVar).containerView;
            viewGroup.invalidate();
        }
        super.setTranslationY(f10 - viVar.f28764l2);
