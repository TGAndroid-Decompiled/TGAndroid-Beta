...
public final class li extends qv0 {
    ...
    public final vi B0;
    public int f25905w0;
    public final RectF f25906x0;
    public boolean f25907y0;
    public float f25908z0;

    public li(vi viVar, Context context) {
        super(context, null);
        this.B0 = viVar;
        this.f25906x0 = new RectF();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if ((niVar2 == qmVar || (niVar = viVar.f28806z0) == qmVar || (niVar2 == viVar.f28754j0 && niVar == null)) && niVar2 != null) {
            canvas.save();
            float f15 = viVar.f28761l2;
            boolean z10 = viVar.f28745g0;
            ci.n6 n6Var = viVar.O0;
            xh xhVar = viVar.f28752i1;
            ...
            if (h == 2) {
                ...
                float f18 = i27;
                f11 = 0.0f;
                if (niVar2 == viVar.f28768o0) {
                    dp = AndroidUtilities.dp(11.0f);
                } else {
                    if (niVar2 == viVar.m0) {
                        dp2 = AndroidUtilities.dp(3.0f);
                    } else if (niVar2 == viVar.f28765n0) {
                        dp2 = AndroidUtilities.dp(3.0f);
                    } else {
            ...
            if (viVar.f28803y0.f()) {
                q12 = viVar.f28803y0.getCustomBackground();
            } else {
                q12 = viVar.q1(true);
            }
            ...
            RectF rectF = this.f25906x0;
            if (h == 2) {
                org.telegram.ui.ActionBar.j6.f19150t0.setColor(q12);
                org.telegram.ui.ActionBar.j6.f19150t0.setAlpha(alpha2);
            ...
            if ((f13 != 1.0f && h != 2) || viVar.f28803y0.e()) {
                Paint paint = org.telegram.ui.ActionBar.j6.f19150t0;
                if (viVar.f28803y0.e()) {
                    q12 = viVar.f28803y0.getCustomActionBarBackground();
                }
                paint.setColor(q12);
                org.telegram.ui.ActionBar.j6.f19150t0.setAlpha(alpha2);
            ...
            if (viVar.f28803y0.e()) {
                org.telegram.ui.ActionBar.j6.f19150t0.setColor(viVar.f28803y0.getCustomActionBarBackground());
                org.telegram.ui.ActionBar.j6.f19150t0.setAlpha(alpha2);
                int p13 = viVar.p1(0);
                if (!z10) {
                ...
                canvas.save();
                canvas.drawRect(rectF, org.telegram.ui.ActionBar.j6.f19150t0);
                canvas.restore();
            }
            if ((xhVar == null || xhVar.getAlpha() != 1.0f) && f13 != f11) {
                ...
                if (h == 2) {
                    ...
                    f16 = f13;
                } else if (viVar.f28803y0.e()) {
                    int customActionBarBackground = viVar.f28803y0.getCustomActionBarBackground();
                ...
                org.telegram.ui.ActionBar.j6.f19150t0.setAlpha((int) (niVar2.getAlpha() * alpha4 * f16 * f13));
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if ((view instanceof ni) && view.getAlpha() > 0.0f) {
            canvas.save();
            canvas.translate(0.0f, viVar.f28761l2);
            ...
            ni niVar3 = viVar.f28803y0;
            qm qmVar = viVar.f28774q0;
            if (niVar3 != qmVar && (niVar = viVar.f28806z0) != qmVar && (niVar3 != viVar.f28754j0 || niVar != null)) {
                z10 = true;
            } else {
                z10 = false;
            }
            ...
            if (view != viVar.f28757k0 && view != viVar.f28782s0 && view != viVar.f28760l0) {
                canvas.save();
            ...
            if (z10) {
                ...
                if ((xhVar == null || xhVar.getAlpha() != 1.0f) && f16 != f14) {
                    ...
                    org.telegram.ui.ActionBar.j6.f19150t0.setColor(themedColor);
                    org.telegram.ui.ActionBar.j6.f19150t0.setAlpha((int) (view.getAlpha() * alpha3 * alpha * f16));
                    canvas.drawRoundRect(rectF, AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f), org.telegram.ui.ActionBar.j6.f19150t0);
                }
            }
            canvas.restore();
            ...
            if (niVar4 != null) {
                ...
                if (h10 != 2) {
                    ...
                    if (i13 + i40 < i12) {
                        float f18 = i39;
                        if (niVar4 == viVar.f28768o0) {
                            dp = AndroidUtilities.dp(11.0f);
                        } else {
                            if (niVar4 == viVar.m0) {
                                dp2 = AndroidUtilities.dp(3.0f);
                            } else if (niVar4 == viVar.f28765n0) {
                                dp2 = AndroidUtilities.dp(3.0f);
                            } else {
                                dp = AndroidUtilities.dp(4.0f);
                            }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (viVar.f28803y0.l(motionEvent)) {
            return true;
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        vi viVar = liVar.B0;
        boolean z11 = viVar.f28745g0;
        org.telegram.ui.ActionBar.w0 w0Var = viVar.f28726a1;
        ...
        ((FrameLayout.LayoutParams) viVar.f28743f1.getLayoutParams()).height = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight();
        liVar.f25907y0 = true;
        ...
        if (viVar.m0 != null && AndroidUtilities.dp(20.0f) >= 0) {
            un unVar3 = viVar.m0;
            if (!unVar3.G && !unVar3.f28412a1 && !unVar3.f28422f1 && !unVar3.f28426h1) {
                liVar.f25907y0 = true;
                unVar3.a0();
                liVar.f25907y0 = false;
            }
        }
        if (viVar.f28765n0 != null && AndroidUtilities.dp(20.0f) >= 0) {
            un unVar4 = viVar.f28765n0;
            if (!unVar4.G && !unVar4.f28412a1 && !unVar4.f28422f1 && !unVar4.f28426h1) {
                liVar.f25907y0 = true;
                unVar4.a0();
                liVar.f25907y0 = false;
            }
        ...
        if (AndroidUtilities.dp(20.0f) >= 0) {
            ...
            if (z10) {
                ...
                un unVar5 = viVar.m0;
                if (niVar == unVar5 && unVar5.E != null && unVar5.f28426h1) {
                    o12 = AndroidUtilities.dp(120.0f);
                } else {
                    un unVar6 = viVar.f28765n0;
                    if (niVar == unVar6 && unVar6.E != null && unVar6.f28426h1) {
                        o12 = AndroidUtilities.dp(120.0f);
                    } else {
                        o12 = 0;
                    }
            ...
            if (f10 != null) {
                i15 = f10.f41877a.f(8).d;
            } else {
                i15 = 0;
            }
            r0.l1 f11 = r0.i0.f(liVar);
            if (f11 != null) {
                i16 = f11.f41877a.f(527).d;
            } else {
                i16 = 0;
            }
            Math.max(i16, o12);
        ...
        while (i22 < childCount) {
            ...
            if (childAt == null || childAt.getVisibility() == 8) {
                i14 = i23;
            } else if (childAt == viVar.f28792v1) {
                i14 = i23;
                ...
                if (!aiVar.l(childAt) && !diVar.l(childAt) && (((unVar = viVar.m0) == null || childAt != unVar.E) && ((unVar2 = viVar.f28765n0) == null || childAt != unVar2.E))) {
    ...
    public final void setTranslationY(float f7) {
        ...
        if (i11 == 1) {
            if (f10 < 0.0f) {
                viVar.f28803y0.setTranslationY(f10);
                if (viVar.Q0 != 0 || viVar.T0) {
                    viVar.f28752i1.setTranslationY((viVar.f28772p1 + f10) - viVar.f28761l2);
                }
                xhVar.setTranslationY(0.0f);
                f10 = 0.0f;
            } else {
                viVar.f28803y0.setTranslationY(0.0f);
                xhVar.setTranslationY(((f10 / this.f25908z0) * xhVar.getMeasuredHeight()) + (-f10));
            }
            viewGroup = ((org.telegram.ui.ActionBar.g3) viVar).containerView;
            viewGroup.invalidate();
        }
        super.setTranslationY(f10 - viVar.f28761l2);
