...
public final class dk0 extends FrameLayout {
    ...
    public boolean O;
    public final fk0 P;
    public final ck0 f25435a;
    public final ck0 f25436b;
    public final ck0 f25437c;
    public final ImageReceiver d;
    public ah.j1 f25438e;
    public sg.e1 f25439f;
    public float h;
    ...
    public dk0(fk0 fk0Var, Context context) {
        ...
        ck0Var2.f32504a.setAutoRepeat(0);
        ck0Var2.f32504a.setAllowStartAnimation(false);
        ck0Var2.f32504a.setAllowStartLottieAnimation(false);
    ...
    public static void a(dk0 dk0Var, ah.j1 j1Var, int i10) {
        ...
        boolean z11;
        int i11;
        ck0 ck0Var = dk0Var.f25437c;
        ck0 ck0Var2 = dk0Var.f25435a;
        ck0 ck0Var3 = dk0Var.f25436b;
        fk0 fk0Var = dk0Var.P;
        dk0Var.f(j1Var, false);
        ah.j1 j1Var2 = dk0Var.f25438e;
        ...
        int i12 = fk0Var.J;
        org.telegram.ui.ActionBar.f6 f6Var = fk0Var.f26130k0;
        int i13 = fk0Var.M0;
        ...
        dk0Var.H = z10;
        if (z10 && dk0Var.f25439f == null) {
            sg.e1 e1Var = new sg.e1(dk0Var.getContext(), 1, null);
            dk0Var.f25439f = e1Var;
            e1Var.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
            dk0Var.f25439f.setImageReceiver(ck0Var3.getImageReceiver());
            dk0Var.addView(dk0Var.f25439f, w7.x5.d(18, 18.0f, 17, 8.0f, 8.0f, 0.0f, 0.0f));
        }
        sg.e1 e1Var2 = dk0Var.f25439f;
        if (e1Var2 != null) {
            if (dk0Var.H) {
                i11 = 0;
            } else {
        ...
        dk0Var.f25441r = z11;
        if (i13 == 4 || dk0Var.f25438e.f606b) {
            dk0Var.f25441r = false;
        }
        ah.j1 j1Var3 = dk0Var.f25438e;
        if (!j1Var3.f605a && j1Var3.f609f == null) {
            ck0Var.getImageReceiver().clearImage();
            ck0Var3.getImageReceiver().clearImage();
            q5 q5Var = new q5(4, fk0Var.J, dk0Var.f25438e.f610g);
            q5 q5Var2 = new q5(3, fk0Var.J, dk0Var.f25438e.f610g);
            if (i13 != 1 && i13 != 2 && i13 != 4) {
                int i14 = org.telegram.ui.ActionBar.j6.f21018v6;
    ...
    public final void b() {
        ...
        ck0 ck0Var = this.f25436b;
        q5 q5Var = ck0Var.f32507e;
        if (q5Var != null) {
            imageReceiver = q5Var.f29612k;
        } else {
            imageReceiver = ck0Var.f32504a;
        }
        if (imageReceiver != null && imageReceiver.getLottieAnimation() != null) {
            fk0 fk0Var = this.P;
            if (fk0Var.f26147x0 == null && !this.N && fk0Var.G0) {
                if (imageReceiver.getLottieAnimation().f32581b0 <= 2) {
    ...
    public final void c(int i10) {
        ...
        if (this.f25441r) {
            if (this.f25435a.getImageReceiver().getLottieAnimation() != null && !this.f25435a.getImageReceiver().getLottieAnimation().w() && !this.f25440n) {
                this.f25440n = true;
                if (i10 == 0) {
                    this.E = false;
                    this.f25435a.getImageReceiver().getLottieAnimation().stop();
                    this.f25435a.getImageReceiver().getLottieAnimation().L(0, false, false);
                    this.G.run();
                    return;
                }
                this.E = true;
            ...
            if (this.f25435a.getImageReceiver().getLottieAnimation() != null && this.f25440n && !this.f25435a.getImageReceiver().getLottieAnimation().f32594l0 && !this.f25435a.getImageReceiver().getLottieAnimation().w()) {
                this.f25435a.getImageReceiver().getLottieAnimation().L(this.f25435a.getImageReceiver().getLottieAnimation().f32585e[0] - 1, false, false);
            }
            ck0 ck0Var3 = this.f25436b;
            float f14 = this.I;
            if (this.f25443w) {
                f7 = 0.76f;
            } else {
            ...
            ck0 ck0Var4 = this.f25436b;
            float f15 = this.I;
            if (!this.f25443w) {
                f11 = 1.0f;
            }
            ck0Var4.setScaleX(f15 * f11);
        } else if (!this.f25440n) {
            this.I = 0.0f;
            this.f25436b.setScaleX(0.0f);
            this.f25436b.setScaleY(0.0f);
            ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
            this.J = ofFloat;
            ofFloat.addUpdateListener(new h70(this, 9));
            this.J.setDuration(150L);
            this.J.setInterpolator(pr.h);
            this.J.setStartDelay(i10 * this.P.f26111c);
            this.J.start();
            this.f25440n = true;
        }
    }
    ...
    public final void d() {
        float f7;
        float f10;
        boolean z10 = this.f25441r;
        fk0 fk0Var = this.P;
        float f11 = 1.0f;
        ck0 ck0Var = this.f25436b;
        if (z10) {
            AndroidUtilities.cancelRunOnUIThread(this.G);
            ck0 ck0Var2 = this.f25435a;
            if (ck0Var2.getImageReceiver().getLottieAnimation() != null && !ck0Var2.getImageReceiver().getLottieAnimation().w()) {
                ...
                if (fk0Var.f26128j0) {
                    ...
                    ck0Var2.getImageReceiver().getLottieAnimation().L(ck0Var2.getImageReceiver().getLottieAnimation().f32585e[0] - 1, false, true);
                }
            }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (j1Var2 != null && j1Var2.f605a && this.F != null && LiteMode.isEnabled(8200) && LiteMode.isEnabled(131072)) {
            ...
            xi0 lottieAnimation = this.f25435a.getImageReceiver().getLottieAnimation();
            zh.h8 h8Var = this.F;
            if (lottieAnimation != null && (i10 = lottieAnimation.f32581b0) > 30) {
                f7 = Utilities.clamp01((i10 - 30) / 30.0f);
            } else {
                f7 = 0.0f;
            }
            h8Var.f52030j = (int) (h8Var.f52024b.size() * f7);
            this.F.g(rectF);
            this.F.d();
    ...
    public final void e(ah.j1 j1Var) {
        ...
        if (j1Var != null && j1Var.f605a) {
            ...
            ah.j1 j1Var2 = this.f25438e;
            if (j1Var2.f606b) {
                TLRPC.Document effectDocument = MessagesController.getInstance(fk0Var.J).getEffectDocument(this.f25438e.f610g);
                SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(effectDocument, org.telegram.ui.ActionBar.j6.f20855m6, 0.2f);
                ...
                imageReceiver.setImage(forDocument, "60_60_firstframe", null, null, svgDrawable4, 0L, "tgs", this.f25438e, 0);
            } else if (j1Var2.f609f != null) {
                TLRPC.TL_availableReaction tL_availableReaction2 = MediaDataController.getInstance(fk0Var.J).getReactionsMap().get(this.f25438e.f609f);
                if (tL_availableReaction2 != null) {
                    SvgHelper.SvgDrawable svgThumb2 = DocumentObject.getSvgThumb(tL_availableReaction2.activate_animation, org.telegram.ui.ActionBar.j6.f20855m6, 0.2f);
                    if (!LiteMode.isEnabled(8200) || i11 == 4) {
                        ...
                        if (SharedConfig.getDevicePerformanceClass() > 0 && i11 != 4) {
                            ...
                            imageReceiver2.setImage(forDocument2, "60_60_firstframe", null, null, svgDrawable2, 0L, "tgs", this.f25438e, 0);
                        } else {
                            ...
                            imageReceiver3.setImage(forDocument3, "60_60_firstframe", null, null, svgDrawable, 0L, "tgs", this.f25438e, 0);
                        }
                    } else {
                        tL_availableReaction = tL_availableReaction2;
                        ...
                        imageReceiver4.setImage(forDocument4, "60_60_pcache", null, null, svgDrawable3, 0L, "tgs", this.f25438e, 0);
                    }
                    if (ck0Var.getImageReceiver().getLottieAnimation() != null) {
                        ck0Var.getImageReceiver().getLottieAnimation().L(0, false, true);
                    }
                    this.f25437c.getImageReceiver().setImage(ImageLocation.getForDocument(tL_availableReaction.select_animation), "60_60_pcache", null, null, svgThumb2, 0L, "tgs", j1Var, 0);
    ...
    public final void f(ah.j1 j1Var, boolean z10) {
        ...
        float f13;
        float f14;
        boolean z11 = this.f25443w;
        boolean contains = this.P.f26114d0.contains(j1Var);
        this.f25443w = contains;
        if (contains != z11) {
            ck0 ck0Var = this.f25435a;
            ck0 ck0Var2 = this.f25436b;
            float f15 = 1.0f;
        ...
        if (this.O) {
            ...
            if (fk0Var.Q == null) {
                ...
                if (action == 0) {
                    ...
                    if (this.h == 1.0f && !this.H && (i10 = fk0Var.M0) != 3 && i10 != 4 && i10 != 5 && ((ek0Var = fk0Var.f26122g0) == null || ek0Var.n())) {
                ...
                if (motionEvent.getAction() == 1 && this.N && ((fk0Var.f26131l0 == null || fk0Var.f26133n0 > 0.8f) && fk0Var.f26122g0 != null)) {
                    fk0Var.f26138r0 = true;
                    if (System.currentTimeMillis() - fk0Var.f26140s0 > 300) {
                        fk0Var.f26140s0 = System.currentTimeMillis();
                        ek0 ek0Var2 = fk0Var.f26122g0;
                        ah.j1 j1Var = this.f25438e;
                        if (fk0Var.f26133n0 > 0.8f) {
                            z10 = true;
                        } else {
                            z10 = false;
                        }
                ...
                if (!fk0Var.f26138r0 && fk0Var.f26131l0 != null) {
                    fk0Var.f26134o0 = 0.0f;
                    float f7 = fk0Var.f26133n0;
                    ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                    fk0Var.Q = ofFloat;
                    ofFloat.addUpdateListener(new tj0(fk0Var, f7));
                    fk0Var.Q.addListener(new di.v5(fk0Var, 2));
                    fk0Var.Q.setDuration(150L);
                    fk0Var.Q.setInterpolator(pr.f29494f);
                    fk0Var.Q.start();
                }
