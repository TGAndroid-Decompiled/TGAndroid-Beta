    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.G) {
            case 0:
                ...
                if (this.f28301a.getLottieAnimation() != null && !ek0Var.E) {
                    this.f28301a.getLottieAnimation().start();
                }
                if (ek0Var.f23586s && !ek0Var.v && this.f28301a.getLottieAnimation() != null && this.f28301a.getLottieAnimation().A() && dk0Var.f28301a.getLottieAnimation() != null && dk0Var.f28301a.getLottieAnimation().u()) {
                    ek0Var.v = true;
                    dk0Var.f28301a.getLottieAnimation().N(0, false, true);
