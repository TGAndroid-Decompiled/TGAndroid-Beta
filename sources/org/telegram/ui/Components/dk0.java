...
public final class dk0 extends FrameLayout {
    ...
    public boolean O;
    public final fk0 P;
    public final ck0 f23345a;
    public final ck0 f23346b;
    public final ck0 f23347c;
    public final ImageReceiver d;
    public zg.p0 e;
    public rg.b1 f23348f;
    public float h;
    ...
    public dk0(fk0 fk0Var, Context context) {
        ...
        ck0Var2.f28314a.setAutoRepeat(0);
        ck0Var2.f28314a.setAllowStartAnimation(false);
        ck0Var2.f28314a.setAllowStartLottieAnimation(false);
    ...
    public static void a(dk0 dk0Var, zg.p0 p0Var, int i10) {
        ...
        boolean z11;
        int i11;
        ck0 ck0Var = dk0Var.f23347c;
        ck0 ck0Var2 = dk0Var.f23345a;
        ck0 ck0Var3 = dk0Var.f23346b;
        fk0 fk0Var = dk0Var.P;
        ...
        int i12 = fk0Var.J;
        org.telegram.ui.ActionBar.e6 e6Var = fk0Var.f23990k0;
        int i13 = fk0Var.M0;
        ...
        dk0Var.H = z10;
        if (z10 && dk0Var.f23348f == null) {
            rg.b1 b1Var = new rg.b1(dk0Var.getContext(), 1, null);
            dk0Var.f23348f = b1Var;
            b1Var.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
            dk0Var.f23348f.setImageReceiver(ck0Var3.getImageReceiver());
            dk0Var.addView(dk0Var.f23348f, w7.x5.d(18, 18.0f, 17, 8.0f, 8.0f, 0.0f, 0.0f));
        }
        rg.b1 b1Var2 = dk0Var.f23348f;
        if (b1Var2 != null) {
            if (dk0Var.H) {
                i11 = 0;
            } else {
        ...
        dk0Var.d();
        dk0Var.e = p0Var;
        if (!p0Var.f49124a && (p0Var.f49127f == null || ((!fk0Var.q() && !fk0Var.G0) || !LiteMode.isEnabled(8200)))) {
            z11 = false;
        } else {
            z11 = true;
        }
        dk0Var.f23350r = z11;
        if (i13 == 4 || dk0Var.e.f49125b) {
            dk0Var.f23350r = false;
        }
        zg.p0 p0Var3 = dk0Var.e;
        if (!p0Var3.f49124a && p0Var3.f49127f == null) {
            ck0Var.getImageReceiver().clearImage();
            ck0Var3.getImageReceiver().clearImage();
            o5 o5Var = new o5(4, fk0Var.J, dk0Var.e.f49128g);
            o5 o5Var2 = new o5(3, fk0Var.J, dk0Var.e.f49128g);
            if (i13 != 1 && i13 != 2 && i13 != 4) {
                int i14 = org.telegram.ui.ActionBar.i6.f19166v6;
    ...
    public final void b() {
        ...
        ck0 ck0Var = this.f23346b;
        o5 o5Var = ck0Var.e;
        if (o5Var != null) {
            imageReceiver = o5Var.f26692k;
        } else {
            imageReceiver = ck0Var.f28314a;
        }
        if (imageReceiver != null && imageReceiver.getLottieAnimation() != null) {
            fk0 fk0Var = this.P;
            if (fk0Var.f24007x0 == null && !this.N && fk0Var.G0) {
                if (imageReceiver.getLottieAnimation().f29948b0 <= 2) {
    ...
    public final void c(int i10) {
        ...
        if (this.f23350r) {
            if (this.f23345a.getImageReceiver().getLottieAnimation() != null && !this.f23345a.getImageReceiver().getLottieAnimation().y() && !this.f23349n) {
                this.f23349n = true;
                if (i10 == 0) {
                    this.E = false;
                    this.f23345a.getImageReceiver().getLottieAnimation().stop();
                    this.f23345a.getImageReceiver().getLottieAnimation().N(0, false, false);
                    this.G.run();
                    return;
                }
                this.E = true;
            ...
            if (this.f23345a.getImageReceiver().getLottieAnimation() != null && this.f23349n && !this.f23345a.getImageReceiver().getLottieAnimation().f29960l0 && !this.f23345a.getImageReceiver().getLottieAnimation().y()) {
                this.f23345a.getImageReceiver().getLottieAnimation().N(this.f23345a.getImageReceiver().getLottieAnimation().e[0] - 1, false, false);
            }
            ck0 ck0Var3 = this.f23346b;
            float f14 = this.I;
            if (this.f23352w) {
                f7 = 0.76f;
            } else {
            ...
            ck0 ck0Var4 = this.f23346b;
            float f15 = this.I;
            if (!this.f23352w) {
                f11 = 1.0f;
            }
            ck0Var4.setScaleX(f15 * f11);
        } else if (!this.f23349n) {
            this.I = 0.0f;
            this.f23346b.setScaleX(0.0f);
            this.f23346b.setScaleY(0.0f);
            ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
            this.J = ofFloat;
            ofFloat.addUpdateListener(new h70(this, 9));
            this.J.setDuration(150L);
            this.J.setInterpolator(qr.h);
            this.J.setStartDelay(i10 * this.P.f23972c);
            this.J.start();
            this.f23349n = true;
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        zg.p0 p0Var2 = this.e;
        if (p0Var2 != null && p0Var2.f49124a && this.F != null && LiteMode.isEnabled(8200) && LiteMode.isEnabled(131072)) {
            ...
            xi0 lottieAnimation = this.f23345a.getImageReceiver().getLottieAnimation();
            yh.k8 k8Var = this.F;
            if (lottieAnimation != null && (i10 = lottieAnimation.f29948b0) > 30) {
                f7 = Utilities.clamp01((i10 - 30) / 30.0f);
            } else {
                f7 = 0.0f;
            }
            k8Var.f47384j = (int) (k8Var.f47379b.size() * f7);
            this.F.g(rectF);
            this.F.d();
    ...
    public final void e(zg.p0 p0Var) {
        ...
        } else if (i11 == 4 && p0Var != null && p0Var.f49127f != null) {
            ck0Var.getImageReceiver().setImageBitmap(Emoji.getEmojiDrawable(p0Var.f49127f));
            ck0Var2.getImageReceiver().setImageBitmap(Emoji.getEmojiDrawable(p0Var.f49127f));
        } else {
            zg.p0 p0Var2 = this.e;
            if (p0Var2.f49125b) {
                TLRPC.Document effectDocument = MessagesController.getInstance(fk0Var.J).getEffectDocument(this.e.f49128g);
                SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(effectDocument, org.telegram.ui.ActionBar.i6.f19001m6, 0.2f);
                ...
                TLRPC.TL_availableReaction tL_availableReaction2 = MediaDataController.getInstance(fk0Var.J).getReactionsMap().get(this.e.f49127f);
                if (tL_availableReaction2 != null) {
                    SvgHelper.SvgDrawable svgThumb2 = DocumentObject.getSvgThumb(tL_availableReaction2.activate_animation, org.telegram.ui.ActionBar.i6.f19001m6, 0.2f);
                    ...
                    this.f23347c.getImageReceiver().setImage(ImageLocation.getForDocument(tL_availableReaction.select_animation), "60_60_pcache", null, null, svgThumb2, 0L, "tgs", p0Var, 0);
    ...
    public final void f(zg.p0 p0Var, boolean z10) {
        ...
        float f13;
        float f14;
        boolean z11 = this.f23352w;
        boolean contains = this.P.f23975d0.contains(p0Var);
        this.f23352w = contains;
        if (contains != z11) {
            ck0 ck0Var = this.f23345a;
            ck0 ck0Var2 = this.f23346b;
            float f15 = 1.0f;
        ...
        if (this.O) {
            ...
            if (fk0Var.Q == null) {
                ...
                if (action == 0) {
                    ...
                    if (this.h == 1.0f && !this.H && (i10 = fk0Var.M0) != 3 && i10 != 4 && i10 != 5 && ((ek0Var = fk0Var.f23982g0) == null || ek0Var.j())) {
                ...
                if (motionEvent.getAction() == 1 && this.N && ((fk0Var.f23991l0 == null || fk0Var.f23993n0 > 0.8f) && fk0Var.f23982g0 != null)) {
                    fk0Var.f23998r0 = true;
                    if (System.currentTimeMillis() - fk0Var.f24000s0 > 300) {
                        fk0Var.f24000s0 = System.currentTimeMillis();
                        ek0 ek0Var2 = fk0Var.f23982g0;
                        zg.p0 p0Var = this.e;
                        if (fk0Var.f23993n0 > 0.8f) {
                            z10 = true;
                        } else {
                            z10 = false;
                        }
                ...
                if (!fk0Var.f23998r0 && fk0Var.f23991l0 != null) {
                    fk0Var.f23994o0 = 0.0f;
                    float f7 = fk0Var.f23993n0;
                    ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                    fk0Var.Q = ofFloat;
                    ofFloat.addUpdateListener(new tj0(fk0Var, f7));
                    fk0Var.Q.addListener(new ci.v5(fk0Var, 2));
                    fk0Var.Q.setDuration(150L);
                    fk0Var.Q.setInterpolator(qr.f27423f);
                    fk0Var.Q.start();
                }
