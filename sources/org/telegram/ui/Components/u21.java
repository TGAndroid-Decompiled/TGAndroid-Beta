...
public final class u21 implements Runnable {
    ...
    public final Object f28693f;
    public final Object h;
    public final TLObject f28694n;
    ...
    public final void run() {
        ...
        switch (this.f28690a) {
            case 0:
                ...
                final y70 y70Var = (y70) this.f28693f;
                final TLRPC.User user = (TLRPC.User) this.h;
                final TLRPC.Chat chat = (TLRPC.Chat) this.f28694n;
                ...
                return;
            default:
                yh.g.Z((yh.g) this.d, (TLRPC.TL_error) this.e, (TwoStepVerificationActivity) this.f28693f, (Activity) this.h, this.f28691b, this.f28692c, this.f28694n);
                return;
        }
    }
    ...
    public u21(yh.g gVar, TLRPC.TL_error tL_error, TwoStepVerificationActivity twoStepVerificationActivity, Activity activity, boolean z10, long j3, TLObject tLObject) {
        this.d = gVar;
        this.e = tL_error;
        this.f28693f = twoStepVerificationActivity;
        this.h = activity;
        this.f28691b = z10;
        this.f28692c = j3;
        this.f28694n = tLObject;
    }
}
