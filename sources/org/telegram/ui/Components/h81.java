...
public class h81 extends FrameLayout {
    ...
    public float R;
    public final org.telegram.ui.ActionBar.d6 f24568a;
    public int f24569b;
    ...
    public final boolean A(android.view.MotionEvent r12) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.h81.A(android.view.MotionEvent):boolean");
    }

    public final boolean B(MotionEvent motionEvent, boolean z10) {
        int i10;
        if (!z10 && this.f24569b == 0) {
            this.R = 0.0f;
            return false;
        } else if ((z10 && this.f24569b == this.L.e() - 1) || this.Q != null || !i(motionEvent) || ((z10 && !k(motionEvent)) || (!z10 && !j(motionEvent)))) {
            return false;
        } else {
            ...
            this.H = true;
            v();
            this.f24573r = (int) (motionEvent.getX() + this.E);
            x71 x71Var = this.M;
            if (x71Var != null) {
    ...
    public final void C(boolean z10) {
        ...
        AnimatorSet animatorSet = this.f24575w;
        if (animatorSet != null) {
            animatorSet.cancel();
            this.f24575w = null;
        }
        ...
        if (this.f24569b > this.L.e() - 1) {
            this.f24569b = this.L.e() - 1;
        }
        if (this.f24569b < 0) {
            this.f24569b = 0;
        }
        int h = this.L.h(this.f24569b);
        int[] iArr = this.f24571f;
        iArr[0] = h;
        View d = this.L.d(h);
        viewArr[0] = d;
        this.L.b(d, this.f24569b, iArr[0]);
        addView(viewArr[0]);
        ...
        if (z10) {
            ...
            if (view7 != null) {
                this.f24575w.playTogether(H(view7, getMeasuredWidth()));
            }
            View view8 = viewArr[0];
            if (view8 != null) {
                this.f24575w.playTogether(H(view8, 0.0f));
            }
            w(true);
            x71 x71Var = this.M;
            x71Var.f24208a = 0.0f;
            ...
            ofFloat.addUpdateListener(new v71(this, 2));
            this.f24575w.playTogether(ofFloat);
            this.f24575w.setInterpolator(S);
            this.f24575w.setDuration(220L);
            this.f24575w.addListener(new w71(this, 2));
    ...
    public final void D(int i10) {
        ...
        if (i10 != this.f24569b) {
            ...
            if (valueAnimator == null || this.d != i10) {
                ...
                ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                this.Q = ofFloat;
                ofFloat.addUpdateListener(new v71(this, 0));
                this.Q.addListener(new w71(this, 0));
    ...
    public void F() {
        ...
        this.f24569b = i11;
        this.d = i10;
        this.f24570c = 1.0f - this.f24570c;
        int[] iArr = this.f24571f;
        int i12 = iArr[0];
        iArr[0] = iArr[1];
        iArr[1] = i12;
    ...
    public final boolean canScrollHorizontally(int i10) {
        boolean z10;
        if (i10 != 0) {
            if (!this.f24576x && !this.H) {
                if (i10 > 0) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                if ((z10 || this.f24569b != 0) && (!z10 || this.f24569b != this.L.e() - 1)) {
                }
            }
            return true;
        }
    ...
    public float getPositionAnimated() {
        ...
        View view = viewArr[0];
        if (view != null && view.getVisibility() == 0) {
            f7 = (this.f24569b * Utilities.clamp(1.0f - Math.abs(viewArr[0].getTranslationX() / getAvailableTranslationX()), 1.0f, 0.0f)) + 0.0f;
        } else {
            f7 = 0.0f;
        }
        View view2 = viewArr[1];
    ...
    public final void l() {
        ...
        if (this.H) {
            ...
            if (this.F) {
                f7 = Math.abs(x10);
                if (this.f24577y) {
                    this.f24575w.playTogether(H(viewArr[0], 0.0f));
                    View view4 = viewArr[1];
                    if (view4 != null) {
                        this.f24575w.playTogether(H(view4, view4.getMeasuredWidth()));
                    }
                } else {
                    this.f24575w.playTogether(H(viewArr[0], 0.0f));
                    View view5 = viewArr[1];
                    if (view5 != null) {
                        this.f24575w.playTogether(H(view5, -view5.getMeasuredWidth()));
                    }
                }
            } else if (this.d >= 0) {
                f7 = viewArr[0].getMeasuredWidth() - Math.abs(x10);
                if (this.f24577y) {
                    this.f24575w.playTogether(H(viewArr[0], -view2.getMeasuredWidth()));
                    View view6 = viewArr[1];
                    if (view6 != null) {
                        this.f24575w.playTogether(H(view6, 0.0f));
                    }
                } else {
                    this.f24575w.playTogether(H(viewArr[0], view.getMeasuredWidth()));
                    View view7 = viewArr[1];
                    if (view7 != null) {
                        this.f24575w.playTogether(H(view7, 0.0f));
                    }
                }
            } else {
                f7 = 0.0f;
            ...
            if (this.d < 0) {
                ...
                ofFloat.addUpdateListener(new v71(this, 3));
                this.f24575w.playTogether(ofFloat);
            }
            ValueAnimator ofFloat2 = ValueAnimator.ofFloat(0.0f, 1.0f);
            ofFloat2.addUpdateListener(this.N);
            this.f24575w.playTogether(ofFloat2);
            this.f24575w.setInterpolator(S);
            ...
            this.f24575w.setDuration(Math.max(150, Math.min(measuredWidth2, 600)));
            this.f24575w.addListener(new w71(this, 3));
            this.f24575w.start();
            this.f24576x = true;
            this.H = false;
            w(false);
    ...
    public final g81 n(int i10, boolean z10) {
        x71 x71Var = new x71(this, getContext(), z10, i10, this.f24568a);
        this.M = x71Var;
        x71Var.f24229r = G();
    ...
    public final void o(boolean z10) {
        ...
        if (this.L != null && (x71Var = this.M) != null) {
            x71Var.h.clear();
            x71Var.f24211b0.clear();
            x71Var.f24213c0.clear();
            x71Var.f24214d0.clear();
            x71Var.f24215e0.clear();
            x71Var.H = 0;
    ...
    public void setAdapter(z71 z71Var) {
        this.L = z71Var;
        int h = z71Var.h(this.f24569b);
        int[] iArr = this.f24571f;
        iArr[0] = h;
        View d = z71Var.d(h);
        View[] viewArr = this.e;
        viewArr[0] = d;
        if (d == null && this.f24569b != 0) {
            this.f24569b = 0;
            int h10 = z71Var.h(0);
            iArr[0] = h10;
            viewArr[0] = z71Var.d(h10);
        }
        z71Var.b(viewArr[0], this.f24569b, iArr[0]);
        addView(viewArr[0]);
        viewArr[0].setVisibility(0);
        o(false);
    }
    ...
    public void setPosition(int i10) {
        ...
        View view = viewArr[1];
        if (view != null) {
            this.h.put(this.f24571f[1], view);
        ...
        if (i11 != i10) {
            ...
            View view2 = viewArr[0];
            I(0);
            t(viewArr[0], view2, this.f24569b, i11);
            E(viewArr[0], 0.0f);
            x71 x71Var = this.M;
            if (x71Var != null) {
                x71Var.e(this.f24570c, this.f24569b, this.d);
            }
            w(true);
        }
    }
