...
public final class c4 extends LinearLayout {
    public final int f24881a = 1;
    public boolean f24882b;
    public final vc0 f24883c;
    public final Object d;
    public final vc0 f24884e;
    public final vc0 f24885f;
    ...
    public c4(Context context, c5 c5Var, vc0 vc0Var, ug.h hVar, ug.i iVar) {
        ...
        textPaint.setColor(c5Var.f24887a);
    }
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f24881a) {
            case 1:
                super.onDraw(canvas);
                canvas.drawText(":", ((ug.h) this.f24884e).getRight() - AndroidUtilities.dp(12.0f), (getHeight() / 2.0f) - AndroidUtilities.dp(11.0f), (TextPaint) this.d);
                return;
            default:
                super.onDraw(canvas);
                return;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        switch (this.f24881a) {
            case 0:
                ...
                vc0 vc0Var2 = this.f24883c;
                vc0Var2.setItemCount(i12);
                vc0Var.setItemCount(i12);
                vc0 vc0Var3 = this.f24884e;
                vc0Var3.setItemCount(i12);
                vc0 vc0Var4 = this.f24885f;
                ...
                return;
            default:
                ug.i iVar = (ug.i) this.f24885f;
                ug.h hVar = (ug.h) this.f24884e;
                this.f24882b = true;
    ...
    public c4(Context context, vc0 vc0Var, vc0 vc0Var2, vc0 vc0Var3, vc0 vc0Var4) {
        ...
        this.f24883c = vc0Var;
        this.d = vc0Var2;
        this.f24884e = vc0Var3;
        this.f24885f = vc0Var4;
        this.f24882b = false;
    }
}
