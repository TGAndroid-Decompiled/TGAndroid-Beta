...
public final class c4 extends LinearLayout {
    public final int f24909a = 1;
    public boolean f24910b;
    public final vc0 f24911c;
    public final Object d;
    public final vc0 f24912e;
    public final vc0 f24913f;
    ...
    public c4(Context context, c5 c5Var, vc0 vc0Var, ug.h hVar, ug.i iVar) {
        ...
        textPaint.setColor(c5Var.f24915a);
    }
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f24909a) {
            case 1:
                super.onDraw(canvas);
                canvas.drawText(":", ((ug.h) this.f24912e).getRight() - AndroidUtilities.dp(12.0f), (getHeight() / 2.0f) - AndroidUtilities.dp(11.0f), (TextPaint) this.d);
                return;
            default:
                super.onDraw(canvas);
                return;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        switch (this.f24909a) {
            case 0:
                ...
                vc0 vc0Var2 = this.f24911c;
                vc0Var2.setItemCount(i12);
                vc0Var.setItemCount(i12);
                vc0 vc0Var3 = this.f24912e;
                vc0Var3.setItemCount(i12);
                vc0 vc0Var4 = this.f24913f;
                ...
                return;
            default:
                ug.i iVar = (ug.i) this.f24913f;
                ug.h hVar = (ug.h) this.f24912e;
                this.f24910b = true;
    ...
    public c4(Context context, vc0 vc0Var, vc0 vc0Var2, vc0 vc0Var3, vc0 vc0Var4) {
        ...
        this.f24911c = vc0Var;
        this.d = vc0Var2;
        this.f24912e = vc0Var3;
        this.f24913f = vc0Var4;
        this.f24910b = false;
    }
}
