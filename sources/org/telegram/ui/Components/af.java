...
public final class af extends ImageView {
    ...
    public final ChatActivityEnterView f24379b;

    public af(ChatActivityEnterView chatActivityEnterView, Context context) {
        super(context);
        this.f24379b = chatActivityEnterView;
    }
    ...
    public final void setTranslationX(float f7) {
        ...
        this.f24378a = f7;
        float f11 = -44.0f;
        float dp = AndroidUtilities.dp(-44.0f) + this.f24378a;
        ChatActivityEnterView chatActivityEnterView = this.f24379b;
        float f12 = dp + chatActivityEnterView.f23826y + chatActivityEnterView.f23820x;
        ...
        cf cfVar3 = chatActivityEnterView.f23816w1;
        float dp3 = AndroidUtilities.dp((cfVar3 == null || cfVar3.getVisibility() != 0) ? 0.0f : 0.0f);
        cf cfVar4 = chatActivityEnterView.f23816w1;
        if (cfVar4 != null) {
            f13 = cfVar4.getAlpha();
        }
