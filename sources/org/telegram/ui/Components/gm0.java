...
public final class gm0 extends ww0 {
    public float d;
    public final Paint f24477f;
    public boolean f24474a = false;
    public long f24475b = 0;
    public boolean f24476c = false;
    public int e = 1;

    public gm0(boolean z10) {
        if (z10) {
            this.f24477f = new Paint(1);
        }
    }

    @Override
    public final void b(int i10) {
        Paint paint = this.f24477f;
        if (paint != null) {
            paint.setColor(i10);
        }
    }
    ...
    @Override
    public final void d() {
        this.f24475b = System.currentTimeMillis();
        this.f24476c = true;
        invalidateSelf();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.f24476c) {
            ...
            long j3 = currentTimeMillis - this.f24475b;
