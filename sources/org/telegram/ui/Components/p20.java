...
public final class p20 extends s4.o {
    ...
    public final boolean b(int i10, int i11) {
        ...
        if (size3 >= 0 && size3 < s20Var.f27747f.size() && size2 >= 0 && size2 < arrayList2.size()) {
            if (MessageObject.getPeerId(((TLRPC.GroupCallParticipant) arrayList2.get(size2)).peer) != MessageObject.getPeerId(((TLRPC.GroupCallParticipant) s20Var.f27747f.get(size3)).peer)) {
                return false;
            }
            return true;
        }
        ...
        if (i11 < s20Var.e.size()) {
            ...
            groupCallParticipant2 = (TLRPC.GroupCallParticipant) s20Var.f27747f.get(size3);
        }
    ...
    public final int d() {
        s20 s20Var = this.d;
        return s20Var.f27747f.size() + s20Var.e.size();
    }

    @Override
    public final int e() {
        return this.f26932c.size() + this.f26931b.size();
    }
}
