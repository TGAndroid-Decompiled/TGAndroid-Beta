...
public final class p20 extends s4.o {
    public final ArrayList f26916b;
    ...
    public final boolean b(int i10, int i11) {
        ...
        ArrayList arrayList = this.f26916b;
        ...
        ArrayList arrayList2 = this.f26917c;
        if (size3 >= 0 && size3 < s20Var.f27751f.size() && size2 >= 0 && size2 < arrayList2.size()) {
            if (MessageObject.getPeerId(((TLRPC.GroupCallParticipant) arrayList2.get(size2)).peer) != MessageObject.getPeerId(((TLRPC.GroupCallParticipant) s20Var.f27751f.get(size3)).peer)) {
                return false;
            }
            return true;
        }
        ...
        if (i11 < s20Var.e.size()) {
            ...
            groupCallParticipant2 = (TLRPC.GroupCallParticipant) s20Var.f27751f.get(size3);
        }
    ...
    public final int d() {
        s20 s20Var = this.d;
        return s20Var.f27751f.size() + s20Var.e.size();
    }

    @Override
    public final int e() {
        return this.f26917c.size() + this.f26916b.size();
    }
}
