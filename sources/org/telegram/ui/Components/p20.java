...
public class p20 {
    ...
    public final Paint f26912c = new Paint(1);
    public final RectF h = new RectF();
    public final Matrix f26916j = new Matrix();
    public Bitmap f26917k = null;
    public final int[] f26918l = new int[4];
    ...
    public final int a() {
        ...
        int i12 = this.f26913f;
        if (i12 != 0) {
            i10 = i0.a.d(0.5f, i10, i12);
        }
        int i13 = this.f26914g;
        if (i13 != 0) {
    ...
    public final void d(int i10, int i11, int i12, int i13) {
        float f7;
        float f10;
        if (this.f26915i != null && this.d == i10 && this.e == i11 && this.f26913f == i12 && this.f26914g == i13) {
            return;
        }
        this.d = i10;
        int[] iArr = this.f26918l;
        iArr[0] = i10;
        this.e = i11;
        iArr[1] = i11;
        this.f26913f = i12;
        ...
        this.f26914g = i13;
        iArr[3] = i13;
        Paint paint = this.f26912c;
        if (i11 == 0) {
            this.f26915i = null;
            paint.setShader(null);
            paint.setColor(i10);
        } else if (i12 == 0) {
            if (this.f26910a && this.f26911b) {
                ...
                this.f26915i = linearGradient2;
                paint.setShader(linearGradient2);
            }
        } else if (this.f26919m) {
            if (this.f26910a && this.f26911b) {
                ...
                this.f26915i = linearGradient4;
                paint.setShader(linearGradient4);
            }
        } else {
            if (this.f26917k == null) {
                this.f26917k = Bitmap.createBitmap(60, 80, Bitmap.Config.ARGB_8888);
            }
            Utilities.generateGradient(this.f26917k, 0, 0.0f, iArr);
            Bitmap bitmap = this.f26917k;
            Shader.TileMode tileMode = Shader.TileMode.CLAMP;
            BitmapShader bitmapShader = new BitmapShader(bitmap, tileMode, tileMode);
            this.f26915i = bitmapShader;
    ...
    public void e() {
        ...
        this.f26915i.setLocalMatrix(matrix);
    }
}
