...
public final class qq0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public String f28220r;
    public final ArrayList f28221s;
    public final HashMap v;
    public TLRPC.WebPage f28222w;
    public int f28223x;
    public int f28224y;

    public qq0(Activity activity, org.telegram.ui.ActionBar.f6 f6Var) {
        super(activity);
        this.f28215a = new oq0[2];
        this.f28216b = 0;
        this.f28218f = new ArrayList();
        this.f28219n = true;
        this.f28221s = new ArrayList();
        this.v = new HashMap();
        int i10 = 0;
        while (true) {
            oq0[] oq0VarArr = this.f28215a;
            if (i10 < oq0VarArr.length) {
                oq0VarArr[i10] = new oq0(this, activity, f6Var);
                addView(this.f28215a[i10], k7.b6.c(-1.0f, -1));
                i10++;
            } else {
                oq0VarArr[0].setVisibility(0);
                this.f28215a[1].setVisibility(8);
                return;
            }
        }
    }
    ...
    public static void a(oq0 oq0Var, TLRPC.WebPage webPage, String str) {
        ImageView imageView = oq0Var.f27646b;
        p9 p9Var = oq0Var.f27649n;
        imageView.setImageResource(R.drawable.msg_link2);
        oq0Var.f27646b.setVisibility(0);
        oq0Var.f27648f.setVisibility(8);
        oq0Var.f27650r.setVisibility(0);
        ...
        oq0Var.f27645a.setClickable(false);
    }
    ...
    public final String c(oq0 oq0Var) {
        ...
        while (i10 < size) {
            ...
            if (longValue == this.d) {
                ...
                if (arrayList.size() == 1) {
                    shortName = DialogObject.getName(this.f28217c, longValue);
                } else {
                    shortName = DialogObject.getShortName(this.f28217c, longValue);
                }
                sb.append(shortName);
            }
        }
    ...
    public final void d() {
        if (this.f28223x != 0) {
            AccountInstance.getInstance(this.f28217c).getConnectionsManager().cancelRequest(this.f28223x, true);
            this.f28223x = 0;
        }
        this.f28224y++;
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        String str;
        if (i10 == NotificationCenter.didReceivedWebpagesInUpdates && this.f28222w != null && i11 == this.f28217c) {
            a0.h hVar = (a0.h) objArr[0];
            for (int i12 = 0; i12 < hVar.m(); i12++) {
                TLRPC.WebPage webPage = (TLRPC.WebPage) hVar.n(i12);
                if (webPage != null && webPage.f19337id == this.f28222w.f19337id) {
                    if (webPage instanceof TLRPC.TL_webPageEmpty) {
                        ...
                        this.f28222w = webPage;
                        ArrayList arrayList = this.f28221s;
                        if (arrayList.isEmpty()) {
                            str = "";
                        } else {
    ...
    public final p9 f(int i10) {
        p9[] p9VarArr;
        if (this.f28216b == 1 && (p9VarArr = this.f28215a[0].h) != null && i10 >= 0 && i10 < p9VarArr.length && p9VarArr[i10].getVisibility() == 0) {
            return p9VarArr[i10];
        }
        return null;
    }
    ...
    public final void h(int i10) {
        if (this.f28217c == i10) {
            ...
            if (isAttachedToWindow()) {
                NotificationCenter.getInstance(this.f28217c).addObserver(this, NotificationCenter.didReceivedWebpagesInUpdates);
                return;
            }
            return;
        }
        if (isAttachedToWindow()) {
            NotificationCenter.getInstance(this.f28217c).removeObserver(this, NotificationCenter.didReceivedWebpagesInUpdates);
        }
        this.f28217c = i10;
        if (isAttachedToWindow()) {
            NotificationCenter.getInstance(this.f28217c).addObserver(this, NotificationCenter.didReceivedWebpagesInUpdates);
    ...
    public final void i(int i10, ArrayList arrayList) {
        ...
        org.telegram.ui.ActionBar.k5 k5Var2 = oq0Var.f27647c;
        imageView.setImageResource(R.drawable.filled_forward);
        oq0Var.f27646b.setVisibility(0);
        oq0Var.f27649n.setVisibility(8);
        oq0Var.f27648f.setVisibility(0);
        oq0Var.f27650r.setVisibility(8);
        oq0Var.f27645a.setClickable(true);
        ...
        int i16 = this.f28216b;
        if (i12 != i16 && (pq0Var = this.E) != null) {
            ((org.telegram.ui.sv) pq0Var).g(i16);
        }
    }
    ...
    public void setLayoutClickListener(View.OnClickListener onClickListener) {
        for (oq0 oq0Var : this.f28215a) {
            oq0Var.f27645a.setOnClickListener(onClickListener);
        }
    }
