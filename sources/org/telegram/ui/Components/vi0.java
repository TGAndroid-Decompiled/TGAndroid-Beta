...
public final class vi0 {
    public final e6 f29088a;
    public final o6 f29089b;
    public final int f29090c;
    public boolean d;
    public final aj0 e;
    public final yc f29091f;
    public final Paint f29092g = new Paint(1);
    public boolean h;

    public vi0(View view) {
        this.f29088a = new e6(view, 350L, qr.h);
        this.e = new aj0(view);
        this.f29091f = new yc(view);
        ...
        this.f29090c = (int) Math.ceil(Math.max(textPaint.measureText(string), textPaint.measureText(LocaleController.getString(R.string.QuoteCollapse))));
    }

    public final void a(Canvas canvas, RectF rectF, float f7, float f10, int i10, boolean z10, boolean z11) {
        int i11;
        boolean z12 = this.d;
        o6 o6Var = this.f29089b;
        if (z10 != z12) {
            this.d = z10;
            if (z10) {
        ...
        float a2 = this.f29091f.a(0.02f) * this.f29088a.e(z11);
        if (a2 > 0.0f) {
            int k10 = i0.a.k(i10, 30);
            Paint paint = this.f29092g;
            paint.setColor(k10);
            canvas.save();
            ...
            Paint paint2 = aj0Var.f22632b;
            paint2.setColor(i10);
            paint2.setAlpha(aj0Var.d);
            boolean z13 = !z10;
            if (aj0Var.e != z13) {
                aj0Var.e = z13;
                aj0Var.f22631a.invalidate();
            }
            aj0Var.draw(canvas);
            canvas.restore();
        }
