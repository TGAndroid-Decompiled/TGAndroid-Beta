...
public final class ps0 implements lm0 {
    ...
    public final void C() {
        ...
        if (qt0Var.F == 0) {
            L0 = (qt0Var.f29824x.L0() / xu0Var.f32705m1[0]) * a2;
        } else {
            L0 = qt0Var.f29824x.L0() * a2;
        }
    ...
    public final boolean n1(int i10, View view) {
        ...
        if (n2Var != null && xu0.d0(i10, xu0Var.f32687d1 instanceof TLRPC.TL_channelFull) != null) {
            if (xu0Var.f32687d1 instanceof TLRPC.TL_channelFull) {
                if (ChatObject.canUserDoAction(n2Var.getMessagesController().getChat(Long.valueOf(xu0Var.f32687d1.f19870id)), 5)) {
                    profileTab = xu0Var.f32687d1.main_tab;
                    if (profileTab != null || (i10 != xu0.e0(profileTab) && xu0Var.R1 != i10)) {
                        n70 H = n70.H(n2Var, view);
                        H.W(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(24.0f), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20663d6, false)));
                        H.c(R.drawable.tabs_reorder, LocaleController.getString(R.string.ProfileTabSetAsMain), new m8(this, i10, 10), false);
                        H.Z();
                        return true;
                    }
                }
            } else if (xu0Var.f32701j1 == n2Var.getUserConfig().getClientUserId() && (userFull = xu0Var.f32690e1) != null) {
                profileTab = userFull.main_tab;
                if (profileTab != null) {
                }
                n70 H2 = n70.H(n2Var, view);
                H2.W(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(24.0f), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20663d6, false)));
