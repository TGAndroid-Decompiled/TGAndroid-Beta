...
public final class jg0 extends FrameLayout {
    public final int f25269a = 4;
    public boolean f25270b;
    public Object f25271c;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (i10) {
            case 1:
                Paint paint = (Paint) this.f25271c;
                if (this.f25270b) {
                ...
                return;
            case 2:
                Paint paint2 = (Paint) this.f25271c;
                if (this.f25270b) {
            ...
            case 3:
                ...
                if (!this.f25270b && z51Var.f39395r > 0.0f) {
                    if (((Paint) this.f25271c) == null) {
                        ...
                        ((Paint) this.f25271c).setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
                    }
                    canvas.saveLayerAlpha(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), 255, 31);
                    super.dispatchDraw(canvas);
                    ((Paint) this.f25271c).setAlpha((int) (z51Var.f39395r * 255.0f));
                    canvas.drawRect(0.0f, 0.0f, AndroidUtilities.dp(18.0f), getMeasuredHeight(), (Paint) this.f25271c);
                    canvas.restore();
                    return;
                }
                super.dispatchDraw(canvas);
        ...
        switch (this.f25269a) {
            case 4:
                ...
                if (view instanceof TextView) {
                    ...
                    if ((z10 || z12) && limitPreviewView.f22118e0 != null) {
                        canvas.saveLayer(view.getLeft(), view.getTop(), view.getRight(), view.getBottom(), (Paint) this.f25271c, 31);
                        rg.t tVar = limitPreviewView.f22118e0;
                        float x10 = getX() + ((ViewGroup) getParent()).getX();
                        float y3 = ((ViewGroup) getParent()).getY();
                        canvas.drawRect(view.getLeft(), view.getTop(), view.getRight(), view.getBottom(), ((org.telegram.ui.v5) ((org.telegram.ui.y0) tVar).f39741b).t0(x10, getY() + y3));
                        canvas.restore();
                        invalidate();
                        return drawChild;
                    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.f25269a) {
            case 0:
                ...
                if (f7 != 1.0f) {
                    org.telegram.ui.ActionBar.j6.f19150t0.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18933h5, false));
                ...
                if (f7 != 0.0f) {
                    ...
                    org.telegram.ui.ActionBar.j6.f19150t0.setColor(w02);
                    org.telegram.ui.ActionBar.j6.f19150t0.setAlpha((int) (alpha * 1.0f * f7));
                ...
                org.telegram.ui.ActionBar.j6.f19150t0.setColor(Color.argb((int) (qg0Var.f27300f.getAlpha() * 255.0f), Color.red(w03), Color.green(w03), Color.blue(w03)));
                canvas.drawRect(qg0.F(qg0Var), 0.0f, getMeasuredWidth() - qg0.G(qg0Var), AndroidUtilities.statusBarHeight, org.telegram.ui.ActionBar.j6.f19150t0);
                return;
            default:
                super.onDraw(canvas);
                return;
        ...
        switch (this.f25269a) {
            case 0:
                ...
                if (motionEvent.getAction() == 0 && qg0Var.E != 0) {
                    if (motionEvent.getY() < AndroidUtilities.dp(12.0f) + qg0Var.E && qg0Var.f27300f.getAlpha() == 0.0f) {
                        qg0Var.dismiss();
                        return true;
                    }
                }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.f25269a) {
            case 0:
                ...
                qg0 qg0Var = (qg0) this.d;
                w5 w5Var = qg0Var.f27306y;
                mg0 mg0Var = qg0Var.f27299c;
                kg0 kg0Var = qg0Var.f27298b;
                if (!qg0.L(qg0Var)) {
                    this.f25270b = true;
