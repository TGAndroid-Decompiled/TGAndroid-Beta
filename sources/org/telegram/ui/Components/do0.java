...
public class do0 extends ScrollView {
    public final org.telegram.ui.ActionBar.f6 f24329a;
    public final LinearLayout f24330b;
    public final float f24331c;
    public final float[] d;
    public final float[] e;
    public final ArrayList f24332f;
    public final ArrayList h;
    public final Path f24333n;

    public do0(Context context, LinearLayout linearLayout, org.telegram.ui.ActionBar.f6 f6Var, boolean z4) {
        super(context);
        float f10;
        this.f24331c = AndroidUtilities.dp(16.0f);
        this.f24332f = new ArrayList();
        this.h = new ArrayList();
        this.f24333n = new Path();
        this.f24329a = f6Var;
    ...
    public static boolean e(View view) {
        if (!Objects.equals(view.getTag(), -33024) && !(view instanceof org.telegram.ui.Cells.z8) && !(view instanceof org.telegram.ui.Cells.y6) && !(view instanceof org.telegram.ui.y10)) {
            return true;
        }
        return false;
    }
    ...
    public final void a(Canvas canvas, View view, View view2) {
        ...
        if (view != null && view2 != null) {
            ...
            float f11 = 0.0f;
            LinearLayout linearLayout = this.f24330b;
            ...
            if (rectF.bottom >= rectF.top) {
                rl0.N0(canvas, rectF, AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f), view.getAlpha(), this.f24329a);
            }
        }
    }
            ...
            if (childAt.getVisibility() == 0) {
                if (childAt instanceof LinearLayout) {
                    ...
                    if (linearLayout.getOrientation() == 1) {
                        LinearLayout linearLayout2 = this.f24330b;
    ...
    public final float c(View view) {
        if (view != this.f24330b && (view.getParent() instanceof View)) {
    ...
    public final void onScrollChanged(int i10, int i11, int i12, int i13) {
        ...
        ArrayList arrayList = this.f24332f;
        int size = arrayList.size();
        int i14 = 0;
        while (i14 < size) {
