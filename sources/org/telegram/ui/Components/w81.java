...
public final class w81 implements Runnable {
    ...
    public final void run() {
        switch (this.f30183a) {
            case 0:
                e91 e91Var = this.f30184b;
                a91 a91Var = e91Var.f24535c0;
                i71 i71Var = e91Var.f24530a;
                if (i71Var != null && i71Var.y()) {
                    a91Var.c((int) (i71Var.n() / 1000));
                    a91Var.f23350w = (int) (i71Var.j() / 1000);
                    a91Var.invalidate();
                    AndroidUtilities.runOnUIThread(e91Var.f24539f0, 1000L);
                    return;
                }
                return;
            default:
                e91 e91Var2 = this.f30184b;
                a91 a91Var2 = e91Var2.f24535c0;
                ...
                a91 a91Var3 = e91Var2.f24535c0;
                boolean z4 = e91Var2.R;
                int i10 = e91Var2.f24536d0;
                int i11 = e91Var2.f24537e0;
                e91Var2.f24534c.getVideoRotation();
