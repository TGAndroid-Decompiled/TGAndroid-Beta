...
public final class ii0 extends Drawable {
    public Path f24982a;
    public Paint f24983b;
    public float f24984c;

    public final void a() {
        int dp = AndroidUtilities.dp(18.0f);
        Path path = this.f24982a;
        path.reset();
        float f7 = dp >> 1;
        ...
        Paint paint = this.f24983b;
        paint.setStyle(Paint.Style.FILL_AND_STROKE);
        paint.setStrokeJoin(Paint.Join.ROUND);
        paint.setStrokeWidth(AndroidUtilities.dpf2(1.0f));
        this.f24984c = AndroidUtilities.density;
    }

    @Override
    public final void draw(Canvas canvas) {
        Paint paint = this.f24983b;
        if (this.f24984c != AndroidUtilities.density) {
            a();
        }
        canvas.save();
        canvas.translate(getBounds().left, getBounds().top);
        canvas.drawPath(this.f24982a, paint);
