...
public final class ii0 extends Drawable {
    public Path f24941a;
    public Paint f24942b;
    public float f24943c;

    public final void a() {
        int dp = AndroidUtilities.dp(18.0f);
        Path path = this.f24941a;
        path.reset();
        float f7 = dp >> 1;
        ...
        this.f24943c = AndroidUtilities.density;
    }

    @Override
    public final void draw(Canvas canvas) {
        Paint paint = this.f24942b;
        if (this.f24943c != AndroidUtilities.density) {
            a();
        }
        canvas.save();
        canvas.translate(getBounds().left, getBounds().top);
        canvas.drawPath(this.f24941a, paint);
