...
public final class ii0 extends Button {
    public final RectF f24965a;
    public final Paint f24966b;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Paint paint = this.f24966b;
        paint.setAlpha(min);
        canvas.drawArc(rectF, this.f24968f, 220.0f, false, paint);
        long currentTimeMillis = System.currentTimeMillis();
        if (Math.abs(this.e - System.currentTimeMillis()) < 1000) {
            long j3 = currentTimeMillis - this.e;
            int i10 = (int) (this.f24968f + (((float) (360 * j3)) / 2000.0f));
            this.f24968f = i10 - ((i10 / 360) * 360);
            if (this.f24967c) {
                float f7 = this.d;
                if (f7 < 1.0f) {
