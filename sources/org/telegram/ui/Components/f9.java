...
public abstract class f9 extends FrameLayout {
    ...
    public f9(Context context) {
        ...
        this.v = 0;
        this.f24052w = 1.0f;
        this.f24054y = new e9((gm) this);
        TLRPC.TL_emojiList a2 = a(i10);
        this.f24049n = a2;
        this.f24047c = new v9(context);
        this.d = new v9(context);
        addView(this.f24047c, w7.y5.e(50, 50, 1));
        addView(this.d, w7.y5.e(50, 50, 1));
        if (!a2.document_id.isEmpty()) {
            p5 p5Var = new p5(4, i10, a2.document_id.get(0).longValue());
            this.f24045a = p5Var;
            this.f24047c.setAnimatedEmojiDrawable(p5Var);
            b();
        }
        int[] iArr = d9.f23518c0[this.f24051s];
        int i11 = iArr[0];
        int i12 = iArr[1];
        int i13 = iArr[2];
        int i14 = iArr[3];
    ...
    public static TLRPC.TL_emojiList a(int i10) {
        ...
        if (stickerSets.isEmpty()) {
            ...
            for (int i11 = 0; i11 < featuredEmojiSets.size(); i11++) {
                ...
                if (document != null) {
                    tL_emojiList2.document_id.add(Long.valueOf(document.f18334id));
                } else if (stickerSetCovered instanceof TLRPC.TL_stickerSetFullCovered) {
                    TLRPC.TL_stickerSetFullCovered tL_stickerSetFullCovered = (TLRPC.TL_stickerSetFullCovered) stickerSetCovered;
                    if (!tL_stickerSetFullCovered.documents.isEmpty()) {
                        tL_emojiList2.document_id.add(Long.valueOf(tL_stickerSetFullCovered.documents.get(0).f18334id));
                    }
                }
            }
        } else {
            for (int i12 = 0; i12 < stickerSets.size(); i12++) {
                ...
                if (!tL_messages_stickerSet.documents.isEmpty()) {
                    tL_emojiList2.document_id.add(Long.valueOf(tL_messages_stickerSet.documents.get(Math.abs(Utilities.fastRandom.nextInt() % tL_messages_stickerSet.documents.size())).f18334id));
                }
            }
        }
    ...
    public final void b() {
        ...
        int i10 = this.v + 1;
        TLRPC.TL_emojiList tL_emojiList = this.f24049n;
        if (i10 > tL_emojiList.document_id.size() - 1) {
            this.f24053x = true;
            return;
        }
        p5 p5Var = new p5(4, this.f24050r, tL_emojiList.document_id.get(i10).longValue());
        this.f24046b = p5Var;
        p5Var.f27164m = true;
        p5Var.v();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        o20 o20Var2 = this.f24048f;
        if (o20Var2 != null) {
            o20Var2.b(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
        }
        float f7 = this.f24052w;
        if (f7 == 1.0f) {
            this.e.f26787c.setAlpha(255);
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), this.e.f26787c);
            this.f24047c.setAlpha(1.0f);
            this.f24047c.setScaleX(1.0f);
            this.f24047c.setScaleY(1.0f);
            this.d.setAlpha(0.0f);
        } else {
            float interpolation = qr.f27642f.getInterpolation(f7);
            this.e.f26787c.setAlpha(255);
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), this.e.f26787c);
            this.f24048f.f26787c.setAlpha((int) (255.0f * interpolation));
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), this.f24048f.f26787c);
            this.f24052w += 0.064f;
            float f10 = 1.0f - interpolation;
            this.f24047c.setAlpha(f10);
            this.f24047c.setScaleX(f10);
            this.f24047c.setScaleY(f10);
            this.f24047c.setPivotY(0.0f);
            ...
            if (this.f24052w > 1.0f) {
                this.f24052w = 1.0f;
                this.e = this.f24048f;
                v9 v9Var2 = this.f24047c;
                this.f24047c = this.d;
                this.d = v9Var2;
            }
            invalidate();
    ...
    public final void onAttachedToWindow() {
        ...
        AndroidUtilities.runOnUIThread(this.f24054y, 1000L);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        AndroidUtilities.cancelRunOnUIThread(this.f24054y);
    }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        ViewGroup.LayoutParams layoutParams = this.f24047c.getLayoutParams();
        this.f24047c.getLayoutParams().height = i12;
        layoutParams.width = i12;
        ViewGroup.LayoutParams layoutParams2 = this.d.getLayoutParams();
        this.d.getLayoutParams().height = i12;
        layoutParams2.width = i12;
        ((FrameLayout.LayoutParams) this.f24047c.getLayoutParams()).topMargin = i13;
