...
public final class hk0 extends View {
    ...
    public boolean U;
    public float V;
    public final org.telegram.ui.ActionBar.d6 f24707a;
    public final Paint f24708b;
    public final Paint f24709c;
    public final Paint d;
    public final Paint e;
    public final fg0 f24710f;
    public final o6 h;
    public f71 f24711n;
    public float f24712r;
    public float f24713s;
    public float v;
    public boolean f24714w;
    public final ac0 f24715x;
    public final RectF f24716y;

    public hk0(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f24708b = new Paint(1);
        this.f24709c = new Paint(1);
        this.d = new Paint(1);
        this.e = new Paint(1);
        this.f24713s = 0.0f;
        this.v = 1.0f;
        this.f24714w = false;
        this.f24715x = new ac0(this, 18);
    ...
    public final void a(Canvas canvas, RectF rectF) {
        ...
        float clamp;
        boolean z10;
        int i14 = org.telegram.ui.ActionBar.h6.f18925kf;
        org.telegram.ui.ActionBar.d6 d6Var = this.f24707a;
        int v02 = org.telegram.ui.ActionBar.h6.v0(i14, d6Var);
        Paint paint4 = this.f24708b;
        paint4.setColor(v02);
        int v03 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18943lf, d6Var);
        Paint paint5 = this.f24709c;
        paint5.setColor(v03);
        int i15 = org.telegram.ui.ActionBar.h6.hf;
        int v04 = org.telegram.ui.ActionBar.h6.v0(i15, d6Var);
        o6 o6Var2 = this.h;
        o6Var2.r(v04);
        int v05 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18832ff, d6Var);
        fg0 fg0Var2 = this.f24710f;
        fg0Var2.f23971a.setColor(v05);
        int v06 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18850gf, d6Var);
        Paint paint6 = this.d;
        paint6.setColor(v06);
        int v07 = org.telegram.ui.ActionBar.h6.v0(i15, d6Var);
        Paint paint7 = this.e;
        paint7.setColor(v07);
        int lerp = (int) AndroidUtilities.lerp(rectF.left + AndroidUtilities.dp(11.33f), rectF.right - AndroidUtilities.dp(11.33f), Utilities.clamp01(this.f24713s));
        ...
        int i19 = org.telegram.ui.ActionBar.h6.f18850gf;
        ...
        if (this.U) {
            ...
            f71 f71Var = this.f24711n;
            if (f71Var != null) {
                f7 = ((float) f71Var.n()) / ((float) this.f24711n.p());
            } else {
                f7 = 1.0f;
            }
            clamp = Utilities.clamp(f7, this.v, this.f24713s);
        }
        ...
        if (clamp2 < f11) {
            ...
            canvas.translate(rectF.left + AndroidUtilities.dp(14.0f), rectF.centerY());
            if (this.f24714w && clamp < this.f24713s && !this.U) {
        ...
        if (e > 0.0f) {
            ...
            if (e7 > 0.0f) {
                ...
                o6Var3.f26631w = (int) (e7 * 255.0f * e);
                o6Var3.draw(canvas);
                canvas.restore();
            }
        }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            boolean z13 = this.R;
            RectF rectF3 = this.f24716y;
            if (z13) {
                this.f24713s = Utilities.clamp(AndroidUtilities.ilerp(motionEvent.getX(), rectF3.left + AndroidUtilities.dp(11.33f), rectF3.right - AndroidUtilities.dp(11.33f)), Utilities.clamp01(this.v - Math.max(1.0f / this.f24712r, AndroidUtilities.dp(30.0f) / (rectF3.width() - AndroidUtilities.dp(22.66f)))), 0.0f);
                invalidate();
            } else if (this.S) {
                this.v = Utilities.clamp(AndroidUtilities.ilerp(motionEvent.getX(), rectF3.left + AndroidUtilities.dp(11.33f), rectF3.right - AndroidUtilities.dp(11.33f)), 1.0f, Utilities.clamp01(Math.max(1.0f / this.f24712r, AndroidUtilities.dp(30.0f) / (rectF3.width() - AndroidUtilities.dp(22.66f))) + this.f24713s));
                invalidate();
            } else if (this.U) {
                f71 f71Var2 = this.f24711n;
                if (f71Var2 != null) {
                    float clamp = Utilities.clamp(AndroidUtilities.ilerp(motionEvent.getX(), rectF3.left + AndroidUtilities.dp(11.33f), rectF3.right - AndroidUtilities.dp(11.33f)), this.v, this.f24713s);
                    this.V = clamp;
                    f71Var2.L(clamp * ((float) this.f24711n.p()), false);
                }
                invalidate();
            }
            this.h.q(AndroidUtilities.formatDuration(Math.round(Math.max(1.0f, (this.v - this.f24713s) * this.f24712r)), false), true, true);
        } else if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
            if (motionEvent.getAction() == 1 && this.T) {
                setPlaying(!b());
            } else if (this.R && this.f24714w) {
                f71 f71Var3 = this.f24711n;
                if (f71Var3 != null) {
                    f71Var3.L(this.f24713s * ((float) f71Var3.p()), false);
                }
                setPlaying(true);
            } else if (this.S && this.f24714w) {
                f71 f71Var4 = this.f24711n;
                if (f71Var4 != null) {
                    f71Var4.L(Math.max(this.f24713s * ((float) f71Var4.p()), (this.v * ((float) this.f24711n.p())) - 1500), false);
                }
                setPlaying(true);
            } else if (this.U && !b()) {
                setPlaying(true);
    ...
    public long getAudioLeftMs() {
        return this.f24713s * ((float) getDuration());
    }
    ...
    public double getNewDuration() {
        return ((this.v - this.f24713s) * ((float) getDuration())) / 1000.0d;
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        this.f24716y.set(0.0f, (getHeight() - dp) / 2.0f, getWidth(), (getHeight() + dp) / 2.0f);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        float dp = AndroidUtilities.dp(32.0f);
        this.f24716y.set(0.0f, (getMeasuredHeight() - dp) / 2.0f, getMeasuredWidth(), (getMeasuredHeight() + dp) / 2.0f);
    }
    ...
    public void setPlaying(boolean z10) {
        ...
        f71 f71Var = this.f24711n;
        if (f71Var != null) {
            float n10 = ((float) f71Var.n()) / ((float) this.f24711n.p());
            float f7 = this.f24713s;
            if (n10 < f7 || n10 > this.v) {
                f71 f71Var2 = this.f24711n;
                f71Var2.L(f7 * ((float) f71Var2.p()), false);
            }
            this.f24711n.P(z10);
        }
        this.f24710f.a(z10, true);
        ac0 ac0Var = this.f24715x;
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.h != drawable && this.f24710f != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
