...
public final class hk0 extends View {
    ...
    public boolean U;
    public float V;
    public final org.telegram.ui.ActionBar.f6 f24683a;
    public final Paint f24684b;
    public final Paint f24685c;
    public final Paint d;
    public final Paint e;
    public final gg0 f24686f;
    public final m6 h;
    public h71 f24687n;
    public float f24688r;
    public float f24689s;
    public float v;
    public boolean f24690w;
    public final bc0 f24691x;
    public final RectF f24692y;

    public hk0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f24684b = new Paint(1);
        ...
        this.v = 1.0f;
        this.f24690w = false;
        this.f24691x = new bc0(this, 18);
        this.f24692y = new RectF();
        this.E = new RectF();
        this.F = new RectF();
        this.G = new Path();
        this.H = new RectF();
    ...
    public final void a(Canvas canvas, RectF rectF) {
        ...
        float clamp;
        boolean z10;
        int i14 = org.telegram.ui.ActionBar.j6.f19000kf;
        org.telegram.ui.ActionBar.f6 f6Var = this.f24683a;
        int v02 = org.telegram.ui.ActionBar.j6.v0(i14, f6Var);
        Paint paint4 = this.f24684b;
        paint4.setColor(v02);
        int v03 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19018lf, f6Var);
        Paint paint5 = this.f24685c;
        paint5.setColor(v03);
        int i15 = org.telegram.ui.ActionBar.j6.hf;
        int v04 = org.telegram.ui.ActionBar.j6.v0(i15, f6Var);
        m6 m6Var2 = this.h;
        m6Var2.r(v04);
        int v05 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18906ff, f6Var);
        gg0 gg0Var2 = this.f24686f;
        gg0Var2.f24212a.setColor(v05);
        int v06 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18925gf, f6Var);
        Paint paint6 = this.d;
        paint6.setColor(v06);
        int v07 = org.telegram.ui.ActionBar.j6.v0(i15, f6Var);
        Paint paint7 = this.e;
        paint7.setColor(v07);
        int lerp = (int) AndroidUtilities.lerp(rectF.left + AndroidUtilities.dp(11.33f), rectF.right - AndroidUtilities.dp(11.33f), Utilities.clamp01(this.f24689s));
        ...
        int i19 = org.telegram.ui.ActionBar.j6.f18925gf;
        ...
        if (this.U) {
            ...
            h71 h71Var = this.f24687n;
            if (h71Var != null) {
                f7 = ((float) h71Var.n()) / ((float) this.f24687n.p());
            } else {
                f7 = 1.0f;
            }
            clamp = Utilities.clamp(f7, this.v, this.f24689s);
        }
        ...
        if (clamp2 < f11) {
            ...
            canvas.translate(rectF.left + AndroidUtilities.dp(14.0f), rectF.centerY());
            if (this.f24690w && clamp < this.f24689s && !this.U) {
        ...
        if (e > 0.0f) {
            ...
            if (e7 > 0.0f) {
                ...
                m6Var3.f26087w = (int) (e7 * 255.0f * e);
                m6Var3.draw(canvas);
                canvas.restore();
            }
        }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            boolean z13 = this.R;
            RectF rectF3 = this.f24692y;
            if (z13) {
                this.f24689s = Utilities.clamp(AndroidUtilities.ilerp(motionEvent.getX(), rectF3.left + AndroidUtilities.dp(11.33f), rectF3.right - AndroidUtilities.dp(11.33f)), Utilities.clamp01(this.v - Math.max(1.0f / this.f24688r, AndroidUtilities.dp(30.0f) / (rectF3.width() - AndroidUtilities.dp(22.66f)))), 0.0f);
                invalidate();
            } else if (this.S) {
                this.v = Utilities.clamp(AndroidUtilities.ilerp(motionEvent.getX(), rectF3.left + AndroidUtilities.dp(11.33f), rectF3.right - AndroidUtilities.dp(11.33f)), 1.0f, Utilities.clamp01(Math.max(1.0f / this.f24688r, AndroidUtilities.dp(30.0f) / (rectF3.width() - AndroidUtilities.dp(22.66f))) + this.f24689s));
                invalidate();
            } else if (this.U) {
                h71 h71Var2 = this.f24687n;
                if (h71Var2 != null) {
                    float clamp = Utilities.clamp(AndroidUtilities.ilerp(motionEvent.getX(), rectF3.left + AndroidUtilities.dp(11.33f), rectF3.right - AndroidUtilities.dp(11.33f)), this.v, this.f24689s);
                    this.V = clamp;
                    h71Var2.L(clamp * ((float) this.f24687n.p()), false);
                }
                invalidate();
            }
            this.h.q(AndroidUtilities.formatDuration(Math.round(Math.max(1.0f, (this.v - this.f24689s) * this.f24688r)), false), true, true);
        } else if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
            if (motionEvent.getAction() == 1 && this.T) {
                setPlaying(!b());
            } else if (this.R && this.f24690w) {
                h71 h71Var3 = this.f24687n;
                if (h71Var3 != null) {
                    h71Var3.L(this.f24689s * ((float) h71Var3.p()), false);
                }
                setPlaying(true);
            } else if (this.S && this.f24690w) {
                h71 h71Var4 = this.f24687n;
                if (h71Var4 != null) {
                    h71Var4.L(Math.max(this.f24689s * ((float) h71Var4.p()), (this.v * ((float) this.f24687n.p())) - 1500), false);
                }
                setPlaying(true);
            } else if (this.U && !b()) {
                setPlaying(true);
    ...
    public long getAudioLeftMs() {
        return this.f24689s * ((float) getDuration());
    }
    ...
    public double getNewDuration() {
        return ((this.v - this.f24689s) * ((float) getDuration())) / 1000.0d;
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        this.f24692y.set(0.0f, (getHeight() - dp) / 2.0f, getWidth(), (getHeight() + dp) / 2.0f);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        float dp = AndroidUtilities.dp(32.0f);
        this.f24692y.set(0.0f, (getMeasuredHeight() - dp) / 2.0f, getMeasuredWidth(), (getMeasuredHeight() + dp) / 2.0f);
    }
    ...
    public void setPlaying(boolean z10) {
        ...
        h71 h71Var = this.f24687n;
        if (h71Var != null) {
            float n10 = ((float) h71Var.n()) / ((float) this.f24687n.p());
            float f7 = this.f24689s;
        ...
        this.f24686f.a(z10, true);
        bc0 bc0Var = this.f24691x;
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.h != drawable && this.f24686f != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
