...
public final class th extends AnimatorListenerAdapter {
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        switch (this.f28099a) {
            case 0:
                ...
                if (biVar.f22752a == animator) {
                    biVar.f22752a = null;
                    return;
                }
                return;
            default:
                vi viVar2 = this.f28101c.e;
                boolean z11 = this.f28100b;
                viVar2.B1 = z11;
                if (!z11) {
    ...
    public void onAnimationStart(Animator animator) {
        switch (this.f28099a) {
            case 0:
                vi viVar = this.f28101c.e;
                if (this.f28100b) {
                    viVar.E1.setAlpha(0.0f);
                    viVar.E1.setVisibility(0);
                    int dp = AndroidUtilities.dp(36.0f);
                    for (int i10 = 0; i10 < viVar.f28802x0.size(); i10++) {
                        ((ei.q4) viVar.f28802x0.valueAt(i10)).setMeasureOffsetY(dp);
                    }
                    return;
                }
                viVar.f28803x1.setAlpha(0.0f);
                viVar.f28803x1.setVisibility(0);
                return;
            default:
