...
public final class th extends AnimatorListenerAdapter {
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        switch (this.f28374a) {
            case 0:
                bi biVar = this.f28376c;
                vi viVar = biVar.e;
                boolean z10 = this.f28375b;
                if (!z10) {
                ...
                if (biVar.f23004a == animator) {
                    biVar.f23004a = null;
                    return;
                }
                return;
            default:
                vi viVar2 = this.f28376c.e;
    ...
    public void onAnimationStart(Animator animator) {
        switch (this.f28374a) {
            case 0:
                vi viVar = this.f28376c.e;
                if (this.f28375b) {
                    viVar.E1.setAlpha(0.0f);
                    viVar.E1.setVisibility(0);
                    int dp = AndroidUtilities.dp(36.0f);
                    for (int i10 = 0; i10 < viVar.f29155x0.size(); i10++) {
                        ((ei.q4) viVar.f29155x0.valueAt(i10)).setMeasureOffsetY(dp);
                    }
                    return;
                }
                viVar.f29156x1.setAlpha(0.0f);
                viVar.f29156x1.setVisibility(0);
                return;
            default:
