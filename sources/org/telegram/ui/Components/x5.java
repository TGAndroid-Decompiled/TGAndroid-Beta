...
public class x5 extends ReplacementSpan {
    ...
    public x5(TLRPC.Document document, Paint.FontMetricsInt fontMetricsInt) {
        this(document.f18115id, 1.2f, fontMetricsInt);
        ...
        if (this.isAdded) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    switch (r2) {
                        case 0:
                            x5.b(this.f26946b, valueAnimator2);
                            return;
                        default:
                            x5.a(this.f26946b, valueAnimator2);
                            return;
                    }
                }
            });
            ...
            this.scaleAnimator.setInterpolator(qr.f27420f);
            ...
            ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator22) {
                    switch (r2) {
                        case 0:
                            x5.b(this.f26946b, valueAnimator22);
                            return;
                        default:
                            x5.a(this.f26946b, valueAnimator22);
                            return;
                    }
                }
            });
    ...
    public static void drawAnimatedEmojis(Canvas canvas, Layout layout, t5 t5Var, float f7, List<vh.h> list, float f10, float f11, float f12, float f13, ColorFilter colorFilter) {
        ...
        ArrayList arrayList = t5Var.f28050c;
        int i10 = 0;
        ...
        while (true) {
            ...
            if (v5Var.f28598a == layout) {
                ArrayList arrayList2 = v5Var.f28599b;
                int i12 = 0;
                while (i12 < arrayList2.size()) {
                    ...
                    if (s5Var != null) {
                        ...
                        if (x5Var.spanDrawn) {
                            ...
                            float max = (list == null || list.isEmpty() || !s5Var.v) ? 1.0f : Math.max(0.0f, list.get(i10).f44410n);
                            s5Var.f27773r = f12;
                            s5Var.f27774s = max;
                            s5Var.getClass();
                            ...
                            s5Var.f27772n = false;
                            o5 o5Var2 = s5Var.f27771f;
                            if (o5Var2 == null) {
                                if (s5Var.h != null) {
                                    float extraScale = s5Var.d.getExtraScale();
                                    s5Var.h.setAlpha((int) (s5Var.f27774s * 255.0f * f13));
                            ...
                            } else if (o5Var2.f26689k != null) {
                                o5Var2.setColorFilter(colorFilter == null ? org.telegram.ui.ActionBar.i6.f19160v3 : colorFilter);
                                s5Var.f27771f.q(currentTimeMillis);
                                float extraScale2 = s5Var.d.getExtraScale();
                                if (extraScale2 == 1.0f && !s5Var.d.invert) {
                                    o5 o5Var3 = s5Var.f27771f;
                                    Rect rect2 = s5Var.e;
                                    float f17 = s5Var.f27774s * f13;
                                    ai.l4 l4Var = o5Var3.f26689k;
                                    if (l4Var != null) {
                                        l4Var.setImageCoords(rect2);
                                        o5Var3.f26689k.setAlpha(f17);
                                        o5Var3.f26689k.draw(canvas);
                                    }
                                } else {
                                    canvas.save();
                                    canvas.scale((s5Var.d.invert ? -1 : 1) * extraScale2, extraScale2, s5Var.e.centerX(), s5Var.e.centerY());
                                    o5 o5Var4 = s5Var.f27771f;
                                    Rect rect3 = s5Var.e;
                                    float f18 = s5Var.f27774s * f13;
                                    ai.l4 l4Var2 = o5Var4.f26689k;
                                    if (l4Var2 != null) {
                                        l4Var2.setImageCoords(rect3);
                                        o5Var4.f26689k.setAlpha(f18);
                                        o5Var4.f26689k.draw(canvas);
                                    }
                                    canvas.restore();
                                }
    ...
    public x5(TLRPC.Document document, float f7, Paint.FontMetricsInt fontMetricsInt) {
        this(document.f18115id, f7, fontMetricsInt);
        this.document = document;
    }
    ...
    public static t5 update(int i10, View view, boolean z10, t5 t5Var, boolean z11, Layout... layoutArr) {
        ...
        if (layoutArr == null || layoutArr.length <= 0) {
            if (t5Var2 != null) {
                ArrayList arrayList = t5Var2.f28048a;
                arrayList.clear();
        ...
        while (i15 < layoutArr.length) {
            ...
            if (layout == null || !(layout.getText() instanceof Spanned)) {
                ...
                while (x5VarArr != null && i16 < x5VarArr.length) {
                    ...
                    if (x5Var == null) {
                        ...
                        if (r02 == 0) {
                            r02 = new Object();
                            r02.f28048a = new ArrayList();
                            r02.f28049b = new HashMap();
                            r02.f28050c = new ArrayList();
                        }
                        ArrayList arrayList2 = r02.f28048a;
                        int i17 = 0;
                        while (true) {
                            if (i17 >= arrayList2.size()) {
                                s5Var = fontMetricsInt;
                                break;
                            } else if (((s5) arrayList2.get(i17)).d == x5Var && ((s5) arrayList2.get(i17)).f27770c == layout) {
                        ...
                        if (s5Var == 0) {
                            ...
                            if (x5Var.documentAbsolutePath != null) {
                                i12 = i15;
                                s5Var2.f27771f = o5.n(UserConfig.selectedAccount, x5Var.getDocumentId(), x5Var.documentAbsolutePath, i13);
                            } else {
                                i12 = i15;
                                TLRPC.Document document = x5Var.document;
                                if (document != null) {
                                    s5Var2.f27771f = o5.m(UserConfig.selectedAccount, i13, document);
                                } else {
                                    long j3 = x5Var.documentId;
                                    if (j3 != 0) {
                                        s5Var2.f27771f = o5.n(UserConfig.selectedAccount, j3, null, i13);
                                    }
                                }
                            }
                            int i18 = x5Var.cacheType;
                            if ((i18 == 20 || i18 == 21) && !TextUtils.isEmpty(x5Var.emoji)) {
                                o5 o5Var = s5Var2.f27771f;
                                if (o5Var != null) {
                                    o5Var.r(x5Var.emoji);
                                } else {
                            ...
                            HashMap hashMap = r02.f28049b;
                            v5 v5Var = (v5) hashMap.get(layout);
                            if (v5Var == null) {
                                v5Var = new v5(s5Var2.f27768a, layout);
                                hashMap.put(layout, v5Var);
                                r02.f28050c.add(v5Var);
                            }
                            v5Var.f28599b.add(s5Var2);
                            v5Var.a();
                            o5 o5Var2 = s5Var2.f27771f;
                            if (o5Var2 != null) {
                                o5Var2.b(s5Var2);
                            }
                        } else {
            ...
            if (t5Var2 != null) {
                ArrayList arrayList3 = t5Var2.f28048a;
                int i19 = 0;
                while (i19 < arrayList3.size()) {
                    if (((s5) arrayList3.get(i19)).f27770c == layout) {
        ...
        if (t5Var2 != null) {
            ArrayList arrayList4 = t5Var2.f28048a;
            int i21 = 0;
            while (i21 < arrayList4.size()) {
                Layout layout2 = ((s5) arrayList4.get(i21)).f27770c;
                int i22 = 0;
                while (true) {
