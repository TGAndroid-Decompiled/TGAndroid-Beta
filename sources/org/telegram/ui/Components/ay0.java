...
public abstract class ay0 {
    ...
    public static void b(TLRPC.StickerSet stickerSet, org.telegram.ui.ActionBar.f6 f6Var, Context context, Runnable runnable) {
        if (stickerSet != null) {
            ...
            alertDialog$Builder.f20199a.R = LocaleController.getString(R.string.StickersDeleteStickerSetTitle);
            alertDialog$Builder.f20199a.T = LocaleController.getString(R.string.StickersDeleteStickerSetDescription);
