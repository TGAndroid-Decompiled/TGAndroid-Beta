...
public abstract class ay0 {
    ...
    public static void b(TLRPC.StickerSet stickerSet, org.telegram.ui.ActionBar.d6 d6Var, Context context, Runnable runnable) {
        if (stickerSet != null) {
            ...
            alertDialog$Builder.f18409a.R = LocaleController.getString(R.string.StickersDeleteStickerSetTitle);
            alertDialog$Builder.f18409a.T = LocaleController.getString(R.string.StickersDeleteStickerSetDescription);
    ...
    public static void c(TLRPC.StickerSet stickerSet, org.telegram.ui.ActionBar.d6 d6Var, Context context, Utilities.Callback2 callback2) {
        ...
        alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), new mv(editTextBoldCursor, 24));
