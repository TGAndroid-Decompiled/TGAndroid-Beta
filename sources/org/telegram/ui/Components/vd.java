...
public final class vd implements View.OnClickListener {
    ...
    public final ChatActivityEnterView f29064b;

    public vd(ChatActivityEnterView chatActivityEnterView, int i10) {
        this.f29063a = i10;
        this.f29064b = chatActivityEnterView;
    }
    ...
    public final void onClick(View view) {
        ...
        int i14;
        int i15;
        int i16 = this.f29063a;
        ChatActivityEnterView chatActivityEnterView = this.f29064b;
        switch (i16) {
            case 0:
            ...
            case 1:
                ...
                if (nfVar == null || nfVar.f38745q0) {
                    AnimatorSet animatorSet = chatActivityEnterView.f22065t2;
            ...
            case 3:
                ...
                if (chatActivityEnterView.f21962b2 != null) {
                    ...
                    chatActivityEnterView.f21969c2 = x10;
                    hg.a0 d = hg.a0.d(chatActivityEnterView.Q);
                    String str2 = chatActivityEnterView.f21962b2.link;
                    String str3 = x10.f25720a;
                    ArrayList<TLRPC.MessageEntity> arrayList = x10.f25721b;
            ...
            case 4:
                ...
                return;
            case 5:
                if (chatActivityEnterView.S0.getVisibility() == 0 && chatActivityEnterView.S0.getAlpha() == 1.0f && !chatActivityEnterView.f22018k3) {
                    if (!chatActivityEnterView.f22097z2 || (qfVar = chatActivityEnterView.E0) == null || !qfVar.isFocused()) {
                        ...
                        if (!chatActivityEnterView.E3) {
                            chatActivityEnterView.n1(chatActivityEnterView.f22098z3 ^ z10, z10, false, z10);
                            return;
                        }
                        return;
                    }
                ...
                return;
            case 6:
                AnimatorSet animatorSet2 = chatActivityEnterView.f22065t2;
                if (animatorSet2 == null || !animatorSet2.isRunning()) {
                    sk0 sk0Var = chatActivityEnterView.f21999h1;
                    if (sk0Var != null) {
                        sk0Var.setPlaying(false);
                    }
                    if (chatActivityEnterView.f21982e3 != null) {
                        ...
                        if (playingMessageObject != null && playingMessageObject == chatActivityEnterView.f21976d3) {
                            MediaController.getInstance().cleanupPlayer(true, true);
                        }
                    }
                    if (chatActivityEnterView.f21970c3 != null) {
                        if (BuildVars.LOGS_ENABLED) {
                            com.google.android.gms.internal.vision.e2.t(chatActivityEnterView.f21970c3, new StringBuilder("delete file "));
                        }
                        new File(chatActivityEnterView.f21970c3).delete();
                    }
            ...
            case 7:
                ...
                if (chatActivityEnterView.j0()) {
                    ...
                    if (chatActivityEnterView.m0 == null) {
                        ...
                        chatActivityEnterView.f22031n0 = h0Var;
                        ...
                        chatActivityEnterView.f22025m1.addView(chatActivityEnterView.m0, w7.y5.e(-1, -1, 80));
                        chatActivityEnterView.m0.setVisibility(8);
                        a0.i iVar = chatActivityEnterView.X4;
                        if (iVar != null) {
                            chatActivityEnterView.f22031n0.E(iVar);
                        }
            ...
            case 8:
                ...
                if (ogVar4 != null && !ogVar4.m()) {
                    ...
                    ogVar5.t1(wgVar, wgVar.f29994a.getText(), true);
                    return;
                }
                return;
            case 9:
                ...
                if (BirthdayController.isToday(wnVar2.f39414a8)) {
                ...
                if ((chatActivityEnterView.getParentFragment().f39414a8 == null || !chatActivityEnterView.getParentFragment().f39414a8.display_gifts_button) && (userFull == null || !userFull.display_gifts_button)) {
                ...
                if (i18 != null) {
                    if (chatActivityEnterView.getParentFragment().f39414a8 != null && BirthdayController.isToday(chatActivityEnterView.getParentFragment().f39414a8.birthday)) {
                        z11 = true;
                    } else {
                        z11 = false;
                    }
                ...
                return;
            case 10:
                int i19 = ChatActivityEnterView.f21952n5;
            ...
            case 11:
                ...
                return;
            case 12:
                ChatActivityEnterView chatActivityEnterView2 = this.f29064b;
                ...
                return;
            case 13:
                ChatActivityEnterView chatActivityEnterView3 = this.f29064b;
            ...
            case 14:
                ...
                if (o1Var == null || !o1Var.f19672f) {
                    if (chatActivityEnterView.A0) {
                        ...
                        return;
                    } else if (chatActivityEnterView.t0() && chatActivityEnterView.f21988f2 == 0) {
                        if (chatActivityEnterView.R1 != 0) {
                            z15 = false;
                            chatActivityEnterView.m1(0, true);
            ...
            case 15:
                ...
                if (chatActivityEnterView.f22033n2 != null) {
                    if (chatActivityEnterView.t0()) {
                        r92 = 1;
                        if (chatActivityEnterView.f21988f2 == 1) {
                            if (chatActivityEnterView.t0() && chatActivityEnterView.f21988f2 == 1) {
                ...
                } else if (chatActivityEnterView.f22043p2) {
                    chatActivityEnterView.setFieldText("/");
                ...
                return;
            case 16:
                ChatActivityEnterView chatActivityEnterView4 = this.f29064b;
                org.telegram.ui.wn wnVar4 = chatActivityEnterView4.P2;
                if (!chatActivityEnterView4.f22024l5 ? chatActivityEnterView4.getTranslationY() != 0.0f : chatActivityEnterView4.t0()) {
                    chatActivityEnterView4.f22052r0 = new je(chatActivityEnterView4, 3);
                    if (chatActivityEnterView4.f22024l5) {
                ...
                if (chatActivityEnterView4.Z2.q() > AndroidUtilities.dp(20.0f)) {
                    ...
                    if (b12 < AndroidUtilities.dp(200.0f)) {
                        chatActivityEnterView4.f22068u0 = new je(chatActivityEnterView4, 4);
                ...
                if (chatActivityEnterView4.Z2.J() != null) {
                    ...
                    ff ffVar = chatActivityEnterView4.f22046q0;
                    if (ffVar != null) {
                        ffVar.e = false;
                        ffVar.l(new o1.k[0]);
                        return;
                    ...
                    chatActivityEnterView4.f22046q0 = ffVar2;
                    ffVar2.e = true;
                    ffVar2.f19635c = 220;
                    ffVar2.setOutsideTouchable(true);
                    chatActivityEnterView4.f22046q0.setClippingEnabled(true);
                    chatActivityEnterView4.f22046q0.setFocusable(true);
                    chatActivityEnterView4.f22046q0.getContentView().measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(1000.0f), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(1000.0f), Integer.MIN_VALUE));
                    chatActivityEnterView4.f22046q0.setInputMethodMode(2);
                    chatActivityEnterView4.f22046q0.setSoftInputMode(0);
                    chatActivityEnterView4.f22046q0.getContentView().setFocusableInTouchMode(true);
                    chatActivityEnterView4.f22046q0.f19634b = false;
                    ...
                    int measuredHeight = chatActivityEnterView4.f22046q0.getContentView().getMeasuredHeight();
                    ...
                    if (measuredHeight < (i21 - i12) - chatActivityEnterView4.f22046q0.f25491p.getMeasuredHeight()) {
                        ...
                        chatActivityEnterView4.f22046q0.f25490o.getLayoutParams().height = ((b13 - i13) - AndroidUtilities.dp(14.0f)) - chatActivityEnterView4.getHeightWithTopView();
                        i14 = i13;
                    }
                    ff ffVar3 = chatActivityEnterView4.f22046q0;
                    View view2 = ffVar3.f25496u;
                    xl0 xl0Var = ffVar3.v;
                    TLRPC.Peer peer5 = ffVar3.f25493r;
                    dp0 dp0Var = ffVar3.f25490o;
                    ai.f0 f0Var = ffVar3.f25495t;
                    ArrayList arrayList2 = ffVar3.f25500z;
                    ...
                    ArrayList<TLRPC.TL_sendAsPeer> arrayList3 = ffVar3.f25494s.peers;
                    if (peer5 != null) {
                        ...
                        while (i23 < arrayList3.size()) {
                            ...
                            if (i23 != arrayList4.size() - 1 && xl0Var2.getMeasuredHeight() < size2) {
                                i15 = xl0Var2.getMeasuredHeight() % dp;
                            } else {
                                i15 = 0;
                            }
                            ffVar3.f25497w.h1(i23, (size2 - ((arrayList4.size() - 2) * dp)) + AndroidUtilities.dp(7.0f) + i15);
                            if (xl0Var2.computeVerticalScrollOffset() > 0) {
                    ...
                    ff ffVar4 = chatActivityEnterView4.f22046q0;
                    chatActivityEnterView4.f22058s0 = i11;
                    chatActivityEnterView4.f22063t0 = i14;
                    ffVar4.showAtLocation(view, 51, i11, i14);
                    chatActivityEnterView4.f22041p0.setProgress(1.0f);
                    return;
                }
                return;
            case 17:
                int i24 = ChatActivityEnterView.f21952n5;
                chatActivityEnterView.d0();
                return;
            case 18:
                org.telegram.ui.ActionBar.o1 o1Var2 = chatActivityEnterView.U;
                if ((o1Var2 == null || !o1Var2.f19672f) && chatActivityEnterView.F != 0.0f) {
            ...
            case 19:
                ...
                if ((o1Var3 == null || !o1Var3.f19672f) && chatActivityEnterView.F != 0.0f) {
                    chatActivityEnterView.Z2.q1();
                    return;
                }
                return;
            default:
                int i25 = ChatActivityEnterView.f21952n5;
                chatActivityEnterView.J0();
                return;
        }
    }
