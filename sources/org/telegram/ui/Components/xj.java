...
public final class xj extends tl0 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        switch (this.U2) {
            case 0:
                if (this.W2.f28142n == 2 && getChildCount() > 0) {
                    ...
                    this.V2.setColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21731h5, false));
                }
                super.dispatchDraw(canvas);
                return;
            default:
                if (this.W2.f28142n == 1 && getChildCount() > 0) {
