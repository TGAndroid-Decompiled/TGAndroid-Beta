...
public abstract class i80 extends org.telegram.ui.ActionBar.f3 {
    ...
    public i80(Context context, TLRPC.Chat chat) {
        ...
        com.google.android.gms.internal.vision.e2.p(org.telegram.ui.ActionBar.j6.f19169j5, null, false, textView, 1);
        TextView h = com.google.android.gms.internal.vision.e2.h(linearLayout, textView, w7.y5.t(-2, -2, 49, 17, 24, 17, 0), context);
        h.setTextSize(1, 14.0f);
        com.google.android.gms.internal.vision.e2.p(org.telegram.ui.ActionBar.j6.f19318r5, null, false, h, 1);
        linearLayout.addView(h, w7.y5.t(-2, -2, 49, 30, 8, 30, 0));
        ChatObject.Call groupCall = AccountInstance.getInstance(this.currentAccount).getMessagesController().getGroupCall(chat.f18296id, false);
        if (groupCall != null) {
