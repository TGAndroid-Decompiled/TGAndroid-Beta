...
public final class qe extends ImageView {
    public float f30391a;
    public final ChatActivityEnterView f30392b;

    public qe(ChatActivityEnterView chatActivityEnterView, Context context) {
        super(context);
        this.f30392b = chatActivityEnterView;
    }
    ...
    public final void setTranslationX(float f10) {
        ...
        this.f30391a = f10;
        float f12 = -44.0f;
        float dp = AndroidUtilities.dp(-44.0f) + this.f30391a;
        ChatActivityEnterView chatActivityEnterView = this.f30392b;
        float f13 = dp + chatActivityEnterView.f24706y + chatActivityEnterView.f24700x;
        ...
        se seVar3 = chatActivityEnterView.f24680t1;
        float dp3 = AndroidUtilities.dp((seVar3 == null || seVar3.getVisibility() != 0) ? 0.0f : 0.0f);
        se seVar4 = chatActivityEnterView.f24680t1;
        if (seVar4 != null) {
            f14 = seVar4.getAlpha();
        }
