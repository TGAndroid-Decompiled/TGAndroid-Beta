...
public final class tz extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.f6 f27521a;
    public final TextView f27522b;
    public final View f27523c;
    public final kj0 d;
    public boolean e;
    public int f27524f;
    ...
    public tz(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f27523c = radialProgressView;
        ...
        linearLayout.addView((View) imageView, w7.a6.t(150, 150, 17, 0, 0, 0, 20));
        TextView textView = new TextView(context);
        this.f27522b = textView;
        textView.setTextSize(1, 20.0f);
        textView.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f17911c7, f6Var));
    ...
    public final void b() {
        AndroidUtilities.updateViewVisibilityAnimated(this.f27522b, false, 0.9f, true);
        AndroidUtilities.updateViewVisibilityAnimated(this.f27523c, true, 1.0f, true);
    }

    public final void c() {
        AndroidUtilities.updateViewVisibilityAnimated(this.f27522b, true, 0.9f, true);
        AndroidUtilities.updateViewVisibilityAnimated(this.f27523c, false, 1.0f, true);
    }
    ...
    public void setText(String str) {
        this.f27522b.setText(str);
    }

    public void setTextColor(int i10) {
        this.f27522b.setTextColor(i10);
    }

    public void setTextSize(int i10) {
        this.f27522b.setTextSize(1, i10);
    }
    ...
    public void setTopImage(int i10) {
        ...
        if (mutate != null) {
            mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f17911c7, this.f27521a), PorterDuff.Mode.MULTIPLY));
        }
