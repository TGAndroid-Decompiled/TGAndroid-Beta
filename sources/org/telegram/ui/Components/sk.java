...
public final class sk implements org.telegram.ui.ActionBar.q0, gg.b, IMapsProvider.ITouchInterceptor, IMapsProvider.OnCameraMoveStartedListener, IMapsProvider.OnMarkerClickListener, org.telegram.ui.ActionBar.z1 {
    ...
    public void a(ArrayList arrayList) {
        switch (this.f28263a) {
            case 1:
                hl hlVar = this.f28264b;
                ArrayList arrayList2 = hlVar.f24801e0;
                if (arrayList != null) {
                    int size = arrayList2.size();
                    for (int i10 = 0; i10 < size; i10++) {
                        ((gl) arrayList2.get(i10)).f24476b.remove();
                    }
                    arrayList2.clear();
                    ...
                    for (int i11 = 0; i11 < size2; i11++) {
                        ...
                        try {
                            ...
                            obj.f24476b = addMarker;
                            obj.f24477c = tL_messageMediaVenue;
                ...
                return;
            default:
                hl hlVar2 = this.f28264b;
                hlVar2.f24810n0 = false;
                hlVar2.f0();
                return;
        }
    }
    ...
    public void m(int i10) {
        IMapsProvider.IMap iMap = this.f28264b.H;
        if (iMap != null) {
            if (i10 == 2) {
                iMap.setMapType(0);
            } else if (i10 == 3) {
    ...
    public boolean onClick(IMapsProvider.IMarker iMarker) {
        ...
        if (iMarker.getTag() instanceof gl) {
            ...
            if (!hlVar.f24819u0) {
                ...
                imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(i14, hlVar.f27086a), PorterDuff.Mode.MULTIPLY));
            ...
            gl glVar2 = hlVar2.f24804h0;
            org.telegram.ui.ActionBar.d6 d6Var = hlVar2.f27086a;
            if (glVar2 != glVar) {
                hlVar2.d0(false);
                IMapsProvider.IMarker iMarker2 = hlVar2.f24803g0;
                if (iMarker2 != null) {
                    ...
                    hlVar2.f24803g0 = null;
                }
                hlVar2.f24804h0 = glVar;
                hlVar2.f24803g0 = iMarker;
                Context context = elVar.getContext();
                FrameLayout frameLayout = new FrameLayout(context);
                elVar.addView(frameLayout, w7.y5.c(114.0f, -2));
                FrameLayout frameLayout2 = new FrameLayout(context);
                hlVar2.f24805i0 = frameLayout2;
                frameLayout2.setBackgroundResource(R.drawable.venue_tooltip);
                hlVar2.f24805i0.getBackground().setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19129h5, d6Var), PorterDuff.Mode.MULTIPLY));
                frameLayout.addView(hlVar2.f24805i0, w7.y5.c(71.0f, -2));
                hlVar2.f24805i0.setAlpha(0.0f);
                hlVar2.f24805i0.setOnClickListener(new org.telegram.ui.pf(22, elVar, glVar));
                ...
                FrameLayout frameLayout3 = hlVar2.f24805i0;
                if (LocaleController.isRTL) {
                    i11 = 5;
                } else {
                    i11 = 3;
                ...
                h.setGravity(i12);
                FrameLayout frameLayout4 = hlVar2.f24805i0;
                if (LocaleController.isRTL) {
                    i13 = 5;
                } else {
                    i13 = 3;
                ...
                textView.setText(glVar.f24477c.title);
                h.setText(LocaleController.getString(R.string.TapToSendLocation));
                FrameLayout frameLayout5 = new FrameLayout(context);
                frameLayout5.setBackground(org.telegram.ui.ActionBar.h6.K(AndroidUtilities.dp(36.0f), org.telegram.ui.Cells.u4.a(glVar.f24475a)));
                frameLayout.addView(frameLayout5, w7.y5.d(36, 36.0f, 81, 0.0f, 0.0f, 0.0f, 4.0f));
                w9 w9Var = new w9(context);
                w9Var.f(a4.a.t(new StringBuilder("https://ss3.4sqi.net/img/categories_v2/"), glVar.f24477c.venue_type, "_64.png"), null, null);
        ...
        switch (i10) {
            ...
            default:
                ...
                if (motionEvent.getAction() == 0) {
                    AnimatorSet animatorSet = hlVar.f24802f0;
                    if (animatorSet != null) {
                        animatorSet.cancel();
                    }
                    AnimatorSet animatorSet2 = new AnimatorSet();
                    hlVar.f24802f0 = animatorSet2;
                    animatorSet2.setDuration(200L);
                    hlVar.f24802f0.playTogether(ObjectAnimator.ofFloat(imageView2, property, hlVar.f24817s0 - AndroidUtilities.dp(10.0f)));
                    hlVar.f24802f0.start();
                } else if (motionEvent.getAction() == 1) {
                    AnimatorSet animatorSet3 = hlVar.f24802f0;
                    if (animatorSet3 != null) {
                        animatorSet3.cancel();
                    }
                    hlVar.K = 0.0f;
                    AnimatorSet animatorSet4 = new AnimatorSet();
                    hlVar.f24802f0 = animatorSet4;
                    animatorSet4.setDuration(200L);
                    hlVar.f24802f0.playTogether(ObjectAnimator.ofFloat(imageView2, property, hlVar.f24817s0));
                    hlVar.f24802f0.start();
                }
                if (motionEvent.getAction() == 2) {
                    if (!hlVar.f24819u0) {
                        int i11 = org.telegram.ui.ActionBar.h6.ui;
                        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(i11, hlVar.f27086a), PorterDuff.Mode.MULTIPLY));
                        imageView.setTag(Integer.valueOf(i11));
                        hlVar.f24819u0 = true;
                    }
                    IMapsProvider.IMap iMap = hlVar.H;
                    if (iMap != null && (location = hlVar.f24815r0) != null) {
                        location.setLatitude(iMap.getCameraPosition().target.latitude);
                        hlVar.f24815r0.setLongitude(hlVar.H.getCameraPosition().target.longitude);
                    }
                    hlVar.O.L(hlVar.f24815r0);
                }
