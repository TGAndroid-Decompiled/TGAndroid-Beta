...
public final class kw0 {
    public final m5 f25689a;
    public Drawable f25690b;
    ...
    public final m5 a(TLRPC.User user, TLRPC.Chat chat, int i10, boolean z10) {
        m5 m5Var = this.f25689a;
        if (chat != null && chat.verified) {
            Drawable drawable = this.f25690b;
            if (drawable == null) {
                drawable = new pq(org.telegram.ui.ActionBar.i6.f18867f1, org.telegram.ui.ActionBar.i6.f18921i1);
            }
            this.f25690b = drawable;
            ...
            Drawable drawable2 = this.f25690b;
            if (drawable2 == null) {
                drawable2 = new pq(org.telegram.ui.ActionBar.i6.f18867f1, org.telegram.ui.ActionBar.i6.f18921i1);
            }
            this.f25690b = drawable2;
    ...
    public kw0(int i10, View view) {
        this.f25689a = new m5(AndroidUtilities.dp(i10), view);
    }
}
