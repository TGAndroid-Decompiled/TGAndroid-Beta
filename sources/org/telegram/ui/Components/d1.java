...
public final class d1 implements View.OnClickListener {
    ...
    public final org.telegram.ui.Cells.z1[] f25170b;

    public d1(org.telegram.ui.Cells.z1[] z1VarArr, int i10) {
        this.f25169a = i10;
        this.f25170b = z1VarArr;
    }
    ...
    public final void onClick(View view) {
        switch (this.f25169a) {
            case 0:
                ...
                org.telegram.ui.Cells.z1[] z1VarArr = this.f25170b;
                z1VarArr[intValue].c(!z1VarArr[num.intValue()].b(), true);
                return;
            default:
                Integer num2 = (Integer) view.getTag();
                int intValue2 = num2.intValue();
                org.telegram.ui.Cells.z1[] z1VarArr2 = this.f25170b;
