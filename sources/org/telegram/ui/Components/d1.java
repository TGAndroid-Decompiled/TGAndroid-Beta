...
public final class d1 implements org.telegram.ui.ActionBar.a2, BillingController.ProductDetailsResponseListenerLegacy {
    ...
    public void k(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        switch (this.f23518a) {
            case 0:
                TLRPC.User user = (TLRPC.User) this.f23519b;
                AccountInstance accountInstance = (AccountInstance) this.f23520c;
                org.telegram.ui.zn znVar = (org.telegram.ui.zn) this.d;
                TLRPC.Chat chat = (TLRPC.Chat) this.e;
                MessageObject messageObject = (MessageObject) this.f23521f;
                org.telegram.ui.Cells.a2[] a2VarArr = (org.telegram.ui.Cells.a2[]) this.h;
                if (user != null) {
                    accountInstance.getMessagesStorage().deleteUserChatHistory(znVar.a(), user.f18490id);
                } else {
                    accountInstance.getMessagesStorage().deleteUserChatHistory(znVar.a(), -chat.f18343id);
                }
                ...
                return;
            default:
                org.telegram.ui.xm0 xm0Var = (org.telegram.ui.xm0) this.f23519b;
                org.telegram.ui.pn0 pn0Var = xm0Var.f39646a;
                pn0Var.Y[0].setText((String) this.f23520c);
                pn0Var.Y[1].setText((String) this.d);
                pn0Var.Y[2].setText((String) this.e);
                pn0Var.N1(true, true);
                xm0Var.c((org.telegram.ui.sl0) this.f23521f, (m5.e) this.h);
                return;
        }
    }
    ...
    public void onProductDetailsResponse(c5.h hVar, List list) {
        switch (this.f23518a) {
            case 2:
                TLRPC.TL_inputStorePaymentPremiumGiftCode tL_inputStorePaymentPremiumGiftCode = (TLRPC.TL_inputStorePaymentPremiumGiftCode) this.f23519b;
                Utilities.Callback callback = (Utilities.Callback) this.f23521f;
                org.telegram.ui.ActionBar.n2 n2Var = (org.telegram.ui.ActionBar.n2) this.h;
                c5.k a2 = ((c5.n) list.get(0)).a();
                tL_inputStorePaymentPremiumGiftCode.currency = a2.f3904c;
                tL_inputStorePaymentPremiumGiftCode.amount = (long) (Math.pow(10.0d, BillingController.getInstance().getCurrencyExp(((TLRPC.TL_premiumGiftCodeOption) this.f23520c).currency)) * (a2.f3903b / Math.pow(10.0d, 6.0d)));
                ...
                return;
            default:
                TLRPC.TL_inputStorePaymentPremiumGiveaway tL_inputStorePaymentPremiumGiveaway = (TLRPC.TL_inputStorePaymentPremiumGiveaway) this.f23519b;
                tg.v vVar = (tg.v) this.f23521f;
                org.telegram.ui.ActionBar.n2 n2Var2 = (org.telegram.ui.ActionBar.n2) this.h;
                c5.k a10 = ((c5.n) list.get(0)).a();
                tL_inputStorePaymentPremiumGiveaway.currency = a10.f3904c;
                tL_inputStorePaymentPremiumGiveaway.amount = (long) (Math.pow(10.0d, BillingController.getInstance().getCurrencyExp(((TLRPC.TL_premiumGiftCodeOption) this.f23520c).currency)) * (a10.f3903b / Math.pow(10.0d, 6.0d)));
    ...
    public d1(TLRPC.User user, AccountInstance accountInstance, org.telegram.ui.zn znVar, TLRPC.Chat chat, MessageObject messageObject, org.telegram.ui.Cells.a2[] a2VarArr, org.telegram.ui.ActionBar.f6 f6Var) {
        this.f23518a = 0;
        this.f23519b = user;
        this.f23520c = accountInstance;
        this.d = znVar;
        this.e = chat;
        this.f23521f = messageObject;
        this.h = a2VarArr;
    }
}
