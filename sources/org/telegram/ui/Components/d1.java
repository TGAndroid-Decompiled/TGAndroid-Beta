...
public final class d1 implements org.telegram.ui.ActionBar.b2, BillingController.ProductDetailsResponseListenerLegacy {
    ...
    public void f(org.telegram.ui.ActionBar.c2 c2Var, int i10) {
        switch (this.f23174a) {
            case 0:
                TLRPC.User user = (TLRPC.User) this.f23175b;
                AccountInstance accountInstance = (AccountInstance) this.f23176c;
                org.telegram.ui.bo boVar = (org.telegram.ui.bo) this.d;
                TLRPC.Chat chat = (TLRPC.Chat) this.e;
                MessageObject messageObject = (MessageObject) this.f23177f;
                ...
                return;
            default:
                org.telegram.ui.ym0 ym0Var = (org.telegram.ui.ym0) this.f23175b;
                org.telegram.ui.qn0 qn0Var = ym0Var.f39941a;
                qn0Var.Y[0].setText((String) this.f23176c);
                qn0Var.Y[1].setText((String) this.d);
                qn0Var.Y[2].setText((String) this.e);
                qn0Var.N1(true, true);
                ym0Var.c((org.telegram.ui.sl0) this.f23177f, (o0.a) this.h);
                return;
        }
    }
    ...
    public void onProductDetailsResponse(c5.h hVar, List list) {
        switch (this.f23174a) {
            case 2:
                TLRPC.TL_inputStorePaymentPremiumGiftCode tL_inputStorePaymentPremiumGiftCode = (TLRPC.TL_inputStorePaymentPremiumGiftCode) this.f23175b;
                Utilities.Callback callback = (Utilities.Callback) this.f23177f;
                ...
                tL_inputStorePaymentPremiumGiftCode.amount = (long) (Math.pow(10.0d, BillingController.getInstance().getCurrencyExp(((TLRPC.TL_premiumGiftCodeOption) this.f23176c).currency)) * (a2.f3905b / Math.pow(10.0d, 6.0d)));
                ...
                return;
            default:
                TLRPC.TL_inputStorePaymentPremiumGiveaway tL_inputStorePaymentPremiumGiveaway = (TLRPC.TL_inputStorePaymentPremiumGiveaway) this.f23175b;
                tg.w wVar = (tg.w) this.f23177f;
                ...
                tL_inputStorePaymentPremiumGiveaway.amount = (long) (Math.pow(10.0d, BillingController.getInstance().getCurrencyExp(((TLRPC.TL_premiumGiftCodeOption) this.f23176c).currency)) * (a10.f3905b / Math.pow(10.0d, 6.0d)));
    ...
    public d1(TLRPC.User user, AccountInstance accountInstance, org.telegram.ui.bo boVar, TLRPC.Chat chat, MessageObject messageObject, org.telegram.ui.Cells.z1[] z1VarArr, org.telegram.ui.ActionBar.f6 f6Var) {
        this.f23174a = 0;
        this.f23175b = user;
        this.f23176c = accountInstance;
        this.d = boVar;
        this.e = chat;
        this.f23177f = messageObject;
        this.h = z1VarArr;
    }
}
