...
public final class d1 implements org.telegram.ui.ActionBar.z1, BillingController.ProductDetailsResponseListenerLegacy {
    ...
    public void f(org.telegram.ui.ActionBar.a2 a2Var, int i10) {
        switch (this.f23427a) {
            case 0:
                TLRPC.User user = (TLRPC.User) this.f23428b;
                AccountInstance accountInstance = (AccountInstance) this.f23429c;
                org.telegram.ui.wn wnVar = (org.telegram.ui.wn) this.d;
                TLRPC.Chat chat = (TLRPC.Chat) this.e;
                MessageObject messageObject = (MessageObject) this.f23430f;
                ...
                return;
            default:
                org.telegram.ui.om0 om0Var = (org.telegram.ui.om0) this.f23428b;
                org.telegram.ui.gn0 gn0Var = om0Var.f36270a;
                gn0Var.Y[0].setText((String) this.f23429c);
                gn0Var.Y[1].setText((String) this.d);
                gn0Var.Y[2].setText((String) this.e);
                gn0Var.N1(true, true);
                om0Var.c((org.telegram.ui.il0) this.f23430f, (o0.a) this.h);
                return;
        }
    }
    ...
    public void onProductDetailsResponse(c5.h hVar, List list) {
        switch (this.f23427a) {
            case 2:
                TLRPC.TL_inputStorePaymentPremiumGiftCode tL_inputStorePaymentPremiumGiftCode = (TLRPC.TL_inputStorePaymentPremiumGiftCode) this.f23428b;
                Utilities.Callback callback = (Utilities.Callback) this.f23430f;
                ...
                tL_inputStorePaymentPremiumGiftCode.amount = (long) (Math.pow(10.0d, BillingController.getInstance().getCurrencyExp(((TLRPC.TL_premiumGiftCodeOption) this.f23429c).currency)) * (a2.f3897b / Math.pow(10.0d, 6.0d)));
                ...
                return;
            default:
                TLRPC.TL_inputStorePaymentPremiumGiveaway tL_inputStorePaymentPremiumGiveaway = (TLRPC.TL_inputStorePaymentPremiumGiveaway) this.f23428b;
                tg.v vVar = (tg.v) this.f23430f;
                ...
                tL_inputStorePaymentPremiumGiveaway.amount = (long) (Math.pow(10.0d, BillingController.getInstance().getCurrencyExp(((TLRPC.TL_premiumGiftCodeOption) this.f23429c).currency)) * (a10.f3897b / Math.pow(10.0d, 6.0d)));
    ...
    public d1(TLRPC.User user, AccountInstance accountInstance, org.telegram.ui.wn wnVar, TLRPC.Chat chat, MessageObject messageObject, org.telegram.ui.Cells.a2[] a2VarArr, org.telegram.ui.ActionBar.d6 d6Var) {
        this.f23427a = 0;
        this.f23428b = user;
        this.f23429c = accountInstance;
        this.d = wnVar;
        this.e = chat;
        this.f23430f = messageObject;
        this.h = a2VarArr;
    }
}
