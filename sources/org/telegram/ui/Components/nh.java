    ...
    public nh(Context context, int i10) {
        ...
        switch (i10) {
            ...
            default:
                ...
                this.f27259a3 = new xd.a(this, mrVar, 320L);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        switch (this.U2) {
            case 0:
                ...
                ((xd.a) this.f27259a3).a(this.Y2, true);
                return;
            default:
                super.dispatchDraw(canvas);
                z5 z5Var = (z5) this.Z2;
        ...
        switch (this.U2) {
            case 0:
                ...
                if (z10) {
                    ...
                    super.drawChild(canvas, view, j10);
                    canvas.save();
                    canvas.translate(e2.c.w(1.0f, ((xd.a) this.f27259a3).e, AndroidUtilities.dp(8.0f), measuredWidth), 0.0f);
            ...
            case 0:
                ...
                for (int i14 = 0; i14 < childCount; i14++) {
                    ...
                    if (childAt2 instanceof gi) {
                        ((gi) childAt2).f25147a.setAdditionalWidth(i12);
                    }
                }
