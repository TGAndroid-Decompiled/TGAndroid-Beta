...
public final class hy0 {
    public final org.telegram.ui.ActionBar.c6 f29270a;
    public StaticLayout f29271b;
    public final ArrayList f29272c = new ArrayList(2);
    public int d;
    public int f29273e;
    public int f29274f;
    public int f29275g;
    ...
    public final void b(MessageObject messageObject) {
        ...
        org.telegram.ui.ActionBar.c6 c6Var = this.f29270a;
        if (c6Var != null) {
            paint = c6Var.G("paintChatActionText3");
        }
        if (paint == null) {
            paint = org.telegram.ui.ActionBar.g6.S0("paintChatActionText3");
        }
        TextPaint textPaint = (TextPaint) paint;
        this.f29275g = AndroidUtilities.dp(14.0f) * 2;
        ArrayList arrayList = this.f29272c;
        arrayList.clear();
        ...
        while (i16 < size) {
            ...
            i16++;
            gy0 gy0Var = (gy0) obj;
            f10 = Math.max(f10, gy0Var.f29011a.l());
            f11 = Math.max(f11, gy0Var.f29012b.l());
            int j10 = ((int) gy0Var.f29011a.j()) + this.f29275g;
            this.f29275g = j10;
            this.f29275g = AndroidUtilities.dp(7.0f) + j10;
        }
        ...
        this.f29271b = new StaticLayout(AndroidUtilities.replaceTags(spannableStringBuilder), textPaint, max, Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
        int i30 = 0;
        for (int i31 = 0; i31 < this.f29271b.getLineCount(); i31++) {
            i30 = (int) Math.max(i30, this.f29271b.getLineWidth(i31));
        }
        int height = this.f29271b.getHeight() + this.f29275g;
        this.f29275g = height;
        this.f29275g = AndroidUtilities.dp(5.0f) + height;
        int D = org.telegram.messenger.x3.D(24.0f, 2, Math.max(dp, i30));
        this.h = D;
        this.d = (D - max) / 2;
        this.f29273e = (D - dp) / 2;
        this.f29274f = (int) (AndroidUtilities.dp(f9) + i15 + f10);
    }
}
