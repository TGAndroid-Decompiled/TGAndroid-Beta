...
public final class j30 extends TextView {
    public final Paint[] f25251a;
    public final m30 f25252b;

    public j30(m30 m30Var, Context context) {
        super(context);
        this.f25252b = m30Var;
        this.f25251a = new Paint[m30Var.e.length];
        int i10 = 0;
        while (true) {
            Paint[] paintArr = this.f25251a;
