...
public final class d10 extends Drawable {
    public final Drawable f23459a;
    public final Path f23460b;
    public boolean f23461c = true;
    public final Paint d;
    public final Paint e;

    public d10(Context context, int i10, int i11) {
        this.f23459a = context.getResources().getDrawable(i10);
        if (i11 >= 0) {
            this.f23460b = new Path();
    ...
    public final int getIntrinsicHeight() {
        return this.f23459a.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f23459a.getIntrinsicWidth();
    }

    @Override
    public final int getOpacity() {
        return this.f23459a.getOpacity();
    }

    @Override
    public final void setAlpha(int i10) {
        this.f23459a.setAlpha(i10);
    }
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f23459a.setColorFilter(colorFilter);
    }
}
