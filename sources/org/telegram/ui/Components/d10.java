...
public final class d10 extends Drawable {
    public final Drawable f25198a;
    public final Path f25199b;
    public boolean f25200c = true;
    public final Paint d;
    public final Paint f25201e;

    public d10(Context context, int i10, int i11) {
        this.f25198a = context.getResources().getDrawable(i10);
        if (i11 >= 0) {
            this.f25199b = new Path();
    ...
    public final void draw(Canvas canvas) {
        Drawable drawable = this.f25198a;
        Path path = this.f25199b;
        if (path != null) {
            ...
            canvas.drawPath(path, this.f25201e);
            canvas.restore();
            return;
        }
        drawable.setBounds(getBounds());
    ...
    public final int getIntrinsicHeight() {
        return this.f25198a.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f25198a.getIntrinsicWidth();
    }

    @Override
    public final int getOpacity() {
        return this.f25198a.getOpacity();
    }

    @Override
    public final void setAlpha(int i10) {
        this.f25198a.setAlpha(i10);
    }
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f25198a.setColorFilter(colorFilter);
    }
}
