...
public final class p90 extends View {
    ...
    public final Paint f27293b;
    public final Paint f27294c;
    public final e6 d;
    public boolean e;
    ...
    public p90(Context context) {
        ...
        w7.a6.a(this);
        this.f27292a = context.getResources().getDrawable(R.drawable.media_live_on).mutate();
