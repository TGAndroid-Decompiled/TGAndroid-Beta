...
public final class p90 extends k7.g0 {
    public int f27795a;
    public final TL_iv.PageBlock f27796b;
    public TL_iv.textConcat f27797c = new TL_iv.textConcat();

    public p90(TL_iv.PageBlock pageBlock) {
        this.f27796b = pageBlock;
    }
    ...
    public final void k(ne.n nVar) {
        if (nVar instanceof lc.a) {
            if (!this.f27797c.texts.isEmpty()) {
                w(s90.j("\n"));
            }
            w(s90.c(((lc.a) nVar).f11852g));
            w(s90.j("\n"));
            return;
        }
        v(nVar);
    ...
    public final void t(ne.g gVar) {
        String str;
        if (this.f27796b instanceof TL_iv.pageBlockBlockquote) {
            str = "\n";
        } else {
            str = " ";
        }
    ...
    public final void w(TL_iv.RichText richText) {
        this.f27797c.texts.add(richText);
    }

    public final TL_iv.RichText y(ne.p pVar) {
        TL_iv.textConcat textconcat = this.f27797c;
        this.f27797c = new TL_iv.textConcat();
        v(pVar);
        TL_iv.RichText x10 = x(this.f27797c);
        this.f27797c = textconcat;
        return x10;
    }
}
