...
public final class p90 extends View {
    ...
    public p90(Context context) {
        ...
        w7.a6.a(this);
        this.f27285a = context.getResources().getDrawable(R.drawable.media_live_on).mutate();
