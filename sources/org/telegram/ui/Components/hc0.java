...
public final class hc0 {
    public static final float[] f24669k = new float[4];
    public static final Matrix f24670l = new Matrix();
    public final fc0 d;
    public int e;
    public int f24674f;
    public int f24675g;
    public int h;
    public final aa.a f24671a = new aa.a(new o2(15));
    public final a5.a f24672b = new a5.a(13, (byte) 0);
    public final i10 f24673c = new i10();
    public final Matrix f24676i = new Matrix();
    public final RectF f24677j = new RectF();
    ...
    public final void c(RectF rectF) {
        RectF rectF2 = this.f24677j;
        rectF2.set(0.0f, 0.0f, this.e, this.f24674f);
        Matrix.ScaleToFit scaleToFit = Matrix.ScaleToFit.FILL;
        Matrix matrix = this.f24676i;
        matrix.setRectToRect(rectF2, rectF, scaleToFit);
        i10 i10Var = this.f24673c;
        gc0 gc0Var = (gc0) i10Var.f24864c;
        gc0Var.f24296b.set(matrix);
        BitmapShader bitmapShader = gc0Var.d;
        if (bitmapShader != null) {
            bitmapShader.setLocalMatrix(matrix);
        }
        gc0 gc0Var2 = (gc0) i10Var.d;
        gc0Var2.f24296b.set(matrix);
        ...
        if (fc0Var != null && Build.VERSION.SDK_INT >= 33) {
            float[] fArr = fc0Var.f23889g;
            a(matrix, fArr);
            fc0Var.e.a(fArr);
            fc0Var.f23888f.a(fArr);
        }
    }
    ...
    public final Paint e(Bitmap bitmap, Bitmap bitmap2, int i10, int i11, int i12, boolean z10) {
        ...
        this.f24674f = bitmap.getHeight();
        this.f24675g = bitmap4.getWidth();
        ...
        i10 i10Var = this.f24673c;
        gt gtVar = (gt) i10Var.f24865f;
        gt gtVar2 = (gt) i10Var.f24866g;
        gc0 gc0Var = (gc0) i10Var.d;
        Paint paint = (Paint) i10Var.f24863b;
        gc0 gc0Var2 = (gc0) i10Var.f24864c;
        boolean b10 = gc0Var2.b(bitmap);
        gc0 gc0Var3 = (gc0) i10Var.e;
        boolean b11 = b10 | gc0Var3.b(bitmap4);
        if (i12 >= 0) {
            if ((gc0Var.b(bitmap6) | b11) || i10Var.f24862a != 1) {
                i10Var.f24862a = 1;
        ...
        } else if ((gtVar2.a(i0.a.k(-1, ((-i12) * i11) / 100)) | b11 | gtVar.a(-16777216)) || i10Var.f24862a != 2) {
            i10Var.f24862a = 2;
            paint.setShader(new ComposeShader((yf.i) gtVar.f24458b, new ComposeShader(new ComposeShader(gc0Var2.d, gc0Var3.d, PorterDuff.Mode.DST_IN), (yf.i) gtVar2.f24458b, PorterDuff.Mode.MULTIPLY), PorterDuff.Mode.SRC_OVER));
            return paint;
        }
        return paint;
    }
