...
public class wi0 extends yi0 {
    ...
    public int B(Bitmap bitmap, boolean z10) {
        ...
        if (i10 == 1) {
            ...
            if (this.X0) {
                this.f30222a0 = this.f29685a1 - 1;
            }
        } else {
            rLottieNative = this.m0;
        }
        if (rLottieNative.c(this.f30222a0, bitmap, z10) < 0) {
            return 2;
        }
        return 1;
    }
    ...
    public void C(boolean z10) {
        ...
        l();
        if (!this.Y0 && !this.V0) {
            if (this.P == null && !this.f30252x0) {
                D(z10);
                yf.e eVar = this.B0;
                if (eVar != null) {
                    RandomAccessFile randomAccessFile = eVar.f46839s;
    ...
    public void i() {
        ...
        if (i10 == 1) {
            ...
            int i13 = this.f30222a0 + 1;
            if (i13 < this.f29685a1) {
                this.f30222a0 = i13;
                return;
            }
            this.N = true;
