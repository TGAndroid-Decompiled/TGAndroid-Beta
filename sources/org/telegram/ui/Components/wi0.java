...
public class wi0 extends org.telegram.ui.ActionBar.f3 {
    ...
    public wi0(Context context, String str, String str2, String str3, boolean z10) {
        ...
        Bitmap bitmap2 = this.f30027b;
        try {
            HashMap hashMap = new HashMap();
            hashMap.put(cc.b.f4196a, hc.c.M);
            hashMap.put(cc.b.f4198c, 0);
            ...
            this.f30029f = telegramQRCodeWriter.getImageSize();
            bitmap = encode;
        } catch (Exception e) {
            FileLog.e(e);
        }
    ...
    public final void n() {
        ...
        if (textView2 != null) {
            ...
            textView2.setBackground(org.telegram.ui.ActionBar.j6.f0(i0.a.k(getThemedColor(i10), Math.min(255, Color.alpha(getThemedColor(org.telegram.ui.ActionBar.j6.f19199i6)) * 2)), 7, -1));
        }
        int i11 = org.telegram.ui.ActionBar.j6.f19492y6;
        int themedColor4 = getThemedColor(i11);
        TextView textView3 = this.f30028c;
        ...
        setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19180h5));
    }
}
