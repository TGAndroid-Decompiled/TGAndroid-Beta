...
public final class rq extends View {
    public final Paint f28512a;
    public final Paint f28513b;
    public final RectF f28514c;
    public int d;
    public long e;
    public int f28515f;
    public int h;
    ...
    public rq(Context context, int i10) {
        ...
        if (i10 == 0) {
            this.f28515f = org.telegram.ui.ActionBar.j6.B7;
            this.h = org.telegram.ui.ActionBar.j6.C7;
        } else if (i10 == 1) {
            this.f28515f = org.telegram.ui.ActionBar.j6.D7;
            this.h = org.telegram.ui.ActionBar.j6.E7;
        } else if (i10 == 2) {
            this.f28515f = org.telegram.ui.ActionBar.j6.F7;
            this.h = org.telegram.ui.ActionBar.j6.G7;
        } else if (i10 == 3) {
            this.f28515f = org.telegram.ui.ActionBar.j6.H7;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        RectF rectF = this.f28514c;
        rectF.set(measuredWidth, measuredHeight, AndroidUtilities.dp(18.0f) + measuredWidth, AndroidUtilities.dp(18.0f) + measuredHeight);
        canvas.drawCircle(getMeasuredWidth() / 2, getMeasuredHeight() / 2, AndroidUtilities.dp(9.0f), this.f28512a);
        canvas.drawArc(rectF, this.d - 90, 90.0f, false, this.f28513b);
        invalidate();
    }
