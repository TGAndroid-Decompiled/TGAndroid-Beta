...
public class RecordedAudioPlayerView extends View {
    ...
    public RecordedAudioPlayerView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.progressUpdate = new Tooltip$$ExternalSyntheticLambda0(this, 5);
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            this.text.setText(AndroidUtilities.formatDuration(Math.round(Math.max(1.0f, (this.right - this.left) * this.duration)), false), true);
    ...
    public void drawIn(Canvas canvas, RectF rectF, float f) {
        ...
        this.waveformPaint.setColor(Theme.multAlpha(0.3f, Theme.getColor(i2, this.resourcesProvider)));
        ...
        if (f4 > 0.0f) {
            float currentWidth = (int) (this.text.getCurrentWidth() + AndroidUtilities.dp(30.0f));
            float f5 = this.showDuration.set(currentWidth <= ((float) ((iLerp2 - iLerp) - AndroidUtilities.dp(8.0f))));
            float fLerp = AndroidUtilities.lerp(AndroidUtilities.dp(24.0f), currentWidth, f5);
            float f6 = iLerp + iLerp2;
            float fDp = AndroidUtilities.dp(20.0f) / 2.0f;
            this.badgeRect.set((f6 - fLerp) / 2.0f, rectF.centerY() - fDp, (f6 + fLerp) / 2.0f, rectF.centerY() + fDp);
