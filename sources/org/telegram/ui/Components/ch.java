...
public final class ch implements bl, le.k, org.telegram.ui.ActionBar.a2, bl0, dh.d, org.telegram.ui.ActionBar.r0, tn, AndroidUtilities.IntColorCallback, b5, dj {
    ...
    public void J(int i10, int i11, boolean z10) {
        ...
        switch (this.f23086a) {
            ...
            default:
                ...
                viVar2.N0 = j10;
                fiVar.setEffect(j10);
                ni niVar2 = viVar2.f28811y0;
                if (niVar2 != viVar2.f28762j0 && niVar2 != viVar2.f28782q0) {
    ...
    public void b(TLRPC.MessageMedia messageMedia, int i10, boolean z10, int i11, long j3) {
        switch (this.f23086a) {
            case 0:
                ((org.telegram.ui.bo) this.f23087b.f28750f0).b(messageMedia, i10, z10, i11, 0L);
                return;
            case 9:
                ((org.telegram.ui.bo) this.f23087b.f28750f0).b(messageMedia, i10, z10, i11, j3);
                return;
            default:
                ((org.telegram.ui.bo) this.f23087b.f28750f0).b(messageMedia, i10, z10, i11, j3);
                return;
    ...
    public boolean d(int i10, View view) {
        ...
        if (view instanceof oi) {
            oi oiVar = (oi) view;
            vi viVar = this.f23087b;
            if (!viVar.V && (user = oiVar.f26807b) != null) {
                viVar.w1(oiVar.f26808c, user);
                return true;
            }
            return false;
        }
    ...
    public void e(TLRPC.MessageMedia messageMedia, Editable editable, qh.f fVar, ArrayList arrayList, boolean z10, int i10, long j3) {
        ...
        switch (i11) {
            case 10:
                org.telegram.ui.bo boVar = (org.telegram.ui.bo) viVar.f28750f0;
                TLRPC.TL_messageMediaToDo tL_messageMediaToDo = (TLRPC.TL_messageMediaToDo) messageMedia;
                if (boVar.f7()) {
                    SendMessagesHelper.SendMessageParams of2 = SendMessagesHelper.SendMessageParams.of((TLRPC.TL_messageMediaPoll) null, boVar.T5, boVar.f32403n5, boVar.X3, (TLRPC.ReplyMarkup) null, (HashMap<String, String>) null, z10, i10, 0);
                ...
                return;
            default:
                org.telegram.ui.bo boVar2 = (org.telegram.ui.bo) viVar.f28750f0;
                ...
                if (boVar2.f7()) {
                    ...
                    SendMessagesHelper.prepareSendingPoll(boVar2.getAccountInstance(), new qh.h(fVar, tL_messageMediaPoll, nextLong, str, arrayList2, arrayList), boVar2.T5, boVar2.f32403n5, boVar2.X3, null, boVar2.f32377l5, z10, i10, boVar2.C8(), j3, boVar2.N8(), boVar2.f32317g5);
                    boVar2.y6();
                    return;
                }
                return;
    ...
    public int g(org.telegram.ui.ActionBar.e6 e6Var, boolean z10) {
        ...
        switch (this.f23086a) {
            case 4:
                ...
                int v03 = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18836d6, e6Var);
                vi viVar = this.f23087b;
                if (viVar.f28771m2) {
                    return i0.a.d(0.75f, v03, viVar.f28775n2);
                }
                return eh.b.m(f7, v02, v03);
            case 5:
                if (this.f23087b.f28771m2) {
                    return 0;
                }
                if (z10) {
                    return 687865855;
            ...
            default:
                vi viVar2 = this.f23087b;
                if (viVar2.f28771m2) {
                    if (AndroidUtilities.computePerceivedBrightness(viVar2.f28775n2) <= 0.72f) {
                        return 1090519039;
                    }
                } else if (z10) {
                    return 0;
    ...
    public void h(ArrayList arrayList, CharSequence charSequence, boolean z10, int i10, int i11, long j3, boolean z11, long j10) {
        ...
        if (n2Var != null && (n2Var instanceof org.telegram.ui.bo)) {
            ...
            if (boVar.f7()) {
                ...
                SendMessagesHelper.prepareSendingAudioDocuments(accountInstance, arrayList, charSequence2, boVar.T5, boVar.f32403n5, boVar.X3, null, z10, i10, i11, boVar.p5, boVar.C8(), j3, z11, j10);
                boVar.y6();
                return;
            }
            return;
    ...
    public void m(int i10) {
        this.f23087b.X0.getActionBarMenuOnItemClick().b(i10);
    }

    @Override
    public void run(int i10) {
        vi.o(this.f23087b, i10);
    }
