...
public final class ch implements Utilities.Callback4 {
    ...
    public final KeyEvent.Callback f25939b;

    public ch(KeyEvent.Callback callback, int i10) {
        this.f25938a = i10;
        this.f25939b = callback;
    }
