...
public final class lu extends org.telegram.ui.ActionBar.h5 {
    ...
    public final boolean g() {
        ...
        try {
            ouVar.f27655r.getWindow().clearFlags(128);
            return true;
        } catch (Exception e) {
            FileLog.e(e);
            return true;
    ...
    public final void onOpenAnimationEnd() {
        ...
        ou ouVar = this.h;
        int i10 = ouVar.N;
        RadialProgressView radialProgressView = ouVar.f27654n;
        iu iuVar = ouVar.f27651b;
        e91 e91Var = ouVar.f27652c;
        if (this.f26875f && ouVar.f27652c.g(ouVar.H, null, null, ouVar.F, true)) {
