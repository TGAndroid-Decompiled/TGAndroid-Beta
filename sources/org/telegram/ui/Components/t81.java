...
public final class t81 extends FrameLayout {
    public static final int f31300f = 0;
    public final org.telegram.ui.ActionBar.g6 f31301a;
    public final am0 f31302b;
    public final RectF f31303c;
    public final RectF d;
    public final Path f31304e;

    public t81(Context context, org.telegram.ui.ActionBar.g6 g6Var) {
        super(context);
        am0 am0Var = new am0(this);
        this.f31302b = am0Var;
        this.f31303c = new RectF();
        this.d = new RectF();
        this.f31304e = new Path();
        ...
        am0Var.A = v02;
        am0Var.f25301z = v02;
        am0Var.f25299x = org.telegram.ui.ActionBar.k6.l1(0.1f, v02);
        am0Var.f25286j = false;
        am0Var.f25285i = false;
        am0Var.k();
    }

    @Override
    public final void onDraw(Canvas canvas) {
        RectF rectF = this.f31303c;
        rectF.set(0.0f, 0.0f, getWidth(), getHeight());
        am0 am0Var = this.f31302b;
        float[] fArr = am0Var.f25282e;
        float dp = AndroidUtilities.dp(10.0f);
        fArr[7] = dp;
        fArr[6] = dp;
        fArr[1] = dp;
        fArr[0] = dp;
        float[] fArr2 = am0Var.f25282e;
        float dp2 = AndroidUtilities.dp(10.0f);
        fArr2[5] = dp2;
        fArr2[4] = dp2;
        fArr2[3] = dp2;
        fArr2[2] = dp2;
        Path path = this.f31304e;
        path.rewind();
        path.addRoundRect(rectF, fArr2, Path.Direction.CW);
        canvas.save();
        canvas.clipPath(path);
        this.f31302b.d(canvas, rectF, 1.0f, false, false);
        RectF rectF2 = this.d;
    ...
    public void setWebPage(TLRPC.WebPage webPage) {
        ...
        org.telegram.ui.ActionBar.g6 g6Var = this.f31301a;
        if (str != null) {
        ...
        if (webPage.description != null) {
            ...
            textView3.setTextColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21768j5, g6Var));
        ...
        if (z4) {
            ...
            p9Var.setBackground(org.telegram.ui.ActionBar.k6.b0(AndroidUtilities.dp(6.0f), org.telegram.ui.ActionBar.k6.l1(0.08f, org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21768j5, g6Var))));
