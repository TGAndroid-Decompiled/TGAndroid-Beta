...
public class yl0 extends RecyclerView implements bh.a {
    ...
    public org.telegram.ui.qi f30689h2;
    ...
    public final org.telegram.ui.ActionBar.f6 f30704p2;
    public ArrayList f30705q1;
    public boolean f30706q2;
    public View f30707r1;
    public final pe f30708r2;
    public int f30709s1;
    ...
    public static void P0(Canvas canvas, RectF rectF, float f7, float f10, float f11, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        paint.setColor(org.telegram.ui.ActionBar.j6.l1(f11, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19109d6, f6Var)));
        if (f7 == f10) {
    ...
    public final void D0(Runnable runnable) {
        this.E2.f27182b.add(new lt(runnable, 1));
    }
                ...
                if (c0Var.f42983o == 1) {
                    if (this.f30686g1 != null) {
                        ...
                        if (i13 != 1 && i13 != 3) {
                            if (i13 == 2) {
                                ...
                                if (this.f30686g1.h() != 0) {
                                    ...
                                    if (view3 != null && (U3 = U(view3)) != null && (S = this.f30686g1.S((b10 = U3.b()))) >= 0) {
                                        if (this.f30709s1 != S || this.f30707r1 == null) {
                                            ...
                                            View T = this.f30686g1.T(S, view4);
                                            if (z12) {
                                                U0(T, false);
                                            }
                                            this.f30707r1 = T;
                                            T.measure(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), 0));
                        ...
                        if (view6 != null && (U = U(view6)) != null) {
                            ...
                            if ((this.K1 || z10) && (fl0Var2 = this.f30684f1) != null && !fl0Var2.f24271n && (getAdapter() instanceof gl0)) {
                            ...
                            if (this.f30686g1.h() != 0) {
                                ...
                                if (this.f30721y1 != 3) {
                                    ...
                                    for (int i22 = this.f30713u1; i22 < this.f30713u1 + this.f30715v1; i22++) {
                                        ...
                                        View T3 = this.f30686g1.T(i22, view);
                                        if (z11) {
                                            U0(T3, false);
                                        }
                                        this.f30703p1.add(T3);
                                        ...
                                        if (i22 == this.f30713u1) {
                                            ...
                                            if (Q3 == M3 - 1) {
                                                ...
                                                T3.setTag(Integer.valueOf(Math.min(i10, 0)));
                                            } else {
                                                T3.setTag(0);
                                            }
                    ...
                    if (L0 != -1) {
                        if ((this.K1 || z10) && (fl0Var = this.f30684f1) != null && !fl0Var.f24271n) {
    ...
    public final void N0(float f7, float f10) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            org.telegram.ui.qi qiVar = this.f30689h2;
            int[] iArr2 = this.f30698m2;
            org.telegram.ui.zn znVar = qiVar.d;
            iArr2[0] = (int) znVar.f40496s9;
            iArr2[1] = znVar.Aa;
            ...
            if (rectF.contains(min2, min)) {
                ...
                if (i11 != T) {
                    ...
                    org.telegram.ui.zn znVar2 = this.f30689h2.d;
                    org.telegram.ui.lm lmVar = znVar2.A0;
                    ArrayList arrayList = znVar2.f40518u6;
                    int i13 = T - lmVar.J;
                    if (i13 >= 0 && i13 < arrayList.size()) {
                        MessageObject messageObject = (MessageObject) arrayList.get(i13);
                        if (messageObject.contentType == 0 && messageObject.hasValidGroupId() && (groupedMessages = (MessageObject.GroupedMessages) znVar2.f40557x6.f(messageObject.getGroupId())) != null) {
                            ...
                            T = arrayList.indexOf(arrayList2.get(size)) + znVar2.A0.J;
                        }
                    }
                    if (z10) {
                        int i14 = this.f30687g2;
                        if (T > i14) {
                            if (!this.f30689h2.f36942a) {
    ...
    public final void O0(Canvas canvas, View view) {
        boolean z10;
        boolean z11;
        if (view != null && ((Boolean) this.H2.f25756a.run(view)).booleanValue()) {
            ...
            if (S == -1) {
                ...
                View V0 = V0(S - 1);
                View V02 = V0(S + 1);
                if (V0 != null && ((Boolean) this.H2.f25756a.run(V0)).booleanValue()) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                if (V02 != null && ((Boolean) this.H2.f25756a.run(V02)).booleanValue()) {
                    z11 = true;
                } else {
                    z11 = false;
                }
    ...
    public final void R0(android.graphics.Canvas r30) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.yl0.R0(android.graphics.Canvas):void");
    }
    ...
    public final Drawable W0(View view, boolean z10) {
        boolean z11;
        boolean z12;
        if (view.getParent() == this && c1() && ((Boolean) this.H2.f25756a.run(view)).booleanValue()) {
            int S = RecyclerView.S(view);
            boolean z13 = true;
            if (S == -1) {
                z12 = false;
            ...
            if (z11 && z12 && !z10) {
                ...
                if (z11 && z13) {
                    return org.telegram.ui.ActionBar.j6.b0(0, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19109d6, this.f30704p2));
                }
                z12 = z13;
            }
            Path path = new Path();
    ...
    public final Paint Y0(String str) {
        Paint paint;
        org.telegram.ui.ActionBar.f6 f6Var = this.f30704p2;
        if (f6Var != null) {
            paint = f6Var.G(str);
        } else {
            paint = null;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (dl0Var != null) {
            yl0 yl0Var = dl0Var.f23709a;
            if (dl0Var.d || dl0Var.e) {
                for (int i10 = 0; i10 < yl0Var.getChildCount(); i10++) {
                    View childAt = yl0Var.getChildAt(i10);
                    int S = RecyclerView.S(childAt);
                    if (S >= 0 && !dl0Var.f23711c.contains(childAt)) {
                        Float f10 = (Float) dl0Var.f23710b.get(S, null);
                        if (f10 == null) {
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if ((fastScroll != null && fastScroll.f24256a0 && fastScroll.f24269k0 && motionEvent.getActionMasked() != 1 && motionEvent.getActionMasked() != 3) || (this.f30686g1 != null && (view = this.f30707r1) != null && view.getAlpha() != 0.0f && this.f30707r1.dispatchTouchEvent(motionEvent))) {
            return true;
        }
        ...
        if (i14 == 1) {
            if (this.f30686g1 != null && !this.f30703p1.isEmpty()) {
                for (int i15 = 0; i15 < this.f30703p1.size(); i15++) {
                    U0((View) this.f30703p1.get(i15), true);
                }
            }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (z10 && motionEvent.getAction() != 0 && motionEvent.getAction() != 1 && motionEvent.getAction() != 3) {
            ...
            if (this.f30683e2) {
                ...
                iArr[1] = znVar.Aa;
                if (motionEvent.getY() > (getMeasuredHeight() - AndroidUtilities.dp(56.0f)) - this.f30698m2[1] && (this.f30687g2 >= this.f30685f2 || !this.f30689h2.f36942a)) {
                    this.f30693j2 = false;
                    if (!this.f30691i2) {
                        this.f30691i2 = true;
                ...
                } else if (motionEvent.getY() < AndroidUtilities.dp(56.0f) + this.f30698m2[0] && (this.f30687g2 <= this.f30685f2 || !this.f30689h2.f36942a)) {
                    this.f30693j2 = true;
                    if (!this.f30691i2) {
                        this.f30691i2 = true;
                        AndroidUtilities.cancelRunOnUIThread(u6Var);
    ...
    public void setAdapter(s4.h0 h0Var) {
        ...
        if (adapter != null) {
            adapter.f43044a.unregisterObserver(p1Var);
        }
    ...
    public void setListSelectorColor(Integer num) {
        ...
        if (num == null) {
            if (c1()) {
                i10 = org.telegram.ui.ActionBar.j6.f19217j6;
            } else {
                i10 = org.telegram.ui.ActionBar.j6.f19199i6;
            }
            intValue = org.telegram.ui.ActionBar.j6.v0(i10, this.f30704p2);
        } else {
    ...
    public void setOnItemLongClickListener(ol0 ol0Var) {
        ...
        k20 k20Var = (k20) eVar.f13244b;
        k20Var.f25604t = z10;
        k20Var.f25605u = longPressTimeout;
    }
    ...
    public final void t1(Utilities.CallbackReturn callbackReturn, Utilities.CallbackReturn callbackReturn2, int i10, float f7, Utilities.Callback5 callback5, boolean z10) {
        setSelectorDrawableColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19217j6, this.f30704p2));
    ...
    public yl0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        setGlowColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19387s8, f6Var));
        org.telegram.ui.Cells.z f02 = org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19199i6, f6Var), 2, -1);
        this.D1 = f02;
