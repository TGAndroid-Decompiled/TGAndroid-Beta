...
public final class yl0 extends Drawable implements Animator.AnimatorListener {
    ...
    public ColorFilter f33556b;
    public Drawable d;
    public Drawable f33558e;
    public ValueAnimator f33559f;
    public boolean f33561r;
    public int f33557c = 0;
    public float h = 1.0f;
    public final ArrayList f33560n = new ArrayList();
    ...
    public final void a(int i10, boolean z4) {
        ...
        b(this.f33555a.getDrawable(i10).mutate(), z4);
        this.f33557c = i10;
    }
    ...
    public final void b(Drawable drawable, boolean z4) {
        ...
        if (drawable == drawable2) {
            drawable2.setColorFilter(this.f33556b);
            return;
        }
        this.f33557c = 0;
        this.f33558e = drawable2;
        this.d = drawable;
        drawable.setColorFilter(this.f33556b);
        c(this.d, getBounds());
        c(this.f33558e, getBounds());
        ValueAnimator valueAnimator = this.f33559f;
        ...
        this.f33559f = ofFloat;
        ofFloat.addUpdateListener(new k70(this, 10));
        this.f33559f.addListener(this);
        this.f33559f.setDuration(150L);
        this.f33559f.start();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        float f11 = this.h;
        if (f11 != 1.0f && this.f33558e != null) {
            float f12 = 1.0f - f11;
            canvas.save();
            canvas.scale(f12, f12, centerX, centerY);
            this.f33558e.setAlpha((int) (f12 * 255.0f));
            this.f33558e.draw(canvas);
            canvas.restore();
            return;
        }
        Drawable drawable2 = this.f33558e;
        if (drawable2 != null) {
    ...
    public final void invalidateSelf() {
        ...
        ArrayList arrayList = this.f33560n;
        if (arrayList != null) {
