...
public final class uf0 extends FrameLayout implements yz, ci.kc {
    ...
    public float f28724a0;
    public final int f28725b;
    public PointF f28726b0;
    public final int f28727c;
    public float f28728c0;
    public final int d;
    public float f28729d0;
    public final int e;
    public MediaController.SavedFilterState f28730e0;
    public final int f28731f;
    public final FrameLayout f28732f0;
    public final TextView f28733g0;
    public final int h;
    public final TextView f28734h0;
    public final TextureView f28735i0;
    public final boolean f28736j0;
    public final boolean f28737k0;
    public vz f28738l0;
    public final yh m0;
    public final int f28739n;
    public final FrameLayout f28740n0;
    public final jf0 f28741o0;
    public final lf0 f28742p0;
    public final TextView f28743q0;
    public final int f28744r;
    public final TextView f28745r0;
    public final int f28746s;
    public final TextView f28747s0;
    public final FrameLayout f28748t0;
    public final RadioButton[] f28749u0;
    public final int v;
    public final rd0 f28750v0;
    public final int f28751w;
    public final boolean f28752w0;
    public final int f28753x;
    public final boolean f28754x0;
    public final int f28755y;
    public int f28756y0;
    public final ImageView f28757z0;

    public uf0(android.content.Context r26, org.telegram.ui.Components.l71 r27, android.graphics.Bitmap r28, android.graphics.Bitmap r29, int r30, org.telegram.messenger.MediaController.SavedFilterState r31, org.telegram.ui.Components.rd0 r32, int r33, boolean r34, boolean r35, org.telegram.ui.Components.ia r36, org.telegram.ui.ActionBar.f6 r37) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.uf0.<init>(android.content.Context, org.telegram.ui.Components.l71, android.graphics.Bitmap, android.graphics.Bitmap, int, org.telegram.messenger.MediaController$SavedFilterState, org.telegram.ui.Components.rd0, int, boolean, boolean, org.telegram.ui.Components.ia, org.telegram.ui.ActionBar.f6):void");
    }

    private void setShowOriginal(boolean z10) {
        if (this.f28723a != z10) {
            this.f28723a = z10;
            vz vzVar = this.f28738l0;
            if (vzVar != null) {
    ...
    public final boolean d() {
        MediaController.SavedFilterState savedFilterState = this.f28730e0;
        qf0 qf0Var = this.W;
        if (savedFilterState != null) {
            if (this.G != savedFilterState.enhanceValue || this.I != savedFilterState.contrastValue || this.P != savedFilterState.highlightsValue || this.H != savedFilterState.exposureValue || this.J != savedFilterState.warmthValue || this.K != savedFilterState.saturationValue || this.R != savedFilterState.vignetteValue || this.Q != savedFilterState.shadowsValue || this.S != savedFilterState.grainValue || this.U != savedFilterState.sharpenValue || this.L != savedFilterState.fadeValue || this.M != savedFilterState.softenSkinValue || this.O != savedFilterState.tintHighlightsColor || this.N != savedFilterState.tintShadowsColor || !qf0Var.b()) {
                return true;
            }
            return false;
        } else if (this.G != 0.0f || this.I != 0.0f || this.P != 0.0f || this.H != 0.0f || this.J != 0.0f || this.K != 0.0f || this.R != 0.0f || this.Q != 0.0f || this.S != 0.0f || this.U != 0.0f || this.L != 0.0f || this.M != 0.0f || this.O != 0 || this.N != 0 || !qf0Var.b()) {
            return true;
        } else {
            return false;
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        rd0 rd0Var = this.f28750v0;
        if (rd0Var != null && view == (textureView = this.f28735i0)) {
            canvas.save();
    ...
    public final void e() {
        boolean z10 = this.f28736j0;
        TextureView textureView = this.f28735i0;
        if (z10) {
            vz vzVar = this.f28738l0;
            if (vzVar != null) {
    ...
    public final void f() {
        boolean z10;
        int i10 = this.f28756y0;
        yh yhVar = this.m0;
        lf0 lf0Var = this.f28742p0;
        FrameLayout frameLayout = this.f28748t0;
        FrameLayout frameLayout2 = this.f28740n0;
        jf0 jf0Var = this.f28741o0;
        if (i10 == 0) {
            ...
            for (int i11 = 0; i11 < 4; i11++) {
                RadioButton radioButton = this.f28749u0[i11];
                if (i11 == 0) {
                    z10 = true;
                } else {
                    z10 = false;
    ...
    public Bitmap getBitmap() {
        vz vzVar = this.f28738l0;
        if (vzVar != null && vzVar.f29841f && vzVar.isAlive()) {
    ...
    public float getBlurAngle() {
        return this.f28729d0;
    }

    public jf0 getBlurControl() {
        return this.f28741o0;
    }

    @Override
    public float getBlurExcludeBlurSize() {
        return this.f28728c0;
    }

    @Override
    public PointF getBlurExcludePoint() {
        return this.f28726b0;
    }
    ...
    public TextureView getMyTextureView() {
        if (this.f28736j0 && !this.f28737k0) {
            return this.f28735i0;
        }
        return null;
    }
    ...
    public MediaController.SavedFilterState getSavedFilterState() {
        ...
        savedFilterState.blurExcludeSize = this.f28724a0;
        savedFilterState.blurExcludePoint = this.f28726b0;
        savedFilterState.blurExcludeBlurSize = this.f28728c0;
        savedFilterState.blurAngle = this.f28729d0;
        this.f28730e0 = savedFilterState;
    ...
    public final void h() {
        int i10 = this.T;
        TextView textView = this.f28747s0;
        TextView textView2 = this.f28745r0;
        org.telegram.ui.ActionBar.f6 f6Var = this.I0;
        TextView textView3 = this.f28743q0;
        if (i10 == 0) {
            Drawable mutate = textView3.getContext().getResources().getDrawable(R.drawable.msg_blur_off).mutate();
            int i11 = org.telegram.ui.ActionBar.j6.f19520zf;
            ...
            int i12 = org.telegram.ui.ActionBar.j6.f19520zf;
            ...
            int i13 = org.telegram.ui.ActionBar.j6.f19520zf;
    ...
    public final boolean m(MotionEvent motionEvent) {
        if (motionEvent.getActionMasked() != 0 && motionEvent.getActionMasked() != 5) {
            ...
            if (textureView instanceof l71) {
                ...
                uk0 uk0Var = ((l71) textureView).f26012c;
                float f7 = uk0Var.f28794a;
                if (x10 >= f7 && x10 <= f7 + uk0Var.f28796c) {
                    float f10 = uk0Var.f28795b;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f28737k0) {
            ...
            wv0Var.f30161a = f17;
            wv0Var.f30162b = f18;
            ((FrameLayout.LayoutParams) jf0Var.getLayoutParams()).height = AndroidUtilities.dp(38.0f) + i15;
            ((FrameLayout.LayoutParams) lf0Var.getLayoutParams()).height = AndroidUtilities.dp(28.0f) + i15;
    ...
    public void setEnhanceValue(float f7) {
        ...
        while (true) {
            ...
            if ((childAt instanceof org.telegram.ui.Cells.w5) && RecyclerView.S(childAt) == this.f28725b) {
