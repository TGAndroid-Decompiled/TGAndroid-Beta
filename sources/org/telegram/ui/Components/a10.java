...
public final class a10 extends View {
    public TextPaint f24215a;
    public Paint f24216b;
    public Path f24217c;
    public float[] d;
    public f01 f24218e;
    public f01 f24219f;
    public f01 h;
    public LinearGradient f24220n;
    public LinearGradient f24221r;
    public Paint f24222s;
    public Paint v;
    public Matrix f24223w;
    public Matrix f24224x;
    public p6 f24225y;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f13;
        float f14;
        Paint paint = this.f24216b;
        Matrix matrix = this.f24224x;
        Matrix matrix2 = this.f24223w;
        Path path = this.f24217c;
        f01 f01Var2 = this.f24218e;
        p6 p6Var = this.f24225y;
        f01 f01Var3 = this.h;
        super.onDraw(canvas);
        canvas.saveLayerAlpha(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), 255, 31);
        float measuredWidth = getMeasuredWidth() / 2.0f;
        float measuredHeight = getMeasuredHeight() / 2.0f;
        f01 f01Var4 = this.f24219f;
        if (f01Var4 != null) {
            canvas.save();
            float f15 = f01Var4.f25848c;
            f7 = 15.32f;
            CharSequence charSequence = p6Var.f29290g;
        ...
        CharSequence charSequence2 = p6Var.f29290g;
        if (charSequence2 == null || charSequence2.length() == 0) {
            ...
            f12 = measuredHeight;
            f01Var = f01Var4;
            rect.set((int) (f01Var4.f25848c + f10 + AndroidUtilities.dp(4.66f)), (int) (measuredHeight - AndroidUtilities.dp(9.0f)), (int) (p6Var.d() + f01Var4.f25848c + f10 + AndroidUtilities.dp(f7)), (int) (f12 + AndroidUtilities.dp(9.0f)));
        ...
        float f17 = (f10 - dp) - f01Var2.f25848c;
        canvas.save();
        ...
        if (f01Var3 != null) {
            ...
            f01Var3.d(canvas);
            canvas.restore();
            f18 += dp + f01Var3.f25848c;
        }
        float f19 = f18;
        float dp2 = AndroidUtilities.dp(12.0f) + (f01Var.j() / f13) + f12;
        canvas.drawRect(0.0f, dp2, getMeasuredWidth(), 1.0f + dp2, this.f24215a);
        path.rewind();
        ...
        this.f24220n.setLocalMatrix(matrix2);
        ...
        this.f24221r.setLocalMatrix(matrix);
        canvas.drawRect(0.0f, 0.0f, measuredWidth, getMeasuredHeight(), this.f24222s);
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f24225y && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
