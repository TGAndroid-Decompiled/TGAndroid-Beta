...
public final class a10 extends View {
    ...
    public f01 f24245f;
    public f01 h;
    public LinearGradient f24246n;
    public LinearGradient f24247r;
    public Paint f24248s;
    public Paint v;
    public Matrix f24249w;
    public Matrix f24250x;
    public p6 f24251y;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Matrix matrix = this.f24250x;
        Matrix matrix2 = this.f24249w;
        Path path = this.f24243c;
        f01 f01Var2 = this.f24244e;
        p6 p6Var = this.f24251y;
        f01 f01Var3 = this.h;
        super.onDraw(canvas);
        canvas.saveLayerAlpha(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), 255, 31);
        float measuredWidth = getMeasuredWidth() / 2.0f;
        float measuredHeight = getMeasuredHeight() / 2.0f;
        f01 f01Var4 = this.f24245f;
        if (f01Var4 != null) {
            canvas.save();
            float f15 = f01Var4.f25874c;
            f7 = 15.32f;
            CharSequence charSequence = p6Var.f29316g;
        ...
        CharSequence charSequence2 = p6Var.f29316g;
        if (charSequence2 == null || charSequence2.length() == 0) {
            ...
            f12 = measuredHeight;
            f01Var = f01Var4;
            rect.set((int) (f01Var4.f25874c + f10 + AndroidUtilities.dp(4.66f)), (int) (measuredHeight - AndroidUtilities.dp(9.0f)), (int) (p6Var.d() + f01Var4.f25874c + f10 + AndroidUtilities.dp(f7)), (int) (f12 + AndroidUtilities.dp(9.0f)));
        ...
        float f17 = (f10 - dp) - f01Var2.f25874c;
        canvas.save();
        ...
        if (f01Var3 != null) {
            ...
            f01Var3.d(canvas);
            canvas.restore();
            f18 += dp + f01Var3.f25874c;
        }
        float f19 = f18;
        float dp2 = AndroidUtilities.dp(12.0f) + (f01Var.j() / f13) + f12;
        canvas.drawRect(0.0f, dp2, getMeasuredWidth(), 1.0f + dp2, this.f24241a);
        path.rewind();
        ...
        this.f24246n.setLocalMatrix(matrix2);
        ...
        this.f24247r.setLocalMatrix(matrix);
        canvas.drawRect(0.0f, 0.0f, measuredWidth, getMeasuredHeight(), this.f24248s);
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f24251y && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
