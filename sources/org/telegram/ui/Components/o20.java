...
public class o20 {
    ...
    public int f26661f;
    public int f26662g;
    public Shader f26663i;
    public boolean f26667m;
    public final Paint f26660c = new Paint(1);
    public final RectF h = new RectF();
    public final Matrix f26664j = new Matrix();
    public Bitmap f26665k = null;
    public final int[] f26666l = new int[4];
    ...
    public final int a() {
        ...
        int i12 = this.f26661f;
        if (i12 != 0) {
            i10 = i0.a.d(0.5f, i10, i12);
        }
        int i13 = this.f26662g;
        if (i13 != 0) {
    ...
    public final void d(int i10, int i11, int i12, int i13) {
        float f7;
        float f10;
        if (this.f26663i != null && this.d == i10 && this.e == i11 && this.f26661f == i12 && this.f26662g == i13) {
            return;
        }
        this.d = i10;
        int[] iArr = this.f26666l;
        iArr[0] = i10;
        this.e = i11;
        iArr[1] = i11;
        this.f26661f = i12;
        ...
        if (i11 == 0) {
            ...
            if (this.f26658a && this.f26659b) {
                ...
                this.f26663i = linearGradient2;
                paint.setShader(linearGradient2);
            }
        } else if (this.f26667m) {
            if (this.f26658a && this.f26659b) {
                ...
                this.f26663i = linearGradient4;
                paint.setShader(linearGradient4);
            }
        } else {
            if (this.f26665k == null) {
                this.f26665k = Bitmap.createBitmap(60, 80, Bitmap.Config.ARGB_8888);
            }
            Utilities.generateGradient(this.f26665k, 0, 0.0f, iArr);
            Bitmap bitmap = this.f26665k;
            Shader.TileMode tileMode = Shader.TileMode.CLAMP;
            BitmapShader bitmapShader = new BitmapShader(bitmap, tileMode, tileMode);
            this.f26663i = bitmapShader;
    ...
    public void e() {
        ...
        RectF rectF = this.h;
        Matrix matrix = this.f26664j;
        matrix.reset();
        matrix.postTranslate(rectF.left, rectF.top);
        matrix.preScale(rectF.width() / 60.0f, rectF.height() / 80.0f);
        this.f26663i.setLocalMatrix(matrix);
    }
}
