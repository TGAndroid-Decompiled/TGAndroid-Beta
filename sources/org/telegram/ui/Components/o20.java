...
public class o20 {
    ...
    public int f26826f;
    public int f26827g;
    public Shader f26828i;
    public boolean f26832m;
    public final Paint f26825c = new Paint(1);
    public final RectF h = new RectF();
    public final Matrix f26829j = new Matrix();
    public Bitmap f26830k = null;
    public final int[] f26831l = new int[4];
    ...
    public final void d(int i10, int i11, int i12, int i13) {
        float f7;
        float f10;
        if (this.f26828i != null && this.d == i10 && this.e == i11 && this.f26826f == i12 && this.f26827g == i13) {
            return;
        }
        this.d = i10;
        int[] iArr = this.f26831l;
        iArr[0] = i10;
        this.e = i11;
        iArr[1] = i11;
        this.f26826f = i12;
        ...
        if (i11 == 0) {
            ...
            if (this.f26823a && this.f26824b) {
                ...
                this.f26828i = linearGradient2;
                paint.setShader(linearGradient2);
            }
        } else if (this.f26832m) {
            if (this.f26823a && this.f26824b) {
                ...
                this.f26828i = linearGradient4;
                paint.setShader(linearGradient4);
            }
        } else {
            if (this.f26830k == null) {
                this.f26830k = Bitmap.createBitmap(60, 80, Bitmap.Config.ARGB_8888);
            }
            Utilities.generateGradient(this.f26830k, 0, 0.0f, iArr);
            Bitmap bitmap = this.f26830k;
            Shader.TileMode tileMode = Shader.TileMode.CLAMP;
            BitmapShader bitmapShader = new BitmapShader(bitmap, tileMode, tileMode);
            this.f26828i = bitmapShader;
    ...
    public void e() {
        ...
        RectF rectF = this.h;
        Matrix matrix = this.f26829j;
        matrix.reset();
        matrix.postTranslate(rectF.left, rectF.top);
        matrix.preScale(rectF.width() / 60.0f, rectF.height() / 80.0f);
        this.f26828i.setLocalMatrix(matrix);
    }
}
