...
public class o20 {
    ...
    public int f28960f;
    public int f28961g;
    public Shader f28962i;
    public boolean f28966m;
    public final Paint f28958c = new Paint(1);
    public final RectF h = new RectF();
    public final Matrix f28963j = new Matrix();
    public Bitmap f28964k = null;
    public final int[] f28965l = new int[4];

    public final int a() {
        int i10 = this.d;
        int i11 = this.f28959e;
        if (i11 != 0) {
    ...
    public final void d(int i10, int i11, int i12, int i13) {
        float f7;
        float f10;
        if (this.f28962i != null && this.d == i10 && this.f28959e == i11 && this.f28960f == i12 && this.f28961g == i13) {
            return;
        }
        this.d = i10;
        int[] iArr = this.f28965l;
        iArr[0] = i10;
        this.f28959e = i11;
        iArr[1] = i11;
        this.f28960f = i12;
        ...
        if (i11 == 0) {
            ...
            if (this.f28956a && this.f28957b) {
                ...
                this.f28962i = linearGradient2;
                paint.setShader(linearGradient2);
            }
        } else if (this.f28966m) {
            if (this.f28956a && this.f28957b) {
                ...
                this.f28962i = linearGradient4;
                paint.setShader(linearGradient4);
            }
        } else {
            if (this.f28964k == null) {
                this.f28964k = Bitmap.createBitmap(60, 80, Bitmap.Config.ARGB_8888);
            }
            Utilities.generateGradient(this.f28964k, 0, 0.0f, iArr);
            Bitmap bitmap = this.f28964k;
            Shader.TileMode tileMode = Shader.TileMode.CLAMP;
            BitmapShader bitmapShader = new BitmapShader(bitmap, tileMode, tileMode);
            this.f28962i = bitmapShader;
    ...
    public void e() {
        ...
        RectF rectF = this.h;
        Matrix matrix = this.f28963j;
        matrix.reset();
        matrix.postTranslate(rectF.left, rectF.top);
        matrix.preScale(rectF.width() / 60.0f, rectF.height() / 80.0f);
        this.f28962i.setLocalMatrix(matrix);
    }
}
