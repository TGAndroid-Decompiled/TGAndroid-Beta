...
public class o20 {
    ...
    public int f26788f;
    public int f26789g;
    public Shader f26790i;
    public boolean f26794m;
    public final Paint f26787c = new Paint(1);
    public final RectF h = new RectF();
    public final Matrix f26791j = new Matrix();
    public Bitmap f26792k = null;
    public final int[] f26793l = new int[4];
    ...
    public final void d(int i10, int i11, int i12, int i13) {
        float f7;
        float f10;
        if (this.f26790i != null && this.d == i10 && this.e == i11 && this.f26788f == i12 && this.f26789g == i13) {
            return;
        }
        this.d = i10;
        int[] iArr = this.f26793l;
        iArr[0] = i10;
        this.e = i11;
        iArr[1] = i11;
        this.f26788f = i12;
        ...
        if (i11 == 0) {
            ...
            if (this.f26785a && this.f26786b) {
                ...
                this.f26790i = linearGradient2;
                paint.setShader(linearGradient2);
            }
        } else if (this.f26794m) {
            if (this.f26785a && this.f26786b) {
                ...
                this.f26790i = linearGradient4;
                paint.setShader(linearGradient4);
            }
        } else {
            if (this.f26792k == null) {
                this.f26792k = Bitmap.createBitmap(60, 80, Bitmap.Config.ARGB_8888);
            }
            Utilities.generateGradient(this.f26792k, 0, 0.0f, iArr);
            Bitmap bitmap = this.f26792k;
            Shader.TileMode tileMode = Shader.TileMode.CLAMP;
            BitmapShader bitmapShader = new BitmapShader(bitmap, tileMode, tileMode);
            this.f26790i = bitmapShader;
    ...
    public void e() {
        ...
        RectF rectF = this.h;
        Matrix matrix = this.f26791j;
        matrix.reset();
        matrix.postTranslate(rectF.left, rectF.top);
        matrix.preScale(rectF.width() / 60.0f, rectF.height() / 80.0f);
        this.f26790i.setLocalMatrix(matrix);
    }
}
