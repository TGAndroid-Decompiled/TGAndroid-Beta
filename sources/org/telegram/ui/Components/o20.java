...
public class o20 {
    ...
    public int f26606f;
    public int f26607g;
    public Shader f26608i;
    public boolean f26612m;
    public final Paint f26605c = new Paint(1);
    public final RectF h = new RectF();
    public final Matrix f26609j = new Matrix();
    public Bitmap f26610k = null;
    public final int[] f26611l = new int[4];
    ...
    public final void d(int i10, int i11, int i12, int i13) {
        float f7;
        float f10;
        if (this.f26608i != null && this.d == i10 && this.e == i11 && this.f26606f == i12 && this.f26607g == i13) {
            return;
        }
        this.d = i10;
        int[] iArr = this.f26611l;
        iArr[0] = i10;
        this.e = i11;
        iArr[1] = i11;
        this.f26606f = i12;
        ...
        if (i11 == 0) {
            ...
            if (this.f26603a && this.f26604b) {
                ...
                this.f26608i = linearGradient2;
                paint.setShader(linearGradient2);
            }
        } else if (this.f26612m) {
            if (this.f26603a && this.f26604b) {
                ...
                this.f26608i = linearGradient4;
                paint.setShader(linearGradient4);
            }
        } else {
            if (this.f26610k == null) {
                this.f26610k = Bitmap.createBitmap(60, 80, Bitmap.Config.ARGB_8888);
            }
            Utilities.generateGradient(this.f26610k, 0, 0.0f, iArr);
            Bitmap bitmap = this.f26610k;
            Shader.TileMode tileMode = Shader.TileMode.CLAMP;
            BitmapShader bitmapShader = new BitmapShader(bitmap, tileMode, tileMode);
            this.f26608i = bitmapShader;
    ...
    public void e() {
        ...
        RectF rectF = this.h;
        Matrix matrix = this.f26609j;
        matrix.reset();
        matrix.postTranslate(rectF.left, rectF.top);
        matrix.preScale(rectF.width() / 60.0f, rectF.height() / 80.0f);
        this.f26608i.setLocalMatrix(matrix);
    }
}
