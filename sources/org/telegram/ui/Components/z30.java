...
public final class z30 extends View implements GestureDetector.OnGestureListener {
    ...
    public float W;
    public final Paint f33742a;
    public final ArrayList f33743b;
    public final ArrayList f33744c;
    public final ArrayList d;
    public final ArrayList f33745e;
    public int f33746f;
    public long h;
    public final int f33747n;
    public final int f33748r;
    public final int f33749s;
    public final int v;
    public int f33750w;
    ...
    public z30(ContextThemeWrapper contextThemeWrapper, int i10) {
        ...
        this.f33747n = AndroidUtilities.dp(42.0f);
        this.f33748r = AndroidUtilities.dp(56.0f);
    ...
    private ImageReceiver getFreeReceiver() {
        ...
        this.f33744c.add(imageReceiver);
        imageReceiver.setCurrentAccount(((org.telegram.ui.gs0) this.T).f37159a.Q);
        return imageReceiver;
    }

    private int getMaxScrollX() {
        return ((this.v * 2) + this.f33747n) * this.f33746f;
    }

    private int getMinScrollX() {
        return ((this.v * 2) + this.f33747n) * (-((this.d.size() - this.f33746f) - 1));
    }
    ...
    public final void a(int i10, boolean z4) {
        ...
        Object obj;
        ArrayList arrayList = this.f33743b;
        ArrayList arrayList2 = this.f33744c;
            ...
            if (!arrayList3.isEmpty()) {
                ...
                if (z4) {
                    ...
                    while (i15 < size) {
                        ...
                        int i16 = ((i13 + i14) * (param - this.f33746f)) + measuredWidth2 + i10;
                ...
                String str2 = "avatar_";
                int i17 = this.f33748r;
                int i18 = this.f33749s;
                ArrayList arrayList4 = this.f33745e;
                if (i11 != Integer.MIN_VALUE) {
                    int size2 = arrayList3.size();
                    while (i11 < size2) {
                        int i19 = ((i13 + i14) * (i11 - this.f33746f)) + measuredWidth2 + i10;
                        ...
                        if (arrayList4.get(0) instanceof MessageObject) {
                            ...
                            org.telegram.ui.ku0 ku0Var = ((org.telegram.ui.gs0) this.T).f37159a.f34283g7;
                            if (ku0Var != null) {
                                obj = ku0Var.g();
                            } else {
                                obj = null;
                            ...
                            obj = "avatar_" + ((org.telegram.ui.gs0) this.T).f37159a.f34425w5;
                        }
                ...
                if (i12 != Integer.MAX_VALUE) {
                    while (i12 >= 0) {
                        int i23 = ((i13 + i14) * (i12 - this.f33746f)) + i22 + i10 + i13;
                        if (i23 <= 0) {
                            break;
                        }
                        ...
                        if (arrayList4.get(0) instanceof MessageObject) {
                            ...
                            org.telegram.ui.ku0 ku0Var2 = ((org.telegram.ui.gs0) this.T).f37159a.f34283g7;
                            if (ku0Var2 != null) {
                                sb = ku0Var2.g();
                            } else {
                                sb = null;
                            ...
                            str = str2;
                            sb2.append(((org.telegram.ui.gs0) this.T).f37159a.f34425w5);
                            sb = sb2.toString();
    ...
    public final void e() {
        ...
        int i10 = this.Q;
        if (i10 >= 0 && i10 < this.f33745e.size()) {
            this.N = true;
            this.J = false;
            int i11 = this.Q;
            this.I = i11;
            this.C = i11;
            this.G = (this.f33747n + this.v) * (this.f33746f - i11);
            this.H = this.f33750w;
            this.f33751x = 1.0f;
            this.Q = -1;
            y30 y30Var = this.T;
            if (y30Var != null) {
                PhotoViewer photoViewer = ((org.telegram.ui.gs0) y30Var).f37159a;
    ...
    public final void f() {
        ...
        int i11;
        int i12;
        int i13 = this.f33750w;
        int abs = Math.abs(i13);
        int i14 = this.f33747n;
        int i15 = this.v;
        int i16 = (i14 / 2) + i15;
        int i17 = -1;
        if (abs > i16) {
        ...
        this.Q = this.f33746f - i10;
        PhotoViewer photoViewer = ((org.telegram.ui.gs0) this.T).f37159a;
        int i18 = photoViewer.M4;
        ArrayList arrayList = photoViewer.X6;
        ArrayList arrayList2 = photoViewer.V6;
        org.telegram.ui.ku0 ku0Var = photoViewer.f34283g7;
        if (ku0Var != null) {
            list = ku0Var.getAll();
        } else {
            list = null;
        ...
        if (i18 != i19 && i19 >= 0 && i19 < this.d.size()) {
            Object obj = this.f33745e.get(this.Q);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        boolean z4 = this.R;
        ArrayList arrayList = this.f33744c;
            ...
            if (!arrayList.isEmpty()) {
                ...
                if (i22 >= 0 && i22 < arrayList2.size()) {
                    ...
                    if (imageLocation2 != null && (photoSize = imageLocation2.photoSize) != null) {
                        i19 = Math.max(i16, (int) ((i19 / photoSize.h) * photoSize.f20870w));
                    }
                } else {
                    i19 = i16;
                }
                ...
                for (int size = arrayList.size(); i26 < size; size = i14) {
                    ...
                    if (param == i27) {
                        ...
                        if (i28 < i27) {
                            if (param < i27) {
                                if (param <= i28) {
                                    imageReceiver.setImageX(((((i16 + i29) * ((imageReceiver.getParam() - this.f33746f) + 1)) + measuredWidth) - (i29 + i25)) + i24);
                                } else {
                                    imageReceiver.setImageX(((i29 + i16) * (imageReceiver.getParam() - this.f33746f)) + measuredWidth + i24);
                                }
                                i14 = size;
                            } else {
                                i14 = size;
                                imageReceiver.setImageX(((i29 + i16) * ((imageReceiver.getParam() - this.f33746f) - 1)) + measuredWidth + i21 + i29 + i24);
                            }
                        } else {
                            i14 = size;
                            if (param < i27) {
                                ...
                                imageReceiver.setImageX(i29 + i25 + ((i16 + i29) * ((imageReceiver.getParam() - this.f33746f) - 2)) + measuredWidth + i21 + i29 + i24);
                            }
                        }
                        if (param == this.C) {
                ...
                if (i30 >= 0) {
                    ...
                    if (f17 > 0.0f) {
                        ...
                        if (i30 == this.f33746f) {
                            ...
                            this.f33750w = this.H + ((int) Math.ceil(this.f33752y * (this.G - i13)));
                        } else {
                            pr prVar = pr.f30169g;
                            this.B = prVar.getInterpolation(1.0f - f19);
                            if (this.N) {
                                float f22 = this.f33752y;
                                if (f22 > 0.0f) {
                                ...
                                this.f33750w = this.H + ((int) Math.ceil(interpolation * (this.G - i12)));
                            } else {
                                this.f33752y = prVar.getInterpolation(this.f33751x);
                                this.f33750w = (int) Math.ceil(this.B * this.G);
                            }
                        }
                        if (this.f33751x <= 0.0f) {
                            this.f33746f = this.I;
                            this.f33751x = 1.0f;
                            this.f33752y = 1.0f;
                            this.B = 0.0f;
                ...
                if (!scroller.isFinished()) {
                    if (scroller.computeScrollOffset()) {
                        this.f33750w = scroller.getCurrX();
                        f();
                        invalidate();
                    }
                    if (scroller.isFinished()) {
    ...
    public final boolean onFling(MotionEvent motionEvent, MotionEvent motionEvent2, float f10, float f11) {
        ...
        scroller.abortAnimation();
        if (this.d.size() >= 10) {
            scroller.fling(this.f33750w, 0, Math.round(f10), 0, getMinScrollX(), getMaxScrollX(), 0, 0);
            return false;
        }
        return false;
    }
    ...
    public final boolean onScroll(MotionEvent motionEvent, MotionEvent motionEvent2, float f10, float f11) {
        this.f33750w = (int) (this.f33750w - f10);
        int minScrollX = getMinScrollX();
        int maxScrollX = getMaxScrollX();
        int i10 = this.f33750w;
        if (i10 < minScrollX) {
            this.f33750w = minScrollX;
        } else if (i10 > maxScrollX) {
            this.f33750w = maxScrollX;
        }
        f();
        return false;
    }
    ...
    public final boolean onSingleTapUp(MotionEvent motionEvent) {
        ...
        e();
        ArrayList arrayList3 = this.f33744c;
    ...
    public void setMoveProgress(float f10) {
        ...
        if (!this.M && this.I < 0) {
            ...
            if (i11 >= 0 && i11 < arrayList.size()) {
                this.f33752y = 1.0f - Math.abs(f10);
            } else {
                this.f33752y = 1.0f;
            }
            this.B = 1.0f - this.f33752y;
            if (i10 != 0) {
                z4 = true;
            } else {
                z4 = false;
            ...
            invalidate();
            if (!arrayList.isEmpty()) {
                if (f10 >= 0.0f || this.f33746f != arrayList.size() - 1) {
                    if (i10 <= 0 || this.f33746f != 0) {
                        int i12 = (int) (f10 * (this.f33747n + this.v));
                        this.f33750w = i12;
                        a(i12, true);
                    }
                }
