...
public final class vq implements Runnable {
    ...
    public final lh.s6 f30067b;
    public final org.telegram.ui.Cells.i3 f30068c;
    public final int[] d;
    public final ph.d e;
    public final boolean f30069f;
    public final int h;
    public final TLRPC.User f30070n;
    public final int[] f30071r;
    public final boolean[] f30072s;
    public final Utilities.Callback v;
    public final org.telegram.ui.ActionBar.g3 f30073w;
    public final org.telegram.ui.ActionBar.f6 f30074x;
    public final Context f30075y;

    public vq(String[] strArr, lh.s6 s6Var, org.telegram.ui.Cells.i3 i3Var, int[] iArr, ph.d dVar, boolean z4, int i10, TLRPC.User user, int[] iArr2, boolean[] zArr, Utilities.Callback callback, org.telegram.ui.ActionBar.g3 g3Var, org.telegram.ui.ActionBar.f6 f6Var, Context context) {
        this.f30066a = strArr;
        this.f30067b = s6Var;
        this.f30068c = i3Var;
        this.d = iArr;
        ...
        this.f30073w = g3Var;
        this.f30074x = f6Var;
        this.f30075y = context;
    }

    @Override
    public final void run() {
        String[] strArr = this.f30066a;
        if (strArr[0] == null) {
            this.f30067b.run();
            return;
        }
        org.telegram.ui.Cells.i3 i3Var = this.f30068c;
        ...
        createbot.via_deeplink = this.f30069f;
        createbot.username = strArr[0];
        createbot.name = trim;
        final int i11 = this.h;
        MessagesController messagesController = MessagesController.getInstance(i11);
        final TLRPC.User user = this.f30070n;
        createbot.manager_id = messagesController.getInputUser(user);
        ConnectionsManager connectionsManager = ConnectionsManager.getInstance(i11);
        ?? obj = new Object();
        final int[] iArr2 = this.f30071r;
        final boolean[] zArr = this.f30072s;
        final Utilities.Callback callback = this.v;
        final org.telegram.ui.ActionBar.g3 g3Var = this.f30073w;
        final org.telegram.ui.ActionBar.f6 f6Var = this.f30074x;
        final Context context = this.f30075y;
            ...
            public final void run(Object obj2, Object obj3) {
                ...
                if (user2 != null) {
                    ...
                    if (equalsIgnoreCase) {
                        ...
                        SpannableStringBuilder replaceSingleLink = AndroidUtilities.replaceSingleLink(formatString, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Gi, f6Var2), new vp(g3Var2, 2));
