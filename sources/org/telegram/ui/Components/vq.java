...
public class vq extends Path {
    public static ArrayList f29788g;
    public int e;
    public int f29792f;
    public boolean f29790b = false;
    public boolean f29791c = true;
    public float d = 0.0f;
    public final ArrayList f29789a = new ArrayList(1);

    public vq() {
    }

    public final void a() {
        if (Build.VERSION.SDK_INT >= 34 && this.f29791c && !this.f29790b) {
            b(this.f29789a);
            this.f29790b = true;
        }
    }
    ...
    public final void addRect(RectF rectF, Path.Direction direction) {
        RectF rectF2;
        if (Build.VERSION.SDK_INT >= 34 && this.f29791c) {
            ...
            if (arrayList.size() <= 0 || !((RectF) hg.c.g(1, arrayList)).contains(rectF)) {
                if (arrayList.size() > 0 && Math.abs(rectF.top - ((RectF) hg.c.g(1, arrayList)).top) <= this.d && Math.abs(rectF.bottom - ((RectF) hg.c.g(1, arrayList)).bottom) <= this.d) {
                    ...
                    ArrayList arrayList2 = f29788g;
                    if (arrayList2 != null && arrayList2.size() > 0) {
                        rectF2 = (RectF) f29788g.remove(0);
                    } else {
                        rectF2 = new RectF();
                    }
                    rectF2.set(rectF);
    ...
    public final void b(List list) {
        if (!list.isEmpty()) {
            boolean z10 = false;
            if (list.size() == 1) {
                super.addRect(((RectF) list.get(0)).left - this.e, ((RectF) list.get(0)).top - this.f29792f, ((RectF) list.get(0)).right + this.e, ((RectF) list.get(0)).bottom + this.f29792f, Path.Direction.CW);
                return;
            }
            RectF rectF = (RectF) list.get(0);
            int size = list.size() - 1;
            super.moveTo(rectF.left - this.e, rectF.top - this.f29792f);
            ...
            super.lineTo(rectF.left - this.e, rectF.bottom + this.f29792f);
            super.lineTo(rectF.right + this.e, rectF.bottom + this.f29792f);
            ...
            super.lineTo(rectF.right + this.e, rectF.top - this.f29792f);
            super.close();
            if (z10) {
    ...
    public void reset() {
        super.reset();
        if (Build.VERSION.SDK_INT >= 34 && this.f29791c) {
            ArrayList arrayList = f29788g;
            ArrayList arrayList2 = this.f29789a;
            if (arrayList == null) {
                f29788g = new ArrayList(arrayList2.size());
            }
            f29788g.addAll(arrayList2);
            arrayList2.clear();
            this.f29790b = false;
        }
    }
