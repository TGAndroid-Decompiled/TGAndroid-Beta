...
public final class vq extends View {
    ...
    public vq(Context context, int i10) {
        ...
        if (i10 == 0) {
            this.f29711f = org.telegram.ui.ActionBar.h6.B7;
            this.h = org.telegram.ui.ActionBar.h6.C7;
        } else if (i10 == 1) {
            this.f29711f = org.telegram.ui.ActionBar.h6.D7;
            this.h = org.telegram.ui.ActionBar.h6.E7;
        } else if (i10 == 2) {
            this.f29711f = org.telegram.ui.ActionBar.h6.F7;
            this.h = org.telegram.ui.ActionBar.h6.G7;
        } else if (i10 == 3) {
            this.f29711f = org.telegram.ui.ActionBar.h6.H7;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        RectF rectF = this.f29710c;
        rectF.set(measuredWidth, measuredHeight, AndroidUtilities.dp(18.0f) + measuredWidth, AndroidUtilities.dp(18.0f) + measuredHeight);
        canvas.drawCircle(getMeasuredWidth() / 2, getMeasuredHeight() / 2, AndroidUtilities.dp(9.0f), this.f29708a);
        canvas.drawArc(rectF, this.d - 90, 90.0f, false, this.f29709b);
        invalidate();
    }
