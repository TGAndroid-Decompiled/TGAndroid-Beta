...
public final class oc0 extends Drawable {
    public final Drawable f29733a;
    public final Paint f29734b;
    public final Paint f29735c;
    public final z5 d;
    ...
    public oc0(Context context) {
        ...
        this.f29735c = paint2;
        this.d = new z5(new ec0(this, 2), 200L, pr.f30169g, 0);
        this.f29733a = context.getResources().getDrawable(R.drawable.filled_sound_on).mutate();
    ...
    public final void draw(Canvas canvas) {
        ...
        Drawable drawable = this.f29733a;
        drawable.setBounds(bounds);
        drawable.draw(canvas);
        float e6 = this.d.e(this.f29736e);
        if (e6 > 0.0f) {
            ...
            float f12 = centerY;
            float f13 = dp;
            canvas.drawLine(f11, f12, f13, f10, this.f29735c);
            Paint paint = this.f29734b;
