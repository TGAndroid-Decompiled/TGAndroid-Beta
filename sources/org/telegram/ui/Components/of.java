...
public final class of extends lg {
    public boolean e;
    public float f26723f;
    public float h;
    public boolean f26724n;
    public final ChatActivityEnterView f26725r;
    ...
    public of(ChatActivityEnterView chatActivityEnterView, Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f26725r = chatActivityEnterView;
        this.e = true;
    }
    ...
    public final void onAttachedToWindow() {
        ...
        ChatActivityEnterView chatActivityEnterView = this.f26725r;
        ...
        if (boVar != null && boVar.getParentLayout() != null && ((ActionBarLayout) chatActivityEnterView.O2.getParentLayout()).f18391b) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (chatActivityEnterView.w()) {
            if (motionEvent.getAction() == 0) {
                this.f26723f = motionEvent.getX();
                this.h = motionEvent.getY();
                this.f26724n = true;
            } else if (this.f26724n && motionEvent.getAction() == 2) {
                if (Math.abs(motionEvent.getX() - this.f26723f) > AndroidUtilities.touchSlop || Math.abs(motionEvent.getY() - this.h) > AndroidUtilities.touchSlop) {
                    this.f26724n = false;
                }
            } else if (this.f26724n) {
                if (chatActivityEnterView.Y2 != null) {
                    int i10 = org.telegram.ui.ActionBar.j6.f19201vf;
        ...
        if (motionEvent.getAction() == 0 && chatActivityEnterView.Y2 != null) {
            int i12 = org.telegram.ui.ActionBar.j6.f19201vf;
    ...
    public final void setOffsetY(float f7) {
        super.setOffsetY(f7);
        this.f26725r.f21877x1.invalidate();
    }
}
