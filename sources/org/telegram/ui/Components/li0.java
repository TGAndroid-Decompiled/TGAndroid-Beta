...
public final class li0 {
    public final c6 f25912a;
    public final m6 f25913b;
    public final int f25914c;
    public boolean d;
    public final qi0 e;
    public final wc f25915f;
    public final Paint f25916g = new Paint(1);
    public boolean h;

    public li0(View view) {
        this.f25912a = new c6(view, 350L, qr.h);
        this.e = new qi0(view);
        this.f25915f = new wc(view);
        ...
        this.f25914c = (int) Math.ceil(Math.max(textPaint.measureText(string), textPaint.measureText(LocaleController.getString(R.string.QuoteCollapse))));
    }

    public final void a(Canvas canvas, RectF rectF, float f7, float f10, int i10, boolean z10, boolean z11) {
        int i11;
        boolean z12 = this.d;
        m6 m6Var = this.f25913b;
        if (z10 != z12) {
            this.d = z10;
            if (z10) {
        ...
        float a2 = this.f25915f.a(0.02f) * this.f25912a.e(z11);
        if (a2 > 0.0f) {
            int k10 = i0.a.k(i10, 30);
            Paint paint = this.f25916g;
            paint.setColor(k10);
            canvas.save();
            ...
            Paint paint2 = qi0Var.f27322b;
            paint2.setColor(i10);
            paint2.setAlpha(qi0Var.d);
            boolean z13 = !z10;
            if (qi0Var.e != z13) {
                qi0Var.e = z13;
                qi0Var.f27321a.invalidate();
            }
            qi0Var.draw(canvas);
            canvas.restore();
        }
