...
public final class li0 {
    public final e6 f25900a;
    public final o6 f25901b;
    public final int f25902c;
    public boolean d;
    public final qi0 e;
    public final yc f25903f;
    public final Paint f25904g = new Paint(1);
    public boolean h;

    public li0(View view) {
        this.f25900a = new e6(view, 350L, rr.h);
        this.e = new qi0(view);
        this.f25903f = new yc(view);
        ...
        this.f25902c = (int) Math.ceil(Math.max(textPaint.measureText(string), textPaint.measureText(LocaleController.getString(R.string.QuoteCollapse))));
    }

    public final void a(Canvas canvas, RectF rectF, float f7, float f10, int i10, boolean z10, boolean z11) {
        int i11;
        boolean z12 = this.d;
        o6 o6Var = this.f25901b;
        if (z10 != z12) {
            this.d = z10;
            if (z10) {
        ...
        float a2 = this.f25903f.a(0.02f) * this.f25900a.e(z11);
        if (a2 > 0.0f) {
            int k10 = i0.a.k(i10, 30);
            Paint paint = this.f25904g;
            paint.setColor(k10);
            canvas.save();
            ...
            Paint paint2 = qi0Var.f27361b;
            paint2.setColor(i10);
            paint2.setAlpha(qi0Var.d);
            boolean z13 = !z10;
            if (qi0Var.e != z13) {
                qi0Var.e = z13;
                qi0Var.f27360a.invalidate();
            }
            qi0Var.draw(canvas);
            canvas.restore();
        }
