...
public final class o80 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        switch (this.f29002a) {
            case 0:
                this.f29003b.f32206r.d();
                return;
            case 1:
                w80 w80Var = this.f29003b;
                org.telegram.ui.ActionBar.n1 n1Var = w80Var.f32207s;
                if (n1Var != null) {
                    n1Var.d(true);
                }
                w80Var.f32206r.b();
                return;
            case 2:
                w80 w80Var2 = this.f29003b;
                String str = w80Var2.f32201b;
                ...
                w80Var2.E.show();
                org.telegram.ui.ActionBar.n1 n1Var2 = w80Var2.f32207s;
                if (n1Var2 != null) {
                    n1Var2.d(true);
                    return;
                }
                return;
            default:
                w80 w80Var3 = this.f29003b;
                org.telegram.ui.ActionBar.n1 n1Var3 = w80Var3.f32207s;
                if (n1Var3 != null) {
                    n1Var3.d(true);
                }
                org.telegram.ui.ActionBar.n2 n2Var = w80Var3.f32202c;
                if (n2Var.getParentActivity() != null) {
                    ...
                    alertDialog$Builder.f20199a.T = LocaleController.getString(R.string.RevokeAlert);
                    alertDialog$Builder.k(LocaleController.getString(R.string.RevokeButton), new n80(w80Var3, 1));
                    alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
                    TextView textView = (TextView) alertDialog$Builder.f20199a.d(-1);
                    if (textView != null) {
