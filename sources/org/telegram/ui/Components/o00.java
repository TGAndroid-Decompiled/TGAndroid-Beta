...
public final class o00 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    public static final int f26553w = 0;
    public final ai.w0 f26554b;
    public final n00 f26555c;
    public final TextView d;
    public AnimatorSet e;
    public final View f26556f;
    public int h;
    public boolean f26557n;
    public org.telegram.ui.eu f26558r;
    public final ArrayList f26559s;
    ...
    public o00(org.telegram.ui.ry ryVar, ArrayList arrayList) {
        ...
        fixNavigationBar();
        this.v = arrayList;
        this.f26559s = new ArrayList(ryVar.getMessagesController().dialogFilters);
        int i10 = 0;
        while (i10 < this.f26559s.size()) {
            if (((MessagesController.DialogFilter) this.f26559s.get(i10)).isDefault()) {
                this.f26559s.remove(i10);
                i10--;
            }
            i10++;
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.emojiLoaded) {
            AndroidUtilities.forEachViews((RecyclerView) this.f26554b, (Utilities.Callback<View>) new ai.i(12));
        }
    }
