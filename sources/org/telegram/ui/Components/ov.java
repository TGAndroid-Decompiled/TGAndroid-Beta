...
public abstract class ov implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ArrayList f29192b;
    public ArrayList[] f29193c;
    public final int d;
    public boolean f29194e = false;
    public final rv f29195f;

    public ov(int i10, ArrayList arrayList, rv rvVar) {
        this.f29195f = rvVar;
        this.d = i10;
        this.f29191a = arrayList == null ? new ArrayList() : arrayList;
    }
    ...
    public final void a(int i10, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        ...
        if (i10 >= 0) {
            ArrayList[] arrayListArr = this.f29193c;
                ...
                if (tL_messages_stickerSet != null && tL_messages_stickerSet.documents != null) {
                    ...
                    for (int i12 = 0; i12 < tL_messages_stickerSet.documents.size(); i12++) {
                        ...
                        if (document == null) {
                            ...
                            obj.f29510a = tL_messages_stickerSet;
                            obj.f29511b = document.f19875id;
                            this.f29193c[i10].add(obj);
                            if (this.f29195f.H) {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.groupStickersDidLoad) {
            for (int i12 = 0; i12 < this.f29192b.size(); i12++) {
                if (this.f29192b.get(i12) == null) {
                    TLRPC.TL_messages_stickerSet stickerSet2 = MediaDataController.getInstance(this.d).getStickerSet((TLRPC.InputStickerSet) this.f29191a.get(i12), true);
                    if (this.f29192b.size() == 1 && stickerSet2 != null && (stickerSet = stickerSet2.set) != null && !stickerSet.emojis) {
                        rv rvVar = this.f29195f;
                        rvVar.dismiss();
                        Context context = rvVar.getContext();
                        org.telegram.ui.ActionBar.n2 n2Var = rvVar.f30095c;
                        TLRPC.InputStickerSet inputStickerSet = (TLRPC.InputStickerSet) this.f29191a.get(i12);
                    ...
                    this.f29192b.set(i12, stickerSet2);
                    if (stickerSet2 != null) {
                        a(i12, stickerSet2);
                    }
                }
