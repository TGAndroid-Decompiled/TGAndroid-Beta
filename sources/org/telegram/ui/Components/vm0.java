...
public final class vm0 extends ll0 {
    ...
    public final MessageObject E(int i10) {
        wm0 wm0Var = this.f28828c;
        int i11 = wm0Var.v;
        if (i10 >= i11 && i10 < wm0Var.f29701w) {
            return (MessageObject) wm0Var.e.get(i10 - i11);
        }
        int i12 = wm0Var.f29703y;
        if (i10 >= i12 && i10 < wm0Var.E) {
            return (MessageObject) wm0Var.f29697f.get(i10 - i12);
        }
        return null;
    }
    ...
    @Override
    public final int h() {
        return this.f28828c.f29699r;
    }

    @Override
    public final int j(int i10) {
        wm0 wm0Var = this.f28828c;
        if (i10 != wm0Var.f29700s && i10 != wm0Var.f29702x) {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i13 == 0) {
            ...
            if (i10 == wm0Var.f29700s) {
                ...
                if (u3Var.getText().equals(string)) {
                    ...
                    org.telegram.ui.Cells.t3 t3Var = u3Var.f21435b;
        ...
        MessageObject E = E(i10);
        if (E != null) {
            if (wm0Var.I.g() && i10 >= wm0Var.v && i10 < wm0Var.f29701w) {
                z10 = true;
            } else {
                z10 = false;
            }
            ...
            if (i13 == 1) {
                sm0 sm0Var = (sm0) view;
                sm0Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18862d6, false));
                org.telegram.ui.Cells.j7 j7Var = sm0Var.f27887a;
                ...
                r10Var.f37062a = j7Var.getMessage().getDialogId();
                r10Var.f37063b = id4;
                ...
                r10Var.f37062a = i7Var.getMessage().getDialogId();
                r10Var.f37063b = id5;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            frameLayout2.f27887a = j7Var;
            j7Var.f20338r.setVisibility(8);
