...
public final class hi implements pj {
    ...
    public final void b(TLRPC.User user, boolean z10, int i10, long j3) {
        org.telegram.ui.co coVar = (org.telegram.ui.co) this.f26735a.f31279f0;
        if (coVar.f7()) {
            SendMessagesHelper.SendMessageParams of2 = SendMessagesHelper.SendMessageParams.of(user, coVar.T5, coVar.f35352n5, coVar.X3, (TLRPC.ReplyMarkup) null, (HashMap<String, String>) null, z10, i10, 0);
    ...
    public final void c(ArrayList arrayList, String str, boolean z10, int i10, long j3, boolean z11) {
        ((org.telegram.ui.co) this.f26735a.f31279f0).db(arrayList, str, z10, i10, j3, z11);
    }
}
