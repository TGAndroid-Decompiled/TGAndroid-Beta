...
public final class hi extends AnimatorListenerAdapter {
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        switch (this.f24770a) {
            case 0:
                wi wiVar = (wi) this.d;
                wiVar.f30066y0.setAlpha(0.0f);
                wiVar.f30066y0.setTranslationY(AndroidUtilities.dp(78.0f) + this.f24771b);
                ki kiVar = wiVar.f30001e0;
                ...
                o1.k kVar = new o1.k(wiVar.f30069z0, o1.h.f15516n, 0.0f);
                kVar.f15533u.a(0.75f);
                kVar.f15533u.b(500.0f);
                kVar.b(new k7(this, 3));
                kVar.a(new ei.m4(3, this, (hh) this.f24772c));
                wiVar.f30049t1 = kVar;
                kVar.f();
                return;
            case 1:
                a5.a aVar = (a5.a) this.d;
                ((wl0) aVar.d).scrollBy(0, this.f24771b - ((int[]) this.f24772c)[0]);
                aVar.f278c = null;
                return;
            default:
                ...
                x3Var.s2();
                x3Var.Z0 = null;
                Runnable runnable = (Runnable) this.f24772c;
                if (runnable != null) {
                    runnable.run();
                    return;
                }
