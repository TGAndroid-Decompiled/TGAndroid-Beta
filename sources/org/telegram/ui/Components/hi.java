...
public final class hi implements pj {
    ...
    public final void a(TLRPC.User user, boolean z10, int i10, long j3) {
        org.telegram.ui.bo boVar = (org.telegram.ui.bo) this.f24674a.f28745f0;
        if (boVar.f7()) {
            SendMessagesHelper.SendMessageParams of2 = SendMessagesHelper.SendMessageParams.of(user, boVar.T5, boVar.f32385n5, boVar.X3, (TLRPC.ReplyMarkup) null, (HashMap<String, String>) null, z10, i10, 0);
    ...
    public final void b(ArrayList arrayList, String str, boolean z10, int i10, long j3, boolean z11) {
        ((org.telegram.ui.bo) this.f24674a.f28745f0).db(arrayList, str, z10, i10, j3, z11);
    }
}
