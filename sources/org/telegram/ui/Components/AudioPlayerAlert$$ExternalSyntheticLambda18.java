...
public final class AudioPlayerAlert$$ExternalSyntheticLambda18 implements Runnable {
    public final int $r8$classId;
    public final AudioPlayerAlert f$0;
    public final TLRPC.TL_error f$1;

    public AudioPlayerAlert$$ExternalSyntheticLambda18(AudioPlayerAlert audioPlayerAlert, TLRPC.TL_error tL_error, int i) {
        this.$r8$classId = i;
