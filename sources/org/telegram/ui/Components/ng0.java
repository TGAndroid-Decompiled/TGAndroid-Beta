...
public abstract class ng0 extends FrameLayout {
    public final y5 f28744a;
    public final TextView f28745b;
    public final org.telegram.ui.Cells.w1 f28746c;
    public final pg0 d;
    ...
    public ng0(pg0 pg0Var, Context context) {
        ...
        int i15;
        this.d = pg0Var;
        setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20753i5, false));
    ...
    public final void a(String str, ArrayList arrayList, int i10, int i11, int i12, boolean z10) {
        ...
        this.f28745b.setText(spannableStringBuilder);
        org.telegram.ui.Cells.w1 w1Var = this.f28746c;
        if (i12 == 0) {
            if (this.d.f29376r.quiz) {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        y5 y5Var = this.f28744a;
        TextView textView = this.f28745b;
        if (z11) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        measureChildWithMargins(this.f28744a, i10, AndroidUtilities.dp(32.0f) + measuredWidth, makeMeasureSpec, 0);
