...
public final class ng0 implements ef.a {
    public static final iv0 f29461k0 = new iv0(new k2(26), new k2(27));
    public static final iv0 f29462l0 = new iv0(new k2(28), new k2(29));
    ...
    public oh.b3 Y;
    public boolean Z;
    public boolean f29464a0;
    public WindowManager f29465b;
    public WindowManager.LayoutParams f29467c;
    public boolean f29468c0;
    public org.telegram.ui.g d;
    public mg0 f29470e;
    public View f29472f;
    public boolean f29473f0;
    public mg0 h;
    public View f29475h0;
    public TextureView f29476i0;
    public boolean f29477j0;
    public boolean f29478n;
    public xf0 f29479r;
    public ScaleGestureDetector f29480s;
    public ai v;
    public boolean f29481w;
    public boolean f29482x;
    public View f29483y;
    public float f29463a = 1.4f;
    public float G = 1.0f;
    public final z61 N = new z61(false);
    public final gg0 f29466b0 = new gg0(this, 1);
    public float[] f29469d0 = new float[2];
    public final gg0 f29471e0 = new gg0(this, 2);
    public final gg0 f29474g0 = new gg0(this, 3);
    ...
    public static sk0 o(float f10, boolean z4) {
        ...
        ng0 ng0Var = m0;
        if (ng0Var.M && !z4) {
            obj.f31078a = ng0Var.H;
            obj.f31079b = ng0Var.I + AndroidUtilities.statusBarHeight;
            obj.f31080c = ng0Var.E;
            obj.d = ng0Var.F;
            return obj;
        }
        float f12 = ((SharedPreferences) ng0Var.n().f25257b).getFloat("x", -1.0f);
        float f13 = ((SharedPreferences) ng0Var.n().f25257b).getFloat("y", -1.0f);
        float f14 = ((SharedPreferences) ng0Var.n().f25257b).getFloat("scale_factor", 1.0f);
        obj.f31080c = s(f11) * f14;
        obj.d = ((int) (s(f11) * f11)) * f14;
        if (f12 != -1.0f) {
            float f15 = obj.f31080c;
            ...
            obj.f31078a = (AndroidUtilities.displaySize.x - obj.f31080c) - AndroidUtilities.dp(16.0f);
        }
        if (f13 != -1.0f) {
            obj.f31079b = k7.o.a(f13, AndroidUtilities.dp(16.0f), (AndroidUtilities.displaySize.y - AndroidUtilities.dp(16.0f)) - obj.d) + AndroidUtilities.statusBarHeight;
            return obj;
        }
        obj.f31079b = AndroidUtilities.dp(16.0f) + AndroidUtilities.statusBarHeight;
        return obj;
    }
    ...
    public static void w(PhotoViewer photoViewer) {
        ...
        if (j71Var != null && ff.d.a(photoViewer.f34439y) == 1) {
            cf.e eVar = new cf.e(photoViewer.f34439y, ng0Var);
            eVar.f2482c = "photo-viewer-pip-" + j71Var.f28043a;
            eVar.f2483e = 1;
            eVar.d = AndroidUtilities.dp(10.0f);
            eVar.f2487j = ng0Var.d;
            eVar.f2488k = ng0Var.f29475h0;
            int i10 = ng0Var.P;
            int i11 = ng0Var.Q;
            eVar.h = i10;
            eVar.f2486i = i11;
            eVar.f2485g = j71Var.d;
            eVar.f2484f = true;
            ng0Var.T = eVar.a();
        }
        ng0Var.z();
    ...
    public final void a(c2.p pVar) {
        ...
        this.f29465b.addView(this.d, this.f29467c);
        this.f29477j0 = false;
        this.d.invalidate();
        PhotoViewer photoViewer = this.S;
        if (photoViewer != null) {
            j71Var = photoViewer.C2;
        } else {
            j71Var = null;
        }
        if (j71Var == null) {
    ...
    public final Bitmap b() {
        TextureView textureView = this.f29476i0;
        if (textureView != null && textureView.isAvailable()) {
            return this.f29476i0.getBitmap();
        }
        return null;
    }
    ...
    public final void e(c2.p pVar) {
        ...
        this.f29465b.removeView(this.d);
        this.f29477j0 = true;
        this.d.invalidate();
    }
    ...
    public final View h() {
        ...
        this.f29476i0 = textureView;
        textureView.setVisibility(4);
        this.f29476i0.setOpaque(false);
        this.f29476i0.setSurfaceTextureListener(new jh.h(this, 2));
        return this.f29476i0;
    }
    ...
    public final void k(boolean z4, boolean z10) {
        ...
        if (this.f29473f0) {
            AndroidUtilities.cancelRunOnUIThread(this.f29474g0);
            this.f29473f0 = false;
        }
        o1.j jVar = this.J;
        if (jVar != null) {
    ...
    public final float q() {
        ...
        if (this.L == null) {
            ...
            Point point = AndroidUtilities.displaySize;
            this.f29463a = (Math.min(point.x, point.y) - AndroidUtilities.dp(32.0f)) / t();
    ...
    public final void u() {
        try {
            ...
            if (gVar != null && gVar.getParent() != null) {
                this.f29465b.removeViewImmediate(this.d);
            }
        ...
        this.f29468c0 = false;
        i();
        AndroidUtilities.cancelRunOnUIThread(this.f29471e0);
    }
