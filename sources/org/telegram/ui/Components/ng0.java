...
public abstract class ng0 extends FrameLayout {
    public final w5 f26451a;
    public final TextView f26452b;
    public final org.telegram.ui.Cells.w1 f26453c;
    public final pg0 d;
    ...
    public ng0(pg0 pg0Var, Context context) {
        ...
        int i15;
        this.d = pg0Var;
        setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18922i5, false));
        ...
        w1Var.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, i16, false));
        if (LocaleController.isRTL) {
            i12 = 3;
        } else {
            i12 = 5;
    ...
    public final void a(String str, ArrayList arrayList, int i10, int i11, int i12, boolean z10) {
        ...
        this.f26452b.setText(spannableStringBuilder);
        org.telegram.ui.Cells.w1 w1Var = this.f26453c;
        if (i12 == 0) {
            if (this.d.f27036r.quiz) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        measureChildWithMargins(this.f26451a, i10, AndroidUtilities.dp(32.0f) + measuredWidth, makeMeasureSpec, 0);
