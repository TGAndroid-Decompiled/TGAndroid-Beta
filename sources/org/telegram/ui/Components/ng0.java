...
public abstract class ng0 extends FrameLayout {
    public final y5 f28771a;
    public final TextView f28772b;
    public final org.telegram.ui.Cells.w1 f28773c;
    public final pg0 d;
    ...
    public ng0(pg0 pg0Var, Context context) {
        ...
        int i15;
        this.d = pg0Var;
        setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20780i5, false));
    ...
    public final void a(String str, ArrayList arrayList, int i10, int i11, int i12, boolean z10) {
        ...
        this.f28772b.setText(spannableStringBuilder);
        org.telegram.ui.Cells.w1 w1Var = this.f28773c;
        if (i12 == 0) {
            if (this.d.f29403r.quiz) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        measureChildWithMargins(this.f28771a, i10, AndroidUtilities.dp(32.0f) + measuredWidth, makeMeasureSpec, 0);
