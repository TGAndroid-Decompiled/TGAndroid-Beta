...
public final class x2 implements Runnable {
    public final fd0 f30244a;
    public final int f30245b;
    public final fd0 f30246c;
    public final fd0 d;
    public final int e;
    public final int f30247f;
    public final int h;

    public x2(fd0 fd0Var, int i10, fd0 fd0Var2, fd0 fd0Var3, int i11, int i12, int i13) {
        this.f30244a = fd0Var;
        this.f30245b = i10;
        this.f30246c = fd0Var2;
        this.d = fd0Var3;
        this.e = i11;
        this.f30247f = i12;
        this.h = i13;
    ...
    public final void run() {
        fd0 fd0Var = this.f30244a;
        int value = fd0Var.getValue();
        int i10 = this.f30245b;
        fd0 fd0Var2 = this.f30246c;
        fd0 fd0Var3 = this.d;
        if (value == i10) {
