...
public final class n81 extends View {
    ...
    public float F;
    public final org.telegram.ui.ActionBar.g6 f29432a;
    public final Paint f29433b;
    public final Paint f29434c;
    public final TextPaint d;
    public final Paint f29435e;
    public String f29436f;
    public int h;
    public int f29437n;
    public final RectF f29438r;
    public boolean f29439s;
    public final Canvas v;
    public final Bitmap f29440w;
    public float f29441x;
    public ObjectAnimator f29442y;
    ...
    public final void a(boolean z4, boolean z10) {
        ...
        if (z10) {
            ...
            this.f29442y = ofFloat;
            ofFloat.setDuration(300L);
            this.f29442y.start();
            return;
        }
        ObjectAnimator objectAnimator = this.f29442y;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        RectF rectF = this.f29438r;
        rectF.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
        View view = this.B;
        org.telegram.ui.ActionBar.g6 g6Var = this.f29432a;
        ...
        canvas2.drawText(this.f29436f, AndroidUtilities.dp(28.0f) + x10, AndroidUtilities.dp(21.0f), textPaint);
        canvas2.save();
        canvas2.translate(x10, AndroidUtilities.dp(7.0f));
        Bitmap bitmap = this.f29440w;
        int i11 = 0;
        Paint paint3 = this.f29435e;
        if (bitmap != null) {
            float f13 = this.f29441x;
            if (f13 <= 0.5f) {
                f10 = f13 / 0.5f;
                f11 = f10;
            } else {
            ...
            if (f11 != 1.0f) {
                ...
                canvas3.drawRoundRect(rectF, rectF.width() / 2.0f, rectF.height() / 2.0f, this.f29433b);
            }
            if (this.f29441x > 0.5f) {
                Paint paint4 = this.f29434c;
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(org.telegram.ui.b.B(56.0f, this.f29437n, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(32.0f), 1073741824));
    }
