...
public final class hm0 extends xw0 {
    public float d;
    public final Paint f24821f;
    public boolean f24818a = false;
    public long f24819b = 0;
    public boolean f24820c = false;
    public int e = 1;

    public hm0(boolean z10) {
        if (z10) {
            this.f24821f = new Paint(1);
        }
    }

    @Override
    public final void b(int i10) {
        Paint paint = this.f24821f;
        if (paint != null) {
            paint.setColor(i10);
        }
    }
    ...
    @Override
    public final void d() {
        this.f24819b = System.currentTimeMillis();
        this.f24820c = true;
        invalidateSelf();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.f24820c) {
            ...
            long j3 = currentTimeMillis - this.f24819b;
            this.f24819b = currentTimeMillis;
            if (j3 > 50) {
                j3 = 50;
            }
            float f10 = this.d;
