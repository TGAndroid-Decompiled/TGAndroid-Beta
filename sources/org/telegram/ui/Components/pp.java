...
public class pp extends View {
    public final CheckBoxBase f27472a;
    public Drawable f27473b;
    public int f27474c;

    public pp(Context context, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f27472a = new CheckBoxBase(i10, this, d6Var);
    }

    public final void a(boolean z10, boolean z11) {
        this.f27472a.f(-1, z10, z11);
    }

    public final void b(int i10, int i11, int i12) {
        this.f27472a.h(i10, i11, i12);
    }
    ...
    public boolean getDrawUnchecked() {
        return this.f27472a.f22202z;
    }

    public float getProgress() {
        return this.f27472a.getProgress();
    }

    @Override
    public final void onAttachedToWindow() {
        super.onAttachedToWindow();
        this.f27472a.f22189l = true;
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f27472a.f22189l = false;
    }
    ...
    public final void onDraw(Canvas canvas) {
        if (this.f27473b != null) {
            ...
            Drawable drawable = this.f27473b;
            drawable.setBounds(org.telegram.messenger.ok.z(2, measuredWidth, drawable), org.telegram.messenger.ok.d(2, measuredHeight, this.f27473b), org.telegram.ui.Cells.c1.t(2, measuredWidth, this.f27473b), org.telegram.ui.Cells.c1.d(2, measuredHeight, this.f27473b));
            this.f27473b.draw(canvas);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setChecked(this.f27472a.f22194q);
    }

    @Override
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        super.onLayout(z10, i10, i11, i12, i13);
        this.f27472a.e(0, 0, i12 - i10, i13 - i11);
    }

    public void setCirclePaintProvider(GenericProvider<Void, Paint> genericProvider) {
        CheckBoxBase checkBoxBase = this.f27472a;
