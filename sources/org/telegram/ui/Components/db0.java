...
public final class db0 extends ReplacementSpan {
    ...
    public final KeyEvent.Callback f23582b;
    ...
    public final int getSize(Paint paint, CharSequence charSequence, int i10, int i11, Paint.FontMetricsInt fontMetricsInt) {
        switch (this.f23581a) {
            case 0:
                return ((fb0) this.f23582b).f24135x;
            case 1:
                return (int) ((org.telegram.ui.kj0) this.f23582b).f35091n0;
            default:
                return (int) ((tg.m1) this.f23582b).f43454t0;
        }
    }
