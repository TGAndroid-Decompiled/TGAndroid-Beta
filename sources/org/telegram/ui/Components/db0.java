...
public final class db0 extends ReplacementSpan {
    ...
    public final KeyEvent.Callback f23583b;

    public db0(KeyEvent.Callback callback, int i10) {
        this.f23582a = i10;
        this.f23583b = callback;
    }

    @Override
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        int i15 = this.f23582a;
    }
    ...
    public final int getSize(Paint paint, CharSequence charSequence, int i10, int i11, Paint.FontMetricsInt fontMetricsInt) {
        switch (this.f23582a) {
            case 0:
                return ((fb0) this.f23583b).f24136x;
            case 1:
                return (int) ((org.telegram.ui.kj0) this.f23583b).f35092n0;
            default:
                return (int) ((tg.m1) this.f23583b).f43455t0;
        }
    }
