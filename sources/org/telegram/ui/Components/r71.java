...
public abstract class r71 extends View {
    public static final Object f29969f0 = new Object();
    public q71 E;
    ...
    public long f29970a;
    public final Paint f29971a0;
    public int f29972b;
    public final Paint f29973b0;
    public int f29974c;
    public final e6 f29975c0;
    public float d;
    public final Path f29976d0;
    public float f29977e;
    public boolean f29978e0;
    public float f29979f;
    public boolean h;
    public boolean f29980n;
    public boolean f29981r;
    public float f29982s;
    public float v;
    public boolean f29983w;
    public ParcelFileDescriptor f29984x;
    public MediaMetadataRetriever f29985y;
    ...
    public r71(Context context) {
        ...
        this.f29971a0 = paint5;
        Paint paint6 = new Paint(1);
        this.f29973b0 = paint6;
        this.f29975c0 = new e6(0.0f, this, 0L, 200L, pr.f29470j);
        this.f29976d0 = new Path();
        paint.setColor(-1);
        paint2.setColor(-256);
    ...
    public final void a() {
        Bitmap bitmap;
        synchronized (f29969f0) {
            try {
                ParcelFileDescriptor parcelFileDescriptor = this.f29984x;
            ...
            try {
                MediaMetadataRetriever mediaMetadataRetriever = this.f29985y;
        ...
        for (int i10 = 0; i10 < this.F.size(); i10++) {
            ...
            if (p71Var != null && (bitmap = p71Var.f29315a) != null) {
                bitmap.recycle();
            }
        }
        this.F.clear();
    ...
    public final void d(int i10) {
        float f7;
        int i11;
        if (this.f29985y == null) {
            return;
        }
        if (i10 == 0) {
            this.J = AndroidUtilities.dp(38.0f);
            int i12 = this.f29972b;
            if (i12 != 0 && (i11 = this.f29974c) != 0) {
                f7 = i12 / i11;
            } else {
                f7 = 1.0f;
            }
    ...
    public long getLength() {
        return Math.max(1L, this.f29970a);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float dp2 = AndroidUtilities.dp(10.0f) + dpf2 + ((int) ((measuredWidth - AndroidUtilities.dp(20.0f)) * this.f29977e));
        float dp3 = AndroidUtilities.dp(6.0f);
        float dp4 = dp3 + AndroidUtilities.dp(38.0f);
        ArrayList arrayList = this.F;
        boolean isEmpty = arrayList.isEmpty();
        Path path = this.f29976d0;
            ...
            if (!z10) {
                ...
                while (true) {
                    if (i10 >= arrayList.size()) {
                        break;
                    } else if (((p71) arrayList.get(i10)).f29315a == null) {
                        this.f29978e0 = true;
                        break;
                    } else {
                        i10++;
            ...
            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                ...
                if (bitmap != null) {
                    ...
                    if (f17 != 1.0f) {
                        ...
                        Paint paint = this.Q;
                        paint.setAlpha((int) (pr.h.getInterpolation(p71Var.f29316b) * 255.0f));
        ...
        if (!z11) {
            ...
            canvas2.drawRect(rectF4, this.f29971a0);
            canvas2.restore();
        ...
        float d = this.f29975c0.d(0.0f, false);
        if (d > 0.0f) {
            c(this.f29977e, d, canvas2, paint3);
        }
        c(this.f29982s, 1.0f - d, canvas2, paint3);
        if (this.f29983w) {
            c(this.f29979f, 1.0f, canvas2, this.U);
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent != null) {
            ...
            int dp2 = AndroidUtilities.dp(22.0f) + ((int) (this.f29982s * f7));
            int dp3 = AndroidUtilities.dp(22.0f) + ((int) (this.f29977e * f7));
            if (motionEvent.getAction() == 0) {
                ...
                if (motionEvent.getAction() == 2) {
                    if (this.f29981r) {
                        ...
                        float f18 = this.d;
                        float f19 = this.f29982s;
                        if (f18 > f19) {
                            this.f29982s = f18;
                        } else {
                            float f20 = this.f29977e;
                            if (f20 < f19) {
                                this.f29982s = f20;
                            }
                        }
                        ...
                        if (q71Var7 != null) {
                            ...
                            if (g71Var != null) {
                                ...
                                vVar3.j(1);
                                vVar3.h(f18);
                                photoViewer3.f33656q3.h(0.0f, false);
                        ...
                        float f26 = this.d;
                        float f27 = this.f29982s;
                        if (f26 > f27) {
                            this.f29982s = f26;
                        } else {
                            float f28 = this.f29977e;
                            if (f28 < f27) {
                                this.f29982s = f28;
                            }
                        }
                        q71 q71Var8 = this.E;
                        if (q71Var8 != null) {
                            ((com.google.android.gms.common.api.internal.v) q71Var8).f(this.f29977e);
                        }
                        invalidate();
                        return true;
                    }
    ...
    public void setProgress(float f7) {
        float f10 = 0.0f;
        if (this.f29983w && (f7 <= 0.0f || f7 >= 1.0f)) {
            f7 = this.f29979f;
        }
        long j3 = this.f29970a;
        if (j3 != 0) {
            f10 = 240.0f / ((float) j3);
        }
        float f11 = this.f29982s;
        if (f7 < f11 && f7 <= this.d + f10 && f11 + f10 >= this.f29977e) {
            this.f29975c0.d(1.0f, true);
        }
        this.f29982s = f7;
        invalidate();
    }
    ...
    public void setRightProgress(float f7) {
        ...
        q71 q71Var2 = this.E;
        if (q71Var2 != null) {
            ((com.google.android.gms.common.api.internal.v) q71Var2).f(this.f29977e);
        }
        q71 q71Var3 = this.E;
        if (q71Var3 != null) {
