...
public abstract class r71 extends View {
    public static final Object f27586f0 = new Object();
    public q71 E;
    ...
    public long f27587a;
    public final Paint f27588a0;
    public int f27589b;
    public final Paint f27590b0;
    public int f27591c;
    public final c6 f27592c0;
    public float d;
    public final Path f27593d0;
    public float e;
    public boolean f27594e0;
    public float f27595f;
    public boolean h;
    public boolean f27596n;
    public boolean f27597r;
    public float f27598s;
    public float v;
    public boolean f27599w;
    public ParcelFileDescriptor f27600x;
    public MediaMetadataRetriever f27601y;
    ...
    public r71(Context context) {
        ...
        this.f27588a0 = paint5;
        Paint paint6 = new Paint(1);
        this.f27590b0 = paint6;
        this.f27592c0 = new c6(0.0f, this, 0L, 200L, qr.f27426j);
        this.f27593d0 = new Path();
        paint.setColor(-1);
        paint2.setColor(-256);
    ...
    public final void a() {
        Bitmap bitmap;
        synchronized (f27586f0) {
            try {
                ParcelFileDescriptor parcelFileDescriptor = this.f27600x;
            ...
            try {
                MediaMetadataRetriever mediaMetadataRetriever = this.f27601y;
        ...
        for (int i10 = 0; i10 < this.F.size(); i10++) {
            ...
            if (p71Var != null && (bitmap = p71Var.f26966a) != null) {
                bitmap.recycle();
            }
        }
        this.F.clear();
    ...
    public final void d(int i10) {
        float f7;
        int i11;
        if (this.f27601y == null) {
            return;
        }
        if (i10 == 0) {
            this.J = AndroidUtilities.dp(38.0f);
            int i12 = this.f27589b;
            if (i12 != 0 && (i11 = this.f27591c) != 0) {
                f7 = i12 / i11;
            } else {
                f7 = 1.0f;
            }
    ...
    public long getLength() {
        return Math.max(1L, this.f27587a);
    }
    ...
    public final void onDraw(Canvas canvas) {
            ...
            if (!z10) {
                ...
                while (true) {
                    if (i10 >= arrayList.size()) {
                        break;
                    } else if (((p71) arrayList.get(i10)).f26966a == null) {
                        this.f27594e0 = true;
                        break;
                    } else {
                        i10++;
            ...
            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                ...
                if (bitmap != null) {
                    ...
                    if (f17 != 1.0f) {
                        ...
                        Paint paint = this.Q;
                        paint.setAlpha((int) (qr.h.getInterpolation(p71Var.f26967b) * 255.0f));
        ...
        if (!z11) {
            ...
            canvas2.drawRect(rectF4, this.f27588a0);
            canvas2.restore();
        ...
        float d = this.f27592c0.d(0.0f, false);
        if (d > 0.0f) {
            c(this.e, d, canvas2, paint3);
        }
        c(this.f27598s, 1.0f - d, canvas2, paint3);
        if (this.f27599w) {
            c(this.f27595f, 1.0f, canvas2, this.U);
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent != null) {
            ...
            int dp2 = AndroidUtilities.dp(22.0f) + ((int) (this.f27598s * f7));
                    ...
                    if (this.f27597r) {
                        ...
                        if (q71Var7 != null) {
                            ...
                            if (g71Var != null) {
                                ...
                                vVar3.j(1);
                                vVar3.h(f18);
                                photoViewer3.f31042q3.h(0.0f, false);
                        ...
                        q71 q71Var8 = this.E;
                        if (q71Var8 != null) {
                            ((com.google.android.gms.common.api.internal.v) q71Var8).f(this.e);
                        }
                        invalidate();
                        return true;
                    }
    ...
    public void setProgress(float f7) {
        float f10 = 0.0f;
        if (this.f27599w && (f7 <= 0.0f || f7 >= 1.0f)) {
            f7 = this.f27595f;
        }
        long j3 = this.f27587a;
        if (j3 != 0) {
            f10 = 240.0f / ((float) j3);
        }
        float f11 = this.f27598s;
        if (f7 < f11 && f7 <= this.d + f10 && f11 + f10 >= this.e) {
            this.f27592c0.d(1.0f, true);
        }
        this.f27598s = f7;
        invalidate();
    }
