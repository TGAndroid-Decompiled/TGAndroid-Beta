...
public abstract class r71 extends View {
    public static final Object f29996f0 = new Object();
    public q71 E;
    ...
    public long f29997a;
    public final Paint f29998a0;
    public int f29999b;
    public final Paint f30000b0;
    public int f30001c;
    public final e6 f30002c0;
    public float d;
    public final Path f30003d0;
    public float f30004e;
    public boolean f30005e0;
    ...
    public ParcelFileDescriptor f30011x;
    public MediaMetadataRetriever f30012y;
    ...
    public r71(Context context) {
        ...
        this.f29998a0 = paint5;
        Paint paint6 = new Paint(1);
        this.f30000b0 = paint6;
        this.f30002c0 = new e6(0.0f, this, 0L, 200L, pr.f29497j);
        this.f30003d0 = new Path();
        paint.setColor(-1);
        paint2.setColor(-256);
    ...
    public final void a() {
        Bitmap bitmap;
        synchronized (f29996f0) {
            try {
                ParcelFileDescriptor parcelFileDescriptor = this.f30011x;
            ...
            try {
                MediaMetadataRetriever mediaMetadataRetriever = this.f30012y;
        ...
        for (int i10 = 0; i10 < this.F.size(); i10++) {
            ...
            if (p71Var != null && (bitmap = p71Var.f29342a) != null) {
                bitmap.recycle();
            }
        }
        this.F.clear();
    ...
    public long getLength() {
        return Math.max(1L, this.f29997a);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float dp2 = AndroidUtilities.dp(10.0f) + dpf2 + ((int) ((measuredWidth - AndroidUtilities.dp(20.0f)) * this.f30004e));
        float dp3 = AndroidUtilities.dp(6.0f);
        float dp4 = dp3 + AndroidUtilities.dp(38.0f);
        ArrayList arrayList = this.F;
        boolean isEmpty = arrayList.isEmpty();
        Path path = this.f30003d0;
            ...
            if (!z10) {
                ...
                while (true) {
                    if (i10 >= arrayList.size()) {
                        break;
                    } else if (((p71) arrayList.get(i10)).f29342a == null) {
                        this.f30005e0 = true;
                        break;
                    } else {
                        i10++;
            ...
            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                ...
                if (bitmap != null) {
                    ...
                    if (f17 != 1.0f) {
                        ...
                        Paint paint = this.Q;
                        paint.setAlpha((int) (pr.h.getInterpolation(p71Var.f29343b) * 255.0f));
        ...
        if (!z11) {
            ...
            canvas2.drawRect(rectF4, this.f29998a0);
            canvas2.restore();
        ...
        float d = this.f30002c0.d(0.0f, false);
        if (d > 0.0f) {
            c(this.f30004e, d, canvas2, paint3);
        }
        c(this.f30009s, 1.0f - d, canvas2, paint3);
        if (this.f30010w) {
            c(this.f30006f, 1.0f, canvas2, this.U);
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent != null) {
            ...
            int dp2 = AndroidUtilities.dp(22.0f) + ((int) (this.f30009s * f7));
            int dp3 = AndroidUtilities.dp(22.0f) + ((int) (this.f30004e * f7));
            if (motionEvent.getAction() == 0) {
                ...
                if (motionEvent.getAction() == 2) {
                    if (this.f30008r) {
                        ...
                        this.d = dp8;
                        float f13 = this.f30004e;
                        float f14 = f13 - dp8;
                        float f15 = this.L;
                        if (f14 > f15) {
                            this.f30004e = dp8 + f15;
                        } else {
                            float f16 = this.M;
                            if (f16 != 0.0f && f14 < f16) {
                                float f17 = f13 - f16;
                        ...
                        float f18 = this.d;
                        float f19 = this.f30009s;
                        if (f18 > f19) {
                            this.f30009s = f18;
                        } else {
                            float f20 = this.f30004e;
                            if (f20 < f19) {
                                this.f30009s = f20;
                            }
                        }
                        ...
                        if (q71Var7 != null) {
                            ...
                            if (g71Var != null) {
                                ...
                                vVar3.j(1);
                                vVar3.h(f18);
                                photoViewer3.f33683q3.h(0.0f, false);
                        ...
                        float f26 = this.d;
                        float f27 = this.f30009s;
                        if (f26 > f27) {
                            this.f30009s = f26;
                        } else {
                            float f28 = this.f30004e;
                            if (f28 < f27) {
                                this.f30009s = f28;
                            }
                        }
                        q71 q71Var8 = this.E;
                        if (q71Var8 != null) {
                            ((com.google.android.gms.common.api.internal.v) q71Var8).f(this.f30004e);
                        }
                        invalidate();
                        return true;
                    }
    ...
    public void setProgress(float f7) {
        float f10 = 0.0f;
        if (this.f30010w && (f7 <= 0.0f || f7 >= 1.0f)) {
            f7 = this.f30006f;
        }
        long j3 = this.f29997a;
        if (j3 != 0) {
            f10 = 240.0f / ((float) j3);
        }
        float f11 = this.f30009s;
        if (f7 < f11 && f7 <= this.d + f10 && f11 + f10 >= this.f30004e) {
            this.f30002c0.d(1.0f, true);
        }
        this.f30009s = f7;
        invalidate();
    }
    ...
    public void setRightProgress(float f7) {
        ...
        q71 q71Var2 = this.E;
        if (q71Var2 != null) {
            ((com.google.android.gms.common.api.internal.v) q71Var2).f(this.f30004e);
        }
        q71 q71Var3 = this.E;
        if (q71Var3 != null) {
