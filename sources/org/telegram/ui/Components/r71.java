...
public abstract class r71 extends View {
    public static final Object f27583f0 = new Object();
    public q71 E;
    ...
    public long f27584a;
    public final Paint f27585a0;
    public int f27586b;
    public final Paint f27587b0;
    public int f27588c;
    public final c6 f27589c0;
    public float d;
    public final Path f27590d0;
    public float e;
    public boolean f27591e0;
    public float f27592f;
    public boolean h;
    ...
    public ParcelFileDescriptor f27597x;
    public MediaMetadataRetriever f27598y;
    ...
    public r71(Context context) {
        ...
        this.f27585a0 = paint5;
        Paint paint6 = new Paint(1);
        this.f27587b0 = paint6;
        this.f27589c0 = new c6(0.0f, this, 0L, 200L, qr.f27423j);
        this.f27590d0 = new Path();
        paint.setColor(-1);
        paint2.setColor(-256);
    ...
    public final void a() {
        Bitmap bitmap;
        synchronized (f27583f0) {
            try {
                ParcelFileDescriptor parcelFileDescriptor = this.f27597x;
            ...
            try {
                MediaMetadataRetriever mediaMetadataRetriever = this.f27598y;
        ...
        for (int i10 = 0; i10 < this.F.size(); i10++) {
            ...
            if (p71Var != null && (bitmap = p71Var.f26963a) != null) {
                bitmap.recycle();
            }
        }
        this.F.clear();
    ...
    public final void d(int i10) {
        ...
        if (i10 == 0) {
            ...
            int i12 = this.f27586b;
            if (i12 != 0 && (i11 = this.f27588c) != 0) {
                f7 = i12 / i11;
            } else {
                f7 = 1.0f;
            }
    ...
    public long getLength() {
        return Math.max(1L, this.f27584a);
    }
    ...
    public final void onDraw(Canvas canvas) {
            ...
            if (!z10) {
                ...
                while (true) {
                    if (i10 >= arrayList.size()) {
                        break;
                    } else if (((p71) arrayList.get(i10)).f26963a == null) {
                        this.f27591e0 = true;
                        break;
                    } else {
                        i10++;
            ...
            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                ...
                if (bitmap != null) {
                    ...
                    if (f17 != 1.0f) {
                        ...
                        Paint paint = this.Q;
                        paint.setAlpha((int) (qr.h.getInterpolation(p71Var.f26964b) * 255.0f));
        ...
        if (!z11) {
            ...
            canvas2.drawRect(rectF4, this.f27585a0);
            canvas2.restore();
        ...
        float d = this.f27589c0.d(0.0f, false);
        if (d > 0.0f) {
            c(this.e, d, canvas2, paint3);
        }
        c(this.f27595s, 1.0f - d, canvas2, paint3);
        if (this.f27596w) {
            c(this.f27592f, 1.0f, canvas2, this.U);
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent != null) {
            ...
            int dp2 = AndroidUtilities.dp(22.0f) + ((int) (this.f27595s * f7));
                    ...
                    if (this.f27594r) {
                        ...
                        if (q71Var7 != null) {
                            ...
                            if (g71Var != null) {
                                ...
                                vVar3.j(1);
                                vVar3.h(f18);
                                photoViewer3.f31040q3.h(0.0f, false);
    ...
    public void setProgress(float f7) {
        float f10 = 0.0f;
        if (this.f27596w && (f7 <= 0.0f || f7 >= 1.0f)) {
            f7 = this.f27592f;
        }
        long j3 = this.f27584a;
        if (j3 != 0) {
            f10 = 240.0f / ((float) j3);
        }
        float f11 = this.f27595s;
        if (f7 < f11 && f7 <= this.d + f10 && f11 + f10 >= this.e) {
            this.f27589c0.d(1.0f, true);
        }
        this.f27595s = f7;
        invalidate();
    }
