...
public final class ua0 implements org.telegram.ui.Cells.k1 {
    ...
    public final CharacterStyle E1(org.telegram.ui.Cells.t1 t1Var) {
        wa0 wa0Var = this.f32970a.f33339c;
        if (wa0Var.f34168a == 2) {
    ...
    public final void R0(org.telegram.ui.Cells.t1 t1Var, CharacterStyle characterStyle, boolean z10) {
        va0 va0Var = this.f32970a;
        wa0 wa0Var = va0Var.f33339c;
        if (wa0Var.f34168a == 2 && wa0Var.V.d.currentLink != characterStyle && t1Var.getMessageObject() != null && (characterStyle instanceof URLSpan)) {
            String url = ((URLSpan) characterStyle).getURL();
            cb0 cb0Var = va0Var.f33339c.V;
            ...
            org.telegram.ui.qn qnVar = cb0Var.f27456c;
            if (qnVar != null && url != null) {
                qnVar.Ya(url, true);
            }
            wa0.b(va0Var.f33339c, t1Var);
        }
    }
    ...
    public final org.telegram.ui.Cells.o9 q2() {
        return this.f32970a.f33339c.f34171e;
    }
