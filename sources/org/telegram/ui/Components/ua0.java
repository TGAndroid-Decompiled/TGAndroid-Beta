...
public final class ua0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public TLRPC.InputStickerSet f30866b;
    public final Rect f30867c;
    public q5 d;
    public boolean f30868e;
    public final h90 f30869f;
    public final TextPaint h;
    public final CharSequence f30870n;
    public StaticLayout f30871r;
    public final String f30872s;
    public SpannableStringBuilder v;
    public StaticLayout f30873w;
    public int f30874x;
    public int f30875y;
    ...
    public final int a(int i10, boolean z10) {
        ...
        CharSequence charSequence2 = this.f30870n;
        if (charSequence2 != charSequence || this.F != i10) {
            if (charSequence2 != null) {
                ...
                this.f30871r = staticLayout;
                h90 h90Var = this.f30869f;
                if (h90Var != null && this.O == null) {
                    int lineCount = staticLayout.getLineCount() - 1;
                    this.f30874x = AndroidUtilities.dp(2.0f) + ((int) this.f30871r.getPrimaryHorizontal(charSequence2.length()));
                    this.f30875y = this.f30871r.getLineTop(lineCount);
                    this.E = r3 - this.f30875y;
                    float min = Math.min(AndroidUtilities.dp(100.0f), this.f30871r.getWidth() - this.f30874x);
                    if (this.N == null) {
                        this.N = new Rect();
                    }
                    Rect rect = this.N;
                    int i13 = this.f30874x;
                    rect.set(i13, this.f30875y, (int) (i13 + min), r3);
        ...
        if (spannableStringBuilder != this.I || this.H != i10) {
            if (spannableStringBuilder != null) {
                ...
                i11 = i10;
                this.f30873w = new StaticLayout(spannableStringBuilder2, 0, spannableStringBuilder2.length(), textPaint, i11, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            } else {
                i11 = i10;
                this.f30873w = null;
            }
        ...
        StaticLayout staticLayout2 = this.f30871r;
        if (staticLayout2 != null) {
            i12 = staticLayout2.getHeight();
        }
        StaticLayout staticLayout3 = this.f30873w;
    ...
    public final void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f30865a).addObserver(this, NotificationCenter.groupStickersDidLoad);
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        NotificationCenter.getInstance(this.f30865a).removeObserver(this, NotificationCenter.groupStickersDidLoad);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f30871r != null) {
            ...
            this.f30871r.draw(canvas);
            h90 h90Var = this.f30869f;
            if (h90Var != null && this.f30868e) {
            ...
            if (this.f30873w != null) {
                canvas.save();
                canvas.translate(0.0f, this.f30875y);
                textPaint.setAlpha((int) (this.M * 255.0f));
                this.f30873w.draw(canvas);
                canvas.restore();
            }
            q5 q5Var = this.d;
            if (q5Var != null) {
                q5Var.setAlpha((int) (this.M * 255.0f));
                this.d.setBounds(this.f30867c);
                this.d.draw(canvas);
            }
            canvas.restore();
        }
