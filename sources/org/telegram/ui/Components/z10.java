...
public final class z10 extends FrameLayout implements le.e {
    public final le.c f30760a;
    public final le.c f30761b;
    public final lj0 f30762c;
    public final RadialProgressView d;
    public final org.telegram.ui.ActionBar.d6 e;
    public ArrayList f30763f;
    public final boolean h;
    public final fh.c f30764n;
    public final ch.f f30765r;
    public final ci.f f30766s;
    public float v;
    public float f30767w;
    public boolean f30768x;
    ...
    private void setAdditionalTranslationY(float f7) {
        if (this.v != f7) {
            this.f30768x = true;
            super.setTranslationY(this.f30767w + f7);
            this.f30768x = false;
            this.v = f7;
        }
    }
    ...
    public final void D(int i10, float f7, float f10, le.f fVar) {
        ...
        if (i10 == 0) {
            ...
            float f12 = 1.0f - f7;
            d(this.f30762c, f12);
            ArrayList arrayList = this.f30763f;
            if (arrayList != null) {
    ...
    public final void a(View view) {
        if (this.f30763f == null) {
            this.f30763f = new ArrayList();
        }
        this.f30763f.add(view);
        d(view, 1.0f - this.f30761b.e);
    }

    @Override
    public final void draw(Canvas canvas) {
        ch.f fVar = this.f30765r;
        if (fVar != null) {
            fVar.draw(canvas);
        }
        super.draw(canvas);
    ...
    public final void e(boolean z10, boolean z11) {
        this.f30760a.a(z10, z11);
    }

    public final void f(boolean z10, boolean z11) {
        this.f30761b.a(z10, z11);
    }

    public final void g() {
        boolean z10 = this.h;
        RadialProgressView radialProgressView = this.d;
        lj0 lj0Var = this.f30762c;
        ...
        if (z10) {
            ...
            this.f30764n.a(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19060d6, false));
            this.f30766s.d();
            this.f30765r.v();
            invalidate();
    ...
    public boolean getButtonVisible() {
        return this.f30760a.f14201f;
    }

    public boolean getProgressVisible() {
        return this.f30761b.f14201f;
    }
    ...
    public void setImageResource(int i10) {
        this.f30762c.setImageResource(i10);
    }
    ...
    public z10(Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10) {
        super(context);
        rr rrVar = rr.h;
        this.f30760a = new le.c(0, this, rrVar, 380L, true);
        this.f30761b = new le.c(1, this, rrVar, 380L, false);
        this.e = d6Var;
        this.h = z10;
        ?? imageView = new ImageView(context);
        this.f30762c = imageView;
