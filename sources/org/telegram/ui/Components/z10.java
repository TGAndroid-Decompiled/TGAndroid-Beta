...
public final class z10 extends FrameLayout implements le.e {
    public final le.c f30504a;
    public final le.c f30505b;
    public final bj0 f30506c;
    public final RadialProgressView d;
    public final org.telegram.ui.ActionBar.d6 e;
    public ArrayList f30507f;
    public final boolean h;
    public final fh.c f30508n;
    public final ch.f f30509r;
    public final ci.f f30510s;
    public float v;
    ...
    private void setAdditionalTranslationY(float f7) {
        if (this.v != f7) {
            this.f30512x = true;
            super.setTranslationY(this.f30511w + f7);
            this.f30512x = false;
            this.v = f7;
        }
    }
    ...
    public final void D(int i10, float f7, float f10, le.f fVar) {
        ...
        if (i10 == 0) {
            ...
            float f12 = 1.0f - f7;
            d(this.f30506c, f12);
            ArrayList arrayList = this.f30507f;
            if (arrayList != null) {
    ...
    public final void a(View view) {
        ...
        this.f30507f.add(view);
        d(view, 1.0f - this.f30505b.e);
    }

    @Override
    public final void draw(Canvas canvas) {
        ch.f fVar = this.f30509r;
        if (fVar != null) {
            fVar.draw(canvas);
        }
        super.draw(canvas);
    ...
    public final void e(boolean z10, boolean z11) {
        this.f30504a.a(z10, z11);
    }

    public final void f(boolean z10, boolean z11) {
        this.f30505b.a(z10, z11);
    }

    public final void g() {
        boolean z10 = this.h;
        RadialProgressView radialProgressView = this.d;
        bj0 bj0Var = this.f30506c;
        ...
        if (z10) {
            ...
            this.f30508n.a(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18789d6, false));
            this.f30510s.d();
            this.f30509r.v();
            invalidate();
    ...
    public boolean getButtonVisible() {
        return this.f30504a.f13963f;
    }

    public boolean getProgressVisible() {
        return this.f30505b.f13963f;
    }
    ...
    public void setImageResource(int i10) {
        this.f30506c.setImageResource(i10);
    }
    ...
    public z10(Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10) {
        super(context);
        rr rrVar = rr.h;
        this.f30504a = new le.c(0, this, rrVar, 380L, true);
        this.f30505b = new le.c(1, this, rrVar, 380L, false);
        this.e = d6Var;
        this.h = z10;
        ?? imageView = new ImageView(context);
        this.f30506c = imageView;
        ...
        w7.z5.a(this);
        if (!z10) {
            setOutlineProvider(yf.i0.f46786a);
            setTranslationZ(AndroidUtilities.dpf2(0.5f));
        }
        if (z10) {
            ci.f fVar = new ci.f(org.telegram.ui.ActionBar.h6.f18859h5, null);
            this.f30510s = fVar;
            fh.c cVar = new fh.c();
            this.f30508n = cVar;
