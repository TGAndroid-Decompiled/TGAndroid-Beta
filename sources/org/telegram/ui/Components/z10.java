...
public final class z10 extends FrameLayout implements le.e {
    public final le.c f30749a;
    public final le.c f30750b;
    public final lj0 f30751c;
    public final RadialProgressView d;
    public final org.telegram.ui.ActionBar.d6 e;
    public ArrayList f30752f;
    public final boolean h;
    public final fh.c f30753n;
    public final ch.f f30754r;
    public final ci.f f30755s;
    public float v;
    ...
    private void setAdditionalTranslationY(float f7) {
        if (this.v != f7) {
            this.f30757x = true;
            super.setTranslationY(this.f30756w + f7);
            this.f30757x = false;
            this.v = f7;
        }
    }
    ...
    public final void D(int i10, float f7, float f10, le.f fVar) {
        ...
        if (i10 == 0) {
            ...
            float f12 = 1.0f - f7;
            d(this.f30751c, f12);
            ArrayList arrayList = this.f30752f;
            if (arrayList != null) {
    ...
    public final void a(View view) {
        ...
        this.f30752f.add(view);
        d(view, 1.0f - this.f30750b.e);
    }

    @Override
    public final void draw(Canvas canvas) {
        ch.f fVar = this.f30754r;
        if (fVar != null) {
            fVar.draw(canvas);
        }
        super.draw(canvas);
    ...
    public final void e(boolean z10, boolean z11) {
        this.f30749a.a(z10, z11);
    }

    public final void f(boolean z10, boolean z11) {
        this.f30750b.a(z10, z11);
    }

    public final void g() {
        boolean z10 = this.h;
        RadialProgressView radialProgressView = this.d;
        lj0 lj0Var = this.f30751c;
        ...
        if (z10) {
            ...
            this.f30753n.a(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19045d6, false));
            this.f30755s.d();
            this.f30754r.v();
            invalidate();
    ...
    public boolean getButtonVisible() {
        return this.f30749a.f14186f;
    }

    public boolean getProgressVisible() {
        return this.f30750b.f14186f;
    }
    ...
    public void setImageResource(int i10) {
        this.f30751c.setImageResource(i10);
    }
    ...
    public z10(Context context, org.telegram.ui.ActionBar.d6 d6Var, boolean z10) {
        super(context);
        rr rrVar = rr.h;
        this.f30749a = new le.c(0, this, rrVar, 380L, true);
        this.f30750b = new le.c(1, this, rrVar, 380L, false);
        this.e = d6Var;
        this.h = z10;
        ?? imageView = new ImageView(context);
        this.f30751c = imageView;
        ...
        w7.a6.a(this);
        if (!z10) {
            setOutlineProvider(yf.i0.f47100a);
            setTranslationZ(AndroidUtilities.dpf2(0.5f));
        }
        if (z10) {
            ci.f fVar = new ci.f(org.telegram.ui.ActionBar.h6.f19115h5, null);
            this.f30755s = fVar;
            fh.c cVar = new fh.c();
            this.f30753n = cVar;
