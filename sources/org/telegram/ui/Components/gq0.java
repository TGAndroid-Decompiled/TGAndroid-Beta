...
public final class gq0 extends bw0 {
    ...
    public final e6 G0;
    public final vq0 H0;
    public boolean f24470w0;
    public final RectF f24471x0;
    public boolean f24472y0;
    public int f24473z0;
    ...
    public gq0(vq0 vq0Var, Context context) {
        ...
        this.H0 = vq0Var;
        this.f24470w0 = false;
        this.f24471x0 = new RectF();
        this.H = new fq0(this, this);
        this.F0 = AndroidUtilities.computePerceivedBrightness(vq0Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19133h5)) > 0.721f;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        canvas.save();
        canvas.clipRect(0.0f, getPaddingTop() + vq0Var.f29736t0, getMeasuredWidth(), getMeasuredHeight() + vq0Var.f29736t0 + AndroidUtilities.dp(50.0f));
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (view instanceof kz) {
            ...
            if (vq0Var.V0 != null) {
                ...
                canvas.clipPath(vq0Var.V0.f4288j.f4277k);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        FrameLayout frameLayout = vq0Var.f29739w;
        canvas.translate(0.0f, vq0Var.f29736t0);
        int i17 = vq0Var.f29730p0;
        i10 = ((org.telegram.ui.ActionBar.f3) vq0Var).backgroundPaddingTop;
        int dp2 = AndroidUtilities.dp(6.0f) + (i17 - i10) + this.f24473z0;
        int i18 = vq0Var.f29730p0;
        i11 = ((org.telegram.ui.ActionBar.f3) vq0Var).backgroundPaddingTop;
        int dp3 = ((i18 - i11) - AndroidUtilities.dp(13.0f)) + this.f24473z0;
        vq0Var.X = dp3;
        ...
        boolean z13 = true;
        if (!z10) {
            dp2 += vq0Var.G0.f10592b;
            if (this.f24472y0) {
                i16 = ((org.telegram.ui.ActionBar.f3) vq0Var).backgroundPaddingTop;
                if (i16 + dp3 < vq0Var.G0.f10592b) {
                    z12 = true;
                    int i20 = dp3 + vq0Var.G0.f10592b;
            ...
            z12 = false;
            int i202 = dp3 + vq0Var.G0.f10592b;
            i15 = ((org.telegram.ui.ActionBar.f3) vq0Var).backgroundPaddingTop;
            f7 = this.G0.e(z12);
        ...
        if (frameLayout != null) {
            if (dp3 > vq0Var.G0.f10592b || frameLayout.getChildCount() <= 0) {
        ...
        if (f7 < 1.0f) {
            ...
            RectF rectF = this.f24471x0;
            rectF.set((getMeasuredWidth() - dp) / 2, f10, measuredWidth, dp5);
            org.telegram.ui.ActionBar.j6.f19351t0.setColor(vq0Var.getThemedColor(org.telegram.ui.ActionBar.j6.Ii));
            org.telegram.ui.ActionBar.j6.f19351t0.setAlpha((int) ((1.0f - f7) * paint.getAlpha()));
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            if (this.F0 && 0 > vq0Var.G0.f10592b * 0.5f) {
                z11 = true;
            } else {
                z11 = false;
            }
        ...
        canvas.restore();
        this.A0 = this.f24473z0;
    }

    @Override
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        boolean z10 = this.f24472y0;
        vq0 vq0Var = this.H0;
        if (!z10) {
            if (motionEvent.getAction() == 0 && motionEvent.getY() < this.f24473z0 - AndroidUtilities.dp(30.0f)) {
                vq0Var.dismiss();
                return true;
            }
        } else if (motionEvent.getAction() == 0 && vq0Var.f29730p0 != 0 && motionEvent.getY() < vq0Var.f29730p0 - AndroidUtilities.dp(30.0f)) {
            vq0Var.dismiss();
            return true;
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ozVar.G = z11;
        z12 = ((org.telegram.ui.ActionBar.f3) vq0Var).isFullscreen;
        if (!z12) {
            gq0Var.f24470w0 = true;
            i20 = ((org.telegram.ui.ActionBar.f3) vq0Var).backgroundPaddingLeft;
            int i23 = vq0Var.G0.f10592b;
            i21 = ((org.telegram.ui.ActionBar.f3) vq0Var).backgroundPaddingLeft;
            gq0Var.setPadding(i20, i23, i21, 0);
            gq0Var.f24470w0 = false;
        }
        int paddingTop = size - gq0Var.getPaddingTop();
        int max = Math.max(vq0Var.M.h(), vq0Var.K.h() - 1);
        int c10 = org.telegram.messenger.wh.c(103.0f, Math.max(2, (int) Math.ceil(max / 4.0f)), AndroidUtilities.dp(48.0f) + AndroidUtilities.dp(103.0f));
        i12 = ((org.telegram.ui.ActionBar.f3) vq0Var).backgroundPaddingTop;
        int i24 = i12 + c10;
        if (wl0Var.getVisibility() != 8) {
            int dp = AndroidUtilities.dp(103.0f);
            int c11 = org.telegram.messenger.wh.c(103.0f, Math.max(2, (int) Math.ceil((vq0Var.L.h() - 1) / 4.0f)), AndroidUtilities.dp(48.0f) + dp);
            i19 = ((org.telegram.ui.ActionBar.f3) vq0Var).backgroundPaddingTop;
            int i25 = i19 + c11;
            if (i25 > i24) {
        ...
        z13 = ((org.telegram.ui.ActionBar.f3) vq0Var).keyboardVisible;
        ...
        FrameLayout frameLayout2 = vq0Var.f29732r;
        aq0 aq0Var = vq0Var.d;
        int i27 = size2 - (i16 * 2);
        int R = gq0Var.R();
        vq0Var.N0 = R;
        ...
        if (vq0Var.N0 <= AndroidUtilities.dp(20.0f)) {
            if (!AndroidUtilities.isInMultiwindow) {
                z15 = ((org.telegram.ui.ActionBar.f3) vq0Var).keyboardVisible;
                if (z15) {
                    emojiPadding = 0;
                } else {
            ...
            if (childAt != null && childAt.getVisibility() != i17) {
                if (aq0Var.l(childAt)) {
                    if (!AndroidUtilities.isInMultiwindow && !AndroidUtilities.isTablet()) {
                        ...
                        childAt.measure(View.MeasureSpec.makeMeasureSpec(i27, 1073741824), View.MeasureSpec.makeMeasureSpec(Math.min(AndroidUtilities.dp(200.0f), gq0Var.getPaddingTop() + (i29 - vq0Var.G0.f10592b)), 1073741824));
                    } else {
                        childAt.measure(View.MeasureSpec.makeMeasureSpec(i27, 1073741824), View.MeasureSpec.makeMeasureSpec(gq0Var.getPaddingTop() + (i29 - vq0Var.G0.f10592b), 1073741824));
                    }
                } else {
