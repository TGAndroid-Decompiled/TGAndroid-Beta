...
public final class bl0 extends View {
    ...
    public final Drawable f25637a0;
    public final RectF f25638b;
    public qg.b f25639b0;
    public final Paint f25640c;
    public qg.b f25641c0;
    public final Paint d;
    public final boolean f25642d0;
    public float f25643e;
    public int f25644e0;
    public float f25645f;
    public final m2.b f25646f0;
    public float f25647g0;
    public float h;
    public boolean f25648h0;
    public long f25649i0;
    public float f25650j0;
    public float f25651k0;
    public final sl0 f25652l0;
    public boolean f25653n;
    public StaticLayout f25654r;
    public StaticLayout f25655s;
    public StaticLayout v;
    public StaticLayout f25656w;
    public StaticLayout f25657x;
    ...
    public bl0(sl0 sl0Var, Context context, int i10) {
        ...
        float f10;
        float f11;
        org.telegram.ui.ActionBar.g6 g6Var = sl0Var.f31106m2;
        this.f25652l0 = sl0Var;
        this.f25636a = true;
        this.f25638b = new RectF();
        this.f25640c = new Paint(1);
        ...
        this.I = new float[8];
        this.T = new int[2];
        this.f25646f0 = new m2.b(this, 29);
        this.f25651k0 = 1.0f;
        this.O = i10;
        if (i10 == 0) {
            textPaint.setTextSize(AndroidUtilities.dp(45.0f));
            this.f25642d0 = LocaleController.isRTL;
        } else {
            this.f25642d0 = false;
            textPaint.setTextSize(AndroidUtilities.dp(13.0f));
            textPaint.setTypeface(AndroidUtilities.bold());
            int i12 = org.telegram.ui.ActionBar.k6.f21661d6;
            paint.setColor(org.telegram.ui.ActionBar.k6.v0(i12, g6Var));
            Drawable mutate = context.getDrawable(R.drawable.calendar_date).mutate();
            this.f25637a0 = mutate;
            mutate.setColorFilter(new PorterDuffColorFilter(i0.a.d(0.1f, org.telegram.ui.ActionBar.k6.v0(i12, g6Var), -1), PorterDuff.Mode.MULTIPLY));
        }
        ...
        if (layoutManager instanceof f2.j0) {
            ...
            if (j0Var.f5816o == 1) {
                ...
                if (adapter instanceof cl0) {
                    ...
                    float f10 = this.f25643e;
                    int[] iArr = this.T;
                    cl0Var.G(sl0Var, f10, iArr);
                    if (z4) {
                        j0Var.h1(iArr[0], (-iArr[1]) + sl0Var.f31119t1);
                    }
                    String F = cl0Var.F(iArr[0]);
                    if (F == null) {
                        StaticLayout staticLayout = this.f25654r;
                        if (staticLayout != null) {
                            this.f25655s = staticLayout;
                        }
                        this.f25654r = null;
                        ...
                        if (i10 == 0) {
                            this.f25654r = new StaticLayout(F, textPaint, 1000, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                        } else {
                            this.v = this.f25654r;
                            int measureText = ((int) textPaint.measureText(F)) + 1;
                            Layout.Alignment alignment = Layout.Alignment.ALIGN_NORMAL;
                            this.f25654r = new StaticLayout(F, textPaint, measureText, alignment, 1.0f, 0.0f, false);
                            if (this.v != null) {
                                ...
                                if (split != null && split2 != null && split.length == 2 && split2.length == 2 && split[1].equals(split2[1])) {
                                    ...
                                    this.f25656w = new StaticLayout(spannableStringBuilder2, textPaint, measureText, alignment, 1.0f, 0.0f, false);
                                    ...
                                    this.f25657x = new StaticLayout(spannableStringBuilder3, textPaint, measureText, alignment, 1.0f, 0.0f, false);
                                } else {
                                    this.f25656w = this.f25654r;
                                    this.f25657x = null;
                                }
                        ...
                        this.f25655s = null;
                        if (this.f25654r.getLineCount() > 0) {
                            this.f25654r.getLineWidth(0);
                            this.f25654r.getLineLeft(0);
                            if (this.f25642d0) {
                                this.J = (((AndroidUtilities.dp(88.0f) - this.f25654r.getLineWidth(0)) / 2.0f) + AndroidUtilities.dp(10.0f)) - this.f25654r.getLineLeft(0);
                            } else {
                                this.J = ((AndroidUtilities.dp(88.0f) - this.f25654r.getLineWidth(0)) / 2.0f) - this.f25654r.getLineLeft(0);
                            }
                            this.K = (AndroidUtilities.dp(88.0f) - this.f25654r.getHeight()) / 2;
                        }
                    }
                }
            }
    ...
    public final void c() {
        ...
        int i10 = this.O;
        if (i10 == 0) {
            k10 = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21824m7, sl0Var.f31106m2);
        } else {
            k10 = i0.a.k(-16777216, 102);
        }
        this.P = k10;
        this.Q = org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21806l7, sl0Var.f31106m2);
        this.f25640c.setColor(this.P);
        TextPaint textPaint = this.E;
        if (i10 == 0) {
            textPaint.setColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21842n7, sl0Var.f31106m2));
        } else {
            textPaint.setColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.G6, sl0Var.f31106m2));
        }
        invalidate();
    }
    ...
    public int getScrollBarY() {
        return AndroidUtilities.dp(17.0f) + ((int) Math.ceil((getMeasuredHeight() - AndroidUtilities.dp(54.0f)) * this.f25643e));
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int ceil = i10 + ((int) Math.ceil(((getMeasuredHeight() - i10) - AndroidUtilities.dp(54.0f)) * this.f25643e));
        int i13 = this.N;
        float f18 = i13;
        RectF rectF = this.f25638b;
        rectF.set(f18, AndroidUtilities.dp(12.0f) + ceil, AndroidUtilities.dp(5.0f) + i13, AndroidUtilities.dp(42.0f) + ceil);
        int i14 = this.O;
        Paint paint = this.f25640c;
        if (i14 == 0) {
            f10 = 12.0f;
            f11 = 36.0f;
            ...
            sl0 sl0Var = this.f25652l0;
            f12 = 8.0f;
            paint.setColor(i0.a.d(0.1f, org.telegram.ui.ActionBar.k6.v0(i15, sl0Var.f31106m2), -1));
            float dp3 = AndroidUtilities.dp(27.0f) + ceil;
            qg.b bVar = this.f25639b0;
            if (bVar != null) {
                c3 = 2;
                f13 = 24.0f;
            ...
            paint.setColor(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.G6, sl0Var.f31106m2));
            canvas.save();
        ...
        if (i14 == 0) {
        ...
        } else if (i14 == 1 && this.f25654r != null && this.S != 0.0f) {
            canvas.save();
            ...
            this.f25654r.getHeight();
            AndroidUtilities.dp(6.0f);
            rectF.set((dp6 - (((1.0f - this.f25658y) * this.D) + (this.f25658y * this.f25654r.getWidth()))) - AndroidUtilities.dp(f11), (centerY - (this.f25654r.getHeight() / 2.0f)) - AndroidUtilities.dp(f12), dp6 - AndroidUtilities.dp(f10), (this.f25654r.getHeight() / 2.0f) + centerY + AndroidUtilities.dp(f12));
            Paint paint2 = this.d;
            int alpha = paint2.getAlpha();
            TextPaint textPaint = this.E;
            int alpha2 = textPaint.getAlpha();
            paint2.setAlpha((int) (alpha * this.S));
            if (this.f25641c0 != null) {
                Rect rect = AndroidUtilities.rectTmp2;
                rectF.round(rect);
                rect.inset(-AndroidUtilities.dp(f14), -AndroidUtilities.dp(f14));
                this.f25641c0.setBounds(rect);
                this.f25641c0.draw(canvas);
            } else {
                Drawable drawable2 = this.f25637a0;
                drawable2.setBounds((int) rectF.left, (int) rectF.top, (int) rectF.right, (int) rectF.bottom);
                drawable2.setAlpha((int) (this.S * 255.0f));
                drawable2.draw(canvas);
            }
            float f21 = this.f25658y;
            if (f21 != 1.0f) {
            ...
            if (this.f25658y != 1.0f) {
                canvas.save();
                rectF.inset(AndroidUtilities.dp(f14), AndroidUtilities.dp(2.0f));
                canvas.clipRect(rectF);
                if (this.v != null) {
                    textPaint.setAlpha((int) ((1.0f - this.f25658y) * alpha2 * this.S));
                    canvas.save();
                    ...
                    canvas.translate(width, (AndroidUtilities.dp(15.0f) * i12 * this.f25658y) + height);
                    this.v.draw(canvas);
                    canvas.restore();
                }
                if (this.f25656w != null) {
                    textPaint.setAlpha((int) (alpha2 * this.S * this.f25658y));
                    canvas.save();
                    float width2 = (dp6 - this.f25656w.getWidth()) - AndroidUtilities.dp(f13);
                    float height2 = centerY - (this.f25656w.getHeight() / 2.0f);
                    if (this.B) {
                        i11 = 1;
                    } else {
                        i11 = -1;
                    }
                    canvas.translate(width2, e2.c.w(1.0f, this.f25658y, AndroidUtilities.dp(15.0f) * i11, height2));
                    this.f25656w.draw(canvas);
                    canvas.restore();
                }
                if (this.f25657x != null) {
                    textPaint.setAlpha((int) (alpha2 * this.S));
                    canvas.save();
                    canvas.translate((dp6 - this.f25657x.getWidth()) - AndroidUtilities.dp(f13), centerY - (this.f25657x.getHeight() / 2.0f));
                    this.f25657x.draw(canvas);
                    canvas.restore();
                }
                canvas.restore();
            } else {
                textPaint.setAlpha((int) (alpha2 * this.S));
                canvas.save();
                canvas.translate((dp6 - this.f25654r.getWidth()) - AndroidUtilities.dp(f13), e2.c.w(1.0f, this.f25658y, AndroidUtilities.dp(15.0f), centerY - (this.f25654r.getHeight() / 2.0f)));
                this.f25654r.draw(canvas);
                canvas.restore();
            }
        ...
        boolean z10 = this.f25648h0;
        if ((z10 && this.f25654r != null && this.L < 1.0f) || ((!z10 || this.f25654r == null) && this.L > 0.0f)) {
            this.M = currentTimeMillis;
            invalidate();
            if (this.f25648h0 && this.f25654r != null) {
    ...
    public void setAlpha(float f10) {
        if (this.f25651k0 != f10) {
            this.f25651k0 = f10;
            super.setAlpha(f10 * this.f25650j0);
        }
    }
    ...
    public void setIsVisible(boolean z4) {
        ...
        if (this.U != z4) {
            ...
            this.f25650j0 = f10;
            super.setAlpha(this.f25651k0 * f10);
        }
    }
