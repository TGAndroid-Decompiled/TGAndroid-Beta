...
public final class f6 {
    ...
    public final TextPaint f23793c;
    public ObjectAnimator d;
    public final org.telegram.ui.Cells.t1 f23795g;
    public final ArrayList f23791a = new ArrayList();
    ...
    public final void b(int i10, boolean z10) {
        ...
        ArrayList arrayList2 = this.f23791a;
        ...
        ArrayList arrayList3 = this.f23792b;
        arrayList3.clear();
        arrayList3.addAll(arrayList2);
        arrayList2.clear();
        Locale locale = Locale.US;
        int i12 = this.f23794f;
        ...
        while (i13 < sb5.length()) {
            ...
            if (str != null && str.equals(substring)) {
                ...
                arrayList = arrayList3;
                arrayList2.add(new StaticLayout(substring, this.f23793c, (int) Math.ceil(textPaint.measureText(substring)), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false));
            }
            i13 = i14;
