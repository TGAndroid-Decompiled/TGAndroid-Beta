...
public final class b40 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ai.x5 e;
    public org.telegram.ui.hk f22879f;
    public FrameLayout h;
    public y30 f22880n;
    public gg.n1 f22881r;
    public FrameLayout f22882s;
    public TextView v;
    public float f22883w;
    public ValueAnimator f22884x;
    ...
    public b40(String str, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        if (indexOf > 0) {
            this.f22877b = trim.substring(0, indexOf);
            this.f22878c = trim.substring(indexOf + 1);
        } else {
            this.f22877b = trim;
            this.f22878c = null;
        }
        ...
        if (!TextUtils.isEmpty(this.f22878c)) {
            str2 = "@" + this.f22878c;
        }
        sb2.append(str2);
        this.f22876a = sb2.toString();
        this.d = new ai.v8(this.currentAccount, this.f22878c, this.f22877b);
    }
    ...
    public final void U(boolean z10, boolean z11) {
        ...
        if (!z11) {
            ...
            org.telegram.ui.hk hkVar = this.f22879f;
            if (hkVar != null && (aoVar = hkVar.f32501a) != null && (w0Var = aoVar.L3) != null) {
                w0Var.setScaleX(AndroidUtilities.lerp(1.0f, 0.95f, this.E));
                this.f22879f.f32501a.L3.setScaleY(AndroidUtilities.lerp(1.0f, 0.95f, this.E));
            }
        } else if (this.f22885y == z10) {
        } else {
            this.f22885y = z10;
    ...
    public final void V(boolean z10, boolean z11) {
        ...
        float f10;
        int i11;
        this.f22881r.animate().cancel();
        ValueAnimator valueAnimator = this.f22884x;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        float f11 = 0.0f;
        if (!z11) {
            gg.n1 n1Var = this.f22881r;
            if (z10) {
                i10 = 0;
            } else {
                i10 = 8;
        ...
        this.f22881r.setVisibility(0);
        ViewPropertyAnimator animate = this.f22881r.animate();
        if (z10) {
            f7 = 0.0f;
        } else {
        ...
        float f12 = this.f22883w;
        if (z10) {
            f11 = 1.0f;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(f12, f11);
        this.f22884x = ofFloat;
        ofFloat.addUpdateListener(new z30(this, 0));
        this.f22884x.addListener(new a40(this, z10, 0));
        this.f22884x.setDuration(320L);
        this.f22884x.setInterpolator(qrVar);
        this.f22884x.start();
    }
    ...
    public final View createView(Context context) {
        ...
        this.actionBar.A(getThemedColor(org.telegram.ui.ActionBar.j6.f19409u8), false);
        ...
        y30 y30Var = new y30(this, context, new bv0(null), this, new Object(), this.resourceProvider);
        this.f22880n = y30Var;
        if (y30Var.getSearchOptionsItem() != null) {
            this.f22880n.getSearchOptionsItem().setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i11, this.resourceProvider), PorterDuff.Mode.SRC_IN));
        }
        this.f22880n.setPinnedToTop(true);
        this.f22880n.f25518r0.setTranslationY(0.0f);
        if (this.f22880n.getSearchOptionsItem() != null) {
            this.f22880n.getSearchOptionsItem().setTranslationY(0.0f);
        }
        this.f22880n.setBackgroundColor(getThemedColor(i10));
        y30 y30Var2 = this.f22880n;
        ai.v8 v8Var = this.d;
        y30Var2.T1 = v8Var;
        rt0 rt0Var = y30Var2.f25486c0;
        rt0Var.f24460s = v8Var;
        rt0Var.l();
        gv0 gv0Var = y30Var2.f25489d0;
        gv0Var.f24460s = v8Var;
        gv0Var.l();
        FrameLayout frameLayout2 = new FrameLayout(context);
        this.h = frameLayout2;
        frameLayout2.setBackgroundColor(getThemedColor(i10));
        this.h.addView(this.f22880n, w7.y5.d(-1, -1.0f, 119, 0.0f, 0.0f, 0.0f, 49.0f));
        FrameLayout frameLayout3 = new FrameLayout(context);
        this.f22882s = frameLayout3;
        frameLayout3.setBackgroundColor(getThemedColor(i10));
        TextView textView = new TextView(context);
        this.v = textView;
        textView.setTypeface(AndroidUtilities.bold());
        this.v.setTextSize(1, 15.0f);
        this.v.setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19485ye));
        this.v.setText(LocaleController.formatPluralString("FoundStories", v8Var.J, new Object[0]));
        this.f22882s.addView(this.v, w7.y5.d(-1, -2.0f, 19, 18.0f, 0.0f, 18.0f, 0.0f));
        View view = new View(context);
        view.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19095d7, this.resourceProvider));
        this.f22882s.addView(view, w7.y5.a(-1.0f, 1.0f / AndroidUtilities.density, 55));
        this.h.addView(this.f22882s, w7.y5.e(-1, 49, 87));
        this.e.addView(this.h, w7.y5.e(-1, -1, 119));
        gg.n1 n1Var = new gg.n1(context, this.resourceProvider);
        this.f22881r = n1Var;
        n1Var.setBackground(org.telegram.ui.ActionBar.j6.g0(getThemedColor(i10), getThemedColor(org.telegram.ui.ActionBar.j6.f19184i6)));
        this.f22881r.setOnClickListener(new f0(this, 25));
        V(this.f22881r.a(v8Var), false);
        this.f22881r.b(HashtagSearchController.getInstance(this.currentAccount).getCount(3), this.f22877b, this.f22878c);
        frameLayout.addView(this.f22881r, w7.y5.e(-1, 48, 55));
        U(false, false);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        } else if (i10 == NotificationCenter.hashtagSearchUpdated && (hkVar = this.f22879f) != null && hkVar.f32501a != null && ((Integer) objArr[0]).intValue() == this.f22879f.f32501a.getClassGuid()) {
            int intValue = ((Integer) objArr[1]).intValue();
            gg.n1 n1Var2 = this.f22881r;
            if (n1Var2 != null) {
                n1Var2.b(intValue, this.f22877b, this.f22878c);
            }
        }
    }
