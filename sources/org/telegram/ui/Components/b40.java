...
public final class b40 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ai.x5 e;
    public org.telegram.ui.ik f22842f;
    public FrameLayout h;
    public y30 f22843n;
    public gg.n1 f22844r;
    public FrameLayout f22845s;
    public TextView v;
    public float f22846w;
    public ValueAnimator f22847x;
    ...
    public b40(String str, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        if (indexOf > 0) {
            this.f22840b = trim.substring(0, indexOf);
            this.f22841c = trim.substring(indexOf + 1);
        } else {
            this.f22840b = trim;
            this.f22841c = null;
        }
        ...
        this.d = new ai.v8(this.currentAccount, this.f22841c, this.f22840b);
    }
    ...
    public final void U(boolean z10, boolean z11) {
        ...
        if (!z11) {
            ...
            org.telegram.ui.ik ikVar = this.f22842f;
            if (ikVar != null && (aoVar = ikVar.f32521a) != null && (w0Var = aoVar.L3) != null) {
                w0Var.setScaleX(AndroidUtilities.lerp(1.0f, 0.95f, this.E));
                this.f22842f.f32521a.L3.setScaleY(AndroidUtilities.lerp(1.0f, 0.95f, this.E));
            }
        } else if (this.f22848y == z10) {
        } else {
            this.f22848y = z10;
    ...
    public final void V(boolean z10, boolean z11) {
        ...
        float f10;
        int i11;
        this.f22844r.animate().cancel();
        ValueAnimator valueAnimator = this.f22847x;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        float f11 = 0.0f;
        if (!z11) {
            gg.n1 n1Var = this.f22844r;
            if (z10) {
                i10 = 0;
            } else {
                i10 = 8;
        ...
        this.f22844r.setVisibility(0);
        ViewPropertyAnimator animate = this.f22844r.animate();
        if (z10) {
            f7 = 0.0f;
        } else {
        ...
        float f12 = this.f22846w;
        if (z10) {
            f11 = 1.0f;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(f12, f11);
        this.f22847x = ofFloat;
        ofFloat.addUpdateListener(new z30(this, 0));
        this.f22847x.addListener(new a40(this, z10, 0));
        this.f22847x.setDuration(320L);
        this.f22847x.setInterpolator(qrVar);
        this.f22847x.start();
    }
    ...
    public final View createView(Context context) {
        ...
        this.actionBar.A(getThemedColor(org.telegram.ui.ActionBar.j6.f19424u8), false);
        ...
        y30 y30Var = new y30(this, context, new dv0(null), this, new Object(), this.resourceProvider);
        this.f22843n = y30Var;
        if (y30Var.getSearchOptionsItem() != null) {
            this.f22843n.getSearchOptionsItem().setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i11, this.resourceProvider), PorterDuff.Mode.SRC_IN));
        }
        this.f22843n.setPinnedToTop(true);
        this.f22843n.f26224r0.setTranslationY(0.0f);
        if (this.f22843n.getSearchOptionsItem() != null) {
            this.f22843n.getSearchOptionsItem().setTranslationY(0.0f);
        }
        this.f22843n.setBackgroundColor(getThemedColor(i10));
        y30 y30Var2 = this.f22843n;
        ai.v8 v8Var = this.d;
        y30Var2.T1 = v8Var;
        tt0 tt0Var = y30Var2.f26192c0;
        tt0Var.f25184s = v8Var;
        tt0Var.l();
        iv0 iv0Var = y30Var2.f26195d0;
        iv0Var.f25184s = v8Var;
        iv0Var.l();
        FrameLayout frameLayout2 = new FrameLayout(context);
        this.h = frameLayout2;
        frameLayout2.setBackgroundColor(getThemedColor(i10));
        this.h.addView(this.f22843n, w7.y5.d(-1, -1.0f, 119, 0.0f, 0.0f, 0.0f, 49.0f));
        FrameLayout frameLayout3 = new FrameLayout(context);
        this.f22845s = frameLayout3;
        frameLayout3.setBackgroundColor(getThemedColor(i10));
        TextView textView = new TextView(context);
        this.v = textView;
        textView.setTypeface(AndroidUtilities.bold());
        this.v.setTextSize(1, 15.0f);
        this.v.setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19500ye));
        this.v.setText(LocaleController.formatPluralString("FoundStories", v8Var.J, new Object[0]));
        this.f22845s.addView(this.v, w7.y5.d(-1, -2.0f, 19, 18.0f, 0.0f, 18.0f, 0.0f));
        View view = new View(context);
        view.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19110d7, this.resourceProvider));
        this.f22845s.addView(view, w7.y5.a(-1.0f, 1.0f / AndroidUtilities.density, 55));
        this.h.addView(this.f22845s, w7.y5.e(-1, 49, 87));
        this.e.addView(this.h, w7.y5.e(-1, -1, 119));
        gg.n1 n1Var = new gg.n1(context, this.resourceProvider);
        this.f22844r = n1Var;
        n1Var.setBackground(org.telegram.ui.ActionBar.j6.g0(getThemedColor(i10), getThemedColor(org.telegram.ui.ActionBar.j6.f19199i6)));
        this.f22844r.setOnClickListener(new f0(this, 25));
        V(this.f22844r.a(v8Var), false);
        this.f22844r.b(HashtagSearchController.getInstance(this.currentAccount).getCount(3), this.f22840b, this.f22841c);
        frameLayout.addView(this.f22844r, w7.y5.e(-1, 48, 55));
        U(false, false);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        } else if (i10 == NotificationCenter.hashtagSearchUpdated && (ikVar = this.f22842f) != null && ikVar.f32521a != null && ((Integer) objArr[0]).intValue() == this.f22842f.f32521a.getClassGuid()) {
            int intValue = ((Integer) objArr[1]).intValue();
            gg.n1 n1Var2 = this.f22844r;
            if (n1Var2 != null) {
                n1Var2.b(intValue, this.f22840b, this.f22841c);
            }
        }
    }
