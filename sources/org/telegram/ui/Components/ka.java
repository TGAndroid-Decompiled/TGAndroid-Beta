...
public final class ka extends View {
    public final Paint f28351a;
    public float f28352b;
    public int f28353c;
    public int d;
    public final RectF f28354e;
    public final m2.h f28355f;
    public final int h;
    public int f28356n;
    public int f28357r;
    ...
    public ka(Context context, m2.h hVar, int i10) {
        super(context);
        this.f28351a = new Paint(1);
        new DecelerateInterpolator();
        this.f28354e = new RectF();
        this.f28356n = -1;
        this.f28357r = -1;
        this.f28355f = hVar;
        this.h = i10;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int i11 = this.f28356n;
        Paint paint = this.f28351a;
        if (i11 >= 0) {
        ...
        this.d = this.f28355f.getCurrentItem();
        int i12 = 0;
        while (true) {
            int i13 = this.h;
            rectF = this.f28354e;
        ...
        if (this.f28352b != 0.0f) {
            if (this.f28353c >= this.d) {
                rectF.set(dp2, 0.0f, (AndroidUtilities.dp(11.0f) * this.f28352b) + AndroidUtilities.dp(5.0f) + dp2, AndroidUtilities.dp(5.0f));
            } else {
                rectF.set(org.telegram.ui.yh.c(1.0f, this.f28352b, AndroidUtilities.dp(11.0f), dp2), 0.0f, AndroidUtilities.dp(5.0f) + dp2, AndroidUtilities.dp(5.0f));
            }
        } else {
