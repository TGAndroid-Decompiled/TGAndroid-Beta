...
public final class z70 {
    ...
    public boolean Y;
    public boolean Z;
    public final ViewGroup f30808a;
    public float f30809a0;
    public ViewGroup f30810b;
    public float f30811b0;
    public final org.telegram.ui.ActionBar.m2 f30812c;
    public boolean f30813c0;
    public final org.telegram.ui.ActionBar.d6 d;
    public boolean f30814d0;
    public final Context e;
    public View f30815e0;
    public final View f30816f;
    public p70 f30817f0;
    public Drawable f30818g;
    public q70 f30819g0;
    public int h;
    public final int[] f30820h0;
    public int f30821i;
    public Integer f30822i0;
    public boolean f30823j;
    public Integer f30824j0;
    public int f30825k;
    public Integer f30826k0;
    public int f30827l;
    public Integer f30828l0;
    public u70 f30829m;
    public ValueAnimator m0;
    public fh.b f30830n;
    public boolean f30831n0;
    public final float[] f30832o;
    public xr f30833o0;
    public Runnable f30834p;
    public View f30835p0;
    public float f30836q;
    public final int[] f30837q0;
    public float f30838r;
    public int f30839s;
    ...
    public x70 f30843x;
    public tt f30844y;
    public final Rect f30845z;

    public z70(org.telegram.ui.ActionBar.m2 m2Var, View view, boolean z10, boolean z11) {
        org.telegram.ui.ActionBar.b5 parentLayout;
        this.f30821i = 5;
        this.f30832o = new float[2];
        this.f30840t = true;
        this.f30842w = true;
        this.f30845z = new Rect();
        this.J = true;
        this.K = -4;
        this.f30820h0 = new int[2];
        this.f30837q0 = new int[2];
        ...
        this.f30816f = view;
        this.f30839s = ((double) AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19059d6, resourceProvider))) > 0.705d ? 102 : 51;
        this.E = z10;
        this.G = z11;
        this.F = false;
        B();
    ...
    public static z70 F(ViewGroup viewGroup, org.telegram.ui.ActionBar.d6 d6Var, View view) {
        return new z70(viewGroup, d6Var, view, false, false, false);
    }

    public static z70 G(ViewGroup viewGroup, org.telegram.ui.ActionBar.d6 d6Var, View view, boolean z10) {
        return new z70(viewGroup, d6Var, view, z10, false, false);
    }

    public static z70 H(org.telegram.ui.ActionBar.m2 m2Var, View view) {
        return new z70(m2Var, view, false, true);
    }

    public static z70 I(org.telegram.ui.ActionBar.m2 m2Var, View view) {
        return new z70(m2Var, view, true, true);
    }
    ...
    public static void a(z70 z70Var, ViewGroup viewGroup) {
        x70 x70Var = z70Var.f30843x;
        if (x70Var == null) {
            return;
        }
        z70Var.f30843x = null;
        ValueAnimator valueAnimator = z70Var.m0;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(x70Var.f30290w, 0.0f);
        z70Var.m0 = ofFloat;
        ofFloat.addUpdateListener(new t70(x70Var, 0));
        z70Var.m0.addListener(new ai.y4(z70Var, x70Var, viewGroup, 7));
        if (z70Var.L) {
            z70Var.m0.setDuration(380L);
            z70Var.m0.setInterpolator(sr.h);
        } else {
            z70Var.m0.setDuration(150L);
        }
        z70Var.m0.start();
    }

    public static void f(z70 z70Var, ai.x8 x8Var, final HashSet hashSet, boolean z10, Runnable runnable, final Utilities.Callback callback) {
        Object obj;
        ArrayList<TLRPC.PhotoSize> arrayList;
        Context context = z70Var.e;
        org.telegram.ui.ActionBar.d6 d6Var = z70Var.d;
        ScrollView scrollView = new ScrollView(context);
        LinearLayout linearLayout = new LinearLayout(context);
        scrollView.addView(linearLayout);
        linearLayout.setOrientation(1);
        z70Var.r(scrollView, w7.y5.n(-1, -2));
        float f7 = 0.12f;
        if (z10 && runnable != null) {
            org.telegram.ui.ActionBar.e1 e1Var = new org.telegram.ui.ActionBar.e1(2, z70Var.e, z70Var.d, false, false);
        ...
        while (i11 < size) {
            ...
            org.telegram.ui.ActionBar.e1 e1Var2 = new org.telegram.ui.ActionBar.e1(2, z70Var.e, z70Var.d, false, false);
    ...
    public final void B() {
        ...
        po poVar = new po(this, this.e, i11, this.d, i13 | i12);
        this.D = poVar;
        poVar.setDispatchKeyEventListener(new o70(this, 0));
        this.A = this.D;
    }

    public final void C() {
        N();
        View view = this.f30816f;
        if (view == null) {
            return;
        }
        this.f30815e0 = view;
        view.getLocationOnScreen(this.f30820h0);
        this.f30817f0 = new ViewTreeObserver.OnScrollChangedListener() {
            @Override
            public final void onScrollChanged() {
                u70 u70Var;
                z70 z70Var = z70.this;
                if (z70Var.f30815e0 != null && (u70Var = z70Var.f30829m) != null && u70Var.isShowing()) {
                    int[] iArr = new int[2];
                    z70Var.f30815e0.getLocationOnScreen(iArr);
                    int i10 = iArr[0];
                    int[] iArr2 = z70Var.f30820h0;
        ...
        this.f30815e0.getViewTreeObserver().addOnScrollChangedListener(this.f30817f0);
        q70 q70Var = new q70(this, 0);
        this.f30819g0 = q70Var;
        this.f30815e0.addOnLayoutChangeListener(q70Var);
    }

    public final boolean D() {
        u70 u70Var = this.f30829m;
    ...
    public final z70 J() {
        z70 z70Var = new z70(this.D, this.d);
        z70Var.C = this.D.b(z70Var.B);
        return z70Var;
    }

    public final void K(z70 z70Var) {
        this.f30831n0 = true;
        this.D.getSwipeBack().e(z70Var.C);
    }
    ...
    public final void M(Runnable runnable) {
        if (runnable != null && this.e != null && this.D.getItemsCount() > 0) {
            ...
            if (childAt instanceof org.telegram.ui.ActionBar.e1) {
                ...
                e1Var.setOnClickListener(new r70(this, runnable, 2));
            }
        }
    }

    public final void N() {
        View view = this.f30815e0;
        if (view != null) {
            if (this.f30817f0 != null) {
                ViewTreeObserver viewTreeObserver = view.getViewTreeObserver();
                if (viewTreeObserver.isAlive()) {
                    viewTreeObserver.removeOnScrollChangedListener(this.f30817f0);
                }
            }
            q70 q70Var = this.f30819g0;
            if (q70Var != null) {
                this.f30815e0.removeOnLayoutChangeListener(q70Var);
            }
        }
        this.f30817f0 = null;
        this.f30819g0 = null;
    ...
    public final void O() {
        ...
        int y3;
        u70 u70Var = this.f30829m;
        if (u70Var != null && u70Var.isShowing() && (view = this.f30816f) != null && (viewGroup = this.f30810b) != null && this.A != null && this.D != null) {
            float[] fArr = this.f30832o;
            ...
            float f14 = x10 + this.f30836q;
            this.f30809a0 = f14;
            float f15 = y3 + this.f30838r;
            this.f30811b0 = f15;
            this.f30829m.update((int) f14, (int) f15, -1, -1);
        }
    }
    ...
    public final void R(ja jaVar, float f7, float f10) {
        ...
        if (viewGroup instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
            viewGroup.setBackground(new ma(new na(jaVar, viewGroup, 5, false), this.A.getX() + this.f30809a0 + f7, this.A.getY() + this.f30811b0 + f10, mutate, AndroidUtilities.dp(12.0f)));
            return;
        }
        for (int i10 = 0; i10 < this.A.getChildCount(); i10++) {
            View childAt = this.A.getChildAt(i10);
            if (childAt instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                childAt.setBackground(new ma(new na(jaVar, childAt, 5, false), this.A.getX() + this.f30809a0 + f7 + childAt.getX(), this.A.getY() + this.f30811b0 + f10 + childAt.getY(), mutate, AndroidUtilities.dp(12.0f)));
            }
        }
    }
    ...
    public final void S(int i10, int i11) {
        View childAt;
        this.f30824j0 = Integer.valueOf(i10);
        this.f30826k0 = Integer.valueOf(i11);
    ...
    public final void T(int i10) {
        View childAt;
        this.f30822i0 = Integer.valueOf(i10);
        if (this.A != null) {
            for (int i11 = 0; i11 < this.A.getChildCount(); i11++) {
                if (i11 == this.A.getChildCount() - 1) {
                    childAt = this.D;
    ...
    public final void X(float f7) {
        u70 u70Var = this.f30829m;
        if (u70Var != null) {
            u70Var.update((int) this.f30809a0, (int) (this.f30811b0 + f7), -1, -1);
        }
    }
    ...
    public final void Z() {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.z70.Z():void");
    }
    ...
    public final void b(int i10, Drawable drawable, CharSequence charSequence, int i11, int i12, Runnable runnable) {
        ...
        e1Var.setOnClickListener(new r70(this, runnable, 3));
        int i13 = this.S;
        if (i13 > 0) {
    ...
    public final void b0(int i10, int i11) {
        ...
        View view2 = this.f30835p0;
        if (view2 != null) {
            int[] iArr = this.f30837q0;
            view2.getLocationOnScreen(iArr);
            this.f30835p0.drawableHotspotChanged(i10 - iArr[0], i11 - iArr[1]);
        }
    }
    ...
    public final void e(int i10, boolean z10, Runnable runnable) {
        ...
        e1Var.setSelectorColor(l1);
        e1Var.setOnClickListener(new r70(this, runnable, 4));
        int i16 = this.S;
        if (i16 > 0) {
    ...
    public final void g(TLObject tLObject, boolean z10, Runnable runnable) {
        ...
        e1Var.setSelectorColor(l1);
        e1Var.setOnClickListener(new r70(this, runnable, 1));
        int i15 = this.S;
        if (i15 > 0) {
    ...
    public final void j(boolean z10, int i10, ii.c2 c2Var, CharSequence charSequence, Runnable runnable) {
        ...
        e1Var.setSelectorColor(l1);
        e1Var.setOnClickListener(new r70(this, runnable, 5));
        int i14 = this.S;
        if (i14 > 0) {
    ...
    public final void n(TLObject tLObject, String str, Runnable runnable) {
        ...
        frameLayout.setOnClickListener(new r70(this, runnable, 0));
    ...
    public final void o() {
        ...
        actionBarPopupWindow$ActionBarPopupWindowLayout2.setDispatchKeyEventListener(new o70(this, 1));
    ...
    public final void u() {
        ...
        Runnable runnable = this.f30834p;
        if (runnable != null) {
            runnable.run();
        }
    }
    ...
    public z70(ViewGroup viewGroup, org.telegram.ui.ActionBar.d6 d6Var, View view, boolean z10, boolean z11, boolean z12) {
        this.f30821i = 5;
        this.f30832o = new float[2];
        this.f30840t = true;
        this.f30842w = true;
        ...
        this.f30808a = viewGroup;
        this.d = d6Var;
        this.e = viewGroup.getContext();
        this.f30816f = view;
        this.f30839s = ((double) AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19059d6, d6Var))) > 0.705d ? 102 : 51;
        this.E = z10;
        this.F = z11;
        this.G = z12;
        B();
    ...
    public z70(ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout, org.telegram.ui.ActionBar.d6 d6Var) {
        this.f30821i = 5;
        this.f30832o = new float[2];
        this.f30840t = true;
        this.f30842w = true;
