...
public final class z70 implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.f30802a) {
            case 0:
                AndroidUtilities.runOnUIThread(new ei.g1((org.telegram.ui.ActionBar.a2) this.e, tLObject, (AccountInstance) this.f30805f, (f80) this.f30806g, this.f30804c, this.f30803b, (org.telegram.ui.ActionBar.m2) this.h, this.d, (TLRPC.Peer) this.f30807i));
                return;
            default:
                ai.a1 a1Var = (ai.a1) this.e;
                byte[] bArr = (byte[]) this.f30805f;
                org.telegram.messenger.video.a aVar = (org.telegram.messenger.video.a) this.f30806g;
                xc xcVar = (xc) this.h;
                org.telegram.messenger.video.d dVar = (org.telegram.messenger.video.d) this.f30807i;
                Context context = this.f30803b;
                if (tLObject != null) {
                    if (tLObject instanceof TLRPC.TL_channels_sponsoredMessageReportResultChooseOption) {
                        AndroidUtilities.runOnUIThread(new org.telegram.ui.aw(tLObject, context, a1Var, this.f30804c, bArr, aVar, xcVar, dVar));
                        return;
