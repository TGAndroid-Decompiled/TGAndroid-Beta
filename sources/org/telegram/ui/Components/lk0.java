...
public final class lk0 implements View.OnLayoutChangeListener {
    public final s4.h0 f25935a;
    public final ArrayList f25936b;
    ...
    public final void onLayoutChange(View view, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17) {
        ...
        View view2;
        ok0 ok0Var = this.e;
        HashMap hashMap = (HashMap) ok0Var.f26833k;
        ...
        while (true) {
            ...
            s4.h0 h0Var = this.f25935a;
            if (h0Var != null && (h0Var.f42721b || ok0Var.f26828c)) {
                ll0Var.getClass();
        ...
        ValueAnimator valueAnimator = (ValueAnimator) ok0Var.f26830g;
        if (valueAnimator != null) {
            valueAnimator.removeAllListeners();
            ((ValueAnimator) ok0Var.f26830g).cancel();
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        ok0Var.f26830g = ofFloat;
        final boolean z12 = this.f25937c;
        final int i28 = i19;
        ...
        ((ValueAnimator) ok0Var.f26830g).addListener(new ai.z(28, this, arrayList2));
        long j3 = 300;
        if (ok0Var.d) {
            if (z10) {
                ((ValueAnimator) ok0Var.f26830g).setDuration(150L);
                ((ValueAnimator) ok0Var.f26830g).setInterpolator(qr.f27421g);
            } else {
                long measuredHeight = ((i28 / ll0Var.getMeasuredHeight()) + 1.0f) * 200.0f;
                if (measuredHeight >= 300) {
                    j3 = measuredHeight;
                }
                ((ValueAnimator) ok0Var.f26830g).setDuration(Math.min(j3, 1300L));
                ((ValueAnimator) ok0Var.f26830g).setInterpolator(qr.h);
            }
        } else {
            if (z10) {
                min = 600;
            ...
            ((ValueAnimator) ok0Var.f26830g).setDuration(min);
            ((ValueAnimator) ok0Var.f26830g).setInterpolator(qr.h);
        }
        ((ValueAnimator) ok0Var.f26830g).start();
    }
}
