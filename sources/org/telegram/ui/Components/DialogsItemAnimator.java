...
public class DialogsItemAnimator extends SimpleItemAnimator {
    ...
    private void animateRemoveImpl(final RecyclerView.ViewHolder viewHolder) {
        ...
        ObjectAnimator duration2 = ObjectAnimator.ofFloat(dialogCell, AnimationProperties.CLIP_DIALOG_CELL_PROGRESS, 1.0f).setDuration(180L);
    ...
    private void lambda$runPendingAnimations$0(ArrayList arrayList) {
    ...
    private void lambda$runPendingAnimations$1(ArrayList arrayList) {
        int size = arrayList.size();
        int i = 0;
        while (i < size) {
            Object obj = arrayList.get(i);
    ...
    private void lambda$runPendingAnimations$2(ArrayList arrayList) {
        int size = arrayList.size();
        int i = 0;
        while (i < size) {
            Object obj = arrayList.get(i);
    ...
    public void runPendingAnimations() {
        ...
        if (!zIsEmpty2) {
            ArrayList<MoveInfo> arrayList2 = new ArrayList<>(this.mPendingMoves);
            this.mMovesList.add(arrayList2);
            this.mPendingMoves.clear();
            lambda$runPendingAnimations$0(arrayList2);
        }
        if (!zIsEmpty3) {
            ArrayList<ChangeInfo> arrayList3 = new ArrayList<>(this.mPendingChanges);
            this.mChangesList.add(arrayList3);
            this.mPendingChanges.clear();
            lambda$runPendingAnimations$1(arrayList3);
        }
        if (zIsEmpty4) {
            return;
        }
        ArrayList<RecyclerView.ViewHolder> arrayList4 = new ArrayList<>(this.mPendingAdditions);
        this.mAdditionsList.add(arrayList4);
        this.mPendingAdditions.clear();
        lambda$runPendingAnimations$2(arrayList4);
    }
