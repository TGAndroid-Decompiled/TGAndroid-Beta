...
public abstract class wt extends EditText {
    ...
    public static void a(wt wtVar) {
        ...
        if (!wtVar.spoilers.isEmpty()) {
            wtVar.spoilers.get(0).f7598q = new vt(wtVar, 3);
            float sqrt = (float) Math.sqrt(Math.pow(wtVar.getHeight(), 2.0d) + Math.pow(wtVar.getWidth(), 2.0d));
            for (ih.k kVar : wtVar.spoilers) {
                kVar.j(wtVar.lastRippleX, wtVar.lastRippleY, sqrt, true);
            }
        }
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (arrayList == null) {
            ...
            while (i10 < size) {
                ...
                if (wi0Var2.b() && wi0Var2.f30300g.contains(motionEvent.getX(), motionEvent.getY() - paddingTop)) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                if (motionEvent.getAction() == 0) {
                    ...
                    if (si0Var != null && si0Var.h && z10) {
                        aj0 aj0Var = wi0Var2.e;
                        aj0Var.e = !aj0Var.e;
        ...
        if (!z4) {
            if (this.shouldRevealSpoilersByTouch && (pVar = this.clickDetector) != null && ((GestureDetector) pVar.f7627a.f31508b).onTouchEvent(motionEvent)) {
    ...
    public void invalidateSpoilers() {
        ...
        if (layout != null && (layout.getText() instanceof Spannable)) {
            ...
            if (this.drawAnimatedEmojiDrawables && (q5Var = this.animatedEmojiDrawables) != null) {
                ArrayList arrayList3 = q5Var.f28069a;
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (!this.spoilers.isEmpty()) {
            ...
            if (kVar2.f7594m > 0.0f && kVar2.f7595n > 0.0f) {
                canvas2.save();
    ...
    public void onTextChanged(java.lang.CharSequence r4, int r5, int r6, int r7) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.wt.onTextChanged(java.lang.CharSequence, int, int, int):void");
    }
