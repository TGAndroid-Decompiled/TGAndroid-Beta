...
public final class be implements ei.m0, org.telegram.ui.ActionBar.z1, bu, org.telegram.ui.ActionBar.k1 {
    public final ChatActivityEnterView f22994a;

    public be(ChatActivityEnterView chatActivityEnterView) {
        this.f22994a = chatActivityEnterView;
    }

    @Override
    public void f(org.telegram.ui.ActionBar.a2 a2Var, int i10) {
        int i11 = ChatActivityEnterView.f21952n5;
        ChatActivityEnterView chatActivityEnterView = this.f22994a;
    ...
    public void p(KeyEvent keyEvent) {
        ...
        if (keyEvent.getKeyCode() == 4 && keyEvent.getRepeatCount() == 0 && (mfVar = (chatActivityEnterView = this.f22994a).N0) != null && mfVar.isShowing()) {
