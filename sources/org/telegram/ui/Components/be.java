...
public final class be implements ei.m0, org.telegram.ui.ActionBar.z1, au, org.telegram.ui.ActionBar.k1 {
    public final ChatActivityEnterView f22971a;

    public be(ChatActivityEnterView chatActivityEnterView) {
        this.f22971a = chatActivityEnterView;
    }

    @Override
    public void f(org.telegram.ui.ActionBar.a2 a2Var, int i10) {
        int i11 = ChatActivityEnterView.f21938n5;
        ChatActivityEnterView chatActivityEnterView = this.f22971a;
    ...
    public void p(KeyEvent keyEvent) {
        ...
        if (keyEvent.getKeyCode() == 4 && keyEvent.getRepeatCount() == 0 && (mfVar = (chatActivityEnterView = this.f22971a).N0) != null && mfVar.isShowing()) {
