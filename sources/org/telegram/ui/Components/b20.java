...
public class b20 extends FrameLayout implements le.d, org.telegram.ui.ActionBar.z5 {
    ...
    public a20 H;
    public int I;
    public final le.b f22782a;
    public final le.b f22783b;
    public final le.e f22784c;
    public final org.telegram.ui.ActionBar.e6 d;
    public final ImageView e;
    public final ImageView f22785f;
    public final LinearLayout h;
    public boolean f22786n;
    public final ci.h2 f22787r;
    public ch.d f22788s;
    public Drawable v;
    public boolean f22789w;
    public boolean f22790x;
    public Runnable f22791y;
    ...
    public b20(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        int i13;
        qr qrVar = qr.h;
        this.f22782a = new le.b(0, this, qrVar, 380L, false);
        this.f22783b = new le.b(1, this, qrVar, 380L, true);
        this.f22784c = new le.e(2, this, ke.a.f13588a, 280L);
    ...
    public final void D(int i10, float f7, float f10, le.e eVar) {
        if (i10 == 0) {
            ImageView imageView = this.f22785f;
            y10.d(imageView, f7);
    ...
    public final void b() {
        int i10;
        int max = Math.max(AndroidUtilities.dp(6.0f) + ((int) this.f22784c.e), AndroidUtilities.dp(48.0f));
    ...
    public final void e() {
        ...
        if (this.f22789w) {
            b02 = org.telegram.ui.ActionBar.j6.d0(AndroidUtilities.dp(20.0f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19062d6, e6Var));
        } else {
            int dp = AndroidUtilities.dp(20.0f);
            if (this.f22790x) {
                l1 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19062d6, e6Var);
            } else {
                ...
                l1 = org.telegram.ui.ActionBar.j6.l1(f7, org.telegram.ui.ActionBar.j6.v0(i10, e6Var));
            }
            b02 = org.telegram.ui.ActionBar.j6.b0(dp, l1);
        }
        this.v = b02;
        int i11 = org.telegram.ui.ActionBar.j6.G6;
        int l12 = org.telegram.ui.ActionBar.j6.l1(0.6f, org.telegram.ui.ActionBar.j6.v0(i11, e6Var));
        PorterDuff.Mode mode = PorterDuff.Mode.MULTIPLY;
        this.e.setColorFilter(l12, mode);
        int l13 = org.telegram.ui.ActionBar.j6.l1(0.6f, org.telegram.ui.ActionBar.j6.v0(i11, e6Var));
        ImageView imageView = this.f22785f;
        imageView.setColorFilter(l13, mode);
        imageView.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19152i6, e6Var), 1, AndroidUtilities.dp(17.0f)));
        int l14 = org.telegram.ui.ActionBar.j6.l1(0.5f, org.telegram.ui.ActionBar.j6.v0(i11, e6Var));
        ci.h2 h2Var = this.f22787r;
        h2Var.setHintTextColor(l14);
        h2Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(i11, e6Var));
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (childAt instanceof org.telegram.ui.ActionBar.v0) {
                ...
                childAt.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19152i6, e6Var), 1, AndroidUtilities.dp(17.0f)));
            }
        }
        bc1 bc1Var = this.G;
    ...
    public final void f() {
        ...
        for (int i13 = 0; i13 < arrayList2.size(); i13++) {
            ...
            bc1Var.addView(u0Var, w7.y5.t(-2, -1, 0, i10, 0, i11, 0));
        }
    ...
    public final void g(gg.q0 q0Var) {
        ...
        if (q0Var.h) {
            ...
            f();
            a20 a20Var = this.H;
            if (a20Var != null && (eyVar = ((org.telegram.ui.zx) a20Var).f40583b.C0) != null) {
                eyVar.R(false);
            }
        }
    }
    ...
    public void setCloseButtonOnClickListener(Runnable runnable) {
        this.f22791y = runnable;
    }

    public void setCloseButtonVisible(boolean z10) {
        boolean z11;
        this.f22786n = z10;
        if (!z10 && this.f22787r.length() <= 0) {
            z11 = false;
        } else {
            z11 = true;
        }
        this.f22782a.a(z11, true);
    }
