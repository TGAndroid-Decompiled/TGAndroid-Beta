...
public class b20 extends FrameLayout implements le.d, org.telegram.ui.ActionBar.a6 {
    ...
    public a20 H;
    public int I;
    public final le.b f22541a;
    public final le.b f22542b;
    public final le.e f22543c;
    public final org.telegram.ui.ActionBar.f6 d;
    public final ImageView e;
    public final ImageView f22544f;
    public final LinearLayout h;
    public boolean f22545n;
    public final ci.h2 f22546r;
    public ch.d f22547s;
    public Drawable v;
    public boolean f22548w;
    public boolean f22549x;
    public Runnable f22550y;
    ...
    public b20(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        int i13;
        qr qrVar = qr.h;
        this.f22541a = new le.b(0, this, qrVar, 380L, false);
        this.f22542b = new le.b(1, this, qrVar, 380L, true);
        this.f22543c = new le.e(2, this, ke.a.f13590a, 280L);
    ...
    public final void D(int i10, float f7, float f10, le.e eVar) {
        if (i10 == 0) {
            ImageView imageView = this.f22544f;
            y10.d(imageView, f7);
    ...
    public final void b() {
        int i10;
        int max = Math.max(AndroidUtilities.dp(6.0f) + ((int) this.f22543c.e), AndroidUtilities.dp(48.0f));
    ...
    public final void e() {
        ...
        if (this.f22548w) {
            b02 = org.telegram.ui.ActionBar.j6.d0(AndroidUtilities.dp(20.0f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18863d6, f6Var));
        } else {
            int dp = AndroidUtilities.dp(20.0f);
            if (this.f22549x) {
                l1 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18863d6, f6Var);
            } else {
        ...
        imageView.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18953i6, f6Var), 1, AndroidUtilities.dp(17.0f)));
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (childAt instanceof org.telegram.ui.ActionBar.w0) {
                ...
                childAt.setBackground(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18953i6, f6Var), 1, AndroidUtilities.dp(17.0f)));
            }
        }
        dc1 dc1Var = this.G;
    ...
    public final void g(gg.q0 q0Var) {
        ...
        if (q0Var.h) {
            ...
            f();
            a20 a20Var = this.H;
            if (a20Var != null && (gyVar = ((org.telegram.ui.cy) a20Var).f32972b.C0) != null) {
                gyVar.R(false);
            }
        }
    }
    ...
    public void setCloseButtonOnClickListener(Runnable runnable) {
        this.f22550y = runnable;
    }

    public void setCloseButtonVisible(boolean z10) {
        boolean z11;
        this.f22545n = z10;
        if (!z10 && this.f22546r.length() <= 0) {
            z11 = false;
        } else {
            z11 = true;
        }
        this.f22541a.a(z11, true);
    }
