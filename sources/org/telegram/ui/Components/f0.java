...
public final class f0 extends bb implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean Z;
    public CharSequence f25847a0;
    public TL_iv.RichMessage f25848b0;
    public boolean f25849c0;
    public CharSequence f25850d0;
    public TL_iv.RichMessage f25851e0;
    public boolean f25852f0;
    public CharSequence f25853g0;
    public TL_iv.RichMessage f25854h0;
    public CharSequence f25855i0;
    public Utilities.Callback f25856j0;
    public Utilities.Callback f25857k0;
    public long f25858l0;
    public boolean m0;
    public Utilities.Callback4 f25859n0;
    public de f25860o0;
    public final boolean[] f25861p0;
    public final boolean[] f25862q0;
    public String f25863r0;
    public String f25864s0;
    public boolean f25865t0;
    public final AiTonesController f25866u0;
    public final FrameLayout f25867v0;
    public final e0 f25868w0;
    public final e0 f25869x0;
    public final ImageView f25870y0;
    public final FrameLayout f25871z0;

    public f0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context, null, true, false, 2, f6Var);
        this.f25861p0 = new boolean[1];
        this.f25862q0 = new boolean[1];
        this.P0 = true;
        this.Q0 = -1;
        ...
        e0Var2.f25528n = new di.p5(this, f6Var, context, 1);
        s0();
        e0Var2.c(-1);
        String B = u31.B();
        this.f25864s0 = B;
        if (B == null) {
            this.f25864s0 = TranslateController.currentLanguage();
        }
        this.L = false;
    ...
    public static void R(f0 f0Var, View view) {
        f0Var.f25865t0 = !f0Var.f25865t0;
        f0Var.k0();
        if (view instanceof LinearLayout) {
            LinearLayout linearLayout = (LinearLayout) view;
            if (linearLayout.getChildAt(0) instanceof mp) {
                ((mp) linearLayout.getChildAt(0)).a(f0Var.f25865t0, true);
            }
        }
    }

    public static void S(f0 f0Var, int i10) {
        e0 e0Var = f0Var.f25868w0;
    ...
    public static void T(f0 f0Var, TL_aicompose.AiComposeTone aiComposeTone) {
        f0Var.f25866u0.tones.add(0, aiComposeTone);
        f0Var.s0();
    ...
    public static void U(f0 f0Var, TL_aicompose.AiComposeTone aiComposeTone) {
        ...
        if (aiComposeTone instanceof a0) {
            ...
            int savedTonesCount = f0Var.f25866u0.getSavedTonesCount() + 1;
    ...
    public static void V(f0 f0Var, org.telegram.ui.ActionBar.j5 j5Var, int i10, TLRPC.TL_messages_composeRichMessageWithAI tL_messages_composeRichMessageWithAI, TLRPC.TL_composedRichMessageWithAI tL_composedRichMessageWithAI, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && ("SUMMARY_FLOOD_PREMIUM".equalsIgnoreCase(tL_error.text) || "AICOMPOSE_FLOOD_PREMIUM".equalsIgnoreCase(tL_error.text))) {
            ...
            if (i10 == 0) {
                f0Var.Z = false;
                f0Var.f25848b0 = tL_composedRichMessageWithAI.result;
            } else if (i10 == 1) {
                f0Var.f25849c0 = false;
                f0Var.f25851e0 = tL_composedRichMessageWithAI.result;
            } else if (i10 == 2) {
                f0Var.f25852f0 = false;
                f0Var.f25854h0 = tL_composedRichMessageWithAI.result;
            }
            f0Var.O0.N(true);
        }
    }
    ...
    public static boolean X(f0 f0Var, org.telegram.ui.ActionBar.f6 f6Var, Context context) {
        boolean z10;
        int i10;
        if (f0Var.m0 || (f0Var.f25860o0 == null ? f0Var.f25859n0 == null || f0Var.h0() == null : f0Var.g0() == null)) {
            return false;
        }
        if (f0Var.f25858l0 == UserConfig.getInstance(f0Var.currentAccount).getClientUserId()) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public static void Y(f0 f0Var, View view) {
        ...
        if (!TextUtils.isEmpty(f0Var.f25864s0)) {
            f0Var2 = f0Var;
            f0Var2.b0(F, linearLayout, true, u31.y(u31.D(f0Var.f25864s0, null, null)), null);
        } else {
            f0Var2 = f0Var;
        }
        ...
        while (i11 < size) {
            ...
            if (!TextUtils.equals(language2.code, f0Var2.f25864s0)) {
                    ...
                    public final void run() {
                        switch (r3) {
                            case 0:
                                ...
                                return;
                            default:
                                f0 f0Var4 = this.f26570b;
                                f0Var4.c0();
                                String str2 = language2.code;
                                f0Var4.f25864s0 = str2;
                                u31.I(str2);
                                f0Var4.k0();
                                return;
                        }
        ...
        while (i10 < size2) {
            ...
            f0Var2.b0(F, linearLayout, TextUtils.equals(language4.code, f0Var2.f25864s0), language4.displayName, new Runnable(f0Var2) {
                public final f0 f26570b;
    ...
    public static void Z(f0 f0Var, org.telegram.ui.ActionBar.j5 j5Var, int i10, TLRPC.TL_messages_composeMessageWithAI tL_messages_composeMessageWithAI, TLRPC.TL_composedMessageWithAI tL_composedMessageWithAI, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && ("SUMMARY_FLOOD_PREMIUM".equalsIgnoreCase(tL_error.text) || "AICOMPOSE_FLOOD_PREMIUM".equalsIgnoreCase(tL_error.text))) {
            ...
            if (i10 == 0) {
                f0Var.Z = false;
                f0Var.f25847a0 = MessageObject.formatTextWithEntities(tL_composedMessageWithAI.result_text);
            } else if (i10 == 1) {
                f0Var.f25849c0 = false;
                f0Var.f25850d0 = MessageObject.formatTextWithEntities(tL_composedMessageWithAI.result_text);
            } else if (i10 == 2) {
                f0Var.f25852f0 = false;
                TLRPC.TL_textWithEntities tL_textWithEntities = tL_composedMessageWithAI.diff_text;
                if (tL_textWithEntities != null) {
                    f0Var.f25853g0 = MessageObject.formatTextWithEntities(tL_textWithEntities);
                    f0Var.f25855i0 = MessageObject.formatTextWithEntities(tL_composedMessageWithAI.result_text);
                } else {
                    CharSequence formatTextWithEntities = MessageObject.formatTextWithEntities(tL_composedMessageWithAI.result_text);
                    f0Var.f25855i0 = formatTextWithEntities;
                    f0Var.f25853g0 = formatTextWithEntities;
                }
            }
            f0Var.O0.N(true);
        }
    ...
    public final void B(float f7) {
        float f10 = 1.0f - f7;
        ImageView imageView = this.f25870y0;
    ...
    public final void c0() {
        ...
        this.R0 = false;
        org.telegram.ui.ActionBar.j5 titleTextView = this.f24675e.getTitleTextView();
    ...
    public final void dismiss() {
        ...
        AiTonesController aiTonesController = this.f25866u0;
    ...
    public final TL_iv.RichMessage g0() {
        if (!this.R0) {
            int selectedTab = this.f25868w0.getSelectedTab();
            if (selectedTab == 0) {
                if (!this.Z) {
                ...
                if (!this.f25852f0) {
                    return this.f25854h0;
                }
                return null;
            } else if (this.f25849c0) {
                return null;
            } else {
                TL_iv.RichMessage richMessage = this.f25851e0;
                if (richMessage == null) {
                    return this.Y;
                }
                return richMessage;
    ...
    public final CharSequence h0() {
        if (i0()) {
            ...
            if (selectedTab == 0) {
                ...
                CharSequence charSequence = this.f25850d0;
    ...
    public final void k0() {
        ...
        e0 e0Var = this.f25869x0;
        e0 e0Var2 = this.f25868w0;
        if (i02) {
            ...
            if (selectedTab == 0) {
                tL_messages_composeRichMessageWithAI.translate_to_lang = TranslateController.normalizeLanguage(this.f25864s0);
                tL_messages_composeRichMessageWithAI.tone = TL_aicompose.InputAiComposeTone.fromDefault(str3);
                tL_messages_composeRichMessageWithAI.emojify = this.f25865t0;
                ...
                if (selectedTone instanceof a0) {
                    ...
                    inputaicomposetoneid.f20108id = tL_aiComposeTone.f20107id;
        ...
        if (selectedTab2 == 0) {
            tL_messages_composeMessageWithAI.translate_to_lang = TranslateController.normalizeLanguage(this.f25864s0);
            tL_messages_composeMessageWithAI.tone = TL_aicompose.InputAiComposeTone.fromDefault(null);
            tL_messages_composeMessageWithAI.emojify = this.f25865t0;
            ...
            if (selectedTone2 instanceof a0) {
                ...
                inputaicomposetoneid2.f20108id = tL_aiComposeTone2.f20107id;
        ...
        if (tL_messages_composeMessageWithAI2 == null || tL_messages_composeMessageWithAI2.proofread != tL_messages_composeMessageWithAI.proofread || tL_messages_composeMessageWithAI2.emojify != tL_messages_composeMessageWithAI.emojify || !TL_aicompose.InputAiComposeTone.equals(tL_messages_composeMessageWithAI2.tone, tL_messages_composeMessageWithAI.tone) || !TextUtils.equals(tL_messages_composeMessageWithAI2.translate_to_lang, tL_messages_composeMessageWithAI.translate_to_lang)) {
            ...
            if (selectedTab3 == 0 && (charSequence5 = this.f25847a0) != null) {
                charSequence7 = charSequence5;
            }
            if (selectedTab3 == 1 && (charSequence4 = this.f25850d0) != null) {
                charSequence7 = charSequence4;
            }
            if (selectedTab3 == 2 && (charSequence3 = this.f25853g0) != null) {
            ...
            for (int i14 = 0; i14 < b10; i14++) {
                ...
                i90Var.f27080f = AndroidUtilities.dp(6.0f);
                i90Var.h = 0.5f;
                i90Var.f27081n = true;
            ...
            if (selectedTab2 == 0) {
                this.Z = true;
                this.f25847a0 = spannableStringBuilder;
            } else if (selectedTab2 == 1) {
                this.f25849c0 = true;
                this.f25850d0 = spannableStringBuilder;
            } else if (selectedTab2 == 2) {
                this.f25852f0 = true;
                this.f25853g0 = spannableStringBuilder;
            }
    ...
    public final void l0(int i10, int i11, boolean z10) {
        if (this.f25860o0 != null) {
            TL_iv.RichMessage g02 = g0();
            if (g02 != null) {
                this.f25860o0.run(g02, Integer.valueOf(i10), Integer.valueOf(i11), Boolean.valueOf(z10));
            }
        } else if (this.f25859n0 != null && h0() != null) {
            this.f25859n0.run(h0(), Integer.valueOf(i10), Integer.valueOf(i11), Boolean.valueOf(z10));
        }
    }
    ...
    public final void p0(boolean z10) {
        ...
        if (z11) {
            ...
            e0 e0Var = this.f25868w0;
            if (e0Var != null) {
                i10 = e0Var.getSelectedTab();
            } else {
                i10 = 0;
            }
            if (i10 == 1 && (this.f25869x0.getSelectedTone() instanceof a0) && !TextUtils.equals(this.A0.getText().toString(), this.I0)) {
                dVar.setText(LocaleController.getString(R.string.ArticleAIGenerate));
                dVar.setOnClickListener(new b(this, 1));
            } else if (this.f25857k0 == null && this.f25856j0 == null) {
                dVar.setText(LocaleController.getString(R.string.OK));
    ...
    public final void q0() {
        ...
        boolean equals = TextUtils.equals(str, i3Var.f22102b.getText().toString());
        boolean z10 = !equals;
        if (this.H0 == z10) {
            return;
        }
        ViewPropertyAnimator animate = i3Var.f22102b.animate();
        this.H0 = z10;
        if (!equals) {
            f7 = 1.0f;
        } else {
    ...
    public final void r0() {
        ...
        while (true) {
            ...
            if (i10 < ll0Var.getChildCount()) {
                ...
                if (G != null && G.f26615c == this.f25869x0) {
                    break;
                }
                i10++;
            } else {
    ...
    public final void s0() {
        e0 e0Var = this.f25869x0;
        TL_aicompose.AiComposeTone selectedTone = e0Var.getSelectedTone();
        e0Var.f25525c.removeAllViews();
        if (i0()) {
            e0Var.b(new TL_aicompose.AiComposeTone(), new e(this, 0));
        }
        e0Var.b(null, new e(this, 0));
        ArrayList<TL_aicompose.AiComposeTone> arrayList = this.f25866u0.tones;
    ...
    public final void show() {
        ...
        if (!this.m0 && (this.f25860o0 != null || this.f25859n0 != null)) {
            i10 = 0;
        } else {
            i10 = 8;
        }
