...
public class TopViewCell extends LinearLayout implements Theme.Colorable {
    ...
    public TopViewCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        backupImageView.setOnClickListener(new SearchField$$ExternalSyntheticLambda0(this, 17));
    ...
    public void setEmoji(int i) {
        if (this.lastIconResId != i) {
            BackupImageView backupImageView = this.imageView;
            this.lastIconResId = i;
            backupImageView.setImageDrawable(new RLottieDrawable(i, DiffUtil.m(i, ""), AndroidUtilities.dp(90.0f), AndroidUtilities.dp(90.0f)));
