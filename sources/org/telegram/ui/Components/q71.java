...
public abstract class q71 extends View {
    public static final Object f27251f0 = new Object();
    public p71 E;
    ...
    public long f27252a;
    public final Paint f27253a0;
    public int f27254b;
    public final Paint f27255b0;
    public int f27256c;
    public final e6 f27257c0;
    public float d;
    public final Path f27258d0;
    public float e;
    public boolean f27259e0;
    public float f27260f;
    public boolean h;
    public boolean f27261n;
    public boolean f27262r;
    public float f27263s;
    public float v;
    public boolean f27264w;
    public ParcelFileDescriptor f27265x;
    public MediaMetadataRetriever f27266y;
    ...
    public q71(Context context) {
        ...
        this.f27253a0 = paint5;
        Paint paint6 = new Paint(1);
        this.f27255b0 = paint6;
        this.f27257c0 = new e6(0.0f, this, 0L, 200L, rr.f27704j);
        this.f27258d0 = new Path();
        paint.setColor(-1);
        paint2.setColor(-256);
    ...
    public final void a() {
        Bitmap bitmap;
        synchronized (f27251f0) {
            try {
                ParcelFileDescriptor parcelFileDescriptor = this.f27265x;
            ...
            try {
                MediaMetadataRetriever mediaMetadataRetriever = this.f27266y;
        ...
        for (int i10 = 0; i10 < this.F.size(); i10++) {
            ...
            if (o71Var != null && (bitmap = o71Var.f26676a) != null) {
                bitmap.recycle();
            }
        }
        this.F.clear();
    ...
    public final void d(int i10) {
        ...
        if (i10 == 0) {
            ...
            int i12 = this.f27254b;
            if (i12 != 0 && (i11 = this.f27256c) != 0) {
                f7 = i12 / i11;
            } else {
                f7 = 1.0f;
            }
    ...
    public long getLength() {
        return Math.max(1L, this.f27252a);
    }
    ...
    public final void onDraw(Canvas canvas) {
            ...
            if (!z10) {
                ...
                while (true) {
                    if (i10 >= arrayList.size()) {
                        break;
                    } else if (((o71) arrayList.get(i10)).f26676a == null) {
                        this.f27259e0 = true;
                        break;
                    } else {
                        i10++;
            ...
            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                ...
                if (bitmap != null) {
                    ...
                    if (f17 != 1.0f) {
                        ...
                        Paint paint = this.Q;
                        paint.setAlpha((int) (rr.h.getInterpolation(o71Var.f26677b) * 255.0f));
        ...
        if (!z11) {
            ...
            canvas2.drawRect(rectF4, this.f27253a0);
            canvas2.restore();
        ...
        float d = this.f27257c0.d(0.0f, false);
        if (d > 0.0f) {
            c(this.e, d, canvas2, paint3);
        }
        c(this.f27263s, 1.0f - d, canvas2, paint3);
        if (this.f27264w) {
            c(this.f27260f, 1.0f, canvas2, this.U);
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent != null) {
            ...
            int dp2 = AndroidUtilities.dp(22.0f) + ((int) (this.f27263s * f7));
            ...
            if (motionEvent.getAction() == 0) {
                ...
                if (motionEvent.getAction() == 2) {
                    if (this.f27262r) {
                        ...
                        p71 p71Var6 = this.E;
                        if (p71Var6 != null) {
                            float f12 = this.f27263s;
                            com.google.android.gms.common.api.internal.v vVar2 = (com.google.android.gms.common.api.internal.v) p71Var6;
                            PhotoViewer photoViewer2 = (PhotoViewer) vVar2.d;
                            if (photoViewer2.F2 != null) {
                                if (photoViewer2.f30892c2 == 1) {
                                    vVar2.j(0);
                                }
                                vVar2.h(f12);
                            }
                        ...
                        p71 p71Var7 = this.E;
                        if (p71Var7 != null) {
                            com.google.android.gms.common.api.internal.v vVar3 = (com.google.android.gms.common.api.internal.v) p71Var7;
                            ...
                            if (f71Var != null) {
                                ...
                                vVar3.j(1);
                                vVar3.h(f18);
                                photoViewer3.f31014q3.h(0.0f, false);
                        ...
                        p71 p71Var8 = this.E;
                        if (p71Var8 != null) {
                            ((com.google.android.gms.common.api.internal.v) p71Var8).f(this.e);
                        }
                        invalidate();
                        return true;
                    }
                ...
                p71 p71Var9 = this.E;
                if (p71Var9 != null) {
                    ((com.google.android.gms.common.api.internal.v) p71Var9).d(0);
                }
                this.h = false;
                return true;
            } else if (this.f27261n) {
                p71 p71Var10 = this.E;
                if (p71Var10 != null) {
                    ((com.google.android.gms.common.api.internal.v) p71Var10).d(1);
                }
                this.f27261n = false;
                return true;
            } else if (this.f27262r) {
                p71 p71Var11 = this.E;
                if (p71Var11 != null) {
                    ((com.google.android.gms.common.api.internal.v) p71Var11).d(2);
                }
                this.f27262r = false;
            }
            return true;
    ...
    public void setProgress(float f7) {
        float f10 = 0.0f;
        if (this.f27264w && (f7 <= 0.0f || f7 >= 1.0f)) {
            f7 = this.f27260f;
        }
        long j3 = this.f27252a;
        if (j3 != 0) {
            f10 = 240.0f / ((float) j3);
        }
        float f11 = this.f27263s;
        if (f7 < f11 && f7 <= this.d + f10 && f11 + f10 >= this.e) {
            this.f27257c0.d(1.0f, true);
        }
        this.f27263s = f7;
        invalidate();
    }
