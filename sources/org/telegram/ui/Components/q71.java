...
public final class q71 {
    ...
    public static q71 d(int i10, TLRPC.Document document, TLRPC.Document document2, int i11, boolean z10) {
        ...
        if (tL_documentAttributeVideo != null) {
            ...
            obj.f27527i = tL_documentAttributeVideo.f18328w;
            obj.f27528j = tL_documentAttributeVideo.h;
            obj.f27530l = j3 / d;
        }
    ...
    public final void e(boolean z10) {
        if (!b() && this.f27526g != null) {
            File pathToAttach = FileLoader.getInstance(this.f27522a).getPathToAttach(this.f27526g, null, false, z10);
            if (pathToAttach != null && pathToAttach.exists()) {
                this.d = Uri.fromFile(pathToAttach);
            } else {
                File pathToAttach2 = FileLoader.getInstance(this.f27522a).getPathToAttach(this.f27526g, null, true, z10);
                if (pathToAttach2 != null && pathToAttach2.exists()) {
        ...
        if (!c() && this.h != null) {
            File pathToAttach3 = FileLoader.getInstance(this.f27522a).getPathToAttach(this.h, null, false, z10);
            if (pathToAttach3 != null && pathToAttach3.exists()) {
                this.f27525f = Uri.fromFile(pathToAttach3);
                return;
            }
            File pathToAttach4 = FileLoader.getInstance(this.f27522a).getPathToAttach(this.h, null, true, z10);
            if (pathToAttach4 != null && pathToAttach4.exists()) {
                this.f27525f = Uri.fromFile(pathToAttach4);
            }
        }
    }
}
