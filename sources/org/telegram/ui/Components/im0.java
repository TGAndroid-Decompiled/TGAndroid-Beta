...
public final class im0 extends yw0 {
    public float d;
    public final Paint f25158f;
    public boolean f25155a = false;
    ...
    public im0(boolean z10) {
        if (z10) {
            this.f25158f = new Paint(1);
        }
    }

    @Override
    public final void b(int i10) {
        Paint paint = this.f25158f;
        if (paint != null) {
            paint.setColor(i10);
        }
    }
    ...
    @Override
    public final void d() {
        this.f25156b = System.currentTimeMillis();
        this.f25157c = true;
        invalidateSelf();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        Paint paint = this.f25158f;
        if (paint == null) {
            paint = org.telegram.ui.ActionBar.j6.f19087c2;
        }
        ...
        if (this.f25157c) {
            ...
            long j3 = currentTimeMillis - this.f25156b;
            this.f25156b = currentTimeMillis;
            if (j3 > 50) {
                j3 = 50;
            }
            float f10 = this.d;
