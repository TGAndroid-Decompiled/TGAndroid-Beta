...
public final class im0 extends FrameLayout {
    public final Paint f25116a;
    public final g50 f25117b;
    public final RectF f25118c;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f7 = this.d;
        RectF rectF = this.f25118c;
        rectF.set(f7, f7, getWidth() - f7, getHeight() - f7);
        canvas.drawOval(rectF, this.f25116a);
        canvas.drawArc(rectF, -90.0f, this.e * 360.0f, false, this.f25117b);
    }
