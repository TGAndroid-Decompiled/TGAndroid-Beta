...
public abstract class im0 extends HorizontalScrollView {
    public static final int f27191t0 = 0;
    public final e6 E;
    ...
    public float W;
    public int f27192a;
    public float f27193a0;
    public hm0 f27194b;
    public boolean f27195b0;
    public final LinearLayout.LayoutParams f27196c;
    public float f27197c0;
    public final LinearLayout.LayoutParams d;
    public float f27198d0;
    public final cc1 f27199e;
    public final dm0 f27200e0;
    public gm0 f27201f;
    public boolean f27202f0;
    public boolean f27203g0;
    public HashMap h;
    public ValueAnimator f27204h0;
    public float f27205i0;
    public final float f27206j0;
    public final float f27207k0;
    public float f27208l0;
    public int m0;
    public HashMap f27209n;
    public final Paint f27210n0;
    public boolean f27211o0;
    public final e6 f27212p0;
    public boolean f27213q0;
    public final SparseArray f27214r;
    public long f27215r0;
    public View f27216s;
    public final dm0 f27217s0;
    public float v;
    ...
    public im0(Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        super(context);
        this.f27192a = 1;
        this.f27194b = hm0.f26786a;
        this.h = new HashMap();
        this.f27209n = new HashMap();
        this.f27214r = new SparseArray();
        pr prVar = pr.h;
        ...
        this.f27200e0 = new dm0(this, 0);
        this.f27202f0 = false;
        this.f27206j0 = AndroidUtilities.dp(64.0f);
        this.f27207k0 = AndroidUtilities.dp(33.0f);
        this.m0 = -1;
        this.f27210n0 = new Paint();
        this.f27211o0 = true;
        this.f27212p0 = new e6(this, 350L, prVar);
        this.f27217s0 = new dm0(this, 1);
        this.O = f6Var;
        this.P = z10;
        ...
        this.f27196c = new LinearLayout.LayoutParams(AndroidUtilities.dp(33.0f), -1);
    ...
    public final FrameLayout b(int i10, Drawable drawable) {
        ...
        int i12 = this.f27219x;
        this.f27219x = i12 + 1;
        FrameLayout frameLayout = (FrameLayout) this.f27209n.get(i11);
        boolean z10 = true;
        if (frameLayout != null) {
            ...
            this.f27199e.addView(frameLayout, i12);
        }
    ...
    public final cx0 c(int i10, Drawable drawable) {
        ...
        int i12 = this.f27219x;
        this.f27219x = i12 + 1;
        cx0 cx0Var = (cx0) this.f27209n.get(i11);
        boolean z10 = true;
        if (cx0Var != null) {
            g(i11, cx0Var, i12);
        } else {
            cx0Var = new cx0(getContext(), 1);
            cx0Var.f25138f.setImageDrawable(drawable);
            cx0Var.setFocusable(true);
            cx0Var.setOnClickListener(new bm0(this, 4));
            cx0Var.setExpanded(this.f27202f0);
            cx0Var.a(this.f27205i0);
            this.f27199e.addView(cx0Var, i12);
        }
        cx0Var.d = false;
    ...
    public final void cancelLongPress() {
        ...
        this.f27195b0 = false;
        AndroidUtilities.cancelRunOnUIThread(this.f27200e0);
    }
    ...
    public final void d(boolean z10) {
        ...
        if (z10) {
            ...
            TransitionManager.beginDelayedTransition(this.f27199e, autoTransition);
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f12;
        float f13;
        float f14 = this.f27207k0 - this.f27206j0;
        float f15 = (1.0f - this.f27205i0) * this.f27208l0;
        int i10 = 0;
        while (true) {
            cc1Var = this.f27199e;
            ...
            if (cc1Var.getChildAt(i10) instanceof cx0) {
                ...
                float f16 = cx0Var.f25144y;
                if (cx0Var.getLeft() != f16 && cx0Var.E) {
                    cx0Var.f25135b = f16 - cx0Var.getLeft();
                    ValueAnimator valueAnimator = cx0Var.f25143x;
                    if (valueAnimator != null) {
                        valueAnimator.removeAllListeners();
                        cx0Var.f25143x.cancel();
                    }
                    ValueAnimator ofFloat = ValueAnimator.ofFloat(cx0Var.f25135b, 0.0f);
                    cx0Var.f25143x = ofFloat;
                    ofFloat.addUpdateListener(new bx0(cx0Var, this, 0));
                    cx0Var.f25143x.addListener(new pk0(3, cx0Var, this));
                    cx0Var.f25143x.start();
                }
                cx0Var.E = false;
                if (this.f27203g0) {
                    cx0Var.setTranslationX(com.google.android.gms.internal.vision.e2.z(1.0f, this.f27205i0, i10 * f14, f15) + cx0Var.f25135b);
                } else {
                    cx0Var.setTranslationX(cx0Var.f25135b);
                }
            }
            i10++;
        }
        ...
        if (this.f27203g0) {
            height = com.google.android.gms.internal.vision.e2.b(1.0f, this.f27205i0, AndroidUtilities.dp(50.0f), getHeight());
        }
        float f17 = height;
        if (this.f27211o0) {
            f7 = 1.0f;
        ...
        float d = this.f27212p0.d(f7, false);
        if (!isInEditMode() && this.f27219x != 0 && this.J >= 0) {
            e6 e6Var = this.E;
            float d10 = e6Var.d(this.f27220y, false);
            ...
            if (view != null && view2 != null) {
                f10 = 2.0f;
                float f19 = d10 - floor;
                f11 = AndroidUtilities.lerp((AndroidUtilities.lerp(AndroidUtilities.dp(33.0f), AndroidUtilities.dp(64.0f), this.f27205i0) / 2.0f) + view.getTranslationX() + view.getLeft(), (AndroidUtilities.lerp(AndroidUtilities.dp(33.0f), AndroidUtilities.dp(64.0f), this.f27205i0) / 2.0f) + view2.getTranslationX() + view2.getLeft(), f19);
                ...
                f10 = 2.0f;
                if (view != null) {
                    f11 = (AndroidUtilities.lerp(AndroidUtilities.dp(33.0f), AndroidUtilities.dp(64.0f), this.f27205i0) / 2.0f) + view.getTranslationX() + view.getLeft();
                    if (view instanceof cx0) {
                    ...
                    if (view2 != null) {
                        f11 = (AndroidUtilities.lerp(AndroidUtilities.dp(33.0f), AndroidUtilities.dp(64.0f), this.f27205i0) / 2.0f) + view2.getTranslationX() + view2.getLeft();
                        if (view2 instanceof cx0) {
            ...
            float interpolation = pr.f29496i.getInterpolation(this.f27205i0);
        ...
        if (!isInEditMode() && this.f27219x != 0 && this.M > 0) {
            int i11 = this.I;
            Paint paint2 = this.H;
            paint2.setColor(i11);
    ...
    public final boolean f(MotionEvent motionEvent) {
        ...
        dm0 dm0Var = this.f27200e0;
        if (action == 0 && this.f27216s == null) {
            this.f27195b0 = true;
            AndroidUtilities.runOnUIThread(dm0Var, 500L);
            this.W = motionEvent.getX();
            this.f27193a0 = motionEvent.getY();
        }
        if (this.f27195b0 && motionEvent.getAction() == 2) {
            float abs = Math.abs(motionEvent.getX() - this.W);
            float f7 = this.G;
            if (abs > f7 || Math.abs(motionEvent.getY() - this.f27193a0) > f7) {
                this.f27195b0 = false;
                AndroidUtilities.cancelRunOnUIThread(dm0Var);
            }
        }
        int action2 = motionEvent.getAction();
        dm0 dm0Var2 = this.f27217s0;
        cc1 cc1Var = this.f27199e;
        if (action2 == 2 && this.f27216s != null) {
            ...
            if (this.U != ceil && e(ceil)) {
                ...
                this.U = ceil;
                cc1Var.removeView(this.f27216s);
                cc1Var.addView(this.f27216s, this.U);
                invalidate();
            }
            this.f27198d0 = this.W - motionEvent.getX();
            float x10 = motionEvent.getX();
            if (x10 < this.f27216s.getMeasuredWidth() / 2.0f) {
                this.f27213q0 = false;
                if (this.f27215r0 <= 0) {
                    this.f27215r0 = System.currentTimeMillis();
                }
                AndroidUtilities.runOnUIThread(dm0Var2, 16L);
            } else if (x10 > getMeasuredWidth() - (this.f27216s.getMeasuredWidth() / 2.0f)) {
                this.f27213q0 = true;
                if (this.f27215r0 <= 0) {
                    this.f27215r0 = System.currentTimeMillis();
                }
    ...
    public final void g(String str, FrameLayout frameLayout, int i10) {
        HashMap hashMap = this.f27209n;
        if (hashMap != null) {
            hashMap.remove(str);
        }
        this.f27214r.put(i10, frameLayout);
    }
    ...
    public float getExpandedOffset() {
        if (this.f27203g0) {
            return AndroidUtilities.dp(50.0f) * this.f27205i0;
        }
        return 0.0f;
    }
    ...
    public final void h() {
        ...
        SparseArray sparseArray = this.f27214r;
    ...
    public final void i(final float f7, final boolean z10) {
        float f10;
        if (this.f27202f0 != z10) {
            this.f27202f0 = z10;
            if (!z10) {
                fling(0);
            }
            ValueAnimator valueAnimator = this.f27204h0;
            if (valueAnimator != null) {
                valueAnimator.removeAllListeners();
                this.f27204h0.cancel();
            }
            float f11 = this.f27205i0;
            if (z10) {
                f10 = 1.0f;
            } else {
                f10 = 0.0f;
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    ...
                    if (!z10) {
                        ...
                        float f12 = f7;
                        float scrollX = (im0Var.getScrollX() + f12) / (im0Var.f27206j0 * cc1Var.getChildCount());
                        ...
                        im0Var.f27208l0 = (im0Var.getScrollX() + f12) - f13;
                    }
                    im0Var.f27205i0 = ((Float) valueAnimator2.getAnimatedValue()).floatValue();
            ...
            this.f27204h0.addListener(new fm0(this, z10, f7, 0));
            this.f27204h0.start();
            cc1 cc1Var = this.f27199e;
            if (z10) {
                this.f27203g0 = true;
            ...
            if (z10) {
                float childCount = this.f27206j0 * cc1Var.getChildCount() * ((getScrollX() + f7) / (this.f27207k0 * cc1Var.getChildCount()));
                this.f27208l0 = childCount - (getScrollX() + f7);
    ...
    public final void m(int i10) {
        if (i10 >= 0 && i10 < this.f27219x) {
            this.f27199e.getChildAt(i10).performClick();
        }
    }
    ...
    public final void q() {
        for (int i10 = 0; i10 < this.f27219x; i10++) {
            View childAt = this.f27199e.getChildAt(i10);
            if (this.f27218w) {
                childAt.setLayoutParams(this.d);
            } else {
                childAt.setLayoutParams(this.f27196c);
            }
        }
    }
    ...
    public void setType(hm0 hm0Var) {
        if (hm0Var != null && this.f27194b != hm0Var) {
            this.f27194b = hm0Var;
