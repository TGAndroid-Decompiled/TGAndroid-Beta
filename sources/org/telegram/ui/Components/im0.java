...
public abstract class im0 extends HorizontalScrollView {
    public static final int f27164t0 = 0;
    public final e6 E;
    ...
    public float W;
    public int f27165a;
    public float f27166a0;
    public hm0 f27167b;
    public boolean f27168b0;
    public final LinearLayout.LayoutParams f27169c;
    public float f27170c0;
    public final LinearLayout.LayoutParams d;
    public float f27171d0;
    public final cc1 f27172e;
    public final dm0 f27173e0;
    public gm0 f27174f;
    public boolean f27175f0;
    public boolean f27176g0;
    public HashMap h;
    public ValueAnimator f27177h0;
    public float f27178i0;
    public final float f27179j0;
    public final float f27180k0;
    public float f27181l0;
    public int m0;
    public HashMap f27182n;
    public final Paint f27183n0;
    public boolean f27184o0;
    public final e6 f27185p0;
    public boolean f27186q0;
    public final SparseArray f27187r;
    public long f27188r0;
    public View f27189s;
    public final dm0 f27190s0;
    public float v;
    ...
    public im0(Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10) {
        super(context);
        this.f27165a = 1;
        this.f27167b = hm0.f26759a;
        this.h = new HashMap();
        this.f27182n = new HashMap();
        this.f27187r = new SparseArray();
        pr prVar = pr.h;
        ...
        this.f27173e0 = new dm0(this, 0);
        this.f27175f0 = false;
        this.f27179j0 = AndroidUtilities.dp(64.0f);
        this.f27180k0 = AndroidUtilities.dp(33.0f);
        this.m0 = -1;
        this.f27183n0 = new Paint();
        this.f27184o0 = true;
        this.f27185p0 = new e6(this, 350L, prVar);
        this.f27190s0 = new dm0(this, 1);
        this.O = f6Var;
        this.P = z10;
        ...
        this.f27169c = new LinearLayout.LayoutParams(AndroidUtilities.dp(33.0f), -1);
    ...
    public final FrameLayout b(int i10, Drawable drawable) {
        ...
        this.f27192x = i12 + 1;
        FrameLayout frameLayout = (FrameLayout) this.f27182n.get(i11);
        boolean z10 = true;
        if (frameLayout != null) {
            ...
            this.f27172e.addView(frameLayout, i12);
        }
    ...
    public final cx0 c(int i10, Drawable drawable) {
        ...
        int i12 = this.f27192x;
        this.f27192x = i12 + 1;
        cx0 cx0Var = (cx0) this.f27182n.get(i11);
        boolean z10 = true;
        if (cx0Var != null) {
            g(i11, cx0Var, i12);
        } else {
            cx0Var = new cx0(getContext(), 1);
            cx0Var.f25111f.setImageDrawable(drawable);
            cx0Var.setFocusable(true);
            cx0Var.setOnClickListener(new bm0(this, 4));
            cx0Var.setExpanded(this.f27175f0);
            cx0Var.a(this.f27178i0);
            this.f27172e.addView(cx0Var, i12);
        }
        cx0Var.d = false;
    ...
    public final void cancelLongPress() {
        ...
        this.f27168b0 = false;
        AndroidUtilities.cancelRunOnUIThread(this.f27173e0);
    }
    ...
    public final void d(boolean z10) {
        ...
        if (z10) {
            ...
            TransitionManager.beginDelayedTransition(this.f27172e, autoTransition);
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f12;
        float f13;
        float f14 = this.f27180k0 - this.f27179j0;
        float f15 = (1.0f - this.f27178i0) * this.f27181l0;
        int i10 = 0;
        while (true) {
            cc1Var = this.f27172e;
            ...
            if (cc1Var.getChildAt(i10) instanceof cx0) {
                ...
                float f16 = cx0Var.f25117y;
                if (cx0Var.getLeft() != f16 && cx0Var.E) {
                    cx0Var.f25108b = f16 - cx0Var.getLeft();
                    ValueAnimator valueAnimator = cx0Var.f25116x;
                    if (valueAnimator != null) {
                        valueAnimator.removeAllListeners();
                        cx0Var.f25116x.cancel();
                    }
                    ValueAnimator ofFloat = ValueAnimator.ofFloat(cx0Var.f25108b, 0.0f);
                    cx0Var.f25116x = ofFloat;
                    ofFloat.addUpdateListener(new bx0(cx0Var, this, 0));
                    cx0Var.f25116x.addListener(new pk0(3, cx0Var, this));
                    cx0Var.f25116x.start();
                }
                cx0Var.E = false;
                if (this.f27176g0) {
                    cx0Var.setTranslationX(com.google.android.gms.internal.vision.e2.z(1.0f, this.f27178i0, i10 * f14, f15) + cx0Var.f25108b);
                } else {
                    cx0Var.setTranslationX(cx0Var.f25108b);
                }
            }
            i10++;
        }
        ...
        if (this.f27176g0) {
            height = com.google.android.gms.internal.vision.e2.b(1.0f, this.f27178i0, AndroidUtilities.dp(50.0f), getHeight());
        }
        float f17 = height;
        if (this.f27184o0) {
            f7 = 1.0f;
        ...
        float d = this.f27185p0.d(f7, false);
        if (!isInEditMode() && this.f27192x != 0 && this.J >= 0) {
            e6 e6Var = this.E;
            float d10 = e6Var.d(this.f27193y, false);
            ...
            if (view != null && view2 != null) {
                f10 = 2.0f;
                float f19 = d10 - floor;
                f11 = AndroidUtilities.lerp((AndroidUtilities.lerp(AndroidUtilities.dp(33.0f), AndroidUtilities.dp(64.0f), this.f27178i0) / 2.0f) + view.getTranslationX() + view.getLeft(), (AndroidUtilities.lerp(AndroidUtilities.dp(33.0f), AndroidUtilities.dp(64.0f), this.f27178i0) / 2.0f) + view2.getTranslationX() + view2.getLeft(), f19);
                ...
                f10 = 2.0f;
                if (view != null) {
                    f11 = (AndroidUtilities.lerp(AndroidUtilities.dp(33.0f), AndroidUtilities.dp(64.0f), this.f27178i0) / 2.0f) + view.getTranslationX() + view.getLeft();
                    if (view instanceof cx0) {
                    ...
                    if (view2 != null) {
                        f11 = (AndroidUtilities.lerp(AndroidUtilities.dp(33.0f), AndroidUtilities.dp(64.0f), this.f27178i0) / 2.0f) + view2.getTranslationX() + view2.getLeft();
                        if (view2 instanceof cx0) {
            ...
            float interpolation = pr.f29469i.getInterpolation(this.f27178i0);
        ...
        if (!isInEditMode() && this.f27192x != 0 && this.M > 0) {
            int i11 = this.I;
            Paint paint2 = this.H;
            paint2.setColor(i11);
    ...
    public final boolean f(MotionEvent motionEvent) {
        ...
        dm0 dm0Var = this.f27173e0;
        if (action == 0 && this.f27189s == null) {
            this.f27168b0 = true;
            AndroidUtilities.runOnUIThread(dm0Var, 500L);
            this.W = motionEvent.getX();
            this.f27166a0 = motionEvent.getY();
        }
        if (this.f27168b0 && motionEvent.getAction() == 2) {
            float abs = Math.abs(motionEvent.getX() - this.W);
            float f7 = this.G;
            if (abs > f7 || Math.abs(motionEvent.getY() - this.f27166a0) > f7) {
                this.f27168b0 = false;
                AndroidUtilities.cancelRunOnUIThread(dm0Var);
            }
        }
        int action2 = motionEvent.getAction();
        dm0 dm0Var2 = this.f27190s0;
        cc1 cc1Var = this.f27172e;
        if (action2 == 2 && this.f27189s != null) {
            ...
            if (this.U != ceil && e(ceil)) {
                ...
                this.U = ceil;
                cc1Var.removeView(this.f27189s);
                cc1Var.addView(this.f27189s, this.U);
                invalidate();
            }
            this.f27171d0 = this.W - motionEvent.getX();
            float x10 = motionEvent.getX();
            if (x10 < this.f27189s.getMeasuredWidth() / 2.0f) {
                this.f27186q0 = false;
                if (this.f27188r0 <= 0) {
                    this.f27188r0 = System.currentTimeMillis();
                }
                AndroidUtilities.runOnUIThread(dm0Var2, 16L);
            } else if (x10 > getMeasuredWidth() - (this.f27189s.getMeasuredWidth() / 2.0f)) {
                this.f27186q0 = true;
                if (this.f27188r0 <= 0) {
                    this.f27188r0 = System.currentTimeMillis();
                }
    ...
    public final void g(String str, FrameLayout frameLayout, int i10) {
        HashMap hashMap = this.f27182n;
        if (hashMap != null) {
            hashMap.remove(str);
        }
        this.f27187r.put(i10, frameLayout);
    }
    ...
    public float getExpandedOffset() {
        if (this.f27176g0) {
            return AndroidUtilities.dp(50.0f) * this.f27178i0;
        }
        return 0.0f;
    }
    ...
    public final void h() {
        ...
        SparseArray sparseArray = this.f27187r;
    ...
    public final void i(final float f7, final boolean z10) {
        float f10;
        if (this.f27175f0 != z10) {
            this.f27175f0 = z10;
            if (!z10) {
                fling(0);
            }
            ValueAnimator valueAnimator = this.f27177h0;
            if (valueAnimator != null) {
                valueAnimator.removeAllListeners();
                this.f27177h0.cancel();
            }
            float f11 = this.f27178i0;
            if (z10) {
                f10 = 1.0f;
            } else {
                f10 = 0.0f;
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    ...
                    if (!z10) {
                        ...
                        float f12 = f7;
                        float scrollX = (im0Var.getScrollX() + f12) / (im0Var.f27179j0 * cc1Var.getChildCount());
                        ...
                        im0Var.f27181l0 = (im0Var.getScrollX() + f12) - f13;
                    }
                    im0Var.f27178i0 = ((Float) valueAnimator2.getAnimatedValue()).floatValue();
            ...
            this.f27177h0.addListener(new fm0(this, z10, f7, 0));
            this.f27177h0.start();
            cc1 cc1Var = this.f27172e;
            if (z10) {
                this.f27176g0 = true;
            ...
            if (z10) {
                float childCount = this.f27179j0 * cc1Var.getChildCount() * ((getScrollX() + f7) / (this.f27180k0 * cc1Var.getChildCount()));
                this.f27181l0 = childCount - (getScrollX() + f7);
    ...
    public final void m(int i10) {
        if (i10 >= 0 && i10 < this.f27192x) {
            this.f27172e.getChildAt(i10).performClick();
        }
    }
    ...
    public final void q() {
        for (int i10 = 0; i10 < this.f27192x; i10++) {
            View childAt = this.f27172e.getChildAt(i10);
            if (this.f27191w) {
                childAt.setLayoutParams(this.d);
            } else {
                childAt.setLayoutParams(this.f27169c);
            }
        }
    }
    ...
    public void setType(hm0 hm0Var) {
        if (hm0Var != null && this.f27167b != hm0Var) {
            this.f27167b = hm0Var;
