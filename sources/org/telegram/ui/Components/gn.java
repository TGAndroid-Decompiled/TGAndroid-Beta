...
public final class gn extends View {
    ...
    public gn(Context context, int i10) {
        super(context);
        this.f25208a = i10;
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.f25208a) {
            ...
            case 6:
                super.onDraw(canvas);
                canvas.drawLine(0.0f, AndroidUtilities.dp(14.0f), 2.0f, getMeasuredHeight() - AndroidUtilities.dp(14.0f), org.telegram.ui.ActionBar.j6.f20000k0);
                return;
            case 13:
            ...
            case 14:
                ...
                canvas.drawLine(dp2, measuredHeight2, measuredWidth2 - i11, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.j6.f20000k0);
                return;
            case 15:
                if (LocaleController.isRTL) {
                    dp3 = 0.0f;
                ...
                canvas.drawLine(dp3, measuredHeight3, measuredWidth3 - i12, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.j6.f20000k0);
                return;
            case 16:
                if (LocaleController.isRTL) {
                    dp4 = 0.0f;
                ...
                canvas.drawLine(dp4, measuredHeight4, measuredWidth4 - i13, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.j6.f20000k0);
                return;
            case 24:
                if (LocaleController.isRTL) {
                    dp5 = 0.0f;
                ...
                canvas.drawLine(dp5, measuredHeight5, measuredWidth5 - i14, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.j6.f20000k0);
                return;
            default:
                super.onDraw(canvas);
                return;
