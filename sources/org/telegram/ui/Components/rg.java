...
public final class rg extends FrameLayout {
    ...
    public ci.f4 f27948a;
    public ci.f4 f27949b;
    public ShapeDrawable f27950c;
    public final Drawable d;
    public final String e;
    public StaticLayout f27951f;
    public float h;
    public final TextPaint f27952n;
    public final Paint f27953r;
    public final Paint f27954s;
    public final Paint v;
    public final Path f27955w;
    public final Paint f27956x;
    public final ci.l f27957y;

    public rg(ChatActivityEnterView chatActivityEnterView, Context context) {
        super(context);
        this.V = chatActivityEnterView;
        TextPaint textPaint = new TextPaint(1);
        this.f27952n = textPaint;
        this.f27953r = new Paint(1);
        this.f27954s = new Paint(1);
        Paint paint = new Paint(1);
        this.v = paint;
        this.f27955w = new Path();
        this.f27956x = new Paint(1);
        this.I = new RectF();
        this.J = new RectF();
        this.L = new Path();
        this.M = r4;
        ...
        drawable.setColorFilter(new PorterDuffColorFilter(chatActivityEnterView.i0(org.telegram.ui.ActionBar.j6.f19079be), PorterDuff.Mode.MULTIPLY));
        this.f27950c = org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(5.0f), chatActivityEnterView.i0(org.telegram.ui.ActionBar.j6.f19356qf));
    ...
    public final void a() {
        ci.f4 f4Var = this.f27948a;
        if (f4Var != null) {
            f4Var.f4637l0 = new pg(this, f4Var, 1);
            f4Var.e(true);
            this.f27948a = null;
        }
        ci.f4 f4Var2 = this.f27949b;
        if (f4Var2 != null) {
            f4Var2.f4637l0 = new pg(this, f4Var2, 2);
            f4Var2.e(true);
            this.f27949b = null;
        }
    }
    ...
    public final void b() {
        ...
        this.f27949b.s(AndroidUtilities.replaceTags(LocaleController.getString(i10)));
        ci.f4 f4Var2 = this.f27949b;
        f4Var2.h = ci.f4.a(f4Var2.getText(), this.f27949b.getTextPaint());
        if (chatActivityEnterView.O) {
            ci.f4 f4Var3 = this.f27949b;
        ...
        addView(this.f27949b, w7.y5.d(-1, -1.0f, 119, 0.0f, 0.0f, 54.0f, 58.0f));
        ci.f4 f4Var4 = this.f27949b;
        f4Var4.f4637l0 = new pg(this, f4Var4, 0);
        f4Var4.u();
    }
    ...
    public final void c() {
        ...
        ChatActivityEnterView chatActivityEnterView = this.V;
        this.f27957y.e(chatActivityEnterView.i0(i10), chatActivityEnterView.i0(org.telegram.ui.ActionBar.j6.f19099cf), -1);
        this.f27952n.setColor(chatActivityEnterView.i0(org.telegram.ui.ActionBar.j6.f19338pf));
        int dp = AndroidUtilities.dp(5.0f);
        int i15 = org.telegram.ui.ActionBar.j6.f19356qf;
        this.f27950c = org.telegram.ui.ActionBar.j6.b0(dp, chatActivityEnterView.i0(i15));
        int i02 = chatActivityEnterView.i0(i15);
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.d.setColorFilter(new PorterDuffColorFilter(i02, mode));
        this.f27953r.setColor(chatActivityEnterView.i0(org.telegram.ui.ActionBar.j6.f19060ae));
        if (this.Q) {
            i11 = org.telegram.ui.ActionBar.j6.Wk;
        } else {
            i11 = org.telegram.ui.ActionBar.j6.Zd;
        }
        this.f27954s.setColor(chatActivityEnterView.i0(i11));
        if (this.Q) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.H != size) {
            this.H = size;
            StaticLayout staticLayout = new StaticLayout(this.e, this.f27952n, AndroidUtilities.dp(220.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, true);
            this.f27951f = staticLayout;
            int lineCount = staticLayout.getLineCount();
            this.h = 0.0f;
            for (int i12 = 0; i12 < lineCount; i12++) {
                float lineWidth = this.f27951f.getLineWidth(i12);
                if (lineWidth > this.h) {
                    this.h = lineWidth;
                }
            }
        ...
        if (action == 0) {
            ...
            if (this.U && rectF.contains(x10, y3)) {
                if (chatActivityEnterView.f21983c1) {
                    ...
                    if (MediaController.getInstance().isRecordingPaused() && (chatActivityEnterView.f22014h1.getAudioLeft() > 0.01f || chatActivityEnterView.f22014h1.getAudioRight() < 0.99f)) {
                        ...
                        if (MessagesController.getGlobalMainSettings().getBoolean("trimvoicehint", true)) {
                            ...
                            alertDialog$Builder.f18669a.R = LocaleController.getString(R.string.RecordingTrimTitle);
                            alertDialog$Builder.f18669a.T = LocaleController.getString(R.string.RecordingTrimText);
    ...
    public void setBlurredBackgroundFactory(ah.c cVar) {
        this.Q = true;
        if (this.P == null) {
            this.P = new dh.b(org.telegram.ui.ActionBar.j6.f19060ae, this.V.W3);
        }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f27957y && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
