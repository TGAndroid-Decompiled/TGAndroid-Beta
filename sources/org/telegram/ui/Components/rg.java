...
public final class rg extends j1.b {
    ...
    public final int g(float f7, float f10) {
        sg sgVar = this.f27960o;
        ChatActivityEnterView chatActivityEnterView = sgVar.V;
        if (chatActivityEnterView.f22048s4 && chatActivityEnterView.N1 != null && chatActivityEnterView.S3.contains(f7, f10)) {
            return 2;
        }
        if (chatActivityEnterView.P && chatActivityEnterView.N1 != null && chatActivityEnterView.f22021n4 > 0.1f && sgVar.J.contains(f7, f10)) {
            return 4;
        }
        return -1;
    }
    ...
    public final void h(ArrayList arrayList) {
        ChatActivityEnterView chatActivityEnterView = this.f27960o.V;
    ...
    public final void l(int i10, s0.d dVar) {
        ...
        if (i10 == 2) {
            ...
            if (chatActivityEnterView.f22031p4 > 0.5f) {
