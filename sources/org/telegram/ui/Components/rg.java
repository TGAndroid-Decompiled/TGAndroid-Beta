...
public final class rg extends FrameLayout {
    ...
    public ci.f4 f27891a;
    public ci.f4 f27892b;
    public ShapeDrawable f27893c;
    public final Drawable d;
    public final String e;
    public StaticLayout f27894f;
    public float h;
    public final TextPaint f27895n;
    public final Paint f27896r;
    public final Paint f27897s;
    public final Paint v;
    public final Path f27898w;
    public final Paint f27899x;
    public final ci.l f27900y;

    public rg(ChatActivityEnterView chatActivityEnterView, Context context) {
        super(context);
        this.V = chatActivityEnterView;
        TextPaint textPaint = new TextPaint(1);
        this.f27895n = textPaint;
        this.f27896r = new Paint(1);
        this.f27897s = new Paint(1);
        Paint paint = new Paint(1);
        this.v = paint;
        this.f27898w = new Path();
        this.f27899x = new Paint(1);
        this.I = new RectF();
        this.J = new RectF();
        this.L = new Path();
        this.M = r4;
        ...
        drawable.setColorFilter(new PorterDuffColorFilter(chatActivityEnterView.i0(org.telegram.ui.ActionBar.j6.f19064be), PorterDuff.Mode.MULTIPLY));
        this.f27893c = org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(5.0f), chatActivityEnterView.i0(org.telegram.ui.ActionBar.j6.f19341qf));
    ...
    public final void a() {
        ci.f4 f4Var = this.f27891a;
        if (f4Var != null) {
            f4Var.f4639l0 = new pg(this, f4Var, 1);
            f4Var.e(true);
            this.f27891a = null;
        }
        ci.f4 f4Var2 = this.f27892b;
        if (f4Var2 != null) {
            f4Var2.f4639l0 = new pg(this, f4Var2, 2);
            f4Var2.e(true);
            this.f27892b = null;
        }
    }
    ...
    public final void b() {
        ...
        this.f27892b.s(AndroidUtilities.replaceTags(LocaleController.getString(i10)));
        ci.f4 f4Var2 = this.f27892b;
        f4Var2.h = ci.f4.a(f4Var2.getText(), this.f27892b.getTextPaint());
        if (chatActivityEnterView.O) {
            ci.f4 f4Var3 = this.f27892b;
        ...
        addView(this.f27892b, w7.y5.d(-1, -1.0f, 119, 0.0f, 0.0f, 54.0f, 58.0f));
        ci.f4 f4Var4 = this.f27892b;
        f4Var4.f4639l0 = new pg(this, f4Var4, 0);
        f4Var4.u();
    }
    ...
    public final void c() {
        ...
        ChatActivityEnterView chatActivityEnterView = this.V;
        this.f27900y.e(chatActivityEnterView.i0(i10), chatActivityEnterView.i0(org.telegram.ui.ActionBar.j6.f19084cf), -1);
        this.f27895n.setColor(chatActivityEnterView.i0(org.telegram.ui.ActionBar.j6.f19323pf));
        int dp = AndroidUtilities.dp(5.0f);
        int i15 = org.telegram.ui.ActionBar.j6.f19341qf;
        this.f27893c = org.telegram.ui.ActionBar.j6.b0(dp, chatActivityEnterView.i0(i15));
        int i02 = chatActivityEnterView.i0(i15);
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.d.setColorFilter(new PorterDuffColorFilter(i02, mode));
        this.f27896r.setColor(chatActivityEnterView.i0(org.telegram.ui.ActionBar.j6.f19045ae));
        if (this.Q) {
            i11 = org.telegram.ui.ActionBar.j6.Wk;
        } else {
            i11 = org.telegram.ui.ActionBar.j6.Zd;
        }
        this.f27897s.setColor(chatActivityEnterView.i0(i11));
        if (this.Q) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.H != size) {
            this.H = size;
            StaticLayout staticLayout = new StaticLayout(this.e, this.f27895n, AndroidUtilities.dp(220.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, true);
            this.f27894f = staticLayout;
            int lineCount = staticLayout.getLineCount();
            this.h = 0.0f;
            for (int i12 = 0; i12 < lineCount; i12++) {
                float lineWidth = this.f27894f.getLineWidth(i12);
                if (lineWidth > this.h) {
                    this.h = lineWidth;
                }
            }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (chatActivityEnterView.P && chatActivityEnterView.M1 != null && chatActivityEnterView.f22028m4 > 0.1f) {
                ...
                if (chatActivityEnterView.f21968c1) {
                    ...
                    if (MediaController.getInstance().isRecordingPaused() && (chatActivityEnterView.f21999h1.getAudioLeft() > 0.01f || chatActivityEnterView.f21999h1.getAudioRight() < 0.99f)) {
                        ...
                        if (MessagesController.getGlobalMainSettings().getBoolean("trimvoicehint", true)) {
                            ...
                            alertDialog$Builder.f18654a.R = LocaleController.getString(R.string.RecordingTrimTitle);
                            alertDialog$Builder.f18654a.T = LocaleController.getString(R.string.RecordingTrimText);
    ...
    public void setBlurredBackgroundFactory(ah.c cVar) {
        this.Q = true;
        if (this.P == null) {
            this.P = new dh.b(org.telegram.ui.ActionBar.j6.f19045ae, this.V.V3);
        }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f27900y && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
