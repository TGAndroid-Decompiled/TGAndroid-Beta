...
public final class zj0 extends s4.s0 {
    ...
    public ValueAnimator f33196c;
    public ValueAnimator d;
    public final fk0 f33197e;
    ...
    public final void b(RecyclerView recyclerView, int i10, int i11) {
        ...
        float f10 = 0.0f;
        if (z10 != this.f33194a) {
            ValueAnimator valueAnimator = this.f33196c;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            float f11 = fk0Var.f26137r;
            if (z10) {
                f7 = 1.0f;
            } else {
                f7 = 0.0f;
            }
            this.f33196c = c(f11, f7, new q0.a(this) {
                public final zj0 f32626b;
                ...
                public final void accept(Object obj) {
                    ...
                    switch (r2) {
                        case 0:
                            fk0 fk0Var2 = this.f32626b.f33197e;
                            Paint paint = fk0Var2.h;
                            float floatValue = f12.floatValue();
                            fk0Var2.f26137r = floatValue;
                            paint.setAlpha((int) (floatValue * 255.0f));
                            fk0Var2.invalidate();
                            return;
                        default:
                            fk0 fk0Var3 = this.f32626b.f33197e;
                            Paint paint2 = fk0Var3.f26132n;
                            float floatValue2 = f12.floatValue();
                            fk0Var3.f26139s = floatValue2;
        ...
        if (j0Var.N0() != fk0Var.f26106a0.h() - 1) {
            z11 = true;
        }
        if (z11 != this.f33195b) {
