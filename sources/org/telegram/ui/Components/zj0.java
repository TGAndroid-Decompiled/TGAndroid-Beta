...
public final class zj0 extends FrameLayout {
    ...
    public zj0(Context context) {
        ...
        this.f31364a = new Paint(1);
        new Path();
        this.f31365b = new RectF();
        this.f31366c = AndroidUtilities.dp(32.0f);
        ...
        this.f31367f = textView;
        textView.setImportantForAccessibility(2);
        textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20087n8, false));
        textView.setTypeface(AndroidUtilities.bold());
        addView(textView, k7.b6.i(-1.0f, -2.0f, 8388627, 40.0f, 0.0f, 8.0f, 0.0f));
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth(AndroidUtilities.dp(1.0f));
        setWillNotDraw(false);
        setOutlineProgress(this.f31368n);
    }
    ...
    public final void a(int i10, TLRPC.ReactionCount reactionCount) {
        ...
        this.f31367f.setText(formatShortNumber);
        mg.q0 d = mg.q0.d(reactionCount.reaction);
        this.v = d;
        String str = d.f14107f;
        ImageView imageView = this.e;
        p9 p9Var = this.d;
        if (str != null) {
            for (TLRPC.TL_availableReaction tL_availableReaction : MediaDataController.getInstance(i10).getReactionsList()) {
                if (tL_availableReaction.reaction.equals(this.v.f14107f)) {
                    p9Var.i(ImageLocation.getForDocument(tL_availableReaction.center_icon), "40_40_lastreactframe", "webp", DocumentObject.getSvgThumb(tL_availableReaction.static_icon, org.telegram.ui.ActionBar.j6.f19852a7, 1.0f), tL_availableReaction);
        ...
        p9Var.setAnimatedEmojiDrawable(new l5(0, i10, this.v.f14108g));
        p9Var.setVisibility(0);
        imageView.setVisibility(8);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        RectF rectF = this.f31365b;
        rectF.set(0.0f, 0.0f, getWidth(), getHeight());
        float f10 = this.f31366c;
        canvas.drawRoundRect(rectF, f10, f10, this.f31364a);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f31368n > 0.5d) {
            accessibilityNodeInfo.setSelected(true);
        }
        mg.q0 q0Var = this.v;
        if (q0Var != null) {
            accessibilityNodeInfo.setText(LocaleController.formatPluralString("AccDescrNumberOfPeopleReactions", this.f31370s, q0Var));
        } else {
            accessibilityNodeInfo.setText(LocaleController.formatPluralString("ReactionsCount", this.f31370s, new Object[0]));
        }
    }
    ...
    public void setOutlineProgress(float f10) {
        ...
        this.f31364a.setColor(i0.a.d(f10, k10, w02));
        this.f31367f.setTextColor(d);
        this.f31369r.setColorFilter(new PorterDuffColorFilter(d, PorterDuff.Mode.MULTIPLY));
        float f11 = this.f31366c;
        View view = this.h;
        if (f10 == 1.0f) {
            int i12 = (int) f11;
