...
public final class wq {
    ...
    public ValueAnimator f30155k;
    public float f30157m;
    public StaticLayout f30158n;
    public StaticLayout f30159o;
    public StaticLayout f30160p;
    public StaticLayout f30161q;
    public int f30162r;
    public int f30163s;
    public int f30164t;
    public int f30165u;
    public int f30167x;
    public int f30168y;
    public float f30149b = 1.0f;
    public int f30150c = -1;
    public TextPaint e = new TextPaint(1);
    public final RectF f30151f = new RectF();
    public float f30156l = 1.0f;
    public int v = org.telegram.ui.ActionBar.h6.f19344sf;
    public int f30166w = org.telegram.ui.ActionBar.h6.f19362tf;
    public int f30169z = 17;
    ...
    public final void a(Canvas canvas) {
        ...
        if (i10 != 1 && i10 != 2) {
            ...
            int v03 = org.telegram.ui.ActionBar.h6.v0(this.f30166w, d6Var);
            if (this.f30165u != v02) {
                this.f30165u = v02;
                this.e.setColor(v02);
            }
            Paint paint2 = this.d;
            if (paint2 != null && this.f30164t != v03) {
                this.f30164t = v03;
                paint2.setColor(v03);
            }
        }
        float f11 = this.f30156l;
        if (f11 != 1.0f) {
            ...
            if (i12 != 0 && i12 != 1) {
                ...
                int i13 = this.f30167x;
                float f13 = this.C;
                float f14 = f13 * 2.0f;
                float dp2 = (i13 - AndroidUtilities.dp(f14)) / 2.0f;
                int i14 = this.f30163s;
                int i15 = this.f30162r;
                if (i14 == i15) {
                    z10 = i14;
                } else {
                ...
                e(z10);
                if (this.f30154j) {
                    float f15 = this.f30156l;
                    if (f15 <= 0.5f) {
                        interpolation = rr.f28031g.getInterpolation(f15 * 2.0f);
                    } else {
                        interpolation = rr.f28032i.getInterpolation(1.0f - ((f15 - 0.5f) * 2.0f));
                    }
                ...
                if (this.f30149b != 1.0f) {
                    canvas.save();
                    float f17 = this.f30149b;
                ...
                if (this.F && (paint = this.d) != null) {
                    ...
                    if (this.f30152g && org.telegram.ui.ActionBar.h6.a1()) {
                ...
                if (this.f30161q != null) {
                    ...
                    this.f30161q.draw(canvas);
                    canvas.restore();
                } else if (this.f30158n != null) {
                    canvas.save();
                    float f21 = this.A;
            ...
            e(this.f30163s);
            float f23 = (this.f30163s / 2.0f) + this.A;
            float f24 = this.f30167x / 2.0f;
            canvas.save();
            if (this.f30150c == 0) {
                f7 = this.f30156l;
            } else {
                f7 = 1.0f - this.f30156l;
            }
    ...
    public final void b(Canvas canvas) {
        ...
        float f7 = this.C;
        float f10 = f7 * 2.0f;
        float dp = (this.f30167x - AndroidUtilities.dp(f10)) / 2.0f;
        e(this.f30163s);
        float f11 = this.B;
        RectF rectF = this.f30151f;
        rectF.set(f11, dp, this.f30163s + f11 + AndroidUtilities.dp(f7 - 0.5f), AndroidUtilities.dp(f10) + dp);
        if (this.d != null && this.F) {
            if (this.f30149b != 1.0f) {
                canvas.save();
                float f12 = this.f30149b;
    ...
    public final void c(int i10, boolean z10) {
        ...
        String str = valueOf;
        if (!TextUtils.equals(str, this.f30153i)) {
            ValueAnimator valueAnimator = this.f30155k;
            ...
            if (!z11) {
                ...
                this.f30163s = Math.max(AndroidUtilities.dp(12.0f), (int) Math.ceil(this.e.measureText(str.toString())));
                StaticLayout staticLayout = new StaticLayout(str, this.e, this.f30163s, Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
                this.f30158n = staticLayout;
                if (staticLayout.getLineCount() >= 1) {
                    f7 = this.f30158n.getLineWidth(0);
                }
                this.f30157m = f7;
                View view3 = this.H;
                if (view3 != null) {
            ...
            if (z11) {
                ValueAnimator valueAnimator2 = this.f30155k;
                if (valueAnimator2 != null) {
                    valueAnimator2.cancel();
                }
                this.f30156l = 0.0f;
                ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                this.f30155k = ofFloat;
                ofFloat.addUpdateListener(new k6(this, 14));
                this.f30155k.addListener(new r8(this, 15));
                if (this.h <= 0) {
                    this.f30150c = 0;
                    this.f30155k.setDuration(220L);
                    this.f30155k.setInterpolator(new OvershootInterpolator());
                } else if (i10 == 0) {
                    this.f30150c = 1;
                    this.f30155k.setDuration(150L);
                    this.f30155k.setInterpolator(rr.f28030f);
                } else {
                    this.f30150c = 2;
                    this.f30155k.setDuration(430L);
                    this.f30155k.setInterpolator(rr.f28030f);
                }
                if (this.f30158n != null) {
                    String str2 = this.f30153i;
                    if (str2.length() == str.length()) {
                        ...
                        this.f30159o = new StaticLayout(spannableStringBuilder, textPaint, max, alignment, 1.0f, 0.0f, false);
                        this.f30160p = new StaticLayout(spannableStringBuilder3, this.e, max, alignment, 1.0f, 0.0f, false);
                        this.f30161q = new StaticLayout(spannableStringBuilder2, this.e, max, alignment, 1.0f, 0.0f, false);
                    } else {
                        this.f30159o = this.f30158n;
                    }
                }
                this.f30162r = this.f30163s;
                if (i10 > this.h) {
                    z12 = true;
                } else {
                    z12 = false;
            ...
            if (i10 > 0) {
                this.f30163s = Math.max(AndroidUtilities.dp(12.0f), (int) Math.ceil(this.e.measureText(str.toString())));
                StaticLayout staticLayout2 = new StaticLayout(str, this.e, this.f30163s, Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
                this.f30158n = staticLayout2;
    ...
    public final void e(float f7) {
        ...
        int i10 = this.f30169z;
        if (i10 == 5) {
            float f11 = this.f30168y - f10;
            this.A = f11;
            float f12 = this.E;
            if (f12 != 0.0f) {
            ...
            this.A = (int) ((this.f30168y - f7) / 2.0f);
        }
        this.B = this.A - f10;
    }
}
