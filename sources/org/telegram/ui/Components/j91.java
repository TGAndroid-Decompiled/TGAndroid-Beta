...
public final class j91 extends AsyncTask {
    ...
    public j91(p91 p91Var, String str, int i10) {
        ...
        switch (i10) {
            case 1:
                this.d = p91Var;
                this.f25355c = new String[4];
                this.f25354b = str;
                return;
            case 2:
                this.d = p91Var;
                this.f25355c = new String[2];
                this.f25354b = str;
                return;
            case 3:
                this.d = p91Var;
    ...
    public final Object doInBackground(Object[] objArr) {
        switch (this.f25353a) {
            case 0:
                ...
                String[] strArr = this.f25355c;
                Locale locale = Locale.US;
                this.d.getClass();
                String c10 = p91.c(this, "http://www.aparat.com/video/video/embed/vt/frame/showvideo/yes/videohash/" + this.f25354b, null, true);
                if (isCancelled()) {
                    return null;
                }
                try {
                    Matcher matcher = p91.f27273r0.matcher(c10);
                    if (matcher.find()) {
            ...
            case 1:
                ...
                String[] strArr2 = this.f25355c;
                Locale locale2 = Locale.US;
                this.d.getClass();
                String c11 = p91.c(this, "https://coub.com/api/v2/coubs/" + this.f25354b + ".json", null, true);
                if (isCancelled()) {
                    return null;
                }
                try {
            ...
            case 2:
                ...
                try {
                    Matcher matcher2 = p91.f27274s0.matcher(c12);
                    if (matcher2.find()) {
            ...
            case 3:
                ...
                String[] strArr4 = this.f25355c;
                HashMap hashMap = new HashMap();
                hashMap.put("Client-ID", "jzkbprff40iqj646a697cyrvl0zt2m6");
                int indexOf = this.f25354b.indexOf(38);
                if (indexOf > 0) {
                    this.f25354b = this.f25354b.substring(0, indexOf);
                }
                Locale locale3 = Locale.US;
                this.d.getClass();
                String c13 = p91.c(this, "https://api.twitch.tv/kraken/streams/" + this.f25354b + "?stream_type=all", hashMap, false);
                if (isCancelled()) {
                    return null;
                }
                try {
                    new JSONObject(c13).getJSONObject("stream");
                    JSONObject jSONObject3 = new JSONObject(p91.c(this, "https://api.twitch.tv/api/channels/" + this.f25354b + "/access_token", hashMap, false));
                    ...
                    URLEncoder.encode("https://youtube.googleapis.com/v/" + this.f25354b, "UTF-8");
            ...
            default:
                ...
                String[] strArr5 = this.f25355c;
                Locale locale4 = Locale.US;
                this.d.getClass();
                String c14 = p91.c(this, "https://player.vimeo.com/video/" + this.f25354b + "/config", null, true);
                if (isCancelled()) {
                    return null;
                }
                try {
    ...
    public final void onPostExecute(Object obj) {
        switch (this.f25353a) {
            ...
            case 1:
                ...
                p91 p91Var2 = this.d;
                if (str2 != null) {
                    p91Var2.f27300w = true;
                    p91Var2.f27301x = str2;
                    String[] strArr = this.f25355c;
                    p91Var2.f27302y = strArr[1];
                    p91Var2.E = strArr[2];
                    p91Var2.F = strArr[3];
                    if (p91Var2.f27299s) {
                        p91Var2.i();
            ...
            case 2:
                ...
                p91 p91Var3 = this.d;
                if (str3 != null) {
                    p91Var3.f27300w = true;
                    p91Var3.f27301x = str3;
                    p91Var3.f27302y = this.f25355c[1];
                    if (p91Var3.f27299s) {
                        p91Var3.i();
                    }
                    p91Var3.j(false, true);
                    p91Var3.f27291f0.d(true, true);
                    return;
                } else if (!isCancelled()) {
                    p91Var3.h();
                    return;
            ...
            case 3:
                ...
                p91 p91Var4 = this.d;
                if (str4 != null) {
                    p91Var4.f27300w = true;
                    p91Var4.f27301x = str4;
                    p91Var4.f27302y = this.f25355c[1];
                    if (p91Var4.f27299s) {
                        p91Var4.i();
                    }
                    p91Var4.j(false, true);
                    p91Var4.f27291f0.d(true, true);
                    return;
                } else if (!isCancelled()) {
                    p91Var4.h();
                    return;
            ...
            default:
                ...
                p91 p91Var5 = this.d;
                if (str5 != null) {
                    p91Var5.f27300w = true;
                    p91Var5.f27301x = str5;
                    p91Var5.f27302y = this.f25355c[1];
                    if (p91Var5.f27299s) {
                        p91Var5.i();
                    }
                    p91Var5.j(false, true);
                    p91Var5.f27291f0.d(true, true);
                    return;
                } else if (!isCancelled()) {
                    p91Var5.h();
                    return;
