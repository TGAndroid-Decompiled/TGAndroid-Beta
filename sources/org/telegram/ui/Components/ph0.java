...
public final class ph0 extends p9 implements nv0 {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        org.telegram.ui.vu0 vu0Var = vh0Var.f29475e1;
        if (vu0Var == null || !vu0Var.f39259n) {
            if (this.E != null) {
                ...
                if (k10 >= arrayList.size() || arrayList.get(k10) == null ? !(drawable == null || (this.I && (!(drawable instanceof y5) || ((y5) drawable).d[4] <= 0))) : ((Float) arrayList.get(k10)).floatValue() >= 1.0f) {
                    if (this.F == null) {
                        ...
                        this.F.addUpdateListener(new i70(this, 4));
                    ...
                    if (this.H < 0) {
                        ...
                        if (currentTimeMillis <= 250 + j10 && currentTimeMillis > j10) {
                            this.E.E = nr.f27346f.getInterpolation(((float) (currentTimeMillis - j10)) / 250.0f);
                        }
                    }
                    if (vh0Var.f29474d1) {
                        invalidate();
                ...
                int i10 = vh0Var.f29480j1;
                if (i10 == 0 && vh0Var.f29481k1 == 0) {
                    canvas.drawRect(0.0f, 0.0f, getWidth(), getHeight(), this.K);
                    canvas2 = canvas;
                } else {
                    canvas2 = canvas;
                    int i11 = vh0Var.f29481k1;
                    Paint paint = this.K;
                    if (i10 == i11) {
                        rectF.set(0.0f, 0.0f, getWidth(), getHeight());
                        float f10 = vh0Var.f29480j1;
                        canvas2.drawRoundRect(rectF, f10, f10, paint);
                    } else {
                        path.reset();
                        rectF.set(0.0f, 0.0f, getWidth(), getHeight());
                        for (int i12 = 0; i12 < 4; i12++) {
                            fArr[i12] = vh0Var.f29480j1;
                            fArr[i12 + 4] = vh0Var.f29481k1;
                        }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        if (this.E != null) {
            if (this.M.f29487w0.getOccupyStatusBar()) {
            ...
            radialProgress2.q((i10 - i15) / 2, kh.a2.d(i16, i15, 2, currentActionBarHeight), (i10 + i15) / 2, ((i16 + i15) / 2) + currentActionBarHeight);
        }
    }
