...
public class ph0 extends wp implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final ArrayList f27032a1;
    public final ArrayList f27033b1;
    public int f27034c1;
    public final SparseArray f27035d1;
    public boolean f27036e1;
    public boolean f27037f1;
    public boolean f27038g1;
    public org.telegram.ui.rv0 f27039h1;
    public boolean f27040i1;
    public int f27041j1;
    public int f27042k1;
    public int l1;
    public int f27043m1;
    ...
    public int f27045o1;
    public gh0 f27046p1;
    public ImageLocation f27047q1;
    public ImageLocation f27048r1;
    public final PointF f27049x0;
    public final int f27050y0;
    public final org.telegram.ui.ActionBar.k f27051z0;

    public ph0(Context context, org.telegram.ui.ActionBar.k kVar, ml0 ml0Var, org.telegram.ui.q4 q4Var) {
        super(context);
        this.f27049x0 = new PointF();
        this.A0 = true;
        this.B0 = true;
        ...
        this.f27032a1 = new ArrayList();
        this.f27033b1 = new ArrayList();
        this.f27035d1 = new SparseArray();
        this.f27036e1 = true;
        this.f27041j1 = -1;
        this.f27042k1 = -1;
        ...
        this.f27051z0 = kVar;
        this.f27050y0 = ViewConfiguration.get(context).getScaledTouchSlop();
        this.G0 = q4Var;
        b(new hh0(this));
    ...
    public final void A(ImageLocation imageLocation, ImageLocation imageLocation2) {
        ...
        this.W0.add(0, null);
        this.V0.add(0, null);
        this.f27032a1.add(0, -1);
        this.f27033b1.add(0, Float.valueOf(0.0f));
        this.D0.g();
        L();
        this.f27047q1 = imageLocation;
        this.f27048r1 = imageLocation2;
    }

    public final void B(float f7, int i10) {
        float f10;
        int i11 = this.f27041j1;
        float f11 = 0.0f;
        if (i11 >= 0 || this.f27042k1 >= 0) {
            if (i11 < 0) {
                i11 = this.f27042k1;
            }
    ...
    public final View E(int i10) {
        oh0 oh0Var = this.D0;
        if (oh0Var != null) {
            ArrayList arrayList = oh0Var.f26737c;
            if (arrayList.size() > i10 && i10 >= 0) {
                lh0 lh0Var = (lh0) arrayList.get(i10);
                mh0 mh0Var = lh0Var.f25906b;
                if (mh0Var == null) {
                    return lh0Var.f25907c;
                }
                return mh0Var;
            }
            return null;
    ...
    public final boolean H(r61 r61Var, ImageLocation imageLocation, ImageLocation imageLocation2, boolean z10) {
        ...
        int i11 = 0;
        if (imageLocation != null && imageLocation2 != null && this.f27034c1 == 0) {
    ...
    public final void N(int i10, int i11) {
        ...
        oh0 oh0Var = this.D0;
        if (oh0Var != null) {
            for (int i12 = 0; i12 < oh0Var.f26737c.size(); i12++) {
                if (((lh0) oh0Var.f26737c.get(i12)).f25907c != null) {
                    jh0 jh0Var = ((lh0) oh0Var.f26737c.get(i12)).f25907c;
                    int i13 = this.f27043m1;
                    int i14 = this.f27044n1;
        ...
        if (imageLocation != null) {
            ...
            while (true) {
                ...
                if (i10 >= arrayList.size()) {
                    ...
                    this.f27033b1.set(i10, Float.valueOf(f7));
                    SparseArray sparseArray = this.f27035d1;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i16) {
            ...
            if (ph0Var2.S0 == dialogPhotos2) {
                ArrayList arrayList7 = new ArrayList(dialogPhotos2.photos);
                if (!arrayList7.isEmpty() || !dialogPhotos2.fromCache) {
                    ph0Var2.f27041j1 = -1;
                    ph0Var2.f27042k1 = -1;
                    int i17 = ph0Var2.L0;
                    TLRPC.User user4 = MessagesController.getInstance(i17).getUser(Long.valueOf(ph0Var2.E0));
                    TLRPC.UserFull userFull = MessagesController.getInstance(i17).getUserFull(ph0Var2.E0);
                    ...
                    if (user4 != null && user4.self && UserObject.hasFallbackPhoto(userFull)) {
                        ...
                        ph0Var2.f27042k1 = arrayList7.size() - 1;
                    }
                    arrayList5.clear();
                    arrayList6.clear();
                    ...
                    arrayList12.clear();
                    ArrayList arrayList13 = ph0Var2.f27032a1;
                    arrayList13.clear();
                    ArrayList arrayList14 = ph0Var2.f27033b1;
                    arrayList14.clear();
                    if (DialogObject.isChatDialog(ph0Var2.E0)) {
                        TLRPC.Chat chat = MessagesController.getInstance(i17).getChat(Long.valueOf(-ph0Var2.E0));
                        ...
                        if (imageLocation != null) {
                            ...
                            if (chatFull != null && FileLoader.isSamePhoto((TLRPC.FileLocation) imageLocation.location, chatFull.chat_photo)) {
                                ...
                                if (!ph0Var2.F0.chat_photo.video_sizes.isEmpty()) {
                                    TLRPC.VideoSize closestVideoSizeWithSize = FileLoader.getClosestVideoSizeWithSize(ph0Var2.F0.chat_photo.video_sizes, 1000);
                            ...
                            if (closestPhotoSizeWithSize2 != null) {
                                ...
                                if (forPhoto != null) {
                                    ...
                                    if (imageLocation3 != null) {
                                        if (imageLocation3.photoId == forPhoto.photoId && !z10 && ph0Var2.E0 != UserConfig.getInstance(i13).getClientUserId()) {
                                            arrayList5.add(null);
                                            ...
                                            if (!photo2.video_sizes.isEmpty()) {
                                                ...
                                                if (vectorMarkupVideoSize != null) {
                                                    ...
                                                    arrayList11.add(new r61(vectorMarkupVideoSize, z14, 2));
                                                    obj = null;
                                                    arrayList9.add(null);
                                                    arrayList6.add(null);
                                                } else {
                                    ...
                                    if (!photo2.video_sizes.isEmpty()) {
                                        ...
                                        if (vectorMarkupVideoSize2 != null) {
                                            ...
                                            user = user2;
                                            arrayList11.add(new r61(vectorMarkupVideoSize2, z13, 2));
                                            z12 = false;
                                            arrayList9.add(null);
                                            arrayList6.add(null);
                                        } else {
                    ...
                    if (ph0Var.f27042k1 < 0 && ph0Var.f27041j1 < 0) {
                        z11 = false;
                        ph0Var.B(0.0f, 0);
                    } else {
                        z11 = false;
                    ...
                    ImageLocation imageLocation5 = ph0Var.f27047q1;
                    if (imageLocation5 != null) {
                        ph0Var.A(imageLocation5, ph0Var.f27048r1);
                        return;
                    }
                    return;
                }
        ...
        SparseArray sparseArray = ph0Var2.f27035d1;
        if (i10 == i28) {
        ...
        } else if (i10 == NotificationCenter.reloadDialogPhotos && ph0Var2.f27034c1 == 0 && (dialogPhotos = ph0Var2.S0) != null) {
            dialogPhotos.reset();
            MessagesController.DialogPhotos dialogPhotos3 = ph0Var2.S0;
    ...
    public u9 getCurrentItemView() {
        oh0 oh0Var = this.D0;
        if (oh0Var != null && !oh0Var.f26737c.isEmpty()) {
            return ((lh0) oh0Var.f26737c.get(getCurrentItem())).f25907c;
        }
        return null;
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        gh0 gh0Var = this.f27046p1;
        if (gh0Var != null) {
            gh0Var.setTranslationY(getHeight() - this.f27046p1.getMeasuredHeight());
        }
    }
    ...
    public final boolean onTouchEvent(android.view.MotionEvent r22) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.ph0.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public ph0(Context context, long j3, org.telegram.ui.ActionBar.k kVar, ml0 ml0Var, org.telegram.ui.o01 o01Var, kh0 kh0Var, gh0 gh0Var) {
        ...
        this.f27041j1 = -1;
        this.f27042k1 = -1;
        this.f27046p1 = gh0Var;
        setPadding(0, 0, 0, gh0Var == null ? 0 : gh0Var.f24223n);
        if (gh0Var != null) {
            gh0Var.setView(this);
        }
        setVisibility(8);
