...
public class ph0 extends wp implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final ArrayList f27029a1;
    public final ArrayList f27030b1;
    public int f27031c1;
    public final SparseArray f27032d1;
    public boolean f27033e1;
    public boolean f27034f1;
    public boolean f27035g1;
    public org.telegram.ui.rv0 f27036h1;
    public boolean f27037i1;
    public int f27038j1;
    public int f27039k1;
    public int l1;
    public int f27040m1;
    ...
    public int f27042o1;
    public gh0 f27043p1;
    public ImageLocation f27044q1;
    public ImageLocation f27045r1;
    public final PointF f27046x0;
    public final int f27047y0;
    public final org.telegram.ui.ActionBar.k f27048z0;

    public ph0(Context context, org.telegram.ui.ActionBar.k kVar, ml0 ml0Var, org.telegram.ui.q4 q4Var) {
        super(context);
        this.f27046x0 = new PointF();
        this.A0 = true;
        this.B0 = true;
        ...
        this.f27029a1 = new ArrayList();
        this.f27030b1 = new ArrayList();
        this.f27032d1 = new SparseArray();
        this.f27033e1 = true;
        this.f27038j1 = -1;
        this.f27039k1 = -1;
        ...
        this.f27048z0 = kVar;
        this.f27047y0 = ViewConfiguration.get(context).getScaledTouchSlop();
        this.G0 = q4Var;
        b(new hh0(this));
    ...
    public final void A(ImageLocation imageLocation, ImageLocation imageLocation2) {
        ...
        this.W0.add(0, null);
        this.V0.add(0, null);
        this.f27029a1.add(0, -1);
        this.f27030b1.add(0, Float.valueOf(0.0f));
        this.D0.g();
        L();
        this.f27044q1 = imageLocation;
        this.f27045r1 = imageLocation2;
    }

    public final void B(float f7, int i10) {
        float f10;
        int i11 = this.f27038j1;
        float f11 = 0.0f;
        if (i11 >= 0 || this.f27039k1 >= 0) {
            if (i11 < 0) {
                i11 = this.f27039k1;
            }
    ...
    public final View E(int i10) {
        oh0 oh0Var = this.D0;
        if (oh0Var != null) {
            ArrayList arrayList = oh0Var.f26734c;
            if (arrayList.size() > i10 && i10 >= 0) {
                lh0 lh0Var = (lh0) arrayList.get(i10);
                mh0 mh0Var = lh0Var.f25903b;
                if (mh0Var == null) {
                    return lh0Var.f25904c;
                }
                return mh0Var;
            }
            return null;
    ...
    public final boolean H(r61 r61Var, ImageLocation imageLocation, ImageLocation imageLocation2, boolean z10) {
        ...
        int i11 = 0;
        if (imageLocation != null && imageLocation2 != null && this.f27031c1 == 0) {
    ...
    public final void N(int i10, int i11) {
        ...
        oh0 oh0Var = this.D0;
        if (oh0Var != null) {
            for (int i12 = 0; i12 < oh0Var.f26734c.size(); i12++) {
                if (((lh0) oh0Var.f26734c.get(i12)).f25904c != null) {
                    jh0 jh0Var = ((lh0) oh0Var.f26734c.get(i12)).f25904c;
                    int i13 = this.f27040m1;
                    int i14 = this.f27041n1;
        ...
        if (imageLocation != null) {
            ...
            while (true) {
                ...
                if (i10 >= arrayList.size()) {
                    ...
                    this.f27030b1.set(i10, Float.valueOf(f7));
                    SparseArray sparseArray = this.f27032d1;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
            ...
            if (ph0Var2.S0 == dialogPhotos2) {
                ...
                if (!arrayList7.isEmpty() || !dialogPhotos2.fromCache) {
                    ...
                    if (user4 != null && user4.self && UserObject.hasFallbackPhoto(userFull)) {
                        ...
                        ph0Var2.f27039k1 = arrayList7.size() - 1;
                    }
                    arrayList5.clear();
                    arrayList6.clear();
                    ...
                    arrayList12.clear();
                    ArrayList arrayList13 = ph0Var2.f27029a1;
                    arrayList13.clear();
                    ArrayList arrayList14 = ph0Var2.f27030b1;
                    arrayList14.clear();
                    ...
                    if (ph0Var.f27039k1 < 0 && ph0Var.f27038j1 < 0) {
                        z11 = false;
                        ph0Var.B(0.0f, 0);
                    } else {
                        z11 = false;
                    ...
                    ImageLocation imageLocation5 = ph0Var.f27044q1;
                    if (imageLocation5 != null) {
                        ph0Var.A(imageLocation5, ph0Var.f27045r1);
                        return;
                    }
                    return;
                }
        ...
        SparseArray sparseArray = ph0Var2.f27032d1;
        if (i10 == i28) {
        ...
        } else if (i10 == NotificationCenter.reloadDialogPhotos && ph0Var2.f27031c1 == 0 && (dialogPhotos = ph0Var2.S0) != null) {
            dialogPhotos.reset();
    ...
    public u9 getCurrentItemView() {
        oh0 oh0Var = this.D0;
        if (oh0Var != null && !oh0Var.f26734c.isEmpty()) {
            return ((lh0) oh0Var.f26734c.get(getCurrentItem())).f25904c;
        }
        return null;
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        gh0 gh0Var = this.f27043p1;
        if (gh0Var != null) {
            gh0Var.setTranslationY(getHeight() - this.f27043p1.getMeasuredHeight());
        }
    }
    ...
    public ph0(Context context, long j3, org.telegram.ui.ActionBar.k kVar, ml0 ml0Var, org.telegram.ui.o01 o01Var, kh0 kh0Var, gh0 gh0Var) {
        ...
        this.f27038j1 = -1;
        this.f27039k1 = -1;
        this.f27043p1 = gh0Var;
        setPadding(0, 0, 0, gh0Var == null ? 0 : gh0Var.f24220n);
        if (gh0Var != null) {
            gh0Var.setView(this);
        }
        setVisibility(8);
