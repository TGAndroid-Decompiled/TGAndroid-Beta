...
public final class gc0 {
    public final Shader.TileMode f24170a;
    public final Matrix f24171b = new Matrix();
    public boolean f24172c;
    public BitmapShader d;
    public WeakReference e;

    public gc0(Shader.TileMode tileMode) {
        this.f24170a = tileMode;
    }
    ...
    public final boolean b(Bitmap bitmap) {
        ...
        Shader.TileMode tileMode = this.f24170a;
        BitmapShader bitmapShader = new BitmapShader(bitmap, tileMode, tileMode);
        this.d = bitmapShader;
        bitmapShader.setLocalMatrix(this.f24171b);
