...
public final class gc0 {
    public final Shader.TileMode f24295a;
    public final Matrix f24296b = new Matrix();
    public boolean f24297c;
    public BitmapShader d;
    public WeakReference e;

    public gc0(Shader.TileMode tileMode) {
        this.f24295a = tileMode;
    }
    ...
    public final boolean b(Bitmap bitmap) {
        ...
        Shader.TileMode tileMode = this.f24295a;
        BitmapShader bitmapShader = new BitmapShader(bitmap, tileMode, tileMode);
        this.d = bitmapShader;
        bitmapShader.setLocalMatrix(this.f24296b);
