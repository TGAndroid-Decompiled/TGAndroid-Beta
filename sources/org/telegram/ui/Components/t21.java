...
public final class t21 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.f6 f28000b;
    public zo0 f28001c;
    public final c90 d;
    public final m6 e;
    public final ai.n4 f28002f;
    public final ImageView h;
    public boolean f28003n;
    public final c6 f28004r;
    public boolean f28005s;
    public int v;
    public long f28006w;
    public boolean f28007x;
    public boolean f28008y;

    public t21(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f28004r = new c6(this, 360L, qr.h);
        this.f28005s = false;
        this.f28007x = false;
        this.f28008y = false;
    ...
    public int getTextColor() {
        ...
        org.telegram.ui.ActionBar.f6 f6Var = this.f28000b;
    ...
    public final void b(long j3, TLRPC.TL_forumTopic tL_forumTopic, boolean z10) {
        ...
        setSelected(z10);
        h();
        e(tL_forumTopic.unread_count, MessagesController.getInstance(this.f27999a).isDialogMuted(j3, this.f28006w), z11);
    ...
    public final void d(boolean z10, boolean z11, boolean z12) {
        ...
        if (z10) {
            ...
            q21Var.f27200b.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Oh, this.f28000b));
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (view == this.d) {
            canvas.save();
            float e = this.f28004r.e(this.f28003n);
            if (e > 0.0f) {
                if (this.f28001c == null) {
                    this.f28001c = new zo0(this);
                }
                canvas.translate(getWidth() / 2.0f, getHeight() / 2.0f);
                this.f28001c.a(canvas, e);
                canvas.translate((-getWidth()) / 2.0f, (-getHeight()) / 2.0f);
            }
    ...
    public final void g(long j3, TLRPC.TL_forumTopic tL_forumTopic, boolean z10) {
        ...
        if (this.f28006w == peerDialogId) {
            z11 = true;
        } else {
            z11 = false;
        }
        this.f28006w = peerDialogId;
        this.h.setVisibility(8);
        c90 c90Var = this.d;
        c90Var.setVisibility(0);
        ...
        if (userOrChat != null) {
            ...
            f9 f9Var = g5Var3.f33850c;
            f9Var.j(g5Var3.e, userOrChat);
            g5Var3.f33849b.setForUserOrChat(userOrChat, f9Var);
