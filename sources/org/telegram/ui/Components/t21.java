...
public final class t21 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.f6 f28003b;
    public zo0 f28004c;
    public final c90 d;
    public final m6 e;
    public final ai.n4 f28005f;
    public final ImageView h;
    public boolean f28006n;
    public final c6 f28007r;
    public boolean f28008s;
    public int v;
    public long f28009w;
    public boolean f28010x;
    public boolean f28011y;

    public t21(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f28007r = new c6(this, 360L, qr.h);
        this.f28008s = false;
        this.f28010x = false;
        this.f28011y = false;
    ...
    public int getTextColor() {
        ...
        org.telegram.ui.ActionBar.f6 f6Var = this.f28003b;
    ...
    public final void b(long j3, TLRPC.TL_forumTopic tL_forumTopic, boolean z10) {
        ...
        setSelected(z10);
        h();
        e(tL_forumTopic.unread_count, MessagesController.getInstance(this.f28002a).isDialogMuted(j3, this.f28009w), z11);
    ...
    public final void d(boolean z10, boolean z11, boolean z12) {
        ...
        if (z10) {
            ...
            q21Var.f27203b.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Oh, this.f28003b));
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (view == this.d) {
            canvas.save();
            float e = this.f28007r.e(this.f28006n);
            if (e > 0.0f) {
                if (this.f28004c == null) {
                    this.f28004c = new zo0(this);
                }
                canvas.translate(getWidth() / 2.0f, getHeight() / 2.0f);
                this.f28004c.a(canvas, e);
                canvas.translate((-getWidth()) / 2.0f, (-getHeight()) / 2.0f);
            }
    ...
    public final void g(long j3, TLRPC.TL_forumTopic tL_forumTopic, boolean z10) {
        ...
        if (this.f28009w == peerDialogId) {
            z11 = true;
        } else {
            z11 = false;
        }
        this.f28009w = peerDialogId;
        this.h.setVisibility(8);
        c90 c90Var = this.d;
        c90Var.setVisibility(0);
        ...
        if (userOrChat != null) {
            ...
            f9 f9Var = g5Var3.f33854c;
            f9Var.j(g5Var3.e, userOrChat);
            g5Var3.f33853b.setForUserOrChat(userOrChat, f9Var);
