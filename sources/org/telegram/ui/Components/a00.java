...
public final class a00 {
    ...
    public int f23204a0;
    public final FloatBuffer f23205a1;
    public int f23207b0;
    public final FloatBuffer f23208b1;
    public boolean f23209c;
    public int f23210c0;
    public ByteBuffer f23211c1;
    public boolean d;
    public int f23212d0;
    public ByteBuffer f23213d1;
    public xz e;
    public int f23214e0;
    public ByteBuffer f23215e1;
    public float f23216f;
    public int f23217f0;
    public yz f23218f1;
    public xz f23219g;
    public int f23220g0;
    public final boolean f23221g1;
    public boolean h;
    public int f23222h0;
    public ph.s6 f23223h1;
    public int f23224i;
    public int f23225i0;
    public int f23227j;
    public int f23228j0;
    ...
    public final boolean a() {
        ...
        if (h != 0 && h9 != 0) {
            ...
            if (iArr3[0] == 0) {
                ...
                this.f23204a0 = GLES20.glGetUniformLocation(this.T, "contrast");
                this.f23207b0 = GLES20.glGetUniformLocation(this.T, "saturation");
                this.f23210c0 = GLES20.glGetUniformLocation(this.T, "warmth");
                this.f23212d0 = GLES20.glGetUniformLocation(this.T, "vignette");
                this.f23214e0 = GLES20.glGetUniformLocation(this.T, "grain");
                this.f23217f0 = GLES20.glGetUniformLocation(this.T, "width");
                this.f23220g0 = GLES20.glGetUniformLocation(this.T, "height");
                this.f23222h0 = GLES20.glGetUniformLocation(this.T, "curvesImage");
                this.f23225i0 = GLES20.glGetUniformLocation(this.T, "skipTone");
                this.f23228j0 = GLES20.glGetUniformLocation(this.T, "fadeAmount");
                this.f23230k0 = GLES20.glGetUniformLocation(this.T, "shadowsTintIntensity");
                this.f23232l0 = GLES20.glGetUniformLocation(this.T, "highlightsTintIntensity");
                this.m0 = GLES20.glGetUniformLocation(this.T, "shadowsTintColor");
                this.f23235n0 = GLES20.glGetUniformLocation(this.T, "highlightsTintColor");
            }
            ...
            if (h10 != 0 && h11 != 0) {
                ...
                if (xzVar.a() && j()) {
                    ...
                    if (h12 != 0 && h13 != 0) {
                        ...
                        this.f23237o0 = glCreateProgram3;
                        GLES20.glAttachShader(glCreateProgram3, h12);
                        GLES20.glAttachShader(this.f23237o0, h13);
                        GLES20.glBindAttribLocation(this.f23237o0, 0, "position");
                        GLES20.glBindAttribLocation(this.f23237o0, 1, "inputTexCoord");
                        GLES20.glLinkProgram(this.f23237o0);
                        GLES20.glGetProgramiv(this.f23237o0, 35714, iArr3, 0);
                        if (iArr3[0] == 0) {
                            GLES20.glDeleteProgram(this.f23237o0);
                            this.f23237o0 = 0;
                        } else {
                            this.f23239p0 = GLES20.glGetAttribLocation(this.f23237o0, "position");
                            this.f23241q0 = GLES20.glGetAttribLocation(this.f23237o0, "inputTexCoord");
                            this.f23243r0 = GLES20.glGetUniformLocation(this.f23237o0, "sTexture");
                            this.f23245s0 = GLES20.glGetUniformLocation(this.f23237o0, "inputImageTexture2");
                            this.f23247t0 = GLES20.glGetUniformLocation(this.f23237o0, "excludeSize");
                            this.f23249u0 = GLES20.glGetUniformLocation(this.f23237o0, "excludePoint");
                            this.f23250v0 = GLES20.glGetUniformLocation(this.f23237o0, "excludeBlurSize");
                            this.f23252w0 = GLES20.glGetUniformLocation(this.f23237o0, "angle");
                            this.f23254x0 = GLES20.glGetUniformLocation(this.f23237o0, "aspectRatio");
                        }
                        ...
                        if (h14 != 0 && h15 != 0) {
                            ...
                            this.f23256y0 = glCreateProgram4;
                            GLES20.glAttachShader(glCreateProgram4, h14);
                            GLES20.glAttachShader(this.f23256y0, h15);
                            GLES20.glBindAttribLocation(this.f23256y0, 0, "position");
                            GLES20.glBindAttribLocation(this.f23256y0, 1, "inputTexCoord");
                            GLES20.glLinkProgram(this.f23256y0);
                            GLES20.glGetProgramiv(this.f23256y0, 35714, iArr3, 0);
                            if (iArr3[0] == 0) {
                                GLES20.glDeleteProgram(this.f23256y0);
                                this.f23256y0 = 0;
                            } else {
                                this.f23258z0 = GLES20.glGetAttribLocation(this.f23256y0, "position");
                                this.A0 = GLES20.glGetAttribLocation(this.f23256y0, "inputTexCoord");
                                this.B0 = GLES20.glGetUniformLocation(this.f23256y0, "sTexture");
                                this.C0 = GLES20.glGetUniformLocation(this.f23256y0, "inputImageTexture2");
                                this.D0 = GLES20.glGetUniformLocation(this.f23256y0, "excludeSize");
                                this.E0 = GLES20.glGetUniformLocation(this.f23256y0, "excludePoint");
                                this.F0 = GLES20.glGetUniformLocation(this.f23256y0, "excludeBlurSize");
                                this.G0 = GLES20.glGetUniformLocation(this.f23256y0, "aspectRatio");
                            }
                            ...
                            if (h16 != 0 && h17 != 0) {
                                ...
                                if (h19 != 0 && h18 != 0) {
                                    ...
                                    this.f23238p = glCreateProgram6;
                                    GLES20.glAttachShader(glCreateProgram6, h19);
                                    GLES20.glAttachShader(this.f23238p, h18);
                                    GLES20.glBindAttribLocation(this.f23238p, 0, "position");
                                    GLES20.glBindAttribLocation(this.f23238p, 1, "inputTexCoord");
                                    GLES20.glLinkProgram(this.f23238p);
                                    GLES20.glGetProgramiv(this.f23238p, 35714, iArr3, 0);
                                    if (iArr3[0] == 0) {
                                        GLES20.glDeleteProgram(this.f23238p);
                                        this.f23238p = 0;
                                    } else {
                                        this.f23240q = GLES20.glGetAttribLocation(this.f23238p, "position");
                                        this.f23242r = GLES20.glGetAttribLocation(this.f23238p, "inputTexCoord");
                                        this.f23244s = GLES20.glGetUniformLocation(this.f23238p, "sTexture");
                                        this.f23246t = GLES20.glGetUniformLocation(this.f23238p, "inputImageTexture2");
                                    }
    ...
    public final boolean b() {
        int i10;
        yz yzVar;
        yz yzVar2 = this.f23218f1;
        if (yzVar2 != null) {
            i10 = yzVar2.getBlurType();
        } else {
            i10 = 0;
        }
        if (this.f23221g1 || (yzVar = this.f23218f1) == null || yzVar.b() || i10 == 0) {
            return false;
        }
        boolean z4 = this.f23203a;
        int[] iArr = this.S0;
        if (z4) {
            if (!this.f23209c) {
            ...
            GLES20.glUseProgram(this.f23219g.f30778c);
            GLES20.glUniform1i(this.f23219g.f30779f, 0);
            GLES20.glEnableVertexAttribArray(this.f23219g.e);
            GLES20.glVertexAttribPointer(this.f23219g.e, 2, 5126, false, 8, (Buffer) this.f23205a1);
            GLES20.glEnableVertexAttribArray(this.f23219g.d);
            GLES20.glVertexAttribPointer(this.f23219g.d, 2, 5126, false, 8, (Buffer) this.f23208b1);
            GLES20.glBindFramebuffer(36160, this.U0[0]);
            GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr[0], 0);
            GLES20.glActiveTexture(33984);
            GLES20.glBindTexture(3553, iArr[1]);
            GLES20.glUniform1f(this.f23219g.f30780g, 0.0f);
            GLES20.glUniform1f(this.f23219g.h, 1.0f / this.Y0);
            GLES20.glDrawArrays(5, 0, 4);
            GLES20.glBindFramebuffer(36160, this.U0[2]);
            GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr[2], 0);
            GLES20.glActiveTexture(33984);
            GLES20.glBindTexture(3553, iArr[0]);
            GLES20.glUniform1f(this.f23219g.f30780g, 1.0f / this.X0);
            GLES20.glUniform1f(this.f23219g.h, 0.0f);
            GLES20.glDrawArrays(5, 0, 4);
            this.f23203a = false;
        }
        GLES20.glBindFramebuffer(36160, this.U0[0]);
        GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr[0], 0);
        if (i10 == 1) {
            GLES20.glUseProgram(this.f23256y0);
            GLES20.glUniform1i(this.B0, 0);
            GLES20.glUniform1i(this.C0, 1);
            GLES20.glUniform1f(this.D0, this.f23218f1.getBlurExcludeSize());
            GLES20.glUniform1f(this.F0, this.f23218f1.getBlurExcludeBlurSize());
            PointF blurExcludePoint = this.f23218f1.getBlurExcludePoint();
            ...
            GLES20.glVertexAttribPointer(this.A0, 2, 5126, false, 8, (Buffer) this.f23205a1);
            GLES20.glEnableVertexAttribArray(this.f23258z0);
            GLES20.glVertexAttribPointer(this.f23258z0, 2, 5126, false, 8, (Buffer) this.f23208b1);
        } else if (i10 == 2) {
            GLES20.glUseProgram(this.f23237o0);
            GLES20.glUniform1i(this.f23243r0, 0);
            GLES20.glUniform1i(this.f23245s0, 1);
            GLES20.glUniform1f(this.f23247t0, this.f23218f1.getBlurExcludeSize());
            GLES20.glUniform1f(this.f23250v0, this.f23218f1.getBlurExcludeBlurSize());
            GLES20.glUniform1f(this.f23252w0, this.f23218f1.getBlurAngle());
            PointF blurExcludePoint2 = this.f23218f1.getBlurExcludePoint();
            GLES20.glUniform2f(this.f23249u0, blurExcludePoint2.x, blurExcludePoint2.y);
            GLES20.glUniform1f(this.f23254x0, this.Y0 / this.X0);
            GLES20.glEnableVertexAttribArray(this.f23241q0);
            GLES20.glVertexAttribPointer(this.f23241q0, 2, 5126, false, 8, (Buffer) this.f23205a1);
            GLES20.glEnableVertexAttribArray(this.f23239p0);
            GLES20.glVertexAttribPointer(this.f23239p0, 2, 5126, false, 8, (Buffer) this.f23208b1);
        }
        GLES20.glActiveTexture(33984);
        GLES20.glBindTexture(3553, iArr[1]);
    ...
    public final void c() {
        ...
        yz yzVar = this.f23218f1;
        float f10 = 1.0f;
        if (yzVar != null && !yzVar.b()) {
            GLES20.glUniform1f(this.X, this.f23218f1.getShadowsValue());
            GLES20.glUniform1f(this.Y, this.f23218f1.getHighlightsValue());
            GLES20.glUniform1f(this.Z, this.f23218f1.getExposureValue());
            GLES20.glUniform1f(this.f23204a0, this.f23218f1.getContrastValue());
            GLES20.glUniform1f(this.f23207b0, this.f23218f1.getSaturationValue());
            GLES20.glUniform1f(this.f23210c0, this.f23218f1.getWarmthValue());
            GLES20.glUniform1f(this.f23212d0, this.f23218f1.getVignetteValue());
            GLES20.glUniform1f(this.f23214e0, this.f23218f1.getGrainValue());
            GLES20.glUniform1f(this.f23228j0, this.f23218f1.getFadeValue());
            int tintHighlightsColor = this.f23218f1.getTintHighlightsColor();
            int tintShadowsColor = this.f23218f1.getTintShadowsColor();
            GLES20.glUniform3f(this.f23235n0, ((tintHighlightsColor >> 16) & 255) / 255.0f, ((tintHighlightsColor >> 8) & 255) / 255.0f, (tintHighlightsColor & 255) / 255.0f);
            GLES20.glUniform1f(this.f23232l0, this.f23218f1.getTintHighlightsIntensityValue());
            GLES20.glUniform3f(this.m0, ((tintShadowsColor >> 16) & 255) / 255.0f, ((tintShadowsColor >> 8) & 255) / 255.0f, (tintShadowsColor & 255) / 255.0f);
            GLES20.glUniform1f(this.f23230k0, this.f23218f1.getTintShadowsIntensityValue());
            boolean c3 = this.f23218f1.c();
            int i11 = this.f23225i0;
            if (c3) {
                f10 = 0.0f;
            }
            GLES20.glUniform1f(i11, f10);
            if (c3) {
                ByteBuffer a2 = this.f23218f1.a();
                GLES20.glActiveTexture(33985);
                GLES20.glBindTexture(3553, this.V0[0]);
                GLES20.glTexImage2D(3553, 0, 6408, 200, 1, 0, 6408, 5121, a2);
                GLES20.glUniform1i(this.f23222h0, 1);
            }
        } else {
            GLES20.glUniform1f(this.X, 1.0f);
            GLES20.glUniform1f(this.Y, 1.0f);
            GLES20.glUniform1f(this.Z, 0.0f);
            GLES20.glUniform1f(this.f23204a0, 1.0f);
            GLES20.glUniform1f(this.f23207b0, 1.0f);
            GLES20.glUniform1f(this.f23210c0, 0.0f);
            GLES20.glUniform1f(this.f23212d0, 0.0f);
            GLES20.glUniform1f(this.f23214e0, 0.0f);
            GLES20.glUniform1f(this.f23228j0, 0.0f);
            GLES20.glUniform3f(this.f23235n0, 0.0f, 0.0f, 0.0f);
            GLES20.glUniform1f(this.f23232l0, 0.0f);
            GLES20.glUniform3f(this.m0, 0.0f, 0.0f, 0.0f);
            GLES20.glUniform1f(this.f23230k0, 0.0f);
            GLES20.glUniform1f(this.f23225i0, 1.0f);
        }
        GLES20.glUniform1f(this.f23217f0, this.X0);
        GLES20.glUniform1f(this.f23220g0, this.Y0);
        GLES20.glEnableVertexAttribArray(this.V);
        GLES20.glVertexAttribPointer(this.V, 2, 5126, false, 8, (Buffer) this.f23205a1);
        GLES20.glEnableVertexAttribArray(this.U);
        GLES20.glVertexAttribPointer(this.U, 2, 5126, false, 8, (Buffer) this.f23208b1);
        GLES20.glDrawArrays(5, 0, 4);
    }
    ...
    public final void d() {
        ...
        if (z4) {
            ...
            GLES20.glVertexAttribPointer(iArr4[c3], 2, 5126, false, 8, (Buffer) this.f23205a1);
            int[] iArr5 = this.I;
            GLES20.glEnableVertexAttribArray(iArr5[c3]);
            int i13 = iArr5[c3];
            if (z10) {
                floatBuffer = this.f23208b1;
            } else {
                floatBuffer = this.Z0;
            }
        ...
        if (!this.W0) {
            ...
            ByteBuffer byteBuffer = this.f23211c1;
            if (byteBuffer == null || i14 > byteBuffer.capacity()) {
                this.f23211c1 = ByteBuffer.allocateDirect(i14);
            }
            if (this.f23213d1 == null) {
                this.f23213d1 = ByteBuffer.allocateDirect(16384);
            }
            if (this.f23215e1 == null) {
                this.f23215e1 = ByteBuffer.allocateDirect(32896);
            }
            GLES20.glReadPixels(0, 0, this.X0, this.Y0, 6408, 5121, this.f23211c1);
            i10 = 33984;
            Utilities.calcCDT(this.f23211c1, this.X0, this.Y0, this.f23213d1, this.f23215e1);
            GLES20.glBindTexture(3553, iArr2[1]);
            GLES20.glTexImage2D(3553, 0, 6408, 256, 16, 0, 6408, 5121, this.f23213d1);
            if (!z10) {
                this.f23211c1 = null;
                this.f23213d1 = null;
                this.f23215e1 = null;
        ...
        yz yzVar = this.f23218f1;
        if (yzVar != null && !yzVar.b()) {
            GLES20.glUniform1f(this.R, this.f23218f1.getEnhanceValue());
        } else {
            GLES20.glUniform1f(this.R, 0.0f);
        }
        GLES20.glEnableVertexAttribArray(this.P);
        GLES20.glVertexAttribPointer(this.P, 2, 5126, false, 8, (Buffer) this.f23205a1);
    ...
    public final void e() {
        ...
        yz yzVar = this.f23218f1;
        if (yzVar != null && !yzVar.b()) {
            GLES20.glUniform1f(this.I0, this.f23218f1.getSharpenValue());
        } else {
        ...
        GLES20.glVertexAttribPointer(this.M0, 2, 5126, false, 8, (Buffer) this.f23205a1);
        GLES20.glEnableVertexAttribArray(this.L0);
        GLES20.glVertexAttribPointer(this.L0, 2, 5126, false, 8, (Buffer) this.f23208b1);
        GLES20.glDrawArrays(5, 0, 4);
    }
    ...
    public final void f() {
        ...
        int i11;
        yz yzVar = this.f23218f1;
        if (yzVar != null && !yzVar.b() && this.f23218f1.getSoftenSkinValue() > 0.0f && (i10 = this.X0) > 0 && this.Y0 > 0) {
            boolean z4 = this.f23206b;
            int[] iArr = this.T0;
            boolean z10 = this.f23221g1;
            int[] iArr2 = this.S0;
            if (z4 || z10) {
                float f10 = i10 * 0.006f;
                if (this.e == null || Math.abs(this.f23216f - f10) > 1.0E-4d) {
                    xz xzVar = this.e;
                    if (xzVar != null && (i11 = xzVar.f30778c) != 0) {
                ...
                GLES20.glUseProgram(this.f23224i);
                GLES20.glUniform1i(this.f23231l, 0);
                GLES20.glEnableVertexAttribArray(this.f23229k);
                GLES20.glVertexAttribPointer(this.f23229k, 2, 5126, false, 8, (Buffer) this.f23205a1);
                GLES20.glEnableVertexAttribArray(this.f23227j);
                if (z10) {
                    GLES20.glUniformMatrix4fv(this.f23233m, 1, false, this.P0, 0);
                    int i12 = this.f23234n;
                    if (i12 != -1) {
                        GLES20.glUniform2f(i12, this.X0, this.Y0);
                    }
                }
                GLES20.glVertexAttribPointer(this.f23227j, 2, 5126, false, 8, (Buffer) this.f23208b1);
                GLES20.glBindFramebuffer(36160, this.U0[0]);
                GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr2[0], 0);
                GLES20.glActiveTexture(33984);
                if (z10) {
                ...
                GLES20.glDrawArrays(5, 0, 4);
                GLES20.glUseProgram(this.e.f30778c);
                GLES20.glUniform1i(this.e.f30779f, 0);
                GLES20.glEnableVertexAttribArray(this.e.e);
                GLES20.glVertexAttribPointer(this.e.e, 2, 5126, false, 8, (Buffer) this.f23205a1);
                GLES20.glEnableVertexAttribArray(this.e.d);
                GLES20.glVertexAttribPointer(this.e.d, 2, 5126, false, 8, (Buffer) this.f23208b1);
                GLES20.glBindFramebuffer(36160, this.U0[1]);
                GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr2[1], 0);
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, iArr2[0]);
                GLES20.glUniform1f(this.e.f30780g, 0.0f);
                ...
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, iArr2[1]);
                GLES20.glUniform1f(this.e.f30780g, 1.0f / this.X0);
                GLES20.glUniform1f(this.e.h, 0.0f);
                GLES20.glDrawArrays(5, 0, 4);
                GLES20.glUseProgram(this.f23238p);
                GLES20.glUniform1i(this.f23244s, 0);
                GLES20.glUniform1i(this.f23246t, 1);
                GLES20.glEnableVertexAttribArray(this.f23242r);
                GLES20.glVertexAttribPointer(this.f23242r, 2, 5126, false, 8, (Buffer) this.f23205a1);
                GLES20.glEnableVertexAttribArray(this.f23240q);
                GLES20.glVertexAttribPointer(this.f23240q, 2, 5126, false, 8, (Buffer) this.f23208b1);
                GLES20.glBindFramebuffer(36160, this.U0[1]);
                GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr2[1], 0);
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, iArr2[0]);
                ...
                GLES20.glVertexAttribPointer(this.F, 2, 5126, false, 8, (Buffer) this.f23205a1);
                GLES20.glEnableVertexAttribArray(this.E);
                GLES20.glVertexAttribPointer(this.E, 2, 5126, false, 8, (Buffer) this.f23208b1);
                GLES20.glBindFramebuffer(36160, this.U0[3]);
                GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr2[3], 0);
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, iArr2[1]);
            ...
            this.h = true;
            this.W0 = false;
            GLES20.glUseProgram(this.f23248u);
            GLES20.glUniform1i(this.f23253x, 0);
            GLES20.glUniform1i(this.f23255y, 1);
            GLES20.glUniform1i(this.f23257z, 2);
            GLES20.glUniform1f(this.A, this.f23218f1.getSoftenSkinValue());
            GLES20.glEnableVertexAttribArray(this.f23251w);
            GLES20.glVertexAttribPointer(this.f23251w, 2, 5126, false, 8, (Buffer) this.f23205a1);
            GLES20.glEnableVertexAttribArray(this.v);
            GLES20.glVertexAttribPointer(this.v, 2, 5126, false, 8, (Buffer) this.f23208b1);
            if (z10) {
            ...
            GLES20.glBindTexture(3553, ((int[]) this.f23236o.f31508b)[0]);
            GLES20.glDrawArrays(5, 0, 4);
        } else if (this.h) {
            this.W0 = false;
            this.h = false;
        ...
        while (true) {
            ...
            if (i14 < i11) {
                ...
                if (z11) {
                    ...
                    GLES20.glDeleteProgram(this.f23224i);
                    if (i12 == 0 && i13 != 0) {
                        int glCreateProgram2 = GLES20.glCreateProgram();
                        this.f23224i = glCreateProgram2;
                        GLES20.glAttachShader(glCreateProgram2, i12);
                        GLES20.glAttachShader(this.f23224i, i13);
                        GLES20.glBindAttribLocation(this.f23224i, 0, "position");
                        GLES20.glBindAttribLocation(this.f23224i, 1, "inputTexCoord");
                        GLES20.glLinkProgram(this.f23224i);
                        GLES20.glGetProgramiv(this.f23224i, 35714, iArr, 0);
                        if (iArr[0] == 0) {
                            GLES20.glDeleteProgram(this.f23224i);
                            this.f23224i = 0;
                        } else {
                            this.f23227j = GLES20.glGetAttribLocation(this.f23224i, "position");
                            this.f23229k = GLES20.glGetAttribLocation(this.f23224i, "inputTexCoord");
                            this.f23231l = GLES20.glGetUniformLocation(this.f23224i, "sTexture");
                            if (z11) {
                                this.f23233m = GLES20.glGetUniformLocation(this.f23224i, "videoMatrix");
                                this.f23234n = GLES20.glGetUniformLocation(this.f23224i, "texSize");
                            }
                        }
                        if (z11) {
                            if (i15 != 0) {
                        ...
                        GLES20.glDeleteProgram(this.f23248u);
                        if (h10 == 0 || h11 == 0) {
                            return false;
                        }
                        int glCreateProgram3 = GLES20.glCreateProgram();
                        this.f23248u = glCreateProgram3;
                        GLES20.glAttachShader(glCreateProgram3, h10);
                        GLES20.glAttachShader(this.f23248u, h11);
                        GLES20.glBindAttribLocation(this.f23248u, 0, "position");
                        GLES20.glBindAttribLocation(this.f23248u, 1, "inputTexCoord");
                        GLES20.glLinkProgram(this.f23248u);
                        GLES20.glGetProgramiv(this.f23248u, 35714, iArr, 0);
                        if (iArr[0] == 0) {
                            GLES20.glDeleteProgram(this.f23248u);
                            this.f23248u = 0;
                            return true;
                        }
                        this.v = GLES20.glGetAttribLocation(this.f23248u, "position");
                        this.f23251w = GLES20.glGetAttribLocation(this.f23248u, "inputTexCoord");
                        this.f23253x = GLES20.glGetUniformLocation(this.f23248u, "sTexture");
                        this.f23255y = GLES20.glGetUniformLocation(this.f23248u, "inputImageTexture3");
                        this.f23257z = GLES20.glGetUniformLocation(this.f23248u, "toneCurveTexture");
                        this.A = GLES20.glGetUniformLocation(this.f23248u, "mixturePercent");
                        if (z11) {
                            this.B = GLES20.glGetUniformLocation(this.f23248u, "videoMatrix");
                            this.C = GLES20.glGetUniformLocation(this.f23248u, "texSize");
                            return true;
                        }
                        return true;
                    }
