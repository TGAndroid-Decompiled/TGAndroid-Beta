...
public final class a00 {
    ...
    public int f22472a0;
    public final FloatBuffer f22473a1;
    public int f22475b0;
    public final FloatBuffer f22476b1;
    public boolean f22477c;
    public int f22478c0;
    public ByteBuffer f22479c1;
    public boolean d;
    public int f22480d0;
    public ByteBuffer f22481d1;
    public yz e;
    public int f22482e0;
    public ByteBuffer f22483e1;
    public float f22484f;
    public int f22485f0;
    public zz f22486f1;
    public yz f22487g;
    public int f22488g0;
    public final boolean f22489g1;
    public boolean h;
    public int f22490h0;
    public ci.k8 f22491h1;
    public int f22492i;
    public int f22493i0;
    public int f22495j;
    public int f22496j0;
    ...
    public final boolean a() {
        ...
        if (h != 0 && h10 != 0) {
            ...
            if (iArr3[0] == 0) {
                ...
                this.f22472a0 = GLES20.glGetUniformLocation(this.T, "contrast");
                this.f22475b0 = GLES20.glGetUniformLocation(this.T, "saturation");
                this.f22478c0 = GLES20.glGetUniformLocation(this.T, "warmth");
                this.f22480d0 = GLES20.glGetUniformLocation(this.T, "vignette");
                this.f22482e0 = GLES20.glGetUniformLocation(this.T, "grain");
                this.f22485f0 = GLES20.glGetUniformLocation(this.T, "width");
                this.f22488g0 = GLES20.glGetUniformLocation(this.T, "height");
                this.f22490h0 = GLES20.glGetUniformLocation(this.T, "curvesImage");
                this.f22493i0 = GLES20.glGetUniformLocation(this.T, "skipTone");
                this.f22496j0 = GLES20.glGetUniformLocation(this.T, "fadeAmount");
                this.f22498k0 = GLES20.glGetUniformLocation(this.T, "shadowsTintIntensity");
                this.f22500l0 = GLES20.glGetUniformLocation(this.T, "highlightsTintIntensity");
                this.m0 = GLES20.glGetUniformLocation(this.T, "shadowsTintColor");
                this.f22503n0 = GLES20.glGetUniformLocation(this.T, "highlightsTintColor");
            }
            ...
            if (h11 != 0 && h12 != 0) {
                ...
                if (yzVar.a() && j()) {
                    ...
                    if (h13 != 0 && h14 != 0) {
                        ...
                        this.f22505o0 = glCreateProgram3;
                        GLES20.glAttachShader(glCreateProgram3, h13);
                        GLES20.glAttachShader(this.f22505o0, h14);
                        GLES20.glBindAttribLocation(this.f22505o0, 0, "position");
                        GLES20.glBindAttribLocation(this.f22505o0, 1, "inputTexCoord");
                        GLES20.glLinkProgram(this.f22505o0);
                        GLES20.glGetProgramiv(this.f22505o0, 35714, iArr3, 0);
                        if (iArr3[0] == 0) {
                            GLES20.glDeleteProgram(this.f22505o0);
                            this.f22505o0 = 0;
                        } else {
                            this.f22507p0 = GLES20.glGetAttribLocation(this.f22505o0, "position");
                            this.f22509q0 = GLES20.glGetAttribLocation(this.f22505o0, "inputTexCoord");
                            this.f22511r0 = GLES20.glGetUniformLocation(this.f22505o0, "sTexture");
                            this.f22513s0 = GLES20.glGetUniformLocation(this.f22505o0, "inputImageTexture2");
                            this.f22515t0 = GLES20.glGetUniformLocation(this.f22505o0, "excludeSize");
                            this.f22517u0 = GLES20.glGetUniformLocation(this.f22505o0, "excludePoint");
                            this.f22518v0 = GLES20.glGetUniformLocation(this.f22505o0, "excludeBlurSize");
                            this.f22520w0 = GLES20.glGetUniformLocation(this.f22505o0, "angle");
                            this.f22522x0 = GLES20.glGetUniformLocation(this.f22505o0, "aspectRatio");
                        }
                        ...
                        if (h15 != 0 && h16 != 0) {
                            ...
                            this.f22524y0 = glCreateProgram4;
                            GLES20.glAttachShader(glCreateProgram4, h15);
                            GLES20.glAttachShader(this.f22524y0, h16);
                            GLES20.glBindAttribLocation(this.f22524y0, 0, "position");
                            GLES20.glBindAttribLocation(this.f22524y0, 1, "inputTexCoord");
                            GLES20.glLinkProgram(this.f22524y0);
                            GLES20.glGetProgramiv(this.f22524y0, 35714, iArr3, 0);
                            if (iArr3[0] == 0) {
                                GLES20.glDeleteProgram(this.f22524y0);
                                this.f22524y0 = 0;
                            } else {
                                this.f22526z0 = GLES20.glGetAttribLocation(this.f22524y0, "position");
                                this.A0 = GLES20.glGetAttribLocation(this.f22524y0, "inputTexCoord");
                                this.B0 = GLES20.glGetUniformLocation(this.f22524y0, "sTexture");
                                this.C0 = GLES20.glGetUniformLocation(this.f22524y0, "inputImageTexture2");
                                this.D0 = GLES20.glGetUniformLocation(this.f22524y0, "excludeSize");
                                this.E0 = GLES20.glGetUniformLocation(this.f22524y0, "excludePoint");
                                this.F0 = GLES20.glGetUniformLocation(this.f22524y0, "excludeBlurSize");
                                this.G0 = GLES20.glGetUniformLocation(this.f22524y0, "aspectRatio");
                            }
                            ...
                            if (h17 != 0 && h18 != 0) {
                                ...
                                if (h20 != 0 && h19 != 0) {
                                    ...
                                    this.f22506p = glCreateProgram6;
                                    GLES20.glAttachShader(glCreateProgram6, h20);
                                    GLES20.glAttachShader(this.f22506p, h19);
                                    GLES20.glBindAttribLocation(this.f22506p, 0, "position");
                                    GLES20.glBindAttribLocation(this.f22506p, 1, "inputTexCoord");
                                    GLES20.glLinkProgram(this.f22506p);
                                    GLES20.glGetProgramiv(this.f22506p, 35714, iArr3, 0);
                                    if (iArr3[0] == 0) {
                                        GLES20.glDeleteProgram(this.f22506p);
                                        this.f22506p = 0;
                                    } else {
                                        this.f22508q = GLES20.glGetAttribLocation(this.f22506p, "position");
                                        this.f22510r = GLES20.glGetAttribLocation(this.f22506p, "inputTexCoord");
                                        this.f22512s = GLES20.glGetUniformLocation(this.f22506p, "sTexture");
                                        this.f22514t = GLES20.glGetUniformLocation(this.f22506p, "inputImageTexture2");
                                    }
    ...
    public final boolean b() {
        int i10;
        zz zzVar;
        zz zzVar2 = this.f22486f1;
        if (zzVar2 != null) {
            i10 = zzVar2.getBlurType();
        } else {
            i10 = 0;
        }
        if (this.f22489g1 || (zzVar = this.f22486f1) == null || zzVar.b() || i10 == 0) {
            return false;
        }
        ...
        if (z10) {
            ...
            GLES20.glUseProgram(this.f22487g.f30736c);
            GLES20.glUniform1i(this.f22487g.f30737f, 0);
            GLES20.glEnableVertexAttribArray(this.f22487g.e);
            GLES20.glVertexAttribPointer(this.f22487g.e, 2, 5126, false, 8, (Buffer) this.f22473a1);
            GLES20.glEnableVertexAttribArray(this.f22487g.d);
            GLES20.glVertexAttribPointer(this.f22487g.d, 2, 5126, false, 8, (Buffer) this.f22476b1);
            GLES20.glBindFramebuffer(36160, this.U0[0]);
            GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr[0], 0);
            GLES20.glActiveTexture(33984);
            GLES20.glBindTexture(3553, iArr[1]);
            GLES20.glUniform1f(this.f22487g.f30738g, 0.0f);
            GLES20.glUniform1f(this.f22487g.h, 1.0f / this.Y0);
            GLES20.glDrawArrays(5, 0, 4);
            GLES20.glBindFramebuffer(36160, this.U0[2]);
            GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr[2], 0);
            GLES20.glActiveTexture(33984);
            GLES20.glBindTexture(3553, iArr[0]);
            GLES20.glUniform1f(this.f22487g.f30738g, 1.0f / this.X0);
            GLES20.glUniform1f(this.f22487g.h, 0.0f);
            GLES20.glDrawArrays(5, 0, 4);
            this.f22471a = false;
        }
        GLES20.glBindFramebuffer(36160, this.U0[0]);
        GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr[0], 0);
        if (i10 == 1) {
            GLES20.glUseProgram(this.f22524y0);
            GLES20.glUniform1i(this.B0, 0);
            GLES20.glUniform1i(this.C0, 1);
            GLES20.glUniform1f(this.D0, this.f22486f1.getBlurExcludeSize());
            GLES20.glUniform1f(this.F0, this.f22486f1.getBlurExcludeBlurSize());
            PointF blurExcludePoint = this.f22486f1.getBlurExcludePoint();
            ...
            GLES20.glVertexAttribPointer(this.A0, 2, 5126, false, 8, (Buffer) this.f22473a1);
            GLES20.glEnableVertexAttribArray(this.f22526z0);
            GLES20.glVertexAttribPointer(this.f22526z0, 2, 5126, false, 8, (Buffer) this.f22476b1);
        } else if (i10 == 2) {
            GLES20.glUseProgram(this.f22505o0);
            GLES20.glUniform1i(this.f22511r0, 0);
            GLES20.glUniform1i(this.f22513s0, 1);
            GLES20.glUniform1f(this.f22515t0, this.f22486f1.getBlurExcludeSize());
            GLES20.glUniform1f(this.f22518v0, this.f22486f1.getBlurExcludeBlurSize());
            GLES20.glUniform1f(this.f22520w0, this.f22486f1.getBlurAngle());
            PointF blurExcludePoint2 = this.f22486f1.getBlurExcludePoint();
            GLES20.glUniform2f(this.f22517u0, blurExcludePoint2.x, blurExcludePoint2.y);
            GLES20.glUniform1f(this.f22522x0, this.Y0 / this.X0);
            GLES20.glEnableVertexAttribArray(this.f22509q0);
            GLES20.glVertexAttribPointer(this.f22509q0, 2, 5126, false, 8, (Buffer) this.f22473a1);
            GLES20.glEnableVertexAttribArray(this.f22507p0);
            GLES20.glVertexAttribPointer(this.f22507p0, 2, 5126, false, 8, (Buffer) this.f22476b1);
        }
        GLES20.glActiveTexture(33984);
        GLES20.glBindTexture(3553, iArr[1]);
    ...
    public final void c() {
        ...
        zz zzVar = this.f22486f1;
        float f7 = 1.0f;
        if (zzVar != null && !zzVar.b()) {
            GLES20.glUniform1f(this.X, this.f22486f1.getShadowsValue());
            GLES20.glUniform1f(this.Y, this.f22486f1.getHighlightsValue());
            GLES20.glUniform1f(this.Z, this.f22486f1.getExposureValue());
            GLES20.glUniform1f(this.f22472a0, this.f22486f1.getContrastValue());
            GLES20.glUniform1f(this.f22475b0, this.f22486f1.getSaturationValue());
            GLES20.glUniform1f(this.f22478c0, this.f22486f1.getWarmthValue());
            GLES20.glUniform1f(this.f22480d0, this.f22486f1.getVignetteValue());
            GLES20.glUniform1f(this.f22482e0, this.f22486f1.getGrainValue());
            GLES20.glUniform1f(this.f22496j0, this.f22486f1.getFadeValue());
            int tintHighlightsColor = this.f22486f1.getTintHighlightsColor();
            int tintShadowsColor = this.f22486f1.getTintShadowsColor();
            GLES20.glUniform3f(this.f22503n0, ((tintHighlightsColor >> 16) & 255) / 255.0f, ((tintHighlightsColor >> 8) & 255) / 255.0f, (tintHighlightsColor & 255) / 255.0f);
            GLES20.glUniform1f(this.f22500l0, this.f22486f1.getTintHighlightsIntensityValue());
            GLES20.glUniform3f(this.m0, ((tintShadowsColor >> 16) & 255) / 255.0f, ((tintShadowsColor >> 8) & 255) / 255.0f, (tintShadowsColor & 255) / 255.0f);
            GLES20.glUniform1f(this.f22498k0, this.f22486f1.getTintShadowsIntensityValue());
            boolean c10 = this.f22486f1.c();
            int i11 = this.f22493i0;
            if (c10) {
                f7 = 0.0f;
            }
            GLES20.glUniform1f(i11, f7);
            if (c10) {
                ByteBuffer a2 = this.f22486f1.a();
                GLES20.glActiveTexture(33985);
                GLES20.glBindTexture(3553, this.V0[0]);
                GLES20.glTexImage2D(3553, 0, 6408, 200, 1, 0, 6408, 5121, a2);
                GLES20.glUniform1i(this.f22490h0, 1);
            }
        } else {
            GLES20.glUniform1f(this.X, 1.0f);
            GLES20.glUniform1f(this.Y, 1.0f);
            GLES20.glUniform1f(this.Z, 0.0f);
            GLES20.glUniform1f(this.f22472a0, 1.0f);
            GLES20.glUniform1f(this.f22475b0, 1.0f);
            GLES20.glUniform1f(this.f22478c0, 0.0f);
            GLES20.glUniform1f(this.f22480d0, 0.0f);
            GLES20.glUniform1f(this.f22482e0, 0.0f);
            GLES20.glUniform1f(this.f22496j0, 0.0f);
            GLES20.glUniform3f(this.f22503n0, 0.0f, 0.0f, 0.0f);
            GLES20.glUniform1f(this.f22500l0, 0.0f);
            GLES20.glUniform3f(this.m0, 0.0f, 0.0f, 0.0f);
            GLES20.glUniform1f(this.f22498k0, 0.0f);
            GLES20.glUniform1f(this.f22493i0, 1.0f);
        }
        GLES20.glUniform1f(this.f22485f0, this.X0);
        GLES20.glUniform1f(this.f22488g0, this.Y0);
        GLES20.glEnableVertexAttribArray(this.V);
        GLES20.glVertexAttribPointer(this.V, 2, 5126, false, 8, (Buffer) this.f22473a1);
        GLES20.glEnableVertexAttribArray(this.U);
        GLES20.glVertexAttribPointer(this.U, 2, 5126, false, 8, (Buffer) this.f22476b1);
        GLES20.glDrawArrays(5, 0, 4);
    }
    ...
    public final void d() {
        ...
        if (z10) {
            ...
            GLES20.glVertexAttribPointer(iArr4[c10], 2, 5126, false, 8, (Buffer) this.f22473a1);
            int[] iArr5 = this.I;
            GLES20.glEnableVertexAttribArray(iArr5[c10]);
            int i13 = iArr5[c10];
            if (z11) {
                floatBuffer = this.f22476b1;
            } else {
                floatBuffer = this.Z0;
            }
        ...
        if (!this.W0) {
            ...
            ByteBuffer byteBuffer = this.f22479c1;
            if (byteBuffer == null || i14 > byteBuffer.capacity()) {
                this.f22479c1 = ByteBuffer.allocateDirect(i14);
            }
            if (this.f22481d1 == null) {
                this.f22481d1 = ByteBuffer.allocateDirect(16384);
            }
            if (this.f22483e1 == null) {
                this.f22483e1 = ByteBuffer.allocateDirect(32896);
            }
            GLES20.glReadPixels(0, 0, this.X0, this.Y0, 6408, 5121, this.f22479c1);
            i10 = 33984;
            Utilities.calcCDT(this.f22479c1, this.X0, this.Y0, this.f22481d1, this.f22483e1);
            GLES20.glBindTexture(3553, iArr2[1]);
            GLES20.glTexImage2D(3553, 0, 6408, 256, 16, 0, 6408, 5121, this.f22481d1);
            if (!z11) {
                this.f22479c1 = null;
                this.f22481d1 = null;
                this.f22483e1 = null;
        ...
        zz zzVar = this.f22486f1;
        if (zzVar != null && !zzVar.b()) {
            GLES20.glUniform1f(this.R, this.f22486f1.getEnhanceValue());
        } else {
            GLES20.glUniform1f(this.R, 0.0f);
        }
        GLES20.glEnableVertexAttribArray(this.P);
        GLES20.glVertexAttribPointer(this.P, 2, 5126, false, 8, (Buffer) this.f22473a1);
    ...
    public final void e() {
        ...
        zz zzVar = this.f22486f1;
        if (zzVar != null && !zzVar.b()) {
            GLES20.glUniform1f(this.I0, this.f22486f1.getSharpenValue());
        } else {
        ...
        GLES20.glVertexAttribPointer(this.M0, 2, 5126, false, 8, (Buffer) this.f22473a1);
        GLES20.glEnableVertexAttribArray(this.L0);
        GLES20.glVertexAttribPointer(this.L0, 2, 5126, false, 8, (Buffer) this.f22476b1);
        GLES20.glDrawArrays(5, 0, 4);
    }
    ...
    public final void f() {
        ...
        int i11;
        zz zzVar = this.f22486f1;
        if (zzVar != null && !zzVar.b() && this.f22486f1.getSoftenSkinValue() > 0.0f && (i10 = this.X0) > 0 && this.Y0 > 0) {
            ...
            if (z10 || z11) {
                float f7 = i10 * 0.006f;
                if (this.e == null || Math.abs(this.f22484f - f7) > 1.0E-4d) {
                    yz yzVar = this.e;
                    if (yzVar != null && (i11 = yzVar.f30736c) != 0) {
                ...
                GLES20.glUseProgram(this.f22492i);
                GLES20.glUniform1i(this.f22499l, 0);
                GLES20.glEnableVertexAttribArray(this.f22497k);
                GLES20.glVertexAttribPointer(this.f22497k, 2, 5126, false, 8, (Buffer) this.f22473a1);
                GLES20.glEnableVertexAttribArray(this.f22495j);
                if (z11) {
                    GLES20.glUniformMatrix4fv(this.f22501m, 1, false, this.P0, 0);
                    int i12 = this.f22502n;
                    if (i12 != -1) {
                        GLES20.glUniform2f(i12, this.X0, this.Y0);
                    }
                }
                GLES20.glVertexAttribPointer(this.f22495j, 2, 5126, false, 8, (Buffer) this.f22476b1);
                GLES20.glBindFramebuffer(36160, this.U0[0]);
                GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr2[0], 0);
                GLES20.glActiveTexture(33984);
                if (z11) {
                ...
                GLES20.glDrawArrays(5, 0, 4);
                GLES20.glUseProgram(this.e.f30736c);
                GLES20.glUniform1i(this.e.f30737f, 0);
                GLES20.glEnableVertexAttribArray(this.e.e);
                GLES20.glVertexAttribPointer(this.e.e, 2, 5126, false, 8, (Buffer) this.f22473a1);
                GLES20.glEnableVertexAttribArray(this.e.d);
                GLES20.glVertexAttribPointer(this.e.d, 2, 5126, false, 8, (Buffer) this.f22476b1);
                GLES20.glBindFramebuffer(36160, this.U0[1]);
                GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr2[1], 0);
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, iArr2[0]);
                GLES20.glUniform1f(this.e.f30738g, 0.0f);
                ...
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, iArr2[1]);
                GLES20.glUniform1f(this.e.f30738g, 1.0f / this.X0);
                GLES20.glUniform1f(this.e.h, 0.0f);
                GLES20.glDrawArrays(5, 0, 4);
                GLES20.glUseProgram(this.f22506p);
                GLES20.glUniform1i(this.f22512s, 0);
                GLES20.glUniform1i(this.f22514t, 1);
                GLES20.glEnableVertexAttribArray(this.f22510r);
                GLES20.glVertexAttribPointer(this.f22510r, 2, 5126, false, 8, (Buffer) this.f22473a1);
                GLES20.glEnableVertexAttribArray(this.f22508q);
                GLES20.glVertexAttribPointer(this.f22508q, 2, 5126, false, 8, (Buffer) this.f22476b1);
                GLES20.glBindFramebuffer(36160, this.U0[1]);
                GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr2[1], 0);
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, iArr2[0]);
                ...
                GLES20.glVertexAttribPointer(this.F, 2, 5126, false, 8, (Buffer) this.f22473a1);
                GLES20.glEnableVertexAttribArray(this.E);
                GLES20.glVertexAttribPointer(this.E, 2, 5126, false, 8, (Buffer) this.f22476b1);
                GLES20.glBindFramebuffer(36160, this.U0[3]);
                GLES20.glFramebufferTexture2D(36160, 36064, 3553, iArr2[3], 0);
                GLES20.glActiveTexture(33984);
                GLES20.glBindTexture(3553, iArr2[1]);
            ...
            this.h = true;
            this.W0 = false;
            GLES20.glUseProgram(this.f22516u);
            GLES20.glUniform1i(this.f22521x, 0);
            GLES20.glUniform1i(this.f22523y, 1);
            GLES20.glUniform1i(this.f22525z, 2);
            GLES20.glUniform1f(this.A, this.f22486f1.getSoftenSkinValue());
            GLES20.glEnableVertexAttribArray(this.f22519w);
            GLES20.glVertexAttribPointer(this.f22519w, 2, 5126, false, 8, (Buffer) this.f22473a1);
            GLES20.glEnableVertexAttribArray(this.v);
            GLES20.glVertexAttribPointer(this.v, 2, 5126, false, 8, (Buffer) this.f22476b1);
            if (z11) {
            ...
            GLES20.glBindTexture(3553, ((int[]) this.f22504o.f15116b)[0]);
            GLES20.glDrawArrays(5, 0, 4);
        } else if (this.h) {
            this.W0 = false;
            this.h = false;
        ...
        while (true) {
            ...
            if (i14 < i11) {
                ...
                if (z12) {
                    ...
                    GLES20.glDeleteProgram(this.f22492i);
                    if (i12 == 0 && i13 != 0) {
                        int glCreateProgram2 = GLES20.glCreateProgram();
                        this.f22492i = glCreateProgram2;
                        GLES20.glAttachShader(glCreateProgram2, i12);
                        GLES20.glAttachShader(this.f22492i, i13);
                        GLES20.glBindAttribLocation(this.f22492i, 0, "position");
                        GLES20.glBindAttribLocation(this.f22492i, 1, "inputTexCoord");
                        GLES20.glLinkProgram(this.f22492i);
                        GLES20.glGetProgramiv(this.f22492i, 35714, iArr, 0);
                        if (iArr[0] == 0) {
                            GLES20.glDeleteProgram(this.f22492i);
                            this.f22492i = 0;
                        } else {
                            this.f22495j = GLES20.glGetAttribLocation(this.f22492i, "position");
                            this.f22497k = GLES20.glGetAttribLocation(this.f22492i, "inputTexCoord");
                            this.f22499l = GLES20.glGetUniformLocation(this.f22492i, "sTexture");
                            if (z12) {
                                this.f22501m = GLES20.glGetUniformLocation(this.f22492i, "videoMatrix");
                                this.f22502n = GLES20.glGetUniformLocation(this.f22492i, "texSize");
                            }
                        }
                        if (z12) {
                            if (i15 != 0) {
                        ...
                        GLES20.glDeleteProgram(this.f22516u);
                        if (h11 == 0 || h12 == 0) {
                            return false;
                        }
                        int glCreateProgram3 = GLES20.glCreateProgram();
                        this.f22516u = glCreateProgram3;
                        GLES20.glAttachShader(glCreateProgram3, h11);
                        GLES20.glAttachShader(this.f22516u, h12);
                        GLES20.glBindAttribLocation(this.f22516u, 0, "position");
                        GLES20.glBindAttribLocation(this.f22516u, 1, "inputTexCoord");
                        GLES20.glLinkProgram(this.f22516u);
                        GLES20.glGetProgramiv(this.f22516u, 35714, iArr, 0);
                        if (iArr[0] == 0) {
                            GLES20.glDeleteProgram(this.f22516u);
                            this.f22516u = 0;
                            return true;
                        }
                        this.v = GLES20.glGetAttribLocation(this.f22516u, "position");
                        this.f22519w = GLES20.glGetAttribLocation(this.f22516u, "inputTexCoord");
                        this.f22521x = GLES20.glGetUniformLocation(this.f22516u, "sTexture");
                        this.f22523y = GLES20.glGetUniformLocation(this.f22516u, "inputImageTexture3");
                        this.f22525z = GLES20.glGetUniformLocation(this.f22516u, "toneCurveTexture");
                        this.A = GLES20.glGetUniformLocation(this.f22516u, "mixturePercent");
                        if (z12) {
                            this.B = GLES20.glGetUniformLocation(this.f22516u, "videoMatrix");
                            this.C = GLES20.glGetUniformLocation(this.f22516u, "texSize");
                            return true;
                        }
                        return true;
                    }
