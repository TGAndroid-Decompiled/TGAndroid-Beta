...
public final class uv extends LinearLayout {
    public final a0.i f28510a;
    public final Paint f28511b;
    public final RectF f28512c;
    public final RectF d;
    public final RectF e;
    public final Path f28513f;
    public final boolean h;
    public final boolean f28514n;
    public final cw f28515r;
    ...
    public uv(cw cwVar, Context context, boolean z10, boolean z11) {
        ...
        this.h = z10;
        this.f28514n = z11;
        this.f28510a = new a0.i();
        this.f28511b = new Paint(1);
        this.f28512c = new RectF();
        this.d = new RectF();
        this.e = new RectF();
        this.f28513f = new Path();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (cwVar.f23151s == null) {
            cwVar.f23151s = new c6(this, 350L, qr.h);
        }
        c6 c6Var = cwVar.f23151s;
        float f11 = 0.0f;
        if (cwVar.f23150r) {
            f7 = 1.0f;
        } else {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (view == this.f28515r.G) {
            canvas.save();
            canvas.clipPath(this.f28513f);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
            ...
            while (true) {
                ...
                if (childAt != yvVar && !cwVar.H.containsKey(childAt) && childAt != null) {
                    ...
                    if (z11) {
                        ...
                        Long l10 = yvVar2.f30401a;
                        if (l10 == null) {
                            wx wxVar = yvVar2.v;
                            if (wxVar != null && (stickerSet = wxVar.f29820b) != null) {
                                l4 = Long.valueOf(stickerSet.f18136id);
                            } else {
                                l10 = yvVar2.f30406r;
                                if (l10 == null) {
                                    TLRPC.Document document = yvVar2.f30407s;
                                    if (document != null) {
                                        l4 = Long.valueOf(document.f18115id);
                                    }
                                }
                            }
                        }
                    ...
                    if ((childAt != cwVar.f23154y || cwVar.W) && (childAt != cwVar.E || cwVar.f23146b0)) {
                        paddingLeft = org.telegram.messenger.y0.C(3.0f, childAt.getMeasuredWidth(), paddingLeft);
                    }
                }
                i15++;
            }
            if (yvVar != null) {
                Long l11 = yvVar.f30401a;
        ...
        int childCount2 = (getChildCount() - (!cwVar.W ? 1 : 0)) - (!cwVar.f23146b0 ? 1 : 0);
        int A = (int) (org.telegram.messenger.vl.A(30.0f, childCount2, ((i12 - i10) - getPaddingLeft()) - getPaddingRight()) / Math.max(1, childCount2 - 1));
        int paddingLeft2 = getPaddingLeft();
        for (int i17 = 0; i17 < childCount2; i17++) {
            View childAt2 = getChildAt((!cwVar.W ? 1 : 0) + (!cwVar.f23146b0 ? 1 : 0) + i17);
            if (childAt2 != null) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        cw cwVar = this.f28515r;
        float f10 = 0.0f;
        if (!cwVar.W && (yvVar2 = cwVar.f23154y) != null) {
            f7 = yvVar2.getAlpha() * AndroidUtilities.dp(33.0f);
        } else {
            f7 = 0.0f;
        }
        int i13 = paddingRight - ((int) f7);
        if (!cwVar.f23146b0 && (yvVar = cwVar.E) != null) {
