...
public final class uv extends LinearLayout {
    public final a0.i f28831a;
    public final Paint f28832b;
    public final RectF f28833c;
    public final RectF d;
    public final RectF e;
    public final Path f28834f;
    public final boolean h;
    public final boolean f28835n;
    public final cw f28836r;
    ...
    public uv(cw cwVar, Context context, boolean z10, boolean z11) {
        ...
        this.h = z10;
        this.f28835n = z11;
        this.f28831a = new a0.i();
        this.f28832b = new Paint(1);
        this.f28833c = new RectF();
        this.d = new RectF();
        this.e = new RectF();
        this.f28834f = new Path();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (cwVar.f23348s == null) {
            cwVar.f23348s = new e6(this, 350L, qr.h);
        }
        e6 e6Var = cwVar.f23348s;
        float f11 = 0.0f;
        if (cwVar.f23347r) {
            f7 = 1.0f;
        } else {
        ...
        Path path = this.f28834f;
        path.rewind();
        boolean z11 = this.f28835n;
        if (z11) {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (view == this.f28836r.G) {
            canvas.save();
            canvas.clipPath(this.f28834f);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
            ...
            while (true) {
                ...
                if (childAt != yvVar && !cwVar.H.containsKey(childAt) && childAt != null) {
                    ...
                    if (z11) {
                        ...
                        Long l10 = yvVar2.f30672a;
                        if (l10 == null) {
                            xx xxVar = yvVar2.v;
                            if (xxVar != null && (stickerSet = xxVar.f30387b) != null) {
                                l4 = Long.valueOf(stickerSet.f18323id);
                            } else {
                                l10 = yvVar2.f30677r;
                                if (l10 == null) {
                                    TLRPC.Document document = yvVar2.f30678s;
                                    if (document != null) {
                                        l4 = Long.valueOf(document.f18302id);
                                    }
                                }
                            }
                        }
                    ...
                    if ((childAt != cwVar.f23351y || cwVar.W) && (childAt != cwVar.E || cwVar.f23343b0)) {
                        paddingLeft = org.telegram.messenger.q.D(3.0f, childAt.getMeasuredWidth(), paddingLeft);
                    }
                }
                i15++;
            }
            if (yvVar != null) {
                Long l11 = yvVar.f30672a;
        ...
        int childCount2 = (getChildCount() - (!cwVar.W ? 1 : 0)) - (!cwVar.f23343b0 ? 1 : 0);
        int B = (int) (org.telegram.messenger.wh.B(30.0f, childCount2, ((i12 - i10) - getPaddingLeft()) - getPaddingRight()) / Math.max(1, childCount2 - 1));
        int paddingLeft2 = getPaddingLeft();
        for (int i17 = 0; i17 < childCount2; i17++) {
            View childAt2 = getChildAt((!cwVar.W ? 1 : 0) + (!cwVar.f23343b0 ? 1 : 0) + i17);
            if (childAt2 != null) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        cw cwVar = this.f28836r;
        float f10 = 0.0f;
        if (!cwVar.W && (yvVar2 = cwVar.f23351y) != null) {
            f7 = yvVar2.getAlpha() * AndroidUtilities.dp(33.0f);
        } else {
            f7 = 0.0f;
        }
        int i13 = paddingRight - ((int) f7);
        if (!cwVar.f23343b0 && (yvVar = cwVar.E) != null) {
