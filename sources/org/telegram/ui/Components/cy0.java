...
public final class cy0 extends ul0 {
    public final Context f23433c;
    public int d;
    public final SparseArray e = new SparseArray();
    public final SparseArray f23434f = new SparseArray();
    public int h;
    public int f23435n;
    public final gy0 f23436r;
    ...
    public final void l() {
        ...
        if (gy0Var.W != null) {
            ...
            sparseArray.clear();
            SparseArray sparseArray2 = this.f23434f;
            sparseArray2.clear();
            this.h = 0;
            this.f23435n = 0;
    ...
    public final void u(int i10) {
        ArrayList arrayList = this.f23436r.Y;
        if (arrayList != null) {
            this.h = arrayList.size();
        }
        super.u(i10);
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (arrayList != null) {
            ...
            ((org.telegram.ui.Cells.g8) view).d((TLRPC.Document) sparseArray.get(i10), null, this.f23434f.get(i10), null, false, false);
        } else if (gy0Var.X != null) {
            ((org.telegram.ui.Cells.g8) view).setSticker((SendMessagesHelper.ImportingSticker) gy0Var.Y.get(i10));
        } else if (c1Var.f42977f != 3) {
            org.telegram.ui.Cells.g8 g8Var = (org.telegram.ui.Cells.g8) view;
            TLRPC.TL_messages_stickerSet tL_messages_stickerSet = gy0Var.S;
            if (tL_messages_stickerSet != null) {
                g8Var.d(tL_messages_stickerSet.documents.get(i10), null, gy0Var.S, null, gy0Var.f24486h0, gy0Var.R);
        ...
        if (i10 == 0) {
            ...
            if (i10 != 1) {
                if (i10 == 2) {
                    ...
                    frameLayout2 = new org.telegram.ui.Cells.t3(8, this.f23433c, f6Var2, true, false);
                } else if (i10 == 3) {
