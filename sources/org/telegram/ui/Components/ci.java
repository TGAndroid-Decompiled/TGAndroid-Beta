...
public final class ci implements org.telegram.ui.web.g0 {
    public ValueAnimator f23327a;
    public final ei.q4 f23328b;
    ...
    public final void k(boolean z10) {
        this.f23328b.setNeedCloseConfirmation(z10);
    }

    @Override
    public final void m(int i10) {
        this.f23328b.setCustomBackground(i10);
    }
    ...
    public final void n(TLRPC.InputInvoice inputInvoice, String str, TLObject tLObject) {
        ...
        if (oo0Var != null) {
            ...
            ld0Var.show();
            oo0Var.Z0 = new ai.q5(ld0Var, q4Var, str, 24);
    ...
    public final void q(boolean z10, boolean z11, String str, long j3, int i10, int i11, boolean z12, boolean z13) {
        ...
        if (oiVar == q4Var) {
            if (q4Var.P || this.f23329c != null) {
                ...
                if (wiVar.D1 != z10) {
                    wiVar.D1 = z10;
                    ValueAnimator valueAnimator = this.f23327a;
                    ...
                    this.f23327a = duration;
                    duration.addUpdateListener(new k6(this, 9));
                    this.f23327a.addListener(new uh(this, z10, 0));
                    this.f23327a.start();
                }
    ...
    public final void t(boolean z10) {
        int i10;
        org.telegram.ui.ActionBar.e1 e1Var = this.f23328b.L;
        if (e1Var != null) {
            if (z10) {
                i10 = 0;
            } else {
    ...
    public final void u(int i10, final int i11, boolean z10) {
        ...
        final ei.q4 q4Var = this.f23328b;
        duration.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                wiVar2.F2.a(d);
                jh.f fVar = wiVar2.f30070v1;
                if (fVar != null) {
                    fVar.invalidate();
                }
                q4Var.setCustomActionBarBackground(d);
                wiVar2.f30081y0.invalidate();
                wiVar2.f30057r1.invalidate();
    ...
    public final void v(TLRPC.User user, String str, ArrayList arrayList) {
        ...
        qyVar.C2 = new a1.d(this, user, str, ld0Var, 7);
        ld0Var.show();
        ld0Var.c(qyVar);
    }
    ...
    public final void x(boolean z10) {
        this.f23328b.setAllowSwipes(z10);
    }

    @Override
    public final void y() {
        wi wiVar = this.e;
        if (wiVar.f30081y0 != this.f23328b) {
            return;
        }
