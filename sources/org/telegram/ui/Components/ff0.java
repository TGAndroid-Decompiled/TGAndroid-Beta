...
public final class ff0 extends FrameLayout {
    ...
    public final cf0 F;
    public ef0 f24261a;
    public final lg.p f24262b;
    public final lg.f f24263c;
    public final boolean d;
    public final ImageReceiver e;
    public boolean f24264f;
    public boolean h;
    public float f24265n;
    public float f24266r;
    public AnimatorSet f24267s;
    public AnimatorSet v;
    public float f24268w;
    public final Paint f24269x;
    public final org.telegram.ui.ActionBar.d6 f24270y;

    public ff0(ContextThemeWrapper contextThemeWrapper, org.telegram.ui.ActionBar.d6 d6Var) {
        super(contextThemeWrapper);
        this.h = true;
        this.f24266r = 1.0f;
        this.f24268w = 0.0f;
        this.f24269x = new Paint(1);
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (this.f24264f && view == (pVar = this.f24262b)) {
            RectF actualRect = pVar.getActualRect();
            int dp = AndroidUtilities.dp(32.0f);
            org.telegram.ui.ls0 ls0Var = (org.telegram.ui.ls0) this.f24261a;
            ls0Var.getClass();
            PhotoViewer photoViewer = ls0Var.f35408a;
            float measuredWidth = (photoViewer.S7.getMeasuredWidth() - AndroidUtilities.dp(32.0f)) * photoViewer.f31389w8;
            int i10 = dp / 2;
            int dp2 = AndroidUtilities.dp(2.0f) + (((int) (measuredWidth + AndroidUtilities.dp(16.0f))) - i10);
            int measuredHeight = getMeasuredHeight() - AndroidUtilities.dp(156.0f);
            float f7 = actualRect.left;
            float f10 = this.f24266r;
            ...
            float width = ((dp - actualRect.width()) * this.f24266r) + actualRect.width();
            ImageReceiver imageReceiver = this.e;
            imageReceiver.setRoundRadius((int) (width / 2.0f));
            imageReceiver.setImageCoords(f11, z10, width, width);
            imageReceiver.setAlpha(this.f24265n);
            imageReceiver.draw(canvas);
            float f13 = this.f24268w;
            Paint paint = this.f24269x;
            if (f13 > 0.0f) {
                paint.setColor(-1);
                paint.setAlpha((int) (this.f24268w * 255.0f));
                canvas.drawCircle(actualRect.centerX(), actualRect.centerY(), actualRect.width() / 2.0f, paint);
            }
            paint.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19470zf, this.f24270y));
            paint.setAlpha(Math.min(255, (int) (this.f24266r * 255.0f * this.f24265n)));
    ...
    public float getRectSizeX() {
        return this.f24262b.getCropWidth();
    }

    public float getRectSizeY() {
        return this.f24262b.getCropHeight();
    }

    public float getRectX() {
        return this.f24262b.getCropLeft() - AndroidUtilities.dp(14.0f);
    }

    public float getRectY() {
        int i10;
        float cropTop = this.f24262b.getCropTop() - AndroidUtilities.dp(14.0f);
        if (!this.d) {
    ...
    public final void invalidate() {
        super.invalidate();
        this.f24262b.invalidate();
    }

    @Override
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (this.h && this.f24264f) {
            if (this.e.isInsideImage(motionEvent.getX(), motionEvent.getY())) {
                if (motionEvent.getAction() == 1) {
                    ((org.telegram.ui.ls0) this.f24261a).f();
                }
                return true;
            }
        }
    ...
    public void setAspectRatio(float f7) {
        this.f24262b.setAspectRatio(f7);
    }
    ...
    public void setFreeform(boolean z10) {
        this.f24262b.setFreeform(z10);
    }

    public void setSubtitle(String str) {
        this.f24262b.setSubtitle(str);
    }
