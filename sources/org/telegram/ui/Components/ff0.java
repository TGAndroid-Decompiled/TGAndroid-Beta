...
public final class ff0 extends View {
    public Paint f24148a;
    public Paint f24149b;
    public int f24150c;
    public int d;
    public float e;
    ...
    public final void a(int i10, boolean z10) {
        ...
        if (i10 < i11) {
            ...
            int i12 = this.f24152n;
            if (i10 > i12) {
                i10 = i12;
            }
        }
        this.e = (i10 - i11) / (this.f24152n - i11);
        invalidate();
        if (z10 && (ef0Var = this.f24153r) != null) {
    ...
    public int getProgress() {
        int i10 = this.h;
        return (int) ((this.e * (this.f24152n - i10)) + i10);
    }

    @Override
    public final void onDraw(Canvas canvas) {
        int i10;
        Paint paint = this.f24149b;
        int measuredHeight = getMeasuredHeight();
        int i11 = this.f24150c;
        int i12 = (measuredHeight - i11) / 2;
        int measuredWidth = (int) ((getMeasuredWidth() - i11) * this.e);
        float f7 = i11 / 2;
        canvas.drawRect(f7, (getMeasuredHeight() / 2) - AndroidUtilities.dp(1.0f), getMeasuredWidth() - i10, AndroidUtilities.dp(1.0f) + (getMeasuredHeight() / 2), this.f24148a);
        if (this.h == 0) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent != null) {
            ...
            if (motionEvent.getAction() == 0) {
                ...
                if (motionEvent.getAction() == 2 && this.f24151f) {
