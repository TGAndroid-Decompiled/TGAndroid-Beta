...
public class xb extends mb {
    ...
    public xb(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f30222b.setSingleLine();
        this.f30222b.setTypeface(Typeface.SANS_SERIF);
        this.f30222b.setTextSize(1, 15.0f);
        this.f30222b.setEllipsize(TextUtils.TruncateAt.END);
        this.f30222b.setPadding(0, AndroidUtilities.dp(8.0f), 0, AndroidUtilities.dp(8.0f));
        addView(this.f30222b, w7.y5.i(-2.0f, -2.0f, 8388627, 56.0f, 0.0f, 16.0f, 0.0f));
        this.f30222b.setLinkTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.Gi));
        setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.Hi));
        setBackground(getThemedColor(org.telegram.ui.ActionBar.j6.Fi));
    }

    public final void c(int i10, int i11, int i12, String... strArr) {
        kj0 kj0Var = this.f30221a;
        kj0Var.f(i10, i11, i12, null);
        for (String str : strArr) {
            kj0Var.h(this.f30223c, str);
        }
    }
    ...
    public void setIconPaddingBottom(int i10) {
        this.f30221a.setLayoutParams(w7.y5.i(56.0f, 48 - i10, 8388627, 0.0f, 0.0f, 0.0f, i10));
    }

    public void setTextColor(int i10) {
        this.f30223c = i10;
        this.f30222b.setTextColor(i10);
    }
