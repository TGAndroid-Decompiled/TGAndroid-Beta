...
public final class su extends org.telegram.ui.ActionBar.h5 {
    ...
    public final boolean g() {
        ...
        try {
            vuVar.f29416r.getWindow().clearFlags(128);
            return true;
        } catch (Exception e) {
            FileLog.e(e);
            return true;
    ...
    public final void onOpenAnimationEnd() {
        ...
        vu vuVar = this.h;
        int i10 = vuVar.Q;
        RadialProgressView radialProgressView = vuVar.f29415n;
        pu puVar = vuVar.f29412b;
        d91 d91Var = vuVar.f29413c;
        if (this.f27930f && vuVar.f29413c.g(vuVar.K, null, null, vuVar.I, true)) {
