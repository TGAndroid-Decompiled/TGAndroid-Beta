...
public final class su extends org.telegram.ui.ActionBar.g5 {
    ...
    public final boolean g() {
        ...
        try {
            vuVar.f29833r.getWindow().clearFlags(128);
            return true;
        } catch (Exception e) {
            FileLog.e(e);
            return true;
    ...
    public final void onOpenAnimationEnd() {
        ...
        vu vuVar = this.h;
        int i10 = vuVar.Q;
        RadialProgressView radialProgressView = vuVar.f29832n;
        pu puVar = vuVar.f29829b;
        p91 p91Var = vuVar.f29830c;
        if (this.f28214f && vuVar.f29830c.g(vuVar.K, null, null, vuVar.I, true)) {
