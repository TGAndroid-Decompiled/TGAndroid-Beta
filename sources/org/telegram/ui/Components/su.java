...
public final class su extends org.telegram.ui.ActionBar.h5 {
    ...
    public final boolean g() {
        ...
        try {
            vuVar.f29413r.getWindow().clearFlags(128);
            return true;
        } catch (Exception e) {
            FileLog.e(e);
            return true;
    ...
    public final void onOpenAnimationEnd() {
        ...
        vu vuVar = this.h;
        int i10 = vuVar.Q;
        RadialProgressView radialProgressView = vuVar.f29412n;
        pu puVar = vuVar.f29409b;
        d91 d91Var = vuVar.f29410c;
        if (this.f27927f && vuVar.f29410c.g(vuVar.K, null, null, vuVar.I, true)) {
