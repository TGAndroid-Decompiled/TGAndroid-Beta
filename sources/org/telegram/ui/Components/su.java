...
public final class su extends org.telegram.ui.ActionBar.g5 {
    ...
    public final boolean g() {
        ...
        try {
            vuVar.f29434r.getWindow().clearFlags(128);
            return true;
        } catch (Exception e) {
            FileLog.e(e);
            return true;
    ...
    public final void onOpenAnimationEnd() {
        ...
        vu vuVar = this.h;
        int i10 = vuVar.Q;
        RadialProgressView radialProgressView = vuVar.f29433n;
        pu puVar = vuVar.f29430b;
        c91 c91Var = vuVar.f29431c;
        if (this.f27971f && vuVar.f29431c.g(vuVar.K, null, null, vuVar.I, true)) {
