...
public class nt extends View {
    public final l01 f29621a;
    public final Drawable f29622b;
    public final ImageReceiver f29623c;
    public final Rect d;
    ...
    public nt(Context context, CharSequence charSequence) {
        ...
        this.f29623c = imageReceiver;
        imageReceiver.setRoundRadius(AndroidUtilities.dp(22.66f));
        this.f29621a = new l01(charSequence, 14.0f, AndroidUtilities.bold());
    ...
    public final void a(TLRPC.Photo photo, Object obj) {
        ...
        this.f29623c.setImage(ImageLocation.getForPhoto(closestPhotoSizeWithSize, photo), "24_24", ImageLocation.getForPhoto(closestPhotoSizeWithSize2, photo), "24_24", 0L, null, obj, 0);
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.f29623c.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f29623c.onDetachedFromWindow();
    }
    ...
    public final void onDraw(Canvas canvas) {
        float f10;
        int dp;
        ImageReceiver imageReceiver = this.f29623c;
        ...
        int dp2 = AndroidUtilities.dp(19.0f) + ((int) Math.ceil(this.f29621a.f28521c)) + AndroidUtilities.dp(f10);
        ...
        qg.b bVar = this.f29625f;
        if (bVar != null) {
            bVar.setBounds(rect);
            this.f29625f.draw(canvas);
        }
        if (hasBitmapImage) {
            float f11 = height;
            float dp4 = (AndroidUtilities.dp(22.66f) / 2.0f) + f11;
            RectF rectF = this.f29624e;
        ...
        this.f29621a.c(width + dp, height, 1.0f, -1, canvas);
        Drawable drawable = this.f29622b;
    ...
    public void setImage(Bitmap bitmap) {
        this.f29623c.setImageBitmap(bitmap);
        invalidate();
    }
