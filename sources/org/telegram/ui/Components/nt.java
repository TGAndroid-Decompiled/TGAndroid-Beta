...
public class nt extends View {
    public final f01 f28885a;
    public final Drawable f28886b;
    public final ImageReceiver f28887c;
    public final Rect d;
    public final RectF f28888e;
    public dh.d f28889f;

    public nt(Context context, CharSequence charSequence) {
        super(context);
        this.d = new Rect();
        this.f28888e = new RectF();
        ImageReceiver imageReceiver = new ImageReceiver(this);
        this.f28887c = imageReceiver;
        imageReceiver.setRoundRadius(AndroidUtilities.dp(22.66f));
        this.f28885a = new f01(charSequence, 14.0f, AndroidUtilities.bold());
    ...
    public final void a(TLRPC.Photo photo, Object obj) {
        ...
        this.f28887c.setImage(ImageLocation.getForPhoto(closestPhotoSizeWithSize, photo), "24_24", ImageLocation.getForPhoto(closestPhotoSizeWithSize2, photo), "24_24", 0L, null, obj, 0);
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.f28887c.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f28887c.onDetachedFromWindow();
    }
    ...
    public final void onDraw(Canvas canvas) {
        float f7;
        int dp;
        ImageReceiver imageReceiver = this.f28887c;
        ...
        int dp2 = AndroidUtilities.dp(19.0f) + ((int) Math.ceil(this.f28885a.f25874c)) + AndroidUtilities.dp(f7);
        ...
        dh.d dVar = this.f28889f;
        if (dVar != null) {
            dVar.setBounds(rect);
            this.f28889f.draw(canvas);
        }
        if (hasBitmapImage) {
            float f10 = height;
            float dp4 = (AndroidUtilities.dp(22.66f) / 2.0f) + f10;
            RectF rectF = this.f28888e;
        ...
        this.f28885a.c(width + dp, height, 1.0f, -1, canvas);
        Drawable drawable = this.f28886b;
    ...
    public void setImage(Bitmap bitmap) {
        this.f28887c.setImageBitmap(bitmap);
        invalidate();
    }
