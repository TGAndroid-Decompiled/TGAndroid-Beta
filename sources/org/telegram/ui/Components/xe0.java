...
public final class xe0 {
    ...
    public final ViewGroup a(Context context, int i10) {
        ...
        if (z10) {
            ...
            frameLayout.f30633b = textView2;
            textView2.setTextColor(af0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19461z6));
            ...
            frameLayout.f30634c = imageView;
            imageView.setScaleType(ImageView.ScaleType.CENTER);
            imageView.setColorFilter(new PorterDuffColorFilter(af0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19223m6), PorterDuff.Mode.MULTIPLY));
            ...
            if (arrayList2.size() == 1 && arrayList.size() == 0) {
                ...
                if (userStatus != null && userStatus.expires != 0) {
                    i11 = ((org.telegram.ui.ActionBar.e3) af0Var).currentAccount;
            ...
            i12 = ((org.telegram.ui.ActionBar.e3) af0Var).currentAccount;
            ...
            textView3.setTextColor(af0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19165j5));
            ...
            if (str != null) {
                ...
                f15.setTextColor(af0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19315r5));
        ...
        if (z10) {
            ...
            ImageView imageView2 = ye0Var.f30634c;
            ye0Var.f30632a.setText(vcardItem.getValue(true));
            ye0Var.f30633b.setText(vcardItem.getType());
            Switch r82 = ye0Var.d;
            if (r82 != null) {
