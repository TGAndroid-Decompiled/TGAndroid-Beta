...
public class ShareTopView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public class Layout extends FrameLayout {
        ...
        public Layout(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            imageView2.setOnClickListener(new SearchField$$ExternalSyntheticLambda0(this, 14));
    ...
    private void bindMedia(Layout layout) {
        ...
        if (size2 == 1) {
            layout.name.setText(LocaleController.getString(arrayList.get(0).isVideo ? R.string.ShareSendVideo : R.string.ShareSendPhoto));
        } else if (i2 == 0) {
    ...
    private CharSequence buildRecipientText(Layout layout) {
        ...
        while (i < size) {
            ...
            if (jLongValue == this.selfId) {
                ...
                sb.append(this.recipients.size() == 1 ? DialogObject.getName(this.currentAccount, jLongValue) : DialogObject.getShortName(this.currentAccount, jLongValue));
            }
        }
    ...
    public void lambda$requestLinkPreview$1(int i, TLObject tLObject, String str) {
        ...
        if (webPage instanceof TLRPC.TL_webPage) {
            if (this.linkPreviewCache.size() > 5) {
                Iterator<String> it = this.linkPreviewCache.keySet().iterator();
    ...
    public void lambda$requestLinkPreview$2(int i, String str, TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new ShareTopView$$ExternalSyntheticLambda3(this, i, tLObject, str, 0));
    }
    ...
    private void requestLinkPreview(String str) {
        cancelLinkRequest();
        ...
        int i = this.linkRequestSerial + 1;
        this.linkRequestSerial = i;
        this.linkRequestId = AccountInstance.getInstance(this.currentAccount).getConnectionsManager().sendRequest(getwebpagepreview, new ShareTopView$$ExternalSyntheticLambda0(this, i, str, 0));
    }
    ...
    private void switchLayouts(boolean z) {
        ...
        Layout layout3 = this.layouts[1];
        layout3.active = false;
        layout3.animate().scaleX(0.8f).scaleY(0.8f).alpha(0.0f).translationY(-AndroidUtilities.dp(20.0f)).setInterpolator(cubicBezierInterpolator).setDuration(320L).withEndAction(new Tooltip$$ExternalSyntheticLambda0(layout3, 15)).start();
    }
    ...
    public void startHintRotation(CharSequence charSequence) {
        ...
        applyHintText(current());
        Tooltip$$ExternalSyntheticLambda0 tooltip$$ExternalSyntheticLambda0 = new Tooltip$$ExternalSyntheticLambda0(this, 14);
        this.hintRunnable = tooltip$$ExternalSyntheticLambda0;
        AndroidUtilities.runOnUIThread(tooltip$$ExternalSyntheticLambda0, 1000L);
    }
