...
public final class oq0 extends View {
    public Random f26833a;
    public Paint f26834b;
    public Paint f26835c;
    public Paint d;
    public Paint e;
    public float f26836f;
    public float h;
    public float f26837n;

    @Override
    public final void onDraw(Canvas canvas) {
        float f7;
        Paint paint = this.f26835c;
        Paint paint2 = this.f26834b;
        super.onDraw(canvas);
        ...
        float f12 = (this.f26837n * interpolation) + ((1.0f - interpolation) * this.h);
        canvas.save();
        ...
        float f15 = this.f26836f + 0.016f;
        this.f26836f = f15;
        if (f15 > 1.0f) {
            this.h = this.f26837n;
            float c10 = org.telegram.ui.Cells.p6.c(this.f26833a, 1001) / 1000.0f;
            this.f26837n = c10;
            if (c10 > this.h) {
                this.f26837n = c10 + 0.3f;
            } else {
                this.f26837n = c10 - 0.3f;
            }
            this.f26837n = Math.max(0.0f, Math.min(1.0f, this.f26837n));
            this.f26836f = 0.0f;
        }
        invalidate();
    }
