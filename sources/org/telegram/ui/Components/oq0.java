...
public final class oq0 extends View {
    public Random f26836a;
    public Paint f26837b;
    public Paint f26838c;
    public Paint d;
    public Paint e;
    ...
    public final void onDraw(Canvas canvas) {
        float f7;
        Paint paint = this.f26838c;
        Paint paint2 = this.f26837b;
        super.onDraw(canvas);
        ...
        float f12 = (this.f26840n * interpolation) + ((1.0f - interpolation) * this.h);
        canvas.save();
        ...
        float f15 = this.f26839f + 0.016f;
        this.f26839f = f15;
        if (f15 > 1.0f) {
            this.h = this.f26840n;
            float c10 = org.telegram.ui.Cells.p6.c(this.f26836a, 1001) / 1000.0f;
            this.f26840n = c10;
            if (c10 > this.h) {
                this.f26840n = c10 + 0.3f;
            } else {
                this.f26840n = c10 - 0.3f;
            }
            this.f26840n = Math.max(0.0f, Math.min(1.0f, this.f26840n));
            this.f26839f = 0.0f;
        }
        invalidate();
    }
