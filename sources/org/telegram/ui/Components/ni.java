...
public final class ni implements Utilities.CallbackReturn {
    ...
    public final Object run(Object obj) {
        ...
        switch (this.f27289a) {
            case 0:
                return Boolean.valueOf(wi.J((wi) this.f27290b, (MessageObject) obj));
            case 1:
                eh.g gVar = (eh.g) this.f27290b;
                View view = (View) obj;
                ...
                svgThumb.setColorKey(org.telegram.ui.ActionBar.j6.f20147qe);
                imageReceiver.setImage(ImageLocation.getForWebFile(WebFile.createWithGeoPoint(gVar.f5614b.geo, 300, 168, 15, Math.min(2, (int) Math.ceil(AndroidUtilities.density)))), (String) null, (ImageLocation) null, (String) null, new cq(svgThumb), (Object) null, 0);
            ...
            case 2:
                int i13 = ((SparseIntArray) this.f27290b).get(((Integer) obj).intValue(), -1);
                if (i13 == -1) {
                    return Boolean.TRUE;
                }
                boolean z4 = true;
            ...
            default:
                g61 g61Var = (g61) this.f27290b;
                View view2 = (View) obj;
                g61Var.getClass();
                if (view2.getParent() != g61Var) {
                    return Boolean.FALSE;
                }
                return Boolean.valueOf(!w51.K(g61Var.T(view2).f5788f));
        }
    }
}
