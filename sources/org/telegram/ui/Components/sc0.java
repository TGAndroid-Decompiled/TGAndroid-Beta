...
public final class sc0 extends Drawable {
    public final Drawable f28092a;
    public final Paint f28093b;
    public final Paint f28094c;
    public final d6 d;
    public boolean e;
    ...
    public sc0(Context context) {
        ...
        this.f28094c = paint2;
        this.d = new d6(new jc0(this, 2), 200L, qr.f27643g, 0);
        this.f28092a = context.getResources().getDrawable(R.drawable.filled_sound_on).mutate();
    ...
    public final void draw(Canvas canvas) {
        ...
        Drawable drawable = this.f28092a;
        ...
        if (e > 0.0f) {
            ...
            float f11 = centerY;
            float f12 = dp;
            canvas.drawLine(f10, f11, f12, f7, this.f28094c);
            Paint paint = this.f28093b;
