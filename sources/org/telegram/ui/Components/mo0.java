...
public class mo0 extends ScrollView {
    public final org.telegram.ui.ActionBar.d6 f26552a;
    public final LinearLayout f26553b;
    public final float f26554c;
    public final float[] d;
    public final float[] e;
    public final ArrayList f26555f;
    public final ArrayList h;
    public final Path f26556n;

    public mo0(Context context, LinearLayout linearLayout, org.telegram.ui.ActionBar.d6 d6Var, boolean z10) {
        super(context);
        float f7;
        this.f26554c = AndroidUtilities.dp(16.0f);
        this.f26555f = new ArrayList();
        this.h = new ArrayList();
        this.f26556n = new Path();
        this.f26552a = d6Var;
    ...
    public final void a(Canvas canvas, View view, View view2) {
        ...
        if (view != null && view2 != null) {
            ...
            if (rectF.bottom >= rectF.top) {
                wl0.O0(canvas, rectF, AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f), view.getAlpha(), this.f26552a);
            }
        }
    }
            ...
            if (childAt.getVisibility() == 0) {
                if (childAt instanceof LinearLayout) {
                    ...
                    if (linearLayout.getOrientation() == 1) {
                        LinearLayout linearLayout2 = this.f26553b;
    ...
    public final float c(View view) {
        if (view != this.f26553b && (view.getParent() instanceof View)) {
    ...
    public final void onScrollChanged(int i10, int i11, int i12, int i13) {
        ...
        ArrayList arrayList = this.f26555f;
        int size = arrayList.size();
        int i14 = 0;
        while (i14 < size) {
