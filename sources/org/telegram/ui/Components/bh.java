...
public final class bh extends e6 {
    public ch.d f22725s;
    public final Path v;
    public final RectF f22726w;
    public FragmentContextView f22727x;

    public bh(Context context) {
        super(context);
        this.v = new Path();
        this.f22726w = new RectF();
        setOrientation(1);
        ch.d dVar = this.f22725s;
        if (dVar != null) {
            dVar.v();
        }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        FragmentContextView fragmentContextView3 = this.f22727x;
        ...
        if (fragmentContextView3 != null && ((currentStyle = fragmentContextView3.getCurrentStyle()) == 3 || currentStyle == 1)) {
            ...
            for (int i10 = 0; i10 < entriesCount; i10++) {
                ...
                View view = ((d6) n10.f13994a).f23213a;
                float c10 = n10.c();
                if (c10 > 0.0f && ((fragmentContextView2 = this.f22727x) == view || fragmentContextView2.getParent() == view)) {
                    gd capsuleBlobDrawable = this.f22727x.getCapsuleBlobDrawable();
        ...
        while (i12 < entriesCount2) {
            ...
            View view2 = ((d6) n11.f13994a).f23213a;
            float min = Math.min(1.0f, n11.f13996c.f14008a) * n11.c();
            if (min > 0.0f && (!z10 || (fragmentContextView = this.f22727x) == null || (fragmentContextView != view2 && fragmentContextView.getParent() != view2))) {
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (!super.dispatchTouchEvent(motionEvent)) {
            if (motionEvent.getAction() != 0 || (dVar = this.f22725s) == null || !dVar.getBounds().contains((int) motionEvent.getX(), (int) motionEvent.getY())) {
                return false;
            }
            return true;
        }
    ...
    public final void j() {
        ...
        if (dVar != null) {
            ...
            this.f22725s.setBounds(getPaddingLeft() - AndroidUtilities.dp(7.0f), 0, AndroidUtilities.dp(7.0f) + (getMeasuredWidth() - getPaddingRight()), getPaddingBottom() + getPaddingTop() + ((int) f7));
            this.f22725s.q(Math.min(AndroidUtilities.dp(18.0f), f7 / 2.0f));
        }
    }
    ...
    public void setCallFragmentContextView(FragmentContextView fragmentContextView) {
        this.f22727x = fragmentContextView;
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (!super.verifyDrawable(drawable)) {
            FragmentContextView fragmentContextView = this.f22727x;
