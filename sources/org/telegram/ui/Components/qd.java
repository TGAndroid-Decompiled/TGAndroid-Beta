...
public final class qd implements sh.i0, org.telegram.ui.ActionBar.c2, vt, org.telegram.ui.ActionBar.n1 {
    public final ChatActivityEnterView f30388a;

    public qd(ChatActivityEnterView chatActivityEnterView) {
        this.f30388a = chatActivityEnterView;
    }

    @Override
    public void b0() {
        ChatActivityEnterView chatActivityEnterView = this.f30388a;
    ...
    public void n(KeyEvent keyEvent) {
        ...
        if (keyEvent.getKeyCode() == 4 && keyEvent.getRepeatCount() == 0 && (bfVar = (chatActivityEnterView = this.f30388a).K0) != null && bfVar.isShowing()) {
