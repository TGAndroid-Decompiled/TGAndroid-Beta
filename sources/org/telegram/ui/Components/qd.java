...
public final class qd implements Runnable {
    ...
    public final ChatActivityEnterView f27268b;

    public qd(ChatActivityEnterView chatActivityEnterView, int i10) {
        this.f27267a = i10;
        this.f27268b = chatActivityEnterView;
    }
    ...
    public final void run() {
        ...
        boolean z10 = true;
        ChatActivityEnterView chatActivityEnterView = this.f27268b;
        switch (i10) {
            case 0:
            ...
            case 5:
                ...
                if (AndroidUtilities.isTablet()) {
                    ...
                    if (activity instanceof LaunchActivity) {
                        ActionBarLayout actionBarLayout = ((LaunchActivity) activity).f30863r0;
                ...
                if (!chatActivityEnterView.f21797i2 && z10 && (ofVar = chatActivityEnterView.E0) != null) {
                    try {
                        ofVar.requestFocus();
                        return;
                    } catch (Exception e) {
            ...
            case 19:
                ...
                ChatActivityEnterView chatActivityEnterView2 = this.f27268b;
            ...
            case 21:
                ...
                return;
            case 22:
                chatActivityEnterView.f21809k3 = false;
            ...
            case 28:
                ...
                String str = chatActivityEnterView.f21795i0;
                String str2 = chatActivityEnterView.f21801j0;
                ...
                if (launchActivity != null && launchActivity.P() != null && LaunchActivity.G1.P().k(b10) != null) {
                    ei.c0 c0Var2 = chatActivityEnterView.f21812l0;
                    if (c0Var2 != null) {
                        c0Var2.setOpened(false);
                        return;
                    }
                    return;
                } else if (org.telegram.ui.hc0.l(chatActivityEnterView.f21801j0)) {
                    ?? obj = new Object();
                    obj.f15221c = new qd(chatActivityEnterView, 1);
                    nf.f.k(chatActivityEnterView.getContext(), chatActivityEnterView.f21801j0, false, false, obj);
                    return;
                } else {
                    ...
                    k3Var.s(boVar5, b10);
                    k3Var.show();
                    ei.c0 c0Var3 = chatActivityEnterView.f21812l0;
                    if (c0Var3 != null) {
            ...
            default:
                if (chatActivityEnterView.f21812l0 != null && !SharedPrefsHelper.isWebViewConfirmShown(chatActivityEnterView.Q, chatActivityEnterView.P2)) {
                    chatActivityEnterView.f21812l0.setOpened(false);
                    return;
                }
                return;
        }
