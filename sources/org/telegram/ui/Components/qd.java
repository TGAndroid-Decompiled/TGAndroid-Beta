...
public final class qd implements Runnable {
    public final int f27571a = 0;
    public final Object f27572b;
    ...
    public final Object f27576r;
    public final Object f27577s;
    public final Object v;

    public qd(gg ggVar, Object obj, MediaController.PhotoEntry photoEntry, boolean z10, int i10, int i11, boolean z11, Long l4, String str, Object obj2) {
        this.f27576r = ggVar;
        this.f27572b = obj;
        this.f27577s = photoEntry;
        this.f27573c = z10;
        this.d = i10;
        this.e = i11;
        this.f27574f = z11;
    ...
    public final void run() {
        ...
        switch (this.f27571a) {
            case 0:
                ChatActivityEnterView.g((ChatActivityEnterView) this.f27576r, (TLRPC.Document) this.f27577s, this.f27575n, (MessageObject.SendAnimationData) this.v, this.f27573c, this.d, this.e, this.f27572b, this.h, this.f27574f);
                return;
            default:
                MediaController.PhotoEntry photoEntry = (MediaController.PhotoEntry) this.f27577s;
                ChatActivityEnterView chatActivityEnterView = ((gg) this.f27576r).f24382a;
                ...
                if (z13) {
                    ...
                    if (obj instanceof TLRPC.BotInlineResult) {
                        ...
                        if (storyItem3 == null) {
                            ...
                            org.telegram.ui.pn pnVar4 = chatActivityEnterView.U2;
                            if (znVar != null) {
                                sendMessageChatArguments = znVar.C8();
                            }
    ...
    public qd(ChatActivityEnterView chatActivityEnterView, TLRPC.Document document, String str, MessageObject.SendAnimationData sendAnimationData, boolean z10, int i10, int i11, Object obj, Long l4, boolean z11) {
        this.f27576r = chatActivityEnterView;
        this.f27577s = document;
        this.f27575n = str;
