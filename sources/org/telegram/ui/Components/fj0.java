...
public class fj0 extends hj0 {
    ...
    public int B(Bitmap bitmap, boolean z10) {
        ...
        if (i10 == 1) {
            ...
            if (this.X0) {
                this.f24678a0 = this.f24131a1 - 1;
            }
        } else {
            rLottieNative = this.m0;
        }
        if (rLottieNative.c(this.f24678a0, bitmap, z10) < 0) {
            return 2;
        }
        return 1;
    }
    ...
    public void i() {
        ...
        if (i10 == 1) {
            ...
            int i13 = this.f24678a0 + 1;
            if (i13 < this.f24131a1) {
                this.f24678a0 = i13;
                return;
            }
            this.N = true;
