        ...
        switch (this.f27279a) {
            case 0:
                ...
                for (int i14 = 0; i14 < 5; i14++) {
                    ...
                    j8 j8Var = this.f27280b;
                    View view = j8Var.f25317n0[i14];
                    view.layout(dp, dp2, view.getMeasuredWidth() + dp, j8Var.f25317n0[i14].getMeasuredHeight() + dp2);
                }
                return;
            case 1:
            default:
            ...
            case 2:
                super.onLayout(z10, i10, i11, i12, i13);
                j8 j8Var2 = this.f27280b;
                if (j8Var2.V != null && (textView = j8Var2.f25301a0) != null) {
