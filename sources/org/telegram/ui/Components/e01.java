...
public final class e01 extends FrameLayout {
    ...
    public d01 f25504b;
    public TLRPC.TL_help_termsOfService f25505c;
    public int d;

    public final void a() {
        d01 d01Var = this.f25504b;
        int i10 = this.d;
        org.telegram.ui.xa0 xa0Var = (org.telegram.ui.xa0) d01Var;
        xa0Var.getClass();
        UserConfig.getInstance(i10).unacceptedTermsOfService = null;
        UserConfig.getInstance(i10).saveConfig(false);
        LaunchActivity launchActivity = xa0Var.f42655a;
        ...
        tL_help_acceptTermsOfService.f19924id = this.f25505c.f19926id;
