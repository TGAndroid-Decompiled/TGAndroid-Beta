...
public final class e01 extends FrameLayout {
    public static final int f25529e = 0;
    public TextView f25530a;
    public d01 f25531b;
    public TLRPC.TL_help_termsOfService f25532c;
    public int d;

    public final void a() {
        d01 d01Var = this.f25531b;
        int i10 = this.d;
        org.telegram.ui.xa0 xa0Var = (org.telegram.ui.xa0) d01Var;
        xa0Var.getClass();
        UserConfig.getInstance(i10).unacceptedTermsOfService = null;
        UserConfig.getInstance(i10).saveConfig(false);
        LaunchActivity launchActivity = xa0Var.f42682a;
        ...
        tL_help_acceptTermsOfService.f19951id = this.f25532c.f19953id;
