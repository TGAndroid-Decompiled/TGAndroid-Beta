...
public final class sl0 {
    ...
    public Bitmap f30386k;
    public int f30387l;
    public int f30388m;
    public int f30389n;
    public int f30390o;
    public boolean f30391p;
    public boolean f30394s;
    public o5 f30395t;
    public o5 f30396u;
    public long v;
    public long f30397w;
    ...
    public int f30399y;
    public int f30400z;
    public final RectF f30378a = new RectF();
    public final Paint f30379b = new Paint(1);
    public final Paint f30380c = new Paint(3);
    public final Matrix d = new Matrix();
    public final float[] f30381e = new float[8];
    public final Path f30382f = new Path();
    public final Paint f30383g = new Paint();
    public int f30392q = 0;
    public float f30393r = 1.0f;
    ...
    public final int a(MessageObject messageObject, TLRPC.User user, TLRPC.Chat chat, org.telegram.ui.ActionBar.f6 f6Var, int i10) {
        ...
        if (messageObject == null) {
            ...
            this.f30398x = org.telegram.ui.ActionBar.j6.l1(f7, v02);
            this.C = h();
        ...
        if (i10 == 4 && (message4 = messageObject.messageOwner) != null && MessageObject.getMedia(message4) != null && (MessageObject.getMedia(messageObject.messageOwner) instanceof TLRPC.TL_messageMediaContact)) {
            ...
            this.f30398x = org.telegram.ui.ActionBar.j6.l1(0.1f, this.f30400z);
            this.f30399y = this.f30400z;
        } else {
            h5Var = h5Var2;
            if (i10 != 0 && (messageObject.overrideLinkColor >= 0 || (messageObject.messageOwner != null && (((messageObject.isFromUser() || DialogObject.isEncryptedDialog(messageObject.getDialogId())) && user4 != null) || ((messageObject.isFromChannel() && chat != null) || (((message3 = messageObject.messageOwner) != null && (messageFwdHeader3 = message3.fwd_from) != null && messageFwdHeader3.from_id != null) || (messageObject.isSponsored() && (peerColor2 = messageObject.sponsoredColor) != null && peerColor2.color != -1))))))) {
                ...
                this.A = v04;
                this.f30400z = v04;
                this.f30398x = org.telegram.ui.ActionBar.j6.l1(0.1f, v04);
                this.f30399y = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Wc, f6Var);
            }
        }
        if (messageObject.shouldDrawWithoutBackground()) {
            ...
            this.f30400z = -1;
            this.f30398x = 0;
            this.f30399y = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Xc, f6Var);
            ...
            if (i10 == 2 && !messageObject.isOutOwner()) {
                ...
                if (!this.f30384i && !this.f30385j) {
                    i12 = org.telegram.ui.ActionBar.j6.f20638ab;
                } else {
                    i12 = org.telegram.ui.ActionBar.j6.f20658bb;
                }
            ...
            if (this.f30385j) {
                this.R = true;
                this.f30400z = org.telegram.ui.ActionBar.j6.l1(0.2f, this.f30400z);
                this.A = org.telegram.ui.ActionBar.j6.l1(0.5f, this.A);
            } else if (this.f30384i) {
                this.R = true;
                this.f30400z = org.telegram.ui.ActionBar.j6.l1(0.35f, this.f30400z);
            }
            int i16 = this.B;
            if (q6) {
                f10 = 0.12f;
            }
            this.f30398x = org.telegram.ui.ActionBar.j6.l1(f10, i16);
            this.f30399y = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.cb, f6Var);
        }
        ...
        if (this.v != 0 && this.f30395t == null && (view = this.D) != null) {
            this.f30395t = new o5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.t1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.t1) view).M0) {
                this.f30395t.a();
            }
        }
        o5 o5Var = this.f30395t;
        if (o5Var != null) {
            z11 = true;
        ...
        o5 o5Var2 = this.f30396u;
        if (o5Var2 != null) {
            o5Var2.j(this.f30397w, z11);
        }
        this.C = h();
        return h5Var.a(this.f30399y, false);
    }
    ...
    public final void d(Canvas canvas, RectF rectF, float f7, boolean z10, boolean z11) {
        ...
        float f10;
        if (!z11) {
            int l1 = org.telegram.ui.ActionBar.j6.l1(f7, this.E.a(this.f30398x, false));
            Paint paint = this.f30383g;
            paint.setColor(l1);
            float[] fArr = this.f30381e;
            if (yf.f0.c(fArr)) {
                float f11 = fArr[0];
                ...
                Path path = this.f30382f;
                path.rewind();
                path.addRoundRect(rectF, fArr, Path.Direction.CW);
                canvas.drawPath(path, paint);
            }
        }
        o5 o5Var2 = this.f30395t;
        if (o5Var2 != null) {
            if (!this.Y) {
                Drawable drawable = o5Var2.f28988f[0];
                if ((drawable instanceof q5) && (y3Var = ((q5) drawable).f29611k) != null && y3Var.hasImageLoaded()) {
                    this.Y = true;
                } else {
                    z12 = false;
                    e7 = this.L.e(z12);
                    if (e7 <= 0.0f && this.f30393r > 0.0f) {
                        if (this.W == null) {
                        ...
                        o5 o5Var3 = this.f30396u;
                        if (o5Var3 != null) {
                            o5Var3.v = (int) (f7 * 255.0f);
                        }
                        this.f30395t.k(Integer.valueOf(this.C));
                        int i10 = 0;
                        while (true) {
                            rl0[] rl0VarArr = this.W;
                            if (i10 < rl0VarArr.length) {
                                if (i10 != 0 || (o5Var = this.f30396u) == null || this.f30397w == 0) {
                                    o5Var = this.f30395t;
                                }
                                rl0 rl0Var = rl0VarArr[i10];
                                if (!rl0Var.f30075e || z10) {
                                    if (o5Var == this.f30396u) {
                                        f10 = 1.0f;
                                    } else {
                                        f10 = 0.3f;
                                    }
                                    o5Var.v = (int) (f10 * 255.0f * rl0Var.d * this.f30393r);
                                    float dp = max - AndroidUtilities.dp(rl0Var.f30072a);
                                    float dp2 = AndroidUtilities.dp(rl0Var.f30073b) + min;
                                    float dp3 = AndroidUtilities.dp(10.0f) * rl0Var.f30074c * e7;
    ...
    public final void f(Canvas canvas, RectF rectF, float f7, float f10, float f11, float f12) {
        ...
        if (this.h == null) {
            ...
            this.h = h90Var3;
            h90Var3.C = true;
            h90Var3.f26715t = 3.5f;
            h90Var3.f26716u = 0.5f;
        }
        this.h.f(org.telegram.ui.ActionBar.j6.l1(0.1f, this.f30400z), org.telegram.ui.ActionBar.j6.l1(0.3f, this.f30400z), org.telegram.ui.ActionBar.j6.l1(0.3f, this.f30400z), org.telegram.ui.ActionBar.j6.l1(1.25f, this.f30400z));
        this.h.d(rectF);
        this.h.i(fArr);
        this.h.f26717w.setStrokeWidth(AndroidUtilities.dp(1.0f));
    ...
    public final void k() {
        this.F.a(this.f30400z, true);
        this.G.a(this.A, true);
        this.J.f(this.f30384i, true);
        this.I.a(this.f30399y, true);
        this.E.a(this.f30398x, true);
        o5 o5Var = this.f30395t;
        if (o5Var != null) {
            o5Var.d.d(1.0f, true);
        }
    ...
    public final int l(MessageObject messageObject, TLRPC.TL_peerColorCollectible tL_peerColorCollectible, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.R = false;
        this.f30400z = tL_peerColorCollectible.colors.get(0).intValue() | (-16777216);
        if (arrayList.size() >= 2) {
            z10 = true;
        } else {
            z10 = false;
        ...
        this.f30399y = i12;
        this.f30398x = org.telegram.ui.ActionBar.j6.l1(0.1f, i12);
        long j3 = tL_peerColorCollectible.background_emoji_id;
        this.v = j3;
        this.f30397w = tL_peerColorCollectible.gift_emoji_id;
        View view = this.D;
        if (j3 != 0 && this.f30395t == null && view != null) {
            this.f30395t = new o5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.t1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.t1) view).M0) {
                this.f30395t.a();
            }
        ...
        this.C = this.f30399y;
        if (this.f30397w != 0 && this.f30396u == null && view != null) {
            this.f30396u = new o5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.t1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.t1) view).M0) {
                this.f30396u.a();
            }
        }
        o5 o5Var2 = this.f30396u;
        if (o5Var2 != null) {
            o5Var2.j(this.f30397w, true);
        }
        return this.I.a(this.f30399y, false);
    }
    ...
    public final void m(MessageObject messageObject, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        if (i10 < 7) {
            int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20945r8[i10], f6Var);
            this.B = v02;
            this.A = v02;
            this.f30400z = v02;
            this.f30385j = false;
    ...
    public final int o(org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f30399y = org.telegram.ui.ActionBar.j6.v0(i10, f6Var);
        this.f30400z = org.telegram.ui.ActionBar.j6.v0(i10, f6Var);
        this.f30384i = false;
        this.f30385j = false;
        this.f30398x = org.telegram.ui.ActionBar.j6.l1(0.1f, org.telegram.ui.ActionBar.j6.v0(i10, f6Var));
        if (this.v != 0 && this.f30395t == null && (view = this.D) != null) {
            this.f30395t = new o5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.t1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.t1) view).M0) {
                this.f30395t.a();
    ...
    public final void q(int i10, boolean z10) {
        ...
        this.f30398x = org.telegram.ui.ActionBar.j6.l1(f7, i10);
        this.C = i10;
    }
}
