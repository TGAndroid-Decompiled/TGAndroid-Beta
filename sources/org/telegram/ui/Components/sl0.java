...
public abstract class sl0 extends el0 {
    public SparseIntArray f28190c;
    public SparseIntArray d;
    public SparseIntArray e;
    public int f28191f;
    public int h;
    public final ArrayList f28192n = new ArrayList();
    ...
    public final void L() {
        ...
        if (sparseIntArray == null) {
            ...
            this.f28190c = new SparseIntArray();
    ...
    public final int Q(int i10) {
        int i11 = this.f28190c.get(i10, Integer.MAX_VALUE);
    ...
    public final void X(boolean z10) {
        ArrayList arrayList = this.f28192n;
