...
public class sl0 extends RecyclerView implements og.a {
    ...
    public View Z0;
    public int Z1;
    public dg.u2 f28727a1;
    public boolean a2;
    public fg.d f28728b1;
    public boolean f28729b2;
    public bl0 f28730c1;
    public int f28731c2;
    public ol0 f28732d1;
    public int f28733d2;
    public boolean f28734e1;
    public org.telegram.ui.mi f28735e2;
    public boolean f28736f1;
    public boolean f28737f2;
    public boolean f28738g1;
    public boolean f28739g2;
    public boolean f28740h1;
    public float f28741h2;
    public Drawable f28742i1;
    public float f28743i2;
    public float f28744j1;
    public int[] f28745j2;
    public float f28746k1;
    public zk0 f28747k2;
    public long l1;
    public q0.a f28748l2;
    public ArrayList f28749m1;
    public final org.telegram.ui.ActionBar.f6 f28750m2;
    public ArrayList f28751n1;
    public boolean f28752n2;
    public View f28753o1;
    public final fe f28754o2;
    public int f28755p1;
    public boolean f28756p2;
    public int f28757q1;
    public final f2.d1 f28758q2;
    public int f28759r1;
    public Paint f28760r2;
    public int f28761s1;
    public boolean f28762s2;
    public int f28763t1;
    public GenericProvider f28764t2;
    public boolean f28765u1;
    public int f28766u2;
    public int f28767v1;
    public int f28768v2;
    public boolean f28769w1;
    public boolean f28770w2;
    public boolean f28771x1;
    public int f28772x2;
    public boolean f28773y1;
    public boolean f28774y2;
    public int f28775z1;
    public boolean f28776z2;
    ...
    public static void N0(Canvas canvas, RectF rectF, float f10, float f11, float f12, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        paint.setColor(org.telegram.ui.ActionBar.j6.l1(f12, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19906d6, f6Var)));
        if (f10 == f11) {
    ...
    public final void C0(Runnable runnable) {
        this.B2.f26381b.add(new ht(runnable, 1));
    }

    public final void D0(ClippingImageView clippingImageView, FrameLayout.LayoutParams layoutParams) {
        if (this.f28727a1 == null) {
            this.f28727a1 = new dg.u2(this, getContext(), 22);
        }
        this.f28727a1.addView(clippingImageView, layoutParams);
    }
    ...
    public final void K0(boolean z4) {
        ...
        int i11;
        int i12;
        if (((this.H1 || z4) && this.f28730c1 != null) || (this.f28767v1 != 0 && this.f28732d1 != null)) {
            f2.v0 layoutManager = getLayoutManager();
            if (layoutManager instanceof f2.i0) {
                f2.i0 i0Var = (f2.i0) layoutManager;
                if (i0Var.f5731o == 1) {
                    if (this.f28732d1 != null) {
                        if (this.f28767v1 == 1) {
                            paddingTop = 0;
                        } else {
                            paddingTop = getPaddingTop();
                        }
                        int i13 = this.f28767v1;
                        int i14 = Integer.MAX_VALUE;
                        if (i13 != 1 && i13 != 3) {
                            if (i13 == 2) {
                                this.f28746k1 = 0.0f;
                                if (this.f28732d1.h() != 0) {
                                    int childCount = getChildCount();
                                    View view2 = null;
                                    ...
                                    for (int i17 = 0; i17 < childCount; i17++) {
                                        ...
                                        if (bottom > this.f28763t1 + paddingTop) {
                                            if (bottom < i14) {
                                                view3 = childAt;
                                                i14 = bottom;
                                            }
                                            i16 = Math.max(i16, bottom);
                                            if (bottom >= AndroidUtilities.dp(32.0f) + this.f28763t1 + paddingTop && bottom < i15) {
                                                view2 = childAt;
                                                i15 = bottom;
                                            }
                                        }
                                    }
                                    if (view3 != null && (T3 = T(view3)) != null && (S = this.f28732d1.S((b10 = T3.b()))) >= 0) {
                                        if (this.f28755p1 != S || this.f28753o1 == null) {
                                            View view4 = this.f28753o1;
                                            if (view4 == null) {
                                                z11 = true;
                                            } else {
                                                z11 = false;
                                            }
                                            View T4 = this.f28732d1.T(S, view4);
                                            if (z11) {
                                                T0(T4, false);
                                            }
                                            this.f28753o1 = T4;
                                            ...
                                            View view5 = this.f28753o1;
                                            view5.layout(0, 0, view5.getMeasuredWidth(), this.f28753o1.getMeasuredHeight());
                                            this.f28755p1 = S;
                                        }
                                        if (this.f28753o1 != null && view2 != null && view2.getClass() != this.f28753o1.getClass()) {
                                            this.f28746k1 = 1.0f;
                                        }
                                        int M = this.f28732d1.M(S);
                                        int Q = this.f28732d1.Q(b10);
                                        ...
                                        if (Q == M - 1) {
                                            int height = this.f28753o1.getHeight();
                                            int height2 = view3.getHeight() + ((view3.getTop() - paddingTop) - this.f28763t1);
                                            if (height2 < height) {
                                                i12 = height2 - height;
                                            } else {
                                                i12 = paddingTop;
                                            ...
                                            if (i12 < 0) {
                                                this.f28753o1.setTag(Integer.valueOf(paddingTop + i11 + i12));
                                            } else {
                                                this.f28753o1.setTag(Integer.valueOf(paddingTop + i11));
                                            }
                                        } else {
                                            this.f28753o1.setTag(Integer.valueOf(paddingTop + i11));
                                        }
                        ...
                        for (int i20 = 0; i20 < childCount2; i20++) {
                            ...
                            if (bottom2 > this.f28763t1 + paddingTop) {
                                if (bottom2 < i14) {
                                    i14 = bottom2;
                                    view6 = childAt2;
                                }
                                i19 = Math.max(i19, bottom2);
                                if (bottom2 >= AndroidUtilities.dp(32.0f) + this.f28763t1 + paddingTop && bottom2 < i18) {
                                    i18 = bottom2;
                                }
                            }
                        }
                        if (view6 != null && (T = T(view6)) != null) {
                            ...
                            if ((this.H1 || z4) && (bl0Var2 = this.f28730c1) != null && !bl0Var2.f23713n && (getAdapter() instanceof cl0)) {
                                this.f28730c1.setProgress(Math.min(1.0f, b11 / ((this.f28732d1.h() - abs) + 1)));
                            }
                            this.f28751n1.addAll(this.f28749m1);
                            this.f28749m1.clear();
                            if (this.f28732d1.h() != 0) {
                                if (this.f28755p1 != b11 || this.f28757q1 != abs) {
                                    this.f28755p1 = b11;
                                    this.f28757q1 = abs;
                                    this.f28761s1 = 1;
                                    int S3 = this.f28732d1.S(b11);
                                    this.f28759r1 = S3;
                                    int M2 = (this.f28732d1.M(S3) + b11) - this.f28732d1.Q(b11);
                                    while (M2 < b11 + abs) {
                                        M2 += this.f28732d1.M(this.f28759r1 + this.f28761s1);
                                        this.f28761s1++;
                                    }
                                }
                                if (this.f28767v1 != 3) {
                                    int i21 = b11;
                                    for (int i22 = this.f28759r1; i22 < this.f28759r1 + this.f28761s1; i22++) {
                                        if (!this.f28751n1.isEmpty()) {
                                            view = (View) this.f28751n1.get(0);
                                            this.f28751n1.remove(0);
                                        } else {
                                            view = null;
                                        }
                                        if (view == null) {
                                        ...
                                        View T5 = this.f28732d1.T(i22, view);
                                        if (z10) {
                                            T0(T5, false);
                                        }
                                        this.f28749m1.add(T5);
                                        int M3 = this.f28732d1.M(i22);
                                        if (i22 == this.f28759r1) {
                                            int Q3 = this.f28732d1.Q(i21);
                                            if (Q3 == M3 - 1) {
                                            ...
                                            i21 = (M3 - this.f28732d1.Q(b11)) + i21;
                                        } else {
                    ...
                    if (L0 != -1) {
                        if ((this.H1 || z4) && (bl0Var = this.f28730c1) != null && !bl0Var.f23713n) {
                            f2.o0 adapter = getAdapter();
                            if (adapter instanceof cl0) {
                                cl0 cl0Var = (cl0) adapter;
                                float H = cl0Var.H(this);
                                this.f28730c1.setIsVisible(cl0Var.E(this));
                                this.f28730c1.setProgress(Math.min(1.0f, H));
                                this.f28730c1.a(false);
                            }
                        }
                    }
                }
    ...
    public final void L0(float f10, float f11) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            org.telegram.ui.mi miVar = this.f28735e2;
            int[] iArr2 = this.f28745j2;
            org.telegram.ui.xn xnVar = miVar.d;
            iArr2[0] = (int) xnVar.f40141p9;
            iArr2[1] = xnVar.f40244xa;
            ...
            if (rectF.contains(min2, min)) {
                ...
                int i11 = this.f28733d2;
                if (i11 != S) {
                    int i12 = this.f28731c2;
                    if (i11 <= i12 && S <= i12) {
                        z4 = false;
                    } else {
                        z4 = true;
                    }
                    org.telegram.ui.xn xnVar2 = this.f28735e2.d;
                    org.telegram.ui.jm jmVar = xnVar2.f40234x0;
                    ArrayList arrayList = xnVar2.f40164r6;
                    int i13 = S - jmVar.G;
                    if (i13 >= 0 && i13 < arrayList.size()) {
                        MessageObject messageObject = (MessageObject) arrayList.get(i13);
                        if (messageObject.contentType == 0 && messageObject.hasValidGroupId() && (groupedMessages = (MessageObject.GroupedMessages) xnVar2.f40199u6.f(messageObject.getGroupId())) != null) {
                            ...
                            S = arrayList.indexOf(arrayList2.get(size)) + xnVar2.f40234x0.G;
                        }
                    }
                    if (z4) {
                        int i14 = this.f28733d2;
                        if (S > i14) {
                            if (!this.f28735e2.f36320a) {
                                for (int i15 = i14 + 1; i15 <= S; i15++) {
                                    if (i15 != this.f28731c2 && this.f28735e2.a(i15)) {
                                        this.f28735e2.b(i15, true, min2, min);
                                    }
                                }
                            }
                        } else {
                            while (i14 > S) {
                                if (i14 != this.f28731c2 && this.f28735e2.a(i14)) {
                                    this.f28735e2.b(i14, false, min2, min);
                                }
                                i14--;
                            }
                        }
                    } else {
                        int i16 = this.f28733d2;
                        if (S > i16) {
                            while (i16 < S) {
                                if (i16 != this.f28731c2 && this.f28735e2.a(i16)) {
                                    this.f28735e2.b(i16, false, min2, min);
                                }
                                i16++;
                            }
                        } else if (!this.f28735e2.f36320a) {
                            for (int i17 = i16 - 1; i17 >= S; i17--) {
                                if (i17 != this.f28731c2 && this.f28735e2.a(i17)) {
                                    this.f28735e2.b(i17, true, min2, min);
                                }
                            }
                        }
                    }
    ...
    public final void M0(Canvas canvas, View view) {
        boolean z4;
        boolean z10;
        if (view != null && ((Boolean) this.E2.f25190a.run(view)).booleanValue()) {
            ...
            if (R == -1) {
                ...
                View U0 = U0(R - 1);
                View U02 = U0(R + 1);
                if (U0 != null && ((Boolean) this.E2.f25190a.run(U0)).booleanValue()) {
                    z4 = true;
                } else {
                    z4 = false;
                }
                if (U02 != null && ((Boolean) this.E2.f25190a.run(U02)).booleanValue()) {
                    z10 = true;
                } else {
                    z10 = false;
                }
    ...
    public final void O0(Canvas canvas, int i10, int i11, int i12, int i13, int i14) {
        if (i11 >= i10 && i10 >= 0 && i11 >= 0) {
            ...
            if (i15 < i16) {
                if (this.f28760r2 == null) {
                    this.f28760r2 = new Paint(1);
                }
                this.f28760r2.setColor(i12);
                canvas.drawRect(0.0f, i15 - i13, getWidth(), i16 + i14, this.f28760r2);
            }
        }
    }
    ...
    public final void P0(Canvas canvas, View view, View view2, boolean z4, boolean z10) {
        ...
        if (view != null && view2 != null) {
            ...
            if (rectF.bottom >= rectF.top) {
                this.G2.mo28run(canvas, rectF, Float.valueOf(this.I2), Float.valueOf(this.I2), Float.valueOf(view.getAlpha()));
            }
        }
    }

    public final void Q0(android.graphics.Canvas r30) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.sl0.Q0(android.graphics.Canvas):void");
    }
    ...
    public final void R0(Canvas canvas) {
        ...
        if (!rect.isEmpty() && (zVar = this.A1) != null) {
            ...
            canvas.save();
            int i11 = this.F1;
            if ((i11 == -2 || i11 == this.B1) && (aVar = this.f28748l2) != null) {
                aVar.accept(canvas);
            }
            int i12 = this.F1;
    ...
    public final Drawable V0(View view, boolean z4) {
        boolean z10;
        boolean z11;
        if (view.getParent() == this && b1() && ((Boolean) this.E2.f25190a.run(view)).booleanValue()) {
            int R = RecyclerView.R(view);
            boolean z12 = true;
            if (R == -1) {
                z11 = false;
            ...
            if (z10 && z11 && !z4) {
                ...
                if (z10 && z12) {
                    return org.telegram.ui.ActionBar.j6.b0(0, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19906d6, this.f28750m2));
                }
                z11 = z12;
            }
            Path path = new Path();
    ...
    public Integer W0(int i10) {
        GenericProvider genericProvider = this.f28764t2;
    ...
    public void dispatchDraw(Canvas canvas) {
        View view;
        float f10;
        zk0 zk0Var = this.f28747k2;
        if (zk0Var != null) {
            sl0 sl0Var = zk0Var.f31374a;
            if (zk0Var.d || zk0Var.e) {
                for (int i10 = 0; i10 < sl0Var.getChildCount(); i10++) {
                    View childAt = sl0Var.getChildAt(i10);
                    int R = RecyclerView.R(childAt);
                    if (R >= 0 && !zk0Var.f31376c.contains(childAt)) {
                        Float f11 = (Float) zk0Var.f31375b.get(R, null);
                        if (f11 == null) {
        ...
        dg.u2 u2Var = this.f28727a1;
        if (u2Var != null) {
            u2Var.draw(canvas);
        }
        if (!this.f28769w1) {
            int i11 = this.f28767v1;
            float f12 = 0.0f;
            if (i11 == 1) {
                if (this.f28732d1 != null && !this.f28749m1.isEmpty()) {
                    for (int i12 = 0; i12 < this.f28749m1.size(); i12++) {
                        View view2 = (View) this.f28749m1.get(i12);
            ...
            } else if (i11 == 2 && this.f28732d1 != null && (view = this.f28753o1) != null && view.getAlpha() != 0.0f) {
                int save2 = canvas.save();
                int intValue2 = ((Integer) this.f28753o1.getTag()).intValue();
                if (LocaleController.isRTL) {
                    f12 = getWidth() - this.f28753o1.getWidth();
                }
                canvas.translate(f12, intValue2);
                Drawable drawable = this.f28742i1;
                if (drawable != null) {
                    drawable.setBounds(0, this.f28753o1.getMeasuredHeight(), getWidth(), this.f28742i1.getIntrinsicHeight() + this.f28753o1.getMeasuredHeight());
                    this.f28742i1.setAlpha((int) (this.f28744j1 * 255.0f));
                    this.f28742i1.draw(canvas);
                    long elapsedRealtime = SystemClock.elapsedRealtime();
                    long min = Math.min(20L, elapsedRealtime - this.l1);
                    this.l1 = elapsedRealtime;
                    float f13 = this.f28744j1;
                    float f14 = this.f28746k1;
                    if (f13 < f14) {
                ...
                canvas.clipRect(0, 0, getWidth(), this.f28753o1.getMeasuredHeight());
                this.f28753o1.draw(canvas);
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            if (this.f28768v2 == 0 && this.f28770w2) {
                setOverScrollMode(0);
            }
            this.f28768v2++;
        } else if (action == 1 || action == 3) {
            int i10 = this.f28768v2 - 1;
            this.f28768v2 = i10;
            if (i10 == 0 && this.f28770w2) {
                setOverScrollMode(2);
            }
        }
        bl0 fastScroll = getFastScroll();
        if ((fastScroll != null && fastScroll.U && fastScroll.f23708h0 && motionEvent.getActionMasked() != 1 && motionEvent.getActionMasked() != 3) || (this.f28732d1 != null && (view = this.f28753o1) != null && view.getAlpha() != 0.0f && this.f28753o1.dispatchTouchEvent(motionEvent))) {
            return true;
        }
    ...
    public final void f0(View view) {
        if (getAdapter() instanceof rl0) {
            ...
            if (G != null) {
                ...
                if (this.f28752n2) {
                    view.setAccessibilityDelegate(this.f28754o2);
                    return;
                }
                return;
            }
    ...
    public bl0 getFastScroll() {
        return this.f28730c1;
    }

    public ArrayList<View> getHeaders() {
        return this.f28749m1;
    }

    public ArrayList<View> getHeadersCache() {
        return this.f28751n1;
    }
    ...
    public final void j1() {
        ...
        this.R1 = null;
        View view = this.C1;
        if (view != null && (i10 = this.f28766u2) != -1) {
            i1(i10, view);
            org.telegram.ui.Cells.z zVar = this.A1;
            if (zVar != null) {
    ...
    public void onAttachedToWindow() {
        ...
        bl0 bl0Var = this.f28730c1;
        if (bl0Var != null && bl0Var.getParent() != getParent()) {
            ViewGroup viewGroup = (ViewGroup) this.f28730c1.getParent();
            if (viewGroup != null) {
                viewGroup.removeView(this.f28730c1);
            }
            ((ViewGroup) getParent()).addView(this.f28730c1);
        }
    }
    ...
    public void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        if (bl0Var != null) {
            ...
            int i15 = i11 + i14;
            bl0 bl0Var2 = this.f28730c1;
            if (bl0Var2.f23703d0) {
                bl0Var2.layout(0, i15, bl0Var2.getMeasuredWidth(), this.f28730c1.getMeasuredHeight() + i15);
            } else {
                int measuredWidth = getMeasuredWidth() - this.f28730c1.getMeasuredWidth();
                bl0 bl0Var3 = this.f28730c1;
                bl0Var3.layout(measuredWidth, i15, bl0Var3.getMeasuredWidth() + measuredWidth, this.f28730c1.getMeasuredHeight() + i15);
            }
            this.G1 = false;
        }
        K0(false);
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (bl0Var != null && bl0Var.getLayoutParams() != null) {
            ...
            if (bl0Var2.f23697a) {
                ...
                i12 = bl0Var2.f23704e0;
            }
            int measuredHeight = (getMeasuredHeight() - i12) - getPaddingBottom();
            this.f28730c1.getLayoutParams().height = measuredHeight;
            this.f28730c1.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(132.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(measuredHeight, 1073741824));
        }
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        int i14 = this.f28767v1;
        if (i14 == 1) {
            if (this.f28732d1 != null && !this.f28749m1.isEmpty()) {
                for (int i15 = 0; i15 < this.f28749m1.size(); i15++) {
                    T0((View) this.f28749m1.get(i15), true);
                }
            }
        } else if (i14 == 2 && this.f28732d1 != null && (view = this.f28753o1) != null) {
            T0(view, true);
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        bl0 bl0Var = this.f28730c1;
        if (bl0Var != null && bl0Var.f23713n) {
            return false;
        }
        boolean z4 = this.a2;
        m2.b bVar = this.A2;
        if (z4 && motionEvent.getAction() != 0 && motionEvent.getAction() != 1 && motionEvent.getAction() != 3) {
            if (this.f28741h2 == Float.MAX_VALUE && this.f28743i2 == Float.MAX_VALUE) {
                this.f28741h2 = motionEvent.getX();
                this.f28743i2 = motionEvent.getY();
            }
            if (!this.f28729b2 && Math.abs(motionEvent.getY() - this.f28743i2) > this.Z1) {
                this.f28729b2 = true;
                l1(this, true);
            }
            if (this.f28729b2) {
                ...
                if (motionEvent.getY() > (getMeasuredHeight() - AndroidUtilities.dp(56.0f)) - this.f28745j2[1] && (this.f28733d2 >= this.f28731c2 || !this.f28735e2.f36320a)) {
                    this.f28739g2 = false;
                    if (!this.f28737f2) {
                        this.f28737f2 = true;
                ...
                } else if (motionEvent.getY() < AndroidUtilities.dp(56.0f) + this.f28745j2[0] && (this.f28733d2 <= this.f28731c2 || !this.f28735e2.f36320a)) {
                    this.f28739g2 = true;
                    if (!this.f28737f2) {
                        this.f28737f2 = true;
                        AndroidUtilities.cancelRunOnUIThread(bVar);
        ...
        this.f28741h2 = Float.MAX_VALUE;
        this.f28743i2 = Float.MAX_VALUE;
        this.a2 = false;
        this.f28729b2 = false;
        l1(this, false);
        this.f28737f2 = false;
    ...
    public final void s1(Utilities.CallbackReturn callbackReturn, Utilities.CallbackReturn callbackReturn2, int i10, float f10, Utilities.Callback5 callback5, boolean z4) {
        setSelectorDrawableColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20013j6, this.f28750m2));
    ...
    public void setAdapter(f2.o0 o0Var) {
        f2.o0 adapter = getAdapter();
        f2.d1 d1Var = this.f28758q2;
        if (adapter != null) {
            adapter.f5816a.unregisterObserver(d1Var);
        }
        ArrayList arrayList = this.f28749m1;
        if (arrayList != null) {
            arrayList.clear();
            this.f28751n1.clear();
        }
    ...
    public void setFastScrollEnabled(int i10) {
        this.f28730c1 = new bl0(this, getContext(), i10);
        if (getParent() != null) {
            ((ViewGroup) getParent()).addView(this.f28730c1);
        }
    }
    ...
    public void setItemSelectorColorProvider(GenericProvider<Integer, Integer> genericProvider) {
        this.f28764t2 = genericProvider;
    }

    public void setItemsEnterAnimator(zk0 zk0Var) {
        this.f28747k2 = zk0Var;
    }
    ...
    public void setListSelectorColor(Integer num) {
        ...
        if (num == null) {
            if (b1()) {
                i10 = org.telegram.ui.ActionBar.j6.f20013j6;
            } else {
                i10 = org.telegram.ui.ActionBar.j6.f19996i6;
            }
            intValue = org.telegram.ui.ActionBar.j6.v0(i10, this.f28750m2);
        } else {
    ...
    public void setOnItemLongClickListener(kl0 kl0Var) {
        ...
        l20 l20Var = (l20) cVar.f9354b;
        l20Var.f26538t = z4;
        l20Var.f26539u = longPressTimeout;
    }
    ...
    public void setSectionsType(int i10) {
        ...
        this.f28749m1 = new ArrayList();
        this.f28751n1 = new ArrayList();
    }
    ...
    public sl0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f28743i2 = Float.MAX_VALUE;
        this.f28752n2 = true;
        this.f28754o2 = new fe(1);
        this.f28756p2 = true;
        this.f28758q2 = new f2.d1(this, 1);
        ...
        setGlowColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20176s8, f6Var));
        org.telegram.ui.Cells.z f02 = org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19996i6, f6Var), 2, -1);
        this.A1 = f02;
