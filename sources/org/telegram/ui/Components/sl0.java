...
public final class sl0 {
    ...
    public int f27930y;
    public int f27931z;
    public final RectF f27910a = new RectF();
    public final Paint f27911b = new Paint(1);
    public final Paint f27912c = new Paint(3);
    public final Matrix d = new Matrix();
    public final float[] e = new float[8];
    public final Path f27913f = new Path();
    public final Paint f27914g = new Paint();
    public int f27923q = 0;
    public float f27924r = 1.0f;
    ...
    public final int a(MessageObject messageObject, TLRPC.User user, TLRPC.Chat chat, org.telegram.ui.ActionBar.e6 e6Var, int i10) {
        ...
        if (messageObject == null) {
            ...
            this.f27929x = org.telegram.ui.ActionBar.i6.l1(f7, v02);
            this.C = h();
        ...
        if (i10 == 4 && (message4 = messageObject.messageOwner) != null && MessageObject.getMedia(message4) != null && (MessageObject.getMedia(messageObject.messageOwner) instanceof TLRPC.TL_messageMediaContact)) {
            ...
            this.f27929x = org.telegram.ui.ActionBar.i6.l1(0.1f, this.f27931z);
            this.f27930y = this.f27931z;
        } else {
            f5Var = f5Var2;
            if (i10 != 0 && (messageObject.overrideLinkColor >= 0 || (messageObject.messageOwner != null && (((messageObject.isFromUser() || DialogObject.isEncryptedDialog(messageObject.getDialogId())) && user4 != null) || ((messageObject.isFromChannel() && chat != null) || (((message3 = messageObject.messageOwner) != null && (messageFwdHeader3 = message3.fwd_from) != null && messageFwdHeader3.from_id != null) || (messageObject.isSponsored() && (peerColor2 = messageObject.sponsoredColor) != null && peerColor2.color != -1))))))) {
                ...
                this.A = v04;
                this.f27931z = v04;
                this.f27929x = org.telegram.ui.ActionBar.i6.l1(0.1f, v04);
                this.f27930y = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Wc, e6Var);
            }
        }
        if (messageObject.shouldDrawWithoutBackground()) {
            ...
            this.f27931z = -1;
            this.f27929x = 0;
            this.f27930y = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Xc, e6Var);
            ...
            if (i10 == 2 && !messageObject.isOutOwner()) {
                ...
                if (!this.f27915i && !this.f27916j) {
                    i12 = org.telegram.ui.ActionBar.i6.f18784ab;
                } else {
                    i12 = org.telegram.ui.ActionBar.i6.f18804bb;
                }
            ...
            if (this.f27916j) {
                this.R = true;
                this.f27931z = org.telegram.ui.ActionBar.i6.l1(0.2f, this.f27931z);
                this.A = org.telegram.ui.ActionBar.i6.l1(0.5f, this.A);
            } else if (this.f27915i) {
                this.R = true;
                this.f27931z = org.telegram.ui.ActionBar.i6.l1(0.35f, this.f27931z);
            }
            int i16 = this.B;
            if (q6) {
                f10 = 0.12f;
            }
            this.f27929x = org.telegram.ui.ActionBar.i6.l1(f10, i16);
            this.f27930y = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.cb, e6Var);
        }
        ...
        if (this.v != 0 && this.f27926t == null && (view = this.D) != null) {
            this.f27926t = new m5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.t1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.t1) view).M0) {
                this.f27926t.a();
            }
        }
        m5 m5Var = this.f27926t;
        if (m5Var != null) {
            z11 = true;
        ...
        m5 m5Var2 = this.f27927u;
        if (m5Var2 != null) {
            m5Var2.j(this.f27928w, z11);
        }
        this.C = h();
        return f5Var.a(this.f27930y, false);
    }
    ...
    public final void d(Canvas canvas, RectF rectF, float f7, boolean z10, boolean z11) {
        ...
        float f10;
        if (!z11) {
            int l1 = org.telegram.ui.ActionBar.i6.l1(f7, this.E.a(this.f27929x, false));
            Paint paint = this.f27914g;
            paint.setColor(l1);
            float[] fArr = this.e;
            if (yf.e0.c(fArr)) {
                float f11 = fArr[0];
                ...
                Path path = this.f27913f;
                path.rewind();
                path.addRoundRect(rectF, fArr, Path.Direction.CW);
                canvas.drawPath(path, paint);
            }
        }
        m5 m5Var2 = this.f27926t;
        if (m5Var2 != null) {
            if (!this.Y) {
                Drawable drawable = m5Var2.f26073f[0];
                if ((drawable instanceof o5) && (l4Var = ((o5) drawable).f26692k) != null && l4Var.hasImageLoaded()) {
                    this.Y = true;
                } else {
                    z12 = false;
                    e = this.L.e(z12);
                    if (e <= 0.0f && this.f27924r > 0.0f) {
                        if (this.W == null) {
                        ...
                        m5 m5Var3 = this.f27927u;
                        if (m5Var3 != null) {
                            m5Var3.v = (int) (f7 * 255.0f);
                        }
                        this.f27926t.k(Integer.valueOf(this.C));
                        int i10 = 0;
                        while (true) {
                            rl0[] rl0VarArr = this.W;
                            if (i10 < rl0VarArr.length) {
                                if (i10 != 0 || (m5Var = this.f27927u) == null || this.f27928w == 0) {
                                    m5Var = this.f27926t;
                                }
                                rl0 rl0Var = rl0VarArr[i10];
                                if (!rl0Var.e || z10) {
                                    if (m5Var == this.f27927u) {
                                        f10 = 1.0f;
                                    } else {
                                        f10 = 0.3f;
                                    }
                                    m5Var.v = (int) (f10 * 255.0f * rl0Var.d * this.f27924r);
                                    float dp = max - AndroidUtilities.dp(rl0Var.f27649a);
                                    float dp2 = AndroidUtilities.dp(rl0Var.f27650b) + min;
                                    float dp3 = AndroidUtilities.dp(10.0f) * rl0Var.f27651c * e;
    ...
    public final void f(Canvas canvas, RectF rectF, float f7, float f10, float f11, float f12) {
        ...
        if (this.h == null) {
            ...
            this.h = g90Var3;
            g90Var3.C = true;
            g90Var3.f24277t = 3.5f;
            g90Var3.f24278u = 0.5f;
        }
        this.h.f(org.telegram.ui.ActionBar.i6.l1(0.1f, this.f27931z), org.telegram.ui.ActionBar.i6.l1(0.3f, this.f27931z), org.telegram.ui.ActionBar.i6.l1(0.3f, this.f27931z), org.telegram.ui.ActionBar.i6.l1(1.25f, this.f27931z));
        this.h.d(rectF);
        this.h.i(fArr);
        this.h.f24279w.setStrokeWidth(AndroidUtilities.dp(1.0f));
    ...
    public final void k() {
        this.F.a(this.f27931z, true);
        this.G.a(this.A, true);
        this.J.f(this.f27915i, true);
        this.I.a(this.f27930y, true);
        this.E.a(this.f27929x, true);
        m5 m5Var = this.f27926t;
        if (m5Var != null) {
            m5Var.d.d(1.0f, true);
        }
    ...
    public final int l(MessageObject messageObject, TLRPC.TL_peerColorCollectible tL_peerColorCollectible, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.R = false;
        this.f27931z = tL_peerColorCollectible.colors.get(0).intValue() | (-16777216);
        if (arrayList.size() >= 2) {
            z10 = true;
        } else {
            z10 = false;
        ...
        this.f27930y = i12;
        this.f27929x = org.telegram.ui.ActionBar.i6.l1(0.1f, i12);
        long j3 = tL_peerColorCollectible.background_emoji_id;
        this.v = j3;
        this.f27928w = tL_peerColorCollectible.gift_emoji_id;
        View view = this.D;
        if (j3 != 0 && this.f27926t == null && view != null) {
            this.f27926t = new m5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.t1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.t1) view).M0) {
                this.f27926t.a();
            }
        ...
        this.C = this.f27930y;
        if (this.f27928w != 0 && this.f27927u == null && view != null) {
            this.f27927u = new m5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.t1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.t1) view).M0) {
                this.f27927u.a();
            }
        }
        m5 m5Var2 = this.f27927u;
        if (m5Var2 != null) {
            m5Var2.j(this.f27928w, true);
        }
        return this.I.a(this.f27930y, false);
    }
    ...
    public final void m(MessageObject messageObject, int i10, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        if (i10 < 7) {
            int v02 = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19094r8[i10], e6Var);
            this.B = v02;
            this.A = v02;
            this.f27931z = v02;
            this.f27916j = false;
    ...
    public final int o(org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.f27930y = org.telegram.ui.ActionBar.i6.v0(i10, e6Var);
        this.f27931z = org.telegram.ui.ActionBar.i6.v0(i10, e6Var);
        this.f27915i = false;
        this.f27916j = false;
        this.f27929x = org.telegram.ui.ActionBar.i6.l1(0.1f, org.telegram.ui.ActionBar.i6.v0(i10, e6Var));
        if (this.v != 0 && this.f27926t == null && (view = this.D) != null) {
            this.f27926t = new m5(AndroidUtilities.dp(20.0f), 13, view, false);
            if (!(view instanceof org.telegram.ui.Cells.t1) ? view.isAttachedToWindow() : ((org.telegram.ui.Cells.t1) view).M0) {
                this.f27926t.a();
    ...
    public final void q(int i10, boolean z10) {
        ...
        this.f27929x = org.telegram.ui.ActionBar.i6.l1(f7, i10);
        this.C = i10;
    }
}
