...
public final class pu implements y81 {
    ...
    public final TextureView a(View view, boolean z10, float f7, int i10, boolean z11) {
        ...
        tu tuVar = this.f29491a;
        FrameLayout frameLayout = tuVar.f30710e;
        Activity activity = tuVar.f30713r;
        if (z10) {
            frameLayout.setVisibility(0);
            frameLayout.setAlpha(1.0f);
            frameLayout.addView(tuVar.f30709c.getAspectRatioView());
            tuVar.N = false;
            tuVar.M = z11;
            if (activity != null) {
                try {
    ...
    public final void d() {
        ...
        tuVar.f30709c.g(null, null, null, null, false);
    ...
    public final void e(b91 b91Var, boolean z10) {
        Activity activity = this.f29491a.f30713r;
        if (z10) {
            try {
    ...
    public final TextureView f(View view, boolean z10, int i10, int i11, boolean z11) {
        ...
        if (z10) {
            ...
            TextureView textureView = new TextureView(tuVar.f30713r);
            if (!eg0.x(false, tuVar.f30713r, null, textureView, i10, i11, false)) {
                return null;
            }
            eg0.f25676p0.U = tuVar;
            return textureView;
        } else if (!z11) {
            viewGroup = ((org.telegram.ui.ActionBar.f3) tuVar).containerView;
    ...
    public final void i(boolean z10, t81 t81Var, float f7, boolean z11) {
        ...
        if (z10) {
            tu tuVar = this.f29491a;
            if (tuVar.f30713r != null) {
                try {
                    viewGroup3 = ((org.telegram.ui.ActionBar.f3) tuVar).containerView;
                    viewGroup3.setSystemUiVisibility(0);
                    tu tuVar2 = this.f29491a;
                    int i10 = tuVar2.L;
                    if (i10 != -2) {
                        tuVar2.f30713r.setRequestedOrientation(i10);
                    }
                } catch (Exception e7) {
                    FileLog.e(e7);
                }
            }
            if (this.f29491a.f30710e.getVisibility() == 0) {
                viewGroup6 = ((org.telegram.ui.ActionBar.f3) this.f29491a).containerView;
                viewGroup7 = ((org.telegram.ui.ActionBar.f3) this.f29491a).containerView;
                viewGroup6.setTranslationY(AndroidUtilities.dp(10.0f) + viewGroup7.getMeasuredHeight());
                e3Var3 = ((org.telegram.ui.ActionBar.f3) this.f29491a).backDrawable;
                e3Var3.setAlpha(0);
            }
            this.f29491a.setOnShowListener(null);
            if (z11) {
                TextureView textureView = this.f29491a.f30709c.getTextureView();
                View controlsView = this.f29491a.f30709c.getControlsView();
                ImageView textureImageView = this.f29491a.f30709c.getTextureImageView();
                hk0 o9 = eg0.o(f7, true);
                float width = o9.f26746c / textureView.getWidth();
                AnimatorSet animatorSet = new AnimatorSet();
                Property property = View.SCALE_X;
                ...
                Property property3 = View.TRANSLATION_X;
                ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(textureImageView, property3, o9.f26744a);
                Property property4 = View.TRANSLATION_Y;
                ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(textureImageView, property4, o9.f26745b);
                ...
                ObjectAnimator ofFloat7 = ObjectAnimator.ofFloat(textureView, property3, o9.f26744a);
                ObjectAnimator ofFloat8 = ObjectAnimator.ofFloat(textureView, property4, o9.f26745b);
                viewGroup4 = ((org.telegram.ui.ActionBar.f3) this.f29491a).containerView;
                viewGroup5 = ((org.telegram.ui.ActionBar.f3) this.f29491a).containerView;
                ...
                e3Var2 = ((org.telegram.ui.ActionBar.f3) this.f29491a).backDrawable;
                ObjectAnimator ofInt = ObjectAnimator.ofInt(e3Var2, t6.d, 0);
                FrameLayout frameLayout = this.f29491a.f30710e;
            ...
            if (this.f29491a.f30710e.getVisibility() == 0) {
                this.f29491a.f30710e.setAlpha(1.0f);
                this.f29491a.f30710e.setVisibility(4);
            }
            t81Var.run();
            this.f29491a.dismissInternal();
            return;
        }
        if (ApplicationLoader.mainInterfacePaused) {
            try {
                this.f29491a.f30713r.startService(new Intent(ApplicationLoader.applicationContext, BringAppForegroundService.class));
            } catch (Throwable th2) {
                FileLog.e(th2);
            }
        }
        if (z11) {
            tu tuVar3 = this.f29491a;
            tuVar3.setOnShowListener(tuVar3.R);
            hk0 o10 = eg0.o(f7, false);
            TextureView textureView2 = this.f29491a.f30709c.getTextureView();
            ImageView textureImageView2 = this.f29491a.f30709c.getTextureImageView();
            float f10 = o10.f26746c / textureView2.getLayoutParams().width;
            textureImageView2.setScaleX(f10);
            textureImageView2.setScaleY(f10);
            textureImageView2.setTranslationX(o10.f26744a);
            textureImageView2.setTranslationY(o10.f26745b);
            textureView2.setScaleX(f10);
            textureView2.setScaleY(f10);
            textureView2.setTranslationX(o10.f26744a);
            textureView2.setTranslationY(o10.f26745b);
        } else {
            eg0.j(false);
        }
        this.f29491a.setShowWithoutAnimation(true);
        this.f29491a.show();
        if (z11) {
            tu tuVar4 = this.f29491a;
            tuVar4.P = 4;
            e3Var = ((org.telegram.ui.ActionBar.f3) tuVar4).backDrawable;
            e3Var.setAlpha(1);
            viewGroup = ((org.telegram.ui.ActionBar.f3) this.f29491a).containerView;
            viewGroup2 = ((org.telegram.ui.ActionBar.f3) this.f29491a).containerView;
