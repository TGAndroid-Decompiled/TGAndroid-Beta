...
public final class pu extends View {
    ...
    public final Drawable f28003c;
    public final Drawable d;
    public String e;
    public boolean f28004f;
    public int h;
    public final int[] f28005n;
    public final int[] f28006r;
    public final Paint f28007s;
    public final RectF v;
    public final z5 f28008w;
    public final z5 f28009x;
    public final org.telegram.ui.ActionBar.f6 f28010y;
    ...
    public pu(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f28001a = AndroidUtilities.dp(f10);
        this.f28002b = new Drawable[11];
        this.f28005n = new int[]{0, 0};
        this.f28006r = new int[]{0, 0};
        this.f28007s = new Paint(1);
        this.v = new RectF();
        mr mrVar = mr.h;
        this.f28008w = new z5(this, 125L, mrVar);
        this.f28009x = new z5(this, 125L, mrVar);
        this.C = -1;
        this.D = true;
        this.f28010y = f6Var;
        this.f28003c = getResources().getDrawable(R.drawable.stickers_back_all);
    ...
    public final void a() {
        ...
        org.telegram.ui.ActionBar.f6 f6Var = this.f28010y;
        org.telegram.ui.ActionBar.j6.w1(org.telegram.ui.ActionBar.j6.v0(i10, f6Var), this.f28003c);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Drawable drawable = puVar.f28003c;
        boolean z4 = false;
        drawable.setBounds(0, 0, measuredWidth, measuredHeight);
        drawable.draw(canvas);
        int dp3 = puVar.h - AndroidUtilities.dp(9.0f);
        int measuredHeight2 = puVar.getMeasuredHeight() - AndroidUtilities.dp(6.34f);
        int dp4 = AndroidUtilities.dp(9.0f) + puVar.h;
        ...
        if (puVar.e != null) {
            boolean z10 = puVar.f28004f;
            org.telegram.ui.ActionBar.f6 f6Var = puVar.f28010y;
            int[] iArr = puVar.f28005n;
            z5 z5Var2 = puVar.f28008w;
            Paint paint = puVar.f28007s;
            Drawable[] drawableArr = puVar.f28002b;
            RectF rectF = puVar.v;
            float f11 = 1.0f;
            int i10 = puVar.f28001a;
            if (z10) {
                int i11 = 0;
                while (i11 < 2) {
                    if (i11 == 0) {
                    ...
                    rectF.set((int) ((i10 * (d + f11)) + AndroidUtilities.dp((f10 * 4.0f) + (Math.max(0.0f, Math.min(f11, f10)) * 3.0f) + 5.0f)), AndroidUtilities.lerp(((AndroidUtilities.dp(f11) + i10) * i11) + AndroidUtilities.dp(3.0f), (puVar.getMeasuredHeight() - i10) / 2, max), dp2 + i10, lerp + i10);
                    rectF.inset(AndroidUtilities.dp(-2.0f), AndroidUtilities.dp(max * (-2.0f)));
                    paint.setColor(org.telegram.ui.ActionBar.j6.l1(AndroidUtilities.lerp(f11, 0.5f, max), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19971i6, f6Var)));
                ...
                canvas.drawRect(AndroidUtilities.dp(8.45f) + i10, AndroidUtilities.dp(2.0f), AndroidUtilities.dp(8.45f) + i10 + 1, getMeasuredHeight() - AndroidUtilities.dp(6.0f), org.telegram.ui.ActionBar.j6.f20000k0);
                return;
            }
            ...
            paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19971i6, f6Var));
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f), paint);
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.F) {
            ...
            int i13 = 0;
            while (true) {
                Drawable[] drawableArr = this.f28002b;
