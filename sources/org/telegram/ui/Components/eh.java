...
public final class eh implements cl, le.l, org.telegram.ui.ActionBar.z1, ml0, dh.d, org.telegram.ui.ActionBar.q0, un, AndroidUtilities.IntColorCallback, d5, ej {
    ...
    public void J(int i10, int i11, boolean z10) {
        ...
        switch (this.f23959a) {
            case 12:
                wi wiVar = this.f23960b;
                oi oiVar = wiVar.f30067y0;
                if (oiVar != wiVar.f30018j0 && oiVar != wiVar.f30038q0) {
            ...
            default:
                ...
                wiVar2.N0 = j10;
                giVar.setEffect(j10);
                oi oiVar2 = wiVar2.f30067y0;
                if (oiVar2 != wiVar2.f30018j0 && oiVar2 != wiVar2.f30038q0) {
    ...
    public void b(TLRPC.MessageMedia messageMedia, int i10, boolean z10, int i11, long j3) {
        switch (this.f23959a) {
            case 0:
                ((org.telegram.ui.wn) this.f23960b.f30006f0).b(messageMedia, i10, z10, i11, 0L);
                return;
            case 9:
                ((org.telegram.ui.wn) this.f23960b.f30006f0).b(messageMedia, i10, z10, i11, j3);
                return;
            default:
                ((org.telegram.ui.wn) this.f23960b.f30006f0).b(messageMedia, i10, z10, i11, j3);
                return;
    ...
    public boolean d(int i10, View view) {
        ...
        if (view instanceof pi) {
            pi piVar = (pi) view;
            wi wiVar = this.f23960b;
            if (!wiVar.V && (user = piVar.f27349b) != null) {
                wiVar.w1(piVar.f27350c, user);
                return true;
            }
            return false;
        }
    ...
    public void e(TLRPC.MessageMedia messageMedia, Editable editable, qh.f fVar, ArrayList arrayList, boolean z10, int i10, long j3) {
        ...
        switch (i11) {
            case 10:
                org.telegram.ui.wn wnVar = (org.telegram.ui.wn) wiVar.f30006f0;
                TLRPC.TL_messageMediaToDo tL_messageMediaToDo = (TLRPC.TL_messageMediaToDo) messageMedia;
                if (wnVar.f7()) {
                    SendMessagesHelper.SendMessageParams of2 = SendMessagesHelper.SendMessageParams.of((TLRPC.TL_messageMediaPoll) null, wnVar.T5, wnVar.f39575n5, wnVar.X3, (TLRPC.ReplyMarkup) null, (HashMap<String, String>) null, z10, i10, 0);
                ...
                return;
            default:
                org.telegram.ui.wn wnVar2 = (org.telegram.ui.wn) wiVar.f30006f0;
                ...
                if (wnVar2.f7()) {
                    ...
                    SendMessagesHelper.prepareSendingPoll(wnVar2.getAccountInstance(), new qh.h(fVar, tL_messageMediaPoll, nextLong, str, arrayList2, arrayList), wnVar2.T5, wnVar2.f39575n5, wnVar2.X3, null, wnVar2.f39549l5, z10, i10, wnVar2.C8(), j3, wnVar2.N8(), wnVar2.f39490g5);
                    wnVar2.y6();
                    return;
                }
                return;
    ...
    public int g(org.telegram.ui.ActionBar.d6 d6Var, boolean z10) {
        ...
        switch (this.f23959a) {
            case 4:
                ...
                int v03 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19060d6, d6Var);
                wi wiVar = this.f23960b;
                if (wiVar.f30027m2) {
                    return i0.a.d(0.75f, v03, wiVar.f30031n2);
                }
                return eh.b.m(f7, v02, v03);
            case 5:
                if (this.f23960b.f30027m2) {
                    return 0;
                }
                if (z10) {
                    return 687865855;
            ...
            default:
                wi wiVar2 = this.f23960b;
                if (wiVar2.f30027m2) {
                    if (AndroidUtilities.computePerceivedBrightness(wiVar2.f30031n2) <= 0.72f) {
                        return 1090519039;
                    }
                } else if (z10) {
                    return 0;
    ...
    public void h(ArrayList arrayList, CharSequence charSequence, boolean z10, int i10, int i11, long j3, boolean z11, long j10) {
        ...
        if (m2Var != null && (m2Var instanceof org.telegram.ui.wn)) {
            ...
            if (wnVar.f7()) {
                ...
                SendMessagesHelper.prepareSendingAudioDocuments(accountInstance, arrayList, charSequence2, wnVar.T5, wnVar.f39575n5, wnVar.X3, null, z10, i10, i11, wnVar.p5, wnVar.C8(), j3, z11, j10);
                wnVar.y6();
                return;
            }
            return;
    ...
    public void m(int i10) {
        this.f23960b.X0.getActionBarMenuOnItemClick().b(i10);
    }

    @Override
    public void run(int i10) {
        wi.o(this.f23960b, i10);
    }
