...
public final class i30 extends TextView {
    public final Paint[] f24866a;
    public final l30 f24867b;

    public i30(l30 l30Var, Context context) {
        super(context);
        this.f24867b = l30Var;
        this.f24866a = new Paint[l30Var.e.length];
        int i10 = 0;
        while (true) {
            Paint[] paintArr = this.f24866a;
