...
public class q5 extends Drawable {
    public static SparseArray f27492q;
    public static HashMap f27493r;
    public static boolean f27494s;
    public static boolean f27495t;
    public static boolean f27496u;
    public static final ai.f v = new ai.f(23);
    public static HashMap f27497w;
    public boolean f27498a;
    public ArrayList f27499b;
    public ArrayList f27500c;
    public int d;
    ...
    public ai.l4 f27505k;
    public boolean f27507m;
    public ColorFilter f27510p;
    public float f27506l = 1.0f;
    public Boolean f27508n = null;
    public Boolean f27509o = null;
    ...
    public static m5 h(int i10) {
        ...
        m5 m5Var = (m5) f27493r.get(Integer.valueOf(i10));
        if (m5Var == null) {
            HashMap hashMap = f27493r;
    ...
    public static q5 m(int i10, int i11, TLRPC.Document document) {
        if (f27492q == null) {
            f27492q = new SparseArray();
        }
        int hash = Objects.hash(Integer.valueOf(i10), Integer.valueOf(i11));
        LongSparseArray longSparseArray = (LongSparseArray) f27492q.get(hash);
        if (longSparseArray == null) {
            SparseArray sparseArray = f27492q;
    ...
    public static q5 n(int i10, long j3, String str, int i11) {
        ...
        if (q5Var == null) {
            ...
            drawable.h = i10;
            drawable.f27502g = i11;
            drawable.y();
            drawable.f27501f = j3;
            drawable.f27503i = str;
    ...
    public static void s(int i10, boolean z10) {
        ...
        if (f27496u != z11) {
            f27496u = z11;
            if (f27492q != null && (longSparseArray = (LongSparseArray) f27492q.get(Objects.hash(Integer.valueOf(i10), 25))) != null) {
                    ...
                    if (q5Var != null && (l4Var = q5Var.f27505k) != null) {
                        if (z10) {
                            ...
                            if (animation != null) {
                                ...
                                if (!animation.f23491n0) {
                                    animation.f23501v0 = z12;
                                }
                                animation.start();
                            } else {
    ...
    public static void u() {
        if (f27492q != null) {
            x();
            for (int i10 = 0; i10 < f27492q.size(); i10++) {
                LongSparseArray longSparseArray = (LongSparseArray) f27492q.valueAt(i10);
                for (int i11 = 0; i11 < longSparseArray.size(); i11++) {
                    long keyAt = longSparseArray.keyAt(i11);
                    q5 q5Var = (q5) longSparseArray.get(keyAt);
                    if (q5Var != null && q5Var.f27498a) {
                        q5Var.j(true);
                    } else {
    ...
    public static void x() {
        f27494s = LiteMode.isEnabled(16388);
        f27495t = LiteMode.isEnabled(8200);
    }
    ...
    public final void a(View view) {
        if (!(view instanceof org.telegram.ui.c61)) {
            ...
            if (this.f27499b == null) {
                this.f27499b = new ArrayList(10);
            }
            if (!this.f27499b.contains(view)) {
                this.f27499b.add(view);
            }
            v();
            return;
        }
    ...
    public final void b(w5 w5Var) {
        if (this.f27500c == null) {
            this.f27500c = new ArrayList(10);
        }
        this.f27507m = false;
        if (!this.f27500c.contains(w5Var)) {
            this.f27500c.add(w5Var);
        }
        v();
    }
    ...
    public final boolean c() {
        ...
        this.f27508n = Boolean.valueOf(z10);
        return z10;
    }

    public final void d() {
        ArrayList arrayList = this.f27500c;
        if (arrayList != null) {
            arrayList.clear();
        }
        ArrayList arrayList2 = this.f27499b;
        if (arrayList2 != null) {
            arrayList2.clear();
        }
        this.f27507m = false;
    ...
    public final void draw(Canvas canvas) {
        ai.l4 l4Var = this.f27505k;
        if (l4Var == null) {
            return;
        }
        l4Var.setImageCoords(getBounds());
        this.f27505k.setAlpha(this.f27506l);
        this.f27505k.draw(canvas);
    }
    ...
    public final void e() {
        if (this.f27505k == null) {
            ...
            this.f27505k.setAllowLoadingOnAttachedOnly(true);
            if (this.f27502g == 12) {
                this.f27505k.ignoreNotifications = true;
            }
        }
    }
    ...
    public final int getAlpha() {
        return (int) (this.f27506l * 255.0f);
    }
    ...
    public final void k() {
        if (this.f27499b != null) {
            for (int i10 = 0; i10 < this.f27499b.size(); i10++) {
                View view = (View) this.f27499b.get(i10);
                if (view != null) {
                    view.invalidate();
                }
            }
        ...
        if (this.f27500c != null) {
            for (int i11 = 0; i11 < this.f27500c.size(); i11++) {
                w5 w5Var = (w5) this.f27500c.get(i11);
                if (w5Var != null) {
                    w5Var.invalidate();
                }
            }
    ...
    public final void r(String str) {
        int i10 = this.f27502g;
        if ((i10 != 20 && i10 != 21) || TextUtils.isEmpty(str) || this.f27505k != null) {
            return;
        }
        e();
        this.f27504j = true;
        this.f27505k.setImageBitmap(Emoji.getEmojiDrawable(str));
        this.f27505k.setCrossfadeWithOldImage(true);
    }
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        if (this.f27505k != null && this.e != null) {
            if (c()) {
                this.f27505k.setColorFilter(colorFilter);
                return;
            }
            return;
        }
        this.f27510p = colorFilter;
    }
    ...
    public final void t(long j3) {
        ...
        if (l4Var != null) {
            ...
            if (l4Var.getLottieAnimation() != null) {
                this.f27505k.getLottieAnimation().V(j3);
            }
            if (this.f27505k.getAnimation() != null) {
                this.f27505k.getAnimation().D(j3);
            }
        }
    }
    ...
    public final void v() {
        ...
        if (this.f27505k != null) {
            ArrayList arrayList2 = this.f27499b;
            if ((arrayList2 != null && arrayList2.size() > 0) || (((arrayList = this.f27500c) != null && arrayList.size() > 0) || this.f27507m)) {
                z10 = true;
            } else {
                z10 = false;
            }
            if (z10 != this.f27498a) {
                this.f27498a = z10;
                if (z10) {
                    this.f27505k.onAttachedToWindow();
                } else {
                    this.f27505k.onDetachedFromWindow();
                }
                if (!this.f27498a) {
                    ai.f fVar = v;
