...
public final class hu0 extends xl0 {
    ...
    public ArrayList f24893f = new ArrayList();
    public int h = 0;
    ...
    public final boolean D(s4.c1 c1Var) {
        if (this.f24893f.size() + this.d.size() != 0) {
            return true;
        }
        return false;
    }
    ...
    public final MessageObject E(int i10) {
        ...
        return (MessageObject) this.f24893f.get(i10 - this.d.size());
    }

    public final void F(final int i10, final String str, long j3, long j10) {
        org.telegram.ui.ActionBar.n2 n2Var = this.v.f26234v1;
                    ...
                    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                        ...
                        if (tL_error == null) {
                            ...
                            for (int i13 = 0; i13 < messages_messages.messages.size(); i13++) {
                                ...
                                int i14 = i10;
                                if (i14 == 0 || message.f18364id <= i14) {
                                    arrayList.add(new MessageObject(hu0Var.v.f26234v1.getCurrentAccount(), message, false, true));
                                }
                            }
                        }
    ...
    public final void G(String str, boolean z10) {
        ...
        if (!this.d.isEmpty() || !this.f24893f.isEmpty()) {
            this.d.clear();
            this.f24893f.clear();
            l();
        }
        ...
        lv0 lv0Var = this.v;
        if (isEmpty) {
            if (!this.d.isEmpty() || !this.f24893f.isEmpty() || this.f24896s != 0) {
                this.d.clear();
                this.f24893f.clear();
                if (this.h != 0) {
                    lv0Var.f26234v1.getConnectionsManager().cancelRequest(this.h, true);
                    this.h = 0;
                    this.f24896s--;
                    return;
                }
        ...
        while (true) {
            ...
            if (i10 < eu0VarArr.length) {
                ...
                if (eu0Var.F == this.f24895r) {
                    eu0Var.f24045w.e(true, z10);
                }
                i10++;
            } else {
