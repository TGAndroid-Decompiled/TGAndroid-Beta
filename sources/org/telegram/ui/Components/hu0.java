...
public final class hu0 extends FrameLayout {
    public final org.telegram.ui.Cells.i6 f24870a;

    public hu0(int i10, Context context, boolean z10, org.telegram.ui.ActionBar.d6 d6Var, xq0 xq0Var) {
        super(context);
        int i11;
        int i12;
        ...
        spannableString.setSpan(new qq(R.drawable.msg_mini_lock2, 0), 0, 1, 33);
        spannableStringBuilder.append((CharSequence) spannableString);
        dVar.g(spannableStringBuilder, false, true);
        addView(dVar, w7.y5.d(-1, 48.0f, 48, 14.0f, 38.0f, 14.0f, 0.0f));
        dVar.setOnClickListener(new j80(xq0Var, 17));
        ...
        o90Var.setLinkTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19243n6, d6Var));
        ...
        o90Var.setText(AndroidUtilities.replaceCharSequence("%s", premiumText, spannableString2));
        addView(o90Var, w7.y5.d(-1, -2.0f, 49, 24.0f, 96.0f, 24.0f, 12.0f));
    }
