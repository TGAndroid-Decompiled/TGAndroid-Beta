...
public final class jp implements org.telegram.ui.ActionBar.j6 {
    ...
    public final void a(float f7) {
        ArrayList arrayList;
        mp mpVar = this.f25394b;
        kp kpVar = mpVar.h;
        if (f7 == 0.0f && !this.f25393a) {
        ...
        mpVar.setOverlayNavBarColor(mpVar.getThemedColor(org.telegram.ui.ActionBar.i6.f18780a7));
        if (mpVar.P) {
            for (int i13 = 0; i13 < kpVar.h(); i13++) {
                ((lp) kpVar.d.get(i13)).getClass();
            }
        }
        if (f7 == 1.0f && this.f25393a) {
            mpVar.P = false;
            this.f25393a = false;
        }
        mpVar.E();
        ...
        if (n6Var != null) {
            ...
            int themedColor = mpVar.getThemedColor(org.telegram.ui.ActionBar.i6.f18836d6);
        ...
        n6 n6Var2 = mpVar.f26193a0;
        if (n6Var2 != null) {
            n6Var2.setTextColor(mpVar.getThemedColor(i12));
        }
        mpVar.setBackgroundColor(mpVar.getThemedColor(org.telegram.ui.ActionBar.i6.f18907h5));
    }
