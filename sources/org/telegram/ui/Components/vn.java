...
public final class vn extends ni {
    public final mz f28839n;
    public final ll0 f28840r;
    ...
    public vn(int i10, Context context, org.telegram.ui.ActionBar.e6 e6Var, vi viVar) {
        ...
        TLRPC.Chat k12 = this.f26461b.k1();
        if (i10 == 1) {
    ...
    public int getListTopPadding() {
        return this.f28840r.getPaddingTop();
    }
