...
public final class fg0 implements rf.a {
    public static final jv0 f23909n0 = new jv0(new l2(25), new l2(26));
    public static final jv0 f23910o0 = new jv0(new l2(27), new l2(28));
    public static final fg0 f23911p0 = new fg0();
    public boolean E;
    ...
    public boolean Y;
    public float Z;
    public float f23913a0;
    public WindowManager f23914b;
    public ai.n4 f23915b0;
    public WindowManager.LayoutParams f23916c;
    public boolean f23917c0;
    public org.telegram.ui.f d;
    public boolean f23918d0;
    public eg0 e;
    public View f23920f;
    public boolean f23921f0;
    public eg0 h;
    public boolean f23924i0;
    public View f23926k0;
    public TextureView f23927l0;
    public boolean m0;
    public boolean f23928n;
    public qf0 f23929r;
    public ScaleGestureDetector f23930s;
    public org.telegram.ui.Cells.ia v;
    public boolean f23931w;
    public boolean f23932x;
    public View f23933y;
    public float f23912a = 1.4f;
    public float J = 1.0f;
    public final x61 Q = new x61(false);
    public final ag0 f23919e0 = new ag0(this, 1);
    public float[] f23922g0 = new float[2];
    public final ag0 f23923h0 = new ag0(this, 2);
    public final ag0 f23925j0 = new ag0(this, 3);

    public static void j(boolean z10) {
        f23911p0.k(z10, false);
    }
    ...
    public static ik0 o(float f7, boolean z10) {
        ...
        fg0 fg0Var = f23911p0;
        if (fg0Var.P && !z10) {
            obj.f24950a = fg0Var.K;
            obj.f24951b = fg0Var.L + AndroidUtilities.statusBarHeight;
            obj.f24952c = fg0Var.H;
            obj.d = fg0Var.I;
            return obj;
        }
        ...
        obj.f24952c = s(f10) * f13;
        obj.d = ((int) (s(f10) * f10)) * f13;
        if (f11 != -1.0f) {
            float f14 = obj.f24952c;
            ...
            obj.f24950a = (AndroidUtilities.displaySize.x - obj.f24952c) - AndroidUtilities.dp(16.0f);
        }
        if (f12 != -1.0f) {
            obj.f24951b = w7.p.a(f12, AndroidUtilities.dp(16.0f), (AndroidUtilities.displaySize.y - AndroidUtilities.dp(16.0f)) - obj.d) + AndroidUtilities.statusBarHeight;
            return obj;
        }
        obj.f24951b = AndroidUtilities.dp(16.0f) + AndroidUtilities.statusBarHeight;
        return obj;
    }
    ...
    public static void w(PhotoViewer photoViewer) {
        ...
        if (h71Var != null && sf.c.a(photoViewer.f31128y) == 1) {
            pf.d dVar = new pf.d(photoViewer.f31128y, fg0Var);
            dVar.f40807c = "photo-viewer-pip-" + h71Var.f24524a;
            dVar.e = 1;
            dVar.d = AndroidUtilities.dp(10.0f);
            dVar.f40811j = fg0Var.d;
            dVar.f40812k = fg0Var.f23926k0;
            int i10 = fg0Var.S;
            int i11 = fg0Var.T;
            dVar.h = i10;
            dVar.f40810i = i11;
            dVar.f40809g = h71Var.d;
            dVar.f40808f = true;
            fg0Var.W = dVar.a();
        }
        fg0Var.z();
    ...
    public final void a(com.google.android.gms.internal.cast.p pVar) {
        ...
        this.f23914b.removeView(this.d);
        this.m0 = true;
        this.d.invalidate();
    }
    ...
    public final void b(com.google.android.gms.internal.cast.p pVar) {
        ...
        if (eVar != null && eVar.h.b()) {
            WindowManager.LayoutParams layoutParams = this.f23916c;
            int width = this.W.h.f42926a.width();
            this.H = width;
            layoutParams.width = width;
            WindowManager.LayoutParams layoutParams2 = this.f23916c;
            int height = this.W.h.f42926a.height();
            this.I = height;
            layoutParams2.height = height;
        }
        this.f23914b.addView(this.d, this.f23916c);
        this.m0 = false;
        this.d.invalidate();
        PhotoViewer photoViewer = this.V;
        if (photoViewer != null) {
    ...
    public final Bitmap c() {
        TextureView textureView = this.f23927l0;
        if (textureView != null && textureView.isAvailable()) {
            return this.f23927l0.getBitmap();
        }
        return null;
    }
    ...
    public final Bitmap e() {
        ...
        PhotoViewer photoViewer = this.V;
        if (photoViewer != null && (textureView = photoViewer.f31112w3) != null && textureView.isAvailable()) {
            return this.V.f31112w3.getBitmap();
        }
        return null;
    }
    ...
    public final View h() {
        ...
        this.f23927l0 = textureView;
        textureView.setVisibility(4);
        this.f23927l0.setOpaque(false);
        this.f23927l0.setSurfaceTextureListener(new j50(this, 1));
    ...
    public final void i() {
        ...
        PhotoViewer photoViewer = this.V;
        if (photoViewer == null || (mt0Var = photoViewer.f30936c4) == null) {
            return;
        }
        mt0Var.cancelRewind();
    }
    ...
    public final void k(boolean z10, boolean z11) {
        ...
        if (this.f23924i0) {
            AndroidUtilities.cancelRunOnUIThread(this.f23925j0);
            this.f23924i0 = false;
        }
        o1.k kVar = this.M;
        if (kVar != null) {
    ...
    public final float q() {
        ...
        if (this.O == null) {
            ...
            Point point = AndroidUtilities.displaySize;
            this.f23912a = (Math.min(point.x, point.y) - AndroidUtilities.dp(32.0f)) / t();
    ...
    public final void u() {
        try {
            ...
            if (fVar != null && fVar.getParent() != null) {
                this.f23914b.removeViewImmediate(this.d);
            }
        ...
        this.f23921f0 = false;
        i();
        AndroidUtilities.cancelRunOnUIThread(this.f23923h0);
    }
