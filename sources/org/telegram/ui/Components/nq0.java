...
public final class nq0 extends View {
    public Random f28847a;
    public Paint f28848b;
    public Paint f28849c;
    public Paint d;
    public Paint f28850e;
    public float f28851f;
    public float h;
    public float f28852n;

    @Override
    public final void onDraw(Canvas canvas) {
        float f7;
        Paint paint = this.f28849c;
        Paint paint2 = this.f28848b;
        super.onDraw(canvas);
        ...
        float f12 = (this.f28852n * interpolation) + ((1.0f - interpolation) * this.h);
        canvas.save();
        ...
        canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), AndroidUtilities.dp(4.0f), this.f28850e);
        canvas.restore();
        ...
        float f15 = this.f28851f + 0.016f;
        this.f28851f = f15;
        if (f15 > 1.0f) {
            this.h = this.f28852n;
            float c10 = org.telegram.ui.Cells.p6.c(this.f28847a, 1001) / 1000.0f;
            this.f28852n = c10;
            if (c10 > this.h) {
                this.f28852n = c10 + 0.3f;
            } else {
                this.f28852n = c10 - 0.3f;
            }
            this.f28852n = Math.max(0.0f, Math.min(1.0f, this.f28852n));
            this.f28851f = 0.0f;
        }
        invalidate();
    }
