...
public final class nq0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public bc0 G;
    public mq0 H;
    public final lq0[] f26517a;
    public int f26518b;
    public int f26519c;
    public long d;
    public ArrayList e;
    public final ArrayList f26520f;
    public boolean h;
    public boolean f26521n;
    public String f26522r;
    public final ArrayList f26523s;
    public final HashMap v;
    public TLRPC.WebPage f26524w;
    public int f26525x;
    public int f26526y;

    public nq0(Activity activity, org.telegram.ui.ActionBar.f6 f6Var) {
        super(activity);
        this.f26517a = new lq0[2];
        this.f26518b = 0;
        this.f26520f = new ArrayList();
        this.f26521n = true;
        this.f26523s = new ArrayList();
        this.v = new HashMap();
        int i10 = 0;
        while (true) {
            lq0[] lq0VarArr = this.f26517a;
            if (i10 < lq0VarArr.length) {
                lq0VarArr[i10] = new lq0(this, activity, f6Var);
                addView(this.f26517a[i10], w7.x5.c(-1.0f, -1));
                i10++;
            } else {
                lq0VarArr[0].setVisibility(0);
                this.f26517a[1].setVisibility(8);
                return;
            }
        }
    }
    ...
    public static void a(lq0 lq0Var, TLRPC.WebPage webPage, String str) {
        ImageView imageView = lq0Var.f25962b;
        u9 u9Var = lq0Var.f25965n;
        imageView.setImageResource(R.drawable.msg_link2);
        lq0Var.f25962b.setVisibility(0);
        lq0Var.f25964f.setVisibility(8);
        lq0Var.f25966r.setVisibility(0);
        ...
        lq0Var.f25961a.setClickable(false);
    }
    ...
    public final String c(lq0 lq0Var) {
        int measuredWidth;
        String shortName;
        ArrayList arrayList = this.f26520f;
        ...
        while (i10 < size) {
            ...
            if (longValue == this.d) {
                ...
                if (arrayList.size() == 1) {
                    shortName = DialogObject.getName(this.f26519c, longValue);
                } else {
                    shortName = DialogObject.getShortName(this.f26519c, longValue);
                }
    ...
    public final void d() {
        if (this.f26525x != 0) {
            AccountInstance.getInstance(this.f26519c).getConnectionsManager().cancelRequest(this.f26525x, true);
            this.f26525x = 0;
        }
        this.f26526y++;
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        String str;
        if (i10 == NotificationCenter.didReceivedWebpagesInUpdates && this.f26524w != null && i11 == this.f26519c) {
            a0.i iVar = (a0.i) objArr[0];
            for (int i12 = 0; i12 < iVar.m(); i12++) {
                TLRPC.WebPage webPage = (TLRPC.WebPage) iVar.n(i12);
                if (webPage != null && webPage.f18274id == this.f26524w.f18274id) {
                    if (webPage instanceof TLRPC.TL_webPageEmpty) {
                        ...
                        this.f26524w = webPage;
                        ArrayList arrayList = this.f26523s;
                        if (arrayList.isEmpty()) {
                            str = "";
                        } else {
    ...
    public final u9 f(int i10) {
        u9[] u9VarArr;
        if (this.f26518b == 1 && (u9VarArr = this.f26517a[0].h) != null && i10 >= 0 && i10 < u9VarArr.length && u9VarArr[i10].getVisibility() == 0) {
            return u9VarArr[i10];
        }
        return null;
    }
    ...
    public final void h(int i10) {
        if (this.f26519c == i10) {
            ...
            if (isAttachedToWindow()) {
                NotificationCenter.getInstance(this.f26519c).addObserver(this, NotificationCenter.didReceivedWebpagesInUpdates);
                return;
            }
            return;
        }
        if (isAttachedToWindow()) {
            NotificationCenter.getInstance(this.f26519c).removeObserver(this, NotificationCenter.didReceivedWebpagesInUpdates);
        }
        this.f26519c = i10;
        if (isAttachedToWindow()) {
            NotificationCenter.getInstance(this.f26519c).addObserver(this, NotificationCenter.didReceivedWebpagesInUpdates);
    ...
    public final void i(int i10, ArrayList arrayList) {
        ...
        org.telegram.ui.ActionBar.k5 k5Var2 = lq0Var.f25963c;
        imageView.setImageResource(R.drawable.filled_forward);
        lq0Var.f25962b.setVisibility(0);
        lq0Var.f25965n.setVisibility(8);
        lq0Var.f25964f.setVisibility(0);
        lq0Var.f25966r.setVisibility(8);
        lq0Var.f25961a.setClickable(true);
    ...
    public void setLayoutClickListener(View.OnClickListener onClickListener) {
        for (lq0 lq0Var : this.f26517a) {
            lq0Var.f25961a.setOnClickListener(onClickListener);
        }
    }
