...
public final class nq0 extends Drawable {
    ...
    public final float[] f29610b = {0.0f, -0.5f};
    public final Drawable f29611c;
    ...
    public nq0(Context context, int i10) {
        this.f29613f = i10;
        if (i10 == 4) {
            this.f29611c = context.getResources().getDrawable(R.drawable.filled_extend_location).mutate();
            this.d = context.getResources().getDrawable(R.drawable.smallanimationpinleft).mutate();
            this.f29612e = context.getResources().getDrawable(R.drawable.smallanimationpinright).mutate();
        } else if (i10 == 5) {
            this.f29611c = context.getResources().getDrawable(R.drawable.filled_stop_location).mutate();
            this.d = context.getResources().getDrawable(R.drawable.smallanimationpinleft).mutate();
            this.f29612e = context.getResources().getDrawable(R.drawable.smallanimationpinright).mutate();
        } else if (i10 == 1) {
            this.f29611c = context.getResources().getDrawable(R.drawable.smallanimationpin).mutate();
            this.d = context.getResources().getDrawable(R.drawable.smallanimationpinleft).mutate();
            this.f29612e = context.getResources().getDrawable(R.drawable.smallanimationpinright).mutate();
        } else {
            this.f29611c = context.getResources().getDrawable(R.drawable.animationpin).mutate();
            this.d = context.getResources().getDrawable(R.drawable.animationpinleft).mutate();
            this.f29612e = context.getResources().getDrawable(R.drawable.animationpinright).mutate();
        }
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        int i10;
        float a2;
        Drawable drawable = this.f29611c;
        int intrinsicWidth = drawable.getIntrinsicWidth();
        int intrinsicHeight = drawable.getIntrinsicHeight();
        int i11 = 3;
        int i12 = 5;
        int i13 = 1;
        int i14 = this.f29613f;
        int i15 = 4;
        if (i14 != 4 && i14 != 5) {
            if (i14 == 3) {
        ...
        while (true) {
            ...
            if (f10 >= 0.0f) {
                ...
                Drawable drawable3 = this.f29612e;
        ...
        long j10 = currentTimeMillis - this.f29609a;
        this.f29609a = currentTimeMillis;
        if (j10 > 16) {
            j10 = 16;
        }
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f29611c.setColorFilter(colorFilter);
        this.d.setColorFilter(colorFilter);
        this.f29612e.setColorFilter(colorFilter);
    }
