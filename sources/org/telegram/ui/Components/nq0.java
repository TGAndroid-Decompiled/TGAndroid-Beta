...
public final class nq0 extends View {
    public Random f26550a;
    public Paint f26551b;
    public Paint f26552c;
    public Paint d;
    public Paint e;
    ...
    public final void onDraw(Canvas canvas) {
        float f7;
        Paint paint = this.f26552c;
        Paint paint2 = this.f26551b;
        super.onDraw(canvas);
        ...
        qr qrVar = qr.f27421g;
        float f11 = this.f26553f;
        if (f11 > 0.4f) {
            f7 = (f11 - 0.4f) / 0.6f;
        } else {
            f7 = 0.0f;
        }
        float interpolation = qrVar.getInterpolation(f7);
        float f12 = (this.f26554n * interpolation) + ((1.0f - interpolation) * this.h);
        canvas.save();
        canvas.translate(0.0f, (-org.telegram.messenger.y0.z(4.0f, getMeasuredHeight(), dp)) * f12);
        int i11 = 0;
        while (i11 < i10) {
            ...
            rectF.set(AndroidUtilities.dp(1.0f) + measuredWidth, f13, org.telegram.messenger.y0.C(1.0f, measuredWidth, measuredWidth), f14);
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f), paint2);
            i11++;
            i10 = 7;
            f10 = 3.0f;
        ...
        float f15 = this.f26553f + 0.016f;
        this.f26553f = f15;
        if (f15 > 1.0f) {
            this.h = this.f26554n;
            float c10 = org.telegram.ui.Cells.q3.c(this.f26550a, 1001) / 1000.0f;
            this.f26554n = c10;
            if (c10 > this.h) {
                this.f26554n = c10 + 0.3f;
            } else {
                this.f26554n = c10 - 0.3f;
            }
            this.f26554n = Math.max(0.0f, Math.min(1.0f, this.f26554n));
            this.f26553f = 0.0f;
        }
        invalidate();
    }
