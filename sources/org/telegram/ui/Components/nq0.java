...
public final class nq0 extends View {
    public Random f26551a;
    public Paint f26552b;
    public Paint f26553c;
    public Paint d;
    public Paint e;
    public float f26554f;
    public float h;
    ...
    public final void onDraw(Canvas canvas) {
        float f7;
        Paint paint = this.f26553c;
        Paint paint2 = this.f26552b;
        super.onDraw(canvas);
        ...
        float f12 = (this.f26555n * interpolation) + ((1.0f - interpolation) * this.h);
        canvas.save();
        ...
        float f15 = this.f26554f + 0.016f;
        this.f26554f = f15;
        if (f15 > 1.0f) {
            this.h = this.f26555n;
            float c10 = org.telegram.ui.Cells.p6.c(this.f26551a, 1001) / 1000.0f;
            this.f26555n = c10;
            if (c10 > this.h) {
                this.f26555n = c10 + 0.3f;
            } else {
                this.f26555n = c10 - 0.3f;
            }
            this.f26555n = Math.max(0.0f, Math.min(1.0f, this.f26555n));
            this.f26554f = 0.0f;
        }
        invalidate();
    }
