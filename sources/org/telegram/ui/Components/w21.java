...
public final class w21 extends i51 {
    ...
    public final void bindView(View view, j51 j51Var, boolean z10, x51 x51Var, f61 f61Var) {
        ...
        if (j51Var.f25130r) {
            ...
            if (obj == null) {
                if (j51Var.B == -2) {
                    x21Var.b(j51Var.f25129q, j51Var.e);
                } else {
                    ...
                    x21Var.c(z11, j51Var.f25129q, j51Var.e);
                }
            } else if (obj instanceof TLRPC.TL_forumTopic) {
                if (!j51Var.I) {
                    x21Var.f((TLRPC.TL_forumTopic) obj, j51Var.e);
                } else {
                    x21Var.a(j51Var.f25135x, (TLRPC.TL_forumTopic) obj, j51Var.e);
                }
            }
        }
        if (f61Var != null && f61Var.f23797c3 && x21Var.f29838y) {
            z12 = true;
        }
