...
public final class w21 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, le.d {
    public static final int f32118f0 = 0;
    ...
    public long V;
    public boolean W;
    public final le.b f32119a;
    public Utilities.Callback2 f32120a0;
    public final int f32121b;
    public Runnable f32122b0;
    public final long f32123c;
    public Utilities.Callback2 f32124c0;
    public final org.telegram.ui.ActionBar.f6 d;
    public boolean f32125d0;
    public final boolean f32126e;
    public final HashSet f32127e0;
    public final boolean f32128f;
    public final org.telegram.ui.co h;
    public final boolean f32129n;
    public final FrameLayout f32130r;
    public final k21 f32131s;
    public final v21 v;
    public final ImageView f32132w;
    public final ImageView f32133x;
    public final ImageView f32134y;
    ...
    public w21(Activity activity, org.telegram.ui.co coVar, int i10, long j3, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        boolean z10;
        pr prVar = pr.h;
        this.f32119a = new le.b(0, this, prVar, 380L, true);
        this.J = new le.b(0, new b21(this), prVar, 320L, false);
        this.R = 0.0f;
        this.f32127e0 = new HashSet();
        this.h = coVar;
        this.f32121b = i10;
        this.f32123c = j3;
        this.d = f6Var;
        long j10 = -j3;
        this.f32126e = ChatObject.isMonoForum(MessagesController.getInstance(i10).getChat(Long.valueOf(j10)));
        ...
        this.f32128f = isBotForumWithEditableTopics;
        this.f32129n = !org.telegram.messenger.w1.v("topics_end_reached_", j10, UserConfig.getInstance(i10).getPreferences(), false);
        setClipChildren(true);
        setClipToPadding(true);
        setWillNotDraw(false);
        ?? frameLayout2 = new FrameLayout(activity);
        this.f32130r = frameLayout2;
        ...
        k21 k21Var = new k21(this, activity, i10, new Utilities.Callback2(this) {
            ...
            public final void run(Object obj, Object obj2) {
                ...
                boolean z17;
                int i13 = r2;
                w21 w21Var = this.f27355b;
                switch (i13) {
                    case 0:
                        ArrayList arrayList = (ArrayList) obj;
                        v51 v51Var = (v51) obj2;
                        boolean z18 = w21Var.f32128f;
                        int i14 = w21Var.f32121b;
                        MessagesController messagesController = MessagesController.getInstance(i14);
                        long j16 = w21Var.f32123c;
                        long j17 = -j16;
                        ...
                        if (topics != null) {
                            ...
                            while (i16 < size) {
                                ...
                                if (w21Var.f32127e0.contains(Integer.valueOf(tL_forumTopic2.f19948id))) {
                                    size = i18;
                                    i16 = i12;
                                } else {
                                    ...
                                    if (!z21 && z20) {
                                        if (!arrayList.isEmpty()) {
                                            ((h51) i2.g.h(1, arrayList)).f26634y |= 8;
                                        }
                                        v51Var.L();
                                        z20 = false;
                                    } else if (z21 && !z20) {
                        ...
                        if (topics != null && !topics.isEmpty() && !topicsController2.endIsReached(j17) && w21Var.f32129n) {
                    ...
                    default:
                        ...
                        if (topics2 != null) {
                            ...
                            while (i21 < size2) {
                                ...
                                if (w21Var.f32127e0.contains(Integer.valueOf(tL_forumTopic4.f19948id))) {
                                    chat2 = chat3;
                                    size2 = i22;
                                    user3 = user;
                                } else {
                        ...
                        if (topics2 != null && !topics2.isEmpty() && !topicsController.endIsReached(j20) && w21Var.f32129n) {
                            int i24 = u21.f30816a;
                ...
                public final void onClick(View view) {
                    switch (r2) {
                        case 0:
                            ...
                            return;
                        case 1:
                            w21 w21Var2 = this.f25908b;
                            m21 m21Var = w21Var2.G;
                            m21Var.v1(false);
                            k21 k21Var2 = w21Var2.f32131s;
                            k21Var2.v1(false);
                            ...
                            return;
                        default:
                            this.f25908b.f32120a0.run(0, Boolean.FALSE);
                            return;
                    }
                }
            });
    ...
    public static void a(w21 w21Var, h51 h51Var) {
        if (w21Var.f32126e) {
            Utilities.Callback2 callback2 = w21Var.f32124c0;
            if (callback2 != null) {
                callback2.run(Long.valueOf(h51Var.B), Boolean.FALSE);
            }
        } else if (h51Var.B == -2) {
            Runnable runnable = w21Var.f32122b0;
            if (runnable != null) {
                runnable.run();
            }
        } else {
            Utilities.Callback2 callback22 = w21Var.f32120a0;
            if (callback22 != null) {
    ...
    public static void b(w21 w21Var, ArrayList arrayList) {
        ...
        TopicsController topicsController = MessagesController.getInstance(w21Var.f32121b).getTopicsController();
    ...
    public static boolean c(final w21 w21Var, h51 h51Var, View view) {
        ...
        long j3 = w21Var.f32123c;
        int i18 = w21Var.f32121b;
        if (w21Var.G.f25309c3 || w21Var.f32131s.f25309c3) {
            return false;
        }
        Object obj = h51Var.G;
            ...
            if (ChatObject.canManageTopics(chat4) || UserObject.isBotForumWithEditableTopics(user)) {
                I.c(R.drawable.outline_profile_edit_24, LocaleController.getString(R.string.EditTopic), new Runnable(w21Var) {
                    ...
                    public final void run() {
                        boolean z12;
                        int i21 = r4;
                        w21 w21Var2 = this.f25556b;
                        TLRPC.TL_forumTopic tL_forumTopic2 = tL_forumTopic;
                        n70 n70Var3 = I;
                        switch (i21) {
                            case 0:
                                n70Var3.u();
                                w21Var2.h.presentFragment(af1.a0(-w21Var2.f32123c, tL_forumTopic2.f19948id));
                                return;
                            case 1:
                                w21Var2.getClass();
                                n70Var3.u();
                                MessagesController.getInstance(w21Var2.f32121b).getTopicsController().toggleCloseTopic(-w21Var2.f32123c, tL_forumTopic2.f19948id, true ^ tL_forumTopic2.closed);
                                return;
                            default:
                                n70Var3.u();
                                ...
                                if (hashSet.size() == 1) {
                                    z12 = false;
                                    b2Var.T = LocaleController.formatString(R.string.DeleteSelectedTopic, MessagesController.getInstance(w21Var3.f32121b).getTopicsController().findTopic(-w21Var3.f32123c, ((Integer) arrayList.get(0)).intValue()).title);
                                } else {
                                    z12 = false;
                                ...
                                if (textView != null) {
                                    textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20926q7, z12));
                                    return;
                                }
                                return;
                        }
                    ...
                    public final void run() {
                        ...
                        switch (i212) {
                            ...
                            default:
                                ...
                                TextView textView = (TextView) b2Var.d(-1);
                                if (textView != null) {
                                    textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20926q7, z122));
                                    return;
                                }
                                return;
                        }
        ...
        if (view instanceof r21) {
            ...
            int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20691d6, f6Var);
            float f7 = b10;
            float f10 = dp;
            float f11 = dp2;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i12) {
            ...
            MessagesController.getInstance(this.f32121b).getTopicsController().sortTopics(-j3, false);
            o();
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        FrameLayout frameLayout2 = this.f32130r;
    ...
    public final void f(boolean z10) {
        boolean z11;
        ArrayList<TLRPC.TL_forumTopic> topics = MessagesController.getInstance(this.f32121b).getTopicsController().getTopics(-this.f32123c);
        if (topics != null && !topics.isEmpty() && !this.f32125d0) {
            z11 = true;
        } else {
            z11 = false;
        }
        this.f32119a.a(z11, z10);
    }
    ...
    public final void g() {
        ...
        ImageView imageView = this.f32132w;
        ...
        ImageView imageView2 = this.f32133x;
        ...
        ImageView imageView3 = this.f32134y;
    ...
    public float getSideMenuT() {
        return this.R * this.f32119a.f15395e;
    }

    public final void h() {
        int i10;
        float lerp = AndroidUtilities.lerp(1.0f, 0.0f, this.R);
        FrameLayout frameLayout = this.f32130r;
        frameLayout.setAlpha(lerp);
        if ((1.0f - this.R) * this.f32119a.f15395e > 0.0f) {
            i10 = 0;
        } else {
            i10 = 8;
        }
        ...
        if (this.P) {
            frameLayout.setTranslationY(((getMeasuredHeight() - AndroidUtilities.dp(50.0f)) - this.M) + AndroidUtilities.lerp(AndroidUtilities.dp(43.0f), 0, j(s21.f30206c)));
        } else {
            frameLayout.setTranslationY(this.N + AndroidUtilities.lerp(-AndroidUtilities.dp(43.0f), 0, j(s21.f30204a)));
        }
    }

    public final float j(s21 s21Var) {
        float f7;
        float f10 = this.f32119a.f15395e;
        if (s21Var == s21.f30205b) {
            f7 = this.R;
        } else if ((s21Var == s21.f30204a && !this.P) || (s21Var == s21.f30206c && this.P)) {
            f7 = 1.0f - this.R;
        } else {
            return 0.0f;
        }
    ...
    public final void l() {
        TopicsController topicsController = MessagesController.getInstance(this.f32121b).getTopicsController();
        long j3 = this.f32123c;
    ...
    public final void m(long j3, boolean z10) {
        if (this.f32126e) {
            Utilities.Callback2 callback2 = this.f32124c0;
            if (callback2 != null) {
        ...
        Utilities.Callback2 callback22 = this.f32120a0;
        if (callback22 != null) {
    ...
    public final void n() {
        ...
        this.f32134y.setColorFilter(new PorterDuffColorFilter(d, mode));
        ...
        this.f32132w.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i12, f6Var), mode));
        this.f32133x.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i12, f6Var), mode));
        invalidate();
    }
