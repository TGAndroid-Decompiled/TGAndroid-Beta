...
public final class w21 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, le.d {
    public static final int f32091f0 = 0;
    ...
    public long V;
    public boolean W;
    public final le.b f32092a;
    public Utilities.Callback2 f32093a0;
    public final int f32094b;
    public Runnable f32095b0;
    public final long f32096c;
    public Utilities.Callback2 f32097c0;
    public final org.telegram.ui.ActionBar.f6 d;
    public boolean f32098d0;
    public final boolean f32099e;
    public final HashSet f32100e0;
    public final boolean f32101f;
    public final org.telegram.ui.co h;
    public final boolean f32102n;
    public final FrameLayout f32103r;
    public final k21 f32104s;
    public final v21 v;
    public final ImageView f32105w;
    public final ImageView f32106x;
    public final ImageView f32107y;
    ...
    public w21(Activity activity, org.telegram.ui.co coVar, int i10, long j3, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        boolean z10;
        pr prVar = pr.h;
        this.f32092a = new le.b(0, this, prVar, 380L, true);
        this.J = new le.b(0, new b21(this), prVar, 320L, false);
        this.R = 0.0f;
        this.f32100e0 = new HashSet();
        this.h = coVar;
        this.f32094b = i10;
        this.f32096c = j3;
        this.d = f6Var;
        long j10 = -j3;
        this.f32099e = ChatObject.isMonoForum(MessagesController.getInstance(i10).getChat(Long.valueOf(j10)));
        ...
        this.f32101f = isBotForumWithEditableTopics;
        this.f32102n = !org.telegram.messenger.w1.v("topics_end_reached_", j10, UserConfig.getInstance(i10).getPreferences(), false);
        setClipChildren(true);
        setClipToPadding(true);
        setWillNotDraw(false);
        ?? frameLayout2 = new FrameLayout(activity);
        this.f32103r = frameLayout2;
        ...
        k21 k21Var = new k21(this, activity, i10, new Utilities.Callback2(this) {
            ...
            public final void run(Object obj, Object obj2) {
                ...
                boolean z17;
                int i13 = r2;
                w21 w21Var = this.f27328b;
                switch (i13) {
                    case 0:
                        ArrayList arrayList = (ArrayList) obj;
                        v51 v51Var = (v51) obj2;
                        boolean z18 = w21Var.f32101f;
                        int i14 = w21Var.f32094b;
                        MessagesController messagesController = MessagesController.getInstance(i14);
                        long j16 = w21Var.f32096c;
                        long j17 = -j16;
                        ...
                        if (topics != null) {
                            ...
                            while (i16 < size) {
                                ...
                                if (w21Var.f32100e0.contains(Integer.valueOf(tL_forumTopic2.f19921id))) {
                                    size = i18;
                                    i16 = i12;
                                } else {
                                    ...
                                    if (!z21 && z20) {
                                        if (!arrayList.isEmpty()) {
                                            ((h51) i2.g.h(1, arrayList)).f26607y |= 8;
                                        }
                                        v51Var.L();
                                        z20 = false;
                                    } else if (z21 && !z20) {
                        ...
                        if (topics != null && !topics.isEmpty() && !topicsController2.endIsReached(j17) && w21Var.f32102n) {
                    ...
                    default:
                        ...
                        if (topics2 != null) {
                            ...
                            while (i21 < size2) {
                                ...
                                if (w21Var.f32100e0.contains(Integer.valueOf(tL_forumTopic4.f19921id))) {
                                    chat2 = chat3;
                                    size2 = i22;
                                    user3 = user;
                                } else {
                        ...
                        if (topics2 != null && !topics2.isEmpty() && !topicsController.endIsReached(j20) && w21Var.f32102n) {
                            int i24 = u21.f30789a;
                ...
                public final void onClick(View view) {
                    switch (r2) {
                        case 0:
                            ...
                            return;
                        case 1:
                            w21 w21Var2 = this.f25881b;
                            m21 m21Var = w21Var2.G;
                            m21Var.v1(false);
                            k21 k21Var2 = w21Var2.f32104s;
                            k21Var2.v1(false);
                            ...
                            return;
                        default:
                            this.f25881b.f32093a0.run(0, Boolean.FALSE);
                            return;
                    }
                }
            });
    ...
    public static void a(w21 w21Var, h51 h51Var) {
        if (w21Var.f32099e) {
            Utilities.Callback2 callback2 = w21Var.f32097c0;
            if (callback2 != null) {
                callback2.run(Long.valueOf(h51Var.B), Boolean.FALSE);
            }
        } else if (h51Var.B == -2) {
            Runnable runnable = w21Var.f32095b0;
            if (runnable != null) {
                runnable.run();
            }
        } else {
            Utilities.Callback2 callback22 = w21Var.f32093a0;
            if (callback22 != null) {
    ...
    public static void b(w21 w21Var, ArrayList arrayList) {
        long j3 = w21Var.f32096c;
        TopicsController topicsController = MessagesController.getInstance(w21Var.f32094b).getTopicsController();
    ...
    public static boolean c(final w21 w21Var, h51 h51Var, View view) {
        ...
        long j3 = w21Var.f32096c;
        int i18 = w21Var.f32094b;
        if (w21Var.G.f25282c3 || w21Var.f32104s.f25282c3) {
            return false;
        }
        Object obj = h51Var.G;
            ...
            if (ChatObject.canManageTopics(chat4) || UserObject.isBotForumWithEditableTopics(user)) {
                I.c(R.drawable.outline_profile_edit_24, LocaleController.getString(R.string.EditTopic), new Runnable(w21Var) {
                    ...
                    public final void run() {
                        boolean z12;
                        int i21 = r4;
                        w21 w21Var2 = this.f25529b;
                        TLRPC.TL_forumTopic tL_forumTopic2 = tL_forumTopic;
                        n70 n70Var3 = I;
                        switch (i21) {
                            case 0:
                                n70Var3.u();
                                w21Var2.h.presentFragment(af1.a0(-w21Var2.f32096c, tL_forumTopic2.f19921id));
                                return;
                            case 1:
                                w21Var2.getClass();
                                n70Var3.u();
                                MessagesController.getInstance(w21Var2.f32094b).getTopicsController().toggleCloseTopic(-w21Var2.f32096c, tL_forumTopic2.f19921id, true ^ tL_forumTopic2.closed);
                                return;
                            default:
                                n70Var3.u();
                                ...
                                if (hashSet.size() == 1) {
                                    z12 = false;
                                    b2Var.T = LocaleController.formatString(R.string.DeleteSelectedTopic, MessagesController.getInstance(w21Var3.f32094b).getTopicsController().findTopic(-w21Var3.f32096c, ((Integer) arrayList.get(0)).intValue()).title);
                                } else {
                                    z12 = false;
                                ...
                                if (textView != null) {
                                    textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20899q7, z12));
                                    return;
                                }
                                return;
                        }
                    ...
                    public final void run() {
                        ...
                        switch (i212) {
                            ...
                            default:
                                ...
                                TextView textView = (TextView) b2Var.d(-1);
                                if (textView != null) {
                                    textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20899q7, z122));
                                    return;
                                }
                                return;
                        }
        ...
        if (view instanceof r21) {
            ...
            int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20664d6, f6Var);
            float f7 = b10;
            float f10 = dp;
            float f11 = dp2;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i12) {
            ...
            MessagesController.getInstance(this.f32094b).getTopicsController().sortTopics(-j3, false);
            o();
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        FrameLayout frameLayout2 = this.f32103r;
    ...
    public final void f(boolean z10) {
        boolean z11;
        ArrayList<TLRPC.TL_forumTopic> topics = MessagesController.getInstance(this.f32094b).getTopicsController().getTopics(-this.f32096c);
        if (topics != null && !topics.isEmpty() && !this.f32098d0) {
            z11 = true;
        } else {
            z11 = false;
        }
        this.f32092a.a(z11, z10);
    }
    ...
    public final void g() {
        ...
        ImageView imageView = this.f32105w;
        ...
        ImageView imageView2 = this.f32106x;
        ...
        ImageView imageView3 = this.f32107y;
    ...
    public float getSideMenuT() {
        return this.R * this.f32092a.f15368e;
    }

    public final void h() {
        int i10;
        float lerp = AndroidUtilities.lerp(1.0f, 0.0f, this.R);
        FrameLayout frameLayout = this.f32103r;
        frameLayout.setAlpha(lerp);
        if ((1.0f - this.R) * this.f32092a.f15368e > 0.0f) {
            i10 = 0;
        } else {
            i10 = 8;
        }
        ...
        if (this.P) {
            frameLayout.setTranslationY(((getMeasuredHeight() - AndroidUtilities.dp(50.0f)) - this.M) + AndroidUtilities.lerp(AndroidUtilities.dp(43.0f), 0, j(s21.f30179c)));
        } else {
            frameLayout.setTranslationY(this.N + AndroidUtilities.lerp(-AndroidUtilities.dp(43.0f), 0, j(s21.f30177a)));
        }
    }

    public final float j(s21 s21Var) {
        float f7;
        float f10 = this.f32092a.f15368e;
        if (s21Var == s21.f30178b) {
            f7 = this.R;
        } else if ((s21Var == s21.f30177a && !this.P) || (s21Var == s21.f30179c && this.P)) {
            f7 = 1.0f - this.R;
        } else {
            return 0.0f;
        }
    ...
    public final void l() {
        TopicsController topicsController = MessagesController.getInstance(this.f32094b).getTopicsController();
        long j3 = this.f32096c;
    ...
    public final void m(long j3, boolean z10) {
        if (this.f32099e) {
            Utilities.Callback2 callback2 = this.f32097c0;
            if (callback2 != null) {
        ...
        Utilities.Callback2 callback22 = this.f32093a0;
        if (callback22 != null) {
    ...
    public final void n() {
        ...
        this.f32107y.setColorFilter(new PorterDuffColorFilter(d, mode));
        ...
        this.f32105w.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i12, f6Var), mode));
        this.f32106x.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i12, f6Var), mode));
        invalidate();
    }
