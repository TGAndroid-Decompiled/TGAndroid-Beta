...
public final class t31 extends FrameLayout {
    public final ImageView f28044a;
    public final org.telegram.ui.sk f28045b;
    public final cc1 f28046c;
    ...
    public t31(v31 v31Var, Context context) {
        ...
        int themedColor = v31Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18904h5);
        String str = v31Var.f28591s;
        view.setBackgroundColor(themedColor);
        addView(view, w7.x5.d(-1, 44.0f, 55, 0.0f, 12.0f, 0.0f, 0.0f));
        ImageView imageView = new ImageView(context);
        this.f28044a = imageView;
        ...
        imageView.setBackground(org.telegram.ui.ActionBar.i6.f0(v31Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18923i6), 1, -1));
        imageView.setAlpha(0.0f);
        imageView.setOnClickListener(new View.OnClickListener(this) {
            public final t31 f27242b;
            ...
            public final void onClick(View view2) {
                ...
                switch (r2) {
                    case 0:
                        this.f27242b.h.dismiss();
                        return;
                    default:
                        t31 t31Var = this.f27242b;
                        r31 r31Var = t31Var.e;
                        ...
                        for (int i13 = 0; i13 < locales.size(); i13++) {
                            ...
                            if (!localeInfo.pluralLangCode.equals(v31Var2.f28591s) && "remote".equals(localeInfo.pathToFile)) {
        ...
        if (LocaleController.isRTL) {
            ...
            cc1Var.addView(r31Var, w7.x5.t(-2, -2, 16, 0, 0, i11, 0));
            if (this.d != null) {
            ...
            cc1Var.addView(r31Var, w7.x5.t(-2, -2, 16, i10, 0, 0, 0));
        }
    ...
    public final void setTranslationY(float f7) {
        ...
        float interpolation = qr.f27421g.getInterpolation(a2);
        float lerp = AndroidUtilities.lerp(0.85f, 1.0f, interpolation);
        org.telegram.ui.sk skVar = this.f28045b;
