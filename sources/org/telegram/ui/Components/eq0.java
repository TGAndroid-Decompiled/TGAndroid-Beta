...
public final class eq0 extends ll0 {
    ...
    public int J;
    public final iq0 K;
    public final Context f23648c;
    public final cq0 e;
    public bq0 f23649f;
    public bq0 h;
    public String f23650n;
    public int f23651r;
    public int f23652s;
    public int v;
    public ArrayList d = new ArrayList();
    public int f23653w = -1;
    public int f23654x = -1;
    ...
    public final void E(String str) {
        if (str != null && str.equals(this.f23650n)) {
            return;
        }
        this.f23650n = str;
        if (this.f23649f != null) {
            Utilities.searchQueue.cancelRunnable(this.f23649f);
            this.f23649f = null;
        }
        bq0 bq0Var = this.h;
        if (bq0Var != null) {
    ...
    public final int h() {
        ...
        this.E = -1;
        this.F = -1;
        if (TextUtils.isEmpty(this.f23650n)) {
            int i10 = this.G;
            this.f23655y = i10;
            this.G = i10 + 2;
            this.f23653w = i10 + 1;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        boolean isEmpty = TextUtils.isEmpty(this.f23650n);
        String str4 = null;
        cq0 cq0Var = this.e;
