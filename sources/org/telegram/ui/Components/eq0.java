...
public final class eq0 extends kl0 {
    ...
    public final TLRPC.TL_forumTopic E(int i10) {
        ...
        if (arrayList != null && i11 >= 0 && i11 < arrayList.size()) {
            return (TLRPC.TL_forumTopic) this.f25782f.get(i11);
        }
        return null;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        int dp;
        if (c1Var.f45771f == 0) {
            org.telegram.ui.Cells.g7 g7Var = (org.telegram.ui.Cells.g7) c1Var.f45767a;
            if (i10 == 1 && this.d) {
                g7Var.setAsNewBotForumTopic(this.f25781e);
            } else if (this.f25782f != null) {
                ...
                org.telegram.ui.Cells.d7 d7Var = g7Var.f22013b;
                int i11 = g7Var.f22016f;
                x9 x9Var = g7Var.f22012a;
                TextView textView = g7Var.f22014c;
                if (dialog != null) {
                    ...
                    if (ChatObject.isMonoForum(chat)) {
                        ...
                        if (DialogObject.isUserDialog(peerDialogId)) {
                            ...
                            textView.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20798j5, g7Var.h));
                            d7Var.m(i11, user);
                            if (user != null) {
