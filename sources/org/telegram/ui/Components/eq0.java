...
public final class eq0 extends Drawable {
    public long f28161a = 0;
    public final float[] f28162b = {0.0f, -0.5f};
    public final Drawable f28163c;
    public final Drawable d;
    public final Drawable f28164e;
    public final int f28165f;

    public eq0(Context context, int i10) {
        this.f28165f = i10;
        if (i10 == 4) {
            this.f28163c = context.getResources().getDrawable(R.drawable.filled_extend_location).mutate();
            this.d = context.getResources().getDrawable(R.drawable.smallanimationpinleft).mutate();
            this.f28164e = context.getResources().getDrawable(R.drawable.smallanimationpinright).mutate();
        } else if (i10 == 5) {
            this.f28163c = context.getResources().getDrawable(R.drawable.filled_stop_location).mutate();
            this.d = context.getResources().getDrawable(R.drawable.smallanimationpinleft).mutate();
            this.f28164e = context.getResources().getDrawable(R.drawable.smallanimationpinright).mutate();
        } else if (i10 == 1) {
            this.f28163c = context.getResources().getDrawable(R.drawable.smallanimationpin).mutate();
            this.d = context.getResources().getDrawable(R.drawable.smallanimationpinleft).mutate();
            this.f28164e = context.getResources().getDrawable(R.drawable.smallanimationpinright).mutate();
        } else {
            this.f28163c = context.getResources().getDrawable(R.drawable.animationpin).mutate();
            this.d = context.getResources().getDrawable(R.drawable.animationpinleft).mutate();
            this.f28164e = context.getResources().getDrawable(R.drawable.animationpinright).mutate();
        }
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        int i10;
        float a2;
        Drawable drawable = this.f28163c;
        int intrinsicWidth = drawable.getIntrinsicWidth();
        int intrinsicHeight = drawable.getIntrinsicHeight();
        int i11 = 3;
        int i12 = 5;
        int i13 = 1;
        int i14 = this.f28165f;
        int i15 = 4;
        if (i14 != 4 && i14 != 5) {
            if (i14 == 3) {
        ...
        while (true) {
            ...
            if (f9 >= 0.0f) {
                ...
                if (f11 < 0.5f) {
                    ...
                    a2 = org.telegram.messenger.x3.a(f11, 0.5f, 0.5f, 1.0f);
                }
                ...
                Drawable drawable3 = this.f28164e;
        ...
        long j10 = currentTimeMillis - this.f28161a;
        this.f28161a = currentTimeMillis;
        if (j10 > 16) {
            j10 = 16;
        }
        for (int i21 = 0; i21 < 2; i21++) {
            ...
            float f12 = (((float) j10) / 1300.0f) + fArr[i21];
            fArr[i21] = f12;
            if (f12 > 1.0f) {
                fArr[i21] = 1.0f;
            }
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        ...
        this.f28164e.setColorFilter(colorFilter);
    }
