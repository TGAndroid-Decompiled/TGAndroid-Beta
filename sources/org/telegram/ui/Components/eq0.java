...
public final class eq0 extends sl0 {
    ...
    public final a0.h f26632e = new a0.h();
    public final mq0 f26633f;
    ...
    public final void E() {
        ...
        arrayList.clear();
        a0.h hVar = this.f26632e;
        hVar.b();
        mq0 mq0Var = this.f26633f;
        ...
        if (mq0Var.W) {
            ...
            dialog.f20847id = Long.MAX_VALUE;
        ...
        for (int i15 = 0; i15 < allDialogs.size(); i15++) {
            ...
            if (dialog3 instanceof TLRPC.TL_dialog) {
                long j11 = dialog3.f20847id;
                if (j11 != j10 && !DialogObject.isEncryptedDialog(j11)) {
                    if (!DialogObject.isUserDialog(dialog3.f20847id)) {
                        i13 = ((org.telegram.ui.ActionBar.h3) mq0Var).currentAccount;
                        TLRPC.Chat chat = MessagesController.getInstance(i13).getChat(Long.valueOf(-dialog3.f20847id));
                        if (chat != null && !ChatObject.isNotInChat(chat) && ((!chat.gigagroup || ChatObject.hasAdminRights(chat)) && (!ChatObject.isChannel(chat) || chat.creator || (((tL_chatAdminRights = chat.admin_rights) != null && tL_chatAdminRights.post_messages) || chat.megagroup)))) {
                            ...
                            hVar.k(dialog3, dialog3.f20847id);
                        }
                    } else {
                        if (dialog3.folder_id == 1) {
                            arrayList2.add(dialog3);
        ...
        org.telegram.ui.xn xnVar = mq0Var.f29200c0;
        if (xnVar != null) {
            int i16 = xnVar.f43112a;
            if (i16 != 1) {
                if (i16 == 2) {
    ...
    public final void v(f2.m1 r7, int r8) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.eq0.v(f2.m1, int):void");
    }
    ...
    public final f2.m1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            cq0Var.setLayoutParams(new f2.x0(-1, AndroidUtilities.dp(f10)));
        }
        return new f2.m1(cq0Var);
    }
}
