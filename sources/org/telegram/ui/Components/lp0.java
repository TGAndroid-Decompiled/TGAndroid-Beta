...
public final class lp0 extends xw0 {
    ...
    public long f26234b = 0;
    public boolean f26235c = false;
    public float d;
    ...
    @Override
    public final void d() {
        this.f26234b = System.currentTimeMillis();
        this.f26235c = true;
        invalidateSelf();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.f26235c) {
            ...
            long j3 = currentTimeMillis - this.f26234b;
            this.f26234b = currentTimeMillis;
            if (j3 > 50) {
                j3 = 50;
            }
