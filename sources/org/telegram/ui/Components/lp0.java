...
public final class lp0 {
    ...
    public lp0(View view) {
        ...
        this.f26223b = System.currentTimeMillis();
        this.f26222a = nuVar;
        this.f26224c = AndroidUtilities.lerp(5.0f, 9.0f, Utilities.clamp01(Utilities.fastRandom.nextFloat()));
    ...
    public final void a(Canvas canvas, float f7) {
        nu nuVar;
        float currentTimeMillis = ((float) (System.currentTimeMillis() - this.f26223b)) / 1000.0f;
        canvas.translate(0.0f, 0.0f);
        canvas.rotate(((float) Math.sin(this.f26224c * currentTimeMillis * 3.141592653589793d)) * 1.0f * f7);
        ...
        canvas.translate(-0.0f, -0.0f);
        if (f7 > 0.0f && (nuVar = this.f26222a) != null) {
            nuVar.run();
        }
    }
}
