...
public final class lp0 extends xw0 {
    public boolean f26142a = false;
    public long f26143b = 0;
    ...
    @Override
    public final void d() {
        this.f26143b = System.currentTimeMillis();
        this.f26144c = true;
        invalidateSelf();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.f26144c) {
            ...
            long j3 = currentTimeMillis - this.f26143b;
            this.f26143b = currentTimeMillis;
            if (j3 > 50) {
                j3 = 50;
            }
