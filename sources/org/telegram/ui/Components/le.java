...
public final class le extends FrameLayout {
    public final Paint f28721a;
    public final RectF f28722b;
    public final org.telegram.ui.ActionBar.g6 f28723c;
    ...
    public le(ChatActivityEnterView chatActivityEnterView, Activity activity, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        this.f28723c = g6Var;
        this.f28721a = new Paint(1);
        this.f28722b = new RectF();
    }
        ...
        if (!chatActivityEnterView.f24621h5) {
            ...
            if (motionEvent.getAction() == 0) {
                    ...
                    if (!z4 || chatActivityEnterView.F3) {
                        ...
                        if (z4 && chatActivityEnterView.Z0) {
                            if (z4.d0(chatActivityEnterView.N, chatActivityEnterView.M2)) {
                                ...
                                z4.a0(chatActivityEnterView.N, 1, chatActivityEnterView.M2, new Utilities.Callback(this) {
                                    ...
                                    public final void run(Object obj) {
                                        ...
                                        switch (r2) {
                                            case 0:
                                                this.f28091b.d.T0(0, true, 0, false, l10.longValue());
                                                return;
                                            case 1:
                                                this.f28091b.d.T0(0, true, 0, false, l10.longValue());
                                                return;
                            ...
                            if (chatActivityEnterView.B2 && chatActivityEnterView.c()) {
                                ...
                                org.telegram.ui.ActionBar.g6 g6Var = this.f28723c;
                            ...
                            if (z4.d0(chatActivityEnterView.N, chatActivityEnterView.M2)) {
                                if (chatActivityEnterView.Z0) {
                                    ...
                                    ChatActivityEnterView.SlideTextView slideTextView3 = chatActivityEnterView.f24611g1;
                        ...
                        chatActivityEnterView.f24590d0 = false;
                        Runnable runnable = new Runnable(this) {
                            public final le f28400b;
                            ...
                            public final void run() {
                                switch (r2) {
                                    case 0:
                                        ChatActivityEnterView chatActivityEnterView2 = this.f28400b.d;
                                        chatActivityEnterView2.f24585c0 = null;
                                        chatActivityEnterView2.L1(1, true);
                                        return;
                                    default:
                                        ChatActivityEnterView chatActivityEnterView3 = this.f28400b.d;
                                        chatActivityEnterView3.f24585c0 = null;
                                        chatActivityEnterView3.L1(1, true);
                                        return;
                                }
                            }
                        };
                        chatActivityEnterView.f24585c0 = runnable;
                ...
                if (motionEvent.getAction() == 2 && chatActivityEnterView.B2) {
                    ...
                    boolean z10 = chatActivityEnterView2.f24656o4;
                    if (!z10) {
                        if (!z10) {
                            if (chatActivityEnterView2.f24620h4 == -1.0f) {
                                chatActivityEnterView2.f24614g4 = y10;
                            }
                            chatActivityEnterView2.f24620h4 = y10;
                            recordCircle.invalidate();
                            if (!chatActivityEnterView2.f24651n4 && chatActivityEnterView2.f24608f4 >= 0.7f && chatActivityEnterView2.f24614g4 - chatActivityEnterView2.f24620h4 >= AndroidUtilities.dp(57.0f)) {
                                chatActivityEnterView2.f24656o4 = true;
                                ...
                                if (igVar != null && MessagesController.getGlobalMainSettings().getInt("voicepausehint", 0) <= 3) {
                                    ...
                                    igVar.f27803a = e3Var;
                                    e3Var.l(1.0f, 0.0f);
                                    igVar.f27803a.p(true);
                                    igVar.f27803a.s(LocaleController.getString(R.string.VoicePauseHint));
                                    ...
                                    igVar.addView(igVar.f27803a, k7.c6.d(-1, -1.0f, 119, 0.0f, 0.0f, 54.0f, 58.0f));
                                    qh.e3 e3Var2 = igVar.f27803a;
                                    e3Var2.f45272i0 = new gg(igVar, e3Var2, 3);
                                    e3Var2.u();
                                }
                            } else {
                                ...
                                if (chatActivityEnterView3.f24575a4 && chatActivityEnterView3.f24588c4 == 0.0f && f14 > recordCircle2.B) {
                                    f10 = 1.0f;
                                    chatActivityEnterView3.f24582b4 = System.currentTimeMillis();
                                } else {
                                    f10 = 1.0f;
                                }
                                if (chatActivityEnterView.f24714z2 == -1.0f) {
                                    chatActivityEnterView.f24714z2 = x10;
                                    float measuredWidth = (float) (chatActivityEnterView.f24623i1.getMeasuredWidth() * 0.35d);
                                ...
                                float f15 = chatActivityEnterView.f24714z2;
                                ...
                                if (f15 != -1.0f) {
                                    ...
                                    ChatActivityEnterView.SlideTextView slideTextView4 = chatActivityEnterView.f24611g1;
                                    if (slideTextView4 != null) {
                                        slideTextView4.f24733r = f11;
                                    }
                ...
                if (chatActivityEnterView.f24608f4 < 0.7f) {
                    if (chatActivityEnterView.a2 && chatActivityEnterView.Z0) {
                        CameraController.getInstance().cancelOnInitRunnable(reVar);
                    ...
                    chatActivityEnterView.f24605f1 = j13;
                    chatActivityEnterView.B2 = false;
                    chatActivityEnterView.L1(5, true);
                    return false;
                }
                chatActivityEnterView.f24656o4 = true;
                ChatActivityEnterView.m(chatActivityEnterView);
                return false;
            } else {
                ChatActivityEnterView.RecordCircle recordCircle3 = chatActivityEnterView.J1;
                if ((recordCircle3 != null && ChatActivityEnterView.this.f24656o4) || ((aeVar = chatActivityEnterView.f24579b1) != null && aeVar.getVisibility() == 0)) {
                    if (chatActivityEnterView.E3) {
                        AndroidUtilities.cancelRunOnUIThread(zfVar);
                    }
                } else if ((((leVar.getX() + motionEvent.getX()) - chatActivityEnterView.f24714z2) / chatActivityEnterView.A2) + 1.0f < 0.45d) {
                    if (chatActivityEnterView.a2 && chatActivityEnterView.Z0) {
                        CameraController.getInstance().cancelOnInitRunnable(reVar);
                    ...
                    chatActivityEnterView.f24605f1 = j12;
                    chatActivityEnterView.B2 = false;
                    chatActivityEnterView.L1(5, true);
                    return true;
                } else if (chatActivityEnterView.E3) {
                    AndroidUtilities.cancelRunOnUIThread(zfVar);
                    if (chatActivityEnterView.f24689v0 && chatActivityEnterView.f24684u0) {
                    ...
                    if (!z11 || chatActivityEnterView.F3) {
                        ...
                        if (z11 && chatActivityEnterView.Z0) {
                            if (z4.d0(chatActivityEnterView.N, chatActivityEnterView.M2)) {
                                ChatActivityEnterView.SlideTextView slideTextView5 = chatActivityEnterView.f24611g1;
                            ...
                            j10 = 0;
                            if (!chatActivityEnterView.f24689v0) {
                                chatActivityEnterView.V2.s2();
                                ...
                                MediaController.getInstance().toggleRecordingPause(chatActivityEnterView.L);
                                chatActivityEnterView.V2.e1(0);
                                ChatActivityEnterView.SlideTextView slideTextView6 = chatActivityEnterView.f24611g1;
                                ...
                                if (chatActivityEnterView.B2 && chatActivityEnterView.c()) {
                                    ...
                                    k2 k2Var2 = new k2(10);
                                    jc jcVar2 = new jc(4);
                                    org.telegram.ui.ActionBar.g6 g6Var2 = this.f28723c;
                        ...
                        Runnable runnable2 = new Runnable(this) {
                            ...
                            public final void run() {
                                switch (r2) {
                                    case 0:
                                        ChatActivityEnterView chatActivityEnterView22 = this.f28400b.d;
                                        chatActivityEnterView22.f24585c0 = null;
                                        chatActivityEnterView22.L1(1, true);
                                        return;
                                    default:
                                        ChatActivityEnterView chatActivityEnterView32 = this.f28400b.d;
                                        chatActivityEnterView32.f24585c0 = null;
                                        chatActivityEnterView32.L1(1, true);
                                        return;
                                }
                            }
                        };
                        chatActivityEnterView.f24585c0 = runnable2;
                        if (chatActivityEnterView.f24688u4) {
                            j11 = 500;
                        } else {
                            j11 = j10;
                        }
