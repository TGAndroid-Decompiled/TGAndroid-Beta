...
public final class le extends FrameLayout {
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        switch (this.f26073a) {
            case 0:
                ChatActivityEnterView chatActivityEnterView = this.f26074b;
                ei.f4 f4Var = chatActivityEnterView.f22001k0;
                if (f4Var != null && f4Var.getVisibility() == 0) {
                    return chatActivityEnterView.f22001k0.dispatchTouchEvent(motionEvent);
                }
                return super.dispatchTouchEvent(motionEvent);
            case 1:
                ChatActivityEnterView chatActivityEnterView2 = this.f26074b;
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        switch (this.f26073a) {
            case 1:
                ChatActivityEnterView chatActivityEnterView = this.f26074b;
                if (view == chatActivityEnterView.J0 && chatActivityEnterView.f21984h0) {
                    return true;
                }
