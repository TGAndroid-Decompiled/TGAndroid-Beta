...
public final class le extends FrameLayout {
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        switch (this.f26080a) {
            case 0:
                ChatActivityEnterView chatActivityEnterView = this.f26081b;
            ...
            case 1:
                ChatActivityEnterView chatActivityEnterView2 = this.f26081b;
