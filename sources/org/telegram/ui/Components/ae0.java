...
public class ae0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final int[] f22655a0 = {R.id.passcode_btn_0, R.id.passcode_btn_1, R.id.passcode_btn_2, R.id.passcode_btn_3, R.id.passcode_btn_4, R.id.passcode_btn_5, R.id.passcode_btn_6, R.id.passcode_btn_7, R.id.passcode_btn_8, R.id.passcode_btn_9, R.id.passcode_btn_backspace, R.id.passcode_btn_fingerprint};
    ...
    public final int[] W;
    public Drawable f22656a;
    public final FrameLayout f22657b;
    public final TextView f22658c;
    public final FrameLayout d;
    public final ai.x5 e;
    public final ArrayList f22659f;
    public final FrameLayout h;
    public final yd0 f22660n;
    public final EditTextBoldCursor f22661r;
    public final ci.m9 f22662s;
    public final ci.n6 v;
    public final TextView f22663w;
    public final TextView f22664x;
    public final ImageView f22665y;
    ...
    public ae0(Context context) {
        ...
        this.f22661r = editTextBoldCursor;
                        ...
                        if (ae0Var.U) {
                            ...
                            switch (intValue) {
                                ...
                                case 10:
                                    ...
                                    break;
                                case 11:
                                    ArrayList arrayList = (ArrayList) m9Var2.f5051c;
                                    Property property = View.TRANSLATION_Y;
                                    Property property2 = View.ALPHA;
                                    Property property3 = View.SCALE_Y;
                                    Property property4 = View.SCALE_X;
                                    ArrayList arrayList2 = (ArrayList) m9Var2.f5050b;
        ...
        while (true) {
            ...
            yd0Var.setTag(Integer.valueOf(i11));
            if (i11 == 11) {
                ...
                yd0Var.setContentDescription(i11 + "");
                yd0Var.setNum(i11);
                if (i11 == 0) {
            ...
            yd0Var.setId(iArr[i11]);
            yd0Var.setOnClickListener(new View.OnClickListener(this) {
                public final ae0 f27849b;
            ...
            this.f22659f.add(yd0Var);
            i11++;
        }
        for (i10 = 11; i10 >= 0; i10--) {
            this.e.addView((FrameLayout) this.f22659f.get(i10), w7.y5.e(60, 60, 51));
        }
        d();
    }
    ...
    public static void a(ae0 ae0Var) {
        ...
        float f7;
        float f10;
        FrameLayout frameLayout = ae0Var.f22657b;
        ci.m9 m9Var = ae0Var.f22662s;
    ...
    public final void b(kc0 kc0Var) {
        ...
        kVar2.f15522u = org.telegram.ui.Cells.c1.m(100.0f, 300.0f, 1.0f);
        this.L = kVar2;
        kVar2.a(new ei.m4(4, this, kc0Var));
        this.L.b(new j7(kc0Var, 4));
        this.L.f();
    }
    ...
    public final void c() {
        ...
        ce0 ce0Var;
        if (Build.VERSION.SDK_INT >= 23 && (findActivity = AndroidUtilities.findActivity(getContext())) != null && this.f22660n.getVisibility() == 0 && !ApplicationLoader.mainInterfacePaused) {
            if (findActivity instanceof LaunchActivity) {
                LaunchActivity launchActivity = (LaunchActivity) findActivity;
                ArrayList arrayList = launchActivity.B0;
                if (arrayList.isEmpty() && (ce0Var = launchActivity.A0) != null) {
                    if (this != ce0Var.f23273b) {
                        return;
                    }
    ...
    public final void d() {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.ae0.d():void");
    }
    ...
    public final void e() {
        ...
        EditTextBoldCursor editTextBoldCursor = this.f22661r;
        FrameLayout frameLayout = this.h;
        org.telegram.ui.Cells.u6 u6Var = this.R;
        TextView textView = this.f22664x;
        if (j10 > 0) {
    ...
    public final boolean g() {
        ...
        if (j4Var != null && j4Var.c()) {
            AndroidUtilities.hideKeyboard(this.f22661r);
            return false;
        }
        return true;
    }
    ...
    public final void i() {
        e();
        if (this.f22664x.getVisibility() != 0) {
            if (SharedConfig.passcodeType == 1) {
                EditTextBoldCursor editTextBoldCursor = this.f22661r;
    ...
    public final void j(boolean z10, int i10, int i11, org.telegram.ui.r80 r80Var) {
        ...
        if (z12) {
            ...
            this.f22656a = org.telegram.ui.ActionBar.j6.r0();
            ...
            if (org.telegram.ui.ActionBar.j6.W && !"CJz3BZ6YGEYBAAAABboWp6SAv04".equals(org.telegram.ui.ActionBar.j6.H0()) && !"qeZWES8rGVIEAAAARfWlK1lnfiI".equals(org.telegram.ui.ActionBar.j6.H0())) {
                ...
                if (!"d".equals(org.telegram.ui.ActionBar.j6.H0())) {
                    ...
                    if (!org.telegram.ui.ActionBar.j6.f19197j0 && !"CJz3BZ6YGEYBAAAABboWp6SAv04".equals(H0) && !"qeZWES8rGVIEAAAARfWlK1lnfiI".equals(H0)) {
        ...
        Drawable drawable = this.f22656a;
        if (drawable instanceof kc0) {
            kc0 kc0Var = (kc0) drawable;
            ...
            this.f22656a = new kc0(false, iArr[0], iArr[1], iArr[2], iArr[3]);
            if (kc0Var.f25755u != null && kc0Var.f25751q < 0) {
                n6Var.setBackgroundColor(2130706432);
            } else {
                n6Var.setBackgroundColor(570425344);
            }
            ((kc0) this.f22656a).r(n6Var);
        }
        this.f22663w.setText(LocaleController.getString(R.string.AppLocked));
        int i16 = SharedConfig.passcodeType;
        ImageView imageView = this.E;
        ImageView imageView2 = this.f22665y;
        ai.x5 x5Var = this.e;
        ci.m9 m9Var = this.f22662s;
        if (i16 == 0) {
            if (textView.getVisibility() != 0) {
            ...
            imageView.setVisibility(this.f22660n.getVisibility());
        }
        setVisibility(0);
    ...
    public final void k(boolean z10) {
        ...
        if (!z10) {
            if (SharedConfig.passcodeRetryInMs <= 0) {
                ...
                FrameLayout frameLayout = this.f22657b;
                if (length == 0) {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        TextView textView = this.f22663w;
        int[] iArr = this.W;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i23 = 0; i23 < 12; i23++) {
            ...
            FrameLayout frameLayout3 = (FrameLayout) this.f22659f.get(i23);
