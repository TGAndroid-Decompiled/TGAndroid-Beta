...
public final class r extends sa implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final FrameLayout f28338a0;
    public final ph.d f28339b0;
    public w51 f28340c0;
    public int f28341d0;
    public final TL_aicompose.aiComposeToneExample[] f28342e0;
    ...
    public r(Context context, TL_aicompose.AiComposeTone aiComposeTone, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f28342e0 = aicomposetoneexampleArr;
        ...
        rl0Var.setPadding(i13, 0, i13, AndroidUtilities.dp(66.0f));
    ...
    public static void P(r rVar, TL_aicompose.AiComposeTone aiComposeTone, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        if (dVar.T && !dVar.K) {
            ...
            ConnectionsManager.getInstance(rVar.currentAccount).sendRequestTyped(savetone, new Object(), new kh.a0(rVar, f6Var, aiComposeTone, 6));
        }
    }
    ...
    public static void Q(final r rVar) {
        ...
        int i10 = rVar.f28341d0 + 1;
        rVar.f28341d0 = i10;
        TL_aicompose.aiComposeToneExample[] aicomposetoneexampleArr = rVar.f28342e0;
        if (i10 >= aicomposetoneexampleArr.length) {
            rVar.f28341d0 = 0;
        }
        final int i11 = rVar.f28341d0;
            ...
            ConnectionsManager.getInstance(rVar.currentAccount).sendRequestTyped(gettoneexample, new Object(), new Utilities.Callback2() {
                ...
                public final void run(Object obj, Object obj2) {
                    ...
                    if (aicomposetoneexample != null) {
                        rVar2.f28342e0[i11] = aicomposetoneexample;
                        rVar2.f28340c0.N(true);
                        return;
                    }
                    rVar2.getClass();
                }
    ...
    public static void R(r rVar, ArrayList arrayList, w51 w51Var) {
        ...
        if (aiComposeTone instanceof TL_aicompose.TL_aiComposeTone) {
            ...
            TL_aicompose.aiComposeToneExample aicomposetoneexample = rVar.f28342e0[rVar.f28341d0];
            w51Var.U();
            ...
            if (user == null) {
                ...
                if (TextUtils.isEmpty(publicUsername)) {
                    ...
                    formatString = LocaleController.formatString(R.string.AIEditorCreatedBy, vh.w2.e("@", publicUsername));
                }
                sb.append(formatString);
                arrayList.add(i51.B(AndroidUtilities.replaceSingleLink(sb.toString(), rVar.getThemedColor(org.telegram.ui.ActionBar.j6.f19941gc), new org.telegram.ui.np(7, rVar, tL_aiComposeTone))));
            }
        }
    ...
    public static void S(r rVar, org.telegram.ui.ActionBar.f6 f6Var, TL_aicompose.AiComposeTone aiComposeTone, TLRPC.TL_error tL_error) {
        FrameLayout frameLayout = rVar.f28338a0;
        rVar.f28339b0.setLoading(false);
        if (tL_error != null) {
    ...
    public final boolean U() {
        ...
        if (aiComposeTone instanceof TL_aicompose.TL_aiComposeTone) {
            ...
            while (true) {
                ...
                if ((aiComposeTone2 instanceof TL_aicompose.TL_aiComposeTone) && ((TL_aicompose.TL_aiComposeTone) aiComposeTone2).f19368id == tL_aiComposeTone.f19368id) {
                    return true;
                }
                i10++;
            }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.loadedAiComposeTones) {
            ...
            this.f28339b0.setText(LocaleController.getString(i12));
        }
    }
