...
public final class qz extends View {
    public final Paint f27690a;
    public final Paint f27691b;
    public final Path f27692c;
    public int d;
    public int e;
    public u01[] f27693f;
    public RectF[] h;
    public float f27694n;
    public org.telegram.ui.zo0 f27695r;
    public int f27696s;

    public qz(Context context) {
        super(context);
        this.f27690a = new Paint(1);
        this.f27691b = new Paint(1);
        this.f27692c = new Path();
        this.d = -1;
        this.e = -1;
        this.f27696s = -1;
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int dp = AndroidUtilities.dp(4.0f) + org.telegram.messenger.l0.D(24.0f, this.f27693f.length, AndroidUtilities.dp(4.0f));
        int i10 = 0;
        while (true) {
            u01[] u01VarArr = this.f27693f;
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(18.0f), AndroidUtilities.dp(18.0f), this.f27690a);
        float dp5 = f7 + AndroidUtilities.dp(16.0f);
        for (int i11 = 0; i11 < this.f27693f.length; i11++) {
            this.h[i11].set(dp5 - AndroidUtilities.dp(16.0f), dp2, this.f27693f[i11].l() + dp5 + AndroidUtilities.dp(16.0f), dp3);
            dp5 += this.f27693f[i11].l() + AndroidUtilities.dp(24.0f);
        }
        AndroidUtilities.dp(4.0f);
        int clamp = Utilities.clamp((int) Math.floor(this.f27694n), this.f27693f.length - 1, 0);
        int clamp2 = Utilities.clamp((int) Math.ceil(this.f27694n), this.f27693f.length - 1, 0);
        float dp6 = this.h[clamp].left + AndroidUtilities.dp(4.0f);
        float dp7 = this.h[clamp2].left + AndroidUtilities.dp(4.0f);
        float f10 = this.f27694n;
        ...
        Path path = this.f27692c;
        path.rewind();
        path.addRoundRect(rectF2, AndroidUtilities.dp(15.0f), AndroidUtilities.dp(15.0f), Path.Direction.CW);
        canvas.drawRoundRect(rectF2, AndroidUtilities.dp(15.0f), AndroidUtilities.dp(15.0f), this.f27691b);
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        int i10 = 0;
        if (this.f27693f == null || this.h == null) {
            return false;
        }
        while (true) {
        ...
        if (i10 >= 0 && i10 != this.f27696s) {
            this.f27696s = i10;
            org.telegram.ui.zo0 zo0Var = this.f27695r;
            if (zo0Var != null) {
    ...
    public void setBackgroundColor(int i10) {
        this.f27690a.setColor(i10);
        invalidate();
    }

    public void setSelected(float f7) {
        if (Math.abs(f7 - this.f27694n) > 0.001f) {
            invalidate();
        }
        this.f27694n = f7;
    }
    ...
    public void setTabs(CharSequence... charSequenceArr) {
        this.f27693f = new u01[charSequenceArr.length];
        this.h = new RectF[charSequenceArr.length];
        for (int i10 = 0; i10 < charSequenceArr.length; i10++) {
            this.f27693f[i10] = new u01(charSequenceArr[i10], 14.0f, AndroidUtilities.bold());
