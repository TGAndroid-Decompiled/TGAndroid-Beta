...
public final class qz extends View {
    public final Paint f27475a;
    public final Paint f27476b;
    public final Path f27477c;
    public int d;
    public int e;
    public g01[] f27478f;
    public RectF[] h;
    public float f27479n;
    public org.telegram.ui.yo0 f27480r;
    public int f27481s;

    public qz(Context context) {
        super(context);
        this.f27475a = new Paint(1);
        this.f27476b = new Paint(1);
        this.f27477c = new Path();
        this.d = -1;
        this.e = -1;
        this.f27481s = -1;
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int dp = AndroidUtilities.dp(4.0f) + org.telegram.messenger.w1.D(24.0f, this.f27478f.length, AndroidUtilities.dp(4.0f));
        int i10 = 0;
        while (true) {
            g01[] g01VarArr = this.f27478f;
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(18.0f), AndroidUtilities.dp(18.0f), this.f27475a);
        float dp5 = f7 + AndroidUtilities.dp(16.0f);
        for (int i11 = 0; i11 < this.f27478f.length; i11++) {
            this.h[i11].set(dp5 - AndroidUtilities.dp(16.0f), dp2, this.f27478f[i11].l() + dp5 + AndroidUtilities.dp(16.0f), dp3);
            dp5 += this.f27478f[i11].l() + AndroidUtilities.dp(24.0f);
        }
        AndroidUtilities.dp(4.0f);
        int clamp = Utilities.clamp((int) Math.floor(this.f27479n), this.f27478f.length - 1, 0);
        int clamp2 = Utilities.clamp((int) Math.ceil(this.f27479n), this.f27478f.length - 1, 0);
        float dp6 = this.h[clamp].left + AndroidUtilities.dp(4.0f);
        float dp7 = this.h[clamp2].left + AndroidUtilities.dp(4.0f);
        float f10 = this.f27479n;
        ...
        Path path = this.f27477c;
        path.rewind();
        path.addRoundRect(rectF2, AndroidUtilities.dp(15.0f), AndroidUtilities.dp(15.0f), Path.Direction.CW);
        canvas.drawRoundRect(rectF2, AndroidUtilities.dp(15.0f), AndroidUtilities.dp(15.0f), this.f27476b);
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        int i10 = 0;
        if (this.f27478f == null || this.h == null) {
            return false;
        }
        while (true) {
        ...
        if (i10 >= 0 && i10 != this.f27481s) {
            this.f27481s = i10;
            org.telegram.ui.yo0 yo0Var = this.f27480r;
            if (yo0Var != null) {
    ...
    public void setBackgroundColor(int i10) {
        this.f27475a.setColor(i10);
        invalidate();
    }

    public void setSelected(float f7) {
        if (Math.abs(f7 - this.f27479n) > 0.001f) {
            invalidate();
        }
        this.f27479n = f7;
    }
    ...
    public void setTabs(CharSequence... charSequenceArr) {
        this.f27478f = new g01[charSequenceArr.length];
        this.h = new RectF[charSequenceArr.length];
        for (int i10 = 0; i10 < charSequenceArr.length; i10++) {
            this.f27478f[i10] = new g01(charSequenceArr[i10], 14.0f, AndroidUtilities.bold());
