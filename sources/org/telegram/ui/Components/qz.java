...
public class qz extends s4.s {
    ...
    public qz(int i10, int i11, xl0 xl0Var) {
        super(i10);
    ...
    public final void B1() {
        ...
        int i10;
        xl0 xl0Var2;
        if (this.S > 0 && D1() && (adapter = (xl0Var = this.V).getAdapter()) != null) {
            int i11 = this.J;
            int h = adapter.h() - 1;
            g.p pVar = this.O;
            int i12 = 0;
            ...
            this.R = Math.max(0, ((this.S - i14) - i10) - xl0Var2.getPaddingBottom());
        }
    }
