...
public final class ti extends vl0 {
    ...
    public final int h() {
        int i10 = this.I;
        wi wiVar = this.J;
        if (wiVar.H1 == null && (wiVar.f29985f0 instanceof org.telegram.ui.wn) && !wiVar.H) {
    ...
    public final int j(int i10) {
        ...
        if (i10 >= this.e && i10 < this.f28514f) {
            return 1;
        }
        return 0;
    }
    ...
    public final void l() {
        ...
        if (wiVar.H) {
            ...
            z10 = (i27 == null || ((org.telegram.ui.wn) m2Var).getMessagesController().getSendPaidMessagesStars(i27.f18468id) <= 0) ? false : false;
            int i28 = this.I;
            this.I = i28 + 1;
            this.d = i28;
