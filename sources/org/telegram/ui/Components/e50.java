...
public final class e50 {
    ...
    public final FloatBuffer f24475g;
    public final FloatBuffer h;
    public final int[] f24478k;
    public final d50 f24473c = new d50(R.raw.round_blur_stage_0_frag);
    public final d50 d = new d50(R.raw.round_blur_stage_3_frag);
    public final b50 e = new b50();
    public final c50 f24474f = new c50();
    public int f24476i = 0;
    public final int[] f24477j = new int[1];
    ...
    public e50(int i10, int i11) {
        ...
        for (int i19 = 5; i18 < i19; i19 = 5) {
            GLES20.glBindTexture(3553, this.f24478k[i18]);
            if (i18 < 2) {
                i12 = 9729;
            } else {
                i12 = 9728;
            ...
            if (i18 == 4) {
                ...
                float c3 = vh.w2.c(i21, this.f24471a, 2.0f, -1.0f);
                ...
                float f10 = (round3 / this.f24471a) * 2.0f;
        ...
        GLES20.glGenFramebuffers(1, this.f24477j, 0);
    ...
    public final void b() {
        ...
        this.f24474f.a();
        this.d.a();
        GLES20.glDeleteTextures(5, this.f24478k, 0);
        GLES20.glDeleteFramebuffers(1, this.f24477j, 0);
    }
}
