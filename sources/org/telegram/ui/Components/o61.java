...
public class o61 extends FrameLayout {
    public ValueAnimator f27455a;
    public float f27456b;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (!q61Var.P) {
            if (f10 != 1.0f) {
                org.telegram.ui.ActionBar.j6.f20185t0.setColor(q61Var.C);
            ...
            org.telegram.ui.ActionBar.j6.f20185t0.setColor(org.telegram.ui.ActionBar.j6.w0(null, q61Var.F, false));
        ...
        if (bool == null || bool.booleanValue() != z4) {
            if (AndroidUtilities.computePerceivedBrightness(q61Var.getThemedColor(org.telegram.ui.ActionBar.j6.f19977h5)) > 0.721f) {
                z10 = true;
            } else {
                z10 = false;
            }
            if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.v(q61Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20176s8), 855638016)) > 0.721f) {
                z11 = true;
            }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (z4) {
            ...
            int i15 = q61Var.f28074y;
            if (i15 != 0) {
                float f10 = i15;
                this.f27456b = f10;
                setTranslationY(f10);
                ValueAnimator valueAnimator = this.f27455a;
                if (valueAnimator != null) {
                    valueAnimator.removeAllListeners();
                    this.f27455a.cancel();
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f27456b, 0.0f);
                this.f27455a = ofFloat;
                ofFloat.addUpdateListener(new h61(1, this));
                this.f27455a.setDuration(250L);
                this.f27455a.setInterpolator(org.telegram.ui.ActionBar.r1.f20543w);
                this.f27455a.addListener(new nd0(this, 27));
                this.f27455a.start();
            } else if (this.f27455a != null) {
                setTranslationY(this.f27456b);
            }
        } else {
