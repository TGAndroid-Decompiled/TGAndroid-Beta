...
public abstract class o61 extends org.telegram.ui.ActionBar.f3 {
    ...
    public final FrameLayout f26702c;
    public final ai.w0 d;
    public kl0 e;
    public kl0 f26703f;
    public final Drawable h;
    public final View f26704n;
    public AnimatorSet f26705r;
    public final yw0 f26706s;
    public final t00 v;
    public final n61 f26707w;
    public final RectF f26708x;
    public int f26709y;
    ...
    public o61(Context context, int i10, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.f26708x = new RectF();
        this.G = true;
        this.H = true;
        this.I = org.telegram.ui.ActionBar.i6.Ii;
        this.J = org.telegram.ui.ActionBar.i6.f18923i6;
        ...
        org.telegram.ui.ActionBar.e6 e6Var2 = yw0Var.f30419n;
    ...
    public final void F(boolean z10) {
        ...
        if ((z10 && view.getTag() != null) || (!z10 && view.getTag() == null)) {
            ...
            AnimatorSet animatorSet = this.f26705r;
            if (animatorSet != null) {
                animatorSet.cancel();
            }
            AnimatorSet animatorSet2 = new AnimatorSet();
            this.f26705r = animatorSet2;
            ...
            this.f26705r.setDuration(150L);
            this.f26705r.addListener(new aa(24, this, z10));
            this.f26705r.start();
        }
    }
    ...
    public void I(int i10) {
        ...
        float f7 = i10;
        this.f26702c.setTranslationY(f7);
        this.f26706s.setTranslationY(f7);
        this.containerView.invalidate();
    }
    ...
    public void L() {
        ...
        if (w0Var.getChildCount() > 0) {
            s4.c1 K = w0Var.K(0);
            if (K != null) {
                i10 = K.f42671a.getTop() - AndroidUtilities.dp(8.0f);
            } else {
                i10 = 0;
            }
    ...
    @Override
    public void dismiss() {
        AndroidUtilities.hideKeyboard(this.f26707w.J);
        super.dismiss();
    }
    ...
    public final void setTitle(CharSequence charSequence) {
        ...
        if (this.f26701b == null) {
            ...
            this.f26701b = textView;
            textView.setTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18940j5, this.resourcesProvider));
            this.f26701b.setTextSize(1, 20.0f);
            this.f26701b.setTypeface(AndroidUtilities.bold());
            this.f26701b.setLines(1);
            this.f26701b.setMaxLines(1);
            this.f26701b.setSingleLine(true);
            TextView textView2 = this.f26701b;
            ...
            this.f26701b.setEllipsize(TextUtils.TruncateAt.END);
            TextView textView3 = this.f26701b;
            FrameLayout.LayoutParams d = w7.x5.d(-1, 36.0f, 51, 16.0f, 0.0f, 0.0f, 0.0f);
            FrameLayout frameLayout = this.f26702c;
            frameLayout.addView(textView3, d);
            ((FrameLayout.LayoutParams) this.f26707w.getLayoutParams()).topMargin = AndroidUtilities.dp(30.0f);
            frameLayout.getLayoutParams().height = AndroidUtilities.dp(94.0f);
        }
        this.f26701b.setText(charSequence);
    }
