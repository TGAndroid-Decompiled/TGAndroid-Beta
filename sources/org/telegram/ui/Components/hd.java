...
public final class hd implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f25392a) {
            case 0:
                ChatActivityEnterView.g((ChatActivityEnterView) this.f25397r, (TLRPC.Document) this.f25398s, this.f25396n, (MessageObject.SendAnimationData) this.v, this.f25394c, this.d, this.e, this.f25393b, this.h, this.f25395f);
                return;
            default:
                MediaController.PhotoEntry photoEntry = (MediaController.PhotoEntry) this.f25398s;
                ChatActivityEnterView chatActivityEnterView = ((xf) this.f25397r).f30668a;
                boolean z10 = chatActivityEnterView.f22850v3;
                ...
                boolean z13 = this.f25394c;
                int i10 = this.d;
                int i11 = this.e;
                Long l10 = this.h;
                int i12 = i10;
                String str3 = this.f25396n;
                Object obj2 = this.v;
                if (z12) {
    ...
    public hd(ChatActivityEnterView chatActivityEnterView, TLRPC.Document document, String str, MessageObject.SendAnimationData sendAnimationData, boolean z4, int i10, int i11, Object obj, Long l10, boolean z10) {
        this.f25397r = chatActivityEnterView;
        this.f25398s = document;
        this.f25396n = str;
