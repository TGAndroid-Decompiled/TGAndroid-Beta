...
public abstract class k41 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final e6 P;
    public Boolean Q;
    public Integer f25577b;
    public final CharSequence f25578c;
    public final TLRPC.InputPeer d;
    public final int e;
    public final boolean f25579f;
    public final TL_iv.RichMessage h;
    public final RichMessageLayout.PreviewView f25580n;
    public final RichMessageLayout.PreviewView f25581r;
    public final String f25582s;
    public String v;
    public String f25583w;
    public final i41 f25584x;
    public final bi.o f25585y;
    ...
    public k41(Context context, String str, String str2, CharSequence charSequence, TLRPC.InputPeer inputPeer, int i10, boolean z10, TL_iv.RichMessage richMessage) {
        ...
        l90Var.setHighlightColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19384uf));
        int themedColor = getThemedColor(org.telegram.ui.ActionBar.j6.f19401vf);
        try {
        ...
        RichMessageLayout.PreviewView previewView3 = this.f25581r;
        ...
        frameLayout.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19133h5));
    ...
    public static void m(k41 k41Var, TLRPC.TL_textWithEntities tL_textWithEntities, TLRPC.TL_textWithEntities tL_textWithEntities2, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && "TRANSLATIONS_DISABLED_ALT".equalsIgnoreCase(tL_error.text)) {
            ...
            g41 g41Var = k41Var.f25584x.e;
            String str = k41Var.f25583w;
            k41Var.v = str;
    ...
    public static void o(k41 k41Var, TLObject tLObject) {
        RichMessageLayout.PreviewView previewView = k41Var.f25581r;
        k41Var.f25577b = null;
    ...
    public static void p(k41 k41Var, String str, Boolean bool) {
        ...
        if (str != null) {
            ...
            xc xcVar = new xc((FrameLayout) k41Var.containerView, k41Var.resourcesProvider);
            if (bool.booleanValue()) {
                i10 = R.string.TranslationFailedAlert1;
            } else {
                i10 = R.string.TranslationFailedAlert2;
            }
            org.telegram.messenger.wh.o(i10, xcVar, null);
            g41 g41Var = k41Var.f25584x.e;
            String str2 = k41Var.f25583w;
            k41Var.v = str2;
    ...
    public static boolean u(k41 k41Var) {
        ...
        for (int i10 = 0; i10 < x31Var.getChildCount(); i10++) {
            View childAt = x31Var.getChildAt(i10);
            if (RecyclerView.S(childAt) == 1) {
                f7 += childAt.getHeight();
            }
        }
        if (f7 < (x31Var.getHeight() - x31Var.getPaddingTop()) - x31Var.getPaddingBottom()) {
            return false;
        }
        return true;
    }
    ...
    public final void M() {
        ...
        if (this.f25577b != null) {
            ConnectionsManager.getInstance(this.currentAccount).cancelRequest(this.f25577b.intValue(), true);
            this.f25577b = null;
        }
        ...
        if (richMessage != null && inputPeer != null) {
            ...
            tL_messages_translateRichMessage.f18417id.add(Integer.valueOf(i10));
            tL_messages_translateRichMessage.to_lang = TranslateController.normalizeLanguage(str);
            this.f25577b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_translateRichMessage, new x1(this, 16)));
            return;
        }
        TLRPC.TL_textWithEntities tL_textWithEntities = new TLRPC.TL_textWithEntities();
        CharSequence charSequence2 = this.f25578c;
        ...
        if (this.f25579f && inputPeer != null) {
            ...
            tL_messages_summarizeText.f18416id = i10;
            tL_messages_summarizeText.to_lang = TranslateController.normalizeLanguage(str);
            this.f25577b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequestTyped(tL_messages_summarizeText, new Object(), new ai.m0(13, this, tL_textWithEntities)));
            return;
        }
        ...
        if (inputPeer != null) {
            ...
            tL_messages_translateText.f18418id.add(Integer.valueOf(i10));
        } else {
            tL_messages_translateText.flags |= 2;
            tL_messages_translateText.text.add(tL_textWithEntities);
        }
        tL_messages_translateText.to_lang = TranslateController.normalizeLanguage(str);
        this.f25577b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_translateText, new org.telegram.ui.oo(17, this, tL_textWithEntities)));
    }
