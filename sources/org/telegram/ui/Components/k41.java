...
public final class k41 implements Runnable {
    public final int f25535a = 1;
    public final ArrayList f25536b;
    public final ArrayList f25537c;
    public final Object d;
    public final Object e;
    public final Serializable f25538f;
    public final Serializable h;
    public final Object f25539n;
    public final Object f25540r;
    public final Object f25541s;
    ...
    public k41(org.telegram.ui.zk zkVar, boolean[] zArr, String str, LinearLayout linearLayout, ArrayList arrayList, String str2, TranslateController translateController, org.telegram.ui.ActionBar.n1 n1Var, ArrayList arrayList2) {
        ...
        this.e = zArr;
        this.f25538f = str;
        this.f25539n = linearLayout;
        this.f25536b = arrayList;
        this.h = str2;
        this.f25540r = translateController;
        this.f25541s = n1Var;
    ...
    public final void run() {
        ...
        switch (this.f25535a) {
            case 0:
                ...
                String str = (String) this.f25538f;
                LinearLayout linearLayout = (LinearLayout) this.f25539n;
                String str2 = (String) this.h;
                final TranslateController translateController = (TranslateController) this.f25540r;
                final org.telegram.ui.ActionBar.n1 n1Var = (org.telegram.ui.ActionBar.n1) this.f25541s;
                boolean z11 = false;
                if (!zArr[0]) {
                    ...
                    ArrayList arrayList = this.f25536b;
                                    ...
                                    public final void onClick(View view) {
                                        switch (r5) {
                                            case 0:
                                                ...
                                                translateController.setDialogTranslateTo(zkVar2.f26064b, str3);
                                                n1Var.d(true);
                                                zkVar2.b();
                                                return;
                                            default:
                                                org.telegram.ui.zk zkVar3 = zkVar;
                                                translateController.setDialogTranslateTo(zkVar3.f26064b, str3);
                                                n1Var.d(true);
                                                zkVar3.b();
                                                return;
                                        }
                    ...
                    ArrayList arrayList2 = this.f25537c;
                                ...
                                f1Var4.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public final void onClick(View view) {
                                        switch (r5) {
                                            case 0:
                                                org.telegram.ui.zk zkVar2 = zkVar;
                                                translateController.setDialogTranslateTo(zkVar2.f26064b, str4);
                                                n1Var.d(true);
                                                zkVar2.b();
                                                return;
                                            default:
                                                org.telegram.ui.zk zkVar3 = zkVar;
                                                translateController.setDialogTranslateTo(zkVar3.f26064b, str4);
                                                n1Var.d(true);
                                                zkVar3.b();
                                                return;
                                        }
            ...
            default:
                ...
                ArrayList arrayList3 = (ArrayList) this.f25538f;
                ArrayList arrayList4 = (ArrayList) this.h;
                ArrayList arrayList5 = (ArrayList) this.f25539n;
                ArrayList arrayList6 = (ArrayList) this.f25540r;
                ArrayList arrayList7 = (ArrayList) this.f25541s;
                notificationsCustomSettingsActivity.getMessagesController().putUsers(this.f25536b, true);
                notificationsCustomSettingsActivity.getMessagesController().putChats(this.f25537c, true);
                notificationsCustomSettingsActivity.getMessagesController().putEncryptedChats((ArrayList) this.e, true);
                int i14 = notificationsCustomSettingsActivity.f30867s;
                if (i14 == 1) {
                    notificationsCustomSettingsActivity.f30868w = arrayList3;
                } else if (i14 == 0) {
                    notificationsCustomSettingsActivity.f30868w = arrayList4;
                } else if (i14 == 3) {
                    notificationsCustomSettingsActivity.f30868w = arrayList5;
                    notificationsCustomSettingsActivity.v = arrayList6;
                } else {
                    notificationsCustomSettingsActivity.f30868w = arrayList7;
                }
    ...
    public k41(NotificationsCustomSettingsActivity notificationsCustomSettingsActivity, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4, ArrayList arrayList5, ArrayList arrayList6, ArrayList arrayList7, ArrayList arrayList8) {
        ...
        this.f25537c = arrayList2;
        this.e = arrayList3;
        this.f25538f = arrayList4;
        this.h = arrayList5;
        this.f25539n = arrayList6;
        this.f25540r = arrayList7;
        this.f25541s = arrayList8;
    }
}
