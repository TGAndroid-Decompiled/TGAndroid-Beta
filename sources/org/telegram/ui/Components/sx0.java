...
public final class sx0 extends ll0 {
    ...
    public final SparseArray f27951f = new SparseArray();
    public int h;
    public int f27952n;
    public final wx0 f27953r;
    ...
    public final void l() {
        ...
        if (wx0Var.W != null) {
            ...
            sparseArray.clear();
            SparseArray sparseArray2 = this.f27951f;
            sparseArray2.clear();
            this.h = 0;
            this.f27952n = 0;
    ...
    public final void u(int i10) {
        ArrayList arrayList = this.f27953r.Y;
        if (arrayList != null) {
            this.h = arrayList.size();
        }
        super.u(i10);
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (arrayList != null) {
            ...
            ((org.telegram.ui.Cells.f8) view).d((TLRPC.Document) sparseArray.get(i10), null, this.f27951f.get(i10), null, false, false);
        } else if (wx0Var.X != null) {
            ((org.telegram.ui.Cells.f8) view).setSticker((SendMessagesHelper.ImportingSticker) wx0Var.Y.get(i10));
        } else if (c1Var.f42700f != 3) {
            org.telegram.ui.Cells.f8 f8Var = (org.telegram.ui.Cells.f8) view;
            TLRPC.TL_messages_stickerSet tL_messages_stickerSet = wx0Var.S;
            if (tL_messages_stickerSet != null) {
                f8Var.d(tL_messages_stickerSet.documents.get(i10), null, wx0Var.S, null, wx0Var.f29776h0, wx0Var.R);
        ...
        if (i10 == 0) {
            ...
            if (i10 != 1) {
                if (i10 == 2) {
                    ...
                    frameLayout2 = new org.telegram.ui.Cells.r3(8, this.f27950c, f6Var2, true, false);
                } else if (i10 == 3) {
