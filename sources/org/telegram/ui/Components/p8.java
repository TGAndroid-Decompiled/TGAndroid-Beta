...
public final class p8 implements org.telegram.ui.ActionBar.a2, lq {
    ...
    public void v0(int i10, int i11, boolean z10) {
        d9 d9Var = this.f27276b;
        if (i11 != 0) {
            if (i11 != 1) {
                if (i11 != 2) {
                    if (i11 == 3) {
                        z8 z8Var = d9Var.Y;
                        int i12 = z8Var.f30845f;
                        if (i12 != i10 && (i12 == 0 || i10 == 0)) {
                            z8 a2 = z8Var.a();
                            d9Var.Y = a2;
                            d9Var.f23604a.b(a2, true);
                            d9Var.n0();
                        }
                        d9Var.Y.f30845f = i10;
                    }
            ...
            z8 z8Var4 = d9Var.Y;
            int i15 = z8Var4.f30844c;
            if (i15 != i10 && (i15 == 0 || i10 == 0)) {
                z8 a12 = z8Var4.a();
                d9Var.Y = a12;
                d9Var.f23604a.b(a12, true);
                d9Var.n0();
            }
            d9Var.Y.f30844c = i10;
        }
