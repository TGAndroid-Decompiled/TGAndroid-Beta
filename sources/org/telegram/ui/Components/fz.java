...
public final class fz extends kl0 {
    ...
    public String N;
    public final kz Q;
    public final ez f24122c;
    public long d;
    public TLRPC.StickerSet e;
    public ArrayList f24123f;
    public final Context h;
    public int f24128x;
    public boolean f24129y;
    public final SparseArray f24124n = new SparseArray();
    public final SparseArray f24125r = new SparseArray();
    public final SparseArray f24126s = new SparseArray();
    public final SparseIntArray v = new SparseIntArray();
    public final SparseArray f24127w = new SparseArray();
    ...
    public fz(kz kzVar, Context context) {
        this.Q = kzVar;
        this.h = context;
        ?? aVar = new nh.a(context, kzVar.f25703c1, new d(this, 12), new lv(this, 3), kzVar.Z1);
        this.f24122c = aVar;
    ...
    public final int j(int i10) {
        ...
        if (i10 == 1 && this.f24128x == 1) {
            return 5;
        }
        Object obj = this.f24125r.get(i10);
        if (obj == null) {
            return 1;
        }
    ...
    public final void l() {
        ...
        this.P = -1;
        SparseArray sparseArray = this.f24124n;
        sparseArray.clear();
        SparseIntArray sparseIntArray = this.v;
        sparseIntArray.clear();
        SparseArray sparseArray2 = this.f24125r;
        sparseArray2.clear();
        SparseArray sparseArray3 = this.f24127w;
        sparseArray3.clear();
        this.f24128x = 0;
        int size = this.G.size() + this.E.size();
        this.f24122c.Y2.N(false);
        long j3 = this.d;
        String str = "";
        SparseArray sparseArray4 = this.f24126s;
        if (j3 != 0) {
            ArrayList arrayList = this.f24123f;
            int i15 = this.f24128x;
            this.f24128x = i15 + 1;
            sparseArray2.put(i15, "search");
            if (size > 0) {
                int i16 = this.f24128x;
                this.f24128x = i16 + 1;
                this.P = i16;
                sparseArray2.put(i16, "packs");
                int i17 = this.f24128x;
                this.f24128x = i17 + 1;
            ...
            if (str2 != null && !"".equals(str2)) {
                sparseArray3.put(this.f24128x, str2);
            }
            int size2 = arrayList.size();
            int i18 = 0;
            int i19 = 0;
            while (i18 < size2) {
                int i20 = this.f24128x + i19;
            ...
            this.f24128x = (ceil * bzVar.d) + this.f24128x;
        } else {
            ...
            int i24 = this.f24128x;
            this.f24128x = i24 + 1;
            sparseArray2.put(i24, "search");
            if (size > 0) {
                int i25 = this.f24128x;
                this.f24128x = i25 + 1;
                this.P = i25;
            ...
            if (!isEmpty) {
                ...
                while (i28 < size3) {
                    ...
                    if (str3 != null && !str.equals(str3)) {
                        sparseArray3.put(this.f24128x + i29, str3);
                        str = str3;
                    }
                ...
                this.f24128x = (bzVar.d * ceil2) + this.f24128x;
                i10 = i37 + ceil2;
            } else {
                i11 = i14;
                z11 = isEmpty;
            ...
            if (z12) {
                ...
                if (str5 != null) {
                    sparseArray3.put(this.f24128x, str5);
                }
                int size5 = this.K.size();
                int i41 = 0;
                for (int i42 = 0; i42 < size5; i42++) {
                    int i43 = this.f24128x + i41;
                ...
                this.f24128x = (ceil3 * bzVar.d) + this.f24128x;
            }
            if (z11 && !z12 && i12 == 0) {
                this.f24128x = 1;
            }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        kz kzVar = this.Q;
        LongSparseArray longSparseArray = kzVar.f25777z1;
        LongSparseArray longSparseArray2 = kzVar.f25774y1;
        int i12 = c1Var.f42678f;
        View view = c1Var.f42675a;
        SparseArray sparseArray = this.f24125r;
        boolean z11 = true;
        char c10 = 1;
        int i13 = 1;
        z11 = true;
        if (i12 != 0) {
            ...
            if (i12 != 1) {
                if (i12 != 2) {
                    if (i12 == 3) {
                        ...
                        if (longSparseArray2.indexOfKey(stickerSetCovered.set.f18139id) >= 0) {
                            z10 = true;
                        } else {
                            z10 = false;
                        }
                        if (longSparseArray.indexOfKey(stickerSetCovered.set.f18139id) < 0) {
                            c10 = 0;
                        }
                        if (z10 || c10 != 0) {
                            if (z10 && r3Var.f20795r) {
                                longSparseArray2.remove(stickerSetCovered.set.f18139id);
                                z10 = false;
                            } else if (c10 != 0 && !r3Var.f20795r) {
            ...
            if (i10 == this.f24128x) {
                ...
                Object obj2 = this.f24124n.get(i14);
                ...
                if (num == null) {
                    ...
                    int A = org.telegram.messenger.wl.A(82.0f, (int) Math.ceil(num.intValue() / kzVar.f25773y0.d), kzVar.h.getHeight());
                    if (A > 0) {
                        i13 = A;
                    }
                    k3Var.setHeight(i13);
        ...
        f8Var.d(document, null, this.f24126s.get(i10), (String) this.f24127w.get(i10), false, false);
        if (!kzVar.f25725j1.contains(document) && !kzVar.f25728k1.contains(document)) {
            z11 = false;
        }
        f8Var.setRecent(z11);
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                break;
            case 2:
                f2Var = new org.telegram.ui.Cells.o8(this.h, false, false, kzVar.Z1, kzVar.f25723i2);
                break;
            case 3:
            ...
            case 4:
                ...
                f2Var.setLayoutParams(new s4.p0(-1, kzVar.f25699b1));
                break;
            case 5:
