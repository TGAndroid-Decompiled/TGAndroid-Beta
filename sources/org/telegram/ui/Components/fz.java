...
public final class fz extends rl0 {
    ...
    public String K;
    public final kz N;
    public final ez f24992c;
    public long d;
    public TLRPC.StickerSet e;
    public ArrayList f24993f;
    public final Context h;
    public int f24998x;
    public boolean f24999y;
    public final SparseArray f24994n = new SparseArray();
    public final SparseArray f24995r = new SparseArray();
    public final SparseArray f24996s = new SparseArray();
    public final SparseIntArray v = new SparseIntArray();
    public final SparseArray f24997w = new SparseArray();
    ...
    public fz(kz kzVar, Context context) {
        this.N = kzVar;
        this.h = context;
        ?? bVar = new ah.b(context, kzVar.Z0, new d(this, 12), new fv(this, 3), kzVar.W1);
        this.f24992c = bVar;
        ...
        bVar.setOnTouchListener(new m.d2(this, 3));
    }
    ...
    public final int j(int i10) {
        ...
        if (i10 == 1 && this.f24998x == 1) {
            return 5;
        }
        Object obj = this.f24995r.get(i10);
        if (obj == null) {
            return 1;
        }
    ...
    public final void l() {
        ...
        this.M = -1;
        SparseArray sparseArray = this.f24994n;
        sparseArray.clear();
        SparseIntArray sparseIntArray = this.v;
        sparseIntArray.clear();
        SparseArray sparseArray2 = this.f24995r;
        sparseArray2.clear();
        SparseArray sparseArray3 = this.f24997w;
        sparseArray3.clear();
        this.f24998x = 0;
        int size = this.D.size() + this.B.size();
        this.f24992c.V2.N(false);
        long j10 = this.d;
        String str = "";
        SparseArray sparseArray4 = this.f24996s;
        if (j10 != 0) {
            ArrayList arrayList = this.f24993f;
            int i15 = this.f24998x;
            this.f24998x = i15 + 1;
            sparseArray2.put(i15, "search");
            if (size > 0) {
                int i16 = this.f24998x;
                this.f24998x = i16 + 1;
                this.M = i16;
                sparseArray2.put(i16, "packs");
                int i17 = this.f24998x;
                this.f24998x = i17 + 1;
            ...
            if (str2 != null && !"".equals(str2)) {
                sparseArray3.put(this.f24998x, str2);
            }
            int size2 = arrayList.size();
            int i18 = 0;
            int i19 = 0;
            while (i18 < size2) {
                int i20 = this.f24998x + i19;
            ...
            this.f24998x = (ceil * bzVar.d) + this.f24998x;
        } else {
            ...
            int i24 = this.f24998x;
            this.f24998x = i24 + 1;
            sparseArray2.put(i24, "search");
            if (size > 0) {
                int i25 = this.f24998x;
                this.f24998x = i25 + 1;
                this.M = i25;
            ...
            if (!isEmpty) {
                ...
                while (i28 < size3) {
                    ...
                    if (str3 != null && !str.equals(str3)) {
                        sparseArray3.put(this.f24998x + i29, str3);
                        str = str3;
                    }
                ...
                this.f24998x = (bzVar.d * ceil2) + this.f24998x;
                i10 = i37 + ceil2;
            } else {
                i11 = i14;
                z10 = isEmpty;
            ...
            if (z11) {
                ...
                if (str5 != null) {
                    sparseArray3.put(this.f24998x, str5);
                }
                int size5 = this.H.size();
                int i41 = 0;
                for (int i42 = 0; i42 < size5; i42++) {
                    int i43 = this.f24998x + i41;
                ...
                this.f24998x = (ceil3 * bzVar.d) + this.f24998x;
            }
            if (z10 && !z11 && i12 == 0) {
                this.f24998x = 1;
            }
    ...
    public final void v(f2.l1 l1Var, int i10) {
        ...
        kz kzVar = this.N;
        LongSparseArray longSparseArray = kzVar.f26481w1;
        LongSparseArray longSparseArray2 = kzVar.f26477v1;
        int i12 = l1Var.f5788f;
        View view = l1Var.f5785a;
        SparseArray sparseArray = this.f24995r;
        boolean z10 = true;
        char c3 = 1;
        int i13 = 1;
        z10 = true;
        if (i12 != 0) {
            ...
            if (i12 != 1) {
                if (i12 != 2) {
                    if (i12 == 3) {
                        ...
                        if (longSparseArray2.indexOfKey(stickerSetCovered.set.f19211id) >= 0) {
                            z4 = true;
                        } else {
                            z4 = false;
                        }
                        if (longSparseArray.indexOfKey(stickerSetCovered.set.f19211id) < 0) {
                            c3 = 0;
                        }
                        if (z4 || c3 != 0) {
                            if (z4 && r3Var.f21757r) {
            ...
            if (i10 == this.f24998x) {
                ...
                Object obj2 = this.f24994n.get(i14);
                ...
                if (num == null) {
                    ...
                    int z11 = org.telegram.ui.b.z(82.0f, (int) Math.ceil(num.intValue() / kzVar.f26476v0.d), kzVar.h.getHeight());
                    if (z11 > 0) {
                        i13 = z11;
                    }
                    k3Var.setHeight(i13);
        ...
        d8Var.d(document, null, this.f24996s.get(i10), (String) this.f24997w.get(i10), false, false);
        if (!kzVar.f26431g1.contains(document) && !kzVar.f26434h1.contains(document)) {
            z10 = false;
        }
        d8Var.setRecent(z10);
    }
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                break;
            case 2:
                azVar = new org.telegram.ui.Cells.m8(this.h, false, false, kzVar.W1, kzVar.f26429f2);
                break;
            case 3:
