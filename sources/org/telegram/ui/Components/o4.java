...
public final class o4 extends sl0 {
    ...
    public o4(Context context, int i10, lh.b bVar, ih.u uVar) {
        ...
        imageView.d();
        frameLayout.addView((View) imageView, i7.f6.d(160, 160.0f, 49, 17.0f, 14.0f, 17.0f, 0.0f));
        ...
        h.setTextColor(getThemedColor(org.telegram.ui.ActionBar.g6.f23310r5));
        h.setGravity(1);
        ...
        this.f32688c = editTextBoldCursor;
        ...
        editTextBoldCursor.setLineColors(getThemedColor(org.telegram.ui.ActionBar.g6.f23189k6), getThemedColor(org.telegram.ui.ActionBar.g6.f23206l6), getThemedColor(org.telegram.ui.ActionBar.g6.f23279p7));
        ...
        frameLayout2.f32337b = textView2;
        ...
        frameLayout2.addView(textView2, i7.f6.e(-2, -2, 17));
        this.f32687b = frameLayout2;
        ...
        frameLayout.addView((View) frameLayout2, i7.f6.d(-1, 50.0f, 51, 0.0f, 357.0f, 0.0f, 0.0f));
