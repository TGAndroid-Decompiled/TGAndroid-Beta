...
public final class k21 extends g61 {
    ...
    public final z5 f26146d3;
    public final z5 f26147e3;
    public final RectF f26148f3;
    public final Paint f26149g3;
    public final z5 f26150h3;
    public Drawable f26151i3;
    public int f26152j3;
    public final Paint f26153k3;
    public final w21 f26154l3;
    ...
    public k21(w21 w21Var, Context context, int i10, j21 j21Var, e21 e21Var, e21 e21Var2, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f26154l3 = w21Var;
        this.c3 = new org.telegram.ui.i20();
        mr mrVar = mr.h;
        this.f26146d3 = new z5(this, 320L, mrVar);
        this.f26147e3 = new z5(this, 320L, mrVar);
        this.f26148f3 = new RectF();
        this.f26149g3 = new Paint(1);
        this.f26150h3 = new z5(this, 420L, mrVar);
        this.f26153k3 = new Paint(1);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f13;
        int i10;
        float e = this.f26146d3.e(canScrollHorizontally(-1));
        float e6 = this.f26147e3.e(canScrollHorizontally(1));
        ...
        if (f14 > width) {
            ...
            if (this.f26151i3 == null) {
                this.f26151i3 = getContext().getResources().getDrawable(R.drawable.msg_limit_pin).mutate();
            }
            int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19848b9, f6Var);
            if (this.f26152j3 != v02) {
                Drawable drawable = this.f26151i3;
                this.f26152j3 = v02;
                drawable.setColorFilter(new PorterDuffColorFilter(v02, PorterDuff.Mode.SRC_IN));
            }
            this.f26151i3.setBounds((int) (AndroidUtilities.dp(-17.0f) + f14), (int) (rectF.top + AndroidUtilities.dp(10.0f)), (int) (f14 + AndroidUtilities.dp(-7.0f)), (int) (rectF.top + AndroidUtilities.dp(20.0f)));
            this.f26151i3.draw(canvas2);
        } else {
            f10 = 14.0f;
            f11 = 1.0f;
        }
        super.dispatchDraw(canvas);
        w21 w21Var = this.f26154l3;
        long j10 = w21Var.E;
        long j11 = w21Var.S;
        z5 z5Var = this.f26150h3;
        if (j10 != j11) {
            w21Var.F = j10;
            z5Var.d(0.0f, true);
        }
