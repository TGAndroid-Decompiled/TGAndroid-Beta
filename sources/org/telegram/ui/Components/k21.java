...
public class k21 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public j21 f25609f;
    public j21 h;
    public float f25610n;
    public final Paint f25611r;
    public final Paint f25612s;
    public final RectF v;
    public final Path f25613w;
    public final org.telegram.ui.ActionBar.f6 f25614x;
    public ValueAnimator f25615y;

    public k21(int i10, int i11, Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f25606a = AndroidUtilities.dp(8.0f);
        this.f25607b = AndroidUtilities.dp(6.0f);
        this.f25608c = AndroidUtilities.dp(4.0f);
        this.d = AndroidUtilities.dp(21.0f);
        this.e = AndroidUtilities.dp(41.0f);
        this.f25609f = new j21(this);
        this.f25610n = 1.0f;
        Paint paint = new Paint(1);
        this.f25611r = paint;
        this.f25612s = new Paint(1);
        this.v = new RectF();
        this.f25613w = new Path();
    ...
    public StaticLayout getNoThemeStaticLayout() {
        ...
        this.E = textPaint;
        textPaint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.We, this.f25614x));
    ...
    public final void d() {
        if (this.H.getImageReceiver().getLottieAnimation() != null) {
            ...
            if (!this.H.getImageReceiver().getLottieAnimation().f25724k0) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.N != null) {
            canvas.save();
            canvas.clipPath(this.f25613w);
            this.N.setBounds(0, 0, getMeasuredWidth(), getMeasuredHeight());
            this.N.draw(canvas);
            canvas.restore();
        }
        if (this.f25610n != 1.0f && (j21Var2 = this.h) != null) {
            j21Var2.b(canvas, 1.0f);
        }
        float f7 = this.f25610n;
        if (f7 != 0.0f) {
            this.f25609f.b(canvas, f7);
        }
        if (this.f25610n != 1.0f && (j21Var = this.h) != null) {
            j21Var.a(canvas, 1.0f);
        }
        float f10 = this.f25610n;
        if (f10 != 0.0f) {
            this.f25609f.a(canvas, f10);
        }
        float f11 = this.f25610n;
        if (f11 != 1.0f) {
    ...
    public final void f(lp lpVar, long j3, boolean z10) {
        ...
        this.V = i17;
        this.G = lpVar;
        TLRPC.Document f7 = lpVar.f26155a.f();
        org.telegram.ui.ActionBar.d4 d4Var2 = lpVar.f26155a;
        if (d4Var2.d instanceof TLRPC.TL_chatThemeUniqueGift) {
            j10 = ChatThemeController.getInstance(d4Var2.f18826g).getGiftThemeUser(((TLRPC.TL_chatThemeUniqueGift) d4Var2.d).gift.slug);
        } else {
            j10 = 0;
        }
        this.U = j10;
        ...
        if (z11) {
            if (f7 != null) {
                drawable = DocumentObject.getSvgThumb(f7, org.telegram.ui.ActionBar.j6.f19092c7, 0.2f);
            } else {
                drawable = null;
            }
            if (drawable == null) {
                Emoji.preloadEmoji(lpVar.f26155a.e);
                drawable = Emoji.getEmojiDrawable(lpVar.f26155a.e);
            }
            this.H.h(ImageLocation.getForDocument(f7), "50_50", drawable, null);
            lpVar.f26155a.getClass();
        ...
        v9 v9Var = this.H;
        if (lpVar.f26155a.m() && this.T != null) {
            i10 = 8;
        } else {
            i10 = 0;
        }
        ...
        if (z11 || z12) {
            ...
            j21 j21Var = this.f25609f;
            lp lpVar2 = this.G;
            if (lpVar2 == null || (d4Var = lpVar2.f26155a) == null) {
                j11 = 0;
            } else {
                org.telegram.ui.ActionBar.c4 c4Var = (org.telegram.ui.ActionBar.c4) d4Var.f18825f.get(lpVar2.f26157c);
                int i18 = c4Var.h;
                if (this.U != 0) {
                    i18 = c4Var.f18787k;
                }
                Paint paint = j21Var.f25263c;
                Paint paint2 = j21Var.f25261a;
                Paint paint3 = j21Var.f25262b;
                paint.setColor(i18);
                paint3.setColor(c4Var.f18785i);
                if (this.G.f26155a.m()) {
                    i11 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Oh, this.f25614x);
                } else {
                    i11 = c4Var.f18786j;
                }
                ...
                lp lpVar3 = this.G;
                fg.a aVar = (fg.a) lpVar3.f26155a.f18825f.get(lpVar3.f26157c);
                if (aVar != null) {
                    org.telegram.ui.ActionBar.c4 c4Var2 = (org.telegram.ui.ActionBar.c4) aVar;
                    if (c4Var2.a() != 0) {
                        lp lpVar4 = this.G;
                        int i19 = ((org.telegram.ui.ActionBar.c4) lpVar4.f26155a.f18825f.get(lpVar4.f26157c)).d;
                        ...
                        if (arrayList.size() > 1) {
                            ...
                            float dp = this.f25608c + AndroidUtilities.dp(8.0f);
                        ...
                        if (this.G != null) {
                            ...
                            this.G.f26156b = nc0Var;
                        }
                        j11 = 0;
                        j21Var.d = this.G.f26156b;
                        invalidate();
                    }
                }
                lp lpVar5 = this.G;
                org.telegram.ui.ActionBar.c4 c4Var3 = (org.telegram.ui.ActionBar.c4) lpVar5.f26155a.f18825f.get(lpVar5.f26157c);
                if (this.G != null) {
                    int i24 = c4Var3.f18787k;
                    int i25 = c4Var3.f18788l;
                    int i26 = c4Var3.f18789m;
                    int i27 = c4Var3.f18790n;
                    int i28 = c4Var3.f18791o;
                    j11 = 0;
                    if (c4Var3.f18780a.k(false) != null) {
                        if (i25 != 0) {
                        ...
                        org.telegram.ui.ActionBar.i6 i6Var = c4Var3.f18780a;
                        if (i6Var != null && (i6Var.P > 0 || i6Var.f18992c != null)) {
                            org.telegram.ui.ActionBar.i6 i6Var2 = c4Var3.f18780a;
                            Bitmap scaledBitmap = AndroidUtilities.getScaledBitmap(AndroidUtilities.dp(112.0f), AndroidUtilities.dp(134.0f), i6Var2.f18992c, i6Var2.f18990b, i6Var2.P);
                            ...
                            org.telegram.ui.ActionBar.d4 d4Var3 = this.G.f26155a;
            ...
            long i29 = lpVar.f26155a.i(this.V);
            if (i29 != j11) {
                TLRPC.WallPaper k10 = lpVar.f26155a.k(this.V);
                if (k10 != null) {
                    lpVar.f26155a.p(this.V, new ei.u1(this, i29, lpVar, k10.settings.intensity));
                }
            } else {
                SparseArray sparseArray = lpVar.f26155a.j(this.V).f18989a0;
                if (sparseArray != null) {
                    h6Var = (org.telegram.ui.ActionBar.h6) sparseArray.get(((org.telegram.ui.ActionBar.c4) lpVar.f26155a.f18825f.get(this.V)).e);
                } else {
                    h6Var = null;
                }
                if (h6Var != null && (tL_theme = h6Var.f18956r) != null && tL_theme.settings.size() > 0) {
                    TLRPC.WallPaper wallPaper2 = h6Var.f18956r.settings.get(0).wallpaper;
                ...
                } else if (h6Var != null && h6Var.f18956r == null) {
                    int i30 = (int) (h6Var.f18954p * 100.0f);
                    Drawable drawable2 = lpVar.f26156b;
                    if (drawable2 instanceof nc0) {
                        nc0 nc0Var6 = (nc0) drawable2;
                        nc0Var6.t(nc0Var6.f26746u, i30);
                    }
        ...
        org.telegram.ui.ActionBar.d4 d4Var4 = this.G.f26155a;
        if (d4Var4 != null && !d4Var4.m()) {
            fg.b bVar = this.G.f26155a.f18824c;
    ...
    public final void g(boolean z10, boolean z11) {
        float f7 = 0.0f;
        if (!z11) {
            ValueAnimator valueAnimator = this.f25615y;
        ...
        if (this.W != z10) {
            float f10 = this.M;
            ValueAnimator valueAnimator2 = this.f25615y;
            ...
            this.f25615y = ofFloat;
            ofFloat.addUpdateListener(new s70(this, 27));
            this.f25615y.addListener(new ba(20, this, z10));
            this.f25615y.setDuration(250L);
            this.f25615y.start();
        }
        this.W = z10;
    }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        float f7 = this.f25608c;
        RectF rectF = this.v;
        rectF.set(f7, f7, i10 - f7, i11 - f7);
        Path path = this.f25613w;
        path.reset();
        float f10 = this.f25607b;
    ...
    public void setBackgroundColor(int i10) {
        ...
        org.telegram.ui.ActionBar.f6 f6Var = this.f25614x;
        this.f25612s.setColor(org.telegram.ui.ActionBar.j6.v0(i11, f6Var));
