...
public final class dz0 extends FrameLayout {
    ...
    public int F;
    public wq0 G;
    public Paint f23738a;
    public Paint f23739b;
    public Paint f23740c;
    public Paint d;
    public RectF e;
    public cz0 f23741f;
    public String[] h;
    ...
    public final void b() {
        ...
        if (this.G == null && this.F != (value = this.f23741f.getValue())) {
            this.F = value;
            int i10 = (this.f23744s + 1) % 2;
            ij0 a2 = a(value);
            if (a2 != null) {
            ...
            AndroidUtilities.updateViewVisibilityAnimated(lj0VarArr[this.f23744s], false, 0.5f, true);
    ...
    public final void c(int i10) {
        ij0[] ij0VarArr = this.f23743r;
        if (ij0VarArr[i10] != null) {
            int d = i0.a.d(0.9f, org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19045d6, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19030c9, false));
            int w02 = org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19066e9, false);
            if (i10 == 2) {
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setContentDescription(this.h[this.f23741f.getValue()]);
    ...
    public void setBackgroundColor(int i10) {
        ...
        for (int i11 = 0; i11 < this.f23743r.length; i11++) {
            c(i11);
        }
        cz0Var.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19151j5, false));
        cz0Var.invalidate();
    }
}
