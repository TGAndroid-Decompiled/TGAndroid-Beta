...
public final class dz0 extends Drawable {
    ...
    public final d6 f23788b;
    public final Drawable f23789c;
    public final Drawable d;
    public int e = 255;

    public dz0(org.telegram.ui.Cells.u1 u1Var) {
        this.f23788b = new d6(u1Var, 420L, qr.h);
        this.f23789c = u1Var.getContext().getResources().getDrawable(R.drawable.summary_arrow);
    ...
    public final void draw(Canvas canvas) {
        ...
        float e = this.f23788b.e(this.f23787a);
        ...
        Drawable drawable2 = this.f23789c;
    ...
    public final int getIntrinsicHeight() {
        return this.f23789c.getIntrinsicHeight();
    }

    @Override
    public final int getIntrinsicWidth() {
        return this.f23789c.getIntrinsicWidth();
    }
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f23789c.setColorFilter(colorFilter);
