...
public final class jf0 extends FrameLayout {
    ...
    public if0 L;
    public int M;
    public PointF f25393a;
    public float f25394b;
    public float f25395c;
    public vv0 d;
    public PointF e;
    public float f25396f;
    public float h;
    public float f25397n;
    public RectF f25398r;
    public float f25399s;
    public float v;
    public float f25400w;
    public float f25401x;
    ...
    private PointF getActualCenterPoint() {
        ...
        float f11 = vv0Var.f29774a;
        return new PointF(width, (this.e.y * f11) + org.telegram.messenger.f0.x(f11, f10, 2.0f, A));
    }

    private float getActualInnerRadius() {
        vv0 vv0Var = this.d;
        return Math.min(vv0Var.f29774a, vv0Var.f29775b) * this.f25396f;
    }

    private float getActualOuterRadius() {
        vv0 vv0Var = this.d;
        return Math.min(vv0Var.f29774a, vv0Var.f29775b) * this.h;
    }
    ...
    public final void c(int i10, MotionEvent motionEvent) {
        ...
        vv0 vv0Var = this.d;
        float min = Math.min(vv0Var.f29774a, vv0Var.f29775b);
        float f12 = this.f25396f * min;
        float f13 = this.h * min;
        float abs = (float) Math.abs((Math.sin(a(this.f25397n) + 1.5707963267948966d) * f11) + (Math.cos(a(this.f25397n) + 1.5707963267948966d) * f10));
        float f14 = 0.0f;
        if (i10 != 1) {
            if (i10 != 2) {
            ...
            if (i14 == 0) {
                ...
                if (c10 != 1) {
                    if (c10 != 2) {
                        if (c10 != 3) {
                            if (c10 == 5) {
                                ...
                                this.f25397n = (((((float) Math.sqrt((f16 * f16) + (f15 * f15))) * ((i13 * 2) - 1)) / 3.1415927f) / 1.15f) + this.f25397n;
                                this.f25399s = x10;
                                this.v = y3;
                            }
                        } else {
                            this.h = Math.max(this.f25396f + 0.02f, (this.f25395c + (abs - this.f25394b)) / min);
                        }
                    } else {
                        this.f25396f = Math.min(Math.max(0.1f, (this.f25395c + (abs - this.f25394b)) / min), this.h - 0.02f);
                    }
                } else {
                    float f17 = x10 - this.f25399s;
                    float f18 = y3 - this.v;
                    float width = (getWidth() - vv0Var.f29774a) / 2.0f;
                    if (!z13) {
                    ...
                    float height = getHeight();
                    float f19 = vv0Var.f29775b;
                    float A = com.google.android.gms.internal.vision.e2.A(height, f19, 2.0f, i12);
                    PointF pointF = new PointF(Math.max(width, Math.min(vv0Var.f29774a + width, this.f25393a.x + f17)), Math.max(A, Math.min(f19 + A, this.f25393a.y + f18)));
                    float f20 = pointF.x - width;
                    float f21 = vv0Var.f29774a;
                    this.e = new PointF(f20 / f21, (((f21 - vv0Var.f29775b) / 2.0f) + (pointF.y - A)) / f21);
                }
            } else if (i14 == 1) {
                ...
                if (c11 != 1) {
                    if (c11 != 2) {
                        if (c11 == 3) {
                            this.h = Math.max(this.f25396f + 0.02f, (this.f25395c + (sqrt - this.f25394b)) / min);
                        }
                    } else {
                        this.f25396f = Math.min(Math.max(0.1f, (this.f25395c + (sqrt - this.f25394b)) / min), this.h - 0.02f);
                    }
                } else {
                    float f22 = x10 - this.f25399s;
                    float f23 = y3 - this.v;
                    float width2 = (getWidth() - vv0Var.f29774a) / 2.0f;
                    if (!z13) {
                    ...
                    float f24 = vv0Var.f29775b;
                    float A2 = com.google.android.gms.internal.vision.e2.A(height2, f24, 2.0f, i11);
                    PointF pointF2 = new PointF(Math.max(width2, Math.min(vv0Var.f29774a + width2, this.f25393a.x + f22)), Math.max(A2, Math.min(f24 + A2, this.f25393a.y + f23)));
                    float f25 = pointF2.x - width2;
                    float f26 = vv0Var.f29774a;
                    this.e = new PointF(f25 / f26, (((f26 - vv0Var.f29775b) / 2.0f) + (pointF2.y - A2)) / f26);
                }
            }
            invalidate();
            if0 if0Var = this.L;
            if (if0Var != null) {
                ...
                float f27 = this.f25396f;
                float f28 = this.h;
                uf0 uf0Var = ((mf0) if0Var).f26396a;
                uf0Var.f28771a0 = f28;
                uf0Var.f28773b0 = pointF3;
                uf0Var.f28775c0 = f27;
                uf0Var.f28776d0 = a(this.f25397n) + 1.5707964f;
        ...
        if (i15 == 0) {
            if (sqrt < f30) {
                this.M = 2;
                this.f25393a = actualCenterPoint;
                return;
            }
            float f31 = f12 - f29;
    ...
    public final void d(int i10, MotionEvent motionEvent) {
        if (i10 != 1) {
            ...
            this.f25400w = b(motionEvent);
            this.f25401x = 1.0f;
            this.M = 5;
        }
        float b10 = b(motionEvent);
        float e = a4.a.e(b10 - this.f25400w, AndroidUtilities.density, 0.01f, this.f25401x);
        this.f25401x = e;
        float max = Math.max(0.1f, this.f25396f * e);
        this.f25396f = max;
        this.h = Math.max(max + 0.02f, this.h * this.f25401x);
        this.f25401x = 1.0f;
        this.f25400w = b10;
        invalidate();
        if0 if0Var = this.L;
        if (if0Var != null) {
            ...
            float f7 = this.f25396f;
            float f10 = this.h;
            uf0 uf0Var = ((mf0) if0Var).f26396a;
            uf0Var.f28771a0 = f10;
            uf0Var.f28773b0 = pointF;
            uf0Var.f28775c0 = f7;
            uf0Var.f28776d0 = a(this.f25397n) + 1.5707964f;
            xz xzVar = uf0Var.f28785l0;
            if (xzVar != null) {
