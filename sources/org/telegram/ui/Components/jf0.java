...
public final class jf0 extends FrameLayout {
    ...
    public if0 L;
    public int M;
    public PointF f25365a;
    public float f25366b;
    public float f25367c;
    public wv0 d;
    public PointF e;
    public float f25368f;
    public float h;
    public float f25369n;
    public RectF f25370r;
    public float f25371s;
    public float v;
    public float f25372w;
    public float f25373x;
    ...
    private PointF getActualCenterPoint() {
        ...
        float f11 = wv0Var.f30161a;
        return new PointF(width, (this.e.y * f11) + org.telegram.messenger.l0.x(f11, f10, 2.0f, A));
    }

    private float getActualInnerRadius() {
        wv0 wv0Var = this.d;
        return Math.min(wv0Var.f30161a, wv0Var.f30162b) * this.f25368f;
    }

    private float getActualOuterRadius() {
        wv0 wv0Var = this.d;
        return Math.min(wv0Var.f30161a, wv0Var.f30162b) * this.h;
    }
    ...
    public final void c(int i10, MotionEvent motionEvent) {
        ...
        wv0 wv0Var = this.d;
        float min = Math.min(wv0Var.f30161a, wv0Var.f30162b);
        float f12 = this.f25368f * min;
        float f13 = this.h * min;
        float abs = (float) Math.abs((Math.sin(a(this.f25369n) + 1.5707963267948966d) * f11) + (Math.cos(a(this.f25369n) + 1.5707963267948966d) * f10));
        float f14 = 0.0f;
        if (i10 != 1) {
            if (i10 != 2) {
            ...
            if (i14 == 0) {
                ...
                if (c10 != 1) {
                    if (c10 != 2) {
                        if (c10 != 3) {
                            if (c10 == 5) {
                                ...
                                this.f25369n = (((((float) Math.sqrt((f16 * f16) + (f15 * f15))) * ((i13 * 2) - 1)) / 3.1415927f) / 1.15f) + this.f25369n;
                                this.f25371s = x10;
                                this.v = y3;
                            }
                        } else {
                            this.h = Math.max(this.f25368f + 0.02f, (this.f25367c + (abs - this.f25366b)) / min);
                        }
                    } else {
                        this.f25368f = Math.min(Math.max(0.1f, (this.f25367c + (abs - this.f25366b)) / min), this.h - 0.02f);
                    }
                } else {
                    float f17 = x10 - this.f25371s;
                    float f18 = y3 - this.v;
                    float width = (getWidth() - wv0Var.f30161a) / 2.0f;
                    if (!z13) {
                    ...
                    float height = getHeight();
                    float f19 = wv0Var.f30162b;
                    float A = com.google.android.gms.internal.vision.e2.A(height, f19, 2.0f, i12);
                    PointF pointF = new PointF(Math.max(width, Math.min(wv0Var.f30161a + width, this.f25365a.x + f17)), Math.max(A, Math.min(f19 + A, this.f25365a.y + f18)));
                    float f20 = pointF.x - width;
                    float f21 = wv0Var.f30161a;
                    this.e = new PointF(f20 / f21, (((f21 - wv0Var.f30162b) / 2.0f) + (pointF.y - A)) / f21);
                }
            } else if (i14 == 1) {
                ...
                if (c11 != 1) {
                    if (c11 != 2) {
                        if (c11 == 3) {
                            this.h = Math.max(this.f25368f + 0.02f, (this.f25367c + (sqrt - this.f25366b)) / min);
                        }
                    } else {
                        this.f25368f = Math.min(Math.max(0.1f, (this.f25367c + (sqrt - this.f25366b)) / min), this.h - 0.02f);
                    }
                } else {
                    float f22 = x10 - this.f25371s;
                    float f23 = y3 - this.v;
                    float width2 = (getWidth() - wv0Var.f30161a) / 2.0f;
                    if (!z13) {
                    ...
                    float f24 = wv0Var.f30162b;
                    float A2 = com.google.android.gms.internal.vision.e2.A(height2, f24, 2.0f, i11);
                    PointF pointF2 = new PointF(Math.max(width2, Math.min(wv0Var.f30161a + width2, this.f25365a.x + f22)), Math.max(A2, Math.min(f24 + A2, this.f25365a.y + f23)));
                    float f25 = pointF2.x - width2;
                    float f26 = wv0Var.f30161a;
                    this.e = new PointF(f25 / f26, (((f26 - wv0Var.f30162b) / 2.0f) + (pointF2.y - A2)) / f26);
                }
            }
            invalidate();
            if0 if0Var = this.L;
            if (if0Var != null) {
                ...
                float f27 = this.f25368f;
                float f28 = this.h;
                uf0 uf0Var = ((mf0) if0Var).f26444a;
                uf0Var.f28724a0 = f28;
                uf0Var.f28726b0 = pointF3;
                uf0Var.f28728c0 = f27;
                uf0Var.f28729d0 = a(this.f25369n) + 1.5707964f;
        ...
        if (i15 == 0) {
            if (sqrt < f30) {
                this.M = 2;
                this.f25365a = actualCenterPoint;
                return;
            }
            float f31 = f12 - f29;
    ...
    public final void d(int i10, MotionEvent motionEvent) {
        if (i10 != 1) {
            ...
            this.f25372w = b(motionEvent);
            this.f25373x = 1.0f;
            this.M = 5;
        }
        float b10 = b(motionEvent);
        float e = a4.a.e(b10 - this.f25372w, AndroidUtilities.density, 0.01f, this.f25373x);
        this.f25373x = e;
        float max = Math.max(0.1f, this.f25368f * e);
        this.f25368f = max;
        this.h = Math.max(max + 0.02f, this.h * this.f25373x);
        this.f25373x = 1.0f;
        this.f25372w = b10;
        invalidate();
        if0 if0Var = this.L;
        if (if0Var != null) {
            ...
            float f7 = this.f25368f;
            float f10 = this.h;
            uf0 uf0Var = ((mf0) if0Var).f26444a;
            uf0Var.f28724a0 = f10;
            uf0Var.f28726b0 = pointF;
            uf0Var.f28728c0 = f7;
            uf0Var.f28729d0 = a(this.f25369n) + 1.5707964f;
            vz vzVar = uf0Var.f28738l0;
            if (vzVar != null) {
