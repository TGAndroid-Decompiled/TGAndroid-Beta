...
public final class jf0 extends FrameLayout implements yz, ci.kc {
    ...
    public float f25236a0;
    public final int f25237b;
    public PointF f25238b0;
    public final int f25239c;
    public float f25240c0;
    public final int d;
    public float f25241d0;
    public final int e;
    public MediaController.SavedFilterState f25242e0;
    public final int f25243f;
    public final FrameLayout f25244f0;
    public final TextView f25245g0;
    public final int h;
    public final TextView f25246h0;
    public final TextureView f25247i0;
    public final boolean f25248j0;
    public final boolean f25249k0;
    public vz f25250l0;
    public final yh m0;
    public final int f25251n;
    public final FrameLayout f25252n0;
    public final ye0 f25253o0;
    public final af0 f25254p0;
    public final TextView f25255q0;
    public final int f25256r;
    public final TextView f25257r0;
    public final int f25258s;
    public final TextView f25259s0;
    public final FrameLayout f25260t0;
    public final RadioButton[] f25261u0;
    public final int v;
    public final fd0 f25262v0;
    public final int f25263w;
    public final boolean f25264w0;
    public final int f25265x;
    public final boolean f25266x0;
    public final int f25267y;
    public int f25268y0;
    public final ImageView f25269z0;

    public jf0(android.content.Context r26, org.telegram.ui.Components.v61 r27, android.graphics.Bitmap r28, android.graphics.Bitmap r29, int r30, org.telegram.messenger.MediaController.SavedFilterState r31, org.telegram.ui.Components.fd0 r32, int r33, boolean r34, boolean r35, org.telegram.ui.Components.ha r36, org.telegram.ui.ActionBar.f6 r37) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.jf0.<init>(android.content.Context, org.telegram.ui.Components.v61, android.graphics.Bitmap, android.graphics.Bitmap, int, org.telegram.messenger.MediaController$SavedFilterState, org.telegram.ui.Components.fd0, int, boolean, boolean, org.telegram.ui.Components.ha, org.telegram.ui.ActionBar.f6):void");
    }

    private void setShowOriginal(boolean z10) {
        if (this.f25235a != z10) {
            this.f25235a = z10;
            vz vzVar = this.f25250l0;
            if (vzVar != null) {
    ...
    public final boolean d() {
        MediaController.SavedFilterState savedFilterState = this.f25242e0;
        ff0 ff0Var = this.W;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        fd0 fd0Var = this.f25262v0;
        if (fd0Var != null && view == (textureView = this.f25247i0)) {
            canvas.save();
    ...
    public final void e() {
        boolean z10 = this.f25248j0;
        TextureView textureView = this.f25247i0;
        if (z10) {
            vz vzVar = this.f25250l0;
            if (vzVar != null) {
        ...
        } else if (textureView instanceof v61) {
    ...
    public final void f() {
        boolean z10;
        int i10 = this.f25268y0;
        yh yhVar = this.m0;
        af0 af0Var = this.f25254p0;
        FrameLayout frameLayout = this.f25260t0;
        FrameLayout frameLayout2 = this.f25252n0;
        ye0 ye0Var = this.f25253o0;
        if (i10 == 0) {
            ...
            for (int i11 = 0; i11 < 4; i11++) {
                RadioButton radioButton = this.f25261u0[i11];
                if (i11 == 0) {
                    z10 = true;
                } else {
                    z10 = false;
    ...
    public Bitmap getBitmap() {
        vz vzVar = this.f25250l0;
        if (vzVar != null && vzVar.f29441f && vzVar.isAlive()) {
    ...
    public float getBlurAngle() {
        return this.f25241d0;
    }

    public ye0 getBlurControl() {
        return this.f25253o0;
    }

    @Override
    public float getBlurExcludeBlurSize() {
        return this.f25240c0;
    }
    ...
    public TextureView getMyTextureView() {
        if (this.f25248j0 && !this.f25249k0) {
            return this.f25247i0;
        }
        return null;
    }
    ...
    public MediaController.SavedFilterState getSavedFilterState() {
        ...
        savedFilterState.blurExcludeSize = this.f25236a0;
        savedFilterState.blurExcludePoint = this.f25238b0;
        savedFilterState.blurExcludeBlurSize = this.f25240c0;
        savedFilterState.blurAngle = this.f25241d0;
        this.f25242e0 = savedFilterState;
    ...
    public final void h() {
        int i10 = this.T;
        TextView textView = this.f25259s0;
        TextView textView2 = this.f25257r0;
        org.telegram.ui.ActionBar.f6 f6Var = this.I0;
        TextView textView3 = this.f25255q0;
        if (i10 == 0) {
            Drawable mutate = textView3.getContext().getResources().getDrawable(R.drawable.msg_blur_off).mutate();
            int i11 = org.telegram.ui.ActionBar.j6.f19273zf;
            ...
            int i12 = org.telegram.ui.ActionBar.j6.f19273zf;
            ...
            int i13 = org.telegram.ui.ActionBar.j6.f19273zf;
    ...
    public final boolean m(MotionEvent motionEvent) {
        if (motionEvent.getActionMasked() != 0 && motionEvent.getActionMasked() != 5) {
            ...
            if (textureView instanceof v61) {
                ...
                ik0 ik0Var = ((v61) textureView).f28641c;
                float f7 = ik0Var.f24953a;
                if (x10 >= f7 && x10 <= f7 + ik0Var.f24955c) {
                    float f10 = ik0Var.f24954b;
    ...
    public void setEnhanceValue(float f7) {
        ...
        while (true) {
            ...
            if ((childAt instanceof org.telegram.ui.Cells.u5) && RecyclerView.S(childAt) == this.f25237b) {
