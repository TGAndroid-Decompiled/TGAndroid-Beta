...
public final class jf0 extends FrameLayout implements yz, di.lc {
    ...
    public float f27496a0;
    public final int f27497b;
    public PointF f27498b0;
    public final int f27499c;
    public float f27500c0;
    public final int d;
    public float f27501d0;
    public final int f27502e;
    public MediaController.SavedFilterState f27503e0;
    public final int f27504f;
    public final FrameLayout f27505f0;
    public final TextView f27506g0;
    public final int h;
    public final TextView f27507h0;
    public final TextureView f27508i0;
    public final boolean f27509j0;
    public final boolean f27510k0;
    public vz f27511l0;
    public final yh m0;
    public final int f27512n;
    public final FrameLayout f27513n0;
    public final ye0 f27514o0;
    public final af0 f27515p0;
    public final TextView f27516q0;
    public final int f27517r;
    public final TextView f27518r0;
    public final int f27519s;
    public final TextView f27520s0;
    public final FrameLayout f27521t0;
    public final RadioButton[] f27522u0;
    public final int v;
    public final gd0 f27523v0;
    public final int f27524w;
    public final boolean f27525w0;
    public final int f27526x;
    public final boolean f27527x0;
    public final int f27528y;
    public int f27529y0;
    public final ImageView f27530z0;

    public jf0(android.content.Context r26, org.telegram.ui.Components.u61 r27, android.graphics.Bitmap r28, android.graphics.Bitmap r29, int r30, org.telegram.messenger.MediaController.SavedFilterState r31, org.telegram.ui.Components.gd0 r32, int r33, boolean r34, boolean r35, org.telegram.ui.Components.ja r36, org.telegram.ui.ActionBar.f6 r37) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.jf0.<init>(android.content.Context, org.telegram.ui.Components.u61, android.graphics.Bitmap, android.graphics.Bitmap, int, org.telegram.messenger.MediaController$SavedFilterState, org.telegram.ui.Components.gd0, int, boolean, boolean, org.telegram.ui.Components.ja, org.telegram.ui.ActionBar.f6):void");
    }

    private void setShowOriginal(boolean z10) {
        if (this.f27495a != z10) {
            this.f27495a = z10;
            vz vzVar = this.f27511l0;
            if (vzVar != null) {
    ...
    public final ByteBuffer a() {
        ff0 ff0Var = this.W;
        ff0Var.a();
        return ff0Var.f26059e;
    }

    @Override
    public final boolean b() {
        if (!this.f27495a && !this.V) {
            return false;
        }
        return true;
    }
    ...
    public final boolean d() {
        MediaController.SavedFilterState savedFilterState = this.f27503e0;
        ff0 ff0Var = this.W;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        gd0 gd0Var = this.f27523v0;
        if (gd0Var != null && view == (textureView = this.f27508i0)) {
            canvas.save();
    ...
    public final void e() {
        boolean z10 = this.f27509j0;
        TextureView textureView = this.f27508i0;
        if (z10) {
            vz vzVar = this.f27511l0;
            if (vzVar != null) {
    ...
    public final void f() {
        boolean z10;
        int i10 = this.f27529y0;
        yh yhVar = this.m0;
        af0 af0Var = this.f27515p0;
        FrameLayout frameLayout = this.f27521t0;
        FrameLayout frameLayout2 = this.f27513n0;
        ye0 ye0Var = this.f27514o0;
        if (i10 == 0) {
            ...
            for (int i11 = 0; i11 < 4; i11++) {
                RadioButton radioButton = this.f27522u0[i11];
                if (i11 == 0) {
                    z10 = true;
                } else {
                    z10 = false;
    ...
    public Bitmap getBitmap() {
        vz vzVar = this.f27511l0;
        if (vzVar != null && vzVar.f32059f && vzVar.isAlive()) {
    ...
    public float getBlurAngle() {
        return this.f27501d0;
    }

    public ye0 getBlurControl() {
        return this.f27514o0;
    }
    ...
    public PointF getBlurExcludePoint() {
        return this.f27498b0;
    }

    @Override
    public float getBlurExcludeSize() {
        return this.f27496a0;
    }
    ...
    public af0 getCurveControl() {
        return this.f27515p0;
    }

    public TextView getDoneTextView() {
        return this.f27506g0;
    }
    ...
    public TextureView getMyTextureView() {
        if (this.f27509j0 && !this.f27510k0) {
            return this.f27508i0;
        }
        return null;
    }
    ...
    public MediaController.SavedFilterState getSavedFilterState() {
        ...
        savedFilterState.blurExcludeSize = this.f27496a0;
        savedFilterState.blurExcludePoint = this.f27498b0;
        savedFilterState.blurExcludeBlurSize = this.f27500c0;
        savedFilterState.blurAngle = this.f27501d0;
        this.f27503e0 = savedFilterState;
    ...
    public final void h() {
        int i10 = this.T;
        TextView textView = this.f27520s0;
        TextView textView2 = this.f27518r0;
        org.telegram.ui.ActionBar.f6 f6Var = this.I0;
        TextView textView3 = this.f27516q0;
        if (i10 == 0) {
            Drawable mutate = textView3.getContext().getResources().getDrawable(R.drawable.msg_blur_off).mutate();
            int i11 = org.telegram.ui.ActionBar.j6.f21098zf;
            ...
            int i12 = org.telegram.ui.ActionBar.j6.f21098zf;
            ...
            int i13 = org.telegram.ui.ActionBar.j6.f21098zf;
    ...
    public final boolean l(MotionEvent motionEvent) {
        if (motionEvent.getActionMasked() != 0 && motionEvent.getActionMasked() != 5) {
            ...
            if (textureView instanceof u61) {
                ...
                hk0 hk0Var = ((u61) textureView).f30850c;
                float f7 = hk0Var.f26771a;
                if (x10 >= f7 && x10 <= f7 + hk0Var.f26773c) {
                    float f10 = hk0Var.f26772b;
    ...
    public void setEnhanceValue(float f7) {
        ...
        while (true) {
            ...
            if ((childAt instanceof org.telegram.ui.Cells.u5) && RecyclerView.R(childAt) == this.f27497b) {
