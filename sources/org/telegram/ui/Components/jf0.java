...
public final class jf0 extends FrameLayout implements yz, di.lc {
    ...
    public float f27495a0;
    public final int f27496b;
    public PointF f27497b0;
    public final int f27498c;
    public float f27499c0;
    public final int d;
    public float f27500d0;
    public final int f27501e;
    public MediaController.SavedFilterState f27502e0;
    public final int f27503f;
    public final FrameLayout f27504f0;
    public final TextView f27505g0;
    public final int h;
    public final TextView f27506h0;
    public final TextureView f27507i0;
    public final boolean f27508j0;
    public final boolean f27509k0;
    public vz f27510l0;
    public final yh m0;
    public final int f27511n;
    public final FrameLayout f27512n0;
    public final ye0 f27513o0;
    public final af0 f27514p0;
    public final TextView f27515q0;
    public final int f27516r;
    public final TextView f27517r0;
    public final int f27518s;
    public final TextView f27519s0;
    public final FrameLayout f27520t0;
    public final RadioButton[] f27521u0;
    public final int v;
    public final gd0 f27522v0;
    public final int f27523w;
    public final boolean f27524w0;
    public final int f27525x;
    public final boolean f27526x0;
    public final int f27527y;
    public int f27528y0;
    public final ImageView f27529z0;
    ...
    public final ByteBuffer a() {
        ff0 ff0Var = this.W;
        ff0Var.a();
        return ff0Var.f26058e;
    }

    @Override
    public final boolean b() {
        if (!this.f27494a && !this.V) {
            return false;
        }
        return true;
    }
    ...
    public final boolean d() {
        MediaController.SavedFilterState savedFilterState = this.f27502e0;
        ff0 ff0Var = this.W;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        gd0 gd0Var = this.f27522v0;
        if (gd0Var != null && view == (textureView = this.f27507i0)) {
            canvas.save();
    ...
    public final void e() {
        boolean z10 = this.f27508j0;
        TextureView textureView = this.f27507i0;
        if (z10) {
            vz vzVar = this.f27510l0;
            if (vzVar != null) {
    ...
    public final void f() {
        boolean z10;
        int i10 = this.f27528y0;
        yh yhVar = this.m0;
        af0 af0Var = this.f27514p0;
        FrameLayout frameLayout = this.f27520t0;
        FrameLayout frameLayout2 = this.f27512n0;
        ye0 ye0Var = this.f27513o0;
        if (i10 == 0) {
            ...
            for (int i11 = 0; i11 < 4; i11++) {
                RadioButton radioButton = this.f27521u0[i11];
                if (i11 == 0) {
                    z10 = true;
                } else {
                    z10 = false;
    ...
    public Bitmap getBitmap() {
        vz vzVar = this.f27510l0;
        if (vzVar != null && vzVar.f32058f && vzVar.isAlive()) {
    ...
    public ye0 getBlurControl() {
        return this.f27513o0;
    }

    @Override
    public float getBlurExcludeBlurSize() {
        return this.f27499c0;
    }

    @Override
    public PointF getBlurExcludePoint() {
        return this.f27497b0;
    }
    ...
    public af0 getCurveControl() {
        return this.f27514p0;
    }

    public TextView getDoneTextView() {
        return this.f27505g0;
    }
    ...
    public TextureView getMyTextureView() {
        if (this.f27508j0 && !this.f27509k0) {
    ...
    public MediaController.SavedFilterState getSavedFilterState() {
        ...
        savedFilterState.blurExcludeSize = this.f27495a0;
        savedFilterState.blurExcludePoint = this.f27497b0;
        savedFilterState.blurExcludeBlurSize = this.f27499c0;
        savedFilterState.blurAngle = this.f27500d0;
        this.f27502e0 = savedFilterState;
    ...
    public final void h() {
        int i10 = this.T;
        TextView textView = this.f27519s0;
        TextView textView2 = this.f27517r0;
        org.telegram.ui.ActionBar.f6 f6Var = this.I0;
        TextView textView3 = this.f27515q0;
        if (i10 == 0) {
            Drawable mutate = textView3.getContext().getResources().getDrawable(R.drawable.msg_blur_off).mutate();
            int i11 = org.telegram.ui.ActionBar.j6.f21097zf;
            ...
            int i12 = org.telegram.ui.ActionBar.j6.f21097zf;
            ...
            int i13 = org.telegram.ui.ActionBar.j6.f21097zf;
    ...
    public final boolean l(MotionEvent motionEvent) {
        if (motionEvent.getActionMasked() != 0 && motionEvent.getActionMasked() != 5) {
            ...
            if (textureView instanceof u61) {
                ...
                hk0 hk0Var = ((u61) textureView).f30849c;
                float f7 = hk0Var.f26770a;
                if (x10 >= f7 && x10 <= f7 + hk0Var.f26772c) {
                    float f10 = hk0Var.f26771b;
    ...
    public void setEnhanceValue(float f7) {
        ...
        while (true) {
            ...
            if ((childAt instanceof org.telegram.ui.Cells.u5) && RecyclerView.R(childAt) == this.f27496b) {
