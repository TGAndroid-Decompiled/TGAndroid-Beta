...
public final class jf0 extends FrameLayout implements yz, di.lc {
    ...
    public float f27469a0;
    public final int f27470b;
    public PointF f27471b0;
    public final int f27472c;
    public float f27473c0;
    public final int d;
    public float f27474d0;
    public final int f27475e;
    public MediaController.SavedFilterState f27476e0;
    public final int f27477f;
    public final FrameLayout f27478f0;
    public final TextView f27479g0;
    public final int h;
    public final TextView f27480h0;
    public final TextureView f27481i0;
    public final boolean f27482j0;
    public final boolean f27483k0;
    public vz f27484l0;
    public final yh m0;
    public final int f27485n;
    public final FrameLayout f27486n0;
    public final ye0 f27487o0;
    public final af0 f27488p0;
    public final TextView f27489q0;
    public final int f27490r;
    public final TextView f27491r0;
    public final int f27492s;
    public final TextView f27493s0;
    public final FrameLayout f27494t0;
    public final RadioButton[] f27495u0;
    public final int v;
    public final gd0 f27496v0;
    public final int f27497w;
    public final boolean f27498w0;
    public final int f27499x;
    public final boolean f27500x0;
    public final int f27501y;
    public int f27502y0;
    public final ImageView f27503z0;
    ...
    public final ByteBuffer a() {
        ff0 ff0Var = this.W;
        ff0Var.a();
        return ff0Var.f26032e;
    }

    @Override
    public final boolean b() {
        if (!this.f27468a && !this.V) {
            return false;
        }
        return true;
    }
    ...
    public final boolean d() {
        MediaController.SavedFilterState savedFilterState = this.f27476e0;
        ff0 ff0Var = this.W;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        gd0 gd0Var = this.f27496v0;
        if (gd0Var != null && view == (textureView = this.f27481i0)) {
            canvas.save();
    ...
    public final void e() {
        boolean z10 = this.f27482j0;
        TextureView textureView = this.f27481i0;
        if (z10) {
            vz vzVar = this.f27484l0;
            if (vzVar != null) {
    ...
    public final void f() {
        boolean z10;
        int i10 = this.f27502y0;
        yh yhVar = this.m0;
        af0 af0Var = this.f27488p0;
        FrameLayout frameLayout = this.f27494t0;
        FrameLayout frameLayout2 = this.f27486n0;
        ye0 ye0Var = this.f27487o0;
        if (i10 == 0) {
            ...
            for (int i11 = 0; i11 < 4; i11++) {
                RadioButton radioButton = this.f27495u0[i11];
                if (i11 == 0) {
                    z10 = true;
                } else {
                    z10 = false;
    ...
    public Bitmap getBitmap() {
        vz vzVar = this.f27484l0;
        if (vzVar != null && vzVar.f32032f && vzVar.isAlive()) {
    ...
    public float getBlurAngle() {
        return this.f27474d0;
    }

    public ye0 getBlurControl() {
        return this.f27487o0;
    }

    @Override
    public float getBlurExcludeBlurSize() {
        return this.f27473c0;
    }
    ...
    public af0 getCurveControl() {
        return this.f27488p0;
    }

    public TextView getDoneTextView() {
        return this.f27479g0;
    }
    ...
    public TextureView getMyTextureView() {
        if (this.f27482j0 && !this.f27483k0) {
    ...
    public MediaController.SavedFilterState getSavedFilterState() {
        ...
        savedFilterState.blurExcludeSize = this.f27469a0;
        savedFilterState.blurExcludePoint = this.f27471b0;
        savedFilterState.blurExcludeBlurSize = this.f27473c0;
        savedFilterState.blurAngle = this.f27474d0;
        this.f27476e0 = savedFilterState;
    ...
    public final void h() {
        int i10 = this.T;
        TextView textView = this.f27493s0;
        TextView textView2 = this.f27491r0;
        org.telegram.ui.ActionBar.f6 f6Var = this.I0;
        TextView textView3 = this.f27489q0;
        if (i10 == 0) {
            Drawable mutate = textView3.getContext().getResources().getDrawable(R.drawable.msg_blur_off).mutate();
            int i11 = org.telegram.ui.ActionBar.j6.f21071zf;
            ...
            int i12 = org.telegram.ui.ActionBar.j6.f21071zf;
            ...
            int i13 = org.telegram.ui.ActionBar.j6.f21071zf;
    ...
    public final boolean l(MotionEvent motionEvent) {
        if (motionEvent.getActionMasked() != 0 && motionEvent.getActionMasked() != 5) {
            ...
            if (textureView instanceof u61) {
                ...
                hk0 hk0Var = ((u61) textureView).f30823c;
                float f7 = hk0Var.f26744a;
                if (x10 >= f7 && x10 <= f7 + hk0Var.f26746c) {
                    float f10 = hk0Var.f26745b;
    ...
    public void setEnhanceValue(float f7) {
        ...
        while (true) {
            ...
            if ((childAt instanceof org.telegram.ui.Cells.u5) && RecyclerView.R(childAt) == this.f27470b) {
