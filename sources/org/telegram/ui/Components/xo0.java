...
public final class xo0 extends View {
    ...
    public ImageReceiver f29957a;
    public f9 f29958b;
    public org.telegram.ui.Cells.z f29959c;
    public Paint d;
    public Paint e;
    public o1.k f29960f;
    public ValueAnimator h;
    public float f29961n;
    ...
    public final void a(boolean z10, boolean z11, float f7) {
        if (z10) {
            ...
            if (z11) {
                ...
                lVar.a(1.0f);
                kVar2.f15361u = lVar;
                this.f29960f.b(new mh(this, z12, f10, f11));
                this.f29960f.a(new fb(this, 3));
                this.f29960f.f();
                return;
            }
            ValueAnimator duration = ValueAnimator.ofFloat(this.f29961n, f7).setDuration(200L);
            this.h = duration;
    ...
    public final void drawableStateChanged() {
        ...
        this.f29959c.setState(getDrawableState());
    }
    ...
    public final void jumpDrawablesToCurrentState() {
        ...
        this.f29959c.jumpToCurrentState();
    }

    @Override
    public final void onAttachedToWindow() {
        super.onAttachedToWindow();
        this.f29957a.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f29957a.onDetachedFromWindow();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f7 = 1.0f;
        if (this.f29962r) {
            f7 = 1.0f - this.f29961n;
        } else if (this.f29963s) {
            f7 = this.f29961n;
        }
        canvas.scale(f7, f7, getWidth() / 2.0f, getHeight() / 2.0f);
        super.onDraw(canvas);
        this.f29957a.draw(canvas);
        int i10 = (int) (this.f29961n * 255.0f);
        paint.setAlpha(i10);
        ...
        canvas.restore();
        this.f29959c.setBounds(0, 0, getWidth(), getHeight());
        this.f29959c.draw(canvas);
        canvas.restore();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f29957a.setImageCoords(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
    }

    public void setAvatar(TLObject tLObject) {
        String str;
        f9 f9Var = this.f29958b;
        ...
        f9Var.p(tLObject);
        this.f29957a.setForUserOrChat(tLObject, f9Var);
    }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (!super.verifyDrawable(drawable) && this.f29959c != drawable) {
            return false;
        }
        return true;
    }
