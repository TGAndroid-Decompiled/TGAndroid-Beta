...
public final class ax0 extends Drawable {
    ...
    public final q5[] f24468c;
    public final boolean f24469e;
    public int d = 255;
    public final RectF f24470f = new RectF();
    ...
    public ax0(int i10, ArrayList arrayList, boolean z10) {
        ...
        for (int i12 = 0; i12 < this.f24467b; i12++) {
            this.f24468c[i12] = q5.m(i10, i11, (TLRPC.Document) arrayList.get(i12));
        }
    }

    public final void a(org.telegram.ui.Cells.t1 t1Var) {
        for (int i10 = 0; i10 < this.f24467b; i10++) {
            this.f24468c[i10].o(t1Var);
        }
    }
            ...
            for (int i12 = 0; i12 < i10; i12++) {
                ...
                if (i13 >= 0) {
                    ...
                    if (i13 < q5VarArr.length && (q5Var = q5VarArr[i13]) != null) {
                        ...
                        if (this.f24469e) {
                            porterDuffColorFilter = org.telegram.ui.ActionBar.j6.f21006w3;
                        } else {
                            porterDuffColorFilter = org.telegram.ui.ActionBar.j6.f20988v3;
                        }
