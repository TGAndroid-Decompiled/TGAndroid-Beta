...
public class ax0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public float F;
    public boolean G;
    public final ib1 f25361a;
    public final p9 f25362b;
    public final RadialProgressView f25363c;
    public final jh.s d;
    public final g90 f25364e;
    public final qh.d f25365f;
    public boolean h;
    public final org.telegram.ui.ActionBar.g6 f25366n;
    public int f25367r;
    public final View f25368s;
    public int v;
    public final int f25369w;
    public boolean f25370x;
    public final ul0 f25371y;
    ...
    public final void b(int i10, boolean z4) {
        if (this.v != i10) {
            ...
            float f10 = i12 + i11;
            RadialProgressView radialProgressView = this.f25363c;
            ib1 ib1Var = this.f25361a;
            if (z4) {
                ViewPropertyAnimator translationY = ib1Var.animate().translationY(f10);
                pr prVar = pr.f30183f;
    ...
    public final void c() {
        ...
        int i10;
        int i11 = this.f25367r;
        p9 p9Var = this.f25362b;
        if (i11 != 0) {
            boolean z4 = true;
            if (i11 != 1) {
                ...
                if (i11 == 16) {
                    ...
                    if (stickerSetByName != null && (i10 = this.f25367r) >= 0 && i10 < stickerSetByName.documents.size()) {
                        document2 = stickerSetByName.documents.get(this.f25367r);
                    }
    ...
    public void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f25369w).addObserver(this, NotificationCenter.diceStickersDidLoad);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f25369w).removeObserver(this, NotificationCenter.diceStickersDidLoad);
    }
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        if ((this.B || this.f25370x) && (i14 = this.C) > 0 && i14 != getMeasuredHeight()) {
            float measuredHeight = (this.C - getMeasuredHeight()) / 2.0f;
            ib1 ib1Var = this.f25361a;
            ib1Var.setTranslationY(ib1Var.getTranslationY() + measuredHeight);
            if (!this.f25370x) {
                ib1Var.animate().translationY(0.0f).setInterpolator(pr.f30183f).setDuration(250L);
            }
            RadialProgressView radialProgressView = this.f25363c;
            if (radialProgressView != null) {
                radialProgressView.setTranslationY(radialProgressView.getTranslationY() + measuredHeight);
                if (!this.f25370x) {
                    radialProgressView.animate().translationY(0.0f).setInterpolator(pr.f30183f).setDuration(250L);
                }
            }
        }
    ...
    public void setPreventMoving(boolean z4) {
        this.f25370x = z4;
        if (!z4) {
            this.f25361a.setTranslationY(0.0f);
            RadialProgressView radialProgressView = this.f25363c;
            if (radialProgressView != null) {
    ...
    public void setSubtitle(CharSequence charSequence) {
        ...
        this.f25364e.setText(charSequence);
    }
    ...
    public ax0(Context context, View view, int i10, org.telegram.ui.ActionBar.g6 g6Var) {
        super(context);
        this.f25369w = UserConfig.selectedAccount;
        this.f25371y = new ul0(this, 3);
        this.D = org.telegram.ui.ActionBar.k6.f21642c7;
        this.f25366n = g6Var;
        this.f25368s = view;
        this.f25367r = i10;
        ...
        if (view == null) {
            ...
            this.f25363c = radialProgressView;
            radialProgressView.setAlpha(0.0f);
            radialProgressView.setScaleY(0.5f);
            radialProgressView.setScaleX(0.5f);
