...
public class w51 extends og.b {
    ...
    public Utilities.Callback2 f29614s;
    public final org.telegram.ui.ActionBar.e6 v;
    public ig.f f29617y;
    public boolean f29613r = true;
    public final ArrayList f29615w = new ArrayList();
    public final ArrayList f29616x = new ArrayList();
    public int E = 0;
    ...
    public final void F(int i10) {
        if (i10 >= 0) {
            ...
            if (i10 < arrayList.size()) {
                ...
                this.L.run(Integer.valueOf(i10), new ArrayList(this.f29616x.subList(u51Var.f28294a, u51Var.f28295b + 1)));
                this.K = false;
            }
        }
    }
    ...
    public final int H(int i10) {
        ...
        while (true) {
            ...
            if (i11 < arrayList.size()) {
                ...
                if (i10 >= u51Var.f28294a && i10 <= u51Var.f28295b) {
                    return i11;
                }
                i11++;
            } else {
    ...
    public final boolean J(int i10) {
        i51 G = G(i10);
        i51 G2 = G(i10 + 1);
        if (G != null && !G.f24892j && G2 != null && K(G2.f15533a) == K(G.f15533a)) {
            return true;
        }
        return false;
    }
    ...
    public final void L() {
        u51 u51Var = this.I;
        if (u51Var != null) {
            u51Var.f28295b = Math.max(0, this.f29616x.size() - 1);
        }
    }
    ...
    public final void P(boolean z10) {
        ll0 ll0Var = this.d;
        if (ll0Var == null || !ll0Var.b0()) {
            ArrayList arrayList = this.f29615w;
            arrayList.clear();
            ArrayList arrayList2 = this.f29616x;
            arrayList.addAll(arrayList2);
            arrayList2.clear();
            this.H = null;
            this.F.clear();
            this.G.clear();
            Utilities.Callback2 callback2 = this.f29614s;
            if (callback2 != null) {
    ...
    public final void R() {
        ...
        if (ll0Var != null) {
            ...
            while (i10 < size) {
                ...
                i10++;
                u51 u51Var = (u51) obj;
                ll0Var.K2.add(Long.valueOf(AndroidUtilities.pack(u51Var.f28294a, u51Var.f28295b)));
            }
        }
    }
    ...
    public final void T() {
        u51 u51Var = this.H;
        if (u51Var != null) {
            u51Var.f28295b = Math.max(0, (this.f29616x.size() + this.E) - 1);
            u51 u51Var2 = this.H;
            if (u51Var2.f28294a == u51Var2.f28295b) {
    ...
    public final void U() {
        ?? obj = new Object();
        this.H = obj;
        obj.f28294a = this.f29616x.size() + this.E;
        u51 u51Var = this.H;
        u51Var.f28295b = -1;
        this.F.add(u51Var);
    }
    ...
    public s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (z10) {
            i11 = org.telegram.ui.ActionBar.i6.f18907h5;
        } else {
        ...
        if (i10 >= 10000) {
            h51 F = i51.F(i10);
            if (F != null) {
                z1Var = F.createView(this.e, this.d, this.f29611f, this.h, this.v);
            } else {
            ...
            switch (i10) {
                ...
                case 0:
                    if (z10) {
                        w8Var = new org.telegram.ui.Cells.l4(this.e, org.telegram.ui.ActionBar.i6.L6, 21, 15, 0, false, false, this.v);
                        z1Var = w8Var;
                        break;
                    } else {
                        z1Var = new org.telegram.ui.Cells.l4(context, e6Var);
                        break;
                    }
                case 1:
                    l4Var = new org.telegram.ui.Cells.l4(this.e, org.telegram.ui.ActionBar.i6.G6, 17, 15, false, this.v);
                    z1Var = l4Var;
                    break;
                case 2:
                ...
                case 9:
                    ...
                    if (i10 == 9) {
                        ...
                        w8Var2.d(org.telegram.ui.ActionBar.i6.f18890g6, org.telegram.ui.ActionBar.i6.O6, org.telegram.ui.ActionBar.i6.P6, org.telegram.ui.ActionBar.i6.Q6, org.telegram.ui.ActionBar.i6.R6);
                ...
                case 10:
                    ...
                    frameLayout2.f21347c = textView2;
                    org.telegram.messenger.wl.r(textView2, org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.I6, false), 1, 16.0f, 1);
                ...
                case 16:
                    ...
                    z1Var = new hg.x1(context, e6Var, z11);
                    break;
                case 17:
                    z1Var = new hg.v1(context, e6Var);
                    break;
                case 18:
                case 19:
                case 20:
                ...
                case 23:
                    if (this.f29617y == null) {
                        this.f29617y = new ig.f(null);
                    }
                    ig.f fVar = this.f29617y;
                    int i19 = this.h;
                    z1Var = new wa1(this.e, this.f29611f, i10 - 18, fVar, i19);
                    break;
                case 24:
                ...
                case 25:
                    ...
                    break;
                case 26:
                    l4Var2 = new org.telegram.ui.Cells.l4(this.e, org.telegram.ui.ActionBar.i6.G6, 23, 20, 0, false, false, this.v);
                ...
                case 31:
                    ...
                    if (ll0Var != null && ll0Var.b1()) {
                        org.telegram.ui.Cells.u3 u3Var = new org.telegram.ui.Cells.u3(context, 28, e6Var);
                        u3Var.setNoBackground(true);
                        z1Var = u3Var;
                        break;
                    } else {
                        z1Var = new org.telegram.ui.Cells.u3(context, e6Var);
                        break;
                    }
                    break;
                case 32:
                ...
                case 40:
                    ...
                    break;
                case 42:
                    l4Var2 = new org.telegram.ui.Cells.l4(this.e, org.telegram.ui.ActionBar.i6.L6, 21, 15, 0, false, true, this.v);
                    z1Var = l4Var2;
                    break;
                case 43:
