...
public final class ru0 extends s4.v {
    ...
    public final void p(s4.c1 c1Var, int i10) {
        bu0 bu0Var;
        tu0 tu0Var = this.d;
        wq0 wq0Var = tu0Var.f28618n;
        if (c1Var != null && (bu0Var = tu0Var.f28620s) != null) {
            bu0Var.d1(false);
        }
        if (i10 == 0) {
    ...
    public final SavedMessagesController.SavedDialog r(s4.c1 c1Var) {
        ...
        if (c1Var != null && (b10 = c1Var.b()) >= 0) {
            tu0 tu0Var = this.d;
            if (b10 < tu0Var.f28617f.size()) {
                return (SavedMessagesController.SavedDialog) tu0Var.f28617f.get(b10);
            }
        }
        return null;
    }
