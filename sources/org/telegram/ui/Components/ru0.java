...
public final class ru0 extends wl0 {
    public final Context f28061c;
    public final int d;
    public final org.telegram.ui.ActionBar.d6 e;
    public final pu0 f28062f;
    public final ArrayList h = new ArrayList(10);
    public final ArrayList f28063n = new ArrayList();
    public cu0 f28064r;
    public final kv0 f28065s;

    public ru0(kv0 kv0Var, Context context, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        this.f28065s = kv0Var;
        this.f28061c = context;
        this.d = i10;
        this.e = d6Var;
        this.f28062f = new pu0(this, i10, d6Var);
        E();
    }
    ...
    public final void E() {
        ArrayList arrayList = this.f28063n;
        arrayList.clear();
        ArrayList c10 = this.f28065s.f25862t1[8].c();
        int i10 = 0;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        if (i10 == 0) {
            qu0 qu0Var = new qu0(this.f28061c, this.d, false, null, this.e);
            qu0Var.setDelegate(this.f28062f);
            return new s4.c1(qu0Var);
        }
        return new s4.c1(new org.telegram.ui.Cells.w0(this.f28061c, this.e, false));
    }
}
