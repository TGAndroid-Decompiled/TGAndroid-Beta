...
public final class ru0 extends s4.v {
    ...
    public final boolean n(RecyclerView recyclerView, s4.c1 c1Var, s4.c1 c1Var2) {
        tu0 tu0Var = this.d;
        ArrayList arrayList = tu0Var.f28618f;
        jv0 jv0Var = tu0Var.f28623x;
    ...
    public final void p(s4.c1 c1Var, int i10) {
        bu0 bu0Var;
        tu0 tu0Var = this.d;
        wq0 wq0Var = tu0Var.f28619n;
        if (c1Var != null && (bu0Var = tu0Var.f28621s) != null) {
            bu0Var.d1(false);
        }
        if (i10 == 0) {
    ...
    public final SavedMessagesController.SavedDialog r(s4.c1 c1Var) {
        ...
        if (c1Var != null && (b10 = c1Var.b()) >= 0) {
            tu0 tu0Var = this.d;
            if (b10 < tu0Var.f28618f.size()) {
                return (SavedMessagesController.SavedDialog) tu0Var.f28618f.get(b10);
            }
        }
        return null;
    }
