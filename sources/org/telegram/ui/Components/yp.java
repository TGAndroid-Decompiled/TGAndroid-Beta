...
public final class yp extends NestedScrollView {
    ...
    public final void onDraw(Canvas canvas) {
        int i10;
        int i11;
        cq cqVar = this.f30313a0;
        int i12 = cqVar.f23121f;
        i10 = ((org.telegram.ui.ActionBar.f3) cqVar).backgroundPaddingTop;
        int scrollY = (int) ((getScrollY() + (i12 - i10)) - getTranslationY());
        Drawable drawable = cqVar.f23119b;
        int measuredWidth = getMeasuredWidth();
        i11 = ((org.telegram.ui.ActionBar.f3) cqVar).backgroundPaddingTop;
        drawable.setBounds(0, scrollY, measuredWidth, AndroidUtilities.dp(19.0f) + i11 + cqVar.f23120c.getMeasuredHeight() + scrollY);
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            cq cqVar = this.f30313a0;
            if (cqVar.f23121f != 0 && motionEvent.getY() < cqVar.f23121f) {
                cqVar.dismiss();
                return true;
            }
        }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (!this.f30313a0.isDismissed() && super.onTouchEvent(motionEvent)) {
            return true;
        }
        return false;
    }
