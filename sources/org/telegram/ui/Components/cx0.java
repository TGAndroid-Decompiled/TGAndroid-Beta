...
public final class cx0 extends Drawable {
    ...
    public final l5[] f26058c;
    public final boolean f26059e;
    public int d = 255;
    public final RectF f26060f = new RectF();
    public boolean f26061g = false;
    ...
    public cx0(int i10, ArrayList arrayList, boolean z4) {
        ...
        for (int i12 = 0; i12 < this.f26057b; i12++) {
            this.f26058c[i12] = l5.m(i10, i11, (TLRPC.Document) arrayList.get(i12));
        }
    }

    public final void a(org.telegram.ui.Cells.t1 t1Var) {
        for (int i10 = 0; i10 < this.f26057b; i10++) {
            this.f26058c[i10].o(t1Var);
        }
    }
    ...
    public final boolean c(ArrayList arrayList) {
        long j10;
        l5[] l5VarArr = this.f26058c;
        if (l5VarArr.length == arrayList.size()) {
            for (int i10 = 0; i10 < l5VarArr.length; i10++) {
                TLRPC.Document document = l5VarArr[i10].f28632e;
                if (document == null) {
                    j10 = 0;
                } else {
                    j10 = document.f20851id;
                }
                if (j10 == ((TLRPC.Document) arrayList.get(i10)).f20851id) {
                }
            }
            return true;
        }
            ...
            for (int i12 = 0; i12 < i10; i12++) {
                ...
                if (i13 >= 0) {
                    ...
                    if (i13 < l5VarArr.length && (l5Var = l5VarArr[i13]) != null) {
                        ...
                        if (this.f26059e) {
                            porterDuffColorFilter = org.telegram.ui.ActionBar.k6.f21997w3;
                        } else {
                            porterDuffColorFilter = org.telegram.ui.ActionBar.k6.f21978v3;
                        }
