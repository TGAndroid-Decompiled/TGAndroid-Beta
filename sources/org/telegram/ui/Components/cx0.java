...
public final class cx0 extends Drawable {
    ...
    public final o5[] f23150c;
    public final boolean e;
    public int d = 255;
    public final RectF f23151f = new RectF();
    public boolean f23152g = false;
    ...
    public cx0(int i10, ArrayList arrayList, boolean z10) {
        ...
        for (int i12 = 0; i12 < this.f23149b; i12++) {
            this.f23150c[i12] = o5.m(i10, i11, (TLRPC.Document) arrayList.get(i12));
        }
    }

    public final void a(org.telegram.ui.Cells.t1 t1Var) {
        for (int i10 = 0; i10 < this.f23149b; i10++) {
            this.f23150c[i10].o(t1Var);
        }
    }
            ...
            for (int i12 = 0; i12 < i10; i12++) {
                ...
                if (i13 >= 0) {
                    ...
                    if (i13 < o5VarArr.length && (o5Var = o5VarArr[i13]) != null) {
                        ...
                        if (this.e) {
                            porterDuffColorFilter = org.telegram.ui.ActionBar.j6.f19207w3;
                        } else {
                            porterDuffColorFilter = org.telegram.ui.ActionBar.j6.f19189v3;
                        }
