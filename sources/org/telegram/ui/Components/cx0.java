...
public final class cx0 extends kj0 {
    ...
    public final hx0 H;
    public int f23418r;
    public float f23419s;
    public ValueAnimator v;
    public boolean f23420w;
    public long f23421x;
    public float f23422y;

    public cx0(hx0 hx0Var, Context context) {
        super(context);
        int v02;
        org.telegram.ui.ActionBar.f6 f6Var = hx0Var.f29207p2;
        this.H = hx0Var;
        this.f23420w = false;
        this.f23422y = 1.0f;
        if (hx0Var.f24793w3) {
    ...
    public final void c() {
        this.f23420w = true;
        if (this.f23422y < 1.0f) {
            ValueAnimator valueAnimator = this.G;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                this.G = null;
            }
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f23422y, 1.0f);
            this.G = ofFloat;
    ...
    public final void draw(Canvas canvas) {
        ...
        float z10 = com.google.android.gms.internal.vision.e2.z(1.0f, this.E, 0.15f, 0.85f) * this.f23422y;
    ...
    public final void j() {
        if (System.currentTimeMillis() - this.f23421x > 250) {
            this.f23421x = System.currentTimeMillis();
    ...
    public final void l(boolean z10, boolean z11) {
        if (Math.abs(this.f23419s - (z10 ? 1.0f : 0.0f)) > 0.01f) {
    ...
    public final void m(float f7) {
        ...
        if (hx0Var.f24793w3) {
            ...
            k(i0.a.d(this.f23419s, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Me, f6Var), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Oe, f6Var)));
        }
        invalidate();
    }
