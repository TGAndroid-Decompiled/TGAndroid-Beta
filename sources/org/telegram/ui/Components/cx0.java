...
public final class cx0 extends FrameLayout {
    ...
    public final void a(float f7) {
        ...
        boolean z10 = this.f25140r;
        View view = this.f25139n;
        if (z10) {
            if (i10 == 1) {
                f10 = 24.0f;
            } else {
    ...
    public void setExpanded(boolean z10) {
        ...
        if (i11 != 2) {
            ...
            if (i11 != 1 && this.f25142w) {
                this.f25137e.setRoundRadius(AndroidUtilities.dp(view.getLayoutParams().width / 2.0f));
            }
        }
    }
}
