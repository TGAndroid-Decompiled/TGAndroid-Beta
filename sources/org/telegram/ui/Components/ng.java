...
public final class ng implements Runnable {
    ...
    public final void run() {
        ...
        switch (i10) {
            ...
            case 1:
                vc vcVar = (vc) obj;
                new rg.x0(vcVar.W(), 42, vcVar.f28687c).show();
                return;
            case 2:
            ...
            case 3:
                ...
                return;
            case 4:
                SparseArray sparseArray = o5.f26676q;
                ((o5) obj).v();
                return;
            case 5:
                k5 k5Var = (k5) obj;
                ArrayList arrayList = new ArrayList(k5Var.f25544c);
                k5Var.f25544c.clear();
            ...
            case 8:
                n6 n6Var = (n6) obj;
                CharSequence charSequence = n6Var.f26330f;
                ...
                return;
            case 9:
                ((g8) obj).f24245n.f24569n.setVisibility(8);
                return;
            case 10:
                ((m8) obj).f26116c.j1();
                return;
            ...
            case 12:
                ...
                if (!caVar.f23036a) {
                    da daVar2 = caVar.d;
                    Bitmap[] bitmapArr = daVar2.f23261g;
                    Canvas[] canvasArr = daVar2.h;
                    daVar2.f23261g = daVar2.f23260f;
                    daVar2.h = daVar2.f23262i;
                    daVar2.f23260f = bitmapArr;
                    daVar2.f23262i = canvasArr;
                    daVar2.f23264k = false;
            ...
            case 14:
                ha haVar2 = (ha) obj;
                haVar2.f24656o = haVar2.f24655n.f26131b;
                haVar2.d();
                return;
            case 15:
                oc ocVar = ((hb) obj).f24660b;
                sb sbVar = ocVar.e;
            ...
            case 18:
                ...
                return;
            case 19:
                ChatActivityEnterView chatActivityEnterView2 = ((qf) obj).f27318f;
            ...
            case 21:
                ...
                return;
            case 22:
                ok okVar = (ok) ((androidx.mediarouter.app.g) obj).f2723b;
                try {
                    File file = okVar.O;
                    if (file == null) {
                        okVar.O();
            ...
            case 23:
                ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout2 = ((xl) obj).f29994b;
                boolean z10 = ChatAttachAlertPhotoLayout.f21895q1;
                chatAttachAlertPhotoLayout2.p0(-1, true);
                return;
            case 24:
                ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout3 = ((ul) obj).f28423c;
                if (chatAttachAlertPhotoLayout3.P != null && !chatAttachAlertPhotoLayout3.f26461b.isDismissed()) {
            ...
            case 25:
                qm qmVar = (qm) obj;
                vi viVar = qmVar.f26461b;
                if (qmVar.Q && (chatAttachAlertPhotoLayout = viVar.f28759j0) != null) {
                    org.telegram.ui.ActionBar.f1 f1Var = chatAttachAlertPhotoLayout.f21905c1;
