...
public final class i8 extends vl0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        if (this.f24969n.f25327v0 && c1Var.b() == 0) {
            return false;
        }
        return true;
    }
    ...
    public final void E(String str) {
        if (this.f24968f != null) {
            Utilities.searchQueue.cancelRunnable(this.f24968f);
            this.f24968f = null;
        }
        if (str == null) {
            this.e = null;
    ...
    public final int h() {
        int size;
        j8 j8Var = this.f24969n;
        boolean z10 = j8Var.f25327v0;
        if (j8Var.f25308f) {
            size = this.d.size();
        } else if (j8Var.f25331x0.size() > 1) {
            size = j8Var.f25331x0.size();
        } else {
            return 0;
        }
        return size + (z10 ? 1 : 0);
    ...
    public final int j(int i10) {
        if (this.f24969n.f25327v0 && i10 == 0) {
            return 1;
        }
        return 0;
    }
    ...
    public final void l() {
            ...
            if (z11) {
                ...
                u7Var.animate().translationY(0.0f).setUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        ...
                        switch (r2) {
                            case 0:
                                viewGroup = ((org.telegram.ui.ActionBar.e3) this.f24097b.f24969n).containerView;
                                viewGroup.invalidate();
                                return;
                            default:
                                viewGroup2 = ((org.telegram.ui.ActionBar.e3) this.f24097b.f24969n).containerView;
        ...
        j8Var.v.setVisibility((j8Var.h && j8Var.f25323s.h() == 0) ? 8 : 8);
        j8Var.E0();
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        d6Var = ((org.telegram.ui.ActionBar.e3) this.f24969n).resourcesProvider;
