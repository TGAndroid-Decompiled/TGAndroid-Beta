...
public final class v60 extends kl0 {
    ...
    public final TLObject E(int i10) {
        int i11;
        int i12;
        b70 b70Var = this.f31143c;
        if (b70Var.m0 != null) {
            TLRPC.Dialog dialog = (TLRPC.Dialog) b70Var.f24580n0.get(i10 - b70Var.Y);
        ...
        return (TLObject) b70Var.f24572e0.get(i10 - b70Var.Y);
    }

    @Override
    public final int h() {
        return this.f31143c.f24570c0;
    }
    ...
    public final int j(int i10) {
        ...
        if (i10 == b70Var.f24569b0) {
            return 4;
        }
        if (i10 == b70Var.f24568a0) {
            return 5;
        }
        return 0;
    }
            ...
            if (i10 != 3) {
                if (i10 != 4) {
                    if (i10 != 5) {
                        ...
                        int i11 = org.telegram.ui.ActionBar.j6.f20846n5;
                        x4Var2.a(i11, i11);
                        x4Var = x4Var2;
                    } else {
