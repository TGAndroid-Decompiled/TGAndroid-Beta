...
public final class v60 implements org.telegram.ui.qb0 {
    ...
    public final void b(TLRPC.TL_chatInviteExported tL_chatInviteExported, TLObject tLObject) {
        int i10;
        org.telegram.ui.hb hbVar = this.f29066a.f29905a.f30272c.f23267j0;
        if (hbVar != null) {
            ...
            if (new MessageObject(i10, tL_channelAdminLogEvent, (ArrayList<MessageObject>) ubVar.f38405n0, (HashMap<String, ArrayList<MessageObject>>) ubVar.m0, ubVar.f38396f, ubVar.T, true).contentType >= 0) {
                ubVar.R0();
                ubVar.E.l();
