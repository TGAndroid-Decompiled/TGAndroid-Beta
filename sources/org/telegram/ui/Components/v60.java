...
public final class v60 extends kl0 {
    ...
    public final TLObject E(int i10) {
        int i11;
        int i12;
        b70 b70Var = this.f28639c;
        if (b70Var.m0 != null) {
            TLRPC.Dialog dialog = (TLRPC.Dialog) b70Var.f22683n0.get(i10 - b70Var.Y);
            if (DialogObject.isUserDialog(dialog.f18116id)) {
                i12 = ((org.telegram.ui.ActionBar.f3) b70Var).currentAccount;
                return MessagesController.getInstance(i12).getUser(Long.valueOf(dialog.f18116id));
            }
            i11 = ((org.telegram.ui.ActionBar.f3) b70Var).currentAccount;
            return MessagesController.getInstance(i11).getChat(Long.valueOf(-dialog.f18116id));
        }
        return (TLObject) b70Var.f22675e0.get(i10 - b70Var.Y);
    }

    @Override
    public final int h() {
        return this.f28639c.f22673c0;
    }
    ...
    public final int j(int i10) {
        ...
        if (i10 == b70Var.f22672b0) {
            return 4;
        }
        if (i10 == b70Var.f22671a0) {
            return 5;
        }
        return 0;
    }
        ...
        if (i11 != 2) {
            if (i11 == 3) {
                ...
                if (E instanceof TLRPC.User) {
                    j10 = ((TLRPC.User) E).f18259id;
                } else if (E instanceof TLRPC.Chat) {
                    j10 = -((TLRPC.Chat) E).f18112id;
                } else {
                    j10 = 0;
                }
                if (j10 != 0) {
            ...
            if (i10 != 3) {
                if (i10 != 4) {
                    if (i10 != 5) {
                        ...
                        int i11 = org.telegram.ui.ActionBar.i6.f19020n5;
                        x4Var2.a(i11, i11);
                        x4Var = x4Var2;
                    } else {
