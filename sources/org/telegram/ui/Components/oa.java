...
public final class oa {
    ...
    public Bitmap f27017b;
    public final Paint f27018c;
    public final int d;
    public final Runnable e;
    public org.telegram.messenger.y7 f27019f;
    ...
    public final void a() {
        ...
        if (this.f27019f != null) {
            Utilities.globalQueue.cancelRunnable(this.f27019f);
        }
        Bitmap bitmap = this.f27017b;
        if (bitmap != null && !bitmap.isRecycled()) {
            this.f27017b.recycle();
        }
        this.f27017b = null;
    }
