...
public final class oa {
    ...
    public Bitmap f29040b;
    public final Paint f29041c;
    public final int d;
    public final Runnable f29042e;
    public org.telegram.messenger.y7 f29043f;

    public oa(int i10, Runnable runnable) {
        Paint paint = new Paint(1);
        this.f29041c = paint;
        this.d = i10;
        this.f29042e = runnable;
    ...
    public final void a() {
        ...
        if (this.f29043f != null) {
            Utilities.globalQueue.cancelRunnable(this.f29043f);
        }
        Bitmap bitmap = this.f29040b;
        if (bitmap != null && !bitmap.isRecycled()) {
            this.f29040b.recycle();
        }
        this.f29040b = null;
    }
