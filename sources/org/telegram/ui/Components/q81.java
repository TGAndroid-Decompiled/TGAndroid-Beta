...
public final class q81 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.e6 f27281a;
    public final sl0 f27282b;
    public final RectF f27283c;
    ...
    public q81(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        sl0Var.A = v02;
        sl0Var.f27928z = v02;
        sl0Var.f27926x = org.telegram.ui.ActionBar.i6.l1(0.1f, v02);
        sl0Var.f27913j = false;
        sl0Var.f27912i = false;
        sl0Var.k();
    }

    @Override
    public final void onDraw(Canvas canvas) {
        RectF rectF = this.f27283c;
        rectF.set(0.0f, 0.0f, getWidth(), getHeight());
        sl0 sl0Var = this.f27282b;
        float[] fArr = sl0Var.e;
        ...
        this.f27282b.d(canvas, rectF, 1.0f, false, false);
        RectF rectF2 = this.d;
    ...
    public void setWebPage(TLRPC.WebPage webPage) {
        ...
        org.telegram.ui.ActionBar.e6 e6Var = this.f27281a;
        if (str != null) {
        ...
        if (webPage.description != null) {
            ...
            textView3.setTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18940j5, e6Var));
        ...
        if (z10) {
            ...
            u9Var.setBackground(org.telegram.ui.ActionBar.i6.b0(AndroidUtilities.dp(6.0f), org.telegram.ui.ActionBar.i6.l1(0.08f, org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18940j5, e6Var))));
