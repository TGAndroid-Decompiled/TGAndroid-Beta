...
public final class xy0 extends View {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f30489b != null) {
            ...
            this.f30489b.setBounds(getPaddingLeft(), getPaddingTop(), getWidth() - getPaddingRight(), getHeight() - getPaddingBottom());
    ...
    public void setImageDrawable(Drawable drawable) {
        ...
        if ((drawable instanceof q5) && this.f30490c) {
            ((q5) drawable).a(this);
        }
    }
