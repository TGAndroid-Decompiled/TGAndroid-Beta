...
public final class nw0 extends kl0 {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        sw0[] sw0VarArr;
        boolean z10 = true;
        if (c1Var.f42674f == 1 && (sw0VarArr = (ww0Var = this.d).Y2) != null) {
            int i11 = i10 - 1;
            sw0 sw0Var = sw0VarArr[i11];
            final rw0 rw0Var = (rw0) c1Var.f42671a;
            if (ww0Var.f29808m3 != i11) {
                z10 = false;
            }
            rw0Var.getClass();
            if (!TextUtils.isEmpty(sw0Var.d)) {
                rw0Var.setContentDescription(sw0Var.d);
            } else if (!TextUtils.isEmpty(sw0Var.f27980a)) {
                rw0Var.setContentDescription(sw0Var.f27980a);
            } else {
            ...
            rw0Var.f27695w = false;
            rw0Var.f27697y = 1.0f;
            o5.h(UserConfig.selectedAccount).b(sw0Var.f27982c, new l5() {
                @Override
            ...
            rw0Var.l(z10, false);
            rw0Var.setAlpha(ww0Var.f29810o3);
            rw0Var.setScaleX(ww0Var.f29810o3);
            rw0Var.setScaleY(ww0Var.f29810o3);
            rw0Var.j();
        }
    }
    ...
    public final void y(s4.c1 c1Var) {
        boolean z10 = true;
        if (c1Var.f42674f == 1) {
            rw0 rw0Var = (rw0) c1Var.f42671a;
            if (this.d.f29808m3 != c1Var.b() - 1) {
                z10 = false;
            }
            rw0Var.l(z10, false);
            rw0Var.j();
