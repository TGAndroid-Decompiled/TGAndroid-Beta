...
public final class qw0 extends aj0 {
    ...
    public final vw0 H;
    public int f29854r;
    public float f29855s;
    public ValueAnimator v;
    public boolean f29856w;
    public long f29857x;
    public float f29858y;

    public qw0(vw0 vw0Var, Context context) {
        super(context);
        int v02;
        org.telegram.ui.ActionBar.f6 f6Var = vw0Var.f28251p2;
        this.H = vw0Var;
        this.f29856w = false;
        this.f29858y = 1.0f;
        if (vw0Var.f32042w3) {
    ...
    public final void c() {
        this.f29856w = true;
        if (this.f29858y < 1.0f) {
            ValueAnimator valueAnimator = this.G;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                this.G = null;
            }
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f29858y, 1.0f);
            this.G = ofFloat;
    ...
    public final void draw(Canvas canvas) {
        ...
        float z10 = com.google.android.gms.internal.vision.e2.z(1.0f, this.E, 0.15f, 0.85f) * this.f29858y;
    ...
    public final void j() {
        if (System.currentTimeMillis() - this.f29857x > 250) {
            this.f29857x = System.currentTimeMillis();
    ...
    public final void l(boolean z10, boolean z11) {
        if (Math.abs(this.f29855s - (z10 ? 1.0f : 0.0f)) > 0.01f) {
    ...
    public final void m(float f7) {
        ...
        if (vw0Var.f32042w3) {
            ...
            k(i0.a.d(this.f29855s, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Me, f6Var), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Oe, f6Var)));
        }
        invalidate();
    }
