...
public final class qw0 extends aj0 {
    ...
    public qw0(vw0 vw0Var, Context context) {
        super(context);
        int v02;
        org.telegram.ui.ActionBar.f6 f6Var = vw0Var.f28225p2;
        this.H = vw0Var;
        this.f29830w = false;
        this.f29832y = 1.0f;
        if (vw0Var.f32016w3) {
    ...
    public final void c() {
        this.f29830w = true;
        if (this.f29832y < 1.0f) {
            ValueAnimator valueAnimator = this.G;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                this.G = null;
            }
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f29832y, 1.0f);
            this.G = ofFloat;
    ...
    public final void draw(Canvas canvas) {
        ...
        float z10 = com.google.android.gms.internal.vision.e2.z(1.0f, this.E, 0.15f, 0.85f) * this.f29832y;
    ...
    public final void j() {
        if (System.currentTimeMillis() - this.f29831x > 250) {
            this.f29831x = System.currentTimeMillis();
    ...
    public final void l(boolean z10, boolean z11) {
        if (Math.abs(this.f29829s - (z10 ? 1.0f : 0.0f)) > 0.01f) {
    ...
    public final void m(float f7) {
        ...
        if (vw0Var.f32016w3) {
            ...
            k(i0.a.d(this.f29829s, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Me, f6Var), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Oe, f6Var)));
        }
        invalidate();
    }
