...
public final class fq0 extends ll0 {
    public final Context f23978c;
    public boolean d;
    public boolean e;
    public ArrayList f23979f;
    public final iq0 h;
    ...
    public final TLRPC.TL_forumTopic E(int i10) {
        ...
        ArrayList arrayList = this.f23979f;
        if (arrayList != null && i11 >= 0 && i11 < arrayList.size()) {
            return (TLRPC.TL_forumTopic) this.f23979f.get(i11);
        }
        return null;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        int dp;
        if (c1Var.f42700f == 0) {
            org.telegram.ui.Cells.g7 g7Var = (org.telegram.ui.Cells.g7) c1Var.f42697a;
            if (i10 == 1 && this.d) {
                g7Var.setAsNewBotForumTopic(this.e);
            } else if (this.f23979f != null) {
                ...
                org.telegram.ui.Cells.d7 d7Var = g7Var.f20156b;
                int i11 = g7Var.f20158f;
                u9 u9Var = g7Var.f20155a;
                TextView textView = g7Var.f20157c;
                if (dialog != null) {
                    ...
                    if (ChatObject.isMonoForum(chat)) {
                        ...
                        if (DialogObject.isUserDialog(peerDialogId)) {
                            ...
                            textView.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18969j5, g7Var.h));
                            d7Var.m(i11, user);
                            if (user != null) {
