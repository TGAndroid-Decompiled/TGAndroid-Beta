...
public final class fq0 extends aw0 {
    ...
    public final RectF f24241x0;
    public boolean f24242y0;
    public int f24243z0;
    ...
    public fq0(uq0 uq0Var, Context context) {
        ...
        this.H0 = uq0Var;
        this.f24240w0 = false;
        this.f24241x0 = new RectF();
        this.H = new eq0(this, this);
        this.F0 = AndroidUtilities.computePerceivedBrightness(uq0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19115h5)) > 0.721f;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        canvas.save();
        canvas.clipRect(0.0f, getPaddingTop() + uq0Var.f28885t0, getMeasuredWidth(), getMeasuredHeight() + uq0Var.f28885t0 + AndroidUtilities.dp(50.0f));
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (view instanceof lz) {
            ...
            if (uq0Var.V0 != null) {
                ...
                canvas.clipPath(uq0Var.V0.f4280j.f4269k);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        FrameLayout frameLayout = uq0Var.f28888w;
        canvas.translate(0.0f, uq0Var.f28885t0);
        int i17 = uq0Var.f28879p0;
        i10 = ((org.telegram.ui.ActionBar.e3) uq0Var).backgroundPaddingTop;
        int dp2 = AndroidUtilities.dp(6.0f) + (i17 - i10) + this.f24243z0;
        int i18 = uq0Var.f28879p0;
        i11 = ((org.telegram.ui.ActionBar.e3) uq0Var).backgroundPaddingTop;
        int dp3 = ((i18 - i11) - AndroidUtilities.dp(13.0f)) + this.f24243z0;
        uq0Var.X = dp3;
        ...
        boolean z13 = true;
        if (!z10) {
            dp2 += uq0Var.G0.f10577b;
            if (this.f24242y0) {
                i16 = ((org.telegram.ui.ActionBar.e3) uq0Var).backgroundPaddingTop;
                if (i16 + dp3 < uq0Var.G0.f10577b) {
                    z12 = true;
                    int i20 = dp3 + uq0Var.G0.f10577b;
            ...
            z12 = false;
            int i202 = dp3 + uq0Var.G0.f10577b;
            i15 = ((org.telegram.ui.ActionBar.e3) uq0Var).backgroundPaddingTop;
            f7 = this.G0.e(z12);
        ...
        if (frameLayout != null) {
            if (dp3 > uq0Var.G0.f10577b || frameLayout.getChildCount() <= 0) {
        ...
        if (f7 < 1.0f) {
            ...
            RectF rectF = this.f24241x0;
            rectF.set((getMeasuredWidth() - dp) / 2, f10, measuredWidth, dp5);
            org.telegram.ui.ActionBar.h6.f19334t0.setColor(uq0Var.getThemedColor(org.telegram.ui.ActionBar.h6.Ii));
            org.telegram.ui.ActionBar.h6.f19334t0.setAlpha((int) ((1.0f - f7) * paint.getAlpha()));
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            if (this.F0 && 0 > uq0Var.G0.f10577b * 0.5f) {
                z11 = true;
            } else {
                z11 = false;
            }
        ...
        canvas.restore();
        this.A0 = this.f24243z0;
    }

    @Override
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        boolean z10 = this.f24242y0;
        uq0 uq0Var = this.H0;
        if (!z10) {
            if (motionEvent.getAction() == 0 && motionEvent.getY() < this.f24243z0 - AndroidUtilities.dp(30.0f)) {
                uq0Var.dismiss();
                return true;
            }
        } else if (motionEvent.getAction() == 0 && uq0Var.f28879p0 != 0 && motionEvent.getY() < uq0Var.f28879p0 - AndroidUtilities.dp(30.0f)) {
            uq0Var.dismiss();
            return true;
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        wp0 wp0Var = uq0Var.G;
        FrameLayout frameLayout = uq0Var.f28865c0;
        wp0 wp0Var2 = uq0Var.F;
        wl0 wl0Var = uq0Var.E;
        ...
        pzVar.G = z11;
        z12 = ((org.telegram.ui.ActionBar.e3) uq0Var).isFullscreen;
        if (!z12) {
            fq0Var.f24240w0 = true;
            i20 = ((org.telegram.ui.ActionBar.e3) uq0Var).backgroundPaddingLeft;
            int i23 = uq0Var.G0.f10577b;
            i21 = ((org.telegram.ui.ActionBar.e3) uq0Var).backgroundPaddingLeft;
            fq0Var.setPadding(i20, i23, i21, 0);
            fq0Var.f24240w0 = false;
        }
        ...
        if (wl0Var.getVisibility() != 8) {
            ...
            int D2 = org.telegram.messenger.f0.D(103.0f, Math.max(2, (int) Math.ceil((uq0Var.L.h() - 1) / 4.0f)), AndroidUtilities.dp(48.0f) + dp);
            i19 = ((org.telegram.ui.ActionBar.e3) uq0Var).backgroundPaddingTop;
            int i25 = i19 + D2;
            if (i25 > i24) {
                i24 = AndroidUtilities.lerp(i24, i25, wl0Var.getAlpha());
            }
        }
        if (i24 < paddingTop) {
            i13 = 0;
        ...
        if (wp0Var2.getPaddingTop() != i13 || wp0Var2.getPaddingBottom() != dp2) {
            ...
            wl0Var.setPadding(0, i13, 0, dp2);
            fq0Var.f24240w0 = false;
        }
        z13 = ((org.telegram.ui.ActionBar.e3) uq0Var).keyboardVisible;
        ...
        FrameLayout frameLayout2 = uq0Var.f28881r;
        zp0 zp0Var = uq0Var.d;
        int i27 = size2 - (i16 * 2);
        int R = fq0Var.R();
        uq0Var.N0 = R;
        ...
        if (uq0Var.N0 <= AndroidUtilities.dp(20.0f)) {
            if (!AndroidUtilities.isInMultiwindow) {
                z15 = ((org.telegram.ui.ActionBar.e3) uq0Var).keyboardVisible;
                if (z15) {
                    emojiPadding = 0;
                } else {
            ...
            if (childAt != null && childAt.getVisibility() != i17) {
                if (zp0Var.l(childAt)) {
                    if (!AndroidUtilities.isInMultiwindow && !AndroidUtilities.isTablet()) {
                        ...
                        childAt.measure(View.MeasureSpec.makeMeasureSpec(i27, 1073741824), View.MeasureSpec.makeMeasureSpec(Math.min(AndroidUtilities.dp(200.0f), fq0Var.getPaddingTop() + (i29 - uq0Var.G0.f10577b)), 1073741824));
                    } else {
                        childAt.measure(View.MeasureSpec.makeMeasureSpec(i27, 1073741824), View.MeasureSpec.makeMeasureSpec(fq0Var.getPaddingTop() + (i29 - uq0Var.G0.f10577b), 1073741824));
                    }
                } else {
