...
public final class m0 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        switch (this.f26026a) {
            case 0:
                uc0 uc0Var = (uc0) this.f26027b;
                uc0 uc0Var2 = (uc0) this.e;
                uc0 uc0Var3 = (uc0) this.f26029f;
                Calendar calendar = (Calendar) this.f26028c;
                ...
                return;
            case 1:
                uc0 uc0Var4 = (uc0) this.f26027b;
                e4 e4Var = (e4) this.e;
                f4 f4Var = (f4) this.f26029f;
                Calendar calendar2 = (Calendar) this.f26028c;
                ...
                ((boolean[]) rv0Var.f37213c)[0] = true;
                ((org.telegram.ui.w51) rv0Var.f37212b).e(Integer.valueOf(timeInMillis));
                runnable2 = a3Var.f18440a.dismissRunnable;
                runnable2.run();
                return;
            case 2:
                uc0 uc0Var5 = (uc0) this.f26027b;
                v3 v3Var = (v3) this.e;
                x3 x3Var = (x3) this.f26029f;
                Calendar calendar3 = (Calendar) this.f26028c;
                b5 b5Var = (b5) this.h;
                ...
                runnable3 = a3Var2.f18440a.dismissRunnable;
                runnable3.run();
                return;
            case 3:
                vx0.x((vx0) this.f26027b, (int[]) this.e, (EditTextBoldCursor) this.f26029f, (TextView) this.f26028c, (TextView) this.h, (AlertDialog$Builder) this.d);
                return;
            case 4:
                org.telegram.ui.ActionBar.f3 f3Var = (org.telegram.ui.ActionBar.f3) this.f26027b;
                ArrayList arrayList = (ArrayList) this.f26029f;
                int[] iArr = (int[]) this.f26028c;
                f9 f9Var = (f9) this.h;
                u9 u9Var = (u9) this.d;
                ...
                return;
            default:
                Calendar calendar4 = (Calendar) this.f26028c;
                calendar4.setTimeInMillis((((uc0) this.f26027b).getValue() * 86400000) + System.currentTimeMillis());
                calendar4.set(11, ((tg.i) this.e).getValue());
                calendar4.set(12, ((tg.j) this.f26029f).getValue() * 5);
                ((tg.v) this.h).J((int) (calendar4.getTimeInMillis() / 1000), 0, true);
                runnable4 = ((org.telegram.ui.ActionBar.a3) this.d).f18440a.dismissRunnable;
                runnable4.run();
                return;
        }
    }
