...
public final class m0 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        switch (this.f26308a) {
            case 0:
                ed0 ed0Var = (ed0) this.f26309b;
                ed0 ed0Var2 = (ed0) this.e;
                ed0 ed0Var3 = (ed0) this.f26311f;
                Calendar calendar = (Calendar) this.f26310c;
                ...
                return;
            case 1:
                ed0 ed0Var4 = (ed0) this.f26309b;
                g4 g4Var = (g4) this.e;
                h4 h4Var = (h4) this.f26311f;
                Calendar calendar2 = (Calendar) this.f26310c;
                ...
                ((boolean[]) ds0Var.f33163c)[0] = true;
                ((org.telegram.ui.p51) ds0Var.f33162b).e(Integer.valueOf(timeInMillis));
                runnable2 = z2Var.f19935a.dismissRunnable;
                runnable2.run();
                return;
            case 2:
                ed0 ed0Var5 = (ed0) this.f26309b;
                x3 x3Var = (x3) this.e;
                z3 z3Var = (z3) this.f26311f;
                Calendar calendar3 = (Calendar) this.f26310c;
                d5 d5Var = (d5) this.h;
                ...
                runnable3 = z2Var2.f19935a.dismissRunnable;
                runnable3.run();
                return;
            case 3:
                fy0.x((fy0) this.f26309b, (int[]) this.e, (EditTextBoldCursor) this.f26311f, (TextView) this.f26310c, (TextView) this.h, (AlertDialog$Builder) this.d);
                return;
            case 4:
                org.telegram.ui.ActionBar.e3 e3Var = (org.telegram.ui.ActionBar.e3) this.f26309b;
                ArrayList arrayList = (ArrayList) this.f26311f;
                int[] iArr = (int[]) this.f26310c;
                h9 h9Var = (h9) this.h;
                w9 w9Var = (w9) this.d;
                ...
                return;
            default:
                Calendar calendar4 = (Calendar) this.f26310c;
                calendar4.setTimeInMillis((((ed0) this.f26309b).getValue() * 86400000) + System.currentTimeMillis());
                calendar4.set(11, ((tg.g) this.e).getValue());
                calendar4.set(12, ((tg.h) this.f26311f).getValue() * 5);
                ((tg.u) this.h).J((int) (calendar4.getTimeInMillis() / 1000), 0, true);
                runnable4 = ((org.telegram.ui.ActionBar.z2) this.d).f19935a.dismissRunnable;
                runnable4.run();
                return;
        }
    }
