        ...
        switch (this.f30442l0) {
            case 0:
                ...
                if (!messageObject.isVoice() && !messageObject.isRoundVideo()) {
                    ...
                    return MediaController.getInstance().setPlaylist(tt0Var.d, messageObject, tt0Var.v.f32711c1);
                }
            ...
            default:
                ...
                int i10 = ku0Var.d;
                xu0 xu0Var = ku0Var.f27933f;
                if (!messageObject.isVoice() && !messageObject.isRoundVideo()) {
                    if (!messageObject.isMusic()) {
                        return false;
                    }
                    return MediaController.getInstance().setPlaylist(xu0Var.f32749t1[i10].f28543a, messageObject, xu0Var.f32711c1);
                }
                boolean playMessage2 = MediaController.getInstance().playMessage(messageObject);
                MediaController mediaController2 = MediaController.getInstance();
                if (playMessage2) {
                    arrayList2 = xu0Var.f32749t1[i10].f28543a;
                } else {
                    arrayList2 = null;
                }
