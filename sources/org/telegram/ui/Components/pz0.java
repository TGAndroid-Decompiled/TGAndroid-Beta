...
public final class pz0 extends TableLayout {
    public final org.telegram.ui.ActionBar.e6 f27202a;
    public final Path f27203b;
    ...
    public pz0(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
        this.f27203b = new Path();
        this.f27204c = new float[8];
        this.d = new Paint(1);
        this.e = new Paint(1);
    ...
    public final nz0 a(CharSequence charSequence) {
        ...
        org.telegram.ui.ActionBar.e6 e6Var = this.f27202a;
    ...
    public final void b(CharSequence charSequence, ArrayList arrayList) {
        ...
        w5Var.setTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.G6, this.f27202a));
    ...
    public final TableRow c(CharSequence charSequence, CharSequence charSequence2, oz0[] oz0VarArr, xc[] xcVarArr) {
        ...
        c90Var.setTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.G6, this.f27202a));
        ...
        tableRow.addView(new mz0(this, c90Var, false), new TableRow.LayoutParams(0, -1, 1.0f));
        addView(tableRow);
        if (xcVarArr != 0) {
            xcVarArr[0] = c90Var;
        }
    ...
    public final void h(String str, CharSequence charSequence, int i10, uh.i iVar) {
        ...
        int i12 = org.telegram.ui.ActionBar.i6.f19166v6;
    ...
    public final TableRow j(CharSequence charSequence, int i10, long j3, Runnable runnable, String str, Runnable runnable2) {
        ...
        ImageReceiver imageReceiver = g5Var.f33758b;
        if (j3 == 2666000) {
        ...
        if (str != null) {
            c90Var.M = new yc(str, runnable2, e6Var);
        }
        c90Var.setText(spannableStringBuilder);
        if (!z10) {
    ...
    public final TableRow l(String str, final int i10, final long j3, Runnable runnable) {
        ...
        m5Var.J = 0;
        a90Var.addOnAttachStateChangeListener(new ai.u2(m5Var, 9));
        ...
        Utilities.Callback<Object[]> callback = new Utilities.Callback() {
            ...
            public final void run(java.lang.Object r12) {
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.lz0.run(java.lang.Object):void");
            }
        };
        callback.run(null);
        a90Var.i(m5Var);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        paint.setStrokeWidth(this.f27205f);
        int i14 = org.telegram.ui.ActionBar.i6.f19084qh;
        org.telegram.ui.ActionBar.e6 e6Var = this.f27202a;
        paint.setColor(org.telegram.ui.ActionBar.i6.v0(i14, e6Var));
        Paint.Style style2 = Paint.Style.FILL;
        Paint paint2 = this.d;
        paint2.setStyle(style2);
        paint2.setColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19066ph, e6Var));
            ...
            if (getChildAt(i15) instanceof TableRow) {
                ...
                for (int i16 = 0; i16 < childCount2; i16++) {
                    ...
                    if (childAt instanceof oz0) {
                        ...
                        if (oz0Var.f26914b != z15 || oz0Var.f26915c != z16) {
                            oz0Var.f26914b = z15;
                            oz0Var.f26915c = z16;
                            oz0Var.invalidate();
                        }
                        ...
                        if (mz0Var.f26268b != z12 || mz0Var.f26269c != z13) {
                            mz0Var.f26268b = z12;
                            mz0Var.f26269c = z13;
                            mz0Var.invalidate();
                        }
                        ...
                        if (nz0Var.f26630c != z11 || nz0Var.d != z16) {
                            nz0Var.f26630c = z11;
                            nz0Var.d = z16;
                            nz0Var.invalidate();
                        }
