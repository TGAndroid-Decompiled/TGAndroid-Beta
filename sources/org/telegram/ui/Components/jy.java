...
public final class jy extends ll0 {
    public boolean E;
    public final kz F;
    public final ey f25461c;
    public long d;
    public TLRPC.StickerSet e;
    public ArrayList f25462f;
    public final ArrayList h = new ArrayList();
    public final ArrayList f25463n = new ArrayList();
    public final ArrayList f25464r = new ArrayList();
    public final ArrayList f25465s = new ArrayList();
    public String v;
    public String f25466w;
    public iy f25467x;
    public boolean f25468y;

    public jy(kz kzVar, Context context) {
        this.F = kzVar;
        ?? aVar = new nh.a(context, kzVar.f25716c1, new d(this, 11), new lv(this, 1), kzVar.Z1);
        this.f25461c = aVar;
    ...
    public static void E(jy jyVar, Runnable runnable, ArrayList arrayList, boolean z10) {
        ...
        MediaDataController.getInstance(kzVar.f25716c1).searchStickers(true, str2, str3, new ai.e4((Object) jyVar, str3, arrayList, (Object) runnable, 8), z10);
    }
    ...
    public final void F(String str, boolean z10) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            this.d = 0L;
            kzVar.f25710b.a(false, true);
            l();
        } else {
            this.v = str.toLowerCase();
        }
        iy iyVar = this.f25467x;
        if (iyVar != null) {
    ...
    public final int h() {
        if (this.d != 0) {
            return this.f25462f.size() + 4;
        }
        ArrayList arrayList = this.h;
        boolean isEmpty = arrayList.isEmpty();
        ArrayList arrayList2 = this.f25465s;
        ArrayList arrayList3 = this.f25464r;
        if (isEmpty && arrayList3.isEmpty() && arrayList2.isEmpty() && !this.f25468y) {
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 != 3) {
                    ...
                    f0Var = new org.telegram.ui.Cells.o8(kzVar.getContext(), true, false, kzVar.Z1, kzVar.f25736i2);
                }
            } else {
                View view3 = new View(kzVar.getContext());
                view3.setLayoutParams(new s4.p0(-1, kzVar.f25712b1));
                f0Var = view3;
            }
        } else {
