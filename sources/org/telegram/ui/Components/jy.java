...
public final class jy extends kl0 {
    public boolean E;
    public final kz F;
    public final ey f25447c;
    public long d;
    public TLRPC.StickerSet e;
    public ArrayList f25448f;
    public final ArrayList h = new ArrayList();
    public final ArrayList f25449n = new ArrayList();
    public final ArrayList f25450r = new ArrayList();
    public final ArrayList f25451s = new ArrayList();
    public String v;
    public String f25452w;
    public iy f25453x;
    public boolean f25454y;

    public jy(kz kzVar, Context context) {
        this.F = kzVar;
        ?? aVar = new nh.a(context, kzVar.f25700c1, new d(this, 11), new lv(this, 1), kzVar.Z1);
        this.f25447c = aVar;
    ...
    public static void E(jy jyVar, Runnable runnable, ArrayList arrayList, boolean z10) {
        ...
        MediaDataController.getInstance(kzVar.f25700c1).searchStickers(true, str2, str3, new ai.e4((Object) jyVar, str3, arrayList, (Object) runnable, 8), z10);
    }
    ...
    public final void F(String str, boolean z10) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            this.d = 0L;
            kzVar.f25694b.a(false, true);
            l();
        } else {
            this.v = str.toLowerCase();
        }
        iy iyVar = this.f25453x;
        if (iyVar != null) {
    ...
    public final int h() {
        if (this.d != 0) {
            return this.f25448f.size() + 4;
        }
        ArrayList arrayList = this.h;
        boolean isEmpty = arrayList.isEmpty();
        ArrayList arrayList2 = this.f25451s;
        ArrayList arrayList3 = this.f25450r;
        if (isEmpty && arrayList3.isEmpty() && arrayList2.isEmpty() && !this.f25454y) {
            ...
            if (i10 != 1) {
                if (i10 != 3) {
                    if (i10 != 4) {
                        ...
                        View view2 = this.f25447c;
                        view2.setLayoutParams(p0Var);
                        f0Var = view2;
                    }
                } else {
                    f0Var = new org.telegram.ui.Cells.o8(kzVar.getContext(), true, false, kzVar.Z1, kzVar.f25720i2);
                }
            } else {
                View view3 = new View(kzVar.getContext());
                view3.setLayoutParams(new s4.p0(-1, kzVar.f25696b1));
                f0Var = view3;
            }
        } else {
