...
public final class gb0 extends org.telegram.ui.Cells.r9 {
    ...
    public gb0(pb0 pb0Var) {
        this.B0 = pb0Var;
        this.f19951h0 = pb0Var.f27001c0.F;
    }

    @Override
    public final boolean A(MessageObject messageObject) {
        pb0 pb0Var = this.B0;
        if (pb0Var.f26996a == 0 && !pb0Var.f27001c0.d.isSecret && y()) {
            return true;
        }
        return false;
    }
    ...
    public final void J(int i10, int i11, MessageObject messageObject) {
        ...
        pb0 pb0Var = this.B0;
        gb0 gb0Var = pb0Var.e;
        int i12 = gb0Var.v - gb0Var.f19975u;
        vb0 vb0Var = pb0Var.f27001c0;
        if (i12 > MessagesController.getInstance(vb0Var.f28685w).quoteLengthMax) {
            pb0Var.f();
            return;
        }
        ...
        if (c10 != null && ((rnVar = vb0Var.d.quote) == null || (messageObject2 = rnVar.f37153a) == null || messageObject2.getId() != c10.getId())) {
    ...
    public final boolean b() {
        ...
        pb0 pb0Var = this.B0;
        if (pb0Var.f26996a == 0 && (c10 = pb0Var.c(null)) != null && (message = c10.messageOwner) != null && message.rich_message != null) {
            return false;
        }
    ...
    public final boolean e() {
        ...
        TLRPC.Message message;
        pb0 pb0Var = this.B0;
        int i10 = pb0Var.f26996a;
        if (i10 == 0 && !pb0Var.f27001c0.d.isSecret) {
