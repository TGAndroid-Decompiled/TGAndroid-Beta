...
public final class ve extends FrameLayout {
    public final Paint f31207a;
    public final RectF f31208b;
    public final org.telegram.ui.ActionBar.f6 f31209c;
        ...
        if (!chatActivityEnterView.f23731k5) {
            ...
            if (motionEvent.getAction() == 0) {
                if (ChatActivityEnterView.this.f23766r4) {
                    boolean z10 = chatActivityEnterView.f23685d2;
                    if (!z10 || chatActivityEnterView.I3) {
                        chatActivityEnterView.C2 = -1.0f;
                        if (z10 && chatActivityEnterView.f23678c1) {
                            if (e5.d0(chatActivityEnterView.Q, chatActivityEnterView.P2)) {
                                ...
                                e5.a0(chatActivityEnterView.Q, 1, chatActivityEnterView.P2, new Utilities.Callback(this) {
                                    ...
                                    public final void run(Object obj) {
                                        ...
                                        switch (r2) {
                                            case 0:
                                                this.f30268b.d.T0(0, true, 0, false, l4.longValue());
                                                return;
                                            case 1:
                                                this.f30268b.d.T0(0, true, 0, false, l4.longValue());
                                                return;
                            ...
                            if (chatActivityEnterView.E2 && chatActivityEnterView.c()) {
                                ...
                                org.telegram.ui.ActionBar.f6 f6Var = this.f31209c;
                            ...
                            if (e5.d0(chatActivityEnterView.Q, chatActivityEnterView.P2)) {
                                if (chatActivityEnterView.f23678c1) {
                                    ...
                                    ChatActivityEnterView.SlideTextView slideTextView3 = chatActivityEnterView.f23722j1;
                        ...
                        chatActivityEnterView.f23703g0 = false;
                        Runnable runnable = new Runnable(this) {
                            public final ve f30595b;
                            ...
                            public final void run() {
                                switch (r2) {
                                    case 0:
                                        ChatActivityEnterView chatActivityEnterView2 = this.f30595b.d;
                                        chatActivityEnterView2.f23697f0 = null;
                                        chatActivityEnterView2.L1(1, true);
                                        return;
                                    default:
                                        ChatActivityEnterView chatActivityEnterView3 = this.f30595b.d;
                                        chatActivityEnterView3.f23697f0 = null;
                                        chatActivityEnterView3.L1(1, true);
                                        return;
                                }
                            }
                        };
                        chatActivityEnterView.f23697f0 = runnable;
                ...
                if (coVar == null) {
                    ...
                    userFull = coVar.f35193a8;
                }
                if ((chat != null && !ChatObject.canSendVoice(chat) && (!ChatObject.canSendRoundVideo(chat) || !chatActivityEnterView.f23685d2)) || (userFull != null && userFull.voice_messages_forbidden)) {
                    chatActivityEnterView.Y2.a2();
                    return true;
                } else if (chatActivityEnterView.f23685d2) {
            ...
            if (motionEvent.getAction() != 1 && motionEvent.getAction() != 3) {
                if (motionEvent.getAction() == 2 && chatActivityEnterView.E2) {
                    ...
                    boolean z11 = chatActivityEnterView2.f23766r4;
                    if (!z11) {
                        if (!z11) {
                            if (chatActivityEnterView2.f23730k4 == -1.0f) {
                                chatActivityEnterView2.f23724j4 = y3;
                            }
                            chatActivityEnterView2.f23730k4 = y3;
                            recordCircle.invalidate();
                            if (!chatActivityEnterView2.f23760q4 && chatActivityEnterView2.f23719i4 >= 0.7f && chatActivityEnterView2.f23724j4 - chatActivityEnterView2.f23730k4 >= AndroidUtilities.dp(57.0f)) {
                                chatActivityEnterView2.f23766r4 = true;
                                ...
                                if (sgVar != null && MessagesController.getGlobalMainSettings().getInt("voicepausehint", 0) <= 3) {
                                    ...
                                    sgVar.f30279a = f4Var;
                                    f4Var.l(1.0f, 0.0f);
                                    sgVar.f30279a.p(true);
                                    sgVar.f30279a.s(LocaleController.getString(R.string.VoicePauseHint));
                                    ...
                                    sgVar.addView(sgVar.f30279a, w7.x5.d(-1, -1.0f, 119, 0.0f, 0.0f, 54.0f, 58.0f));
                                    di.f4 f4Var2 = sgVar.f30279a;
                                    f4Var2.f7210l0 = new qg(sgVar, f4Var2, 3);
                                    f4Var2.u();
                                }
                            } else {
                                ...
                                if (chatActivityEnterView3.f23687d4 && chatActivityEnterView3.f23701f4 == 0.0f && f12 > recordCircle2.E) {
                                    chatActivityEnterView3.f23694e4 = System.currentTimeMillis();
                                }
                                ...
                                if (f13 != -1.0f) {
                                    ...
                                    ChatActivityEnterView.SlideTextView slideTextView4 = chatActivityEnterView.f23722j1;
                                    if (slideTextView4 != null) {
                                        slideTextView4.f23827r = f7;
                                    }
                ...
                if (chatActivityEnterView.f23719i4 < 0.7f) {
                    if (chatActivityEnterView.f23685d2 && chatActivityEnterView.f23678c1) {
                        CameraController.getInstance().cancelOnInitRunnable(bfVar);
                    ...
                    chatActivityEnterView.f23716i1 = j12;
                    chatActivityEnterView.E2 = false;
                    chatActivityEnterView.L1(5, true);
                    return false;
                }
                chatActivityEnterView.f23766r4 = true;
                ChatActivityEnterView.m(chatActivityEnterView);
                return false;
            } else {
                ChatActivityEnterView.RecordCircle recordCircle3 = chatActivityEnterView.M1;
                if ((recordCircle3 != null && ChatActivityEnterView.this.f23766r4) || ((keVar = chatActivityEnterView.f23691e1) != null && keVar.getVisibility() == 0)) {
                    ...
                    chatActivityEnterView.f23716i1 = j11;
                    chatActivityEnterView.E2 = false;
                    chatActivityEnterView.L1(5, true);
                    return true;
                } else if (chatActivityEnterView.H3) {
                    AndroidUtilities.cancelRunOnUIThread(jgVar);
                    if (chatActivityEnterView.f23801y0 && chatActivityEnterView.f23795x0) {
                        chatActivityEnterView.Y2.W(!chatActivityEnterView.f23678c1);
                        chatActivityEnterView.k1(!chatActivityEnterView.f23678c1, true);
                    } else {
                        chatActivityEnterView.Y2.a2();
                    }
                    ...
                    boolean z12 = chatActivityEnterView.f23685d2;
                    if (!z12 || chatActivityEnterView.I3) {
                        chatActivityEnterView.C2 = -1.0f;
                        if (z12 && chatActivityEnterView.f23678c1) {
                            if (e5.d0(chatActivityEnterView.Q, chatActivityEnterView.P2)) {
                                ChatActivityEnterView.SlideTextView slideTextView5 = chatActivityEnterView.f23722j1;
                            ...
                            j3 = 0;
                            if (!chatActivityEnterView.f23801y0) {
                                chatActivityEnterView.Y2.a2();
                                ...
                                MediaController.getInstance().toggleRecordingPause(chatActivityEnterView.O);
                                chatActivityEnterView.Y2.V0(0);
                                ChatActivityEnterView.SlideTextView slideTextView6 = chatActivityEnterView.f23722j1;
                                ...
                                if (chatActivityEnterView.E2 && chatActivityEnterView.c()) {
                                    ...
                                    p2 p2Var2 = new p2(6);
                                    ue ueVar = new ue(0);
                                    org.telegram.ui.ActionBar.f6 f6Var2 = this.f31209c;
                        ...
                        Runnable runnable2 = new Runnable(this) {
                            ...
                            public final void run() {
                                switch (r2) {
                                    case 0:
                                        ChatActivityEnterView chatActivityEnterView22 = this.f30595b.d;
                                        chatActivityEnterView22.f23697f0 = null;
                                        chatActivityEnterView22.L1(1, true);
                                        return;
                                    default:
                                        ChatActivityEnterView chatActivityEnterView32 = this.f30595b.d;
                                        chatActivityEnterView32.f23697f0 = null;
                                        chatActivityEnterView32.L1(1, true);
                                        return;
                                }
                            }
                        };
                        chatActivityEnterView.f23697f0 = runnable2;
                        if (chatActivityEnterView.f23799x4) {
                            j10 = 500;
                        } else {
                            j10 = j3;
                        }
