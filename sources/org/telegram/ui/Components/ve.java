...
public final class ve extends ah {
    ...
    public final ChatActivityEnterView f29066y;

    public ve(ChatActivityEnterView chatActivityEnterView, Activity activity) {
        super(activity, 24);
        this.f29066y = chatActivityEnterView;
    ...
    public final void draw(Canvas canvas) {
        Drawable drawable;
        ChatActivityEnterView chatActivityEnterView = this.f29066y;
