...
public final class ve extends FrameLayout {
    public final Paint f31234a;
    public final RectF f31235b;
    public final org.telegram.ui.ActionBar.f6 f31236c;
    ...
    public ve(ChatActivityEnterView chatActivityEnterView, Activity activity, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f31236c = f6Var;
        this.f31234a = new Paint(1);
        this.f31235b = new RectF();
    }
        ...
        if (!chatActivityEnterView.f23758k5) {
            ...
            if (motionEvent.getAction() == 0) {
                if (ChatActivityEnterView.this.f23793r4) {
                    boolean z10 = chatActivityEnterView.f23712d2;
                    if (!z10 || chatActivityEnterView.I3) {
                        chatActivityEnterView.C2 = -1.0f;
                        if (z10 && chatActivityEnterView.f23705c1) {
                            if (e5.d0(chatActivityEnterView.Q, chatActivityEnterView.P2)) {
                                ...
                                e5.a0(chatActivityEnterView.Q, 1, chatActivityEnterView.P2, new Utilities.Callback(this) {
                                    ...
                                    public final void run(Object obj) {
                                        ...
                                        switch (r2) {
                                            case 0:
                                                this.f30295b.d.T0(0, true, 0, false, l4.longValue());
                                                return;
                                            case 1:
                                                this.f30295b.d.T0(0, true, 0, false, l4.longValue());
                                                return;
                            ...
                            if (chatActivityEnterView.E2 && chatActivityEnterView.c()) {
                                ...
                                org.telegram.ui.ActionBar.f6 f6Var = this.f31236c;
                            ...
                            if (e5.d0(chatActivityEnterView.Q, chatActivityEnterView.P2)) {
                                if (chatActivityEnterView.f23705c1) {
                                    ...
                                    ChatActivityEnterView.SlideTextView slideTextView3 = chatActivityEnterView.f23749j1;
                        ...
                        chatActivityEnterView.f23730g0 = false;
                        Runnable runnable = new Runnable(this) {
                            public final ve f30622b;
                            ...
                            public final void run() {
                                switch (r2) {
                                    case 0:
                                        ChatActivityEnterView chatActivityEnterView2 = this.f30622b.d;
                                        chatActivityEnterView2.f23724f0 = null;
                                        chatActivityEnterView2.L1(1, true);
                                        return;
                                    default:
                                        ChatActivityEnterView chatActivityEnterView3 = this.f30622b.d;
                                        chatActivityEnterView3.f23724f0 = null;
                                        chatActivityEnterView3.L1(1, true);
                                        return;
                                }
                            }
                        };
                        chatActivityEnterView.f23724f0 = runnable;
                ...
                if (coVar == null) {
                    ...
                    userFull = coVar.f35220a8;
                }
                if ((chat != null && !ChatObject.canSendVoice(chat) && (!ChatObject.canSendRoundVideo(chat) || !chatActivityEnterView.f23712d2)) || (userFull != null && userFull.voice_messages_forbidden)) {
                    chatActivityEnterView.Y2.a2();
                    return true;
                } else if (chatActivityEnterView.f23712d2) {
            ...
            if (motionEvent.getAction() != 1 && motionEvent.getAction() != 3) {
                if (motionEvent.getAction() == 2 && chatActivityEnterView.E2) {
                    ...
                    boolean z11 = chatActivityEnterView2.f23793r4;
                    if (!z11) {
                        if (!z11) {
                            if (chatActivityEnterView2.f23757k4 == -1.0f) {
                                chatActivityEnterView2.f23751j4 = y3;
                            }
                            chatActivityEnterView2.f23757k4 = y3;
                            recordCircle.invalidate();
                            if (!chatActivityEnterView2.f23787q4 && chatActivityEnterView2.f23746i4 >= 0.7f && chatActivityEnterView2.f23751j4 - chatActivityEnterView2.f23757k4 >= AndroidUtilities.dp(57.0f)) {
                                chatActivityEnterView2.f23793r4 = true;
                                ...
                                if (sgVar != null && MessagesController.getGlobalMainSettings().getInt("voicepausehint", 0) <= 3) {
                                    ...
                                    sgVar.f30306a = f4Var;
                                    f4Var.l(1.0f, 0.0f);
                                    sgVar.f30306a.p(true);
                                    sgVar.f30306a.s(LocaleController.getString(R.string.VoicePauseHint));
                                    ...
                                    sgVar.addView(sgVar.f30306a, w7.x5.d(-1, -1.0f, 119, 0.0f, 0.0f, 54.0f, 58.0f));
                                    di.f4 f4Var2 = sgVar.f30306a;
                                ...
                                if (chatActivityEnterView3.f23714d4 && chatActivityEnterView3.f23728f4 == 0.0f && f12 > recordCircle2.E) {
                                    chatActivityEnterView3.f23721e4 = System.currentTimeMillis();
                                }
                                ...
                                if (f13 != -1.0f) {
                                    ...
                                    ChatActivityEnterView.SlideTextView slideTextView4 = chatActivityEnterView.f23749j1;
                                    if (slideTextView4 != null) {
                                        slideTextView4.f23854r = f7;
                                    }
                ...
                if (chatActivityEnterView.f23746i4 < 0.7f) {
                    if (chatActivityEnterView.f23712d2 && chatActivityEnterView.f23705c1) {
                        CameraController.getInstance().cancelOnInitRunnable(bfVar);
                    ...
                    chatActivityEnterView.f23743i1 = j12;
                    chatActivityEnterView.E2 = false;
                    chatActivityEnterView.L1(5, true);
                    return false;
                }
                chatActivityEnterView.f23793r4 = true;
                ChatActivityEnterView.m(chatActivityEnterView);
                return false;
            } else {
                ChatActivityEnterView.RecordCircle recordCircle3 = chatActivityEnterView.M1;
                if ((recordCircle3 != null && ChatActivityEnterView.this.f23793r4) || ((keVar = chatActivityEnterView.f23718e1) != null && keVar.getVisibility() == 0)) {
                    ...
                    chatActivityEnterView.f23743i1 = j11;
                    chatActivityEnterView.E2 = false;
                    chatActivityEnterView.L1(5, true);
                    return true;
                } else if (chatActivityEnterView.H3) {
                    AndroidUtilities.cancelRunOnUIThread(jgVar);
                    if (chatActivityEnterView.f23828y0 && chatActivityEnterView.f23822x0) {
                        chatActivityEnterView.Y2.W(!chatActivityEnterView.f23705c1);
                        chatActivityEnterView.k1(!chatActivityEnterView.f23705c1, true);
                    } else {
                        chatActivityEnterView.Y2.a2();
                    }
                    ...
                    boolean z12 = chatActivityEnterView.f23712d2;
                    if (!z12 || chatActivityEnterView.I3) {
                        chatActivityEnterView.C2 = -1.0f;
                        if (z12 && chatActivityEnterView.f23705c1) {
                            if (e5.d0(chatActivityEnterView.Q, chatActivityEnterView.P2)) {
                                ChatActivityEnterView.SlideTextView slideTextView5 = chatActivityEnterView.f23749j1;
                            ...
                            j3 = 0;
                            if (!chatActivityEnterView.f23828y0) {
                                chatActivityEnterView.Y2.a2();
                                ...
                                MediaController.getInstance().toggleRecordingPause(chatActivityEnterView.O);
                                chatActivityEnterView.Y2.V0(0);
                                ChatActivityEnterView.SlideTextView slideTextView6 = chatActivityEnterView.f23749j1;
                                ...
                                if (chatActivityEnterView.E2 && chatActivityEnterView.c()) {
                                    ...
                                    p2 p2Var2 = new p2(6);
                                    ue ueVar = new ue(0);
                                    org.telegram.ui.ActionBar.f6 f6Var2 = this.f31236c;
                        ...
                        Runnable runnable2 = new Runnable(this) {
                            ...
                            public final void run() {
                                switch (r2) {
                                    case 0:
                                        ChatActivityEnterView chatActivityEnterView22 = this.f30622b.d;
                                        chatActivityEnterView22.f23724f0 = null;
                                        chatActivityEnterView22.L1(1, true);
                                        return;
                                    default:
                                        ChatActivityEnterView chatActivityEnterView32 = this.f30622b.d;
                                        chatActivityEnterView32.f23724f0 = null;
                                        chatActivityEnterView32.L1(1, true);
                                        return;
                                }
                            }
                        };
                        chatActivityEnterView.f23724f0 = runnable2;
                        if (chatActivityEnterView.f23826x4) {
                            j10 = 500;
                        } else {
                            j10 = j3;
                        }
