...
public final class e00 {
    ...
    public e00(float f7, float f10, boolean z10) {
        ...
        sb3.append("}");
        this.f22519a = sb3.toString();
    }

    public final boolean a() {
        int h = g00.h(35633, this.f22519a);
        int h10 = g00.h(35632, this.f22520b);
        if (h == 0 || h10 == 0) {
            return false;
        }
        int glCreateProgram = GLES20.glCreateProgram();
        this.f22521c = glCreateProgram;
        GLES20.glAttachShader(glCreateProgram, h);
        GLES20.glAttachShader(this.f22521c, h10);
        GLES20.glBindAttribLocation(this.f22521c, 0, "position");
        GLES20.glBindAttribLocation(this.f22521c, 1, "inputTexCoord");
        GLES20.glLinkProgram(this.f22521c);
        int[] iArr = new int[1];
        GLES20.glGetProgramiv(this.f22521c, 35714, iArr, 0);
        if (iArr[0] == 0) {
            GLES20.glDeleteProgram(this.f22521c);
            this.f22521c = 0;
        } else {
            this.d = GLES20.glGetAttribLocation(this.f22521c, "position");
            this.e = GLES20.glGetAttribLocation(this.f22521c, "inputTexCoord");
            this.f22522f = GLES20.glGetUniformLocation(this.f22521c, "sTexture");
            this.f22523g = GLES20.glGetUniformLocation(this.f22521c, "texelWidthOffset");
            this.h = GLES20.glGetUniformLocation(this.f22521c, "texelHeightOffset");
        }
        return true;
    }
}
