...
public abstract class y90 {
    public static final Pattern f30486a = Pattern.compile("^\\[\\^([^\\]]+)\\]:[ \\t]*(.*)$");
    public static final Pattern f30487b = Pattern.compile("\\[\\^([^\\]]+)\\]");
    public static final Pattern f30488c = Pattern.compile("^(\\d+)[.)]\\s");

    public static TL_iv.RichText a(bf.p pVar, TL_iv.PageBlock pageBlock) {
        v90 v90Var = new v90(pageBlock);
        pVar.a(v90Var);
        return g(h(v90.x(v90Var.f29041c)));
    }
    ...
    public static TL_iv.RichText g(TL_iv.RichText richText) {
        ...
        if (richText instanceof TL_iv.textConcat) {
            ...
            return textconcat;
        } else if (richText instanceof x90) {
            x90 x90Var = (x90) richText;
            TL_iv.textStrike g10 = g(x90Var.text);
            int i11 = x90Var.f30208a;
            if ((i11 & 4) != 0) {
    ...
    public static org.telegram.tgnet.tl.TL_iv.RichText h(org.telegram.tgnet.tl.TL_iv.RichText r17) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.y90.h(org.telegram.tgnet.tl.TL_iv$RichText):org.telegram.tgnet.tl.TL_iv$RichText");
    }

    public static java.lang.String i(java.lang.String r23, java.util.ArrayList r24) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.y90.i(java.lang.String, java.util.ArrayList):java.lang.String");
    }
