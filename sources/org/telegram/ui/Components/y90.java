...
public final class y90 extends v7.i0 {
    public int f30610a;
    public final TL_iv.PageBlock f30611b;
    public TL_iv.textConcat f30612c = new TL_iv.textConcat();

    public y90(TL_iv.PageBlock pageBlock) {
        this.f30611b = pageBlock;
    }
    ...
    public final void k(bf.n nVar) {
        if (nVar instanceof zc.a) {
            if (!this.f30612c.texts.isEmpty()) {
                w(ba0.j("\n"));
            }
            w(ba0.c(((zc.a) nVar).f49180g));
            w(ba0.j("\n"));
            return;
        }
        v(nVar);
    ...
    public final void t(bf.g gVar) {
        String str;
        if (this.f30611b instanceof TL_iv.pageBlockBlockquote) {
            str = "\n";
        } else {
            str = " ";
        }
    ...
    public final void w(TL_iv.RichText richText) {
        this.f30612c.texts.add(richText);
    }

    public final TL_iv.RichText y(bf.p pVar) {
        TL_iv.textConcat textconcat = this.f30612c;
        this.f30612c = new TL_iv.textConcat();
        v(pVar);
        TL_iv.RichText x10 = x(this.f30612c);
        this.f30612c = textconcat;
        return x10;
    }
}
