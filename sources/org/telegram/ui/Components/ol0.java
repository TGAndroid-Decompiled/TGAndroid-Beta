...
public abstract class ol0 extends cl0 {
    public SparseIntArray f27587c;
    public SparseIntArray d;
    public SparseIntArray e;
    public int f27588f;
    public int h;
    public final ArrayList f27589n = new ArrayList();
    ...
    public final void L() {
        ...
        if (sparseIntArray == null) {
            ...
            this.f27587c = new SparseIntArray();
    ...
    public final int Q(int i10) {
        int i11 = this.f27587c.get(i10, Integer.MAX_VALUE);
    ...
    public final void X(boolean z4) {
        ArrayList arrayList = this.f27589n;
