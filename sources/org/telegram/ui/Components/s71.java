...
public final class s71 {
    ...
    public static s71 d(int i10, TLRPC.Document document, TLRPC.Document document2, int i11, boolean z10) {
        ...
        if (tL_documentAttributeVideo != null) {
            ...
            obj.f28082i = tL_documentAttributeVideo.f18303w;
            obj.f28083j = tL_documentAttributeVideo.h;
            obj.f28085l = j3 / d;
        }
    ...
    public final void e(boolean z10) {
        if (!b() && this.f28081g != null) {
            File pathToAttach = FileLoader.getInstance(this.f28077a).getPathToAttach(this.f28081g, null, false, z10);
            if (pathToAttach != null && pathToAttach.exists()) {
                this.d = Uri.fromFile(pathToAttach);
            } else {
                File pathToAttach2 = FileLoader.getInstance(this.f28077a).getPathToAttach(this.f28081g, null, true, z10);
                if (pathToAttach2 != null && pathToAttach2.exists()) {
        ...
        if (!c() && this.h != null) {
            File pathToAttach3 = FileLoader.getInstance(this.f28077a).getPathToAttach(this.h, null, false, z10);
            if (pathToAttach3 != null && pathToAttach3.exists()) {
                this.f28080f = Uri.fromFile(pathToAttach3);
                return;
            }
            File pathToAttach4 = FileLoader.getInstance(this.f28077a).getPathToAttach(this.h, null, true, z10);
            if (pathToAttach4 != null && pathToAttach4.exists()) {
                this.f28080f = Uri.fromFile(pathToAttach4);
            }
        }
    }
}
