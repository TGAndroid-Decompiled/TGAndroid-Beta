...
public abstract class s71 extends View {
    public static final Object f27789f0 = new Object();
    public r71 E;
    ...
    public long f27790a;
    public final Paint f27791a0;
    public int f27792b;
    public final Paint f27793b0;
    public int f27794c;
    public final c6 f27795c0;
    public float d;
    public final Path f27796d0;
    public float e;
    public boolean f27797e0;
    public float f27798f;
    public boolean h;
    public boolean f27799n;
    public boolean f27800r;
    public float f27801s;
    public float v;
    public boolean f27802w;
    public ParcelFileDescriptor f27803x;
    public MediaMetadataRetriever f27804y;
    ...
    public s71(Context context) {
        ...
        this.f27791a0 = paint5;
        Paint paint6 = new Paint(1);
        this.f27793b0 = paint6;
        this.f27795c0 = new c6(0.0f, this, 0L, 200L, qr.f27386j);
        this.f27796d0 = new Path();
        paint.setColor(-1);
        paint2.setColor(-256);
    ...
    public final void a() {
        Bitmap bitmap;
        synchronized (f27789f0) {
            try {
                ParcelFileDescriptor parcelFileDescriptor = this.f27803x;
            ...
            try {
                MediaMetadataRetriever mediaMetadataRetriever = this.f27804y;
        ...
        for (int i10 = 0; i10 < this.F.size(); i10++) {
            ...
            if (q71Var != null && (bitmap = q71Var.f27239a) != null) {
                bitmap.recycle();
            }
        }
        this.F.clear();
    ...
    public long getLength() {
        return Math.max(1L, this.f27790a);
    }
    ...
    public final void onDraw(Canvas canvas) {
            ...
            if (!z10) {
                ...
                while (true) {
                    if (i10 >= arrayList.size()) {
                        break;
                    } else if (((q71) arrayList.get(i10)).f27239a == null) {
                        this.f27797e0 = true;
                        break;
                    } else {
                        i10++;
            ...
            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                ...
                if (bitmap != null) {
                    ...
                    if (f17 != 1.0f) {
                        ...
                        Paint paint = this.Q;
                        paint.setAlpha((int) (qr.h.getInterpolation(q71Var.f27240b) * 255.0f));
        ...
        if (!z11) {
            ...
            canvas2.drawRect(rectF4, this.f27791a0);
            canvas2.restore();
        ...
        float d = this.f27795c0.d(0.0f, false);
        if (d > 0.0f) {
            c(this.e, d, canvas2, paint3);
        }
        c(this.f27801s, 1.0f - d, canvas2, paint3);
        if (this.f27802w) {
            c(this.f27798f, 1.0f, canvas2, this.U);
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent != null) {
            ...
            int dp2 = AndroidUtilities.dp(22.0f) + ((int) (this.f27801s * f7));
            ...
            if (motionEvent.getAction() == 0) {
                ...
                if (motionEvent.getAction() == 2) {
                    if (this.f27800r) {
                        ...
                        r71 r71Var6 = this.E;
                        if (r71Var6 != null) {
                            float f12 = this.f27801s;
                            com.google.android.gms.common.api.internal.v vVar2 = (com.google.android.gms.common.api.internal.v) r71Var6;
                            PhotoViewer photoViewer2 = (PhotoViewer) vVar2.d;
                            if (photoViewer2.F2 != null) {
                                if (photoViewer2.f30938c2 == 1) {
                                    vVar2.j(0);
                                }
                                vVar2.h(f12);
                            }
                        ...
                        r71 r71Var7 = this.E;
                        if (r71Var7 != null) {
                            com.google.android.gms.common.api.internal.v vVar3 = (com.google.android.gms.common.api.internal.v) r71Var7;
                            ...
                            if (h71Var != null) {
                                ...
                                vVar3.j(1);
                                vVar3.h(f18);
                                photoViewer3.f31060q3.h(0.0f, false);
                        ...
                        r71 r71Var8 = this.E;
                        if (r71Var8 != null) {
                            ((com.google.android.gms.common.api.internal.v) r71Var8).f(this.e);
                        }
                        invalidate();
                        return true;
                    }
                ...
                r71 r71Var9 = this.E;
                if (r71Var9 != null) {
                    ((com.google.android.gms.common.api.internal.v) r71Var9).d(0);
                }
                this.h = false;
                return true;
            } else if (this.f27799n) {
                r71 r71Var10 = this.E;
                if (r71Var10 != null) {
                    ((com.google.android.gms.common.api.internal.v) r71Var10).d(1);
                }
                this.f27799n = false;
                return true;
            } else if (this.f27800r) {
                r71 r71Var11 = this.E;
                if (r71Var11 != null) {
                    ((com.google.android.gms.common.api.internal.v) r71Var11).d(2);
                }
                this.f27800r = false;
            }
            return true;
    ...
    public void setProgress(float f7) {
        float f10 = 0.0f;
        if (this.f27802w && (f7 <= 0.0f || f7 >= 1.0f)) {
            f7 = this.f27798f;
        }
        long j3 = this.f27790a;
        if (j3 != 0) {
            f10 = 240.0f / ((float) j3);
        }
        float f11 = this.f27801s;
        if (f7 < f11 && f7 <= this.d + f10 && f11 + f10 >= this.e) {
            this.f27795c0.d(1.0f, true);
        }
        this.f27801s = f7;
        invalidate();
    }
