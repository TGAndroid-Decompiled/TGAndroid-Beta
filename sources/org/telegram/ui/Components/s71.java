...
public abstract class s71 extends View {
    public static final Object f27786f0 = new Object();
    public r71 E;
    ...
    public long f27787a;
    public final Paint f27788a0;
    public int f27789b;
    public final Paint f27790b0;
    public int f27791c;
    public final c6 f27792c0;
    public float d;
    public final Path f27793d0;
    public float e;
    public boolean f27794e0;
    ...
    public ParcelFileDescriptor f27800x;
    public MediaMetadataRetriever f27801y;
    ...
    public s71(Context context) {
        ...
        this.f27788a0 = paint5;
        Paint paint6 = new Paint(1);
        this.f27790b0 = paint6;
        this.f27792c0 = new c6(0.0f, this, 0L, 200L, qr.f27383j);
        this.f27793d0 = new Path();
        paint.setColor(-1);
        paint2.setColor(-256);
    ...
    public final void a() {
        Bitmap bitmap;
        synchronized (f27786f0) {
            try {
                ParcelFileDescriptor parcelFileDescriptor = this.f27800x;
            ...
            try {
                MediaMetadataRetriever mediaMetadataRetriever = this.f27801y;
        ...
        for (int i10 = 0; i10 < this.F.size(); i10++) {
            ...
            if (q71Var != null && (bitmap = q71Var.f27236a) != null) {
                bitmap.recycle();
            }
        }
        this.F.clear();
    ...
    public long getLength() {
        return Math.max(1L, this.f27787a);
    }
    ...
    public final void onDraw(Canvas canvas) {
            ...
            if (!z10) {
                ...
                while (true) {
                    if (i10 >= arrayList.size()) {
                        break;
                    } else if (((q71) arrayList.get(i10)).f27236a == null) {
                        this.f27794e0 = true;
                        break;
                    } else {
                        i10++;
            ...
            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                ...
                if (bitmap != null) {
                    ...
                    if (f17 != 1.0f) {
                        ...
                        Paint paint = this.Q;
                        paint.setAlpha((int) (qr.h.getInterpolation(q71Var.f27237b) * 255.0f));
        ...
        if (!z11) {
            ...
            canvas2.drawRect(rectF4, this.f27788a0);
            canvas2.restore();
        ...
        float d = this.f27792c0.d(0.0f, false);
        if (d > 0.0f) {
            c(this.e, d, canvas2, paint3);
        }
        c(this.f27798s, 1.0f - d, canvas2, paint3);
        if (this.f27799w) {
            c(this.f27795f, 1.0f, canvas2, this.U);
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent != null) {
            ...
            int dp2 = AndroidUtilities.dp(22.0f) + ((int) (this.f27798s * f7));
                    ...
                    if (this.f27797r) {
                        ...
                        if (r71Var7 != null) {
                            ...
                            if (h71Var != null) {
                                ...
                                vVar3.j(1);
                                vVar3.h(f18);
                                photoViewer3.f31056q3.h(0.0f, false);
    ...
    public void setProgress(float f7) {
        float f10 = 0.0f;
        if (this.f27799w && (f7 <= 0.0f || f7 >= 1.0f)) {
            f7 = this.f27795f;
        }
        long j3 = this.f27787a;
        if (j3 != 0) {
            f10 = 240.0f / ((float) j3);
        }
        float f11 = this.f27798s;
        if (f7 < f11 && f7 <= this.d + f10 && f11 + f10 >= this.e) {
            this.f27792c0.d(1.0f, true);
        }
        this.f27798s = f7;
        invalidate();
    }
