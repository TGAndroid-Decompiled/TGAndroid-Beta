    ...
    public final void run() {
        ...
        switch (i12) {
            case 0:
                fs0 fs0Var = (fs0) obj;
                if (!z11) {
                    fs0Var.H.f25835q0.setVisibility(0);
                    return;
                } else {
                    fs0Var.getClass();
                    return;
            ...
            case 1:
                bw0 bw0Var = (bw0) obj;
                ArrayList arrayList = bw0Var.f23111r;
                aw0 aw0Var = bw0Var.f23106n;
                if (aw0Var != null) {
                    aw0Var.H(bw0Var.f23098f, z11);
                }
                while (i13 < arrayList.size()) {
                    ((aw0) arrayList.get(i13)).H(bw0Var.f23098f, z11);
                    i13++;
                }
                return;
            case 2:
                cw0 cw0Var = (cw0) obj;
                ArrayList arrayList2 = cw0Var.f23111r;
                aw0 aw0Var2 = cw0Var.f23106n;
                if (aw0Var2 != null) {
                    aw0Var2.H(cw0Var.f23354y0, z11);
                }
                while (i13 < arrayList2.size()) {
                    ((aw0) arrayList2.get(i13)).H(cw0Var.f23354y0, z11);
                    i13++;
                }
                return;
            case 3:
                ...
                if (kpVar != null && kpVar.d != null) {
                    ...
                    if (kpVar.d != null) {
                        while (i13 < kpVar.d.size()) {
                            ((lp) kpVar.d.get(i13)).f26232c = z11 ? 1 : 0;
                            ((lp) kpVar.d.get(i13)).e = e31Var.b0(((lp) kpVar.d.get(i13)).f26230a, z11);
                            i13++;
                        }
                        e31Var.f33163r = null;
                        kpVar.l();
            ...
            case 11:
                ...
                if (u1Var != null) {
                    ...
                    if (!z11) {
                        ...
                        if (checkBoxBaseArr2 != null && O2 >= 0 && O2 < checkBoxBaseArr2.length && (checkBoxBase = checkBoxBaseArr2[O2]) != null && ie1Var != null && (checkBoxBaseArr = ie1Var.R8) != null && O2 >= 0 && O2 < checkBoxBaseArr.length && (checkBoxBase2 = checkBoxBaseArr[O2]) != null) {
                            ObjectAnimator objectAnimator = checkBoxBase.f22157p;
                            if (objectAnimator != null) {
                                objectAnimator.cancel();
                                checkBoxBase.f22157p = null;
                            }
                            checkBoxBase.setProgress(checkBoxBase2.getProgress());
                            checkBoxBase.f(-1, checkBoxBase2.f22158q, true);
                        }
                    }
                ...
                org.telegram.ui.wm wmVar = ke1Var.f35074c0;
                if (wmVar != null) {
                    AndroidUtilities.runOnUIThread(wmVar);
                    ke1Var.f35074c0 = null;
                    return;
                }
                return;
            case 12:
                wh.n nVar = (wh.n) obj;
                ArrayList arrayList3 = nVar.f45364c;
                boolean isEmpty = TextUtils.isEmpty(nVar.f45378t);
                String str = nVar.f45378t;
                nVar.f45380w = true;
                nVar.A = false;
                ...
                nVar.v = nVar.f45367i.getImporters(nVar.f45368j, str, tL_chatInviteImporter, nVar.d, new wh.f(nVar, isEmpty, eVar2, str, z10));
                return;
            case 13:
                yh.s0 s0Var = (yh.s0) obj;
                if (!z11) {
                    s0Var.f47976q0.setVisibility(8);
                    return;
                } else {
                    s0Var.getClass();
                    return;
            ...
            case 14:
                ...
                y3Var.o2(y3Var.f48261c1, AndroidUtilities.replaceTags(LocaleController.formatString(i11, y3Var.C1())), true);
                return;
            case 15:
                yh.y3 y3Var2 = ((yh.h2) obj).U;
                TL_stars.SavedStarGift H1 = y3Var2.H1(z11);
                if (H1 != null) {
                    y3Var2.f48259b1 = true;
            ...
            default:
                zg.n nVar2 = (zg.n) obj;
                if (z11) {
                    ((zg.q) nVar2.f49372x.f48085c).f49413w.setVisibility(4);
                    return;
                } else {
                    nVar2.getClass();
                    return;
