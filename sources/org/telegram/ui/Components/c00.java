...
public final class c00 extends s4.j {
    ...
    public final void C(s4.c1 c1Var, s4.i iVar) {
        ...
        if (view instanceof i00) {
            i00 i00Var = (i00) view;
            if (i00Var.f26946w) {
                ValueAnimator valueAnimator = i00Var.f26926a;
                if (valueAnimator != null) {
                    valueAnimator.removeAllListeners();
                    i00Var.f26926a.removeAllUpdateListeners();
                    i00Var.f26926a.cancel();
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                ofFloat.addUpdateListener(new b00(i00Var, 0));
                ofFloat.addListener(new j6(i00Var, 24));
                i00Var.f26926a = ofFloat;
    ...
    public final boolean r(s4.c1 c1Var, b2.q0 q0Var, int i10, int i11, int i12, int i13) {
        ...
        if (view instanceof i00) {
            ...
            TextPaint textPaint = k00Var.f27634b;
            TextPaint textPaint2 = k00Var.f27636c;
            int i26 = i00Var.f26928b.d;
            int i27 = i00Var.I;
            if (i26 != i27) {
                i00Var.H = true;
                i00Var.J = i27;
                i00Var.f26936f0 = i00Var.f26932d0;
                i00Var.f26937g0 = i00Var.f26934e0;
                if (i27 > 0 && i26 > 0) {
                    String valueOf = String.valueOf(i27);
                    String valueOf2 = String.valueOf(i00Var.f26928b.d);
            ...
            int i32 = i00Var.f26928b.f26247c;
            if (i17 != 0) {
                if (str != null) {
                    f10 = 1.0f;
                } else {
            ...
            if (charSequence3 != null && !i00Var.f26928b.f26246b.equals(charSequence3)) {
                if (i00Var.N.length() > i00Var.f26928b.f26246b.length()) {
                    charSequence = i00Var.N;
                    charSequence2 = i00Var.f26928b.f26246b;
                    z14 = true;
                } else {
                    charSequence = i00Var.f26928b.f26246b;
                ...
                if (charSequenceIndexOf >= 0) {
                    ...
                    i00Var.f26927a0 = f7;
                    i00Var.f26931c0 = i00Var.f26929b0;
                    i00Var.R = null;
                    z5.release(i00Var, i00Var.Q);
                } else {
                    z12 = false;
                    CharSequence charSequence4 = i00Var.f26928b.f26246b;
            ...
            if (i33 != i00Var.f26938h0 || i00Var.getMeasuredWidth() != i00Var.f26940j0) {
                z13 = true;
                i00Var.W = true;
                i00Var.f26939i0 = i00Var.f26938h0;
                z11 = true;
            } else {
                z13 = true;
            }
            ...
            this.f45835r.add(new s4.i(c1Var, i14, i15, i12, i13));
            return z13;
        }
    ...
    public final void x(s4.c1 c1Var) {
        c1Var.f45767a.setTranslationX(0.0f);
        View view = c1Var.f45767a;
        if (view instanceof i00) {
            ((i00) view).a();
        }
