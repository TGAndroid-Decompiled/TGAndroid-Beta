...
public final class c00 extends s4.j {
    ...
    public final void C(s4.c1 c1Var, s4.i iVar) {
        ...
        if (view instanceof i00) {
            i00 i00Var = (i00) view;
            if (i00Var.f24855w) {
                ValueAnimator valueAnimator = i00Var.f24836a;
                if (valueAnimator != null) {
                    valueAnimator.removeAllListeners();
                    i00Var.f24836a.removeAllUpdateListeners();
                    i00Var.f24836a.cancel();
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                ofFloat.addUpdateListener(new b00(i00Var, 0));
                ofFloat.addListener(new p8(i00Var, 21));
                i00Var.f24836a = ofFloat;
    ...
    public final boolean r(s4.c1 c1Var, b2.q0 q0Var, int i10, int i11, int i12, int i13) {
        ...
        if (view instanceof i00) {
            ...
            TextPaint textPaint = k00Var.f25464b;
            TextPaint textPaint2 = k00Var.f25466c;
            int i26 = i00Var.f24838b.d;
            int i27 = i00Var.I;
            if (i26 != i27) {
                i00Var.H = true;
                i00Var.J = i27;
                i00Var.f24845f0 = i00Var.f24842d0;
                i00Var.f24846g0 = i00Var.f24843e0;
                if (i27 > 0 && i26 > 0) {
                    String valueOf = String.valueOf(i27);
                    String valueOf2 = String.valueOf(i00Var.f24838b.d);
                    if (valueOf.length() == valueOf2.length()) {
                        ...
                        i00Var.L = new StaticLayout(valueOf, textPaint2, (int) Math.ceil(org.telegram.ui.ActionBar.i6.L0.measureText(valueOf)), alignment2, 1.0f, 0.0f, false);
            ...
            int i32 = i00Var.f24838b.f24141c;
            if (i17 != 0) {
                if (str != null) {
                    f10 = 1.0f;
                } else {
            ...
            if (charSequence3 != null && !i00Var.f24838b.f24140b.equals(charSequence3)) {
                if (i00Var.N.length() > i00Var.f24838b.f24140b.length()) {
                    charSequence = i00Var.N;
                    charSequence2 = i00Var.f24838b.f24140b;
                    z14 = true;
                } else {
                    charSequence = i00Var.f24838b.f24140b;
                ...
                if (charSequenceIndexOf >= 0) {
                    ...
                    i00Var.f24837a0 = f7;
                    i00Var.f24841c0 = i00Var.f24839b0;
                    i00Var.R = null;
                    x5.release(i00Var, i00Var.Q);
                } else {
                    z12 = false;
                    CharSequence charSequence4 = i00Var.f24838b.f24140b;
            ...
            if (i33 != i00Var.f24847h0 || i00Var.getMeasuredWidth() != i00Var.f24849j0) {
                z13 = true;
                i00Var.W = true;
                i00Var.f24848i0 = i00Var.f24847h0;
                z11 = true;
            } else {
                z13 = true;
            }
            ...
            this.f42731r.add(new s4.i(c1Var, i14, i15, i12, i13));
            return z13;
        }
    ...
    public final void x(s4.c1 c1Var) {
        c1Var.f42671a.setTranslationX(0.0f);
        View view = c1Var.f42671a;
        if (view instanceof i00) {
            ((i00) view).a();
        }
