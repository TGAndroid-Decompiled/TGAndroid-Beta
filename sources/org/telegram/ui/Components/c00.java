...
public final class c00 extends s4.j {
    ...
    public final void C(s4.c1 c1Var, s4.i iVar) {
        ...
        if (view instanceof i00) {
            i00 i00Var = (i00) view;
            if (i00Var.f24849w) {
                ValueAnimator valueAnimator = i00Var.f24830a;
                if (valueAnimator != null) {
                    valueAnimator.removeAllListeners();
                    i00Var.f24830a.removeAllUpdateListeners();
                    i00Var.f24830a.cancel();
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                ofFloat.addUpdateListener(new b00(i00Var, 0));
                ofFloat.addListener(new p8(i00Var, 21));
                i00Var.f24830a = ofFloat;
    ...
    public final boolean r(s4.c1 c1Var, b2.q0 q0Var, int i10, int i11, int i12, int i13) {
        ...
        if (view instanceof i00) {
            ...
            TextPaint textPaint = k00Var.f25467b;
            TextPaint textPaint2 = k00Var.f25469c;
            int i26 = i00Var.f24832b.d;
            int i27 = i00Var.I;
            if (i26 != i27) {
                i00Var.H = true;
                i00Var.J = i27;
                i00Var.f24839f0 = i00Var.f24836d0;
                i00Var.f24840g0 = i00Var.f24837e0;
                if (i27 > 0 && i26 > 0) {
                    String valueOf = String.valueOf(i27);
                    String valueOf2 = String.valueOf(i00Var.f24832b.d);
            ...
            int i32 = i00Var.f24832b.f24144c;
            if (i17 != 0) {
                if (str != null) {
                    f10 = 1.0f;
                } else {
            ...
            if (charSequence3 != null && !i00Var.f24832b.f24143b.equals(charSequence3)) {
                if (i00Var.N.length() > i00Var.f24832b.f24143b.length()) {
                    charSequence = i00Var.N;
                    charSequence2 = i00Var.f24832b.f24143b;
                    z14 = true;
                } else {
                    charSequence = i00Var.f24832b.f24143b;
                ...
                if (charSequenceIndexOf >= 0) {
                    ...
                    i00Var.f24831a0 = f7;
                    i00Var.f24835c0 = i00Var.f24833b0;
                    i00Var.R = null;
                    x5.release(i00Var, i00Var.Q);
                } else {
                    z12 = false;
                    CharSequence charSequence4 = i00Var.f24832b.f24143b;
            ...
            if (i33 != i00Var.f24841h0 || i00Var.getMeasuredWidth() != i00Var.f24843j0) {
                z13 = true;
                i00Var.W = true;
                i00Var.f24842i0 = i00Var.f24841h0;
                z11 = true;
            } else {
                z13 = true;
            }
            ...
            this.f42735r.add(new s4.i(c1Var, i14, i15, i12, i13));
            return z13;
        }
    ...
    public final void x(s4.c1 c1Var) {
        c1Var.f42675a.setTranslationX(0.0f);
        View view = c1Var.f42675a;
        if (view instanceof i00) {
            ((i00) view).a();
        }
