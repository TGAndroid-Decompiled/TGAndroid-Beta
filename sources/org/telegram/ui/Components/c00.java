...
public final class c00 extends s4.j {
    ...
    public final void C(s4.c1 c1Var, s4.i iVar) {
        ...
        if (view instanceof i00) {
            i00 i00Var = (i00) view;
            if (i00Var.f24805w) {
                ValueAnimator valueAnimator = i00Var.f24786a;
                if (valueAnimator != null) {
                    valueAnimator.removeAllListeners();
                    i00Var.f24786a.removeAllUpdateListeners();
                    i00Var.f24786a.cancel();
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                ofFloat.addUpdateListener(new b00(i00Var, 0));
                ofFloat.addListener(new r8(i00Var, 21));
                i00Var.f24786a = ofFloat;
    ...
    public final boolean r(s4.c1 c1Var, b2.q0 q0Var, int i10, int i11, int i12, int i13) {
        ...
        if (view instanceof i00) {
            ...
            TextPaint textPaint = k00Var.f25490b;
            TextPaint textPaint2 = k00Var.f25492c;
            int i26 = i00Var.f24788b.d;
            int i27 = i00Var.I;
            if (i26 != i27) {
                i00Var.H = true;
                i00Var.J = i27;
                i00Var.f24795f0 = i00Var.f24792d0;
                i00Var.f24796g0 = i00Var.f24793e0;
                if (i27 > 0 && i26 > 0) {
                    String valueOf = String.valueOf(i27);
                    String valueOf2 = String.valueOf(i00Var.f24788b.d);
            ...
            int i32 = i00Var.f24788b.f24282c;
            if (i17 != 0) {
                if (str != null) {
                    f10 = 1.0f;
                } else {
            ...
            if (charSequence3 != null && !i00Var.f24788b.f24281b.equals(charSequence3)) {
                if (i00Var.N.length() > i00Var.f24788b.f24281b.length()) {
                    charSequence = i00Var.N;
                    charSequence2 = i00Var.f24788b.f24281b;
                    z14 = true;
                } else {
                    charSequence = i00Var.f24788b.f24281b;
                ...
                if (charSequenceIndexOf >= 0) {
                    ...
                    i00Var.f24787a0 = f7;
                    i00Var.f24791c0 = i00Var.f24789b0;
                    i00Var.R = null;
                    z5.release(i00Var, i00Var.Q);
                } else {
                    z12 = false;
                    CharSequence charSequence4 = i00Var.f24788b.f24281b;
            ...
            if (i33 != i00Var.f24797h0 || i00Var.getMeasuredWidth() != i00Var.f24799j0) {
                z13 = true;
                i00Var.W = true;
                i00Var.f24798i0 = i00Var.f24797h0;
                z11 = true;
            } else {
                z13 = true;
            }
            ...
            this.f42989r.add(new s4.i(c1Var, i14, i15, i12, i13));
            return z13;
        }
    ...
    public final void x(s4.c1 c1Var) {
        c1Var.f42929a.setTranslationX(0.0f);
        View view = c1Var.f42929a;
        if (view instanceof i00) {
            ((i00) view).a();
        }
