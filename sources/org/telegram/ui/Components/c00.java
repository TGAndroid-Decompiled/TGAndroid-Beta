...
public final class c00 extends s4.j {
    ...
    public final void C(s4.c1 c1Var, s4.i iVar) {
        ...
        if (view instanceof i00) {
            i00 i00Var = (i00) view;
            if (i00Var.f26918w) {
                ValueAnimator valueAnimator = i00Var.f26898a;
                if (valueAnimator != null) {
                    valueAnimator.removeAllListeners();
                    i00Var.f26898a.removeAllUpdateListeners();
                    i00Var.f26898a.cancel();
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                ofFloat.addUpdateListener(new b00(i00Var, 0));
                ofFloat.addListener(new j6(i00Var, 24));
                i00Var.f26898a = ofFloat;
    ...
    public final boolean r(s4.c1 c1Var, b2.q0 q0Var, int i10, int i11, int i12, int i13) {
        ...
        if (view instanceof i00) {
            ...
            TextPaint textPaint = k00Var.f27606b;
            TextPaint textPaint2 = k00Var.f27608c;
            int i26 = i00Var.f26900b.d;
            int i27 = i00Var.I;
            if (i26 != i27) {
                i00Var.H = true;
                i00Var.J = i27;
                i00Var.f26908f0 = i00Var.f26904d0;
                i00Var.f26909g0 = i00Var.f26906e0;
                if (i27 > 0 && i26 > 0) {
                    String valueOf = String.valueOf(i27);
                    String valueOf2 = String.valueOf(i00Var.f26900b.d);
            ...
            int i32 = i00Var.f26900b.f26219c;
            if (i17 != 0) {
                if (str != null) {
                    f10 = 1.0f;
                } else {
            ...
            if (charSequence3 != null && !i00Var.f26900b.f26218b.equals(charSequence3)) {
                if (i00Var.N.length() > i00Var.f26900b.f26218b.length()) {
                    charSequence = i00Var.N;
                    charSequence2 = i00Var.f26900b.f26218b;
                    z14 = true;
                } else {
                    charSequence = i00Var.f26900b.f26218b;
                ...
                if (charSequenceIndexOf >= 0) {
                    ...
                    i00Var.f26899a0 = f7;
                    i00Var.f26903c0 = i00Var.f26901b0;
                    i00Var.R = null;
                    z5.release(i00Var, i00Var.Q);
                } else {
                    z12 = false;
                    CharSequence charSequence4 = i00Var.f26900b.f26218b;
            ...
            if (i33 != i00Var.f26910h0 || i00Var.getMeasuredWidth() != i00Var.f26912j0) {
                z13 = true;
                i00Var.W = true;
                i00Var.f26911i0 = i00Var.f26910h0;
                z11 = true;
            } else {
                z13 = true;
            }
            ...
            this.f45806r.add(new s4.i(c1Var, i14, i15, i12, i13));
            return z13;
        }
    ...
    public final void x(s4.c1 c1Var) {
        c1Var.f45738a.setTranslationX(0.0f);
        View view = c1Var.f45738a;
        if (view instanceof i00) {
            ((i00) view).a();
        }
