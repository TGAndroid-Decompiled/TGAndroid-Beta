...
public class be0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final int[] f21807a0 = {R.id.passcode_btn_0, R.id.passcode_btn_1, R.id.passcode_btn_2, R.id.passcode_btn_3, R.id.passcode_btn_4, R.id.passcode_btn_5, R.id.passcode_btn_6, R.id.passcode_btn_7, R.id.passcode_btn_8, R.id.passcode_btn_9, R.id.passcode_btn_backspace, R.id.passcode_btn_fingerprint};
    ...
    public final ArrayList f21811f;
    public final FrameLayout h;
    public final zd0 f21812n;
    public final EditTextBoldCursor f21813r;
    public final bi.oa f21814s;
    ...
    public be0(Context context) {
        ...
        addView((View) imageView, w7.a6.e(58, 58, 51));
        FrameLayout frameLayout = new FrameLayout(context);
        this.h = frameLayout;
        n7Var.addView(frameLayout, w7.a6.c(-1.0f, -1));
        TextView textView = new TextView(context);
        this.f21815w = textView;
        ...
        this.f21813r = editTextBoldCursor;
        ...
        frameLayout.addView(imageView2, w7.a6.d(60, 60.0f, 85, 0.0f, 0.0f, 10.0f, 4.0f));
        imageView2.setContentDescription(LocaleController.getString(R.string.Done));
        imageView2.setOnClickListener(new View.OnClickListener(this) {
            public final be0 f27007b;
                        ...
                        if (be0Var.U) {
                            ...
                            switch (intValue) {
                                ...
                                case 10:
                                    ...
                                    break;
                                case 11:
                                    ArrayList arrayList = (ArrayList) oaVar2.f3332c;
                                    Property property = View.TRANSLATION_Y;
                                    Property property2 = View.ALPHA;
                                    Property property3 = View.SCALE_Y;
                                    Property property4 = View.SCALE_X;
                                    ArrayList arrayList2 = (ArrayList) oaVar2.f3331b;
                                    ...
                                    if (sb2.length() == 0) {
                                        ...
                                        while (i16 < 4) {
                                            ...
                                            if (textView2.getAlpha() != 0.0f) {
                                                ...
                                                arrayList3.add(ObjectAnimator.ofFloat(textView2, property5, oaVar2.c(i16)));
                                            } else {
                                                linkedList3 = linkedList5;
                                                i12 = intValue;
                                                i13 = 1;
                                        ...
                                        for (int i17 = 0; i17 < length; i17++) {
                                            arrayList3.add(ObjectAnimator.ofFloat((TextView) arrayList2.get(i17), property5, oaVar2.c(i17)));
                                            arrayList3.add(ObjectAnimator.ofFloat((TextView) arrayList.get(i17), property5, oaVar2.c(i17)));
                                        }
                                        kf kfVar = (kf) oaVar2.f3333f;
                                        if (kfVar != null) {
        ...
        frameLayout.addView(imageView3, w7.a6.d(60, 60.0f, 83, 10.0f, 0.0f, 0.0f, 4.0f));
        ...
        while (true) {
            ...
            zd0Var.setTag(Integer.valueOf(i11));
            if (i11 == 11) {
                ...
                zd0Var.setContentDescription(i11 + "");
                zd0Var.setNum(i11);
                if (i11 == 0) {
            ...
            this.f21811f.add(zd0Var);
            i11++;
        }
        for (i10 = 11; i10 >= 0; i10--) {
            this.e.addView((FrameLayout) this.f21811f.get(i10), w7.a6.e(60, 60, 51));
        }
        d();
    }
    ...
    public static void a(be0 be0Var) {
        ...
        float f7;
        float f10;
        FrameLayout frameLayout = be0Var.f21809b;
        bi.oa oaVar = be0Var.f21814s;
        if (oaVar != null && ((StringBuilder) oaVar.d).length() <= 0) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (frameLayout != null) {
            ...
            org.telegram.messenger.em.q(scaleX.scaleY(f11), wr.h, 320L);
        }
    }
    ...
    public final void b(lc0 lc0Var) {
        ...
        kVar2.f14134u = org.telegram.ui.Cells.r6.l(100.0f, 300.0f, 1.0f);
        this.L = kVar2;
        kVar2.a(new di.q4(4, this, lc0Var));
        this.L.b(new k7(lc0Var, 4));
        this.L.f();
    }
    ...
    public final void c() {
        ...
        de0 de0Var;
        if (Build.VERSION.SDK_INT >= 23 && (findActivity = AndroidUtilities.findActivity(getContext())) != null && this.f21812n.getVisibility() == 0 && !ApplicationLoader.mainInterfacePaused) {
            if (findActivity instanceof LaunchActivity) {
                LaunchActivity launchActivity = (LaunchActivity) findActivity;
                ArrayList arrayList = launchActivity.B0;
                if (arrayList.isEmpty() && (de0Var = launchActivity.A0) != null) {
                    if (this != de0Var.f22400b) {
                        return;
                    }
                } else if (hc.b.i(1, arrayList) != this) {
                    return;
                }
            }
            try {
                if (new aa.a(new androidx.biometric.s(getContext(), 0)).f(15) == 0 && FingerprintController.isKeyReady() && !FingerprintController.checkDeviceFingerprintsChanged()) {
                    ...
                    lVar.f11802b = LocaleController.getString(R.string.UnlockToUse);
    ...
    public final void d() {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.be0.d():void");
    }
    ...
    public final void e() {
        ...
        EditTextBoldCursor editTextBoldCursor = this.f21813r;
    ...
    public final boolean g() {
        ...
        if (b5Var != null && b5Var.c()) {
            AndroidUtilities.hideKeyboard(this.f21813r);
            return false;
        }
        return true;
    }
    ...
    public final void i() {
        e();
        if (this.f21816x.getVisibility() != 0) {
            if (SharedConfig.passcodeType == 1) {
                EditTextBoldCursor editTextBoldCursor = this.f21813r;
    ...
    public final void j(boolean z10, int i10, int i11, org.telegram.ui.h90 h90Var) {
        ...
        if (z12) {
            ...
            this.f21808a = org.telegram.ui.ActionBar.j6.r0();
            ...
            if (org.telegram.ui.ActionBar.j6.W && !"CJz3BZ6YGEYBAAAABboWp6SAv04".equals(org.telegram.ui.ActionBar.j6.H0()) && !"qeZWES8rGVIEAAAARfWlK1lnfiI".equals(org.telegram.ui.ActionBar.j6.H0())) {
                ...
                if (!"d".equals(org.telegram.ui.ActionBar.j6.H0())) {
                    ...
                    if (!org.telegram.ui.ActionBar.j6.f18030j0 && !"CJz3BZ6YGEYBAAAABboWp6SAv04".equals(H0) && !"qeZWES8rGVIEAAAARfWlK1lnfiI".equals(H0)) {
        ...
        Drawable drawable = this.f21808a;
        if (drawable instanceof lc0) {
            lc0 lc0Var = (lc0) drawable;
            ...
            this.f21808a = new lc0(false, iArr[0], iArr[1], iArr[2], iArr[3]);
            if (lc0Var.f24959u != null && lc0Var.f24955q < 0) {
                n7Var.setBackgroundColor(2130706432);
            } else {
                n7Var.setBackgroundColor(570425344);
            }
            ((lc0) this.f21808a).r(n7Var);
        }
        this.f21815w.setText(LocaleController.getString(R.string.AppLocked));
        int i16 = SharedConfig.passcodeType;
        ImageView imageView = this.E;
        ImageView imageView2 = this.f21817y;
        bi.l4 l4Var = this.e;
        bi.oa oaVar = this.f21814s;
        if (i16 == 0) {
            if (textView.getVisibility() != 0) {
            ...
            imageView.setVisibility(this.f21812n.getVisibility());
        }
        setVisibility(0);
    ...
    public final void k(boolean z10) {
        ...
        if (!z10) {
            if (SharedConfig.passcodeRetryInMs <= 0) {
                ...
                bi.oa oaVar = this.f21814s;
                if (i10 == 0) {
                    str = ((StringBuilder) oaVar.d).toString();
                } else if (i10 != 1) {
                    str = "";
                } else {
                ...
                FrameLayout frameLayout = this.f21809b;
                if (length == 0) {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        TextView textView = this.f21815w;
        int[] iArr = this.W;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (z10) {
            ...
            int y3 = org.telegram.messenger.em.y(140.0f, i17, 2);
            if (SharedConfig.passcodeType == 0) {
            ...
            if (AndroidUtilities.isTablet()) {
                ...
                if (i17 > AndroidUtilities.dp(528.0f)) {
                    i19 = org.telegram.messenger.em.y(528.0f, i17, 2);
        ...
        for (int i23 = 0; i23 < 12; i23++) {
            ...
            FrameLayout frameLayout3 = (FrameLayout) this.f21811f.get(i23);
