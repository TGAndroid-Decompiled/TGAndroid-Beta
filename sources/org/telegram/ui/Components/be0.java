...
public class be0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final int[] f22982a0 = {R.id.passcode_btn_0, R.id.passcode_btn_1, R.id.passcode_btn_2, R.id.passcode_btn_3, R.id.passcode_btn_4, R.id.passcode_btn_5, R.id.passcode_btn_6, R.id.passcode_btn_7, R.id.passcode_btn_8, R.id.passcode_btn_9, R.id.passcode_btn_backspace, R.id.passcode_btn_fingerprint};
    ...
    public final int[] W;
    public Drawable f22983a;
    public final FrameLayout f22984b;
    public final TextView f22985c;
    public final FrameLayout d;
    public final ai.x5 e;
    public final ArrayList f22986f;
    public final FrameLayout h;
    public final zd0 f22987n;
    public final EditTextBoldCursor f22988r;
    public final ci.m9 f22989s;
    public final ci.n6 v;
    public final TextView f22990w;
    public final TextView f22991x;
    public final ImageView f22992y;
    ...
    public be0(Context context) {
        ...
        this.f22988r = editTextBoldCursor;
        ...
        while (true) {
            ...
            this.f22986f.add(zd0Var);
            i11++;
        }
        for (i10 = 11; i10 >= 0; i10--) {
            this.e.addView((FrameLayout) this.f22986f.get(i10), w7.y5.e(60, 60, 51));
        }
        d();
    }
    ...
    public static void a(be0 be0Var) {
        ...
        float f7;
        float f10;
        FrameLayout frameLayout = be0Var.f22984b;
        ci.m9 m9Var = be0Var.f22989s;
        ...
        if (frameLayout != null) {
            ...
            org.telegram.messenger.wh.r(scaleX.scaleY(f11), qr.h, 320L);
        }
    }
    ...
    public final void b(lc0 lc0Var) {
        ...
        kVar2.f15490u = org.telegram.ui.Cells.c1.j(100.0f, 300.0f, 1.0f);
        this.L = kVar2;
        kVar2.a(new ei.m4(4, this, lc0Var));
    ...
    public final void c() {
        ...
        de0 de0Var;
        if (Build.VERSION.SDK_INT >= 23 && (findActivity = AndroidUtilities.findActivity(getContext())) != null && this.f22987n.getVisibility() == 0 && !ApplicationLoader.mainInterfacePaused) {
            if (findActivity instanceof LaunchActivity) {
                LaunchActivity launchActivity = (LaunchActivity) findActivity;
                ArrayList arrayList = launchActivity.B0;
                if (arrayList.isEmpty() && (de0Var = launchActivity.A0) != null) {
                    if (this != de0Var.f23568b) {
                        return;
                    }
    ...
    public final void e() {
        ...
        EditTextBoldCursor editTextBoldCursor = this.f22988r;
        FrameLayout frameLayout = this.h;
        org.telegram.ui.Cells.t6 t6Var = this.R;
        TextView textView = this.f22991x;
        if (j10 > 0) {
    ...
    public final boolean g() {
        ...
        if (j4Var != null && j4Var.c()) {
            AndroidUtilities.hideKeyboard(this.f22988r);
            return false;
        }
        return true;
    }
    ...
    public final void i() {
        e();
        if (this.f22991x.getVisibility() != 0) {
            if (SharedConfig.passcodeType == 1) {
                EditTextBoldCursor editTextBoldCursor = this.f22988r;
    ...
    public final void j(boolean z10, int i10, int i11, org.telegram.ui.y80 y80Var) {
        ...
        if (z12) {
            ...
            this.f22983a = org.telegram.ui.ActionBar.j6.r0();
            ...
            if (org.telegram.ui.ActionBar.j6.W && !"CJz3BZ6YGEYBAAAABboWp6SAv04".equals(org.telegram.ui.ActionBar.j6.H0()) && !"qeZWES8rGVIEAAAARfWlK1lnfiI".equals(org.telegram.ui.ActionBar.j6.H0())) {
                ...
                if (!"d".equals(org.telegram.ui.ActionBar.j6.H0())) {
                    ...
                    if (!org.telegram.ui.ActionBar.j6.f19165j0 && !"CJz3BZ6YGEYBAAAABboWp6SAv04".equals(H0) && !"qeZWES8rGVIEAAAARfWlK1lnfiI".equals(H0)) {
        ...
        Drawable drawable = this.f22983a;
        if (drawable instanceof lc0) {
            lc0 lc0Var = (lc0) drawable;
            int[] iArr = lc0Var.f26098a;
            if (z11) {
            ...
            this.f22983a = new lc0(false, iArr[0], iArr[1], iArr[2], iArr[3]);
            if (lc0Var.f26119u != null && lc0Var.f26115q < 0) {
                n6Var.setBackgroundColor(2130706432);
            } else {
                n6Var.setBackgroundColor(570425344);
            }
            ((lc0) this.f22983a).r(n6Var);
        }
        this.f22990w.setText(LocaleController.getString(R.string.AppLocked));
        int i16 = SharedConfig.passcodeType;
        ImageView imageView = this.E;
        ImageView imageView2 = this.f22992y;
        ai.x5 x5Var = this.e;
        ci.m9 m9Var = this.f22989s;
        if (i16 == 0) {
            if (textView.getVisibility() != 0) {
            ...
            imageView.setVisibility(this.f22987n.getVisibility());
        }
        setVisibility(0);
    ...
    public final void k(boolean z10) {
        ...
        if (!z10) {
            if (SharedConfig.passcodeRetryInMs <= 0) {
                ...
                FrameLayout frameLayout = this.f22984b;
                if (length == 0) {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        TextView textView = this.f22990w;
        int[] iArr = this.W;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (z10) {
            ...
            int A = org.telegram.messenger.wh.A(140.0f, i17, 2);
            if (SharedConfig.passcodeType == 0) {
            ...
            if (AndroidUtilities.isTablet()) {
                ...
                if (i17 > AndroidUtilities.dp(528.0f)) {
                    i19 = org.telegram.messenger.wh.A(528.0f, i17, 2);
        ...
        for (int i23 = 0; i23 < 12; i23++) {
            ...
            FrameLayout frameLayout3 = (FrameLayout) this.f22986f.get(i23);
