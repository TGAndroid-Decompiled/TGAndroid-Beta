...
public final class zq0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public wq0 G;
    public yq0 H;
    public final xq0[] f30962a;
    public int f30963b;
    public int f30964c;
    public long d;
    public ArrayList e;
    public final ArrayList f30965f;
    public boolean h;
    public boolean f30966n;
    public String f30967r;
    public final ArrayList f30968s;
    public final HashMap v;
    public TLRPC.WebPage f30969w;
    public int f30970x;
    public int f30971y;

    public zq0(Activity activity, org.telegram.ui.ActionBar.d6 d6Var) {
        super(activity);
        this.f30962a = new xq0[2];
        this.f30963b = 0;
        this.f30965f = new ArrayList();
        this.f30966n = true;
        this.f30968s = new ArrayList();
        this.v = new HashMap();
        int i10 = 0;
        while (true) {
            xq0[] xq0VarArr = this.f30962a;
            if (i10 < xq0VarArr.length) {
                xq0VarArr[i10] = new xq0(this, activity, d6Var);
                addView(this.f30962a[i10], w7.y5.c(-1.0f, -1));
                i10++;
            } else {
                xq0VarArr[0].setVisibility(0);
                this.f30962a[1].setVisibility(8);
                return;
            }
        }
    }
    ...
    public static void a(xq0 xq0Var, TLRPC.WebPage webPage, String str) {
        ImageView imageView = xq0Var.f30387b;
        w9 w9Var = xq0Var.f30390n;
        imageView.setImageResource(R.drawable.msg_link2);
        xq0Var.f30387b.setVisibility(0);
        xq0Var.f30389f.setVisibility(8);
        xq0Var.f30391r.setVisibility(0);
        ...
        xq0Var.f30386a.setClickable(false);
    }
    ...
    public final String c(xq0 xq0Var) {
        int measuredWidth;
        String shortName;
        ArrayList arrayList = this.f30965f;
        ...
        while (i10 < size) {
            ...
            if (longValue == this.d) {
                ...
                if (arrayList.size() == 1) {
                    shortName = DialogObject.getName(this.f30964c, longValue);
                } else {
                    shortName = DialogObject.getShortName(this.f30964c, longValue);
                }
    ...
    public final void d() {
        if (this.f30970x != 0) {
            AccountInstance.getInstance(this.f30964c).getConnectionsManager().cancelRequest(this.f30970x, true);
            this.f30970x = 0;
        }
        this.f30971y++;
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        String str;
        if (i10 == NotificationCenter.didReceivedWebpagesInUpdates && this.f30969w != null && i11 == this.f30964c) {
            a0.i iVar = (a0.i) objArr[0];
            for (int i12 = 0; i12 < iVar.m(); i12++) {
                TLRPC.WebPage webPage = (TLRPC.WebPage) iVar.n(i12);
                if (webPage != null && webPage.f18488id == this.f30969w.f18488id) {
                    if (webPage instanceof TLRPC.TL_webPageEmpty) {
                        ...
                        this.f30969w = webPage;
                        ArrayList arrayList = this.f30968s;
                        if (arrayList.isEmpty()) {
                            str = "";
                        } else {
    ...
    public final w9 f(int i10) {
        w9[] w9VarArr;
        if (this.f30963b == 1 && (w9VarArr = this.f30962a[0].h) != null && i10 >= 0 && i10 < w9VarArr.length && w9VarArr[i10].getVisibility() == 0) {
            return w9VarArr[i10];
        }
        return null;
    }
    ...
    public final void h(int i10) {
        if (this.f30964c == i10) {
            ...
            if (isAttachedToWindow()) {
                NotificationCenter.getInstance(this.f30964c).addObserver(this, NotificationCenter.didReceivedWebpagesInUpdates);
                return;
            }
            return;
        }
        if (isAttachedToWindow()) {
            NotificationCenter.getInstance(this.f30964c).removeObserver(this, NotificationCenter.didReceivedWebpagesInUpdates);
        }
        this.f30964c = i10;
        if (isAttachedToWindow()) {
            NotificationCenter.getInstance(this.f30964c).addObserver(this, NotificationCenter.didReceivedWebpagesInUpdates);
    ...
    public final void i(int i10, ArrayList arrayList) {
        ...
        org.telegram.ui.ActionBar.h5 h5Var2 = xq0Var.f30388c;
        imageView.setImageResource(R.drawable.filled_forward);
        xq0Var.f30387b.setVisibility(0);
        xq0Var.f30390n.setVisibility(8);
        xq0Var.f30389f.setVisibility(0);
        xq0Var.f30391r.setVisibility(8);
        xq0Var.f30386a.setClickable(true);
    ...
    public void setLayoutClickListener(View.OnClickListener onClickListener) {
        for (xq0 xq0Var : this.f30962a) {
            xq0Var.f30386a.setOnClickListener(onClickListener);
        }
    }
