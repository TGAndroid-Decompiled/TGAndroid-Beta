...
public final class zd0 extends FrameLayout {
    public final ImageView f29648a;
    public final TextView f29649b;
    public final TextView f29650c;

    public zd0(Context context) {
        super(context);
        ImageView imageView = new ImageView(context);
        this.f29648a = imageView;
    ...
    public void setImage(int i10) {
        ImageView imageView = this.f29648a;
        imageView.setVisibility(0);
        this.f29649b.setVisibility(8);
        this.f29650c.setVisibility(8);
        imageView.setImageResource(i10);
    }

    public void setNum(int i10) {
        this.f29648a.setVisibility(8);
        TextView textView = this.f29649b;
        textView.setVisibility(0);
        TextView textView2 = this.f29650c;
