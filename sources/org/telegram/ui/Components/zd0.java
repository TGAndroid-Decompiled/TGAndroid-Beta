...
public final class zd0 extends FrameLayout {
    ...
    public void setImage(int i10) {
        ImageView imageView = this.f30771a;
        imageView.setVisibility(0);
        this.f30772b.setVisibility(8);
        this.f30773c.setVisibility(8);
        imageView.setImageResource(i10);
    }

    public void setNum(int i10) {
        this.f30771a.setVisibility(8);
        TextView textView = this.f30772b;
        textView.setVisibility(0);
        TextView textView2 = this.f30773c;
