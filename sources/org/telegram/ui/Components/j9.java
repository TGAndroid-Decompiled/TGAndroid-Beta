...
public final class j9 {
    ...
    public boolean d;
    public ValueAnimator f25250f;
    public boolean f25251g;
    public Runnable f25253j;
    public int f25254k;
    ...
    public int f25258o;
    public int f25259p;
    public final View f25261r;
    public int f25262s;
    public boolean f25265w;
    public boolean f25266x;
    public ai.m9 f25267y;
    public final Random f25268z;
    public final i9[] f25248b = new i9[3];
    public final i9[] f25249c = new i9[3];
    public float e = 1.0f;
    public final Paint h = new Paint(1);
    public final Paint f25252i = new Paint(1);
    public int f25260q = AndroidUtilities.dp(1.67f);
    public float f25263t = 0.8f;
    public float f25264u = 1.0f;
    public long v = 220;

    public j9(View view, boolean z10) {
        qr qrVar = qr.f27715f;
        this.f25268z = new Random();
        this.f25261r = view;
        for (int i10 = 0; i10 < 3; i10++) {
            i9[] i9VarArr = this.f25248b;
            ?? obj = new Object();
            i9VarArr[i10] = obj;
            obj.e = new ImageReceiver(view);
            this.f25248b[i10].e.setInvalidateAll(true);
            this.f25248b[i10].e.setRoundRadius(AndroidUtilities.dp(12.0f));
            this.f25248b[i10].f24869a = new h9((org.telegram.ui.ActionBar.e6) null);
            this.f25248b[i10].f24869a.u(AndroidUtilities.dp(12.0f));
            i9[] i9VarArr2 = this.f25249c;
            ?? obj2 = new Object();
            i9VarArr2[i10] = obj2;
            obj2.e = new ImageReceiver(view);
            this.f25249c[i10].e.setInvalidateAll(true);
            this.f25249c[i10].e.setRoundRadius(AndroidUtilities.dp(12.0f));
            this.f25249c[i10].f24869a = new h9((org.telegram.ui.ActionBar.e6) null);
            this.f25249c[i10].f24869a.u(AndroidUtilities.dp(12.0f));
        }
        this.f25256m = z10;
        this.f25252i.setColor(0);
        this.f25252i.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.CLEAR));
    }
    ...
    public final void b(boolean z10, boolean z11) {
        ...
        if (this.d && z10) {
            ...
            boolean z12 = false;
            while (true) {
                i9VarArr = this.f25248b;
                i9VarArr2 = this.f25249c;
                if (i10 >= 3) {
                    break;
                }
                i9VarArr3[i10] = i9VarArr[i10];
                i9 i9Var = i9VarArr[i10];
                long j3 = i9Var.f24873g;
                i9 i9Var2 = i9VarArr2[i10];
                if (j3 != i9Var2.f24873g) {
                    z12 = true;
                } else {
                    i9Var.d = i9Var2.d;
                }
            ...
            for (int i11 = 0; i11 < 3; i11++) {
                ...
                while (true) {
                    if (i12 < 3) {
                        if (i9VarArr[i12].f24873g == i9VarArr2[i11].f24873g) {
                            i9VarArr3[i12] = null;
                            if (i11 == i12) {
                                i9 i9Var3 = i9VarArr2[i11];
                                i9Var3.f24874i = -1;
                                org.telegram.ui.Cells.c4 c4Var = i9Var3.f24870b;
                                i9 i9Var4 = i9VarArr[i11];
                                i9Var3.f24870b = i9Var4.f24870b;
                                i9Var4.f24870b = c4Var;
                            } else {
            ...
            ValueAnimator valueAnimator = this.f25250f;
            ...
            if (z11) {
                ...
                this.f25250f = ofFloat;
                ofFloat.addUpdateListener(new k6(this, 4));
                this.f25250f.addListener(new r8(this, 1));
                this.f25250f.setDuration(this.v);
                this.f25250f.setInterpolator(qr.f27715f);
                this.f25250f.start();
            } else {
                this.f25265w = true;
            }
    ...
    public final float e() {
        ...
        if (i10 == 11) {
            ...
            int i12 = this.f25262s;
            if (i12 != 0) {
                dp = (int) (i12 * this.f25263t);
            } else {
                if (z10) {
                    f7 = 24.0f;
                } else {
    ...
    public final void g() {
        if (!this.B) {
            this.B = true;
            for (int i10 = 0; i10 < 3; i10++) {
                this.f25248b[i10].e.onAttachedToWindow();
                this.f25249c[i10].e.onAttachedToWindow();
            }
        }
    }
    ...
    public final void h() {
        if (this.B) {
            ...
            this.d = false;
            for (int i10 = 0; i10 < 3; i10++) {
                this.f25248b[i10].e.onDetachedFromWindow();
                this.f25249c[i10].e.onDetachedFromWindow();
            }
            if (this.f25254k == 3) {
    ...
    public final void j(int i10) {
        ...
        h9 h9Var2;
        for (int i11 = 0; i11 < 3; i11++) {
            i9 i9Var = this.f25248b[i11];
            if (i9Var != null && (h9Var2 = i9Var.f24869a) != null) {
                h9Var2.u(i10);
            }
            i9 i9Var2 = this.f25249c[i11];
            if (i9Var2 != null && (h9Var = i9Var2.f24869a) != null) {
                h9Var.u(i10);
            }
        }
    }
    ...
    public final void l(int i10, TLObject tLObject, int i11) {
        ...
        if (tLObject instanceof TLRPC.GroupCallParticipant) {
            ...
            i9VarArr[i10].f24873g = peerId;
        } else if (tLObject instanceof TLRPC.User) {
            TLRPC.User user2 = (TLRPC.User) tLObject;
            if (user2.self && this.f25247a) {
                i9Var.f24869a.g(1);
                i9VarArr[i10].f24869a.f24604p = 0.6f;
            } else {
                i9Var.f24869a.g(0);
                h9 h9Var = i9VarArr[i10].f24869a;
                h9Var.f24604p = 1.0f;
                h9Var.m(i11, user2);
            }
            i9VarArr[i10].f24873g = user2.f18443id;
            user = user2;
            chat = null;
        } else if (tLObject instanceof TLRPC.Chat) {
            chat = (TLRPC.Chat) tLObject;
            i9Var.f24869a.g(0);
            h9 h9Var2 = i9VarArr[i10].f24869a;
            h9Var2.f24604p = 1.0f;
            h9Var2.k(i11, chat);
            i9VarArr[i10].f24873g = -chat.f18296id;
            user = null;
        } else {
            user = null;
            chat = null;
        ...
        if (tLObject instanceof TL_stories.StoryItem) {
            ...
            i9VarArr[i10].f24873g = storyItem.f18531id;
            ...
            if (user.self && this.f25247a) {
                i9 i9Var2 = i9VarArr[i10];
                i9Var2.e.setImageBitmap(i9Var2.f24869a);
            } else {
                i9 i9Var3 = i9VarArr[i10];
                i9Var3.e.setForUserOrChat(user, i9Var3.f24869a);
            }
        } else {
            i9 i9Var4 = i9VarArr[i10];
            i9Var4.e.setForUserOrChat(chat, i9Var4.f24869a);
        }
