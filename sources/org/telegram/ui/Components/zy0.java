...
public final class zy0 extends View {
    ...
    public Drawable f30977b;
    public boolean f30978c;
    public int d;
    public final d6 e;
    public final az0 f30979f;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f30977b != null) {
            ...
            this.f30977b.setBounds(getPaddingLeft(), getPaddingTop(), getWidth() - getPaddingRight(), getHeight() - getPaddingBottom());
            canvas.scale(d, d, getWidth() / 2, (getPaddingTop() + height) / 2);
            Drawable drawable = this.f30977b;
            if (drawable instanceof p5) {
                ((p5) drawable).q(System.currentTimeMillis());
            }
            this.f30977b.draw(canvas);
        }
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        Drawable drawable2 = this.f30977b;
        if (drawable2 instanceof p5) {
            ((p5) drawable2).o(this);
        }
        this.f30977b = drawable;
        if ((drawable instanceof p5) && this.f30978c) {
            ((p5) drawable).a(this);
        }
    }
