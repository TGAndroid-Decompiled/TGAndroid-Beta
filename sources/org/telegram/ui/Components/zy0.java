...
public final class zy0 {
    public final org.telegram.ui.ActionBar.d6 f30997a;
    public StaticLayout f30998b;
    public final ArrayList f30999c = new ArrayList(2);
    public int d;
    public int e;
    public int f31000f;
    public int f31001g;
    ...
    public final void b(MessageObject messageObject) {
        ...
        org.telegram.ui.ActionBar.d6 d6Var = this.f30997a;
        if (d6Var != null) {
        ...
        this.f31001g = AndroidUtilities.dp(14.0f) * 2;
        ArrayList arrayList = this.f30999c;
        arrayList.clear();
        ...
        while (i16 < size) {
            ...
            i16++;
            yy0 yy0Var = (yy0) obj;
            f10 = Math.max(f10, yy0Var.f30722a.l());
            f11 = Math.max(f11, yy0Var.f30723b.l());
            int j3 = ((int) yy0Var.f30722a.j()) + this.f31001g;
            this.f31001g = j3;
            this.f31001g = AndroidUtilities.dp(7.0f) + j3;
        }
        ...
        this.f30998b = new StaticLayout(AndroidUtilities.replaceTags(spannableStringBuilder), textPaint, max, Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
        int i30 = 0;
        for (int i31 = 0; i31 < this.f30998b.getLineCount(); i31++) {
            i30 = (int) Math.max(i30, this.f30998b.getLineWidth(i31));
        }
        int height = this.f30998b.getHeight() + this.f31001g;
        this.f31001g = height;
        this.f31001g = AndroidUtilities.dp(5.0f) + height;
        int D = org.telegram.messenger.f0.D(24.0f, 2, Math.max(dp, i30));
        this.h = D;
        this.d = (D - max) / 2;
        this.e = (D - dp) / 2;
        this.f31000f = (int) (AndroidUtilities.dp(f7) + i15 + f10);
    }
}
