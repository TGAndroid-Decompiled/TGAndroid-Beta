...
public final class ec extends FrameLayout {
    public final c6 f23535a;
    public final c6 f23536b;
    public final Paint f23537c;
    public final RectF d;
    public final long e;
    public final fc f23538f;

    public ec(fc fcVar, Activity activity) {
        super(activity);
        this.f23538f = fcVar;
        qr qrVar = qr.h;
        this.f23535a = new c6(this, 320L, qrVar);
        this.f23536b = new c6(this, 320L, qrVar);
    ...
    public final void onDraw(Canvas canvas) {
        boolean z10;
        fc fcVar = this.f23538f;
        float d = this.f23535a.d(fcVar.f23865a, false);
        if (fcVar.f23865a >= 1.0f) {
            z10 = true;
        } else {
            z10 = false;
        }
        float e = this.f23536b.e(z10);
