...
public final class vo0 {
    ...
    public long f29166b;
    public final Object f29167c;
    public final Object d;
    public Object e;
    public Object f29168f;
    public Object f29169g;

    public vo0(y2.d dVar) {
        this.f29167c = dVar;
        int i10 = dVar.f46543b;
        this.f29165a = i10;
        this.d = new e2.v(32);
    ...
    public static u2.x0 d(u2.x0 x0Var, long j3, ByteBuffer byteBuffer, int i10) {
        while (j3 >= x0Var.f43816b) {
            x0Var = (u2.x0) x0Var.d;
        }
        while (i10 > 0) {
            int min = Math.min(i10, (int) (x0Var.f43816b - j3));
            y2.a aVar = (y2.a) x0Var.f43817c;
            byteBuffer.put(aVar.f46537a, ((int) (j3 - x0Var.f43815a)) + aVar.f46538b, min);
            i10 -= min;
            j3 += min;
            if (j3 == x0Var.f43816b) {
                x0Var = (u2.x0) x0Var.d;
    ...
    public static u2.x0 e(u2.x0 x0Var, long j3, byte[] bArr, int i10) {
        ...
        int i11 = i10;
        while (i11 > 0) {
            int min = Math.min(i11, (int) (x0Var.f43816b - j3));
            y2.a aVar = (y2.a) x0Var.f43817c;
            System.arraycopy(aVar.f46537a, ((int) (j3 - x0Var.f43815a)) + aVar.f46538b, bArr, i10 - i11, min);
            i11 -= min;
            j3 += min;
            if (j3 == x0Var.f43816b) {
                x0Var = (u2.x0) x0Var.d;
    ...
    public void a(u2.x0 x0Var) {
        ...
        y2.d dVar = (y2.d) this.f29167c;
        synchronized (dVar) {
            u2.x0 x0Var2 = x0Var;
            while (x0Var2 != null) {
                try {
                    y2.a[] aVarArr = dVar.f46545f;
                    int i10 = dVar.e;
                    dVar.e = i10 + 1;
                    y2.a aVar = (y2.a) x0Var2.f43817c;
                    aVar.getClass();
                    aVarArr[i10] = aVar;
                    dVar.d--;
                    x0Var2 = (u2.x0) x0Var2.d;
                    if (x0Var2 == null || ((y2.a) x0Var2.f43817c) == null) {
                        x0Var2 = null;
                    }
                } catch (Throwable th2) {
                    throw th2;
    ...
    public void b(long j3) {
        ...
        if (j3 != -1) {
            ...
            if (((u2.x0) this.f29168f).f43815a < x0Var.f43815a) {
                this.f29168f = x0Var;
            }
        }
    }
    ...
    public int c(int i10) {
        y2.a aVar;
        u2.x0 x0Var = (u2.x0) this.f29169g;
        if (((y2.a) x0Var.f43817c) == null) {
            y2.d dVar = (y2.d) this.f29167c;
            synchronized (dVar) {
                try {
                    ...
                    if (i12 > 0) {
                        ...
                        aVar = aVarArr[i13];
                        aVar.getClass();
                        dVar.f46545f[dVar.e] = null;
                    } else {
                        y2.a aVar2 = new y2.a(new byte[dVar.f46543b], 0);
                        y2.a[] aVarArr2 = dVar.f46545f;
                        if (i11 > aVarArr2.length) {
                            dVar.f46545f = (y2.a[]) Arrays.copyOf(aVarArr2, aVarArr2.length * 2);
                        }
                        aVar = aVar2;
                    }
                } catch (Throwable th2) {
            ...
            u2.x0 x0Var2 = new u2.x0(((u2.x0) this.f29169g).f43816b, this.f29165a);
            x0Var.f43817c = aVar;
            x0Var.d = x0Var2;
        }
        return Math.min(i10, (int) (((u2.x0) this.f29169g).f43816b - this.f29166b));
    }
