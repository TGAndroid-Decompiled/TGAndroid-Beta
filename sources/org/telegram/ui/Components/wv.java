...
public final class wv extends LinearLayout {
    public final a0.i f30207a;
    public final Paint f30208b;
    public final RectF f30209c;
    public final RectF d;
    public final RectF e;
    public final Path f30210f;
    public final boolean h;
    public final boolean f30211n;
    public final ew f30212r;
    ...
    public wv(ew ewVar, Context context, boolean z10, boolean z11) {
        ...
        this.h = z10;
        this.f30211n = z11;
        this.f30207a = new a0.i();
        this.f30208b = new Paint(1);
        this.f30209c = new RectF();
        this.d = new RectF();
        this.e = new RectF();
        this.f30210f = new Path();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (ewVar.f24067s == null) {
            ewVar.f24067s = new e6(this, 350L, sr.h);
        }
        e6 e6Var = ewVar.f24067s;
        float f11 = 0.0f;
        if (ewVar.f24066r) {
            f7 = 1.0f;
        } else {
        ...
        Path path = this.f30210f;
        path.rewind();
        boolean z11 = this.f30211n;
        if (z11) {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (view == this.f30212r.G) {
            canvas.save();
            canvas.clipPath(this.f30210f);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (this.h) {
            ...
            while (true) {
                ...
                if (childAt != awVar && !ewVar.H.containsKey(childAt) && childAt != null) {
                    ...
                    if (z11) {
                        ...
                        if (l10 == null) {
                            ...
                            if (zxVar != null && (stickerSet = zxVar.f30992b) != null) {
                                ...
                                l10 = awVar2.f22773r;
                                if (l10 == null) {
                                    TLRPC.Document document = awVar2.f22774s;
                                    if (document != null) {
                    ...
                    if ((childAt != ewVar.f24070y || ewVar.W) && (childAt != ewVar.E || ewVar.f24062b0)) {
        ...
        int childCount2 = (getChildCount() - (!ewVar.W ? 1 : 0)) - (!ewVar.f24062b0 ? 1 : 0);
        ...
        for (int i17 = 0; i17 < childCount2; i17++) {
            View childAt2 = getChildAt((!ewVar.W ? 1 : 0) + (!ewVar.f24062b0 ? 1 : 0) + i17);
            if (childAt2 != null) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ew ewVar = this.f30212r;
        float f10 = 0.0f;
        if (!ewVar.W && (awVar2 = ewVar.f24070y) != null) {
            f7 = awVar2.getAlpha() * AndroidUtilities.dp(33.0f);
        } else {
            f7 = 0.0f;
        }
        int i13 = paddingRight - ((int) f7);
        if (!ewVar.f24062b0 && (awVar = ewVar.E) != null) {
