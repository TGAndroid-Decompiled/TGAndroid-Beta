...
public final class ld0 extends Dialog implements org.telegram.ui.ActionBar.a5 {
    public final ActionBarLayout f26081a;
    public final FrameLayout f26082b;
    public final de0 f26083c;

    public ld0(Context context) {
        super(context, R.style.TransparentDialog);
        ActionBarLayout actionBarLayout = new ActionBarLayout(context, false);
        this.f26081a = actionBarLayout;
    ...
    public final void onBackPressed() {
        if (this.f26083c.getVisibility() == 0) {
        ...
        ActionBarLayout actionBarLayout = this.f26081a;
        actionBarLayout.G();
        if (actionBarLayout.getFragmentStack().size() <= 1) {
            dismiss();
        }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        FrameLayout frameLayout = this.f26082b;
        frameLayout.setSystemUiVisibility(1280);
        frameLayout.setOnApplyWindowInsetsListener(new org.telegram.ui.ActionBar.g3(2));
        if (i10 >= 26) {
            if (i0.a.f(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19109d6, true)) < 0.9d) {
                z10 = false;
            }
    ...
    public final void onStart() {
        ...
        if (context instanceof LaunchActivity) {
            ((LaunchActivity) context).B0.add(this.f26083c);
        }
    }
    ...
    public final void onStop() {
        ...
        if (context instanceof LaunchActivity) {
            ((LaunchActivity) context).B0.remove(this.f26083c);
        }
    }
