...
public abstract class l41 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final d6 P;
    public Boolean Q;
    public Integer f25987b;
    public final CharSequence f25988c;
    public final TLRPC.InputPeer d;
    public final int e;
    public final boolean f25989f;
    public final TL_iv.RichMessage h;
    public final RichMessageLayout.PreviewView f25990n;
    public final RichMessageLayout.PreviewView f25991r;
    public final String f25992s;
    public String v;
    public String f25993w;
    public final j41 f25994x;
    public final bi.o f25995y;
    ...
    public l41(Context context, String str, String str2, CharSequence charSequence, TLRPC.InputPeer inputPeer, int i10, boolean z10, TL_iv.RichMessage richMessage) {
        ...
        n90Var.setHighlightColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19431uf));
        int themedColor = getThemedColor(org.telegram.ui.ActionBar.j6.f19448vf);
        try {
        ...
        ?? h0Var = new s4.h0();
        h0Var.e = 1;
        h0Var.f25621c = context;
        h0Var.d = view;
        this.I = h0Var;
        y31Var.setAdapter(h0Var);
        ...
        RichMessageLayout.PreviewView previewView3 = this.f25991r;
        ...
        frameLayout.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19180h5));
    ...
    public static void m(l41 l41Var, TLRPC.TL_textWithEntities tL_textWithEntities, TLRPC.TL_textWithEntities tL_textWithEntities2, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && "TRANSLATIONS_DISABLED_ALT".equalsIgnoreCase(tL_error.text)) {
            ...
            h41 h41Var = l41Var.f25994x.e;
            String str = l41Var.f25993w;
            l41Var.v = str;
    ...
    public static void o(l41 l41Var, TLObject tLObject) {
        RichMessageLayout.PreviewView previewView = l41Var.f25991r;
        l41Var.f25987b = null;
    ...
    public static void p(l41 l41Var, String str, Boolean bool) {
        ...
        if (str != null) {
            ...
            xc xcVar = new xc((FrameLayout) l41Var.containerView, l41Var.resourcesProvider);
            if (bool.booleanValue()) {
                i10 = R.string.TranslationFailedAlert1;
            } else {
                i10 = R.string.TranslationFailedAlert2;
            }
            org.telegram.messenger.rk.p(i10, xcVar, null);
            h41 h41Var = l41Var.f25994x.e;
            String str2 = l41Var.f25993w;
            l41Var.v = str2;
    ...
    public static boolean u(l41 l41Var) {
        ...
        for (int i10 = 0; i10 < y31Var.getChildCount(); i10++) {
            View childAt = y31Var.getChildAt(i10);
            if (RecyclerView.S(childAt) == 1) {
                f7 += childAt.getHeight();
            }
        }
        if (f7 < (y31Var.getHeight() - y31Var.getPaddingTop()) - y31Var.getPaddingBottom()) {
            return false;
        }
        return true;
    }
    ...
    public final void M() {
        ...
        if (this.f25987b != null) {
            ConnectionsManager.getInstance(this.currentAccount).cancelRequest(this.f25987b.intValue(), true);
            this.f25987b = null;
        }
        ...
        if (richMessage != null && inputPeer != null) {
            ...
            tL_messages_translateRichMessage.f18464id.add(Integer.valueOf(i10));
            tL_messages_translateRichMessage.to_lang = TranslateController.normalizeLanguage(str);
            this.f25987b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_translateRichMessage, new x1(this, 16)));
            return;
        }
        TLRPC.TL_textWithEntities tL_textWithEntities = new TLRPC.TL_textWithEntities();
        CharSequence charSequence2 = this.f25988c;
        ...
        if (this.f25989f && inputPeer != null) {
            ...
            tL_messages_summarizeText.f18463id = i10;
            tL_messages_summarizeText.to_lang = TranslateController.normalizeLanguage(str);
            this.f25987b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequestTyped(tL_messages_summarizeText, new Object(), new ai.m0(13, this, tL_textWithEntities)));
            return;
        }
        ...
        if (inputPeer != null) {
            ...
            tL_messages_translateText.f18465id.add(Integer.valueOf(i10));
        } else {
            tL_messages_translateText.flags |= 2;
            tL_messages_translateText.text.add(tL_textWithEntities);
        }
        tL_messages_translateText.to_lang = TranslateController.normalizeLanguage(str);
        this.f25987b = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_translateText, new org.telegram.ui.oo(17, this, tL_textWithEntities)));
    }
