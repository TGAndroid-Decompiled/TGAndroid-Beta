...
public class ChatReplyContainer extends FrameLayout {
    ...
    public void switchLayouts(boolean z) {
        ...
        this.layouts[1].animate().scaleX(0.8f).scaleY(0.8f).alpha(0.0f).translationY(-AndroidUtilities.dp(20.0f)).setInterpolator(cubicBezierInterpolator).setDuration(320L).withEndAction(new GroupCallPip$$ExternalSyntheticLambda2(layout3, 5)).start();
    }
}
