...
public final class oz0 extends TableLayout {
    public final org.telegram.ui.ActionBar.d6 f26887a;
    public final Path f26888b;
    public final float[] f26889c;
    ...
    public oz0(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f26888b = new Path();
        this.f26889c = new float[8];
        this.d = new Paint(1);
        this.e = new Paint(1);
    ...
    public final mz0 a(CharSequence charSequence) {
        ...
        org.telegram.ui.ActionBar.d6 d6Var = this.f26887a;
    ...
    public final void b(CharSequence charSequence, ArrayList arrayList) {
        ...
        y5Var.setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.G6, this.f26887a));
    ...
    public final TableRow c(CharSequence charSequence, CharSequence charSequence2, nz0[] nz0VarArr, zc[] zcVarArr) {
        ...
        d90Var.setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.G6, this.f26887a));
    ...
    public final void h(String str, CharSequence charSequence, int i10, uh.i iVar) {
        ...
        int i12 = org.telegram.ui.ActionBar.h6.f19118v6;
    ...
    public final TableRow j(CharSequence charSequence, int i10, long j3, Runnable runnable, String str, Runnable runnable2) {
        ...
        ImageReceiver imageReceiver = h5Var.f33732b;
        if (j3 == 2666000) {
        ...
        if (str != null) {
            d90Var.M = new ad(str, runnable2, d6Var);
        }
        d90Var.setText(spannableStringBuilder);
        if (!z10) {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        paint.setStrokeWidth(this.f26890f);
        int i14 = org.telegram.ui.ActionBar.h6.f19036qh;
        org.telegram.ui.ActionBar.d6 d6Var = this.f26887a;
        paint.setColor(org.telegram.ui.ActionBar.h6.v0(i14, d6Var));
        Paint.Style style2 = Paint.Style.FILL;
        Paint paint2 = this.d;
        paint2.setStyle(style2);
        paint2.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19018ph, d6Var));
            ...
            if (getChildAt(i15) instanceof TableRow) {
                ...
                for (int i16 = 0; i16 < childCount2; i16++) {
                    ...
                    if (childAt instanceof nz0) {
                        ...
                        if (nz0Var.f26547b != z15 || nz0Var.f26548c != z16) {
                            nz0Var.f26547b = z15;
                            nz0Var.f26548c = z16;
                            nz0Var.invalidate();
                        }
                        ...
                        if (lz0Var.f26045b != z12 || lz0Var.f26046c != z13) {
                            lz0Var.f26045b = z12;
                            lz0Var.f26046c = z13;
                            lz0Var.invalidate();
                        }
                        ...
                        if (mz0Var.f26305c != z11 || mz0Var.d != z16) {
                            mz0Var.f26305c = z11;
                            mz0Var.d = z16;
                            mz0Var.invalidate();
                        }
