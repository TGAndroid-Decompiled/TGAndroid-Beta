...
public final class oz0 extends TextView {
    ...
    public oz0(pz0 pz0Var, CharSequence charSequence) {
        ...
        this.f26910a = pz0Var;
        org.telegram.ui.ActionBar.e6 e6Var = pz0Var.f27199a;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f7;
        float f10;
        boolean z10 = this.f26911b;
        pz0 pz0Var = this.f26910a;
        if (z10 || this.f26912c) {
            canvas2 = canvas;
            ...
            canvas2.drawPath(pz0Var.f27200b, pz0Var.d);
