...
public final class um0 extends kl0 {
    ...
    public final MessageObject E(int i10) {
        vm0 vm0Var = this.f28431c;
        int i11 = vm0Var.v;
        if (i10 >= i11 && i10 < vm0Var.f28839w) {
            return (MessageObject) vm0Var.e.get(i10 - i11);
        }
        int i12 = vm0Var.f28841y;
        if (i10 >= i12 && i10 < vm0Var.E) {
            return (MessageObject) vm0Var.f28835f.get(i10 - i12);
        }
        return null;
    }
    ...
    @Override
    public final int h() {
        return this.f28431c.f28837r;
    }

    @Override
    public final int j(int i10) {
        vm0 vm0Var = this.f28431c;
        if (i10 != vm0Var.f28838s && i10 != vm0Var.f28840x) {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i13 == 0) {
            ...
            if (i10 == vm0Var.f28838s) {
                ...
                if (u3Var.getText().equals(string)) {
                    ...
                    org.telegram.ui.Cells.t3 t3Var = u3Var.f21425b;
        ...
        MessageObject E = E(i10);
        if (E != null) {
            if (vm0Var.I.g() && i10 >= vm0Var.v && i10 < vm0Var.f28839w) {
                z10 = true;
            } else {
                z10 = false;
            }
            ...
            if (i13 == 1) {
                rm0 rm0Var = (rm0) view;
                rm0Var.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18836d6, false));
                org.telegram.ui.Cells.j7 j7Var = rm0Var.f27655a;
                ...
                p10Var.f36388a = j7Var.getMessage().getDialogId();
                p10Var.f36389b = id4;
                ...
                p10Var.f36388a = i7Var.getMessage().getDialogId();
                p10Var.f36389b = id5;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            frameLayout2.f27655a = j7Var;
            j7Var.f20328r.setVisibility(8);
