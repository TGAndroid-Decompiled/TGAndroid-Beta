...
public final class p01 {
    ...
    public final void a(TextPaint textPaint) {
        ...
        if ((this.f26908a & 16) != 0) {
            textPaint.setFlags(textPaint.getFlags() | 8);
        } else {
            textPaint.setFlags(textPaint.getFlags() & (-9));
        }
        int i12 = this.f26908a;
        if ((i12 & 8) == 0 && (i12 & 8192) == 0) {
            textPaint.setFlags(textPaint.getFlags() & (-17));
        } else {
            textPaint.setFlags(textPaint.getFlags() | 16);
        }
        if ((this.f26908a & 512) != 0) {
            textPaint.bgColor = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.R9, false);
        }
        int i13 = this.f26908a;
        if ((i13 & 8192) != 0) {
            textPaint.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19101q7, false));
        } else if ((i13 & 4096) != 0) {
    ...
    public p01(p01 p01Var) {
        this.f26908a = p01Var.f26908a;
        this.f26909b = p01Var.f26909b;
        this.f26910c = p01Var.f26910c;
        this.d = p01Var.d;
        this.e = p01Var.e;
    }
}
