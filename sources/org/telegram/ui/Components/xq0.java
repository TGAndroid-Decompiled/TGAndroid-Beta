...
public final class xq0 extends FrameLayout {
    public final LinearLayout f30379a;
    public final ImageView f30380b;
    public final org.telegram.ui.ActionBar.h5 f30381c;
    public final org.telegram.ui.ActionBar.h5 d;
    public final org.telegram.ui.ActionBar.h5 e;
    public final FrameLayout f30382f;
    public final w9[] h;
    public final w9 f30383n;
    public final ImageView f30384r;
    public final zq0 f30385s;

    public xq0(zq0 zq0Var, Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f30385s = zq0Var;
        LinearLayout linearLayout = new LinearLayout(context);
        this.f30379a = linearLayout;
        linearLayout.setOrientation(0);
        linearLayout.setBackground(org.telegram.ui.ActionBar.h6.a0(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19134i6, d6Var), 20, 20, 6, 6));
        ...
        imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19347te, d6Var), PorterDuff.Mode.MULTIPLY));
        linearLayout.addView(imageView, w7.y5.q(40, 38, 51));
        FrameLayout frameLayout = new FrameLayout(context);
        this.f30382f = frameLayout;
        ...
        for (int i10 = 2; i10 >= 0; i10--) {
            ...
            int i11 = 32 - (i10 * 4);
            this.f30382f.addView(this.h[i10], w7.y5.d(i11, i11, 19, i10 * 12, 0.0f, 0.0f, 0.0f));
        }
        w9 w9Var = new w9(context);
        this.f30383n = w9Var;
        w9Var.setRoundRadius(AndroidUtilities.dp(4.0f));
        w9Var.setVisibility(8);
        this.f30379a.addView(w9Var, w7.y5.t(34, 34, 19, 6, 0, 0, 0));
        FrameLayout frameLayout2 = new FrameLayout(context);
        this.f30379a.addView(frameLayout2, w7.y5.o(0, -1, 1.0f, 119));
        org.telegram.ui.ActionBar.h5 h5Var = new org.telegram.ui.ActionBar.h5(context);
        this.f30381c = h5Var;
        h5Var.setTextSize(14);
        h5Var.setTypeface(AndroidUtilities.bold());
        h5Var.setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19383ve, d6Var));
        ...
        imageView2.setBackground(org.telegram.ui.ActionBar.h6.f0(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19134i6, d6Var), 1, AndroidUtilities.dp(18.0f)));
        imageView2.setVisibility(8);
        imageView2.setOnClickListener(new i80(this, 15));
        this.f30379a.addView(imageView2, w7.y5.t(36, 36, 21, 0, 0, 4, 0));
    }
}
