...
public class BottomPagerTabs extends View {
    ...
    public class Tab {
        ...
        public Tab(int i, int i2, int i3, int i4, CharSequence charSequence) {
            ...
            RLottieDrawable rLottieDrawable = new RLottieDrawable(i2, DiffUtil.m(i2, ""), AndroidUtilities.dp(29.0f), AndroidUtilities.dp(29.0f));
            ...
            this.ripple = Theme.createSelectorDrawable(Theme.multAlpha(0.1f, Theme.getColor(i5, BottomPagerTabs.this.resourcesProvider)), 7, AndroidUtilities.dp(16.0f));
        }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (f > 0.0f) {
            ...
            float fLerp = AndroidUtilities.lerp(fFloor, fCeil, f6 - ((int) f6)) + paddingLeft;
        ...
        while (true) {
            ...
            Tab tab = tabArr[i];
            int paddingLeft2 = (i * width) + getPaddingLeft();
            ...
            tab.setColor(ColorUtils.blendARGB(fMin, color, Theme.getColor(i2, this.resourcesProvider)));
            ...
            if (f < 1.0f) {
                this.selectPaint.setColor(ColorUtils.setAlphaComponent(Theme.getColor(i2, this.resourcesProvider), (int) ((1.0f - f) * f9 * 18.0f)));
