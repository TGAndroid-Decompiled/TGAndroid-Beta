...
public final class tp0 extends qv0 {
    ...
    public tp0(iq0 iq0Var, Context context) {
        ...
        this.F0 = AndroidUtilities.computePerceivedBrightness(iq0Var.getThemedColor(org.telegram.ui.ActionBar.j6.f18934h5)) > 0.721f;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        canvas.save();
        canvas.clipRect(0.0f, getPaddingTop() + iq0Var.f25011t0, getMeasuredWidth(), getMeasuredHeight() + iq0Var.f25011t0 + AndroidUtilities.dp(50.0f));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        FrameLayout frameLayout = iq0Var.f25014w;
        canvas.translate(0.0f, iq0Var.f25011t0);
        int i17 = iq0Var.f25005p0;
        i10 = ((org.telegram.ui.ActionBar.g3) iq0Var).backgroundPaddingTop;
        int dp2 = AndroidUtilities.dp(6.0f) + (i17 - i10) + this.f28184z0;
        int i18 = iq0Var.f25005p0;
        ...
        if (f7 < 1.0f) {
            ...
            org.telegram.ui.ActionBar.j6.f19151t0.setColor(iq0Var.getThemedColor(org.telegram.ui.ActionBar.j6.Ii));
            org.telegram.ui.ActionBar.j6.f19151t0.setAlpha((int) ((1.0f - f7) * paint.getAlpha()));
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        } else if (motionEvent.getAction() == 0 && iq0Var.f25005p0 != 0 && motionEvent.getY() < iq0Var.f25005p0 - AndroidUtilities.dp(30.0f)) {
            iq0Var.dismiss();
            return true;
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        FrameLayout frameLayout2 = iq0Var.f25007r;
        np0 np0Var = iq0Var.d;
        int i27 = size2 - (i16 * 2);
        int R = tp0Var.R();
        iq0Var.N0 = R;
