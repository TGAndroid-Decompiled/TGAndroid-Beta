...
public final class d41 extends org.telegram.ui.ActionBar.g3 {
    ...
    public final ci.i1 f32999b;
    public final Paint f33000c;
    public final boolean d;
    public final boolean e;
    public final boolean f33001f;
    public final ArrayList h;
    public final byte[] f33002n;
    public final long f33003r;
    public z31 f33004s;
    ...
    public static void H(d41 d41Var, CharSequence charSequence, byte[] bArr, String str) {
        ...
        if (d41Var.d) {
            ...
            if (d41Var.e) {
                ...
                if (arrayList != null) {
                    tL_stories_report.f18368id.addAll(arrayList);
                }
                if (str != null) {
                    str2 = str;
                }
                ...
                if (arrayList != null && !arrayList.isEmpty()) {
                    tL_reportMessage.f18336id = ((Integer) arrayList.get(0)).intValue();
                }
                if (str != null) {
                    str2 = str;
                }
    ...
    public static void m(Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10, boolean z11, long j3, ArrayList arrayList, boolean[] zArr, Utilities.Callback callback, org.telegram.ui.Components.vc vcVar, TLRPC.ReportResult reportResult) {
        ...
        if (z12) {
            ...
            View[] viewPages = d41Var.f32999b.getViewPages();
        ...
        d41Var.f33004s = new u31(zArr, callback, vcVar);
    ...
    public static void n(d41 d41Var, TLObject tLObject, CharSequence charSequence, TLRPC.TL_error tL_error, byte[] bArr, String str) {
        ...
        z31 z31Var2;
        ci.d dVar;
        ci.i1 i1Var = d41Var.f32999b;
        if ((i1Var.getCurrentView() instanceof c41) && (dVar = ((c41) i1Var.getCurrentView()).f32670s) != null) {
        ...
        if (tLObject != null) {
            ...
            if (!z10 && !(tLObject instanceof TLRPC.TL_reportResultChooseOption) && !(tLObject instanceof TLRPC.TL_reportResultAddComment)) {
                if (tLObject instanceof TLRPC.TL_channels_sponsoredMessageReportResultAdsHidden) {
                    ...
                    return;
                } else if (((tLObject instanceof TLRPC.TL_channels_sponsoredMessageReportResultReported) || (tLObject instanceof TLRPC.TL_reportResultReported)) && (z31Var2 = d41Var.f33004s) != null) {
                    z31Var2.a();
                    d41Var.dismiss();
                    return;
                } else {
            ...
            if (c41Var != null) {
                ...
                if (tLObject instanceof TLRPC.TL_reportResultChooseOption) {
                    c41Var.f32665b = null;
                    c41Var.f32666c = (TLRPC.TL_reportResultChooseOption) tLObject;
                    c41Var.d = null;
                    f61Var.Y2.N(false);
                } else if (tLObject instanceof TLRPC.TL_reportResultAddComment) {
                    c41Var.b((TLRPC.TL_reportResultAddComment) tLObject);
                } else if (z10) {
                    c41Var.f32665b = (TLRPC.TL_channels_sponsoredMessageReportResultChooseOption) tLObject;
                    c41Var.f32666c = null;
                    c41Var.d = null;
                    f61Var.Y2.N(false);
                }
            ...
            if (!d41Var.d && "MESSAGE_ID_REQUIRED".equals(tL_error.text)) {
                ...
                z31 z31Var4 = d41Var.f33004s;
                if (z31Var4 != null) {
                    z31Var4.c();
                }
            } else if ("AD_EXPIRED".equals(tL_error.text) && (z31Var = d41Var.f33004s) != null) {
                z31Var.a();
            }
            d41Var.dismiss();
        }
    ...
    public final void O(TLRPC.TL_channels_sponsoredMessageReportResultChooseOption tL_channels_sponsoredMessageReportResultChooseOption) {
        View[] viewPages = this.f32999b.getViewPages();
        View view = viewPages[0];
        if (view instanceof c41) {
            ((c41) view).a(0);
    ...
    public final boolean canDismissWithSwipe() {
        View currentView = this.f32999b.getCurrentView();
        if (!(currentView instanceof c41)) {
            return true;
        }
        return !((c41) currentView).f32667f.canScrollVertically(-1);
    }

    @Override
    public final void onBackPressed() {
        b41 b41Var;
        ci.i1 i1Var = this.f32999b;
        if ((i1Var.getCurrentView() instanceof c41) && (b41Var = ((c41) i1Var.getCurrentView()).f32668n) != null) {
