...
public final class d41 implements Runnable {
    ...
    public final SecretMediaViewer f36003b;

    public d41(SecretMediaViewer secretMediaViewer, int i10) {
        this.f36002a = i10;
        this.f36003b = secretMediaViewer;
    }
    ...
    public final void run() {
        ...
        SecretMediaViewer secretMediaViewer = this.f36003b;
        switch (i10) {
            case 0:
                ...
                secretMediaViewer.i();
                new ArrayList();
                AndroidUtilities.runOnUIThread(new d41(secretMediaViewer, 4), 50L);
                return;
            case 1:
            ...
            case 2:
                ...
                if (j41Var != null) {
                    ...
                    if (p10 > 0) {
                        ...
                        if (!m71Var.f28961f) {
                            m71Var.h(((float) n10) / ((float) p10), false);
                    ...
                    Arrays.fill(iArr2, 0);
                    j41 j41Var2 = secretMediaViewer.f34811y;
                    if (j41Var2 != null) {
    ...
    public d41(SecretMediaViewer secretMediaViewer, lu0 lu0Var, int i10) {
        this.f36002a = i10;
        this.f36003b = secretMediaViewer;
    }
}
