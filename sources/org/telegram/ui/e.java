    ...
    public final void b() {
        ...
        switch (this.f33234a) {
            case 0:
                ...
                return;
            case 1:
                fv fvVar = ((z6) this.f33235b).T;
                if (fvVar != null) {
                    fvVar.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19129h5, false));
                    return;
                }
                return;
            case 2:
                k9.U((k9) this.f33235b);
                return;
            case 3:
                ld ldVar = (ld) this.f33235b;
                ...
                if (linearLayout != null) {
                    ...
                    for (int i11 = 0; i11 < childCount; i11++) {
                        ...
                        if (childAt instanceof org.telegram.ui.Cells.n) {
                            ...
                            nVar.d.k(nVar.f20661n, nVar.f20660f);
                            nVar.f20657a.invalidate();
                        }
                    }
                    return;
                }
                return;
            case 4:
                wn wnVar = (wn) this.f33235b;
                gj gjVar = wnVar.f39680w;
                if (gjVar != null) {
                    gjVar.d();
                }
                gj gjVar2 = wnVar.f39693x;
                if (gjVar2 != null) {
                    gjVar2.d();
                }
                jk jkVar = wnVar.Y;
                ...
                if (rjVar != null) {
                    ...
                    for (int i12 = 0; i12 < childCount2; i12++) {
                        View childAt2 = wnVar.f39694x0.getChildAt(i12);
                ...
                org.telegram.ui.Components.gg0 gg0Var = wnVar.f39721z2;
                if (gg0Var != null) {
                    gg0Var.d();
                }
                lk lkVar = wnVar.Z;
                if (lkVar != null && lkVar.getEditView() != null) {
                    for (org.telegram.ui.Components.pd pdVar : wnVar.Z.getEditView().f27031a) {
                        pdVar.d();
                    }
                }
                ...
                if (mjVar != null) {
                    org.telegram.ui.ActionBar.d6 d6Var = mjVar.f24539d0;
                    org.telegram.ui.Components.xw0 xw0Var = mjVar.N;
                    if (xw0Var != null) {
                        xw0Var.b(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19282pa, d6Var));
                    }
                    Drawable drawable = mjVar.f24553q0;
                    if (drawable != null) {
                        drawable.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19472zh, d6Var), PorterDuff.Mode.MULTIPLY));
                    }
                    org.telegram.ui.Components.o5 o5Var = mjVar.f24543g0;
                    if (o5Var != null) {
                        o5Var.k(Integer.valueOf(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19472zh, d6Var)));
                    }
                    org.telegram.ui.Components.o5 o5Var2 = mjVar.f24542f0;
                    if (o5Var2 != null) {
                        o5Var2.k(Integer.valueOf(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19472zh, d6Var)));
                    }
                    Drawable drawable2 = mjVar.f24555r0;
                    if (drawable2 != null) {
                        drawable2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19472zh, d6Var), PorterDuff.Mode.MULTIPLY));
                    }
                    Drawable drawable3 = mjVar.f24557s0;
                    if (drawable3 != null) {
                ...
                if (dhVar != null) {
                    ch.d dVar2 = dhVar.f23698s;
                    if (dVar2 != null) {
                        dVar2.v();
                    }
                    Color.alpha(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19059d6, false));
                    dhVar.invalidate();
                }
                org.telegram.ui.Components.yy0 yy0Var = wnVar.f39447d1;
                if (yy0Var != null) {
                    org.telegram.ui.ActionBar.d6 d6Var2 = yy0Var.f30729b;
                ...
                mj mjVar2 = wnVar.f39408a1;
                if (mjVar2 != null && mjVar2.getTimeItem() != null) {
                    wnVar.f39408a1.getTimeItem().invalidate();
                }
                hh.g gVar = wnVar.S;
                if (gVar != null) {
                    gVar.f10510f.v();
            ...
            case 5:
                ...
                return;
            case 6:
                fp fpVar = (fp) this.f33235b;
                LinearLayout linearLayout2 = fpVar.f33735x;
                if (linearLayout2 != null) {
                    int childCount4 = linearLayout2.getChildCount();
                    for (int i16 = 0; i16 < childCount4; i16++) {
                        View childAt4 = fpVar.f33735x.getChildAt(i16);
                        if (childAt4 instanceof org.telegram.ui.Cells.n) {
                            org.telegram.ui.Cells.n nVar3 = (org.telegram.ui.Cells.n) childAt4;
                            nVar3.d.k(nVar3.f20661n, nVar3.f20660f);
                            nVar3.f20657a.invalidate();
                        }
                    }
                }
                fpVar.G.f();
                org.telegram.ui.Components.d70 d70Var = fpVar.f33727p0;
                if (d70Var != null) {
                    d70Var.b0();
                    return;
                }
                return;
            case 7:
                rp rpVar = (rp) this.f33235b;
                org.telegram.ui.Components.xl0 xl0Var = rpVar.f37426b;
                if (xl0Var != null) {
                    int childCount5 = xl0Var.getChildCount();
                    for (int i17 = 0; i17 < childCount5; i17++) {
                        View childAt5 = rpVar.f37426b.getChildAt(i17);
            ...
            case 8:
                ...
                return;
            case 9:
                kq kqVar = (kq) this.f33235b;
                ai.w0 w0Var2 = kqVar.f35124b;
                if (w0Var2 != null) {
                    int childCount6 = w0Var2.getChildCount();
                    for (int i18 = 0; i18 < childCount6; i18++) {
                        View childAt6 = kqVar.f35124b.getChildAt(i18);
                ...
                return;
            case 10:
                pr prVar = (pr) this.f33235b;
                ai.w0 w0Var3 = prVar.f36614c;
                if (w0Var3 != null) {
                    int childCount7 = w0Var3.getChildCount();
                    for (int i19 = 0; i19 < childCount7; i19++) {
                        View childAt7 = prVar.f36614c.getChildAt(i19);
                ...
                return;
            case 11:
                ms.W((ms) this.f33235b);
                return;
            case 12:
                ContactsActivity.V((ContactsActivity) this.f33235b);
                return;
            case 13:
                b10 b10Var = (b10) this.f33235b;
                ai.w0 w0Var4 = b10Var.f32272a;
                if (w0Var4 != null) {
                    int childCount8 = w0Var4.getChildCount();
                    for (int i20 = 0; i20 < childCount8; i20++) {
                        View childAt8 = b10Var.f32272a.getChildAt(i20);
                ...
                return;
            case 14:
                ai.n4 n4Var = ((t10) this.f33235b).m0;
            ...
            case 15:
                ...
                return;
            case 16:
                z60 z60Var = (z60) this.f33235b;
                org.telegram.ui.Components.xl0 xl0Var2 = z60Var.f40381n;
                if (xl0Var2 != null) {
                    int childCount9 = xl0Var2.getChildCount();
                    for (int i21 = 0; i21 < childCount9; i21++) {
                        View childAt9 = z60Var.f40381n.getChildAt(i21);
                ...
                org.telegram.ui.Components.a20 a20Var = z60Var.f40394y;
                if (a20Var != null) {
                    a20Var.g();
                    return;
                }
                return;
            case 17:
                g70 g70Var = (g70) this.f33235b;
                org.telegram.ui.Components.xl0 xl0Var3 = g70Var.f33835b;
                if (xl0Var3 != null) {
                    int childCount10 = xl0Var3.getChildCount();
                    for (int i22 = 0; i22 < childCount10; i22++) {
                        View childAt10 = g70Var.f33835b.getChildAt(i22);
                ...
                return;
            case 18:
                ((y70) this.f33235b).V(true);
                return;
            case 19:
                g80 g80Var = (g80) this.f33235b;
                org.telegram.ui.Components.xl0 xl0Var4 = g80Var.h;
                if (xl0Var4 != null) {
                    int childCount11 = xl0Var4.getChildCount();
            ...
            case 20:
                ...
                if (e9Var != null) {
                    ...
                    int i25 = org.telegram.ui.ActionBar.h6.f19442y6;
                    nb0Var2.setHintTextColor(org.telegram.ui.ActionBar.h6.w0(null, i25, false));
                    rb0Var.f37287w.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i24, false));
                    rb0Var.f37287w.setHintTextColor(org.telegram.ui.ActionBar.h6.w0(null, i25, false));
            ...
            case 21:
                ...
                cd0Var.f32677s.setColorFilter(new PorterDuffColorFilter(cd0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19129h5), PorterDuff.Mode.MULTIPLY));
                cd0Var.v.invalidate();
                if (cd0Var.I != null) {
                    if (AndroidUtilities.computePerceivedBrightness(cd0Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19059d6)) < 0.721f) {
                    ...
                    if (i10 != 0) {
                        ...
                        return;
                    } else if (cd0Var.f32655a0) {
                        cd0Var.f32655a0 = false;
            ...
            case 23:
                ...
                return;
            case 24:
                sh0 sh0Var = (sh0) this.f33235b;
                org.telegram.ui.Components.xl0 xl0Var5 = sh0Var.f37769b;
                if (xl0Var5 != null) {
                    int childCount12 = xl0Var5.getChildCount();
                    for (int i26 = 0; i26 < childCount12; i26++) {
                        View childAt12 = sh0Var.f37769b.getChildAt(i26);
                        if (childAt12 instanceof org.telegram.ui.Cells.b5) {
                            ((org.telegram.ui.Cells.b5) childAt12).c(0);
                        }
                        if (childAt12 instanceof org.telegram.ui.Components.h90) {
                            ((org.telegram.ui.Components.h90) childAt12).f();
                        }
                    }
                }
                org.telegram.ui.Components.d70 d70Var2 = sh0Var.f37782l0;
                if (d70Var2 != null) {
                    d70Var2.b0();
                    return;
                }
                return;
            case 25:
                dj0 dj0Var = (dj0) this.f33235b;
                org.telegram.ui.Components.xl0 xl0Var6 = dj0Var.f33139f;
                if (xl0Var6 != null) {
                    int childCount13 = xl0Var6.getChildCount();
                    for (int i27 = 0; i27 < childCount13; i27++) {
                        dj0Var.d0(dj0Var.f33139f.getChildAt(i27));
                    }
                    int hiddenChildCount = dj0Var.f33139f.getHiddenChildCount();
                    for (int i28 = 0; i28 < hiddenChildCount; i28++) {
                        dj0Var.d0(dj0Var.f33139f.V(i28));
                    }
                    int cachedChildCount = dj0Var.f33139f.getCachedChildCount();
                    for (int i29 = 0; i29 < cachedChildCount; i29++) {
                        dj0Var.d0(dj0Var.f33139f.P(i29));
                    }
                    int attachedScrapChildCount = dj0Var.f33139f.getAttachedScrapChildCount();
                    for (int i30 = 0; i30 < attachedScrapChildCount; i30++) {
                        dj0Var.d0(dj0Var.f33139f.O(i30));
                    }
                    dj0Var.f33139f.getRecycledViewPool().a();
                }
                ig.f fVar = dj0Var.f33136c0;
                if (fVar != null) {
                    fVar.f11101g = true;
                }
                View subtitleTextView = dj0Var.f33134b0.getSubtitleTextView();
                ...
                return;
            case 26:
                NotificationsCustomSettingsActivity notificationsCustomSettingsActivity = (NotificationsCustomSettingsActivity) this.f33235b;
                org.telegram.ui.Components.xl0 xl0Var7 = notificationsCustomSettingsActivity.f31149a;
                if (xl0Var7 != null) {
                    int childCount14 = xl0Var7.getChildCount();
                    for (int i31 = 0; i31 < childCount14; i31++) {
                        View childAt13 = notificationsCustomSettingsActivity.f31149a.getChildAt(i31);
            ...
            case 27:
                ...
                return;
            case 28:
                ((PremiumPreviewFragment) this.f33235b).u0();
                return;
            default:
                yx0 yx0Var = (yx0) this.f33235b;
                org.telegram.ui.Components.xl0 xl0Var8 = yx0Var.f40267a;
                if (xl0Var8 != null) {
                    int childCount15 = xl0Var8.getChildCount();
                    for (int i32 = 0; i32 < childCount15; i32++) {
                        View childAt14 = yx0Var.f40267a.getChildAt(i32);
