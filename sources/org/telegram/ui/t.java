...
public final class t implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        switch (this.f41413a) {
            case 0:
                l4 l4Var = this.f41414b;
                eh.d dVar = l4Var.f38615n0;
            ...
            case 1:
                ...
                if (!TextUtils.isEmpty(str)) {
                    l4 l4Var2 = this.f41414b;
                    l4Var2.f38607e0.V.setText(str);
                    mh.m mVar = l4Var2.f38607e0.V;
                    mVar.setSelection(mVar.getText().length());
                    AndroidUtilities.showKeyboard(l4Var2.f38607e0.V);
                    return;
                }
                return;
            case 2:
                String str2 = (String) obj;
                l4 l4Var3 = this.f41414b;
                if (l4Var3.I != null && str2 != null) {
                    l4Var3.f38607e0.k(false);
                    if (af.g.f(Uri.parse(str2), false, null)) {
                        ...
                        if (p3Var != null && p3Var.getWebView() != null) {
                            l4Var3.f38619r0[0].getWebView().loadUrl(str2);
                            return;
                        } else {
                            af.g.n(str2);
                            return;
            ...
            default:
                ...
                l4 l4Var4 = this.f41414b;
                if (l4Var4.I != null && b1Var != null) {
                    l4Var4.f38607e0.k(false);
                    p3 p3Var2 = l4Var4.f38619r0[0];
                    if (p3Var2 != null && p3Var2.getWebView() != null) {
                        l4Var4.f38619r0[0].getWebView().e(b1Var.f42511c, b1Var.d);
                        return;
                    } else {
                        af.g.n(b1Var.f42511c);
                        return;
                    }
                }
                return;
