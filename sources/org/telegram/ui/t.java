...
public final class t implements lv0, org.telegram.ui.Components.bl0, org.telegram.ui.ActionBar.l1 {
    ...
    public boolean a(int i10, View view) {
        i4 i4Var = this.f40578a;
        i4Var.getClass();
        if (view instanceof i2) {
            c4 c4Var = ((i2) view).f37168n;
            i4Var.Z(c4Var.f34991a.articles.get(c4Var.f34992b).url);
            return true;
        }
        return false;
    }
    ...
    public void h(float[] fArr) {
        i4 i4Var = this.f40578a;
        fArr[0] = i4Var.I0;
        fArr[1] = i4Var.f37233u0[0].f38552b.getMeasuredHeight();
    }
