...
public final class t implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        switch (this.f38464a) {
            case 0:
                l4 l4Var = this.f38465b;
                dh.d dVar = l4Var.f35941n0;
            ...
            case 1:
                ...
                if (!TextUtils.isEmpty(str)) {
                    l4 l4Var2 = this.f38465b;
                    l4Var2.f35933e0.V.setText(str);
                    lh.n nVar = l4Var2.f35933e0.V;
                    nVar.setSelection(nVar.getText().length());
                    AndroidUtilities.showKeyboard(l4Var2.f35933e0.V);
                    return;
                }
                return;
            case 2:
                String str2 = (String) obj;
                l4 l4Var3 = this.f38465b;
                if (l4Var3.I != null && str2 != null) {
                    l4Var3.f35933e0.k(false);
                    if (af.g.f(Uri.parse(str2), false, null)) {
                        ...
                        if (p3Var != null && p3Var.getWebView() != null) {
                            l4Var3.f35945r0[0].getWebView().loadUrl(str2);
                            return;
                        } else {
                            af.g.n(str2);
                            return;
            ...
            default:
                ...
                l4 l4Var4 = this.f38465b;
                if (l4Var4.I != null && b1Var != null) {
                    l4Var4.f35933e0.k(false);
                    p3 p3Var2 = l4Var4.f35945r0[0];
                    if (p3Var2 != null && p3Var2.getWebView() != null) {
                        l4Var4.f35945r0[0].getWebView().e(b1Var.f39461c, b1Var.d);
                        return;
                    } else {
                        af.g.n(b1Var.f39461c);
                        return;
                    }
                }
                return;
