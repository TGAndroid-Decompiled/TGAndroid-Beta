...
public final class mx0 extends s4.o {
    public int f35670b;
    public final SparseIntArray f35671c = new SparseIntArray();
    ...
    public final boolean b(int i10, int i11) {
        int i12 = this.f35671c.get(i10, -1);
    ...
    public final void f(SparseIntArray sparseIntArray) {
        ...
        g(6, privacyControlActivity.f31472g0, sparseIntArray);
        ...
        g(19, privacyControlActivity.f31463a0, sparseIntArray);
        g(20, privacyControlActivity.f31465b0, sparseIntArray);
        g(21, privacyControlActivity.f31467c0, sparseIntArray);
        i14 = privacyControlActivity.readRow;
        g(22, i14, sparseIntArray);
        g(23, privacyControlActivity.f31468d0, sparseIntArray);
        g(24, privacyControlActivity.f31469e0, sparseIntArray);
        g(25, privacyControlActivity.f31471f0, sparseIntArray);
        g(26, privacyControlActivity.f31473h0, sparseIntArray);
        i15 = privacyControlActivity.priceRow;
        g(27, i15, sparseIntArray);
        g(28, privacyControlActivity.f31475j0, sparseIntArray);
        i16 = privacyControlActivity.showGiftIconRow;
        g(29, i16, sparseIntArray);
        g(30, privacyControlActivity.f31476k0, sparseIntArray);
        i17 = privacyControlActivity.giftTypesHeaderRow;
        g(31, i17, sparseIntArray);
        g(32, privacyControlActivity.m0, sparseIntArray);
        g(33, privacyControlActivity.f31477l0, sparseIntArray);
        g(34, privacyControlActivity.f31479n0, sparseIntArray);
        g(35, privacyControlActivity.f31480o0, sparseIntArray);
        g(36, privacyControlActivity.f31481p0, sparseIntArray);
        g(37, privacyControlActivity.f31482q0, sparseIntArray);
    }
}
