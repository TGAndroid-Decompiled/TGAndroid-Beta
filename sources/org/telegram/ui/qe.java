                        ...
                        switch (r3) {
                            ...
                            default:
                                ...
                                if (tLObject3 == null && boVar3.getParentActivity() != null) {
                                    AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(boVar3.getParentActivity(), 0, boVar3.f32275ea);
                                    alertDialog$Builder.f18446a.R = LocaleController.getString(R.string.AppName);
                                    alertDialog$Builder.f18446a.T = LocaleController.getString(R.string.EditMessageError);
                                    alertDialog$Builder.k(LocaleController.getString(R.string.OK), null);
                                    boVar3.showDialog(alertDialog$Builder.f18446a);
                                    nk nkVar = boVar3.Y;
                                    if (nkVar != null) {
                                        nkVar.b1(null, null, false);
                                        boVar3.e9(true);
                                        return;
                                    }
                                    return;
                        ...
                        switch (r3) {
                            ...
                            default:
                                ...
                                if (tLObject3 == null && boVar32.getParentActivity() != null) {
                                    AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(boVar32.getParentActivity(), 0, boVar32.f32275ea);
                                    alertDialog$Builder.f18446a.R = LocaleController.getString(R.string.AppName);
                                    alertDialog$Builder.f18446a.T = LocaleController.getString(R.string.EditMessageError);
                                    alertDialog$Builder.k(LocaleController.getString(R.string.OK), null);
                                    boVar32.showDialog(alertDialog$Builder.f18446a);
                                    nk nkVar = boVar32.Y;
                                    if (nkVar != null) {
                                        nkVar.b1(null, null, false);
                                        boVar32.e9(true);
