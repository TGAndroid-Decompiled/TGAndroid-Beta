...
public final class qe implements org.telegram.ui.Components.b60, org.telegram.ui.Components.d60, org.telegram.ui.ActionBar.a2, org.telegram.ui.Components.io, MessagesStorage.BooleanCallback, org.telegram.ui.Components.wj0, ResultCallback, wh.c, jh.a, jh.b, z60, rs, org.telegram.ui.Components.ll0, jh.d, org.telegram.ui.Components.xk0 {
    public final int f36890a;
    public final zn f36891b;
    ...
    public void b() {
        ...
        if (znVar.y3 == null && znVar.getParentActivity() != null) {
            znVar.Q7();
            znVar.y3.m(znVar.T5, znVar.f40305f, 8);
        }
    }
    ...
    public void c(TLRPC.Document document) {
        switch (this.f36890a) {
            case 4:
                zn.b1(this.f36891b, document);
                return;
            default:
                zn.e1(this.f36891b, document);
                return;
        }
    }
            ...
            if ((adapter.I != null || adapter.J != null) && i10 != 0) {
                ...
                if (J instanceof gg.h1) {
                    ...
                    if (znVar.I1.getAdapter().J != null) {
                        ...
                        alertDialog$Builder.f18654a.T = LocaleController.getString(R.string.ClearSearch);
        ...
        switch (this.f36890a) {
            case 11:
                ...
                if (znVar.getParentActivity() != null && znVar.getParentActivity() != null) {
                    ii iiVar = new ii(znVar, znVar, znVar.getParentActivity(), znVar.f40303ea, arrayList);
                ...
                return;
            default:
                zn znVar2 = this.f36891b;
                if (znVar2.getParentActivity() != null && znVar2.getParentActivity() != null) {
                    fj fjVar = new fj(znVar2, znVar2, znVar2.getParentActivity(), znVar2.f40303ea, arrayList);
    ...
    public void f(boolean z10, boolean z11) {
        zn znVar = this.f36891b;
        znVar.M0.i(znVar.f40315fa.c(), z10, z11);
    }
    ...
    public void h(int i10) {
        ...
        if (i10 == 1) {
            ...
            znVar.D4 = true;
            znVar.getMessagesController().getNextPollVotesMention(znVar.T5, znVar.d(), znVar.f40391m1, new qg(znVar, 1));
        } else if (i10 == 6) {
            znVar.Y8(true);
        } else if (i10 == 5) {
            znVar.Y8(false);
    ...
    public void i(int i10, ArrayList arrayList) {
        ...
        znVar.getMessagesController().hidePeerSettingsBar(znVar.T5, znVar.f40305f, znVar.e);
        znVar.Qc(true);
        znVar.oc(true);
    }
    ...
    public void k(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        switch (this.f36890a) {
            ...
            case 8:
                zn znVar2 = this.f36891b;
                znVar2.getMessagesController().unblockPeer(znVar2.f40305f.f18475id);
                return;
            case 10:
                this.f36891b.finishFragment();
                return;
            case 12:
                gg.k1 adapter = this.f36891b.I1.getAdapter();
                adapter.f9841w.c();
                adapter.I.clear();
                adapter.l();
            ...
            case 16:
                ...
                return;
            case 17:
                zn znVar5 = this.f36891b;
                MessageObject messageObject = (MessageObject) znVar5.J4.get(Integer.valueOf(znVar5.L4));
                if (messageObject == null) {
                    messageObject = (MessageObject) znVar5.f40421o6[0].get(znVar5.L4);
                }
                znVar5.cc(messageObject);
                return;
            case 19:
                zn znVar6 = this.f36891b;
                MessagePreviewParams messagePreviewParams2 = znVar6.f40311f5;
    ...
    public void run(boolean z10) {
        ...
        znVar.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.needDeleteDialog, Long.valueOf(znVar.T5), znVar.f40305f, znVar.e, Boolean.valueOf(z10));
    }
