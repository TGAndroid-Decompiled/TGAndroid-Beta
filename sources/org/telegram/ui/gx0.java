...
public final class gx0 extends org.telegram.ui.Components.ll0 {
    ...
    public gx0(jx0 jx0Var, Context context) {
        ...
        this.X2 = paint;
        paint.setColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18907h5, false));
        this.Y2 = new Path();
    }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (this.Z2.f34997n.f31174q0 >= 1.0f) {
            return false;
        }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        PremiumPreviewFragment premiumPreviewFragment = this.Z2.f34997n;
        int i14 = 0;
        int i15 = 0;
        while (true) {
