...
public final class oq extends org.telegram.ui.Components.ll0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        ...
        int i11 = pqVar.f36715y;
        TLRPC.TL_chatAdminRights tL_chatAdminRights = pqVar.N;
        if (!pqVar.f36711w.creator || ((i11 != 0 && (i11 != 2 || !pqVar.K)) || i10 != 4 || c1Var.b() != pqVar.f36690e0)) {
            if (pqVar.I) {
                if ((i11 == 0 || i11 == 2) && i10 == 4) {
                    int b10 = c1Var.b();
                    if (b10 == pqVar.W) {
                        if (!tL_chatAdminRights.add_admins && ((chat = pqVar.f36711w) == null || !chat.creator)) {
                            return false;
                        }
    ...
    public final long i(int i10) {
        ...
        if (pqVar.f36715y == 2) {
            ...
            if (i10 == pqVar.f36684b0) {
                return 4L;
            }
            if (i10 == pqVar.f36687c0) {
                return 5L;
            }
            if (i10 == pqVar.f36689d0) {
                return 6L;
            }
            if (i10 == pqVar.f36690e0) {
                return 7L;
            }
            if (i10 == pqVar.f36692f0) {
                return 8L;
            }
            if (i10 == pqVar.f36693g0) {
                return 9L;
            }
            if (i10 == pqVar.f36694h0) {
                return 10L;
            }
            if (i10 == pqVar.f36701o0) {
                return 11L;
            }
            if (i10 == pqVar.f36702p0) {
                return 12L;
            }
            if (i10 == pqVar.f36703q0) {
                return 13L;
            }
            if (i10 == pqVar.f36705r0) {
                return 14L;
            }
            if (i10 == pqVar.f36707s0) {
                return 15L;
            }
            if (i10 == pqVar.f36708t0) {
                return 16L;
            }
            if (i10 == pqVar.f36709u0) {
                return 17L;
            }
            if (i10 == pqVar.f36710v0) {
                return 18L;
            }
            if (i10 == pqVar.f36712w0) {
                return 19L;
            }
            if (i10 == pqVar.f36716y0) {
                return 20L;
            }
            if (i10 == pqVar.B0) {
                return 21L;
            ...
            if (i10 == pqVar.f36695i0) {
                return 45L;
            }
            if (i10 == pqVar.f36696j0) {
                return 46L;
            }
            if (i10 == pqVar.f36697k0) {
                return 47L;
            }
            if (i10 == pqVar.f36698l0) {
                return 48L;
            }
            if (i10 == pqVar.f36700n0) {
                return 49L;
            }
            if (i10 == pqVar.f36681a0) {
                return 50L;
            }
            return 0L;
        }
    ...
    public final int j(int i10) {
        pq pqVar = this.e;
        if (i10 != pqVar.H0 && i10 != pqVar.J0 && i10 != pqVar.I0 && i10 != pqVar.B0 && i10 != pqVar.C0 && i10 != pqVar.E0 && i10 != pqVar.D0 && i10 != pqVar.G0 && i10 != pqVar.F0 && i10 != pqVar.f36696j0 && i10 != pqVar.P0 && i10 != pqVar.Q0 && i10 != pqVar.R0 && i10 != pqVar.U0 && i10 != pqVar.V0 && i10 != pqVar.W0) {
            if (i10 != pqVar.f36717z0 && i10 != pqVar.N0 && i10 != pqVar.S0) {
                if (i10 == 0) {
                    return 0;
                }
                if (i10 != 1 && i10 != pqVar.f36701o0 && i10 != pqVar.f36703q0 && i10 != pqVar.L0 && i10 != pqVar.f36707s0) {
                    if (i10 != 2 && i10 != pqVar.f36709u0) {
                        if (i10 != pqVar.X && i10 != pqVar.Y && i10 != pqVar.Z && i10 != pqVar.f36684b0 && i10 != pqVar.f36687c0 && i10 != pqVar.f36689d0 && i10 != pqVar.f36692f0 && i10 != pqVar.f36693g0 && i10 != pqVar.f36694h0 && i10 != pqVar.f36695i0 && i10 != pqVar.f36716y0 && i10 != pqVar.f36690e0 && i10 != pqVar.K0 && i10 != pqVar.W && i10 != pqVar.m0 && i10 != pqVar.f36697k0 && i10 != pqVar.f36700n0 && i10 != pqVar.f36681a0) {
                            if (i10 == pqVar.f36705r0 || i10 == pqVar.f36712w0 || i10 == pqVar.f36698l0) {
                                return 1;
                            }
                            if (i10 == pqVar.M0) {
                                return 6;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        Context context = this.f36403c;
        pq pqVar = this.e;
        switch (i10) {
            case 0:
                View zaVar = new org.telegram.ui.Cells.za(context, null);
                zaVar.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18863d6, false));
                c6Var = zaVar;
                break;
            case 1:
            ...
            default:
                ...
                break;
            case 3:
                View l4Var = new org.telegram.ui.Cells.l4(this.f36403c, org.telegram.ui.ActionBar.j6.L6, 21, 15, true, null);
            ...
            case 9:
                ...
                v8Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18863d6, false));
                c6Var = v8Var;
                break;
            case 5:
            ...
            case 6:
                ...
                c9Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18863d6, false));
                c6Var = c9Var;
                break;
            case 7:
                org.telegram.ui.Cells.c6 c6Var2 = new org.telegram.ui.Cells.c6(context, 0, null, null);
                c6Var2.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18863d6, false));
            ...
            case 8:
                ...
                pqVar.f36691f.setTextColor(-1);
                pqVar.f36691f.setTextSize(AndroidUtilities.dp(14.0f));
                pqVar.f36691f.setGravity(17);
                org.telegram.ui.Components.n6 n6Var2 = pqVar.f36691f;
                ...
                pqVar.e.addView(pqVar.f36691f, w7.x5.e(-2, -2, 17));
                ...
                break;
            case 10:
                org.telegram.ui.Cells.z1 z1Var2 = new org.telegram.ui.Cells.z1(4, 21, this.f36403c, pqVar.getResourceProvider(), false);
                z1Var2.setPad(1);
                ...
                z1Var2.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18863d6, false));
                z1Var = z1Var2;
                c6Var = z1Var;
                break;
            case 11:
                ...
                c6Var = new org.telegram.ui.Components.c01(i12, -pqVar.f36706s, this.f36403c, f6Var);
                break;
        }
    ...
    public final void y(s4.c1 c1Var) {
        int b10 = c1Var.b();
        pq pqVar = this.e;
        if (b10 == pqVar.f36709u0) {
            pq.f0(pqVar, c1Var.f42702a);
        }
    }
    ...
    public final void z(s4.c1 c1Var) {
        int b10 = c1Var.b();
        pq pqVar = this.e;
        if (b10 == pqVar.f36710v0 && pqVar.getParentActivity() != null) {
