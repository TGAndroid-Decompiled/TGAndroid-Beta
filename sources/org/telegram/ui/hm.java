    ...
    public final boolean onPreDraw() {
        ...
        switch (i10) {
            case 0:
                ...
                org.telegram.ui.Components.hk0 cameraRect = boVar.f32248b3.getCameraRect();
                float f10 = imageWidth / cameraRect.f24714c;
                ...
                org.telegram.ui.Components.p50 cameraContainer = boVar.f32248b3.getCameraContainer();
                ...
                ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(cameraContainer, View.TRANSLATION_Y, iArr[1] - cameraRect.f24713b);
                View buttonsLayout = boVar.f32248b3.getButtonsLayout();
                Property property = View.ALPHA;
                animatorSet.playTogether(ofFloat, ofFloat2, ofFloat3, ObjectAnimator.ofFloat(buttonsLayout, property, 0.0f), ObjectAnimator.ofInt(boVar.f32248b3.getPaint(), org.telegram.ui.Components.q6.f27257b, 0), ObjectAnimator.ofFloat(boVar.f32248b3.getMuteImageView(), property, 0.0f));
                animatorSet.setInterpolator(org.telegram.ui.Components.qr.h);
                ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(cameraContainer, View.TRANSLATION_X, iArr[0] - cameraRect.f24712a);
                ...
                return true;
            case 1:
                ((zx) obj).f40323b.f38222e0[0].f37752a.getViewTreeObserver().removeOnPreDrawListener(this);
            ...
            default:
                ...
                if (wbVar != null) {
                    ...
                    hVar.f43787a.getLocationInWindow(iArr2);
                    hVar.X = (hVar.W.f29678a.getMeasuredWidth() / 2.0f) + (f11 - iArr2[0]) + hVar.W.f29678a.getLeft();
                    hVar.Y = (hVar.W.f29678a.getMeasuredHeight() / 2.0f) + ((translationY + f7) - iArr2[1]) + hVar.W.f29678a.getTop();
                }
                hVar.c();
                return true;
        }
