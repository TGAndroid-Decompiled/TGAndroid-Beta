    ...
    public final boolean onPreDraw() {
        ...
        switch (i10) {
            case 0:
                ...
                org.telegram.ui.Components.hk0 cameraRect = boVar.f32252b3.getCameraRect();
                float f10 = imageWidth / cameraRect.f24711c;
                ...
                org.telegram.ui.Components.p50 cameraContainer = boVar.f32252b3.getCameraContainer();
                ...
                ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(cameraContainer, View.TRANSLATION_Y, iArr[1] - cameraRect.f24710b);
                View buttonsLayout = boVar.f32252b3.getButtonsLayout();
                Property property = View.ALPHA;
                animatorSet.playTogether(ofFloat, ofFloat2, ofFloat3, ObjectAnimator.ofFloat(buttonsLayout, property, 0.0f), ObjectAnimator.ofInt(boVar.f32252b3.getPaint(), org.telegram.ui.Components.q6.f27260b, 0), ObjectAnimator.ofFloat(boVar.f32252b3.getMuteImageView(), property, 0.0f));
                animatorSet.setInterpolator(org.telegram.ui.Components.qr.h);
                ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(cameraContainer, View.TRANSLATION_X, iArr[0] - cameraRect.f24709a);
                ...
                return true;
            case 1:
                ((zx) obj).f40327b.f38207e0[0].f37803a.getViewTreeObserver().removeOnPreDrawListener(this);
            ...
            default:
                ...
                if (wbVar != null) {
                    ...
                    hVar.f43791a.getLocationInWindow(iArr2);
                    hVar.X = (hVar.W.f29681a.getMeasuredWidth() / 2.0f) + (f11 - iArr2[0]) + hVar.W.f29681a.getLeft();
                    hVar.Y = (hVar.W.f29681a.getMeasuredHeight() / 2.0f) + ((translationY + f7) - iArr2[1]) + hVar.W.f29681a.getTop();
                }
                hVar.c();
                return true;
        }
