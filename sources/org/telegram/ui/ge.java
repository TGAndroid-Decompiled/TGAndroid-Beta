...
public final class ge extends LinearLayout {
    ...
    public final org.telegram.ui.Components.i81 f36662b;
    public final fe f36663c;
    public final long d;
    public final od f36664e;
    public String f36665f;
    public final ArrayList h;
    public final ArrayList f36666n;
    public String f36667r;
    public final boolean[] f36668s;
    public final ke v;
    ...
    public ge(ke keVar, Context context, int i10, long j3, int i11, od odVar, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f36667r = "";
        this.f36668s = new boolean[]{false, false};
        this.f36661a = i10;
        this.d = j3;
        this.f36664e = odVar;
        setOrientation(1);
    ...
    public final boolean a() {
        if (this.h.isEmpty() && this.f36666n.isEmpty()) {
            return false;
        }
        return true;
    }
    ...
    public final void c(final int i10) {
        ...
        if (!zArr[i10]) {
            ...
            if (i10 == 1) {
                                            ...
                                            switch (r7) {
                                                case 0:
                                                    ...
                                                    if (z12) {
                                                        ...
                                                        geVar2.f36666n.addAll(starsStatus.history);
                                                        geVar2.f36667r = starsStatus.next_offset;
                                                        geVar2.f36668s[i15] = false;
                                                        geVar2.d();
                                                    } else {
                                                    ...
                                                    if (geVar2.a() != z10 && (odVar = geVar2.f36664e) != null) {
                                                        odVar.run();
                                                    }
                                                    if (geVar2.b(i15) != z11) {
                                                        geVar2.e();
                                                ...
                                                default:
                                                    ...
                                                    if (z13) {
                                                        ...
                                                        geVar3.f36665f = starsStatus2.next_offset;
                                                        geVar3.f36668s[i17] = false;
                                                        geVar3.d();
                                                    } else {
                                                    ...
                                                    if (geVar3.a() != z10 && (odVar2 = geVar3.f36664e) != null) {
                                                        odVar2.run();
                                                    }
                                                    if (geVar3.b(i17) != z11) {
                                                        geVar3.e();
                                            ...
                                            switch (r7) {
                                                case 0:
                                                    ...
                                                    if (z122) {
                                                        ...
                                                        geVar22.f36666n.addAll(starsStatus.history);
                                                        geVar22.f36667r = starsStatus.next_offset;
                                                        geVar22.f36668s[i15] = false;
                                                        geVar22.d();
                                                    } else {
                                                        TLRPC.TL_error tL_error2 = tL_error;
                                                        if (tL_error2 != null) {
                                                    ...
                                                    if (geVar22.a() != z12 && (odVar = geVar22.f36664e) != null) {
                                                        odVar.run();
                                                    }
                                                ...
                                                default:
                                                    ...
                                                    if (geVar3.a() != z12 && (odVar2 = geVar3.f36664e) != null) {
                                                        odVar2.run();
                                                    }
                                                    if (geVar3.b(i17) != z13) {
                                                        geVar3.e();
            ...
            } else if (i10 == 0 && this.f36667r != null && keVar.f38046g1) {
                zArr[i10] = true;
                ...
                tL_payments_getStarsTransactions2.offset = this.f36667r;
                if (this.f36666n.isEmpty()) {
                    i11 = 5;
                }
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r7) {
                                            case 0:
                                                ...
                                                if (geVar22.a() != z10 && (odVar = geVar22.f36664e) != null) {
                                                    odVar.run();
                                                }
    ...
    public final void d() {
        int i10 = 0;
        while (true) {
            org.telegram.ui.Components.i81 i81Var = this.f36662b;
            if (i10 < i81Var.getViewPages().length) {
                View view = i81Var.getViewPages()[i10];
                if (view instanceof ee) {
                    ee eeVar = (ee) view;
                    org.telegram.ui.Components.d61 d61Var = eeVar.f36032a;
                    d61Var.Y2.N(true);
    ...
    public final void e() {
        ...
        int[] iArr = i81Var.f27045f;
        if (iArr[0] != i81Var.L.h(i81Var.f27042b)) {
            i81Var.I(0);
            View view = viewArr[1];
            if (view != null) {
    ...
    public org.telegram.ui.Components.ll0 getCurrentListView() {
        View currentView = this.f36662b.getCurrentView();
        if (!(currentView instanceof ee)) {
            return null;
        }
        return ((ee) currentView).f36032a;
    }
}
