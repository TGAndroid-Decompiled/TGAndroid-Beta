...
public final class x71 implements RequestDelegate {
    public final int f42952a;
    public final SessionsActivity f42953b;

    public x71(SessionsActivity sessionsActivity, int i10) {
        this.f42952a = i10;
        this.f42953b = sessionsActivity;
    }
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f42952a) {
            case 0:
                AndroidUtilities.runOnUIThread(new sz0(this.f42953b, 17));
                return;
            case 1:
                final SessionsActivity sessionsActivity = this.f42953b;
                ...
                return;
            case 2:
                final SessionsActivity sessionsActivity2 = this.f42953b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        org.telegram.ui.Components.qc a02;
                ...
                return;
            default:
                final SessionsActivity sessionsActivity3 = this.f42953b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        org.telegram.ui.Components.qc a02;
