...
public final class gh1 extends ScrollView {
    ...
    public final void onScrollChanged(int i10, int i11, int i12, int i13) {
        ...
        hh1 hh1Var = this.e;
        TextView textView = hh1Var.f34272c;
        if (textView != null) {
            int[] iArr = this.f33859a;
            textView.getLocationOnScreen(iArr);
            int measuredHeight = hh1Var.f34272c.getMeasuredHeight() + iArr[1];
            ...
            if (hh1Var.f34272c.getTag() == null) {
                z11 = true;
            } else {
                z11 = false;
            }
            if (z10 != z11) {
                TextView textView2 = hh1Var.f34272c;
                if (z10) {
                    num = null;
                } else {
                    num = 1;
    ...
    public final void requestChildFocus(View view, View view2) {
        if (Build.VERSION.SDK_INT < 29 && view2 != null && !this.f33861c) {
