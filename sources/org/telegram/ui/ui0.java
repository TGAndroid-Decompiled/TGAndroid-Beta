...
public final class ui0 extends org.telegram.ui.Components.ll0 {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        bj0 bj0Var = this.f38007b3;
        if (bj0Var.f32203w && ((view == (t1Var = bj0Var.Q) && t1Var != null && t1Var.getCurrentPosition() == null) || view == bj0Var.X)) {
            return false;
        }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        for (int i14 = 0; i14 < getChildCount(); i14++) {
            ...
            if (childAt.getTop() != 0 && (childAt instanceof aj0)) {
                ...
                aj0Var.Fe = childAt.getTop();
                aj0Var.Ge = childAt.getBottom();
                aj0Var.He = aj0Var.getMessageObject().getId();
            }
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(Math.max(0, ((AndroidUtilities.displaySize.y - (dp + measuredHeight)) - AndroidUtilities.dp(8.0f)) - bj0Var.e.f10589b), Integer.MIN_VALUE));
        if (bj0Var.m0) {
            l4 = bj0Var.Y;
        } else {
            l4 = bj0Var.W.l();
        }
        int max = Math.max(AndroidUtilities.dp(12.0f) + l4, -((AndroidUtilities.dp(7.0f) + bj0Var.f32193o0[0]) - getMeasuredWidth()));
        int i13 = bj0Var.O;
