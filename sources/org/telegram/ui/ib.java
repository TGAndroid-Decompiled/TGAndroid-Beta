...
public final class ib extends rb {
    public final hh.l f34089x0;
    public final ub f34090y0;

    public ib(ub ubVar, Context context) {
        super(ubVar, context);
        this.f34090y0 = ubVar;
        this.f34089x0 = new hh.l();
    }
    ...
    public final void onAttachedToWindow() {
        ...
        if (playingMessageObject != null && playingMessageObject.isRoundVideo() && playingMessageObject.eventId != 0) {
            ...
            if (dialogId == (-ubVar.f38017f.f18083id)) {
                MediaController.getInstance().setTextureView(ubVar.Q0(false), ubVar.f38016e0, ubVar.f38015d0, true);
            }
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ub ubVar = this.f34090y0;
        fh.a aVar = ubVar.f38009a.f9064a;
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (childAt != null && childAt.getVisibility() != 8 && childAt != ub.d0(ubVar)) {
                if (childAt != ubVar.v && childAt != ubVar.f38025n) {
                    if (childAt == ubVar.H) {
