...
public final class ib extends rb {
    public final ih.l f37285x0;
    public final ub f37286y0;

    public ib(ub ubVar, Context context) {
        super(ubVar, context);
        this.f37286y0 = ubVar;
        this.f37285x0 = new ih.l();
    }
    ...
    public final void U(Drawable drawable) {
        ...
        ih.l lVar = this.f37285x0;
        gh.a c10 = lVar.c(drawable);
        AndroidUtilities.computePerceivedBrightness(lVar.a(c10));
        ub ubVar = this.f37286y0;
        ubVar.f41016a.f10661a = c10;
        kh.f fVar = ubVar.f41017a0;
        if (fVar != null) {
            fVar.invalidate();
        }
    }
    ...
    public final void onAttachedToWindow() {
        ...
        if (playingMessageObject != null && playingMessageObject.isRoundVideo() && playingMessageObject.eventId != 0) {
            ...
            if (dialogId == (-ubVar.f41040s.f19869id)) {
                MediaController.getInstance().setTextureView(ubVar.Q0(false), ubVar.f41029i0, ubVar.f41028h0, true);
            }
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        gh.a aVar = ubVar.f41016a.f10661a;
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (childAt != null && childAt.getVisibility() != 8) {
                ...
                if (childAt != kVar4) {
                    if (childAt != ubVar.E && childAt != ubVar.f41045w) {
                        if (childAt == ubVar.L) {
                        ...
                        childAt.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(Math.max(AndroidUtilities.dp(10.0f), View.MeasureSpec.getSize(i11)) + (ubVar.f41038r * 2), 1073741824));
                    }
                }
            }
        }
