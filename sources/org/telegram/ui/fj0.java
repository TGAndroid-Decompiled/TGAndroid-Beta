...
public final class fj0 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        switch (this.f33690a) {
            case 0:
                kj0 kj0Var = this.f33691b;
                jj0 jj0Var = kj0Var.f35093q0;
                HashSet hashSet = kj0Var.f35081d0;
                if (hashSet.size() != 0 && jj0Var != null) {
                    ArrayList arrayList = new ArrayList();
                    for (TLRPC.User user : kj0Var.f35086i0.values()) {
                ...
                return;
            default:
                kj0 kj0Var2 = this.f33691b;
                kj0Var2.f35081d0.clear();
                kj0Var2.Y.d.b(true);
