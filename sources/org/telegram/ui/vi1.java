...
public final class vi1 extends org.telegram.ui.ActionBar.j {
    public final WallpapersListActivity f38762a;

    public vi1(WallpapersListActivity wallpapersListActivity) {
        this.f38762a = wallpapersListActivity;
    }
    ...
    public final void b(int i10) {
        ...
        WallpapersListActivity wallpapersListActivity = this.f38762a;
        LongSparseArray longSparseArray = wallpapersListActivity.f31921i0;
        if (i10 == -1) {
            ...
            if (wallpapersListActivity.getParentActivity() != null) {
                ...
                alertDialog$Builder.f18662a.R = LocaleController.formatPluralString("DeleteBackground", longSparseArray.size(), new Object[0]);
                alertDialog$Builder.f18662a.T = LocaleController.formatString("DeleteChatBackgroundsAlert", R.string.DeleteChatBackgroundsAlert, new Object[0]);
