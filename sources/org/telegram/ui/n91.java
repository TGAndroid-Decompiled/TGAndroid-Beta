    ...
    public final void run() {
        ...
        switch (this.f35919a) {
            ...
            case 3:
                ...
                return;
            case 4:
                Utilities.globalQueue.postRunnable(new n91(6));
                return;
            case 5:
                ...
                try {
                    ...
                    if (file.exists()) {
                        ...
                        for (long j3 = 0; j3 < readInt64; j3++) {
                            ...
                            longSparseArray.put(tLObject.f38936a, tLObject);
                        }
                    }
                } catch (Exception e) {
                    FileLog.e(e);
                }
                AndroidUtilities.runOnUIThread(new nb1(23, arrayList, longSparseArray));
                return;
            case 6:
                try {
                    ...
                    long size = org.telegram.ui.web.f1.f38944c.size();
                    SerializedData serializedData2 = new SerializedData(true);
                    serializedData2.writeInt64(size);
                    ArrayList arrayList2 = org.telegram.ui.web.f1.f38944c;
                    ...
                    ArrayList arrayList3 = org.telegram.ui.web.f1.f38944c;
