...
public final class px extends j71 {
    public final a71[] f39649d2;
    public final uy f39650e2;
    ...
    public final boolean F(TL_stars.TL_starGiftUnique tL_starGiftUnique) {
        ...
        if (tL_starGiftUnique != null) {
            i10 = ((org.telegram.ui.ActionBar.n2) this.f39650e2).currentAccount;
    ...
    public final void p(View view, Long l4, TLRPC.Document document, TL_stars.TL_starGiftUnique tL_starGiftUnique, Integer num) {
        ...
        a71[] a71VarArr = this.f39649d2;
        uy uyVar = this.f39650e2;
        if (l4 == null) {
            emojiStatus = new TLRPC.TL_emojiStatusEmpty();
        } else {
            if (tL_starGiftUnique != null) {
                i10 = ((org.telegram.ui.ActionBar.n2) uyVar).currentAccount;
                TL_stars.SavedStarGift n10 = zh.s5.y(i10, false).n(tL_starGiftUnique.f20096id);
                ...
                tL_inputEmojiStatusCollectible.collectible_id = tL_starGiftUnique.f20096id;
