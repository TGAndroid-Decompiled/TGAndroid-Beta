...
public class StakedDiceSheet extends BottomSheetWithRecyclerListView {
        ...
        if (emojiGameInfo instanceof TLRPC.TL_emojiGameDiceInfo) {
            ...
            Utilities.Callback2Return callback2Return = new Utilities.Callback2Return() {
                ...
                public final Object run(Object obj, Object obj2) {
                    return StakedDiceSheet.m4072$r8$lambda$Avzvs7HEBCdkCHlzfUQfHJlva8(context, iArr, resourcesProvider, tableView, (Integer) obj, (Float) obj2);
                }
            };
            ...
            Utilities.CallbackReturn callbackReturn = new Utilities.CallbackReturn() {
                ...
                public final Object run(Object obj) {
                    return StakedDiceSheet.m4073$r8$lambda$U3QzNjIEL4Nod70FOH84Lt4RXk(context, resourcesProvider, editTextBoldCursor, (Long) obj);
                }
            };
    ...
    public static TableView.TableRowContent m4072$r8$lambda$Avzvs7HEBCdkCHlzfUQfHJlva8(Context context, int[] iArr, Theme.ResourcesProvider resourcesProvider, TableView tableView, Integer num, Float f) {
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setOrientation(1);
        LinearLayout linearLayout2 = new LinearLayout(context);
    ...
    public static View m4073$r8$lambda$U3QzNjIEL4Nod70FOH84Lt4RXk(Context context, Theme.ResourcesProvider resourcesProvider, final EditTextBoldCursor editTextBoldCursor, final Long l) {
        TextView textView = new TextView(context);
        textView.setGravity(17);
        textView.setTextSize(1, 13.0f);
