...
public final class uj extends xm {
    ...
    public final ArrayList f38015a3;
    public final ArrayList f38016b3;
    public final ArrayList f38017c3;
    public final ArrayList f38018d3;
    public int f38019e3;
    public int f38020f3;
    public int f38021g3;
    public long f38022h3;
    public float f38023i3;
    public float j3;
    public boolean f38024k3;
    public final float f38025l3;
    public final Paint f38026m3;
    public final Paint f38027n3;
    public final o1.j f38028o3;
    public final o1.k f38029p3;
    public final o1.j f38030q3;
    public final o1.k f38031r3;
    public final o1.j f38032s3;
    public final o1.k f38033t3;
    public boolean f38034u3;
    public final Path f38035v3;
    public boolean f38036w3;
    public int f38037x3;
    public final bo y3;
    ...
    public uj(bo boVar, Context context, zn znVar) {
        ...
        this.f38015a3 = new ArrayList();
        this.f38016b3 = new ArrayList();
        this.f38017c3 = new ArrayList();
        this.f38018d3 = new ArrayList(10);
        this.f38025l3 = 2000.0f;
        Paint paint = new Paint(1);
        this.f38026m3 = paint;
        Paint paint2 = new Paint(1);
        this.f38027n3 = paint2;
        o1.j jVar = new o1.j(0.0f);
        this.f38028o3 = jVar;
        o1.k kVar = new o1.k(jVar);
        kVar.h = 0.0f;
        kVar.f15345g = 2000.0f;
        kVar.f15351u = org.telegram.ui.Cells.p6.l(0.0f, 1500.0f, 1.0f);
        kVar.b(new o1.g(this) {
            public final uj f37402b;
        ...
        kVar2.h = 0.0f;
        kVar2.f15351u = org.telegram.ui.Cells.p6.l(0.0f, 400.0f, 0.5f);
        ...
        kVar3.h = 0.0f;
        kVar3.f15351u = org.telegram.ui.Cells.p6.l(0.0f, 200.0f, 1.0f);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (boVar.N9 != 0.0f) {
            ...
            if (boVar.U9 != 0.0f) {
                f7 = (boVar.f32524x0.getMeasuredHeight() - boVar.N9) * boVar.U9;
            } else {
                f7 = 0.0f;
            }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (this.f38037x3 != measuredHeight) {
            this.f38036w3 = true;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (motionEvent.getAction() == 1 && min == 1.0f && (zpVar = boVar.P9) != null && !zpVar.R) {
                ...
                if (zpVar3 != null && zpVar3.R) {
                    ...
                    if (currentTimeMillis - zpVar4.U < 500 && zpVar4.M) {
                        ...
                        ofFloat4.setInterpolator(org.telegram.ui.Components.qr.f27423f);
        ...
        if (!this.X1) {
            ...
            if (!kVar.s() && !boVar.A9()) {
                y1(motionEvent);
                if (boVar.f32308f9 || onTouchEvent) {
                    return true;
                }
            } else {
                return onTouchEvent;
    ...
    public final void requestLayout() {
        ...
        if (aVar.f10493b != 0) {
            int childCount = aVar.f10492a.getChildCount();
            for (int i10 = 0; i10 < childCount; i10++) {
                aVar.f10492a.getChildAt(i10).forceLayout();
            }
        }
        super.requestLayout();
    }
    ...
    public final void x1(Canvas canvas, RectF rectF) {
        ...
        ArrayList arrayList3 = this.f38015a3;
        ...
        ArrayList arrayList4 = this.f38016b3;
        ...
        if (size3 > 0) {
            ...
            while (i12 < size3) {
                ...
                if (bo.d2(boVar, t1Var3, rectF)) {
                    ...
                    if (t1Var3.getTransitionParams().f20917v0) {
        ...
        ArrayList arrayList5 = this.f38017c3;
        ...
        if (size4 > 0) {
            for (int i13 = 0; i13 < size4; i13++) {
                ...
                if (!bo.d2(boVar, t1Var4, rectF)) {
                    ...
                    if (!z10 && t1Var4.getTransitionParams().f20917v0) {
    ...
    public final void y1(MotionEvent motionEvent) {
        ...
        if (motionEvent != null && motionEvent.getAction() == 0 && !boVar.f32308f9 && !boVar.f32296e9 && boVar.f32284d9 == null) {
            ...
            if (!z10) {
                ...
                if (pressedChildView instanceof org.telegram.ui.Cells.t1) {
                    ...
                    boVar.f32284d9 = (org.telegram.ui.Cells.t1) pressedChildView;
                    MessageObject T1 = bo.T1(boVar);
                    boolean F6 = boVar.F6(T1);
                    int i10 = boVar.R3;
                    if ((i10 == 0 || i10 == 5 || i10 == 8 || (i10 == 3 && boVar.f32279d4 == boVar.getUserConfig().getClientUserId())) && (((arrayList = boVar.f32239a4) == null || !arrayList.contains(T1)) && ((boVar.E8(T1) != 1 || (T1.getDialogId() != boVar.L6 && !T1.needDrawBluredPreview())) && ((boVar.h != null || T1.getId() >= 0) && (((chat2 = boVar.e) == null || !ChatObject.isForum(chat2) || F6) && !boVar.b9() && (!T1.isEphemeral() || !T1.isOut())))))) {
                        this.f38021g3 = motionEvent.getPointerId(0);
                        boVar.f32296e9 = true;
                        this.f38019e3 = (int) motionEvent.getX();
                        this.f38020f3 = (int) motionEvent.getY();
                        return;
                    }
                    bo.V1(boVar, 0.0f);
                    boVar.f32284d9 = null;
        ...
        if (boVar.f32284d9 != null && motionEvent != null && motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.f38021g3) {
            int max = Math.max(AndroidUtilities.dp(-80.0f), Math.min(0, (int) (motionEvent.getX() - this.f38019e3)));
            int abs = Math.abs(((int) motionEvent.getY()) - this.f38020f3);
            if (getScrollState() == 0 && boVar.f32296e9 && !boVar.f32308f9 && max <= (-AndroidUtilities.getPixelsInCM(0.4f, true)) && Math.abs(max) / 3 > abs) {
                MotionEvent obtain = MotionEvent.obtain(0L, 0L, 3, 0.0f, 0.0f, 0);
                boVar.f32284d9.onTouchEvent(obtain);
        ...
        } else if (boVar.f32284d9 != null) {
            if (motionEvent != null) {
                if (motionEvent.getPointerId(0) == this.f38021g3) {
            ...
            if (motionEvent != null && motionEvent.getAction() != 3) {
                org.telegram.ui.Cells.t1 t1Var2 = boVar.f32284d9;
            ...
            org.telegram.ui.Cells.t1 t1Var3 = boVar.f32284d9;
            ...
            this.f38022h3 = System.currentTimeMillis();
            this.f38023i3 = 0.0f;
            invalidate();
            boVar.f32296e9 = false;
