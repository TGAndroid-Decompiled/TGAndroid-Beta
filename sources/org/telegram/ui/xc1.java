...
public final class xc1 implements org.telegram.ui.ActionBar.f6 {
    public org.telegram.ui.ActionBar.f6 f39522a;
    public final SparseIntArray f39523b = new SparseIntArray();
    public final Paint f39524c = new Paint(3);
    public final Paint d = new Paint(3);
    public final Paint e;
    public final TextPaint f39525f;
    public final TextPaint h;
    public final TextPaint f39526n;
    public Bitmap f39527r;
    public BitmapShader f39528s;
    public Matrix v;
    public final xd1 f39529w;
    public final xd1 f39530x;
    ...
    public xc1(xd1 xd1Var) {
        ...
        this.f39525f = textPaint;
        TextPaint textPaint2 = new TextPaint();
        this.h = textPaint2;
        TextPaint textPaint3 = new TextPaint();
        this.f39526n = textPaint3;
    ...
    public final Paint G(String str) {
        ...
        switch (c10) {
            ...
            case 5:
                return this.f39525f;
            default:
                org.telegram.ui.ActionBar.f6 f6Var = this.f39522a;
                if (f6Var != null) {
                    return f6Var.G(str);
                }
    ...
    public final boolean a() {
        od1 od1Var = this.f39530x.f39579p1;
        if (od1Var != null) {
            return od1Var.a();
        }
        od1 od1Var2 = this.f39529w.f39579p1;
        if (od1Var2 != null) {
            return od1Var2.a();
        }
        org.telegram.ui.ActionBar.f6 f6Var = this.f39522a;
    ...
    public final void b(Drawable drawable, Drawable drawable2, Float f7) {
        ...
        float f12;
        float f13;
        int i10 = org.telegram.ui.ActionBar.j6.f19015lc;
        int G0 = G0(i10);
        int G02 = G0(org.telegram.ui.ActionBar.j6.f19034mc);
        if (drawable == null) {
            drawable = drawable2;
        }
        boolean z10 = drawable instanceof org.telegram.ui.Components.cc0;
        TextPaint textPaint = this.h;
        TextPaint textPaint2 = this.f39525f;
        if ((z10 || (drawable instanceof BitmapDrawable)) && SharedConfig.getDevicePerformanceClass() != 0 && LiteMode.isEnabled(32)) {
            if (z10) {
                bitmap = ((org.telegram.ui.Components.cc0) drawable).f23009k;
            } else if (drawable instanceof BitmapDrawable) {
                bitmap = ((BitmapDrawable) drawable).getBitmap();
            } else {
                bitmap = null;
            }
            if (this.f39527r != bitmap) {
                this.f39527r = bitmap;
                Bitmap bitmap2 = this.f39527r;
                Shader.TileMode tileMode = Shader.TileMode.CLAMP;
                this.f39528s = new BitmapShader(bitmap2, tileMode, tileMode);
                if (this.v == null) {
                    this.v = new Matrix();
                }
            }
            ...
            textPaint2.linkColor = G0(org.telegram.ui.ActionBar.j6.f18977jc);
        }
        Paint paint = this.f39524c;
        paint.setColor(G0);
        Paint paint2 = this.d;
        paint2.setColor(G02);
        if (this.f39528s != null && (this.f39523b.indexOfKey(i10) < 0 || z10 || (drawable instanceof BitmapDrawable))) {
            ColorMatrix colorMatrix = new ColorMatrix();
            if (z10) {
                float f14 = -0.06f;
                if (((org.telegram.ui.Components.cc0) drawable).f23015q >= 0.0f) {
            ...
            if (z10) {
                float f15 = ((org.telegram.ui.Components.cc0) drawable).f23015q;
                if (f7 != null) {
                    f15 = f7.floatValue();
                }
                if (f15 >= 0.0f) {
            ...
            paint.setShader(this.f39528s);
            paint.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
            paint.setAlpha(255);
            paint2.setShader(this.f39528s);
    ...
    public final void m(float f7, float f10, int i10, int i11) {
        ...
        Bitmap bitmap = this.f39527r;
        if (bitmap != null && (bitmapShader = this.f39528s) != null) {
