...
public final class zg implements MessagesStorage.IntCallback {
    ...
    public final void run(int i10) {
        switch (this.f40468a) {
            case 0:
                wn wnVar = this.f40469b;
                if (wnVar.getParentActivity() != null && wnVar.fragmentView != null && i10 > 0) {
                    org.telegram.ui.Components.xc.a0(wnVar).m(org.telegram.ui.Components.wc.f29960r, i10, 0, 0, wnVar.f39469ea).j();
                    return;
                }
                return;
            case 1:
                wn wnVar2 = this.f40469b;
                if (i10 == 0) {
                    wnVar2.f39561m6 = false;
                    wnVar2.H9();
                    return;
                }
