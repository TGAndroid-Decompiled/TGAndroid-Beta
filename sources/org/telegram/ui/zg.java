...
public final class zg implements aw0, qy {
    public final boolean f39310a;
    public final int f39311b;
    public final Object f39312c;
    public final Object d;

    public zg(eo eoVar, boolean z10, MessageObject messageObject, int i10) {
        this.f39312c = eoVar;
        this.f39310a = z10;
    ...
    public boolean v(wy wyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, ig1 ig1Var) {
        LaunchActivity launchActivity = (LaunchActivity) this.f39312c;
        String str = (String) this.d;
        Pattern pattern = LaunchActivity.B1;
        long j3 = ((MessagesStorage.TopicKey) arrayList.get(0)).dialogId;
        Bundle bundle = new Bundle();
        bundle.putBoolean("scrollToTopOnResume", true);
        bundle.putBoolean("hasUrl", this.f39310a);
    ...
    public zg(LaunchActivity launchActivity, boolean z10, int i10, String str) {
        this.f39312c = launchActivity;
        this.f39310a = z10;
        this.f39311b = i10;
        this.d = str;
    }
