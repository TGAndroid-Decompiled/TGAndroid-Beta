    ...
    public final void run() {
        ...
        switch (i10) {
            ...
            case 10:
                ...
                return;
            case 11:
                ArrayList arrayList3 = wnVar.f39661u6;
            ...
            case 20:
                ...
                return;
            case 21:
                nk nkVar = wnVar.f39651t8;
                if (nkVar != null && nkVar.getParent() != null) {
                    wnVar.f39694x0.f1();
                    wnVar.f39676v8.setDrawingReady(false);
                    wnVar.f39651t8.setTag(null);
            ...
            case 22:
                ...
                if (i60Var != null) {
                    org.telegram.ui.Components.f60 cameraContainer = i60Var.getCameraContainer();
                    ...
                    animatorSet.playTogether(ofFloat, ofFloat2, ObjectAnimator.ofFloat(cameraContainer, property, 0.0f), ObjectAnimator.ofFloat(wnVar.f39423b3.getButtonsLayout(), property, 0.0f), ObjectAnimator.ofInt(wnVar.f39423b3.getPaint(), org.telegram.ui.Components.s6.f28171b, 0), ObjectAnimator.ofFloat(wnVar.f39423b3.getMuteImageView(), property, 0.0f));
            ...
            case 25:
                if (wnVar.getParentActivity() != null && wnVar.fragmentView != null && (jkVar = wnVar.Y) != null && (sendButton = jkVar.getSendButton()) != null && wnVar.Y.getEditField() != null && wnVar.Y.getEditField().getText().length() >= 5) {
                    ...
                    if (wnVar.f39485g2 == null) {
                        fj fjVar = new fj(4, 0, wnVar.getParentActivity(), wnVar.f39468ea, false);
                        wnVar.f39485g2 = fjVar;
                        fjVar.a();
                        wnVar.f39485g2.setAlpha(0.0f);
                        wnVar.f39485g2.setVisibility(4);
                        wnVar.f39485g2.setText(LocaleController.getString(R.string.ScheduledOrNoSoundHint));
                        wnVar.X0.addView(wnVar.f39485g2, w7.y5.d(-2, -2.0f, 51, 10.0f, 0.0f, 10.0f, 0.0f));
                    }
                    wnVar.f39485g2.f(sendButton, true);
                    wnVar.f39496h2 = true;
                    return;
                }
                return;
