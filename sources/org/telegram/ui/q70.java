...
public final class q70 extends LinearLayout {
    public final org.telegram.ui.Components.bu f36807a;
    public boolean f36808b;
    public int f36809c;
    public yt d;
    public String e;
    public final p70 f36810f;
    public final t70 h;

    public q70(t70 t70Var, Context context) {
        super(context);
        this.h = t70Var;
        this.f36810f = new p70(this);
        TextView f7 = org.telegram.messenger.l0.f(context, 1, 16.0f);
        f7.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19216j5, false));
        ...
        buVar.setLinkTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19186hc, false));
        buVar.setHighlightColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19431uf, false));
        ...
        buVar.setHandlesColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19448vf, false));
    ...
    public final void onDraw(Canvas canvas) {
        if (this.f36808b) {
            canvas.drawLine(AndroidUtilities.dp(20.0f), getHeight() - 1, getWidth() - getPaddingRight(), getHeight() - 1, org.telegram.ui.ActionBar.j6.f19231k0);
        }
    }
}
