...
public final class q70 extends LinearLayout {
    public final org.telegram.ui.Components.bu f36779a;
    public boolean f36780b;
    public int f36781c;
    public kw d;
    public String e;
    public final p70 f36782f;
    public final t70 h;

    public q70(t70 t70Var, Context context) {
        super(context);
        this.h = t70Var;
        this.f36782f = new p70(this);
        TextView g10 = org.telegram.messenger.y0.g(context, 1, 16.0f);
        g10.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18940j5, false));
        ...
        buVar.setLinkTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18910hc, false));
        buVar.setHighlightColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19154uf, false));
        ...
        buVar.setHandlesColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19171vf, false));
    ...
    public final void onDraw(Canvas canvas) {
        if (this.f36780b) {
            canvas.drawLine(AndroidUtilities.dp(20.0f), getHeight() - 1, getWidth() - getPaddingRight(), getHeight() - 1, org.telegram.ui.ActionBar.i6.f18955k0);
        }
    }
}
