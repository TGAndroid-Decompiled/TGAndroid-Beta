...
public final class ki1 implements org.telegram.ui.Components.voip.d {
    ...
    public final void a() {
        mi1 mi1Var = this.f34735a;
        if (mi1Var.f35332p0 == 17) {
        ...
        } else if (Build.VERSION.SDK_INT >= 23 && mi1Var.f35304b.checkSelfPermission("android.permission.RECORD_AUDIO") != 0) {
            mi1Var.f35304b.requestPermissions(new String[]{"android.permission.RECORD_AUDIO"}, 101);
