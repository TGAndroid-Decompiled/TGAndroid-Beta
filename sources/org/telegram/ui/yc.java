...
public final class yc extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.e6 f39805b;
    public final ArrayList f39806c;
    public final ec1 d;
    public final org.telegram.ui.Components.t00 e;
    public boolean f39807f;
    public final wc h;
    public boolean f39808n;
    public Utilities.Callback f39809r;
    public String f39810s;
    public TLRPC.WallPaper v;
    public final HashMap f39811w;
    public final HashMap f39812x;

    public yc(int i10, Activity activity, org.telegram.ui.ActionBar.e6 e6Var) {
        super(activity);
        this.f39806c = new ArrayList();
        this.f39811w = new HashMap();
        this.f39812x = new HashMap();
        this.f39804a = i10;
        this.f39805b = e6Var;
    ...
    public final void a(String str, boolean z10) {
        ...
        int i11 = 0;
        while (true) {
            arrayList = this.f39806c;
            boolean z11 = true;
            if (i11 >= arrayList.size()) {
                break;
            }
            org.telegram.ui.Components.lp lpVar = (org.telegram.ui.Components.lp) arrayList.get(i11);
            if (!TextUtils.equals(this.f39810s, lpVar.a()) && (!TextUtils.isEmpty(str) || !lpVar.f25997a.f18587a)) {
                z11 = false;
            }
            lpVar.d = z11;
            if (z11) {
    ...
    public void setGalleryWallpaper(TLRPC.WallPaper wallPaper) {
        ...
        if (this.v != null) {
            ArrayList arrayList = this.f39806c;
            if ((arrayList.isEmpty() || ((org.telegram.ui.Components.lp) arrayList.get(0)).f25997a.f18587a) && this.f39807f) {
                arrayList.add(0, new org.telegram.ui.Components.lp(org.telegram.ui.ActionBar.d4.a(this.f39804a)));
                this.h.l();
            }
        }
    }
