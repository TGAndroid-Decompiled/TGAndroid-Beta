...
public final class gg0 implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f36668a) {
            case 0:
                kg0 kg0Var = this.f36669b;
                kg0Var.getClass();
                float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                kg0Var.d.setAlpha(floatValue);
                kg0Var.f38056e.setAlpha(floatValue);
                kg0Var.f38057f.setProgress(floatValue);
                FrameLayout frameLayout = kg0Var.f38061w;
                ...
                return;
            default:
                kg0 kg0Var2 = this.f36669b;
                kg0Var2.getClass();
                float floatValue2 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                kg0Var2.f38057f.setProgress(floatValue2);
                kg0Var2.d.setAlpha(floatValue2);
                kg0Var2.f38056e.setAlpha(floatValue2);
                FrameLayout frameLayout2 = kg0Var2.f38061w;
