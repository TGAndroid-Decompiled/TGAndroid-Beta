...
public final class zd0 implements RequestDelegate {
    ...
    public final ie0 f40224b;
    public final Bundle f40225c;
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f40223a) {
            case 0:
                final ie0 ie0Var = this.f40224b;
                final Bundle bundle = this.f40225c;
                            ...
                            default:
                                ...
                                if (tLObject2 instanceof TLRPC.TL_auth_sentCode) {
                                    ...
                                    if (auth_sentcodetype instanceof TLRPC.TL_auth_sentCodeTypeEmailCode) {
                                        auth_sentcodetype.email_pattern = ie0Var2.f34555y.getString("emailPattern");
                                        ie0Var2.f34554x = true;
                                    }
                ...
                return;
            default:
                final ie0 ie0Var2 = this.f40224b;
                final Bundle bundle2 = this.f40225c;
                        ...
                        switch (i12) {
                            ...
                            default:
                                ...
                                if (tLObject2 instanceof TLRPC.TL_auth_sentCode) {
                                    ...
                                    TLRPC.auth_SentCodeType auth_sentcodetype = tL_auth_sentCode.type;
                                    if (auth_sentcodetype instanceof TLRPC.TL_auth_sentCodeTypeEmailCode) {
                                        auth_sentcodetype.email_pattern = ie0Var22.f34555y.getString("emailPattern");
                                        ie0Var22.f34554x = true;
                                    }
