                                ...
                                if (yg0Var.getParentActivity() != null) {
                                    ...
                                    if (tLObject2 instanceof TLRPC.TL_auth_sentCode) {
                                        ...
                                        if (str.contains("TASK_ALREADY_EXISTS")) {
                                            ...
                                            gf.b c10 = gf.b.c();
                                            b2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString(i13, LocaleController.addNbsp(c10.b("+" + ie0Var2.L))));
                                            ...
                                            org.telegram.ui.Components.d5.f0(i10, tL_error2, yg0Var, tL_auth_resetLoginEmail2, new Object[0]);
                                            return;
                                        } else {
                            ...
                            default:
                                ...
                                if (tLObject2 instanceof TLRPC.TL_auth_sentCode) {
                                    ...
                                    if (!str2.contains("PHONE_CODE_EXPIRED")) {
                                        ...
                                        org.telegram.ui.Components.d5.f0(i11, tL_error2, yg0Var2, tL_auth_resetLoginEmail2, new Object[0]);
                                        return;
                                    }
                        ...
                        switch (i12) {
                                ...
                                if (yg0Var.getParentActivity() != null) {
                                    ...
                                    if (tLObject2 instanceof TLRPC.TL_auth_sentCode) {
                                        ...
                                        if (str.contains("TASK_ALREADY_EXISTS")) {
                                            ...
                                            int i13 = R.string.LoginEmailResetPremiumRequiredMessage;
                                            gf.b c10 = gf.b.c();
                                            b2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString(i13, LocaleController.addNbsp(c10.b("+" + ie0Var22.L))));
                                            org.telegram.messenger.l0.n(R.string.OK, alertDialog$Builder, null);
                                            return;
                                        } else if (!tL_error2.text.contains("PHONE_CODE_EXPIRED")) {
                                            i10 = ((org.telegram.ui.ActionBar.n2) yg0Var).currentAccount;
                                            org.telegram.ui.Components.d5.f0(i10, tL_error2, yg0Var, tL_auth_resetLoginEmail22, new Object[0]);
                                            return;
                                        } else {
                                            yg0Var.u1(0, true, null, true);
                                            yg0Var.l1(LocaleController.getString(R.string.RestorePasswordNoEmailTitle), LocaleController.getString("CodeExpired", R.string.CodeExpired));
                            ...
                            default:
                                ...
                                if (tLObject2 instanceof TLRPC.TL_auth_sentCode) {
                                    ...
                                    if (!str2.contains("PHONE_CODE_EXPIRED")) {
                                        i11 = ((org.telegram.ui.ActionBar.n2) yg0Var2).currentAccount;
                                        org.telegram.ui.Components.d5.f0(i11, tL_error2, yg0Var2, tL_auth_resetLoginEmail22, new Object[0]);
                                        return;
                                    }
                                    yg0Var2.u1(0, true, null, true);
                                    yg0Var2.l1(LocaleController.getString(R.string.RestorePasswordNoEmailTitle), LocaleController.getString("CodeExpired", R.string.CodeExpired));
