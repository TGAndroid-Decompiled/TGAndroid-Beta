    ...
    public final void run() {
        switch (this.f40155a) {
            ...
            case 1:
                ...
                return;
            case 2:
                de0 de0Var = this.f40156b.f33827a;
                int i10 = 0;
                de0Var.e = false;
            ...
            case 3:
                ge0 ge0Var2 = this.f40156b;
                ge0Var2.postDelayed(new zd0(ge0Var2, 5), 150L);
                return;
            case 4:
                ge0 ge0Var3 = this.f40156b;
                fe0 fe0Var = ge0Var3.Q;
                boolean z10 = false;
                ge0Var3.R = false;
                int i11 = 0;
                while (true) {
                    gs[] gsVarArr2 = ge0Var3.f33827a.f33081f;
                    if (i11 < gsVarArr2.length) {
                        ...
                        if (ge0Var3.f33830f.getVisibility() != 0 && ge0Var3.W.F != 3 && !ge0Var3.P) {
                            z10 = true;
                        }
                ...
                break;
            case 5:
                de0 de0Var2 = this.f40156b.f33827a;
                int i12 = 0;
                de0Var2.e = false;
                de0Var2.f33081f[0].requestFocus();
                while (true) {
                    gs[] gsVarArr3 = de0Var2.f33081f;
            ...
            case 7:
                ...
                return;
            default:
                ge0 ge0Var4 = this.f40156b;
                org.telegram.ui.Components.aj0 aj0Var = ge0Var4.f33834w;
                aj0Var.getAnimatedDrawable().N(0, false, false);
                aj0Var.d();
                de0 de0Var3 = ge0Var4.f33827a;
                if (de0Var3 != null && de0Var3.f33081f != null) {
                    de0Var3.setText("");
                    de0Var3.f33081f[0].requestFocus();
                    return;
                }
                return;
        }
