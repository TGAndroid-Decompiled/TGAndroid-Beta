    ...
    public final void run() {
        switch (this.f43381a) {
            ...
            case 1:
                ...
                return;
            case 2:
                de0 de0Var = this.f43382b.f36643a;
                int i10 = 0;
            ...
            case 3:
                ge0 ge0Var2 = this.f43382b;
                ge0Var2.postDelayed(new zd0(ge0Var2, 5), 150L);
                return;
            case 4:
                ge0 ge0Var3 = this.f43382b;
                fe0 fe0Var = ge0Var3.Q;
                boolean z10 = false;
                ge0Var3.R = false;
                int i11 = 0;
                while (true) {
                    gs[] gsVarArr2 = ge0Var3.f36643a.f36164f;
                    if (i11 < gsVarArr2.length) {
                        gsVarArr2[i11].i(0.0f);
                        i11++;
                    } else if (fe0Var.getCurrentView() != ge0Var3.f36646e) {
                        fe0Var.showNext();
                        FrameLayout frameLayout = ge0Var3.h;
                        if (ge0Var3.f36647f.getVisibility() != 0 && ge0Var3.W.F != 3 && !ge0Var3.P) {
                            z10 = true;
                        }
                ...
                break;
            case 5:
                de0 de0Var2 = this.f43382b.f36643a;
                int i12 = 0;
                de0Var2.f36163e = false;
                de0Var2.f36164f[0].requestFocus();
                while (true) {
                    gs[] gsVarArr3 = de0Var2.f36164f;
            ...
            case 7:
                ...
                return;
            default:
                ge0 ge0Var4 = this.f43382b;
                org.telegram.ui.Components.aj0 aj0Var = ge0Var4.f36651w;
                aj0Var.getAnimatedDrawable().L(0, false, false);
                aj0Var.d();
                de0 de0Var3 = ge0Var4.f36643a;
                if (de0Var3 != null && de0Var3.f36164f != null) {
                    de0Var3.setText("");
                    de0Var3.f36164f[0].requestFocus();
                    return;
                }
                return;
        }
