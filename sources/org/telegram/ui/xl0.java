...
public final class xl0 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        super.onDraw(canvas);
        if (this.f39621n) {
            Paint T0 = org.telegram.ui.ActionBar.j6.T0("paintDivider", this.f39618b);
            if (T0 == null) {
