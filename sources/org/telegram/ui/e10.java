...
public final class e10 extends og.b {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (y00Var != null) {
            int i14 = i10 + 1;
            boolean z11 = false;
            if (i14 < arrayList.size() && (i13 = ((y00) arrayList.get(i14)).f15543a) != 3 && i13 != 6) {
                z10 = true;
            } else {
                z10 = false;
            }
            ...
            if (i15 != 0) {
                if (i15 != 1) {
                    ...
                    if (i15 != 4) {
                        switch (i15) {
                            case 6:
                                ...
                                return;
                            case 7:
                                ((a10) view).e(y00Var.f39749m, z10);
                                return;
                            case 8:
                                o00 o00Var = (o00) view;
                                if (o00Var.f36191c != z10) {
                                    o00Var.f36191c = z10;
                            ...
                            case 9:
                                v00 v00Var = (v00) view;
                                h10Var.I = v00Var;
                                v00Var.e(org.telegram.ui.Components.x5.cloneSpans(h10Var.f34093w, -1, v00Var.f38252s.getPaint().getFontMetricsInt(), 0.5f), false);
                            ...
                            case 11:
                                ...
                                t3Var.setOnClickListener(y00Var.f39742c);
                                return;
                            default:
                                return;
                        }
                    ...
                    m00 m00Var = (m00) view;
                    boolean z12 = y00Var.f39748l;
                    ImageView imageView = m00Var.f35657a;
                    TextView textView = m00Var.f35658b;
                    if (z12) {
                        i11 = org.telegram.ui.ActionBar.j6.f19100q7;
                    } else {
                        i11 = org.telegram.ui.ActionBar.j6.f19064o6;
                    }
                    ...
                    int i17 = y00Var.f39747k;
                    CharSequence charSequence = y00Var.d;
                    ImageView imageView2 = m00Var.f35657a;
                ...
                String str = y00Var.f39745i;
                if (str != null) {
                    abVar.d(str, y00Var.d, null, z10);
                    return;
                }
                long j3 = y00Var.h;
                if (j3 > 0) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                h10Var.K = f3Var;
                f3Var.f20077n = false;
                org.telegram.ui.Cells.d3 d3Var = f3Var.f20074b;
                ...
                d3Var.setText(h10Var.f34093w);
                i11 = ((org.telegram.ui.ActionBar.o2) h10Var).currentAccount;
                org.telegram.ui.Components.o5.s(i11, h10Var.f34094x);
            ...
            case 5:
                ...
                frameLayout2.f39336a = imageView2;
            ...
            default:
                ...
                break;
            case 7:
                i14 = ((org.telegram.ui.ActionBar.o2) h10Var).currentAccount;
                abVar = new d10(this, this.d, h10Var, i14, h10Var.f34091r.f15613id);
                break;
            case 8:
                abVar = new o00(context);
                break;
            case 9:
                abVar = new v00(h10Var, context);
                break;
            case 10:
                Activity parentActivity = h10Var.getParentActivity();
                i15 = ((org.telegram.ui.ActionBar.o2) h10Var).currentAccount;
    ...
    public final void y(s4.c1 c1Var) {
        ...
        if (i10 != 2 && i10 == 9) {
            h10 h10Var = this.e;
            ((v00) c1Var.f42697a).e(org.telegram.ui.Components.x5.cloneSpans(h10Var.f34093w, -1, h10Var.I.f38252s.getPaint().getFontMetricsInt(), 0.5f), true);
        }
    }
    ...
    public final void z(s4.c1 c1Var) {
        if (c1Var.f42700f == 2) {
            org.telegram.ui.Cells.f3 f3Var = (org.telegram.ui.Cells.f3) c1Var.f42697a;
            f3Var.f20074b.k(true);
            f3Var.f20074b.d();
        }
    }
}
