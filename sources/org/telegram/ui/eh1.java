...
public final class eh1 implements Utilities.Callback {
    ...
    public final UserInfoActivity f33413b;

    public eh1(UserInfoActivity userInfoActivity, int i10) {
        this.f33412a = i10;
        this.f33413b = userInfoActivity;
    }
    ...
    public final void run(Object obj) {
        switch (this.f33412a) {
            case 0:
                UserInfoActivity userInfoActivity = this.f33413b;
                userInfoActivity.J = (TL_account.TL_birthday) obj;
                org.telegram.ui.Components.l61 l61Var = userInfoActivity.f31892x;
                if (l61Var != null) {
                    l61Var.Y2.N(true);
                }
            ...
            default:
                ...
                UserInfoActivity userInfoActivity2 = this.f33413b;
                if (userInfoActivity2.K != chat) {
                    ...
                    org.telegram.ui.Components.l61 l61Var2 = userInfoActivity2.f31892x;
                    if (l61Var2 != null) {
                        l61Var2.Y2.N(true);
                        return;
                    }
