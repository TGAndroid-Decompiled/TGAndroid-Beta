    ...
    public final boolean onPreDraw() {
        ...
        switch (i10) {
            case 0:
                ...
                org.telegram.ui.Components.hk0 cameraRect = coVar.f35202b3.getCameraRect();
                float f10 = imageWidth / cameraRect.f26746c;
                t1Var.getTransitionParams().f22807x0 = true;
                t1Var.setAlpha(0.0f);
                ...
                org.telegram.ui.Components.p50 cameraContainer = coVar.f35202b3.getCameraContainer();
                ...
                ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(cameraContainer, View.TRANSLATION_Y, iArr[1] - cameraRect.f26745b);
                View buttonsLayout = coVar.f35202b3.getButtonsLayout();
                Property property = View.ALPHA;
                animatorSet.playTogether(ofFloat, ofFloat2, ofFloat3, ObjectAnimator.ofFloat(buttonsLayout, property, 0.0f), ObjectAnimator.ofInt(coVar.f35202b3.getPaint(), org.telegram.ui.Components.t6.f30537b, 0), ObjectAnimator.ofFloat(coVar.f35202b3.getMuteImageView(), property, 0.0f));
                animatorSet.setInterpolator(org.telegram.ui.Components.pr.h);
                ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(cameraContainer, View.TRANSLATION_X, iArr[0] - cameraRect.f26744a);
                ...
                return true;
            case 1:
                ((zx) obj).f43571b.f41260e0[0].f40859a.getViewTreeObserver().removeOnPreDrawListener(this);
            ...
            default:
                ...
                if (ybVar != null) {
                    ...
                    hVar.f47883a.getLocationInWindow(iArr2);
                    hVar.X = (hVar.W.f32876a.getMeasuredWidth() / 2.0f) + (f11 - iArr2[0]) + hVar.W.f32876a.getLeft();
                    hVar.Y = (hVar.W.f32876a.getMeasuredHeight() / 2.0f) + ((translationY + f7) - iArr2[1]) + hVar.W.f32876a.getTop();
                }
                hVar.c();
                return true;
        }
