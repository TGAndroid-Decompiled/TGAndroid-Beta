...
public final class im implements ViewTreeObserver.OnPreDrawListener {
    ...
    public final boolean onPreDraw() {
        ...
        Object obj = this.f37432c;
        Object obj2 = this.f37431b;
        switch (i10) {
            case 0:
                co coVar = ((om) obj).Q;
                ...
                org.telegram.ui.Components.hk0 cameraRect = coVar.f35229b3.getCameraRect();
                float f10 = imageWidth / cameraRect.f26773c;
                t1Var.getTransitionParams().f22834x0 = true;
                t1Var.setAlpha(0.0f);
                ...
                org.telegram.ui.Components.p50 cameraContainer = coVar.f35229b3.getCameraContainer();
                ...
                ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(cameraContainer, View.TRANSLATION_Y, iArr[1] - cameraRect.f26772b);
                View buttonsLayout = coVar.f35229b3.getButtonsLayout();
                Property property = View.ALPHA;
                animatorSet.playTogether(ofFloat, ofFloat2, ofFloat3, ObjectAnimator.ofFloat(buttonsLayout, property, 0.0f), ObjectAnimator.ofInt(coVar.f35229b3.getPaint(), org.telegram.ui.Components.t6.f30564b, 0), ObjectAnimator.ofFloat(coVar.f35229b3.getMuteImageView(), property, 0.0f));
                animatorSet.setInterpolator(org.telegram.ui.Components.pr.h);
                ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(cameraContainer, View.TRANSLATION_X, iArr[0] - cameraRect.f26771a);
                ...
                return true;
            case 1:
                ((zx) obj).f43598b.f41287e0[0].f40886a.getViewTreeObserver().removeOnPreDrawListener(this);
            ...
            default:
                ...
                if (ybVar != null) {
                    ...
                    hVar.f47911a.getLocationInWindow(iArr2);
                    hVar.X = (hVar.W.f32903a.getMeasuredWidth() / 2.0f) + (f11 - iArr2[0]) + hVar.W.f32903a.getLeft();
                    hVar.Y = (hVar.W.f32903a.getMeasuredHeight() / 2.0f) + ((translationY + f7) - iArr2[1]) + hVar.W.f32903a.getTop();
                }
                hVar.c();
                return true;
        }
