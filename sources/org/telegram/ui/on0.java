...
public final class on0 extends FrameLayout implements DownloadController.FileDownloadProgressListener {
    ...
    public final TextView f36392b;
    public final org.telegram.ui.Components.u9 f36393c;
    public final org.telegram.ui.Components.cj0 d;
    public int e;
    public SecureDocument f36394f;
    public final int h;
    public final qn0 f36395n;
    ...
    public final void a(boolean z10) {
        ...
        int i12;
        int i13;
        String attachFileName = FileLoader.getAttachFileName(this.f36394f);
        boolean exists = FileLoader.getInstance(UserConfig.selectedAccount).getPathToAttach(this.f36394f).exists();
        ...
        SecureDocument secureDocument = this.f36394f;
        String str = secureDocument.path;
        float f7 = 0.0f;
        qn0 qn0Var = this.f36395n;
        if (str != null) {
            ...
            DownloadController.getInstance(i12).addLoadingFileObserver(this.f36394f.path, this);
            this.e = 1;
            Float fileProgress = ImageLoader.getInstance().getFileProgress(this.f36394f.path);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        org.telegram.ui.Components.u9 u9Var = this.f36393c;
    ...
    public void setValue(CharSequence charSequence) {
        this.f36392b.setText(charSequence);
    }
}
