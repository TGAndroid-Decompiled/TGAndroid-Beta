...
public final class on0 implements TextWatcher {
    ...
    public final void afterTextChanged(Editable editable) {
        ...
        int currencyExpDivider = LocaleController.getCurrencyExpDivider(lo0Var.f38745z0.invoice.currency);
        if (a2 >= 0) {
        ...
        lo0Var.E0 = valueOf;
        if (lo0Var.f38745z0.invoice.max_tip_amount != 0) {
            long longValue3 = valueOf.longValue();
            long j11 = lo0Var.f38745z0.invoice.max_tip_amount;
            if (longValue3 > j11) {
                lo0Var.E0 = Long.valueOf(j11);
            }
        }
        int selectionStart = lo0Var.f38719f[0].getSelectionStart();
        ...
        if (lo0Var.E0.longValue() == 0) {
            ...
            str4 = LocaleController.getInstance().formatCurrencyString(lo0Var.E0.longValue(), false, z4, true, lo0Var.f38745z0.invoice.currency);
            editTextBoldCursor.setText(str4);
        }
        if (j10 < lo0Var.E0.longValue() && j10 != 0 && this.f39765a && selectionStart >= 0) {
            EditTextBoldCursor editTextBoldCursor2 = lo0Var.f38719f[0];
            editTextBoldCursor2.setSelection(Math.min(selectionStart, editTextBoldCursor2.length()));
        } else if (this.f39767c && this.d != lo0Var.f38719f[0].length()) {
            EditTextBoldCursor editTextBoldCursor3 = lo0Var.f38719f[0];
            editTextBoldCursor3.setSelection(Math.max(0, Math.min(selectionStart, editTextBoldCursor3.length())));
        } else if (!this.f39769f && z4 && a2 >= 0) {
            int a10 = a(str4);
            if (a10 > 0) {
                lo0Var.f38719f[0].setSelection(a10 + 1);
            } else {
                EditTextBoldCursor editTextBoldCursor4 = lo0Var.f38719f[0];
                editTextBoldCursor4.setSelection(editTextBoldCursor4.length());
            }
        } else {
            EditTextBoldCursor editTextBoldCursor5 = lo0Var.f38719f[0];
    ...
    public final void beforeTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
        ...
        boolean z4;
        String str;
        if (!this.f39770n.f38724j0) {
            this.f39765a = !TextUtils.isEmpty(charSequence);
            this.f39766b = null;
            ...
            if (z4) {
                ...
                if ((charAt >= '0' && charAt <= '9') || (str.length() != 0 && longValue == 0)) {
                    if (a2 > 0 && i10 > a2 && longValue == 0) {
                        this.f39766b = fixNumbers.substring(0, a2 - 1);
                        return;
                    }
                    return;
                }
                while (true) {
                    ...
                    if (i13 >= 0) {
                        ...
                        if (charAt2 >= '0' && charAt2 <= '9') {
                            this.f39766b = fixNumbers.substring(0, i13) + fixNumbers.substring(i10);
                            return;
                        }
                        i10 = i13;
                    } else {
