...
public final class on0 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public EditTextBoldCursor[] f36257a0;
    public boolean f36258a1;
    public final int f36259b;
    public ScrollView f36260b0;
    public long f36261b1;
    public long f36262c;
    public LinearLayout f36263c0;
    public byte[] f36264c1;
    public final String d;
    public LinearLayout f36265d0;
    public String f36266d1;
    public final String e;
    public LinearLayout f36267e0;
    public byte[] f36268e1;
    public boolean f36269f;
    public LinearLayout f36270f0;
    public boolean f36271f1;
    public LinearLayout f36272g0;
    public boolean f36273g1;
    public final String h;
    public LinearLayout f36274h0;
    public on0 f36275h1;
    public LinearLayout f36276i0;
    public final ArrayList f36277i1;
    public org.telegram.ui.Cells.m4 f36278j0;
    public SecureDocument f36279j1;
    public final ArrayList f36280k0;
    public final ArrayList f36281k1;
    public org.telegram.ui.Cells.a7 f36282l0;
    public SecureDocument l1;
    public org.telegram.ui.Cells.a7 m0;
    public SecureDocument f36283m1;
    public final String f36284n;
    public org.telegram.ui.Cells.e9 f36285n0;
    public final HashMap f36286n1;
    public org.telegram.ui.Cells.e9 f36287o0;
    public final HashMap f36288o1;
    public org.telegram.ui.Cells.e9 f36289p0;
    public final HashMap f36290p1;
    public org.telegram.ui.Cells.e9 f36291q0;
    public final HashMap f36292q1;
    public final String f36293r;
    public org.telegram.ui.Cells.ea f36294r0;
    public final HashMap f36295r1;
    public String f36296s;
    public int f36297s0;
    public final HashMap f36298s1;
    public final boolean[] f36299t0;
    public final HashMap f36300t1;
    public boolean f36301u0;
    public final HashMap f36302u1;
    public String v;
    public boolean f36303v0;
    public final HashMap f36304v1;
    public String f36305w;
    public TextView f36306w0;
    public HashMap f36307w1;
    public final int[] f36308x;
    public org.telegram.ui.Cells.ea f36309x0;
    public HashMap f36310x1;
    public TL_account.authorizationForm f36311y;
    public org.telegram.ui.Cells.ea f36312y0;
    public final HashMap f36313y1;
    public org.telegram.ui.Cells.a7 f36314z0;
    public String f36315z1;
    ...
    public on0(int i10, TL_account.authorizationForm authorizationform, TL_account.Password password, TLRPC.TL_secureRequiredType tL_secureRequiredType, TLRPC.TL_secureValue tL_secureValue, TLRPC.TL_secureRequiredType tL_secureRequiredType2, TLRPC.TL_secureValue tL_secureValue2, HashMap hashMap, HashMap hashMap2) {
        ...
        this.f36296s = "";
        this.v = "";
        this.f36308x = new int[3];
        this.f36280k0 = new ArrayList();
        this.f36299t0 = new boolean[3];
        this.f36301u0 = true;
        this.U0 = new ArrayList();
        this.V0 = new HashMap();
        this.W0 = new HashMap();
        this.X0 = new HashMap();
        this.f36277i1 = new ArrayList();
        this.f36281k1 = new ArrayList();
        this.f36286n1 = new HashMap();
        this.f36288o1 = new HashMap();
        this.f36290p1 = new HashMap();
        this.f36292q1 = new HashMap();
        this.f36295r1 = new HashMap();
        this.f36302u1 = new HashMap();
        this.f36304v1 = new HashMap();
        this.f36313y1 = new HashMap();
        this.D1 = new nm0(this);
        this.f36259b = i10;
        this.f36311y = authorizationform;
        this.E = tL_secureRequiredType;
        if (tL_secureRequiredType != null) {
            this.f36301u0 = tL_secureRequiredType.native_names;
        }
        this.H = tL_secureValue;
        this.F = tL_secureRequiredType2;
        this.I = tL_secureValue2;
        this.J = password;
        this.f36298s1 = hashMap;
        this.f36300t1 = hashMap2;
        if (i10 == 3) {
        ...
        if (hashMap == null) {
            this.f36298s1 = new HashMap();
        }
        if (hashMap2 == null) {
            this.f36300t1 = new HashMap();
        }
        if (i10 == 5) {
    ...
    public static void V(on0 on0Var) {
        ...
        HashMap hashMap = on0Var.f36295r1;
        HashMap hashMap2 = on0Var.f36292q1;
        String str = on0Var.f36293r;
        ArrayList arrayList2 = new ArrayList();
        int size = on0Var.f36311y.required_types.size();
        for (int i12 = 0; i12 < size; i12++) {
            TLRPC.SecureRequiredType secureRequiredType = on0Var.f36311y.required_types.get(i12);
            ...
            HashMap hashMap3 = (HashMap) on0Var.f36302u1.get(o1(tL_secureRequiredType.type));
        ...
        acceptauthorization.bot_id = on0Var.f36262c;
        ...
        while (i14 < size3) {
            ...
            TLRPC.TL_secureValue tL_secureValue = om0Var.f36248a;
            ...
            if (securePlainData != null) {
                ...
                try {
                    ...
                    if (om0Var.f36250c && !tL_secureValue.translation.isEmpty()) {
        ...
        tL_secureCredentialsEncrypted.data = (byte[]) k12.f4259c;
        try {
            ...
            acceptauthorization.credentials.secret = cipher.doFinal((byte[]) k12.f4258b);
        } catch (Exception e) {
            FileLog.e(e);
        }
    ...
    public static void W(on0 on0Var, TLRPC.TL_error tL_error, String str, en0 en0Var, TLObject tLObject, TL_account.sendVerifyPhoneCode sendverifyphonecode) {
        if (tL_error == null) {
            ...
            on0 on0Var2 = new on0(7, on0Var.f36311y, on0Var.J, on0Var.E, (TLRPC.TL_secureValue) null, (TLRPC.TL_secureRequiredType) null, (TLRPC.TL_secureValue) null, hashMap, (HashMap) null);
            on0Var2.currentAccount = on0Var.currentAccount;
            on0Var2.f36268e1 = on0Var.f36268e1;
            on0Var2.f36264c1 = on0Var.f36264c1;
            on0Var2.B1 = en0Var;
    ...
    public static void X(on0 on0Var, SecureDocument secureDocument, int i10) {
        HashMap hashMap = on0Var.f36286n1;
        int i11 = on0Var.S0;
        if (i11 == 1) {
            SecureDocument secureDocument2 = on0Var.f36279j1;
            if (secureDocument2 != null) {
                mn0 mn0Var = (mn0) hashMap.remove(secureDocument2);
                if (mn0Var != null) {
                    on0Var.f36272g0.removeView(mn0Var);
                }
                on0Var.f36279j1 = null;
            }
        } else if (i11 == 4) {
            if (on0Var.f36281k1.size() >= 20) {
                return;
            }
        } else if (i11 == 2) {
            ...
            if (secureDocument3 != null) {
                ...
                if (mn0Var2 != null) {
                    on0Var.f36267e0.removeView(mn0Var2);
                }
                on0Var.l1 = null;
            }
        } else if (i11 == 3) {
            SecureDocument secureDocument4 = on0Var.f36283m1;
            if (secureDocument4 != null) {
                mn0 mn0Var3 = (mn0) hashMap.remove(secureDocument4);
                if (mn0Var3 != null) {
                    on0Var.f36270f0.removeView(mn0Var3);
                }
                on0Var.f36283m1 = null;
            }
        } else if (i11 == 0 && on0Var.f36277i1.size() >= 20) {
            return;
        }
        on0Var.f36288o1.put(secureDocument.path, secureDocument);
    ...
    public static void Z(int i10, String str, SecureDocument secureDocument, mn0 mn0Var, on0 on0Var) {
        HashMap hashMap = on0Var.f36288o1;
        on0Var.f36286n1.remove(secureDocument);
        if (i10 == 1) {
            on0Var.f36279j1 = null;
            on0Var.f36272g0.removeView(mn0Var);
        } else if (i10 == 4) {
            on0Var.f36281k1.remove(secureDocument);
            on0Var.f36274h0.removeView(mn0Var);
        } else if (i10 == 2) {
            on0Var.l1 = null;
            on0Var.f36267e0.removeView(mn0Var);
        } else if (i10 == 3) {
            on0Var.f36283m1 = null;
            on0Var.f36270f0.removeView(mn0Var);
        } else {
            on0Var.f36277i1.remove(secureDocument);
            on0Var.f36265d0.removeView(mn0Var);
        }
        if (str != null) {
            HashMap hashMap2 = on0Var.f36310x1;
            if (hashMap2 != null) {
                hashMap2.remove(str);
            }
            HashMap hashMap3 = on0Var.f36313y1;
            if (hashMap3 != null) {
                hashMap3.remove(str);
            }
        }
    ...
    public static void a0(on0 on0Var) {
        ...
        for (int i10 = 0; i10 < on0Var.f36311y.values.size(); i10++) {
            deletesecurevalue.types.add(on0Var.f36311y.values.get(i10).type);
        }
        on0Var.y1();
    ...
    public final void C1() {
        ...
        if (getParentActivity() != null && !arrayList.isEmpty()) {
            ...
            alertDialog$Builder.f18435a.R = LocaleController.getString(R.string.PassportNoDocumentsAdd);
    ...
    public final void D1() {
        ...
        int i11 = this.S0;
        ArrayList arrayList = this.f36277i1;
        int i12 = 1;
    ...
    public final void E1(TLRPC.TL_secureRequiredType tL_secureRequiredType, TLRPC.TL_secureRequiredType tL_secureRequiredType2, ArrayList arrayList, boolean z10) {
        ...
        if (i11 != -1) {
            HashMap hashMap4 = this.f36302u1;
            if (!z10) {
            ...
            TL_account.authorizationForm authorizationform = this.f36311y;
            int i12 = i11;
            TL_account.Password password = this.J;
            HashMap hashMap7 = this.f36290p1;
            ...
            on0Var.f36268e1 = this.f36268e1;
            on0Var.f36264c1 = this.f36264c1;
            on0Var.f36262c = this.f36262c;
            on0Var.f36307w1 = hashMap6;
            on0Var.f36303v0 = z10;
            on0Var.f36310x1 = hashMap2;
            on0Var.G = arrayList;
            if (i12 == 4) {
                on0Var.f36266d1 = this.f36266d1;
            }
    ...
    public final TLRPC.TL_secureValue H1(TLRPC.TL_secureRequiredType tL_secureRequiredType) {
        ...
        int size = this.f36311y.values.size();
        for (int i10 = 0; i10 < size; i10++) {
            if (tL_secureRequiredType.type.getClass() == this.f36311y.values.get(i10).type.getClass()) {
                return this.f36311y.values.remove(i10);
            }
        }
        return null;
    }
    ...
    public final void I1(View view) {
        while (view != null && this.f36263c0.indexOfChild(view) < 0) {
            view = (View) view.getParent();
        }
        if (view != null) {
            this.f36260b0.smoothScrollTo(0, view.getTop() - ((this.f36260b0.getMeasuredHeight() - view.getMeasuredHeight()) / 2));
        }
    }
    ...
    public final void J1(HashMap hashMap, EditTextBoldCursor editTextBoldCursor, String str) {
        ...
        HashMap hashMap2 = this.f36307w1;
        HashMap hashMap3 = this.f36313y1;
        ...
        HashMap hashMap4 = this.f36310x1;
    ...
    public final void Q1() {
        if (this.f36311y.values.isEmpty()) {
            this.A0.setVisibility(0);
            this.f36282l0.setVisibility(8);
            this.f36278j0.setVisibility(8);
            this.f36309x0.setVisibility(8);
            this.f36312y0.setVisibility(8);
            this.f36314z0.setVisibility(8);
            return;
        }
        this.A0.setVisibility(8);
        this.f36282l0.setVisibility(0);
        this.f36278j0.setVisibility(0);
        this.f36312y0.setVisibility(0);
        this.f36314z0.setVisibility(0);
    ...
    public final void R0(final SecureDocument secureDocument, final int i10) {
        ...
        HashMap hashMap;
        if (i10 == 1) {
            this.f36279j1 = secureDocument;
            if (this.f36272g0 == null) {
                return;
            }
        } else if (i10 == 4) {
            this.f36281k1.add(secureDocument);
            if (this.f36274h0 == null) {
                return;
            }
        } else if (i10 == 2) {
            this.l1 = secureDocument;
            if (this.f36267e0 == null) {
                return;
            }
        } else if (i10 == 3) {
            this.f36283m1 = secureDocument;
            if (this.f36270f0 == null) {
                return;
            }
        } else {
            this.f36277i1.add(secureDocument);
            if (this.f36265d0 == null) {
                return;
            }
        }
        if (getParentActivity() == null) {
        ...
        if (i10 == 1) {
            ...
            this.f36267e0.addView(mn0Var, w7.x5.n(-1, -2));
            str = "front" + n12;
        } else if (i10 == 3) {
            string = LocaleController.getString(R.string.PassportReverseSide);
            this.f36270f0.addView(mn0Var, w7.x5.n(-1, -2));
            str = "reverse" + n12;
        } else {
            string = LocaleController.getString(R.string.AttachPhoto);
            this.f36265d0.addView(mn0Var, w7.x5.n(-1, -2));
            str = "files" + n12;
        }
        if (str != null && (hashMap = this.f36310x1) != null && (formatDateForBan = (String) hashMap.get(str)) != null) {
            mn0Var.f35779b.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19053p7, false));
            this.f36313y1.put(str, "");
        } else {
            formatDateForBan = LocaleController.formatDateForBan(secureDocument.secureFile.date);
        }
        mn0Var.f35778a.setText(string);
        mn0Var.f35779b.setText(formatDateForBan);
        org.telegram.ui.Components.u9 u9Var = mn0Var.f35780c;
        u9Var.getClass();
        u9Var.m(ImageLocation.getForSecureDocument(secureDocument), "48_48", null, null, null, null, 0, null);
        mn0Var.f35781f = secureDocument;
        mn0Var.a(false);
        ...
        mn0Var.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public final boolean onLongClick(View view) {
                ...
                int i11 = i10;
                if (i11 == 1) {
                    alertDialog$Builder.f18435a.T = LocaleController.getString(R.string.PassportDeleteSelfie);
                } else {
                    alertDialog$Builder.f18435a.T = LocaleController.getString(R.string.PassportDeleteScan);
                }
                ...
                on0Var.showDialog(alertDialog$Builder.f18435a);
                return true;
            }
        });
    }
    ...
    public final void Y0(boolean z10) {
        ...
        if (this.f36257a0 != null) {
            ...
            if (this.E.native_names && !TextUtils.isEmpty(this.v) && !"EN".equals(str3)) {
                if (this.f36291q0.getVisibility() != 0) {
                    this.f36291q0.setVisibility(0);
                    this.f36278j0.setVisibility(0);
                    this.T.setVisibility(0);
                    int i11 = 0;
                    while (true) {
                        editTextBoldCursorArr = this.f36257a0;
                        if (i11 >= editTextBoldCursorArr.length) {
                            break;
                        }
                    ...
                    if (editTextBoldCursorArr[0].length() == 0 && this.f36257a0[1].length() == 0 && this.f36257a0[2].length() == 0) {
                        int i12 = 0;
                        while (true) {
                            boolean[] zArr = this.f36299t0;
                            if (i12 >= zArr.length) {
                                break;
                            } else if (zArr[i12]) {
                                this.f36257a0[0].setText(this.Y[0].getText());
                                this.f36257a0[1].setText(this.Y[1].getText());
                                this.f36257a0[2].setText(this.Y[2].getText());
                                break;
                            } else {
                                i12++;
                            }
                    ...
                    this.m0.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.V0(getParentActivity(), R.drawable.greydivider, org.telegram.ui.ActionBar.i6.f18798b7));
                }
                this.f36291q0.setText(LocaleController.formatString("PassportNativeInfo", R.string.PassportNativeInfo, str2));
                if (str3 != null) {
                ...
                if (str != null) {
                    this.f36278j0.setText(LocaleController.formatString("PassportNativeHeaderLang", R.string.PassportNativeHeaderLang, str));
                } else {
                    this.f36278j0.setText(LocaleController.getString(R.string.PassportNativeHeader));
                }
                for (int i13 = 0; i13 < 3; i13++) {
                    if (i13 != 0) {
                        if (i13 != 1) {
                            if (i13 == 2) {
                                if (str != null) {
                                    this.f36257a0[i13].setHintText(LocaleController.getString(R.string.PassportSurname));
                                } else {
                                    this.f36257a0[i13].setHintText(LocaleController.formatString("PassportSurnameCountry", R.string.PassportSurnameCountry, str2));
                                }
                            }
                        } else if (str != null) {
                            this.f36257a0[i13].setHintText(LocaleController.getString(R.string.PassportMidname));
                        } else {
                            this.f36257a0[i13].setHintText(LocaleController.formatString("PassportMidnameCountry", R.string.PassportMidnameCountry, str2));
                        }
                    } else if (str != null) {
                        this.f36257a0[i13].setHintText(LocaleController.getString(R.string.PassportName));
                    } else {
                        this.f36257a0[i13].setHintText(LocaleController.formatString("PassportNameCountry", R.string.PassportNameCountry, str2));
                    }
                }
                if (z10) {
                    AndroidUtilities.runOnUIThread(new xl0(this, 2));
                }
            } else if (this.f36291q0.getVisibility() != 8) {
                this.f36291q0.setVisibility(8);
                this.f36278j0.setVisibility(8);
                this.T.setVisibility(8);
                while (true) {
                    EditTextBoldCursor[] editTextBoldCursorArr2 = this.f36257a0;
                ...
                if (((this.f36262c != 0 || this.F == null) && this.H != null && !this.f36303v0) || this.I != null) {
                    this.m0.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.V0(getParentActivity(), R.drawable.greydivider, org.telegram.ui.ActionBar.i6.f18798b7));
                } else {
                    this.m0.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.V0(getParentActivity(), R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.i6.f18798b7));
                }
            }
        }
    }
    ...
    public final void a1(boolean z10) {
        ...
        if (this.f36289p0 != null) {
            HashMap hashMap = this.f36307w1;
            HashMap hashMap2 = this.f36313y1;
            if (hashMap != null && ((z10 || hashMap2.containsKey("error_all")) && (str2 = (String) this.f36307w1.get("error_all")) != null)) {
            ...
            if (this.f36310x1 != null && ((z10 || hashMap2.containsKey("error_document_all")) && (str = (String) this.f36310x1.get("error_all")) != null)) {
            ...
            if (spannableStringBuilder != null) {
                spannableStringBuilder.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19053p7, false)), 0, spannableStringBuilder.length(), 33);
                this.f36289p0.setText(spannableStringBuilder);
                this.f36289p0.setVisibility(0);
            } else if (this.f36289p0.getVisibility() != 8) {
                this.f36289p0.setVisibility(8);
            }
        }
    }
    ...
    public final void b1(Context context) {
        ...
        this.f36289p0.setPadding(0, AndroidUtilities.dp(7.0f), 0, 0);
        this.f36263c0.addView(this.f36289p0, w7.x5.n(-1, -2));
        a1(true);
        TLRPC.TL_secureRequiredType tL_secureRequiredType = this.F;
        if (tL_secureRequiredType != null) {
            ...
            org.telegram.ui.Cells.m4 m4Var2 = this.f36278j0;
            int i12 = org.telegram.ui.ActionBar.i6.f18834d6;
            m4Var2.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, i12, false));
            this.f36263c0.addView(this.f36278j0, w7.x5.n(-1, -2));
            LinearLayout linearLayout = new LinearLayout(context);
            this.f36265d0 = linearLayout;
            linearLayout.setOrientation(1);
            this.f36263c0.addView(this.f36265d0, w7.x5.n(-1, -2));
            ...
            if (hashMap != null) {
                ...
                if (str4 != null) {
                    ...
                    spannableStringBuilder.append((CharSequence) "\n\n");
                    spannableStringBuilder.append((CharSequence) this.f36315z1);
                    spannableStringBuilder.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19053p7, false)), 0, str4.length(), 33);
                    hashMap2.put("files_all", "");
                    str3 = spannableStringBuilder;
                }
            }
            this.f36285n0.setText(str3);
            this.f36263c0.addView(this.f36285n0, w7.x5.n(-1, -2));
            if (this.F.translation_required) {
                org.telegram.ui.Cells.m4 m4Var3 = new org.telegram.ui.Cells.m4(context);
                this.f36278j0 = m4Var3;
                m4Var3.setText(LocaleController.getString(R.string.PassportTranslation));
                this.f36278j0.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, i12, false));
                this.f36263c0.addView(this.f36278j0, w7.x5.n(-1, -2));
                LinearLayout linearLayout2 = new LinearLayout(context);
                this.f36274h0 = linearLayout2;
                linearLayout2.setOrientation(1);
                this.f36263c0.addView(this.f36274h0, w7.x5.n(-1, -2));
                ...
                String str5 = this.A1;
                HashMap hashMap3 = this.f36310x1;
                String str6 = str5;
                if (hashMap3 != null) {
                    ...
                    if (str7 != null) {
                        ...
                        spannableStringBuilder2.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19053p7, false)), 0, str7.length(), 33);
                        hashMap2.put("translation_all", "");
                        str6 = spannableStringBuilder2;
                    }
                }
                this.f36287o0.setText(str6);
                this.f36263c0.addView(this.f36287o0, w7.x5.n(-1, -2));
            }
        } else {
            j3 = 0;
        ...
        this.f36278j0 = m4Var4;
        m4Var4.setText(LocaleController.getString(R.string.PassportAddressHeader));
        this.f36278j0.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18834d6, false));
        this.f36263c0.addView(this.f36278j0, w7.x5.n(-1, -2));
        ...
        for (int i13 = 0; i13 < 6; i13++) {
            ...
            this.f36263c0.addView(im0Var, w7.x5.n(-1, -2));
            ...
            if (i13 == 5) {
                ...
                this.f36263c0.addView(this.S, w7.x5.n(-1, 6));
            }
            if (this.f36303v0 && this.F != null) {
            ...
            this.Y[i13].setLineColors(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18961k6, false), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18979l6, false), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19053p7, false));
            if (i13 == 5) {
            ...
            J1(this.f36298s1, this.Y[i13], str);
            if (i13 == 2) {
        ...
        this.f36282l0 = a7Var;
        this.f36263c0.addView(a7Var, w7.x5.n(-1, -2));
        if (this.f36303v0 && this.F != null) {
            this.f36278j0.setVisibility(8);
            this.f36282l0.setVisibility(8);
        }
        long j10 = this.f36262c;
        TLRPC.TL_secureValue tL_secureValue = this.I;
        if (((j10 != j3 || this.F == null) && this.H != null && !this.f36303v0) || tL_secureValue != null) {
            if (tL_secureValue != null) {
                T0(tL_secureValue.files);
                V0(tL_secureValue.translation);
            }
            org.telegram.ui.Cells.a7 a7Var2 = this.f36282l0;
            int i17 = R.drawable.greydivider;
            int i18 = org.telegram.ui.ActionBar.i6.f18798b7;
            ...
            eaVar3.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19053p7, false));
            ...
            this.f36263c0.addView(eaVar3, w7.x5.n(-1, -2));
            ...
            this.f36282l0 = a7Var3;
            a7Var3.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.V0(context, R.drawable.greydivider_bottom, i18));
            this.f36263c0.addView(this.f36282l0, w7.x5.n(-1, -2));
        } else {
            org.telegram.ui.Cells.a7 a7Var4 = this.f36282l0;
            int i19 = R.drawable.greydivider_bottom;
            int i20 = org.telegram.ui.ActionBar.i6.f18798b7;
            a7Var4.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.V0(context, i19, i20));
            if (this.f36303v0 && this.F != null) {
                this.f36285n0.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.V0(context, R.drawable.greydivider_bottom, i20));
            }
        }
        S1(0);
        S1(4);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.fileUploaded) {
            ...
            if (secureDocument != null) {
                ...
                HashMap hashMap2 = this.f36286n1;
                ...
                if (i12 == 0) {
                    if (this.f36285n0 != null && !TextUtils.isEmpty(this.f36315z1)) {
                        this.f36285n0.setText(this.f36315z1);
                    }
                    hashMap3.remove("files_all");
                } else if (i12 == 4) {
                    if (this.f36287o0 != null && !TextUtils.isEmpty(this.A1)) {
                        this.f36287o0.setText(this.A1);
                    }
    ...
    public final void dismissCurrentDialog() {
        ...
        if (viVar != null && this.visibleDialog == viVar) {
            viVar.f28759j0.a0(false);
            this.R0.dismissInternal();
            this.R0.f28759j0.d0(true);
            return;
        }
    ...
    public final void e1(Context context) {
        ...
        int i13 = org.telegram.ui.ActionBar.i6.f18798b7;
        ...
        if (tL_secureRequiredType != null) {
            ...
            m4Var2.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, i15, false));
            this.f36263c0.addView(this.f36278j0, w7.x5.n(-1, -2));
            LinearLayout linearLayout = new LinearLayout(context);
            this.f36267e0 = linearLayout;
            linearLayout.setOrientation(1);
            this.f36263c0.addView(this.f36267e0, w7.x5.n(-1, -2));
            ...
            this.f36263c0.addView(this.U, w7.x5.n(-1, -2));
            this.U.setOnClickListener(new yl0(this, 0));
            LinearLayout linearLayout2 = new LinearLayout(context);
            this.f36270f0 = linearLayout2;
            linearLayout2.setOrientation(1);
            this.f36263c0.addView(this.f36270f0, w7.x5.n(-1, -2));
            ...
            this.f36263c0.addView(this.V, w7.x5.n(-1, -2));
            this.V.setOnClickListener(new yl0(this, 2));
            if (this.F.selfie_required) {
                LinearLayout linearLayout3 = new LinearLayout(context);
                this.f36272g0 = linearLayout3;
                linearLayout3.setOrientation(1);
                this.f36263c0.addView(this.f36272g0, w7.x5.n(-1, -2));
                ...
                this.f36263c0.addView(this.W, w7.x5.n(-1, -2));
            ...
            this.f36285n0.setText(LocaleController.getString(R.string.PassportPersonalUploadInfo));
            this.f36263c0.addView(this.f36285n0, w7.x5.n(-1, -2));
            if (this.F.translation_required) {
                org.telegram.ui.Cells.m4 m4Var3 = new org.telegram.ui.Cells.m4(context);
                this.f36278j0 = m4Var3;
                m4Var3.setText(LocaleController.getString(R.string.PassportTranslation));
                this.f36278j0.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, i15, false));
                this.f36263c0.addView(this.f36278j0, w7.x5.n(-1, -2));
                LinearLayout linearLayout4 = new LinearLayout(context);
                this.f36274h0 = linearLayout4;
                ...
                if (hashMap != null) {
                    ...
                    if (str5 != null) {
                        ...
                        spannableStringBuilder.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19053p7, false)), 0, str5.length(), 33);
                        this.f36313y1.put("translation_all", "");
                        str4 = spannableStringBuilder;
                    }
                }
                this.f36287o0.setText(str4);
                this.f36263c0.addView(this.f36287o0, w7.x5.n(-1, -2));
            }
        } else {
            j3 = 0;
            org.telegram.ui.Cells.ea eaVar2 = new org.telegram.ui.Cells.ea(context);
            this.f36294r0 = eaVar2;
            eaVar2.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.K0(true));
            this.f36294r0.b(LocaleController.getString(R.string.PassportScanPassport), false);
            this.f36263c0.addView(this.f36294r0, w7.x5.n(-1, -2));
            this.f36294r0.setOnClickListener(new yl0(this, 5));
            org.telegram.ui.Cells.e9 e9Var4 = new org.telegram.ui.Cells.e9(context);
            this.f36285n0 = e9Var4;
            e9Var4.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.V0(context, R.drawable.greydivider, i13));
            this.f36285n0.setText(LocaleController.getString(R.string.PassportScanPassportInfo));
            this.f36263c0.addView(this.f36285n0, w7.x5.n(-1, -2));
        }
        org.telegram.ui.Cells.m4 m4Var4 = new org.telegram.ui.Cells.m4(context);
        this.f36278j0 = m4Var4;
        ...
        while (true) {
            ...
            if (i17 < i10) {
                ...
                if (i17 == i10 - 1) {
                    ...
                    this.f36263c0.addView(this.S, w7.x5.n(i14, 6));
                }
                if (this.f36303v0 && this.F != null && i17 < i16) {
                    im0Var.setVisibility(8);
                    View view2 = this.S;
                    if (view2 != null) {
                        view2.setVisibility(8);
                ...
                this.Y[i17].setLineColors(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18961k6, false), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18979l6, false), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19053p7, false));
                int i20 = 5;
                if (i17 != 5 && i17 != 6) {
                    if (i17 != 3 && i17 != 8) {
                        if (i17 == 4) {
                ...
                HashMap hashMap3 = this.f36300t1;
                switch (i17) {
                    case 0:
                ...
                this.f36278j0 = m4Var5;
                m4Var5.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18834d6, false));
                this.f36263c0.addView(this.f36278j0, w7.x5.n(-1, -2));
                this.f36257a0 = new EditTextBoldCursor[3];
                int i21 = 0;
                for (int i22 = 3; i21 < i22; i22 = 3) {
                    EditTextBoldCursor editTextBoldCursor5 = new EditTextBoldCursor(context);
                    this.f36257a0[i21] = editTextBoldCursor5;
                    im0 im0Var2 = new im0(context, editTextBoldCursor5, 2);
                    im0Var2.setWillNotDraw(false);
                    this.f36263c0.addView(im0Var2, w7.x5.n(-1, 64));
                    ...
                    if (i21 == 2) {
                        ...
                        this.f36263c0.addView(this.T, w7.x5.n(-1, 6));
                    }
                    this.f36257a0[i21].setTag(Integer.valueOf(i21));
                    this.f36257a0[i21].setSupportRtlHint(true);
                    this.f36257a0[i21].setTextSize(1, 16.0f);
                    this.f36257a0[i21].setHintColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.H6, false));
                    EditTextBoldCursor editTextBoldCursor6 = this.f36257a0[i21];
                    int i24 = org.telegram.ui.ActionBar.i6.G6;
                    editTextBoldCursor6.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, i24, false));
                    this.f36257a0[i21].setHeaderHintColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.L6, false));
                    this.f36257a0[i21].setTransformHintToHeader(true);
                    this.f36257a0[i21].setBackgroundDrawable(null);
                    this.f36257a0[i21].setCursorColor(org.telegram.ui.ActionBar.i6.w0(null, i24, false));
                    this.f36257a0[i21].setCursorSize(AndroidUtilities.dp(20.0f));
                    this.f36257a0[i21].setCursorWidth(1.5f);
                    this.f36257a0[i21].setLineColors(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18961k6, false), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18979l6, false), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19053p7, false));
                    this.f36257a0[i21].setInputType(16385);
                    this.f36257a0[i21].setImeOptions(268435461);
                    if (i21 != 0) {
                        if (i21 != 1) {
                            if (i21 == 2) {
                    ...
                    J1(hashMap2, this.f36257a0[i21], str);
                    EditTextBoldCursor editTextBoldCursor7 = this.f36257a0[i21];
                    editTextBoldCursor7.setSelection(editTextBoldCursor7.length());
                    if (i21 == 0 || i21 == 2 || i21 == 1) {
                        this.f36257a0[i21].addTextChangedListener(new km0(this, editTextBoldCursor5, str, 1));
                    }
                    this.f36257a0[i21].setPadding(0, 0, 0, 0);
                    EditTextBoldCursor editTextBoldCursor8 = this.f36257a0[i21];
                    if (LocaleController.isRTL) {
                        i11 = 5;
                    } else {
                        i11 = 3;
                    ...
                    im0Var2.addView(this.f36257a0[i21], w7.x5.d(-1, -1.0f, 51, 21.0f, 0.0f, 21.0f, 0.0f));
                    this.f36257a0[i21].setOnEditorActionListener(new wl0(this, 2));
                    i21++;
                }
                org.telegram.ui.Cells.e9 e9Var5 = new org.telegram.ui.Cells.e9(context);
                this.f36291q0 = e9Var5;
                this.f36263c0.addView(e9Var5, w7.x5.n(-1, -2));
                long j10 = this.f36262c;
                TLRPC.TL_secureValue tL_secureValue = this.I;
                if (((j10 != j3 || this.F == null) && this.H != null && !this.f36303v0) || tL_secureValue != null) {
                    if (tL_secureValue != null) {
                    ...
                    org.telegram.ui.Cells.e9 e9Var6 = this.f36291q0;
                    int i25 = R.drawable.greydivider;
                    int i26 = org.telegram.ui.ActionBar.i6.f18798b7;
                    ...
                    this.f36282l0 = a7Var2;
                    a7Var2.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.V0(context, R.drawable.greydivider_bottom, i26));
                    this.f36263c0.addView(this.f36282l0, w7.x5.n(-1, -2));
                } else {
                    this.f36291q0.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.V0(context, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.i6.f18798b7));
                }
                P1();
                Y0(false);
                return;
    ...
    public final void g1(Context context) {
        ...
        this.f36263c0.addView(eaVar, w7.x5.n(-1, -2));
        ...
        this.f36285n0.setText(LocaleController.getString(R.string.PassportPhoneUseSameInfo));
        this.f36263c0.addView(this.f36285n0, w7.x5.n(-1, -2));
        org.telegram.ui.Cells.m4 m4Var = new org.telegram.ui.Cells.m4(context);
        this.f36278j0 = m4Var;
        ...
        for (int i11 = 0; i11 < 3; i11++) {
            ...
            if (i11 == 1) {
                ...
                this.f36263c0.addView(frameLayout, w7.x5.n(-1, 50));
            ...
            if (i11 == 1) {
                ...
                this.f36306w0 = textView;
                textView.setText("+");
                this.f36306w0.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, i12, false));
                this.f36306w0.setTextSize(1, 16.0f);
                frameLayout.addView(this.f36306w0, w7.x5.k(21.0f, 12.0f, 0.0f, 6.0f, -2, -2));
        ...
        org.telegram.ui.Cells.e9 e9Var2 = new org.telegram.ui.Cells.e9(context);
        this.f36285n0 = e9Var2;
        e9Var2.setBackgroundDrawable(org.telegram.ui.ActionBar.i6.V0(context, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.i6.f18798b7));
        this.f36285n0.setText(LocaleController.getString(R.string.PassportPhoneUploadInfo));
        this.f36263c0.addView(this.f36285n0, w7.x5.n(-1, -2));
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36260b0, 32768, null, null, null, null, i10));
        ...
        int i11 = 0;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36263c0, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.i6.f18955k0, null, null, org.telegram.ui.ActionBar.i6.f18835d7));
        View view = this.S;
        int i12 = org.telegram.ui.ActionBar.i6.f18834d6;
        ...
        int i13 = 0;
        while (true) {
            ArrayList arrayList2 = this.f36280k0;
            if (i13 >= arrayList2.size()) {
                break;
            }
            arrayList.add(new org.telegram.ui.ActionBar.k6((View) arrayList2.get(i13), 1, null, null, null, null, org.telegram.ui.ActionBar.i6.f18835d7));
            i13++;
        }
        for (Map.Entry entry : this.f36286n1.entrySet()) {
            mn0 mn0Var = (mn0) entry.getValue();
            arrayList.add(new org.telegram.ui.ActionBar.k6(mn0Var, 268435456, new Class[]{mn0.class}, null, null, null, org.telegram.ui.ActionBar.i6.f18834d6));
            ...
            arrayList.add(new org.telegram.ui.ActionBar.k6(mn0Var, 0, new Class[]{mn0.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.f19234z6));
        }
        int i14 = org.telegram.ui.ActionBar.i6.f18834d6;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36263c0, 268435456, new Class[]{org.telegram.ui.Cells.d9.class}, null, null, null, i14));
        int i15 = org.telegram.ui.ActionBar.i6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36263c0, 0, new Class[]{org.telegram.ui.Cells.d9.class}, new String[]{"textView"}, null, null, -1, null, i15));
        int i16 = org.telegram.ui.ActionBar.i6.f19234z6;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36263c0, 0, new Class[]{org.telegram.ui.Cells.d9.class}, new String[]{"valueTextView"}, null, null, -1, null, i16));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36263c0, 268435456, new Class[]{org.telegram.ui.Cells.ea.class}, null, null, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36263c0, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i15));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36263c0, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.I6));
        int i17 = org.telegram.ui.ActionBar.i6.f18798b7;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36263c0, 32, new Class[]{org.telegram.ui.Cells.a7.class}, null, null, null, i17));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36263c0, 268435456, new Class[]{nn0.class}, null, null, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36263c0, 4, new Class[]{nn0.class}, new String[]{"textView"}, null, null, -1, null, i15));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36263c0, 4, new Class[]{nn0.class}, null, null, null, org.telegram.ui.ActionBar.i6.f18835d7));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36263c0, 4, new Class[]{nn0.class}, new String[]{"valueTextView"}, null, null, -1, null, i16));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36263c0, 8, new Class[]{nn0.class}, new String[]{"checkImageView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.Mh));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36263c0, 16, new Class[]{org.telegram.ui.Cells.m4.class}, null, null, null, i14));
        int i18 = org.telegram.ui.ActionBar.i6.L6;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36263c0, 0, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView"}, null, null, -1, null, i18));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36263c0, 32, new Class[]{org.telegram.ui.Cells.e9.class}, null, null, null, i17));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36263c0, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.B6));
        if (this.Y != null) {
            int i19 = 0;
            while (true) {
                EditTextBoldCursor[] editTextBoldCursorArr = this.Y;
                ...
                arrayList.add(new org.telegram.ui.ActionBar.k6((View) editTextBoldCursorArr[i19].getParent(), 1, null, null, null, null, org.telegram.ui.ActionBar.i6.f18834d6));
                ...
                arrayList.add(new org.telegram.ui.ActionBar.k6(this.Y[i19], 32, null, null, null, null, org.telegram.ui.ActionBar.i6.f18961k6));
                arrayList.add(new org.telegram.ui.ActionBar.k6(this.Y[i19], 65568, null, null, null, null, org.telegram.ui.ActionBar.i6.f18979l6));
                arrayList.add(new org.telegram.ui.ActionBar.k6(this.Y[i19], 2080, null, null, null, null, org.telegram.ui.ActionBar.i6.f19053p7));
                i19++;
            }
        } else {
            ...
            arrayList.add(new org.telegram.ui.ActionBar.k6(null, 32, null, null, null, null, org.telegram.ui.ActionBar.i6.f18961k6));
            arrayList.add(new org.telegram.ui.ActionBar.k6(null, 65568, null, null, null, null, org.telegram.ui.ActionBar.i6.f18979l6));
            arrayList.add(new org.telegram.ui.ActionBar.k6(null, 2080, null, null, null, null, org.telegram.ui.ActionBar.i6.f19053p7));
        }
        if (this.f36257a0 != null) {
            while (true) {
                EditTextBoldCursor[] editTextBoldCursorArr2 = this.f36257a0;
                ...
                arrayList.add(new org.telegram.ui.ActionBar.k6((View) editTextBoldCursorArr2[i11].getParent(), 1, null, null, null, null, org.telegram.ui.ActionBar.i6.f18834d6));
                arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36257a0[i11], 16777220, null, null, null, null, org.telegram.ui.ActionBar.i6.G6));
                arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36257a0[i11], 8388608, null, null, null, null, org.telegram.ui.ActionBar.i6.H6));
                arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36257a0[i11], 8390656, null, null, null, null, org.telegram.ui.ActionBar.i6.L6));
                arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36257a0[i11], 32, null, null, null, null, org.telegram.ui.ActionBar.i6.f18961k6));
                arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36257a0[i11], 65568, null, null, null, null, org.telegram.ui.ActionBar.i6.f18979l6));
                arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36257a0[i11], 2080, null, null, null, null, org.telegram.ui.ActionBar.i6.f19053p7));
                i11++;
            }
        }
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.F0, 2048, null, null, null, null, org.telegram.ui.ActionBar.i6.f18905h6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.K0, 4, null, null, null, null, org.telegram.ui.ActionBar.i6.f19089r6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f36306w0, 4, null, null, null, null, org.telegram.ui.ActionBar.i6.G6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.O, 4, null, null, null, null, org.telegram.ui.ActionBar.i6.f19137th));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.Q, 32, null, null, null, null, org.telegram.ui.ActionBar.i6.f19100rh));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.Q, 65568, null, null, null, null, org.telegram.ui.ActionBar.i6.f19119sh));
        org.telegram.ui.Components.tq tqVar = this.N;
        ...
        int i23 = org.telegram.ui.ActionBar.i6.f19234z6;
    ...
    public final byte[] i1(byte[] bArr, byte[] bArr2) {
        ...
        byte[] bArr3 = new byte[32];
        System.arraycopy(this.f36268e1, 0, bArr3, 0, 32);
        byte[] bArr4 = new byte[16];
        System.arraycopy(this.f36268e1, 32, bArr4, 0, 16);
        byte[] bArr5 = new byte[32];
        System.arraycopy(this.f36264c1, 0, bArr5, 0, 32);
            ...
            public final void run(TLObject tLObject, final TLRPC.TL_error tL_error) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    public final void run() {
                        ...
                        int i11 = 0;
                        if (on0Var2.f36259b == 8) {
                            nn0 nn0Var = (nn0) on0Var2.f36292q1.remove(tL_secureRequiredType6);
                            if (nn0Var != null) {
                                on0Var2.f36263c0.removeView(nn0Var);
                                View childAt = on0Var2.f36263c0.getChildAt(linearLayout.getChildCount() - 6);
    ...
    public final cf.c k1(byte[] bArr) {
        ...
        byte[] bArr6 = new byte[32];
        System.arraycopy(this.f36268e1, 0, bArr6, 0, 32);
        byte[] bArr7 = new byte[16];
        System.arraycopy(this.f36268e1, 32, bArr7, 0, 16);
        byte[] bArr8 = new byte[32];
        System.arraycopy(this.f36264c1, 0, bArr8, 0, 32);
        Utilities.aesCbcEncryptionByteArraySafe(bArr8, bArr6, bArr7, 0, 32, 0, 0);
    ...
    public final String m1() {
        ...
        int size = arrayList.size();
        for (int i12 = 0; i12 < size; i12++) {
            sb2.append(((SecureDocument) arrayList.get(i12)).secureFile.f18244id);
        }
        SecureDocument secureDocument = this.l1;
        if (secureDocument != null) {
            sb2.append(secureDocument.secureFile.f18244id);
        }
        SecureDocument secureDocument2 = this.f36283m1;
        if (secureDocument2 != null) {
            sb2.append(secureDocument2.secureFile.f18244id);
        }
        SecureDocument secureDocument3 = this.f36279j1;
        if (secureDocument3 != null) {
            sb2.append(secureDocument3.secureFile.f18244id);
        }
        ArrayList arrayList2 = this.f36281k1;
        int size2 = arrayList2.size();
        for (int i13 = 0; i13 < size2; i13++) {
            sb2.append(((SecureDocument) arrayList2.get(i13)).secureFile.f18244id);
        }
        return sb2.toString();
    }
    ...
    public final void onActivityResultFragment(int i10, int i11, Intent intent) {
        if (i11 == -1) {
            ...
            org.telegram.ui.Components.vi viVar = this.R0;
            if (viVar != null) {
                viVar.f28759j0.g0(i10, intent, this.Q0);
            }
            this.Q0 = null;
        }
    }
    ...
    public final void onDialogDismiss(Dialog dialog) {
        if (this.f36259b == 3 && Build.VERSION.SDK_INT >= 23 && dialog == this.L1) {
    ...
    public final void onRequestPermissionsResultFragment(int i10, String[] strArr, int[] iArr) {
        ...
        if ((i11 == 1 || i11 == 2) && (viVar = this.R0) != null) {
            if (i10 == 17) {
                ...
                F1(0);
            } else if (i10 == 22 && iArr != null && iArr.length > 0 && iArr[0] == 0 && (eaVar = this.f36294r0) != null) {
                eaVar.callOnClick();
            }
        } else if (i11 == 3 && i10 == 6) {
    ...
    public final void onResume() {
        ...
        if (this.f36259b == 5 && (viewGroupArr = this.Z) != null && (viewGroup = viewGroupArr[0]) != null && viewGroup.getVisibility() == 0) {
    ...
    public final TLRPC.TL_secureValue r1(TLRPC.TL_secureRequiredType tL_secureRequiredType, boolean z10) {
        ...
        if (tL_secureRequiredType != null) {
            int size = this.f36311y.values.size();
            for (int i10 = 0; i10 < size; i10++) {
                TLRPC.TL_secureValue tL_secureValue = this.f36311y.values.get(i10);
    ...
    public final boolean s1(Class cls) {
        int size = this.f36311y.values.size();
        for (int i10 = 0; i10 < size; i10++) {
            if (this.f36311y.values.get(i10).type.getClass() == cls) {
                return false;
            }
        }
        return true;
    ...
    public on0(int i10, long j3, String str, String str2, String str3, String str4, String str5, TL_account.authorizationForm authorizationform, TL_account.Password password) {
        ...
        try {
            ...
            while (i12 < size) {
                ...
                HashMap hashMap = (HashMap) this.f36302u1.get(o12);
                if (hashMap == null) {
                    hashMap = new HashMap();
                    i11 = size;
                    this.f36302u1.put(o12, hashMap);
                    this.f36304v1.put(o12, str6);
                } else {
                    i11 = size;
                }
                if (bArr != null) {
