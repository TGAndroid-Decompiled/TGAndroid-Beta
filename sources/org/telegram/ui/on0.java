...
public final class on0 extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public EditTextBoldCursor[] f35518a0;
    public boolean f35519a1;
    public final int f35520b;
    public ScrollView f35521b0;
    public long f35522b1;
    public long f35523c;
    public LinearLayout f35524c0;
    public byte[] f35525c1;
    public final String d;
    public LinearLayout f35526d0;
    public String f35527d1;
    public final String e;
    public LinearLayout f35528e0;
    public byte[] f35529e1;
    public boolean f35530f;
    public LinearLayout f35531f0;
    public boolean f35532f1;
    public LinearLayout f35533g0;
    public boolean f35534g1;
    public final String h;
    public LinearLayout f35535h0;
    public on0 f35536h1;
    public LinearLayout f35537i0;
    public final ArrayList f35538i1;
    public org.telegram.ui.Cells.m4 f35539j0;
    public SecureDocument f35540j1;
    public final ArrayList f35541k0;
    public final ArrayList f35542k1;
    public org.telegram.ui.Cells.c7 f35543l0;
    public SecureDocument l1;
    public org.telegram.ui.Cells.c7 m0;
    public SecureDocument f35544m1;
    public final String f35545n;
    public org.telegram.ui.Cells.f9 f35546n0;
    public final HashMap f35547n1;
    public org.telegram.ui.Cells.f9 f35548o0;
    public final HashMap f35549o1;
    public org.telegram.ui.Cells.f9 f35550p0;
    public final HashMap f35551p1;
    public org.telegram.ui.Cells.f9 f35552q0;
    public final HashMap f35553q1;
    public final String f35554r;
    public org.telegram.ui.Cells.ga f35555r0;
    public final HashMap f35556r1;
    public String f35557s;
    public int f35558s0;
    public final HashMap f35559s1;
    public final boolean[] f35560t0;
    public final HashMap f35561t1;
    public boolean f35562u0;
    public final HashMap f35563u1;
    public String v;
    public boolean f35564v0;
    public final HashMap f35565v1;
    public String f35566w;
    public TextView f35567w0;
    public HashMap f35568w1;
    public final int[] f35569x;
    public org.telegram.ui.Cells.ga f35570x0;
    public HashMap f35571x1;
    public TL_account.authorizationForm f35572y;
    public org.telegram.ui.Cells.ga f35573y0;
    public final HashMap f35574y1;
    public org.telegram.ui.Cells.c7 f35575z0;
    public String f35576z1;
    ...
    public on0(int i10, TL_account.authorizationForm authorizationform, TL_account.Password password, TLRPC.TL_secureRequiredType tL_secureRequiredType, TLRPC.TL_secureValue tL_secureValue, TLRPC.TL_secureRequiredType tL_secureRequiredType2, TLRPC.TL_secureValue tL_secureValue2, HashMap hashMap, HashMap hashMap2) {
        ...
        this.f35557s = "";
        this.v = "";
        this.f35569x = new int[3];
        this.f35541k0 = new ArrayList();
        this.f35560t0 = new boolean[3];
        this.f35562u0 = true;
        this.U0 = new ArrayList();
        this.V0 = new HashMap();
        this.W0 = new HashMap();
        this.X0 = new HashMap();
        this.f35538i1 = new ArrayList();
        this.f35542k1 = new ArrayList();
        this.f35547n1 = new HashMap();
        this.f35549o1 = new HashMap();
        this.f35551p1 = new HashMap();
        this.f35553q1 = new HashMap();
        this.f35556r1 = new HashMap();
        this.f35563u1 = new HashMap();
        this.f35565v1 = new HashMap();
        this.f35574y1 = new HashMap();
        this.D1 = new nm0(this);
        this.f35520b = i10;
        this.f35572y = authorizationform;
        this.E = tL_secureRequiredType;
        if (tL_secureRequiredType != null) {
            this.f35562u0 = tL_secureRequiredType.native_names;
        }
        this.H = tL_secureValue;
        this.F = tL_secureRequiredType2;
        this.I = tL_secureValue2;
        this.J = password;
        this.f35559s1 = hashMap;
        this.f35561t1 = hashMap2;
        if (i10 == 3) {
        ...
        if (hashMap == null) {
            this.f35559s1 = new HashMap();
        }
        if (hashMap2 == null) {
            this.f35561t1 = new HashMap();
        }
        if (i10 == 5) {
    ...
    public static void V(on0 on0Var) {
        ...
        HashMap hashMap = on0Var.f35556r1;
        HashMap hashMap2 = on0Var.f35553q1;
        String str = on0Var.f35554r;
        ArrayList arrayList2 = new ArrayList();
        int size = on0Var.f35572y.required_types.size();
        for (int i12 = 0; i12 < size; i12++) {
            TLRPC.SecureRequiredType secureRequiredType = on0Var.f35572y.required_types.get(i12);
            ...
            HashMap hashMap3 = (HashMap) on0Var.f35563u1.get(o1(tL_secureRequiredType.type));
        ...
        acceptauthorization.bot_id = on0Var.f35523c;
        ...
        while (i14 < size3) {
            ...
            TLRPC.TL_secureValue tL_secureValue = om0Var.f35514a;
            ...
            if (securePlainData != null) {
                ...
                try {
                    ...
                    if (om0Var.f35516c && !tL_secureValue.translation.isEmpty()) {
        ...
        tL_secureCredentialsEncrypted.data = (byte[]) k12.f3721c;
        try {
            ...
            acceptauthorization.credentials.secret = cipher.doFinal((byte[]) k12.f3720b);
        } catch (Exception e) {
            FileLog.e(e);
        }
    ...
    public static void W(on0 on0Var, TLRPC.TL_error tL_error, String str, en0 en0Var, TLObject tLObject, TL_account.sendVerifyPhoneCode sendverifyphonecode) {
        if (tL_error == null) {
            ...
            on0 on0Var2 = new on0(7, on0Var.f35572y, on0Var.J, on0Var.E, (TLRPC.TL_secureValue) null, (TLRPC.TL_secureRequiredType) null, (TLRPC.TL_secureValue) null, hashMap, (HashMap) null);
    ...
    public static void X(on0 on0Var, SecureDocument secureDocument, int i10) {
        HashMap hashMap = on0Var.f35547n1;
        int i11 = on0Var.S0;
        if (i11 == 1) {
            SecureDocument secureDocument2 = on0Var.f35540j1;
            if (secureDocument2 != null) {
                mn0 mn0Var = (mn0) hashMap.remove(secureDocument2);
                if (mn0Var != null) {
                    on0Var.f35533g0.removeView(mn0Var);
                }
                on0Var.f35540j1 = null;
            }
        } else if (i11 == 4) {
            if (on0Var.f35542k1.size() >= 20) {
                return;
            }
        } else if (i11 == 2) {
            ...
            if (secureDocument3 != null) {
                ...
                if (mn0Var2 != null) {
                    on0Var.f35528e0.removeView(mn0Var2);
                }
                on0Var.l1 = null;
            }
        } else if (i11 == 3) {
            SecureDocument secureDocument4 = on0Var.f35544m1;
            if (secureDocument4 != null) {
                mn0 mn0Var3 = (mn0) hashMap.remove(secureDocument4);
                if (mn0Var3 != null) {
                    on0Var.f35531f0.removeView(mn0Var3);
                }
                on0Var.f35544m1 = null;
            }
        } else if (i11 == 0 && on0Var.f35538i1.size() >= 20) {
            return;
        }
        on0Var.f35549o1.put(secureDocument.path, secureDocument);
    ...
    public static void Z(int i10, String str, SecureDocument secureDocument, mn0 mn0Var, on0 on0Var) {
        HashMap hashMap = on0Var.f35549o1;
        on0Var.f35547n1.remove(secureDocument);
        if (i10 == 1) {
            on0Var.f35540j1 = null;
            on0Var.f35533g0.removeView(mn0Var);
        } else if (i10 == 4) {
            on0Var.f35542k1.remove(secureDocument);
            on0Var.f35535h0.removeView(mn0Var);
        } else if (i10 == 2) {
            on0Var.l1 = null;
            on0Var.f35528e0.removeView(mn0Var);
        } else if (i10 == 3) {
            on0Var.f35544m1 = null;
            on0Var.f35531f0.removeView(mn0Var);
        } else {
            on0Var.f35538i1.remove(secureDocument);
            on0Var.f35526d0.removeView(mn0Var);
        }
        if (str != null) {
            HashMap hashMap2 = on0Var.f35571x1;
            if (hashMap2 != null) {
                hashMap2.remove(str);
            }
            HashMap hashMap3 = on0Var.f35574y1;
            if (hashMap3 != null) {
                hashMap3.remove(str);
            }
        }
    ...
    public static void a0(on0 on0Var) {
        ...
        for (int i10 = 0; i10 < on0Var.f35572y.values.size(); i10++) {
            deletesecurevalue.types.add(on0Var.f35572y.values.get(i10).type);
        }
        on0Var.y1();
    ...
    public final void C1() {
        ...
        if (getParentActivity() != null && !arrayList.isEmpty()) {
            ...
            alertDialog$Builder.f17528a.R = LocaleController.getString(R.string.PassportNoDocumentsAdd);
    ...
    public final void D1() {
        ...
        int i11 = this.S0;
        ArrayList arrayList = this.f35538i1;
        int i12 = 1;
    ...
    public final void E1(TLRPC.TL_secureRequiredType tL_secureRequiredType, TLRPC.TL_secureRequiredType tL_secureRequiredType2, ArrayList arrayList, boolean z10) {
        ...
        if (i11 != -1) {
            HashMap hashMap4 = this.f35563u1;
            if (!z10) {
            ...
            TL_account.authorizationForm authorizationform = this.f35572y;
            int i12 = i11;
            TL_account.Password password = this.J;
            HashMap hashMap7 = this.f35551p1;
            ...
            on0Var.f35529e1 = this.f35529e1;
            on0Var.f35525c1 = this.f35525c1;
            on0Var.f35523c = this.f35523c;
            on0Var.f35568w1 = hashMap6;
            on0Var.f35564v0 = z10;
            on0Var.f35571x1 = hashMap2;
            on0Var.G = arrayList;
            if (i12 == 4) {
                on0Var.f35527d1 = this.f35527d1;
            }
    ...
    public final TLRPC.TL_secureValue H1(TLRPC.TL_secureRequiredType tL_secureRequiredType) {
        ...
        int size = this.f35572y.values.size();
        for (int i10 = 0; i10 < size; i10++) {
            if (tL_secureRequiredType.type.getClass() == this.f35572y.values.get(i10).type.getClass()) {
                return this.f35572y.values.remove(i10);
            }
        }
        return null;
    }
    ...
    public final void I1(View view) {
        while (view != null && this.f35524c0.indexOfChild(view) < 0) {
            view = (View) view.getParent();
        }
        if (view != null) {
            this.f35521b0.smoothScrollTo(0, view.getTop() - ((this.f35521b0.getMeasuredHeight() - view.getMeasuredHeight()) / 2));
        }
    }
    ...
    public final void J1(HashMap hashMap, EditTextBoldCursor editTextBoldCursor, String str) {
        ...
        HashMap hashMap2 = this.f35568w1;
        HashMap hashMap3 = this.f35574y1;
        ...
        HashMap hashMap4 = this.f35571x1;
    ...
    public final void N1(boolean z10, boolean z11) {
        ...
        if (z10 && this.L != null) {
            ...
            if (z11) {
                ...
                animatorSet3.playTogether(ofFloat3, ofFloat4, ObjectAnimator.ofFloat(zqVar3, property6, 0.0f), ObjectAnimator.ofFloat(this.L.getContentView(), property4, 1.0f), ObjectAnimator.ofFloat(this.L.getContentView(), property5, 1.0f), ObjectAnimator.ofFloat(this.L.getContentView(), property6, 1.0f));
            }
            ...
            if (z11) {
                ...
                animatorSet5.playTogether(ofFloat7, ofFloat8, ObjectAnimator.ofFloat(zqVar6, property12, 0.0f), ObjectAnimator.ofFloat(this.O, property10, 1.0f), ObjectAnimator.ofFloat(this.O, property11, 1.0f), ObjectAnimator.ofFloat(this.O, property12, 1.0f));
            }
    ...
    public final void Q1() {
        if (this.f35572y.values.isEmpty()) {
            this.A0.setVisibility(0);
            this.f35543l0.setVisibility(8);
            this.f35539j0.setVisibility(8);
            this.f35570x0.setVisibility(8);
            this.f35573y0.setVisibility(8);
            this.f35575z0.setVisibility(8);
            return;
        }
        this.A0.setVisibility(8);
        this.f35543l0.setVisibility(0);
        this.f35539j0.setVisibility(0);
        this.f35573y0.setVisibility(0);
        this.f35575z0.setVisibility(0);
    ...
    public final void R0(final SecureDocument secureDocument, final int i10) {
        ...
        HashMap hashMap;
        if (i10 == 1) {
            this.f35540j1 = secureDocument;
            if (this.f35533g0 == null) {
                return;
            }
        } else if (i10 == 4) {
            this.f35542k1.add(secureDocument);
            if (this.f35535h0 == null) {
                return;
            }
        } else if (i10 == 2) {
            this.l1 = secureDocument;
            if (this.f35528e0 == null) {
                return;
            }
        } else if (i10 == 3) {
            this.f35544m1 = secureDocument;
            if (this.f35531f0 == null) {
                return;
            }
        } else {
            this.f35538i1.add(secureDocument);
            if (this.f35526d0 == null) {
                return;
            }
        }
        if (getParentActivity() == null) {
        ...
        if (i10 == 1) {
            ...
            this.f35528e0.addView(mn0Var, w7.a6.n(-1, -2));
            str = "front" + n12;
        } else if (i10 == 3) {
            string = LocaleController.getString(R.string.PassportReverseSide);
            this.f35531f0.addView(mn0Var, w7.a6.n(-1, -2));
            str = "reverse" + n12;
        } else {
            string = LocaleController.getString(R.string.AttachPhoto);
            this.f35526d0.addView(mn0Var, w7.a6.n(-1, -2));
            str = "files" + n12;
        }
        if (str != null && (hashMap = this.f35571x1) != null && (formatDateForBan = (String) hashMap.get(str)) != null) {
            mn0Var.f35006b.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18144p7, false));
            this.f35574y1.put(str, "");
        } else {
            formatDateForBan = LocaleController.formatDateForBan(secureDocument.secureFile.date);
        }
        mn0Var.f35005a.setText(string);
        mn0Var.f35006b.setText(formatDateForBan);
        org.telegram.ui.Components.w9 w9Var = mn0Var.f35007c;
        w9Var.getClass();
        w9Var.m(ImageLocation.getForSecureDocument(secureDocument), "48_48", null, null, null, null, 0, null);
        mn0Var.f35008f = secureDocument;
        mn0Var.a(false);
        ...
        mn0Var.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public final boolean onLongClick(View view) {
                ...
                int i11 = i10;
                if (i11 == 1) {
                    alertDialog$Builder.f17528a.T = LocaleController.getString(R.string.PassportDeleteSelfie);
                } else {
                    alertDialog$Builder.f17528a.T = LocaleController.getString(R.string.PassportDeleteScan);
                }
    ...
    public final void Y0(boolean z10) {
        ...
        if (this.f35518a0 != null) {
            ...
            if (this.E.native_names && !TextUtils.isEmpty(this.v) && !"EN".equals(str3)) {
                if (this.f35552q0.getVisibility() != 0) {
                    this.f35552q0.setVisibility(0);
                    this.f35539j0.setVisibility(0);
                    this.T.setVisibility(0);
                    int i11 = 0;
                    while (true) {
                        editTextBoldCursorArr = this.f35518a0;
                        if (i11 >= editTextBoldCursorArr.length) {
                            break;
                        }
                    ...
                    if (editTextBoldCursorArr[0].length() == 0 && this.f35518a0[1].length() == 0 && this.f35518a0[2].length() == 0) {
                        int i12 = 0;
                        while (true) {
                            boolean[] zArr = this.f35560t0;
                            if (i12 >= zArr.length) {
                                break;
                            } else if (zArr[i12]) {
                                this.f35518a0[0].setText(this.Y[0].getText());
                                this.f35518a0[1].setText(this.Y[1].getText());
                                this.f35518a0[2].setText(this.Y[2].getText());
                                break;
                            } else {
                                i12++;
                            }
                    ...
                    this.m0.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(getParentActivity(), R.drawable.greydivider, org.telegram.ui.ActionBar.j6.f17892b7));
                }
                this.f35552q0.setText(LocaleController.formatString("PassportNativeInfo", R.string.PassportNativeInfo, str2));
                if (str3 != null) {
                ...
                if (str != null) {
                    this.f35539j0.setText(LocaleController.formatString("PassportNativeHeaderLang", R.string.PassportNativeHeaderLang, str));
                } else {
                    this.f35539j0.setText(LocaleController.getString(R.string.PassportNativeHeader));
                }
                for (int i13 = 0; i13 < 3; i13++) {
                    if (i13 != 0) {
                        if (i13 != 1) {
                            if (i13 == 2) {
                                if (str != null) {
                                    this.f35518a0[i13].setHintText(LocaleController.getString(R.string.PassportSurname));
                                } else {
                                    this.f35518a0[i13].setHintText(LocaleController.formatString("PassportSurnameCountry", R.string.PassportSurnameCountry, str2));
                                }
                            }
                        } else if (str != null) {
                            this.f35518a0[i13].setHintText(LocaleController.getString(R.string.PassportMidname));
                        } else {
                            this.f35518a0[i13].setHintText(LocaleController.formatString("PassportMidnameCountry", R.string.PassportMidnameCountry, str2));
                        }
                    } else if (str != null) {
                        this.f35518a0[i13].setHintText(LocaleController.getString(R.string.PassportName));
                    } else {
                        this.f35518a0[i13].setHintText(LocaleController.formatString("PassportNameCountry", R.string.PassportNameCountry, str2));
                    }
                }
                if (z10) {
                    AndroidUtilities.runOnUIThread(new yl0(this, 2));
                }
            } else if (this.f35552q0.getVisibility() != 8) {
                this.f35552q0.setVisibility(8);
                this.f35539j0.setVisibility(8);
                this.T.setVisibility(8);
                while (true) {
                    EditTextBoldCursor[] editTextBoldCursorArr2 = this.f35518a0;
                ...
                if (((this.f35523c != 0 || this.F == null) && this.H != null && !this.f35564v0) || this.I != null) {
                    this.m0.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(getParentActivity(), R.drawable.greydivider, org.telegram.ui.ActionBar.j6.f17892b7));
                } else {
                    this.m0.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(getParentActivity(), R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.j6.f17892b7));
                }
            }
        }
    }
    ...
    public final void a1(boolean z10) {
        ...
        String str;
        String str2;
        if (this.f35550p0 != null) {
            HashMap hashMap = this.f35568w1;
            HashMap hashMap2 = this.f35574y1;
            if (hashMap != null && ((z10 || hashMap2.containsKey("error_all")) && (str2 = (String) this.f35568w1.get("error_all")) != null)) {
            ...
            if (this.f35571x1 != null && ((z10 || hashMap2.containsKey("error_document_all")) && (str = (String) this.f35571x1.get("error_all")) != null)) {
            ...
            if (spannableStringBuilder != null) {
                spannableStringBuilder.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18144p7, false)), 0, spannableStringBuilder.length(), 33);
                this.f35550p0.setText(spannableStringBuilder);
                this.f35550p0.setVisibility(0);
            } else if (this.f35550p0.getVisibility() != 8) {
                this.f35550p0.setVisibility(8);
            }
        }
    }
    ...
    public final void b1(Context context) {
        ...
        this.f35550p0.setPadding(0, AndroidUtilities.dp(7.0f), 0, 0);
        this.f35524c0.addView(this.f35550p0, w7.a6.n(-1, -2));
        a1(true);
        TLRPC.TL_secureRequiredType tL_secureRequiredType = this.F;
        if (tL_secureRequiredType != null) {
            ...
            org.telegram.ui.Cells.m4 m4Var2 = this.f35539j0;
            int i12 = org.telegram.ui.ActionBar.j6.f17928d6;
            m4Var2.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i12, false));
            this.f35524c0.addView(this.f35539j0, w7.a6.n(-1, -2));
            LinearLayout linearLayout = new LinearLayout(context);
            this.f35526d0 = linearLayout;
            linearLayout.setOrientation(1);
            this.f35524c0.addView(this.f35526d0, w7.a6.n(-1, -2));
            ...
            if (hashMap != null) {
                ...
                if (str4 != null) {
                    ...
                    spannableStringBuilder.append((CharSequence) "\n\n");
                    spannableStringBuilder.append((CharSequence) this.f35576z1);
                    spannableStringBuilder.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18144p7, false)), 0, str4.length(), 33);
                    hashMap2.put("files_all", "");
                    str3 = spannableStringBuilder;
                }
            }
            this.f35546n0.setText(str3);
            this.f35524c0.addView(this.f35546n0, w7.a6.n(-1, -2));
            if (this.F.translation_required) {
                org.telegram.ui.Cells.m4 m4Var3 = new org.telegram.ui.Cells.m4(context);
                this.f35539j0 = m4Var3;
                m4Var3.setText(LocaleController.getString(R.string.PassportTranslation));
                this.f35539j0.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i12, false));
                this.f35524c0.addView(this.f35539j0, w7.a6.n(-1, -2));
                LinearLayout linearLayout2 = new LinearLayout(context);
                this.f35535h0 = linearLayout2;
                linearLayout2.setOrientation(1);
                this.f35524c0.addView(this.f35535h0, w7.a6.n(-1, -2));
                ...
                String str5 = this.A1;
                HashMap hashMap3 = this.f35571x1;
                String str6 = str5;
                if (hashMap3 != null) {
                    ...
                    if (str7 != null) {
                        ...
                        spannableStringBuilder2.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18144p7, false)), 0, str7.length(), 33);
                        hashMap2.put("translation_all", "");
                        str6 = spannableStringBuilder2;
                    }
                }
                this.f35548o0.setText(str6);
                this.f35524c0.addView(this.f35548o0, w7.a6.n(-1, -2));
            }
        } else {
            j3 = 0;
        ...
        this.f35539j0 = m4Var4;
        m4Var4.setText(LocaleController.getString(R.string.PassportAddressHeader));
        this.f35539j0.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f17928d6, false));
        this.f35524c0.addView(this.f35539j0, w7.a6.n(-1, -2));
        ...
        for (int i13 = 0; i13 < 6; i13++) {
            ...
            this.f35524c0.addView(im0Var, w7.a6.n(-1, -2));
            int i14 = org.telegram.ui.ActionBar.j6.f17928d6;
            im0Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i14, false));
            int i15 = 5;
            if (i13 == 5) {
                View view = new View(context);
                this.S = view;
                view.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i14, false));
                this.f35524c0.addView(this.S, w7.a6.n(-1, 6));
            }
            if (this.f35564v0 && this.F != null) {
            ...
            this.Y[i13].setLineColors(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18055k6, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18073l6, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18144p7, false));
            if (i13 == 5) {
            ...
            J1(this.f35559s1, this.Y[i13], str);
            if (i13 == 2) {
            ...
            im0Var.addView(this.Y[i13], w7.a6.d(-1, 64.0f, 51, 21.0f, 0.0f, 21.0f, 0.0f));
        ...
        this.f35543l0 = c7Var;
        this.f35524c0.addView(c7Var, w7.a6.n(-1, -2));
        if (this.f35564v0 && this.F != null) {
            this.f35539j0.setVisibility(8);
            this.f35543l0.setVisibility(8);
        }
        ...
        if (((j10 != j3 || this.F == null) && this.H != null && !this.f35564v0) || tL_secureValue != null) {
            if (tL_secureValue != null) {
                T0(tL_secureValue.files);
                V0(tL_secureValue.translation);
            }
            org.telegram.ui.Cells.c7 c7Var2 = this.f35543l0;
            int i17 = R.drawable.greydivider;
            int i18 = org.telegram.ui.ActionBar.j6.f17892b7;
            ...
            gaVar3.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18144p7, false));
            ...
            this.f35524c0.addView(gaVar3, w7.a6.n(-1, -2));
            ...
            this.f35543l0 = c7Var3;
            c7Var3.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider_bottom, i18));
            this.f35524c0.addView(this.f35543l0, w7.a6.n(-1, -2));
        } else {
            org.telegram.ui.Cells.c7 c7Var4 = this.f35543l0;
            int i19 = R.drawable.greydivider_bottom;
            int i20 = org.telegram.ui.ActionBar.j6.f17892b7;
            c7Var4.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(context, i19, i20));
            if (this.f35564v0 && this.F != null) {
                this.f35546n0.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider_bottom, i20));
            }
        }
        S1(0);
        S1(4);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.fileUploaded) {
            ...
            if (secureDocument != null) {
                ...
                HashMap hashMap2 = this.f35547n1;
                ...
                if (i12 == 0) {
                    if (this.f35546n0 != null && !TextUtils.isEmpty(this.f35576z1)) {
                        this.f35546n0.setText(this.f35576z1);
                    }
                    hashMap3.remove("files_all");
                } else if (i12 == 4) {
                    if (this.f35548o0 != null && !TextUtils.isEmpty(this.A1)) {
                        this.f35548o0.setText(this.A1);
                    }
    ...
    public final void e1(Context context) {
        ...
        int i13 = org.telegram.ui.ActionBar.j6.f17892b7;
        ...
        if (tL_secureRequiredType != null) {
            ...
            this.f35524c0.addView(this.f35539j0, w7.a6.n(-1, -2));
            LinearLayout linearLayout = new LinearLayout(context);
            this.f35528e0 = linearLayout;
            linearLayout.setOrientation(1);
            this.f35524c0.addView(this.f35528e0, w7.a6.n(-1, -2));
            org.telegram.ui.Cells.e9 e9Var = new org.telegram.ui.Cells.e9(context);
            this.U = e9Var;
            e9Var.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.K0(true));
            this.f35524c0.addView(this.U, w7.a6.n(-1, -2));
            this.U.setOnClickListener(new zl0(this, 0));
            LinearLayout linearLayout2 = new LinearLayout(context);
            this.f35531f0 = linearLayout2;
            linearLayout2.setOrientation(1);
            this.f35524c0.addView(this.f35531f0, w7.a6.n(-1, -2));
            ...
            this.f35524c0.addView(this.V, w7.a6.n(-1, -2));
            this.V.setOnClickListener(new zl0(this, 2));
            if (this.F.selfie_required) {
                LinearLayout linearLayout3 = new LinearLayout(context);
                this.f35533g0 = linearLayout3;
                linearLayout3.setOrientation(1);
                this.f35524c0.addView(this.f35533g0, w7.a6.n(-1, -2));
                ...
                this.f35524c0.addView(this.W, w7.a6.n(-1, -2));
            ...
            this.f35546n0.setText(LocaleController.getString(R.string.PassportPersonalUploadInfo));
            this.f35524c0.addView(this.f35546n0, w7.a6.n(-1, -2));
            if (this.F.translation_required) {
                org.telegram.ui.Cells.m4 m4Var3 = new org.telegram.ui.Cells.m4(context);
                this.f35539j0 = m4Var3;
                m4Var3.setText(LocaleController.getString(R.string.PassportTranslation));
                this.f35539j0.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i15, false));
                this.f35524c0.addView(this.f35539j0, w7.a6.n(-1, -2));
                LinearLayout linearLayout4 = new LinearLayout(context);
                this.f35535h0 = linearLayout4;
                ...
                if (hashMap != null) {
                    ...
                    if (str5 != null) {
                        ...
                        spannableStringBuilder.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18144p7, false)), 0, str5.length(), 33);
                        this.f35574y1.put("translation_all", "");
                        str4 = spannableStringBuilder;
                    }
                }
                this.f35548o0.setText(str4);
                this.f35524c0.addView(this.f35548o0, w7.a6.n(-1, -2));
            }
        } else {
            j3 = 0;
            org.telegram.ui.Cells.ga gaVar2 = new org.telegram.ui.Cells.ga(context);
            this.f35555r0 = gaVar2;
            gaVar2.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.K0(true));
            this.f35555r0.b(LocaleController.getString(R.string.PassportScanPassport), false);
            this.f35524c0.addView(this.f35555r0, w7.a6.n(-1, -2));
            this.f35555r0.setOnClickListener(new zl0(this, 5));
            org.telegram.ui.Cells.f9 f9Var4 = new org.telegram.ui.Cells.f9(context);
            this.f35546n0 = f9Var4;
            f9Var4.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider, i13));
            this.f35546n0.setText(LocaleController.getString(R.string.PassportScanPassportInfo));
            this.f35524c0.addView(this.f35546n0, w7.a6.n(-1, -2));
        }
        org.telegram.ui.Cells.m4 m4Var4 = new org.telegram.ui.Cells.m4(context);
        this.f35539j0 = m4Var4;
        ...
        int i17 = 0;
        while (true) {
            HashMap hashMap2 = this.f35559s1;
            if (i17 < i10) {
                EditTextBoldCursor editTextBoldCursor = new EditTextBoldCursor(context);
                this.Y[i17] = editTextBoldCursor;
                im0 im0Var = new im0(context, editTextBoldCursor, 1);
                im0Var.setWillNotDraw(z10);
                this.f35524c0.addView(im0Var, w7.a6.n(i14, 64));
                int i18 = org.telegram.ui.ActionBar.j6.f17928d6;
                im0Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i18, z10));
                if (i17 == i10 - 1) {
                    View view = new View(context);
                    this.S = view;
                    view.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i18, z10));
                    this.f35524c0.addView(this.S, w7.a6.n(i14, 6));
                }
                if (this.f35564v0 && this.F != null && i17 < i16) {
                    im0Var.setVisibility(8);
                    View view2 = this.S;
                    if (view2 != null) {
                        view2.setVisibility(8);
                ...
                this.Y[i17].setLineColors(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18055k6, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18073l6, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18144p7, false));
                int i20 = 5;
                if (i17 != 5 && i17 != 6) {
                    if (i17 != 3 && i17 != 8) {
                        if (i17 == 4) {
                            this.Y[i17].setOnTouchListener(new am0(this, 1));
                        ...
                        this.Y[i17].setOnTouchListener(new bi.x1(7, this, context));
                        this.Y[i17].setInputType(0);
                        this.Y[i17].setFocusable(false);
                    }
                } else {
                ...
                HashMap hashMap3 = this.f35561t1;
                switch (i17) {
                    case 0:
                ...
                im0Var.addView(this.Y[i17], w7.a6.d(-1, -1.0f, 51, 21.0f, 0.0f, 21.0f, 0.0f));
                this.Y[i17].setOnEditorActionListener(new xl0(this, 1));
                i17++;
                r42 = 1;
                i16 = 7;
                z10 = false;
                ...
                this.f35539j0 = m4Var5;
                m4Var5.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f17928d6, false));
                this.f35524c0.addView(this.f35539j0, w7.a6.n(-1, -2));
                this.f35518a0 = new EditTextBoldCursor[3];
                int i21 = 0;
                for (int i22 = 3; i21 < i22; i22 = 3) {
                    EditTextBoldCursor editTextBoldCursor5 = new EditTextBoldCursor(context);
                    this.f35518a0[i21] = editTextBoldCursor5;
                    im0 im0Var2 = new im0(context, editTextBoldCursor5, 2);
                    im0Var2.setWillNotDraw(false);
                    this.f35524c0.addView(im0Var2, w7.a6.n(-1, 64));
                    int i23 = org.telegram.ui.ActionBar.j6.f17928d6;
                    im0Var2.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i23, false));
                    if (i21 == 2) {
                        View view3 = new View(context);
                        this.T = view3;
                        view3.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i23, false));
                        this.f35524c0.addView(this.T, w7.a6.n(-1, 6));
                    }
                    this.f35518a0[i21].setTag(Integer.valueOf(i21));
                    this.f35518a0[i21].setSupportRtlHint(true);
                    this.f35518a0[i21].setTextSize(1, 16.0f);
                    this.f35518a0[i21].setHintColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.H6, false));
                    EditTextBoldCursor editTextBoldCursor6 = this.f35518a0[i21];
                    int i24 = org.telegram.ui.ActionBar.j6.G6;
                    editTextBoldCursor6.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i24, false));
                    this.f35518a0[i21].setHeaderHintColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.L6, false));
                    this.f35518a0[i21].setTransformHintToHeader(true);
                    this.f35518a0[i21].setBackgroundDrawable(null);
                    this.f35518a0[i21].setCursorColor(org.telegram.ui.ActionBar.j6.w0(null, i24, false));
                    this.f35518a0[i21].setCursorSize(AndroidUtilities.dp(20.0f));
                    this.f35518a0[i21].setCursorWidth(1.5f);
                    this.f35518a0[i21].setLineColors(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18055k6, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18073l6, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18144p7, false));
                    this.f35518a0[i21].setInputType(16385);
                    this.f35518a0[i21].setImeOptions(268435461);
                    if (i21 != 0) {
                        if (i21 != 1) {
                            if (i21 == 2) {
                    ...
                    J1(hashMap2, this.f35518a0[i21], str);
                    EditTextBoldCursor editTextBoldCursor7 = this.f35518a0[i21];
                    editTextBoldCursor7.setSelection(editTextBoldCursor7.length());
                    if (i21 == 0 || i21 == 2 || i21 == 1) {
                        this.f35518a0[i21].addTextChangedListener(new km0(this, editTextBoldCursor5, str, 1));
                    }
                    this.f35518a0[i21].setPadding(0, 0, 0, 0);
                    EditTextBoldCursor editTextBoldCursor8 = this.f35518a0[i21];
                    if (LocaleController.isRTL) {
                        i11 = 5;
                    } else {
                        i11 = 3;
                    ...
                    im0Var2.addView(this.f35518a0[i21], w7.a6.d(-1, -1.0f, 51, 21.0f, 0.0f, 21.0f, 0.0f));
                    this.f35518a0[i21].setOnEditorActionListener(new xl0(this, 2));
                    i21++;
                }
                org.telegram.ui.Cells.f9 f9Var5 = new org.telegram.ui.Cells.f9(context);
                this.f35552q0 = f9Var5;
                this.f35524c0.addView(f9Var5, w7.a6.n(-1, -2));
                long j10 = this.f35523c;
                TLRPC.TL_secureValue tL_secureValue = this.I;
                if (((j10 != j3 || this.F == null) && this.H != null && !this.f35564v0) || tL_secureValue != null) {
                    if (tL_secureValue != null) {
                    ...
                    org.telegram.ui.Cells.f9 f9Var6 = this.f35552q0;
                    int i25 = R.drawable.greydivider;
                    int i26 = org.telegram.ui.ActionBar.j6.f17892b7;
                    ...
                    this.f35543l0 = c7Var2;
                    c7Var2.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider_bottom, i26));
                    this.f35524c0.addView(this.f35543l0, w7.a6.n(-1, -2));
                } else {
                    this.f35552q0.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.j6.f17892b7));
                }
                P1();
                Y0(false);
                return;
    ...
    public final void g1(Context context) {
        ...
        Collections.sort(this.U0, new sg.p(0));
        ...
        gf.b c10 = gf.b.c();
        gaVar.b(LocaleController.formatString("PassportPhoneUseSame", i10, c10.b("+" + str2)), false);
        this.f35524c0.addView(gaVar, w7.a6.n(-1, -2));
        ...
        this.f35546n0.setText(LocaleController.getString(R.string.PassportPhoneUseSameInfo));
        this.f35524c0.addView(this.f35546n0, w7.a6.n(-1, -2));
        org.telegram.ui.Cells.m4 m4Var = new org.telegram.ui.Cells.m4(context);
        this.f35539j0 = m4Var;
        ...
        for (int i11 = 0; i11 < 3; i11++) {
            if (i11 == 2) {
                this.Y[i11] = new org.telegram.ui.Components.p40(context);
            } else {
                this.Y[i11] = new EditTextBoldCursor(context);
            }
            if (i11 == 1) {
                frameLayout = org.telegram.messenger.em.f(context, 0);
                this.f35524c0.addView(frameLayout, w7.a6.n(-1, 50));
            ...
            if (i11 == 0) {
                this.Y[i11].setOnTouchListener(new am0(this, 3));
            ...
            if (i11 == 1) {
                ...
                this.f35567w0 = textView;
                textView.setText("+");
                this.f35567w0.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i12, false));
                this.f35567w0.setTextSize(1, 16.0f);
                frameLayout.addView(this.f35567w0, w7.a6.k(21.0f, 12.0f, 0.0f, 6.0f, -2, -2));
                ...
                frameLayout.addView(this.Y[i11], w7.a6.k(0.0f, 12.0f, 16.0f, 6.0f, 55, -2));
                ...
                frameLayout.addView(this.Y[i11], w7.a6.k(0.0f, 12.0f, 21.0f, 6.0f, -1, -2));
                this.Y[i11].addTextChangedListener(new es(this, 3));
            } else {
                ...
                frameLayout.addView(this.Y[i11], w7.a6.d(-1, -2.0f, 51, 21.0f, 12.0f, 21.0f, 6.0f));
            }
            this.Y[i11].setOnEditorActionListener(new xl0(this, 0));
            if (i11 == 2) {
                this.Y[i11].setOnKeyListener(new wg(this, 1));
            }
            if (i11 == 0) {
                View view = new View(context);
                this.f35541k0.add(view);
        ...
        org.telegram.ui.Cells.f9 f9Var2 = new org.telegram.ui.Cells.f9(context);
        this.f35546n0 = f9Var2;
        f9Var2.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.j6.f17892b7));
        this.f35546n0.setText(LocaleController.getString(R.string.PassportPhoneUploadInfo));
        this.f35524c0.addView(this.f35546n0, w7.a6.n(-1, -2));
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35521b0, 32768, null, null, null, null, i10));
        ...
        int i11 = 0;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35524c0, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f18049k0, null, null, org.telegram.ui.ActionBar.j6.f17929d7));
        View view = this.S;
        int i12 = org.telegram.ui.ActionBar.j6.f17928d6;
        ...
        int i13 = 0;
        while (true) {
            ArrayList arrayList2 = this.f35541k0;
            if (i13 >= arrayList2.size()) {
                break;
            }
            arrayList.add(new org.telegram.ui.ActionBar.l6((View) arrayList2.get(i13), 1, null, null, null, null, org.telegram.ui.ActionBar.j6.f17929d7));
            i13++;
        }
        for (Map.Entry entry : this.f35547n1.entrySet()) {
            mn0 mn0Var = (mn0) entry.getValue();
            arrayList.add(new org.telegram.ui.ActionBar.l6(mn0Var, 268435456, new Class[]{mn0.class}, null, null, null, org.telegram.ui.ActionBar.j6.f17928d6));
            ...
            arrayList.add(new org.telegram.ui.ActionBar.l6(mn0Var, 0, new Class[]{mn0.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f18325z6));
        }
        int i14 = org.telegram.ui.ActionBar.j6.f17928d6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35524c0, 268435456, new Class[]{org.telegram.ui.Cells.e9.class}, null, null, null, i14));
        int i15 = org.telegram.ui.ActionBar.j6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35524c0, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, i15));
        int i16 = org.telegram.ui.ActionBar.j6.f18325z6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35524c0, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"valueTextView"}, null, null, -1, null, i16));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35524c0, 268435456, new Class[]{org.telegram.ui.Cells.ga.class}, null, null, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35524c0, 0, new Class[]{org.telegram.ui.Cells.ga.class}, new String[]{"textView"}, null, null, -1, null, i15));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35524c0, 0, new Class[]{org.telegram.ui.Cells.ga.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.I6));
        int i17 = org.telegram.ui.ActionBar.j6.f17892b7;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35524c0, 32, new Class[]{org.telegram.ui.Cells.c7.class}, null, null, null, i17));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35524c0, 268435456, new Class[]{nn0.class}, null, null, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35524c0, 4, new Class[]{nn0.class}, new String[]{"textView"}, null, null, -1, null, i15));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35524c0, 4, new Class[]{nn0.class}, null, null, null, org.telegram.ui.ActionBar.j6.f17929d7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35524c0, 4, new Class[]{nn0.class}, new String[]{"valueTextView"}, null, null, -1, null, i16));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35524c0, 8, new Class[]{nn0.class}, new String[]{"checkImageView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.Mh));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35524c0, 16, new Class[]{org.telegram.ui.Cells.m4.class}, null, null, null, i14));
        int i18 = org.telegram.ui.ActionBar.j6.L6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35524c0, 0, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView"}, null, null, -1, null, i18));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35524c0, 32, new Class[]{org.telegram.ui.Cells.f9.class}, null, null, null, i17));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35524c0, 0, new Class[]{org.telegram.ui.Cells.f9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.B6));
        if (this.Y != null) {
            int i19 = 0;
            while (true) {
                EditTextBoldCursor[] editTextBoldCursorArr = this.Y;
                ...
                arrayList.add(new org.telegram.ui.ActionBar.l6((View) editTextBoldCursorArr[i19].getParent(), 1, null, null, null, null, org.telegram.ui.ActionBar.j6.f17928d6));
                ...
                arrayList.add(new org.telegram.ui.ActionBar.l6(this.Y[i19], 32, null, null, null, null, org.telegram.ui.ActionBar.j6.f18055k6));
                arrayList.add(new org.telegram.ui.ActionBar.l6(this.Y[i19], 65568, null, null, null, null, org.telegram.ui.ActionBar.j6.f18073l6));
                arrayList.add(new org.telegram.ui.ActionBar.l6(this.Y[i19], 2080, null, null, null, null, org.telegram.ui.ActionBar.j6.f18144p7));
                i19++;
            }
        } else {
            ...
            arrayList.add(new org.telegram.ui.ActionBar.l6(null, 32, null, null, null, null, org.telegram.ui.ActionBar.j6.f18055k6));
            arrayList.add(new org.telegram.ui.ActionBar.l6(null, 65568, null, null, null, null, org.telegram.ui.ActionBar.j6.f18073l6));
            arrayList.add(new org.telegram.ui.ActionBar.l6(null, 2080, null, null, null, null, org.telegram.ui.ActionBar.j6.f18144p7));
        }
        if (this.f35518a0 != null) {
            while (true) {
                EditTextBoldCursor[] editTextBoldCursorArr2 = this.f35518a0;
                ...
                arrayList.add(new org.telegram.ui.ActionBar.l6((View) editTextBoldCursorArr2[i11].getParent(), 1, null, null, null, null, org.telegram.ui.ActionBar.j6.f17928d6));
                arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35518a0[i11], 16777220, null, null, null, null, org.telegram.ui.ActionBar.j6.G6));
                arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35518a0[i11], 8388608, null, null, null, null, org.telegram.ui.ActionBar.j6.H6));
                arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35518a0[i11], 8390656, null, null, null, null, org.telegram.ui.ActionBar.j6.L6));
                arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35518a0[i11], 32, null, null, null, null, org.telegram.ui.ActionBar.j6.f18055k6));
                arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35518a0[i11], 65568, null, null, null, null, org.telegram.ui.ActionBar.j6.f18073l6));
                arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35518a0[i11], 2080, null, null, null, null, org.telegram.ui.ActionBar.j6.f18144p7));
                i11++;
            }
        }
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.F0, 2048, null, null, null, null, org.telegram.ui.ActionBar.j6.f17999h6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.K0, 4, null, null, null, null, org.telegram.ui.ActionBar.j6.f18180r6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35567w0, 4, null, null, null, null, org.telegram.ui.ActionBar.j6.G6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.O, 4, null, null, null, null, org.telegram.ui.ActionBar.j6.f18228th));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.Q, 32, null, null, null, null, org.telegram.ui.ActionBar.j6.f18191rh));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.Q, 65568, null, null, null, null, org.telegram.ui.ActionBar.j6.f18210sh));
        org.telegram.ui.Components.zq zqVar = this.N;
        ...
        int i23 = org.telegram.ui.ActionBar.j6.f18325z6;
    ...
    public final byte[] i1(byte[] bArr, byte[] bArr2) {
        ...
        byte[] bArr3 = new byte[32];
        System.arraycopy(this.f35529e1, 0, bArr3, 0, 32);
        byte[] bArr4 = new byte[16];
        System.arraycopy(this.f35529e1, 32, bArr4, 0, 16);
        byte[] bArr5 = new byte[32];
        System.arraycopy(this.f35525c1, 0, bArr5, 0, 32);
            ...
            public final void run(TLObject tLObject, final TLRPC.TL_error tL_error) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    public final void run() {
                        ...
                        int i11 = 0;
                        if (on0Var2.f35520b == 8) {
                            nn0 nn0Var = (nn0) on0Var2.f35553q1.remove(tL_secureRequiredType6);
                            if (nn0Var != null) {
                                on0Var2.f35524c0.removeView(nn0Var);
                                View childAt = on0Var2.f35524c0.getChildAt(linearLayout.getChildCount() - 6);
    ...
    public final bi.u6 k1(byte[] bArr) {
        ...
        byte[] bArr6 = new byte[32];
        System.arraycopy(this.f35529e1, 0, bArr6, 0, 32);
        byte[] bArr7 = new byte[16];
        System.arraycopy(this.f35529e1, 32, bArr7, 0, 16);
        byte[] bArr8 = new byte[32];
        System.arraycopy(this.f35525c1, 0, bArr8, 0, 32);
        Utilities.aesCbcEncryptionByteArraySafe(bArr8, bArr6, bArr7, 0, 32, 0, 0);
    ...
    public final String m1() {
        ...
        int size = arrayList.size();
        for (int i12 = 0; i12 < size; i12++) {
            sb2.append(((SecureDocument) arrayList.get(i12)).secureFile.f17330id);
        }
        SecureDocument secureDocument = this.l1;
        if (secureDocument != null) {
            sb2.append(secureDocument.secureFile.f17330id);
        }
        SecureDocument secureDocument2 = this.f35544m1;
        if (secureDocument2 != null) {
            sb2.append(secureDocument2.secureFile.f17330id);
        }
        SecureDocument secureDocument3 = this.f35540j1;
        if (secureDocument3 != null) {
            sb2.append(secureDocument3.secureFile.f17330id);
        }
        ArrayList arrayList2 = this.f35542k1;
        int size2 = arrayList2.size();
        for (int i13 = 0; i13 < size2; i13++) {
            sb2.append(((SecureDocument) arrayList2.get(i13)).secureFile.f17330id);
        }
        return sb2.toString();
    }
    ...
    public final void onActivityResultFragment(int i10, int i11, Intent intent) {
        if (i11 == -1) {
            ...
            org.telegram.ui.Components.yi yiVar = this.R0;
            if (yiVar != null) {
                yiVar.f29378j0.g0(i10, intent, this.Q0);
            }
            this.Q0 = null;
        }
    }
    ...
    public final void onDialogDismiss(Dialog dialog) {
        if (this.f35520b == 3 && Build.VERSION.SDK_INT >= 23 && dialog == this.L1) {
    ...
    public final void onRequestPermissionsResultFragment(int i10, String[] strArr, int[] iArr) {
        ...
        if ((i11 == 1 || i11 == 2) && (yiVar = this.R0) != null) {
            if (i10 == 17) {
                ...
                F1(0);
            } else if (i10 == 22 && iArr != null && iArr.length > 0 && iArr[0] == 0 && (gaVar = this.f35555r0) != null) {
                gaVar.callOnClick();
            }
        } else if (i11 == 3 && i10 == 6) {
    ...
    public final void onResume() {
        ...
        if (this.f35520b == 5 && (viewGroupArr = this.Z) != null && (viewGroup = viewGroupArr[0]) != null && viewGroup.getVisibility() == 0) {
    ...
    public final TLRPC.TL_secureValue r1(TLRPC.TL_secureRequiredType tL_secureRequiredType, boolean z10) {
        ...
        if (tL_secureRequiredType != null) {
            int size = this.f35572y.values.size();
            for (int i10 = 0; i10 < size; i10++) {
                TLRPC.TL_secureValue tL_secureValue = this.f35572y.values.get(i10);
    ...
    public final boolean s1(Class cls) {
        int size = this.f35572y.values.size();
        for (int i10 = 0; i10 < size; i10++) {
            if (this.f35572y.values.get(i10).type.getClass() == cls) {
                return false;
            }
        }
        return true;
    ...
    public on0(int i10, long j3, String str, String str2, String str3, String str4, String str5, TL_account.authorizationForm authorizationform, TL_account.Password password) {
        ...
        try {
            ...
            while (i12 < size) {
                ...
                HashMap hashMap = (HashMap) this.f35563u1.get(o12);
                if (hashMap == null) {
                    hashMap = new HashMap();
                    i11 = size;
                    this.f35563u1.put(o12, hashMap);
                    this.f35565v1.put(o12, str6);
                } else {
                    i11 = size;
                }
                if (bArr != null) {
