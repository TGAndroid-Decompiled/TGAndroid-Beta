...
public final class we implements org.telegram.ui.ActionBar.z1, org.telegram.ui.Components.ml0 {
    public final int f38966a;
    public final long f38967b;
    public final NotificationCenter.NotificationCenterDelegate f38968c;
    public final Object d;
    public final Object e;
    public final Object f38969f;

    public we(Object obj, KeyEvent.Callback callback, Object obj2, long j3, Object obj3, int i10) {
        this.f38966a = i10;
        this.f38968c = (NotificationCenter.NotificationCenterDelegate) obj;
        this.d = callback;
        this.e = obj2;
        this.f38967b = j3;
        this.f38969f = obj3;
    ...
    public void c(final float f7, final float f10, int i10, View view) {
        ...
        long j3;
        int i12 = i10;
        final org.telegram.ui.Components.kv0 kv0Var = (org.telegram.ui.Components.kv0) this.f38968c;
        org.telegram.ui.Components.gs0 gs0Var = (org.telegram.ui.Components.gs0) this.d;
        final Context context = (Context) this.e;
        org.telegram.ui.ActionBar.d6 d6Var = (org.telegram.ui.ActionBar.d6) this.f38969f;
        org.telegram.ui.Components.tt0 tt0Var = kv0Var.Q;
        org.telegram.ui.Components.uu0 uu0Var = kv0Var.R;
        org.telegram.ui.Components.ut0 ut0Var = kv0Var.f25817a0;
        ...
        if (i13 == 7) {
            ...
            org.telegram.ui.Components.bu0 bu0Var = kv0Var.f25840j0;
            if (adapter == bu0Var) {
            ...
            if (i13 == 3 && (view instanceof org.telegram.ui.Cells.n7)) {
                    ...
                    if (m2Var != null) {
                        ...
                        messagesController.getContentSettings(new Utilities.Callback() {
                            ...
                            public final void run(Object obj) {
                                ...
                                org.telegram.ui.ActionBar.m2 m2Var2 = kv0.this.f25866v1;
                                a2Var.c(200L);
                                ...
                                alertDialog$Builder.f18661a.R = LocaleController.getString(R.string.MessageShowSensitiveContentMediaTitle);
                                if (z11) {
                                    i15 = R.string.MessageShowSensitiveContentMediaTextClosed;
                                } else {
                                    i15 = R.string.MessageShowSensitiveContentMediaText;
                                }
                                alertDialog$Builder.f18661a.T = LocaleController.getString(i15);
                                alertDialog$Builder.n(frameLayout);
                                alertDialog$Builder.f18661a.G = 9;
                                if (z11) {
                                    ...
                                    alertDialog$Builder.k(string, new org.telegram.ui.ActionBar.z1() {
                                        ...
                                        public final void f(org.telegram.ui.ActionBar.a2 a2Var3, int i18) {
                                            ...
                                            if (zArr[0]) {
                                                ...
                                                org.telegram.ui.oc ocVar = new org.telegram.ui.oc(28, messagesController2, sr0Var);
                                                if (U == null) {
                                ...
                                if (m2Var2 != null && m2Var2.getContext() != null) {
                                    m2Var2.showDialog(alertDialog$Builder.f18661a);
                                } else {
                ...
                MessageObject messageObject2 = t7Var.f21226n;
                if (messageObject2 != null && messageObject2.hasMediaSpoilers() && t7Var.f21222i0 == 0.0f && !t7Var.f21226n.isMediaSpoilersRevealedInSharedMedia) {
                    t7Var.n(f7, f10);
                ...
                if (i15 == 10) {
                    if (((view instanceof org.telegram.ui.Cells.i6) || f10 < AndroidUtilities.dp(60.0f)) && i12 >= 0 && i12 < tt0Var.d.size()) {
                        ...
                        if (tLObject instanceof TLRPC.Chat) {
                            bundle2.putLong("chat_id", ((TLRPC.Chat) tLObject).f18335id);
                        } else if (tLObject instanceof TLRPC.User) {
                            bundle2.putLong("user_id", ((TLRPC.User) tLObject).f18482id);
                        } else {
                            return;
                        }
                    ...
                    if (gs0Var.h.getAdapter() == vu0Var) {
                        if (i12 >= 0) {
                            ...
                            if (size < arrayList2.size()) {
                                ...
                                m2Var.presentFragment(os0Var);
                            }
                        }
                    } else if (kv0Var.C1) {
                        if (uu0Var.v.f43108y == 0) {
                            uu0Var.E(view);
                        }
                    } else {
                        Bundle bundle5 = new Bundle();
                        if (i12 >= 0 && i12 < uu0Var.f28905f.size()) {
                            bundle5.putLong("user_id", m2Var.getUserConfig().getClientUserId());
                            bundle5.putInt("chatMode", 3);
                            wn wnVar2 = new wn(bundle5);
                            wnVar2.f39450d4 = ((SavedMessagesController.SavedDialog) uu0Var.f28905f.get(i12)).dialogId;
                    ...
                    org.telegram.ui.Components.z70 F = org.telegram.ui.Components.z70.F(gs0Var, d6Var, u1Var);
                    F.f30813c0 = true;
                    ...
                    if (!messageObject5.isPollClosed()) {
                        if (messageObject5.canUnvote()) {
                            F.c(R.drawable.msg_unvote, LocaleController.getString(R.string.Unvote), new org.telegram.ui.Components.kr0(kv0Var, d6Var, currentAccount2, messageObject5), false);
                        }
                        if (!messageObject5.isForwarded() && ((messageObject5.isOut() && (!ChatObject.isChannel(chat2) || chat2.megagroup)) || (ChatObject.isChannel(chat2) && !chat2.megagroup && (chat2.creator || ((tL_chatAdminRights = chat2.admin_rights) != null && tL_chatAdminRights.edit_messages))))) {
                            ...
                            F.c(i16, LocaleController.getString(i11), new org.telegram.ui.Components.kr0(kv0Var, d6Var, messageObject5, currentAccount2), false);
                        }
                    }
                    F.Z();
                }
    ...
    public void f(org.telegram.ui.ActionBar.a2 a2Var, int i10) {
        switch (this.f38966a) {
            case 0:
                wn.S0((wn) this.f38968c, (TLRPC.TL_game) this.d, (MessageObject) this.e, (String) this.f38969f, this.f38967b);
                return;
            default:
                org.telegram.ui.Components.l31 l31Var = (org.telegram.ui.Components.l31) this.f38968c;
                ArrayList arrayList = (ArrayList) this.d;
                HashSet hashSet = (HashSet) this.e;
                org.telegram.ui.Components.th thVar = (org.telegram.ui.Components.th) this.f38969f;
                int size = arrayList.size();
                int i11 = 0;
                while (true) {
                    long j3 = this.f38967b;
                    if (i11 < size) {
                        ...
                        l31Var.f25948e0.addAll(hashSet);
                        l31Var.o();
                        org.telegram.ui.Components.xc.a0(l31Var.h).U(LocaleController.getPluralString("TopicsDeleted", hashSet.size()), false, new org.telegram.ui.Components.x21(l31Var, hashSet, arrayList, j3, 0), new org.telegram.ui.Components.xn0(l31Var, arrayList, thVar, 12)).j();
                        a2Var.dismiss();
                        return;
                    }
                }
    ...
    public we(org.telegram.ui.Components.l31 l31Var, ArrayList arrayList, long j3, HashSet hashSet, org.telegram.ui.Components.th thVar) {
        this.f38966a = 2;
        this.f38968c = l31Var;
        this.d = arrayList;
        this.f38967b = j3;
