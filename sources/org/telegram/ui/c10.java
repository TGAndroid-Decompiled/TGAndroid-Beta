...
public final class c10 extends pg.b {
    ...
    @Override
    public final int h() {
        return this.f34999e.P.size();
    }

    @Override
    public final int j(int i10) {
        w00 w00Var = (w00) this.f34999e.P.get(i10);
        if (w00Var == null) {
            return 3;
        }
        return w00Var.f44098a;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        int i12;
        int i13;
        f10 f10Var = this.f34999e;
        ArrayList arrayList = f10Var.P;
        w00 w00Var = (w00) arrayList.get(i10);
        if (w00Var != null) {
            int i14 = i10 + 1;
            boolean z11 = false;
            if (i14 < arrayList.size() && (i13 = ((w00) arrayList.get(i14)).f44098a) != 3 && i13 != 6) {
                z10 = true;
            } else {
                z10 = false;
            }
            ...
            if (i15 != 0) {
                if (i15 != 1) {
                    ...
                    if (i15 != 4) {
                        switch (i15) {
                            ...
                            case 9:
                                t00 t00Var = (t00) view;
                                f10Var.I = t00Var;
                                t00Var.e(org.telegram.ui.Components.z5.cloneSpans(f10Var.f36257w, -1, t00Var.f40607s.getPaint().getFontMetricsInt(), 0.5f), false);
                            ...
                            case 11:
                                ...
                                t3Var.setText(w00Var.f41760e);
                                t3Var.setOnClickListener(w00Var.f41759c);
                                return;
                            default:
                                return;
                        }
                    ...
                    k00 k00Var = (k00) view;
                    boolean z12 = w00Var.f41766l;
                    ImageView imageView = k00Var.f37896a;
                    TextView textView = k00Var.f37897b;
                    if (z12) {
                        i11 = org.telegram.ui.ActionBar.j6.f20925q7;
                    } else {
                        i11 = org.telegram.ui.ActionBar.j6.f20889o6;
                    }
                    ...
                    int i17 = w00Var.f41765k;
                    CharSequence charSequence = w00Var.d;
                    ImageView imageView2 = k00Var.f37896a;
                    ...
                    Boolean bool = k00Var.f37899e;
                    if (bool == null || bool.booleanValue() != z11) {
                        k00Var.f37899e = Boolean.valueOf(z11);
                        float f10 = 0.0f;
                        if (k00Var.f37898c == i17) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                f10Var.K = f3Var;
                f3Var.f21931n = false;
                org.telegram.ui.Cells.d3 d3Var = f3Var.f21927b;
                ...
                d3Var.setText(f10Var.f36257w);
                i11 = ((org.telegram.ui.ActionBar.n2) f10Var).currentAccount;
                org.telegram.ui.Components.q5.s(i11, f10Var.f36258x);
            ...
            case 4:
                ...
                frameLayout.d = true;
                frameLayout.f37899e = null;
                ImageView imageView = new ImageView(context);
                frameLayout.f37896a = imageView;
            ...
            case 5:
                ...
                frameLayout2.f41402a = imageView2;
            ...
            case 7:
                ...
                zaVar = new b10(this, this.d, f10Var, i14, f10Var.f36255r.f17107id);
                break;
            case 8:
    ...
    public final void y(s4.c1 c1Var) {
        ...
        if (i10 != 2 && i10 == 9) {
            f10 f10Var = this.f34999e;
            ((t00) c1Var.f45766a).e(org.telegram.ui.Components.z5.cloneSpans(f10Var.f36257w, -1, f10Var.I.f40607s.getPaint().getFontMetricsInt(), 0.5f), true);
        }
    }
    ...
    public final void z(s4.c1 c1Var) {
        if (c1Var.f45770f == 2) {
            org.telegram.ui.Cells.f3 f3Var = (org.telegram.ui.Cells.f3) c1Var.f45766a;
            f3Var.f21927b.k(true);
            f3Var.f21927b.d();
        }
    }
}
