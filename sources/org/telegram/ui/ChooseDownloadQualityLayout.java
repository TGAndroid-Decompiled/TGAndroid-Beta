...
public class ChooseDownloadQualityLayout {
    ...
    public ChooseDownloadQualityLayout(Context context, PopupSwipeBackLayout popupSwipeBackLayout, Callback callback) {
    ...
    public boolean update(MessageObject messageObject) {
        ...
        for (int i2 = 0; i2 < qualities.size(); i2++) {
            VideoPlayer.Quality quality = qualities.get(i2);
            ...
            actionBarMenuSubItemAddItem.setOnClickListener(new OAuthSheet$$ExternalSyntheticLambda0(this, messageObject, quality, 10));
            actionBarMenuSubItemAddItem.setSelectorColor(268435455);
        }
        return true;
    }
