...
public final class ro0 implements TextWatcher {
    public final String[] f40213a = {"34", "37"};
    public final String[] f40214b = {"300", "301", "302", "303", "304", "305", "309", "36", "38", "39"};
    public final String[] f40215c = {"2221", "2222", "2223", "2224", "2225", "2226", "2227", "2228", "2229", "2200", "2201", "2202", "2203", "2204", "8600", "9860", "223", "224", "225", "226", "227", "228", "229", "23", "24", "25", "26", "270", "271", "2720", "50", "51", "52", "53", "54", "55", "4", "60", "62", "64", "65", "35"};
    public int d = -1;
    public int f40216e;
    public final xo0 f40217f;
    ...
    public final void afterTextChanged(Editable editable) {
        ...
        int i14 = 1;
        if (this.d == 3) {
            obj = obj.substring(0, this.f40216e) + obj.substring(this.f40216e + 1);
            selectionStart--;
        }
        ...
        if (str2 != null) {
            if (sb2.length() == i17) {
                xo0Var.f42819f[c10].requestFocus();
            }
