...
public final class hf1 implements RequestDelegate {
    public final int f38894a;
    public final TwoStepVerificationActivity f38895b;

    public hf1(TwoStepVerificationActivity twoStepVerificationActivity, int i10) {
        this.f38894a = i10;
        this.f38895b = twoStepVerificationActivity;
    }
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f38894a) {
            case 0:
                final TwoStepVerificationActivity twoStepVerificationActivity = this.f38895b;
                ...
                return;
            case 1:
                final TwoStepVerificationActivity twoStepVerificationActivity2 = this.f38895b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        switch (r4) {
                ...
                return;
            case 2:
                final TwoStepVerificationActivity twoStepVerificationActivity3 = this.f38895b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        String formatPluralString;
                ...
                return;
            case 3:
                final TwoStepVerificationActivity twoStepVerificationActivity4 = this.f38895b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        switch (r4) {
                ...
                return;
            case 4:
                final TwoStepVerificationActivity twoStepVerificationActivity5 = this.f38895b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        switch (r4) {
                ...
                return;
            case 5:
                final TwoStepVerificationActivity twoStepVerificationActivity6 = this.f38895b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        switch (r4) {
                ...
                return;
            default:
                final TwoStepVerificationActivity twoStepVerificationActivity7 = this.f38895b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        switch (r4) {
