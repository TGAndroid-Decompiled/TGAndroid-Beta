...
public final class qv implements DialogInterface.OnClickListener {
    ...
    public final NotificationCenter.NotificationCenterDelegate f36986b;

    public qv(NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, int i10) {
        this.f36985a = i10;
        this.f36986b = notificationCenterDelegate;
    }
    ...
    public final void onClick(DialogInterface dialogInterface, int i10) {
        ...
        switch (this.f36985a) {
            case 0:
                qy qyVar = (qy) this.f36986b;
                if (i10 == 0) {
                    qyVar.getMessagesStorage().readAllDialogs(1);
                    return;
                } else if (i10 != 1 || qyVar.f37021e0 == null) {
                    return;
                } else {
                    while (true) {
                        ...
                        if (i11 < pyVarArr.length) {
                            ...
                            if (pyVar.f36685s == 0 && pyVar.getVisibility() == 0) {
                                org.telegram.ui.Cells.s2 Q3 = qy.Q3(qyVar.f37021e0[i11]);
                                my myVar = qyVar.f37021e0[i11].f36679a;
                                int i12 = my.f35672v3;
                                myVar.z1(true, Q3);
                            }
                            i11++;
