...
public final class po0 implements yf.a0, r0.n, org.telegram.ui.ActionBar.z1 {
    ...
    public void a(int i10) {
        int i11;
        tp0 tp0Var = this.f36588b;
        fh.d dVar = tp0Var.f38175g0;
        ArrayList arrayList = tp0Var.f38179k0;
        ah.h hVar = tp0Var.f38174f0;
        int i12 = Build.VERSION.SDK_INT;
        if (i12 >= 31 && hVar != null) {
            ArrayList arrayList2 = tp0Var.f38178j0;
            if (i12 >= 29 && dVar != null) {
            ...
            hVar.g(a2, arrayList);
            if (hVar.e(tp0Var.f38177i0, tp0Var.d.getWidth(), tp0Var.d.getHeight())) {
                if (dVar != null) {
                    dVar.f();
                }
                Iterator it = tp0Var.f38171d0.iterator();
                while (it.hasNext()) {
