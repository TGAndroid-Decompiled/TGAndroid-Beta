...
public final class k3 extends org.telegram.ui.web.d1 {
    ...
    public final void E(String str, boolean z10) {
        ...
        m3 m3Var = this.S0;
        if (z10) {
            if (m3Var.f38584r == null) {
                j3 j3Var = m3Var.f38581e;
                d3 d3Var = new d3(m3Var.getContext());
                m3Var.f38584r = d3Var;
                j3Var.addView(d3Var, w7.x5.c(-1.0f, -1));
                m3Var.f38584r.h.setOnClickListener(new a(m3Var, 2));
                AndroidUtilities.updateViewVisibilityAnimated(m3Var.f38584r, m3Var.f38583n, 1.0f, false);
            }
            d3 d3Var2 = m3Var.f38584r;
            if (getWebView() != null) {
                str2 = getWebView().getUrl();
            } else {
                str2 = null;
            }
            TextView textView = d3Var2.f35663e;
            ...
            d3Var2.f35664f.setText(str);
            d3 d3Var3 = m3Var.f38584r;
            ...
            d3Var3.b(z11, false);
            m3Var.f38584r.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        }
        d3 d3Var4 = m3Var.f38584r;
        m3Var.f38583n = z10;
    ...
    public final void J(boolean z10, boolean z11) {
        ...
        if (m3Var == i4Var.f37260u0[0]) {
            ...
            if (!k0Var.W && !k0Var.T) {
                ArticleViewer$WindowView articleViewer$WindowView = i4Var.f37246f0;
                if (!articleViewer$WindowView.f21596e && !articleViewer$WindowView.f21597f) {
                    if (!i4Var.J() && i4Var.f37244d0.size() <= 1) {
                        i4Var.f37248h0.setBackButtonCached(false);
                        i4Var.f37248h0.P.f();
                    } else {
                        org.telegram.ui.ActionBar.g2 g2Var = i4Var.f37248h0.M;
                        if (!m3Var.f38585s && i4Var.f37244d0.size() <= 1) {
                            f7 = 1.0f;
                        } else {
                            f7 = 0.0f;
                        }
                        g2Var.c(f7, true);
                        k0 k0Var2 = i4Var.f37248h0;
                        if (!m3Var.f38585s && i4Var.f37244d0.size() <= 1) {
                            z12 = false;
                        } else {
                            z12 = true;
                    ...
                    i4Var.f37248h0.setHasForward(m3Var.v);
                    k0 k0Var3 = i4Var.f37248h0;
    ...
    public final void K(org.telegram.ui.web.z0 z0Var) {
        this.S0.f38581e.setWebView(z0Var);
    }
    ...
    public final void U(String str, boolean z10) {
        ...
        m3 m3Var = this.S0;
        i4 i4Var = m3Var.K;
        if (i4Var.f37248h0 != null && m3Var == i4Var.f37260u0[0] && (h2Var = m3Var.f38588y) != null && h2Var.b() == null) {
            m3Var.f38588y.d(getWebView());
        }
        super.U(str, z10);
    }
}
