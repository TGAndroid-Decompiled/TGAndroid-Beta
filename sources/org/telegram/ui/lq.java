...
public class lq extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int f35870e0;
    public org.telegram.ui.Components.k6 f35871f;
    public int f35872f0;
    public int f35873g0;
    ...
    public int f35890v0;
    public TLRPC.Chat f35891w;
    public int f35892w0;
    public TLRPC.ChatFull f35893x;
    public boolean f35894x0;
    ...
    public lq(long j10, long j11, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights, TLRPC.TL_chatBannedRights tL_chatBannedRights2, String str, int i10, boolean z4, boolean z10, String str2) {
        ...
        this.L0 = z36;
        this.V0 = str2;
        this.f35891w = getMessagesController().getChat(Long.valueOf(this.f35886s));
        this.f35893x = getMessagesController().getChatFull(this.f35886s);
        ...
        this.P = str3;
        this.Q = str3;
        this.C = ChatObject.isCommunity(this.f35891w);
        TLRPC.Chat chat2 = this.f35891w;
        if (chat2 != null) {
            if (ChatObject.isChannel(chat2) && !this.f35891w.megagroup) {
                z34 = true;
            } else {
                z34 = false;
            }
            this.B = z34;
            this.D = ChatObject.isForum(this.f35891w);
            this.K = this.f35891w.admin_rights;
        }
        if (this.K == null) {
            if (i10 == 2 && ((chat = this.f35891w) == null || !chat.creator)) {
                z33 = false;
            } else {
                z33 = true;
            }
    ...
    public static void U(lq lqVar, long j10) {
        if (j10 != 0) {
            lqVar.f35886s = j10;
            lqVar.f35891w = MessagesController.getInstance(lqVar.currentAccount).getChat(Long.valueOf(j10));
            lqVar.r0(true);
        }
    }

    public static void V(lq lqVar, org.telegram.ui.ActionBar.b3 b3Var, View view) {
        Runnable runnable;
    ...
    public static boolean W(lq lqVar, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && "USER_PRIVACY_RESTRICTED".equals(tL_error.text)) {
            if (!ChatObject.isChannel(lqVar.f35891w)) {
                ...
                v0Var.I1(lqVar.f35891w, arrayList, null, null, null);
                v0Var.show();
            }
            return false;
        }
            ...
            if (lqVar.getParentActivity() != null) {
                if ("PASSWORD_HASH_INVALID".equals(tL_error.text)) {
                    if (inputCheckPasswordSRP == null) {
                        ...
                        d2Var.Q = AndroidUtilities.replaceTags(LocaleController.formatString(R.string.EditAdminTransferReadyAlertText, lqVar.f35891w.title, UserObject.getFirstName(user)));
                    ...
                    if ("SRP_ID_INVALID".equals(tL_error.text)) {
                        ConnectionsManager.getInstance(lqVar.currentAccount).sendRequest(new TL_account.getPassword(), new no(2, lqVar, twoStepVerificationActivity), 8);
    ...
    public static void Z(lq lqVar, long j10) {
        long j11;
        TLRPC.User user;
        TLRPC.ChatFull chatFull = lqVar.f35893x;
        if (chatFull != null) {
        ...
        if (j11 != 0) {
            user = lqVar.getMessagesController().getUser(Long.valueOf(j11));
        } else {
            user = null;
        }
        TLRPC.User user2 = user;
        if (user2 != null && j10 != 0 && user2.f19306id != j10) {
            new org.telegram.ui.Components.z30(lqVar.getParentActivity(), lqVar.resourceProvider, user2, lqVar.v, new bq(lqVar, j10, 0)).show();
            return;
        }
        lqVar.f35879n = j10;
        lqVar.f35884r = true;
    ...
    public static void a0(lq lqVar, TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, TwoStepVerificationActivity twoStepVerificationActivity, long j10) {
        if (j10 != 0) {
            lqVar.f35886s = j10;
            lqVar.f35891w = MessagesController.getInstance(lqVar.currentAccount).getChat(Long.valueOf(j10));
    ...
    public final View createView(Context context) {
        ...
        if (this.F || (!this.B && this.f35891w.creator && UserObject.isUserSelf(this.v))) {
            org.telegram.ui.ActionBar.z n10 = this.actionBar.n();
            Drawable mutate = context.getResources().getDrawable(R.drawable.ic_ab_done).mutate();
            int i12 = org.telegram.ui.ActionBar.j6.f20202v8;
            mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, i12, false), PorterDuff.Mode.MULTIPLY));
            this.h = new org.telegram.ui.Components.lr(mutate, new org.telegram.ui.Components.qp(org.telegram.ui.ActionBar.j6.w0(null, i12, false)));
        ...
        y7Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19827a7, false));
        ...
        this.f35867c = kVar;
        kVar.E = 100;
        this.f35865b.setLayoutManager(kVar);
        lh.e1 e1Var2 = this.f35865b;
        kq kqVar = new kq(this, context);
        this.f35863a = kqVar;
        e1Var2.setAdapter(kqVar);
        f2.l lVar = new f2.l();
        if (i11 == 2) {
            this.f35865b.setResetSelectorOnChanged(false);
        }
        lVar.f5807m = false;
        lVar.C = false;
        lVar.o(org.telegram.ui.Components.mr.h);
        lVar.n(350L);
        this.f35865b.setItemAnimator(lVar);
        lh.e1 e1Var3 = this.f35865b;
        if (!LocaleController.isRTL) {
            i10 = 2;
        }
        e1Var3.setVerticalScrollbarPosition(i10);
        frameLayout.addView(this.f35865b, k7.b6.c(-1.0f, -1));
        this.f35865b.o1();
        this.actionBar.setAdaptiveBackground(this.f35865b);
        this.f35865b.setOnScrollListener(new n3(this, 6));
        this.f35865b.setOnItemClickListener(new gg.v0(8, this, context));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.chatInfoDidLoad) {
            ...
            TLRPC.Chat chat = this.f35891w;
            if (chat != null && chatFull.f19160id == chat.f19159id) {
                this.f35893x = chatFull;
                n0();
            }
        } else if (i10 == NotificationCenter.dialogDeleted) {
            if ((-this.f35886s) == ((Long) objArr[0]).longValue()) {
    ...
    public final ArrayList getThemeDescriptions() {
        ArrayList arrayList = new ArrayList();
        f fVar = new f(this, 9);
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35865b, 16, new Class[]{org.telegram.ui.Cells.ta.class, org.telegram.ui.Cells.z9.class, org.telegram.ui.Cells.q8.class, org.telegram.ui.Cells.l4.class, org.telegram.ui.Cells.x8.class, org.telegram.ui.Cells.b6.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19881d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35865b, 32768, null, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35865b, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f19971i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35865b, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f20000k0, null, null, org.telegram.ui.ActionBar.j6.f19882d7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35865b, 0, new Class[]{org.telegram.ui.Cells.z8.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.B6));
        int i11 = org.telegram.ui.ActionBar.j6.f20097p7;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35865b, 262144, new Class[]{org.telegram.ui.Cells.z9.class}, new String[]{"textView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.j6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35865b, 262144, new Class[]{org.telegram.ui.Cells.z9.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35865b, 0, new Class[]{org.telegram.ui.Cells.z9.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.I6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35865b, 0, new Class[]{org.telegram.ui.Cells.z9.class}, new String[]{"valueImageView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f20042m6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35865b, 0, new Class[]{org.telegram.ui.Cells.x8.class}, new String[]{"textView"}, null, null, -1, null, i12));
        int i13 = org.telegram.ui.ActionBar.j6.f20273z6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35865b, 0, new Class[]{org.telegram.ui.Cells.x8.class}, new String[]{"valueTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35865b, 0, new Class[]{org.telegram.ui.Cells.q8.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35865b, 0, new Class[]{org.telegram.ui.Cells.q8.class}, new String[]{"valueTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35865b, 0, new Class[]{org.telegram.ui.Cells.q8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.U6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35865b, 0, new Class[]{org.telegram.ui.Cells.q8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.V6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35865b, 0, new Class[]{org.telegram.ui.Cells.l4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.L6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35865b, 262144, new Class[]{org.telegram.ui.Cells.l4.class}, new String[]{"textView2"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35865b, 262144, new Class[]{org.telegram.ui.Cells.l4.class}, new String[]{"textView2"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.A6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35865b, 4, new Class[]{org.telegram.ui.Cells.b6.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35865b, 8388608, new Class[]{org.telegram.ui.Cells.b6.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.H6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35865b, 0, new Class[]{org.telegram.ui.Cells.ta.class}, new String[]{"nameTextView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35865b, 0, new Class[]{org.telegram.ui.Cells.ta.class}, new String[]{"statusColor"}, null, null, -1, fVar, org.telegram.ui.ActionBar.j6.f20256y6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35865b, 0, new Class[]{org.telegram.ui.Cells.ta.class}, new String[]{"statusOnlineColor"}, null, null, -1, fVar, org.telegram.ui.ActionBar.j6.f20060n6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35865b, 0, new Class[]{org.telegram.ui.Cells.ta.class}, null, org.telegram.ui.ActionBar.j6.f20126r0, null, org.telegram.ui.ActionBar.j6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, new Class[]{org.telegram.ui.Cells.s2.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19987j5));
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, new Class[]{org.telegram.ui.Cells.s2.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f20114q5));
        ...
        if (i10 != 2) {
            ...
            if (!equals) {
                if (z4) {
                    ...
                    org.telegram.ui.ActionBar.d2 d2Var = alertDialog$Builder.f19478a;
                    d2Var.O = string;
                    d2Var.Q = AndroidUtilities.replaceTags(LocaleController.formatString("UserRestrictionsApplyChangesText", R.string.UserRestrictionsApplyChangesText, MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(this.f35886s)).title));
    ...
    public final void n0() {
        ...
        TLRPC.User user;
        long j10;
        int i10 = this.f35874h0;
        if (i10 >= 0) {
            org.telegram.ui.Cells.q8 q8Var = (org.telegram.ui.Cells.q8) this.f35867c.m(i10);
            if (q8Var != null) {
                TLRPC.ChatFull chatFull = this.f35893x;
    ...
    public final void p0(TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, TwoStepVerificationActivity twoStepVerificationActivity) {
        ...
        if (inputCheckPasswordSRP != null && !ChatObject.isChannel(this.f35891w)) {
            MessagesController.getInstance(this.currentAccount).convertToMegaGroup(getParentActivity(), this.f35886s, this, new f7(this, inputCheckPasswordSRP, twoStepVerificationActivity, 10));
            return;
        }
        TLRPC.TL_channels_editCreator tL_channels_editCreator = new TLRPC.TL_channels_editCreator();
        if (ChatObject.isChannel(this.f35891w)) {
    ...
    public final void t0(boolean z4) {
        ...
        if (lrVar != null) {
            ...
            this.Y0.setDuration(Math.abs(this.h.f26868c - (this.E ? 1.0f : 0.0f)) * 150.0f);
            this.Y0.start();
        }
    }
    ...
    public final void u0(boolean z4) {
        int i10;
        int min = Math.min(this.f35882p0, this.f35883q0);
        this.T = -1;
        this.U = -1;
        this.V = -1;
        this.W = -1;
        ...
        if (z13) {
            ...
            if (!z11 && (!this.P.isEmpty() || (this.f35891w.creator && UserObject.isUserSelf(user)))) {
                int i32 = this.S;
                this.f35878l0 = i32;
                this.S = i32 + 2;
                this.f35887s0 = i32 + 1;
                if (this.f35891w.creator && UserObject.isUserSelf(user)) {
                    int i33 = this.S;
                    this.S = i33 + 1;
                    this.f35888t0 = i33;
                } else {
        ...
        if (z4) {
            if (min == -1 && (i10 = this.f35882p0) != -1) {
                this.f35863a.s(Math.min(i10, this.f35883q0), 2);
            } else if (min != -1 && this.f35882p0 == -1) {
                this.f35863a.t(min, 2);
            }
        }
    }
}
