...
public class lq extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public kq f35040a;
    public int f35041a0;
    public final boolean f35042a1;
    public ai.w0 f35043b;
    public int f35044b0;
    public ValueAnimator f35045b1;
    public gg.b0 f35046c;
    public int f35047c0;
    public ValueAnimator f35048c1;
    public FrameLayout d;
    public int f35049d0;
    public FrameLayout e;
    public int f35050e0;
    public org.telegram.ui.Components.p6 f35051f;
    public int f35052f0;
    public int f35053g0;
    ...
    public int f35070v0;
    public TLRPC.Chat f35071w;
    public int f35072w0;
    public TLRPC.ChatFull f35073x;
    public int f35074x0;
    public final int f35075y;
    public int f35076y0;
    public int f35077z0;
    ...
    public lq(long j3, long j10, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights, TLRPC.TL_chatBannedRights tL_chatBannedRights2, String str, int i10, boolean z10, boolean z11, String str2) {
        ...
        this.O0 = z37;
        this.Y0 = str2;
        this.f35071w = getMessagesController().getChat(Long.valueOf(this.f35066s));
        this.f35073x = getMessagesController().getChatFull(this.f35066s);
        ...
        this.S = str3;
        this.T = str3;
        this.F = ChatObject.isCommunity(this.f35071w);
        TLRPC.Chat chat2 = this.f35071w;
        if (chat2 != null) {
            if (ChatObject.isChannel(chat2) && !this.f35071w.megagroup) {
                z35 = true;
            } else {
                z35 = false;
            }
            this.E = z35;
            this.G = ChatObject.isForum(this.f35071w);
            this.N = this.f35071w.admin_rights;
        }
        if (this.N == null) {
            if (i10 == 2 && ((chat = this.f35071w) == null || !chat.creator)) {
                z34 = false;
            } else {
                z34 = true;
            }
    ...
    public static void U(lq lqVar, long j3) {
        if (j3 != 0) {
            lqVar.f35066s = j3;
            lqVar.f35071w = MessagesController.getInstance(lqVar.currentAccount).getChat(Long.valueOf(j3));
            lqVar.r0(true);
        }
    }

    public static void V(lq lqVar, org.telegram.ui.ActionBar.a3 a3Var, View view) {
        Runnable runnable;
                ...
                if (intValue != 2) {
                    if (intValue != 3) {
                        if (intValue == 4) {
                            ...
                            try {
                                DatePickerDialog datePickerDialog = new DatePickerDialog(lqVar.getParentActivity(), new DatePickerDialog.OnDateSetListener() {
                                    @Override
                                    public final void onDateSet(DatePicker datePicker, int i10, int i11, int i12) {
                                        ...
                                        try {
                                            TimePickerDialog timePickerDialog = new TimePickerDialog(lqVar2.getParentActivity(), new TimePickerDialog.OnTimeSetListener() {
                                                @Override
                                                public final void onTimeSet(TimePicker timePicker, int i13, int i14) {
                                                    lq lqVar3 = lq.this;
                                                    lqVar3.O.until_date = (i14 * 60) + (i13 * 3600) + time;
                                                    lqVar3.f35040a.m(lqVar3.M0);
                                                }
                                            }, 0, 0, true);
    ...
    public static boolean W(lq lqVar, TLRPC.TL_error tL_error) {
        lqVar.t0(false);
        if (tL_error != null && "USER_PRIVACY_RESTRICTED".equals(tL_error.text)) {
            if (!ChatObject.isChannel(lqVar.f35071w)) {
                ...
                j0Var.I1(lqVar.f35071w, arrayList, null, null, null);
                j0Var.show();
            }
            return false;
        }
    ...
    public static void X(org.telegram.ui.lq r23, android.content.Context r24, android.view.View r25, int r26) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.lq.X(org.telegram.ui.lq, android.content.Context, android.view.View, int):void");
    }
            ...
            if (lqVar.getParentActivity() != null) {
                if ("PASSWORD_HASH_INVALID".equals(tL_error.text)) {
                    if (inputCheckPasswordSRP == null) {
                        ...
                        b2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString(R.string.EditAdminTransferReadyAlertText, lqVar.f35071w.title, UserObject.getFirstName(user)));
                        alertDialog$Builder.k(LocaleController.getString(R.string.EditAdminTransferChangeOwner), new aq(lqVar, 5));
                    ...
                    if ("SRP_ID_INVALID".equals(tL_error.text)) {
                        ConnectionsManager.getInstance(lqVar.currentAccount).sendRequest(new TL_account.getPassword(), new mo(2, lqVar, twoStepVerificationActivity), 8);
    ...
    public static void Z(lq lqVar, long j3) {
        long j10;
        TLRPC.User user;
        TLRPC.ChatFull chatFull = lqVar.f35073x;
        if (chatFull != null) {
        ...
        if (j10 != 0) {
            user = lqVar.getMessagesController().getUser(Long.valueOf(j10));
        } else {
            user = null;
        }
        TLRPC.User user2 = user;
        if (user2 != null && j3 != 0 && user2.f18230id != j3) {
            new org.telegram.ui.Components.x30(lqVar.getParentActivity(), lqVar.resourceProvider, user2, lqVar.v, new bq(lqVar, j3, 0)).show();
            return;
        }
        lqVar.f35059n = j3;
        lqVar.f35064r = true;
    ...
    public static void a0(lq lqVar, TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, TwoStepVerificationActivity twoStepVerificationActivity, long j3) {
        if (j3 != 0) {
            lqVar.f35066s = j3;
            lqVar.f35071w = MessagesController.getInstance(lqVar.currentAccount).getChat(Long.valueOf(j3));
    ...
    public final View createView(Context context) {
        ...
        if (this.I || (!this.E && this.f35071w.creator && UserObject.isUserSelf(this.v))) {
            org.telegram.ui.ActionBar.z n10 = this.actionBar.n();
            Drawable mutate = context.getResources().getDrawable(R.drawable.ic_ab_done).mutate();
            int i12 = org.telegram.ui.ActionBar.h6.f19120v8;
            mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.w0(null, i12, false), PorterDuff.Mode.MULTIPLY));
            this.h = new org.telegram.ui.Components.qr(mutate, new org.telegram.ui.Components.up(org.telegram.ui.ActionBar.h6.w0(null, i12, false)));
        ...
        u7Var.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18733a7, false));
        ...
        this.f35046c = b0Var;
        b0Var.E = 100;
        this.f35043b.setLayoutManager(b0Var);
        ai.w0 w0Var2 = this.f35043b;
        kq kqVar = new kq(this, context);
        this.f35040a = kqVar;
        w0Var2.setAdapter(kqVar);
        s4.j jVar = new s4.j();
        if (i11 == 2) {
            this.f35043b.setResetSelectorOnChanged(false);
        }
        jVar.f42662m = false;
        jVar.C = false;
        jVar.o(org.telegram.ui.Components.rr.h);
        jVar.n(350L);
        this.f35043b.setItemAnimator(jVar);
        ai.w0 w0Var3 = this.f35043b;
        if (!LocaleController.isRTL) {
            i10 = 2;
        }
        w0Var3.setVerticalScrollbarPosition(i10);
        frameLayout.addView(this.f35043b, w7.x5.c(-1.0f, -1));
        this.f35043b.p1();
        this.actionBar.setAdaptiveBackground(this.f35043b);
        this.f35043b.setOnScrollListener(new i3(this, 6));
        this.f35043b.setOnItemClickListener(new ai.n6(7, this, context));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.chatInfoDidLoad) {
            ...
            TLRPC.Chat chat = this.f35071w;
            if (chat != null && chatFull.f18084id == chat.f18083id) {
                this.f35073x = chatFull;
                n0();
            }
        } else if (i10 == NotificationCenter.dialogDeleted) {
            if ((-this.f35066s) == ((Long) objArr[0]).longValue()) {
    ...
    public final ArrayList getThemeDescriptions() {
        ArrayList arrayList = new ArrayList();
        e eVar = new e(this, 9);
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35043b, 16, new Class[]{org.telegram.ui.Cells.ab.class, org.telegram.ui.Cells.fa.class, org.telegram.ui.Cells.w8.class, org.telegram.ui.Cells.m4.class, org.telegram.ui.Cells.d9.class, org.telegram.ui.Cells.d6.class}, null, null, null, org.telegram.ui.ActionBar.h6.f18789d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35043b, 32768, null, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35043b, 4096, null, null, null, null, org.telegram.ui.ActionBar.h6.f18878i6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35043b, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.h6.f18910k0, null, null, org.telegram.ui.ActionBar.h6.f18790d7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35043b, 0, new Class[]{org.telegram.ui.Cells.f9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.B6));
        int i11 = org.telegram.ui.ActionBar.h6.f19008p7;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35043b, 262144, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"textView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.h6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35043b, 262144, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35043b, 0, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.I6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35043b, 0, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"valueImageView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f18953m6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35043b, 0, new Class[]{org.telegram.ui.Cells.d9.class}, new String[]{"textView"}, null, null, -1, null, i12));
        int i13 = org.telegram.ui.ActionBar.h6.f19189z6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35043b, 0, new Class[]{org.telegram.ui.Cells.d9.class}, new String[]{"valueTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35043b, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35043b, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"valueTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35043b, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.U6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35043b, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.V6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35043b, 0, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.L6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35043b, 262144, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView2"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35043b, 262144, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView2"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.A6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35043b, 4, new Class[]{org.telegram.ui.Cells.d6.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35043b, 8388608, new Class[]{org.telegram.ui.Cells.d6.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.H6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35043b, 0, new Class[]{org.telegram.ui.Cells.ab.class}, new String[]{"nameTextView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35043b, 0, new Class[]{org.telegram.ui.Cells.ab.class}, new String[]{"statusColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.h6.f19170y6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35043b, 0, new Class[]{org.telegram.ui.Cells.ab.class}, new String[]{"statusOnlineColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.h6.f18973n6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35043b, 0, new Class[]{org.telegram.ui.Cells.ab.class}, null, org.telegram.ui.ActionBar.h6.f19038r0, null, org.telegram.ui.ActionBar.h6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(null, 0, new Class[]{org.telegram.ui.Cells.t2.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f18895j5));
        arrayList.add(new org.telegram.ui.ActionBar.j6(null, 0, new Class[]{org.telegram.ui.Cells.t2.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f19025q5));
        ...
        if (i10 != 2) {
            ...
            if (!equals) {
                if (z10) {
                    ...
                    org.telegram.ui.ActionBar.b2 b2Var = alertDialog$Builder.f18409a;
                    b2Var.R = string;
                    b2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString("UserRestrictionsApplyChangesText", R.string.UserRestrictionsApplyChangesText, MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(this.f35066s)).title));
                    alertDialog$Builder.k(LocaleController.getString(R.string.ApplyTheme), new aq(this, 0));
    ...
    public final void n0() {
        ...
        TLRPC.User user;
        long j3;
        int i10 = this.f35057k0;
        if (i10 >= 0) {
            org.telegram.ui.Cells.w8 w8Var = (org.telegram.ui.Cells.w8) this.f35046c.m(i10);
            if (w8Var != null) {
                TLRPC.ChatFull chatFull = this.f35073x;
    ...
    public final void p0(TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, TwoStepVerificationActivity twoStepVerificationActivity) {
        ...
        if (inputCheckPasswordSRP != null && !ChatObject.isChannel(this.f35071w)) {
            MessagesController.getInstance(this.currentAccount).convertToMegaGroup(getParentActivity(), this.f35066s, this, new b7(this, inputCheckPasswordSRP, twoStepVerificationActivity, 10));
            return;
        }
        TLRPC.TL_channels_editCreator tL_channels_editCreator = new TLRPC.TL_channels_editCreator();
        if (ChatObject.isChannel(this.f35071w)) {
    ...
    public final void r0(boolean r20) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.lq.r0(boolean):void");
    }

    public final void t0(boolean z10) {
        float f7;
        ValueAnimator valueAnimator = this.f35045b1;
        ...
        if (qrVar != null) {
            ...
            this.f35045b1 = ofFloat;
            ofFloat.addUpdateListener(new cq(this, 0));
            this.f35045b1.addListener(new u4(this, 24));
            this.f35045b1.setDuration(Math.abs(this.h.f27437c - (this.H ? 1.0f : 0.0f)) * 150.0f);
            this.f35045b1.start();
        }
    }
    ...
    public final void u0(boolean z10) {
        int i10;
        int min = Math.min(this.f35067s0, this.f35068t0);
        this.W = -1;
        this.X = -1;
        this.Y = -1;
        this.Z = -1;
        ...
        if (z14) {
            ...
            if (!z12 && (!this.S.isEmpty() || (this.f35071w.creator && UserObject.isUserSelf(user)))) {
                int i32 = this.V;
                this.f35061o0 = i32;
                this.V = i32 + 2;
                this.f35070v0 = i32 + 1;
                if (this.f35071w.creator && UserObject.isUserSelf(user)) {
                    int i33 = this.V;
                    this.V = i33 + 1;
                    this.f35072w0 = i33;
                } else {
        ...
        if (z10) {
            if (min == -1 && (i10 = this.f35067s0) != -1) {
                this.f35040a.s(Math.min(i10, this.f35068t0), 2);
            } else if (min != -1 && this.f35067s0 == -1) {
                this.f35040a.t(min, 2);
            }
        }
    }
}
