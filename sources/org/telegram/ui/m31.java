...
public final class m31 extends FrameLayout {
    public final org.telegram.ui.Components.m5 f35680a;
    public final n31 f35681b;
    ...
    public m31(n31 n31Var, Context context) {
        ...
        this.f35680a = new org.telegram.ui.Components.m5(AndroidUtilities.dp(24.0f), this);
    }

    public final void a(boolean z10) {
        n31 n31Var = this.f35681b;
        String doubleTapReaction = MediaDataController.getInstance(n31.Y(n31Var)).getDoubleTapReaction();
        org.telegram.ui.Components.m5 m5Var = this.f35680a;
    ...
    public final void b() {
        int width = getWidth();
        org.telegram.ui.Components.m5 m5Var = this.f35680a;
        m5Var.setBounds((width - m5Var.f26060s) - AndroidUtilities.dp(21.0f), (getHeight() - m5Var.f26060s) / 2, getWidth() - AndroidUtilities.dp(21.0f), (getHeight() + m5Var.f26060s) / 2);
    }
