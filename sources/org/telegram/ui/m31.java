...
public final class m31 extends FrameLayout {
    public final org.telegram.ui.Components.o5 f38589a;
    public final n31 f38590b;
    ...
    public m31(n31 n31Var, Context context) {
        ...
        this.f38589a = new org.telegram.ui.Components.o5(AndroidUtilities.dp(24.0f), this);
    }

    public final void a(boolean z10) {
        n31 n31Var = this.f38590b;
        String doubleTapReaction = MediaDataController.getInstance(n31.Y(n31Var)).getDoubleTapReaction();
        org.telegram.ui.Components.o5 o5Var = this.f38589a;
    ...
    public final void b() {
        int width = getWidth();
        org.telegram.ui.Components.o5 o5Var = this.f38589a;
        o5Var.setBounds((width - o5Var.f28991s) - AndroidUtilities.dp(21.0f), (getHeight() - o5Var.f28991s) / 2, getWidth() - AndroidUtilities.dp(21.0f), (getHeight() + o5Var.f28991s) / 2);
    }
