...
public final class k9 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate, dh0 {
    ...
    public final gh.d f37990a0;
    public h9 f37991b;
    public final bh.b f37992b0;
    public s4.c0 f37993c;
    public bh.l f37994c0;
    public org.telegram.ui.Components.d61 d;
    public final ArrayList f37995d0;
    public org.telegram.ui.Components.ok0 f37996e;
    public final RectF f37997e0;
    public org.telegram.ui.Components.y10 f37998f;
    public final RectF f37999f0;
    public org.telegram.ui.Components.t00 h;
    public w8 f38000n;
    public di.r6 f38001r;
    public di.f4 f38002s;
    public boolean v;
    public boolean f38003w;
    public ImageView f38004x;
    public NumberTextView f38005y;
    ...
    public static void U(k9 k9Var) {
        ...
        ImageView imageView = k9Var.f38004x;
        if (imageView != null) {
            imageView.setColorFilter(new PorterDuffColorFilter(k9Var.getThemedColor(org.telegram.ui.ActionBar.j6.f21072y8), PorterDuff.Mode.MULTIPLY));
            k9Var.f38004x.setBackground(org.telegram.ui.ActionBar.j6.f0(k9Var.getThemedColor(org.telegram.ui.ActionBar.j6.f21091z8), 1, -1));
        }
    ...
    public static void X(k9 k9Var, org.telegram.ui.Components.h51 h51Var, View view) {
        ...
        if (i10 == 2) {
            ...
            if (obj instanceof g9) {
                g9 g9Var = (g9) obj;
                ArrayList arrayList = g9Var.f36630c;
                if (k9Var.actionBar.s()) {
                    k9Var.e0(arrayList, (f9) view);
                } else if (g9Var.f36628a != 0 && !arrayList.isEmpty()) {
                    boolean z10 = g9Var.f36631e;
                    HashSet hashSet = new HashSet();
                    ArrayList arrayList2 = g9Var.f36629b;
                ...
                bundle2.putLong("chat_id", ((j9) view).f37727c.f19896id);
                k9Var.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.closeChats, new Object[0]);
    ...
    public static void o0(final Context context, int i10, TLRPC.InputGroupCall inputGroupCall, String str, final org.telegram.ui.ActionBar.f6 f6Var, boolean z10, final boolean z11) {
        String str2;
        int i11;
        int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20762h5, f6Var);
        ...
        int v03 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f21070y6, f6Var);
        ...
        int i14 = org.telegram.ui.ActionBar.j6.f20635a7;
        ...
        imageView3.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20943r5, f6Var), mode));
        ...
        if (z10) {
            ...
            a9Var.setGravity(17);
            a9Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f21089z6, f6Var));
        ...
        frameLayout3.setOnClickListener(new View.OnClickListener() {
            ...
            public final void onClick(View view) {
                ...
                org.telegram.messenger.vl.o(i15, ycVar);
            }
        });
    ...
    public final View createView(Context context) {
        ...
        this.d.o1();
        this.d.Y2.f31163r = false;
        this.f38000n = new w8(this, context, 0);
        ih.k kVar = new ih.k(this.f38000n);
        w8 w8Var = this.f38000n;
        bh.b bVar = this.f37992b0;
        bVar.d = kVar;
        bVar.f2680e = w8Var;
        org.telegram.ui.Components.d61 d61Var2 = this.d;
        Objects.requireNonNull(d61Var2);
        this.f37994c0 = new bh.l(d61Var2, w8Var, new v8(d61Var2, 0));
        this.d.C0(new j8(this, 6));
        w8 w8Var2 = this.f38000n;
        ...
        this.h.f30493w = false;
        h9 h9Var = new h9(this, context, this.h);
        this.f37991b = h9Var;
        this.f38000n.addView(h9Var, w7.x5.c(-1.0f, -1));
        this.d.setClipToPadding(false);
        this.d.setEmptyView(this.f37991b);
        ...
        org.telegram.ui.Components.ok0 ok0Var = new org.telegram.ui.Components.ok0(this.d, this.f37993c);
        this.f37996e = ok0Var;
        ok0Var.h = new k8(this);
        w8 w8Var3 = this.f38000n;
        org.telegram.ui.Components.d61 d61Var5 = this.d;
        float f7 = -this.f37989a;
        ...
        this.f37998f = y10Var;
        y10Var.f32840c.setImageResource(R.drawable.filled_calls_plus);
        this.f37998f.setContentDescription(LocaleController.getString(R.string.Call));
        this.f37998f.setOnClickListener(new n8(this, 3));
        this.f38000n.addView(this.f37998f, org.telegram.ui.Components.y10.b());
        ...
        y8 y8Var = new y8(this, context, this, this.f38000n, this.resourceProvider, 0);
        this.O = y8Var;
        this.N.addView(y8Var);
        this.M.setCallFragmentContextView(this.O);
        this.f38000n.addView(this.M, w7.x5.d(-1, -2.0f, 48, 0.0f, -14.0f, 0.0f, 0.0f));
        this.f38000n.addView(this.actionBar);
        di.r6 r6Var = new di.r6(context, this.parentLayout);
        this.f38001r = r6Var;
        r6Var.b(false, false);
        this.f38000n.addView(this.f38001r, w7.x5.e(-1, 5, 48));
        this.actionBar.setDrawBlurBackground(this.f38000n);
    ...
    public final void e0(ArrayList arrayList, f9 f9Var) {
        ...
        if (l02) {
            ...
            org.telegram.ui.Components.mp mpVar = f9Var.f36370e;
            if (mpVar != null) {
                mpVar.a(false, true);
            }
            q0();
        ...
        org.telegram.ui.Components.mp mpVar2 = f9Var.f36370e;
        if (mpVar2 != null) {
            mpVar2.a(true, true);
        }
        q0();
    ...
    public final void f0() {
        ...
        if (Build.VERSION.SDK_INT >= 31 && (fVar = this.Y) != null) {
            ...
            this.f37997e0.set(0.0f, -dp, this.fragmentView.getMeasuredWidth(), this.actionBar.getMeasuredHeight() + dp);
            RectF rectF = this.f37999f0;
            ...
            fVar.g(i10, this.f37995d0);
            fVar.e(this.f37994c0, this.fragmentView.getMeasuredWidth(), this.fragmentView.getMeasuredHeight());
        }
    }

    public final void g0() {
        this.f37998f.setTranslationY(((-this.W) - this.U) - this.V);
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37991b, 4, new Class[]{h9.class}, new String[]{"emptyTextView1"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.G6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37991b, 4, new Class[]{h9.class}, new String[]{"emptyTextView2"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f20674c7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{org.telegram.ui.Cells.r4.class}, new String[]{"progressBar"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f20763h6));
        ...
        org.telegram.ui.Components.y10 y10Var = this.f37998f;
        if (y10Var != null) {
            arrayList.add(new org.telegram.ui.ActionBar.l6(y10Var.f32840c, 8, null, null, null, null, org.telegram.ui.ActionBar.j6.O9));
            arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37998f.f32840c, 32, null, null, null, null, org.telegram.ui.ActionBar.j6.P9));
            arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37998f.f32840c, 65568, null, null, null, null, org.telegram.ui.ActionBar.j6.Q9));
        }
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{f9.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f20776i1}, null, org.telegram.ui.ActionBar.j6.A9));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{f9.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f20723f1}, null, org.telegram.ui.ActionBar.j6.f21092z9));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{f9.class}, org.telegram.ui.ActionBar.j6.P0, null, null, org.telegram.ui.ActionBar.j6.f20907p6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{f9.class}, null, org.telegram.ui.ActionBar.j6.f20938r0, null, org.telegram.ui.ActionBar.j6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{View.class}, null, new Drawable[]{null, null, org.telegram.ui.ActionBar.j6.W4, org.telegram.ui.ActionBar.j6.Y4}, null, org.telegram.ui.ActionBar.j6.f20945r7));
    ...
    public final void i0() {
        ...
        this.f37991b.setPadding(0, 0, 0, this.W + this.T);
    }
    ...
    public final void k0(boolean z10) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if ((childAt instanceof f9) && (mpVar = ((f9) childAt).f36370e) != null) {
                mpVar.a(false, z10);
            }
        }
        this.d.Y2.N(true);
    ...
    public final void onBecomeFullyVisible() {
        ...
        if (!this.S && getUserConfig().showCallsTab && MessagesController.getGlobalMainSettings().getInt("hidecallshint", 0) < 2) {
            ...
            f4Var.d = 3000L;
            f4Var.l(1.0f, -25.0f);
            this.f38002s.setPadding(0, AndroidUtilities.dp(4.0f), 0, 0);
            this.f38002s.s(AndroidUtilities.replaceTags(LocaleController.getString(R.string.TapToHideCallsTab)));
            this.f38000n.addView(this.f38002s, w7.x5.e(-1, 80, 48));
            this.f38002s.setTranslationY((org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight) - AndroidUtilities.dp(16.0f));
            this.f38002s.u();
            this.S = true;
    ...
    public final boolean onFragmentCreate() {
        ...
        if (bundle != null) {
            ...
            this.f38003w = this.arguments.getBoolean("hasMainTabs", false);
        }
        if (this.f38003w) {
    ...
    public final void q0() {
        ...
        if (s10) {
            ...
            if (!a2) {
                ...
                if (this.f38003w) {
                    ...
                    this.f38004x = imageView;
                    imageView.setScaleType(ImageView.ScaleType.CENTER);
                    this.f38004x.setImageDrawable(new org.telegram.ui.ActionBar.g2(true));
                    this.f38004x.setColorFilter(new PorterDuffColorFilter(getThemedColor(org.telegram.ui.ActionBar.j6.f21072y8), PorterDuff.Mode.MULTIPLY));
                    this.f38004x.setBackground(org.telegram.ui.ActionBar.j6.f0(getThemedColor(org.telegram.ui.ActionBar.j6.f21091z8), 1, -1));
                    this.f38004x.setOnClickListener(new n8(this, 1));
                    j3.addView(this.f38004x, w7.x5.q(54, 54, 16));
                    arrayList2.add(this.f38004x);
                }
                NumberTextView numberTextView = new NumberTextView(j3.getContext());
                this.f38005y = numberTextView;
                numberTextView.setTextSize(18);
                this.f38005y.setTypeface(AndroidUtilities.bold());
                this.f38005y.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f21072y8, false));
                NumberTextView numberTextView2 = this.f38005y;
                if (this.f38003w) {
                    i10 = 18;
                } else {
                    i10 = 72;
                ...
                this.f38005y.setOnTouchListener(new ci.d(2));
        ...
        this.f38005y.a(arrayList.size(), z10);
    }

    @Override
    public final void r() {
        if (this.f37993c.L0() < 15) {
            this.d.x0(0);
            return;
        }
        org.telegram.ui.Components.ok0 ok0Var = this.f37996e;
        ok0Var.f29126b = 1;
    ...
    public k9(Bundle bundle) {
        ...
        this.X = new Rect();
        ArrayList arrayList = new ArrayList();
        this.f37995d0 = arrayList;
        RectF rectF = new RectF();
        this.f37997e0 = rectF;
        RectF rectF2 = new RectF();
        this.f37999f0 = rectF2;
        arrayList.add(rectF);
        arrayList.add(rectF2);
        gh.c cVar = new gh.c();
        cVar.a(getThemedColor(org.telegram.ui.ActionBar.j6.f20635a7));
        if (i10 >= 31) {
