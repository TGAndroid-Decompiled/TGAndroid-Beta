...
public final class k9 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate, dh0 {
    ...
    public final fh.d f35060a0;
    public h9 f35061b;
    public final ah.c f35062b0;
    public s4.c0 f35063c;
    public ah.n f35064c0;
    public org.telegram.ui.Components.e61 d;
    public final ArrayList f35065d0;
    public org.telegram.ui.Components.ok0 e;
    public final RectF f35066e0;
    public org.telegram.ui.Components.y10 f35067f;
    public final RectF f35068f0;
    public org.telegram.ui.Components.t00 h;
    public w8 f35069n;
    public ci.s6 f35070r;
    public ci.f4 f35071s;
    public boolean v;
    public boolean f35072w;
    public ImageView f35073x;
    public NumberTextView f35074y;
    ...
    public static void U(k9 k9Var) {
        ...
        ImageView imageView = k9Var.f35073x;
        if (imageView != null) {
            imageView.setColorFilter(new PorterDuffColorFilter(k9Var.getThemedColor(org.telegram.ui.ActionBar.i6.f19220y8), PorterDuff.Mode.MULTIPLY));
            k9Var.f35073x.setBackground(org.telegram.ui.ActionBar.i6.f0(k9Var.getThemedColor(org.telegram.ui.ActionBar.i6.f19239z8), 1, -1));
        }
    ...
    public static void X(k9 k9Var, org.telegram.ui.Components.i51 i51Var, View view) {
        ...
        if (i10 == 2) {
            ...
            if (obj instanceof g9) {
                g9 g9Var = (g9) obj;
                ArrayList arrayList = g9Var.f33847c;
                if (k9Var.actionBar.s()) {
                    k9Var.e0(arrayList, (f9) view);
                } else if (g9Var.f33845a != 0 && !arrayList.isEmpty()) {
                    boolean z10 = g9Var.e;
                    HashSet hashSet = new HashSet();
                    ArrayList arrayList2 = g9Var.f33846b;
                    int size = arrayList2.size();
                    int i11 = 0;
                    while (i11 < size) {
                        Object obj2 = arrayList2.get(i11);
                        i11++;
                        hashSet.add(Long.valueOf(((TLRPC.User) obj2).f18259id));
                    }
                    TLRPC.TL_inputGroupCallInviteMessage tL_inputGroupCallInviteMessage = new TLRPC.TL_inputGroupCallInviteMessage();
                    tL_inputGroupCallInviteMessage.msg_id = ((TLRPC.Message) arrayList.get(0)).f18133id;
                    ...
                    bundle.putInt("message_id", ((TLRPC.Message) arrayList.get(0)).f18133id);
                ...
                bundle2.putLong("chat_id", ((j9) view).f34838c.f18112id);
                k9Var.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.closeChats, new Object[0]);
    ...
    public static void o0(final Context context, int i10, TLRPC.InputGroupCall inputGroupCall, String str, final org.telegram.ui.ActionBar.e6 e6Var, boolean z10, final boolean z11) {
        String str2;
        int i11;
        int v02 = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18907h5, e6Var);
        ...
        int v03 = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19218y6, e6Var);
        ...
        imageView3.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19091r5, e6Var), mode));
        ...
        if (z10) {
            ...
            a9Var.setGravity(17);
            a9Var.setTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19237z6, e6Var));
    ...
    public final View createView(Context context) {
        ...
        this.d.p1();
        this.d.Y2.f29613r = false;
        this.f35069n = new w8(this, context, 0);
        hh.k kVar = new hh.k(this.f35069n);
        w8 w8Var = this.f35069n;
        ah.c cVar = this.f35062b0;
        cVar.f423f = kVar;
        cVar.f424g = w8Var;
        org.telegram.ui.Components.e61 e61Var2 = this.d;
        Objects.requireNonNull(e61Var2);
        this.f35064c0 = new ah.n(e61Var2, w8Var, new v8(e61Var2, 0));
        this.d.C0(new j8(this, 6));
        w8 w8Var2 = this.f35069n;
        ...
        this.h.f28018w = false;
        h9 h9Var = new h9(this, context, this.h);
        this.f35061b = h9Var;
        this.f35069n.addView(h9Var, w7.x5.c(-1.0f, -1));
        this.d.setClipToPadding(false);
        this.d.setEmptyView(this.f35061b);
        ...
        org.telegram.ui.Components.ok0 ok0Var = new org.telegram.ui.Components.ok0(this.d, this.f35063c);
        this.e = ok0Var;
        ok0Var.h = new k8(this);
        w8 w8Var3 = this.f35069n;
        org.telegram.ui.Components.e61 e61Var5 = this.d;
        float f7 = -this.f35059a;
        ...
        this.f35067f = y10Var;
        y10Var.f30130c.setImageResource(R.drawable.filled_calls_plus);
        this.f35067f.setContentDescription(LocaleController.getString(R.string.Call));
        this.f35067f.setOnClickListener(new n8(this, 3));
        this.f35069n.addView(this.f35067f, org.telegram.ui.Components.y10.b());
        ...
        y8 y8Var = new y8(this, context, this, this.f35069n, this.resourceProvider, 0);
        this.O = y8Var;
        this.N.addView(y8Var);
        this.M.setCallFragmentContextView(this.O);
        this.f35069n.addView(this.M, w7.x5.d(-1, -2.0f, 48, 0.0f, -14.0f, 0.0f, 0.0f));
        this.f35069n.addView(this.actionBar);
        ci.s6 s6Var = new ci.s6(context, this.parentLayout);
        this.f35070r = s6Var;
        s6Var.b(false, false);
        this.f35069n.addView(this.f35070r, w7.x5.e(-1, 5, 48));
        this.actionBar.setDrawBlurBackground(this.f35069n);
    ...
    public final void e0(ArrayList arrayList, f9 f9Var) {
        ...
        if (l02) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                arrayList2.remove(Integer.valueOf(((TLRPC.Message) arrayList.get(i10)).f18133id));
            }
        ...
        for (int i11 = 0; i11 < size2; i11++) {
            Integer valueOf = Integer.valueOf(((TLRPC.Message) arrayList.get(i11)).f18133id);
    ...
    public final void f0() {
        ...
        if (Build.VERSION.SDK_INT >= 31 && (hVar = this.Y) != null) {
            ...
            this.f35066e0.set(0.0f, -dp, this.fragmentView.getMeasuredWidth(), this.actionBar.getMeasuredHeight() + dp);
            RectF rectF = this.f35068f0;
            ...
            hVar.g(i10, this.f35065d0);
            hVar.e(this.f35064c0, this.fragmentView.getMeasuredWidth(), this.fragmentView.getMeasuredHeight());
        }
    }

    public final void g0() {
        this.f35067f.setTranslationY(((-this.W) - this.U) - this.V);
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35061b, 4, new Class[]{h9.class}, new String[]{"emptyTextView1"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.G6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35061b, 4, new Class[]{h9.class}, new String[]{"emptyTextView2"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.f18819c7));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.d, 0, new Class[]{org.telegram.ui.Cells.r4.class}, new String[]{"progressBar"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.f18908h6));
        ...
        org.telegram.ui.Components.y10 y10Var = this.f35067f;
        if (y10Var != null) {
            arrayList.add(new org.telegram.ui.ActionBar.k6(y10Var.f30130c, 8, null, null, null, null, org.telegram.ui.ActionBar.i6.O9));
            arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35067f.f30130c, 32, null, null, null, null, org.telegram.ui.ActionBar.i6.P9));
            arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35067f.f30130c, 65568, null, null, null, null, org.telegram.ui.ActionBar.i6.Q9));
        }
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.d, 0, new Class[]{f9.class}, null, new Drawable[]{org.telegram.ui.ActionBar.i6.f18921i1}, null, org.telegram.ui.ActionBar.i6.A9));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.d, 0, new Class[]{f9.class}, null, new Drawable[]{org.telegram.ui.ActionBar.i6.f18867f1}, null, org.telegram.ui.ActionBar.i6.f19240z9));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.d, 0, new Class[]{f9.class}, org.telegram.ui.ActionBar.i6.P0, null, null, org.telegram.ui.ActionBar.i6.f19055p6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.d, 0, new Class[]{f9.class}, null, org.telegram.ui.ActionBar.i6.f19086r0, null, org.telegram.ui.ActionBar.i6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.d, 0, new Class[]{View.class}, null, new Drawable[]{null, null, org.telegram.ui.ActionBar.i6.W4, org.telegram.ui.ActionBar.i6.Y4}, null, org.telegram.ui.ActionBar.i6.f19093r7));
    ...
    public final void i0() {
        ...
        this.f35061b.setPadding(0, 0, 0, this.W + this.T);
    }
    ...
    public final boolean l0(ArrayList arrayList) {
        int size = arrayList.size();
        for (int i10 = 0; i10 < size; i10++) {
            if (this.L.contains(Integer.valueOf(((TLRPC.Message) arrayList.get(i10)).f18133id))) {
                return true;
            }
        }
        return false;
    ...
    public final void onBecomeFullyVisible() {
        ...
        if (!this.S && getUserConfig().showCallsTab && MessagesController.getGlobalMainSettings().getInt("hidecallshint", 0) < 2) {
            ...
            f4Var.d = 3000L;
            f4Var.l(1.0f, -25.0f);
            this.f35071s.setPadding(0, AndroidUtilities.dp(4.0f), 0, 0);
            this.f35071s.s(AndroidUtilities.replaceTags(LocaleController.getString(R.string.TapToHideCallsTab)));
            this.f35069n.addView(this.f35071s, w7.x5.e(-1, 80, 48));
            this.f35071s.setTranslationY((org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight) - AndroidUtilities.dp(16.0f));
            this.f35071s.u();
            this.S = true;
    ...
    public final boolean onFragmentCreate() {
        ...
        if (bundle != null) {
            ...
            this.f35072w = this.arguments.getBoolean("hasMainTabs", false);
        }
        if (this.f35072w) {
    ...
    public final void onRequestPermissionsResultFragment(int i10, String[] strArr, int[] iArr) {
        ...
        if (iArr.length > 0 && z10) {
            ...
            if (this.P != null) {
                userFull = getMessagesController().getUserFull(this.P.f18259id);
            }
    ...
    public final void q0() {
        ...
        if (s10) {
            ...
            if (!a2) {
                ...
                if (this.f35072w) {
                    ...
                    this.f35073x = imageView;
                    imageView.setScaleType(ImageView.ScaleType.CENTER);
                    this.f35073x.setImageDrawable(new org.telegram.ui.ActionBar.g2(true));
                    this.f35073x.setColorFilter(new PorterDuffColorFilter(getThemedColor(org.telegram.ui.ActionBar.i6.f19220y8), PorterDuff.Mode.MULTIPLY));
                    this.f35073x.setBackground(org.telegram.ui.ActionBar.i6.f0(getThemedColor(org.telegram.ui.ActionBar.i6.f19239z8), 1, -1));
                    this.f35073x.setOnClickListener(new n8(this, 1));
                    j3.addView(this.f35073x, w7.x5.q(54, 54, 16));
                    arrayList2.add(this.f35073x);
                }
                NumberTextView numberTextView = new NumberTextView(j3.getContext());
                this.f35074y = numberTextView;
                numberTextView.setTextSize(18);
                this.f35074y.setTypeface(AndroidUtilities.bold());
                this.f35074y.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19220y8, false));
                NumberTextView numberTextView2 = this.f35074y;
                if (this.f35072w) {
                    i10 = 18;
                } else {
                    i10 = 72;
                ...
                this.f35074y.setOnTouchListener(new bi.d(2));
        ...
        this.f35074y.a(arrayList.size(), z10);
    }

    @Override
    public final void r() {
        if (this.f35063c.L0() < 15) {
            this.d.x0(0);
            return;
        }
    ...
    @Override
    public final fh.d x() {
        return this.f35060a0;
    }

    public k9(Bundle bundle) {
        super(bundle);
        int i10 = Build.VERSION.SDK_INT;
        this.f35059a = i10 >= 31 ? 48 : 0;
        this.v = true;
        ...
        this.X = new Rect();
        ArrayList arrayList = new ArrayList();
        this.f35065d0 = arrayList;
        RectF rectF = new RectF();
        this.f35066e0 = rectF;
        RectF rectF2 = new RectF();
        this.f35068f0 = rectF2;
        arrayList.add(rectF);
        arrayList.add(rectF2);
        fh.c cVar = new fh.c();
        cVar.a(getThemedColor(org.telegram.ui.ActionBar.i6.f18780a7));
        if (i10 >= 31) {
