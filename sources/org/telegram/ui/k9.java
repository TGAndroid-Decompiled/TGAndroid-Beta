...
public final class k9 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate, yg0 {
    ...
    public final fh.d f34605a0;
    public h9 f34606b;
    public final ah.c f34607b0;
    public s4.c0 f34608c;
    public ah.n f34609c0;
    public org.telegram.ui.Components.d61 d;
    public final ArrayList f34610d0;
    public org.telegram.ui.Components.pk0 e;
    public final RectF f34611e0;
    public org.telegram.ui.Components.z10 f34612f;
    public final RectF f34613f0;
    public org.telegram.ui.Components.u00 h;
    public w8 f34614n;
    public ci.r6 f34615r;
    public ci.e4 f34616s;
    public boolean v;
    public boolean f34617w;
    public ImageView f34618x;
    public NumberTextView f34619y;
    ...
    public static void U(k9 k9Var) {
        ...
        ImageView imageView = k9Var.f34618x;
        if (imageView != null) {
            imageView.setColorFilter(new PorterDuffColorFilter(k9Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19172y8), PorterDuff.Mode.MULTIPLY));
            k9Var.f34618x.setBackground(org.telegram.ui.ActionBar.h6.f0(k9Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19191z8), 1, -1));
        }
    ...
    public static void X(k9 k9Var, org.telegram.ui.Components.h51 h51Var, View view) {
        ...
        if (i10 == 2) {
            ...
            if (obj instanceof g9) {
                g9 g9Var = (g9) obj;
                ArrayList arrayList = g9Var.f33490c;
                if (k9Var.actionBar.s()) {
                    k9Var.e0(arrayList, (f9) view);
                } else if (g9Var.f33488a != 0 && !arrayList.isEmpty()) {
                    boolean z10 = g9Var.e;
                    HashSet hashSet = new HashSet();
                    ArrayList arrayList2 = g9Var.f33489b;
                    int size = arrayList2.size();
                    int i11 = 0;
                    while (i11 < size) {
                        Object obj2 = arrayList2.get(i11);
                        i11++;
                        hashSet.add(Long.valueOf(((TLRPC.User) obj2).f18230id));
                    }
                    TLRPC.TL_inputGroupCallInviteMessage tL_inputGroupCallInviteMessage = new TLRPC.TL_inputGroupCallInviteMessage();
                    tL_inputGroupCallInviteMessage.msg_id = ((TLRPC.Message) arrayList.get(0)).f18104id;
                    ...
                    bundle.putInt("message_id", ((TLRPC.Message) arrayList.get(0)).f18104id);
                ...
                bundle2.putLong("chat_id", ((j9) view).f34365c.f18083id);
                k9Var.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.closeChats, new Object[0]);
    ...
    public static void o0(final Context context, int i10, TLRPC.InputGroupCall inputGroupCall, String str, final org.telegram.ui.ActionBar.d6 d6Var, boolean z10, final boolean z11) {
        String str2;
        int i11;
        int v02 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18859h5, d6Var);
        ...
        int v03 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19170y6, d6Var);
        ...
        imageView3.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19043r5, d6Var), mode));
        ...
        if (z10) {
            ...
            a9Var.setGravity(17);
            a9Var.setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19189z6, d6Var));
        ...
        frameLayout3.setOnClickListener(new View.OnClickListener() {
            ...
            public final void onClick(View view) {
                ...
                org.telegram.messenger.ul.p(i15, xcVar);
            }
        });
    ...
    public final View createView(Context context) {
        ...
        this.d.p1();
        this.d.Y2.f28662r = false;
        this.f34614n = new w8(this, context, 0);
        hh.k kVar = new hh.k(this.f34614n);
        w8 w8Var = this.f34614n;
        ah.c cVar = this.f34607b0;
        cVar.f425f = kVar;
        cVar.f426g = w8Var;
        org.telegram.ui.Components.d61 d61Var2 = this.d;
        Objects.requireNonNull(d61Var2);
        this.f34609c0 = new ah.n(d61Var2, w8Var, new v8(d61Var2, 0));
        this.d.C0(new j8(this, 6));
        w8 w8Var2 = this.f34614n;
        ...
        this.h.f28353w = false;
        h9 h9Var = new h9(this, context, this.h);
        this.f34606b = h9Var;
        this.f34614n.addView(h9Var, w7.x5.c(-1.0f, -1));
        this.d.setClipToPadding(false);
        this.d.setEmptyView(this.f34606b);
        ...
        org.telegram.ui.Components.pk0 pk0Var = new org.telegram.ui.Components.pk0(this.d, this.f34608c);
        this.e = pk0Var;
        pk0Var.h = new k8(this);
        w8 w8Var3 = this.f34614n;
        org.telegram.ui.Components.d61 d61Var5 = this.d;
        float f7 = -this.f34604a;
        ...
        this.f34612f = z10Var;
        z10Var.f30506c.setImageResource(R.drawable.filled_calls_plus);
        this.f34612f.setContentDescription(LocaleController.getString(R.string.Call));
        this.f34612f.setOnClickListener(new n8(this, 3));
        this.f34614n.addView(this.f34612f, org.telegram.ui.Components.z10.b());
        ...
        y8 y8Var = new y8(this, context, this, this.f34614n, this.resourceProvider, 0);
        this.O = y8Var;
        this.N.addView(y8Var);
        this.M.setCallFragmentContextView(this.O);
        this.f34614n.addView(this.M, w7.x5.d(-1, -2.0f, 48, 0.0f, -14.0f, 0.0f, 0.0f));
        this.f34614n.addView(this.actionBar);
        ci.r6 r6Var = new ci.r6(context, this.parentLayout);
        this.f34615r = r6Var;
        r6Var.b(false, false);
        this.f34614n.addView(this.f34615r, w7.x5.e(-1, 5, 48));
        this.actionBar.setDrawBlurBackground(this.f34614n);
    ...
    public final void e0(ArrayList arrayList, f9 f9Var) {
        ...
        if (l02) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                arrayList2.remove(Integer.valueOf(((TLRPC.Message) arrayList.get(i10)).f18104id));
            }
        ...
        for (int i11 = 0; i11 < size2; i11++) {
            Integer valueOf = Integer.valueOf(((TLRPC.Message) arrayList.get(i11)).f18104id);
    ...
    public final void f0() {
        ...
        if (Build.VERSION.SDK_INT >= 31 && (hVar = this.Y) != null) {
            ...
            this.f34611e0.set(0.0f, -dp, this.fragmentView.getMeasuredWidth(), this.actionBar.getMeasuredHeight() + dp);
            RectF rectF = this.f34613f0;
            ...
            hVar.g(i10, this.f34610d0);
            hVar.e(this.f34609c0, this.fragmentView.getMeasuredWidth(), this.fragmentView.getMeasuredHeight());
        }
    }

    public final void g0() {
        this.f34612f.setTranslationY(((-this.W) - this.U) - this.V);
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34606b, 4, new Class[]{h9.class}, new String[]{"emptyTextView1"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.G6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34606b, 4, new Class[]{h9.class}, new String[]{"emptyTextView2"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f18772c7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.d, 0, new Class[]{org.telegram.ui.Cells.s4.class}, new String[]{"progressBar"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f18860h6));
        ...
        org.telegram.ui.Components.z10 z10Var = this.f34612f;
        if (z10Var != null) {
            arrayList.add(new org.telegram.ui.ActionBar.j6(z10Var.f30506c, 8, null, null, null, null, org.telegram.ui.ActionBar.h6.O9));
            arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34612f.f30506c, 32, null, null, null, null, org.telegram.ui.ActionBar.h6.P9));
            arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34612f.f30506c, 65568, null, null, null, null, org.telegram.ui.ActionBar.h6.Q9));
        }
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.d, 0, new Class[]{f9.class}, null, new Drawable[]{org.telegram.ui.ActionBar.h6.f18873i1}, null, org.telegram.ui.ActionBar.h6.A9));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.d, 0, new Class[]{f9.class}, null, new Drawable[]{org.telegram.ui.ActionBar.h6.f18820f1}, null, org.telegram.ui.ActionBar.h6.f19192z9));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.d, 0, new Class[]{f9.class}, org.telegram.ui.ActionBar.h6.P0, null, null, org.telegram.ui.ActionBar.h6.f19007p6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.d, 0, new Class[]{f9.class}, null, org.telegram.ui.ActionBar.h6.f19038r0, null, org.telegram.ui.ActionBar.h6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.d, 0, new Class[]{View.class}, null, new Drawable[]{null, null, org.telegram.ui.ActionBar.h6.W4, org.telegram.ui.ActionBar.h6.Y4}, null, org.telegram.ui.ActionBar.h6.f19045r7));
    ...
    public final void i0() {
        ...
        this.f34606b.setPadding(0, 0, 0, this.W + this.T);
    }
    ...
    public final boolean l0(ArrayList arrayList) {
        int size = arrayList.size();
        for (int i10 = 0; i10 < size; i10++) {
            if (this.L.contains(Integer.valueOf(((TLRPC.Message) arrayList.get(i10)).f18104id))) {
                return true;
            }
        }
        return false;
    ...
    public final void onBecomeFullyVisible() {
        ...
        if (!this.S && getUserConfig().showCallsTab && MessagesController.getGlobalMainSettings().getInt("hidecallshint", 0) < 2) {
            ...
            e4Var.d = 3000L;
            e4Var.l(1.0f, -25.0f);
            this.f34616s.setPadding(0, AndroidUtilities.dp(4.0f), 0, 0);
            this.f34616s.s(AndroidUtilities.replaceTags(LocaleController.getString(R.string.TapToHideCallsTab)));
            this.f34614n.addView(this.f34616s, w7.x5.e(-1, 80, 48));
            this.f34616s.setTranslationY((org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight) - AndroidUtilities.dp(16.0f));
            this.f34616s.u();
            this.S = true;
    ...
    public final boolean onFragmentCreate() {
        ...
        if (bundle != null) {
            ...
            this.f34617w = this.arguments.getBoolean("hasMainTabs", false);
        }
        if (this.f34617w) {
    ...
    public final void onRequestPermissionsResultFragment(int i10, String[] strArr, int[] iArr) {
        ...
        if (iArr.length > 0 && z10) {
            ...
            if (this.P != null) {
                userFull = getMessagesController().getUserFull(this.P.f18230id);
            }
    ...
    public final void q0() {
        ...
        if (s10) {
            ...
            if (!a2) {
                ...
                if (this.f34617w) {
                    ...
                    this.f34618x = imageView;
                    imageView.setScaleType(ImageView.ScaleType.CENTER);
                    this.f34618x.setImageDrawable(new org.telegram.ui.ActionBar.g2(true));
                    this.f34618x.setColorFilter(new PorterDuffColorFilter(getThemedColor(org.telegram.ui.ActionBar.h6.f19172y8), PorterDuff.Mode.MULTIPLY));
                    this.f34618x.setBackground(org.telegram.ui.ActionBar.h6.f0(getThemedColor(org.telegram.ui.ActionBar.h6.f19191z8), 1, -1));
                    this.f34618x.setOnClickListener(new n8(this, 1));
                    j3.addView(this.f34618x, w7.x5.q(54, 54, 16));
                    arrayList2.add(this.f34618x);
                }
                NumberTextView numberTextView = new NumberTextView(j3.getContext());
                this.f34619y = numberTextView;
                numberTextView.setTextSize(18);
                this.f34619y.setTypeface(AndroidUtilities.bold());
                this.f34619y.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19172y8, false));
                NumberTextView numberTextView2 = this.f34619y;
                if (this.f34617w) {
                    i10 = 18;
                } else {
                    i10 = 72;
                ...
                this.f34619y.setOnTouchListener(new bi.d(2));
        ...
        this.f34619y.a(arrayList.size(), z10);
    }

    @Override
    public final void r() {
        if (this.f34608c.L0() < 15) {
            this.d.x0(0);
            return;
        }
    ...
    @Override
    public final fh.d x() {
        return this.f34605a0;
    }

    public k9(Bundle bundle) {
        super(bundle);
        int i10 = Build.VERSION.SDK_INT;
        this.f34604a = i10 >= 31 ? 48 : 0;
        this.v = true;
        ...
        this.X = new Rect();
        ArrayList arrayList = new ArrayList();
        this.f34610d0 = arrayList;
        RectF rectF = new RectF();
        this.f34611e0 = rectF;
        RectF rectF2 = new RectF();
        this.f34613f0 = rectF2;
        arrayList.add(rectF);
        arrayList.add(rectF2);
        fh.c cVar = new fh.c();
        cVar.a(getThemedColor(org.telegram.ui.ActionBar.h6.f18733a7));
        if (i10 >= 31) {
