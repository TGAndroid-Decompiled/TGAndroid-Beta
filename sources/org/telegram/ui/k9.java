...
public final class k9 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate, dh0 {
    ...
    public final gh.d f37963a0;
    public h9 f37964b;
    public final bh.b f37965b0;
    public s4.c0 f37966c;
    public bh.l f37967c0;
    public org.telegram.ui.Components.d61 d;
    public final ArrayList f37968d0;
    public org.telegram.ui.Components.ok0 f37969e;
    public final RectF f37970e0;
    public org.telegram.ui.Components.y10 f37971f;
    public final RectF f37972f0;
    public org.telegram.ui.Components.t00 h;
    public w8 f37973n;
    public di.r6 f37974r;
    public di.f4 f37975s;
    public boolean v;
    public boolean f37976w;
    public ImageView f37977x;
    public NumberTextView f37978y;
    ...
    public static void U(k9 k9Var) {
        ...
        ImageView imageView = k9Var.f37977x;
        if (imageView != null) {
            imageView.setColorFilter(new PorterDuffColorFilter(k9Var.getThemedColor(org.telegram.ui.ActionBar.j6.f21045y8), PorterDuff.Mode.MULTIPLY));
            k9Var.f37977x.setBackground(org.telegram.ui.ActionBar.j6.f0(k9Var.getThemedColor(org.telegram.ui.ActionBar.j6.f21064z8), 1, -1));
        }
    ...
    public static void X(k9 k9Var, org.telegram.ui.Components.h51 h51Var, View view) {
        ...
        if (i10 == 2) {
            ...
            if (obj instanceof g9) {
                g9 g9Var = (g9) obj;
                ArrayList arrayList = g9Var.f36603c;
                if (k9Var.actionBar.s()) {
                    k9Var.e0(arrayList, (f9) view);
                } else if (g9Var.f36601a != 0 && !arrayList.isEmpty()) {
                    boolean z10 = g9Var.f36604e;
                    HashSet hashSet = new HashSet();
                    ArrayList arrayList2 = g9Var.f36602b;
                ...
                bundle2.putLong("chat_id", ((j9) view).f37700c.f19869id);
                k9Var.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.closeChats, new Object[0]);
    ...
    public static void o0(final Context context, int i10, TLRPC.InputGroupCall inputGroupCall, String str, final org.telegram.ui.ActionBar.f6 f6Var, boolean z10, final boolean z11) {
        String str2;
        int i11;
        int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20735h5, f6Var);
        ...
        int v03 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f21043y6, f6Var);
        ...
        int i14 = org.telegram.ui.ActionBar.j6.f20608a7;
        ...
        imageView3.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20916r5, f6Var), mode));
        ...
        if (z10) {
            ...
            a9Var.setGravity(17);
            a9Var.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f21062z6, f6Var));
    ...
    public final View createView(Context context) {
        ...
        this.d.o1();
        this.d.Y2.f31136r = false;
        this.f37973n = new w8(this, context, 0);
        ih.k kVar = new ih.k(this.f37973n);
        w8 w8Var = this.f37973n;
        bh.b bVar = this.f37965b0;
        bVar.d = kVar;
        bVar.f2653e = w8Var;
        org.telegram.ui.Components.d61 d61Var2 = this.d;
        Objects.requireNonNull(d61Var2);
        this.f37967c0 = new bh.l(d61Var2, w8Var, new v8(d61Var2, 0));
        this.d.C0(new j8(this, 6));
        w8 w8Var2 = this.f37973n;
        ...
        this.h.f30466w = false;
        h9 h9Var = new h9(this, context, this.h);
        this.f37964b = h9Var;
        this.f37973n.addView(h9Var, w7.x5.c(-1.0f, -1));
        this.d.setClipToPadding(false);
        this.d.setEmptyView(this.f37964b);
        ...
        org.telegram.ui.Components.ok0 ok0Var = new org.telegram.ui.Components.ok0(this.d, this.f37966c);
        this.f37969e = ok0Var;
        ok0Var.h = new k8(this);
        w8 w8Var3 = this.f37973n;
        org.telegram.ui.Components.d61 d61Var5 = this.d;
        float f7 = -this.f37962a;
        ...
        this.f37971f = y10Var;
        y10Var.f32813c.setImageResource(R.drawable.filled_calls_plus);
        this.f37971f.setContentDescription(LocaleController.getString(R.string.Call));
        this.f37971f.setOnClickListener(new n8(this, 3));
        this.f37973n.addView(this.f37971f, org.telegram.ui.Components.y10.b());
        ...
        y8 y8Var = new y8(this, context, this, this.f37973n, this.resourceProvider, 0);
        this.O = y8Var;
        this.N.addView(y8Var);
        this.M.setCallFragmentContextView(this.O);
        this.f37973n.addView(this.M, w7.x5.d(-1, -2.0f, 48, 0.0f, -14.0f, 0.0f, 0.0f));
        this.f37973n.addView(this.actionBar);
        di.r6 r6Var = new di.r6(context, this.parentLayout);
        this.f37974r = r6Var;
        r6Var.b(false, false);
        this.f37973n.addView(this.f37974r, w7.x5.e(-1, 5, 48));
        this.actionBar.setDrawBlurBackground(this.f37973n);
    ...
    public final void e0(ArrayList arrayList, f9 f9Var) {
        ...
        if (l02) {
            ...
            org.telegram.ui.Components.mp mpVar = f9Var.f36343e;
            if (mpVar != null) {
                mpVar.a(false, true);
            }
            q0();
        ...
        org.telegram.ui.Components.mp mpVar2 = f9Var.f36343e;
        if (mpVar2 != null) {
            mpVar2.a(true, true);
        }
        q0();
    ...
    public final void f0() {
        ...
        if (Build.VERSION.SDK_INT >= 31 && (fVar = this.Y) != null) {
            ...
            this.f37970e0.set(0.0f, -dp, this.fragmentView.getMeasuredWidth(), this.actionBar.getMeasuredHeight() + dp);
            RectF rectF = this.f37972f0;
            ...
            fVar.g(i10, this.f37968d0);
            fVar.e(this.f37967c0, this.fragmentView.getMeasuredWidth(), this.fragmentView.getMeasuredHeight());
        }
    }

    public final void g0() {
        this.f37971f.setTranslationY(((-this.W) - this.U) - this.V);
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37964b, 4, new Class[]{h9.class}, new String[]{"emptyTextView1"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.G6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37964b, 4, new Class[]{h9.class}, new String[]{"emptyTextView2"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f20647c7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{org.telegram.ui.Cells.r4.class}, new String[]{"progressBar"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f20736h6));
        ...
        org.telegram.ui.Components.y10 y10Var = this.f37971f;
        if (y10Var != null) {
            arrayList.add(new org.telegram.ui.ActionBar.l6(y10Var.f32813c, 8, null, null, null, null, org.telegram.ui.ActionBar.j6.O9));
            arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37971f.f32813c, 32, null, null, null, null, org.telegram.ui.ActionBar.j6.P9));
            arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37971f.f32813c, 65568, null, null, null, null, org.telegram.ui.ActionBar.j6.Q9));
        }
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{f9.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f20749i1}, null, org.telegram.ui.ActionBar.j6.A9));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{f9.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.f20696f1}, null, org.telegram.ui.ActionBar.j6.f21065z9));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{f9.class}, org.telegram.ui.ActionBar.j6.P0, null, null, org.telegram.ui.ActionBar.j6.f20880p6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{f9.class}, null, org.telegram.ui.ActionBar.j6.f20911r0, null, org.telegram.ui.ActionBar.j6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.d, 0, new Class[]{View.class}, null, new Drawable[]{null, null, org.telegram.ui.ActionBar.j6.W4, org.telegram.ui.ActionBar.j6.Y4}, null, org.telegram.ui.ActionBar.j6.f20918r7));
    ...
    public final void i0() {
        ...
        this.f37964b.setPadding(0, 0, 0, this.W + this.T);
    }
    ...
    public final void k0(boolean z10) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if ((childAt instanceof f9) && (mpVar = ((f9) childAt).f36343e) != null) {
                mpVar.a(false, z10);
            }
        }
        this.d.Y2.N(true);
    ...
    public final void onBecomeFullyVisible() {
        ...
        if (!this.S && getUserConfig().showCallsTab && MessagesController.getGlobalMainSettings().getInt("hidecallshint", 0) < 2) {
            ...
            f4Var.d = 3000L;
            f4Var.l(1.0f, -25.0f);
            this.f37975s.setPadding(0, AndroidUtilities.dp(4.0f), 0, 0);
            this.f37975s.s(AndroidUtilities.replaceTags(LocaleController.getString(R.string.TapToHideCallsTab)));
            this.f37973n.addView(this.f37975s, w7.x5.e(-1, 80, 48));
            this.f37975s.setTranslationY((org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight) - AndroidUtilities.dp(16.0f));
            this.f37975s.u();
            this.S = true;
    ...
    public final boolean onFragmentCreate() {
        ...
        if (bundle != null) {
            ...
            this.f37976w = this.arguments.getBoolean("hasMainTabs", false);
        }
        if (this.f37976w) {
    ...
    public final void q0() {
        ...
        if (s10) {
            ...
            if (!a2) {
                ...
                if (this.f37976w) {
                    ...
                    this.f37977x = imageView;
                    imageView.setScaleType(ImageView.ScaleType.CENTER);
                    this.f37977x.setImageDrawable(new org.telegram.ui.ActionBar.g2(true));
                    this.f37977x.setColorFilter(new PorterDuffColorFilter(getThemedColor(org.telegram.ui.ActionBar.j6.f21045y8), PorterDuff.Mode.MULTIPLY));
                    this.f37977x.setBackground(org.telegram.ui.ActionBar.j6.f0(getThemedColor(org.telegram.ui.ActionBar.j6.f21064z8), 1, -1));
                    this.f37977x.setOnClickListener(new n8(this, 1));
                    j3.addView(this.f37977x, w7.x5.q(54, 54, 16));
                    arrayList2.add(this.f37977x);
                }
                NumberTextView numberTextView = new NumberTextView(j3.getContext());
                this.f37978y = numberTextView;
                numberTextView.setTextSize(18);
                this.f37978y.setTypeface(AndroidUtilities.bold());
                this.f37978y.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f21045y8, false));
                NumberTextView numberTextView2 = this.f37978y;
                if (this.f37976w) {
                    i10 = 18;
                } else {
                    i10 = 72;
                ...
                this.f37978y.setOnTouchListener(new ci.d(2));
        ...
        this.f37978y.a(arrayList.size(), z10);
    }

    @Override
    public final void r() {
        if (this.f37966c.L0() < 15) {
            this.d.x0(0);
            return;
        }
        org.telegram.ui.Components.ok0 ok0Var = this.f37969e;
        ok0Var.f29099b = 1;
    ...
    @Override
    public final gh.d x() {
        return this.f37963a0;
    }

    public k9(Bundle bundle) {
        super(bundle);
        int i10 = Build.VERSION.SDK_INT;
        this.f37962a = i10 >= 31 ? 48 : 0;
        this.v = true;
        ...
        this.X = new Rect();
        ArrayList arrayList = new ArrayList();
        this.f37968d0 = arrayList;
        RectF rectF = new RectF();
        this.f37970e0 = rectF;
        RectF rectF2 = new RectF();
        this.f37972f0 = rectF2;
        arrayList.add(rectF);
        arrayList.add(rectF2);
        gh.c cVar = new gh.c();
        cVar.a(getThemedColor(org.telegram.ui.ActionBar.j6.f20608a7));
        if (i10 >= 31) {
