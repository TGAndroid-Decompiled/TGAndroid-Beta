...
public final class a20 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.j5 f34296a;
    public final TextView f34297b;
    public final ImageView f34298c;
    public int d;
    public int f34299e;
    public final View f34300f;
    public final ImageView h;
    public final org.telegram.ui.Components.j30 f34301n;
    public boolean f34302r;
    public final org.telegram.ui.Components.h90 f34303s;
    public boolean v;
    public float f34304w;
    public MessagesController.DialogFilter f34305x;
    public ValueAnimator f34306y;
    ...
    public a20(FiltersSetupActivity filtersSetupActivity, Context context) {
        ...
        textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f21062z6, false));
        ...
        h90Var.C = true;
        h90Var.f26689t = 2.0f;
        int i22 = org.telegram.ui.ActionBar.j6.f20754i6;
        ...
        h90Var.f26691w.setStrokeWidth(dp);
        h90Var.j(40.0f);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        MessagesController.DialogFilter dialogFilter = this.f34305x;
        if (dialogFilter != null) {
            boolean z10 = dialogFilter.locked;
            if (z10) {
                float f7 = this.f34304w;
                if (f7 != 1.0f) {
                    this.f34304w = f7 + 0.10666667f;
                    invalidate();
                }
            }
            if (!z10) {
                float f10 = this.f34304w;
                if (f10 != 0.0f) {
                    this.f34304w = f10 - 0.10666667f;
                    invalidate();
                }
            }
        }
        float clamp = Utilities.clamp(this.f34304w, 1.0f, 0.0f);
        this.f34304w = clamp;
        org.telegram.ui.ActionBar.j5 j5Var = this.f34296a;
    ...
    public void setOnReorderButtonTouchListener(View.OnTouchListener onTouchListener) {
        this.f34298c.setOnTouchListener(onTouchListener);
    }
}
