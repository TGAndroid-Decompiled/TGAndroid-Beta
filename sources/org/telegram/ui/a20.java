...
public final class a20 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.j5 f34323a;
    public final TextView f34324b;
    public final ImageView f34325c;
    public int d;
    public int f34326e;
    public final View f34327f;
    public final ImageView h;
    public final org.telegram.ui.Components.j30 f34328n;
    public boolean f34329r;
    public final org.telegram.ui.Components.h90 f34330s;
    public boolean v;
    public float f34331w;
    public MessagesController.DialogFilter f34332x;
    public ValueAnimator f34333y;
    ...
    public a20(FiltersSetupActivity filtersSetupActivity, Context context) {
        ...
        textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f21089z6, false));
        ...
        h90Var.C = true;
        h90Var.f26716t = 2.0f;
        int i22 = org.telegram.ui.ActionBar.j6.f20781i6;
        ...
        h90Var.f26718w.setStrokeWidth(dp);
        h90Var.j(40.0f);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        MessagesController.DialogFilter dialogFilter = this.f34332x;
        if (dialogFilter != null) {
            boolean z10 = dialogFilter.locked;
            if (z10) {
                float f7 = this.f34331w;
                if (f7 != 1.0f) {
                    this.f34331w = f7 + 0.10666667f;
                    invalidate();
                }
            }
            if (!z10) {
                float f10 = this.f34331w;
                if (f10 != 0.0f) {
                    this.f34331w = f10 - 0.10666667f;
                    invalidate();
                }
            }
        }
        float clamp = Utilities.clamp(this.f34331w, 1.0f, 0.0f);
        this.f34331w = clamp;
        org.telegram.ui.ActionBar.j5 j5Var = this.f34323a;
    ...
    public void setOnReorderButtonTouchListener(View.OnTouchListener onTouchListener) {
        this.f34325c.setOnTouchListener(onTouchListener);
    }
}
