...
public final class a20 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.j5 f31913a;
    public final TextView f31914b;
    public final ImageView f31915c;
    public int d;
    public int e;
    public final View f31916f;
    public final ImageView h;
    public final org.telegram.ui.Components.j30 f31917n;
    public boolean f31918r;
    public final org.telegram.ui.Components.p90 f31919s;
    public boolean v;
    public float f31920w;
    public MessagesController.DialogFilter f31921x;
    public ValueAnimator f31922y;
    ...
    public a20(FiltersSetupActivity filtersSetupActivity, Context context) {
        ...
        j5Var.setEmojiColor(org.telegram.ui.ActionBar.j6.v0(i19, e6Var));
        ...
        p90Var.C = true;
        p90Var.f27155t = 2.0f;
        int i22 = org.telegram.ui.ActionBar.j6.f19152i6;
        ...
        p90Var.f27157w.setStrokeWidth(dp);
        p90Var.j(40.0f);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        MessagesController.DialogFilter dialogFilter = this.f31921x;
        if (dialogFilter != null) {
            boolean z10 = dialogFilter.locked;
            if (z10) {
                float f7 = this.f31920w;
                if (f7 != 1.0f) {
                    this.f31920w = f7 + 0.10666667f;
                    invalidate();
                }
            }
            if (!z10) {
                float f10 = this.f31920w;
                if (f10 != 0.0f) {
                    this.f31920w = f10 - 0.10666667f;
                    invalidate();
                }
            }
        }
        float clamp = Utilities.clamp(this.f31920w, 1.0f, 0.0f);
        this.f31920w = clamp;
        org.telegram.ui.ActionBar.j5 j5Var = this.f31913a;
    ...
    public void setOnReorderButtonTouchListener(View.OnTouchListener onTouchListener) {
        this.f31915c.setOnTouchListener(onTouchListener);
    }
}
