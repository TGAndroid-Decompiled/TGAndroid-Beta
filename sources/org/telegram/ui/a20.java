...
public final class a20 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.j5 f31953a;
    ...
    public final org.telegram.ui.Components.j30 f31957n;
    public boolean f31958r;
    public final org.telegram.ui.Components.o90 f31959s;
    public boolean v;
    public float f31960w;
    public MessagesController.DialogFilter f31961x;
    public ValueAnimator f31962y;
    ...
    public a20(FiltersSetupActivity filtersSetupActivity, Context context) {
        ...
        addView(j5Var, w7.y5.d(-1, -2.0f, i20, f7, 10.0f, f10, 0.0f));
        TextView textView = new TextView(context);
        this.f31954b = textView;
        textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19496z6, false));
        ...
        o90Var.C = true;
        o90Var.f26858t = 2.0f;
        int i22 = org.telegram.ui.ActionBar.j6.f19184i6;
        ...
        o90Var.f26860w.setStrokeWidth(dp);
        o90Var.j(40.0f);
        ...
        addView(j30Var, w7.y5.d(40, 40.0f, i23, f13, 0.0f, f14, 0.0f));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        MessagesController.DialogFilter dialogFilter = this.f31961x;
        if (dialogFilter != null) {
            boolean z10 = dialogFilter.locked;
            if (z10) {
                float f7 = this.f31960w;
                if (f7 != 1.0f) {
                    this.f31960w = f7 + 0.10666667f;
                    invalidate();
                }
            }
            if (!z10) {
                float f10 = this.f31960w;
                if (f10 != 0.0f) {
                    this.f31960w = f10 - 0.10666667f;
                    invalidate();
                }
            }
        }
        float clamp = Utilities.clamp(this.f31960w, 1.0f, 0.0f);
        this.f31960w = clamp;
        org.telegram.ui.ActionBar.j5 j5Var = this.f31953a;
    ...
    public void setOnReorderButtonTouchListener(View.OnTouchListener onTouchListener) {
        this.f31955c.setOnTouchListener(onTouchListener);
    }
}
