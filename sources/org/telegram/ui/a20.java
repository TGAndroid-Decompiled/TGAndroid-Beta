...
public final class a20 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.j5 f31974a;
    public final TextView f31975b;
    public final ImageView f31976c;
    public int d;
    public int e;
    public final View f31977f;
    public final ImageView h;
    public final org.telegram.ui.Components.j30 f31978n;
    public boolean f31979r;
    public final org.telegram.ui.Components.r90 f31980s;
    public boolean v;
    public float f31981w;
    public MessagesController.DialogFilter f31982x;
    public ValueAnimator f31983y;
    ...
    public a20(FiltersSetupActivity filtersSetupActivity, Context context) {
        ...
        r90Var.C = true;
        r90Var.f27870t = 2.0f;
        int i22 = org.telegram.ui.ActionBar.j6.f19199i6;
        ...
        r90Var.f27872w.setStrokeWidth(dp);
        r90Var.j(40.0f);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        MessagesController.DialogFilter dialogFilter = this.f31982x;
        if (dialogFilter != null) {
            boolean z10 = dialogFilter.locked;
            if (z10) {
                float f7 = this.f31981w;
                if (f7 != 1.0f) {
                    this.f31981w = f7 + 0.10666667f;
                    invalidate();
                }
            }
            if (!z10) {
                float f10 = this.f31981w;
                if (f10 != 0.0f) {
                    this.f31981w = f10 - 0.10666667f;
                    invalidate();
                }
            }
        }
        float clamp = Utilities.clamp(this.f31981w, 1.0f, 0.0f);
        this.f31981w = clamp;
        org.telegram.ui.ActionBar.j5 j5Var = this.f31974a;
    ...
    public void setOnReorderButtonTouchListener(View.OnTouchListener onTouchListener) {
        this.f31976c.setOnTouchListener(onTouchListener);
    }
}
