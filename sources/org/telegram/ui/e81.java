...
public final class e81 extends FrameLayout {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.e) {
            canvas.drawRect(AndroidUtilities.dp(64.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight(), org.telegram.ui.ActionBar.j6.f18985k0);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (r02 != null) {
            ...
            sb2.append((Object) this.f33329b.getText());
            sb2.append("\n");
            sb2.append((Object) this.f33330c.getText());
            sb2.append("\n");
            if (r02.h) {
