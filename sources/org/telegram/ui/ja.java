...
public final class ja implements TextWatcher {
    ...
    public final void beforeTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
        ...
        ka kaVar = this.f34707a;
        qa qaVar = kaVar.f35012c;
        String str = qaVar.f36835r;
        if (charSequence == null) {
            charSequence2 = "";
        } else {
            charSequence2 = charSequence.toString();
        }
        qaVar.f36835r = charSequence2;
        qa qaVar2 = kaVar.f35012c;
        na naVar = qaVar2.E;
        if (naVar != null && str != null) {
            naVar.b(qaVar2.f36835r);
        }
    }
