...
public final class lz0 implements org.telegram.ui.Components.bl0 {
    public int f35585a = 0;
    public final Context f35586b;
    public final ProfileActivity f35587c;

    public lz0(ProfileActivity profileActivity, Context context) {
        this.f35587c = profileActivity;
    ...
    public static void a(lz0 lz0Var, Context context, int i10) {
        ...
        int i20 = 0;
        if (i10 == 0) {
            lz0Var.f35587c.getUserConfig().syncContacts = true;
            lz0Var.f35587c.getUserConfig().saveConfig(false);
            lz0Var.f35587c.getContactsController().forceImportContacts();
            return;
        }
        long j10 = 0;
        if (i10 == 1) {
            lz0Var.f35587c.getContactsController().loadContacts(false, 0L);
        } else if (i10 == 2) {
            lz0Var.f35587c.getContactsController().resetImportedContacts();
        } else if (i10 == 3) {
            lz0Var.f35587c.getMessagesController().forceResetDialogs();
        } else if (i10 == 4) {
            ...
            lz0Var.f35587c.getMessagesStorage().clearSentMedia();
            ...
            w7.w5.a();
            i15 = ((org.telegram.ui.ActionBar.n2) lz0Var.f35587c).currentAccount;
            ...
            i16 = ((org.telegram.ui.ActionBar.n2) lz0Var.f35587c).currentAccount;
            ChatThemeController.getInstance(i16).clearCache();
            lz0Var.f35587c.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.newSuggestionsAvailable, new Object[0]);
            e41.W();
            i17 = ((org.telegram.ui.ActionBar.n2) lz0Var.f35587c).currentAccount;
            pg.s0.e(i17).a();
            SharedPreferences mainSettings = lz0Var.f35587c.getMessagesController().getMainSettings();
            ...
            edit.apply();
            i18 = ((org.telegram.ui.ActionBar.n2) lz0Var.f35587c).currentAccount;
            SharedPreferences.Editor edit2 = MessagesController.getNotificationsSettings(i18).edit();
            i19 = ((org.telegram.ui.ActionBar.n2) lz0Var.f35587c).currentAccount;
            ...
            org.telegram.ui.Components.voip.f2.i(lz0Var.f35587c.getParentActivity());
        } else if (i10 == 8) {
            SharedConfig.toggleRoundCamera16to9();
        } else if (i10 == 9) {
            ((LaunchActivity) lz0Var.f35587c.getParentActivity()).z(true);
        } else if (i10 == 10) {
            lz0Var.f35587c.getMessagesStorage().readAllDialogs(-1);
        } else if (i10 == 11) {
            ...
            Set<String> set = lz0Var.f35587c.getMessagesController().pendingSuggestions;
            ...
            try {
                if (i10 == 14) {
                    ...
                    Activity parentActivity = lz0Var.f35587c.getParentActivity();
                    ...
                    w7.x.a((LaunchActivity) lz0Var.f35587c.getParentActivity(), !SharedConfig.isFloatingDebugActive, true);
                } else if (i10 == 19) {
                    lz0Var.f35587c.getMessagesController().loadAppConfig();
                    TLRPC.TL_help_dismissSuggestion tL_help_dismissSuggestion = new TLRPC.TL_help_dismissSuggestion();
                    tL_help_dismissSuggestion.suggestion = "VALIDATE_PHONE_NUMBER";
                    tL_help_dismissSuggestion.peer = new TLRPC.TL_inputPeerEmpty();
                    lz0Var.f35587c.getConnectionsManager().sendRequest(tL_help_dismissSuggestion, new iz0(lz0Var, 0));
                } else if (i10 == 20) {
                    ...
                    ProfileActivity.S0(lz0Var.f35587c, "video/avc", sb3);
                    ProfileActivity.S0(lz0Var.f35587c, "video/hevc", sb3);
                    ProfileActivity.S0(lz0Var.f35587c, "video/x-vnd.on2.vp8", sb3);
                    ProfileActivity.S0(lz0Var.f35587c, "video/x-vnd.on2.vp9", sb3);
                    lz0Var.f35587c.showDialog(new kz0(lz0Var, lz0Var.f35587c.getParentActivity(), sb3.toString()));
                } else if (i10 == 21) {
                    AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(lz0Var.f35587c.getParentActivity(), 0, lz0Var.f35587c.f31412z0);
                    ...
                    alertDialog$Builder.f(new CharSequence[]{replaceTags, replaceTags2, AndroidUtilities.replaceTags(str5.concat(str8))}, new jz0(measureDevicePerformanceClass, 0));
                    alertDialog$Builder.h(LocaleController.getString("Cancel", R.string.Cancel), null);
                    alertDialog$Builder.o();
                } else if (i10 == 22) {
                    SharedConfig.toggleRoundCamera();
                } else if (i10 == 23) {
                    boolean q6 = ci.d1.q(lz0Var.f35587c.getParentActivity());
                    MessagesController.getGlobalMainSettings().edit().putBoolean("dual_available", !q6).apply();
                    Activity parentActivity2 = lz0Var.f35587c.getParentActivity();
                    if (!q6) {
                    ...
                    while (i20 < lz0Var.f35587c.getParentLayout().getFragmentStack().size()) {
                        ((org.telegram.ui.ActionBar.n2) lz0Var.f35587c.getParentLayout().getFragmentStack().get(i20)).clearSheets();
                        i20++;
                    }
                } else if (i10 == 25) {
                    ...
                    lz0Var.f35587c.getMediaDataController().loadAttachMenuBots(false, true);
                } else if (i10 == 28) {
                    i12 = ((org.telegram.ui.ActionBar.n2) lz0Var.f35587c).currentAccount;
                    ...
                    i11 = ((org.telegram.ui.ActionBar.n2) lz0Var.f35587c).currentAccount;
    ...
    public final boolean d(int r46, android.view.View r47) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.lz0.d(int, android.view.View):boolean");
    }
}
