...
public class BlurSettingsBottomSheet extends BottomSheet {
    ...
    private BlurSettingsBottomSheet(BaseFragment baseFragment) {
        ...
        BlurSettingsBottomSheet$$ExternalSyntheticOutline0.m(textView3, Theme.getColor(null, i, false), 1, 16.0f, 1);
    ...
    public static void onThemeApplyed() {
        blurAlpha = 1.0f - (Color.alpha(Theme.getColor(null, Theme.key_chat_BlurAlpha, true)) / 255.0f);
    }
