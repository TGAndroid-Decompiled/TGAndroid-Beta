...
public final class dq0 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public bq0 f32699n;
    public FrameLayout f32700r;
    public TextView f32701s;
    public boolean v;
    public final int f32702w;
    public boolean f32703x;
    public final boolean f32704y;
    ...
    public static void U(dq0 dq0Var, MediaController.AlbumEntry albumEntry) {
        if (albumEntry != null) {
            uq0 uq0Var = new uq0(0, albumEntry, dq0Var.f32696b, dq0Var.f32697c, dq0Var.f32702w, dq0Var.E, dq0Var.F, false);
            ...
            uq0Var.f38191s0 = new zp0(dq0Var);
        ...
        if (dq0Var.f32704y) {
            ar0 ar0Var = new ar0(hashMap, arrayList, dq0Var.f32702w, dq0Var.E, dq0Var.F);
            Editable text2 = dq0Var.M.getText();
            dq0Var.f32695a = text2;
            uq0 uq0Var2 = ar0Var.f31867a;
            if (uq0Var2 != null) {
                uq0Var2.d = text2;
                org.telegram.ui.Components.ku kuVar2 = uq0Var2.f38173d0;
                if (kuVar2 != null) {
                    kuVar2.setText(text2);
                }
            }
            aq0 aq0Var = new aq0(dq0Var, hashMap, arrayList);
            uq0 uq0Var3 = ar0Var.f31867a;
            uq0Var3.f38191s0 = aq0Var;
            uq0 uq0Var4 = ar0Var.f31868b;
            uq0Var4.f38191s0 = aq0Var;
            uq0Var3.f38192t0 = new zq0(ar0Var, 0);
            uq0Var4.f38192t0 = new zq0(ar0Var, 1);
            int i10 = dq0Var.G;
            boolean z10 = dq0Var.H;
            uq0Var3.f0(i10, z10);
            ar0Var.f31868b.f0(i10, z10);
            dq0Var.presentFragment(ar0Var);
            return;
        }
        uq0 uq0Var5 = new uq0(0, albumEntry, hashMap, arrayList, dq0Var.f32702w, dq0Var.E, dq0Var.F, false);
        Editable text3 = dq0Var.M.getText();
        dq0Var.f32695a = text3;
        uq0Var5.d = text3;
        org.telegram.ui.Components.ku kuVar3 = uq0Var5.f38173d0;
        if (kuVar3 != null) {
            kuVar3.setText(text3);
        }
        uq0Var5.f38191s0 = new wp0(dq0Var, hashMap, arrayList);
        uq0Var5.f0(dq0Var.G, dq0Var.H);
        dq0Var.presentFragment(uq0Var5);
    }
    ...
    public final void W(boolean z10) {
        ...
        p50Var.setScaleX(f12);
        p50 p50Var2 = this.Q;
        if (z10) {
            f13 = 1.0f;
        }
        p50Var2.setScaleY(f13);
        p50 p50Var3 = this.Q;
        if (!z10) {
            f14 = 0.0f;
        }
        p50Var3.setAlpha(f14);
    ...
    public final View createView(Context context) {
        ...
        this.f32701s = textView;
        textView.setTextColor(-8355712);
        this.f32701s.setTextSize(1, 20.0f);
        this.f32701s.setGravity(17);
        this.f32701s.setVisibility(8);
        this.f32701s.setText(LocaleController.getString(R.string.NoPhotos));
        this.P.addView(this.f32701s, w7.x5.d(-1, -1.0f, 51, 0.0f, 0.0f, 0.0f, 48.0f));
        this.f32701s.setOnTouchListener(new bi.d(2));
        FrameLayout frameLayout = new FrameLayout(context);
        this.f32700r = frameLayout;
        frameLayout.setVisibility(8);
        this.P.addView(this.f32700r, w7.x5.d(-1, -1.0f, 51, 0.0f, 0.0f, 0.0f, 48.0f));
        RadialProgressView radialProgressView = new RadialProgressView(context, null);
        radialProgressView.setProgressColor(-11371101);
        this.f32700r.addView(radialProgressView, w7.x5.e(-2, -2, 17));
        ...
        CharSequence charSequence = this.f32695a;
        if (charSequence != null) {
        ...
        this.O.setOnClickListener(new h60(this, 17));
        this.O.setOnLongClickListener(new v(this, 3));
        TextPaint textPaint = this.S;
        textPaint.setTextSize(AndroidUtilities.dp(12.0f));
        textPaint.setTypeface(AndroidUtilities.bold());
        p50 p50Var = new p50(this, context, 2);
        this.Q = p50Var;
        ...
        if (this.e && ((arrayList = this.d) == null || arrayList.isEmpty())) {
            ...
            this.f32700r.setVisibility(8);
            this.h.setEmptyView(this.f32701s);
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.albumsDidLoad) {
            if (this.classGuid == ((Integer) objArr[0]).intValue()) {
                int i12 = this.f32702w;
                if (i12 != 1 && i12 != 2 && i12 != 10 && this.f32703x) {
                    this.d = (ArrayList) objArr[1];
                } else {
                    this.d = (ArrayList) objArr[2];
                }
                FrameLayout frameLayout = this.f32700r;
                if (frameLayout != null) {
                    frameLayout.setVisibility(8);
                }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.h, 0, new Class[]{View.class}, null, new Drawable[]{org.telegram.ui.ActionBar.h6.R4}, null, org.telegram.ui.ActionBar.h6.f18793da));
    ...
    public final boolean onFragmentCreate() {
        int i10 = this.f32702w;
        boolean z10 = true;
        if (i10 != 1 && i10 != 2 && i10 != 10 && this.f32703x) {
