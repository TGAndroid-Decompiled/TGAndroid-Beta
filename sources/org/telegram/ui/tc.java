...
public final class tc extends FrameLayout {
    public final org.telegram.ui.ActionBar.f6 f37715a;
    public final fc1 f37716b;
    public final s4.c0 f37717c;
    public final int d;
    public int e;
    ...
    public final void a(int i10, boolean z10) {
        ...
        if (i11 != this.e) {
            this.e = i11;
            if (!z10) {
                this.f37717c.h1(i11, (AndroidUtilities.displaySize.x - AndroidUtilities.dp(56.0f)) / 2);
            }
            AndroidUtilities.forEachViews((RecyclerView) this.f37716b, (e2.h) new m4.t0(1, this, z10));
        }
    }
