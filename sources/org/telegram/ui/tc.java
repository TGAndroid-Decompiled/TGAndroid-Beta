...
public final class tc extends org.telegram.ui.Components.yk0 {
    ...
    @Override
    public final int h() {
        return this.f42854e.f43417c.size();
    }
    ...
    public final void v(f2.o1 o1Var, int i10) {
        ...
        int iIntValue;
        String[] strArrSplit;
        org.telegram.ui.Components.b11 b11Var = (org.telegram.ui.Components.b11) o1Var.f5789a;
        vc vcVar = this.f42854e;
        ArrayList arrayList = vcVar.f43417c;
        org.telegram.ui.ActionBar.f6 f6VarJ = ((org.telegram.ui.Components.zo) arrayList.get(i10)).f35316a.j(((org.telegram.ui.Components.zo) arrayList.get(i10)).f35318c);
        if (f6VarJ == null || f6VarJ.f22943b == null || f6VarJ.P || !new File(f6VarJ.f22943b).exists()) {
            z10 = true;
        } else {
            HashMap map = vcVar.f43424x;
            if (f6VarJ.f22943b == null) {
                ...
                if (f6VarJ.f22945c == null || f6VarJ.f22950f || new File(f6VarJ.f22945c).exists()) {
                    ...
                    if (!map.containsKey(f6VarJ)) {
                        ...
                        ConnectionsManager.getInstance(f6VarJ.A).sendRequest(getwallpaper, new cg.g0(27, vcVar, f6VarJ));
                    }
                    z10 = true;
                }
            }
        ...
        b11Var.setFallbackWallpaper(zoVar.f35316a.f22781b ? null : vcVar.v);
    }

    @Override
    public final f2.o1 x(ViewGroup viewGroup, int i10) {
        return new org.telegram.ui.Components.lk0(new sc(this.f42853c, 3, viewGroup.getContext(), this.d));
    }
    ...
    public final void y(f2.o1 o1Var) {
        ...
        org.telegram.ui.Components.zo zoVar = (org.telegram.ui.Components.zo) arrayList.get(iB);
