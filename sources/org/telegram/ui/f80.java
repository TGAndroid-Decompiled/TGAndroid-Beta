...
public final class f80 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f33510a) {
            case 0:
                Utilities.searchQueue.postRunnable(new f80(this.f33511b, this.f33512c, 1));
                return;
            default:
                g80 g80Var = this.f33511b;
                String str = this.f33512c;
                h80 h80Var = g80Var.f33842b;
                ...
                for (int i12 = 0; i12 < h80Var.f34211n.f35373w.size(); i12++) {
                    ContactsController.Contact contact = (ContactsController.Contact) h80Var.f34211n.f35373w.get(i12);
