...
public final class f80 extends ViewGroup {
    public AnimatorSet f33560a;
    public boolean f33561b;
    public final ArrayList f33562c;
    ...
    public final void a(org.telegram.ui.Components.n30 n30Var) {
        ...
        AnimatorSet animatorSet = this.f33560a;
        if (animatorSet != null && animatorSet.isRunning()) {
            this.f33560a.setupEndValues();
            this.f33560a.cancel();
        }
        this.f33561b = false;
        AnimatorSet animatorSet2 = new AnimatorSet();
        this.f33560a = animatorSet2;
        animatorSet2.addListener(new org.telegram.ui.Components.al0(7, this, n30Var));
        this.f33560a.setInterpolator(org.telegram.ui.Components.rr.h);
        this.f33560a.setDuration(320L);
        this.e = n30Var;
        ArrayList arrayList = this.f33562c;
        arrayList.clear();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        g80 g80Var = this.h;
        if (i12 > g80Var.f33842x - AndroidUtilities.dp(12.0f)) {
            z11 = true;
        } else {
            z11 = false;
        }
        ...
        if (i13 > g80Var.f33842x - AndroidUtilities.dp(12.0f)) {
            z12 = true;
        } else {
            z12 = false;
        }
        if (!this.f33561b) {
            ...
            if (this.f33560a != null) {
                this.f33563f = AndroidUtilities.dp(28.0f) + dp2;
                this.f33560a.playTogether(arrayList);
                this.f33560a.start();
                this.f33561b = true;
            } else {
                this.f33563f = dp5;
        ...
        if (z12) {
            max = g80Var.f33842x - AndroidUtilities.dp(12.0f);
        } else {
            ...
            max = Math.max(dp6, Math.min(i14, g80Var.f33842x - AndroidUtilities.dp(12.0f)));
        }
        g80Var.f33835b.a(max);
        e80 e80Var = g80Var.d;
        if (e80Var != null) {
            if (this.e != null) {
                i15 = 1;
            ...
            ViewPropertyAnimator animate = e80Var.f33271c.animate();
            float f15 = 0.0f;
            float f16 = 1.0f;
            if (z10) {
                f7 = 1.0f;
            ...
            e80Var.f33272f.e.post(new c0(e80Var, b10, 3));
        }
        setMeasuredDimension(size, this.f33563f);
    }
}
