...
public final class f80 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public bi.o f33578n;
    public FrameLayout f33579r;
    public ci.n6 f33580s;
    ...
    public f80() {
        super(null);
        this.f33574a = new Object();
        this.f33575b = new Object();
        this.f33576c = UserConfig.selectedAccount;
        this.f33581w = 0;
        this.f33582x = false;
        this.f33583y = false;
    }
    ...
    public final void V(boolean z10) {
        ...
        this.f33577f.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.q6, false));
        this.f33578n.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.Sh, false));
        bi.o oVar = this.f33578n;
        ...
        if (z10) {
            ...
            for (int i12 = 0; i12 < this.d.getChildCount(); i12++) {
                ...
                ((TextView) childAt.findViewWithTag(this.f33574a)).setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
                ((TextView) childAt.findViewWithTag(this.f33575b)).setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
            }
            return;
        }
    ...
    public final View createView(Context context) {
        ...
        this.f33579r = frameLayout2;
        this.f33580s.addView(frameLayout2, w7.x5.d(-1, -2.0f, 51, 0.0f, 78.0f, 0.0f, 0.0f));
        TextureView textureView = new TextureView(context);
        this.f33579r.addView(textureView, w7.x5.e(200, 150, 17));
        ...
        this.f33580s.addView(this.d, w7.x5.c(-1.0f, -1));
        ...
        this.f33578n.setText(LocaleController.getString(R.string.StartMessaging));
        this.f33578n.setGravity(17);
        this.f33578n.setTypeface(AndroidUtilities.bold());
        this.f33578n.setTextSize(1, 15.0f);
        this.f33578n.setPadding(AndroidUtilities.dp(34.0f), 0, AndroidUtilities.dp(34.0f), 0);
        this.f33580s.addView(this.f33578n, w7.x5.d(-1, 48.0f, 81, 16.0f, 0.0f, 16.0f, 76.0f));
        this.f33578n.setOnClickListener(new View.OnClickListener(this) {
            public final f80 f31759b;
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        ...
                        return;
                    default:
                        f80 f80Var2 = this.f31759b;
                        if (!f80Var2.f33583y && f80Var2.L != null) {
                            f80Var2.f33583y = true;
                            ...
                            LocaleController.getInstance().applyLanguage(f80Var2.L, true, false, f80Var2.f33576c);
                            return;
                        }
                        return;
                }
        ...
        this.e = qaVar;
        this.f33580s.addView(qaVar, w7.x5.d(66, 5.0f, 49, 0.0f, 350.0f, 0.0f, 0.0f));
        TextView textView = new TextView(context);
        this.f33577f = textView;
        textView.setGravity(17);
        this.f33577f.setTextSize(1, 16.0f);
        this.f33580s.addView(this.f33577f, w7.x5.d(-2, 30.0f, 81, 0.0f, 0.0f, 0.0f, 20.0f));
        this.f33577f.setOnClickListener(new View.OnClickListener(this) {
            public final f80 f31759b;
        ...
        float f7 = 4;
        this.f33580s.addView(frameLayout, w7.x5.d(64, 64.0f, 53, 0.0f, f7, f7, 0.0f));
        this.fragmentView = scrollView;
        NotificationCenter.getGlobalInstance().addObserver(this, NotificationCenter.suggestedLangpack);
        int i13 = this.f33576c;
    ...
    public final ArrayList getThemeDescriptions() {
        return w7.a6.a(new e(this, 18), org.telegram.ui.ActionBar.j6.f18862d6, org.telegram.ui.ActionBar.j6.q6, org.telegram.ui.ActionBar.j6.P9, org.telegram.ui.ActionBar.j6.Q9, org.telegram.ui.ActionBar.j6.Sh, org.telegram.ui.ActionBar.j6.G6);
    }
    ...
    public final void onFragmentDestroy() {
        ...
        NotificationCenter.getInstance(this.f33576c).removeObserver(this, NotificationCenter.configLoaded);
