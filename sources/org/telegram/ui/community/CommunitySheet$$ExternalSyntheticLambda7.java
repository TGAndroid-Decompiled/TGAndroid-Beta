...
public final class CommunitySheet$$ExternalSyntheticLambda7 implements Utilities.Callback2 {
    public final int $r8$classId;
    public final NotificationCenter.NotificationCenterDelegate f$0;
    public final boolean f$1;

    public CommunitySheet$$ExternalSyntheticLambda7(boolean z, NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, int i) {
        this.$r8$classId = i;
            ...
            default:
                ...
                if (obj == null) {
                    ...
                    if (!this.f$1) {
                        ...
                        boolean z = storyRecorder.mode == 1;
                        recordControl.overrideStartModeIsVideoT = -1.0f;
                        recordControl.startModeIsVideo = z;
                        ...
                        if (obj instanceof MediaController.PhotoEntry) {
                            ...
                            if (tLObject instanceof TLRPC.Photo) {
                                ...
                                boolean z3 = tLObject instanceof TLRPC.WebDocument;
                            }
                            anonymousClass7 = anonymousClass25.entitiesView;
                            if (f > 1.0f) {
