...
public abstract class CommunityUtils {
    ...
    public static void lambda$onCommunityLinkSuccess$6(int i, ChatActivity chatActivity) throws Resources.NotFoundException, IOException, NumberFormatException {
        if (i != 2) {
