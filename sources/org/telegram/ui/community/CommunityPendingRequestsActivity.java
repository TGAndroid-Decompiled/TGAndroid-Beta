...
public class CommunityPendingRequestsActivity extends BaseFragment implements FactorAnimator.Target {
            ...
            if (user != null) {
                ...
                new CommunityInviteOnlySheet(getContext(), chat, data.requestFromUser, new Runnable() {
                    ...
                    public final void run() {
                        CommunityPendingRequestsActivity.m4877$r8$lambda$agN6v2Z85kITDOXEQ078tXVcec(this.f$0, data);
                    }
                }).show();
            }
        }
    ...
    public static void m4877$r8$lambda$agN6v2Z85kITDOXEQ078tXVcec(CommunityPendingRequestsActivity communityPendingRequestsActivity, CommunityPendingRequestCell.Data data) {
