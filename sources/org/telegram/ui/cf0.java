...
public final class cf0 extends org.telegram.ui.Components.fw0 {
    public final qg0 E;
    public final org.telegram.ui.Components.lj0 f32699a;
    public final TextView f32700b;
    public final TextView f32701c;
    public final TextView d;
    public final TextView e;
    public final TextView f32702f;
    public w5 h;
    public Bundle f32703n;
    public String f32704r;
    public String f32705s;
    public String v;
    public int f32706w;
    public int f32707x;
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        this.f32703n = bundle;
        this.f32704r = bundle.getString("phoneFormated");
        this.f32705s = bundle.getString("phoneHash");
        this.v = bundle.getString("code");
        this.f32706w = bundle.getInt("startTime");
        this.f32707x = bundle.getInt("waitTime");
        int i10 = R.string.ResetAccountInfo;
        gf.b c10 = gf.b.c();
        this.f32701c.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ResetAccountInfo", i10, LocaleController.addNbsp(c10.b("+" + this.f32704r)))));
        o();
    ...
    public final void n() {
        ...
        this.f32700b.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i10, false));
        this.f32701c.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i10, false));
        this.f32702f.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i10, false));
    ...
    public final void o() {
        ...
        int i11;
        int i12;
        int i13 = this.f32707x;
        i10 = ((org.telegram.ui.ActionBar.m2) this.E).currentAccount;
        int currentTime = i13 - (ConnectionsManager.getInstance(i10).getCurrentTime() - this.f32706w);
        int i14 = 0;
        ...
        Boolean bool = this.f32708y;
        if (bool != null && bool.booleanValue() == z10) {
            return;
        }
        org.telegram.ui.Components.lj0 lj0Var = this.f32699a;
        if (!z10) {
        ...
        this.f32702f.setVisibility(i12);
        if (!z10) {
            i14 = 4;
        }
        this.d.setVisibility(i14);
        this.f32708y = Boolean.valueOf(z10);
    }
}
