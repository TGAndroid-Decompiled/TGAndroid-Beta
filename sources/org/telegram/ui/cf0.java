...
public final class cf0 extends org.telegram.ui.Components.gw0 {
    public final qg0 E;
    public final org.telegram.ui.Components.mj0 f32698a;
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        this.f32702n = bundle;
        this.f32703r = bundle.getString("phoneFormated");
        this.f32704s = bundle.getString("phoneHash");
        this.v = bundle.getString("code");
        this.f32705w = bundle.getInt("startTime");
        this.f32706x = bundle.getInt("waitTime");
        int i10 = R.string.ResetAccountInfo;
        gf.b c10 = gf.b.c();
        this.f32700c.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ResetAccountInfo", i10, LocaleController.addNbsp(c10.b("+" + this.f32703r)))));
        o();
    ...
    public final void n() {
        ...
        this.f32699b.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i10, false));
        this.f32700c.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i10, false));
        this.f32701f.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i10, false));
    ...
    public final void o() {
        ...
        int i11;
        int i12;
        int i13 = this.f32706x;
        i10 = ((org.telegram.ui.ActionBar.m2) this.E).currentAccount;
        int currentTime = i13 - (ConnectionsManager.getInstance(i10).getCurrentTime() - this.f32705w);
        int i14 = 0;
        ...
        Boolean bool = this.f32707y;
        if (bool != null && bool.booleanValue() == z10) {
            return;
        }
        org.telegram.ui.Components.mj0 mj0Var = this.f32698a;
        if (!z10) {
        ...
        this.f32701f.setVisibility(i12);
        if (!z10) {
            i14 = 4;
        }
        this.d.setVisibility(i14);
        this.f32707y = Boolean.valueOf(z10);
    }
}
