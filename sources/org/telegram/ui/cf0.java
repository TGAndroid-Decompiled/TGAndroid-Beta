...
public final class cf0 extends org.telegram.ui.Components.vv0 {
    public final pg0 B;
    public final org.telegram.ui.Components.jj0 f33126a;
    public final TextView f33127b;
    public final TextView f33128c;
    public final TextView d;
    public final TextView e;
    public final TextView f33129f;
    public b6 h;
    public Bundle f33130n;
    public String f33131r;
    public String f33132s;
    public String v;
    public int f33133w;
    public int f33134x;
    ...
    public final void m(Bundle bundle, boolean z4) {
        ...
        this.f33130n = bundle;
        this.f33131r = bundle.getString("phoneFormated");
        this.f33132s = bundle.getString("phoneHash");
        this.v = bundle.getString("code");
        this.f33133w = bundle.getInt("startTime");
        this.f33134x = bundle.getInt("waitTime");
        int i10 = R.string.ResetAccountInfo;
        se.b c3 = se.b.c();
        this.f33128c.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ResetAccountInfo", i10, LocaleController.addNbsp(c3.b("+" + this.f33131r)))));
        o();
    ...
    public final void n() {
        ...
        this.f33127b.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        this.f33128c.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        this.f33129f.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
    ...
    public final void o() {
        ...
        int i11;
        int i12;
        int i13 = this.f33134x;
        i10 = ((org.telegram.ui.ActionBar.p2) this.B).currentAccount;
        int currentTime = i13 - (ConnectionsManager.getInstance(i10).getCurrentTime() - this.f33133w);
        int i14 = 0;
        ...
        org.telegram.ui.Components.jj0 jj0Var = this.f33126a;
        if (!z4) {
        ...
        this.f33129f.setVisibility(i12);
        if (!z4) {
            i14 = 4;
        }
        this.d.setVisibility(i14);
        this.f33135y = Boolean.valueOf(z4);
    }
}
