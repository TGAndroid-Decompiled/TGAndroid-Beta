...
public final class vk extends org.telegram.ui.Components.un0 {
    ...
    public final void b(boolean z10) {
        ...
        if (alVar != null) {
            alVar.setTranslationY(wnVar.f39692w9 + getCurrentHeight());
        }
        if (z10) {
            wnVar.D9 = true;
            wnVar.jc();
    ...
    public final boolean f(zg.o0 o0Var) {
        ...
        wnVar.Ic();
        wnVar.vc();
        wnVar.f39648t3 = wnVar.f39521j0.getSearchField().getText().toString();
        MediaDataController mediaDataController = wnVar.getMediaDataController();
        String str = wnVar.f39648t3;
        long j3 = wnVar.T5;
        long j10 = wnVar.L6;
        i10 = ((org.telegram.ui.ActionBar.m2) wnVar).classGuid;
        long j11 = wnVar.f39452d4;
        TLRPC.User user = wnVar.f39584o3;
        TLRPC.Chat chat = wnVar.f39596p3;
        if (TextUtils.isEmpty(wnVar.f39648t3) && wnVar.f39608q3 == null) {
            z11 = false;
        } else {
            z11 = true;
        }
        mediaDataController.searchMessagesInChat(str, j3, j10, i10, 0, j11, false, user, chat, z11, wnVar.f39608q3);
        AndroidUtilities.hideKeyboard(wnVar.f39521j0.getSearchField());
        return true;
    }
    ...
    public final void h(boolean z10) {
        ...
        if (u0Var != null && u0Var.s() && a() && wnVar.f39660u3 == null) {
            z11 = true;
        } else {
            z11 = false;
        }
