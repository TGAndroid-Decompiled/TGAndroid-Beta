...
public final class zb0 extends org.telegram.ui.ActionBar.o2 {
    ...
    public org.telegram.ui.Components.uv0 f40201c;
    public org.telegram.ui.Components.uv0 d;
    public TLRPC.TL_chatInviteExported e;
    public wb0 f40202f;
    public org.telegram.ui.Cells.e9 h;
    public org.telegram.ui.Cells.w8 f40203n;
    public xb0 f40204r;
    public TextView f40205s;
    public org.telegram.ui.Cells.e9 v;
    public TextView f40206w;
    public org.telegram.ui.Cells.l4 f40207x;
    public org.telegram.ui.Cells.e9 f40208y;
    ...
    public final void V(int i10) {
        int[] iArr;
        long j3 = i10;
        this.f40206w.setText(LocaleController.formatDateAudio(j3, false));
    ...
    public final void W(int i10) {
        ...
        this.f40201c.b(i13, null, strArr);
    }
    ...
    public final void X() {
        ...
        while (true) {
            ...
            if (i10 < iArr.length) {
                ...
                this.f40201c.b(3, null, "1", "10", "100", LocaleController.getString(R.string.NoLimit));
                return;
            }
        }
    }
    ...
    public final void Y(TLRPC.TL_chatInviteExported tL_chatInviteExported) {
        ...
        if (this.fragmentView != null && tL_chatInviteExported != null) {
            ...
            wb0 wb0Var = this.f40202f;
            if (wb0Var != null) {
                wb0Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18862d6, false));
                this.f40202f.setChecked(tL_chatInviteExported.request_needed);
            }
            boolean z10 = true;
            ...
            org.telegram.ui.Cells.w8 w8Var = this.f40203n;
            if (w8Var != null) {
            ...
            if (tL_chatInviteExported.subscription_pricing != null) {
                wb0 wb0Var2 = this.f40202f;
                if (wb0Var2 != null) {
                    wb0Var2.setChecked(false);
                    this.f40202f.setCheckBoxIcon(R.drawable.permission_locked);
                }
            ...
            if (xb0Var != null) {
                ...
                this.f40204r.setText(Long.toString(tL_chatInviteExported.subscription_pricing.amount));
                this.f40204r.f20239b.setClickable(false);
                this.f40204r.f20239b.setFocusable(false);
                this.f40204r.f20239b.setFocusableInTouchMode(false);
                this.f40204r.f20239b.setLongClickable(false);
            }
        }
    }
    ...
    public final void Z(boolean z10) {
        ...
        org.telegram.ui.Components.uv0 uv0Var = this.f40201c;
        if (z10) {
            i11 = 0;
        } else {
            i11 = 8;
    ...
    public final View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new x70(this, 3));
        ...
        ub0Var.addView(this.f40207x);
        org.telegram.ui.Components.uv0 uv0Var = new org.telegram.ui.Components.uv0(context, null);
        this.d = uv0Var;
        ub0Var.addView(uv0Var);
        TextView textView2 = new TextView(context);
        this.f40206w = textView2;
        textView2.setPadding(AndroidUtilities.dp(22.0f), 0, AndroidUtilities.dp(22.0f), 0);
        this.f40206w.setGravity(16);
        this.f40206w.setTextSize(1, 16.0f);
        this.f40206w.setHint(LocaleController.getString(R.string.TimeLimitHint));
        this.f40206w.setOnClickListener(new uv(14, this, context));
        ...
        ub0Var.addView(this.f40206w, w7.x5.n(-1, 50));
        ...
        this.f40201c = uv0Var2;
        uv0Var2.setCallback(new pb0(this, 3));
        X();
        ub0Var.addView(this.f40201c);
        ...
        this.f40202f.setTag(Integer.valueOf(i13));
        this.f40202f.f(LocaleController.getString(R.string.ApproveNewMembers2), false, false);
        this.f40202f.setOnClickListener(new ai.j3(7, this, z10));
        ub0Var.addView(this.f40202f, w7.x5.n(-1, 56));
        ...
        if (chat == null || chat.username == null) {
            ...
            if ((this.e == null && ChatObject.isChannelAndNotMegaGroup(MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(j3))) && chatFull != null && chatFull.paid_media_allowed) || ((tL_chatInviteExported = this.e) != null && tL_chatInviteExported.subscription_pricing != null)) {
                ...
                this.f40203n.setDrawCheckRipple(true);
                this.f40203n.f(LocaleController.getString(R.string.RequireMonthlyFee), false, true);
                if (this.e != null) {
                    this.f40203n.setCheckBoxIcon(R.drawable.permission_locked);
                    this.f40203n.setEnabled(false);
                }
                this.f40203n.setOnClickListener(new uv(15, this, new Runnable[1]));
                ub0Var.addView(this.f40203n, w7.x5.n(-1, 48));
                TextView textView3 = new TextView(context);
                this.f40205s = textView3;
                textView3.setTextSize(1, 16.0f);
                this.f40205s.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.A6, false));
                ...
                this.f40204r = xb0Var;
                xb0Var.f20239b.setInputType(2);
                this.f40204r.f20239b.setRawInputType(2);
                this.f40204r.setBackgroundColor(getThemedColor(i13));
                xb0 xb0Var2 = this.f40204r;
                xb0Var2.getClass();
                org.telegram.ui.Cells.g gVar = new org.telegram.ui.Cells.g(xb0Var2, 4);
                org.telegram.ui.Cells.g3 g3Var = xb0Var2.f20239b;
                g3Var.setImeOptions(6);
                g3Var.setOnEditorActionListener(new m.s2(gVar, 2));
                this.f40204r.addView(this.f40205s, w7.x5.d(-2, -2.0f, 21, 0.0f, 0.0f, 19.0f, 0.0f));
                xb0 xb0Var3 = this.f40204r;
                ...
                org.telegram.ui.Cells.g3 g3Var2 = xb0Var3.f20239b;
                ...
                ub0Var.addView(this.f40204r, w7.x5.n(-1, 48));
                this.f40204r.setVisibility(8);
        ...
        if (i11 == 1) {
            ...
            this.I.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19082p7, false));
        ...
        this.H = frameLayout;
        int i16 = org.telegram.ui.ActionBar.j6.f18806a7;
        ...
        this.f40207x.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
        this.d.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
        this.f40206w.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
        this.E.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
        this.f40201c.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
        ...
        y8Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i16, false));
        ...
        this.f40206w.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i15, false));
        this.f40206w.setHintTextColor(org.telegram.ui.ActionBar.j6.w0(null, i14, false));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f40207x, 0, new Class[]{org.telegram.ui.Cells.l4.class}, new String[]{"textView"}, null, null, -1, null, i10));
        ...
        org.telegram.ui.Cells.l4 l4Var = this.f40207x;
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f40201c, 1, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f40206w, 1, null, null, null, null, i11));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f40208y, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, i12));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, null, null, null, eVar, org.telegram.ui.ActionBar.j6.f19244y6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, null, null, null, eVar, org.telegram.ui.ActionBar.j6.Sh));
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, null, null, null, eVar, org.telegram.ui.ActionBar.j6.f19082p7));
        return arrayList;
    }
}
