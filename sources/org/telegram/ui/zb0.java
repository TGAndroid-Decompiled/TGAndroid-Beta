...
public final class zb0 extends org.telegram.ui.ActionBar.o2 {
    ...
    public org.telegram.ui.Components.uv0 f40206c;
    public org.telegram.ui.Components.uv0 d;
    public TLRPC.TL_chatInviteExported e;
    public wb0 f40207f;
    public org.telegram.ui.Cells.e9 h;
    public org.telegram.ui.Cells.w8 f40208n;
    public xb0 f40209r;
    public TextView f40210s;
    public org.telegram.ui.Cells.e9 v;
    public TextView f40211w;
    public org.telegram.ui.Cells.l4 f40212x;
    public org.telegram.ui.Cells.e9 f40213y;
    ...
    public final void V(int i10) {
        int[] iArr;
        long j3 = i10;
        this.f40211w.setText(LocaleController.formatDateAudio(j3, false));
    ...
    public final void W(int i10) {
        ...
        this.f40206c.b(i13, null, strArr);
    }
    ...
    public final void X() {
        ...
        while (true) {
            ...
            if (i10 < iArr.length) {
                ...
                this.f40206c.b(3, null, "1", "10", "100", LocaleController.getString(R.string.NoLimit));
                return;
            }
        }
    }
    ...
    public final void Y(TLRPC.TL_chatInviteExported tL_chatInviteExported) {
        ...
        if (this.fragmentView != null && tL_chatInviteExported != null) {
            ...
            wb0 wb0Var = this.f40207f;
            if (wb0Var != null) {
                wb0Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18863d6, false));
                this.f40207f.setChecked(tL_chatInviteExported.request_needed);
            }
            boolean z10 = true;
            ...
            org.telegram.ui.Cells.w8 w8Var = this.f40208n;
            if (w8Var != null) {
            ...
            if (tL_chatInviteExported.subscription_pricing != null) {
                wb0 wb0Var2 = this.f40207f;
                if (wb0Var2 != null) {
                    wb0Var2.setChecked(false);
                    this.f40207f.setCheckBoxIcon(R.drawable.permission_locked);
                }
            ...
            if (xb0Var != null) {
                ...
                this.f40209r.setText(Long.toString(tL_chatInviteExported.subscription_pricing.amount));
                this.f40209r.f20240b.setClickable(false);
                this.f40209r.f20240b.setFocusable(false);
                this.f40209r.f20240b.setFocusableInTouchMode(false);
                this.f40209r.f20240b.setLongClickable(false);
            }
        }
    }
    ...
    public final void Z(boolean z10) {
        ...
        org.telegram.ui.Components.uv0 uv0Var = this.f40206c;
        if (z10) {
            i11 = 0;
        } else {
            i11 = 8;
    ...
    public final View createView(Context context) {
        ...
        ub0Var.addView(this.f40212x);
        org.telegram.ui.Components.uv0 uv0Var = new org.telegram.ui.Components.uv0(context, null);
        this.d = uv0Var;
        ub0Var.addView(uv0Var);
        TextView textView2 = new TextView(context);
        this.f40211w = textView2;
        textView2.setPadding(AndroidUtilities.dp(22.0f), 0, AndroidUtilities.dp(22.0f), 0);
        this.f40211w.setGravity(16);
        this.f40211w.setTextSize(1, 16.0f);
        this.f40211w.setHint(LocaleController.getString(R.string.TimeLimitHint));
        this.f40211w.setOnClickListener(new uv(14, this, context));
        ...
        ub0Var.addView(this.f40211w, w7.x5.n(-1, 50));
        ...
        this.f40206c = uv0Var2;
        uv0Var2.setCallback(new pb0(this, 3));
        X();
        ub0Var.addView(this.f40206c);
        ...
        this.f40207f.setTag(Integer.valueOf(i13));
        this.f40207f.f(LocaleController.getString(R.string.ApproveNewMembers2), false, false);
        this.f40207f.setOnClickListener(new ai.j3(7, this, z10));
        ub0Var.addView(this.f40207f, w7.x5.n(-1, 56));
        ...
        if (chat == null || chat.username == null) {
            ...
            if ((this.e == null && ChatObject.isChannelAndNotMegaGroup(MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(j3))) && chatFull != null && chatFull.paid_media_allowed) || ((tL_chatInviteExported = this.e) != null && tL_chatInviteExported.subscription_pricing != null)) {
                ...
                this.f40208n.setDrawCheckRipple(true);
                this.f40208n.f(LocaleController.getString(R.string.RequireMonthlyFee), false, true);
                if (this.e != null) {
                    this.f40208n.setCheckBoxIcon(R.drawable.permission_locked);
                    this.f40208n.setEnabled(false);
                }
                this.f40208n.setOnClickListener(new uv(15, this, new Runnable[1]));
                ub0Var.addView(this.f40208n, w7.x5.n(-1, 48));
                TextView textView3 = new TextView(context);
                this.f40210s = textView3;
                textView3.setTextSize(1, 16.0f);
                this.f40210s.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.A6, false));
                ...
                this.f40209r = xb0Var;
                xb0Var.f20240b.setInputType(2);
                this.f40209r.f20240b.setRawInputType(2);
                this.f40209r.setBackgroundColor(getThemedColor(i13));
                xb0 xb0Var2 = this.f40209r;
                xb0Var2.getClass();
                org.telegram.ui.Cells.g gVar = new org.telegram.ui.Cells.g(xb0Var2, 4);
                org.telegram.ui.Cells.g3 g3Var = xb0Var2.f20240b;
                g3Var.setImeOptions(6);
                g3Var.setOnEditorActionListener(new m.s2(gVar, 2));
                this.f40209r.addView(this.f40210s, w7.x5.d(-2, -2.0f, 21, 0.0f, 0.0f, 19.0f, 0.0f));
                xb0 xb0Var3 = this.f40209r;
                ...
                org.telegram.ui.Cells.g3 g3Var2 = xb0Var3.f20240b;
                ...
                ub0Var.addView(this.f40209r, w7.x5.n(-1, 48));
        ...
        if (i11 == 1) {
            ...
            this.I.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19083p7, false));
        ...
        this.H = frameLayout;
        int i16 = org.telegram.ui.ActionBar.j6.f18807a7;
        ...
        this.f40212x.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
        this.d.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
        this.f40211w.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
        this.E.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
        this.f40206c.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
        ...
        this.f40211w.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i15, false));
        this.f40211w.setHintTextColor(org.telegram.ui.ActionBar.j6.w0(null, i14, false));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f40212x, 0, new Class[]{org.telegram.ui.Cells.l4.class}, new String[]{"textView"}, null, null, -1, null, i10));
        ...
        org.telegram.ui.Cells.l4 l4Var = this.f40212x;
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f40206c, 1, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f40211w, 1, null, null, null, null, i11));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f40213y, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, i12));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, null, null, null, eVar, org.telegram.ui.ActionBar.j6.f19245y6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, null, null, null, eVar, org.telegram.ui.ActionBar.j6.Sh));
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, null, null, null, eVar, org.telegram.ui.ActionBar.j6.f19083p7));
        return arrayList;
    }
}
