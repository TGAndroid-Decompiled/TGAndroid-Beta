...
public final class pr0 implements Utilities.Callback {
    ...
    public final PhotoViewer f36677b;

    public pr0(PhotoViewer photoViewer, int i10) {
        this.f36676a = i10;
        this.f36677b = photoViewer;
    }
    ...
    public final void run(Object obj) {
        ...
        switch (this.f36676a) {
            case 0:
                PhotoViewer photoViewer = this.f36677b;
                qg.k2 k2Var = (qg.k2) obj;
                Drawable[] drawableArr = PhotoViewer.U8;
                try {
                    boolean isEmpty = TextUtils.isEmpty(((MediaController.MediaEditState) photoViewer.f31245g7.get(photoViewer.P4)).filterPath);
                    ...
                    photoViewer.f31357t5.post(new jr0(photoViewer, 9));
                    return;
                } catch (Exception e) {
                    FileLog.e(e);
                    return;
            ...
            case 1:
                Uri uri = (Uri) obj;
                org.telegram.ui.Components.xc.F(this.f36677b.f31221e0, true).j();
                return;
            case 2:
                PhotoViewer photoViewer2 = this.f36677b;
                photoViewer2.L1.f41798h2 = photoViewer2.K1.c();
                photoViewer2.f31221e0.invalidate();
                int max = Math.max(((Integer) obj).intValue(), photoViewer2.L1.f41802j2);
                ...
                ValueAnimator valueAnimator = photoViewer2.f31350s7;
                if (valueAnimator != null) {
                    valueAnimator.cancel();
                    photoViewer2.f31350s7 = null;
                }
                if (photoViewer2.f31365u4 != 3) {
                    f7 = 0.0f;
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(photoViewer2.Z5, f7);
                photoViewer2.f31350s7 = ofFloat;
                ofFloat.addUpdateListener(new ir0(photoViewer2, 9));
                photoViewer2.f31350s7.setDuration(320L);
                ValueAnimator valueAnimator2 = photoViewer2.f31350s7;
                org.telegram.ui.Components.qr qrVar = org.telegram.ui.Components.qr.h;
                valueAnimator2.setInterpolator(qrVar);
                photoViewer2.f31350s7.start();
                ...
                ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(photoViewer2.L1.f41787c1, property, Math.min(0, AndroidUtilities.dp(40.0f) + i11));
                ci.x5 x5Var = photoViewer2.L1.f41793f1;
                ...
                if (!au0Var.f41798h2 && !au0Var.f41796g2) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                ...
                TextView textView3 = au0Var.f41821z1;
                if (!au0Var.f41798h2 && !au0Var.f41796g2) {
                    z13 = false;
                } else {
                    z13 = true;
                ...
                return;
            case 3:
                PhotoViewer photoViewer3 = this.f36677b;
                MediaController.PhotoEntry photoEntry = (MediaController.PhotoEntry) obj;
                if (!photoViewer3.f31329q5.f28103b.N && (i10 = photoViewer3.P4) >= 0 && i10 < photoViewer3.f31245g7.size() && (photoViewer3.f31245g7.get(photoViewer3.P4) instanceof MediaController.PhotoEntry)) {
                    org.telegram.ui.Components.sf0 sf0Var = photoViewer3.f31329q5;
                    ci.b4 b4Var = sf0Var.h;
                    if (b4Var != null) {
                        b4Var.dismiss();
                        sf0Var.h = null;
                    }
                    photoViewer3.f31329q5.f28103b.setLoading(true);
                    Utilities.globalQueue.postRunnable(new org.telegram.ui.Components.vn0(photoViewer3, photoEntry, (MediaController.PhotoEntry) photoViewer3.f31245g7.get(photoViewer3.P4), PhotoViewer.y1(), 28));
                    return;
                }
                return;
            case 4:
                PhotoViewer photoViewer4 = this.f36677b;
                Integer num = (Integer) obj;
                Object obj2 = photoViewer4.f31245g7.get(photoViewer4.P4);
                ...
                return;
            case 5:
                PhotoViewer photoViewer5 = this.f36677b;
                ...
                photoViewer5.f31222e1.setTranslationY(photoViewer5.U1.getAlpha() * (-org.telegram.messenger.l0.b(46.0f, num2.intValue(), 0)));
                photoViewer5.f31231f1.setTranslationY(photoViewer5.U1.getAlpha() * (-org.telegram.messenger.l0.b(46.0f, num2.intValue(), 0)));
                photoViewer5.f31239g1.setTranslationY(photoViewer5.U1.getAlpha() * (-org.telegram.messenger.l0.b(46.0f, num2.intValue(), 0)));
                ...
                return;
            case 6:
                PhotoViewer photoViewer6 = this.f36677b;
                Integer num3 = (Integer) obj;
                Object obj3 = photoViewer6.f31245g7.get(photoViewer6.P4);
            ...
            case 7:
                ...
                return;
            case 8:
                PhotoViewer photoViewer7 = this.f36677b;
                Boolean bool = (Boolean) obj;
                Drawable[] drawableArr2 = PhotoViewer.U8;
                photoViewer7.B0(0, false);
                return;
            default:
                PhotoViewer photoViewer8 = this.f36677b;
