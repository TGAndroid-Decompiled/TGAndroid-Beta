        ...
        switch (i10) {
            ...
            case 2:
                ...
                if (chatFull != null) {
                    ...
                    mf1 mf1Var = new mf1(this, this.f36214a, i11, iVar, chatFull.f18110id, eg1Var, j10);
                    mf1Var.f22678l0 = new ai.z1(this, j10, 11);
                    mf1Var.show();
                    return;
                }
                return;
            ...
            case 5:
                if (hashSet.size() > 0) {
                    eg1Var.C0 = true;
                    eg1Var.N0 = true;
                    TopicsController topicsController2 = eg1Var.f33326s;
                    long j11 = eg1Var.f33291a;
            ...
            case 8:
                ...
                for (int i14 = 0; i14 < arrayList2.size(); i14++) {
                    ...
                    if (findTopic != null) {
                        eg1Var.getMessagesController().markMentionsAsRead(-j3, findTopic.f18161id);
                        ...
                        messagesController.markDialogAsRead(j12, i15, 0, i12, false, findTopic.f18161id, 0, true, 0);
                        eg1Var.getMessagesStorage().updateRepliesMaxReadId(eg1Var.f33291a, findTopic.f18161id, findTopic.top_message, 0, true);
                    }
                }
                eg1Var.C0();
                return;
            ...
            case 13:
                ...
                while (true) {
                    if (i17 < eg1Var.N.getChildCount()) {
                        ...
                        if ((childAt instanceof bg1) && (tL_forumTopic = (bg1Var = (bg1) childAt).N) != null && tL_forumTopic.f18161id == 1) {
                ...
                if (tL_forumTopic2 == null) {
                    while (true) {
                        if (i13 < arrayList.size()) {
                            if (arrayList.get(i13) != null && ((vf1) arrayList.get(i13)).f38528c != null && ((vf1) arrayList.get(i13)).f38528c.f18161id == 1) {
                                tL_forumTopic2 = ((vf1) arrayList.get(i13)).f38528c;
                            } else {
                                i13++;
                            }
                        }
