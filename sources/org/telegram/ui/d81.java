...
public final class d81 extends FrameLayout {
    public final ImageView f32979a;
    public final TextView f32980b;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.e) {
            canvas.drawRect(AndroidUtilities.dp(64.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight(), org.telegram.ui.ActionBar.i6.f18955k0);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (r02 != null) {
            ...
            sb2.append((Object) this.f32980b.getText());
            sb2.append("\n");
            sb2.append((Object) this.f32981c.getText());
            sb2.append("\n");
            if (r02.h) {
