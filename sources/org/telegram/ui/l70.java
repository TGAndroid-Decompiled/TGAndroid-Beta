...
public final class l70 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.t40 {
    ...
    public k70 Y;
    public j70 f35334a;
    public org.telegram.ui.Components.ll0 f35335b;
    ...
    public jd f35338n;
    public final org.telegram.ui.Components.f9 f35339r;
    ...
    public l70(Bundle bundle) {
        ...
        this.f35339r = new org.telegram.ui.Components.f9((org.telegram.ui.ActionBar.e6) null);
    ...
    public final void Z(boolean z10, boolean z11) {
        ...
        if (z11) {
            ...
            if (z10) {
                ...
                id idVar = this.f35337f;
                Property property = View.ALPHA;
                animatorSet2.playTogether(ObjectAnimator.ofFloat(idVar, property, 0.0f), ObjectAnimator.ofFloat(this.f35338n, property, 1.0f));
            } else {
                this.f35337f.setVisibility(0);
                AnimatorSet animatorSet3 = this.h;
                id idVar2 = this.f35337f;
                Property property2 = View.ALPHA;
                animatorSet3.playTogether(ObjectAnimator.ofFloat(idVar2, property2, 1.0f), ObjectAnimator.ofFloat(this.f35338n, property2, 0.0f));
            }
    ...
    public final boolean dismissDialogOnPause(Dialog dialog) {
        if (dialog != this.N.f28282c && super.dismissDialogOnPause(dialog)) {
            return true;
        }
        return false;
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35335b, 32768, null, null, null, null, org.telegram.ui.ActionBar.i6.f19110s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35335b, 4096, null, null, null, null, org.telegram.ui.ActionBar.i6.f18923i6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35335b, 33554432, null, null, null, null, org.telegram.ui.ActionBar.i6.f18980l7));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35335b, 33554432, null, null, null, null, org.telegram.ui.ActionBar.i6.f18999m7));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35335b, 33554432, null, null, null, null, org.telegram.ui.ActionBar.i6.f19019n7));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35335b, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.i6.f18955k0, null, null, org.telegram.ui.ActionBar.i6.f18835d7));
        org.telegram.ui.Components.ju juVar = this.f35336c;
        int i11 = org.telegram.ui.ActionBar.i6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.k6(juVar, 4, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35336c, 8388608, null, null, null, null, org.telegram.ui.ActionBar.i6.Xh));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35336c, 16777216, null, null, null, null, org.telegram.ui.ActionBar.i6.Yh));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35336c, 32, null, null, null, null, org.telegram.ui.ActionBar.i6.f18961k6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35336c, 65568, null, null, null, null, org.telegram.ui.ActionBar.i6.f18979l6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35335b, 32, new Class[]{org.telegram.ui.Cells.a7.class}, null, null, null, org.telegram.ui.ActionBar.i6.f18798b7));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35335b, 48, new Class[]{org.telegram.ui.Cells.a7.class}, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35335b, 0, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.L6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35335b, 4, new Class[]{org.telegram.ui.Cells.g4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.f18789ai));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35335b, 262148, new Class[]{org.telegram.ui.Cells.g4.class}, new String[]{"statusTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.f19018n6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35335b, 262148, new Class[]{org.telegram.ui.Cells.g4.class}, new String[]{"statusTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.f19215y6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35335b, 0, new Class[]{org.telegram.ui.Cells.g4.class}, null, org.telegram.ui.ActionBar.i6.f19083r0, eVar, org.telegram.ui.ActionBar.i6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35335b, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35336c, 4, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f35336c, 8388608, null, null, null, null, org.telegram.ui.ActionBar.i6.H6));
        return arrayList;
    }
    ...
    public final void onTransitionAnimationEnd(boolean z10, boolean z11) {
        if (z10) {
            org.telegram.ui.Components.eu euVar = this.f35336c.f25419a;
            euVar.requestFocus();
