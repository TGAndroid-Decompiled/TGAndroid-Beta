...
public final class s30 implements View.OnClickListener {
    public final w5 f37378a = new w5(this, 5);
    public final k60 f37379b;
    ...
    public final void onClick(View view) {
        ...
        k60 k60Var = this.f37379b;
        q30 q30Var = k60Var.f35111x;
        ...
        if (k60Var.f35017a1 != null && k60Var.F1 != 3) {
            int i11 = 6;
            int i12 = 0;
            if (k60Var.r1() && !k60Var.f35017a1.isScheduled()) {
                c40 c40Var = k60Var.a2;
                if (c40Var != null && c40Var.f29038b && (AndroidUtilities.isTablet() || k60.F3 == k60Var.q1())) {
                    k60Var.e1(null);
                    if (k60.F3) {
                        AndroidUtilities.runOnUIThread(new i10(this, 5), 200L);
                    }
                    k60Var.f35050i0.setRequestedOrientation(-1);
                    return;
                    ...
                    if (k60Var.q1()) {
                        k60Var.f35050i0.setRequestedOrientation(6);
                        return;
                    } else {
                        k60Var.f35050i0.setRequestedOrientation(1);
                        return;
            ...
            if (i13 == 5) {
                if (!k60Var.H1) {
                    ...
                    accountInstance.getConnectionsManager().sendRequest(startscheduledgroupcall, new RequestDelegate(this) {
                        ...
                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                            switch (r2) {
                                case 0:
                                    s30 s30Var = this.f37077b;
                                    if (tLObject != null) {
                                        s30Var.f37379b.d.getMessagesController().processUpdates((TLRPC.Updates) tLObject, false);
                                        return;
                                    } else {
                                        s30Var.getClass();
                                        return;
                                ...
                                default:
                                    s30 s30Var2 = this.f37077b;
                                    if (tLObject != null) {
                                        s30Var2.f37379b.d.getMessagesController().processUpdates((TLRPC.Updates) tLObject, false);
                                        return;
                                    } else {
                                        s30Var2.getClass();
                                        return;
                ...
                if (VoIPService.getSharedInstance() != null && (i10 = k60Var.T1) != 1 && i10 != 2 && i10 != 6 && i10 != 5) {
                    ...
                    if (i14 != 2 && i14 != 4) {
                        try {
                            if (i14 == 0) {
                                if (Build.VERSION.SDK_INT >= 23 && (launchActivity = k60Var.f35050i0) != null && launchActivity.checkSelfPermission("android.permission.RECORD_AUDIO") != 0) {
                        ...
                        yi0Var.P(i15);
                        yi0Var.S(i15 - 1, this.f37378a);
                        q30Var.setAnimation(yi0Var);
                        yi0Var.M(i12);
                        q30Var.d();
                        if (k60Var.F1 == 2) {
                            long peerId = MessageObject.getPeerId(((TLRPC.GroupCallParticipant) k60Var.f35017a1.participants.f(MessageObject.getPeerId(k60Var.A0))).peer);
                ...
                if (i13 == 6 && (i40Var = k60Var.f35068n0) != null) {
                    i40Var.b(true);
                }
                TL_phone.toggleGroupCallStartSubscription togglegroupcallstartsubscription = new TL_phone.toggleGroupCallStartSubscription();
                togglegroupcallstartsubscription.call = k60Var.f35017a1.getInputGroupCall();
                TLRPC.GroupCall groupCall = k60Var.f35017a1.call;
                ...
                if (k60Var.f35017a1.call.schedule_start_subscribed) {
                    i11 = 7;
                }
                k60Var.J1(i11, true);
            }
