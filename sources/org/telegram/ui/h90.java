    ...
    public final void run() {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                return;
            case 3:
                if (!launchActivity.f30861q0.getFragmentStack().isEmpty()) {
                    launchActivity.f30861q0.getFragmentStack().get(0).showDialog(new org.telegram.ui.Components.wx0(launchActivity, launchActivity.f30849j0, launchActivity.f30845h0, launchActivity.f30847i0));
                    return;
                }
                return;
            case 4:
            ...
            case 5:
                ...
                ArrayList arrayList2 = launchActivity.f30839e0;
            ...
            case 8:
                ...
                return;
            case 9:
                launchActivity.f30868t1 = null;
                return;
            default:
                launchActivity.f30870u1 = null;
                return;
        }
    }
}
