...
public final class e70 extends org.telegram.ui.Components.uk0 {
    ...
    public final ArrayList f33310r = new ArrayList();
            ...
            if (z10) {
                ...
                for (int i12 = 0; i12 < size2; i12++) {
                    ...
                    if (DialogObject.isChatDialog(dialog2.f18125id) && (chat = g70Var.getMessagesController().getChat(Long.valueOf(-dialog2.f18125id))) != null && chat.migrated_to == null && (!ChatObject.isChannel(chat) || chat.megagroup)) {
                        this.f33310r.add(chat);
                    }
                }
            }
            Collections.sort(this.f33310r, new Object());
            TLObject tLObject = null;
            int i13 = 0;
            while (i13 < this.f33310r.size()) {
                TLObject tLObject2 = (TLObject) this.f33310r.get(i13);
                if (tLObject != null) {
                ...
                ArrayList arrayList2 = this.f33310r;
    ...
    public final String F(int i10) {
        String str;
        String str2;
        if (!this.f33309n && i10 >= this.E) {
            ArrayList arrayList = this.f33310r;
            int size = arrayList.size();
            int i11 = this.E;
            if (i10 < size + i11) {
                TLObject tLObject = (TLObject) arrayList.get(i10 - i11);
                if (tLObject instanceof f70) {
                    return ((f70) tLObject).f33572a;
                }
    ...
    public final void L(String str) {
        ...
        this.d.clear();
        this.e.clear();
        this.f33308f.f(null, null);
        gg.c2 c2Var = this.f33308f;
        g70 g70Var = this.I;
    ...
    public final int h() {
        ...
        this.E = i10;
        int size4 = this.f33310r.size() + i10;
        if (g70Var.R) {
            if (j10 != 0) {
    ...
    public final int j(int i10) {
        if (this.f33309n) {
            if (i10 == this.f33308f.d.size() + this.d.size()) {
                return 0;
            }
            return 1;
        } else if (i10 != this.f33312w) {
            if (i10 != this.f33311s) {
                if (i10 != this.f33313x && i10 != this.f33314y) {
                    if (this.F != 0 && i10 == 0) {
                        return 2;
                    }
                    if (this.G == i10) {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 != 0) {
            ...
            if (i11 != 1) {
                if (i11 == 2) {
                    ...
                    if (i10 == this.f33312w) {
                        ...
                        r8Var.e(org.telegram.ui.ActionBar.j6.f19028m6, org.telegram.ui.ActionBar.j6.G6);
                        return;
                    } else {
            ...
            if (this.f33309n) {
            ...
            } else if (i10 == this.f33313x) {
                f4Var.f20087r = true;
                f4Var.f20085f = "premium";
                f4Var.f20082a.setImageDrawable(org.telegram.ui.Cells.f4.b(f4Var.getContext(), false));
                f4Var.f20083b.l(LocaleController.getString(R.string.PrivacyPremium), false);
                org.telegram.ui.ActionBar.k5 k5Var = f4Var.f20084c;
                int i12 = org.telegram.ui.ActionBar.j6.f19245y6;
                k5Var.setTag(Integer.valueOf(i12));
                if (f4Var.K) {
                    i12 = org.telegram.ui.ActionBar.j6.f19074og;
                }
                ...
                f4Var.c(z11, false);
                return;
            } else if (i10 == this.f33314y) {
                f4Var.f20088s = true;
                f4Var.f20085f = "miniapps";
                org.telegram.ui.Components.u9 u9Var = f4Var.f20082a;
                f4Var.getContext();
                u9Var.setImageDrawable(org.telegram.ui.Cells.f4.a(false));
                f4Var.f20083b.l(LocaleController.getString(R.string.PrivacyMiniapps), false);
                org.telegram.ui.ActionBar.k5 k5Var2 = f4Var.f20084c;
                int i13 = org.telegram.ui.ActionBar.j6.f19245y6;
                k5Var2.setTag(Integer.valueOf(i13));
                if (f4Var.K) {
                    i13 = org.telegram.ui.ActionBar.j6.f19074og;
                }
        ...
        if (this.f33309n) {
            ...
            if (i14 >= 0 && i14 < arrayList.size()) {
                ...
                if (tLObject2 instanceof f70) {
                    u3Var.setText(((f70) tLObject2).f33572a.toUpperCase());
                }
            }
        }
        if (i10 == this.v) {
