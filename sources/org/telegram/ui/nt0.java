...
public final class nt0 extends org.telegram.ui.Components.u00 {
    public final vs0 e;
    public final PhotoViewer f36161f;

    public nt0(PhotoViewer photoViewer, vs0 vs0Var) {
        super(false);
        this.f36161f = photoViewer;
        this.e = vs0Var;
    }
    ...
    public final CharSequence d() {
        ...
        PhotoViewer photoViewer = this.f36161f;
        int[] iArr = photoViewer.f31024m3;
        ...
        int[] iArr2 = photoViewer.f31034n3;
    ...
    public final float k() {
        return this.f36161f.f31060q3.c();
    }
