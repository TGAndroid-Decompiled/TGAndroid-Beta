...
public final class vg1 extends ScrollView {
    ...
    public vg1(wg1 wg1Var, Context context) {
        super(context);
        this.e = wg1Var;
        this.f39095a = new int[2];
        this.f39096b = new Rect();
        this.f39097c = true;
    }
    ...
    public final void onScrollChanged(int i10, int i11, int i12, int i13) {
        ...
        wg1 wg1Var = this.e;
        TextView textView = wg1Var.f39685c;
        if (textView != null) {
            int[] iArr = this.f39095a;
            textView.getLocationOnScreen(iArr);
            int measuredHeight = wg1Var.f39685c.getMeasuredHeight() + iArr[1];
            ...
            if (wg1Var.f39685c.getTag() == null) {
                z10 = true;
            } else {
                z10 = false;
            }
            if (z4 != z10) {
                TextView textView2 = wg1Var.f39685c;
                if (z4) {
                    num = null;
                } else {
                    num = 1;
    ...
    public final void requestChildFocus(View view, View view2) {
        if (Build.VERSION.SDK_INT < 29 && view2 != null && !this.f39097c) {
