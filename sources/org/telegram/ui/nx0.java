...
public final class nx0 extends s4.o {
    public int f35620b;
    public final SparseIntArray f35621c = new SparseIntArray();
    ...
    public final boolean b(int i10, int i11) {
        int i12 = this.f35621c.get(i10, -1);
    ...
    public final void f(SparseIntArray sparseIntArray) {
        ...
        g(6, privacyControlActivity.f31171g0, sparseIntArray);
        ...
        g(19, privacyControlActivity.f31162a0, sparseIntArray);
        g(20, privacyControlActivity.f31164b0, sparseIntArray);
        g(21, privacyControlActivity.f31166c0, sparseIntArray);
        i14 = privacyControlActivity.readRow;
        g(22, i14, sparseIntArray);
        g(23, privacyControlActivity.f31167d0, sparseIntArray);
        g(24, privacyControlActivity.f31168e0, sparseIntArray);
        g(25, privacyControlActivity.f31170f0, sparseIntArray);
        g(26, privacyControlActivity.f31172h0, sparseIntArray);
        i15 = privacyControlActivity.priceRow;
        g(27, i15, sparseIntArray);
        g(28, privacyControlActivity.f31174j0, sparseIntArray);
        i16 = privacyControlActivity.showGiftIconRow;
        g(29, i16, sparseIntArray);
        g(30, privacyControlActivity.f31175k0, sparseIntArray);
        i17 = privacyControlActivity.giftTypesHeaderRow;
        g(31, i17, sparseIntArray);
        g(32, privacyControlActivity.m0, sparseIntArray);
        g(33, privacyControlActivity.f31176l0, sparseIntArray);
        g(34, privacyControlActivity.f31178n0, sparseIntArray);
        g(35, privacyControlActivity.f31179o0, sparseIntArray);
        g(36, privacyControlActivity.f31180p0, sparseIntArray);
        g(37, privacyControlActivity.f31181q0, sparseIntArray);
    }
}
