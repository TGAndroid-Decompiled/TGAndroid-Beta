...
public final class g9 extends FrameLayout {
    ...
    public final org.telegram.ui.Components.j9 f33864b;
    public final ImageView f33865c;
    ...
    public g9(Context context, int i10) {
        ...
        j6Var.f20488b0 = AndroidUtilities.dp(f7);
        j6Var.f20489c0 = -AndroidUtilities.dp(7.0f);
        ...
        if (checkBoxBase.f22215x != w02) {
            checkBoxBase.f22215x = w02;
            checkBoxBase.b();
        }
