...
public abstract class y00 extends FrameLayout {
    public final org.telegram.ui.ActionBar.n2 f42927a;
    public final int f42928b;
    public final int f42929c;
    public final Drawable d;
    public final Drawable f42930e;
    public final org.telegram.ui.Components.q6 f42931f;
    public final org.telegram.ui.Components.q6 h;
    public final Paint f42932n;
    public final Paint f42933r;
    public float f42934s;
    public boolean v;
    public ValueAnimator f42935w;
    public String f42936x;
    public TL_chatlists.TL_exportedChatlistInvite f42937y;
    ...
    public y00(Context context, org.telegram.ui.ActionBar.n2 n2Var, int i10, int i11) {
        ...
        q6Var2.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f21062z6, false));
        if (LocaleController.isRTL) {
            i13 = 5;
        } else {
            i13 = 3;
    ...
    public final void a() {
        ...
        tL_inputChatlistDialogFilter.filter_id = this.f42929c;
        tL_chatlists_deleteExportedInvite.slug = substring;
        x00 x00Var = new x00(this, 2);
        ConnectionsManager.getInstance(this.f42928b).sendRequest(tL_chatlists_deleteExportedInvite, new ro(21, this, x00Var));
    ...
    public void c() {
        org.telegram.ui.ActionBar.n2 n2Var = this.f42927a;
        if (!(n2Var instanceof f10)) {
            return;
        }
        bi.o0 o0Var = ((f10) n2Var).f36223a;
    ...
    public final void d() {
        ...
        org.telegram.ui.Components.ji0 ji0Var = new org.telegram.ui.Components.ji0(getContext(), LocaleController.getString(R.string.InviteByQRCode), this.f42936x, LocaleController.getString(R.string.QRCodeLinkHelpFolder), false);
    ...
    public final void e(TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite, boolean z10) {
        boolean z11;
        if (this.f42937y == tL_exportedChatlistInvite) {
            z11 = true;
        } else {
            z11 = false;
        }
        this.f42937y = tL_exportedChatlistInvite;
        ...
        org.telegram.ui.Components.q6 q6Var = this.f42931f;
        if (isEmpty) {
        ...
        if ((z12 ? 1.0f : 0.0f) != this.f42934s) {
            ValueAnimator valueAnimator = this.f42935w;
            ...
            float f7 = 0.0f;
            if (z11) {
                float f10 = this.f42934s;
                if (z12) {
                    f7 = 1.0f;
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, f7);
                this.f42935w = ofFloat;
                ofFloat.addUpdateListener(new c3(this, 13));
                this.f42935w.addListener(new to(29, this, z12));
                this.f42935w.setInterpolator(org.telegram.ui.Components.pr.h);
                this.f42935w.setDuration(350L);
                this.f42935w.start();
                return;
            }
            if (z12) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f7 = dp;
        canvas.drawCircle(f7, getMeasuredHeight() / 2.0f, AndroidUtilities.dp(16.0f), this.f42932n);
        if (this.f42934s > 0.0f) {
            canvas.drawCircle(f7, getMeasuredHeight() / 2.0f, AndroidUtilities.dp(16.0f) * this.f42934s, this.f42933r);
        }
        float f10 = this.f42934s;
        if (f10 < 1.0f) {
        ...
        float f11 = this.f42934s;
        if (f11 > 0.0f) {
            Drawable drawable2 = this.f42930e;
        ...
        if (this.v) {
            ...
            canvas.drawRect(dp2, measuredHeight, measuredWidth - i10, getMeasuredHeight(), org.telegram.ui.ActionBar.j6.f20786k0);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite = this.f42937y;
        String str2 = "";
        if (tL_exportedChatlistInvite == null || TextUtils.isEmpty(tL_exportedChatlistInvite.title)) {
            str = "";
        } else {
            str = a4.a.s(new StringBuilder(), this.f42937y.title, "\n ");
        }
        sb2.append(str);
        org.telegram.messenger.vl.l(R.string.InviteLink, ", ", sb2);
        sb2.append((Object) this.h.getText());
        TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite2 = this.f42937y;
