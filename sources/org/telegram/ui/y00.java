...
public abstract class y00 extends FrameLayout {
    public final org.telegram.ui.ActionBar.n2 f39654a;
    public final int f39655b;
    public final int f39656c;
    public final Drawable d;
    public final Drawable e;
    public final org.telegram.ui.Components.p6 f39657f;
    public final org.telegram.ui.Components.p6 h;
    public final Paint f39658n;
    public final Paint f39659r;
    public float f39660s;
    public boolean v;
    public ValueAnimator f39661w;
    public String f39662x;
    public TL_chatlists.TL_exportedChatlistInvite f39663y;
    ...
    public y00(Context context, org.telegram.ui.ActionBar.n2 n2Var, int i10, int i11) {
        ...
        p6Var2.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19464z6, false));
        if (LocaleController.isRTL) {
            i13 = 5;
        } else {
            i13 = 3;
    ...
    public final void a() {
        ...
        tL_inputChatlistDialogFilter.filter_id = this.f39656c;
        tL_chatlists_deleteExportedInvite.slug = substring;
        x00 x00Var = new x00(this, 2);
        ConnectionsManager.getInstance(this.f39655b).sendRequest(tL_chatlists_deleteExportedInvite, new oo(21, this, x00Var));
    ...
    public void c() {
        org.telegram.ui.ActionBar.n2 n2Var = this.f39654a;
        if (!(n2Var instanceof f10)) {
            return;
        }
        ai.w0 w0Var = ((f10) n2Var).f33390a;
    ...
    public final void d() {
        ...
        org.telegram.ui.Components.ui0 ui0Var = new org.telegram.ui.Components.ui0(getContext(), LocaleController.getString(R.string.InviteByQRCode), this.f39662x, LocaleController.getString(R.string.QRCodeLinkHelpFolder), false);
    ...
    public final void e(TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite, boolean z10) {
        boolean z11;
        if (this.f39663y == tL_exportedChatlistInvite) {
            z11 = true;
        } else {
            z11 = false;
        }
        this.f39663y = tL_exportedChatlistInvite;
        ...
        org.telegram.ui.Components.p6 p6Var = this.f39657f;
        if (isEmpty) {
        ...
        if ((z12 ? 1.0f : 0.0f) != this.f39660s) {
            ValueAnimator valueAnimator = this.f39661w;
            ...
            float f7 = 0.0f;
            if (z11) {
                float f10 = this.f39660s;
                if (z12) {
                    f7 = 1.0f;
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, f7);
                this.f39661w = ofFloat;
                ofFloat.addUpdateListener(new b3(this, 12));
                this.f39661w.addListener(new org.telegram.ui.Components.ca(28, this, z12));
                this.f39661w.setInterpolator(org.telegram.ui.Components.qr.h);
                this.f39661w.setDuration(350L);
                this.f39661w.start();
                return;
            }
            if (z12) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f7 = dp;
        canvas.drawCircle(f7, getMeasuredHeight() / 2.0f, AndroidUtilities.dp(16.0f), this.f39658n);
        if (this.f39660s > 0.0f) {
            canvas.drawCircle(f7, getMeasuredHeight() / 2.0f, AndroidUtilities.dp(16.0f) * this.f39660s, this.f39659r);
        }
        float f10 = this.f39660s;
        if (f10 < 1.0f) {
        ...
        if (this.v) {
            ...
            canvas.drawRect(dp2, measuredHeight, measuredWidth - i10, getMeasuredHeight(), org.telegram.ui.ActionBar.j6.f19184k0);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite = this.f39663y;
        String str2 = "";
        if (tL_exportedChatlistInvite == null || TextUtils.isEmpty(tL_exportedChatlistInvite.title)) {
            str = "";
        } else {
            str = a4.a.s(new StringBuilder(), this.f39663y.title, "\n ");
        }
        sb2.append(str);
        org.telegram.ui.Cells.c1.l(R.string.InviteLink, ", ", sb2);
        sb2.append((Object) this.h.getText());
        TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite2 = this.f39663y;
