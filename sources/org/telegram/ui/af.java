...
public final class af implements Utilities.Callback2 {
    ...
    public final void run(Object obj, Object obj2) {
        switch (this.f32020a) {
            case 0:
                zn.k1(this.f32021b, (Integer) obj, (Boolean) obj2);
                return;
            case 1:
                zn.O0(this.f32021b, (Long) obj, (Boolean) obj2);
                return;
            case 2:
                Bitmap bitmap = (Bitmap) obj;
                zn znVar = this.f32021b;
                fh.b bVar = znVar.f40521z8;
                bVar.a((Bitmap) obj2);
                gh.d.c(bVar, znVar.fragmentView);
                znVar.A8.d();
                return;
            default:
                zn znVar2 = this.f32021b;
