...
public final class af implements Utilities.Callback2 {
    ...
    public final void run(Object obj, Object obj2) {
        switch (this.f34425a) {
            case 0:
                co.g1(this.f34426b, (Integer) obj, (Boolean) obj2);
                return;
            case 1:
                co.O0(this.f34426b, (Long) obj, (Boolean) obj2);
                return;
            case 2:
                Bitmap bitmap = (Bitmap) obj;
                co coVar = this.f34426b;
                gh.b bVar = coVar.f35534z8;
                bVar.a((Bitmap) obj2);
                hh.d.c(bVar, coVar.fragmentView);
                coVar.A8.d();
                return;
            default:
                co coVar2 = this.f34426b;
