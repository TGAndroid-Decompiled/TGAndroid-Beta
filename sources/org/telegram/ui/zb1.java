...
public final class zb1 extends View {
    ...
    public final Paint f40210a;
    public int[] f40211b;

    public zb1(Context context) {
        super(context);
        this.f40210a = new Paint(1);
        this.f40211b = new int[7];
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Paint paint = this.f40210a;
        paint.setStyle(style);
        int i10 = 0;
        paint.setColor(this.f40211b[0]);
        canvas.drawCircle(measuredWidth, measuredHeight, dp, paint);
        double d = 0.0d;
        while (i10 < 6) {
            i10++;
            paint.setColor(this.f40211b[i10]);
