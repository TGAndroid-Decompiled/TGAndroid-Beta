...
public final class zb1 extends FrameLayout {
    public final org.telegram.ui.Cells.ia f40438a;
    public final org.telegram.ui.Components.to0 f40439b;
    ...
    public zb1(ThemeActivity themeActivity, Context context) {
        ...
        to0Var.setDelegate(new aw0(this, 4));
    ...
    public final void invalidate() {
        super.invalidate();
        this.f40438a.invalidate();
        this.f40439b.invalidate();
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        this.f40439b.getSeekBarAccessibilityDelegate().e(this, accessibilityNodeInfo);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f40441f != size) {
            int i12 = SharedConfig.fontSize;
            int i13 = this.f40440c;
            this.f40439b.setProgress((i12 - i13) / (this.d - i13));
            this.f40441f = size;
        }
    }
    ...
    public final boolean performAccessibilityAction(int i10, Bundle bundle) {
        if (!super.performAccessibilityAction(i10, bundle) && !this.f40439b.getSeekBarAccessibilityDelegate().g(this, i10, bundle)) {
            return false;
        }
        return true;
    }
