...
public final class m00 extends FrameLayout {
    public final TextView f38557a;
    public final ImageView f38558b;
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (this.f38559c) {
            TextView textView = this.f38557a;
            canvas.drawRect(textView.getLeft(), getMeasuredHeight() - 1, textView.getRight(), getMeasuredHeight(), org.telegram.ui.ActionBar.j6.f20812k0);
        }
    }
    ...
    public final void setEnabled(boolean z10) {
        ...
        this.f38557a.setAlpha(f7);
        if (z10) {
            f10 = 1.0f;
        }
        this.f38558b.setAlpha(f10);
    }
}
