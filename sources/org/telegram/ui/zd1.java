    ...
    public final void run() {
        ...
        switch (i11) {
            case 0:
                ...
                if (str2 != null && str2.equals(str)) {
                    if (tL_error != null && ("THEME_SLUG_INVALID".equals(tL_error.text) || "THEME_SLUG_OCCUPIED".equals(tL_error.text))) {
                        ce1Var.a0(org.telegram.ui.ActionBar.j6.f19083p7, LocaleController.getString(R.string.SetUrlInUse));
                        return;
                    } else {
                        ce1Var.a0(org.telegram.ui.ActionBar.j6.f19211w6, LocaleController.formatString("SetUrlAvailable", R.string.SetUrlAvailable, str));
                        return;
                    }
                }
                return;
            ...
            case 3:
                ...
                arrayList.clear();
                ArrayList arrayList2 = ue1Var.f38060f;
                arrayList2.clear();
                arrayList.addAll((ArrayList) obj2);
                arrayList2.addAll(((TLRPC.TL_messages_inactiveChats) obj).chats);
                ue1Var.d.l();
                if (ue1Var.f38057a.getMeasuredHeight() > 0) {
                    ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
                    ue1Var.f38066y = ofFloat;
                    ofFloat.addUpdateListener(new k21(ue1Var, 14));
                    ue1Var.f38066y.setDuration(100L);
                    ue1Var.f38066y.start();
                } else {
                    ue1Var.E = 1.0f;
                }
            ...
            case 4:
                fg1 fg1Var = (fg1) obj3;
                fg1Var.f33675s.deleteTopics(fg1Var.f33640a, (ArrayList) obj2);
                ((Runnable) obj).run();
                return;
            case 5:
                bg1 bg1Var = (bg1) obj3;
                ...
                ArrayList arrayList3 = bg1Var.f32165e0;
                if (str3.equals(bg1Var.f32163c0)) {
                    int i13 = bg1Var.f32172l0;
                    bg1Var.f32176q0 = false;
                    bg1Var.m0 = false;
                    if (tLObject instanceof TLRPC.messages_Messages) {
                        TLRPC.messages_Messages messages_messages = (TLRPC.messages_Messages) tLObject;
                        for (int i14 = 0; i14 < messages_messages.messages.size(); i14++) {
                            i10 = ((org.telegram.ui.ActionBar.o2) bg1Var.f32180u0).currentAccount;
                        ...
                        bg1Var.f32173n0 = false;
                    }
                    if (bg1Var.f32172l0 == 0) {
                        bg1Var.f32174o0.e(bg1Var.m0, true);
                    }
                    bg1Var.f32175p0.b(i13);
                    return;
                }
                return;
            default:
                ...
                gg.c2 c2Var = wh1Var.f39042f;
                if (wh1Var.f39043n) {
                    wh1Var.h = null;
                    wh1Var.d = arrayList4;
                    wh1Var.e = arrayList5;
                    c2Var.f(arrayList4, null);
                    if (wh1Var.f39043n && !c2Var.e()) {
