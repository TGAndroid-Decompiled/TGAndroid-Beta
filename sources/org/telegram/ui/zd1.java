...
public final class zd1 implements TextWatcher {
    ...
    public final void afterTextChanged(Editable editable) {
        ae1 ae1Var = this.f40089a;
        if (ae1Var.I) {
            return;
        }
        if (ae1Var.f32010a.length() > 0) {
            String str = "https://" + ae1Var.getMessagesController().linkPrefix + "/addtheme/" + ((Object) ae1Var.f32010a.getText());
    ...
    public final void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
        ...
        ae1Var.Z(ae1Var.f32010a.getText().toString(), false);
    }
