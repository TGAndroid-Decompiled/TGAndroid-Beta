...
public final class bm extends tu0 {
    public final MessageObject f32513a;
    public final MediaController.PhotoEntry f32514b;
    public final cm f32515c;

    public bm(cm cmVar, MessageObject messageObject, MediaController.PhotoEntry photoEntry) {
        this.f32515c = cmVar;
        this.f32513a = messageObject;
        this.f32514b = photoEntry;
    }

    @Override
    public final dv0 E(MessageObject messageObject, TLRPC.FileLocation fileLocation, int i10, boolean z10, boolean z11) {
        return this.f32515c.f32809a.Q.Fa.E(this.f32513a, fileLocation, i10, z10, false);
    }

    @Override
    public final void o(int i10, VideoEditedInfo videoEditedInfo, boolean z10, int i11, int i12, boolean z11) {
        lm lmVar = this.f32515c.f32809a;
        MessageObject messageObject = this.f32513a;
        messageObject.settingAvatar = true;
        MediaController.PhotoEntry photoEntry = this.f32514b;
        if (photoEntry.imagePath == null && !photoEntry.isVideo) {
            TLRPC.TL_photos_updateProfilePhoto tL_photos_updateProfilePhoto = new TLRPC.TL_photos_updateProfilePhoto();
            TLRPC.TL_inputPhoto tL_inputPhoto = new TLRPC.TL_inputPhoto();
            tL_photos_updateProfilePhoto.f18475id = tL_inputPhoto;
        ...
        u40Var.t(photoEntry);
        u40Var.f28620b = new ea(currentAccount, djVar, parentLayout, u40Var);
    }
}
