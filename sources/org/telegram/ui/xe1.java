    ...
    public final void b(int i10) {
        ...
        if (i10 == 1) {
            ...
            if (TextUtils.isEmpty(obj)) {
                ...
                tL_messages_createForumTopic.peer = bf1Var.getMessagesController().getInputPeer(bf1Var.f32398a);
            ...
            if (!bf1Var.f32405w.title.equals(str) || bf1Var.f32405w.icon_emoji_id != bf1Var.f32399b) {
                TL_forum.TL_messages_editForumTopic tL_messages_editForumTopic = new TL_forum.TL_messages_editForumTopic();
                tL_messages_editForumTopic.peer = bf1Var.getMessagesController().getInputPeer(bf1Var.f32398a);
                TLRPC.TL_forumTopic tL_forumTopic = bf1Var.f32405w;
                tL_messages_editForumTopic.topic_id = tL_forumTopic.f18380id;
                if (!tL_forumTopic.title.equals(str)) {
                    tL_messages_editForumTopic.title = str;
                    tL_messages_editForumTopic.flags |= 1;
                }
                long j10 = bf1Var.f32405w.icon_emoji_id;
                long j11 = bf1Var.f32399b;
                if (j10 != j11) {
            ...
            if (bf1Var.d != null) {
                TLRPC.TL_forumTopic tL_forumTopic2 = bf1Var.f32405w;
                if (tL_forumTopic2.f18380id == 1 && (!w8Var.d.h) != tL_forumTopic2.hidden) {
                    TL_forum.TL_messages_editForumTopic tL_messages_editForumTopic2 = new TL_forum.TL_messages_editForumTopic();
                    tL_messages_editForumTopic2.peer = bf1Var.getMessagesController().getInputPeer(bf1Var.f32398a);
                    tL_messages_editForumTopic2.topic_id = bf1Var.f32405w.f18380id;
            ...
            TLRPC.TL_forumTopic tL_forumTopic3 = bf1Var.f32405w;
            long j12 = bf1Var.f32399b;
            ...
            bf1Var.getMessagesController().getTopicsController().onTopicEdited(bf1Var.f32398a, bf1Var.f32405w);
            bf1Var.finishFragment();
        }
    }
}
