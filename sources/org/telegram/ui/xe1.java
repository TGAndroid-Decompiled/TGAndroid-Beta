    ...
    public final void b(int i10) {
        ...
        if (i10 == 1) {
            ...
            if (TextUtils.isEmpty(obj)) {
                ...
                tL_messages_createForumTopic.peer = bf1Var.getMessagesController().getInputPeer(bf1Var.f32119a);
            ...
            if (!bf1Var.f32126w.title.equals(str) || bf1Var.f32126w.icon_emoji_id != bf1Var.f32120b) {
                TL_forum.TL_messages_editForumTopic tL_messages_editForumTopic = new TL_forum.TL_messages_editForumTopic();
                tL_messages_editForumTopic.peer = bf1Var.getMessagesController().getInputPeer(bf1Var.f32119a);
                TLRPC.TL_forumTopic tL_forumTopic = bf1Var.f32126w;
                ...
                long j10 = bf1Var.f32126w.icon_emoji_id;
                long j11 = bf1Var.f32120b;
                if (j10 != j11) {
            ...
            if (bf1Var.d != null) {
                TLRPC.TL_forumTopic tL_forumTopic2 = bf1Var.f32126w;
                if (tL_forumTopic2.f18173id == 1 && (!v8Var.d.h) != tL_forumTopic2.hidden) {
                    ...
                    tL_messages_editForumTopic2.peer = bf1Var.getMessagesController().getInputPeer(bf1Var.f32119a);
                    tL_messages_editForumTopic2.topic_id = bf1Var.f32126w.f18173id;
            ...
            TLRPC.TL_forumTopic tL_forumTopic3 = bf1Var.f32126w;
            long j12 = bf1Var.f32120b;
            ...
            bf1Var.getMessagesController().getTopicsController().onTopicEdited(bf1Var.f32119a, bf1Var.f32126w);
            bf1Var.finishFragment();
        }
    }
}
