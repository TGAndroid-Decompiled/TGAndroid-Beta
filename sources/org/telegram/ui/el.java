...
public final class el extends org.telegram.ui.Components.fc0 {
    ...
    public final void b() {
        ...
        if (mnVar2 != null && (messageObject = mnVar2.f35625a) != null && ((mnVar = wnVar.f39478f5.quote) == null || mnVar.f35625a == null || messageObject.getId() == wnVar.f39478f5.quote.f35625a.getId())) {
            return;
        }
        wnVar.f39549l5 = wnVar.f39478f5.quote;
    }
        ...
        if (messagePreviewParams != null) {
            ...
            if (messages2 != null) {
                ...
                for (int i13 = 0; i13 < size; i13++) {
                    MessageObject messageObject = wnVar.f39478f5.forwardMessages.messages.get(i13);
            ...
            if (!z10 && (messages = wnVar.f39478f5.replyMessage) != null && !messages.messages.isEmpty() && wnVar.f39478f5.quote == null) {
                z12 = true;
            } else {
                z12 = false;
            }
            e.putBoolean("reply_to", z12);
            if (z12 && (DialogObject.getPeerDialogId(wnVar.f39478f5.replyMessage.messages.get(0).getFromPeer())) != 0 && peerDialogId != wnVar.a() && peerDialogId != wnVar.getUserConfig().getClientUserId() && i11 > 0) {
                e.putLong("reply_to_author", peerDialogId);
            }
            e.putInt("hasPoll", i10);
            e.putBoolean("hasInvoice", z11);
            MessagePreviewParams.Messages messages3 = wnVar.f39478f5.forwardMessages;
            if (messages3 != null) {
