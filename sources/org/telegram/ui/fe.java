...
public final class fe extends LinearLayout {
    ...
    public final org.telegram.ui.Components.i81 f33547b;
    public final ee f33548c;
    public final long d;
    public final nd e;
    public String f33549f;
    public final ArrayList h;
    public final ArrayList f33550n;
    ...
    public fe(je jeVar, Context context, int i10, long j3, int i11, nd ndVar, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.f33551r = "";
        this.f33552s = new boolean[]{false, false};
        this.f33546a = i10;
        this.d = j3;
        this.e = ndVar;
        setOrientation(1);
    ...
    public final boolean a() {
        if (this.h.isEmpty() && this.f33550n.isEmpty()) {
            return false;
        }
        return true;
    }
    ...
    public final void c(final int i10) {
        ...
        if (!zArr[i10]) {
            ...
            if (i10 == 1) {
                                            ...
                                            switch (r7) {
                                                case 0:
                                                    ...
                                                    if (z12) {
                                                        ...
                                                        feVar2.f33550n.addAll(starsStatus.history);
                                                        feVar2.f33551r = starsStatus.next_offset;
                                                        feVar2.f33552s[i15] = false;
                                                        feVar2.d();
                                                    } else {
                                                ...
                                                default:
                                                    ...
                                                    if (z13) {
                                                        ...
                                                        feVar3.f33549f = starsStatus2.next_offset;
                                                        feVar3.f33552s[i17] = false;
                                                        feVar3.d();
                                                    } else {
                                            ...
                                            switch (r7) {
                                                case 0:
                                                    ...
                                                    if (z122) {
                                                        ...
                                                        feVar22.f33550n.addAll(starsStatus.history);
                                                        feVar22.f33551r = starsStatus.next_offset;
                                                        feVar22.f33552s[i15] = false;
                                                        feVar22.d();
                                                    } else {
                                                        TLRPC.TL_error tL_error2 = tL_error;
                                                        if (tL_error2 != null) {
            ...
            } else if (i10 == 0 && this.f33551r != null && jeVar.f34866g1) {
                zArr[i10] = true;
                ...
                tL_payments_getStarsTransactions2.offset = this.f33551r;
                if (this.f33550n.isEmpty()) {
                    i11 = 5;
                }
    ...
    public final void d() {
        int i10 = 0;
        while (true) {
            org.telegram.ui.Components.i81 i81Var = this.f33547b;
            if (i10 < i81Var.getViewPages().length) {
                View view = i81Var.getViewPages()[i10];
                if (view instanceof de) {
                    de deVar = (de) view;
                    org.telegram.ui.Components.e61 e61Var = deVar.f32996a;
                    e61Var.Y2.N(true);
    ...
    public final void e() {
        ...
        int[] iArr = i81Var.f24959f;
        if (iArr[0] != i81Var.L.h(i81Var.f24957b)) {
            i81Var.I(0);
            View view = viewArr[1];
            if (view != null) {
    ...
    public org.telegram.ui.Components.ll0 getCurrentListView() {
        View currentView = this.f33547b.getCurrentView();
        if (!(currentView instanceof de)) {
            return null;
        }
        return ((de) currentView).f32996a;
    }
}
