...
public final class fe extends LinearLayout {
    ...
    public final org.telegram.ui.Components.w81 f33644b;
    public final ee f33645c;
    public final long d;
    public final nd e;
    public String f33646f;
    public final ArrayList h;
    public final ArrayList f33647n;
    public String f33648r;
    public final boolean[] f33649s;
    public final je v;
    ...
    public fe(je jeVar, Context context, int i10, long j3, int i11, nd ndVar, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        this.f33648r = "";
        this.f33649s = new boolean[]{false, false};
        this.f33643a = i10;
        this.d = j3;
        this.e = ndVar;
        setOrientation(1);
    ...
    public final boolean a() {
        if (this.h.isEmpty() && this.f33647n.isEmpty()) {
            return false;
        }
        return true;
    }
    ...
    public final void c(final int i10) {
        ...
        if (!zArr[i10]) {
            ...
            if (i10 == 1) {
                                            ...
                                            switch (r7) {
                                                case 0:
                                                    ...
                                                    if (z12) {
                                                        ...
                                                        feVar2.f33647n.addAll(starsStatus.history);
                                                        feVar2.f33648r = starsStatus.next_offset;
                                                        feVar2.f33649s[i15] = false;
                                                        feVar2.d();
                                                    } else {
                                                ...
                                                default:
                                                    ...
                                                    if (z13) {
                                                        ...
                                                        feVar3.f33646f = starsStatus2.next_offset;
                                                        feVar3.f33649s[i17] = false;
                                                        feVar3.d();
                                                    } else {
                                            ...
                                            switch (r7) {
                                                case 0:
                                                    ...
                                                    if (z122) {
                                                        ...
                                                        feVar22.f33647n.addAll(starsStatus.history);
                                                        feVar22.f33648r = starsStatus.next_offset;
                                                        feVar22.f33649s[i15] = false;
                                                        feVar22.d();
                                                    } else {
                                                        TLRPC.TL_error tL_error2 = tL_error;
                                                        if (tL_error2 != null) {
            ...
            } else if (i10 == 0 && this.f33648r != null && jeVar.f34758g1) {
                zArr[i10] = true;
                ...
                tL_payments_getStarsTransactions2.offset = this.f33648r;
                if (this.f33647n.isEmpty()) {
                    i11 = 5;
                }
    ...
    public final void d() {
        int i10 = 0;
        while (true) {
            org.telegram.ui.Components.w81 w81Var = this.f33644b;
            if (i10 < w81Var.getViewPages().length) {
                View view = w81Var.getViewPages()[i10];
                if (view instanceof de) {
                    de deVar = (de) view;
                    org.telegram.ui.Components.r61 r61Var = deVar.f33083a;
                    r61Var.Y2.N(true);
    ...
    public final void e() {
        ...
        int[] iArr = w81Var.f29935f;
        if (iArr[0] != w81Var.L.h(w81Var.f29933b)) {
            w81Var.I(0);
            View view = viewArr[1];
            if (view != null) {
    ...
    public org.telegram.ui.Components.wl0 getCurrentListView() {
        View currentView = this.f33644b.getCurrentView();
        if (!(currentView instanceof de)) {
            return null;
        }
        return ((de) currentView).f33083a;
    }
}
