...
public final class h5 extends Drawable {
    ...
    public Paint f18913b;

    public h5(int i10) {
        this.f18912a = i10;
        switch (i10) {
            case 1:
                this.f18913b = new Paint(1);
                return;
            default:
                return;
        }
    ...
    public final void draw(Canvas canvas) {
        switch (this.f18912a) {
            case 0:
                canvas.drawCircle(getBounds().centerX(), getBounds().centerY() - AndroidUtilities.dp(1.0f), (getBounds().width() - AndroidUtilities.dp(8.0f)) / 2.0f, this.f18913b);
                return;
            default:
                Paint paint = this.f18913b;
