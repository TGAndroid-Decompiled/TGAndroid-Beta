...
public final class h5 extends Drawable {
    ...
    public final void draw(Canvas canvas) {
        switch (this.f18940a) {
            case 0:
                canvas.drawCircle(getBounds().centerX(), getBounds().centerY() - AndroidUtilities.dp(1.0f), (getBounds().width() - AndroidUtilities.dp(8.0f)) / 2.0f, this.f18941b);
                return;
            default:
