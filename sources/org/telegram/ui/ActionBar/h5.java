...
public final class h5 extends Drawable {
    ...
    public Paint f20517b;

    public h5(int i10) {
        this.f20516a = i10;
        switch (i10) {
            case 1:
                this.f20517b = new Paint(1);
                return;
            default:
                return;
        }
    ...
    public final void draw(Canvas canvas) {
        switch (this.f20516a) {
            case 0:
                canvas.drawCircle(getBounds().centerX(), getBounds().centerY() - AndroidUtilities.dp(1.0f), (getBounds().width() - AndroidUtilities.dp(8.0f)) / 2.0f, this.f20517b);
                return;
            default:
                Paint paint = this.f20517b;
