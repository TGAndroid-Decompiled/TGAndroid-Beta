...
public final class h5 extends Drawable {
    ...
    public Paint f20490b;

    public h5(int i10) {
        this.f20489a = i10;
        switch (i10) {
            case 1:
                this.f20490b = new Paint(1);
                return;
            default:
                return;
        }
    ...
    public final void draw(Canvas canvas) {
        switch (this.f20489a) {
            case 0:
                canvas.drawCircle(getBounds().centerX(), getBounds().centerY() - AndroidUtilities.dp(1.0f), (getBounds().width() - AndroidUtilities.dp(8.0f)) / 2.0f, this.f20490b);
                return;
            default:
                Paint paint = this.f20490b;
