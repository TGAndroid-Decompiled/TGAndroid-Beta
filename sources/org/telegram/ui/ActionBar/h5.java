...
public class h5 extends Drawable {
    ...
    public boolean v;
    public final Paint f17772c = new Paint(1);
    public final RectF f17776j = new RectF();
    public final Matrix f17777k = new Matrix();
    public final Rect f17781o = new Rect();
    public final int[] f17788w = {-1, -1, -1, -1};
    public final Bitmap[] f17789x = new Bitmap[4];
    public final Drawable[] f17790y = new Drawable[4];
    public final int[] f17791z = {-1, -1, -1, -1};
    ...
    public final Path f17780n = new Path();
    ...
    public final void a() {
        Bitmap bitmap;
        if (this.f17770a instanceof BitmapShader) {
            boolean z10 = this.J;
            Matrix matrix = this.f17777k;
            lc0[] lc0VarArr = Q;
            char c10 = 0;
            ...
            Bitmap bitmap2 = lc0VarArr[c11].f24949k;
    ...
    public final void c(Canvas canvas, Paint paint) {
        ...
        if (paint == null && this.f17770a == null && this.O == 0 && this.P <= 0.0f && (f7 = f()) != null) {
            f7.setBounds(bounds);
            f7.draw(canvas);
            return;
        }
        ...
        if (paint == null && this.f17770a != null) {
            Matrix matrix = this.f17777k;
            matrix.reset();
            a();
            matrix.postTranslate(0.0f, -this.f17784r);
            this.f17770a.setLocalMatrix(matrix);
        }
        ...
        if (!z10 && this.O == 0) {
            ...
            int i13 = i11;
            path2 = path;
            h5Var.e(path2, bounds, b11, i13, b12, i10, max, true, true, z11);
        }
        canvas.drawPath(path2, paint2);
        if (h5Var.f17770a != null && h5Var.f17779m && paint == null) {
            int g10 = g(j6.f17897bc);
    ...
    public final void e(Path path, Rect rect, int i10, int i11, int i12, int i13, int i14, boolean z10, boolean z11, boolean z12) {
        ...
        boolean z13 = this.f17783q;
        int i20 = this.f17778l;
        RectF rectF = this.f17776j;
        if (z13) {
            if (!this.G && i20 != 2 && !z12 && !z10) {
                path.moveTo(rect.right - b(8.0f), (i14 - this.f17784r) + this.f17771b);
                path.lineTo(rect.left + i10, (i14 - this.f17784r) + this.f17771b);
            } else {
                if (this.f17787u) {
                    i17 = i13;
                } else {
            ...
            if (!this.G && i20 != 2 && !z12 && !z11) {
                path.lineTo(rect.left + i10, (i14 - this.f17784r) - b(2.0f));
                if (i20 == 1) {
                    path.lineTo(rect.right - i10, (i14 - this.f17784r) - b(2.0f));
                } else {
                    path.lineTo(rect.right - b(8.0f), (i14 - this.f17784r) - b(2.0f));
                }
            } else {
            ...
            if (i20 == 1) {
                if (!z12 && !z10) {
                    path.lineTo(rect.right - i10, (i14 - this.f17784r) + this.f17771b);
                } else {
                    if (this.f17786t) {
                        i19 = i13;
                    }
                ...
                path.lineTo(rect.right - b(8.0f), (i14 - this.f17784r) + this.f17771b);
            } else {
            ...
            if (!this.G && i20 != 2 && !z12 && !z10) {
                path.moveTo(b(8.0f) + rect.left, (i14 - this.f17784r) + this.f17771b);
                path.lineTo(rect.right - i10, (i14 - this.f17784r) + this.f17771b);
            } else {
                if (this.f17787u) {
                    i15 = i13;
            ...
            if (!this.G && i20 != 2 && !z12 && !z11) {
                ...
                if (i20 == 1) {
                    ...
                    path.lineTo(b(8.0f) + rect.left, (i14 - this.f17784r) - b(2.0f));
                }
            } else {
            ...
            if (i20 == 1) {
                ...
                path.lineTo(b(8.0f) + rect.left, (i14 - this.f17784r) + this.f17771b);
            } else {
    ...
    public final Drawable f() {
        ...
        boolean z11 = this.f17785s;
        char c11 = 3;
        if (z11 && this.f17786t) {
            c10 = 3;
        } else if (z11) {
            c10 = 2;
        } else if (this.f17786t) {
            c10 = 1;
        } else {
            c10 = 0;
        }
        boolean z12 = this.f17779m;
        if (!z12 || !this.f17787u) {
            if (z12) {
                c11 = 1;
            } else if (this.f17787u) {
                c11 = 2;
            } else {
                c11 = 0;
            }
        ...
        if (this.f17770a == null && !z12 && !this.J) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        if (z14 != z10 || iArr4[c11][c10] != i15 || ((z10 && iArr3[c10] != g11) || iArr2[c11][c10] != g10)) {
            ...
            try {
                ...
                i12 = g10;
                try {
                    drawableArr2[c11][c10] = new NinePatchDrawable(createBitmap, j7.c((createBitmap.getWidth() / 2) - 1, (createBitmap.getWidth() / 2) + 1, (createBitmap.getHeight() / 2) - 1, (createBitmap.getHeight() / 2) + 1, 0, 0, 0, 0, i12).array(), new Rect(), null);
                    setBounds(rect);
    ...
    public final void finalize() {
        ...
        Arrays.fill(this.f17790y, (Object) null);
        Arrays.fill(this.f17788w, -1);
    }
    ...
    public final Drawable j() {
        ...
        int i10;
        int i11;
        if (this.J || (this.f17770a == null && !this.f17779m && this.H == null)) {
            return null;
        }
        int b10 = b(SharedConfig.bubbleRadius);
        boolean z10 = this.f17785s;
        boolean z11 = false;
        if (z10 && this.f17786t) {
            c10 = 3;
        } else if (z10) {
        ...
        int[] iArr = this.f17788w;
        int i12 = iArr[c10];
        Drawable[] drawableArr = this.f17790y;
        if (i12 != b10) {
            iArr[c10] = b10;
            Bitmap[] bitmapArr = this.f17789x;
            ...
            try {
                ...
                drawableArr[c10] = new NinePatchDrawable(createBitmap, j7.c((createBitmap.getWidth() / 2) - 1, (createBitmap.getWidth() / 2) + 1, (createBitmap.getHeight() / 2) - 1, (createBitmap.getHeight() / 2) + 1, 0, 0, 0, 0, i11).array(), new Rect(), null);
                z11 = true;
            } catch (Throwable unused) {
            }
        }
    ...
    public final Path m() {
        ...
        int max = Math.max(bounds.top, 0);
        boolean z13 = true;
        if (c3Var != null && bounds.height() < this.f17771b) {
            z10 = true;
            z11 = true;
        } else {
            if (i12 != 1 ? (this.f17784r + bounds.bottom) - i11 < this.f17771b : (this.f17784r + bounds.bottom) - (b12 * 2) < this.f17771b) {
                z10 = true;
            } else {
                z10 = false;
            }
            if ((i11 * 2) + this.f17784r >= 0) {
                z12 = true;
            }
            z11 = z12;
        }
    ...
    public final void setAlpha(int i10) {
        int i11 = this.F;
        Paint paint = this.f17772c;
        if (i11 != i10 || paint.getAlpha() != i10) {
            this.F = i10;
            paint.setAlpha(i10);
            if (this.f17783q) {
                this.d.setAlpha((int) ((i10 / 255.0f) * Color.alpha(g(j6.f17897bc))));
            }
        }
