...
public final class c6 implements NotificationCenter.NotificationCenterDelegate {
    public static c6 f18782c;
    public int f18783a;
    public HashMap f18784b;
    ...
    public static void a(boolean z10) {
        ...
        for (int i10 = 0; i10 < 5; i10++) {
            ...
            if (g6Var != null && (arrayList = g6Var.f18921b0) != null && !arrayList.isEmpty()) {
                int size = g6Var.f18921b0.size();
                for (int i11 = 0; i11 < size; i11++) {
                    f6 f6Var = (f6) g6Var.f18921b0.get(i11);
                    if (f6Var.f18871a != h6.f19222n && !TextUtils.isEmpty(f6Var.f18882o)) {
                        if (arrayList2 == null) {
        ...
        ?? obj = new Object();
        obj.f18783a = UserConfig.selectedAccount;
        if (arrayList2 != null) {
    ...
    public static Bitmap b(Bitmap bitmap, boolean z10, File file, f6 f6Var) {
        ...
        try {
            ...
            g6 g6Var = f6Var.f18872b;
            SparseIntArray Q0 = h6.Q0(null, g6Var.d, null);
            h6.G(Q0, g6Var);
            int i14 = f6Var.f18873c;
            int i15 = (int) f6Var.f18877j;
            long j3 = f6Var.f18878k;
            int i16 = (int) j3;
            if (i16 == 0 && j3 == 0) {
                if (i15 != 0) {
                    i14 = i15;
            ...
            if (i18 != 0) {
                ...
                Drawable v9Var = new v9(v9.d(f6Var.f18881n), new int[]{i15, i16});
            ...
            try {
                if (drawable != null) {
                    ...
                    paint.setAlpha((int) (Math.abs(f6Var.f18883p) * 255.0f));
