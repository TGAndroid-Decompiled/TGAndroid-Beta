    ...
    public final void applyTransformation(float f10, Transformation transformation) {
        switch (this.f20503a) {
            case 0:
                ...
                return;
            case 1:
                int i12 = this.f20504b;
                int i13 = this.f20505c;
                w4 w4Var2 = this.e;
                RelativeLayout relativeLayout2 = w4Var2.f20699f;
                ...
                w4Var2.f20700g.setX(relativeLayout2.getWidth() - i13);
                w4Var2.h.setX(relativeLayout2.getWidth() - i12);
                return;
            case 2:
                int i14 = this.f20504b;
                int i15 = this.f20505c;
                w4 w4Var3 = this.e;
                RelativeLayout relativeLayout3 = w4Var3.f20699f;
                ...
                return;
            default:
                int i16 = this.f20504b;
                int i17 = this.f20505c;
                w4 w4Var4 = this.e;
                RelativeLayout relativeLayout4 = w4Var4.f20699f;
                ...
                w4Var4.f20700g.setX(relativeLayout4.getWidth() - i16);
