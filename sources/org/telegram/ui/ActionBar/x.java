...
public final class x extends FrameLayout {
    ...
    public int h;
    public int f19666n;
    public LinearGradient f19667r;
    public final Matrix f19668s;
    public Paint v;
    public b4 f19669w;
    ...
    public x(Context context, ActionBarLayout actionBarLayout) {
        ...
        this.f19662a = new Rect();
        this.d = new Paint();
        this.f19668s = new Matrix();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        a4 a4Var = actionBarLayout.f18431x;
        boolean z10 = false;
        if (a4Var != null) {
            w02 = a4Var.getInternalNavbarPaint().getColor();
        } else {
            w02 = j6.w0(null, j6.f18806a7, false);
        }
        if (this == actionBarLayout.f18429w) {
            org.telegram.ui.Components.c6 c6Var = actionBarLayout.f18392b1;
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if ((!z10 && !actionBarLayout.f18388a0) || (motionEvent.getActionMasked() != 0 && motionEvent.getActionMasked() != 5)) {
            if (z10) {
                try {
                    if (this != actionBarLayout.f18424s) {
                    }
                } catch (Throwable th2) {
                    FileLog.e(th2);
                }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (i11 != 0 && (drawable = ActionBarLayout.f18384p1) != null) {
            int alpha = drawable.getAlpha();
            int i15 = i12 + i11;
            ActionBarLayout.f18384p1.setBounds(0, i15, getMeasuredWidth(), ActionBarLayout.f18384p1.getIntrinsicHeight() + i15);
            ActionBarLayout.f18384p1.setAlpha(i10);
            ActionBarLayout.f18384p1.draw(canvas);
            ActionBarLayout.f18384p1.setAlpha(alpha);
        }
        if (this.f19671y && this.f19670x && o2Var != null && (i13 = AndroidUtilities.navigationBarHeight) >= AndroidUtilities.dp(32.0f)) {
            int i16 = (int) (i13 * 1.33f);
            int navigationBarColor = o2Var.getNavigationBarColor();
            if (i16 != this.h || this.f19666n != navigationBarColor || this.v == null) {
                if (this.v == null) {
                    this.v = new Paint(1);
                }
                this.f19666n = navigationBarColor;
                this.h = i16;
                ...
                this.f19667r = linearGradient;
                this.v.setShader(linearGradient);
            }
            Matrix matrix = this.f19668s;
            matrix.reset();
            matrix.postTranslate(0.0f, getHeight() - i16);
            this.f19667r.setLocalMatrix(matrix);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f19664c != 0) {
            ...
            canvas2 = canvas;
            canvas2.drawRect(0.0f, (getMeasuredHeight() - this.f19664c) - 3, getMeasuredWidth(), getMeasuredHeight(), paint);
        } else {
            canvas2 = canvas;
        }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (runnable != null && !actionBarLayout.f18424s.f19663b && !actionBarLayout.v.f19663b) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        boolean z11 = this.f19665f;
        ActionBarLayout actionBarLayout = this.E;
        if (z11 != z10 && actionBarLayout.y() && (actionBarLayout.h || actionBarLayout.f18388a0)) {
        ...
        this.f19665f = z10;
        int childCount = getChildCount();
        getWindowVisibleDisplayFrame(this.f19662a);
        ...
        for (int i16 = 0; i16 < childCount; i16++) {
            ...
            if (!(childAt2 instanceof k)) {
                if (childAt2 instanceof l2) {
                    if (actionBarLayout.v(false) <= 0 && this.f19670x) {
                        i14 = actionBarLayout.f18417n1.d;
                    } else {
                        i14 = 0;
                    }
                    ...
                    if (this.f19670x) {
                        i13 = actionBarLayout.f18417n1.d;
                    } else {
                        i13 = 0;
                    }
