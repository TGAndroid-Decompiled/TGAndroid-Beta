...
public final class s4 extends ListView {
    public final t4 f19742a;
    public final LinearGradient f19743b;
    public final Paint f19744c;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (z10) {
            canvas.drawRect(0.0f, 0.0f, getWidth(), AndroidUtilities.dp(16.0f), this.f19744c);
        }
        if (z11) {
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        this.f19743b.setLocalMatrix(matrix);
    }
}
