...
public final class EmojiThemes$$ExternalSyntheticLambda5 implements OnSuccessListener, OnFailureListener, ImageReceiver.ImageReceiverDelegate {
    public final int f$0;
    public final Object f$1;
    public final int f$2;
    public final long f$3;

    public EmojiThemes$$ExternalSyntheticLambda5(int i, int i2, long j, String str) {
        this.f$0 = i;
        this.f$3 = j;
        this.f$2 = i2;
        this.f$1 = str;
    ...
    public EmojiThemes$$ExternalSyntheticLambda5(int i, long j, int i2, Utilities.Callback callback) {
        this.f$0 = i;
        this.f$1 = callback;
        this.f$2 = i2;
        this.f$3 = j;
