...
public final class g6 {
    ...
    public TLRPC.TL_theme f18704r;
    public TLRPC.TL_wallPaper f18705s;
    public int f18706t;
    public String f18707u;
    public String v;
    public TLRPC.InputFile f18708w;
    public TLRPC.InputFile f18709x;
    public b6 f18710y;
    public boolean f18711z;
    public int f18700n = 45;
    ...
    public static void g(SparseIntArray sparseIntArray) {
        for (int i10 = i6.f19238za; i10 < i6.Ga; i10++) {
        ...
        for (int i12 = i6.Ub; i12 < i6.f18821cc; i12++) {
    ...
    public final File d() {
        if (this.f18690a < 100) {
            if (TextUtils.isEmpty(this.f18701o)) {
                return null;
            }
            File filesDirFixed = ApplicationLoader.getFilesDirFixed();
            Locale locale = Locale.US;
            String m10 = this.f18691b.m();
            int i10 = this.f18690a;
            String str = this.f18701o;
            return new File(filesDirFixed, m10 + "_" + i10 + "_" + str + "_v5.jpg");
        } else if (TextUtils.isEmpty(this.f18701o)) {
            return null;
        } else {
            File filesDirFixed2 = ApplicationLoader.getFilesDirFixed();
            Locale locale2 = Locale.US;
            String m11 = this.f18691b.m();
