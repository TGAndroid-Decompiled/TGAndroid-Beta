...
public final class p0 implements ViewTreeObserver.OnPreDrawListener {
    ...
    public final boolean onPreDraw() {
        v0 v0Var = this.f19440b;
        v0Var.e.getViewTreeObserver().removeOnPreDrawListener(this);
        float x10 = v0Var.e.getX();
        float f7 = this.f19439a;
        if (x10 != f7) {
            ci.h2 h2Var = v0Var.e;
            h2Var.setTranslationX(f7 - h2Var.getX());
        }
        v0Var.e.animate().translationX(0.0f).setDuration(250L).setStartDelay(0L).setInterpolator(rr.f27701f).start();
        return true;
    }
}
