...
public final class v extends FrameLayout {
    ...
    public int h;
    public int f19829n;
    public LinearGradient f19830r;
    public final Matrix f19831s;
    public Paint v;
    public y3 f19832w;
    ...
    public v(Context context, ActionBarLayout actionBarLayout) {
        ...
        this.f19825a = new Rect();
        this.d = new Paint();
        this.f19831s = new Matrix();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        x3 x3Var = actionBarLayout.f18632x;
        boolean z10 = false;
        if (x3Var != null) {
            w02 = x3Var.getInternalNavbarPaint().getColor();
        } else {
            w02 = h6.w0(null, h6.f18989a7, false);
        }
        if (this == actionBarLayout.f18630w) {
            org.telegram.ui.Components.e6 e6Var = actionBarLayout.f18593b1;
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if ((!z10 && !actionBarLayout.f18589a0) || (motionEvent.getActionMasked() != 0 && motionEvent.getActionMasked() != 5)) {
            if (z10) {
                try {
                    if (this != actionBarLayout.f18625s) {
                    }
                } catch (Throwable th2) {
                    FileLog.e(th2);
                }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (!actionBarLayout.O0.isEmpty()) {
            m2Var = (m2) org.telegram.ui.Cells.c1.i(1, actionBarLayout.O0);
        } else {
            m2Var = null;
        }
        r rVar = actionBarLayout.G;
        ...
        if (i11 != 0 && (drawable = ActionBarLayout.f18585p1) != null) {
            int alpha = drawable.getAlpha();
            int i15 = i12 + i11;
            ActionBarLayout.f18585p1.setBounds(0, i15, getMeasuredWidth(), ActionBarLayout.f18585p1.getIntrinsicHeight() + i15);
            ActionBarLayout.f18585p1.setAlpha(i10);
            ActionBarLayout.f18585p1.draw(canvas);
            ActionBarLayout.f18585p1.setAlpha(alpha);
        }
        if (this.f19834y && this.f19833x && m2Var != null && (i13 = AndroidUtilities.navigationBarHeight) >= AndroidUtilities.dp(32.0f)) {
            int i16 = (int) (i13 * 1.33f);
            int navigationBarColor = m2Var.getNavigationBarColor();
            if (i16 != this.h || this.f19829n != navigationBarColor || this.v == null) {
                if (this.v == null) {
                    this.v = new Paint(1);
                }
                this.f19829n = navigationBarColor;
                this.h = i16;
                ...
                this.f19830r = linearGradient;
                this.v.setShader(linearGradient);
            }
            Matrix matrix = this.f19831s;
            matrix.reset();
            matrix.postTranslate(0.0f, getHeight() - i16);
            this.f19830r.setLocalMatrix(matrix);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f19827c != 0) {
            ...
            canvas2 = canvas;
            canvas2.drawRect(0.0f, (getMeasuredHeight() - this.f19827c) - 3, getMeasuredWidth(), getMeasuredHeight(), paint);
        } else {
            canvas2 = canvas;
        }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (runnable != null && !actionBarLayout.f18625s.f19826b && !actionBarLayout.v.f19826b) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        boolean z11 = this.f19828f;
        ActionBarLayout actionBarLayout = this.E;
        if (z11 != z10 && actionBarLayout.y() && (actionBarLayout.h || actionBarLayout.f18589a0)) {
        ...
        this.f19828f = z10;
        int childCount = getChildCount();
        getWindowVisibleDisplayFrame(this.f19825a);
        ...
        for (int i16 = 0; i16 < childCount; i16++) {
            ...
            if (!(childAt2 instanceof k)) {
                if (childAt2 instanceof j2) {
                    if (actionBarLayout.v(false) <= 0 && this.f19833x) {
                        i14 = actionBarLayout.f18618n1.d;
                    } else {
                        i14 = 0;
                    }
                    ...
                    if (this.f19833x) {
                        i13 = actionBarLayout.f18618n1.d;
                    } else {
                        i13 = 0;
                    }
