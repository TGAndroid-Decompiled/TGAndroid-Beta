...
public class ActionBarLayout extends FrameLayout implements e5, mg.b {
    public static Drawable f18385p1;
    public static Drawable f18386q1;
    public static Paint f18387r1;
    public boolean A0;
    public View B0;
    public boolean C0;
    public u D0;
    ...
    public final ArrayList f18392b0;
    public final org.telegram.ui.Components.c6 f18393b1;
    public Window f18394c;
    public final ArrayList f18395c0;
    public boolean f18396c1;
    public Runnable d;
    public final n7.a1 f18397d0;
    public boolean f18398d1;
    public Runnable e;
    public g5 f18399e0;
    public boolean f18400e1;
    public boolean f18401f;
    public g5 f18402f0;
    public float f18403f1;
    public wn f18404g0;
    public boolean f18405g1;
    public boolean h;
    public final ArrayList f18406h0;
    public AnimatorSet f18407h1;
    public ArrayList f18408i0;
    public ArrayList f18409i1;
    public final ArrayList f18410j0;
    public final o f18411j1;
    public AnimatorSet f18412k0;
    public boolean f18413k1;
    public final AnimationNotificationsLocker f18414l0;
    public int l1;
    public float m0;
    public r0.l1 f18415m1;
    public boolean f18416n;
    public boolean f18417n0;
    public i0.b f18418n1;
    public i6 f18419o0;
    public i0.b f18420o1;
    public boolean f18421p0;
    public boolean f18422q0;
    public ColorDrawable f18423r;
    public int f18424r0;
    public x f18425s;
    public boolean f18426s0;
    public boolean f18427t0;
    public boolean f18428u0;
    public x v;
    public long f18429v0;
    public x f18430w;
    public boolean f18431w0;
    public a4 f18432x;
    public int f18433x0;
    public k f18434y;
    public Runnable f18435y0;
    public Runnable f18436z0;
    ...
    public ActionBarLayout(Context context, boolean z10) {
        ...
        this.f18392b0 = new ArrayList();
        this.f18395c0 = new ArrayList();
        n7.a1 a1Var = new n7.a1(1);
        a1Var.f15118b = new SparseIntArray();
        a1Var.f15119c = new int[]{j6.Aa, j6.Da, j6.Ea, j6.Fa, j6.f18812ac, j6.Ca};
        this.f18397d0 = a1Var;
        this.f18406h0 = new ArrayList();
        this.f18410j0 = new ArrayList();
        this.f18414l0 = new AnimationNotificationsLocker();
        this.Q0 = new Rect();
        this.T0 = -1;
        this.V0 = new Path();
        this.W0 = new float[8];
        this.Y0 = new int[2];
        this.f18393b1 = new org.telegram.ui.Components.c6(this, 280L, qr.h);
        this.f18409i1 = new ArrayList();
        this.f18411j1 = new o(this, 2);
        i0.b bVar = i0.b.e;
        this.f18418n1 = bVar;
        this.f18420o1 = bVar;
        ...
        this.L0 = z10;
        if (f18386q1 == null) {
            f18386q1 = getResources().getDrawable(R.drawable.layer_shadow);
            f18385p1 = getResources().getDrawable(R.drawable.header_shadow).mutate();
            f18387r1 = new Paint();
        }
        p pVar = new p(this, 0);
    ...
    public static void a(ActionBarLayout actionBarLayout, boolean z10) {
        ...
        actionBarLayout.f18425s.setTranslationX(0.0f);
        actionBarLayout.v.setTranslationX(0.0f);
        actionBarLayout.f18425s.setLayerType(0, null);
    ...
    public final boolean D() {
        if (this.f18398d1 && this.f18400e1) {
            return true;
        }
        return false;
    }
    ...
    public final void F(boolean z10) {
        ...
        setAlpha(1.0f);
        this.f18425s.setAlpha(1.0f);
        this.f18425s.setScaleX(1.0f);
        this.f18425s.setScaleY(1.0f);
    ...
    public final void G() {
        k kVar;
        if (!this.f18389a0 && !this.Q && !j() && !this.O0.isEmpty()) {
            z20 z20Var = z20.f30376d0;
            if (z20Var != null && z20Var.f30388w) {
                z20Var.e(false);
                return;
            }
            if (!e0() && (kVar = this.f18434y) != null && !kVar.s()) {
                k kVar2 = this.f18434y;
                if (kVar2.f19305n0) {
                    kVar2.h(true);
                    return;
                }
    ...
    public final void H() {
        if (this.W && this.f18435y0 != null) {
            ...
            this.H = null;
            this.I = null;
            Runnable runnable = this.f18435y0;
            this.f18435y0 = null;
            if (runnable != null) {
                runnable.run();
            }
    ...
    public final void K() {
        Runnable runnable;
        if (this.W && (runnable = this.f18436z0) != null) {
            this.W = false;
            this.f18389a0 = false;
            this.f18429v0 = 0L;
            this.H = null;
    ...
    public final void O() {
        ...
        if (!o2Var.hasOwnBackground && view.getBackground() == null) {
            view.setBackgroundColor(j6.w0(null, j6.f18863d6, false));
        }
        o2Var.onResume();
        if (this.f18412k0 != null) {
            this.f18408i0 = o2Var.getThemeDescriptions();
        }
        this.f18425s.setLayerType(2, null);
    ...
    public final boolean c(int i10, o2 o2Var) {
        ...
        if (i10 != -1 && i10 != -2) {
            if (i10 == -3) {
                ...
                this.f18425s.setShouldHandleBottomInsets(o2Var.getEdgeToEdgeSupportMode());
                this.f18425s.setDrawNavigationBar(o2Var.drawEdgeNavigationBar());
                k kVar = o2Var.actionBar;
                if (kVar != null && kVar.K) {
                    if (this.C0) {
                    ...
                    this.f18425s.addView(o2Var.actionBar);
                }
                o2Var.setTitleOverlayTextIfActionBarAttached(this.G0, this.H0, this.I0);
                o2Var.attachSheets(this.f18425s);
                i10 = 0;
            }
            ...
            if (i10 != -2) {
                ...
                if (!o2Var.hasOwnBackground && view3.getBackground() == null) {
                    view3.setBackgroundColor(j6.w0(null, j6.f18863d6, false));
                }
                this.f18425s.addView(view3, w7.x5.c(-1.0f, -1));
                this.f18425s.setShouldHandleBottomInsets(o2Var.getEdgeToEdgeSupportMode());
                this.f18425s.setDrawNavigationBar(o2Var.drawEdgeNavigationBar());
        ...
        if (!this.O0.isEmpty()) {
            ...
            if (!this.O0.isEmpty()) {
                if (this.O0.isEmpty() || this.O0.size() - 1 != size || ((o2) this.O0.get(size)).fragmentView == null) {
                    ...
                    this.f18425s.addView(view2, w7.x5.c(-1.0f, -1));
                    this.f18425s.setShouldHandleBottomInsets(o2Var2.getEdgeToEdgeSupportMode());
                    this.f18425s.setDrawNavigationBar(o2Var2.drawEdgeNavigationBar());
                    k kVar2 = o2Var2.actionBar;
                    if (kVar2 != null && kVar2.K) {
                        ...
                        this.f18425s.addView(o2Var2.actionBar);
                    }
                    o2Var2.setTitleOverlayTextIfActionBarAttached(this.G0, this.H0, this.I0);
                    o2Var2.attachSheets(this.f18425s);
                    o2Var2.onResume();
                    o2Var2.onBecomeFullyVisible();
                    this.f18434y = o2Var2.actionBar;
                    if (!o2Var2.hasOwnBackground && view2.getBackground() == null) {
                        view2.setBackgroundColor(j6.w0(null, j6.f18863d6, false));
                    }
                }
            }
        }
    ...
    public final void d(ArrayList arrayList) {
        if (arrayList != null) {
            this.f18406h0.add(arrayList);
            int[] iArr = new int[arrayList.size()];
            this.f18392b0.add(iArr);
            int size = arrayList.size();
            for (int i10 = 0; i10 < size; i10++) {
                ...
                l6Var.h = null;
                if (k6Var != null) {
                    ArrayList arrayList2 = this.f18410j0;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.E != null && v(true) > 0) {
            canvas2 = canvas;
            canvas2.drawRect(0.0f, getHeight() - (this.E.getMeasuredHeight() + this.f18418n1.d), getWidth(), getHeight(), this.E.getBackgroundPaint());
        } else {
            canvas2 = canvas;
        }
        this.U0 = true;
    ...
    public final void e(boolean z10) {
        ...
        float x10 = this.f18425s.getX();
        AnimatorSet animatorSet = new AnimatorSet();
        boolean shouldOverrideSlideTransition = o2Var.shouldOverrideSlideTransition(false, z10);
        Property property = View.TRANSLATION_X;
        if (!z10) {
            x10 = Math.abs(this.f18425s.getMeasuredWidth() - x10);
            int measuredWidth = (int) ((200.0f / this.f18425s.getMeasuredWidth()) * x10);
            if (D()) {
                i11 = 380;
            } else {
                i11 = 50;
            ...
            if (!shouldOverrideSlideTransition) {
                ...
                long j3 = max;
                animatorSet.playTogether(ofFloat.setDuration(j3), ObjectAnimator.ofFloat(this, "innerTranslationX", this.f18425s.getMeasuredWidth()).setDuration(j3));
                if (D()) {
                    animatorSet.setInterpolator(qr.h);
                }
            }
        } else {
            int measuredWidth3 = (int) ((320.0f / this.f18425s.getMeasuredWidth()) * x10);
            if (D()) {
                i10 = 320;
            } else {
                i10 = 120;
            ...
            if (!shouldOverrideSlideTransition) {
                ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(this.f18425s, property, 0.0f);
                long j10 = max2;
    ...
    public float getCurrentPreviewFragmentAlpha() {
        x xVar;
        if (!this.h && !this.f18389a0 && !this.f18416n) {
            return 0.0f;
        }
        o2 o2Var = this.I;
    ...
    public final void h(String str) {
        if (BuildVars.DEBUG_VERSION) {
            ArrayList arrayList = this.f18409i1;
            StringBuilder g10 = w.f.g(str, " ");
            g10.append(this.O0.size());
            arrayList.add(0, g10.toString());
            if (this.f18409i1.size() > 20) {
                ArrayList arrayList2 = new ArrayList();
                for (int i10 = 0; i10 < 10; i10++) {
                    arrayList2.add((String) this.f18409i1.get(i10));
                }
                this.f18409i1 = arrayList2;
            }
        }
        o oVar = this.f18411j1;
    ...
    public final void i() {
        if (this.f18426s0) {
            U(this.f18427t0, this.f18428u0);
            this.f18426s0 = false;
        } else if (this.f18417n0) {
            d5 d5Var = new d5(this.f18419o0, this.f18424r0, this.f18422q0, false);
            boolean z10 = this.f18421p0;
            if (!z10) {
                d5Var.f18591g = z10;
                d5Var.f18590f = z10;
            }
    ...
    public final boolean j() {
        ...
        if (this.W && (this.f18429v0 < System.currentTimeMillis() - 1500 || this.h)) {
            F(true);
        }
        return this.W;
    }
    ...
    public final void l(boolean z10, boolean z11) {
        ...
        if (lastFragment == null || !lastFragment.closeLastFragment()) {
            ...
            if ((b5Var == null || b5Var.k(this)) && !j() && !this.O0.isEmpty()) {
                ...
                if (!z11 && (this.h || this.f18389a0 || (z10 && MessagesController.getGlobalMainSettings().getBoolean("view_animations", true)))) {
                    z12 = true;
                } else {
                    z12 = false;
                }
                ...
                if (o2Var != null) {
                    if (j6.w0(null, j6.f19140s8, false) != -1 && (!o2Var.hasForceLightStatusBar() || j6.A0().q())) {
                        z13 = false;
                    } else {
                        z13 = true;
                    }
                    ...
                    this.f18434y = o2Var.actionBar;
                    if (!o2Var.hasOwnBackground && view.getBackground() == null) {
                        view.setBackgroundColor(j6.w0(null, j6.f18863d6, false));
                    }
                    if (z12) {
                        this.f18429v0 = System.currentTimeMillis();
                        this.W = true;
                        o2Var2.setRemovingFromStack(true);
                        this.f18435y0 = new q(this, o2Var2, o2Var, 0);
                        if (!this.h && !this.f18389a0) {
                            animatorSet = o2Var2.onCustomTransitionAnimation(false, new o(this, 3));
                        }
                        if (animatorSet == null) {
                            boolean z15 = this.h;
                            if (!z15 && (this.f18425s.f19664b || this.v.f19664b)) {
                                w2 w2Var = new w2(this, 1);
                                this.d = w2Var;
                                AndroidUtilities.runOnUIThread(w2Var, 200L);
                            } else {
                                if (!z15 && !this.f18389a0) {
                                    z14 = false;
                                } else {
                                    z14 = true;
                                }
                    ...
                    this.f18429v0 = System.currentTimeMillis();
                    this.W = true;
                    this.f18435y0 = new m4.g0(22, this, o2Var2);
    ...
    public final void m(o2 o2Var) {
        ...
        bringChildToFront(this.f18425s);
        x xVar = this.f18430w;
        if (xVar != null) {
    ...
    public final void o(View view, r0.l1 l1Var) {
        ...
        boolean z11 = this.M0;
        if (z11) {
            if ((view instanceof x) && ((x) view).f19671x) {
                int i18 = l1Var.f41882a.f(8).d;
        ...
        i0.b bVar = this.f18418n1;
        i0.b bVar2 = this.f18420o1;
        if (view instanceof p3) {
            ...
            if (b4Var == b4.f18472a) {
                ...
                r0.i0.b(view, l1Var.f41882a.m(i13, 0, i14, i10));
            }
    ...
    public final boolean onKeyUp(int i10, KeyEvent keyEvent) {
        k kVar;
        a0 a0Var;
        if (i10 == 82 && !j() && !this.Q && (kVar = this.f18434y) != null && !kVar.s() && (a0Var = kVar.E) != null) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        t tVar;
        boolean z10 = false;
        if (!j() && !this.f18431w0 && !this.T && !this.f18398d1) {
            if (this.O0.size() > 1 && ((tVar = this.G) == null || tVar.getLastSheet() == null || !this.G.getLastSheet().isShown())) {
                if (motionEvent != null && motionEvent.getAction() == 0) {
                    if (!((o2) p6.g(1, this.O0)).isSwipeBackEnabled(motionEvent)) {
                        ...
                        this.f18433x0 = motionEvent.getPointerId(0);
                        this.P = true;
                ...
                } else if (motionEvent != null && motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.f18433x0) {
                    if (this.U == null) {
                    ...
                    if (!this.W && !this.h && this.P && !this.Q && max >= AndroidUtilities.getPixelsInCM(0.4f, true) && Math.abs(max) / 3 > abs) {
                        ...
                        if (D()) {
                            float f7 = max;
                            this.f18425s.setTranslationX((f7 / getWidth()) * AndroidUtilities.dp(56.0f) * 5);
                            setInnerTranslationX((f7 / getWidth()) * AndroidUtilities.dp(56.0f) * 5);
                        } else {
                            float f10 = max;
                            this.f18425s.setTranslationX(f10);
                            setInnerTranslationX(f10);
                        }
                    }
                } else if (motionEvent != null && motionEvent.getPointerId(0) == this.f18433x0 && (motionEvent.getAction() == 3 || motionEvent.getAction() == 1 || motionEvent.getAction() == 6)) {
                    if (this.U == null) {
                        this.U = VelocityTracker.obtain();
                    }
                    this.U.addMovement(motionEvent);
                    ...
                    if (!this.h && !this.f18389a0 && !this.Q && o2Var.isSwipeBackEnabled(motionEvent)) {
                    ...
                    if (this.Q) {
                        ...
                        if (!D() ? x10 < this.f18425s.getMeasuredWidth() / 3.0f : !(x10 >= AndroidUtilities.dp(56.0f) / 2 && xVelocity2 >= -1000.0f)) {
    ...
    public final void p(Canvas canvas, int i10, int i11) {
        if (f18385p1 != null && SharedConfig.drawActionBarShadow) {
            int i12 = i10 / 2;
            if (f18385p1.getAlpha() != i12) {
                f18385p1.setAlpha(i12);
            }
            f18385p1.setBounds(0, i11, getMeasuredWidth(), f18385p1.getIntrinsicHeight() + i11);
            f18385p1.draw(canvas);
        }
    }
    ...
    public void setFragmentStack(List<o2> list) {
        ...
        if (z10) {
            ...
            y3 y3Var = LaunchActivity.G1.f30877y0;
            if (y3Var != null) {
        ...
        this.f18425s = xVar4;
        addView(xVar4);
        FrameLayout.LayoutParams layoutParams3 = (FrameLayout.LayoutParams) this.f18425s.getLayoutParams();
        layoutParams3.width = -1;
        layoutParams3.height = -1;
        layoutParams3.gravity = 51;
        this.f18425s.setLayoutParams(layoutParams3);
        x xVar5 = this.f18430w;
        if (xVar5 != null) {
            AndroidUtilities.removeFromParent(xVar5);
        }
        x xVar6 = new x(activity, this);
        this.f18430w = xVar6;
        this.f18393b1.f22938a = xVar6;
        addView(xVar6);
        FrameLayout.LayoutParams layoutParams4 = (FrameLayout.LayoutParams) this.f18430w.getLayoutParams();
        layoutParams4.width = -1;
        layoutParams4.height = -1;
        layoutParams4.gravity = 51;
        this.f18430w.setLayoutParams(layoutParams4);
        t tVar = this.G;
        if (tVar != null) {
            ...
            if (view.getParent() != this.f18430w) {
                AndroidUtilities.removeFromParent(view);
                this.f18430w.addView(view, w7.x5.c(-1.0f, -1));
                this.f18430w.setShouldHandleBottomInsets(this.G.getEdgeToEdgeSupportMode());
            }
            this.G.onResume();
    ...
    public void setInnerTranslationX(float f7) {
        ...
        this.O = f7;
        invalidate();
        if (this.O0.size() >= 2 && this.f18425s.getMeasuredWidth() > 0) {
            if (D()) {
                measuredWidth = Utilities.clamp01(f7 / (AndroidUtilities.dp(56.0f) * 6));
            } else {
                measuredWidth = f7 / this.f18425s.getMeasuredWidth();
            }
            o2 o2Var = (o2) p6.g(2, this.O0);
    ...
    public void setThemeAnimationValue(float f7) {
        this.m0 = f7;
        ArrayList arrayList = this.f18406h0;
        int size = arrayList.size();
        int i10 = 0;
        while (i10 < size) {
            ArrayList arrayList2 = (ArrayList) arrayList.get(i10);
            int[] iArr = (int[]) this.f18392b0.get(i10);
            int[] iArr2 = (int[]) this.f18395c0.get(i10);
            ...
            while (i11 < size2) {
                ...
                int i14 = l6Var.f19384f;
                f6 f6Var = l6Var.f19392o;
                if (f6Var != null) {
                    f6Var.L0(i14, argb);
                } else {
        ...
        ArrayList arrayList4 = this.f18410j0;
        ...
        ArrayList arrayList5 = this.f18408i0;
        if (arrayList5 != null) {
            int size4 = arrayList5.size();
            for (int i16 = 0; i16 < size4; i16++) {
                l6 l6Var2 = (l6) this.f18408i0.get(i16);
                l6Var2.d(j6.v0(l6Var2.f19384f, l6Var2.f19392o), false, false);
            }
        }
        wn wnVar = this.f18404g0;
        if (wnVar != null) {
            zn znVar = wnVar.f39084a;
            znVar.V.f32506x0.invalidate();
            znVar.I.I = f7;
            znVar.J.I = f7;
            znVar.k(f7);
        }
    ...
    public final jz w() {
        ...
        if (this.G == null) {
            ...
            if (view.getParent() != this.f18430w) {
                ...
                this.f18430w.addView(view, w7.x5.c(-1.0f, -1));
                this.f18430w.setShouldHandleBottomInsets(this.G.getEdgeToEdgeSupportMode());
                this.f18430w.setDrawNavigationBar(this.G.drawEdgeNavigationBar());
            }
            this.G.onResume();
            this.G.onBecomeFullyVisible();
        }
