...
public class ActionBarLayout extends FrameLayout implements d5, mg.b {
    public static Drawable f18560p1;
    public static Drawable f18561q1;
    public static Paint f18562r1;
    public boolean A0;
    public View B0;
    public boolean C0;
    public t D0;
    ...
    public boolean f18564a0;
    public int f18565a1;
    public boolean f18566b;
    public final ArrayList f18567b0;
    public final org.telegram.ui.Components.e6 f18568b1;
    public Window f18569c;
    public final ArrayList f18570c0;
    public boolean f18571c1;
    public Runnable d;
    public final n7.z0 f18572d0;
    public boolean f18573d1;
    public Runnable e;
    public f5 f18574e0;
    public boolean f18575e1;
    public boolean f18576f;
    public f5 f18577f0;
    public float f18578f1;
    public un f18579g0;
    public boolean f18580g1;
    public boolean h;
    public final ArrayList f18581h0;
    public AnimatorSet f18582h1;
    public ArrayList f18583i0;
    public ArrayList f18584i1;
    public final ArrayList f18585j0;
    public final o f18586j1;
    public AnimatorSet f18587k0;
    public boolean f18588k1;
    public final AnimationNotificationsLocker f18589l0;
    public int l1;
    public float m0;
    public r0.m1 f18590m1;
    public boolean f18591n;
    public boolean f18592n0;
    public i0.b f18593n1;
    public i6 f18594o0;
    public i0.b f18595o1;
    public boolean f18596p0;
    public boolean f18597q0;
    public ColorDrawable f18598r;
    public int f18599r0;
    public w f18600s;
    public boolean f18601s0;
    public boolean f18602t0;
    public boolean f18603u0;
    public w v;
    public long f18604v0;
    public w f18605w;
    public boolean f18606w0;
    public z3 f18607x;
    public int f18608x0;
    public k f18609y;
    public Runnable f18610y0;
    public Runnable f18611z0;
    ...
    public ActionBarLayout(Context context, boolean z10) {
        ...
        this.f18567b0 = new ArrayList();
        this.f18570c0 = new ArrayList();
        n7.z0 z0Var = new n7.z0(1);
        z0Var.f15367b = new SparseIntArray();
        z0Var.f15368c = new int[]{j6.Aa, j6.Da, j6.Ea, j6.Fa, j6.f19011ac, j6.Ca};
        this.f18572d0 = z0Var;
        this.f18581h0 = new ArrayList();
        this.f18585j0 = new ArrayList();
        this.f18589l0 = new AnimationNotificationsLocker();
        this.Q0 = new Rect();
        this.T0 = -1;
        this.V0 = new Path();
        this.W0 = new float[8];
        this.Y0 = new int[2];
        this.f18568b1 = new org.telegram.ui.Components.e6(this, 280L, qr.h);
        this.f18584i1 = new ArrayList();
        this.f18586j1 = new o(this, 2);
        i0.b bVar = i0.b.e;
        this.f18593n1 = bVar;
        this.f18595o1 = bVar;
        ...
        this.L0 = z10;
        if (f18561q1 == null) {
            f18561q1 = getResources().getDrawable(R.drawable.layer_shadow);
            f18560p1 = getResources().getDrawable(R.drawable.header_shadow).mutate();
            f18562r1 = new Paint();
        }
        p pVar = new p(this, 0);
    ...
    public static void a(ActionBarLayout actionBarLayout, boolean z10) {
        ...
        if (!z10) {
            ...
            n2 n2Var = (n2) t8.b.h(1, actionBarLayout.O0);
            ...
            n2 n2Var3 = (n2) t8.b.h(2, actionBarLayout.O0);
        ...
        actionBarLayout.f18600s.setLayerType(0, null);
    ...
    public final boolean D() {
        if (this.f18573d1 && this.f18575e1) {
            return true;
        }
        return false;
    }
    ...
    public final void F(boolean z10) {
        ...
        setAlpha(1.0f);
        this.f18600s.setAlpha(1.0f);
        this.f18600s.setScaleX(1.0f);
        this.f18600s.setScaleY(1.0f);
    ...
    public final void G() {
        k kVar;
        if (!this.f18564a0 && !this.Q && !j() && !this.O0.isEmpty()) {
            z20 z20Var = z20.f30710d0;
            if (z20Var != null && z20Var.f30722w) {
                z20Var.e(false);
                return;
            }
            if (!e0() && (kVar = this.f18609y) != null && !kVar.s()) {
                k kVar2 = this.f18609y;
                if (kVar2.f19505n0) {
                    kVar2.h(true);
                    return;
                }
    ...
    public final void H() {
        if (this.W && this.f18610y0 != null) {
            ...
            this.H = null;
            this.I = null;
            Runnable runnable = this.f18610y0;
            this.f18610y0 = null;
            if (runnable != null) {
                runnable.run();
            }
    ...
    public final void K() {
        Runnable runnable;
        if (this.W && (runnable = this.f18611z0) != null) {
            this.W = false;
            this.f18564a0 = false;
            this.f18604v0 = 0L;
            this.H = null;
    ...
    public final void O() {
        ...
        if (!n2Var.hasOwnBackground && view.getBackground() == null) {
            view.setBackgroundColor(j6.w0(null, j6.f19062d6, false));
        }
        n2Var.onResume();
        if (this.f18587k0 != null) {
            this.f18583i0 = n2Var.getThemeDescriptions();
        }
        this.f18600s.setLayerType(2, null);
    ...
    public final void b0(n2 n2Var, boolean z10) {
        ...
        } else if (t8.b.h(1, this.O0) == n2Var && this.O0.size() > 1) {
    ...
    public final boolean c(int i10, n2 n2Var) {
        ...
        if (i10 != -1 && i10 != -2) {
            if (i10 == -3) {
                ...
                this.f18600s.setShouldHandleBottomInsets(n2Var.getEdgeToEdgeSupportMode());
                this.f18600s.setDrawNavigationBar(n2Var.drawEdgeNavigationBar());
                k kVar = n2Var.actionBar;
                if (kVar != null && kVar.K) {
                    if (this.C0) {
                    ...
                    this.f18600s.addView(n2Var.actionBar);
                }
                n2Var.setTitleOverlayTextIfActionBarAttached(this.G0, this.H0, this.I0);
                n2Var.attachSheets(this.f18600s);
                i10 = 0;
            }
            ...
            if (i10 != -2) {
                ...
                if (!n2Var.hasOwnBackground && view3.getBackground() == null) {
                    view3.setBackgroundColor(j6.w0(null, j6.f19062d6, false));
                }
                this.f18600s.addView(view3, w7.y5.c(-1.0f, -1));
                this.f18600s.setShouldHandleBottomInsets(n2Var.getEdgeToEdgeSupportMode());
                this.f18600s.setDrawNavigationBar(n2Var.drawEdgeNavigationBar());
        ...
        if (!this.O0.isEmpty()) {
            ...
            if (!this.O0.isEmpty()) {
                if (this.O0.isEmpty() || this.O0.size() - 1 != size || ((n2) this.O0.get(size)).fragmentView == null) {
                    ...
                    this.f18600s.addView(view2, w7.y5.c(-1.0f, -1));
                    this.f18600s.setShouldHandleBottomInsets(n2Var2.getEdgeToEdgeSupportMode());
                    this.f18600s.setDrawNavigationBar(n2Var2.drawEdgeNavigationBar());
                    k kVar2 = n2Var2.actionBar;
                    if (kVar2 != null && kVar2.K) {
                        ...
                        this.f18600s.addView(n2Var2.actionBar);
                    }
                    n2Var2.setTitleOverlayTextIfActionBarAttached(this.G0, this.H0, this.I0);
                    n2Var2.attachSheets(this.f18600s);
                    n2Var2.onResume();
                    n2Var2.onBecomeFullyVisible();
                    this.f18609y = n2Var2.actionBar;
                    if (!n2Var2.hasOwnBackground && view2.getBackground() == null) {
                        view2.setBackgroundColor(j6.w0(null, j6.f19062d6, false));
                    }
                }
            }
        }
    ...
    public final void d(ArrayList arrayList) {
        if (arrayList != null) {
            this.f18581h0.add(arrayList);
            int[] iArr = new int[arrayList.size()];
            this.f18567b0.add(iArr);
            int size = arrayList.size();
            for (int i10 = 0; i10 < size; i10++) {
                ...
                l6Var.h = null;
                if (k6Var != null) {
                    ArrayList arrayList2 = this.f18585j0;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.E != null && v(true) > 0) {
            canvas2 = canvas;
            canvas2.drawRect(0.0f, getHeight() - (this.E.getMeasuredHeight() + this.f18593n1.d), getWidth(), getHeight(), this.E.getBackgroundPaint());
        } else {
            canvas2 = canvas;
        }
        this.U0 = true;
    ...
    public final void e(boolean z10) {
        ...
        float x10 = this.f18600s.getX();
        AnimatorSet animatorSet = new AnimatorSet();
        boolean shouldOverrideSlideTransition = n2Var.shouldOverrideSlideTransition(false, z10);
        Property property = View.TRANSLATION_X;
        if (!z10) {
            x10 = Math.abs(this.f18600s.getMeasuredWidth() - x10);
            int measuredWidth = (int) ((200.0f / this.f18600s.getMeasuredWidth()) * x10);
            if (D()) {
                i11 = 380;
            } else {
                i11 = 50;
            ...
            if (!shouldOverrideSlideTransition) {
                ...
                long j3 = max;
                animatorSet.playTogether(ofFloat.setDuration(j3), ObjectAnimator.ofFloat(this, "innerTranslationX", this.f18600s.getMeasuredWidth()).setDuration(j3));
                if (D()) {
                    animatorSet.setInterpolator(qr.h);
                }
            }
        } else {
            int measuredWidth3 = (int) ((320.0f / this.f18600s.getMeasuredWidth()) * x10);
            if (D()) {
                i10 = 320;
            } else {
                i10 = 120;
            ...
            if (!shouldOverrideSlideTransition) {
                ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(this.f18600s, property, 0.0f);
                long j10 = max2;
    ...
    public float getCurrentPreviewFragmentAlpha() {
        w wVar;
        if (!this.h && !this.f18564a0 && !this.f18591n) {
            return 0.0f;
        }
        n2 n2Var = this.I;
    ...
    public final void h(String str) {
        if (BuildVars.DEBUG_VERSION) {
            ArrayList arrayList = this.f18584i1;
            StringBuilder j3 = t8.b.j(str, " ");
            j3.append(this.O0.size());
            arrayList.add(0, j3.toString());
            if (this.f18584i1.size() > 20) {
                ArrayList arrayList2 = new ArrayList();
                for (int i10 = 0; i10 < 10; i10++) {
                    arrayList2.add((String) this.f18584i1.get(i10));
                }
                this.f18584i1 = arrayList2;
            }
        }
        o oVar = this.f18586j1;
    ...
    public final void i() {
        if (this.f18601s0) {
            U(this.f18602t0, this.f18603u0);
            this.f18601s0 = false;
        } else if (this.f18592n0) {
            c5 c5Var = new c5(this.f18594o0, this.f18599r0, this.f18597q0, false);
            boolean z10 = this.f18596p0;
            if (!z10) {
                c5Var.f18749g = z10;
                c5Var.f18748f = z10;
            }
    ...
    public final boolean j() {
        ...
        if (this.W && (this.f18604v0 < System.currentTimeMillis() - 1500 || this.h)) {
            F(true);
        }
        return this.W;
    }
    ...
    public final void l(boolean z10, boolean z11) {
        ...
        if (lastFragment == null || !lastFragment.closeLastFragment()) {
            ...
            if ((a5Var == null || a5Var.k(this)) && !j() && !this.O0.isEmpty()) {
                ...
                if (!z11 && (this.h || this.f18564a0 || (z10 && MessagesController.getGlobalMainSettings().getBoolean("view_animations", true)))) {
                    z12 = true;
                } else {
                    z12 = false;
                }
                ...
                if (this.O0.size() > 1) {
                    n2Var = (n2) t8.b.h(2, this.O0);
                } else {
                    n2Var = null;
                }
                if (n2Var != null) {
                    if (j6.w0(null, j6.f19340s8, false) != -1 && (!n2Var.hasForceLightStatusBar() || j6.A0().q())) {
                        z13 = false;
                    } else {
                        z13 = true;
                    }
                    ...
                    this.f18609y = n2Var.actionBar;
                    if (!n2Var.hasOwnBackground && view.getBackground() == null) {
                        view.setBackgroundColor(j6.w0(null, j6.f19062d6, false));
                    }
                    if (z12) {
                        this.f18604v0 = System.currentTimeMillis();
                        this.W = true;
                        n2Var2.setRemovingFromStack(true);
                        this.f18610y0 = new org.telegram.messenger.video.o(this, n2Var2, n2Var, 3);
                        if (!this.h && !this.f18564a0) {
                            animatorSet = n2Var2.onCustomTransitionAnimation(false, new o(this, 3));
                        }
                        if (animatorSet == null) {
                            boolean z15 = this.h;
                            if (!z15 && (this.f18600s.f19823b || this.v.f19823b)) {
                                v2 v2Var = new v2(this, 1);
                                this.d = v2Var;
                                AndroidUtilities.runOnUIThread(v2Var, 200L);
                            } else {
                                if (!z15 && !this.f18564a0) {
                                    z14 = false;
                                } else {
                                    z14 = true;
                                }
                    ...
                    this.f18604v0 = System.currentTimeMillis();
                    this.W = true;
                    this.f18610y0 = new ki.c0(26, this, n2Var2);
    ...
    public final void m(n2 n2Var) {
        ...
        bringChildToFront(this.f18600s);
        w wVar = this.f18605w;
        if (wVar != null) {
    ...
    public final void o(View view, r0.m1 m1Var) {
        ...
        boolean z11 = this.M0;
        if (z11) {
            if ((view instanceof w) && ((w) view).f19830x) {
                int i18 = m1Var.f42109a.f(8).d;
                ...
                r0.i0.b(view, y0Var.b());
                return;
            }
            r0.i0.b(view, r0.m1.f42108b);
            return;
        }
        boolean z12 = this.N0;
        boolean z13 = true;
        ...
        i0.b bVar = this.f18593n1;
        i0.b bVar2 = this.f18595o1;
        if (view instanceof o3) {
            ...
            if (a4Var == a4.f18628a) {
                ...
                r0.i0.b(view, m1Var.f42109a.m(i13, 0, i14, i10));
            }
    ...
    public final boolean onKeyUp(int i10, KeyEvent keyEvent) {
        k kVar;
        z zVar;
        if (i10 == 82 && !j() && !this.Q && (kVar = this.f18609y) != null && !kVar.s() && (zVar = kVar.E) != null) {
            ...
            if (this.O0.size() > 1 && ((sVar = this.G) == null || sVar.getLastSheet() == null || !this.G.getLastSheet().isShown())) {
                if (motionEvent != null && motionEvent.getAction() == 0) {
                    if (!((n2) t8.b.h(1, this.O0)).isSwipeBackEnabled(motionEvent)) {
                        ...
                        this.f18608x0 = motionEvent.getPointerId(0);
                        this.P = true;
                ...
                } else if (motionEvent != null && motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.f18608x0) {
                    if (this.U == null) {
                    ...
                    if (!this.W && !this.h && this.P && !this.Q && max >= AndroidUtilities.getPixelsInCM(0.4f, true) && Math.abs(max) / 3 > abs) {
                        if (((n2) t8.b.h(1, this.O0)).canBeginSlide() && u(this, motionEvent.getX(), motionEvent.getY()) == null) {
                            this.R = (int) motionEvent.getX();
                            O();
                        } else {
                            this.P = false;
                        ...
                        if (D()) {
                            float f7 = max;
                            this.f18600s.setTranslationX((f7 / getWidth()) * AndroidUtilities.dp(56.0f) * 5);
                            setInnerTranslationX((f7 / getWidth()) * AndroidUtilities.dp(56.0f) * 5);
                        } else {
                            float f10 = max;
                            this.f18600s.setTranslationX(f10);
                            setInnerTranslationX(f10);
                        }
                    }
                } else if (motionEvent != null && motionEvent.getPointerId(0) == this.f18608x0 && (motionEvent.getAction() == 3 || motionEvent.getAction() == 1 || motionEvent.getAction() == 6)) {
                    if (this.U == null) {
                        this.U = VelocityTracker.obtain();
                    }
                    this.U.addMovement(motionEvent);
                    ...
                    if (!this.h && !this.f18564a0 && !this.Q && n2Var.isSwipeBackEnabled(motionEvent)) {
                    ...
                    if (this.Q) {
                        ...
                        if (!D() ? x10 < this.f18600s.getMeasuredWidth() / 3.0f : !(x10 >= AndroidUtilities.dp(56.0f) / 2 && xVelocity2 >= -1000.0f)) {
    ...
    public final void p(Canvas canvas, int i10, int i11) {
        if (f18560p1 != null && SharedConfig.drawActionBarShadow) {
            int i12 = i10 / 2;
            if (f18560p1.getAlpha() != i12) {
                f18560p1.setAlpha(i12);
            }
            f18560p1.setBounds(0, i11, getMeasuredWidth(), f18560p1.getIntrinsicHeight() + i11);
            f18560p1.draw(canvas);
        }
    }
    ...
    public final boolean s(Menu menu) {
        if (!this.O0.isEmpty() && ((n2) t8.b.h(1, this.O0)).extendActionMode(menu)) {
            return true;
        }
        return false;
    }
    ...
    public void setFragmentStack(List<n2> list) {
        ...
        if (z10) {
            ...
            x3 x3Var = LaunchActivity.G1.f31104y0;
            if (x3Var != null) {
        ...
        this.f18600s = wVar4;
        addView(wVar4);
        FrameLayout.LayoutParams layoutParams3 = (FrameLayout.LayoutParams) this.f18600s.getLayoutParams();
        layoutParams3.width = -1;
        layoutParams3.height = -1;
        layoutParams3.gravity = 51;
        this.f18600s.setLayoutParams(layoutParams3);
        w wVar5 = this.f18605w;
        if (wVar5 != null) {
            AndroidUtilities.removeFromParent(wVar5);
        }
        w wVar6 = new w(activity, this);
        this.f18605w = wVar6;
        this.f18568b1.f23792a = wVar6;
        addView(wVar6);
        FrameLayout.LayoutParams layoutParams4 = (FrameLayout.LayoutParams) this.f18605w.getLayoutParams();
        layoutParams4.width = -1;
        layoutParams4.height = -1;
        layoutParams4.gravity = 51;
        this.f18605w.setLayoutParams(layoutParams4);
        s sVar = this.G;
        if (sVar != null) {
            ...
            if (view.getParent() != this.f18605w) {
                AndroidUtilities.removeFromParent(view);
                this.f18605w.addView(view, w7.y5.c(-1.0f, -1));
                this.f18605w.setShouldHandleBottomInsets(this.G.getEdgeToEdgeSupportMode());
            }
            this.G.onResume();
    ...
    public void setInnerTranslationX(float f7) {
        ...
        this.O = f7;
        invalidate();
        if (this.O0.size() >= 2 && this.f18600s.getMeasuredWidth() > 0) {
            if (D()) {
                measuredWidth = Utilities.clamp01(f7 / (AndroidUtilities.dp(56.0f) * 6));
            } else {
                measuredWidth = f7 / this.f18600s.getMeasuredWidth();
            }
            n2 n2Var = (n2) t8.b.h(2, this.O0);
    ...
    public void setThemeAnimationValue(float f7) {
        this.m0 = f7;
        ArrayList arrayList = this.f18581h0;
        int size = arrayList.size();
        int i10 = 0;
        while (i10 < size) {
            ArrayList arrayList2 = (ArrayList) arrayList.get(i10);
            int[] iArr = (int[]) this.f18567b0.get(i10);
            int[] iArr2 = (int[]) this.f18570c0.get(i10);
            ...
            while (i11 < size2) {
                ...
                int i14 = l6Var.f19577f;
                e6 e6Var = l6Var.f19585o;
                if (e6Var != null) {
                    e6Var.L0(i14, argb);
                } else {
        ...
        ArrayList arrayList4 = this.f18585j0;
        ...
        ArrayList arrayList5 = this.f18583i0;
        if (arrayList5 != null) {
            int size4 = arrayList5.size();
            for (int i16 = 0; i16 < size4; i16++) {
                l6 l6Var2 = (l6) this.f18583i0.get(i16);
                l6Var2.d(j6.v0(l6Var2.f19577f, l6Var2.f19585o), false, false);
            }
        }
        un unVar = this.f18579g0;
        if (unVar != null) {
            xn xnVar = unVar.f38031a;
            xnVar.V.f40488x0.invalidate();
            xnVar.I.I = f7;
            xnVar.J.I = f7;
            xnVar.k(f7);
        }
    ...
    public final hz w() {
        ...
        if (this.G == null) {
            ...
            if (view.getParent() != this.f18605w) {
                ...
                this.f18605w.addView(view, w7.y5.c(-1.0f, -1));
                this.f18605w.setShouldHandleBottomInsets(this.G.getEdgeToEdgeSupportMode());
                this.f18605w.setDrawNavigationBar(this.G.drawEdgeNavigationBar());
            }
            this.G.onResume();
            this.G.onBecomeFullyVisible();
        }
