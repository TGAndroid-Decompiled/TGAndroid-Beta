...
public final class r3 extends j1.b {
    public final Rect f19706o;
    public final v3 f19707p;

    public r3(v3 v3Var, v3 v3Var2) {
        super(v3Var2);
        this.f19707p = v3Var;
        this.f19706o = new Rect();
    }

    @Override
    public final int g(float f7, float f10) {
        v3 v3Var = this.f19707p;
        ArrayList arrayList = v3Var.R;
        if (v3Var.V >= 0.5f) {
            org.telegram.ui.Cells.z zVar = v3Var.f19851i0;
            if (zVar != null && zVar.getBounds().contains((int) f7, (int) f10)) {
                return 1;
            }
            for (int size = arrayList.size() - 1; size >= 0; size--) {
                u3 u3Var = (u3) arrayList.get(size);
                float f11 = u3Var.f19811i;
                RectF rectF = u3Var.f19806a;
                if (Math.abs(f11) < 0.4f && rectF.contains(f7, f10)) {
                    Rect bounds = u3Var.d.f19481k.getBounds();
    ...
    public final void h(ArrayList arrayList) {
        ...
        if (v3Var.V >= 0.5f) {
            ...
            for (int i10 = 0; i10 < arrayList2.size(); i10++) {
                ...
                if (Math.abs(u3Var.f19811i) < 0.4f && !u3Var.f19806a.isEmpty()) {
                    arrayList.add(Integer.valueOf(i10 + 1000));
                    j3 j3Var = u3Var.d;
                    if (j3Var != null && !j3Var.f19481k.getBounds().isEmpty()) {
    ...
    public final boolean k(int i10, int i11) {
        ...
        if (i11 == 16) {
            ...
            if (i12 >= 0 && i12 < arrayList.size()) {
                ...
                if (z10) {
                    m3 m3Var2 = v3Var.f19839a;
                    if (m3Var2 != null) {
                        m3Var2.g(u3Var.f19808c, new ai.g3(26, this, u3Var));
                        return true;
                    }
                } else if (v3Var.f19839a != null) {
                    v3Var.a(false);
                    u3Var.getClass();
                    v3Var.f19839a.e(u3Var.f19808c);
                }
                return true;
            }
        }
