...
public final class y4 {
    public static final k4 f19724p = new Object();
    public static final List f19725q = Arrays.asList(Integer.valueOf(R.id.menu_regular), Integer.valueOf(R.id.menu_bold), Integer.valueOf(R.id.menu_italic), Integer.valueOf(R.id.menu_strike), Integer.valueOf(R.id.menu_mono), Integer.valueOf(R.id.menu_underline), Integer.valueOf(R.id.menu_spoiler), Integer.valueOf(R.id.menu_link), Integer.valueOf(R.id.menu_quote), Integer.valueOf(R.id.menu_date));
    public static final List f19726r = Arrays.asList(Integer.valueOf(R.id.menu_bold), Integer.valueOf(R.id.menu_italic), Integer.valueOf(R.id.menu_strike), Integer.valueOf(R.id.menu_link), Integer.valueOf(R.id.menu_mono), Integer.valueOf(R.id.menu_underline), Integer.valueOf(R.id.menu_spoiler), Integer.valueOf(R.id.menu_quote));
    public final View f19727a;
    public final w4 f19728b;
    public Menu e;
    public final int f19732i;
    public Runnable f19733j;
    public qt f19734k;
    public final f6 f19737n;
    public final ah.c f19738o;
    public final Rect f19729c = new Rect();
    public final Rect d = new Rect();
    public ArrayList f19730f = new ArrayList();
    public MenuItem.OnMenuItemClickListener f19731g = f19724p;
    public boolean h = true;
    public final l4 f19735l = new l4(this);
    public final a4.e f19736m = new a4.e(23);
    ...
    public y4(Context context, View view, int i10, f6 f6Var, ah.c cVar) {
        ...
        this.f19738o = cVar;
        this.f19737n = f6Var;
        this.f19728b = new w4(this, context, view);
    }
    ...
    public static LinearLayout b(y4 y4Var, Context context, MenuItem menuItem, boolean z10, boolean z11, boolean z12) {
        ...
        int v03 = j6.v0(j6.f18952i6, f6Var);
        int i13 = y4Var.f19732i;
        if (i13 == 0) {
            v02 = j6.v0(j6.f18969j5, f6Var);
    ...
    public final ArrayList d(Menu menu) {
        ...
        for (int i10 = 0; menu != null && i10 < menu.size(); i10++) {
            ...
            if (item.isVisible() && item.isEnabled()) {
                ...
                } else if ((item.getItemId() != R.id.menu_quote || (qtVar = this.f19734k) == null || ((Boolean) qtVar.run()).booleanValue()) && item.getItemId() != 16908353 && item.getItemId() != 16909808 && (item.getItemId() != R.id.menu_regular || this.f19733j == null)) {
                    arrayList.add(item);
                }
            }
        }
