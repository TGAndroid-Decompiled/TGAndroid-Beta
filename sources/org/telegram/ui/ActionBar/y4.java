...
public final class y4 {
    public static final k4 f19725p = new Object();
    public static final List f19726q = Arrays.asList(Integer.valueOf(R.id.menu_regular), Integer.valueOf(R.id.menu_bold), Integer.valueOf(R.id.menu_italic), Integer.valueOf(R.id.menu_strike), Integer.valueOf(R.id.menu_mono), Integer.valueOf(R.id.menu_underline), Integer.valueOf(R.id.menu_spoiler), Integer.valueOf(R.id.menu_link), Integer.valueOf(R.id.menu_quote), Integer.valueOf(R.id.menu_date));
    public static final List f19727r = Arrays.asList(Integer.valueOf(R.id.menu_bold), Integer.valueOf(R.id.menu_italic), Integer.valueOf(R.id.menu_strike), Integer.valueOf(R.id.menu_link), Integer.valueOf(R.id.menu_mono), Integer.valueOf(R.id.menu_underline), Integer.valueOf(R.id.menu_spoiler), Integer.valueOf(R.id.menu_quote));
    public final View f19728a;
    public final w4 f19729b;
    public Menu e;
    public final int f19733i;
    public Runnable f19734j;
    public qt f19735k;
    public final f6 f19738n;
    public final ah.c f19739o;
    public final Rect f19730c = new Rect();
    public final Rect d = new Rect();
    public ArrayList f19731f = new ArrayList();
    public MenuItem.OnMenuItemClickListener f19732g = f19725p;
    public boolean h = true;
    public final l4 f19736l = new l4(this);
    public final a4.e f19737m = new a4.e(23);
    ...
    public y4(Context context, View view, int i10, f6 f6Var, ah.c cVar) {
        ...
        this.f19739o = cVar;
        this.f19738n = f6Var;
        this.f19729b = new w4(this, context, view);
    }
    ...
    public static LinearLayout b(y4 y4Var, Context context, MenuItem menuItem, boolean z10, boolean z11, boolean z12) {
        ...
        int v03 = j6.v0(j6.f18953i6, f6Var);
        int i13 = y4Var.f19733i;
        if (i13 == 0) {
            v02 = j6.v0(j6.f18970j5, f6Var);
    ...
    public final ArrayList d(Menu menu) {
        ...
        for (int i10 = 0; menu != null && i10 < menu.size(); i10++) {
            ...
            if (item.isVisible() && item.isEnabled()) {
                ...
                } else if ((item.getItemId() != R.id.menu_quote || (qtVar = this.f19735k) == null || ((Boolean) qtVar.run()).booleanValue()) && item.getItemId() != 16908353 && item.getItemId() != 16909808 && (item.getItemId() != R.id.menu_regular || this.f19734j == null)) {
                    arrayList.add(item);
                }
            }
        }
