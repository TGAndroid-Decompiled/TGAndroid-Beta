...
public final class y4 {
    public static final k4 f20754p = new Object();
    public static final List f20755q = Arrays.asList(Integer.valueOf(R.id.menu_regular), Integer.valueOf(R.id.menu_bold), Integer.valueOf(R.id.menu_italic), Integer.valueOf(R.id.menu_strike), Integer.valueOf(R.id.menu_mono), Integer.valueOf(R.id.menu_underline), Integer.valueOf(R.id.menu_spoiler), Integer.valueOf(R.id.menu_link), Integer.valueOf(R.id.menu_quote), Integer.valueOf(R.id.menu_date));
    public static final List f20756r = Arrays.asList(Integer.valueOf(R.id.menu_bold), Integer.valueOf(R.id.menu_italic), Integer.valueOf(R.id.menu_strike), Integer.valueOf(R.id.menu_link), Integer.valueOf(R.id.menu_mono), Integer.valueOf(R.id.menu_underline), Integer.valueOf(R.id.menu_spoiler), Integer.valueOf(R.id.menu_quote));
    public final View f20757a;
    public final w4 f20758b;
    public Menu e;
    public final int f20762i;
    public Runnable f20763j;
    public mt f20764k;
    public final f6 f20767n;
    public final ng.a f20768o;
    public final Rect f20759c = new Rect();
    public final Rect d = new Rect();
    public ArrayList f20760f = new ArrayList();
    public MenuItem.OnMenuItemClickListener f20761g = f20754p;
    public boolean h = true;
    public final l4 f20765l = new l4(this);
    public final nh.e4 f20766m = new nh.e4(4);
    ...
    public y4(Context context, View view, int i10, f6 f6Var, ng.a aVar) {
        ...
        this.f20768o = aVar;
        this.f20767n = f6Var;
        this.f20758b = new w4(this, context, view);
    }
    ...
    public static LinearLayout b(y4 y4Var, Context context, MenuItem menuItem, boolean z4, boolean z10, boolean z11) {
        ...
        int v03 = j6.v0(j6.f19996i6, f6Var);
        int i13 = y4Var.f20762i;
        if (i13 == 0) {
            v02 = j6.v0(j6.f20012j5, f6Var);
    ...
    public final ArrayList d(Menu menu) {
        ...
        for (int i10 = 0; menu != null && i10 < menu.size(); i10++) {
            ...
            if (item.isVisible() && item.isEnabled()) {
                ...
                } else if ((item.getItemId() != R.id.menu_quote || (mtVar = this.f20764k) == null || ((Boolean) mtVar.run()).booleanValue()) && item.getItemId() != 16908353 && item.getItemId() != 16909808 && (item.getItemId() != R.id.menu_regular || this.f20763j == null)) {
                    arrayList.add(item);
                }
            }
        }
