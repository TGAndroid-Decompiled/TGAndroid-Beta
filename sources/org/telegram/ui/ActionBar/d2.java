...
public class d2 extends Dialog implements Drawable.Callback, NotificationCenter.NotificationCenterDelegate {
    ...
    public int Z;
    public int f19559a;
    public final int f19560a0;
    public View f19561b;
    public int f19562b0;
    public TextView f19563c;
    ...
    public boolean f19569g0;
    public TextView h;
    public jj0 f19570h0;
    public CharSequence f19571i0;
    public c2 f19572j0;
    public CharSequence f19573k0;
    public c2 f19574l0;
    public String m0;
    public du f19575n;
    public vh.z3 f19576n0;
    public CharSequence f19577o0;
    public c2 f19578p0;
    public ViewGroup f19579q0;
    public FrameLayout f19580r;
    public o80 f19581r0;
    public FrameLayout f19582s;
    public TextView f19583s0;
    public s80 f19584t0;
    public final int[] f19585u0;
    public x1 v;
    public boolean f19586v0;
    public LinearLayout f19587w;
    public final Drawable f19588w0;
    public a2 f19589x;
    public final Rect f19590x0;
    public final BitmapDrawable[] f19591y;
    public final float f19592y0;
    public Bitmap f19593z0;
    ...
    public static void a(d2 d2Var, int i10, boolean z4) {
        ...
        if ((z4 && !zArr[i10]) || (!z4 && zArr[i10])) {
            ...
            BitmapDrawable bitmapDrawable = d2Var.f19591y[i10];
    ...
    public final View d(int i10) {
        ViewGroup viewGroup = this.f19579q0;
        if (viewGroup != null) {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        du duVar;
        if (i10 == NotificationCenter.emojiLoaded && (duVar = this.f19575n) != null) {
            duVar.invalidate();
        }
    }
    ...
    public void dismiss() {
        ...
        if (callback != null) {
            ...
            if (this.B0 != null && (bitmap = this.f19593z0) != null) {
                bitmap.recycle();
                this.B0 = null;
                this.C0 = null;
                this.f19593z0 = null;
    ...
    public final ViewGroup f(boolean z4) {
        ...
        if ((z11 || i27 == 3) && i27 != 2) {
            ...
            boolean z12 = this.f19569g0;
            Drawable drawable = this.f19588w0;
            if (z12) {
                Rect rect = new Rect();
                ...
                b2Var2.setOutlineProvider(new kf.q0(AndroidUtilities.dp(8.0f), AndroidUtilities.dp(20.0f)));
            ...
            if (this.V0 == null) {
                ...
                frameLayout.setOnClickListener(new View.OnClickListener(this) {
                    ...
                    public final void onClick(View view) {
                        switch (r2) {
                            case 0:
                                this.f20574b.dismiss();
                                return;
                            case 1:
                                d2 d2Var = this.f20574b;
                                new aa(d2Var.getContext(), d2Var.O0).show();
                                return;
                            default:
                                d2 d2Var2 = this.f20574b;
        ...
        if (this.f19571i0 == null && this.f19573k0 == null && this.m0 == null && this.f19577o0 == null) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (this.R == 0 && this.U == 0 && this.Y == null) {
            ...
            if (drawable2 != null) {
                ...
                if (drawable3 instanceof s6) {
                    ...
                    this.f19570h0.addOnAttachStateChangeListener(new v1(s6Var));
                    s6Var.a(this.f19570h0);
                }
            } else {
                int i28 = this.R;
                if (i28 != 0) {
                    ...
                    jj0 jj0Var = this.f19570h0;
                    int i29 = this.U;
                    int i30 = this.V;
                    jj0Var.f(i29, i30, i30, null);
                    if (this.W != null) {
                        gj0 animatedDrawable = this.f19570h0.getAnimatedDrawable();
                        for (Map.Entry entry : this.W.entrySet()) {
                            Integer num = (Integer) entry.getValue();
                            num.getClass();
                            animatedDrawable.f25175s.put((String) entry.getKey(), num);
                            animatedDrawable.E();
                        }
                    }
                    this.f19570h0.d();
            ...
            this.f19570h0.setScaleType(ImageView.ScaleType.CENTER);
            if (this.T) {
                GradientDrawable gradientDrawable = new GradientDrawable();
                gradientDrawable.setColor(this.Z);
                gradientDrawable.setCornerRadius(AndroidUtilities.dp(128.0f));
                this.f19570h0.setBackground(new w1(this, gradientDrawable));
                this.X = 92;
            } else {
                this.f19570h0.setBackground(j6.c0(AndroidUtilities.dp(10.0f), 0, this.Z));
            }
            if (this.T) {
                this.f19570h0.setTranslationY(AndroidUtilities.dp(16.0f));
            } else {
                this.f19570h0.setTranslationY(0.0f);
            }
            this.f19570h0.setPadding(0, 0, 0, 0);
            this.X0.addView(this.f19570h0, k7.b6.t(-1, this.X, 51, 0, 0, 0, 0));
        }
        if (this.O != null) {
            FrameLayout frameLayout2 = new FrameLayout(getContext());
            this.f19582s = frameLayout2;
            ...
            ih.s sVar2 = this.f19567f;
            sVar2.h = 3;
            sVar2.setText(this.O);
            this.f19567f.setTextColor(e(j6.f19987j5));
            this.f19567f.setTextSize(1, 20.0f);
            this.f19567f.setTypeface(AndroidUtilities.bold());
            ih.s sVar3 = this.f19567f;
            if (this.T) {
                i24 = 1;
            ...
            FrameLayout frameLayout3 = this.f19582s;
            ih.s sVar4 = this.f19567f;
            boolean z14 = this.T;
            if (z14) {
                i25 = 1;
            } else if (LocaleController.isRTL) {
        ...
        if (i27 == 0) {
            BitmapDrawable[] bitmapDrawableArr = this.f19591y;
            ...
            this.f19587w = linearLayout;
            linearLayout.setOrientation(1);
            f10 = 20.0f;
            f11 = 4.0f;
            this.v.addView(this.f19587w, new FrameLayout.LayoutParams(-1, -2));
        } else {
            f10 = 20.0f;
            f11 = 4.0f;
        }
        ...
        du duVar2 = this.f19575n;
        if (this.T) {
            i10 = j6.f20256y6;
        } else {
            i10 = j6.f19987j5;
        }
        duVar2.setTextColor(e(i10));
        this.f19575n.setTextSize(1, 16.0f);
        this.f19575n.setMovementMethod(new AndroidUtilities.LinkMovementMethodMy());
        this.f19575n.setLinkTextColor(e(j6.f20005k5));
        if (!this.f19564c0) {
            this.f19575n.setClickable(false);
            this.f19575n.setEnabled(false);
        }
        du duVar3 = this.f19575n;
        if (this.T) {
            i11 = 1;
        } else if (LocaleController.isRTL) {
            i11 = 5;
        ...
        duVar3.setGravity(i11 | 48);
        if (i27 == 2) {
            b2 b2Var4 = this.X0;
            du duVar4 = this.f19575n;
            if (LocaleController.isRTL) {
                i17 = 5;
            } else {
                i17 = 3;
            ...
            b2Var4.addView(duVar4, k7.b6.t(-2, -2, i33, 24, i18, 24, 20));
            o80 o80Var = new o80(getContext());
            this.f19581r0 = o80Var;
            o80Var.a(this.f19562b0 / 100.0f, false);
            this.f19581r0.setProgressColor(e(j6.F5));
            this.f19581r0.setBackColor(e(j6.G5));
            this.X0.addView(this.f19581r0, k7.b6.t(-1, 4, 19, 24, 0, 24, 0));
            TextView textView4 = new TextView(getContext());
            this.f19583s0 = textView4;
            textView4.setTypeface(AndroidUtilities.bold());
            TextView textView5 = this.f19583s0;
            if (LocaleController.isRTL) {
                i19 = 5;
            } else {
                i19 = 3;
            ...
            this.f19583s0.setTextColor(e(j6.f20114q5));
            this.f19583s0.setTextSize(1, 14.0f);
            b2 b2Var5 = this.X0;
            TextView textView6 = this.f19583s0;
            if (LocaleController.isRTL) {
                i20 = 5;
            } else {
                i20 = 3;
            ...
            this.f19583s0.setText(String.format("%d%%", Integer.valueOf(this.f19562b0)));
        } else if (i27 == 3) {
            super.setCanceledOnTouchOutside(false);
            setCancelable(false);
            this.f19580r = new FrameLayout(getContext());
            this.R0 = e(j6.M5);
            if (!this.Q0) {
                this.f19580r.setBackgroundDrawable(j6.b0(AndroidUtilities.dp(18.0f), this.R0));
            }
            this.X0.addView(this.f19580r, k7.b6.q(86, 86, 17));
            ...
            this.f19580r.addView(radialProgressView, k7.b6.e(86, 86, 17));
        } else {
            du duVar5 = this.d;
            if (duVar5 != null) {
                this.f19587w.addView(duVar5, k7.b6.k(22.0f, 4.0f, 22.0f, 12.0f, -1, -2));
            }
            LinearLayout linearLayout2 = this.f19587w;
            du duVar6 = this.f19575n;
            if (this.T) {
                i12 = 1;
            } else if (LocaleController.isRTL) {
                i12 = 5;
            ...
            int i34 = i12 | 48;
            if (this.f19561b == null && this.M == null) {
                i13 = 0;
            } else {
                i13 = this.D;
            }
            linearLayout2.addView(duVar6, k7.b6.t(-2, -2, i34, 24, 0, 24, i13));
            TextView textView7 = this.f19563c;
            if (textView7 != null) {
                this.f19587w.addView(textView7, k7.b6.k(22.0f, 12.0f, 22.0f, 0.0f, -1, -2));
            }
        }
        if (!TextUtils.isEmpty(this.Q)) {
            this.f19575n.setText(this.Q);
            this.f19575n.setVisibility(0);
        } else {
            this.f19575n.setVisibility(8);
        }
        if (this.M != null) {
            int i35 = 0;
            while (true) {
                ...
                if (charSequenceArr[i35] != null) {
                    ...
                    this.K0.add(z1Var);
                    this.f19587w.addView(z1Var, k7.b6.n(-1, 50));
        ...
        View view2 = this.f19561b;
        if (view2 != null) {
            if (view2.getParent() != null) {
                ((ViewGroup) this.f19561b.getParent()).removeView(this.f19561b);
            }
            this.f19587w.addView(this.f19561b, k7.b6.n(-1, this.e));
        }
        if (z10) {
            if (!this.F0) {
                ...
                if (this.f19577o0 != null) {
                    if (i15 > 0) {
                        i15 += AndroidUtilities.dp(8.0f);
                    }
                    CharSequence charSequence4 = this.f19577o0;
                ...
                if (i15 > AndroidUtilities.displaySize.x - AndroidUtilities.dp(64.0f)) {
                    if (this.G0 && this.f19571i0 != null && this.f19573k0 != null && this.m0 != null && this.f19577o0 != null) {
                        this.H0 = true;
                    } else {
                        this.F0 = true;
                    }
            ...
            if (this.F0) {
                ...
                this.f19579q0 = linearLayout3;
            } else {
                this.f19579q0 = new u2(this, getContext(), 1);
            }
            if (this.f19563c != null) {
                this.f19579q0.setPadding(AndroidUtilities.dp(16.0f), 0, AndroidUtilities.dp(16.0f), AndroidUtilities.dp(f11));
                this.f19579q0.setTranslationY(-AndroidUtilities.dp(6.0f));
            } else {
                this.f19579q0.setPadding(AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f));
            }
            b2 b2Var6 = this.X0;
            ViewGroup viewGroup2 = this.f19579q0;
            if (this.H0) {
                i14 = 96;
            } else {
                i14 = 52;
            ...
            if (this.T) {
                this.f19579q0.setTranslationY(-AndroidUtilities.dp(8.0f));
            }
            if (this.f19571i0 != null) {
                ...
                if (this.F0) {
                    f13 = 6.0f;
                    this.f19579q0.addView(y1Var, k7.b6.q(-1, 40, 7));
                } else {
                    f13 = 6.0f;
                    this.f19579q0.addView(y1Var, k7.b6.e(-2, 40, 53));
                }
            ...
            if (this.f19573k0 != null) {
                ...
                y1Var2.setText(this.f19573k0.toString());
                ...
                if (this.F0) {
                    this.f19579q0.addView(y1Var2, 0, k7.b6.q(-1, 40, 7));
                } else {
                    this.f19579q0.addView(y1Var2, k7.b6.e(-2, 40, 53));
                }
            ...
            if (this.f19577o0 != null) {
                ...
                y1Var3.setText(this.f19577o0.toString());
                ...
                if (this.F0) {
                    this.f19579q0.addView(y1Var3, 1, k7.b6.q(-1, 40, 7));
                } else {
                    this.f19579q0.addView(y1Var3, k7.b6.e(-2, 40, 51));
                }
            ...
            if (this.m0 != null) {
                ...
                if (this.F0) {
                    this.f19579q0.addView(y1Var4, 0, k7.b6.q(-1, 40, 7));
                } else {
                    this.f19579q0.addView(y1Var4, k7.b6.e(-2, 40, 53));
                }
                y1Var4.setOnClickListener(new org.telegram.messenger.video.g(6, this, y1Var4));
            }
            if (this.F0) {
                for (int i36 = 1; i36 < this.f19579q0.getChildCount(); i36++) {
                    ((ViewGroup.MarginLayoutParams) this.f19579q0.getChildAt(i36).getLayoutParams()).topMargin = AndroidUtilities.dp(f13);
                }
            }
        }
        ...
        if (this.U0) {
            ...
            Rect rect2 = this.f19590x0;
            layoutParams3.width = min + rect2.left + rect2.right;
        }
        View view3 = this.f19561b;
        if (view3 != null && this.f19586v0 && b(view3)) {
    ...
    public final void h() {
        ...
        if (textView != null) {
            textView.setTextColor(e(j6.f20116q7));
        }
    }
    ...
    public final void l(int i10, int i11, int i12) {
        if (i10 >= 0) {
            ...
            if (i10 < arrayList.size()) {
                ...
                z1Var.f20751a.setTextColor(i11);
                z1Var.f20752b.setColorFilter(new PorterDuffColorFilter(i12, PorterDuff.Mode.MULTIPLY));
            }
        }
    }
    ...
    public final void o(int i10) {
        ih.s sVar = this.f19567f;
        if (sVar != null) {
            sVar.setTextColor(i10);
        }
        du duVar = this.f19575n;
        if (duVar != null) {
    ...
    public void show() {
        ...
        this.Y0 = false;
        super.show();
        FrameLayout frameLayout = this.f19580r;
        if (frameLayout != null && this.f19560a0 == 3) {
            frameLayout.setScaleX(0.0f);
            this.f19580r.setScaleY(0.0f);
            this.f19580r.animate().scaleX(1.0f).scaleY(1.0f).setInterpolator(new OvershootInterpolator(1.3f)).setDuration(190L).start();
        }
    ...
    public d2(Context context, int i10, f6 f6Var) {
        ...
        this.f19559a = -1;
        this.e = -2;
        this.f19591y = new BitmapDrawable[2];
        ...
        if (i10 != 3 || this.Q0) {
            ...
            this.f19588w0 = mutate;
            this.f19592y0 = i10 == 3 ? 0.55f : z4 ? 0.8f : 0.985f;
