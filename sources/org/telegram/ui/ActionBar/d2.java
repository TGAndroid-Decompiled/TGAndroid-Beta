...
public final class d2 implements Animation.AnimationListener {
    ...
    public final void onAnimationEnd(Animation animation) {
        switch (this.f20375a) {
            case 0:
                ((f2) this.f20376b).f20443g1.setAlpha(0.0f);
                return;
            default:
                ((v4) this.f20376b).f21442f.post(new q(this, 12));
                return;
        }
    }
    ...
    public final void onAnimationStart(Animation animation) {
        switch (this.f20375a) {
            case 0:
                return;
            default:
                v4 v4Var = (v4) this.f20376b;
                v4Var.f21444i.setEnabled(false);
                v4Var.f21443g.setVisibility(0);
