...
public final class s3 extends j1.b {
    public final Rect f19493o;
    public final w3 f19494p;

    public s3(w3 w3Var, w3 w3Var2) {
        super(w3Var2);
        this.f19494p = w3Var;
        this.f19493o = new Rect();
    }

    @Override
    public final int g(float f7, float f10) {
        w3 w3Var = this.f19494p;
        ArrayList arrayList = w3Var.R;
        if (w3Var.V >= 0.5f) {
            org.telegram.ui.Cells.z zVar = w3Var.f19638i0;
            if (zVar != null && zVar.getBounds().contains((int) f7, (int) f10)) {
                return 1;
            }
            for (int size = arrayList.size() - 1; size >= 0; size--) {
                v3 v3Var = (v3) arrayList.get(size);
                float f11 = v3Var.f19598i;
                RectF rectF = v3Var.f19593a;
                if (Math.abs(f11) < 0.4f && rectF.contains(f7, f10)) {
                    Rect bounds = v3Var.d.f19330k.getBounds();
    ...
    public final void h(ArrayList arrayList) {
        ...
        if (w3Var.V >= 0.5f) {
            ...
            for (int i10 = 0; i10 < arrayList2.size(); i10++) {
                ...
                if (Math.abs(v3Var.f19598i) < 0.4f && !v3Var.f19593a.isEmpty()) {
                    arrayList.add(Integer.valueOf(i10 + 1000));
                    k3 k3Var = v3Var.d;
                    if (k3Var != null && !k3Var.f19330k.getBounds().isEmpty()) {
        ...
        if (i11 == 16) {
            ...
            if (i12 >= 0 && i12 < arrayList.size()) {
                ...
                if (z10) {
                    ...
                    if (n3Var2 != null) {
                        n3Var2.g(v3Var.f19595c, new ai.g3(26, this, v3Var));
                        return true;
                    }
                } else if (w3Var.f19626a != null) {
                    w3Var.a(false);
                    v3Var.getClass();
                    w3Var.f19626a.e(v3Var.f19595c);
                }
                return true;
            }
        }
