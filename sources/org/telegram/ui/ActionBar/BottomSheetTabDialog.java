...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1169getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView mo1169getWindowView = sheet.mo1169getWindowView();
        this.sheetView = mo1169getWindowView;
        ...
        WindowView windowView = new WindowView(mo1169getWindowView);
