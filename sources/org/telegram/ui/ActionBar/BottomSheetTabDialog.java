...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1172getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView mo1172getWindowView = sheet.mo1172getWindowView();
        this.sheetView = mo1172getWindowView;
        ...
        WindowView windowView = new WindowView(mo1172getWindowView);
