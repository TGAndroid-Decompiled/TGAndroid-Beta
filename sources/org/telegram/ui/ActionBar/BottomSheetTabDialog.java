...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1302getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView sheetViewMo1302getWindowView = sheet.mo1302getWindowView();
        this.sheetView = sheetViewMo1302getWindowView;
        ...
        WindowView windowView = new WindowView(sheetViewMo1302getWindowView);
