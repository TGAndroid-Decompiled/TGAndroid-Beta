...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1286getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView sheetViewMo1286getWindowView = sheet.mo1286getWindowView();
        this.sheetView = sheetViewMo1286getWindowView;
        ...
        WindowView windowView = new WindowView(sheetViewMo1286getWindowView);
