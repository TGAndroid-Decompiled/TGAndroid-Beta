...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1259getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView sheetViewMo1259getWindowView = sheet.mo1259getWindowView();
        this.sheetView = sheetViewMo1259getWindowView;
        ...
        WindowView windowView = new WindowView(sheetViewMo1259getWindowView);
