...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1267getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView sheetViewMo1267getWindowView = sheet.mo1267getWindowView();
        this.sheetView = sheetViewMo1267getWindowView;
        ...
        WindowView windowView = new WindowView(sheetViewMo1267getWindowView);
