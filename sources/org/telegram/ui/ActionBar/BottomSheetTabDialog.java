...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1272getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView sheetViewMo1272getWindowView = sheet.mo1272getWindowView();
        this.sheetView = sheetViewMo1272getWindowView;
        ...
        WindowView windowView = new WindowView(sheetViewMo1272getWindowView);
