...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1196getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView mo1196getWindowView = sheet.mo1196getWindowView();
        this.sheetView = mo1196getWindowView;
        ...
        WindowView windowView = new WindowView(mo1196getWindowView);
