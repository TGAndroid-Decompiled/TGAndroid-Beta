...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1211getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView mo1211getWindowView = sheet.mo1211getWindowView();
        this.sheetView = mo1211getWindowView;
        ...
        WindowView windowView = new WindowView(mo1211getWindowView);
