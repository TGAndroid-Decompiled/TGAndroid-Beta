...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1212getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView mo1212getWindowView = sheet.mo1212getWindowView();
        this.sheetView = mo1212getWindowView;
        ...
        WindowView windowView = new WindowView(mo1212getWindowView);
