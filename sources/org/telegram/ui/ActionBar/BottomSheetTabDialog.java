...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1337getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView sheetViewMo1337getWindowView = sheet.mo1337getWindowView();
        this.sheetView = sheetViewMo1337getWindowView;
        ...
        WindowView windowView = new WindowView(sheetViewMo1337getWindowView);
