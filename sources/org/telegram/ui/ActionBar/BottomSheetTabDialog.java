...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1359getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView sheetViewMo1359getWindowView = sheet.mo1359getWindowView();
        this.sheetView = sheetViewMo1359getWindowView;
        ...
        WindowView windowView = new WindowView(sheetViewMo1359getWindowView);
