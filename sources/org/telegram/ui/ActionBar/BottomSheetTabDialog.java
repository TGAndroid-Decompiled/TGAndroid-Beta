...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1360getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView sheetViewMo1360getWindowView = sheet.mo1360getWindowView();
        this.sheetView = sheetViewMo1360getWindowView;
        ...
        WindowView windowView = new WindowView(sheetViewMo1360getWindowView);
