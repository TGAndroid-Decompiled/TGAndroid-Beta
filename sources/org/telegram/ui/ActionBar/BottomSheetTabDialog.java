...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1260getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView sheetViewMo1260getWindowView = sheet.mo1260getWindowView();
        this.sheetView = sheetViewMo1260getWindowView;
        ...
        WindowView windowView = new WindowView(sheetViewMo1260getWindowView);
