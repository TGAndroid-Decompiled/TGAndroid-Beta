...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1179getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView mo1179getWindowView = sheet.mo1179getWindowView();
        this.sheetView = mo1179getWindowView;
        ...
        WindowView windowView = new WindowView(mo1179getWindowView);
