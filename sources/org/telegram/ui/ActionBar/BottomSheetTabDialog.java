...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1301getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView sheetViewMo1301getWindowView = sheet.mo1301getWindowView();
        this.sheetView = sheetViewMo1301getWindowView;
        ...
        WindowView windowView = new WindowView(sheetViewMo1301getWindowView);
