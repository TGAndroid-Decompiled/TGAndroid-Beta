...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1330getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView sheetViewMo1330getWindowView = sheet.mo1330getWindowView();
        this.sheetView = sheetViewMo1330getWindowView;
        ...
        WindowView windowView = new WindowView(sheetViewMo1330getWindowView);
