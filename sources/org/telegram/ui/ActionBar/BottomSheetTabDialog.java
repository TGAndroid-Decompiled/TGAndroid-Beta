...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1290getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView sheetViewMo1290getWindowView = sheet.mo1290getWindowView();
        this.sheetView = sheetViewMo1290getWindowView;
        ...
        WindowView windowView = new WindowView(sheetViewMo1290getWindowView);
