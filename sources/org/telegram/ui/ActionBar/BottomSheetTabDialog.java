...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1189getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView mo1189getWindowView = sheet.mo1189getWindowView();
        this.sheetView = mo1189getWindowView;
        ...
        WindowView windowView = new WindowView(mo1189getWindowView);
