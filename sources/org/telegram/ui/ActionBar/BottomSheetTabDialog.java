...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1255getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView sheetViewMo1255getWindowView = sheet.mo1255getWindowView();
        this.sheetView = sheetViewMo1255getWindowView;
        ...
        WindowView windowView = new WindowView(sheetViewMo1255getWindowView);
