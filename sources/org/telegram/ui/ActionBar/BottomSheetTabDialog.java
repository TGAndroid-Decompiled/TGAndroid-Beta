...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1338getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView sheetViewMo1338getWindowView = sheet.mo1338getWindowView();
        this.sheetView = sheetViewMo1338getWindowView;
        ...
        WindowView windowView = new WindowView(sheetViewMo1338getWindowView);
