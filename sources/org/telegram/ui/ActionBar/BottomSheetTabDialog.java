...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1341getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView sheetViewMo1341getWindowView = sheet.mo1341getWindowView();
        this.sheetView = sheetViewMo1341getWindowView;
        ...
        WindowView windowView = new WindowView(sheetViewMo1341getWindowView);
