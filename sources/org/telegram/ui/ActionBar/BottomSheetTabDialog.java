...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1258getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView sheetViewMo1258getWindowView = sheet.mo1258getWindowView();
        this.sheetView = sheetViewMo1258getWindowView;
        ...
        WindowView windowView = new WindowView(sheetViewMo1258getWindowView);
