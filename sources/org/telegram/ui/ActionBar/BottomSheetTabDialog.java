...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1144getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView mo1144getWindowView = sheet.mo1144getWindowView();
        this.sheetView = mo1144getWindowView;
        ...
        WindowView windowView = new WindowView(mo1144getWindowView);
