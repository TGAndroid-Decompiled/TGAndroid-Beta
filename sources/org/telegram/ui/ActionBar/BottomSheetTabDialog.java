...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1335getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView sheetViewMo1335getWindowView = sheet.mo1335getWindowView();
        this.sheetView = sheetViewMo1335getWindowView;
        ...
        WindowView windowView = new WindowView(sheetViewMo1335getWindowView);
