...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1352getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView sheetViewMo1352getWindowView = sheet.mo1352getWindowView();
        this.sheetView = sheetViewMo1352getWindowView;
        ...
        WindowView windowView = new WindowView(sheetViewMo1352getWindowView);
