...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1361getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView sheetViewMo1361getWindowView = sheet.mo1361getWindowView();
        this.sheetView = sheetViewMo1361getWindowView;
        ...
        WindowView windowView = new WindowView(sheetViewMo1361getWindowView);
