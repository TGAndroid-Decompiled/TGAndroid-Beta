...
public final class z1 extends FrameLayout {
    ...
    public z1(Context context, f6 f6Var) {
        ...
        addView(imageView, w7.a6.e(-2, 40, i10 | 16));
        ...
        em.n(j6.f18034j5, f6Var, textView, 1, 16.0f);
    ...
    public final void a(int i10, CharSequence charSequence) {
        int dp;
        int i11;
        TextView textView = this.f18796a;
        textView.setText(charSequence);
        ImageView imageView = this.f18797b;
        if (i10 != 0) {
    ...
    public void setGravity(int i10) {
        this.f18796a.setGravity(i10);
    }

    public void setTextColor(int i10) {
        this.f18796a.setTextColor(i10);
    }
}
