...
public final class b4 {
    public static final int[] h = {h6.f19320ra, h6.Aa, h6.Oh, h6.Nd, h6.Od, h6.Pd, h6.Qd, h6.Rd};
    public boolean f18756a;
    public boolean f18757b;
    public fg.b f18758c;
    public TLRPC.ChatTheme d;
    public String e;
    public final ArrayList f18759f;
    ...
    public static b4 a(int i10) {
        ...
        b4Var.f18757b = true;
        a4 a4Var = new a4();
        a4Var.f18709a = e(true);
        b4Var.f18759f.add(a4Var);
        a4 a4Var2 = new a4();
        a4Var2.f18709a = e(false);
    ...
    public static b4 c(int i10) {
        ...
        a4 a4Var = new a4();
        a4Var.f18709a = h6.N0("Blue");
        a4Var.e = 99;
        b4Var.f18759f.add(a4Var);
        a4 a4Var2 = new a4();
        a4Var2.f18709a = h6.N0("Day");
        a4Var2.e = 9;
        b4Var.f18759f.add(a4Var2);
        a4 a4Var3 = new a4();
        a4Var3.f18709a = h6.N0("Night");
        a4Var3.e = 0;
        b4Var.f18759f.add(a4Var3);
        a4 a4Var4 = new a4();
        a4Var4.f18709a = h6.N0("Dark Blue");
        a4Var4.e = 0;
        b4Var.f18759f.add(a4Var4);
        return b4Var;
    }
    ...
    public static void q(g6 g6Var, int i10) {
        ...
        f6 f6Var;
        if (g6Var != null) {
            if (i10 < 0 || (sparseArray = g6Var.f18933a0) == null || ((f6Var = (f6) sparseArray.get(i10)) != null && !f6Var.f18906z)) {
    ...
    public final SparseIntArray b(int i10, int i11) {
        ...
        if (j3.f18934b != null) {
            sparseIntArray = h6.Q0(new File(j3.f18934b), null, strArr);
        } else {
            String str = j3.d;
            if (str != null) {
        ...
        ((a4) arrayList.get(i11)).f18713g = strArr[0];
        if (f6Var != null) {
            SparseIntArray clone = sparseIntArray.clone();
            f6Var.c(sparseIntArray, clone);
            fg.b bVar = this.f18758c;
            if (bVar != null && !TextUtils.isEmpty(bVar.f9049b) && (g6Var = f6Var.f18886b) != null && g6Var.f18934b == null && !g6Var.q()) {
                f6.g(clone);
            }
    ...
    public final TLRPC.Document f() {
        ...
        if (chatTheme instanceof TLRPC.TL_chatTheme) {
            return MediaDataController.getInstance(this.f18760g).getEmojiAnimatedSticker(((TLRPC.TL_chatTheme) this.d).emoticon);
        }
        return null;
    }
    ...
    public final SparseIntArray h(int i10, int i11) {
        ...
        f6 f6Var2;
        ArrayList arrayList = this.f18759f;
        SparseIntArray sparseIntArray2 = ((a4) arrayList.get(i11)).f18712f;
        ...
        ((a4) arrayList.get(i11)).f18712f = sparseIntArray4;
        while (true) {
            try {
                int[] iArr = h;
                if (i13 < iArr.length) {
    ...
    public final long i(int i10) {
        return ((a4) this.f18759f.get(i10)).a();
    }

    public final g6 j(int i10) {
        return ((a4) this.f18759f.get(i10)).f18709a;
    }

    public final TLRPC.WallPaper k(int i10) {
        a4 a4Var = (a4) this.f18759f.get(i10);
        ...
        while (true) {
            ...
            if (i12 < arrayList.size()) {
                if (arrayList.get(i12) != null) {
                    ...
                    ((a4) arrayList.get(i12)).h = g(h10, h6.f19320ra);
                    ((a4) arrayList.get(i12)).f18714i = g(h10, h6.Aa);
                    ((a4) arrayList.get(i12)).f18715j = g(h10, h6.Oh);
                    ((a4) arrayList.get(i12)).f18716k = h10.get(h6.Nd, 0);
                    ((a4) arrayList.get(i12)).f18717l = h10.get(h6.Od, 0);
                    ((a4) arrayList.get(i12)).f18718m = h10.get(h6.Pd, 0);
                    ((a4) arrayList.get(i12)).f18719n = h10.get(h6.Qd, 0);
                    ((a4) arrayList.get(i12)).f18720o = h10.get(h6.Rd, 0);
                    if (((a4) arrayList.get(i12)).f18709a != null && ((a4) arrayList.get(i12)).f18709a.m().equals("Blue")) {
                        if (((a4) arrayList.get(i12)).e >= 0) {
                            i11 = ((a4) arrayList.get(i12)).e;
                        } else {
                            i11 = ((a4) arrayList.get(i12)).f18709a.Y;
                        }
                        if (i11 == 99) {
                            ((a4) arrayList.get(i12)).f18716k = -2368069;
                            ((a4) arrayList.get(i12)).f18717l = -9722489;
                            ((a4) arrayList.get(i12)).f18718m = -2762611;
                            ((a4) arrayList.get(i12)).f18719n = -7817084;
                        }
                    }
                }
                i12++;
    ...
    public final void p(int i10, ResultCallback resultCallback) {
        ...
        if (k10 == null) {
            ...
            if (i11 == 0) {
                ...
                Bitmap wallpaperThumbBitmap = ChatThemeController.getInstance(this.f18760g).getWallpaperThumbBitmap(i11);
    ...
    public b4(int i10, TLRPC.TL_theme tL_theme) {
        ...
        this.f18759f = arrayList;
        this.f18760g = i10;
        this.f18756a = false;
        String str = tL_theme.emoticon;
        this.e = str;
        this.f18758c = new fg.b(str, null);
    ...
    public b4(int i10, TLRPC.TL_chatThemeUniqueGift tL_chatThemeUniqueGift) {
        ...
        this.f18758c = fg.b.c(tL_chatThemeUniqueGift);
        this.d = tL_chatThemeUniqueGift;
        a4 a4Var = new a4();
        a4Var.f18711c = tL_chatThemeUniqueGift;
        a4Var.d = 0;
        arrayList.add(a4Var);
        a4 a4Var2 = new a4();
        a4Var2.f18711c = tL_chatThemeUniqueGift;
        a4Var2.d = 1;
        arrayList.add(a4Var2);
    }
}
