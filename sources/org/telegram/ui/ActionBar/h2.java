...
public final class h2 extends Drawable {
    ...
    public final void c(float f7, boolean z10) {
        ...
        if (z10) {
            if (f10 < f7) {
                this.f18709f = (int) (f10 * this.f18713k);
            } else {
                this.f18709f = (int) ((1.0f - f10) * this.f18713k);
            }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.e != this.d) {
            if (this.f18708c != 0) {
                int currentTimeMillis = this.f18709f + ((int) (System.currentTimeMillis() - this.f18708c));
                this.f18709f = currentTimeMillis;
        ...
        int d = i0.a.d(this.e, this.f18711i, this.f18712j);
        Paint paint = this.f18706a;
        paint.setColor(d);
        canvas.save();
    ...
    public final void setAlpha(int i10) {
        this.f18706a.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f18706a.setColorFilter(colorFilter);
    }
}
