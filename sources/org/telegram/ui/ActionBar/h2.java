...
public final class h2 extends e3 {
    public final k2 f18942b;
    public final b5[] f18943c;
    public final m2 d;
    public final e3[] e;
    ...
    public final boolean canSwipeToBack(MotionEvent motionEvent) {
        b5[] b5VarArr;
        b5 b5Var;
        k2 k2Var = this.f18942b;
        if (k2Var == null || !k2Var.f19567a || (b5Var = (b5VarArr = this.f18943c)[0]) == null || b5Var.getFragmentStack().size() > 1 || (b5VarArr[0].getFragmentStack().size() == 1 && !((m2) b5VarArr[0].getFragmentStack().get(0)).isSwipeBackEnabled(motionEvent))) {
            return false;
        }
        return true;
    }
    ...
    public final void dismiss() {
        k2 k2Var;
        Runnable runnable;
        if (!isDismissed() && (k2Var = this.f18942b) != null && (runnable = k2Var.d) != null) {
            runnable.run();
        }
        super.dismiss();
        ArrayList arrayList = LaunchActivity.G1.P;
        b5[] b5VarArr = this.f18943c;
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (k2Var != null && k2Var.e) {
            ...
            fixNavigationBar(h6.v0(h6.f19133i5, m2Var.getResourceProvider()));
        }
    ...
    public final void onOpenAnimationEnd() {
        ...
        k2 k2Var = this.f18942b;
        if (k2Var != null && (runnable = k2Var.f19569c) != null) {
            runnable.run();
        }
    }
}
