...
public final class h2 extends Drawable {
    ...
    public final void c(float f7, boolean z10) {
        ...
        if (z10) {
            if (f10 < f7) {
                this.f18708f = (int) (f10 * this.f18712k);
            } else {
                this.f18708f = (int) ((1.0f - f10) * this.f18712k);
            }
            this.f18707c = System.currentTimeMillis();
            this.d = f7;
        } else {
            this.e = f7;
            this.d = f7;
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.e != this.d) {
            if (this.f18707c != 0) {
                int currentTimeMillis = this.f18708f + ((int) (System.currentTimeMillis() - this.f18707c));
                this.f18708f = currentTimeMillis;
                float f7 = currentTimeMillis;
                float f10 = this.f18712k;
                if (f7 >= f10) {
                    this.e = this.d;
                } else {
                    float f11 = this.e;
        ...
        int d = i0.a.d(this.e, this.f18710i, this.f18711j);
        Paint paint = this.f18705a;
        paint.setColor(d);
        canvas.save();
    ...
    public final void setAlpha(int i10) {
        this.f18705a.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f18705a.setColorFilter(colorFilter);
    }
}
