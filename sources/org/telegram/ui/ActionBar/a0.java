...
public class a0 extends LinearLayout {
        ...
        if (charSequence != null) {
            ...
            if (drawable != null) {
                if (drawable instanceof yi0) {
                    w0Var.f19632x.setAnimation((yi0) drawable);
                } else {
                    w0Var.f19632x.setImageDrawable(drawable);
                }
            } else if (i12 != 0) {
                w0Var.f19632x.setImageResource(i12);
            }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        Runnable runnable = this.f18454f;
        if (runnable != null) {
            runnable.run();
        }
        k kVar = this.f18452b;
            ...
            if (childAt instanceof w0) {
                ...
                if (w0Var.G) {
                    ...
                    if (w0Var.F.getTag() != null) {
                        w0Var.f19615h0 = arrayList.size() - 1;
                    }
                    w0Var.y();
                    return;
                }
