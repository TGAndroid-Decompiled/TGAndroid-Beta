...
public class z extends LinearLayout {
    ...
    public final k f20748b;
    public boolean f20749c;
    public boolean d;
    public ArrayList e;
    public Runnable f20750f;
        ...
        if (charSequence != null) {
            ...
            if (drawable != null) {
                if (drawable instanceof gj0) {
                    w0Var.f20647x.setAnimation((gj0) drawable);
                } else {
                    w0Var.f20647x.setImageDrawable(drawable);
                }
            } else if (i12 != 0) {
                w0Var.f20647x.setImageResource(i12);
            }
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        Runnable runnable = this.f20750f;
        if (runnable != null) {
            runnable.run();
        }
        k kVar = this.f20748b;
            ...
            if (childAt instanceof w0) {
                ...
                if (w0Var.D) {
                    ...
                    if (w0Var.C.getTag() != null) {
                        w0Var.f20629e0 = arrayList.size() - 1;
                    }
                    w0Var.y();
                    return;
                }
