...
public final class a3 extends FrameLayout {
    public final org.telegram.ui.Components.t5 f21177a;
    ...
    public a3(Context context, int i10, g6 g6Var) {
        ...
        this.f21179c = imageView2;
        imageView2.setScaleType(scaleType);
        imageView2.setColorFilter(new PorterDuffColorFilter(k6.v0(k6.f21735h7, g6Var), PorterDuff.Mode.SRC_IN));
        if (LocaleController.isRTL) {
            i12 = 3;
        } else {
            i12 = 5;
        ...
        if (i10 != 0 && i10 != 4) {
            if (i10 == 1) {
                t5Var.setGravity(17);
                t5Var.setTextColor(k6.v0(k6.f21768j5, g6Var));
    ...
    public final void a(CharSequence charSequence, int i10, Drawable drawable, boolean z4) {
        ...
        int i11;
        float f12;
        org.telegram.ui.Components.t5 t5Var = this.f21177a;
        t5Var.setText(charSequence);
        float f13 = 16.0f;
        float f14 = 21.0f;
        ImageView imageView = this.f21178b;
    ...
    public void setChecked(boolean z4) {
        ...
        this.f21179c.setImageResource(i10);
    }

    public void setGravity(int i10) {
        this.f21177a.setGravity(i10);
    }

    public void setIconColor(int i10) {
        this.f21178b.setColorFilter(new PorterDuffColorFilter(i10, PorterDuff.Mode.MULTIPLY));
    }

    public void setTextColor(int i10) {
        this.f21177a.setTextColor(i10);
    }
}
