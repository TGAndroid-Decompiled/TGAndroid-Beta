...
public final class t3 extends j1.b {
    public final Rect f22289o;
    public final x3 f22290p;

    public t3(x3 x3Var, x3 x3Var2) {
        super(x3Var2);
        this.f22290p = x3Var;
        this.f22289o = new Rect();
    }

    @Override
    public final int g(float f10, float f11) {
        x3 x3Var = this.f22290p;
        ArrayList arrayList = x3Var.O;
        if (x3Var.S >= 0.5f) {
            org.telegram.ui.Cells.z zVar = x3Var.f22415f0;
            if (zVar != null && zVar.getBounds().contains((int) f10, (int) f11)) {
                return 1;
            }
            for (int size = arrayList.size() - 1; size >= 0; size--) {
                w3 w3Var = (w3) arrayList.get(size);
                float f12 = w3Var.f22380i;
                RectF rectF = w3Var.f22374a;
                if (Math.abs(f12) < 0.4f && rectF.contains(f10, f11)) {
                    Rect bounds = w3Var.d.f22073k.getBounds();
    ...
    public final void h(ArrayList arrayList) {
        ...
        if (x3Var.S >= 0.5f) {
            ...
            for (int i10 = 0; i10 < arrayList2.size(); i10++) {
                ...
                if (Math.abs(w3Var.f22380i) < 0.4f && !w3Var.f22374a.isEmpty()) {
                    arrayList.add(Integer.valueOf(i10 + 1000));
                    l3 l3Var = w3Var.d;
                    if (l3Var != null && !l3Var.f22073k.getBounds().isEmpty()) {
        ...
        if (i11 == 16) {
            ...
            if (i12 >= 0 && i12 < arrayList.size()) {
                ...
                if (z4) {
                    ...
                    if (o3Var2 != null) {
                        o3Var2.g(w3Var.f22376c, new lh.a1(12, this, w3Var));
                        return true;
                    }
                } else if (x3Var.f22405a != null) {
                    x3Var.a(false);
                    w3Var.getClass();
                    x3Var.f22405a.e(w3Var.f22376c);
                }
                return true;
            }
        }
