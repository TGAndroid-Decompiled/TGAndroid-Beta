    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f20508a) {
            ...
            case 1:
                ...
                return;
            case 2:
                this.f20509b.onContainerViewTranslation();
                return;
            case 3:
                this.f20509b.onContainerViewTranslation();
                return;
            case 4:
                ...
                return;
            case 5:
                g3.j(this.f20509b, valueAnimator);
                return;
            case 6:
                this.f20509b.onContainerViewTranslation();
                return;
            default:
                g3.i(this.f20509b, valueAnimator);
                return;
        }
    }
}
