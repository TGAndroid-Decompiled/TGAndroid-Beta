...
public class BottomSheetTabsOverlay extends View {
    ...
    public static void lambda$dismissSheet$3(Sheet sheet) {
        if (sheet == null || sheet.mo1339getWindowView() == null) {
            return;
        }
        sheet.mo1339getWindowView().setDrawingFromOverlay(true);
    }
    ...
    class AnonymousClass2 extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            this.val$sheet.mo1339getWindowView().setDrawingFromOverlay(false);
        ...
        public static void lambda$onAnimationEnd$0(BottomSheetTabs.WebTabData webTabData, Sheet sheet, Bitmap bitmap) {
            ...
            sheet.mo1339getWindowView().setDrawingFromOverlay(false);
            sheet.release();
        }
    }
    ...
    private void drawDismissingTab(Canvas canvas) {
        if (this.dismissingSheet != null) {
            ...
            SheetView sheetViewMo1339getWindowView = this.dismissingSheet.mo1339getWindowView();
            RectF rectF2 = this.rect;
            float f = this.dismissProgress;
            float fDrawInto = sheetViewMo1339getWindowView.drawInto(canvas, rectF2, f, this.clipRect, f, false);
