...
public class BottomSheetTabsOverlay extends FrameLayout {
    ...
    public class AnonymousClass2 extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            int i;
            int i2;
            this.val$sheet.mo981getWindowView().setDrawingFromOverlay(false);
    ...
    private void drawDismissingTab(Canvas canvas) {
        if (this.dismissingSheet != null) {
            ...
            SheetView mo981getWindowView = this.dismissingSheet.mo981getWindowView();
            RectF rectF2 = this.rect;
            float f = this.dismissProgress;
            float drawInto = mo981getWindowView.drawInto(canvas, rectF2, f, this.clipRect, f, false);
    ...
    public boolean dismissSheet(Sheet sheet) {
        ...
        sheet.mo981getWindowView().setDrawingFromOverlay(true);
        invalidate();
