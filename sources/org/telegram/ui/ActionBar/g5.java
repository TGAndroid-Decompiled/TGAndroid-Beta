...
public class g5 extends Drawable {
    ...
    public boolean v;
    public final Paint f19691c = new Paint(1);
    public final RectF f19695j = new RectF();
    public final Matrix f19696k = new Matrix();
    public final Rect f19700o = new Rect();
    public final int[] f19707w = {-1, -1, -1, -1};
    public final Bitmap[] f19708x = new Bitmap[4];
    public final Drawable[] f19709y = new Drawable[4];
    public final int[] f19710z = {-1, -1, -1, -1};
    ...
    public final Path f19699n = new Path();
    ...
    public final void a() {
        Bitmap bitmap;
        if (this.f19689a instanceof BitmapShader) {
            boolean z4 = this.J;
            Matrix matrix = this.f19696k;
            ec0[] ec0VarArr = Q;
            char c3 = 0;
            ...
            if (z4 && (bitmap = this.L) != null) {
                ...
                float min = 1.0f / Math.min(bitmap.getWidth() / ec0VarArr[c3].getBounds().width(), this.L.getHeight() / ec0VarArr[c3].getBounds().height());
            ...
            Bitmap bitmap2 = ec0VarArr[c10].f24580k;
            float min2 = 1.0f / Math.min(bitmap2.getWidth() / ec0VarArr[c10].getBounds().width(), bitmap2.getHeight() / ec0VarArr[c10].getBounds().height());
    ...
    public final void c(Canvas canvas, Paint paint) {
        ...
        if (paint == null && this.f19689a == null && this.O == 0 && this.P <= 0.0f && (f10 = f()) != null) {
        ...
        if (paint == null && this.f19689a != null) {
            Matrix matrix = this.f19696k;
            matrix.reset();
            a();
            matrix.postTranslate(0.0f, -this.f19703r);
            this.f19689a.setLocalMatrix(matrix);
        }
        ...
        if (g5Var.f19689a != null && g5Var.f19698m && paint == null) {
            int g10 = g(j6.f19851bc);
    ...
    public final void e(Path path, Rect rect, int i10, int i11, int i12, int i13, int i14, boolean z4, boolean z10, boolean z11) {
        ...
        boolean z12 = this.f19702q;
        int i20 = this.f19697l;
        RectF rectF = this.f19695j;
        if (z12) {
            if (!this.G && i20 != 2 && !z11 && !z4) {
                path.moveTo(rect.right - b(8.0f), (i14 - this.f19703r) + this.f19690b);
                path.lineTo(rect.left + i10, (i14 - this.f19703r) + this.f19690b);
            } else {
                if (this.f19706u) {
                    i17 = i13;
                } else {
            ...
            if (!this.G && i20 != 2 && !z11 && !z10) {
                path.lineTo(rect.left + i10, (i14 - this.f19703r) - b(2.0f));
                if (i20 == 1) {
                    path.lineTo(rect.right - i10, (i14 - this.f19703r) - b(2.0f));
                } else {
                    path.lineTo(rect.right - b(8.0f), (i14 - this.f19703r) - b(2.0f));
                }
            } else {
            ...
            if (i20 == 1) {
                if (!z11 && !z4) {
                    path.lineTo(rect.right - i10, (i14 - this.f19703r) + this.f19690b);
                } else {
                    if (this.f19705t) {
                        i19 = i13;
                    }
                ...
                path.lineTo(rect.right - b(8.0f), (i14 - this.f19703r) + this.f19690b);
            } else {
            ...
            if (!this.G && i20 != 2 && !z11 && !z4) {
                path.moveTo(b(8.0f) + rect.left, (i14 - this.f19703r) + this.f19690b);
                path.lineTo(rect.right - i10, (i14 - this.f19703r) + this.f19690b);
            } else {
                if (this.f19706u) {
                    i15 = i13;
            ...
            if (!this.G && i20 != 2 && !z11 && !z10) {
                ...
                if (i20 == 1) {
                    ...
                    path.lineTo(b(8.0f) + rect.left, (i14 - this.f19703r) - b(2.0f));
                }
            } else {
            ...
            if (i20 == 1) {
                ...
                path.lineTo(b(8.0f) + rect.left, (i14 - this.f19703r) + this.f19690b);
            } else {
    ...
    public final Drawable f() {
        ...
        boolean z10 = this.f19704s;
        char c10 = 3;
        if (z10 && this.f19705t) {
            c3 = 3;
        } else if (z10) {
            c3 = 2;
        } else if (this.f19705t) {
            c3 = 1;
        } else {
            c3 = 0;
        }
        boolean z11 = this.f19698m;
        if (!z11 || !this.f19706u) {
            if (z11) {
                c10 = 1;
            } else if (this.f19706u) {
                c10 = 2;
            } else {
                c10 = 0;
            }
        ...
        if (this.f19689a == null && !z11 && !this.J) {
            z4 = true;
        } else {
            z4 = false;
        }
    ...
    public final void finalize() {
        ...
        Arrays.fill(this.f19709y, (Object) null);
        Arrays.fill(this.f19707w, -1);
    }
    ...
    public final Drawable j() {
        ...
        int i10;
        int i11;
        if (this.J || (this.f19689a == null && !this.f19698m && this.H == null)) {
            return null;
        }
        int b10 = b(SharedConfig.bubbleRadius);
        boolean z4 = this.f19704s;
        boolean z10 = false;
        if (z4 && this.f19705t) {
            c3 = 3;
        } else if (z4) {
        ...
        int[] iArr = this.f19707w;
        int i12 = iArr[c3];
        Drawable[] drawableArr = this.f19709y;
        if (i12 != b10) {
            iArr[c3] = b10;
            Bitmap[] bitmapArr = this.f19708x;
    ...
    public final Path m() {
        ...
        int max = Math.max(bounds.top, 0);
        boolean z12 = true;
        if (f3Var != null && bounds.height() < this.f19690b) {
            z4 = true;
            z10 = true;
        } else {
            if (i12 != 1 ? (this.f19703r + bounds.bottom) - i11 < this.f19690b : (this.f19703r + bounds.bottom) - (b12 * 2) < this.f19690b) {
                z4 = true;
            } else {
                z4 = false;
            }
            if ((i11 * 2) + this.f19703r >= 0) {
                z11 = true;
            }
            z10 = z11;
        }
    ...
    public final void setAlpha(int i10) {
        int i11 = this.F;
        Paint paint = this.f19691c;
        if (i11 != i10 || paint.getAlpha() != i10) {
            this.F = i10;
            paint.setAlpha(i10);
            if (this.f19702q) {
                this.d.setAlpha((int) ((i10 / 255.0f) * Color.alpha(g(j6.f19851bc))));
            }
        }
