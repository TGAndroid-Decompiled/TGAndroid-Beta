...
public abstract class g5 implements z2 {
    public static final double[] f20467a = {0.819022437996703d, 0.3619062600528904d, -0.1288737815209879d, 0.0329836539323885d, 0.9292868615863434d, 0.0361446663506424d, 0.0481771893596242d, 0.2642395317527308d, 0.6335478284694309d};
    public static final double[] f20468b = {0.210454268309314d, 0.7936177747023054d, -0.0040720430116193d, 1.9779985324311684d, -2.42859224204858d, 0.450593709617411d, 0.0259040424655478d, 0.7827717124575296d, -0.8086757549230774d};
    public static final double[] f20469c = {0.41239079926595934d, 0.357584339383878d, 0.1804807884018343d, 0.21263900587151027d, 0.715168678767756d, 0.07219231536073371d, 0.01933081871559182d, 0.11919477979462598d, 0.9505321522496607d};
    public static SparseArray d;
    public static HashMap f20470e;

    public static SparseArray d() {
        SparseArray sparseArray = new SparseArray();
        sparseArray.put(j6.f20717g5, "wallpaperFileOffset");
        sparseArray.put(j6.f20734h5, "dialogBackground");
        sparseArray.put(j6.f20752i5, "dialogBackgroundGray");
        sparseArray.put(j6.f20770j5, "dialogTextBlack");
        sparseArray.put(j6.f20790k5, "dialogTextLink");
        sparseArray.put(j6.f20808l5, "dialogLinkSelection");
        sparseArray.put(j6.f20826m5, "dialogTextBlue");
        sparseArray.put(j6.f20845n5, "dialogTextBlue2");
        sparseArray.put(j6.f20861o5, "dialogTextBlue4");
        sparseArray.put(j6.p5, "dialogTextGray");
        sparseArray.put(j6.f20897q5, "dialogTextGray2");
        sparseArray.put(j6.f20915r5, "dialogTextGray3");
        sparseArray.put(j6.f20934s5, "dialogTextGray4");
        sparseArray.put(j6.f20953t5, "dialogTextHint");
        sparseArray.put(j6.f20971u5, "dialogInputField");
        sparseArray.put(j6.f20989v5, "dialogInputFieldActivated");
        sparseArray.put(j6.f21007w5, "dialogCheckboxSquareBackground");
        sparseArray.put(j6.f21024x5, "dialogCheckboxSquareCheck");
        sparseArray.put(j6.f21041y5, "dialogCheckboxSquareUnchecked");
        sparseArray.put(j6.f21060z5, "dialogCheckboxSquareDisabled");
        ...
        sparseArray.put(j6.f20663d6, "windowBackgroundWhite");
        sparseArray.put(j6.f20683e6, "windowBackgroundUnchecked");
        sparseArray.put(j6.f20700f6, "windowBackgroundChecked");
        sparseArray.put(j6.f20718g6, "windowBackgroundCheckText");
        sparseArray.put(j6.f20735h6, "progressCircle");
        sparseArray.put(j6.f20753i6, "listSelectorSDK21");
        sparseArray.put(j6.f20791k6, "windowBackgroundWhiteInputField");
        sparseArray.put(j6.f20809l6, "windowBackgroundWhiteInputFieldActivated");
        sparseArray.put(j6.f20863o7, "pollCreateIcons");
        sparseArray.put(j6.f20827m6, "windowBackgroundWhiteGrayIcon");
        sparseArray.put(j6.f20846n6, "windowBackgroundWhiteBlueText");
        sparseArray.put(j6.f20862o6, "windowBackgroundWhiteBlueText2");
        sparseArray.put(j6.f20879p6, "windowBackgroundWhiteBlueText3");
        sparseArray.put(j6.q6, "windowBackgroundWhiteBlueText4");
        sparseArray.put(j6.f20916r6, "windowBackgroundWhiteBlueText5");
        sparseArray.put(j6.f20935s6, "windowBackgroundWhiteBlueText6");
        sparseArray.put(j6.f20954t6, "windowBackgroundWhiteBlueText7");
        sparseArray.put(j6.f20972u6, "windowBackgroundWhiteBlueButton");
        sparseArray.put(j6.f20990v6, "windowBackgroundWhiteBlueIcon");
        sparseArray.put(j6.f21008w6, "windowBackgroundWhiteGreenText");
        sparseArray.put(j6.f21025x6, "windowBackgroundWhiteGreenText2");
        sparseArray.put(j6.f21042y6, "windowBackgroundWhiteGrayText");
        sparseArray.put(j6.f21061z6, "windowBackgroundWhiteGrayText2");
        ...
        sparseArray.put(j6.f20607a7, "windowBackgroundGray");
        sparseArray.put(j6.f20627b7, "windowBackgroundGrayShadow");
        sparseArray.put(j6.f20646c7, "emptyListPlaceholder");
        sparseArray.put(j6.f20664d7, "divider");
        sparseArray.put(j6.e7, "graySection");
        sparseArray.put(j6.f7, "key_graySectionText");
        sparseArray.put(j6.f20719g7, "radioBackground");
        sparseArray.put(j6.f20736h7, "radioBackgroundChecked");
        sparseArray.put(j6.f20754i7, "checkbox");
        sparseArray.put(j6.f20772j7, "checkboxDisabled");
        sparseArray.put(j6.f20792k7, "checkboxCheck");
        sparseArray.put(j6.f20810l7, "fastScrollActive");
        sparseArray.put(j6.f20828m7, "fastScrollInactive");
        sparseArray.put(j6.f20847n7, "fastScrollText");
        sparseArray.put(j6.f20880p7, "text_RedRegular");
        sparseArray.put(j6.f20898q7, "text_RedBold");
        sparseArray.put(j6.f20917r7, "fill_RedNormal");
        sparseArray.put(j6.f20936s7, "fill_RedDark");
        sparseArray.put(j6.f20955t7, "inappPlayerPerformer");
        sparseArray.put(j6.f20973u7, "inappPlayerTitle");
        sparseArray.put(j6.f20991v7, "inappPlayerBackground");
        sparseArray.put(j6.f21009w7, "inappPlayerPlayPause");
        sparseArray.put(j6.f21026x7, "inappPlayerClose");
        sparseArray.put(j6.f21043y7, "returnToCallBackground");
        sparseArray.put(j6.f21062z7, "returnToCallMutedBackground");
        ...
        sparseArray.put(j6.f20608a8, "avatar_background2Blue");
        sparseArray.put(j6.f20628b8, "avatar_background2Pink");
        sparseArray.put(j6.f20665d8, "avatar_backgroundInProfileBlue");
        sparseArray.put(j6.f20684e8, "avatar_backgroundActionBarBlue");
        sparseArray.put(j6.f20701f8, "avatar_actionBarSelectorBlue");
        sparseArray.put(j6.f20720g8, "avatar_actionBarIconBlue");
        sparseArray.put(j6.f20737h8, "avatar_subtitleInProfileBlue");
        sparseArray.put(j6.f20755i8, "avatar_nameInMessageRed");
        sparseArray.put(j6.f20773j8, "avatar_nameInMessageOrange");
        sparseArray.put(j6.f20793k8, "avatar_nameInMessageViolet");
        sparseArray.put(j6.f20811l8, "avatar_nameInMessageGreen");
        sparseArray.put(j6.f20829m8, "avatar_nameInMessageCyan");
        sparseArray.put(j6.f20848n8, "avatar_nameInMessageBlue");
        sparseArray.put(j6.f20864o8, "avatar_nameInMessagePink");
        sparseArray.put(j6.f20937s8, "actionBarDefault");
        sparseArray.put(j6.f20956t8, "actionBarDefaultSelector");
        sparseArray.put(j6.f20974u8, "actionBarWhiteSelector");
        sparseArray.put(j6.f20992v8, "actionBarDefaultIcon");
        sparseArray.put(j6.f21010w8, "actionBarActionModeDefault");
        sparseArray.put(j6.f21027x8, "actionBarActionModeDefaultTop");
        sparseArray.put(j6.f21044y8, "actionBarActionModeDefaultIcon");
        sparseArray.put(j6.f21063z8, "actionBarActionModeDefaultSelector");
        sparseArray.put(j6.f20976ua, "actionBarActionModeReaction");
        sparseArray.put(j6.f20993va, "actionBarActionModeReactionText");
        sparseArray.put(j6.f21012wa, "actionBarActionModeReactionDot");
        ...
        sparseArray.put(j6.f20890ph, "table_background");
        sparseArray.put(j6.f20908qh, "table_border");
        ...
        sparseArray.put(j6.f20609a9, "chats_secretIcon");
        sparseArray.put(j6.f20629b9, "chats_pinnedIcon");
        sparseArray.put(j6.f20648c9, "chats_archiveBackground");
        sparseArray.put(j6.f20666d9, "chats_archivePinBackground");
        sparseArray.put(j6.f20685e9, "chats_archiveIcon");
        sparseArray.put(j6.f20702f9, "chats_archiveText");
        sparseArray.put(j6.f20721g9, "chats_message");
        sparseArray.put(j6.f20738h9, "chats_messageArchived");
        sparseArray.put(j6.f20756i9, "chats_message_threeLines");
        sparseArray.put(j6.f20774j9, "chats_draft");
        sparseArray.put(j6.f20794k9, "chats_nameMessage");
        sparseArray.put(j6.f20812l9, "chats_nameMessageArchived");
        sparseArray.put(j6.f20830m9, "chats_nameMessage_threeLines");
        sparseArray.put(j6.f20849n9, "chats_nameMessageArchived_threeLines");
        sparseArray.put(j6.o9, "chats_attachMessage");
        sparseArray.put(j6.f20882p9, "chats_actionMessage");
        sparseArray.put(j6.f20900q9, "chats_date");
        sparseArray.put(j6.f20919r9, "chats_date_bold");
        sparseArray.put(j6.f20938s9, "chats_pinnedOverlay");
        sparseArray.put(j6.f20957t9, "chats_tabletSelectedOverlay");
        sparseArray.put(j6.f20975u9, "chats_sentCheck");
        sparseArray.put(j6.v9, "chats_sentReadCheck");
        sparseArray.put(j6.f21011w9, "chats_sentClock");
        sparseArray.put(j6.f21028x9, "chats_sentError");
        sparseArray.put(j6.f21045y9, "chats_sentErrorIcon");
        sparseArray.put(j6.f21064z9, "chats_verifiedBackground");
        ...
        sparseArray.put(j6.f20610aa, "chat_attachPermissionImage");
        sparseArray.put(j6.f20630ba, "chat_attachPermissionMark");
        sparseArray.put(j6.f20649ca, "chat_attachPermissionText");
        sparseArray.put(j6.f20667da, "chat_attachEmptyImage");
        sparseArray.put(j6.f20686ea, "chat_inPollCorrectAnswer");
        sparseArray.put(j6.f20703fa, "chat_outPollCorrectAnswer");
        sparseArray.put(j6.ga, "chat_inPollWrongAnswer");
        sparseArray.put(j6.ha, "chat_outPollWrongAnswer");
        sparseArray.put(j6.f20757ia, "chat_attachIcon");
        sparseArray.put(j6.f20775ja, "chat_attachGalleryBackground");
        sparseArray.put(j6.f20795ka, "chat_attachAudioBackground");
        sparseArray.put(j6.f20813la, "chat_attachContactBackground");
        sparseArray.put(j6.f20831ma, "chat_attachContactText");
        sparseArray.put(j6.f20850na, "chat_attachLocationBackground");
        sparseArray.put(j6.f20865oa, "chat_attachPollBackground");
        sparseArray.put(j6.f20883pa, "chat_status");
        sparseArray.put(j6.f20901qa, "chat_inDownCall");
        sparseArray.put(j6.Ia, "chat_outUpCall");
        sparseArray.put(j6.f20920ra, "chat_inBubble");
        sparseArray.put(j6.f20669dc, "chat_inBubbleSelected");
        sparseArray.put(j6.f20939sa, "chat_inBubbleSelectedOverlay");
        ...
        sparseArray.put(j6.f20612ac, "chat_outBubbleGradientAnimated");
        sparseArray.put(j6.f20632bc, "chat_outBubbleGradientSelectedOverlay");
        ...
        sparseArray.put(j6.f20705fc, "chat_messageTextOut");
        sparseArray.put(j6.gc, "chat_messageLinkIn");
        sparseArray.put(j6.f20740hc, "chat_messageLinkOut");
        sparseArray.put(j6.f20759ic, "chat_serviceText");
        sparseArray.put(j6.f20777jc, "chat_serviceLink");
        sparseArray.put(j6.f20797kc, "chat_serviceIcon");
        sparseArray.put(j6.f20815lc, "chat_serviceBackground");
        sparseArray.put(j6.f20833mc, "chat_serviceBackgroundSelected");
        ...
        sparseArray.put(j6.f20867oc, "chat_muteIcon");
        sparseArray.put(j6.f20885pc, "chat_lockIcon");
        ...
        sparseArray.put(j6.f20903qc, "chat_inSentClock");
        sparseArray.put(j6.f20922rc, "chat_inSentClockSelected");
        sparseArray.put(j6.f20941sc, "chat_mediaSentCheck");
        sparseArray.put(j6.f20959tc, "chat_mediaSentClock");
        sparseArray.put(j6.f20978uc, "chat_inMediaIcon");
        sparseArray.put(j6.Pa, "chat_outMediaIcon");
        sparseArray.put(j6.f20995vc, "chat_inMediaIconSelected");
        ...
        sparseArray.put(j6.f21048yc, "chat_inViewsSelected");
        sparseArray.put(j6.f21067zc, "chat_mediaViews");
        ...
        sparseArray.put(j6.f20611ab, "chat_outReplyLine");
        sparseArray.put(j6.f20631bb, "chat_outReplyLine2");
        ...
        sparseArray.put(j6.f20668db, "chat_outReplyMessageText");
        sparseArray.put(j6.Zc, "chat_inReplyMediaMessageText");
        sparseArray.put(j6.f20687eb, "chat_outReplyMediaMessageText");
        sparseArray.put(j6.f20613ad, "chat_inReplyMediaMessageSelectedText");
        sparseArray.put(j6.f20704fb, "chat_outReplyMediaMessageSelectedText");
        sparseArray.put(j6.bd, "chat_stickerReplyMessageText");
        sparseArray.put(j6.f20651cd, "chat_inPreviewLine");
        sparseArray.put(j6.f20722gb, "chat_outPreviewLine");
        sparseArray.put(j6.f20670dd, "chat_inSiteNameText");
        sparseArray.put(j6.f20739hb, "chat_outSiteNameText");
        sparseArray.put(j6.f20688ed, "chat_inContactNameText");
        sparseArray.put(j6.f20758ib, "chat_outContactNameText");
        sparseArray.put(j6.f20706fd, "chat_inContactPhoneText");
        sparseArray.put(j6.f20723gd, "chat_inContactPhoneSelectedText");
        sparseArray.put(j6.f20776jb, "chat_outContactPhoneText");
        sparseArray.put(j6.f20796kb, "chat_outContactPhoneSelectedText");
        sparseArray.put(j6.f20741hd, "chat_mediaProgress");
        sparseArray.put(j6.f20760id, "chat_inAudioProgress");
        sparseArray.put(j6.f20902qb, "chat_outAudioProgress");
        sparseArray.put(j6.f20778jd, "chat_inAudioSelectedProgress");
        sparseArray.put(j6.f20921rb, "chat_outAudioSelectedProgress");
        sparseArray.put(j6.f20798kd, "chat_mediaTimeText");
        sparseArray.put(j6.f20816ld, "chat_adminText");
        sparseArray.put(j6.f20834md, "chat_adminSelectedText");
        sparseArray.put(j6.f20866ob, "chat_outAdminText");
        sparseArray.put(j6.f20884pb, "chat_outAdminSelectedText");
        sparseArray.put(j6.f20851nd, "chat_inTimeText");
        sparseArray.put(j6.f20940sb, "chat_outTimeText");
        sparseArray.put(j6.f20868od, "chat_inTimeSelectedText");
        sparseArray.put(j6.nb, "chat_outTimeSelectedText");
        sparseArray.put(j6.f20886pd, "chat_inAudioPerfomerText");
        sparseArray.put(j6.f20904qd, "chat_inAudioPerfomerSelectedText");
        sparseArray.put(j6.f20814lb, "chat_outAudioPerfomerText");
        sparseArray.put(j6.f20832mb, "chat_outAudioPerfomerSelectedText");
        sparseArray.put(j6.f20923rd, "chat_inAudioTitleText");
        sparseArray.put(j6.f20958tb, "chat_outAudioTitleText");
        sparseArray.put(j6.f20942sd, "chat_inAudioDurationText");
        sparseArray.put(j6.f20977ub, "chat_outAudioDurationText");
        sparseArray.put(j6.f20960td, "chat_inAudioDurationSelectedText");
        sparseArray.put(j6.f20994vb, "chat_outAudioDurationSelectedText");
        sparseArray.put(j6.f20979ud, "chat_inAudioSeekbar");
        sparseArray.put(j6.f20996vd, "chat_inAudioCacheSeekbar");
        sparseArray.put(j6.f21013wb, "chat_outAudioSeekbar");
        sparseArray.put(j6.f21030xb, "chat_outAudioCacheSeekbar");
        sparseArray.put(j6.f21014wd, "chat_inAudioSeekbarSelected");
        sparseArray.put(j6.f21047yb, "chat_outAudioSeekbarSelected");
        sparseArray.put(j6.f21031xd, "chat_inAudioSeekbarFill");
        sparseArray.put(j6.f21066zb, "chat_outAudioSeekbarFill");
        sparseArray.put(j6.f21049yd, "chat_inVoiceSeekbar");
        sparseArray.put(j6.Ab, "chat_outVoiceSeekbar");
        sparseArray.put(j6.f21068zd, "chat_inVoiceSeekbarSelected");
        ...
        sparseArray.put(j6.f20614ae, "key_chat_messagePanelVoiceLockBackground");
        sparseArray.put(j6.f20633be, "key_chat_messagePanelVoiceLockShadow");
        sparseArray.put(j6.f20652ce, "chat_topPanelBackground");
        sparseArray.put(j6.f20671de, "chat_topPanelClose");
        sparseArray.put(j6.f20689ee, "chat_topPanelLine");
        sparseArray.put(j6.fe, "chat_topPanelTitle");
        sparseArray.put(j6.f20724ge, "chat_topPanelMessage");
        sparseArray.put(j6.f20742he, "chat_addContact");
        sparseArray.put(j6.f20761ie, "chat_inLoader");
        sparseArray.put(j6.f20779je, "chat_inLoaderSelected");
        sparseArray.put(j6.Nb, "chat_outLoader");
        sparseArray.put(j6.Ob, "chat_outLoaderSelected");
        sparseArray.put(j6.f20799ke, "chat_inLoaderPhoto");
        sparseArray.put(j6.f20817le, "chat_mediaLoaderPhoto");
        sparseArray.put(j6.f20835me, "chat_mediaLoaderPhotoSelected");
        sparseArray.put(j6.ne, "chat_mediaLoaderPhotoIcon");
        sparseArray.put(j6.f20869oe, "chat_mediaLoaderPhotoIconSelected");
        sparseArray.put(j6.f20887pe, "chat_inLocationBackground");
        sparseArray.put(j6.f20905qe, "chat_inLocationIcon");
        sparseArray.put(j6.Pb, "chat_outLocationIcon");
        sparseArray.put(j6.f20924re, "chat_inContactBackground");
        sparseArray.put(j6.f20943se, "chat_inContactIcon");
        sparseArray.put(j6.Qb, "chat_outContactBackground");
        sparseArray.put(j6.Rb, "chat_outContactIcon");
        sparseArray.put(j6.f20961te, "chat_replyPanelIcons");
        sparseArray.put(j6.f20980ue, "chat_replyPanelClose");
        sparseArray.put(j6.f20997ve, "chat_replyPanelName");
        sparseArray.put(j6.f21015we, "chat_replyPanelLine");
        sparseArray.put(j6.f21032xe, "chat_searchPanelIcons");
        sparseArray.put(j6.f21050ye, "chat_searchPanelText");
        sparseArray.put(j6.f21069ze, "chat_secretChatStatusText");
        ...
        sparseArray.put(j6.f20615af, "chat_emojiPanelNewTrending");
        sparseArray.put(j6.f20634bf, "chat_messagePanelVoicePressed");
        sparseArray.put(j6.f20653cf, "chat_messagePanelVoiceBackground");
        sparseArray.put(j6.f20672df, "chat_messagePanelVoiceDelete");
        sparseArray.put(j6.f20690ef, "chat_messagePanelVoiceDuration");
        sparseArray.put(j6.f20707ff, "chat_recordedVoicePlayPause");
        sparseArray.put(j6.f20725gf, "chat_recordedVoiceProgress");
        sparseArray.put(j6.hf, "chat_recordedVoiceProgressInner");
        sparseArray.put(j6.f20780jf, "chat_recordedVoiceDot");
        sparseArray.put(j6.f20800kf, "chat_recordedVoiceBackground");
        sparseArray.put(j6.f20818lf, "chat_recordedVoiceDarkerBackground");
        sparseArray.put(j6.f20836mf, "chat_recordVoiceCancel");
        sparseArray.put(j6.f20852nf, "chat_recordTime");
        sparseArray.put(j6.f20870of, "chat_messagePanelCancelInlineBot");
        sparseArray.put(j6.f20888pf, "chat_gifSaveHintText");
        sparseArray.put(j6.f20906qf, "chat_gifSaveHintBackground");
        sparseArray.put(j6.f20925rf, "chat_goDownButton");
        sparseArray.put(j6.f20944sf, "chat_goDownButtonCounter");
        sparseArray.put(j6.f20962tf, "chat_goDownButtonCounterBackground");
        sparseArray.put(j6.Vb, "chat_outTextSelectionHighlight");
        sparseArray.put(j6.f20981uf, "chat_inTextSelectionHighlight");
        sparseArray.put(j6.f20998vf, "chat_TextSelectionCursor");
        ...
        sparseArray.put(j6.f21033xf, "chat_BlurAlpha");
        sparseArray.put(j6.f21051yf, "chat_BlurAlphaSlow");
        sparseArray.put(j6.f21070zf, "chat_editMediaButton");
        ...
        sparseArray.put(j6.f20616ag, "chat_msgIvButtonSuccessOutText");
        sparseArray.put(j6.f20635bg, "chat_msgIvButtonDefaultInlineOut");
        sparseArray.put(j6.f20654cg, "chat_msgIvButtonDefaultInlineOutPressed");
        sparseArray.put(j6.f20673dg, "chat_msgIvButtonDefaultInlineOutText");
        sparseArray.put(j6.eg, "voipgroup_listSelector");
        sparseArray.put(j6.f20708fg, "voipgroup_inviteMembersBackground");
        sparseArray.put(j6.f20726gg, "voipgroup_actionBar");
        sparseArray.put(j6.f20743hg, "voipgroup_actionBarItems");
        sparseArray.put(j6.f20762ig, "voipgroup_actionBarItemsSelector");
        sparseArray.put(j6.f20781jg, "voipgroup_actionBarUnscrolled");
        sparseArray.put(j6.f20801kg, "voipgroup_listViewBackgroundUnscrolled");
        sparseArray.put(j6.f20819lg, "voipgroup_lastSeenTextUnscrolled");
        sparseArray.put(j6.f20837mg, "voipgroup_mutedIconUnscrolled");
        sparseArray.put(j6.f20853ng, "voipgroup_nameText");
        sparseArray.put(j6.f20871og, "voipgroup_lastSeenText");
        sparseArray.put(j6.f20889pg, "voipgroup_listeningText");
        sparseArray.put(j6.f20907qg, "voipgroup_speakingText");
        sparseArray.put(j6.f20926rg, "voipgroup_mutedIcon");
        sparseArray.put(j6.f20945sg, "voipgroup_mutedByAdminIcon");
        sparseArray.put(j6.f20963tg, "voipgroup_listViewBackground");
        sparseArray.put(j6.f20982ug, "voipgroup_dialogBackground");
        sparseArray.put(j6.f20999vg, "voipgroup_leaveCallMenu");
        sparseArray.put(j6.f21016wg, "voipgroup_checkMenu");
        sparseArray.put(j6.f21034xg, "voipgroup_soundButton");
        sparseArray.put(j6.f21052yg, "voipgroup_soundButtonActive");
        sparseArray.put(j6.f21071zg, "voipgroup_soundButtonActiveScrolled");
        ...
        sparseArray.put(j6.f20617ah, "voipgroup_topPanelBlue2");
        sparseArray.put(j6.f20636bh, "voipgroup_topPanelGray");
        sparseArray.put(j6.f20655ch, "voipgroup_overlayAlertGradientMuted");
        sparseArray.put(j6.f20674dh, "voipgroup_overlayAlertGradientMuted2");
        sparseArray.put(j6.f20691eh, "voipgroup_overlayAlertGradientUnmuted");
        sparseArray.put(j6.f20709fh, "voipgroup_overlayAlertGradientUnmuted2");
        sparseArray.put(j6.f20727gh, "voipgroup_overlayAlertMutedByAdmin");
        sparseArray.put(j6.f20744hh, "voipgroup_overlayAlertMutedByAdmin2");
        sparseArray.put(j6.f20763ih, "voipgroup_mutedByAdminGradient");
        sparseArray.put(j6.f20782jh, "voipgroup_mutedByAdminGradient2");
        sparseArray.put(j6.f20802kh, "voipgroup_mutedByAdminGradient3");
        sparseArray.put(j6.f20820lh, "voipgroup_mutedByAdminMuteButton");
        sparseArray.put(j6.f20838mh, "voipgroup_mutedByAdminMuteButtonDisabled");
        sparseArray.put(j6.f20854nh, "voipgroup_windowBackgroundWhiteInputField");
        sparseArray.put(j6.f20872oh, "voipgroup_windowBackgroundWhiteInputFieldActivated");
        sparseArray.put(j6.f20927rh, "passport_authorizeBackground");
        sparseArray.put(j6.f20946sh, "passport_authorizeBackgroundSelected");
        sparseArray.put(j6.f20964th, "passport_authorizeText");
        sparseArray.put(j6.f20983uh, "profile_creatorIcon");
        sparseArray.put(j6.Ch, "chat_tagAdmin");
        sparseArray.put(j6.Dh, "chat_tagCreator");
        sparseArray.put(j6.f21000vh, "profile_title");
        sparseArray.put(j6.f21017wh, "profile_actionIcon");
        sparseArray.put(j6.f21035xh, "profile_actionBackground");
        sparseArray.put(j6.f21053yh, "profile_actionPressedBackground");
        sparseArray.put(j6.f21072zh, "profile_verifiedBackground");
        ...
        sparseArray.put(j6.f21029xa, "buttonNeutral");
        sparseArray.put(j6.f21046ya, "buttonNeutralText");
        ...
        sparseArray.put(j6.f20618ai, "groupcreate_sectionText");
        sparseArray.put(j6.f20637bi, "groupcreate_spanText");
        sparseArray.put(j6.f20656ci, "groupcreate_spanBackground");
        sparseArray.put(j6.f20675di, "groupcreate_spanDelete");
        sparseArray.put(j6.f20692ei, "contacts_inviteBackground");
        sparseArray.put(j6.f20710fi, "contacts_inviteText");
        sparseArray.put(j6.f20728gi, "login_progressInner");
        sparseArray.put(j6.f20745hi, "login_progressOuter");
        sparseArray.put(j6.f20764ii, "picker_enabledButton");
        sparseArray.put(j6.f20783ji, "picker_disabledButton");
        sparseArray.put(j6.f20803ki, "picker_badge");
        ...
        sparseArray.put(j6.f20606a6, "dialogCardShadow");
        sparseArray.put(j6.f20626b6, "dialogGiftsBackground");
        sparseArray.put(j6.f20645c6, "dialogGiftsTabText");
    ...
    public static int[] e() {
        int[] iArr = new int[j6.f20699f5];
        iArr[j6.f20717g5] = 0;
        iArr[j6.f20734h5] = -1;
        iArr[j6.f20752i5] = -986896;
        iArr[j6.f20770j5] = -15065823;
        iArr[j6.f20790k5] = -14255946;
        iArr[j6.f20808l5] = 862104035;
        iArr[j6.f20826m5] = -13660983;
        iArr[j6.f20845n5] = -12937771;
        iArr[j6.f20861o5] = -15095832;
        iArr[j6.p5] = -13333567;
        iArr[j6.f20897q5] = -9079435;
        iArr[j6.f20915r5] = -6710887;
        iArr[j6.f20934s5] = -5000269;
        iArr[j6.f20953t5] = -6842473;
        iArr[j6.J5] = -15065823;
        iArr[j6.K5] = -2960686;
        iArr[j6.L5] = -14054705;
        iArr[j6.f20971u5] = -2368549;
        iArr[j6.f20989v5] = -14509328;
        iArr[j6.f21007w5] = -14509328;
        iArr[j6.f21024x5] = -1;
        iArr[j6.f21041y5] = -9211021;
        iArr[j6.f21060z5] = -5197648;
        iArr[j6.D5] = -5000269;
        iArr[j6.E5] = -14509328;
        iArr[j6.F5] = -11371101;
        iArr[j6.G5] = -2368549;
        ...
        iArr[j6.Y5] = -1743531;
        iArr[j6.Z5] = -1352098;
        iArr[j6.f20606a6] = 385875968;
        iArr[j6.f20626b6] = -657673;
        iArr[j6.f20645c6] = -11118244;
        iArr[j6.Ki] = -855310;
        iArr[j6.Li] = -12147470;
        iArr[j6.Mi] = -3389625;
        iArr[j6.Vk] = -9538955;
        ...
        iArr[j6.f20663d6] = -1;
        iArr[j6.f20683e6] = -6905171;
        iArr[j6.f20700f6] = -14509328;
        iArr[j6.f20718g6] = -1;
        iArr[j6.f20735h6] = -14904349;
        iArr[j6.f20827m6] = -15065823;
        iArr[j6.f20846n6] = -12545331;
        iArr[j6.f20862o6] = -12937771;
        iArr[j6.f20879p6] = -14255946;
        iArr[j6.q6] = -14904349;
        iArr[j6.f20916r6] = -11759926;
        iArr[j6.f20935s6] = -12940081;
        iArr[j6.f20954t6] = -13141330;
        iArr[j6.f20972u6] = -14776109;
        iArr[j6.f20990v6] = -13132315;
        iArr[j6.f21008w6] = -14248148;
        iArr[j6.f21025x6] = -13129704;
        iArr[j6.f20880p7] = -3397335;
        iArr[j6.f20898q7] = -3389625;
        iArr[j6.f20917r7] = -1352098;
        iArr[j6.f21042y6] = -8354940;
        iArr[j6.f21061z6] = -8223094;
        iArr[j6.A6] = -6710887;
        iArr[j6.B6] = -8355712;
        iArr[j6.C6] = -6052957;
        iArr[j6.D6] = -9079435;
        ...
        iArr[j6.L6] = -14054705;
        iArr[j6.f20791k6] = -2368549;
        iArr[j6.f20809l6] = -14509328;
        iArr[j6.M6] = -5853773;
        iArr[j6.N6] = -14509328;
        iArr[j6.O6] = -8879478;
        iArr[j6.P6] = -15697468;
        ...
        iArr[j6.Y6] = -9211021;
        iArr[j6.Z6] = -5197648;
        iArr[j6.f20753i6] = 251658240;
        iArr[j6.f20771j6] = 486539280;
        iArr[j6.f20719g7] = -5000269;
        iArr[j6.f20736h7] = -14509328;
        iArr[j6.f20607a7] = -921101;
        iArr[j6.f20627b7] = -16777216;
        iArr[j6.f20646c7] = -9209733;
        iArr[j6.f20664d7] = -2500135;
        iArr[j6.e7] = -657931;
        iArr[j6.f7] = -8222838;
        iArr[j6.B7] = -4202506;
        iArr[j6.C7] = -13920542;
        ...
        iArr[j6.H7] = -3486256;
        iArr[j6.I7] = -13683656;
        iArr[j6.f20810l7] = -14509328;
        iArr[j6.f20828m7] = -3551791;
        iArr[j6.f20847n7] = -1;
        iArr[j6.f20863o7] = -7301735;
        iArr[j6.J7] = -1;
        iArr[j6.K7] = -9847303;
        iArr[j6.L7] = -12541983;
        iArr[j6.M7] = -4668724;
        ...
        iArr[j6.Z7] = -13264172;
        iArr[j6.T7] = -10702854;
        iArr[j6.f20608a8] = -12547377;
        iArr[j6.U7] = -30036;
        iArr[j6.f20628b8] = -2534028;
        iArr[j6.f20647c8] = -6181963;
        iArr[j6.f20665d8] = -1;
        iArr[j6.f20684e8] = -657931;
        iArr[j6.f20737h8] = -15065823;
        iArr[j6.f20701f8] = 303701281;
        iArr[j6.f20720g8] = -15065823;
        iArr[j6.f20755i8] = -3387319;
        iArr[j6.f20773j8] = -2722014;
        iArr[j6.f20793k8] = -6988581;
        iArr[j6.f20811l8] = -12539616;
        iArr[j6.f20829m8] = -13590854;
        iArr[j6.f20848n8] = -13202735;
        iArr[j6.f20864o8] = -3714933;
        iArr[j6.f20937s8] = -1;
        iArr[j6.f20992v8] = -15065823;
        iArr[j6.f21010w8] = -1;
        iArr[j6.f21027x8] = 268435456;
        iArr[j6.f21044y8] = -15065823;
        iArr[j6.A8] = -15065823;
        iArr[j6.B8] = -8814210;
        iArr[j6.f20956t8] = 303701281;
        iArr[j6.f20974u8] = 303701281;
        iArr[j6.C8] = -15065823;
        iArr[j6.D8] = -8814210;
        iArr[j6.E8] = -15065823;
        iArr[j6.F8] = -15065823;
        iArr[j6.G8] = -1;
        iArr[j6.H8] = -657931;
        iArr[j6.f21063z8] = -1907998;
        iArr[j6.f20976ua] = -986896;
        iArr[j6.f20993va] = -8223094;
        iArr[j6.f21012wa] = -4144960;
        iArr[j6.I8] = -14054705;
        iArr[j6.J8] = -8946561;
        iArr[j6.K8] = -14054705;
        iArr[j6.T9] = -10048031;
        ...
        iArr[j6.S8] = -1;
        iArr[j6.f20890ph] = -526345;
        iArr[j6.f20908qh] = -2039584;
        iArr[j6.M8] = -1;
        ...
        iArr[j6.V8] = -4275257;
        iArr[j6.W8] = -1;
        iArr[j6.f20648c9] = -14509328;
        iArr[j6.f20666d9] = -6313293;
        iArr[j6.f20685e9] = -1;
        iArr[j6.f20702f9] = -1;
        iArr[j6.X8] = -15065823;
        iArr[j6.Y8] = -15065823;
        iArr[j6.Z8] = -16734706;
        iArr[j6.f20609a9] = -15093466;
        iArr[j6.f20629b9] = -7236972;
        iArr[j6.f20721g9] = -9078662;
        iArr[j6.f20738h9] = -7237231;
        iArr[j6.f20756i9] = -7434095;
        iArr[j6.f20774j9] = -2274503;
        iArr[j6.f20794k9] = -14054705;
        iArr[j6.f20812l9] = -7631473;
        iArr[j6.f20830m9] = -12434359;
        iArr[j6.f20849n9] = -10592674;
        iArr[j6.o9] = -14054705;
        iArr[j6.f20882p9] = -14054705;
        iArr[j6.f20900q9] = -8092024;
        iArr[j6.f20919r9] = -7236715;
        iArr[j6.f20938s9] = 134217728;
        iArr[j6.f20957t9] = 251658240;
        iArr[j6.f20975u9] = -12146122;
        iArr[j6.v9] = -12146122;
        iArr[j6.f21011w9] = -9061026;
        iArr[j6.f21028x9] = -2796974;
        iArr[j6.f21045y9] = -1;
        iArr[j6.f21064z9] = -13391642;
        iArr[j6.A9] = -1;
        iArr[j6.B9] = -4341308;
        iArr[j6.C9] = -1;
        iArr[j6.F9] = -1;
        ...
        iArr[j6.Y9] = -13391883;
        iArr[j6.Z9] = -7169634;
        iArr[j6.f20610aa] = -13421773;
        iArr[j6.f20630ba] = -1945520;
        iArr[j6.f20649ca] = -9472134;
        iArr[j6.f20667da] = -3355444;
        iArr[j6.f20757ia] = -1;
        iArr[j6.f20775ja] = -12214795;
        iArr[j6.f20795ka] = -1351584;
        iArr[j6.f20813la] = -868277;
        iArr[j6.f20831ma] = -2121728;
        iArr[j6.f20850na] = -10436011;
        iArr[j6.f20865oa] = -868277;
        iArr[j6.f20686ea] = -10436011;
        iArr[j6.f20703fa] = -10436011;
        iArr[j6.ga] = -1351584;
        iArr[j6.ha] = -1351584;
        iArr[j6.f20883pa] = -14054705;
        iArr[j6.f20901qa] = -16725933;
        iArr[j6.Ia] = -16725933;
        iArr[j6.f20885pc] = -14540254;
        iArr[j6.f20867oc] = -8814210;
        iArr[j6.f20920ra] = -1;
        iArr[j6.f20669dc] = -1247235;
        iArr[j6.ta] = -14862509;
        iArr[j6.Aa] = -1048610;
        iArr[j6.f20632bc] = 335544320;
        iArr[j6.Ba] = -2492475;
        iArr[j6.Ca] = -14781172;
        iArr[j6.f20978uc] = -1;
        iArr[j6.f20995vc] = -1050370;
        iArr[j6.Pa] = -1048610;
        iArr[j6.Qa] = -1967921;
        iArr[j6.ec] = -16777216;
        iArr[j6.f20705fc] = -16777216;
        iArr[j6.gc] = -14255946;
        iArr[j6.f20740hc] = -14255946;
        iArr[j6.f20759ic] = -1;
        iArr[j6.f20777jc] = -1;
        iArr[j6.f20797kc] = -1;
        ...
        iArr[j6.Na] = -9061026;
        iArr[j6.Oa] = -9061026;
        iArr[j6.f20903qc] = -6182221;
        iArr[j6.f20922rc] = -7094838;
        iArr[j6.f20941sc] = -1;
        iArr[j6.f20959tc] = -1;
        iArr[j6.xc] = -6182221;
        iArr[j6.f21048yc] = -7094838;
        iArr[j6.Ra] = -9522601;
        iArr[j6.Sa] = -9522601;
        iArr[j6.f21067zc] = -1;
        iArr[j6.Ac] = -4801083;
        ...
        iArr[j6.Rc] = -1;
        iArr[j6.Uc] = -10903592;
        iArr[j6.f20611ab] = -9520791;
        iArr[j6.f20631bb] = -12539616;
        iArr[j6.Vc] = -1;
        iArr[j6.Wc] = -14054705;
        iArr[j6.cb] = -11162801;
        iArr[j6.Xc] = -1;
        iArr[j6.Yc] = -16777216;
        iArr[j6.f20668db] = -16777216;
        iArr[j6.Zc] = -6182221;
        iArr[j6.f20687eb] = -10112933;
        iArr[j6.f20613ad] = -7752511;
        iArr[j6.f20704fb] = -10112933;
        iArr[j6.bd] = -1;
        iArr[j6.f20651cd] = -9390872;
        iArr[j6.f20722gb] = -7812741;
        iArr[j6.f20670dd] = -14054705;
        iArr[j6.f20739hb] = -11162801;
        iArr[j6.f20688ed] = -11625772;
        iArr[j6.f20758ib] = -11162801;
        iArr[j6.f20706fd] = -13683656;
        iArr[j6.f20723gd] = -13683656;
        iArr[j6.f20776jb] = -13286860;
        iArr[j6.f20796kb] = -13286860;
        iArr[j6.f20741hd] = -1;
        iArr[j6.f20760id] = -1;
        iArr[j6.f20902qb] = -1048610;
        iArr[j6.f20778jd] = -1050370;
        iArr[j6.f20921rb] = -1967921;
        iArr[j6.f20798kd] = -1;
        iArr[j6.f20816ld] = -4143413;
        iArr[j6.f20834md] = -7752511;
        iArr[j6.f20866ob] = -9391780;
        iArr[j6.f20884pb] = -9391780;
        iArr[j6.f20851nd] = -6182221;
        iArr[j6.f20868od] = -7752511;
        iArr[j6.f20940sb] = -9391780;
        iArr[j6.nb] = -9391780;
        iArr[j6.f20886pd] = -13683656;
        iArr[j6.f20904qd] = -13683656;
        iArr[j6.f20814lb] = -13286860;
        iArr[j6.f20832mb] = -13286860;
        iArr[j6.f20923rd] = -11625772;
        iArr[j6.f20958tb] = -11162801;
        iArr[j6.f20942sd] = -6182221;
        iArr[j6.f20977ub] = -10112933;
        iArr[j6.f20960td] = -7752511;
        iArr[j6.f20994vb] = -10112933;
        iArr[j6.f20979ud] = -1774864;
        iArr[j6.f20996vd] = 1071966960;
        iArr[j6.f21013wb] = -4463700;
        iArr[j6.f21030xb] = 1069278124;
        iArr[j6.f21014wd] = -4399384;
        iArr[j6.f21047yb] = -5644906;
        iArr[j6.f21031xd] = -14509328;
        iArr[j6.f21066zb] = -8863118;
        iArr[j6.f21049yd] = -2169365;
        iArr[j6.Ab] = -4463700;
        iArr[j6.f21068zd] = -4399384;
        iArr[j6.Bb] = -5644906;
        iArr[j6.Ad] = -14509328;
        iArr[j6.Cb] = -8863118;
        iArr[j6.Bd] = -1314571;
        ...
        iArr[j6.Ee] = -11102772;
        iArr[j6.Fe] = -1;
        iArr[j6.f20887pe] = -1314571;
        iArr[j6.f20905qe] = -6113849;
        iArr[j6.Pb] = -7880840;
        iArr[j6.f20924re] = -14509328;
        iArr[j6.f20943se] = -1;
        iArr[j6.Qb] = -8863118;
        iArr[j6.Rb] = -1048610;
        iArr[j6.f21032xe] = -9999761;
        iArr[j6.f21050ye] = -9999761;
        iArr[j6.f21069ze] = -8421505;
        iArr[j6.Ae] = -14054705;
        iArr[j6.Be] = -1;
        iArr[j6.f20961te] = -14509328;
        iArr[j6.f20980ue] = -7432805;
        iArr[j6.f20997ve] = -14054705;
        iArr[j6.f21015we] = -1513240;
        iArr[j6.Sd] = -1;
        iArr[j6.Ud] = -16777216;
        iArr[j6.Vd] = -8025468;
        iArr[j6.Wd] = -11230757;
        ...
        iArr[j6.Xd] = -7432805;
        iArr[j6.f20707ff] = -1;
        iArr[j6.f20780jf] = -2468275;
        iArr[j6.f20800kf] = -10637848;
        iArr[j6.f20818lf] = -14710309;
        iArr[j6.f20725gf] = -5120257;
        iArr[j6.hf] = -1;
        iArr[j6.f20836mf] = -12937772;
        iArr[j6.Yd] = -14509328;
        iArr[j6.Zd] = -5987164;
        iArr[j6.f20614ae] = -1;
        iArr[j6.f20633be] = -16777216;
        iArr[j6.f20852nf] = -7432805;
        iArr[j6.f20615af] = -11688214;
        iArr[j6.f20888pf] = -1;
        iArr[j6.f20906qf] = -501273800;
        iArr[j6.f20925rf] = -1;
        iArr[j6.f20944sf] = -1;
        iArr[j6.f20962tf] = -14509328;
        iArr[j6.f20870of] = -5395027;
        iArr[j6.f20634bf] = -1;
        iArr[j6.f20653cf] = -14509328;
        iArr[j6.f20672df] = -9211021;
        iArr[j6.f20690ef] = -1;
        iArr[j6.Ge] = -11037236;
        iArr[j6.f20652ce] = -1;
        iArr[j6.f20671de] = -8288378;
        iArr[j6.f20689ee] = -12605201;
        iArr[j6.fe] = -14054705;
        iArr[j6.f20724ge] = -9011588;
        iArr[j6.f20742he] = -14054705;
        iArr[j6.f20761ie] = -14509328;
        iArr[j6.f20779je] = -10114080;
        iArr[j6.Nb] = -8863118;
        iArr[j6.Ob] = -9783964;
        iArr[j6.f20799ke] = -6113080;
        iArr[j6.f20817le] = 1711276032;
        iArr[j6.f20835me] = 2130706432;
        iArr[j6.ne] = -1;
        iArr[j6.f20869oe] = -2500135;
        iArr[j6.nc] = 553648127;
        iArr[j6.Sc] = -12215336;
        iArr[j6.Tc] = -9783200;
        iArr[j6.f20983uh] = -12937771;
        iArr[j6.f21017wh] = -8288630;
        iArr[j6.f21035xh] = -1;
        iArr[j6.f21053yh] = 303701281;
        iArr[j6.f21072zh] = -14509328;
        iArr[j6.Ah] = -1;
        iArr[j6.f21000vh] = -14540254;
        iArr[j6.Bh] = -14540254;
        iArr[j6.Ch] = -12539616;
        iArr[j6.Dh] = -6988581;
        iArr[j6.Eh] = -7893872;
        ...
        iArr[j6.Bi] = -1;
        iArr[j6.Ci] = -6908266;
        iArr[j6.f20927rh] = -12211217;
        iArr[j6.f20946sh] = -12542501;
        iArr[j6.f20964th] = -1;
        iArr[j6.mi] = -12149258;
        iArr[j6.ni] = -1;
        iArr[j6.oi] = -14906664;
        ...
        iArr[j6.Sh] = -1;
        iArr[j6.Th] = -11688214;
        iArr[j6.f21029xa] = -1776412;
        iArr[j6.f21046ya] = -15065823;
        iArr[j6.f20955t7] = -15065823;
        iArr[j6.f20973u7] = -15065823;
        iArr[j6.f20991v7] = -1;
        iArr[j6.f21009w7] = -14509328;
        iArr[j6.f21026x7] = -7763066;
        iArr[j6.f21043y7] = -12279325;
        iArr[j6.f21062z7] = -6445135;
        iArr[j6.A7] = -1;
        iArr[j6.Ih] = -13196562;
        iArr[j6.Jh] = -986123;
        iArr[j6.Kh] = -4735293;
        iArr[j6.Lh] = -1182729;
        iArr[j6.f20754i7] = -10567099;
        iArr[j6.f20792k7] = -1;
        iArr[j6.f20772j7] = -5195326;
        iArr[j6.Uh] = -4801083;
        ...
        iArr[j6.Yh] = -11361317;
        iArr[j6.Zh] = -16777216;
        iArr[j6.f20618ai] = -8617336;
        iArr[j6.f20637bi] = -14540254;
        iArr[j6.f20656ci] = -855310;
        iArr[j6.f20675di] = -1;
        iArr[j6.f20692ei] = -11157919;
        iArr[j6.f20710fi] = -1;
        iArr[j6.f20728gi] = -1971470;
        iArr[j6.f20745hi] = -10313520;
        iArr[j6.f20764ii] = -15095832;
        iArr[j6.f20783ji] = -6710887;
        iArr[j6.f20803ki] = -14043401;
        iArr[j6.li] = -1;
        iArr[j6.Ce] = -12348980;
        ...
        iArr[j6.f20981uf] = 1348643299;
        iArr[j6.f20998vf] = -12476440;
        iArr[j6.Wb] = -12476440;
        iArr[j6.Xb] = 506491665;
        iArr[j6.wf] = 508584819;
        iArr[j6.f21033xf] = -1308622848;
        iArr[j6.f21051yf] = -1056964608;
        iArr[j6.f21070zf] = -15033089;
        iArr[j6.Af] = -1184275;
        iArr[j6.Bf] = -1184275;
        iArr[j6.Cf] = -15065823;
        iArr[j6.Df] = -14509328;
        ...
        iArr[j6.Yf] = -2296629;
        iArr[j6.Zf] = -2296629;
        iArr[j6.f20616ag] = -12539616;
        iArr[j6.f20635bg] = -2296629;
        iArr[j6.f20654cg] = -2296629;
        iArr[j6.f20673dg] = -11293879;
        ...
        iArr[j6.Qg] = -8024684;
        iArr[j6.Rg] = -13616313;
        iArr[j6.f20999vg] = -35467;
        iArr[j6.Pg] = -13023660;
        iArr[j6.f21034xg] = 2100052301;
        iArr[j6.f21052yg] = 2099422443;
        iArr[j6.f21071zg] = -2110540545;
        ...
        iArr[j6.Ig] = -11297032;
        iArr[j6.Jg] = -10038021;
        iArr[j6.f20781jg] = -15130842;
        iArr[j6.f20801kg] = -14538189;
        iArr[j6.f20819lg] = -8024684;
        iArr[j6.f20837mg] = -8485236;
        iArr[j6.f20726gg] = -15789289;
        iArr[j6.f20743hg] = -1;
        iArr[j6.f20762ig] = 515562495;
        iArr[j6.f20945sg] = -36752;
        iArr[j6.f20926rg] = -9471616;
        iArr[j6.f20871og] = -8813686;
        iArr[j6.f20853ng] = -1;
        iArr[j6.f20963tg] = -14933463;
        iArr[j6.f20982ug] = -14933463;
        iArr[j6.f20889pg] = -11683585;
        iArr[j6.f20907qg] = -8917379;
        iArr[j6.eg] = 251658239;
        iArr[j6.f20708fg] = -14538189;
        iArr[j6.Vg] = -13906177;
        iArr[j6.Wg] = -16156957;
        iArr[j6.Tg] = -15551198;
        iArr[j6.Ug] = -16722239;
        iArr[j6.Zg] = -10434565;
        iArr[j6.f20617ah] = -11427847;
        iArr[j6.Xg] = -11350435;
        iArr[j6.Yg] = -16731712;
        iArr[j6.f20636bh] = -8021590;
        iArr[j6.f20655ch] = -14455406;
        iArr[j6.f20674dh] = -13873813;
        iArr[j6.f20691eh] = -15955316;
        iArr[j6.f20709fh] = -14136203;
        iArr[j6.f20763ih] = -11033346;
        iArr[j6.f20782jh] = -1026983;
        iArr[j6.f20802kh] = -9015575;
        iArr[j6.f20727gh] = -9998178;
        iArr[j6.f20744hh] = -13676424;
        iArr[j6.f20820lh] = 2138612735;
        iArr[j6.f20838mh] = 863544319;
        iArr[j6.f20854nh] = -2368549;
        iArr[j6.f20872oh] = -14509328;
        iArr[j6.Sb] = -8863118;
        iArr[j6.Cj] = -14509328;
        iArr[j6.Ej] = -14054705;
        iArr[j6.Dj] = -11162801;
    ...
    public static int s(String str) {
        ...
        if (((Integer) f20470e.get(str)) == null) {
            return -1;
        }
        return ((Integer) f20470e.get(str)).intValue();
    }
