...
public abstract class g5 implements z2 {
    public static final double[] f20495a = {0.819022437996703d, 0.3619062600528904d, -0.1288737815209879d, 0.0329836539323885d, 0.9292868615863434d, 0.0361446663506424d, 0.0481771893596242d, 0.2642395317527308d, 0.6335478284694309d};
    public static final double[] f20496b = {0.210454268309314d, 0.7936177747023054d, -0.0040720430116193d, 1.9779985324311684d, -2.42859224204858d, 0.450593709617411d, 0.0259040424655478d, 0.7827717124575296d, -0.8086757549230774d};
    public static final double[] f20497c = {0.41239079926595934d, 0.357584339383878d, 0.1804807884018343d, 0.21263900587151027d, 0.715168678767756d, 0.07219231536073371d, 0.01933081871559182d, 0.11919477979462598d, 0.9505321522496607d};
    public static SparseArray d;
    public static HashMap f20498e;

    public static SparseArray d() {
        SparseArray sparseArray = new SparseArray();
        sparseArray.put(j6.f20745g5, "wallpaperFileOffset");
        sparseArray.put(j6.f20762h5, "dialogBackground");
        sparseArray.put(j6.f20780i5, "dialogBackgroundGray");
        sparseArray.put(j6.f20798j5, "dialogTextBlack");
        sparseArray.put(j6.f20818k5, "dialogTextLink");
        sparseArray.put(j6.f20836l5, "dialogLinkSelection");
        sparseArray.put(j6.f20854m5, "dialogTextBlue");
        sparseArray.put(j6.f20873n5, "dialogTextBlue2");
        sparseArray.put(j6.f20889o5, "dialogTextBlue4");
        sparseArray.put(j6.p5, "dialogTextGray");
        sparseArray.put(j6.f20925q5, "dialogTextGray2");
        sparseArray.put(j6.f20943r5, "dialogTextGray3");
        sparseArray.put(j6.f20962s5, "dialogTextGray4");
        sparseArray.put(j6.f20981t5, "dialogTextHint");
        sparseArray.put(j6.f20999u5, "dialogInputField");
        sparseArray.put(j6.f21017v5, "dialogInputFieldActivated");
        sparseArray.put(j6.f21035w5, "dialogCheckboxSquareBackground");
        sparseArray.put(j6.f21052x5, "dialogCheckboxSquareCheck");
        sparseArray.put(j6.f21069y5, "dialogCheckboxSquareUnchecked");
        sparseArray.put(j6.f21088z5, "dialogCheckboxSquareDisabled");
        ...
        sparseArray.put(j6.f20691d6, "windowBackgroundWhite");
        sparseArray.put(j6.f20711e6, "windowBackgroundUnchecked");
        sparseArray.put(j6.f20728f6, "windowBackgroundChecked");
        sparseArray.put(j6.f20746g6, "windowBackgroundCheckText");
        sparseArray.put(j6.f20763h6, "progressCircle");
        sparseArray.put(j6.f20781i6, "listSelectorSDK21");
        sparseArray.put(j6.f20819k6, "windowBackgroundWhiteInputField");
        sparseArray.put(j6.f20837l6, "windowBackgroundWhiteInputFieldActivated");
        sparseArray.put(j6.f20891o7, "pollCreateIcons");
        sparseArray.put(j6.f20855m6, "windowBackgroundWhiteGrayIcon");
        sparseArray.put(j6.f20874n6, "windowBackgroundWhiteBlueText");
        sparseArray.put(j6.f20890o6, "windowBackgroundWhiteBlueText2");
        sparseArray.put(j6.f20907p6, "windowBackgroundWhiteBlueText3");
        sparseArray.put(j6.q6, "windowBackgroundWhiteBlueText4");
        sparseArray.put(j6.f20944r6, "windowBackgroundWhiteBlueText5");
        sparseArray.put(j6.f20963s6, "windowBackgroundWhiteBlueText6");
        sparseArray.put(j6.f20982t6, "windowBackgroundWhiteBlueText7");
        sparseArray.put(j6.f21000u6, "windowBackgroundWhiteBlueButton");
        sparseArray.put(j6.f21018v6, "windowBackgroundWhiteBlueIcon");
        sparseArray.put(j6.f21036w6, "windowBackgroundWhiteGreenText");
        sparseArray.put(j6.f21053x6, "windowBackgroundWhiteGreenText2");
        sparseArray.put(j6.f21070y6, "windowBackgroundWhiteGrayText");
        sparseArray.put(j6.f21089z6, "windowBackgroundWhiteGrayText2");
        ...
        sparseArray.put(j6.f20635a7, "windowBackgroundGray");
        sparseArray.put(j6.f20655b7, "windowBackgroundGrayShadow");
        sparseArray.put(j6.f20674c7, "emptyListPlaceholder");
        sparseArray.put(j6.f20692d7, "divider");
        sparseArray.put(j6.e7, "graySection");
        sparseArray.put(j6.f7, "key_graySectionText");
        sparseArray.put(j6.f20747g7, "radioBackground");
        sparseArray.put(j6.f20764h7, "radioBackgroundChecked");
        sparseArray.put(j6.f20782i7, "checkbox");
        sparseArray.put(j6.f20800j7, "checkboxDisabled");
        sparseArray.put(j6.f20820k7, "checkboxCheck");
        sparseArray.put(j6.f20838l7, "fastScrollActive");
        sparseArray.put(j6.f20856m7, "fastScrollInactive");
        sparseArray.put(j6.f20875n7, "fastScrollText");
        sparseArray.put(j6.f20908p7, "text_RedRegular");
        sparseArray.put(j6.f20926q7, "text_RedBold");
        sparseArray.put(j6.f20945r7, "fill_RedNormal");
        sparseArray.put(j6.f20964s7, "fill_RedDark");
        sparseArray.put(j6.f20983t7, "inappPlayerPerformer");
        sparseArray.put(j6.f21001u7, "inappPlayerTitle");
        sparseArray.put(j6.f21019v7, "inappPlayerBackground");
        sparseArray.put(j6.f21037w7, "inappPlayerPlayPause");
        sparseArray.put(j6.f21054x7, "inappPlayerClose");
        sparseArray.put(j6.f21071y7, "returnToCallBackground");
        sparseArray.put(j6.f21090z7, "returnToCallMutedBackground");
        ...
        sparseArray.put(j6.f20636a8, "avatar_background2Blue");
        sparseArray.put(j6.f20656b8, "avatar_background2Pink");
        sparseArray.put(j6.f20693d8, "avatar_backgroundInProfileBlue");
        sparseArray.put(j6.f20712e8, "avatar_backgroundActionBarBlue");
        sparseArray.put(j6.f20729f8, "avatar_actionBarSelectorBlue");
        sparseArray.put(j6.f20748g8, "avatar_actionBarIconBlue");
        sparseArray.put(j6.f20765h8, "avatar_subtitleInProfileBlue");
        sparseArray.put(j6.f20783i8, "avatar_nameInMessageRed");
        sparseArray.put(j6.f20801j8, "avatar_nameInMessageOrange");
        sparseArray.put(j6.f20821k8, "avatar_nameInMessageViolet");
        sparseArray.put(j6.f20839l8, "avatar_nameInMessageGreen");
        sparseArray.put(j6.f20857m8, "avatar_nameInMessageCyan");
        sparseArray.put(j6.f20876n8, "avatar_nameInMessageBlue");
        sparseArray.put(j6.f20892o8, "avatar_nameInMessagePink");
        sparseArray.put(j6.f20965s8, "actionBarDefault");
        sparseArray.put(j6.f20984t8, "actionBarDefaultSelector");
        sparseArray.put(j6.f21002u8, "actionBarWhiteSelector");
        sparseArray.put(j6.f21020v8, "actionBarDefaultIcon");
        sparseArray.put(j6.f21038w8, "actionBarActionModeDefault");
        sparseArray.put(j6.f21055x8, "actionBarActionModeDefaultTop");
        sparseArray.put(j6.f21072y8, "actionBarActionModeDefaultIcon");
        sparseArray.put(j6.f21091z8, "actionBarActionModeDefaultSelector");
        sparseArray.put(j6.f21004ua, "actionBarActionModeReaction");
        sparseArray.put(j6.f21021va, "actionBarActionModeReactionText");
        sparseArray.put(j6.f21040wa, "actionBarActionModeReactionDot");
        ...
        sparseArray.put(j6.f20918ph, "table_background");
        sparseArray.put(j6.f20936qh, "table_border");
        ...
        sparseArray.put(j6.f20637a9, "chats_secretIcon");
        sparseArray.put(j6.f20657b9, "chats_pinnedIcon");
        sparseArray.put(j6.f20676c9, "chats_archiveBackground");
        sparseArray.put(j6.f20694d9, "chats_archivePinBackground");
        sparseArray.put(j6.f20713e9, "chats_archiveIcon");
        sparseArray.put(j6.f20730f9, "chats_archiveText");
        sparseArray.put(j6.f20749g9, "chats_message");
        sparseArray.put(j6.f20766h9, "chats_messageArchived");
        sparseArray.put(j6.f20784i9, "chats_message_threeLines");
        sparseArray.put(j6.f20802j9, "chats_draft");
        sparseArray.put(j6.f20822k9, "chats_nameMessage");
        sparseArray.put(j6.f20840l9, "chats_nameMessageArchived");
        sparseArray.put(j6.f20858m9, "chats_nameMessage_threeLines");
        sparseArray.put(j6.f20877n9, "chats_nameMessageArchived_threeLines");
        sparseArray.put(j6.o9, "chats_attachMessage");
        sparseArray.put(j6.f20910p9, "chats_actionMessage");
        sparseArray.put(j6.f20928q9, "chats_date");
        sparseArray.put(j6.f20947r9, "chats_date_bold");
        sparseArray.put(j6.f20966s9, "chats_pinnedOverlay");
        sparseArray.put(j6.f20985t9, "chats_tabletSelectedOverlay");
        sparseArray.put(j6.f21003u9, "chats_sentCheck");
        sparseArray.put(j6.v9, "chats_sentReadCheck");
        sparseArray.put(j6.f21039w9, "chats_sentClock");
        sparseArray.put(j6.f21056x9, "chats_sentError");
        sparseArray.put(j6.f21073y9, "chats_sentErrorIcon");
        sparseArray.put(j6.f21092z9, "chats_verifiedBackground");
        ...
        sparseArray.put(j6.f20638aa, "chat_attachPermissionImage");
        sparseArray.put(j6.f20658ba, "chat_attachPermissionMark");
        sparseArray.put(j6.f20677ca, "chat_attachPermissionText");
        sparseArray.put(j6.f20695da, "chat_attachEmptyImage");
        sparseArray.put(j6.f20714ea, "chat_inPollCorrectAnswer");
        sparseArray.put(j6.f20731fa, "chat_outPollCorrectAnswer");
        sparseArray.put(j6.ga, "chat_inPollWrongAnswer");
        sparseArray.put(j6.ha, "chat_outPollWrongAnswer");
        sparseArray.put(j6.f20785ia, "chat_attachIcon");
        sparseArray.put(j6.f20803ja, "chat_attachGalleryBackground");
        sparseArray.put(j6.f20823ka, "chat_attachAudioBackground");
        sparseArray.put(j6.f20841la, "chat_attachContactBackground");
        sparseArray.put(j6.f20859ma, "chat_attachContactText");
        sparseArray.put(j6.f20878na, "chat_attachLocationBackground");
        sparseArray.put(j6.f20893oa, "chat_attachPollBackground");
        sparseArray.put(j6.f20911pa, "chat_status");
        sparseArray.put(j6.f20929qa, "chat_inDownCall");
        sparseArray.put(j6.Ia, "chat_outUpCall");
        sparseArray.put(j6.f20948ra, "chat_inBubble");
        sparseArray.put(j6.f20697dc, "chat_inBubbleSelected");
        sparseArray.put(j6.f20967sa, "chat_inBubbleSelectedOverlay");
        ...
        sparseArray.put(j6.f20640ac, "chat_outBubbleGradientAnimated");
        sparseArray.put(j6.f20660bc, "chat_outBubbleGradientSelectedOverlay");
        ...
        sparseArray.put(j6.f20733fc, "chat_messageTextOut");
        sparseArray.put(j6.gc, "chat_messageLinkIn");
        sparseArray.put(j6.f20768hc, "chat_messageLinkOut");
        sparseArray.put(j6.f20787ic, "chat_serviceText");
        sparseArray.put(j6.f20805jc, "chat_serviceLink");
        sparseArray.put(j6.f20825kc, "chat_serviceIcon");
        sparseArray.put(j6.f20843lc, "chat_serviceBackground");
        sparseArray.put(j6.f20861mc, "chat_serviceBackgroundSelected");
        ...
        sparseArray.put(j6.f20895oc, "chat_muteIcon");
        sparseArray.put(j6.f20913pc, "chat_lockIcon");
        ...
        sparseArray.put(j6.f20931qc, "chat_inSentClock");
        sparseArray.put(j6.f20950rc, "chat_inSentClockSelected");
        sparseArray.put(j6.f20969sc, "chat_mediaSentCheck");
        sparseArray.put(j6.f20987tc, "chat_mediaSentClock");
        sparseArray.put(j6.f21006uc, "chat_inMediaIcon");
        sparseArray.put(j6.Pa, "chat_outMediaIcon");
        sparseArray.put(j6.f21023vc, "chat_inMediaIconSelected");
        ...
        sparseArray.put(j6.f21076yc, "chat_inViewsSelected");
        sparseArray.put(j6.f21095zc, "chat_mediaViews");
        ...
        sparseArray.put(j6.f20639ab, "chat_outReplyLine");
        sparseArray.put(j6.f20659bb, "chat_outReplyLine2");
        ...
        sparseArray.put(j6.f20696db, "chat_outReplyMessageText");
        sparseArray.put(j6.Zc, "chat_inReplyMediaMessageText");
        sparseArray.put(j6.f20715eb, "chat_outReplyMediaMessageText");
        sparseArray.put(j6.f20641ad, "chat_inReplyMediaMessageSelectedText");
        sparseArray.put(j6.f20732fb, "chat_outReplyMediaMessageSelectedText");
        sparseArray.put(j6.bd, "chat_stickerReplyMessageText");
        sparseArray.put(j6.f20679cd, "chat_inPreviewLine");
        sparseArray.put(j6.f20750gb, "chat_outPreviewLine");
        sparseArray.put(j6.f20698dd, "chat_inSiteNameText");
        sparseArray.put(j6.f20767hb, "chat_outSiteNameText");
        sparseArray.put(j6.f20716ed, "chat_inContactNameText");
        sparseArray.put(j6.f20786ib, "chat_outContactNameText");
        sparseArray.put(j6.f20734fd, "chat_inContactPhoneText");
        sparseArray.put(j6.f20751gd, "chat_inContactPhoneSelectedText");
        sparseArray.put(j6.f20804jb, "chat_outContactPhoneText");
        sparseArray.put(j6.f20824kb, "chat_outContactPhoneSelectedText");
        sparseArray.put(j6.f20769hd, "chat_mediaProgress");
        sparseArray.put(j6.f20788id, "chat_inAudioProgress");
        sparseArray.put(j6.f20930qb, "chat_outAudioProgress");
        sparseArray.put(j6.f20806jd, "chat_inAudioSelectedProgress");
        sparseArray.put(j6.f20949rb, "chat_outAudioSelectedProgress");
        sparseArray.put(j6.f20826kd, "chat_mediaTimeText");
        sparseArray.put(j6.f20844ld, "chat_adminText");
        sparseArray.put(j6.f20862md, "chat_adminSelectedText");
        sparseArray.put(j6.f20894ob, "chat_outAdminText");
        sparseArray.put(j6.f20912pb, "chat_outAdminSelectedText");
        sparseArray.put(j6.f20879nd, "chat_inTimeText");
        sparseArray.put(j6.f20968sb, "chat_outTimeText");
        sparseArray.put(j6.f20896od, "chat_inTimeSelectedText");
        sparseArray.put(j6.nb, "chat_outTimeSelectedText");
        sparseArray.put(j6.f20914pd, "chat_inAudioPerfomerText");
        sparseArray.put(j6.f20932qd, "chat_inAudioPerfomerSelectedText");
        sparseArray.put(j6.f20842lb, "chat_outAudioPerfomerText");
        sparseArray.put(j6.f20860mb, "chat_outAudioPerfomerSelectedText");
        sparseArray.put(j6.f20951rd, "chat_inAudioTitleText");
        sparseArray.put(j6.f20986tb, "chat_outAudioTitleText");
        sparseArray.put(j6.f20970sd, "chat_inAudioDurationText");
        sparseArray.put(j6.f21005ub, "chat_outAudioDurationText");
        sparseArray.put(j6.f20988td, "chat_inAudioDurationSelectedText");
        sparseArray.put(j6.f21022vb, "chat_outAudioDurationSelectedText");
        sparseArray.put(j6.f21007ud, "chat_inAudioSeekbar");
        sparseArray.put(j6.f21024vd, "chat_inAudioCacheSeekbar");
        sparseArray.put(j6.f21041wb, "chat_outAudioSeekbar");
        sparseArray.put(j6.f21058xb, "chat_outAudioCacheSeekbar");
        sparseArray.put(j6.f21042wd, "chat_inAudioSeekbarSelected");
        sparseArray.put(j6.f21075yb, "chat_outAudioSeekbarSelected");
        sparseArray.put(j6.f21059xd, "chat_inAudioSeekbarFill");
        sparseArray.put(j6.f21094zb, "chat_outAudioSeekbarFill");
        sparseArray.put(j6.f21077yd, "chat_inVoiceSeekbar");
        sparseArray.put(j6.Ab, "chat_outVoiceSeekbar");
        sparseArray.put(j6.f21096zd, "chat_inVoiceSeekbarSelected");
        ...
        sparseArray.put(j6.f20642ae, "key_chat_messagePanelVoiceLockBackground");
        sparseArray.put(j6.f20661be, "key_chat_messagePanelVoiceLockShadow");
        sparseArray.put(j6.f20680ce, "chat_topPanelBackground");
        sparseArray.put(j6.f20699de, "chat_topPanelClose");
        sparseArray.put(j6.f20717ee, "chat_topPanelLine");
        sparseArray.put(j6.fe, "chat_topPanelTitle");
        sparseArray.put(j6.f20752ge, "chat_topPanelMessage");
        sparseArray.put(j6.f20770he, "chat_addContact");
        sparseArray.put(j6.f20789ie, "chat_inLoader");
        sparseArray.put(j6.f20807je, "chat_inLoaderSelected");
        sparseArray.put(j6.Nb, "chat_outLoader");
        sparseArray.put(j6.Ob, "chat_outLoaderSelected");
        sparseArray.put(j6.f20827ke, "chat_inLoaderPhoto");
        sparseArray.put(j6.f20845le, "chat_mediaLoaderPhoto");
        sparseArray.put(j6.f20863me, "chat_mediaLoaderPhotoSelected");
        sparseArray.put(j6.ne, "chat_mediaLoaderPhotoIcon");
        sparseArray.put(j6.f20897oe, "chat_mediaLoaderPhotoIconSelected");
        sparseArray.put(j6.f20915pe, "chat_inLocationBackground");
        sparseArray.put(j6.f20933qe, "chat_inLocationIcon");
        sparseArray.put(j6.Pb, "chat_outLocationIcon");
        sparseArray.put(j6.f20952re, "chat_inContactBackground");
        sparseArray.put(j6.f20971se, "chat_inContactIcon");
        sparseArray.put(j6.Qb, "chat_outContactBackground");
        sparseArray.put(j6.Rb, "chat_outContactIcon");
        sparseArray.put(j6.f20989te, "chat_replyPanelIcons");
        sparseArray.put(j6.f21008ue, "chat_replyPanelClose");
        sparseArray.put(j6.f21025ve, "chat_replyPanelName");
        sparseArray.put(j6.f21043we, "chat_replyPanelLine");
        sparseArray.put(j6.f21060xe, "chat_searchPanelIcons");
        sparseArray.put(j6.f21078ye, "chat_searchPanelText");
        sparseArray.put(j6.f21097ze, "chat_secretChatStatusText");
        ...
        sparseArray.put(j6.f20643af, "chat_emojiPanelNewTrending");
        sparseArray.put(j6.f20662bf, "chat_messagePanelVoicePressed");
        sparseArray.put(j6.f20681cf, "chat_messagePanelVoiceBackground");
        sparseArray.put(j6.f20700df, "chat_messagePanelVoiceDelete");
        sparseArray.put(j6.f20718ef, "chat_messagePanelVoiceDuration");
        sparseArray.put(j6.f20735ff, "chat_recordedVoicePlayPause");
        sparseArray.put(j6.f20753gf, "chat_recordedVoiceProgress");
        sparseArray.put(j6.hf, "chat_recordedVoiceProgressInner");
        sparseArray.put(j6.f20808jf, "chat_recordedVoiceDot");
        sparseArray.put(j6.f20828kf, "chat_recordedVoiceBackground");
        sparseArray.put(j6.f20846lf, "chat_recordedVoiceDarkerBackground");
        sparseArray.put(j6.f20864mf, "chat_recordVoiceCancel");
        sparseArray.put(j6.f20880nf, "chat_recordTime");
        sparseArray.put(j6.f20898of, "chat_messagePanelCancelInlineBot");
        sparseArray.put(j6.f20916pf, "chat_gifSaveHintText");
        sparseArray.put(j6.f20934qf, "chat_gifSaveHintBackground");
        sparseArray.put(j6.f20953rf, "chat_goDownButton");
        sparseArray.put(j6.f20972sf, "chat_goDownButtonCounter");
        sparseArray.put(j6.f20990tf, "chat_goDownButtonCounterBackground");
        sparseArray.put(j6.Vb, "chat_outTextSelectionHighlight");
        sparseArray.put(j6.f21009uf, "chat_inTextSelectionHighlight");
        sparseArray.put(j6.f21026vf, "chat_TextSelectionCursor");
        ...
        sparseArray.put(j6.f21061xf, "chat_BlurAlpha");
        sparseArray.put(j6.f21079yf, "chat_BlurAlphaSlow");
        sparseArray.put(j6.f21098zf, "chat_editMediaButton");
        ...
        sparseArray.put(j6.f20644ag, "chat_msgIvButtonSuccessOutText");
        sparseArray.put(j6.f20663bg, "chat_msgIvButtonDefaultInlineOut");
        sparseArray.put(j6.f20682cg, "chat_msgIvButtonDefaultInlineOutPressed");
        sparseArray.put(j6.f20701dg, "chat_msgIvButtonDefaultInlineOutText");
        sparseArray.put(j6.eg, "voipgroup_listSelector");
        sparseArray.put(j6.f20736fg, "voipgroup_inviteMembersBackground");
        sparseArray.put(j6.f20754gg, "voipgroup_actionBar");
        sparseArray.put(j6.f20771hg, "voipgroup_actionBarItems");
        sparseArray.put(j6.f20790ig, "voipgroup_actionBarItemsSelector");
        sparseArray.put(j6.f20809jg, "voipgroup_actionBarUnscrolled");
        sparseArray.put(j6.f20829kg, "voipgroup_listViewBackgroundUnscrolled");
        sparseArray.put(j6.f20847lg, "voipgroup_lastSeenTextUnscrolled");
        sparseArray.put(j6.f20865mg, "voipgroup_mutedIconUnscrolled");
        sparseArray.put(j6.f20881ng, "voipgroup_nameText");
        sparseArray.put(j6.f20899og, "voipgroup_lastSeenText");
        sparseArray.put(j6.f20917pg, "voipgroup_listeningText");
        sparseArray.put(j6.f20935qg, "voipgroup_speakingText");
        sparseArray.put(j6.f20954rg, "voipgroup_mutedIcon");
        sparseArray.put(j6.f20973sg, "voipgroup_mutedByAdminIcon");
        sparseArray.put(j6.f20991tg, "voipgroup_listViewBackground");
        sparseArray.put(j6.f21010ug, "voipgroup_dialogBackground");
        sparseArray.put(j6.f21027vg, "voipgroup_leaveCallMenu");
        sparseArray.put(j6.f21044wg, "voipgroup_checkMenu");
        sparseArray.put(j6.f21062xg, "voipgroup_soundButton");
        sparseArray.put(j6.f21080yg, "voipgroup_soundButtonActive");
        sparseArray.put(j6.f21099zg, "voipgroup_soundButtonActiveScrolled");
        ...
        sparseArray.put(j6.f20645ah, "voipgroup_topPanelBlue2");
        sparseArray.put(j6.f20664bh, "voipgroup_topPanelGray");
        sparseArray.put(j6.f20683ch, "voipgroup_overlayAlertGradientMuted");
        sparseArray.put(j6.f20702dh, "voipgroup_overlayAlertGradientMuted2");
        sparseArray.put(j6.f20719eh, "voipgroup_overlayAlertGradientUnmuted");
        sparseArray.put(j6.f20737fh, "voipgroup_overlayAlertGradientUnmuted2");
        sparseArray.put(j6.f20755gh, "voipgroup_overlayAlertMutedByAdmin");
        sparseArray.put(j6.f20772hh, "voipgroup_overlayAlertMutedByAdmin2");
        sparseArray.put(j6.f20791ih, "voipgroup_mutedByAdminGradient");
        sparseArray.put(j6.f20810jh, "voipgroup_mutedByAdminGradient2");
        sparseArray.put(j6.f20830kh, "voipgroup_mutedByAdminGradient3");
        sparseArray.put(j6.f20848lh, "voipgroup_mutedByAdminMuteButton");
        sparseArray.put(j6.f20866mh, "voipgroup_mutedByAdminMuteButtonDisabled");
        sparseArray.put(j6.f20882nh, "voipgroup_windowBackgroundWhiteInputField");
        sparseArray.put(j6.f20900oh, "voipgroup_windowBackgroundWhiteInputFieldActivated");
        sparseArray.put(j6.f20955rh, "passport_authorizeBackground");
        sparseArray.put(j6.f20974sh, "passport_authorizeBackgroundSelected");
        sparseArray.put(j6.f20992th, "passport_authorizeText");
        sparseArray.put(j6.f21011uh, "profile_creatorIcon");
        sparseArray.put(j6.Ch, "chat_tagAdmin");
        sparseArray.put(j6.Dh, "chat_tagCreator");
        sparseArray.put(j6.f21028vh, "profile_title");
        sparseArray.put(j6.f21045wh, "profile_actionIcon");
        sparseArray.put(j6.f21063xh, "profile_actionBackground");
        sparseArray.put(j6.f21081yh, "profile_actionPressedBackground");
        sparseArray.put(j6.f21100zh, "profile_verifiedBackground");
        ...
        sparseArray.put(j6.f21057xa, "buttonNeutral");
        sparseArray.put(j6.f21074ya, "buttonNeutralText");
        ...
        sparseArray.put(j6.f20646ai, "groupcreate_sectionText");
        sparseArray.put(j6.f20665bi, "groupcreate_spanText");
        sparseArray.put(j6.f20684ci, "groupcreate_spanBackground");
        sparseArray.put(j6.f20703di, "groupcreate_spanDelete");
        sparseArray.put(j6.f20720ei, "contacts_inviteBackground");
        sparseArray.put(j6.f20738fi, "contacts_inviteText");
        sparseArray.put(j6.f20756gi, "login_progressInner");
        sparseArray.put(j6.f20773hi, "login_progressOuter");
        sparseArray.put(j6.f20792ii, "picker_enabledButton");
        sparseArray.put(j6.f20811ji, "picker_disabledButton");
        sparseArray.put(j6.f20831ki, "picker_badge");
        ...
        sparseArray.put(j6.f20634a6, "dialogCardShadow");
        sparseArray.put(j6.f20654b6, "dialogGiftsBackground");
        sparseArray.put(j6.f20673c6, "dialogGiftsTabText");
    ...
    public static int[] e() {
        int[] iArr = new int[j6.f20727f5];
        iArr[j6.f20745g5] = 0;
        iArr[j6.f20762h5] = -1;
        iArr[j6.f20780i5] = -986896;
        iArr[j6.f20798j5] = -15065823;
        iArr[j6.f20818k5] = -14255946;
        iArr[j6.f20836l5] = 862104035;
        iArr[j6.f20854m5] = -13660983;
        iArr[j6.f20873n5] = -12937771;
        iArr[j6.f20889o5] = -15095832;
        iArr[j6.p5] = -13333567;
        iArr[j6.f20925q5] = -9079435;
        iArr[j6.f20943r5] = -6710887;
        iArr[j6.f20962s5] = -5000269;
        iArr[j6.f20981t5] = -6842473;
        iArr[j6.J5] = -15065823;
        iArr[j6.K5] = -2960686;
        iArr[j6.L5] = -14054705;
        iArr[j6.f20999u5] = -2368549;
        iArr[j6.f21017v5] = -14509328;
        iArr[j6.f21035w5] = -14509328;
        iArr[j6.f21052x5] = -1;
        iArr[j6.f21069y5] = -9211021;
        iArr[j6.f21088z5] = -5197648;
        iArr[j6.D5] = -5000269;
        iArr[j6.E5] = -14509328;
        iArr[j6.F5] = -11371101;
        iArr[j6.G5] = -2368549;
        ...
        iArr[j6.Y5] = -1743531;
        iArr[j6.Z5] = -1352098;
        iArr[j6.f20634a6] = 385875968;
        iArr[j6.f20654b6] = -657673;
        iArr[j6.f20673c6] = -11118244;
        iArr[j6.Ki] = -855310;
        iArr[j6.Li] = -12147470;
        iArr[j6.Mi] = -3389625;
        iArr[j6.Vk] = -9538955;
        ...
        iArr[j6.f20691d6] = -1;
        iArr[j6.f20711e6] = -6905171;
        iArr[j6.f20728f6] = -14509328;
        iArr[j6.f20746g6] = -1;
        iArr[j6.f20763h6] = -14904349;
        iArr[j6.f20855m6] = -15065823;
        iArr[j6.f20874n6] = -12545331;
        iArr[j6.f20890o6] = -12937771;
        iArr[j6.f20907p6] = -14255946;
        iArr[j6.q6] = -14904349;
        iArr[j6.f20944r6] = -11759926;
        iArr[j6.f20963s6] = -12940081;
        iArr[j6.f20982t6] = -13141330;
        iArr[j6.f21000u6] = -14776109;
        iArr[j6.f21018v6] = -13132315;
        iArr[j6.f21036w6] = -14248148;
        iArr[j6.f21053x6] = -13129704;
        iArr[j6.f20908p7] = -3397335;
        iArr[j6.f20926q7] = -3389625;
        iArr[j6.f20945r7] = -1352098;
        iArr[j6.f21070y6] = -8354940;
        iArr[j6.f21089z6] = -8223094;
        iArr[j6.A6] = -6710887;
        iArr[j6.B6] = -8355712;
        iArr[j6.C6] = -6052957;
        iArr[j6.D6] = -9079435;
        ...
        iArr[j6.L6] = -14054705;
        iArr[j6.f20819k6] = -2368549;
        iArr[j6.f20837l6] = -14509328;
        iArr[j6.M6] = -5853773;
        iArr[j6.N6] = -14509328;
        iArr[j6.O6] = -8879478;
        iArr[j6.P6] = -15697468;
        ...
        iArr[j6.Y6] = -9211021;
        iArr[j6.Z6] = -5197648;
        iArr[j6.f20781i6] = 251658240;
        iArr[j6.f20799j6] = 486539280;
        iArr[j6.f20747g7] = -5000269;
        iArr[j6.f20764h7] = -14509328;
        iArr[j6.f20635a7] = -921101;
        iArr[j6.f20655b7] = -16777216;
        iArr[j6.f20674c7] = -9209733;
        iArr[j6.f20692d7] = -2500135;
        iArr[j6.e7] = -657931;
        iArr[j6.f7] = -8222838;
        iArr[j6.B7] = -4202506;
        iArr[j6.C7] = -13920542;
        ...
        iArr[j6.H7] = -3486256;
        iArr[j6.I7] = -13683656;
        iArr[j6.f20838l7] = -14509328;
        iArr[j6.f20856m7] = -3551791;
        iArr[j6.f20875n7] = -1;
        iArr[j6.f20891o7] = -7301735;
        iArr[j6.J7] = -1;
        iArr[j6.K7] = -9847303;
        iArr[j6.L7] = -12541983;
        iArr[j6.M7] = -4668724;
        ...
        iArr[j6.Z7] = -13264172;
        iArr[j6.T7] = -10702854;
        iArr[j6.f20636a8] = -12547377;
        iArr[j6.U7] = -30036;
        iArr[j6.f20656b8] = -2534028;
        iArr[j6.f20675c8] = -6181963;
        iArr[j6.f20693d8] = -1;
        iArr[j6.f20712e8] = -657931;
        iArr[j6.f20765h8] = -15065823;
        iArr[j6.f20729f8] = 303701281;
        iArr[j6.f20748g8] = -15065823;
        iArr[j6.f20783i8] = -3387319;
        iArr[j6.f20801j8] = -2722014;
        iArr[j6.f20821k8] = -6988581;
        iArr[j6.f20839l8] = -12539616;
        iArr[j6.f20857m8] = -13590854;
        iArr[j6.f20876n8] = -13202735;
        iArr[j6.f20892o8] = -3714933;
        iArr[j6.f20965s8] = -1;
        iArr[j6.f21020v8] = -15065823;
        iArr[j6.f21038w8] = -1;
        iArr[j6.f21055x8] = 268435456;
        iArr[j6.f21072y8] = -15065823;
        iArr[j6.A8] = -15065823;
        iArr[j6.B8] = -8814210;
        iArr[j6.f20984t8] = 303701281;
        iArr[j6.f21002u8] = 303701281;
        iArr[j6.C8] = -15065823;
        iArr[j6.D8] = -8814210;
        iArr[j6.E8] = -15065823;
        iArr[j6.F8] = -15065823;
        iArr[j6.G8] = -1;
        iArr[j6.H8] = -657931;
        iArr[j6.f21091z8] = -1907998;
        iArr[j6.f21004ua] = -986896;
        iArr[j6.f21021va] = -8223094;
        iArr[j6.f21040wa] = -4144960;
        iArr[j6.I8] = -14054705;
        iArr[j6.J8] = -8946561;
        iArr[j6.K8] = -14054705;
        iArr[j6.T9] = -10048031;
        ...
        iArr[j6.S8] = -1;
        iArr[j6.f20918ph] = -526345;
        iArr[j6.f20936qh] = -2039584;
        iArr[j6.M8] = -1;
        ...
        iArr[j6.V8] = -4275257;
        iArr[j6.W8] = -1;
        iArr[j6.f20676c9] = -14509328;
        iArr[j6.f20694d9] = -6313293;
        iArr[j6.f20713e9] = -1;
        iArr[j6.f20730f9] = -1;
        iArr[j6.X8] = -15065823;
        iArr[j6.Y8] = -15065823;
        iArr[j6.Z8] = -16734706;
        iArr[j6.f20637a9] = -15093466;
        iArr[j6.f20657b9] = -7236972;
        iArr[j6.f20749g9] = -9078662;
        iArr[j6.f20766h9] = -7237231;
        iArr[j6.f20784i9] = -7434095;
        iArr[j6.f20802j9] = -2274503;
        iArr[j6.f20822k9] = -14054705;
        iArr[j6.f20840l9] = -7631473;
        iArr[j6.f20858m9] = -12434359;
        iArr[j6.f20877n9] = -10592674;
        iArr[j6.o9] = -14054705;
        iArr[j6.f20910p9] = -14054705;
        iArr[j6.f20928q9] = -8092024;
        iArr[j6.f20947r9] = -7236715;
        iArr[j6.f20966s9] = 134217728;
        iArr[j6.f20985t9] = 251658240;
        iArr[j6.f21003u9] = -12146122;
        iArr[j6.v9] = -12146122;
        iArr[j6.f21039w9] = -9061026;
        iArr[j6.f21056x9] = -2796974;
        iArr[j6.f21073y9] = -1;
        iArr[j6.f21092z9] = -13391642;
        iArr[j6.A9] = -1;
        iArr[j6.B9] = -4341308;
        iArr[j6.C9] = -1;
        iArr[j6.F9] = -1;
        ...
        iArr[j6.Y9] = -13391883;
        iArr[j6.Z9] = -7169634;
        iArr[j6.f20638aa] = -13421773;
        iArr[j6.f20658ba] = -1945520;
        iArr[j6.f20677ca] = -9472134;
        iArr[j6.f20695da] = -3355444;
        iArr[j6.f20785ia] = -1;
        iArr[j6.f20803ja] = -12214795;
        iArr[j6.f20823ka] = -1351584;
        iArr[j6.f20841la] = -868277;
        iArr[j6.f20859ma] = -2121728;
        iArr[j6.f20878na] = -10436011;
        iArr[j6.f20893oa] = -868277;
        iArr[j6.f20714ea] = -10436011;
        iArr[j6.f20731fa] = -10436011;
        iArr[j6.ga] = -1351584;
        iArr[j6.ha] = -1351584;
        iArr[j6.f20911pa] = -14054705;
        iArr[j6.f20929qa] = -16725933;
        iArr[j6.Ia] = -16725933;
        iArr[j6.f20913pc] = -14540254;
        iArr[j6.f20895oc] = -8814210;
        iArr[j6.f20948ra] = -1;
        iArr[j6.f20697dc] = -1247235;
        iArr[j6.ta] = -14862509;
        iArr[j6.Aa] = -1048610;
        iArr[j6.f20660bc] = 335544320;
        iArr[j6.Ba] = -2492475;
        iArr[j6.Ca] = -14781172;
        iArr[j6.f21006uc] = -1;
        iArr[j6.f21023vc] = -1050370;
        iArr[j6.Pa] = -1048610;
        iArr[j6.Qa] = -1967921;
        iArr[j6.ec] = -16777216;
        iArr[j6.f20733fc] = -16777216;
        iArr[j6.gc] = -14255946;
        iArr[j6.f20768hc] = -14255946;
        iArr[j6.f20787ic] = -1;
        iArr[j6.f20805jc] = -1;
        iArr[j6.f20825kc] = -1;
        ...
        iArr[j6.Na] = -9061026;
        iArr[j6.Oa] = -9061026;
        iArr[j6.f20931qc] = -6182221;
        iArr[j6.f20950rc] = -7094838;
        iArr[j6.f20969sc] = -1;
        iArr[j6.f20987tc] = -1;
        iArr[j6.xc] = -6182221;
        iArr[j6.f21076yc] = -7094838;
        iArr[j6.Ra] = -9522601;
        iArr[j6.Sa] = -9522601;
        iArr[j6.f21095zc] = -1;
        iArr[j6.Ac] = -4801083;
        ...
        iArr[j6.Rc] = -1;
        iArr[j6.Uc] = -10903592;
        iArr[j6.f20639ab] = -9520791;
        iArr[j6.f20659bb] = -12539616;
        iArr[j6.Vc] = -1;
        iArr[j6.Wc] = -14054705;
        iArr[j6.cb] = -11162801;
        iArr[j6.Xc] = -1;
        iArr[j6.Yc] = -16777216;
        iArr[j6.f20696db] = -16777216;
        iArr[j6.Zc] = -6182221;
        iArr[j6.f20715eb] = -10112933;
        iArr[j6.f20641ad] = -7752511;
        iArr[j6.f20732fb] = -10112933;
        iArr[j6.bd] = -1;
        iArr[j6.f20679cd] = -9390872;
        iArr[j6.f20750gb] = -7812741;
        iArr[j6.f20698dd] = -14054705;
        iArr[j6.f20767hb] = -11162801;
        iArr[j6.f20716ed] = -11625772;
        iArr[j6.f20786ib] = -11162801;
        iArr[j6.f20734fd] = -13683656;
        iArr[j6.f20751gd] = -13683656;
        iArr[j6.f20804jb] = -13286860;
        iArr[j6.f20824kb] = -13286860;
        iArr[j6.f20769hd] = -1;
        iArr[j6.f20788id] = -1;
        iArr[j6.f20930qb] = -1048610;
        iArr[j6.f20806jd] = -1050370;
        iArr[j6.f20949rb] = -1967921;
        iArr[j6.f20826kd] = -1;
        iArr[j6.f20844ld] = -4143413;
        iArr[j6.f20862md] = -7752511;
        iArr[j6.f20894ob] = -9391780;
        iArr[j6.f20912pb] = -9391780;
        iArr[j6.f20879nd] = -6182221;
        iArr[j6.f20896od] = -7752511;
        iArr[j6.f20968sb] = -9391780;
        iArr[j6.nb] = -9391780;
        iArr[j6.f20914pd] = -13683656;
        iArr[j6.f20932qd] = -13683656;
        iArr[j6.f20842lb] = -13286860;
        iArr[j6.f20860mb] = -13286860;
        iArr[j6.f20951rd] = -11625772;
        iArr[j6.f20986tb] = -11162801;
        iArr[j6.f20970sd] = -6182221;
        iArr[j6.f21005ub] = -10112933;
        iArr[j6.f20988td] = -7752511;
        iArr[j6.f21022vb] = -10112933;
        iArr[j6.f21007ud] = -1774864;
        iArr[j6.f21024vd] = 1071966960;
        iArr[j6.f21041wb] = -4463700;
        iArr[j6.f21058xb] = 1069278124;
        iArr[j6.f21042wd] = -4399384;
        iArr[j6.f21075yb] = -5644906;
        iArr[j6.f21059xd] = -14509328;
        iArr[j6.f21094zb] = -8863118;
        iArr[j6.f21077yd] = -2169365;
        iArr[j6.Ab] = -4463700;
        iArr[j6.f21096zd] = -4399384;
        iArr[j6.Bb] = -5644906;
        iArr[j6.Ad] = -14509328;
        iArr[j6.Cb] = -8863118;
        iArr[j6.Bd] = -1314571;
        ...
        iArr[j6.Ee] = -11102772;
        iArr[j6.Fe] = -1;
        iArr[j6.f20915pe] = -1314571;
        iArr[j6.f20933qe] = -6113849;
        iArr[j6.Pb] = -7880840;
        iArr[j6.f20952re] = -14509328;
        iArr[j6.f20971se] = -1;
        iArr[j6.Qb] = -8863118;
        iArr[j6.Rb] = -1048610;
        iArr[j6.f21060xe] = -9999761;
        iArr[j6.f21078ye] = -9999761;
        iArr[j6.f21097ze] = -8421505;
        iArr[j6.Ae] = -14054705;
        iArr[j6.Be] = -1;
        iArr[j6.f20989te] = -14509328;
        iArr[j6.f21008ue] = -7432805;
        iArr[j6.f21025ve] = -14054705;
        iArr[j6.f21043we] = -1513240;
        iArr[j6.Sd] = -1;
        iArr[j6.Ud] = -16777216;
        iArr[j6.Vd] = -8025468;
        iArr[j6.Wd] = -11230757;
        ...
        iArr[j6.Xd] = -7432805;
        iArr[j6.f20735ff] = -1;
        iArr[j6.f20808jf] = -2468275;
        iArr[j6.f20828kf] = -10637848;
        iArr[j6.f20846lf] = -14710309;
        iArr[j6.f20753gf] = -5120257;
        iArr[j6.hf] = -1;
        iArr[j6.f20864mf] = -12937772;
        iArr[j6.Yd] = -14509328;
        iArr[j6.Zd] = -5987164;
        iArr[j6.f20642ae] = -1;
        iArr[j6.f20661be] = -16777216;
        iArr[j6.f20880nf] = -7432805;
        iArr[j6.f20643af] = -11688214;
        iArr[j6.f20916pf] = -1;
        iArr[j6.f20934qf] = -501273800;
        iArr[j6.f20953rf] = -1;
        iArr[j6.f20972sf] = -1;
        iArr[j6.f20990tf] = -14509328;
        iArr[j6.f20898of] = -5395027;
        iArr[j6.f20662bf] = -1;
        iArr[j6.f20681cf] = -14509328;
        iArr[j6.f20700df] = -9211021;
        iArr[j6.f20718ef] = -1;
        iArr[j6.Ge] = -11037236;
        iArr[j6.f20680ce] = -1;
        iArr[j6.f20699de] = -8288378;
        iArr[j6.f20717ee] = -12605201;
        iArr[j6.fe] = -14054705;
        iArr[j6.f20752ge] = -9011588;
        iArr[j6.f20770he] = -14054705;
        iArr[j6.f20789ie] = -14509328;
        iArr[j6.f20807je] = -10114080;
        iArr[j6.Nb] = -8863118;
        iArr[j6.Ob] = -9783964;
        iArr[j6.f20827ke] = -6113080;
        iArr[j6.f20845le] = 1711276032;
        iArr[j6.f20863me] = 2130706432;
        iArr[j6.ne] = -1;
        iArr[j6.f20897oe] = -2500135;
        iArr[j6.nc] = 553648127;
        iArr[j6.Sc] = -12215336;
        iArr[j6.Tc] = -9783200;
        iArr[j6.f21011uh] = -12937771;
        iArr[j6.f21045wh] = -8288630;
        iArr[j6.f21063xh] = -1;
        iArr[j6.f21081yh] = 303701281;
        iArr[j6.f21100zh] = -14509328;
        iArr[j6.Ah] = -1;
        iArr[j6.f21028vh] = -14540254;
        iArr[j6.Bh] = -14540254;
        iArr[j6.Ch] = -12539616;
        iArr[j6.Dh] = -6988581;
        iArr[j6.Eh] = -7893872;
        ...
        iArr[j6.Bi] = -1;
        iArr[j6.Ci] = -6908266;
        iArr[j6.f20955rh] = -12211217;
        iArr[j6.f20974sh] = -12542501;
        iArr[j6.f20992th] = -1;
        iArr[j6.mi] = -12149258;
        iArr[j6.ni] = -1;
        iArr[j6.oi] = -14906664;
        ...
        iArr[j6.Sh] = -1;
        iArr[j6.Th] = -11688214;
        iArr[j6.f21057xa] = -1776412;
        iArr[j6.f21074ya] = -15065823;
        iArr[j6.f20983t7] = -15065823;
        iArr[j6.f21001u7] = -15065823;
        iArr[j6.f21019v7] = -1;
        iArr[j6.f21037w7] = -14509328;
        iArr[j6.f21054x7] = -7763066;
        iArr[j6.f21071y7] = -12279325;
        iArr[j6.f21090z7] = -6445135;
        iArr[j6.A7] = -1;
        iArr[j6.Ih] = -13196562;
        iArr[j6.Jh] = -986123;
        iArr[j6.Kh] = -4735293;
        iArr[j6.Lh] = -1182729;
        iArr[j6.f20782i7] = -10567099;
        iArr[j6.f20820k7] = -1;
        iArr[j6.f20800j7] = -5195326;
        iArr[j6.Uh] = -4801083;
        ...
        iArr[j6.Yh] = -11361317;
        iArr[j6.Zh] = -16777216;
        iArr[j6.f20646ai] = -8617336;
        iArr[j6.f20665bi] = -14540254;
        iArr[j6.f20684ci] = -855310;
        iArr[j6.f20703di] = -1;
        iArr[j6.f20720ei] = -11157919;
        iArr[j6.f20738fi] = -1;
        iArr[j6.f20756gi] = -1971470;
        iArr[j6.f20773hi] = -10313520;
        iArr[j6.f20792ii] = -15095832;
        iArr[j6.f20811ji] = -6710887;
        iArr[j6.f20831ki] = -14043401;
        iArr[j6.li] = -1;
        iArr[j6.Ce] = -12348980;
        ...
        iArr[j6.f21009uf] = 1348643299;
        iArr[j6.f21026vf] = -12476440;
        iArr[j6.Wb] = -12476440;
        iArr[j6.Xb] = 506491665;
        iArr[j6.wf] = 508584819;
        iArr[j6.f21061xf] = -1308622848;
        iArr[j6.f21079yf] = -1056964608;
        iArr[j6.f21098zf] = -15033089;
        iArr[j6.Af] = -1184275;
        iArr[j6.Bf] = -1184275;
        iArr[j6.Cf] = -15065823;
        iArr[j6.Df] = -14509328;
        ...
        iArr[j6.Yf] = -2296629;
        iArr[j6.Zf] = -2296629;
        iArr[j6.f20644ag] = -12539616;
        iArr[j6.f20663bg] = -2296629;
        iArr[j6.f20682cg] = -2296629;
        iArr[j6.f20701dg] = -11293879;
        ...
        iArr[j6.Qg] = -8024684;
        iArr[j6.Rg] = -13616313;
        iArr[j6.f21027vg] = -35467;
        iArr[j6.Pg] = -13023660;
        iArr[j6.f21062xg] = 2100052301;
        iArr[j6.f21080yg] = 2099422443;
        iArr[j6.f21099zg] = -2110540545;
        ...
        iArr[j6.Ig] = -11297032;
        iArr[j6.Jg] = -10038021;
        iArr[j6.f20809jg] = -15130842;
        iArr[j6.f20829kg] = -14538189;
        iArr[j6.f20847lg] = -8024684;
        iArr[j6.f20865mg] = -8485236;
        iArr[j6.f20754gg] = -15789289;
        iArr[j6.f20771hg] = -1;
        iArr[j6.f20790ig] = 515562495;
        iArr[j6.f20973sg] = -36752;
        iArr[j6.f20954rg] = -9471616;
        iArr[j6.f20899og] = -8813686;
        iArr[j6.f20881ng] = -1;
        iArr[j6.f20991tg] = -14933463;
        iArr[j6.f21010ug] = -14933463;
        iArr[j6.f20917pg] = -11683585;
        iArr[j6.f20935qg] = -8917379;
        iArr[j6.eg] = 251658239;
        iArr[j6.f20736fg] = -14538189;
        iArr[j6.Vg] = -13906177;
        iArr[j6.Wg] = -16156957;
        iArr[j6.Tg] = -15551198;
        iArr[j6.Ug] = -16722239;
        iArr[j6.Zg] = -10434565;
        iArr[j6.f20645ah] = -11427847;
        iArr[j6.Xg] = -11350435;
        iArr[j6.Yg] = -16731712;
        iArr[j6.f20664bh] = -8021590;
        iArr[j6.f20683ch] = -14455406;
        iArr[j6.f20702dh] = -13873813;
        iArr[j6.f20719eh] = -15955316;
        iArr[j6.f20737fh] = -14136203;
        iArr[j6.f20791ih] = -11033346;
        iArr[j6.f20810jh] = -1026983;
        iArr[j6.f20830kh] = -9015575;
        iArr[j6.f20755gh] = -9998178;
        iArr[j6.f20772hh] = -13676424;
        iArr[j6.f20848lh] = 2138612735;
        iArr[j6.f20866mh] = 863544319;
        iArr[j6.f20882nh] = -2368549;
        iArr[j6.f20900oh] = -14509328;
        iArr[j6.Sb] = -8863118;
        iArr[j6.Cj] = -14509328;
        iArr[j6.Ej] = -14054705;
        iArr[j6.Dj] = -11162801;
    ...
    public static int s(String str) {
        ...
        if (((Integer) f20498e.get(str)) == null) {
            return -1;
        }
        return ((Integer) f20498e.get(str)).intValue();
    }
