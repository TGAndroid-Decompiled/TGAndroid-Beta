...
public abstract class d3 extends FrameLayout {
    ...
    public final f3 G;
    public VelocityTracker f18579a;
    public int f18580b;
    public int f18581c;
    public int d;
    public boolean e;
    ...
    public final b2.q0 f18583n;
    public final Rect f18584r;
    public final Paint f18585s;
    public boolean v;
    public int f18586w;
    public float f18587x;
    public float f18588y;
    ...
    public d3(f3 f3Var, Context context) {
        ...
        this.f18582f = false;
        this.h = null;
        this.f18584r = new Rect();
        this.f18585s = new Paint();
        this.f18587x = 0.0f;
        this.f18588y = 0.0f;
        this.F = new Paint(1);
        this.f18583n = new Object();
    ...
    public final void b(float f7, float f10) {
        ...
        this.h.setInterpolator(qr.f27423f);
        ...
        if (!z11) {
            if (!f3Var.onContainerTouchEvent(motionEvent)) {
                if (!f3Var.canSwipeToBack(motionEvent) && !this.E) {
                    if (f3Var.canDismissWithTouchOutside() && motionEvent != null && ((motionEvent.getAction() == 0 || motionEvent.getAction() == 2) && !this.f18582f && !this.e && motionEvent.getPointerCount() == 1)) {
                        this.f18580b = (int) motionEvent.getX();
                        int y3 = (int) motionEvent.getY();
                        this.f18581c = y3;
                        if (f3Var.isTouchOutside(this.f18580b, y3)) {
                            f3Var.onDismissWithTouchOutside();
                            return true;
                        }
                        f3Var.onScrollUpBegin(this.f18587x);
                        this.d = motionEvent.getPointerId(0);
                        this.e = true;
                        a();
                        VelocityTracker velocityTracker = this.f18579a;
                        ...
                        if (this.f18579a == null) {
                            this.f18579a = VelocityTracker.obtain();
                        }
                        float abs = Math.abs((int) (motionEvent.getX() - this.f18580b));
                        float y10 = ((int) motionEvent.getY()) - this.f18581c;
                        boolean onScrollUp = f3Var.onScrollUp(this.f18587x + y10);
                        this.f18579a.addMovement(motionEvent);
                        z13 = f3Var.disableScroll;
                        if (!z13 && this.e && !this.f18582f && y10 > 0.0f && y10 / 3.0f > Math.abs(abs)) {
                            float abs2 = Math.abs(y10);
                            i11 = f3Var.touchSlop;
                            if (abs2 >= i11) {
                                this.f18581c = (int) motionEvent.getY();
                                this.e = false;
                                this.f18582f = true;
                        ...
                        if (this.f18582f) {
                            float f7 = this.f18587x + y10;
                            this.f18587x = f7;
                            if (!onScrollUp) {
                                this.f18587x = Math.max(f7, 0.0f);
                            }
                            f3Var.containerView.setTranslationY(Math.max(this.f18587x, 0.0f));
                        ...
                        this.f18579a.computeCurrentVelocity(1000);
                        f3Var.onScrollUpEnd(this.f18587x);
                        if (!this.f18582f && this.f18587x <= 0.0f) {
                            this.e = false;
                        } else {
                            b(this.f18579a.getXVelocity(), this.f18579a.getYVelocity());
                        }
                        this.f18582f = false;
                        VelocityTracker velocityTracker2 = this.f18579a;
                ...
                } else if (motionEvent != null && ((motionEvent.getAction() == 0 || motionEvent.getAction() == 2) && !this.f18582f && !this.e && motionEvent.getPointerCount() == 1)) {
                    this.E = true;
                    this.f18580b = (int) motionEvent.getX();
                    this.f18581c = (int) motionEvent.getY();
                    this.d = motionEvent.getPointerId(0);
                    ...
                    float x10 = motionEvent.getX() - this.f18580b;
                    float y11 = motionEvent.getY() - this.f18581c;
                    if (this.f18579a == null) {
                        this.f18579a = VelocityTracker.obtain();
                    }
                    this.f18579a.addMovement(motionEvent);
                    z12 = f3Var.disableScroll;
                    if (!z12 && this.e && !this.f18582f && x10 > 0.0f && x10 / 3.0f > Math.abs(y11)) {
                    ...
                    float xVelocity = this.f18579a.getXVelocity();
                    float yVelocity = this.f18579a.getYVelocity();
                    if (this.f18588y < f3Var.containerView.getMeasuredWidth() / 3.0f && (xVelocity < 3500.0f || xVelocity < yVelocity)) {
                        float max = Math.max(this.f18588y, 0.0f);
                        this.f18588y = max;
                        ...
                        ValueAnimator ofFloat2 = ValueAnimator.ofFloat(this.f18588y, getMeasuredWidth());
                ...
                if ((z10 || !this.e) && !this.f18582f && (f3Var.canDismissWithSwipe() || f3Var.canSwipeToBack(motionEvent))) {
                }
            }
            return true;
        }
