...
public final class w5 extends Drawable {
    ...
    public final void draw(Canvas canvas) {
        ...
        switch (this.f22394a) {
            case 0:
                ...
                canvas.drawCircle(bounds.centerX(), bounds.centerY(), this.f22396c / 2.0f, (Paint) this.d);
                return;
            case 1:
                Rect bounds2 = getBounds();
                int i11 = this.f22396c;
                int i12 = this.f22395b;
                if (i12 == 7) {
                    ...
                    canvas.drawRoundRect((RectF) this.d, f10, f10, k6.f22047z);
                    return;
                }
                if (i12 != 1 && i12 != 6) {
                    if (i12 == 3) {
                ...
                canvas.drawCircle(bounds2.centerX(), bounds2.centerY(), i10, k6.f22047z);
                return;
            default:
    ...
    public int getIntrinsicHeight() {
        switch (this.f22394a) {
            case 0:
                return this.f22396c + this.f22395b;
            default:
