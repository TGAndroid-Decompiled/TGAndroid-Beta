...
public abstract class w5 {
    public static final int f19901a = h6.f19059d6;
    public static float[] f19902b;
    ...
    public static int b(int i10) {
        ...
        return Color.HSVToColor(127, f19902b);
    }
    ...
    public static org.telegram.ui.Cells.z c(v5 v5Var, int i10) {
        ...
        drawable.f19890b = -1.0f;
        if (v5.f19888c == null) {
            Paint paint = new Paint(1);
            v5.f19888c = paint;
            paint.setColor(-1);
        }
        drawable.f19889a = v5.f19888c;
