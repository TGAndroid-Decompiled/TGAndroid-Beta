...
public final class u4 extends ListView {
    public final v4 f19789a;
    public final LinearGradient f19790b;
    public final Paint f19791c;
    ...
    public u4(v4 v4Var) {
        super(v4Var.f19829a);
        int[] iArr = new int[8];
        PathInterpolator pathInterpolator = yf.y.f47174i;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (z10) {
            canvas.drawRect(0.0f, 0.0f, getWidth(), AndroidUtilities.dp(16.0f), this.f19791c);
        }
        if (z11) {
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        this.f19790b.setLocalMatrix(matrix);
    }
}
