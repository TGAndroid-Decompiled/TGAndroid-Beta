...
public final class u4 extends ListView {
    public final v4 f19570a;
    public final LinearGradient f19571b;
    ...
    public u4(v4 v4Var) {
        super(v4Var.f19610a);
        int[] iArr = new int[8];
        PathInterpolator pathInterpolator = yf.y.f46872i;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (z10) {
            canvas.drawRect(0.0f, 0.0f, getWidth(), AndroidUtilities.dp(16.0f), this.f19572c);
        }
        if (z11) {
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        this.f19571b.setLocalMatrix(matrix);
    }
}
