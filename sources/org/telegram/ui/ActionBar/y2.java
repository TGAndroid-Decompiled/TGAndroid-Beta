...
public final class y2 extends FrameLayout {
    public final org.telegram.ui.Components.y5 f19689a;
    public final ImageView f19690b;
    public final ImageView f19691c;
    public final int d;
    public boolean e;
    ...
    public y2(Context context, int i10, d6 d6Var) {
        ...
        this.f19691c = imageView2;
        imageView2.setScaleType(scaleType);
        imageView2.setColorFilter(new PorterDuffColorFilter(h6.v0(h6.f18861h7, d6Var), PorterDuff.Mode.SRC_IN));
        if (LocaleController.isRTL) {
            i12 = 3;
        } else {
            i12 = 5;
        ...
        if (i10 != 0 && i10 != 4) {
            if (i10 == 1) {
                y5Var.setGravity(17);
                y5Var.setTextColor(h6.v0(h6.f18895j5, d6Var));
    ...
    public final void a(CharSequence charSequence, int i10, Drawable drawable, boolean z10) {
        ...
        int i11;
        float f11;
        org.telegram.ui.Components.y5 y5Var = this.f19689a;
    ...
    public void setChecked(boolean z10) {
        ...
        this.f19691c.setImageResource(i10);
    }

    public void setGravity(int i10) {
        this.f19689a.setGravity(i10);
    }

    public void setIconColor(int i10) {
        this.f19690b.setColorFilter(new PorterDuffColorFilter(i10, PorterDuff.Mode.MULTIPLY));
    }

    public void setTextColor(int i10) {
        this.f19689a.setTextColor(i10);
    }
}
