...
public abstract class k5 extends TextView {
    ...
    public final org.telegram.ui.Components.e6 f21164b;
    public final sp f21165c;

    public k5(Context context) {
        super(context);
        this.f21163a = false;
        this.f21164b = new org.telegram.ui.Components.e6(this, 320L, pr.h);
        this.f21165c = new sp(-1);
    }

    @Override
    public final void onDraw(Canvas canvas) {
        Canvas canvas2;
        float e7 = this.f21164b.e(this.f21163a);
        if (e7 < 1.0f) {
            if (e7 <= 0.0f) {
                canvas.save();
                canvas2 = canvas;
