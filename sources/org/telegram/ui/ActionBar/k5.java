...
public abstract class k5 extends TextView {
    ...
    public final org.telegram.ui.Components.c6 f19351b;
    public final tp f19352c;

    public k5(Context context) {
        super(context);
        this.f19350a = false;
        this.f19351b = new org.telegram.ui.Components.c6(this, 320L, qr.h);
        this.f19352c = new tp(-1);
    }

    @Override
    public final void onDraw(Canvas canvas) {
        Canvas canvas2;
        float e = this.f19351b.e(this.f19350a);
        if (e < 1.0f) {
            if (e <= 0.0f) {
                canvas.save();
                canvas2 = canvas;
