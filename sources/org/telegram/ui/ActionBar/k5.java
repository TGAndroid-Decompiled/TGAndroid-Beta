...
public abstract class k5 extends TextView {
    ...
    public final org.telegram.ui.Components.d6 f19587b;
    public final tp f19588c;

    public k5(Context context) {
        super(context);
        this.f19586a = false;
        this.f19587b = new org.telegram.ui.Components.d6(this, 320L, qr.h);
        this.f19588c = new tp(-1);
    }

    @Override
    public final void onDraw(Canvas canvas) {
        Canvas canvas2;
        float e = this.f19587b.e(this.f19586a);
        if (e < 1.0f) {
            if (e <= 0.0f) {
                canvas.save();
                canvas2 = canvas;
