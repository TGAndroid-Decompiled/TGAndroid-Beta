...
public final class f3 extends Drawable {
    public final Paint f18632a;
    public final Rect f18633b;
    public final Rect f18634c;
    ...
    public final void onBoundsChange(Rect rect) {
        ...
        Rect rect2 = this.f18634c;
        rect2.set(rect);
        int i10 = rect2.left;
        Rect rect3 = this.f18633b;
    ...
    public final void setAlpha(int i10) {
        this.f18632a.setAlpha(i10);
        invalidateSelf();
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f18632a.setColorFilter(colorFilter);
    }
}
