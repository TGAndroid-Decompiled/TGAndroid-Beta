...
public abstract class f3 extends FrameLayout {
    ...
    public final h3 D;
    public VelocityTracker f21347a;
    public int f21348b;
    public int f21349c;
    public int d;
    ...
    public final c5.e f21352n;
    public final Rect f21353r;
    public final Paint f21354s;
    public boolean v;
    public int f21355w;
    public float f21356x;
    ...
    public f3(h3 h3Var, Context context) {
        ...
        this.f21351f = false;
        this.h = null;
        this.f21353r = new Rect();
        this.f21354s = new Paint();
        this.f21356x = 0.0f;
        this.f21357y = 0.0f;
        this.C = new Paint(1);
        this.f21352n = new Object();
    ...
    public final void b(float f10, float f11) {
        ...
        this.h.setInterpolator(pr.f30183f);
        ...
        if (!z10) {
            if (!h3Var.onContainerTouchEvent(motionEvent)) {
                if (!h3Var.canSwipeToBack(motionEvent) && !this.B) {
                    if (h3Var.canDismissWithTouchOutside() && motionEvent != null && ((motionEvent.getAction() == 0 || motionEvent.getAction() == 2) && !this.f21351f && !this.f21350e && motionEvent.getPointerCount() == 1)) {
                        this.f21348b = (int) motionEvent.getX();
                        int y10 = (int) motionEvent.getY();
                        this.f21349c = y10;
                        if (h3Var.isTouchOutside(this.f21348b, y10)) {
                            h3Var.onDismissWithTouchOutside();
                            return true;
                        }
                        h3Var.onScrollUpBegin(this.f21356x);
                        this.d = motionEvent.getPointerId(0);
                        this.f21350e = true;
                        a();
                        VelocityTracker velocityTracker = this.f21347a;
                        ...
                        if (this.f21347a == null) {
                            this.f21347a = VelocityTracker.obtain();
                        }
                        float abs = Math.abs((int) (motionEvent.getX() - this.f21348b));
                        float y11 = ((int) motionEvent.getY()) - this.f21349c;
                        boolean onScrollUp = h3Var.onScrollUp(this.f21356x + y11);
                        this.f21347a.addMovement(motionEvent);
                        z12 = h3Var.disableScroll;
                        if (!z12 && this.f21350e && !this.f21351f && y11 > 0.0f && y11 / 3.0f > Math.abs(abs)) {
                            float abs2 = Math.abs(y11);
                            i11 = h3Var.touchSlop;
                            if (abs2 >= i11) {
                                this.f21349c = (int) motionEvent.getY();
                                this.f21350e = false;
                                this.f21351f = true;
                        ...
                        if (this.f21351f) {
                            float f10 = this.f21356x + y11;
                            this.f21356x = f10;
                            if (!onScrollUp) {
                                this.f21356x = Math.max(f10, 0.0f);
                            }
                            h3Var.containerView.setTranslationY(Math.max(this.f21356x, 0.0f));
                        ...
                        this.f21347a.computeCurrentVelocity(1000);
                        h3Var.onScrollUpEnd(this.f21356x);
                        if (!this.f21351f && this.f21356x <= 0.0f) {
                            this.f21350e = false;
                        } else {
                            b(this.f21347a.getXVelocity(), this.f21347a.getYVelocity());
                        }
                        this.f21351f = false;
                        VelocityTracker velocityTracker2 = this.f21347a;
                ...
                } else if (motionEvent != null && ((motionEvent.getAction() == 0 || motionEvent.getAction() == 2) && !this.f21351f && !this.f21350e && motionEvent.getPointerCount() == 1)) {
                    this.B = true;
                    this.f21348b = (int) motionEvent.getX();
                    this.f21349c = (int) motionEvent.getY();
                    this.d = motionEvent.getPointerId(0);
                    ...
                    float x10 = motionEvent.getX() - this.f21348b;
                    float y12 = motionEvent.getY() - this.f21349c;
                    if (this.f21347a == null) {
                        this.f21347a = VelocityTracker.obtain();
                    }
                    this.f21347a.addMovement(motionEvent);
                    z11 = h3Var.disableScroll;
                    if (!z11 && this.f21350e && !this.f21351f && x10 > 0.0f && x10 / 3.0f > Math.abs(y12)) {
                    ...
                    float xVelocity = this.f21347a.getXVelocity();
                    float yVelocity = this.f21347a.getYVelocity();
                    if (this.f21357y < h3Var.containerView.getMeasuredWidth() / 3.0f && (xVelocity < 3500.0f || xVelocity < yVelocity)) {
                        float max = Math.max(this.f21357y, 0.0f);
                        this.f21357y = max;
                        ...
                        ValueAnimator ofFloat2 = ValueAnimator.ofFloat(this.f21357y, getMeasuredWidth());
                ...
                if ((z4 || !this.f21350e) && !this.f21351f && (h3Var.canDismissWithSwipe() || h3Var.canSwipeToBack(motionEvent))) {
                }
            }
            return true;
        }
