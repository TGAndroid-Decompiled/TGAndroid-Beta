...
public abstract class i5 extends TextView {
    ...
    public final org.telegram.ui.Components.e6 f19469b;
    public final up f19470c;

    public i5(Context context) {
        super(context);
        this.f19468a = false;
        this.f19469b = new org.telegram.ui.Components.e6(this, 320L, rr.h);
        this.f19470c = new up(-1);
    }

    @Override
    public final void onDraw(Canvas canvas) {
        Canvas canvas2;
        float e = this.f19469b.e(this.f19468a);
        if (e < 1.0f) {
            if (e <= 0.0f) {
                canvas.save();
                canvas2 = canvas;
