...
public final class i5 extends Drawable {
    ...
    public final void draw(Canvas canvas) {
        switch (this.f19778a) {
            case 0:
                canvas.drawCircle(getBounds().centerX(), getBounds().centerY() - AndroidUtilities.dp(1.0f), (getBounds().width() - AndroidUtilities.dp(8.0f)) / 2.0f, this.f19779b);
                return;
            default:
                Paint paint = this.f19779b;
