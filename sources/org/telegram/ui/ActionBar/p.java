...
public final class p implements Runnable {
    ...
    public final void run() {
        ...
        switch (i10) {
            ...
            case 7:
                e2 e2Var = (e2) obj;
                e2Var.f18846f1.setVisibility(0);
                e2Var.f18848h1.setAlpha(0.0f);
                e2Var.f18847g1.startAnimation(AnimationUtils.loadAnimation(e2Var.getContext(), e2Var.f18844d1));
                e2Var.f18848h1.animate().setDuration(300L).alpha(1.0f).setListener(new b2(e2Var, 0)).start();
                return;
            case 8:
                e3 e3Var = (e3) ((w2) obj).f19900c;
            ...
            case 11:
                ...
                return;
            case 12:
                t4 t4Var = (t4) ((c2) obj).f18773b;
                t4Var.k();
                t4Var.j();
                return;
            case 13:
                t4 t4Var2 = ((q4) obj).f19717b;
                t4Var2.f19761c.dismiss();
                t4Var2.f19762f.removeAllViews();
                return;
            case 14:
                ((q4) obj).f19717b.f19761c.dismiss();
                return;
            case 15:
            ...
            case 17:
                ...
                return;
            case 18:
                k8 k8Var = (k8) h6.f19078e5.remove((MessageObject) obj);
                if (k8Var != null) {
                    k8Var.f25698i = null;
                    return;
                }
