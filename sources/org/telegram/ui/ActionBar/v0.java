...
public final class v0 implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f19850a) {
            case 0:
                b1 b1Var = (b1) this.f19851b;
                b1Var.getClass();
                b1Var.f18739a = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                b1Var.invalidate();
                return;
            case 1:
                e1 e1Var = (e1) this.f19851b;
                float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                e1Var.setTextColor(i0.a.d(floatValue, -1, -9194260));
                e1Var.setIconColor(i0.a.d(floatValue, -1, -9194260));
                return;
            case 2:
                ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout = (ActionBarPopupWindow$ActionBarPopupWindowLayout) this.f19851b;
                ...
                return;
            case 3:
                o1 o1Var = (o1) this.f19851b;
                if (!o1Var.e) {
                    float floatValue3 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                    if (o1Var.f19684r) {
                        floatValue3 = 1.0f - floatValue3;
                    }
                    float z10 = (int) com.google.android.gms.internal.vision.e2.z(1.0f, floatValue3, o1Var.f19683q, o1Var.f19682p * floatValue3);
                    if (!(o1Var instanceof zg.n)) {
                        o1Var.f19670a.setTranslationY(z10);
                    }
                    o1Var.e(-z10, floatValue3, o1Var.f19685s);
                    return;
                }
                return;
            case 4:
                m3 m3Var = (m3) this.f19851b;
                m3Var.getClass();
                ...
                return;
            default:
                u3 u3Var = (u3) this.f19851b;
                u3Var.f19826i = ((Float) valueAnimator.getAnimatedValue()).floatValue();
