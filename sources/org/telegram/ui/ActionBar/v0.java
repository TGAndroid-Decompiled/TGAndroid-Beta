...
public class v0 extends FrameLayout implements le.d {
    public final le.b f19586a;
    public pq f19587b;
    public final u9 f19588c;
    public final ImageView d;
    public final TextView e;
    public gg.q0 f19589f;
    public final r h;
    public final f6 f19590n;
    ...
    public v0(Context context, f6 f6Var) {
        super(context);
        this.f19586a = new le.b(0, this, qr.h, 380L, false);
        this.h = new r(this, 2);
        this.f19590n = f6Var;
        ...
        this.f19593w = AndroidUtilities.dp(28.0f);
        a();
    }
    ...
    public final void a() {
        int v02;
        float f7 = this.f19586a.e;
        boolean z10 = this.f19591r;
        f6 f6Var = this.f19590n;
        if (z10) {
            v02 = j6.l1(0.075f, j6.v0(j6.G6, f6Var));
        } else {
            v02 = j6.v0(j6.f18856ci, f6Var);
        }
        int i10 = j6.Oh;
        ...
        pq pqVar = this.f19587b;
        if (pqVar != null) {
            j6.v1(pqVar, j6.v0(i10, f6Var), false);
            j6.v1(this.f19587b, j6.v0(i11, f6Var), true);
        }
        this.f19588c.setAlpha(1.0f - f7);
        gg.q0 q0Var = this.f19589f;
    ...
    public void setData(gg.q0 q0Var) {
        ...
        if (i12 == 4) {
            ...
            if (tLObject instanceof TLRPC.User) {
                ...
                u9Var.getImageReceiver().setForUserOrChat(user, this.f19587b);
            } else if (tLObject instanceof TLRPC.Chat) {
                TLRPC.Chat chat = (TLRPC.Chat) tLObject;
                this.f19592s = ChatObject.isCommunity(chat);
                ...
                u9Var.getImageReceiver().setForUserOrChat(chat, this.f19587b);
            }
        } else if (i12 == 7) {
            ...
            u9Var.setImageDrawable(this.f19587b);
        }
    }
