...
public abstract class z5 {
    public static final int f20761a = j6.f19881d6;
    public static float[] f20762b;
    ...
    public static int b(int i10) {
        ...
        return Color.HSVToColor(127, f20762b);
    }
    ...
    public static org.telegram.ui.Cells.z c(y5 y5Var, int i10) {
        ...
        drawable.f20746b = -1.0f;
        if (y5.f20744c == null) {
            Paint paint = new Paint(1);
            y5.f20744c = paint;
            paint.setColor(-1);
        }
        drawable.f20745a = y5.f20744c;
