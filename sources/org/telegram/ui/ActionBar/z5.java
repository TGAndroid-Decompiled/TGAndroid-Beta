...
public abstract class z5 {
    public static final int f19760a = j6.f18862d6;
    public static float[] f19761b;
    ...
    public static int b(int i10) {
        ...
        return Color.HSVToColor(127, f19761b);
    }
    ...
    public static org.telegram.ui.Cells.z c(y5 y5Var, int i10) {
        ...
        drawable.f19741b = -1.0f;
        if (y5.f19739c == null) {
            Paint paint = new Paint(1);
            y5.f19739c = paint;
            paint.setColor(-1);
        }
        drawable.f19740a = y5.f19739c;
