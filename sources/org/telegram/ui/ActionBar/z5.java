...
public abstract class z5 {
    public static final int f19761a = j6.f18863d6;
    public static float[] f19762b;
    ...
    public static int b(int i10) {
        ...
        return Color.HSVToColor(127, f19762b);
    }
    ...
    public static org.telegram.ui.Cells.z c(y5 y5Var, int i10) {
        ...
        drawable.f19742b = -1.0f;
        if (y5.f19740c == null) {
            Paint paint = new Paint(1);
            y5.f19740c = paint;
            paint.setColor(-1);
        }
        drawable.f19741a = y5.f19740c;
