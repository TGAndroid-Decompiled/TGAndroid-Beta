...
public abstract class e3 extends FrameLayout {
    ...
    public final g3 G;
    public VelocityTracker f18608a;
    public int f18609b;
    public int f18610c;
    public int d;
    public boolean e;
    ...
    public final b2.q0 f18612n;
    public final Rect f18613r;
    public final Paint f18614s;
    public boolean v;
    public int f18615w;
    public float f18616x;
    public float f18617y;
    ...
    public e3(g3 g3Var, Context context) {
        ...
        this.f18614s = new Paint();
        this.f18616x = 0.0f;
        this.f18617y = 0.0f;
        this.F = new Paint(1);
        this.f18612n = new Object();
    ...
    public final void b(float f7, float f10) {
        ...
        this.h.setInterpolator(qr.f27383f);
        ...
        if (!z11) {
            if (!g3Var.onContainerTouchEvent(motionEvent)) {
                if (!g3Var.canSwipeToBack(motionEvent) && !this.E) {
                    if (g3Var.canDismissWithTouchOutside() && motionEvent != null && ((motionEvent.getAction() == 0 || motionEvent.getAction() == 2) && !this.f18611f && !this.e && motionEvent.getPointerCount() == 1)) {
                        this.f18609b = (int) motionEvent.getX();
                        int y3 = (int) motionEvent.getY();
                        this.f18610c = y3;
                        if (g3Var.isTouchOutside(this.f18609b, y3)) {
                            g3Var.onDismissWithTouchOutside();
                            return true;
                        }
                        g3Var.onScrollUpBegin(this.f18616x);
                        this.d = motionEvent.getPointerId(0);
                        this.e = true;
                        a();
                        VelocityTracker velocityTracker = this.f18608a;
                        ...
                        if (this.f18608a == null) {
                            this.f18608a = VelocityTracker.obtain();
                        }
                        float abs = Math.abs((int) (motionEvent.getX() - this.f18609b));
                        float y10 = ((int) motionEvent.getY()) - this.f18610c;
                        boolean onScrollUp = g3Var.onScrollUp(this.f18616x + y10);
                        this.f18608a.addMovement(motionEvent);
                        z13 = g3Var.disableScroll;
                        if (!z13 && this.e && !this.f18611f && y10 > 0.0f && y10 / 3.0f > Math.abs(abs)) {
                            float abs2 = Math.abs(y10);
                            i11 = g3Var.touchSlop;
                            if (abs2 >= i11) {
                                this.f18610c = (int) motionEvent.getY();
                                this.e = false;
                                this.f18611f = true;
                        ...
                        if (this.f18611f) {
                            float f7 = this.f18616x + y10;
                            this.f18616x = f7;
                            if (!onScrollUp) {
                                this.f18616x = Math.max(f7, 0.0f);
                            }
                            g3Var.containerView.setTranslationY(Math.max(this.f18616x, 0.0f));
                        ...
                        this.f18608a.computeCurrentVelocity(1000);
                        g3Var.onScrollUpEnd(this.f18616x);
                        if (!this.f18611f && this.f18616x <= 0.0f) {
                            this.e = false;
                        } else {
                            b(this.f18608a.getXVelocity(), this.f18608a.getYVelocity());
                        }
                        this.f18611f = false;
                        VelocityTracker velocityTracker2 = this.f18608a;
                ...
                } else if (motionEvent != null && ((motionEvent.getAction() == 0 || motionEvent.getAction() == 2) && !this.f18611f && !this.e && motionEvent.getPointerCount() == 1)) {
                    this.E = true;
                    this.f18609b = (int) motionEvent.getX();
                    this.f18610c = (int) motionEvent.getY();
                    this.d = motionEvent.getPointerId(0);
                    ...
                    float x10 = motionEvent.getX() - this.f18609b;
                    float y11 = motionEvent.getY() - this.f18610c;
                    if (this.f18608a == null) {
                        this.f18608a = VelocityTracker.obtain();
                    }
                    this.f18608a.addMovement(motionEvent);
                    z12 = g3Var.disableScroll;
                    if (!z12 && this.e && !this.f18611f && x10 > 0.0f && x10 / 3.0f > Math.abs(y11)) {
                    ...
                    float xVelocity = this.f18608a.getXVelocity();
                    float yVelocity = this.f18608a.getYVelocity();
                    if (this.f18617y < g3Var.containerView.getMeasuredWidth() / 3.0f && (xVelocity < 3500.0f || xVelocity < yVelocity)) {
                        float max = Math.max(this.f18617y, 0.0f);
                        this.f18617y = max;
                        ...
                        ValueAnimator ofFloat2 = ValueAnimator.ofFloat(this.f18617y, getMeasuredWidth());
                ...
                if ((z10 || !this.e) && !this.f18611f && (g3Var.canDismissWithSwipe() || g3Var.canSwipeToBack(motionEvent))) {
                }
            }
            return true;
        }
