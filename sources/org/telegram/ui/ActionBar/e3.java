...
public abstract class e3 extends FrameLayout {
    ...
    public final g3 D;
    public VelocityTracker f19628a;
    public int f19629b;
    public int f19630c;
    public int d;
    public boolean e;
    ...
    public final c5.e f19632n;
    public final Rect f19633r;
    public final Paint f19634s;
    public boolean v;
    public int f19635w;
    ...
    public e3(g3 g3Var, Context context) {
        ...
        this.f19631f = false;
        this.h = null;
        this.f19633r = new Rect();
        this.f19634s = new Paint();
        this.f19636x = 0.0f;
        this.f19637y = 0.0f;
        this.C = new Paint(1);
        this.f19632n = new Object();
    ...
    public final void b(float f10, float f11) {
        ...
        this.h.setInterpolator(mr.f27122f);
        ...
        if (!z10) {
            if (!g3Var.onContainerTouchEvent(motionEvent)) {
                if (!g3Var.canSwipeToBack(motionEvent) && !this.B) {
                    if (g3Var.canDismissWithTouchOutside() && motionEvent != null && ((motionEvent.getAction() == 0 || motionEvent.getAction() == 2) && !this.f19631f && !this.e && motionEvent.getPointerCount() == 1)) {
                        this.f19629b = (int) motionEvent.getX();
                        int y10 = (int) motionEvent.getY();
                        this.f19630c = y10;
                        if (g3Var.isTouchOutside(this.f19629b, y10)) {
                            g3Var.onDismissWithTouchOutside();
                            return true;
                        }
                        g3Var.onScrollUpBegin(this.f19636x);
                        this.d = motionEvent.getPointerId(0);
                        this.e = true;
                        a();
                        VelocityTracker velocityTracker = this.f19628a;
                        ...
                        if (this.f19628a == null) {
                            this.f19628a = VelocityTracker.obtain();
                        }
                        float abs = Math.abs((int) (motionEvent.getX() - this.f19629b));
                        float y11 = ((int) motionEvent.getY()) - this.f19630c;
                        boolean onScrollUp = g3Var.onScrollUp(this.f19636x + y11);
                        this.f19628a.addMovement(motionEvent);
                        z12 = g3Var.disableScroll;
                        if (!z12 && this.e && !this.f19631f && y11 > 0.0f && y11 / 3.0f > Math.abs(abs)) {
                            float abs2 = Math.abs(y11);
                            i11 = g3Var.touchSlop;
                            if (abs2 >= i11) {
                                this.f19630c = (int) motionEvent.getY();
                                this.e = false;
                                this.f19631f = true;
                        ...
                        if (this.f19631f) {
                            float f10 = this.f19636x + y11;
                            this.f19636x = f10;
                            if (!onScrollUp) {
                                this.f19636x = Math.max(f10, 0.0f);
                            }
                            g3Var.containerView.setTranslationY(Math.max(this.f19636x, 0.0f));
                        ...
                        this.f19628a.computeCurrentVelocity(1000);
                        g3Var.onScrollUpEnd(this.f19636x);
                        if (!this.f19631f && this.f19636x <= 0.0f) {
                            this.e = false;
                        } else {
                            b(this.f19628a.getXVelocity(), this.f19628a.getYVelocity());
                        }
                        this.f19631f = false;
                        VelocityTracker velocityTracker2 = this.f19628a;
                ...
                } else if (motionEvent != null && ((motionEvent.getAction() == 0 || motionEvent.getAction() == 2) && !this.f19631f && !this.e && motionEvent.getPointerCount() == 1)) {
                    this.B = true;
                    this.f19629b = (int) motionEvent.getX();
                    this.f19630c = (int) motionEvent.getY();
                    this.d = motionEvent.getPointerId(0);
                    ...
                    float x10 = motionEvent.getX() - this.f19629b;
                    float y12 = motionEvent.getY() - this.f19630c;
                    if (this.f19628a == null) {
                        this.f19628a = VelocityTracker.obtain();
                    }
                    this.f19628a.addMovement(motionEvent);
                    z11 = g3Var.disableScroll;
                    if (!z11 && this.e && !this.f19631f && x10 > 0.0f && x10 / 3.0f > Math.abs(y12)) {
                    ...
                    float xVelocity = this.f19628a.getXVelocity();
                    float yVelocity = this.f19628a.getYVelocity();
                    if (this.f19637y < g3Var.containerView.getMeasuredWidth() / 3.0f && (xVelocity < 3500.0f || xVelocity < yVelocity)) {
                        float max = Math.max(this.f19637y, 0.0f);
                        this.f19637y = max;
                        ...
                        ValueAnimator ofFloat2 = ValueAnimator.ofFloat(this.f19637y, getMeasuredWidth());
                ...
                if ((z4 || !this.e) && !this.f19631f && (g3Var.canDismissWithSwipe() || g3Var.canSwipeToBack(motionEvent))) {
                }
            }
            return true;
        }
