...
public final class e3 extends Drawable {
    public final Paint f18835a;
    public final Rect f18836b;
    public final Rect f18837c;

    public e3() {
        Paint paint = new Paint(1);
        this.f18835a = paint;
        this.f18836b = new Rect();
    ...
    public final void onBoundsChange(Rect rect) {
        ...
        Rect rect2 = this.f18837c;
        rect2.set(rect);
        int i10 = rect2.left;
        Rect rect3 = this.f18836b;
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f18835a.setColorFilter(colorFilter);
    }
}
