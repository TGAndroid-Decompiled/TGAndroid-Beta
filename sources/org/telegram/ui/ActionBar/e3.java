...
public final class e3 extends Drawable {
    ...
    public final Rect f20405b;
    public final Rect f20406c;

    public e3() {
        Paint paint = new Paint(1);
        this.f20404a = paint;
        this.f20405b = new Rect();
        this.f20406c = new Rect();
        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.SRC));
        paint.setColor(-16777216);
    }

    public final void a(int i10) {
        Rect rect = this.f20405b;
    ...
    public final void draw(Canvas canvas) {
        Rect rect = this.f20406c;
        if (!rect.isEmpty()) {
            Paint paint = this.f20404a;
    ...
    public final void onBoundsChange(Rect rect) {
        ...
        Rect rect2 = this.f20406c;
        rect2.set(rect);
        int i10 = rect2.left;
        Rect rect3 = this.f20405b;
    ...
    public final void setAlpha(int i10) {
        this.f20404a.setAlpha(i10);
        invalidateSelf();
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f20404a.setColorFilter(colorFilter);
    }
}
