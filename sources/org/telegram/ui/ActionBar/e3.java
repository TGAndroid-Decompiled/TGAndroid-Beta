...
public final class e3 extends Drawable {
    public final Paint f20377a;
    public final Rect f20378b;
    public final Rect f20379c;

    public e3() {
        Paint paint = new Paint(1);
        this.f20377a = paint;
        this.f20378b = new Rect();
        this.f20379c = new Rect();
        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.SRC));
        paint.setColor(-16777216);
    }

    public final void a(int i10) {
        Rect rect = this.f20378b;
    ...
    public final void draw(Canvas canvas) {
        Rect rect = this.f20379c;
        if (!rect.isEmpty()) {
            Paint paint = this.f20377a;
    ...
    public final void onBoundsChange(Rect rect) {
        ...
        Rect rect2 = this.f20379c;
        rect2.set(rect);
        int i10 = rect2.left;
        Rect rect3 = this.f20378b;
    ...
    public final void setAlpha(int i10) {
        this.f20377a.setAlpha(i10);
        invalidateSelf();
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f20377a.setColorFilter(colorFilter);
    }
}
