...
public final class e3 extends Drawable {
    ...
    public final Rect f20404b;
    public final Rect f20405c;

    public e3() {
        Paint paint = new Paint(1);
        this.f20403a = paint;
        this.f20404b = new Rect();
        this.f20405c = new Rect();
        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.SRC));
        paint.setColor(-16777216);
    }

    public final void a(int i10) {
        Rect rect = this.f20404b;
    ...
    public final void onBoundsChange(Rect rect) {
        ...
        Rect rect2 = this.f20405c;
        rect2.set(rect);
        int i10 = rect2.left;
        Rect rect3 = this.f20404b;
    ...
    public final void setAlpha(int i10) {
        this.f20403a.setAlpha(i10);
        invalidateSelf();
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f20403a.setColorFilter(colorFilter);
    }
}
