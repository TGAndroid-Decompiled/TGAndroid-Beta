...
public final class c2 implements Animation.AnimationListener {
    ...
    public final void onAnimationEnd(Animation animation) {
        switch (this.f18771a) {
            case 0:
                ((e2) this.f18772b).f18846g1.setAlpha(0.0f);
                return;
            default:
                ((t4) this.f18772b).f19761f.post(new p(this, 12));
                return;
        }
    }
    ...
    public final void onAnimationStart(Animation animation) {
        switch (this.f18771a) {
            case 0:
                return;
            default:
                t4 t4Var = (t4) this.f18772b;
                t4Var.f19763i.setEnabled(false);
                t4Var.f19762g.setVisibility(0);
