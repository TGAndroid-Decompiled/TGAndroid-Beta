...
public final class l3 {
    public final n3 f21174a;
    public int f21175b;
    public int f21176c;
    public final org.telegram.ui.Components.e6 d;
    public final org.telegram.ui.Components.e6 f21177e;
    public final Paint f21178f = new Paint(1);
    public final Paint f21179g = new Paint(1);
    public final Paint h;
    public final Paint f21180i;
    public int f21181j;
    public final org.telegram.ui.Cells.z f21182k;
    public int f21183l;
    public final int f21184m;
    public boolean f21185n;
    public final boolean f21186o;
    public final float f21187p;
    public final Bitmap f21188q;
    public final Drawable f21189r;
    public int f21190s;
    public final f01 f21191t;
    public f01 f21192u;
    public float v;
    public final float[] f21193w;
    public final Path f21194x;
    public final Path f21195y;
    public final Path f21196z;
    ...
    public l3(View view, n3 n3Var) {
        ...
        this.h = paint;
        this.f21180i = new Paint(3);
        org.telegram.ui.Cells.z f02 = j6.f0(822083583, 1, -1);
        this.f21182k = f02;
        this.f21190s = -1;
        this.f21193w = new float[8];
        this.f21194x = new Path();
        Path path = new Path();
        this.f21195y = path;
        Path path2 = new Path();
        this.f21196z = path2;
        ...
        this.f21177e = new org.telegram.ui.Components.e6(view, 320L, prVar);
        this.f21188q = n3Var.F;
        String b10 = n3Var.b();
        textPaint = o3.getTextPaint();
        this.f21191t = new f01(Emoji.replaceEmoji(b10, textPaint.getFontMetricsInt(), false), 17.0f, AndroidUtilities.bold());
        int i10 = n3Var.f21258q;
        this.f21184m = i10;
        this.f21186o = AndroidUtilities.computePerceivedBrightness(i10) < 0.721f;
        ...
        if (i4Var != null) {
            ...
            if (!arrayList.isEmpty()) {
                ...
                if ((h instanceof TLRPC.WebPage) && ((page = ((TLRPC.WebPage) h).cached_page) == null || page.local == null)) {
                    this.f21189r = view.getContext().getResources().getDrawable(R.drawable.msg_instant).mutate();
                }
            }
        }
        this.f21187p = n3Var.I;
        path.rewind();
    ...
    public final void a(Canvas canvas, RectF rectF, float f7, float f10, float f11) {
        ...
        int d = i0.a.d(this.v, this.f21183l, this.f21184m);
        Paint paint = this.f21178f;
        paint.setColor(d);
        ...
        fArr[5] = lerp;
        fArr[4] = lerp;
        Path path = this.f21194x;
        path.rewind();
        path.addRoundRect(rectF, fArr, Path.Direction.CW);
        canvas2.drawPath(path, paint);
        float f18 = this.f21187p;
        ...
        org.telegram.ui.Cells.z zVar = this.f21182k;
        ...
        f01 f01Var = this.f21192u;
        if (f01Var != null) {
            f01Var.f25886p = (int) ((rectF.width() - AndroidUtilities.dp(100.0f)) - f15);
        ...
        f01 f01Var2 = this.f21191t;
        f01Var2.f25886p = (int) (width - f13);
    ...
    public final float c() {
        ...
        return this.d.d(this.f21175b, false);
    }
}
