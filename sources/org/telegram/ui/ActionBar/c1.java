...
public abstract class c1 extends FrameLayout {
    ...
    public float f18716a0;
    public Utilities.Callback2 f18717b;
    public float f18718b0;
    public final y0 f18719c;
    public long f18720c0;
    public final y0 d;
    public boolean f18721d0;
    public final org.telegram.ui.Components.e6 e;
    public Bitmap f18722f;
    public BitmapShader h;
    public Matrix f18723n;
    public final int[] f18724r;
    public float f18725s;
    public boolean v;
    public boolean f18726w;
    public final e6 f18727x;
    public final Paint f18728y;
    ...
    public c1(Context context, e6 e6Var) {
        ...
        TextPaint textPaint = y0Var.f26867a;
        ...
        TextPaint textPaint2 = y0Var2.f26867a;
    ...
    public final void c(float f7, boolean z10) {
        ...
        if (!z10) {
            ...
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f18715a, a2);
            this.T = ofFloat;
        ...
        b1 b1Var = (b1) this;
        String str2 = b1Var.f18644f0;
        if (str2 == null) {
            str2 = ed.a((a2 * 2.8f) + 0.2f) + "x";
        }
        if (str2 != null) {
            y0 y0Var = this.f18719c;
            if (!TextUtils.equals(y0Var.f26871g, str2)) {
                y0Var.b();
                y0Var.q(str2, true, true);
            }
        }
        if (b1Var.f18644f0 != null) {
            str = ed.a((a2 * 2.8f) + 0.2f) + "x";
        }
        if (str != null) {
            y0 y0Var2 = this.d;
            if (!TextUtils.equals(y0Var2.f26871g, str)) {
                y0Var2.b();
                y0Var2.q(str, true, true);
            }
        }
        int i10 = j6.sj;
        e6 e6Var = b1Var.f18727x;
        this.J.setColor(i0.a.d(w7.q.a((((a2 * 2.8f) + 0.2f) - 1.0f) / 1.0f, 0.0f, 1.0f), j6.v0(i10, e6Var), j6.v0(j6.tj, e6Var)));
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.v) {
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18725s), AndroidUtilities.dp(this.f18725s), this.f18728y);
        }
        boolean z10 = this.f18726w;
        Paint paint = this.J;
        if (z10) {
            ...
            if (d < 1.0f) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18725s), AndroidUtilities.dp(this.f18725s), paint2);
            }
            if (this.f18722f != null && this.f18715a < 1.0f && d > 0.0f) {
                Paint paint3 = this.F;
                paint3.setAlpha((int) (d * 255.0f));
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18725s), AndroidUtilities.dp(this.f18725s), paint3);
            }
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18725s), AndroidUtilities.dp(this.f18725s), this.G);
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18725s), AndroidUtilities.dp(this.f18725s), this.H);
            paint.setColor(-1);
        } else {
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18725s), AndroidUtilities.dp(this.f18725s), this.E);
        }
        a(canvas);
        if (!this.L) {
            b(canvas, false);
        }
        if (this.f18715a < 1.0f) {
            canvas.save();
            canvas.clipRect(getPaddingLeft(), getPaddingTop(), (((getWidth() - getPaddingLeft()) - getPaddingRight()) * this.f18715a) + getPaddingLeft(), getHeight() - getPaddingBottom());
        }
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18725s), AndroidUtilities.dp(this.f18725s), paint);
        a(canvas);
        if (!this.L) {
            b(canvas, true);
        }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int[] iArr = this.f18724r;
        getLocationOnScreen(iArr);
        Matrix matrix = this.f18723n;
        if (matrix != null) {
            matrix.reset();
            this.f18723n.postScale(8.0f, 8.0f);
            this.f18723n.postTranslate(-iArr[0], -iArr[1]);
            BitmapShader bitmapShader = this.h;
            if (bitmapShader != null) {
                bitmapShader.setLocalMatrix(this.f18723n);
                invalidate();
            }
        }
        boolean z11 = this.N;
        e6 e6Var = this.f18727x;
        if (z11) {
            Drawable r02 = j6.r0();
            if (r02 instanceof ColorDrawable) {
                ...
                v02 = j6.l1(0.25f, j6.v0(j6.f19062d6, e6Var));
            }
        } else {
            v02 = j6.v0(j6.f19062d6, e6Var);
            if (!j6.I.q()) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f18726w && this.f18722f == null && !this.U && z10) {
            this.V.run();
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            this.f18721d0 = true;
            this.f18716a0 = x10;
            this.f18718b0 = this.f18715a;
            this.f18720c0 = System.currentTimeMillis();
            return true;
        }
        if (action == 2 || action == 1) {
            ...
            if (action == 1) {
                this.f18721d0 = false;
                if (System.currentTimeMillis() - this.f18720c0 < ViewConfiguration.getTapTimeout()) {
                    ...
                    Utilities.Callback2 callback2 = this.f18717b;
                    if (callback2 != null) {
            ...
            float max = ((x10 - this.f18716a0) / Math.max(1, (getWidth() - getPaddingLeft()) - getPaddingRight())) + this.f18718b0;
            if (this.M != null) {
                int i11 = 0;
                while (true) {
                    float[] fArr2 = this.M;
            ...
            boolean z10 = !this.f18721d0;
            c(max, false);
            Utilities.Callback2 callback22 = this.f18717b;
            if (callback22 != null) {
                callback22.run(Float.valueOf(this.f18715a), Boolean.valueOf(z10));
            }
        }
        return true;
    }
