...
public final class c1 extends d1 {
    public final b1 f18487e0;
    public String f18488f0;
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        this.f18487e0.e(this, accessibilityNodeInfo);
    }

    @Override
    public final boolean performAccessibilityAction(int i10, Bundle bundle) {
        if (!super.performAccessibilityAction(i10, bundle) && !this.f18487e0.g(this, i10, bundle)) {
            return false;
        }
        return true;
    }
