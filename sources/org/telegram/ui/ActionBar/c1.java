...
public abstract class c1 extends FrameLayout {
    ...
    public float f20326a0;
    public Utilities.Callback2 f20327b;
    public float f20328b0;
    public final y0 f20329c;
    public long f20330c0;
    public final y0 d;
    public boolean f20331d0;
    public final org.telegram.ui.Components.e6 f20332e;
    public Bitmap f20333f;
    public BitmapShader h;
    public Matrix f20334n;
    public final int[] f20335r;
    public float f20336s;
    public boolean v;
    public boolean f20337w;
    public final f6 f20338x;
    public final Paint f20339y;
    ...
    public c1(Context context, f6 f6Var) {
        ...
        this.f20325a = 0.5f;
        pr prVar = pr.h;
        this.f20332e = new org.telegram.ui.Components.e6(1.0f, this, 0L, 320L, prVar);
        this.f20335r = new int[2];
        this.f20336s = 0.0f;
        ...
        TextPaint textPaint = y0Var.f29312a;
        ...
        TextPaint textPaint2 = y0Var2.f29312a;
    ...
    public final void c(float f7, boolean z10) {
        ...
        if (!z10) {
            ...
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f20325a, a2);
            this.T = ofFloat;
        ...
        b1 b1Var = (b1) this;
        String str2 = b1Var.f20250f0;
        if (str2 == null) {
            str2 = fd.a((a2 * 2.8f) + 0.2f) + "x";
        }
        if (str2 != null) {
            y0 y0Var = this.f20329c;
            if (!TextUtils.equals(y0Var.f29317g, str2)) {
                y0Var.b();
                y0Var.q(str2, true, true);
            }
        }
        if (b1Var.f20250f0 != null) {
            str = fd.a((a2 * 2.8f) + 0.2f) + "x";
        }
        if (str != null) {
            y0 y0Var2 = this.d;
            if (!TextUtils.equals(y0Var2.f29317g, str)) {
                y0Var2.b();
                y0Var2.q(str, true, true);
            }
        }
        int i10 = j6.sj;
        f6 f6Var = b1Var.f20338x;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.v) {
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f20336s), AndroidUtilities.dp(this.f20336s), this.f20339y);
        }
        boolean z10 = this.f20337w;
        Paint paint = this.J;
        if (z10) {
            ...
            float d = this.f20332e.d(f7, false);
            if (d < 1.0f) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f20336s), AndroidUtilities.dp(this.f20336s), paint2);
            }
            if (this.f20333f != null && this.f20325a < 1.0f && d > 0.0f) {
                Paint paint3 = this.F;
                paint3.setAlpha((int) (d * 255.0f));
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f20336s), AndroidUtilities.dp(this.f20336s), paint3);
            }
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f20336s), AndroidUtilities.dp(this.f20336s), this.G);
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f20336s), AndroidUtilities.dp(this.f20336s), this.H);
            paint.setColor(-1);
        } else {
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f20336s), AndroidUtilities.dp(this.f20336s), this.E);
        }
        a(canvas);
        if (!this.L) {
            b(canvas, false);
        }
        if (this.f20325a < 1.0f) {
            canvas.save();
            canvas.clipRect(getPaddingLeft(), getPaddingTop(), (((getWidth() - getPaddingLeft()) - getPaddingRight()) * this.f20325a) + getPaddingLeft(), getHeight() - getPaddingBottom());
        }
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f20336s), AndroidUtilities.dp(this.f20336s), paint);
        a(canvas);
        if (!this.L) {
            b(canvas, true);
        }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int[] iArr = this.f20335r;
        getLocationOnScreen(iArr);
        Matrix matrix = this.f20334n;
        if (matrix != null) {
            matrix.reset();
            this.f20334n.postScale(8.0f, 8.0f);
            this.f20334n.postTranslate(-iArr[0], -iArr[1]);
            BitmapShader bitmapShader = this.h;
            if (bitmapShader != null) {
                bitmapShader.setLocalMatrix(this.f20334n);
                invalidate();
            }
        }
        boolean z11 = this.N;
        f6 f6Var = this.f20338x;
        if (z11) {
            Drawable r02 = j6.r0();
            if (r02 instanceof ColorDrawable) {
                ...
                v02 = j6.l1(0.25f, j6.v0(j6.f20691d6, f6Var));
            }
        } else {
            v02 = j6.v0(j6.f20691d6, f6Var);
            if (!j6.I.q()) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f20337w && this.f20333f == null && !this.U && z10) {
            this.V.run();
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            this.f20331d0 = true;
            this.f20326a0 = x10;
            this.f20328b0 = this.f20325a;
            this.f20330c0 = System.currentTimeMillis();
            return true;
        }
        if (action == 2 || action == 1) {
            ...
            if (action == 1) {
                this.f20331d0 = false;
                if (System.currentTimeMillis() - this.f20330c0 < ViewConfiguration.getTapTimeout()) {
                    ...
                    Utilities.Callback2 callback2 = this.f20327b;
                    if (callback2 != null) {
            ...
            float max = ((x10 - this.f20326a0) / Math.max(1, (getWidth() - getPaddingLeft()) - getPaddingRight())) + this.f20328b0;
            if (this.M != null) {
                int i11 = 0;
                while (true) {
                    float[] fArr2 = this.M;
            ...
            boolean z10 = !this.f20331d0;
            c(max, false);
            Utilities.Callback2 callback22 = this.f20327b;
            if (callback22 != null) {
                callback22.run(Float.valueOf(this.f20325a), Boolean.valueOf(z10));
            }
        }
        return true;
    }
