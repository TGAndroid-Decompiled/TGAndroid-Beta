...
public abstract class c1 extends FrameLayout {
    ...
    public float f20298a0;
    public Utilities.Callback2 f20299b;
    public float f20300b0;
    public final y0 f20301c;
    public long f20302c0;
    public final y0 d;
    public boolean f20303d0;
    public final org.telegram.ui.Components.e6 f20304e;
    public Bitmap f20305f;
    public BitmapShader h;
    public Matrix f20306n;
    public final int[] f20307r;
    public float f20308s;
    public boolean v;
    public boolean f20309w;
    public final f6 f20310x;
    public final Paint f20311y;
    ...
    public c1(Context context, f6 f6Var) {
        ...
        this.f20297a = 0.5f;
        pr prVar = pr.h;
        this.f20304e = new org.telegram.ui.Components.e6(1.0f, this, 0L, 320L, prVar);
        this.f20307r = new int[2];
        this.f20308s = 0.0f;
        ...
        TextPaint textPaint = y0Var.f29284a;
        ...
        TextPaint textPaint2 = y0Var2.f29284a;
    ...
    public final void c(float f7, boolean z10) {
        ...
        if (!z10) {
            ...
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f20297a, a2);
            this.T = ofFloat;
        ...
        b1 b1Var = (b1) this;
        String str2 = b1Var.f20222f0;
        if (str2 == null) {
            str2 = fd.a((a2 * 2.8f) + 0.2f) + "x";
        }
        if (str2 != null) {
            y0 y0Var = this.f20301c;
            if (!TextUtils.equals(y0Var.f29289g, str2)) {
                y0Var.b();
                y0Var.q(str2, true, true);
            }
        }
        if (b1Var.f20222f0 != null) {
            str = fd.a((a2 * 2.8f) + 0.2f) + "x";
        }
        if (str != null) {
            y0 y0Var2 = this.d;
            if (!TextUtils.equals(y0Var2.f29289g, str)) {
                y0Var2.b();
                y0Var2.q(str, true, true);
            }
        }
        int i10 = j6.sj;
        f6 f6Var = b1Var.f20310x;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.v) {
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f20308s), AndroidUtilities.dp(this.f20308s), this.f20311y);
        }
        boolean z10 = this.f20309w;
        Paint paint = this.J;
        if (z10) {
            ...
            float d = this.f20304e.d(f7, false);
            if (d < 1.0f) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f20308s), AndroidUtilities.dp(this.f20308s), paint2);
            }
            if (this.f20305f != null && this.f20297a < 1.0f && d > 0.0f) {
                Paint paint3 = this.F;
                paint3.setAlpha((int) (d * 255.0f));
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f20308s), AndroidUtilities.dp(this.f20308s), paint3);
            }
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f20308s), AndroidUtilities.dp(this.f20308s), this.G);
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f20308s), AndroidUtilities.dp(this.f20308s), this.H);
            paint.setColor(-1);
        } else {
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f20308s), AndroidUtilities.dp(this.f20308s), this.E);
        }
        a(canvas);
        if (!this.L) {
            b(canvas, false);
        }
        if (this.f20297a < 1.0f) {
            canvas.save();
            canvas.clipRect(getPaddingLeft(), getPaddingTop(), (((getWidth() - getPaddingLeft()) - getPaddingRight()) * this.f20297a) + getPaddingLeft(), getHeight() - getPaddingBottom());
        }
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f20308s), AndroidUtilities.dp(this.f20308s), paint);
        a(canvas);
        if (!this.L) {
            b(canvas, true);
        }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int[] iArr = this.f20307r;
        getLocationOnScreen(iArr);
        Matrix matrix = this.f20306n;
        if (matrix != null) {
            matrix.reset();
            this.f20306n.postScale(8.0f, 8.0f);
            this.f20306n.postTranslate(-iArr[0], -iArr[1]);
            BitmapShader bitmapShader = this.h;
            if (bitmapShader != null) {
                bitmapShader.setLocalMatrix(this.f20306n);
                invalidate();
            }
        }
        boolean z11 = this.N;
        f6 f6Var = this.f20310x;
        if (z11) {
            Drawable r02 = j6.r0();
            if (r02 instanceof ColorDrawable) {
                ...
                v02 = j6.l1(0.25f, j6.v0(j6.f20663d6, f6Var));
            }
        } else {
            v02 = j6.v0(j6.f20663d6, f6Var);
            if (!j6.I.q()) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f20309w && this.f20305f == null && !this.U && z10) {
            this.V.run();
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 2 || action == 1) {
            ...
            if (action == 1) {
                this.f20303d0 = false;
                if (System.currentTimeMillis() - this.f20302c0 < ViewConfiguration.getTapTimeout()) {
                    ...
                    Utilities.Callback2 callback2 = this.f20299b;
                    if (callback2 != null) {
            ...
            float max = ((x10 - this.f20298a0) / Math.max(1, (getWidth() - getPaddingLeft()) - getPaddingRight())) + this.f20300b0;
            if (this.M != null) {
                int i11 = 0;
                while (true) {
                    float[] fArr2 = this.M;
            ...
            boolean z10 = !this.f20303d0;
            c(max, false);
            Utilities.Callback2 callback22 = this.f20299b;
            if (callback22 != null) {
                callback22.run(Float.valueOf(this.f20297a), Boolean.valueOf(z10));
            }
        }
        return true;
    }
