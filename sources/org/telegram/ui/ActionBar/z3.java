...
public final class z3 implements Utilities.Callback {
    public final Utilities.Callback f19936a;
    public final TLRPC.WallPaper f19937b;
    public final int f19938c;
    public final int d;
    public final long e;

    public z3(Utilities.Callback callback, TLRPC.WallPaper wallPaper, int i10, int i11, long j3) {
        this.f19936a = callback;
        this.f19937b = wallPaper;
        this.f19938c = i10;
        this.d = i11;
        this.e = j3;
    }
    ...
    public final void run(Object obj) {
        dg.a aVar = (dg.a) obj;
        Utilities.Callback callback = this.f19936a;
        if (aVar != null) {
            callback.run(aVar);
            return;
        }
        TLRPC.WallPaper wallPaper = this.f19937b;
        ...
        imageReceiver.setDelegate(new org.telegram.tgnet.g(this.f19938c, this.d, this.e, callback));
