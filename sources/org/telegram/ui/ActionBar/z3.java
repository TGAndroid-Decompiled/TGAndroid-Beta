...
public final class z3 extends FrameLayout {
    public d5 f21584a;
    public ActionBarLayout f21585b;
    public boolean f21586c;
    public final Paint d;
    public r0.l1 f21587e;
    public i0.c f21588f;
    public i0.c h;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ActionBarLayout actionBarLayout = this.f21585b;
        if (actionBarLayout != null && actionBarLayout.getParent() == this) {
            this.f21585b.N(canvas, this);
        }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        return ((ActionBarLayout) this.f21584a).j();
    }
