...
public final class z3 extends FrameLayout {
    public d5 f21557a;
    public ActionBarLayout f21558b;
    public boolean f21559c;
    public final Paint d;
    public r0.l1 f21560e;
    public i0.c f21561f;
    public i0.c h;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ActionBarLayout actionBarLayout = this.f21558b;
        if (actionBarLayout != null && actionBarLayout.getParent() == this) {
            this.f21558b.N(canvas, this);
        }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        return ((ActionBarLayout) this.f21557a).j();
    }
