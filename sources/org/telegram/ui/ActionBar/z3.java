...
public final class z3 extends FrameLayout {
    public d5 f19741a;
    public ActionBarLayout f19742b;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ActionBarLayout actionBarLayout = this.f19742b;
        if (actionBarLayout != null && actionBarLayout.getParent() == this) {
            this.f19742b.N(canvas, this);
        }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        return ((ActionBarLayout) this.f19741a).j();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        i0.b bVar = this.f19744f;
        int i12 = (size - bVar.f10590a) - bVar.f10592c;
        int i13 = (size2 - bVar.f10591b) - bVar.d;
