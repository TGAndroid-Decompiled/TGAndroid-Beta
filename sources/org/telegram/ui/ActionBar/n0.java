    ...
    public final Animator onAppear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
        switch (this.f19649a) {
            ...
            case 3:
                ...
                animatorSet4.setInterpolator(qr.f27657k);
                return animatorSet4;
            case 4:
                ...
                if (view instanceof org.telegram.ui.Components.voip.k3) {
                    ...
                    view.setScaleX(0.0f);
                    view.setScaleY(0.0f);
                    ofPropertyValuesHolder.setStartDelay(((org.telegram.ui.Components.voip.k3) view).f29406f);
                }
            ...
            default:
                ...
                animatorSet5.setInterpolator(qr.f27653f);
                return animatorSet5;
        }
    }
    ...
    public final Animator onDisappear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
        switch (this.f19649a) {
            ...
            case 3:
                ...
                animatorSet4.setInterpolator(qr.f27653f);
                return animatorSet4;
            case 4:
