...
public final class j2 extends g3 {
    public final m2 f18779b;
    public final e5[] f18780c;
    public final o2 d;
    public final g3[] e;
    ...
    public final boolean canSwipeToBack(MotionEvent motionEvent) {
        e5[] e5VarArr;
        e5 e5Var;
        m2 m2Var = this.f18779b;
        if (m2Var == null || !m2Var.f19398a || (e5Var = (e5VarArr = this.f18780c)[0]) == null || e5Var.getFragmentStack().size() > 1 || (e5VarArr[0].getFragmentStack().size() == 1 && !((o2) e5VarArr[0].getFragmentStack().get(0)).isSwipeBackEnabled(motionEvent))) {
            return false;
        }
        return true;
    }
    ...
    public final void dismiss() {
        m2 m2Var;
        Runnable runnable;
        if (!isDismissed() && (m2Var = this.f18779b) != null && (runnable = m2Var.d) != null) {
            runnable.run();
        }
        super.dismiss();
        ArrayList arrayList = LaunchActivity.G1.P;
        e5[] e5VarArr = this.f18780c;
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (m2Var != null && m2Var.e) {
            ...
            fixNavigationBar(j6.v0(j6.f18952i5, o2Var.getResourceProvider()));
        }
    ...
    public final void onOpenAnimationEnd() {
        ...
        m2 m2Var = this.f18779b;
        if (m2Var != null && (runnable = m2Var.f19400c) != null) {
            runnable.run();
        }
    }
}
