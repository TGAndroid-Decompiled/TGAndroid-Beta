...
public class f5 extends Drawable {
    ...
    public boolean v;
    public final Paint f18882c = new Paint(1);
    public final RectF f18886j = new RectF();
    public final Matrix f18887k = new Matrix();
    public final Rect f18891o = new Rect();
    public final int[] f18898w = {-1, -1, -1, -1};
    public final Bitmap[] f18899x = new Bitmap[4];
    public final Drawable[] f18900y = new Drawable[4];
    public final int[] f18901z = {-1, -1, -1, -1};
    ...
    public final Path f18890n = new Path();
    ...
    public final void a() {
        Bitmap bitmap;
        if (this.f18880a instanceof BitmapShader) {
            boolean z10 = this.J;
            Matrix matrix = this.f18887k;
            nc0[] nc0VarArr = Q;
            char c10 = 0;
            int i10 = this.f18888l;
            char c11 = 2;
            ...
            Bitmap bitmap2 = nc0VarArr[c11].f26736k;
    ...
    public final void c(Canvas canvas, Paint paint) {
        ...
        if (paint == null && this.f18880a == null && this.O == 0 && this.P <= 0.0f && (f7 = f()) != null) {
            f7.setBounds(bounds);
            f7.draw(canvas);
            return;
        }
        ...
        if (paint == null && this.f18880a != null) {
            Matrix matrix = this.f18887k;
            matrix.reset();
            a();
            matrix.postTranslate(0.0f, -this.f18894r);
            this.f18880a.setLocalMatrix(matrix);
        }
        ...
        if (f5Var.f18880a != null && f5Var.f18889m && paint == null) {
            int g10 = g(j6.f19078bc);
    ...
    public final void e(Path path, Rect rect, int i10, int i11, int i12, int i13, int i14, boolean z10, boolean z11, boolean z12) {
        ...
        boolean z13 = this.f18893q;
        int i20 = this.f18888l;
        RectF rectF = this.f18886j;
        if (z13) {
            if (!this.G && i20 != 2 && !z12 && !z10) {
                path.moveTo(rect.right - b(8.0f), (i14 - this.f18894r) + this.f18881b);
                path.lineTo(rect.left + i10, (i14 - this.f18894r) + this.f18881b);
            } else {
                if (this.f18897u) {
                    i17 = i13;
                } else {
            ...
            if (!this.G && i20 != 2 && !z12 && !z11) {
                path.lineTo(rect.left + i10, (i14 - this.f18894r) - b(2.0f));
                if (i20 == 1) {
                    path.lineTo(rect.right - i10, (i14 - this.f18894r) - b(2.0f));
                } else {
                    path.lineTo(rect.right - b(8.0f), (i14 - this.f18894r) - b(2.0f));
                }
            } else {
            ...
            if (i20 == 1) {
                if (!z12 && !z10) {
                    path.lineTo(rect.right - i10, (i14 - this.f18894r) + this.f18881b);
                } else {
                    if (this.f18896t) {
                        i19 = i13;
                    }
                ...
                path.lineTo(rect.right - b(8.0f), (i14 - this.f18894r) + this.f18881b);
            } else {
            ...
            if (!this.G && i20 != 2 && !z12 && !z10) {
                path.moveTo(b(8.0f) + rect.left, (i14 - this.f18894r) + this.f18881b);
                path.lineTo(rect.right - i10, (i14 - this.f18894r) + this.f18881b);
            } else {
                if (this.f18897u) {
                    i15 = i13;
            ...
            if (!this.G && i20 != 2 && !z12 && !z11) {
                ...
                if (i20 == 1) {
                    ...
                    path.lineTo(b(8.0f) + rect.left, (i14 - this.f18894r) - b(2.0f));
                }
            } else {
            ...
            if (i20 == 1) {
                ...
                path.lineTo(b(8.0f) + rect.left, (i14 - this.f18894r) + this.f18881b);
            } else {
    ...
    public final Drawable f() {
        ...
        boolean z12 = this.f18889m;
        if (!z12 || !this.f18897u) {
            if (z12) {
                c11 = 1;
            } else if (this.f18897u) {
                c11 = 2;
            } else {
                c11 = 0;
            }
        ...
        if (this.f18880a == null && !z12 && !this.J) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final void finalize() {
        ...
        Arrays.fill(this.f18900y, (Object) null);
        Arrays.fill(this.f18898w, -1);
    }
    ...
    public final Drawable j() {
        ...
        int i10;
        int i11;
        if (this.J || (this.f18880a == null && !this.f18889m && this.H == null)) {
            return null;
        }
        int b10 = b(SharedConfig.bubbleRadius);
        boolean z10 = this.f18895s;
        boolean z11 = false;
        if (z10 && this.f18896t) {
            c10 = 3;
        } else if (z10) {
        ...
        int[] iArr = this.f18898w;
        int i12 = iArr[c10];
        Drawable[] drawableArr = this.f18900y;
        if (i12 != b10) {
            iArr[c10] = b10;
            Bitmap[] bitmapArr = this.f18899x;
    ...
    public final Path m() {
        ...
        int max = Math.max(bounds.top, 0);
        boolean z13 = true;
        if (c3Var != null && bounds.height() < this.f18881b) {
            z10 = true;
            z11 = true;
        } else {
            if (i12 != 1 ? (this.f18894r + bounds.bottom) - i11 < this.f18881b : (this.f18894r + bounds.bottom) - (b12 * 2) < this.f18881b) {
                z10 = true;
            } else {
                z10 = false;
            }
            if ((i11 * 2) + this.f18894r >= 0) {
                z12 = true;
            }
            z11 = z12;
        }
    ...
    public final void setAlpha(int i10) {
        int i11 = this.F;
        Paint paint = this.f18882c;
        if (i11 != i10 || paint.getAlpha() != i10) {
            this.F = i10;
            paint.setAlpha(i10);
            if (this.f18893q) {
                this.d.setAlpha((int) ((i10 / 255.0f) * Color.alpha(g(j6.f19078bc))));
            }
        }
