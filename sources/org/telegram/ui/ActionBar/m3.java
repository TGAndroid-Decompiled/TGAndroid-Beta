...
public final class m3 extends j1.b {
    public static final int f21220r = 0;
    public final RectF f21221o;
    public final Rect f21222p;
    public final o3 f21223q;

    public m3(o3 o3Var, o3 o3Var2) {
        super(o3Var2);
        this.f21223q = o3Var;
        this.f21221o = new RectF();
        this.f21222p = new Rect();
    }

    @Override
    public final int g(float f7, float f10) {
        l3 c10;
        o3 o3Var = this.f21223q;
        if (o3Var.f21282b) {
            ArrayList<n3> tabs = o3Var.getTabs();
            if (!tabs.isEmpty() && (c10 = o3Var.c(tabs.get(0))) != null) {
                float c11 = c10.c();
                RectF rectF = this.f21221o;
                o3Var.d(rectF, c11);
                Rect bounds = c10.f21182k.getBounds();
    ...
    public final void l(int i10, s0.c cVar) {
        ...
        if (i10 == 2) {
            Rect bounds = l3Var.f21182k.getBounds();
