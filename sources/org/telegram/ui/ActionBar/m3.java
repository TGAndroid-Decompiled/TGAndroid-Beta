...
public final class m3 {
    public final o3 f19400a;
    public int f19401b;
    public int f19402c;
    public final org.telegram.ui.Components.c6 d;
    public final org.telegram.ui.Components.c6 e;
    public final Paint f19403f = new Paint(1);
    public final Paint f19404g = new Paint(1);
    public final Paint h;
    public final Paint f19405i;
    public int f19406j;
    public final org.telegram.ui.Cells.z f19407k;
    public int f19408l;
    public final int f19409m;
    public boolean f19410n;
    public final boolean f19411o;
    public final float f19412p;
    public final Bitmap f19413q;
    public final Drawable f19414r;
    public int f19415s;
    public final h01 f19416t;
    public h01 f19417u;
    public float v;
    public final float[] f19418w;
    public final Path f19419x;
    public final Path f19420y;
    public final Path f19421z;
    ...
    public m3(View view, o3 o3Var) {
        ...
        this.h = paint;
        this.f19405i = new Paint(3);
        org.telegram.ui.Cells.z f02 = j6.f0(822083583, 1, -1);
        this.f19407k = f02;
        this.f19415s = -1;
        this.f19418w = new float[8];
        this.f19419x = new Path();
        Path path = new Path();
        this.f19420y = path;
        Path path2 = new Path();
        this.f19421z = path2;
        ...
        this.f19413q = o3Var.F;
        String b10 = o3Var.b();
        textPaint = p3.getTextPaint();
        this.f19416t = new h01(Emoji.replaceEmoji(b10, textPaint.getFontMetricsInt(), false), 17.0f, AndroidUtilities.bold());
        int i10 = o3Var.f19466q;
        this.f19409m = i10;
        this.f19411o = AndroidUtilities.computePerceivedBrightness(i10) < 0.721f;
        ...
        if (h4Var != null) {
            ...
            if (!arrayList.isEmpty()) {
                ...
                if ((h instanceof TLRPC.WebPage) && ((page = ((TLRPC.WebPage) h).cached_page) == null || page.local == null)) {
                    this.f19414r = view.getContext().getResources().getDrawable(R.drawable.msg_instant).mutate();
                }
            }
        }
        this.f19412p = o3Var.I;
        path.rewind();
    ...
    public final void a(Canvas canvas, RectF rectF, float f7, float f10, float f11) {
        ...
        int d = i0.a.d(this.v, this.f19408l, this.f19409m);
        Paint paint = this.f19403f;
        paint.setColor(d);
        ...
        fArr[5] = lerp;
        fArr[4] = lerp;
        Path path = this.f19419x;
        path.rewind();
        path.addRoundRect(rectF, fArr, Path.Direction.CW);
        canvas2.drawPath(path, paint);
        float f18 = this.f19412p;
        ...
        org.telegram.ui.Cells.z zVar = this.f19407k;
        ...
        h01 h01Var = this.f19417u;
        if (h01Var != null) {
            h01Var.f24449p = (int) ((rectF.width() - AndroidUtilities.dp(100.0f)) - f15);
            h01Var.c(rectF.left + AndroidUtilities.dp(60.0f) + i11, rectF.centerY(), org.telegram.messenger.w1.A(1.0f, this.v, f10, f11), d10, canvas2);
        }
        float width = rectF.width() - AndroidUtilities.dp(100.0f);
        h01 h01Var2 = this.f19416t;
        h01Var2.f24449p = (int) (width - f13);
        ...
        h01Var2.c(dp5, centerY, f14 * f10 * f11, d10, canvas);
    }
    ...
    public final float c() {
        ...
        return this.d.d(this.f19401b, false);
    }
}
