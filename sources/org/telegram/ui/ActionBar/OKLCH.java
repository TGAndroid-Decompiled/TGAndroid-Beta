...
public abstract class OKLCH implements BottomSheet.BottomSheetDelegateInterface {
    ...
    public static SparseArray createColorKeysMap() {
        ...
        sparseArray.put(Theme.key_chat_inTableBackground, "chat_inTableBackground");
        sparseArray.put(Theme.key_chat_outTableBackground, "chat_outTableBackground");
        sparseArray.put(Theme.key_chat_inTableBorder, "chat_inTableBorder");
        sparseArray.put(Theme.key_chat_outTableBorder, "chat_outTableBorder");
        sparseArray.put(Theme.key_chat_inDivider, "chat_inDivider");
        sparseArray.put(Theme.key_chat_outDivider, "chat_outDivider");
        sparseArray.put(Theme.key_chat_inArticleCodeBackground, "chat_inArticleCodeBackground");
        sparseArray.put(Theme.key_chat_outArticleCodeBackground, "chat_outArticleCodeBackground");
        sparseArray.put(Theme.key_chat_inArticleCodeScrollbarBackground, "chat_inArticleCodeScrollbarBackground");
        sparseArray.put(Theme.key_chat_inArticleCodeScrollbar, "chat_inArticleCodeScrollbar");
        sparseArray.put(Theme.key_chat_outArticleCodeScrollbarBackground, "chat_outArticleCodeScrollbarBackground");
        sparseArray.put(Theme.key_chat_outArticleCodeScrollbar, "chat_outArticleCodeScrollbar");
        sparseArray.put(Theme.key_chat_inArticleDetailsArrow, "chat_inArticleDetailsArrow");
        sparseArray.put(Theme.key_chat_outArticleDetailsArrow, "chat_outArticleDetailsArrow");
        sparseArray.put(Theme.key_chat_inArticleDetailsLine, "chat_inArticleDetailsLine");
        sparseArray.put(Theme.key_chat_outArticleDetailsLine, "chat_outArticleDetailsLine");
        ...
        sparseArray.put(Theme.key_chat_msgIvButtonDefaultIn, "chat_msgIvButtonDefaultIn");
        sparseArray.put(Theme.key_chat_msgIvButtonDefaultInPressed, "chat_msgIvButtonDefaultInPressed");
        sparseArray.put(Theme.key_chat_msgIvButtonDefaultInText, "chat_msgIvButtonDefaultInText");
        sparseArray.put(Theme.key_chat_msgIvButtonPrimaryIn, "chat_msgIvButtonPrimaryIn");
        sparseArray.put(Theme.key_chat_msgIvButtonPrimaryInPressed, "chat_msgIvButtonPrimaryInPressed");
        sparseArray.put(Theme.key_chat_msgIvButtonPrimaryInText, "chat_msgIvButtonPrimaryInText");
        sparseArray.put(Theme.key_chat_msgIvButtonDangerIn, "chat_msgIvButtonDangerIn");
        sparseArray.put(Theme.key_chat_msgIvButtonDangerInPressed, "chat_msgIvButtonDangerInPressed");
        sparseArray.put(Theme.key_chat_msgIvButtonDangerInText, "chat_msgIvButtonDangerInText");
        sparseArray.put(Theme.key_chat_msgIvButtonSuccessIn, "chat_msgIvButtonSuccessIn");
        sparseArray.put(Theme.key_chat_msgIvButtonSuccessInPressed, "chat_msgIvButtonSuccessInPressed");
        sparseArray.put(Theme.key_chat_msgIvButtonSuccessInText, "chat_msgIvButtonSuccessInText");
        sparseArray.put(Theme.key_chat_msgIvButtonDefaultInlineIn, "chat_msgIvButtonDefaultInlineIn");
        sparseArray.put(Theme.key_chat_msgIvButtonDefaultInlineInPressed, "chat_msgIvButtonDefaultInlineInPressed");
        sparseArray.put(Theme.key_chat_msgIvButtonDefaultInlineInText, "chat_msgIvButtonDefaultInlineInText");
        sparseArray.put(Theme.key_chat_msgIvButtonDefaultOut, "chat_msgIvButtonDefaultOut");
        sparseArray.put(Theme.key_chat_msgIvButtonDefaultOutPressed, "chat_msgIvButtonDefaultOutPressed");
        sparseArray.put(Theme.key_chat_msgIvButtonDefaultOutText, "chat_msgIvButtonDefaultOutText");
        sparseArray.put(Theme.key_chat_msgIvButtonPrimaryOut, "chat_msgIvButtonPrimaryOut");
        sparseArray.put(Theme.key_chat_msgIvButtonPrimaryOutPressed, "chat_msgIvButtonPrimaryOutPressed");
        sparseArray.put(Theme.key_chat_msgIvButtonPrimaryOutText, "chat_msgIvButtonPrimaryOutText");
        sparseArray.put(Theme.key_chat_msgIvButtonDangerOut, "chat_msgIvButtonDangerOut");
        sparseArray.put(Theme.key_chat_msgIvButtonDangerOutPressed, "chat_msgIvButtonDangerOutPressed");
        sparseArray.put(Theme.key_chat_msgIvButtonDangerOutText, "chat_msgIvButtonDangerOutText");
        sparseArray.put(Theme.key_chat_msgIvButtonSuccessOut, "chat_msgIvButtonSuccessOut");
        sparseArray.put(Theme.key_chat_msgIvButtonSuccessOutPressed, "chat_msgIvButtonSuccessOutPressed");
        sparseArray.put(Theme.key_chat_msgIvButtonSuccessOutText, "chat_msgIvButtonSuccessOutText");
        sparseArray.put(Theme.key_chat_msgIvButtonDefaultInlineOut, "chat_msgIvButtonDefaultInlineOut");
        sparseArray.put(Theme.key_chat_msgIvButtonDefaultInlineOutPressed, "chat_msgIvButtonDefaultInlineOutPressed");
        sparseArray.put(Theme.key_chat_msgIvButtonDefaultInlineOutText, "chat_msgIvButtonDefaultInlineOutText");
    ...
    public static int[] createDefaultColors() {
        ...
        iArr[Theme.key_chat_msgIvButtonDefaultIn] = -1184275;
        iArr[Theme.key_chat_msgIvButtonDefaultInPressed] = -1184275;
        iArr[Theme.key_chat_msgIvButtonDefaultInText] = -15065823;
        iArr[Theme.key_chat_msgIvButtonPrimaryIn] = -14509328;
        iArr[Theme.key_chat_msgIvButtonPrimaryInPressed] = -14509328;
        iArr[Theme.key_chat_msgIvButtonPrimaryInText] = -459521;
        iArr[Theme.key_chat_msgIvButtonDangerIn] = -464151;
        iArr[Theme.key_chat_msgIvButtonDangerInPressed] = -464151;
        iArr[Theme.key_chat_msgIvButtonDangerInText] = -3387319;
        iArr[Theme.key_chat_msgIvButtonSuccessIn] = -1510172;
        iArr[Theme.key_chat_msgIvButtonSuccessInPressed] = -1510172;
        iArr[Theme.key_chat_msgIvButtonSuccessInText] = -12539616;
        iArr[Theme.key_chat_msgIvButtonDefaultInlineIn] = -1444870;
        iArr[Theme.key_chat_msgIvButtonDefaultInlineInPressed] = -1444870;
        iArr[Theme.key_chat_msgIvButtonDefaultInlineInText] = -14054705;
        iArr[Theme.key_chat_msgIvButtonDefaultOut] = -2296629;
        iArr[Theme.key_chat_msgIvButtonDefaultOutPressed] = -2296629;
        iArr[Theme.key_chat_msgIvButtonDefaultOutText] = -11293879;
        iArr[Theme.key_chat_msgIvButtonPrimaryOut] = -11293879;
        iArr[Theme.key_chat_msgIvButtonPrimaryOutPressed] = -11293879;
        iArr[Theme.key_chat_msgIvButtonPrimaryOutText] = -328455;
        iArr[Theme.key_chat_msgIvButtonDangerOut] = -1381941;
        iArr[Theme.key_chat_msgIvButtonDangerOutPressed] = -1381941;
        iArr[Theme.key_chat_msgIvButtonDangerOutText] = -3387319;
        iArr[Theme.key_chat_msgIvButtonSuccessOut] = -2296629;
        iArr[Theme.key_chat_msgIvButtonSuccessOutPressed] = -2296629;
        ...
        iArr[Theme.key_chat_inTableBackground] = -526345;
        iArr[Theme.key_chat_outTableBackground] = -2166580;
        iArr[Theme.key_chat_inTableBorder] = -2039584;
        iArr[Theme.key_chat_outTableBorder] = -3548234;
        iArr[Theme.key_chat_inDivider] = -1710619;
        iArr[Theme.key_chat_outDivider] = 862894441;
        iArr[Theme.key_chat_inArticleCodeBackground] = -920071;
        iArr[Theme.key_chat_inArticleCodeScrollbarBackground] = -1972501;
        iArr[Theme.key_chat_inArticleCodeScrollbar] = -3813931;
        iArr[Theme.key_chat_outArticleCodeScrollbarBackground] = -1774628;
        iArr[Theme.key_chat_outArticleCodeScrollbar] = -3353150;
        iArr[Theme.key_chat_inArticleDetailsArrow] = -6380376;
        iArr[Theme.key_chat_outArticleDetailsArrow] = -8084613;
        iArr[Theme.key_chat_inArticleDetailsLine] = -2565928;
        iArr[Theme.key_chat_outArticleDetailsLine] = -3417915;
    ...
    public static int m$2(float f, int i, int i2) {
        return (i - AndroidUtilities.dp(f)) / i2;
    }

    public static int m$3(float f, int i, int i2) {
    ...
    public static void m(int i, BaseFragment baseFragment) {
        baseFragment.presentFragment(new ThemeActivity(i));
    }

    public static void m(int i, Theme.ResourcesProvider resourcesProvider, TextView textView, float f) {
        textView.setTextColor(Theme.getColor(i, resourcesProvider));
        textView.setTextSize(1, f);
    }

    public static void m(ViewPropertyAnimator viewPropertyAnimator, float f, long j) {
        viewPropertyAnimator.alpha(f).setDuration(j).start();
    }
