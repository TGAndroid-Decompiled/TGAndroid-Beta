...
public final class x4 {
    ...
    public final PopupWindow f22425c;
    public final int d;
    public final int f22426e;
    public final RelativeLayout f22427f;
    public final ib1 f22428g;
    public final w4 h;
    public final FrameLayout f22429i;
    public final View f22430j;
    public final t4 f22431k;
    public final TextView f22432l;
    public final Drawable f22433m;
    public final Drawable f22434n;
    public final AnimatedVectorDrawable f22435o;
    public final AnimatedVectorDrawable f22436p;
    public final com.google.firebase.messaging.n f22437q;
    public final v4 f22438r;
    public final Interpolator f22439s;
    public final Interpolator f22440t;
    public final Interpolator f22441u;
    public final AnimatorSet v;
    public final AnimatorSet f22442w;
    public final AnimatorSet f22443x;
    public final AnimationSet f22444y;
    public final AnimationSet f22445z;
    ...
    public x4(z4 z4Var, Context context, View view) {
        ...
        if (aVar != null) {
            ...
            if (i11 == 0) {
                gradientDrawable.setColor(k6.v0(k6.f21731h5, g6Var));
            } else if (i11 == 2) {
                gradientDrawable.setColor(-115203550);
            } else if (i11 == 1) {
                gradientDrawable.setColor(k6.v0(k6.f21659d6, g6Var));
            }
            relativeLayout2.setBackground(gradientDrawable);
        }
        relativeLayout2.setLayoutParams(new ViewGroup.LayoutParams(-2, -2));
        relativeLayout2.setClipToOutline(true);
        this.f22427f = relativeLayout2;
        ...
        this.f22425c = popupWindow;
        this.d = AndroidUtilities.dp(16.0f);
        this.f22426e = AndroidUtilities.dp(8.0f);
        this.E = AndroidUtilities.dp(48.0f);
        int dp3 = AndroidUtilities.dp(8.0f);
        this.f22438r = new v4();
        this.f22439s = AnimationUtils.loadInterpolator(context, 17563661);
        this.f22440t = AnimationUtils.loadInterpolator(context, 17563662);
        this.f22441u = AnimationUtils.loadInterpolator(context, 17563663);
        ...
        this.f22435o = animatedVectorDrawable;
        ...
        this.f22436p = animatedVectorDrawable2;
        animatedVectorDrawable2.setAutoMirrored(true);
        FrameLayout frameLayout = new FrameLayout(context);
        this.f22429i = frameLayout;
        ...
        if (i11 == 0) {
            ...
            if (i11 == 2) {
                ...
                view2.setBackgroundColor(k6.v0(k6.f21660d7, g6Var));
            }
        }
        mutate2.setTint(v02);
        mutate.setTint(v02);
        ...
        this.f22428g = new ib1(this, context, 5);
        this.f22437q = new com.google.firebase.messaging.n(this, context, i10);
        ...
        w4Var.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public final void onItemClick(AdapterView adapterView, View view3, int i15, long j10) {
                ...
                z4 z4Var2 = x4Var.Q;
                if (z4Var2.f22497j != null && z4.f22489r.contains(Integer.valueOf(menuItem.getItemId()))) {
                    int i16 = -x4Var.P;
                    x4Var.P = i16;
        ...
        this.f22444y = animationSet;
        animationSet.setAnimationListener(f2Var);
        AnimationSet animationSet2 = new AnimationSet(true);
        this.f22445z = animationSet2;
        ...
        this.v = animatorSet;
        this.f22442w = z4.a(relativeLayout3, 150, new u4(this, 0));
        this.f22443x = z4.a(relativeLayout3, 0, new u4(this, 1));
    }

    public static void a(x4 x4Var) {
        FrameLayout frameLayout = x4Var.f22429i;
        RelativeLayout relativeLayout = x4Var.f22427f;
        if (x4Var.M) {
            x4Var.f22428g.setY(relativeLayout.getHeight() - x4Var.J.getHeight());
    ...
    public static boolean b(x4 x4Var) {
        boolean z4;
        boolean z10;
        AnimationSet animationSet = x4Var.f22445z;
        AnimationSet animationSet2 = x4Var.f22444y;
    ...
    public final void d() {
        this.f22427f.clearAnimation();
        this.f22428g.animate().cancel();
    ...
    public final void g() {
        boolean z4 = this.N;
        Interpolator interpolator = this.f22440t;
        w4 w4Var = this.h;
        ib1 ib1Var = this.f22428g;
        v4 v4Var = this.f22438r;
        Interpolator interpolator2 = this.f22439s;
        FrameLayout frameLayout = this.f22429i;
        RelativeLayout relativeLayout = this.f22427f;
        t4 t4Var = this.f22431k;
        if (z4) {
            AnimatedVectorDrawable animatedVectorDrawable = this.f22436p;
            ...
            q4Var.setDuration(e());
            AnimationSet animationSet = this.f22445z;
            ...
            this.N = false;
            n();
            ib1Var.animate().alpha(1.0f).withLayer().setInterpolator(this.f22441u).setDuration(100L).start();
            w4Var.animate().alpha(0.0f).withLayer().setInterpolator(interpolator).setDuration(150L).start();
            return;
        }
        AnimatedVectorDrawable animatedVectorDrawable2 = this.f22435o;
        ...
        AnimationSet animationSet2 = this.f22444y;
    ...
    public final void h() {
        ...
        relativeLayout.addView(this.f22428g);
        if (this.I != null) {
            relativeLayout.addView(this.f22429i);
        }
        k();
        j();
    }
    ...
    public final void i(Rect rect) {
        View view = this.f22424b;
        Rect rect2 = this.A;
        view.getWindowVisibleDisplayFrame(rect2);
        int centerX = rect.centerX();
        PopupWindow popupWindow = this.f22425c;
    ...
    public final void k() {
        ...
        if (z4) {
            ...
            t4Var.setImageDrawable(this.f22433m);
            ...
            if (this.M) {
                ...
                ib1Var.setY(size2.getHeight() - relativeLayout.getHeight());
        ...
        t4Var.setImageDrawable(this.f22434n);
        frameLayout.setContentDescription(LocaleController.getString(R.string.AccDescrMoreOptions));
        if (this.I != null) {
    ...
    public final void p() {
        ...
        popupWindow.setHeight((this.f22426e * 2) + i10);
        Size size3 = this.J;
        if (size3 != null && this.I != null) {
            int width = size3.getWidth() - this.I.getWidth();
            int height = this.I.getHeight() - this.J.getHeight();
            this.O = (int) (Math.sqrt((height * height) + (width * width)) / this.f22427f.getContext().getResources().getDisplayMetrics().density);
        }
    }
}
