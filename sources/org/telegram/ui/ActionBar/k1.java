...
public final class k1 extends LinearLayout {
    public final ActionBarPopupWindow$ActionBarPopupWindowLayout f19331a;
    ...
    public k1(ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout, Context context) {
        super(context);
        this.f19331a = actionBarPopupWindow$ActionBarPopupWindowLayout;
    }

    @Override
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if ((view instanceof l1) && this.f19331a.N != null) {
            return false;
        }
    ...
    public final void onMeasure(int i10, int i11) {
        k1 k1Var = this;
        ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout = k1Var.f19331a;
