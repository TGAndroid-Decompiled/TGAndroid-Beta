...
public abstract class d1 extends FrameLayout {
    ...
    public float f18558a0;
    public Utilities.Callback2 f18559b;
    public float f18560b0;
    public final z0 f18561c;
    ...
    public Matrix f18565n;
    public final int[] f18566r;
    public float f18567s;
    public boolean v;
    public boolean f18568w;
    public final f6 f18569x;
    public final Paint f18570y;
    ...
    public d1(Context context, f6 f6Var) {
        ...
        TextPaint textPaint = z0Var.f26069a;
        ...
        TextPaint textPaint2 = z0Var2.f26069a;
    ...
    public final void c(float f7, boolean z10) {
        ...
        if (!z10) {
            ...
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f18557a, a2);
            this.T = ofFloat;
        ...
        c1 c1Var = (c1) this;
        String str2 = c1Var.f18489f0;
        if (str2 == null) {
            str2 = cd.a((a2 * 2.8f) + 0.2f) + "x";
        }
        if (str2 != null) {
            z0 z0Var = this.f18561c;
            if (!TextUtils.equals(z0Var.f26073g, str2)) {
                z0Var.b();
                z0Var.q(str2, true, true);
            }
        }
        if (c1Var.f18489f0 != null) {
            str = cd.a((a2 * 2.8f) + 0.2f) + "x";
        }
        if (str != null) {
            z0 z0Var2 = this.d;
            if (!TextUtils.equals(z0Var2.f26073g, str)) {
                z0Var2.b();
                z0Var2.q(str, true, true);
            }
        }
        int i10 = j6.sj;
        f6 f6Var = c1Var.f18569x;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.v) {
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18567s), AndroidUtilities.dp(this.f18567s), this.f18570y);
        }
        boolean z10 = this.f18568w;
        Paint paint = this.J;
        if (z10) {
            ...
            if (d < 1.0f) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18567s), AndroidUtilities.dp(this.f18567s), paint2);
            }
            if (this.f18564f != null && this.f18557a < 1.0f && d > 0.0f) {
                Paint paint3 = this.F;
                paint3.setAlpha((int) (d * 255.0f));
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18567s), AndroidUtilities.dp(this.f18567s), paint3);
            }
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18567s), AndroidUtilities.dp(this.f18567s), this.G);
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18567s), AndroidUtilities.dp(this.f18567s), this.H);
            paint.setColor(-1);
        } else {
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18567s), AndroidUtilities.dp(this.f18567s), this.E);
        }
        a(canvas);
        if (!this.L) {
            b(canvas, false);
        }
        if (this.f18557a < 1.0f) {
            canvas.save();
            canvas.clipRect(getPaddingLeft(), getPaddingTop(), (((getWidth() - getPaddingLeft()) - getPaddingRight()) * this.f18557a) + getPaddingLeft(), getHeight() - getPaddingBottom());
        }
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18567s), AndroidUtilities.dp(this.f18567s), paint);
        a(canvas);
        if (!this.L) {
            b(canvas, true);
        }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int[] iArr = this.f18566r;
        getLocationOnScreen(iArr);
        Matrix matrix = this.f18565n;
        if (matrix != null) {
            matrix.reset();
            this.f18565n.postScale(8.0f, 8.0f);
            this.f18565n.postTranslate(-iArr[0], -iArr[1]);
            BitmapShader bitmapShader = this.h;
            if (bitmapShader != null) {
                bitmapShader.setLocalMatrix(this.f18565n);
                invalidate();
            }
        }
        boolean z11 = this.N;
        f6 f6Var = this.f18569x;
        if (z11) {
            Drawable r02 = j6.r0();
            if (r02 instanceof ColorDrawable) {
                ...
                v02 = j6.l1(0.25f, j6.v0(j6.f18863d6, f6Var));
            }
        } else {
            v02 = j6.v0(j6.f18863d6, f6Var);
            if (!j6.I.q()) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f18568w && this.f18564f == null && !this.U && z10) {
            this.V.run();
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            this.f18563d0 = true;
            this.f18558a0 = x10;
            this.f18560b0 = this.f18557a;
            this.f18562c0 = System.currentTimeMillis();
            return true;
        }
        if (action == 2 || action == 1) {
            ...
            if (action == 1) {
                this.f18563d0 = false;
                if (System.currentTimeMillis() - this.f18562c0 < ViewConfiguration.getTapTimeout()) {
                    ...
                    Utilities.Callback2 callback2 = this.f18559b;
                    if (callback2 != null) {
            ...
            float max = ((x10 - this.f18558a0) / Math.max(1, (getWidth() - getPaddingLeft()) - getPaddingRight())) + this.f18560b0;
            if (this.M != null) {
                int i11 = 0;
                while (true) {
                    float[] fArr2 = this.M;
            ...
            boolean z10 = !this.f18563d0;
            c(max, false);
            Utilities.Callback2 callback22 = this.f18559b;
            if (callback22 != null) {
                callback22.run(Float.valueOf(this.f18557a), Boolean.valueOf(z10));
            }
        }
        return true;
    }
