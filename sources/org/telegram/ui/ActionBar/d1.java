...
public abstract class d1 extends FrameLayout {
    ...
    public float f18556a;
    public float f18557a0;
    public Utilities.Callback2 f18558b;
    public float f18559b0;
    public final z0 f18560c;
    public long f18561c0;
    public final z0 d;
    public boolean f18562d0;
    public final org.telegram.ui.Components.c6 e;
    public Bitmap f18563f;
    public BitmapShader h;
    public Matrix f18564n;
    public final int[] f18565r;
    public float f18566s;
    public boolean v;
    public boolean f18567w;
    public final f6 f18568x;
    public final Paint f18569y;
    ...
    public d1(Context context, f6 f6Var) {
        ...
        TextPaint textPaint = z0Var.f26066a;
        ...
        TextPaint textPaint2 = z0Var2.f26066a;
    ...
    public final void c(float f7, boolean z10) {
        ...
        if (!z10) {
            ...
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f18556a, a2);
            this.T = ofFloat;
        ...
        c1 c1Var = (c1) this;
        String str2 = c1Var.f18488f0;
        if (str2 == null) {
            str2 = cd.a((a2 * 2.8f) + 0.2f) + "x";
        }
        if (str2 != null) {
            z0 z0Var = this.f18560c;
            if (!TextUtils.equals(z0Var.f26070g, str2)) {
                z0Var.b();
                z0Var.q(str2, true, true);
            }
        }
        if (c1Var.f18488f0 != null) {
            str = cd.a((a2 * 2.8f) + 0.2f) + "x";
        }
        if (str != null) {
            z0 z0Var2 = this.d;
            if (!TextUtils.equals(z0Var2.f26070g, str)) {
                z0Var2.b();
                z0Var2.q(str, true, true);
            }
        }
        int i10 = j6.sj;
        f6 f6Var = c1Var.f18568x;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.v) {
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18566s), AndroidUtilities.dp(this.f18566s), this.f18569y);
        }
        boolean z10 = this.f18567w;
        Paint paint = this.J;
        if (z10) {
            ...
            if (d < 1.0f) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18566s), AndroidUtilities.dp(this.f18566s), paint2);
            }
            if (this.f18563f != null && this.f18556a < 1.0f && d > 0.0f) {
                Paint paint3 = this.F;
                paint3.setAlpha((int) (d * 255.0f));
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18566s), AndroidUtilities.dp(this.f18566s), paint3);
            }
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18566s), AndroidUtilities.dp(this.f18566s), this.G);
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18566s), AndroidUtilities.dp(this.f18566s), this.H);
            paint.setColor(-1);
        } else {
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18566s), AndroidUtilities.dp(this.f18566s), this.E);
        }
        a(canvas);
        if (!this.L) {
            b(canvas, false);
        }
        if (this.f18556a < 1.0f) {
            canvas.save();
            canvas.clipRect(getPaddingLeft(), getPaddingTop(), (((getWidth() - getPaddingLeft()) - getPaddingRight()) * this.f18556a) + getPaddingLeft(), getHeight() - getPaddingBottom());
        }
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18566s), AndroidUtilities.dp(this.f18566s), paint);
        a(canvas);
        if (!this.L) {
            b(canvas, true);
        }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int[] iArr = this.f18565r;
        getLocationOnScreen(iArr);
        Matrix matrix = this.f18564n;
        if (matrix != null) {
            matrix.reset();
            this.f18564n.postScale(8.0f, 8.0f);
            this.f18564n.postTranslate(-iArr[0], -iArr[1]);
            BitmapShader bitmapShader = this.h;
            if (bitmapShader != null) {
                bitmapShader.setLocalMatrix(this.f18564n);
                invalidate();
            }
        }
        boolean z11 = this.N;
        f6 f6Var = this.f18568x;
        if (z11) {
            Drawable r02 = j6.r0();
            if (r02 instanceof ColorDrawable) {
                ...
                v02 = j6.l1(0.25f, j6.v0(j6.f18862d6, f6Var));
            }
        } else {
            v02 = j6.v0(j6.f18862d6, f6Var);
            if (!j6.I.q()) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f18567w && this.f18563f == null && !this.U && z10) {
            this.V.run();
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            this.f18562d0 = true;
            this.f18557a0 = x10;
            this.f18559b0 = this.f18556a;
            this.f18561c0 = System.currentTimeMillis();
            return true;
        }
        if (action == 2 || action == 1) {
            ...
            if (action == 1) {
                this.f18562d0 = false;
                if (System.currentTimeMillis() - this.f18561c0 < ViewConfiguration.getTapTimeout()) {
                    ...
                    Utilities.Callback2 callback2 = this.f18558b;
                    if (callback2 != null) {
            ...
            float max = ((x10 - this.f18557a0) / Math.max(1, (getWidth() - getPaddingLeft()) - getPaddingRight())) + this.f18559b0;
            if (this.M != null) {
                int i11 = 0;
                while (true) {
                    float[] fArr2 = this.M;
            ...
            boolean z10 = !this.f18562d0;
            c(max, false);
            Utilities.Callback2 callback22 = this.f18558b;
            if (callback22 != null) {
                callback22.run(Float.valueOf(this.f18556a), Boolean.valueOf(z10));
            }
        }
        return true;
    }
