...
public final class b0 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        switch (this.f18641a) {
            case 0:
                v0 v0Var = this.f18642b;
                ArrayList arrayList = v0Var.f19773g0;
                if (v0Var.e.length() != 0) {
                    v0Var.e.setText("");
                } else if (v0Var.p()) {
            ...
            case 1:
                ...
                return;
            case 2:
                v0 v0Var3 = this.f18642b;
                z zVar2 = v0Var3.f19767c;
                if (zVar2 != null) {
