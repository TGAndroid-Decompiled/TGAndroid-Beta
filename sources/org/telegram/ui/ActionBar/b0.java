...
public final class b0 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        switch (this.f18454a) {
            case 0:
                v0 v0Var = this.f18455b;
                ArrayList arrayList = v0Var.f19582g0;
                if (v0Var.e.length() != 0) {
                    v0Var.e.setText("");
                } else if (v0Var.p()) {
            ...
            case 1:
                ...
                return;
            case 2:
                v0 v0Var3 = this.f18455b;
                z zVar2 = v0Var3.f19576c;
                if (zVar2 != null) {
