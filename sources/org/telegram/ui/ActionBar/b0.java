...
public final class b0 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        switch (this.f19495a) {
            case 0:
                w0 w0Var = this.f19496b;
                ArrayList arrayList = w0Var.f20628d0;
                if (w0Var.e.length() != 0) {
                    w0Var.e.setText("");
                } else if (w0Var.p()) {
            ...
            case 1:
                ...
                return;
            case 2:
                w0 w0Var3 = this.f19496b;
                z zVar2 = w0Var3.f20626c;
                if (zVar2 != null) {
