...
public class u0 extends FrameLayout implements le.d {
    public final le.b f21356a;
    public oq f21357b;
    public final x9 f21358c;
    public final ImageView d;
    public final TextView f21359e;
    public hg.q0 f21360f;
    public final q h;
    public final f6 f21361n;
    ...
    public u0(Context context, f6 f6Var) {
        super(context);
        this.f21356a = new le.b(0, this, pr.h, 380L, false);
        this.h = new q(this, 2);
        this.f21361n = f6Var;
        ...
        this.f21364w = AndroidUtilities.dp(28.0f);
        a();
    }
    ...
    public final void a() {
        int v02;
        float f7 = this.f21356a.f15368e;
        boolean z10 = this.f21362r;
        f6 f6Var = this.f21361n;
        if (z10) {
            v02 = j6.l1(0.075f, j6.v0(j6.G6, f6Var));
        } else {
            v02 = j6.v0(j6.f20657ci, f6Var);
        }
        int i10 = j6.Oh;
        ...
        this.f21359e.setTextColor(i0.a.d(f7, v04, v05));
        ...
        oq oqVar = this.f21357b;
        if (oqVar != null) {
            j6.v1(oqVar, j6.v0(i10, f6Var), false);
            j6.v1(this.f21357b, j6.v0(i11, f6Var), true);
        }
        this.f21358c.setAlpha(1.0f - f7);
        hg.q0 q0Var = this.f21360f;
    ...
    public void setData(hg.q0 q0Var) {
        ...
        if (i12 == 4) {
            ...
            if (tLObject instanceof TLRPC.User) {
                ...
                x9Var.getImageReceiver().setForUserOrChat(user, this.f21357b);
            } else if (tLObject instanceof TLRPC.Chat) {
                TLRPC.Chat chat = (TLRPC.Chat) tLObject;
                this.f21363s = ChatObject.isCommunity(chat);
                ...
                x9Var.getImageReceiver().setForUserOrChat(chat, this.f21357b);
            }
        } else if (i12 == 7) {
            ...
            x9Var.setImageDrawable(this.f21357b);
        }
    }

    public void setExpanded(boolean z10) {
        TextView textView = this.f21359e;
        if (z10) {
