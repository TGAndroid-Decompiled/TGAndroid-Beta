    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        switch (this.f18862a) {
            case 0:
                ...
                while (true) {
                    ...
                    if (i10 < size) {
                        ...
                        if (z10 && !this.f18864c) {
                            h5 h5Var = kVar.f19555n[0];
                            if (h5Var != null) {
                                h5Var.setVisibility(8);
                            }
                            h5 h5Var2 = kVar.f19555n[1];
                            if (h5Var2 != null) {
            ...
            default:
                ...
                vi0Var.E = f7;
                vi0Var.f38757x = false;
                vi0Var.f38759y = false;
                vi0Var.H.setAlpha(f7);
                if (z11) {
                    vi0Var.f38755w = false;
                    vi0Var.v = false;
                }
                qf qfVar2 = vi0Var.S;
                if (qfVar2 != null) {
                ...
                org.telegram.ui.Cells.u1 u1Var2 = vi0Var.f38749r0;
                if (u1Var2 != null) {
                    u1Var2.setVisibility(0);
                }
                vg vgVar = vi0Var.W;
                if (vgVar != null && !vi0Var.f38750s) {
                    vgVar.setAlpha(1.0f);
                }
                if (!z11 && (ii0Var = vi0Var.X) != null) {
                    ii0Var.setAlpha(0.0f);
                }
                if (!this.f18864c && (viewGroup = vi0Var.Z) != null) {
                ...
                vi0Var.G.invalidate();
                if (runnable != null) {
                    if (!z11 && (u1Var = vi0Var.f38749r0) != null && u1Var.isAttachedToWindow()) {
                        vi0Var.f38749r0.post(runnable);
                        return;
