...
public class BottomSheet extends Dialog implements BaseFragment.AttachedSheet {
    ...
    @Override
    public View mo1155getWindowView() {
        return this.container;
    }
    ...
    public void setOverlayNavBarColor(int i) {
        ...
        if (this.attachedFragment != null) {
            ...
            AndroidUtilities.setLightNavigationBar(mo1155getWindowView(), AndroidUtilities.computePerceivedBrightness(getNavigationBarColor(getThemedColor(Theme.key_windowBackgroundGray))) >= 0.721f);
        } else {
