...
public final class j3 {
    public final l3 f19488a;
    public int f19489b;
    public int f19490c;
    public final org.telegram.ui.Components.e6 d;
    public final org.telegram.ui.Components.e6 e;
    public final Paint f19491f = new Paint(1);
    public final Paint f19492g = new Paint(1);
    public final Paint h;
    public final Paint f19493i;
    public int f19494j;
    public final org.telegram.ui.Cells.z f19495k;
    public int f19496l;
    public final int f19497m;
    public boolean f19498n;
    public final boolean f19499o;
    public final float f19500p;
    public final Bitmap f19501q;
    public final Drawable f19502r;
    public int f19503s;
    public final u01 f19504t;
    public u01 f19505u;
    public float v;
    public final float[] f19506w;
    public final Path f19507x;
    public final Path f19508y;
    public final Path f19509z;
    ...
    public j3(View view, l3 l3Var) {
        ...
        this.h = paint;
        this.f19493i = new Paint(3);
        org.telegram.ui.Cells.z f02 = h6.f0(822083583, 1, -1);
        this.f19495k = f02;
        this.f19503s = -1;
        this.f19506w = new float[8];
        this.f19507x = new Path();
        Path path = new Path();
        this.f19508y = path;
        Path path2 = new Path();
        this.f19509z = path2;
        ...
        this.f19501q = l3Var.F;
        String b10 = l3Var.b();
        textPaint = m3.getTextPaint();
        this.f19504t = new u01(Emoji.replaceEmoji(b10, textPaint.getFontMetricsInt(), false), 17.0f, AndroidUtilities.bold());
        int i10 = l3Var.f19610q;
        this.f19497m = i10;
        this.f19499o = AndroidUtilities.computePerceivedBrightness(i10) < 0.721f;
        ...
        if (i4Var != null) {
            ...
            if (!arrayList.isEmpty()) {
                ...
                if ((g10 instanceof TLRPC.WebPage) && ((page = ((TLRPC.WebPage) g10).cached_page) == null || page.local == null)) {
                    this.f19502r = view.getContext().getResources().getDrawable(R.drawable.msg_instant).mutate();
                }
            }
        }
        this.f19500p = l3Var.I;
        path.rewind();
    ...
    public final void a(Canvas canvas, RectF rectF, float f7, float f10, float f11) {
        ...
        int d = i0.a.d(this.v, this.f19496l, this.f19497m);
        Paint paint = this.f19491f;
        paint.setColor(d);
        ...
        fArr[5] = lerp;
        fArr[4] = lerp;
        Path path = this.f19507x;
        path.rewind();
        path.addRoundRect(rectF, fArr, Path.Direction.CW);
        canvas2.drawPath(path, paint);
        float f18 = this.f19500p;
        ...
        org.telegram.ui.Cells.z zVar = this.f19495k;
        ...
        u01 u01Var = this.f19505u;
        if (u01Var != null) {
            u01Var.f28659p = (int) ((rectF.width() - AndroidUtilities.dp(100.0f)) - f15);
            u01Var.c(rectF.left + AndroidUtilities.dp(60.0f) + i11, rectF.centerY(), org.telegram.messenger.f0.z(1.0f, this.v, f10, f11), d10, canvas2);
        }
        float width = rectF.width() - AndroidUtilities.dp(100.0f);
        u01 u01Var2 = this.f19504t;
        u01Var2.f28659p = (int) (width - f13);
        float dp5 = i11 + rectF.left + AndroidUtilities.dp(60.0f);
        float centerY = rectF.centerY();
        if (this.f19505u == null) {
            f14 = 1.0f;
        } else {
            f14 = this.v;
        }
        u01Var2.c(dp5, centerY, f14 * f10 * f11, d10, canvas);
    }
    ...
    public final float c() {
        ...
        return this.d.d(this.f19489b, false);
    }
}
