...
public final class j3 extends Dialog {
    public final v3 f18780a;
    public final i3 f18781b;
    public final eb f18782c;
    ...
    public j3(v3 v3Var) {
        ...
        this.f18782c = ebVar;
        paint.setColor(j6.w0(null, j6.f18806a7, false));
    ...
    public static void b(v3 v3Var) {
        ...
        if (U != null) {
            if (AndroidUtilities.isTablet() || v3Var.b() || AndroidUtilities.hasDialogOnTop(U)) {
                ...
                if (v3Var.c(j3Var)) {
                    i3 i3Var = j3Var.f18781b;
                    View view = (View) i3Var.f18748a;
