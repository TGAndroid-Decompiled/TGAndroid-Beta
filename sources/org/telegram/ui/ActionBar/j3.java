...
public final class j3 {
    public final l3 f19474a;
    public int f19475b;
    public int f19476c;
    public final org.telegram.ui.Components.e6 d;
    public final org.telegram.ui.Components.e6 e;
    public final Paint f19477f = new Paint(1);
    public final Paint f19478g = new Paint(1);
    public final Paint h;
    public final Paint f19479i;
    public int f19480j;
    public final org.telegram.ui.Cells.z f19481k;
    public int f19482l;
    public final int f19483m;
    public boolean f19484n;
    public final boolean f19485o;
    public final float f19486p;
    public final Bitmap f19487q;
    public final Drawable f19488r;
    public int f19489s;
    public final t01 f19490t;
    public t01 f19491u;
    public float v;
    public final float[] f19492w;
    public final Path f19493x;
    public final Path f19494y;
    public final Path f19495z;
    ...
    public j3(View view, l3 l3Var) {
        ...
        this.h = paint;
        this.f19479i = new Paint(3);
        org.telegram.ui.Cells.z f02 = h6.f0(822083583, 1, -1);
        this.f19481k = f02;
        this.f19489s = -1;
        this.f19492w = new float[8];
        this.f19493x = new Path();
        Path path = new Path();
        this.f19494y = path;
        Path path2 = new Path();
        this.f19495z = path2;
        ...
        this.f19487q = l3Var.F;
        String b10 = l3Var.b();
        textPaint = m3.getTextPaint();
        this.f19490t = new t01(Emoji.replaceEmoji(b10, textPaint.getFontMetricsInt(), false), 17.0f, AndroidUtilities.bold());
        int i10 = l3Var.f19596q;
        this.f19483m = i10;
        this.f19485o = AndroidUtilities.computePerceivedBrightness(i10) < 0.721f;
        ...
        if (i4Var != null) {
            ...
            if (!arrayList.isEmpty()) {
                ...
                if ((g10 instanceof TLRPC.WebPage) && ((page = ((TLRPC.WebPage) g10).cached_page) == null || page.local == null)) {
                    this.f19488r = view.getContext().getResources().getDrawable(R.drawable.msg_instant).mutate();
                }
            }
        }
        this.f19486p = l3Var.I;
        path.rewind();
    ...
    public final void a(Canvas canvas, RectF rectF, float f7, float f10, float f11) {
        ...
        int d = i0.a.d(this.v, this.f19482l, this.f19483m);
        Paint paint = this.f19477f;
        paint.setColor(d);
        ...
        fArr[5] = lerp;
        fArr[4] = lerp;
        Path path = this.f19493x;
        path.rewind();
        path.addRoundRect(rectF, fArr, Path.Direction.CW);
        canvas2.drawPath(path, paint);
        float f18 = this.f19486p;
        ...
        org.telegram.ui.Cells.z zVar = this.f19481k;
        ...
        t01 t01Var = this.f19491u;
        if (t01Var != null) {
            t01Var.f28367p = (int) ((rectF.width() - AndroidUtilities.dp(100.0f)) - f15);
        ...
        t01 t01Var2 = this.f19490t;
        t01Var2.f28367p = (int) (width - f13);
    ...
    public final float c() {
        ...
        return this.d.d(this.f19475b, false);
    }
}
