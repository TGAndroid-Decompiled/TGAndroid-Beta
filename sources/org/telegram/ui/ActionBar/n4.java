    ...
    public final void applyTransformation(float f7, Transformation transformation) {
        switch (this.f19683a) {
            case 0:
                ...
                return;
            case 1:
                int i12 = this.f19684b;
                int i13 = this.f19685c;
                v4 v4Var2 = this.e;
                RelativeLayout relativeLayout2 = v4Var2.f19847f;
                ...
                v4Var2.f19848g.setX(relativeLayout2.getWidth() - i13);
                v4Var2.h.setX(relativeLayout2.getWidth() - i12);
                return;
            case 2:
                int i14 = this.f19684b;
                int i15 = this.f19685c;
                v4 v4Var3 = this.e;
                RelativeLayout relativeLayout3 = v4Var3.f19847f;
                ...
                return;
            default:
                int i16 = this.f19684b;
                int i17 = this.f19685c;
                v4 v4Var4 = this.e;
                RelativeLayout relativeLayout4 = v4Var4.f19847f;
                ...
                v4Var4.f19848g.setX(relativeLayout4.getWidth() - i16);
