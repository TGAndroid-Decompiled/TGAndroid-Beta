...
public final class k2 extends g3 {
    public final n2 f20333b;
    public final e5[] f20334c;
    public final p2 d;
    public final g3[] e;
    ...
    public final boolean canSwipeToBack(MotionEvent motionEvent) {
        e5[] e5VarArr;
        e5 e5Var;
        n2 n2Var = this.f20333b;
        if (n2Var == null || !n2Var.f20453a || (e5Var = (e5VarArr = this.f20334c)[0]) == null || e5Var.getFragmentStack().size() > 1 || (e5VarArr[0].getFragmentStack().size() == 1 && !((p2) e5VarArr[0].getFragmentStack().get(0)).isSwipeBackEnabled(motionEvent))) {
            return false;
        }
        return true;
    }
    ...
    public final void dismiss() {
        n2 n2Var;
        Runnable runnable;
        if (!isDismissed() && (n2Var = this.f20333b) != null && (runnable = n2Var.d) != null) {
            runnable.run();
        }
        super.dismiss();
        ArrayList arrayList = LaunchActivity.D1.M;
        e5[] e5VarArr = this.f20334c;
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (n2Var != null && n2Var.e) {
            ...
            fixNavigationBar(j6.v0(j6.f19970i5, p2Var.getResourceProvider()));
        }
    ...
    public final void onOpenAnimationEnd() {
        ...
        n2 n2Var = this.f20333b;
        if (n2Var != null && (runnable = n2Var.f20455c) != null) {
            runnable.run();
        }
    }
}
