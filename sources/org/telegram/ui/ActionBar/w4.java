...
public final class w4 {
    public static final i4 f19646p = new Object();
    public static final List f19647q = Arrays.asList(Integer.valueOf(R.id.menu_regular), Integer.valueOf(R.id.menu_bold), Integer.valueOf(R.id.menu_italic), Integer.valueOf(R.id.menu_strike), Integer.valueOf(R.id.menu_mono), Integer.valueOf(R.id.menu_underline), Integer.valueOf(R.id.menu_spoiler), Integer.valueOf(R.id.menu_link), Integer.valueOf(R.id.menu_quote), Integer.valueOf(R.id.menu_date));
    public static final List f19648r = Arrays.asList(Integer.valueOf(R.id.menu_bold), Integer.valueOf(R.id.menu_italic), Integer.valueOf(R.id.menu_strike), Integer.valueOf(R.id.menu_link), Integer.valueOf(R.id.menu_mono), Integer.valueOf(R.id.menu_underline), Integer.valueOf(R.id.menu_spoiler), Integer.valueOf(R.id.menu_quote));
    public final View f19649a;
    public final u4 f19650b;
    public Menu e;
    public final int f19654i;
    public Runnable f19655j;
    public rt f19656k;
    public final d6 f19659n;
    public final ah.c f19660o;
    public final Rect f19651c = new Rect();
    public final Rect d = new Rect();
    public ArrayList f19652f = new ArrayList();
    public MenuItem.OnMenuItemClickListener f19653g = f19646p;
    public boolean h = true;
    public final j4 f19657l = new j4(this);
    public final a4.e f19658m = new a4.e(23);
    ...
    public w4(Context context, View view, int i10, d6 d6Var, ah.c cVar) {
        ...
        this.f19660o = cVar;
        this.f19659n = d6Var;
        this.f19650b = new u4(this, context, view);
    }
    ...
    public static LinearLayout b(w4 w4Var, Context context, MenuItem menuItem, boolean z10, boolean z11, boolean z12) {
        ...
        int v03 = h6.v0(h6.f18878i6, d6Var);
        int i13 = w4Var.f19654i;
        if (i13 == 0) {
            v02 = h6.v0(h6.f18895j5, d6Var);
    ...
    public final ArrayList d(Menu menu) {
        ...
        for (int i10 = 0; menu != null && i10 < menu.size(); i10++) {
            ...
            if (item.isVisible() && item.isEnabled()) {
                ...
                } else if ((item.getItemId() != R.id.menu_quote || (rtVar = this.f19656k) == null || ((Boolean) rtVar.run()).booleanValue()) && item.getItemId() != 16908353 && item.getItemId() != 16909808 && (item.getItemId() != R.id.menu_regular || this.f19655j == null)) {
                    arrayList.add(item);
                }
            }
        }
