...
public final class w4 {
    ...
    public final View f19638b;
    public final PopupWindow f19639c;
    public final int d;
    public final int e;
    public final RelativeLayout f19640f;
    public final dc1 f19641g;
    public final v4 h;
    public final FrameLayout f19642i;
    public final View f19643j;
    public final s4 f19644k;
    public final TextView f19645l;
    public final Drawable f19646m;
    public final Drawable f19647n;
    public final AnimatedVectorDrawable f19648o;
    public final AnimatedVectorDrawable f19649p;
    public final com.google.firebase.messaging.p f19650q;
    public final u4 f19651r;
    public final Interpolator f19652s;
    public final Interpolator f19653t;
    public final Interpolator f19654u;
    public final AnimatorSet v;
    public final AnimatorSet f19655w;
    public final AnimatorSet f19656x;
    public final AnimationSet f19657y;
    public final AnimationSet f19658z;
    ...
    public w4(y4 y4Var, Context context, View view) {
        ...
        f6 f6Var = y4Var.f19737n;
        int i11 = y4Var.f19732i;
        ...
        if (cVar != null) {
            ...
            if (i11 == 0) {
                gradientDrawable.setColor(j6.v0(j6.f18933h5, f6Var));
            } else if (i11 == 2) {
                gradientDrawable.setColor(-115203550);
            } else if (i11 == 1) {
                gradientDrawable.setColor(j6.v0(j6.f18862d6, f6Var));
            }
            relativeLayout2.setBackground(gradientDrawable);
        }
        relativeLayout2.setLayoutParams(new ViewGroup.LayoutParams(-2, -2));
        relativeLayout2.setClipToOutline(true);
        this.f19640f = relativeLayout2;
        ...
        this.f19639c = popupWindow;
        this.d = AndroidUtilities.dp(16.0f);
        this.e = AndroidUtilities.dp(8.0f);
        this.E = AndroidUtilities.dp(48.0f);
        int dp3 = AndroidUtilities.dp(8.0f);
        this.f19651r = new u4();
        this.f19652s = AnimationUtils.loadInterpolator(context, 17563661);
        this.f19653t = AnimationUtils.loadInterpolator(context, 17563662);
        this.f19654u = AnimationUtils.loadInterpolator(context, 17563663);
        ...
        this.f19648o = animatedVectorDrawable;
        ...
        this.f19649p = animatedVectorDrawable2;
        animatedVectorDrawable2.setAutoMirrored(true);
        FrameLayout frameLayout = new FrameLayout(context);
        this.f19642i = frameLayout;
        ...
        if (i11 == 0) {
            ...
            if (i11 == 2) {
                ...
                view2.setBackgroundColor(j6.v0(j6.f18863d7, f6Var));
            }
        }
        mutate2.setTint(v02);
        mutate.setTint(v02);
        ...
        this.f19641g = new dc1(this, context, 4);
        ?? obj = new Object();
        obj.e = this;
        obj.f7345c = context;
        obj.f7343a = i10;
        ...
        v4Var.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public final void onItemClick(AdapterView adapterView, View view3, int i15, long j3) {
                ...
                y4 y4Var2 = w4Var.Q;
                if (y4Var2.f19733j != null && y4.f19726r.contains(Integer.valueOf(menuItem.getItemId()))) {
                    int i16 = -w4Var.P;
                    w4Var.P = i16;
        ...
        this.f19657y = animationSet;
        animationSet.setAnimationListener(e2Var);
        AnimationSet animationSet2 = new AnimationSet(true);
        this.f19658z = animationSet2;
        ...
        this.v = animatorSet;
        this.f19655w = y4.a(relativeLayout3, 150, new t4(this, 0));
        this.f19656x = y4.a(relativeLayout3, 0, new t4(this, 1));
    }

    public static void a(w4 w4Var) {
        FrameLayout frameLayout = w4Var.f19642i;
        RelativeLayout relativeLayout = w4Var.f19640f;
        if (w4Var.M) {
            w4Var.f19641g.setY(relativeLayout.getHeight() - w4Var.J.getHeight());
    ...
    public static boolean b(w4 w4Var) {
        boolean z10;
        boolean z11;
        AnimationSet animationSet = w4Var.f19658z;
        AnimationSet animationSet2 = w4Var.f19657y;
    ...
    public final void d() {
        this.f19640f.clearAnimation();
        this.f19641g.animate().cancel();
    ...
    public final void g() {
        boolean z10 = this.N;
        Interpolator interpolator = this.f19653t;
        v4 v4Var = this.h;
        dc1 dc1Var = this.f19641g;
        u4 u4Var = this.f19651r;
        Interpolator interpolator2 = this.f19652s;
        FrameLayout frameLayout = this.f19642i;
        RelativeLayout relativeLayout = this.f19640f;
        s4 s4Var = this.f19644k;
        if (z10) {
            AnimatedVectorDrawable animatedVectorDrawable = this.f19649p;
            ...
            p4Var.setDuration(e());
            AnimationSet animationSet = this.f19658z;
            ...
            this.N = false;
            n();
            dc1Var.animate().alpha(1.0f).withLayer().setInterpolator(this.f19654u).setDuration(100L).start();
            v4Var.animate().alpha(0.0f).withLayer().setInterpolator(interpolator).setDuration(150L).start();
            return;
        }
        AnimatedVectorDrawable animatedVectorDrawable2 = this.f19648o;
        ...
        AnimationSet animationSet2 = this.f19657y;
    ...
    public final void h() {
        ...
        relativeLayout.addView(this.f19641g);
        if (this.I != null) {
            relativeLayout.addView(this.f19642i);
        }
        k();
        j();
    }
    ...
    public final void i(Rect rect) {
        View view = this.f19638b;
        Rect rect2 = this.A;
        view.getWindowVisibleDisplayFrame(rect2);
        int centerX = rect.centerX();
        PopupWindow popupWindow = this.f19639c;
    ...
    public final void k() {
        ...
        if (z10) {
            ...
            s4Var.setImageDrawable(this.f19646m);
        ...
        s4Var.setImageDrawable(this.f19647n);
        frameLayout.setContentDescription(LocaleController.getString(R.string.AccDescrMoreOptions));
        if (this.I != null) {
    ...
    public final void p() {
        ...
        if (size3 != null && this.I != null) {
            ...
            this.O = (int) (Math.sqrt((height * height) + (width * width)) / this.f19640f.getContext().getResources().getDisplayMetrics().density);
        }
    }
}
