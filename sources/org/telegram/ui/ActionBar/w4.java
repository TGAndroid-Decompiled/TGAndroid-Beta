...
public final class w4 extends ListView {
    public final x4 f18718a;
    public final LinearGradient f18719b;
    public final Paint f18720c;
    ...
    public w4(x4 x4Var) {
        super(x4Var.f18732a);
        int[] iArr = new int[8];
        PathInterpolator pathInterpolator = xf.z.f45189i;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (z10) {
            canvas.drawRect(0.0f, 0.0f, getWidth(), AndroidUtilities.dp(16.0f), this.f18720c);
        }
        if (z11) {
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        this.f18719b.setLocalMatrix(matrix);
    }
}
