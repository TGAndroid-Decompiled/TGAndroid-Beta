...
public final class w4 {
    ...
    public final PopupWindow f20673c;
    public final int d;
    public final int e;
    public final RelativeLayout f20674f;
    public final pb1 f20675g;
    public final v4 h;
    public final FrameLayout f20676i;
    public final View f20677j;
    public final s4 f20678k;
    public final TextView f20679l;
    public final Drawable f20680m;
    public final Drawable f20681n;
    public final AnimatedVectorDrawable f20682o;
    public final AnimatedVectorDrawable f20683p;
    public final com.google.firebase.messaging.n f20684q;
    public final u4 f20685r;
    public final Interpolator f20686s;
    public final Interpolator f20687t;
    public final Interpolator f20688u;
    public final AnimatorSet v;
    public final AnimatorSet f20689w;
    public final AnimatorSet f20690x;
    public final AnimationSet f20691y;
    public final AnimationSet f20692z;
    ...
    public w4(y4 y4Var, Context context, View view) {
        ...
        if (aVar != null) {
            ...
            if (i11 == 0) {
                gradientDrawable.setColor(j6.v0(j6.f19952h5, f6Var));
            } else if (i11 == 2) {
                gradientDrawable.setColor(-115203550);
            } else if (i11 == 1) {
                gradientDrawable.setColor(j6.v0(j6.f19881d6, f6Var));
            }
            relativeLayout2.setBackground(gradientDrawable);
        }
        relativeLayout2.setLayoutParams(new ViewGroup.LayoutParams(-2, -2));
        relativeLayout2.setClipToOutline(true);
        this.f20674f = relativeLayout2;
        ...
        this.f20673c = popupWindow;
        this.d = AndroidUtilities.dp(16.0f);
        this.e = AndroidUtilities.dp(8.0f);
        this.E = AndroidUtilities.dp(48.0f);
        int dp3 = AndroidUtilities.dp(8.0f);
        this.f20685r = new u4();
        this.f20686s = AnimationUtils.loadInterpolator(context, 17563661);
        this.f20687t = AnimationUtils.loadInterpolator(context, 17563662);
        this.f20688u = AnimationUtils.loadInterpolator(context, 17563663);
        ...
        this.f20682o = animatedVectorDrawable;
        ...
        this.f20683p = animatedVectorDrawable2;
        animatedVectorDrawable2.setAutoMirrored(true);
        FrameLayout frameLayout = new FrameLayout(context);
        this.f20676i = frameLayout;
        ...
        if (i11 == 0) {
            ...
            if (i11 == 2) {
                ...
                view2.setBackgroundColor(j6.v0(j6.f19882d7, f6Var));
            }
        }
        mutate2.setTint(v02);
        mutate.setTint(v02);
        ...
        this.f20675g = new pb1(this, context, 5);
        ?? obj = new Object();
        obj.e = this;
        obj.f4000c = context;
        obj.f3998a = i10;
        ...
        v4Var.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public final void onItemClick(AdapterView adapterView, View view3, int i15, long j10) {
                ...
                y4 y4Var2 = w4Var.Q;
                if (y4Var2.f20738j != null && y4.f20731r.contains(Integer.valueOf(menuItem.getItemId()))) {
                    int i16 = -w4Var.P;
                    w4Var.P = i16;
        ...
        this.f20691y = animationSet;
        animationSet.setAnimationListener(f2Var);
        AnimationSet animationSet2 = new AnimationSet(true);
        this.f20692z = animationSet2;
        ...
        this.v = animatorSet;
        this.f20689w = y4.a(relativeLayout3, 150, new t4(this, 0));
        this.f20690x = y4.a(relativeLayout3, 0, new t4(this, 1));
    }

    public static void a(w4 w4Var) {
        FrameLayout frameLayout = w4Var.f20676i;
        RelativeLayout relativeLayout = w4Var.f20674f;
        if (w4Var.M) {
            w4Var.f20675g.setY(relativeLayout.getHeight() - w4Var.J.getHeight());
    ...
    public static boolean b(w4 w4Var) {
        boolean z4;
        boolean z10;
        AnimationSet animationSet = w4Var.f20692z;
        AnimationSet animationSet2 = w4Var.f20691y;
    ...
    public final void d() {
        this.f20674f.clearAnimation();
        this.f20675g.animate().cancel();
    ...
    public final void g() {
        boolean z4 = this.N;
        Interpolator interpolator = this.f20687t;
        v4 v4Var = this.h;
        pb1 pb1Var = this.f20675g;
        u4 u4Var = this.f20685r;
        Interpolator interpolator2 = this.f20686s;
        FrameLayout frameLayout = this.f20676i;
        RelativeLayout relativeLayout = this.f20674f;
        s4 s4Var = this.f20678k;
        if (z4) {
            AnimatedVectorDrawable animatedVectorDrawable = this.f20683p;
            ...
            p4Var.setDuration(e());
            AnimationSet animationSet = this.f20692z;
            ...
            this.N = false;
            n();
            pb1Var.animate().alpha(1.0f).withLayer().setInterpolator(this.f20688u).setDuration(100L).start();
            v4Var.animate().alpha(0.0f).withLayer().setInterpolator(interpolator).setDuration(150L).start();
            return;
        }
        AnimatedVectorDrawable animatedVectorDrawable2 = this.f20682o;
        ...
        AnimationSet animationSet2 = this.f20691y;
    ...
    public final void h() {
        ...
        relativeLayout.addView(this.f20675g);
        if (this.I != null) {
            relativeLayout.addView(this.f20676i);
        }
        k();
        j();
    }
    ...
    public final void i(Rect rect) {
        ...
        PopupWindow popupWindow = this.f20673c;
    ...
    public final void k() {
        ...
        if (z4) {
            ...
            s4Var.setImageDrawable(this.f20680m);
            ...
            if (this.M) {
                ...
                pb1Var.setY(size2.getHeight() - relativeLayout.getHeight());
        ...
        s4Var.setImageDrawable(this.f20681n);
        frameLayout.setContentDescription(LocaleController.getString(R.string.AccDescrMoreOptions));
        if (this.I != null) {
    ...
    public final void p() {
        ...
        if (size3 != null && this.I != null) {
            ...
            this.O = (int) (Math.sqrt((height * height) + (width * width)) / this.f20674f.getContext().getResources().getDisplayMetrics().density);
        }
    }
}
