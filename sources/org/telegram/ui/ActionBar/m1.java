...
public class m1 extends PopupWindow {
    public static Method f19615k;
    public static final Field f19616l;
    public static final DecelerateInterpolator f19617m = new DecelerateInterpolator();
    public static final f1 f19618n;
    public AnimatorSet f19619a;
    ...
    public ViewTreeObserver f19624i;
    public AnimationNotificationsLocker f19625j;
    ...
    public static void i(ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout) {
        actionBarPopupWindow$ActionBarPopupWindowLayout.f18641n = true;
        ...
        HashMap hashMap = actionBarPopupWindow$ActionBarPopupWindowLayout.f18646y;
        hashMap.clear();
        int i10 = 0;
        ...
        if (actionBarPopupWindow$ActionBarPopupWindowLayout.v) {
            actionBarPopupWindow$ActionBarPopupWindowLayout.f18643s = itemsCount - 1;
        } else {
            actionBarPopupWindow$ActionBarPopupWindowLayout.f18643s = 0;
        }
        ...
        actionBarPopupWindow$ActionBarPopupWindowLayout.f18637a = false;
        actionBarPopupWindow$ActionBarPopupWindowLayout.f18638b = true;
    ...
    public void d(boolean z10) {
        ...
        AnimatorSet animatorSet = this.f19619a;
        ...
        if (this.f19620b && z10) {
            ...
            if (actionBarPopupWindow$ActionBarPopupWindowLayout != null && (arrayList = actionBarPopupWindow$ActionBarPopupWindowLayout.f18645x) != null && !arrayList.isEmpty()) {
                int size = actionBarPopupWindow$ActionBarPopupWindowLayout.f18645x.size();
                for (int i12 = 0; i12 < size; i12++) {
                    AnimatorSet animatorSet2 = (AnimatorSet) actionBarPopupWindow$ActionBarPopupWindowLayout.f18645x.get(i12);
                    animatorSet2.removeAllListeners();
                    animatorSet2.cancel();
                }
                actionBarPopupWindow$ActionBarPopupWindowLayout.f18645x.clear();
            }
            AnimatorSet animatorSet3 = new AnimatorSet();
            this.f19619a = animatorSet3;
            if (j3 > 0) {
                animatorSet3.playTogether(ValueAnimator.ofFloat(0.0f, 1.0f));
                this.f19619a.setDuration(j3);
            } else if (this.f19623g) {
                ...
                this.f19619a.setDuration(this.f19621c);
            } else {
            ...
            this.f19619a.addListener(new g1(this, 1));
            if (this.e) {
                this.f19625j.lock();
            }
            this.f19619a.start();
    ...
    public final void f(View view) {
        ...
        if (this.h != null) {
            ...
            ViewTreeObserver viewTreeObserver2 = this.f19624i;
            if (viewTreeObserver != viewTreeObserver2) {
                if (viewTreeObserver2 != null && viewTreeObserver2.isAlive()) {
                    this.f19624i.removeOnScrollChangedListener(this.h);
                }
                this.f19624i = viewTreeObserver;
    ...
    public final void g() {
        try {
            if (f19615k == null) {
                ...
                f19615k = declaredMethod;
                declaredMethod.setAccessible(true);
            }
            f19615k.invoke(this, Boolean.TRUE);
        } catch (Exception e) {
            FileLog.e(e);
        }
    }
    ...
    public final void h() {
        ...
        if (this.f19620b && this.f19619a == null) {
            ViewGroup viewGroup = (ViewGroup) getContentView();
            if (viewGroup instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                ...
                for (int i10 = 0; i10 < viewGroup.getChildCount(); i10++) {
                    if (viewGroup.getChildAt(i10) instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                        ...
                        actionBarPopupWindow$ActionBarPopupWindowLayout2.f18641n = true;
                    }
                }
            ...
            this.f19619a.setDuration((i11 * 16) + 150);
            this.f19619a.addListener(new g1(this, 0));
            this.f19619a.start();
        }
    }
    ...
    public final void j() {
        ViewTreeObserver viewTreeObserver;
        if (this.h != null && (viewTreeObserver = this.f19624i) != null) {
