...
public class f1 extends FrameLayout {
    ...
    public boolean J;
    public int K;
    public final org.telegram.ui.Components.y5 f18610a;
    public TextView f18611b;
    public final bj0 f18612c;
    public boolean d;
    public op e;
    ...
    public int f18614n;
    public int f18615r;
    public PorterDuff.Mode f18616s;
    public int v;
    public int f18617w;
    ...
    public final void a(int i10) {
        ...
        if (i10 > 0) {
            ...
            org.telegram.ui.Components.y5 y5Var = this.f18610a;
            int i13 = 3;
            if (i10 == 1) {
                ...
                addView(opVar2, w7.x5.e(26, -1, i13 | 16));
            ...
            addView(opVar3, w7.x5.e(26, -1, i13 | 16));
            if (LocaleController.isRTL) {
    ...
    public final void e(int i10, PorterDuff.Mode mode) {
        if (this.f18615r == i10 && this.f18616s == mode) {
            return;
        }
        this.f18615r = i10;
        this.f18616s = mode;
        this.f18612c.setColorFilter(new PorterDuffColorFilter(i10, mode));
    }
    ...
    public final void h(CharSequence charSequence, ImageLocation imageLocation, String str, SvgHelper.SvgDrawable svgDrawable, TLRPC.TL_attachMenuBot tL_attachMenuBot) {
        ...
        if (this.h == null) {
            ...
            addView(w9Var2, w7.x5.e(28, 28, i11 | 16));
        }
        this.f18612c.setVisibility(4);
    ...
    public final void j(boolean z10, boolean z11) {
        if (this.f18618x == z10 && this.f18619y == z11) {
            return;
        }
        this.f18618x = z10;
        this.f18619y = z11;
    ...
    public final void k(boolean z10, boolean z11) {
        if (this.f18618x == z10 && this.f18619y == z11 && this.f18617w == 12) {
            return;
        }
        this.f18618x = z10;
        this.f18619y = z11;
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (opVar != null && opVar.f26827a.f21943q) {
            ...
            accessibilityNodeInfo.setChecked(this.e.f26827a.f21943q);
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (this.H && this.f18610a.getLayout().getLineCount() > 1) {
    ...
    public void setEmojiCacheType(int i10) {
        this.f18610a.setCacheType(i10);
    }

    public void setIcon(int i10) {
        this.K = i10;
        this.f18612c.setImageResource(i10);
    }
    ...
    public void setRightIcon(int i10) {
        ...
        if (this.f18613f == null) {
            ...
            this.f18613f.setColorFilter(this.f18615r, PorterDuff.Mode.MULTIPLY);
            if (LocaleController.isRTL) {
                this.f18613f.setScaleX(-1.0f);
            }
            ImageView imageView2 = this.f18613f;
            if (LocaleController.isRTL) {
                i13 = 3;
            } else {
                i13 = 5;
        ...
        this.f18613f.setImageResource(i10);
    }
    ...
    public void setSubtext(CharSequence charSequence) {
        ...
        if (this.f18611b == null) {
            ...
            textView.setLines(1);
            this.f18611b.setSingleLine(true);
            int i13 = 3;
            this.f18611b.setGravity(3);
            this.f18611b.setEllipsize(TextUtils.TruncateAt.END);
            this.f18611b.setTextColor(h6.v0(h6.f18744ai, this.F));
            this.f18611b.setVisibility(8);
            this.f18611b.setTextSize(1, 13.0f);
            TextView textView2 = this.f18611b;
            if (LocaleController.isRTL) {
                dp = 0;
            } else {
                dp = AndroidUtilities.dp(43.0f);
            ...
            TextView textView3 = this.f18611b;
            if (LocaleController.isRTL) {
                i13 = 5;
            }
        ...
        boolean z11 = !isEmpty;
        if (this.f18611b.getVisibility() != 0) {
            z10 = false;
        }
        if (z11 != z10) {
            TextView textView4 = this.f18611b;
            if (!isEmpty) {
                i11 = 0;
            }
        ...
        this.f18611b.setText(charSequence);
    }
    ...
    public void setText(CharSequence charSequence) {
        this.f18610a.setText(charSequence);
    }

    public void setTextColor(int i10) {
        if (this.f18614n != i10) {
            this.f18614n = i10;
            this.f18610a.setTextColor(i10);
        }
    }
    ...
    public void setIcon(Drawable drawable) {
        this.K = 0;
        this.f18612c.setImageDrawable(drawable);
    }
    ...
    public f1(int i10, Context context, d6 d6Var, boolean z10, boolean z11) {
        ...
        this.f18618x = z10;
        this.f18619y = z11;
        this.f18614n = h6.v0(h6.E8, d6Var);
        this.f18615r = h6.v0(h6.F8, d6Var);
        this.f18616s = PorterDuff.Mode.MULTIPLY;
        ...
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        imageView.setColorFilter(new PorterDuffColorFilter(this.f18615r, PorterDuff.Mode.SRC_IN));
        ...
        y5Var.setTextColor(this.f18614n);
