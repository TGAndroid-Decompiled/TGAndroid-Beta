...
public class f1 extends FrameLayout {
    ...
    public boolean J;
    public int K;
    public final org.telegram.ui.Components.w5 f18623a;
    public TextView f18624b;
    public final aj0 f18625c;
    public boolean d;
    public np e;
    public ImageView f18626f;
    public u9 h;
    public int f18627n;
    public int f18628r;
    public PorterDuff.Mode f18629s;
    public int v;
    public int f18630w;
    ...
    public final void a(int i10) {
        ...
        if (i10 > 0) {
            ...
            org.telegram.ui.Components.w5 w5Var = this.f18623a;
            int i13 = 3;
            if (i10 == 1) {
    ...
    public final void e(int i10, PorterDuff.Mode mode) {
        if (this.f18628r == i10 && this.f18629s == mode) {
            return;
        }
        this.f18628r = i10;
        this.f18629s = mode;
        this.f18625c.setColorFilter(new PorterDuffColorFilter(i10, mode));
    }
    ...
    public final void j(boolean z10, boolean z11) {
        if (this.f18631x == z10 && this.f18632y == z11) {
            return;
        }
        this.f18631x = z10;
        this.f18632y = z11;
    ...
    public final void k(boolean z10, boolean z11) {
        if (this.f18631x == z10 && this.f18632y == z11 && this.f18630w == 12) {
            return;
        }
        this.f18631x = z10;
        this.f18632y = z11;
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (npVar != null && npVar.f26547a.f21972q) {
            ...
            accessibilityNodeInfo.setChecked(this.e.f26547a.f21972q);
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (this.H && this.f18623a.getLayout().getLineCount() > 1) {
    ...
    public void setEmojiCacheType(int i10) {
        this.f18623a.setCacheType(i10);
    }

    public void setIcon(int i10) {
        this.K = i10;
        this.f18625c.setImageResource(i10);
    }
    ...
    public void setRightIcon(int i10) {
        ...
        if (this.f18626f == null) {
            ...
            this.f18626f = imageView;
            imageView.setScaleType(ImageView.ScaleType.CENTER);
            this.f18626f.setColorFilter(this.f18628r, PorterDuff.Mode.MULTIPLY);
            if (LocaleController.isRTL) {
                this.f18626f.setScaleX(-1.0f);
            }
            ImageView imageView2 = this.f18626f;
            if (LocaleController.isRTL) {
                i13 = 3;
            } else {
                i13 = 5;
    ...
    public void setSubtext(CharSequence charSequence) {
        ...
        if (this.f18624b == null) {
            ...
            textView.setLines(1);
            this.f18624b.setSingleLine(true);
            int i13 = 3;
            this.f18624b.setGravity(3);
            this.f18624b.setEllipsize(TextUtils.TruncateAt.END);
            this.f18624b.setTextColor(i6.v0(i6.f18791ai, this.F));
            this.f18624b.setVisibility(8);
            this.f18624b.setTextSize(1, 13.0f);
            TextView textView2 = this.f18624b;
            if (LocaleController.isRTL) {
                dp = 0;
            } else {
                dp = AndroidUtilities.dp(43.0f);
            ...
            TextView textView3 = this.f18624b;
            if (LocaleController.isRTL) {
                i13 = 5;
            }
        ...
        boolean z11 = !isEmpty;
        if (this.f18624b.getVisibility() != 0) {
            z10 = false;
        }
        if (z11 != z10) {
            TextView textView4 = this.f18624b;
            if (!isEmpty) {
                i11 = 0;
            }
        ...
        this.f18624b.setText(charSequence);
    }

    public void setSubtextColor(int i10) {
        TextView textView = this.f18624b;
        if (textView != null) {
    ...
    public void setText(CharSequence charSequence) {
        this.f18623a.setText(charSequence);
    }

    public void setTextColor(int i10) {
        if (this.f18627n != i10) {
            this.f18627n = i10;
            this.f18623a.setTextColor(i10);
        }
    }
    ...
    public void setIcon(Drawable drawable) {
        this.K = 0;
        this.f18625c.setImageDrawable(drawable);
    }
    ...
    public f1(int i10, Context context, e6 e6Var, boolean z10, boolean z11) {
        ...
        this.f18631x = z10;
        this.f18632y = z11;
        this.f18627n = i6.v0(i6.E8, e6Var);
        this.f18628r = i6.v0(i6.F8, e6Var);
        this.f18629s = PorterDuff.Mode.MULTIPLY;
        this.v = i6.v0(i6.I5, e6Var);
        i();
        setPadding(AndroidUtilities.dp(18.0f), 0, AndroidUtilities.dp(18.0f), 0);
        ?? imageView = new ImageView(context);
        this.f18625c = imageView;
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        imageView.setColorFilter(new PorterDuffColorFilter(this.f18628r, PorterDuff.Mode.SRC_IN));
        ...
        w5Var.setTextColor(this.f18627n);
