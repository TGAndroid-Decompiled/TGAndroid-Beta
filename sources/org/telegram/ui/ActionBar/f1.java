...
public class f1 extends FrameLayout {
    ...
    public boolean J;
    public int K;
    public final org.telegram.ui.Components.y5 f18808a;
    public TextView f18809b;
    public final lj0 f18810c;
    public boolean d;
    public np e;
    ...
    public int f18812n;
    public int f18813r;
    public PorterDuff.Mode f18814s;
    public int v;
    public int f18815w;
    ...
    public final void a(int i10) {
        ...
        if (i10 > 0) {
            ...
            org.telegram.ui.Components.y5 y5Var = this.f18808a;
            int i13 = 3;
            if (i10 == 1) {
    ...
    public final void e(int i10, PorterDuff.Mode mode) {
        if (this.f18813r == i10 && this.f18814s == mode) {
            return;
        }
        this.f18813r = i10;
        this.f18814s = mode;
        this.f18810c.setColorFilter(new PorterDuffColorFilter(i10, mode));
    }
    ...
    public final void j(boolean z10, boolean z11) {
        if (this.f18816x == z10 && this.f18817y == z11) {
            return;
        }
        this.f18816x = z10;
        this.f18817y = z11;
    ...
    public final void k(boolean z10, boolean z11) {
        if (this.f18816x == z10 && this.f18817y == z11 && this.f18815w == 12) {
            return;
        }
        this.f18816x = z10;
        this.f18817y = z11;
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (npVar != null && npVar.f26739a.f22158q) {
            ...
            accessibilityNodeInfo.setChecked(this.e.f26739a.f22158q);
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (this.H && this.f18808a.getLayout().getLineCount() > 1) {
    ...
    public void setEmojiCacheType(int i10) {
        this.f18808a.setCacheType(i10);
    }

    public void setIcon(int i10) {
        this.K = i10;
        this.f18810c.setImageResource(i10);
    }
    ...
    public void setRightIcon(int i10) {
        ...
        if (this.f18811f == null) {
            ...
            this.f18811f = imageView;
            imageView.setScaleType(ImageView.ScaleType.CENTER);
            this.f18811f.setColorFilter(this.f18813r, PorterDuff.Mode.MULTIPLY);
            if (LocaleController.isRTL) {
                this.f18811f.setScaleX(-1.0f);
            }
            ImageView imageView2 = this.f18811f;
            if (LocaleController.isRTL) {
                i13 = 3;
            } else {
                i13 = 5;
        ...
        this.f18811f.setImageResource(i10);
    }
    ...
    public void setSubtext(CharSequence charSequence) {
        ...
        if (this.f18809b == null) {
            ...
            textView.setLines(1);
            this.f18809b.setSingleLine(true);
            int i13 = 3;
            this.f18809b.setGravity(3);
            this.f18809b.setEllipsize(TextUtils.TruncateAt.END);
            this.f18809b.setTextColor(j6.v0(j6.f19017ai, this.F));
            this.f18809b.setVisibility(8);
            this.f18809b.setTextSize(1, 13.0f);
            TextView textView2 = this.f18809b;
            if (LocaleController.isRTL) {
                dp = 0;
            } else {
                dp = AndroidUtilities.dp(43.0f);
            ...
            TextView textView3 = this.f18809b;
            if (LocaleController.isRTL) {
                i13 = 5;
            }
        ...
        boolean z11 = !isEmpty;
        if (this.f18809b.getVisibility() != 0) {
            z10 = false;
        }
        if (z11 != z10) {
            TextView textView4 = this.f18809b;
            if (!isEmpty) {
                i11 = 0;
            }
        ...
        this.f18809b.setText(charSequence);
    }

    public void setSubtextColor(int i10) {
        TextView textView = this.f18809b;
        if (textView != null) {
    ...
    public void setText(CharSequence charSequence) {
        this.f18808a.setText(charSequence);
    }

    public void setTextColor(int i10) {
        if (this.f18812n != i10) {
            this.f18812n = i10;
            this.f18808a.setTextColor(i10);
        }
    }
    ...
    public void setIcon(Drawable drawable) {
        this.K = 0;
        this.f18810c.setImageDrawable(drawable);
    }
    ...
    public f1(int i10, Context context, e6 e6Var, boolean z10, boolean z11) {
        ...
        this.f18816x = z10;
        this.f18817y = z11;
        this.f18812n = j6.v0(j6.E8, e6Var);
        this.f18813r = j6.v0(j6.F8, e6Var);
        this.f18814s = PorterDuff.Mode.MULTIPLY;
        ...
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        imageView.setColorFilter(new PorterDuffColorFilter(this.f18813r, PorterDuff.Mode.SRC_IN));
        ...
        y5Var.setTextColor(this.f18812n);
