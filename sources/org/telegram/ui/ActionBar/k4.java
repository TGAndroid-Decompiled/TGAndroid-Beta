...
public final class k4 implements View.OnLayoutChangeListener {
    ...
    public final void onLayoutChange(View view, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17) {
        switch (this.f21161a) {
            case 0:
                Rect rect = (Rect) this.f21162b;
                rect.set(i10, i11, i12, i13);
                Rect rect2 = (Rect) this.f21163c;
                ...
                return;
            default:
                ((fo0) this.f21162b).setProgress(org.telegram.ui.i5.f37268c);
                ((fo0) this.f21163c).setProgress(org.telegram.ui.i5.d);
                ((fo0) this.d).setProgress(org.telegram.ui.i5.f37269e);
                return;
        }
    }
