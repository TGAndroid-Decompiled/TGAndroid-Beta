...
public final class i2 extends f3 {
    public final l2 f18952b;
    public final d5[] f18953c;
    public final n2 d;
    public final f3[] e;
    ...
    public final boolean canSwipeToBack(MotionEvent motionEvent) {
        d5[] d5VarArr;
        d5 d5Var;
        l2 l2Var = this.f18952b;
        if (l2Var == null || !l2Var.f19577a || (d5Var = (d5VarArr = this.f18953c)[0]) == null || d5Var.getFragmentStack().size() > 1 || (d5VarArr[0].getFragmentStack().size() == 1 && !((n2) d5VarArr[0].getFragmentStack().get(0)).isSwipeBackEnabled(motionEvent))) {
            return false;
        }
        return true;
    }
    ...
    public final void dismiss() {
        l2 l2Var;
        Runnable runnable;
        if (!isDismissed() && (l2Var = this.f18952b) != null && (runnable = l2Var.d) != null) {
            runnable.run();
        }
        super.dismiss();
        ArrayList arrayList = LaunchActivity.G1.P;
        d5[] d5VarArr = this.f18953c;
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (l2Var != null && l2Var.e) {
            ...
            fixNavigationBar(j6.v0(j6.f19183i5, n2Var.getResourceProvider()));
        }
    ...
    public final void onOpenAnimationEnd() {
        ...
        l2 l2Var = this.f18952b;
        if (l2Var != null && (runnable = l2Var.f19579c) != null) {
            runnable.run();
        }
    }
}
