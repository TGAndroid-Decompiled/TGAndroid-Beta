...
public final class i2 extends f3 {
    public final l2 f20544b;
    public final d5[] f20545c;
    public final n2 d;
    public final f3[] f20546e;

    public i2(Activity activity, f6 f6Var, l2 l2Var, d5[] d5VarArr, n2 n2Var, f3[] f3VarArr) {
        super(1, (Context) activity, f6Var, true);
        boolean z10;
        this.f20544b = l2Var;
        this.f20545c = d5VarArr;
        this.d = n2Var;
        this.f20546e = f3VarArr;
        if (l2Var != null && l2Var.f21173e) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final boolean canSwipeToBack(MotionEvent motionEvent) {
        d5[] d5VarArr;
        d5 d5Var;
        l2 l2Var = this.f20544b;
        if (l2Var == null || !l2Var.f21170a || (d5Var = (d5VarArr = this.f20545c)[0]) == null || d5Var.getFragmentStack().size() > 1 || (d5VarArr[0].getFragmentStack().size() == 1 && !((n2) d5VarArr[0].getFragmentStack().get(0)).isSwipeBackEnabled(motionEvent))) {
            return false;
        }
        return true;
    }
    ...
    public final void dismiss() {
        l2 l2Var;
        Runnable runnable;
        if (!isDismissed() && (l2Var = this.f20544b) != null && (runnable = l2Var.d) != null) {
            runnable.run();
        }
        super.dismiss();
        ArrayList arrayList = LaunchActivity.G1.P;
        d5[] d5VarArr = this.f20545c;
    ...
    public final void onCreate(Bundle bundle) {
        ...
        d5 d5Var = this.f20545c[0];
        f3[] f3VarArr = this.f20546e;
        ...
        if (l2Var != null && l2Var.f21173e) {
            ...
            fixNavigationBar(j6.v0(j6.f20780i5, n2Var.getResourceProvider()));
        }
    ...
    public final void onOpenAnimationEnd() {
        ...
        l2 l2Var = this.f20544b;
        if (l2Var != null && (runnable = l2Var.f21172c) != null) {
            runnable.run();
        }
    }
}
