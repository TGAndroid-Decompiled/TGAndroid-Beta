...
public final class h3 extends Dialog {
    public final s3 f18958a;
    public final g3 f18959b;
    public final bb f18960c;
    ...
    public h3(s3 s3Var) {
        ...
        this.f18960c = bbVar;
        paint.setColor(h6.w0(null, h6.f19003a7, false));
    ...
    public static void b(s3 s3Var) {
        ...
        if (U != null) {
            if (AndroidUtilities.isTablet() || s3Var.b() || AndroidUtilities.hasDialogOnTop(U)) {
                ...
                if (s3Var.c(h3Var)) {
                    g3 g3Var = h3Var.f18959b;
                    View view = (View) g3Var.f18915a;
