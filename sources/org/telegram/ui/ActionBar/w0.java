...
public final class w0 implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f21449a) {
            case 0:
                c1 c1Var = (c1) this.f21450b;
                c1Var.getClass();
                c1Var.f20297a = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                c1Var.invalidate();
                return;
            case 1:
                f1 f1Var = (f1) this.f21450b;
                float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                f1Var.setTextColor(i0.a.d(floatValue, -1, -9194260));
                f1Var.setIconColor(i0.a.d(floatValue, -1, -9194260));
                return;
            case 2:
                ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout = (ActionBarPopupWindow$ActionBarPopupWindowLayout) this.f21450b;
            ...
            case 3:
                ...
                if (!p1Var.f21279e) {
                    ...
                    float z10 = (int) com.google.android.gms.internal.vision.e2.z(1.0f, floatValue3, p1Var.f21290q, p1Var.f21289p * floatValue3);
                    if (!(p1Var instanceof ah.v)) {
                        p1Var.f21276a.setTranslationY(z10);
                    }
                    p1Var.e(-z10, floatValue3, p1Var.f21292s);
                    return;
                }
                return;
            case 4:
                o3 o3Var = (o3) this.f21450b;
                o3Var.getClass();
                ...
                return;
            default:
                w3 w3Var = (w3) this.f21450b;
                w3Var.f21459i = ((Float) valueAnimator.getAnimatedValue()).floatValue();
