...
public final class w0 implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        switch (this.f19894a) {
            case 0:
                b1 b1Var = (b1) this.f19895b;
                Bitmap bitmap = (Bitmap) obj;
                Paint paint = b1Var.F;
                b1Var.U = false;
                b1Var.f18746f = bitmap;
                Shader.TileMode tileMode = Shader.TileMode.CLAMP;
                b1Var.h = new BitmapShader(bitmap, tileMode, tileMode);
                Matrix matrix = b1Var.f18747n;
                if (matrix == null) {
                    b1Var.f18747n = new Matrix();
                } else {
                    matrix.reset();
                }
                b1Var.f18747n.postScale(8.0f, 8.0f);
                Matrix matrix2 = b1Var.f18747n;
                int[] iArr = b1Var.f18748r;
                matrix2.postTranslate(-iArr[0], -iArr[1]);
                b1Var.h.setLocalMatrix(b1Var.f18747n);
