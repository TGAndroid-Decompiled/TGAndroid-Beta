...
public final class w3 extends View {
    ...
    public n3 f20654a;
    public final RectF f20655a0;
    public t3 f20656b;
    public final RectF f20657b0;
    public k3 f20658c;
    public final Path f20659c0;
    public ValueAnimator d;
    public k01 f20660d0;
    public float e;
    public boolean f20661e0;
    public final org.telegram.ui.Components.z5 f20662f;
    public org.telegram.ui.Cells.z f20663f0;
    public i20 f20664g0;
    ...
    public float f20670y;

    public w3(LaunchActivity launchActivity) {
        super(launchActivity);
        this.f20662f = new org.telegram.ui.Components.z5(this, 0L, 350L, mr.h);
        this.N = new RectF();
        this.O = new ArrayList();
        this.U = new int[2];
        this.V = new int[2];
        this.W = new RectF();
        this.f20655a0 = new RectF();
        this.f20657b0 = new RectF();
        this.f20659c0 = new Path();
        setWillNotDraw(false);
        this.h = new OverScroller(launchActivity);
        ViewConfiguration viewConfiguration = ViewConfiguration.get(launchActivity);
        this.f20665n = viewConfiguration.getScaledMaximumFlingVelocity();
        this.f20666r = viewConfiguration.getScaledMinimumFlingVelocity();
    ...
    public final void b(t3 t3Var) {
        ...
        if (this.f20656b != null && (valueAnimator = this.d) != null) {
            valueAnimator.end();
            this.d = null;
        }
        this.f20656b = t3Var;
        ...
        for (int i10 = 0; i10 < tabDrawables.size(); i10++) {
            ...
            int indexOf = tabs.indexOf(k3Var2.f20335a);
            k3Var2.f20337c = indexOf;
            if (indexOf >= 0) {
                k3Var2.f20336b = indexOf;
            }
        }
        n3Var.n();
        n3Var.o(true);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        t3 t3Var = w3Var.f20656b;
        int[] iArr = w3Var.U;
        int[] iArr2 = w3Var.V;
        RectF rectF3 = w3Var.W;
        if (t3Var != null) {
            w3Var.getLocationOnScreen(iArr2);
            w3Var.f20654a.getLocationOnScreen(iArr);
            w3Var.f20654a.d(rectF3, 0.0f);
            rectF3.offset(iArr[0] - iArr2[0], iArr[1] - iArr2[1]);
            canvas.save();
            canvas.clipRect(0, 0, w3Var.getMeasuredWidth(), w3Var.getMeasuredHeight() - w3Var.f20667s);
            u3 mo37getWindowView = w3Var.f20656b.mo37getWindowView();
            float f19 = w3Var.e;
            RectF rectF4 = w3Var.f20657b0;
            float z10 = mo37getWindowView.z(canvas, rectF3, f19, rectF4, f19);
            if (w3Var.f20658c != null) {
                Path path = w3Var.f20659c0;
                path.rewind();
                ...
                w3Var.f20654a.setupTab(w3Var.f20658c);
                w3Var.f20658c.a(canvas, rectF3, z10, w3Var.e, 1.0f);
                rectF = rectF3;
                canvas.restore();
            } else {
                rectF = rectF3;
        ...
        while (true) {
            ...
            if (((v3) arrayList.get(i15)).d.f20337c >= 0) {
                f18 = 1.0f;
            } else {
                f18 = 0.0f;
            }
        ...
        float d = w3Var.f20662f.d(f23, false);
        ...
        while (i16 < arrayList.size() + 1) {
            if (i16 == arrayList.size()) {
                ...
                k3 k3Var2 = v3Var.d;
                float[] fArr = v3Var.f20595g;
                float f24 = dp;
                Matrix matrix = v3Var.f20594f;
                float[] fArr2 = v3Var.h;
                if (k3Var2 == null) {
                    f11 = 1.0f;
                } else {
                ...
                boolean z11 = z4;
                w3Var.f20654a.d(rectF, Utilities.clamp(k3Var2.c(), 1.0f, 0.0f));
                rectF.offset(w3Var.f20654a.getX(), w3Var.f20654a.getY());
                ...
                if (rectF6.top > f21 || rectF6.bottom < 0.0f) {
                    ...
                    matrix.setPolyToPoly(v3Var.f20595g, 0, v3Var.h, 0, 4);
                    ...
                    RadialGradient radialGradient = v3Var.f20603p;
                    Paint paint = v3Var.f20602o;
                    Paint paint2 = v3Var.f20605r;
                    f13 = lerp;
                    Matrix matrix2 = v3Var.f20604q;
                    m3 m3Var = v3Var.f20593c;
                    f15 = d;
                    Path path2 = v3Var.f20601n;
                    arrayList2 = arrayList;
                    Paint paint3 = v3Var.e;
                    rectF2 = rectF;
                    RectF rectF7 = v3Var.f20600m;
                    i12 = i14;
                    Paint paint4 = v3Var.f20599l;
                    f16 = f21;
                    f14 = f20;
                    float clamp = Utilities.clamp(1.0f - ((Math.abs(v3Var.f20596i) - 0.3f) / 0.7f), 1.0f, 0.0f) * lerp2;
                    if (clamp > 0.0f) {
                        float f31 = f30 * 1.0f;
                        ...
                        canvas.save();
                        canvas.rotate(v3Var.f20596i * 20.0f, (v3Var.f20596i * AndroidUtilities.dp(50.0f)) + rectF6.centerX(), rectF6.bottom + AndroidUtilities.dp(350.0f));
                        float a2 = v3Var.f20598k.a(0.01f);
                        ...
                        if (z11) {
                            ...
                            if (m3Var != null && m3Var.f20432m != null) {
                                float width3 = rectF6.width() / m3Var.f20432m.getWidth();
                                canvas.scale(width3, width3);
                                paint.setAlpha(i17);
                                canvas.drawBitmap(m3Var.f20432m, 0.0f, 0.0f, paint);
                            }
                            canvas.restore();
                            canvas.save();
        ...
        float f34 = f20;
        canvas.save();
        if (this.f20664g0 == null) {
            this.f20664g0 = new i20();
        }
        RectF rectF8 = AndroidUtilities.rectTmp;
        rectF8.set(0.0f, 0.0f, f34, f33);
        this.f20664g0.b(canvas, rectF8, 1, this.S);
        canvas.restore();
        canvas.restore();
        if (this.f20660d0 == null) {
            this.f20660d0 = new k01(LocaleController.getString(R.string.BotCloseAllTabs), 14.0f, AndroidUtilities.bold());
        }
        if (this.f20663f0 == null || this.f20661e0 != j6.I.q()) {
            boolean q10 = j6.I.q();
            this.f20661e0 = q10;
            if (q10) {
                this.f20663f0 = j6.i0(64, 64, 64, 64, 553648127, 872415231, 872415231);
            } else {
                this.f20663f0 = j6.i0(64, 64, 64, 64, 771751936, 1140850688, 1140850688);
            }
            this.f20663f0.setCallback(this);
        }
        float dp3 = this.f20660d0.f26124c + AndroidUtilities.dp(24.0f);
        float f35 = (f34 - dp3) / 2.0f;
        this.f20663f0.setBounds((int) f35, (int) ((f33 - (AndroidUtilities.dp(95.0f) / 2.0f)) - AndroidUtilities.dp(14.0f)), (int) ((f34 + dp3) / 2.0f), (int) ((f33 - (AndroidUtilities.dp(95.0f) / 2.0f)) + AndroidUtilities.dp(14.0f)));
        this.f20663f0.setAlpha((int) (this.S * 255.0f));
        this.f20663f0.draw(canvas);
        this.f20660d0.c(f35 + AndroidUtilities.dp(12.0f), f33 - (AndroidUtilities.dp(95.0f) / 2.0f), this.S, -1, canvas);
        canvas.restore();
    }
    ...
    public final float e(boolean z4) {
        ...
        while (true) {
            ...
            if (((v3) arrayList.get(i10)).d.f20337c >= 0) {
                f10 = 1.0f;
            } else {
                f10 = 0.0f;
            }
        ...
        if (z4) {
            return this.f20662f.d(f11, false);
        }
        return f11;
    }
    ...
    public final void f() {
        ...
        if (n3Var != null && (n3Var.getParent() instanceof View)) {
            ...
            View view = (View) this.f20654a.getParent();
            this.P = view;
            int[] iArr = this.U;
            if (view != null) {
                view.getLocationOnScreen(iArr);
            ...
            ArrayList arrayList = this.O;
            arrayList.clear();
            ArrayList<m3> tabs = this.f20654a.getTabs();
            ArrayList<k3> tabDrawables = this.f20654a.getTabDrawables();
            ...
            this.f20662f.d(arrayList.size(), true);
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f20663f0 && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
