...
public final class z2 extends FrameLayout {
    public final org.telegram.ui.Components.w5 f19755a;
    ...
    public z2(Context context, int i10, f6 f6Var) {
        ...
        this.f19757c = imageView2;
        imageView2.setScaleType(scaleType);
        imageView2.setColorFilter(new PorterDuffColorFilter(j6.v0(j6.f18935h7, f6Var), PorterDuff.Mode.SRC_IN));
        if (LocaleController.isRTL) {
            i12 = 3;
        } else {
            i12 = 5;
        ...
        if (i10 != 0 && i10 != 4) {
            if (i10 == 1) {
                w5Var.setGravity(17);
                w5Var.setTextColor(j6.v0(j6.f18969j5, f6Var));
    ...
    public final void a(CharSequence charSequence, int i10, Drawable drawable, boolean z10) {
        ...
        int i11;
        float f11;
        org.telegram.ui.Components.w5 w5Var = this.f19755a;
    ...
    public void setChecked(boolean z10) {
        ...
        this.f19757c.setImageResource(i10);
    }

    public void setGravity(int i10) {
        this.f19755a.setGravity(i10);
    }

    public void setIconColor(int i10) {
        this.f19756b.setColorFilter(new PorterDuffColorFilter(i10, PorterDuff.Mode.MULTIPLY));
    }

    public void setTextColor(int i10) {
        this.f19755a.setTextColor(i10);
    }
}
