...
public final class z2 extends FrameLayout {
    public final org.telegram.ui.Components.t5 f20778a;
    ...
    public z2(Context context, int i10, f6 f6Var) {
        ...
        addView(imageView, k7.b6.e(56, 48, i11 | 16));
        ImageView imageView2 = new ImageView(context);
        this.f20780c = imageView2;
        imageView2.setScaleType(scaleType);
        imageView2.setColorFilter(new PorterDuffColorFilter(j6.v0(j6.f19979h7, f6Var), PorterDuff.Mode.SRC_IN));
        if (LocaleController.isRTL) {
            i12 = 3;
        } else {
            i12 = 5;
        }
        addView(imageView2, k7.b6.e(56, 48, i12 | 16));
        ...
        if (i10 != 0 && i10 != 4) {
            if (i10 == 1) {
                t5Var.setGravity(17);
                t5Var.setTextColor(j6.v0(j6.f20012j5, f6Var));
    ...
    public final void a(CharSequence charSequence, int i10, Drawable drawable, boolean z4) {
        ...
        int i11;
        float f12;
        org.telegram.ui.Components.t5 t5Var = this.f20778a;
        t5Var.setText(charSequence);
        float f13 = 16.0f;
        float f14 = 21.0f;
        ImageView imageView = this.f20779b;
    ...
    public void setChecked(boolean z4) {
        ...
        this.f20780c.setImageResource(i10);
    }

    public void setGravity(int i10) {
        this.f20778a.setGravity(i10);
    }

    public void setIconColor(int i10) {
        this.f20779b.setColorFilter(new PorterDuffColorFilter(i10, PorterDuff.Mode.MULTIPLY));
    }

    public void setTextColor(int i10) {
        this.f20778a.setTextColor(i10);
    }
}
