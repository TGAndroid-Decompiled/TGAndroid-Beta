...
public final class z2 extends FrameLayout {
    public final org.telegram.ui.Components.w5 f19756a;
    public final ImageView f19757b;
    public final ImageView f19758c;
    public final int d;
    public boolean e;
    ...
    public z2(Context context, int i10, f6 f6Var) {
        ...
        this.f19758c = imageView2;
        imageView2.setScaleType(scaleType);
        imageView2.setColorFilter(new PorterDuffColorFilter(j6.v0(j6.f18936h7, f6Var), PorterDuff.Mode.SRC_IN));
        if (LocaleController.isRTL) {
            i12 = 3;
        } else {
            i12 = 5;
        ...
        if (i10 != 0 && i10 != 4) {
            if (i10 == 1) {
                w5Var.setGravity(17);
                w5Var.setTextColor(j6.v0(j6.f18970j5, f6Var));
    ...
    public final void a(CharSequence charSequence, int i10, Drawable drawable, boolean z10) {
        ...
        int i11;
        float f11;
        org.telegram.ui.Components.w5 w5Var = this.f19756a;
        ...
        if (i10 == 0 && drawable == null) {
            ...
            w5Var.setPadding(dp2, 0, AndroidUtilities.dp(f12), 0);
            return;
        }
        if (drawable != null) {
        ...
        if (z10) {
            ...
            w5Var.setPadding(dp3, 0, AndroidUtilities.dp(f13), 0);
            if (LocaleController.isRTL) {
                dp = 0;
            } else {
        ...
        w5Var.setPadding(dp4, 0, AndroidUtilities.dp(f12), 0);
    ...
    public void setChecked(boolean z10) {
        ...
        this.f19758c.setImageResource(i10);
    }

    public void setGravity(int i10) {
        this.f19756a.setGravity(i10);
    }

    public void setIconColor(int i10) {
        this.f19757b.setColorFilter(new PorterDuffColorFilter(i10, PorterDuff.Mode.MULTIPLY));
    }

    public void setTextColor(int i10) {
        this.f19756a.setTextColor(i10);
    }
}
