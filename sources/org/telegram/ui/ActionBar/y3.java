...
public final class y3 extends FrameLayout {
    public e5 f20725a;
    public ActionBarLayout f20726b;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ActionBarLayout actionBarLayout = this.f20726b;
        if (actionBarLayout != null && actionBarLayout.getParent() == this) {
            this.f20726b.N(canvas, this);
        }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        return ((ActionBarLayout) this.f20725a).j();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        i0.b bVar = this.f20728f;
        int i12 = (size - bVar.f7196a) - bVar.f7198c;
        int i13 = (size2 - bVar.f7197b) - bVar.d;
