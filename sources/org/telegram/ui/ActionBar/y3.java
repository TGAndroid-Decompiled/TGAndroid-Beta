...
public final class y3 extends FrameLayout {
    public e5 f20750a;
    public ActionBarLayout f20751b;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ActionBarLayout actionBarLayout = this.f20751b;
        if (actionBarLayout != null && actionBarLayout.getParent() == this) {
            this.f20751b.N(canvas, this);
        }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        return ((ActionBarLayout) this.f20750a).j();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        i0.b bVar = this.f20753f;
        int i12 = (size - bVar.f7213a) - bVar.f7215c;
        int i13 = (size2 - bVar.f7214b) - bVar.d;
