...
public final class y3 extends View {
    ...
    public p3 f19705a;
    public final int[] f19706a0;
    public v3 f19707b;
    public final int[] f19708b0;
    public m3 f19709c;
    public final RectF f19710c0;
    public ValueAnimator d;
    public final RectF f19711d0;
    public float e;
    public final RectF f19712e0;
    public final org.telegram.ui.Components.c6 f19713f;
    public final Path f19714f0;
    public h01 f19715g0;
    public final OverScroller h;
    public boolean f19716h0;
    public org.telegram.ui.Cells.z f19717i0;
    public n20 f19718j0;
    ...
    public float f19724y;

    public y3(LaunchActivity launchActivity) {
        super(launchActivity);
        this.f19713f = new org.telegram.ui.Components.c6(this, 0L, 350L, qr.h);
        this.Q = new RectF();
        this.R = new ArrayList();
        this.f19706a0 = new int[2];
        this.f19708b0 = new int[2];
        this.f19710c0 = new RectF();
        this.f19711d0 = new RectF();
        this.f19712e0 = new RectF();
        this.f19714f0 = new Path();
        setWillNotDraw(false);
        this.h = new OverScroller(launchActivity);
        ViewConfiguration viewConfiguration = ViewConfiguration.get(launchActivity);
        this.f19719n = viewConfiguration.getScaledMaximumFlingVelocity();
        this.f19720r = viewConfiguration.getScaledMinimumFlingVelocity();
    ...
    public final void b(v3 v3Var) {
        ...
        if (this.f19707b != null && (valueAnimator = this.d) != null) {
            valueAnimator.end();
            this.d = null;
        }
        this.f19707b = v3Var;
        ...
        for (int i10 = 0; i10 < tabDrawables.size(); i10++) {
            ...
            int indexOf = tabs.indexOf(m3Var2.f19401a);
            m3Var2.f19403c = indexOf;
            if (indexOf >= 0) {
                m3Var2.f19402b = indexOf;
            }
        }
        p3Var.n();
        p3Var.o(true);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        v3 v3Var = y3Var.f19707b;
        int[] iArr = y3Var.f19706a0;
        int[] iArr2 = y3Var.f19708b0;
        RectF rectF3 = y3Var.f19710c0;
        if (v3Var != null) {
            y3Var.getLocationOnScreen(iArr2);
            y3Var.f19705a.getLocationOnScreen(iArr);
            y3Var.f19705a.d(rectF3, 0.0f);
            rectF3.offset(iArr[0] - iArr2[0], iArr[1] - iArr2[1]);
            canvas.save();
            canvas.clipRect(0, 0, y3Var.getMeasuredWidth(), y3Var.getMeasuredHeight() - y3Var.f19721s);
            w3 mo37getWindowView = y3Var.f19707b.mo37getWindowView();
            float f18 = y3Var.e;
            RectF rectF4 = y3Var.f19712e0;
            float x10 = mo37getWindowView.x(canvas, rectF3, f18, rectF4, f18);
            if (y3Var.f19709c != null) {
                Path path = y3Var.f19714f0;
                path.rewind();
                ...
                y3Var.f19705a.setupTab(y3Var.f19709c);
                y3Var.f19709c.a(canvas, rectF3, x10, y3Var.e, 1.0f);
                rectF = rectF3;
                canvas.restore();
            } else {
                rectF = rectF3;
        ...
        while (true) {
            ...
            if (((x3) arrayList.get(i15)).d.f19403c >= 0) {
                f17 = 1.0f;
            } else {
                f17 = 0.0f;
            }
        ...
        float d = y3Var.f19713f.d(f22, false);
        ...
        while (i16 < arrayList.size() + 1) {
            if (i16 == arrayList.size()) {
                ...
                m3 m3Var2 = x3Var.d;
                float[] fArr = x3Var.f19681g;
                float f23 = dp;
                Matrix matrix = x3Var.f19680f;
                float[] fArr2 = x3Var.h;
                if (m3Var2 == null) {
                    f10 = 1.0f;
                } else {
                ...
                boolean z11 = z10;
                y3Var.f19705a.d(rectF, Utilities.clamp(m3Var2.c(), 1.0f, 0.0f));
                rectF.offset(y3Var.f19705a.getX(), y3Var.f19705a.getY());
                ...
                if (rectF6.top > f20 || rectF6.bottom < 0.0f) {
                    ...
                    matrix.setPolyToPoly(x3Var.f19681g, 0, x3Var.h, 0, 4);
                    ...
                    RadialGradient radialGradient = x3Var.f19689p;
                    Paint paint = x3Var.f19688o;
                    Paint paint2 = x3Var.f19691r;
                    f12 = lerp;
                    Matrix matrix2 = x3Var.f19690q;
                    o3 o3Var = x3Var.f19679c;
                    f14 = d;
                    Path path2 = x3Var.f19687n;
                    arrayList2 = arrayList;
                    Paint paint3 = x3Var.e;
                    rectF2 = rectF;
                    RectF rectF7 = x3Var.f19686m;
                    i12 = i14;
                    Paint paint4 = x3Var.f19685l;
                    f15 = f20;
                    f13 = f19;
                    float clamp = Utilities.clamp(1.0f - ((Math.abs(x3Var.f19682i) - 0.3f) / 0.7f), 1.0f, 0.0f) * lerp2;
                    if (clamp > 0.0f) {
                        float f30 = f29 * 1.0f;
                        ...
                        canvas.save();
                        canvas.rotate(x3Var.f19682i * 20.0f, (x3Var.f19682i * AndroidUtilities.dp(50.0f)) + rectF6.centerX(), rectF6.bottom + AndroidUtilities.dp(350.0f));
                        float a2 = x3Var.f19684k.a(0.01f);
                        ...
                        if (z11) {
                            ...
                            if (o3Var != null && o3Var.f19463m != null) {
                                float width3 = rectF6.width() / o3Var.f19463m.getWidth();
                                canvas.scale(width3, width3);
                                paint.setAlpha(i17);
                                canvas.drawBitmap(o3Var.f19463m, 0.0f, 0.0f, paint);
                            }
                            canvas.restore();
                            canvas.save();
        ...
        float f33 = f19;
        canvas.save();
        if (this.f19718j0 == null) {
            this.f19718j0 = new n20();
        }
        RectF rectF8 = AndroidUtilities.rectTmp;
        rectF8.set(0.0f, 0.0f, f33, f32);
        this.f19718j0.b(canvas, rectF8, 1, this.V);
        canvas.restore();
        canvas.restore();
        if (this.f19715g0 == null) {
            this.f19715g0 = new h01(LocaleController.getString(R.string.BotCloseAllTabs), 14.0f, AndroidUtilities.bold());
        }
        if (this.f19717i0 == null || this.f19716h0 != j6.I.q()) {
            boolean q6 = j6.I.q();
            this.f19716h0 = q6;
            if (q6) {
                this.f19717i0 = j6.i0(64, 64, 64, 64, 553648127, 872415231, 872415231);
            } else {
                this.f19717i0 = j6.i0(64, 64, 64, 64, 771751936, 1140850688, 1140850688);
            }
            this.f19717i0.setCallback(this);
        }
        float dp3 = this.f19715g0.f24442c + AndroidUtilities.dp(24.0f);
        float f34 = (f33 - dp3) / 2.0f;
        this.f19717i0.setBounds((int) f34, (int) ((f32 - (AndroidUtilities.dp(95.0f) / 2.0f)) - AndroidUtilities.dp(14.0f)), (int) ((f33 + dp3) / 2.0f), (int) ((f32 - (AndroidUtilities.dp(95.0f) / 2.0f)) + AndroidUtilities.dp(14.0f)));
        this.f19717i0.setAlpha((int) (this.V * 255.0f));
        this.f19717i0.draw(canvas);
        this.f19715g0.c(f34 + AndroidUtilities.dp(12.0f), f32 - (AndroidUtilities.dp(95.0f) / 2.0f), this.V, -1, canvas);
        canvas.restore();
    }
    ...
    public final float e(boolean z10) {
        ...
        while (true) {
            ...
            if (((x3) arrayList.get(i10)).d.f19403c >= 0) {
                f7 = 1.0f;
            } else {
                f7 = 0.0f;
            }
        ...
        if (z10) {
            return this.f19713f.d(f10, false);
        }
        return f10;
    }
    ...
    public final void f() {
        ...
        if (p3Var != null && (p3Var.getParent() instanceof View)) {
            ...
            View view = (View) this.f19705a.getParent();
            this.S = view;
            int[] iArr = this.f19706a0;
            if (view != null) {
                view.getLocationOnScreen(iArr);
            } else {
                iArr[1] = 0;
            ...
            ArrayList arrayList = this.R;
            arrayList.clear();
            ArrayList<o3> tabs = this.f19705a.getTabs();
            ArrayList<m3> tabDrawables = this.f19705a.getTabDrawables();
            ...
            this.f19713f.d(arrayList.size(), true);
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f19717i0 && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
