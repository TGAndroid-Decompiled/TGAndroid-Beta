...
public final class v4 {
    ...
    public final PopupWindow f19608c;
    public final int d;
    public final int e;
    public final RelativeLayout f19609f;
    public final cc1 f19610g;
    public final u4 h;
    public final FrameLayout f19611i;
    public final View f19612j;
    public final r4 f19613k;
    public final TextView f19614l;
    public final Drawable f19615m;
    public final Drawable f19616n;
    public final AnimatedVectorDrawable f19617o;
    public final AnimatedVectorDrawable f19618p;
    public final com.google.firebase.messaging.p f19619q;
    public final t4 f19620r;
    public final Interpolator f19621s;
    public final Interpolator f19622t;
    public final Interpolator f19623u;
    public final AnimatorSet v;
    public final AnimatorSet f19624w;
    public final AnimatorSet f19625x;
    public final AnimationSet f19626y;
    public final AnimationSet f19627z;
    ...
    public v4(x4 x4Var, Context context, View view) {
        ...
        e6 e6Var = x4Var.f19706n;
        int i11 = x4Var.f19701i;
        ...
        if (cVar != null) {
            ...
            if (i11 == 0) {
                gradientDrawable.setColor(i6.v0(i6.f18904h5, e6Var));
            } else if (i11 == 2) {
                gradientDrawable.setColor(-115203550);
            } else if (i11 == 1) {
                gradientDrawable.setColor(i6.v0(i6.f18834d6, e6Var));
            }
            relativeLayout2.setBackground(gradientDrawable);
        }
        relativeLayout2.setLayoutParams(new ViewGroup.LayoutParams(-2, -2));
        relativeLayout2.setClipToOutline(true);
        this.f19609f = relativeLayout2;
        ...
        this.f19608c = popupWindow;
        this.d = AndroidUtilities.dp(16.0f);
        this.e = AndroidUtilities.dp(8.0f);
        this.E = AndroidUtilities.dp(48.0f);
        int dp3 = AndroidUtilities.dp(8.0f);
        this.f19620r = new t4();
        this.f19621s = AnimationUtils.loadInterpolator(context, 17563661);
        this.f19622t = AnimationUtils.loadInterpolator(context, 17563662);
        this.f19623u = AnimationUtils.loadInterpolator(context, 17563663);
        ...
        this.f19617o = animatedVectorDrawable;
        ...
        this.f19618p = animatedVectorDrawable2;
        animatedVectorDrawable2.setAutoMirrored(true);
        FrameLayout frameLayout = new FrameLayout(context);
        this.f19611i = frameLayout;
        ...
        if (i11 == 0) {
            ...
            if (i11 == 2) {
                ...
                view2.setBackgroundColor(i6.v0(i6.f18835d7, e6Var));
            }
        }
        mutate2.setTint(v02);
        mutate.setTint(v02);
        ...
        this.f19610g = new cc1(this, context, 4);
        ?? obj = new Object();
        obj.e = this;
        obj.f7342c = context;
        obj.f7340a = i10;
        ...
        u4Var.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public final void onItemClick(AdapterView adapterView, View view3, int i15, long j3) {
                ...
                x4 x4Var2 = v4Var.Q;
                if (x4Var2.f19702j != null && x4.f19695r.contains(Integer.valueOf(menuItem.getItemId()))) {
                    int i16 = -v4Var.P;
                    v4Var.P = i16;
        ...
        this.f19626y = animationSet;
        animationSet.setAnimationListener(d2Var);
        AnimationSet animationSet2 = new AnimationSet(true);
        this.f19627z = animationSet2;
        ...
        this.v = animatorSet;
        this.f19624w = x4.a(relativeLayout3, 150, new s4(this, 0));
        this.f19625x = x4.a(relativeLayout3, 0, new s4(this, 1));
    }

    public static void a(v4 v4Var) {
        FrameLayout frameLayout = v4Var.f19611i;
        RelativeLayout relativeLayout = v4Var.f19609f;
        if (v4Var.M) {
            v4Var.f19610g.setY(relativeLayout.getHeight() - v4Var.J.getHeight());
    ...
    public static boolean b(v4 v4Var) {
        boolean z10;
        boolean z11;
        AnimationSet animationSet = v4Var.f19627z;
        AnimationSet animationSet2 = v4Var.f19626y;
    ...
    public final void d() {
        this.f19609f.clearAnimation();
        this.f19610g.animate().cancel();
    ...
    public final void g() {
        boolean z10 = this.N;
        Interpolator interpolator = this.f19622t;
        u4 u4Var = this.h;
        cc1 cc1Var = this.f19610g;
        t4 t4Var = this.f19620r;
        Interpolator interpolator2 = this.f19621s;
        FrameLayout frameLayout = this.f19611i;
        RelativeLayout relativeLayout = this.f19609f;
        r4 r4Var = this.f19613k;
        if (z10) {
            AnimatedVectorDrawable animatedVectorDrawable = this.f19618p;
            ...
            o4Var.setDuration(e());
            AnimationSet animationSet = this.f19627z;
            ...
            this.N = false;
            n();
            cc1Var.animate().alpha(1.0f).withLayer().setInterpolator(this.f19623u).setDuration(100L).start();
            u4Var.animate().alpha(0.0f).withLayer().setInterpolator(interpolator).setDuration(150L).start();
            return;
        }
        AnimatedVectorDrawable animatedVectorDrawable2 = this.f19617o;
        ...
        AnimationSet animationSet2 = this.f19626y;
    ...
    public final void h() {
        ...
        relativeLayout.addView(this.f19610g);
        if (this.I != null) {
            relativeLayout.addView(this.f19611i);
        }
        k();
        j();
    }
    ...
    public final void i(Rect rect) {
        ...
        PopupWindow popupWindow = this.f19608c;
    ...
    public final void k() {
        ...
        if (z10) {
            ...
            r4Var.setImageDrawable(this.f19615m);
        ...
        r4Var.setImageDrawable(this.f19616n);
        frameLayout.setContentDescription(LocaleController.getString(R.string.AccDescrMoreOptions));
        if (this.I != null) {
    ...
    public final void p() {
        ...
        if (size3 != null && this.I != null) {
            ...
            this.O = (int) (Math.sqrt((height * height) + (width * width)) / this.f19609f.getContext().getResources().getDisplayMetrics().density);
        }
    }
}
