...
public final class v4 extends ListView {
    public final w4 f20606a;
    public final LinearGradient f20607b;
    public final Paint f20608c;
    ...
    public v4(w4 w4Var) {
        super(w4Var.f20671a);
        int[] iArr = new int[8];
        PathInterpolator pathInterpolator = kf.b0.f10399i;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        if (z4) {
            canvas.drawRect(0.0f, 0.0f, getWidth(), AndroidUtilities.dp(16.0f), this.f20608c);
        }
        if (z10) {
    ...
    public final void onMeasure(int i10, int i11) {
        w4 w4Var = this.f20606a;
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(w4Var.I.getHeight() - w4Var.H.getHeight(), 1073741824));
    }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        this.f20607b.setLocalMatrix(matrix);
    }
}
