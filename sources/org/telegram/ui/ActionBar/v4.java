...
public final class v4 extends ListView {
    public final w4 f20631a;
    public final LinearGradient f20632b;
    public final Paint f20633c;
    ...
    public v4(w4 w4Var) {
        super(w4Var.f20696a);
        int[] iArr = new int[8];
        PathInterpolator pathInterpolator = lf.b0.f11957i;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        if (z4) {
            canvas.drawRect(0.0f, 0.0f, getWidth(), AndroidUtilities.dp(16.0f), this.f20633c);
        }
        if (z10) {
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        this.f20632b.setLocalMatrix(matrix);
    }
}
