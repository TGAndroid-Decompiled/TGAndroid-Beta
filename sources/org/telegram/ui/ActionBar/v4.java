...
public final class v4 {
    ...
    public final View f21440b;
    public final PopupWindow f21441c;
    public final int d;
    public final int f21442e;
    public final RelativeLayout f21443f;
    public final cc1 f21444g;
    public final u4 h;
    public final FrameLayout f21445i;
    public final View f21446j;
    public final r4 f21447k;
    public final TextView f21448l;
    public final Drawable f21449m;
    public final Drawable f21450n;
    public final AnimatedVectorDrawable f21451o;
    public final AnimatedVectorDrawable f21452p;
    public final com.google.firebase.messaging.p f21453q;
    public final t4 f21454r;
    public final Interpolator f21455s;
    public final Interpolator f21456t;
    public final Interpolator f21457u;
    public final AnimatorSet v;
    public final AnimatorSet f21458w;
    public final AnimatorSet f21459x;
    public final AnimationSet f21460y;
    public final AnimationSet f21461z;
    ...
    public v4(x4 x4Var, Context context, View view) {
        ...
        f6 f6Var = x4Var.f21546n;
        int i11 = x4Var.f21541i;
        ...
        if (bVar != null) {
            ...
            if (i11 == 0) {
                gradientDrawable.setColor(j6.v0(j6.f20762h5, f6Var));
            } else if (i11 == 2) {
                gradientDrawable.setColor(-115203550);
            } else if (i11 == 1) {
                gradientDrawable.setColor(j6.v0(j6.f20691d6, f6Var));
            }
            relativeLayout2.setBackground(gradientDrawable);
        }
        relativeLayout2.setLayoutParams(new ViewGroup.LayoutParams(-2, -2));
        relativeLayout2.setClipToOutline(true);
        this.f21443f = relativeLayout2;
        ...
        this.f21441c = popupWindow;
        this.d = AndroidUtilities.dp(16.0f);
        this.f21442e = AndroidUtilities.dp(8.0f);
        this.E = AndroidUtilities.dp(48.0f);
        int dp3 = AndroidUtilities.dp(8.0f);
        this.f21454r = new t4();
        this.f21455s = AnimationUtils.loadInterpolator(context, 17563661);
        this.f21456t = AnimationUtils.loadInterpolator(context, 17563662);
        this.f21457u = AnimationUtils.loadInterpolator(context, 17563663);
        ...
        this.f21451o = animatedVectorDrawable;
        ...
        this.f21452p = animatedVectorDrawable2;
        animatedVectorDrawable2.setAutoMirrored(true);
        FrameLayout frameLayout = new FrameLayout(context);
        this.f21445i = frameLayout;
        ...
        if (i11 == 0) {
            ...
            if (i11 == 2) {
                ...
                view2.setBackgroundColor(j6.v0(j6.f20692d7, f6Var));
            }
        }
        mutate2.setTint(v02);
        mutate.setTint(v02);
        ...
        this.f21444g = new cc1(this, context, 4);
        ?? obj = new Object();
        obj.f6412e = this;
        obj.f6411c = context;
        obj.f6409a = i10;
        ...
        u4Var.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public final void onItemClick(AdapterView adapterView, View view3, int i15, long j3) {
                ...
                x4 x4Var2 = v4Var.Q;
                if (x4Var2.f21542j != null && x4.f21534r.contains(Integer.valueOf(menuItem.getItemId()))) {
                    int i16 = -v4Var.P;
                    v4Var.P = i16;
        ...
        this.f21460y = animationSet;
        animationSet.setAnimationListener(d2Var);
        AnimationSet animationSet2 = new AnimationSet(true);
        this.f21461z = animationSet2;
        ...
        this.v = animatorSet;
        this.f21458w = x4.a(relativeLayout3, 150, new s4(this, 0));
        this.f21459x = x4.a(relativeLayout3, 0, new s4(this, 1));
    }

    public static void a(v4 v4Var) {
        FrameLayout frameLayout = v4Var.f21445i;
        RelativeLayout relativeLayout = v4Var.f21443f;
        if (v4Var.M) {
            v4Var.f21444g.setY(relativeLayout.getHeight() - v4Var.J.getHeight());
    ...
    public static boolean b(v4 v4Var) {
        boolean z10;
        boolean z11;
        AnimationSet animationSet = v4Var.f21461z;
        AnimationSet animationSet2 = v4Var.f21460y;
    ...
    public final void d() {
        this.f21443f.clearAnimation();
        this.f21444g.animate().cancel();
    ...
    public final void g() {
        boolean z10 = this.N;
        Interpolator interpolator = this.f21456t;
        u4 u4Var = this.h;
        cc1 cc1Var = this.f21444g;
        t4 t4Var = this.f21454r;
        Interpolator interpolator2 = this.f21455s;
        FrameLayout frameLayout = this.f21445i;
        RelativeLayout relativeLayout = this.f21443f;
        r4 r4Var = this.f21447k;
        if (z10) {
            AnimatedVectorDrawable animatedVectorDrawable = this.f21452p;
            ...
            o4Var.setDuration(e());
            AnimationSet animationSet = this.f21461z;
            ...
            this.N = false;
            n();
            cc1Var.animate().alpha(1.0f).withLayer().setInterpolator(this.f21457u).setDuration(100L).start();
            u4Var.animate().alpha(0.0f).withLayer().setInterpolator(interpolator).setDuration(150L).start();
            return;
        }
        AnimatedVectorDrawable animatedVectorDrawable2 = this.f21451o;
        ...
        AnimationSet animationSet2 = this.f21460y;
    ...
    public final void h() {
        ...
        relativeLayout.addView(this.f21444g);
        if (this.I != null) {
            relativeLayout.addView(this.f21445i);
        }
        k();
        j();
    }
    ...
    public final void i(Rect rect) {
        ...
        PopupWindow popupWindow = this.f21441c;
    ...
    public final void k() {
        ...
        if (z10) {
            ...
            r4Var.setImageDrawable(this.f21449m);
        ...
        r4Var.setImageDrawable(this.f21450n);
        frameLayout.setContentDescription(LocaleController.getString(R.string.AccDescrMoreOptions));
        if (this.I != null) {
    ...
    public final void p() {
        ...
        popupWindow.setHeight((this.f21442e * 2) + i10);
        Size size3 = this.J;
        if (size3 != null && this.I != null) {
            int width = size3.getWidth() - this.I.getWidth();
            int height = this.I.getHeight() - this.J.getHeight();
            this.O = (int) (Math.sqrt((height * height) + (width * width)) / this.f21443f.getContext().getResources().getDisplayMetrics().density);
        }
    }
}
