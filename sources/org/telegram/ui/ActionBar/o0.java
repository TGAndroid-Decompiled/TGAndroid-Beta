    ...
    public final Animator onAppear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
        switch (this.f18516a) {
            ...
            case 3:
                ...
                animatorSet4.setInterpolator(wr.f28823k);
                return animatorSet4;
            case 4:
                ...
                if (view instanceof org.telegram.ui.Components.voip.k3) {
                    ...
                    view.setScaleX(0.0f);
                    view.setScaleY(0.0f);
                    ofPropertyValuesHolder.setStartDelay(((org.telegram.ui.Components.voip.k3) view).f28220f);
                }
            ...
            default:
                ...
                animatorSet5.setInterpolator(wr.f28819f);
                return animatorSet5;
        }
    }
    ...
    public final Animator onDisappear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
        switch (this.f18516a) {
            ...
            case 3:
                ...
                animatorSet4.setInterpolator(wr.f28819f);
                return animatorSet4;
            case 4:
