...
public class d5 extends Drawable {
    ...
    public d6 f18819p;
    public final boolean f18820q;
    public int f18821r;
    public boolean f18822s;
    public boolean f18823t;
    public boolean f18824u;
    public boolean v;
    public final Paint f18809c = new Paint(1);
    public final RectF f18813j = new RectF();
    public final Matrix f18814k = new Matrix();
    public final Rect f18818o = new Rect();
    public final int[] f18825w = {-1, -1, -1, -1};
    public final Bitmap[] f18826x = new Bitmap[4];
    public final Drawable[] f18827y = new Drawable[4];
    public final int[] f18828z = {-1, -1, -1, -1};
    ...
    public final Path f18817n = new Path();
    ...
    public final void c(Canvas canvas, Paint paint) {
        ...
        if (paint == null && this.f18807a == null && this.O == 0 && this.P <= 0.0f && (f7 = f()) != null) {
            f7.setBounds(bounds);
            f7.draw(canvas);
            return;
        }
        ...
        if (paint == null && this.f18807a != null) {
            Matrix matrix = this.f18814k;
            matrix.reset();
            a();
            matrix.postTranslate(0.0f, -this.f18821r);
            this.f18807a.setLocalMatrix(matrix);
        }
        ...
        if (d5Var.f18807a != null && d5Var.f18816m && paint == null) {
            int g10 = g(h6.f19028bc);
    ...
    public final void e(Path path, Rect rect, int i10, int i11, int i12, int i13, int i14, boolean z10, boolean z11, boolean z12) {
        ...
        boolean z13 = this.f18820q;
        int i20 = this.f18815l;
        RectF rectF = this.f18813j;
        if (z13) {
            if (!this.G && i20 != 2 && !z12 && !z10) {
                path.moveTo(rect.right - b(8.0f), (i14 - this.f18821r) + this.f18808b);
                path.lineTo(rect.left + i10, (i14 - this.f18821r) + this.f18808b);
            } else {
                if (this.f18824u) {
                    i17 = i13;
                } else {
            ...
            if (!this.G && i20 != 2 && !z12 && !z11) {
                path.lineTo(rect.left + i10, (i14 - this.f18821r) - b(2.0f));
                if (i20 == 1) {
                    path.lineTo(rect.right - i10, (i14 - this.f18821r) - b(2.0f));
                } else {
                    path.lineTo(rect.right - b(8.0f), (i14 - this.f18821r) - b(2.0f));
                }
            } else {
            ...
            if (i20 == 1) {
                if (!z12 && !z10) {
                    path.lineTo(rect.right - i10, (i14 - this.f18821r) + this.f18808b);
                } else {
                    if (this.f18823t) {
                        i19 = i13;
                    }
                ...
                path.lineTo(rect.right - b(8.0f), (i14 - this.f18821r) + this.f18808b);
            } else {
            ...
            if (!this.G && i20 != 2 && !z12 && !z10) {
                path.moveTo(b(8.0f) + rect.left, (i14 - this.f18821r) + this.f18808b);
                path.lineTo(rect.right - i10, (i14 - this.f18821r) + this.f18808b);
            } else {
                if (this.f18824u) {
                    i15 = i13;
            ...
            if (!this.G && i20 != 2 && !z12 && !z11) {
                ...
                if (i20 == 1) {
                    ...
                    path.lineTo(b(8.0f) + rect.left, (i14 - this.f18821r) - b(2.0f));
                }
            } else {
            ...
            if (i20 == 1) {
                ...
                path.lineTo(b(8.0f) + rect.left, (i14 - this.f18821r) + this.f18808b);
            } else {
    ...
    public final Drawable f() {
        ...
        boolean z11 = this.f18822s;
        char c11 = 3;
        if (z11 && this.f18823t) {
            c10 = 3;
        } else if (z11) {
            c10 = 2;
        } else if (this.f18823t) {
            c10 = 1;
        } else {
            c10 = 0;
        }
        boolean z12 = this.f18816m;
        if (!z12 || !this.f18824u) {
            if (z12) {
                c11 = 1;
            } else if (this.f18824u) {
                c11 = 2;
            } else {
                c11 = 0;
            }
        ...
        if (this.f18807a == null && !z12 && !this.J) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final void finalize() {
        ...
        Arrays.fill(this.f18827y, (Object) null);
        Arrays.fill(this.f18825w, -1);
    }
    ...
    public final Drawable j() {
        ...
        int i10;
        int i11;
        if (this.J || (this.f18807a == null && !this.f18816m && this.H == null)) {
            return null;
        }
        int b10 = b(SharedConfig.bubbleRadius);
        boolean z10 = this.f18822s;
        boolean z11 = false;
        if (z10 && this.f18823t) {
            c10 = 3;
        } else if (z10) {
        ...
        int[] iArr = this.f18825w;
        int i12 = iArr[c10];
        Drawable[] drawableArr = this.f18827y;
        if (i12 != b10) {
            iArr[c10] = b10;
            Bitmap[] bitmapArr = this.f18826x;
    ...
    public final Path m() {
        ...
        int max = Math.max(bounds.top, 0);
        boolean z13 = true;
        if (c3Var != null && bounds.height() < this.f18808b) {
            z10 = true;
            z11 = true;
        } else {
            if (i12 != 1 ? (this.f18821r + bounds.bottom) - i11 < this.f18808b : (this.f18821r + bounds.bottom) - (b12 * 2) < this.f18808b) {
                z10 = true;
            } else {
                z10 = false;
            }
            if ((i11 * 2) + this.f18821r >= 0) {
                z12 = true;
            }
            z11 = z12;
        }
    ...
    public final void setAlpha(int i10) {
        int i11 = this.F;
        Paint paint = this.f18809c;
        if (i11 != i10 || paint.getAlpha() != i10) {
            this.F = i10;
            paint.setAlpha(i10);
            if (this.f18820q) {
                this.d.setAlpha((int) ((i10 / 255.0f) * Color.alpha(g(h6.f19028bc))));
            }
        }
