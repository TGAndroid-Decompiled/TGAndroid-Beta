...
public final class s implements Runnable {
    ...
    public final void run() {
        ...
        boolean z10 = this.f19725a;
        if (z10) {
            actionBarLayout.f18643v0 = System.currentTimeMillis();
        }
        ...
        if (z11) {
            ...
            actionBarLayout.f18639s.setAlpha(a2);
            if (z12) {
                float f11 = (0.3f * interpolation) + 0.7f;
                actionBarLayout.f18639s.setScaleX(f11);
                actionBarLayout.f18639s.setScaleY(f11);
                if (actionBarLayout.J != null) {
                    float f12 = 1.0f - interpolation;
                    actionBarLayout.f18639s.setTranslationY(AndroidUtilities.dp(40.0f) * f12);
                ...
                actionBarLayout.f18637r.setAlpha((int) (46.0f * a2));
                h6.f19329s0.setAlpha((int) (a2 * 255.0f));
                actionBarLayout.f18639s.invalidate();
                actionBarLayout.invalidate();
            } else {
                actionBarLayout.f18639s.setTranslationX((1.0f - interpolation) * AndroidUtilities.dp(48.0f));
            }
        } else {
            ...
            if (z12) {
                ...
                actionBarLayout.f18637r.setAlpha((int) (46.0f * a10));
                if (actionBarLayout.J == null) {
                    h6.f19329s0.setAlpha((int) (a10 * 255.0f));
                }
                actionBarLayout.f18639s.invalidate();
                actionBarLayout.invalidate();
            } else {
