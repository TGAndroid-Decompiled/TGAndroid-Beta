...
public final class t4 extends ListView {
    public final u4 f19515a;
    public final LinearGradient f19516b;
    ...
    public t4(u4 u4Var) {
        super(u4Var.f19531a);
        int[] iArr = new int[8];
        PathInterpolator pathInterpolator = yf.y.f46823i;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (z10) {
            canvas.drawRect(0.0f, 0.0f, getWidth(), AndroidUtilities.dp(16.0f), this.f19517c);
        }
        if (z11) {
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        this.f19516b.setLocalMatrix(matrix);
    }
}
