...
public final class q0 extends FrameLayout {
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        switch (this.f19693a) {
            case 3:
                ...
                vd1 vd1Var = (vd1) this.f19695c;
                if (view == vd1Var.f38517s0) {
                    d5Var = vd1Var.parentLayout;
                    if (d5Var != null) {
                        d5Var2 = vd1Var.parentLayout;
                        if (vd1Var.f38517s0.getVisibility() == 0) {
                            i10 = (int) (vd1Var.f38517s0.getTranslationY() + vd1Var.f38517s0.getMeasuredHeight());
                        } else {
                            i10 = 0;
                        }
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        switch (this.f19693a) {
            ...
            case 2:
                ...
                if (e31Var.f33166x.getVisibility() == 0) {
                    if (z11) {
                        AndroidUtilities.rectTmp2.set(0, 0, measuredWidth2, AndroidUtilities.dp(25.0f) + (measuredHeight2 - e31Var.f33166x.getMeasuredHeight()));
                    } else {
                        AndroidUtilities.rectTmp2.set(0, 0, AndroidUtilities.dp(25.0f) + (measuredWidth2 - e31Var.f33166x.getWidth()), measuredHeight2);
                    }
                    e31Var.f33165w.setClipBounds(AndroidUtilities.rectTmp2);
                } else {
                    e31Var.f33165w.setClipBounds(null);
                }
                e31Var.f33165w.layout(0, 0, measuredWidth2, measuredHeight2);
                if (e31Var.f33166x.getVisibility() == 0) {
                    i15 = e31Var.f33166x.getMeasuredHeight();
                }
                if (z11) {
                    measuredWidth = (measuredWidth2 - e31Var.E.getMeasuredWidth()) / 2;
                } else {
                    measuredWidth = e31Var.Q.f10591a + ((((measuredWidth2 - e31Var.f33166x.getMeasuredWidth()) - e31Var.Q.f10591a) - e31Var.E.getMeasuredWidth()) / 2);
                }
                if (z11) {
                    int i16 = e31Var.Q.f10592b;
                ...
                if (z11) {
                    int measuredWidth3 = (measuredWidth2 - e31Var.f33167y.getMeasuredWidth()) / 2;
                    int dp = measuredHeight - AndroidUtilities.dp(48.0f);
                    w9 w9Var = e31Var.f33167y;
                    w9Var.layout(measuredWidth3, dp, w9Var.getMeasuredWidth() + measuredWidth3, e31Var.f33167y.getMeasuredHeight() + dp);
                }
                if (e31Var.f33166x.getVisibility() == 0) {
                    if (z11) {
                        int measuredWidth4 = (measuredWidth2 - e31Var.f33166x.getMeasuredWidth()) / 2;
                        e31Var.f33166x.layout(measuredWidth4, getMeasuredHeight() - i15, e31Var.f33166x.getMeasuredWidth() + measuredWidth4, getMeasuredHeight());
                    } else {
                        int measuredHeight3 = (measuredHeight2 - e31Var.f33166x.getMeasuredHeight()) / 2;
                        e31Var.f33166x.layout(getMeasuredWidth() - e31Var.f33166x.getMeasuredWidth(), measuredHeight3, getMeasuredWidth(), e31Var.f33166x.getMeasuredHeight() + measuredHeight3);
                    }
                }
                lj0 lj0Var = e31Var.F;
                Rect rect = e31Var.f33160c;
                lj0Var.layout(rect.left + measuredWidth, rect.top + measuredHeight, measuredWidth + rect.right, measuredHeight + rect.bottom);
                int dp2 = AndroidUtilities.dp(11.0f) + e31Var.Q.f10591a;
                int dp3 = AndroidUtilities.dp(11.0f) + e31Var.Q.f10592b;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        switch (this.f19693a) {
            case 0:
                v0 v0Var = (v0) this.f19695c;
                measureChildWithMargins(v0Var.f19786s, i10, 0, i11, 0);
                View view = v0Var.f19790w;
                if (view != null) {
                ...
                if (!LocaleController.isRTL) {
                    ...
                    q0Var.f19694b = true;
                    q0Var.measureChildWithMargins(v0Var.f19771f, i10, i14, i11, 0);
                    if (v0Var.f19771f.getVisibility() == 0) {
                        i15 = v0Var.f19771f.getMeasuredWidth();
                    } else {
                        i15 = 0;
                    }
                    ci.h2 h2Var = v0Var.e;
                    int i26 = i14 + i15;
                    View view2 = v0Var.f19790w;
                    if (view2 != null) {
                ...
                this.f19694b = true;
                measureChildWithMargins(v0Var.f19771f, i10, i12, i11, 0);
                if (v0Var.f19771f.getVisibility() == 0) {
                    i13 = v0Var.f19771f.getMeasuredWidth();
                } else {
                    i13 = 0;
                }
                measureChildWithMargins(v0Var.e, wh.y(12.0f, size2, 0), i12 + i13, i11, 0);
                this.f19694b = false;
                setMeasuredDimension(Math.max(v0Var.e.getMeasuredWidth() + i13, size2), View.MeasureSpec.getSize(i11));
                return;
            case 1:
                int size3 = View.MeasureSpec.getSize(i10);
                zn znVar = (zn) this.f19695c;
                if (znVar.C9()) {
            ...
            case 2:
                ...
                if (z10) {
                    this.f19694b = true;
                    n6 n6Var = e31Var.f33166x;
                    int i27 = e31Var.Q.f10591a;
                    int dp = AndroidUtilities.dp(8.0f);
                    i0.b bVar = e31Var.Q;
                    n6Var.setPadding(i27, dp, bVar.f10593c, bVar.d);
                    this.f19694b = false;
                    e31Var.f33166x.measure(View.MeasureSpec.makeMeasureSpec(size4, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(size5 + e31Var.Q.d, Integer.MIN_VALUE));
                ...
                this.f19694b = true;
                n6 n6Var2 = e31Var.f33166x;
                i0.b bVar2 = e31Var.Q;
                n6Var2.setPadding(0, (bVar2.f10592b * 2) / 3, bVar2.f10593c, bVar2.d);
                this.f19694b = false;
                e31Var.f33166x.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(273.0f) + e31Var.Q.f10593c, 1073741824), i11);
            ...
            default:
                ...
                if (((vd1) this.f19695c).e != null) {
                    this.f19694b = true;
                    if (!AndroidUtilities.isTablet()) {
                        FrameLayout.LayoutParams layoutParams3 = (FrameLayout.LayoutParams) ((vd1) this.f19695c).e.getLayoutParams();
                        layoutParams3.topMargin = AndroidUtilities.statusBarHeight;
                        ((vd1) this.f19695c).e.setLayoutParams(layoutParams3);
                    }
                    if (!AndroidUtilities.isTablet() && ApplicationLoader.applicationContext.getResources().getConfiguration().orientation == 2) {
                        ((vd1) this.f19695c).h.setTextSize(1, 18.0f);
                    } else {
                        ((vd1) this.f19695c).h.setTextSize(1, 20.0f);
                    }
                    this.f19694b = false;
                }
                measureChildWithMargins(((vd1) this.f19695c).f38517s0, i10, 0, i11, 0);
                int measuredHeight = ((vd1) this.f19695c).f38517s0.getMeasuredHeight();
                if (((vd1) this.f19695c).f38517s0.getVisibility() == 0) {
                    size7 -= measuredHeight;
                }
                FrameLayout.LayoutParams layoutParams4 = (FrameLayout.LayoutParams) ((vd1) this.f19695c).f38521u0.getLayoutParams();
                layoutParams4.topMargin = measuredHeight;
                vd1 vd1Var = (vd1) this.f19695c;
                int i28 = 58;
                if (vd1Var.f38470b == 2) {
                    qc1 qc1Var = vd1Var.f38521u0;
                    int dp2 = AndroidUtilities.dp(4.0f);
                    vd1 vd1Var2 = (vd1) this.f19695c;
                ...
                ((vd1) this.f19695c).f38521u0.measure(View.MeasureSpec.makeMeasureSpec(size6, 1073741824), View.MeasureSpec.makeMeasureSpec(size7 - layoutParams4.bottomMargin, 1073741824));
                ((FrameLayout.LayoutParams) ((vd1) this.f19695c).f38529x0.getLayoutParams()).topMargin = measuredHeight;
                ((vd1) this.f19695c).f38529x0.measure(View.MeasureSpec.makeMeasureSpec(size6, 1073741824), View.MeasureSpec.makeMeasureSpec(size7, 1073741824));
                org.telegram.ui.t5 t5Var = ((vd1) this.f19695c).Q1;
                if (t5Var != null) {
                    ((FrameLayout.LayoutParams) t5Var.getLayoutParams()).topMargin = measuredHeight;
                    ((vd1) this.f19695c).Q1.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(222.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(76.0f), 1073741824));
                }
                org.telegram.ui.u4 u4Var = ((vd1) this.f19695c).C0;
                if (u4Var != null) {
                    ...
                    FrameLayout.LayoutParams layoutParams5 = (FrameLayout.LayoutParams) ((vd1) this.f19695c).C0.getLayoutParams();
                    vd1 vd1Var3 = (vd1) this.f19695c;
                    ...
                    measureChildWithMargins(((vd1) this.f19695c).C0, i10, 0, i11, 0);
                }
                Drawable drawable = ((vd1) this.f19695c).f38513r;
                if (drawable != null) {
                    drawable.getPadding(AndroidUtilities.rectTmp2);
                }
                int i29 = 0;
                while (true) {
                    FrameLayout[] frameLayoutArr = ((vd1) this.f19695c).L0;
                    if (i29 < frameLayoutArr.length) {
                        FrameLayout frameLayout = frameLayoutArr[i29];
                        if (frameLayout != null) {
                            FrameLayout.LayoutParams layoutParams6 = (FrameLayout.LayoutParams) frameLayout.getLayoutParams();
                            if (i29 == 0) {
                                if (((vd1) this.f19695c).f38470b == 2) {
                                    i21 = 321;
                                } else {
                                    i21 = 273;
                                }
                            ...
                            FrameLayout frameLayout2 = ((vd1) this.f19695c).L0[i29];
                            if (i29 == 0) {
                            ...
                            measureChildWithMargins(((vd1) this.f19695c).L0[i29], i10, 0, i11, 0);
                        }
                        i29++;
                    } else {
                        return;
    ...
    public void setAlpha(float f7) {
        switch (this.f19693a) {
            case 0:
                super.setAlpha(f7);
                v0 v0Var = (v0) this.f19695c;
                k0 k0Var = v0Var.f19786s;
                if (k0Var != null && k0Var.getTag() != null) {
                    v0Var.f19786s.setAlpha(f7);
                    v0Var.f19786s.setScaleX(f7);
                    v0Var.f19786s.setScaleY(f7);
                    return;
                }
                return;
            default:
    ...
    public void setVisibility(int i10) {
        switch (this.f19693a) {
            case 0:
                ...
                FrameLayout frameLayout = v0Var.f19763a;
                if (frameLayout != null) {
