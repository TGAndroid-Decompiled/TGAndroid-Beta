...
public final class r extends AnimatorListenerAdapter {
    ...
    public final ActionBarLayout f19519b;

    public r(ActionBarLayout actionBarLayout, int i10) {
        this.f19518a = i10;
        this.f19519b = actionBarLayout;
    }

    @Override
    public final void onAnimationEnd(Animator animator) {
        int i10 = this.f19518a;
        ActionBarLayout actionBarLayout = this.f19519b;
        switch (i10) {
            case 0:
    ...
    public void onAnimationStart(Animator animator) {
        switch (this.f19518a) {
            case 0:
                this.f19519b.f18419v0 = System.currentTimeMillis();
                return;
            default:
