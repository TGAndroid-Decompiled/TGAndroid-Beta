...
public final class r implements Runnable {
    ...
    public final void run() {
        ...
        switch (i10) {
            ...
            case 7:
                g2 g2Var = (g2) obj;
                g2Var.f18666f1.setVisibility(0);
                g2Var.f18668h1.setAlpha(0.0f);
                g2Var.f18667g1.startAnimation(AnimationUtils.loadAnimation(g2Var.getContext(), g2Var.f18664d1));
                g2Var.f18668h1.animate().setDuration(300L).alpha(1.0f).setListener(new d2(g2Var, 0)).start();
                return;
            case 8:
                g3 g3Var = (g3) ((y2) obj).f19704c;
            ...
            case 11:
                ...
                return;
            case 12:
                w4 w4Var = (w4) ((e2) obj).f18607b;
                w4Var.k();
                w4Var.j();
                return;
            case 13:
                w4 w4Var2 = ((t4) obj).f19562b;
                w4Var2.f19640c.dismiss();
                w4Var2.f19641f.removeAllViews();
                return;
            case 14:
                ((t4) obj).f19562b.f19640c.dismiss();
                return;
            case 15:
            ...
            case 17:
                ...
                return;
            case 18:
                i8 i8Var = (i8) j6.f18881e5.remove((MessageObject) obj);
                if (i8Var != null) {
                    i8Var.f24859i = null;
                    return;
                }
