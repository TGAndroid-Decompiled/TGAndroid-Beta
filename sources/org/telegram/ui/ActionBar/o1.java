...
public class o1 extends PopupWindow {
    public static Method f19443k;
    public static final Field f19444l;
    public static final DecelerateInterpolator f19445m = new DecelerateInterpolator();
    public static final h1 f19446n;
    public AnimatorSet f19447a;
    ...
    public ViewTreeObserver f19452i;
    public AnimationNotificationsLocker f19453j;
    ...
    public static void i(ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout) {
        actionBarPopupWindow$ActionBarPopupWindowLayout.f18441n = true;
        ...
        HashMap hashMap = actionBarPopupWindow$ActionBarPopupWindowLayout.f18446y;
        hashMap.clear();
        int i10 = 0;
        ...
        if (actionBarPopupWindow$ActionBarPopupWindowLayout.v) {
            actionBarPopupWindow$ActionBarPopupWindowLayout.f18443s = itemsCount - 1;
        } else {
            actionBarPopupWindow$ActionBarPopupWindowLayout.f18443s = 0;
        }
        ...
        actionBarPopupWindow$ActionBarPopupWindowLayout.f18437a = false;
        actionBarPopupWindow$ActionBarPopupWindowLayout.f18438b = true;
    ...
    public void d(boolean z10) {
        ...
        AnimatorSet animatorSet = this.f19447a;
        ...
        if (this.f19448b && z10) {
            ...
            if (actionBarPopupWindow$ActionBarPopupWindowLayout != null && (arrayList = actionBarPopupWindow$ActionBarPopupWindowLayout.f18445x) != null && !arrayList.isEmpty()) {
                int size = actionBarPopupWindow$ActionBarPopupWindowLayout.f18445x.size();
                for (int i12 = 0; i12 < size; i12++) {
                    AnimatorSet animatorSet2 = (AnimatorSet) actionBarPopupWindow$ActionBarPopupWindowLayout.f18445x.get(i12);
                    animatorSet2.removeAllListeners();
                    animatorSet2.cancel();
                }
                actionBarPopupWindow$ActionBarPopupWindowLayout.f18445x.clear();
            }
            AnimatorSet animatorSet3 = new AnimatorSet();
            this.f19447a = animatorSet3;
            if (j3 > 0) {
                animatorSet3.playTogether(ValueAnimator.ofFloat(0.0f, 1.0f));
                this.f19447a.setDuration(j3);
            } else if (this.f19451g) {
                ...
                this.f19447a.setDuration(this.f19449c);
            } else {
            ...
            this.f19447a.addListener(new i1(this, 1));
            if (this.e) {
                this.f19453j.lock();
            }
            this.f19447a.start();
    ...
    public final void f(View view) {
        ...
        if (this.h != null) {
            ...
            ViewTreeObserver viewTreeObserver2 = this.f19452i;
            if (viewTreeObserver != viewTreeObserver2) {
                if (viewTreeObserver2 != null && viewTreeObserver2.isAlive()) {
                    this.f19452i.removeOnScrollChangedListener(this.h);
                }
                this.f19452i = viewTreeObserver;
    ...
    public final void g() {
        try {
            if (f19443k == null) {
                ...
                f19443k = declaredMethod;
                declaredMethod.setAccessible(true);
            }
            f19443k.invoke(this, Boolean.TRUE);
        } catch (Exception e) {
            FileLog.e(e);
        }
    }
    ...
    public final void h() {
        ...
        if (this.f19448b && this.f19447a == null) {
            ViewGroup viewGroup = (ViewGroup) getContentView();
            if (viewGroup instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                ...
                for (int i10 = 0; i10 < viewGroup.getChildCount(); i10++) {
                    if (viewGroup.getChildAt(i10) instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                        ...
                        actionBarPopupWindow$ActionBarPopupWindowLayout2.f18441n = true;
                    }
                }
            ...
            this.f19447a.setDuration((i11 * 16) + 150);
            this.f19447a.addListener(new i1(this, 0));
            this.f19447a.start();
        }
    }
    ...
    public final void j() {
        ViewTreeObserver viewTreeObserver;
        if (this.h != null && (viewTreeObserver = this.f19452i) != null) {
