...
public final class h6 {
    ...
    public long f19769l;
    public long f19770m;
    public float f19773p;
    public boolean f19774q;
    public TLRPC.TL_theme f19775r;
    public TLRPC.TL_wallPaper f19776s;
    public int f19777t;
    public String f19778u;
    public String v;
    public TLRPC.InputFile f19779w;
    public TLRPC.InputFile f19780x;
    public c6 f19781y;
    public boolean f19782z;
    public int f19771n = 45;
    ...
    public static void g(SparseIntArray sparseIntArray) {
        ...
        for (int i12 = j6.Ub; i12 < j6.f19894cc; i12++) {
    ...
    public final File d() {
        if (this.f19761a < 100) {
            ...
            String m9 = this.f19762b.m();
            int i10 = this.f19761a;
            String str = this.f19772o;
            return new File(filesDirFixed, m9 + "_" + i10 + "_" + str + "_v5.jpg");
        } else if (TextUtils.isEmpty(this.f19772o)) {
            return null;
        } else {
            File filesDirFixed2 = ApplicationLoader.getFilesDirFixed();
            Locale locale2 = Locale.US;
            String m10 = this.f19762b.m();
            int i11 = this.f19761a;
            String str2 = this.f19772o;
