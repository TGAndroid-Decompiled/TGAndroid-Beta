...
public abstract class x5 {
    public static final int f19674a = h6.f18789d6;
    public static float[] f19675b;
    ...
    public static int b(int i10) {
        ...
        return Color.HSVToColor(127, f19675b);
    }
    ...
    public static org.telegram.ui.Cells.z c(w5 w5Var, int i10) {
        ...
        drawable.f19663b = -1.0f;
        if (w5.f19661c == null) {
            Paint paint = new Paint(1);
            w5.f19661c = paint;
            paint.setColor(-1);
        }
        drawable.f19662a = w5.f19661c;
