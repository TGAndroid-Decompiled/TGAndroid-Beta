                    ...
                    if (num != null) {
                        if (num.intValue() == i18) {
                            ...
                            if (LocaleController.isRTL) {
                                ...
                                if (view != null) {
                                    paddingLeft2 = org.telegram.messenger.a2.C(8.0f, view.getMeasuredWidth(), paddingLeft2);
                                }
                                ...
                                if (view != null) {
                                    paddingRight2 = em.v(8.0f, view.getMeasuredWidth(), paddingRight2);
                                }
