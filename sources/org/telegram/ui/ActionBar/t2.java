                    ...
                    if (num != null) {
                        if (num.intValue() == i18) {
                            ...
                            if (LocaleController.isRTL) {
                                ...
                                if (view != null) {
                                    paddingLeft2 = org.telegram.messenger.z0.C(8.0f, view.getMeasuredWidth(), paddingLeft2);
                                }
                                ...
                                if (view != null) {
                                    paddingRight2 = ul.w(8.0f, view.getMeasuredWidth(), paddingRight2);
                                }
