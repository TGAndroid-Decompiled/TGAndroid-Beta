...
public abstract class l5 extends TextView {
    ...
    public final org.telegram.ui.Components.c6 f19378b;
    public final tp f19379c;

    public l5(Context context) {
        super(context);
        this.f19377a = false;
        this.f19378b = new org.telegram.ui.Components.c6(this, 320L, qr.h);
        this.f19379c = new tp(-1);
    }

    @Override
    public final void onDraw(Canvas canvas) {
        Canvas canvas2;
        float e = this.f19378b.e(this.f19377a);
        if (e < 1.0f) {
            if (e <= 0.0f) {
                canvas.save();
                canvas2 = canvas;
