...
public final class u3 extends j1.b {
    public final Rect f19580o;
    public final y3 f19581p;

    public u3(y3 y3Var, y3 y3Var2) {
        super(y3Var2);
        this.f19581p = y3Var;
        this.f19580o = new Rect();
    }

    @Override
    public final int g(float f7, float f10) {
        y3 y3Var = this.f19581p;
        ArrayList arrayList = y3Var.R;
        if (y3Var.V >= 0.5f) {
            org.telegram.ui.Cells.z zVar = y3Var.f19717i0;
            if (zVar != null && zVar.getBounds().contains((int) f7, (int) f10)) {
                return 1;
            }
            for (int size = arrayList.size() - 1; size >= 0; size--) {
                x3 x3Var = (x3) arrayList.get(size);
                float f11 = x3Var.f19682i;
                RectF rectF = x3Var.f19677a;
                if (Math.abs(f11) < 0.4f && rectF.contains(f7, f10)) {
                    Rect bounds = x3Var.d.f19408k.getBounds();
    ...
    public final void h(ArrayList arrayList) {
        ...
        if (y3Var.V >= 0.5f) {
            ...
            for (int i10 = 0; i10 < arrayList2.size(); i10++) {
                ...
                if (Math.abs(x3Var.f19682i) < 0.4f && !x3Var.f19677a.isEmpty()) {
                    arrayList.add(Integer.valueOf(i10 + 1000));
                    m3 m3Var = x3Var.d;
                    if (m3Var != null && !m3Var.f19408k.getBounds().isEmpty()) {
    ...
    public final boolean k(int i10, int i11) {
        ...
        if (i11 == 16) {
            ...
            if (i12 >= 0 && i12 < arrayList.size()) {
                ...
                if (z10) {
                    p3 p3Var2 = y3Var.f19705a;
                    if (p3Var2 != null) {
                        p3Var2.g(x3Var.f19679c, new ci.m2(25, this, x3Var));
                        return true;
                    }
                } else if (y3Var.f19705a != null) {
                    y3Var.a(false);
                    x3Var.getClass();
                    y3Var.f19705a.e(x3Var.f19679c);
                }
                return true;
            }
        }
