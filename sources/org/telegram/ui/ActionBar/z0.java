...
public final class z0 extends AnimatorListenerAdapter {
    ...
    public final void onAnimationEnd(Animator animator) {
        switch (this.f19735a) {
            case 0:
                c1 c1Var = (c1) this.f19737c;
                c1Var.T = null;
                c1Var.f18528a = this.f19736b;
                c1Var.invalidate();
                return;
            case 1:
                w3 w3Var = (w3) this.f19737c;
                w3Var.f19650i = this.f19736b;
                ...
                return;
            case 2:
                o6 o6Var = (o6) this.f19737c;
                o6Var.E = this.f19736b;
                o6Var.invalidate();
                return;
            case 3:
                ColorMatrix colorMatrix = new ColorMatrix();
                z7 z7Var = (z7) this.f19737c;
                float f7 = this.f19736b;
                z7Var.v = f7;
                ...
                return;
            case 4:
                w9 w9Var = (w9) this.f19737c;
                w9Var.f29672g = this.f19736b;
                w9Var.invalidateSelf();
                return;
            default:
                ug0 ug0Var = (ug0) this.f19737c;
                ug0Var.H.unlock();
                float f10 = this.f19736b;
                ug0Var.f28395b = f10;
                if (f10 <= 0.0f) {
                    ug0Var.G = -1;
                }
                ug0Var.c(true);
                ug0Var.f28397f = false;
