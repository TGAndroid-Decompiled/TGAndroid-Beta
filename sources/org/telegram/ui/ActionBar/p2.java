    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f19733a) {
            ...
            case 1:
                ...
                return;
            case 2:
                this.f19734b.onContainerViewTranslation();
                return;
            case 3:
                this.f19734b.onContainerViewTranslation();
                return;
            case 4:
                ...
                return;
            case 5:
                f3.j(this.f19734b, valueAnimator);
                return;
            case 6:
                this.f19734b.onContainerViewTranslation();
                return;
            default:
                f3.i(this.f19734b, valueAnimator);
                return;
        }
    }
}
