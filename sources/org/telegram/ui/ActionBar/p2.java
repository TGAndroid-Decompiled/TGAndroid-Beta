    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f21323a) {
            ...
            case 1:
                ...
                return;
            case 2:
                this.f21324b.onContainerViewTranslation();
                return;
            case 3:
                this.f21324b.onContainerViewTranslation();
                return;
            case 4:
                ...
                return;
            case 5:
                f3.j(this.f21324b, valueAnimator);
                return;
            case 6:
                this.f21324b.onContainerViewTranslation();
                return;
            default:
                f3.i(this.f21324b, valueAnimator);
                return;
        }
    }
}
