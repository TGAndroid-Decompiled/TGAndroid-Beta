    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f19460a) {
            ...
            case 1:
                ...
                return;
            case 2:
                this.f19461b.onContainerViewTranslation();
                return;
            case 3:
                this.f19461b.onContainerViewTranslation();
                return;
            case 4:
                ...
                return;
            case 5:
                f3.j(this.f19461b, valueAnimator);
                return;
            case 6:
                this.f19461b.onContainerViewTranslation();
                return;
            default:
                f3.i(this.f19461b, valueAnimator);
                return;
        }
    }
}
