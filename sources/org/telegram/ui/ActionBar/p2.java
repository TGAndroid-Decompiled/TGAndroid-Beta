    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f19718a) {
            ...
            case 1:
                ...
                return;
            case 2:
                this.f19719b.onContainerViewTranslation();
                return;
            case 3:
                this.f19719b.onContainerViewTranslation();
                return;
            case 4:
                ...
                return;
            case 5:
                f3.j(this.f19719b, valueAnimator);
                return;
            case 6:
                this.f19719b.onContainerViewTranslation();
                return;
            default:
                f3.i(this.f19719b, valueAnimator);
                return;
        }
    }
}
