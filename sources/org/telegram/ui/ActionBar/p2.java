    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f19495a) {
            ...
            case 1:
                ...
                return;
            case 2:
                this.f19496b.onContainerViewTranslation();
                return;
            case 3:
                this.f19496b.onContainerViewTranslation();
                return;
            case 4:
                ...
                return;
            case 5:
                f3.j(this.f19496b, valueAnimator);
                return;
            case 6:
                this.f19496b.onContainerViewTranslation();
                return;
            default:
                f3.i(this.f19496b, valueAnimator);
                return;
        }
    }
}
