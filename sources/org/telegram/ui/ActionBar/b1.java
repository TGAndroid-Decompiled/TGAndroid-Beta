...
public abstract class b1 extends FrameLayout {
    ...
    public float f18739a0;
    public Utilities.Callback2 f18740b;
    public float f18741b0;
    public final x0 f18742c;
    public long f18743c0;
    public final x0 d;
    public boolean f18744d0;
    public final org.telegram.ui.Components.e6 e;
    public Bitmap f18745f;
    public BitmapShader h;
    public Matrix f18746n;
    public final int[] f18747r;
    public float f18748s;
    public boolean v;
    public boolean f18749w;
    public final d6 f18750x;
    public final Paint f18751y;
    ...
    public final void c(float f7, boolean z10) {
        ...
        if (!z10) {
            ...
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f18738a, a2);
            this.T = ofFloat;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.v) {
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18748s), AndroidUtilities.dp(this.f18748s), this.f18751y);
        }
        boolean z10 = this.f18749w;
        Paint paint = this.J;
        if (z10) {
            ...
            if (d < 1.0f) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18748s), AndroidUtilities.dp(this.f18748s), paint2);
            }
            if (this.f18745f != null && this.f18738a < 1.0f && d > 0.0f) {
                Paint paint3 = this.F;
                paint3.setAlpha((int) (d * 255.0f));
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18748s), AndroidUtilities.dp(this.f18748s), paint3);
            }
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18748s), AndroidUtilities.dp(this.f18748s), this.G);
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18748s), AndroidUtilities.dp(this.f18748s), this.H);
            paint.setColor(-1);
        } else {
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18748s), AndroidUtilities.dp(this.f18748s), this.E);
        }
        a(canvas);
        if (!this.L) {
            b(canvas, false);
        }
        if (this.f18738a < 1.0f) {
            canvas.save();
            canvas.clipRect(getPaddingLeft(), getPaddingTop(), (((getWidth() - getPaddingLeft()) - getPaddingRight()) * this.f18738a) + getPaddingLeft(), getHeight() - getPaddingBottom());
        }
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(this.f18748s), AndroidUtilities.dp(this.f18748s), paint);
        a(canvas);
        if (!this.L) {
            b(canvas, true);
        }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int[] iArr = this.f18747r;
        getLocationOnScreen(iArr);
        Matrix matrix = this.f18746n;
        if (matrix != null) {
            matrix.reset();
            this.f18746n.postScale(8.0f, 8.0f);
            this.f18746n.postTranslate(-iArr[0], -iArr[1]);
            BitmapShader bitmapShader = this.h;
            if (bitmapShader != null) {
                bitmapShader.setLocalMatrix(this.f18746n);
                invalidate();
            }
        }
        boolean z11 = this.N;
        d6 d6Var = this.f18750x;
        if (z11) {
            Drawable r02 = h6.r0();
            if (r02 instanceof ColorDrawable) {
                ...
                v02 = h6.l1(0.25f, h6.v0(h6.f19059d6, d6Var));
            }
        } else {
            v02 = h6.v0(h6.f19059d6, d6Var);
            if (!h6.I.q()) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f18749w && this.f18745f == null && !this.U && z10) {
            this.V.run();
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            this.f18744d0 = true;
            this.f18739a0 = x10;
            this.f18741b0 = this.f18738a;
            this.f18743c0 = System.currentTimeMillis();
            return true;
        }
        if (action == 2 || action == 1) {
            ...
            if (action == 1) {
                this.f18744d0 = false;
                if (System.currentTimeMillis() - this.f18743c0 < ViewConfiguration.getTapTimeout()) {
                    ...
                    Utilities.Callback2 callback2 = this.f18740b;
                    if (callback2 != null) {
            ...
            float max = ((x10 - this.f18739a0) / Math.max(1, (getWidth() - getPaddingLeft()) - getPaddingRight())) + this.f18741b0;
            if (this.M != null) {
                int i11 = 0;
                while (true) {
                    float[] fArr2 = this.M;
            ...
            boolean z10 = !this.f18744d0;
            c(max, false);
            Utilities.Callback2 callback22 = this.f18740b;
            if (callback22 != null) {
                callback22.run(Float.valueOf(this.f18738a), Boolean.valueOf(z10));
            }
        }
        return true;
    }
