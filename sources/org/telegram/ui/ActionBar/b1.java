...
public final class b1 extends c1 {
    public final a1 f18690e0;
    public String f18691f0;
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        this.f18690e0.e(this, accessibilityNodeInfo);
    }

    @Override
    public final boolean performAccessibilityAction(int i10, Bundle bundle) {
        if (!super.performAccessibilityAction(i10, bundle) && !this.f18690e0.g(this, i10, bundle)) {
            return false;
        }
        return true;
    }
