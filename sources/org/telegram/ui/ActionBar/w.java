...
public final class w extends FrameLayout {
    ...
    public int h;
    public int f19873n;
    public LinearGradient f19874r;
    public final Matrix f19875s;
    public Paint v;
    public a4 f19876w;
    public boolean f19877x;
    public boolean f19878y;

    public w(Context context, ActionBarLayout actionBarLayout) {
        super(context);
        this.E = actionBarLayout;
        this.f19869a = new Rect();
        this.d = new Paint();
        this.f19875s = new Matrix();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        z3 z3Var = actionBarLayout.f18654x;
        boolean z10 = false;
        if (z3Var != null) {
            w02 = z3Var.getInternalNavbarPaint().getColor();
        } else {
            w02 = j6.w0(null, j6.f19053a7, false);
        }
        if (this == actionBarLayout.f18652w) {
            org.telegram.ui.Components.d6 d6Var = actionBarLayout.f18615b1;
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if ((!z10 && !actionBarLayout.f18611a0) || (motionEvent.getActionMasked() != 0 && motionEvent.getActionMasked() != 5)) {
            if (z10) {
                try {
                    if (this != actionBarLayout.f18647s) {
                    }
                } catch (Throwable th2) {
                    FileLog.e(th2);
                }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (!actionBarLayout.O0.isEmpty()) {
            n2Var = (n2) org.telegram.ui.Cells.c1.i(1, actionBarLayout.O0);
        } else {
            n2Var = null;
        }
        s sVar = actionBarLayout.G;
        ...
        if (i11 != 0 && (drawable = ActionBarLayout.f18607p1) != null) {
            int alpha = drawable.getAlpha();
            int i15 = i12 + i11;
            ActionBarLayout.f18607p1.setBounds(0, i15, getMeasuredWidth(), ActionBarLayout.f18607p1.getIntrinsicHeight() + i15);
            ActionBarLayout.f18607p1.setAlpha(i10);
            ActionBarLayout.f18607p1.draw(canvas);
            ActionBarLayout.f18607p1.setAlpha(alpha);
        }
        if (this.f19878y && this.f19877x && n2Var != null && (i13 = AndroidUtilities.navigationBarHeight) >= AndroidUtilities.dp(32.0f)) {
            int i16 = (int) (i13 * 1.33f);
            int navigationBarColor = n2Var.getNavigationBarColor();
            if (i16 != this.h || this.f19873n != navigationBarColor || this.v == null) {
                if (this.v == null) {
                    this.v = new Paint(1);
                }
                this.f19873n = navigationBarColor;
                this.h = i16;
                ...
                this.f19874r = linearGradient;
                this.v.setShader(linearGradient);
            }
            Matrix matrix = this.f19875s;
            matrix.reset();
            matrix.postTranslate(0.0f, getHeight() - i16);
            this.f19874r.setLocalMatrix(matrix);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f19871c != 0) {
            ...
            canvas2 = canvas;
            canvas2.drawRect(0.0f, (getMeasuredHeight() - this.f19871c) - 3, getMeasuredWidth(), getMeasuredHeight(), paint);
        } else {
            canvas2 = canvas;
        }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (runnable != null && !actionBarLayout.f18647s.f19870b && !actionBarLayout.v.f19870b) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        boolean z11 = this.f19872f;
        ActionBarLayout actionBarLayout = this.E;
        if (z11 != z10 && actionBarLayout.y() && (actionBarLayout.h || actionBarLayout.f18611a0)) {
        ...
        this.f19872f = z10;
        int childCount = getChildCount();
        getWindowVisibleDisplayFrame(this.f19869a);
        ...
        for (int i16 = 0; i16 < childCount; i16++) {
            ...
            if (!(childAt2 instanceof k)) {
                if (childAt2 instanceof k2) {
                    if (actionBarLayout.v(false) <= 0 && this.f19877x) {
                        i14 = actionBarLayout.f18640n1.d;
                    } else {
                        i14 = 0;
                    }
                    ...
                    if (this.f19877x) {
                        i13 = actionBarLayout.f18640n1.d;
                    } else {
                        i13 = 0;
                    }
