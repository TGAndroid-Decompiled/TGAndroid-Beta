...
public class ActionBarPopupWindow$ActionBarPopupWindowLayout extends FrameLayout {
    ...
    public ArrayList f18645x;
    public final HashMap f18646y;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        fh0 fh0Var = this.J;
        if (z12) {
            setTranslationX((1.0f - this.f18640f) * getMeasuredWidth());
            View view = this.P;
            if (view != null) {
                view.setTranslationX((1.0f - this.f18640f) * getMeasuredWidth());
                this.P.setAlpha(1.0f - fh0Var.f24171b);
                float f11 = (-(this.P.getMeasuredHeight() - AndroidUtilities.dp(16.0f))) * fh0Var.f24171b;
        ...
        if (this.N != null) {
            ...
            for (float f12 = 16.0f; i26 < 2 && (i26 != i10 || i22 >= (-AndroidUtilities.dp(f12))); f12 = 16.0f) {
                ...
                if (z10 && this.f18642r != 255) {
                    ...
                    f10 = 1.0f;
                    canvas2 = canvas;
                    canvas2.saveLayerAlpha(0.0f, rect2.top, getMeasuredWidth(), getMeasuredHeight(), this.f18642r, 31);
                    z11 = false;
                } else {
                    i11 = i26;
                    i12 = saveCount;
                ...
                if (this.v) {
                    ...
                    AndroidUtilities.rectTmp2.set(0, (int) ((f10 - this.h) * measuredHeight), (int) (getMeasuredWidth() * this.f18640f), measuredHeight);
                } else if (i22 > (-AndroidUtilities.dp(f7))) {
                    int measuredHeight2 = (int) (getMeasuredHeight() * this.h);
                    if (i11 == 0) {
                        if (fh0Var != null && fh0Var.P) {
                            Rect rect3 = AndroidUtilities.rectTmp2;
                            int measuredWidth = getMeasuredWidth() - ((int) (getMeasuredWidth() * this.f18640f));
                            if (scrollView == null) {
                                i19 = 0;
                            } else {
                            ...
                            int i28 = i17 + i18;
                            int measuredWidth3 = (int) (getMeasuredWidth() * this.f18640f);
                            if (this.E != i13) {
                                measuredHeight2 = Math.min(measuredHeight2, AndroidUtilities.dp(f7) + i22);
                            }
                        ...
                        AndroidUtilities.rectTmp2.set(getMeasuredWidth() - ((int) (getMeasuredWidth() * this.f18640f)), i24, getMeasuredWidth(), measuredHeight2);
                    } else {
                        AndroidUtilities.rectTmp2.set(0, i24, (int) (getMeasuredWidth() * this.f18640f), measuredHeight2);
                    }
                } else if (fh0Var != null && fh0Var.P) {
                    Rect rect5 = AndroidUtilities.rectTmp2;
                    int measuredWidth4 = getMeasuredWidth() - ((int) (getMeasuredWidth() * this.f18640f));
                    if (this.E < 0) {
                        i16 = 0;
                    } else {
                    ...
                    rect6.set(0, i15, (int) (getMeasuredWidth() * this.f18640f), (int) (getMeasuredHeight() * this.h));
                }
                if (this.I != f10) {
                    if (this.R == null) {
                        this.R = new Rect();
    ...
    public final void e(View view) {
        ...
        if (this.f18644w) {
            ...
            animatorSet.setInterpolator(m1.f19617m);
            animatorSet.start();
            if (this.f18645x == null) {
                this.f18645x = new ArrayList();
            }
            this.f18645x.add(animatorSet);
        }
    }
    ...
    public void setBackScaleY(float f7) {
        ...
        if (this.h != f7) {
            this.h = f7;
            if (this.f18644w && this.f18637a) {
                int measuredHeight = getMeasuredHeight() - AndroidUtilities.dp(16.0f);
                boolean z10 = this.v;
                HashMap hashMap = this.f18646y;
                i1 i1Var = this.L;
                if (z10) {
                    for (int i10 = this.f18643s; i10 >= 0; i10--) {
    ...
    public ActionBarPopupWindow$ActionBarPopupWindowLayout(int i10, int i11, Context context, d6 d6Var) {
        ...
        if ((i11 & 1) > 0) {
            ...
            frameLayout.f24170a = new SparseIntArray();
            frameLayout.f24172c = -1.0f;
            Paint paint = new Paint(1);
            frameLayout.f24174n = paint;
            frameLayout.f24175r = new Paint();
            frameLayout.f24176s = 0;
            frameLayout.v = new Path();
            frameLayout.f24177w = new RectF();
            frameLayout.f24178x = new ArrayList();
            frameLayout.G = -1;
