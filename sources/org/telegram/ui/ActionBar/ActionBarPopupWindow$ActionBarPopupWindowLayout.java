...
public class ActionBarPopupWindow$ActionBarPopupWindowLayout extends FrameLayout {
    ...
    public ArrayList f18652x;
    public final HashMap f18653y;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        float scaleY;
        int scrollY3;
        boolean z12 = this.f18646c;
        eh0 eh0Var = this.J;
        if (z12) {
            setTranslationX((1.0f - this.f18647f) * getMeasuredWidth());
            View view = this.P;
            if (view != null) {
                view.setTranslationX((1.0f - this.f18647f) * getMeasuredWidth());
                this.P.setAlpha(1.0f - eh0Var.f23851b);
                float f11 = (-(this.P.getMeasuredHeight() - AndroidUtilities.dp(16.0f))) * eh0Var.f23851b;
        ...
        if (this.N != null) {
            ...
            for (float f12 = 16.0f; i26 < 2 && (i26 != i10 || i22 >= (-AndroidUtilities.dp(f12))); f12 = 16.0f) {
                ...
                if (z10 && this.f18649r != 255) {
                    ...
                    f10 = 1.0f;
                    canvas2 = canvas;
                    canvas2.saveLayerAlpha(0.0f, rect2.top, getMeasuredWidth(), getMeasuredHeight(), this.f18649r, 31);
                    z11 = false;
                } else {
                    i11 = i26;
                    i12 = saveCount;
                ...
                if (this.v) {
                    ...
                    AndroidUtilities.rectTmp2.set(0, (int) ((f10 - this.h) * measuredHeight), (int) (getMeasuredWidth() * this.f18647f), measuredHeight);
                } else if (i22 > (-AndroidUtilities.dp(f7))) {
                    int measuredHeight2 = (int) (getMeasuredHeight() * this.h);
                    if (i11 == 0) {
                        if (eh0Var != null && eh0Var.P) {
                            Rect rect3 = AndroidUtilities.rectTmp2;
                            int measuredWidth = getMeasuredWidth() - ((int) (getMeasuredWidth() * this.f18647f));
                            if (scrollView == null) {
                                i19 = 0;
                            } else {
                            ...
                            int i28 = i17 + i18;
                            int measuredWidth3 = (int) (getMeasuredWidth() * this.f18647f);
                            if (this.E != i13) {
                                measuredHeight2 = Math.min(measuredHeight2, AndroidUtilities.dp(f7) + i22);
                            }
                        ...
                        AndroidUtilities.rectTmp2.set(getMeasuredWidth() - ((int) (getMeasuredWidth() * this.f18647f)), i24, getMeasuredWidth(), measuredHeight2);
                    } else {
                        AndroidUtilities.rectTmp2.set(0, i24, (int) (getMeasuredWidth() * this.f18647f), measuredHeight2);
                    }
                } else if (eh0Var != null && eh0Var.P) {
                    Rect rect5 = AndroidUtilities.rectTmp2;
                    int measuredWidth4 = getMeasuredWidth() - ((int) (getMeasuredWidth() * this.f18647f));
                    if (this.E < 0) {
                        i16 = 0;
                    } else {
                    ...
                    rect6.set(0, i15, (int) (getMeasuredWidth() * this.f18647f), (int) (getMeasuredHeight() * this.h));
                }
                if (this.I != f10) {
                    if (this.R == null) {
                        this.R = new Rect();
    ...
    public final void e(View view) {
        ...
        if (this.f18651w) {
            ...
            animatorSet.setInterpolator(n1.f19637m);
            animatorSet.start();
            if (this.f18652x == null) {
                this.f18652x = new ArrayList();
            }
            this.f18652x.add(animatorSet);
        }
    }
    ...
    public void setBackScaleY(float f7) {
        ...
        if (this.h != f7) {
            this.h = f7;
            if (this.f18651w && this.f18644a) {
                int measuredHeight = getMeasuredHeight() - AndroidUtilities.dp(16.0f);
                boolean z10 = this.v;
                HashMap hashMap = this.f18653y;
                j1 j1Var = this.L;
                if (z10) {
                    for (int i10 = this.f18650s; i10 >= 0; i10--) {
                        ...
                        if (childAt != null && childAt.getVisibility() == 0 && !(childAt instanceof k1)) {
                            if (((Integer) hashMap.get(childAt)) != null) {
                                if (rk.x(32.0f, AndroidUtilities.dp(48.0f) * num.intValue(), measuredHeight) > measuredHeight * f7) {
                                    break;
                                }
                            }
                            this.f18650s = i10 - 1;
    ...
    public ActionBarPopupWindow$ActionBarPopupWindowLayout(int i10, int i11, Context context, f6 f6Var) {
        ...
        if ((i11 & 1) > 0) {
            ...
            frameLayout.f23850a = new SparseIntArray();
            frameLayout.f23852c = -1.0f;
            Paint paint = new Paint(1);
            frameLayout.f23854n = paint;
            frameLayout.f23855r = new Paint();
            frameLayout.f23856s = 0;
            frameLayout.v = new Path();
            frameLayout.f23857w = new RectF();
            frameLayout.f23858x = new ArrayList();
            frameLayout.G = -1;
        ...
        if ((i11 & 4) == 0) {
            try {
                ...
                eh0 eh0Var = this.J;
                if (eh0Var != null) {
                    eh0Var.addView(scrollView, w7.y5.e(-2, -2, this.v ? 80 : 48));
                } else {
        ...
        eh0 eh0Var2 = this.J;
        if (eh0Var2 != null) {
            eh0Var2.addView(j1Var, w7.y5.e(-2, -2, this.v ? 80 : 48));
        } else {
