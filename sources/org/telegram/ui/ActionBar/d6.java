...
public final class d6 implements NotificationCenter.NotificationCenterDelegate {
    public static d6 f18592c;
    public int f18593a;
    public HashMap f18594b;
    ...
    public static void a(boolean z10) {
        ...
        for (int i10 = 0; i10 < 5; i10++) {
            ...
            if (h6Var != null && (arrayList = h6Var.f18730b0) != null && !arrayList.isEmpty()) {
                int size = h6Var.f18730b0.size();
                for (int i11 = 0; i11 < size; i11++) {
                    g6 g6Var = (g6) h6Var.f18730b0.get(i11);
                    if (g6Var.f18690a != i6.f19011n && !TextUtils.isEmpty(g6Var.f18701o)) {
                        if (arrayList2 == null) {
        ...
        ?? obj = new Object();
        obj.f18593a = UserConfig.selectedAccount;
        if (arrayList2 != null) {
    ...
    public static Bitmap b(Bitmap bitmap, boolean z10, File file, g6 g6Var) {
        ...
        try {
            ...
            i6.G(Q0, h6Var);
            int i14 = g6Var.f18692c;
            int i15 = (int) g6Var.f18696j;
            ...
            if (i18 != 0) {
                ...
                Drawable t9Var = new t9(t9.d(g6Var.f18700n), new int[]{i15, i16});
            ...
            try {
                if (drawable != null) {
                    ...
                    paint.setAlpha((int) (Math.abs(g6Var.f18702p) * 255.0f));
