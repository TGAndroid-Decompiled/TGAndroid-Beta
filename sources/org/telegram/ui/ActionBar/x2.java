...
public final class x2 extends FrameLayout {
    public final org.telegram.ui.Components.y5 f19916a;
    public final ImageView f19917b;
    ...
    public x2(Context context, int i10, d6 d6Var) {
        ...
        this.f19918c = imageView2;
        imageView2.setScaleType(scaleType);
        imageView2.setColorFilter(new PorterDuffColorFilter(h6.v0(h6.f19131h7, d6Var), PorterDuff.Mode.SRC_IN));
        if (LocaleController.isRTL) {
            i12 = 3;
        } else {
            i12 = 5;
        ...
        if (i10 != 0 && i10 != 4) {
            if (i10 == 1) {
                y5Var.setGravity(17);
                y5Var.setTextColor(h6.v0(h6.f19165j5, d6Var));
    ...
    public final void a(CharSequence charSequence, int i10, Drawable drawable, boolean z10) {
        ...
        int i11;
        float f11;
        org.telegram.ui.Components.y5 y5Var = this.f19916a;
        y5Var.setText(charSequence);
        float f12 = 16.0f;
        float f13 = 21.0f;
        ImageView imageView = this.f19917b;
    ...
    public void setChecked(boolean z10) {
        ...
        this.f19918c.setImageResource(i10);
    }

    public void setGravity(int i10) {
        this.f19916a.setGravity(i10);
    }

    public void setIconColor(int i10) {
        this.f19917b.setColorFilter(new PorterDuffColorFilter(i10, PorterDuff.Mode.MULTIPLY));
    }

    public void setTextColor(int i10) {
        this.f19916a.setTextColor(i10);
    }
}
