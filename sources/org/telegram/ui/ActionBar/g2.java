...
public final class g2 extends Drawable {
    ...
    public final void c(float f7, boolean z10) {
        ...
        if (z10) {
            if (f10 < f7) {
                this.f18680f = (int) (f10 * this.f18684k);
            } else {
                this.f18680f = (int) ((1.0f - f10) * this.f18684k);
            }
            this.f18679c = System.currentTimeMillis();
            this.d = f7;
        } else {
            this.e = f7;
            this.d = f7;
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.e != this.d) {
            if (this.f18679c != 0) {
                int currentTimeMillis = this.f18680f + ((int) (System.currentTimeMillis() - this.f18679c));
                this.f18680f = currentTimeMillis;
                float f7 = currentTimeMillis;
                float f10 = this.f18684k;
                if (f7 >= f10) {
                    this.e = this.d;
                } else {
                    float f11 = this.e;
        ...
        int d = i0.a.d(this.e, this.f18682i, this.f18683j);
        Paint paint = this.f18677a;
        paint.setColor(d);
        canvas.save();
        canvas.translate(AndroidUtilities.dp(24.0f) / 2.0f, AndroidUtilities.dp(24.0f) / 2.0f);
        int i12 = this.f18685l;
        if (i12 != 0) {
            canvas.rotate(i12);
        }
        float f13 = this.e;
    ...
    public final void setAlpha(int i10) {
        this.f18677a.setAlpha(i10);
    }

    @Override
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f18677a.setColorFilter(colorFilter);
    }
}
