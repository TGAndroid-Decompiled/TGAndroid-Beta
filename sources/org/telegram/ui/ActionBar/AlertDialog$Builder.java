        ...
        while (true) {
            ...
            if (i10 < zArr.length) {
                if (zArr[i10] && (textView = (TextView) d2Var.d(-(i10 + 1))) != null) {
                    textView.setTextColor(d2Var.e(j6.f20116q7));
                }
                i10++;
            } else {
                return d2Var;
