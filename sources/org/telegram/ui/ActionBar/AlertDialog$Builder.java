...
public class AlertDialog$Builder {
    ...
    public final void c() {
        int i10 = c2.f18489c1;
        this.f18446a.getClass();
    }

    public final void d(int i10) {
        int i11 = (-i10) - 1;
        if (i11 >= 0) {
            boolean[] zArr = this.f18447b;
            if (i11 < zArr.length) {
                zArr[i11] = true;
            }
        }
        ...
        while (true) {
            ...
            if (i10 < zArr.length) {
                if (zArr[i10] && (textView = (TextView) c2Var.d(-(i10 + 1))) != null) {
                    textView.setTextColor(c2Var.e(j6.f19100q7));
                }
                i10++;
            } else {
                return c2Var;
