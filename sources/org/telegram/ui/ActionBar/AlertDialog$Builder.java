        ...
        while (true) {
            ...
            if (i10 < zArr.length) {
                if (zArr[i10] && (textView = (TextView) b2Var.d(-(i10 + 1))) != null) {
                    textView.setTextColor(b2Var.e(j6.f19333q7));
                }
                i10++;
            } else {
                return b2Var;
