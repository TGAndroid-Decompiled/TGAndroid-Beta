...
public final class v3 extends View {
    ...
    public m3 f19853a;
    public final int[] f19854a0;
    public s3 f19855b;
    public final int[] f19856b0;
    public j3 f19857c;
    public final RectF f19858c0;
    public ValueAnimator d;
    public final RectF f19859d0;
    public float e;
    ...
    public final int f19868r;
    public int f19869s;
    public final r3 v;
    public u3 f19870w;
    public boolean f19871x;
    public float f19872y;
    ...
    public v3(LaunchActivity launchActivity) {
        ...
        this.f19856b0 = new int[2];
        this.f19858c0 = new RectF();
        this.f19859d0 = new RectF();
        this.f19860e0 = new RectF();
        this.f19862f0 = new Path();
        setWillNotDraw(false);
        this.h = new OverScroller(launchActivity);
        ViewConfiguration viewConfiguration = ViewConfiguration.get(launchActivity);
        this.f19867n = viewConfiguration.getScaledMaximumFlingVelocity();
        this.f19868r = viewConfiguration.getScaledMinimumFlingVelocity();
    ...
    public final void b(s3 s3Var) {
        ...
        if (this.f19855b != null && (valueAnimator = this.d) != null) {
            valueAnimator.end();
            this.d = null;
        }
        this.f19855b = s3Var;
        ...
        for (int i10 = 0; i10 < tabDrawables.size(); i10++) {
            ...
            int indexOf = tabs.indexOf(j3Var2.f19488a);
            j3Var2.f19490c = indexOf;
            if (indexOf >= 0) {
                j3Var2.f19489b = indexOf;
            }
        }
        m3Var.n();
        m3Var.o(true);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        s3 s3Var = v3Var.f19855b;
        int[] iArr = v3Var.f19854a0;
        int[] iArr2 = v3Var.f19856b0;
        RectF rectF3 = v3Var.f19858c0;
        if (s3Var != null) {
            v3Var.getLocationOnScreen(iArr2);
            v3Var.f19853a.getLocationOnScreen(iArr);
            v3Var.f19853a.d(rectF3, 0.0f);
            rectF3.offset(iArr[0] - iArr2[0], iArr[1] - iArr2[1]);
            canvas.save();
            canvas.clipRect(0, 0, v3Var.getMeasuredWidth(), v3Var.getMeasuredHeight() - v3Var.f19869s);
            t3 mo37getWindowView = v3Var.f19855b.mo37getWindowView();
            float f18 = v3Var.e;
            RectF rectF4 = v3Var.f19860e0;
            float x10 = mo37getWindowView.x(canvas, rectF3, f18, rectF4, f18);
            if (v3Var.f19857c != null) {
                Path path = v3Var.f19862f0;
                path.rewind();
                ...
                v3Var.f19853a.setupTab(v3Var.f19857c);
                v3Var.f19857c.a(canvas, rectF3, x10, v3Var.e, 1.0f);
                rectF = rectF3;
                canvas.restore();
            } else {
                rectF = rectF3;
        ...
        while (true) {
            ...
            if (((u3) arrayList.get(i15)).d.f19490c >= 0) {
                f17 = 1.0f;
            } else {
                f17 = 0.0f;
            }
        ...
        float d = v3Var.f19861f.d(f22, false);
        ...
        while (i16 < arrayList.size() + 1) {
            if (i16 == arrayList.size()) {
                ...
                j3 j3Var2 = u3Var.d;
                float[] fArr = u3Var.f19824g;
                float f23 = dp;
                Matrix matrix = u3Var.f19823f;
                float[] fArr2 = u3Var.h;
                if (j3Var2 == null) {
                    f10 = 1.0f;
                } else {
                ...
                boolean z11 = z10;
                v3Var.f19853a.d(rectF, Utilities.clamp(j3Var2.c(), 1.0f, 0.0f));
                rectF.offset(v3Var.f19853a.getX(), v3Var.f19853a.getY());
                ...
                if (rectF6.top > f20 || rectF6.bottom < 0.0f) {
                    ...
                    matrix.setPolyToPoly(u3Var.f19824g, 0, u3Var.h, 0, 4);
                    ...
                    RadialGradient radialGradient = u3Var.f19832p;
                    Paint paint = u3Var.f19831o;
                    Paint paint2 = u3Var.f19834r;
                    f12 = lerp;
                    Matrix matrix2 = u3Var.f19833q;
                    l3 l3Var = u3Var.f19822c;
                    f14 = d;
                    Path path2 = u3Var.f19830n;
                    arrayList2 = arrayList;
                    Paint paint3 = u3Var.e;
                    rectF2 = rectF;
                    RectF rectF7 = u3Var.f19829m;
                    i12 = i14;
                    Paint paint4 = u3Var.f19828l;
                    f15 = f20;
                    f13 = f19;
                    float clamp = Utilities.clamp(1.0f - ((Math.abs(u3Var.f19825i) - 0.3f) / 0.7f), 1.0f, 0.0f) * lerp2;
                    if (clamp > 0.0f) {
                        float f30 = f29 * 1.0f;
                        ...
                        canvas.save();
                        canvas.rotate(u3Var.f19825i * 20.0f, (u3Var.f19825i * AndroidUtilities.dp(50.0f)) + rectF6.centerX(), rectF6.bottom + AndroidUtilities.dp(350.0f));
                        float a2 = u3Var.f19827k.a(0.01f);
                        ...
                        if (z11) {
                            ...
                            if (l3Var != null && l3Var.f19606m != null) {
                                float width3 = rectF6.width() / l3Var.f19606m.getWidth();
                                canvas.scale(width3, width3);
                                paint.setAlpha(i17);
                                canvas.drawBitmap(l3Var.f19606m, 0.0f, 0.0f, paint);
                            }
                            canvas.restore();
                            canvas.save();
        ...
        if (this.f19865i0 == null || this.f19864h0 != h6.I.q()) {
            ...
            this.f19864h0 = q6;
            if (q6) {
                this.f19865i0 = h6.i0(64, 64, 64, 64, 553648127, 872415231, 872415231);
            } else {
                this.f19865i0 = h6.i0(64, 64, 64, 64, 771751936, 1140850688, 1140850688);
            }
        ...
        this.f19865i0.draw(canvas);
        this.f19863g0.c(f34 + AndroidUtilities.dp(12.0f), f32 - (AndroidUtilities.dp(95.0f) / 2.0f), this.V, -1, canvas);
        canvas.restore();
    }
    ...
    public final float e(boolean z10) {
        ...
        while (true) {
            ...
            if (((u3) arrayList.get(i10)).d.f19490c >= 0) {
                f7 = 1.0f;
            } else {
                f7 = 0.0f;
            }
        ...
        if (z10) {
            return this.f19861f.d(f10, false);
        }
        return f10;
    }
    ...
    public final void f() {
        ...
        if (m3Var != null && (m3Var.getParent() instanceof View)) {
            ...
            View view = (View) this.f19853a.getParent();
            this.S = view;
            int[] iArr = this.f19854a0;
            if (view != null) {
                view.getLocationOnScreen(iArr);
            } else {
                iArr[1] = 0;
            ...
            ArrayList arrayList = this.R;
            arrayList.clear();
            ArrayList<l3> tabs = this.f19853a.getTabs();
            ArrayList<j3> tabDrawables = this.f19853a.getTabDrawables();
            ...
            this.f19861f.d(arrayList.size(), true);
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f19865i0 && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
