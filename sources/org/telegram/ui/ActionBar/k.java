...
public class k extends FrameLayout implements le.d, z5 {
    ...
    public ch.d f19476a;
    public int f19477a0;
    public boolean f19478a1;
    public ch.d f19479b;
    public boolean f19480b0;
    public float f19481b1;
    public ch.d f19482c;
    public CharSequence f19483c0;
    public final le.e f19484c1;
    public final z4 d;
    public Drawable f19485d0;
    public final le.b f19486d1;
    public ImageView e;
    public View.OnClickListener f19487e0;
    public final le.e f19488e1;
    public w9 f19489f;
    public String f19490f0;
    public final le.b f19491f1;
    public final Object[] f19492g0;
    public int f19493g1;
    public Drawable h;
    public Runnable f19494h0;
    public int f19495h1;
    public boolean f19496i0;
    public boolean f19497i1;
    public Runnable f19498j0;
    public boolean f19499j1;
    public boolean f19500k0;
    public boolean f19501k1;
    public int f19502l0;
    public boolean l1;
    public boolean m0;
    public ai.s f19503m1;
    public final j5[] f19504n;
    public boolean f19505n0;
    public boolean f19506n1;
    public float f19507o0;
    public boolean f19508o1;
    public int f19509p0;
    public int f19510p1;
    public int f19511q0;
    public int f19512q1;
    public j5 f19513r;
    public int f19514r0;
    public boolean f19515r1;
    public j5 f19516s;
    public int f19517s0;
    public float f19518s1;
    public n2 f19519t0;
    public ValueAnimator f19520t1;
    public j f19521u0;
    public View v;
    public int f19522v0;
    public int f19523w;
    ...
    public boolean f19528y0;
    public boolean f19529z0;

    public k(Context context, e6 e6Var) {
        super(context);
        this.d = z4.f19936a;
        this.f19504n = new j5[2];
        this.I = true;
        this.K = true;
        this.M = true;
        this.f19492g0 = new Object[3];
        this.f19500k0 = true;
        this.f19502l0 = 255;
        this.f19522v0 = 0;
        this.M0 = new Paint();
        ...
        qr qrVar = qr.h;
        this.f19484c1 = new le.e(0, this, qrVar, 380L);
        this.f19486d1 = new le.b(0, this, qrVar, 380L, false);
        this.f19488e1 = new le.e(0, this, qrVar, 320L);
        this.f19491f1 = new le.b(0, this, qrVar, 320L, false);
        this.f19515r1 = true;
        this.f19518s1 = 1.0f;
        this.J0 = e6Var;
    ...
    public void B(int i10, boolean z10) {
        ...
        if (imageView3 != null && this.T0) {
            imageView3.setColorFilter(new PorterDuffColorFilter(this.f19514r0, PorterDuff.Mode.SRC_IN));
        }
    }
    ...
    public final void I(CharSequence charSequence, org.telegram.ui.Components.o5 o5Var) {
        int i10;
        j5[] j5VarArr = this.f19504n;
        if (charSequence != null && j5VarArr[0] == null) {
            p(0);
        }
        j5 j5Var = j5VarArr[0];
        if (j5Var != null) {
            if (charSequence != null && !this.f19505n0) {
                i10 = 0;
            } else {
                i10 = 4;
            }
            ...
            this.f19483c0 = charSequence;
            j5Var2.k(charSequence);
            if (this.C0) {
                Drawable drawable = this.f19485d0;
    ...
    public final void J(CharSequence charSequence, boolean z10, long j3, Interpolator interpolator) {
        ...
        if (j5VarArr[0] != null && charSequence != null) {
            if (this.f19524w0 && !TextUtils.isEmpty(this.A0)) {
                z11 = true;
            } else {
                z11 = false;
            }
            if (z11) {
                if (this.f19513r.getVisibility() != 0) {
                    this.f19513r.setVisibility(0);
                    this.f19513r.setAlpha(0.0f);
                }
                ViewPropertyAnimator animate = this.f19513r.animate();
                if (z10) {
                    f7 = 0.0f;
                } else {
                    f7 = 1.0f;
                }
                wh.q(animate, f7, 220L);
            }
            j5 j5Var = j5VarArr[1];
            if (j5Var != null) {
    ...
    public final void K(String str, int i10, Runnable runnable) {
        ...
        if (this.f19480b0 && this.f19519t0.parentLayout != null) {
            Object[] objArr = this.f19492g0;
            objArr[0] = str;
            objArr[1] = Integer.valueOf(i10);
            objArr[2] = runnable;
            if (!this.Z0) {
                String str3 = this.f19490f0;
                if (str3 != null || str != null) {
                    if (str3 == null || !str3.equals(str)) {
                        this.f19490f0 = str;
                        Drawable drawable = null;
                        if (this.f19503m1 != null) {
                        ...
                        if ((spannableString == null || j5VarArr[0] != null) && getMeasuredWidth() != 0 && ((j5Var = j5VarArr[0]) == null || j5Var.getVisibility() == 0)) {
                            ...
                            if (j5Var2 != null) {
                                ...
                                j5VarArr[1].setRightDrawableOnClick(this.f19487e0);
                                if (drawable instanceof org.telegram.ui.Components.o5) {
                        ...
                        if (runnable == null) {
                            runnable = this.f19494h0;
                        }
                        this.f19498j0 = runnable;
                    }
                }
            }
        }
    ...
    public boolean N(View view) {
        if (this.L) {
            j5[] j5VarArr = this.f19504n;
            if (view == j5VarArr[0] || view == j5VarArr[1] || view == this.f19513r || view == this.E || view == this.e || view == this.f19516s || view == this.F0) {
                return true;
            }
        }
        return false;
    ...
    public void O(View[] viewArr, boolean[] zArr) {
        if (this.F != null && !this.J) {
            ...
            if (this.f19523w == 0) {
                if (!this.f19505n0) {
                    j5 j5Var = this.f19504n[0];
                    if (j5Var != null) {
                        arrayList.add(ObjectAnimator.ofFloat(j5Var, property, 0.0f));
                    }
                    if (this.f19513r != null && !TextUtils.isEmpty(this.A0)) {
                        arrayList.add(ObjectAnimator.ofFloat(this.f19513r, property, 0.0f));
                    }
                }
                z zVar = this.E;
                if (zVar != null) {
            ...
            if (imageView != null) {
                ...
                this.e.setBackgroundDrawable(j6.f0(this.f19511q0, 1, -1));
            }
        }
    }
    ...
    public final void b() {
        ...
        if (this.f19506n1) {
            if (this.f19508o1) {
                ai.x5 x5Var = this.F0;
                if (x5Var != null) {
                    x5Var.setAlpha(1.0f - this.f19518s1);
                } else {
                    j5 j5Var = this.f19504n[0];
                    if (j5Var != null) {
                        j5Var.setAlpha(1.0f - this.f19518s1);
                    }
                }
            }
            float f7 = this.f19518s1;
            int i10 = this.f19512q1;
            e6 e6Var = this.J0;
            if (i10 == -1) {
                v02 = 0;
            } else {
            ...
            setShadowAlpha((int) ((1.0f - this.f19518s1) * 255.0f));
            if (this.L0) {
                invalidate();
            }
        }
    ...
    public final void e() {
        ...
        ch.d dVar2 = this.f19482c;
        if (dVar2 != null) {
            dVar2.v();
        }
        ch.d dVar3 = this.f19479b;
        if (dVar3 != null) {
            dVar3.v();
        }
        ai.s sVar = this.f19503m1;
        if (sVar != null) {
            sVar.d();
        }
    }
    ...
    public final void g() {
        ...
        this.f19491f1.a(z10, this.f19501k1);
        le.e eVar = this.f19488e1;
        if (eVar.f14139g) {
            f7 = eVar.f14138f;
        } else {
            f7 = eVar.e;
    ...
    public int getShadowAlpha() {
        return this.f19502l0;
    }

    public String getSubtitle() {
        CharSequence charSequence;
        if (this.f19513r != null && (charSequence = this.A0) != null) {
    ...
    public j5 getTitleTextView() {
        return this.f19504n[0];
    }

    public j5 getTitleTextView2() {
        return this.f19504n[1];
    }
    ...
    public void h(boolean z10) {
        z zVar;
        if (this.f19505n0 && (zVar = this.E) != null) {
            zVar.j(z10);
        }
    }
    ...
    public final z j(String str) {
        ...
        if (!this.P0) {
            this.F.setBackgroundColor(j6.v0(j6.f19413w8, this.J0));
        }
    ...
    public final void l() {
        ...
        this.f19516s = j5Var;
        j5Var.setGravity(3);
        this.f19516s.setVisibility(8);
        this.f19516s.setTextColor(j6.v0(j6.B8, this.J0));
        addView(this.f19516s, 0, w7.y5.e(-2, -2, 51));
    }
    ...
    public final void m() {
        ...
        this.e.setBackgroundDrawable(j6.f0(this.f19509p0, 1, -1));
    ...
    public final void o() {
        ...
        this.f19513r.setTextColor(j6.v0(j6.B8, this.J0));
        addView(this.f19513r, 0, w7.y5.e(-2, -2, 51));
    }
    ...
    public final void onAttachedToWindow() {
        ...
        Drawable drawable = this.f19485d0;
        if (drawable instanceof org.telegram.ui.Components.o5) {
            ((org.telegram.ui.Components.o5) drawable).l(this.f19504n[0]);
        }
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        if (this.J) {
            ...
            if (i10 != 0 && this.f19523w != 0 && !this.P0) {
                if (i0.a.f(i10) < 0.699999988079071d) {
                    AndroidUtilities.setLightStatusBar((Activity) getContext(), false);
                } else {
                    AndroidUtilities.setLightStatusBar((Activity) getContext(), true);
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        Drawable y02;
        if (this.R && !this.f19496i0 && !LocaleController.isRTL && motionEvent.getAction() == 0 && (y02 = j6.y0()) != null && y02.getBounds().contains((int) motionEvent.getX(), (int) motionEvent.getY())) {
            this.V = true;
            mw0 mw0Var = this.S;
            j5[] j5VarArr = this.f19504n;
            if (mw0Var == null) {
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (zVar != null && zVar.getVisibility() != 8) {
            ...
            } else if (kVar.f19505n0) {
                if (kVar.m0) {
                    f11 = 0.0f;
                } else if (AndroidUtilities.isTablet()) {
                    f11 = 74.0f;
                }
                makeMeasureSpec = wh.y(f11, size, 1073741824);
                if (!kVar.f19527y) {
                    kVar.E.r(0.0f);
                }
            } else {
        ...
        int i20 = 0;
        while (true) {
            j5VarArr = kVar.f19504n;
            if (i20 >= 2) {
                break;
            }
            j5 j5Var3 = j5VarArr[0];
            if ((j5Var3 != null && j5Var3.getVisibility() != 8) || ((j5Var = kVar.f19513r) != null && j5Var.getVisibility() != 8)) {
                z zVar2 = kVar.E;
                if (zVar2 != null) {
                ...
                if (kVar.H0) {
                    C = size - (Math.max(dp, (AndroidUtilities.dp(16.0f) + i13) + kVar.f19477a0) * 2);
                } else {
                    C = org.telegram.messenger.q.C(16.0f, size - i13, dp) - kVar.f19477a0;
                }
                int max = Math.max(C, 0);
                boolean z10 = kVar.f19528y0;
                int i21 = 20;
                if (((z10 && i20 == 0) || (!z10 && i20 == i19)) && kVar.f19524w0 && kVar.f19526x0) {
                    ...
                    if (j5Var5 != null && j5Var5.getVisibility() != 8 && (j5Var2 = kVar.f19513r) != null && j5Var2.getVisibility() != 8) {
                        ...
                        j5 j5Var11 = kVar.f19513r;
                        if (j5Var11 != null && j5Var11.getVisibility() != 8) {
                            j5 j5Var12 = kVar.f19513r;
                ...
                j5 j5Var16 = kVar.f19513r;
                if (j5Var16 != null && j5Var16.getVisibility() != 8) {
                    kVar.f19513r.measure(View.MeasureSpec.makeMeasureSpec(max, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), Integer.MIN_VALUE));
                }
                ai.s sVar = kVar.f19503m1;
                if (sVar != null) {
                ...
                j5 j5Var17 = kVar.f19516s;
                if (j5Var17 != null && j5Var17.getVisibility() != 8) {
                    kVar.f19516s.measure(View.MeasureSpec.makeMeasureSpec(max, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), Integer.MIN_VALUE));
                }
            }
            i20++;
            i19 = 1;
        ...
        while (i22 < childCount) {
            ...
            if (childAt.getVisibility() != 8 && childAt != j5VarArr[0] && childAt != j5VarArr[1] && childAt != kVar.f19503m1 && childAt != kVar.f19513r && childAt != kVar.E && childAt != kVar.e && childAt != kVar.f19516s && childAt != kVar.f19489f) {
    ...
    public void r() {
        ...
        if (dVar != null && this.J) {
            ...
            if (!z10) {
                ...
                if (this.f19513r != null && !TextUtils.isEmpty(this.A0)) {
                    arrayList.add(ObjectAnimator.ofFloat(this.f19513r, property, 1.0f));
                }
            }
            z zVar = this.E;
            if (zVar != null) {
    ...
    public void setAdaptiveBackground(RecyclerView recyclerView) {
        y(recyclerView, false, j6.f19006a7, j6.f19340s8);
    }
    ...
    public void setBackButtonDrawable(Drawable drawable) {
        ...
        if (drawable instanceof g2) {
            ...
            g2Var.c(f7, false);
            g2Var.b(this.f19517s0);
            g2Var.a(this.f19514r0);
        } else if (drawable instanceof e5) {
            e5 e5Var = (e5) drawable;
            e5Var.f18799k = this.f19525x;
            e5Var.f18798j = this.f19514r0;
        } else if ((drawable instanceof BitmapDrawable) || (drawable instanceof VectorDrawable)) {
            this.e.setColorFilter(new PorterDuffColorFilter(this.f19514r0, PorterDuff.Mode.SRC_IN));
        }
        if (this.T0) {
            this.e.setColorFilter(new PorterDuffColorFilter(this.f19514r0, PorterDuff.Mode.SRC_IN));
        }
    ...
    public void setBackgroundColor(int i10) {
        ...
        if (imageView != null) {
            ...
            if (drawable instanceof e5) {
                ((e5) drawable).f18799k = i10;
            }
        }
    }

    public void setCastShadows(boolean z10) {
        if (this.f19500k0 != z10 && (getParent() instanceof View)) {
    ...
    public void setRightDrawableOnClick(View.OnClickListener onClickListener) {
        ...
        if (j5Var2 != null) {
            j5Var2.setRightDrawableOnClick(this.f19487e0);
        }
    }

    public void setSearchAvatarImageView(w9 w9Var) {
        w9 w9Var2 = this.f19489f;
        if (w9Var2 != w9Var) {
            if (w9Var2 != null) {
                removeView(w9Var2);
            }
    ...
    public void setSubtitle(CharSequence charSequence) {
        int i10;
        if (charSequence != null && this.f19513r == null) {
            o();
        }
        if (this.f19513r != null) {
            boolean isEmpty = TextUtils.isEmpty(charSequence);
            j5 j5Var = this.f19513r;
            if (!isEmpty && !this.f19505n0) {
                i10 = 0;
            } else {
                i10 = 8;
            }
            j5Var.setVisibility(i10);
            this.f19513r.setAlpha(1.0f);
            if (!isEmpty) {
                this.f19513r.l(charSequence, false);
            }
    ...
    public void setTitleScrollNonFitText(boolean z10) {
        this.f19504n[0].setScrollNonFitText(z10);
    }
    ...
    public void v(boolean z10) {
        ...
        if (!u10) {
            ...
            if (this.f19513r != null && !TextUtils.isEmpty(this.A0)) {
                arrayList.add(this.f19513r);
                j5 j5Var2 = this.f19513r;
                if (z10) {
                    i10 = 4;
                } else {
                    i10 = 0;
    ...
    public final void y(RecyclerView recyclerView, boolean z10, int i10, int i11) {
        ...
        this.f19515r1 = !canScrollVertically;
    ...
    public final void z(wl0 wl0Var, boolean z10) {
        y(wl0Var, z10, j6.f19006a7, j6.f19340s8);
    }
    ...
    public void setAdaptiveBackground(mo0 mo0Var) {
        ...
        this.f19515r1 = !canScrollVertically;
        this.f19518s1 = !canScrollVertically ? 1.0f : 0.0f;
        b();
    }
