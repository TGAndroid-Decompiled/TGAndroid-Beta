...
public final class j5 extends Drawable {
    ...
    public Paint f21502b;

    public j5(int i10) {
        this.f21501a = i10;
        switch (i10) {
            case 1:
                this.f21502b = new Paint(1);
                return;
            default:
                return;
        }
    ...
    public final void draw(Canvas canvas) {
        switch (this.f21501a) {
            case 0:
                canvas.drawCircle(getBounds().centerX(), getBounds().centerY() - AndroidUtilities.dp(1.0f), (getBounds().width() - AndroidUtilities.dp(8.0f)) / 2.0f, this.f21502b);
                return;
            default:
                Paint paint = this.f21502b;
