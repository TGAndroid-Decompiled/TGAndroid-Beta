...
public final class v5 extends Drawable {
    ...
    public final void draw(Canvas canvas) {
        ...
        switch (this.f20634a) {
            case 0:
                ...
                canvas.drawCircle(bounds.centerX(), bounds.centerY(), this.f20636c / 2.0f, (Paint) this.d);
                return;
            case 1:
                ...
                if (i12 == 7) {
                    ...
                    canvas.drawRoundRect((RectF) this.d, f10, f10, j6.f20292z);
                    return;
                }
                if (i12 != 1 && i12 != 6) {
                    if (i12 == 3) {
                ...
                canvas.drawCircle(bounds2.centerX(), bounds2.centerY(), i10, j6.f20292z);
                return;
            default:
    ...
    public int getIntrinsicHeight() {
        switch (this.f20634a) {
            case 0:
                return this.f20636c + this.f20635b;
            default:
