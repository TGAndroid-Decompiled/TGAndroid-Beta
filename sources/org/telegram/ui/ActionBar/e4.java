...
public final class e4 {
    public static final int[] h = {j6.f19123ra, j6.Aa, j6.Oh, j6.Nd, j6.Od, j6.Pd, j6.Qd, j6.Rd};
    public boolean f18618a;
    public boolean f18619b;
    public fg.b f18620c;
    public TLRPC.ChatTheme d;
    public String e;
    public final ArrayList f18621f;
    public final int f18622g;

    public e4(int i10) {
        this.f18621f = new ArrayList();
        this.f18622g = i10;
    }
    ...
    public static e4 a(int i10) {
        ...
        e4Var.f18619b = true;
        d4 d4Var = new d4();
        d4Var.f18575a = e(true);
        e4Var.f18621f.add(d4Var);
        d4 d4Var2 = new d4();
        d4Var2.f18575a = e(false);
    ...
    public static e4 c(int i10) {
        ...
        d4 d4Var = new d4();
        d4Var.f18575a = j6.N0("Blue");
        d4Var.e = 99;
        e4Var.f18621f.add(d4Var);
        d4 d4Var2 = new d4();
        d4Var2.f18575a = j6.N0("Day");
        d4Var2.e = 9;
        e4Var.f18621f.add(d4Var2);
        d4 d4Var3 = new d4();
        d4Var3.f18575a = j6.N0("Night");
        d4Var3.e = 0;
        e4Var.f18621f.add(d4Var3);
        d4 d4Var4 = new d4();
        d4Var4.f18575a = j6.N0("Dark Blue");
        d4Var4.e = 0;
        e4Var.f18621f.add(d4Var4);
        return e4Var;
    }
    ...
    public static void q(i6 i6Var, int i10) {
        ...
        h6 h6Var;
        if (i6Var != null) {
            if (i10 < 0 || (sparseArray = i6Var.f18758a0) == null || ((h6Var = (h6) sparseArray.get(i10)) != null && !h6Var.f18742z)) {
    ...
    public final SparseIntArray b(int i10, int i11) {
        ...
        if (j3.f18759b != null) {
            sparseIntArray = j6.Q0(new File(j3.f18759b), null, strArr);
        } else {
            String str = j3.d;
            if (str != null) {
        ...
        ((d4) arrayList.get(i11)).f18579g = strArr[0];
        if (h6Var != null) {
            SparseIntArray clone = sparseIntArray.clone();
            h6Var.c(sparseIntArray, clone);
            fg.b bVar = this.f18620c;
            if (bVar != null && !TextUtils.isEmpty(bVar.f9067b) && (i6Var = h6Var.f18722b) != null && i6Var.f18759b == null && !i6Var.q()) {
                h6.g(clone);
            }
    ...
    public final TLRPC.Document f() {
        ...
        if (chatTheme instanceof TLRPC.TL_chatTheme) {
            return MediaDataController.getInstance(this.f18622g).getEmojiAnimatedSticker(((TLRPC.TL_chatTheme) this.d).emoticon);
        }
        return null;
    }
    ...
    public final SparseIntArray h(int i10, int i11) {
        ...
        h6 h6Var2;
        ArrayList arrayList = this.f18621f;
        SparseIntArray sparseIntArray2 = ((d4) arrayList.get(i11)).f18578f;
        ...
        ((d4) arrayList.get(i11)).f18578f = sparseIntArray4;
        while (true) {
            try {
                int[] iArr = h;
                if (i13 < iArr.length) {
    ...
    public final long i(int i10) {
        return ((d4) this.f18621f.get(i10)).a();
    }

    public final i6 j(int i10) {
        return ((d4) this.f18621f.get(i10)).f18575a;
    }

    public final TLRPC.WallPaper k(int i10) {
        d4 d4Var = (d4) this.f18621f.get(i10);
        ...
        while (true) {
            ...
            if (i12 < arrayList.size()) {
                if (arrayList.get(i12) != null) {
                    ...
                    ((d4) arrayList.get(i12)).h = g(h10, j6.f19123ra);
                    ((d4) arrayList.get(i12)).f18580i = g(h10, j6.Aa);
                    ((d4) arrayList.get(i12)).f18581j = g(h10, j6.Oh);
                    ((d4) arrayList.get(i12)).f18582k = h10.get(j6.Nd, 0);
                    ((d4) arrayList.get(i12)).f18583l = h10.get(j6.Od, 0);
                    ((d4) arrayList.get(i12)).f18584m = h10.get(j6.Pd, 0);
                    ((d4) arrayList.get(i12)).f18585n = h10.get(j6.Qd, 0);
                    ((d4) arrayList.get(i12)).f18586o = h10.get(j6.Rd, 0);
                    if (((d4) arrayList.get(i12)).f18575a != null && ((d4) arrayList.get(i12)).f18575a.m().equals("Blue")) {
                        if (((d4) arrayList.get(i12)).e >= 0) {
                            i11 = ((d4) arrayList.get(i12)).e;
                        } else {
                            i11 = ((d4) arrayList.get(i12)).f18575a.Y;
                        }
                        if (i11 == 99) {
                            ((d4) arrayList.get(i12)).f18582k = -2368069;
                            ((d4) arrayList.get(i12)).f18583l = -9722489;
                            ((d4) arrayList.get(i12)).f18584m = -2762611;
                            ((d4) arrayList.get(i12)).f18585n = -7817084;
                        }
                    }
                }
                i12++;
    ...
    public final void p(int i10, ResultCallback resultCallback) {
        ...
        if (k10 == null) {
            ...
            if (i11 == 0) {
                ...
                Bitmap wallpaperThumbBitmap = ChatThemeController.getInstance(this.f18622g).getWallpaperThumbBitmap(i11);
    ...
    public e4(int i10, TLRPC.TL_theme tL_theme) {
        ...
        String str = tL_theme.emoticon;
        this.e = str;
        this.f18620c = new fg.b(str, null);
    ...
    public e4(int i10, TLRPC.TL_chatThemeUniqueGift tL_chatThemeUniqueGift) {
        ...
        this.f18620c = fg.b.c(tL_chatThemeUniqueGift);
        this.d = tL_chatThemeUniqueGift;
        d4 d4Var = new d4();
        d4Var.f18577c = tL_chatThemeUniqueGift;
        d4Var.d = 0;
        arrayList.add(d4Var);
        d4 d4Var2 = new d4();
        d4Var2.f18577c = tL_chatThemeUniqueGift;
        d4Var2.d = 1;
        arrayList.add(d4Var2);
    }
}
