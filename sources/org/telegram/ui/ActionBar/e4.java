...
public final class e4 {
    public static final int[] h = {j6.f19122ra, j6.Aa, j6.Oh, j6.Nd, j6.Od, j6.Pd, j6.Qd, j6.Rd};
    ...
    public static e4 a(int i10) {
        ...
        e4Var.f18618b = true;
        d4 d4Var = new d4();
        d4Var.f18574a = e(true);
        e4Var.f18620f.add(d4Var);
        d4 d4Var2 = new d4();
        d4Var2.f18574a = e(false);
    ...
    public static e4 c(int i10) {
        ...
        d4 d4Var = new d4();
        d4Var.f18574a = j6.N0("Blue");
        d4Var.e = 99;
        e4Var.f18620f.add(d4Var);
        d4 d4Var2 = new d4();
        d4Var2.f18574a = j6.N0("Day");
        d4Var2.e = 9;
        e4Var.f18620f.add(d4Var2);
        d4 d4Var3 = new d4();
        d4Var3.f18574a = j6.N0("Night");
        d4Var3.e = 0;
        e4Var.f18620f.add(d4Var3);
        d4 d4Var4 = new d4();
        d4Var4.f18574a = j6.N0("Dark Blue");
        d4Var4.e = 0;
        e4Var.f18620f.add(d4Var4);
        return e4Var;
    }
    ...
    public static void q(i6 i6Var, int i10) {
        ...
        h6 h6Var;
        if (i6Var != null) {
            if (i10 < 0 || (sparseArray = i6Var.f18757a0) == null || ((h6Var = (h6) sparseArray.get(i10)) != null && !h6Var.f18741z)) {
    ...
    public final SparseIntArray b(int i10, int i11) {
        ...
        if (j3 == null) {
            ...
            TLRPC.TL_theme tL_theme = ((d4) arrayList.get(i11)).f18575b;
            i6 i6Var2 = new i6(j6.N0(j6.q0(b10)));
            h6Var = i6Var2.e(d4Var.a(), b10, tL_theme, i10, true);
            i6Var2.u(h6Var.f18720a);
            j3 = i6Var2;
        } else {
            SparseArray sparseArray = j3.f18757a0;
            if (sparseArray != null) {
        ...
        if (j3.f18758b != null) {
            sparseIntArray = j6.Q0(new File(j3.f18758b), null, strArr);
        } else {
            String str = j3.d;
            if (str != null) {
        ...
        ((d4) arrayList.get(i11)).f18578g = strArr[0];
        if (h6Var != null) {
            SparseIntArray clone = sparseIntArray.clone();
            h6Var.c(sparseIntArray, clone);
            fg.b bVar = this.f18619c;
            if (bVar != null && !TextUtils.isEmpty(bVar.f9067b) && (i6Var = h6Var.f18721b) != null && i6Var.f18758b == null && !i6Var.q()) {
                h6.g(clone);
            }
    ...
    public final TLRPC.Document f() {
        ...
        if (chatTheme instanceof TLRPC.TL_chatTheme) {
            return MediaDataController.getInstance(this.f18621g).getEmojiAnimatedSticker(((TLRPC.TL_chatTheme) this.d).emoticon);
        }
        return null;
    }
    ...
    public final SparseIntArray h(int i10, int i11) {
        ...
        h6 h6Var2;
        ArrayList arrayList = this.f18620f;
        SparseIntArray sparseIntArray2 = ((d4) arrayList.get(i11)).f18577f;
        ...
        ((d4) arrayList.get(i11)).f18577f = sparseIntArray4;
        while (true) {
            try {
                int[] iArr = h;
                if (i13 < iArr.length) {
    ...
    public final long i(int i10) {
        return ((d4) this.f18620f.get(i10)).a();
    }

    public final i6 j(int i10) {
        return ((d4) this.f18620f.get(i10)).f18574a;
    }

    public final TLRPC.WallPaper k(int i10) {
        d4 d4Var = (d4) this.f18620f.get(i10);
        ...
        while (true) {
            ...
            if (i12 < arrayList.size()) {
                if (arrayList.get(i12) != null) {
                    ...
                    ((d4) arrayList.get(i12)).h = g(h10, j6.f19122ra);
                    ((d4) arrayList.get(i12)).f18579i = g(h10, j6.Aa);
                    ((d4) arrayList.get(i12)).f18580j = g(h10, j6.Oh);
                    ((d4) arrayList.get(i12)).f18581k = h10.get(j6.Nd, 0);
                    ((d4) arrayList.get(i12)).f18582l = h10.get(j6.Od, 0);
                    ((d4) arrayList.get(i12)).f18583m = h10.get(j6.Pd, 0);
                    ((d4) arrayList.get(i12)).f18584n = h10.get(j6.Qd, 0);
                    ((d4) arrayList.get(i12)).f18585o = h10.get(j6.Rd, 0);
                    if (((d4) arrayList.get(i12)).f18574a != null && ((d4) arrayList.get(i12)).f18574a.m().equals("Blue")) {
                        if (((d4) arrayList.get(i12)).e >= 0) {
                            i11 = ((d4) arrayList.get(i12)).e;
                        } else {
                            i11 = ((d4) arrayList.get(i12)).f18574a.Y;
                        }
                        if (i11 == 99) {
                            ((d4) arrayList.get(i12)).f18581k = -2368069;
                            ((d4) arrayList.get(i12)).f18582l = -9722489;
                            ((d4) arrayList.get(i12)).f18583m = -2762611;
                            ((d4) arrayList.get(i12)).f18584n = -7817084;
                        }
                    }
                }
                i12++;
    ...
    public final void p(int i10, ResultCallback resultCallback) {
        ...
        if (k10 == null) {
            ...
            if (i11 == 0) {
                ...
                Bitmap wallpaperThumbBitmap = ChatThemeController.getInstance(this.f18621g).getWallpaperThumbBitmap(i11);
    ...
    public e4(int i10, TLRPC.TL_theme tL_theme) {
        ...
        String str = tL_theme.emoticon;
        this.e = str;
        this.f18619c = new fg.b(str, null);
    ...
    public e4(int i10, TLRPC.TL_chatThemeUniqueGift tL_chatThemeUniqueGift) {
        ...
        this.f18619c = fg.b.c(tL_chatThemeUniqueGift);
        this.d = tL_chatThemeUniqueGift;
        d4 d4Var = new d4();
        d4Var.f18576c = tL_chatThemeUniqueGift;
        d4Var.d = 0;
        arrayList.add(d4Var);
        d4 d4Var2 = new d4();
        d4Var2.f18576c = tL_chatThemeUniqueGift;
        d4Var2.d = 1;
        arrayList.add(d4Var2);
    }
}
