...
public final class e4 {
    public static final int[] h = {j6.f20162ra, j6.Aa, j6.Oh, j6.Nd, j6.Od, j6.Pd, j6.Qd, j6.Rd};
    public boolean f19663a;
    public boolean f19664b;
    public sf.b f19665c;
    public TLRPC.ChatTheme d;
    public String e;
    public final ArrayList f19666f;
    ...
    public static e4 a(int i10) {
        ...
        e4Var.f19664b = true;
        d4 d4Var = new d4();
        d4Var.f19621a = e(true);
        e4Var.f19666f.add(d4Var);
        d4 d4Var2 = new d4();
        d4Var2.f19621a = e(false);
    ...
    public static e4 c(int i10) {
        ...
        d4 d4Var = new d4();
        d4Var.f19621a = j6.N0("Blue");
        d4Var.e = 99;
        e4Var.f19666f.add(d4Var);
        d4 d4Var2 = new d4();
        d4Var2.f19621a = j6.N0("Day");
        d4Var2.e = 9;
        e4Var.f19666f.add(d4Var2);
        d4 d4Var3 = new d4();
        d4Var3.f19621a = j6.N0("Night");
        d4Var3.e = 0;
        e4Var.f19666f.add(d4Var3);
        d4 d4Var4 = new d4();
        d4Var4.f19621a = j6.N0("Dark Blue");
        d4Var4.e = 0;
        e4Var.f19666f.add(d4Var4);
        return e4Var;
    }
    ...
    public static void q(i6 i6Var, int i10) {
        ...
        h6 h6Var;
        if (i6Var != null) {
            if (i10 < 0 || (sparseArray = i6Var.X) == null || ((h6Var = (h6) sparseArray.get(i10)) != null && !h6Var.f19782z)) {
    ...
    public final SparseIntArray b(int i10, int i11) {
        ...
        if (j10.f19807b != null) {
            sparseIntArray = j6.Q0(new File(j10.f19807b), null, strArr);
        } else {
            String str = j10.d;
            if (str != null) {
        ...
        ((d4) arrayList.get(i11)).f19625g = strArr[0];
        if (h6Var != null) {
            SparseIntArray clone = sparseIntArray.clone();
            h6Var.c(sparseIntArray, clone);
            sf.b bVar = this.f19665c;
            if (bVar != null && !TextUtils.isEmpty(bVar.f44303b) && (i6Var = h6Var.f19762b) != null && i6Var.f19807b == null && !i6Var.q()) {
                h6.g(clone);
            }
    ...
    public final TLRPC.Document f() {
        ...
        if (chatTheme instanceof TLRPC.TL_chatTheme) {
            return MediaDataController.getInstance(this.f19667g).getEmojiAnimatedSticker(((TLRPC.TL_chatTheme) this.d).emoticon);
        }
        return null;
    }
    ...
    public final SparseIntArray h(int i10, int i11) {
        ...
        h6 h6Var2;
        ArrayList arrayList = this.f19666f;
        SparseIntArray sparseIntArray2 = ((d4) arrayList.get(i11)).f19624f;
        ...
        ((d4) arrayList.get(i11)).f19624f = sparseIntArray4;
        while (true) {
            try {
                int[] iArr = h;
                if (i13 < iArr.length) {
    ...
    public final long i(int i10) {
        return ((d4) this.f19666f.get(i10)).a();
    }

    public final i6 j(int i10) {
        return ((d4) this.f19666f.get(i10)).f19621a;
    }

    public final TLRPC.WallPaper k(int i10) {
        d4 d4Var = (d4) this.f19666f.get(i10);
        ...
        while (true) {
            ...
            if (i12 < arrayList.size()) {
                if (arrayList.get(i12) != null) {
                    ...
                    ((d4) arrayList.get(i12)).h = g(h9, j6.f20162ra);
                    ((d4) arrayList.get(i12)).f19626i = g(h9, j6.Aa);
                    ((d4) arrayList.get(i12)).f19627j = g(h9, j6.Oh);
                    ((d4) arrayList.get(i12)).f19628k = h9.get(j6.Nd, 0);
                    ((d4) arrayList.get(i12)).f19629l = h9.get(j6.Od, 0);
                    ((d4) arrayList.get(i12)).f19630m = h9.get(j6.Pd, 0);
                    ((d4) arrayList.get(i12)).f19631n = h9.get(j6.Qd, 0);
                    ((d4) arrayList.get(i12)).f19632o = h9.get(j6.Rd, 0);
                    if (((d4) arrayList.get(i12)).f19621a != null && ((d4) arrayList.get(i12)).f19621a.m().equals("Blue")) {
                        if (((d4) arrayList.get(i12)).e >= 0) {
                            i11 = ((d4) arrayList.get(i12)).e;
                        } else {
                            i11 = ((d4) arrayList.get(i12)).f19621a.V;
                        }
                        if (i11 == 99) {
                            ((d4) arrayList.get(i12)).f19628k = -2368069;
                            ((d4) arrayList.get(i12)).f19629l = -9722489;
                            ((d4) arrayList.get(i12)).f19630m = -2762611;
                            ((d4) arrayList.get(i12)).f19631n = -7817084;
                        }
                    }
                }
                i12++;
    ...
    public final void p(int i10, ResultCallback resultCallback) {
        ...
        if (k10 == null) {
            ...
            if (i11 == 0) {
                ...
                Bitmap wallpaperThumbBitmap = ChatThemeController.getInstance(this.f19667g).getWallpaperThumbBitmap(i11);
    ...
    public e4(int i10, TLRPC.TL_theme tL_theme) {
        ...
        String str = tL_theme.emoticon;
        this.e = str;
        this.f19665c = new sf.b(str, null);
    ...
    public e4(int i10, TLRPC.TL_chatThemeUniqueGift tL_chatThemeUniqueGift) {
        ...
        this.f19665c = sf.b.c(tL_chatThemeUniqueGift);
        this.d = tL_chatThemeUniqueGift;
        d4 d4Var = new d4();
        d4Var.f19623c = tL_chatThemeUniqueGift;
        d4Var.d = 0;
        arrayList.add(d4Var);
        d4 d4Var2 = new d4();
        d4Var2.f19623c = tL_chatThemeUniqueGift;
        d4Var2.d = 1;
        arrayList.add(d4Var2);
    }
}
