...
public final class y1 extends FrameLayout {
    ...
    public y1(Context context, f6 f6Var) {
        ...
        wl.n(j6.f18970j5, f6Var, textView, 1, 16.0f);
    ...
    public final void a(int i10, CharSequence charSequence) {
        ...
        ImageView imageView = this.f19701b;
        if (i10 != 0) {
    ...
    public void setGravity(int i10) {
        this.f19700a.setGravity(i10);
    }

    public void setTextColor(int i10) {
        this.f19700a.setTextColor(i10);
    }
}
