...
public final class k3 extends j1.b {
    public static final int f19584r = 0;
    public final RectF f19585o;
    public final Rect f19586p;
    public final m3 f19587q;

    public k3(m3 m3Var, m3 m3Var2) {
        super(m3Var2);
        this.f19587q = m3Var;
        this.f19585o = new RectF();
        this.f19586p = new Rect();
    }

    @Override
    public final int g(float f7, float f10) {
        j3 c10;
        m3 m3Var = this.f19587q;
        if (m3Var.f19641b) {
            ArrayList<l3> tabs = m3Var.getTabs();
            if (!tabs.isEmpty() && (c10 = m3Var.c(tabs.get(0))) != null) {
                float c11 = c10.c();
                RectF rectF = this.f19585o;
                m3Var.d(rectF, c11);
                Rect bounds = c10.f19495k.getBounds();
    ...
    public final void l(int i10, s0.d dVar) {
        ...
        if (i10 == 2) {
            Rect bounds = j3Var.f19495k.getBounds();
