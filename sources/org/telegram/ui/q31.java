...
public final class q31 extends org.telegram.ui.ActionBar.h3 {
    ...
    public static void G(q31 q31Var, CharSequence charSequence, byte[] bArr, String str) {
        ...
        if (q31Var.d) {
            ...
            if (q31Var.f40312e) {
                ...
                if (arrayList != null) {
                    tL_stories_report.f21094id.addAll(arrayList);
                }
                if (str != null) {
                    str2 = str;
                }
                ...
                if (arrayList != null && !arrayList.isEmpty()) {
                    tL_reportMessage.f21062id = ((Integer) arrayList.get(0)).intValue();
                }
                if (str != null) {
                    str2 = str;
                }
                ...
                if (arrayList != null) {
                    tL_messages_report2.f20949id.addAll(arrayList);
                }
                if (str != null) {
                    str2 = str;
                }
    ...
    public static void J(int i10, final Context context, final long j10, final boolean z4, final boolean z10, final ArrayList arrayList, final org.telegram.ui.Components.qc qcVar, final org.telegram.ui.ActionBar.g6 g6Var, byte[] bArr, String str, final Utilities.Callback callback) {
        ...
        if (context != null) {
            ...
            if (z4) {
                ...
                tL_messages_report3.f20949id.addAll(arrayList);
    ...
    public static void m(Context context, org.telegram.ui.ActionBar.g6 g6Var, boolean z4, boolean z10, long j10, ArrayList arrayList, boolean[] zArr, Utilities.Callback callback, org.telegram.ui.Components.qc qcVar, TLRPC.ReportResult reportResult) {
        ...
        q31Var.f40316s = new h31(zArr, callback, qcVar);
    ...
    public static void n(q31 q31Var, TLObject tLObject, CharSequence charSequence, TLRPC.TL_error tL_error, byte[] bArr, String str) {
        ...
        m31 m31Var2;
        qh.d dVar;
        ek ekVar = q31Var.f40310b;
        if ((ekVar.getCurrentView() instanceof p31) && (dVar = ((p31) ekVar.getCurrentView()).f39879s) != null) {
        ...
        if (tLObject != null) {
            ...
            if (!z4 && !(tLObject instanceof TLRPC.TL_reportResultChooseOption) && !(tLObject instanceof TLRPC.TL_reportResultAddComment)) {
                if (tLObject instanceof TLRPC.TL_channels_sponsoredMessageReportResultAdsHidden) {
                    ...
                    return;
                } else if (((tLObject instanceof TLRPC.TL_channels_sponsoredMessageReportResultReported) || (tLObject instanceof TLRPC.TL_reportResultReported)) && (m31Var2 = q31Var.f40316s) != null) {
                    m31Var2.a();
                    q31Var.dismiss();
                    return;
                } else {
            ...
            if (p31Var != null) {
                ...
                if (tLObject instanceof TLRPC.TL_reportResultChooseOption) {
                    p31Var.f39873b = null;
                    p31Var.f39874c = (TLRPC.TL_reportResultChooseOption) tLObject;
                    p31Var.d = null;
                    h61Var.V2.N(false);
                } else if (tLObject instanceof TLRPC.TL_reportResultAddComment) {
                    p31Var.b((TLRPC.TL_reportResultAddComment) tLObject);
                } else if (z4) {
                    p31Var.f39873b = (TLRPC.TL_channels_sponsoredMessageReportResultChooseOption) tLObject;
                    p31Var.f39874c = null;
                    p31Var.d = null;
                    h61Var.V2.N(false);
                }
            ...
            if (!q31Var.d && "MESSAGE_ID_REQUIRED".equals(tL_error.text)) {
                ...
                m31 m31Var4 = q31Var.f40316s;
                if (m31Var4 != null) {
                    m31Var4.c();
                }
            } else if ("AD_EXPIRED".equals(tL_error.text) && (m31Var = q31Var.f40316s) != null) {
                m31Var.a();
            }
            q31Var.dismiss();
        }
    ...
    public final void O(TLRPC.TL_channels_sponsoredMessageReportResultChooseOption tL_channels_sponsoredMessageReportResultChooseOption) {
        View[] viewPages = this.f40310b.getViewPages();
        View view = viewPages[0];
        if (view instanceof p31) {
            ((p31) view).a(0);
    ...
    public final boolean canDismissWithSwipe() {
        View currentView = this.f40310b.getCurrentView();
        if (!(currentView instanceof p31)) {
            return true;
        }
        return !((p31) currentView).f39876f.canScrollVertically(-1);
    }

    @Override
    public final void onBackPressed() {
        o31 o31Var;
        ek ekVar = this.f40310b;
        if ((ekVar.getCurrentView() instanceof p31) && (o31Var = ((p31) ekVar.getCurrentView()).f39877n) != null) {
