...
public final class xu0 extends org.telegram.ui.Components.rv0 {
    ...
    public final void Z() {
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            this.D0.clear();
            PhotoViewer photoViewer = this.E0;
            if (photoViewer.f31094u4 == 1 || photoViewer.f31042o6 == 1) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        PhotoViewer photoViewer = this.E0;
        photoViewer.Q.o(photoViewer.f30967g0.getContext()).draw(canvas);
    }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        org.telegram.ui.Cells.da daVar = o9.f19900r;
        if (motionEvent.getAction() == 0) {
            o9.h = motionEvent.getX();
            o9.f19899n = motionEvent.getY();
            daVar.e = daVar.y();
        } else if (daVar.e && Math.abs(motionEvent.getX() - o9.h) < AndroidUtilities.touchSlop && Math.abs(motionEvent.getY() - o9.f19899n) < AndroidUtilities.touchSlop && (motionEvent.getAction() == 3 || motionEvent.getAction() == 1)) {
            motionEvent.getX();
            motionEvent.getY();
            org.telegram.ui.Cells.da daVar2 = o9.f19900r;
            if (!daVar2.f19962i && daVar2.e) {
                daVar2.f(false);
            }
        }
        if (photoViewer.Q.y()) {
    ...
    public final void draw(Canvas canvas) {
        ...
        if (ku0Var != null && ku0Var.f27286x) {
            int measuredHeight = ((int) ((photoViewer.f30918a6 - 1.0f) * ku0Var.getWebView().getMeasuredHeight())) / 2;
            org.telegram.ui.Components.x61 x61Var = photoViewer.f31138z1;
            if (x61Var != null && x61Var.f29868j) {
                x61Var.setBounds(photoViewer.f30959f0.getLeft(), (photoViewer.f30959f0.getWebView().getTop() - measuredHeight) + ((int) (photoViewer.Y5 / photoViewer.f30918a6)), photoViewer.f30959f0.getRight(), photoViewer.f30959f0.getWebView().getBottom() + measuredHeight + ((int) (photoViewer.Y5 / photoViewer.f30918a6)));
                photoViewer.f31138z1.draw(canvas);
            }
            org.telegram.ui.Components.lo0 lo0Var = photoViewer.A1;
            if (lo0Var != null && lo0Var.a()) {
                photoViewer.A1.setBounds(photoViewer.f30959f0.getLeft(), (int) ((photoViewer.F.getAlpha() * AndroidUtilities.dp(90.0f)) + AndroidUtilities.statusBarHeight), photoViewer.f30959f0.getRight(), photoViewer.f30959f0.getWebView().getBottom() + measuredHeight + ((int) (photoViewer.Y5 / photoViewer.f30918a6)));
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        PhotoViewer photoViewer = this.E0;
        if (view != photoViewer.Q.o(photoViewer.f30967g0.getContext()) && view != photoViewer.f31077s5 && view != photoViewer.f31141z4 && view != photoViewer.A4 && view != photoViewer.X0) {
            ...
            try {
                if (view != photoViewer.f31131y2 && view != photoViewer.f31132y4) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (photoViewer.f30985i0.getVisibility() != 8) {
        ...
        mv0 mv0Var = photoViewer.f30988i3;
        if (mv0Var != null) {
            mv0Var.e = size;
            mv0Var.f35893f = i17;
        }
        ...
        while (i18 < childCount) {
            ...
            if (childAt.getVisibility() != 8 && childAt != photoViewer.l1) {
                ...
                if (childAt == ut0Var) {
                ...
                } else if (childAt == photoViewer.f31132y4) {
                    ...
                    photoViewer.f31132y4.measure(View.MeasureSpec.makeMeasureSpec(bitmapWidth, 1073741824), View.MeasureSpec.makeMeasureSpec(bitmapHeight, 1073741824));
                } else if (!photoViewer.U1.f4995f.l(childAt) && !photoViewer.V1.f4995f.l(childAt)) {
                    if (childAt == photoViewer.T1) {
                        if (photoViewer.f31019m2) {
                            if (xu0Var.C0) {
                                i15 = i12 + i14;
