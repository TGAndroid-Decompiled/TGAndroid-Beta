...
public final class py extends org.telegram.ui.Components.qv0 {
    ...
    public final void L(Canvas canvas, ArrayList arrayList) {
        ...
        wy wyVar = this.E0;
        if (wyVar.f39277p3 && (gyVar = wyVar.C0) != null && gyVar.getVisibility() == 0) {
            gy gyVar2 = wyVar.C0;
    ...
    public final int a0() {
        ...
        if (wyVar.K) {
            height = com.google.android.gms.internal.vision.e2.z(1.0f, wyVar.f39299t3, (1.0f - f7) * (1.0f - wyVar.f39318x1) * AndroidUtilities.dp(81.0f), height);
        }
        return (int) com.google.android.gms.internal.vision.e2.z(1.0f, f7, (1.0f - wyVar.f39318x1) * (1.0f - wyVar.f39299t3) * AndroidUtilities.dp(48.0f), height + wyVar.T);
    }
    ...
    public final int b0() {
        ...
        return (int) com.google.android.gms.internal.vision.e2.z(1.0f, wyVar.f39318x1, org.telegram.messenger.w1.A(1.0f, f7, 1.0f - wyVar.f39299t3, f10), -getY());
    }
    ...
    public final boolean c0(MotionEvent motionEvent, boolean z10) {
        ...
        SparseIntArray sparseIntArray = uwVar.f25492j0;
        int i11 = uwVar.K;
        if (z10) {
            i10 = 1;
        } else {
        ...
        wyVar.f39261m3 = false;
        wyVar.f39258l3 = true;
        this.f36757y0 = (int) (motionEvent.getX() + wyVar.f39245i3);
        kVar = ((org.telegram.ui.ActionBar.o2) wyVar).actionBar;
        kVar.setEnabled(false);
        wyVar.f39325z0.setEnabled(false);
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (org.telegram.ui.Components.qv0.f27413v0) {
            return super.drawChild(canvas, view, j3);
        }
        vy[] vyVarArr = wyVar.f39221e0;
        int i10 = 0;
        if (view != vyVarArr[0] && ((vyVarArr.length <= 1 || view != vyVarArr[1]) && view != wyVar.J1 && view != wyVar.f39325z0)) {
            kVar = ((org.telegram.ui.ActionBar.o2) wyVar).actionBar;
            if (view == kVar && wyVar.W3 != 1.0f) {
                ...
                if (wyVar.X3) {
                    ...
                    float b10 = com.google.android.gms.internal.vision.e2.b(1.0f, wyVar.W3, 0.05f, 1.0f);
        ...
        canvas.save();
        if (view != wyVar.J1 && view != wyVar.f39325z0) {
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (Z() || (((uwVar = wyVar.f39325z0) != null && uwVar.O) || onTouchEvent(motionEvent))) {
            return true;
        }
        return false;
    }
                ...
                if (childAt != kVar2) {
                    if (childAt instanceof dv) {
                        ...
                        if (childAt == gyVar) {
                            ...
                            wyVar.C0.f30564q0.setKeyboardHeight(R);
    ...
    public final void requestDisallowInterceptTouchEvent(boolean z10) {
        wy wyVar = this.E0;
        if (wyVar.f39261m3 && !wyVar.f39258l3) {
            onTouchEvent(null);
        }
