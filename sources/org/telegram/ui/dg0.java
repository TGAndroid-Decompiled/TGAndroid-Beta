...
public final class dg0 extends AnimatorListenerAdapter {
    ...
    public void onAnimationStart(Animator animator) {
        switch (this.f33099a) {
            case 0:
                eg0 eg0Var = this.f33100b;
                eg0Var.f33371c.setVisibility(8);
                int measuredWidth = (int) (eg0Var.f33370b.getMeasuredWidth() / 10.0f);
                int measuredHeight = (int) (eg0Var.f33370b.getMeasuredHeight() / 10.0f);
