...
public class PasskeysActivity extends org.telegram.ui.ActionBar.n2 {
    public org.telegram.ui.Components.e61 f30894a;
    public int addPasskeyRow;
    public final ArrayList f30895b;

    public PasskeysActivity(ArrayList arrayList) {
        super(null);
        this.f30895b = arrayList;
    }
    ...
    public static void V(PasskeysActivity passkeysActivity, TL_account.Passkey passkey, String str, int i10) {
        passkeysActivity.f30895b.remove(passkey);
        passkeysActivity.f30894a.Y2.N(true);
        TL_account.deletePasskey deletepasskey = new TL_account.deletePasskey();
        deletepasskey.f18317id = str;
    ...
    public static void X(PasskeysActivity passkeysActivity) {
        ...
        boolean z10 = true;
        if (passkeysActivity.f30895b.size() + 1 > passkeysActivity.getMessagesController().config.passkeysAccountPasskeysMax.get()) {
            z10 = false;
        }
    ...
    public final void Y(TL_account.Passkey passkey) {
        ...
        this.f30895b.add(passkey);
        org.telegram.ui.Components.e61 e61Var = this.f30894a;
    ...
    public final void Z(View view) {
        ...
        String str = vl0Var.f38649r;
        int i11 = 0;
        while (true) {
            arrayList = this.f30895b;
            if (i11 < arrayList.size()) {
                if (str.equals(((TL_account.Passkey) arrayList.get(i11)).f18316id)) {
                    i10 = i11;
                    break;
                }
                i11++;
        ...
        if (i10 >= 0 && i10 < arrayList.size()) {
            ...
            H.W(this.f30894a.V0(vl0Var, false));
            H.Z();
        }
    }
    ...
    public final View createView(Context context) {
        ...
        this.f30894a = e61Var;
        e61Var.p1();
        org.telegram.ui.Components.e61 e61Var2 = this.f30894a;
        e61Var2.Y2.f29613r = false;
        frameLayout.addView(e61Var2, w7.x5.c(-1.0f, -1));
        this.actionBar.setAdaptiveBackground(this.f30894a);
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f30894a.setPadding(0, 0, 0, i13);
        this.f30894a.setClipToPadding(false);
    }
}
