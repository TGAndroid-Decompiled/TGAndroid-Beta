...
public class PasskeysActivity extends org.telegram.ui.ActionBar.p2 {
    public org.telegram.ui.Components.i61 f34217a;
    ...
    public final void Y(TL_account.Passkey passkey) {
        ...
        org.telegram.ui.Components.i61 i61Var = this.f34217a;
    ...
    public final void Z(View view) {
        ...
        String str = nl0Var.f39479r;
        int i11 = 0;
        while (true) {
            arrayList = this.f34218b;
            if (i11 < arrayList.size()) {
                if (str.equals(((TL_account.Passkey) arrayList.get(i11)).f21048id)) {
                    i10 = i11;
                    break;
                }
                i11++;
        ...
        if (i10 >= 0 && i10 < arrayList.size()) {
            ...
            H.W(this.f34217a.V0(nl0Var, false));
            H.Z();
        }
    }
    ...
    public final View createView(Context context) {
        ...
        this.f34217a = i61Var;
        i61Var.p1();
        org.telegram.ui.Components.i61 i61Var2 = this.f34217a;
