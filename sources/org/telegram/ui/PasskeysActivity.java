...
public class PasskeysActivity extends org.telegram.ui.ActionBar.o2 {
    public org.telegram.ui.Components.f61 f30911a;
    public int addPasskeyRow;
    public final ArrayList f30912b;
    ...
    public static void V(PasskeysActivity passkeysActivity, TL_account.Passkey passkey, String str, int i10) {
        passkeysActivity.f30912b.remove(passkey);
        passkeysActivity.f30911a.Y2.N(true);
        TL_account.deletePasskey deletepasskey = new TL_account.deletePasskey();
        deletepasskey.f18325id = str;
    ...
    public static void X(PasskeysActivity passkeysActivity) {
        ...
        boolean z10 = true;
        if (passkeysActivity.f30912b.size() + 1 > passkeysActivity.getMessagesController().config.passkeysAccountPasskeysMax.get()) {
            z10 = false;
        }
    ...
    public final void Y(TL_account.Passkey passkey) {
        ...
        this.f30912b.add(passkey);
        org.telegram.ui.Components.f61 f61Var = this.f30911a;
    ...
    public final void Z(View view) {
        ...
        String str = xl0Var.f39672r;
        int i11 = 0;
        while (true) {
            arrayList = this.f30912b;
            if (i11 < arrayList.size()) {
                if (str.equals(((TL_account.Passkey) arrayList.get(i11)).f18324id)) {
                    i10 = i11;
                    break;
                }
                i11++;
        ...
        if (i10 >= 0 && i10 < arrayList.size()) {
            ...
            H.W(this.f30911a.W0(xl0Var, false));
            H.Z();
        }
    }
    ...
    public final View createView(Context context) {
        ...
        this.f30911a = f61Var;
        f61Var.q1();
        org.telegram.ui.Components.f61 f61Var2 = this.f30911a;
        f61Var2.Y2.f29854r = false;
        frameLayout.addView(f61Var2, w7.x5.c(-1.0f, -1));
        this.actionBar.setAdaptiveBackground(this.f30911a);
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f30911a.setPadding(0, 0, 0, i13);
        this.f30911a.setClipToPadding(false);
    }
}
