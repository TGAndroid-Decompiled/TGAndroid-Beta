...
public class PasskeysActivity extends org.telegram.ui.ActionBar.n2 {
    public org.telegram.ui.Components.d61 f33507a;
    public int addPasskeyRow;
    public final ArrayList f33508b;

    public PasskeysActivity(ArrayList arrayList) {
        super(null);
        this.f33508b = arrayList;
    }
        ...
        if (str != null) {
            if (!"CANCELLED".equalsIgnoreCase(str)) {
                if ("EMPTY".equalsIgnoreCase(str)) {
                    ...
                    alertDialog$Builder.f20199a.R = LocaleController.getString(R.string.PasskeyNoOptionsTitle);
                    alertDialog$Builder.f20199a.T = LocaleController.getString(R.string.PasskeyNoOptionsText);
    ...
    public static void V(PasskeysActivity passkeysActivity, TL_account.Passkey passkey, String str, int i10) {
        passkeysActivity.f33508b.remove(passkey);
        passkeysActivity.f33507a.Y2.N(true);
        TL_account.deletePasskey deletepasskey = new TL_account.deletePasskey();
        deletepasskey.f20075id = str;
    ...
    public static void X(PasskeysActivity passkeysActivity) {
        ...
        boolean z10 = true;
        if (passkeysActivity.f33508b.size() + 1 > passkeysActivity.getMessagesController().config.passkeysAccountPasskeysMax.get()) {
            z10 = false;
        }
    ...
    public final void Y(TL_account.Passkey passkey) {
        ...
        this.f33508b.add(passkey);
        org.telegram.ui.Components.d61 d61Var = this.f33507a;
    ...
    public final void Z(View view) {
        ...
        String str = xl0Var.f42760r;
        int i11 = 0;
        while (true) {
            arrayList = this.f33508b;
            if (i11 < arrayList.size()) {
                if (str.equals(((TL_account.Passkey) arrayList.get(i11)).f20074id)) {
                    i10 = i11;
                    break;
                }
                i11++;
        ...
        if (i10 >= 0 && i10 < arrayList.size()) {
            ...
            H.W(this.f33507a.U0(xl0Var, false));
            H.Z();
        }
    }
    ...
    public final View createView(Context context) {
        ...
        this.f33507a = d61Var;
        d61Var.o1();
        org.telegram.ui.Components.d61 d61Var2 = this.f33507a;
        d61Var2.Y2.f31136r = false;
        frameLayout.addView(d61Var2, w7.x5.c(-1.0f, -1));
        this.actionBar.setAdaptiveBackground(this.f33507a);
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f33507a.setPadding(0, 0, 0, i13);
        this.f33507a.setClipToPadding(false);
    }
}
