...
public final class d2 extends FrameLayout implements DownloadController.FileDownloadProgressListener, org.telegram.ui.Cells.p9 {
    ...
    public Drawable S;
    public boolean T;
    public final v70 f35640a;
    public final g4 f35641b;
    public b3 f35642c;
    public b3 d;
    public final ImageReceiver f35643e;
    public final RadialProgress2 f35644f;
    public final d1 h;
    public final int f35645n;
    ...
    public d2(Context context, v70 v70Var, g4 g4Var, int i10) {
        ...
        this.f35643e = new ImageReceiver(this);
        d1 d1Var = new d1(context, v70Var, g4Var, 1);
        this.h = d1Var;
        RadialProgress2 radialProgress2 = new RadialProgress2(this, null);
        this.f35644f = radialProgress2;
        radialProgress2.d = -1;
    ...
    public final void b(boolean z10) {
        ...
        RadialProgress2 radialProgress2 = this.f35644f;
        if (isEmpty) {
    ...
    public final void onAttachedToWindow() {
        ...
        this.f35643e.onAttachedToWindow();
        b(false);
        b3 b3Var = this.f35642c;
        if (b3Var != null) {
            b3Var.attach(this);
    ...
    public final void onDetachedFromWindow() {
        ...
        this.f35643e.onDetachedFromWindow();
        DownloadController.getInstance(((i4) this.f35640a).X).removeLoadingFileObserver(this);
        b3 b3Var = this.f35642c;
        if (b3Var != null) {
            b3Var.detach(this);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        ImageReceiver imageReceiver = this.f35643e;
        if (imageReceiver.hasBitmapImage() && imageReceiver.getCurrentAlpha() == 1.0f) {
            canvas2 = canvas;
        } else {
            canvas2 = canvas;
            canvas2.drawRect(imageReceiver.getImageX(), imageReceiver.getImageY(), imageReceiver.getImageX2(), imageReceiver.getImageY2(), i4.f37228o1);
        }
        imageReceiver.draw(canvas2);
        if (imageReceiver.getVisible()) {
            this.f35644f.draw(canvas2);
        }
        ...
        b3 b3Var = this.f35642c;
        v70 v70Var = this.f35640a;
        int i10 = 0;
        if (b3Var != null) {
            canvas2.save();
            canvas2.translate(this.f35647s, this.v);
            i4.v(v70Var, canvas2, this, 0);
            this.f35642c.draw(canvas2, this);
            canvas2.restore();
            i10 = 1;
        }
        if (this.d != null) {
            canvas2.save();
            canvas2.translate(this.f35647s, this.v + this.f35648w);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f35642c != null) {
            sb2.append(", ");
            sb2.append(this.f35642c.d.getText());
        }
    ...
    public final void onProgressDownload(String str, long j3, long j10) {
        this.f35644f.o(Math.min(1.0f, ((float) j3) / ((float) j10)), true);
        if (this.F != 1) {
            b(true);
        }
    }
