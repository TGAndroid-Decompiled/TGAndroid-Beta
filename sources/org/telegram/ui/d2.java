...
public final class d2 extends FrameLayout implements DownloadController.FileDownloadProgressListener, org.telegram.ui.Cells.p9 {
    ...
    public Drawable S;
    public boolean T;
    public final v70 f35613a;
    public final g4 f35614b;
    public b3 f35615c;
    public b3 d;
    public final ImageReceiver f35616e;
    public final RadialProgress2 f35617f;
    public final d1 h;
    ...
    public d2(Context context, v70 v70Var, g4 g4Var, int i10) {
        ...
        this.f35616e = new ImageReceiver(this);
        d1 d1Var = new d1(context, v70Var, g4Var, 1);
        this.h = d1Var;
        RadialProgress2 radialProgress2 = new RadialProgress2(this, null);
        this.f35617f = radialProgress2;
        radialProgress2.d = -1;
    ...
    public final void b(boolean z10) {
        ...
        RadialProgress2 radialProgress2 = this.f35617f;
        if (isEmpty) {
    ...
    public final void onAttachedToWindow() {
        ...
        this.f35616e.onAttachedToWindow();
        b(false);
        b3 b3Var = this.f35615c;
        if (b3Var != null) {
            b3Var.attach(this);
    ...
    public final void onDetachedFromWindow() {
        ...
        this.f35616e.onDetachedFromWindow();
        DownloadController.getInstance(((i4) this.f35613a).X).removeLoadingFileObserver(this);
        b3 b3Var = this.f35615c;
        if (b3Var != null) {
            b3Var.detach(this);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        ImageReceiver imageReceiver = this.f35616e;
        if (imageReceiver.hasBitmapImage() && imageReceiver.getCurrentAlpha() == 1.0f) {
            canvas2 = canvas;
        } else {
            canvas2 = canvas;
            canvas2.drawRect(imageReceiver.getImageX(), imageReceiver.getImageY(), imageReceiver.getImageX2(), imageReceiver.getImageY2(), i4.f37201o1);
        }
        imageReceiver.draw(canvas2);
        if (imageReceiver.getVisible()) {
            this.f35617f.draw(canvas2);
        }
        ...
        b3 b3Var = this.f35615c;
        v70 v70Var = this.f35613a;
        int i10 = 0;
        if (b3Var != null) {
            canvas2.save();
            canvas2.translate(this.f35620s, this.v);
            i4.v(v70Var, canvas2, this, 0);
            this.f35615c.draw(canvas2, this);
            canvas2.restore();
            i10 = 1;
        }
        if (this.d != null) {
            canvas2.save();
            canvas2.translate(this.f35620s, this.v + this.f35621w);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f35615c != null) {
            sb2.append(", ");
            sb2.append(this.f35615c.d.getText());
        }
    ...
    public final void onProgressDownload(String str, long j3, long j10) {
        this.f35617f.o(Math.min(1.0f, ((float) j3) / ((float) j10)), true);
        if (this.F != 1) {
            b(true);
        }
    }
