...
public final class z11 extends FrameLayout {
    public final TextView f39935a;
    public final TextView f39936b;
    public final ImageView f39937c;
    public SharedConfig.ProxyInfo d;
    public Drawable e;
    public final org.telegram.ui.Components.op f39938f;
    public boolean h;
    public boolean f39939n;
    public int f39940r;
    public final ProxyListActivity f39941s;
    ...
    public z11(ProxyListActivity proxyListActivity, Context context) {
        ...
        int i16;
        int i17;
        this.f39941s = proxyListActivity;
        TextView textView = new TextView(context);
        this.f39935a = textView;
        ...
        this.f39938f = opVar;
        opVar.b(org.telegram.ui.ActionBar.h6.f18879i7, org.telegram.ui.ActionBar.h6.f18844g7, org.telegram.ui.ActionBar.h6.f18917k7);
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        if (!z11) {
            ...
            this.f39935a.setTranslationX(f10);
            this.f39936b.setTranslationX(f10);
            ImageView imageView = this.f39937c;
            ...
            float f12 = dp2 + f10;
            org.telegram.ui.Components.op opVar = this.f39938f;
    ...
    public final void b() {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.z11.b():void");
    }
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), org.telegram.messenger.ul.C(64.0f, 1, 1073741824));
    }

    public void setChecked(boolean z10) {
        TextView textView = this.f39936b;
        if (z10) {
            if (this.e == null) {
            ...
            if (drawable != null) {
                drawable.setColorFilter(new PorterDuffColorFilter(this.f39940r, PorterDuff.Mode.MULTIPLY));
            }
            if (LocaleController.isRTL) {
    ...
    public void setProxy(SharedConfig.ProxyInfo proxyInfo) {
        String str;
        if (proxyInfo.settings.f15220a == 3) {
            str = a4.a.t(new StringBuilder(), proxyInfo.settings.f15221b, " (WEB)");
        } else {
            str = proxyInfo.settings.f15221b + ":" + proxyInfo.settings.f15222c;
        }
        this.f39935a.setText(str);
        this.d = proxyInfo;
    }

    public void setValue(CharSequence charSequence) {
        this.f39936b.setText(charSequence);
    }
}
