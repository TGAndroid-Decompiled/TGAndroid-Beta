...
public abstract class a10 extends FrameLayout {
    public final org.telegram.ui.ActionBar.o2 f31664a;
    public final int f31665b;
    public final int f31666c;
    public final Drawable d;
    public final Drawable e;
    public final org.telegram.ui.Components.n6 f31667f;
    public final org.telegram.ui.Components.n6 h;
    public final Paint f31668n;
    public final Paint f31669r;
    public float f31670s;
    public boolean v;
    public ValueAnimator f31671w;
    public String f31672x;
    public TL_chatlists.TL_exportedChatlistInvite f31673y;
    ...
    public a10(Context context, org.telegram.ui.ActionBar.o2 o2Var, int i10, int i11) {
        ...
        n6Var2.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19263z6, false));
        if (LocaleController.isRTL) {
            i13 = 5;
        } else {
            i13 = 3;
    ...
    public final void a() {
        ...
        tL_inputChatlistDialogFilter.filter_id = this.f31666c;
        tL_chatlists_deleteExportedInvite.slug = substring;
        z00 z00Var = new z00(this, 2);
        ConnectionsManager.getInstance(this.f31665b).sendRequest(tL_chatlists_deleteExportedInvite, new qo(21, this, z00Var));
    ...
    public void c() {
        org.telegram.ui.ActionBar.o2 o2Var = this.f31664a;
        if (!(o2Var instanceof h10)) {
            return;
        }
        ai.w0 w0Var = ((h10) o2Var).f34086a;
    ...
    public final void d() {
        if (this.f31672x == null) {
            return;
        }
        org.telegram.ui.Components.ki0 ki0Var = new org.telegram.ui.Components.ki0(getContext(), LocaleController.getString(R.string.InviteByQRCode), this.f31672x, LocaleController.getString(R.string.QRCodeLinkHelpFolder), false);
    ...
    public final void e(TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite, boolean z10) {
        boolean z11;
        if (this.f31673y == tL_exportedChatlistInvite) {
            z11 = true;
        } else {
            z11 = false;
        }
        this.f31673y = tL_exportedChatlistInvite;
        ...
        org.telegram.ui.Components.n6 n6Var = this.f31667f;
        if (isEmpty) {
        ...
        if ((z12 ? 1.0f : 0.0f) != this.f31670s) {
            ValueAnimator valueAnimator = this.f31671w;
            ...
            float f7 = 0.0f;
            if (z11) {
                float f10 = this.f31670s;
                if (z12) {
                    f7 = 1.0f;
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, f7);
                this.f31671w = ofFloat;
                ofFloat.addUpdateListener(new b3(this, 12));
                this.f31671w.addListener(new org.telegram.ui.Components.aa(28, this, z12));
                this.f31671w.setInterpolator(org.telegram.ui.Components.qr.h);
                this.f31671w.setDuration(350L);
                this.f31671w.start();
                return;
            }
            if (z12) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f7 = dp;
        canvas.drawCircle(f7, getMeasuredHeight() / 2.0f, AndroidUtilities.dp(16.0f), this.f31668n);
        if (this.f31670s > 0.0f) {
            canvas.drawCircle(f7, getMeasuredHeight() / 2.0f, AndroidUtilities.dp(16.0f) * this.f31670s, this.f31669r);
        }
        float f10 = this.f31670s;
        if (f10 < 1.0f) {
        ...
        if (this.v) {
            ...
            canvas.drawRect(dp2, measuredHeight, measuredWidth - i10, getMeasuredHeight(), org.telegram.ui.ActionBar.j6.f18984k0);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite = this.f31673y;
        String str2 = "";
        if (tL_exportedChatlistInvite == null || TextUtils.isEmpty(tL_exportedChatlistInvite.title)) {
            str = "";
        } else {
            str = a4.a.s(new StringBuilder(), this.f31673y.title, "\n ");
        }
        sb2.append(str);
        org.telegram.messenger.wl.l(R.string.InviteLink, ", ", sb2);
        sb2.append((Object) this.h.getText());
        TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite2 = this.f31673y;
