...
public abstract class a10 extends FrameLayout {
    public final org.telegram.ui.ActionBar.o2 f31668a;
    public final int f31669b;
    public final int f31670c;
    public final Drawable d;
    public final Drawable e;
    public final org.telegram.ui.Components.n6 f31671f;
    public final org.telegram.ui.Components.n6 h;
    public final Paint f31672n;
    public final Paint f31673r;
    public float f31674s;
    public boolean v;
    public ValueAnimator f31675w;
    public String f31676x;
    public TL_chatlists.TL_exportedChatlistInvite f31677y;
    ...
    public a10(Context context, org.telegram.ui.ActionBar.o2 o2Var, int i10, int i11) {
        ...
        n6Var2.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19264z6, false));
        if (LocaleController.isRTL) {
            i13 = 5;
        } else {
            i13 = 3;
    ...
    public final void a() {
        ...
        tL_inputChatlistDialogFilter.filter_id = this.f31670c;
        tL_chatlists_deleteExportedInvite.slug = substring;
        z00 z00Var = new z00(this, 2);
        ConnectionsManager.getInstance(this.f31669b).sendRequest(tL_chatlists_deleteExportedInvite, new qo(21, this, z00Var));
    ...
    public void c() {
        org.telegram.ui.ActionBar.o2 o2Var = this.f31668a;
        if (!(o2Var instanceof h10)) {
            return;
        }
        ai.w0 w0Var = ((h10) o2Var).f34091a;
    ...
    public final void d() {
        ...
        org.telegram.ui.Components.ki0 ki0Var = new org.telegram.ui.Components.ki0(getContext(), LocaleController.getString(R.string.InviteByQRCode), this.f31676x, LocaleController.getString(R.string.QRCodeLinkHelpFolder), false);
    ...
    public final void e(TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite, boolean z10) {
        boolean z11;
        if (this.f31677y == tL_exportedChatlistInvite) {
            z11 = true;
        } else {
            z11 = false;
        }
        this.f31677y = tL_exportedChatlistInvite;
        ...
        org.telegram.ui.Components.n6 n6Var = this.f31671f;
        if (isEmpty) {
        ...
        if ((z12 ? 1.0f : 0.0f) != this.f31674s) {
            ValueAnimator valueAnimator = this.f31675w;
            ...
            float f7 = 0.0f;
            if (z11) {
                float f10 = this.f31674s;
                if (z12) {
                    f7 = 1.0f;
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, f7);
                this.f31675w = ofFloat;
                ofFloat.addUpdateListener(new b3(this, 12));
                this.f31675w.addListener(new org.telegram.ui.Components.aa(28, this, z12));
                this.f31675w.setInterpolator(org.telegram.ui.Components.qr.h);
                this.f31675w.setDuration(350L);
                this.f31675w.start();
                return;
            }
            if (z12) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f7 = dp;
        canvas.drawCircle(f7, getMeasuredHeight() / 2.0f, AndroidUtilities.dp(16.0f), this.f31672n);
        if (this.f31674s > 0.0f) {
            canvas.drawCircle(f7, getMeasuredHeight() / 2.0f, AndroidUtilities.dp(16.0f) * this.f31674s, this.f31673r);
        }
        float f10 = this.f31674s;
        if (f10 < 1.0f) {
        ...
        if (this.v) {
            ...
            canvas.drawRect(dp2, measuredHeight, measuredWidth - i10, getMeasuredHeight(), org.telegram.ui.ActionBar.j6.f18985k0);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite = this.f31677y;
        String str2 = "";
        if (tL_exportedChatlistInvite == null || TextUtils.isEmpty(tL_exportedChatlistInvite.title)) {
            str = "";
        } else {
            str = a4.a.s(new StringBuilder(), this.f31677y.title, "\n ");
        }
        sb2.append(str);
        org.telegram.messenger.wl.l(R.string.InviteLink, ", ", sb2);
        sb2.append((Object) this.h.getText());
        TL_chatlists.TL_exportedChatlistInvite tL_exportedChatlistInvite2 = this.f31677y;
