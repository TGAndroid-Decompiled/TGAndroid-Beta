...
public class a10 extends ReplacementSpan {
    public final TextPaint f31632a;
    public final Paint f31633b;
    public StaticLayout f31634c;
    public float d;
    public float e;
    public int f31635f;
    public final int h;
    public CharSequence f31636n;

    public a10(int i10) {
        TextPaint textPaint = new TextPaint(1);
        this.f31632a = textPaint;
    ...
    public final void a() {
        if (this.f31634c == null) {
            StaticLayout staticLayout = new StaticLayout(this.f31636n, this.f31632a, AndroidUtilities.displaySize.x, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            this.f31634c = staticLayout;
            this.d = staticLayout.getLineWidth(0);
            this.e = this.f31634c.getHeight();
        }
    }
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        ...
        float f10;
        a();
        int i16 = this.f31635f;
        if (i16 == 0) {
            i16 = paint.getColor();
        }
        Paint paint2 = this.f31633b;
        paint2.setColor(i16);
        ...
        TextPaint textPaint = this.f31632a;
