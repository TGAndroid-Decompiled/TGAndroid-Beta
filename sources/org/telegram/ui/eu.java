...
public final class eu extends org.telegram.ui.Components.za {
    ...
    public final ci.d Y;
    public final ci.d Z;
    public final ArrayList f33474a0;
    public final HashSet f33475b0;
    public boolean f33476c0;
    public org.telegram.ui.Components.x51 f33477d0;

    public eu(Activity activity, HashSet hashSet) {
        super(activity, null, false, false, new ai.d());
        ArrayList arrayList = new ArrayList();
        this.f33474a0 = arrayList;
        HashSet hashSet2 = new HashSet();
        this.f33475b0 = hashSet2;
        ...
        imageView.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        this.f33227b.dismiss();
                        return;
                    case 1:
                        this.f33227b.S(false);
                        return;
                    default:
                        this.f33227b.S(true);
                        return;
        ...
        org.telegram.ui.Components.x51 x51Var = this.f33477d0;
        if (x51Var != null) {
            x51Var.N(false);
        }
        s4.j jVar = new s4.j();
        ...
        ml0Var.setPadding(i11, 0, i11, AndroidUtilities.dp(76.0f));
    }
    ...
    public static void Q(eu euVar, TLObject tLObject, ci.d dVar, boolean z10, HashSet hashSet, TLRPC.TL_error tL_error) {
        if (tLObject instanceof TLRPC.Updates) {
            ...
            if (groupCall != null && LaunchActivity.G1 != null) {
                ...
                euVar.dismiss();
                org.telegram.ui.Components.voip.f2.g(LaunchActivity.G1, euVar.currentAccount, tL_inputGroupCall, z10, groupCall, hashSet);
                return;
            }
            euVar.f33476c0 = false;
            ...
            euVar.dismiss();
            org.telegram.ui.Components.voip.f2.g(LaunchActivity.G1, euVar.currentAccount, tL_inputGroupCall2, z10, groupcall.call, hashSet);
    ...
    public static void R(eu euVar, ArrayList arrayList) {
        ...
        ArrayList arrayList2 = euVar.f33474a0;
