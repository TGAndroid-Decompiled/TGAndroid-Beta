    ...
    public final int compare(Object obj, Object obj2) {
        ...
        switch (this.f33852a) {
            case 0:
                ...
                return 0;
            case 1:
                return Long.compare(((uu) obj2).f29456c, ((uu) obj).f29456c);
            case 2:
            ...
            case 13:
                ...
                return 0;
            case 14:
                return (int) (((org.telegram.ui.web.j) obj2).f39488c - ((org.telegram.ui.web.j) obj).f39488c);
            case 15:
                return (int) (((org.telegram.ui.web.j) obj2).f39488c - ((org.telegram.ui.web.j) obj).f39488c);
            case 16:
                mg.q0 q0Var = (mg.q0) obj2;
                String str = ((mg.q0) obj).f14095f;
                if (str != null && str.equals("❤")) {
                    i12 = -1;
                } else {
                    i12 = 0;
                }
                String str2 = q0Var.f14095f;
            ...
            case 18:
                ...
                int compare = Integer.compare(bVar.f44050c, bVar2.f44050c);
                if (compare == 0) {
                    return bVar.f44049b.compareTo(bVar2.f44049b);
                }
                return compare;
            case 19:
                int i27 = ((tf.y) obj).f44943b;
                int i28 = ((tf.y) obj2).f44943b;
                if (i27 < i28) {
                    return 1;
                }
                if (i27 > i28) {
            ...
            case 21:
                int i29 = ((tf.h1) obj).f44806b;
                int i30 = ((tf.h1) obj2).f44806b;
                if (i29 < i30) {
                    return 1;
                }
                if (i29 > i30) {
            ...
            case 23:
                return ((uf.o1) obj).f45473c - ((uf.o1) obj2).f45473c;
            case 24:
                return Integer.compare(((w4.d) obj2).f46492b, ((w4.d) obj).f46492b);
            default:
                return ((f2.l1) obj2).f5774a.getTop() - ((f2.l1) obj).f5774a.getTop();
        }
    }
}
