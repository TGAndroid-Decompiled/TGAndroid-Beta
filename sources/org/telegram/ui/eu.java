...
public final class eu extends org.telegram.ui.Components.za {
    ...
    public final ci.d Y;
    public final ci.d Z;
    public final ArrayList f33470a0;
    public final HashSet f33471b0;
    public boolean f33472c0;
    public org.telegram.ui.Components.x51 f33473d0;

    public eu(Activity activity, HashSet hashSet) {
        super(activity, null, false, false, new ai.d());
        ArrayList arrayList = new ArrayList();
        this.f33470a0 = arrayList;
        HashSet hashSet2 = new HashSet();
        this.f33471b0 = hashSet2;
        ...
        imageView.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        this.f33223b.dismiss();
                        return;
                    case 1:
                        this.f33223b.S(false);
                        return;
                    default:
                        this.f33223b.S(true);
                        return;
        ...
        org.telegram.ui.Components.x51 x51Var = this.f33473d0;
        if (x51Var != null) {
            x51Var.N(false);
        }
        s4.j jVar = new s4.j();
    ...
    public static void R(eu euVar, ArrayList arrayList) {
        ...
        ArrayList arrayList2 = euVar.f33470a0;
