...
public final class rc1 extends org.telegram.ui.Components.ll0 {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        if (view instanceof org.telegram.ui.Cells.t1) {
            ...
            if (avatarImage != null) {
                ...
                wd1 wd1Var = this.Z2;
                if (m32 && (T = wd1Var.f41997u0.T(view)) != null) {
                    if (wd1Var.f41997u0.K(T.b() - 1) != null) {
                ...
                int measuredHeight = wd1Var.f41997u0.getMeasuredHeight() - wd1Var.f41997u0.getPaddingBottom();
                if (layoutHeight > measuredHeight) {
                    layoutHeight = measuredHeight;
                }
                if (t1Var.n3() && (r11 = wd1Var.f41997u0.T(view)) != null) {
                    int i10 = 0;
                    while (i10 < 20) {
                        i10++;
                        s4.c1 T2 = wd1Var.f41997u0.K(T2.b() + 1);
                        if (T2 == null) {
                            break;
                        }
                        View view2 = T2.f45767a;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        wd1 wd1Var = this.Z2;
        if (action == 1) {
            if (!wd1Var.f41990r0 && (wd1Var.B1 instanceof gj1) && wd1Var.L0[0].getVisibility() == 0) {
                wd1Var.f1(0, false, true);
            }
            wd1Var.f41990r0 = false;
        }
        if (wd1Var.a2) {
