...
public final class ys extends org.telegram.ui.ActionBar.j {
    public final ContactsActivity f43229a;

    public ys(ContactsActivity contactsActivity) {
        this.f43229a = contactsActivity;
    }
    ...
    public final void b(int i10) {
        ...
        ContactsActivity contactsActivity = this.f43229a;
        if (i10 == -1) {
        ...
        if (i10 == 100) {
            ...
            if (iVar.m() == 1) {
                alertDialog$Builder.f20226a.R = LocaleController.getString(R.string.DeleteContactTitle);
                alertDialog$Builder.f20226a.T = LocaleController.getString(R.string.DeleteContactSubtitle);
            } else {
                alertDialog$Builder.f20226a.R = LocaleController.formatPluralString("DeleteContactsTitle", iVar.m(), new Object[0]);
                alertDialog$Builder.f20226a.T = LocaleController.getString(R.string.DeleteContactsSubtitle);
            }
            ...
            atVar.Y(i12, false);
            org.telegram.ui.ActionBar.v0 v0Var = contactsActivity.f33389s;
            ...
            contactsActivity.f33374f.x0(0);
            AndroidUtilities.doOnPreDraw(contactsActivity.Z.f24550r, new dj(this, 14));
        }
    }
}
