...
public final class ys extends org.telegram.ui.ActionBar.j {
    public final ContactsActivity f43202a;

    public ys(ContactsActivity contactsActivity) {
        this.f43202a = contactsActivity;
    }
    ...
    public final void b(int i10) {
        ...
        ContactsActivity contactsActivity = this.f43202a;
        if (i10 == -1) {
        ...
        if (i10 == 100) {
            ...
            if (iVar.m() == 1) {
                alertDialog$Builder.f20199a.R = LocaleController.getString(R.string.DeleteContactTitle);
                alertDialog$Builder.f20199a.T = LocaleController.getString(R.string.DeleteContactSubtitle);
            } else {
                alertDialog$Builder.f20199a.R = LocaleController.formatPluralString("DeleteContactsTitle", iVar.m(), new Object[0]);
                alertDialog$Builder.f20199a.T = LocaleController.getString(R.string.DeleteContactsSubtitle);
            }
            ...
            atVar.Y(i12, false);
            org.telegram.ui.ActionBar.v0 v0Var = contactsActivity.f33362s;
            ...
            contactsActivity.f33347f.x0(0);
            AndroidUtilities.doOnPreDraw(contactsActivity.Z.f24523r, new dj(this, 14));
        }
    }
}
