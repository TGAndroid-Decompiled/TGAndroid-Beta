...
public final class ys extends org.telegram.ui.ActionBar.j {
    public final ContactsActivity f40005a;

    public ys(ContactsActivity contactsActivity) {
        this.f40005a = contactsActivity;
    }
    ...
    public final void b(int i10) {
        ...
        ContactsActivity contactsActivity = this.f40005a;
        if (i10 == -1) {
        ...
        if (i10 == 100) {
            ...
            if (iVar.m() == 1) {
                alertDialog$Builder.f18654a.R = LocaleController.getString(R.string.DeleteContactTitle);
                alertDialog$Builder.f18654a.T = LocaleController.getString(R.string.DeleteContactSubtitle);
            } else {
                alertDialog$Builder.f18654a.R = LocaleController.formatPluralString("DeleteContactsTitle", iVar.m(), new Object[0]);
                alertDialog$Builder.f18654a.T = LocaleController.getString(R.string.DeleteContactsSubtitle);
            }
            ...
            atVar.Y(i12, false);
            org.telegram.ui.ActionBar.v0 v0Var = contactsActivity.f31041s;
            ...
            contactsActivity.f31026f.y0(0);
            AndroidUtilities.doOnPreDraw(contactsActivity.Z.f22856r, new cj(this, 14));
        }
    }
}
