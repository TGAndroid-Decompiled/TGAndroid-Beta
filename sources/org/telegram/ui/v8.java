...
public final class v8 implements RequestDelegate {
    ...
    public final Object f38333f;
    public final Object f38334g;
    public final Object h;

    public v8(int i10, TLRPC.InputGroupCall inputGroupCall, String[] strArr, FrameLayout frameLayout, org.telegram.ui.Components.l90 l90Var, org.telegram.ui.ActionBar.f3 f3Var, org.telegram.ui.ActionBar.e6 e6Var) {
        this.f38330a = 0;
        this.f38331b = i10;
        this.f38332c = inputGroupCall;
        this.d = strArr;
        this.e = frameLayout;
        this.f38333f = l90Var;
        this.f38334g = f3Var;
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        Object obj = this.h;
        Object obj2 = this.f38334g;
        Object obj3 = this.f38333f;
        Object obj4 = this.e;
        Object obj5 = this.d;
        Object obj6 = this.f38332c;
        switch (i10) {
            case 0:
            ...
            case 1:
                ...
                return;
            case 2:
                ArrayList arrayList2 = ExternalActionActivity.f31033x;
                AndroidUtilities.runOnUIThread(new org.telegram.messenger.y5((ExternalActionActivity) obj6, (org.telegram.ui.ActionBar.b2) obj5, tLObject, this.f38331b, (TL_account.authorizationForm) obj4, (TL_account.getAuthorizationForm) obj3, (String) obj2, (String) obj));
                return;
            default:
                AndroidUtilities.runOnUIThread(new org.telegram.messenger.jb((gg0) obj6, tLObject, tL_error, (c5.k) obj5, this.f38331b, (c5.o) obj4, (TLRPC.TL_inputStorePaymentAuthCode) obj3, (String) obj2, (TLRPC.TL_payments_canPurchaseStore) obj));
                return;
        }
    }
    ...
    public v8(KeyEvent.Callback callback, Object obj, int i10, Object obj2, TLObject tLObject, String str, Object obj3, int i11) {
        this.f38330a = i11;
        this.f38332c = callback;
        this.d = obj;
        this.f38331b = i10;
        this.e = obj2;
        this.f38333f = tLObject;
        this.f38334g = str;
        this.h = obj3;
    }
}
