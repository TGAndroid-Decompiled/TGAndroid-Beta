...
public final class oy extends s4.v {
    ...
    public final long d(RecyclerView recyclerView, int i10, float f7, float f10) {
        ...
        if (i10 == 8 && (s2Var = (qyVar = this.h).X0) != null) {
            AndroidUtilities.runOnUIThread(new kh(1, s2Var), this.f36352g.f36687x.e);
            qyVar.X0 = null;
        }
    ...
    public final boolean n(RecyclerView recyclerView, s4.c1 c1Var, s4.c1 c1Var2) {
        ...
        int i10;
        qy qyVar = this.h;
        ArrayList arrayList = qyVar.f37001a1;
        ...
        if (view instanceof org.telegram.ui.Cells.s2) {
            ...
            if (dialog != null && qyVar.g4(dialog) && !DialogObject.isFolderDialogId(dialogId)) {
                int b10 = c1Var.b();
                int b11 = c1Var2.b();
                py pyVar = this.f36352g;
                if (pyVar.f36679a.getItemAnimator() == null) {
                    pyVar.f36679a.setItemAnimator(pyVar.f36687x);
                }
                xw xwVar = pyVar.d;
                qy qyVar2 = xwVar.R;
                int i11 = xwVar.F;
                ...
                if (i12 != 7 && i12 != 8) {
                    ...
                    int i14 = dialogFilter.pinnedDialogs.get(dialog2.f18325id);
                    dialogFilter.pinnedDialogs.put(dialog2.f18325id, dialogFilter.pinnedDialogs.get(dialog3.f18325id));
                    dialogFilter.pinnedDialogs.put(dialog3.f18325id, i14);
                }
                Collections.swap(R3, G, G2);
                xwVar.W(null);
                int i15 = qyVar.f37021e0[0].f36685s;
                if (i15 != 7) {
                    i10 = 8;
                    if (i15 != 8) {
                        qyVar.Z0 = true;
                ...
                if (qyVar.f37021e0[0].f36685s == i10) {
                    c11 = 1;
                }
    ...
    public final void p(s4.c1 c1Var, int i10) {
        if (c1Var != null) {
            this.f36352g.f36679a.d1(false);
        }
        this.d = c1Var;
        if (c1Var != null) {
            View view = c1Var.f42946a;
            if (view instanceof org.telegram.ui.Cells.s2) {
                ((org.telegram.ui.Cells.s2) view).f21016w = false;
            }
        }
    }
    ...
    public final void q(s4.c1 c1Var) {
        ...
        if (c1Var != null) {
            ...
            if (Utilities.random.nextInt(1000) == 1) {
                if (qyVar.V0 == null) {
                    my myVar2 = pyVar.f36679a;
                    ?? obj = new Object();
                    obj.f26064a = new Paint(1);
                    Paint paint = new Paint(1);
                    obj.f26065b = paint;
                    obj.e = 0L;
                    obj.f26067f = new RectF();
                    paint.setStyle(Paint.Style.STROKE);
                    paint.setStrokeWidth(AndroidUtilities.dp(2.0f));
                    obj.f26066c = myVar2;
                    qyVar.V0 = obj;
                }
                org.telegram.ui.Components.ld0 ld0Var = qyVar.V0;
                ld0Var.d = a0Var;
                ld0Var.h = 0.0f;
                ld0Var.f26068g = 0.0f;
                ld0Var.e = System.currentTimeMillis();
                ld0Var.f26066c.invalidate();
                return;
            }
            a0Var.run();
            return;
