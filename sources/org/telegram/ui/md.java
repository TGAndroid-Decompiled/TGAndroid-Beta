        ...
        switch (i10) {
            ...
            default:
                ...
                if (currentTime < jeVar.L0) {
                    ...
                    if (jeVar.f34759h1 == null) {
                        jeVar.f34759h1 = new SpannableStringBuilder("l");
                        org.telegram.ui.Components.pq pqVar = new org.telegram.ui.Components.pq(R.drawable.mini_switch_lock, 0);
                        pqVar.setTopOffset(1);
                        jeVar.f34759h1.setSpan(pqVar, 0, 1, 33);
                    }
                    SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
                    spannableStringBuilder.append((CharSequence) jeVar.f34759h1).append((CharSequence) yh.g.j0(jeVar.L0 - currentTime));
                    ...
                    if (qcVar != null) {
                        ...
                        if ((ubVar instanceof org.telegram.ui.Components.yb) && ubVar.isAttachedToWindow()) {
                            org.telegram.messenger.ok.q(R.string.BotStarsWithdrawalToast, new Object[]{yh.g.j0(jeVar.L0 - currentTime)}, ((org.telegram.ui.Components.yb) jeVar.Z0.e).f30582b);
                        }
                    }
