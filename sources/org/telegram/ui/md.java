        ...
        switch (i10) {
            ...
            default:
                ...
                if (currentTime < jeVar.L0) {
                    ...
                    if (jeVar.f34877h1 == null) {
                        jeVar.f34877h1 = new SpannableStringBuilder("l");
                        org.telegram.ui.Components.oq oqVar = new org.telegram.ui.Components.oq(R.drawable.mini_switch_lock, 0);
                        oqVar.setTopOffset(1);
                        jeVar.f34877h1.setSpan(oqVar, 0, 1, 33);
                    }
                    SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
                    spannableStringBuilder.append((CharSequence) jeVar.f34877h1).append((CharSequence) yh.g.j0(jeVar.L0 - currentTime));
                    ...
                    if (ocVar != null) {
                        ...
                        if ((sbVar instanceof org.telegram.ui.Components.wb) && sbVar.isAttachedToWindow()) {
                            org.telegram.messenger.vl.q(R.string.BotStarsWithdrawalToast, new Object[]{yh.g.j0(jeVar.L0 - currentTime)}, ((org.telegram.ui.Components.wb) jeVar.Z0.e).f29679b);
                        }
                    }
                ...
                aeVar.g(yh.x7.V0(false, formatPluralStringSpaced, jeVar.R0), true, true);
                return;
        }
    }
}
