...
public final class sr extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int f37448a0;
    public int f37449a1;
    public org.telegram.ui.Components.jx0 f37450b;
    public int f37451b0;
    public int f37452b1;
    public ai.w0 f37453c;
    public int f37454c0;
    public int f37455c1;
    public gg.j0 d;
    public int f37456d0;
    ...
    public rr e;
    public int f37458e0;
    public final int f37459e1;
    public org.telegram.ui.ActionBar.v0 f37460f;
    public int f37461f0;
    public int f37462f1;
    public int f37463g0;
    public int f37464g1;
    ...
    public int m0;
    public lr f37474m1;
    public UndoView f37475n;
    public int f37476n0;
    public final boolean f37477n1;
    public int f37478o0;
    public boolean f37479o1;
    public int f37480p0;
    public int f37481p1;
    public int f37482q0;
    public int f37483q1;
    public TLRPC.Chat f37484r;
    public int f37485r0;
    public boolean f37486r1;
    public TLRPC.ChatFull f37487s;
    public int f37488s0;
    public int f37489s1;
    public int f37490t0;
    public final boolean f37491t1;
    public int f37492u0;
    public final boolean f37493u1;
    public final boolean v;
    public int f37494v0;
    public boolean f37495v1;
    public final boolean f37496w;
    public boolean f37497w0;
    public boolean f37498w1;
    public final boolean f37499x;
    public int f37500x0;
    public boolean f37501x1;
    public final String f37502y;
    public int f37503y0;
    public boolean f37504y1;
    public int f37505z0;
    public long f37506z1;
    ...
    public sr(Bundle bundle) {
        ...
        this.f37477n1 = this.arguments.getBoolean("open_search");
        this.f37459e1 = this.arguments.getInt("selectType");
        ...
        this.f37502y = ChatObject.getBannedRightsString(this.E);
        boolean isCommunity = ChatObject.isCommunity(this.f37484r);
        this.f37496w = isCommunity;
        if (ChatObject.isChannel(this.f37484r) && !this.f37484r.megagroup && !isCommunity) {
            z10 = true;
        }
        this.v = z10;
        this.f37499x = ChatObject.isForum(this.f37484r);
        TLRPC.Chat chat2 = this.f37484r;
        if (chat2 != null) {
    ...
    public static void U(sr srVar, long j3) {
        if (j3 != 0) {
            srVar.N = j3;
            srVar.f37484r = MessagesController.getInstance(srVar.currentAccount).getChat(Long.valueOf(j3));
            srVar.u0();
        }
    }
    ...
    public static void c0(sr srVar, TLRPC.User user) {
        ...
        UndoView undoView = srVar.f37475n;
        long j3 = -srVar.N;
        boolean z12 = srVar.v;
        if (z12) {
            i10 = 9;
        ...
        while (i11 < 3) {
            ...
            TLObject tLObject = (TLObject) iVar.f(user.f18475id);
            if (tLObject instanceof TLRPC.ChannelParticipant) {
    ...
    public final void A0(mr mrVar) {
        ...
        B0();
        mrVar.f(mrVar.d);
        s4.o.c(mrVar, true).b(this.f37447a);
        ai.w0 w0Var = this.f37453c;
        if (w0Var != null && this.d != null && w0Var.getChildCount() > 0) {
            int i10 = 0;
            int i11 = -1;
            while (true) {
                if (i10 < this.f37453c.getChildCount()) {
                    i11 = RecyclerView.S(this.f37453c.getChildAt(i10));
                    if (i11 != -1) {
                        view = this.f37453c.getChildAt(i10);
                        break;
                    }
                    i10++;
                } else {
            ...
            if (view != null) {
                this.d.h1(i11, view.getTop() - this.f37453c.getPaddingTop());
            }
        }
    }
    ...
    public final View createView(Context context) {
        ...
        if (i11 == 0 && i12 != 2 && i12 != 0 && i12 != 3) {
            if (i12 == 1 && ChatObject.isChannelAndNotMegaGroup(this.f37484r) && ChatObject.hasAdminRights(this.f37484r)) {
            ...
            if (i12 == 3) {
                this.f37460f.setSearchFieldHint(LocaleController.getString("ChannelSearchException", R.string.ChannelSearchException));
            } else {
                this.f37460f.setSearchFieldHint(LocaleController.getString("Search", R.string.Search));
            }
            if (!ChatObject.isChannel(this.f37484r) && !this.f37484r.creator) {
                this.f37460f.setVisibility(8);
            }
            if (i12 == 3) {
        ...
        frameLayout.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19038a7));
        ...
        this.f37450b.e.setText(LocaleController.getString(R.string.SearchEmptyViewFilteredSubtitle2));
        this.f37450b.setVisibility(8);
        this.f37450b.setAnimateLayoutChange(true);
        this.f37450b.e(true, false);
        frameLayout2.addView(this.f37450b, w7.y5.c(-1.0f, -1));
        this.f37450b.addView(frameLayout3, 0);
        ai.w0 w0Var = new ai.w0(this, context, 9);
        this.f37453c = w0Var;
        w0Var.q1();
        ai.w0 w0Var2 = this.f37453c;
        ...
        frVar.C = false;
        frVar.f43009m = false;
        this.f37453c.setItemAnimator(frVar);
        ai.w0 w0Var3 = this.f37453c;
        w0Var3.Y1 = true;
        w0Var3.Z1 = 0;
        or orVar = new or(this, context);
        this.f37447a = orVar;
        w0Var3.setAdapter(orVar);
        ai.w0 w0Var4 = this.f37453c;
        if (!LocaleController.isRTL) {
            i10 = 2;
        }
        w0Var4.setVerticalScrollbarPosition(i10);
        frameLayout2.addView(this.f37453c, w7.y5.c(-1.0f, -1));
        this.actionBar.setAdaptiveBackground(this.f37453c);
        this.f37453c.setOnItemClickListener(new qq(this, 3));
        this.f37453c.setOnItemLongClickListener(new qq(this, 4));
        if (this.f37460f != null) {
            this.f37453c.setOnScrollListener(new h3(this, 7));
        }
        UndoView undoView = new UndoView(context);
        this.f37475n = undoView;
        frameLayout2.addView(undoView, w7.y5.d(-1, -2.0f, 83, 8.0f, 0.0f, 8.0f, 8.0f));
        B0();
        this.f37453c.setEmptyView(this.f37450b);
        ai.w0 w0Var5 = this.f37453c;
        w0Var5.Y1 = false;
        w0Var5.Z1 = 0;
        if (this.f37477n1) {
            this.f37460f.z(false);
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.chatInfoDidLoad) {
            ...
            if (chatFull.f18329id == this.N) {
                if (!booleanValue || !ChatObject.isChannel(this.f37484r)) {
                    if (this.f37487s != null) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
                    this.f37487s = chatFull;
                    if (!z10) {
                        int k02 = k0();
                        this.f37483q1 = k02;
                        this.f37481p1 = k02;
                        int i12 = this.f37487s.boosts_unrestrict;
                        if (i12 > 0) {
                            z11 = true;
                        } else {
                            z11 = false;
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 16, new Class[]{org.telegram.ui.Cells.n4.class, org.telegram.ui.Cells.c5.class, org.telegram.ui.Cells.z4.class, org.telegram.ui.Cells.w8.class, org.telegram.ui.Cells.fa.class, org.telegram.ui.Components.ew0.class}, null, null, null, org.telegram.ui.ActionBar.j6.f19094d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 32768, null, null, null, null, org.telegram.ui.ActionBar.j6.f19372s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f19184i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f19216k0, null, null, org.telegram.ui.ActionBar.j6.f19095d7));
        int i10 = org.telegram.ui.ActionBar.j6.f19058b7;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 32, new Class[]{org.telegram.ui.Cells.f9.class}, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 0, new Class[]{org.telegram.ui.Cells.f9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.B6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 32, new Class[]{org.telegram.ui.Cells.c7.class}, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 0, new Class[]{org.telegram.ui.Cells.n4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.L6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 0, new Class[]{org.telegram.ui.Cells.w3.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f7));
        int i11 = org.telegram.ui.ActionBar.j6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 0, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 0, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.I6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19496z6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.U6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.V6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 0, new Class[]{org.telegram.ui.Cells.c5.class}, new String[]{"nameTextView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.j6.f19477y6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 0, new Class[]{org.telegram.ui.Cells.c5.class}, new String[]{"statusColor"}, null, null, -1, eVar, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 0, new Class[]{org.telegram.ui.Cells.c5.class}, new String[]{"statusOnlineColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.j6.f19279n6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37475n, 32, null, null, null, null, org.telegram.ui.ActionBar.j6.Fi));
        int i13 = org.telegram.ui.ActionBar.j6.Gi;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37475n, 0, new Class[]{UndoView.class}, new String[]{"undoImageView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37475n, 0, new Class[]{UndoView.class}, new String[]{"undoTextView"}, null, null, -1, null, i13));
        int i14 = org.telegram.ui.ActionBar.j6.Hi;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37475n, 0, new Class[]{UndoView.class}, new String[]{"infoTextView"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37475n, 0, new Class[]{UndoView.class}, new String[]{"textPaint"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37475n, 0, new Class[]{UndoView.class}, new String[]{"progressPaint"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37475n, 8, new Class[]{UndoView.class}, new String[]{"leftImageView"}, null, null, -1, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 262144, new Class[]{org.telegram.ui.Cells.z4.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 262144, new Class[]{org.telegram.ui.Cells.z4.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19259m6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 262144, new Class[]{org.telegram.ui.Cells.z4.class}, new String[]{"imageView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19407u6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 262144, new Class[]{org.telegram.ui.Cells.z4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19425v6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 0, new Class[]{org.telegram.ui.Components.jx0.class}, new String[]{"title"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 0, new Class[]{org.telegram.ui.Components.jx0.class}, new String[]{"subtitle"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37450b.d, 4, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37450b.e, 4, null, null, null, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f37453c, 0, new Class[]{org.telegram.ui.Cells.c5.class}, null, org.telegram.ui.ActionBar.j6.f19345r0, null, org.telegram.ui.ActionBar.j6.J7));
    ...
    public final boolean h0(TLObject tLObject, boolean z10, View view) {
        ...
        String str2;
        int i14;
        if (tLObject == null || (i10 = this.f37459e1) != 0) {
            return false;
        }
        if (tLObject instanceof TLRPC.ChannelParticipant) {
            ...
            if (tLObject instanceof TLRPC.ChatParticipant) {
                ...
                str = "";
                z11 = ChatObject.canAddAdmins(this.f37484r);
        ...
        if (i16 == 2) {
            ...
            if (ChatObject.canAddAdmins(this.f37484r) && ((tLObject instanceof TLRPC.TL_channelParticipant) || (tLObject instanceof TLRPC.TL_channelParticipantBanned) || (tLObject instanceof TLRPC.TL_chatParticipant) || z11)) {
                z13 = true;
            } else {
                z13 = false;
            }
            ...
            if (ChatObject.canBlockUsers(this.f37484r) && z15 && !z21 && ChatObject.isChannel(this.f37484r) && !this.f37484r.gigagroup) {
                z17 = true;
            } else {
                z17 = false;
            }
            ...
            if (!z14 && (!ChatObject.canBlockUsers(this.f37484r) || !z15)) {
                z18 = false;
            } else {
                z18 = true;
            }
            if (!z10 && z18) {
                ...
                H.W(this.f37453c.W0(view, false));
                ...
                if (ChatObject.canBlockUsers(this.f37484r) && z15) {
                    z19 = true;
                } else {
                    z19 = false;
                }
        ...
        if (i16 == 3 && ChatObject.canBlockUsers(this.f37484r)) {
            srVar = this;
            ...
            String str3 = str;
            srVar = this;
            if (i16 == 0 && ChatObject.canBlockUsers(srVar.f37484r)) {
                if (ChatObject.canAddUsers(srVar.f37484r) && i15 > 0 && !ChatObject.isCommunity(srVar.f37484r)) {
            ...
            } else if (i16 == 1 && ChatObject.canAddAdmins(srVar.f37484r) && z11) {
                if (!srVar.f37484r.creator && (tLObject instanceof TLRPC.TL_channelParticipantCreator)) {
                    j10 = j13;
                } else {
                    j10 = j13;
        ...
        H2.W(srVar.f37453c.W0(view, false));
        H2.S = 190;
        if (H2.x() > 0) {
            z12 = true;
        } else {
    ...
    public final int k0() {
        TLRPC.ChatFull chatFull = this.f37487s;
        if (chatFull != null) {
    ...
    public final void onBecomeFullyHidden() {
        UndoView undoView = this.f37475n;
        if (undoView != null) {
            undoView.e(0, true);
        }
    }
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f37453c.setPadding(0, 0, 0, i13);
        this.f37453c.setClipToPadding(false);
        this.f37475n.setTranslationY(-i13);
    }
    ...
    public final void onResume() {
        ...
        or orVar = this.f37447a;
        if (orVar != null) {
            orVar.l();
        }
        org.telegram.ui.Components.jx0 jx0Var = this.f37450b;
        if (jx0Var != null) {
    ...
    public final void onTransitionAnimationEnd(boolean z10, boolean z11) {
        ...
        if (z10 && !z11 && this.f37477n1) {
            this.f37460f.getSearchField().requestFocus();
            AndroidUtilities.showKeyboard(this.f37460f.getSearchField());
            this.f37460f.setVisibility(8);
        }
    }

    public final boolean p0(int i10) {
        if (i10 != this.V && i10 != this.W && i10 != this.X && i10 != this.Y && i10 != this.Z && i10 != this.f37448a0 && i10 != this.f37471k0 && i10 != this.f37451b0 && i10 != this.f37454c0 && i10 != this.f37456d0) {
            return false;
        }
        return true;
    }
    ...
    public final void r0() {
        ...
        if (!this.Q) {
            ...
            if (z10 && i11 == 2) {
            ...
            } else if (!ChatObject.isChannel(this.f37484r)) {
                this.Q = false;
                arrayList3.clear();
                arrayList.clear();
                arrayList2.clear();
                ...
                iVar.b();
                if (i11 == 1) {
                    TLRPC.ChatFull chatFull2 = this.f37487s;
                    if (chatFull2 != null && (chatParticipants = chatFull2.participants) != null) {
                        int size3 = chatParticipants.participants.size();
                        while (i10 < size3) {
                            TLRPC.ChatParticipant chatParticipant = this.f37487s.participants.participants.get(i10);
                ...
                } else if (i11 == 2 && (chatFull = this.f37487s) != null && chatFull.participants != null) {
                    long j3 = getUserConfig().clientUserId;
                    int size4 = this.f37487s.participants.participants.size();
                    while (i10 < size4) {
                        TLRPC.ChatParticipant chatParticipant2 = this.f37487s.participants.participants.get(i10);
                        int i14 = this.f37459e1;
                ...
                or orVar2 = this.f37447a;
                if (orVar2 != null) {
                    orVar2.l();
                }
                B0();
                or orVar3 = this.f37447a;
                if (orVar3 != null) {
                    orVar3.l();
                }
            } else {
    ...
    public final ArrayList s0() {
        ...
        if (i10 == 0) {
            ...
            TLRPC.ChatFull chatFull = this.f37487s;
            if (chatFull != null && chatFull.participants_count <= 200 && (chat = this.f37484r) != null && chat.megagroup) {
                tL_channels_getParticipants.filter = new TLRPC.TL_channelParticipantsRecent();
            } else if (this.f37459e1 == 1) {
                if (!this.J) {
                    this.f37472k1 = 2;
    ...
    public final void v0(long j3) {
        ...
        for (int i10 = 0; i10 < 3; i10++) {
            ...
            if (tLObject != null) {
                ...
                if (this.O == 0 && (chatFull = this.f37487s) != null) {
        ...
        s4.h0 adapter = this.f37453c.getAdapter();
        rr rrVar = this.e;
        if (adapter == rrVar) {
            gg.c2 c2Var = rrVar.h;
    ...
    public final mr w0() {
        ...
        mrVar.f35795b = this.f37457d1;
        mrVar.f35799i = this.X0;
        mrVar.f35800j = this.Y0;
        mrVar.f35802l.clear();
        mrVar.f35802l.addAll(this.G);
        mrVar.h = this.V0;
        mrVar.f35798g = this.U0;
        mrVar.f35803m.clear();
        mrVar.f35803m.addAll(this.H);
        mrVar.e = this.E0;
        mrVar.f35797f = this.F0;
        mrVar.f35801k.clear();
        mrVar.f35801k.addAll(this.F);
        mrVar.f(mrVar.f35796c);
        return mrVar;
    }
    ...
    public final void x0(TLRPC.ChatFull chatFull) {
        ...
        if (chatFull != null) {
            ...
            this.f37483q1 = k02;
            this.f37481p1 = k02;
            int i10 = this.f37487s.boosts_unrestrict;
            boolean z11 = false;
            if (i10 > 0) {
                z10 = true;
            } else {
    ...
    public final void y0(int i10) {
        if (!this.isPaused && this.B1) {
            if (this.f37453c.getAdapter() != this.f37447a || !this.R) {
                org.telegram.ui.Components.t00 t00Var = null;
                for (int i11 = 0; i11 < this.f37453c.getChildCount(); i11++) {
                    View childAt = this.f37453c.getChildAt(i11);
                    if (childAt instanceof org.telegram.ui.Components.t00) {
                        t00Var = childAt;
                    }
                }
                if (t00Var != null) {
                    this.f37453c.removeView(t00Var);
                    i10--;
                }
                this.f37453c.getViewTreeObserver().addOnPreDrawListener(new zq(this, t00Var, i10, 0));
            }
        }
    }
