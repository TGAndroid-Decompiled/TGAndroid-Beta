...
public final class wz0 extends nq {
    public final boolean[] f39271d1;
    public final TLRPC.User f39272e1;
    public final ProfileActivity f39273f1;
    ...
    public final void onTransitionAnimationEnd(boolean z10, boolean z11) {
        if (!z10 && z11 && this.f39271d1[0]) {
            ProfileActivity profileActivity = this.f39273f1;
            if (org.telegram.ui.Components.xc.a(profileActivity)) {
                org.telegram.ui.Components.xc.C(profileActivity, this.f39272e1.first_name).j();
            }
        }
    }
}
