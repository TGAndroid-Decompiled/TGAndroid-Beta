...
public final class wz0 extends i71 {
    public final z61[] f39329d2;
    public final ProfileActivity f39330e2;
    ...
    public wz0(ProfileActivity profileActivity, ProfileActivity profileActivity2, Activity activity, Integer num, int i10, org.telegram.ui.ActionBar.f6 f6Var, int i11, z61[] z61VarArr) {
        ...
        this.f39330e2 = profileActivity;
        this.f39329d2 = z61VarArr;
    }
    ...
    public final boolean F(TL_stars.TL_starGiftUnique tL_starGiftUnique) {
        ...
        if (tL_starGiftUnique != null) {
            i10 = ((org.telegram.ui.ActionBar.o2) this.f39330e2).currentAccount;
    ...
    public final void p(View view, Long l4, TLRPC.Document document, TL_stars.TL_starGiftUnique tL_starGiftUnique, Integer num) {
        ...
        int i11;
        int i12;
        ProfileActivity profileActivity = this.f39330e2;
        org.telegram.ui.Components.m5[] m5VarArr = profileActivity.G;
        z61[] z61VarArr = this.f39329d2;
        if (tL_starGiftUnique != null) {
            ...
            if (n10 != null && MessagesController.getGlobalMainSettings().getInt("statusgiftpage", 0) < 2) {
                ...
                yh.a4 a4Var = new yh.a4(context, i11, UserConfig.getInstance(i12).getClientUserId(), profileActivity.f31425z0, null);
                a4Var.j2(n10, null);
                a4Var.m2();
                a4Var.show();
            ...
            tL_inputEmojiStatusCollectible2.collectible_id = tL_starGiftUnique.f18347id;
        ...
        if (tL_starGiftUnique != null) {
            l10 = Long.valueOf(tL_starGiftUnique.f18347id);
        } else {
            l10 = null;
        }
        ...
        if (l4 != null) {
            org.telegram.ui.Cells.o oVar = profileActivity.f31274d0;
            ?? obj = new Object();
