...
public final class wz0 extends i71 {
    public final z61[] f39334d2;
    public final ProfileActivity f39335e2;
    ...
    public wz0(ProfileActivity profileActivity, ProfileActivity profileActivity2, Activity activity, Integer num, int i10, org.telegram.ui.ActionBar.f6 f6Var, int i11, z61[] z61VarArr) {
        ...
        this.f39335e2 = profileActivity;
        this.f39334d2 = z61VarArr;
    }
    ...
    public final boolean F(TL_stars.TL_starGiftUnique tL_starGiftUnique) {
        ...
        if (tL_starGiftUnique != null) {
            i10 = ((org.telegram.ui.ActionBar.o2) this.f39335e2).currentAccount;
    ...
    public final void p(View view, Long l4, TLRPC.Document document, TL_stars.TL_starGiftUnique tL_starGiftUnique, Integer num) {
        ...
        int i11;
        int i12;
        ProfileActivity profileActivity = this.f39335e2;
        org.telegram.ui.Components.m5[] m5VarArr = profileActivity.G;
        z61[] z61VarArr = this.f39334d2;
        if (tL_starGiftUnique != null) {
            i10 = ((org.telegram.ui.ActionBar.o2) profileActivity).currentAccount;
            TL_stars.SavedStarGift n10 = yh.v5.y(i10, false).n(tL_starGiftUnique.f18346id);
            if (n10 != null && MessagesController.getGlobalMainSettings().getInt("statusgiftpage", 0) < 2) {
                ...
                yh.a4 a4Var = new yh.a4(context, i11, UserConfig.getInstance(i12).getClientUserId(), profileActivity.f31429z0, null);
                a4Var.j2(n10, null);
                a4Var.m2();
                a4Var.show();
            ...
            tL_inputEmojiStatusCollectible2.collectible_id = tL_starGiftUnique.f18346id;
        ...
        if (tL_starGiftUnique != null) {
            l10 = Long.valueOf(tL_starGiftUnique.f18346id);
        } else {
            l10 = null;
        }
        ...
        for (int i13 = 0; i13 < 2; i13++) {
            ...
            if (m5Var != null) {
                ...
                org.telegram.ui.Components.m5 m5Var2 = m5VarArr[i13];
                if (tL_starGiftUnique != null) {
                    z10 = true;
                } else {
                    z10 = false;
        ...
        if (l4 != null) {
            org.telegram.ui.Cells.o oVar = profileActivity.f31278d0;
            ?? obj = new Object();
            long longValue = l4.longValue();
            obj.f49156g = longValue;
            obj.h = longValue;
            oVar.a(obj);
        }
        profileActivity.X4();
