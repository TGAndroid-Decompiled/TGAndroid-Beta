...
public final class wz0 extends nq {
    public final boolean[] f39281d1;
    public final TLRPC.User f39282e1;
    public final ProfileActivity f39283f1;
    ...
    public final void onTransitionAnimationEnd(boolean z10, boolean z11) {
        if (!z10 && z11 && this.f39281d1[0]) {
            ProfileActivity profileActivity = this.f39283f1;
            if (org.telegram.ui.Components.xc.a(profileActivity)) {
                org.telegram.ui.Components.xc.C(profileActivity, this.f39282e1.first_name).j();
            }
        }
    }
}
