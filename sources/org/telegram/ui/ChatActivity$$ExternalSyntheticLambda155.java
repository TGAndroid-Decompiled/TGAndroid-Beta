...
public final class ChatActivity$$ExternalSyntheticLambda155 implements Runnable {
    public final int $r8$classId;
    public final Object f$0;
    public final long f$1;
    public final boolean f$2;

    public ChatActivity$$ExternalSyntheticLambda155(Object obj, long j, boolean z, int i) {
        this.$r8$classId = i;
        this.f$0 = obj;
        this.f$1 = j;
        this.f$2 = z;
    ...
    public final void run() {
        switch (this.$r8$classId) {
            ...
            case 6:
                ...
                long j2 = this.f$1;
                if (z) {
                    MessagesController.getInstance(((BottomSheet) storyPrivacyBottomSheet).currentAccount).loadChannelParticipants(Long.valueOf(j2), new EmojiThemes$$ExternalSyntheticLambda0(page, j2, 1), 200);
                } else {
    ...
    public ChatActivity$$ExternalSyntheticLambda155(Object obj, boolean z, long j, int i) {
        this.$r8$classId = i;
        this.f$0 = obj;
        this.f$2 = z;
        this.f$1 = j;
