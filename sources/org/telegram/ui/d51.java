...
public final class d51 implements Runnable {
    ...
    public final void run() {
        switch (this.f32927a) {
            case 0:
                a71 a71Var = this.f32928b;
                a71Var.getClass();
                HashSet hashSet = zg.e0.f49289a;
            ...
            case 1:
                ...
                a71Var2.f32043q0.E(true);
                return;
            case 2:
                this.f32928b.U1.start();
                return;
            case 3:
                this.f32928b.B(true, true, true);
                return;
            default:
                a71 a71Var3 = this.f32928b;
