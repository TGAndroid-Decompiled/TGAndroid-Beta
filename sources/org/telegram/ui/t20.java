...
public abstract class t20 extends org.telegram.ui.ActionBar.o2 {
    ...
    public int N;
    public int O;
    public final p20 f37626a;
    public final p20 f37627b;
    public org.telegram.ui.Components.ml0 f37628c;
    public Drawable d;
    public rg.v1 e;
    public boolean f37629f;
    public boolean h;
    public float f37630n;
    public int f37631r;
    public s20 f37632s;
    public float v;
    public final Canvas f37633w;
    public float f37634x;
    public q20 f37635y;
    ...
    public t20() {
        ...
        this.f37626a = new p20(i10, i11, i12, i13, null, 0);
        p20 p20Var = new p20(i10, i11, i12, i13, null, 1);
        this.f37627b = p20Var;
        this.f37633w = new Canvas(Bitmap.createBitmap(100, 100, Bitmap.Config.ARGB_8888));
        this.E = -1;
        this.G = true;
        this.K = new Paint();
        p20Var.f42590n = true;
    ...
    public View createView(Context context) {
        ...
        this.f37628c = new org.telegram.ui.Components.ml0(context, null);
        if (this.G) {
            this.F = new org.telegram.ui.Components.pz(this.f37628c, (AndroidUtilities.dp(68.0f) + this.I) - AndroidUtilities.dp(16.0f));
        } else {
            this.F = new s4.c0();
        }
        this.f37628c.setLayoutManager(this.F);
        s4.c0 c0Var = this.F;
        if (c0Var instanceof org.telegram.ui.Components.pz) {
            ((org.telegram.ui.Components.pz) c0Var).R = true;
        }
        s4.h0 n02 = n0();
        this.f37628c.setAdapter(n02);
        if (n02 instanceof org.telegram.ui.Components.x51) {
            org.telegram.ui.Components.ml0 ml0Var = this.f37628c;
            o20 o20Var = new o20(this, 0);
            int dp = AndroidUtilities.dp(12.0f);
            float dp2 = AndroidUtilities.dp(16.0f);
            org.telegram.ui.Components.ml0 ml0Var2 = this.f37628c;
            Objects.requireNonNull(ml0Var2);
            ml0Var.s1(o20Var, dp, dp2, new gu(ml0Var2, 11), true);
        } else {
            this.f37628c.setSections(true);
        }
        this.f37628c.setClipToPadding(false);
        this.f37628c.j(new h3(this, 11));
        this.f37635y = new q20(context);
        s20 s20Var = this.f37632s;
        rg.v1 p02 = p0();
        this.e = p02;
        s20Var.addView(p02, w7.x5.c(-2.0f, -1));
        this.f37632s.addView(this.f37635y, w7.x5.c(-2.0f, -1));
        this.f37632s.addView(this.f37628c, w7.x5.c(-1.0f, -1));
        this.f37632s.addView(this.actionBar);
        this.fragmentView = this.f37632s;
    ...
    public void onInsets(int i10, int i11, int i12, int i13) {
        this.f37628c.setPadding(0, 0, 0, i13);
    }
    ...
    public final void s0() {
        ...
        if (ml0Var != null && ml0Var.getChildCount() > 0) {
            int i11 = 0;
            while (true) {
                if (i11 < this.f37628c.getChildCount()) {
                    view = this.f37628c.getChildAt(i11);
                    this.f37628c.getClass();
    ...
    public final Paint t0(float f7, float f10) {
        int measuredWidth = this.f37632s.getMeasuredWidth();
        int measuredHeight = this.f37632s.getMeasuredHeight();
        p20 p20Var = this.f37627b;
        p20Var.d(0, (-f7) - ((this.f37632s.getMeasuredWidth() * 0.1f) * this.f37630n), 0, measuredWidth, -f10, measuredHeight);
        return p20Var.f42583f;
    }

    public final void u0() {
        if (this.f37632s.getMeasuredWidth() != 0 && this.f37632s.getMeasuredHeight() != 0 && this.f37635y != null) {
            int measuredWidth = this.f37632s.getMeasuredWidth();
            int measuredHeight = this.f37632s.getMeasuredHeight();
            p20 p20Var = this.f37626a;
            p20Var.d(0, 0.0f, 0, measuredWidth, 0.0f, measuredHeight);
            Canvas canvas = this.f37633w;
            canvas.save();
            canvas.scale(100.0f / this.f37632s.getMeasuredWidth(), 100.0f / this.f37632s.getMeasuredHeight());
            canvas.drawRect(0.0f, 0.0f, this.f37632s.getMeasuredWidth(), this.f37632s.getMeasuredHeight(), p20Var.f42583f);
            canvas.restore();
        }
    }

    public final void v0() {
        if (this.f37635y != null && this.actionBar != null) {
            this.K.setColor(getThemedColor(org.telegram.ui.ActionBar.j6.f18934h5));
            ...
            if (q20Var != null) {
                ...
                if (this.M) {
                    ...
                    ((org.telegram.ui.Components.c90) this.f37635y.f36785c).setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i11, false));
                    ((org.telegram.ui.Components.c90) this.f37635y.f36785c).setLinkTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.gc, false));
                } else {
                    textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
                    ((org.telegram.ui.Components.c90) this.f37635y.f36785c).setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
                    ((org.telegram.ui.Components.c90) this.f37635y.f36785c).setLinkTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.gc, false));
                }
            }
            u0();
