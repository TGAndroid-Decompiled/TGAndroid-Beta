...
public final class t20 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        int i11;
        String string;
        int i12 = this.f37551a;
        int i13 = 0;
        i60 i60Var = this.f37552b;
        switch (i12) {
            case 0:
                org.telegram.ui.ActionBar.v0 v0Var = i60Var.f34370k1;
                org.telegram.ui.ActionBar.f1 f1Var = i60Var.f34415v1;
                org.telegram.ui.ActionBar.f1 f1Var2 = i60Var.f34411u1;
                org.telegram.ui.ActionBar.f1 f1Var3 = i60Var.f34389p1;
                ChatObject.Call call = i60Var.f34329a1;
                if (call != null && !i60Var.a2.f29354b) {
                    if (call.call.join_muted) {
                        int i14 = org.telegram.ui.ActionBar.j6.f19142hg;
                        ...
                        int i15 = org.telegram.ui.ActionBar.j6.f19419wg;
                        ...
                        int i16 = org.telegram.ui.ActionBar.j6.f19419wg;
                        ...
                        int i17 = org.telegram.ui.ActionBar.j6.f19142hg;
            ...
            case 1:
                if (i60Var.r1()) {
                    if (sf.c.a(i60Var.f34362i0) > 0) {
                        org.telegram.ui.Components.voip.j1.n(i60Var.f34362i0);
                        i60Var.dismiss();
                        return;
                    }
                    org.telegram.ui.Components.e5.B(i60Var.f34362i0, null, true).o();
                    return;
                } else if (AndroidUtilities.checkInlinePermissions(i60Var.f34362i0)) {
            ...
            case 2:
                ...
                if (sharedInstance != null) {
                    ...
                    LaunchActivity launchActivity = i60Var.f34362i0;
                    if (launchActivity != null) {
                        i60Var.f34362i0.startActivityForResult(((MediaProjectionManager) launchActivity.getSystemService("media_projection")).createScreenCaptureIntent(), 520);
                        return;
                    }
                    return;
                }
            ...
            case 6:
                ...
                org.telegram.ui.Components.eu euVar = i60Var.H.f25450a;
                euVar.requestFocus();
            ...
            case 8:
                ...
                return;
            case 9:
                ChatObject.Call call5 = i60Var.f34329a1;
                ...
                if (sharedInstance2 != null && sharedInstance2.getVideoState(false) == 2) {
                    ...
                    for (int i18 = 0; i18 < arrayList.size(); i18++) {
                        ...
                        if (videoParticipant.participant.self && !videoParticipant.presentation) {
                            org.telegram.ui.Components.voip.p pVar = uVar.f29536a;
                            if (uVar.J0 == null) {
                                uVar.K0 = false;
                                ImageView imageView = uVar.f29567x0;
                                if (imageView == null) {
                                    uVar.f29567x0 = new ImageView(uVar.getContext());
                                } else {
                                ...
                                if (pVar.d.isFirstFrameRendered()) {
                                    ...
                                    if (bitmap != null) {
                                        ...
                                        uVar.f29567x0.setBackground(new BitmapDrawable(bitmap));
                                    }
                                    uVar.f29567x0.setAlpha(0.0f);
                                } else {
                                    uVar.f29567x0.setAlpha(1.0f);
                                }
                                if (uVar.f29567x0.getParent() == null) {
                                    pVar.addView(uVar.f29567x0);
                                }
                                ((FrameLayout.LayoutParams) uVar.f29567x0.getLayoutParams()).gravity = 17;
                                ...
                                uVar.J0.setInterpolator(org.telegram.ui.Components.qr.f27715f);
                                uVar.J0.start();
                            }
                        }
                    }
            ...
            default:
                ...
                i60Var.N1(true, true);
                i60Var.y3 = null;
                AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.x2(i60Var, i13, 16));
                return;
        }
    }
}
