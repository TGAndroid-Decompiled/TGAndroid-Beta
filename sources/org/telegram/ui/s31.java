...
public final class s31 extends FrameLayout {
    public int f37580a;
    public TLRPC.TL_channels_sponsoredMessageReportResultChooseOption f37581b;
    public TLRPC.TL_reportResultChooseOption f37582c;
    public TLRPC.TL_reportResultAddComment d;
    public final FrameLayout e;
    public final org.telegram.ui.Components.s61 f37583f;
    public final t5 h;
    public r31 f37584n;
    public FrameLayout f37585r;
    public ci.d f37586s;
    public final t31 v;
    ...
    public s31(t31 t31Var, Context context) {
        ...
        ((org.telegram.ui.ActionBar.f2) t5Var.f37967b).a(org.telegram.ui.ActionBar.h6.v0(i11, d6Var2));
        ...
        org.telegram.ui.Components.s61 s61Var = new org.telegram.ui.Components.s61(context, i10, 0, true, b5Var, ml0Var, null, d6Var4);
        this.f37583f = s61Var;
        s61Var.setClipToPadding(false);
        s61Var.X2.k1(true);
        s61Var.setOnScrollListener(new i3(this, 26));
    ...
    public final void a(int i10) {
        ...
        this.h.b(z10);
        org.telegram.ui.Components.s61 s61Var = this.f37583f;
        if (s61Var != null) {
            s61Var.Y2.N(true);
        }
    }
