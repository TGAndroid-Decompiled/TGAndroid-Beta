...
public final class u9 extends TextView {
    ...
    public u9(org.telegram.ui.Components.jn0 jn0Var, Context context) {
        super(context);
        this.e = jn0Var;
        this.f37975c = new Path();
        this.d = new RectF();
        this.f37974b = new Paint();
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.f37973a) {
            case 1:
                int l1 = org.telegram.ui.ActionBar.j6.l1(0.15f, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19065o6, ((org.telegram.ui.Components.jn0) this.e).f25360c));
                Paint paint = this.f37974b;
                paint.setColor(l1);
                RectF rectF = (RectF) this.d;
                rectF.set(0.0f, 0.0f, getWidth(), getHeight());
                Path path = this.f37975c;
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f37973a) {
            case 0:
                org.telegram.ui.Components.w80 w80Var = (org.telegram.ui.Components.w80) this.f37975c;
                if (w80Var != null) {
                    canvas.drawPath(w80Var, this.f37974b);
                }
                ...
                if (getText() instanceof Spanned) {
                    ...
                    if (n51VarArr != null && n51VarArr.length > 0) {
                        ...
                        for (int i14 = 0; i14 < n51VarArr.length; i14++) {
                            ...
                            ((org.telegram.ui.Components.w80) this.f37975c).d(getLayout(), spanStart, 0.0f);
                            if (getText() != null) {
                                i12 = getPaint().baselineShift;
                            } else {
                                i12 = 0;
                            }
                            org.telegram.ui.Components.w80 w80Var2 = (org.telegram.ui.Components.w80) this.f37975c;
                            if (i12 != 0) {
                                if (i12 > 0) {
                                    f7 = 5.0f;
                                } else {
                            ...
                            w80Var2.f29606o = i13;
                            getLayout().getSelectionPath(spanStart, spanEnd, (org.telegram.ui.Components.w80) this.f37975c);
                        }
                        ((org.telegram.ui.Components.w80) this.f37975c).f29605n = true;
                        return;
                    }
                    return;
                }
                    ...
                    if (lineLeft <= f10 && layout.getLineWidth(lineForVertical) + lineLeft >= f10 && y3 >= 0 && y3 <= layout.getHeight()) {
                        ...
                        if (clickableSpanArr.length != 0) {
                            ...
                            if (motionEvent.getAction() == 0) {
                                ...
                                int spanStart = spannable.getSpanStart(((org.telegram.ui.Components.d90) this.d).f23243i);
                                int spanEnd = spannable.getSpanEnd(((org.telegram.ui.Components.d90) this.d).f23243i);
