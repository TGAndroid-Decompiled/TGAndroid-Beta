...
public final class bc0 extends og.a {
    public final CharSequence f32371c;
    public final int d;
    public final int e;
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof bc0) {
                bc0 bc0Var = (bc0) obj;
                int i10 = bc0Var.f15700a;
                int i11 = this.f15700a;
                if (i10 == i11) {
                    if (i11 != 3 || bc0Var.d == this.d) {
                        if (i11 != 5 || bc0Var.f32372f == this.f32372f) {
                            if ((i11 != 3 && i11 != 4) || bc0Var.e == this.e) {
                                if ((i11 == 0 || i11 == 2 || i11 == 3 || i11 == 4 || i11 == 5) && !TextUtils.equals(bc0Var.f32371c, this.f32371c)) {
                                    return false;
                                }
                                return true;
                            }
