...
public final class bc0 extends og.a {
    public final CharSequence f32385c;
    public final int d;
    public final int e;
            ...
            if (obj instanceof bc0) {
                ...
                if (i10 == i11) {
                    if (i11 != 3 || bc0Var.d == this.d) {
                        if (i11 != 5 || bc0Var.f32386f == this.f32386f) {
                            if ((i11 != 3 && i11 != 4) || bc0Var.e == this.e) {
                                if ((i11 == 0 || i11 == 2 || i11 == 3 || i11 == 4 || i11 == 5) && !TextUtils.equals(bc0Var.f32385c, this.f32385c)) {
                                    return false;
                                }
                                return true;
                            }
