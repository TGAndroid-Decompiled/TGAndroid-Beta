...
public final class le1 extends Dialog {
    ...
    public float Y;
    public boolean Z;
    public final org.telegram.ui.ActionBar.f6 f38315a;
    public boolean f38316a0;
    public final ie1 f38317b;
    public boolean f38318b0;
    public final ie1 f38319c;
    public zm f38320c0;
    public final ie1 d;
    public ValueAnimator f38321d0;
    public final di.i1 f38322e;
    public ValueAnimator f38323e0;
    public final TextView f38324f;
    public final org.telegram.ui.Components.ub0 h;
    public i0.c f38325n;
    public Bitmap f38326r;
    public BitmapShader f38327s;
    public Paint v;
    public Matrix f38328w;
    public float f38329x;
    public float f38330y;

    public le1(Activity activity, org.telegram.ui.ActionBar.f6 f6Var) {
        super(activity, R.style.TransparentDialog);
        this.f38325n = i0.c.f11424e;
        this.L = 0.0f;
        this.M = 0.0f;
        this.R = -1.0f;
        this.T = -1.0f;
    ...
    public final void b(boolean z10, org.telegram.ui.Components.mr0 mr0Var) {
        float f7;
        long j3;
        ValueAnimator valueAnimator = this.f38321d0;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ValueAnimator valueAnimator2 = this.f38323e0;
        if (valueAnimator2 != null) {
            valueAnimator2.cancel();
        }
        d();
        float f10 = this.f38329x;
        float f11 = 0.0f;
        if (z10) {
            f7 = 1.0f;
        } else {
        ...
        this.f38321d0 = ofFloat;
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
            public final le1 f36012b;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                switch (r2) {
                    case 0:
                        ...
                        le1 le1Var = this.f36012b;
                        le1Var.f38329x = floatValue;
                        le1Var.f38317b.invalidate();
                        le1Var.f38319c.invalidate();
                        le1Var.e();
                        return;
                    default:
                        le1 le1Var2 = this.f36012b;
                        le1Var2.getClass();
                        le1Var2.f38330y = ((Float) valueAnimator3.getAnimatedValue()).floatValue();
                        return;
                }
            }
        });
        this.f38321d0.addListener(new ah.r0(this, z10, mr0Var, 12));
        if (!z10) {
            j3 = 330;
        } else {
            j3 = 520;
        }
        ValueAnimator valueAnimator3 = this.f38321d0;
        org.telegram.ui.Components.pr prVar = org.telegram.ui.Components.pr.h;
        valueAnimator3.setInterpolator(prVar);
        this.f38321d0.setDuration(j3);
        this.f38321d0.start();
        float f12 = this.f38330y;
        if (z10) {
            f11 = 1.0f;
        }
        ValueAnimator ofFloat2 = ValueAnimator.ofFloat(f12, f11);
        this.f38323e0 = ofFloat2;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator32) {
                switch (r2) {
                    ...
                    default:
                        le1 le1Var2 = this.f36012b;
                        le1Var2.getClass();
                        le1Var2.f38330y = ((Float) valueAnimator32.getAnimatedValue()).floatValue();
                        return;
                }
            }
        });
        this.f38323e0.addListener(new e50(11, this, z10));
        this.f38323e0.setDuration(((float) j3) * 1.5f);
        this.f38323e0.setInterpolator(prVar);
        this.f38323e0.start();
    }
    ...
    public final void c(boolean z10) {
        ...
        if (z10 && (fk0Var = this.P) != null && fk0Var.getReactionsWindow() != null && !this.P.getReactionsWindow().f699q) {
            this.P.e();
        } else if (this.f38316a0) {
        } else {
            this.f38316a0 = true;
            this.W = false;
            di.i1 i1Var = this.f38322e;
            i1Var.l();
    ...
    public final void e() {
        ...
        if (viewGroup2 != null) {
            ...
            this.S.setAlpha(this.f38329x);
            float lerp3 = AndroidUtilities.lerp(0.75f, 1.0f, this.f38329x);
        ...
        if (this.Q != null) {
            ...
            this.Q.setAlpha(this.f38329x);
            float lerp4 = AndroidUtilities.lerp(0.75f, 1.0f, this.f38329x);
            this.Q.setScaleX(lerp4);
            this.Q.setScaleY(lerp4);
        }
        if (this.f38318b0) {
            this.J.setAlpha(this.f38329x);
            this.I.setAlpha(this.f38329x);
        }
        if (this.P != null) {
