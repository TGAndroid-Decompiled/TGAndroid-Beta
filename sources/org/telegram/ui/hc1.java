...
public final class hc1 extends FrameLayout {
    public final org.telegram.ui.Cells.ia f36980a;
    public final org.telegram.ui.Components.fo0 f36981b;
    public final int f36982c;
    public final int d;
    public final TextPaint f36983e;
    public int f36984f;
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        this.f36981b.getSeekBarAccessibilityDelegate().e(this, accessibilityNodeInfo);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f36984f != size) {
            int i12 = SharedConfig.fontSize;
            int i13 = this.f36982c;
            this.f36981b.setProgress((i12 - i13) / (this.d - i13));
            this.f36984f = size;
        }
    }
    ...
    public final boolean performAccessibilityAction(int i10, Bundle bundle) {
        if (!super.performAccessibilityAction(i10, bundle) && !this.f36981b.getSeekBarAccessibilityDelegate().g(this, i10, bundle)) {
            return false;
        }
        return true;
    }
