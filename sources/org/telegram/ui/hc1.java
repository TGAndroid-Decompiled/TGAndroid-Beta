...
public final class hc1 extends FrameLayout {
    public final org.telegram.ui.Cells.ia f36953a;
    public final org.telegram.ui.Components.fo0 f36954b;
    public final int f36955c;
    public final int d;
    public final TextPaint f36956e;
    public int f36957f;
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        this.f36954b.getSeekBarAccessibilityDelegate().e(this, accessibilityNodeInfo);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f36957f != size) {
            int i12 = SharedConfig.fontSize;
            int i13 = this.f36955c;
            this.f36954b.setProgress((i12 - i13) / (this.d - i13));
            this.f36957f = size;
        }
    }
    ...
    public final boolean performAccessibilityAction(int i10, Bundle bundle) {
        if (!super.performAccessibilityAction(i10, bundle) && !this.f36954b.getSeekBarAccessibilityDelegate().g(this, i10, bundle)) {
            return false;
        }
        return true;
    }
