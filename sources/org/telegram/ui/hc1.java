...
public final class hc1 extends org.telegram.ui.Components.ll0 {
    ...
    public final int j(int i10) {
        ...
        if (i10 != themeActivity.f31567a0 && i10 != themeActivity.K && i10 != themeActivity.f31569b0 && i10 != themeActivity.Y && i10 != themeActivity.P && i10 != themeActivity.Q && i10 != themeActivity.M && i10 != themeActivity.L) {
            if (i10 != themeActivity.f31575f0 && i10 != themeActivity.Z && i10 != themeActivity.f31593v0 && i10 != themeActivity.A0 && i10 != themeActivity.G0) {
                if (i10 != themeActivity.f31588r0 && i10 != themeActivity.V && i10 != themeActivity.f31571c0 && i10 != themeActivity.O && i10 != themeActivity.f31577h0 && i10 != themeActivity.f31583n0 && i10 != themeActivity.f31580k0 && i10 != themeActivity.J && i10 != themeActivity.I0 && i10 != themeActivity.f31600z0 && i10 != themeActivity.B0 && i10 != themeActivity.C0 && i10 != themeActivity.D0) {
                    if (i10 != themeActivity.R && i10 != themeActivity.S && i10 != themeActivity.T && i10 != themeActivity.U) {
                        if (i10 != themeActivity.W && i10 != themeActivity.f31572d0 && i10 != themeActivity.f31576g0 && i10 != themeActivity.f31596x && i10 != themeActivity.f31578i0 && i10 != themeActivity.f31594w && i10 != themeActivity.f31581l0 && i10 != themeActivity.f31579j0 && i10 != themeActivity.f31591t0 && i10 != themeActivity.f31595w0 && i10 != themeActivity.H0 && i10 != themeActivity.E0 && i10 != themeActivity.F0) {
                            if (i10 == themeActivity.f31573e0) {
                                return 6;
                            }
                            if (i10 != themeActivity.X && i10 != themeActivity.G && i10 != themeActivity.E) {
                                ...
                                if (i10 != i11) {
                                    ...
                                    if (i10 != i12 && i10 != themeActivity.f31598y && i10 != themeActivity.f31590s0) {
                                            ...
                                            if (i10 != i14) {
                                                ...
                                                if (i10 != themeActivity.m0) {
                                                    ...
                                                    if (i10 != i16) {
                                                        ...
                                                        if (i10 != i17) {
                                                            if (i10 == themeActivity.f31584o0) {
                                                                return 11;
                                                            }
                                                            if (i10 != themeActivity.f31586q0) {
                                                                i18 = themeActivity.bubbleRadiusRow;
                                                                if (i10 != i18) {
                                                                    i19 = themeActivity.backgroundRow;
                                                                    if (i10 != i19 && i10 != themeActivity.f31599y0) {
                                                                        ...
                                                                        if (i10 != i20) {
                                                                            ...
                                                                            if (i10 != i21) {
                                                                                ...
                                                                                if (i10 != i22) {
                                                                                    if (i10 == themeActivity.f31592u0) {
                                                                                        return 15;
                                                                                    }
                                                                                    if (i10 == themeActivity.f31597x0) {
                                                                                        return 16;
                                                                                    }
                                                                                    if (i10 == themeActivity.f31585p0) {
                                                                                        return 17;
                                                                                    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i24 != 1) {
                    ...
                    if (i24 != 5) {
                        if (i24 != 6) {
                                            ...
                                            if (i24 != 21) {
                                                switch (i24) {
                                                    case 10:
                                                        ...
                                                        if (z11) {
                                                            int i25 = org.telegram.ui.ActionBar.j6.f19058o;
                                                            if (i25 == 1) {
                                                    ...
                                                    case 11:
                                                        if (this.d) {
                                                            themeActivity.f31570c.y1(themeActivity.f31568b.getMeasuredWidth());
                                                            this.d = false;
                                                            return;
                                                        }
                                                        return;
                                                    case 12:
                                                        ...
                                                        if (indexOf != -1) {
                                                            ((s4.c0) ml0Var.getLayoutManager()).h1(indexOf, (themeActivity.f31568b.getMeasuredWidth() / 2) - AndroidUtilities.dp(42.0f));
                                                            return;
                                                        }
                                                        return;
                                                    default:
                            ...
                            if (i10 == themeActivity.X) {
                                w8Var.f(LocaleController.getString("AutoNightLocation", R.string.AutoNightLocation), org.telegram.ui.ActionBar.j6.f19076p, true);
                                return;
                        ...
                        ((org.telegram.ui.Cells.k0) view).setProgress(org.telegram.ui.ActionBar.j6.f19094q);
                        return;
                    }
            ...
            if (i10 == themeActivity.f31575f0) {
                e9Var.setText(LocaleController.formatString("AutoNightBrightnessInfo", R.string.AutoNightBrightnessInfo, Integer.valueOf((int) (org.telegram.ui.ActionBar.j6.f19094q * 100.0f))));
                return;
            } else if (i10 == themeActivity.Z) {
                e9Var.setText(ThemeActivity.y0());
                return;
            } else if (i10 == themeActivity.f31593v0) {
        ...
        if (i10 == i11) {
            if (org.telegram.ui.ActionBar.j6.f19058o != 0 && org.telegram.ui.ActionBar.j6.J != null) {
        ...
        } else if (i10 == themeActivity.f31567a0) {
            int i30 = org.telegram.ui.ActionBar.j6.f19112r;
            int i31 = i30 / 60;
        ...
        } else if (i10 == themeActivity.f31569b0) {
            int i32 = org.telegram.ui.ActionBar.j6.f19131s;
            int i33 = i32 / 60;
            ...
            eaVar.c(LocaleController.getString("AutoNightUpdateLocation", R.string.AutoNightUpdateLocation), org.telegram.ui.ActionBar.j6.f19204w, false, false);
            ...
            eaVar.c(LocaleController.getString(R.string.SearchEngine), org.telegram.ui.web.o1.a().f38894a, themeActivity.P0, false);
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 9:
                ...
                frameLayout.f33098b = new org.telegram.ui.Cells.y0[2];
                ...
                int i21 = 0;
                while (true) {
                    ?? r32 = (org.telegram.ui.Cells.y0[]) frameLayout.f33098b;
                    if (i21 >= r32.length) {
                        i5Var = frameLayout;
                        break;
                    } else {
                        ...
                        frameLayout2.f21660c = new RectF();
                        TextPaint textPaint = new TextPaint(1);
                        frameLayout2.d = textPaint;
                        frameLayout2.setWillNotDraw(false);
                        frameLayout2.f21659b = z10;
                        if (z10) {
                        ...
                        org.telegram.ui.Cells.y0 y0Var = ((org.telegram.ui.Cells.y0[]) frameLayout.f33098b)[i21];
                        if (i21 == 1) {
                            i14 = 10;
                        } else {
                            i14 = 0;
                        ...
                        ((org.telegram.ui.Cells.y0[]) frameLayout.f33098b)[i21].setOnClickListener(new ai.j3(3, frameLayout, z10));
                        i21++;
                    }
                }
                break;
            case 10:
                i5Var = new org.telegram.ui.Cells.i5(21, 60, this.f34240c, null, true);
                break;
            case 11:
                this.d = true;
                ec1 ec1Var = new ec1(this, this.f34240c, themeActivity, themeActivity.f31574f, themeActivity.e, themeActivity.d);
                themeActivity.f31570c = ec1Var;
                ec1Var.setDrawDivider(themeActivity.v);
                themeActivity.f31570c.setFocusable(false);
                View view = themeActivity.f31570c;
            ...
            case 15:
                ...
                frameLayout3.f28515a = paint;
                frameLayout3.f28516b = new Paint(1);
                Paint paint2 = new Paint(1);
                frameLayout3.f28517c = paint2;
                Paint paint3 = new Paint(1);
                frameLayout3.d = paint3;
                frameLayout3.e = new RectF();
                int i22 = 6;
                frameLayout3.h = r14;
                frameLayout3.f28519n = r15;
                frameLayout3.f28520r = new org.telegram.ui.Components.yi0[6];
                frameLayout3.v = new org.telegram.ui.Components.bj0[2];
                float f11 = 1.0f;
                frameLayout3.f28523x = 1.0f;
                ...
                int i23 = org.telegram.ui.ActionBar.j6.f18848c9;
                int[] iArr = {i23, i23, i23, i23, org.telegram.ui.ActionBar.j6.Y5, org.telegram.ui.ActionBar.j6.f18866d9};
                ...
                org.telegram.ui.Components.ty0 ty0Var = new org.telegram.ui.Components.ty0(frameLayout3, context);
                frameLayout3.f28518f = ty0Var;
                ...
                ty0Var.setMaxValue(i18);
                if (isEmpty) {
                    i22 = 5;
                }
                ty0Var.setAllItemsCount(i22);
                ty0Var.setWrapSelectorWheel(true);
                ty0Var.setFormatter(new org.telegram.ui.Components.sy0(frameLayout3));
                ty0Var.setOnValueChangedListener(new org.telegram.ui.Components.sy0(frameLayout3));
                ty0Var.setImportantForAccessibility(2);
                ty0Var.setValue(SharedConfig.getChatSwipeAction(i15));
                frameLayout3.addView(ty0Var, w7.x5.d(132, -1.0f, 5, 21.0f, 0.0f, 21.0f, 0.0f));
                frameLayout3.setWillNotDraw(false);
                frameLayout3.f28521s = 0;
                ...
                org.telegram.ui.Components.yi0 a2 = frameLayout3.a(frameLayout3.f28518f.getValue());
                if (a2 != null) {
                ...
                if (frameLayout3.f28518f.getValue() != 5) {
                    f11 = 0.0f;
                }
                frameLayout3.f28522w = f11;
                frameLayout3.F = frameLayout3.f28518f.getValue();
                i5Var = frameLayout3;
                break;
            case 16:
                e5Var = ((org.telegram.ui.ActionBar.o2) themeActivity).parentLayout;
                View jaVar = new org.telegram.ui.Cells.ja(context, e5Var, 0);
                jaVar.setImportantForAccessibility(4);
                i5Var = jaVar;
                break;
            case 17:
                View hvVar = new hv(themeActivity.f31574f, context, themeActivity);
            ...
            case 20:
                ...
                ml0Var.setAdapter(new y7(ml0Var, 1));
            ...
            case 21:
                ...
                frameLayout = new hp0(i17, 0L, this.f34240c, themeActivity.getResourceProvider());
                i5Var = frameLayout;
                break;
        }
    ...
    public final void y(s4.c1 c1Var) {
        boolean z10;
        if (c1Var.f42705f == 4) {
            org.telegram.ui.Cells.ka kaVar = (org.telegram.ui.Cells.ka) c1Var.f42702a;
            if (c1Var.b() == org.telegram.ui.ActionBar.j6.f19058o) {
                z10 = true;
            } else {
                z10 = false;
            }
