...
public abstract class bg1 extends org.telegram.ui.Components.ga {
    public static final int f32159h3 = 0;
    public boolean f32160d3;
    public boolean f32161e3;
    public float f32162f3;
    public final dg1 f32163g3;

    public bg1(dg1 dg1Var, Context context) {
        super(context, null);
        this.f32163g3 = dg1Var;
        this.f32160d3 = true;
        new Paint();
        new RectF();
        this.f25950h1 = true;
    ...
    public final void addView(View view, int i10, ViewGroup.LayoutParams layoutParams) {
        ...
        view.setTranslationY(this.f32162f3);
    ...
    public final void dispatchDraw(Canvas canvas) {
        dg1 dg1Var = this.f32163g3;
        if (dg1Var.f33017b1 != null) {
            canvas.save();
            canvas.translate(dg1Var.f33017b1.getLeft(), dg1Var.f33017b1.getY());
            dg1Var.f33017b1.draw(canvas);
            canvas.restore();
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        y1();
        if (this.f32163g3.f33017b1 == view) {
            return true;
        }
    ...
    public final void onDraw(Canvas canvas) {
        dg1 dg1Var = this.f32163g3;
        if (dg1Var.f33052w != null && this.f32162f3 != 0.0f) {
            int paddingTop = getPaddingTop();
            if (paddingTop != 0) {
                canvas.save();
                canvas.translate(0.0f, paddingTop);
            }
            dg1Var.f33052w.c(canvas, true);
            if (paddingTop != 0) {
                canvas.restore();
            }
        }
        ...
        if (!this.X1) {
            ...
            if (dg1Var.getParentLayout() == null || !((ActionBarLayout) dg1Var.getParentLayout()).y()) {
                ...
                if (action == 1 || action == 3) {
                    hf1 hf1Var = dg1Var.O;
                    if (hf1Var.f42824y != 0 && dg1Var.P.d && hf1Var.g(null, 4) != 0) {
                        dg1Var.P.getClass();
                    }
                }
                boolean onTouchEvent = super.onTouchEvent(motionEvent);
                if ((action == 1 || action == 3) && dg1Var.f33056y == 2 && dg1Var.f33054x > 0 && (L0 = (c0Var = (s4.c0) getLayoutManager()).L0()) == 0) {
                    int paddingTop = getPaddingTop();
                    View m10 = c0Var.m(L0);
                    ...
                    float f10 = this.f32162f3;
                    if (f10 != 0.0f) {
                        ValueAnimator ofFloat = ValueAnimator.ofFloat(f10, 0.0f);
                        ofFloat.addUpdateListener(new z11(this, 19));
                        ofFloat.setDuration(Math.max(100L, org.telegram.messenger.wl.c(this.f32162f3, AndroidUtilities.dp(72.0f), 120.0f, 350.0f)));
