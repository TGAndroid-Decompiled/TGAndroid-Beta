...
public final class y6 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public r6 f40059a;
    public final org.telegram.ui.ActionBar.d6 f40060b;
    ...
    public boolean h;
    public org.telegram.ui.Components.pp f40063n;
    ...
    public y6(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        this.e = w9Var;
        w9Var.getAvatarDrawable().f24716p = 0.8f;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        TextView textView;
        if (i10 == NotificationCenter.emojiLoaded && (textView = this.f40061c) != null) {
            textView.invalidate();
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        sb2.append((Object) this.f40061c.getText());
    ...
    public final void onMeasure(int i10, int i11) {
        setMeasuredDimension(View.MeasureSpec.getSize(i10), AndroidUtilities.dp(50.0f) + (this.f40062f ? 1 : 0));
        ...
        org.telegram.ui.Components.pp ppVar = this.f40063n;
        if (ppVar != null) {
