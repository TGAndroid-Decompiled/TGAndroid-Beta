...
public final class y6 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public s6 f39762a;
    public final org.telegram.ui.ActionBar.e6 f39763b;
    public final TextView f39764c;
    public final org.telegram.ui.Components.n6 d;
    public final org.telegram.ui.Components.u9 e;
    public boolean f39765f;
    public boolean h;
    public org.telegram.ui.Components.np f39766n;
    ...
    public y6(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        addView(n6Var, w7.x5.d(-2, -1.0f, i15, f11, 0.0f, f12, 0.0f));
        org.telegram.ui.Components.u9 u9Var = new org.telegram.ui.Components.u9(context);
        this.e = u9Var;
        u9Var.getAvatarDrawable().f23866p = 0.8f;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        TextView textView;
        if (i10 == NotificationCenter.emojiLoaded && (textView = this.f39764c) != null) {
            textView.invalidate();
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        sb2.append((Object) this.f39764c.getText());
    ...
    public final void onMeasure(int i10, int i11) {
        setMeasuredDimension(View.MeasureSpec.getSize(i10), AndroidUtilities.dp(50.0f) + (this.f39765f ? 1 : 0));
        int measuredWidth = ((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight()) - AndroidUtilities.dp(34.0f);
        int i12 = measuredWidth / 2;
        org.telegram.ui.Components.u9 u9Var = this.e;
        if (u9Var.getVisibility() == 0) {
            u9Var.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(38.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(38.0f), 1073741824));
        }
        org.telegram.ui.Components.n6 n6Var = this.d;
        ...
        boolean z10 = LocaleController.isRTL;
        TextView textView = this.f39764c;
        if (z10) {
        ...
        org.telegram.ui.Components.np npVar = this.f39766n;
        if (npVar != null) {
