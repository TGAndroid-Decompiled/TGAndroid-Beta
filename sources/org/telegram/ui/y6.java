...
public final class y6 extends og.b {
    ...
    @Override
    public final int h() {
        return this.e.f31743e0.size();
    }

    @Override
    public final int j(int i10) {
        return ((v6) this.e.f31743e0.get(i10)).f15543a;
    }
            ...
            if (i12 != 1) {
                if (i12 != 2) {
                    if (i12 != 3) {
                        if (i12 != 7) {
                            switch (i12) {
                                ...
                                case 11:
                                    ...
                                    String formatFileSize = AndroidUtilities.formatFileSize(v6Var.f38306g);
                                    if (v6Var.f38305f >= 0 ? !v6Var.f38308j : !a7Var.L) {
                                        z11 = true;
                                    } else {
                                        z11 = false;
                                    }
                                    ...
                                    int i17 = v6Var.h;
                                    int i18 = org.telegram.ui.ActionBar.j6.f18992k7;
                                    org.telegram.ui.Components.np npVar = z1Var.f21688r;
                                    if (npVar != null) {
                                        npVar.b(i17, i17, i18);
                                    }
                                    if (v6Var.f38305f < 0) {
                                    ...
                                    z1Var.setPad(v6Var.f38307i ? 1 : 0);
                                    return;
                                default:
                                    return;
                            }
                        ...
                        int i19 = v6Var.f38304c;
                        int size = cacheByChatsController.getKeepMediaExceptions(((v6) arrayList.get(i10)).f38304c).size();
                        if (size > 0) {
                        ...
                        if (((v6) arrayList.get(i10)).f38304c == 0) {
                        ...
                        } else if (((v6) arrayList.get(i10)).f38304c == 1) {
                        ...
                        } else if (((v6) arrayList.get(i10)).f38304c == 2) {
                        ...
                        } else if (((v6) arrayList.get(i10)).f38304c == 3) {
                ...
                View view2 = gy0Var.f24425w;
                TextView textView = gy0Var.f24422n;
                TextView textView2 = gy0Var.h;
                TextView textView3 = gy0Var.v;
                org.telegram.ui.Cells.ea eaVar = gy0Var.f24427y;
                gy0Var.e = z14;
                TextView textView4 = gy0Var.f24423r;
                ...
                TextView textView5 = gy0Var.f24424s;
                long j16 = j15 - j14;
        ...
        if (i10 != 0) {
            ...
            switch (i10) {
                case 2:
                    ...
                    frameLayout.f24418a = paint;
                    Paint paint2 = new Paint(1);
                    Paint paint3 = new Paint(1);
                    frameLayout.f24419b = paint3;
                    Paint paint4 = new Paint(1);
                    frameLayout.f24420c = paint4;
                    ...
                    frameLayout.f24422n = textView3;
                    textView3.setCompoundDrawablePadding(AndroidUtilities.dp(6.0f));
                    textView3.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i12, false));
                    TextView textView4 = new TextView(context);
                    frameLayout.f24423r = textView4;
                    textView4.setCompoundDrawablePadding(AndroidUtilities.dp(6.0f));
                    textView4.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i12, false));
                    TextView textView5 = new TextView(context);
                    frameLayout.f24424s = textView5;
                    textView5.setCompoundDrawablePadding(AndroidUtilities.dp(6.0f));
                    textView5.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i12, false));
                    frameLayout.f24426x = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.Vi, false);
                    textView2.setCompoundDrawablesWithIntrinsicBounds(org.telegram.ui.ActionBar.j6.K(AndroidUtilities.dp(10.0f), frameLayout.f24426x), (Drawable) null, (Drawable) null, (Drawable) null);
                    textView2.setCompoundDrawablePadding(AndroidUtilities.dp(6.0f));
                    textView4.setCompoundDrawablesWithIntrinsicBounds(org.telegram.ui.ActionBar.j6.K(AndroidUtilities.dp(10.0f), i0.a.k(frameLayout.f24426x, 64)), (Drawable) null, (Drawable) null, (Drawable) null);
                    textView4.setCompoundDrawablePadding(AndroidUtilities.dp(6.0f));
                    textView5.setCompoundDrawablesWithIntrinsicBounds(org.telegram.ui.ActionBar.j6.K(AndroidUtilities.dp(10.0f), i0.a.k(frameLayout.f24426x, 127)), (Drawable) null, (Drawable) null, (Drawable) null);
                    textView5.setCompoundDrawablePadding(AndroidUtilities.dp(6.0f));
                    textView3.setCompoundDrawablesWithIntrinsicBounds(org.telegram.ui.ActionBar.j6.K(AndroidUtilities.dp(10.0f), frameLayout.f24426x), (Drawable) null, (Drawable) null, (Drawable) null);
                    textView3.setCompoundDrawablePadding(AndroidUtilities.dp(6.0f));
                ...
                case 8:
                    ...
                    x6 x6Var2 = a7Var.M;
                    x6Var2.f37961x = true;
                    FrameLayout frameLayout3 = x6Var2.f37954b;
                    ...
                    a7Var.M.c(AndroidUtilities.dp(56.0f), a7Var.f31738b.getPaddingBottom());
                    ai.w0 w0Var = a7Var.f31738b;
                    if (w0Var != null) {
