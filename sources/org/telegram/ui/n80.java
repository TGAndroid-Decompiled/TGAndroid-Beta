...
public final class n80 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate, View.OnClickListener, le.d, ph.d {
    ...
    public final le.e f35973b;
    public org.telegram.ui.Components.y10 f35974c;
    public l80 d;
    public org.telegram.ui.ActionBar.w1 e;
    public m80 f35975f;
    public org.telegram.ui.Components.ml0 h;
    public s4.c0 f35976n;
    public org.telegram.ui.Components.zw0 f35977r;
    public j80 f35978s;
    public boolean v;
    public ArrayList f35979w;
    public int f35980x;
    ...
    public n80() {
        ...
        this.f35972a = i10;
        this.f35973b = new le.e(3, this, org.telegram.ui.Components.qr.h, 350L, AndroidUtilities.dp(37.0f));
        this.F = new HashMap();
    ...
    public static void U(n80 n80Var, View view, int i10) {
        ...
        if (i10 == 0 && !n80Var.E) {
            ...
            if (m30Var != null) {
                ...
                m80 m80Var = n80Var.f35975f;
                ArrayList arrayList = m80Var.f35708c;
                n80 n80Var2 = m80Var.h;
                n80Var2.G.add(m30Var2);
                n80Var2.F.put(m30Var2.getKey(), m30Var2);
                AnimatorSet animatorSet = m80Var.f35706a;
                if (animatorSet != null) {
                    animatorSet.setupEndValues();
                    m80Var.f35706a.cancel();
                }
                m80Var.f35707b = false;
                AnimatorSet animatorSet2 = new AnimatorSet();
                m80Var.f35706a = animatorSet2;
                animatorSet2.addListener(new org.telegram.ui.Components.w81(m80Var, 23));
                m80Var.f35706a.setInterpolator(org.telegram.ui.Components.qr.h);
                m80Var.f35706a.setDuration(320L);
                m80Var.d = m30Var2;
                arrayList.clear();
    ...
    public final void Y() {
        ...
        if (Build.VERSION.SDK_INT >= 31 && (iVar = this.L) != null) {
            ...
            this.P.set(0.0f, -dp, this.fragmentView.getMeasuredWidth(), this.actionBar.getMeasuredHeight() + dp + AndroidUtilities.dp(48.0f) + this.f35980x);
            iVar.g(1, this.O);
    ...
    public final void Z() {
        org.telegram.ui.Components.y10 y10Var = this.f35974c;
        if (y10Var != null) {
    ...
    public final void a0() {
        this.h.setPadding(0, AndroidUtilities.dp(4.0f) + this.actionBar.getMeasuredHeight() + AndroidUtilities.dp(this.f35972a) + ((int) this.f35973b.e), 0, this.J);
        this.f35977r.setPadding(0, 0, 0, this.J);
    }
    ...
    public final View createView(Context context) {
        ...
        this.f35977r.setAnimateLayoutChange(true);
        this.f35977r.d.setText(LocaleController.getString(R.string.NoContacts));
        this.f35977r.e.setText("");
        this.f35977r.e(ContactsController.getInstance(this.currentAccount).isLoadingContacts(), true);
        int i12 = org.telegram.ui.ActionBar.j6.f18807a7;
        j0Var.setBackgroundColor(getThemedColor(i12));
        j0Var.addView(this.f35977r);
        this.f35976n = new s4.c0(1, false);
        this.f35978s = new j80(this, context);
        org.telegram.ui.Components.ml0 ml0Var = new org.telegram.ui.Components.ml0(context, null);
        this.h = ml0Var;
        ml0Var.setSections(true);
        this.h.setEmptyView(this.f35977r);
        this.h.setAdapter(this.f35978s);
        this.h.setLayoutManager(this.f35976n);
        ...
        j0Var.addView(this.h, w7.x5.d(-1, -1.0f, 119, 0.0f, -this.f35972a, 0.0f, 0.0f));
        ...
        this.f35974c = y10Var;
        y10Var.f30078c.setImageDrawable(h2Var);
        this.f35974c.e(false, false);
        this.f35974c.setContentDescription(LocaleController.getString(R.string.Next));
        this.f35974c.setOnClickListener(new m60(this, 4));
        ...
        j80 j80Var = this.f35978s;
        if (j80Var != null && !this.E) {
            int h = j80Var.h();
            org.telegram.ui.Components.zw0 zw0Var2 = this.f35977r;
            if (h != 2) {
                i10 = 4;
            }
            zw0Var2.setVisibility(i10);
        }
        j0Var.addView(this.f35974c, org.telegram.ui.Components.y10.b());
    ...
    public final void d0() {
        ...
        this.f35979w = arrayList;
        Collections.sort(arrayList, new ff(22));
        org.telegram.ui.Components.zw0 zw0Var = this.f35977r;
        if (zw0Var != null) {
            zw0Var.e(false, true);
        }
        j80 j80Var = this.f35978s;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.contactsImported) {
            d0();
        } else if (i10 == NotificationCenter.contactsDidLoad && (zw0Var = this.f35977r) != null) {
            zw0Var.e(false, true);
        }
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.h, 32768, null, null, null, null, org.telegram.ui.ActionBar.j6.f19140s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.h, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f18953i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.h, 33554432, null, null, null, null, org.telegram.ui.ActionBar.j6.f19010l7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.h, 33554432, null, null, null, null, org.telegram.ui.ActionBar.j6.f19029m7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.h, 33554432, null, null, null, null, org.telegram.ui.ActionBar.j6.f19049n7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.h, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f18985k0, null, null, org.telegram.ui.ActionBar.j6.f18864d7));
        ...
        int i10 = org.telegram.ui.ActionBar.j6.f18818ai;
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.h, 4, new Class[]{org.telegram.ui.Cells.o4.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f18954i7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.h, 4, new Class[]{org.telegram.ui.Cells.o4.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f18992k7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.h, 262148, new Class[]{org.telegram.ui.Cells.o4.class}, new String[]{"statusTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19048n6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.h, 262148, new Class[]{org.telegram.ui.Cells.o4.class}, new String[]{"statusTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19245y6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.h, 0, new Class[]{org.telegram.ui.Cells.o4.class}, null, org.telegram.ui.ActionBar.j6.f19113r0, null, org.telegram.ui.ActionBar.j6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35975f, 0, new Class[]{org.telegram.ui.Components.m30.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18856ci));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35975f, 0, new Class[]{org.telegram.ui.Components.m30.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18837bi));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35975f, 0, new Class[]{org.telegram.ui.Components.m30.class}, null, null, null, org.telegram.ui.ActionBar.j6.f18875di));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35975f, 0, new Class[]{org.telegram.ui.Components.m30.class}, null, null, null, i11));
        return arrayList;
    }
    ...
    public final void onClick(View view) {
        ...
        if (m30Var.f26041y) {
            this.H = null;
            this.f35975f.a(m30Var);
            this.f35974c.e(!this.G.isEmpty(), true);
            c0();
            return;
        }
