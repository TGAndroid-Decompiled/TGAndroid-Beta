...
public final class bo implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        switch (this.f32441a) {
            case 0:
                final ro roVar = (ro) this.f32443c;
                ...
                if (!zArr[0]) {
                    ...
                    boostsController.getBoostsStats(j3, new Utilities.Callback() {
                        ...
                        public final void run(Object obj) {
                            ...
                            ro roVar2 = ro.this;
                            TLRPC.Chat chat = roVar2.f37407x0;
                            int i11 = chat.level;
                            int i12 = tL_premium_boostsStatus.level;
                            if (i11 != i12) {
                                chat.level = i12;
                                roVar2.getMessagesController().putChat(roVar2.f37407x0, false);
                            }
                            ...
                            tL_channels_toggleAutotranslation.channel = MessagesController.getInputChannel(roVar2.f37407x0);
                ...
                return;
            case 1:
                ((org.telegram.ui.ActionBar.a2[]) this.f32443c)[0].dismiss();
                ((org.telegram.ui.Components.cs) this.d).run(-this.f32442b);
                return;
            case 2:
                ((org.telegram.ui.ActionBar.a2[]) this.f32443c)[0].dismiss();
                ((org.telegram.ui.Components.cs) this.d).run(-this.f32442b);
                return;
            case 3:
                org.telegram.ui.Components.m70.N((org.telegram.ui.Components.m70) this.f32443c, (Context) this.d, this.f32442b);
                return;
            case 4:
                qy qyVar = (qy) this.f32443c;
                ...
                return;
            case 5:
                oo0 oo0Var = (oo0) this.f32443c;
                oo0Var.getClass();
                long longValue = ((Long) ((TextView) this.d).getTag()).longValue();
                Long l4 = oo0Var.H0;
                if (l4 != null && longValue == l4.longValue()) {
                    oo0Var.m0 = true;
                    oo0Var.f36274f[0].setText("");
                    oo0Var.m0 = false;
                    oo0Var.H0 = 0L;
                    oo0Var.L0();
                } else {
                    oo0Var.f36274f[0].setText(LocaleController.getInstance().formatCurrencyString(this.f32442b, false, true, true, oo0Var.C0.invoice.currency));
                }
                EditTextBoldCursor editTextBoldCursor = oo0Var.f36274f[0];
                editTextBoldCursor.setSelection(editTextBoldCursor.length());
                return;
            default:
                yh.x3.Y0((yh.x3) this.f32443c, (String) this.d, this.f32442b);
                return;
        }
    }
}
