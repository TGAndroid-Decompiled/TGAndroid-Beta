...
public abstract class c61 extends org.telegram.ui.Components.wl0 {
    ...
    public final ArrayList f32581a3;
    public final ArrayList f32582b3;
    public boolean f32583c3;
    public final LongSparseArray f32584d3;
    public final a71 f32585e3;

    public c61(a71 a71Var, Context context) {
        super(context, null);
        this.f32585e3 = a71Var;
        this.X2 = new SparseArray();
        this.Y2 = new ArrayList();
        this.Z2 = new ArrayList();
        this.f32581a3 = new ArrayList();
        this.f32582b3 = new ArrayList();
        this.f32584d3 = new LongSparseArray();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (getVisibility() == 0) {
                ...
                while (i14 < getChildCount()) {
                    ...
                    if (childAt instanceof j61) {
                        ...
                        if (j61Var.f34669w != null) {
                            ...
                            collectionParticles.a(canvas2, j61Var.f34669w.intValue());
                            canvas2.restore();
                            z12 = z14;
                        } else {
                            i10 = i14;
                        ...
                        if ((z15 || j61Var.M || j61Var.S > 0.0f) && !j61Var.f34663b) {
                            if (z15 || j61Var.M) {
                                float f14 = j61Var.R;
                                if (f14 < 1.0f) {
                        ...
                        i61 i61Var = j61Var.J;
                        if (i61Var != null && i61Var.getVisibility() == 0 && j61Var.J.getImageReceiver() == null && (imageReceiver2 = j61Var.f34667r) != null) {
                    ...
                    if (z10 && view != null) {
                        ...
                        List list = a71.Z1;
                        if (R == i18 - 1) {
                            float interpolation2 = org.telegram.ui.Components.rr.f28031g.getInterpolation(w7.q.a(((float) (SystemClock.elapsedRealtime() - a71Var.P1)) / 200.0f, 0.0f, 1.0f));
            ...
            ArrayList arrayList6 = this.f32582b3;
            arrayList6.clear();
            ArrayList arrayList7 = this.f32581a3;
                ...
                if (childAt2 instanceof j61) {
                    ...
                    if (i61Var2 != null && i61Var2.getVisibility() == 0) {
                        ...
                        if (drawable2 instanceof org.telegram.ui.Components.q5) {
                            imageReceiver = ((org.telegram.ui.Components.q5) drawable2).f27504k;
                        } else {
            ...
            Runnable runnable = zg.e0.f49292c;
            if (runnable != null) {
                runnable.run();
                zg.e0.f49292c = null;
            }
