...
public class kq extends org.telegram.ui.ActionBar.m2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public jq f35122a;
    public int f35123a0;
    public final boolean f35124a1;
    public ai.w0 f35125b;
    public int f35126b0;
    public ValueAnimator f35127b1;
    public gg.b0 f35128c;
    public int f35129c0;
    public ValueAnimator f35130c1;
    public FrameLayout d;
    public int f35131d0;
    public FrameLayout e;
    public int f35132e0;
    public org.telegram.ui.Components.p6 f35133f;
    public int f35134f0;
    public int f35135g0;
    ...
    public int f35152v0;
    public TLRPC.Chat f35153w;
    public int f35154w0;
    public TLRPC.ChatFull f35155x;
    public int f35156x0;
    public final int f35157y;
    public int f35158y0;
    public int f35159z0;
    ...
    public kq(long j3, long j10, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights, TLRPC.TL_chatBannedRights tL_chatBannedRights2, String str, int i10, boolean z10, boolean z11, String str2) {
        ...
        this.O0 = z37;
        this.Y0 = str2;
        this.f35153w = getMessagesController().getChat(Long.valueOf(this.f35148s));
        this.f35155x = getMessagesController().getChatFull(this.f35148s);
        ...
        this.S = str3;
        this.T = str3;
        this.F = ChatObject.isCommunity(this.f35153w);
        TLRPC.Chat chat2 = this.f35153w;
        if (chat2 != null) {
            if (ChatObject.isChannel(chat2) && !this.f35153w.megagroup) {
                z35 = true;
            } else {
                z35 = false;
            }
            this.E = z35;
            this.G = ChatObject.isForum(this.f35153w);
            this.N = this.f35153w.admin_rights;
        }
        if (this.N == null) {
            if (i10 == 2 && ((chat = this.f35153w) == null || !chat.creator)) {
                z34 = false;
            } else {
                z34 = true;
            }
    ...
    public static void U(kq kqVar, long j3) {
        if (j3 != 0) {
            kqVar.f35148s = j3;
            kqVar.f35153w = MessagesController.getInstance(kqVar.currentAccount).getChat(Long.valueOf(j3));
            kqVar.r0(true);
        }
    }
    ...
    public static boolean W(kq kqVar, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && "USER_PRIVACY_RESTRICTED".equals(tL_error.text)) {
            if (!ChatObject.isChannel(kqVar.f35153w)) {
                ...
                j0Var.I1(kqVar.f35153w, arrayList, null, null, null);
                j0Var.show();
            }
            return false;
        }
            ...
            if (kqVar.getParentActivity() != null) {
                if ("PASSWORD_HASH_INVALID".equals(tL_error.text)) {
                    if (inputCheckPasswordSRP == null) {
                        ...
                        a2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString(R.string.EditAdminTransferReadyAlertText, kqVar.f35153w.title, UserObject.getFirstName(user)));
    ...
    public static void Z(kq kqVar, long j3) {
        long j10;
        TLRPC.User user;
        TLRPC.ChatFull chatFull = kqVar.f35155x;
        if (chatFull != null) {
        ...
        if (user2 != null && j3 != 0 && user2.f18482id != j3) {
    ...
    public final View createView(Context context) {
        ...
        if (this.I || (!this.E && this.f35153w.creator && UserObject.isUserSelf(this.v))) {
            org.telegram.ui.ActionBar.y n10 = this.actionBar.n();
            Drawable mutate = context.getResources().getDrawable(R.drawable.ic_ab_done).mutate();
            int i12 = org.telegram.ui.ActionBar.h6.f19392v8;
        ...
        u7Var.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19003a7, false));
        ...
        this.f35128c = b0Var;
        b0Var.E = 100;
        this.f35125b.setLayoutManager(b0Var);
        ai.w0 w0Var2 = this.f35125b;
        jq jqVar = new jq(this, context);
        this.f35122a = jqVar;
        w0Var2.setAdapter(jqVar);
        s4.j jVar = new s4.j();
        if (i11 == 2) {
            this.f35125b.setResetSelectorOnChanged(false);
        }
        jVar.f42995m = false;
        jVar.C = false;
        jVar.o(org.telegram.ui.Components.rr.h);
        jVar.n(350L);
        this.f35125b.setItemAnimator(jVar);
        ai.w0 w0Var3 = this.f35125b;
        if (!LocaleController.isRTL) {
            i10 = 2;
        }
        w0Var3.setVerticalScrollbarPosition(i10);
        frameLayout.addView(this.f35125b, w7.y5.c(-1.0f, -1));
        this.f35125b.p1();
        this.actionBar.setAdaptiveBackground(this.f35125b);
        this.f35125b.setOnScrollListener(new i3(this, 6));
        this.f35125b.setOnItemClickListener(new ai.n6(7, this, context));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.chatInfoDidLoad) {
            ...
            TLRPC.Chat chat = this.f35153w;
            if (chat != null && chatFull.f18336id == chat.f18335id) {
                this.f35155x = chatFull;
                n0();
            }
        } else if (i10 == NotificationCenter.dialogDeleted) {
            if ((-this.f35148s) == ((Long) objArr[0]).longValue()) {
    ...
    public final ArrayList getThemeDescriptions() {
        ArrayList arrayList = new ArrayList();
        e eVar = new e(this, 9);
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35125b, 16, new Class[]{org.telegram.ui.Cells.ya.class, org.telegram.ui.Cells.ea.class, org.telegram.ui.Cells.v8.class, org.telegram.ui.Cells.m4.class, org.telegram.ui.Cells.c9.class, org.telegram.ui.Cells.d6.class}, null, null, null, org.telegram.ui.ActionBar.h6.f19059d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35125b, 32768, null, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35125b, 4096, null, null, null, null, org.telegram.ui.ActionBar.h6.f19148i6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35125b, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.h6.f19180k0, null, null, org.telegram.ui.ActionBar.h6.f19060d7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35125b, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.B6));
        int i11 = org.telegram.ui.ActionBar.h6.f19279p7;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35125b, 262144, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i11));
        int i12 = org.telegram.ui.ActionBar.h6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35125b, 262144, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35125b, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.I6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35125b, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"valueImageView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f19223m6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35125b, 0, new Class[]{org.telegram.ui.Cells.c9.class}, new String[]{"textView"}, null, null, -1, null, i12));
        int i13 = org.telegram.ui.ActionBar.h6.f19461z6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35125b, 0, new Class[]{org.telegram.ui.Cells.c9.class}, new String[]{"valueTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35125b, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35125b, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"valueTextView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35125b, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.U6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35125b, 0, new Class[]{org.telegram.ui.Cells.v8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.V6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35125b, 0, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.L6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35125b, 262144, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView2"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35125b, 262144, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView2"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.A6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35125b, 4, new Class[]{org.telegram.ui.Cells.d6.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35125b, 8388608, new Class[]{org.telegram.ui.Cells.d6.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.H6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35125b, 0, new Class[]{org.telegram.ui.Cells.ya.class}, new String[]{"nameTextView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35125b, 0, new Class[]{org.telegram.ui.Cells.ya.class}, new String[]{"statusColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.h6.f19442y6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35125b, 0, new Class[]{org.telegram.ui.Cells.ya.class}, new String[]{"statusOnlineColor"}, null, null, -1, eVar, org.telegram.ui.ActionBar.h6.f19243n6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f35125b, 0, new Class[]{org.telegram.ui.Cells.ya.class}, null, org.telegram.ui.ActionBar.h6.f19310r0, null, org.telegram.ui.ActionBar.h6.J7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(null, 0, new Class[]{org.telegram.ui.Cells.u2.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f19165j5));
        arrayList.add(new org.telegram.ui.ActionBar.j6(null, 0, new Class[]{org.telegram.ui.Cells.u2.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f19297q5));
        ...
        if (i10 != 2) {
            ...
            if (!equals) {
                if (z10) {
                    ...
                    org.telegram.ui.ActionBar.a2 a2Var = alertDialog$Builder.f18661a;
                    a2Var.R = string;
                    a2Var.T = AndroidUtilities.replaceTags(LocaleController.formatString("UserRestrictionsApplyChangesText", R.string.UserRestrictionsApplyChangesText, MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(this.f35148s)).title));
    ...
    public final void n0() {
        ...
        TLRPC.User user;
        long j3;
        int i10 = this.f35139k0;
        if (i10 >= 0) {
            org.telegram.ui.Cells.v8 v8Var = (org.telegram.ui.Cells.v8) this.f35128c.m(i10);
            if (v8Var != null) {
                TLRPC.ChatFull chatFull = this.f35155x;
    ...
    public final void p0(TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, TwoStepVerificationActivity twoStepVerificationActivity) {
        ...
        if (inputCheckPasswordSRP != null && !ChatObject.isChannel(this.f35153w)) {
            MessagesController.getInstance(this.currentAccount).convertToMegaGroup(getParentActivity(), this.f35148s, this, new b7(this, inputCheckPasswordSRP, twoStepVerificationActivity, 10));
            return;
        }
        TLRPC.TL_channels_editCreator tL_channels_editCreator = new TLRPC.TL_channels_editCreator();
        if (ChatObject.isChannel(this.f35153w)) {
    ...
    public final void t0(boolean z10) {
        float f7;
        ValueAnimator valueAnimator = this.f35127b1;
        ...
        if (qrVar != null) {
            ...
            this.f35127b1 = ofFloat;
            ofFloat.addUpdateListener(new bq(this, 0));
            this.f35127b1.addListener(new t4(this, 24));
            this.f35127b1.setDuration(Math.abs(this.h.f27751c - (this.H ? 1.0f : 0.0f)) * 150.0f);
            this.f35127b1.start();
        }
    }
    ...
    public final void u0(boolean z10) {
        int i10;
        int min = Math.min(this.f35149s0, this.f35150t0);
        this.W = -1;
        this.X = -1;
        this.Y = -1;
        this.Z = -1;
        ...
        if (z14) {
            ...
            if (!z12 && (!this.S.isEmpty() || (this.f35153w.creator && UserObject.isUserSelf(user)))) {
                int i32 = this.V;
                this.f35143o0 = i32;
                this.V = i32 + 2;
                this.f35152v0 = i32 + 1;
                if (this.f35153w.creator && UserObject.isUserSelf(user)) {
                    int i33 = this.V;
                    this.V = i33 + 1;
                    this.f35154w0 = i33;
                } else {
        ...
        if (z10) {
            if (min == -1 && (i10 = this.f35149s0) != -1) {
                this.f35122a.s(Math.min(i10, this.f35150t0), 2);
            } else if (min != -1 && this.f35149s0 == -1) {
                this.f35122a.t(min, 2);
            }
        }
    }
}
