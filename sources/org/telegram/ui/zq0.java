...
public final class zq0 implements org.telegram.ui.Cells.s5 {
    ...
    public final void a(org.telegram.ui.Cells.t5 t5Var) {
        ...
        cr0 cr0Var = this.f40548a.d;
        MediaController.AlbumEntry albumEntry = cr0Var.J;
        int i10 = -1;
        int i11 = 1;
        if (albumEntry != null) {
            MediaController.PhotoEntry photoEntry = albumEntry.photos.get(intValue);
            boolean containsKey = cr0Var.f32762b.containsKey(Integer.valueOf(photoEntry.imageId));
            z10 = !containsKey;
            if (!containsKey && cr0Var.H > 0 && cr0Var.f32762b.size() >= cr0Var.H) {
                b();
                return;
            }
            if (cr0Var.e && !containsKey) {
                i10 = cr0Var.f32764c.size();
            }
            t5Var.b(i10, z10, true);
            cr0Var.Y(intValue, photoEntry);
        } else {
            AndroidUtilities.hideKeyboard(cr0Var.getParentActivity().getCurrentFocus());
            MediaController.SearchImage searchImage = (MediaController.SearchImage) cr0Var.f32768f.get(intValue);
            boolean containsKey2 = cr0Var.f32762b.containsKey(searchImage.f15784id);
            z10 = !containsKey2;
            if (!containsKey2 && cr0Var.H > 0 && cr0Var.f32762b.size() >= cr0Var.H) {
                b();
                return;
            }
