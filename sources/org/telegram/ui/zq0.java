...
public final class zq0 implements org.telegram.ui.Cells.r5 {
    ...
    public final void b(org.telegram.ui.Cells.s5 s5Var) {
        ...
        if (albumEntry != null) {
            ...
            boolean containsKey = cr0Var.f32873b.containsKey(Integer.valueOf(photoEntry.imageId));
            z10 = !containsKey;
            if (!containsKey && cr0Var.H > 0 && cr0Var.f32873b.size() >= cr0Var.H) {
                a();
                return;
            }
            if (cr0Var.e && !containsKey) {
                i10 = cr0Var.f32875c.size();
            }
            s5Var.b(i10, z10, true);
            cr0Var.Y(intValue, photoEntry);
        } else {
            AndroidUtilities.hideKeyboard(cr0Var.getParentActivity().getCurrentFocus());
            MediaController.SearchImage searchImage = (MediaController.SearchImage) cr0Var.f32879f.get(intValue);
            boolean containsKey2 = cr0Var.f32873b.containsKey(searchImage.f15607id);
            z10 = !containsKey2;
            if (!containsKey2 && cr0Var.H > 0 && cr0Var.f32873b.size() >= cr0Var.H) {
                a();
                return;
            }
