...
public abstract class ChatListItemAnimator extends DefaultItemAnimator {
                    ...
                    if (view instanceof ChatMessageCell) {
                        ...
                        if (moveInfoExtended2.animateImage) {
                            ...
                            valueAnimatorOfFloat3.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                                @Override
                                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                    ChatListItemAnimator.m5028$r8$lambda$om2k4wYSnG7ii6RhLEuKuITF6s(moveInfoExtended, transitionParams2, z4, f4, f5, chatMessageCell, iArr2, viewHolder, valueAnimator);
                                }
                            });
                ...
                if (view instanceof ChatMessageCell) {
                    ...
                    if (moveInfoExtended2.animateImage) {
                        ...
                        valueAnimatorOfFloat9.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                            @Override
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                ChatListItemAnimator.m5028$r8$lambda$om2k4wYSnG7ii6RhLEuKuITF6s(moveInfoExtended, transitionParams2, z4, f4, f5, chatMessageCell, iArr3, viewHolder, valueAnimator);
                            }
                        });
                ...
                if (view instanceof ChatMessageCell) {
                    ...
                    if (moveInfoExtended2.animateImage) {
                        ...
                        valueAnimatorOfFloat17.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                            @Override
                            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                ChatListItemAnimator.m5028$r8$lambda$om2k4wYSnG7ii6RhLEuKuITF6s(moveInfoExtended, transitionParams2, z4, f4, f5, chatMessageCell, iArr4, viewHolder, valueAnimator);
                            }
                        });
            ...
            if (view instanceof ChatMessageCell) {
                ...
                if (moveInfoExtended2.animateImage) {
                    ...
                    valueAnimatorOfFloat114.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                        @Override
                        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                            ChatListItemAnimator.m5028$r8$lambda$om2k4wYSnG7ii6RhLEuKuITF6s(moveInfoExtended, transitionParams2, z4, f4, f5, chatMessageCell, iArr5, viewHolder, valueAnimator);
                        }
                    });
    ...
    public static void m5028$r8$lambda$om2k4wYSnG7ii6RhLEuKuITF6s(MoveInfoExtended moveInfoExtended, ChatMessageCell.TransitionParams transitionParams, boolean z, float f, float f2, ChatMessageCell chatMessageCell, int[] iArr, RecyclerView.ViewHolder viewHolder, ValueAnimator valueAnimator) {
        float fFloatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        ...
        if (z && (callback0Return = this.getThanosEffectContainer) != null) {
            ...
            thanosEffect.animate(view, new Runnable() {
                ...
                public final void run() {
                    ChatListItemAnimator.m5026$r8$lambda$0Fw2DeKdCu1fL7NSC9LfaHUiJ8(this.f$0, view, viewHolder);
                }
            });
    ...
    public static void m5026$r8$lambda$0Fw2DeKdCu1fL7NSC9LfaHUiJ8(ChatListItemAnimator chatListItemAnimator, View view, RecyclerView.ViewHolder viewHolder) {
    ...
    private void animateRemoveGroupImpl(final ArrayList arrayList) {
        ...
        thanosEffect.animateGroup(arrayList2, new Runnable() {
            @Override
            public final void run() {
                ChatListItemAnimator.m5027$r8$lambda$Gr_Ym_CfugNbnWQr848cwBmg(this.f$0, arrayList2, arrayList);
            }
        });
    ...
    public static void m5027$r8$lambda$Gr_Ym_CfugNbnWQr848cwBmg(ChatListItemAnimator chatListItemAnimator, ArrayList arrayList, ArrayList arrayList2) {
        chatListItemAnimator.getClass();
        for (int i = 0; i < arrayList.size(); i++) {
