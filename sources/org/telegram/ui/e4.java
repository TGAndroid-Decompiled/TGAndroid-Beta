...
public final class e4 extends FrameLayout {
    public final org.telegram.ui.Components.fo0 f32789a;
    public final int f32790b;
    public final int f32791c;
    public int d;
    public final TextPaint e;
    public final i4 f32792f;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.d != size) {
            ...
            this.f32789a.setProgress((i12 - i13) / (this.f32791c - i13));
            this.d = size;
        }
    }
}
