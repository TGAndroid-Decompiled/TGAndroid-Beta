...
public final class io implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        switch (this.f37442a) {
            case 0:
                final xo xoVar = (xo) this.f37444c;
                ...
                if (!zArr[0]) {
                    ...
                    boostsController.getBoostsStats(j3, new e2.h() {
                        ...
                        public final void accept(Object obj) {
                            ...
                            xo xoVar2 = xo.this;
                            TLRPC.Chat chat = xoVar2.f42826x0;
                            int i11 = chat.level;
                            int i12 = tL_premium_boostsStatus.level;
                            if (i11 != i12) {
                                chat.level = i12;
                                xoVar2.getMessagesController().putChat(xoVar2.f42826x0, false);
                            }
                            ...
                            tL_channels_toggleAutotranslation.channel = MessagesController.getInputChannel(xoVar2.f42826x0);
                ...
                return;
            case 1:
                ((org.telegram.ui.ActionBar.b2[]) this.f37444c)[0].dismiss();
                ((org.telegram.ui.Components.as) this.d).run(-this.f37443b);
                return;
            case 2:
                ((org.telegram.ui.ActionBar.b2[]) this.f37444c)[0].dismiss();
                ((org.telegram.ui.Components.as) this.d).run(-this.f37443b);
                return;
            case 3:
                org.telegram.ui.Components.b70.N((org.telegram.ui.Components.b70) this.f37444c, (Context) this.d, this.f37443b);
                return;
            case 4:
                uy uyVar = (uy) this.f37444c;
            ...
            case 5:
                ...
                if (l4 != null && longValue == l4.longValue()) {
                    ...
                    xo0Var.f42846f[0].setText(LocaleController.getInstance().formatCurrencyString(this.f37443b, false, true, true, xo0Var.C0.invoice.currency));
                }
                EditTextBoldCursor editTextBoldCursor = xo0Var.f42846f[0];
                editTextBoldCursor.setSelection(editTextBoldCursor.length());
                return;
            default:
                zh.w3.Y0((zh.w3) this.f37444c, (String) this.d, this.f37443b);
                return;
        }
    }
}
