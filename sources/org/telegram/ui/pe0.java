...
public final class pe0 implements Runnable {
    ...
    public final se0 f36098b;

    public pe0(se0 se0Var, int i10) {
        this.f36097a = i10;
        this.f36098b = se0Var;
    }
    ...
    public final void run() {
        switch (this.f36097a) {
            case 0:
                ...
                if (str != null) {
                    ...
                    if (str.length() > 1) {
                        ...
                        int length2 = se0Var.K.length() + i11;
            ...
            case 1:
                ...
                return;
            case 2:
                this.f36098b.o(false);
                return;
            default:
                ci.h2 h2Var2 = this.f36098b.f37255c;
                if (h2Var2 != null) {
                    h2Var2.requestFocus();
