...
public final class ec1 implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        switch (this.f33369a) {
            case 0:
                od1 od1Var = this.f33370b;
                od1Var.getClass();
                od1Var.f36192n1 = ((Float) obj).floatValue();
                od1Var.f36215x0.invalidate();
                od1Var.V0();
                return;
            case 1:
                od1 od1Var2 = this.f33370b;
                ...
                return;
            default:
                od1.U(this.f33370b, (ChannelBoostsController.CanApplyBoost) obj);
                return;
        }
    }
}
