...
public final class ec1 extends org.telegram.ui.Components.rl0 {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        if (view instanceof org.telegram.ui.Cells.s1) {
            ...
            if (avatarImage != null) {
                ...
                jd1 jd1Var = this.W2;
                if (m32 && (T = jd1Var.f35223r0.T(view)) != null) {
                    if (jd1Var.f35223r0.K(T.b() - 1) != null) {
                ...
                int measuredHeight = jd1Var.f35223r0.getMeasuredHeight() - jd1Var.f35223r0.getPaddingBottom();
                if (layoutHeight > measuredHeight) {
                    layoutHeight = measuredHeight;
                }
                if (s1Var.n3() && (r11 = jd1Var.f35223r0.T(view)) != null) {
                    int i10 = 0;
                    while (i10 < 20) {
                        i10++;
                        f2.l1 T2 = jd1Var.f35223r0.K(T2.b() + 1);
                        if (T2 == null) {
                            break;
                        }
                        View view2 = T2.f5774a;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        jd1 jd1Var = this.W2;
        if (action == 1) {
            if (!jd1Var.f35216o0 && (jd1Var.f35242y1 instanceof ui1) && jd1Var.I0[0].getVisibility() == 0) {
                jd1Var.f1(0, false, true);
            }
            jd1Var.f35216o0 = false;
        }
        if (jd1Var.X1) {
