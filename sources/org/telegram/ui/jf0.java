...
public final class jf0 extends org.telegram.ui.Components.vv0 implements org.telegram.ui.Components.t40 {
    ...
    public final yg0 O;
    public final org.telegram.ui.Components.yc0 f34868a;
    public final org.telegram.ui.Components.yc0 f34869b;
    public final EditTextBoldCursor f34870c;
    public final EditTextBoldCursor d;
    public final ai.z5 e;
    public final org.telegram.ui.Components.f9 f34871f;
    public final ci.s6 h;
    public final kd f34872n;
    public final ld f34873r;
    public AnimatorSet f34874s;
    public final TextView v;
    public final TextView f34875w;
    public final TextView f34876x;
    public final TextView f34877y;
    ...
    public jf0(yg0 yg0Var, Context context) {
        ...
        this.f34870c = editTextBoldCursor;
        ...
        editTextBoldCursor.setOnFocusChangeListener(new View.OnFocusChangeListener(this) {
            ...
            public final void onFocusChange(View view, boolean z10) {
                ...
                switch (r2) {
                    case 0:
                        org.telegram.ui.Components.yc0 yc0Var2 = this.f33633b.f34868a;
                        if (z10) {
                            f10 = 1.0f;
                        } else {
                            f10 = 0.0f;
                        ...
                        return;
                    default:
                        org.telegram.ui.Components.yc0 yc0Var3 = this.f33633b.f34869b;
                        if (z10) {
                            f11 = 1.0f;
                        } else {
                            f11 = 0.0f;
        ...
        editTextBoldCursor2.setOnFocusChangeListener(new View.OnFocusChangeListener(this) {
            ...
            public final void onFocusChange(View view, boolean z10) {
                ...
                switch (r2) {
                    case 0:
                        org.telegram.ui.Components.yc0 yc0Var22 = this.f33633b.f34868a;
                        if (z10) {
                            f10 = 1.0f;
                        } else {
                            f10 = 0.0f;
    ...
    public final boolean c(boolean z10) {
        ...
        if (!z10) {
            ...
            alertDialog$Builder.f18447a.T = LocaleController.getString("AreYouSureRegistration", R.string.AreYouSureRegistration);
    ...
    public final void h(String str) {
        ...
        yg0 yg0Var = this.O;
        TLRPC.TL_help_termsOfService tL_help_termsOfService = yg0Var.f39907p0;
        if (tL_help_termsOfService != null && tL_help_termsOfService.popup) {
            q(true);
            return;
        }
        EditTextBoldCursor editTextBoldCursor = this.f34870c;
        if (editTextBoldCursor.length() == 0) {
            yg0.U0(yg0Var, this.f34868a, true);
            return;
        }
        this.H = true;
    ...
    @Override
    public final void j() {
        TextView textView = this.f34876x;
        if (textView != null) {
            if (this.O.f39896f) {
        ...
        AndroidUtilities.runOnUIThread(new wd0(this, 3), yg0.f39887t0);
    }
    ...
    public final void k(Bundle bundle) {
        ...
        try {
            ...
            if (string != null && (decode = Base64.decode(string, 0)) != null) {
                ...
                this.O.f39907p0 = TLRPC.TL_help_termsOfService.TLdeserialize(serializedData, serializedData.readInt32(false), false);
    ...
    public final void l(Bundle bundle) {
        String obj = this.f34870c.getText().toString();
        if (obj.length() != 0) {
        ...
        if (tL_help_termsOfService != null) {
            ...
            yg0Var.f39907p0.serializeToStream(serializedData);
    ...
    @Override
    public final void n() {
        this.f34871f.invalidateSelf();
        int i10 = org.telegram.ui.ActionBar.j6.G6;
        this.f34877y.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        int i11 = org.telegram.ui.ActionBar.j6.D6;
        this.v.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i11, false));
        int w02 = org.telegram.ui.ActionBar.j6.w0(null, i10, false);
        EditTextBoldCursor editTextBoldCursor = this.f34870c;
        editTextBoldCursor.setTextColor(w02);
        int i12 = org.telegram.ui.ActionBar.j6.f19009l6;
        ...
        this.f34875w.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.q6, false));
    ...
    public final void o() {
        this.f34876x.animate().alpha(0.0f).setDuration(150L).setStartDelay(0L).setInterpolator(AndroidUtilities.accelerateInterpolator).start();
    }

    public final void p(boolean z10) {
        kd kdVar = this.f34872n;
        if (kdVar == null) {
            return;
        }
        AnimatorSet animatorSet = this.f34874s;
        if (animatorSet != null) {
            animatorSet.cancel();
            this.f34874s = null;
        }
        ld ldVar = this.f34873r;
        if (z10) {
            this.f34874s = new AnimatorSet();
            kdVar.setVisibility(0);
            AnimatorSet animatorSet2 = this.f34874s;
            Property property = View.ALPHA;
            animatorSet2.playTogether(ObjectAnimator.ofFloat(kdVar, property, 1.0f), ObjectAnimator.ofFloat(ldVar, property, 0.0f));
            this.f34874s.setDuration(180L);
            this.f34874s.addListener(new org.telegram.ui.Components.w81(this, 25));
            this.f34874s.start();
            return;
        }
        kdVar.setAlpha(1.0f);
    ...
    public final void q(boolean z10) {
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(yg0Var.f39907p0.text);
        MessageObject.addEntitiesToText(spannableStringBuilder, yg0Var.f39907p0.entities, false, false, false, false);
