...
public final class sm implements org.telegram.ui.Components.og {
    ...
    public final void B0(int i10, int i11) {
        ...
        co coVar = this.f40474c;
        if (coVar.f35286i0 != null) {
            kVar = ((org.telegram.ui.ActionBar.n2) coVar).actionBar;
            final org.telegram.ui.ActionBar.z n10 = kVar.n();
            org.telegram.ui.Components.my0 my0Var = coVar.f35226d1;
            if (my0Var != null) {
                my0Var.e();
            }
            if (i11 - i10 > 0) {
                org.telegram.ui.ActionBar.y yVar = coVar.f35286i0;
                if (yVar.f21536o == null) {
                    yVar.f21536o = 1;
                    if (coVar.f35286i0.f21533l != 0) {
                        if ((coVar.R3 == 3 && coVar.I8() == coVar.getUserConfig().getClientUserId()) || (coVar.R3 == 0 && ((coVar.f35229d4 == 0 || coVar.f35278h4) && !UserObject.isReplyUser(coVar.f35250f) && !coVar.A9()))) {
                            coVar.f35286i0.f(0);
                            co.J3(coVar);
                            org.telegram.ui.ActionBar.v0 v0Var = coVar.f35274h0;
                            if (v0Var != null) {
                                v0Var.setVisibility(8);
                            }
                            org.telegram.ui.ActionBar.y yVar2 = coVar.f35239e0;
                            if (yVar2 != null) {
                                yVar2.f(8);
                            }
                            ...
                            ofFloat.setInterpolator(org.telegram.ui.Components.pr.f29467f);
            ...
            org.telegram.ui.ActionBar.y yVar3 = coVar.f35286i0;
            if (yVar3.f21536o != null) {
                yVar3.f21536o = null;
                if (yVar3.f21533l != 8) {
                    if ((coVar.R3 == 3 && coVar.I8() == coVar.getUserConfig().getClientUserId()) || (coVar.R3 == 0 && ((coVar.f35229d4 == 0 || coVar.f35278h4) && !UserObject.isReplyUser(coVar.f35250f) && !coVar.A9()))) {
                        coVar.f35286i0.f(8);
                        if (coVar.Y.k0() && TextUtils.isEmpty(coVar.Y.getSlowModeTimer())) {
                            org.telegram.ui.ActionBar.v0 v0Var2 = coVar.f35274h0;
                            if (v0Var2 != null) {
                                v0Var2.setVisibility(8);
                            }
                            org.telegram.ui.ActionBar.y yVar4 = coVar.f35239e0;
                            if (yVar4 != null) {
                                yVar4.f(0);
                            }
                            hs hsVar2 = coVar.f35225d0;
                            if (hsVar2 != null) {
                                hsVar2.b(true);
                                return;
                            }
                        ...
                        org.telegram.ui.ActionBar.v0 v0Var3 = coVar.f35274h0;
                        if (v0Var3 != null) {
                            v0Var3.setVisibility(0);
                        }
                        org.telegram.ui.ActionBar.y yVar5 = coVar.f35239e0;
                        if (yVar5 != null) {
                            yVar5.f(8);
                        }
                        hs hsVar3 = coVar.f35225d0;
                        if (hsVar3 != null) {
                            hsVar3.b(false);
                            return;
                        }
                    ...
                    ofFloat2.setInterpolator(org.telegram.ui.Components.pr.f29467f);
    ...
    public final void G(CharSequence charSequence, boolean z10, int i10, int i11, long j3) {
        ...
        co coVar = this.f40474c;
        ArrayList arrayList = coVar.f35441u6;
        if (coVar.f35487y0 != null) {
            coVar.f35199b0 = coVar.Y.getBackgroundTop();
        }
        fk fkVar = coVar.I1;
        ...
        if (i10 != 0) {
            ...
            MessagePreviewParams messagePreviewParams2 = coVar.f35256f5;
            if (messagePreviewParams2 != null && (messages2 = messagePreviewParams2.forwardMessages) != null && !messages2.messages.isEmpty()) {
                coVar.S3 += coVar.f35256f5.forwardMessages.messages.size();
            }
            coVar.Ec(false);
        }
        if (!TextUtils.isEmpty(charSequence) && (messagePreviewParams = coVar.f35256f5) != null && (messages = messagePreviewParams.forwardMessages) != null && !messages.messages.isEmpty() && coVar.f35256f5.quote == null && j3 <= 0) {
            ArrayList<MessageObject> arrayList2 = new ArrayList<>();
            coVar.f35256f5.forwardMessages.getSelectedMessages(arrayList2);
            ...
            if (z12) {
                ...
                org.telegram.ui.Components.aj0 aj0Var = ((org.telegram.ui.Components.nc) M.f29676e).f28724a;
                aj0Var.setScaleX(1.8f);
                aj0Var.setScaleY(1.8f);
                M.k(true);
            }
        }
        if (ChatObject.isForum(coVar.f35238e) && !coVar.f35278h4 && (messageObject = coVar.f35353n5) != null) {
            TLRPC.TL_forumTopic tL_forumTopic = messageObject.replyToForumTopic;
            if (tL_forumTopic == null) {
                i12 = ((org.telegram.ui.ActionBar.n2) coVar).currentAccount;
                topicId = MessageObject.getTopicId(i12, coVar.f35353n5.messageOwner, true);
            } else {
    ...
    public final void P0() {
        ...
        if (sendingMessageId != 0) {
            this.f40474c.F(sendingMessageId, 0, 0, 0, true, true);
        }
    }
    ...
    public final void V0(int i10) {
        ...
        co coVar = this.f40474c;
        if (coVar.f35216c3.getVisibility() != i11) {
            coVar.f35216c3.setVisibility(i11);
        }
    }

    @Override
    public final void V1() {
        org.telegram.ui.Components.my0 my0Var = this.f40474c.f35226d1;
        if (my0Var != null) {
            my0Var.e();
        }
    }
    ...
    public final void W(boolean z10) {
        this.f40474c.Vb(false, z10);
    }

    @Override
    public final int W0() {
        return this.f40474c.X0.getHeight();
    }
    ...
    public final void X1(int i10) {
        ...
        if (i10 < currentActionBarHeight) {
            coVar.Z4 = false;
            if (coVar.f35226d1.getVisibility() == 0) {
                coVar.f35226d1.setVisibility(4);
            }
        } else {
            coVar.Z4 = true;
            if (coVar.f35226d1.getVisibility() == 4 && !coVar.isInPreviewMode()) {
                coVar.f35226d1.setVisibility(0);
            }
        }
        coVar.f35190a5 = true ^ coVar.Y.t0();
        if (coVar.Y.t0()) {
            i11 = 65536;
        } else {
            i11 = 0;
    ...
    public final void a2() {
        ...
        if (coVar.getParentActivity() != null) {
            if ((coVar.f35238e != null || coVar.f35193a8 != null) && coVar.fragmentView != null) {
                org.telegram.ui.Components.i40 i40Var = coVar.f35253f2;
                if ((i40Var == null || i40Var.getVisibility() != 0) && (indexOfChild = (umVar = coVar.X0).indexOfChild(coVar.S)) != -1) {
                    ...
                    if (coVar.f35253f2 == null) {
                        org.telegram.ui.Components.i40 i40Var2 = new org.telegram.ui.Components.i40(9, coVar.getParentActivity(), coVar.f35248ea, false);
                        coVar.f35253f2 = i40Var2;
                        i40Var2.setVisibility(8);
                        umVar.addView(coVar.f35253f2, indexOfChild + 1, w7.x5.d(-2, -2.0f, 51, 10.0f, 0.0f, 10.0f, 0.0f));
                    }
                    TLRPC.UserFull userFull = coVar.f35193a8;
                    if (userFull != null && userFull.voice_messages_forbidden) {
                        org.telegram.ui.Components.i40 i40Var3 = coVar.f35253f2;
                        if (coVar.Y.f23678c1) {
                            i10 = R.string.VideoMessagesRestrictedByPrivacy;
                        } else {
                            i10 = R.string.VoiceMessagesRestrictedByPrivacy;
                        }
                        i40Var3.setText(AndroidUtilities.replaceTags(LocaleController.formatString(i10, coVar.f35250f.first_name)));
                    } else if (!ChatObject.canSendVoice(coVar.f35238e) && !ChatObject.canSendRoundVideo(coVar.f35238e)) {
                        if (!coVar.K6()) {
                            if (coVar.Y.f23678c1) {
                                coVar.f35253f2.setText(ChatObject.getRestrictedErrorText(coVar.f35238e, 21));
                            } else {
                                coVar.f35253f2.setText(ChatObject.getRestrictedErrorText(coVar.f35238e, 20));
                            }
                        } else {
                            return;
                        }
                    } else if (ChatObject.isActionBannedByDefault(coVar.f35238e, 20)) {
                        coVar.f35253f2.setText(LocaleController.getString(R.string.GlobalAttachVoiceRestricted));
                    } else if (ChatObject.isActionBannedByDefault(coVar.f35238e, 21)) {
                        coVar.f35253f2.setText(LocaleController.getString(R.string.GlobalAttachRoundRestricted));
                    } else if (ChatObject.isActionBannedByDefault(coVar.f35238e, 7)) {
                        coVar.f35253f2.setText(LocaleController.getString(R.string.GlobalAttachMediaRestricted));
                    } else {
                        TLRPC.TL_chatBannedRights tL_chatBannedRights = coVar.f35238e.banned_rights;
                        if (tL_chatBannedRights != null) {
                            if (AndroidUtilities.isBannedForever(tL_chatBannedRights)) {
                                coVar.f35253f2.setText(LocaleController.getString(R.string.AttachMediaRestrictedForever));
                            } else {
                                coVar.f35253f2.setText(LocaleController.formatString("AttachMediaRestricted", R.string.AttachMediaRestricted, LocaleController.formatDateForBan(coVar.f35238e.banned_rights.until_date)));
                            }
                        } else {
                            return;
                        }
                    ...
                    coVar.f35253f2.f(sendButton, true);
                }
            }
        }
    }
    ...
    public final void c2(int i10, int i11, int i12, long j3, long j10, boolean z10) {
        co coVar = this.f40474c;
        boolean z11 = true;
        if (coVar.f35202b3 == null && CameraView.isCameraAllowed() && coVar.getParentActivity() != null) {
            gl glVar = new gl(coVar, coVar.getParentActivity(), coVar, coVar.f35248ea);
            coVar.f35202b3 = glVar;
            glVar.setClipToPadding(false);
            gl glVar2 = coVar.f35202b3;
            bh.b bVar = coVar.J;
            jj jjVar = coVar.f35460w;
            View view = glVar2.R0;
            ...
            coVar.X0.addView(coVar.f35202b3, Math.min(indexOfChild + 1, coVar.X0.getChildCount()), w7.x5.e(-1, -1, 51));
        }
        gl glVar3 = coVar.f35202b3;
        if (glVar3 != null) {
            if (i10 == 0) {
                glVar3.l(false);
                coVar.f35474x0.B0();
    ...
    public final void f1(CharSequence charSequence, boolean z10, boolean z11) {
        ...
        if (fkVar != null && fkVar.getAdapter() != null) {
            ...
            coVar.I1.getAdapter().U(charSequence2, coVar.Y.getCursorPosition(), coVar.f35441u6, false, false);
        } else {
            charSequence2 = charSequence;
        }
        i9.s sVar = coVar.J5;
        ...
        xk xkVar = coVar.f35484xa;
        if (xkVar != null) {
            ArrayList arrayList = xkVar.F;
            for (int i10 = 0; i10 < arrayList.size(); i10++) {
                ((fz) arrayList.get(i10)).f36508n = true;
            }
        }
        ah.e1 e1Var = ah.e1.B;
        if (e1Var != null) {
        ...
        if (!z11) {
            ij ijVar = coVar.f35265g2;
            if ((ijVar != null && ijVar.getVisibility() == 0) || ((i40Var = coVar.f35288i2) != null && i40Var.getVisibility() == 0)) {
                ij ijVar2 = coVar.f35265g2;
                if (ijVar2 != null) {
                    ijVar2.b(true);
                }
                org.telegram.ui.Components.i40 i40Var2 = coVar.f35288i2;
                if (i40Var2 != null) {
                    i40Var2.b(true);
                    return;
                }
            ...
            qf qfVar = coVar.Na;
            if (UserObject.isUserSelf(coVar.f35250f) || ((chatFull = coVar.Z7) != null && chatFull.slowmode_next_send_date > 0 && coVar.R3 == 0)) {
                z13 = true;
            }
            if (!coVar.f35301j2 && !coVar.f35276h2 && !z13 && SharedConfig.scheduledHintShows < 3 && !coVar.Y.r0()) {
    ...
    public final void g2() {
        ...
        org.telegram.ui.Components.i40 i40Var = coVar.f35288i2;
        if (i40Var != null) {
            i40Var.b(true);
        }
    }
    ...
    public final boolean i1() {
        ...
        if (user != null && !UserObject.isUserSelf(user) && !coVar.f35250f.bot && coVar.h == null && coVar.R3 == 0) {
            return true;
        }
        return false;
    }
    ...
    public final void m1() {
        ...
        if (fkVar != null) {
            ...
            animate.alpha(f7).setInterpolator(org.telegram.ui.Components.pr.f29467f).start();
        }
        org.telegram.ui.Components.my0 my0Var = coVar.f35226d1;
        if (my0Var != null) {
            my0Var.setVisibility(0);
            ViewPropertyAnimator animate2 = coVar.f35226d1.animate();
            if (!z12 && !coVar.isInPreviewMode()) {
                f10 = 1.0f;
            }
            animate2.alpha(f10).setInterpolator(org.telegram.ui.Components.pr.f29467f).withEndAction(new ah.u(20, this, z12)).start();
        }
    }
    ...
    public final void n1(View view, CharSequence charSequence, boolean z10) {
        ...
        if (v0Var != null && v0Var.getVisibility() != 0) {
            coVar.f35274h0.setVisibility(0);
            org.telegram.ui.ActionBar.y yVar = coVar.f35239e0;
            if (yVar != null) {
                yVar.f(8);
            }
            hs hsVar = coVar.f35225d0;
    ...
    @Override
    public final sn o0() {
        return this.f40474c.f35327l5;
    }

    @Override
    public final int p() {
        return this.f40474c.X0.R();
    }

    @Override
    public final void p1(CharSequence charSequence) {
        this.f40474c.Ya(charSequence, true);
    }
    ...
    public final boolean q1() {
        MessagePreviewParams.Messages messages;
        MessagePreviewParams messagePreviewParams = this.f40474c.f35256f5;
    ...
    public final void v() {
        ...
        if (coVar.f35364o5 != 0) {
            coVar.getConnectionsManager().cancelRequest(coVar.f35364o5, true);
            coVar.f35364o5 = 0;
        }
        coVar.yc(0, true);
        coVar.hc(false);
    ...
    public final boolean z0() {
        int i10;
        co coVar = this.f40474c;
        if ((!coVar.getMessagesController().isForum(coVar.a()) || coVar.f35278h4) && (i10 = coVar.R3) != 9 && coVar.S3 > 0) {
            if (i10 != 0) {
