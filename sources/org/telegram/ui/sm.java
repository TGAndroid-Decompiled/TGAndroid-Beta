...
public final class sm extends lu0 {
    public final ArrayList f37823a;
    public final int[] f37824b = new int[2];
    public final wn f37825c;

    public sm(wn wnVar, ArrayList arrayList) {
        this.f37825c = wnVar;
        this.f37823a = arrayList;
    }
    ...
    public final vu0 E(MessageObject messageObject, TLRPC.FileLocation fileLocation, int i10, boolean z10, boolean z11) {
        ...
        wn wnVar = this.f37825c;
        if (wnVar.f39694x0 != null && i10 >= 0) {
            ArrayList arrayList = this.f37823a;
            if (i10 < arrayList.size()) {
                TL_iv.PageBlock pageBlock = (TL_iv.PageBlock) arrayList.get(i10);
                int childCount = wnVar.f39694x0.getChildCount();
                for (int i11 = 0; i11 < childCount; i11++) {
                    View childAt = wnVar.f39694x0.getChildAt(i11);
                    boolean z12 = childAt instanceof org.telegram.ui.Cells.u1;
                    int[] iArr = this.f37824b;
                    ...
                    if (imageReceiver != null) {
                        ...
                        vu0Var.d = wnVar.f39694x0;
                        vu0Var.f38818a = imageReceiver;
                        vu0Var.e = imageReceiver.getBitmapSafe();
                        vu0Var.h = imageReceiver.getRoundRadius(true);
                        vu0Var.f38824j = (int) ((wnVar.f39639s9 - wnVar.f39664u9) - AndroidUtilities.dp(4.0f));
                        vu0Var.f38823i = (int) (wnVar.W8(org.telegram.ui.Components.h31.f24664c) + wnVar.v.c() + AndroidUtilities.dp(9.0f) + wnVar.Aa + wnVar.f39628rc);
                        return vu0Var;
                    }
                }
            }
