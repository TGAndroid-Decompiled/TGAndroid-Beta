...
public final class cq0 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final yh.n5 f32853b;
    public i0.b f32854b0;
    public final yh.n5 f32855c;
    public yf.b0 f32856c0;
    public j0 d;
    public final pe.b f32857d0;
    public fp0 e;
    public final pe.b f32858e0;
    public final int f32859f;
    public final ah.i f32860f0;
    public final fh.d f32861g0;
    public wp0 h;
    public final ah.c f32862h0;
    public final xa f32863i0;
    public final ArrayList f32864j0;
    public final ArrayList f32865k0;
    public wp0 f32866n;
    public boolean f32867r;
    public org.telegram.ui.ActionBar.f6 f32868s;
    public final SparseIntArray v;
    public final org.telegram.ui.ActionBar.g5 f32869w;
    public final org.telegram.ui.ActionBar.g5 f32870x;
    public final fh.c f32871y;

    public cq0() {
        super(null);
        this.f32859f = AndroidUtilities.dp(6.0f);
        this.v = new SparseIntArray();
        boolean q6 = org.telegram.ui.ActionBar.j6.I.q();
        this.S = q6;
        this.f32852a0 = q6;
        this.f32854b0 = i0.b.e;
        pe.b bVar = new pe.b(true);
        this.f32857d0 = bVar;
        pe.b bVar2 = new pe.b(true);
        this.f32858e0 = bVar2;
        this.f32863i0 = new xa(this, 1);
        this.f32864j0 = new ArrayList();
        this.f32865k0 = new ArrayList();
        fh.c cVar = new fh.c();
        this.f32871y = cVar;
        ...
        if (Build.VERSION.SDK_INT >= 31 && SharedConfig.chatBlurEnabled()) {
            ...
            this.f32860f0 = null;
            this.f32861g0 = null;
            this.f32862h0 = new ah.c(cVar);
        }
        cVar2.e = bVar;
        cVar2.d = bVar2;
        cVar4.e = bVar;
        cVar4.d = bVar2;
        ah.c cVar6 = this.f32862h0;
        cVar6.e = bVar;
        cVar6.d = bVar2;
        this.f32851a = false;
        ...
        this.f32869w = new org.telegram.ui.ActionBar.g5(0, false, false, this.resourceProvider);
        this.f32870x = new org.telegram.ui.ActionBar.g5(0, false, true, this.resourceProvider);
    }
    ...
    public static void U(cq0 cq0Var, boolean[] zArr, TL_stars.TL_starGiftUnique tL_starGiftUnique, long j3, ap0 ap0Var, yh.d3 d3Var, nf.e eVar) {
        zArr[0] = true;
        eVar.d();
        yh.v5.x(cq0Var.currentAccount, d3Var.f47101a).h(d3Var.f47102b, tL_starGiftUnique, j3, null, true, new ai.m0(18, eVar, ap0Var));
    }
    ...
    public final void A0() {
        int themedColor;
        if (AndroidUtilities.computePerceivedBrightness(getThemedColor(org.telegram.ui.ActionBar.j6.f18863d6)) > 0.72d) {
            themedColor = i0.a.d(0.085f, getThemedColor(org.telegram.ui.ActionBar.j6.f18807a7), this.e.getColor());
        } else {
            themedColor = getThemedColor(org.telegram.ui.ActionBar.j6.f18807a7);
        }
        this.d.setBackgroundColor(themedColor);
        fh.c cVar = this.F;
        if (cVar.f9073a.getColor() != themedColor) {
            cVar.a(themedColor);
            Iterator it = this.f32858e0.iterator();
            while (it.hasNext()) {
                ((ch.d) it.next()).v();
            }
            Iterator it2 = this.f32857d0.iterator();
            while (it2.hasNext()) {
    ...
    public final void D0(int i10) {
        if (Build.VERSION.SDK_INT >= 31 && this.f32860f0 != null) {
            yf.b0 b0Var = this.f32856c0;
            if (b0Var.f46809c == 0) {
                b0Var.invalidate();
            }
    ...
    public final void F0() {
        ...
        fp0 fp0Var = this.e;
        if (fp0Var != null) {
            fp0Var.f34646a = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18807a7, fp0Var.f34647b);
            fp0Var.a();
            fp0Var.invalidate();
        }
        G0();
    ...
    public final void G0() {
        ...
        if (this.e != null) {
            ...
            if (this.M != null) {
                ...
                int d = i0.a.d(a2, tabsViewBackgroundColor, getThemedColor(org.telegram.ui.ActionBar.j6.f18863d6));
                int d10 = i0.a.d(a2, -1, getThemedColor(org.telegram.ui.ActionBar.j6.f18807a7));
                int d11 = i0.a.d(a2, -1, getThemedColor(org.telegram.ui.ActionBar.j6.f19264z6));
                int d12 = i0.a.d(a2, tabsViewBackgroundColor, getThemedColor(org.telegram.ui.ActionBar.j6.G6));
                qzVar.f27458a.setColor(d);
                qzVar.f27459b.setColor(d10);
                qzVar.d = d11;
                qzVar.e = d12;
                qzVar.invalidate();
            }
    ...
    public final View createView(Context context) {
        ...
        this.f32856c0 = new yf.b0(context, new zo0(this, 0));
        hh.k kVar = new hh.k(this.d);
        j0 j0Var2 = this.d;
        ah.c cVar = this.f32862h0;
        cVar.f425f = kVar;
        cVar.f426g = j0Var2;
        this.h = new wp0(this, context, 1);
        this.f32866n = new wp0(this, context, 0);
        fp0 fp0Var = new fp0(this, context, this.resourceProvider);
        this.e = fp0Var;
        fp0Var.E = true;
        this.f32866n.j(false);
        this.f32866n.addView(this.e, 2, w7.x5.e(-1, -2, 55));
        ...
        int i12 = org.telegram.ui.ActionBar.j6.f19177u8;
        ...
        fp0 fp0Var3 = this.e;
        fp0Var3.getClass();
        fp0Var3.f34646a = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18807a7, fp0Var3.f34647b);
        fp0Var3.a();
        fp0Var3.invalidate();
        z0();
        this.d.addView(this.f32856c0);
        A0();
    ...
    public final boolean isSwipeBackEnabled(MotionEvent motionEvent) {
        if (!this.f32851a && ((this.h.b() || this.f32866n.b()) && getUserConfig().isPremium())) {
            return false;
        }
    ...
    public final boolean onBackPressed(boolean z10) {
        int i10;
        int i11;
        boolean z11 = this.f32851a;
        if (!z11 && ((this.h.b() || this.f32866n.b()) && getUserConfig().isPremium())) {
    ...
    public final void z0() {
        this.f32871y.a(getThemedColor(org.telegram.ui.ActionBar.j6.f18863d6));
        this.O.invalidate();
        this.P.invalidate();
        this.h.f39155w.invalidate();
        this.h.f39156x.invalidate();
        this.f32866n.f39155w.invalidate();
        this.h.f39135b.invalidate();
        this.f32866n.f39135b.invalidate();
