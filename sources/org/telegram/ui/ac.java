...
public final class ac extends og.a {
    ...
    public final boolean equals(Object obj) {
        ...
        if (boost2.f18313id.hashCode() == boost.f18313id.hashCode() && z10 == z11 && this.f31730g == acVar.f31730g) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Objects.hash(this.f31728c, this.d, this.e, Boolean.valueOf(this.f31729f), Integer.valueOf(this.f31730g));
    }
