...
public final class ac extends og.b {
    ...
    public final boolean D(s4.c1 c1Var) {
        return ((bc) this.f31728f.f32750x.get(c1Var.b())).f15532b;
    }

    @Override
    public final int h() {
        return this.f31728f.f32750x.size();
    }

    @Override
    public final int j(int i10) {
        return ((bc) this.f31728f.f32750x.get(i10)).f15531a;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        int i12;
        int i13;
        cc ccVar = this.f31728f;
        int i14 = ccVar.f32743b;
        TLRPC.Chat chat = ccVar.J;
        ArrayList arrayList = ccVar.f32750x;
        ...
        if (i15 != 4) {
            if (i15 != 1 && i15 != 12) {
                if (i15 == 0) {
                    ...
                    bVar.d(user, ContactsController.formatName(user), formatString, !((bc) arrayList.get(i10)).f32113f);
                    bVar.setStatus(boost);
                    bVar.setAvatarPadding(5);
                    return;
                } else if (i15 == 6) {
                    ((org.telegram.ui.Cells.e9) view).setText(((bc) arrayList.get(i10)).f32112c);
                    return;
                } else if (i15 == 9) {
                    org.telegram.ui.Cells.y4 y4Var = (org.telegram.ui.Cells.y4) view;
                    if (ccVar.f32751y == 0) {
                        y4Var.b(LocaleController.formatPluralString("BoostingShowMoreBoosts", ccVar.f32748s, new Object[0]), R.drawable.arrow_more, 5, false);
                        return;
                    } else {
                        y4Var.b(LocaleController.formatPluralString("BoostingShowMoreGifts", ccVar.f32749w, new Object[0]), R.drawable.arrow_more, 5, false);
                        return;
                    }
                } else if (i15 == 3) {
                    ((org.telegram.ui.Components.v80) view).setLink(((bc) arrayList.get(i10)).f32112c);
                    return;
                } else if (i15 == 11) {
                    bc bcVar = (bc) arrayList.get(i10);
                    TL_stories.PrepaidGiveaway prepaidGiveaway = bcVar.e;
                    boolean z10 = bcVar.f32113f;
                    yg.c cVar = (yg.c) view;
                    ...
                    if (i16 != i17 || this.e != ccVar.O) {
                        ...
                        this.e = ccVar.O;
                        ccVar.f32745f.g();
                        ccVar.f32745f.a(0, LocaleController.formatPluralString("BoostingBoostsCount", ccVar.P, new Object[0]), null);
                        if (MessagesController.getInstance(i14).giveawayGiftsPurchaseAvailable && (i11 = ccVar.O) > 0 && i11 != ccVar.P) {
                            ccVar.f32745f.a(1, LocaleController.formatPluralString("BoostingGiftsCount", i11, new Object[0]), null);
                        }
                        ccVar.f32745f.setInitialTabId(ccVar.f32751y);
                        ccVar.f32745f.c();
                        return;
                    }
                    return;
            ...
            cVar2.setTitle(((bc) arrayList.get(i10)).f32112c);
            cVar2.c(false);
            if (c1Var.f42674f == 12) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        za1 za1Var = ccVar.f32744c;
        switch (i10) {
            case 0:
                n6Var = new ta1(ccVar.getContext(), 2);
                break;
            case 1:
                ...
                break;
            case 2:
                n6Var = new org.telegram.ui.Cells.a7(viewGroup.getContext(), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18778a7, false), 0);
                break;
            case 3:
                org.telegram.ui.Components.v80 v80Var = new org.telegram.ui.Components.v80(ccVar.getContext(), ccVar.f32744c, null, false, false);
                v80Var.d.setVisibility(8);
                v80Var.f28651a.setGravity(17);
            ...
            case 4:
                ...
                limitPreviewView.f22103c0 = true;
            ...
            case 6:
                ...
                break;
            case 7:
                n6Var = new org.telegram.ui.Cells.t3(ccVar.getContext(), 8);
                break;
            case 8:
            ...
            case 9:
                ...
                n5Var.a(org.telegram.ui.ActionBar.i6.f19163v6, org.telegram.ui.ActionBar.i6.f19145u6);
                n6Var = n5Var;
                break;
            case 10:
            ...
            case 13:
                ...
                ccVar.f32745f = scrollSlidingTextTabStrip;
                ...
                ccVar.f32745f.setDelegate(new g(this, 11));
                n6Var2.addView(ccVar.f32745f, w7.x5.c(48.0f, -2));
                n6Var = n6Var2;
                break;
            default:
