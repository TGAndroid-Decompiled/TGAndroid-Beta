...
public final class ui implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final dg.u1 f41943b;
    public final xn f41944c;
    public final xn d;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i13 && ((Integer) objArr[10]).intValue() == this.f41942a) {
            this.f41943b.run();
            AndroidUtilities.runOnUIThread(new j3.b0(this.f41944c, i10, i11, objArr), 50L);
