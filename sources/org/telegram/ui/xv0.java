...
public final class xv0 extends org.telegram.ui.Components.kl0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        ...
        int b10 = c1Var.b();
        zv0 zv0Var = this.d;
        if (b10 != zv0Var.f43541i0 && b10 != zv0Var.f43555u0 && b10 != zv0Var.f43556v0) {
            if (zv0Var.I && b10 >= (i10 = zv0Var.f43546n0) && b10 < zv0Var.f43561y + i10) {
                if (b10 - i10 < zv0Var.f43559x) {
                    return false;
                }
            } else if (b10 != zv0Var.f43547o0 && b10 != zv0Var.f43551r0 && b10 != zv0Var.f43553s0 && (zv0Var.N != 0 || b10 != zv0Var.f43554t0)) {
                return false;
            }
            return true;
        }
    ...
    @Override
    public final int h() {
        return this.d.f43560x0;
    }

    @Override
    public final int j(int i10) {
        zv0 zv0Var = this.d;
        if (i10 != zv0Var.f43540h0 && i10 != zv0Var.m0 && i10 != zv0Var.f43549q0) {
            if (i10 == zv0Var.f43544l0) {
                return 1;
            }
            if (i10 != zv0Var.f43548p0 && i10 != zv0Var.f43558w0 && i10 != zv0Var.f43543k0) {
                if (i10 == zv0Var.f43547o0) {
                    return 3;
                }
                if (i10 == zv0Var.f43541i0) {
                    return 4;
                }
                if (i10 == zv0Var.f43542j0) {
                    return 7;
                }
                if (i10 != zv0Var.f43551r0 && i10 != zv0Var.f43553s0 && i10 != zv0Var.f43554t0 && i10 != zv0Var.f43555u0 && i10 != zv0Var.f43556v0) {
                    return 5;
                }
                return 6;
            }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i16 != 0) {
            ...
            if (i16 != 6) {
                ...
                if (i16 != 2) {
                    if (i16 == 3) {
                        ...
                        drawable2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20793k7, false), mode));
                ...
                e9Var.setBackground(org.telegram.ui.ActionBar.j6.V0(context, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.j6.f20628b7));
                if (i10 == zv0Var.f43543k0) {
                    e9Var.setText(LocaleController.getString(R.string.AddAnExplanationInfo));
                    return;
                } else if (i10 == zv0Var.f43558w0) {
                    e9Var.setFixedSize(12);
                    e9Var.setText(null);
                    return;
                } else {
                    int i17 = zv0Var.f43545n - zv0Var.f43561y;
                    if (i17 <= 0) {
                        if (z10) {
            ...
            if (i10 == zv0Var.f43555u0) {
                ...
                w8Var.e(null, true);
                return;
            } else if (i10 == zv0Var.f43551r0) {
                w8Var.f(LocaleController.getString(R.string.PollAnonymous), zv0Var.G, (zv0Var.f43553s0 == -1 && zv0Var.f43554t0 == -1) ? true : true);
                w8Var.e(null, true);
                return;
            } else if (i10 == zv0Var.f43553s0) {
                String string = LocaleController.getString(R.string.PollMultiple);
                boolean z13 = zv0Var.K;
                if (zv0Var.f43554t0 != -1) {
                    z12 = true;
                }
                w8Var.f(string, z13, z12);
                w8Var.e(null, true);
                return;
            } else if (i10 == zv0Var.f43554t0) {
        ...
        if (i10 == zv0Var.f43540h0) {
            if (z10) {
                if (zv0Var.f43563z0 != null) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
                        ...
                        if (i10 != 4) {
                            if (i10 != 6) {
                                if (i10 != 7) {
                                    ...
                                    wv0Var2.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20664d6, false));
                                    ...
                                    vv0Var.c();
                                    vv0Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20664d6, false));
                                    vv0Var.b(new org.telegram.ui.Components.pn(5, this, vv0Var));
                                    wv0Var = vv0Var;
                                }
                            } else {
                                View w8Var = new org.telegram.ui.Cells.w8(context);
                                w8Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20664d6, false));
                                wv0Var = w8Var;
                            }
                        } else {
                            uv0 uv0Var = new uv0(this, context, z10 ? 1 : 0);
                            uv0Var.c();
                            uv0Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20664d6, false));
                            uv0Var.b(new org.telegram.ui.Components.pn(4, this, uv0Var));
                            wv0Var = uv0Var;
                        }
                    } else {
                        View r8Var = new org.telegram.ui.Cells.r8(context);
                        r8Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20664d6, false));
                        wv0Var = r8Var;
                    }
                } else {
            ...
            View l4Var = new org.telegram.ui.Cells.l4(this.f42906c, org.telegram.ui.ActionBar.j6.L6, 21, 15, false, null);
    ...
    public final void y(s4.c1 c1Var) {
        ...
        if (i13 == 4) {
            ...
            int i14 = b10 - zv0Var.f43546n0;
            if (zv0Var.I && i14 < zv0Var.f43559x) {
                z10 = false;
            } else {
                z10 = true;
            }
            ...
            c6Var2.setTag(null);
            ImageView imageView = c6Var2.f21687f;
            if (imageView != null) {
                if (z10) {
                    i11 = 0;
                } else {
            ...
            if (!zv0Var.f43538f0 && zv0Var.f43539g0 == b10) {
                EditTextBoldCursor textView = c6Var2.getTextView();
                textView.requestFocus();
                AndroidUtilities.showKeyboard(textView);
                zv0Var.f43538f0 = false;
                zv0Var.f43539g0 = -1;
            }
