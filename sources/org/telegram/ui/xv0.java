...
public final class xv0 extends org.telegram.ui.Cells.d6 {
    ...
    public final boolean e() {
        ...
        if (T != null) {
            int b10 = T.b();
            int i10 = aw0Var.f31982y;
            if (i10 == aw0Var.f31966n && b10 == (aw0Var.f31967n0 + i10) - 1) {
                return false;
            }
        }
        return true;
    ...
    public final boolean f(org.telegram.ui.Cells.d6 d6Var) {
        ...
        if (T != null && (b10 = T.b()) != -1) {
            return aw0Var.f31978w[b10 - aw0Var.f31967n0];
        }
        return false;
    }
    ...
    public final void g(org.telegram.ui.Cells.c6 c6Var, ActionMode actionMode) {
        if (c6Var.isFocused() && c6Var.hasSelection()) {
            ...
            if (menu.findItem(16908321) != null) {
                bo.k8(menu, this.F.d.f31958f.h, false, true, true, true);
            }
        }
    }
    ...
    public final void h(org.telegram.ui.Cells.d6 d6Var, boolean z10) {
        ...
        aw0 aw0Var = this.F.d;
        if (z10 && aw0Var.L) {
            Arrays.fill(aw0Var.f31978w, false);
            aw0Var.f31954c.getChildCount();
            for (int i10 = aw0Var.f31967n0; i10 < aw0Var.f31967n0 + aw0Var.f31982y; i10++) {
                s4.c1 K = aw0Var.f31954c.K(i10);
                if (K != null) {
                    View view = K.f42671a;
                    if (view instanceof org.telegram.ui.Cells.d6) {
                        ((org.telegram.ui.Cells.d6) view).f19903r.a(false, true);
                    }
                }
            }
        }
        ...
        if (T != null && (b10 = T.b()) != -1) {
            aw0Var.f31978w[b10 - aw0Var.f31967n0] = z10;
        }
        aw0Var.i0();
    }
    ...
    public final boolean l(ArrayList arrayList) {
        ...
        if (!arrayList.isEmpty()) {
            aw0Var.f31954c.getClass();
            int R = RecyclerView.R(this) - aw0Var.f31967n0;
            if (R >= 0) {
                org.telegram.ui.Cells.c6 c6Var = this.d;
                c6Var.getText().replace(c6Var.getSelectionStart(), c6Var.getSelectionEnd(), (CharSequence) arrayList.remove(0));
                int i10 = R + 1;
                while (!arrayList.isEmpty() && i10 < aw0Var.f31966n) {
                ...
                aw0Var.r0();
                aw0Var.f31960g0 = (aw0Var.f31967n0 + i10) - 1;
                aw0Var.f31952b.l();
                return true;
            }
        }
