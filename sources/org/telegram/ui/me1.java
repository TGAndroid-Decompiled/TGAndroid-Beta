...
public final class me1 extends Dialog {
    ...
    public float Y;
    public boolean Z;
    public final org.telegram.ui.ActionBar.f6 f35778a;
    public boolean f35779a0;
    public final je1 f35780b;
    public boolean f35781b0;
    public final je1 f35782c;
    public ym f35783c0;
    public final je1 d;
    public ValueAnimator f35784d0;
    public final ci.i1 e;
    public ValueAnimator f35785e0;
    public final TextView f35786f;
    public final org.telegram.ui.Components.tb0 h;
    public i0.b f35787n;
    public Bitmap f35788r;
    public BitmapShader f35789s;
    public Paint v;
    public Matrix f35790w;
    public float f35791x;
    public float f35792y;
    ...
    public final void b(boolean z10, org.telegram.ui.Components.tr0 tr0Var) {
        float f7;
        long j3;
        ValueAnimator valueAnimator = this.f35784d0;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ValueAnimator valueAnimator2 = this.f35785e0;
        if (valueAnimator2 != null) {
            valueAnimator2.cancel();
        }
        d();
        float f10 = this.f35791x;
        float f11 = 0.0f;
        if (z10) {
            f7 = 1.0f;
        } else {
        ...
        this.f35784d0 = ofFloat;
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
            public final me1 f33630b;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                switch (r2) {
                    case 0:
                        ...
                        me1 me1Var = this.f33630b;
                        me1Var.f35791x = floatValue;
                        me1Var.f35780b.invalidate();
                        me1Var.f35782c.invalidate();
                        me1Var.e();
                        return;
                    default:
                        me1 me1Var2 = this.f33630b;
                        me1Var2.getClass();
                        me1Var2.f35792y = ((Float) valueAnimator3.getAnimatedValue()).floatValue();
                        return;
                }
            }
        });
        this.f35784d0.addListener(new androidx.fragment.app.g(this, z10, tr0Var, 11));
        if (!z10) {
            j3 = 330;
        } else {
            j3 = 520;
        }
        ValueAnimator valueAnimator3 = this.f35784d0;
        org.telegram.ui.Components.qr qrVar = org.telegram.ui.Components.qr.h;
        valueAnimator3.setInterpolator(qrVar);
        this.f35784d0.setDuration(j3);
        this.f35784d0.start();
        float f12 = this.f35792y;
        if (z10) {
            f11 = 1.0f;
        }
        ValueAnimator ofFloat2 = ValueAnimator.ofFloat(f12, f11);
        this.f35785e0 = ofFloat2;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator32) {
                switch (r2) {
                    ...
                    default:
                        me1 me1Var2 = this.f33630b;
                        me1Var2.getClass();
                        me1Var2.f35792y = ((Float) valueAnimator32.getAnimatedValue()).floatValue();
                        return;
                }
            }
        });
        this.f35785e0.addListener(new j70(10, this, z10));
        this.f35785e0.setDuration(((float) j3) * 1.5f);
        this.f35785e0.setInterpolator(qrVar);
        this.f35785e0.start();
    }
    ...
    public final void c(boolean z10) {
        ...
        if (z10 && (gk0Var = this.P) != null && gk0Var.getReactionsWindow() != null && !this.P.getReactionsWindow().f49024q) {
            this.P.e();
        } else if (this.f35779a0) {
        } else {
            this.f35779a0 = true;
            this.W = false;
            ci.i1 i1Var = this.e;
    ...
    public final void e() {
        ...
        if (viewGroup2 != null) {
            ...
            this.S.setAlpha(this.f35791x);
            float lerp3 = AndroidUtilities.lerp(0.75f, 1.0f, this.f35791x);
        ...
        if (this.Q != null) {
            ...
            this.Q.setAlpha(this.f35791x);
            float lerp4 = AndroidUtilities.lerp(0.75f, 1.0f, this.f35791x);
            this.Q.setScaleX(lerp4);
            this.Q.setScaleY(lerp4);
        }
        if (this.f35781b0) {
            this.J.setAlpha(this.f35791x);
            this.I.setAlpha(this.f35791x);
        }
        if (this.P != null) {
