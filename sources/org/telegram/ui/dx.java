...
public final class dx extends gg.m {
    public final vy f33231d0;
    public final wy f33232e0;
    ...
    @Override
    public final void J() {
        this.f33232e0.presentFragment(new l());
    }

    @Override
    public final void K() {
        int i10;
        wy wyVar = this.f33232e0;
        ...
        if (requestPeerType instanceof TLRPC.TL_requestPeerTypeBroadcast) {
            ...
            nd ndVar = new nd(e);
            ndVar.f36062t0 = new n6(wyVar, ndVar, c2Var, 2);
    ...
    public final void L(TLRPC.User user) {
        int i10;
        i10 = ((org.telegram.ui.ActionBar.o2) this.f33232e0).currentAccount;
        MessagesController.getInstance(i10).openApp(user, 0);
    }

    @Override
    public final boolean S() {
        if (this.f33232e0.R0 == 0) {
            return true;
        }
        return false;
    }
    ...
    public final void a(org.telegram.ui.Cells.r2 r2Var) {
        vy vyVar = this.f33231d0;
        vyVar.f38522a.getClass();
        this.f33232e0.o4(r2Var, RecyclerView.S(r2Var), 0.0f, vyVar.d);
    }
    ...
    public final void l() {
        ...
        wy wyVar = this.f33232e0;
        if (wyVar.R0 == 15) {
            org.telegram.ui.ActionBar.w0 w0Var = wyVar.f39241j0;
            if (this.U) {
                i10 = 8;
            } else {
                i10 = 0;
