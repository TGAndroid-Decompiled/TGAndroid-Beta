...
public final class gc1 extends org.telegram.ui.Components.kl0 {
    ...
    public final ThemeActivity f36654e;

    public gc1(ThemeActivity themeActivity, Context context) {
        this.f36654e = themeActivity;
    ...
    public final int j(int i10) {
        ...
        int i23;
        int i24;
        ThemeActivity themeActivity = this.f36654e;
        if (i10 != themeActivity.f34203a0 && i10 != themeActivity.K && i10 != themeActivity.f34205b0 && i10 != themeActivity.Y && i10 != themeActivity.P && i10 != themeActivity.Q && i10 != themeActivity.M && i10 != themeActivity.L) {
            if (i10 != themeActivity.f34212f0 && i10 != themeActivity.Z && i10 != themeActivity.f34230v0 && i10 != themeActivity.A0 && i10 != themeActivity.G0) {
                if (i10 != themeActivity.f34225r0 && i10 != themeActivity.V && i10 != themeActivity.f34207c0 && i10 != themeActivity.O && i10 != themeActivity.f34214h0 && i10 != themeActivity.f34220n0 && i10 != themeActivity.f34217k0 && i10 != themeActivity.J && i10 != themeActivity.I0 && i10 != themeActivity.f34237z0 && i10 != themeActivity.B0 && i10 != themeActivity.C0 && i10 != themeActivity.D0) {
                    if (i10 != themeActivity.R && i10 != themeActivity.S && i10 != themeActivity.T && i10 != themeActivity.U) {
                        if (i10 != themeActivity.W && i10 != themeActivity.f34208d0 && i10 != themeActivity.f34213g0 && i10 != themeActivity.f34233x && i10 != themeActivity.f34215i0 && i10 != themeActivity.f34231w && i10 != themeActivity.f34218l0 && i10 != themeActivity.f34216j0 && i10 != themeActivity.f34228t0 && i10 != themeActivity.f34232w0 && i10 != themeActivity.H0 && i10 != themeActivity.E0 && i10 != themeActivity.F0) {
                            if (i10 == themeActivity.f34210e0) {
                                return 6;
                            }
                            if (i10 != themeActivity.X && i10 != themeActivity.G && i10 != themeActivity.E) {
                                ...
                                if (i10 != i11) {
                                    ...
                                    if (i10 != i12 && i10 != themeActivity.f34235y && i10 != themeActivity.f34227s0) {
                                            ...
                                            if (i10 != i14) {
                                                ...
                                                if (i10 != themeActivity.m0) {
                                                    ...
                                                    if (i10 != i16) {
                                                        ...
                                                        if (i10 != i17) {
                                                            if (i10 == themeActivity.f34221o0) {
                                                                return 11;
                                                            }
                                                            if (i10 != themeActivity.f34223q0) {
                                                                i18 = themeActivity.bubbleRadiusRow;
                                                                if (i10 != i18) {
                                                                    i19 = themeActivity.backgroundRow;
                                                                    if (i10 != i19 && i10 != themeActivity.f34236y0) {
                                                                        ...
                                                                        if (i10 != i20) {
                                                                            ...
                                                                            if (i10 != i21) {
                                                                                ...
                                                                                if (i10 != i22) {
                                                                                    if (i10 == themeActivity.f34229u0) {
                                                                                        return 15;
                                                                                    }
                                                                                    if (i10 == themeActivity.f34234x0) {
                                                                                        return 16;
                                                                                    }
                                                                                    if (i10 == themeActivity.f34222p0) {
                                                                                        return 17;
                                                                                    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i24 != 1) {
                    ...
                    if (i24 != 5) {
                        if (i24 != 6) {
                                            ...
                                            if (i24 != 21) {
                                                switch (i24) {
                                                    case 10:
                                                        ...
                                                        if (z11) {
                                                            int i25 = org.telegram.ui.ActionBar.j6.f20883o;
                                                            if (i25 == 1) {
                                                    ...
                                                    case 11:
                                                        if (this.d) {
                                                            themeActivity.f34206c.w1(themeActivity.f34204b.getMeasuredWidth());
                                                            this.d = false;
                                                            return;
                                                        }
                                                        return;
                                                    case 12:
                                                        ...
                                                        ic1Var.l();
                                                        int indexOf = ic1Var.f37326e.indexOf(ic1Var.d.k(false));
                                                        if (indexOf == -1) {
                                                            indexOf = ic1Var.h() - 1;
                                                        }
                                                        if (indexOf != -1) {
                                                            ((s4.c0) ll0Var.getLayoutManager()).h1(indexOf, (themeActivity.f34204b.getMeasuredWidth() / 2) - AndroidUtilities.dp(42.0f));
                                                            return;
                                                        }
                                                        return;
                                                    default:
                            ...
                            if (i10 == themeActivity.X) {
                                w8Var.f(LocaleController.getString("AutoNightLocation", R.string.AutoNightLocation), org.telegram.ui.ActionBar.j6.f20901p, true);
                                return;
                        ...
                        ((org.telegram.ui.Cells.k0) view).setProgress(org.telegram.ui.ActionBar.j6.f20919q);
                        return;
                    }
            ...
            if (i10 == themeActivity.f34212f0) {
                e9Var.setText(LocaleController.formatString("AutoNightBrightnessInfo", R.string.AutoNightBrightnessInfo, Integer.valueOf((int) (org.telegram.ui.ActionBar.j6.f20919q * 100.0f))));
                return;
            } else if (i10 == themeActivity.Z) {
                e9Var.setText(ThemeActivity.y0());
                return;
            } else if (i10 == themeActivity.f34230v0) {
        ...
        if (i10 == i11) {
            if (org.telegram.ui.ActionBar.j6.f20883o != 0 && org.telegram.ui.ActionBar.j6.J != null) {
        ...
        } else if (i10 == themeActivity.f34203a0) {
            int i30 = org.telegram.ui.ActionBar.j6.f20937r;
            int i31 = i30 / 60;
        ...
        } else if (i10 == themeActivity.f34205b0) {
            int i32 = org.telegram.ui.ActionBar.j6.f20956s;
            int i33 = i32 / 60;
            ...
            eaVar.c(LocaleController.getString("AutoNightUpdateLocation", R.string.AutoNightUpdateLocation), org.telegram.ui.ActionBar.j6.f21029w, false, false);
            ...
            eaVar.c(LocaleController.getString(R.string.SearchEngine), org.telegram.ui.web.p1.a().f42236a, themeActivity.P0, false);
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 9:
                ...
                frameLayout.f35098b = new org.telegram.ui.Cells.y0[2];
                ...
                int i21 = 0;
                while (true) {
                    ?? r32 = (org.telegram.ui.Cells.y0[]) frameLayout.f35098b;
                    if (i21 >= r32.length) {
                        i5Var = frameLayout;
                        break;
                    } else {
                        ...
                        frameLayout2.f23584c = new RectF();
                        TextPaint textPaint = new TextPaint(1);
                        frameLayout2.d = textPaint;
                        frameLayout2.setWillNotDraw(false);
                        frameLayout2.f23583b = z10;
                        if (z10) {
                        ...
                        org.telegram.ui.Cells.y0 y0Var = ((org.telegram.ui.Cells.y0[]) frameLayout.f35098b)[i21];
                        if (i21 == 1) {
                            i14 = 10;
                        } else {
                            i14 = 0;
                        ...
                        ((org.telegram.ui.Cells.y0[]) frameLayout.f35098b)[i21].setOnClickListener(new bi.w2(3, frameLayout, z10));
                        i21++;
                    }
                }
                break;
            case 10:
                i5Var = new org.telegram.ui.Cells.i5(21, 60, this.f36653c, null, true);
                break;
            case 11:
                this.d = true;
                dc1 dc1Var = new dc1(this, this.f36653c, themeActivity, themeActivity.f34211f, themeActivity.f34209e, themeActivity.d);
                themeActivity.f34206c = dc1Var;
                dc1Var.setDrawDivider(themeActivity.v);
                themeActivity.f34206c.setFocusable(false);
                View view = themeActivity.f34206c;
            ...
            case 15:
                ...
                frameLayout3.f30468a = paint;
                frameLayout3.f30469b = new Paint(1);
                Paint paint2 = new Paint(1);
                frameLayout3.f30470c = paint2;
                Paint paint3 = new Paint(1);
                frameLayout3.d = paint3;
                frameLayout3.f30471e = new RectF();
                int i22 = 6;
                frameLayout3.h = r14;
                frameLayout3.f30473n = r15;
                frameLayout3.f30474r = new org.telegram.ui.Components.xi0[6];
                frameLayout3.v = new org.telegram.ui.Components.aj0[2];
                float f11 = 1.0f;
                frameLayout3.f30477x = 1.0f;
                ...
                int i23 = org.telegram.ui.ActionBar.j6.f20676c9;
                int[] iArr = {i23, i23, i23, i23, org.telegram.ui.ActionBar.j6.Y5, org.telegram.ui.ActionBar.j6.f20694d9};
                ...
                org.telegram.ui.Components.xi0 a2 = frameLayout3.a(frameLayout3.f30472f.getValue());
                if (a2 != null) {
                ...
                if (frameLayout3.f30472f.getValue() != 5) {
                    f11 = 0.0f;
                }
                frameLayout3.f30476w = f11;
                frameLayout3.F = frameLayout3.f30472f.getValue();
                i5Var = frameLayout3;
                break;
            case 16:
                ...
                break;
            case 17:
                View gvVar = new gv(themeActivity.f34211f, context, themeActivity);
            ...
            case 21:
                ...
                frameLayout = new gp0(i17, 0L, this.f36653c, themeActivity.getResourceProvider());
                i5Var = frameLayout;
                break;
        }
    ...
    public final void y(s4.c1 c1Var) {
        boolean z10;
        if (c1Var.f45771f == 4) {
            org.telegram.ui.Cells.ja jaVar = (org.telegram.ui.Cells.ja) c1Var.f45767a;
            if (c1Var.b() == org.telegram.ui.ActionBar.j6.f20883o) {
                z10 = true;
            } else {
                z10 = false;
            }
