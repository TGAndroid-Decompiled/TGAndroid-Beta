...
public final class ft0 extends OrientationEventListener {
    public final PhotoViewer f33756a;

    public ft0(Context context, PhotoViewer photoViewer) {
        super(context);
        this.f33756a = photoViewer;
    }
    ...
    public final void onOrientationChanged(int i10) {
        ...
        Activity activity;
        int i11;
        PhotoViewer photoViewer = this.f33756a;
        if (photoViewer.W3 != null && (kt0Var = photoViewer.f31403y2) != null && kt0Var.getVisibility() == 0 && (activity = photoViewer.f31400y) != null && (i11 = photoViewer.Y3) != 0) {
            if (i11 == 1) {
                if (i10 >= 240 && i10 <= 300) {
                    photoViewer.Z3 = true;
