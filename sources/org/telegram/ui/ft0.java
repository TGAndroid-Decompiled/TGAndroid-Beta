...
public final class ft0 extends org.telegram.ui.Components.hq0 {
    public final FrameLayout f36465b1;
    public final boolean f36466c1;
    public final PhotoViewer f36467d1;
    ...
    public ft0(PhotoViewer photoViewer, Context context, co coVar, ArrayList arrayList, String str, Integer num, FrameLayout frameLayout, boolean z10) {
        ...
        this.f36467d1 = photoViewer;
        this.f36465b1 = frameLayout;
        this.f36466c1 = z10;
    }
    ...
    public final void R0(a0.i iVar, int i10, TLRPC.TL_forumTopic tL_forumTopic, boolean z10) {
        ...
        AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.r11(this, this.f36465b1, iVar, i10, 9), 250L);
    }
    ...
    public final void dismissInternal() {
        ...
        PhotoViewer photoViewer = this.f36467d1;
        photoViewer.f33539d0.softInputMode = 272;
        try {
