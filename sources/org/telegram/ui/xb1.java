...
public final class xb1 extends View {
    public static final int f39427c = 0;
    public final Paint f39428a;
    public int[] f39429b;

    public xb1(Context context) {
        super(context);
        this.f39428a = new Paint(1);
        this.f39429b = new int[7];
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Paint paint = this.f39428a;
        paint.setStyle(style);
        int i10 = 0;
        paint.setColor(this.f39429b[0]);
        canvas.drawCircle(measuredWidth, measuredHeight, dp, paint);
        double d = 0.0d;
        while (i10 < 6) {
            i10++;
            paint.setColor(this.f39429b[i10]);
