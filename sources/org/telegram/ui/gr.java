...
public final class gr implements u60 {
    public final z60 f34040a;
    public final pr f34041b;
    ...
    public final void g(TLRPC.User user) {
        this.f34041b.t0(user.f18483id, null, null, null, "", true, 0, false);
    }

    @Override
    public final void i(int i10, ArrayList arrayList) {
        if (this.f34040a.getParentActivity() == null) {
            return;
        }
        pr prVar = this.f34041b;
