...
public final class rc extends View {
    public final Paint f40134a;
    public final Paint f40135b;
    public final Paint f40136c;
    public final Paint d;
    public final Path f40137e;
    public final Path f40138f;
    public boolean h;
    public boolean f40139n;
    public final org.telegram.ui.Components.zc f40140r;
    public boolean f40141s;
    public final org.telegram.ui.Components.e6 v;
    public final sc f40142w;
    ...
    public rc(sc scVar, Context context) {
        ...
        this.f40134a = paint;
        this.f40135b = new Paint(1);
        this.f40136c = new Paint(1);
        this.d = new Paint(1);
        this.f40137e = new Path();
        this.f40138f = new Path();
        this.f40140r = new org.telegram.ui.Components.zc(this);
    ...
    public final void a(MessagesController.PeerColor peerColor) {
        boolean q6;
        org.telegram.ui.ActionBar.f6 f6Var = this.f40142w.f40408a;
        if (f6Var != null) {
            q6 = f6Var.a();
        } else {
            q6 = org.telegram.ui.ActionBar.j6.I.q();
        }
        Paint paint = this.f40136c;
        Paint paint2 = this.f40135b;
        ...
        this.f40139n = peerColor.hasColor3();
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        canvas.save();
        float a2 = this.f40140r.a(0.05f);
        canvas.scale(a2, a2, getMeasuredWidth() / 2.0f, getMeasuredHeight() / 2.0f);
        canvas.save();
        canvas.clipPath(this.f40137e);
        canvas.drawPaint(this.f40135b);
        if (this.h) {
            canvas.drawPath(this.f40138f, this.f40136c);
        }
        canvas.restore();
        if (this.f40139n) {
            canvas.save();
        ...
        float e7 = this.v.e(this.f40141s);
        if (e7 > 0.0f) {
            float dpf2 = AndroidUtilities.dpf2(2.0f);
            Paint paint = this.f40134a;
