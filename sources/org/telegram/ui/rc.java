...
public final class rc extends View {
    public final Paint f40161a;
    public final Paint f40162b;
    public final Paint f40163c;
    public final Paint d;
    public final Path f40164e;
    public final Path f40165f;
    public boolean h;
    public boolean f40166n;
    public final org.telegram.ui.Components.zc f40167r;
    public boolean f40168s;
    public final org.telegram.ui.Components.e6 v;
    public final sc f40169w;
    ...
    public rc(sc scVar, Context context) {
        ...
        this.f40161a = paint;
        this.f40162b = new Paint(1);
        this.f40163c = new Paint(1);
        this.d = new Paint(1);
        this.f40164e = new Path();
        this.f40165f = new Path();
        this.f40167r = new org.telegram.ui.Components.zc(this);
    ...
    public final void a(MessagesController.PeerColor peerColor) {
        boolean q6;
        org.telegram.ui.ActionBar.f6 f6Var = this.f40169w.f40435a;
        if (f6Var != null) {
            q6 = f6Var.a();
        } else {
            q6 = org.telegram.ui.ActionBar.j6.I.q();
        }
        Paint paint = this.f40163c;
        Paint paint2 = this.f40162b;
        ...
        this.f40166n = peerColor.hasColor3();
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        canvas.save();
        float a2 = this.f40167r.a(0.05f);
        canvas.scale(a2, a2, getMeasuredWidth() / 2.0f, getMeasuredHeight() / 2.0f);
        canvas.save();
        canvas.clipPath(this.f40164e);
        canvas.drawPaint(this.f40162b);
        if (this.h) {
            canvas.drawPath(this.f40165f, this.f40163c);
        }
        canvas.restore();
        if (this.f40166n) {
            canvas.save();
        ...
        float e7 = this.v.e(this.f40168s);
        if (e7 > 0.0f) {
            float dpf2 = AndroidUtilities.dpf2(2.0f);
            Paint paint = this.f40161a;
