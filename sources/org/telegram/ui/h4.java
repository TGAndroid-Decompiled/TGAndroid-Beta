...
public final class h4 extends FrameLayout {
    public final org.telegram.ui.Components.ko0 f34749a;
    public final int f34750b;
    public final int f34751c;
    public int d;
    public final TextPaint e;
    public final l4 f34752f;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.d != size) {
            ...
            int i13 = this.f34750b;
            this.f34749a.setProgress((i12 - i13) / (this.f34751c - i13));
            this.d = size;
        }
    }
}
