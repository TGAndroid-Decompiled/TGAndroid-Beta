...
public final class h4 extends AnimatorListenerAdapter {
    ...
    public final ArticleViewer$WindowView f36875b;

    public h4(ArticleViewer$WindowView articleViewer$WindowView, boolean z10) {
        this.f36875b = articleViewer$WindowView;
        this.f36874a = z10;
    }

    @Override
    public final void onAnimationEnd(Animator animator) {
        ArticleViewer$WindowView articleViewer$WindowView = this.f36875b;
        i4 i4Var = articleViewer$WindowView.H;
        boolean z10 = articleViewer$WindowView.f21568e;
        boolean z11 = this.f36874a;
        if (z10) {
            Object obj = null;
