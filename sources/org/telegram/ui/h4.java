...
public final class h4 extends AnimatorListenerAdapter {
    ...
    public final ArticleViewer$WindowView f34120b;

    public h4(ArticleViewer$WindowView articleViewer$WindowView, boolean z10) {
        this.f34120b = articleViewer$WindowView;
        this.f34119a = z10;
    }

    @Override
    public final void onAnimationEnd(Animator animator) {
        ArticleViewer$WindowView articleViewer$WindowView = this.f34120b;
        i4 i4Var = articleViewer$WindowView.H;
        boolean z10 = articleViewer$WindowView.e;
        boolean z11 = this.f34119a;
        if (z10) {
            Object obj = null;
