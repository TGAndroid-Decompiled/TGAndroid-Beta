...
public final class h4 extends AnimatorListenerAdapter {
    ...
    public final ArticleViewer$WindowView f34106b;

    public h4(ArticleViewer$WindowView articleViewer$WindowView, boolean z10) {
        this.f34106b = articleViewer$WindowView;
        this.f34105a = z10;
    }

    @Override
    public final void onAnimationEnd(Animator animator) {
        ArticleViewer$WindowView articleViewer$WindowView = this.f34106b;
        i4 i4Var = articleViewer$WindowView.H;
        boolean z10 = articleViewer$WindowView.e;
        boolean z11 = this.f34105a;
        if (z10) {
            Object obj = null;
