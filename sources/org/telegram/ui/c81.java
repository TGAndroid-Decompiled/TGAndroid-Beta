...
public final class c81 extends FrameLayout {
    public final ImageView f32711a;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.e) {
            canvas.drawRect(AndroidUtilities.dp(64.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight(), org.telegram.ui.ActionBar.i6.f18958k0);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (r02 != null) {
            ...
            sb2.append((Object) this.f32712b.getText());
            sb2.append("\n");
            sb2.append((Object) this.f32713c.getText());
            sb2.append("\n");
            if (r02.h) {
