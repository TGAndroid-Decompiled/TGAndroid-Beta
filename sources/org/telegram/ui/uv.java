...
public final class uv implements DialogInterface.OnClickListener {
    ...
    public final NotificationCenter.NotificationCenterDelegate f38169b;

    public uv(NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, int i10) {
        this.f38168a = i10;
        this.f38169b = notificationCenterDelegate;
    }
    ...
    public final void onClick(DialogInterface dialogInterface, int i10) {
        ...
        switch (this.f38168a) {
            case 0:
                uy uyVar = (uy) this.f38169b;
                if (i10 == 0) {
                    uyVar.getMessagesStorage().readAllDialogs(1);
                    return;
                } else if (i10 != 1 || uyVar.f38207e0 == null) {
                    return;
                } else {
                    while (true) {
                        ...
                        if (i11 < tyVarArr.length) {
                            ...
                            if (tyVar.f37809s == 0 && tyVar.getVisibility() == 0) {
                                org.telegram.ui.Cells.r2 Q3 = uy.Q3(uyVar.f38207e0[i11]);
                                qy qyVar = uyVar.f38207e0[i11].f37803a;
                                int i12 = qy.f36955v3;
                                qyVar.z1(true, Q3);
                            }
                            i11++;
