...
public final class ik implements rt {
    ...
    @Override
    public final long a() {
        return this.f33747a.T5;
    }

    @Override
    public final boolean b() {
        return this.f33747a.D6();
    }

    @Override
    public final boolean c() {
        if (this.f33747a.R3 == 1) {
            return true;
        }
        return false;
    }
    ...
    public final void l(TLRPC.Document document, String str, Object obj, boolean z10, int i10, int i11) {
        this.f33747a.Y.d(document, str, obj, null, true, z10, i10, i11);
    }
