        ...
        if (sbVar.B != null && sbVar.D != null && (i14 = sbVar.O0) >= 0) {
            if (sbVar.N0 != 0) {
                ...
                while (true) {
                    ob obVar = sbVar.F;
                    if (i15 < obVar.d) {
                        if (i15 >= obVar.f36863f && i15 < obVar.h) {
                            ArrayList arrayList = obVar.f36864n.f38269p0;
                            messageObject = (MessageObject) arrayList.get((arrayList.size() - (i15 - obVar.f36863f)) - 1);
                        } else {
                            messageObject = null;
                        }
