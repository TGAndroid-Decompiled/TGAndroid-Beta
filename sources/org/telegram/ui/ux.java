...
public final class ux extends AnimatorListenerAdapter {
    ...
    public void onAnimationCancel(Animator animator) {
        switch (this.f38177a) {
            case 0:
                uy uyVar = this.f38179c;
                uyVar.f38258o3.unlock();
                if (uyVar.f38299w1 == animator) {
                    if (this.f38178b) {
                        uyVar.f38207e0[0].f37803a.c1();
                    } else {
                        qy qyVar = uyVar.f38207e0[0].f37803a;
                        if (qyVar.f25952i1) {
                            qyVar.f25952i1 = false;
                            qyVar.K0(false);
                        }
                    }
                    uyVar.f38299w1 = null;
            ...
            case 0:
                ...
                if (uyVar.f38299w1 == animator) {
                    ...
                    if (z10) {
                        ...
                        uyVar.f38233j0.setVisibility(8);
                        ox oxVar = uyVar.F3;
                        if (oxVar != null) {
                            oxVar.setVisibility(8);
                        }
                    } else {
                        uyVar.f38274r3 = false;
                        ey eyVar = uyVar.C0;
                        if (eyVar != null) {
                    ...
                    uyVar.D4(f7);
                    uyVar.f38207e0[0].f37803a.setVerticalScrollBarEnabled(true);
                    ey eyVar3 = uyVar.C0;
                    if (eyVar3 != null) {
                ...
                return;
            case 1:
                uy uyVar2 = this.f38179c;
                uyVar2.P3 = null;
                if (!this.f38178b && (v0Var = uyVar2.m0) != null) {
                    v0Var.setVisibility(8);
                    return;
                }
                return;
            default:
                uy uyVar3 = this.f38179c;
                uyVar3.I = null;
                ...
                if (!z11) {
                    uyVar3.C4(0.0f);
                    uyVar3.f38307x3 = AndroidUtilities.dp(81.0f);
                } else {
                    uyVar3.f38307x3 = -AndroidUtilities.dp(81.0f);
                    uyVar3.C4(-uyVar3.U3());
                }
