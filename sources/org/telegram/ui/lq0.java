...
public final class lq0 extends org.telegram.ui.Components.aw0 {
    public int f35400w0;
    public boolean f35401x0;
    public int f35402y0;
    public final tq0 f35403z0;

    public lq0(tq0 tq0Var, Context context) {
        super(context, null);
        this.f35403z0 = tq0Var;
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (R > AndroidUtilities.dp(20.0f) && (kuVar = tq0Var.f38194d0) != null) {
            this.f35401x0 = true;
            kuVar.j();
            this.f35401x0 = false;
        }
        ...
        for (int i14 = 0; i14 < childCount; i14++) {
            ...
            if (childAt != null && childAt.getVisibility() != 8) {
                org.telegram.ui.Components.ku kuVar3 = tq0Var.f38194d0;
