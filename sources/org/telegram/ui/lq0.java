...
public final class lq0 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public kq0 V;
    public CharSequence f35600a;
    public final HashMap f35601b;
    public final ArrayList f35602c;
    public ArrayList d;
    public boolean e;
    public int f35603f;
    public org.telegram.ui.Components.ml0 h;
    public jq0 f35604n;
    public FrameLayout f35605r;
    public TextView f35606s;
    public boolean v;
    public final int f35607w;
    public boolean f35608x;
    ...
    public static void U(lq0 lq0Var, MediaController.AlbumEntry albumEntry) {
        if (albumEntry != null) {
            cr0 cr0Var = new cr0(0, albumEntry, lq0Var.f35601b, lq0Var.f35602c, lq0Var.f35607w, lq0Var.E, lq0Var.F, false);
            ...
            cr0Var.f32895s0 = new hq0(lq0Var);
        ...
        if (lq0Var.f35609y) {
            ir0 ir0Var = new ir0(hashMap, arrayList, lq0Var.f35607w, lq0Var.E, lq0Var.F);
            Editable text2 = lq0Var.M.getText();
            lq0Var.f35600a = text2;
            cr0 cr0Var2 = ir0Var.f34657a;
            if (cr0Var2 != null) {
                cr0Var2.d = text2;
                org.telegram.ui.Components.ju juVar2 = cr0Var2.f32877d0;
                if (juVar2 != null) {
                    juVar2.setText(text2);
                }
            }
            iq0 iq0Var = new iq0(lq0Var, hashMap, arrayList);
            cr0 cr0Var3 = ir0Var.f34657a;
            cr0Var3.f32895s0 = iq0Var;
            cr0 cr0Var4 = ir0Var.f34658b;
            cr0Var4.f32895s0 = iq0Var;
            cr0Var3.f32896t0 = new hr0(ir0Var, 0);
            cr0Var4.f32896t0 = new hr0(ir0Var, 1);
            int i10 = lq0Var.G;
            boolean z10 = lq0Var.H;
            cr0Var3.f0(i10, z10);
            ir0Var.f34658b.f0(i10, z10);
            lq0Var.presentFragment(ir0Var);
            return;
        }
        cr0 cr0Var5 = new cr0(0, albumEntry, hashMap, arrayList, lq0Var.f35607w, lq0Var.E, lq0Var.F, false);
        Editable text3 = lq0Var.M.getText();
        lq0Var.f35600a = text3;
        cr0Var5.d = text3;
        org.telegram.ui.Components.ju juVar3 = cr0Var5.f32877d0;
        if (juVar3 != null) {
            juVar3.setText(text3);
        }
        cr0Var5.f32895s0 = new eq0(lq0Var, hashMap, arrayList);
    ...
    public final View createView(Context context) {
        ...
        this.f35606s = textView;
        textView.setTextColor(-8355712);
        this.f35606s.setTextSize(1, 20.0f);
        this.f35606s.setGravity(17);
        this.f35606s.setVisibility(8);
        this.f35606s.setText(LocaleController.getString(R.string.NoPhotos));
        this.P.addView(this.f35606s, w7.x5.d(-1, -1.0f, 51, 0.0f, 0.0f, 0.0f, 48.0f));
        this.f35606s.setOnTouchListener(new bi.d(2));
        FrameLayout frameLayout = new FrameLayout(context);
        this.f35605r = frameLayout;
        frameLayout.setVisibility(8);
        this.P.addView(this.f35605r, w7.x5.d(-1, -1.0f, 51, 0.0f, 0.0f, 0.0f, 48.0f));
        RadialProgressView radialProgressView = new RadialProgressView(context, null);
        radialProgressView.setProgressColor(-11371101);
        this.f35605r.addView(radialProgressView, w7.x5.e(-2, -2, 17));
        ...
        CharSequence charSequence = this.f35600a;
        if (charSequence != null) {
        ...
        if (this.e && ((arrayList = this.d) == null || arrayList.isEmpty())) {
            this.f35605r.setVisibility(0);
            this.h.setEmptyView(null);
        } else {
            this.f35605r.setVisibility(8);
            this.h.setEmptyView(this.f35606s);
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.albumsDidLoad) {
            if (this.classGuid == ((Integer) objArr[0]).intValue()) {
                int i12 = this.f35607w;
                if (i12 != 1 && i12 != 2 && i12 != 10 && this.f35608x) {
                    this.d = (ArrayList) objArr[1];
                } else {
                    this.d = (ArrayList) objArr[2];
                }
                FrameLayout frameLayout = this.f35605r;
                if (frameLayout != null) {
                    frameLayout.setVisibility(8);
                }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.h, 0, new Class[]{View.class}, null, new Drawable[]{org.telegram.ui.ActionBar.j6.R4}, null, org.telegram.ui.ActionBar.j6.f18866da));
    ...
    public final boolean onFragmentCreate() {
        int i10 = this.f35607w;
        boolean z10 = true;
        if (i10 != 1 && i10 != 2 && i10 != 10 && this.f35608x) {
