...
public final class al extends org.telegram.ui.Components.gk0 {
    public final int[] l1;
    public ValueAnimator f31816m1;
    public boolean f31817n1;
    public final xn f31818o1;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        kVar = ((org.telegram.ui.ActionBar.n2) this.f31818o1).actionBar;
        ...
        if (k10 != null) {
            ...
            if (z11) {
                s(f7 - x10, !this.f31817n1);
            } else {
                s(f7 - width, !this.f31817n1);
            }
            this.f31817n1 = false;
        }
    }
    ...
    public final void s(float f7, boolean z10) {
        ValueAnimator valueAnimator = this.f31816m1;
        ...
        this.f31816m1 = ofFloat;
        ofFloat.addUpdateListener(new c3(this, 6));
        this.f31816m1.setInterpolator(org.telegram.ui.Components.rr.h);
        this.f31816m1.setDuration(420L);
        this.f31816m1.start();
    }
}
