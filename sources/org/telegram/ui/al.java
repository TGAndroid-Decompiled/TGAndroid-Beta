...
public final class al extends org.telegram.ui.Components.qk0 {
    public final int[] f35211i1;
    public ValueAnimator f35212j1;
    public boolean f35213k1;
    public final xn l1;
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        if (k10 != null) {
            ...
            if (z10) {
                s(f10 - x10, !this.f35213k1);
            } else {
                s(f10 - width, !this.f35213k1);
            }
            this.f35213k1 = false;
        }
    }
    ...
    public final void s(float f10, boolean z4) {
        ValueAnimator valueAnimator = this.f35212j1;
        ...
        this.f35212j1 = ofFloat;
        ofFloat.addUpdateListener(new e3(this, 6));
        this.f35212j1.setInterpolator(org.telegram.ui.Components.pr.h);
        this.f35212j1.setDuration(420L);
        this.f35212j1.start();
    }
}
