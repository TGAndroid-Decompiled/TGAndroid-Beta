...
public final class x20 implements org.telegram.ui.Components.yc0 {
    public final int f39324a;
    public final long f39325b;
    public final Calendar f39326c;
    public final int d;

    public x20(long j3, Calendar calendar, int i10, int i11) {
        this.f39324a = i11;
        this.f39325b = j3;
        this.f39326c = calendar;
        this.d = i10;
    }
    ...
    public final String e(int i10) {
        switch (this.f39324a) {
            case 0:
                ...
                long j3 = (i10 * 86400000) + this.f39325b;
                Calendar calendar = this.f39326c;
            ...
            default:
                ...
                long j10 = (i10 * 86400000) + this.f39325b;
                Calendar calendar2 = this.f39326c;
