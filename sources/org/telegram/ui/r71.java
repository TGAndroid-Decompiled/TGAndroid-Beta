...
public final class r71 implements RequestDelegate {
    ...
    public final SessionsActivity f37935b;

    public r71(SessionsActivity sessionsActivity, int i10) {
        this.f37934a = i10;
        this.f37935b = sessionsActivity;
    }
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f37934a) {
            case 0:
                AndroidUtilities.runOnUIThread(new vy0(this.f37935b, 19));
                return;
            case 1:
                final SessionsActivity sessionsActivity = this.f37935b;
                ...
                return;
            case 2:
                final SessionsActivity sessionsActivity2 = this.f37935b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        org.telegram.ui.Components.qc a02;
                ...
                return;
            default:
                final SessionsActivity sessionsActivity3 = this.f37935b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        org.telegram.ui.Components.qc a02;
