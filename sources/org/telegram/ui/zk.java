...
public final class zk extends org.telegram.ui.Components.jn0 {
    ...
    public final boolean f(zg.p0 p0Var) {
        ...
        boVar.Ic();
        boVar.vc();
        boVar.f32454t3 = boVar.f32327j0.getSearchField().getText().toString();
        MediaDataController mediaDataController = boVar.getMediaDataController();
        String str = boVar.f32454t3;
        long j3 = boVar.T5;
        long j10 = boVar.L6;
        i10 = ((org.telegram.ui.ActionBar.o2) boVar).classGuid;
        long j11 = boVar.f32257d4;
        TLRPC.User user = boVar.f32390o3;
        TLRPC.Chat chat = boVar.f32402p3;
        if (TextUtils.isEmpty(boVar.f32454t3) && boVar.f32414q3 == null) {
            z11 = false;
        } else {
            z11 = true;
        }
        mediaDataController.searchMessagesInChat(str, j3, j10, i10, 0, j11, false, user, chat, z11, boVar.f32414q3);
        AndroidUtilities.hideKeyboard(boVar.f32327j0.getSearchField());
        return true;
    }
    ...
    public final void h(boolean z10) {
        ...
        if (w0Var != null && w0Var.s() && a() && boVar.f32466u3 == null) {
            z11 = true;
        } else {
            z11 = false;
        }
