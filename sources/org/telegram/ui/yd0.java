...
public final class yd0 implements Runnable {
    public final int f39848a = 0;
    public final ge0 f39849b;
    public final TLRPC.TL_error f39850c;
    public final TLObject d;
    public final String e;

    public yd0(ge0 ge0Var, TLRPC.TL_error tL_error, String str, TLObject tLObject) {
        this.f39849b = ge0Var;
        this.f39850c = tL_error;
        this.e = str;
        this.d = tLObject;
    }
    ...
    public final void run() {
        ...
        switch (this.f39848a) {
            case 0:
                final ge0 ge0Var = this.f39849b;
                de0 de0Var = ge0Var.f33876a;
                wg0 wg0Var = ge0Var.W;
                wg0Var.k1(false, true);
                TLRPC.TL_error tL_error = this.f39850c;
                String str = this.e;
                if (tL_error == null) {
                    ge0Var.E = false;
                ...
                return;
            default:
                final ge0 ge0Var2 = this.f39849b;
                ge0Var2.E = false;
                wg0 wg0Var2 = ge0Var2.W;
                wg0Var2.v1(false, true);
                TLRPC.TL_error tL_error2 = this.f39850c;
                if (tL_error2 == null) {
