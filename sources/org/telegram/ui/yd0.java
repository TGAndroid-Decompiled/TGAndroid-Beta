...
public final class yd0 implements Runnable {
    public final int f39815a = 0;
    public final ge0 f39816b;
    public final TLRPC.TL_error f39817c;
    public final TLObject d;
    public final String e;

    public yd0(ge0 ge0Var, TLRPC.TL_error tL_error, String str, TLObject tLObject) {
        this.f39816b = ge0Var;
        this.f39817c = tL_error;
        this.e = str;
        this.d = tLObject;
    }
    ...
    public final void run() {
        ...
        switch (this.f39815a) {
            case 0:
                final ge0 ge0Var = this.f39816b;
                de0 de0Var = ge0Var.f33827a;
                wg0 wg0Var = ge0Var.W;
                wg0Var.k1(false, true);
                TLRPC.TL_error tL_error = this.f39817c;
                String str = this.e;
                if (tL_error == null) {
                    ge0Var.E = false;
                ...
                return;
            default:
                final ge0 ge0Var2 = this.f39816b;
                ge0Var2.E = false;
                wg0 wg0Var2 = ge0Var2.W;
                wg0Var2.v1(false, true);
                TLRPC.TL_error tL_error2 = this.f39817c;
                if (tL_error2 == null) {
