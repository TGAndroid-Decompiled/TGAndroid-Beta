...
public final class sr0 implements Runnable {
    ...
    public final void run() {
        ...
        Object obj = this.h;
        Serializable serializable = this.f37445f;
        Object obj2 = this.e;
        switch (i10) {
            case 0:
                ...
                photoViewer.f30918c2 = 2;
                photoViewer.f31076u2 = false;
                photoViewer.d = new eu0(photoViewer, photoViewer.d, messageObject, orientation, this.f37444c, this.d);
                photoViewer.f31030p1.l();
                ...
                photoViewer.f30934e0.setAlpha(1.0f);
            ...
            default:
                ...
                int i13 = ((int[]) obj)[0];
                if (i12 == i13) {
                    vu0 vu0Var = ss0Var.f37457b.f30934e0;
                    boolean z11 = this.f37443b;
                    boolean z12 = this.f37444c;
                    int i14 = z11 ? 1 : 0;
                    boolean z13 = this.d;
                    if ((z12 ? 1 : 0) + i14 + (z13 ? 1 : 0) > 1) {
                        ...
                        if (i13 > 1) {
                            ucVar = org.telegram.ui.Components.uc.f28334s;
                        } else {
                            ucVar = org.telegram.ui.Components.uc.f28333r;
                        }
                    } else if (z11) {
                        if (i13 > 1) {
                            ucVar = org.telegram.ui.Components.uc.f28332n;
                        } else {
                            ucVar = org.telegram.ui.Components.uc.h;
                        }
                    } else if (i13 > 1) {
                        ucVar = org.telegram.ui.Components.uc.f28331f;
                    } else {
