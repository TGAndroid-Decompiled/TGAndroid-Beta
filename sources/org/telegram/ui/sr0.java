...
public final class sr0 implements Runnable {
    public final int f40532a = 0;
    public final boolean f40533b;
    public final boolean f40534c;
    public final boolean d;
    public final Object f40535e;
    public final Serializable f40536f;
    ...
    public final void run() {
        ...
        Object obj = this.h;
        Serializable serializable = this.f40536f;
        Object obj2 = this.f40535e;
        switch (i10) {
            case 0:
                ...
                photoViewer.f33559c2 = 2;
                photoViewer.f33718u2 = false;
                photoViewer.d = new du0(photoViewer, photoViewer.d, messageObject, orientation, this.f40534c, this.d);
                photoViewer.f33672p1.l();
            ...
            default:
                ...
                int i13 = ((int[]) obj)[0];
                if (i12 == i13) {
                    uu0 uu0Var = rs0Var.f40257b.f33576e0;
                    boolean z11 = this.f40533b;
                    boolean z12 = this.f40534c;
                    int i14 = z11 ? 1 : 0;
                    boolean z13 = this.d;
                    if ((z12 ? 1 : 0) + i14 + (z13 ? 1 : 0) > 1) {
                        ...
                        if (i13 > 1) {
                            xcVar = org.telegram.ui.Components.xc.f32527s;
                        } else {
                            xcVar = org.telegram.ui.Components.xc.f32526r;
                        }
                    } else if (z11) {
                        if (i13 > 1) {
                            xcVar = org.telegram.ui.Components.xc.f32525n;
                        } else {
                            xcVar = org.telegram.ui.Components.xc.h;
                        }
                    } else if (i13 > 1) {
                        xcVar = org.telegram.ui.Components.xc.f32524f;
                    } else {
                        xcVar = org.telegram.ui.Components.xc.f32523e;
                    }
