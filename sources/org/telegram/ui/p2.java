...
public final class p2 extends FrameLayout implements org.telegram.ui.Cells.p9 {
    public final k2 f36297a;
    public final n2 f36298b;
    public final o2 f36299c;
    ...
    public int f36301n;
    public int f36302r;
    public float f36303s;
    public int v;
    public final f4 f36304w;
    public final h4 f36305x;
    ...
    public p2(h4 h4Var, Context context, f4 f4Var) {
        ...
        AndroidUtilities.setViewPagerEdgeEffectColor(k2Var, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19062d6, false));
        addView(k2Var);
    ...
    public final void onDraw(Canvas canvas) {
        if (this.d != null) {
            a3 a3Var = this.e;
            h4 h4Var = this.f36305x;
            int i10 = this.h;
            int i11 = 0;
            if (a3Var != null) {
                canvas.save();
                canvas.translate(i10, this.f36301n);
            ...
            if (this.f36300f != null) {
                canvas.save();
                canvas.translate(i10, this.f36301n + this.f36302r);
                h4.v(h4Var, canvas, this, i11);
                this.f36300f.draw(canvas, this);
                canvas.restore();
            }
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f36300f != null) {
            sb2.append(", ");
            sb2.append(this.f36300f.d.getText());
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.d != null) {
            ...
            this.f36297a.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(dp, 1073741824));
            this.d.items.size();
            this.f36299c.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(10.0f), 1073741824));
            ...
            h4 h4Var = this.f36305x;
            a3 p5 = h4.p(h4Var, this, null, richText, dp2, dp3, pageblockslideshow, alignment, 0, this.f36304w);
            this.e = p5;
            int i13 = this.h;
            if (p5 != null) {
            ...
            a3 p10 = h4.p(h4Var, this, null, richText2, dp2, 0, pageblockslideshow2, alignment, 0, this.f36304w);
            this.f36300f = p10;
            if (p10 != null) {
                dp += this.f36300f.d.getHeight() + AndroidUtilities.dp(4.0f);
                a3 a3Var2 = this.f36300f;
                a3Var2.f31935s = i13;
                a3Var2.v = this.f36301n + this.f36302r;
            }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        h4 h4Var = this.f36305x;
        if (!h4.l(h4Var, this.f36304w, motionEvent, this, a3Var, i10, i11)) {
            if (!h4.l(h4Var, this.f36304w, motionEvent, this, this.f36300f, this.h, this.f36301n + this.f36302r) && !super.onTouchEvent(motionEvent)) {
                return false;
            }
            return true;
        }
