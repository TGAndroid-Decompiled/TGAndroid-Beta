...
public final class if0 extends org.telegram.ui.Components.tv0 {
    public final wg0 E;
    public final org.telegram.ui.Components.aj0 f37350a;
    public final TextView f37351b;
    public final TextView f37352c;
    public final TextView d;
    public final TextView f37353e;
    public final TextView f37354f;
    public w5 h;
    public Bundle f37355n;
    public String f37356r;
    public String f37357s;
    public String v;
    public int f37358w;
    public int f37359x;
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        this.f37355n = bundle;
        this.f37356r = bundle.getString("phoneFormated");
        this.f37357s = bundle.getString("phoneHash");
        this.v = bundle.getString("code");
        this.f37358w = bundle.getInt("startTime");
        this.f37359x = bundle.getInt("waitTime");
        int i10 = R.string.ResetAccountInfo;
        gf.b c10 = gf.b.c();
        this.f37352c.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ResetAccountInfo", i10, LocaleController.addNbsp(c10.b("+" + this.f37356r)))));
        o();
    ...
    public final void n() {
        ...
        this.f37351b.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        this.f37352c.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        this.f37354f.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        this.f37353e.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
    ...
    public final void o() {
        ...
        int i11;
        int i12;
        int i13 = this.f37359x;
        i10 = ((org.telegram.ui.ActionBar.n2) this.E).currentAccount;
        int currentTime = i13 - (ConnectionsManager.getInstance(i10).getCurrentTime() - this.f37358w);
        int i14 = 0;
        ...
        int i17 = (max / 60) % 60;
        int i18 = max % 60;
        TextView textView = this.f37353e;
        if (i15 >= 2) {
        ...
        Boolean bool = this.f37360y;
        if (bool != null && bool.booleanValue() == z10) {
            return;
        }
        org.telegram.ui.Components.aj0 aj0Var = this.f37350a;
        if (!z10) {
        ...
        this.f37354f.setVisibility(i12);
        if (!z10) {
            i14 = 4;
        }
        this.d.setVisibility(i14);
        this.f37360y = Boolean.valueOf(z10);
    }
}
