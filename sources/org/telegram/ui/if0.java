...
public final class if0 extends org.telegram.ui.Components.tv0 {
    public final wg0 E;
    public final org.telegram.ui.Components.aj0 f37377a;
    public final TextView f37378b;
    public final TextView f37379c;
    public final TextView d;
    public final TextView f37380e;
    public final TextView f37381f;
    public w5 h;
    public Bundle f37382n;
    public String f37383r;
    public String f37384s;
    public String v;
    public int f37385w;
    public int f37386x;
    public Boolean f37387y;
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        this.f37382n = bundle;
        this.f37383r = bundle.getString("phoneFormated");
        this.f37384s = bundle.getString("phoneHash");
        this.v = bundle.getString("code");
        this.f37385w = bundle.getInt("startTime");
        this.f37386x = bundle.getInt("waitTime");
        int i10 = R.string.ResetAccountInfo;
        gf.b c10 = gf.b.c();
        this.f37379c.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ResetAccountInfo", i10, LocaleController.addNbsp(c10.b("+" + this.f37383r)))));
        o();
    ...
    public final void n() {
        ...
        this.f37378b.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        this.f37379c.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        this.f37381f.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        this.f37380e.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
    ...
    public final void o() {
        ...
        int i11;
        int i12;
        int i13 = this.f37386x;
        i10 = ((org.telegram.ui.ActionBar.n2) this.E).currentAccount;
        int currentTime = i13 - (ConnectionsManager.getInstance(i10).getCurrentTime() - this.f37385w);
        int i14 = 0;
        ...
        Boolean bool = this.f37387y;
        if (bool != null && bool.booleanValue() == z10) {
            return;
        }
        org.telegram.ui.Components.aj0 aj0Var = this.f37377a;
        if (!z10) {
        ...
        this.f37381f.setVisibility(i12);
        if (!z10) {
            i14 = 4;
        }
        this.d.setVisibility(i14);
        this.f37387y = Boolean.valueOf(z10);
    }
}
