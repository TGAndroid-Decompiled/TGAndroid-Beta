...
public final class if0 extends org.telegram.ui.Components.uv0 {
    public final wg0 E;
    public final org.telegram.ui.Components.aj0 f34650a;
    ...
    public w5 h;
    public Bundle f34654n;
    public String f34655r;
    public String f34656s;
    public String v;
    public int f34657w;
    public int f34658x;
    public Boolean f34659y;
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        this.f34654n = bundle;
        this.f34655r = bundle.getString("phoneFormated");
        this.f34656s = bundle.getString("phoneHash");
        this.v = bundle.getString("code");
        this.f34657w = bundle.getInt("startTime");
        this.f34658x = bundle.getInt("waitTime");
        int i10 = R.string.ResetAccountInfo;
        gf.b c10 = gf.b.c();
        this.f34652c.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ResetAccountInfo", i10, LocaleController.addNbsp(c10.b("+" + this.f34655r)))));
        o();
    ...
    public final void n() {
        ...
        this.f34651b.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, i10, false));
        this.f34652c.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, i10, false));
        this.f34653f.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, i10, false));
    ...
    public final void o() {
        ...
        int i11;
        int i12;
        int i13 = this.f34658x;
        i10 = ((org.telegram.ui.ActionBar.n2) this.E).currentAccount;
        int currentTime = i13 - (ConnectionsManager.getInstance(i10).getCurrentTime() - this.f34657w);
        int i14 = 0;
        ...
        Boolean bool = this.f34659y;
        if (bool != null && bool.booleanValue() == z10) {
            return;
        }
        org.telegram.ui.Components.aj0 aj0Var = this.f34650a;
        if (!z10) {
        ...
        this.f34653f.setVisibility(i12);
        if (!z10) {
            i14 = 4;
        }
        this.d.setVisibility(i14);
        this.f34659y = Boolean.valueOf(z10);
    }
}
