...
public final class i50 extends org.telegram.ui.Components.l30 {
    ...
    public final void n(int i10) {
        ...
        j60 j60Var = this.f37244n.f38575b;
        j60Var.f37605w0 = false;
        alertDialog$Builder.f20199a.R = LocaleController.getString(R.string.VoipGroupStartRecordingTitle);
        if (i10 == 0) {
            if (j60Var.f37514a1.call.rtmp_stream) {
                i13 = R.string.VoipGroupStartRecordingRtmpText;
            } else {
                i13 = R.string.VoipGroupStartRecordingText;
            }
            alertDialog$Builder.f20199a.T = LocaleController.getString(i13);
        ...
        alertDialog$Builder.f20199a.f20261y0 = false;
        EditTextBoldCursor editTextBoldCursor = new EditTextBoldCursor(getContext());
        editTextBoldCursor.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.T(getContext(), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20855nh, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20873oh, false)));
