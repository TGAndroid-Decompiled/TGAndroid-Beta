...
public final class bg implements org.telegram.ui.Components.yj0, org.telegram.ui.ActionBar.a2 {
    public final int f32408a;
    public final zn f32409b;
    public final MessageObject f32410c;

    public bg(zn znVar, MessageObject messageObject, int i10) {
        this.f32408a = i10;
        this.f32409b = znVar;
        this.f32410c = messageObject;
    }
    ...
    public void a(long j3, TLRPC.MessagePeerReaction messagePeerReaction) {
        switch (this.f32408a) {
            case 0:
                ...
                zn znVar = this.f32409b;
                if (messagePeerReaction != null && messagePeerReaction.reaction != null) {
                    bundle.putInt("report_reaction_message_id", this.f32410c.getId());
            ...
            default:
                ...
                if (messagePeerReaction != null && messagePeerReaction.reaction != null) {
                    bundle2.putInt("report_reaction_message_id", this.f32410c.getId());
    ...
    public void k(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        zn znVar = this.f32409b;
        org.telegram.ui.ActionBar.b2[] b2VarArr = {new org.telegram.ui.ActionBar.b2(znVar.getParentActivity(), 3, znVar.f40303ea)};
        TLRPC.TL_messages_editMessage tL_messages_editMessage = new TLRPC.TL_messages_editMessage();
        MessageObject messageObject = this.f32410c;
