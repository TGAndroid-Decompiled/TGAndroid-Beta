        ...
        switch (this.f32144a) {
            case 0:
                if (messagePeerReaction != null && messagePeerReaction.reaction != null) {
                    final bo boVar = this.f32145b;
                    if (j3 != boVar.getUserConfig().getClientUserId() && this.f32146c) {
                ...
                return;
            default:
                final bo boVar2 = this.f32145b;
                boVar2.getClass();
                if (messagePeerReaction != null && messagePeerReaction.reaction != null && j3 != boVar2.getUserConfig().getClientUserId() && this.f32146c) {
