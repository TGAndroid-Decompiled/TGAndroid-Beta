...
public final class iu extends org.telegram.ui.Components.kl0 {
    ...
    public final int j(int i10) {
        ...
        if (i10 == dataAutoDownloadActivity.f30772s) {
            return 1;
        }
        if (i10 != dataAutoDownloadActivity.f30771r && i10 != dataAutoDownloadActivity.v) {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        int i23;
        DataAutoDownloadActivity dataAutoDownloadActivity = this.d;
        int i24 = dataAutoDownloadActivity.f30769f;
        DownloadController.Preset preset = dataAutoDownloadActivity.G;
        int i25 = c1Var.f42674f;
        ...
        if (i25 != 0) {
                ...
                if (i25 != 3) {
                    ...
                    if (i25 != 4) {
                        if (i25 == 5) {
                            ...
                            if (i10 == dataAutoDownloadActivity.f30773w) {
                                e9Var.setText(LocaleController.getString(R.string.AutoDownloadAudioInfo));
                                e9Var.setFixedSize(0);
                                e9Var.setImportantForAccessibility(1);
                                return;
                            } else if (i10 == dataAutoDownloadActivity.f30770n) {
                                if (dataAutoDownloadActivity.f30771r == -1) {
                                    if (i24 == 0) {
            ...
            if (i10 == dataAutoDownloadActivity.f30771r) {
        ...
        if (i10 == i11) {
            ...
            if (preset.enabled) {
                i12 = org.telegram.ui.ActionBar.i6.f18870f6;
            } else {
                i12 = org.telegram.ui.ActionBar.i6.f18853e6;
            }
            w8Var.setTag(Integer.valueOf(i12));
            if (preset.enabled) {
                i13 = org.telegram.ui.ActionBar.i6.f18870f6;
            } else {
                i13 = org.telegram.ui.ActionBar.i6.f18853e6;
            }
                ...
                if (i10 != 2) {
                    if (i10 != 3) {
                        if (i10 != 4) {
                            ...
                            tv0Var = new org.telegram.ui.Cells.j5(context);
                        }
                    } else {
                    ...
                    tv0Var = new org.telegram.ui.Cells.m4(context);
                }
            } else {
