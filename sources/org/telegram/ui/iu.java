...
public final class iu implements Runnable {
    ...
    public final DataSettingsActivity f37780b;

    public iu(DataSettingsActivity dataSettingsActivity, int i10) {
        this.f37779a = i10;
        this.f37780b = dataSettingsActivity;
    }
    ...
    public final void run() {
        ...
        switch (this.f37779a) {
            case 0:
                this.f37780b.getMediaDataController().clearAllDrafts(true);
                return;
            case 1:
                DataSettingsActivity dataSettingsActivity = this.f37780b;
            ...
            default:
                b7.f35371j0 = null;
                DataSettingsActivity dataSettingsActivity2 = this.f37780b;
