...
public final class iu extends org.telegram.ui.Components.kl0 {
    ...
    public final int j(int i10) {
        ...
        if (i10 == dataAutoDownloadActivity.f30775s) {
            return 1;
        }
        if (i10 != dataAutoDownloadActivity.f30774r && i10 != dataAutoDownloadActivity.v) {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        int i23;
        DataAutoDownloadActivity dataAutoDownloadActivity = this.d;
        int i24 = dataAutoDownloadActivity.f30772f;
        DownloadController.Preset preset = dataAutoDownloadActivity.G;
        int i25 = c1Var.f42678f;
        ...
        if (i25 != 0) {
                ...
                if (i25 != 3) {
                    ...
                    if (i25 != 4) {
                        if (i25 == 5) {
                            ...
                            if (i10 == dataAutoDownloadActivity.f30776w) {
                                e9Var.setText(LocaleController.getString(R.string.AutoDownloadAudioInfo));
                                e9Var.setFixedSize(0);
                                e9Var.setImportantForAccessibility(1);
                                return;
                            } else if (i10 == dataAutoDownloadActivity.f30773n) {
                                if (dataAutoDownloadActivity.f30774r == -1) {
                                    if (i24 == 0) {
            ...
            if (i10 == dataAutoDownloadActivity.f30774r) {
        ...
        if (i10 == i11) {
            ...
            if (preset.enabled) {
                i12 = org.telegram.ui.ActionBar.i6.f18872f6;
            } else {
                i12 = org.telegram.ui.ActionBar.i6.f18855e6;
            }
            w8Var.setTag(Integer.valueOf(i12));
            if (preset.enabled) {
                i13 = org.telegram.ui.ActionBar.i6.f18872f6;
            } else {
                i13 = org.telegram.ui.ActionBar.i6.f18855e6;
            }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
                ...
                if (i10 != 2) {
                    if (i10 != 3) {
                        if (i10 != 4) {
                            ...
                            tv0Var = new org.telegram.ui.Cells.i5(context);
                        }
                    } else {
                        org.telegram.ui.Components.tv0 tv0Var2 = new org.telegram.ui.Components.tv0(context, null);
                        tv0Var2.setCallback(new hu(this, 0));
                        tv0Var = tv0Var2;
                    }
                } else {
                    tv0Var = new org.telegram.ui.Cells.l4(context);
                }
            } else {
            ...
            w8Var.d(org.telegram.ui.ActionBar.i6.f18890g6, org.telegram.ui.ActionBar.i6.O6, org.telegram.ui.ActionBar.i6.P6, org.telegram.ui.ActionBar.i6.Q6, org.telegram.ui.ActionBar.i6.R6);
            w8Var.setTypeface(AndroidUtilities.bold());
            w8Var.setHeight(56);
            tv0Var = w8Var;
        }
        return com.google.android.gms.internal.vision.e2.k(tv0Var, tv0Var, -1, -2);
    }
}
