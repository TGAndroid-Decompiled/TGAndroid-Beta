...
public final class yx0 extends ClickableSpan {
    ...
    public final void onClick(View view) {
        ...
        ((ClipboardManager) ApplicationLoader.applicationContext.getSystemService("clipboard")).setPrimaryClip(ClipData.newPlainText("label", this.f40056a));
        org.telegram.ui.Components.xc a02 = org.telegram.ui.Components.xc.a0(this.f40057b.d);
        String string = LocaleController.getString(R.string.LinkCopied);
        org.telegram.ui.ActionBar.f6 resourceProvider = this.f40057b.d.getResourceProvider();
        a02.getClass();
