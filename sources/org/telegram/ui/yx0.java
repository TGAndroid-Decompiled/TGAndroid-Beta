...
public final class yx0 extends ClickableSpan {
    ...
    public final void onClick(View view) {
        ...
        ((ClipboardManager) ApplicationLoader.applicationContext.getSystemService("clipboard")).setPrimaryClip(ClipData.newPlainText("label", this.f43234a));
        org.telegram.ui.Components.yc a02 = org.telegram.ui.Components.yc.a0(this.f43235b.d);
        String string = LocaleController.getString(R.string.LinkCopied);
        org.telegram.ui.ActionBar.f6 resourceProvider = this.f43235b.d.getResourceProvider();
        a02.getClass();
