...
public final class yx0 implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        switch (this.f40036a) {
            case 0:
                PrivacyControlActivity privacyControlActivity = this.f40037b.d;
                privacyControlActivity.L = ((Integer) obj).intValue();
                AndroidUtilities.updateVisibleRow(privacyControlActivity.d, privacyControlActivity.f31220j0);
