...
public final class yx0 implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        switch (this.f40031a) {
            case 0:
                PrivacyControlActivity privacyControlActivity = this.f40032b.d;
                privacyControlActivity.L = ((Integer) obj).intValue();
                AndroidUtilities.updateVisibleRow(privacyControlActivity.d, privacyControlActivity.f31216j0);
            ...
            default:
                ...
                privacyControlActivity2.getConnectionsManager().sendRequest(updatebirthday, new ps0(ay0Var, userFull, tL_birthday, 1), 1024);
