...
public final class nc1 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        switch (this.f35852a) {
            case 0:
                od1 od1Var = this.f35854c;
                od1Var.F0.setRotation(this.f35853b);
                this.f35853b -= 45;
                od1Var.F0.animate().rotationBy(-45.0f).setDuration(300L).setInterpolator(org.telegram.ui.Components.rr.f28031g).start();
                dd1[] dd1VarArr = od1Var.f36211w0;
                ...
                if (dd1Var != null) {
                    ...
                    if (background instanceof org.telegram.ui.Components.mc0) {
                        ...
                        if (od1Var.f36155b == 2) {
                            od1Var.f36177h1 += 45;
                            while (true) {
                                int i10 = od1Var.f36177h1;
                                if (i10 >= 360) {
                                    od1Var.f36177h1 = i10 - 360;
                                } else {
                ...
                return;
            default:
                od1 od1Var2 = this.f35854c;
                org.telegram.ui.ActionBar.o5 o5Var = od1Var2.R;
                od1Var2.G0.setRotation(this.f35853b);
                this.f35853b -= 45;
                od1Var2.G0.animate().rotationBy(-45.0f).setDuration(300L).setInterpolator(org.telegram.ui.Components.rr.f28031g).start();
                org.telegram.ui.ActionBar.f6 f6Var2 = od1Var2.f36201s;
                if (f6Var2.f18890i) {
                    if (o5Var.i() != null) {
                        o5Var.i().x(false);
                        return;
