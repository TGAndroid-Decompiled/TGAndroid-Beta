...
public final class li1 extends View {
    public final Paint f34989a;
    public final org.telegram.ui.Components.j9 f34990b;
    public org.telegram.ui.Components.f01 f34991c;
    ...
    public li1(Activity activity) {
        ...
        this.f34990b = j9Var;
        j9Var.f25211p = AndroidUtilities.dp(100.0f);
        j9Var.f25210o = AndroidUtilities.dp(30.0f);
        j9Var.f25218x = false;
        j9Var.f25214s = AndroidUtilities.dp(24.0f);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        org.telegram.ui.Components.j9 j9Var = this.f34990b;
        float e = j9Var.e() + AndroidUtilities.dp(4.0f) + AndroidUtilities.dp(7.0f) + this.f34991c.f23785c + AndroidUtilities.dp(13.0f);
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set((getWidth() - e) / 2.0f, 0.0f, (getWidth() + e) / 2.0f, getHeight());
        float dp = AndroidUtilities.dp(30.0f) / 2.0f;
        canvas.drawRoundRect(rectF, dp, dp, this.f34989a);
        canvas.save();
        canvas.translate(rectF.left + AndroidUtilities.dp(4.0f), 0.0f);
        j9Var.i(canvas);
        canvas.translate(j9Var.A + AndroidUtilities.dp(7.0f), 0.0f);
        this.f34991c.c(0.0f, dp, 1.0f, -1, canvas);
        canvas.restore();
    }
