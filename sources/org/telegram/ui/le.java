...
public final class le implements Runnable {
    ...
    public final void run() {
        ...
        switch (i12) {
            ...
            case 5:
                boVar.o9();
                AndroidUtilities.forEachViews((RecyclerView) boVar.f32524x0, (e2.h) new hg(boVar, 1));
                boVar.u7();
                dk dkVar = boVar.X2;
                if (dkVar != null) {
            ...
            case 21:
                ...
                if (glVar != null) {
                    ...
                    animatorSet.playTogether(ofFloat, ofFloat2, ObjectAnimator.ofFloat(cameraContainer, property, 0.0f), ObjectAnimator.ofFloat(boVar.f32252b3.getButtonsLayout(), property, 0.0f), ObjectAnimator.ofInt(boVar.f32252b3.getPaint(), org.telegram.ui.Components.q6.f27260b, 0), ObjectAnimator.ofFloat(boVar.f32252b3.getMuteImageView(), property, 0.0f));
                ...
                return;
            case 22:
                AndroidUtilities.forEachViews((RecyclerView) boVar.f32524x0, (e2.h) new ai.i(22));
                nm nmVar = boVar.A0;
                if (nmVar != null) {
                    nmVar.O(true);
                    return;
                ...
                return;
            case 23:
                bo boVar2 = this.f35479b;
                int i14 = boVar2.f32443qb;
                if (i14 != 0) {
                    boVar2.F(i14, boVar2.f32457rb, boVar2.f32483tb, boVar2.f32508vb, boVar2.f32471sb, boVar2.f32496ub);
                    boVar2.f32443qb = 0;
                    return;
                }
                return;
            case 24:
                if (!boVar.f32376l3 && boVar.f32524x0 != null && boVar.getParentActivity() != null && boVar.fragmentView != null) {
                    org.telegram.ui.Components.qp qpVar = boVar.f32500v2;
                    if (qpVar == null || qpVar.getTag() == null) {
                        if (boVar.f32500v2 == null) {
                            tm tmVar = boVar.X0;
                            int indexOfChild = tmVar.indexOfChild(boVar.S);
                            if (indexOfChild != -1) {
                                i10 = 1;
                                org.telegram.ui.Components.qp qpVar2 = new org.telegram.ui.Components.qp(boVar.getParentActivity(), boVar.f32297ea);
                                boVar.f32500v2 = qpVar2;
                                tmVar.addView(qpVar2, indexOfChild + 1, w7.x5.d(-2, -2.0f, 51, 10.0f, 0.0f, 10.0f, 0.0f));
                                boVar.f32500v2.setAlpha(0.0f);
                                boVar.f32500v2.setVisibility(4);
                            } else {
                                return;
                            }
                        } else {
                        ...
                        int childCount2 = boVar.f32524x0.getChildCount();
                        for (int i15 = 0; i15 < childCount2; i15++) {
                            View childAt2 = boVar.f32524x0.getChildAt(i15);
                            if ((childAt2 instanceof org.telegram.ui.Cells.t1) && (messageObject = (t1Var = (org.telegram.ui.Cells.t1) childAt2).getMessageObject()) != null && messageObject.isOutOwner() && messageObject.isSent()) {
                                org.telegram.ui.Components.qp qpVar3 = boVar.f32500v2;
                                ImageView imageView = qpVar3.f27413c;
                                ...
                                if (i17 > AndroidUtilities.dp(10.0f) + qpVar3.getMeasuredHeight()) {
                                    ...
                                    qpVar3.d.start();
                                    while (i13 < 2) {
                                        ViewPropertyAnimator interpolator = qpVar3.f27411a[i13].animate().scaleX(1.04f).scaleY(1.04f).setInterpolator(org.telegram.ui.Components.qr.f27425i);
                                        if (i13 == 0) {
                                            i11 = 132;
                                        } else {
                                            i11 = 500;
                ...
                return;
            case 25:
                AndroidUtilities.forEachViews((RecyclerView) boVar.f32524x0, (e2.h) new ai.i(21));
                nm nmVar2 = boVar.A0;
                if (nmVar2 != null) {
                    nmVar2.O(false);
                    return;
            ...
            case 27:
                mk mkVar2 = boVar.Y;
                if (mkVar2 != null && boVar.f32419ob != 5) {
                    mkVar2.H0();
                    return;
                }
                return;
            case 28:
                org.telegram.ui.Components.qo qoVar = ((org.telegram.ui.Components.qo[]) boVar.f32236a0.f780b)[0];
