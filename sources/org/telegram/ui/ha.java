...
public final class ha extends org.telegram.ui.Components.kl0 {
    ...
    public final int h() {
        int i10;
        qa qaVar = this.f34222c;
        org.telegram.ui.Components.ll0 ll0Var = qaVar.f36817b;
        ...
        if (ll0Var != null) {
            ...
            if (arrayList.size() > 0) {
                qaVar.f36817b.K2.add(Long.valueOf(AndroidUtilities.pack(3, arrayList.size() + 3)));
            }
        }
        if (qaVar.v.size() > 0) {
            i10 = qaVar.v.size() + 2;
        ...
        if (i13 != 0) {
            if (i13 != 2) {
                if (i13 != 3) {
                    ...
                    naVar.a(tL_username, z10, false, qaVar.f36824x);
                    return;
                }
                qaVar.f36820n = true;
                ka kaVar = (ka) view;
                qaVar.f36825y = kaVar;
                kaVar.f35085a.setText(qaVar.f36821r);
                qaVar.f36820n = false;
                return;
            }
