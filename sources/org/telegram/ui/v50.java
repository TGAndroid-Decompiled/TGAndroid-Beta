...
public final class v50 {
    ...
    public final org.telegram.ui.Components.h01 f38291f;
    public u50 f38292g;
    public int f38294j;
    public final Paint f38288a = new Paint(1);
    public final Paint f38289b = new Paint(1);
    public final x50[] f38290c = new x50[4];
    public boolean h = true;
    public final org.telegram.ui.Components.c6 f38293i = new org.telegram.ui.Components.c6(new i10(this, 7), 320, org.telegram.ui.Components.qr.h, 0);
    public final RectF f38295k = new RectF();
    public final RectF f38296l = new RectF();
    public final Path f38297m = new Path();

    public v50() {
        int i10 = 0;
        while (true) {
            x50[] x50VarArr = this.f38290c;
            if (i10 < x50VarArr.length) {
                x50VarArr[i10] = new x50(i10);
                i10++;
            } else {
                this.f38288a.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19165tg, false));
                ...
                this.e = h01Var;
                this.f38291f = new org.telegram.ui.Components.h01(LocaleController.getString(R.string.ConferenceEncryptedClose), 14.0f, AndroidUtilities.bold());
                b(null);
                return;
            }
        }
    ...
    public final boolean a(Canvas canvas, float f7, float f10) {
        ...
        h01Var.f24449p = f7 - AndroidUtilities.dp(132.0f);
        int d = i0.a.d(f10, this.f38294j, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19165tg, false));
        Paint paint = this.f38288a;
        paint.setColor(d);
        float e = this.f38293i.e(this.h);
        ...
        if (f10 > 0.0f) {
            ...
            this.f38291f.c(rectF.centerX() - (this.f38291f.l() / 2.0f), j3 - AndroidUtilities.dp(20.0f), f10, -1, canvas);
        }
        canvas.restore();
        return z11;
    }
    ...
    public final void b(String[] strArr) {
        ...
        for (int i10 = 0; i10 < 4; i10++) {
            x50 x50Var = this.f38290c[i10];
            if (strArr == null) {
                str = null;
            } else {
                str = strArr[i10];
            }
            w50 w50Var = x50Var.f39385k;
            boolean z12 = x50Var.f39381f;
            if (str != null) {
                z11 = true;
            } else {
                z11 = false;
            ...
            x50Var.f39381f = z11;
            if (str != null && (x50Var.d == null || !TextUtils.equals(x50Var.f39386l, str))) {
                org.telegram.ui.Components.o5 o5Var = x50Var.d;
                if (o5Var != null) {
                    o5Var.p(w50Var);
                }
                x50Var.f39380c = Emoji.getEmojiDrawable(str);
            ...
            if (x50Var.f39381f && !z12) {
                x50Var.e = false;
            }
        }
        u50 u50Var = this.f38292g;
        if (u50Var != null) {
            u50Var.invalidate();
        }
    }
