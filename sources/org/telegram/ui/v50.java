...
public final class v50 {
    ...
    public Emoji.EmojiDrawable f38361c;
    public org.telegram.ui.Components.o5 d;
    public boolean e;
    public boolean f38362f;
    public long f38363g;
    public String f38367l;
    public final Drawable[] f38360b = new Drawable[6];
    public final l20 h = new l20();
    public final HashSet f38364i = new HashSet();
    public boolean f38365j = false;
    public final u50 f38366k = new u50(this, 0);
    public final RectF f38368m = new RectF();

    public v50(int i10) {
        int i11 = 0;
        this.f38359a = i10;
        while (true) {
            Drawable[] drawableArr = this.f38360b;
            if (i11 < drawableArr.length) {
                drawableArr[i11] = Emoji.getEmojiDrawable(i60.A0());
                i11++;
            } else {
                this.f38363g = System.currentTimeMillis();
                return;
            }
        }
    }
    ...
    public final void a() {
        boolean isEmpty = this.f38364i.isEmpty();
        boolean z10 = !isEmpty;
        if (this.f38365j != z10) {
            this.f38365j = z10;
            u50 u50Var = this.f38366k;
            if (!isEmpty) {
    ...
    public final boolean b(Canvas canvas, RectF rectF, float f7) {
        ...
        RectF rectF2 = this.f38368m;
        rectF2.set(rectF);
        float f12 = -dp;
        rectF2.inset(f12, f12);
        canvas.saveLayerAlpha(rectF2.left, rectF2.top, rectF2.right, rectF2.bottom, 255, 31);
        long currentTimeMillis = (this.f38359a * 45) + System.currentTimeMillis();
        long j10 = currentTimeMillis - this.f38363g;
        float f13 = ((float) j10) / 180.0f;
        float min = Math.min(1.0f, f13);
        boolean z10 = this.f38362f;
        Drawable[] drawableArr = this.f38360b;
        boolean z11 = false;
        if (z10 && this.d != null && this.f38361c != null && this.e) {
            rectF2.set(rectF);
            ...
            if (f7 < 1.0f) {
                ...
                f11 = 0.0f;
                j3 = j10;
                this.f38361c.setBounds(0, 0, (int) rectF2.width(), (int) rectF2.height());
                canvas.translate(rectF2.left, rectF2.top);
                this.f38361c.setAlpha((int) ((1.0f - f7) * 255.0f));
                this.f38361c.draw(canvas);
                this.f38361c.setAlpha(255);
                canvas.restore();
            } else {
                j3 = j10;
                f10 = 255.0f;
        ...
        canvas.restore();
        if (f13 >= 1.0f) {
            if (this.f38362f && this.e) {
                z11 = true;
            } else {
                this.f38363g = currentTimeMillis - (j3 % 180);
                int i10 = 0;
    ...
    public final void c() {
        ...
        if (this.d != null && this.f38367l != null) {
            ...
            if (stickerSet != null) {
                String replace = this.f38367l.replace("️", "");
                ...
                FileLog.e("emoji \"" + this.f38367l + "\" not found in addemoji/" + tL_inputStickerSetShortName.short_name);
            }
        }
    }
}
