...
public final class k1 extends FrameLayout implements org.telegram.ui.Cells.p9 {
    public final ai.w0 f34904a;
    public final h1 f34905b;
    public b3 f34906c;
    public b3 d;
    public int e;
    public int f34907f;
    ...
    public TL_iv.pageBlockCollage f34910s;
    public final j1 v;
    public final g4 f34911w;
    public final i4 f34912x;
    ...
    public final void onDraw(Canvas canvas) {
        if (this.f34910s != null) {
            b3 b3Var = this.f34906c;
            i4 i4Var = this.f34912x;
            int i10 = 0;
            if (b3Var != null) {
                canvas.save();
                canvas.translate(this.f34907f, this.h);
                i4.v(i4Var, canvas, this, 0);
                this.f34906c.draw(canvas, this);
                canvas.restore();
                i10 = 1;
            }
            if (this.d != null) {
                canvas.save();
                canvas.translate(this.f34907f, this.h + this.f34908n);
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.f34906c != null) {
            sb2.append(", ");
            sb2.append(this.f34906c.d.getText());
        }
        if (this.d != null) {
            sb2.append(", ");
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        TL_iv.pageBlockCollage pageblockcollage = this.f34910s;
        if (pageblockcollage != null) {
            ...
            if (i14 > 0) {
                ...
                this.e = 0;
                this.f34907f = AndroidUtilities.dp(18.0f);
            ...
            this.h = dp3;
            TL_iv.pageBlockCollage pageblockcollage2 = this.f34910s;
            TL_iv.RichText richText = pageblockcollage2.caption.text;
            HashSet hashSet = i4.f34362b1;
            Layout.Alignment alignment = Layout.Alignment.ALIGN_NORMAL;
            i4 i4Var = this.f34912x;
            k1Var = this;
            b3 p5 = i4.p(i4Var, k1Var, null, richText, dp, dp3, pageblockcollage2, alignment, 0, this.f34911w);
            k1Var.f34906c = p5;
            if (p5 != null) {
                int height = k1Var.f34906c.d.getHeight() + AndroidUtilities.dp(4.0f);
                k1Var.f34908n = height;
                measuredHeight = org.telegram.messenger.f0.C(4.0f, height, measuredHeight);
                b3 b3Var = k1Var.f34906c;
                b3Var.f32303s = k1Var.f34907f;
                b3Var.v = k1Var.h;
            } else {
                k1Var.f34908n = 0;
            }
            TL_iv.pageBlockCollage pageblockcollage3 = k1Var.f34910s;
            TL_iv.RichText richText2 = pageblockcollage3.caption.credit;
            if (k1Var.f34911w.G) {
                alignment = org.telegram.ui.Components.vw0.a();
            }
            b3 p10 = i4.p(i4Var, k1Var, null, richText2, dp, 0, pageblockcollage3, alignment, 0, k1Var.f34911w);
            k1Var.d = p10;
            if (p10 != null) {
                measuredHeight += k1Var.d.d.getHeight() + AndroidUtilities.dp(4.0f);
                b3 b3Var2 = k1Var.d;
                b3Var2.f32303s = k1Var.f34907f;
                b3Var2.v = k1Var.h + k1Var.f34908n;
            }
            int dp4 = AndroidUtilities.dp(16.0f) + measuredHeight;
            TL_iv.pageBlockCollage pageblockcollage4 = k1Var.f34910s;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        int i11 = this.h;
        i4 i4Var = this.f34912x;
        if (!i4.l(i4Var, this.f34911w, motionEvent, this, b3Var, i10, i11)) {
            if (!i4.l(i4Var, this.f34911w, motionEvent, this, this.d, this.f34907f, this.h + this.f34908n) && !super.onTouchEvent(motionEvent)) {
                return false;
            }
            return true;
        }
