...
public class StickersActivity extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    public org.telegram.ui.Components.h61 f34830a;
    ...
    public static void U(StickersActivity stickersActivity, org.telegram.ui.Components.h51 h51Var, View view) {
        ...
        if (obj instanceof TLRPC.StickerSetCovered) {
            ...
            tL_inputStickerSetID2.f20865id = stickerSet3.f20872id;
                    ...
                    if (k02 != null) {
                        for (int i11 = 0; i11 < k02.size(); i11++) {
                            ...
                            if (stickerSetCovered != null && stickerSetCovered.set != null) {
                                ...
                                tL_inputStickerSetID3.f20865id = stickerSet4.f20872id;
    ...
    public static void V(StickersActivity stickersActivity, ArrayList arrayList) {
        oa1 oa1Var = stickersActivity.f34840y;
        ArrayList arrayList2 = new ArrayList();
    ...
    public static void X(StickersActivity stickersActivity, View view) {
        ...
        if (arrayList.contains(Long.valueOf(stickerSet.set.f20872id))) {
            return;
        }
        arrayList.add(Long.valueOf(stickerSet.set.f20872id));
        o3Var.f23293e.a(true, true);
        if (o3Var.f23297s) {
                ...
                if (k8Var.f23083y == view) {
                    ...
                    while (true) {
                        if (i10 < featuredEmojiSets.size()) {
                            if (stickersSet.set.f20872id == featuredEmojiSets.get(i10).set.f20872id) {
                    ...
                    if (stickerSetCovered != null) {
                        if (!arrayList.contains(Long.valueOf(stickerSetCovered.set.f20872id))) {
                            arrayList.add(Long.valueOf(stickerSetCovered.set.f20872id));
                        } else {
                            return;
                        }
                    }
        ...
        if (view instanceof org.telegram.ui.Cells.aa) {
            ...
            if (doubleTapReaction != null) {
                ...
                if (tL_availableReaction != null) {
                    aaVar.getValueBackupImageView().getImageReceiver().setImage(ImageLocation.getForDocument(tL_availableReaction.center_icon), "100_100_lastreactframe", DocumentObject.getSvgThumb(tL_availableReaction.static_icon.thumbs, org.telegram.ui.ActionBar.k6.f21607a7, 1.0f), "webp", tL_availableReaction, 1);
                }
            }
        }
    }
    ...
    public static void c0(StickersActivity stickersActivity, ArrayList arrayList, org.telegram.ui.Components.w51 w51Var) {
        ...
        MediaDataController mediaDataController = MediaDataController.getInstance(stickersActivity.currentAccount);
        org.telegram.ui.Components.h61 h61Var = stickersActivity.f34830a;
        if (h61Var == null || (!h61Var.Z2 && !stickersActivity.f34837s && stickersActivity.f34836r <= 0)) {
            if (i16 == 5) {
        ...
        while (i18 < stickersActivity.f34834f.size()) {
            if (arrayList2.contains(Long.valueOf(((TLRPC.StickerSetCovered) stickersActivity.f34834f.get(i18)).set.f20872id))) {
        ...
        if (stickersActivity.f34833e.size() > 0) {
            ...
            for (int size3 = arrayList4.size(); i26 < size3; size3 = size3) {
                ...
                i26++;
                TLRPC.TL_messages_stickerSet tL_messages_stickerSet = (TLRPC.TL_messages_stickerSet) obj;
                int i27 = org.telegram.ui.Cells.j8.f23031a;
                ...
                J.D = new View.OnClickListener(stickersActivity) {
                    public final StickersActivity f39965b;

                    {
                        this.f39965b = stickersActivity;
                    }
                        ...
                        switch (r2) {
                            case 0:
                                if (view != null && (view.getParent() instanceof org.telegram.ui.Cells.k8)) {
                                    ...
                                    final StickersActivity stickersActivity2 = this.f39965b;
                                ...
                                return;
                            case 1:
                                StickersActivity.Z(this.f39965b, view);
                                return;
                            default:
                                StickersActivity.X(this.f39965b, view);
                                return;
                        }
                    }
                };
                ...
                J.K(stickersActivity.f34839x.contains(Long.valueOf(tL_messages_stickerSet.set.f20872id)));
                arrayList.add(J);
            }
            charSequence = null;
            w51Var.L();
        ...
        if (i16 == 5 && !stickersActivity.f34834f.isEmpty()) {
            ...
            while (i17 < size4) {
                ...
                int i28 = org.telegram.ui.Cells.n3.f23207a;
                ...
                J2.f27383t = arrayList2.contains(Long.valueOf(stickerSetCovered.set.f20872id));
                arrayList.add(J2);
            }
            if (z4) {
    ...
    public static void d0(StickersActivity stickersActivity, int i10) {
        ...
        if (i10 == 2) {
            ...
            for (int i13 = 0; i13 < size; i13++) {
                ...
                if (stickersActivity.f34839x.contains(Long.valueOf(tL_messages_stickerSet.set.f20872id))) {
                    if (sb.length() != 0) {
                        sb.append("\n");
                    }
            ...
            N0.f28844p0 = new vv0(stickersActivity, 2);
            N0.show();
        } else if (i10 == 0 || i10 == 1) {
            ...
            for (int i14 = 0; i14 < size2; i14++) {
                ...
                if (stickersActivity.f34839x.contains(Long.valueOf(tL_messages_stickerSet2.set.f20872id))) {
            ...
            if (size3 != 0) {
                if (size3 != 1) {
                    ...
                    if (i10 == 1) {
                        alertDialog$Builder.f21168a.O = LocaleController.formatString(R.string.DeleteStickerSetsAlertTitle, LocaleController.formatPluralString("StickerSets", size3, new Object[0]));
                        alertDialog$Builder.f21168a.Q = LocaleController.formatString(R.string.DeleteStickersAlertMessage, Integer.valueOf(size3));
                        string = LocaleController.getString(R.string.Delete);
                    } else {
                        alertDialog$Builder.f21168a.O = LocaleController.formatString(R.string.ArchiveStickerSetsAlertTitle, LocaleController.formatPluralString("StickerSets", size3, new Object[0]));
                        alertDialog$Builder.f21168a.Q = LocaleController.formatString(R.string.ArchiveStickersAlertMessage, Integer.valueOf(size3));
                ...
                while (true) {
                    if (i12 < size4) {
                        ...
                        if (stickersActivity.f34839x.contains(Long.valueOf(tL_messages_stickerSet3.set.f20872id))) {
                            if (i10 == 0) {
                                MediaDataController mediaDataController = MediaDataController.getInstance(stickersActivity.currentAccount);
                                Activity parentActivity = stickersActivity.getParentActivity();
                                ...
                                if (i10 == 1) {
                                    ...
                                    if (hashSet.contains(Long.valueOf(tL_messages_stickerSet3.set.f20872id))) {
                                        hashSet.remove(Long.valueOf(tL_messages_stickerSet3.set.f20872id));
                                    } else {
    ...
    public final View createView(Context context) {
        ...
        this.f34832c.setTextColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f22040y8, false));
        ...
        org.telegram.ui.Components.h61 h61Var = new org.telegram.ui.Components.h61(this, new Utilities.Callback2(this) {
            public final StickersActivity f40800b;
            ...
            public final void run(Object obj, Object obj2) {
                switch (r2) {
                    case 0:
                        StickersActivity.c0(this.f40800b, (ArrayList) obj, (org.telegram.ui.Components.w51) obj2);
                        return;
                    default:
                        ((Integer) obj).getClass();
                        StickersActivity.V(this.f40800b, (ArrayList) obj2);
                        return;
                }
            }
        ...
        this.f34830a.A1(new Utilities.Callback2(this) {
            public final StickersActivity f40800b;
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f34830a, 32768, null, null, null, null, org.telegram.ui.ActionBar.k6.f21932s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f34830a, 4096, null, null, null, null, org.telegram.ui.ActionBar.k6.f21752i6));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f34830a, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.k6.f21781k0, null, null, org.telegram.ui.ActionBar.k6.f21662d7));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f34830a, 0, new Class[]{org.telegram.ui.Cells.k8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.k6.f22055z6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f34830a, 16384, new Class[]{org.telegram.ui.Cells.k8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.k6.f21788k7));
        ...
        if (size > 0) {
            if (hashSet.size() > 0) {
                ...
                while (true) {
                    ...
                    i11++;
                    TLRPC.TL_messages_stickerSet tL_messages_stickerSet = (TLRPC.TL_messages_stickerSet) obj;
                    if (hashSet.contains(Long.valueOf(tL_messages_stickerSet.set.f20872id))) {
                        TLRPC.StickerSet stickerSet = tL_messages_stickerSet.set;
    ...
    public final ArrayList k0() {
        ...
        if (this.v == 5) {
            ...
            while (i10 < arrayList.size()) {
                if (arrayList.get(i10) == null || mediaDataController.isStickerPackInstalled(((TLRPC.StickerSetCovered) arrayList.get(i10)).set.f20872id, false)) {
    ...
    public final void m0() {
        ...
        if (this.f34837s) {
            ...
            while (i11 < this.f34833e.size()) {
                i11 = android.support.v4.media.a.g(((TLRPC.TL_messages_stickerSet) this.f34833e.get(i11)).set.f20872id, tL_messages_reorderStickerSets.order, i11, 1);
            }
    ...
    public final void n0(org.telegram.ui.Cells.k8 k8Var) {
        ...
        Long valueOf = Long.valueOf(stickersSet.set.f20872id);
        HashSet hashSet = this.f34839x;
        if (hashSet.contains(valueOf)) {
            hashSet.remove(Long.valueOf(stickersSet.set.f20872id));
            k8Var.b(false, true);
        } else {
            hashSet.add(Long.valueOf(stickersSet.set.f20872id));
            k8Var.b(true, true);
        }
        this.f34830a.V2.N(true);
        i0();
    ...
    public final void onResume() {
        super.onResume();
        org.telegram.ui.Components.h61 h61Var = this.f34830a;
        if (h61Var != null) {
            h61Var.V2.N(true);
        }
    }
