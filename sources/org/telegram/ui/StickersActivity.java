...
public class StickersActivity extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    public org.telegram.ui.Components.d61 f31479a;
    private int archivedRow;
    public gg.j0 f31480b;
    public NumberTextView f31481c;
    public org.telegram.ui.Components.p41 d;
    private int dynamicPackOrder;
    public ArrayList e;
    public ArrayList f31482f;
    private int featuredRow;
    public final ArrayList h;
    private int largeEmojiRow;
    public org.telegram.ui.ActionBar.v0 f31483n;
    public int f31484r;
    public boolean f31485s;
    private int suggestRow;
    public final int v;
    public ArrayList f31486w;
    public final HashSet f31487x;
    public final sa1 f31488y;

    public StickersActivity(int i10, ArrayList arrayList) {
        super(null);
        this.h = new ArrayList();
        this.f31487x = new HashSet();
        this.f31488y = new sa1(this, 0);
        this.v = i10;
        this.f31486w = arrayList;
    }
    ...
    public static void U(StickersActivity stickersActivity, org.telegram.ui.Components.h51 h51Var, View view) {
        ...
        if (obj instanceof TLRPC.TL_messages_stickerSet) {
            ...
            if (stickersActivity.f31487x.isEmpty()) {
        ...
        if (obj instanceof TLRPC.StickerSetCovered) {
            ...
            tL_inputStickerSetID2.f18103id = stickerSet3.f18110id;
                    ...
                    if (k02 != null) {
                        for (int i11 = 0; i11 < k02.size(); i11++) {
                            ...
                            if (stickerSetCovered != null && stickerSetCovered.set != null) {
                                ...
                                tL_inputStickerSetID3.f18103id = stickerSet4.f18110id;
    ...
    public static void V(StickersActivity stickersActivity, ArrayList arrayList) {
        sa1 sa1Var = stickersActivity.f31488y;
        ArrayList arrayList2 = new ArrayList();
    ...
    public static void X(StickersActivity stickersActivity, View view) {
        ...
        if (arrayList.contains(Long.valueOf(stickerSet.set.f18110id))) {
            return;
        }
        arrayList.add(Long.valueOf(stickerSet.set.f18110id));
        o3Var.e.a(true, true);
        if (o3Var.f20533s) {
                ...
                if (n8Var.f20479y == view) {
                    ...
                    while (true) {
                        if (i10 < featuredEmojiSets.size()) {
                            if (stickersSet.set.f18110id == featuredEmojiSets.get(i10).set.f18110id) {
                    ...
                    if (stickerSetCovered != null) {
                        if (!arrayList.contains(Long.valueOf(stickerSetCovered.set.f18110id))) {
                            arrayList.add(Long.valueOf(stickerSetCovered.set.f18110id));
                        } else {
                            return;
                        }
                    }
        ...
        if (view instanceof org.telegram.ui.Cells.fa) {
            ...
            if (doubleTapReaction != null) {
                ...
                if (tL_availableReaction != null) {
                    faVar.getValueBackupImageView().getImageReceiver().setImage(ImageLocation.getForDocument(tL_availableReaction.center_icon), "100_100_lastreactframe", DocumentObject.getSvgThumb(tL_availableReaction.static_icon.thumbs, org.telegram.ui.ActionBar.h6.f18733a7, 1.0f), "webp", tL_availableReaction, 1);
                }
            }
        }
    }
    ...
    public static void c0(StickersActivity stickersActivity, ArrayList arrayList, org.telegram.ui.Components.v51 v51Var) {
        ...
        MediaDataController mediaDataController = MediaDataController.getInstance(stickersActivity.currentAccount);
        org.telegram.ui.Components.d61 d61Var = stickersActivity.f31479a;
        if (d61Var == null || (!d61Var.f23292c3 && !stickersActivity.f31485s && stickersActivity.f31484r <= 0)) {
            if (i16 == 5) {
                ...
                stickersActivity.f31486w = arrayList3;
        ...
        stickersActivity.f31482f = new ArrayList(stickersActivity.k0());
        int i17 = 0;
        int i18 = 0;
        while (i18 < stickersActivity.f31482f.size()) {
            if (arrayList2.contains(Long.valueOf(((TLRPC.StickerSetCovered) stickersActivity.f31482f.get(i18)).set.f18110id))) {
                stickersActivity.f31482f.remove(i18);
                i18--;
            }
            i18++;
        }
        int size = stickersActivity.f31482f.size();
        ...
        if (stickersActivity.e.size() > 0) {
            v51Var.U();
            if (i16 == 5 || (!stickersActivity.f31482f.isEmpty() && i16 == 0)) {
                if (i16 == 5) {
            ...
            for (int size3 = arrayList4.size(); i26 < size3; size3 = size3) {
                ...
                i26++;
                TLRPC.TL_messages_stickerSet tL_messages_stickerSet = (TLRPC.TL_messages_stickerSet) obj;
                int i27 = org.telegram.ui.Cells.m8.f20410a;
                ...
                J.D = new View.OnClickListener(stickersActivity) {
                    public final StickersActivity f37594b;

                    {
                        this.f37594b = stickersActivity;
                    }
                        ...
                        switch (r2) {
                            case 0:
                                if (view != null && (view.getParent() instanceof org.telegram.ui.Cells.n8)) {
                                    ...
                                    final StickersActivity stickersActivity2 = this.f37594b;
                                ...
                                return;
                            case 1:
                                StickersActivity.Z(this.f37594b, view);
                                return;
                            default:
                                StickersActivity.X(this.f37594b, view);
                                return;
                        }
                    }
                };
                ...
                J.K(stickersActivity.f31487x.contains(Long.valueOf(tL_messages_stickerSet.set.f18110id)));
                arrayList.add(J);
            }
            charSequence = null;
            v51Var.L();
        ...
        if (stickersActivity.f31482f.size() > 3) {
            stickersActivity.f31482f = new ArrayList(stickersActivity.f31482f.subList(0, 3));
            z10 = true;
        } else {
            z10 = false;
        }
        if (i16 == 5 && !stickersActivity.f31482f.isEmpty()) {
            if (stickersActivity.e.size() > 0) {
            ...
            while (i17 < size4) {
                ...
                J2.f24515t = arrayList2.contains(Long.valueOf(stickerSetCovered.set.f18110id));
                arrayList.add(J2);
            }
            if (z10) {
    ...
    public static void d0(StickersActivity stickersActivity, int i10) {
        ...
        if (i10 == 2) {
            ...
            for (int i13 = 0; i13 < size; i13++) {
                ...
                if (stickersActivity.f31487x.contains(Long.valueOf(tL_messages_stickerSet.set.f18110id))) {
                    if (sb2.length() != 0) {
                        sb2.append("\n");
                    }
            ...
            N0.f24796s0 = new cw0(stickersActivity, 2);
            N0.show();
        } else if (i10 == 0 || i10 == 1) {
            ArrayList arrayList = new ArrayList(stickersActivity.f31487x.size());
            ...
            for (int i14 = 0; i14 < size2; i14++) {
                ...
                if (stickersActivity.f31487x.contains(Long.valueOf(tL_messages_stickerSet2.set.f18110id))) {
            ...
            if (size3 != 0) {
                if (size3 != 1) {
                    ...
                    if (i10 == 1) {
                        alertDialog$Builder.f18409a.R = LocaleController.formatString(R.string.DeleteStickerSetsAlertTitle, LocaleController.formatPluralString("StickerSets", size3, new Object[0]));
                        alertDialog$Builder.f18409a.T = LocaleController.formatString(R.string.DeleteStickersAlertMessage, Integer.valueOf(size3));
                        string = LocaleController.getString(R.string.Delete);
                    } else {
                        alertDialog$Builder.f18409a.R = LocaleController.formatString(R.string.ArchiveStickerSetsAlertTitle, LocaleController.formatPluralString("StickerSets", size3, new Object[0]));
                        alertDialog$Builder.f18409a.T = LocaleController.formatString(R.string.ArchiveStickersAlertMessage, Integer.valueOf(size3));
                ...
                while (true) {
                    if (i12 < size4) {
                        ...
                        if (stickersActivity.f31487x.contains(Long.valueOf(tL_messages_stickerSet3.set.f18110id))) {
                            if (i10 == 0) {
                                MediaDataController mediaDataController = MediaDataController.getInstance(stickersActivity.currentAccount);
                                Activity parentActivity = stickersActivity.getParentActivity();
                                ...
                                if (i10 == 1) {
                                    ...
                                    HashSet hashSet = stickersActivity2.f31487x;
                                    if (hashSet.contains(Long.valueOf(tL_messages_stickerSet3.set.f18110id))) {
                                        hashSet.remove(Long.valueOf(tL_messages_stickerSet3.set.f18110id));
                                    } else {
                                        hashSet.add(Long.valueOf(tL_messages_stickerSet3.set.f18110id));
                                    }
                                    stickersActivity2.f31479a.Y2.N(true);
    ...
    public final View createView(Context context) {
        ...
        this.f31481c = numberTextView;
        numberTextView.setTextSize(18);
        this.f31481c.setTypeface(AndroidUtilities.bold());
        this.f31481c.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19172y8, false));
        j3.addView(this.f31481c, w7.x5.m(1.0f, 0, -1, 72, 0, 0));
        this.f31481c.setOnTouchListener(new bi.d(2));
        j3.g(2, R.drawable.msg_share, AndroidUtilities.dp(54.0f));
        j3.g(0, R.drawable.msg_archive, AndroidUtilities.dp(54.0f));
        this.f31483n = j3.g(1, R.drawable.msg_delete, AndroidUtilities.dp(54.0f));
        if (i10 == 5 && (arrayList = this.f31486w) != null) {
            this.e = arrayList;
        } else {
        ...
        org.telegram.ui.Components.d61 d61Var = new org.telegram.ui.Components.d61(this, new Utilities.Callback2(this) {
            public final StickersActivity f38342b;
            ...
            public final void run(Object obj, Object obj2) {
                switch (r2) {
                    case 0:
                        StickersActivity.c0(this.f38342b, (ArrayList) obj, (org.telegram.ui.Components.v51) obj2);
                        return;
                    default:
                        ((Integer) obj).getClass();
                        StickersActivity.V(this.f38342b, (ArrayList) obj2);
                        return;
                }
            }
        ...
        this.f31479a = d61Var;
        d61Var.p1();
        this.actionBar.setAdaptiveBackground(this.f31479a);
        this.f31479a.setFocusable(true);
        this.f31479a.setTag(7);
        this.f31479a.B1(new Utilities.Callback2(this) {
            public final StickersActivity f38342b;
        ...
        this.f31480b = j0Var;
        j0Var.j1(1);
        this.f31479a.setLayoutManager(this.f31480b);
        frameLayout.addView(this.f31479a, w7.x5.c(-1.0f, -1));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31479a, 16, new Class[]{org.telegram.ui.Cells.n8.class, org.telegram.ui.Cells.fa.class, org.telegram.ui.Cells.x8.class}, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31479a, 32768, null, null, null, null, org.telegram.ui.ActionBar.h6.f19065s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31481c, 4, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31479a, 4096, null, null, null, null, org.telegram.ui.ActionBar.h6.f18878i6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31479a, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.h6.f18910k0, null, null, org.telegram.ui.ActionBar.h6.f18790d7));
        int i12 = org.telegram.ui.ActionBar.h6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31479a, 0, new Class[]{org.telegram.ui.Cells.x8.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31479a, 0, new Class[]{org.telegram.ui.Cells.x8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.M6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31479a, 0, new Class[]{org.telegram.ui.Cells.x8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.N6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31479a, 0, new Class[]{org.telegram.ui.Cells.f9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.B6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31479a, 2, new Class[]{org.telegram.ui.Cells.f9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.J6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31479a, 0, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31479a, 0, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.I6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31479a, 0, new Class[]{org.telegram.ui.Cells.n8.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31479a, 0, new Class[]{org.telegram.ui.Cells.n8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f19189z6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31479a, 196608, new Class[]{org.telegram.ui.Cells.n8.class}, new String[]{"optionsButton"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.Vh));
        int i13 = org.telegram.ui.ActionBar.h6.Uh;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31479a, 0, new Class[]{org.telegram.ui.Cells.n8.class}, new String[]{"optionsButton"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31479a, 0, new Class[]{org.telegram.ui.Cells.n8.class}, new String[]{"reorderButton"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31479a, 8192, new Class[]{org.telegram.ui.Cells.n8.class}, new String[]{"checkBox"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31479a, 16384, new Class[]{org.telegram.ui.Cells.n8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f18917k7));
        ...
        if (size > 0) {
            if (hashSet.size() > 0) {
                ...
                while (true) {
                    ...
                    i11++;
                    TLRPC.TL_messages_stickerSet tL_messages_stickerSet = (TLRPC.TL_messages_stickerSet) obj;
                    if (hashSet.contains(Long.valueOf(tL_messages_stickerSet.set.f18110id))) {
                        TLRPC.StickerSet stickerSet = tL_messages_stickerSet.set;
                ...
                if (this.f31483n.getVisibility() != i10) {
                    this.f31483n.setVisibility(i10);
                }
            }
            this.f31481c.a(size, s10);
            if (!s10) {
                this.actionBar.O(null, null);
                this.f31479a.w1(true);
    ...
    public final ArrayList k0() {
        ...
        if (this.v == 5) {
            ...
            while (i10 < arrayList.size()) {
                if (arrayList.get(i10) == null || mediaDataController.isStickerPackInstalled(((TLRPC.StickerSetCovered) arrayList.get(i10)).set.f18110id, false)) {
    ...
    public final void m0() {
        ...
        if (this.f31485s) {
            ...
            while (i11 < this.e.size()) {
                i11 = com.google.android.gms.internal.vision.e2.g(((TLRPC.TL_messages_stickerSet) this.e.get(i11)).set.f18110id, tL_messages_reorderStickerSets.order, i11, 1);
            }
    ...
    public final void n0(org.telegram.ui.Cells.n8 n8Var) {
        ...
        Long valueOf = Long.valueOf(stickersSet.set.f18110id);
        HashSet hashSet = this.f31487x;
        if (hashSet.contains(valueOf)) {
            hashSet.remove(Long.valueOf(stickersSet.set.f18110id));
            n8Var.b(false, true);
        } else {
            hashSet.add(Long.valueOf(stickersSet.set.f18110id));
            n8Var.b(true, true);
        }
        this.f31479a.Y2.N(true);
        i0();
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f31479a.setPadding(0, 0, 0, i13);
        this.f31479a.setClipToPadding(false);
    }

    @Override
    public final void onResume() {
        super.onResume();
        org.telegram.ui.Components.d61 d61Var = this.f31479a;
        if (d61Var != null) {
            d61Var.Y2.N(true);
        }
    }
