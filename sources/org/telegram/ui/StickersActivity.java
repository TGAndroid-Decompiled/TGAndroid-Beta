...
public class StickersActivity extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    public org.telegram.ui.Components.g61 f32267a;
    private int archivedRow;
    public dr f32268b;
    public NumberTextView f32269c;
    public org.telegram.ui.Components.q41 d;
    private int dynamicPackOrder;
    public ArrayList e;
    public ArrayList f32270f;
    private int featuredRow;
    public final ArrayList h;
    private int largeEmojiRow;
    public org.telegram.ui.ActionBar.w0 f32271n;
    public int f32272r;
    public boolean f32273s;
    private int suggestRow;
    public final int v;
    public ArrayList f32274w;
    public final HashSet f32275x;
    public final pa1 f32276y;

    public StickersActivity(int i10, ArrayList arrayList) {
        super(null);
        this.h = new ArrayList();
        this.f32275x = new HashSet();
        this.f32276y = new pa1(this, 0);
        this.v = i10;
        this.f32274w = arrayList;
    }
    ...
    public static void U(StickersActivity stickersActivity, org.telegram.ui.Components.i51 i51Var, View view) {
        ...
        if (obj instanceof TLRPC.TL_messages_stickerSet) {
            ...
            if (stickersActivity.f32275x.isEmpty()) {
        ...
        if (obj instanceof TLRPC.StickerSetCovered) {
            ...
            tL_inputStickerSetID2.f19179id = stickerSet3.f19186id;
        ...
        switch (i51Var.d) {
                    ...
                    if (k02 != null) {
                        for (int i11 = 0; i11 < k02.size(); i11++) {
                            ...
                            if (stickerSetCovered != null && stickerSetCovered.set != null) {
                                ...
                                tL_inputStickerSetID3.f19179id = stickerSet4.f19186id;
            ...
            case 5:
                ...
                H.i(new dh(4, view), LocaleController.getString(R.string.SuggestStickersAll), z4);
                if (SharedConfig.suggestStickers == 1) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                H.i(new dh(5, view), LocaleController.getString(R.string.SuggestStickersInstalled), z10);
                if (SharedConfig.suggestStickers != 2) {
                    z11 = false;
                }
                H.i(new dh(6, view), LocaleController.getString(R.string.SuggestStickersNone), z11);
                H.Z();
                return;
            case 6:
    ...
    public static void V(StickersActivity stickersActivity, ArrayList arrayList) {
        pa1 pa1Var = stickersActivity.f32276y;
        ArrayList arrayList2 = new ArrayList();
    ...
    public static void X(StickersActivity stickersActivity, View view) {
        ...
        if (arrayList.contains(Long.valueOf(stickerSet.set.f19186id))) {
            return;
        }
        arrayList.add(Long.valueOf(stickerSet.set.f19186id));
        n3Var.e.a(true, true);
        if (n3Var.f21423s) {
                ...
                if (j8Var.f21245y == view) {
                    ...
                    while (true) {
                        if (i10 < featuredEmojiSets.size()) {
                            if (stickersSet.set.f19186id == featuredEmojiSets.get(i10).set.f19186id) {
                    ...
                    if (stickerSetCovered != null) {
                        if (!arrayList.contains(Long.valueOf(stickerSetCovered.set.f19186id))) {
                            arrayList.add(Long.valueOf(stickerSetCovered.set.f19186id));
                        } else {
                            return;
                        }
                    }
        ...
        if (view instanceof org.telegram.ui.Cells.z9) {
            ...
            if (doubleTapReaction != null) {
                ...
                if (tL_availableReaction != null) {
                    z9Var.getValueBackupImageView().getImageReceiver().setImage(ImageLocation.getForDocument(tL_availableReaction.center_icon), "100_100_lastreactframe", DocumentObject.getSvgThumb(tL_availableReaction.static_icon.thumbs, org.telegram.ui.ActionBar.j6.f19827a7, 1.0f), "webp", tL_availableReaction, 1);
                }
            }
        }
    }
    ...
    public static void c0(StickersActivity stickersActivity, ArrayList arrayList, org.telegram.ui.Components.w51 w51Var) {
        ...
        MediaDataController mediaDataController = MediaDataController.getInstance(stickersActivity.currentAccount);
        org.telegram.ui.Components.g61 g61Var = stickersActivity.f32267a;
        if (g61Var == null || (!g61Var.Z2 && !stickersActivity.f32273s && stickersActivity.f32272r <= 0)) {
            if (i16 == 5) {
                ...
                stickersActivity.f32274w = arrayList3;
        ...
        stickersActivity.f32270f = new ArrayList(stickersActivity.k0());
        int i17 = 0;
        int i18 = 0;
        while (i18 < stickersActivity.f32270f.size()) {
            if (arrayList2.contains(Long.valueOf(((TLRPC.StickerSetCovered) stickersActivity.f32270f.get(i18)).set.f19186id))) {
                stickersActivity.f32270f.remove(i18);
                i18--;
            }
            i18++;
        }
        int size = stickersActivity.f32270f.size();
        ...
        if (stickersActivity.e.size() > 0) {
            w51Var.U();
            if (i16 == 5 || (!stickersActivity.f32270f.isEmpty() && i16 == 0)) {
                if (i16 == 5) {
            ...
            for (int size3 = arrayList4.size(); i26 < size3; size3 = size3) {
                ...
                i26++;
                TLRPC.TL_messages_stickerSet tL_messages_stickerSet = (TLRPC.TL_messages_stickerSet) obj;
                int i27 = org.telegram.ui.Cells.i8.f21193a;
                ...
                J.D = new View.OnClickListener(stickersActivity) {
                    public final StickersActivity f37371b;

                    {
                        this.f37371b = stickersActivity;
                    }
                        ...
                        switch (r2) {
                            case 0:
                                if (view != null && (view.getParent() instanceof org.telegram.ui.Cells.j8)) {
                                    ...
                                    final StickersActivity stickersActivity2 = this.f37371b;
                                ...
                                return;
                            case 1:
                                StickersActivity.Z(this.f37371b, view);
                                return;
                            default:
                                StickersActivity.X(this.f37371b, view);
                                return;
                        }
                    }
                };
                ...
                J.K(stickersActivity.f32275x.contains(Long.valueOf(tL_messages_stickerSet.set.f19186id)));
                arrayList.add(J);
            }
            charSequence = null;
            w51Var.L();
        ...
        if (stickersActivity.f32270f.size() > 3) {
            stickersActivity.f32270f = new ArrayList(stickersActivity.f32270f.subList(0, 3));
            z4 = true;
        } else {
            z4 = false;
        }
        if (i16 == 5 && !stickersActivity.f32270f.isEmpty()) {
            if (stickersActivity.e.size() > 0) {
            ...
            while (i17 < size4) {
                ...
                J2.f25593t = arrayList2.contains(Long.valueOf(stickerSetCovered.set.f19186id));
                arrayList.add(J2);
            }
            if (z4) {
    ...
    public static void d0(StickersActivity stickersActivity, int i10) {
        ...
        if (i10 == 2) {
            ...
            for (int i13 = 0; i13 < size; i13++) {
                ...
                if (stickersActivity.f32275x.contains(Long.valueOf(tL_messages_stickerSet.set.f19186id))) {
                    if (sb.length() != 0) {
                        sb.append("\n");
                    }
            ...
            N0.f26850p0 = new vv0(stickersActivity, 2);
            N0.show();
        } else if (i10 == 0 || i10 == 1) {
            ArrayList arrayList = new ArrayList(stickersActivity.f32275x.size());
            ...
            for (int i14 = 0; i14 < size2; i14++) {
                ...
                if (stickersActivity.f32275x.contains(Long.valueOf(tL_messages_stickerSet2.set.f19186id))) {
            ...
            if (size3 != 0) {
                if (size3 != 1) {
                    ...
                    if (i10 == 1) {
                        alertDialog$Builder.f19478a.O = LocaleController.formatString(R.string.DeleteStickerSetsAlertTitle, LocaleController.formatPluralString("StickerSets", size3, new Object[0]));
                        alertDialog$Builder.f19478a.Q = LocaleController.formatString(R.string.DeleteStickersAlertMessage, Integer.valueOf(size3));
                        string = LocaleController.getString(R.string.Delete);
                    } else {
                        alertDialog$Builder.f19478a.O = LocaleController.formatString(R.string.ArchiveStickerSetsAlertTitle, LocaleController.formatPluralString("StickerSets", size3, new Object[0]));
                        alertDialog$Builder.f19478a.Q = LocaleController.formatString(R.string.ArchiveStickersAlertMessage, Integer.valueOf(size3));
                ...
                while (true) {
                    if (i12 < size4) {
                        ...
                        if (stickersActivity.f32275x.contains(Long.valueOf(tL_messages_stickerSet3.set.f19186id))) {
                            if (i10 == 0) {
                                MediaDataController mediaDataController = MediaDataController.getInstance(stickersActivity.currentAccount);
                                Activity parentActivity = stickersActivity.getParentActivity();
                                ...
                                if (i10 == 1) {
                                    ...
                                    HashSet hashSet = stickersActivity2.f32275x;
                                    if (hashSet.contains(Long.valueOf(tL_messages_stickerSet3.set.f19186id))) {
                                        hashSet.remove(Long.valueOf(tL_messages_stickerSet3.set.f19186id));
                                    } else {
                                        hashSet.add(Long.valueOf(tL_messages_stickerSet3.set.f19186id));
                                    }
                                    stickersActivity2.f32267a.V2.N(true);
    ...
    public final View createView(Context context) {
        ...
        this.f32269c = numberTextView;
        numberTextView.setTextSize(18);
        this.f32269c.setTypeface(AndroidUtilities.bold());
        this.f32269c.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20258y8, false));
        j10.addView(this.f32269c, k7.b6.m(1.0f, 0, -1, 72, 0, 0));
        this.f32269c.setOnTouchListener(new oh.d(2));
        j10.g(2, R.drawable.msg_share, AndroidUtilities.dp(54.0f));
        j10.g(0, R.drawable.msg_archive, AndroidUtilities.dp(54.0f));
        this.f32271n = j10.g(1, R.drawable.msg_delete, AndroidUtilities.dp(54.0f));
        if (i10 == 5 && (arrayList = this.f32274w) != null) {
            this.e = arrayList;
        } else {
        ...
        org.telegram.ui.Components.g61 g61Var = new org.telegram.ui.Components.g61(this, new Utilities.Callback2(this) {
            public final StickersActivity f38144b;
            ...
            public final void run(Object obj, Object obj2) {
                switch (r2) {
                    case 0:
                        StickersActivity.c0(this.f38144b, (ArrayList) obj, (org.telegram.ui.Components.w51) obj2);
                        return;
                    default:
                        ((Integer) obj).getClass();
                        StickersActivity.V(this.f38144b, (ArrayList) obj2);
                        return;
                }
            }
        ...
        this.f32267a = g61Var;
        g61Var.o1();
        this.actionBar.setAdaptiveBackground(this.f32267a);
        this.f32267a.setFocusable(true);
        this.f32267a.setTag(7);
        this.f32267a.A1(new Utilities.Callback2(this) {
            public final StickersActivity f38144b;
        ...
        this.f32268b = drVar;
        drVar.j1(1);
        this.f32267a.setLayoutManager(this.f32268b);
        frameLayout.addView(this.f32267a, k7.b6.c(-1.0f, -1));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32267a, 16, new Class[]{org.telegram.ui.Cells.j8.class, org.telegram.ui.Cells.z9.class, org.telegram.ui.Cells.r8.class}, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32267a, 32768, null, null, null, null, org.telegram.ui.ActionBar.j6.f20151s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32269c, 4, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32267a, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f19971i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32267a, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f20000k0, null, null, org.telegram.ui.ActionBar.j6.f19882d7));
        int i12 = org.telegram.ui.ActionBar.j6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32267a, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32267a, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.M6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32267a, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.N6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32267a, 0, new Class[]{org.telegram.ui.Cells.z8.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.B6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32267a, 2, new Class[]{org.telegram.ui.Cells.z8.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.J6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32267a, 0, new Class[]{org.telegram.ui.Cells.z9.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32267a, 0, new Class[]{org.telegram.ui.Cells.z9.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.I6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32267a, 0, new Class[]{org.telegram.ui.Cells.j8.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32267a, 0, new Class[]{org.telegram.ui.Cells.j8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f20273z6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32267a, 196608, new Class[]{org.telegram.ui.Cells.j8.class}, new String[]{"optionsButton"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.Vh));
        int i13 = org.telegram.ui.ActionBar.j6.Uh;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32267a, 0, new Class[]{org.telegram.ui.Cells.j8.class}, new String[]{"optionsButton"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32267a, 0, new Class[]{org.telegram.ui.Cells.j8.class}, new String[]{"reorderButton"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32267a, 8192, new Class[]{org.telegram.ui.Cells.j8.class}, new String[]{"checkBox"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f32267a, 16384, new Class[]{org.telegram.ui.Cells.j8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f20007k7));
        ...
        if (size > 0) {
            if (hashSet.size() > 0) {
                ...
                while (true) {
                    ...
                    i11++;
                    TLRPC.TL_messages_stickerSet tL_messages_stickerSet = (TLRPC.TL_messages_stickerSet) obj;
                    if (hashSet.contains(Long.valueOf(tL_messages_stickerSet.set.f19186id))) {
                        TLRPC.StickerSet stickerSet = tL_messages_stickerSet.set;
                ...
                if (this.f32271n.getVisibility() != i10) {
                    this.f32271n.setVisibility(i10);
                }
            }
            this.f32269c.a(size, s6);
            if (!s6) {
                this.actionBar.O(null, null);
                this.f32267a.v1(true);
    ...
    public final ArrayList k0() {
        ...
        if (this.v == 5) {
            ...
            while (i10 < arrayList.size()) {
                if (arrayList.get(i10) == null || mediaDataController.isStickerPackInstalled(((TLRPC.StickerSetCovered) arrayList.get(i10)).set.f19186id, false)) {
    ...
    public final void m0() {
        ...
        if (this.f32273s) {
            ...
            while (i11 < this.e.size()) {
                i11 = android.support.v4.media.a.g(((TLRPC.TL_messages_stickerSet) this.e.get(i11)).set.f19186id, tL_messages_reorderStickerSets.order, i11, 1);
            }
    ...
    public final void n0(org.telegram.ui.Cells.j8 j8Var) {
        ...
        Long valueOf = Long.valueOf(stickersSet.set.f19186id);
        HashSet hashSet = this.f32275x;
        if (hashSet.contains(valueOf)) {
            hashSet.remove(Long.valueOf(stickersSet.set.f19186id));
            j8Var.b(false, true);
        } else {
            hashSet.add(Long.valueOf(stickersSet.set.f19186id));
            j8Var.b(true, true);
        }
        this.f32267a.V2.N(true);
        i0();
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f32267a.setPadding(0, 0, 0, i13);
        this.f32267a.setClipToPadding(false);
    }

    @Override
    public final void onResume() {
        super.onResume();
        org.telegram.ui.Components.g61 g61Var = this.f32267a;
        if (g61Var != null) {
            g61Var.V2.N(true);
        }
    }
