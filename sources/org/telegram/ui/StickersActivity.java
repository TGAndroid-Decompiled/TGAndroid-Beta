...
public class StickersActivity extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    public org.telegram.ui.Components.f61 f31525a;
    private int archivedRow;
    public gg.j0 f31526b;
    public NumberTextView f31527c;
    public org.telegram.ui.Components.r41 d;
    private int dynamicPackOrder;
    public ArrayList e;
    public ArrayList f31528f;
    private int featuredRow;
    public final ArrayList h;
    private int largeEmojiRow;
    public org.telegram.ui.ActionBar.w0 f31529n;
    public int f31530r;
    public boolean f31531s;
    private int suggestRow;
    public final int v;
    public ArrayList f31532w;
    public final HashSet f31533x;
    public final bb1 f31534y;

    public StickersActivity(int i10, ArrayList arrayList) {
        super(null);
        this.h = new ArrayList();
        this.f31533x = new HashSet();
        this.f31534y = new bb1(this, 0);
        this.v = i10;
        this.f31532w = arrayList;
    }
    ...
    public static void U(StickersActivity stickersActivity, org.telegram.ui.Components.j51 j51Var, View view) {
        ...
        if (obj instanceof TLRPC.TL_messages_stickerSet) {
            ...
            if (stickersActivity.f31533x.isEmpty()) {
    ...
    public static void V(StickersActivity stickersActivity, ArrayList arrayList) {
        bb1 bb1Var = stickersActivity.f31534y;
        ArrayList arrayList2 = new ArrayList();
        ...
        if (view instanceof org.telegram.ui.Cells.ea) {
            ...
            if (doubleTapReaction != null) {
                ...
                if (tL_availableReaction != null) {
                    eaVar.getValueBackupImageView().getImageReceiver().setImage(ImageLocation.getForDocument(tL_availableReaction.center_icon), "100_100_lastreactframe", DocumentObject.getSvgThumb(tL_availableReaction.static_icon.thumbs, org.telegram.ui.ActionBar.j6.f18807a7, 1.0f), "webp", tL_availableReaction, 1);
                }
            }
        }
    }
    ...
    public static void c0(StickersActivity stickersActivity, ArrayList arrayList, org.telegram.ui.Components.x51 x51Var) {
        ...
        MediaDataController mediaDataController = MediaDataController.getInstance(stickersActivity.currentAccount);
        org.telegram.ui.Components.f61 f61Var = stickersActivity.f31525a;
        if (f61Var == null || (!f61Var.f23800c3 && !stickersActivity.f31531s && stickersActivity.f31530r <= 0)) {
            if (i16 == 5) {
                ...
                stickersActivity.f31532w = arrayList3;
        ...
        stickersActivity.f31528f = new ArrayList(stickersActivity.k0());
        int i17 = 0;
        int i18 = 0;
        while (i18 < stickersActivity.f31528f.size()) {
            if (arrayList2.contains(Long.valueOf(((TLRPC.StickerSetCovered) stickersActivity.f31528f.get(i18)).set.f18148id))) {
                stickersActivity.f31528f.remove(i18);
                i18--;
            }
            i18++;
        }
        int size = stickersActivity.f31528f.size();
        ...
        if (stickersActivity.e.size() > 0) {
            x51Var.U();
            if (i16 == 5 || (!stickersActivity.f31528f.isEmpty() && i16 == 0)) {
                if (i16 == 5) {
            ...
            for (int size3 = arrayList4.size(); i26 < size3; size3 = size3) {
                ...
                i26++;
                TLRPC.TL_messages_stickerSet tL_messages_stickerSet = (TLRPC.TL_messages_stickerSet) obj;
                int i27 = org.telegram.ui.Cells.l8.f20410a;
                        ...
                        switch (r2) {
                            case 0:
                                if (view != null && (view.getParent() instanceof org.telegram.ui.Cells.m8)) {
                                    ...
                                    final StickersActivity stickersActivity2 = this.f32723b;
                                ...
                                return;
                            case 1:
                                StickersActivity.Z(this.f32723b, view);
                                return;
                            default:
                                StickersActivity.X(this.f32723b, view);
                                return;
                        }
                    }
                };
                ...
                J.K(stickersActivity.f31533x.contains(Long.valueOf(tL_messages_stickerSet.set.f18148id)));
                arrayList.add(J);
            }
            charSequence = null;
            x51Var.L();
        ...
        if (stickersActivity.f31528f.size() > 3) {
            stickersActivity.f31528f = new ArrayList(stickersActivity.f31528f.subList(0, 3));
            z10 = true;
        } else {
            z10 = false;
        }
        if (i16 == 5 && !stickersActivity.f31528f.isEmpty()) {
            if (stickersActivity.e.size() > 0) {
            ...
            while (i17 < size4) {
                ...
                J2.f25135t = arrayList2.contains(Long.valueOf(stickerSetCovered.set.f18148id));
                arrayList.add(J2);
            }
            if (z10) {
    ...
    public static void d0(StickersActivity stickersActivity, int i10) {
        ...
        if (i10 == 2) {
            ...
            for (int i13 = 0; i13 < size; i13++) {
                ...
                if (stickersActivity.f31533x.contains(Long.valueOf(tL_messages_stickerSet.set.f18148id))) {
                    if (sb2.length() != 0) {
                        sb2.append("\n");
                    }
            ...
            N0.f25010s0 = new lw0(stickersActivity, 2);
            N0.show();
        } else if (i10 == 0 || i10 == 1) {
            ArrayList arrayList = new ArrayList(stickersActivity.f31533x.size());
            ...
            for (int i14 = 0; i14 < size2; i14++) {
                ...
                if (stickersActivity.f31533x.contains(Long.valueOf(tL_messages_stickerSet2.set.f18148id))) {
            ...
            if (size3 != 0) {
                if (size3 != 1) {
                    ...
                    if (i10 == 1) {
                        alertDialog$Builder.f18447a.R = LocaleController.formatString(R.string.DeleteStickerSetsAlertTitle, LocaleController.formatPluralString("StickerSets", size3, new Object[0]));
                        alertDialog$Builder.f18447a.T = LocaleController.formatString(R.string.DeleteStickersAlertMessage, Integer.valueOf(size3));
                        string = LocaleController.getString(R.string.Delete);
                    } else {
                        alertDialog$Builder.f18447a.R = LocaleController.formatString(R.string.ArchiveStickerSetsAlertTitle, LocaleController.formatPluralString("StickerSets", size3, new Object[0]));
                        alertDialog$Builder.f18447a.T = LocaleController.formatString(R.string.ArchiveStickersAlertMessage, Integer.valueOf(size3));
                ...
                while (true) {
                    if (i12 < size4) {
                        ...
                        if (stickersActivity.f31533x.contains(Long.valueOf(tL_messages_stickerSet3.set.f18148id))) {
                            if (i10 == 0) {
                                MediaDataController mediaDataController = MediaDataController.getInstance(stickersActivity.currentAccount);
                                Activity parentActivity = stickersActivity.getParentActivity();
                                ...
                                if (i10 == 1) {
                                    ...
                                    HashSet hashSet = stickersActivity2.f31533x;
                                    ...
                                    stickersActivity2.f31525a.Y2.N(true);
    ...
    public final View createView(Context context) {
        ...
        this.f31527c = numberTextView;
        numberTextView.setTextSize(18);
        this.f31527c.setTypeface(AndroidUtilities.bold());
        this.f31527c.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19247y8, false));
        j3.addView(this.f31527c, w7.x5.m(1.0f, 0, -1, 72, 0, 0));
        this.f31527c.setOnTouchListener(new bi.d(2));
        j3.g(2, R.drawable.msg_share, AndroidUtilities.dp(54.0f));
        j3.g(0, R.drawable.msg_archive, AndroidUtilities.dp(54.0f));
        this.f31529n = j3.g(1, R.drawable.msg_delete, AndroidUtilities.dp(54.0f));
        if (i10 == 5 && (arrayList = this.f31532w) != null) {
            this.e = arrayList;
        } else {
        ...
        org.telegram.ui.Components.f61 f61Var = new org.telegram.ui.Components.f61(this, new Utilities.Callback2(this) {
            public final StickersActivity f33356b;
            ...
            public final void run(Object obj, Object obj2) {
                switch (r2) {
                    case 0:
                        StickersActivity.c0(this.f33356b, (ArrayList) obj, (org.telegram.ui.Components.x51) obj2);
                        return;
                    default:
                        ((Integer) obj).getClass();
                        StickersActivity.V(this.f33356b, (ArrayList) obj2);
                        return;
                }
            }
        ...
        this.f31525a = f61Var;
        f61Var.q1();
        this.f31525a.setFocusable(true);
        this.f31525a.setTag(7);
        this.f31525a.C1(new Utilities.Callback2(this) {
            public final StickersActivity f33356b;
        ...
        this.f31526b = j0Var;
        j0Var.j1(1);
        this.f31525a.setLayoutManager(this.f31526b);
        frameLayout.addView(this.f31525a, w7.x5.c(-1.0f, -1));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31525a, 16, new Class[]{org.telegram.ui.Cells.m8.class, org.telegram.ui.Cells.ea.class, org.telegram.ui.Cells.w8.class}, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31525a, 32768, null, null, null, null, org.telegram.ui.ActionBar.j6.f19140s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31527c, 4, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31525a, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f18953i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31525a, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f18985k0, null, null, org.telegram.ui.ActionBar.j6.f18864d7));
        int i12 = org.telegram.ui.ActionBar.j6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31525a, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31525a, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.M6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31525a, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.N6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31525a, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.B6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31525a, 2, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.J6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31525a, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31525a, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.I6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31525a, 0, new Class[]{org.telegram.ui.Cells.m8.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31525a, 0, new Class[]{org.telegram.ui.Cells.m8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19264z6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31525a, 196608, new Class[]{org.telegram.ui.Cells.m8.class}, new String[]{"optionsButton"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.Vh));
        int i13 = org.telegram.ui.ActionBar.j6.Uh;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31525a, 0, new Class[]{org.telegram.ui.Cells.m8.class}, new String[]{"optionsButton"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31525a, 0, new Class[]{org.telegram.ui.Cells.m8.class}, new String[]{"reorderButton"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31525a, 8192, new Class[]{org.telegram.ui.Cells.m8.class}, new String[]{"checkBox"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31525a, 16384, new Class[]{org.telegram.ui.Cells.m8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f18992k7));
    ...
    public final void i0() {
        ...
        if (size > 0) {
            if (hashSet.size() > 0) {
                ...
                if (this.f31529n.getVisibility() != i10) {
                    this.f31529n.setVisibility(i10);
                }
            }
            this.f31527c.a(size, s10);
            if (!s10) {
                this.actionBar.O(null, null);
                this.f31525a.x1(true);
    ...
    public final void onResume() {
        super.onResume();
        org.telegram.ui.Components.f61 f61Var = this.f31525a;
        if (f61Var != null) {
            f61Var.Y2.N(true);
        }
    }
