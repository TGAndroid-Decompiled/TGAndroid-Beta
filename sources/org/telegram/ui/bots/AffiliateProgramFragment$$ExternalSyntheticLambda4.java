...
public final class AffiliateProgramFragment$$ExternalSyntheticLambda4 implements Runnable {
    public final int $r8$classId;
    public final AffiliateProgramFragment f$0;

    public AffiliateProgramFragment$$ExternalSyntheticLambda4(AffiliateProgramFragment affiliateProgramFragment, int i) {
        this.$r8$classId = i;
    ...
    public final void run() {
        switch (this.$r8$classId) {
            ...
            case 1:
                ...
                Browser.openUrl(affiliateProgramFragment2.getContext(), LocaleController.getString((affiliateProgramFragment2.new_program || affiliateProgramFragment2.program.end_date != 0) ? R.string.AffiliateProgramUpdateInfoLink : R.string.AffiliateProgramStartInfoLink));
                break;
            default:
                ...
                AlertDialog alertDialog = new AlertDialog(affiliateProgramFragment3.getContext(), 3, null);
                ...
                affiliateProgramFragment3.getConnectionsManager().sendRequest(updatestarrefprogram, new AffiliateProgramFragment$$ExternalSyntheticLambda13(affiliateProgramFragment3, alertDialog, 1));
                break;
        }
    }
}
