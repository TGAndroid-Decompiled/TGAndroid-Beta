...
public class BotWebViewSheet extends Dialog implements NotificationCenter.NotificationCenterDelegate, BottomSheetTabsOverlay.Sheet {
    ...
    public void showJustAddedBulletin() {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() {
            ...
            public final void run() {
                BotWebViewSheet.m4830$r8$lambda$DCLnpefspF3cKG10fzqKOvqTpU(this.f$0, string);
            }
        }, 200L);
    }

    public static void m4830$r8$lambda$DCLnpefspF3cKG10fzqKOvqTpU(BotWebViewSheet botWebViewSheet, final String str) {
    ...
    public static void $r8$lambda$Mn_TVu4ChUTsqxCpM5C0Fm_UEAY(final BotWebViewSheet botWebViewSheet) {
        ...
        ConnectionsManager.getInstance(botWebViewSheet.currentAccount).sendRequest(tL_messages_prolongWebView, new RequestDelegate() {
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                BotWebViewSheet.m4837$r8$lambda$s2PtDEFvVIbvcLXS67atgeNfEI(this.f$0, tLObject, tL_error);
            }
        });
    }

    public static void m4837$r8$lambda$s2PtDEFvVIbvcLXS67atgeNfEI(final BotWebViewSheet botWebViewSheet, TLObject tLObject, final TLRPC.TL_error tL_error) {
        botWebViewSheet.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
    ...
    public BotWebViewSheet(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        botButtons.setOnButtonClickListener(new Utilities.Callback() {
            ...
            public final void run(Object obj) {
                BotWebViewSheet.m4833$r8$lambda$ewBebiJ2R2NkactmnJRNg89s(this.f$0, (Boolean) obj);
            }
        });
        ...
        this.fullscreenButtons.setOnCollapseClickListener(new Runnable() {
            @Override
            public final void run() {
                BotWebViewSheet.m4834$r8$lambda$fR_PZN517ustV5BvUIIAagrPik(this.f$0);
            }
        });
    ...
    class AnonymousClass3 implements BotWebViewContainer.Delegate {
        ...
        public static void $r8$lambda$TnL23fOEsU9628ru1WC1tk7GYzU(final AnonymousClass3 anonymousClass3) {
            ...
            ConnectionsManager.getInstance(BotWebViewSheet.this.currentAccount).sendRequest(toggleuseremojistatuspermission, new RequestDelegate() {
                @Override
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    BotWebViewSheet.AnonymousClass3.m4843$r8$lambda$fEFGszjyeIAu6gdwzeKpB3XYc0(this.f$0, tLObject, tL_error);
                }
            });
        }

        public static void m4843$r8$lambda$fEFGszjyeIAu6gdwzeKpB3XYc0(final AnonymousClass3 anonymousClass3, final TLObject tLObject, final TLRPC.TL_error tL_error) {
            anonymousClass3.getClass();
            AndroidUtilities.runOnUIThread(new Runnable() {
                @Override
                public final void run() {
            ...
            if (paymentFormActivity != null) {
                ...
                paymentFormActivity.setPaymentFormCallback(new PaymentFormActivity.PaymentFormCallback() {
                    ...
                    public final void onInvoiceStatusChanged(PaymentFormActivity.InvoiceStatus invoiceStatus) {
                        BotWebViewSheet.AnonymousClass3.m4842$r8$lambda$8pBhQdIMbkPrhPqtjcb8kZMRoY(this.f$0, overlayActionBarLayoutDialog, str, invoiceStatus);
                    }
                });
        ...
        public static void m4842$r8$lambda$8pBhQdIMbkPrhPqtjcb8kZMRoY(AnonymousClass3 anonymousClass3, OverlayActionBarLayoutDialog overlayActionBarLayoutDialog, String str, PaymentFormActivity.InvoiceStatus invoiceStatus) {
            anonymousClass3.getClass();
    ...
    public static void m4833$r8$lambda$ewBebiJ2R2NkactmnJRNg89s(BotWebViewSheet botWebViewSheet, Boolean bool) {
    ...
    public static void m4834$r8$lambda$fR_PZN517ustV5BvUIIAagrPik(BotWebViewSheet botWebViewSheet) {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.windowView.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() {
            ...
            public final WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
                return BotWebViewSheet.m4840$r8$lambda$vtQLlun3FEzMs2jxFqv4zCQD3I(this.f$0, view, windowInsets);
            }
        });
    ...
    public static WindowInsets m4840$r8$lambda$vtQLlun3FEzMs2jxFqv4zCQD3I(BotWebViewSheet botWebViewSheet, View view, WindowInsets windowInsets) {
        botWebViewSheet.getClass();
    ...
    public void requestWebView(BaseFragment baseFragment, WebViewRequestProps webViewRequestProps) {
        ...
        if (i3 == 2) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_requestWebView2, new RequestDelegate() {
                @Override
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    BotWebViewSheet.m4829$r8$lambda$2toRd11VFnE3AHJJG6hSdIaDyY(this.f$0, tLObject, tL_error);
                }
            });
            NotificationCenter.getInstance(this.currentAccount).addObserver(this, NotificationCenter.webViewResultSent);
            return;
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_requestMainWebView, new RequestDelegate() {
            @Override
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                BotWebViewSheet.m4835$r8$lambda$jBosqiv3J4I4wRQVsICB99VHX0(this.f$0, tLObject, tL_error);
            }
        }, 66);
    }
    ...
    public static void m4829$r8$lambda$2toRd11VFnE3AHJJG6hSdIaDyY(final BotWebViewSheet botWebViewSheet, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        botWebViewSheet.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
    ...
    public static void m4835$r8$lambda$jBosqiv3J4I4wRQVsICB99VHX0(final BotWebViewSheet botWebViewSheet, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        botWebViewSheet.getClass();
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public final void run() {
    ...
    public void openOptions() {
        ...
        itemOptionsMakeOptions.addIf(this.onVerifiedAge == null, R.drawable.msg_bot, LocaleController.getString(R.string.BotWebViewOpenBot), new Runnable() {
            ...
            @Override
            public final void run() {
                BotWebViewSheet.m4828$r8$lambda$BiRon4FW4qOOI_E6GWeWg89tAw(this.f$0);
            }
    ...
    public static void m4828$r8$lambda$BiRon4FW4qOOI_E6GWeWg89tAw(BotWebViewSheet botWebViewSheet) {
    ...
    private void updateDownloadBulletin() {
        ...
        for (Map.Entry entry : this.fileItems.entrySet()) {
            ...
            actionBarMenuSubItem.setOnClickListener(new View.OnClickListener() {
                @Override
                public final void onClick(View view) {
                    BotWebViewSheet.m4839$r8$lambda$vGsI7GPbISv81TdixovJBFoc(this.f$0, fileDownload, view);
                }
            });
        }
    ...
    public static void m4839$r8$lambda$vGsI7GPbISv81TdixovJBFoc(BotWebViewSheet botWebViewSheet, BotDownloads.FileDownload fileDownload, View view) {
        botWebViewSheet.getClass();
        if (fileDownload.isDownloading()) {
            fileDownload.cancel();
        } else {
    ...
    public static void deleteBot(final int i, final long j, final Runnable runnable) {
        ...
        new AlertDialog.Builder(LaunchActivity.getLastFragment().getContext()).setTitle(LocaleController.getString(R.string.BotRemoveFromMenuTitle)).setMessage(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.BotRemoveFromMenu, tL_attachMenuBot.short_name))).setPositiveButton(LocaleController.getString(R.string.OK), new AlertDialog.OnButtonClickListener() {
            ...
            public final void onClick(AlertDialog alertDialog, int i3) {
                BotWebViewSheet.m4838$r8$lambda$uIn1j0k8zAK1QSr4PfDD44GQQo(i, j, tL_attachMenuBot, runnable, alertDialog, i3);
            }
        }).setNegativeButton(LocaleController.getString(R.string.Cancel), null).show();
    }

    public static void m4838$r8$lambda$uIn1j0k8zAK1QSr4PfDD44GQQo(final int i, long j, TLRPC.TL_attachMenuBot tL_attachMenuBot, Runnable runnable, AlertDialog alertDialog, int i2) {
