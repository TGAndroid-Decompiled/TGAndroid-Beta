...
public class BotWebViewSheet extends Dialog implements NotificationCenter.NotificationCenterDelegate, BottomSheetTabsOverlay.Sheet {
    ...
    class AnonymousClass3 implements BotWebViewContainer.Delegate {
        ...
        public void lambda$onSendWebViewData$1(TLObject tLObject, TLRPC.TL_error tL_error) throws InterruptedException {
    ...
    public void openOptions() {
        ...
        if (botDownloads.hasFiles()) {
            ...
            itemOptionsMakeSwipeback.add(R.drawable.msg_arrow_back, LocaleController.getString(R.string.Back), new ChatActivity$$ExternalSyntheticLambda320(itemOptionsMakeOptions));
