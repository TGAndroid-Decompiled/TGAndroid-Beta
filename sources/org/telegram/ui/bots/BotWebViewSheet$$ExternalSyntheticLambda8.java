...
public final class BotWebViewSheet$$ExternalSyntheticLambda8 implements RequestDelegate {
    public final int $r8$classId;
    public final BotWebViewSheet f$0;

    public BotWebViewSheet$$ExternalSyntheticLambda8(BotWebViewSheet botWebViewSheet, int i) {
        this.$r8$classId = i;
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.$r8$classId) {
            ...
            case 2:
                ...
                break;
            case 3:
                final BotWebViewSheet botWebViewSheet4 = this.f$0;
                botWebViewSheet4.getClass();
                final int i4 = 0;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        switch (i4) {
                            case 0:
                                BotWebViewSheet botWebViewSheet5 = botWebViewSheet4;
                                if (tL_error == null) {
                                    WebViewRequestProps webViewRequestProps = botWebViewSheet5.requestProps;
                                    if (webViewRequestProps != null) {
                                        webViewRequestProps.response = tLObject;
                                        webViewRequestProps.responseTime = System.currentTimeMillis();
                                        botWebViewSheet5.loadFromResponse();
                                ...
                                break;
                            case 1:
                                BotWebViewSheet botWebViewSheet6 = botWebViewSheet4;
                                if (tL_error == null) {
                                    WebViewRequestProps webViewRequestProps2 = botWebViewSheet6.requestProps;
                                    if (webViewRequestProps2 != null) {
                                        webViewRequestProps2.response = tLObject;
                                        webViewRequestProps2.responseTime = System.currentTimeMillis();
                                        botWebViewSheet6.loadFromResponse();
                                ...
                                break;
                            case 2:
                                BotWebViewSheet botWebViewSheet7 = botWebViewSheet4;
                                if (tL_error == null) {
                                    WebViewRequestProps webViewRequestProps3 = botWebViewSheet7.requestProps;
                                    if (webViewRequestProps3 != null) {
                                        webViewRequestProps3.response = tLObject;
                                        webViewRequestProps3.responseTime = System.currentTimeMillis();
                                        botWebViewSheet7.loadFromResponse();
                                ...
                                break;
                            case 3:
                                BotWebViewSheet botWebViewSheet8 = botWebViewSheet4;
                                if (tL_error == null) {
                                    WebViewRequestProps webViewRequestProps4 = botWebViewSheet8.requestProps;
                                    if (webViewRequestProps4 != null) {
                                        webViewRequestProps4.response = tLObject;
                                        webViewRequestProps4.responseTime = System.currentTimeMillis();
                                        botWebViewSheet8.loadFromResponse();
                                ...
                                break;
                            default:
                                BotWebViewSheet botWebViewSheet9 = botWebViewSheet4;
                                if (tL_error == null) {
                                    WebViewRequestProps webViewRequestProps5 = botWebViewSheet9.requestProps;
                                    if (webViewRequestProps5 != null) {
                                        webViewRequestProps5.response = tLObject;
                                        webViewRequestProps5.responseTime = System.currentTimeMillis();
            ...
            case 4:
                ...
                botWebViewSheet5.getClass();
                AndroidUtilities.runOnUIThread(new RichTableCell$$ExternalSyntheticLambda3(14, botWebViewSheet5, tL_error));
                break;
            default:
