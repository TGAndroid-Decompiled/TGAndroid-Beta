...
public final class BotWebViewSheet$3$$ExternalSyntheticLambda1 implements Runnable {
    public final int $r8$classId;
    public final BotWebViewSheet.AnonymousClass3 f$0;

    public BotWebViewSheet$3$$ExternalSyntheticLambda1(BotWebViewSheet.AnonymousClass3 anonymousClass3, int i) {
        this.$r8$classId = i;
    ...
    public final void run() {
        switch (this.$r8$classId) {
            ...
            case 1:
                ...
                BotLocation.get(botWebViewSheet2.getContext(), botWebViewSheet2.currentAccount, botWebViewSheet2.botId).setGranted(null, false);
                break;
            default:
