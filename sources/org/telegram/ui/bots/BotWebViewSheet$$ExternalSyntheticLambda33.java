...
public final class BotWebViewSheet$$ExternalSyntheticLambda33 implements ValueAnimator.AnimatorUpdateListener {
    public final int $r8$classId;
    public final BotWebViewSheet f$0;
    public final int f$1;
    public final int f$2;

    public BotWebViewSheet$$ExternalSyntheticLambda33(BotWebViewSheet botWebViewSheet, int i, int i2, int i3) {
        this.$r8$classId = i3;
