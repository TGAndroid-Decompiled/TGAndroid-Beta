...
public final class BotWebViewSheet$$ExternalSyntheticLambda13 implements ValueAnimator.AnimatorUpdateListener {
    public final int $r8$classId;
    public final BotWebViewSheet f$0;

    public BotWebViewSheet$$ExternalSyntheticLambda13(BotWebViewSheet botWebViewSheet, int i) {
        this.$r8$classId = i;
