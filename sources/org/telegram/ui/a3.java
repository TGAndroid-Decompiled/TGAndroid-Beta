...
public final class a3 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f34336a) {
            case 0:
                i4 i4Var = this.f34337b;
                if (i4Var.J0 && (articleViewer$WindowView = i4Var.f37245f0) != null) {
                    i4Var.J0 = false;
                    if (i4Var.f41461b != null) {
                        try {
                            articleViewer$WindowView.performHapticFeedback(0, 2);
                        } catch (Exception unused) {
                        }
                        i4Var.Z(((org.telegram.ui.Components.j01) i4Var.f41461b.f25650i).f27323b);
                        i4Var.f41461b = null;
                        i4Var.d = null;
                    ...
                    View view2 = i4Var.f41464f;
                    if (view2 != null && i4Var.O0.g0(view2)) {
                        if (i4Var.f41464f.getTag() != null && i4Var.f41464f.getTag() == "bottomSheet" && (q9Var = i4Var.P0) != null) {
                            q9Var.m0();
                        } else {
                            i4Var.O0.m0();
                        }
                        if (i4Var.O0.y()) {
                            try {
                                i4Var.f37245f0.performHapticFeedback(0, 2);
                                return;
                        ...
                        return;
                    } else if (i4Var.d != null && i4Var.f41464f != null) {
                        try {
                            i4Var.f37245f0.performHapticFeedback(0, 2);
                        } catch (Exception unused3) {
                        }
                        int[] iArr = new int[2];
                        i4Var.f41464f.getLocationInWindow(iArr);
                        int dp = (iArr[1] + i4Var.f41463e) - AndroidUtilities.dp(54.0f);
                        if (dp < 0) {
                            dp = 0;
                        }
                        i4Var.f41464f.invalidate();
                        i4Var.h = true;
                        View view3 = i4Var.f41464f;
                        ...
                        if (n1Var != null && n1Var.isShowing()) {
                            ...
                            if (i4Var.A0 == null) {
                                ...
                                i4Var.B0 = textView;
                                textView.setBackgroundDrawable(org.telegram.ui.ActionBar.j6.f0(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20780i6, false), 2, -1));
                        ...
                        i4Var.f37259u0[0].f38578b.setLayoutFrozen(true);
                        i4Var.f37259u0[0].f38578b.setLayoutFrozen(false);
                        return;
                    } else {
                        return;
                    }
                ...
                return;
            default:
                i4 i4Var2 = this.f34337b;
                if (i4Var2.K0 == null) {
                    i4Var2.K0 = new a3(i4Var2, 0);
                }
                i4Var2.K0.getClass();
                ArticleViewer$WindowView articleViewer$WindowView2 = i4Var2.f37245f0;
