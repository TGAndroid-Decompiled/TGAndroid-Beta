    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        switch (this.Q) {
            ...
            case 1:
                ...
                int measuredHeight4 = (measuredHeight3 - zx0Var.d.f33862v0.getMeasuredHeight()) / 2;
                org.telegram.ui.Components.x9 x9Var2 = zx0Var.d.f33862v0;
                x9Var2.layout(dp2, measuredHeight4, x9Var2.getMeasuredWidth() + dp2, zx0Var.d.f33862v0.getMeasuredHeight() + measuredHeight4);
                return;
            default:
                super.onLayout(z10, i10, i11, i12, i13);
                return;
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.Q) {
            ...
            case 1:
                super.onMeasure(i10, i11);
                zx0 zx0Var = (zx0) this.R;
                zx0Var.d.f33862v0.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(30.0f), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(30.0f), 1073741824));
                zx0Var.d.f33862v0.setRoundRadius(AndroidUtilities.dp(30.0f));
                return;
            default:
                super.onMeasure(i10, i11);
                return;
