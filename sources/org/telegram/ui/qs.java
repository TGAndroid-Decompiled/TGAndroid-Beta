...
public final class qs extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i10) {
        ...
        int i11;
        int i12;
        us usVar = this.f37014a;
        if (i10 == -1) {
            usVar.finishFragment();
        } else if (i10 == 1 && usVar.f38182b.getText().length() != 0) {
            ...
            user.first_name = usVar.f38182b.getText().toString();
            user.last_name = usVar.f38183c.getText().toString();
            user.contact = true;
