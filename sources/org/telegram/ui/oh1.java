...
public final class oh1 extends ViewGroup {
    public final Paint f35499a;
    public View f35500b;
    public boolean f35501c;

    public oh1(Context context) {
        super(context);
        this.f35499a = new Paint(1);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int h = i0.a.h(org.telegram.ui.ActionBar.j6.l1(navigationBarThirdButtonsFactor, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f17928d6, false)), w02);
        Paint paint = this.f35499a;
        paint.setColor(w02);
