...
public final class o30 extends org.telegram.ui.Components.aj0 {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        i60 i60Var = this.f36101r;
        v20 v20Var = i60Var.f34512y2;
        ArrayList arrayList = i60Var.Z1;
        if (i60Var.r1()) {
            return super.onTouchEvent(motionEvent);
        }
        if (motionEvent.getAction() == 0 && i60Var.F1 == 0 && i60Var.f34410a1 != null) {
            ...
            if (i60Var.R1) {
                ...
                AndroidUtilities.cancelRunOnUIThread(i60Var.f34507x2);
                i60Var.J1(0, true);
                if (VoIPService.getSharedInstance() != null) {
                    VoIPService.getSharedInstance().setMicMute(true, true, false);
                    try {
                        i60Var.f34499w.performHapticFeedback(3, 2);
