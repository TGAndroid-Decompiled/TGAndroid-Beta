...
public final class b61 extends org.telegram.ui.Components.jt {
            ...
            if (i10 < arrayList.size()) {
                ...
                if (!j61Var.f34649b) {
                    if (j61Var.f34648a) {
                        ...
                        ImageReceiver imageReceiver = j61Var.f34653r;
                        if (imageReceiver != null) {
                            imageReceiver.draw(canvas, j61Var.f34651f[this.K]);
                        }
                    }
                }
                i10++;
        ...
        if (this.O != null) {
            ...
            while (i11 < this.O.size()) {
                ...
                if (!j61Var.f34649b) {
                    ...
                    } else if (!j61Var.f34654s && !j61Var.Q) {
                        if ((j61Var.e != null || a71Var.W == 13) && !j61Var.f34649b && (drawable = j61Var.E) != null) {
                            drawable.setAlpha(255);
                            drawable.setBounds(rect);
                        }
                    } else {
                    ...
                    PorterDuffColorFilter porterDuffColorFilter = a71Var.f32020k1;
    ...
    public final void g() {
        ...
        while (true) {
            ArrayList arrayList = this.P;
            if (i10 < arrayList.size()) {
                ImageReceiver.BackgroundThreadDrawHolder backgroundThreadDrawHolder = ((j61) arrayList.get(i10)).f34651f[this.K];
                if (backgroundThreadDrawHolder != null) {
                    backgroundThreadDrawHolder.release();
                }
                i10++;
            } else {
                this.T.f32571e3.f32013h0.invalidate();
                return;
            }
        }
    }
    ...
    public final void m(Canvas canvas, Drawable drawable, j61 j61Var, float f7) {
        if (drawable != null) {
            ...
            drawable.setColorFilter(this.T.f32571e3.f32020k1);
        } else if ((j61Var.f34654s || j61Var.Q) && j61Var.h != null) {
            canvas.save();
