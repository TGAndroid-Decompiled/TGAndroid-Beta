...
public class TwoStepVerificationActivity extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int Z;
    public ug1 f31605a;
    public String f31606a0;
    public org.telegram.ui.Components.ml0 f31607b;
    public vg1 f31608b0;
    public org.telegram.ui.Components.bj0 f31609c;
    public final og1 f31610c0;
    private int changePasswordRow;
    public TextView d;
    public TextView e;
    public TextView f31611f;
    public TextView h;
    public org.telegram.ui.ActionBar.k5 f31612n;
    public TextView f31613r;
    public EditTextBoldCursor f31614s;
    private int turnPasswordOffRow;
    public org.telegram.ui.Components.yc0 v;
    public org.telegram.ui.ActionBar.c2 f31615w;
    public org.telegram.ui.Components.mz f31616x;
    public ScrollView f31617y;
    ...
    public static void W(TwoStepVerificationActivity twoStepVerificationActivity, TLRPC.TL_error tL_error) {
        ...
        if ("PASSWORD_HASH_INVALID".equals(tL_error.text)) {
            twoStepVerificationActivity.q0(twoStepVerificationActivity.v, twoStepVerificationActivity.f31614s, true);
    ...
    public static void X(TwoStepVerificationActivity twoStepVerificationActivity, boolean z10, byte[] bArr) {
        if (twoStepVerificationActivity.f31608b0 == null || !z10) {
            twoStepVerificationActivity.o0();
        }
        if (z10) {
            twoStepVerificationActivity.K = bArr;
            twoStepVerificationActivity.J = true;
            if (twoStepVerificationActivity.f31608b0 != null) {
                AndroidUtilities.hideKeyboard(twoStepVerificationActivity.f31614s);
                twoStepVerificationActivity.f31608b0.e(twoStepVerificationActivity.l0());
                return;
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31607b, 16, new Class[]{org.telegram.ui.Cells.ea.class, org.telegram.ui.Cells.j3.class}, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31607b, 32768, null, null, null, null, i11));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31607b, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f18953i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31607b, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f18985k0, null, null, org.telegram.ui.ActionBar.j6.f18864d7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31616x, 2048, null, null, null, null, org.telegram.ui.ActionBar.j6.f18935h6));
        int i12 = org.telegram.ui.ActionBar.j6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31607b, 262144, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31607b, 262144, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.f19083p7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31607b, 4, new Class[]{org.telegram.ui.Cells.j3.class}, new String[]{"textView"}, null, null, -1, null, i12));
        int i13 = org.telegram.ui.ActionBar.j6.H6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31607b, 8388608, new Class[]{org.telegram.ui.Cells.j3.class}, new String[]{"textView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31607b, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.B6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31611f, 4, null, null, null, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31612n, 4, null, null, null, null, org.telegram.ui.ActionBar.j6.q6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31614s, 4, null, null, null, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31614s, 8388608, null, null, null, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31614s, 32, null, null, null, null, org.telegram.ui.ActionBar.j6.f18991k6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f31614s, 65568, null, null, null, null, org.telegram.ui.ActionBar.j6.f19009l6));
        return arrayList;
    }
    ...
    public final void j0() {
        ...
        alertDialog$Builder.f18447a.R = LocaleController.getString(R.string.CancelReset);
    ...
    public final void o0() {
        ...
        org.telegram.ui.ActionBar.c2 c2Var = this.f31615w;
        if (c2Var == null) {
            return;
        }
        try {
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        org.telegram.ui.Components.bj0 bj0Var = this.f31609c;
    ...
    public final void onFragmentDestroy() {
        ...
        AndroidUtilities.cancelRunOnUIThread(this.f31610c0);
    ...
    public final void p0(boolean z10) {
        if (getParentActivity() != null && !getParentActivity().isFinishing() && this.f31615w == null) {
            if (!this.J) {
                AnimatorSet animatorSet = new AnimatorSet();
    ...
    public final void r0() {
        ...
        if (password.pending_reset_date == 0 && password.has_recovery) {
            ...
            alertDialog$Builder2.f18447a.R = LocaleController.getString(R.string.ResetPassword);
    ...
    public final void t0() {
        if (!this.J) {
            String obj = this.f31614s.getText().toString();
            if (obj.length() == 0) {
                q0(this.v, this.f31614s, false);
                return;
            }
    ...
    public final void x0() {
        ...
        alertDialog$Builder.f18447a.T = LocaleController.formatPluralString("ForceSetPasswordAlertMessageShort", this.X, new Object[0]);
    ...
    public final void z0() {
        ...
        sb3.append(this.S);
        sb3.append(this.T);
        if (this.f31605a != null && !sb2.toString().equals(sb3.toString())) {
            this.f31605a.l();
        }
        if (this.fragmentView != null) {
            if (!this.G && !this.J) {
                org.telegram.ui.Components.ml0 ml0Var = this.f31607b;
                if (ml0Var != null) {
                    ml0Var.setEmptyView(null);
                    this.f31607b.setVisibility(4);
                    this.f31617y.setVisibility(0);
                    this.f31616x.setVisibility(4);
                }
                if (this.f31614s != null) {
                    this.E.e(true, false);
                    this.f31614s.setVisibility(0);
                    ...
                    this.f31612n.setVisibility(0);
                    y0();
                    this.f31611f.setVisibility(8);
                    if (!TextUtils.isEmpty(this.I.hint)) {
                        this.f31614s.setHint(this.I.hint);
                    } else {
                        this.f31614s.setHint((CharSequence) null);
                    }
            ...
            org.telegram.ui.Components.ml0 ml0Var2 = this.f31607b;
            if (ml0Var2 != null) {
                ml0Var2.setVisibility(0);
                this.f31617y.setVisibility(4);
                this.f31607b.setEmptyView(this.f31616x);
            }
            if (this.f31614s != null) {
                this.E.e(false, false);
                this.f31614s.setVisibility(4);
                this.d.setVisibility(4);
                this.f31611f.setVisibility(8);
                this.f31612n.setVisibility(4);
                y0();
            }
