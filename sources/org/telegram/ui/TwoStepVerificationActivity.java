...
public class TwoStepVerificationActivity extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int Z;
    public sg1 f31588a;
    public String f31589a0;
    public org.telegram.ui.Components.ll0 f31590b;
    public tg1 f31591b0;
    public org.telegram.ui.Components.aj0 f31592c;
    public final mg1 f31593c0;
    private int changePasswordRow;
    public TextView d;
    public TextView e;
    public TextView f31594f;
    public TextView h;
    public org.telegram.ui.ActionBar.j5 f31595n;
    public TextView f31596r;
    public EditTextBoldCursor f31597s;
    private int turnPasswordOffRow;
    public org.telegram.ui.Components.yc0 v;
    public org.telegram.ui.ActionBar.b2 f31598w;
    public org.telegram.ui.Components.mz f31599x;
    public ScrollView f31600y;
    ...
    public static void W(TwoStepVerificationActivity twoStepVerificationActivity, TLRPC.TL_error tL_error) {
        ...
        if ("PASSWORD_HASH_INVALID".equals(tL_error.text)) {
            twoStepVerificationActivity.q0(twoStepVerificationActivity.v, twoStepVerificationActivity.f31597s, true);
    ...
    public static void X(TwoStepVerificationActivity twoStepVerificationActivity, boolean z10, byte[] bArr) {
        if (twoStepVerificationActivity.f31591b0 == null || !z10) {
            twoStepVerificationActivity.o0();
        }
        if (z10) {
            twoStepVerificationActivity.K = bArr;
            twoStepVerificationActivity.J = true;
            if (twoStepVerificationActivity.f31591b0 != null) {
                AndroidUtilities.hideKeyboard(twoStepVerificationActivity.f31597s);
                twoStepVerificationActivity.f31591b0.e(twoStepVerificationActivity.l0());
                return;
    ...
    public static void Y(TwoStepVerificationActivity twoStepVerificationActivity, byte[] bArr) {
        ...
        ns0 ns0Var = new ns0(twoStepVerificationActivity, bArr, bArr2, 12);
    ...
    public static void c0(TwoStepVerificationActivity twoStepVerificationActivity, int i10) {
        if (i10 != twoStepVerificationActivity.O && i10 != twoStepVerificationActivity.changePasswordRow) {
            ...
            gh1 gh1Var = new gh1(twoStepVerificationActivity.currentAccount, 3, twoStepVerificationActivity.I);
            gh1Var.J.add(twoStepVerificationActivity);
            gh1Var.D0(twoStepVerificationActivity.K, twoStepVerificationActivity.L, twoStepVerificationActivity.M, true);
            twoStepVerificationActivity.presentFragment(gh1Var);
            return;
        }
        gh1 gh1Var2 = new gh1(twoStepVerificationActivity.currentAccount, 0, twoStepVerificationActivity.I);
        gh1Var2.J.add(twoStepVerificationActivity);
        gh1Var2.D0(twoStepVerificationActivity.K, twoStepVerificationActivity.L, twoStepVerificationActivity.M, false);
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31590b, 16, new Class[]{org.telegram.ui.Cells.ea.class, org.telegram.ui.Cells.j3.class}, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31590b, 32768, null, null, null, null, i11));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31590b, 4096, null, null, null, null, org.telegram.ui.ActionBar.i6.f18926i6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31590b, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.i6.f18958k0, null, null, org.telegram.ui.ActionBar.i6.f18837d7));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31599x, 2048, null, null, null, null, org.telegram.ui.ActionBar.i6.f18908h6));
        int i12 = org.telegram.ui.ActionBar.i6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31590b, 262144, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31590b, 262144, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.f19056p7));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31590b, 4, new Class[]{org.telegram.ui.Cells.j3.class}, new String[]{"textView"}, null, null, -1, null, i12));
        int i13 = org.telegram.ui.ActionBar.i6.H6;
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31590b, 8388608, new Class[]{org.telegram.ui.Cells.j3.class}, new String[]{"textView"}, null, null, -1, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31590b, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.i6.B6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31594f, 4, null, null, null, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31595n, 4, null, null, null, null, org.telegram.ui.ActionBar.i6.q6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31597s, 4, null, null, null, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31597s, 8388608, null, null, null, null, i13));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31597s, 32, null, null, null, null, org.telegram.ui.ActionBar.i6.f18964k6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f31597s, 65568, null, null, null, null, org.telegram.ui.ActionBar.i6.f18982l6));
        return arrayList;
    }
    ...
    public final void j0() {
        ...
        alertDialog$Builder.f18437a.R = LocaleController.getString(R.string.CancelReset);
    ...
    public final void k0() {
        ...
        p0(false);
        Utilities.globalQueue.postRunnable(new nb1(10, this, updatepasswordsettings));
    }
    ...
    public final void o0() {
        ...
        org.telegram.ui.ActionBar.b2 b2Var = this.f31598w;
        if (b2Var == null) {
            return;
        }
        try {
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        org.telegram.ui.Components.aj0 aj0Var = this.f31592c;
    ...
    public final void onFragmentDestroy() {
        ...
        AndroidUtilities.cancelRunOnUIThread(this.f31593c0);
    ...
    public final void p0(boolean z10) {
        if (getParentActivity() != null && !getParentActivity().isFinishing() && this.f31598w == null) {
            if (!this.J) {
                AnimatorSet animatorSet = new AnimatorSet();
    ...
    public final void q0(org.telegram.ui.Components.yc0 yc0Var, EditTextBoldCursor editTextBoldCursor, boolean z10) {
        ...
        yc0Var.a(1.0f);
        AndroidUtilities.shakeViewSpring(yc0Var, 5.0f, new mg1(this, 3));
    }
        ...
        if (password.pending_reset_date == 0 && password.has_recovery) {
            ...
            if (this.I.pending_reset_date != 0) {
                if (getConnectionsManager().getCurrentTime() > this.I.pending_reset_date) {
                    AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(getParentActivity());
                    alertDialog$Builder.k(LocaleController.getString(R.string.Reset), new kg1(this, 3));
                    alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
            ...
            alertDialog$Builder2.k(LocaleController.getString(R.string.Reset), new kg1(this, 4));
            alertDialog$Builder2.h(LocaleController.getString(R.string.Cancel), null);
            alertDialog$Builder2.f18437a.R = LocaleController.getString(R.string.ResetPassword);
    ...
    public final void t0() {
        if (!this.J) {
            String obj = this.f31597s.getText().toString();
            if (obj.length() == 0) {
                q0(this.v, this.f31597s, false);
                return;
            }
            byte[] stringBytes = AndroidUtilities.getStringBytes(obj);
            p0(false);
            Utilities.globalQueue.postRunnable(new nb1(9, this, stringBytes));
        }
    }
    ...
    public final void x0() {
        ...
        alertDialog$Builder.f18437a.T = LocaleController.formatPluralString("ForceSetPasswordAlertMessageShort", this.X, new Object[0]);
    ...
    public final void z0() {
        ...
        sb3.append(this.S);
        sb3.append(this.T);
        if (this.f31588a != null && !sb2.toString().equals(sb3.toString())) {
            this.f31588a.l();
        }
        if (this.fragmentView != null) {
            if (!this.G && !this.J) {
                org.telegram.ui.Components.ll0 ll0Var = this.f31590b;
                if (ll0Var != null) {
                    ll0Var.setEmptyView(null);
                    this.f31590b.setVisibility(4);
                    this.f31600y.setVisibility(0);
                    this.f31599x.setVisibility(4);
                }
                if (this.f31597s != null) {
                    this.E.e(true, false);
                    this.f31597s.setVisibility(0);
                    ...
                    this.f31595n.setVisibility(0);
                    y0();
                    this.f31594f.setVisibility(8);
                    if (!TextUtils.isEmpty(this.I.hint)) {
                        this.f31597s.setHint(this.I.hint);
                    } else {
                        this.f31597s.setHint((CharSequence) null);
                    }
            ...
            org.telegram.ui.Components.ll0 ll0Var2 = this.f31590b;
            if (ll0Var2 != null) {
                ll0Var2.setVisibility(0);
                this.f31600y.setVisibility(4);
                this.f31590b.setEmptyView(this.f31599x);
            }
            if (this.f31597s != null) {
                this.E.e(false, false);
                this.f31597s.setVisibility(4);
