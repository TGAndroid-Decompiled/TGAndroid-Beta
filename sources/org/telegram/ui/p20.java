...
public final class p20 implements View.OnClickListener {
    public final int f36924a;
    public final e60 f36925b;

    public p20(e60 e60Var, int i10) {
        this.f36924a = i10;
        this.f36925b = e60Var;
    }
    ...
    public final void onClick(View view) {
        ...
        int i11;
        String string;
        int i12 = this.f36924a;
        int i13 = 0;
        e60 e60Var = this.f36925b;
        switch (i12) {
            case 0:
                org.telegram.ui.ActionBar.w0 w0Var = e60Var.f33647h1;
                org.telegram.ui.ActionBar.g1 g1Var = e60Var.f33692s1;
                org.telegram.ui.ActionBar.g1 g1Var2 = e60Var.f33687r1;
                org.telegram.ui.ActionBar.g1 g1Var3 = e60Var.f33665m1;
                ChatObject.Call call = e60Var.X0;
                if (call != null && !e60Var.X1.f29685b) {
                    if (call.call.join_muted) {
                        int i14 = org.telegram.ui.ActionBar.j6.f19962hg;
                        ...
                        int i15 = org.telegram.ui.ActionBar.j6.f20229wg;
                        ...
                        int i16 = org.telegram.ui.ActionBar.j6.f20229wg;
                        ...
                        int i17 = org.telegram.ui.ActionBar.j6.f19962hg;
            ...
            case 1:
                if (e60Var.r1()) {
                    if (ef.d.a(e60Var.f33638f0) > 0) {
                        org.telegram.ui.Components.voip.g1.n(e60Var.f33638f0);
                        e60Var.dismiss();
                        return;
                    }
                    org.telegram.ui.Components.z4.B(e60Var.f33638f0, null, true).o();
                    return;
                } else if (AndroidUtilities.checkInlinePermissions(e60Var.f33638f0)) {
            ...
            case 2:
                ...
                if (sharedInstance != null) {
                    ...
                    LaunchActivity launchActivity = e60Var.f33638f0;
                    if (launchActivity != null) {
                        e60Var.f33638f0.startActivityForResult(((MediaProjectionManager) launchActivity.getSystemService("media_projection")).createScreenCaptureIntent(), 520);
                        return;
                    }
                    return;
                }
            ...
            case 6:
                ...
                org.telegram.ui.Components.xt xtVar = e60Var.E.f24030a;
                xtVar.requestFocus();
                ...
                if (sharedInstance2 != null && sharedInstance2.getVideoState(false) == 2) {
                    ...
                    for (int i18 = 0; i18 < arrayList.size(); i18++) {
                        ...
                        if (videoParticipant.participant.self && !videoParticipant.presentation) {
                            org.telegram.ui.Components.voip.o oVar = tVar.f29891a;
                            if (tVar.G0 == null) {
                                tVar.H0 = false;
                                ImageView imageView = tVar.f29917u0;
                                if (imageView == null) {
                                    tVar.f29917u0 = new ImageView(tVar.getContext());
                                } else {
                                ...
                                if (oVar.d.isFirstFrameRendered()) {
                                    ...
                                    if (bitmap != null) {
                                        ...
                                        tVar.f29917u0.setBackground(new BitmapDrawable(bitmap));
                                    }
                                    tVar.f29917u0.setAlpha(0.0f);
                                } else {
                                    tVar.f29917u0.setAlpha(1.0f);
                                }
                                if (tVar.f29917u0.getParent() == null) {
                                    oVar.addView(tVar.f29917u0);
                                }
                                ((FrameLayout.LayoutParams) tVar.f29917u0.getLayoutParams()).gravity = 17;
                                ...
                                tVar.G0.setInterpolator(org.telegram.ui.Components.mr.f27122f);
                                tVar.G0.start();
                            }
                        }
                    }
            ...
            default:
                ...
                e60Var.f33706v3 = Integer.valueOf(i13);
                e60Var.N1(true, true);
                e60Var.f33706v3 = null;
                AndroidUtilities.runOnUIThread(new org.telegram.ui.Components.dw(e60Var, i13, 11));
                return;
        }
    }
}
