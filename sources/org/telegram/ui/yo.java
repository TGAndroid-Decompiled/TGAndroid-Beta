        ...
        switch (this.f43200a) {
            case 0:
                if (tLObject instanceof TLRPC.TL_boolTrue) {
                    AndroidUtilities.runOnUIThread(new ap(this.f43201b, 3));
                    return;
                }
                return;
            case 1:
                final lp lpVar = this.f43201b;
                    ...
                    public final void run() {
                        switch (r3) {
                            case 0:
                                ...
                                lpVar2.f38477t0 = false;
                                AndroidUtilities.runOnUIThread(new ap(lpVar2, 4));
                                return;
                            default:
                                lp lpVar3 = lpVar;
                                ArrayList arrayList = lpVar3.f38461f0;
                                lpVar3.f38457d0 = false;
                                ...
                                if (tLObject2 != null && lpVar3.getParentActivity() != null) {
                                    ...
                                    for (int i12 = 0; i12 < tL_messages_chats.chats.size(); i12++) {
                                        ...
                                        nVar.a(chat, z11);
                                        arrayList.add(nVar);
                                        lpVar3.f38479x.addView(nVar, w7.x5.n(-1, 72));
                                    }
                                    lpVar3.b0();
                                    return;
                                }
            ...
            case 2:
                ...
                return;
            default:
                AndroidUtilities.runOnUIThread(new fh(16, this.f43201b, tL_error));
                return;
        }
    }
}
