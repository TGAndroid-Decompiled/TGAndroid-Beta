...
public final class pj extends org.telegram.ui.Components.co {
    ...
    public final boolean d() {
        ...
        if (user != null && user.linked_community_id != 0) {
            coVar.showDialog(new gi.k0(coVar, coVar.f35277f.linked_community_id, null, null));
            return true;
        }
        TLRPC.Chat chat = coVar.f35265e;
        if (chat != null && chat.linked_community_id != 0) {
            coVar.showDialog(new gi.k0(coVar, coVar.f35265e.linked_community_id, null, null));
            return true;
        }
        return false;
    }
