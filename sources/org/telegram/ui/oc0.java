...
public final class oc0 extends FrameLayout {
    public final HashMap f41089a;
    public final rc0 f41090b;

    public oc0(rc0 rc0Var, Context context) {
        super(context);
        this.f41090b = rc0Var;
        this.f41089a = new HashMap();
    }

    public final void a() {
        IMapsProvider.IMap iMap = this.f41090b.E;
        if (iMap != null) {
            IMapsProvider.IProjection projection = iMap.getProjection();
            for (Map.Entry entry : this.f41089a.entrySet()) {
