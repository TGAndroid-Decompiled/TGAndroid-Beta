        ...
        switch (this.f36136a) {
            case 0:
                ...
                if (cd0Var.I != null) {
                    ...
                    TLRPC.TL_channelLocation tL_channelLocation = cd0Var.f32688z0;
                    if (tL_channelLocation != null) {
                        ...
                        if (DialogObject.isUserDialog(cd0Var.f32661e0)) {
                            obj2.f38956c = cd0Var.getMessagesController().getUser(Long.valueOf(cd0Var.f32661e0));
                        } else {
                            obj2.d = cd0Var.getMessagesController().getChat(Long.valueOf(-cd0Var.f32661e0));
                        }
                        obj2.f38954a = cd0Var.f32661e0;
                        cd0Var.v0(obj2);
                        try {
                            ...
                            if (g02 != null) {
                                ...
                                if (!UserObject.isUserSelf(obj2.f38956c)) {
                                    IMapsProvider.IMarkerOptions flat = ApplicationLoader.getMapsProvider().onCreateMarkerOptions().position(latLng).flat(true);
                                    flat.icon(R.drawable.map_pin_circle);
                                    flat.anchor(0.5f, 0.5f);
                                    obj2.f38957f = cd0Var.I.addMarker(flat);
                                }
                                cd0Var.f32664g0.add(obj2);
                                cd0Var.f32665h0.k(obj2, obj2.f38954a);
                            }
                        } catch (Exception e) {
                            FileLog.e(e);
                        }
                        ...
                        if (messageObject != null) {
                            if (messageObject.isLiveLocation()) {
                                ...
                                IMapsProvider.LatLng latLng2 = new IMapsProvider.LatLng(cd0Var.f32685x0.getLatitude(), cd0Var.f32685x0.getLongitude());
                                try {
                                ...
                                cd0Var.f32663f0 = false;
                                cd0Var.l0();
                            }
                        } else {
                            Location location = new Location("network");
                            cd0Var.f32685x0 = location;
                            ...
                            if (tL_channelLocation2 != null) {
                                ...
                                cd0Var.f32685x0.setLatitude(cd0Var.A0.geo_point.lat);
                                cd0Var.f32685x0.setLongitude(cd0Var.A0.geo_point._long);
                                cd0Var.f32685x0.setAccuracy(cd0Var.A0.geo_point.accuracy_radius);
                                cd0Var.T.L(cd0Var.f32685x0);
                            } else {
                                location.setLatitude(20.659322d);
                                cd0Var.f32685x0.setLongitude(-11.40625d);
                            }
                        }
                    }
                    try {
                    ...
                    for (int size = providers.size() - 1; size >= 0; size--) {
                        ...
                        if (location2 != null) {
                            cd0Var.f32683w0 = location2;
                            cd0Var.t0(location2);
                            if (cd0Var.f32657b0 && cd0Var.getParentActivity() != null) {
                                cd0Var.f32657b0 = false;
                                cd0Var.d0();
                            }
                            imageView = cd0Var.f32658c;
                            if (imageView == null && imageView.getVisibility() == 0 && (sharingLocationInfo = cd0Var.getLocationController().getSharingLocationInfo(cd0Var.f32661e0)) != null && (i11 = sharingLocationInfo.proximityMeters) > 0) {
                                cd0Var.e0(i11);
                                return;
                            }
                            return;
                ...
                return;
            default:
                cd0 cd0Var2 = this.f36137b;
                Location location3 = (Location) obj;
                cd0Var2.t0(location3);
                cd0Var2.getLocationController().setMapLocation(location3, cd0Var2.f32660d0);
                cd0Var2.f32660d0 = false;
                return;
        }
    }
}
