...
public final class oc0 extends FrameLayout {
    public final ImageView f36299a;
    public final LinearLayout f36300b;
    public final ai.p4 f36301c;
    public final org.telegram.ui.Components.n6 d;
    public final ImageView e;
    public final Switch f36302f;
    ...
    public oc0(pc0 pc0Var, Context context) {
        ...
        this.f36299a = imageView;
        int w02 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19028m6, false);
        ...
        n6Var.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i16, false));
    ...
    public final void b(boolean z10, boolean z11) {
        ...
        if (this.f36305s != z10) {
            ...
            Switch r12 = this.f36302f;
            LinearLayout linearLayout = this.f36300b;
            ImageView imageView = this.f36299a;
            float f15 = 1.0f;
            if (z11) {
    ...
    public final void c(jc0 jc0Var, boolean z10) {
        ...
        int i10 = jc0Var.e;
        this.f36306w = a(value & i10);
        this.f36307x = a(i10);
        boolean z11 = false;
        String format = String.format("%d/%d", Integer.valueOf(this.f36306w), Integer.valueOf(this.f36307x));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        super.onDraw(canvas);
        boolean z10 = LocaleController.isRTL;
        ai.p4 p4Var = this.f36301c;
        if (z10) {
            if (this.f36304r) {
                float dp = AndroidUtilities.dp(75.0f);
                canvas.drawRect(dp - AndroidUtilities.dp(0.66f), (getMeasuredHeight() - AndroidUtilities.dp(20.0f)) / 2.0f, dp, (AndroidUtilities.dp(20.0f) + getMeasuredHeight()) / 2.0f, org.telegram.ui.ActionBar.j6.f18985k0);
            }
            if (this.f36303n) {
                ...
                canvas.drawLine(measuredWidth + i10, getMeasuredHeight() - 1, 0.0f, getMeasuredHeight() - 1, org.telegram.ui.ActionBar.j6.f18985k0);
                return;
            }
            return;
        }
        if (this.f36304r) {
            ...
            canvas.drawRect(measuredWidth2 - AndroidUtilities.dp(0.66f), (getMeasuredHeight() - AndroidUtilities.dp(20.0f)) / 2.0f, measuredWidth2, (AndroidUtilities.dp(20.0f) + getMeasuredHeight()) / 2.0f, org.telegram.ui.ActionBar.j6.f18985k0);
        }
        if (this.f36303n) {
            canvas.drawLine(p4Var.getTranslationX() + AndroidUtilities.dp(64.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, org.telegram.ui.ActionBar.j6.f18985k0);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (npVar.getVisibility() == 0) {
            ...
            accessibilityNodeInfo.setChecked(this.f36302f.h);
        }
        StringBuilder sb2 = new StringBuilder();
        sb2.append(this.f36301c.getText());
        if (this.v) {
            sb2.append('\n');
            sb2.append(LocaleController.formatString("Of", R.string.Of, Integer.valueOf(this.f36306w), Integer.valueOf(this.f36307x)));
        }
