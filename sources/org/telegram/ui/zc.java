...
public final class zc extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.f6 f40193b;
    ...
    public final void a(String str, boolean z10) {
        ...
        int i11 = 0;
        while (true) {
            arrayList = this.f40194c;
            boolean z11 = true;
            if (i11 >= arrayList.size()) {
                break;
            }
            org.telegram.ui.Components.lp lpVar = (org.telegram.ui.Components.lp) arrayList.get(i11);
            if (!TextUtils.equals(this.f40198s, lpVar.a()) && (!TextUtils.isEmpty(str) || !lpVar.f26155a.f18822a)) {
                z11 = false;
            }
            lpVar.d = z11;
            if (z11) {
    ...
    public void setGalleryWallpaper(TLRPC.WallPaper wallPaper) {
        ...
        if (this.v != null) {
            ArrayList arrayList = this.f40194c;
            if ((arrayList.isEmpty() || ((org.telegram.ui.Components.lp) arrayList.get(0)).f26155a.f18822a) && this.f40195f) {
                arrayList.add(0, new org.telegram.ui.Components.lp(org.telegram.ui.ActionBar.d4.a(this.f40192a)));
                this.h.l();
            }
        }
    }
