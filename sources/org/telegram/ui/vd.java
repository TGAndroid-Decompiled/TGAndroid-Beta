        ...
        switch (this.f42089a) {
            case 0:
                if (tL_error != null) {
                    ...
                    ke keVar = this.f42090b;
                    AndroidUtilities.runOnUIThread(new pd(keVar, 4));
                    MessagesController.getInstance(keVar.f38282v0).processUpdates((TLRPC.Updates) tLObject, false);
                    return;
                } else {
                    return;
                }
            case 1:
                final ke keVar2 = this.f42090b;
                        ...
                        switch (r3) {
                            case 0:
                                ...
                                if (tLObject2 instanceof TLRPC.TL_payments_starsRevenueStats) {
                                    ...
                                    keVar3.f38272m1 = na1.f0(statsGraph, LocaleController.getString(R.string.MonetizationGraphRevenue), 2, false);
                                    z91 z91Var = keVar3.l1;
                                    if (z91Var != null) {
                                        z91Var.f43870n = true;
                                    }
                                    keVar3.f38267g1 = tL_payments_starsRevenueStats.usd_rate;
                        ...
                        switch (r3) {
                            case 0:
                                ...
                                if (tLObject2 instanceof TLRPC.TL_payments_starsRevenueStats) {
                                    ...
                                    keVar32.f38272m1 = na1.f0(statsGraph, LocaleController.getString(R.string.MonetizationGraphRevenue), 2, false);
                                    z91 z91Var = keVar32.l1;
                                    if (z91Var != null) {
                                        z91Var.f43870n = true;
                                    }
                                    keVar32.f38267g1 = tL_payments_starsRevenueStats.usd_rate;
