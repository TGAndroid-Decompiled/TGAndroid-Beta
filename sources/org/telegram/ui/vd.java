        ...
        switch (this.f38397a) {
            case 0:
                if (tL_error != null) {
                    ...
                    le leVar = this.f38398b;
                    AndroidUtilities.runOnUIThread(new pd(leVar, 4));
                    MessagesController.getInstance(leVar.f35533y0).processUpdates((TLRPC.Updates) tLObject, false);
                    return;
                } else {
                    return;
                }
            case 1:
                final le leVar2 = this.f38398b;
                        ...
                        switch (r3) {
                            case 0:
                                ...
                                if (tLObject2 instanceof TLRPC.TL_payments_starsRevenueStats) {
                                    ...
                                    leVar3.f35523p1 = ab1.f0(statsGraph, LocaleController.getString(R.string.MonetizationGraphRevenue), 2, false);
                                    ma1 ma1Var = leVar3.f35522o1;
                                    if (ma1Var != null) {
                                        ma1Var.f35756n = true;
                                    }
                                    leVar3.f35518j1 = tL_payments_starsRevenueStats.usd_rate;
                                    leVar3.g0(true, tL_payments_starsRevenueStats.status);
                                    leVar3.f35511c1.animate().alpha(0.0f).setDuration(380L).setInterpolator(org.telegram.ui.Components.qr.h).withEndAction(new pd(leVar3, 6)).start();
                                    leVar3.a0();
                                    return;
                                }
                                return;
                        ...
                        switch (r3) {
                            case 0:
                                ...
                                if (tLObject2 instanceof TLRPC.TL_payments_starsRevenueStats) {
                                    ...
                                    ma1 f02 = ab1.f0(tL_payments_starsRevenueStats.top_hours_graph, LocaleController.getString(R.string.MonetizationGraphImpressions), 0, false);
                                    le leVar32 = leVar3;
                                    leVar32.f35522o1 = f02;
                                    TL_stats.StatsGraph statsGraph = tL_payments_starsRevenueStats.revenue_graph;
                                    if (statsGraph != null) {
                                        statsGraph.rate = (float) (1.0E7d / tL_payments_starsRevenueStats.usd_rate);
                                    }
                                    leVar32.f35523p1 = ab1.f0(statsGraph, LocaleController.getString(R.string.MonetizationGraphRevenue), 2, false);
                                    ma1 ma1Var = leVar32.f35522o1;
                                    if (ma1Var != null) {
                                        ma1Var.f35756n = true;
                                    }
                                    leVar32.f35518j1 = tL_payments_starsRevenueStats.usd_rate;
                                    leVar32.g0(true, tL_payments_starsRevenueStats.status);
                                    leVar32.f35511c1.animate().alpha(0.0f).setDuration(380L).setInterpolator(org.telegram.ui.Components.qr.h).withEndAction(new pd(leVar32, 6)).start();
                                    leVar32.a0();
                                    return;
                                }
                                return;
