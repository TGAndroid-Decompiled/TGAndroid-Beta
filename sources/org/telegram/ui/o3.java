...
public final class o3 implements pu0 {
    public final TLRPC.WebPage f36042a;
    public final List f36043b;
    public final i4 f36044c;

    public o3(i4 i4Var, TLRPC.WebPage webPage, List list) {
        this.f36044c = i4Var;
        this.f36042a = webPage;
        this.f36043b = list;
    }

    @Override
    public final boolean a(int i10) {
        if (i10 < this.f36043b.size() && i10 >= 0 && f4.g(this.f36042a, get(i10))) {
            return true;
        }
        return false;
    }
    ...
    public final boolean e(int i10) {
        if (i10 < this.f36043b.size() && i10 >= 0 && !f4.g(this.f36042a, get(i10))) {
            g4 g4Var = this.f36044c.f34408u0[0].f35462c;
            TL_iv.PageBlock pageBlock = get(i10);
            g4Var.getClass();
            if (g4.I(pageBlock) == 5) {
                return true;
    ...
    public final TL_iv.PageBlock get(int i10) {
        return (TL_iv.PageBlock) this.f36043b.get(i10);
    }
    ...
    public final void h(TL_iv.PageBlock pageBlock) {
        i4 i4Var = this.f36044c;
        int childCount = i4Var.f34408u0[0].f35461b.getChildCount();
        for (int i10 = 0; i10 < childCount; i10++) {
            View childAt = i4Var.f34408u0[0].f35461b.getChildAt(i10);
            if (childAt instanceof q2) {
                q2 q2Var = (q2) childAt;
                int indexOf = q2Var.d.items.indexOf(pageBlock);
                if (indexOf != -1) {
                    q2Var.f36727a.x(indexOf, false);
                    return;
                }
            }
        }
