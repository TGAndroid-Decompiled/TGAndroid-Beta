...
public final class o3 implements qu0 {
    public final TLRPC.WebPage f35670a;
    public final List f35671b;
    public final i4 f35672c;

    public o3(i4 i4Var, TLRPC.WebPage webPage, List list) {
        this.f35672c = i4Var;
        this.f35670a = webPage;
        this.f35671b = list;
    }

    @Override
    public final boolean a(int i10) {
        if (i10 < this.f35671b.size() && i10 >= 0 && f4.g(this.f35670a, get(i10))) {
            return true;
        }
        return false;
    }
    ...
    public final boolean e(int i10) {
        if (i10 < this.f35671b.size() && i10 >= 0 && !f4.g(this.f35670a, get(i10))) {
            g4 g4Var = this.f35672c.f34021u0[0].f35131c;
            TL_iv.PageBlock pageBlock = get(i10);
            g4Var.getClass();
            if (g4.I(pageBlock) == 5) {
                return true;
    ...
    public final TL_iv.PageBlock get(int i10) {
        return (TL_iv.PageBlock) this.f35671b.get(i10);
    }
    ...
    public final void h(TL_iv.PageBlock pageBlock) {
        i4 i4Var = this.f35672c;
        int childCount = i4Var.f34021u0[0].f35130b.getChildCount();
        for (int i10 = 0; i10 < childCount; i10++) {
            View childAt = i4Var.f34021u0[0].f35130b.getChildAt(i10);
            if (childAt instanceof q2) {
                q2 q2Var = (q2) childAt;
                int indexOf = q2Var.d.items.indexOf(pageBlock);
                if (indexOf != -1) {
                    q2Var.f36243a.x(indexOf, false);
                    return;
                }
            }
        }
