...
public final class bb0 {
    ...
    public static final bb0[] f35407n;
    ...
    static {
        ...
        h = bb0Var;
        f35407n = new bb0[]{bb0Var, new bb0("VINTAGE", 1, "VintageIcon", R.drawable.icon_6_background_sa, R.mipmap.icon_6_foreground_sa, R.string.AppIconVintage, false), new bb0("AQUA", 2, "AquaIcon", R.drawable.icon_4_background_sa, i11, R.string.AppIconAqua, false), new bb0("PREMIUM", 3, "PremiumIcon", R.drawable.icon_3_background_sa, R.mipmap.icon_3_foreground_sa, R.string.AppIconPremium, true), new bb0("TURBO", 4, "TurboIcon", R.drawable.icon_5_background_sa, R.mipmap.icon_5_foreground_sa, R.string.AppIconTurbo, true), new bb0("NOX", 5, "NoxIcon", R.mipmap.icon_2_background_sa, i11, R.string.AppIconNox, true)};
    }
    ...
    public static bb0[] values() {
        return (bb0[]) f35407n.clone();
    }

    public final ComponentName a(Context context) {
        if (this.f35412f == null) {
            String packageName = context.getPackageName();
            this.f35412f = new ComponentName(packageName, "org.telegram.messenger." + this.f35408a);
        }
        return this.f35412f;
    }
}
