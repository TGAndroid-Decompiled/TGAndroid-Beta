...
public final class dc1 extends org.telegram.ui.Cells.qa {
    ...
    public final void A1() {
        ...
        switch (this.j3) {
            case 0:
                ((gc1) this.f32998k3).e.A0(false);
                return;
            default:
                runnable = ((org.telegram.ui.ActionBar.a3) this.f32998k3).f18440a.dismissRunnable;
                runnable.run();
                return;
        }
    }
    ...
    public void z1(org.telegram.ui.ActionBar.h6 h6Var) {
        ...
        switch (this.j3) {
            case 0:
                gc1 gc1Var = ((gc1) this.f32998k3).e.f31546a;
                ThemeActivity themeActivity = gc1Var.e;
                if (themeActivity.getParentActivity() != null) {
                    if ((h6Var.F == null || h6Var.U) && themeActivity.f31554f != 1) {
