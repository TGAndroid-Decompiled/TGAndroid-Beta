...
public final class dc1 extends org.telegram.ui.Cells.pa {
    ...
    public void y1(org.telegram.ui.ActionBar.i6 i6Var) {
        ...
        switch (this.j3) {
            case 0:
                gc1 gc1Var = ((gc1) this.f35789k3).f36654e.f34202a;
                ThemeActivity themeActivity = gc1Var.f36654e;
                if (themeActivity.getParentActivity() != null) {
                    if ((i6Var.F == null || i6Var.U) && themeActivity.f34211f != 1) {
    ...
    public final void z1() {
        ...
        switch (this.j3) {
            case 0:
                ((gc1) this.f35789k3).f36654e.A0(false);
                return;
            default:
                runnable = ((org.telegram.ui.ActionBar.a3) this.f35789k3).f20232a.dismissRunnable;
                runnable.run();
                return;
        }
    }
