...
public final class dc1 extends org.telegram.ui.Cells.pa {
    ...
    public void y1(org.telegram.ui.ActionBar.i6 i6Var) {
        ...
        switch (this.j3) {
            case 0:
                gc1 gc1Var = ((gc1) this.f35762k3).f36627e.f34175a;
                ThemeActivity themeActivity = gc1Var.f36627e;
                if (themeActivity.getParentActivity() != null) {
                    if ((i6Var.F == null || i6Var.U) && themeActivity.f34184f != 1) {
    ...
    public final void z1() {
        ...
        switch (this.j3) {
            case 0:
                ((gc1) this.f35762k3).f36627e.A0(false);
                return;
            default:
                runnable = ((org.telegram.ui.ActionBar.a3) this.f35762k3).f20205a.dismissRunnable;
                runnable.run();
                return;
        }
    }
