...
public final class dc1 extends LinearLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.f33093a) {
            case 12:
                ...
                return;
            case 18:
                xh.p1 p1Var = (xh.p1) this.f33094b;
                RectF rectF = p1Var.h;
                RectF rectF2 = p1Var.f46088f;
                RectF rectF3 = p1Var.e;
                Paint paint = p1Var.f46089n;
                paint.setColor(org.telegram.ui.ActionBar.j6.l1(0.1f, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18844c6, false)));
                float d = p1Var.f46087c.d(p1Var.f46086b, false);
                double d10 = d;
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        switch (this.f33093a) {
            case 1:
                if (!((di.i) this.f33094b).f7763e0) {
                    return false;
                }
                return super.dispatchTouchEvent(motionEvent);
            case 9:
                ScrollSlidingTextTabStrip scrollSlidingTextTabStrip = (ScrollSlidingTextTabStrip) this.f33094b;
                SparseIntArray sparseIntArray = scrollSlidingTextTabStrip.O;
                if (scrollSlidingTextTabStrip.f22178b != null && scrollSlidingTextTabStrip.f22193n0) {
                    if (motionEvent.getAction() == 0) {
                        ...
                        scrollSlidingTextTabStrip.f22181c0 = view;
                        if (view != null && getParent() != null) {
                            sparseIntArray.get(indexOfChild(scrollSlidingTextTabStrip.f22181c0));
                            scrollSlidingTextTabStrip.f22178b.getClass();
                            scrollSlidingTextTabStrip.f22181c0 = null;
                            return super.dispatchTouchEvent(motionEvent);
                        }
                    } else if (motionEvent.getAction() == 2) {
                        View view2 = scrollSlidingTextTabStrip.f22181c0;
                        if (view2 != null) {
                            view2.setTranslationX(motionEvent.getX() - 0.0f);
                            int indexOfChild = indexOfChild(scrollSlidingTextTabStrip.f22181c0);
                            if (scrollSlidingTextTabStrip.f22192n == indexOfChild) {
                            ...
                            float width = (scrollSlidingTextTabStrip.f22181c0.getWidth() / 2.0f) + scrollSlidingTextTabStrip.f22181c0.getX();
                            int width2 = scrollSlidingTextTabStrip.f22181c0.getWidth();
                            if (width < 0.0f) {
                                i10 = 0;
                            } else {
                                i10 = 0;
                            ...
                            if (i10 != indexOfChild) {
                                org.telegram.ui.Components.mm0 mm0Var = scrollSlidingTextTabStrip.f22178b;
                                sparseIntArray.get(i10);
                                mm0Var.getClass();
                            }
                        }
                    } else if (motionEvent.getAction() == 1) {
                        View view3 = scrollSlidingTextTabStrip.f22181c0;
                        if (view3 != null) {
                            view3.animate().translationX(0.0f).translationY(0.0f).setDuration(320L).setUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                                ...
                                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                                    switch (r2) {
                                        case 0:
                                            dc1 dc1Var = this.f25655b;
                                            dc1Var.invalidate();
                                            ((ScrollSlidingTextTabStrip) dc1Var.f33094b).invalidate();
                                            return;
                                        default:
                                            dc1 dc1Var2 = this.f25655b;
                                            dc1Var2.invalidate();
                                            ((ScrollSlidingTextTabStrip) dc1Var2.f33094b).invalidate();
                                            return;
                                    }
                                }
                        ...
                        View view4 = scrollSlidingTextTabStrip.f22181c0;
                        if (view4 != null) {
                    ...
                    if (scrollSlidingTextTabStrip.f22181c0 != null || super.dispatchTouchEvent(motionEvent)) {
                        return true;
                    }
                    return false;
                }
                return super.dispatchTouchEvent(motionEvent);
            case 19:
                if (!((yh.x3) this.f33094b).U.c(0)) {
                    return false;
                }
                return super.dispatchTouchEvent(motionEvent);
            case 20:
                if (!((yh.y7) this.f33094b).f48062f0) {
                    return false;
                }
                return super.dispatchTouchEvent(motionEvent);
            default:
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        switch (this.f33093a) {
            case 5:
                if (view == ((org.telegram.ui.Components.c9) this.f33094b).f22963a) {
                    return true;
                }
                return super.drawChild(canvas, view, j3);
            case 8:
                org.telegram.ui.Components.jm0 jm0Var = (org.telegram.ui.Components.jm0) this.f33094b;
                if (view instanceof org.telegram.ui.Components.ex0) {
                    ((org.telegram.ui.Components.ex0) view).a(jm0Var.f25339i0);
                }
                if (view == jm0Var.f25350s) {
                    return true;
                }
                return super.drawChild(canvas, view, j3);
            case 13:
                boolean drawChild = super.drawChild(canvas, view, j3);
                n70 n70Var = (n70) this.f33094b;
                if (view == n70Var.f35957b && n70Var.f35964x != null) {
                    int measuredHeight = n70Var.f35962s.getMeasuredHeight();
                    n70Var.f35964x.setBounds(0, measuredHeight, getMeasuredWidth(), n70Var.f35964x.getIntrinsicHeight() + measuredHeight);
                    n70Var.f35964x.draw(canvas);
                }
                return drawChild;
            case 17:
                rg.k1 k1Var = ((rg.j1) this.f33094b).f42357c;
                if (view == k1Var.f42382r0 && k1Var.H0) {
                    return true;
                }
                return super.drawChild(canvas, view, j3);
            default:
    ...
    public void invalidate() {
        switch (this.f33093a) {
            case 0:
                ...
                int i10 = 0;
                while (true) {
                    org.telegram.ui.Cells.y0[] y0VarArr = (org.telegram.ui.Cells.y0[]) this.f33094b;
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        switch (this.f33093a) {
            case 16:
                ...
                accessibilityNodeInfo.setVisibleToUser(((ti1) this.f33094b).B0);
                return;
            default:
                super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
                return;
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        switch (this.f33093a) {
            case 4:
                return org.telegram.ui.ActionBar.w4.b((org.telegram.ui.ActionBar.w4) this.f33094b);
            default:
        ...
        switch (this.f33093a) {
            case 6:
                ...
                for (int i15 = 0; i15 < getChildCount(); i15++) {
                    ...
                    if (childAt != ((org.telegram.ui.Components.aw) this.f33094b).f22494s.F && childAt != null) {
                ...
                return;
            case 7:
                ((org.telegram.ui.Components.b20) this.f33094b).f22540c.a(getMeasuredWidth());
            ...
            case 9:
                ...
                if (scrollSlidingTextTabStrip.f22191l0 && sparseIntArray.indexOfKey(scrollSlidingTextTabStrip.f22194r) >= 0 && scrollSlidingTextTabStrip.f22176a.getChildAt(sparseIntArray.get(scrollSlidingTextTabStrip.f22194r)) != null) {
                    scrollSlidingTextTabStrip.i(sparseIntArray.get(scrollSlidingTextTabStrip.f22194r), false);
                    scrollSlidingTextTabStrip.f22191l0 = false;
                    return;
                }
                return;
        }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.f33093a) {
            ...
            case 2:
                ...
                ii.d2 d2Var = (ii.d2) this.f33094b;
            ...
            case 3:
                ...
                ii.b4 b4Var = (ii.b4) this.f33094b;
                ...
                return;
            case 4:
                org.telegram.ui.ActionBar.w4 w4Var = (org.telegram.ui.ActionBar.w4) this.f33094b;
                ...
                return;
            case 6:
                super.onMeasure(Math.max(View.MeasureSpec.getSize(i10), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(((org.telegram.ui.Components.aw) this.f33094b).f26502b.getChildCount() * 32), 1073741824)), i11);
                return;
            case 11:
                super.onMeasure(i10, i11);
                if (LocaleController.isRTL) {
                    ((org.telegram.ui.Components.u31) this.f33094b).f28268c.setPivotX(getMeasuredWidth());
                    return;
                }
                return;
            case 14:
                ...
                if (i14 != 0) {
                    ...
                    if (((PhotoViewer) this.f33094b).f30995j1.getVisibility() == 0) {
                        if (((PhotoViewer) this.f33094b).X7 < 2) {
                            i12 = 48;
                        } else {
                            i12 = 64;
                        }
                        int max = Math.max(0, (min - AndroidUtilities.dp(i12)) / 2);
                        ((PhotoViewer) this.f33094b).f30995j1.setPadding(max, 0, max, 0);
                    }
            ...
            case 15:
                super.onMeasure(i10, i11);
                ih1 ih1Var = (ih1) this.f33094b;
                ViewGroup.MarginLayoutParams marginLayoutParams7 = (ViewGroup.MarginLayoutParams) ih1Var.f34575c.getLayoutParams();
                int i17 = 0;
                if (ih1Var.f34571a.getVisibility() == 8) {
    ...
    public void setAlpha(float f7) {
        switch (this.f33093a) {
            case 9:
                super.setAlpha(f7);
                ((ScrollSlidingTextTabStrip) this.f33094b).invalidate();
                return;
            default:
                super.setAlpha(f7);
                return;
    ...
    public void setVisibility(int i10) {
        switch (this.f33093a) {
            case 10:
                org.telegram.ui.Components.zw0 zw0Var = (org.telegram.ui.Components.zw0) this.f33094b;
                org.telegram.ui.Components.u9 u9Var = zw0Var.f30673b;
