...
public final class i81 implements RequestDelegate {
    public final int f34513a;
    public final SessionsActivity f34514b;

    public i81(SessionsActivity sessionsActivity, int i10) {
        this.f34513a = i10;
        this.f34514b = sessionsActivity;
    }
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f34513a) {
            case 0:
                AndroidUtilities.runOnUIThread(new g01(this.f34514b, 17));
                return;
            case 1:
                final SessionsActivity sessionsActivity = this.f34514b;
                ...
                return;
            case 2:
                final SessionsActivity sessionsActivity2 = this.f34514b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        org.telegram.ui.Components.vc a02;
                ...
                return;
            default:
                final SessionsActivity sessionsActivity3 = this.f34514b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        org.telegram.ui.Components.vc a02;
