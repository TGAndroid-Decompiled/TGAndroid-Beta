...
public final class i81 implements RequestDelegate {
    ...
    public final SessionsActivity f34509b;

    public i81(SessionsActivity sessionsActivity, int i10) {
        this.f34508a = i10;
        this.f34509b = sessionsActivity;
    }
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f34508a) {
            case 0:
                AndroidUtilities.runOnUIThread(new g01(this.f34509b, 17));
                return;
            case 1:
                final SessionsActivity sessionsActivity = this.f34509b;
                ...
                return;
            case 2:
                final SessionsActivity sessionsActivity2 = this.f34509b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        org.telegram.ui.Components.vc a02;
                ...
                return;
            default:
                final SessionsActivity sessionsActivity3 = this.f34509b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        org.telegram.ui.Components.vc a02;
