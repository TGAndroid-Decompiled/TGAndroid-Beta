...
public final class i81 extends org.telegram.ui.Components.ll0 {
        ...
        if (b10 != i10) {
            if (b10 < sessionsActivity.K || b10 >= sessionsActivity.L) {
                if (b10 < sessionsActivity.M || b10 >= sessionsActivity.N) {
                    if ((b10 < sessionsActivity.G || b10 >= sessionsActivity.H) && b10 != sessionsActivity.f31476y) {
    ...
    public final long i(int i10) {
        ...
        } else if (i10 == sessionsActivity.f31475x) {
        ...
        } else if (i10 == sessionsActivity.f31476y) {
            ...
            if (i10 >= i13 && i10 < sessionsActivity.L) {
                ...
                if (i10 >= i14 && i10 < sessionsActivity.N) {
                    ...
                    if (i10 >= i15 && i10 < sessionsActivity.H) {
                        TLObject tLObject2 = (TLObject) sessionsActivity.f31470f.get(i10 - i15);
    ...
    public final int j(int i10) {
        ...
        if (i10 != i11) {
            if (i10 != sessionsActivity.E && i10 != sessionsActivity.O && i10 != sessionsActivity.I && i10 != sessionsActivity.R && i10 != sessionsActivity.U && i10 != sessionsActivity.P) {
                if (i10 != sessionsActivity.f31475x && i10 != sessionsActivity.J && i10 != sessionsActivity.F && i10 != sessionsActivity.T) {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i13 != 0) {
            if (i13 != 1) {
                if (i13 != 2) {
                    if (i13 != 5) {
                        if (i13 != 6) {
                            org.telegram.ui.Cells.u6 u6Var = (org.telegram.ui.Cells.u6) c1Var.f42627a;
                            SessionsActivity sessionsActivity = this.d;
                            if (i10 == sessionsActivity.f31476y) {
                                TLRPC.TL_authorization tL_authorization = sessionsActivity.f31471n;
                                if (tL_authorization == null) {
                                    u6Var.f21416w = sessionsActivity.d;
                                    u6Var.f21415s = true;
                                    ...
                                    org.telegram.ui.Components.w9 w9Var = u6Var.f21412f;
                                    if (w9Var != null) {
                                ...
                                u6Var.c(tL_authorization, (sessionsActivity.e.isEmpty() && this.d.f31470f.isEmpty() && this.d.Q == -1) ? true : true);
                                return;
                            }
                            ...
                            if (i10 >= i17 && i10 < sessionsActivity.H) {
                                TLObject tLObject2 = (TLObject) sessionsActivity.f31470f.get(i10 - i17);
                                if (i10 != this.d.H - 1) {
                                    z10 = true;
                                }
                        ...
                        faVar.c(LocaleController.getString(R.string.IfInactiveFor), formatPluralString, true, false);
                        return;
                    }
                    return;
                }
                org.telegram.ui.Cells.m4 m4Var = (org.telegram.ui.Cells.m4) c1Var.f42627a;
                SessionsActivity sessionsActivity3 = this.d;
                if (i10 == sessionsActivity3.f31475x) {
                    m4Var.setText(LocaleController.getString(R.string.CurrentSession));
                    return;
                } else if (i10 == sessionsActivity3.J) {
                    if (sessionsActivity3.f31474w == 0) {
            ...
            org.telegram.ui.Cells.f9 f9Var = (org.telegram.ui.Cells.f9) c1Var.f42627a;
            f9Var.setFixedSize(0);
            SessionsActivity sessionsActivity4 = this.d;
            if (i10 == sessionsActivity4.E) {
                if (sessionsActivity4.f31474w == 0) {
        ...
        org.telegram.ui.Cells.s8 s8Var = (org.telegram.ui.Cells.s8) c1Var.f42627a;
        i11 = this.d.terminateAllSessionsRow;
        if (i10 == i11) {
            int i19 = org.telegram.ui.ActionBar.h6.f19008p7;
            s8Var.e(i19, i19);
    ...
    public final s4.c1 x(android.view.ViewGroup r26, int r27) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.i81.x(android.view.ViewGroup, int):s4.c1");
    }
}
