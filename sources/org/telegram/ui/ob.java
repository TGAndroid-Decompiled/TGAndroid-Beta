...
public final class ob extends f2.o0 {
    public final Context f36862c;
    public int d;
    public int e;
    public int f36863f;
    public int h;
    public final sb f36864n;
    ...
    public final void D(boolean z4) {
        this.d = 0;
        sb sbVar = this.f36864n;
        ArrayList arrayList = sbVar.f38269p0;
    ...
    public final long i(int i10) {
        if (i10 >= this.f36863f && i10 < this.h) {
            ArrayList arrayList = this.f36864n.f38269p0;
            return ((MessageObject) arrayList.get((arrayList.size() - (i10 - this.f36863f)) - 1)).stableId;
        } else if (i10 == this.e) {
            return 2L;
        } else {
            return 5L;
    ...
    public final int j(int i10) {
        if (i10 >= this.f36863f && i10 < this.h) {
            ArrayList arrayList = this.f36864n.f38269p0;
            return ((MessageObject) arrayList.get((arrayList.size() - (i10 - this.f36863f)) - 1)).contentType;
        }
        return 4;
    }
    ...
    public final void v(f2.l1 r21, int r22) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.ob.v(f2.l1, int):void");
    }
