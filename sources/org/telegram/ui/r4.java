...
public abstract class r4 extends View implements org.telegram.ui.Components.kh0 {
    ...
    public int S;
    public String T;
    public final RectF f36681a;
    public int f36682b;
    public final Rect f36683c;
    public final Rect d;
    public final RectF e;
    public final GradientDrawable f36684f;
    public final GradientDrawable h;
    public final float[] f36685n;
    public final Paint f36686r;
    public final Paint f36687s;
    public final Paint v;
    public final Path f36688w;
    public final RectF f36689x;
    public final GradientDrawable[] f36690y;

    public r4(Context context) {
        super(context);
        GradientDrawable.Orientation orientation;
        this.f36681a = new RectF();
        this.f36682b = 1;
        this.f36683c = new Rect();
        this.d = new Rect();
        this.e = new RectF();
        this.f36685n = new float[]{0.0f, 1.0f};
        this.f36688w = new Path();
        this.f36689x = new RectF();
        this.f36690y = new GradientDrawable[2];
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            ...
            this.f36690y[i10] = new GradientDrawable(orientation, new int[]{838860800, 0});
            this.f36690y[i10].setShape(0);
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        Path path = this.f36688w;
        path.reset();
        RectF rectF = this.f36689x;
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        this.f36684f.setBounds(0, rect.bottom, i10, AndroidUtilities.dp(16.0f) + currentActionBarHeight);
        this.h.setBounds(0, (i11 - AndroidUtilities.dp(72.0f)) - AndroidUtilities.dp(24.0f), i10, rect2.top);
        GradientDrawable[] gradientDrawableArr = this.f36690y;
        int i14 = i10 / 5;
