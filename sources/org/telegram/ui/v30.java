...
public final class v30 extends org.telegram.ui.Components.voip.m0 {
    ...
    public final void i(boolean z10) {
        ...
        int i10 = 0;
        if (d60.G3) {
            if (!z10 && v30Var.f29378b) {
                d60Var.f32991o2.H(d60Var.f32987n2, false, true);
                return;
            }
            return;
        }
        if (z10) {
            ...
            if (r30Var.getVisibility() == 0) {
                for (int i11 = 0; i11 < r30Var.getChildCount(); i11++) {
                    ...
                    ((org.telegram.ui.Components.t20) childAt).setProgressToFullscreen(v30Var.f29380c);
                }
            }
        }
        View view = d60Var.K2;
