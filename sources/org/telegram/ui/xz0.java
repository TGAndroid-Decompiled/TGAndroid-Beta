...
public final class xz0 extends qq {
    public final boolean[] f42919d1;
    public final TLRPC.User f42920e1;
    public final ProfileActivity f42921f1;
    ...
    public final void onTransitionAnimationEnd(boolean z10, boolean z11) {
        if (!z10 && z11 && this.f42919d1[0]) {
            ProfileActivity profileActivity = this.f42921f1;
            if (org.telegram.ui.Components.yc.a(profileActivity)) {
                org.telegram.ui.Components.yc.C(profileActivity, this.f42920e1.first_name).j();
            }
        }
    }
}
