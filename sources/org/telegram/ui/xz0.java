...
public final class xz0 implements kq {
    ...
    public final TLRPC.ChatParticipant f39647b;
    ...
    public final void b(int i10, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights, String str) {
        ...
        int i11 = 0;
        TLRPC.ChatParticipant chatParticipant = this.f39647b;
        ProfileActivity profileActivity = this.e;
        ...
        if (i12 == 0) {
            if (chatParticipant instanceof TLRPC.TL_chatChannelParticipant) {
                ...
                int indexOf = profileActivity.f31624u2.participants.participants.indexOf(chatParticipant);
                if (indexOf >= 0) {
                    profileActivity.f31624u2.participants.participants.set(indexOf, tL_chatParticipant);
                }
            }
            if (i10 == 1 && !this.f39648c) {
                this.d[0] = true;
            }
        } else if (i12 == 1 && i10 == 0 && profileActivity.E2.megagroup && (chatFull = profileActivity.f31624u2) != null && chatFull.participants != null) {
            int i13 = 0;
            while (true) {
                if (i13 < profileActivity.f31624u2.participants.participants.size()) {
                    if (MessageObject.getPeerId(((TLRPC.TL_chatChannelParticipant) profileActivity.f31624u2.participants.participants.get(i13)).channelParticipant.peer) == chatParticipant.user_id) {
            ...
            TLRPC.ChatFull chatFull3 = profileActivity.f31624u2;
            if (chatFull3 != null && chatFull3.participants != null) {
                while (true) {
                    if (i11 >= profileActivity.f31624u2.participants.participants.size()) {
                        break;
                    } else if (profileActivity.f31624u2.participants.participants.get(i11).user_id == chatParticipant.user_id) {
