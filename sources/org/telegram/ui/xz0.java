...
public final class xz0 extends pq {
    public final boolean[] f39710d1;
    public final TLRPC.User f39711e1;
    public final ProfileActivity f39712f1;
    ...
    public final void onTransitionAnimationEnd(boolean z10, boolean z11) {
        if (!z10 && z11 && this.f39710d1[0]) {
            ProfileActivity profileActivity = this.f39712f1;
            if (org.telegram.ui.Components.vc.a(profileActivity)) {
                org.telegram.ui.Components.vc.C(profileActivity, this.f39711e1.first_name).j();
            }
        }
    }
}
