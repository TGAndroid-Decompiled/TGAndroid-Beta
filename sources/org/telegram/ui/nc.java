...
public final class nc extends org.telegram.ui.Components.rl0 {
    ...
    @Override
    public final int h() {
        return this.f36574c.O;
    }

    @Override
    public final int j(int i10) {
        bd bdVar = this.f36574c;
        if (i10 == bdVar.P) {
            return 0;
        }
        if (i10 == bdVar.T) {
        ...
        if (i10 != bdVar.R && i10 != bdVar.Z && i10 != bdVar.f32915c0 && i10 != bdVar.f32917e0 && i10 != bdVar.f32920g0) {
            if (i10 != bdVar.U && i10 != bdVar.f32913b0) {
                return 7;
            }
            return 5;
        }
    ...
    public final void v(f2.l1 l1Var, int i10) {
        ...
        if (i16 != 1) {
            if (i16 != 3) {
                if (i16 != 4) {
                    if (i16 != 5) {
                        ...
                        if (i10 == bdVar.R) {
                            ...
                            if (bdVar.f32912b < bdVar.J0()) {
                                ocVar.e(bdVar.J0());
                            } else {
                                ocVar.e(0);
                            }
                            ocVar.c(bdVar.f32938w, false, false);
                            return;
                        } else if (i10 == bdVar.f32915c0) {
                            i13 = ((org.telegram.ui.ActionBar.p2) bdVar).currentAccount;
                            ocVar.a(i13, bdVar.f32933s, false);
                            k5Var.l(LocaleController.getString(bdVar.G0()), false);
                            if (bdVar.f32912b < bdVar.F0()) {
                                ocVar.e(bdVar.F0());
                            } else {
                                ocVar.e(0);
                            }
                            ocVar.c(DialogObject.getEmojiStatusDocumentId(bdVar.f32940y), DialogObject.isEmojiStatusCollectible(bdVar.f32940y), false);
                            return;
                        } else if (i10 == bdVar.f32917e0) {
                            i12 = ((org.telegram.ui.ActionBar.p2) bdVar).currentAccount;
                            ocVar.a(i12, bdVar.f32933s, false);
                            k5Var.l(LocaleController.getString(bdVar.B0()), false);
                            if (bdVar.f32912b < bdVar.H0()) {
                                ocVar.e(bdVar.H0());
                            } else {
                                ocVar.e(0);
                            }
                ...
                ((ep0) view).a(bdVar.f32933s, false);
                return;
            }
            ((sc) view).a(bdVar.f32918f, false);
            return;
        }
        uc ucVar = (uc) view;
        po0 po0Var = ucVar.f38902a;
        tc tcVar = ucVar.f38903b;
        i11 = ((org.telegram.ui.ActionBar.p2) bdVar).currentAccount;
        po0Var.b(i11, bdVar.f32933s, false);
        tcVar.b(bdVar.f32933s, false);
        tcVar.d(bdVar.f32938w, false, false);
        tcVar.setForum(bdVar.R0());
        tcVar.e(DialogObject.getEmojiStatusDocumentId(bdVar.f32940y), false, false);
        tcVar.a(bdVar.f32918f);
    }
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
                ...
                public final void run(Object obj) {
                    switch (r2) {
                        case 0:
                            ...
                            bd bdVar2 = this.f36264b.f36574c;
                            if (str == null) {
                                bdVar2.C = bdVar2.D;
                            } else if (str.equals("❌")) {
                                bdVar2.C = null;
                                ...
                                tL_wallPaperNoFile.f19336id = 0L;
                            ...
                            return;
                        default:
                            bd bdVar3 = this.f36264b.f36574c;
                            bdVar3.f32933s = ((Integer) obj).intValue();
                            if (bdVar3.f32940y instanceof TLRPC.TL_emojiStatusCollectible) {
                                bdVar3.f32940y = null;
                            }
                            bdVar3.X0(true);
                            bdVar3.b1();
            ...
            frameLayout.f36871c = new org.telegram.ui.Components.j5(AndroidUtilities.dp(24.0f), 13, frameLayout, false);
            zcVar = frameLayout;
        } else if (i10 == 3) {
            ...
            scVar.f38292b.setOnItemClickListener(new gg.v0(6, this, scVar));
            zcVar = scVar;
        } else if (i10 == 4) {
            ...
            ep0Var.setOnColorClick(new Utilities.Callback(this) {
                public final nc f36264b;
    ...
    public final void y(f2.l1 l1Var) {
        ...
        bd bdVar = this.f36574c;
        if (z4) {
            tc tcVar = ((uc) view).f38903b;
            TLRPC.EmojiStatus emojiStatus = bdVar.f32940y;
            if (emojiStatus instanceof TLRPC.TL_emojiStatusCollectible) {
                tcVar.c(MessagesController.PeerColor.fromCollectible(emojiStatus), false);
                tcVar.d(((TLRPC.TL_emojiStatusCollectible) bdVar.f32940y).pattern_document_id, true, false);
            } else {
                tcVar.b(bdVar.f32933s, false);
                tcVar.d(bdVar.f32938w, false, false);
            }
            tcVar.e(DialogObject.getEmojiStatusDocumentId(bdVar.f32940y), DialogObject.isEmojiStatusCollectible(bdVar.f32940y), false);
            tcVar.setForum(bdVar.R0());
            tcVar.a(bdVar.f32918f);
