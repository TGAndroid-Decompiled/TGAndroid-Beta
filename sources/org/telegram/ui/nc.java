...
public final class nc extends org.telegram.ui.Components.kl0 {
    ...
    @Override
    public final int h() {
        return this.f35951c.R;
    }

    @Override
    public final int j(int i10) {
        ad adVar = this.f35951c;
        if (i10 == adVar.S) {
            return 0;
        }
        if (i10 == adVar.W) {
        ...
        if (i10 == adVar.f31738b0) {
            return 4;
        }
        if (i10 != adVar.U && i10 != adVar.f31740c0 && i10 != adVar.f31744f0 && i10 != adVar.f31746h0 && i10 != adVar.f31748j0) {
            if (i10 != adVar.X && i10 != adVar.f31742e0) {
                return 7;
            }
            return 5;
        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i16 != 1) {
            if (i16 != 3) {
                if (i16 != 4) {
                    if (i16 != 5) {
                        ...
                        if (i10 == adVar.U) {
                            ...
                            if (adVar.f31737b < adVar.J0()) {
                                ocVar.e(adVar.J0());
                            } else {
                                ocVar.e(0);
                            }
                            ocVar.c(adVar.f31763w, false, false);
                            return;
                        } else if (i10 == adVar.f31744f0) {
                            i13 = ((org.telegram.ui.ActionBar.n2) adVar).currentAccount;
                            ocVar.a(i13, adVar.f31758s, false);
                            j5Var.l(LocaleController.getString(adVar.G0()), false);
                            if (adVar.f31737b < adVar.F0()) {
                                ocVar.e(adVar.F0());
                            } else {
                                ocVar.e(0);
                            }
                            ocVar.c(DialogObject.getEmojiStatusDocumentId(adVar.f31767y), DialogObject.isEmojiStatusCollectible(adVar.f31767y), false);
                            return;
                        } else if (i10 == adVar.f31746h0) {
                            i12 = ((org.telegram.ui.ActionBar.n2) adVar).currentAccount;
                            ocVar.a(i12, adVar.f31758s, false);
                            j5Var.l(LocaleController.getString(adVar.B0()), false);
                            if (adVar.f31737b < adVar.H0()) {
                                ocVar.e(adVar.H0());
                            } else {
                                ocVar.e(0);
                            }
                ...
                ((xp0) view).a(adVar.f31758s, false);
                return;
            }
            ((rc) view).a(adVar.f31743f, false);
            return;
        }
        tc tcVar = (tc) view;
        gp0 gp0Var = tcVar.f37630a;
        sc scVar = tcVar.f37631b;
        i11 = ((org.telegram.ui.ActionBar.n2) adVar).currentAccount;
        gp0Var.b(i11, adVar.f31758s, false);
        scVar.b(adVar.f31758s, false);
        scVar.d(adVar.f31763w, false, false);
        scVar.setForum(adVar.R0());
        scVar.e(DialogObject.getEmojiStatusDocumentId(adVar.f31767y), false, false);
        scVar.a(adVar.f31743f);
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
                ...
                public final void run(Object obj) {
                    switch (r2) {
                        case 0:
                            ...
                            ad adVar2 = this.f35691b.f35951c;
                            if (str == null) {
                                adVar2.F = adVar2.G;
                            } else if (str.equals("❌")) {
                                adVar2.F = null;
                                ...
                                tL_wallPaperNoFile.f18261id = 0L;
                            ...
                            return;
                        default:
                            ad adVar3 = this.f35691b.f35951c;
                            adVar3.f31758s = ((Integer) obj).intValue();
                            if (adVar3.f31767y instanceof TLRPC.TL_emojiStatusCollectible) {
                                adVar3.f31767y = null;
                            }
                            adVar3.X0(true);
                            adVar3.b1();
            ...
            frameLayout.f36190c = new org.telegram.ui.Components.m5(AndroidUtilities.dp(24.0f), 13, frameLayout, false);
            ycVar = frameLayout;
        } else if (i10 == 3) {
            ...
            rcVar.f37100b.setOnItemClickListener(new ai.o6(5, this, rcVar));
            ycVar = rcVar;
        } else if (i10 == 4) {
            ...
            ycVar = new org.telegram.ui.Cells.m4(parentActivity6, e6Var3);
        } else if (i10 == 9) {
    ...
    public final void y(s4.c1 c1Var) {
        ...
        ad adVar = this.f35951c;
        if (z10) {
            sc scVar = ((tc) view).f37631b;
            TLRPC.EmojiStatus emojiStatus = adVar.f31767y;
            if (emojiStatus instanceof TLRPC.TL_emojiStatusCollectible) {
                scVar.c(MessagesController.PeerColor.fromCollectible(emojiStatus), false);
                scVar.d(((TLRPC.TL_emojiStatusCollectible) adVar.f31767y).pattern_document_id, true, false);
            } else {
                scVar.b(adVar.f31758s, false);
                scVar.d(adVar.f31763w, false, false);
            }
            scVar.e(DialogObject.getEmojiStatusDocumentId(adVar.f31767y), DialogObject.isEmojiStatusCollectible(adVar.f31767y), false);
            scVar.setForum(adVar.R0());
            scVar.a(adVar.f31743f);
