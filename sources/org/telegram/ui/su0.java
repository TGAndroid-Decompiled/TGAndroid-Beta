...
public final class su0 extends vh.o {
    ...
    public boolean W;
    public org.telegram.ui.Components.g90 f37552a0;
    public Layout f37553b0;
    public Path f37554c0;
    ...
    public su0(Context context, qu0 qu0Var, org.telegram.ui.Cells.aa aaVar, final Utilities.Callback2 callback2, final Utilities.Callback3 callback3) {
        ...
        this.f44482x = new org.telegram.ui.Components.b90(this) {
            public final su0 f37307b;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.W) {
            ...
            Path path = this.f37554c0;
            if (path == null || this.f37553b0 != layout) {
                if (path == null) {
                    this.f37554c0 = new Path();
                } else {
                    path.rewind();
                }
                if (layout != null) {
                    ...
                    while (i11 < layout.getLineCount()) {
                        ...
                        this.f37554c0.addRect(getPaddingLeft() + lineLeft, getPaddingTop() + f10, getPaddingLeft() + lineRight, getPaddingTop() + f7, Path.Direction.CW);
                        i11++;
                        f10 = f7;
                    }
                }
                this.f37553b0 = layout;
            }
            if (this.f37552a0 == null) {
                org.telegram.ui.Components.g90 g90Var = new org.telegram.ui.Components.g90();
                this.f37552a0 = g90Var;
                g90Var.f24149x = this.f37554c0;
                g90Var.j(4.0f);
                this.f37552a0.f(org.telegram.ui.ActionBar.j6.l1(0.3f, -1), org.telegram.ui.ActionBar.j6.l1(0.1f, -1), org.telegram.ui.ActionBar.j6.l1(0.2f, -1), org.telegram.ui.ActionBar.j6.l1(0.7f, -1));
                this.f37552a0.setCallback(this);
            }
            this.f37552a0.setBounds(0, 0, getWidth(), getHeight());
            this.f37552a0.draw(canvas);
        }
        if (this.W) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (aaVar != null && aaVar.y()) {
            canvas.save();
            canvas.translate(getPaddingLeft(), getPaddingTop());
            if (aaVar != null && getStaticTextLayout() != null && aaVar.f19814u0 == this) {
                aaVar.X(canvas);
            }
            canvas.restore();
        }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f37552a0 && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
