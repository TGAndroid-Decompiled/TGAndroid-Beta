...
public final class su0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public final FrameLayout f37864a;
    public final ai.w5 f37865b;
    public final org.telegram.ui.ActionBar.h5[] f37866c;
    public final org.telegram.ui.Components.p6 d;
    public AnimatorSet e;
    public AnimatorSet f37867f;
    public boolean h;
    public ValueAnimator f37868n;
    public float f37869r;
    public int f37870s;
    ...
    public su0(Activity activity) {
        ...
        this.f37866c = new org.telegram.ui.ActionBar.h5[2];
        for (int i10 = 0; i10 < 2; i10++) {
            this.f37866c[i10] = new org.telegram.ui.ActionBar.h5(activity);
            this.f37866c[i10].setGravity(19);
            this.f37866c[i10].setTextColor(-1);
            this.f37866c[i10].setTextSize(20);
            this.f37866c[i10].setTypeface(AndroidUtilities.bold());
            this.f37866c[i10].setDrawablePadding(AndroidUtilities.dp(4.0f));
            this.f37866c[i10].setScrollNonFitText(true);
            this.f37865b.addView(this.f37866c[i10], w7.y5.e(-1, -2, 19));
        }
        ...
        this.f37864a.addView(p6Var, w7.y5.d(-1, 20.0f, 51, 16.0f, 0.0f, 0.0f, 0.0f));
    }
    ...
    public final void a(CharSequence charSequence, boolean z10) {
        ...
        if (z12 != z13) {
            this.h = z12;
            AnimatorSet animatorSet = this.f37867f;
            if (animatorSet != null) {
                animatorSet.cancel();
            }
            ...
            if (z10) {
                ...
                this.f37867f = animatorSet2;
                animatorSet2.playTogether(arrayList);
                this.f37867f.setInterpolator(org.telegram.ui.Components.sr.h);
                this.f37867f.start();
            } else {
                if (!isEmpty) {
                    f7 = 1.0f;
    ...
    public final void b(boolean z10) {
        int i10;
        int i11;
        org.telegram.ui.ActionBar.h5[] h5VarArr = this.f37866c;
        int i12 = 0;
    ...
    public final void d(CharSequence charSequence, boolean z10, boolean z11) {
        ...
        h5VarArr[1].setRightPadding((int) this.f37869r);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        this.f37864a.layout(0, AndroidUtilities.statusBarHeight, i12 - i10, i13 - i11);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f37864a.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(size2 - i12, 1073741824));
