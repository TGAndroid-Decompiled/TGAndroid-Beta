...
public final class u11 extends org.telegram.ui.Components.kl0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        ...
        w11 w11Var = this.d;
        if (b10 == w11Var.E) {
            return w11Var.f38746n;
        }
        if (c1Var.b() == w11Var.W) {
            return true;
        }
        switch (c1Var.f42678f) {
            case 0:
            case 2:
            case 5:
            case 6:
        ...
        if (i10 != w11Var.F && i10 != w11Var.G && i10 != w11Var.I && i10 != w11Var.H && i10 != w11Var.Q && i10 != w11Var.R && i10 != w11Var.W) {
            if (i10 != w11Var.N && i10 != w11Var.V && i10 != w11Var.J && i10 != w11Var.S) {
                ...
                if (i10 != w11Var.L && i10 != w11Var.M) {
                    if (i10 == w11Var.f38749w) {
                        return 5;
                    }
                    if (i10 != w11Var.f38750x && i10 != w11Var.X) {
                        if (i10 != w11Var.f38751y && i10 != w11Var.E && i10 != w11Var.O) {
                            return 0;
                        }
                        return 7;
                    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        int i17;
        w11 w11Var = this.d;
        long j3 = w11Var.f38745f;
        long j10 = w11Var.e;
        int i18 = c1Var.f42678f;
        ...
        switch (i18) {
            ...
            case 1:
                ...
                if (i10 == w11Var.W) {
                    ...
                    eaVar.setTextColor(w11Var.getThemedColor(org.telegram.ui.ActionBar.i6.f19074q7));
                    return;
                }
                eaVar.setTextColor(w11Var.getThemedColor(org.telegram.ui.ActionBar.i6.G6));
                if (i10 == w11Var.F) {
            ...
            case 3:
                ...
                while (true) {
                    if (i19 < 9) {
                        if (org.telegram.ui.Cells.y8.f21664f[i19] == i13) {
            ...
            case 6:
                ...
                if (a7Var.f19801c != z10 || a7Var.d != z11) {
                    a7Var.f19801c = z10;
                    a7Var.d = z11;
                    int i20 = a7Var.f19800b;
                    if (i20 == 0) {
            ...
            case 7:
                ...
                if (i10 == w11Var.f38751y) {
                    w8Var.f(LocaleController.getString(R.string.Notifications), w11Var.f38746n, true);
                    return;
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 0:
                ...
                l4Var.setBackgroundColor(w11Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18836d6));
                break;
            case 1:
                l4Var = new org.telegram.ui.Cells.ea(context, 0, e6Var);
                l4Var.setBackgroundColor(w11Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18836d6));
                break;
            case 2:
                l4Var = new org.telegram.ui.Cells.e9(context, e6Var);
                break;
            case 3:
                l4Var = new org.telegram.ui.Cells.y8(context, e6Var);
                l4Var.setBackgroundColor(w11Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18836d6));
                break;
            case 4:
                l4Var = new org.telegram.ui.Cells.j6(context, e6Var);
                l4Var.setBackgroundColor(w11Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18836d6));
                break;
            case 5:
                l4Var = new org.telegram.ui.Cells.za(context, e6Var);
                l4Var.setBackgroundColor(w11Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18836d6));
                break;
            case 6:
                ...
                break;
            default:
                l4Var = new org.telegram.ui.Cells.w8(context, e6Var);
                l4Var.setBackgroundColor(w11Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18836d6));
                break;
        }
            ...
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 != 3) {
                        ...
                        ((org.telegram.ui.Cells.j6) view).b(null, w11Var.f38746n);
                        return;
                    }
                    ((org.telegram.ui.Cells.y8) view).a(null, w11Var.f38746n);
                    return;
                }
                ((org.telegram.ui.Cells.e9) view).c(null, w11Var.f38746n);
                return;
            }
            org.telegram.ui.Cells.ea eaVar = (org.telegram.ui.Cells.ea) view;
            if (c1Var.b() == w11Var.W) {
                ...
                eaVar.a(null, w11Var.f38746n);
                return;
            }
        }
        ((org.telegram.ui.Cells.l4) view).a(null, w11Var.f38746n);
    }
}
