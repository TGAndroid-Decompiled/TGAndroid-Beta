...
public final class u11 implements TextWatcher {
    ...
    public final w11 f38821b;

    public u11(w11 w11Var, int i10) {
        this.f38820a = i10;
        this.f38821b = w11Var;
    }
    ...
    public final void afterTextChanged(Editable editable) {
        switch (this.f38820a) {
            case 0:
                ...
                return;
            case 1:
                w11 w11Var = this.f38821b;
                if (!w11Var.I) {
                    EditTextBoldCursor editTextBoldCursor = w11Var.f39299a[1];
