...
public abstract class e5 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean B;
    public final OvershootInterpolator f36396a;
    public final l0 f36397b;
    public final w4 f36398c;
    public final ActionBarPopupWindow$ActionBarPopupWindowLayout d;
    public final x4 f36399e;
    public final org.telegram.ui.ActionBar.g6 f36400f;
    public final tg.b h;
    public AnimatorSet f36401n;
    ...
    public e5(Context context, org.telegram.ui.ActionBar.g6 g6Var, x4 x4Var) {
        super(context);
        this.f36396a = new OvershootInterpolator(1.02f);
        tg.b bVar = new tg.b();
        this.h = bVar;
        new Matrix();
        this.f36399e = x4Var;
    ...
    public final void a(z4 z4Var) {
        ...
        boolean z10;
        boolean z11;
        this.f36403s = z4Var.f43812i;
        if (z4Var.f43808c != null) {
            z4 = true;
        } else {
            z4 = false;
        }
        w4 w4Var = this.f36398c;
        w4Var.f42373c = z4;
        w4Var.invalidate();
        this.f36405x = z4Var.f43810f;
        b5 b5Var = this.f36406y;
        if (b5Var != null) {
            if (b5Var.f35335g) {
                b5Var.f35335g = false;
        ...
        b5 b5Var2 = z4Var.f43813j;
        if (b5Var2 != null) {
            this.f36406y = b5Var2;
            hg.m0 m0Var = new hg.m0(4, this, z4Var);
            if (!b5Var2.f35335g) {
                b5Var2.f35335g = true;
                b5Var2.f35334f = m0Var;
                b5Var2.f35331b.addObserver(b5Var2.f35330a, b5Var2.f35333e);
                b5Var2.a();
            }
        }
        int i10 = UserConfig.selectedAccount;
        ImageLocation imageLocation = z4Var.f43808c;
        String str = z4Var.f43809e;
        ImageLocation imageLocation2 = z4Var.f43806a;
        ImageLocation imageLocation3 = z4Var.f43807b;
        String str2 = z4Var.d;
        BitmapDrawable bitmapDrawable = z4Var.f43811g;
        Object obj = z4Var.h;
        ...
        int i11 = 0;
        while (true) {
            f5[] f5VarArr = this.f36403s;
            if (i11 < f5VarArr.length) {
                f5 f5Var = f5VarArr[i11];
                String string = LocaleController.getString(f5Var.f36758a, f5Var.f36759b);
                if (i11 == 0) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                if (i11 == this.f36403s.length - 1) {
                    z11 = true;
                } else {
                    z11 = false;
                }
                ...
                org.telegram.ui.ActionBar.g1 c3 = org.telegram.ui.ActionBar.w0.c(z10, z11, actionBarPopupWindow$ActionBarPopupWindowLayout2, f5Var.f36760c, string, false, this.f36400f);
    ...
    public final void b(final boolean z4) {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                switch (r3) {
                    case 0:
                        ...
                        e5Var.f36398c.setTranslationY(AndroidUtilities.dp(40.0f) * f11);
        ...
        AnimatorSet animatorSet = this.f36401n;
        if (animatorSet != null) {
            animatorSet.cancel();
        }
        AnimatorSet animatorSet2 = new AnimatorSet();
        this.f36401n = animatorSet2;
        if (z4) {
            j10 = 190;
        } else {
            j10 = 150;
        ...
        this.f36401n.playTogether(ofFloat, ofFloat2);
        this.f36401n.addListener(new eg.u2(10, this, z4));
        this.f36401n.start();
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        w4 w4Var = this.f36398c;
        boolean z4 = w4Var.f42373c;
        RadialProgress2 radialProgress2 = (RadialProgress2) w4Var.f42374e;
        if (z4 && !TextUtils.isEmpty(this.f36405x)) {
            if (i10 == NotificationCenter.fileLoaded) {
                if (TextUtils.equals((String) objArr[0], this.f36405x)) {
                    radialProgress2.o(1.0f, true);
                }
            } else if (i10 == NotificationCenter.fileLoadProgressChanged && TextUtils.equals((String) objArr[0], this.f36405x)) {
