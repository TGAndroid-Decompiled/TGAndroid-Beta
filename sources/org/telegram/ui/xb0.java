...
public final class xb0 extends org.telegram.ui.ActionBar.n2 {
    ...
    public org.telegram.ui.Components.tv0 f39569c;
    public org.telegram.ui.Components.tv0 d;
    public TLRPC.TL_chatInviteExported e;
    public ub0 f39570f;
    public org.telegram.ui.Cells.e9 h;
    public org.telegram.ui.Cells.w8 f39571n;
    public vb0 f39572r;
    public TextView f39573s;
    public org.telegram.ui.Cells.e9 v;
    public TextView f39574w;
    public org.telegram.ui.Cells.l4 f39575x;
    public org.telegram.ui.Cells.e9 f39576y;
    ...
    public final void V(int i10) {
        int[] iArr;
        long j3 = i10;
        this.f39574w.setText(LocaleController.formatDateAudio(j3, false));
    ...
    public final void W(int i10) {
        ...
        this.f39569c.b(i13, null, strArr);
    }
    ...
    public final void X() {
        ...
        while (true) {
            ...
            if (i10 < iArr.length) {
                ...
                this.f39569c.b(3, null, "1", "10", "100", LocaleController.getString(R.string.NoLimit));
                return;
            }
        }
    }
    ...
    public final void Y(TLRPC.TL_chatInviteExported tL_chatInviteExported) {
        ...
        if (this.fragmentView != null && tL_chatInviteExported != null) {
            ...
            ub0 ub0Var = this.f39570f;
            if (ub0Var != null) {
                ub0Var.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18836d6, false));
                this.f39570f.setChecked(tL_chatInviteExported.request_needed);
            }
            boolean z10 = true;
            ...
            org.telegram.ui.Cells.w8 w8Var = this.f39571n;
            if (w8Var != null) {
            ...
            if (tL_chatInviteExported.subscription_pricing != null) {
                ub0 ub0Var2 = this.f39570f;
                if (ub0Var2 != null) {
                    ub0Var2.setChecked(false);
                    this.f39570f.setCheckBoxIcon(R.drawable.permission_locked);
                }
            ...
            if (vb0Var != null) {
                ...
                this.f39572r.setText(Long.toString(tL_chatInviteExported.subscription_pricing.amount));
                this.f39572r.f20229b.setClickable(false);
                this.f39572r.f20229b.setFocusable(false);
                this.f39572r.f20229b.setFocusableInTouchMode(false);
                this.f39572r.f20229b.setLongClickable(false);
            }
        }
    }
    ...
    public final void Z(boolean z10) {
        ...
        org.telegram.ui.Components.tv0 tv0Var = this.f39569c;
        if (z10) {
            i11 = 0;
        } else {
            i11 = 8;
    ...
    public final View createView(Context context) {
        ...
        this.f39574w.setGravity(16);
        this.f39574w.setTextSize(1, 16.0f);
        this.f39574w.setHint(LocaleController.getString(R.string.TimeLimitHint));
        this.f39574w.setOnClickListener(new sv(14, this, context));
        ...
        sb0Var.addView(this.f39574w, w7.x5.n(-1, 50));
        ...
        this.f39569c = tv0Var2;
        tv0Var2.setCallback(new nb0(this, 3));
        X();
        sb0Var.addView(this.f39569c);
        ...
        this.f39570f.setTag(Integer.valueOf(i13));
        this.f39570f.f(LocaleController.getString(R.string.ApproveNewMembers2), false, false);
        this.f39570f.setOnClickListener(new ai.j3(7, this, z10));
        sb0Var.addView(this.f39570f, w7.x5.n(-1, 56));
        ...
        if (chat == null || chat.username == null) {
            ...
            if ((this.e == null && ChatObject.isChannelAndNotMegaGroup(MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(j3))) && chatFull != null && chatFull.paid_media_allowed) || ((tL_chatInviteExported = this.e) != null && tL_chatInviteExported.subscription_pricing != null)) {
                ...
                this.f39571n = w8Var3;
                w8Var3.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, i13, false));
                this.f39571n.setDrawCheckRipple(true);
                this.f39571n.f(LocaleController.getString(R.string.RequireMonthlyFee), false, true);
                if (this.e != null) {
                    this.f39571n.setCheckBoxIcon(R.drawable.permission_locked);
                    this.f39571n.setEnabled(false);
                }
                this.f39571n.setOnClickListener(new sv(15, this, new Runnable[1]));
                sb0Var.addView(this.f39571n, w7.x5.n(-1, 48));
                TextView textView3 = new TextView(context);
                this.f39573s = textView3;
                textView3.setTextSize(1, 16.0f);
                this.f39573s.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.A6, false));
                ...
                this.f39572r = vb0Var;
                vb0Var.f20229b.setInputType(2);
                this.f39572r.f20229b.setRawInputType(2);
                this.f39572r.setBackgroundColor(getThemedColor(i13));
                vb0 vb0Var2 = this.f39572r;
                vb0Var2.getClass();
                org.telegram.ui.Cells.g gVar = new org.telegram.ui.Cells.g(vb0Var2, 4);
                org.telegram.ui.Cells.g3 g3Var = vb0Var2.f20229b;
                g3Var.setImeOptions(6);
                g3Var.setOnEditorActionListener(new m.s2(gVar, 2));
                this.f39572r.addView(this.f39573s, w7.x5.d(-2, -2.0f, 21, 0.0f, 0.0f, 19.0f, 0.0f));
                vb0 vb0Var3 = this.f39572r;
                ...
                org.telegram.ui.Cells.g3 g3Var2 = vb0Var3.f20229b;
                ...
                sb0Var.addView(this.f39572r, w7.x5.n(-1, 48));
                this.f39572r.setVisibility(8);
        ...
        tb0Var3.setHintTextColor(org.telegram.ui.ActionBar.i6.w0(null, i14, false));
        this.K.setLines(1);
        this.K.setPadding(AndroidUtilities.dp(22.0f), 0, AndroidUtilities.dp(22.0f), 0);
        this.K.setSingleLine();
        tb0 tb0Var4 = this.K;
        int i15 = org.telegram.ui.ActionBar.i6.G6;
        tb0Var4.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, i15, false));
        ...
        if (i11 == 1) {
            ...
            this.I.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19056p7, false));
        ...
        this.H = frameLayout;
        int i16 = org.telegram.ui.ActionBar.i6.f18780a7;
        ...
        this.f39575x.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, i13, false));
        this.d.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, i13, false));
        this.f39574w.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, i13, false));
        this.E.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, i13, false));
        this.f39569c.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, i13, false));
        ...
        w8Var.setBackgroundColor(org.telegram.ui.ActionBar.i6.w0(null, i16, false));
        ...
        this.f39574w.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, i15, false));
        this.f39574w.setHintTextColor(org.telegram.ui.ActionBar.i6.w0(null, i14, false));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f39575x, 0, new Class[]{org.telegram.ui.Cells.l4.class}, new String[]{"textView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.E, 0, new Class[]{org.telegram.ui.Cells.l4.class}, new String[]{"textView"}, null, null, -1, null, i10));
        org.telegram.ui.Cells.l4 l4Var = this.f39575x;
        int i11 = org.telegram.ui.ActionBar.i6.f18836d6;
        arrayList.add(new org.telegram.ui.ActionBar.k6(l4Var, 1, null, null, null, null, i11));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f39569c, 1, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f39574w, 1, null, null, null, null, i11));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f39576y, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, i12));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(null, 0, null, null, null, eVar, org.telegram.ui.ActionBar.i6.f19218y6));
        arrayList.add(new org.telegram.ui.ActionBar.k6(null, 0, null, null, null, eVar, org.telegram.ui.ActionBar.i6.Sh));
        arrayList.add(new org.telegram.ui.ActionBar.k6(null, 0, null, null, null, eVar, org.telegram.ui.ActionBar.i6.f19056p7));
        return arrayList;
    }
}
