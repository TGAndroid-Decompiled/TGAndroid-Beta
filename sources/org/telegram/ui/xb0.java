...
public final class xb0 extends org.telegram.ui.ActionBar.n2 {
    ...
    public org.telegram.ui.Components.sv0 f42674c;
    public org.telegram.ui.Components.sv0 d;
    public TLRPC.TL_chatInviteExported f42675e;
    public ub0 f42676f;
    public org.telegram.ui.Cells.e9 h;
    public org.telegram.ui.Cells.w8 f42677n;
    public vb0 f42678r;
    public TextView f42679s;
    public org.telegram.ui.Cells.e9 v;
    public TextView f42680w;
    public org.telegram.ui.Cells.l4 f42681x;
    public org.telegram.ui.Cells.e9 f42682y;
    ...
    public final void V(int i10) {
        int[] iArr;
        long j3 = i10;
        this.f42680w.setText(LocaleController.formatDateAudio(j3, false));
    ...
    public final void W(int i10) {
        ...
        this.f42674c.b(i13, null, strArr);
    }
    ...
    public final void X() {
        ...
        while (true) {
            ...
            if (i10 < iArr.length) {
                ...
                this.f42674c.b(3, null, "1", "10", "100", LocaleController.getString(R.string.NoLimit));
                return;
            }
        }
    }
    ...
    public final void Y(TLRPC.TL_chatInviteExported tL_chatInviteExported) {
        int i10;
        this.f42675e = tL_chatInviteExported;
        if (this.fragmentView != null && tL_chatInviteExported != null) {
            ...
            ub0 ub0Var = this.f42676f;
            if (ub0Var != null) {
                ub0Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20664d6, false));
                this.f42676f.setChecked(tL_chatInviteExported.request_needed);
            }
            boolean z10 = true;
            ...
            org.telegram.ui.Cells.w8 w8Var = this.f42677n;
            if (w8Var != null) {
            ...
            if (tL_chatInviteExported.subscription_pricing != null) {
                ub0 ub0Var2 = this.f42676f;
                if (ub0Var2 != null) {
                    ub0Var2.setChecked(false);
                    this.f42676f.setCheckBoxIcon(R.drawable.permission_locked);
                }
            ...
            if (vb0Var != null) {
                ...
                this.f42678r.setText(Long.toString(tL_chatInviteExported.subscription_pricing.amount));
                this.f42678r.f22075b.setClickable(false);
                this.f42678r.f22075b.setFocusable(false);
                this.f42678r.f22075b.setFocusableInTouchMode(false);
                this.f42678r.f22075b.setLongClickable(false);
            }
        }
    }
    ...
    public final void Z(boolean z10) {
        ...
        org.telegram.ui.Components.sv0 sv0Var = this.f42674c;
        if (z10) {
            i11 = 0;
        } else {
            i11 = 8;
    ...
    public final View createView(Context context) {
        ...
        sb0Var.addView(this.f42681x);
        org.telegram.ui.Components.sv0 sv0Var = new org.telegram.ui.Components.sv0(context, null);
        this.d = sv0Var;
        sb0Var.addView(sv0Var);
        TextView textView2 = new TextView(context);
        this.f42680w = textView2;
        textView2.setPadding(AndroidUtilities.dp(22.0f), 0, AndroidUtilities.dp(22.0f), 0);
        this.f42680w.setGravity(16);
        this.f42680w.setTextSize(1, 16.0f);
        this.f42680w.setHint(LocaleController.getString(R.string.TimeLimitHint));
        this.f42680w.setOnClickListener(new tv(14, this, context));
        ...
        sb0Var.addView(this.f42680w, w7.x5.n(-1, 50));
        ...
        this.f42674c = sv0Var2;
        sv0Var2.setCallback(new nb0(this, 3));
        X();
        sb0Var.addView(this.f42674c);
        ...
        this.f42676f.setTag(Integer.valueOf(i13));
        this.f42676f.f(LocaleController.getString(R.string.ApproveNewMembers2), false, false);
        this.f42676f.setOnClickListener(new bi.w2(7, this, z10));
        sb0Var.addView(this.f42676f, w7.x5.n(-1, 56));
        ...
        if (chat == null || chat.username == null) {
            ...
            if ((this.f42675e == null && ChatObject.isChannelAndNotMegaGroup(MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(j3))) && chatFull != null && chatFull.paid_media_allowed) || ((tL_chatInviteExported = this.f42675e) != null && tL_chatInviteExported.subscription_pricing != null)) {
                ...
                this.f42677n.setDrawCheckRipple(true);
                this.f42677n.f(LocaleController.getString(R.string.RequireMonthlyFee), false, true);
                if (this.f42675e != null) {
                    this.f42677n.setCheckBoxIcon(R.drawable.permission_locked);
                    this.f42677n.setEnabled(false);
                }
                this.f42677n.setOnClickListener(new tv(15, this, new Runnable[1]));
                sb0Var.addView(this.f42677n, w7.x5.n(-1, 48));
                TextView textView3 = new TextView(context);
                this.f42679s = textView3;
                textView3.setTextSize(1, 16.0f);
                this.f42679s.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.A6, false));
                ...
                this.f42678r = vb0Var;
                vb0Var.f22075b.setInputType(2);
                this.f42678r.f22075b.setRawInputType(2);
                this.f42678r.setBackgroundColor(getThemedColor(i13));
                vb0 vb0Var2 = this.f42678r;
                vb0Var2.getClass();
                org.telegram.ui.Cells.g gVar = new org.telegram.ui.Cells.g(vb0Var2, 4);
                org.telegram.ui.Cells.g3 g3Var = vb0Var2.f22075b;
                g3Var.setImeOptions(6);
                g3Var.setOnEditorActionListener(new m.s2(gVar, 2));
                this.f42678r.addView(this.f42679s, w7.x5.d(-2, -2.0f, 21, 0.0f, 0.0f, 19.0f, 0.0f));
                vb0 vb0Var3 = this.f42678r;
                ...
                org.telegram.ui.Cells.g3 g3Var2 = vb0Var3.f22075b;
                ...
                sb0Var.addView(this.f42678r, w7.x5.n(-1, 48));
                this.f42678r.setVisibility(8);
        ...
        if (i11 == 1) {
            ...
            this.I.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20881p7, false));
        ...
        this.H = frameLayout;
        int i16 = org.telegram.ui.ActionBar.j6.f20608a7;
        ...
        this.f42681x.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
        this.d.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
        this.f42680w.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
        this.E.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
        this.f42674c.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
        ...
        this.f42680w.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i15, false));
        this.f42680w.setHintTextColor(org.telegram.ui.ActionBar.j6.w0(null, i14, false));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f42681x, 0, new Class[]{org.telegram.ui.Cells.l4.class}, new String[]{"textView"}, null, null, -1, null, i10));
        ...
        org.telegram.ui.Cells.l4 l4Var = this.f42681x;
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f42674c, 1, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f42680w, 1, null, null, null, null, i11));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f42682y, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, i12));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, null, null, null, eVar, org.telegram.ui.ActionBar.j6.f21043y6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, null, null, null, eVar, org.telegram.ui.ActionBar.j6.Sh));
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, null, null, null, eVar, org.telegram.ui.ActionBar.j6.f20881p7));
        return arrayList;
    }
}
