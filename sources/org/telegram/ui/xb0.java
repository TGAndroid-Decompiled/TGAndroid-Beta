...
public final class xb0 extends org.telegram.ui.ActionBar.n2 {
    ...
    public org.telegram.ui.Components.sv0 f42701c;
    public org.telegram.ui.Components.sv0 d;
    public TLRPC.TL_chatInviteExported f42702e;
    public ub0 f42703f;
    public org.telegram.ui.Cells.e9 h;
    public org.telegram.ui.Cells.w8 f42704n;
    public vb0 f42705r;
    public TextView f42706s;
    public org.telegram.ui.Cells.e9 v;
    public TextView f42707w;
    public org.telegram.ui.Cells.l4 f42708x;
    public org.telegram.ui.Cells.e9 f42709y;
    ...
    public final void V(int i10) {
        int[] iArr;
        long j3 = i10;
        this.f42707w.setText(LocaleController.formatDateAudio(j3, false));
    ...
    public final void W(int i10) {
        ...
        this.f42701c.b(i13, null, strArr);
    }
    ...
    public final void X() {
        ...
        while (true) {
            ...
            if (i10 < iArr.length) {
                ...
                this.f42701c.b(3, null, "1", "10", "100", LocaleController.getString(R.string.NoLimit));
                return;
            }
        }
    }
    ...
    public final void Y(TLRPC.TL_chatInviteExported tL_chatInviteExported) {
        int i10;
        this.f42702e = tL_chatInviteExported;
        if (this.fragmentView != null && tL_chatInviteExported != null) {
            ...
            ub0 ub0Var = this.f42703f;
            if (ub0Var != null) {
                ub0Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20691d6, false));
                this.f42703f.setChecked(tL_chatInviteExported.request_needed);
            }
            boolean z10 = true;
            ...
            org.telegram.ui.Cells.w8 w8Var = this.f42704n;
            if (w8Var != null) {
            ...
            if (tL_chatInviteExported.subscription_pricing != null) {
                ub0 ub0Var2 = this.f42703f;
                if (ub0Var2 != null) {
                    ub0Var2.setChecked(false);
                    this.f42703f.setCheckBoxIcon(R.drawable.permission_locked);
                }
            ...
            if (vb0Var != null) {
                ...
                this.f42705r.setText(Long.toString(tL_chatInviteExported.subscription_pricing.amount));
                this.f42705r.f22102b.setClickable(false);
                this.f42705r.f22102b.setFocusable(false);
                this.f42705r.f22102b.setFocusableInTouchMode(false);
                this.f42705r.f22102b.setLongClickable(false);
            }
        }
    }
    ...
    public final void Z(boolean z10) {
        ...
        org.telegram.ui.Components.sv0 sv0Var = this.f42701c;
        if (z10) {
            i11 = 0;
        } else {
            i11 = 8;
    ...
    public final View createView(Context context) {
        ...
        sb0Var.addView(this.f42708x);
        org.telegram.ui.Components.sv0 sv0Var = new org.telegram.ui.Components.sv0(context, null);
        this.d = sv0Var;
        sb0Var.addView(sv0Var);
        TextView textView2 = new TextView(context);
        this.f42707w = textView2;
        textView2.setPadding(AndroidUtilities.dp(22.0f), 0, AndroidUtilities.dp(22.0f), 0);
        this.f42707w.setGravity(16);
        this.f42707w.setTextSize(1, 16.0f);
        this.f42707w.setHint(LocaleController.getString(R.string.TimeLimitHint));
        this.f42707w.setOnClickListener(new tv(14, this, context));
        ...
        sb0Var.addView(this.f42707w, w7.x5.n(-1, 50));
        ...
        this.f42701c = sv0Var2;
        sv0Var2.setCallback(new nb0(this, 3));
        X();
        sb0Var.addView(this.f42701c);
        ...
        this.f42703f.setTag(Integer.valueOf(i13));
        this.f42703f.f(LocaleController.getString(R.string.ApproveNewMembers2), false, false);
        this.f42703f.setOnClickListener(new bi.w2(7, this, z10));
        sb0Var.addView(this.f42703f, w7.x5.n(-1, 56));
        ...
        if (chat == null || chat.username == null) {
            ...
            if ((this.f42702e == null && ChatObject.isChannelAndNotMegaGroup(MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(j3))) && chatFull != null && chatFull.paid_media_allowed) || ((tL_chatInviteExported = this.f42702e) != null && tL_chatInviteExported.subscription_pricing != null)) {
                ...
                this.f42704n.setDrawCheckRipple(true);
                this.f42704n.f(LocaleController.getString(R.string.RequireMonthlyFee), false, true);
                if (this.f42702e != null) {
                    this.f42704n.setCheckBoxIcon(R.drawable.permission_locked);
                    this.f42704n.setEnabled(false);
                }
                this.f42704n.setOnClickListener(new tv(15, this, new Runnable[1]));
                sb0Var.addView(this.f42704n, w7.x5.n(-1, 48));
                TextView textView3 = new TextView(context);
                this.f42706s = textView3;
                textView3.setTextSize(1, 16.0f);
                this.f42706s.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.A6, false));
                ...
                this.f42705r = vb0Var;
                vb0Var.f22102b.setInputType(2);
                this.f42705r.f22102b.setRawInputType(2);
                this.f42705r.setBackgroundColor(getThemedColor(i13));
                vb0 vb0Var2 = this.f42705r;
                vb0Var2.getClass();
                org.telegram.ui.Cells.g gVar = new org.telegram.ui.Cells.g(vb0Var2, 4);
                org.telegram.ui.Cells.g3 g3Var = vb0Var2.f22102b;
                g3Var.setImeOptions(6);
                g3Var.setOnEditorActionListener(new m.s2(gVar, 2));
                this.f42705r.addView(this.f42706s, w7.x5.d(-2, -2.0f, 21, 0.0f, 0.0f, 19.0f, 0.0f));
                vb0 vb0Var3 = this.f42705r;
                ...
                org.telegram.ui.Cells.g3 g3Var2 = vb0Var3.f22102b;
                ...
                sb0Var.addView(this.f42705r, w7.x5.n(-1, 48));
        ...
        if (i11 == 1) {
            ...
            this.I.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20908p7, false));
        ...
        this.H = frameLayout;
        int i16 = org.telegram.ui.ActionBar.j6.f20635a7;
        ...
        this.f42708x.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
        this.d.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
        this.f42707w.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
        this.E.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
        this.f42701c.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i13, false));
        ...
        this.f42707w.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i15, false));
        this.f42707w.setHintTextColor(org.telegram.ui.ActionBar.j6.w0(null, i14, false));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f42708x, 0, new Class[]{org.telegram.ui.Cells.l4.class}, new String[]{"textView"}, null, null, -1, null, i10));
        ...
        org.telegram.ui.Cells.l4 l4Var = this.f42708x;
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f42701c, 1, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f42707w, 1, null, null, null, null, i11));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f42709y, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, i12));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, null, null, null, eVar, org.telegram.ui.ActionBar.j6.f21070y6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, null, null, null, eVar, org.telegram.ui.ActionBar.j6.Sh));
        arrayList.add(new org.telegram.ui.ActionBar.l6(null, 0, null, null, null, eVar, org.telegram.ui.ActionBar.j6.f20908p7));
        return arrayList;
    }
}
