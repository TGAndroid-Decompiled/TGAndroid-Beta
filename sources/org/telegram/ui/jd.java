...
public final class jd extends org.telegram.ui.Components.qv0 {
    public final int f34844w0;
    public boolean f34845x0;
    public final org.telegram.ui.ActionBar.o2 f34846y0;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        float f12;
        switch (this.f34844w0) {
            case 0:
                int size = View.MeasureSpec.getSize(i10);
                int size2 = View.MeasureSpec.getSize(i11);
                setMeasuredDimension(size, size2);
                int paddingTop = size2 - getPaddingTop();
                nd ndVar = (nd) this.f34846y0;
            ...
            case 1:
                ...
                wo woVar = (wo) this.f34846y0;
                kVar = ((org.telegram.ui.ActionBar.o2) woVar).actionBar;
                ...
                for (int i14 = 0; i14 < childCount2; i14++) {
                    ...
                    if (childAt2 != null && childAt2.getVisibility() != 8) {
                        kVar2 = ((org.telegram.ui.ActionBar.o2) woVar).actionBar;
                        if (childAt2 != kVar2) {
            ...
            case 2:
                ...
                n70 n70Var = (n70) this.f34846y0;
                kVar3 = ((org.telegram.ui.ActionBar.o2) n70Var).actionBar;
                measureChildWithMargins(kVar3, i10, 0, i11, 0);
                if (R() > AndroidUtilities.dp(20.0f)) {
                    org.telegram.ui.Components.ju juVar3 = n70Var.f35958c;
                    if (!juVar3.e) {
                        this.f34845x0 = true;
                        juVar3.j();
                        this.f34845x0 = false;
                ...
                for (int i15 = 0; i15 < childCount3; i15++) {
                    ...
                    if (childAt3 != null && childAt3.getVisibility() != 8) {
                        kVar4 = ((org.telegram.ui.ActionBar.o2) n70Var).actionBar;
                        if (childAt3 != kVar4) {
                            org.telegram.ui.Components.ju juVar4 = n70Var.f35958c;
            ...
            default:
                ...
                cw0 cw0Var = (cw0) this.f34846y0;
                kVar5 = ((org.telegram.ui.ActionBar.o2) cw0Var).actionBar;
                ...
                for (int i17 = 0; i17 < childCount4; i17++) {
                    ...
                    if (childAt4 != null && childAt4.getVisibility() != 8) {
                        kVar6 = ((org.telegram.ui.ActionBar.o2) cw0Var).actionBar;
                        if (childAt4 != kVar6) {
                            ...
                            } else if (cw0Var.f32934c == childAt4) {
