...
public final class kn0 extends org.telegram.ui.Components.uv0 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final LinearLayout f35191c;
    public EditTextBoldCursor[] d;
    public final TextView e;
    public final TextView f35192f;
    public final ImageView h;
    public final hn0 f35193n;
    public final hn0 f35194r;
    public final ln0 f35195s;
    public Timer v;
    public Timer f35196w;
    public final Object f35197x;
    public int f35198y;
    ...
    public kn0(on0 on0Var, Context context, int i10) {
        ...
        this.f35192f = textView2;
        int i19 = org.telegram.ui.ActionBar.i6.G6;
        org.telegram.messenger.y0.q(textView2, org.telegram.ui.ActionBar.i6.w0(null, i19, false), 1, 18.0f);
        ...
        this.f35193n = hn0Var;
        hn0Var.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, i18, false));
        ...
        if (i10 == 3) {
            ...
            addView(hn0Var, w7.x5.q(-2, -2, i12));
            ?? view = new View(context);
            Paint paint = new Paint();
            view.f35519a = paint;
            Paint paint2 = new Paint();
            view.f35520b = paint2;
            paint.setColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18898gi, false));
            paint2.setColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18915hi, false));
            this.f35195s = view;
            if (LocaleController.isRTL) {
                i13 = 5;
            } else {
    ...
    public final boolean c(boolean z10) {
        ...
        if (!z10) {
            ...
            alertDialog$Builder.f18435a.T = LocaleController.getString(R.string.StopVerification);
        ...
        tL_auth_cancelCode.phone_number = this.f35189a;
        tL_auth_cancelCode.phone_code_hash = this.f35190b;
    ...
    public final void h(String str) {
        ...
        if (TextUtils.isEmpty(code)) {
            AndroidUtilities.shakeView(this.f35191c);
            return;
        }
        this.J = true;
        int i11 = this.L;
        ...
        verifyphone.phone_number = this.f35189a;
        verifyphone.phone_code = code;
        verifyphone.phone_code_hash = this.f35190b;
        s();
        on0Var.y1();
        i10 = ((org.telegram.ui.ActionBar.n2) on0Var).currentAccount;
    ...
    @Override
    public final void j() {
        LinearLayout linearLayout = this.f35191c;
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        if (bundle != null) {
            ...
            this.f35189a = bundle.getString("phone");
            this.f35190b = bundle.getString("phoneHash");
            ...
            if (editTextBoldCursorArr != null && editTextBoldCursorArr.length == this.O) {
                ...
                for (final int i21 = 0; i21 < this.O; i21++) {
                    ...
                    editTextBoldCursor.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, i22, false));
                    this.d[i21].setCursorColor(org.telegram.ui.ActionBar.i6.w0(null, i22, false));
                    ...
                    mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18979l6, false), PorterDuff.Mode.MULTIPLY));
                    ...
                    this.f35191c.addView(editTextBoldCursor2, w7.x5.t(34, 36, 1, 0, 0, i10, 0));
            ...
            String h = org.telegram.messenger.vl.h(new StringBuilder("+"), this.f35189a, gf.b.c());
            if (i17 == 2) {
            ...
            hn0 hn0Var = this.f35194r;
            hn0 hn0Var2 = this.f35193n;
            if (i17 == 3) {
                int i23 = this.M;
                i11 = 2;
                if (i23 == 4 || i23 == 2) {
            ...
            if (i17 == i11 && ((i13 = this.M) == 4 || i13 == 3)) {
                ...
                objArr[0] = 2;
                objArr[1] = 0;
                hn0Var2.setText(LocaleController.formatString("CallText", i25, objArr));
                if (this.f35198y < 1000) {
                    i14 = 0;
                } else {
                    i14 = 8;
                }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.L != 3 && (imageView = this.h) != null) {
            int dp = AndroidUtilities.dp(35.0f) + this.e.getMeasuredHeight() + this.f35192f.getMeasuredHeight() + imageView.getMeasuredHeight();
            int dp2 = AndroidUtilities.dp(80.0f);
            int dp3 = AndroidUtilities.dp(291.0f);
            on0 on0Var = this.Q;
            if (on0Var.f36297s0 - dp < dp2) {
                setMeasuredDimension(getMeasuredWidth(), dp + dp2);
            } else {
                setMeasuredDimension(getMeasuredWidth(), Math.min(on0Var.f36297s0, dp3));
            }
        }
    }

    public final void p() {
        if (this.f35196w != null) {
            return;
        }
        this.E = 15000;
        this.f35196w = new Timer();
        this.G = System.currentTimeMillis();
        this.f35196w.schedule(new ci.p2(this, 4), 0L, 1000L);
    }
    ...
    public final void r() {
        try {
            synchronized (this.f35197x) {
                Timer timer = this.f35196w;
                if (timer != null) {
                    timer.cancel();
                    this.f35196w = null;
                }
    ...
    public final void u() {
        ...
        bundle.putString("phone", this.f35189a);
        this.J = true;
        on0 on0Var = this.Q;
        on0Var.y1();
        TLRPC.TL_auth_resendCode tL_auth_resendCode = new TLRPC.TL_auth_resendCode();
        tL_auth_resendCode.phone_number = this.f35189a;
        tL_auth_resendCode.phone_code_hash = this.f35190b;
        i10 = ((org.telegram.ui.ActionBar.n2) on0Var).currentAccount;
