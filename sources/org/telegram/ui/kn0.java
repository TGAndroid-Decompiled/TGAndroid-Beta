...
public final class kn0 extends org.telegram.ui.Components.uv0 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final TextView f35199f;
    public final ImageView h;
    public final hn0 f35200n;
    public final hn0 f35201r;
    public final ln0 f35202s;
    public Timer v;
    public Timer f35203w;
    public final Object f35204x;
    public int f35205y;
    ...
    public kn0(on0 on0Var, Context context, int i10) {
        ...
        this.f35199f = textView2;
        int i19 = org.telegram.ui.ActionBar.i6.G6;
        org.telegram.messenger.w1.q(textView2, org.telegram.ui.ActionBar.i6.w0(null, i19, false), 1, 18.0f);
        ...
        if (i10 == 3) {
            ...
            view.f35537b = paint2;
            paint.setColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18901gi, false));
            paint2.setColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18918hi, false));
            this.f35202s = view;
            if (LocaleController.isRTL) {
                i13 = 5;
            } else {
    ...
    public final boolean c(boolean z10) {
        ...
        if (!z10) {
            ...
            alertDialog$Builder.f18437a.T = LocaleController.getString(R.string.StopVerification);
        ...
        tL_auth_cancelCode.phone_number = this.f35196a;
        tL_auth_cancelCode.phone_code_hash = this.f35197b;
    ...
    public final void h(String str) {
        ...
        if (TextUtils.isEmpty(code)) {
            AndroidUtilities.shakeView(this.f35198c);
            return;
        }
        this.J = true;
        int i11 = this.L;
        ...
        verifyphone.phone_number = this.f35196a;
        verifyphone.phone_code = code;
        verifyphone.phone_code_hash = this.f35197b;
        s();
        on0Var.y1();
        i10 = ((org.telegram.ui.ActionBar.n2) on0Var).currentAccount;
    ...
    @Override
    public final void j() {
        LinearLayout linearLayout = this.f35198c;
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        if (bundle != null) {
            ...
            this.f35196a = bundle.getString("phone");
            this.f35197b = bundle.getString("phoneHash");
            ...
            if (editTextBoldCursorArr != null && editTextBoldCursorArr.length == this.O) {
                ...
                for (final int i21 = 0; i21 < this.O; i21++) {
                    ...
                    mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18982l6, false), PorterDuff.Mode.MULTIPLY));
                    ...
                    this.f35198c.addView(editTextBoldCursor2, w7.x5.t(34, 36, 1, 0, 0, i10, 0));
            ...
            String j3 = org.telegram.messenger.w1.j(new StringBuilder("+"), this.f35196a, gf.b.c());
            if (i17 == 2) {
            ...
            hn0 hn0Var = this.f35201r;
            hn0 hn0Var2 = this.f35200n;
            if (i17 == 3) {
                int i23 = this.M;
                i11 = 2;
                if (i23 == 4 || i23 == 2) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.L != 3 && (imageView = this.h) != null) {
            int dp = AndroidUtilities.dp(35.0f) + this.e.getMeasuredHeight() + this.f35199f.getMeasuredHeight() + imageView.getMeasuredHeight();
            int dp2 = AndroidUtilities.dp(80.0f);
            int dp3 = AndroidUtilities.dp(291.0f);
            on0 on0Var = this.Q;
            if (on0Var.f36294s0 - dp < dp2) {
                setMeasuredDimension(getMeasuredWidth(), dp + dp2);
            } else {
                setMeasuredDimension(getMeasuredWidth(), Math.min(on0Var.f36294s0, dp3));
            }
        }
    }

    public final void p() {
        if (this.f35203w != null) {
            return;
        }
        this.E = 15000;
        this.f35203w = new Timer();
        this.G = System.currentTimeMillis();
        this.f35203w.schedule(new ci.p2(this, 4), 0L, 1000L);
    }
    ...
    public final void r() {
        try {
            synchronized (this.f35204x) {
                Timer timer = this.f35203w;
                if (timer != null) {
                    timer.cancel();
                    this.f35203w = null;
                }
    ...
    public final void u() {
        ...
        bundle.putString("phone", this.f35196a);
        this.J = true;
        on0 on0Var = this.Q;
        on0Var.y1();
        TLRPC.TL_auth_resendCode tL_auth_resendCode = new TLRPC.TL_auth_resendCode();
        tL_auth_resendCode.phone_number = this.f35196a;
        tL_auth_resendCode.phone_code_hash = this.f35197b;
        i10 = ((org.telegram.ui.ActionBar.n2) on0Var).currentAccount;
