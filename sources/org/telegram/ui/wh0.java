...
public final class wh0 extends FrameLayout {
    ...
    public final zh0 K;
    public int f39161a;
    public final LinearLayout f39162b;
    public final TextView f39163c;
    public final TextView d;
    public final LinearLayout e;
    public final TextView f39164f;
    public final TextView h;
    public TLRPC.TL_chatInviteExported f39165n;
    public int f39166r;
    public final Paint f39167s;
    public final Paint v;
    public final RectF f39168w;
    public final ImageView f39169x;
    public int f39170y;

    public wh0(zh0 zh0Var, Context context) {
        super(context);
        this.K = zh0Var;
        this.f39167s = new Paint(1);
        Paint paint = new Paint(1);
        this.v = paint;
        this.f39168w = new RectF();
        this.E = 1.0f;
        this.J = new org.telegram.ui.Components.m21();
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeCap(Paint.Cap.ROUND);
        LinearLayout linearLayout = new LinearLayout(context);
        this.f39162b = linearLayout;
        linearLayout.setOrientation(1);
        addView(linearLayout, w7.y5.d(-1, -2.0f, 16, 64.0f, 0.0f, 30.0f, 0.0f));
        TextView textView = new TextView(context);
        this.f39163c = textView;
    ...
    public final int a(float f7, int i10) {
        TLRPC.TL_chatInviteExported tL_chatInviteExported = this.f39165n;
        ...
        if (i10 == 3) {
            return org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19194ka, false);
        }
        if (i10 == 1) {
            if (f7 > 0.5f) {
                return i0.a.d(1.0f - ((f7 - 0.5f) / 0.5f), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19251na, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19267oa, false));
            }
            return i0.a.d(1.0f - (f7 / 0.5f), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19267oa, false), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19194ka, false));
        } else if (i10 == 2) {
            return org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19267oa, false);
        } else {
            if (i10 == 4) {
    ...
    public final void b(TLRPC.TL_chatInviteExported tL_chatInviteExported, int i10) {
        ...
        ImageView imageView = this.f39169x;
        ...
        if (tL_starsSubscriptionPricing != null) {
            ...
            TextView textView = this.f39164f;
            textView.setText(X0);
        ...
        ((ViewGroup.MarginLayoutParams) this.f39162b.getLayoutParams()).rightMargin = dp;
        boolean isEmpty = TextUtils.isEmpty(tL_chatInviteExported.title);
        zh0 zh0Var = this.K;
        TextView textView3 = this.f39163c;
        if (!isEmpty) {
        ...
        if (tL_chatInviteExported.permanent && !tL_chatInviteExported.revoked) {
            ...
            if (tL_chatInviteExported.expire_date > 0) {
                ...
                btVar2.f23073b = AndroidUtilities.dp(1.5f);
                ...
                long currentTimeMillis = (tL_chatInviteExported.expire_date * 1000) - ((zh0Var.f40163n0 * 1000) + System.currentTimeMillis());
            ...
            btVar3.f23073b = AndroidUtilities.dp(1.5f);
        ...
        if (tL_chatInviteExported.request_needed) {
            ...
            btVar4.f23073b = AndroidUtilities.dp(1.5f);
