...
public final class rf1 extends View {
    public final HashMap f37054a;
    public final sf1 f37055b;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i18 = 0; i18 < sf1Var.F().size(); i18++) {
            if (sf1Var.F().get(i18) != null && ((uf1) sf1Var.F().get(i18)).f37987c != null) {
                String str = ((uf1) sf1Var.F().get(i18)).f37987c.title;
                HashMap hashMap = this.f37054a;
                ...
                if (((uf1) sf1Var.F().get(i18)).f37987c.f18348id == 1) {
                    dp2 = dp4;
                }
                if (((uf1) sf1Var.F().get(i18)).f37987c.hidden) {
                    i16++;
                }
                i17 += dp4;
            }
