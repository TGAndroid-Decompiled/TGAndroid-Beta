...
public final class t10 implements org.telegram.ui.Cells.m7 {
    ...
    public final void b(TLRPC.WebPage webPage, MessageObject messageObject) {
        x10 x10Var = this.f40624a.v;
        SpannableStringBuilder[] spannableStringBuilderArr = x10.f42561s0;
        org.telegram.ui.Components.tu.J(x10Var.L, messageObject, x10Var.f42573g0, webPage.site_name, webPage.description, webPage.url, webPage.embed_url, webPage.embed_width, webPage.embed_height, -1, false);
    }

    @Override
    public final boolean c() {
        return !this.f40624a.v.f42581o0.g();
    }
}
