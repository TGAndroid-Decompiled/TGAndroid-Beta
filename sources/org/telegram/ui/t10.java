...
public final class t10 implements org.telegram.ui.Cells.m7 {
    ...
    public final void b(TLRPC.WebPage webPage, MessageObject messageObject) {
        x10 x10Var = this.f37524a.v;
        SpannableStringBuilder[] spannableStringBuilderArr = x10.f39437s0;
        org.telegram.ui.Components.vu.J(x10Var.L, messageObject, x10Var.f39448g0, webPage.site_name, webPage.description, webPage.url, webPage.embed_url, webPage.embed_width, webPage.embed_height, -1, false);
    }

    @Override
    public final boolean e() {
        return !this.f37524a.v.f39456o0.g();
    }
}
