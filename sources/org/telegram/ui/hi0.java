...
public final class hi0 extends cz {
    ...
    public final void h(bz bzVar) {
        ...
        oi0 oi0Var = vi0Var.K;
        if (bzVar != null) {
            if (vi0Var.f38741l0 != null) {
                bzVar.f32514c = true;
                float f7 = (cz.f() * AndroidUtilities.density) / 1.3f;
                float f10 = f7 / 3.0f;
                bzVar.d = f10;
                bzVar.e = f10;
                bzVar.f32512a = Utilities.clamp(vi0Var.f38741l0.right - (0.75f * f7), AndroidUtilities.displaySize.x - f7, 0.0f);
                bzVar.f32513b = vi0Var.f38741l0.bottom - (f7 / 2.0f);
                return;
            }
            ...
            if (u1Var != null && u1Var.isAttachedToWindow() && vi0Var.Q.getMessageObject() != null && vi0Var.Q.getMessageObject().getId() == vi0Var.R) {
                ...
                bzVar.e = f12;
                float f13 = f11 / 2.0f;
                bzVar.f32512a = Utilities.clamp(((oi0Var.getScaleX() * vi0Var.Q.getTimeX()) + iArr[0]) - f13, AndroidUtilities.displaySize.x - f11, 0.0f);
                bzVar.f32513b = ((oi0Var.getScaleY() * vi0Var.Q.getTimeY()) + iArr[1]) - f13;
            }
        }
    }
}
