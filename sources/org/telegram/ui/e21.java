...
public final class e21 extends org.telegram.ui.Components.vl0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        ...
        if (b10 != i10 && b10 != proxyListActivity.v) {
            ...
            if (b10 != i11 && b10 != proxyListActivity.f31671y) {
                if (b10 < proxyListActivity.f31666n || b10 >= proxyListActivity.f31667r) {
                    return false;
                }
                return true;
            }
    ...
    public final void E() {
        ...
        if (size > 0) {
            ...
            if (!s10) {
                ...
                kVar3.O(null, null);
                int i10 = proxyListActivity.f31666n;
                r(i10, proxyListActivity.f31667r - i10, 2);
            }
        } else if (s10) {
            kVar2 = ((org.telegram.ui.ActionBar.n2) proxyListActivity).actionBar;
            kVar2.r();
            int i11 = proxyListActivity.f31666n;
            r(i11, proxyListActivity.f31667r - i11, 2);
        }
    }
    ...
    public final void F() {
        ...
        int i10 = proxyListActivity.f31666n;
        r(i10, proxyListActivity.f31667r - i10, 1);
        E();
    }
    ...
    public final void G(int i10) {
        ...
        int i11 = proxyListActivity.f31666n;
        if (i10 >= i11 && i10 < proxyListActivity.f31667r) {
    ...
    public final long i(int i10) {
        ...
        int i12;
        ProxyListActivity proxyListActivity = this.d;
        if (i10 == proxyListActivity.f31665f) {
            return -1L;
        }
        if (i10 != proxyListActivity.f31668s) {
            i11 = proxyListActivity.proxyAddRow;
            if (i10 != i11) {
                ...
                if (i10 == proxyListActivity.f31671y) {
                    return -8L;
                }
                if (i10 == proxyListActivity.v) {
                    return -9L;
                }
                if (i10 == proxyListActivity.f31669w) {
                    return -10L;
                }
                if (i10 == proxyListActivity.f31670x) {
                    return -11L;
                }
                int i13 = proxyListActivity.f31666n;
                if (i10 >= i13 && i10 < proxyListActivity.f31667r) {
    ...
    public final int j(int i10) {
        ...
        int i12;
        ProxyListActivity proxyListActivity = this.d;
        if (i10 != proxyListActivity.f31665f && i10 != proxyListActivity.f31668s) {
            i11 = proxyListActivity.proxyAddRow;
            if (i10 != i11 && i10 != proxyListActivity.f31671y) {
                i12 = proxyListActivity.useProxyRow;
        ...
        switch (i13) {
            case 1:
                ...
                if (i10 == i11) {
                    ...
                    if (proxyListActivity.f31671y == -1) {
                        z11 = false;
                    }
                    eaVar.b(string, z11);
                    return;
            ...
            case 5:
                f21 f21Var = (f21) view;
                SharedConfig.ProxyInfo proxyInfo = (SharedConfig.ProxyInfo) arrayList2.get(i10 - proxyListActivity.f31666n);
                ...
                boolean contains = arrayList.contains(arrayList2.get(i10 - proxyListActivity.f31666n));
                f21Var.h = contains;
                f21Var.f33413f.a(contains, false);
    ...
    public final void w(s4.c1 c1Var, int i10, List list) {
        ...
        if (i12 == 5 && !list.isEmpty()) {
            f21 f21Var = (f21) view;
            if (list.contains(1) && (contains = arrayList.contains(proxyListActivity.G.get(i10 - proxyListActivity.f31666n))) != f21Var.h) {
                f21Var.h = contains;
                f21Var.f33413f.a(contains, true);
            }
            if (list.contains(2)) {
                f21Var.a(!arrayList.isEmpty(), true);
            }
        } else if (c1Var.f42932f == 3 && list.contains(0)) {
            org.telegram.ui.Cells.w8 w8Var = (org.telegram.ui.Cells.w8) view;
                    ...
                    if (i10 != 3) {
                        if (i10 != 4) {
                            if (i10 != 6) {
                                ...
                                b7Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19062d6, false));
                            } else {
