...
public final class vk0 extends org.telegram.ui.Components.kl0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        ...
        if (b10 != notificationsSettingsActivity.f33521x && b10 != notificationsSettingsActivity.f33522y && b10 != notificationsSettingsActivity.E && b10 != notificationsSettingsActivity.K && b10 != notificationsSettingsActivity.M && b10 != notificationsSettingsActivity.S && b10 != notificationsSettingsActivity.N && b10 != notificationsSettingsActivity.L && b10 != notificationsSettingsActivity.R && b10 != notificationsSettingsActivity.F && b10 != notificationsSettingsActivity.G && b10 != notificationsSettingsActivity.O && b10 != notificationsSettingsActivity.f33518r && b10 != notificationsSettingsActivity.f33519s && b10 != notificationsSettingsActivity.T && b10 != notificationsSettingsActivity.J) {
            return true;
        }
        return false;
    }
    ...
    public final int j(int i10) {
        ...
        int i27;
        NotificationsSettingsActivity notificationsSettingsActivity = this.d;
        if (i10 != notificationsSettingsActivity.K && i10 != notificationsSettingsActivity.M && i10 != notificationsSettingsActivity.S && i10 != notificationsSettingsActivity.G && i10 != notificationsSettingsActivity.N && i10 != notificationsSettingsActivity.E && i10 != notificationsSettingsActivity.f33521x && i10 != notificationsSettingsActivity.f33518r) {
            i11 = notificationsSettingsActivity.inappSoundRow;
            if (i10 != i11) {
                i12 = notificationsSettingsActivity.inappVibrateRow;
                if (i10 != i12 && i10 != notificationsSettingsActivity.f33520w) {
                                                                ...
                                                                if (i10 != i24) {
                                                                    ...
                                                                    if (i10 != i25) {
                                                                        ...
                                                                        if (i10 != i26) {
                                                                            ...
                                                                            if (i10 != i27) {
                                                                                if (i10 != notificationsSettingsActivity.J && i10 != notificationsSettingsActivity.f33522y && i10 != notificationsSettingsActivity.L && i10 != notificationsSettingsActivity.R && i10 != notificationsSettingsActivity.F && i10 != notificationsSettingsActivity.O && i10 != notificationsSettingsActivity.T) {
                                                                                    if (i10 == notificationsSettingsActivity.f33519s) {
                                                                                        return 6;
                                                                                    }
                                                                                    return 5;
                                                                                }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            if (i10 == 3) {
                ...
                l4Var = new org.telegram.ui.Cells.i5(21, 64, this.f41612c, f6Var3, true);
            } else if (i10 != 4) {
                if (i10 != 5) {
