...
public final class o40 implements dv0 {
    ...
    public final void E0(MessageObject messageObject) {
        ViewGroup viewGroup;
        d60 d60Var = this.f36048a;
        d60Var.Q.I0(true);
        d60Var.f32946c2.f34299f.setRoundRadius(AndroidUtilities.dp(13.0f), AndroidUtilities.dp(13.0f), 0, 0);
    ...
    public final void H(MessageObject messageObject) {
        ViewGroup viewGroup;
        viewGroup = ((org.telegram.ui.ActionBar.e3) this.f36048a).containerView;
        viewGroup.invalidate();
    }
