...
public final class v20 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        int i13 = 0;
        k60 k60Var = this.f38266b;
        switch (i12) {
            case 0:
                org.telegram.ui.ActionBar.w0 w0Var = k60Var.f35053k1;
                org.telegram.ui.ActionBar.g1 g1Var = k60Var.f35098v1;
                org.telegram.ui.ActionBar.g1 g1Var2 = k60Var.f35094u1;
                org.telegram.ui.ActionBar.g1 g1Var3 = k60Var.f35072p1;
                ChatObject.Call call = k60Var.f35012a1;
                if (call != null && !k60Var.a2.f29035b) {
                    if (call.call.join_muted) {
                        int i14 = org.telegram.ui.ActionBar.j6.f18942hg;
                        ...
                        int i15 = org.telegram.ui.ActionBar.j6.f19218wg;
                        ...
                        int i16 = org.telegram.ui.ActionBar.j6.f19218wg;
                        ...
                        int i17 = org.telegram.ui.ActionBar.j6.f18942hg;
            ...
            case 1:
                if (k60Var.r1()) {
                    if (sf.c.a(k60Var.f35045i0) > 0) {
                        org.telegram.ui.Components.voip.j1.n(k60Var.f35045i0);
                        k60Var.dismiss();
                        return;
                    }
                    org.telegram.ui.Components.c5.B(k60Var.f35045i0, null, true).o();
                    return;
                } else if (AndroidUtilities.checkInlinePermissions(k60Var.f35045i0)) {
            ...
            case 2:
                ...
                if (sharedInstance != null) {
                    ...
                    LaunchActivity launchActivity = k60Var.f35045i0;
                    if (launchActivity != null) {
                        k60Var.f35045i0.startActivityForResult(((MediaProjectionManager) launchActivity.getSystemService("media_projection")).createScreenCaptureIntent(), 520);
                        return;
                    }
                    return;
                }
            ...
            case 6:
                ...
                org.telegram.ui.Components.eu euVar = k60Var.H.f25430a;
                euVar.requestFocus();
            ...
            case 8:
                ...
                return;
            case 9:
                ChatObject.Call call5 = k60Var.f35012a1;
                ...
                if (sharedInstance2 != null && sharedInstance2.getVideoState(false) == 2) {
                    ...
                    for (int i18 = 0; i18 < arrayList.size(); i18++) {
                        ...
                        if (videoParticipant.participant.self && !videoParticipant.presentation) {
                            org.telegram.ui.Components.voip.p pVar = uVar.f29217a;
                            if (uVar.J0 == null) {
                                uVar.K0 = false;
                                ImageView imageView = uVar.f29248x0;
                                if (imageView == null) {
                                    uVar.f29248x0 = new ImageView(uVar.getContext());
                                } else {
                                ...
                                if (pVar.d.isFirstFrameRendered()) {
                                    ...
                                    if (bitmap != null) {
                                        ...
                                        uVar.f29248x0.setBackground(new BitmapDrawable(bitmap));
                                    }
                                    uVar.f29248x0.setAlpha(0.0f);
                                } else {
                                    uVar.f29248x0.setAlpha(1.0f);
                                }
                                if (uVar.f29248x0.getParent() == null) {
                                    pVar.addView(uVar.f29248x0);
                                }
                                ((FrameLayout.LayoutParams) uVar.f29248x0.getLayoutParams()).gravity = 17;
                                ...
                                uVar.J0.setInterpolator(org.telegram.ui.Components.qr.f27380f);
                                uVar.J0.start();
                            }
                        }
                    }
