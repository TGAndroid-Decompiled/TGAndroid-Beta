...
public final class vh0 extends FrameLayout {
    ...
    public final yh0 K;
    public int f38613a;
    public final LinearLayout f38614b;
    public final TextView f38615c;
    public final TextView d;
    public final LinearLayout e;
    public final TextView f38616f;
    public final TextView h;
    public TLRPC.TL_chatInviteExported f38617n;
    public int f38618r;
    public final Paint f38619s;
    public final Paint v;
    public final RectF f38620w;
    public final ImageView f38621x;
    public int f38622y;

    public vh0(yh0 yh0Var, Context context) {
        super(context);
        this.K = yh0Var;
        this.f38619s = new Paint(1);
        Paint paint = new Paint(1);
        this.v = paint;
        this.f38620w = new RectF();
        this.E = 1.0f;
        this.J = new org.telegram.ui.Components.x11();
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeCap(Paint.Cap.ROUND);
        LinearLayout linearLayout = new LinearLayout(context);
        this.f38614b = linearLayout;
    ...
    public final int a(float f7, int i10) {
        TLRPC.TL_chatInviteExported tL_chatInviteExported = this.f38617n;
        ...
        if (i10 == 3) {
            return org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18968ka, false);
        }
        if (i10 == 1) {
            if (f7 > 0.5f) {
                return i0.a.d(1.0f - ((f7 - 0.5f) / 0.5f), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19025na, false), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19041oa, false));
            }
            return i0.a.d(1.0f - (f7 / 0.5f), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19041oa, false), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18968ka, false));
        } else if (i10 == 2) {
            return org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19041oa, false);
        } else {
            if (i10 == 4) {
    ...
    public final void b(TLRPC.TL_chatInviteExported tL_chatInviteExported, int i10) {
        ...
        ImageView imageView = this.f38621x;
        ...
        if (tL_starsSubscriptionPricing != null) {
            ...
            TextView textView = this.f38616f;
            textView.setText(X0);
        ...
        ((ViewGroup.MarginLayoutParams) this.f38614b.getLayoutParams()).rightMargin = dp;
        boolean isEmpty = TextUtils.isEmpty(tL_chatInviteExported.title);
        yh0 yh0Var = this.K;
        TextView textView3 = this.f38615c;
        if (!isEmpty) {
        ...
        if (tL_chatInviteExported.permanent && !tL_chatInviteExported.revoked) {
            ...
            btVar.f22870b = AndroidUtilities.dp(1.5f);
            ...
            if (tL_chatInviteExported.expire_date > 0) {
                ...
                btVar2.f22870b = AndroidUtilities.dp(1.5f);
                ...
                long currentTimeMillis = (tL_chatInviteExported.expire_date * 1000) - ((yh0Var.f39899n0 * 1000) + System.currentTimeMillis());
            ...
            btVar3.f22870b = AndroidUtilities.dp(1.5f);
        ...
        if (tL_chatInviteExported.request_needed) {
            ...
            btVar4.f22870b = AndroidUtilities.dp(1.5f);
