...
public final class vh0 extends FrameLayout {
    ...
    public final TextView f38551f;
    public final TextView h;
    public TLRPC.TL_chatInviteExported f38552n;
    public int f38553r;
    public final Paint f38554s;
    public final Paint v;
    public final RectF f38555w;
    public final ImageView f38556x;
    public int f38557y;

    public vh0(yh0 yh0Var, Context context) {
        super(context);
        this.K = yh0Var;
        this.f38554s = new Paint(1);
        Paint paint = new Paint(1);
        this.v = paint;
        this.f38555w = new RectF();
        this.E = 1.0f;
    ...
    public final int a(float f7, int i10) {
        TLRPC.TL_chatInviteExported tL_chatInviteExported = this.f38552n;
        ...
        if (i10 == 3) {
            return org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18965ka, false);
        }
        if (i10 == 1) {
            if (f7 > 0.5f) {
                return i0.a.d(1.0f - ((f7 - 0.5f) / 0.5f), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19022na, false), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19038oa, false));
            }
            return i0.a.d(1.0f - (f7 / 0.5f), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19038oa, false), org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18965ka, false));
        } else if (i10 == 2) {
            return org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19038oa, false);
        } else {
            if (i10 == 4) {
    ...
    public final void b(TLRPC.TL_chatInviteExported tL_chatInviteExported, int i10) {
        ...
        ImageView imageView = this.f38556x;
        ...
        if (tL_starsSubscriptionPricing != null) {
            ...
            TextView textView = this.f38551f;
            textView.setText(X0);
        ...
        ((ViewGroup.MarginLayoutParams) this.f38549b.getLayoutParams()).rightMargin = dp;
        boolean isEmpty = TextUtils.isEmpty(tL_chatInviteExported.title);
        yh0 yh0Var = this.K;
        TextView textView3 = this.f38550c;
        if (!isEmpty) {
        ...
        if (tL_chatInviteExported.permanent && !tL_chatInviteExported.revoked) {
            ...
            if (tL_chatInviteExported.expire_date > 0) {
                ...
                btVar2.f22868b = AndroidUtilities.dp(1.5f);
                ...
                long currentTimeMillis = (tL_chatInviteExported.expire_date * 1000) - ((yh0Var.f39869n0 * 1000) + System.currentTimeMillis());
            ...
            btVar3.f22868b = AndroidUtilities.dp(1.5f);
        ...
        if (tL_chatInviteExported.request_needed) {
            ...
            btVar4.f22868b = AndroidUtilities.dp(1.5f);
