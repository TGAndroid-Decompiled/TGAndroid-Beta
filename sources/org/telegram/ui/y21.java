...
public final class y21 extends View {
    ...
    public String R;
    public boolean S;
    public final org.telegram.ui.Components.lc0 f39681a;
    public final Paint f39682b;
    public final BitmapShader f39683c;
    public final BitmapShader d;
    public p21 e;
    public Bitmap f39684f;
    public Bitmap h;
    public Bitmap f39685n;
    public boolean f39686r;
    public final org.telegram.ui.Components.xo0 f39687s;
    public TextPaint v;
    public StaticLayout f39688w;
    public final org.telegram.ui.Components.e6 f39689x;
    public final Paint f39690y;
    ...
    public y21(Context context) {
        ...
        this.f39689x = new org.telegram.ui.Components.e6(1.0f, this, 0L, 2000L, qrVar);
        ...
        lc0Var.N = true;
        lc0Var.r(this);
        Bitmap bitmap = lc0Var.f26109k;
        Shader.TileMode tileMode = Shader.TileMode.MIRROR;
        BitmapShader bitmapShader = new BitmapShader(bitmap, tileMode, tileMode);
        this.f39683c = bitmapShader;
        BitmapShader bitmapShader2 = new BitmapShader(lc0Var.f26109k, tileMode, tileMode);
        ...
        xo0Var.f26867a.setShader(bitmapShader2);
        xo0Var.f26868b = 17;
    ...
    public final void a(Canvas canvas) {
        ...
        if (this.F != null) {
            ...
            if (!this.M && (p21Var = this.e) != null) {
                e31 e31Var = p21Var.f36306a;
                e31Var.f33160c.set((int) (width2 - round), (int) (width3 - round), (int) (width2 + round), (int) (width3 + round));
    ...
    public final void d(boolean z10) {
        ...
        if (z10) {
            ...
            this.f39688w = org.telegram.ui.Components.vw0.c(Emoji.replaceEmoji(str, this.v.getFontMetricsInt(), false), this.v, getWidth(), Layout.Alignment.ALIGN_CENTER, 0.0f, false, TextUtils.TruncateAt.END, getWidth() - AndroidUtilities.dp(60.0f), 1, true);
            return;
        }
        this.f39688w = null;
    }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        this.f39684f = Bitmap.createBitmap(i10, i11, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(this.f39684f);
        float f10 = i10;
        ...
        float max = Math.max((getWidth() * 1.0f) / this.f39681a.f26109k.getWidth(), (getHeight() * 1.0f) / this.f39681a.f26109k.getHeight());
        Matrix matrix = new Matrix();
        matrix.setScale(max, max);
        this.f39683c.setLocalMatrix(matrix);
