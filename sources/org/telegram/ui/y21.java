...
public final class y21 extends View {
    ...
    public String R;
    public boolean S;
    public final org.telegram.ui.Components.cc0 f39733a;
    public final Paint f39734b;
    public final BitmapShader f39735c;
    public final BitmapShader d;
    public p21 e;
    public Bitmap f39736f;
    public Bitmap h;
    public Bitmap f39737n;
    public boolean f39738r;
    public final org.telegram.ui.Components.jo0 f39739s;
    public TextPaint v;
    public StaticLayout f39740w;
    public final org.telegram.ui.Components.c6 f39741x;
    public final Paint f39742y;
    ...
    public y21(Context context) {
        ...
        this.f39741x = new org.telegram.ui.Components.c6(1.0f, this, 0L, 2000L, qrVar);
        ...
        cc0Var.N = true;
        cc0Var.r(this);
        Bitmap bitmap = cc0Var.f23056k;
        Shader.TileMode tileMode = Shader.TileMode.MIRROR;
        BitmapShader bitmapShader = new BitmapShader(bitmap, tileMode, tileMode);
        this.f39735c = bitmapShader;
        BitmapShader bitmapShader2 = new BitmapShader(cc0Var.f23056k, tileMode, tileMode);
        ...
        jo0Var.f26085a.setShader(bitmapShader2);
        jo0Var.f26086b = 17;
    ...
    public final void a(Canvas canvas) {
        ...
        if (this.F != null) {
            ...
            if (!this.M && (p21Var = this.e) != null) {
                e31 e31Var = p21Var.f36399a;
                e31Var.f33201c.set((int) (width2 - round), (int) (width3 - round), (int) (width2 + round), (int) (width3 + round));
    ...
    public final void d(boolean z10) {
        ...
        if (z10) {
            ...
            this.f39740w = org.telegram.ui.Components.jw0.c(Emoji.replaceEmoji(str, this.v.getFontMetricsInt(), false), this.v, getWidth(), Layout.Alignment.ALIGN_CENTER, 0.0f, false, TextUtils.TruncateAt.END, getWidth() - AndroidUtilities.dp(60.0f), 1, true);
            return;
        }
        this.f39740w = null;
    }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        this.f39736f = Bitmap.createBitmap(i10, i11, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(this.f39736f);
        float f10 = i10;
        ...
        float max = Math.max((getWidth() * 1.0f) / this.f39733a.f23056k.getWidth(), (getHeight() * 1.0f) / this.f39733a.f23056k.getHeight());
        Matrix matrix = new Matrix();
        matrix.setScale(max, max);
        this.f39735c.setLocalMatrix(matrix);
