...
public final class kk extends org.telegram.ui.Components.b81 {
    ...
    public final void b(View view, int i10, int i11) {
        if (view instanceof eo) {
            ((eo) view).f33444a.Jc(this.f35298b.f32466u3);
        }
    ...
    public final View d(int i10) {
        ...
        bundle.putString("searchHashtag", boVar.f32466u3);
        jk jkVar = new jk(context, boVar.getParentLayout(), bundle, 0);
        jkVar.h = false;
        co coVar = jkVar.f33444a;
        coVar.L.f9081a = boVar.L;
        coVar.f32251ca = boVar.f32275ea;
        coVar.f32263da = boVar;
