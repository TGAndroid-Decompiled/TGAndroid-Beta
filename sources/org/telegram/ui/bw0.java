...
public class bw0 extends FrameLayout {
    public final org.telegram.ui.ActionBar.l5 f35604a;
    public final TextView f35605b;
    public final ImageView f35606c;
    public final ImageView d;
    public boolean f35607e;
    public rw0 f35608f;
    public org.telegram.ui.Components.j5 h;
    public Drawable f35609n;
    ...
    public final void a(rw0 rw0Var, boolean z4) {
        ...
        if (isPremium && rw0Var.f41056a == 12 && rw0Var.f41057b == R.drawable.filled_premium_status2) {
        ...
        this.f35608f = rw0Var;
        this.f35604a.l(rw0Var.f41058c, false);
        this.f35605b.setText(rw0Var.d);
        this.f35606c.setImageResource(rw0Var.f41057b);
        this.f35607e = z4;
    }
    ...
    public final void b(long j10, boolean z4) {
        ...
        if (j10 == 0) {
            if (this.f35609n == null) {
                ...
                this.f35609n = mutate;
                mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21979v6, false), PorterDuff.Mode.SRC_IN));
            }
            this.h.g(this.f35609n, z4);
            return;
        }
        this.h.j(j10, z4);
    }
    ...
    public final void c() {
        this.h.setBounds((getWidth() - this.h.f28001s) - AndroidUtilities.dp(21.0f), (getHeight() - this.h.f28001s) / 2, getWidth() - AndroidUtilities.dp(21.0f), (getHeight() + this.h.f28001s) / 2);
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.h != null) {
            c();
            this.h.k(Integer.valueOf(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21979v6, false)));
            this.h.draw(canvas);
        }
        if (this.f35607e) {
            canvas.drawRect(AndroidUtilities.dp(62.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight(), org.telegram.ui.ActionBar.k6.f21779k0);
        }
    }
