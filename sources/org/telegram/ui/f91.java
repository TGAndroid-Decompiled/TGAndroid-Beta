...
public final class f91 extends org.telegram.ui.Components.sa {
    public static final int f36722a0 = 0;
    public final mh.b U;
    ...
    public f91(final Context context, final int i10, final org.telegram.ui.ActionBar.g6 g6Var, final lh.a1 a1Var) {
        ...
        mh.b bVar = new mh.b(context, i10, mf.b.f13654b, g6Var);
        this.U = bVar;
        bVar.setScaleX(0.6f);
        bVar.setScaleY(0.6f);
        bVar.setAlpha(0.0f);
        ...
        a1.d dVar = new a1.d(context, new int[]{i14, i15, i16, i17, i18, i19, i19}, g6Var, sz0Var, 19);
        ...
        TextView b13 = k7.g6.b(context, 14.0f, org.telegram.ui.ActionBar.k6.f22038y6, false, null);
        b13.setGravity(17);
        ...
        dVar2.setOnClickListener(new View.OnClickListener() {
            ...
            public final void onClick(View view2) {
                ...
                try {
                    ...
                    } else if (mh.t7.y(i23, true).f14834f.toDouble() < parseDouble) {
                        new rh.f(context, g6Var, mf.a.i((long) (parseDouble * 1.0E9d), mf.b.f13654b), true, new sj0(5));
                    } else {
