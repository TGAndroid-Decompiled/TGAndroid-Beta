...
public final class pw implements org.telegram.ui.Components.g00 {
    ...
    public final int a(int i10) {
        py pyVar = this.f40138b;
        if (pyVar.O0 != 3) {
            if (i10 == pyVar.f40262w0.getDefaultTabId()) {
    ...
    public final void b(float f10) {
        ...
        if (i10 != 0 || pyVar.f40155b0[1].getVisibility() == 0 || pyVar.f40184g2) {
            if (pyVar.f40174e3) {
                oy oyVar = pyVar.f40155b0[0];
                oyVar.setTranslationX((-f10) * oyVar.getMeasuredWidth());
                oy[] oyVarArr = pyVar.f40155b0;
                oyVarArr[1].setTranslationX(oyVarArr[0].getMeasuredWidth() - (f10 * pyVar.f40155b0[0].getMeasuredWidth()));
            } else {
                oy oyVar2 = pyVar.f40155b0[0];
                oyVar2.setTranslationX(oyVar2.getMeasuredWidth() * f10);
                oy[] oyVarArr2 = pyVar.f40155b0;
                oyVarArr2[1].setTranslationX((f10 * oyVarArr2[0].getMeasuredWidth()) - pyVar.f40155b0[0].getMeasuredWidth());
            }
            if (i10 == 0) {
                oy[] oyVarArr3 = pyVar.f40155b0;
                ...
                py.f1(pyVar, true);
                pyVar.T4(false);
                pyVar.f40262w0.L = false;
                pyVar.r3(pyVar.f40155b0[0]);
                pyVar.f40155b0[0].d.getClass();
                pyVar.f40155b0[1].d.getClass();
            }
        }
    }
    ...
    public final void c(org.telegram.ui.Components.i00 i00Var, boolean z4) {
        ...
        int i11;
        py pyVar = this.f40138b;
        int i12 = pyVar.f40155b0[0].h;
        int i13 = i00Var.f27676a;
        if (i12 != i13) {
            if (i00Var.f27680f) {
                pyVar.f40262w0.i(i13);
                i11 = ((org.telegram.ui.ActionBar.p2) pyVar).currentAccount;
                pyVar.showDialog(new fg.v0(3, i11, this.f40137a, pyVar, null));
                return;
            }
            ArrayList<MessagesController.DialogFilter> dialogFilters = pyVar.getMessagesController().getDialogFilters();
            if (!i00Var.f27679e && ((i10 = i00Var.f27676a) < 0 || i10 >= dialogFilters.size())) {
                return;
            }
            oy oyVar = pyVar.f40155b0[1];
            oyVar.h = i00Var.f27676a;
    ...
    public final void d(MessagesController.DialogFilter dialogFilter) {
        ...
        py pyVar = this.f40138b;
        if (isChatlist) {
            org.telegram.ui.Components.d10.T(pyVar, dialogFilter.f18057id, null);
            return;
        }
