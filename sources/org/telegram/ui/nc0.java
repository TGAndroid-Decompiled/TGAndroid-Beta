...
public final class nc0 extends org.telegram.ui.ActionBar.n2 {
    public FrameLayout f35943a;
    public org.telegram.ui.Components.ll0 f35944b;
    public s4.c0 f35945c;
    public tu d;
    public org.telegram.ui.Components.oc e;
    public int f35946f;
    public final s3 h;
    public final boolean[] f35947n;
    public final ArrayList f35948r;
    public final ArrayList f35949s;

    public nc0() {
        super(null);
        this.h = new s3(this, 7);
        this.f35947n = new boolean[3];
        this.f35948r = new ArrayList();
        this.f35949s = new ArrayList();
    }
    ...
    public final void V(int i10) {
        int i11 = 0;
        while (true) {
            ArrayList arrayList = this.f35949s;
            if (i11 < arrayList.size()) {
                if (((hc0) arrayList.get(i11)).e == i10) {
                    this.f35944b.e1(new i2.s(this, i11, 12), 700, true);
                    return;
                }
                i11++;
            } else {
    ...
    public final void X() {
        String formatString;
        ArrayList arrayList = this.f35948r;
        arrayList.clear();
        ArrayList arrayList2 = this.f35949s;
        ...
        arrayList2.add(hc0.c(R.drawable.msg2_ask_question, this.f35946f, LocaleController.getString(R.string.LiteOptionsChat)));
        if (zArr[2]) {
    ...
    public final void Y() {
        ...
        if (this.f35944b != null) {
            for (int i10 = 0; i10 < this.f35944b.getChildCount(); i10++) {
                View childAt = this.f35944b.getChildAt(i10);
                if (childAt != null) {
                        ...
                        if (R < arrayList.size()) {
                            ...
                            if (i11 != 3 && i11 != 4) {
                                ...
                                if (i11 == 3) {
                                    ...
                                    mc0Var.f35701f.c(LiteMode.isEnabled(i12), true);
                                } else {
    ...
    public final View createView(Context context) {
        ...
        this.f35944b = ll0Var;
        ll0Var.p1();
        this.actionBar.setAdaptiveBackground(this.f35944b);
        org.telegram.ui.Components.ll0 ll0Var2 = this.f35944b;
        s4.c0 c0Var = new s4.c0();
        this.f35945c = c0Var;
        ll0Var2.setLayoutManager(c0Var);
        org.telegram.ui.Components.ll0 ll0Var3 = this.f35944b;
        ...
        jVar.C = false;
        jVar.f42710m = false;
        this.f35944b.setItemAnimator(jVar);
        this.f35943a.addView(this.f35944b, w7.x5.c(-1.0f, -1));
        this.f35944b.setOnItemClickListener(new hu(this, 16));
        this.fragmentView = this.f35943a;
        if (AndroidUtilities.isTablet()) {
            i10 = 360864;
        } else {
            i10 = 360928;
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f35944b.setPadding(0, 0, 0, i13);
        this.f35944b.setClipToPadding(false);
    }
}
