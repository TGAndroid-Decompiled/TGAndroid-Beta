...
public final class me0 extends org.telegram.ui.Components.tv0 {
    public final wg0 E;
    public final org.telegram.ui.Components.zc0[] f38705a;
    public final EditTextBoldCursor[] f38706b;
    public final TextView f38707c;
    public final TextView d;
    public final TextView f38708e;
    public final ImageView f38709f;
    public String h;
    public String f38710n;
    public String f38711r;
    public TL_account.Password f38712s;
    public Bundle v;
    public boolean f38713w;
    public final int f38714x;
    ...
    public me0(wg0 wg0Var, Context context, int i10) {
        ...
        this.f38706b = new EditTextBoldCursor[i11];
        this.f38705a = new org.telegram.ui.Components.zc0[i11];
        TextView textView = new TextView(context);
        this.f38707c = textView;
        float f7 = 18.0f;
        ...
        while (i15 < this.f38706b.length) {
            ...
            this.f38706b[i15] = new EditTextBoldCursor(context);
            this.f38706b[i15].setCursorSize(AndroidUtilities.dp(20.0f));
            this.f38706b[i15].setCursorWidth(1.5f);
            this.f38706b[i15].setImeOptions(268435461);
            this.f38706b[i15].setTextSize(1, f7);
            this.f38706b[i15].setMaxLines(1);
            this.f38706b[i15].setBackground(null);
            int dp = AndroidUtilities.dp(16.0f);
            this.f38706b[i15].setPadding(dp, dp, dp, dp);
            if (i10 == 0) {
                this.f38706b[i15].setInputType(129);
                this.f38706b[i15].setTransformationMethod(PasswordTransformationMethod.getInstance());
            }
            this.f38706b[i15].setTypeface(Typeface.DEFAULT);
            EditTextBoldCursor editTextBoldCursor = this.f38706b[i15];
            ...
            EditTextBoldCursor editTextBoldCursor2 = this.f38706b[i15];
            if (i15 == 0 && i10 == 0) {
                z10 = true;
            } else {
                z10 = false;
            ...
            this.f38706b[i15].setOnFocusChangeListener(new pd(zc0Var, 3));
            if (z10) {
                LinearLayout linearLayout = new LinearLayout(context);
                linearLayout.setOrientation(0);
                linearLayout.setGravity(16);
                linearLayout.addView(this.f38706b[i15], w7.x5.l(1.0f, 0, -2));
                ImageView imageView = new ImageView(context);
                this.f38709f = imageView;
                imageView.setImageResource(R.drawable.msg_message);
                AndroidUtilities.updateViewVisibilityAnimated(imageView, true, 0.1f, false);
                imageView.setOnClickListener(new View.OnClickListener(this) {
                    public final me0 f37373b;
                    ...
                    public final void onClick(View view) {
                        ...
                        switch (r2) {
                            case 0:
                                me0 me0Var = this.f37373b;
                                ImageView imageView2 = me0Var.f38709f;
                                EditTextBoldCursor[] editTextBoldCursorArr = me0Var.f38706b;
                                me0Var.f38715y = !me0Var.f38715y;
                                ...
                                imageView2.setTag(Boolean.valueOf(me0Var.f38715y));
                                if (me0Var.f38715y) {
                                    i16 = org.telegram.ui.ActionBar.j6.f20836l6;
                                } else {
                                ...
                                return;
                            default:
                                me0 me0Var2 = this.f37373b;
                                if (me0Var2.f38714x == 0) {
                                    me0Var2.o(null, null);
                                    return;
                                } else {
                                    me0Var2.o(me0Var2.f38710n, null);
                                    return;
                                }
                        }
                    }
                ...
                zc0Var.addView(this.f38706b[i15], w7.x5.c(-2.0f, -1));
            }
            zc0Var.e(this.f38706b[i15]);
            addView(zc0Var, w7.x5.t(-1, -2, 1, 16, 16, 16, 0));
            this.f38706b[i15].setOnEditorActionListener(new TextView.OnEditorActionListener() {
                @Override
    ...
    public final void h(String str) {
        if (!this.f38713w) {
            EditTextBoldCursor[] editTextBoldCursorArr = this.f38706b;
            ...
            if (length == 0) {
                ...
                bundle.putString("password", this.f38711r);
    ...
    @Override
    public final void j() {
        AndroidUtilities.runOnUIThread(new g10(this, 18), wg0.f42385t0);
    }

    @Override
    public final void k(Bundle bundle) {
        Bundle bundle2 = bundle.getBundle("recoveryview_params" + this.f38714x);
        this.v = bundle2;
        if (bundle2 != null) {
            m(bundle2, true);
        }
    ...
    public final void l(Bundle bundle) {
        if (this.v != null) {
            bundle.putBundle("recoveryview_params" + this.f38714x, this.v);
        }
    }
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        int i10 = 0;
        while (true) {
            editTextBoldCursorArr = this.f38706b;
        ...
        if (string != null) {
            ...
            this.f38712s = TLdeserialize;
            TwoStepVerificationActivity.m0(TLdeserialize);
        }
        this.f38710n = this.v.getString("new_password");
    ...
    public final void n() {
        EditTextBoldCursor[] editTextBoldCursorArr;
        int i10;
        this.f38707c.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.G6, false));
        this.d.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.D6, false));
        for (EditTextBoldCursor editTextBoldCursor : this.f38706b) {
            editTextBoldCursor.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.G6, false));
            editTextBoldCursor.setCursorColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20836l6, false));
        }
        for (org.telegram.ui.Components.zc0 zc0Var : this.f38705a) {
            zc0Var.f();
        }
        this.f38708e.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.q6, false));
        ImageView imageView = this.f38709f;
        if (imageView != null) {
            if (this.f38715y) {
                i10 = org.telegram.ui.ActionBar.j6.f20836l6;
            } else {
                i10 = org.telegram.ui.ActionBar.j6.H6;
            }
            imageView.setColorFilter(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
            imageView.setBackground(org.telegram.ui.ActionBar.j6.f0(this.E.getThemedColor(org.telegram.ui.ActionBar.j6.f20780i6), 1, -1));
        }
    }
    ...
    public final void o(String str, String str2) {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            passwordinputsettings.new_algo = this.f38712s.new_algo;
        }
