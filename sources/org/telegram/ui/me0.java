...
public final class me0 extends org.telegram.ui.Components.tv0 {
    public final wg0 E;
    public final org.telegram.ui.Components.zc0[] f38679a;
    public final EditTextBoldCursor[] f38680b;
    public final TextView f38681c;
    public final TextView d;
    public final TextView f38682e;
    public final ImageView f38683f;
    public String h;
    public String f38684n;
    public String f38685r;
    public TL_account.Password f38686s;
    public Bundle v;
    public boolean f38687w;
    public final int f38688x;
    ...
    public me0(wg0 wg0Var, Context context, int i10) {
        ...
        this.f38680b = new EditTextBoldCursor[i11];
        this.f38679a = new org.telegram.ui.Components.zc0[i11];
        TextView textView = new TextView(context);
        this.f38681c = textView;
        float f7 = 18.0f;
        ...
        while (i15 < this.f38680b.length) {
            ...
            this.f38680b[i15] = new EditTextBoldCursor(context);
            this.f38680b[i15].setCursorSize(AndroidUtilities.dp(20.0f));
            this.f38680b[i15].setCursorWidth(1.5f);
            this.f38680b[i15].setImeOptions(268435461);
            this.f38680b[i15].setTextSize(1, f7);
            this.f38680b[i15].setMaxLines(1);
            this.f38680b[i15].setBackground(null);
            int dp = AndroidUtilities.dp(16.0f);
            this.f38680b[i15].setPadding(dp, dp, dp, dp);
            if (i10 == 0) {
                this.f38680b[i15].setInputType(129);
                this.f38680b[i15].setTransformationMethod(PasswordTransformationMethod.getInstance());
            }
            this.f38680b[i15].setTypeface(Typeface.DEFAULT);
            EditTextBoldCursor editTextBoldCursor = this.f38680b[i15];
            ...
            EditTextBoldCursor editTextBoldCursor2 = this.f38680b[i15];
            if (i15 == 0 && i10 == 0) {
                z10 = true;
            } else {
                z10 = false;
            ...
            this.f38680b[i15].setOnFocusChangeListener(new pd(zc0Var, 3));
            if (z10) {
                LinearLayout linearLayout = new LinearLayout(context);
                linearLayout.setOrientation(0);
                linearLayout.setGravity(16);
                linearLayout.addView(this.f38680b[i15], w7.x5.l(1.0f, 0, -2));
                ImageView imageView = new ImageView(context);
                this.f38683f = imageView;
                imageView.setImageResource(R.drawable.msg_message);
                AndroidUtilities.updateViewVisibilityAnimated(imageView, true, 0.1f, false);
                imageView.setOnClickListener(new View.OnClickListener(this) {
                    public final me0 f37347b;
                    ...
                    public final void onClick(View view) {
                        ...
                        switch (r2) {
                            case 0:
                                me0 me0Var = this.f37347b;
                                ImageView imageView2 = me0Var.f38683f;
                                EditTextBoldCursor[] editTextBoldCursorArr = me0Var.f38680b;
                                me0Var.f38689y = !me0Var.f38689y;
                                ...
                                imageView2.setTag(Boolean.valueOf(me0Var.f38689y));
                                if (me0Var.f38689y) {
                                    i16 = org.telegram.ui.ActionBar.j6.f20810l6;
                                } else {
                                ...
                                return;
                            default:
                                me0 me0Var2 = this.f37347b;
                                if (me0Var2.f38688x == 0) {
                                    me0Var2.o(null, null);
                                    return;
                                } else {
                                    me0Var2.o(me0Var2.f38684n, null);
                                    return;
                                }
                        }
                    }
                ...
                zc0Var.addView(this.f38680b[i15], w7.x5.c(-2.0f, -1));
            }
            zc0Var.e(this.f38680b[i15]);
            addView(zc0Var, w7.x5.t(-1, -2, 1, 16, 16, 16, 0));
            this.f38680b[i15].setOnEditorActionListener(new TextView.OnEditorActionListener() {
                @Override
    ...
    public final void h(String str) {
        if (!this.f38687w) {
            EditTextBoldCursor[] editTextBoldCursorArr = this.f38680b;
            ...
            if (length == 0) {
                ...
                bundle.putString("password", this.f38685r);
    ...
    @Override
    public final void j() {
        AndroidUtilities.runOnUIThread(new g10(this, 18), wg0.f42359t0);
    }

    @Override
    public final void k(Bundle bundle) {
        Bundle bundle2 = bundle.getBundle("recoveryview_params" + this.f38688x);
        this.v = bundle2;
        if (bundle2 != null) {
            m(bundle2, true);
        }
    ...
    public final void l(Bundle bundle) {
        if (this.v != null) {
            bundle.putBundle("recoveryview_params" + this.f38688x, this.v);
        }
    }
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        int i10 = 0;
        while (true) {
            editTextBoldCursorArr = this.f38680b;
        ...
        if (string != null) {
            ...
            this.f38686s = TLdeserialize;
            TwoStepVerificationActivity.m0(TLdeserialize);
        }
        this.f38684n = this.v.getString("new_password");
    ...
    public final void n() {
        EditTextBoldCursor[] editTextBoldCursorArr;
        int i10;
        this.f38681c.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.G6, false));
        this.d.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.D6, false));
        for (EditTextBoldCursor editTextBoldCursor : this.f38680b) {
            editTextBoldCursor.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.G6, false));
            editTextBoldCursor.setCursorColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20810l6, false));
        }
        for (org.telegram.ui.Components.zc0 zc0Var : this.f38679a) {
            zc0Var.f();
        }
        this.f38682e.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.q6, false));
        ImageView imageView = this.f38683f;
        if (imageView != null) {
            if (this.f38689y) {
                i10 = org.telegram.ui.ActionBar.j6.f20810l6;
            } else {
                i10 = org.telegram.ui.ActionBar.j6.H6;
            }
            imageView.setColorFilter(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
            imageView.setBackground(org.telegram.ui.ActionBar.j6.f0(this.E.getThemedColor(org.telegram.ui.ActionBar.j6.f20754i6), 1, -1));
        }
    }
    ...
    public final void o(String str, String str2) {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            passwordinputsettings.new_algo = this.f38686s.new_algo;
        }
