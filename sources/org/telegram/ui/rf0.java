...
public final class rf0 extends org.telegram.ui.Components.vv0 implements NotificationCenter.NotificationCenterDelegate {
    public static final int f38014q0 = 0;
    ...
    public double V;
    public boolean W;
    public final org.telegram.ui.Components.gj0 f38015a;
    public boolean f38016a0;
    public String f38017b;
    public String f38018b0;
    public String f38019c;
    public final int f38020c0;
    public String d;
    public int f38021d0;
    public String e;
    public int f38022e0;
    public final yr f38023f;
    public boolean f38024f0;
    public String f38025g0;
    public final org.telegram.ui.Components.voip.n2 h;
    public String f38026h0;
    public String f38027i0;
    public int f38028j0;
    public String f38029k0;
    public Bundle f38030l0;
    public TLRPC.TL_auth_sentCode m0;
    public final TextView f38031n;
    public boolean f38032n0;
    public final ef0 f38033o0;
    public final ng0 f38034p0;
    public final TextView f38035r;
    public final org.telegram.ui.Components.jj0 f38036s;
    public final pf0 v;
    public final xd0 f38037w;
    public final pf0 f38038x;
    public final FrameLayout f38039y;

    public rf0(org.telegram.ui.ng0 r39, android.content.Context r40, int r41) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.rf0.<init>(org.telegram.ui.ng0, android.content.Context, int):void");
    }

    public static void o(rf0 rf0Var, Context context) {
        String str;
        String str2;
        String str3;
        ...
        try {
            ...
            sb2.append(str3);
            sb2.append("\n");
            if (!TextUtils.isEmpty(rf0Var.f38018b0)) {
                sb2.append("Error: ");
                sb2.append(rf0Var.f38018b0);
                sb2.append("\n");
            }
            sb2.append("\n\n================================================\n");
            ...
            rf0Var.f38034p0.l1(LocaleController.getString(R.string.AppName), LocaleController.getString("NoMailInstalled", R.string.NoMailInstalled));
        }
    }
    ...
    public final void A(int i10) {
        ...
        if (gj0Var != null) {
            ...
            this.N = true;
            org.telegram.ui.Components.gj0 gj0Var2 = this.f38015a;
            if (gj0Var2.Y != gj0Var2.e[0] - 1) {
                gj0Var2.f25168r0 = new kf0(this, i10, 0);
                return;
            }
            gj0Var.f25168r0 = new ef0(this, 3);
            org.telegram.ui.Components.jj0 jj0Var = this.f38036s;
    ...
    public final boolean c(boolean z4) {
        int i10;
        ng0 ng0Var = this.f38034p0;
        if (ng0Var.C != 0) {
            ng0Var.finishFragment();
            return false;
        }
        int i11 = this.f38022e0;
        if (i11 != 0) {
            ng0Var.u1(i11, true, null, true);
            return false;
        } else if (!z4) {
            ...
            d2Var.O = string;
            d2Var.Q = AndroidUtilities.replaceTags(LocaleController.formatString("EditNumberInfo", R.string.EditNumberInfo, this.f38017b));
            alertDialog$Builder.k(LocaleController.getString(R.string.Close), null);
            alertDialog$Builder.h(LocaleController.getString(R.string.Edit), new gf0(this, 0));
            ...
            tL_auth_cancelCode.phone_code_hash = this.f38019c;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (this.W) {
            yr yrVar = this.f38023f;
            if (yrVar.f40565f != null) {
                if (i10 == NotificationCenter.didReceiveSmsCode) {
                    yrVar.setText("" + objArr[0]);
                    h(null);
                } else if (i10 == NotificationCenter.didReceiveCall) {
                    String str = "" + objArr[0];
                    if (AndroidUtilities.checkPhonePattern(this.f38025g0, str)) {
                        if (!this.f38025g0.equals("*")) {
                            this.f38027i0 = str;
    ...
    public final void g() {
        ...
        this.f38024f0 = false;
        this.f38016a0 = false;
        if (this.f38022e0 != 0 && (bundle = this.E) != null) {
    ...
    public final void h(String str) {
        ...
        int i12;
        ng0 ng0Var = this.f38034p0;
        int i13 = ng0Var.f36622a;
        if (i13 == 11) {
            if (this.f38016a0) {
                return;
            }
        } else if (!this.f38016a0) {
        ...
        int i15 = ng0Var.f36622a;
        if (i15 < 1 || i15 > 4 || !yrVar.e) {
            this.f38016a0 = true;
            int i16 = this.f38020c0;
            if (i16 == 15) {
                NotificationCenter.getGlobalInstance().removeObserver(this, NotificationCenter.didReceiveSmsCode);
            } else if (i16 == 2) {
                AndroidUtilities.setWaitingForSms(false);
            ...
            if (i17 != 1) {
                if (i17 != 2) {
                    ...
                    tL_auth_signIn.phone_code_hash = this.f38019c;
                ...
                changephone.phone_code_hash = this.f38019c;
                w();
                yrVar.e = true;
            ...
            confirmphone.phone_code_hash = this.f38019c;
            w();
            yrVar.e = true;
            bs[] bsVarArr3 = yrVar.f40565f;
    ...
    @Override
    public final void j() {
        org.telegram.ui.Components.gj0 gj0Var = this.f38015a;
        if (gj0Var != null) {
            gj0Var.K(0);
        }
        AndroidUtilities.runOnUIThread(new ef0(this, 0), ng0.f36621q0);
    }
    ...
    public final void l(Bundle bundle) {
        String code = this.f38023f.getCode();
        int length = code.length();
        int i10 = this.f38020c0;
        if (length != 0) {
            bundle.putString("smsview_code_" + i10, code);
        }
        String str = this.f38027i0;
        if (str != null) {
    ...
    public final void m(android.os.Bundle r22, boolean r23) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.rf0.m(android.os.Bundle, boolean):void");
    }
    ...
    public final void n() {
        ...
        if (i12 == 11) {
            ...
            int w03 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20049l6, false);
        ...
        if (i12 != 15) {
            this.f38038x.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20140q6, false));
        }
        this.B.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20141q7, false));
    }
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        yr yrVar = this.f38023f;
        if (yrVar != null && (bsVarArr = yrVar.f40565f) != null) {
            for (bs bsVar : bsVarArr) {
                ...
                bsVar.setShowSoftInputOnFocusCompat(z4);
            }
        }
    }
    ...
    public final void q(Runnable runnable) {
        ...
        while (true) {
            ...
            if (i10 < bsVarArr.length) {
                ...
                yrVar.postDelayed(new fe0(8, this, runnable), (bsVarArr.length * 75) + 400);
                return;
            }
        }
    }
    ...
    public final void x() {
        int i10;
        if (!this.f38016a0 && !this.f38024f0) {
            ng0 ng0Var = this.f38034p0;
            if (!ng0Var.f36637l0) {
                this.f38024f0 = true;
                this.v.invalidate();
                this.f38038x.invalidate();
                Bundle bundle = new Bundle();
                bundle.putString("phone", this.f38017b);
                bundle.putString("ephone", this.e);
                bundle.putString("phoneFormated", this.d);
                bundle.putInt("prevType", this.f38020c0);
                this.f38016a0 = true;
                TLRPC.TL_auth_resendCode tL_auth_resendCode = new TLRPC.TL_auth_resendCode();
                tL_auth_resendCode.phone_number = this.d;
                tL_auth_resendCode.phone_code_hash = this.f38019c;
                i10 = ((org.telegram.ui.ActionBar.p2) ng0Var).currentAccount;
    ...
    public final void y() {
        ...
        while (true) {
            ...
            yrVar.f40565f[i10].i(1.0f);
            i10++;
        }
        xd0 xd0Var = this.f38037w;
        if (xd0Var.getCurrentView() != this.B) {
            xd0Var.showNext();
        }
        yrVar.f40565f[0].requestFocus();
        if (this.f38020c0 == 11) {
            f10 = 3.5f;
        } else {
            f10 = 10.0f;
        }
        AndroidUtilities.shakeViewSpring(yrVar, f10, new ef0(this, 7));
        ef0 ef0Var = this.f38033o0;
