...
public final class r21 extends View {
    ...
    public String R;
    public boolean S;
    public final org.telegram.ui.Components.bc0 f36664a;
    public final Paint f36665b;
    public final BitmapShader f36666c;
    public final BitmapShader d;
    public i21 e;
    public Bitmap f36667f;
    public Bitmap h;
    public Bitmap f36668n;
    public boolean f36669r;
    public final org.telegram.ui.Components.jo0 f36670s;
    public TextPaint v;
    public StaticLayout f36671w;
    public final org.telegram.ui.Components.e6 f36672x;
    public final Paint f36673y;
    ...
    public r21(Context context) {
        ...
        this.f36672x = new org.telegram.ui.Components.e6(1.0f, this, 0L, 2000L, rrVar);
        ...
        bc0Var.N = true;
        bc0Var.r(this);
        Bitmap bitmap = bc0Var.f22686k;
        Shader.TileMode tileMode = Shader.TileMode.MIRROR;
        BitmapShader bitmapShader = new BitmapShader(bitmap, tileMode, tileMode);
        this.f36666c = bitmapShader;
        BitmapShader bitmapShader2 = new BitmapShader(bc0Var.f22686k, tileMode, tileMode);
        ...
        jo0Var.f26613a.setShader(bitmapShader2);
        jo0Var.f26614b = 17;
    ...
    public final void a(Canvas canvas) {
        ...
        if (this.F != null) {
            ...
            if (!this.M && (i21Var = this.e) != null) {
                x21 x21Var = i21Var.f33971a;
                x21Var.f39171c.set((int) (width2 - round), (int) (width3 - round), (int) (width2 + round), (int) (width3 + round));
    ...
    public final void b(int r25, int r26) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.r21.b(int, int):void");
    }
    ...
    public final void d(boolean z10) {
        ...
        if (z10) {
            ...
            this.f36671w = org.telegram.ui.Components.jw0.c(Emoji.replaceEmoji(str, this.v.getFontMetricsInt(), false), this.v, getWidth(), Layout.Alignment.ALIGN_CENTER, 0.0f, false, TextUtils.TruncateAt.END, getWidth() - AndroidUtilities.dp(60.0f), 1, true);
            return;
        }
        this.f36671w = null;
    }
    ...
    public final void onDraw(android.graphics.Canvas r20) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.r21.onDraw(android.graphics.Canvas):void");
    }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        this.f36667f = Bitmap.createBitmap(i10, i11, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(this.f36667f);
        float f10 = i10;
        ...
        float max = Math.max((getWidth() * 1.0f) / this.f36664a.f22686k.getWidth(), (getHeight() * 1.0f) / this.f36664a.f22686k.getHeight());
        Matrix matrix = new Matrix();
        matrix.setScale(max, max);
        this.f36666c.setLocalMatrix(matrix);
