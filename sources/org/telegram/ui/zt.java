...
public final class zt extends org.telegram.ui.Components.bb {
    ...
    public final ci.d Y;
    public final ci.d Z;
    public final ArrayList f40241a0;
    public final HashSet f40242b0;
    public boolean f40243c0;
    public org.telegram.ui.Components.v51 f40244d0;

    public zt(Activity activity, HashSet hashSet) {
        super(activity, null, false, false, new ai.d());
        ArrayList arrayList = new ArrayList();
        this.f40241a0 = arrayList;
        HashSet hashSet2 = new HashSet();
        this.f40242b0 = hashSet2;
        ...
        imageView.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        this.f39888b.dismiss();
                        return;
                    case 1:
                        this.f39888b.S(false);
                        return;
                    default:
                        this.f39888b.S(true);
                        return;
        ...
        org.telegram.ui.Components.v51 v51Var = this.f40244d0;
        if (v51Var != null) {
            v51Var.N(false);
        }
        s4.j jVar = new s4.j();
    ...
    public static void Q(zt ztVar, TLObject tLObject, ci.d dVar, boolean z10, HashSet hashSet, TLRPC.TL_error tL_error) {
        if (tLObject instanceof TLRPC.Updates) {
            ...
            if (groupCall != null && LaunchActivity.G1 != null) {
                ...
                ztVar.dismiss();
                org.telegram.ui.Components.voip.f2.g(LaunchActivity.G1, ztVar.currentAccount, tL_inputGroupCall, z10, groupCall, hashSet);
                return;
            }
            ztVar.f40243c0 = false;
            ...
            ztVar.dismiss();
            org.telegram.ui.Components.voip.f2.g(LaunchActivity.G1, ztVar.currentAccount, tL_inputGroupCall2, z10, groupcall.call, hashSet);
    ...
    public static void R(zt ztVar, ArrayList arrayList) {
        ...
        ArrayList arrayList2 = ztVar.f40241a0;
