...
public final class zt extends org.telegram.ui.Components.il0 {
    public final Context f40341r;
    public final HashMap f40342s = new HashMap();
    public final ArrayList v = new ArrayList();
    public final cu f40343w;

    public zt(cu cuVar, Context context, ArrayList arrayList, boolean z10) {
        Comparator lb1Var;
        Locale locale;
        this.f40343w = cuVar;
        this.f40341r = context;
        if (arrayList != null) {
            for (int i10 = 0; i10 < arrayList.size(); i10++) {
                xt xtVar = (xt) arrayList.get(i10);
                String upperCase = xtVar.f39700a.substring(0, 1).toUpperCase();
                ArrayList arrayList2 = (ArrayList) this.f40342s.get(upperCase);
                if (arrayList2 == null) {
                    arrayList2 = new ArrayList();
                    this.f40342s.put(upperCase, arrayList2);
            ...
            try {
                ...
                while (true) {
                    ...
                    if (!str.equals("FT") || !z10) {
                        String upperCase2 = obj.f39700a.substring(0, 1).toUpperCase();
                        ArrayList arrayList3 = (ArrayList) this.f40342s.get(upperCase2);
                        if (arrayList3 == null) {
                            arrayList3 = new ArrayList();
                            this.f40342s.put(upperCase2, arrayList3);
        ...
        for (ArrayList arrayList4 : this.f40342s.values()) {
    ...
    public final int M(int i10) {
        ArrayList arrayList = this.v;
        int size = ((ArrayList) this.f40342s.get(arrayList.get(i10))).size();
    ...
    public final int P(int i10, int i11) {
        if (i11 < ((ArrayList) this.f40342s.get(this.v.get(i10))).size()) {
            return 0;
        }
        return 1;
    }
    ...
    public final void W(int i10, int i11, s4.c1 c1Var) {
        String str;
        if (c1Var.f42705f == 0) {
            xt xtVar = (xt) ((ArrayList) this.f40342s.get(this.v.get(i10))).get(i11);
    ...
    public final xt O(int i10, int i11) {
        if (i10 >= 0) {
            ...
            if (i10 < arrayList.size()) {
                ArrayList arrayList2 = (ArrayList) this.f40342s.get(arrayList.get(i10));
