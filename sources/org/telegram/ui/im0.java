...
public final class im0 implements RequestDelegate {
    public final um0 f34543a;
    public final String f34544b;
    public final TL_account.saveSecureValue f34545c;
    public final TLRPC.TL_secureRequiredType d;
    public final TLRPC.TL_secureRequiredType e;
    public final ArrayList f34546f;
    public final SecureDocument f34547g;
    public final SecureDocument h;
    public final SecureDocument f34548i;
    public final ArrayList f34549j;
    public final String f34550k;
    public final String f34551l;
    public final Runnable f34552m;
    public final jm0 f34553n;
    public final TLRPC.TL_inputSecureValue f34554o;
    public final jm0 f34555p;
    ...
    public im0(jm0 jm0Var, um0 um0Var, String str, TL_account.saveSecureValue savesecurevalue, TLRPC.TL_secureRequiredType tL_secureRequiredType, TLRPC.TL_secureRequiredType tL_secureRequiredType2, ArrayList arrayList, SecureDocument secureDocument, SecureDocument secureDocument2, SecureDocument secureDocument3, ArrayList arrayList2, String str2, String str3, Runnable runnable, jm0 jm0Var2, TLRPC.TL_inputSecureValue tL_inputSecureValue) {
        ...
        this.f34543a = um0Var;
        this.f34544b = str;
        this.f34545c = savesecurevalue;
        this.d = tL_secureRequiredType;
        this.e = tL_secureRequiredType2;
        this.f34546f = arrayList;
        this.f34547g = secureDocument;
        this.h = secureDocument2;
        this.f34548i = secureDocument3;
        this.f34549j = arrayList2;
        this.f34550k = str2;
        this.f34551l = str3;
        this.f34552m = runnable;
        this.f34553n = jm0Var2;
        this.f34554o = tL_inputSecureValue;
    }
    ...
    public final void a(final TLRPC.TL_error tL_error, final TLRPC.TL_secureValue tL_secureValue, final TLRPC.TL_secureValue tL_secureValue2) {
        jm0 jm0Var = this.f34555p;
        final boolean z10 = jm0Var.f34832b;
        final int i10 = jm0Var.f34833c;
        final um0 um0Var = this.f34543a;
        final String str = this.f34544b;
        final TL_account.saveSecureValue savesecurevalue = this.f34545c;
        ...
        final ArrayList arrayList = this.f34546f;
        final SecureDocument secureDocument = this.f34547g;
        final SecureDocument secureDocument2 = this.h;
        final SecureDocument secureDocument3 = this.f34548i;
        final ArrayList arrayList2 = this.f34549j;
        final String str2 = this.f34550k;
        final String str3 = this.f34551l;
        final Runnable runnable = this.f34552m;
        AndroidUtilities.runOnUIThread(new Runnable() {
            ...
            public final void run() {
                ...
                if (tL_secureValue3 != null) {
                    gn0Var2.f34023y.values.add(tL_secureValue3);
                }
                TLRPC.TL_secureValue tL_secureValue4 = tL_secureValue2;
                if (tL_secureValue4 != null) {
                    gn0Var2.f34023y.values.add(tL_secureValue4);
                }
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null) {
            ...
            if (equals) {
                ...
                ConnectionsManager.getInstance(i11).sendRequest(sendverifyemailcode, new ci.hd(this, this.f34544b, this.e, this.f34553n, this.f34543a, 10));
                return;
            }
            im0Var = this;
            if (tL_error.text.equals("PHONE_VERIFICATION_NEEDED")) {
                AndroidUtilities.runOnUIThread(new jf0(im0Var.f34543a, tL_error, str, 11));
                return;
            }
        } else {
            im0Var = this;
        }
        if (tL_error == null && (tL_inputSecureValue = im0Var.f34554o) != null) {
            TL_account.saveSecureValue savesecurevalue = new TL_account.saveSecureValue();
            savesecurevalue.value = tL_inputSecureValue;
            savesecurevalue.secure_secret_id = gn0Var.f33973b1;
