...
public final class zv0 extends org.telegram.ui.Cells.c6 {
    ...
    public final boolean e() {
        ...
        if (U != null) {
            int b10 = U.b();
            int i10 = cw0Var.f32962y;
            if (i10 == cw0Var.f32946n && b10 == (cw0Var.f32947n0 + i10) - 1) {
                return false;
            }
        }
        return true;
    ...
    public final boolean f(org.telegram.ui.Cells.c6 c6Var) {
        ...
        if (U != null && (b10 = U.b()) != -1) {
            return cw0Var.f32958w[b10 - cw0Var.f32947n0];
        }
        return false;
    }
    ...
    public final void g(org.telegram.ui.Cells.b6 b6Var, ActionMode actionMode) {
        if (b6Var.isFocused() && b6Var.hasSelection()) {
            ...
            if (menu.findItem(16908321) != null) {
                bo.k8(menu, this.F.d.f32938f.h, false, true, true, true);
            }
        }
    }
    ...
    public final void h(org.telegram.ui.Cells.c6 c6Var, boolean z10) {
        ...
        cw0 cw0Var = this.F.d;
        if (z10 && cw0Var.L) {
            Arrays.fill(cw0Var.f32958w, false);
            cw0Var.f32934c.getChildCount();
            for (int i10 = cw0Var.f32947n0; i10 < cw0Var.f32947n0 + cw0Var.f32962y; i10++) {
                s4.c1 L = cw0Var.f32934c.L(i10);
                if (L != null) {
                    View view = L.f42697a;
        ...
        if (U != null && (b10 = U.b()) != -1) {
            cw0Var.f32958w[b10 - cw0Var.f32947n0] = z10;
        }
        cw0Var.i0();
    }
    ...
    public final boolean l(ArrayList arrayList) {
        ...
        if (!arrayList.isEmpty()) {
            cw0Var.f32934c.getClass();
            int S = RecyclerView.S(this) - cw0Var.f32947n0;
            if (S >= 0) {
