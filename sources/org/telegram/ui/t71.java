...
public final class t71 extends FrameLayout {
    public final ImageView f41454a;
    public final TextView f41455b;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f41457e) {
            canvas.drawRect(AndroidUtilities.dp(64.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight(), org.telegram.ui.ActionBar.k6.f21781k0);
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (r02 != null) {
            ...
            sb.append((Object) this.f41455b.getText());
            sb.append("\n");
            sb.append((Object) this.f41456c.getText());
            sb.append("\n");
            if (r02.h) {
