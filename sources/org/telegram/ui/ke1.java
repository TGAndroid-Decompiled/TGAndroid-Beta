...
public final class ke1 extends Dialog {
    ...
    public float Y;
    public boolean Z;
    public final org.telegram.ui.ActionBar.e6 f35069a;
    public boolean f35070a0;
    public final he1 f35071b;
    public boolean f35072b0;
    public final he1 f35073c;
    public wm f35074c0;
    public final he1 d;
    public ValueAnimator f35075d0;
    public final ci.i1 e;
    public ValueAnimator f35076e0;
    public final TextView f35077f;
    public final org.telegram.ui.Components.cc0 h;
    public i0.b f35078n;
    public Bitmap f35079r;
    public BitmapShader f35080s;
    public Paint v;
    public Matrix f35081w;
    ...
    public ke1(Activity activity, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.F = cVar;
        cVar.f425f = new hh.k(he1Var);
        cVar.f426g = he1Var;
        he1 he1Var2 = new he1(this, activity, 1);
        this.f35073c = he1Var2;
    ...
    public final void b(boolean z10, org.telegram.ui.Components.es0 es0Var) {
        float f7;
        long j3;
        ValueAnimator valueAnimator = this.f35075d0;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ValueAnimator valueAnimator2 = this.f35076e0;
        if (valueAnimator2 != null) {
            valueAnimator2.cancel();
        }
        d();
        float f10 = this.f35082x;
        float f11 = 0.0f;
        if (z10) {
            f7 = 1.0f;
        } else {
        ...
        this.f35075d0 = ofFloat;
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
            public final ke1 f32954b;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                switch (r2) {
                    case 0:
                        ...
                        ke1 ke1Var = this.f32954b;
                        ke1Var.f35082x = floatValue;
                        ke1Var.f35071b.invalidate();
                        ke1Var.f35073c.invalidate();
                        ke1Var.e();
                        return;
                    default:
                        ke1 ke1Var2 = this.f32954b;
                        ke1Var2.getClass();
                        ke1Var2.f35083y = ((Float) valueAnimator3.getAnimatedValue()).floatValue();
                        return;
                }
            }
        });
        this.f35075d0.addListener(new androidx.fragment.app.g(this, z10, es0Var, 11));
        if (!z10) {
            j3 = 330;
        } else {
            j3 = 520;
        }
        ValueAnimator valueAnimator3 = this.f35075d0;
        org.telegram.ui.Components.qr qrVar = org.telegram.ui.Components.qr.h;
        valueAnimator3.setInterpolator(qrVar);
        this.f35075d0.setDuration(j3);
        this.f35075d0.start();
        float f12 = this.f35083y;
        if (z10) {
            f11 = 1.0f;
        }
        ValueAnimator ofFloat2 = ValueAnimator.ofFloat(f12, f11);
        this.f35076e0 = ofFloat2;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator32) {
                switch (r2) {
                    ...
                    default:
                        ke1 ke1Var2 = this.f32954b;
                        ke1Var2.getClass();
                        ke1Var2.f35083y = ((Float) valueAnimator32.getAnimatedValue()).floatValue();
                        return;
                }
            }
        });
        this.f35076e0.addListener(new h70(10, this, z10));
        this.f35076e0.setDuration(((float) j3) * 1.5f);
        this.f35076e0.setInterpolator(qrVar);
        this.f35076e0.start();
    }
    ...
    public final void c(boolean z10) {
        ...
        if (z10 && (qk0Var = this.P) != null && qk0Var.getReactionsWindow() != null && !this.P.getReactionsWindow().f49239q) {
            this.P.e();
        } else if (this.f35070a0) {
        } else {
            this.f35070a0 = true;
            this.W = false;
            ci.i1 i1Var = this.e;
    ...
    public final void e() {
        ...
        if (viewGroup2 != null) {
            ...
            this.S.setAlpha(this.f35082x);
            float lerp3 = AndroidUtilities.lerp(0.75f, 1.0f, this.f35082x);
        ...
        if (this.Q != null) {
            ...
            this.Q.setAlpha(this.f35082x);
            float lerp4 = AndroidUtilities.lerp(0.75f, 1.0f, this.f35082x);
            this.Q.setScaleX(lerp4);
            this.Q.setScaleY(lerp4);
        }
        if (this.f35072b0) {
            this.J.setAlpha(this.f35082x);
            this.I.setAlpha(this.f35082x);
        }
        if (this.P != null) {
