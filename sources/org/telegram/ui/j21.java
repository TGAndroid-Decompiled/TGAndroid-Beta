...
public final class j21 extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i10) {
        ...
        if (i10 == 1 && o21Var.getParentActivity() != null) {
            ...
            a2.f15239a = i11;
            String obj = o21Var.f36088a[0].getText().toString();
            String str4 = "";
            if (obj == null) {
                obj = "";
            }
            ...
            if (o21Var.v == 3) {
                ...
                intValue = Utilities.parseInt((CharSequence) o21Var.f36088a[1].getText().toString()).intValue();
            }
            a2.f15241c = intValue;
            if (o21Var.v != 1) {
                str = "";
            } else {
                str = o21Var.f36088a[2].getText().toString();
            }
            if (str == null) {
                str = "";
            }
            ...
            if (o21Var.v != 1) {
                ...
                str2 = o21Var.f36088a[3].getText().toString();
            }
            if (str2 == null) {
                str2 = "";
            }
            ...
            if (o21Var.v == 1) {
                ...
                str3 = o21Var.f36088a[4].getText().toString();
            }
            if (str3 != null) {
                str4 = str3;
            }
