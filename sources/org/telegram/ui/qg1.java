...
public final class qg1 extends ViewGroup {
    public final Paint f37754a;
    public View f37755b;
    public boolean f37756c;

    public qg1(Context context) {
        super(context);
        this.f37754a = new Paint(1);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int h = i0.a.h(org.telegram.ui.ActionBar.j6.l1(navigationBarThirdButtonsFactor, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19906d6, false)), w02);
        Paint paint = this.f37754a;
        paint.setColor(w02);
