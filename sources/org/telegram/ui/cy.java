...
public final class cy {
        ...
        if (eo0Var.N && eo0Var.P()) {
            ...
            alertDialog$Builder.k(LocaleController.getString(R.string.Clear), new org.telegram.ui.ActionBar.z1(this) {
                ...
                public final void f(org.telegram.ui.ActionBar.a2 a2Var, int i11) {
                    switch (r2) {
                        case 0:
                            this.f32255b.f32817a.C0.f26151b0.E();
                            return;
                        default:
                            qy qyVar2 = this.f32255b.f32817a;
                            if (qyVar2.C0.f26151b0.P()) {
                                qyVar2.C0.f26151b0.E();
                                return;
                            }
                            org.telegram.ui.Components.eo0 eo0Var3 = qyVar2.C0.f26151b0;
                            eo0Var3.f9754j0.c();
                            eo0Var3.J.clear();
                            eo0Var3.l();
                            return;
    ...
    public final void c() {
        ...
        if (zxVar != null) {
            org.telegram.ui.Components.bl0 bl0Var = zxVar.f26153d0;
            int i11 = zxVar.S0;
            if (i11 > 0) {
                i10 = i11 + 1;
            } else {
    ...
    public final void d(boolean z10, boolean z11) {
        ...
        if (qyVar.f37061j2 && qyVar.f37065k2) {
            zx zxVar = qyVar.C0;
            if (zxVar.W != null) {
                if (!z10 && zxVar.f26151b0.h() == 0) {
