...
public final class cy implements ah.k, org.telegram.ui.Components.vn0, org.telegram.ui.Components.dl0, ci.fc, org.telegram.ui.Components.a20 {
        ...
        switch (this.f32967a) {
            case 0:
                ...
                if (SharedConfig.chatBlurEnabled()) {
                    ...
                    if (fg1Var != null && fg1Var.getFragmentView() != null && !wyVar.f39243j2 && (dVar = fg1Var.f33653g1) != null) {
                        canvas.save();
            ...
            default:
                ...
                if (SharedConfig.chatBlurEnabled()) {
                    ...
                    if (fg1Var2 != null && fg1Var2.getFragmentView() != null && !wyVar2.f39243j2 && (dVar2 = fg1Var2.f33655h1) != null) {
                        canvas.save();
    ...
    public boolean mo18c(float f7, float f10, int i10, View view) {
        ...
        gy gyVar = wyVar.C0;
        ai.w0 w0Var = gyVar.W;
        return wyVar.o4(view, i10, f7, gyVar.f30548c0);
    }
    ...
    public void d(long j3, ai.j jVar) {
        ...
        if (wyVar.E0 != null) {
            ...
            wyVar.f39215e0[0].f38522a.getViewTreeObserver().addOnPreDrawListener(new hm(1, this, jVar));
            return;
        }
        jVar.run();
    }
    ...
    public void e(float f7) {
        ...
        if (point.x > point.y) {
            this.f32968b.movePreviewFragment(f7);
        }
    }

    @Override
    public void f(org.telegram.ui.Cells.r2 r2Var) {
        this.f32968b.H4(r2Var);
    }
    ...
    public void finish() {
        Point point = AndroidUtilities.displaySize;
        if (point.x > point.y) {
            this.f32968b.finishPreviewFragment();
        }
    }
    ...
    public void h(gg.q0 q0Var) {
        ...
        if (gyVar != null) {
            ...
            gy gyVar2 = wyVar.C0;
            String obj = wyVar.f39241j0.getSearchField().getText().toString();
        ...
        wyVar.Y.f46843a.q(wyVar.X.f22543r);
    }
        ...
        switch (this.f32967a) {
            case 0:
                ...
                if (SharedConfig.chatBlurEnabled()) {
                    ...
                    if (fg1Var != null && fg1Var.getFragmentView() != null && !wyVar.f39243j2) {
                        aVar.f417a = true;
                        return;
                    }
                    return;
            ...
            default:
                ...
                if (SharedConfig.chatBlurEnabled()) {
                    ...
                    if (fg1Var2 != null && fg1Var2.getFragmentView() != null && !wyVar2.f39243j2) {
                        aVar.f417a = true;
                        return;
                    }
                    return;
