...
public final class vc1 implements org.telegram.ui.ActionBar.e6 {
    public org.telegram.ui.ActionBar.e6 f38453a;
    public final SparseIntArray f38454b = new SparseIntArray();
    public final Paint f38455c = new Paint(3);
    public final Paint d = new Paint(3);
    public final Paint e;
    public final TextPaint f38456f;
    public final TextPaint h;
    public final TextPaint f38457n;
    public Bitmap f38458r;
    public BitmapShader f38459s;
    public Matrix v;
    public final vd1 f38460w;
    public final vd1 f38461x;
    ...
    public vc1(vd1 vd1Var) {
        ...
        this.f38456f = textPaint;
        TextPaint textPaint2 = new TextPaint();
        this.h = textPaint2;
        TextPaint textPaint3 = new TextPaint();
        this.f38457n = textPaint3;
    ...
    public final Paint G(String str) {
        ...
        switch (c10) {
            ...
            case 5:
                return this.f38456f;
            default:
                org.telegram.ui.ActionBar.e6 e6Var = this.f38453a;
                if (e6Var != null) {
                    return e6Var.G(str);
                }
    ...
    public final boolean a() {
        md1 md1Var = this.f38461x.f38510p1;
        if (md1Var != null) {
            return md1Var.a();
        }
        md1 md1Var2 = this.f38460w.f38510p1;
        if (md1Var2 != null) {
            return md1Var2.a();
        }
        org.telegram.ui.ActionBar.e6 e6Var = this.f38453a;
    ...
    public final void b(Drawable drawable, Drawable drawable2, Float f7) {
        ...
        float f12;
        float f13;
        int i10 = org.telegram.ui.ActionBar.j6.f19214lc;
        int G0 = G0(i10);
        int G02 = G0(org.telegram.ui.ActionBar.j6.f19233mc);
        if (drawable == null) {
            drawable = drawable2;
        }
        boolean z10 = drawable instanceof org.telegram.ui.Components.lc0;
        TextPaint textPaint = this.h;
        TextPaint textPaint2 = this.f38456f;
        if ((z10 || (drawable instanceof BitmapDrawable)) && SharedConfig.getDevicePerformanceClass() != 0 && LiteMode.isEnabled(32)) {
            if (z10) {
                bitmap = ((org.telegram.ui.Components.lc0) drawable).f26109k;
            } else if (drawable instanceof BitmapDrawable) {
                bitmap = ((BitmapDrawable) drawable).getBitmap();
            } else {
                bitmap = null;
            }
            if (this.f38458r != bitmap) {
                this.f38458r = bitmap;
                Bitmap bitmap2 = this.f38458r;
                Shader.TileMode tileMode = Shader.TileMode.CLAMP;
                this.f38459s = new BitmapShader(bitmap2, tileMode, tileMode);
                if (this.v == null) {
                    this.v = new Matrix();
                }
            }
            ...
            textPaint2.linkColor = G0(org.telegram.ui.ActionBar.j6.f19176jc);
        }
        Paint paint = this.f38455c;
        paint.setColor(G0);
        Paint paint2 = this.d;
        paint2.setColor(G02);
        if (this.f38459s != null && (this.f38454b.indexOfKey(i10) < 0 || z10 || (drawable instanceof BitmapDrawable))) {
            ColorMatrix colorMatrix = new ColorMatrix();
            if (z10) {
                float f14 = -0.06f;
                if (((org.telegram.ui.Components.lc0) drawable).f26115q >= 0.0f) {
            ...
            if (z10) {
                float f15 = ((org.telegram.ui.Components.lc0) drawable).f26115q;
                if (f7 != null) {
                    f15 = f7.floatValue();
                }
                if (f15 >= 0.0f) {
            ...
            paint.setShader(this.f38459s);
            paint.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
            paint.setAlpha(255);
            paint2.setShader(this.f38459s);
    ...
    public final void m(float f7, float f10, int i10, int i11) {
        ...
        Bitmap bitmap = this.f38458r;
        if (bitmap != null && (bitmapShader = this.f38459s) != null) {
