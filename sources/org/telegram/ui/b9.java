    ...
    public final void b(org.telegram.ui.Components.oc ocVar) {
        switch (this.f32076a) {
            ...
            case 2:
                ...
                bo boVar = (bo) this.f32077b;
                ch.d c10 = boVar.J.c(sbVar, null, true);
                dh.e eVar = new dh.e(boVar.f32279ea);
                eVar.e = new d2.c(4);
            ...
            case 3:
                return;
            case 4:
                wy wyVar = (wy) this.f32077b;
                UndoView undoView = wyVar.f39322y0[0];
                if (undoView != null && undoView.getVisibility() == 0) {
                    wyVar.f39322y0[0].e(2, true);
                    return;
                }
                return;
            case 5:
    ...
    public final void c(float f7) {
        switch (this.f32076a) {
            ...
            case 2:
                return;
            case 3:
                ContactsActivity contactsActivity = (ContactsActivity) this.f32077b;
                contactsActivity.f30770p0 = Math.max(0.0f, (f7 - contactsActivity.f30771q0) - contactsActivity.f30769o0);
                contactsActivity.i0();
                return;
            case 4:
                wy wyVar = (wy) this.f32077b;
                UndoView undoView = wyVar.f39322y0[0];
                if (undoView == null || undoView.getVisibility() != 0) {
                    wyVar.f39302u1 = Math.max(0.0f, (f7 - wyVar.f39231f4) - wyVar.f39246i4);
                    wyVar.X4();
                    return;
                }
                return;
    ...
    public final boolean e() {
        switch (this.f32076a) {
            ...
            case 7:
                return true;
            case 8:
                if (((ProfileActivity) this.f32077b).f31386s5 == null) {
                    return true;
                }
                return false;
            default:
    ...
    public final int f(int i10) {
        ...
        switch (this.f32076a) {
            case 0:
                ...
                break;
            case 1:
                return ((cd) this.f32077b).O.getMeasuredHeight();
            case 2:
                bo boVar = (bo) this.f32077b;
                if (i10 == 1) {
                    return 0;
                }
                return Math.round(boVar.S.getInputBubbleHeight() + AndroidUtilities.dp(16.0f) + boVar.W8(org.telegram.ui.Components.u21.f28265c) + boVar.v.c());
            case 3:
                ContactsActivity contactsActivity = (ContactsActivity) this.f32077b;
                i11 = contactsActivity.f30771q0;
                i12 = contactsActivity.f30769o0;
                break;
            case 4:
                wy wyVar = (wy) this.f32077b;
                if (wyVar.X2 != 0) {
                    return AndroidUtilities.dp(60.0f) + wyVar.f39231f4;
                }
                return wyVar.n3();
            case 5:
                i12 = ((gh0) this.f32077b).L;
                i11 = AndroidUtilities.dp(64.0f);
                break;
            case 6:
                PhotoViewer photoViewer = ((xu0) this.f32077b).E0;
                int i13 = 0;
                if (photoViewer.R4) {
                ...
                ai.x5 x5Var = photoViewer.f30989i0;
                if (x5Var != null && x5Var.getVisibility() == 0) {
                    i13 = (int) ((photoViewer.f30989i0.getAlpha() * photoViewer.f30989i0.getHeight()) + 0);
                }
                org.telegram.ui.Components.v30 v30Var = photoViewer.l1;
                if (v30Var != null && v30Var.c()) {
                    if (AndroidUtilities.isTablet() || photoViewer.f30954e0.getMeasuredHeight() > photoViewer.f30954e0.getMeasuredWidth()) {
                ...
                return i13;
            case 7:
                return ((PremiumPreviewFragment) this.f32077b).f31190o0.d;
            case 8:
                ProfileActivity profileActivity = (ProfileActivity) this.f32077b;
                if (profileActivity.f31386s5 == null) {
                    return profileActivity.f31338l6 + profileActivity.f31333k6;
                }
                return profileActivity.f31338l6 + profileActivity.f31333k6 + ((int) (((AndroidUtilities.dp(52.0f) - profileActivity.f31386s5.getTranslationY()) - (profileActivity.f31393t5[1].getTranslationY() * profileActivity.O.g0(9, false))) - (profileActivity.f31393t5[0].getTranslationY() * profileActivity.O.g0(8, true))));
            default:
                fg1 fg1Var = (fg1) this.f32077b;
                t41 t41Var = fg1Var.f33670o0;
                if (t41Var != null && t41Var.getVisibility() == 0) {
                    return fg1Var.f33670o0.getMeasuredHeight();
                }
                return 0;
        }
        return i11 + i12;
    ...
    public final int h(int i10) {
        ...
        switch (this.f32076a) {
            ...
            case 2:
                ...
                max2 = (int) Math.max(0.0f, boVar.f32464t9);
                break;
            case 3:
                return 0;
            case 4:
                ...
                if (uwVar != null && uwVar.getVisibility() == 0) {
                    i13 = wyVar.f39325z0.getMeasuredHeight();
                } else {
                    i13 = 0;
                }
                int i16 = i12 + i13;
