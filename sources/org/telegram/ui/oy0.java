...
public final class oy0 implements org.telegram.ui.ActionBar.i6 {
    ...
    public final org.telegram.ui.ActionBar.m2 f36354b;
    ...
    public final void b() {
        ...
        int i12 = 0;
        org.telegram.ui.ActionBar.m2 m2Var = this.f36354b;
        switch (i11) {
            case 0:
            ...
            case 1:
                ...
                org.telegram.ui.Components.wl0 wl0Var = n11Var.f35711a;
                if (wl0Var != null) {
                    int childCount = wl0Var.getChildCount();
                    while (i12 < childCount) {
                        View childAt = n11Var.f35711a.getChildAt(i12);
            ...
            case 2:
                ...
                if (f21Var.f33508a != null) {
                    int i13 = 0;
                    while (true) {
                        EditTextBoldCursor[] editTextBoldCursorArr = f21Var.f33508a;
                        if (i13 < editTextBoldCursorArr.length) {
                            editTextBoldCursorArr[i13].setLineColors(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19172k6, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19190l6, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19265p7, false));
                            i13++;
                        } else {
                            return;
                        }
            ...
            case 3:
                ...
                w21Var.getClass();
                w21Var.setNavigationBarColor(w21Var.getThemedColor(org.telegram.ui.ActionBar.h6.f18989a7));
                return;
            case 4:
                d31 d31Var = (d31) m2Var;
                d31Var.f32889a.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18989a7, false));
                d31Var.f32891c.l();
                return;
            case 5:
            ...
            case 6:
                ...
                for (int i17 = 0; i17 < themeActivity.f31823b.getChildCount(); i17++) {
                    View childAt2 = themeActivity.f31823b.getChildAt(i17);
                ...
                for (int i18 = 0; i18 < themeActivity.f31823b.getCachedChildCount(); i18++) {
                    View P = themeActivity.f31823b.P(i18);
                ...
                for (int i19 = 0; i19 < themeActivity.f31823b.getHiddenChildCount(); i19++) {
                    View V = themeActivity.f31823b.V(i19);
                ...
                while (i12 < themeActivity.f31823b.getAttachedScrapChildCount()) {
                    View O = themeActivity.f31823b.O(i12);
            ...
            case 8:
                ...
                org.telegram.ui.Components.wl0 wl0Var2 = le1Var.f35307a;
                if (wl0Var2 != null) {
                    int childCount3 = wl0Var2.getChildCount();
                    for (int i20 = 0; i20 < childCount3; i20++) {
                        View childAt3 = le1Var.f35307a.getChildAt(i20);
                        if (childAt3 instanceof org.telegram.ui.Cells.g4) {
                            ((org.telegram.ui.Cells.g4) childAt3).f(0);
                        }
                    }
                }
                org.telegram.ui.Components.wl0 wl0Var3 = le1Var.f35308b;
                if (wl0Var3 != null) {
                    int childCount4 = wl0Var3.getChildCount();
                    for (int i21 = 0; i21 < childCount4; i21++) {
                        View childAt4 = le1Var.f35308b.getChildAt(i21);
                        if (childAt4 instanceof org.telegram.ui.Cells.g4) {
                            ((org.telegram.ui.Cells.g4) childAt4).f(0);
                        }
                    }
                }
                le1Var.f35309c.setBackground(org.telegram.ui.ActionBar.w5.f(new float[]{4.0f}, org.telegram.ui.ActionBar.h6.Oh));
                le1Var.F.setProgressColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19116h6, false));
                return;
            case 9:
                wf1.X((wf1) m2Var);
                return;
