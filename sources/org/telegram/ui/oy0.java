...
public final class oy0 implements Runnable {
    ...
    public final ProfileActivity f36462b;
    public final TLRPC.TL_error f36463c;
    ...
    public oy0(ProfileActivity profileActivity, TLRPC.TL_error tL_error, TLObject tLObject, TLRPC.TL_channels_getParticipants tL_channels_getParticipants, int i10) {
        this.f36461a = i10;
        this.f36462b = profileActivity;
        this.f36463c = tL_error;
        this.d = tLObject;
    ...
    public final void run() {
        switch (this.f36461a) {
            case 0:
                ProfileActivity profileActivity = this.f36462b;
                profileActivity.getNotificationCenter().doOnIdle(new oy0(profileActivity, this.f36463c, this.d, this.e, 1));
                return;
            default:
                ProfileActivity profileActivity2 = this.f36462b;
                if (this.f36463c == null) {
                    ...
                    if (this.e.offset == 0) {
                        ...
                        profileActivity2.f31397u2.participants = new TLRPC.TL_chatParticipants();
                        ...
                        profileActivity2.getMessagesStorage().updateChannelUsers(profileActivity2.f31294f1, tL_channels_channelParticipants.participants);
                    }
                    for (int i10 = 0; i10 < tL_channels_channelParticipants.participants.size(); i10++) {
                        ...
                        if (profileActivity2.C1.h(peerId) < 0) {
                            TLRPC.ChatFull chatFull = profileActivity2.f31397u2;
                            if (chatFull.participants == null) {
                                chatFull.participants = new TLRPC.TL_chatParticipants();
                            }
                            profileActivity2.f31397u2.participants.participants.add(tL_chatChannelParticipant);
