...
public final class oy0 implements Runnable {
    ...
    public final ProfileActivity f36457b;
    public final TLRPC.TL_error f36458c;
    public final TLObject d;
    public final TLRPC.TL_channels_getParticipants e;

    public oy0(ProfileActivity profileActivity, TLRPC.TL_error tL_error, TLObject tLObject, TLRPC.TL_channels_getParticipants tL_channels_getParticipants, int i10) {
        this.f36456a = i10;
        this.f36457b = profileActivity;
        this.f36458c = tL_error;
        this.d = tLObject;
    ...
    public final void run() {
        switch (this.f36456a) {
            case 0:
                ProfileActivity profileActivity = this.f36457b;
                profileActivity.getNotificationCenter().doOnIdle(new oy0(profileActivity, this.f36458c, this.d, this.e, 1));
                return;
            default:
                ProfileActivity profileActivity2 = this.f36457b;
                if (this.f36458c == null) {
                    ...
                    if (this.e.offset == 0) {
                        ...
                        profileActivity2.f31393u2.participants = new TLRPC.TL_chatParticipants();
                        ...
                        profileActivity2.getMessagesStorage().updateChannelUsers(profileActivity2.f31290f1, tL_channels_channelParticipants.participants);
                    }
                    for (int i10 = 0; i10 < tL_channels_channelParticipants.participants.size(); i10++) {
                        ...
                        if (profileActivity2.C1.h(peerId) < 0) {
                            TLRPC.ChatFull chatFull = profileActivity2.f31393u2;
                            if (chatFull.participants == null) {
                                chatFull.participants = new TLRPC.TL_chatParticipants();
                            }
                            profileActivity2.f31393u2.participants.participants.add(tL_chatChannelParticipant);
