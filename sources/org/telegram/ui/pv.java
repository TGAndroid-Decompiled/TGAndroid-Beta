...
public final class pv extends org.telegram.ui.ActionBar.o2 {
    public static final org.telegram.ui.Components.kr0 f36733x = new org.telegram.ui.Components.kr0(2);
    public wy f36734a;
    public ContactsActivity f36735b;
    public org.telegram.ui.ActionBar.w0 f36736c;
    public Paint d;
    ...
    public final View createView(Context context) {
        ...
        ai.w0 w0Var;
        ContactsActivity contactsActivity = this.f36735b;
        wy wyVar = this.f36734a;
        ov[] ovVarArr = this.f36737f;
        ...
        for (int i10 = 0; i10 < ovVarArr.length; i10++) {
            ...
            if (i10 == 0) {
                ...
                ovVar2.f36428a = wyVar;
                ovVar2.d = wyVar.f39215e0[0].f38522a;
                wyVar.M3();
                gy gyVar = wyVar.C0;
                if (gyVar != null) {
                    w0Var = gyVar.W;
                ...
                ovVar3.f36428a = contactsActivity;
                ovVar3.d = contactsActivity.f30756f;
                ovVar3.setVisibility(8);
            }
            ovVarArr[i10].d.setScrollingTouchSlop(1);
            ov ovVar4 = ovVarArr[i10];
            ovVar4.f36429b = (FrameLayout) ovVar4.f36428a.getFragmentView();
            ov ovVar5 = ovVarArr[i10];
            ovVar5.f36430c = ovVar5.f36428a.getActionBar();
            ov ovVar6 = ovVarArr[i10];
            ovVar6.addView(ovVar6.f36429b, w7.x5.c(-1.0f, -1));
            AndroidUtilities.removeFromParent(ovVarArr[i10].f36430c);
            ov ovVar7 = ovVarArr[i10];
            ovVar7.addView(ovVar7.f36430c, w7.x5.c(-2.0f, -1));
            ovVarArr[i10].f36430c.setVisibility(8);
        ...
        if (scrollSlidingTextTabStrip2 != null) {
            ...
            if (currentTabId >= 0) {
                ovVarArr[0].f36431f = currentTabId;
            }
            this.e.c();
        }
        m0(false);
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.fragmentView, 0, null, null, null, null, org.telegram.ui.ActionBar.j6.f18862d6));
        ...
        arrayList.addAll(this.f36734a.getThemeDescriptions());
        arrayList.addAll(this.f36735b.getThemeDescriptions());
        return arrayList;
    }
