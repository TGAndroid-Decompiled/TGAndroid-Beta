...
public final class g30 extends s4.s0 {
    ...
    public final void a(RecyclerView recyclerView, int i10) {
        int i11;
        i60 i60Var = this.f33760a;
        o50 o50Var = i60Var.Q;
        if (i10 == 0) {
            int dp = AndroidUtilities.dp(74.0f);
            i11 = ((org.telegram.ui.ActionBar.f3) i60Var).backgroundPaddingTop;
            if ((i60Var.f34528y0 - dp) + i11 < org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() && o50Var.canScrollVertically(1)) {
                o50Var.getChildAt(0);
        ...
        org.telegram.ui.Components.i40 i40Var2 = i60Var.f34479n0;
        if (i40Var2 != null) {
            i40Var2.b(true);
        }
    }
    ...
    public final void b(RecyclerView recyclerView, int i10, int i11) {
        ...
        ViewGroup viewGroup;
        i60 i60Var = this.f33760a;
        if (i60Var.Q.getChildCount() > 0 && (call = i60Var.f34428a1) != null) {
            if (!call.loadingMembers && !call.membersLoadEndReached && i60Var.Y.N0() > i60Var.P.F - 5) {
                i60Var.f34428a1.loadMembers(false);
            }
            i60.J0(i60Var);
