...
public final class cj1 extends org.telegram.ui.ActionBar.j {
    public final WallpapersListActivity f32807a;

    public cj1(WallpapersListActivity wallpapersListActivity) {
        this.f32807a = wallpapersListActivity;
    }
    ...
    public final void b(int i10) {
        ...
        WallpapersListActivity wallpapersListActivity = this.f32807a;
        ...
        if (i10 == -1) {
            ...
            if (wallpapersListActivity.getParentActivity() != null) {
                ...
                alertDialog$Builder.f18437a.R = LocaleController.formatPluralString("DeleteBackground", longSparseArray.size(), new Object[0]);
                alertDialog$Builder.f18437a.T = LocaleController.formatString("DeleteChatBackgroundsAlert", R.string.DeleteChatBackgroundsAlert, new Object[0]);
