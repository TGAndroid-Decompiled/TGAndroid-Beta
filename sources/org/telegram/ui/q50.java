...
public final class q50 {
    ...
    public Emoji.EmojiDrawable f36792c;
    public org.telegram.ui.Components.q5 d;
    public boolean e;
    public boolean f36793f;
    public long f36794g;
    public String f36798l;
    public final Drawable[] f36791b = new Drawable[6];
    public final g20 h = new g20();
    public final HashSet f36795i = new HashSet();
    public boolean f36796j = false;
    public final p50 f36797k = new p50(this, 0);
    public final RectF f36799m = new RectF();

    public q50(int i10) {
        int i11 = 0;
        this.f36790a = i10;
        while (true) {
            Drawable[] drawableArr = this.f36791b;
            if (i11 < drawableArr.length) {
                drawableArr[i11] = Emoji.getEmojiDrawable(d60.A0());
                i11++;
            } else {
                this.f36794g = System.currentTimeMillis();
                return;
            }
        }
    }
    ...
    public final void a() {
        boolean isEmpty = this.f36795i.isEmpty();
        boolean z10 = !isEmpty;
        if (this.f36796j != z10) {
            this.f36796j = z10;
            p50 p50Var = this.f36797k;
            if (!isEmpty) {
    ...
    public final boolean b(Canvas canvas, RectF rectF, float f7) {
        ...
        RectF rectF2 = this.f36799m;
        rectF2.set(rectF);
        float f12 = -dp;
        rectF2.inset(f12, f12);
        canvas.saveLayerAlpha(rectF2.left, rectF2.top, rectF2.right, rectF2.bottom, 255, 31);
        long currentTimeMillis = (this.f36790a * 45) + System.currentTimeMillis();
        long j10 = currentTimeMillis - this.f36794g;
        float f13 = ((float) j10) / 180.0f;
        float min = Math.min(1.0f, f13);
        boolean z10 = this.f36793f;
        Drawable[] drawableArr = this.f36791b;
        boolean z11 = false;
        if (z10 && this.d != null && this.f36792c != null && this.e) {
            rectF2.set(rectF);
            ...
            if (f7 < 1.0f) {
                ...
                f11 = 0.0f;
                j3 = j10;
                this.f36792c.setBounds(0, 0, (int) rectF2.width(), (int) rectF2.height());
                canvas.translate(rectF2.left, rectF2.top);
                this.f36792c.setAlpha((int) ((1.0f - f7) * 255.0f));
                this.f36792c.draw(canvas);
                this.f36792c.setAlpha(255);
                canvas.restore();
            } else {
                j3 = j10;
                f10 = 255.0f;
        ...
        canvas.restore();
        if (f13 >= 1.0f) {
            if (this.f36793f && this.e) {
                z11 = true;
            } else {
                this.f36794g = currentTimeMillis - (j3 % 180);
                int i10 = 0;
    ...
    public final void c() {
        ...
        if (this.d != null && this.f36798l != null) {
            ...
            if (stickerSet != null) {
                String replace = this.f36798l.replace("️", "");
                ...
                FileLog.e("emoji \"" + this.f36798l + "\" not found in addemoji/" + tL_inputStickerSetShortName.short_name);
            }
        }
    }
}
