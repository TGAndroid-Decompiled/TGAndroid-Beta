...
public final class q50 {
    ...
    public final org.telegram.ui.Components.f01 f36290f;
    public p50 f36291g;
    public int f36293j;
    public final Paint f36287a = new Paint(1);
    public final Paint f36288b = new Paint(1);
    public final s50[] f36289c = new s50[4];
    public boolean h = true;
    public final org.telegram.ui.Components.e6 f36292i = new org.telegram.ui.Components.e6(new d10(this, 7), 320, org.telegram.ui.Components.rr.h, 0);
    public final RectF f36294k = new RectF();
    public final RectF f36295l = new RectF();
    public final Path f36296m = new Path();

    public q50() {
        int i10 = 0;
        while (true) {
            s50[] s50VarArr = this.f36289c;
            if (i10 < s50VarArr.length) {
                s50VarArr[i10] = new s50(i10);
                i10++;
            } else {
                this.f36287a.setColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19091tg, false));
                ...
                this.e = f01Var;
                this.f36290f = new org.telegram.ui.Components.f01(LocaleController.getString(R.string.ConferenceEncryptedClose), 14.0f, AndroidUtilities.bold());
                b(null);
                return;
            }
        }
    ...
    public final boolean a(Canvas canvas, float f7, float f10) {
        ...
        f01Var.f23795p = f7 - AndroidUtilities.dp(132.0f);
        int d = i0.a.d(f10, this.f36293j, org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19091tg, false));
        Paint paint = this.f36287a;
        paint.setColor(d);
        float e = this.f36292i.e(this.h);
        ...
        f01Var2.c(f14 - (f01Var2.l() / 2.0f), dp3 / 2.0f, AndroidUtilities.lerp(1.0f, 0.75f, e) * (1.0f - f10), -1, canvas);
        ...
        if (f10 > 0.0f) {
            ...
            this.f36290f.c(rectF.centerX() - (this.f36290f.l() / 2.0f), j3 - AndroidUtilities.dp(20.0f), f10, -1, canvas);
        }
        canvas.restore();
        return z11;
    }
    ...
    public final void b(String[] strArr) {
        ...
        for (int i10 = 0; i10 < 4; i10++) {
            s50 s50Var = this.f36289c[i10];
            if (strArr == null) {
                str = null;
            } else {
                str = strArr[i10];
            }
            r50 r50Var = s50Var.f37124k;
            boolean z12 = s50Var.f37120f;
            if (str != null) {
                z11 = true;
            } else {
                z11 = false;
            ...
            s50Var.f37120f = z11;
            if (str != null && (s50Var.d == null || !TextUtils.equals(s50Var.f37125l, str))) {
                org.telegram.ui.Components.q5 q5Var = s50Var.d;
                if (q5Var != null) {
                    q5Var.p(r50Var);
                }
                s50Var.f37119c = Emoji.getEmojiDrawable(str);
            ...
            if (s50Var.f37120f && !z12) {
                s50Var.e = false;
            }
        }
        p50 p50Var = this.f36291g;
        if (p50Var != null) {
            p50Var.invalidate();
        }
    }
