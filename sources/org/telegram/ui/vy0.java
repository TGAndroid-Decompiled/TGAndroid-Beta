...
public final class vy0 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        switch (this.f38709a) {
            case 0:
                ProfileActivity profileActivity = (ProfileActivity) this.f38710b;
                TLRPC.Chat chat = (TLRPC.Chat) this.f38711c;
                long j12 = profileActivity.f31269e1;
                ...
                pqVar.X0 = new nz0(profileActivity, chat, pqVar);
                profileActivity.presentFragment(pqVar);
                return;
            case 1:
                o21 o21Var = (o21) this.f38710b;
                Context context = (Context) this.f38711c;
                StringBuilder sb2 = new StringBuilder();
                String obj = o21Var.f36088a[0].getText().toString();
                String obj2 = o21Var.f36088a[3].getText().toString();
                String obj3 = o21Var.f36088a[2].getText().toString();
                String obj4 = o21Var.f36088a[1].getText().toString();
                String obj5 = o21Var.f36088a[4].getText().toString();
                try {
            ...
            case 2:
                v51 v51Var2 = (v51) this.f38710b;
                Context context2 = (Context) this.f38711c;
                if (v51Var2.f32705w == null) {
                    boolean[] zArr = new boolean[1];
                    long currentTimeMillis = System.currentTimeMillis() / 1000;
                    rv0 rv0Var = new rv0(7, v51Var2, zArr);
                    ...
                    if (context2 == null) {
                        ...
                        a3Var2.b(u3Var3);
                        org.telegram.ui.ActionBar.f3 f3Var = a3Var2.f18442a;
                        f3Var.show();
                        f3Var.setBackgroundColor(w03);
                        f3Var.fixNavigationBar(w03);
                        a3Var = a3Var2;
                    }
                    a3Var.f18442a.setOnHideListener(new ei.e0(v51Var, zArr, 11));
                    org.telegram.ui.ActionBar.f3 f3Var2 = a3Var.f18442a;
                    f3Var2.show();
                    v51Var.f32705w = f3Var2;
                    v51Var.c(false);
                    return;
                }
                return;
            case 3:
                t71 t71Var = (t71) this.f38710b;
                org.telegram.ui.Components.rc rcVar = (org.telegram.ui.Components.rc) this.f38711c;
                if (t71Var.Z.g() != 0) {
                    rcVar.run(new ArrayList(t71Var.f37581a0.values()));
                    t71Var.dismiss();
                    return;
                }
                return;
            case 4:
                SessionsActivity sessionsActivity = (SessionsActivity) this.f38710b;
                ((AlertDialog$Builder) this.f38711c).f18437a.L0.run();
                ...
                return;
            case 5:
                EditTextBoldCursor editTextBoldCursor = (EditTextBoldCursor) this.f38710b;
                editTextBoldCursor.setText(yh.y7.M0(((Long) this.f38711c).longValue()));
                editTextBoldCursor.setSelection(editTextBoldCursor.getText().length());
                return;
            case 6:
                ya1 ya1Var = ((da1) this.f38710b).f32979d0;
                ya1Var.getOrCreateStoryViewer().C(ya1Var.getParentActivity(), ((va1) this.f38711c).b(), ya1Var.f39829z0, ai.u9.a(ya1Var.S));
                return;
            case 7:
                ha1 ha1Var = (ha1) this.f38710b;
                kg.f fVar = (kg.f) this.f38711c;
                int i12 = ha1Var.f34227c;
                ia1 ia1Var = ha1Var.d;
                ...
                if (s00Var.f27726c) {
                    ...
                    while (true) {
                        if (i13 < size) {
                            if (i13 == i12 || !((ha1) arrayList.get(i13)).f34225a.f27726c || !((ha1) arrayList.get(i13)).f34225a.f27725b) {
                                i13++;
                            }
                        } else {
                            i11 = 1;
                    ...
                    s00Var.setChecked(!s00Var.f27725b);
                    fVar.f13628n = s00Var.f27725b;
                    ia1Var.f34572b.z();
                    if (ia1Var.f34576r.f35095c > 0 && i12 < gVar.d.size()) {
                        ((kg.f) gVar.d.get(i12)).f13628n = s00Var.f27725b;
                        gVar.z();
                        return;
                    }
                    return;
                ...
                return;
            case 8:
                uy uyVar = (uy) this.f38711c;
                AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(uyVar.getParentActivity());
                alertDialog$Builder.f18437a.R = LocaleController.getString(R.string.LocalDatabaseClearTextTitle);
                alertDialog$Builder.f18437a.T = LocaleController.getString(R.string.LocalDatabaseClearText);
                alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
                alertDialog$Builder.k(LocaleController.getString(R.string.CacheClear), new rv0(9, (gb1) this.f38710b, uyVar));
                ...
                return;
            case 9:
                ae1 ae1Var = (ae1) this.f38710b;
                Context context3 = (Context) this.f38711c;
                if (ae1Var.getParentActivity() != null) {
                    ...
                    org.telegram.messenger.w1.q(textView3, org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18943j5, false), 1, 20.0f);
                    ...
                    linearLayout2.addView(cc1Var, w7.x5.k(0.0f, 7.0f, 0.0f, 1.0f, -1, 148));
                    cc1Var.x1(ae1Var.fragmentView.getMeasuredWidth());
                    ae1Var.showDialog(a3Var3.f18442a);
                    return;
                }
                return;
            case 10:
                ti1 ti1Var = (ti1) this.f38710b;
                Context context4 = (Context) this.f38711c;
                tg.n1 n1Var = ti1Var.M;
                if (n1Var != null) {
                    n1Var.dismiss();
                    ti1Var.M = null;
                }
                tg.n1 n1Var2 = new tg.n1(context4, ti1Var.f37693a, null, 4, new ai.a1());
                TLRPC.User user = ti1Var.f37699c;
                if (user != null) {
                    j3 = user.f18259id;
                } else {
                    j3 = 0;
                ...
                return;
            case 11:
                ci.d dVar = (ci.d) this.f38710b;
                int[] iArr = (int[]) this.f38711c;
                if (!dVar.N && (cVar = kj1.d) != null) {
                    ...
                    try {
                        ...
                        n6.l.n(eVar, y8.j0.f46380a).addOnSuccessListener(new b7(cVar, dVar, iArr, 24)).addOnFailureListener(new jj1(dVar, 0));
                        return;
                    } catch (Exception e) {
                        FileLog.e(e);
                ...
                return;
            case 12:
                org.telegram.ui.web.k kVar = (org.telegram.ui.web.k) this.f38710b;
                kVar.f39001b = true;
                ((x) this.f38711c).run();
                kVar.f39007w.Y2.N(true);
                return;
            case 13:
                pg.x xVar = (pg.x) this.f38710b;
                Context context5 = (Context) this.f38711c;
                if (!xVar.f41039n.c()) {
                    Bitmap snapshotView = AndroidUtilities.snapshotView(xVar.f41039n.e());
                    Bitmap createBitmap = Bitmap.createBitmap(snapshotView.getWidth(), snapshotView.getHeight(), Bitmap.Config.ARGB_8888);
                    Canvas canvas = new Canvas(createBitmap);
                    canvas.drawColor(-16777216);
                    xVar.f41039n.b(canvas);
                    canvas.drawBitmap(snapshotView, 0.0f, 0.0f, (Paint) null);
                    snapshotView.recycle();
                    pg.n nVar = new pg.n(xVar, context5, createBitmap);
                    xVar.f41039n.f().addView(nVar, w7.x5.c(-1.0f, -1));
                    pg.u uVar = xVar.f41039n;
                ...
                return;
            case 14:
                qg.p2 p2Var = (qg.p2) this.f38710b;
                ci.hd hdVar = (ci.hd) this.f38711c;
                qg.m2[] m2VarArr = p2Var.H;
                if (m2VarArr != null && m2VarArr.length != 0 && p2Var.I != null && (j10 = p2Var.j(p2Var.f41571n0, p2Var.f41572o0)) != null) {
                    hdVar.run(j10);
                    return;
                }
                return;
            case 15:
                org.telegram.ui.Components.un.d0((bo) this.f38711c, 41026, new org.telegram.ui.web.b1((qh.c) this.f38710b, 7), null);
                return;
            case 16:
                rg.j0.V((rg.j0) this.f38710b, (Context) this.f38711c);
                return;
            case 17:
                tg.t0 t0Var2 = (tg.t0) this.f38710b;
                TLRPC.Chat chat2 = (TLRPC.Chat) this.f38711c;
                ArrayList arrayList3 = t0Var2.X;
                if (!arrayList3.isEmpty()) {
                    tg.e0 e0Var = t0Var2.f43222a0;
                    if (!e0Var.N) {
                        ...
                        tg.t.a(chat2.f18112id, arrayList4, new ai.e4(t0Var2, chat2, arrayList4, hashSet, 16), new org.telegram.ui.web.b1(t0Var2, 11));
                        return;
                    }
                    return;
                }
                return;
            case 18:
                tg.n1 n1Var3 = (tg.n1) this.f38710b;
                ArrayList arrayList5 = (ArrayList) this.f38711c;
                HashSet hashSet2 = n1Var3.f43181h0;
                ...
                return;
            case 19:
                tg.n1.S((tg.n1) this.f38710b, (TLRPC.User) this.f38711c, view);
                return;
            case 20:
                final ug.e eVar2 = (ug.e) this.f38710b;
                final vg.a aVar = (vg.a) this.f38711c;
                if (eVar2.d) {
                    if (!aVar.f44297a.N) {
                        aVar.b(true);
                        String str2 = eVar2.h;
                            ...
                            public final void run(Object obj8) {
                                switch (r3) {
                                    case 0:
                                        ...
                                        c0Var.f43117r.dismiss();
                                        return;
                                    default:
                                        aVar.b(false);
                                        e eVar3 = eVar2;
                                        k.c((TLRPC.TL_error) obj8, eVar3.f43722n, eVar3.f43720c, new c(eVar3, 1));
                                        return;
                                }
                            }
                        };
                ...
                ((tg.c0) eVar2).f43117r.dismiss();
                return;
            case 21:
                TLRPC.Chat chat3 = (TLRPC.Chat) this.f38711c;
                vg.f fVar2 = ((vg.g) this.f38710b).f44325s;
                if (fVar2 != null) {
                    tg.b0 b0Var = ((tg.v) fVar2).f43229a;
                    b0Var.f43090c0.remove(chat3);
                    b0Var.a0(true, true);
                    return;
                }
                return;
            case 22:
                ((org.telegram.ui.web.b1) this.f38710b).run((TLRPC.TL_payments_checkedGiftCode) this.f38711c);
                return;
            case 23:
                ((org.telegram.ui.web.b1) this.f38710b).run((TLRPC.Chat) this.f38711c);
                return;
            case 24:
                xh.c.P((xh.c) this.f38710b, (TL_stars.TL_StarGiftAuctionAcquiredGift) this.f38711c);
                return;
            case 25:
                xh.h4 h4Var = (xh.h4) this.f38710b;
                h4Var.getClass();
                if (((yh.m7) this.f38711c).f47471f > 0) {
                    h4Var.presentFragment(new yh.y7());
                    return;
                }
                return;
            case 26:
                xh.g4.P((xh.g4) this.f38710b, (xh.f4) this.f38711c);
                return;
            case 27:
                xh.l4 l4Var = (xh.l4) this.f38710b;
                ei.r4 r4Var = (ei.r4) this.f38711c;
                ...
                if (!hashSet3.isEmpty()) {
                    ...
                    while (it.hasNext()) {
                        ...
                        ArrayList arrayList7 = l4Var.Y.f47498l;
                ...
                return;
            case 28:
                yh.n5 n5Var = ((xh.i4) this.f38710b).f45929c.Y;
                n5Var.e = !n5Var.e;
                ((org.telegram.messenger.kk) this.f38711c).run();
                n5Var.i(true);
                return;
            default:
                yh.g.X((yh.g) this.f38710b, (Context) this.f38711c, view);
                return;
        }
    }
}
