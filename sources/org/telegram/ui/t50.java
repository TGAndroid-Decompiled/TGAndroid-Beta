...
public final class t50 {
    ...
    public final org.telegram.ui.Components.v01 f37572f;
    public s50 f37573g;
    public int f37575j;
    public final Paint f37569a = new Paint(1);
    public final Paint f37570b = new Paint(1);
    public final v50[] f37571c = new v50[4];
    public boolean h = true;
    public final org.telegram.ui.Components.e6 f37574i = new org.telegram.ui.Components.e6(new g10(this, 7), 320, org.telegram.ui.Components.qr.h, 0);
    public final RectF f37576k = new RectF();
    public final RectF f37577l = new RectF();
    public final Path f37578m = new Path();

    public t50() {
        int i10 = 0;
        while (true) {
            v50[] v50VarArr = this.f37571c;
            if (i10 < v50VarArr.length) {
                v50VarArr[i10] = new v50(i10);
                i10++;
            } else {
                this.f37569a.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19366tg, false));
                ...
                this.e = v01Var;
                this.f37572f = new org.telegram.ui.Components.v01(LocaleController.getString(R.string.ConferenceEncryptedClose), 14.0f, AndroidUtilities.bold());
                b(null);
                return;
            }
        }
    ...
    public final boolean a(Canvas canvas, float f7, float f10) {
        ...
        v01Var.f28878p = f7 - AndroidUtilities.dp(132.0f);
        int d = i0.a.d(f10, this.f37575j, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19366tg, false));
        Paint paint = this.f37569a;
        paint.setColor(d);
        float e = this.f37574i.e(this.h);
        ...
        if (f10 > 0.0f) {
            ...
            this.f37572f.c(rectF.centerX() - (this.f37572f.l() / 2.0f), j3 - AndroidUtilities.dp(20.0f), f10, -1, canvas);
        }
        canvas.restore();
        return z11;
    }
    ...
    public final void b(String[] strArr) {
        ...
        for (int i10 = 0; i10 < 4; i10++) {
            v50 v50Var = this.f37571c[i10];
            if (strArr == null) {
                str = null;
            } else {
                str = strArr[i10];
            }
            u50 u50Var = v50Var.f38307k;
            boolean z12 = v50Var.f38303f;
            if (str != null) {
                z11 = true;
            } else {
                z11 = false;
            ...
            v50Var.f38303f = z11;
            if (str != null && (v50Var.d == null || !TextUtils.equals(v50Var.f38308l, str))) {
                org.telegram.ui.Components.q5 q5Var = v50Var.d;
                if (q5Var != null) {
                    q5Var.p(u50Var);
                }
                v50Var.f38302c = Emoji.getEmojiDrawable(str);
            ...
            if (v50Var.f38303f && !z12) {
                v50Var.e = false;
            }
        }
        s50 s50Var = this.f37573g;
        if (s50Var != null) {
            s50Var.invalidate();
        }
    }
