...
public final class t50 {
    ...
    public final org.telegram.ui.Components.w01 f37650f;
    public s50 f37651g;
    public int f37653j;
    public final Paint f37647a = new Paint(1);
    public final Paint f37648b = new Paint(1);
    public final v50[] f37649c = new v50[4];
    public boolean h = true;
    public final org.telegram.ui.Components.d6 f37652i = new org.telegram.ui.Components.d6(new g10(this, 7), 320, org.telegram.ui.Components.qr.h, 0);
    public final RectF f37654k = new RectF();
    public final RectF f37655l = new RectF();
    public final Path f37656m = new Path();

    public t50() {
        int i10 = 0;
        while (true) {
            v50[] v50VarArr = this.f37649c;
            if (i10 < v50VarArr.length) {
                v50VarArr[i10] = new v50(i10);
                i10++;
            } else {
                this.f37647a.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19413tg, false));
                ...
                this.e = w01Var;
                this.f37650f = new org.telegram.ui.Components.w01(LocaleController.getString(R.string.ConferenceEncryptedClose), 14.0f, AndroidUtilities.bold());
                b(null);
                return;
            }
        }
    ...
    public final boolean a(Canvas canvas, float f7, float f10) {
        ...
        w01Var.f29872p = f7 - AndroidUtilities.dp(132.0f);
        int d = i0.a.d(f10, this.f37653j, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19413tg, false));
        Paint paint = this.f37647a;
        paint.setColor(d);
        float e = this.f37652i.e(this.h);
        ...
        if (f10 > 0.0f) {
            ...
            this.f37650f.c(rectF.centerX() - (this.f37650f.l() / 2.0f), j3 - AndroidUtilities.dp(20.0f), f10, -1, canvas);
        }
        canvas.restore();
        return z11;
    }
    ...
    public final void b(String[] strArr) {
        ...
        for (int i10 = 0; i10 < 4; i10++) {
            v50 v50Var = this.f37649c[i10];
            if (strArr == null) {
                str = null;
            } else {
                str = strArr[i10];
            }
            u50 u50Var = v50Var.f38433k;
            boolean z12 = v50Var.f38429f;
            if (str != null) {
                z11 = true;
            } else {
                z11 = false;
            ...
            v50Var.f38429f = z11;
            if (str != null && (v50Var.d == null || !TextUtils.equals(v50Var.f38434l, str))) {
                org.telegram.ui.Components.p5 p5Var = v50Var.d;
                if (p5Var != null) {
                    p5Var.p(u50Var);
                }
                v50Var.f38428c = Emoji.getEmojiDrawable(str);
            ...
            if (v50Var.f38429f && !z12) {
                v50Var.e = false;
            }
        }
        s50 s50Var = this.f37651g;
        if (s50Var != null) {
            s50Var.invalidate();
        }
    }
