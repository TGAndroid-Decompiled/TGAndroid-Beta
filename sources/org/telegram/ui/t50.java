...
public final class t50 {
    ...
    public final org.telegram.ui.Components.g01 f37555f;
    public s50 f37556g;
    public int f37558j;
    public final Paint f37552a = new Paint(1);
    public final Paint f37553b = new Paint(1);
    public final v50[] f37554c = new v50[4];
    public boolean h = true;
    public final org.telegram.ui.Components.c6 f37557i = new org.telegram.ui.Components.c6(new g10(this, 7), 320, org.telegram.ui.Components.qr.h, 0);
    public final RectF f37559k = new RectF();
    public final RectF f37560l = new RectF();
    public final Path f37561m = new Path();

    public t50() {
        int i10 = 0;
        while (true) {
            v50[] v50VarArr = this.f37554c;
            if (i10 < v50VarArr.length) {
                v50VarArr[i10] = new v50(i10);
                i10++;
            } else {
                this.f37552a.setColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19139tg, false));
                ...
                this.e = g01Var;
                this.f37555f = new org.telegram.ui.Components.g01(LocaleController.getString(R.string.ConferenceEncryptedClose), 14.0f, AndroidUtilities.bold());
                b(null);
                return;
            }
        }
    ...
    public final boolean a(Canvas canvas, float f7, float f10) {
        ...
        g01Var.f24159p = f7 - AndroidUtilities.dp(132.0f);
        int d = i0.a.d(f10, this.f37558j, org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19139tg, false));
        Paint paint = this.f37552a;
        paint.setColor(d);
        float e = this.f37557i.e(this.h);
        ...
        if (f10 > 0.0f) {
            ...
            this.f37555f.c(rectF.centerX() - (this.f37555f.l() / 2.0f), j3 - AndroidUtilities.dp(20.0f), f10, -1, canvas);
        }
        canvas.restore();
        return z11;
    }
    ...
    public final void b(String[] strArr) {
        ...
        for (int i10 = 0; i10 < 4; i10++) {
            v50 v50Var = this.f37554c[i10];
            if (strArr == null) {
                str = null;
            } else {
                str = strArr[i10];
            }
            u50 u50Var = v50Var.f38366k;
            boolean z12 = v50Var.f38362f;
            if (str != null) {
                z11 = true;
            } else {
                z11 = false;
            ...
            v50Var.f38362f = z11;
            if (str != null && (v50Var.d == null || !TextUtils.equals(v50Var.f38367l, str))) {
                org.telegram.ui.Components.o5 o5Var = v50Var.d;
                if (o5Var != null) {
                    o5Var.p(u50Var);
                }
                v50Var.f38361c = Emoji.getEmojiDrawable(str);
            ...
            if (v50Var.f38362f && !z12) {
                v50Var.e = false;
            }
        }
        s50 s50Var = this.f37556g;
        if (s50Var != null) {
            s50Var.invalidate();
        }
    }
