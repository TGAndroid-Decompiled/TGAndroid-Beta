...
public final class eg1 extends s4.v {
    ...
    public final int e(RecyclerView recyclerView, s4.c1 c1Var) {
        ...
        if (b10 >= 0) {
            fg1 fg1Var = this.e;
            if (b10 < fg1Var.f33643b.size() && ((wf1) fg1Var.f33643b.get(b10)).f39031c != null && ChatObject.canManageTopics(fg1Var.g())) {
                TLRPC.TL_forumTopic tL_forumTopic = ((wf1) fg1Var.f33643b.get(b10)).f39031c;
                if (fg1Var.f33641a0.isEmpty()) {
    ...
    public final boolean k() {
        return !this.e.f33641a0.isEmpty();
    }
    ...
    public final boolean n(RecyclerView recyclerView, s4.c1 c1Var, s4.c1 c1Var2) {
        int b10;
        fg1 fg1Var = this.e;
        ArrayList arrayList = fg1Var.f33643b;
        if (c1Var.f42705f == c1Var2.f42705f && (b10 = c1Var2.b()) >= 0 && b10 < arrayList.size() && ((wf1) arrayList.get(b10)).f39031c != null && ((wf1) arrayList.get(b10)).f39031c.pinned) {
            uf1 uf1Var = fg1Var.f33673r;
            int b11 = c1Var.b();
            int b12 = c1Var2.b();
            fg1 fg1Var2 = uf1Var.d;
            ArrayList arrayList2 = fg1Var2.f33643b;
    ...
    public final void p(s4.c1 c1Var, int i10) {
        ...
        if (i10 == 0) {
            ...
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                TLRPC.TL_forumTopic tL_forumTopic = ((wf1) arrayList.get(i11)).f39031c;
                if (tL_forumTopic != null && tL_forumTopic.pinned) {
                    arrayList2.add(Integer.valueOf(tL_forumTopic.f18173id));
                }
            }
            fg1Var.getMessagesController().getTopicsController().reorderPinnedTopics(fg1Var.f33640a, arrayList2);
            return;
        }
        fg1Var.N.J0(false);
    ...
    public final void q(s4.c1 c1Var) {
        if (c1Var != null) {
            ...
            fg1Var.f33645b1 = cg1Var;
            int i10 = dg1.f33122h3;
