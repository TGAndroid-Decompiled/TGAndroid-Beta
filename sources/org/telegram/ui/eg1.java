...
public class eg1 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.ah, dh0 {
    public static final HashSet f33290n1 = new HashSet();
    public HashSet A0;
    public boolean B0;
    public boolean C0;
    public ai.d7 D0;
    ...
    public final HashSet f33292a0;
    public org.telegram.ui.Components.h81 f33293a1;
    public final ArrayList f33294b;
    public boolean f33295b0;
    public View f33296b1;
    public int f33297c;
    public NumberTextView f33298c0;
    public int f33299c1;
    public lf1 d;
    public org.telegram.ui.ActionBar.v0 f33300d0;
    public int f33301d1;
    public j0 e;
    public org.telegram.ui.ActionBar.v0 f33302e0;
    public int f33303e1;
    public org.telegram.ui.Components.eo f33304f;
    public org.telegram.ui.ActionBar.v0 f33305f0;
    public final ah.h f33306f1;
    public org.telegram.ui.ActionBar.v0 f33307g0;
    public final fh.d f33308g1;
    public org.telegram.ui.Components.y10 h;
    public org.telegram.ui.ActionBar.v0 f33309h0;
    public final fh.d f33310h1;
    public org.telegram.ui.ActionBar.v0 f33311i0;
    public final ah.c f33312i1;
    public org.telegram.ui.ActionBar.f1 f33313j0;
    public ah.n f33314j1;
    public org.telegram.ui.ActionBar.f1 f33315k0;
    public final ArrayList f33316k1;
    public org.telegram.ui.ActionBar.f1 f33317l0;
    public final RectF l1;
    public org.telegram.ui.ActionBar.v0 m0;
    public final RectF f33318m1;
    public uf1 f33319n;
    public RadialProgressView f33320n0;
    public t51 f33321o0;
    public org.telegram.ui.ActionBar.v0 f33322p0;
    public org.telegram.ui.ActionBar.v0 f33323q0;
    public final tf1 f33324r;
    public ag1 f33325r0;
    public final TopicsController f33326s;
    public boolean f33327s0;
    public final boolean f33328t0;
    public final boolean f33329u0;
    public fg1 v;
    public final boolean f33330v0;
    public ax f33331w;
    public final boolean f33332w0;
    public int f33333x;
    public final boolean f33334x0;
    public int f33335y;
    public String f33336y0;
    public boolean f33337z0;

    public eg1(Bundle bundle) {
        super(bundle);
        this.f33294b = new ArrayList();
        new ArrayList();
        this.f33324r = new tf1(this);
        this.f33333x = 0;
        this.E = true;
        this.G = true;
        this.V = true;
        this.W = 0.0f;
        this.f33292a0 = new HashSet();
        this.B0 = false;
        this.O0 = new AnimationNotificationsLocker(new int[]{NotificationCenter.topicsDidLoaded});
        this.S0 = 1.0f;
        new ArrayList();
        ArrayList arrayList = new ArrayList();
        this.f33316k1 = arrayList;
        RectF rectF = new RectF();
        this.l1 = rectF;
        RectF rectF2 = new RectF();
        this.f33318m1 = rectF2;
        arrayList.add(rectF);
        arrayList.add(rectF2);
        long j3 = this.arguments.getLong("chat_id", 0L);
        this.f33291a = j3;
        this.f33328t0 = this.arguments.getBoolean("for_select", false);
        this.f33329u0 = this.arguments.getBoolean("forward_to", false);
        this.f33334x0 = this.arguments.getBoolean("bot_share_to", false);
        this.f33330v0 = this.arguments.getBoolean("quote", false);
        this.f33332w0 = this.arguments.getBoolean("reply_to", false);
        this.f33336y0 = this.arguments.getString("voicechat", null);
        this.f33337z0 = this.arguments.getBoolean("videochat", false);
        this.f33326s = getMessagesController().getTopicsController();
        ...
        if (Build.VERSION.SDK_INT >= 31) {
            this.f33306f1 = new ah.h(false);
            this.f33308g1 = new fh.d(null);
    ...
    public static void I0(org.telegram.ui.bo r6) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.eg1.I0(org.telegram.ui.bo):void");
    }
    ...
    public static boolean U(eg1 eg1Var, TLRPC.TL_error tL_error) {
        ...
        edit.putLong("dialog_join_requested_time_" + (-eg1Var.f33291a), System.currentTimeMillis()).commit();
    ...
    public static void V(eg1 eg1Var, View view) {
        ...
        if (eg1Var.getParentLayout() != null && !((ActionBarLayout) eg1Var.getParentLayout()).y() && (view instanceof bg1)) {
            ...
            if (tL_forumTopic == null) {
                ...
                j3 = tL_forumTopic.f18161id;
            }
            long j12 = j3;
            if (eg1Var.f33328t0) {
                fg1 fg1Var = eg1Var.v;
                if (fg1Var != null) {
                    hg1 hg1Var = fg1Var.f33599a;
                    Bundle bundle = new Bundle();
                    kg1 kg1Var = hg1Var.f34259a;
                    bundle.putLong("dialog_id", kg1Var.f35158c);
                    bundle.putLong("topic_id", tL_forumTopic.f18161id);
                    bundle.putBoolean("exception", true);
                    x11 x11Var = new x11(bundle, null);
                    x11Var.f39468r = new rv0(16, hg1Var, tL_forumTopic);
            ...
            } else if (eg1Var.f33292a0.size() > 0) {
                eg1Var.N0(view);
            } else {
                if (eg1Var.inPreviewMode && AndroidUtilities.isTablet()) {
                    for (org.telegram.ui.ActionBar.n2 n2Var : eg1Var.getParentLayout().getFragmentStack()) {
                        if (n2Var instanceof uy) {
                            uy uyVar2 = (uy) n2Var;
                            if (uyVar2.h4()) {
                                MessagesStorage.TopicKey topicKey = uyVar2.f38277p2;
                ...
                ng.d.m(eg1Var, j10, tL_forumTopic, 0);
            }
        }
    }

    public static boolean W(eg1 eg1Var, View view, float f7) {
        if (eg1Var.f33328t0 || eg1Var.getParentLayout() == null || ((ActionBarLayout) eg1Var.getParentLayout()).y()) {
            return false;
        }
    ...
    public static void X(eg1 eg1Var) {
        ...
        if (s50Var != null && Build.VERSION.SDK_INT >= 23) {
            s50Var.setForeground(new ColorDrawable(i0.a.k(eg1Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18834d6), 100)));
        }
        eg1Var.P0();
    }
    ...
    public static void b0(eg1 eg1Var, boolean z10) {
        ...
        if (eg1Var.f33293a1 == null) {
            org.telegram.ui.Components.h81 n10 = eg1Var.f33325r0.n(8, false);
            eg1Var.f33293a1 = n10;
            if (eg1Var.M0 != null) {
                n10.setBackgroundColor(eg1Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18834d6));
            }
            eg1Var.e.addView(eg1Var.f33293a1, w7.x5.c(44.0f, -1));
        }
        float f10 = eg1Var.W;
        if (z10) {
            f7 = 1.0f;
        ...
        AndroidUtilities.updateViewVisibilityAnimated(eg1Var.f33325r0, false, 1.0f, true);
        uy uyVar = eg1Var.M0;
        if (uyVar != null && (oxVar = uyVar.F3) != null) {
            oxVar.M = !z10;
        }
        if (!z10 && eg1Var.f33325r0.getVisibility() == 0 && eg1Var.f33325r0.getAlpha() == 1.0f) {
            z11 = true;
        } else {
            z11 = false;
        }
        ...
        eg1Var.f33325r0.setVisibility(0);
        if (!z10) {
            eg1Var.f33323q0.setVisibility(0);
        } else {
        ...
        eg1Var.Y0.setInterpolator(org.telegram.ui.Components.qr.f27420f);
        eg1Var.Y0.start();
        NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.needCheckSystemBarColors, Boolean.TRUE);
    }

    public final void A0() {
        this.J0 = this.f33326s.isLoading(this.f33291a);
        if (this.D0 != null) {
            ArrayList arrayList = this.f33294b;
            if (arrayList.size() == 0 || (arrayList.size() == 1 && ((vf1) arrayList.get(0)).f38528c != null && ((vf1) arrayList.get(0)).f38528c.f18161id == 1)) {
    ...
    public final void B0() {
        ...
        if (uyVar != null) {
            ...
            if (ksVar2 != null) {
                ...
                if (ksVar3 != null) {
                    f10 = ksVar3.getMetadata().f13988c.f13996a;
                } else {
                    f10 = 0.0f;
                }
                ...
                if (ksVar5 != null) {
                    f11 = ksVar5.getMetadata().f13988c.f13996a;
                }
        ...
        int i11 = this.f33303e1 + this.f33299c1;
        if (this.V) {
    ...
    public final void D0(HashSet hashSet, Runnable runnable) {
        ...
        if (hashSet.size() == 1) {
            b2Var.T = LocaleController.formatString(R.string.DeleteSelectedTopic, this.f33326s.findTopic(this.f33291a, ((Integer) arrayList.get(0)).intValue()).title);
        } else {
    ...
    public final void H0(boolean z10) {
        ...
        Bundle bundle = new Bundle();
        bundle.putLong("chat_id", this.f33291a);
        ProfileActivity profileActivity = new ProfileActivity(bundle, this.f33304f.getSharedMediaPreloader());
        profileActivity.K4(this.J);
        if (this.fragmentView.getMeasuredHeight() > this.fragmentView.getMeasuredWidth() && this.f33304f.getAvatarImageView().getImageReceiver().hasImageLoaded() && z10) {
            i10 = 2;
        } else {
            i10 = 1;
        }
    ...
    public final void M0(org.telegram.ui.Cells.r2 r2Var) {
        ...
        int b10 = r32[0].b(poVar.f27099f);
        poVar.f27107o = 1;
        long j10 = this.f33291a;
        long j11 = -j10;
        poVar.d(j11, tL_forumTopic.f18161id, null);
        if (ChatObject.canManageTopics(g())) {
            ...
            f1Var.setOnClickListener(new View.OnClickListener(this) {
                ...
                public final void onClick(View view) {
                    switch (r3) {
                        case 0:
                            eg1 eg1Var = this.f33285b;
                            eg1Var.C0 = true;
                            eg1Var.N0 = true;
                            TopicsController topicsController = eg1Var.f33326s;
                            long j12 = eg1Var.f33291a;
                            TLRPC.TL_forumTopic tL_forumTopic2 = tL_forumTopic;
                            topicsController.pinTopic(j12, tL_forumTopic2.f18161id, !tL_forumTopic2.pinned, eg1Var);
                            eg1Var.finishPreviewFragment();
                            return;
                        case 1:
                            eg1 eg1Var2 = this.f33285b;
                            eg1Var2.N0 = true;
                            TopicsController topicsController2 = eg1Var2.f33326s;
                            long j13 = eg1Var2.f33291a;
                            TLRPC.TL_forumTopic tL_forumTopic3 = tL_forumTopic;
                            topicsController2.toggleCloseTopic(j13, tL_forumTopic3.f18161id, true ^ tL_forumTopic3.closed);
                            eg1Var2.finishPreviewFragment();
                            return;
                        default:
                            HashSet hashSet = new HashSet();
                            hashSet.add(Integer.valueOf(tL_forumTopic.f18161id));
                            eg1 eg1Var3 = this.f33285b;
        ...
        if (getMessagesController().isDialogMuted(j11, tL_forumTopic.f18161id)) {
        ...
        if (ChatObject.canDeleteTopic(this.currentAccount, g(), tL_forumTopic)) {
            ...
            f1Var4.setIconColor(getThemedColor(org.telegram.ui.ActionBar.i6.f19053p7));
            f1Var4.setTextColor(getThemedColor(org.telegram.ui.ActionBar.i6.f19071q7));
        ...
        bo boVar = new bo(w.c.e(j10, "chat_id"));
        if (isMonoForum) {
        ...
        if ((view instanceof bg1) && (tL_forumTopic = (bg1Var = (bg1) view).N) != null) {
            ...
            if (!hashSet.isEmpty()) {
                if (!this.actionBar.a(null)) {
                    ...
                    this.f33298c0 = numberTextView;
                    numberTextView.setTextSize(18);
                    this.f33298c0.setTypeface(AndroidUtilities.bold());
                    this.f33298c0.setTextColor(getThemedColor(org.telegram.ui.ActionBar.i6.f19217y8));
                    j10.addView(this.f33298c0, w7.x5.m(1.0f, 0, -1, 72, 0, 0));
                    this.f33298c0.setOnTouchListener(new ff1(0));
                    this.f33300d0 = j10.g(4, R.drawable.msg_pin, AndroidUtilities.dp(54.0f));
                    this.f33302e0 = j10.g(5, R.drawable.msg_unpin, AndroidUtilities.dp(54.0f));
                    this.f33305f0 = j10.g(6, R.drawable.msg_mute, AndroidUtilities.dp(54.0f));
                    this.f33307g0 = j10.h(7, R.drawable.msg_delete, LocaleController.getString(R.string.Delete), AndroidUtilities.dp(54.0f));
                    ...
                    this.m0 = h11;
                    this.f33313j0 = h11.e(8, R.drawable.msg_markread, LocaleController.getString(R.string.MarkAsRead));
                    this.f33315k0 = this.m0.e(9, R.drawable.msg_topic_close, LocaleController.getString(R.string.CloseTopic));
                    this.f33317l0 = this.m0.e(10, R.drawable.msg_topic_restart, LocaleController.getString(R.string.RestartTopic));
                }
                if (this.inPreviewMode) {
                ...
                if (i20 > 0) {
                    this.f33313j0.setVisibility(0);
                    this.f33313j0.g(LocaleController.getString(R.string.MarkAsRead), R.drawable.msg_markread, null);
                } else {
                    this.f33313j0.setVisibility(8);
                }
                if (i21 != 0) {
                    this.B0 = false;
                    this.f33305f0.setIcon(R.drawable.msg_unmute);
                    this.f33305f0.setContentDescription(LocaleController.getString(R.string.ChatsUnmute));
                    z10 = true;
                } else {
                    z10 = true;
                    this.B0 = true;
                    this.f33305f0.setIcon(R.drawable.msg_mute);
                    this.f33305f0.setContentDescription(LocaleController.getString(R.string.ChatsMute));
                }
                org.telegram.ui.ActionBar.v0 v0Var = this.f33300d0;
                if (i22 == z10 && i23 == 0) {
                    i10 = 0;
                } else {
                    i10 = 8;
                ...
                org.telegram.ui.ActionBar.v0 v0Var2 = this.f33302e0;
                if (i23 == z10 && i22 == 0) {
                    i11 = 0;
                } else {
                    i11 = 8;
                ...
                this.f33298c0.a(hashSet3.size(), z10);
                ...
                org.telegram.ui.ActionBar.f1 f1Var = this.f33315k0;
                if (i24 == 0 && i25 > 0) {
                    i12 = 0;
                } else {
                    i12 = 8;
                ...
                org.telegram.ui.ActionBar.f1 f1Var2 = this.f33315k0;
                if (i25 > 1) {
                ...
                org.telegram.ui.ActionBar.f1 f1Var3 = this.f33317l0;
                if (i25 == 0 && i24 > 0) {
                    i14 = 0;
                } else {
                    i14 = 8;
                ...
                org.telegram.ui.ActionBar.f1 f1Var4 = this.f33317l0;
                if (i24 > 1) {
                ...
                org.telegram.ui.ActionBar.v0 v0Var3 = this.f33307g0;
                ...
                org.telegram.ui.ActionBar.v0 v0Var4 = this.f33309h0;
                ...
                org.telegram.ui.ActionBar.v0 v0Var5 = this.f33311i0;
    ...
    public final void P0() {
        ...
        this.f33325r0.setBackgroundColor(getThemedColor(i10));
    }
    ...
    public final void Q0(boolean z10) {
        ...
        TLRPC.Chat chat = messagesController.getChat(Long.valueOf(j3));
        int i10 = 0;
        if (!ChatObject.isNotInChat(getMessagesController().getChat(Long.valueOf(j3))) && ChatObject.canCreateTopic(chat) && !this.f33327s0 && !this.f33328t0 && !this.J0) {
            z11 = true;
        } else {
            z11 = false;
        }
    ...
    public final void R0() {
        boolean z10;
        if (ChatObject.canManageTopics(g()) && !this.f33292a0.isEmpty()) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (this.f33295b0 != z10) {
            this.f33295b0 = z10;
            tf1 tf1Var = this.f33324r;
            tf1Var.q(0, tf1Var.h());
        }
    }
    ...
    public final void S0(float f7) {
        this.W = f7;
        int themedColor = getThemedColor(org.telegram.ui.ActionBar.i6.f19165v8);
        ...
        this.actionBar.A(i0.a.d(this.W, getThemedColor(org.telegram.ui.ActionBar.i6.f19129t8), getThemedColor(org.telegram.ui.ActionBar.i6.f19236z8)), false);
        if (!this.inPreviewMode) {
            this.actionBar.setBackgroundColor(i0.a.d(this.W, getThemedColor(org.telegram.ui.ActionBar.i6.f19110s8), getThemedColor(org.telegram.ui.ActionBar.i6.f18834d6)));
        }
        float f10 = 1.0f - f7;
        this.f33304f.getTitleTextView().setAlpha(f10);
        this.f33304f.getSubtitleTextView().setAlpha(f10);
        org.telegram.ui.Components.h81 h81Var = this.f33293a1;
        if (h81Var != null) {
            h81Var.setTranslationY((-AndroidUtilities.dp(16.0f)) * f10);
            this.f33293a1.setAlpha(f7);
        }
        this.f33325r0.setTranslationY((-AndroidUtilities.dp(16.0f)) * f10);
        this.f33325r0.setAlpha(f7);
        if (isInPreviewMode()) {
            this.e.invalidate();
        }
        this.d.invalidate();
    ...
    public final void T0() {
        ...
        if (d7Var != null && d7Var.e != null) {
            ...
            TLRPC.TL_forumTopic findTopic = getMessagesController().getTopicsController().findTopic(this.f33291a, 1L);
            if (findTopic != null) {
    ...
    public final void U0(boolean z10, boolean z11) {
        ...
        this.N0 = false;
        TopicsController topicsController = this.f33326s;
        long j3 = this.f33291a;
        ...
        if (topics != null) {
            ...
            arrayList.clear();
            rf1 rf1Var2 = null;
            if (UserObject.isBotForum(this.currentAccount, -j3) && this.f33329u0) {
                arrayList.add(new vf1(3, null));
            }
            for (int i10 = 0; i10 < topics.size(); i10++) {
                HashSet hashSet = this.A0;
                if (hashSet == null || !hashSet.contains(Integer.valueOf(topics.get(i10).f18161id))) {
            ...
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                ...
                if (vf1Var != null && (tL_forumTopic = vf1Var.f38528c) != null && tL_forumTopic.hidden) {
                    this.f33333x++;
                }
            }
            pf1 pf1Var = this.N;
    ...
    public final View createView(Context context) {
        ...
        lf1Var.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.i6.f18834d6));
        ...
        this.actionBar.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                ...
                switch (r2) {
                    case 0:
                        eg1 eg1Var = this.f32143b;
                        eg1Var.presentFragment(af1.a0(eg1Var.f33291a, 0L));
                        return;
                    case 1:
                        eg1 eg1Var2 = this.f32143b;
                        eg1Var2.getMessagesController().hidePeerSettingsBar(-eg1Var2.f33291a, null, eg1Var2.g());
                        eg1Var2.O0(false);
                        return;
                    case 2:
                        eg1 eg1Var3 = this.f32143b;
                        if (!eg1Var3.f33327s0) {
                            eg1Var3.H0(false);
                            return;
                        }
                        return;
                    case 3:
                        this.f32143b.finishPreviewFragment();
                        return;
                    default:
                        uy uyVar3 = this.f32143b.M0;
                        if (uyVar3 != null && (v0Var = uyVar3.f38248j0) != null) {
                            v0Var.performClick();
                            return;
                        }
                        return;
        ...
        if (this.M0 != null) {
            ...
            this.f33322p0.setSearchPaddingStart(56);
            this.f33322p0.setSearchFieldHint(LocaleController.getString(R.string.Search));
            EditTextBoldCursor searchField = this.f33322p0.getSearchField();
        ...
        this.f33323q0.e(1, R.drawable.msg_discussion, LocaleController.getString(R.string.TopicViewAsMessages));
        this.R = this.f33323q0.e(2, R.drawable.msg_addcontact, LocaleController.getString(R.string.AddMember));
        org.telegram.ui.ActionBar.v0 v0Var = this.f33323q0;
        ...
        this.Q = this.f33323q0.e(3, R.drawable.msg_topic_create, LocaleController.getString(R.string.CreateTopic));
        this.U = this.f33323q0.e(15, R.drawable.msg_report, LocaleController.getString(R.string.ReportChat));
        this.S = this.f33323q0.f(11, R.drawable.msg_leave, LocaleController.getString(R.string.LeaveMegaMenu), null);
        ...
        org.telegram.ui.Components.eo eoVar2 = this.f33304f;
        if (!AndroidUtilities.isTablet() && !this.inPreviewMode) {
            z11 = true;
        } else {
            z11 = false;
        ...
        org.telegram.ui.Components.eo eoVar3 = this.f33304f;
        long j3 = -this.f33291a;
        if (j3 < 0) {
            z12 = true;
        } else {
        ...
        this.actionBar.addView(this.f33304f, 0, w7.x5.d(-2, -1.0f, 51, 56.0f, 0.0f, 86.0f, 0.0f));
        if (!this.f33328t0) {
            this.f33304f.getAvatarImageView().setOnClickListener(new y7(this, 3));
        }
        this.N = new pf1(this, context);
        hh.k kVar2 = new hh.k(this.d);
        ViewGroup viewGroup = this.d;
        ah.c cVar = this.f33312i1;
        cVar.f425f = kVar2;
        ...
        this.f33314j1 = new ah.n(pf1Var, viewGroup, new v8(pf1Var2, 2));
        ...
        new SparseArray();
        new HashMap();
        this.N.setAdapter(this.f33324r);
            ...
            public final void onClick(View view) {
                ...
                switch (r2) {
                    ...
                    case 3:
                        ...
                        return;
                    default:
                        uy uyVar32 = this.f32143b.M0;
                        if (uyVar32 != null && (v0Var2 = uyVar32.f38248j0) != null) {
                            v0Var2.performClick();
                            return;
                        }
                        return;
        ...
        this.h.f30127c.setImageResource(R.drawable.ic_chatlist_add_2);
        this.h.f30127c.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
        this.h.f30127c.setPadding(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f));
        ...
        textView.setTextColor(getThemedColor(org.telegram.ui.ActionBar.i6.f19215y6));
        ...
        this.f33319n = frameLayout;
        textView.setAlpha(0.0f);
        ai.d7 d7Var = new ai.d7(this, context, t00Var);
        this.D0 = d7Var;
        try {
            d7Var.f30416b.getImageReceiver().setAutoRepeat(2);
        } catch (Exception unused) {
        }
        this.D0.e(this.J0, this.fragmentBeginToShow);
        this.D0.d.setText(LocaleController.getString(R.string.NoTopics));
        T0();
        this.f33319n.addView(t00Var);
        this.f33319n.addView(this.D0);
        this.d.addView(this.f33319n);
        this.N.setEmptyView(this.f33319n);
        this.f33321o0 = new t51(context, 6);
        org.telegram.ui.Components.g61 g61Var = new org.telegram.ui.Components.g61(context);
        this.L = g61Var;
        this.f33321o0.addView(g61Var);
        this.d.addView(this.f33321o0, w7.x5.e(-1, 51, 80));
        this.L.setOnClickListener(new jf1(this));
        RadialProgressView radialProgressView = new RadialProgressView(context, null);
        this.f33320n0 = radialProgressView;
        radialProgressView.setSize(AndroidUtilities.dp(22.0f));
        this.f33320n0.setVisibility(4);
        this.f33321o0.addView(this.f33320n0, w7.x5.e(30, 30, 17));
        ImageView imageView = new ImageView(context);
        this.W0 = imageView;
        imageView.setImageResource(R.drawable.miniplayer_close);
        this.W0.setContentDescription(LocaleController.getString(R.string.Close));
        ImageView imageView2 = this.W0;
        int i13 = org.telegram.ui.ActionBar.i6.f18842de;
        ...
        this.f33321o0.addView(this.W0, w7.x5.d(36, 36.0f, 53, 0.0f, 6.0f, 2.0f, 0.0f));
        ...
        this.f33325r0 = ag1Var;
        ag1Var.setVisibility(8);
        this.e.addView(this.f33325r0, w7.x5.d(-1, -1.0f, 119, 0.0f, 44.0f, 0.0f, 0.0f));
        ag1 ag1Var2 = this.f33325r0;
        ...
        getMessagesStorage().loadChatInfo(this.f33291a, true, null, true, false, 0);
        ...
        if (g10 != null) {
            ...
            this.U0.g(this.R0.c());
            wh.d dVar2 = this.R0;
            dVar2.f45079m = new df1(this);
            TLRPC.ChatFull chatFull = this.J;
            dVar2.f45076j = chatFull;
            if (chatFull != null) {
        ...
        if (this.inPreviewMode && AndroidUtilities.isTablet()) {
            ...
            while (true) {
                ...
                if (n2Var instanceof uy) {
                    uy uyVar4 = (uy) n2Var;
                    if (uyVar4.h4()) {
                        MessagesStorage.TopicKey topicKey = uyVar4.f38277p2;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i12) {
            ...
            if (chatFull2.f18110id == j3) {
                O0(false);
                wh.d dVar = this.R0;
                if (dVar != null) {
                    dVar.f45076j = chatFull2;
    ...
    public final TLRPC.Chat g() {
        return getMessagesController().getChat(Long.valueOf(this.f33291a));
    }
    ...
    public final boolean isLightStatusBar() {
        ...
        if (this.actionBar.s()) {
            themedColor = getThemedColor(org.telegram.ui.ActionBar.i6.f19183w8);
        }
    ...
    public final boolean onBackPressed(boolean z10) {
        if (!this.f33292a0.isEmpty()) {
            if (z10) {
                C0();
                return false;
            }
        } else if (this.f33327s0) {
            if (z10) {
                this.actionBar.v(this.f33322p0.L(false));
            }
        } else {
    ...
    public final void onFragmentDestroy() {
        ...
        TLRPC.Chat chat = getMessagesController().getChat(Long.valueOf(this.f33291a));
        if (ChatObject.isChannel(chat)) {
    ...
    public final void onPause() {
        super.onPause();
        getMessagesController().getTopicsController().onTopicFragmentPause(this.f33291a);
    ...
    public final void setPreviewOpenedProgress(float f7) {
        org.telegram.ui.Components.eo eoVar = this.f33304f;
        if (eoVar != null) {
            eoVar.setAlpha(f7);
            this.f33323q0.setAlpha(f7);
            org.telegram.ui.ActionBar.v0 v0Var = this.f33322p0;
            if (v0Var != null) {
                v0Var.setAlpha(f7);
            }
    ...
    public final void setPreviewReplaceProgress(float f7) {
        ...
        if (eoVar != null) {
            eoVar.setAlpha(f7);
            this.f33304f.setTranslationX((1.0f - f7) * AndroidUtilities.dp(40.0f));
        }
    }

    @Override
    public final fh.d x() {
        return this.f33310h1;
    }
    ...
    public final void x0() {
        ...
        float f7;
        int i10;
        if (Build.VERSION.SDK_INT >= 31 && (hVar = this.f33306f1) != null) {
            ...
            int measuredHeight = (view.getMeasuredHeight() - this.f33303e1) - AndroidUtilities.dp(8.0f);
            this.l1.set(0.0f, -dp, view.getMeasuredWidth(), kVar.getMeasuredHeight() + dp + dp2);
            RectF rectF = this.f33318m1;
            ...
            hVar.g(i10, this.f33316k1);
            hVar.e(this.f33314j1, view.getMeasuredWidth(), view.getMeasuredHeight());
        }
    }
    ...
    public final void y0() {
        ...
        if (!topicsController.endIsReached(j3) && (gf1Var = this.F) != null) {
            int N0 = gf1Var.N0();
            if (this.f33294b.isEmpty() || N0 >= this.f33324r.h() - 5) {
    ...
    public final void z0(boolean z10) {
        ...
        ChatObject.Call call = this.H0;
        if (call != null && ((str = this.f33336y0) != null || this.f33337z0)) {
            ...
            this.f33336y0 = null;
            this.f33337z0 = false;
        } else if (this.f33336y0 != null && z10 && chatFull != null && chatFull.call == null && this.fragmentView != null && getParentActivity() != null) {
