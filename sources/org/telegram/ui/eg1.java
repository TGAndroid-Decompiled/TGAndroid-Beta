...
public class eg1 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.ch, dh0 {
    public static final HashSet f36051n1 = new HashSet();
    public HashSet A0;
    public boolean B0;
    public boolean C0;
    public bi.m6 D0;
    ...
    public final HashSet f36053a0;
    public org.telegram.ui.Components.h81 f36054a1;
    public final ArrayList f36055b;
    public boolean f36056b0;
    public View f36057b1;
    public int f36058c;
    public NumberTextView f36059c0;
    public int f36060c1;
    public lf1 d;
    public org.telegram.ui.ActionBar.v0 f36061d0;
    public int f36062d1;
    public j0 f36063e;
    public org.telegram.ui.ActionBar.v0 f36064e0;
    public int f36065e1;
    public org.telegram.ui.Components.co f36066f;
    public org.telegram.ui.ActionBar.v0 f36067f0;
    public final bh.f f36068f1;
    public org.telegram.ui.ActionBar.v0 f36069g0;
    public final gh.d f36070g1;
    public org.telegram.ui.Components.y10 h;
    public org.telegram.ui.ActionBar.v0 f36071h0;
    public final gh.d f36072h1;
    public org.telegram.ui.ActionBar.v0 f36073i0;
    public final bh.b f36074i1;
    public org.telegram.ui.ActionBar.f1 f36075j0;
    public bh.l f36076j1;
    public org.telegram.ui.ActionBar.f1 f36077k0;
    public final ArrayList f36078k1;
    public org.telegram.ui.ActionBar.f1 f36079l0;
    public final RectF l1;
    public org.telegram.ui.ActionBar.v0 m0;
    public final RectF f36080m1;
    public uf1 f36081n;
    public RadialProgressView f36082n0;
    public v51 f36083o0;
    public org.telegram.ui.ActionBar.v0 f36084p0;
    public org.telegram.ui.ActionBar.v0 f36085q0;
    public final tf1 f36086r;
    public ag1 f36087r0;
    public final TopicsController f36088s;
    public boolean f36089s0;
    public final boolean f36090t0;
    public final boolean f36091u0;
    public fg1 v;
    public final boolean f36092v0;
    public ax f36093w;
    public final boolean f36094w0;
    public int f36095x;
    public final boolean f36096x0;
    public int f36097y;
    public String f36098y0;
    public boolean f36099z0;

    public eg1(Bundle bundle) {
        super(bundle);
        this.f36055b = new ArrayList();
        new ArrayList();
        this.f36086r = new tf1(this);
        this.f36095x = 0;
        this.E = true;
        this.G = true;
        this.V = true;
        this.W = 0.0f;
        this.f36053a0 = new HashSet();
        this.B0 = false;
        this.O0 = new AnimationNotificationsLocker(new int[]{NotificationCenter.topicsDidLoaded});
        this.S0 = 1.0f;
        new ArrayList();
        ArrayList arrayList = new ArrayList();
        this.f36078k1 = arrayList;
        RectF rectF = new RectF();
        this.l1 = rectF;
        RectF rectF2 = new RectF();
        this.f36080m1 = rectF2;
        arrayList.add(rectF);
        arrayList.add(rectF2);
        long j3 = this.arguments.getLong("chat_id", 0L);
        this.f36052a = j3;
        this.f36090t0 = this.arguments.getBoolean("for_select", false);
        this.f36091u0 = this.arguments.getBoolean("forward_to", false);
        this.f36096x0 = this.arguments.getBoolean("bot_share_to", false);
        this.f36092v0 = this.arguments.getBoolean("quote", false);
        this.f36094w0 = this.arguments.getBoolean("reply_to", false);
        this.f36098y0 = this.arguments.getString("voicechat", null);
        this.f36099z0 = this.arguments.getBoolean("videochat", false);
        this.f36088s = getMessagesController().getTopicsController();
        ...
        if (Build.VERSION.SDK_INT >= 31) {
            this.f36068f1 = new bh.f(false);
            this.f36070g1 = new gh.d(null);
    ...
    public static boolean U(eg1 eg1Var, TLRPC.TL_error tL_error) {
        ...
        edit.putLong("dialog_join_requested_time_" + (-eg1Var.f36052a), System.currentTimeMillis()).commit();
    ...
    public static void V(eg1 eg1Var, View view) {
        ...
        if (eg1Var.getParentLayout() != null && !((ActionBarLayout) eg1Var.getParentLayout()).y() && (view instanceof bg1)) {
            ...
            if (eg1Var.f36090t0) {
                fg1 fg1Var = eg1Var.v;
                if (fg1Var != null) {
                    hg1 hg1Var = fg1Var.f36430a;
                    Bundle bundle = new Bundle();
                    kg1 kg1Var = hg1Var.f37024a;
                    bundle.putLong("dialog_id", kg1Var.f38092c);
                    bundle.putLong("topic_id", tL_forumTopic.f19948id);
                    bundle.putBoolean("exception", true);
                    y11 y11Var = new y11(bundle, null);
                    y11Var.f42984r = new qv0(17, hg1Var, tL_forumTopic);
            ...
            } else if (eg1Var.f36053a0.size() > 0) {
                eg1Var.N0(view);
            } else {
                if (eg1Var.inPreviewMode && AndroidUtilities.isTablet()) {
                    for (org.telegram.ui.ActionBar.n2 n2Var : eg1Var.getParentLayout().getFragmentStack()) {
                        if (n2Var instanceof uy) {
                            uy uyVar2 = (uy) n2Var;
                            if (uyVar2.h4()) {
                                MessagesStorage.TopicKey topicKey = uyVar2.f41341p2;
    ...
    public static boolean W(eg1 eg1Var, View view, float f7) {
        if (eg1Var.f36090t0 || eg1Var.getParentLayout() == null || ((ActionBarLayout) eg1Var.getParentLayout()).y()) {
            return false;
        }
    ...
    public static void X(eg1 eg1Var) {
        ...
        if (t50Var != null && Build.VERSION.SDK_INT >= 23) {
            t50Var.setForeground(new ColorDrawable(i0.a.k(eg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20690d6), 100)));
        }
        eg1Var.P0();
    }
    ...
    public static void b0(eg1 eg1Var, boolean z10) {
        ...
        if (eg1Var.f36054a1 == null) {
            org.telegram.ui.Components.h81 n10 = eg1Var.f36087r0.n(8, false);
            eg1Var.f36054a1 = n10;
            if (eg1Var.M0 != null) {
                n10.setBackgroundColor(eg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20690d6));
            }
            eg1Var.f36063e.addView(eg1Var.f36054a1, w7.x5.c(44.0f, -1));
        }
        float f10 = eg1Var.W;
        if (z10) {
            f7 = 1.0f;
        ...
        AndroidUtilities.updateViewVisibilityAnimated(eg1Var.f36087r0, false, 1.0f, true);
        uy uyVar = eg1Var.M0;
        if (uyVar != null && (oxVar = uyVar.F3) != null) {
            oxVar.M = !z10;
        }
        if (!z10 && eg1Var.f36087r0.getVisibility() == 0 && eg1Var.f36087r0.getAlpha() == 1.0f) {
            z11 = true;
        } else {
            z11 = false;
        }
        ...
        eg1Var.f36087r0.setVisibility(0);
        if (!z10) {
            eg1Var.f36085q0.setVisibility(0);
        } else {
        ...
        eg1Var.Y0.setInterpolator(org.telegram.ui.Components.pr.f29493f);
        eg1Var.Y0.start();
        NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.needCheckSystemBarColors, Boolean.TRUE);
    }

    public final void A0() {
        this.J0 = this.f36088s.isLoading(this.f36052a);
        if (this.D0 != null) {
            ArrayList arrayList = this.f36055b;
            if (arrayList.size() == 0 || (arrayList.size() == 1 && ((vf1) arrayList.get(0)).f41560c != null && ((vf1) arrayList.get(0)).f41560c.f19948id == 1)) {
    ...
    public final void B0() {
        ...
        int i11 = this.f36065e1 + this.f36060c1;
        if (this.V) {
    ...
    public final void D0(HashSet hashSet, Runnable runnable) {
        ...
        if (hashSet.size() == 1) {
            b2Var.T = LocaleController.formatString(R.string.DeleteSelectedTopic, this.f36088s.findTopic(this.f36052a, ((Integer) arrayList.get(0)).intValue()).title);
        } else {
    ...
    public final void H0(boolean z10) {
        ...
        Bundle bundle = new Bundle();
        bundle.putLong("chat_id", this.f36052a);
        ProfileActivity profileActivity = new ProfileActivity(bundle, this.f36066f.getSharedMediaPreloader());
        profileActivity.K4(this.J);
        if (this.fragmentView.getMeasuredHeight() > this.fragmentView.getMeasuredWidth() && this.f36066f.getAvatarImageView().getImageReceiver().hasImageLoaded() && z10) {
            i10 = 2;
        } else {
            i10 = 1;
        }
    ...
    public final void M0(org.telegram.ui.Cells.r2 r2Var) {
        ...
        int b10 = r32[0].b(ooVar.f29167f);
        ooVar.f29175o = 1;
        long j10 = this.f36052a;
        long j11 = -j10;
        ...
        if (ChatObject.canManageTopics(g())) {
            ...
            f1Var.setOnClickListener(new View.OnClickListener(this) {
                ...
                public final void onClick(View view) {
                    switch (r3) {
                        case 0:
                            eg1 eg1Var = this.f36046b;
                            eg1Var.C0 = true;
                            eg1Var.N0 = true;
                            TopicsController topicsController = eg1Var.f36088s;
                            long j12 = eg1Var.f36052a;
                            TLRPC.TL_forumTopic tL_forumTopic2 = tL_forumTopic;
                            topicsController.pinTopic(j12, tL_forumTopic2.f19948id, !tL_forumTopic2.pinned, eg1Var);
                            eg1Var.finishPreviewFragment();
                            return;
                        case 1:
                            eg1 eg1Var2 = this.f36046b;
                            eg1Var2.N0 = true;
                            TopicsController topicsController2 = eg1Var2.f36088s;
                            long j13 = eg1Var2.f36052a;
        ...
        if (ChatObject.canDeleteTopic(this.currentAccount, g(), tL_forumTopic)) {
            ...
            f1Var4.setIconColor(getThemedColor(org.telegram.ui.ActionBar.j6.f20907p7));
            f1Var4.setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f20925q7));
        ...
        if ((view instanceof bg1) && (tL_forumTopic = (bg1Var = (bg1) view).N) != null) {
            ...
            if (!hashSet.isEmpty()) {
                if (!this.actionBar.a(null)) {
                    ...
                    this.f36059c0 = numberTextView;
                    numberTextView.setTextSize(18);
                    this.f36059c0.setTypeface(AndroidUtilities.bold());
                    this.f36059c0.setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f21071y8));
                    j10.addView(this.f36059c0, w7.x5.m(1.0f, 0, -1, 72, 0, 0));
                    this.f36059c0.setOnTouchListener(new ff1(0));
                    this.f36061d0 = j10.g(4, R.drawable.msg_pin, AndroidUtilities.dp(54.0f));
                    this.f36064e0 = j10.g(5, R.drawable.msg_unpin, AndroidUtilities.dp(54.0f));
                    this.f36067f0 = j10.g(6, R.drawable.msg_mute, AndroidUtilities.dp(54.0f));
                    this.f36069g0 = j10.h(7, R.drawable.msg_delete, LocaleController.getString(R.string.Delete), AndroidUtilities.dp(54.0f));
                    ...
                    this.m0 = h11;
                    this.f36075j0 = h11.e(8, R.drawable.msg_markread, LocaleController.getString(R.string.MarkAsRead));
                    this.f36077k0 = this.m0.e(9, R.drawable.msg_topic_close, LocaleController.getString(R.string.CloseTopic));
                    this.f36079l0 = this.m0.e(10, R.drawable.msg_topic_restart, LocaleController.getString(R.string.RestartTopic));
                }
                if (this.inPreviewMode) {
                ...
                if (i20 > 0) {
                    this.f36075j0.setVisibility(0);
                    this.f36075j0.g(LocaleController.getString(R.string.MarkAsRead), R.drawable.msg_markread, null);
                } else {
                    this.f36075j0.setVisibility(8);
                }
                if (i21 != 0) {
                    this.B0 = false;
                    this.f36067f0.setIcon(R.drawable.msg_unmute);
                    this.f36067f0.setContentDescription(LocaleController.getString(R.string.ChatsUnmute));
                    z10 = true;
                } else {
                    z10 = true;
                    this.B0 = true;
                    this.f36067f0.setIcon(R.drawable.msg_mute);
                    this.f36067f0.setContentDescription(LocaleController.getString(R.string.ChatsMute));
                }
                org.telegram.ui.ActionBar.v0 v0Var = this.f36061d0;
                if (i22 == z10 && i23 == 0) {
                    i10 = 0;
                } else {
                    i10 = 8;
                ...
                org.telegram.ui.ActionBar.v0 v0Var2 = this.f36064e0;
                if (i23 == z10 && i22 == 0) {
                    i11 = 0;
                } else {
                    i11 = 8;
                ...
                this.f36059c0.a(hashSet3.size(), z10);
                ...
                org.telegram.ui.ActionBar.f1 f1Var = this.f36077k0;
                if (i24 == 0 && i25 > 0) {
                    i12 = 0;
                } else {
                    i12 = 8;
                ...
                org.telegram.ui.ActionBar.f1 f1Var2 = this.f36077k0;
                if (i25 > 1) {
                ...
                org.telegram.ui.ActionBar.f1 f1Var3 = this.f36079l0;
                if (i25 == 0 && i24 > 0) {
                    i14 = 0;
                } else {
                    i14 = 8;
                ...
                org.telegram.ui.ActionBar.f1 f1Var4 = this.f36079l0;
                if (i24 > 1) {
                ...
                org.telegram.ui.ActionBar.v0 v0Var3 = this.f36069g0;
                ...
                org.telegram.ui.ActionBar.v0 v0Var4 = this.f36071h0;
                ...
                org.telegram.ui.ActionBar.v0 v0Var5 = this.f36073i0;
    ...
    public final void P0() {
        ...
        this.f36087r0.setBackgroundColor(getThemedColor(i10));
    }
    ...
    public final void Q0(boolean z10) {
        ...
        TLRPC.Chat chat = messagesController.getChat(Long.valueOf(j3));
        int i10 = 0;
        if (!ChatObject.isNotInChat(getMessagesController().getChat(Long.valueOf(j3))) && ChatObject.canCreateTopic(chat) && !this.f36089s0 && !this.f36090t0 && !this.J0) {
            z11 = true;
        } else {
            z11 = false;
        }
    ...
    public final void R0() {
        boolean z10;
        if (ChatObject.canManageTopics(g()) && !this.f36053a0.isEmpty()) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (this.f36056b0 != z10) {
            this.f36056b0 = z10;
            tf1 tf1Var = this.f36086r;
            tf1Var.q(0, tf1Var.h());
        }
    }
    ...
    public final void S0(float f7) {
        this.W = f7;
        int themedColor = getThemedColor(org.telegram.ui.ActionBar.j6.f21019v8);
        ...
        this.actionBar.B(i0.a.d(this.W, getThemedColor(org.telegram.ui.ActionBar.j6.f20983t8), getThemedColor(org.telegram.ui.ActionBar.j6.f21090z8)), false);
        if (!this.inPreviewMode) {
            this.actionBar.setBackgroundColor(i0.a.d(this.W, getThemedColor(org.telegram.ui.ActionBar.j6.f20964s8), getThemedColor(org.telegram.ui.ActionBar.j6.f20690d6)));
        }
        float f10 = 1.0f - f7;
        this.f36066f.getTitleTextView().setAlpha(f10);
        this.f36066f.getSubtitleTextView().setAlpha(f10);
        org.telegram.ui.Components.h81 h81Var = this.f36054a1;
        if (h81Var != null) {
            h81Var.setTranslationY((-AndroidUtilities.dp(16.0f)) * f10);
            this.f36054a1.setAlpha(f7);
        }
        this.f36087r0.setTranslationY((-AndroidUtilities.dp(16.0f)) * f10);
        this.f36087r0.setAlpha(f7);
        if (isInPreviewMode()) {
            this.f36063e.invalidate();
        }
        this.d.invalidate();
        this.N.setAlpha(f10);
        if (this.Z0) {
    ...
    public final void T0() {
        bi.m6 m6Var = this.D0;
        if (m6Var != null && m6Var.f32782e != null) {
            ...
            if (ChatObject.canUserDoAdminAction(g(), 15)) {
                this.D0.f32782e.setText(AndroidUtilities.replaceCharSequence("%s", AndroidUtilities.replaceTags(LocaleController.getString(R.string.NoTopicsDescription)), spannableStringBuilder));
                return;
            }
            String string = LocaleController.getString(R.string.General);
            TLRPC.TL_forumTopic findTopic = getMessagesController().getTopicsController().findTopic(this.f36052a, 1L);
            if (findTopic != null) {
                string = findTopic.title;
            }
            this.D0.f32782e.setText(AndroidUtilities.replaceTags(LocaleController.formatString("NoTopicsDescriptionUser", R.string.NoTopicsDescriptionUser, string)));
        }
    }
    ...
    public final void U0(boolean z10, boolean z11) {
        ...
        this.N0 = false;
        TopicsController topicsController = this.f36088s;
        long j3 = this.f36052a;
        ...
        if (topics != null) {
            ...
            arrayList.clear();
            rf1 rf1Var2 = null;
            if (UserObject.isBotForum(this.currentAccount, -j3) && this.f36091u0) {
            ...
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                ...
                if (vf1Var != null && (tL_forumTopic = vf1Var.f41560c) != null && tL_forumTopic.hidden) {
                    this.f36095x++;
                }
            }
            pf1 pf1Var = this.N;
    ...
    public final View createView(Context context) {
        ...
        lf1Var.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f20690d6));
        ...
        this.actionBar.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                ...
                switch (r2) {
                    case 0:
                        eg1 eg1Var = this.f34816b;
                        eg1Var.presentFragment(af1.a0(eg1Var.f36052a, 0L));
                        return;
                    case 1:
                        eg1 eg1Var2 = this.f34816b;
                        eg1Var2.getMessagesController().hidePeerSettingsBar(-eg1Var2.f36052a, null, eg1Var2.g());
                        eg1Var2.O0(false);
                        return;
                    case 2:
                        eg1 eg1Var3 = this.f34816b;
                        if (!eg1Var3.f36089s0) {
                            eg1Var3.H0(false);
                            return;
                        }
                        return;
                    case 3:
                        this.f34816b.finishPreviewFragment();
                        return;
                    default:
                        uy uyVar3 = this.f34816b.M0;
                        if (uyVar3 != null && (v0Var = uyVar3.f41312j0) != null) {
                            v0Var.performClick();
                            return;
                        }
                        return;
        ...
        if (this.M0 != null) {
            ...
            this.f36084p0.setSearchPaddingStart(56);
            this.f36084p0.setSearchFieldHint(LocaleController.getString(R.string.Search));
            EditTextBoldCursor searchField = this.f36084p0.getSearchField();
        ...
        this.f36085q0.e(1, R.drawable.msg_discussion, LocaleController.getString(R.string.TopicViewAsMessages));
        this.R = this.f36085q0.e(2, R.drawable.msg_addcontact, LocaleController.getString(R.string.AddMember));
        org.telegram.ui.ActionBar.v0 v0Var = this.f36085q0;
        ...
        this.Q = this.f36085q0.e(3, R.drawable.msg_topic_create, LocaleController.getString(R.string.CreateTopic));
        this.U = this.f36085q0.e(15, R.drawable.msg_report, LocaleController.getString(R.string.ReportChat));
        this.S = this.f36085q0.f(11, R.drawable.msg_leave, LocaleController.getString(R.string.LeaveMegaMenu), null);
        ...
        org.telegram.ui.Components.co coVar2 = this.f36066f;
        if (!AndroidUtilities.isTablet() && !this.inPreviewMode) {
            z11 = true;
        } else {
            z11 = false;
        ...
        org.telegram.ui.Components.co coVar3 = this.f36066f;
        long j3 = -this.f36052a;
        if (j3 < 0) {
            z12 = true;
        } else {
        ...
        this.actionBar.addView(this.f36066f, 0, w7.x5.d(-2, -1.0f, 51, 56.0f, 0.0f, 86.0f, 0.0f));
        if (!this.f36090t0) {
            this.f36066f.getAvatarImageView().setOnClickListener(new y7(this, 3));
        }
        this.N = new pf1(this, context);
        ih.k kVar2 = new ih.k(this.d);
        ViewGroup viewGroup = this.d;
        bh.b bVar = this.f36074i1;
        bVar.d = kVar2;
        ...
        this.f36076j1 = new bh.l(pf1Var, viewGroup, new v8(pf1Var2, 2));
        ...
        new SparseArray();
        new HashMap();
        this.N.setAdapter(this.f36086r);
            ...
            public final void onClick(View view) {
                ...
                switch (r2) {
                    ...
                    case 3:
                        ...
                        return;
                    default:
                        uy uyVar32 = this.f34816b.M0;
                        if (uyVar32 != null && (v0Var2 = uyVar32.f41312j0) != null) {
                            v0Var2.performClick();
                            return;
                        }
                        return;
        ...
        this.h.f32839c.setImageResource(R.drawable.ic_chatlist_add_2);
        this.h.f32839c.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
        this.h.f32839c.setPadding(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f));
        ...
        textView.setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f21069y6));
        ...
        this.f36081n = frameLayout;
        textView.setAlpha(0.0f);
        bi.m6 m6Var = new bi.m6(this, context, t00Var);
        this.D0 = m6Var;
        try {
            m6Var.f32780b.getImageReceiver().setAutoRepeat(2);
        } catch (Exception unused) {
        }
        this.D0.e(this.J0, this.fragmentBeginToShow);
        this.D0.d.setText(LocaleController.getString(R.string.NoTopics));
        T0();
        this.f36081n.addView(t00Var);
        this.f36081n.addView(this.D0);
        this.d.addView(this.f36081n);
        this.N.setEmptyView(this.f36081n);
        this.f36083o0 = new v51(context, 6);
        org.telegram.ui.Components.f61 f61Var = new org.telegram.ui.Components.f61(context);
        this.L = f61Var;
        this.f36083o0.addView(f61Var);
        this.d.addView(this.f36083o0, w7.x5.e(-1, 51, 80));
        this.L.setOnClickListener(new jf1(this));
        RadialProgressView radialProgressView = new RadialProgressView(context, null);
        this.f36082n0 = radialProgressView;
        radialProgressView.setSize(AndroidUtilities.dp(22.0f));
        this.f36082n0.setVisibility(4);
        this.f36083o0.addView(this.f36082n0, w7.x5.e(30, 30, 17));
        ImageView imageView = new ImageView(context);
        this.W0 = imageView;
        imageView.setImageResource(R.drawable.miniplayer_close);
        this.W0.setContentDescription(LocaleController.getString(R.string.Close));
        ImageView imageView2 = this.W0;
        int i13 = org.telegram.ui.ActionBar.j6.f20698de;
        ...
        this.f36083o0.addView(this.W0, w7.x5.d(36, 36.0f, 53, 0.0f, 6.0f, 2.0f, 0.0f));
        ...
        this.f36087r0 = ag1Var;
        ag1Var.setVisibility(8);
        this.f36063e.addView(this.f36087r0, w7.x5.d(-1, -1.0f, 119, 0.0f, 44.0f, 0.0f, 0.0f));
        ag1 ag1Var2 = this.f36087r0;
        ...
        getMessagesStorage().loadChatInfo(this.f36052a, true, null, true, false, 0);
        ...
        if (g10 != null) {
            ...
            this.U0.g(this.R0.c());
            xh.d dVar2 = this.R0;
            dVar2.f49439m = new df1(this);
            TLRPC.ChatFull chatFull = this.J;
            dVar2.f49436j = chatFull;
            if (chatFull != null) {
        ...
        if (this.inPreviewMode && AndroidUtilities.isTablet()) {
            ...
            while (true) {
                ...
                if (n2Var instanceof uy) {
                    uy uyVar4 = (uy) n2Var;
                    if (uyVar4.h4()) {
                        MessagesStorage.TopicKey topicKey = uyVar4.f41341p2;
    ...
    public final TLRPC.Chat g() {
        return getMessagesController().getChat(Long.valueOf(this.f36052a));
    }
    ...
    public final boolean isLightStatusBar() {
        ...
        if (this.actionBar.s()) {
            themedColor = getThemedColor(org.telegram.ui.ActionBar.j6.f21037w8);
        }
    ...
    public final boolean onBackPressed(boolean z10) {
        if (!this.f36053a0.isEmpty()) {
            if (z10) {
                C0();
                return false;
            }
        } else if (this.f36089s0) {
            if (z10) {
                this.actionBar.v(this.f36084p0.L(false));
            }
        } else {
    ...
    public final void onFragmentDestroy() {
        ...
        TLRPC.Chat chat = getMessagesController().getChat(Long.valueOf(this.f36052a));
        if (ChatObject.isChannel(chat)) {
    ...
    public final void onPause() {
        super.onPause();
        getMessagesController().getTopicsController().onTopicFragmentPause(this.f36052a);
    ...
    public final void setPreviewOpenedProgress(float f7) {
        org.telegram.ui.Components.co coVar = this.f36066f;
        if (coVar != null) {
            coVar.setAlpha(f7);
            this.f36085q0.setAlpha(f7);
            org.telegram.ui.ActionBar.v0 v0Var = this.f36084p0;
            if (v0Var != null) {
                v0Var.setAlpha(f7);
            }
    ...
    public final void setPreviewReplaceProgress(float f7) {
        ...
        if (coVar != null) {
            coVar.setAlpha(f7);
            this.f36066f.setTranslationX((1.0f - f7) * AndroidUtilities.dp(40.0f));
        }
    }

    @Override
    public final gh.d x() {
        return this.f36072h1;
    }
    ...
    public final void x0() {
        ...
        float f7;
        int i10;
        if (Build.VERSION.SDK_INT >= 31 && (fVar = this.f36068f1) != null) {
            ...
            int measuredHeight = (view.getMeasuredHeight() - this.f36065e1) - AndroidUtilities.dp(8.0f);
            this.l1.set(0.0f, -dp, view.getMeasuredWidth(), kVar.getMeasuredHeight() + dp + dp2);
            RectF rectF = this.f36080m1;
            ...
            fVar.g(i10, this.f36078k1);
            fVar.e(this.f36076j1, view.getMeasuredWidth(), view.getMeasuredHeight());
        }
    }
    ...
    public final void y0() {
        ...
        if (!topicsController.endIsReached(j3) && (gf1Var = this.F) != null) {
            int N0 = gf1Var.N0();
            if (this.f36055b.isEmpty() || N0 >= this.f36086r.h() - 5) {
    ...
    public final void z0(boolean z10) {
        ...
        ChatObject.Call call = this.H0;
        if (call != null && ((str = this.f36098y0) != null || this.f36099z0)) {
            ...
            this.f36098y0 = null;
            this.f36099z0 = false;
        } else if (this.f36098y0 != null && z10 && chatFull != null && chatFull.call == null && this.fragmentView != null && getParentActivity() != null) {
