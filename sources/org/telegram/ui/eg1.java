...
public class eg1 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.Components.ch, dh0 {
    public static final HashSet f36025n1 = new HashSet();
    public HashSet A0;
    public boolean B0;
    public boolean C0;
    public bi.m6 D0;
    ...
    public final HashSet f36027a0;
    public org.telegram.ui.Components.h81 f36028a1;
    public final ArrayList f36029b;
    public boolean f36030b0;
    public View f36031b1;
    public int f36032c;
    public NumberTextView f36033c0;
    public int f36034c1;
    public lf1 d;
    public org.telegram.ui.ActionBar.v0 f36035d0;
    public int f36036d1;
    public j0 f36037e;
    public org.telegram.ui.ActionBar.v0 f36038e0;
    public int f36039e1;
    public org.telegram.ui.Components.co f36040f;
    public org.telegram.ui.ActionBar.v0 f36041f0;
    public final bh.f f36042f1;
    public org.telegram.ui.ActionBar.v0 f36043g0;
    public final gh.d f36044g1;
    public org.telegram.ui.Components.y10 h;
    public org.telegram.ui.ActionBar.v0 f36045h0;
    public final gh.d f36046h1;
    public org.telegram.ui.ActionBar.v0 f36047i0;
    public final bh.b f36048i1;
    public org.telegram.ui.ActionBar.f1 f36049j0;
    public bh.l f36050j1;
    public org.telegram.ui.ActionBar.f1 f36051k0;
    public final ArrayList f36052k1;
    public org.telegram.ui.ActionBar.f1 f36053l0;
    public final RectF l1;
    public org.telegram.ui.ActionBar.v0 m0;
    public final RectF f36054m1;
    public uf1 f36055n;
    public RadialProgressView f36056n0;
    public v51 f36057o0;
    public org.telegram.ui.ActionBar.v0 f36058p0;
    public org.telegram.ui.ActionBar.v0 f36059q0;
    public final tf1 f36060r;
    public ag1 f36061r0;
    public final TopicsController f36062s;
    public boolean f36063s0;
    public final boolean f36064t0;
    public final boolean f36065u0;
    public fg1 v;
    public final boolean f36066v0;
    public ax f36067w;
    public final boolean f36068w0;
    public int f36069x;
    public final boolean f36070x0;
    public int f36071y;
    public String f36072y0;
    public boolean f36073z0;

    public eg1(Bundle bundle) {
        super(bundle);
        this.f36029b = new ArrayList();
        new ArrayList();
        this.f36060r = new tf1(this);
        this.f36069x = 0;
        this.E = true;
        this.G = true;
        this.V = true;
        this.W = 0.0f;
        this.f36027a0 = new HashSet();
        this.B0 = false;
        this.O0 = new AnimationNotificationsLocker(new int[]{NotificationCenter.topicsDidLoaded});
        this.S0 = 1.0f;
        new ArrayList();
        ArrayList arrayList = new ArrayList();
        this.f36052k1 = arrayList;
        RectF rectF = new RectF();
        this.l1 = rectF;
        RectF rectF2 = new RectF();
        this.f36054m1 = rectF2;
        arrayList.add(rectF);
        arrayList.add(rectF2);
        long j3 = this.arguments.getLong("chat_id", 0L);
        this.f36026a = j3;
        this.f36064t0 = this.arguments.getBoolean("for_select", false);
        this.f36065u0 = this.arguments.getBoolean("forward_to", false);
        this.f36070x0 = this.arguments.getBoolean("bot_share_to", false);
        this.f36066v0 = this.arguments.getBoolean("quote", false);
        this.f36068w0 = this.arguments.getBoolean("reply_to", false);
        this.f36072y0 = this.arguments.getString("voicechat", null);
        this.f36073z0 = this.arguments.getBoolean("videochat", false);
        this.f36062s = getMessagesController().getTopicsController();
        ...
        if (Build.VERSION.SDK_INT >= 31) {
            this.f36042f1 = new bh.f(false);
            this.f36044g1 = new gh.d(null);
    ...
    public static boolean U(eg1 eg1Var, TLRPC.TL_error tL_error) {
        ...
        edit.putLong("dialog_join_requested_time_" + (-eg1Var.f36026a), System.currentTimeMillis()).commit();
        ...
        int i10 = org.telegram.ui.Components.g80.f26321r;
    ...
    public static void V(eg1 eg1Var, View view) {
        ...
        if (eg1Var.getParentLayout() != null && !((ActionBarLayout) eg1Var.getParentLayout()).y() && (view instanceof bg1)) {
            ...
            if (eg1Var.f36064t0) {
                fg1 fg1Var = eg1Var.v;
                if (fg1Var != null) {
                    hg1 hg1Var = fg1Var.f36404a;
                    Bundle bundle = new Bundle();
                    kg1 kg1Var = hg1Var.f36998a;
                    bundle.putLong("dialog_id", kg1Var.f38066c);
                    bundle.putLong("topic_id", tL_forumTopic.f19921id);
                    bundle.putBoolean("exception", true);
                    y11 y11Var = new y11(bundle, null);
                    y11Var.f42958r = new qv0(17, hg1Var, tL_forumTopic);
            ...
            } else if (eg1Var.f36027a0.size() > 0) {
                eg1Var.N0(view);
            } else {
                if (eg1Var.inPreviewMode && AndroidUtilities.isTablet()) {
                    for (org.telegram.ui.ActionBar.n2 n2Var : eg1Var.getParentLayout().getFragmentStack()) {
                        if (n2Var instanceof uy) {
                            uy uyVar2 = (uy) n2Var;
                            if (uyVar2.h4()) {
                                MessagesStorage.TopicKey topicKey = uyVar2.f41315p2;
    ...
    public static boolean W(eg1 eg1Var, View view, float f7) {
        if (eg1Var.f36064t0 || eg1Var.getParentLayout() == null || ((ActionBarLayout) eg1Var.getParentLayout()).y()) {
            return false;
        }
    ...
    public static void X(eg1 eg1Var) {
        ...
        if (t50Var != null && Build.VERSION.SDK_INT >= 23) {
            t50Var.setForeground(new ColorDrawable(i0.a.k(eg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20664d6), 100)));
        }
        eg1Var.P0();
    }
    ...
    public static void b0(eg1 eg1Var, boolean z10) {
        ...
        if (eg1Var.f36028a1 == null) {
            org.telegram.ui.Components.h81 n10 = eg1Var.f36061r0.n(8, false);
            eg1Var.f36028a1 = n10;
            if (eg1Var.M0 != null) {
                n10.setBackgroundColor(eg1Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20664d6));
            }
            eg1Var.f36037e.addView(eg1Var.f36028a1, w7.x5.c(44.0f, -1));
        }
        float f10 = eg1Var.W;
        if (z10) {
            f7 = 1.0f;
        ...
        AndroidUtilities.updateViewVisibilityAnimated(eg1Var.f36061r0, false, 1.0f, true);
        uy uyVar = eg1Var.M0;
        if (uyVar != null && (oxVar = uyVar.F3) != null) {
            oxVar.M = !z10;
        }
        if (!z10 && eg1Var.f36061r0.getVisibility() == 0 && eg1Var.f36061r0.getAlpha() == 1.0f) {
            z11 = true;
        } else {
            z11 = false;
        }
        ...
        eg1Var.f36061r0.setVisibility(0);
        if (!z10) {
            eg1Var.f36059q0.setVisibility(0);
        } else {
        ...
        eg1Var.Y0.setInterpolator(org.telegram.ui.Components.pr.f29467f);
        eg1Var.Y0.start();
        NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.needCheckSystemBarColors, Boolean.TRUE);
    }

    public final void A0() {
        this.J0 = this.f36062s.isLoading(this.f36026a);
        if (this.D0 != null) {
            ArrayList arrayList = this.f36029b;
            if (arrayList.size() == 0 || (arrayList.size() == 1 && ((vf1) arrayList.get(0)).f41534c != null && ((vf1) arrayList.get(0)).f41534c.f19921id == 1)) {
    ...
    public final void B0() {
        ...
        int i11 = this.f36039e1 + this.f36034c1;
        if (this.V) {
    ...
    public final void D0(HashSet hashSet, Runnable runnable) {
        ...
        if (hashSet.size() == 1) {
            b2Var.T = LocaleController.formatString(R.string.DeleteSelectedTopic, this.f36062s.findTopic(this.f36026a, ((Integer) arrayList.get(0)).intValue()).title);
        } else {
    ...
    public final void H0(boolean z10) {
        ...
        Bundle bundle = new Bundle();
        bundle.putLong("chat_id", this.f36026a);
        ProfileActivity profileActivity = new ProfileActivity(bundle, this.f36040f.getSharedMediaPreloader());
        profileActivity.K4(this.J);
        if (this.fragmentView.getMeasuredHeight() > this.fragmentView.getMeasuredWidth() && this.f36040f.getAvatarImageView().getImageReceiver().hasImageLoaded() && z10) {
            i10 = 2;
        } else {
            i10 = 1;
        }
    ...
    public final void J0(int i10) {
        ...
        if (this.M != i10) {
            ...
            if (i10 == 0) {
                ...
                i11 = org.telegram.ui.ActionBar.j6.f20899q7;
            }
    ...
    public final void M0(org.telegram.ui.Cells.r2 r2Var) {
        ...
        if (ChatObject.canManageTopics(g())) {
            ...
            f1Var.setOnClickListener(new View.OnClickListener(this) {
                ...
                public final void onClick(View view) {
                    switch (r3) {
                        case 0:
                            eg1 eg1Var = this.f36020b;
                            eg1Var.C0 = true;
                            eg1Var.N0 = true;
                            TopicsController topicsController = eg1Var.f36062s;
                            long j12 = eg1Var.f36026a;
                            TLRPC.TL_forumTopic tL_forumTopic2 = tL_forumTopic;
                            topicsController.pinTopic(j12, tL_forumTopic2.f19921id, !tL_forumTopic2.pinned, eg1Var);
                            eg1Var.finishPreviewFragment();
                            return;
                        case 1:
                            eg1 eg1Var2 = this.f36020b;
                            eg1Var2.N0 = true;
                            TopicsController topicsController2 = eg1Var2.f36062s;
                            long j13 = eg1Var2.f36026a;
        ...
        if (ChatObject.canDeleteTopic(this.currentAccount, g(), tL_forumTopic)) {
            ...
            f1Var4.setIconColor(getThemedColor(org.telegram.ui.ActionBar.j6.f20881p7));
            f1Var4.setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f20899q7));
        ...
        if ((view instanceof bg1) && (tL_forumTopic = (bg1Var = (bg1) view).N) != null) {
            ...
            if (!hashSet.isEmpty()) {
                if (!this.actionBar.a(null)) {
                    ...
                    this.f36033c0 = numberTextView;
                    numberTextView.setTextSize(18);
                    this.f36033c0.setTypeface(AndroidUtilities.bold());
                    this.f36033c0.setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f21045y8));
                    j10.addView(this.f36033c0, w7.x5.m(1.0f, 0, -1, 72, 0, 0));
                    this.f36033c0.setOnTouchListener(new ff1(0));
                    this.f36035d0 = j10.g(4, R.drawable.msg_pin, AndroidUtilities.dp(54.0f));
                    this.f36038e0 = j10.g(5, R.drawable.msg_unpin, AndroidUtilities.dp(54.0f));
                    this.f36041f0 = j10.g(6, R.drawable.msg_mute, AndroidUtilities.dp(54.0f));
                    this.f36043g0 = j10.h(7, R.drawable.msg_delete, LocaleController.getString(R.string.Delete), AndroidUtilities.dp(54.0f));
                    ...
                    this.m0 = h11;
                    this.f36049j0 = h11.e(8, R.drawable.msg_markread, LocaleController.getString(R.string.MarkAsRead));
                    this.f36051k0 = this.m0.e(9, R.drawable.msg_topic_close, LocaleController.getString(R.string.CloseTopic));
                    this.f36053l0 = this.m0.e(10, R.drawable.msg_topic_restart, LocaleController.getString(R.string.RestartTopic));
                }
                if (this.inPreviewMode) {
                ...
                if (i20 > 0) {
                    this.f36049j0.setVisibility(0);
                    this.f36049j0.g(LocaleController.getString(R.string.MarkAsRead), R.drawable.msg_markread, null);
                } else {
                    this.f36049j0.setVisibility(8);
                }
                if (i21 != 0) {
                    this.B0 = false;
                    this.f36041f0.setIcon(R.drawable.msg_unmute);
                    this.f36041f0.setContentDescription(LocaleController.getString(R.string.ChatsUnmute));
                    z10 = true;
                } else {
                    z10 = true;
                    this.B0 = true;
                    this.f36041f0.setIcon(R.drawable.msg_mute);
                    this.f36041f0.setContentDescription(LocaleController.getString(R.string.ChatsMute));
                }
                org.telegram.ui.ActionBar.v0 v0Var = this.f36035d0;
                if (i22 == z10 && i23 == 0) {
                    i10 = 0;
                } else {
                    i10 = 8;
                ...
                org.telegram.ui.ActionBar.v0 v0Var2 = this.f36038e0;
                if (i23 == z10 && i22 == 0) {
                    i11 = 0;
                } else {
                    i11 = 8;
                ...
                this.f36033c0.a(hashSet3.size(), z10);
                ...
                org.telegram.ui.ActionBar.f1 f1Var = this.f36051k0;
                if (i24 == 0 && i25 > 0) {
                    i12 = 0;
                } else {
                    i12 = 8;
                ...
                org.telegram.ui.ActionBar.f1 f1Var2 = this.f36051k0;
                if (i25 > 1) {
                ...
                org.telegram.ui.ActionBar.f1 f1Var3 = this.f36053l0;
                if (i25 == 0 && i24 > 0) {
                    i14 = 0;
                } else {
                    i14 = 8;
                ...
                org.telegram.ui.ActionBar.f1 f1Var4 = this.f36053l0;
                if (i24 > 1) {
                ...
                org.telegram.ui.ActionBar.v0 v0Var3 = this.f36043g0;
                ...
                org.telegram.ui.ActionBar.v0 v0Var4 = this.f36045h0;
                ...
                org.telegram.ui.ActionBar.v0 v0Var5 = this.f36047i0;
    ...
    public final void P0() {
        ...
        if (!this.inPreviewMode) {
            this.actionBar.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f20938s8));
        }
        this.f36061r0.setBackgroundColor(getThemedColor(i10));
    }
    ...
    public final void Q0(boolean z10) {
        ...
        TLRPC.Chat chat = messagesController.getChat(Long.valueOf(j3));
        int i10 = 0;
        if (!ChatObject.isNotInChat(getMessagesController().getChat(Long.valueOf(j3))) && ChatObject.canCreateTopic(chat) && !this.f36063s0 && !this.f36064t0 && !this.J0) {
            z11 = true;
        } else {
            z11 = false;
        }
    ...
    public final void R0() {
        boolean z10;
        if (ChatObject.canManageTopics(g()) && !this.f36027a0.isEmpty()) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (this.f36030b0 != z10) {
            this.f36030b0 = z10;
            tf1 tf1Var = this.f36060r;
            tf1Var.q(0, tf1Var.h());
        }
    }
    ...
    public final void S0(float f7) {
        this.W = f7;
        int themedColor = getThemedColor(org.telegram.ui.ActionBar.j6.f20993v8);
        ...
        this.actionBar.B(i0.a.d(this.W, getThemedColor(org.telegram.ui.ActionBar.j6.f20957t8), getThemedColor(org.telegram.ui.ActionBar.j6.f21064z8)), false);
        if (!this.inPreviewMode) {
            this.actionBar.setBackgroundColor(i0.a.d(this.W, getThemedColor(org.telegram.ui.ActionBar.j6.f20938s8), getThemedColor(org.telegram.ui.ActionBar.j6.f20664d6)));
        }
        float f10 = 1.0f - f7;
        this.f36040f.getTitleTextView().setAlpha(f10);
        this.f36040f.getSubtitleTextView().setAlpha(f10);
        org.telegram.ui.Components.h81 h81Var = this.f36028a1;
        if (h81Var != null) {
            h81Var.setTranslationY((-AndroidUtilities.dp(16.0f)) * f10);
            this.f36028a1.setAlpha(f7);
        }
        this.f36061r0.setTranslationY((-AndroidUtilities.dp(16.0f)) * f10);
        this.f36061r0.setAlpha(f7);
        if (isInPreviewMode()) {
            this.f36037e.invalidate();
        }
        this.d.invalidate();
        this.N.setAlpha(f10);
        if (this.Z0) {
    ...
    public final void T0() {
        bi.m6 m6Var = this.D0;
        if (m6Var != null && m6Var.f32756e != null) {
            ...
            if (ChatObject.canUserDoAdminAction(g(), 15)) {
                this.D0.f32756e.setText(AndroidUtilities.replaceCharSequence("%s", AndroidUtilities.replaceTags(LocaleController.getString(R.string.NoTopicsDescription)), spannableStringBuilder));
                return;
            }
            String string = LocaleController.getString(R.string.General);
            TLRPC.TL_forumTopic findTopic = getMessagesController().getTopicsController().findTopic(this.f36026a, 1L);
            if (findTopic != null) {
                string = findTopic.title;
            }
            this.D0.f32756e.setText(AndroidUtilities.replaceTags(LocaleController.formatString("NoTopicsDescriptionUser", R.string.NoTopicsDescriptionUser, string)));
        }
    }
    ...
    public final void U0(boolean z10, boolean z11) {
        ...
        this.N0 = false;
        TopicsController topicsController = this.f36062s;
        long j3 = this.f36026a;
        ...
        if (topics != null) {
            ...
            arrayList.clear();
            rf1 rf1Var2 = null;
            if (UserObject.isBotForum(this.currentAccount, -j3) && this.f36065u0) {
            ...
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                ...
                if (vf1Var != null && (tL_forumTopic = vf1Var.f41534c) != null && tL_forumTopic.hidden) {
                    this.f36069x++;
                }
            }
            pf1 pf1Var = this.N;
    ...
    public final View createView(Context context) {
        ...
        lf1Var.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f20664d6));
        ...
        this.actionBar.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                ...
                switch (r2) {
                    case 0:
                        eg1 eg1Var = this.f34790b;
                        eg1Var.presentFragment(af1.a0(eg1Var.f36026a, 0L));
                        return;
                    case 1:
                        eg1 eg1Var2 = this.f34790b;
                        eg1Var2.getMessagesController().hidePeerSettingsBar(-eg1Var2.f36026a, null, eg1Var2.g());
                        eg1Var2.O0(false);
                        return;
                    case 2:
                        eg1 eg1Var3 = this.f34790b;
                        if (!eg1Var3.f36063s0) {
                            eg1Var3.H0(false);
                            return;
                        }
                        return;
                    case 3:
                        this.f34790b.finishPreviewFragment();
                        return;
                    default:
                        uy uyVar3 = this.f34790b.M0;
                        if (uyVar3 != null && (v0Var = uyVar3.f41286j0) != null) {
                            v0Var.performClick();
                            return;
                        }
                        return;
        ...
        if (this.M0 != null) {
            ...
            this.f36058p0.setSearchPaddingStart(56);
            this.f36058p0.setSearchFieldHint(LocaleController.getString(R.string.Search));
            EditTextBoldCursor searchField = this.f36058p0.getSearchField();
        ...
        this.f36059q0.e(1, R.drawable.msg_discussion, LocaleController.getString(R.string.TopicViewAsMessages));
        this.R = this.f36059q0.e(2, R.drawable.msg_addcontact, LocaleController.getString(R.string.AddMember));
        org.telegram.ui.ActionBar.v0 v0Var = this.f36059q0;
        ...
        this.Q = this.f36059q0.e(3, R.drawable.msg_topic_create, LocaleController.getString(R.string.CreateTopic));
        this.U = this.f36059q0.e(15, R.drawable.msg_report, LocaleController.getString(R.string.ReportChat));
        this.S = this.f36059q0.f(11, R.drawable.msg_leave, LocaleController.getString(R.string.LeaveMegaMenu), null);
        ...
        org.telegram.ui.Components.co coVar2 = this.f36040f;
        if (!AndroidUtilities.isTablet() && !this.inPreviewMode) {
            z11 = true;
        } else {
            z11 = false;
        ...
        org.telegram.ui.Components.co coVar3 = this.f36040f;
        long j3 = -this.f36026a;
        if (j3 < 0) {
            z12 = true;
        } else {
        ...
        this.actionBar.addView(this.f36040f, 0, w7.x5.d(-2, -1.0f, 51, 56.0f, 0.0f, 86.0f, 0.0f));
        if (!this.f36064t0) {
            this.f36040f.getAvatarImageView().setOnClickListener(new y7(this, 3));
        }
        this.N = new pf1(this, context);
        ih.k kVar2 = new ih.k(this.d);
        ViewGroup viewGroup = this.d;
        bh.b bVar = this.f36048i1;
        bVar.d = kVar2;
        ...
        this.f36050j1 = new bh.l(pf1Var, viewGroup, new v8(pf1Var2, 2));
        ...
        new SparseArray();
        new HashMap();
        this.N.setAdapter(this.f36060r);
            ...
            public final void onClick(View view) {
                ...
                switch (r2) {
                    ...
                    case 3:
                        ...
                        return;
                    default:
                        uy uyVar32 = this.f34790b.M0;
                        if (uyVar32 != null && (v0Var2 = uyVar32.f41286j0) != null) {
                            v0Var2.performClick();
                            return;
                        }
                        return;
        ...
        this.h.f32813c.setImageResource(R.drawable.ic_chatlist_add_2);
        this.h.f32813c.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
        this.h.f32813c.setPadding(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f));
        ...
        textView.setTextColor(getThemedColor(org.telegram.ui.ActionBar.j6.f21043y6));
        ...
        this.f36055n = frameLayout;
        textView.setAlpha(0.0f);
        bi.m6 m6Var = new bi.m6(this, context, t00Var);
        this.D0 = m6Var;
        try {
            m6Var.f32754b.getImageReceiver().setAutoRepeat(2);
        } catch (Exception unused) {
        }
        this.D0.e(this.J0, this.fragmentBeginToShow);
        this.D0.d.setText(LocaleController.getString(R.string.NoTopics));
        T0();
        this.f36055n.addView(t00Var);
        this.f36055n.addView(this.D0);
        this.d.addView(this.f36055n);
        this.N.setEmptyView(this.f36055n);
        this.f36057o0 = new v51(context, 6);
        org.telegram.ui.Components.f61 f61Var = new org.telegram.ui.Components.f61(context);
        this.L = f61Var;
        this.f36057o0.addView(f61Var);
        this.d.addView(this.f36057o0, w7.x5.e(-1, 51, 80));
        this.L.setOnClickListener(new jf1(this));
        RadialProgressView radialProgressView = new RadialProgressView(context, null);
        this.f36056n0 = radialProgressView;
        radialProgressView.setSize(AndroidUtilities.dp(22.0f));
        this.f36056n0.setVisibility(4);
        this.f36057o0.addView(this.f36056n0, w7.x5.e(30, 30, 17));
        ImageView imageView = new ImageView(context);
        this.W0 = imageView;
        imageView.setImageResource(R.drawable.miniplayer_close);
        this.W0.setContentDescription(LocaleController.getString(R.string.Close));
        ImageView imageView2 = this.W0;
        int i13 = org.telegram.ui.ActionBar.j6.f20672de;
        ...
        this.f36057o0.addView(this.W0, w7.x5.d(36, 36.0f, 53, 0.0f, 6.0f, 2.0f, 0.0f));
        ...
        this.f36061r0 = ag1Var;
        ag1Var.setVisibility(8);
        this.f36037e.addView(this.f36061r0, w7.x5.d(-1, -1.0f, 119, 0.0f, 44.0f, 0.0f, 0.0f));
        ag1 ag1Var2 = this.f36061r0;
        ...
        getMessagesStorage().loadChatInfo(this.f36026a, true, null, true, false, 0);
        ...
        if (g10 != null) {
            ...
            this.U0.g(this.R0.c());
            xh.d dVar2 = this.R0;
            dVar2.f49411m = new df1(this);
            TLRPC.ChatFull chatFull = this.J;
            dVar2.f49408j = chatFull;
            if (chatFull != null) {
        ...
        if (this.inPreviewMode && AndroidUtilities.isTablet()) {
            ...
            while (true) {
                ...
                if (n2Var instanceof uy) {
                    uy uyVar4 = (uy) n2Var;
                    if (uyVar4.h4()) {
                        MessagesStorage.TopicKey topicKey = uyVar4.f41315p2;
    ...
    public final TLRPC.Chat g() {
        return getMessagesController().getChat(Long.valueOf(this.f36026a));
    }
    ...
    public final boolean isLightStatusBar() {
        int i10;
        if (this.f36063s0) {
            i10 = org.telegram.ui.ActionBar.j6.f20664d6;
        } else {
            i10 = org.telegram.ui.ActionBar.j6.f20938s8;
        }
        int themedColor = getThemedColor(i10);
        if (this.actionBar.s()) {
            themedColor = getThemedColor(org.telegram.ui.ActionBar.j6.f21011w8);
        }
    ...
    public final boolean onBackPressed(boolean z10) {
        if (!this.f36027a0.isEmpty()) {
            if (z10) {
                C0();
                return false;
            }
        } else if (this.f36063s0) {
            if (z10) {
                this.actionBar.v(this.f36058p0.L(false));
            }
        } else {
    ...
    public final void onFragmentDestroy() {
        ...
        TLRPC.Chat chat = getMessagesController().getChat(Long.valueOf(this.f36026a));
        if (ChatObject.isChannel(chat)) {
    ...
    public final void onPause() {
        super.onPause();
        getMessagesController().getTopicsController().onTopicFragmentPause(this.f36026a);
    ...
    public final void setPreviewOpenedProgress(float f7) {
        org.telegram.ui.Components.co coVar = this.f36040f;
        if (coVar != null) {
            coVar.setAlpha(f7);
            this.f36059q0.setAlpha(f7);
            org.telegram.ui.ActionBar.v0 v0Var = this.f36058p0;
            if (v0Var != null) {
                v0Var.setAlpha(f7);
            }
    ...
    public final void setPreviewReplaceProgress(float f7) {
        ...
        if (coVar != null) {
            coVar.setAlpha(f7);
            this.f36040f.setTranslationX((1.0f - f7) * AndroidUtilities.dp(40.0f));
        }
    }

    @Override
    public final gh.d x() {
        return this.f36046h1;
    }
    ...
    public final void x0() {
        ...
        float f7;
        int i10;
        if (Build.VERSION.SDK_INT >= 31 && (fVar = this.f36042f1) != null) {
            ...
            int measuredHeight = (view.getMeasuredHeight() - this.f36039e1) - AndroidUtilities.dp(8.0f);
            this.l1.set(0.0f, -dp, view.getMeasuredWidth(), kVar.getMeasuredHeight() + dp + dp2);
            RectF rectF = this.f36054m1;
            ...
            fVar.g(i10, this.f36052k1);
            fVar.e(this.f36050j1, view.getMeasuredWidth(), view.getMeasuredHeight());
        }
    }
    ...
    public final void y0() {
        ...
        if (!topicsController.endIsReached(j3) && (gf1Var = this.F) != null) {
            int N0 = gf1Var.N0();
            if (this.f36029b.isEmpty() || N0 >= this.f36060r.h() - 5) {
    ...
    public final void z0(boolean z10) {
        ...
        ChatObject.Call call = this.H0;
        if (call != null && ((str = this.f36072y0) != null || this.f36073z0)) {
            ...
            this.f36072y0 = null;
            this.f36073z0 = false;
        } else if (this.f36072y0 != null && z10 && chatFull != null && chatFull.call == null && this.fragmentView != null && getParentActivity() != null) {
