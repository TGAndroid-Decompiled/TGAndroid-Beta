...
public final class sw0 implements org.telegram.ui.Components.mg {
    public final PopupNotificationActivity f37564a;

    public sw0(PopupNotificationActivity popupNotificationActivity) {
        this.f37564a = popupNotificationActivity;
    }
    ...
    public final void E1() {
        PopupNotificationActivity popupNotificationActivity = this.f37564a;
    ...
    public final void H(CharSequence charSequence, boolean z10, int i10, int i11, long j3) {
        ...
        if (i12 >= 0 && i12 < popupNotificationActivity.f31158a0.size()) {
            popupNotificationActivity.f31158a0.remove(popupNotificationActivity.S);
        }
