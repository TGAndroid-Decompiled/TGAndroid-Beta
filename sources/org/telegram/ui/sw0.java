...
public final class sw0 extends lw0 {
    public final int f37878r = 0;
    public final org.telegram.ui.Components.vl0 f37879s;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f37878r) {
            ...
            default:
                ...
                ImageView imageView2 = this.f35424c;
                rectF2.set(imageView2.getLeft(), imageView2.getTop(), imageView2.getRight(), imageView2.getBottom());
                rg.j1 j1Var = (rg.j1) this.f37879s;
                j1Var.f42619c.f42642p0.d(0, 0.0f, 0, getMeasuredWidth(), -this.f35425f.e, j1Var.f42619c.f42632e0);
                canvas.drawRoundRect(rectF2, AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), j1Var.f42619c.f42642p0.f42840f);
                super.dispatchDraw(canvas);
                return;
        }
    }
