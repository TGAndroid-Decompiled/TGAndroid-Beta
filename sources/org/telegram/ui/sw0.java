...
public final class sw0 implements org.telegram.ui.Components.mg {
    public final PopupNotificationActivity f37569a;

    public sw0(PopupNotificationActivity popupNotificationActivity) {
        this.f37569a = popupNotificationActivity;
    }
    ...
    public final void E1() {
        PopupNotificationActivity popupNotificationActivity = this.f37569a;
    ...
    public final void H(CharSequence charSequence, boolean z10, int i10, int i11, long j3) {
        ...
        if (i12 >= 0 && i12 < popupNotificationActivity.f31162a0.size()) {
            popupNotificationActivity.f31162a0.remove(popupNotificationActivity.S);
        }
