...
public final class tj extends f2.x {
    ...
    public final boolean B1(int i10) {
        ...
        int i12 = jmVar.G;
        if (i10 >= i12 && i10 < jmVar.H && (i11 = i10 - i12) >= 0 && i11 < jmVar.L().size() && (X8 = xnVar.X8((messageObject = (MessageObject) xnVar.f43381x0.L().get(i11)))) != null) {
    ...
    public final int K() {
        if (this.S) {
            return (int) ((this.f5951n - this.T.f43288p9) - C());
        }
        return super.K();
    }
    ...
    @Override
    public final int o0(int r11, bf.f r12, f2.j1 r13) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.tj.o0(int, bf.f, f2.j1):int");
    }

    @Override
    public final void v0(RecyclerView recyclerView, f2.j1 j1Var, int i10) {
        this.T.f43289pa = false;
