...
public final class dr implements mq {
    ...
    public final void b(int i10, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights, String str) {
        ...
        ur urVar = this.f33217f;
        ArrayList arrayList = urVar.F;
        long j3 = this.f33215b;
            ...
            while (true) {
                ...
                if (tLObject instanceof TLRPC.ChannelParticipant) {
                    if (MessageObject.getPeerId(((TLRPC.ChannelParticipant) tLObject).peer) == j3) {
                        ...
                        tL_channelParticipant.date = this.f33216c;
                    ...
                    int indexOf = urVar.f38162s.participants.participants.indexOf(chatParticipant);
                    if (indexOf >= 0) {
                        urVar.f38162s.participants.participants.set(indexOf, tL_chatParticipant);
                    }
                    urVar.r0();
                }
                i12++;
