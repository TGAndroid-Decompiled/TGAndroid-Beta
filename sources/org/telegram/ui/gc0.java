...
public final class gc0 extends FrameLayout {
    public final org.telegram.ui.Components.y9 f33513a;
    public final SpannableStringBuilder f33514b;
    public final org.telegram.ui.Cells.w1 f33515c;
    public final TextView d;
    public final org.telegram.ui.Cells.w1 e;
    public final TextView f33516f;
    public final org.telegram.ui.Components.fo0 h;
    public final ec0 f33517n;
    public boolean f33518r;
    public float f33519s;
    public ValueAnimator v;
    public float f33520w;
    public ValueAnimator f33521x;
    public final ic0 f33522y;
    ...
    public gc0(ic0 ic0Var, Context context) {
        ...
        w1Var.v = org.telegram.ui.ActionBar.h6.b0(AndroidUtilities.dp(4.0f), org.telegram.ui.ActionBar.h6.l1(0.15f, org.telegram.ui.ActionBar.h6.w0(null, i12, false)));
        this.f33515c = w1Var;
        ...
        w1Var.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i12, false));
        ...
        w1Var2.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18973n6, false));
        frameLayout.addView(w1Var2, w7.x5.e(-2, -2, 17));
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder("b");
        this.f33514b = spannableStringBuilder;
        org.telegram.ui.Components.y9 y9Var = new org.telegram.ui.Components.y9();
        this.f33513a = y9Var;
        y9Var.f30180a = w1Var2.getPaint();
        y9Var.f30183f = AndroidUtilities.dp(1.5f);
    ...
    public final void a() {
        ...
        if (powerSaverLevel <= 0) {
            ...
            this.f33513a.a(f11 / 100.0f, true);
            w1Var.c(AndroidUtilities.replaceCharSequence("%s", LocaleController.getString(R.string.LiteBatteryWhenBelow), TextUtils.concat(String.format("%d%% ", Integer.valueOf(Math.round(f11))), this.f33514b)), !LocaleController.isRTL, true);
        }
        ...
        org.telegram.ui.Cells.w1 w1Var2 = this.f33515c;
        ...
        if (z10 != this.f33518r) {
            ...
            org.telegram.messenger.ul.r(animate.alpha(f10), org.telegram.ui.Components.rr.h, 220L);
        }
        ...
        if (this.f33519s != f7) {
            ...
            ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f33519s, f7);
            this.v = ofFloat;
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                public final gc0 f32575b;
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    switch (r2) {
                        case 0:
                            ...
                            gc0Var.f33519s = floatValue;
                            textView.setTextColor(i0.a.d(floatValue, w02, w03));
                            return;
                        default:
                            gc0 gc0Var2 = this.f32575b;
                            ...
                            gc0Var2.f33520w = floatValue2;
                            textView2.setTextColor(i0.a.d(floatValue2, w04, w05));
                            return;
                    }
                }
            });
            this.v.addListener(new fc0(this, f7, 0));
        ...
        if (this.f33520w != f12) {
            this.f33520w = f12;
            ValueAnimator valueAnimator2 = this.f33521x;
            if (valueAnimator2 != null) {
                valueAnimator2.cancel();
                this.f33521x = null;
            }
            ValueAnimator ofFloat2 = ValueAnimator.ofFloat(this.f33520w, f12);
            this.f33521x = ofFloat2;
            ...
            this.f33521x.addListener(new fc0(this, f12, 1));
            this.f33521x.setInterpolator(org.telegram.ui.Components.rr.h);
            this.f33521x.setDuration(320L);
            this.f33521x.start();
        }
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        this.f33517n.onInitializeAccessibilityNodeInfo(this, accessibilityNodeInfo);
    }
    ...
    public final void onPopulateAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        this.f33517n.onPopulateAccessibilityEvent(this, accessibilityEvent);
    }

    @Override
    public final boolean performAccessibilityAction(int i10, Bundle bundle) {
        return this.f33517n.performAccessibilityAction(this, i10, bundle);
    }
}
