...
public final class gc0 {
    public final LaunchActivity f33803a;
    public final int f33804b;
    public final nf.e f33805c;
    ...
    public static boolean l(java.lang.String r7) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.gc0.l(java.lang.String):boolean");
    }
    ...
    public final org.telegram.ui.ActionBar.d5 c() {
        return this.f33803a.O();
    }

    public final UserConfig d() {
        return UserConfig.getInstance(this.f33804b);
    }
    ...
    public final boolean e(Uri uri) {
        ...
        if (uri != null) {
            ...
            LaunchActivity launchActivity = this.f33803a;
            if (equalsIgnoreCase) {
                        ...
                        if (!arrayList.isEmpty()) {
                            ...
                            if ("newbot".equalsIgnoreCase(str4)) {
                                ...
                                if ("new".equalsIgnoreCase(str4)) {
                                    ...
                                    ci.oc E = ci.oc.E(launchActivity, this.f33804b);
                                    if (E.O1 != r15) {
                                        E.O1 = r15;
                                        ?? r22 = E.Q0;
                                        if (r22 != 0) {
    ...
    public final boolean f(String str) {
        ...
        k();
        ConnectionsManager.getInstance(this.f33804b).sendRequestTyped(gettone, new Object(), new b5(this, 14));
        return true;
    }
    ...
    public final boolean g(String str) {
        ...
        this.h = ConnectionsManager.getInstance(this.f33804b).sendRequest(tL_payments_getPaymentForm, new ba((Object) this, (TLObject) tL_inputInvoiceSlug, str, 18));
        return true;
    }
    ...
    public final void h(String str, String str2, String str3) {
        ...
        if (U != null && U.getContext() != null) {
            ...
            MessagesController.getInstance(this.f33804b).getUserNameResolver().resolve(str, new rh(this, userArr, new org.telegram.ui.Components.wn0(this, U, userArr, tL_requestPeerTypeCreateBot, 15), 3));
        }
    }
    ...
    public final boolean i(Uri uri, String str) {
        ...
        ConnectionsManager.getInstance(this.f33804b).sendRequestTyped(tL_messages_requestUrlAuth, new Object(), new ai.m0(16, this, tL_messages_requestUrlAuth));
        return true;
    }

    public final boolean j(java.util.List r28) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.gc0.j(java.util.List):boolean");
    }

    public final void k() {
        if (!this.f33806f && !this.f33807g) {
            nf.e eVar = this.f33805c;
            if (eVar == null) {
                if (this.e == null) {
                    this.e = new org.telegram.ui.ActionBar.b2(this.f33803a, 3, null);
                }
                this.e.setOnCancelListener(new og(this, 3));
                this.e.q(300L);
            } else {
                eVar.f15394b = new ac0(this, 0);
                eVar.d();
            }
            this.f33806f = true;
        }
    ...
    public final void o(String str) {
        AndroidUtilities.scrollToFragmentRow(this.f33803a.O(), str);
    }
}
