...
public final class ac0 {
    public final LaunchActivity f31731a;
    public final int f31732b;
    public final nf.e f31733c;
    ...
    public static boolean l(java.lang.String r7) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.ac0.l(java.lang.String):boolean");
    }
    ...
    public final UserConfig d() {
        return UserConfig.getInstance(this.f31732b);
    }
    ...
    public final boolean e(Uri uri) {
        ...
        if (uri != null) {
            ...
            LaunchActivity launchActivity = this.f31731a;
            if (equalsIgnoreCase) {
                        ...
                        if (!arrayList.isEmpty()) {
                            ...
                            if ("newbot".equalsIgnoreCase(str4)) {
                                ...
                                if ("new".equalsIgnoreCase(str4)) {
                                    ...
                                    ci.lc E = ci.lc.E(launchActivity, this.f31732b);
                                    if (E.O1 != r15) {
                                        E.O1 = r15;
                                        ?? r22 = E.Q0;
                                        if (r22 != 0) {
    ...
    public final boolean f(String str) {
        ...
        k();
        ConnectionsManager.getInstance(this.f31732b).sendRequestTyped(gettone, new Object(), new c5(this, 14));
        return true;
    }
    ...
    public final boolean g(String str) {
        ...
        this.h = ConnectionsManager.getInstance(this.f31732b).sendRequest(tL_payments_getPaymentForm, new aa((Object) this, (TLObject) tL_inputInvoiceSlug, str, 18));
        return true;
    }
    ...
    public final void h(String str, String str2, String str3) {
        ...
        if (U != null && U.getContext() != null) {
            ...
            MessagesController.getInstance(this.f31732b).getUserNameResolver().resolve(str, new z(this, userArr, new org.telegram.ui.Components.jn0(this, U, userArr, tL_requestPeerTypeCreateBot, 15), 10));
        }
    }
    ...
    public final boolean i(Uri uri, String str) {
        ...
        ConnectionsManager.getInstance(this.f31732b).sendRequestTyped(tL_messages_requestUrlAuth, new Object(), new ai.m0(16, this, tL_messages_requestUrlAuth));
        return true;
    }

    public final boolean j(java.util.List r28) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.ac0.j(java.util.List):boolean");
    }

    public final void k() {
        if (!this.f31734f && !this.f31735g) {
            nf.e eVar = this.f31733c;
            if (eVar == null) {
                if (this.e == null) {
                    this.e = new org.telegram.ui.ActionBar.b2(this.f31731a, 3, null);
                }
                this.e.setOnCancelListener(new ng(this, 3));
                this.e.q(300L);
            } else {
                eVar.f15185b = new ub0(this, 0);
                eVar.d();
            }
            this.f31734f = true;
        }
    ...
    public final void o(String str) {
        AndroidUtilities.scrollToFragmentRow(this.f31731a.O(), str);
    }
}
