...
public class a6 extends org.telegram.ui.ActionBar.m2 {
    public y5 f31976a;
    public org.telegram.ui.Components.wl0 f31977b;
    public final ArrayList f31978c;
    public ArrayList d;
    public int e;
    ...
    public final void U() {
        ...
        ArrayList arrayList2 = this.f31978c;
        if (!z10 && this.f31976a != null) {
    ...
    public final View createView(Context context) {
        ...
        this.f31977b = new org.telegram.ui.Components.wl0(context, null);
        s4.j jVar = new s4.j();
        jVar.C = false;
        jVar.f42981m = false;
        this.f31977b.setItemAnimator(jVar);
        this.f31977b.setLayoutManager(new s4.c0());
        org.telegram.ui.Components.wl0 wl0Var = this.f31977b;
        y5 y5Var = new y5(this);
        this.f31976a = y5Var;
        wl0Var.setAdapter(y5Var);
        this.f31977b.setOnItemClickListener(new z0(this, 7));
        frameLayout.addView(this.f31977b);
