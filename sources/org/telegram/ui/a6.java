...
public class a6 extends org.telegram.ui.ActionBar.m2 {
    public y5 f31990a;
    public org.telegram.ui.Components.wl0 f31991b;
    public final ArrayList f31992c;
    public ArrayList d;
    public int e;
    ...
    public final void U() {
        ...
        ArrayList arrayList2 = this.f31992c;
        if (!z10 && this.f31990a != null) {
    ...
    public final View createView(Context context) {
        ...
        this.f31991b = new org.telegram.ui.Components.wl0(context, null);
        s4.j jVar = new s4.j();
        jVar.C = false;
        jVar.f42995m = false;
        this.f31991b.setItemAnimator(jVar);
        this.f31991b.setLayoutManager(new s4.c0());
        org.telegram.ui.Components.wl0 wl0Var = this.f31991b;
        y5 y5Var = new y5(this);
        this.f31990a = y5Var;
        wl0Var.setAdapter(y5Var);
        this.f31991b.setOnItemClickListener(new z0(this, 7));
        frameLayout.addView(this.f31991b);
