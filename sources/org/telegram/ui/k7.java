...
public final class k7 extends FrameLayout {
    public final org.telegram.ui.Components.np f35048a;
    public final FrameLayout f35049b;
    public final TextView f35050c;
    public boolean d;
    public int e;
    public final int f35051f;
    public final g7 h;
    ...
    public k7(g7 g7Var, Context context, int i10) {
        ...
        this.f35049b = frameLayout;
        TextView textView = new TextView(context);
        this.f35050c = textView;
        textView.setTextSize(1, 16.0f);
        textView.setGravity(5);
        textView.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19021n6, false));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.d) {
            if (LocaleController.isRTL) {
                canvas.drawLine(0.0f, getMeasuredHeight() - 1, getMeasuredWidth() - AndroidUtilities.dp(48.0f), getMeasuredHeight() - 1, org.telegram.ui.ActionBar.i6.f18958k0);
            } else {
                canvas.drawLine(getMeasuredWidth() - AndroidUtilities.dp(90.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, org.telegram.ui.ActionBar.i6.f18958k0);
            }
        }
    }
}
