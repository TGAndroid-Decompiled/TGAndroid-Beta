...
public final class k7 extends FrameLayout {
    public final org.telegram.ui.Components.op f34942a;
    public final FrameLayout f34943b;
    ...
    public k7(g7 g7Var, Context context, int i10) {
        ...
        this.f34943b = frameLayout;
        TextView textView = new TextView(context);
        this.f34944c = textView;
        textView.setTextSize(1, 16.0f);
        textView.setGravity(5);
        textView.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19229n6, false));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.d) {
            if (LocaleController.isRTL) {
                canvas.drawLine(0.0f, getMeasuredHeight() - 1, getMeasuredWidth() - AndroidUtilities.dp(48.0f), getMeasuredHeight() - 1, org.telegram.ui.ActionBar.h6.f19166k0);
            } else {
                canvas.drawLine(getMeasuredWidth() - AndroidUtilities.dp(90.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, org.telegram.ui.ActionBar.h6.f19166k0);
            }
        }
    }
}
