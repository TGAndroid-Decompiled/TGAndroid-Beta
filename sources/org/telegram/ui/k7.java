...
public final class k7 extends FrameLayout {
    public final org.telegram.ui.Components.mp f37973a;
    public final FrameLayout f37974b;
    public final TextView f37975c;
    public boolean d;
    public int f37976e;
    ...
    public k7(g7 g7Var, Context context, int i10) {
        ...
        this.f37974b = frameLayout;
        TextView textView = new TextView(context);
        this.f37975c = textView;
        textView.setTextSize(1, 16.0f);
        textView.setGravity(5);
        textView.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20874n6, false));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.d) {
            if (LocaleController.isRTL) {
                canvas.drawLine(0.0f, getMeasuredHeight() - 1, getMeasuredWidth() - AndroidUtilities.dp(48.0f), getMeasuredHeight() - 1, org.telegram.ui.ActionBar.j6.f20813k0);
            } else {
                canvas.drawLine(getMeasuredWidth() - AndroidUtilities.dp(90.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, org.telegram.ui.ActionBar.j6.f20813k0);
            }
        }
    }
}
