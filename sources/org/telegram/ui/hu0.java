...
public final class hu0 implements ViewTreeObserver.OnPreDrawListener {
    public final bv0 f34292a;
    public final Integer f34293b;
    public final PhotoViewer f34294c;

    public hu0(PhotoViewer photoViewer, bv0 bv0Var, Integer num) {
        this.f34294c = photoViewer;
        this.f34292a = bv0Var;
        this.f34293b = num;
    }
    ...
    public final boolean onPreDraw() {
        PhotoViewer photoViewer = this.f34294c;
        ...
        photoViewer.f31346s3.setTranslationY(AndroidUtilities.dp(32.0f));
        photoViewer.f31346s3.animate().alpha(1.0f).translationY(0.0f).setDuration(150L).setInterpolator(qrVar).start();
        photoViewer.f31221e0.setAlpha(0.0f);
        photoViewer.L0.setAlpha(0);
        photoViewer.f31302n4 = 4;
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(photoViewer.f31221e0, property, 0.0f, 1.0f).setDuration(220L), ObjectAnimator.ofFloat(photoViewer.f31265j0, property, 0.0f, 1.0f).setDuration(220L), duration2, duration3);
