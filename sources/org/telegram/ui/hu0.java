...
public final class hu0 implements ViewTreeObserver.OnPreDrawListener {
    ...
    public final boolean onPreDraw() {
        PhotoViewer photoViewer = this.f34246c;
        photoViewer.f31198g0.getViewTreeObserver().removeOnPreDrawListener(this);
        ...
        photoViewer.f31306s3.setTranslationY(AndroidUtilities.dp(32.0f));
        photoViewer.f31306s3.animate().alpha(1.0f).translationY(0.0f).setDuration(150L).setInterpolator(qrVar).start();
        photoViewer.f31181e0.setAlpha(0.0f);
        photoViewer.L0.setAlpha(0);
        photoViewer.f31262n4 = 4;
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(photoViewer.f31181e0, property, 0.0f, 1.0f).setDuration(220L), ObjectAnimator.ofFloat(photoViewer.f31225j0, property, 0.0f, 1.0f).setDuration(220L), duration2, duration3);
