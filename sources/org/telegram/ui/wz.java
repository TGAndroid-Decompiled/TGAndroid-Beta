...
public final class wz implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        switch (this.f39332a) {
            case 0:
                c00 c00Var = this.f39333b;
                String str = c00Var.f39738s;
                if (str != null) {
                    AndroidUtilities.addToClipboard(str);
                    org.telegram.messenger.wl.o(R.string.LinkCopied, org.telegram.ui.Components.vc.a0(c00Var.f39737r));
                    return;
                }
                return;
            case 1:
                c00 c00Var2 = this.f39333b;
                FrameLayout frameLayout = c00Var2.f39732a;
                ...
                float[] fArr = c00Var2.f39741y;
                if (c00Var2.f39740x == null && c00Var2.f39738s != null) {
                    ...
                    FrameLayout overlayContainerView = c00Var2.f39737r.getParentLayout().getOverlayContainerView();
                    if (overlayContainerView != null) {
                        ...
                        c00Var2.f39740x = o1Var;
                        o1Var.setOnDismissListener(new org.telegram.ui.Components.r80(c00Var2, s6Var, overlayContainerView, g7Var, 1));
                        c00Var2.f39740x.setOutsideTouchable(true);
                        c00Var2.f39740x.setFocusable(true);
                        c00Var2.f39740x.setBackgroundDrawable(new ColorDrawable(0));
                        c00Var2.f39740x.setAnimationStyle(R.style.PopupContextAnimation);
                        c00Var2.f39740x.setInputMethodMode(2);
                        c00Var2.f39740x.setSoftInputMode(0);
                        ...
                        c00Var2.f39740x.showAtLocation(overlayContainerView, 0, (int) (overlayContainerView.getX() + ((overlayContainerView.getMeasuredWidth() - actionBarPopupWindow$ActionBarPopupWindowLayout.getMeasuredWidth()) - AndroidUtilities.dp(16.0f)) + f10), (int) (overlayContainerView.getY() + f7 + frameLayout.getMeasuredHeight()));
                        return;
                    }
                    return;
                }
                return;
            case 2:
                c00 c00Var3 = this.f39333b;
                String str2 = c00Var3.f39738s;
                if (str2 != null) {
                    AndroidUtilities.addToClipboard(str2);
                    org.telegram.messenger.wl.o(R.string.LinkCopied, org.telegram.ui.Components.vc.a0(c00Var3.f39737r));
                    return;
                }
                return;
            case 3:
                c00 c00Var4 = this.f39333b;
                if (c00Var4.f39738s != null) {
                    try {
                        Intent intent = new Intent("android.intent.action.SEND");
                        intent.setType("text/plain");
                        intent.putExtra("android.intent.extra.TEXT", c00Var4.f39738s);
                        c00Var4.f39737r.startActivityForResult(Intent.createChooser(intent, LocaleController.getString(R.string.InviteToGroupByLink)), 500);
                        return;
                    } catch (Exception e) {
                        FileLog.e(e);
                        return;
                ...
                return;
            case 4:
                c00 c00Var5 = this.f39333b;
                org.telegram.ui.ActionBar.o1 o1Var2 = c00Var5.f39740x;
                if (o1Var2 != null) {
                    o1Var2.d(true);
                }
                e00 e00Var = c00Var5.E.f32982c;
                ...
                if (tL_exportedChatlistInvite != null && tL_exportedChatlistInvite.url != null) {
                    ...
                    alertDialog$Builder.f18447a.I = org.telegram.ui.ActionBar.j6.H5;
                    alertDialog$Builder.f18447a.R = LocaleController.getString(R.string.FilterInviteEditName);
                    ...
                    editTextBoldCursor.setHint(e00Var.f33251c.name);
                    editTextBoldCursor.setHintTextColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19156t5, false));
                ...
                return;
            case 5:
                c00 c00Var6 = this.f39333b;
                org.telegram.ui.ActionBar.o1 o1Var3 = c00Var6.f39740x;
                if (o1Var3 != null) {
                    o1Var3.d(true);
                }
                if (c00Var6.f39738s != null) {
                    org.telegram.ui.Components.ki0 ki0Var = new org.telegram.ui.Components.ki0(c00Var6.getContext(), LocaleController.getString(R.string.InviteByQRCode), c00Var6.f39738s, LocaleController.getString(R.string.QRCodeLinkHelpFolder), false);
                ...
                return;
            default:
                c00 c00Var7 = this.f39333b;
                org.telegram.ui.ActionBar.o1 o1Var4 = c00Var7.f39740x;
                if (o1Var4 != null) {
                    o1Var4.d(true);
                }
                ...
                e00 e00Var2 = c00Var7.E.f32982c;
                tL_inputChatlistDialogFilter.filter_id = e00Var2.f33251c.f15613id;
