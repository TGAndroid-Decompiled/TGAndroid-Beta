...
public final class qe0 extends org.telegram.ui.Components.wv0 {
    ...
    public final org.telegram.ui.Components.cd0 f40448b;
    public final lg.f f40449c;
    public final org.telegram.ui.Components.voip.o2 d;
    public final TextView f40450e;
    public final TextView f40451f;
    public final org.telegram.ui.Components.lj0 h;
    public final TextView f40452n;
    public final TextView f40453r;
    public final TextView f40454s;
    public final qf0 v;
    public boolean f40455w;
    public boolean f40456x;
    public boolean f40457y;

    public qe0(org.telegram.ui.og0 r28, android.content.Context r29, int r30) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.qe0.<init>(org.telegram.ui.og0, android.content.Context, int):void");
    }
    ...
    public final void h(String str) {
        ...
        String obj = this.f40449c.getText().toString();
        if (obj.length() == 0) {
            s(false);
        } else if (!p(obj)) {
            s(true);
    ...
    @Override
    public final void j() {
        AndroidUtilities.runOnUIThread(new ne0(this, 3), og0.f39749q0);
    }

    @Override
    public final void k(Bundle bundle) {
        Bundle bundle2 = bundle.getBundle("recoveryview_word" + this.f40447a);
        this.I = bundle2;
        if (bundle2 != null) {
            m(bundle2, true);
        }
    ...
    public final void l(Bundle bundle) {
        if (this.I != null) {
            bundle.putBundle("recoveryview_word" + this.f40447a, this.I);
        }
    }
    ...
    public final void m(Bundle bundle, boolean z4) {
        ...
        String str2 = this.H;
        TextView textView = this.f40453r;
        if (str2 == null) {
            if (!z10) {
    ...
    public final void n() {
        ...
        og0 og0Var = this.U;
        this.f40452n.setTextColor(og0Var.getThemedColor(i10));
        this.f40453r.setTextColor(og0Var.getThemedColor(org.telegram.ui.ActionBar.k6.D6));
        int themedColor = og0Var.getThemedColor(i10);
        lg.f fVar = this.f40449c;
        fVar.setTextColor(themedColor);
        fVar.setCursorColor(og0Var.getThemedColor(org.telegram.ui.ActionBar.k6.f21803l6));
    ...
    public final void o(boolean z4) {
        ...
        float f13 = -5.0f;
        ViewPropertyAnimator translationY = this.f40450e.animate().scaleX(f12).scaleY(f12).alpha(f10).translationY((1.0f - f10) * AndroidUtilities.dp(-5.0f));
        org.telegram.ui.Components.pr prVar = org.telegram.ui.Components.pr.h;
        b.p(translationY, prVar, 290L);
        if (this.f40455w && !this.f40456x) {
            f11 = 1.0f;
        }
        float f14 = (0.1f * f11) + 0.9f;
        ViewPropertyAnimator alpha = this.f40451f.animate().scaleX(f14).scaleY(f14).alpha(f11);
        float f15 = 1.0f - f11;
        if (this.f40456x) {
            f13 = 5.0f;
        }
    ...
    public final void q(boolean z4) {
        ...
        if (TextUtils.isEmpty(this.f40449c.getText()) && clipboardManager != null && clipboardManager.hasPrimaryClip()) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (this.f40455w != z10) {
            ...
            float f17 = 0.9f;
            float f18 = 0.7f;
            TextView textView = this.f40454s;
            TextView textView2 = this.f40451f;
            float f19 = 0.0f;
            float f20 = 1.0f;
            if (z4) {
                ...
                ViewPropertyAnimator alpha2 = scaleX2.scaleY(f17).alpha((!this.f40455w || this.f40456x) ? 0.0f : 0.0f);
                if (!this.f40455w || this.f40456x) {
                    if (this.f40456x) {
                        f16 = 5.0f;
                    }
                ...
                textView2.setAlpha((!this.f40455w || this.f40456x) ? 0.0f : 0.0f);
                if (!this.f40455w || this.f40456x) {
                    if (this.f40456x) {
                        f16 = 5.0f;
                    }
    ...
    public final void s(boolean z4) {
        ...
        TextView textView = this.f40450e;
        if (z4) {
            if (!z10) {
