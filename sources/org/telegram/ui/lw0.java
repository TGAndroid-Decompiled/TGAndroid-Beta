...
public final class lw0 extends Dialog {
    ...
    public float f38518a0;
    public final org.telegram.ui.ActionBar.f6 f38519b;
    public boolean f38520b0;
    public final gw0 f38521c;
    public boolean f38522c0;
    public final gw0 d;
    public boolean f38523d0;
    public final gw0 f38524e;
    public zm f38525e0;
    public final di.i1 f38526f;
    public ValueAnimator f38527f0;
    public ValueAnimator f38528g0;
    public final TextView h;
    public final org.telegram.ui.Components.ub0 f38529n;
    public i0.c f38530r;
    public Bitmap f38531s;
    public BitmapShader v;
    public Paint f38532w;
    public Matrix f38533x;
    public float f38534y;

    public lw0(Activity activity, org.telegram.ui.ActionBar.f6 f6Var) {
        super(activity, R.style.TransparentDialog);
        this.f38530r = i0.c.f11450e;
        this.M = 0.0f;
        this.N = 0.0f;
        this.S = -1.0f;
        this.U = -1.0f;
        this.f38522c0 = false;
        this.f38517a = activity;
        this.f38519b = f6Var;
    ...
    public final void b(boolean z10, aw0 aw0Var) {
        float f7;
        long j3;
        ValueAnimator valueAnimator = this.f38527f0;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ValueAnimator valueAnimator2 = this.f38528g0;
        if (valueAnimator2 != null) {
            valueAnimator2.cancel();
        }
        d();
        float f10 = this.f38534y;
        float f11 = 0.0f;
        if (z10) {
            f7 = 1.0f;
        } else {
        ...
        this.f38527f0 = ofFloat;
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
            public final lw0 f34965b;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                switch (r2) {
                    case 0:
                        ...
                        lw0 lw0Var = this.f34965b;
                        lw0Var.f38534y = floatValue;
        ...
        this.f38527f0.addListener(new ah.r0(this, z10, aw0Var, 10));
        if (!z10) {
            j3 = 330;
        } else {
            j3 = 520;
        }
        ValueAnimator valueAnimator3 = this.f38527f0;
        org.telegram.ui.Components.pr prVar = org.telegram.ui.Components.pr.h;
        valueAnimator3.setInterpolator(prVar);
        this.f38527f0.setDuration(j3);
        this.f38527f0.start();
        float f12 = this.E;
        if (z10) {
            f11 = 1.0f;
        ...
        this.f38528g0.addListener(new e50(5, this, z10));
        this.f38528g0.setDuration(((float) j3) * 1.5f);
        this.f38528g0.setInterpolator(prVar);
        this.f38528g0.start();
    }
    ...
    public final void c(boolean z10) {
        ...
        if (z10 && (fk0Var = this.Q) != null && fk0Var.getReactionsWindow() != null && !this.Q.getReactionsWindow().f711q) {
            this.Q.e();
        } else if (this.f38522c0) {
        } else {
            this.f38522c0 = true;
            this.Y = false;
            di.i1 i1Var = this.f38526f;
            i1Var.l();
        ...
        if (!this.Y) {
            ...
            if (gw0Var.getWidth() > 0) {
                ...
                if (t1Var != null) {
                    ...
                    int i11 = iArr[0];
                    i0.c cVar = this.f38530r;
                    this.W = i11 - cVar.f11451a;
                    ...
                    if (!this.f38520b0) {
                        ...
                        if (this.T != null) {
                            ...
                            i0.c cVar2 = this.f38530r;
                            if (height > ((height2 - cVar2.f11452b) - cVar2.d) - AndroidUtilities.dp(66.0f)) {
                                int height3 = gw0Var.getHeight();
                                i0.c cVar3 = this.f38530r;
                                this.Z = ((((height3 - cVar3.f11452b) - cVar3.d) - AndroidUtilities.dp(66.0f)) - this.L.getHeight()) - this.T.getHeight();
                            }
                        }
                        ...
                        if (f10 + f11 > dp - textView.getHeight()) {
                            ...
                            i0.c cVar5 = this.f38530r;
                            this.f38518a0 = ((((height5 - cVar5.f11452b) - cVar5.d) - AndroidUtilities.dp(78.0f)) - textView.getHeight()) - i10;
                        }
                        if (this.R != null) {
                            float height6 = this.f38518a0 + f11 + viewGroup.getHeight();
                            int height7 = gw0Var.getHeight();
                            i0.c cVar6 = this.f38530r;
                            if (height6 > (((height7 - cVar6.f11452b) - cVar6.d) - AndroidUtilities.dp(78.0f)) - textView.getHeight()) {
                                int height8 = gw0Var.getHeight();
                                i0.c cVar7 = this.f38530r;
                                this.f38518a0 = (((((height8 - cVar7.f11452b) - cVar7.d) - AndroidUtilities.dp(78.0f)) - textView.getHeight()) - i10) - this.R.getHeight();
                            }
                        }
                    }
                    e();
    ...
    public final void e() {
        ...
        if (this.Y) {
            ...
            if (viewGroup instanceof ActionBarPopupWindow$ActionBarPopupWindowLayout) {
                ...
                if (height > ((height2 - cVar.f11452b) - cVar.d) - AndroidUtilities.dp(66.0f)) {
                    int height3 = gw0Var.getHeight();
                    i0.c cVar2 = this.f38530r;
                    this.Z = ((((height3 - cVar2.f11452b) - cVar2.d) - AndroidUtilities.dp(66.0f)) - this.L.getHeight()) - actionBarPopupWindow$ActionBarPopupWindowLayout.getVisibleHeight();
                }
            }
        }
        kw0 kw0Var = this.K;
        ...
        if (viewGroup2 != null) {
            ...
            this.T.setAlpha(this.f38534y);
            float lerp3 = AndroidUtilities.lerp(0.75f, 1.0f, this.f38534y);
        ...
        if (this.R != null) {
            ...
            this.R.setAlpha(this.f38534y);
            float lerp4 = AndroidUtilities.lerp(0.75f, 1.0f, this.f38534y);
            this.R.setScaleX(lerp4);
            this.R.setScaleY(lerp4);
        }
        if (this.f38523d0) {
            this.K.setAlpha(this.f38534y);
            this.J.setAlpha(this.f38534y);
        }
        if (this.Q != null) {
            ...
            this.Q.setAlpha(this.f38534y);
            View windowView = this.Q.getWindowView();
            if (windowView != null) {
                windowView.setTranslationX(max);
                windowView.setAlpha(this.f38534y);
            }
        }
        TextView textView = this.h;
        textView.setTranslationX(lerp);
        textView.setAlpha(this.f38534y);
        org.telegram.ui.Components.ub0 ub0Var = this.f38529n;
        ub0Var.setSelectedTab(positionAnimated);
        ub0Var.setAlpha(this.f38534y);
    }
