...
public final class lw0 extends Dialog {
    ...
    public float f38492a0;
    public final org.telegram.ui.ActionBar.f6 f38493b;
    public boolean f38494b0;
    public final gw0 f38495c;
    public boolean f38496c0;
    public final gw0 d;
    public boolean f38497d0;
    public final gw0 f38498e;
    public zm f38499e0;
    public final di.i1 f38500f;
    public ValueAnimator f38501f0;
    public ValueAnimator f38502g0;
    public final TextView h;
    public final org.telegram.ui.Components.ub0 f38503n;
    public i0.c f38504r;
    public Bitmap f38505s;
    public BitmapShader v;
    public Paint f38506w;
    public Matrix f38507x;
    public float f38508y;

    public lw0(Activity activity, org.telegram.ui.ActionBar.f6 f6Var) {
        super(activity, R.style.TransparentDialog);
        this.f38504r = i0.c.f11424e;
        this.M = 0.0f;
        this.N = 0.0f;
        this.S = -1.0f;
        this.U = -1.0f;
    ...
    public final void b(boolean z10, aw0 aw0Var) {
        float f7;
        long j3;
        ValueAnimator valueAnimator = this.f38501f0;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ValueAnimator valueAnimator2 = this.f38502g0;
        if (valueAnimator2 != null) {
            valueAnimator2.cancel();
        }
        d();
        float f10 = this.f38508y;
        float f11 = 0.0f;
        if (z10) {
            f7 = 1.0f;
        } else {
        ...
        this.f38501f0 = ofFloat;
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
            public final lw0 f34939b;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                switch (r2) {
                    case 0:
                        ...
                        lw0 lw0Var = this.f34939b;
                        lw0Var.f38508y = floatValue;
                        lw0Var.f38495c.invalidate();
                        lw0Var.d.invalidate();
                        jw0 jw0Var = lw0Var.J;
                        if (jw0Var != null) {
                            jw0Var.invalidate();
        ...
        this.f38501f0.addListener(new ah.r0(this, z10, aw0Var, 10));
        if (!z10) {
            j3 = 330;
        } else {
            j3 = 520;
        }
        ValueAnimator valueAnimator3 = this.f38501f0;
        org.telegram.ui.Components.pr prVar = org.telegram.ui.Components.pr.h;
        valueAnimator3.setInterpolator(prVar);
        this.f38501f0.setDuration(j3);
        this.f38501f0.start();
        float f12 = this.E;
        if (z10) {
            f11 = 1.0f;
        ...
        this.f38502g0.addListener(new e50(5, this, z10));
        this.f38502g0.setDuration(((float) j3) * 1.5f);
        this.f38502g0.setInterpolator(prVar);
        this.f38502g0.start();
    }
    ...
    public final void c(boolean z10) {
        ...
        if (z10 && (fk0Var = this.Q) != null && fk0Var.getReactionsWindow() != null && !this.Q.getReactionsWindow().f699q) {
            this.Q.e();
        } else if (this.f38496c0) {
        } else {
            this.f38496c0 = true;
            this.Y = false;
            di.i1 i1Var = this.f38500f;
            i1Var.l();
                ...
                if (t1Var != null) {
                    ...
                    if (!this.f38494b0) {
                        ...
                        if (f10 + f11 > dp - textView.getHeight()) {
                            ...
                            i0.c cVar5 = this.f38504r;
                            this.f38492a0 = ((((height5 - cVar5.f11426b) - cVar5.d) - AndroidUtilities.dp(78.0f)) - textView.getHeight()) - i10;
                        }
                        if (this.R != null) {
                            float height6 = this.f38492a0 + f11 + viewGroup.getHeight();
                            int height7 = gw0Var.getHeight();
                            i0.c cVar6 = this.f38504r;
                            if (height6 > (((height7 - cVar6.f11426b) - cVar6.d) - AndroidUtilities.dp(78.0f)) - textView.getHeight()) {
                                int height8 = gw0Var.getHeight();
                                i0.c cVar7 = this.f38504r;
                                this.f38492a0 = (((((height8 - cVar7.f11426b) - cVar7.d) - AndroidUtilities.dp(78.0f)) - textView.getHeight()) - i10) - this.R.getHeight();
                            }
                        }
                    }
                    e();
    ...
    public final void e() {
        ...
        if (viewGroup2 != null) {
            ...
            this.T.setAlpha(this.f38508y);
            float lerp3 = AndroidUtilities.lerp(0.75f, 1.0f, this.f38508y);
        ...
        if (this.R != null) {
            ...
            this.R.setAlpha(this.f38508y);
            float lerp4 = AndroidUtilities.lerp(0.75f, 1.0f, this.f38508y);
            this.R.setScaleX(lerp4);
            this.R.setScaleY(lerp4);
        }
        if (this.f38497d0) {
            this.K.setAlpha(this.f38508y);
            this.J.setAlpha(this.f38508y);
        }
        if (this.Q != null) {
            ...
            this.Q.setAlpha(this.f38508y);
            View windowView = this.Q.getWindowView();
            if (windowView != null) {
                windowView.setTranslationX(max);
                windowView.setAlpha(this.f38508y);
            }
        }
        TextView textView = this.h;
        textView.setTranslationX(lerp);
        textView.setAlpha(this.f38508y);
        org.telegram.ui.Components.ub0 ub0Var = this.f38503n;
        ub0Var.setSelectedTab(positionAnimated);
        ub0Var.setAlpha(this.f38508y);
    }
