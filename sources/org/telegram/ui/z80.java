...
public final class z80 implements Runnable {
    public final int f40106a = 0;
    public final LaunchActivity f40107b;
    public final TLRPC.TL_error f40108c;
    ...
    public final void run() {
        ...
        int i10;
        int i11;
        int i12 = this.f40106a;
        ma0 ma0Var = this.h;
        String str2 = this.f40109f;
        TLObject tLObject = this.d;
        TLRPC.TL_error tL_error = this.f40108c;
        switch (i12) {
            case 0:
                ...
                if (z10) {
                    ...
                    org.telegram.messenger.w1.p(R.string.NoUsernameFound, org.telegram.ui.Components.vc.a0((org.telegram.ui.ActionBar.n2) hg.k0.h(1, launchActivity.f30820d0)), null);
                }
                try {
                    ma0Var.run();
                    return;
            ...
            default:
                ...
                if (tL_error != null) {
                    ...
                    LaunchActivity launchActivity2 = this.f40107b;
