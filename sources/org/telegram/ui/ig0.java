...
public final class ig0 implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f34580a) {
            case 0:
                mg0 mg0Var = this.f34581b;
                mg0Var.getClass();
                float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                mg0Var.d.setAlpha(floatValue);
                mg0Var.e.setAlpha(floatValue);
                mg0Var.f35746f.setProgress(floatValue);
                FrameLayout frameLayout = mg0Var.f35750w;
                ...
                return;
            default:
                mg0 mg0Var2 = this.f34581b;
                mg0Var2.getClass();
                float floatValue2 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                mg0Var2.f35746f.setProgress(floatValue2);
                mg0Var2.d.setAlpha(floatValue2);
                mg0Var2.e.setAlpha(floatValue2);
                FrameLayout frameLayout2 = mg0Var2.f35750w;
