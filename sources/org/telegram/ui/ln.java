...
public final class ln implements st {
    public final TLRPC.TL_messageMediaPoll f35592a;
    public final TLRPC.PollAnswer f35593b;
    public final org.telegram.ui.Cells.t1 f35594c;
    public final nn d;
    ...
    public ln(nn nnVar, TLRPC.TL_messageMediaPoll tL_messageMediaPoll, TLRPC.PollAnswer pollAnswer, org.telegram.ui.Cells.t1 t1Var) {
        this.d = nnVar;
        this.f35592a = tL_messageMediaPoll;
        this.f35593b = pollAnswer;
        this.f35594c = t1Var;
    }
    ...
    public final void K() {
        ...
        arrayList.add(this.f35593b);
        SendMessagesHelper sendMessagesHelper = this.d.f36139a.getSendMessagesHelper();
        org.telegram.ui.Cells.t1 t1Var = this.f35594c;
    ...
    public final void M(TLRPC.InputStickerSet inputStickerSet, boolean z10) {
        ...
        if (inputStickerSet != null && boVar.getParentActivity() != null) {
            ...
            org.telegram.ui.Components.wx0 wx0Var = new org.telegram.ui.Components.wx0(boVar.getParentActivity(), boVar, tL_inputStickerSetID, null, boVar.Y, boVar.f32279ea);
    ...
    public final MessageObject z() {
        return this.f35594c.getMessageObject();
    }
