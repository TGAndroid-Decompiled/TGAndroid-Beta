...
public final class ln implements qt {
    public final TLRPC.TL_messageMediaPoll f35533a;
    public final TLRPC.PollAnswer f35534b;
    public final org.telegram.ui.Cells.t1 f35535c;
    public final nn d;
    ...
    public ln(nn nnVar, TLRPC.TL_messageMediaPoll tL_messageMediaPoll, TLRPC.PollAnswer pollAnswer, org.telegram.ui.Cells.t1 t1Var) {
        this.d = nnVar;
        this.f35533a = tL_messageMediaPoll;
        this.f35534b = pollAnswer;
        this.f35535c = t1Var;
    }
    ...
    public final void K() {
        ...
        SendMessagesHelper sendMessagesHelper = this.d.f36012a.getSendMessagesHelper();
        org.telegram.ui.Cells.t1 t1Var = this.f35535c;
    ...
    public final MessageObject z() {
        return this.f35535c.getMessageObject();
    }
