...
public final class dp extends org.telegram.ui.Components.vl0 {
    ...
    @Override
    public final int h() {
        return this.f33168c.f33456a3.N.size() + 2;
    }
    ...
    public final int j(int i10) {
        ...
        if (i10 <= this.f33168c.f33456a3.N.size()) {
            return 1;
        }
        return 2;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 != 0) {
            if (i11 != 1) {
                if (i11 == 2) {
                    ...
                    e9Var.setBackground(org.telegram.ui.ActionBar.h6.V0(epVar.getContext(), R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.h6.f19024b7));
                    return;
                }
                return;
            }
        ...
        m4Var.setBackgroundColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19060d6, epVar.f30115p2));
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ep epVar = this.f33168c;
        org.telegram.ui.ActionBar.d6 d6Var = epVar.f30115p2;
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 != 2) {
                    return null;
