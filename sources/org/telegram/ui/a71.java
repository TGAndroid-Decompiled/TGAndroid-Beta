...
public abstract class a71 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int f32009a;
    public final u51 f32010a0;
    public float f32011a1;
    public int f32012b;
    public final ci.r6 f32013b0;
    public float f32014b1;
    public int f32015c;
    public final org.telegram.ui.Components.dw[] f32016c0;
    public final org.telegram.ui.ActionBar.m2 f32017c1;
    public int d;
    public org.telegram.ui.Components.dw f32018d0;
    public final int f32019d1;
    public int e;
    public final s51 f32020e0;
    public final y51 f32021e1;
    public int f32022f;
    public final r51 f32023f0;
    public final int f32024f1;
    public final m51 f32025g0;
    public boolean f32026g1;
    public int h;
    public final x51 f32027h0;
    public boolean f32028h1;
    public final n51 f32029i0;
    public ValueAnimator f32030i1;
    public final FrameLayout f32031j0;
    public Drawable f32032j1;
    public final ci.m6 f32033k0;
    public final PorterDuffColorFilter f32034k1;
    public final org.telegram.ui.Components.w9 f32035l0;
    public float l1;
    public final View m0;
    public int f32036m1;
    public int f32037n;
    public final org.telegram.ui.Components.ln f32038n0;
    public org.telegram.ui.Components.o5 f32039n1;
    public final View f32040o0;
    public Rect f32041o1;
    public final z51 f32042p0;
    public View f32043p1;
    public final k61 f32044q0;
    public float f32045q1;
    public int f32046r;
    public final o51 f32047r0;
    public j61 f32048r1;
    public int f32049s;
    public final org.telegram.ui.Components.zk0 f32050s0;
    public Rect f32051s1;
    public final View f32052t0;
    public final OvershootInterpolator f32053t1;
    public int f32054u0;
    public ValueAnimator f32055u1;
    public int v;
    public final ArrayList f32056v0;
    public boolean f32057v1;
    public int f32058w;
    public final SparseIntArray f32059w0;
    public boolean f32060w1;
    public int f32061x;
    public final SparseIntArray f32062x0;
    public boolean f32063x1;
    public int f32064y;
    public final SparseIntArray f32065y0;
    public boolean f32066y1;
    public final SparseIntArray f32067z0;
    public String f32068z1;
    public static final List Z1 = Arrays.asList("😖", "😫", "🫠", "😨", "❓");
    public static final boolean[] f32007b2 = new boolean[4];
    public static final HashMap f32008c2 = new HashMap();
    ...
    public static void a(a71 a71Var, int i10, int i11) {
        int i12;
        org.telegram.ui.Components.zk0 zk0Var = a71Var.f32050s0;
        o51 o51Var = a71Var.f32047r0;
        ...
        ci.m1 m1Var = new ci.m1(a71Var, a71Var.f32027h0.getContext(), 4);
        m1Var.f43110a = i10;
        m1Var.f13094p = i11;
        o51Var.w0(m1Var);
    }
    ...
    public Drawable getPremiumStar() {
        if (this.f32032j1 == null) {
            int i10 = this.W;
            if (i10 != 5 && i10 != 9 && i10 != 10 && i10 != 7) {
                this.f32032j1 = ApplicationLoader.applicationContext.getResources().getDrawable(R.drawable.msg_settings_premium).mutate();
            } else {
                this.f32032j1 = ApplicationLoader.applicationContext.getResources().getDrawable(R.drawable.msg_filled_blocked).mutate();
            }
            this.f32032j1.setColorFilter(this.f32034k1);
        }
        return this.f32032j1;
    }
    ...
    public void setBigReactionAnimatedEmoji(org.telegram.ui.Components.q5 q5Var) {
        ...
        if (this.I && (q5Var2 = this.W0) != q5Var) {
            ...
            this.W0 = q5Var;
            if (q5Var != null) {
                q5Var.setColorFilter(this.f32034k1);
                this.W0.a(this);
            }
        }
    }
    ...
    public static void t(int i10) {
        ...
        if (!zArr[i10] && MediaDataController.getInstance(i10) != null) {
            ...
            org.telegram.ui.Components.gx0.f24545x3.fetch(i10, 1, new ai.m(i10, 1));
        }
    }

    public final void A(Long l4) {
        this.K.remove(l4);
        x51 x51Var = this.f32027h0;
        if (x51Var != null) {
            int i10 = 0;
            boolean z10 = false;
            ...
            if (!z10) {
                while (true) {
                    ArrayList arrayList = this.f32056v0;
    ...
    public final void C() {
        ...
        if (x51Var.getChildCount() > 0) {
            ...
            if (RecyclerView.R(childAt) == this.f32009a && "searchbox".equals(childAt.getTag())) {
                r51Var.setVisibility(0);
    ...
    public final void E(float f7) {
        ...
        View view = this.m0;
        if (view != null) {
            float interpolation = org.telegram.ui.Components.rr.f28031g.getInterpolation(w7.q.a((((f7 * 800.0f) - 0.0f) / 120.0f) / 1.0f, 0.0f, 1.0f));
        ...
        org.telegram.ui.Components.ln lnVar = this.f32038n0;
        if (lnVar != null) {
        ...
        this.f32013b0.setAlpha(a14);
        this.f32023f0.setAlpha(a14);
        int i12 = 0;
        for (int i13 = 0; i13 < this.f32018d0.f30650b.getChildCount(); i13++) {
            this.f32018d0.f30650b.getChildAt(i13).setAlpha(a14);
        }
        if (this.f32039n1 != null) {
            invalidate();
        }
        float f12 = 1.0f - a14;
        u51 u51Var = this.f32010a0;
        u51Var.setTranslationY(AndroidUtilities.dp(-5.0f) * f12);
        if (lnVar != null) {
            lnVar.setTranslationY(AndroidUtilities.dp(-5.0f) * f12);
        }
        this.f32011a1 = (interpolation2 * 0.85f) + 0.15f;
        this.f32014b1 = (interpolation3 * 0.925f) + 0.075f;
        u51Var.invalidateOutline();
        if (lnVar != null) {
            lnVar.setAlpha(a14);
        }
        s51 s51Var = this.f32020e0;
        s51Var.setAlpha(a14);
        s51Var.setScaleX(Math.min(this.f32011a1, 1.0f));
        ...
        for (int i14 = 0; i14 < this.f32018d0.f30650b.getChildCount(); i14++) {
            View childAt = this.f32018d0.f30650b.getChildAt(i14);
            if (f7 == 0.0f) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        org.telegram.ui.Components.o5 o5Var = this.f32039n1;
        if (o5Var != null && (num = this.Y0) != null) {
            Rect bounds = o5Var.getBounds();
            View view = this.f32043p1;
            if (view == null) {
                scaleY = 1.0f;
            } else {
                scaleY = view.getScaleY();
            }
            int alpha = this.f32039n1.getAlpha();
            View view2 = this.f32043p1;
            if (view2 == null) {
                bounds.height();
            } else {
                view2.getHeight();
            ...
            this.f32039n1.v = (int) (Math.pow(this.f32010a0.getAlpha(), 0.25d) * alpha * this.l1);
            if (this.f32041o1 == null) {
                this.f32041o1 = new Rect();
            }
            ...
            this.f32041o1.set((int) (intValue - width), (int) (scrimDrawableTranslationY - height), (int) (intValue + width), (int) (scrimDrawableTranslationY + height));
            org.telegram.ui.Components.o5 o5Var2 = this.f32039n1;
            Rect rect = this.f32041o1;
            int i12 = rect.left;
            Rect rect2 = this.f32041o1;
            o5Var2.setBounds(i12, rect.top, (int) ((rect.width() / scaleY) + i12), (int) ((rect2.height() / scaleY) + rect2.top));
            Rect rect3 = this.f32041o1;
            canvas.scale(scaleY, scaleY, rect3.left, rect3.top);
            this.f32039n1.draw(canvas);
            org.telegram.ui.Components.o5 o5Var3 = this.f32039n1;
            o5Var3.v = alpha;
            o5Var3.setBounds(bounds);
            canvas.restore();
        }
        super.dispatchDraw(canvas);
        j61 j61Var = this.f32048r1;
        if (j61Var != null && this.f32051s1 != null && j61Var.E != null) {
            canvas.save();
            canvas.translate(0.0f, -getTranslationY());
            this.f32048r1.E.setAlpha((int) (this.f32045q1 * 255.0f));
            this.f32048r1.E.setBounds(this.f32051s1);
            this.f32048r1.E.setColorFilter(new PorterDuffColorFilter(i0.a.d(1.0f - this.l1, this.f32024f1, this.f32036m1), PorterDuff.Mode.SRC_IN));
            this.f32048r1.E.draw(canvas);
            canvas.restore();
        }
    }
    ...
    public final void h() {
        ...
        if (canScrollVertically != this.f32057v1) {
            this.f32057v1 = canScrollVertically;
            ViewPropertyAnimator animate = this.f32040o0.animate();
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (z10 && this.W == 6) {
            this.f32047r0.y1((getMeasuredWidth() / AndroidUtilities.dp(42.0f)) * 5);
        }
    }
    ...
    public final void s(q61 q61Var) {
        Integer num = this.Y1;
        if (num != null) {
            Parcelable parcelable = (Parcelable) f32008c2.get(num);
        }
        this.T1 = q61Var;
        boolean z10 = this.Q0;
        x51 x51Var = this.f32027h0;
        ...
        if (i11 != 3 && i11 != 4 && i11 != 6) {
            ...
            zg.e0.f49292c = d51Var;
            NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.stopAllHeavyOperations, 512);
            this.W1.lock();
            this.U1.setDuration(800L);
            x51Var.setLayerType(2, null);
            this.f32023f0.setLayerType(2, null);
            this.f32020e0.setLayerType(2, null);
            this.f32013b0.setLayerType(2, null);
            org.telegram.ui.Components.ln lnVar = this.f32038n0;
            if (lnVar != null) {
    ...
    public void setDrawBackground(boolean z10) {
        this.Q0 = z10;
        this.f32010a0.setClipToOutline(z10);
        ci.r6 r6Var = this.f32013b0;
        if (!z10) {
    ...
    public void setEnterAnimationInProgress(boolean z10) {
        if (this.T != z10) {
            this.T = z10;
            if (!z10) {
                AndroidUtilities.forEachViews((RecyclerView) this.f32027h0, (Utilities.Callback<View>) new ai.i(21));
                for (int i10 = 0; i10 < this.f32018d0.f30650b.getChildCount(); i10++) {
                    View childAt = this.f32018d0.f30650b.getChildAt(i10);
                    childAt.setScaleX(1.0f);
                    childAt.setScaleY(1.0f);
                }
                this.f32018d0.f30650b.invalidate();
            }
        }
    }
    ...
    public void setSelectedReactions(HashSet<zg.o0> hashSet) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            if (arrayList.get(i10) != null && ((zg.o0) arrayList.get(i10)).f49397g != 0) {
                hashSet2.add(Long.valueOf(((zg.o0) arrayList.get(i10)).f49397g));
            }
        }
    }
    ...
    public final void v(String str, boolean z10, boolean z11) {
        ...
        if (isEmpty) {
            ...
            if (!z12) {
                ...
                k61Var.E(false);
            } else if (!str.equals(this.f32068z1)) {
    ...
    public final void w(float f7) {
        ValueAnimator valueAnimator = this.f32030i1;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.f32030i1 = null;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f32052t0.getAlpha(), f7 * 0.25f);
        this.f32030i1 = ofFloat;
        ofFloat.addUpdateListener(new c51(this, 2));
        this.f32030i1.setDuration(200L);
        this.f32030i1.setInterpolator(org.telegram.ui.Components.rr.f28030f);
        this.f32030i1.start();
    }
    ...
    public final void z(boolean z10, boolean z11) {
        ...
        org.telegram.messenger.ok.s(animate.translationY(f7).setUpdateListener(new c51(this, 1)), org.telegram.ui.Components.rr.f28030f, 160L);
        if (this.F1 && z11) {
