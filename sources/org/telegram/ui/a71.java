...
public abstract class a71 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int f32008a;
    public final u51 f32009a0;
    public float f32010a1;
    public int f32011b;
    public final ci.r6 f32012b0;
    public float f32013b1;
    public int f32014c;
    public final org.telegram.ui.Components.ew[] f32015c0;
    public final org.telegram.ui.ActionBar.m2 f32016c1;
    public int d;
    public org.telegram.ui.Components.ew f32017d0;
    public final int f32018d1;
    public int e;
    public final s51 f32019e0;
    public final y51 f32020e1;
    public int f32021f;
    public final r51 f32022f0;
    public final int f32023f1;
    public final m51 f32024g0;
    public boolean f32025g1;
    public int h;
    public final x51 f32026h0;
    public boolean f32027h1;
    public final n51 f32028i0;
    public ValueAnimator f32029i1;
    public final FrameLayout f32030j0;
    public Drawable f32031j1;
    public final ci.m6 f32032k0;
    public final PorterDuffColorFilter f32033k1;
    public final org.telegram.ui.Components.w9 f32034l0;
    public float l1;
    public final View m0;
    public int f32035m1;
    public int f32036n;
    public final org.telegram.ui.Components.mn f32037n0;
    public org.telegram.ui.Components.o5 f32038n1;
    public final View f32039o0;
    public Rect f32040o1;
    public final z51 f32041p0;
    public View f32042p1;
    public final k61 f32043q0;
    public float f32044q1;
    public int f32045r;
    public final o51 f32046r0;
    public j61 f32047r1;
    public int f32048s;
    public final org.telegram.ui.Components.al0 f32049s0;
    public Rect f32050s1;
    public final View f32051t0;
    public final OvershootInterpolator f32052t1;
    public int f32053u0;
    public ValueAnimator f32054u1;
    public int v;
    public final ArrayList f32055v0;
    public boolean f32056v1;
    public int f32057w;
    public final SparseIntArray f32058w0;
    public boolean f32059w1;
    public int f32060x;
    public final SparseIntArray f32061x0;
    public boolean f32062x1;
    public int f32063y;
    public final SparseIntArray f32064y0;
    public boolean f32065y1;
    public final SparseIntArray f32066z0;
    public String f32067z1;
    public static final List Z1 = Arrays.asList("😖", "😫", "🫠", "😨", "❓");
    public static final boolean[] f32006b2 = new boolean[4];
    public static final HashMap f32007c2 = new HashMap();
    ...
    public static void a(a71 a71Var, int i10, int i11) {
        int i12;
        org.telegram.ui.Components.al0 al0Var = a71Var.f32049s0;
        o51 o51Var = a71Var.f32046r0;
        ...
        ci.m1 m1Var = new ci.m1(a71Var, a71Var.f32026h0.getContext(), 4);
        m1Var.f43109a = i10;
        m1Var.f13094p = i11;
        o51Var.w0(m1Var);
    }
    ...
    public Drawable getPremiumStar() {
        if (this.f32031j1 == null) {
            int i10 = this.W;
            if (i10 != 5 && i10 != 9 && i10 != 10 && i10 != 7) {
                this.f32031j1 = ApplicationLoader.applicationContext.getResources().getDrawable(R.drawable.msg_settings_premium).mutate();
            } else {
                this.f32031j1 = ApplicationLoader.applicationContext.getResources().getDrawable(R.drawable.msg_filled_blocked).mutate();
            }
            this.f32031j1.setColorFilter(this.f32033k1);
        }
        return this.f32031j1;
    }
    ...
    public static ArrayList j(HashSet hashSet, ArrayList arrayList) {
        ...
        while (i10 < arrayList.size()) {
            ...
            if (document == null || hashSet.contains(Long.valueOf(document.f18341id))) {
    ...
    public void setBigReactionAnimatedEmoji(org.telegram.ui.Components.q5 q5Var) {
        ...
        if (this.I && (q5Var2 = this.W0) != q5Var) {
            ...
            this.W0 = q5Var;
            if (q5Var != null) {
                q5Var.setColorFilter(this.f32033k1);
                this.W0.a(this);
            }
        }
    }
    ...
    public static void t(int i10) {
        ...
        if (!zArr[i10] && MediaDataController.getInstance(i10) != null) {
            ...
            org.telegram.ui.Components.hx0.f24884x3.fetch(i10, 1, new ai.m(i10, 1));
        }
    }

    public final void A(Long l4) {
        this.K.remove(l4);
        x51 x51Var = this.f32026h0;
        if (x51Var != null) {
            int i10 = 0;
            boolean z10 = false;
            for (int i11 = 0; i11 < x51Var.getChildCount(); i11++) {
                if (x51Var.getChildAt(i11) instanceof j61) {
                    ...
                    if (z5Var != null && z5Var.getDocumentId() == l4.longValue()) {
                        ...
                        if (document != null && document.f18341id == l4.longValue()) {
                            j61Var.f();
                        }
                    }
                    z10 = true;
            ...
            if (!z10) {
                while (true) {
                    ArrayList arrayList = this.f32055v0;
    ...
    public final void C() {
        ...
        if (x51Var.getChildCount() > 0) {
            ...
            if (RecyclerView.R(childAt) == this.f32008a && "searchbox".equals(childAt.getTag())) {
                r51Var.setVisibility(0);
    ...
    public final void E(float f7) {
        ...
        View view = this.m0;
        if (view != null) {
            float interpolation = org.telegram.ui.Components.sr.f28340g.getInterpolation(w7.q.a((((f7 * 800.0f) - 0.0f) / 120.0f) / 1.0f, 0.0f, 1.0f));
        ...
        org.telegram.ui.Components.mn mnVar = this.f32037n0;
        if (mnVar != null) {
        ...
        this.f32012b0.setAlpha(a14);
        this.f32022f0.setAlpha(a14);
        int i12 = 0;
        for (int i13 = 0; i13 < this.f32017d0.f30927b.getChildCount(); i13++) {
            this.f32017d0.f30927b.getChildAt(i13).setAlpha(a14);
        }
        if (this.f32038n1 != null) {
            invalidate();
        }
        float f12 = 1.0f - a14;
        u51 u51Var = this.f32009a0;
        u51Var.setTranslationY(AndroidUtilities.dp(-5.0f) * f12);
        if (mnVar != null) {
            mnVar.setTranslationY(AndroidUtilities.dp(-5.0f) * f12);
        }
        this.f32010a1 = (interpolation2 * 0.85f) + 0.15f;
        this.f32013b1 = (interpolation3 * 0.925f) + 0.075f;
        u51Var.invalidateOutline();
        if (mnVar != null) {
            mnVar.setAlpha(a14);
        }
        s51 s51Var = this.f32019e0;
        s51Var.setAlpha(a14);
        s51Var.setScaleX(Math.min(this.f32010a1, 1.0f));
        ...
        for (int i14 = 0; i14 < this.f32017d0.f30927b.getChildCount(); i14++) {
            View childAt = this.f32017d0.f30927b.getChildAt(i14);
            if (f7 == 0.0f) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        org.telegram.ui.Components.o5 o5Var = this.f32038n1;
        if (o5Var != null && (num = this.Y0) != null) {
            Rect bounds = o5Var.getBounds();
            View view = this.f32042p1;
            if (view == null) {
                scaleY = 1.0f;
            } else {
                scaleY = view.getScaleY();
            }
            int alpha = this.f32038n1.getAlpha();
            View view2 = this.f32042p1;
            if (view2 == null) {
                bounds.height();
            } else {
                view2.getHeight();
            ...
            this.f32038n1.v = (int) (Math.pow(this.f32009a0.getAlpha(), 0.25d) * alpha * this.l1);
            if (this.f32040o1 == null) {
                this.f32040o1 = new Rect();
            }
            ...
            this.f32040o1.set((int) (intValue - width), (int) (scrimDrawableTranslationY - height), (int) (intValue + width), (int) (scrimDrawableTranslationY + height));
            org.telegram.ui.Components.o5 o5Var2 = this.f32038n1;
            Rect rect = this.f32040o1;
            int i12 = rect.left;
            Rect rect2 = this.f32040o1;
            o5Var2.setBounds(i12, rect.top, (int) ((rect.width() / scaleY) + i12), (int) ((rect2.height() / scaleY) + rect2.top));
            Rect rect3 = this.f32040o1;
            canvas.scale(scaleY, scaleY, rect3.left, rect3.top);
            this.f32038n1.draw(canvas);
            org.telegram.ui.Components.o5 o5Var3 = this.f32038n1;
            o5Var3.v = alpha;
            o5Var3.setBounds(bounds);
            canvas.restore();
        }
        super.dispatchDraw(canvas);
        j61 j61Var = this.f32047r1;
        if (j61Var != null && this.f32050s1 != null && j61Var.E != null) {
            canvas.save();
            canvas.translate(0.0f, -getTranslationY());
            this.f32047r1.E.setAlpha((int) (this.f32044q1 * 255.0f));
            this.f32047r1.E.setBounds(this.f32050s1);
            this.f32047r1.E.setColorFilter(new PorterDuffColorFilter(i0.a.d(1.0f - this.l1, this.f32023f1, this.f32035m1), PorterDuff.Mode.SRC_IN));
            this.f32047r1.E.draw(canvas);
            canvas.restore();
        }
    }
    ...
    public final void h() {
        ...
        if (canScrollVertically != this.f32056v1) {
            this.f32056v1 = canScrollVertically;
            ViewPropertyAnimator animate = this.f32039o0.animate();
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (z10 && this.W == 6) {
            this.f32046r0.y1((getMeasuredWidth() / AndroidUtilities.dp(42.0f)) * 5);
        }
    }
    ...
    public final void s(q61 q61Var) {
        Integer num = this.Y1;
        if (num != null) {
            Parcelable parcelable = (Parcelable) f32007c2.get(num);
        }
        this.T1 = q61Var;
        boolean z10 = this.Q0;
        x51 x51Var = this.f32026h0;
        ...
        if (i11 != 3 && i11 != 4 && i11 != 6) {
            ...
            zg.e0.f49291c = d51Var;
            NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.stopAllHeavyOperations, 512);
            this.W1.lock();
            this.U1.setDuration(800L);
            x51Var.setLayerType(2, null);
            this.f32022f0.setLayerType(2, null);
            this.f32019e0.setLayerType(2, null);
            this.f32012b0.setLayerType(2, null);
            org.telegram.ui.Components.mn mnVar = this.f32037n0;
            if (mnVar != null) {
    ...
    public void setDrawBackground(boolean z10) {
        this.Q0 = z10;
        this.f32009a0.setClipToOutline(z10);
        ci.r6 r6Var = this.f32012b0;
        if (!z10) {
    ...
    public void setEnterAnimationInProgress(boolean z10) {
        if (this.T != z10) {
            this.T = z10;
            if (!z10) {
                AndroidUtilities.forEachViews((RecyclerView) this.f32026h0, (Utilities.Callback<View>) new ai.i(21));
                for (int i10 = 0; i10 < this.f32017d0.f30927b.getChildCount(); i10++) {
                    View childAt = this.f32017d0.f30927b.getChildAt(i10);
                    childAt.setScaleX(1.0f);
                    childAt.setScaleY(1.0f);
                }
                this.f32017d0.f30927b.invalidate();
            }
        }
    }
    ...
    public void setSelectedReactions(HashSet<zg.o0> hashSet) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            if (arrayList.get(i10) != null && ((zg.o0) arrayList.get(i10)).f49396g != 0) {
                hashSet2.add(Long.valueOf(((zg.o0) arrayList.get(i10)).f49396g));
            }
        }
    }
    ...
    public final void v(String str, boolean z10, boolean z11) {
        ...
        if (isEmpty) {
            ...
            if (!z12) {
                ...
                k61Var.E(false);
            } else if (!str.equals(this.f32067z1)) {
    ...
    public final void w(float f7) {
        ValueAnimator valueAnimator = this.f32029i1;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.f32029i1 = null;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f32051t0.getAlpha(), f7 * 0.25f);
        this.f32029i1 = ofFloat;
        ofFloat.addUpdateListener(new c51(this, 2));
        this.f32029i1.setDuration(200L);
        this.f32029i1.setInterpolator(org.telegram.ui.Components.sr.f28339f);
        this.f32029i1.start();
    }
    ...
    public final void z(boolean z10, boolean z11) {
        ...
        org.telegram.messenger.ok.s(animate.translationY(f7).setUpdateListener(new c51(this, 1)), org.telegram.ui.Components.sr.f28339f, 160L);
        if (this.F1 && z11) {
    ...
    public a71(org.telegram.ui.ActionBar.m2 m2Var, Context context, boolean z10, Integer num, int i10, boolean z11, org.telegram.ui.ActionBar.d6 d6Var, int i11) {
        this(m2Var, context, z10, num, i10, z11, d6Var, i11, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19390v6, d6Var));
    }
