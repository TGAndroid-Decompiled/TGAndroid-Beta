...
public class pv0 {
    ...
    public final ViewGroup f36612a;
    public final ViewGroup f36613b;
    public final boolean f36614c;
    public ov0 d;
    public View e;
    public ImageReceiver f36615f;
    public ImageReceiver f36616g;
    public ImageReceiver h;
    public boolean f36617i;
    public final vh.h f36618j;
    public vh.g f36619k;
    public final Path f36620l;
    public final float[] f36621m;
    public boolean f36622n;
    public float f36623o;
    public float f36624p;
    public float f36625q;
    public float f36626r;
    public float f36627s;
    public float f36628t;
    public float f36629u;
    public float v;
    public float f36630w;
    public float f36631x;
    public float f36632y;
    public float f36633z;

    public pv0(ViewGroup viewGroup, ViewGroup viewGroup2) {
        this.f36616g = new ImageReceiver();
        this.h = new ImageReceiver();
        this.f36618j = new vh.h();
        this.f36620l = new Path();
        this.f36621m = new float[8];
        this.Q = new float[2];
        this.f36612a = viewGroup;
        this.f36613b = viewGroup2;
        this.f36614c = false;
    }
            ...
            if (motionEvent.getActionMasked() == 2 && this.L) {
                ...
                if (i15 != -1 && i16 != -1) {
                    ...
                    if (hypot > 1.005f && !this.f36622n) {
                        ...
                        ov0 ov0Var = this.d;
                        ViewGroup viewGroup2 = this.f36612a;
                        boolean z11 = this.f36614c;
                        if (ov0Var == null && !z11) {
                            i13 = -1;
                        ...
                        if (this.f36616g == null) {
                            ...
                            this.f36616g = imageReceiver2;
                            imageReceiver2.setCrossfadeAlpha((byte) 2);
                            this.f36616g.setCrossfadeWithOldImage(false);
                            this.f36616g.onAttachedToWindow();
                        ...
                        if (!z11) {
                            ...
                            this.f36617i = z10;
                            if (z10 && this.f36619k == null) {
                                vh.g e = vh.g.e(this.d);
                                this.f36619k = e;
                                if (e != null) {
                                    e.f44654k.put(this.d, Integer.valueOf(i10));
                                }
                            }
                            ...
                            if (imageReceiver.getBitmap() != null && !imageReceiver.getBitmap().isRecycled() && this.f36617i) {
                            ...
                            if (messageObject == null || !messageObject.isPhoto()) {
                                ...
                                if (imageLocation != null) {
                                    i11 = i16;
                                    i14 = i15;
                                    this.f36616g.setImage(imageLocation, null, null, null, null, iArr[0], null, messageObject, messageObject.isWebpage() ? 1 : 0);
                                    this.f36616g.setCrossfadeAlpha((byte) 2);
                                } else {
                                    i14 = i15;
                                    i11 = i16;
                                }
                            ...
                            this.f36629u = imageReceiver.getImageX();
                            this.v = imageReceiver.getImageY() + viewGroup.getPaddingTop();
                            this.f36630w = imageReceiver.getImageHeight();
                            this.f36631x = imageReceiver.getImageWidth();
                            this.f36632y = imageReceiver.getBitmapHeight();
                            float bitmapWidth = imageReceiver.getBitmapWidth();
                            this.f36633z = bitmapWidth;
                            float f7 = this.f36632y;
                            float f10 = f7 / bitmapWidth;
                            float f11 = this.f36630w;
                            float f12 = this.f36631x;
                            float f13 = f11 / f12;
                            if (f10 != f13) {
                                if (f10 < f13) {
                                    this.f36633z = (bitmapWidth / f7) * f11;
                                    this.f36632y = f11;
                                } else {
                                    this.f36632y = f10 * f12;
                                    this.f36633z = f12;
                                }
                            } else {
                                this.f36632y = f11;
                            ...
                            if (messageObject != null && messageObject.isVideo() && MediaController.getInstance().isPlayingMessage(messageObject)) {
                                ...
                                ov0 ov0Var3 = this.d;
                                mediaController.setTextureView(ov0Var3.f36264b, ov0Var3.f36265c, ov0Var3.f36263a, true);
                                FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.d.f36263a.getLayoutParams();
                                this.d.f36263a.setTag(R.id.parent_tag, imageReceiver);
                                if (layoutParams.width != imageReceiver.getImageWidth() || layoutParams.height != imageReceiver.getImageHeight()) {
                                    this.d.f36265c.setResizeMode(3);
                                    layoutParams.width = (int) imageReceiver.getImageWidth();
                                    layoutParams.height = (int) imageReceiver.getImageHeight();
                                    this.d.f36263a.setLayoutParams(layoutParams);
                                }
                                this.d.f36264b.setScaleX(1.0f);
                                this.d.f36264b.setScaleY(1.0f);
                                lv0 lv0Var = this.E;
                                if (lv0Var != null) {
                                    this.d.d.setImageBitmap(lv0Var.j0().getBitmap((int) this.f36633z, (int) this.f36632y));
                                    this.d.d.s((int) this.f36633z, (int) this.f36632y);
                                    this.d.d.getImageReceiver().setRoundRadius(imageReceiver.getRoundRadius(true));
                                }
                                this.d.f36263a.setVisibility(0);
                            } else {
                                this.R = false;
                                ImageReceiver imageReceiver5 = new ImageReceiver();
                                this.f36615f = imageReceiver5;
                                imageReceiver5.onAttachedToWindow();
                                Drawable drawable = imageReceiver.getDrawable();
                                this.f36615f.setImageBitmap(drawable);
                                ...
                                this.f36615f.setImageCoords(this.f36629u, this.v, this.f36631x, this.f36630w);
                                this.f36615f.setAspectFit(imageReceiver.isAspectFit());
                                this.f36615f.setRoundRadius(imageReceiver.getRoundRadius(true));
                                this.f36616g.setRoundRadius(imageReceiver.getRoundRadius(true));
                                this.f36616g.setAspectFit(imageReceiver.isAspectFit());
                                this.d.f36263a.setVisibility(8);
                            }
                        } else {
                            i14 = i15;
                            i11 = i16;
    ...
    public final void b() {
        ...
        if (ov0Var != null && ov0Var.getParent() != null) {
            this.f36612a.removeView(this.d);
            this.d.d.getImageReceiver().clearImage();
            vh.g gVar = this.f36619k;
            if (gVar != null) {
                gVar.b(this.d);
                this.f36619k = null;
            }
            ImageReceiver imageReceiver = this.f36615f;
        ...
        ImageReceiver imageReceiver2 = this.f36615f;
        if (imageReceiver2 != null) {
            imageReceiver2.onDetachedFromWindow();
            this.f36615f.clearImage();
            this.f36615f = null;
        }
        ImageReceiver imageReceiver3 = this.f36616g;
        if (imageReceiver3 != null) {
            imageReceiver3.onDetachedFromWindow();
            this.f36616g.clearImage();
            this.f36616g = null;
        }
        ImageReceiver imageReceiver4 = this.h;
    ...
    public final void d() {
        if (this.C == null && this.f36622n) {
            ...
            this.C.setInterpolator(org.telegram.ui.Components.qr.f27715f);
            this.C.start();
        }
    }
    ...
    public void e() {
        View view;
        if (this.f36614c && (view = this.e) != null) {
            view.invalidate();
        }
        ov0 ov0Var = this.d;
        if (ov0Var != null) {
    ...
    public final boolean g(MotionEvent motionEvent) {
        if (i() && this.e != null) {
            motionEvent.offsetLocation(-this.f36625q, -this.f36626r);
    ...
    public final boolean i() {
        ...
        float f10 = 0.0f;
        float f11 = 0.0f;
        for (View view = this.e; view != this.f36612a; view = (View) view.getParent()) {
            if (view == null) {
                return false;
            }
            f10 += view.getLeft();
        ...
        float f12 = 0.0f;
        for (View view2 = this.e; view2 != this.f36613b; view2 = (View) view2.getParent()) {
            if (view2 == null) {
                return false;
            }
            f7 += view2.getLeft();
    ...
    public boolean j(View view, ImageReceiver imageReceiver) {
        if (!this.f36614c) {
            if (imageReceiver.getDrawable() instanceof org.telegram.ui.Components.d6) {
                AnimatedFileDrawableStream animatedFileDrawableStream = ((org.telegram.ui.Components.d6) imageReceiver.getDrawable()).f23455u0;
