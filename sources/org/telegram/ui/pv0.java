...
public class pv0 {
                    ...
                    if (hypot > 1.005f && !this.f36696n) {
                        ...
                        if (!z11) {
                            ...
                            if (z10 && this.f36693k == null) {
                                ...
                                this.f36693k = e;
                                if (e != null) {
                                    e.f44401k.put(this.d, Integer.valueOf(i10));
                                }
                            }
                            ...
                            if (messageObject != null && messageObject.isVideo() && MediaController.getInstance().isPlayingMessage(messageObject)) {
                                ...
                                ov0 ov0Var3 = this.d;
                                mediaController.setTextureView(ov0Var3.f36357b, ov0Var3.f36358c, ov0Var3.f36356a, true);
                                FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.d.f36356a.getLayoutParams();
                                this.d.f36356a.setTag(R.id.parent_tag, imageReceiver);
                                if (layoutParams.width != imageReceiver.getImageWidth() || layoutParams.height != imageReceiver.getImageHeight()) {
                                    this.d.f36358c.setResizeMode(3);
                                    layoutParams.width = (int) imageReceiver.getImageWidth();
                                    layoutParams.height = (int) imageReceiver.getImageHeight();
                                    this.d.f36356a.setLayoutParams(layoutParams);
                                }
                                this.d.f36357b.setScaleX(1.0f);
                                this.d.f36357b.setScaleY(1.0f);
                                lv0 lv0Var = this.E;
                                if (lv0Var != null) {
                                ...
                                this.d.f36356a.setVisibility(0);
                            } else {
                                this.R = false;
                                ...
                                this.d.f36356a.setVisibility(8);
                            }
                        } else {
                            i14 = i15;
                            i11 = i16;
    ...
    public final void d() {
        if (this.C == null && this.f36696n) {
            ...
            this.C.setInterpolator(org.telegram.ui.Components.qr.f27423f);
            this.C.start();
        }
    }
    ...
    public boolean j(View view, ImageReceiver imageReceiver) {
        if (!this.f36688c) {
            if (imageReceiver.getDrawable() instanceof org.telegram.ui.Components.b6) {
                AnimatedFileDrawableStream animatedFileDrawableStream = ((org.telegram.ui.Components.b6) imageReceiver.getDrawable()).f22655u0;
