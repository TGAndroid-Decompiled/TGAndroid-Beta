...
public final class pv0 extends org.telegram.ui.Components.vl0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        ...
        int b10 = c1Var.b();
        rv0 rv0Var = this.d;
        if (b10 != rv0Var.f37509i0 && b10 != rv0Var.f37523u0 && b10 != rv0Var.f37524v0) {
            if (rv0Var.I && b10 >= (i10 = rv0Var.f37514n0) && b10 < rv0Var.f37529y + i10) {
                if (b10 - i10 < rv0Var.f37527x) {
                    return false;
                }
            } else if (b10 != rv0Var.f37515o0 && b10 != rv0Var.f37519r0 && b10 != rv0Var.f37521s0 && (rv0Var.N != 0 || b10 != rv0Var.f37522t0)) {
                return false;
            }
            return true;
        }
    ...
    @Override
    public final int h() {
        return this.d.f37528x0;
    }

    @Override
    public final int j(int i10) {
        rv0 rv0Var = this.d;
        if (i10 != rv0Var.f37508h0 && i10 != rv0Var.m0 && i10 != rv0Var.f37517q0) {
            if (i10 == rv0Var.f37512l0) {
                return 1;
            }
            if (i10 != rv0Var.f37516p0 && i10 != rv0Var.f37526w0 && i10 != rv0Var.f37511k0) {
                ...
                if (i10 == rv0Var.f37510j0) {
                    return 7;
                }
                if (i10 != rv0Var.f37519r0 && i10 != rv0Var.f37521s0 && i10 != rv0Var.f37522t0 && i10 != rv0Var.f37523u0 && i10 != rv0Var.f37524v0) {
                    return 5;
                }
                return 6;
            }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i16 != 0) {
            ...
            if (i16 != 6) {
                ...
                e9Var.setBackground(org.telegram.ui.ActionBar.h6.V0(context, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.h6.f19024b7));
                if (i10 == rv0Var.f37511k0) {
                    e9Var.setText(LocaleController.getString(R.string.AddAnExplanationInfo));
                    return;
                } else if (i10 == rv0Var.f37526w0) {
                    e9Var.setFixedSize(12);
                    e9Var.setText(null);
                    return;
                } else {
                    int i17 = rv0Var.f37513n - rv0Var.f37529y;
                    if (i17 <= 0) {
                        if (z10) {
            ...
            if (i10 == rv0Var.f37523u0) {
                ...
                w8Var.e(null, true);
                return;
            } else if (i10 == rv0Var.f37519r0) {
                w8Var.f(LocaleController.getString(R.string.PollAnonymous), rv0Var.G, (rv0Var.f37521s0 == -1 && rv0Var.f37522t0 == -1) ? true : true);
                w8Var.e(null, true);
                return;
            } else if (i10 == rv0Var.f37521s0) {
                String string = LocaleController.getString(R.string.PollMultiple);
                boolean z13 = rv0Var.K;
                if (rv0Var.f37522t0 != -1) {
                    z12 = true;
                }
                w8Var.f(string, z13, z12);
                w8Var.e(null, true);
                return;
            } else if (i10 == rv0Var.f37522t0) {
        ...
        if (i10 == rv0Var.f37508h0) {
            if (z10) {
                if (rv0Var.f37531z0 != null) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
                        ...
                        if (i10 != 4) {
                            if (i10 != 6) {
                                if (i10 != 7) {
                                    ...
                                    ov0Var2.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19060d6, false));
                                    ...
                                    nv0Var.d();
                                    nv0Var.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19060d6, false));
                            ...
                            mv0Var.d();
                            mv0Var.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19060d6, false));
            ...
            View m4Var = new org.telegram.ui.Cells.m4(this.f36685c, org.telegram.ui.ActionBar.h6.L6, 21, 15, false, null);
    ...
    public final void y(s4.c1 c1Var) {
        ...
        if (i13 == 4) {
            ...
            int i14 = b10 - rv0Var.f37514n0;
            if (rv0Var.I && i14 < rv0Var.f37527x) {
                z10 = false;
            } else {
                z10 = true;
            }
            ...
            d6Var2.setTag(null);
            ImageView imageView = d6Var2.f20138f;
            if (imageView != null) {
                if (z10) {
                    i11 = 0;
                } else {
            ...
            if (!rv0Var.f37506f0 && rv0Var.f37507g0 == b10) {
                EditTextBoldCursor textView = d6Var2.getTextView();
                textView.requestFocus();
                AndroidUtilities.showKeyboard(textView);
                rv0Var.f37506f0 = false;
                rv0Var.f37507g0 = -1;
            }
