...
public final class pv0 extends org.telegram.ui.Components.wl0 {
    public final Context f36683c;
    public final rv0 d;

    public pv0(rv0 rv0Var, Context context) {
        this.d = rv0Var;
        this.f36683c = context;
    }
    ...
    public final boolean D(s4.c1 c1Var) {
        ...
        int b10 = c1Var.b();
        rv0 rv0Var = this.d;
        if (b10 != rv0Var.f37507i0 && b10 != rv0Var.f37521u0 && b10 != rv0Var.f37522v0) {
            if (rv0Var.I && b10 >= (i10 = rv0Var.f37512n0) && b10 < rv0Var.f37527y + i10) {
                if (b10 - i10 < rv0Var.f37525x) {
                    return false;
                }
            } else if (b10 != rv0Var.f37513o0 && b10 != rv0Var.f37517r0 && b10 != rv0Var.f37519s0 && (rv0Var.N != 0 || b10 != rv0Var.f37520t0)) {
                return false;
            }
            return true;
        }
    ...
    @Override
    public final int h() {
        return this.d.f37526x0;
    }

    @Override
    public final int j(int i10) {
        rv0 rv0Var = this.d;
        if (i10 != rv0Var.f37506h0 && i10 != rv0Var.m0 && i10 != rv0Var.f37515q0) {
            if (i10 == rv0Var.f37510l0) {
                return 1;
            }
            if (i10 != rv0Var.f37514p0 && i10 != rv0Var.f37524w0 && i10 != rv0Var.f37509k0) {
                ...
                if (i10 == rv0Var.f37508j0) {
                    return 7;
                }
                if (i10 != rv0Var.f37517r0 && i10 != rv0Var.f37519s0 && i10 != rv0Var.f37520t0 && i10 != rv0Var.f37521u0 && i10 != rv0Var.f37522v0) {
                    return 5;
                }
                return 6;
            }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i16 != 0) {
            ...
            if (i16 != 6) {
                ...
                if (i10 == rv0Var.f37509k0) {
                    e9Var.setText(LocaleController.getString(R.string.AddAnExplanationInfo));
                    return;
                } else if (i10 == rv0Var.f37524w0) {
                    e9Var.setFixedSize(12);
                    e9Var.setText(null);
                    return;
                } else {
                    int i17 = rv0Var.f37511n - rv0Var.f37527y;
                    if (i17 <= 0) {
                        if (z10) {
            ...
            if (i10 == rv0Var.f37521u0) {
                ...
                w8Var.e(null, true);
                return;
            } else if (i10 == rv0Var.f37517r0) {
                w8Var.f(LocaleController.getString(R.string.PollAnonymous), rv0Var.G, (rv0Var.f37519s0 == -1 && rv0Var.f37520t0 == -1) ? true : true);
                w8Var.e(null, true);
                return;
            } else if (i10 == rv0Var.f37519s0) {
                String string = LocaleController.getString(R.string.PollMultiple);
                boolean z13 = rv0Var.K;
                if (rv0Var.f37520t0 != -1) {
                    z12 = true;
                }
                w8Var.f(string, z13, z12);
                w8Var.e(null, true);
                return;
            } else if (i10 == rv0Var.f37520t0) {
        ...
        if (i10 == rv0Var.f37506h0) {
            if (z10) {
                if (rv0Var.f37529z0 != null) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
                        ...
                        if (i10 != 4) {
                            if (i10 != 6) {
                                if (i10 != 7) {
                                    ...
                                    ov0Var2.c(new org.telegram.ui.Components.sn(6, this, ov0Var2));
            ...
            View m4Var = new org.telegram.ui.Cells.m4(this.f36683c, org.telegram.ui.ActionBar.h6.L6, 21, 15, false, null);
    ...
    public final void y(s4.c1 c1Var) {
        ...
        if (i13 == 4) {
            ...
            int i14 = b10 - rv0Var.f37512n0;
            if (rv0Var.I && i14 < rv0Var.f37525x) {
                z10 = false;
            } else {
                z10 = true;
            }
            ...
            if (!rv0Var.f37504f0 && rv0Var.f37505g0 == b10) {
                EditTextBoldCursor textView = d6Var2.getTextView();
                textView.requestFocus();
                AndroidUtilities.showKeyboard(textView);
                rv0Var.f37504f0 = false;
                rv0Var.f37505g0 = -1;
            }
