...
public final class yq0 extends org.telegram.ui.ActionBar.m2 {
    public static final org.telegram.ui.Components.ur0 f40225y = new org.telegram.ui.Components.ur0(4);
    public final tq0 f40226a;
    public final tq0 f40227b;
    public org.telegram.ui.ActionBar.u0 f40228c;
    public org.telegram.ui.Components.ku d;
    public boolean e;
    public final Paint f40229f;
    public ScrollSlidingTextTabStrip h;
    public final wq0[] f40230n;
    public AnimatorSet f40231r;
    public boolean f40232s;
    public boolean v;
    public boolean f40233w;
    public int f40234x;

    public yq0(HashMap hashMap, ArrayList arrayList, int i10, boolean z10, wn wnVar) {
        super(null);
        this.e = true;
        this.f40229f = new Paint();
        this.f40230n = new wq0[2];
        this.f40226a = new tq0(0, null, hashMap, arrayList, i10, z10, wnVar, false);
        this.f40227b = new tq0(1, null, hashMap, arrayList, i10, z10, wnVar, false);
    }
    ...
    public static void h0(yq0 yq0Var, String str) {
        yq0Var.f40228c.getSearchField().setText(str);
        yq0Var.f40228c.getSearchField().setSelection(str.length());
        yq0Var.actionBar.w();
    }
    ...
    public final View createView(Context context) {
        wq0[] wq0VarArr;
        View view;
        this.actionBar.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19130h5, false));
        ...
        EditTextBoldCursor searchField = this.f40228c.getSearchField();
        ...
        this.f40234x = ViewConfiguration.get(context).getScaledMaximumFlingVelocity();
        vq0 vq0Var = new vq0(this, context);
        this.fragmentView = vq0Var;
        vq0Var.setWillNotDraw(false);
        tq0 tq0Var = this.f40226a;
        ...
        for (int i13 = 0; i13 < 4; i13++) {
            if (i13 != 0) {
                if (i13 != 1) {
                    if (i13 != 2) {
                        view = tq0Var.f38194c0;
                    } else {
                        view = tq0Var.f38192b0;
                    }
                } else {
                    view = tq0Var.f38190a0;
                }
            } else {
                view = tq0Var.Z;
            }
        ...
        k0 k0Var = tq0Var.f38190a0;
        n50 n50Var = tq0Var.f38192b0;
        View view2 = tq0Var.f38194c0;
        org.telegram.ui.Components.ku kuVar2 = tq0Var.f38195d0;
        tq0 tq0Var2 = this.f40227b;
        tq0Var2.Z = frameLayout;
        tq0Var2.f38190a0 = k0Var;
        tq0Var2.f38195d0 = kuVar2;
        tq0Var2.f38192b0 = n50Var;
        tq0Var2.f38194c0 = view2;
        tq0Var2.f38209q0 = false;
        tq0Var2.setParentFragment(this);
        int i14 = 0;
        while (true) {
            wq0VarArr = this.f40230n;
            ...
            if (i14 == 0) {
                ...
                wq0Var2.f39744a = tq0Var;
                wq0Var2.d = tq0Var.K;
            } else if (i14 == 1) {
                wq0 wq0Var3 = wq0VarArr[i14];
                wq0Var3.f39744a = tq0Var2;
                wq0Var3.d = tq0Var2.K;
                wq0Var3.setVisibility(8);
            }
            wq0VarArr[i14].d.setScrollingTouchSlop(1);
            wq0 wq0Var4 = wq0VarArr[i14];
            wq0Var4.f39745b = (FrameLayout) wq0Var4.f39744a.getFragmentView();
            wq0VarArr[i14].d.setClipToPadding(false);
            wq0 wq0Var5 = wq0VarArr[i14];
            wq0Var5.f39746c = wq0Var5.f39744a.getActionBar();
            wq0 wq0Var6 = wq0VarArr[i14];
            wq0Var6.addView(wq0Var6.f39745b, w7.y5.c(-1.0f, -1));
            wq0 wq0Var7 = wq0VarArr[i14];
            wq0Var7.addView(wq0Var7.f39746c, w7.y5.c(-2.0f, -1));
            wq0VarArr[i14].f39746c.setVisibility(8);
        ...
        vq0Var.addView(tq0Var.f38190a0, w7.y5.d(60, 60.0f, 85, 0.0f, 0.0f, 12.0f, 10.0f));
        vq0Var.addView(tq0Var.f38192b0, w7.y5.d(42, 24.0f, 85, 0.0f, 0.0f, -2.0f, 9.0f));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f40228c.getSearchField(), 16777216, null, null, null, null, i11));
        ...
        arrayList.addAll(this.f40226a.getThemeDescriptions());
        arrayList.addAll(this.f40227b.getThemeDescriptions());
        return arrayList;
    }
    ...
    public final void onResume() {
        super.onResume();
        org.telegram.ui.ActionBar.u0 u0Var = this.f40228c;
        if (u0Var != null) {
            u0Var.z(true);
