...
public final class yq0 extends org.telegram.ui.Components.kl0 {
    public final Context f39937c;
    public final ar0 d;

    public yq0(ar0 ar0Var, Context context) {
        this.d = ar0Var;
        this.f39937c = context;
    }
    ...
    public final boolean D(s4.c1 c1Var) {
        ...
        if (ar0Var.J == null) {
            if (TextUtils.isEmpty(ar0Var.v)) {
                ...
                return true;
            } else if (c1Var.b() >= ar0Var.f31901f.size()) {
                return false;
            } else {
                return true;
            }
    ...
    public final int h() {
        ...
        if (albumEntry == null) {
            if (ar0Var.f31901f.isEmpty()) {
                if (!TextUtils.isEmpty(ar0Var.v) || ar0Var.f31909n.isEmpty()) {
                    return 0;
                }
                return ar0Var.f31909n.size() + 2;
            }
            return ar0Var.f31901f.size() + (!ar0Var.f31916s ? 1 : 0);
        }
    ...
    public final int j(int i10) {
        ...
        if (ar0Var.f31901f.isEmpty()) {
            if (i10 == ar0Var.f31909n.size()) {
                return 4;
            }
            return 3;
        } else if (i10 < ar0Var.f31901f.size()) {
            return 0;
        } else {
            return 1;
        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        ar0 ar0Var = this.d;
        MediaController.AlbumEntry albumEntry = ar0Var.J;
        ArrayList arrayList = ar0Var.f31909n;
        ArrayList arrayList2 = ar0Var.f31897c;
        HashMap hashMap = ar0Var.f31895b;
        ...
        if (albumEntry != null) {
            ...
            if (ar0Var.e) {
                i12 = arrayList2.indexOf(searchImage.f15595id);
            }
            t5Var.b(i12, hashMap.containsKey(searchImage.f15595id), false);
            L1 = PhotoViewer.L1(searchImage.getPathToAttach());
        }
        imageView.getImageReceiver().setVisible(!L1, true);
        t5Var.getCheckBox().setVisibility((ar0Var.T != 0 || L1) ? 8 : 8);
    }
            ...
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 != 3) {
                        ...
                        viewGroup2 = r8Var;
                        if (z10) {
                            r8Var.f20793a.setTextColor(org.telegram.ui.ActionBar.i6.w0(null, ar0Var.f31920v0, false));
                            r8Var.e.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19099rg, false), PorterDuff.Mode.MULTIPLY));
                            viewGroup2 = r8Var;
                        }
                    }
                } else {
