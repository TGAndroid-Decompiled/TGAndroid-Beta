...
public class PrivacySettingsActivity extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public org.telegram.ui.Components.tl0 f34550b;
    private int bioRow;
    private int birthdayRow;
    private int blockedRow;
    public org.telegram.ui.ActionBar.d2 f34551c;
    ...
    public static void U(PrivacySettingsActivity privacySettingsActivity) {
        if (privacySettingsActivity.f34549a != null) {
    ...
    public static void V(PrivacySettingsActivity privacySettingsActivity, Context context, View view, int i10) {
        ...
        if (view.isEnabled()) {
            if (i10 == privacySettingsActivity.autoDeleteMesages) {
            ...
            } else if (i10 == privacySettingsActivity.f34556s) {
                ...
                if (i10 == privacySettingsActivity.deleteAccountRow) {
                    if (privacySettingsActivity.getParentActivity() != null) {
                        ...
                        alertDialog$Builder.f21166a.O = LocaleController.getString("DeleteAccountTitle", R.string.DeleteAccountTitle);
                    ...
                    if (password != null && (str = password.login_email_pattern) != null) {
                        ...
                        if (indexOf != lastIndexOf && indexOf != -1 && lastIndexOf != -1) {
                            ...
                            obj.f31227c = i14;
                            valueOf.setSpan(new org.telegram.ui.Components.u01(obj, 0), indexOf, i14, 0);
                        }
                        AlertDialog$Builder alertDialog$Builder2 = new AlertDialog$Builder(context);
                        alertDialog$Builder2.f21166a.O = valueOf;
                        alertDialog$Builder2.f21166a.Q = LocaleController.getString(R.string.EmailLoginChangeMessage);
                    ...
                    if (password2 != null) {
                        ...
                        privacySettingsActivity.presentFragment(new qg1(i12, privacySettingsActivity.d));
                    }
                    ...
                    if (Build.VERSION.SDK_INT >= 28 && BuildVars.SUPPORTS_PASSKEYS) {
                        ...
                        if (arrayList != null && arrayList.size() > 0) {
                            privacySettingsActivity.presentFragment(new PasskeysActivity(privacySettingsActivity.f34552e));
                        } else {
                    ...
                    if (privacySettingsActivity.getParentActivity() != null) {
                        ...
                        alertDialog$Builder3.f21166a.O = LocaleController.getString("SyncContactsDeleteTitle", R.string.SyncContactsDeleteTitle);
                        alertDialog$Builder3.f21166a.Q = AndroidUtilities.replaceTags(LocaleController.getString("SyncContactsDeleteText", R.string.SyncContactsDeleteText));
                        ...
                        org.telegram.ui.ActionBar.d2 d2Var = alertDialog$Builder3.f21166a;
                    ...
                    if (privacySettingsActivity.S) {
                        ...
                        alertDialog$Builder4.f21166a.O = LocaleController.getString("SuggestContactsTitle", R.string.SuggestContactsTitle);
                        alertDialog$Builder4.f21166a.Q = LocaleController.getString("SuggestContactsAlert", R.string.SuggestContactsAlert);
                        alertDialog$Builder4.k(LocaleController.getString("MuteDisable", R.string.MuteDisable), new vl0(12, privacySettingsActivity, s8Var2));
                        alertDialog$Builder4.h(LocaleController.getString("Cancel", R.string.Cancel), null);
                        org.telegram.ui.ActionBar.d2 d2Var2 = alertDialog$Builder4.f21166a;
                    ...
                    alertDialog$Builder5.f21166a.O = LocaleController.getString("PrivacyPaymentsClearAlertTitle", R.string.PrivacyPaymentsClearAlertTitle);
                    alertDialog$Builder5.f21166a.Q = LocaleController.getString("PrivacyPaymentsClearAlertText", R.string.PrivacyPaymentsClearAlertText);
                    ...
                    for (int i15 = 0; i15 < 2; i15++) {
                        ...
                        z1Var.setTextColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21766j5, false));
                    ...
                    privacySettingsActivity.showDialog(alertDialog$Builder5.f21166a);
                    org.telegram.ui.ActionBar.d2 d2Var3 = alertDialog$Builder5.f21166a;
    ...
    public static SpannableStringBuilder u0(PrivacySettingsActivity privacySettingsActivity, String str) {
        if (privacySettingsActivity.Z == null) {
            ...
            org.telegram.ui.Components.k5 k5Var = new org.telegram.ui.Components.k5(AndroidUtilities.dp(18.0f), AndroidUtilities.dp(18.0f), fg.q1.d().f6517f);
    ...
    public final View createView(Context context) {
        ...
        this.f34549a = new kx0(this, context);
        ...
        this.f34550b = tl0Var;
        tl0Var.p1();
        this.actionBar.setAdaptiveBackground(this.f34550b);
        this.f34550b.setLayoutManager(new k(1, false, 14));
        this.f34550b.setVerticalScrollBarEnabled(false);
        this.f34550b.setLayoutAnimation(null);
        this.f34550b.setItemAnimator(null);
        frameLayout.addView(this.f34550b, k7.c6.c(-1.0f, -1));
        this.f34550b.setAdapter(this.f34549a);
        this.f34550b.setOnItemClickListener(new hg.v0(21, this, context));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.didUpdateGlobalAutoDeleteTimer && (kx0Var = this.f34549a) != null) {
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f34550b, 16, new Class[]{org.telegram.ui.Cells.aa.class, org.telegram.ui.Cells.m4.class, org.telegram.ui.Cells.s8.class}, null, null, null, org.telegram.ui.ActionBar.k6.f21659d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f34550b, 32768, null, null, null, null, org.telegram.ui.ActionBar.k6.f21930s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f34550b, 4096, null, null, null, null, org.telegram.ui.ActionBar.k6.f21750i6));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f34550b, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.k6.f21779k0, null, null, org.telegram.ui.ActionBar.k6.f21660d7));
        int i10 = org.telegram.ui.ActionBar.k6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f34550b, 0, new Class[]{org.telegram.ui.Cells.aa.class}, new String[]{"textView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f34550b, 0, new Class[]{org.telegram.ui.Cells.aa.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.k6.I6));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f34550b, 0, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.k6.L6));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f34550b, 32, new Class[]{org.telegram.ui.Cells.a9.class}, null, null, null, org.telegram.ui.ActionBar.k6.f21624b7));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f34550b, 0, new Class[]{org.telegram.ui.Cells.a9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.k6.B6));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f34550b, 0, new Class[]{org.telegram.ui.Cells.s8.class}, new String[]{"textView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f34550b, 0, new Class[]{org.telegram.ui.Cells.s8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.k6.f22053z6));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f34550b, 0, new Class[]{org.telegram.ui.Cells.s8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.k6.M6));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f34550b, 0, new Class[]{org.telegram.ui.Cells.s8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.k6.N6));
        return arrayList;
    }
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f34550b.setPadding(0, 0, 0, i13);
        this.f34550b.setClipToPadding(false);
    }
