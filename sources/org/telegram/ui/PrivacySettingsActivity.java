...
public class PrivacySettingsActivity extends org.telegram.ui.ActionBar.m2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ux0 f31512a;
    public SessionsActivity f31513a0;
    private int autoDeleteMesages;
    public org.telegram.ui.Components.wl0 f31514b;
    public SessionsActivity f31515b0;
    private int bioRow;
    private int birthdayRow;
    private int blockedRow;
    public org.telegram.ui.ActionBar.a2 f31516c;
    public SpannableString f31517c0;
    ...
    public static void U(PrivacySettingsActivity privacySettingsActivity) {
        if (privacySettingsActivity.f31512a != null) {
            int j02 = privacySettingsActivity.f31515b0.j0();
    ...
    public static void V(PrivacySettingsActivity privacySettingsActivity, Context context, View view, int i10) {
        ...
        if (view.isEnabled()) {
            if (i10 == privacySettingsActivity.autoDeleteMesages) {
            ...
            } else if (i10 == privacySettingsActivity.f31521s) {
                privacySettingsActivity.f31513a0.resetFragment();
                privacySettingsActivity.presentFragment(privacySettingsActivity.f31513a0);
            } else if (i10 == privacySettingsActivity.webSessionsRow) {
                privacySettingsActivity.f31515b0.resetFragment();
                privacySettingsActivity.presentFragment(privacySettingsActivity.f31515b0);
            } else {
                int i11 = 4;
                int i12 = 5;
                boolean z11 = true;
                if (i10 == privacySettingsActivity.deleteAccountRow) {
                    if (privacySettingsActivity.getParentActivity() != null) {
                        ...
                        alertDialog$Builder.f18662a.R = LocaleController.getString("DeleteAccountTitle", R.string.DeleteAccountTitle);
                    ...
                    if (password != null && (str = password.login_email_pattern) != null) {
                        ...
                        alertDialog$Builder2.f18662a.R = valueOf;
                        alertDialog$Builder2.f18662a.T = LocaleController.getString(R.string.EmailLoginChangeMessage);
                    ...
                    if (privacySettingsActivity.getParentActivity() != null) {
                        ...
                        alertDialog$Builder3.f18662a.R = LocaleController.getString("SyncContactsDeleteTitle", R.string.SyncContactsDeleteTitle);
                        alertDialog$Builder3.f18662a.T = AndroidUtilities.replaceTags(LocaleController.getString("SyncContactsDeleteText", R.string.SyncContactsDeleteText));
                        ...
                        org.telegram.ui.ActionBar.a2 a2Var = alertDialog$Builder3.f18662a;
                    ...
                    if (privacySettingsActivity.V) {
                        ...
                        alertDialog$Builder4.f18662a.R = LocaleController.getString("SuggestContactsTitle", R.string.SuggestContactsTitle);
                        alertDialog$Builder4.f18662a.T = LocaleController.getString("SuggestContactsAlert", R.string.SuggestContactsAlert);
                        ...
                        org.telegram.ui.ActionBar.a2 a2Var2 = alertDialog$Builder4.f18662a;
                    ...
                    alertDialog$Builder5.f18662a.R = LocaleController.getString("PrivacyPaymentsClearAlertTitle", R.string.PrivacyPaymentsClearAlertTitle);
                    alertDialog$Builder5.f18662a.T = LocaleController.getString("PrivacyPaymentsClearAlertText", R.string.PrivacyPaymentsClearAlertText);
                    ...
                    for (int i15 = 0; i15 < 2; i15++) {
                        ...
                        a2Var3.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19166j5, false));
                    ...
                    privacySettingsActivity.showDialog(alertDialog$Builder5.f18662a);
                    org.telegram.ui.ActionBar.a2 a2Var4 = alertDialog$Builder5.f18662a;
    ...
    public static SpannableStringBuilder u0(PrivacySettingsActivity privacySettingsActivity, String str) {
        if (privacySettingsActivity.f31517c0 == null) {
            privacySettingsActivity.f31517c0 = new SpannableString("★");
            org.telegram.ui.Components.p5 p5Var = new org.telegram.ui.Components.p5(AndroidUtilities.dp(18.0f), AndroidUtilities.dp(18.0f), rg.a1.d().f42534f);
            p5Var.setBounds(0, 0, AndroidUtilities.dp(18.0f), AndroidUtilities.dp(18.0f));
            privacySettingsActivity.f31517c0.setSpan(new ImageSpan(p5Var, 2), 0, privacySettingsActivity.f31517c0.length(), 17);
        }
        return new SpannableStringBuilder(str).append((CharSequence) " \u2009").append((CharSequence) privacySettingsActivity.f31517c0);
    }
    ...
    public final void A0(boolean z10) {
        ...
        SessionsActivity sessionsActivity = this.f31515b0;
    ...
    public final View createView(Context context) {
        ...
        this.f31512a = new ux0(this, context);
        ...
        this.f31514b = wl0Var;
        wl0Var.p1();
        this.actionBar.setAdaptiveBackground(this.f31514b);
        this.f31514b.setLayoutManager(new gg.b0(1, false, 16));
        this.f31514b.setVerticalScrollBarEnabled(false);
        this.f31514b.setLayoutAnimation(null);
        this.f31514b.setItemAnimator(null);
        frameLayout.addView(this.f31514b, w7.y5.c(-1.0f, -1));
        this.f31514b.setAdapter(this.f31512a);
        this.f31514b.setOnItemClickListener(new ai.n6(21, this, context));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.didUpdateGlobalAutoDeleteTimer && (ux0Var = this.f31512a) != null) {
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31514b, 16, new Class[]{org.telegram.ui.Cells.ea.class, org.telegram.ui.Cells.m4.class, org.telegram.ui.Cells.w8.class}, null, null, null, org.telegram.ui.ActionBar.h6.f19060d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31514b, 32768, null, null, null, null, org.telegram.ui.ActionBar.h6.f19338s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31514b, 4096, null, null, null, null, org.telegram.ui.ActionBar.h6.f19149i6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31514b, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.h6.f19181k0, null, null, org.telegram.ui.ActionBar.h6.f19061d7));
        int i10 = org.telegram.ui.ActionBar.h6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31514b, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"textView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31514b, 0, new Class[]{org.telegram.ui.Cells.ea.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.I6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31514b, 0, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.L6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31514b, 32, new Class[]{org.telegram.ui.Cells.e9.class}, null, null, null, org.telegram.ui.ActionBar.h6.f19024b7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31514b, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.B6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31514b, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"textView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31514b, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f19462z6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31514b, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.M6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f31514b, 0, new Class[]{org.telegram.ui.Cells.w8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.N6));
        return arrayList;
    }
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f31514b.setPadding(0, 0, 0, i13);
        this.f31514b.setClipToPadding(false);
    }
