...
public class PrivacySettingsActivity extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public org.telegram.ui.Components.jl0 f35974b;
    private int bioRow;
    private int birthdayRow;
    private int blockedRow;
    public org.telegram.ui.ActionBar.c2 f35975c;
    ...
    public static void U(PrivacySettingsActivity privacySettingsActivity) {
        if (privacySettingsActivity.f35973a != null) {
    ...
    public static void V(PrivacySettingsActivity privacySettingsActivity, Context context, View view, int i10) {
        ...
        if (view.isEnabled()) {
            if (i10 == privacySettingsActivity.autoDeleteMesages) {
            ...
            } else if (i10 == privacySettingsActivity.f35980s) {
                ...
                if (i10 == privacySettingsActivity.deleteAccountRow) {
                    if (privacySettingsActivity.getParentActivity() != null) {
                        ...
                        alertDialog$Builder.f22714a.N = LocaleController.getString("DeleteAccountTitle", R.string.DeleteAccountTitle);
                    ...
                    if (password != null && (str = password.login_email_pattern) != null) {
                        ...
                        if (indexOf != lastIndexOf && indexOf != -1 && lastIndexOf != -1) {
                            ...
                            obj.f29026c = i14;
                            valueOf.setSpan(new org.telegram.ui.Components.i01(obj, 0), indexOf, i14, 0);
                        }
                        AlertDialog$Builder alertDialog$Builder2 = new AlertDialog$Builder(context);
                        alertDialog$Builder2.f22714a.N = valueOf;
                        alertDialog$Builder2.f22714a.P = LocaleController.getString(R.string.EmailLoginChangeMessage);
                    ...
                    if (password2 != null) {
                        ...
                        privacySettingsActivity.presentFragment(new cg1(i12, privacySettingsActivity.d));
                    }
                    ...
                    if (Build.VERSION.SDK_INT >= 28 && BuildVars.SUPPORTS_PASSKEYS) {
                        ...
                        if (arrayList != null && arrayList.size() > 0) {
                            privacySettingsActivity.presentFragment(new PasskeysActivity(privacySettingsActivity.f35976e));
                        } else {
                    ...
                    if (privacySettingsActivity.getParentActivity() != null) {
                        ...
                        alertDialog$Builder3.f22714a.N = LocaleController.getString("SyncContactsDeleteTitle", R.string.SyncContactsDeleteTitle);
                        alertDialog$Builder3.f22714a.P = AndroidUtilities.replaceTags(LocaleController.getString("SyncContactsDeleteText", R.string.SyncContactsDeleteText));
                        ...
                        org.telegram.ui.ActionBar.c2 c2Var = alertDialog$Builder3.f22714a;
                    ...
                    if (privacySettingsActivity.R) {
                        ...
                        alertDialog$Builder4.f22714a.N = LocaleController.getString("SuggestContactsTitle", R.string.SuggestContactsTitle);
                        alertDialog$Builder4.f22714a.P = LocaleController.getString("SuggestContactsAlert", R.string.SuggestContactsAlert);
                        alertDialog$Builder4.k(LocaleController.getString("MuteDisable", R.string.MuteDisable), new kl0(13, privacySettingsActivity, q8Var2));
                    ...
                    alertDialog$Builder5.f22714a.N = LocaleController.getString("PrivacyPaymentsClearAlertTitle", R.string.PrivacyPaymentsClearAlertTitle);
                    alertDialog$Builder5.f22714a.P = LocaleController.getString("PrivacyPaymentsClearAlertText", R.string.PrivacyPaymentsClearAlertText);
                    ...
                    for (int i15 = 0; i15 < 2; i15++) {
                        ...
                        String str3 = string;
                        privacySettingsActivity.V[i15] = true;
                    ...
                    privacySettingsActivity.showDialog(alertDialog$Builder5.f22714a);
    ...
    public static SpannableStringBuilder u0(PrivacySettingsActivity privacySettingsActivity, String str) {
        if (privacySettingsActivity.Y == null) {
            ...
            org.telegram.ui.Components.o5 o5Var = new org.telegram.ui.Components.o5(AndroidUtilities.dp(18.0f), AndroidUtilities.dp(18.0f), cg.s1.d().f3364f);
    ...
    public final View createView(Context context) {
        ...
        this.f35973a = new xw0(this, context);
        ...
        this.f35974b = jl0Var;
        jl0Var.p1();
        this.actionBar.setAdaptiveBackground(this.f35974b);
        this.f35974b.setLayoutManager(new k(1, false, 14));
        this.f35974b.setVerticalScrollBarEnabled(false);
        this.f35974b.setLayoutAnimation(null);
        this.f35974b.setItemAnimator(null);
        frameLayout.addView(this.f35974b, i7.f6.c(-1.0f, -1));
        this.f35974b.setAdapter(this.f35973a);
        this.f35974b.setOnItemClickListener(new eg.w0(22, this, context));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.didUpdateGlobalAutoDeleteTimer && (xw0Var = this.f35973a) != null) {
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.f35974b, 16, new Class[]{org.telegram.ui.Cells.y9.class, org.telegram.ui.Cells.k4.class, org.telegram.ui.Cells.q8.class}, null, null, null, org.telegram.ui.ActionBar.g6.f23062d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.f35974b, 32768, null, null, null, null, org.telegram.ui.ActionBar.g6.f23329s8));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.f35974b, 4096, null, null, null, null, org.telegram.ui.ActionBar.g6.f23152i6));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.f35974b, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.g6.f23183k0, null, null, org.telegram.ui.ActionBar.g6.f23063d7));
        int i10 = org.telegram.ui.ActionBar.g6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.f35974b, 0, new Class[]{org.telegram.ui.Cells.y9.class}, new String[]{"textView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.f35974b, 0, new Class[]{org.telegram.ui.Cells.y9.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.I6));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.f35974b, 0, new Class[]{org.telegram.ui.Cells.k4.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.L6));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.f35974b, 32, new Class[]{org.telegram.ui.Cells.y8.class}, null, null, null, org.telegram.ui.ActionBar.g6.f23028b7));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.f35974b, 0, new Class[]{org.telegram.ui.Cells.y8.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.B6));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.f35974b, 0, new Class[]{org.telegram.ui.Cells.q8.class}, new String[]{"textView"}, null, null, -1, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.f35974b, 0, new Class[]{org.telegram.ui.Cells.q8.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.f23450z6));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.f35974b, 0, new Class[]{org.telegram.ui.Cells.q8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.M6));
        arrayList.add(new org.telegram.ui.ActionBar.i6(this.f35974b, 0, new Class[]{org.telegram.ui.Cells.q8.class}, new String[]{"checkBox"}, null, null, -1, null, org.telegram.ui.ActionBar.g6.N6));
        return arrayList;
    }
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f35974b.setPadding(0, 0, 0, i13);
        this.f35974b.setClipToPadding(false);
    }
