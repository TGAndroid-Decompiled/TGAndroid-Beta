...
public final class vm implements xu0 {
    public final TL_iv.RichMessage f38586a;
    public final ArrayList f38587b;
    public final MessageObject f38588c;

    public vm(TL_iv.RichMessage richMessage, ArrayList arrayList, MessageObject messageObject) {
        this.f38586a = richMessage;
        this.f38587b = arrayList;
        this.f38588c = messageObject;
    }

    @Override
    public final boolean a(int i10) {
        if (i10 >= 0) {
            ArrayList arrayList = this.f38587b;
            if (i10 < arrayList.size()) {
                TL_iv.PageBlock pageBlock = (TL_iv.PageBlock) arrayList.get(i10);
                if (pageBlock instanceof TL_iv.pageBlockVideo) {
                    TLRPC.Document b10 = e4.b(this.f38586a, ((TL_iv.pageBlockVideo) pageBlock).video_id);
                    if (b10 != null) {
    ...
    public final File b(int i10) {
        ...
        if (i10 >= 0) {
            ...
            if (i10 < arrayList.size()) {
                ...
                TL_iv.RichMessage richMessage = this.f38586a;
                if (z10) {
    ...
    public final Object g() {
        MessageObject messageObject = this.f38588c;
    ...
    public final TL_iv.PageBlock get(int i10) {
        return (TL_iv.PageBlock) this.f38587b.get(i10);
    }
