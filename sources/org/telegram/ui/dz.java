...
public final class dz extends org.telegram.ui.ActionBar.n2 {
    public az f35888a;
    public org.telegram.ui.Components.ll0 f35889b;
    public s4.y f35890c;
    public ImageView d;
    public final ArrayList f35891e;
    public cz f35892f;
    public int h;
    public int f35893n;
    public int f35894r;
    public int f35895s;
    public int v;
    public final int f35896w;
    public final int f35897x;
    public z0 f35898y;
    ...
    public static void U(dz dzVar, Context context, int i10) {
        ArrayList arrayList = dzVar.f35891e;
        if (i10 == dzVar.h) {
    ...
    public final void Z() {
        this.v = 2;
        this.h = 1;
        ArrayList arrayList = this.f35891e;
    ...
    public final View createView(Context context) {
        ...
        this.f35888a = new az(this, context);
        ...
        this.f35889b.setVerticalScrollBarEnabled(false);
        this.f35889b.setAdapter(this.f35888a);
        ((s4.j) this.f35889b.getItemAnimator()).C = false;
        frameLayout.addView(this.f35889b, w7.x5.c(-1.0f, -1));
        s4.y yVar = new s4.y(new bz(this));
        this.f35890c = yVar;
        yVar.d(this.f35889b);
        this.f35889b.setOnItemClickListener(new bi.x5(16, this, context));
        this.f35889b.setOnItemLongClickListener(new zy(this));
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35889b, 16, new Class[]{org.telegram.ui.Cells.r8.class}, null, null, null, org.telegram.ui.ActionBar.j6.f20664d6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35889b, 32768, null, null, null, null, i10));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35889b, 4096, null, null, null, null, org.telegram.ui.ActionBar.j6.f20754i6));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35889b, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.j6.f20786k0, null, null, org.telegram.ui.ActionBar.j6.f20665d7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35889b, 32, new Class[]{org.telegram.ui.Cells.e9.class}, null, null, null, org.telegram.ui.ActionBar.j6.f20628b7));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35889b, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.j6.B6));
        int i11 = org.telegram.ui.ActionBar.j6.q6;
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35889b, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"textView"}, null, null, -1, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f35889b, 0, new Class[]{org.telegram.ui.Cells.r8.class}, new String[]{"imageView"}, null, null, -1, null, i11));
        return arrayList;
    }
