...
public final class mn0 implements OnCompleteListener, org.telegram.ui.ActionBar.z1, vt {
    ...
    public void a1(qt qtVar) {
        switch (this.f35632a) {
            case 2:
                oo0 oo0Var = this.f35633b;
                oo0Var.A0 = qtVar;
                oo0Var.f36289f[4].setText(qtVar.f36980a);
                return;
            default:
                oo0 oo0Var2 = this.f35633b;
                oo0Var2.A0 = qtVar;
                oo0Var2.f36289f[4].setText(qtVar.f36980a);
                oo0Var2.B0 = qtVar.d;
                return;
        }
    }
