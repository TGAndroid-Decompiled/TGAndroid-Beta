...
public final class mn0 extends FrameLayout implements DownloadController.FileDownloadProgressListener {
    public final TextView f35778a;
    public final TextView f35779b;
    public final org.telegram.ui.Components.u9 f35780c;
    public final org.telegram.ui.Components.bj0 d;
    public int e;
    public SecureDocument f35781f;
    public final int h;
    public final on0 f35782n;
    ...
    public final void a(boolean z10) {
        ...
        int i12;
        int i13;
        String attachFileName = FileLoader.getAttachFileName(this.f35781f);
        boolean exists = FileLoader.getInstance(UserConfig.selectedAccount).getPathToAttach(this.f35781f).exists();
        ...
        SecureDocument secureDocument = this.f35781f;
        String str = secureDocument.path;
        float f7 = 0.0f;
        on0 on0Var = this.f35782n;
        if (str != null) {
            ...
            DownloadController.getInstance(i12).addLoadingFileObserver(this.f35781f.path, this);
            this.e = 1;
            Float fileProgress = ImageLoader.getInstance().getFileProgress(this.f35781f.path);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        org.telegram.ui.Components.u9 u9Var = this.f35780c;
    ...
    public void setValue(CharSequence charSequence) {
        this.f35779b.setText(charSequence);
    }
}
