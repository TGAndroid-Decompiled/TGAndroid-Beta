...
public final class mn0 extends org.telegram.ui.Components.vv0 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final LinearLayout f35851c;
    public EditTextBoldCursor[] d;
    public final TextView e;
    public final TextView f35852f;
    public final ImageView h;
    public final jn0 f35853n;
    public final jn0 f35854r;
    public final nn0 f35855s;
    public Timer v;
    public Timer f35856w;
    public final Object f35857x;
    public int f35858y;
    ...
    public mn0(qn0 qn0Var, Context context, int i10) {
        ...
        this.f35853n = jn0Var;
        jn0Var.setTextColor(org.telegram.ui.ActionBar.j6.w0(null, i18, false));
        ...
        if (i10 == 3) {
            ...
            addView(jn0Var, w7.x5.q(-2, -2, i12));
            ?? view = new View(context);
            Paint paint = new Paint();
            view.f36140a = paint;
            Paint paint2 = new Paint();
            view.f36141b = paint2;
            paint.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18928gi, false));
            paint2.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18945hi, false));
            this.f35855s = view;
            if (LocaleController.isRTL) {
                i13 = 5;
            } else {
    ...
    public final boolean c(boolean z10) {
        ...
        if (!z10) {
            ...
            alertDialog$Builder.f18447a.T = LocaleController.getString(R.string.StopVerification);
        ...
        tL_auth_cancelCode.phone_number = this.f35849a;
        tL_auth_cancelCode.phone_code_hash = this.f35850b;
    ...
    public final void h(String str) {
        ...
        if (TextUtils.isEmpty(code)) {
            AndroidUtilities.shakeView(this.f35851c);
            return;
        }
        this.J = true;
        int i11 = this.L;
        ...
        verifyphone.phone_number = this.f35849a;
        verifyphone.phone_code = code;
        verifyphone.phone_code_hash = this.f35850b;
        s();
        qn0Var.y1();
        i10 = ((org.telegram.ui.ActionBar.o2) qn0Var).currentAccount;
    ...
    @Override
    public final void j() {
        LinearLayout linearLayout = this.f35851c;
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        if (bundle != null) {
            ...
            this.f35849a = bundle.getString("phone");
            this.f35850b = bundle.getString("phoneHash");
            ...
            if (editTextBoldCursorArr != null && editTextBoldCursorArr.length == this.O) {
                ...
                for (final int i21 = 0; i21 < this.O; i21++) {
                    ...
                    mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19009l6, false), PorterDuff.Mode.MULTIPLY));
                    ...
                    this.f35851c.addView(editTextBoldCursor2, w7.x5.t(34, 36, 1, 0, 0, i10, 0));
                    this.d[i21].addTextChangedListener(new kn0(this, i21));
                        ...
                        public final boolean onKey(View view, int i23, KeyEvent keyEvent) {
                            ...
                            if (i23 == 67) {
                                ...
                                if (editTextBoldCursorArr3[i24].length() == 0 && i24 > 0) {
                                    int i25 = i24 - 1;
                                    EditTextBoldCursor editTextBoldCursor3 = mn0Var.d[i25];
                                    editTextBoldCursor3.setSelection(editTextBoldCursor3.length());
                                    mn0Var.d[i25].requestFocus();
                                    mn0Var.d[i25].dispatchKeyEvent(keyEvent);
                                    return true;
                                }
                                return false;
                            }
            ...
            if (nn0Var != null) {
                ...
                nn0Var.setVisibility(i15);
            }
            if (this.f35849a == null) {
                return;
            }
            String j3 = org.telegram.messenger.w1.j(new StringBuilder("+"), this.f35849a, gf.b.c());
            if (i17 == 2) {
            ...
            jn0 jn0Var = this.f35854r;
            jn0 jn0Var2 = this.f35853n;
            if (i17 == 3) {
                int i23 = this.M;
                i11 = 2;
                if (i23 == 4 || i23 == 2) {
            ...
            if (i17 == i11 && ((i13 = this.M) == 4 || i13 == 3)) {
                ...
                objArr[0] = 2;
                objArr[1] = 0;
                jn0Var2.setText(LocaleController.formatString("CallText", i25, objArr));
                if (this.f35858y < 1000) {
                    i14 = 0;
                } else {
                    i14 = 8;
                }
                jn0Var.setVisibility(i14);
                if (this.f35858y < 1000) {
                    i16 = 8;
                }
                jn0Var2.setVisibility(i16);
                q();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.L != 3 && (imageView = this.h) != null) {
            int dp = AndroidUtilities.dp(35.0f) + this.e.getMeasuredHeight() + this.f35852f.getMeasuredHeight() + imageView.getMeasuredHeight();
            int dp2 = AndroidUtilities.dp(80.0f);
            int dp3 = AndroidUtilities.dp(291.0f);
            qn0 qn0Var = this.Q;
            if (qn0Var.f36988s0 - dp < dp2) {
                setMeasuredDimension(getMeasuredWidth(), dp + dp2);
            } else {
                setMeasuredDimension(getMeasuredWidth(), Math.min(qn0Var.f36988s0, dp3));
            }
        }
    }

    public final void p() {
        if (this.f35856w != null) {
            return;
        }
        this.E = 15000;
        this.f35856w = new Timer();
        this.G = System.currentTimeMillis();
        this.f35856w.schedule(new ci.p2(this, 4), 0L, 1000L);
    }
    ...
    public final void r() {
        try {
            synchronized (this.f35857x) {
                Timer timer = this.f35856w;
                if (timer != null) {
                    timer.cancel();
                    this.f35856w = null;
                }
    ...
    public final void u() {
        ...
        bundle.putString("phone", this.f35849a);
        this.J = true;
        qn0 qn0Var = this.Q;
        qn0Var.y1();
        TLRPC.TL_auth_resendCode tL_auth_resendCode = new TLRPC.TL_auth_resendCode();
        tL_auth_resendCode.phone_number = this.f35849a;
        tL_auth_resendCode.phone_code_hash = this.f35850b;
        i10 = ((org.telegram.ui.ActionBar.o2) qn0Var).currentAccount;
