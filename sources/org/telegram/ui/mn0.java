...
public final class mn0 implements OnCompleteListener, org.telegram.ui.ActionBar.z1, vt {
    ...
    public void a1(qt qtVar) {
        switch (this.f35633a) {
            case 2:
                oo0 oo0Var = this.f35634b;
                oo0Var.A0 = qtVar;
                oo0Var.f36290f[4].setText(qtVar.f36981a);
                return;
            default:
                oo0 oo0Var2 = this.f35634b;
                oo0Var2.A0 = qtVar;
                oo0Var2.f36290f[4].setText(qtVar.f36981a);
                oo0Var2.B0 = qtVar.d;
                return;
        }
    }
