...
public final class mn0 extends FrameLayout implements DownloadController.FileDownloadProgressListener {
    ...
    public final org.telegram.ui.Components.w9 f35007c;
    public final org.telegram.ui.Components.lj0 d;
    public int e;
    public SecureDocument f35008f;
    public final int h;
    public final on0 f35009n;
    ...
    public mn0(on0 on0Var, Activity activity) {
        ...
        addView(w9Var, w7.a6.d(48, 48.0f, i11 | 48, 21.0f, 8.0f, 21.0f, 0.0f));
        ...
        addView(textView, w7.a6.d(-2, -2.0f, i18, f7, 10.0f, i15, 0.0f));
        ...
        addView(textView2, w7.a6.d(-2, -2.0f, i19, i17, 35.0f, z11 ? 81 : 21, 0.0f));
    ...
    public final void a(boolean z10) {
        ...
        int i12;
        int i13;
        String attachFileName = FileLoader.getAttachFileName(this.f35008f);
        boolean exists = FileLoader.getInstance(UserConfig.selectedAccount).getPathToAttach(this.f35008f).exists();
        ...
        SecureDocument secureDocument = this.f35008f;
        String str = secureDocument.path;
        float f7 = 0.0f;
        on0 on0Var = this.f35009n;
        if (str != null) {
            ...
            DownloadController.getInstance(i12).addLoadingFileObserver(this.f35008f.path, this);
            this.e = 1;
            Float fileProgress = ImageLoader.getInstance().getFileProgress(this.f35008f.path);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        org.telegram.ui.Components.w9 w9Var = this.f35007c;
    ...
    public void setValue(CharSequence charSequence) {
        this.f35006b.setText(charSequence);
    }
}
