...
public final class p8 implements RequestDelegate {
    ...
    public final l9 f36487b;
    public final org.telegram.ui.ActionBar.b2 f36488c;
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f36486a) {
            case 0:
                final l9 l9Var = this.f36487b;
                final org.telegram.ui.ActionBar.b2 b2Var = this.f36488c;
                final HashSet hashSet = this.d;
                final TLRPC.TL_inputGroupCallInviteMessage tL_inputGroupCallInviteMessage = this.e;
                final boolean z10 = this.f36489f;
                ...
                return;
            default:
                final l9 l9Var2 = this.f36487b;
                final org.telegram.ui.ActionBar.b2 b2Var2 = this.f36488c;
                final HashSet hashSet2 = this.d;
                final TLRPC.TL_inputGroupCallInviteMessage tL_inputGroupCallInviteMessage2 = this.e;
                final boolean z11 = this.f36489f;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        switch (r8) {
