...
public final class st0 implements org.telegram.ui.Components.e71 {
    public boolean f37552a = true;
    public final PhotoViewer f37553b;

    public st0(PhotoViewer photoViewer) {
        this.f37553b = photoViewer;
    }

    @Override
    public final void onError(org.telegram.ui.Components.h71 h71Var, Exception exc) {
        View findViewWithTag;
        PhotoViewer photoViewer = this.f37553b;
        if (photoViewer.F2 == h71Var) {
            FileLog.e(exc);
            ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout = photoViewer.f31040o0.f19606b;
            if (actionBarPopupWindow$ActionBarPopupWindowLayout != null && (findViewWithTag = actionBarPopupWindow$ActionBarPopupWindowLayout.findViewWithTag(10)) != null && findViewWithTag.getVisibility() == 0) {
                AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(photoViewer.f31132y, 0, photoViewer.f31105v2);
                alertDialog$Builder.f18447a.R = LocaleController.getString("AppName", R.string.AppName);
                alertDialog$Builder.f18447a.T = LocaleController.getString(R.string.CantPlayVideo);
    ...
    public final void onStateChanged(boolean z10, int i10) {
        ...
        boolean z11;
        PhotoViewer photoViewer = this.f37553b;
        ArrayList arrayList = photoViewer.f30978g7;
        ...
        if (this.f37552a && (h71Var = photoViewer.F2) != null && h71Var.p() != -9223372036854775807L) {
            this.f37552a = false;
            if (photoViewer.Y6.isEmpty() && photoViewer.e7.isEmpty() && photoViewer.f30923a7.isEmpty() && !arrayList.isEmpty() && (i11 = photoViewer.Q4) >= 0 && i11 < arrayList.size()) {
    ...
    public final boolean onSurfaceDestroyed(SurfaceTexture surfaceTexture) {
        ...
        PhotoViewer photoViewer = this.f37553b;
        if (p5 != null && org.telegram.ui.Components.fg0.p().f40821b.f42256a != 0 && (textureView = photoViewer.f31116w3) != null && textureView.getSurfaceTexture() == surfaceTexture) {
        ...
        if (photoViewer.F3) {
            ...
            if (photoViewer.J3) {
                photoViewer.G3 = 1;
                photoViewer.f31116w3.setSurfaceTexture(surfaceTexture);
                photoViewer.f31116w3.setSurfaceTextureListener(photoViewer.f31001j4);
                photoViewer.f31116w3.setVisibility(0);
                return true;
            }
        }
        return false;
