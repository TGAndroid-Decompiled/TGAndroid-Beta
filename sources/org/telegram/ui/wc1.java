...
public final class wc1 implements org.telegram.ui.ActionBar.f6 {
    public org.telegram.ui.ActionBar.f6 f41926a;
    public final SparseIntArray f41927b = new SparseIntArray();
    public final Paint f41928c = new Paint(3);
    public final Paint d = new Paint(3);
    public final Paint f41929e;
    public final TextPaint f41930f;
    public final TextPaint h;
    public final TextPaint f41931n;
    public Bitmap f41932r;
    public BitmapShader f41933s;
    public Matrix v;
    public final wd1 f41934w;
    public final wd1 f41935x;
    ...
    public wc1(wd1 wd1Var) {
        ...
        this.f41930f = textPaint;
        TextPaint textPaint2 = new TextPaint();
        this.h = textPaint2;
        TextPaint textPaint3 = new TextPaint();
        this.f41931n = textPaint3;
    ...
    public final Paint G(String str) {
        ...
        switch (c10) {
            ...
            case 5:
                return this.f41930f;
            default:
                org.telegram.ui.ActionBar.f6 f6Var = this.f41926a;
                if (f6Var != null) {
                    return f6Var.G(str);
                }
    ...
    public final boolean a() {
        nd1 nd1Var = this.f41935x.f41986p1;
        if (nd1Var != null) {
            return nd1Var.a();
        }
        nd1 nd1Var2 = this.f41934w.f41986p1;
        if (nd1Var2 != null) {
            return nd1Var2.a();
        }
        org.telegram.ui.ActionBar.f6 f6Var = this.f41926a;
    ...
    public final void b(Drawable drawable, Drawable drawable2, Float f7) {
        ...
        float f12;
        float f13;
        int i10 = org.telegram.ui.ActionBar.j6.f20843lc;
        int G0 = G0(i10);
        int G02 = G0(org.telegram.ui.ActionBar.j6.f20861mc);
        if (drawable == null) {
            drawable = drawable2;
        }
        boolean z10 = drawable instanceof org.telegram.ui.Components.dc0;
        TextPaint textPaint = this.h;
        TextPaint textPaint2 = this.f41930f;
        if ((z10 || (drawable instanceof BitmapDrawable)) && SharedConfig.getDevicePerformanceClass() != 0 && LiteMode.isEnabled(32)) {
            if (z10) {
                bitmap = ((org.telegram.ui.Components.dc0) drawable).f25381k;
            } else if (drawable instanceof BitmapDrawable) {
                bitmap = ((BitmapDrawable) drawable).getBitmap();
            } else {
                bitmap = null;
            }
            if (this.f41932r != bitmap) {
                this.f41932r = bitmap;
                Bitmap bitmap2 = this.f41932r;
                Shader.TileMode tileMode = Shader.TileMode.CLAMP;
                this.f41933s = new BitmapShader(bitmap2, tileMode, tileMode);
                if (this.v == null) {
                    this.v = new Matrix();
                }
            }
            ...
            textPaint2.linkColor = G0(org.telegram.ui.ActionBar.j6.f20805jc);
        }
        Paint paint = this.f41928c;
        paint.setColor(G0);
        Paint paint2 = this.d;
        paint2.setColor(G02);
        if (this.f41933s != null && (this.f41927b.indexOfKey(i10) < 0 || z10 || (drawable instanceof BitmapDrawable))) {
            ColorMatrix colorMatrix = new ColorMatrix();
            if (z10) {
                float f14 = -0.06f;
                if (((org.telegram.ui.Components.dc0) drawable).f25387q >= 0.0f) {
            ...
            if (z10) {
                float f15 = ((org.telegram.ui.Components.dc0) drawable).f25387q;
                if (f7 != null) {
                    f15 = f7.floatValue();
                }
                if (f15 >= 0.0f) {
            ...
            paint.setShader(this.f41933s);
            paint.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
            paint.setAlpha(255);
            paint2.setShader(this.f41933s);
    ...
    public final void l(float f7, float f10, int i10, int i11) {
        ...
        Bitmap bitmap = this.f41932r;
        if (bitmap != null && (bitmapShader = this.f41933s) != null) {
