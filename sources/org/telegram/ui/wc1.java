...
public final class wc1 implements org.telegram.ui.ActionBar.e6 {
    public org.telegram.ui.ActionBar.e6 f38773a;
    public final SparseIntArray f38774b = new SparseIntArray();
    public final Paint f38775c = new Paint(3);
    public final Paint d = new Paint(3);
    public final Paint e;
    public final TextPaint f38776f;
    public final TextPaint h;
    public final TextPaint f38777n;
    public Bitmap f38778r;
    public BitmapShader f38779s;
    public Matrix v;
    public final wd1 f38780w;
    public final wd1 f38781x;
    ...
    public wc1(wd1 wd1Var) {
        ...
        this.f38776f = textPaint;
        TextPaint textPaint2 = new TextPaint();
        this.h = textPaint2;
        TextPaint textPaint3 = new TextPaint();
        this.f38777n = textPaint3;
    ...
    public final Paint G(String str) {
        ...
        switch (c10) {
            ...
            case 5:
                return this.f38776f;
            default:
                org.telegram.ui.ActionBar.e6 e6Var = this.f38773a;
                if (e6Var != null) {
                    return e6Var.G(str);
                }
    ...
    public final boolean a() {
        nd1 nd1Var = this.f38781x.f38829p1;
        if (nd1Var != null) {
            return nd1Var.a();
        }
        nd1 nd1Var2 = this.f38780w.f38829p1;
        if (nd1Var2 != null) {
            return nd1Var2.a();
        }
        org.telegram.ui.ActionBar.e6 e6Var = this.f38773a;
    ...
    public final void b(Drawable drawable, Drawable drawable2, Float f7) {
        ...
        float f12;
        float f13;
        int i10 = org.telegram.ui.ActionBar.i6.f18985lc;
        int G0 = G0(i10);
        int G02 = G0(org.telegram.ui.ActionBar.i6.f19004mc);
        if (drawable == null) {
            drawable = drawable2;
        }
        boolean z10 = drawable instanceof org.telegram.ui.Components.cc0;
        TextPaint textPaint = this.h;
        TextPaint textPaint2 = this.f38776f;
        if ((z10 || (drawable instanceof BitmapDrawable)) && SharedConfig.getDevicePerformanceClass() != 0 && LiteMode.isEnabled(32)) {
            if (z10) {
                bitmap = ((org.telegram.ui.Components.cc0) drawable).f23054k;
            } else if (drawable instanceof BitmapDrawable) {
                bitmap = ((BitmapDrawable) drawable).getBitmap();
            } else {
                bitmap = null;
            }
            if (this.f38778r != bitmap) {
                this.f38778r = bitmap;
                Bitmap bitmap2 = this.f38778r;
                Shader.TileMode tileMode = Shader.TileMode.CLAMP;
                this.f38779s = new BitmapShader(bitmap2, tileMode, tileMode);
                if (this.v == null) {
                    this.v = new Matrix();
                }
            }
            ...
            textPaint2.linkColor = G0(org.telegram.ui.ActionBar.i6.f18947jc);
        }
        Paint paint = this.f38775c;
        paint.setColor(G0);
        Paint paint2 = this.d;
        paint2.setColor(G02);
        if (this.f38779s != null && (this.f38774b.indexOfKey(i10) < 0 || z10 || (drawable instanceof BitmapDrawable))) {
            ColorMatrix colorMatrix = new ColorMatrix();
            if (z10) {
                float f14 = -0.06f;
                if (((org.telegram.ui.Components.cc0) drawable).f23060q >= 0.0f) {
            ...
            if (z10) {
                float f15 = ((org.telegram.ui.Components.cc0) drawable).f23060q;
                if (f7 != null) {
                    f15 = f7.floatValue();
                }
                if (f15 >= 0.0f) {
            ...
            paint.setShader(this.f38779s);
            paint.setColorFilter(new ColorMatrixColorFilter(colorMatrix));
            paint.setAlpha(255);
            paint2.setShader(this.f38779s);
    ...
    public final void m(float f7, float f10, int i10, int i11) {
        ...
        Bitmap bitmap = this.f38778r;
        if (bitmap != null && (bitmapShader = this.f38779s) != null) {
