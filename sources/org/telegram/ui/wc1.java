...
public final class wc1 implements View.OnClickListener {
    ...
    public int f38818b = 0;
    public final xd1 f38819c;
    ...
    public final void onClick(View view) {
        switch (this.f38817a) {
            case 0:
                xd1 xd1Var = this.f38819c;
                xd1Var.F0.setRotation(this.f38818b);
                this.f38818b -= 45;
                xd1Var.F0.animate().rotationBy(-45.0f).setDuration(300L).setInterpolator(org.telegram.ui.Components.qr.f27654g).start();
                md1[] md1VarArr = xd1Var.f39553w0;
                ...
                if (md1Var != null) {
                    ...
                    if (background instanceof org.telegram.ui.Components.nc0) {
                        ...
                        if (xd1Var.f39497b == 2) {
                            xd1Var.f39519h1 += 45;
                            while (true) {
                                int i10 = xd1Var.f39519h1;
                                if (i10 >= 360) {
                                    xd1Var.f39519h1 = i10 - 360;
                                } else {
                            ...
                            h6Var.f18952n += 45;
                            while (true) {
                                int i11 = h6Var.f18952n;
                                if (i11 >= 360) {
                                    h6Var.f18952n = i11 - 360;
                                } else {
                ...
                return;
            default:
                xd1 xd1Var2 = this.f38819c;
                org.telegram.ui.ActionBar.q5 q5Var = xd1Var2.R;
                xd1Var2.G0.setRotation(this.f38818b);
                this.f38818b -= 45;
                xd1Var2.G0.animate().rotationBy(-45.0f).setDuration(300L).setInterpolator(org.telegram.ui.Components.qr.f27654g).start();
                ...
                if (i12 != 0) {
                    ...
                    h6Var2.e = h6Var2.f18945f;
                    h6Var2.f18945f = h6Var2.f18946g;
                    h6Var2.f18946g = i12;
                    h6Var2.h = i13;
                } else {
                    int i14 = h6Var2.e;
                ...
                xd1Var2.V.e(h6Var2.f18946g, 2);
                xd1Var2.V.e(h6Var2.f18945f, 1);
                ...
                xd1Var2.K0[1].b(1, h6Var2.f18945f);
                xd1Var2.K0[1].b(2, h6Var2.f18946g);
