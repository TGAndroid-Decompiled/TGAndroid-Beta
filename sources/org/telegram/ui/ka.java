...
public final class ka implements TextWatcher {
    ...
    public final void beforeTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
        ...
        la laVar = this.f35025a;
        ra raVar = laVar.f35317c;
        String str = raVar.f37006r;
        if (charSequence == null) {
            charSequence2 = "";
        } else {
            charSequence2 = charSequence.toString();
        }
        raVar.f37006r = charSequence2;
        ra raVar2 = laVar.f35317c;
        oa oaVar = raVar2.E;
        if (oaVar != null && str != null) {
            oaVar.b(raVar2.f37006r);
        }
    }
