...
public final class aj1 implements org.telegram.ui.ActionBar.b2, qy {
    ...
    public void f(org.telegram.ui.ActionBar.c2 c2Var, int i10) {
        ...
        for (int i12 = 0; i12 < longSparseArray.size(); i12++) {
            ...
            if (valueAt instanceof fj1) {
                ...
                TLRPC.WallPaper wallPaper = fj1Var.f33716l;
                if (wallPaper != null && wallPaper.f18273id < 0) {
                    wallpapersListActivity.getMessagesStorage().deleteWallpaper(fj1Var.f33716l.f18273id);
                    wallpapersListActivity.f31645d0.remove(fj1Var);
                    wallpapersListActivity.f31642b0.remove(fj1Var.a());
                } else {
                    valueAt = wallPaper;
                }
            }
    ...
    public boolean u(wy wyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, fg1 fg1Var) {
        ...
        int i17;
        String b10;
        WallpapersListActivity wallpapersListActivity = this.f31912a.f32824a;
        StringBuilder sb2 = new StringBuilder();
        int i18 = 0;
        while (true) {
            longSparseArray = wallpapersListActivity.f31649g0;
