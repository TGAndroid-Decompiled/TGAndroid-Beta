...
public final class aj1 implements org.telegram.ui.ActionBar.b2, qy {
    public final cj1 f31908a;
    ...
    public void f(org.telegram.ui.ActionBar.c2 c2Var, int i10) {
        ...
        LongSparseArray longSparseArray = wallpapersListActivity.f31645g0;
        ...
        for (int i12 = 0; i12 < longSparseArray.size(); i12++) {
            ...
            if (valueAt instanceof fj1) {
                ...
                TLRPC.WallPaper wallPaper = fj1Var.f33712l;
                if (wallPaper != null && wallPaper.f18273id < 0) {
                    wallpapersListActivity.getMessagesStorage().deleteWallpaper(fj1Var.f33712l.f18273id);
                    wallpapersListActivity.f31641d0.remove(fj1Var);
                    wallpapersListActivity.f31638b0.remove(fj1Var.a());
                } else {
                    valueAt = wallPaper;
                }
            }
            if (valueAt instanceof TLRPC.WallPaper) {
                ...
                if (valueAt instanceof TLRPC.TL_wallPaperNoFile) {
                    ...
                    tL_inputWallPaperNoFile.f18194id = wallPaper2.f18273id;
                    savewallpaper.wallpaper = tL_inputWallPaperNoFile;
                } else {
                    TLRPC.TL_inputWallPaper tL_inputWallPaper = new TLRPC.TL_inputWallPaper();
                    tL_inputWallPaper.f18193id = wallPaper2.f18273id;
    ...
    public boolean u(wy wyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, fg1 fg1Var) {
        ...
        int i17;
        String b10;
        WallpapersListActivity wallpapersListActivity = this.f31908a.f32820a;
        StringBuilder sb2 = new StringBuilder();
        int i18 = 0;
        while (true) {
            longSparseArray = wallpapersListActivity.f31645g0;
