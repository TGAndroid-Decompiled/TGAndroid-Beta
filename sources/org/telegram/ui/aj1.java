...
public final class aj1 implements org.telegram.ui.ActionBar.a2, oy {
    ...
    public void f(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        ...
        for (int i12 = 0; i12 < longSparseArray.size(); i12++) {
            ...
            if (valueAt instanceof fj1) {
                ...
                TLRPC.WallPaper wallPaper = fj1Var.f33602l;
                if (wallPaper != null && wallPaper.f18264id < 0) {
                    wallpapersListActivity.getMessagesStorage().deleteWallpaper(fj1Var.f33602l.f18264id);
                    wallpapersListActivity.f31628d0.remove(fj1Var);
                    wallpapersListActivity.f31625b0.remove(fj1Var.a());
                } else {
                    valueAt = wallPaper;
                }
            }
            if (valueAt instanceof TLRPC.WallPaper) {
                ...
                if (valueAt instanceof TLRPC.TL_wallPaperNoFile) {
                    ...
                    tL_inputWallPaperNoFile.f18185id = wallPaper2.f18264id;
                    savewallpaper.wallpaper = tL_inputWallPaperNoFile;
                } else {
                    TLRPC.TL_inputWallPaper tL_inputWallPaper = new TLRPC.TL_inputWallPaper();
                    tL_inputWallPaper.f18184id = wallPaper2.f18264id;
    ...
    public boolean u(uy uyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, dg1 dg1Var) {
        ...
        int i17;
        String b10;
        WallpapersListActivity wallpapersListActivity = this.f31854a.f32807a;
        StringBuilder sb2 = new StringBuilder();
        int i18 = 0;
        while (true) {
            longSparseArray = wallpapersListActivity.f31632g0;
