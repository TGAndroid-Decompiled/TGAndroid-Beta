...
public final class tf1 extends View {
    public final HashMap f37737a;
    public final uf1 f37738b;

    public tf1(uf1 uf1Var, Activity activity) {
        super(activity);
        this.f37738b = uf1Var;
        this.f37737a = new HashMap();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i18 = 0; i18 < uf1Var.F().size(); i18++) {
            if (uf1Var.F().get(i18) != null && ((wf1) uf1Var.F().get(i18)).f39026c != null) {
                String str = ((wf1) uf1Var.F().get(i18)).f39026c.title;
                HashMap hashMap = this.f37737a;
                ...
                if (((wf1) uf1Var.F().get(i18)).f39026c.f18173id == 1) {
                    dp2 = dp4;
                }
                if (((wf1) uf1Var.F().get(i18)).f39026c.hidden) {
                    i16++;
                }
                i17 += dp4;
            }
