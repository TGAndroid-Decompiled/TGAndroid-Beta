...
public final class tf1 extends og.b {
    ...
    public final int j(int i10) {
        ...
        return ((vf1) this.d.f33294b.get(i10)).f15531a;
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 3) {
            ...
            boolean isBotForumWithEditableTopics = UserObject.isBotForumWithEditableTopics(i11, -eg1Var.f33291a);
            bg1Var.setForumIcon(ng.d.d(ng.a.f15215k[0], ""));
        ...
        bg1Var.f20706k0 = z10;
        bg1Var.setArchivedPullAnimation(eg1Var.f33331w);
