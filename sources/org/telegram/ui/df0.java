...
public final class df0 implements org.telegram.ui.ActionBar.b2 {
    ...
    public final void f(org.telegram.ui.ActionBar.c2 c2Var, int i10) {
        switch (this.f33109a) {
            case 0:
                jf0 jf0Var = this.f33110b;
                jf0Var.c(true);
                jf0Var.O.u1(0, true, null, true);
                jf0Var.o();
                return;
            case 1:
                jf0 jf0Var2 = this.f33110b;
                jf0Var2.O.f39902p0.popup = false;
                jf0Var2.h(null);
                return;
            case 2:
                jf0 jf0Var3 = this.f33110b;
                yg0 yg0Var = jf0Var3.O;
                AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(yg0Var.getParentActivity());
                alertDialog$Builder.f18446a.R = LocaleController.getString("TermsOfService", R.string.TermsOfService);
                alertDialog$Builder.f18446a.T = LocaleController.getString("TosDecline", R.string.TosDecline);
                ...
                yg0Var.showDialog(alertDialog$Builder.f18446a);
                return;
            case 3:
                jf0 jf0Var4 = this.f33110b;
                jf0Var4.O.f39902p0.popup = false;
                jf0Var4.h(null);
                return;
            default:
                jf0 jf0Var5 = this.f33110b;
                jf0Var5.c(true);
