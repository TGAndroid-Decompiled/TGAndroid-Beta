...
public final class df0 extends org.telegram.ui.Components.uv0 {
    public final rg0 E;
    public final org.telegram.ui.Components.bj0 f32637a;
    public final TextView f32638b;
    public final TextView f32639c;
    public final TextView d;
    public final TextView e;
    public final TextView f32640f;
    public x5 h;
    public Bundle f32641n;
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        this.f32641n = bundle;
        this.f32642r = bundle.getString("phoneFormated");
        this.f32643s = bundle.getString("phoneHash");
        this.v = bundle.getString("code");
        this.f32644w = bundle.getInt("startTime");
        this.f32645x = bundle.getInt("waitTime");
        int i10 = R.string.ResetAccountInfo;
        gf.b c10 = gf.b.c();
        this.f32639c.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ResetAccountInfo", i10, LocaleController.addNbsp(c10.b("+" + this.f32642r)))));
        o();
    ...
    public final void n() {
        ...
        this.f32638b.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i10, false));
        this.f32639c.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i10, false));
        this.f32640f.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i10, false));
    ...
    public final void o() {
        ...
        int i11;
        int i12;
        int i13 = this.f32645x;
        i10 = ((org.telegram.ui.ActionBar.n2) this.E).currentAccount;
        int currentTime = i13 - (ConnectionsManager.getInstance(i10).getCurrentTime() - this.f32644w);
        int i14 = 0;
        ...
        Boolean bool = this.f32646y;
        if (bool != null && bool.booleanValue() == z10) {
            return;
        }
        org.telegram.ui.Components.bj0 bj0Var = this.f32637a;
        if (!z10) {
        ...
        this.f32640f.setVisibility(i12);
        if (!z10) {
            i14 = 4;
        }
        this.d.setVisibility(i14);
        this.f32646y = Boolean.valueOf(z10);
    }
}
