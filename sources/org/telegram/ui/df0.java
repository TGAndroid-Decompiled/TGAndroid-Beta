...
public final class df0 implements org.telegram.ui.ActionBar.a2 {
    ...
    public final void k(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        switch (this.f33048a) {
            case 0:
                jf0 jf0Var = this.f33049b;
                jf0Var.c(true);
                jf0Var.O.u1(0, true, null, true);
                jf0Var.o();
                return;
            case 1:
                jf0 jf0Var2 = this.f33049b;
                jf0Var2.O.f39948p0.popup = false;
                jf0Var2.h(null);
                return;
            case 2:
                jf0 jf0Var3 = this.f33049b;
                ...
                alertDialog$Builder.f18669a.T = LocaleController.getString("TosDecline", R.string.TosDecline);
                ...
                return;
            case 3:
                jf0 jf0Var4 = this.f33049b;
                jf0Var4.O.f39948p0.popup = false;
                jf0Var4.h(null);
                return;
            default:
                jf0 jf0Var5 = this.f33049b;
                jf0Var5.c(true);
