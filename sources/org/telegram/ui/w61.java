...
public abstract class w61 extends Dialog {
    ...
    public boolean O;
    public final a71 P;
    public final j61 f38888a;
    public final ImageReceiver f38889b;
    public final Rect f38890c;
    public final Rect d;
    public final Rect e;
    public final Runnable f38891f;
    public final View h;
    public Bitmap f38892n;
    public Paint f38893r;
    public final k0 f38894s;
    public final ActionBarPopupWindow$ActionBarPopupWindowLayout v;
    public org.telegram.ui.ActionBar.e3 f38895w;
    public boolean f38896x;
    public final int f38897y;
    ...
    public w61(a71 a71Var, Context context, Runnable runnable, View view, j61 j61Var, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        org.telegram.ui.ActionBar.u0.c(true, false, actionBarPopupWindow$ActionBarPopupWindowLayout, 0, LocaleController.getString(R.string.SetEmojiStatusUntil1Hour), false, d6Var).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        org.telegram.ui.ActionBar.u0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout, 0, LocaleController.getString(R.string.SetEmojiStatusUntil2Hours), false, d6Var).setOnClickListener(new View.OnClickListener() {
            @Override
            public final void onClick(View view2) {
                switch (r2) {
                    case 0:
        ...
        org.telegram.ui.ActionBar.u0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout, 0, LocaleController.getString(R.string.SetEmojiStatusUntil8Hours), false, d6Var).setOnClickListener(new View.OnClickListener() {
            @Override
            public final void onClick(View view2) {
                switch (r2) {
                    case 0:
        ...
        org.telegram.ui.ActionBar.u0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout, 0, LocaleController.getString(R.string.SetEmojiStatusUntil2Days), false, d6Var).setOnClickListener(new View.OnClickListener() {
            @Override
            public final void onClick(View view2) {
                switch (r2) {
                    case 0:
        ...
        if (window != null) {
            ...
            z10 = true;
            k0Var.setOnApplyWindowInsetsListener(new o41(p51Var, 1));
    ...
    public final void c(boolean z10) {
        ...
        if (z10) {
            ...
            this.N.setInterpolator(org.telegram.ui.Components.rr.f28023g);
        }
        this.N.start();
    }
    ...
    public final void d(final boolean z10, s61 s61Var, final s61 s61Var2, final boolean z11) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ...
                w61 w61Var = w61.this;
                w61Var.I = floatValue;
                AndroidUtilities.lerp(w61Var.f38890c, w61Var.d, floatValue, w61Var.e);
                w61Var.f38894s.invalidate();
                boolean z12 = z10;
                if (!z12) {
    ...
    public final void f() {
        ...
        this.f38893r = new Paint(1);
        this.f38892n = createBitmap;
    }
