...
public final class or extends org.telegram.ui.Components.vl0 {
    ...
    @Override
    public final int h() {
        return this.d.f37402d1;
    }

    @Override
    public final int j(int i10) {
        sr srVar = this.d;
        if (i10 != srVar.f37450z0 && i10 != srVar.A0 && i10 != srVar.f37439v0 && i10 != srVar.f37435t0) {
            ...
            if (i10 != srVar.C0 && i10 != srVar.G0 && i10 != srVar.H0) {
                if (i10 != srVar.D0 && i10 != srVar.S && i10 != srVar.N0 && i10 != srVar.f37433s0 && i10 != srVar.f37425p0) {
                    if (i10 != srVar.f37397b1 && i10 != srVar.P0 && i10 != srVar.R0 && i10 != srVar.f37437u0 && i10 != srVar.f37448y0 && i10 != srVar.K0 && i10 != srVar.M0 && i10 != srVar.f37415j1 && i10 != srVar.f37423o0 && i10 != srVar.f37430r0) {
                        if (i10 == srVar.f37400c1) {
                            return 4;
                        }
                        if (i10 == srVar.B0) {
                            return 6;
                        }
                        if (i10 != srVar.f37408g0 && i10 != srVar.f37410h0 && i10 != srVar.m0 && i10 != srVar.f37412i0 && i10 != srVar.f37414j0 && i10 != srVar.T && i10 != srVar.f37403e0 && i10 != srVar.f37406f0 && i10 != srVar.f37418l0 && i10 != srVar.Q0) {
                            if (i10 != srVar.Z0 && i10 != srVar.T0 && i10 != srVar.W0 && i10 != srVar.f37409g1) {
                                if (i10 == srVar.O0) {
                                    return 9;
                                }
                                if (i10 == srVar.f37394a1) {
                                    return 10;
                                }
                                if (i10 == srVar.f37407f1) {
                                    return 11;
                                }
                                if (i10 != srVar.f37445x0 && i10 != srVar.J0 && i10 != srVar.L0) {
                                    if (srVar.p0(i10)) {
                                        return 13;
                                    }
                                    if (i10 == srVar.U) {
                                    ...
                                    if (i10 != srVar.f37411h1 && i10 != srVar.f37413i1 && i10 != srVar.f37421n0) {
                                        if (i10 != srVar.f37427q0) {
                                            return 0;
                                        }
                                        return 17;
                                    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 0:
                ...
                org.telegram.ui.Cells.b5 b5Var = new org.telegram.ui.Cells.b5(i11, i12, this.f36231c, null, z10);
            ...
            case 5:
                org.telegram.ui.Cells.m4 m4Var = new org.telegram.ui.Cells.m4(this.f36231c, org.telegram.ui.ActionBar.j6.L6, 21, 11, false, null);
                m4Var.setHeight(43);
                fw0Var2 = m4Var;
                fw0Var = fw0Var2;
                break;
            ...
            case 11:
                ...
                break;
            case 12:
                org.telegram.ui.Cells.r8 r8Var = new org.telegram.ui.Cells.r8(23, this.f36231c, srVar.getResourceProvider(), false, true);
                r8Var.v = 50;
                fw0Var = r8Var;
                break;
            case 13:
                org.telegram.ui.Cells.a2 a2Var = new org.telegram.ui.Cells.a2(4, 21, this.f36231c, srVar.getResourceProvider(), false);
                a2Var.getCheckBoxRound().setDrawBackgroundAsArc(14);
                a2Var.getCheckBoxRound().b(org.telegram.ui.ActionBar.j6.V6, org.telegram.ui.ActionBar.j6.f19117g7, org.telegram.ui.ActionBar.j6.f19191k7);
            ...
            case 15:
                ...
                int i15 = srVar.f37434s1;
                if (i15 > 0) {
                    i13 = i15 - 1;
                }
                fw0Var4.b(i13, drawableArr, "1", "2", "3", "4", "5");
                fw0Var4.setCallback(new nr(this, 2));
                fw0Var2 = fw0Var4;
                fw0Var = fw0Var2;
                break;
            case 16:
                fw0Var = new org.telegram.ui.Cells.w8(context, srVar.getResourceProvider());
                break;
            case 17:
                fw0Var = new org.telegram.ui.Cells.z7(context, srVar.getResourceProvider());
                break;
        }
