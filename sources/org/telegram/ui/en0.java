...
public final class en0 extends org.telegram.ui.Components.uv0 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final LinearLayout f32982c;
    public EditTextBoldCursor[] d;
    public final TextView e;
    public final TextView f32983f;
    public final ImageView h;
    public final bn0 f32984n;
    public final bn0 f32985r;
    public final fn0 f32986s;
    public Timer v;
    public Timer f32987w;
    public final Object f32988x;
    public int f32989y;
    ...
    public en0(in0 in0Var, Context context, int i10) {
        ...
        textView.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i18, false));
        textView.setTextSize(1, 14.0f);
        textView.setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
        TextView textView2 = new TextView(context);
        this.f32983f = textView2;
        int i19 = org.telegram.ui.ActionBar.h6.G6;
        org.telegram.messenger.z0.q(textView2, org.telegram.ui.ActionBar.h6.w0(null, i19, false), 1, 18.0f);
        ...
        this.f32984n = bn0Var;
        bn0Var.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i18, false));
        ...
        if (i10 == 3) {
            ...
            addView(bn0Var, w7.x5.q(-2, -2, i12));
            ?? view = new View(context);
            Paint paint = new Paint();
            view.f33346a = paint;
            Paint paint2 = new Paint();
            view.f33347b = paint2;
            paint.setColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18853gi, false));
            paint2.setColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18870hi, false));
            this.f32986s = view;
            if (LocaleController.isRTL) {
                i13 = 5;
            } else {
    ...
    public final boolean c(boolean z10) {
        ...
        if (!z10) {
            ...
            alertDialog$Builder.f18409a.T = LocaleController.getString(R.string.StopVerification);
            ...
            in0Var.showDialog(alertDialog$Builder.f18409a);
            return false;
        }
        TLRPC.TL_auth_cancelCode tL_auth_cancelCode = new TLRPC.TL_auth_cancelCode();
        tL_auth_cancelCode.phone_number = this.f32980a;
        tL_auth_cancelCode.phone_code_hash = this.f32981b;
    ...
    public final void h(String str) {
        ...
        if (TextUtils.isEmpty(code)) {
            AndroidUtilities.shakeView(this.f32982c);
            return;
        }
        this.J = true;
        int i11 = this.L;
        ...
        verifyphone.phone_number = this.f32980a;
        verifyphone.phone_code = code;
        verifyphone.phone_code_hash = this.f32981b;
        s();
        in0Var.y1();
        i10 = ((org.telegram.ui.ActionBar.n2) in0Var).currentAccount;
    ...
    @Override
    public final void j() {
        LinearLayout linearLayout = this.f32982c;
    ...
    public final void m(Bundle bundle, boolean z10) {
        ...
        if (bundle != null) {
            ...
            this.f32980a = bundle.getString("phone");
            this.f32981b = bundle.getString("phoneHash");
            ...
            if (editTextBoldCursorArr != null && editTextBoldCursorArr.length == this.O) {
                ...
                for (final int i21 = 0; i21 < this.O; i21++) {
                    ...
                    editTextBoldCursor.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i22, false));
                    this.d[i21].setCursorColor(org.telegram.ui.ActionBar.h6.w0(null, i22, false));
                    ...
                    mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18934l6, false), PorterDuff.Mode.MULTIPLY));
                    ...
                    this.f32982c.addView(editTextBoldCursor2, w7.x5.t(34, 36, 1, 0, 0, i10, 0));
                    this.d[i21].addTextChangedListener(new cn0(this, i21));
                        ...
                        public final boolean onKey(View view, int i23, KeyEvent keyEvent) {
                            ...
                            if (i23 == 67) {
                                ...
                                if (editTextBoldCursorArr3[i24].length() == 0 && i24 > 0) {
                                    int i25 = i24 - 1;
                                    EditTextBoldCursor editTextBoldCursor3 = en0Var.d[i25];
                                    editTextBoldCursor3.setSelection(editTextBoldCursor3.length());
                                    en0Var.d[i25].requestFocus();
                                    en0Var.d[i25].dispatchKeyEvent(keyEvent);
                                    return true;
                                }
                                return false;
                            }
            ...
            if (fn0Var != null) {
                ...
                fn0Var.setVisibility(i15);
            }
            if (this.f32980a == null) {
                return;
            }
            String h = org.telegram.messenger.ul.h(new StringBuilder("+"), this.f32980a, gf.b.c());
            if (i17 == 2) {
            ...
            bn0 bn0Var = this.f32985r;
            bn0 bn0Var2 = this.f32984n;
            if (i17 == 3) {
                int i23 = this.M;
                i11 = 2;
                if (i23 == 4 || i23 == 2) {
            ...
            if (i17 == i11 && ((i13 = this.M) == 4 || i13 == 3)) {
                ...
                objArr[0] = 2;
                objArr[1] = 0;
                bn0Var2.setText(LocaleController.formatString("CallText", i25, objArr));
                if (this.f32989y < 1000) {
                    i14 = 0;
                } else {
                    i14 = 8;
                }
                bn0Var.setVisibility(i14);
                if (this.f32989y < 1000) {
                    i16 = 8;
                }
                bn0Var2.setVisibility(i16);
                q();
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.L != 3 && (imageView = this.h) != null) {
            int dp = AndroidUtilities.dp(35.0f) + this.e.getMeasuredHeight() + this.f32983f.getMeasuredHeight() + imageView.getMeasuredHeight();
            int dp2 = AndroidUtilities.dp(80.0f);
            int dp3 = AndroidUtilities.dp(291.0f);
            in0 in0Var = this.Q;
            if (in0Var.f34203s0 - dp < dp2) {
                setMeasuredDimension(getMeasuredWidth(), dp + dp2);
            } else {
                setMeasuredDimension(getMeasuredWidth(), Math.min(in0Var.f34203s0, dp3));
            }
        }
    }

    public final void p() {
        if (this.f32987w != null) {
            return;
        }
        this.E = 15000;
        this.f32987w = new Timer();
        this.G = System.currentTimeMillis();
        this.f32987w.schedule(new ci.o2(this, 4), 0L, 1000L);
    }
    ...
    public final void r() {
        try {
            synchronized (this.f32988x) {
                Timer timer = this.f32987w;
                if (timer != null) {
                    timer.cancel();
                    this.f32987w = null;
                }
    ...
    public final void u() {
        ...
        bundle.putString("phone", this.f32980a);
        this.J = true;
        in0 in0Var = this.Q;
        in0Var.y1();
        TLRPC.TL_auth_resendCode tL_auth_resendCode = new TLRPC.TL_auth_resendCode();
        tL_auth_resendCode.phone_number = this.f32980a;
        tL_auth_resendCode.phone_code_hash = this.f32981b;
        i10 = ((org.telegram.ui.ActionBar.n2) in0Var).currentAccount;
