...
public final class en0 extends FrameLayout implements DownloadController.FileDownloadProgressListener {
    ...
    public final org.telegram.ui.Components.w9 f33445c;
    public final org.telegram.ui.Components.nj0 d;
    public int e;
    public SecureDocument f33446f;
    public final int h;
    public final gn0 f33447n;
    ...
    public en0(gn0 gn0Var, Activity activity) {
        ...
        this.d = new org.telegram.ui.Components.nj0(this);
    ...
    public final void a(boolean z10) {
        ...
        int i12;
        int i13;
        String attachFileName = FileLoader.getAttachFileName(this.f33446f);
        boolean exists = FileLoader.getInstance(UserConfig.selectedAccount).getPathToAttach(this.f33446f).exists();
        boolean isEmpty = TextUtils.isEmpty(attachFileName);
        org.telegram.ui.Components.nj0 nj0Var = this.d;
        if (isEmpty) {
            nj0Var.d(null, false, false);
            return;
        }
        SecureDocument secureDocument = this.f33446f;
        String str = secureDocument.path;
        float f7 = 0.0f;
        gn0 gn0Var = this.f33447n;
        if (str != null) {
            if (secureDocument.inputFile != null) {
                ...
                nj0Var.d(null, false, z10);
                this.e = -1;
                return;
            }
            i12 = ((org.telegram.ui.ActionBar.m2) gn0Var).currentAccount;
            DownloadController.getInstance(i12).addLoadingFileObserver(this.f33446f.path, this);
            this.e = 1;
            Float fileProgress = ImageLoader.getInstance().getFileProgress(this.f33446f.path);
            nj0Var.d(getResources().getDrawable(R.drawable.circle), true, z10);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        org.telegram.ui.Components.w9 w9Var = this.f33445c;
    ...
    public void setValue(CharSequence charSequence) {
        this.f33444b.setText(charSequence);
    }
}
