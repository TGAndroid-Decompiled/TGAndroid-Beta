...
public final class is extends org.telegram.ui.ActionBar.j {
    ...
    public final void b(int i10) {
        ...
        int i11;
        int i12;
        ms msVar = this.f34560a;
        if (i10 == -1) {
            msVar.finishFragment();
        } else if (i10 == 1 && msVar.f35640b.getText().length() != 0) {
            ...
            user.first_name = msVar.f35640b.getText().toString();
            user.last_name = msVar.f35641c.getText().toString();
            user.contact = true;
            ...
            if (userFull != null) {
                ...
                msVar.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.userInfoDidLoad, Long.valueOf(userFull.f18469id), userFull);
            }
            msVar.finishFragment();
            ls lsVar = msVar.O;
            if (lsVar != null) {
