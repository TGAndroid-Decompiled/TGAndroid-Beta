...
public abstract class is extends EditTextBoldCursor {
    ...
    public o1.k f34674n;
    public o1.k f34675r;
    public boolean f34676s;
    public float v;
    public float f34677w;
    public boolean f34678x;
    public Bitmap f34679y;
    ...
    public final void j(float f7) {
        k(this.f34673f, f7 * 100.0f);
    }

    public final void l(float f7) {
        k(this.f34674n, f7 * 100.0f);
        o1.k kVar = this.f34675r;
        kVar.c();
        if (f7 != 0.0f) {
    ...
    public final void m() {
        if (getMeasuredHeight() != 0 && getMeasuredWidth() != 0 && getLayout() != null) {
            Bitmap bitmap = this.f34679y;
            if (bitmap == null || bitmap.getHeight() != getMeasuredHeight() || this.f34679y.getWidth() != getMeasuredWidth()) {
                Bitmap bitmap2 = this.f34679y;
                if (bitmap2 != null) {
                    bitmap2.recycle();
                }
                this.f34679y = Bitmap.createBitmap(getMeasuredWidth(), getMeasuredHeight(), Bitmap.Config.ARGB_8888);
                this.E = new Canvas(this.f34679y);
            }
            this.f34679y.eraseColor(0);
