...
public final class b30 extends s4.s0 {
    ...
    public final void a(RecyclerView recyclerView, int i10) {
        int i11;
        d60 d60Var = this.f32309a;
        j50 j50Var = d60Var.Q;
        if (i10 == 0) {
            int dp = AndroidUtilities.dp(74.0f);
            i11 = ((org.telegram.ui.ActionBar.e3) d60Var).backgroundPaddingTop;
            if ((d60Var.f33036y0 - dp) + i11 < org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() && j50Var.canScrollVertically(1)) {
                j50Var.getChildAt(0);
        ...
        org.telegram.ui.Components.j40 j40Var2 = d60Var.f32987n0;
        if (j40Var2 != null) {
            j40Var2.b(true);
        }
    }
    ...
    public final void b(RecyclerView recyclerView, int i10, int i11) {
        ...
        ViewGroup viewGroup;
        d60 d60Var = this.f32309a;
        if (d60Var.Q.getChildCount() > 0 && (call = d60Var.f32936a1) != null) {
            if (!call.loadingMembers && !call.membersLoadEndReached && d60Var.Y.N0() > d60Var.P.F - 5) {
                d60Var.f32936a1.loadMembers(false);
            }
            d60.J0(d60Var);
