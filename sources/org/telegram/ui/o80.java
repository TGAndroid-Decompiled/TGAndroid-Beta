...
public final class o80 implements ky, org.telegram.ui.ActionBar.c2 {
    public final int f36683a;
    public final KeyEvent.Callback f36684b;
    public final Object f36685c;
    public final Object d;
    public final Object e;
    public final Object f36686f;

    public o80(LaunchActivity launchActivity, int i10, TLRPC.User user, String str, String str2, qy qyVar) {
        this.f36684b = launchActivity;
        this.f36683a = i10;
        this.f36685c = user;
        this.d = str;
        this.e = str2;
    ...
    public void l(org.telegram.ui.ActionBar.d2 d2Var, int i10) {
        int i11;
        uf.g1 g1Var = (uf.g1) this.f36684b;
        gg.c1 c1Var = (gg.c1) this.f36685c;
        uf.o1 o1Var = (uf.o1) this.d;
        TextView textView = (TextView) this.e;
        Utilities.Callback callback = (Utilities.Callback) this.f36686f;
        String obj = g1Var.getText().toString();
        if (obj.length() > 0 && obj.length() <= 32) {
            uf.p1 f10 = uf.p1.f(this.f36683a);
            if (o1Var == null) {
                i11 = -1;
            } else {
                i11 = o1Var.f45471a;
    ...
    public boolean w(qy qyVar, ArrayList arrayList, CharSequence charSequence, boolean z4, boolean z10, int i10, int i11, sf1 sf1Var) {
        ...
        final LaunchActivity launchActivity = (LaunchActivity) this.f36684b;
        final TLRPC.User user = (TLRPC.User) this.f36685c;
        final String str2 = (String) this.d;
        final String str3 = (String) this.e;
        final qy qyVar2 = (qy) this.f36686f;
        ...
        if (chat != null && (chat.creator || ((tL_chatAdminRights = chat.admin_rights) != null && tL_chatAdminRights.add_admins))) {
            MessagesController.getInstance(i12).checkIsInChat(false, chat, user, new MessagesController.IsInChatCheckedCallback() {
                ...
                public final void run(boolean z11, TLRPC.TL_chatAdminRights tL_chatAdminRights2, String str4) {
                    ...
                    AndroidUtilities.runOnUIThread(new org.telegram.messenger.p8(LaunchActivity.this, str2, tL_chatAdminRights2, z11, str3, i12, chat, qyVar2, user, j10, str4));
                }
            });
        } else {
            ...
            alertDialog$Builder.k(LocaleController.getString(R.string.AddBot), new org.telegram.ui.ActionBar.c2() {
                ...
                public final void l(org.telegram.ui.ActionBar.d2 d2Var2, int i13) {
                    ...
                    MessagesController.getInstance(i15).addUserToChat(j11, user, 0, str3, znVar, null);
    ...
    public o80(uf.g1 g1Var, gg.c1 c1Var, int i10, uf.o1 o1Var, TextView textView, Utilities.Callback callback) {
        this.f36684b = g1Var;
        this.f36685c = c1Var;
        this.f36683a = i10;
        this.d = o1Var;
        this.e = textView;
        this.f36686f = callback;
    }
}
