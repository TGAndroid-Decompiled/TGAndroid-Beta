...
public final class qe1 extends org.telegram.ui.Components.kl0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        if (c1Var.b() >= this.f39855f && c1Var.b() < this.h) {
            return true;
        }
        return false;
    }
    ...
    public final void E() {
        ...
        this.f39853c = 2;
        this.d = 1;
        ArrayList arrayList = this.f39857r.f40732f;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        int i11 = this.f39854e;
        te1 te1Var = this.f39857r;
        if (i10 >= i11 && i11 > 0) {
        ...
        if (j(i10) == 4) {
            ...
            TLRPC.Chat chat = (TLRPC.Chat) te1Var.f40732f.get(i10 - this.f39855f);
            String str = (String) te1Var.h.get(i10 - this.f39855f);
            ...
            f4Var.c(te1Var.f40736w.contains(Long.valueOf(chat.f19869id)), false);
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                ...
                org.telegram.ui.Components.oq oqVar = new org.telegram.ui.Components.oq(new ColorDrawable(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20607a7, false)), org.telegram.ui.ActionBar.j6.V0(viewGroup.getContext(), R.drawable.greydivider, org.telegram.ui.ActionBar.j6.f20627b7));
                oqVar.f29167w = true;
            ...
            te1Var.f40737x.setMessageText(string);
            ...
            te1Var.f40737x.setLayoutParams(p0Var);
            l4Var = frameLayout;
        }
