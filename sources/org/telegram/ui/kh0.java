...
public final class kh0 implements RequestDelegate {
    ...
    public final ai0 f35286b;
    public final TLRPC.TL_chatInviteExported f35287c;

    public kh0(ai0 ai0Var, TLRPC.TL_chatInviteExported tL_chatInviteExported, int i10) {
        this.f35285a = i10;
        this.f35286b = ai0Var;
        this.f35287c = tL_chatInviteExported;
    }
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f35285a) {
            case 0:
                final ai0 ai0Var = this.f35286b;
                final TLRPC.TL_chatInviteExported tL_chatInviteExported = this.f35287c;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    public final void run() {
                        switch (r5) {
                            case 0:
                                if (tL_error == null) {
                                    ...
                                    if (ai0Var2.getParentActivity() != null) {
                                        ...
                                        rh0 f02 = ai0Var2.f0();
                                        ai0Var2.f31886j0.add(0, tL_chatInviteExported3);
                                        ai0Var2.h0(f02);
                            ...
                            default:
                                ai0 ai0Var3 = ai0Var;
                                ArrayList arrayList = ai0Var3.f31885i0;
                                if (tL_error == null) {
                                    ...
                                    if (z10) {
                                        ...
                                        rh0 f03 = ai0Var3.f0();
                                        if (ai0Var3.f31891o0 && ai0Var3.f31881f == ai0Var3.getAccountInstance().getUserConfig().getClientUserId()) {
                                        ...
                                        ai0Var3.f31886j0.add(0, tL_chatInviteExported4);
                                        ai0Var3.h0(f03);
                                    } else {
                                        ai0Var3.f31897s0.b(tL_chatInviteExported4, tLObject2);
                                        ...
                                        if (chatFull2 != null) {
                                            ...
                                            ai0Var3.getMessagesStorage().saveChatLinksCount(ai0Var3.f31889n, ai0Var3.d.invitesCount);
                                        }
                                    }
                ...
                return;
            case 1:
                ai0 ai0Var2 = this.f35286b;
                ai0Var2.getClass();
                AndroidUtilities.runOnUIThread(new rf0(ai0Var2, tL_error, this.f35287c, 5));
                return;
            default:
                final ai0 ai0Var3 = this.f35286b;
                final TLRPC.TL_chatInviteExported tL_chatInviteExported2 = this.f35287c;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        switch (r5) {
                            case 0:
                                if (tL_error == null) {
                                    ...
                                    if (ai0Var22.getParentActivity() != null) {
                                        ...
                                        tL_chatInviteExported3.revoked = true;
                                        rh0 f02 = ai0Var22.f0();
                                        ai0Var22.f31886j0.add(0, tL_chatInviteExported3);
                                        ai0Var22.h0(f02);
                            ...
                            default:
                                ...
                                ArrayList arrayList = ai0Var32.f31885i0;
                                if (tL_error == null) {
                                    TLObject tLObject2 = tLObject;
                                    boolean z10 = tLObject2 instanceof TLRPC.TL_messages_exportedChatInviteReplaced;
                                    ...
                                    if (z10) {
                                        TLRPC.TL_messages_exportedChatInviteReplaced tL_messages_exportedChatInviteReplaced = (TLRPC.TL_messages_exportedChatInviteReplaced) tLObject2;
                                        if (!ai0Var32.f31891o0) {
                                            ai0Var32.e = (TLRPC.TL_chatInviteExported) tL_messages_exportedChatInviteReplaced.new_invite;
                                        }
                                        tL_chatInviteExported4.revoked = true;
                                        rh0 f03 = ai0Var32.f0();
                                        if (ai0Var32.f31891o0 && ai0Var32.f31881f == ai0Var32.getAccountInstance().getUserConfig().getClientUserId()) {
                                            arrayList.remove(tL_chatInviteExported4);
                                            arrayList.add(0, (TLRPC.TL_chatInviteExported) tL_messages_exportedChatInviteReplaced.new_invite);
                                        } else if (ai0Var32.e != null) {
                                            ai0Var32.e = (TLRPC.TL_chatInviteExported) tL_messages_exportedChatInviteReplaced.new_invite;
                                        }
                                        ai0Var32.f31886j0.add(0, tL_chatInviteExported4);
                                        ai0Var32.h0(f03);
                                    } else {
                                        ai0Var32.f31897s0.b(tL_chatInviteExported4, tLObject2);
                                        ...
                                        if (chatFull2 != null) {
                                            ...
                                            ai0Var32.getMessagesStorage().saveChatLinksCount(ai0Var32.f31889n, ai0Var32.d.invitesCount);
                                        }
                                    }
