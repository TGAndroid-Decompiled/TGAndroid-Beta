...
public class CameraScanActivity extends BaseFragment {
    ...
    public class AnonymousClass1 extends BottomSheet {
        ...
        AnonymousClass1(Context context, boolean z, INavigationLayout[] iNavigationLayoutArr, int i, boolean z2, CameraScanActivityDelegate cameraScanActivityDelegate) {
            ...
            C00091 c00091 = new CameraScanActivity(i) {
                C00091(int i2) {
                    super(i2);
                }
            ...
            this.fragment = c00091;
            c00091.shownAsBottomSheet = true;
            ((CameraScanActivity) c00091).needGalleryButton = z2;
        ...
        public class C00091 extends CameraScanActivity {
            C00091(int i2) {
                super(i2);
            }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() {
            ...
            public void onItemClick(int i) {
                if (i == -1) {
                    CameraScanActivity.this.lambda$onBackPressed$308();
                }
            }
        });
                        ...
                        if (clickableSpanArr.length != 0) {
                            ...
                            if (motionEvent.getAction() == 0) {
                                ...
                                if (linkSpanDrawable2 != null) {
                                    URLSpanNoUnderline span = linkSpanDrawable2.getSpan();
                ...
                if (detect == null || detect.size() <= 0) {
                    if (bitmap != null) {
                        ...
                        if (detect2 != null && detect2.size() > 0) {
                            ...
                            pointFArr = toPointF(valueAt.cornerPoints, width, height);
                    ...
                    pointFArr = toPointF(valueAt3.cornerPoints, i4, i5);
