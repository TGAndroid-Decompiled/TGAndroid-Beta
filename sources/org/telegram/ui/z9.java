...
public final class z9 extends org.telegram.ui.ActionBar.n2 {
    public y9 f43341a;
    public y9 f43342b;
    public org.telegram.ui.ActionBar.v0 f43343c;
    ...
    public static void U(z9 z9Var) {
        ...
        if (currentUser != null && z9Var.f43342b.getText() != null && z9Var.f43341a.getText() != null) {
            String obj = z9Var.f43341a.getText().toString();
            String obj2 = z9Var.f43342b.getText().toString();
    ...
    public final View createView(Context context) {
        ...
        int i12 = org.telegram.ui.ActionBar.j6.f20702f8;
        ...
        this.f43343c = this.actionBar.n().h(1, R.drawable.ic_ab_done, LocaleController.getString(R.string.Done), AndroidUtilities.dp(56.0f));
        ...
        this.f43341a.setMaxLines(1);
        this.f43341a.setLines(1);
        this.f43341a.setSingleLine(true);
        y9 y9Var5 = this.f43341a;
        ...
        this.f43341a.setInputType(49152);
        this.f43341a.setImeOptions(5);
        this.f43341a.setHint(LocaleController.getString(R.string.FirstName));
        this.f43341a.setCursorColor(org.telegram.ui.ActionBar.j6.v0(i14, f6Var));
        this.f43341a.setCursorSize(AndroidUtilities.dp(20.0f));
        this.f43341a.setCursorWidth(1.5f);
        linearLayout.addView(this.f43341a, w7.x5.k(24.0f, 24.0f, 24.0f, 0.0f, -1, 36));
        this.f43341a.setOnEditorActionListener(new TextView.OnEditorActionListener(this) {
            public final z9 f42621b;
            ...
            public final boolean onEditorAction(TextView textView, int i18, KeyEvent keyEvent) {
                switch (r2) {
                    case 0:
                        if (i18 == 5) {
                            z9 z9Var = this.f42621b;
                            z9Var.f43342b.requestFocus();
                            y9 y9Var6 = z9Var.f43342b;
                    ...
                    default:
                        if (i18 == 6) {
                            this.f42621b.f43343c.performClick();
                            return true;
                        }
                        return false;
                }
        ...
        this.f43342b.setHintTextColor(org.telegram.ui.ActionBar.j6.v0(i13, f6Var));
        this.f43342b.setTextColor(org.telegram.ui.ActionBar.j6.v0(i14, f6Var));
        this.f43342b.setBackgroundDrawable(null);
        this.f43342b.setLineColors(getThemedColor(i15), getThemedColor(i16), getThemedColor(i17));
        this.f43342b.setMaxLines(1);
        this.f43342b.setLines(1);
        this.f43342b.setSingleLine(true);
        y9 y9Var7 = this.f43342b;
        if (LocaleController.isRTL) {
            i11 = 5;
        } else {
            i11 = 3;
        ...
        this.f43342b.setInputType(49152);
        this.f43342b.setImeOptions(6);
        this.f43342b.setHint(LocaleController.getString(R.string.LastName));
        this.f43342b.setCursorColor(org.telegram.ui.ActionBar.j6.v0(i14, f6Var));
        this.f43342b.setCursorSize(AndroidUtilities.dp(20.0f));
        this.f43342b.setCursorWidth(1.5f);
        linearLayout.addView(this.f43342b, w7.x5.k(24.0f, 16.0f, 24.0f, 0.0f, -1, 36));
        this.f43342b.setOnEditorActionListener(new TextView.OnEditorActionListener(this) {
            public final z9 f42621b;
        ...
        if (user != null) {
            this.f43341a.setText(user.first_name);
            y9 y9Var8 = this.f43341a;
            y9Var8.setSelection(y9Var8.length());
            this.f43342b.setText(user.last_name);
        }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f43342b, 4, null, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f43342b, 8388608, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f43342b, 32, null, null, null, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f43342b, 65568, null, null, null, null, i13));
        return arrayList;
    }
    ...
    public final void onResume() {
        ...
        if (!MessagesController.getGlobalMainSettings().getBoolean("view_animations", true)) {
            this.f43341a.requestFocus();
            AndroidUtilities.showKeyboard(this.f43341a);
        }
    }
