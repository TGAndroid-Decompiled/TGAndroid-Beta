...
public final class z9 extends org.telegram.ui.ActionBar.n2 {
    public y9 f43368a;
    public y9 f43369b;
    public org.telegram.ui.ActionBar.v0 f43370c;
    ...
    public static void U(z9 z9Var) {
        ...
        if (currentUser != null && z9Var.f43369b.getText() != null && z9Var.f43368a.getText() != null) {
            String obj = z9Var.f43368a.getText().toString();
            String obj2 = z9Var.f43369b.getText().toString();
    ...
    public final View createView(Context context) {
        ...
        int i12 = org.telegram.ui.ActionBar.j6.f20729f8;
        ...
        this.f43370c = this.actionBar.n().h(1, R.drawable.ic_ab_done, LocaleController.getString(R.string.Done), AndroidUtilities.dp(56.0f));
        ...
        this.f43368a.setMaxLines(1);
        this.f43368a.setLines(1);
        this.f43368a.setSingleLine(true);
        y9 y9Var5 = this.f43368a;
        ...
        this.f43368a.setInputType(49152);
        this.f43368a.setImeOptions(5);
        this.f43368a.setHint(LocaleController.getString(R.string.FirstName));
        this.f43368a.setCursorColor(org.telegram.ui.ActionBar.j6.v0(i14, f6Var));
        this.f43368a.setCursorSize(AndroidUtilities.dp(20.0f));
        this.f43368a.setCursorWidth(1.5f);
        linearLayout.addView(this.f43368a, w7.x5.k(24.0f, 24.0f, 24.0f, 0.0f, -1, 36));
        this.f43368a.setOnEditorActionListener(new TextView.OnEditorActionListener(this) {
            public final z9 f42648b;
            ...
            public final boolean onEditorAction(TextView textView, int i18, KeyEvent keyEvent) {
                switch (r2) {
                    case 0:
                        if (i18 == 5) {
                            z9 z9Var = this.f42648b;
                            z9Var.f43369b.requestFocus();
                            y9 y9Var6 = z9Var.f43369b;
                    ...
                    default:
                        if (i18 == 6) {
                            this.f42648b.f43370c.performClick();
                            return true;
                        }
                        return false;
                }
        ...
        this.f43369b.setHintTextColor(org.telegram.ui.ActionBar.j6.v0(i13, f6Var));
        this.f43369b.setTextColor(org.telegram.ui.ActionBar.j6.v0(i14, f6Var));
        this.f43369b.setBackgroundDrawable(null);
        this.f43369b.setLineColors(getThemedColor(i15), getThemedColor(i16), getThemedColor(i17));
        this.f43369b.setMaxLines(1);
        this.f43369b.setLines(1);
        this.f43369b.setSingleLine(true);
        y9 y9Var7 = this.f43369b;
        if (LocaleController.isRTL) {
            i11 = 5;
        } else {
            i11 = 3;
        ...
        this.f43369b.setInputType(49152);
        this.f43369b.setImeOptions(6);
        this.f43369b.setHint(LocaleController.getString(R.string.LastName));
        this.f43369b.setCursorColor(org.telegram.ui.ActionBar.j6.v0(i14, f6Var));
        this.f43369b.setCursorSize(AndroidUtilities.dp(20.0f));
        this.f43369b.setCursorWidth(1.5f);
        linearLayout.addView(this.f43369b, w7.x5.k(24.0f, 16.0f, 24.0f, 0.0f, -1, 36));
        this.f43369b.setOnEditorActionListener(new TextView.OnEditorActionListener(this) {
            public final z9 f42648b;
        ...
        if (user != null) {
            this.f43368a.setText(user.first_name);
            y9 y9Var8 = this.f43368a;
            y9Var8.setSelection(y9Var8.length());
            this.f43369b.setText(user.last_name);
        }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f43369b, 4, null, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f43369b, 8388608, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f43369b, 32, null, null, null, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.l6(this.f43369b, 65568, null, null, null, null, i13));
        return arrayList;
    }
    ...
    public final void onResume() {
        ...
        if (!MessagesController.getGlobalMainSettings().getBoolean("view_animations", true)) {
            this.f43368a.requestFocus();
            AndroidUtilities.showKeyboard(this.f43368a);
        }
    }
