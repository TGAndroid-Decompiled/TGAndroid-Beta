        ...
        switch (this.f33289a) {
            ...
            case 1:
                ...
                for (int i10 = 0; i10 < longSparseArray.size(); i10++) {
                    ...
                    arrayList.add(t6Var);
                    if (a7Var2.getMessagesController().getUserOrChat(((t6) arrayList.get(i10)).f37667a) == null) {
                ...
                Collections.sort(bVar.f49225f, new lb1(26));
                Collections.sort(bVar.f49226g, new lb1(26));
                ...
                return;
            default:
                a7 a7Var3 = this.f33290b;
                a7Var3.f31740f = a7.q0(5, FileLoader.checkDirectory(4));
                if (!a7.f31728l0) {
                    a7Var3.f31747n = a7.q0(4, FileLoader.checkDirectory(4));
                    if (!a7.f31728l0) {
                        long q02 = a7.q0(0, FileLoader.checkDirectory(0));
                        a7Var3.f31751x = q02;
                        a7Var3.f31751x = a7.q0(0, FileLoader.checkDirectory(100)) + q02;
                        if (!a7.f31728l0) {
                            long q03 = a7.q0(0, FileLoader.checkDirectory(2));
                            a7Var3.f31752y = q03;
                            a7Var3.f31752y = a7.q0(0, FileLoader.checkDirectory(101)) + q03;
                            if (!a7.f31728l0) {
                                ...
                                if (!a7.f31728l0) {
                                    ...
                                    a7Var3.f31748r = q05;
                                    a7Var3.f31748r = a7.q0(1, FileLoader.checkDirectory(5)) + q05;
                                    if (!a7.f31728l0) {
                                        long q06 = a7.q0(2, FileLoader.checkDirectory(3));
                                        a7Var3.f31750w = q06;
                                        a7Var3.f31750w = a7.q0(2, FileLoader.checkDirectory(5)) + q06;
                                        if (!a7.f31728l0) {
                                            ...
                                            if (!a7.f31728l0) {
                                                ...
                                                if (!a7.f31728l0) {
                                                    a7Var3.F += a7Var3.h;
                                                    a7Var3.f31749s = a7.q0(0, FileLoader.checkDirectory(1));
                                                    a7Var3.v = a7.q0(0, FileLoader.checkDirectory(6));
                                                    if (!a7.f31728l0) {
                                                        long j10 = a7Var3.f31740f + a7Var3.f31747n + a7Var3.f31752y + a7Var3.E + a7Var3.f31749s + a7Var3.f31751x + a7Var3.f31748r + a7Var3.f31750w + a7Var3.v + a7Var3.F;
                                                        a7.f31729n0 = Long.valueOf(j10);
                                                        a7Var3.G = j10;
