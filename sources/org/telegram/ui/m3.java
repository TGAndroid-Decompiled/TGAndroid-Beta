...
public final class m3 extends FrameLayout {
    ...
    public final i4 K;
    public int f35459a;
    public final ci.v f35460b;
    public final g4 f35461c;
    public final s4.c0 d;
    public final j3 e;
    public final k3 f35462f;
    public boolean h;
    public boolean f35463n;
    public d3 f35464r;
    public boolean f35465s;
    public boolean v;
    public int f35466w;
    public int f35467x;
    public org.telegram.ui.web.g2 f35468y;
    ...
    public m3(i4 i4Var, Activity activity) {
        ...
        this.f35466w = org.telegram.ui.ActionBar.h6.w0(null, i10, false);
        this.f35467x = org.telegram.ui.ActionBar.h6.w0(null, i10, false);
        this.E = false;
        this.I = -1.0f;
        new Matrix();
            ...
            public final void run() {
                switch (r2) {
                    case 0:
                        ...
                        return;
                    case 1:
                        this.f33808b.f35462f.o(true, false);
                        return;
                    default:
                        m3 m3Var = this.f33808b;
                        j3 j3Var2 = m3Var.e;
                        m3Var.f35462f.o(false, false);
                        d3 d3Var = m3Var.f35464r;
                        if (d3Var != null) {
    ...
    public static void a(m3 m3Var, boolean z10, int i10) {
        ...
        if (z10) {
            ...
            if (m3Var == i4Var.f34407u0[0]) {
                if (SharedConfig.adaptableColorInBrowser) {
                    i4Var.f34395h0.setMenuColors(v9);
                }
                if (v3Var != null) {
                    v3Var.i();
                }
    ...
    public final void b() {
        ...
        if (d3Var != null) {
            ...
            d3Var.b(z10, true);
            this.f35464r.setBackgroundColor(this.f35467x);
            d3 d3Var2 = this.f35464r;
            this.f35463n = false;
            AndroidUtilities.updateViewVisibilityAnimated(d3Var2, false, 1.0f, false);
        }
        g4 g4Var = this.f35461c;
        g4Var.E = null;
        g4Var.e.clear();
        g4Var.f33812f.clear();
        g4Var.f33815s.clear();
    ...
    public final boolean d() {
        ...
        TL_iv.Page page;
        if (!f() && (g4Var = this.f35461c) != null && (webPage = g4Var.E) != null && (page = webPage.cached_page) != null && page.local != null) {
            return true;
        }
        return false;
    }
        ...
        if (c()) {
            ...
            for (int i11 = 0; i11 < vVar.getChildCount(); i11++) {
                ...
                if (vVar.getLayoutManager() == null) {
                    ...
                    i10 = RecyclerView.U(childAt).f42963f;
                }
                if (i10 == 2147483646) {
    ...
    public float getProgress() {
        ...
        } else if (f() && (webView = this.f35462f.getWebView()) != null) {
    ...
    public String getSubtitle() {
        ...
        String[] split;
        l0 l0Var;
        if (!f() || (webView = this.f35462f.getWebView()) == null) {
            return "";
        }
            ...
            try {
                if (!e()) {
                    try {
                        ...
                        if (a2.split("\\.").length > 2 && (l0Var = this.K.f34395h0) != null && ci.e4.g(a2, l0Var.E) > AndroidUtilities.displaySize.x - AndroidUtilities.dp(162.0f)) {
    ...
    public String getTitle() {
        ...
        String str2;
        if (c()) {
            TLRPC.WebPage webPage = this.f35461c.E;
    ...
    public final void onAttachedToWindow() {
        ...
        if (this.f35463n && (d3Var = this.f35464r) != null) {
            int i10 = org.telegram.ui.ActionBar.h6.Pk;
            ...
            d3Var.b(z10, false);
            this.f35464r.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, i10, false));
        }
    }
    ...
    public void setLastVisible(boolean z10) {
        if (this.H != z10) {
            this.H = z10;
            this.f35462f.setKeyboardFocusable(z10);
        }
    }
    ...
    public void setTranslationX(float f7) {
        ...
        i4 i4Var = this.K;
        i4Var.f0();
        if (i4Var.f34393f0.f19979f) {
            i4Var.f34394g0.invalidate();
        }
        if (i4Var.f34393f0.e) {
            i4Var.f34394g0.invalidate();
            i4Var.X((int) (((AndroidUtilities.dp(56.0f) - i4Var.f34393f0.h) * (f7 / getMeasuredWidth())) + i4Var.f34393f0.h));
        }
        v3 v3Var = i4Var.K;
        if (v3Var != null) {
            v3Var.n();
    ...
    public void setType(int i10) {
        ...
        this.f35460b.setVisibility(i11);
        if (f()) {
            i12 = 0;
        }
    ...
    public void setWeb(z2 z2Var) {
        ...
        if (z2Var2 != z2Var) {
            ...
            org.telegram.ui.web.g2 g2Var = this.f35468y;
            if (g2Var != null) {
                g2Var.a();
                org.telegram.ui.web.g2 g2Var2 = this.f35468y;
