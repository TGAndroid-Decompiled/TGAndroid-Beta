...
public final class m3 extends FrameLayout {
    ...
    public final i4 K;
    public int f35129a;
    public final ci.v f35130b;
    public final g4 f35131c;
    public final s4.c0 d;
    public final j3 e;
    public final k3 f35132f;
    public boolean h;
    ...
    public int f35136w;
    public int f35137x;
    public org.telegram.ui.web.f2 f35138y;
    ...
    public m3(i4 i4Var, Activity activity) {
        ...
        this.f35136w = org.telegram.ui.ActionBar.h6.w0(null, i10, false);
        this.f35137x = org.telegram.ui.ActionBar.h6.w0(null, i10, false);
        this.E = false;
        this.I = -1.0f;
        new Matrix();
        ...
        k3 k3Var = new k3(this, getContext(), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18789d6, false));
        this.f35132f = k3Var;
        k3Var.setOnCloseRequestedListener(new Runnable(this) {
            public final m3 f33446b;
            ...
            public final void run() {
                switch (r2) {
                    case 0:
                        ...
                        return;
                    case 1:
                        this.f33446b.f35132f.o(true, false);
                        return;
                    default:
                        m3 m3Var2 = this.f33446b;
                        j3 j3Var2 = m3Var2.e;
                        m3Var2.f35132f.o(false, false);
                        d3 d3Var = m3Var2.f35134r;
                        if (d3Var != null) {
                            d3Var.f32494a.setTranslationY(((j3Var2.getTopActionBarOffsetY() + (-j3Var2.getOffsetY())) - j3Var2.getSwipeOffsetY()) / 2.0f);
                        }
                        m3Var2.K.f0();
                        return;
                }
    ...
    public static void a(m3 m3Var, boolean z10, int i10) {
        ...
        if (z10) {
            ...
            if (m3Var == i4Var.f34021u0[0]) {
                if (SharedConfig.adaptableColorInBrowser) {
                    i4Var.f34009h0.setMenuColors(v9);
                }
                if (v3Var != null) {
                    v3Var.i();
                }
    ...
    public final void b() {
        ...
        if (d3Var != null) {
            ...
            d3Var.b(z10, true);
            this.f35134r.setBackgroundColor(this.f35137x);
            d3 d3Var2 = this.f35134r;
            this.f35133n = false;
            AndroidUtilities.updateViewVisibilityAnimated(d3Var2, false, 1.0f, false);
        }
        g4 g4Var = this.f35131c;
        g4Var.E = null;
        g4Var.e.clear();
        g4Var.f33452f.clear();
        g4Var.f33455s.clear();
    ...
    public final boolean d() {
        ...
        TL_iv.Page page;
        if (!f() && (g4Var = this.f35131c) != null && (webPage = g4Var.E) != null && (page = webPage.cached_page) != null && page.local != null) {
            return true;
        }
        return false;
    }
        ...
        if (c()) {
            ...
            for (int i11 = 0; i11 < vVar.getChildCount(); i11++) {
                ...
                if (vVar.getLayoutManager() == null) {
                    ...
                    i10 = RecyclerView.U(childAt).f42630f;
                }
                if (i10 == 2147483646) {
    ...
    public float getProgress() {
        ...
        } else if (f() && (webView = this.f35132f.getWebView()) != null) {
    ...
    public String getSubtitle() {
        ...
        String[] split;
        l0 l0Var;
        if (!f() || (webView = this.f35132f.getWebView()) == null) {
            return "";
        }
            ...
            try {
                if (!e()) {
                    try {
                        ...
                        if (a2.split("\\.").length > 2 && (l0Var = this.K.f34009h0) != null && ci.e4.g(a2, l0Var.E) > AndroidUtilities.displaySize.x - AndroidUtilities.dp(162.0f)) {
    ...
    public String getTitle() {
        ...
        String str2;
        if (c()) {
            TLRPC.WebPage webPage = this.f35131c.E;
    ...
    public final void onAttachedToWindow() {
        ...
        if (this.f35133n && (d3Var = this.f35134r) != null) {
            int i10 = org.telegram.ui.ActionBar.h6.Pk;
            ...
            d3Var.b(z10, false);
            this.f35134r.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, i10, false));
        }
    }
    ...
    public void setLastVisible(boolean z10) {
        if (this.H != z10) {
            this.H = z10;
            this.f35132f.setKeyboardFocusable(z10);
        }
    }
    ...
    public void setTranslationX(float f7) {
        ...
        if (i4Var.f34007f0.f19725f) {
            i4Var.f34008g0.invalidate();
        }
        if (i4Var.f34007f0.e) {
            i4Var.f34008g0.invalidate();
            i4Var.X((int) (((AndroidUtilities.dp(56.0f) - i4Var.f34007f0.h) * (f7 / getMeasuredWidth())) + i4Var.f34007f0.h));
        }
        v3 v3Var = i4Var.K;
        if (v3Var != null) {
            v3Var.n();
    ...
    public void setType(int i10) {
        ...
        this.f35130b.setVisibility(i11);
        if (f()) {
            i12 = 0;
        }
    ...
    public void setWeb(z2 z2Var) {
        ...
        if (z2Var2 != z2Var) {
            ...
            this.J = z2Var;
            if (z2Var != null) {
                org.telegram.ui.web.y0 y0Var = z2Var.f19371b;
                k3 k3Var = this.f35132f;
                if (y0Var != null) {
                    y0Var.onResume();
                    k3Var.O(UserConfig.selectedAccount, z2Var.f19371b, z2Var.d, z2Var.f19389x, false);
                    a(this, true, z2Var.f19383q);
                    a(this, false, z2Var.f19384r);
                } else {
                    String str = z2Var.f19389x;
                    if (str != null) {
                        k3Var.u(UserConfig.selectedAccount, str, false);
                    }
                }
            }
            org.telegram.ui.web.f2 f2Var = this.f35138y;
            if (f2Var != null) {
                f2Var.a();
                org.telegram.ui.web.f2 f2Var2 = this.f35138y;
