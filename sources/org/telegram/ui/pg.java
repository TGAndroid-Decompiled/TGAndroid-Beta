...
public final class pg implements Runnable {
    ...
    public final xn f37304b;
    public final org.telegram.ui.ActionBar.d2[] f37305c;
    public final int d;

    public pg(xn xnVar, org.telegram.ui.ActionBar.d2[] d2VarArr, int i10, int i11) {
        this.f37303a = i11;
        this.f37304b = xnVar;
        this.f37305c = d2VarArr;
        this.d = i10;
    }
    ...
    public final void run() {
        switch (this.f37303a) {
            case 0:
                org.telegram.ui.ActionBar.d2[] d2VarArr = this.f37305c;
                org.telegram.ui.ActionBar.d2 d2Var = d2VarArr[0];
                if (d2Var != null) {
                    final xn xnVar = this.f37304b;
                ...
                return;
            case 1:
                org.telegram.ui.ActionBar.d2[] d2VarArr2 = this.f37305c;
                org.telegram.ui.ActionBar.d2 d2Var2 = d2VarArr2[0];
                if (d2Var2 != null) {
                    final xn xnVar2 = this.f37304b;
                ...
                return;
            default:
                org.telegram.ui.ActionBar.d2[] d2VarArr3 = this.f37305c;
                org.telegram.ui.ActionBar.d2 d2Var3 = d2VarArr3[0];
                if (d2Var3 != null) {
                    final xn xnVar3 = this.f37304b;
