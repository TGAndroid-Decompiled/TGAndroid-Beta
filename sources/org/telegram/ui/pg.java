...
public final class pg implements Utilities.Callback2 {
    ...
    public final void run(Object obj, Object obj2) {
        ...
        Object obj3 = this.d;
        Object obj4 = this.f36518c;
        switch (i10) {
            case 0:
                AndroidUtilities.runOnUIThread(new ei.l3((wn) obj4, this.f36517b, (Boolean) obj, (TLRPC.WebPage) obj2, (TL_account.getWebPagePreview) obj3, 16));
                return;
            case 1:
                ...
                AndroidUtilities.runOnUIThread(new ei.l3(launchActivity, n80Var, tL_error, updates, this.f36517b, 26));
                return;
            default:
                PasskeysActivity passkeysActivity = (PasskeysActivity) obj4;
                TL_account.Passkey passkey = (TL_account.Passkey) obj3;
                TLRPC.TL_error tL_error2 = (TLRPC.TL_error) obj2;
                ArrayList arrayList = passkeysActivity.f31180b;
