...
public final class hb1 implements org.telegram.ui.Components.hl0, org.telegram.ui.ActionBar.z1 {
    ...
    public final ThemeActivity f34184b;

    public hb1(ThemeActivity themeActivity, int i10) {
        this.f34183a = i10;
        this.f34184b = themeActivity;
    }
    ...
    public void f(org.telegram.ui.ActionBar.a2 a2Var, int i10) {
        switch (this.f34183a) {
            case 1:
                ThemeActivity themeActivity = this.f34184b;
                themeActivity.getClass();
                org.telegram.ui.Components.e5.W(themeActivity, 0, null, null);
                return;
            default:
                ThemeActivity themeActivity2 = this.f34184b;
    ...
    public int run() {
        int i10;
        i10 = this.f34184b.sensitiveContentRow;
        return i10;
    }
}
