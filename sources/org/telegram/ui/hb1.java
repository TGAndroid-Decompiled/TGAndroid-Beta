...
public final class hb1 extends org.telegram.ui.Components.i51 {
    public static final int f34226b = 0;
    public org.telegram.ui.Cells.s7 f34227a;
    ...
    public final View createView(Context context, org.telegram.ui.Components.ml0 ml0Var, int i10, int i11, org.telegram.ui.ActionBar.f6 f6Var) {
        if (this.f34227a == null) {
            this.f34227a = new org.telegram.ui.Cells.s7(context, f6Var);
        }
        org.telegram.ui.Cells.t7 t7Var = new org.telegram.ui.Cells.t7(context, this.f34227a, i10);
        t7Var.f21410w0 = true;
        t7Var.f21387d0 = true;
        return t7Var;
    }
    ...
    public final boolean equals(org.telegram.ui.Components.j51 j51Var, org.telegram.ui.Components.j51 j51Var2) {
        if (j51Var.f25129q == j51Var2.f25129q && j51Var.e == j51Var2.e && j51Var.B == j51Var2.B) {
            return true;
        }
        return false;
    }
