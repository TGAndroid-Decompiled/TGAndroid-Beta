    ...
    public final void b(int i10) {
        ...
        if (i10 == 1) {
            ...
            if (TextUtils.isEmpty(obj)) {
                ...
                tL_messages_createForumTopic.peer = ze1Var.getMessagesController().getInputPeer(ze1Var.f40097a);
            ...
            if (!ze1Var.f40104w.title.equals(str) || ze1Var.f40104w.icon_emoji_id != ze1Var.f40098b) {
                TL_forum.TL_messages_editForumTopic tL_messages_editForumTopic = new TL_forum.TL_messages_editForumTopic();
                tL_messages_editForumTopic.peer = ze1Var.getMessagesController().getInputPeer(ze1Var.f40097a);
                TLRPC.TL_forumTopic tL_forumTopic = ze1Var.f40104w;
                tL_messages_editForumTopic.topic_id = tL_forumTopic.f18348id;
                if (!tL_forumTopic.title.equals(str)) {
                    tL_messages_editForumTopic.title = str;
                    tL_messages_editForumTopic.flags |= 1;
                }
                long j10 = ze1Var.f40104w.icon_emoji_id;
                long j11 = ze1Var.f40098b;
                if (j10 != j11) {
            ...
            if (ze1Var.d != null) {
                TLRPC.TL_forumTopic tL_forumTopic2 = ze1Var.f40104w;
                if (tL_forumTopic2.f18348id == 1 && (!v8Var.d.h) != tL_forumTopic2.hidden) {
                    TL_forum.TL_messages_editForumTopic tL_messages_editForumTopic2 = new TL_forum.TL_messages_editForumTopic();
                    tL_messages_editForumTopic2.peer = ze1Var.getMessagesController().getInputPeer(ze1Var.f40097a);
                    tL_messages_editForumTopic2.topic_id = ze1Var.f40104w.f18348id;
            ...
            TLRPC.TL_forumTopic tL_forumTopic3 = ze1Var.f40104w;
            long j12 = ze1Var.f40098b;
            ...
            ze1Var.getMessagesController().getTopicsController().onTopicEdited(ze1Var.f40097a, ze1Var.f40104w);
            ze1Var.finishFragment();
        }
    }
}
