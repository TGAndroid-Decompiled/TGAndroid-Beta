...
public final class s4 extends org.telegram.ui.ActionBar.p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final int U() {
        ...
        while (true) {
            ...
            if (i10 < arrayList.size()) {
                if (((r4) arrayList.get(i10)).f23025b.f25006f) {
                    return ((r4) arrayList.get(i10)).f40762e;
                }
                i10++;
            } else {
                return this.f41132n;
    ...
    public final void V(int i10, boolean z4) {
        ...
        transitionSet.setInterpolator((TimeInterpolator) org.telegram.ui.Components.pr.f30183f);
        TransitionManager.beginDelayedTransition(this.f41131f, transitionSet);
        int i11 = 0;
        while (true) {
            ArrayList arrayList = this.h;
            if (i11 < arrayList.size()) {
                if (((r4) arrayList.get(i11)).f40762e == i10) {
                ...
                while (i12 < arrayList.size()) {
                    if (((r4) arrayList.get(i12)).d) {
                        this.f41131f.removeView((View) arrayList.get(i12));
                ...
                while (true) {
                    if (i13 >= arrayList.size()) {
                        break;
                    } else if (i10 < ((r4) arrayList.get(i13)).f40762e) {
                        size = i13 + 1;
                        break;
                    } else {
                        i13++;
                ...
                this.f41131f.addView((View) j6Var, size);
                X();
                W(j6Var, z4);
                return;
            }
    ...
    public final void X() {
        ...
        while (true) {
            ArrayList arrayList = this.h;
            if (i10 < arrayList.size()) {
                ((r4) arrayList.get(i10)).setBackground(org.telegram.ui.ActionBar.k6.g0(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21659d6, false), org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21750i6, false)));
    ...
    public final View createView(Context context) {
        ...
        this.f41131f = linearLayout;
        linearLayout.setOrientation(1);
        this.f41131f.setBackgroundColor(org.telegram.ui.ActionBar.k6.w0(null, org.telegram.ui.ActionBar.k6.f21659d6, false));
        s3Var.addView(this.f41131f, k7.c6.n(-1, -2));
        ...
        r4 r4Var2 = this.f41128b;
        r4Var2.f40762e = 1440;
        this.f41131f.addView(r4Var2);
        ...
        r4 r4Var3 = this.f41129c;
        r4Var3.f40762e = 10080;
        this.f41131f.addView(r4Var3);
        ...
        r4 r4Var4 = this.d;
        r4Var4.f40762e = 44640;
        this.f41131f.addView(r4Var4);
        ...
        this.f41130e.f23025b.setVisibility(8);
        this.f41131f.addView(this.f41130e);
        r4 r4Var5 = this.f41127a;
        ArrayList arrayList = this.h;
        arrayList.add(r4Var5);
        arrayList.add(this.f41128b);
        arrayList.add(this.f41129c);
        arrayList.add(this.d);
        arrayList.add(this.f41130e);
        X();
    ...
    public final void onPause() {
        ...
        while (true) {
            ...
            if (i10 < arrayList.size()) {
                if (((r4) arrayList.get(i10)).f23025b.f25006f) {
                    if (((r4) arrayList.get(i10)).f40762e != this.f41132n) {
                        this.f41132n = ((r4) arrayList.get(i10)).f40762e;
                        TLRPC.TL_messages_setDefaultHistoryTTL tL_messages_setDefaultHistoryTTL = new TLRPC.TL_messages_setDefaultHistoryTTL();
                        tL_messages_setDefaultHistoryTTL.period = ((r4) arrayList.get(i10)).f40762e * 60;
                        getConnectionsManager().sendRequest(tL_messages_setDefaultHistoryTTL, new Object());
                        getUserConfig().setGlobalTtl(this.f41132n);
