...
public final class tw0 extends org.telegram.ui.ActionBar.n2 {
    ...
    public org.telegram.ui.Cells.a8 f37892b;
    public org.telegram.ui.Components.g90 f37893c;
    public org.telegram.ui.Components.u61 d;
    public org.telegram.ui.Components.pr e;
    public org.telegram.ui.ActionBar.v0 f37894f;
    public final boolean h;
    public final long f37895n;
    ...
    public final void V(boolean z10) {
        ...
        float f11;
        float f12;
        if (this.f37894f == null || this.f37898w == (X = X())) {
            return;
        }
        this.f37898w = X;
        this.f37894f.setEnabled(X);
        float f13 = 0.0f;
        if (z10) {
            ViewPropertyAnimator animate = this.f37894f.animate();
            if (X) {
                f11 = 1.0f;
            } else {
                f11 = 0.0f;
        ...
        org.telegram.ui.ActionBar.v0 v0Var = this.f37894f;
        if (X) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        ...
        v0Var.setAlpha(f7);
        org.telegram.ui.ActionBar.v0 v0Var2 = this.f37894f;
        if (X) {
            f10 = 1.0f;
        } else {
            f10 = 0.0f;
        ...
        org.telegram.ui.ActionBar.v0 v0Var3 = this.f37894f;
        if (X) {
            f13 = 1.0f;
        }
    ...
    public final String W() {
        ...
        return LocaleController.formatString(R.string.PostSuggestionsPriceInfo2, ei.l.G0(i10), String.valueOf(((int) (((((float) this.f37897s) * (i10 / 1000.0f)) / 1000.0d) * getMessagesController().starsUsdWithdrawRate1000)) / 100.0d));
    }

    public final boolean X() {
        if (this.f37897s == this.f37895n && this.f37896r == this.h) {
            return false;
        }
        return true;
    }
        ...
        if (this.e.f27411c <= 0.0f) {
            ...
            if (chat != null) {
                ...
                if (chat2 != null) {
                    if (this.f37896r) {
                        chat2.flags2 |= 16384;
                        chat2.send_paid_messages_stars = this.f37897s;
                    } else {
                        chat2.flags2 &= -16385;
    ...
    public final View createView(Context context) {
        ...
        this.f37894f = this.actionBar.n().i(AndroidUtilities.dp(56.0f), LocaleController.getString(R.string.Done), this.e);
        V(false);
        ...
        this.f37893c.setBackgroundColor(getThemedColor(i11));
        this.f37893c.b(true);
        this.f37893c.d(0, null, false);
    ...
    public final boolean onBackPressed(boolean z10) {
        if (X()) {
            if (z10) {
                ...
                alertDialog$Builder.f18669a.T = LocaleController.getString(R.string.MessageSuggestionsUnsavedChanges);
