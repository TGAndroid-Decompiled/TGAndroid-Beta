...
public final class tw0 extends org.telegram.ui.ActionBar.n2 {
    ...
    public org.telegram.ui.Cells.z7 f37743b;
    public org.telegram.ui.Components.v80 f37744c;
    public org.telegram.ui.Components.e61 d;
    public org.telegram.ui.Components.pr e;
    public org.telegram.ui.ActionBar.v0 f37745f;
    public final boolean h;
    public final long f37746n;
    public boolean f37747r;
    public long f37748s;
    public no v;
    public boolean f37749w;
    ...
    public final void V(boolean z10) {
        ...
        float f11;
        float f12;
        if (this.f37745f == null || this.f37749w == (X = X())) {
            return;
        }
        this.f37749w = X;
        this.f37745f.setEnabled(X);
        float f13 = 0.0f;
        if (z10) {
            ViewPropertyAnimator animate = this.f37745f.animate();
            if (X) {
                f11 = 1.0f;
            } else {
                f11 = 0.0f;
        ...
        org.telegram.ui.ActionBar.v0 v0Var = this.f37745f;
        if (X) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        ...
        v0Var.setAlpha(f7);
        org.telegram.ui.ActionBar.v0 v0Var2 = this.f37745f;
        if (X) {
            f10 = 1.0f;
        } else {
            f10 = 0.0f;
        ...
        org.telegram.ui.ActionBar.v0 v0Var3 = this.f37745f;
        if (X) {
            f13 = 1.0f;
        }
    ...
    public final String W() {
        ...
        return LocaleController.formatString(R.string.PostSuggestionsPriceInfo2, ei.l.G0(i10), String.valueOf(((int) (((((float) this.f37748s) * (i10 / 1000.0f)) / 1000.0d) * getMessagesController().starsUsdWithdrawRate1000)) / 100.0d));
    }

    public final boolean X() {
        if (this.f37748s == this.f37746n && this.f37747r == this.h) {
            return false;
        }
        return true;
    }
        ...
        if (this.e.f27129c <= 0.0f) {
            ...
            if (chat != null) {
                ...
                if (chat2 != null) {
                    if (this.f37747r) {
                        chat2.flags2 |= 16384;
                        chat2.send_paid_messages_stars = this.f37748s;
                    } else {
                        chat2.flags2 &= -16385;
    ...
    public final View createView(Context context) {
        ...
        this.f37745f = this.actionBar.n().i(AndroidUtilities.dp(56.0f), LocaleController.getString(R.string.Done), this.e);
        V(false);
        ...
        this.f37744c.setBackgroundColor(getThemedColor(i11));
        this.f37744c.b(true);
        this.f37744c.d(0, null, false);
    ...
    public final boolean onBackPressed(boolean z10) {
        if (X()) {
            if (z10) {
                ...
                alertDialog$Builder.f18435a.T = LocaleController.getString(R.string.MessageSuggestionsUnsavedChanges);
