...
public final class tw0 extends org.telegram.ui.ActionBar.n2 {
    ...
    public org.telegram.ui.Cells.z7 f40843b;
    public org.telegram.ui.Components.w80 f40844c;
    public org.telegram.ui.Components.d61 d;
    public org.telegram.ui.Components.or f40845e;
    public org.telegram.ui.ActionBar.v0 f40846f;
    public final boolean h;
    public final long f40847n;
    ...
    public final void V(boolean z10) {
        ...
        float f11;
        float f12;
        if (this.f40846f == null || this.f40850w == (X = X())) {
            return;
        }
        this.f40850w = X;
        this.f40846f.setEnabled(X);
        float f13 = 0.0f;
        if (z10) {
            ViewPropertyAnimator animate = this.f40846f.animate();
            if (X) {
                f11 = 1.0f;
            } else {
                f11 = 0.0f;
        ...
        org.telegram.ui.ActionBar.v0 v0Var = this.f40846f;
        if (X) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        ...
        v0Var.setAlpha(f7);
        org.telegram.ui.ActionBar.v0 v0Var2 = this.f40846f;
        if (X) {
            f10 = 1.0f;
        } else {
            f10 = 0.0f;
        ...
        org.telegram.ui.ActionBar.v0 v0Var3 = this.f40846f;
        if (X) {
            f13 = 1.0f;
        }
    ...
    public final String W() {
        ...
        return LocaleController.formatString(R.string.PostSuggestionsPriceInfo2, fi.m.G0(i10), String.valueOf(((int) (((((float) this.f40849s) * (i10 / 1000.0f)) / 1000.0d) * getMessagesController().starsUsdWithdrawRate1000)) / 100.0d));
    }

    public final boolean X() {
        if (this.f40849s == this.f40847n && this.f40848r == this.h) {
            return false;
        }
        return true;
    }
        ...
        if (this.f40845e.f29171c <= 0.0f) {
            ...
            if (chat != null) {
                ...
                if (chat2 != null) {
                    if (this.f40848r) {
                        chat2.flags2 |= 16384;
                        chat2.send_paid_messages_stars = this.f40849s;
                    } else {
                        chat2.flags2 &= -16385;
    ...
    public final View createView(Context context) {
        ...
        this.f40845e = new org.telegram.ui.Components.or(mutate, new org.telegram.ui.Components.sp(org.telegram.ui.ActionBar.j6.w0(null, i10, false)));
        this.f40846f = this.actionBar.n().i(AndroidUtilities.dp(56.0f), LocaleController.getString(R.string.Done), this.f40845e);
        V(false);
        ...
        this.f40844c.setBackgroundColor(getThemedColor(i11));
        this.f40844c.b(true);
        this.f40844c.d(0, null, false);
    ...
    public final boolean onBackPressed(boolean z10) {
        if (X()) {
            if (z10) {
                ...
                alertDialog$Builder.f20198a.T = LocaleController.getString(R.string.MessageSuggestionsUnsavedChanges);
