...
public final class tw0 extends org.telegram.ui.Components.vl0 {
    public final PremiumPreviewFragment f38249c;

    public tw0(PremiumPreviewFragment premiumPreviewFragment) {
        this.f38249c = premiumPreviewFragment;
    }
    ...
    @Override
    public final int h() {
        return this.f38249c.h;
    }

    @Override
    public final int j(int i10) {
        if (i10 != 0) {
            PremiumPreviewFragment premiumPreviewFragment = this.f38249c;
            if (i10 < premiumPreviewFragment.f31458n || i10 >= premiumPreviewFragment.f31463r) {
                if (i10 >= premiumPreviewFragment.v && i10 < premiumPreviewFragment.f31470w) {
                    return 1;
                }
                if (i10 == 0) {
                    return 4;
                }
                if (i10 != premiumPreviewFragment.f31472x && i10 != premiumPreviewFragment.f31474y && i10 != premiumPreviewFragment.E && i10 != premiumPreviewFragment.H) {
                    if (i10 == premiumPreviewFragment.F) {
                        return 6;
                    }
                    if (i10 != premiumPreviewFragment.f31465s && i10 != premiumPreviewFragment.G) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 7:
                ...
                break;
            case 8:
                d6Var = ((org.telegram.ui.ActionBar.m2) this.f38249c).resourceProvider;
