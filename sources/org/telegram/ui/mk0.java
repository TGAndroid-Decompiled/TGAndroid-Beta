...
public final class mk0 extends org.telegram.ui.Components.ll0 {
    ...
    public final int j(int i10) {
        ...
        int i27;
        NotificationsSettingsActivity notificationsSettingsActivity = this.d;
        if (i10 != notificationsSettingsActivity.K && i10 != notificationsSettingsActivity.M && i10 != notificationsSettingsActivity.S && i10 != notificationsSettingsActivity.G && i10 != notificationsSettingsActivity.N && i10 != notificationsSettingsActivity.E && i10 != notificationsSettingsActivity.f30853x && i10 != notificationsSettingsActivity.f30850r) {
            i11 = notificationsSettingsActivity.inappSoundRow;
            if (i10 != i11) {
                i12 = notificationsSettingsActivity.inappVibrateRow;
                if (i10 != i12 && i10 != notificationsSettingsActivity.f30852w) {
                                                                ...
                                                                if (i10 != i24) {
                                                                    ...
                                                                    if (i10 != i25) {
                                                                        ...
                                                                        if (i10 != i26) {
                                                                            ...
                                                                            if (i10 != i27) {
                                                                                if (i10 != notificationsSettingsActivity.J && i10 != notificationsSettingsActivity.f30854y && i10 != notificationsSettingsActivity.L && i10 != notificationsSettingsActivity.R && i10 != notificationsSettingsActivity.F && i10 != notificationsSettingsActivity.O && i10 != notificationsSettingsActivity.T) {
                                                                                    if (i10 == notificationsSettingsActivity.f30851s) {
                                                                                        return 6;
                                                                                    }
                                                                                    return 5;
                                                                                }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            if (i10 == 3) {
                ...
                m4Var = new org.telegram.ui.Cells.j5(21, 64, this.f35350c, d6Var3, true);
            } else if (i10 != 4) {
                if (i10 != 5) {
