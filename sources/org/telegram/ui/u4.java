...
public final class u4 extends FrameLayout {
        ...
        switch (i10) {
                ...
                if (this.f37853c) {
                    ...
                    if ((drawable instanceof org.telegram.ui.Components.b6) && ((org.telegram.ui.Components.b6) drawable).d[4] > 0) {
                        ...
                        if (valueAnimator != null) {
                            ...
                            if (radialProgress2.f22127c) {
                                s90Var = radialProgress2.f22131j;
                            } else {
                                s90Var = radialProgress2.f22130i;
                            }
                            if (s90Var.f27819w < 1.0f) {
                                radialProgress2.o(1.0f, true);
                            }
                            ValueAnimator ofFloat = ValueAnimator.ofFloat(((Float) ((ValueAnimator) this.h).getAnimatedValue()).floatValue(), 0.0f);
                            this.f37854f = ofFloat;
                            ofFloat.addListener(new t4(this, 0));
                            ((ValueAnimator) this.f37854f).addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                                public final u4 f37250b;
                            ...
                            ((ValueAnimator) this.f37854f).setDuration(250L);
                            ((ValueAnimator) this.f37854f).start();
                        } else {
                            this.f37853c = false;
                        }
                    ...
                    ValueAnimator valueAnimator2 = (ValueAnimator) this.f37854f;
            ...
            default:
                ...
                if (this.f37853c) {
                    ...
                    org.telegram.ui.ActionBar.i6.s(this, vd1Var.f38575x0, vc1Var);
                    Paint G = vc1Var.G("paintChatActionBackground");
                    ColorFilter colorFilter = G.getColorFilter();
                    G.setColorFilter((ColorMatrixColorFilter) this.f37854f);
                    kd1 kd1Var = vd1Var.f38575x0;
                    if (kd1Var != null && (kd1Var.getBackground() instanceof org.telegram.ui.Components.cc0) && vd1Var.l1 < 0.0f) {
                        f7 = 0.33f;
                    }
                    ...
                    if (vd1Var.M1) {
                        float f10 = vd1Var.f38552n1;
                        if (f10 > 0.0f) {
                            canvas.drawColor(i0.a.k(-16777216, (int) (f10 * 255.0f * vd1Var.f38554o1)));
                        }
                    }
                    canvas.save();
                    if (((LinearGradient) this.d) == null || this.f37852b != getHeight()) {
    ...
    public u4(vd1 vd1Var, Context context, boolean z10) {
        ...
        this.f37854f = new ColorMatrixColorFilter(colorMatrix);
    }
}
