...
public final class u4 extends FrameLayout {
        ...
        switch (i10) {
                ...
                if (this.f40950c) {
                    ...
                    if ((drawable instanceof org.telegram.ui.Components.d6) && ((org.telegram.ui.Components.d6) drawable).d[4] > 0) {
                        ...
                        if (valueAnimator != null) {
                            ...
                            if (radialProgress2.f24100c) {
                                t90Var = radialProgress2.f24105j;
                            } else {
                                t90Var = radialProgress2.f24104i;
                            }
                            if (t90Var.f30606w < 1.0f) {
                                radialProgress2.o(1.0f, true);
                            }
                            ValueAnimator ofFloat = ValueAnimator.ofFloat(((Float) ((ValueAnimator) this.h).getAnimatedValue()).floatValue(), 0.0f);
                            this.f40952f = ofFloat;
                            ofFloat.addListener(new s0(this, 3));
                            ((ValueAnimator) this.f40952f).addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                                public final u4 f40642b;
                            ...
                            ((ValueAnimator) this.f40952f).setDuration(250L);
                            ((ValueAnimator) this.f40952f).start();
                        } else {
                            this.f40950c = false;
                        }
                    ...
                    ValueAnimator valueAnimator2 = (ValueAnimator) this.f40952f;
            ...
            default:
                ...
                if (this.f40950c) {
                    ...
                    org.telegram.ui.ActionBar.j6.s(this, wd1Var.f42005x0, wc1Var);
                    Paint G = wc1Var.G("paintChatActionBackground");
                    ColorFilter colorFilter = G.getColorFilter();
                    G.setColorFilter((ColorMatrixColorFilter) this.f40952f);
                    ...
                    if (wd1Var.M1) {
                        float f10 = wd1Var.f41982n1;
                        if (f10 > 0.0f) {
                            canvas.drawColor(i0.a.k(-16777216, (int) (f10 * 255.0f * wd1Var.f41984o1)));
                        }
                    }
                    canvas.save();
                    if (((LinearGradient) this.d) == null || this.f40949b != getHeight()) {
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        switch (this.f40948a) {
            case 0:
                ...
                int i14 = this.f40949b;
                ((RadialProgress2) this.f40951e).q(width - i14, height - i14, width + i14, height + i14);
                return;
            default:
                super.onLayout(z10, i10, i11, i12, i13);
                return;
    ...
    public u4(wd1 wd1Var, Context context, boolean z10) {
        ...
        this.f40952f = new ColorMatrixColorFilter(colorMatrix);
    }
}
