...
public final class u4 extends FrameLayout {
        ...
        switch (i10) {
                ...
                if (this.f40922c) {
                    ...
                    if ((drawable instanceof org.telegram.ui.Components.d6) && ((org.telegram.ui.Components.d6) drawable).d[4] > 0) {
                        ...
                        if (valueAnimator != null) {
                            ...
                            this.f40924f = ofFloat;
                            ofFloat.addListener(new s0(this, 3));
                            ((ValueAnimator) this.f40924f).addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                                public final u4 f40614b;
                            ...
                            ((ValueAnimator) this.f40924f).setDuration(250L);
                            ((ValueAnimator) this.f40924f).start();
                        } else {
                            this.f40922c = false;
                        }
                    ...
                    ValueAnimator valueAnimator2 = (ValueAnimator) this.f40924f;
            ...
            default:
                ...
                if (this.f40922c) {
                    ...
                    org.telegram.ui.ActionBar.j6.s(this, wd1Var.f41977x0, wc1Var);
                    Paint G = wc1Var.G("paintChatActionBackground");
                    ColorFilter colorFilter = G.getColorFilter();
                    G.setColorFilter((ColorMatrixColorFilter) this.f40924f);
                    ...
                    if (wd1Var.M1) {
                        float f10 = wd1Var.f41954n1;
                        if (f10 > 0.0f) {
                            canvas.drawColor(i0.a.k(-16777216, (int) (f10 * 255.0f * wd1Var.f41956o1)));
                        }
                    }
                    canvas.save();
                    if (((LinearGradient) this.d) == null || this.f40921b != getHeight()) {
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        switch (this.f40920a) {
            case 0:
                ...
                int i14 = this.f40921b;
                ((RadialProgress2) this.f40923e).q(width - i14, height - i14, width + i14, height + i14);
                return;
            default:
                super.onLayout(z10, i10, i11, i12, i13);
                return;
    ...
    public u4(wd1 wd1Var, Context context, boolean z10) {
        ...
        this.f40924f = new ColorMatrixColorFilter(colorMatrix);
    }
}
