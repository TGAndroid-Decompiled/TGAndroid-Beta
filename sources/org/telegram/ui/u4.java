...
public final class u4 extends FrameLayout {
    ...
    public u4(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f37952b = AndroidUtilities.dp(64.0f);
        ...
        switch (i10) {
                ...
                if (this.f37953c) {
                    ...
                    if ((drawable instanceof org.telegram.ui.Components.c6) && ((org.telegram.ui.Components.c6) drawable).d[4] > 0) {
                        ...
                        if (valueAnimator != null) {
                            ...
                            this.f37954f = ofFloat;
                            ofFloat.addListener(new t4(this, 0));
                            ((ValueAnimator) this.f37954f).addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                                public final u4 f37294b;
                            ...
                            ((ValueAnimator) this.f37954f).setDuration(250L);
                            ((ValueAnimator) this.f37954f).start();
                        } else {
                            this.f37953c = false;
                        }
                    ...
                    ValueAnimator valueAnimator2 = (ValueAnimator) this.f37954f;
            ...
            default:
                ...
                if (this.f37953c) {
                    ...
                    org.telegram.ui.ActionBar.j6.s(this, xd1Var.f39532x0, xc1Var);
                    Paint G = xc1Var.G("paintChatActionBackground");
                    ColorFilter colorFilter = G.getColorFilter();
                    G.setColorFilter((ColorMatrixColorFilter) this.f37954f);
                    ...
                    if (xd1Var.M1) {
                        float f10 = xd1Var.f39509n1;
                        if (f10 > 0.0f) {
                            canvas.drawColor(i0.a.k(-16777216, (int) (f10 * 255.0f * xd1Var.f39511o1)));
                        }
                    }
                    canvas.save();
                    if (((LinearGradient) this.d) == null || this.f37952b != getHeight()) {
    ...
    public u4(xd1 xd1Var, Context context, boolean z10) {
        ...
        this.f37954f = new ColorMatrixColorFilter(colorMatrix);
    }
}
