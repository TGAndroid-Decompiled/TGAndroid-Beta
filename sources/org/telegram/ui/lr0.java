...
public final class lr0 implements Runnable {
    ...
    public final void run() {
        ...
        Object obj = this.h;
        Serializable serializable = this.f35409f;
        Object obj2 = this.e;
        switch (i10) {
            case 0:
                ...
                photoViewer.f31208c2 = 2;
                photoViewer.f31366u2 = false;
                photoViewer.d = new wt0(photoViewer, photoViewer.d, messageObject, orientation, this.f35408c, this.d);
                photoViewer.f31320p1.l();
            ...
            default:
                ...
                int i13 = ((int[]) obj)[0];
                if (i12 == i13) {
                    nu0 nu0Var = ks0Var.f35168b.f31224e0;
                    boolean z11 = this.f35407b;
                    boolean z12 = this.f35408c;
                    int i14 = z11 ? 1 : 0;
                    boolean z13 = this.d;
                    if ((z12 ? 1 : 0) + i14 + (z13 ? 1 : 0) > 1) {
                        ...
                        if (i13 > 1) {
                            wcVar = org.telegram.ui.Components.wc.f29962s;
                        } else {
                            wcVar = org.telegram.ui.Components.wc.f29961r;
                        }
                    } else if (z11) {
                        if (i13 > 1) {
                            wcVar = org.telegram.ui.Components.wc.f29960n;
                        } else {
                            wcVar = org.telegram.ui.Components.wc.h;
                        }
                    } else if (i13 > 1) {
                        wcVar = org.telegram.ui.Components.wc.f29959f;
                    } else {
