...
public abstract class u7 extends FrameLayout implements org.telegram.ui.Components.lc0 {
    ...
    public u7(Context context, org.telegram.ui.ActionBar.o2 o2Var, ki.i iVar) {
        ...
        this.f37957n = t7VarArr;
        this.f37962y = new g7(this, 0);
        this.d = o2Var;
        ...
        int i12 = org.telegram.ui.ActionBar.j6.f19266z8;
        ...
        this.f37953a.add(imageView);
        imageView.setOnClickListener(new View.OnClickListener(this) {
            public final u7 f32065b;
    ...
    public static void a(u7 u7Var, o7 o7Var, q7 q7Var, org.telegram.ui.Components.ml0 ml0Var) {
        ...
        if (u7Var.f37958r == null) {
            u7Var.f37958r = new j7(u7Var);
        }
        u7Var.f37958r.f34789a = ml0Var;
        if (arrayList.indexOf(o7Var) >= 0) {
            PhotoViewer.t1().f2(q7Var.f36822r, arrayList.indexOf(o7Var), -1, false, u7Var.f37958r, null);
        }
    }
    ...
    public static void b(u7 u7Var, zh.a aVar, m7 m7Var) {
        ...
        if (m7Var.e == 2) {
            if (ml0Var.getAdapter() instanceof n7) {
                ...
                if (!file.getName().endsWith("mp4") && !file.getName().endsWith(".jpg") && !lowerCase.endsWith(".jpeg") && !lowerCase.endsWith(".png") && !lowerCase.endsWith(".gif")) {
                    ...
                    PhotoViewer.t1().f2(arrayList, 0, -1, false, u7Var.f37958r, null);
                }
            } else {
                return;
            }
        ...
        if (m7Var.e == 3) {
            if (MediaController.getInstance().isPlayingMessage(aVar.f49225f)) {
                if (!MediaController.getInstance().isMessagePaused()) {
                    MediaController.getInstance().lambda$startAudioAgain$7(aVar.f49225f);
                    return;
                } else {
                    MediaController.getInstance().playMessage(aVar.f49225f);
                    return;
                }
            }
            MediaController.getInstance().playMessage(aVar.f49225f);
    ...
    public final void onAttachedToWindow() {
        ...
        getViewTreeObserver().addOnPreDrawListener(this.f37962y);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        getViewTreeObserver().removeOnPreDrawListener(this.f37962y);
    }
