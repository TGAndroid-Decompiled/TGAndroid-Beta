...
public final class n11 extends org.telegram.ui.Components.rl0 {
    ...
    public final boolean D(f2.l1 l1Var) {
        ...
        if (b10 != i10 && b10 != proxyListActivity.f32213w) {
            i11 = proxyListActivity.callsRow;
            if (b10 != i11) {
                i12 = proxyListActivity.proxyAddRow;
                if (b10 != i12 && b10 != proxyListActivity.C) {
                    if (b10 < proxyListActivity.f32211r || b10 >= proxyListActivity.f32212s) {
                        return false;
                    }
                    return true;
                }
    ...
    public final void E() {
        ...
        if (size > 0) {
            ...
            if (!s6) {
                ...
                kVar3.O(null, null);
                int i10 = proxyListActivity.f32211r;
                r(i10, proxyListActivity.f32212s - i10, 2);
            }
        } else if (s6) {
            kVar2 = ((org.telegram.ui.ActionBar.p2) proxyListActivity).actionBar;
            kVar2.r();
            int i11 = proxyListActivity.f32211r;
            r(i11, proxyListActivity.f32212s - i11, 2);
        }
    }
    ...
    public final void F() {
        ...
        int i10 = proxyListActivity.f32211r;
        r(i10, proxyListActivity.f32212s - i10, 1);
        E();
    }
    ...
    public final void G(int i10) {
        ...
        int i11 = proxyListActivity.f32211r;
        if (i10 >= i11 && i10 < proxyListActivity.f32212s) {
        ...
        if (i10 != proxyListActivity.v) {
            ...
            if (i10 != i11) {
                ...
                if (i10 != i12) {
                    ...
                    if (i10 == proxyListActivity.f32210n) {
                        return -6L;
                    }
                    if (i10 == proxyListActivity.C) {
                        return -8L;
                    }
                    if (i10 == proxyListActivity.f32213w) {
                        return -9L;
                    }
                    if (i10 == proxyListActivity.f32214x) {
                        return -10L;
                    }
                    if (i10 == proxyListActivity.f32215y) {
                        return -11L;
                    }
                    int i14 = proxyListActivity.f32211r;
                    if (i10 >= i14 && i10 < proxyListActivity.f32212s) {
    ...
    public final int j(int i10) {
        ...
        if (i10 != proxyListActivity.h && i10 != proxyListActivity.v) {
            ...
            if (i10 != i11 && i10 != proxyListActivity.C) {
                i12 = proxyListActivity.useProxyRow;
                if (i10 != i12 && i10 != proxyListActivity.f32213w) {
                    i13 = proxyListActivity.callsRow;
                    if (i10 != i13) {
                        if (i10 == proxyListActivity.f32210n) {
                            return 2;
    ...
    public final void v(f2.l1 l1Var, int i10) {
        ...
        switch (i14) {
            ...
            case 3:
                ...
                if (proxyListActivity.f32213w == -1) {
                    z10 = false;
                }
            ...
            case 4:
                ...
                if (i10 == proxyListActivity.B) {
                    ...
                    return;
                } else if (i10 == proxyListActivity.f32215y) {
            ...
            case 5:
                o11 o11Var = (o11) view;
                SharedConfig.ProxyInfo proxyInfo = (SharedConfig.ProxyInfo) arrayList2.get(i10 - proxyListActivity.f32211r);
                ...
                boolean contains = arrayList.contains(arrayList2.get(i10 - proxyListActivity.f32211r));
                o11Var.h = contains;
                o11Var.f36769f.a(contains, false);
    ...
    public final void w(f2.l1 l1Var, int i10, List list) {
        ...
        if (i13 == 5 && !list.isEmpty()) {
            o11 o11Var = (o11) view;
            if (list.contains(1) && (contains = arrayList.contains(proxyListActivity.F.get(i10 - proxyListActivity.f32211r))) != o11Var.h) {
                o11Var.h = contains;
                o11Var.f36769f.a(contains, true);
            }
            if (list.contains(2)) {
                o11Var.a(!arrayList.isEmpty(), true);
            }
        } else if (l1Var.f5788f == 3 && list.contains(0)) {
            org.telegram.ui.Cells.s8 s8Var = (org.telegram.ui.Cells.s8) view;
                    ...
                    if (i10 != 3) {
                        if (i10 != 4) {
                            if (i10 != 6) {
                                ...
                                z6Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19906d6, false));
                            } else {
        ...
        if (l1Var.f5788f == 3) {
            ...
            if (b10 != i10) {
                ...
                if (b10 == i11) {
                    s8Var.setChecked(proxyListActivity.e);
                    return;
                } else if (b10 == proxyListActivity.f32213w) {
                    s8Var.setChecked(SharedConfig.proxyRotationEnabled);
                    return;
                } else {
                    return;
