...
public abstract class SMSSubscribeSheet {
    ...
    public static void lambda$show$5(final int i, final BottomSheet bottomSheet, final Context context, final Theme.ResourcesProvider resourcesProvider, final ButtonWithCounterView buttonWithCounterView) {
        ...
        if (SMSJobController.getInstance(i).getSelectedSIM() != null) {
            ...
            new AlertDialog.Builder(context, resourcesProvider).setTitle(LocaleController.getString(2131695992)).setMessage(AndroidUtilities.replaceTags(LocaleController.getString(2131695991))).setPositiveButton(LocaleController.getString(2131694170), null).show();
        }
    }
    ...
    public static void requestSMSPermissions(final Context context, final Runnable runnable, boolean z) {
        ...
        if (!shouldShowRequestPermissionRationale) {
            ...
            if (!shouldShowRequestPermissionRationale2) {
                ...
                if (!shouldShowRequestPermissionRationale3 && !z) {
                    negativeButton = new AlertDialog.Builder(findActivity).setMessage(AndroidUtilities.replaceTags(LocaleController.getString(2131695996))).setPositiveButton(LocaleController.getString(2131693794), new DialogInterface.OnClickListener() {
                        @Override
        ...
        negativeButton = new AlertDialog.Builder(findActivity).setMessage(AndroidUtilities.replaceTags(LocaleController.getString((z3 || z2) ? !z3 ? 2131695999 : 2131695997 : 2131695998))).setPositiveButton(LocaleController.getString(2131695841), new DialogInterface.OnClickListener() {
            @Override
            public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    public static BottomSheet show(final Context context, final TL_smsjobs$TL_smsjobs_eligibleToJoin tL_smsjobs$TL_smsjobs_eligibleToJoin, final Runnable runnable, final Theme.ResourcesProvider resourcesProvider) {
        ...
        textView.setTypeface(AndroidUtilities.bold());
        textView.setText(LocaleController.getString(2131696029));
        ...
        textView2.setText(AndroidUtilities.replaceTags(LocaleController.getString(2131696028)));
        ...
        linearLayout.addView(new FeatureCell(context, 2131231259, LocaleController.getString(2131696023), LocaleController.formatPluralString("SmsSubscribeFeature1Message", tL_smsjobs$TL_smsjobs_eligibleToJoin == null ? 100 : tL_smsjobs$TL_smsjobs_eligibleToJoin.monthly_sent_sms, new Object[0]), resourcesProvider), LayoutHelper.createLinear(-1, -2, 1, 30, 16, 30, 0));
        linearLayout.addView(new FeatureCell(context, 2131231257, LocaleController.getString(2131696025), AndroidUtilities.replaceSingleTag(LocaleController.getString(2131696024), runnable2), resourcesProvider), LayoutHelper.createLinear(-1, -2, 1, 30, 16, 30, 0));
        linearLayout.addView(new FeatureCell(context, 2131231250, LocaleController.getString(2131696027), LocaleController.getString(2131696026), resourcesProvider), LayoutHelper.createLinear(-1, -2, 1, 30, 16, 30, 0));
        ...
        linksTextView.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(2131696019), runnable3));
        ...
        buttonWithCounterView.setText(LocaleController.getString(2131696020), false);
        ...
        linksTextView2.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(2131696021), runnable3));
    ...
    public static BottomSheet showSubscribed(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        textView.setTextColor(Theme.getColor(i2, resourcesProvider));
        textView.setTypeface(AndroidUtilities.bold());
        textView.setText(LocaleController.getString(2131696000));
        ...
        textView2.setText(AndroidUtilities.replaceTags(str != null ? LocaleController.formatString(2131696001, str) : LocaleController.getString(2131696003)));
        ...
        linksTextView.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(2131696002), new Runnable() {
            @Override
            public final void run() {
        ...
        buttonWithCounterView.setText(LocaleController.getString(2131694170), false);
        linearLayout.addView(buttonWithCounterView, LayoutHelper.createLinear(-1, 48, 14.0f, 0.0f, 14.0f, 0.0f));
        buttonWithCounterView.setOnClickListener(new View.OnClickListener() {
            @Override
            public final void onClick(View view) {
