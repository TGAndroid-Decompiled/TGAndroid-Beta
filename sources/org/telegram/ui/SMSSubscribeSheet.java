...
public abstract class SMSSubscribeSheet {
    ...
    public static void lambda$show$5(final int i, final BottomSheet bottomSheet, final Context context, final Theme.ResourcesProvider resourcesProvider, final ButtonWithCounterView buttonWithCounterView) {
        ...
        if (SMSJobController.getInstance(i).getSelectedSIM() != null) {
            ...
            new AlertDialog.Builder(context, resourcesProvider).setTitle(LocaleController.getString(2131695857)).setMessage(AndroidUtilities.replaceTags(LocaleController.getString(2131695856))).setPositiveButton(LocaleController.getString(2131694057), null).show();
        }
    }
        ...
        if (!shouldShowRequestPermissionRationale) {
            ...
            if (!shouldShowRequestPermissionRationale2) {
                ...
                if (!shouldShowRequestPermissionRationale3 && !z) {
                    negativeButton = new AlertDialog.Builder(findActivity).setMessage(AndroidUtilities.replaceTags(LocaleController.getString(2131695861))).setPositiveButton(LocaleController.getString(2131693687), new DialogInterface.OnClickListener() {
                        @Override
                        public final void onClick(DialogInterface dialogInterface, int i) {
                            SMSSubscribeSheet.lambda$requestSMSPermissions$15(context, runnable, findActivity, dialogInterface, i);
                        }
                    }).setNegativeButton(LocaleController.getString(2131691168), null);
                    ...
                    negativeButton.setOnDismissListener(onDismissListener).setTopImage(2131231846, Theme.getColor(Theme.key_dialogTopBackground)).show();
                }
            }
        }
        negativeButton = new AlertDialog.Builder(findActivity).setMessage(AndroidUtilities.replaceTags(LocaleController.getString((z3 || z2) ? !z3 ? 2131695864 : 2131695862 : 2131695863))).setPositiveButton(LocaleController.getString(2131695706), new DialogInterface.OnClickListener() {
            @Override
            public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    public static BottomSheet show(final Context context, final TL_smsjobs$TL_smsjobs_eligibleToJoin tL_smsjobs$TL_smsjobs_eligibleToJoin, final Runnable runnable, final Theme.ResourcesProvider resourcesProvider) {
        ...
        textView.setTypeface(AndroidUtilities.bold());
        textView.setText(LocaleController.getString(2131695894));
        ...
        textView2.setText(AndroidUtilities.replaceTags(LocaleController.getString(2131695893)));
        ...
        linearLayout.addView(new FeatureCell(context, 2131231259, LocaleController.getString(2131695888), LocaleController.formatPluralString("SmsSubscribeFeature1Message", tL_smsjobs$TL_smsjobs_eligibleToJoin == null ? 100 : tL_smsjobs$TL_smsjobs_eligibleToJoin.monthly_sent_sms, new Object[0]), resourcesProvider), LayoutHelper.createLinear(-1, -2, 1, 30, 16, 30, 0));
        linearLayout.addView(new FeatureCell(context, 2131231257, LocaleController.getString(2131695890), AndroidUtilities.replaceSingleTag(LocaleController.getString(2131695889), runnable2), resourcesProvider), LayoutHelper.createLinear(-1, -2, 1, 30, 16, 30, 0));
        linearLayout.addView(new FeatureCell(context, 2131231250, LocaleController.getString(2131695892), LocaleController.getString(2131695891), resourcesProvider), LayoutHelper.createLinear(-1, -2, 1, 30, 16, 30, 0));
        ...
        linksTextView.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(2131695884), runnable3));
        ...
        buttonWithCounterView.setText(LocaleController.getString(2131695885), false);
        ...
        linksTextView2.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(2131695886), runnable3));
    ...
    public static BottomSheet showSubscribed(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        textView.setTextColor(Theme.getColor(i2, resourcesProvider));
        textView.setTypeface(AndroidUtilities.bold());
        textView.setText(LocaleController.getString(2131695865));
        ...
        textView2.setText(AndroidUtilities.replaceTags(str != null ? LocaleController.formatString(2131695866, str) : LocaleController.getString(2131695868)));
        ...
        linksTextView.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(2131695867), new Runnable() {
            @Override
            public final void run() {
        ...
        buttonWithCounterView.setText(LocaleController.getString(2131694057), false);
        linearLayout.addView(buttonWithCounterView, LayoutHelper.createLinear(-1, 48, 14.0f, 0.0f, 14.0f, 0.0f));
        buttonWithCounterView.setOnClickListener(new View.OnClickListener() {
            @Override
            public final void onClick(View view) {
