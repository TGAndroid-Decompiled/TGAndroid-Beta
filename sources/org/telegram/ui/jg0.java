...
public final class jg0 extends AnimatorListenerAdapter {
    ...
    public void onAnimationStart(Animator animator) {
        switch (this.f37796a) {
            case 0:
                kg0 kg0Var = this.f37797b;
                kg0Var.f38082c.setVisibility(8);
                int measuredWidth = (int) (kg0Var.f38081b.getMeasuredWidth() / 10.0f);
                int measuredHeight = (int) (kg0Var.f38081b.getMeasuredHeight() / 10.0f);
