...
public final class jg0 extends AnimatorListenerAdapter {
    ...
    public void onAnimationStart(Animator animator) {
        switch (this.f37768a) {
            case 0:
                kg0 kg0Var = this.f37769b;
                kg0Var.f38054c.setVisibility(8);
                int measuredWidth = (int) (kg0Var.f38053b.getMeasuredWidth() / 10.0f);
                int measuredHeight = (int) (kg0Var.f38053b.getMeasuredHeight() / 10.0f);
