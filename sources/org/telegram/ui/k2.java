...
public final class k2 extends View implements org.telegram.ui.Cells.l9 {
    public final o70 f38255a;
    public final j4 f38256b;
    public d3 f38257c;
    public d3 d;
    ...
    public f4 f38260n;
    public TLObject f38261r;
    public final int f38262s;
    public final int v;
    public int f38263w;

    public k2(Context context, o70 o70Var, j4 j4Var) {
        super(context);
        this.f38262s = AndroidUtilities.dp(18.0f);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f38260n != null) {
            ...
            canvas.save();
            canvas.translate(this.f38262s, AndroidUtilities.dp(10.0f));
            d3 d3Var = this.f38257c;
            o70 o70Var = this.f38255a;
            int i11 = 0;
            if (d3Var != null) {
                l4.v(o70Var, canvas, this, 0);
                this.f38257c.draw(canvas, this);
                i10 = 1;
            } else {
                i10 = 0;
            }
            if (this.d != null) {
                canvas.translate(0.0f, this.f38263w);
                l4.v(o70Var, canvas, this, i10);
                this.d.draw(canvas, this);
            }
            canvas.restore();
            if (this.f38258e) {
                j4 j4Var = this.f38256b;
                ...
                canvas.drawLine(dp, measuredHeight, measuredWidth - i11, getMeasuredHeight() - 1, l4.f38592o1);
            }
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        f4 f4Var = this.f38260n;
        if (f4Var.f36749b != f4Var.f36748a.articles.size() - 1) {
            z4 = true;
        } else {
            z4 = false;
        }
        this.f38258e = z4;
        f4 f4Var2 = this.f38260n;
        TL_iv.pageRelatedArticle pagerelatedarticle = f4Var2.f36748a.articles.get(f4Var2.f36749b);
        ...
        if (photo != null) {
            ...
            imageReceiver2.setImage(ImageLocation.getForPhoto(closestPhotoSizeWithSize, photo), "64_64", ImageLocation.getForPhoto(photoSize, photo), "64_64_b", closestPhotoSizeWithSize.size, null, this.f38261r, 1);
        ...
        if (str2 != null) {
            ...
            c3 = 1;
            f10 = 6.0f;
            this.f38257c = l4.p(this.f38255a, this, str2, null, i14, this.v, this.f38260n, Layout.Alignment.ALIGN_NORMAL, 3, this.f38256b);
        } else {
            i12 = dp3;
            c3 = 1;
            f10 = 6.0f;
        ...
        d3 d3Var = this.f38257c;
        int i15 = this.f38262s;
        int i16 = this.v;
        if (d3Var != null) {
            int lineCount = d3Var.d.getLineCount();
            int i17 = 4 - lineCount;
            this.f38263w = org.telegram.messenger.y3.C(f10, this.f38257c.d.getHeight(), dp2);
            dp6 = this.f38257c.d.getHeight() + dp6;
            int i18 = 0;
            while (true) {
                if (i18 < lineCount) {
                    if (this.f38257c.d.getLineLeft(i18) != 0.0f) {
                        z10 = true;
                        break;
                    }
                    i18++;
        ...
        int i20 = this.f38263w + i16;
        String str4 = str;
        f4 f4Var3 = this.f38260n;
        if ((j4Var != null && j4Var.D) || z10) {
            alignment = org.telegram.ui.Components.lw0.a();
        } else {
            alignment = Layout.Alignment.ALIGN_NORMAL;
        }
        d3 p10 = l4.p(this.f38255a, this, str4, null, i14, i20, f4Var3, alignment, i13, this.f38256b);
        this.d = p10;
        if (p10 != null) {
            ...
            d3 d3Var3 = this.d;
            d3Var3.f35986s = i15;
            d3Var3.v = i16 + this.f38263w;
        }
        setMeasuredDimension(size, Math.max(i12, dp6) + (this.f38258e ? 1 : 0));
    }
}
