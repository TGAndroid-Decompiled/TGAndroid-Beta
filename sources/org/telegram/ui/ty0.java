...
public final class ty0 implements RequestDelegate {
    ...
    public final ProfileActivity f40871b;

    public ty0(ProfileActivity profileActivity, int i10) {
        this.f40870a = i10;
        this.f40871b = profileActivity;
    }
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f40870a) {
            case 0:
                final ProfileActivity profileActivity = this.f40871b;
                ...
                return;
            case 1:
                final ProfileActivity profileActivity2 = this.f40871b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        switch (r4) {
                ...
                return;
            case 2:
                final ProfileActivity profileActivity3 = this.f40871b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        switch (r4) {
                ...
                return;
            case 3:
                final ProfileActivity profileActivity4 = this.f40871b;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        switch (r4) {
            ...
            case 4:
                if (tLObject != null) {
                    AndroidUtilities.runOnUIThread(new rx0(10, this.f40871b, tLObject));
                    return;
                }
                return;
            default:
                boolean z10 = tLObject instanceof TL_account.TL_password;
                ProfileActivity profileActivity5 = this.f40871b;
                if (z10) {
