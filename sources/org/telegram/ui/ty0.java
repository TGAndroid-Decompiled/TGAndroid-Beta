...
public final class ty0 extends dq {
    ...
    public final TLRPC.User f43113a1;
    public final ProfileActivity f43114b1;
    ...
    public final void onTransitionAnimationEnd(boolean z10, boolean z11) {
        if (!z10 && z11 && this.Z0[0]) {
            ProfileActivity profileActivity = this.f43114b1;
            if (org.telegram.ui.Components.tc.a(profileActivity)) {
                org.telegram.ui.Components.tc.C(profileActivity, this.f43113a1.first_name).j();
            }
        }
    }
}
