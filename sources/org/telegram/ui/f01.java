    ...
    public final void onClick(View view) {
        switch (this.f33505a) {
            case 0:
                ...
                return;
            default:
                ProfileActivity profileActivity3 = this.f33506b.e;
                ...
                if (i10 >= 0) {
                    profileActivity3.f31539c.h1(i10, profileActivity3.V5 - profileActivity3.f31524a.getPaddingTop());
                    return;
                }
                return;
        }
