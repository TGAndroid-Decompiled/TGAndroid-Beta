...
public class f01 extends org.telegram.ui.Components.w9 implements org.telegram.ui.Components.mv0 {
    public static final t0 f33054g0 = new t0("crossfadeProgress", 3);
    public boolean G;
    public float H;
    public float I;
    public int J;
    ...
    public boolean f33055a0;
    public float f33056b0;
    public org.telegram.ui.Components.ph0 f33057c0;
    public boolean f33058d0;
    public float f33059e0;
    public Runnable f33060f0;
    ...
    public final void invalidate() {
        super.invalidate();
        org.telegram.ui.Components.ph0 ph0Var = this.f33057c0;
        if (ph0Var != null) {
            ph0Var.invalidate();
        }
        Runnable runnable = this.f33060f0;
        if (runnable != null) {
            runnable.run();
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        org.telegram.ui.Components.ph0 ph0Var = this.f33057c0;
        boolean z12 = true;
        if (ph0Var != null && ph0Var.getVisibility() == 0 && this.M && this.H > 0.0f) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (z10) {
            org.telegram.ui.Components.gh0 blurDrawer = this.f33057c0.getBlurDrawer();
            if (blurDrawer == null) {
                z12 = false;
            }
            boolean z13 = z12;
        ...
        float A = org.telegram.messenger.z0.A(1.0f, this.V, this.f33059e0, (1.0f - this.f33056b0) * f7);
        ...
        if (imageReceiver != null && f12 > f11 && (this.V < 1.0f || !this.f33055a0)) {
            float f22 = A * f10;
        ...
        if (this.V > f11 && this.f33055a0 && f12 > f11) {
        ...
        if (z11) {
            ...
            if (!this.G && !gh0Var.f24289a && this.f33057c0.getRealPosition() != 0) {
                f13 = 1.0f;
            } else {
                f13 = 1.0f - this.H;
            }
            float f26 = A * f10;
            gh0Var.f(canvas, this, f17 - f26, f25 - f26, true, f13, f12);
        }
        canvas.restore();
    }
