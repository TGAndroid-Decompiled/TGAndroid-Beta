...
public class f10 extends ReplacementSpan {
    ...
    public final Paint f33508b;
    public StaticLayout f33509c;
    public float d;
    public float e;
    public int f33510f;
    public final int h;
    public CharSequence f33511n;
    ...
    public final void a() {
        if (this.f33509c == null) {
            StaticLayout staticLayout = new StaticLayout(this.f33511n, this.f33507a, AndroidUtilities.displaySize.x, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            this.f33509c = staticLayout;
            this.d = staticLayout.getLineWidth(0);
            this.e = this.f33509c.getHeight();
        }
    }
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        ...
        float f10;
        a();
        int i16 = this.f33510f;
        if (i16 == 0) {
            i16 = paint.getColor();
        }
        Paint paint2 = this.f33508b;
        paint2.setColor(i16);
        ...
        TextPaint textPaint = this.f33507a;
