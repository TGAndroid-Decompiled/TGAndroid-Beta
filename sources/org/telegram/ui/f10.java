...
public class f10 extends ReplacementSpan {
    public final TextPaint f33511a;
    public final Paint f33512b;
    public StaticLayout f33513c;
    public float d;
    public float e;
    public int f33514f;
    public final int h;
    public CharSequence f33515n;

    public f10(int i10) {
        TextPaint textPaint = new TextPaint(1);
        this.f33511a = textPaint;
    ...
    public final void a() {
        if (this.f33513c == null) {
            StaticLayout staticLayout = new StaticLayout(this.f33515n, this.f33511a, AndroidUtilities.displaySize.x, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            this.f33513c = staticLayout;
            this.d = staticLayout.getLineWidth(0);
            this.e = this.f33513c.getHeight();
        }
    }
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        ...
        float f10;
        a();
        int i16 = this.f33514f;
        if (i16 == 0) {
            i16 = paint.getColor();
        }
        Paint paint2 = this.f33512b;
        paint2.setColor(i16);
        ...
        TextPaint textPaint = this.f33511a;
