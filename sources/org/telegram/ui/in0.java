...
public final class in0 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public EditTextBoldCursor[] f34163a0;
    public boolean f34164a1;
    public final int f34165b;
    public ScrollView f34166b0;
    public long f34167b1;
    public long f34168c;
    public LinearLayout f34169c0;
    public byte[] f34170c1;
    public final String d;
    public LinearLayout f34171d0;
    public String f34172d1;
    public final String e;
    public LinearLayout f34173e0;
    public byte[] f34174e1;
    public boolean f34175f;
    public LinearLayout f34176f0;
    public boolean f34177f1;
    public LinearLayout f34178g0;
    public boolean f34179g1;
    public final String h;
    public LinearLayout f34180h0;
    public in0 f34181h1;
    public LinearLayout f34182i0;
    public final ArrayList f34183i1;
    public org.telegram.ui.Cells.m4 f34184j0;
    public SecureDocument f34185j1;
    public final ArrayList f34186k0;
    public final ArrayList f34187k1;
    public org.telegram.ui.Cells.a7 f34188l0;
    public SecureDocument l1;
    public org.telegram.ui.Cells.a7 m0;
    public SecureDocument f34189m1;
    public final String f34190n;
    public org.telegram.ui.Cells.f9 f34191n0;
    public final HashMap f34192n1;
    public org.telegram.ui.Cells.f9 f34193o0;
    public final HashMap f34194o1;
    public org.telegram.ui.Cells.f9 f34195p0;
    public final HashMap f34196p1;
    public org.telegram.ui.Cells.f9 f34197q0;
    public final HashMap f34198q1;
    public final String f34199r;
    public org.telegram.ui.Cells.fa f34200r0;
    public final HashMap f34201r1;
    public String f34202s;
    public int f34203s0;
    public final HashMap f34204s1;
    public final boolean[] f34205t0;
    public final HashMap f34206t1;
    public boolean f34207u0;
    public final HashMap f34208u1;
    public String v;
    public boolean f34209v0;
    public final HashMap f34210v1;
    public String f34211w;
    public TextView f34212w0;
    public HashMap f34213w1;
    public final int[] f34214x;
    public org.telegram.ui.Cells.fa f34215x0;
    public HashMap f34216x1;
    public TL_account.authorizationForm f34217y;
    public org.telegram.ui.Cells.fa f34218y0;
    public final HashMap f34219y1;
    public org.telegram.ui.Cells.a7 f34220z0;
    public String f34221z1;
    ...
    public in0(int i10, TL_account.authorizationForm authorizationform, TL_account.Password password, TLRPC.TL_secureRequiredType tL_secureRequiredType, TLRPC.TL_secureValue tL_secureValue, TLRPC.TL_secureRequiredType tL_secureRequiredType2, TLRPC.TL_secureValue tL_secureValue2, HashMap hashMap, HashMap hashMap2) {
        ...
        this.f34202s = "";
        this.v = "";
        this.f34214x = new int[3];
        this.f34186k0 = new ArrayList();
        this.f34205t0 = new boolean[3];
        this.f34207u0 = true;
        this.U0 = new ArrayList();
        this.V0 = new HashMap();
        this.W0 = new HashMap();
        this.X0 = new HashMap();
        this.f34183i1 = new ArrayList();
        this.f34187k1 = new ArrayList();
        this.f34192n1 = new HashMap();
        this.f34194o1 = new HashMap();
        this.f34196p1 = new HashMap();
        this.f34198q1 = new HashMap();
        this.f34201r1 = new HashMap();
        this.f34208u1 = new HashMap();
        this.f34210v1 = new HashMap();
        this.f34219y1 = new HashMap();
        this.D1 = new hm0(this);
        this.f34165b = i10;
        this.f34217y = authorizationform;
        this.E = tL_secureRequiredType;
        if (tL_secureRequiredType != null) {
            this.f34207u0 = tL_secureRequiredType.native_names;
        }
        this.H = tL_secureValue;
        this.F = tL_secureRequiredType2;
        this.I = tL_secureValue2;
        this.J = password;
        this.f34204s1 = hashMap;
        this.f34206t1 = hashMap2;
        if (i10 == 3) {
        ...
        if (hashMap == null) {
            this.f34204s1 = new HashMap();
        }
        if (hashMap2 == null) {
            this.f34206t1 = new HashMap();
        }
        if (i10 == 5) {
    ...
    public static boolean D0(org.telegram.ui.in0 r14) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.in0.D0(org.telegram.ui.in0):boolean");
    }
    ...
    public static void U(in0 in0Var, TLRPC.TL_auth_passwordRecovery tL_auth_passwordRecovery) {
    ...
    public static void V(in0 in0Var) {
        ...
        HashMap hashMap = in0Var.f34201r1;
        HashMap hashMap2 = in0Var.f34198q1;
        String str = in0Var.f34199r;
        ArrayList arrayList2 = new ArrayList();
        int size = in0Var.f34217y.required_types.size();
        for (int i12 = 0; i12 < size; i12++) {
            TLRPC.SecureRequiredType secureRequiredType = in0Var.f34217y.required_types.get(i12);
            ...
            HashMap hashMap3 = (HashMap) in0Var.f34208u1.get(o1(tL_secureRequiredType.type));
        ...
        acceptauthorization.bot_id = in0Var.f34168c;
        ...
        int i14 = 0;
        while (i14 < size3) {
            im0 im0Var = (im0) arrayList2.get(i14);
            TLRPC.TL_secureValue tL_secureValue = im0Var.f34159a;
            ...
            if (securePlainData != null) {
                ...
                try {
                    ...
                    if (im0Var.f34161c && !tL_secureValue.translation.isEmpty()) {
    ...
    public static void W(in0 in0Var, TLRPC.TL_error tL_error, String str, ym0 ym0Var, TLObject tLObject, TL_account.sendVerifyPhoneCode sendverifyphonecode) {
        if (tL_error == null) {
            HashMap hashMap = new HashMap();
            hashMap.put("phone", str);
            in0 in0Var2 = new in0(7, in0Var.f34217y, in0Var.J, in0Var.E, (TLRPC.TL_secureValue) null, (TLRPC.TL_secureRequiredType) null, (TLRPC.TL_secureValue) null, hashMap, (HashMap) null);
    ...
    public static void X(in0 in0Var, SecureDocument secureDocument, int i10) {
        HashMap hashMap = in0Var.f34192n1;
        int i11 = in0Var.S0;
        if (i11 == 1) {
            SecureDocument secureDocument2 = in0Var.f34185j1;
            if (secureDocument2 != null) {
                gn0 gn0Var = (gn0) hashMap.remove(secureDocument2);
                if (gn0Var != null) {
                    in0Var.f34178g0.removeView(gn0Var);
                }
                in0Var.f34185j1 = null;
            }
        } else if (i11 == 4) {
            if (in0Var.f34187k1.size() >= 20) {
                return;
            }
        } else if (i11 == 2) {
            ...
            if (secureDocument3 != null) {
                ...
                if (gn0Var2 != null) {
                    in0Var.f34173e0.removeView(gn0Var2);
                }
                in0Var.l1 = null;
            }
        } else if (i11 == 3) {
            SecureDocument secureDocument4 = in0Var.f34189m1;
            if (secureDocument4 != null) {
                gn0 gn0Var3 = (gn0) hashMap.remove(secureDocument4);
                if (gn0Var3 != null) {
                    in0Var.f34176f0.removeView(gn0Var3);
                }
                in0Var.f34189m1 = null;
            }
        } else if (i11 == 0 && in0Var.f34183i1.size() >= 20) {
            return;
        }
        in0Var.f34194o1.put(secureDocument.path, secureDocument);
    ...
    public static void Y(org.telegram.ui.in0 r9, boolean r10, java.lang.String r11) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.in0.Y(org.telegram.ui.in0, boolean, java.lang.String):void");
    }

    public static void Z(int i10, String str, SecureDocument secureDocument, gn0 gn0Var, in0 in0Var) {
        HashMap hashMap = in0Var.f34194o1;
        in0Var.f34192n1.remove(secureDocument);
        if (i10 == 1) {
            in0Var.f34185j1 = null;
            in0Var.f34178g0.removeView(gn0Var);
        } else if (i10 == 4) {
            in0Var.f34187k1.remove(secureDocument);
            in0Var.f34180h0.removeView(gn0Var);
        } else if (i10 == 2) {
            in0Var.l1 = null;
            in0Var.f34173e0.removeView(gn0Var);
        } else if (i10 == 3) {
            in0Var.f34189m1 = null;
            in0Var.f34176f0.removeView(gn0Var);
        } else {
            in0Var.f34183i1.remove(secureDocument);
            in0Var.f34171d0.removeView(gn0Var);
        }
        if (str != null) {
            HashMap hashMap2 = in0Var.f34216x1;
            if (hashMap2 != null) {
                hashMap2.remove(str);
            }
            HashMap hashMap3 = in0Var.f34219y1;
            if (hashMap3 != null) {
                hashMap3.remove(str);
            }
        }
    ...
    public static void a0(in0 in0Var) {
        TL_account.deleteSecureValue deletesecurevalue = new TL_account.deleteSecureValue();
        for (int i10 = 0; i10 < in0Var.f34217y.values.size(); i10++) {
            deletesecurevalue.types.add(in0Var.f34217y.values.get(i10).type);
        }
        in0Var.y1();
    ...
    public static void c0(in0 in0Var) {
        ...
        } else if (in0Var.getParentActivity() == null) {
        } else {
    ...
    public static void d0(in0 in0Var) {
        Activity parentActivity = in0Var.getParentActivity();
        nf.f.s(parentActivity, "https://telegram.org/deactivate?phone=" + UserConfig.getInstance(in0Var.currentAccount).getClientPhone());
    }
    ...
    public static int s0(in0 in0Var) {
        return in0Var.currentAccount;
    }

    public static int t0(in0 in0Var) {
        return in0Var.currentAccount;
    }
    ...
    public final void C1() {
        ...
        if (getParentActivity() != null && !arrayList.isEmpty()) {
            ...
            alertDialog$Builder.f18409a.R = LocaleController.getString(R.string.PassportNoDocumentsAdd);
    ...
    public final void D1() {
        ...
        int i11 = this.S0;
        ArrayList arrayList = this.f34183i1;
        int i12 = 1;
    ...
    public final void E1(TLRPC.TL_secureRequiredType tL_secureRequiredType, TLRPC.TL_secureRequiredType tL_secureRequiredType2, ArrayList arrayList, boolean z10) {
        ...
        if (i11 != -1) {
            HashMap hashMap4 = this.f34208u1;
            if (!z10) {
            ...
            TL_account.authorizationForm authorizationform = this.f34217y;
            int i12 = i11;
            TL_account.Password password = this.J;
            HashMap hashMap7 = this.f34196p1;
            ...
            in0 in0Var = new in0(i12, authorizationform, password, tL_secureRequiredType, r12, tL_secureRequiredType2, r13, hashMap8, hashMap3);
            in0Var.B1 = new lm0(this, secureValueType2, z10, i10);
            in0Var.currentAccount = this.currentAccount;
            in0Var.f34174e1 = this.f34174e1;
            in0Var.f34170c1 = this.f34170c1;
            in0Var.f34168c = this.f34168c;
            in0Var.f34213w1 = hashMap6;
            in0Var.f34209v0 = z10;
            in0Var.f34216x1 = hashMap2;
            in0Var.G = arrayList;
            if (i12 == 4) {
                in0Var.f34172d1 = this.f34172d1;
            }
    ...
    public final TLRPC.TL_secureValue H1(TLRPC.TL_secureRequiredType tL_secureRequiredType) {
        ...
        int size = this.f34217y.values.size();
        for (int i10 = 0; i10 < size; i10++) {
            if (tL_secureRequiredType.type.getClass() == this.f34217y.values.get(i10).type.getClass()) {
                return this.f34217y.values.remove(i10);
            }
        }
        return null;
    }
    ...
    public final void I1(View view) {
        while (view != null && this.f34169c0.indexOfChild(view) < 0) {
            view = (View) view.getParent();
        }
        if (view != null) {
            this.f34166b0.smoothScrollTo(0, view.getTop() - ((this.f34166b0.getMeasuredHeight() - view.getMeasuredHeight()) / 2));
        }
    }
    ...
    public final void J1(HashMap hashMap, EditTextBoldCursor editTextBoldCursor, String str) {
        ...
        HashMap hashMap2 = this.f34213w1;
        HashMap hashMap3 = this.f34219y1;
        ...
        HashMap hashMap4 = this.f34216x1;
    ...
    public final void K1(Bundle bundle, int i10, boolean z10) {
        ...
        if (z10) {
            ...
            animatorSet.addListener(new org.telegram.ui.Components.qk0(uv0Var2, uv0Var, 8));
            animatorSet.start();
            return;
        }
    ...
    public final void L1(org.telegram.tgnet.TLRPC.TL_secureRequiredType r31, java.lang.String r32, java.lang.String r33, org.telegram.tgnet.TLRPC.TL_secureRequiredType r34, java.lang.String r35, boolean r36, int r37) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.in0.L1(org.telegram.tgnet.TLRPC$TL_secureRequiredType, java.lang.String, java.lang.String, org.telegram.tgnet.TLRPC$TL_secureRequiredType, java.lang.String, boolean, int):void");
    }
    ...
    public final void N1(boolean z10, boolean z11) {
        ...
        if (z10 && this.L != null) {
            ...
            this.M.addListener(new mm0(this, z11, 0));
            ...
            this.M.addListener(new mm0(this, z11, 1));
            this.M.setDuration(150L);
            this.M.start();
        }
    }
    ...
    public final void Q1() {
        if (this.f34217y.values.isEmpty()) {
            this.A0.setVisibility(0);
            this.f34188l0.setVisibility(8);
            this.f34184j0.setVisibility(8);
            this.f34215x0.setVisibility(8);
            this.f34218y0.setVisibility(8);
            this.f34220z0.setVisibility(8);
            return;
        }
        this.A0.setVisibility(8);
        this.f34188l0.setVisibility(0);
        this.f34184j0.setVisibility(0);
        this.f34218y0.setVisibility(0);
        this.f34220z0.setVisibility(0);
    ...
    public final void R0(final SecureDocument secureDocument, final int i10) {
        ...
        HashMap hashMap;
        if (i10 == 1) {
            this.f34185j1 = secureDocument;
            if (this.f34178g0 == null) {
                return;
            }
        } else if (i10 == 4) {
            this.f34187k1.add(secureDocument);
            if (this.f34180h0 == null) {
                return;
            }
        } else if (i10 == 2) {
            this.l1 = secureDocument;
            if (this.f34173e0 == null) {
                return;
            }
        } else if (i10 == 3) {
            this.f34189m1 = secureDocument;
            if (this.f34176f0 == null) {
                return;
            }
        } else {
            this.f34183i1.add(secureDocument);
            if (this.f34171d0 == null) {
                return;
            }
        }
        if (getParentActivity() == null) {
        ...
        if (i10 == 1) {
            ...
            this.f34173e0.addView(gn0Var, w7.x5.n(-1, -2));
            str = "front" + n12;
        } else if (i10 == 3) {
            string = LocaleController.getString(R.string.PassportReverseSide);
            this.f34176f0.addView(gn0Var, w7.x5.n(-1, -2));
            str = "reverse" + n12;
        } else {
            string = LocaleController.getString(R.string.AttachPhoto);
            this.f34171d0.addView(gn0Var, w7.x5.n(-1, -2));
            str = "files" + n12;
        }
        if (str != null && (hashMap = this.f34216x1) != null && (formatDateForBan = (String) hashMap.get(str)) != null) {
            gn0Var.f33594b.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19008p7, false));
            this.f34219y1.put(str, "");
        } else {
            formatDateForBan = LocaleController.formatDateForBan(secureDocument.secureFile.date);
        }
        gn0Var.f33593a.setText(string);
        gn0Var.f33594b.setText(formatDateForBan);
        org.telegram.ui.Components.w9 w9Var = gn0Var.f33595c;
        w9Var.getClass();
        w9Var.m(ImageLocation.getForSecureDocument(secureDocument), "48_48", null, null, null, null, 0, null);
        gn0Var.f33596f = secureDocument;
        gn0Var.a(false);
        gn0Var.setOnClickListener(new ci.n4(this, i10, 20));
        gn0Var.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public final boolean onLongClick(View view) {
                ...
                int i11 = i10;
                if (i11 == 1) {
                    alertDialog$Builder.f18409a.T = LocaleController.getString(R.string.PassportDeleteSelfie);
                } else {
                    alertDialog$Builder.f18409a.T = LocaleController.getString(R.string.PassportDeleteScan);
                }
    ...
    public final void S1(int r7) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.in0.S1(int):void");
    }
    ...
    public final org.telegram.ui.hn0 U0(android.content.Context r28, org.telegram.tgnet.TLRPC.TL_secureRequiredType r29, java.util.ArrayList r30, boolean r31, boolean r32) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.in0.U0(android.content.Context, org.telegram.tgnet.TLRPC$TL_secureRequiredType, java.util.ArrayList, boolean, boolean):org.telegram.ui.hn0");
    }
    ...
    public final void Y0(boolean z10) {
        ...
        if (this.f34163a0 != null) {
            ...
            if (this.E.native_names && !TextUtils.isEmpty(this.v) && !"EN".equals(str3)) {
                if (this.f34197q0.getVisibility() != 0) {
                    this.f34197q0.setVisibility(0);
                    this.f34184j0.setVisibility(0);
                    this.T.setVisibility(0);
                    int i11 = 0;
                    while (true) {
                        editTextBoldCursorArr = this.f34163a0;
                        if (i11 >= editTextBoldCursorArr.length) {
                            break;
                        }
                    ...
                    if (editTextBoldCursorArr[0].length() == 0 && this.f34163a0[1].length() == 0 && this.f34163a0[2].length() == 0) {
                        int i12 = 0;
                        while (true) {
                            boolean[] zArr = this.f34205t0;
                            if (i12 >= zArr.length) {
                                break;
                            } else if (zArr[i12]) {
                                this.f34163a0[0].setText(this.Y[0].getText());
                                this.f34163a0[1].setText(this.Y[1].getText());
                                this.f34163a0[2].setText(this.Y[2].getText());
                                break;
                            } else {
                                i12++;
                            }
                    ...
                    this.m0.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(getParentActivity(), R.drawable.greydivider, org.telegram.ui.ActionBar.h6.f18753b7));
                }
                this.f34197q0.setText(LocaleController.formatString("PassportNativeInfo", R.string.PassportNativeInfo, str2));
                if (str3 != null) {
                ...
                if (str != null) {
                    this.f34184j0.setText(LocaleController.formatString("PassportNativeHeaderLang", R.string.PassportNativeHeaderLang, str));
                } else {
                    this.f34184j0.setText(LocaleController.getString(R.string.PassportNativeHeader));
                }
                for (int i13 = 0; i13 < 3; i13++) {
                    if (i13 != 0) {
                        if (i13 != 1) {
                            if (i13 == 2) {
                                if (str != null) {
                                    this.f34163a0[i13].setHintText(LocaleController.getString(R.string.PassportSurname));
                                } else {
                                    this.f34163a0[i13].setHintText(LocaleController.formatString("PassportSurnameCountry", R.string.PassportSurnameCountry, str2));
                                }
                            }
                        } else if (str != null) {
                            this.f34163a0[i13].setHintText(LocaleController.getString(R.string.PassportMidname));
                        } else {
                            this.f34163a0[i13].setHintText(LocaleController.formatString("PassportMidnameCountry", R.string.PassportMidnameCountry, str2));
                        }
                    } else if (str != null) {
                        this.f34163a0[i13].setHintText(LocaleController.getString(R.string.PassportName));
                    } else {
                        this.f34163a0[i13].setHintText(LocaleController.formatString("PassportNameCountry", R.string.PassportNameCountry, str2));
                    }
                }
                if (z10) {
                    AndroidUtilities.runOnUIThread(new rl0(this, 2));
                }
            } else if (this.f34197q0.getVisibility() != 8) {
                this.f34197q0.setVisibility(8);
                this.f34184j0.setVisibility(8);
                this.T.setVisibility(8);
                while (true) {
                    EditTextBoldCursor[] editTextBoldCursorArr2 = this.f34163a0;
                ...
                if (((this.f34168c != 0 || this.F == null) && this.H != null && !this.f34209v0) || this.I != null) {
                    this.m0.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(getParentActivity(), R.drawable.greydivider, org.telegram.ui.ActionBar.h6.f18753b7));
                } else {
                    this.m0.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(getParentActivity(), R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.h6.f18753b7));
                }
            }
        }
    }
    ...
    public final void a1(boolean z10) {
        ...
        String str;
        String str2;
        if (this.f34195p0 != null) {
            HashMap hashMap = this.f34213w1;
            HashMap hashMap2 = this.f34219y1;
            if (hashMap != null && ((z10 || hashMap2.containsKey("error_all")) && (str2 = (String) this.f34213w1.get("error_all")) != null)) {
            ...
            if (this.f34216x1 != null && ((z10 || hashMap2.containsKey("error_document_all")) && (str = (String) this.f34216x1.get("error_all")) != null)) {
            ...
            if (spannableStringBuilder != null) {
                spannableStringBuilder.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19008p7, false)), 0, spannableStringBuilder.length(), 33);
                this.f34195p0.setText(spannableStringBuilder);
                this.f34195p0.setVisibility(0);
            } else if (this.f34195p0.getVisibility() != 8) {
                this.f34195p0.setVisibility(8);
            }
        }
    }
    ...
    public final void b1(Context context) {
        ...
        this.f34195p0.setPadding(0, AndroidUtilities.dp(7.0f), 0, 0);
        this.f34169c0.addView(this.f34195p0, w7.x5.n(-1, -2));
        a1(true);
        TLRPC.TL_secureRequiredType tL_secureRequiredType = this.F;
        if (tL_secureRequiredType != null) {
            ...
            org.telegram.ui.Cells.m4 m4Var2 = this.f34184j0;
            int i12 = org.telegram.ui.ActionBar.h6.f18789d6;
            m4Var2.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, i12, false));
            this.f34169c0.addView(this.f34184j0, w7.x5.n(-1, -2));
            LinearLayout linearLayout = new LinearLayout(context);
            this.f34171d0 = linearLayout;
            linearLayout.setOrientation(1);
            this.f34169c0.addView(this.f34171d0, w7.x5.n(-1, -2));
            ...
            if (hashMap != null) {
                ...
                if (str4 != null) {
                    ...
                    spannableStringBuilder.append((CharSequence) "\n\n");
                    spannableStringBuilder.append((CharSequence) this.f34221z1);
                    spannableStringBuilder.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19008p7, false)), 0, str4.length(), 33);
                    hashMap2.put("files_all", "");
                    str3 = spannableStringBuilder;
                }
            }
            this.f34191n0.setText(str3);
            this.f34169c0.addView(this.f34191n0, w7.x5.n(-1, -2));
            if (this.F.translation_required) {
                org.telegram.ui.Cells.m4 m4Var3 = new org.telegram.ui.Cells.m4(context);
                this.f34184j0 = m4Var3;
                m4Var3.setText(LocaleController.getString(R.string.PassportTranslation));
                this.f34184j0.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, i12, false));
                this.f34169c0.addView(this.f34184j0, w7.x5.n(-1, -2));
                LinearLayout linearLayout2 = new LinearLayout(context);
                this.f34180h0 = linearLayout2;
                linearLayout2.setOrientation(1);
                this.f34169c0.addView(this.f34180h0, w7.x5.n(-1, -2));
                ...
                String str5 = this.A1;
                HashMap hashMap3 = this.f34216x1;
                String str6 = str5;
                if (hashMap3 != null) {
                    ...
                    if (str7 != null) {
                        ...
                        spannableStringBuilder2.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19008p7, false)), 0, str7.length(), 33);
                        hashMap2.put("translation_all", "");
                        str6 = spannableStringBuilder2;
                    }
                }
                this.f34193o0.setText(str6);
                this.f34169c0.addView(this.f34193o0, w7.x5.n(-1, -2));
            }
        } else {
            j3 = 0;
        ...
        this.f34184j0 = m4Var4;
        m4Var4.setText(LocaleController.getString(R.string.PassportAddressHeader));
        this.f34184j0.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18789d6, false));
        this.f34169c0.addView(this.f34184j0, w7.x5.n(-1, -2));
        this.Y = new EditTextBoldCursor[6];
        for (int i13 = 0; i13 < 6; i13++) {
            EditTextBoldCursor editTextBoldCursor = new EditTextBoldCursor(context);
            this.Y[i13] = editTextBoldCursor;
            cm0 cm0Var = new cm0(context, editTextBoldCursor, 0);
            cm0Var.setWillNotDraw(false);
            this.f34169c0.addView(cm0Var, w7.x5.n(-1, -2));
            int i14 = org.telegram.ui.ActionBar.h6.f18789d6;
            cm0Var.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, i14, false));
            int i15 = 5;
            if (i13 == 5) {
                View view = new View(context);
                this.S = view;
                view.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, i14, false));
                this.f34169c0.addView(this.S, w7.x5.n(-1, 6));
            }
            if (this.f34209v0 && this.F != null) {
            ...
            this.Y[i13].setLineColors(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18916k6, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18934l6, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19008p7, false));
            if (i13 == 5) {
                this.Y[i13].setOnTouchListener(new tl0(this, 2));
            ...
            J1(this.f34204s1, this.Y[i13], str);
            if (i13 == 2) {
                this.Y[i13].addTextChangedListener(new dm0(this, editTextBoldCursor, str));
                this.Y[i13].setFilters(new InputFilter[]{new InputFilter.LengthFilter(10)});
            } else {
                this.Y[i13].addTextChangedListener(new em0(this, editTextBoldCursor, str, 0));
            }
            ...
            cm0Var.addView(this.Y[i13], w7.x5.d(-1, 64.0f, 51, 21.0f, 0.0f, 21.0f, 0.0f));
            this.Y[i13].setOnEditorActionListener(new ql0(this, 4));
        }
        org.telegram.ui.Cells.a7 a7Var = new org.telegram.ui.Cells.a7(context, (org.telegram.ui.Cells.q3) null);
        this.f34188l0 = a7Var;
        this.f34169c0.addView(a7Var, w7.x5.n(-1, -2));
        if (this.f34209v0 && this.F != null) {
            this.f34184j0.setVisibility(8);
            this.f34188l0.setVisibility(8);
        }
        long j10 = this.f34168c;
        TLRPC.TL_secureValue tL_secureValue = this.I;
        if (((j10 != j3 || this.F == null) && this.H != null && !this.f34209v0) || tL_secureValue != null) {
            if (tL_secureValue != null) {
                T0(tL_secureValue.files);
                V0(tL_secureValue.translation);
            }
            org.telegram.ui.Cells.a7 a7Var2 = this.f34188l0;
            int i17 = R.drawable.greydivider;
            int i18 = org.telegram.ui.ActionBar.h6.f18753b7;
            a7Var2.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(context, i17, i18));
            org.telegram.ui.Cells.fa faVar3 = new org.telegram.ui.Cells.fa(context);
            faVar3.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19008p7, false));
            ...
            this.f34169c0.addView(faVar3, w7.x5.n(-1, -2));
            ...
            this.f34188l0 = a7Var3;
            a7Var3.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(context, R.drawable.greydivider_bottom, i18));
            this.f34169c0.addView(this.f34188l0, w7.x5.n(-1, -2));
        } else {
            org.telegram.ui.Cells.a7 a7Var4 = this.f34188l0;
            int i19 = R.drawable.greydivider_bottom;
            int i20 = org.telegram.ui.ActionBar.h6.f18753b7;
            a7Var4.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(context, i19, i20));
            if (this.f34209v0 && this.F != null) {
                this.f34191n0.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(context, R.drawable.greydivider_bottom, i20));
            }
        }
        S1(0);
        S1(4);
    ...
    public final android.view.View createView(android.content.Context r37) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.in0.createView(android.content.Context):android.view.View");
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.fileUploaded) {
            ...
            if (secureDocument != null) {
                ...
                HashMap hashMap2 = this.f34192n1;
                ...
                if (i12 == 0) {
                    if (this.f34191n0 != null && !TextUtils.isEmpty(this.f34221z1)) {
                        this.f34191n0.setText(this.f34221z1);
                    }
                    hashMap3.remove("files_all");
                } else if (i12 == 4) {
                    if (this.f34193o0 != null && !TextUtils.isEmpty(this.A1)) {
                        this.f34193o0.setText(this.A1);
                    }
    ...
    public final void e1(Context context) {
        ...
        int i13 = org.telegram.ui.ActionBar.h6.f18753b7;
        f9Var.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(context, i12, i13));
        boolean z10 = false;
        this.f34195p0.setPadding(0, AndroidUtilities.dp(7.0f), 0, 0);
        int i14 = -1;
        this.f34169c0.addView(this.f34195p0, w7.x5.n(-1, -2));
        ...
        if (tL_secureRequiredType != null) {
            ...
            this.f34169c0.addView(this.f34184j0, w7.x5.n(-1, -2));
            LinearLayout linearLayout = new LinearLayout(context);
            this.f34173e0 = linearLayout;
            linearLayout.setOrientation(1);
            this.f34169c0.addView(this.f34173e0, w7.x5.n(-1, -2));
            org.telegram.ui.Cells.e9 e9Var = new org.telegram.ui.Cells.e9(context);
            this.U = e9Var;
            e9Var.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.K0(true));
            this.f34169c0.addView(this.U, w7.x5.n(-1, -2));
            this.U.setOnClickListener(new sl0(this, 0));
            LinearLayout linearLayout2 = new LinearLayout(context);
            this.f34176f0 = linearLayout2;
            linearLayout2.setOrientation(1);
            this.f34169c0.addView(this.f34176f0, w7.x5.n(-1, -2));
            ...
            this.f34169c0.addView(this.V, w7.x5.n(-1, -2));
            this.V.setOnClickListener(new sl0(this, 2));
            if (this.F.selfie_required) {
                LinearLayout linearLayout3 = new LinearLayout(context);
                this.f34178g0 = linearLayout3;
                linearLayout3.setOrientation(1);
                this.f34169c0.addView(this.f34178g0, w7.x5.n(-1, -2));
                ...
                this.f34169c0.addView(this.W, w7.x5.n(-1, -2));
                this.W.setOnClickListener(new sl0(this, 3));
            }
            org.telegram.ui.Cells.f9 f9Var2 = new org.telegram.ui.Cells.f9(context);
            this.f34191n0 = f9Var2;
            f9Var2.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(context, R.drawable.greydivider, i13));
            this.f34191n0.setText(LocaleController.getString(R.string.PassportPersonalUploadInfo));
            this.f34169c0.addView(this.f34191n0, w7.x5.n(-1, -2));
            if (this.F.translation_required) {
                org.telegram.ui.Cells.m4 m4Var3 = new org.telegram.ui.Cells.m4(context);
                this.f34184j0 = m4Var3;
                m4Var3.setText(LocaleController.getString(R.string.PassportTranslation));
                this.f34184j0.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, i15, false));
                this.f34169c0.addView(this.f34184j0, w7.x5.n(-1, -2));
                LinearLayout linearLayout4 = new LinearLayout(context);
                this.f34180h0 = linearLayout4;
                ...
                org.telegram.ui.Cells.f9 f9Var3 = new org.telegram.ui.Cells.f9(context);
                this.f34193o0 = f9Var3;
                f9Var3.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(context, R.drawable.greydivider, i13));
                if (this.f34168c != 0) {
                    this.A1 = LocaleController.getString(R.string.PassportAddTranslationUploadInfo);
                } else {
                    TLRPC.SecureValueType secureValueType = this.F.type;
                ...
                if (hashMap != null) {
                    ...
                    if (str5 != null) {
                        ...
                        spannableStringBuilder.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19008p7, false)), 0, str5.length(), 33);
                        this.f34219y1.put("translation_all", "");
                        str4 = spannableStringBuilder;
                    }
                }
                this.f34193o0.setText(str4);
                this.f34169c0.addView(this.f34193o0, w7.x5.n(-1, -2));
            }
        } else {
            j3 = 0;
            org.telegram.ui.Cells.fa faVar2 = new org.telegram.ui.Cells.fa(context);
            this.f34200r0 = faVar2;
            faVar2.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.K0(true));
            this.f34200r0.b(LocaleController.getString(R.string.PassportScanPassport), false);
            this.f34169c0.addView(this.f34200r0, w7.x5.n(-1, -2));
            this.f34200r0.setOnClickListener(new sl0(this, 5));
            org.telegram.ui.Cells.f9 f9Var4 = new org.telegram.ui.Cells.f9(context);
            this.f34191n0 = f9Var4;
            f9Var4.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(context, R.drawable.greydivider, i13));
            this.f34191n0.setText(LocaleController.getString(R.string.PassportScanPassportInfo));
            this.f34169c0.addView(this.f34191n0, w7.x5.n(-1, -2));
        }
        org.telegram.ui.Cells.m4 m4Var4 = new org.telegram.ui.Cells.m4(context);
        this.f34184j0 = m4Var4;
        ...
        int i17 = 0;
        while (true) {
            HashMap hashMap2 = this.f34204s1;
            if (i17 < i10) {
                EditTextBoldCursor editTextBoldCursor = new EditTextBoldCursor(context);
                this.Y[i17] = editTextBoldCursor;
                cm0 cm0Var = new cm0(context, editTextBoldCursor, 1);
                cm0Var.setWillNotDraw(z10);
                this.f34169c0.addView(cm0Var, w7.x5.n(i14, 64));
                int i18 = org.telegram.ui.ActionBar.h6.f18789d6;
                cm0Var.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, i18, z10));
                if (i17 == i10 - 1) {
                    View view = new View(context);
                    this.S = view;
                    view.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, i18, z10));
                    this.f34169c0.addView(this.S, w7.x5.n(i14, 6));
                }
                if (this.f34209v0 && this.F != null && i17 < i16) {
                    cm0Var.setVisibility(8);
                    View view2 = this.S;
                    if (view2 != null) {
                        view2.setVisibility(8);
                ...
                this.Y[i17].setLineColors(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18916k6, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18934l6, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19008p7, false));
                int i20 = 5;
                if (i17 != 5 && i17 != 6) {
                    if (i17 != 3 && i17 != 8) {
                        if (i17 == 4) {
                            this.Y[i17].setOnTouchListener(new tl0(this, 1));
                    ...
                    this.Y[i17].setOnTouchListener(new tl0(this, 0));
                    this.Y[i17].setInputType(0);
                }
                HashMap hashMap3 = this.f34206t1;
                switch (i17) {
                    case 0:
                ...
                if (i17 != 0 && i17 != 2 && i17 != 1) {
                    ...
                    this.Y[i17].addTextChangedListener(new gm0(this, editTextBoldCursor, str2));
                }
                ...
                cm0Var.addView(this.Y[i17], w7.x5.d(-1, -1.0f, 51, 21.0f, 0.0f, 21.0f, 0.0f));
                this.Y[i17].setOnEditorActionListener(new ql0(this, 1));
                i17++;
                r42 = 1;
                i16 = 7;
                z10 = false;
                ...
                this.f34184j0 = m4Var5;
                m4Var5.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18789d6, false));
                this.f34169c0.addView(this.f34184j0, w7.x5.n(-1, -2));
                this.f34163a0 = new EditTextBoldCursor[3];
                int i21 = 0;
                for (int i22 = 3; i21 < i22; i22 = 3) {
                    EditTextBoldCursor editTextBoldCursor5 = new EditTextBoldCursor(context);
                    this.f34163a0[i21] = editTextBoldCursor5;
                    cm0 cm0Var2 = new cm0(context, editTextBoldCursor5, 2);
                    cm0Var2.setWillNotDraw(false);
                    this.f34169c0.addView(cm0Var2, w7.x5.n(-1, 64));
                    int i23 = org.telegram.ui.ActionBar.h6.f18789d6;
                    cm0Var2.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, i23, false));
                    if (i21 == 2) {
                        View view3 = new View(context);
                        this.T = view3;
                        view3.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, i23, false));
                        this.f34169c0.addView(this.T, w7.x5.n(-1, 6));
                    }
                    this.f34163a0[i21].setTag(Integer.valueOf(i21));
                    this.f34163a0[i21].setSupportRtlHint(true);
                    this.f34163a0[i21].setTextSize(1, 16.0f);
                    this.f34163a0[i21].setHintColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.H6, false));
                    EditTextBoldCursor editTextBoldCursor6 = this.f34163a0[i21];
                    int i24 = org.telegram.ui.ActionBar.h6.G6;
                    editTextBoldCursor6.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i24, false));
                    this.f34163a0[i21].setHeaderHintColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.L6, false));
                    this.f34163a0[i21].setTransformHintToHeader(true);
                    this.f34163a0[i21].setBackgroundDrawable(null);
                    this.f34163a0[i21].setCursorColor(org.telegram.ui.ActionBar.h6.w0(null, i24, false));
                    this.f34163a0[i21].setCursorSize(AndroidUtilities.dp(20.0f));
                    this.f34163a0[i21].setCursorWidth(1.5f);
                    this.f34163a0[i21].setLineColors(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18916k6, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18934l6, false), org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f19008p7, false));
                    this.f34163a0[i21].setInputType(16385);
                    this.f34163a0[i21].setImeOptions(268435461);
                    if (i21 != 0) {
                        if (i21 != 1) {
                            if (i21 == 2) {
                    ...
                    J1(hashMap2, this.f34163a0[i21], str);
                    EditTextBoldCursor editTextBoldCursor7 = this.f34163a0[i21];
                    editTextBoldCursor7.setSelection(editTextBoldCursor7.length());
                    if (i21 == 0 || i21 == 2 || i21 == 1) {
                        this.f34163a0[i21].addTextChangedListener(new em0(this, editTextBoldCursor5, str, 1));
                    }
                    this.f34163a0[i21].setPadding(0, 0, 0, 0);
                    EditTextBoldCursor editTextBoldCursor8 = this.f34163a0[i21];
                    if (LocaleController.isRTL) {
                        i11 = 5;
                    } else {
                        i11 = 3;
                    ...
                    cm0Var2.addView(this.f34163a0[i21], w7.x5.d(-1, -1.0f, 51, 21.0f, 0.0f, 21.0f, 0.0f));
                    this.f34163a0[i21].setOnEditorActionListener(new ql0(this, 2));
                    i21++;
                }
                org.telegram.ui.Cells.f9 f9Var5 = new org.telegram.ui.Cells.f9(context);
                this.f34197q0 = f9Var5;
                this.f34169c0.addView(f9Var5, w7.x5.n(-1, -2));
                long j10 = this.f34168c;
                TLRPC.TL_secureValue tL_secureValue = this.I;
                if (((j10 != j3 || this.F == null) && this.H != null && !this.f34209v0) || tL_secureValue != null) {
                    if (tL_secureValue != null) {
                    ...
                    org.telegram.ui.Cells.f9 f9Var6 = this.f34197q0;
                    int i25 = R.drawable.greydivider;
                    int i26 = org.telegram.ui.ActionBar.h6.f18753b7;
                    f9Var6.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(context, i25, i26));
                    org.telegram.ui.Cells.a7 a7Var2 = new org.telegram.ui.Cells.a7(context, (org.telegram.ui.Cells.q3) null);
                    this.f34188l0 = a7Var2;
                    a7Var2.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(context, R.drawable.greydivider_bottom, i26));
                    this.f34169c0.addView(this.f34188l0, w7.x5.n(-1, -2));
                } else {
                    this.f34197q0.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(context, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.h6.f18753b7));
                }
                P1();
                Y0(false);
                return;
    ...
    public final void f1(android.content.Context r19) {
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.in0.f1(android.content.Context):void");
    }
    ...
    public final void g1(Context context) {
        ...
        this.f34169c0.addView(faVar, w7.x5.n(-1, -2));
        ...
        this.f34191n0.setText(LocaleController.getString(R.string.PassportPhoneUseSameInfo));
        this.f34169c0.addView(this.f34191n0, w7.x5.n(-1, -2));
        org.telegram.ui.Cells.m4 m4Var = new org.telegram.ui.Cells.m4(context);
        this.f34184j0 = m4Var;
        ...
        for (int i11 = 0; i11 < 3; i11++) {
            ...
            if (i11 == 1) {
                ...
                this.f34169c0.addView(frameLayout, w7.x5.n(-1, 50));
                frameLayout.setBackgroundColor(org.telegram.ui.ActionBar.h6.w0(null, org.telegram.ui.ActionBar.h6.f18789d6, false));
            } else if (i11 == 2) {
            ...
            if (i11 == 0) {
                this.Y[i11].setOnTouchListener(new tl0(this, 3));
            ...
            if (i11 == 1) {
                ...
                this.f34212w0 = textView;
                textView.setText("+");
                this.f34212w0.setTextColor(org.telegram.ui.ActionBar.h6.w0(null, i12, false));
                this.f34212w0.setTextSize(1, 16.0f);
                frameLayout.addView(this.f34212w0, w7.x5.k(21.0f, 12.0f, 0.0f, 6.0f, -2, -2));
                ...
                this.Y[i11].addTextChangedListener(new vm0(this));
            } else if (i11 == 2) {
                ...
                this.Y[i11].addTextChangedListener(new yr(this, 3));
            } else {
            ...
            this.Y[i11].setOnEditorActionListener(new ql0(this, 0));
            if (i11 == 2) {
                this.Y[i11].setOnKeyListener(new tg(this, 1));
            }
            if (i11 == 0) {
                View view = new View(context);
                this.f34186k0.add(view);
        ...
        org.telegram.ui.Cells.f9 f9Var2 = new org.telegram.ui.Cells.f9(context);
        this.f34191n0 = f9Var2;
        f9Var2.setBackgroundDrawable(org.telegram.ui.ActionBar.h6.V0(context, R.drawable.greydivider_bottom, org.telegram.ui.ActionBar.h6.f18753b7));
        this.f34191n0.setText(LocaleController.getString(R.string.PassportPhoneUploadInfo));
        this.f34169c0.addView(this.f34191n0, w7.x5.n(-1, -2));
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34166b0, 32768, null, null, null, null, i10));
        ...
        int i11 = 0;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34169c0, 0, new Class[]{View.class}, org.telegram.ui.ActionBar.h6.f18910k0, null, null, org.telegram.ui.ActionBar.h6.f18790d7));
        View view = this.S;
        int i12 = org.telegram.ui.ActionBar.h6.f18789d6;
        ...
        int i13 = 0;
        while (true) {
            ArrayList arrayList2 = this.f34186k0;
            if (i13 >= arrayList2.size()) {
                break;
            }
            arrayList.add(new org.telegram.ui.ActionBar.j6((View) arrayList2.get(i13), 1, null, null, null, null, org.telegram.ui.ActionBar.h6.f18790d7));
            i13++;
        }
        for (Map.Entry entry : this.f34192n1.entrySet()) {
            gn0 gn0Var = (gn0) entry.getValue();
            arrayList.add(new org.telegram.ui.ActionBar.j6(gn0Var, 268435456, new Class[]{gn0.class}, null, null, null, org.telegram.ui.ActionBar.h6.f18789d6));
            ...
            arrayList.add(new org.telegram.ui.ActionBar.j6(gn0Var, 0, new Class[]{gn0.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.f19189z6));
        }
        int i14 = org.telegram.ui.ActionBar.h6.f18789d6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34169c0, 268435456, new Class[]{org.telegram.ui.Cells.e9.class}, null, null, null, i14));
        int i15 = org.telegram.ui.ActionBar.h6.G6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34169c0, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"textView"}, null, null, -1, null, i15));
        int i16 = org.telegram.ui.ActionBar.h6.f19189z6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34169c0, 0, new Class[]{org.telegram.ui.Cells.e9.class}, new String[]{"valueTextView"}, null, null, -1, null, i16));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34169c0, 268435456, new Class[]{org.telegram.ui.Cells.fa.class}, null, null, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34169c0, 0, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"textView"}, null, null, -1, null, i15));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34169c0, 0, new Class[]{org.telegram.ui.Cells.fa.class}, new String[]{"valueTextView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.I6));
        int i17 = org.telegram.ui.ActionBar.h6.f18753b7;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34169c0, 32, new Class[]{org.telegram.ui.Cells.a7.class}, null, null, null, i17));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34169c0, 268435456, new Class[]{hn0.class}, null, null, null, i14));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34169c0, 4, new Class[]{hn0.class}, new String[]{"textView"}, null, null, -1, null, i15));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34169c0, 4, new Class[]{hn0.class}, null, null, null, org.telegram.ui.ActionBar.h6.f18790d7));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34169c0, 4, new Class[]{hn0.class}, new String[]{"valueTextView"}, null, null, -1, null, i16));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34169c0, 8, new Class[]{hn0.class}, new String[]{"checkImageView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.Mh));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34169c0, 16, new Class[]{org.telegram.ui.Cells.m4.class}, null, null, null, i14));
        int i18 = org.telegram.ui.ActionBar.h6.L6;
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34169c0, 0, new Class[]{org.telegram.ui.Cells.m4.class}, new String[]{"textView"}, null, null, -1, null, i18));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34169c0, 32, new Class[]{org.telegram.ui.Cells.f9.class}, null, null, null, i17));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34169c0, 0, new Class[]{org.telegram.ui.Cells.f9.class}, new String[]{"textView"}, null, null, -1, null, org.telegram.ui.ActionBar.h6.B6));
        if (this.Y != null) {
            int i19 = 0;
            while (true) {
                EditTextBoldCursor[] editTextBoldCursorArr = this.Y;
                ...
                arrayList.add(new org.telegram.ui.ActionBar.j6((View) editTextBoldCursorArr[i19].getParent(), 1, null, null, null, null, org.telegram.ui.ActionBar.h6.f18789d6));
                ...
                arrayList.add(new org.telegram.ui.ActionBar.j6(this.Y[i19], 32, null, null, null, null, org.telegram.ui.ActionBar.h6.f18916k6));
                arrayList.add(new org.telegram.ui.ActionBar.j6(this.Y[i19], 65568, null, null, null, null, org.telegram.ui.ActionBar.h6.f18934l6));
                arrayList.add(new org.telegram.ui.ActionBar.j6(this.Y[i19], 2080, null, null, null, null, org.telegram.ui.ActionBar.h6.f19008p7));
                i19++;
            }
        } else {
            ...
            arrayList.add(new org.telegram.ui.ActionBar.j6(null, 32, null, null, null, null, org.telegram.ui.ActionBar.h6.f18916k6));
            arrayList.add(new org.telegram.ui.ActionBar.j6(null, 65568, null, null, null, null, org.telegram.ui.ActionBar.h6.f18934l6));
            arrayList.add(new org.telegram.ui.ActionBar.j6(null, 2080, null, null, null, null, org.telegram.ui.ActionBar.h6.f19008p7));
        }
        if (this.f34163a0 != null) {
            while (true) {
                EditTextBoldCursor[] editTextBoldCursorArr2 = this.f34163a0;
                ...
                arrayList.add(new org.telegram.ui.ActionBar.j6((View) editTextBoldCursorArr2[i11].getParent(), 1, null, null, null, null, org.telegram.ui.ActionBar.h6.f18789d6));
                arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34163a0[i11], 16777220, null, null, null, null, org.telegram.ui.ActionBar.h6.G6));
                arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34163a0[i11], 8388608, null, null, null, null, org.telegram.ui.ActionBar.h6.H6));
                arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34163a0[i11], 8390656, null, null, null, null, org.telegram.ui.ActionBar.h6.L6));
                arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34163a0[i11], 32, null, null, null, null, org.telegram.ui.ActionBar.h6.f18916k6));
                arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34163a0[i11], 65568, null, null, null, null, org.telegram.ui.ActionBar.h6.f18934l6));
                arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34163a0[i11], 2080, null, null, null, null, org.telegram.ui.ActionBar.h6.f19008p7));
                i11++;
            }
        }
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.F0, 2048, null, null, null, null, org.telegram.ui.ActionBar.h6.f18860h6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.K0, 4, null, null, null, null, org.telegram.ui.ActionBar.h6.f19044r6));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.f34212w0, 4, null, null, null, null, org.telegram.ui.ActionBar.h6.G6));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.O, 4, null, null, null, null, org.telegram.ui.ActionBar.h6.f19092th));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.Q, 32, null, null, null, null, org.telegram.ui.ActionBar.h6.f19055rh));
        arrayList.add(new org.telegram.ui.ActionBar.j6(this.Q, 65568, null, null, null, null, org.telegram.ui.ActionBar.h6.f19074sh));
        org.telegram.ui.Components.uq uqVar = this.N;
        ...
        int i23 = org.telegram.ui.ActionBar.h6.f19189z6;
    ...
    public final byte[] i1(byte[] bArr, byte[] bArr2) {
        ...
        byte[] bArr3 = new byte[32];
        System.arraycopy(this.f34174e1, 0, bArr3, 0, 32);
        byte[] bArr4 = new byte[16];
        System.arraycopy(this.f34174e1, 32, bArr4, 0, 16);
        byte[] bArr5 = new byte[32];
        System.arraycopy(this.f34170c1, 0, bArr5, 0, 32);
            ...
            public final void run(TLObject tLObject, final TLRPC.TL_error tL_error) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    public final void run() {
                        ...
                        int i11 = 0;
                        if (in0Var2.f34165b == 8) {
                            hn0 hn0Var = (hn0) in0Var2.f34198q1.remove(tL_secureRequiredType6);
                            if (hn0Var != null) {
                                in0Var2.f34169c0.removeView(hn0Var);
                                View childAt = in0Var2.f34169c0.getChildAt(linearLayout.getChildCount() - 6);
                                    ...
                                    if (i12 < size) {
                                        ...
                                        if (r12 != null) {
                                            ...
                                            if (tL_secureData2 != null) {
                                                str2 = in0.h1(tL_secureData2.data, in0Var2.i1(tL_secureData2.secret, tL_secureData2.data_hash), r12.data.data_hash);
                                            } else {
                                                str2 = null;
                                            }
                                            str = str2;
                            ...
                            if (z15) {
                                ...
                                in0Var2.L1(tL_secureRequiredType6, null, null, tL_secureRequiredType5, str, z14, i11);
                            } else {
                                ...
                                if (r13 != null && (tL_secureData = r13.data) != null) {
                                    str3 = in0.h1(tL_secureData.data, in0Var2.i1(tL_secureData.secret, tL_secureData.data_hash), r13.data.data_hash);
                                }
                                if (arrayList3 != null) {
                                    i10 = arrayList3.size();
                                } else {
                                ...
                                in0Var2.L1(tL_secureRequiredType6, null, str3, tL_secureRequiredType8, str4, z14, i10);
                            }
                        }
    ...
    public final cf.c k1(byte[] bArr) {
        ...
        byte[] bArr6 = new byte[32];
        System.arraycopy(this.f34174e1, 0, bArr6, 0, 32);
        byte[] bArr7 = new byte[16];
        System.arraycopy(this.f34174e1, 32, bArr7, 0, 16);
        byte[] bArr8 = new byte[32];
        System.arraycopy(this.f34170c1, 0, bArr8, 0, 32);
        Utilities.aesCbcEncryptionByteArraySafe(bArr8, bArr6, bArr7, 0, 32, 0, 0);
    ...
    public final String m1() {
        ...
        int size = arrayList.size();
        for (int i12 = 0; i12 < size; i12++) {
            sb2.append(((SecureDocument) arrayList.get(i12)).secureFile.f18218id);
        }
        SecureDocument secureDocument = this.l1;
        if (secureDocument != null) {
            sb2.append(secureDocument.secureFile.f18218id);
        }
        SecureDocument secureDocument2 = this.f34189m1;
        if (secureDocument2 != null) {
            sb2.append(secureDocument2.secureFile.f18218id);
        }
        SecureDocument secureDocument3 = this.f34185j1;
        if (secureDocument3 != null) {
            sb2.append(secureDocument3.secureFile.f18218id);
        }
        ArrayList arrayList2 = this.f34187k1;
        int size2 = arrayList2.size();
        for (int i13 = 0; i13 < size2; i13++) {
            sb2.append(((SecureDocument) arrayList2.get(i13)).secureFile.f18218id);
        }
        return sb2.toString();
    }
    ...
    public final void onActivityResultFragment(int i10, int i11, Intent intent) {
        if (i11 == -1) {
            ...
            org.telegram.ui.Components.wi wiVar = this.R0;
            if (wiVar != null) {
                wiVar.f29677j0.g0(i10, intent, this.Q0);
            }
            this.Q0 = null;
        }
    }
    ...
    public final void onDialogDismiss(Dialog dialog) {
        if (this.f34165b == 3 && Build.VERSION.SDK_INT >= 23 && dialog == this.L1) {
    ...
    public final void onRequestPermissionsResultFragment(int i10, String[] strArr, int[] iArr) {
        ...
        if ((i11 == 1 || i11 == 2) && (wiVar = this.R0) != null) {
            if (i10 == 17) {
                ...
                F1(0);
            } else if (i10 == 22 && iArr != null && iArr.length > 0 && iArr[0] == 0 && (faVar = this.f34200r0) != null) {
                faVar.callOnClick();
            }
        } else if (i11 == 3 && i10 == 6) {
    ...
    public final void onResume() {
        ...
        if (this.f34165b == 5 && (viewGroupArr = this.Z) != null && (viewGroup = viewGroupArr[0]) != null && viewGroup.getVisibility() == 0) {
    ...
    public final TLRPC.TL_secureValue r1(TLRPC.TL_secureRequiredType tL_secureRequiredType, boolean z10) {
        ...
        if (tL_secureRequiredType != null) {
            int size = this.f34217y.values.size();
            for (int i10 = 0; i10 < size; i10++) {
                TLRPC.TL_secureValue tL_secureValue = this.f34217y.values.get(i10);
    ...
    public final boolean s1(Class cls) {
        int size = this.f34217y.values.size();
        for (int i10 = 0; i10 < size; i10++) {
            if (this.f34217y.values.get(i10).type.getClass() == cls) {
                return false;
            }
        }
        return true;
    ...
    public in0(int i10, long j3, String str, String str2, String str3, String str4, String str5, TL_account.authorizationForm authorizationform, TL_account.Password password) {
        ...
        try {
            ...
            while (i12 < size) {
                ...
                HashMap hashMap = (HashMap) this.f34208u1.get(o12);
                if (hashMap == null) {
                    hashMap = new HashMap();
                    i11 = size;
                    this.f34208u1.put(o12, hashMap);
                    this.f34210v1.put(o12, str6);
                } else {
                    i11 = size;
                }
                if (bArr != null) {
