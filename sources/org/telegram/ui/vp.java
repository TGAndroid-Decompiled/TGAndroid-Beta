...
public final class vp implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int f39144a;
    public final int[] f39145a0;
    public int f39146b;
    public final int f39147b0;
    public int f39148c;
    public final int f39149c0;
    public float d;
    public final int f39150d0;
    public final Paint e;
    public final long f39151e0;
    public final TextPaint f39152f;
    public final long f39153f0;
    public final org.telegram.ui.ActionBar.f6 f39154g0;
    public final TextPaint h;
    public org.telegram.ui.Components.l5 f39155h0;
    public final Paint f39156n;
    public final Path f39157r;
    public StaticLayout f39158s;
    public StaticLayout v;
    public StaticLayout f39159w;
    public int f39160x;
    public int f39161y;
    ...
    public static TLRPC.Dialog c(long j10, int i10, int i11, boolean z4, int[] iArr) {
        ...
        if (dialogs != null) {
            for (int i13 = 0; i13 < dialogs.size(); i13++) {
                ...
                TLRPC.Chat chat = messagesController.getChat(Long.valueOf(-dialog.f19163id));
                if (chat != null && dialog.f19163id != j10 && dialog.unread_count > 0 && DialogObject.isChannel(dialog) && !chat.megagroup && !messagesController.isPromoDialog(dialog.f19163id, false) && messagesController.getRestrictionReason(chat.restriction_reason) == null) {
                    return dialog;
                }
            }
            if (z4) {
                if (i11 != 0) {
                    ...
                    while (i14 < messagesController.dialogFilters.size()) {
                        int i15 = messagesController.dialogFilters.get(i14).f16649id;
                        if (i11 != i15) {
                            long j12 = j10;
                            int i16 = i10;
                            int[] iArr3 = iArr;
    ...
    public final void a(Canvas canvas, sj sjVar, float f10, float f11) {
        ...
        if (this.X != sjVar) {
            this.X = sjVar;
            org.telegram.ui.Components.l5 l5Var = this.f39155h0;
            if (l5Var != null) {
                l5Var.a(sjVar);
            }
        }
        ...
        org.telegram.ui.ActionBar.j6.q(0.0f, sjVar.getMeasuredHeight() - dp, this.f39148c, sjVar.getMeasuredHeight());
        int i17 = org.telegram.ui.ActionBar.j6.ic;
        org.telegram.ui.ActionBar.f6 f6Var = this.f39154g0;
        int v02 = org.telegram.ui.ActionBar.j6.v0(i17, f6Var);
        TextPaint textPaint3 = this.f39152f;
        ...
        int alpha2 = org.telegram.ui.ActionBar.j6.f19949h2.getAlpha();
        int alpha3 = textPaint3.getAlpha();
        int alpha4 = paint2.getAlpha();
        org.telegram.ui.ActionBar.j6.f19949h2.setAlpha((int) (alpha2 * f12));
        ...
        if (f29 >= 1.0f && !this.O) {
            ...
            if (this.T) {
                ...
                if (a13) {
                    canvas2.drawPath(path, org.telegram.ui.ActionBar.j6.f19949h2);
                }
            } else {
                f16 = f30;
                sqVar = sqVar2;
                ...
                if (a12) {
                    int alpha6 = org.telegram.ui.ActionBar.j6.f19949h2.getAlpha();
                    org.telegram.ui.ActionBar.j6.f19949h2.setAlpha((int) (alpha6 * f15));
                    float f41 = this.d;
                    canvas2.drawRoundRect(rectF4, f41, f41, org.telegram.ui.ActionBar.j6.f19949h2);
                    org.telegram.ui.ActionBar.j6.f19949h2.setAlpha(alpha6);
                }
            }
        ...
        if (this.f39158s != null && this.H > 0.0f) {
            ...
            float f50 = (i16 - this.f39160x) / 2.0f;
            rectF5.set(f50, dp13, this.f39148c - f50, this.f39158s.getHeight() + dp13);
            ...
            if (a14) {
                canvas2.drawRoundRect(rectF5, AndroidUtilities.dp(15.0f), AndroidUtilities.dp(15.0f), org.telegram.ui.ActionBar.j6.f19949h2);
            }
            canvas2.save();
            canvas2.translate((this.f39148c - this.f39160x) / 2.0f, dp13);
            this.f39158s.draw(canvas2);
            canvas2.restore();
        } else {
            textPaint2 = textPaint;
        }
        if (!this.O && f17 > 0.0f) {
            ...
            org.telegram.ui.Components.l5 l5Var2 = this.f39155h0;
            if (l5Var2 == null || (imageReceiver = l5Var2.f26587k) == null) {
            ...
            if (this.U && imageReceiver2.getDrawable() != null && (imageReceiver2.getDrawable() instanceof org.telegram.ui.Components.mq) && (((org.telegram.ui.Components.mq) imageReceiver2.getDrawable()).f27110b instanceof org.telegram.ui.Components.n80)) {
                ((org.telegram.ui.Components.n80) ((org.telegram.ui.Components.mq) imageReceiver2.getDrawable()).f27110b).f27229i = f10;
            }
            if (this.H > 0.0f && this.Y) {
                ...
                sqVar3.e(sqVar3.f28790s);
                canvas2.scale(f53, f53, (sqVar3.f28790s / 2.0f) + sqVar3.A + AndroidUtilities.dp(12.0f) + f19, (A2 - AndroidUtilities.dp(6.0f)) + AndroidUtilities.dp(14.0f));
                canvas2.translate(AndroidUtilities.dp(12.0f) + f19, A2 - AndroidUtilities.dp(6.0f));
                float f54 = sqVar3.C;
                float f55 = sqVar3.f28783l;
                if (f55 != 1.0f) {
                    f24 = 6.0f;
                    int i22 = sqVar3.f28777c;
                    if (i22 == 0 || i22 == 1) {
                        rectF2 = rectF;
                        f25 = 14.0f;
                        sqVar3.e(sqVar3.f28790s);
                        float dp14 = (sqVar3.f28794x - AndroidUtilities.dp(f54 * 2.0f)) / 2.0f;
                        float f56 = sqVar3.B;
                        rectF2.set(f56, dp14, sqVar3.f28790s + f56 + AndroidUtilities.dp(11.0f), AndroidUtilities.dp(23.0f) + dp14);
                    } else {
                        float f57 = f55 * 2.0f;
                        if (f57 > 1.0f) {
                            f57 = 1.0f;
                        }
                        float dp15 = (sqVar3.f28794x - AndroidUtilities.dp(f54 * 2.0f)) / 2.0f;
                        int i23 = sqVar3.f28790s;
                        int i24 = sqVar3.f28789r;
                        if (i23 == i24) {
                            w10 = i23;
                            f25 = 14.0f;
                        } else {
                    ...
                    f25 = 14.0f;
                    sqVar3.e(sqVar3.f28790s);
                    float dp16 = (sqVar3.f28794x - AndroidUtilities.dp(f54 * 2.0f)) / 2.0f;
                    float f59 = sqVar3.B;
                    rectF2.set(f59, dp16, sqVar3.f28790s + f59 + AndroidUtilities.dp(11.0f), AndroidUtilities.dp(23.0f) + dp16);
                }
                rectF2.inset(-AndroidUtilities.dp(2.0f), -AndroidUtilities.dp(2.0f));
                canvas2.drawRoundRect(rectF2, rectF2.height() / 2.0f, rectF2.height() / 2.0f, this.f39156n);
                canvas2.restore();
                canvas2.save();
                float f60 = this.H;
                sqVar3.e(sqVar3.f28790s);
                canvas2.scale(f60, f60, (sqVar3.f28790s / 2.0f) + sqVar3.A + AndroidUtilities.dp(12.0f) + f19, (A2 - AndroidUtilities.dp(f24)) + AndroidUtilities.dp(f25));
        ...
        org.telegram.ui.ActionBar.j6.f19949h2.setAlpha(i12);
        textPaint2.setAlpha(alpha3);
        paint.setAlpha(alpha4);
    }

    public final void b(Canvas canvas, int i10, int i11) {
        int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Xk, this.f39154g0);
        ...
        if (this.v != null) {
            ...
            if (f10 < 1.0f) {
                ...
                canvas.save();
                canvas.translate((this.f39148c - this.f39161y) / 2.0f, height);
                this.v.draw(canvas);
                canvas.restore();
            }
        }
        if (this.f39159w != null) {
            float f11 = this.H;
            if (f11 > 0.0f) {
                textPaint.setAlpha((int) (alpha2 * f11 * this.P));
                float dp = ((1.0f - this.H) * AndroidUtilities.dp(10.0f)) + (((i11 - i10) - this.f39159w.getHeight()) / 2.0f) + i10;
                canvas.save();
                canvas.translate((this.f39148c - this.B) / 2.0f, dp);
                this.f39159w.draw(canvas);
                canvas.restore();
            }
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        TLRPC.Dialog dialog;
        if (this.W != 0 && (dialog = (TLRPC.Dialog) MessagesController.getInstance(this.f39147b0).dialogs_dict.f(this.W)) != null) {
    ...
    public final void f() {
        ...
        NotificationCenter.getInstance(this.f39147b0).addObserver(this, NotificationCenter.updateInterfaces);
    }
    ...
    public final void g(final View view, boolean z4) {
        ...
        if (z4) {
            ...
            org.telegram.ui.Components.mr mrVar = org.telegram.ui.Components.mr.f27125j;
        ...
        ofFloat5.setInterpolator(org.telegram.ui.Components.mr.f27122f);
    ...
    public final void h() {
        ...
        this.S = false;
        this.E = null;
        TLRPC.Dialog c3 = c(this.f39153f0, this.f39149c0, this.f39150d0, true, this.f39145a0);
        if (c3 != null) {
            this.W = c3.f19163id;
            int[] iArr = this.f39145a0;
            if (iArr[0] == 1) {
                z4 = true;
            } else {
                z4 = false;
            ...
            this.f39146b = iArr[2];
            this.O = false;
            int i10 = this.f39147b0;
            TLRPC.Chat chat = MessagesController.getInstance(i10).getChat(Long.valueOf(-c3.f19163id));
            this.D = chat;
            if (chat == null) {
                this.D = MessagesController.getInstance(i10).getChat(Long.valueOf(c3.f19163id));
            }
            ...
            MessagesController.getInstance(i10).ensureMessagesLoaded(c3.f19163id, 0, null);
    ...
    public final void i(TLRPC.Chat chat) {
        ...
        int i11 = this.f39147b0;
        z8Var.k(i11, chat2);
        this.C.setImage(ImageLocation.getForChat(this.D, 1), "50_50", z8Var, null, UserConfig.getInstance(0).getCurrentUser(), 0);
        MessagesController.getInstance(i11).ensureMessagesLoaded(-chat.f19159id, 0, null);
        TLRPC.Dialog dialog = MessagesController.getInstance(i11).getDialog(-chat.f19159id);
        if (dialog == null) {
            i10 = 0;
        } else {
    ...
    public final void j() {
        ...
        int i10 = this.f39147b0;
        ArrayList<TLRPC.TL_forumTopic> topics = MessagesController.getInstance(i10).getTopicsController().getTopics(-this.f39153f0);
        if (topics != null && topics.size() > 1) {
            tL_forumTopic = null;
            for (int i11 = 0; i11 < topics.size(); i11++) {
                TLRPC.TL_forumTopic tL_forumTopic2 = topics.get(i11);
                if (tL_forumTopic2.f19211id != this.f39151e0 && !tL_forumTopic2.hidden && tL_forumTopic2.unread_count > 0 && (tL_forumTopic == null || ((message = tL_forumTopic2.topMessage) != null && (message2 = tL_forumTopic.topMessage) != null && message.date > message2.date))) {
        ...
        if (tL_forumTopic != null) {
            ...
            int i12 = tL_forumTopic.f19211id;
            org.telegram.ui.ActionBar.f6 f6Var = this.f39154g0;
            if (i12 == 1) {
                View view3 = this.X;
                if (view3 != null && (l5Var2 = this.f39155h0) != null) {
                    l5Var2.o(view3);
                }
                this.f39155h0 = null;
                ...
                org.telegram.ui.Components.l5 l5Var3 = this.f39155h0;
                if (l5Var3 == null || l5Var3.i() != tL_forumTopic.icon_emoji_id) {
                    org.telegram.ui.Components.l5 l5Var4 = this.f39155h0;
                ...
                org.telegram.ui.Components.l5 l5Var6 = this.f39155h0;
                ...
                View view4 = this.X;
                if (view4 != null && (l5Var = this.f39155h0) != null) {
                    l5Var.o(view4);
                }
                this.f39155h0 = null;
