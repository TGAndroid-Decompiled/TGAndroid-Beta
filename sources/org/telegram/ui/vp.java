...
public final class vp implements NotificationCenter.NotificationCenterDelegate {
    ...
    public long Z;
    public int f38442a;
    public View f38443a0;
    public int f38444b;
    public boolean f38445b0;
    public int f38446c;
    public final org.telegram.ui.Components.wq f38447c0;
    public float d;
    public final int[] f38448d0;
    public final Paint e;
    public final int f38449e0;
    public final TextPaint f38450f;
    public final int f38451f0;
    public final int f38452g0;
    public final TextPaint h;
    public final long f38453h0;
    public final long f38454i0;
    public final org.telegram.ui.ActionBar.d6 f38455j0;
    public org.telegram.ui.Components.q5 f38456k0;
    public final Paint f38457n;
    public final Path f38458r;
    public StaticLayout f38459s;
    public StaticLayout v;
    public StaticLayout f38460w;
    public int f38461x;
    public int f38462y;
    ...
    public static TLRPC.Dialog c(long j3, int i10, int i11, boolean z10, int[] iArr) {
        ...
        if (dialogs != null) {
            for (int i13 = 0; i13 < dialogs.size(); i13++) {
                ...
                TLRPC.Chat chat = messagesController.getChat(Long.valueOf(-dialog.f18087id));
                if (chat != null && dialog.f18087id != j3 && dialog.unread_count > 0 && DialogObject.isChannel(dialog) && !chat.megagroup && !messagesController.isPromoDialog(dialog.f18087id, false) && messagesController.getRestrictionReason(chat.restriction_reason) == null) {
                    return dialog;
                }
            }
            if (z10) {
                if (i11 != 0) {
                    ...
                    while (i14 < messagesController.dialogFilters.size()) {
                        int i15 = messagesController.dialogFilters.get(i14).f15577id;
                        if (i11 != i15) {
                            long j11 = j3;
                            int i16 = i10;
                            int[] iArr3 = iArr;
    ...
    public final void a(Canvas canvas, rj rjVar, float f7, float f10) {
        ...
        if (this.f38443a0 != rjVar) {
            this.f38443a0 = rjVar;
            org.telegram.ui.Components.q5 q5Var = this.f38456k0;
            if (q5Var != null) {
                q5Var.a(rjVar);
            }
        }
        org.telegram.ui.Components.wq wqVar2 = this.f38447c0;
        wqVar2.H = rjVar;
        RectF rectF3 = wqVar2.f29775f;
        ...
        org.telegram.ui.ActionBar.h6.q(0.0f, rjVar.getMeasuredHeight() - dp, this.f38446c, rjVar.getMeasuredHeight());
        int i17 = org.telegram.ui.ActionBar.h6.f18884ic;
        org.telegram.ui.ActionBar.d6 d6Var = this.f38455j0;
        int v02 = org.telegram.ui.ActionBar.h6.v0(i17, d6Var);
        TextPaint textPaint3 = this.f38450f;
        ...
        org.telegram.ui.ActionBar.h6.f18856h2.setAlpha((int) (alpha2 * f11));
        ...
        if (f28 >= 1.0f && !this.R) {
            ...
            if (this.W) {
                ...
                if (a12) {
                    int alpha6 = org.telegram.ui.ActionBar.h6.f18856h2.getAlpha();
                    org.telegram.ui.ActionBar.h6.f18856h2.setAlpha((int) (alpha6 * f14));
                    float f40 = this.d;
                    canvas2.drawRoundRect(rectF4, f40, f40, org.telegram.ui.ActionBar.h6.f18856h2);
                    org.telegram.ui.ActionBar.h6.f18856h2.setAlpha(alpha6);
                }
            }
        ...
        if (this.f38459s != null && this.K > 0.0f) {
            ...
            float f49 = (i16 - this.f38461x) / 2.0f;
            rectF5.set(f49, dp13, this.f38446c - f49, this.f38459s.getHeight() + dp13);
            ...
            if (a14) {
                canvas2.drawRoundRect(rectF5, AndroidUtilities.dp(15.0f), AndroidUtilities.dp(15.0f), org.telegram.ui.ActionBar.h6.f18856h2);
            }
            canvas2.save();
            canvas2.translate((this.f38446c - this.f38461x) / 2.0f, dp13);
            this.f38459s.draw(canvas2);
            canvas2.restore();
        } else {
            textPaint2 = textPaint;
        }
        if (!this.R && f16 > 0.0f) {
            ...
            org.telegram.ui.Components.q5 q5Var2 = this.f38456k0;
            if (q5Var2 == null || (imageReceiver = q5Var2.f27230k) == null) {
            ...
            if (this.X && imageReceiver2.getDrawable() != null && (imageReceiver2.getDrawable() instanceof org.telegram.ui.Components.qq) && (((org.telegram.ui.Components.qq) imageReceiver2.getDrawable()).f27425b instanceof org.telegram.ui.Components.m80)) {
                ((org.telegram.ui.Components.m80) ((org.telegram.ui.Components.qq) imageReceiver2.getDrawable()).f27425b).f26140i = f7;
            }
            if (this.K > 0.0f && this.f38445b0) {
                ...
                wqVar3.e(wqVar3.f29787s);
                canvas2.scale(f52, f52, (wqVar3.f29787s / 2.0f) + wqVar3.A + AndroidUtilities.dp(12.0f) + f18, (a10 - AndroidUtilities.dp(6.0f)) + AndroidUtilities.dp(14.0f));
                canvas2.translate(AndroidUtilities.dp(12.0f) + f18, a10 - AndroidUtilities.dp(6.0f));
                float f53 = wqVar3.C;
                float f54 = wqVar3.f29780l;
                if (f54 != 1.0f) {
                    f23 = 6.0f;
                    int i22 = wqVar3.f29774c;
                    if (i22 == 0 || i22 == 1) {
                        rectF2 = rectF;
                        f24 = 14.0f;
                        wqVar3.e(wqVar3.f29787s);
                        float dp14 = (wqVar3.f29791x - AndroidUtilities.dp(f53 * 2.0f)) / 2.0f;
                        float f55 = wqVar3.B;
                        rectF2.set(f55, dp14, wqVar3.f29787s + f55 + AndroidUtilities.dp(11.0f), AndroidUtilities.dp(23.0f) + dp14);
                    } else {
                        float f56 = f54 * 2.0f;
                        if (f56 > 1.0f) {
                            f56 = 1.0f;
                        }
                        float dp15 = (wqVar3.f29791x - AndroidUtilities.dp(f53 * 2.0f)) / 2.0f;
                        int i23 = wqVar3.f29787s;
                        int i24 = wqVar3.f29786r;
                        if (i23 == i24) {
                            z10 = i23;
                            f24 = 14.0f;
                        } else {
                    ...
                    f24 = 14.0f;
                    wqVar3.e(wqVar3.f29787s);
                    float dp16 = (wqVar3.f29791x - AndroidUtilities.dp(f53 * 2.0f)) / 2.0f;
                    float f58 = wqVar3.B;
                    rectF2.set(f58, dp16, wqVar3.f29787s + f58 + AndroidUtilities.dp(11.0f), AndroidUtilities.dp(23.0f) + dp16);
                }
                rectF2.inset(-AndroidUtilities.dp(2.0f), -AndroidUtilities.dp(2.0f));
                canvas2.drawRoundRect(rectF2, rectF2.height() / 2.0f, rectF2.height() / 2.0f, this.f38457n);
                canvas2.restore();
                canvas2.save();
                float f59 = this.K;
                wqVar3.e(wqVar3.f29787s);
                canvas2.scale(f59, f59, (wqVar3.f29787s / 2.0f) + wqVar3.A + AndroidUtilities.dp(12.0f) + f18, (a10 - AndroidUtilities.dp(f23)) + AndroidUtilities.dp(f24));
        ...
        org.telegram.ui.ActionBar.h6.f18856h2.setAlpha(i12);
        textPaint2.setAlpha(alpha3);
        paint.setAlpha(alpha4);
    }

    public final void b(Canvas canvas, int i10, int i11) {
        int v02 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Xk, this.f38455j0);
        ...
        if (this.v != null) {
            ...
            if (f7 < 1.0f) {
                ...
                canvas.save();
                canvas.translate((this.f38446c - this.f38462y) / 2.0f, height);
                this.v.draw(canvas);
                canvas.restore();
            }
        }
        if (this.f38460w != null) {
            float f10 = this.K;
            if (f10 > 0.0f) {
                textPaint.setAlpha((int) (alpha2 * f10 * this.S));
                float dp = ((1.0f - this.K) * AndroidUtilities.dp(10.0f)) + (((i11 - i10) - this.f38460w.getHeight()) / 2.0f) + i10;
                canvas.save();
                canvas.translate((this.f38446c - this.E) / 2.0f, dp);
                this.f38460w.draw(canvas);
                canvas.restore();
            }
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        TLRPC.Dialog dialog;
        if (this.Z != 0 && (dialog = (TLRPC.Dialog) MessagesController.getInstance(this.f38449e0).dialogs_dict.f(this.Z)) != null) {
            int i12 = dialog.unread_count;
            boolean z10 = true;
            this.f38447c0.c(i12, true);
            if (i12 <= 0) {
                z10 = false;
            }
            this.f38445b0 = z10;
            View view = this.f38443a0;
            if (view != null) {
                view.invalidate();
            }
        }
    ...
    public final void f() {
        ...
        org.telegram.ui.Components.q5 q5Var = this.f38456k0;
        if (q5Var != null && (view = this.f38443a0) != null) {
            q5Var.a(view);
        }
        NotificationCenter.getInstance(this.f38449e0).addObserver(this, NotificationCenter.updateInterfaces);
    }
    ...
    public final void g(final View view, boolean z10) {
        ...
        if (z10) {
            ...
            org.telegram.ui.Components.rr rrVar = org.telegram.ui.Components.rr.f27704j;
        ...
        ofFloat5.setInterpolator(org.telegram.ui.Components.rr.f27701f);
    ...
    public final void h() {
        ...
        this.V = false;
        this.H = null;
        TLRPC.Dialog c10 = c(this.f38454i0, this.f38451f0, this.f38452g0, true, this.f38448d0);
        if (c10 != null) {
            this.Z = c10.f18087id;
            int[] iArr = this.f38448d0;
            if (iArr[0] == 1) {
                z10 = true;
            } else {
                z10 = false;
            ...
            this.f38444b = iArr[2];
            this.R = false;
            int i10 = this.f38449e0;
            TLRPC.Chat chat = MessagesController.getInstance(i10).getChat(Long.valueOf(-c10.f18087id));
            this.G = chat;
            if (chat == null) {
                this.G = MessagesController.getInstance(i10).getChat(Long.valueOf(c10.f18087id));
            }
            ...
            MessagesController.getInstance(i10).ensureMessagesLoaded(c10.f18087id, 0, null);
            int i11 = c10.unread_count;
            this.f38447c0.c(i11, false);
            if (i11 > 0) {
                z11 = true;
            }
            this.f38445b0 = z11;
    ...
    public final void i(TLRPC.Chat chat) {
        ...
        int i11 = this.f38449e0;
        h9Var.k(i11, chat2);
        this.F.setImage(ImageLocation.getForChat(this.G, 1), "50_50", h9Var, null, UserConfig.getInstance(0).getCurrentUser(), 0);
        MessagesController.getInstance(i11).ensureMessagesLoaded(-chat.f18083id, 0, null);
        TLRPC.Dialog dialog = MessagesController.getInstance(i11).getDialog(-chat.f18083id);
        if (dialog == null) {
            i10 = 0;
        } else {
            i10 = dialog.unread_count;
        }
        this.f38447c0.c(i10, false);
        if (i10 > 0) {
            z11 = true;
        }
        this.f38445b0 = z11;
    ...
    public final void j() {
        ...
        int i10 = this.f38449e0;
        ArrayList<TLRPC.TL_forumTopic> topics = MessagesController.getInstance(i10).getTopicsController().getTopics(-this.f38454i0);
        if (topics != null && topics.size() > 1) {
            tL_forumTopic = null;
            for (int i11 = 0; i11 < topics.size(); i11++) {
                TLRPC.TL_forumTopic tL_forumTopic2 = topics.get(i11);
                if (tL_forumTopic2.f18135id != this.f38453h0 && !tL_forumTopic2.hidden && tL_forumTopic2.unread_count > 0 && (tL_forumTopic == null || ((message = tL_forumTopic2.topMessage) != null && (message2 = tL_forumTopic.topMessage) != null && message.date > message2.date))) {
        ...
        if (tL_forumTopic != null) {
            ...
            int i12 = tL_forumTopic.f18135id;
            org.telegram.ui.ActionBar.d6 d6Var = this.f38455j0;
            if (i12 == 1) {
                View view3 = this.f38443a0;
                if (view3 != null && (q5Var2 = this.f38456k0) != null) {
                    q5Var2.o(view3);
                }
                this.f38456k0 = null;
                ...
                org.telegram.ui.Components.q5 q5Var3 = this.f38456k0;
                if (q5Var3 == null || q5Var3.i() != tL_forumTopic.icon_emoji_id) {
                    org.telegram.ui.Components.q5 q5Var4 = this.f38456k0;
                    if (q5Var4 != null && (view = this.f38443a0) != null) {
                        q5Var4.o(view);
                    }
                    org.telegram.ui.Components.q5 q5Var5 = new org.telegram.ui.Components.q5(22, i10, tL_forumTopic.icon_emoji_id);
                    this.f38456k0 = q5Var5;
                    q5Var5.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18884ic, d6Var), PorterDuff.Mode.SRC_IN));
                }
                org.telegram.ui.Components.q5 q5Var6 = this.f38456k0;
                if (q5Var6 != null && (view2 = this.f38443a0) != null) {
                    q5Var6.a(view2);
                }
                imageReceiver.setImageBitmap((Bitmap) null);
            } else {
                View view4 = this.f38443a0;
                if (view4 != null && (q5Var = this.f38456k0) != null) {
                    q5Var.o(view4);
                }
                this.f38456k0 = null;
