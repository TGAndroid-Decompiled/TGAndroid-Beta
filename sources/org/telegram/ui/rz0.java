...
public final class rz0 extends org.telegram.ui.Components.y80 {
    ...
    public final void setTextColor(int i10) {
        ...
        m11 m11Var = profileActivity.f33871b6;
        if (m11Var != null && m11Var.f38544c != (l1 = org.telegram.ui.ActionBar.j6.l1(1.4f, org.telegram.ui.ActionBar.j6.b(-0.02f, 0.15f, i10)))) {
            m11Var.f38544c = l1;
    ...
    public final void setTranslationX(float f7) {
        ...
        profileActivity.f33975r[2].setTranslationX(f7);
        profileActivity.f33975r[3].setTranslationX(f7);
