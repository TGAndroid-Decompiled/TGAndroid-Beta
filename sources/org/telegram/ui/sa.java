...
public final class sa extends org.telegram.ui.ActionBar.o2 {
    ...
    public org.telegram.ui.ActionBar.w0 f37434a;
    public org.telegram.ui.Components.ml0 f37435b;
    public ja f37436c;
    public boolean d;
    public int e;
    public String f37437f;
    public l4 h;
    public boolean f37438n;
    public String f37439r;
    public final ArrayList f37440s;
    public final ArrayList v;
    public final ArrayList f37441w;
    public final long f37442x;
    public ma f37443y;

    public sa(Bundle bundle) {
        super(bundle);
        this.f37439r = "";
        this.f37440s = new ArrayList();
        this.v = new ArrayList();
        this.f37441w = new ArrayList();
        if (bundle != null) {
            this.f37442x = bundle.getLong("bot_id");
        }
    }
    ...
    public static void Y(sa saVar) {
        ...
        ArrayList arrayList2 = saVar.f37440s;
        if (!saVar.d) {
            return;
        }
        saVar.d = false;
    ...
    public static void Z(sa saVar) {
        ...
        if (!saVar.f37439r.isEmpty() && !saVar.d0(saVar.f37439r)) {
            saVar.h0();
            return;
        }
        ...
        if (saVar.getParentActivity() != null && f02 != null) {
            ...
            if (publicUsername.equals(saVar.f37439r)) {
                saVar.finishFragment();
                return;
            }
            ...
            updateusername.username = saVar.f37439r;
    ...
    public final View createView(Context context) {
        ...
        this.f37434a = this.actionBar.n().h(1, R.drawable.ic_ab_done, LocaleController.getString(R.string.Done), AndroidUtilities.dp(56.0f));
            ...
            if (user.usernames != null) {
                ...
                while (true) {
                    ...
                    if (tL_username != null && tL_username.editable) {
                        this.f37439r = tL_username.username;
                        break;
                    }
                    i10++;
                }
            }
            if (this.f37439r == null && (str = user.username) != null) {
                this.f37439r = str;
            }
        ...
        this.f37435b = ml0Var;
        ml0Var.q1();
        this.fragmentView.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f18807a7));
        this.f37435b.setLayoutManager(new s4.c0());
        org.telegram.ui.Components.ml0 ml0Var2 = this.f37435b;
        ja jaVar = new ja(this);
        this.f37436c = jaVar;
        ml0Var2.setAdapter(jaVar);
        this.f37435b.setSelectorDrawableColor(getThemedColor(org.telegram.ui.ActionBar.j6.f18953i6));
        new s4.y(new na(this)).e(this.f37435b);
        ((FrameLayout) this.fragmentView).addView(this.f37435b, w7.x5.c(-1.0f, -1));
        this.fragmentView.setOnTouchListener(new bi.d(6));
        this.f37435b.setOnItemClickListener(new ha(this));
        ...
        if (str != null && str.length() >= 4) {
            if (str.length() > 32) {
                ...
                if (x1Var8 != null) {
                    ...
                    int i15 = org.telegram.ui.ActionBar.j6.f19083p7;
                ...
                if (str.equals(str2)) {
                    ...
                    if (x1Var10 != null) {
                        ...
                        int i16 = org.telegram.ui.ActionBar.j6.f19211w6;
    ...
    public final void e0(boolean z10) {
        ma maVar = this.f37443y;
        if (maVar != null) {
            if (!maVar.f35738a.isFocused()) {
                EditTextBoldCursor editTextBoldCursor = this.f37443y.f35738a;
                editTextBoldCursor.setSelection(editTextBoldCursor.length());
            }
            this.f37443y.f35738a.requestFocus();
            if (z10) {
                AndroidUtilities.showKeyboard(this.f37443y.f35738a);
            }
        }
    }

    public final TLRPC.User f0() {
        long j3 = this.f37442x;
    ...
    public final void h0() {
        ...
        for (int i10 = 0; i10 < this.f37435b.getChildCount(); i10++) {
            View childAt = this.f37435b.getChildAt(i10);
            if ((childAt instanceof org.telegram.ui.Cells.l4) && i10 == 0) {
                ...
                ma maVar = (ma) childAt;
                AndroidUtilities.shakeViewSpring(maVar.f35738a);
                AndroidUtilities.shakeViewSpring(maVar.f35739b);
            }
        }
