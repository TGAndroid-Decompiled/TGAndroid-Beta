...
public final class sa implements Utilities.Callback {
    ...
    public sa(NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, Object obj, Object obj2, Object obj3, Object obj4, int i10) {
        this.f37327a = i10;
        this.f37328b = notificationCenterDelegate;
        this.f37329c = obj;
        this.d = obj2;
        this.e = obj3;
        this.f37330f = obj4;
    ...
    public final void run(Object obj) {
        ...
        switch (this.f37327a) {
            case 0:
                AndroidUtilities.runOnUIThread(new ai.z8((ub) this.f37328b, (TLRPC.ChannelParticipant) obj, (ArrayList) this.f37329c, (ArrayList) this.d, (ArrayList) this.e, (ra) this.f37330f));
                return;
            case 1:
                final bo boVar = (bo) this.f37328b;
                org.telegram.ui.Cells.t1 t1Var = (org.telegram.ui.Cells.t1) this.f37329c;
                String str = (String) this.d;
                TLRPC.TL_contact tL_contact = (TLRPC.TL_contact) this.e;
                CharacterStyle characterStyle = (CharacterStyle) this.f37330f;
                final TLRPC.User user = (TLRPC.User) obj;
                if (user != null) {
                    userFull = boVar.getMessagesController().getUserFull(user.f18256id);
                } else {
                    userFull = null;
                }
                org.telegram.ui.Components.n70 I = org.telegram.ui.Components.n70.I(boVar, t1Var);
                org.telegram.ui.Components.am0 am0Var = new org.telegram.ui.Components.am0(boVar.getParentActivity(), boVar.f32293ea);
                I.f26362p = new pe(am0Var, 1);
                ...
                if (tL_contact == null && (user == null || !boVar.getContactsController().contactsDict.containsKey(Long.valueOf(user.f18256id)))) {
                ...
                return;
            case 2:
                bo boVar2 = (bo) this.f37328b;
                TLRPC.TL_document tL_document = (TLRPC.TL_document) this.f37329c;
                String str2 = (String) this.d;
                MessageObject.SendAnimationData sendAnimationData = (MessageObject.SendAnimationData) this.f37330f;
                Long l4 = (Long) obj;
                int i10 = boVar2.R3;
                Object obj2 = this.e;
                if (i10 == 1) {
                    org.telegram.ui.Components.c5.M(boVar2.getParentActivity(), boVar2.T5, new a1.d(boVar2, tL_document, str2, obj2, 4), boVar2.f32293ea);
                } else {
                    boVar2.getSendMessagesHelper().sendSticker(tL_document, str2, boVar2.T5, boVar2.f32398n5, boVar2.X3, null, boVar2.f32372l5, sendAnimationData, true, 0, 0, false, obj2, boVar2.C8(), l4.longValue(), boVar2.N8(), boVar2.f32313g5);
                ...
                return;
            case 3:
                ArrayList arrayList = (ArrayList) this.f37329c;
                ArrayList arrayList2 = (ArrayList) this.d;
                ArrayList arrayList3 = (ArrayList) this.e;
                Runnable runnable = (Runnable) obj;
                org.telegram.ui.Components.jy jyVar = ((org.telegram.ui.Components.iy) this.f37328b).f25164a;
                String str3 = jyVar.v;
                ArrayList arrayList4 = jyVar.f25450r;
                ArrayList arrayList5 = jyVar.h;
                ArrayList arrayList6 = jyVar.f25451s;
                org.telegram.ui.Components.kz kzVar = jyVar.F;
                if (((String) this.f37330f).equals(str3)) {
                    ...
                    arrayList5.clear();
                    arrayList5.addAll(jyVar.f25449n);
                    arrayList4.clear();
                    ...
                    while (i12 < size) {
                        ...
                        if (longSparseIntArray.indexOfKey(cyVar.f23161c.f18136id) < 0) {
                            longSparseIntArray.append(cyVar.f23161c.f18136id, 1);
                    ...
                    while (i11 < size2) {
                        ...
                        if (longSparseIntArray.indexOfKey(cyVar2.f23161c.f18136id) < 0) {
                            longSparseIntArray.append(cyVar2.f23161c.f18136id, 1);
                ...
                return;
            case 4:
                uy uyVar = (uy) this.f37328b;
                Long l10 = (Long) this.d;
                Runnable runnable2 = (Runnable) obj;
                uyVar.getClass();
                ((org.telegram.ui.ActionBar.b2) this.f37329c).dismiss();
                uyVar.getMessagesController().loadChannelParticipants(l10);
                oy oyVar = uyVar.C2;
                uyVar.removeSelfFromStack();
                ((ld) this.e).removeSelfFromStack();
                ((org.telegram.ui.ActionBar.n2) this.f37330f).finishFragment();
                if (oyVar != null) {
                ...
                return;
            default:
                yh.z3.s0((yh.z3) this.f37328b, (TL_stars.StarGift) this.f37329c, (TL_stars.StarGiftAttribute) this.d, (org.telegram.ui.Components.xc[]) this.e, (boolean[]) this.f37330f, (ArrayList) obj);
                return;
        }
    }
