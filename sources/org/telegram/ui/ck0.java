...
public final class ck0 implements Runnable {
    ...
    public final NotificationsCustomSettingsActivity f32742b;
    ...
    public ck0(NotificationsCustomSettingsActivity notificationsCustomSettingsActivity, View view, int i10, int i11) {
        this.f32741a = i11;
        this.f32742b = notificationsCustomSettingsActivity;
        this.f32743c = view;
        this.d = i10;
    }
    ...
    public final void run() {
        switch (this.f32741a) {
            case 0:
                NotificationsCustomSettingsActivity notificationsCustomSettingsActivity = this.f32742b;
                ...
                return;
            case 1:
                NotificationsCustomSettingsActivity notificationsCustomSettingsActivity2 = this.f32742b;
                ArrayList arrayList2 = notificationsCustomSettingsActivity2.I;
                View view2 = this.f32743c;
                if (view2 instanceof org.telegram.ui.Cells.ea) {
                    int i11 = this.d;
                    if (i11 >= 0 && i11 < arrayList2.size()) {
                        ((hk0) arrayList2.get(i11)).f34245f = notificationsCustomSettingsActivity2.g0();
                    }
                ...
                return;
            default:
                NotificationsCustomSettingsActivity notificationsCustomSettingsActivity3 = this.f32742b;
                ArrayList arrayList3 = notificationsCustomSettingsActivity3.I;
                View view3 = this.f32743c;
                if (view3 instanceof org.telegram.ui.Cells.ea) {
                    int i12 = this.d;
                    if (i12 >= 0 && i12 < arrayList3.size()) {
                        ((hk0) arrayList3.get(i12)).f34245f = notificationsCustomSettingsActivity3.h0();
                    }
