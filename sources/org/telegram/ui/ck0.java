...
public final class ck0 implements Runnable {
    ...
    public final NotificationsCustomSettingsActivity f32740b;
    public final View f32741c;
    public final int d;

    public ck0(NotificationsCustomSettingsActivity notificationsCustomSettingsActivity, View view, int i10, int i11) {
        this.f32739a = i11;
        this.f32740b = notificationsCustomSettingsActivity;
        this.f32741c = view;
        this.d = i10;
    }
    ...
    public final void run() {
        switch (this.f32739a) {
            case 0:
                NotificationsCustomSettingsActivity notificationsCustomSettingsActivity = this.f32740b;
                ArrayList arrayList = notificationsCustomSettingsActivity.I;
                View view = this.f32741c;
                ...
                return;
            case 1:
                NotificationsCustomSettingsActivity notificationsCustomSettingsActivity2 = this.f32740b;
                ArrayList arrayList2 = notificationsCustomSettingsActivity2.I;
                View view2 = this.f32741c;
                if (view2 instanceof org.telegram.ui.Cells.ea) {
                    int i11 = this.d;
                    if (i11 >= 0 && i11 < arrayList2.size()) {
                        ((hk0) arrayList2.get(i11)).f34243f = notificationsCustomSettingsActivity2.g0();
                    }
                ...
                return;
            default:
                NotificationsCustomSettingsActivity notificationsCustomSettingsActivity3 = this.f32740b;
                ArrayList arrayList3 = notificationsCustomSettingsActivity3.I;
                View view3 = this.f32741c;
                if (view3 instanceof org.telegram.ui.Cells.ea) {
                    int i12 = this.d;
                    if (i12 >= 0 && i12 < arrayList3.size()) {
                        ((hk0) arrayList3.get(i12)).f34243f = notificationsCustomSettingsActivity3.h0();
                    }
