...
public final class ck0 extends org.telegram.ui.ActionBar.f3 implements AdapterView.OnItemSelectedListener {
    public static final int f32815d0 = 0;
    public boolean E;
    public boolean F;
    public boolean G;
    public boolean H;
    ...
    public final TextView f32816a0;
    public final LinearLayout f32817b;
    public String f32818b0;
    public final org.telegram.ui.Components.tq f32819c;
    public int f32820c0;
    public final org.telegram.ui.Components.xc0 d;
    public final org.telegram.ui.Components.xc0 e;
    public final FrameLayout f32821f;
    public final View h;
    public final ci.d f32822n;
    public final org.telegram.ui.Components.xc0 f32823r;
    public final org.telegram.ui.Components.yc0 f32824s;
    public final org.telegram.ui.Components.c90 v;
    public final ArrayList f32825w;
    public final HashMap f32826x;
    public final HashMap f32827y;
    ...
    public static void q(ck0 ck0Var) {
        ...
        for (int min = Math.min(3, replaceAll.length()); min >= 0; min--) {
            ...
            List list = (List) ck0Var.f32826x.get(substring);
            if (list != null && !list.isEmpty()) {
                List list2 = (List) ck0Var.f32827y.get(substring);
        ...
        if (!z10) {
            if (!TextUtils.isEmpty(ck0Var.f32818b0)) {
                ck0Var.f32818b0 = null;
                ck0Var.y(null);
            }
        } else if (!TextUtils.equals(ck0Var.f32818b0, replaceAll)) {
            ck0Var.f32818b0 = replaceAll;
            ck0Var.y(replaceAll);
        }
    }
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f32819c, 0, null, null, null, null, org.telegram.ui.ActionBar.i6.D7));
        arrayList.add(new org.telegram.ui.ActionBar.k6(this.f32819c, 0, null, null, null, null, org.telegram.ui.ActionBar.i6.E7));
        return arrayList;
    }
    ...
    public final void onItemSelected(AdapterView adapterView, View view, int i10, long j3) {
        ...
        this.E = true;
        this.O.setText(((vt) this.f32825w.get(i10)).f38618c);
        this.E = false;
    }
    ...
    public final void r() {
        ...
        if (this.f32823r.getVisibility() == 0) {
            str = this.f32823r.getEditText().getText().toString();
        } else {
            str = "";
        }
    ...
    public final void t(CharSequence charSequence) {
        if (TextUtils.isEmpty(charSequence)) {
            ...
            this.f32816a0.animate().setInterpolator(qrVar).translationX(-AndroidUtilities.dp(30.0f)).setDuration(150L);
        ...
        ViewPropertyAnimator animate2 = this.f32816a0.animate();
    ...
    public final void v(String str, boolean z10) {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            if (this.I.startsWith("+")) {
                ...
                while (true) {
                    if (i10 >= 1) {
                        List list = (List) this.f32826x.get(str2.substring(0, i10));
                        if (list != null && list.size() > 0) {
                            String str3 = ((vt) list.get(0)).f38618c;
                            this.O.setText(str3);
    ...
    public final void w(boolean z10) {
        ...
        ViewPropertyAnimator animate2 = this.f32821f.animate();
        if (z10) {
    ...
    public final void x(boolean z10) {
        ...
        float f11;
        float f12;
        boolean z11 = this.S.f26546a.f21969q;
        final boolean z12 = !z11;
        float f13 = 0.0f;
        int i12 = 0;
        if (z10) {
            this.f32822n.setVisibility(0);
            ViewPropertyAnimator animate = this.f32822n.animate();
            if (!z11) {
                f11 = 1.0f;
            } else {
                f11 = 0.0f;
            ...
            alpha.setInterpolator(qrVar).setDuration(420L).withEndAction(new Runnable(this) {
                ...
                public final void run() {
                    switch (r3) {
                        case 0:
                            boolean z13 = z12;
                            ck0 ck0Var = this.f39894b;
                            if (!z13) {
                                ck0Var.f32822n.setVisibility(4);
                                return;
                            } else {
                                ck0Var.getClass();
                                return;
                        ...
                        default:
                            boolean z15 = z12;
                            ck0 ck0Var3 = this.f39894b;
                            if (z15) {
                                ck0Var3.f32823r.setVisibility(4);
                                return;
                            } else {
                                ck0Var3.getClass();
                                return;
            ...
            ViewPropertyAnimator animate3 = this.f32823r.animate();
            if (z11) {
                f13 = 1.0f;
            }
        ...
        this.f32822n.animate().cancel();
        if (!z11) {
            i10 = 0;
        } else {
            i10 = 4;
        }
        this.f32822n.setVisibility(i10);
        if (!z11) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        }
        this.f32822n.setAlpha(f7);
        ...
        this.h.setAlpha(f10);
        this.f32823r.animate().cancel();
        if (!z11) {
            i12 = 4;
        }
        this.f32823r.setVisibility(i12);
        if (z11) {
            f13 = 1.0f;
        }
        this.f32823r.setAlpha(f13);
    }

    public final void y(String str) {
        if (this.f32820c0 >= 0) {
            ConnectionsManager.getInstance(this.currentAccount).cancelRequest(this.f32820c0, true);
            this.f32820c0 = -1;
        }
        if (TextUtils.isEmpty(str)) {
        ...
        this.R.setImageDrawable(new org.telegram.ui.Components.tp(AndroidUtilities.dp(30.0f), AndroidUtilities.dp(3.0f), getThemedColor(org.telegram.ui.ActionBar.i6.f18997m5)));
        this.v.setText("");
        w(true);
        ...
        this.f32820c0 = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_contacts_resolvePhone, new bc0(6, this, mj0Var));
    }
