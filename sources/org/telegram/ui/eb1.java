...
public final class eb1 extends org.telegram.ui.Components.b51 {
    public final StickersActivity f33307b;

    public eb1(StickersActivity stickersActivity) {
        this.f33307b = stickersActivity;
    }

    @Override
    public final void g(TLRPC.StickerSetCovered stickerSetCovered, boolean z10) {
        int i10;
        StickersActivity stickersActivity = this.f33307b;
