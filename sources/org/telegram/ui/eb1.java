...
public final class eb1 extends View {
    public static final int f36460c = 0;
    public final Paint f36461a;
    public int[] f36462b;

    public eb1(Context context) {
        super(context);
        this.f36461a = new Paint(1);
        this.f36462b = new int[7];
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Paint paint = this.f36461a;
        paint.setStyle(style);
        int i10 = 0;
        paint.setColor(this.f36462b[0]);
        canvas.drawCircle(measuredWidth, measuredHeight, dp, paint);
        double d = 0.0d;
        while (i10 < 6) {
            i10++;
            paint.setColor(this.f36462b[i10]);
