...
public final class e9 extends org.telegram.ui.Components.h51 {
    public static final int f33228a = 0;
    ...
    public final void bindView(View view, org.telegram.ui.Components.i51 i51Var, boolean z10, org.telegram.ui.Components.w51 w51Var, org.telegram.ui.Components.e61 e61Var) {
        ...
        int i11 = f9Var.f33537a;
        org.telegram.ui.Components.i9 i9Var = f9Var.f33538b;
        org.telegram.ui.Cells.i6 i6Var = f9Var.d;
        ImageView imageView = f9Var.f33539c;
        boolean z12 = g9Var.e;
            ...
            if (i12 != 1) {
                if (i12 != 2) {
                    if (i12 == 3) {
                        ...
                        mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19090r7, false), PorterDuff.Mode.MULTIPLY));
                    ...
                    mutate2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f19090r7, false), PorterDuff.Mode.MULTIPLY));
                ...
                mutate3.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.A6, false), PorterDuff.Mode.MULTIPLY));
        ...
        if (g9Var.f33794a != 0) {
            ...
            i6Var.f20222r.clearImage();
            i6Var.f20209f = true;
            int min = Math.min(3, arrayList3.size());
            for (int i14 = 0; i14 < min; i14++) {
                i9Var.b(i14, (TLObject) arrayList3.get(i14), i11);
            }
            z11 = false;
            i9Var.a(false);
        } else {
