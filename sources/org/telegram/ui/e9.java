...
public final class e9 extends z60 {
    public final int f36385s0;
    public final org.telegram.ui.ActionBar.p2 f36386t0;
    ...
    public final void n0(HashSet hashSet) {
        ...
        int i10 = this.f36385s0;
        if (size == 1) {
            TLRPC.User user = MessagesController.getInstance(i10).getUser((Long) hashSet.iterator().next());
            TLRPC.UserFull userFull = MessagesController.getInstance(i10).getUserFull(user.f20992id);
            if (userFull == null) {
                TLRPC.TL_users_getFullUser tL_users_getFullUser = new TLRPC.TL_users_getFullUser();
                tL_users_getFullUser.f20985id = MessagesController.getInstance(i10).getInputUser(user.f20992id);
            ...
            ConnectionsManager.getInstance(i10).sendRequest(createconferencecall, new hg.l0(i10, hashSet, this.f36386t0));
        }
        finishFragment();
    }
}
