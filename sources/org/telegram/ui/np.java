...
public final class np extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    public org.telegram.ui.Components.w9 f35996a;
    public org.telegram.ui.Components.r90 f35997b;
    public int f35998c;

    public final void a() {
        boolean z10;
        org.telegram.ui.Components.w9 w9Var = this.f35996a;
        ...
        if (tL_messages_stickerSet != null && tL_messages_stickerSet.documents.size() >= 3) {
            w9Var.i(ImageLocation.getForDocument(tL_messages_stickerSet.documents.get(2)), "104_104", "tgs", this.f35997b, tL_messages_stickerSet);
            return;
        }
        ...
        w9Var.setImageDrawable(this.f35997b);
    }
    ...
    public final void onAttachedToWindow() {
        ...
        a();
        NotificationCenter.getInstance(this.f35998c).addObserver(this, NotificationCenter.diceStickersDidLoad);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f35998c).removeObserver(this, NotificationCenter.diceStickersDidLoad);
    }
}
