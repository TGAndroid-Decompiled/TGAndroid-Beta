...
public final class kg implements Utilities.Callback2 {
    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (i10) {
            case 0:
                AndroidUtilities.runOnUIThread(new fi.l3((co) obj4, this.f38078b, (Boolean) obj, (TLRPC.WebPage) obj2, (TL_account.getWebPagePreview) obj3, 15));
                return;
            case 1:
                ...
                AndroidUtilities.runOnUIThread(new fi.l3(launchActivity, r80Var, tL_error, updates, this.f38078b, 25));
                return;
            default:
                PasskeysActivity passkeysActivity = (PasskeysActivity) obj4;
                TL_account.Passkey passkey = (TL_account.Passkey) obj3;
                TLRPC.TL_error tL_error2 = (TLRPC.TL_error) obj2;
                ArrayList arrayList = passkeysActivity.f33535b;
