...
public final class t00 extends org.telegram.ui.Cells.m4 {
    ...
    public final s00 f37526s;
    public int v;
    public final org.telegram.ui.Components.h5 f37527w;
    public boolean f37528x;
    public final f10 f37529y;
    ...
    public final void d(int i10, boolean z10) {
        ...
        TextView textView = this.f37525r;
        ...
        this.v = i12;
        s00 s00Var = this.f37526s;
        if (!z11) {
            s00Var.setEmojiColor(i12);
        }
        if (!z10) {
            this.f37527w.a(this.v, true);
        }
        if (z11 != this.f37528x) {
            this.f37528x = z11;
