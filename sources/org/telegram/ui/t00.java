...
public final class t00 extends org.telegram.ui.Cells.l4 {
    ...
    public final s00 f40608s;
    public int v;
    public final org.telegram.ui.Components.h5 f40609w;
    public boolean f40610x;
    public final f10 f40611y;
    ...
    public final void d(int i10, boolean z10) {
        ...
        TextView textView = this.f40607r;
        ...
        this.v = i12;
        s00 s00Var = this.f40608s;
        if (!z11) {
            s00Var.setEmojiColor(i12);
        }
        if (!z10) {
            this.f40609w.a(this.v, true);
        }
        if (z11 != this.f40610x) {
            this.f40610x = z11;
