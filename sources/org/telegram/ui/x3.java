...
public final class x3 extends org.telegram.ui.Components.qv0 implements org.telegram.ui.ActionBar.m2, org.telegram.ui.ActionBar.u3 {
    ...
    public boolean D0;
    public final y3 E0;
    public final Paint f39844t0;
    public final Paint f39845u0;
    public final Paint f39846v0;
    public final Paint f39847w0;
    public final org.telegram.ui.Components.z5 f39848x0;
    public boolean f39849y0;
    public final Path f39850z0;

    public x3(y3 y3Var, Context context) {
        super(context, null);
        this.E0 = y3Var;
        this.f39844t0 = new Paint(1);
        this.f39845u0 = new Paint(1);
        this.f39846v0 = new Paint(1);
        this.f39847w0 = new Paint(1);
        new Paint(1);
        this.f39848x0 = new org.telegram.ui.Components.z5(this, 0L, 420L, org.telegram.ui.Components.nr.h);
        this.f39850z0 = new Path();
        this.A0 = new RectF();
        new RectF();
        this.B0 = new RectF();
        this.C0 = new Path();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float min = Math.min(y3Var.f40371w, 1.0f - y3Var.f40372x);
        Paint paint = this.f39844t0;
        ...
        float max = Math.max(1.0f - y3Var.f40371w, y3Var.f40372x) * y3Var.k();
        canvas.save();
        ...
        if (dp <= f10) {
            ...
            Path path = this.f39850z0;
            path.rewind();
            path.addRoundRect(rectF, dp, dp, Path.Direction.CW);
            canvas.clipPath(path);
        }
        int backgroundColor = l4Var.f35945r0[1].getBackgroundColor();
        Paint paint3 = this.f39846v0;
        paint3.setColor(backgroundColor);
        canvas.drawRect(rectF, paint3);
        paint3.setColor(l4Var.f35945r0[c3].getBackgroundColor());
        RectF rectF2 = AndroidUtilities.rectTmp;
        rectF2.set(rectF);
        rectF2.left = l4Var.f35945r0[c3].getX();
        ...
        if (e > 0.0f) {
            ...
            l4Var.f35933e0.a(canvas, org.telegram.messenger.y3.C(20.0f, l10, 1) - lerp2, e, true);
            canvas.restore();
        }
        canvas.translate(0.0f, -max);
        if (!AndroidUtilities.makingGlobalBlurBitmap && (!l4Var.f35945r0[0].f() || canvas.isHardwareAccelerated())) {
    ...
    public final boolean onNestedPreFling(View view, float f10, float f11) {
        ...
        if (!l4Var.L0.y()) {
            ...
            if (p3Var.c()) {
                z4 = !p3Var.f37159b.canScrollVertically(-1);
            } else {
                z4 = false;
            }
            if (z4 && f11 < -1000.0f) {
        ...
        if (f10 != 0.0f || f11 != 0.0f) {
            ...
            AndroidUtilities.cancelRunOnUIThread(m9Var.f22676g0);
            m9Var.f22705z = false;
        }
        this.D0 = true;
    ...
    public final void onNestedPreScroll(View view, int i10, int i11, int[] iArr) {
        ...
        if (z4 && !l4Var.L0.y()) {
            iArr[1] = Math.min((int) (y3Var.k() * y3Var.f40372x), i11);
            y3Var.f40372x = Utilities.clamp(y3Var.f40372x - (i11 / y3Var.k()), 1.0f, 0.0f);
            y3Var.n();
            y3Var.h();
        }
        if (i10 == 0 && i11 == 0) {
    ...
    public final float z(Canvas canvas, RectF rectF, float f10, RectF rectF2, float f11) {
        ...
        Paint paint = this.f39844t0;
        paint.setColor(-16777216);
        paint.setAlpha((int) ((1.0f - y3Var.F) * Math.min(y3Var.f40371w, 1.0f - y3Var.f40372x) * f12 * 96.0f));
        canvas.drawRect(0.0f, 0.0f, getWidth(), getHeight(), paint);
        ...
        if (getChildCount() == 1) {
            ...
            if (y3Var.C) {
                i10 = l4Var.f35933e0.getMeasuredHeight();
            } else {
                i10 = 0;
            }
