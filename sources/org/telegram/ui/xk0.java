...
public final class xk0 extends org.telegram.ui.Components.ll0 {
    ...
    @Override
    public final int h() {
        return this.f39660c.f31917n;
    }

    @Override
    public final long i(int i10) {
        yk0 yk0Var;
        al0 al0Var = this.f39660c;
        int i11 = al0Var.E;
        if (i10 >= i11 && i10 < al0Var.F) {
            yk0Var = (yk0) al0Var.f31914b.get(i10 - i11);
        } else {
            int i12 = al0Var.f31918r;
            if (i10 >= i12 && i10 < al0Var.f31919s) {
                yk0Var = (yk0) al0Var.f31913a.get(i10 - i12);
            } else {
                yk0Var = null;
            }
        }
        if (yk0Var != null) {
            return yk0Var.f39929c;
        }
        al0Var.getClass();
        if (i10 == 0) {
            return 1L;
        }
        if (i10 == al0Var.f31922y) {
            return 2L;
        }
        if (i10 == al0Var.v) {
            return 3L;
        }
        if (i10 == al0Var.f31920w) {
            return 4L;
        }
        if (i10 == al0Var.f31921x) {
            return 5L;
        }
    ...
    public final int j(int i10) {
        ...
        al0Var.getClass();
        if (i10 != 0 && i10 != al0Var.f31922y) {
            if (i10 == al0Var.v) {
                return 2;
            }
            if (i10 != al0Var.f31920w && i10 != al0Var.f31921x) {
                return 0;
            }
            return 3;
        }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i11 != 0) {
            if (i11 != 1) {
                if (i11 == 2) {
                    ...
                    f2Var.f20070a.l(LocaleController.getString(R.string.UploadSound), false);
                    f2Var.f20071b.setImageDrawable(pqVar);
                    f2Var.f20072c = false;
                    return;
                }
                return;
        ...
        if (i10 >= i12 && i10 < al0Var.F) {
            yk0Var = (yk0) al0Var.f31914b.get(i10 - i12);
        } else {
            yk0Var = null;
        }
        int i13 = al0Var.f31918r;
        if (i10 >= i13 && i10 < al0Var.f31919s) {
            yk0Var = (yk0) al0Var.f31913a.get(i10 - i13);
        }
        if (yk0Var != null) {
            if (zk0Var.e == yk0Var) {
                z10 = true;
            ...
            if (al0Var.J.get(yk0Var.f39929c) != null) {
                z12 = true;
            } else {
                z12 = false;
            }
            zk0Var.e = yk0Var;
            zk0Var.f40263a.setText(yk0Var.f39930f);
            if (i10 != al0Var.F - 1) {
                z13 = true;
            }
            zk0Var.d = z13;
            zk0Var.f40264b.a(z11, z10);
            zk0Var.f40265c.a(z12, z10);
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        org.telegram.ui.ActionBar.f6 f6Var = this.f39660c.h;
        ...
        if (i10 != 0) {
            if (i10 != 2) {
                if (i10 != 3) {
                    ...
                    l4Var2.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18862d6, f6Var));
                    l4Var = l4Var2;
                } else {
                ...
                f2Var.d = 61;
                f2Var.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18862d6, f6Var));
                l4Var = f2Var;
            }
        } else {
            ?? frameLayout = new FrameLayout(context);
            RadioButton radioButton = new RadioButton(context);
            frameLayout.f40264b = radioButton;
            ...
            frameLayout.f40265c = npVar;
            int i22 = org.telegram.ui.ActionBar.j6.f18862d6;
            npVar.b(-1, i22, org.telegram.ui.ActionBar.j6.f18991k7);
