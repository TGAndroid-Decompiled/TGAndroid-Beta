...
public final class cd1 extends org.telegram.ui.Components.sl0 {
    ...
    public final void v(f2.m1 m1Var, int i10) {
        ...
        k5Var.getImageReceiver().setColorFilter(new PorterDuffColorFilter(ed1Var.f36509g1, ed1Var.f36527p1));
        if (Build.VERSION.SDK_INT >= 29) {
            int i11 = 0;
            if (ed1Var.f36489b == 1) {
                int B0 = org.telegram.ui.ActionBar.k6.B0(org.telegram.ui.ActionBar.k6.Pd);
                long j10 = ed1Var.f36533s.f21476l;
                int i12 = (int) j10;
                if (i12 != 0 || j10 == 0) {
                    i11 = i12 != 0 ? i12 : B0;
                }
            ...
            if (i11 != 0 && ed1Var.f36514i1 >= 0.0f) {
                ImageReceiver imageReceiver = ed1Var.f36538u0.getImageReceiver();
    ...
    public final f2.m1 x(ViewGroup viewGroup, int i10) {
        ...
        ?? p9Var = new org.telegram.ui.Components.p9(this.f35782c);
        p9Var.D = new RectF();
