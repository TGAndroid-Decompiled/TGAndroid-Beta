...
public final class l71 implements TextWatcher {
    public final g01 f35476a = new g01(this, 16);
    public final s71 f35477b;
    ...
    public final void a() {
        ...
        s71 s71Var = this.f35477b;
        String obj = s71Var.f37408c0.getText().toString();
        tL_channelParticipantsSearch.f18120q = obj;
        r71 r71Var = s71Var.f37412g0;
        TLRPC.ChannelParticipantsFilter channelParticipantsFilter = r71Var.f37112c;
        ...
        r71Var.f37112c = tL_channelParticipantsSearch;
        if (z10) {
            if (z11) {
                r71Var.f37115r = false;
                if (r71Var.f37114n >= 0) {
                    ConnectionsManager.getInstance(r71Var.f37110a).cancelRequest(r71Var.f37114n, true);
                    r71Var.f37114n = -1;
                }
        ...
        org.telegram.ui.Components.x51 x51Var = s71Var.f37414i0;
        if (x51Var != null) {
            x51Var.N(true);
        }
    }
