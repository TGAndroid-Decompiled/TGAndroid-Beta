...
public final class l3 extends FrameLayout {
    ...
    public final h4 K;
    public int f35286a;
    public final ci.v f35287b;
    public final f4 f35288c;
    public final s4.c0 d;
    public final i3 e;
    public final j3 f35289f;
    public boolean h;
    ...
    public int f35293w;
    public int f35294x;
    public org.telegram.ui.web.h2 f35295y;
    ...
    public l3(h4 h4Var, Activity activity) {
        ...
        this.f35293w = org.telegram.ui.ActionBar.j6.w0(null, i10, false);
        this.f35294x = org.telegram.ui.ActionBar.j6.w0(null, i10, false);
        this.E = false;
        this.I = -1.0f;
        new Matrix();
        ...
        j3 j3Var = new j3(this, getContext(), org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19094d6, false));
        this.f35289f = j3Var;
        j3Var.setOnCloseRequestedListener(new Runnable(this) {
            public final l3 f33462b;
            ...
            public final void run() {
                switch (r2) {
                    case 0:
                        ...
                        return;
                    case 1:
                        this.f33462b.f35289f.o(true, false);
                        return;
                    default:
                        l3 l3Var = this.f33462b;
                        i3 i3Var2 = l3Var.e;
                        l3Var.f35289f.o(false, false);
                        c3 c3Var = l3Var.f35291r;
                        if (c3Var != null) {
                            c3Var.f32605a.setTranslationY(((i3Var2.getTopActionBarOffsetY() + (-i3Var2.getOffsetY())) - i3Var2.getSwipeOffsetY()) / 2.0f);
                        }
                        l3Var.K.f0();
                        return;
                }
    ...
    public static void a(l3 l3Var, boolean z10, int i10) {
        ...
        if (z10) {
            ...
            if (l3Var == h4Var.f34114u0[0]) {
                if (SharedConfig.adaptableColorInBrowser) {
                    h4Var.f34102h0.setMenuColors(v9);
                }
                if (u3Var != null) {
                    u3Var.i();
                }
    ...
    public final void b() {
        ...
        if (c3Var != null) {
            ...
            c3Var.b(z10, true);
            this.f35291r.setBackgroundColor(this.f35294x);
            c3 c3Var2 = this.f35291r;
            this.f35290n = false;
            AndroidUtilities.updateViewVisibilityAnimated(c3Var2, false, 1.0f, false);
        }
        f4 f4Var = this.f35288c;
        f4Var.E = null;
        f4Var.e.clear();
        f4Var.f33478f.clear();
        f4Var.f33481s.clear();
    ...
    public final boolean d() {
        ...
        TL_iv.Page page;
        if (!f() && (f4Var = this.f35288c) != null && (webPage = f4Var.E) != null && (page = webPage.cached_page) != null && page.local != null) {
            return true;
        }
        return false;
    }
        ...
        if (c()) {
            ...
            for (int i11 = 0; i11 < vVar.getChildCount(); i11++) {
                ...
                if (vVar.getLayoutManager() == null) {
                    ...
                    i10 = RecyclerView.V(childAt).f42977f;
                }
                if (i10 == 2147483646) {
    ...
    public float getProgress() {
        ...
        } else if (f() && (webView = this.f35289f.getWebView()) != null) {
    ...
    public String getSubtitle() {
        ...
        String[] split;
        k0 k0Var;
        if (!f() || (webView = this.f35289f.getWebView()) == null) {
            return "";
        }
            ...
            try {
                if (!e()) {
                    try {
                        ...
                        if (a2.split("\\.").length > 2 && (k0Var = this.K.f34102h0) != null && ci.f4.g(a2, k0Var.E) > AndroidUtilities.displaySize.x - AndroidUtilities.dp(162.0f)) {
    ...
    public String getTitle() {
        ...
        String str2;
        if (c()) {
            TLRPC.WebPage webPage = this.f35288c.E;
    ...
    public final void onAttachedToWindow() {
        ...
        if (this.f35290n && (c3Var = this.f35291r) != null) {
            int i10 = org.telegram.ui.ActionBar.j6.Pk;
            ...
            c3Var.b(z10, false);
            this.f35291r.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, i10, false));
        }
    }
    ...
    public void setLastVisible(boolean z10) {
        if (this.H != z10) {
            this.H = z10;
            this.f35289f.setKeyboardFocusable(z10);
        }
    }
    ...
    public void setTranslationX(float f7) {
        ...
        if (h4Var.f34100f0.f19975f) {
            h4Var.f34101g0.invalidate();
        }
        if (h4Var.f34100f0.e) {
            h4Var.f34101g0.invalidate();
            h4Var.X((int) (((AndroidUtilities.dp(56.0f) - h4Var.f34100f0.h) * (f7 / getMeasuredWidth())) + h4Var.f34100f0.h));
        }
        u3 u3Var = h4Var.K;
        if (u3Var != null) {
            u3Var.n();
    ...
    public void setType(int i10) {
        ...
        this.f35287b.setVisibility(i11);
        if (f()) {
            i12 = 0;
        }
    ...
    public void setWeb(y2 y2Var) {
        ...
        if (y2Var2 != y2Var) {
            ...
            this.J = y2Var;
            if (y2Var != null) {
                org.telegram.ui.web.z0 z0Var = y2Var.f19647b;
                j3 j3Var = this.f35289f;
                if (z0Var != null) {
                    z0Var.onResume();
                    j3Var.O(UserConfig.selectedAccount, y2Var.f19647b, y2Var.d, y2Var.f19665x, false);
                    a(this, true, y2Var.f19659q);
                    a(this, false, y2Var.f19660r);
                } else {
                    String str = y2Var.f19665x;
                    if (str != null) {
                        j3Var.u(UserConfig.selectedAccount, str, false);
                    }
                }
            }
            org.telegram.ui.web.h2 h2Var = this.f35295y;
            if (h2Var != null) {
                h2Var.a();
                org.telegram.ui.web.h2 h2Var2 = this.f35295y;
                TLRPC.TL_webPage tL_webPage = h2Var2.f38924j;
                if (tL_webPage != null) {
