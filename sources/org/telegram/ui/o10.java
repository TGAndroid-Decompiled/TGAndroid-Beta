...
public final class o10 extends org.telegram.ui.Components.sl0 {
    public final Context f36006r;
    public final int f36007s;
    public final t10 v;

    public o10(t10 t10Var, Context context, int i10) {
        this.v = t10Var;
        this.f36006r = context;
        this.f36007s = i10;
    }
    ...
    public final int R() {
        t10 t10Var = this.v;
        int i10 = 0;
        if (t10Var.f37918n.isEmpty()) {
            return 0;
        }
        int size = t10Var.f37918n.size();
        if (!t10Var.f37918n.isEmpty() && !t10Var.N) {
            i10 = 1;
        }
        return size + i10;
    }
    ...
    public final View T(int i10, View view) {
        if (view == null) {
            view = new org.telegram.ui.Cells.v3(this.f36006r, null);
