...
public final class b90 implements Runnable {
    ...
    public final TLRPC.TL_error f32080c;
    ...
    public final void run() {
        ...
        oa0 oa0Var = this.h;
        String str2 = this.f32081f;
        TLObject tLObject = this.d;
        TLRPC.TL_error tL_error = this.f32080c;
        switch (i12) {
            case 0:
                Pattern pattern = LaunchActivity.B1;
                boolean z10 = tLObject instanceof TLRPC.User;
                LaunchActivity launchActivity = this.f32079b;
                if (z10) {
                    ...
                    org.telegram.messenger.w1.p(R.string.NoUsernameFound, org.telegram.ui.Components.vc.a0((org.telegram.ui.ActionBar.o2) hg.k0.h(1, launchActivity.f30837d0)), null);
                }
                try {
                    oa0Var.run();
                    return;
            ...
            default:
                ...
                if (tL_error != null) {
                    ...
                    LaunchActivity launchActivity2 = this.f32079b;
