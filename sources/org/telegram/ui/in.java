...
public final class in extends org.telegram.ui.Components.hq0 {
    public final MessageObject f37413b1;
    public final on f37414c1;
    ...
    public in(on onVar, Activity activity, co coVar, ArrayList arrayList, boolean z10, boolean z11, org.telegram.ui.ActionBar.f6 f6Var, boolean z12, MessageObject messageObject) {
        ...
        this.f37414c1 = onVar;
        this.f37413b1 = messageObject;
        this.f26788a0 = z12;
    }

    @Override
    public final void R0(a0.i iVar, int i10, TLRPC.TL_forumTopic tL_forumTopic, boolean z10) {
        on onVar = this.f37414c1;
        co coVar = onVar.f39284a;
        int i11 = co.Hc;
        coVar.Q7();
        if (onVar.f39284a.y3 != null && z10) {
            if (iVar.m() == 1) {
                if (((TLRPC.Dialog) iVar.n(0)).f19873id != onVar.f39284a.getUserConfig().getClientUserId() || !org.telegram.ui.Components.yc.a0(onVar.f39284a).e0(i10, ((TLRPC.Dialog) iVar.n(0)).f19873id)) {
                    onVar.f39284a.y3.k(((TLRPC.Dialog) iVar.n(0)).f19873id, 53, Integer.valueOf(i10), tL_forumTopic, null, null);
                    return;
                }
                return;
            }
            onVar.f39284a.y3.k(0L, 53, Integer.valueOf(i10), Integer.valueOf(iVar.m()), null, null);
        }
    }
    ...
    public final void S0(final View view) {
        di.ic icVar;
        co coVar = this.f37414c1.f39284a;
        ...
        MessageObject messageObject = this.f37413b1;
        if (messageObject.getGroupId() != 0) {
            groupedMessages = (MessageObject.GroupedMessages) coVar.f35480x6.f(messageObject.getGroupId());
        }
