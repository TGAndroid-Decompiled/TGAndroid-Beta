...
public final class ml0 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f35770a) {
            case 0:
                org.telegram.ui.ActionBar.f1 f1Var = (org.telegram.ui.ActionBar.f1) this.f35772c;
                PasscodeActivity passcodeActivity = ((nl0) this.f35771b).f36009b;
                ...
                if (passcodeActivity.e0()) {
                    ...
                    AndroidUtilities.updateViewVisibilityAnimated(passcodeActivity.f30887s, true, 0.1f, false);
                    return;
                }
                return;
            case 1:
                ((PasskeysActivity) this.f35771b).Y((TL_account.Passkey) this.f35772c);
                return;
            case 2:
                on0 on0Var = (on0) this.f35771b;
                MrzRecognizer.Result result = (MrzRecognizer.Result) this.f35772c;
                ...
                return;
            case 3:
                on0 on0Var2 = (on0) this.f35771b;
                TLObject tLObject = (TLObject) this.f35772c;
                if (tLObject != null) {
                ...
                return;
            case 4:
                on0 on0Var3 = (on0) this.f35771b;
                TLRPC.TL_error tL_error = (TLRPC.TL_error) this.f35772c;
                if (tL_error == null) {
                    on0Var3.f36271f1 = true;
                    on0Var3.W0(true);
            ...
            case 5:
                ((jn0) this.f35771b).f34955a.K = ((TLRPC.TL_error) this.f35772c).text;
                return;
            case 6:
                ((wo0) this.f35771b).D0(false);
                ((View) this.f35772c).callOnClick();
                return;
            case 7:
                wo0 wo0Var = (wo0) this.f35771b;
                TLRPC.TL_error tL_error2 = (TLRPC.TL_error) this.f35772c;
                wo0Var.H0(true, false);
                if (tL_error2 == null) {
                    if (wo0Var.getParentActivity() != null) {
                        tn0 tn0Var = wo0Var.f39311d0;
                        if (tn0Var != null) {
                            AndroidUtilities.cancelRunOnUIThread(tn0Var);
                            wo0Var.f39311d0 = null;
                        }
                        wo0Var.t0();
                        return;
                    }
                    ...
                    j3Var2.f20276a.setText("");
                    j3Var2.f20277b = false;
            ...
            case 8:
                wo0.W((wo0) this.f35771b, (TLRPC.TL_payments_validatedRequestedInfo) this.f35772c);
                return;
            case 9:
                wo0 wo0Var2 = (wo0) this.f35771b;
                TLRPC.Message[] messageArr = (TLRPC.Message[]) this.f35772c;
                ...
                if (parentActivity != null) {
                    wo0Var2.f39304a1 = true;
                    wo0Var2.f39317f1 = 1;
                    TLRPC.InputInvoice inputInvoice = wo0Var2.f39307b1;
                    ...
                    if (z12) {
                        ...
                        formatString = LocaleController.formatString(R.string.PaymentInfoHint, wo0Var2.R0[0], wo0Var2.f39328q0);
                    }
                ...
                return;
            case 10:
                PhotoViewer photoViewer = (PhotoViewer) this.f35771b;
                i41.T(photoViewer.E, photoViewer.f31005m4, false, (ai.d) this.f35772c, null);
                return;
            case 11:
                PhotoViewer photoViewer2 = (PhotoViewer) this.f35771b;
                gt0 gt0Var = (gt0) this.f35772c;
            ...
            case 12:
                ...
                ((org.telegram.messenger.f2) this.f35771b).run((Bitmap) this.f35772c);
                return;
            case 13:
                PhotoViewer photoViewer3 = (PhotoViewer) this.f35771b;
                qg.z0 z0Var = (qg.z0) this.f35772c;
                Drawable[] drawableArr3 = PhotoViewer.U8;
                z0Var.e.h();
                z0Var.f41722c.postRunnable(new o91(10));
                photoViewer3.f30934e0.removeView(photoViewer3.N1);
                return;
            case 14:
                org.telegram.ui.Components.b6 b6Var = (org.telegram.ui.Components.b6) this.f35771b;
                Bitmap bitmap = (Bitmap) this.f35772c;
                Drawable[] drawableArr4 = PhotoViewer.U8;
                if (b6Var != null) {
                    ArrayList arrayList = b6Var.h;
                    org.telegram.ui.Components.y5 y5Var = b6Var.f22641n;
                    if (y5Var != null) {
                        arrayList.add(y5Var);
                    }
                    org.telegram.ui.Components.y5 y5Var2 = b6Var.f22646r;
                    if (y5Var2 != null) {
                        arrayList.add(y5Var2);
                    }
                    org.telegram.ui.Components.y5 y5Var3 = b6Var.f22648s;
                    if (y5Var3 != null) {
                        arrayList.add(y5Var3);
                    }
                    b6Var.f22641n = new org.telegram.ui.Components.y5(bitmap);
                    b6Var.f22646r = null;
                    b6Var.f22648s = null;
                    b6Var.t();
                    return;
                ...
                return;
            case 15:
                gs0 gs0Var = (gs0) this.f35771b;
                gs0Var.getClass();
                ((View) this.f35772c).setOutlineProvider(null);
                PhotoViewer photoViewer4 = gs0Var.f33943c;
                ImageView imageView = photoViewer4.f31106x3;
                if (imageView != null) {
                ...
                return;
            case 16:
                rt0 rt0Var = (rt0) this.f35771b;
                org.telegram.ui.Components.g71 g71Var = (org.telegram.ui.Components.g71) this.f35772c;
                rt0Var.getClass();
                if (g71Var.p() > 0 && g71Var.n() >= g71Var.p() - 590) {
                    rt0Var.f37204a.f30934e0.invalidate();
                    return;
                }
                return;
            case 17:
                vt0 vt0Var = (vt0) this.f35771b;
                qg.z0 z0Var2 = (qg.z0) this.f35772c;
                z0Var2.e.h();
                z0Var2.f41722c.postRunnable(new o91(10));
                try {
                    vt0Var.f38620b.f30934e0.removeView(z0Var2);
                    return;
                } catch (Exception e) {
                    FileLog.e(e);
                    return;
            ...
            case 18:
                ci.n6 n6Var = (ci.n6) this.f35772c;
                PhotoViewer photoViewer5 = ((at0) this.f35771b).f31932b;
                if (photoViewer5.C3 != null) {
                    ImageView imageView2 = photoViewer5.f31106x3;
                    if (imageView2 != null) {
                        imageView2.setVisibility(0);
                        photoViewer5.f31106x3.setImageBitmap(photoViewer5.C3);
                    }
                    ((ImageReceiver) n6Var.f5071b).setImageBitmap(photoViewer5.C3);
                    return;
                }
                return;
            case 19:
                ((fu0) this.f35771b).f33690r.f31000l7.lock();
                ((AnimatorSet) this.f35772c).start();
                return;
            case 20:
                dv0 dv0Var = (dv0) this.f35772c;
                ((fu0) this.f35771b).f33690r.f31060s4 = false;
                if (!dv0Var.f33111s) {
                    dv0Var.f33096a.setVisible(false, true);
                    return;
                }
                return;
            case 21:
                mw0 mw0Var = (mw0) this.f35771b;
                mw0Var.getClass();
                AndroidUtilities.addToClipboard((String) this.f35772c);
                mw0Var.c(true);
                return;
            case 22:
                mw0 mw0Var2 = (mw0) this.f35771b;
                mw0Var2.getClass();
                AndroidUtilities.addToClipboard(MessageObject.formatTextWithEntities(((TLRPC.PollAnswer) this.f35772c).text, false));
                mw0Var2.c(true);
                return;
            case 23:
                mw0 mw0Var3 = (mw0) this.f35771b;
                SendMessagesHelper.getInstance(mw0Var3.H.currentAccount).deletePollOption(mw0Var3.H, (byte[]) this.f35772c);
                mw0Var3.c(true);
                return;
            case 24:
                PrivacyControlActivity.W((PrivacyControlActivity) this.f35771b, (TLObject) this.f35772c);
                return;
            case 25:
                PrivacyControlActivity privacyControlActivity = (PrivacyControlActivity) this.f35771b;
                boolean[] zArr = (boolean[]) this.f35772c;
                ...
                return;
            case 26:
                PrivacySettingsActivity privacySettingsActivity = (PrivacySettingsActivity) this.f35771b;
                privacySettingsActivity.d = (TL_account.Password) this.f35772c;
                privacySettingsActivity.y0();
                return;
            case 27:
                PrivacySettingsActivity privacySettingsActivity2 = (PrivacySettingsActivity) this.f35771b;
                boolean z13 = !privacySettingsActivity2.V;
                privacySettingsActivity2.V = z13;
                ((org.telegram.ui.Cells.w8) this.f35772c).setChecked(z13);
                return;
            case 28:
                ((gy0) this.f35771b).getMessagesController().unblockPeer(((Long) this.f35772c).longValue());
                return;
            default:
                ProfileActivity profileActivity = (ProfileActivity) this.f35771b;
                ...
                bundle.putInt("enc_id", ((TLRPC.EncryptedChat) ((Object[]) this.f35772c)[0]).f18117id);
