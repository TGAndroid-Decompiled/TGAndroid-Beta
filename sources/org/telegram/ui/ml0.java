...
public final class ml0 implements Utilities.Callback5, org.telegram.ui.Cells.x5, org.telegram.ui.Components.h71, org.telegram.ui.ActionBar.z1, org.telegram.ui.ActionBar.l1, r0.n, Utilities.Callback2Return, org.telegram.ui.Cells.a5, LanguageDetector.ExceptionCallback, RequestTimeDelegate, org.telegram.ui.ActionBar.l2, org.telegram.ui.Components.ml0, ig.e, gg.b2 {
    ...
    public r0.l1 Q0(View view, r0.l1 l1Var) {
        ...
        switch (this.f35619a) {
            case 8:
                PremiumPreviewFragment premiumPreviewFragment = (PremiumPreviewFragment) this.f35620b;
                i0.b defaultWindowInsets = AndroidUtilities.getDefaultWindowInsets(l1Var, false);
                premiumPreviewFragment.f31460o0 = defaultWindowInsets;
                premiumPreviewFragment.f31442a.setPadding(0, defaultWindowInsets.f10577b, 0, AndroidUtilities.dp(48.0f) + premiumPreviewFragment.f31460o0.d);
                org.telegram.ui.Components.wl0 wl0Var = premiumPreviewFragment.f31442a;
                i0.b bVar = premiumPreviewFragment.f31460o0;
                AndroidUtilities.setViewLayoutMargins(wl0Var, bVar.f10576a, 0, bVar.f10578c, 0);
                ax0 ax0Var = premiumPreviewFragment.U;
                i0.b bVar2 = premiumPreviewFragment.f31460o0;
                ax0Var.setPadding(bVar2.f10576a, 0, bVar2.f10578c, 0);
                FrameLayout frameLayout = premiumPreviewFragment.J;
                if (frameLayout != null) {
                    int i12 = premiumPreviewFragment.f31460o0.f10576a;
                    int dp = AndroidUtilities.dp(14.0f);
                    i0.b bVar3 = premiumPreviewFragment.f31460o0;
                    frameLayout.setPadding(i12, dp, bVar3.f10578c, bVar3.d);
                }
                return r0.l1.f42140b;
            default:
                yg0 yg0Var = (yg0) ((th1) this.f35620b);
                ...
                View view2 = yg0Var.f40149y.f32426b;
                ...
                yg0Var.f40149y.setPadding(0, 0, 0, yg0Var.L);
                ...
                ViewGroup.MarginLayoutParams marginLayoutParams2 = (ViewGroup.MarginLayoutParams) yg0Var.f38127c.getLayoutParams();
                if (marginLayoutParams2.bottomMargin != i11 || marginLayoutParams2.leftMargin != i13 || marginLayoutParams2.rightMargin != i14) {
                    ...
                    yg0Var.f38127c.setLayoutParams(marginLayoutParams2);
                }
                yg0Var.E.setPadding(i13, 0, i14, yg0Var.L);
                if (z10) {
                    l1Var = l1Var.f42141a.m(0, 0, 0, yg0Var.L);
                }
                yg0Var.i0();
                yg0Var.h0();
                SparseArray sparseArray = yg0Var.f38125a;
                int size = sparseArray.size();
                for (int i15 = 0; i15 < size; i15++) {
                    rh1 rh1Var = (rh1) sparseArray.valueAt(i15);
                    if (rh1Var != null && (fragmentView = rh1Var.f37338a.getFragmentView()) != null) {
    ...
    public void a(int i10) {
        ph1 ph1Var = (ph1) this.f35620b;
        if (ph1Var.h == null && !ph1Var.f36551f.e()) {
            ph1Var.v.f31898f.e(false, true);
        }
        ph1Var.l();
    }
    ...
    public void c(org.telegram.ui.Components.wz wzVar) {
        ...
        wzVar.f(new org.telegram.ui.Components.xz((MediaController.SavedFilterState) this.f35620b));
    }
    ...
    public boolean d(int i10, View view) {
        switch (this.f35619a) {
            case 17:
                return ((n71) this.f35620b).Q(i10, view);
            case 18:
                final sa1 sa1Var = (sa1) this.f35620b;
                org.telegram.ui.ActionBar.a2[] a2VarArr = sa1Var.f37679h0;
                x91 x91Var = sa1Var.X;
                int i11 = x91Var.I;
                if (i10 >= i11 && i10 <= x91Var.J) {
                    final MessageObject messageObject = ((pa1) sa1Var.f37695v0.get(i10 - i11)).f36487b;
                        ...
                        public final void run() {
                            switch (r3) {
                                ...
                                default:
                                    ...
                                    bundle.putLong("chat_id", sa1Var3.f37670b);
                    ...
                    if (i10 >= i12 && i10 <= x91Var.V) {
                        ((la1) sa1Var.Q.get(i10 - i12)).c(sa1Var.f37668a, sa1Var, a2VarArr, true);
                    } else {
                        int i13 = x91Var.R;
                        if (i10 >= i13 && i10 <= x91Var.S) {
                            ((la1) sa1Var.O.get(i10 - i13)).c(sa1Var.f37668a, sa1Var, a2VarArr, true);
                        } else {
                            int i14 = x91Var.X;
                            if (i10 < i14 || i10 > x91Var.Y) {
                                return false;
                            }
                            ((la1) sa1Var.P.get(i10 - i14)).c(sa1Var.f37668a, sa1Var, a2VarArr, true);
                        }
                    }
                }
                return true;
            default:
                ((le1) this.f35620b).J.d(i10, view);
                return true;
        }
    }
    ...
    public void f(org.telegram.ui.ActionBar.a2 a2Var, int i10) {
        ...
        switch (this.f35619a) {
            case 3:
                PhotoViewer photoViewer = ((it0) this.f35620b).f34577b;
                try {
                    AndroidUtilities.openForView(photoViewer.T4, photoViewer.f31402y, photoViewer.f31375v2, true);
            ...
            case 4:
                ((rv0) this.f35620b).finishFragment();
                return;
            case 5:
                ((lv0) this.f35620b).f35417a.R.r();
                return;
            case 7:
                PopupNotificationActivity popupNotificationActivity = (PopupNotificationActivity) this.f35620b;
                int i14 = PopupNotificationActivity.f31430b0;
            ...
            case 11:
                ((org.telegram.messenger.lk) this.f35620b).run(1);
                return;
            case 14:
                ProxyListActivity proxyListActivity = ((v11) this.f35620b).f38601b;
                ...
                return;
            case 20:
                ThemeActivity themeActivity = ((nb1) this.f35620b).f35845a;
                ...
                if (k02) {
                    ...
                    yb1 yb1Var2 = themeActivity.f31836a;
                    i13 = themeActivity.bubbleRadiusRow;
                    yb1Var2.n(i13, new Object());
                }
                if (themeActivity.f31840c != null) {
                    ...
                    SparseArray sparseArray = N0.f18934a0;
                    int i17 = org.telegram.ui.ActionBar.h6.f19237n;
                    ...
                    if (f6Var != null) {
                        ...
                        z5Var.f19961c = "d";
                        z5Var.f19959a = "Blue_99_wp.jpg";
                        z5Var.f19960b = "Blue_99_wp.jpg";
                        f6Var.f18906y = z5Var;
                        N0.v(z5Var);
                    }
                    if (N0 != A0) {
                ...
                return;
            case 21:
                od1 od1Var = ((rc1) this.f35620b).f37299a;
                org.telegram.ui.ActionBar.h6.j0(od1Var.f36167e0, od1Var.f36202s, true);
                org.telegram.ui.ActionBar.h6.o();
                org.telegram.ui.ActionBar.h6.n1(false, false);
                NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.needSetDayNightTheme, od1Var.f36167e0, Boolean.valueOf(od1Var.f36171f0), null, -1);
                od1Var.finishFragment();
                return;
            default:
                ((xg1) this.f35620b).f39922a.E0(true);
                return;
        }
    }
    ...
    public void mo17run(Object obj, Object obj2, Object obj3, Object obj4, Object obj5) {
        switch (this.f35619a) {
            case 0:
                ...
                ((Float) obj4).getClass();
                ((Float) obj5).getClass();
                PasskeysActivity.W((PasskeysActivity) this.f35620b, (org.telegram.ui.Components.v51) obj, (View) obj2);
                return;
            default:
                s31 s31Var = (s31) this.f35620b;
                ...
                if (v51Var.f15715a == 30) {
                    ...
                    t31.H(t31Var, v51Var.f29049l, null, null);
                    return;
                }
                return;
        }
    ...
    public void run(long j3) {
        AndroidUtilities.runOnUIThread(new org.telegram.messenger.qh((SharedConfig.ProxyInfo) this.f35620b, j3, 1));
    }

    @Override
    public Object run(Object obj, Object obj2) {
        Integer num = (Integer) obj2;
        PrivacyControlActivity privacyControlActivity = ((qx0) this.f35620b).d;
        if (((Integer) obj).intValue() == 0) {
            if (!privacyControlActivity.getUserConfig().isPremium()) {
                if (privacyControlActivity.f31511z0 == null) {
                    ...
                    privacyControlActivity.f31511z0 = spannableString;
                }
                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
                spannableStringBuilder.append((CharSequence) privacyControlActivity.f31511z0);
