    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f36356a) {
            case 0:
                ...
                dj0 dj0Var = this.f36357b;
                pi0 pi0Var = dj0Var.f33136a0;
                pi0Var.e(canvas);
                ...
                if (!arrayList.isEmpty()) {
                    ...
                    if (mediaLocation != null) {
                        if (hzVar.f34397s == null) {
                            TLRPC.Document document = mediaLocation.document;
                            if (document != null) {
                                hzVar.f34397s = FileLoader.getAttachFileName(document, "tgs");
                            } else {
                                hzVar.f34397s = FileLoader.getAttachFileName(mediaLocation.location, "tgs");
                            }
                        }
                        if (hzVar.f34397s != null) {
                            Float fileProgress = ImageLoader.getInstance().getFileProgress(hzVar.f34397s);
                ...
                return;
            default:
                dj0 dj0Var2 = this.f36357b;
                mb0 mb0Var = dj0Var2.d;
                if (mb0Var != null) {
                    if (dj0Var2.E == 1.0f && dj0Var2.f33151n != null) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
                ...
                if (dj0Var2.E > 0.0f && dj0Var2.f33151n != null) {
                    dj0Var2.f33156r.reset();
                    float width = getWidth() / dj0Var2.f33143f.getWidth();
                    dj0Var2.f33156r.postScale(width, width);
                    dj0Var2.h.setLocalMatrix(dj0Var2.f33156r);
                    dj0Var2.f33151n.setAlpha((int) (dj0Var2.E * 255.0f));
                    canvas2 = canvas;
                    canvas2.drawRect(0.0f, 0.0f, getWidth(), getHeight(), dj0Var2.f33151n);
                } else {
                    canvas2 = canvas;
                }
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        switch (this.f36356a) {
            case 1:
                ...
                dj0 dj0Var = this.f36357b;
                if (!dj0Var.f33145g0 || dj0Var.f33146h0) {
                    ...
                    if (dj0Var.F.getWidth() > 0) {
                        ...
                        FrameLayout frameLayout = dj0Var.f33141d0;
                        if (frameLayout != null) {
                            frameLayout.setX(hg.k0.f(6.0f, (dj0Var.X.l() + iArr[0]) - dj0Var.f33141d0.getMeasuredWidth(), 0));
                            RectF rectF = dj0Var.f33150l0;
                            if (rectF != null) {
                                FrameLayout frameLayout2 = dj0Var.f33141d0;
                                float max = Math.max(dj0Var.e.f10592b, rectF.top - frameLayout2.getMeasuredWidth());
                                dj0Var.f33140c0 = max;
                                frameLayout2.setY(max);
                                ri0 ri0Var = dj0Var.f33142e0;
                                if (ri0Var != null) {
                                    ri0Var.setY(Math.max(dj0Var.e.f10592b, (dj0Var.f33150l0.top - AndroidUtilities.dp(24.0f)) - dj0Var.f33142e0.getMeasuredHeight()));
                                }
                            } else {
                                float height2 = (dj0Var.X.getHeight() + iArr[1]) - wi0Var.getMeasuredHeight();
                                FrameLayout frameLayout3 = dj0Var.f33141d0;
                                float max2 = Math.max(dj0Var.e.f10592b, height2 - frameLayout3.getMeasuredHeight()) + AndroidUtilities.dp(24.0f);
                                dj0Var.f33140c0 = max2;
                                frameLayout3.setY(max2);
                                ri0 ri0Var2 = dj0Var.f33142e0;
                                if (ri0Var2 != null) {
                                    ri0Var2.setY(Math.max(0.0f, (height2 - ri0Var2.getMeasuredHeight()) - dj0Var.f33140c0));
                                }
                            }
                        }
                    }
                    dj0Var.f33145g0 = true;
                    return;
                }
                return;
            default:
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        switch (this.f36356a) {
            case 1:
                ...
                dj0 dj0Var = this.f36357b;
                gh.d.c(dj0Var.f33148j0, dj0Var.F);
                ViewGroup viewGroup = dj0Var.Z;
                if (viewGroup != null) {
