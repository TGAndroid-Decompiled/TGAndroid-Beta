...
public final class oi0 extends org.telegram.ui.Components.xl0 {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        vi0 vi0Var = this.f36251b3;
        if (vi0Var.f38753w && ((view == (u1Var = vi0Var.Q) && u1Var != null && u1Var.getCurrentPosition() == null) || view == vi0Var.X)) {
            return false;
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int max = Math.max(AndroidUtilities.dp(12.0f) + l4, -((AndroidUtilities.dp(7.0f) + vi0Var.f38743o0[0]) - getMeasuredWidth()));
        int i13 = vi0Var.O;
