...
public final class ic1 extends FrameLayout {
    public final org.telegram.ui.Cells.ja f34545a;
    public final org.telegram.ui.Components.uo0 f34546b;
    ...
    public final void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        this.f34546b.getSeekBarAccessibilityDelegate().e(this, accessibilityNodeInfo);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f34548f != size) {
            int i12 = SharedConfig.fontSize;
            int i13 = this.f34547c;
            this.f34546b.setProgress((i12 - i13) / (this.d - i13));
            this.f34548f = size;
        }
    }
    ...
    public final boolean performAccessibilityAction(int i10, Bundle bundle) {
        if (!super.performAccessibilityAction(i10, bundle) && !this.f34546b.getSeekBarAccessibilityDelegate().g(this, i10, bundle)) {
            return false;
        }
        return true;
    }
