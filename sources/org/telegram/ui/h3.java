...
public final class h3 implements q0.a {
    ...
    public final void accept(Object obj) {
        ...
        switch (this.f36870a) {
            case 0:
                m3 m3Var = (m3) this.f36871b;
                Float f7 = (Float) obj;
                i4 i4Var = m3Var.K;
                if (m3Var == i4Var.f37232u0[0]) {
                    if (i4Var.f37220h0.f42280d0.getCurrentProgress() > f7.floatValue()) {
                        i4Var.f37220h0.f42280d0.a(0.0f, false);
                    }
                    i4Var.f37220h0.f42280d0.a(f7.floatValue(), true);
                    return;
                }
                return;
            case 1:
                ((org.telegram.ui.Components.pj0) this.f36871b).h((List) obj);
                return;
            case 2:
                TLRPC.User user = (TLRPC.User) obj;
                vr vrVar = ((mr) this.f36871b).f38749b;
                pr w02 = vrVar.w0();
            ...
            case 4:
                ...
                return;
            case 5:
                ((ArrayList) this.f36871b).add((TLRPC.User) obj);
                return;
            case 6:
                ProfileActivity profileActivity = (ProfileActivity) this.f36871b;
                TLRPC.User user2 = (TLRPC.User) obj;
                for (int i11 = 0; i11 < profileActivity.f33999u2.participants.participants.size(); i11++) {
                    if (profileActivity.f33999u2.participants.participants.get(i11).user_id == user2.f20016id) {
                ...
                return;
            default:
                View view = ((ProxyListActivity) this.f36871b).f34038b.T((View) obj).f45738a;
