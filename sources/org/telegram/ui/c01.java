...
public final class c01 extends org.telegram.ui.Components.pv0 implements r0.m {
    ...
    public final b2.q0 f32210w0;
    public final ProfileActivity f32211x0;
    public boolean f32212y0;
    public final Paint f32213z0;

    public c01(ProfileActivity profileActivity, Context context) {
        super(context, null);
        this.D0 = profileActivity;
        this.f32211x0 = profileActivity;
        this.f32210w0 = new Object();
        this.f32213z0 = new Paint();
    ...
    public final void E(ViewGroup viewGroup, int i10, int i11, int[] iArr, int i12) {
        ...
        int L0;
        int max;
        ProfileActivity profileActivity = this.f32211x0;
        if (viewGroup == profileActivity.f31209a) {
            int i14 = -1;
            if (profileActivity.J4 != -1 && profileActivity.Q) {
                kVar = ((org.telegram.ui.ActionBar.n2) profileActivity).actionBar;
                boolean z10 = kVar.f19296n0;
    ...
    public final void L(Canvas canvas, ArrayList arrayList) {
        canvas.save();
        ProfileActivity profileActivity = this.f32211x0;
        canvas.translate(0.0f, profileActivity.f31209a.getY());
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        org.telegram.ui.Components.g50 g50Var = profileActivity.f31371x0;
        Paint paint = profileActivity.f31322q2;
        fh.d dVar = profileActivity.f31306n6;
        ah.h hVar = profileActivity.f31298m6;
        Paint paint2 = profileActivity.f31378y0;
        if (Build.VERSION.SDK_INT >= 31 && hVar != null) {
            ...
            if (dVar != null && !dVar.f9061n) {
                ...
                a2.drawColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18733a7, profileActivity.f31383z0));
        ...
        paint.setColor(org.telegram.ui.ActionBar.h6.v0(i10, profileActivity.f31383z0));
        if (profileActivity.f31209a.getVisibility() == 0) {
            int v02 = org.telegram.ui.ActionBar.h6.v0(i10, profileActivity.f31383z0);
            Paint paint3 = this.f32213z0;
            paint3.setColor(v02);
            if (profileActivity.H1) {
                paint.setAlpha((int) (profileActivity.f31209a.getAlpha() * 255.0f));
            }
            if (profileActivity.H1) {
                paint3.setAlpha((int) (profileActivity.f31209a.getAlpha() * 255.0f));
            }
            ...
            for (int i11 = 0; i11 < childCount; i11++) {
                View childAt = profileActivity.f31209a.getChildAt(i11);
                profileActivity.f31209a.getClass();
                if (RecyclerView.R(childAt) != -1) {
                    arrayList.add(profileActivity.f31209a.getChildAt(i11));
                } else {
                    z11 = true;
                }
            }
            Collections.sort(arrayList, this.C0);
            profileActivity.f31209a.getY();
        ...
        if (g50Var.getAlpha() > 0) {
            canvas.drawRect(0.0f, 0.0f, getWidth(), getHeight(), profileActivity.f31371x0);
        }
        if (profileActivity.f31364w0 != null) {
            int save = canvas.save();
            canvas.translate(profileActivity.f31364w0.getLeft(), profileActivity.f31364w0.getTop());
            View view2 = profileActivity.f31364w0;
            kVar = ((org.telegram.ui.ActionBar.n2) profileActivity).actionBar;
            if (view2 == kVar.getBackButton()) {
                int alpha = paint2.getAlpha();
                paint2.setAlpha((int) (((g50Var.getAlpha() / 255.0f) * alpha) / 0.3f));
                float max = Math.max(profileActivity.f31364w0.getMeasuredWidth(), profileActivity.f31364w0.getMeasuredHeight()) / 2;
                canvas.drawCircle(max, max, 0.7f * max, paint2);
                paint2.setAlpha(alpha);
            }
            profileActivity.f31364w0.draw(canvas);
        ...
        if (!profileActivity.I0) {
            ...
            int v03 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18789d6, profileActivity.f31383z0);
            int i13 = profileActivity.f31292l6;
            yy0 yy0Var2 = profileActivity.f31209a;
            if (yy0Var2 != null) {
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (e01Var != null && (rt0Var = (rt0VarArr = e01Var.f30426k0)[0]) != null && rt0Var.h.getFastScroll() != null && rt0VarArr[0].h.getFastScroll().f28236n) {
    ...
    public final void j(ViewGroup viewGroup, int i10, int i11, int i12, int i13, int i14, int[] iArr) {
        ProfileActivity profileActivity = this.f32211x0;
        try {
            if (viewGroup == profileActivity.f31209a && profileActivity.Q) {
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        ProfileActivity profileActivity = this.D0;
        gh.d.c(profileActivity.f31319p6, profileActivity.fragmentView);
        profileActivity.q6.d();
    }

    @Override
    public final boolean p(View view, View view2, int i10, int i11) {
        if (this.f32211x0.J4 != -1 && i10 == 2) {
            return true;
        }
        return false;
    }
