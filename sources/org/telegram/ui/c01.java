...
public final class c01 extends org.telegram.ui.Components.jv0 {
    public boolean f32536f2;
    public final ProfileActivity f32537g2;
    ...
    public c01(ProfileActivity profileActivity, Context context, long j3, org.telegram.ui.Components.bv0 bv0Var, int i10, ArrayList arrayList, TLRPC.ChatFull chatFull, TLRPC.UserFull userFull, int i11, int i12, ProfileActivity profileActivity2, ProfileActivity profileActivity3, org.telegram.ui.ActionBar.d6 d6Var, ah.c cVar) {
        ...
        this.f32537g2 = profileActivity;
    }

    @Override
    public final void D0(SparseArray sparseArray) {
        char c10;
        ProfileActivity profileActivity = this.f32537g2;
        if (profileActivity.f31651s1) {
            ...
            if (c10 >= 0) {
                ...
                profileActivity.f31684w5[c10].b(size, true);
            }
        }
    }
    ...
    public final void E0() {
        ...
        ProfileActivity profileActivity = this.f32537g2;
        if (profileActivity.f31651s1 && (frameLayout = profileActivity.f31662t5[0]) != null && profileActivity.O != null) {
    ...
    public final boolean I0(TLRPC.ChatParticipant chatParticipant, boolean z10, View view) {
        return this.f32537g2.h(chatParticipant, z10, false, view);
    }
    ...
    public final void M0(float f7) {
        ...
        if (c01Var != null && profileActivity.f31651s1) {
            if (profileActivity.f31662t5[0] != null) {
                profileActivity.f31662t5[0].setTranslationX(c01Var.f0(8, true));
            }
            if (profileActivity.f31662t5[1] != null) {
                profileActivity.f31662t5[1].setTranslationX(profileActivity.O.f0(9, false));
            }
            ProfileActivity.G0(profileActivity, profileActivity.f31582h6);
            profileActivity.U4();
        }
    }
    ...
    public final void P(Canvas canvas, float f7, Rect rect, Paint paint) {
        ProfileActivity profileActivity = this.f32537g2;
        profileActivity.f31612m5.J(canvas, getY() + profileActivity.f31524a.getY() + f7, rect, paint, true);
    }

    @Override
    public final int V0(int i10) {
        this.f32537g2.getClass();
        return i10;
    }
    ...
    public final boolean l0() {
        ProfileActivity profileActivity = this.f32537g2;
        if (profileActivity.f31584i1 == profileActivity.getUserConfig().getClientUserId() && !profileActivity.f31577h1) {
            return true;
        }
        return false;
    }
    ...
    public final void o0() {
        a01 a01Var = this.f32537g2.f31612m5;
        if (a01Var != null) {
            a01Var.M();
        }
    }
    ...
    public final void v1(boolean z10) {
        ...
        super.v1(z10);
        ProfileActivity profileActivity = this.f32537g2;
        boolean z11 = profileActivity.f31658t1;
        org.telegram.ui.Components.zr0 zr0Var = this.V;
        if (z11 && !profileActivity.f31680w1 && this.I0.d(14)) {
            if (!this.f32536f2 && (i11 = profileActivity.f31665u1) > 0 && zr0Var != null) {
                this.f32536f2 = true;
                zr0Var.M = i11;
                zr0Var.e();
            }
            profileActivity.f31680w1 = true;
            Y0(14);
        } else if (profileActivity.f31658t1 && profileActivity.f31680w1 && !this.f32536f2 && (i10 = profileActivity.f31665u1) > 0 && zr0Var != null) {
            this.f32536f2 = true;
            zr0Var.M = i10;
            zr0Var.e();
        }
