...
public final class c01 extends org.telegram.ui.Components.jv0 {
    ...
    public final void v1(boolean z10) {
        ...
        if (z11 && !profileActivity.f31681w1 && this.I0.d(14)) {
            if (!this.f32537f2 && (i11 = profileActivity.f31666u1) > 0 && zr0Var != null) {
                this.f32537f2 = true;
                zr0Var.M = i11;
                zr0Var.e();
            }
            ...
            Y0(14);
        } else if (profileActivity.f31659t1 && profileActivity.f31681w1 && !this.f32537f2 && (i10 = profileActivity.f31666u1) > 0 && zr0Var != null) {
            this.f32537f2 = true;
            zr0Var.M = i10;
            zr0Var.e();
        }
