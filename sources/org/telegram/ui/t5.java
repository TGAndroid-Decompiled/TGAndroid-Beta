...
public final class t5 extends FrameLayout {
    ...
    public float a() {
        zh.w3 w3Var = (zh.w3) this.f40621e;
        return (w3Var.Y0.a(3) * w3Var.A0.getMeasuredHeight()) + (w3Var.Y0.a(2) * w3Var.f52793y0.getMeasuredHeight()) + (w3Var.Y0.a(1) * w3Var.f52786r0.getMeasuredHeight()) + (w3Var.Y0.a(0) * w3Var.f52765f0.getMeasuredHeight()) + w3Var.f52763e0.getRealHeight() + 0.0f;
    }
    ...
    public void b(boolean z10) {
        ...
        float f7;
        float f10;
        ImageView imageView = (ImageView) this.f40620c;
        if (z10) {
            i10 = 0;
        } else {
            i10 = 8;
    ...
    public void c(int i10, String str) {
        ...
        ((ImageView) this.f40620c).setImageDrawable(getContext().getDrawable(i10));
    }
        ...
        while (true) {
            ...
            if (R >= 0) {
                if (R == 2) {
                    ...
                    max = childAt.getY() - w3Var.f52763e0.getRealHeight();
                    break;
                }
            }
            childCount--;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f40618a) {
            case 2:
                Path path = (Path) this.f40620c;
                org.telegram.ui.Components.u31 u31Var = (org.telegram.ui.Components.u31) this.f40621e;
                boolean z11 = true;
                ...
                u31Var.f30797x.setTranslationY(Math.max(AndroidUtilities.statusBarHeight, A));
                if (A <= AndroidUtilities.statusBarHeight / 2.0f) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                Boolean bool = (Boolean) this.f40619b;
                if (bool == null || bool.booleanValue() != z10) {
                    this.f40619b = Boolean.valueOf(z10);
                    Window window = u31Var.getWindow();
                    if (z10) {
                        v = u31Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20734h5);
                    } else {
                        v = org.telegram.ui.ActionBar.j6.v(u31Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20937s8), 855638016);
                    }
            ...
            case 3:
                ...
                Matrix matrix = (Matrix) this.f40619b;
                Paint paint = (Paint) this.f40620c;
                PhotoViewer photoViewer = (PhotoViewer) this.f40621e;
                if (!photoViewer.S4) {
                    if (photoViewer.f33626n0.getVisibility() == 0) {
            ...
            default:
                ...
                return;
            case 5:
                Paint paint2 = (Paint) this.f40619b;
                ...
                Paint paint4 = (Paint) this.f40620c;
                paint4.setColor(0);
                float dpf2 = AndroidUtilities.dpf2(1.0f);
                float dpf22 = AndroidUtilities.dpf2(0.33f);
                wd1 wd1Var = (wd1) this.f40621e;
                ...
                if (wd1Var.M1) {
                    ...
                    if (f7 > 0.0f) {
                        paint2.setColor(i0.a.k(-16777216, (int) (f7 * 255.0f * wd1Var.f41956o1)));
                ...
                return;
            case 7:
                org.telegram.ui.ActionBar.f6 f6Var = (org.telegram.ui.ActionBar.f6) this.f40619b;
                Paint paint5 = (Paint) this.f40620c;
                LimitPreviewView limitPreviewView = (LimitPreviewView) this.f40621e;
                if (limitPreviewView.P) {
                    if (!limitPreviewView.f24050c0 && !limitPreviewView.R) {
                        paint5.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.e7, f6Var));
                    } else {
                        paint5.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20753i6, f6Var));
                    }
                } else {
                    paint5.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20607a7, f6Var));
                }
                RectF rectF3 = AndroidUtilities.rectTmp;
                rectF3.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                sg.t tVar = limitPreviewView.f24053e0;
                if (tVar != null) {
                    canvas.drawRoundRect(rectF3, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), ((v5) ((z0) tVar).f43251b).t0(getX() + ((ViewGroup) getParent()).getX(), getY() + ((ViewGroup) getParent()).getY()));
                } else {
                    canvas.drawRoundRect(rectF3, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), paint5);
                }
                canvas.save();
                if (!limitPreviewView.P) {
                    canvas.clipRect(limitPreviewView.f24061n, 0, getMeasuredWidth(), getMeasuredHeight());
                }
                ...
                ViewGroup viewGroup = limitPreviewView.f24066y;
                if (viewGroup != null) {
                    sg.c1 c1Var = limitPreviewView.E;
                    if (c1Var != null) {
                        e7 = c1Var.f46035f;
                        c1Var.a();
                        Matrix matrix2 = c1Var.f46034e;
                        matrix2.reset();
                        matrix2.postScale(1.0f, limitPreviewView.f24049c / 100.0f, 0.0f, 0.0f);
                ...
                if (limitPreviewView.V && (valueAnimator2 = limitPreviewView.f24058i0) != null) {
                    e7.setAlpha((int) ((1.0f - ((Float) valueAnimator2.getAnimatedValue()).floatValue()) * alpha2));
                } else if (limitPreviewView.U && (valueAnimator = limitPreviewView.f24058i0) != null) {
                    e7.setAlpha((int) (((Float) valueAnimator.getAnimatedValue()).floatValue() * alpha2));
                }
                if (limitPreviewView.P) {
                    if (!limitPreviewView.L && !limitPreviewView.M) {
                        AndroidUtilities.rectTmp.set(0.0f, 0.0f, limitPreviewView.f24061n, getMeasuredHeight());
                    } else {
                        AndroidUtilities.rectTmp.set(limitPreviewView.f24061n, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                    }
                }
                canvas.drawRoundRect(AndroidUtilities.rectTmp, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), e7);
                e7.setAlpha(alpha2);
                canvas.restore();
                if (limitPreviewView.E == null && limitPreviewView.f24051d0) {
                    invalidate();
                }
                super.dispatchDraw(canvas);
                return;
            case 8:
                ...
                paint6.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Ii, (org.telegram.ui.ActionBar.f6) this.f40619b));
                sg.g0 g0Var = (sg.g0) this.f40621e;
                ...
                sg.c1 c1Var2 = (sg.c1) this.f40620c;
                c1Var2.e(rectF4);
                canvas.drawRoundRect(rectF4, AndroidUtilities.dp(15.0f), AndroidUtilities.dp(15.0f), c1Var2.f46035f);
                canvas.restore();
                super.dispatchDraw(canvas);
                return;
            case 9:
                Drawable drawable3 = (Drawable) this.f40619b;
                sg.a1 a1Var = (sg.a1) this.f40621e;
            ...
            case 11:
                ...
                RectF rectF5 = (RectF) this.f40619b;
                rectF5.set(zh.w3.n1(w3Var), d11, getWidth() - zh.w3.o1(w3Var), getHeight() + dp2);
                Paint paint7 = (Paint) this.f40620c;
                paint7.setColor(w3Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20734h5));
                ...
                e();
                canvas.restore();
                org.telegram.ui.Components.xa xaVar = w3Var.f24647e;
    ...
    public void draw(Canvas canvas) {
        switch (this.f40618a) {
            case 0:
                RectF rectF = (RectF) this.f40619b;
                rectF.set(0.0f, 0.0f, getWidth(), getHeight());
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(10.0f), AndroidUtilities.dp(10.0f), ((v5) this.f40621e).t0(getX() + ((ViewGroup) getParent()).getX(), ((ViewGroup) getParent().getParent().getParent()).getY()));
                invalidate();
                super.draw(canvas);
                return;
            default:
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        switch (this.f40618a) {
            case 6:
                ...
                Path path = (Path) this.f40619b;
                Matrix matrix = (Matrix) this.f40620c;
                di.c6 c6Var = (di.c6) this.f40621e;
                rg.z0 z0Var = c6Var.f45190r0;
                if (view == c6Var.f45195w0) {
                    ...
                    matrix.postScale((c6Var.f45197y0 / c6Var.f45195w0.getWidth()) * max, (c6Var.f45198z0 / c6Var.f45195w0.getHeight()) * max);
                    matrix.postTranslate((photoImage.getCenterX() + (q6.getX() + z0Var.getX())) - ((c6Var.f45197y0 * max) / 2.0f), (photoImage.getCenterY() + (q6.getY() + z0Var.getY())) - ((c6Var.f45198z0 * max) / 2.0f));
                    c6Var.f45195w0.setTransform(matrix);
                    canvas.save();
                    path.rewind();
            ...
            default:
                return super.drawChild(canvas, view, j3);
            case 9:
                Path path2 = (Path) this.f40620c;
                if (view == ((ScrollView) this.d)) {
                    canvas.save();
                    path2.rewind();
                    RectF rectF = AndroidUtilities.rectTmp;
                    rectF.set(getPaddingLeft(), AndroidUtilities.dp(18.0f) + ((sg.a1) this.f40621e).M, getMeasuredWidth() - getPaddingRight(), getMeasuredHeight());
            ...
            case 10:
                ...
                yf.z zVar2 = (yf.z) this.f40620c;
                boolean drawChild2 = super.drawChild(canvas, view, j3);
                uh.f fVar = (uh.f) this.f40621e;
                int i12 = (int) fVar.X.f15376e;
                if (view == fVar.f47254h0 && i12 > 0) {
            ...
            case 11:
                zh.w3 w3Var = (zh.w3) this.f40621e;
                if (view == w3Var.f24647e) {
                    return false;
                }
                if (view != w3Var.f52761d0) {
                    canvas.save();
    ...
    public void e() {
        ...
        w3Var.f52765f0.setTranslationY(t3Var.getRealHeight() + d);
        w3Var.f52786r0.setTranslationY(t3Var.getRealHeight() + d);
        w3Var.f52793y0.setTranslationY(t3Var.getRealHeight() + d);
        ...
        AndroidUtilities.updateViewVisibilityAnimated(w3Var.f52779n0, w3Var.d.canScrollVertically(1));
    }
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f40618a) {
            case 1:
                ...
                path.close();
                Paint paint = (Paint) this.f40621e;
                paint.setColor(2130706432);
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        switch (this.f40618a) {
            ...
            case 11:
                ...
                if (n0Var != null) {
                    int finalHeight = w3Var.f52763e0.getFinalHeight();
                    int z12 = w3Var.z1();
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.f40618a) {
            ...
            case 7:
                org.telegram.ui.ActionBar.f6 f6Var = (org.telegram.ui.ActionBar.f6) this.f40619b;
                LimitPreviewView limitPreviewView = (LimitPreviewView) this.f40621e;
                TextView textView = limitPreviewView.f24064w;
                org.telegram.ui.Components.ig0 ig0Var = limitPreviewView.f24056g0;
                org.telegram.ui.Components.q6 q6Var = limitPreviewView.N;
                org.telegram.ui.Components.ig0 ig0Var2 = limitPreviewView.f24055f0;
                ...
                if (getChildCount() == 2) {
                    ...
                    if (limitPreviewView.P) {
                        ...
                        int i19 = -1;
                        if (f7 == 0.0f) {
                            limitPreviewView.f24061n = 0;
                            if (!limitPreviewView.U && !limitPreviewView.V) {
                                if (limitPreviewView.L || limitPreviewView.f24053e0 != null) {
                                    v03 = -1;
                                } else {
                            ...
                            limitPreviewView.f24061n = (int) ((((size - measuredWidth) - f10) * limitPreviewView.f24045a) + measuredWidth);
                            if (!limitPreviewView.U && !limitPreviewView.V) {
                                if (limitPreviewView.L || limitPreviewView.f24053e0 != null) {
                                    v02 = -1;
                                } else {
                        ...
                        int clamp = (int) Utilities.clamp(size * limitPreviewView.f24045a, size - Math.max(measuredWidth5, measuredWidth6 + i18), max);
                        limitPreviewView.f24061n = clamp;
                        ig0Var2.measure(View.MeasureSpec.makeMeasureSpec(clamp, 1073741824), View.MeasureSpec.makeMeasureSpec(size2, 1073741824));
                        ig0Var.measure(View.MeasureSpec.makeMeasureSpec(size - limitPreviewView.f24061n, 1073741824), View.MeasureSpec.makeMeasureSpec(size2, 1073741824));
                    }
            ...
            case 11:
                ...
                w3Var.f52763e0.L.setPadding(0, 0, 0, bottomInset);
        ...
        switch (this.f40618a) {
            case 3:
                ...
                if (at0Var != null && at0Var.getVisibility() != 8) {
                    photoViewer.U1.setAlpha(photoViewer.f33734y7[0] * f7);
                }
                bt0 bt0Var = photoViewer.V1;
                if (bt0Var != null && bt0Var.getVisibility() != 8) {
                    photoViewer.V1.setAlpha(f7 * photoViewer.f33743z7[0]);
                    return;
                }
                return;
            default:
    ...
    public void setTranslationY(float f7) {
        switch (this.f40618a) {
            ...
            case 9:
                super.setTranslationY(f7);
                ((sg.a1) this.f40621e).onContainerTranslationYChanged(f7);
                return;
            case 11:
                super.setTranslationY(f7);
                FrameLayout frameLayout3 = ((zh.w3) this.f40621e).topBulletinContainer;
    ...
    public t5(di.c6 c6Var, Context context) {
        super(context);
        this.f40621e = c6Var;
        this.f40620c = new Matrix();
        this.d = new float[8];
        this.f40619b = new Path();
    }

    public t5(LimitPreviewView limitPreviewView, Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f40621e = limitPreviewView;
        this.f40619b = f6Var;
        this.f40620c = new Paint();
    ...
    public t5(sg.a1 a1Var, Context context, ScrollView scrollView, Drawable drawable) {
        ...
        this.f40621e = a1Var;
        this.d = scrollView;
        this.f40619b = drawable;
        this.f40620c = new Path();
    }
    ...
    public t5(org.telegram.ui.Components.u31 u31Var, Context context) {
        ...
        this.d = paint;
        paint.setColor(u31Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20734h5));
    ...
    public t5(wd1 wd1Var, Activity activity) {
        super(activity);
        this.f40621e = wd1Var;
        this.f40620c = new Paint(1);
        this.d = new Paint(1);
        this.f40619b = new Paint(1);
    }
    ...
    public t5(sg.g0 g0Var, Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f40621e = g0Var;
        this.f40619b = f6Var;
        this.f40620c = new sg.c1(org.telegram.ui.ActionBar.j6.Lj, org.telegram.ui.ActionBar.j6.Mj, -1, -1, f6Var);
        Paint paint = new Paint(1);
        this.d = paint;
