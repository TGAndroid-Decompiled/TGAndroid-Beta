...
public final class t5 extends FrameLayout {
    public final int f37966a = 1;
    public Object f37967b;
    public Object f37968c;
    public Object d;
    public Object e;
    ...
    public float a() {
        ...
        return (x3Var.Y0.a(3) * x3Var.A0.getMeasuredHeight()) + (x3Var.Y0.a(2) * x3Var.f48265y0.getMeasuredHeight()) + (x3Var.Y0.a(1) * x3Var.f48258r0.getMeasuredHeight()) + (x3Var.Y0.a(0) * x3Var.f48237f0.getMeasuredHeight()) + x3Var.f48235e0.getRealHeight() + 0.0f;
    }
    ...
    public void b(boolean z10) {
        ...
        float f7;
        float f10;
        ImageView imageView = (ImageView) this.f37968c;
        if (z10) {
            i10 = 0;
        } else {
            i10 = 8;
    ...
    public void c(int i10, String str) {
        ...
        ((ImageView) this.f37968c).setImageDrawable(getContext().getDrawable(i10));
    }
    ...
    public float d() {
        ...
        yh.x3 x3Var = (yh.x3) this.e;
        org.telegram.ui.Components.xl0 xl0Var = x3Var.d;
        int childCount = xl0Var.getChildCount() - 1;
        while (true) {
            if (childCount < 0) {
                break;
            }
            View childAt = xl0Var.getChildAt(childCount);
            xl0Var.getClass();
            ...
            if (R >= 0) {
                if (R == 2) {
                    ...
                    max = childAt.getY() - x3Var.f48235e0.getRealHeight();
                    break;
                }
            }
            childCount--;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f37966a) {
            case 2:
                ...
                j41Var.f25260x.setTranslationY(Math.max(AndroidUtilities.statusBarHeight, z12));
                if (z12 <= AndroidUtilities.statusBarHeight / 2.0f) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                Boolean bool = (Boolean) this.f37967b;
                if (bool == null || bool.booleanValue() != z10) {
                    this.f37967b = Boolean.valueOf(z10);
                    Window window = j41Var.getWindow();
                    if (z10) {
                        v = j41Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19129h5);
                    } else {
                        v = org.telegram.ui.ActionBar.h6.v(j41Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19337s8), 855638016);
                    }
            ...
            case 3:
                ...
                Matrix matrix = (Matrix) this.f37967b;
                Paint paint = (Paint) this.f37968c;
                PhotoViewer photoViewer = (PhotoViewer) this.e;
                if (!photoViewer.S4) {
                    if (photoViewer.f31299n0.getVisibility() == 0) {
            ...
            default:
                ...
                return;
            case 5:
                Paint paint2 = (Paint) this.f37967b;
                ...
                Paint paint4 = (Paint) this.f37968c;
                paint4.setColor(0);
                ...
                if (od1Var.M1) {
                    ...
                    if (f7 > 0.0f) {
                        paint2.setColor(i0.a.k(-16777216, (int) (f7 * 255.0f * od1Var.f36192o1)));
                ...
                return;
            case 7:
                org.telegram.ui.ActionBar.d6 d6Var = (org.telegram.ui.ActionBar.d6) this.f37967b;
                Paint paint5 = (Paint) this.f37968c;
                ...
                if (tVar != null) {
                    canvas.drawRoundRect(rectF3, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), ((v5) ((z0) tVar).f40299b).t0(getX() + ((ViewGroup) getParent()).getX(), getY() + ((ViewGroup) getParent()).getY()));
                } else {
            ...
            case 8:
                ...
                paint6.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Ii, (org.telegram.ui.ActionBar.d6) this.f37967b));
                ...
                rg.z0 z0Var2 = (rg.z0) this.f37968c;
                z0Var2.e(rectF4);
                canvas.drawRoundRect(rectF4, AndroidUtilities.dp(15.0f), AndroidUtilities.dp(15.0f), z0Var2.f42839f);
                canvas.restore();
                super.dispatchDraw(canvas);
                return;
            case 9:
                Drawable drawable3 = (Drawable) this.f37967b;
    ...
    public void draw(Canvas canvas) {
        switch (this.f37966a) {
            case 0:
                RectF rectF = (RectF) this.f37967b;
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        switch (this.f37966a) {
            case 6:
                ...
                Path path = (Path) this.f37967b;
                Matrix matrix = (Matrix) this.f37968c;
                ci.b6 b6Var = (ci.b6) this.e;
                qg.y0 y0Var = b6Var.f41629r0;
                if (view == b6Var.f41634w0) {
                    ...
                    matrix.postScale((b6Var.f41636y0 / b6Var.f41634w0.getWidth()) * max, (b6Var.f41637z0 / b6Var.f41634w0.getHeight()) * max);
                    matrix.postTranslate((photoImage.getCenterX() + (q6.getX() + y0Var.getX())) - ((b6Var.f41636y0 * max) / 2.0f), (photoImage.getCenterY() + (q6.getY() + y0Var.getY())) - ((b6Var.f41637z0 * max) / 2.0f));
                    b6Var.f41634w0.setTransform(matrix);
                    canvas.save();
                    path.rewind();
            ...
            case 10:
                ...
                yf.y yVar2 = (yf.y) this.f37968c;
                boolean drawChild2 = super.drawChild(canvas, view, j3);
                th.f fVar = (th.f) this.e;
                int i12 = (int) fVar.X.e;
                if (view == fVar.f43549h0 && i12 > 0) {
    ...
    public void e() {
        ...
        yh.u3 u3Var = x3Var.f48235e0;
        u3Var.setTranslationY(d);
        x3Var.f48237f0.setTranslationY(u3Var.getRealHeight() + d);
        x3Var.f48258r0.setTranslationY(u3Var.getRealHeight() + d);
        x3Var.f48265y0.setTranslationY(u3Var.getRealHeight() + d);
        ...
        AndroidUtilities.updateViewVisibilityAnimated(x3Var.f48251n0, x3Var.d.canScrollVertically(1));
    }
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        switch (this.f37966a) {
            ...
            case 11:
                ...
                if (n0Var != null) {
                    int finalHeight = x3Var.f48235e0.getFinalHeight();
                    int z12 = x3Var.z1();
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.f37966a) {
            ...
            case 7:
                ...
                org.telegram.ui.Components.tg0 tg0Var = limitPreviewView.f22333g0;
                org.telegram.ui.Components.p6 p6Var = limitPreviewView.N;
                org.telegram.ui.Components.tg0 tg0Var2 = limitPreviewView.f22332f0;
                ...
                if (getChildCount() == 2) {
                    ...
                    if (limitPreviewView.P) {
                        ...
                        tg0Var.measure(View.MeasureSpec.makeMeasureSpec(size - limitPreviewView.f22338n, 1073741824), View.MeasureSpec.makeMeasureSpec(size2, 1073741824));
                    }
            ...
            case 11:
                ...
                x3Var.f48235e0.L.setPadding(0, 0, 0, bottomInset);
        ...
        switch (this.f37966a) {
            case 3:
                ...
                if (ts0Var != null && ts0Var.getVisibility() != 8) {
                    photoViewer.U1.setAlpha(photoViewer.f31407y7[0] * f7);
                }
                us0 us0Var = photoViewer.V1;
                if (us0Var != null && us0Var.getVisibility() != 8) {
                    photoViewer.V1.setAlpha(f7 * photoViewer.f31416z7[0]);
                    return;
                }
                return;
            default:
    ...
    public t5(ci.b6 b6Var, Context context) {
        super(context);
        this.e = b6Var;
        this.f37968c = new Matrix();
        this.d = new float[8];
        this.f37967b = new Path();
    }
    ...
    public t5(rg.x0 x0Var, Context context, ScrollView scrollView, Drawable drawable) {
        ...
        this.e = x0Var;
        this.d = scrollView;
        this.f37967b = drawable;
        this.f37968c = new Path();
    }
    ...
    public t5(org.telegram.ui.Components.j41 j41Var, Context context) {
        ...
        this.d = paint;
        paint.setColor(j41Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19129h5));
    ...
    public t5(od1 od1Var, Activity activity) {
        super(activity);
        this.e = od1Var;
        this.f37968c = new Paint(1);
        this.d = new Paint(1);
        this.f37967b = new Paint(1);
    }
    ...
    public t5(rg.f0 f0Var, Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        this.e = f0Var;
        this.f37967b = d6Var;
        this.f37968c = new rg.z0(org.telegram.ui.ActionBar.h6.Lj, org.telegram.ui.ActionBar.h6.Mj, -1, -1, d6Var);
        Paint paint = new Paint(1);
        this.d = paint;
