...
public final class t5 extends FrameLayout {
    ...
    public float a() {
        ...
        return (x3Var.Y0.a(3) * x3Var.A0.getMeasuredHeight()) + (x3Var.Y0.a(2) * x3Var.f48255y0.getMeasuredHeight()) + (x3Var.Y0.a(1) * x3Var.f48248r0.getMeasuredHeight()) + (x3Var.Y0.a(0) * x3Var.f48227f0.getMeasuredHeight()) + x3Var.f48225e0.getRealHeight() + 0.0f;
    }
    ...
    public void b(boolean z10) {
        ...
        float f7;
        float f10;
        ImageView imageView = (ImageView) this.f37952c;
        if (z10) {
            i10 = 0;
        } else {
            i10 = 8;
    ...
    public void c(int i10, String str) {
        ...
        ((ImageView) this.f37952c).setImageDrawable(getContext().getDrawable(i10));
    }
        ...
        while (true) {
            ...
            if (R >= 0) {
                if (R == 2) {
                    ...
                    max = childAt.getY() - x3Var.f48225e0.getRealHeight();
                    break;
                }
            }
            childCount--;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f37950a) {
            case 2:
                ...
                i41Var.f24919x.setTranslationY(Math.max(AndroidUtilities.statusBarHeight, z12));
                if (z12 <= AndroidUtilities.statusBarHeight / 2.0f) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                Boolean bool = (Boolean) this.f37951b;
                if (bool == null || bool.booleanValue() != z10) {
                    this.f37951b = Boolean.valueOf(z10);
                    Window window = i41Var.getWindow();
                    if (z10) {
                        v = i41Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19115h5);
                    } else {
                        v = org.telegram.ui.ActionBar.h6.v(i41Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19323s8), 855638016);
                    }
            ...
            case 3:
                ...
                Matrix matrix = (Matrix) this.f37951b;
                Paint paint = (Paint) this.f37952c;
                PhotoViewer photoViewer = (PhotoViewer) this.e;
                if (!photoViewer.S4) {
                    if (photoViewer.f31286n0.getVisibility() == 0) {
            ...
            default:
                ...
                return;
            case 5:
                Paint paint2 = (Paint) this.f37951b;
                ...
                Paint paint4 = (Paint) this.f37952c;
                paint4.setColor(0);
                ...
                G.setAlpha(alpha);
                if (od1Var.M1) {
                    float f7 = od1Var.f36167n1;
                    if (f7 > 0.0f) {
                        paint2.setColor(i0.a.k(-16777216, (int) (f7 * 255.0f * od1Var.f36169o1)));
                ...
                return;
            case 7:
                org.telegram.ui.ActionBar.d6 d6Var = (org.telegram.ui.ActionBar.d6) this.f37951b;
                Paint paint5 = (Paint) this.f37952c;
                LimitPreviewView limitPreviewView = (LimitPreviewView) this.e;
                if (limitPreviewView.P) {
                    if (!limitPreviewView.f22314c0 && !limitPreviewView.R) {
                        paint5.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.e7, d6Var));
                    } else {
                        paint5.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19134i6, d6Var));
                    }
                } else {
                    paint5.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18989a7, d6Var));
                }
                RectF rectF3 = AndroidUtilities.rectTmp;
                rectF3.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                rg.t tVar = limitPreviewView.f22316e0;
                if (tVar != null) {
                    canvas.drawRoundRect(rectF3, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), ((v5) ((z0) tVar).f40284b).t0(getX() + ((ViewGroup) getParent()).getX(), getY() + ((ViewGroup) getParent()).getY()));
                } else {
                    canvas.drawRoundRect(rectF3, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), paint5);
                }
                canvas.save();
                if (!limitPreviewView.P) {
                    canvas.clipRect(limitPreviewView.f22324n, 0, getMeasuredWidth(), getMeasuredHeight());
                }
                ...
                ViewGroup viewGroup = limitPreviewView.f22329y;
                if (viewGroup != null) {
                    ...
                    if (z0Var != null) {
                        ...
                        matrix2.reset();
                        matrix2.postScale(1.0f, limitPreviewView.f22313c / 100.0f, 0.0f, 0.0f);
                ...
                if (limitPreviewView.V && (valueAnimator2 = limitPreviewView.f22321i0) != null) {
                    e.setAlpha((int) ((1.0f - ((Float) valueAnimator2.getAnimatedValue()).floatValue()) * alpha2));
                } else if (limitPreviewView.U && (valueAnimator = limitPreviewView.f22321i0) != null) {
                    e.setAlpha((int) (((Float) valueAnimator.getAnimatedValue()).floatValue() * alpha2));
                }
                if (limitPreviewView.P) {
                    if (!limitPreviewView.L && !limitPreviewView.M) {
                        AndroidUtilities.rectTmp.set(0.0f, 0.0f, limitPreviewView.f22324n, getMeasuredHeight());
                    } else {
                        AndroidUtilities.rectTmp.set(limitPreviewView.f22324n, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                    }
                }
                canvas.drawRoundRect(AndroidUtilities.rectTmp, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), e);
                e.setAlpha(alpha2);
                canvas.restore();
                if (limitPreviewView.E == null && limitPreviewView.f22315d0) {
                    invalidate();
                }
                super.dispatchDraw(canvas);
                return;
            case 8:
                ...
                paint6.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.Ii, (org.telegram.ui.ActionBar.d6) this.f37951b));
                ...
                rg.z0 z0Var2 = (rg.z0) this.f37952c;
                z0Var2.e(rectF4);
                canvas.drawRoundRect(rectF4, AndroidUtilities.dp(15.0f), AndroidUtilities.dp(15.0f), z0Var2.f42826f);
                canvas.restore();
                super.dispatchDraw(canvas);
                return;
            case 9:
                Drawable drawable3 = (Drawable) this.f37951b;
                rg.x0 x0Var = (rg.x0) this.e;
                drawable = ((org.telegram.ui.ActionBar.e3) x0Var).shadowDrawable;
                int i13 = x0Var.M;
                i11 = ((org.telegram.ui.ActionBar.e3) x0Var).backgroundPaddingTop;
                drawable.setBounds(0, org.telegram.messenger.ok.D(2.0f, i11 + i13, 1), getMeasuredWidth(), getMeasuredHeight());
            ...
            case 11:
                ...
                RectF rectF5 = (RectF) this.f37951b;
                rectF5.set(yh.x3.n1(x3Var), d11, getWidth() - yh.x3.o1(x3Var), getHeight() + dp2);
                Paint paint7 = (Paint) this.f37952c;
                paint7.setColor(x3Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19115h5));
    ...
    public void draw(Canvas canvas) {
        switch (this.f37950a) {
            case 0:
                RectF rectF = (RectF) this.f37951b;
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        switch (this.f37950a) {
            case 6:
                ...
                Path path = (Path) this.f37951b;
                Matrix matrix = (Matrix) this.f37952c;
                ci.b6 b6Var = (ci.b6) this.e;
                qg.y0 y0Var = b6Var.f41616r0;
                if (view == b6Var.f41621w0) {
                    org.telegram.ui.Cells.u1 q6 = qg.f1.q(b6Var);
                    if (q6 == null || (photoImage = q6.getPhotoImage()) == null) {
                        return false;
                    }
                    matrix.reset();
                    float max = Math.max(photoImage.getImageWidth() / b6Var.f41623y0, photoImage.getImageHeight() / b6Var.f41624z0);
                    matrix.postScale((b6Var.f41623y0 / b6Var.f41621w0.getWidth()) * max, (b6Var.f41624z0 / b6Var.f41621w0.getHeight()) * max);
                    matrix.postTranslate((photoImage.getCenterX() + (q6.getX() + y0Var.getX())) - ((b6Var.f41623y0 * max) / 2.0f), (photoImage.getCenterY() + (q6.getY() + y0Var.getY())) - ((b6Var.f41624z0 * max) / 2.0f));
                    b6Var.f41621w0.setTransform(matrix);
                    canvas.save();
                    path.rewind();
            ...
            case 10:
                ...
                yf.y yVar2 = (yf.y) this.f37952c;
                boolean drawChild2 = super.drawChild(canvas, view, j3);
                th.f fVar = (th.f) this.e;
                int i12 = (int) fVar.X.e;
                if (view == fVar.f43536h0 && i12 > 0) {
    ...
    public void e() {
        ...
        yh.u3 u3Var = x3Var.f48225e0;
        u3Var.setTranslationY(d);
        x3Var.f48227f0.setTranslationY(u3Var.getRealHeight() + d);
        x3Var.f48248r0.setTranslationY(u3Var.getRealHeight() + d);
        x3Var.f48255y0.setTranslationY(u3Var.getRealHeight() + d);
        ...
        AndroidUtilities.updateViewVisibilityAnimated(x3Var.f48241n0, x3Var.d.canScrollVertically(1));
    }
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        switch (this.f37950a) {
            ...
            case 6:
                ...
                TextureView textureView = b6Var.f41621w0;
                if (textureView != null) {
            ...
            case 11:
                ...
                if (n0Var != null) {
                    int finalHeight = x3Var.f48225e0.getFinalHeight();
                    int z12 = x3Var.z1();
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.f37950a) {
            ...
            case 7:
                org.telegram.ui.ActionBar.d6 d6Var = (org.telegram.ui.ActionBar.d6) this.f37951b;
                LimitPreviewView limitPreviewView = (LimitPreviewView) this.e;
                TextView textView = limitPreviewView.f22327w;
                org.telegram.ui.Components.sg0 sg0Var = limitPreviewView.f22319g0;
                org.telegram.ui.Components.p6 p6Var = limitPreviewView.N;
                org.telegram.ui.Components.sg0 sg0Var2 = limitPreviewView.f22318f0;
                ...
                if (getChildCount() == 2) {
                    ...
                    if (limitPreviewView.P) {
                        float f7 = limitPreviewView.f22309a;
                        float f10 = 0.0f;
                        int i19 = -1;
                        if (f7 == 0.0f) {
                            limitPreviewView.f22324n = 0;
                            if (!limitPreviewView.U && !limitPreviewView.V) {
                                if (limitPreviewView.L || limitPreviewView.f22316e0 != null) {
                                    v03 = -1;
                                } else {
                            ...
                            limitPreviewView.f22324n = (int) ((((size - measuredWidth) - f10) * limitPreviewView.f22309a) + measuredWidth);
                            if (!limitPreviewView.U && !limitPreviewView.V) {
                                if (limitPreviewView.L || limitPreviewView.f22316e0 != null) {
                                    v02 = -1;
                                } else {
                        ...
                        int clamp = (int) Utilities.clamp(size * limitPreviewView.f22309a, size - Math.max(measuredWidth5, measuredWidth6 + i18), max);
                        limitPreviewView.f22324n = clamp;
                        sg0Var2.measure(View.MeasureSpec.makeMeasureSpec(clamp, 1073741824), View.MeasureSpec.makeMeasureSpec(size2, 1073741824));
                        sg0Var.measure(View.MeasureSpec.makeMeasureSpec(size - limitPreviewView.f22324n, 1073741824), View.MeasureSpec.makeMeasureSpec(size2, 1073741824));
                    }
            ...
            case 9:
                ...
                i14 = ((org.telegram.ui.ActionBar.e3) x0Var).backgroundPaddingTop;
                x0Var.L = i14 + size3;
                super.onMeasure(i10, i11);
                x0Var.y();
                return;
            case 11:
                ...
                x3Var.f48225e0.L.setPadding(0, 0, 0, bottomInset);
        ...
        switch (this.f37950a) {
            case 3:
                ...
                if (ts0Var != null && ts0Var.getVisibility() != 8) {
                    photoViewer.U1.setAlpha(photoViewer.f31394y7[0] * f7);
                }
                us0 us0Var = photoViewer.V1;
                if (us0Var != null && us0Var.getVisibility() != 8) {
                    photoViewer.V1.setAlpha(f7 * photoViewer.f31403z7[0]);
                    return;
                }
                return;
            default:
    ...
    public t5(ci.b6 b6Var, Context context) {
        super(context);
        this.e = b6Var;
        this.f37952c = new Matrix();
        this.d = new float[8];
        this.f37951b = new Path();
    }
    ...
    public t5(rg.x0 x0Var, Context context, ScrollView scrollView, Drawable drawable) {
        ...
        this.e = x0Var;
        this.d = scrollView;
        this.f37951b = drawable;
        this.f37952c = new Path();
    }
    ...
    public t5(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        textView.setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19151j5, d6Var));
        addView(textView);
        ImageView imageView = new ImageView(context);
        this.f37952c = imageView;
    ...
    public t5(org.telegram.ui.Components.i41 i41Var, Context context) {
        ...
        this.d = paint;
        paint.setColor(i41Var.getThemedColor(org.telegram.ui.ActionBar.h6.f19115h5));
    ...
    public t5(od1 od1Var, Activity activity) {
        super(activity);
        this.e = od1Var;
        this.f37952c = new Paint(1);
        this.d = new Paint(1);
        this.f37951b = new Paint(1);
    }
    ...
    public t5(rg.f0 f0Var, Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        this.e = f0Var;
        this.f37951b = d6Var;
        this.f37952c = new rg.z0(org.telegram.ui.ActionBar.h6.Lj, org.telegram.ui.ActionBar.h6.Mj, -1, -1, d6Var);
        Paint paint = new Paint(1);
        this.d = paint;
