...
public final class t5 extends FrameLayout {
    public final int f37549a = 1;
    public Object f37550b;
    public Object f37551c;
    public Object d;
    public Object e;
    ...
    public float a() {
        ...
        return (a4Var.Y0.a(3) * a4Var.A0.getMeasuredHeight()) + (a4Var.Y0.a(2) * a4Var.f46983y0.getMeasuredHeight()) + (a4Var.Y0.a(1) * a4Var.f46976r0.getMeasuredHeight()) + (a4Var.Y0.a(0) * a4Var.f46955f0.getMeasuredHeight()) + a4Var.f46953e0.getRealHeight() + 0.0f;
    }
    ...
    public void b(boolean z10) {
        ...
        float f7;
        float f10;
        ImageView imageView = (ImageView) this.f37551c;
        if (z10) {
            i10 = 0;
        } else {
            i10 = 8;
    ...
    public void c(int i10, String str) {
        ...
        ((ImageView) this.f37551c).setImageDrawable(getContext().getDrawable(i10));
    }
    ...
    public float d() {
        ...
        yh.a4 a4Var = (yh.a4) this.e;
        org.telegram.ui.Components.ll0 ll0Var = a4Var.d;
        ...
        while (true) {
            ...
            if (R >= 0) {
                if (R == 2) {
                    ...
                    max = childAt.getY() - a4Var.f46953e0.getRealHeight();
                    break;
                }
            }
            childCount--;
        ...
        Float f7 = a4Var.X0;
        if (f7 != null && (dVar = a4Var.Y0) != null && dVar.f8872c < 1.0f) {
            return AndroidUtilities.lerp(f7.floatValue(), a2, a4Var.Y0.f8872c);
        }
        return a2;
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f37549a) {
            case 2:
                Path path = (Path) this.f37551c;
                org.telegram.ui.Components.v31 v31Var = (org.telegram.ui.Components.v31) this.e;
                boolean z11 = true;
                float z12 = v31Var.z(true);
                float lerp = AndroidUtilities.lerp(0, AndroidUtilities.dp(12.0f), w7.p.a(z12 / AndroidUtilities.dpf2(24.0f), 0.0f, 1.0f));
                v31Var.f28596x.setTranslationY(Math.max(AndroidUtilities.statusBarHeight, z12));
                if (z12 <= AndroidUtilities.statusBarHeight / 2.0f) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                Boolean bool = (Boolean) this.f37550b;
                if (bool == null || bool.booleanValue() != z10) {
                    this.f37550b = Boolean.valueOf(z10);
                    Window window = v31Var.getWindow();
                    if (z10) {
                        v = v31Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18907h5);
                    } else {
                        v = org.telegram.ui.ActionBar.i6.v(v31Var.getThemedColor(org.telegram.ui.ActionBar.i6.f19113s8), 855638016);
                    }
                ...
                v31Var.topBulletinContainer.setTranslationY(Math.max(v31Var.topBulletinContainer.getHeight() + AndroidUtilities.dp(56.0f) + AndroidUtilities.statusBarHeight, z12) + getTranslationY() + ((-frameLayout.getTop()) - v31Var.topBulletinContainer.getHeight()));
                path.rewind();
            ...
            case 3:
                ...
                Matrix matrix = (Matrix) this.f37550b;
                Paint paint = (Paint) this.f37551c;
                PhotoViewer photoViewer = (PhotoViewer) this.e;
                if (!photoViewer.S4) {
                    if (photoViewer.f31013n0.getVisibility() == 0) {
            ...
            default:
                ...
                return;
            case 5:
                Paint paint2 = (Paint) this.f37550b;
                ...
                Paint paint4 = (Paint) this.f37551c;
                paint4.setColor(0);
                ...
                org.telegram.ui.ActionBar.i6.s(this, kd1Var, vc1Var);
                ...
                G.setAlpha(alpha);
                if (vd1Var.M1) {
                    float f7 = vd1Var.f38552n1;
                    if (f7 > 0.0f) {
                        paint2.setColor(i0.a.k(-16777216, (int) (f7 * 255.0f * vd1Var.f38554o1)));
                ...
                return;
            case 7:
                org.telegram.ui.ActionBar.e6 e6Var = (org.telegram.ui.ActionBar.e6) this.f37550b;
                Paint paint5 = (Paint) this.f37551c;
                LimitPreviewView limitPreviewView = (LimitPreviewView) this.e;
                if (limitPreviewView.P) {
                    if (!limitPreviewView.f22106c0 && !limitPreviewView.R) {
                        paint5.setColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.e7, e6Var));
                    } else {
                        paint5.setColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18926i6, e6Var));
                    }
                } else {
                    paint5.setColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18780a7, e6Var));
                }
                RectF rectF3 = AndroidUtilities.rectTmp;
                rectF3.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                rg.t tVar = limitPreviewView.f22108e0;
                if (tVar != null) {
                    canvas.drawRoundRect(rectF3, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), ((v5) ((y0) tVar).f39705b).t0(getX() + ((ViewGroup) getParent()).getX(), getY() + ((ViewGroup) getParent()).getY()));
                } else {
                    canvas.drawRoundRect(rectF3, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), paint5);
                }
                canvas.save();
                if (!limitPreviewView.P) {
                    canvas.clipRect(limitPreviewView.f22116n, 0, getMeasuredWidth(), getMeasuredHeight());
                }
                if (limitPreviewView.R) {
                    e = limitPreviewView.K;
                } else if (limitPreviewView.f22108e0 != null) {
                    e = (Paint) this.d;
                } else {
                    e = rg.a1.d().e();
                }
                ViewGroup viewGroup = limitPreviewView.f22121y;
                if (viewGroup != null) {
                    ...
                    if (z0Var != null) {
                        ...
                        matrix2.reset();
                        matrix2.postScale(1.0f, limitPreviewView.f22105c / 100.0f, 0.0f, 0.0f);
                ...
                if (limitPreviewView.V && (valueAnimator2 = limitPreviewView.f22113i0) != null) {
                    e.setAlpha((int) ((1.0f - ((Float) valueAnimator2.getAnimatedValue()).floatValue()) * alpha2));
                } else if (limitPreviewView.U && (valueAnimator = limitPreviewView.f22113i0) != null) {
                    e.setAlpha((int) (((Float) valueAnimator.getAnimatedValue()).floatValue() * alpha2));
                }
                if (limitPreviewView.P) {
                    if (!limitPreviewView.L && !limitPreviewView.M) {
                        AndroidUtilities.rectTmp.set(0.0f, 0.0f, limitPreviewView.f22116n, getMeasuredHeight());
                    } else {
                        AndroidUtilities.rectTmp.set(limitPreviewView.f22116n, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                    }
                }
                canvas.drawRoundRect(AndroidUtilities.rectTmp, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), e);
                e.setAlpha(alpha2);
                canvas.restore();
                if (limitPreviewView.E == null && limitPreviewView.f22107d0) {
                    invalidate();
                }
                super.dispatchDraw(canvas);
                return;
            case 8:
                ...
                paint6.setColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.Ii, (org.telegram.ui.ActionBar.e6) this.f37550b));
                ...
                rg.z0 z0Var2 = (rg.z0) this.f37551c;
                z0Var2.e(rectF4);
                canvas.drawRoundRect(rectF4, AndroidUtilities.dp(15.0f), AndroidUtilities.dp(15.0f), z0Var2.f42556f);
                canvas.restore();
                super.dispatchDraw(canvas);
                return;
            case 9:
                Drawable drawable3 = (Drawable) this.f37550b;
            ...
            case 11:
                ...
                RectF rectF5 = (RectF) this.f37550b;
                rectF5.set(yh.a4.n1(a4Var), d, getWidth() - yh.a4.o1(a4Var), getHeight() + dp2);
                Paint paint7 = (Paint) this.f37551c;
                paint7.setColor(a4Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18907h5));
    ...
    public void draw(Canvas canvas) {
        switch (this.f37549a) {
            case 0:
                RectF rectF = (RectF) this.f37550b;
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        switch (this.f37549a) {
            case 6:
                ...
                Path path = (Path) this.f37550b;
                Matrix matrix = (Matrix) this.f37551c;
                ci.c6 c6Var = (ci.c6) this.e;
                qg.a1 a1Var = c6Var.f41371r0;
                if (view == c6Var.f41376w0) {
                    org.telegram.ui.Cells.t1 q6 = qg.h1.q(c6Var);
                    if (q6 == null || (photoImage = q6.getPhotoImage()) == null) {
                        return false;
                    }
                    matrix.reset();
                    float max = Math.max(photoImage.getImageWidth() / c6Var.f41378y0, photoImage.getImageHeight() / c6Var.f41379z0);
                    matrix.postScale((c6Var.f41378y0 / c6Var.f41376w0.getWidth()) * max, (c6Var.f41379z0 / c6Var.f41376w0.getHeight()) * max);
                    matrix.postTranslate((photoImage.getCenterX() + (q6.getX() + a1Var.getX())) - ((c6Var.f41378y0 * max) / 2.0f), (photoImage.getCenterY() + (q6.getY() + a1Var.getY())) - ((c6Var.f41379z0 * max) / 2.0f));
                    c6Var.f41376w0.setTransform(matrix);
                    canvas.save();
                    path.rewind();
            ...
            case 10:
                ...
                yf.y yVar2 = (yf.y) this.f37551c;
                boolean drawChild2 = super.drawChild(canvas, view, j3);
                th.f fVar = (th.f) this.e;
                int i12 = (int) fVar.X.e;
                if (view == fVar.f43266h0 && i12 > 0) {
    ...
    public void e() {
        ...
        a4Var.f46955f0.setTranslationY(x3Var.getRealHeight() + d);
        a4Var.f46976r0.setTranslationY(x3Var.getRealHeight() + d);
        a4Var.f46983y0.setTranslationY(x3Var.getRealHeight() + d);
        ...
        AndroidUtilities.updateViewVisibilityAnimated(a4Var.f46969n0, a4Var.d.canScrollVertically(1));
    }
        ...
        switch (this.f37549a) {
            case 3:
                ...
                if (photoViewer.H0.getVisibility() != 8) {
                    ...
                    bc1Var.layout(measuredWidth, bc1Var.getTop(), photoViewer.H0.getMeasuredWidth() + measuredWidth, photoViewer.H0.getMeasuredHeight() + photoViewer.H0.getTop());
                    return;
                }
                return;
            case 6:
                ...
                TextureView textureView = c6Var.f41376w0;
                if (textureView != null) {
            ...
            case 11:
                ...
                if (n0Var != null) {
                    int finalHeight = a4Var.f46953e0.getFinalHeight();
                    int z12 = a4Var.z1();
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.f37549a) {
            ...
            case 7:
                org.telegram.ui.ActionBar.e6 e6Var = (org.telegram.ui.ActionBar.e6) this.f37550b;
                LimitPreviewView limitPreviewView = (LimitPreviewView) this.e;
                TextView textView = limitPreviewView.f22119w;
                org.telegram.ui.Components.ig0 ig0Var = limitPreviewView.f22111g0;
                org.telegram.ui.Components.n6 n6Var = limitPreviewView.N;
                org.telegram.ui.Components.ig0 ig0Var2 = limitPreviewView.f22110f0;
                ...
                if (getChildCount() == 2) {
                    ...
                    if (limitPreviewView.P) {
                        float f7 = limitPreviewView.f22101a;
                        float f10 = 0.0f;
                        int i19 = -1;
                        if (f7 == 0.0f) {
                            limitPreviewView.f22116n = 0;
                            if (!limitPreviewView.U && !limitPreviewView.V) {
                                if (limitPreviewView.L || limitPreviewView.f22108e0 != null) {
                                    v03 = -1;
                                } else {
                                    v03 = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.G6, e6Var);
                                }
                                n6Var2.setTextColor(v03);
                                if (limitPreviewView.f22108e0 == null) {
                            ...
                            limitPreviewView.f22116n = (int) ((((size - measuredWidth) - f10) * limitPreviewView.f22101a) + measuredWidth);
                            if (!limitPreviewView.U && !limitPreviewView.V) {
                                if (limitPreviewView.L || limitPreviewView.f22108e0 != null) {
                                    v02 = -1;
                                } else {
                        ...
                        int clamp = (int) Utilities.clamp(size * limitPreviewView.f22101a, size - Math.max(measuredWidth5, measuredWidth6 + i18), max);
                        limitPreviewView.f22116n = clamp;
                        ig0Var2.measure(View.MeasureSpec.makeMeasureSpec(clamp, 1073741824), View.MeasureSpec.makeMeasureSpec(size2, 1073741824));
                        ig0Var.measure(View.MeasureSpec.makeMeasureSpec(size - limitPreviewView.f22116n, 1073741824), View.MeasureSpec.makeMeasureSpec(size2, 1073741824));
                    }
            ...
            case 11:
                ...
                a4Var.f46953e0.L.setPadding(0, 0, 0, bottomInset);
        ...
        switch (this.f37549a) {
            case 3:
                ...
                if (bt0Var != null && bt0Var.getVisibility() != 8) {
                    photoViewer.U1.setAlpha(photoViewer.f31121y7[0] * f7);
                }
                ct0 ct0Var = photoViewer.V1;
                if (ct0Var != null && ct0Var.getVisibility() != 8) {
                    photoViewer.V1.setAlpha(f7 * photoViewer.f31130z7[0]);
                    return;
                }
                return;
            default:
    ...
    public void setTranslationY(float f7) {
        switch (this.f37549a) {
            case 2:
                ...
                org.telegram.ui.Components.v31 v31Var = (org.telegram.ui.Components.v31) this.e;
                FrameLayout frameLayout = v31Var.topBulletinContainer;
                frameLayout.setTranslationY(Math.max(v31Var.topBulletinContainer.getHeight() + AndroidUtilities.dp(56.0f) + AndroidUtilities.statusBarHeight, v31Var.z(true)) + ((-frameLayout.getTop()) - v31Var.topBulletinContainer.getHeight()) + f7);
                return;
            case 3:
                super.setTranslationY(f7);
                PhotoViewer photoViewer = (PhotoViewer) this.e;
    ...
    public t5(ci.c6 c6Var, Context context) {
        super(context);
        this.e = c6Var;
        this.f37551c = new Matrix();
        this.d = new float[8];
        this.f37550b = new Path();
    }
    ...
    public t5(org.telegram.ui.Components.v31 v31Var, Context context) {
        ...
        this.d = paint;
        paint.setColor(v31Var.getThemedColor(org.telegram.ui.ActionBar.i6.f18907h5));
    ...
    public t5(vd1 vd1Var, Activity activity) {
        super(activity);
        this.e = vd1Var;
        this.f37551c = new Paint(1);
        this.d = new Paint(1);
        this.f37550b = new Paint(1);
    }
    ...
    public t5(rg.f0 f0Var, Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        this.e = f0Var;
        this.f37550b = e6Var;
        this.f37551c = new rg.z0(org.telegram.ui.ActionBar.i6.Lj, org.telegram.ui.ActionBar.i6.Mj, -1, -1, e6Var);
        Paint paint = new Paint(1);
        this.d = paint;
