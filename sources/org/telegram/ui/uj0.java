...
public final class uj0 implements Choreographer.FrameCallback {
    ...
    public static final Paint f38038x;
    public static final LinearGradient f38039y;
    public final Choreographer f38040a = Choreographer.getInstance();
    public List f38041b = new ArrayList();
    public final ArrayList f38042c = new ArrayList();
    public int d = 0;
    public int e = 0;
    public float f38043f = 0.0f;
    public boolean h = false;
    public boolean f38044n = true;
    public long f38045r = 0;
    public float f38046s = AndroidUtilities.dp(40.0f);
    public View v;
    public ai.y7 f38047w;
            ...
            if (i10 >= 0 && i10 < lineCount) {
                ...
                if (max > min) {
                    ...
                    if (a2 > 0.0f) {
                        ...
                        f38039y.setLocalMatrix(matrix);
                        canvas.drawRect(min, f12, max, f13, f38038x);
    ...
    public final void a(float f7) {
        float f10;
        float f11;
        int size = this.f38041b.size();
        View view = null;
        for (int i10 = 0; i10 < size; i10++) {
            sj0 sj0Var = (sj0) this.f38041b.get(i10);
            if (!this.f38044n && i10 > this.d) {
                f10 = 0.0f;
            } else {
                f10 = 1.0f;
            }
            ArrayList arrayList = this.f38042c;
    ...
    public final int d(sj0 sj0Var) {
        int size = this.f38041b.size();
        for (int i10 = 0; i10 < size; i10++) {
            if (this.f38041b.get(i10) == sj0Var) {
                return i10;
            }
        }
        return -1;
    ...
    public final void doFrame(long j3) {
        if (this.h) {
            long j10 = this.f38045r;
            float f7 = 0.0f;
            if (j10 != 0) {
                float f10 = ((float) (j3 - j10)) * 1.0E-9f;
                if (!this.f38041b.isEmpty() && f10 > 0.0f) {
                    float f11 = this.f38046s * f10;
                    while (true) {
                        if (f11 <= 0.0f) {
                            break;
                        } else if (this.d >= this.f38041b.size()) {
                            this.f38044n = true;
                            break;
                        } else {
                            Layout layout = ((sj0) this.f38041b.get(this.d)).getLayout();
                            if (layout != null && layout.getLineCount() != 0) {
                                if (this.e >= layout.getLineCount()) {
                                    int lineCount = layout.getLineCount() - 1;
                                    this.e = lineCount;
                                    this.f38043f = i(layout, lineCount);
                                }
                    ...
                    this.f38044n = this.f38041b.isEmpty();
                }
                f7 = f10;
            }
            this.f38045r = j3;
            ...
            if (this.f38044n) {
                ...
                int size2 = this.f38041b.size();
                View view = null;
                for (int i12 = 0; i12 < size2; i12++) {
                    View parentView = ((sj0) this.f38041b.get(i12)).getParentView();
                    if (parentView != null && parentView != view) {
            ...
            this.f38040a.postFrameCallback(this);
        }
    }
    ...
    public final void e() {
        ...
        sj0 sj0Var;
        int i10 = this.d;
        if (i10 >= 0 && i10 < this.f38041b.size() && (sj0Var = (sj0) this.f38041b.get(this.d)) != null) {
    ...
    public final boolean f() {
        if (!this.f38041b.isEmpty()) {
            int size = this.f38041b.size() - 1;
            Layout layout = null;
            while (size >= 0) {
                layout = ((sj0) this.f38041b.get(size)).getLayout();
                if (layout != null && layout.getLineCount() > 0) {
                    break;
                }
                size--;
            ...
            if (size >= 0 && layout != null) {
                ...
                if (i10 >= size) {
                    if (i10 <= size) {
                        ...
                        if (this.e < lineCount || this.f38043f < i11 - 0.001f) {
                            return false;
                        }
                    }
                } else {
    ...
    public final void l(List list) {
        ...
        int lineCount;
        float lineWidth;
        if (!this.f38041b.isEmpty() && this.d >= this.f38041b.size()) {
            int size = this.f38041b.size() - 1;
            this.d = size;
            Layout layout = ((sj0) this.f38041b.get(size)).getLayout();
            if (layout == null) {
                lineCount = 0;
            } else {
        ...
        if (list.isEmpty()) {
            ...
            f7 = 0.0f;
            for (int i11 = this.d; i11 < this.f38041b.size(); i11++) {
                Layout layout2 = ((sj0) this.f38041b.get(i11)).getLayout();
                if (layout2 != null) {
                    if (i11 == this.d) {
        ...
        if (f7 <= 0.001f) {
            ...
            this.f38046s = Math.max(dp, f7 / 1.05f);
        }
        this.f38044n = f();
        while (true) {
            arrayList = this.f38042c;
            if (arrayList.size() <= this.f38041b.size()) {
                break;
            }
            a4.a.x(1, arrayList);
        }
        for (int size2 = arrayList.size(); size2 < this.f38041b.size(); size2++) {
            if (!this.f38044n && size2 > this.d) {
                f10 = 0.0f;
            } else {
                f10 = 1.0f;
            }
        ...
        if (!this.f38044n && !(z10 = this.h) && !z10) {
            this.h = true;
            if (f()) {
                this.f38044n = true;
            }
