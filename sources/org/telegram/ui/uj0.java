...
public final class uj0 extends org.telegram.ui.ActionBar.h3 implements AdapterView.OnItemSelectedListener {
    public static final int f41952a0 = 0;
    public boolean B;
    public boolean C;
    public boolean D;
    public boolean E;
    ...
    public String Y;
    public int Z;
    public final LinearLayout f41953b;
    public final org.telegram.ui.Components.tq f41954c;
    public final org.telegram.ui.Components.bd0 d;
    public final org.telegram.ui.Components.bd0 f41955e;
    public final FrameLayout f41956f;
    public final View h;
    public final qh.d f41957n;
    public final org.telegram.ui.Components.bd0 f41958r;
    public final org.telegram.ui.Components.cd0 f41959s;
    public final org.telegram.ui.Components.g90 v;
    public final ArrayList f41960w;
    public final HashMap f41961x;
    public final HashMap f41962y;
    ...
    public static void q(uj0 uj0Var) {
        ...
        for (int min = Math.min(3, replaceAll.length()); min >= 0; min--) {
            ...
            List list = (List) uj0Var.f41961x.get(substring);
            if (list != null && !list.isEmpty()) {
                List list2 = (List) uj0Var.f41962y.get(substring);
    ...
    public final ArrayList getThemeDescriptions() {
        ...
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f41955e, 4, null, null, null, null, i10));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f41955e, 8388608, null, null, null, null, i11));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f41955e, 32, null, null, null, null, i12));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f41955e, 65568, null, null, null, null, i13));
        ...
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f41954c, 0, null, null, null, null, org.telegram.ui.ActionBar.k6.D7));
        arrayList.add(new org.telegram.ui.ActionBar.m6(this.f41954c, 0, null, null, null, null, org.telegram.ui.ActionBar.k6.E7));
        return arrayList;
    }
    ...
    public final void onItemSelected(AdapterView adapterView, View view, int i10, long j10) {
        ...
        this.B = true;
        this.L.setText(((tt) this.f41960w.get(i10)).f41705c);
        this.B = false;
    }
    ...
    public final void r() {
        ...
        String obj2 = this.f41955e.getEditText().getText().toString();
        if (this.f41958r.getVisibility() == 0) {
            str = this.f41958r.getEditText().getText().toString();
        } else {
            str = "";
        }
    ...
    public final void v(String str, boolean z4) {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            if (this.F.startsWith("+")) {
                ...
                while (true) {
                    if (i10 >= 1) {
                        List list = (List) this.f41961x.get(str2.substring(0, i10));
                        if (list != null && list.size() > 0) {
                            String str3 = ((tt) list.get(0)).f41705c;
                            this.L.setText(str3);
    ...
    public final void w(boolean z4) {
        ...
        ViewPropertyAnimator animate2 = this.f41956f.animate();
        if (z4) {
    ...
    public final void x(boolean z4) {
        ...
        float f12;
        float f13;
        boolean z10 = this.P.f29606a.f24809q;
        final boolean z11 = !z10;
        float f14 = 0.0f;
        int i12 = 0;
        if (z4) {
            this.f41957n.setVisibility(0);
            ViewPropertyAnimator animate = this.f41957n.animate();
            if (!z10) {
                f12 = 1.0f;
            } else {
                f12 = 0.0f;
            ...
            alpha.setInterpolator(prVar).setDuration(420L).withEndAction(new Runnable(this) {
                ...
                public final void run() {
                    switch (r3) {
                        case 0:
                            boolean z12 = z11;
                            uj0 uj0Var = this.f40070b;
                            if (!z12) {
                                uj0Var.f41957n.setVisibility(4);
                                return;
                            } else {
                                uj0Var.getClass();
                                return;
                        ...
                        default:
                            boolean z14 = z11;
                            uj0 uj0Var3 = this.f40070b;
                            if (z14) {
                                uj0Var3.f41958r.setVisibility(4);
                                return;
                            } else {
                                uj0Var3.getClass();
                                return;
            ...
            this.f41958r.setVisibility(0);
            ViewPropertyAnimator animate3 = this.f41958r.animate();
            if (z10) {
                f14 = 1.0f;
            }
        ...
        this.f41957n.animate().cancel();
        if (!z10) {
            i10 = 0;
        } else {
            i10 = 4;
        }
        this.f41957n.setVisibility(i10);
        if (!z10) {
            f10 = 1.0f;
        } else {
            f10 = 0.0f;
        }
        this.f41957n.setAlpha(f10);
        ...
        this.h.setAlpha(f11);
        this.f41958r.animate().cancel();
        if (!z10) {
            i12 = 4;
        }
        this.f41958r.setVisibility(i12);
        if (z10) {
            f14 = 1.0f;
        }
        this.f41958r.setAlpha(f14);
    }
    ...
    public final void y(String str) {
        ...
        this.O.setImageDrawable(new org.telegram.ui.Components.tp(AndroidUtilities.dp(30.0f), AndroidUtilities.dp(3.0f), getThemedColor(org.telegram.ui.ActionBar.k6.f21820m5)));
        this.v.setText("");
        w(true);
