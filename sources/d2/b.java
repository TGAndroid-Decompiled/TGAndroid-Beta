...
public final class b {
    public static final r f4090f = new r(1);
    public static final c f4091g = new Object();
    ...
    public b(int[] iArr, int i10, c[] cVarArr) {
        ...
        for (int i14 = 0; i14 < 32768; i14++) {
            if (iArr2[i14] > 0) {
                ...
                ThreadLocal threadLocal = i0.a.f7195a;
        ...
        if (i13 <= i10) {
            ...
            for (int i17 = 0; i17 < i13; i17++) {
                int i18 = iArr3[i17];
                ((ArrayList) this.f4094c).add(new d(Color.rgb(b((i18 >> 10) & 31, 5, 8), b((i18 >> 5) & 31, 5, 8), b(i18 & 31, 5, 8)), iArr2[i18]));
            }
            return;
        }
        PriorityQueue priorityQueue = new PriorityQueue(i10, f4090f);
        priorityQueue.offer(new a(this, 0, ((int[]) this.f4092a).length - 1));
        while (priorityQueue.size() < i10 && (aVar = (a) priorityQueue.poll()) != null) {
            ...
            if ((i19 + 1) - i20 > 1) {
                ...
                int i22 = aVar.f4087g - aVar.f4086f;
                int i23 = aVar.f4088i - aVar.h;
                int i24 = (i21 < i22 || i21 < i23) ? (i22 < i21 || i22 < i23) ? -1 : -2 : -3;
                int[] iArr4 = (int[]) bVar.f4092a;
                int[] iArr5 = (int[]) bVar.f4093b;
                a(i24, i20, i19, iArr4);
                Arrays.sort(iArr4, i20, aVar.f4084b + 1);
                a(i24, i20, aVar.f4084b, iArr4);
                int i25 = aVar.f4085c / 2;
                int i26 = i20;
                int i27 = 0;
                while (true) {
                    int i28 = aVar.f4084b;
                ...
                a aVar2 = new a(bVar, i20 + 1, aVar.f4084b);
                aVar.f4084b = i20;
                aVar.a();
        ...
        while (it.hasNext()) {
            a aVar3 = (a) it.next();
            b bVar2 = aVar3.f4089j;
            int[] iArr6 = (int[]) bVar2.f4092a;
            int[] iArr7 = (int[]) bVar2.f4093b;
            int i29 = 0;
            int i30 = 0;
            int i31 = 0;
            int i32 = 0;
            for (int i33 = aVar3.f4083a; i33 <= aVar3.f4084b; i33++) {
                int i34 = iArr6[i33];
                int i35 = iArr7[i34];
                i30 += i35;
