...
public final class a {
    public static SparseIntArray f45298b;
    public static final a f45299c = new a();
    public final SparseArray f45300a;

    public a() {
        this.f45300a = new SparseArray();
    }
        ...
        if (context != null && i10 != 0) {
            if (f45298b == null) {
                try {
                    ...
                    bufferedInputStream.close();
                    f45298b = sparseIntArray;
                } catch (IOException e) {
                    throw new RuntimeException(e);
                }
            }
            int i12 = f45298b.get(i10);
            if (i12 != 0) {
                return (String) this.f45300a.get(i12);
            }
            return null;
        }
        return null;
    ...
    public final String c(Context context, String str, int i10) {
        String str2;
        if (str != null) {
            str2 = (String) this.f45300a.get(str.hashCode());
        } else {
            str2 = null;
        }
        if (str2 != null) {
    ...
    public a(c cVar) {
        SparseArray sparseArray = (SparseArray) cVar.f16228b;
        this.f45300a = sparseArray == null ? new SparseArray() : sparseArray;
    }
}
