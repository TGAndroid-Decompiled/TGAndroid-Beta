...
public final class h extends FrameLayout implements z5 {
    ...
    public long E;
    public final f6 f11389a;
    public final int f11390b;
    public final x9 f11391c;
    public final TextView d;
    public final x9 f11392e;
    public final TextView f11393f;
    public final TextView h;
    public final TextView f11394n;
    public final nq f11395r;
    public final gh.d f11396s;
    public final dh.d v;
    ...
    public h(Context context, int i10, f6 f6Var) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        ...
                        return;
                    case 1:
                        h hVar2 = this.f11384b;
                        e eVar3 = hVar2.f11398x;
                        if (eVar3 != null) {
                            long j10 = hVar2.E;
                        ...
                        return;
                    case 2:
                        h hVar3 = this.f11384b;
                        e eVar4 = hVar3.f11398x;
                        if (eVar4 != null) {
                            ((t0) eVar4).g(hVar3.f11399y, false);
                            return;
                        }
                        return;
                    default:
                        h hVar4 = this.f11384b;
                        e eVar5 = hVar4.f11398x;
                        if (eVar5 != null) {
                            ((t0) eVar5).g(hVar4.f11399y, true);
                            return;
                        }
                        return;
                }
        ...
        dVar2.e();
        dVar2.d();
        dVar2.setColor(j6.l1(0.14f, j6.v0(j6.f21088z6, f6Var)));
    ...
    public final void d() {
        int i10 = j6.G6;
        f6 f6Var = this.f11389a;
        this.f11393f.setTextColor(j6.v0(i10, f6Var));
        int i11 = j6.f21088z6;
        this.h.setTextColor(j6.v0(i11, f6Var));
        this.f11394n.setTextColor(j6.v0(i11, f6Var));
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f11397w) {
            canvas2 = canvas;
            canvas2.drawLine(AndroidUtilities.dp(76.0f), getHeight() - 1, getMeasuredWidth(), getHeight() - 1, j6.f20812k0);
        } else {
            canvas2 = canvas;
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        gh.d dVar;
        x9 x9Var;
        if (Build.VERSION.SDK_INT >= 31 && (dVar = this.f11396s) != null && view == (x9Var = this.f11391c)) {
            ...
            a2.drawColor(j6.v0(j6.f20690d6, this.f11389a));
            a2.save();
            float f7 = dp2 / 2.0f;
