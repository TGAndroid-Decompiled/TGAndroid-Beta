...
public abstract class i6 {
    public static final int[] f9665a = {1, 2, 16, 8, 4, 256, 16384, 32768, 65536};
    ...
    public static void a(SpannableStringBuilder spannableStringBuilder, TL_iv.RichText richText, int i10, TL_iv.PageBlock pageBlock, boolean z10) {
        ...
        if (richText instanceof TL_iv.textConcat) {
            ...
            if (spannableStringBuilder.length() > length4) {
                ...
                ?? obj3 = new Object();
                obj3.f21677a |= 128;
                spannableStringBuilder.setSpan(new p10(charSequence2, obj3, tL_messageEntityFormattedDate), length4, spannableStringBuilder.length(), 33);
            }
    ...
    public static int d(java.lang.CharSequence r14) {
        throw new UnsupportedOperationException("Method not decompiled: hi.i6.d(java.lang.CharSequence):int");
    }
    ...
    public static int e(Spanned spanned, int i10, int i11) {
        ...
        for (c11 c11Var : c11VarArr) {
            int i13 = c11Var.f21969b.f21677a;
            if ((i13 & 512) != 0) {
                i13 |= 256;
            }
            i12 |= i13;
    ...
    public static org.telegram.tgnet.tl.TL_iv.RichText f(java.lang.CharSequence r14) {
        throw new UnsupportedOperationException("Method not decompiled: hi.i6.f(java.lang.CharSequence):org.telegram.tgnet.tl.TL_iv$RichText");
    }
    ...
    public static void o(Spannable spannable, int i10, int i11, int i12, boolean z10, TL_iv.PageBlock pageBlock) {
        ...
        if (max < max2) {
            for (c11 c11Var : (c11[]) spannable.getSpans(max, max2, c11.class)) {
                ...
                int i14 = c11Var.f21969b.f21677a;
    ...
    public static TL_iv.RichText s(String str, h6 h6Var) {
        ...
        if (j3 != 0) {
            ...
            textcustomemoji2.document_id = j3;
            if (str == null) {
                str = "";
            }
        ...
        if (h6Var.f9640b != null) {
            TL_iv.RichText texturl = new TL_iv.textUrl();
            texturl.text = richText9;
            texturl.url = h6Var.f9640b;
            richText10 = texturl;
        }
        p10 p10Var = h6Var.f9641c;
        if (p10Var != null) {
