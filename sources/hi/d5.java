...
public final class d5 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final TLRPC.Document f9526r;
    public final c5 f9527s;
    public boolean v;
    ...
    public final void a(String str) {
        int i10;
        boolean z10;
        if (!this.f9528w && !this.f9529x) {
            this.E = str;
            NotificationCenter notificationCenter = NotificationCenter.getInstance(this.f9521a);
            ...
            FileLoader fileLoader = FileLoader.getInstance(this.f9521a);
            String str2 = this.E;
            if (!this.f9523c && !this.d && !this.e) {
                z10 = true;
            } else {
                z10 = false;
            }
    ...
    public final void b() {
        if (!this.f9529x && !this.f9528w) {
            this.f9528w = true;
            try {
                if (this.E != null) {
                    FileLoader.getInstance(this.f9521a).cancelFileUpload(this.E, false);
                }
            } catch (Throwable unused) {
            }
            if (this.f9530y != 0) {
                ConnectionsManager.getInstance(this.f9521a).cancelRequest(this.f9530y, true);
                this.f9530y = 0;
            }
            e();
        }
    ...
    public final void c(TLRPC.InputFile inputFile, TLRPC.InputFile inputFile2) {
        ...
        if (this.f9523c) {
            ...
            tL_documentAttributeVideo.duration = this.f9525n;
            tL_documentAttributeVideo.f17202w = this.f9524f;
            ...
            if (!z10 && !z11) {
                ...
                TLRPC.Document document = this.f9526r;
                if (z11) {
        ...
        this.f9530y = ConnectionsManager.getInstance(this.f9521a).sendRequest(tL_messages_uploadMedia, new bi.c2(this, 14));
    }

    public final void d() {
        int i10;
        int i11;
        if (!this.v && !this.f9528w && !this.f9529x) {
            this.v = true;
            if (this.f9523c) {
                c5 c5Var = this.f9527s;
                int i12 = this.f9524f;
                ...
                try {
                    ...
                    BitmapFactory.decodeFile(this.f9522b, options);
                    int i13 = options.outWidth;
                    if (i13 > 0 && (i10 = options.outHeight) > 0) {
                        this.f9527s.a(i13, i10);
                    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i11 == this.f9521a && !this.f9528w && !this.f9529x) {
            ...
            if (this.E != null && this.E.equals(str)) {
                if (i10 == NotificationCenter.fileUploaded) {
                    ...
                    if (this.e && !this.H && !TextUtils.isEmpty(this.F)) {
                        ...
                        this.H = true;
                        this.E = this.F;
                        FileLoader.getInstance(this.f9521a).uploadFile(this.E, false, true, 16777216);
