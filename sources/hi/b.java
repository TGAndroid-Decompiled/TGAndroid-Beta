...
public final class b extends za {
    ...
    public b(Context context, TLRPC.Chat chat, long j3, Utilities.Callback callback) {
        ...
        this.f10544b0 = UserObject.isBot(user);
        this.f10543a0 = ChatObject.isChannelAndNotMegaGroup(chat2);
        this.L = false;
        this.K = AndroidUtilities.dp(12.0f);
        this.e.setTitle(y());
        setBackgroundColor(i6.v0(i6.f18780a7, this.resourcesProvider));
    ...
    public final void Q(boolean z10) {
        ...
        if (this.Y != z10) {
            this.Y = z10;
            ll0 ll0Var = this.d;
            View U0 = ll0Var.U0(this.f10545c0 + 1);
            if (U0 instanceof org.telegram.ui.Cells.i6) {
                ((org.telegram.ui.Cells.i6) U0).a(!z10);
                z11 = false;
            } else {
                z11 = true;
            }
            View U02 = ll0Var.U0(this.f10545c0 + 2);
            if (U02 instanceof org.telegram.ui.Cells.i6) {
                ((org.telegram.ui.Cells.i6) U02).a(z10);
            } else {
                z11 = true;
            }
            if (z11) {
