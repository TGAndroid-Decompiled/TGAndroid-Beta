...
public final class b extends ab {
    ...
    public b(Context context, TLRPC.Chat chat, long j3, Utilities.Callback callback) {
        ...
        this.f10550b0 = UserObject.isBot(user);
        this.f10549a0 = ChatObject.isChannelAndNotMegaGroup(chat2);
        this.L = false;
    ...
    public final void P(Utilities.Callback callback, boolean z10, boolean z11) {
        ...
        if (z11 && !z10 && !this.f10550b0) {
            ...
            d5.P(context, f6Var, string, LocaleController.getString(i10), LocaleController.getString(R.string.Add), new y0(this, callback, z10, 3)).show();
            return;
        }
