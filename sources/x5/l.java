...
public abstract class l {
    public static final Object f48951a = new Object();
    public static boolean f48952b;
    public static int f48953c;
    ...
    public static void d(Handler handler) {
        ...
        if (myLooper != handler.getLooper()) {
            ...
            throw new IllegalStateException(j2.h("Must be called on ", handler.getLooper().getThread().getName(), " thread, but got ", str, "."));
        }
    }
