...
public final class n extends o6.a {
    ...
    public final String toString() {
        ...
        return "UsageInfo[documentId=" + this.f40670a + ", timestamp=" + this.f40671b + ", usageType=" + this.f40672c + ", status=" + this.f40674n + "]";
    }

    @Override
    public final void writeToParcel(Parcel parcel, int i10) {
        int q6 = e0.q(parcel, 20293);
        e0.k(parcel, 1, this.f40670a, i10);
        e0.s(parcel, 2, 8);
        parcel.writeLong(this.f40671b);
        e0.s(parcel, 3, 4);
        parcel.writeInt(this.f40672c);
        e0.l(parcel, 4, this.d);
        e0.k(parcel, 5, this.e, i10);
        e0.s(parcel, 6, 4);
        parcel.writeInt(this.f40673f ? 1 : 0);
        e0.s(parcel, 7, 4);
        parcel.writeInt(this.h);
        e0.s(parcel, 8, 4);
        parcel.writeInt(this.f40674n);
        e0.l(parcel, 9, this.f40675r);
        e0.r(parcel, q6);
    }
}
