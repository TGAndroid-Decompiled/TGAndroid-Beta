...
public final class g extends o6.a {
    ...
    public final l f43995b;
    public final int f43996c;
    public final byte[] d;
    public static final int f43993e = Integer.parseInt("-1");
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        e0.l(parcel, 1, this.f43994a);
        e0.k(parcel, 3, this.f43995b, i10);
        e0.s(parcel, 4, 4);
        parcel.writeInt(this.f43996c);
