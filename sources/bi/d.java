    ...
    public final void a(int i10, View view) {
        ...
        switch (this.f2872a) {
            ...
            case 4:
                ...
                if (i10 >= 0) {
                    e2Var.d.getClass();
                    if (RecyclerView.U(view).f45770f != 4) {
            ...
            case 5:
                ...
                rbVar.l1.setTypeface(j0Var.f44482a);
                qg.s0 e7 = qg.s0.e(rbVar.F1);
                String str = j0Var.f44482a;
                e7.f44601j = str;
                e7.f44594a.edit().putString("typeface", str).apply();
                rg.k kVar2 = rbVar.J0;
            ...
            case 9:
                ...
                if (view instanceof org.telegram.ui.Cells.m4) {
                    ...
                    if (m4Var.E) {
                        gy gyVar = i0Var.U;
                        if (gyVar != null) {
                            gyVar.f36837a.N4(m4Var.getDialogId(), view);
                            return;
                        }
                        return;
                    }
                ...
                if (gyVar2 != null) {
                    ...
                    uyVar.J3();
                    if (AndroidUtilities.isTablet() && uyVar.f41286e0 != null) {
                        int i13 = 0;
                        while (true) {
                            ty[] tyVarArr = uyVar.f41286e0;
                            if (i13 < tyVarArr.length) {
                                bx bxVar = tyVarArr[i13].d;
                                uyVar.f41341p2.dialogId = longValue2;
                ...
                if (O instanceof ig.a2) {
                    if (!UserConfig.getInstance(viVar.J1).isPremium()) {
                        if (viVar.f31306f0 != null) {
                            new sg.a1(viVar.f31306f0, i0Var2.getContext(), viVar.J1, true, 31, false, null).show();
                            return;
                        }
                        return;
                    }
            ...
            case 14:
                ...
                zt0Var.f45398u1.setTypeface(j0Var2.f44482a);
                qg.s0 e10 = qg.s0.e(zt0Var.P1);
                String str2 = j0Var2.f44482a;
                e10.f44601j = str2;
                e10.f44594a.edit().putString("typeface", str2).apply();
            ...
            case 15:
                ...
                k1Var.f45297b3.accept(Integer.valueOf(k1Var.f45296a3.b(i10)));
                qg.s0 s0Var = k1Var.f45296a3;
                s0Var.f44596c.put(Integer.valueOf(s0Var.f44598f), Integer.valueOf(s0Var.b(i10)));
                s0Var.f44597e = true;
                return;
            case 16:
            ...
            case 20:
                ...
                di.d dVar = k4Var.f50412c0;
                HashSet hashSet = k4Var.Z;
                v51 v51Var2 = k4Var.f50414e0;
