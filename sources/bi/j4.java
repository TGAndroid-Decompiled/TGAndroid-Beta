    ...
    public final void onAnimationEnd(Animator animator) {
        switch (this.f3163a) {
            case 0:
                ...
                return;
            case 1:
                ((ActionBarPopupWindow$ActionBarPopupWindowLayout) this.d).f20224x.remove((AnimatorSet) this.f3164b);
                View view = (View) this.f3165c;
                if (view instanceof org.telegram.ui.ActionBar.f1) {
                    aj0 aj0Var = ((org.telegram.ui.ActionBar.f1) view).f20431c;
            ...
            case 2:
                ...
                if (viewGroup != null) {
                    chatActivityEnterView.l1.removeView(chatActivityEnterView.f23718e1);
                    viewGroup.addView(chatActivityEnterView.f23718e1, (ViewGroup.LayoutParams) this.f3165c);
                }
                chatActivityEnterView.f23718e1.setAlpha(1.0f);
                chatActivityEnterView.f23737h1.setAlpha(1.0f);
                chatActivityEnterView.h = 0.0f;
                chatActivityEnterView.f23767n = 0.0f;
                chatActivityEnterView.F1();
                fi.c0 c0Var = chatActivityEnterView.f23759l0;
                if (c0Var != null) {
                    c0Var.setAlpha(0.0f);
                    chatActivityEnterView.f23759l0.setScaleX(0.0f);
                    chatActivityEnterView.f23759l0.setScaleY(0.0f);
                }
            ...
            case 5:
                ...
                if (animator.equals(kzVar.M0)) {
                    ...
                    if (ll0Var == kzVar.D0) {
                        ll0Var.setPadding(0, AndroidUtilities.dp(36.0f), 0, AndroidUtilities.dp(44.0f) + kzVar.f28004q2);
                    } else if (ll0Var == kzVar.f27976h0) {
                        ll0Var.setPadding(0, kzVar.f27956b1, 0, AndroidUtilities.dp(44.0f) + kzVar.f28004q2);
                    } else if (ll0Var == kzVar.P) {
                        ll0Var.setPadding(AndroidUtilities.dp(5.0f), AndroidUtilities.dp(36.0f), AndroidUtilities.dp(5.0f), AndroidUtilities.dp(44.0f) + kzVar.f28004q2);
                    }
                    if (L0 != -1) {
                        sVar.h1(L0, 0);
                    }
            ...
            case 6:
                ...
                w50Var.f32155b.setRotationY(0.0f);
            ...
            case 7:
                ...
                View view2 = n70Var.f28665f;
                viewTreeObserver.removeOnPreDrawListener(n70Var.f28693y);
                if (n70Var.P) {
                    ...
                    if (view2 instanceof yh.h1) {
                        ...
                        frameLayout.invalidateDrawable(h1Var.f50343e);
                        return;
                    }
                    return;
                }
