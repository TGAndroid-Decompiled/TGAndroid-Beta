...
public final class ca {
                ...
                while (true) {
                    ...
                    if (aaVar != null) {
                        ...
                        if (f11 == f12) {
                            ...
                            float lerp2 = AndroidUtilities.lerp(aaVar.d, aaVar.f2804f, pr.f29495g.getInterpolation(daVar.f2911w));
    ...
    public final void g(CharSequence charSequence, z9 z9Var, z9 z9Var2) {
        ...
        if (z9Var != null) {
            ...
            z9Var.h.f25591a = daVar;
            z9Var.f4107i.f33146a = daVar;
            z9Var.c();
        }
        ...
        if (z9Var3 != null) {
            ...
            z9Var3.h.f25591a = daVar;
            z9Var3.f4107i.f33146a = daVar;
            z9Var3.c();
        }
        daVar.f2910s = 0;
        daVar.requestLayout();
