...
public final class ca {
                ...
                while (true) {
                    ...
                    if (aaVar != null) {
                        ...
                        if (f11 == f12) {
                            ...
                            float lerp2 = AndroidUtilities.lerp(aaVar.d, aaVar.f2777f, pr.f29468g.getInterpolation(daVar.f2884w));
    ...
    public final void g(CharSequence charSequence, z9 z9Var, z9 z9Var2) {
        ...
        if (z9Var != null) {
            ...
            z9Var.h.f25564a = daVar;
            z9Var.f4080i.f33119a = daVar;
            z9Var.c();
        }
        ...
        if (z9Var3 != null) {
            ...
            z9Var3.h.f25564a = daVar;
            z9Var3.f4080i.f33119a = daVar;
            z9Var3.c();
        }
        daVar.f2883s = 0;
        daVar.requestLayout();
