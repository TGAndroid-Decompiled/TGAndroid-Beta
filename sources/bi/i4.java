    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (this.f3120a) {
            ...
            case 1:
                ...
                float interpolation = pr.f29494f.getInterpolation(q6Var.f7981a1);
            ...
            case 3:
                ...
                if (nVar.f15050l) {
                    s1Var.f22764g0 = (-nVar.f15057s) * floatValue2;
                    s1Var.f22768h0 = (-nVar.f15058t) * floatValue2;
                    s1Var.f22778j0 = (-nVar.f15059u) * floatValue2;
                    s1Var.f22773i0 = (-nVar.v) * floatValue2;
                } else {
                    s1Var.f22764g0 = ((-nVar.f15057s) * floatValue2) - t1Var.getAnimationOffsetX();
                    s1Var.f22768h0 = ((-nVar.f15058t) * floatValue2) - t1Var.getAnimationOffsetX();
                    s1Var.f22778j0 = ((-nVar.f15059u) * floatValue2) - t1Var.getTranslationY();
                    s1Var.f22773i0 = ((-nVar.v) * floatValue2) - t1Var.getTranslationY();
                }
                t1Var.invalidate();
                return;
            default:
                ...
                o0Var.f45382i1 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                o0Var.f45376f1.invalidate();
                o0Var.f45370c1.invalidate();
                o0Var.f45372d1.invalidate();
                for (int i11 = 0; i11 < o0Var.f45376f1.getChildCount(); i11++) {
                    View childAt2 = o0Var.f45376f1.getChildAt(i11);
                    if (i11 == o0Var.f45380h1) {
                        f10 = o0Var.f45382i1;
                    } else if (i11 == o0Var.f45378g1) {
                        f10 = 1.0f - o0Var.f45382i1;
                    } else {
                        f10 = 0.0f;
                    }
                    childAt2.setAlpha((f10 * 0.4f) + 0.6f);
                }
                float interpolation2 = pr.f29494f.getInterpolation(o0Var.f45382i1);
