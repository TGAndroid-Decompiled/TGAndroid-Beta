    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (this.f3093a) {
            ...
            case 1:
                ...
                float interpolation = pr.f29467f.getInterpolation(q6Var.f7953a1);
            ...
            case 3:
                ...
                if (nVar.f15024l) {
                    s1Var.f22737g0 = (-nVar.f15031s) * floatValue2;
                    s1Var.f22741h0 = (-nVar.f15032t) * floatValue2;
                    s1Var.f22751j0 = (-nVar.f15033u) * floatValue2;
                    s1Var.f22746i0 = (-nVar.v) * floatValue2;
                } else {
                    s1Var.f22737g0 = ((-nVar.f15031s) * floatValue2) - t1Var.getAnimationOffsetX();
                    s1Var.f22741h0 = ((-nVar.f15032t) * floatValue2) - t1Var.getAnimationOffsetX();
                    s1Var.f22751j0 = ((-nVar.f15033u) * floatValue2) - t1Var.getTranslationY();
                    s1Var.f22746i0 = ((-nVar.v) * floatValue2) - t1Var.getTranslationY();
                }
                t1Var.invalidate();
                return;
            default:
                ...
                o0Var.f45354i1 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                o0Var.f45348f1.invalidate();
                o0Var.f45342c1.invalidate();
                o0Var.f45344d1.invalidate();
                for (int i11 = 0; i11 < o0Var.f45348f1.getChildCount(); i11++) {
                    View childAt2 = o0Var.f45348f1.getChildAt(i11);
                    if (i11 == o0Var.f45352h1) {
                        f10 = o0Var.f45354i1;
                    } else if (i11 == o0Var.f45350g1) {
                        f10 = 1.0f - o0Var.f45354i1;
                    } else {
                        f10 = 0.0f;
                    }
                    childAt2.setAlpha((f10 * 0.4f) + 0.6f);
                }
                float interpolation2 = pr.f29467f.getInterpolation(o0Var.f45354i1);
