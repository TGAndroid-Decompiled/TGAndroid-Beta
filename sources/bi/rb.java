...
public final class rb extends qb {
    ...
    public final void a(Canvas canvas, float f7) {
        ...
        if (imageReceiver != null && imageReceiver.hasImageSet() && imageReceiver.hasImageLoaded()) {
            ...
            float f10 = (float) (((mediaAreaCoordinates.f20103x * d) / 100.0d) + ubVar.f3843b);
            double d10 = ubVar.f3844c;
            double d11 = ubVar.f3845e;
            float f11 = (float) (((mediaAreaCoordinates.f20104y * d11) / 100.0d) + d10);
            float f12 = ((float) ((d * mediaAreaCoordinates.f20102w) / 100.0d)) / 2.0f;
