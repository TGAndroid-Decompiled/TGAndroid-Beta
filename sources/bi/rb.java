...
public final class rb extends qb {
    ...
    public final void a(Canvas canvas, float f7) {
        ...
        if (imageReceiver != null && imageReceiver.hasImageSet() && imageReceiver.hasImageLoaded()) {
            ...
            float f10 = (float) (((mediaAreaCoordinates.f20130x * d) / 100.0d) + ubVar.f3870b);
            double d10 = ubVar.f3871c;
            double d11 = ubVar.f3872e;
            float f11 = (float) (((mediaAreaCoordinates.f20131y * d11) / 100.0d) + d10);
            float f12 = ((float) ((d * mediaAreaCoordinates.f20129w) / 100.0d)) / 2.0f;
