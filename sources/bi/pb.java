...
public final class pb implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.ActionBar.j2, sf.a {
    ...
    public static void J(long j3, TL_stories.StoryItem storyItem, Editable editable) {
        if (j3 != 0 && storyItem != null) {
            E1.put(j3 + (j3 >> 16) + (storyItem.f20106id << 16), editable);
        }
    }
    ...
    public static CharSequence u(long j3, TL_stories.StoryItem storyItem) {
        ...
        return (CharSequence) E1.get(j3 + (j3 >> 16) + (storyItem.f20106id << 16), "");
    }
        ...
        if (i10 == NotificationCenter.storiesListUpdated) {
            if (this.O0 == ((l8) objArr[0])) {
                ...
                if (a7Var != null) {
                    ...
                    while (i12 < this.O0.f3275i.size()) {
                        if (selectedStory != null && selectedStory.f20106id == ((MessageObject) this.O0.f3275i.get(i12)).storyItem.f20106id) {
                            i13 = i12;
                        }
            ...
            if (i10 != i15 && i10 != NotificationCenter.articleClosed) {
                if (i10 == NotificationCenter.storyDeleted) {
                    ...
                    if (storyItem != null && storyItem.dialogId == longValue && storyItem.f20106id == intValue) {
                        this.S0 = true;
                        return;
                    }
                    return;
    ...
    public final void m() {
        if (this.H == null) {
            ...
            this.H.setInterpolator(org.telegram.ui.ActionBar.p1.f21276w);
            this.H.start();
        }
    }
    ...
    public final void n(boolean z10) {
        if (this.f3580v1 == null) {
            ...
            if (z10) {
                ...
                this.f3580v1.setDuration(350L);
                this.f3580v1.setInterpolator(pr.f29467f);
            }
            this.f3580v1.start();
        }
    }
