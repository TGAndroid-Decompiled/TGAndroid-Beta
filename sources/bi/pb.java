...
public final class pb {
    ...
    public pb(int i10, ArrayList arrayList) {
        ...
        if (a(arrayList, TLRPC.TL_privacyValueAllowAll.class) != null) {
            ...
            if (tL_privacyValueDisallowUsers != null) {
                ...
                this.f3416b.add(tL_inputPrivacyValueDisallowUsers);
            }
            ...
            if (tL_privacyValueAllowUsers != null) {
                ...
                this.f3416b.add(tL_inputPrivacyValueAllowUsers);
                ...
                if (tL_privacyValueDisallowUsers2 != null) {
                    ...
                    this.f3416b.add(tL_inputPrivacyValueDisallowUsers2);
                }
            } else {
                this.f3415a = 4;
            }
    ...
    public final boolean b(TLRPC.User user) {
        ...
        int i10 = this.f3415a;
        if (i10 == 4) {
            return !arrayList.contains(Long.valueOf(user.f17342id));
        }
        if (i10 == 2) {
            if (arrayList.contains(Long.valueOf(user.f17342id)) || !user.contact) {
                return false;
            }
            return true;
        } else if (i10 == 1) {
            ...
            if (i10 == 3) {
                if (arrayList.contains(Long.valueOf(user.f17342id))) {
                    return true;
                }
                for (ArrayList arrayList2 : this.d.values()) {
                    if (arrayList2.contains(Long.valueOf(user.f17342id))) {
                        return true;
                    }
                }
            }
    ...
    public final String toString() {
        int size;
        ArrayList arrayList = this.f3418f;
    ...
    public pb(int i10, ArrayList arrayList, int i11) {
        ...
        if (i10 == 4) {
            ...
            while (i12 < arrayList.size()) {
                ...
                if (inputUser != null) {
                    tL_inputPrivacyValueDisallowUsers.users.add(inputUser);
                    this.f3417c.add(Long.valueOf(inputUser.user_id));
                    this.e.add(inputUser);
                }
                i12++;
            }
            ...
            while (i12 < arrayList.size()) {
                ...
                if (inputUser2 != null) {
                    tL_inputPrivacyValueDisallowUsers2.users.add(inputUser2);
                    this.f3417c.add(Long.valueOf(inputUser2.user_id));
                    this.e.add(inputUser2);
                }
                i12++;
            }
            ...
            if (i10 == 5) {
                while (i12 < arrayList.size()) {
                    ...
                    if (inputUser3 != null) {
                        this.f3418f.add(Long.valueOf(inputUser3.user_id));
                    }
                    i12++;
                }
            }
            ...
            if (!arrayList.isEmpty()) {
                while (i12 < arrayList.size()) {
                    ...
                    if (inputUser4 != null) {
                        ...
                        this.f3417c.add(Long.valueOf(inputUser4.user_id));
