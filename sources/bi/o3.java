...
public final class o3 implements og {
    ...
    public final boolean a1(long j3) {
        ...
        if (storyItem != null && (storyItem.media instanceof TLRPC.TL_messageMediaVideoStream)) {
            ...
            savedefaultsendas.call = ((TLRPC.TL_messageMediaVideoStream) m5Var.f3310a.media).call;
            ...
            o5Var.r0(true);
            o5Var.f3406b2.P1(true);
            o5Var.f3406b2.K(true);
            o5Var.f1(false);
        }
        return true;
    }
    ...
    public final void a2() {
        ...
        o5Var.W2.f(o5Var.f3406b2.getAudioVideoButtonContainer(), true);
    }
    ...
    public final void c2(int i10, int i11, int i12, long j3, long j10, boolean z10) {
        ...
        if (o5Var.J2 == null && CameraView.isCameraAllowed()) {
            ...
            o5Var.addView(o5Var.J2, Math.min(o5Var.indexOfChild(o5Var.f3406b2.getRecordCircle()), o5Var.indexOfChild(o5Var.f3406b2.N1)), w7.x5.e(-1, -1, 51));
        }
        w50 w50Var = o5Var.J2;
        if (w50Var != null) {
            if (i10 == 0) {
    ...
    public final boolean d1() {
        w50 w50Var = this.f3398a.J2;
        if (w50Var != null && !w50Var.f32134e0) {
            return true;
        }
        return false;
    }
    ...
    public final void f1(CharSequence charSequence, boolean z10, boolean z11) {
        o5 o5Var = this.f3398a;
        if (o5Var.f3415d3 == null) {
            p3 p3Var = new p3(o5Var, o5Var.getContext(), o5Var.B1, o5Var.J0.f3545f, o5Var.B0);
            o5Var.f3415d3 = p3Var;
            p3Var.p(new s3(o5Var));
            o5Var.addView(o5Var.f3415d3, w7.x5.e(-1, -1, 83));
        }
        if (o5Var.f3415d3.getAdapter() != null) {
            o5Var.f3415d3.setDialogId(o5Var.B1);
            if (o5Var.O1.f3314f) {
                hg.k1 adapter = o5Var.f3415d3.getAdapter();
                if (adapter.f11140j0 == 0 && adapter.f11153u0 == 0 && adapter.f11152t0 == 0 && adapter.E0 == 0) {
                    adapter.f11156w0 = null;
                    adapter.F = null;
                    ...
                    adapter.T = null;
                    adapter.U = null;
                    ArrayList arrayList3 = adapter.f11157x;
                    if (arrayList3 != null) {
                        arrayList3.clear();
                    }
                ...
                hg.k1 adapter2 = o5Var.f3415d3.getAdapter();
                MessagesController.getInstance(o5Var.C2).getUser(Long.valueOf(o5Var.B1));
                TLRPC.Chat chat = MessagesController.getInstance(o5Var.C2).getChat(Long.valueOf(-o5Var.B1));
                adapter2.getClass();
                adapter2.f11142l0 = chat;
                o5Var.f3415d3.getAdapter().U(charSequence, o5Var.f3406b2.getCursorPosition(), null, false, false);
            }
        }
        o5Var.invalidate();
    }
