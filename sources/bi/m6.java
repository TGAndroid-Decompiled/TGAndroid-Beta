    ...
    public void e(boolean z10, boolean z11) {
        switch (this.K) {
            case 2:
                ...
                float f7 = 1.0f;
                if (z11) {
                    ViewPropertyAnimator animate = eg1Var.f36082n.f41113a.animate();
                    if (z10) {
                        f7 = 0.0f;
                    }
                ...
                eg1Var.f36082n.f41113a.animate().cancel();
                TextView textView = eg1Var.f36082n.f41113a;
                if (z10) {
                    f7 = 0.0f;
                }
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.K) {
            case 0:
                ...
                super.onMeasure(i10, vl.d(s6Var.f3720e, s6Var.f3722n - s6Var.f3723r.getPaddingTop(), 1073741824));
                return;
            default:
