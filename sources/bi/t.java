...
public class t extends uk0 {
    ...
    public final boolean L(int i10) {
        nr0 nr0Var = this.f3589s.W;
        d9 d9Var = this.e;
        if (d9Var != null) {
            if (d9Var instanceof t8) {
                TLRPC.User user = MessagesController.getInstance(nr0Var.f3608b).getUser(Long.valueOf(nr0Var.d));
    ...
    public final void v(c1 c1Var, int i10) {
        ...
        if (this.e != null) {
            ...
            if (size >= 0 && size < this.e.f721i.size()) {
                ...
                nr0 nr0Var = uVar.W;
                if (nr0Var.G.C1 && messageObject3 != null) {
                    t7Var.i(nr0Var.c(messageObject3), true);
                    return;
                } else {
                    t7Var.i(false, false);
                    return;
    ...
    public final c1 x(ViewGroup viewGroup, int i10) {
        nr0 nr0Var = this.f3589s.W;
        if (this.h == null) {
            this.h = new s7(viewGroup.getContext(), nr0Var.f3609c);
        }
        t7 t7Var = new t7(this.f3585c, this.h, nr0Var.f3608b);
        t7Var.f21410w0 = true;
