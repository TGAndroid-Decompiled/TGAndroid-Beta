...
public class t extends tk0 {
    ...
    public final String F(int i10) {
        ...
        d9 d9Var = this.e;
        if (d9Var == null || i10 < 0 || i10 >= d9Var.f716i.size() || (messageObject = (MessageObject) this.e.f716i.get(i10)) == null || (storyItem = messageObject.storyItem) == null) {
            return null;
        }
    ...
    public final boolean L(int i10) {
        mr0 mr0Var = this.f3584s.W;
        d9 d9Var = this.e;
        if (d9Var != null) {
            if (d9Var instanceof t8) {
                TLRPC.User user = MessagesController.getInstance(mr0Var.f3603b).getUser(Long.valueOf(mr0Var.d));
                if (user != null && user.bot && user.bot_has_main_app && user.bot_can_edit) {
                    return true;
                }
                return false;
            } else if (i10 >= 0 && i10 < d9Var.f716i.size()) {
                return this.e.m(((MessageObject) this.e.f716i.get(i10)).getId());
            } else {
                return false;
            }
        }
    ...
    public void l() {
        ...
        if (z10) {
            ...
            arrayList.clear();
            ArrayList E = MessagesController.getInstance(this.e.f713c).getStoriesController().E(uVar.W.d);
            if (E != null) {
                for (int i10 = 0; i10 < E.size(); i10++) {
                    k9 k9Var = (k9) E.get(i10);
                    o8 o8Var = k9Var.f1138c;
                    if (o8Var != null && !o8Var.f5152g && TextUtils.equals(o8Var.K0, t8Var.E)) {
                        arrayList.add(k9Var);
                    }
                }
            }
        ...
        if (this.e != null) {
            ...
            if (i10 >= 0 && i10 < arrayList.size()) {
                ...
                if (k9Var.K == null) {
                    ...
                    tL_storyItem.f18348id = i14;
                    tL_storyItem.attachPath = k9Var.f1139f;
                    MessageObject messageObject = new MessageObject(this.e.f713c, tL_storyItem);
            ...
            if (size >= 0 && size < this.e.f716i.size()) {
                MessageObject messageObject3 = (MessageObject) this.e.f716i.get(size);
    ...
    public final c1 x(ViewGroup viewGroup, int i10) {
        mr0 mr0Var = this.f3584s.W;
        if (this.h == null) {
            this.h = new s7(viewGroup.getContext(), mr0Var.f3604c);
        }
        t7 t7Var = new t7(this.f3580c, this.h, mr0Var.f3603b);
        t7Var.f21400w0 = true;
