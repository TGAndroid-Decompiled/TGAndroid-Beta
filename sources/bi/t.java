...
public class t extends gl0 {
    ...
    public final boolean L(int i10) {
        zr0 zr0Var = this.f3588s.W;
        d9 d9Var = this.e;
        if (d9Var != null) {
            if (d9Var instanceof t8) {
                TLRPC.User user = MessagesController.getInstance(zr0Var.f3607b).getUser(Long.valueOf(zr0Var.d));
        ...
        if (z10) {
            ...
            if (E != null) {
                for (int i10 = 0; i10 < E.size(); i10++) {
                    ...
                    if (o8Var != null && !o8Var.f5156g && TextUtils.equals(o8Var.K0, t8Var.E)) {
                        arrayList.add(k9Var);
                    }
                }
            }
        ...
        if (this.e != null) {
            ...
            if (size >= 0 && size < this.e.f718i.size()) {
                ...
                if (zr0Var.G.C1 && messageObject3 != null) {
                    u7Var.i(zr0Var.c(messageObject3), true);
                    return;
                } else {
                    u7Var.i(false, false);
                    return;
    ...
    public final c1 x(ViewGroup viewGroup, int i10) {
        zr0 zr0Var = this.f3588s.W;
        if (this.h == null) {
            this.h = new t7(viewGroup.getContext(), zr0Var.f3608c);
        }
        u7 u7Var = new u7(this.f3584c, this.h, zr0Var.f3607b);
        u7Var.f21663w0 = true;
