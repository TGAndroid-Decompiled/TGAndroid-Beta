...
public final class ja extends View {
    ...
    public final org.telegram.ui.ActionBar.f6 f3170a;
    public final TextPaint f3171b;
    public final PorterDuffColorFilter f3172c;
    public StaticLayout d;
    public float f3173e;
    public org.telegram.ui.Components.v5 f3174f;
    public final h90 h;
    public final Path f3175n;
    public final ArrayList f3176r;
    public final ArrayList f3177s;
    public boolean v;
    public boolean f3178w;
    public final Object f3179x;
    public float f3180y;
    ...
    public ja(Context context, int i10, TLObject tLObject, Object obj, boolean z10, ArrayList arrayList, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        setBackground(org.telegram.ui.ActionBar.j6.Y(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20753i6, f6Var), 0, 8));
        setClickable(true);
        TextPaint textPaint = new TextPaint(1);
        this.f3171b = textPaint;
        textPaint.setTextSize(AndroidUtilities.dp(13.0f));
        int i11 = org.telegram.ui.ActionBar.j6.E8;
        textPaint.setColor(org.telegram.ui.ActionBar.j6.v0(i11, f6Var));
        this.f3172c = new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i11, f6Var), PorterDuff.Mode.SRC_IN);
        ...
        this.f3179x = obj;
        if (z10) {
            this.f3176r = new ArrayList();
            this.f3177s = new ArrayList();
            this.v = false;
            this.f3178w = false;
        ...
        this.f3177s = arrayList2;
        arrayList2.addAll(arrayList);
        if (this.f3177s.size() == 1) {
            MediaDataController.getInstance(i10).getStickerSet((TLRPC.InputStickerSet) this.f3177s.get(0), 0, false, new ha(this, 0));
            return;
        }
        set(this.f3177s.size());
        d(false);
    }
    ...
    public static void a(ja jaVar, TLObject tLObject, Object obj, ArrayList arrayList, boolean[] zArr, int i10) {
        ...
        for (int i12 = 0; i12 < vector.objects.size(); i12++) {
            ...
            jaVar.f3176r.add(stickerSetCovered);
            TLRPC.StickerSet stickerSet = stickerSetCovered.set;
            if (stickerSet != null) {
                jaVar.f3177s.add(MediaDataController.getInputStickerSet(stickerSet));
        ...
        ArrayList arrayList2 = jaVar.f3176r;
        if (arrayList2 == null) {
            size = 0;
        } else {
        ...
        int i13 = i11 + size;
        if (jaVar.f3177s != null && arrayList != null && !arrayList.isEmpty()) {
            for (int i14 = 0; i14 < arrayList.size(); i14++) {
                TLRPC.InputStickerSet inputStickerSet = (TLRPC.InputStickerSet) arrayList.get(i14);
                long j3 = inputStickerSet.f19889id;
                int i15 = 0;
                while (true) {
                    if (i15 < jaVar.f3177s.size()) {
                        if (((TLRPC.InputStickerSet) jaVar.f3177s.get(i15)).f19889id == j3) {
                            break;
                        }
                        i15++;
                    } else {
                        jaVar.f3177s.add(inputStickerSet);
                        break;
                    }
                }
            }
        ...
        if (i13 == 1) {
            if (jaVar.f3176r.size() >= 1) {
                jaVar.set((TLRPC.StickerSetCovered) jaVar.f3176r.get(0));
    ...
    private void set(TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        ...
        spannableString.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, this.h.f26671a)), 0, spannableString.length(), 33);
        ...
        while (true) {
            if (i10 >= arrayList.size()) {
                document = null;
                break;
            } else if (arrayList.get(i10).f19875id == tL_messages_stickerSet.set.thumb_document_id) {
        ...
        if (document != null) {
            spannableString.setSpan(new org.telegram.ui.Components.z5(document, this.f3171b.getFontMetricsInt()), 0, 1, 33);
    ...
    public final void d(boolean z10) {
        ...
        if (z10) {
            boolean z11 = false;
            this.H = ValueAnimator.ofFloat(this.f3180y, 1.0f);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f7 = this.f3180y;
        if (f7 < 1.0f) {
            h90 h90Var = this.h;
            h90Var.setAlpha((int) ((1.0f - f7) * 255.0f));
            Path path = this.f3175n;
            path.rewind();
        ...
        if (this.d != null) {
            ...
            if (this.f3180y > 0.0f) {
                ...
                this.f3171b.setAlpha((int) (this.f3180y * 255.0f));
                this.d.draw(canvas);
                org.telegram.ui.Components.z5.drawAnimatedEmojis(canvas, this.d, this.f3174f, 0.0f, null, 0.0f, 0.0f, 0.0f, this.f3180y, this.f3172c);
                canvas.restore();
            }
        }
    }
    ...
    public rv getAlert() {
        ...
        return new rv(null, getContext(), this.f3170a, this.f3177s);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int paddingBottom = getPaddingBottom() + AndroidUtilities.lerp(dp, height, this.f3180y) + paddingTop;
        if (z10) {
    ...
    public void setText(CharSequence charSequence) {
        ...
        StaticLayout staticLayout = new StaticLayout(charSequence, this.f3171b, measuredWidth, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        this.d = staticLayout;
        ...
        this.f3174f = org.telegram.ui.Components.z5.update(0, this, this.f3174f, this.d);
    }
    ...
    private void set(TLRPC.StickerSetCovered stickerSetCovered) {
        ...
        if (document == null && (stickerSetCovered instanceof TLRPC.TL_stickerSetFullCovered)) {
            ...
            for (int i10 = 0; i10 < arrayList.size(); i10++) {
                if (arrayList.get(i10).f19875id == stickerSetCovered.set.thumb_document_id) {
                    document = arrayList.get(i10);
                }
            }
            if (document == null && !arrayList.isEmpty()) {
    ...
    private void set(int i10) {
        ...
        h90 h90Var = this.h;
        if (z10 && this.f3178w) {
            setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("StoryContainsStickersEmoji", i10, new Object[0]), 0, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, h90Var.f26671a), null));
        } else if (z10) {
            setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("StoryContainsEmoji", i10, new Object[0]), 0, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, h90Var.f26671a), null));
        } else {
            setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("StoryContainsStickers", i10, new Object[0]), 0, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, h90Var.f26671a), null));
        }
    }
}
