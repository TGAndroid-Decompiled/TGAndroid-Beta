        ...
        switch (i10) {
            ...
            case 6:
                ...
                if (activity instanceof LaunchActivity) {
                    ((LaunchActivity) activity).f33472z0.post(new di.ka(pcVar2, 5));
                    return;
                } else {
                    pcVar2.q(true);
                    return;
            ...
            case 10:
                ji.r rVar = (ji.r) obj;
                org.telegram.ui.Components.e5.M(rVar.f28754b.f31280f0.getParentActivity(), j3, new xa.c(rVar, 22), rVar.f28753a);
                return;
            case 11:
