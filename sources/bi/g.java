...
public final class g extends s4.v {
    ...
    public final int e(RecyclerView recyclerView, c1 c1Var) {
        switch (this.d) {
            ...
            case 3:
                ...
                if (b10 >= in0Var.v && c1Var.b() < in0Var.f25126w) {
                    return s4.v.l(3, 0);
                }
                return s4.v.l(0, 0);
            case 4:
                r61 r61Var = (r61) this.e;
                if (r61Var.f27886c3 && r61Var.Y2.H(c1Var.b()) >= 0) {
                    int i10 = 15;
                    if (r61Var.X2.f42948o == 0) {
                        if (!r61Var.f27885b3) {
                            i10 = 12;
                        }
                    } else if (!r61Var.f27885b3) {
                        i10 = 3;
                    }
                    return s4.v.l(i10, 0);
                }
                return s4.v.l(0, 0);
            case 5:
                if (((l.d) ((v81) this.e).f29106y).G(c1Var.b())) {
                    return s4.v.l(12, 0);
                }
                return s4.v.l(0, 0);
            default:
    ...
    public boolean k() {
        switch (this.d) {
            ...
            case 4:
                r61 r61Var = (r61) this.e;
                if (r61Var.f27886c3 && r61Var.f27888e3) {
                    return true;
                }
                return false;
            case 6:
    ...
    public final boolean n(RecyclerView recyclerView, c1 c1Var, c1 c1Var2) {
        ...
        switch (this.d) {
            ...
            case 2:
                ...
                tn tnVar = ((vn) this.e).f29212r;
                int b14 = c1Var.b();
                int b15 = c1Var2.b();
                vn vnVar = tnVar.d;
                int i16 = vnVar.f29216t0;
                qh.f fVar = vnVar.l1;
                int i17 = b14 - i16;
                int i18 = b15 - i16;
            ...
            case 3:
                ...
                if (b17 >= in0Var.v && c1Var2.b() < in0Var.f25126w) {
                    int b18 = c1Var.b();
                    int b19 = c1Var2.b();
                    int i19 = in0Var.v;
                    int i20 = b18 - i19;
            ...
            case 4:
                ...
                if (j61Var.H(c1Var.b()) >= 0 && j61Var.H(c1Var.b()) == j61Var.H(c1Var2.b())) {
                    int b20 = c1Var.b();
                    int b21 = c1Var2.b();
                    ArrayList arrayList5 = j61Var.f25293x;
                    if (j61Var.L != null) {
                        int H = j61Var.H(b20);
                        int H2 = j61Var.H(b21);
                        if (H >= 0 && H == H2) {
            ...
            case 5:
                ...
                int i22 = 0;
                z11 = false;
                if (((l.d) v81Var.f29106y).G(b22) && ((l.d) v81Var.f29106y).G(b23)) {
                    Utilities.swapItems(arrayList6, b22, b23);
                    v81Var.f29105x.p(b22, b23);
                    ArrayList arrayList7 = new ArrayList();
                    int size2 = arrayList6.size();
                    while (i22 < size2) {
                        Object obj = arrayList6.get(i22);
                        i22++;
                        arrayList7.add(Integer.valueOf(((s81) obj).f28203a));
                    }
                    n81 n81Var = ((w81) ((l.d) v81Var.f29106y).f13924a).L;
                    z11 = true;
                    z11 = true;
                    if (n81Var != null) {
                        n81Var.a(arrayList7);
        ...
        switch (this.d) {
            ...
            case 2:
                ...
                if (i10 != 0) {
                    ...
                    wb1Var.I0(false);
                    c1Var.f42960a.setPressed(true);
                    c1Var.f42960a.setBackgroundColor(h6.v0(h6.f19129h5, vnVar.f27086a));
                    return;
                }
                return;
            case 3:
                if (i10 != 0) {
                    ((in0) this.e).f25120b.I0(false);
                    c1Var.f42960a.setPressed(true);
                    return;
                }
                return;
            case 4:
                ...
                if (i10 == 0) {
                    ...
                    if (r61Var.f27887d3 != null) {
                        r61Var.D1();
                        r61Var.f27887d3 = null;
                        return;
                    }
                    return;
                }
