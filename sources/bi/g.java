...
public final class g extends s4.v {
    ...
    public final int e(RecyclerView recyclerView, c1 c1Var) {
        switch (this.d) {
            case 0:
                ...
                return s4.v.l(0, 0);
            case 1:
                if (c1Var.f42700f == 1 && ((pa) c1Var.f42697a).G) {
                    return s4.v.l(3, 0);
                }
                return s4.v.l(0, 0);
            case 2:
            ...
            case 3:
                ...
                if (b10 >= wm0Var.v && c1Var.b() < wm0Var.f29701w) {
                    return s4.v.l(3, 0);
                }
                return s4.v.l(0, 0);
            case 4:
                f61 f61Var = (f61) this.e;
                if (f61Var.f23797c3 && f61Var.Y2.H(c1Var.b()) >= 0) {
                    int i10 = 15;
                    if (f61Var.X2.f42685o == 0) {
                        if (!f61Var.f23796b3) {
                            i10 = 12;
                        }
                    } else if (!f61Var.f23796b3) {
                        i10 = 3;
                    }
                    return s4.v.l(i10, 0);
                }
                return s4.v.l(0, 0);
            case 5:
                if (((ka.c) ((i81) this.e).f24896y).d(c1Var.b())) {
                    return s4.v.l(12, 0);
                }
                return s4.v.l(0, 0);
            default:
                if (c1Var.f42700f == 5 && r(c1Var.b())) {
                    return s4.v.l(3, 0);
                }
                return s4.v.l(0, 0);
        }
    ...
    public boolean k() {
        switch (this.d) {
            ...
            case 4:
                f61 f61Var = (f61) this.e;
                if (f61Var.f23797c3 && f61Var.f23799e3) {
                    return true;
                }
                return false;
            case 6:
    ...
    public final boolean n(RecyclerView recyclerView, c1 c1Var, c1 c1Var2) {
        ...
        switch (this.d) {
            ...
            case 2:
                ...
                sn snVar = ((un) this.e).f28439r;
                int b14 = c1Var.b();
                int b15 = c1Var2.b();
                un unVar = snVar.d;
                int i16 = unVar.f28443t0;
                qh.f fVar = unVar.l1;
                int i17 = b14 - i16;
                int i18 = b15 - i16;
            ...
            case 3:
                ...
                if (b17 >= wm0Var.v && c1Var2.b() < wm0Var.f29701w) {
                    int b18 = c1Var.b();
                    int b19 = c1Var2.b();
                    int i19 = wm0Var.v;
                    int i20 = b18 - i19;
            ...
            case 4:
                ...
                if (x51Var.H(c1Var.b()) >= 0 && x51Var.H(c1Var.b()) == x51Var.H(c1Var2.b())) {
                    int b20 = c1Var.b();
                    int b21 = c1Var2.b();
                    ArrayList arrayList5 = x51Var.f29854x;
                    if (x51Var.L != null) {
                        int H = x51Var.H(b20);
                        int H2 = x51Var.H(b21);
                        if (H >= 0 && H == H2) {
            ...
            case 5:
                ...
                int i22 = 0;
                z11 = false;
                if (((ka.c) i81Var.f24896y).d(b22) && ((ka.c) i81Var.f24896y).d(b23)) {
                    Utilities.swapItems(arrayList6, b22, b23);
                    i81Var.f24895x.p(b22, b23);
                    ArrayList arrayList7 = new ArrayList();
                    int size2 = arrayList6.size();
                    while (i22 < size2) {
                        Object obj = arrayList6.get(i22);
                        i22++;
                        arrayList7.add(Integer.valueOf(((f81) obj).f23821a));
                    }
                    b81 b81Var = ((j81) ((ka.c) i81Var.f24896y).f13567b).L;
                    z11 = true;
                    z11 = true;
                    if (b81Var != null) {
                        b81Var.a(arrayList7);
                ...
                return z11;
            default:
                if (c1Var.f42700f == c1Var2.f42700f && r(c1Var.b()) && r(c1Var2.b())) {
                    aw0 aw0Var = ((cw0) this.e).f32932b;
                    int b24 = c1Var.b();
                    int b25 = c1Var2.b();
                    cw0 cw0Var = aw0Var.d;
                    int i23 = cw0Var.f32947n0;
                    int i24 = b24 - i23;
                    int i25 = b25 - i23;
                    if (i24 >= 0 && i25 >= 0 && i24 < (i12 = cw0Var.f32962y) && i25 < i12) {
        ...
        switch (this.d) {
            ...
            case 2:
                ...
                if (i10 != 0) {
                    ...
                    fc1Var.J0(false);
                    c1Var.f42697a.setPressed(true);
                    c1Var.f42697a.setBackgroundColor(j6.v0(j6.f18933h5, unVar.f26459a));
                    return;
                }
                return;
            case 3:
                if (i10 != 0) {
                    ((wm0) this.e).f29695b.J0(false);
                    c1Var.f42697a.setPressed(true);
                    return;
                }
                return;
            case 4:
                ...
                if (i10 == 0) {
                    ...
                    if (f61Var.f23798d3 != null) {
                        f61Var.E1();
                        f61Var.f23798d3 = null;
                        return;
                    }
                    return;
                }
    ...
    public boolean r(int i10) {
        ...
        if (!cw0Var.I || i10 - cw0Var.f32947n0 >= cw0Var.f32960x) {
            return true;
        }
        return false;
    }
