...
public final class u extends FrameLayout {
    ...
    public u(xr0 xr0Var, Context context) {
        ...
        l lVar = new l(this);
        this.f3597s = lVar;
        vl0Var.setLayoutManager(lVar);
        vl0Var.i(new k(this, 1));
        lVar.y1(this.e);
        vl0Var.setVisibility(8);
        addView((View) vl0Var, y5.c(-1.0f, -1));
        ...
        jx0Var.e(true, false);
        jx0Var.f25549b.setVisibility(8);
        jx0Var.d.setText(LocaleController.getString(R.string.ProfileBotPreviewEmptyTitle));
        jx0Var.e.setText(LocaleController.formatPluralString("ProfileBotPreviewEmptyText", MessagesController.getInstance(xr0Var.f3608b).botPreviewMediasMax, new Object[0]));
        String string = LocaleController.getString(R.string.ProfileBotPreviewEmptyButton);
        ci.d dVar = jx0Var.f25551f;
        ...
        jx0Var.f25548a.addView(oVar, y5.t(165, -2, 17, 0, 17, 0, 12));
        ci.d dVar2 = new ci.d(context, f6Var, false);
        this.F = dVar2;
        dVar2.setMinWidth(AndroidUtilities.dp(200.0f));
        jx0Var.f25548a.addView(dVar2, y5.q(-2, 44, 17));
    ...
    public final void c() {
        ...
        if (z10) {
            ...
            formatString = LocaleController.formatString(R.string.ProfileBotPreviewFooterLanguage, j41.E(this.f3591a.E, null, null));
        }
        ...
        if (z10) {
            ...
            jx0Var.f25551f.g(LocaleController.getString(R.string.ProfileBotPreviewEmptyButton), false, true);
            oVar2.setVisibility(8);
            dVar2.setVisibility(8);
        } else {
            jx0Var.d.setVisibility(8);
            jx0Var.e.setText(LocaleController.formatString(R.string.ProfileBotPreviewFooterLanguage, j41.E(this.f3591a.E, null, null)));
            jx0Var.f25551f.g(LocaleController.getString(R.string.ProfileBotPreviewEmptyButton), false, true);
