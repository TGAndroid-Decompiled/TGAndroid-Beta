    ...
    public final void run(Object obj) {
        ...
        switch (i10) {
            ...
            case 4:
                ...
                tnVar.f30643j0.d(tL_messageMediaToDo, null, null, null, true, 0, l4.longValue());
                tnVar.f28754b.dismiss(true);
                return;
            case 5:
                jy jyVar = (jy) obj4;
                ...
                while (i11 < size) {
                    ...
                    if (stickerSetCovered instanceof TLRPC.TL_stickerSetFullCovered) {
                        ...
                        TLRPC.TL_messages_stickerSet stickerSet = MediaDataController.getInstance(jyVar.f27585a.F.f27933c1).getStickerSet(MediaDataController.getInputStickerSet(stickerSetCovered.set), Integer.valueOf(stickerSetCovered.set.hash), true);
                        if (stickerSet != null) {
            ...
            case 8:
                ...
                new yh.c(mVar.getContext(), (org.telegram.ui.ActionBar.f6) obj2, mVar.f50416l0, (List) obj).show();
                return;
            case 9:
                yh.v vVar = (yh.v) obj4;
