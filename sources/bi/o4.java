...
public final class o4 implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        int i11 = 0;
        Object obj2 = this.d;
        Object obj3 = this.f3428c;
        Object obj4 = this.f3427b;
        switch (i10) {
            case 0:
                s4 s4Var = (s4) obj4;
                s4Var.getClass();
                ...
                rv rvVar = new rv(((pb) obj3).f3572f, s4Var.getContext(), (org.telegram.ui.ActionBar.f6) obj2, arrayList2);
                h5 h5Var = s4Var.f3714z0.Q1;
                if (h5Var != null) {
                    ((gb) h5Var).h(rvVar);
                    return;
                }
            ...
            case 1:
                ...
                o5 o5Var = f5Var.f2999l;
                if ((storyItem instanceof a8) && (b8Var = ((a8) storyItem).f2799a) != null) {
                    a3.k0 k0Var = new a3.k0(b8Var, storyItem2, callback, 6);
                    if (b8Var.F != 0) {
                        ConnectionsManager.getInstance(b8Var.f3298c).cancelRequest(b8Var.F, true);
                        b8Var.F = 0;
                    }
                    b8Var.C = false;
                    b8Var.D = false;
                ...
                tL_stories_getStoriesByID.f20140id.add(Integer.valueOf(storyItem.f20133id));
            ...
            case 2:
                ...
                o5Var2.S1.c(m8Var.f3348a, o5Var2.B1, (TL_stories.StoryItem) obj3);
                new yc(o5Var2.f3436c1, (org.telegram.ui.ActionBar.f6) obj2).Q(R.raw.contact_check, 36, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.StoryAddedToAlbumX, m8Var.f3349b))).j();
                return;
            case 3:
            ...
            case 4:
                ...
                tnVar.f30670j0.d(tL_messageMediaToDo, null, null, null, true, 0, l4.longValue());
                tnVar.f28781b.dismiss(true);
                return;
            case 5:
                jy jyVar = (jy) obj4;
                ...
                while (i11 < size) {
                    ...
                    if (stickerSetCovered instanceof TLRPC.TL_stickerSetFullCovered) {
                        ...
                        TLRPC.TL_messages_stickerSet stickerSet = MediaDataController.getInstance(jyVar.f27612a.F.f27960c1).getStickerSet(MediaDataController.getInputStickerSet(stickerSetCovered.set), Integer.valueOf(stickerSetCovered.set.hash), true);
                        if (stickerSet != null) {
            ...
            case 8:
                ...
                new yh.c(mVar.getContext(), (org.telegram.ui.ActionBar.f6) obj2, mVar.f50445l0, (List) obj).show();
                return;
            case 9:
                yh.v vVar = (yh.v) obj4;
