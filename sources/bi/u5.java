    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (this.f3822a) {
            ...
            case 7:
                ...
                return;
            case 8:
                o0 o0Var = ((a70) this.f3823b).f24327e.d;
                int i11 = o0Var.E1;
            ...
            case 9:
                ...
                if (i81Var.f27051x) {
                    ...
                    y71 y71Var = i81Var.M;
                    if (y71Var != null) {
                        y71Var.e(abs, i81Var.d, i81Var.f27043b);
                    }
                }
                i81Var.w(false);
                return;
            case 10:
                ...
                s1Var.J = floatValue;
                org.telegram.ui.Components.voip.r1 r1Var = s1Var.f31822i0;
                if (r1Var != null) {
                    ((ci1) r1Var).f35152b.f41144d0.d(floatValue, s1Var.P);
                }
                s1Var.invalidate();
                return;
            case 11:
                ((s4.u) this.f3823b).f45908x = valueAnimator.getAnimatedFraction();
                return;
            case 12:
                sg.r0 r0Var = (sg.r0) this.f3823b;
                r0Var.f46269n = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                r0Var.e();
                return;
            default:
