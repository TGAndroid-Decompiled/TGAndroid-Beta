...
public final class y3 extends ImageReceiver {
    ...
    public void invalidate() {
        switch (this.f4037a) {
            case 3:
                View view = ((go) this.f4038b).f36752b;
                if (view != null) {
                    view.invalidate();
                    return;
                }
                return;
            case 4:
                ((org.telegram.ui.Components.q5) this.f4038b).k();
                super.invalidate();
                return;
            default:
                super.invalidate();
    ...
    public boolean setImageBitmapByKey(Drawable drawable, String str, int i10, boolean z10, int i11) {
        ...
        switch (i12) {
            case 0:
                ...
                if (i10 == 1 && (runnable = o5Var.f3456i1) != null) {
                    runnable.run();
                    o5Var.f3456i1 = null;
                }
            ...
            case 1:
                if (drawable != null && i10 != 1) {
                    wl.q(((ig.e1) ((i5) obj).H).f12072n.animate().alpha(1.0f).translationY(0.0f), pr.f29497k, 250L);
                }
            ...
            case 4:
                ...
                if (q5Var.f29613m && hasImageLoaded()) {
                    q5Var.f29613m = false;
    ...
    public void setRoundRadius(int[] iArr) {
        switch (this.f4037a) {
            case 2:
                ...
                org.telegram.ui.Cells.t1 t1Var = (org.telegram.ui.Cells.t1) this.f4038b;
                int[] iArr2 = t1Var.R0;
                iArr2[0] = iArr[0];
                iArr2[1] = iArr[1];
                ...
                iArr2[3] = dp;
                iArr2[2] = dp;
                rh.g gVar = t1Var.f22903b6;
                if (gVar != null) {
                    gVar.f45649b.setRoundRadius(t1Var.R0);
                    return;
                }
                return;
            default:
