...
public final class y3 extends ImageReceiver {
    ...
    public void invalidate() {
        switch (this.f4037a) {
            case 3:
                View view = ((go) this.f4038b).f36753b;
                if (view != null) {
                    view.invalidate();
                    return;
                }
        ...
        switch (i12) {
            ...
            case 1:
                if (drawable != null && i10 != 1) {
                    vl.q(((ig.e1) ((i5) obj).H).f12072n.animate().alpha(1.0f).translationY(0.0f), pr.f29498k, 250L);
                }
            ...
            case 4:
                ...
                if (q5Var.f29614m && hasImageLoaded()) {
                    q5Var.f29614m = false;
    ...
    public void setRoundRadius(int[] iArr) {
        switch (this.f4037a) {
            case 2:
                ...
                iArr2[3] = dp;
                iArr2[2] = dp;
                rh.g gVar = t1Var.f22904b6;
                if (gVar != null) {
                    gVar.f45650b.setRoundRadius(t1Var.R0);
                    return;
                }
                return;
            default:
