...
public final class s3 implements la0 {
    ...
    public final Paint.FontMetricsInt k() {
        return this.f3684a.f3406b2.getEditField().getPaint().getFontMetricsInt();
    }
    ...
    public final void v(int i10, int i11, CharSequence charSequence, boolean z10) {
        this.f3684a.f3406b2.O0(i10, i11, charSequence, z10);
    }

    @Override
    public final void x(String str) {
        n3 n3Var = this.f3684a.f3406b2;
        n3Var.U();
        n3Var.U0.h(str);
    }
}
