...
public abstract class s6 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public s6(pb pbVar, Context context, d6 d6Var, ah.m mVar) {
        ...
        this.h = textView;
        textView.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20798j5, bVar));
    ...
    public static void f(int i10, long j3, TL_stories.StoryItem storyItem) {
        ...
        if (storyItem != null) {
            ...
            if (sparseArray == null) {
                ...
                r6Var = (r6) sparseArray.get(storyItem.f20133id);
            }
            ...
            sparseArray.put(storyItem.f20133id, r6Var2);
        }
    }
    ...
    public final void g(long j3, z6 z6Var) {
        ...
        if (z6Var != null && z6Var.f4087a != null) {
            NotificationsController.getInstance(this.v).processSeenStoryReactions(j3, z6Var.f4087a.f20133id);
        }
    }
    ...
    public final void h(boolean z10) {
        ...
        if (z11 != h6Var.f3089s || !z10) {
            ...
            if (!z10) {
                ...
                h6Var.f3090w.setInterpolator(pr.f29494f);
                h6Var.f3090w.start();
            }
        }
