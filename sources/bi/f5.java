...
public final class f5 extends wr {
    ...
    public final pb f2966e;
    public final boolean f2967f;
    public final boolean f2968g;
    public final boolean h;
    public final Context f2969i;
    public final l5 f2970j;
    public final boolean[] f2971k;
    public final o5 f2972l;
    ...
    @Override
    public final void c() {
        if (!this.f2965c && !this.f2971k[0]) {
            AndroidUtilities.runOnUIThread(new x4(this, 0));
        }
        o5 o5Var = this.f2972l;
        o5Var.f3460t1 = null;
        o5Var.f3457s1 = null;
    }
    ...
    public final void d(ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout, boolean z10) {
        m5 m5Var;
        boolean z11 = this.f2967f;
        o5 o5Var = this.f2972l;
        if (z11 && ((m5Var = o5Var.O1) == null || m5Var.f3311b == null)) {
            ...
            obj.f34915a = actionBarPopupWindow$ActionBarPopupWindowLayout2;
            ...
            int b10 = actionBarPopupWindow$ActionBarPopupWindowLayout.b(o5Var.C3.f34915a);
    ...
    public final void e(ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout, TL_stories.StoryItem storyItem) {
        ...
        if (o5Var.D1 && storyItem != null && !(storyItem.media instanceof TLRPC.TL_messageMediaVideoStream) && (chat = MessagesController.getInstance(o5Var.C2).getChat(Long.valueOf(-o5Var.B1))) != null) {
            TLRPC.ChatFull chatFull = MessagesController.getInstance(o5Var.C2).getChatFull(chat.f19869id);
            if (chatFull == null) {
                chatFull = MessagesStorage.getInstance(o5Var.C2).loadChatInfo(chat.f19869id, true, new CountDownLatch(1), false, false);
            }
            if (chatFull != null && chatFull.can_view_stats) {
                org.telegram.ui.ActionBar.v0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout, R.drawable.msg_stats, LocaleController.getString(R.string.ViewStatistics), false, this.d).setOnClickListener(new z4(this, storyItem, this.f2966e, chat, 0));
            }
        }
    }
}
