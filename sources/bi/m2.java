            ...
            default:
                ...
                if (storyItem2 instanceof a8) {
                    ...
                    if (!(storyItem2 instanceof TL_stories.TL_storyItemDeleted)) {
                            ...
                            if (peerStories != null) {
                                ...
                                while (true) {
                                    if (i14 < peerStories.stories.size()) {
                                        if (peerStories.stories.get(i14).f20133id == storyItem2.f20133id) {
                        ...
                        tL_stories_deleteStories.f20136id.add(Integer.valueOf(storyItem2.f20133id));
                        ConnectionsManager.getInstance(i12).sendRequest(tL_stories_deleteStories, new g7(u8Var, 5));
                        h9 h9Var = u8Var.f3840k;
                        h9Var.f3101b.getStorageQueue().postRunnable(new f9(h9Var, j10, storyItem2.f20133id, 0));
