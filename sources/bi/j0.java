...
public final class j0 implements Utilities.Callback3 {
    ...
    public final void run(Object obj, Object obj2, Object obj3) {
        ...
        switch (this.f3118a) {
            case 0:
                e3 e3Var = (e3) this.f3119b;
                e1 e1Var = (e1) this.f3120c;
                ...
                if (((Boolean) obj2).booleanValue()) {
                    ...
                    deletegroupcallparticipantmessages.participant = MessagesController.getInstance(i10).getInputPeer(e1Var.f2900c);
                    ...
                    ArrayList arrayList2 = e3Var.f3014s;
                    int i11 = 0;
                    boolean z10 = false;
                    while (i11 < arrayList.size()) {
                        if (((e1) arrayList.get(i11)).f2900c == j3) {
                            e1 e1Var2 = (e1) arrayList.get(i11);
                            int i12 = 0;
                            while (true) {
                                if (i12 < arrayList2.size()) {
                                    if (((f1) arrayList2.get(i12)).f2951f.contains(e1Var2)) {
                                        ((f1) arrayList2.get(i12)).f2951f.remove(e1Var2);
                ...
                if (bool2.booleanValue()) {
                    if (e3Var.M >= 0) {
                        ...
                        MessagesController.getInstance(i10).deleteParticipantFromChat(-e3Var.M, MessagesController.getInstance(i10).getInputPeer(e1Var.f2900c), false, true);
                        return;
                    }
                }
                return;
            case 1:
                fc fcVar = (fc) this.f3119b;
                di.p pVar = (di.p) this.f3120c;
                File file = (File) obj;
                ...
                if (o8Var != null) {
                    ...
                    o8Var2.f7783u0 = 1.0f;
                    pcVar.u();
                    if (pcVar.X0 != null && (rbVar = pcVar.f7910v1) != null) {
                        rg.d2 m0 = rbVar.m0(pcVar.K1.f7773p0, true);
                        fcVar.setHasRoundVideo(true);
                        pcVar.X0.s(pcVar.K1, m0, true);
                        AndroidUtilities.cancelRunOnUIThread(pVar.h);
                        pVar.f8002a.destroy(true, null);
                        m0.setDraw(false);
                ...
                return;
            default:
                fi.s sVar = (fi.s) this.f3119b;
                Utilities.Callback2 callback2 = (Utilities.Callback2) this.f3120c;
                ...
                if (tVar != null) {
                    try {
                        ...
                        if (i13 < 23) {
                            ...
                            if (uVar != null) {
                                str2 = !TextUtils.isEmpty(sVar.f9943g) ? new String(uVar.f1059b.doFinal(Utilities.hexToBytes(sVar.f9943g)), StandardCharsets.UTF_8) : sVar.f9943g;
                            } else if (!TextUtils.isEmpty(sVar.f9943g)) {
