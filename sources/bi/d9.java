        ...
        if (viewGroup != null) {
            ...
            while (i13 < viewGroup.getChildCount()) {
                ...
                if (childAt instanceof u) {
                    ...
                    org.telegram.ui.Cells.j2 j2Var = r2Var.f22661u0;
                    ...
                    if (n6Var.f22370x != j3) {
                        ...
                        if (n6Var.f22366n == i11 && z10) {
                            ...
                            if (alphaInternal < 1.0f) {
                                ...
                                mbVar.f3367j = paint;
                                paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20762h5, n6Var.getResourcesProvider()));
                            }
                            b(mbVar);
                            return true;
                        } else if (!z10) {
                            org.telegram.ui.Cells.m6 m6Var = n6Var.f22363c;
                            mbVar.f3360a = m6Var;
                            mbVar.f3370m = n6Var.f22371y;
                            ...
                            if (alphaInternal2 < 1.0f) {
                                ...
                                mbVar.f3367j = paint2;
                                paint2.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20762h5, n6Var.getResourcesProvider()));
                            }
                            b(mbVar);
                            return true;
                        }
                    ...
                    if (h6Var.getDialogId() == j3) {
                        mbVar.f3360a = h6Var;
                        mbVar.f3370m = h6Var.f22079u0;
                        mbVar.f3361b = h6Var.f22074r;
                    ...
                    if (i11 < arrayList.size()) {
                        ...
                        if (i6Var != null) {
                            ...
                            if (storyReaction instanceof TL_stories.TL_storyReactionPublicRepost) {
                                ...
                                if (tL_storyReactionPublicRepost.story != null && DialogObject.getPeerDialogId(tL_storyReactionPublicRepost.peer_id) == j3 && tL_storyReactionPublicRepost.story.f20133id == i10) {
                                    break;
                                }
                            } else {
                                continue;
