        ...
        if (viewGroup != null) {
            ...
            while (i13 < viewGroup.getChildCount()) {
                ...
                if (childAt instanceof u) {
                    ...
                    org.telegram.ui.Cells.j2 j2Var = r2Var.f22634u0;
                    ...
                    if (n6Var.f22343x != j3) {
                        ...
                        if (n6Var.f22339n == i11 && z10) {
                            ...
                            if (alphaInternal < 1.0f) {
                                ...
                                mbVar.f3340j = paint;
                                paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20735h5, n6Var.getResourcesProvider()));
                            }
                            b(mbVar);
                            return true;
                        } else if (!z10) {
                            org.telegram.ui.Cells.m6 m6Var = n6Var.f22336c;
                            mbVar.f3333a = m6Var;
                            mbVar.f3343m = n6Var.f22344y;
                            ...
                            if (alphaInternal2 < 1.0f) {
                                ...
                                mbVar.f3340j = paint2;
                                paint2.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20735h5, n6Var.getResourcesProvider()));
                            }
                            b(mbVar);
                            return true;
                        }
                    ...
                    if (h6Var.getDialogId() == j3) {
                        mbVar.f3333a = h6Var;
                        mbVar.f3343m = h6Var.f22052u0;
                        mbVar.f3334b = h6Var.f22047r;
                    ...
                    if (i11 < arrayList.size()) {
                        ...
                        if (i6Var != null) {
                            ...
                            if (storyReaction instanceof TL_stories.TL_storyReactionPublicRepost) {
                                ...
                                if (tL_storyReactionPublicRepost.story != null && DialogObject.getPeerDialogId(tL_storyReactionPublicRepost.peer_id) == j3 && tL_storyReactionPublicRepost.story.f20106id == i10) {
                                    break;
                                }
                            } else {
                                continue;
