        ...
        if (arrayList != arrayList2 || (arrayList != null && arrayList2 != null && arrayList.size() != this.f3759r.size())) {
            ...
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                ...
                if (mediaArea != null && mediaArea.coordinates != null) {
                    ...
                    addView(waVar);
                    double d = mediaArea.coordinates.f20102w;
                }
            }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        for (int i14 = 0; i14 < getChildCount(); i14++) {
            ...
            if (childAt == this.d) {
                ...
                raVar.setTranslationX((float) ((mediaArea.coordinates.f20103x / 100.0d) * getMeasuredWidth()));
                raVar.setTranslationY((float) ((mediaArea.coordinates.f20104y / 100.0d) * getMeasuredHeight()));
                ...
                saVar.setTranslationX((float) ((mediaArea2.coordinates.f20103x / 100.0d) * getMeasuredWidth()));
                saVar.setTranslationY((float) ((mediaArea2.coordinates.f20104y / 100.0d) * getMeasuredHeight()));
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        for (int i12 = 0; i12 < getChildCount(); i12++) {
            ...
            if (childAt == frameLayout) {
                ...
                raVar.measure(View.MeasureSpec.makeMeasureSpec((int) Math.ceil((raVar.f3666b.coordinates.f20102w / 100.0d) * size), 1073741824), View.MeasureSpec.makeMeasureSpec((int) Math.ceil((raVar.f3666b.coordinates.h / 100.0d) * size2), 1073741824));
            } else if (childAt instanceof sa) {
                sa saVar = (sa) getChildAt(i12);
                saVar.measure(View.MeasureSpec.makeMeasureSpec((int) Math.ceil((saVar.f3710a.coordinates.f20102w / 100.0d) * size), 1073741824), View.MeasureSpec.makeMeasureSpec((int) Math.ceil((saVar.f3710a.coordinates.h / 100.0d) * size2), 1073741824));
            }
        }
