...
public final class a extends i81 {
    ...
    public final void w(boolean z10) {
        switch (this.T) {
            case 0:
                ...
                return;
            default:
                ((rr0) this.U).d.J0(((tr0) this.V).f32030n.getAnimatingIndicatorProgress());
                return;
        }
    }
    ...
    public void y(int i10, boolean z10) {
        switch (this.T) {
            case 1:
                int i11 = ((tr0) this.V).f32030n.f24591b0.get(i10, -1);
                yu0 yu0Var = ((rr0) this.U).d;
                if (i11 <= 0) {
                    yu0.t(yu0Var, 8, z10);
                    return;
                } else {
                    yu0.t(yu0Var, yu0Var.i1(i11).f30066a, z10);
                    return;
                }
            default:
                super.y(i10, z10);
    ...
    public final void z(int i10) {
        switch (this.T) {
            case 0:
                ...
                return;
            default:
                ((tr0) this.V).f32030n.f24591b0.get(i10, -1);
