    ...
    public final void run(Object obj) {
        ...
        switch (this.f3393a) {
            ...
            case 8:
                ...
                return;
            case 9:
                ((di.x3) this.f3394b).f8378s.animate().translationY(((-((Integer) obj).intValue()) / 2.0f) + AndroidUtilities.dp(80.0f)).setDuration(250L).setInterpolator(org.telegram.ui.ActionBar.p1.f21275w).start();
                return;
            case 10:
