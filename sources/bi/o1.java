    ...
    public final void run(Object obj) {
        ...
        switch (this.f3420a) {
            ...
            case 8:
                ...
                return;
            case 9:
                ((di.x3) this.f3421b).f8406s.animate().translationY(((-((Integer) obj).intValue()) / 2.0f) + AndroidUtilities.dp(80.0f)).setDuration(250L).setInterpolator(org.telegram.ui.ActionBar.p1.f21303w).start();
                return;
            case 10:
