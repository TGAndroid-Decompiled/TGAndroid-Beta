...
public final class o1 implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        switch (this.f3393a) {
            case 0:
                t1 t1Var = (t1) this.f3394b;
                if (((Boolean) obj).booleanValue() && !t1Var.f3723w) {
                    t1Var.f3720n = true;
                    t1Var.I = true;
                    t1Var.u(false);
                    t1.W = t1Var;
                    ...
                    t1Var.c();
                    t1Var.k();
                    NotificationCenter.getInstance(t1Var.f3718e).lambda$postNotificationNameOnUIThread$1(NotificationCenter.liveStoryUpdated, Long.valueOf(t1Var.f3719f.f19886id));
                    return;
                }
                return;
            case 1:
                o5 o5Var = (o5) this.f3394b;
                ...
                return;
            case 2:
                pb pbVar = (pb) this.f3394b;
                Boolean bool = (Boolean) obj;
                pbVar.f3557k1 = false;
                pbVar.P();
                return;
            case 3:
                u8 u8Var = (u8) this.f3394b;
                l8 l8Var = (l8) obj;
                HashMap hashMap = u8Var.H;
                int i12 = l8Var.f3272e;
                int i13 = l8Var.f3273f;
                long j3 = l8Var.d;
                if (i12 == 0 && i13 > 0) {
            ...
            case 4:
                ...
                return;
            case 5:
                ((di.m) this.f3394b).x(((Integer) obj).intValue());
                return;
            case 6:
                di.e0 e0Var = (di.e0) this.f3394b;
                e0Var.f7133j0.f7036n.P = ((Float) obj).floatValue();
                di.d0 d0Var = e0Var.f7133j0;
                di.c0 c0Var = d0Var.d;
                if (c0Var != null) {
                    c0Var.setVolume(d0Var.f7036n.P);
                    return;
                }
                return;
            case 7:
                di.r0 r0Var = (di.r0) this.f3394b;
                VideoEditedInfo videoEditedInfo = (VideoEditedInfo) obj;
                MessageObject messageObject = r0Var.f8052c;
                if (messageObject != null) {
                    messageObject.videoEditedInfo = videoEditedInfo;
                    MediaController.getInstance().scheduleVideoConvert(r0Var.f8052c);
                    return;
                }
                return;
            case 8:
                di.y2 y2Var = (di.y2) this.f3394b;
                y2Var.h(-1.0f);
                AndroidUtilities.runOnUIThread(new s8(25, y2Var, (Runnable) obj), 80L);
                return;
            case 9:
                ((di.x3) this.f3394b).f8378s.animate().translationY(((-((Integer) obj).intValue()) / 2.0f) + AndroidUtilities.dp(80.0f)).setDuration(250L).setInterpolator(org.telegram.ui.ActionBar.p1.f21276w).start();
                return;
            case 10:
                di.rb rbVar = (di.rb) ((di.q6) this.f3394b);
                pc pcVar = rbVar.A2;
                pcVar.X0.q((MessageObject) obj);
                di.o8 o8Var = pcVar.K1;
                if (o8Var != null && pcVar.O1 != 1) {
                    boolean isEmpty = TextUtils.isEmpty(o8Var.f7789y);
                    boolean z14 = !isEmpty;
                    ((fg0) pcVar.f7873j1.f8069c).a(!pcVar.X0.k(), false);
                    pcVar.f7873j1.setVisibility(0);
                    ViewPropertyAnimator animate = pcVar.f7873j1.animate();
                    if (!isEmpty) {
                        f7 = 1.0f;
                    } else {
                        f7 = 0.0f;
                ...
                if (pcVar.A0.j()) {
                    ...
                    while (true) {
                        if (i11 < size) {
                            ...
                            i11++;
                            di.o8 o8Var2 = ((di.d0) obj2).f7036n;
                            if (o8Var2 != null && o8Var2.K) {
                                if (!TextUtils.isEmpty(pcVar.K1.f7789y)) {
                                    i10 = 2;
                                }
                            }
                        }
            ...
            case 11:
                ...
                u61 u61Var = ((di.d7) this.f3394b).f7085n;
                if (u61Var != null) {
                ...
                return;
            case 12:
                di.x8 x8Var = (di.x8) this.f3394b;
                rg.p0 p0Var = (rg.p0) obj;
                if (p0Var == null) {
                    x8Var.U();
                    return;
                }
                x8Var.f8408o0 = p0Var.f45411e;
                x8Var.f8407n0 = p0Var.f45412f;
                return;
            case 13:
                ((di.x9) this.f3394b).f8411n.W.H = ((Integer) obj).intValue();
                return;
            case 14:
                ((di.jb) this.f3394b).g((Utilities.Callback) obj);
                return;
            case 15:
                fi.u uVar = (fi.u) this.f3394b;
                ArrayList arrayList3 = uVar.f9986b;
                arrayList3.clear();
            ...
            case 16:
                ...
                return;
            case 17:
                ((hg.m) this.f3394b).L((TLRPC.User) obj);
                return;
            case 18:
                TLRPC.User user2 = (TLRPC.User) obj;
                rn0 rn0Var = (rn0) ((hg.i0) this.f3394b);
                ey eyVar = rn0Var.K0;
                if (user2 != null) {
                    uy uyVar = eyVar.J0;
                    if (uyVar != null) {
                    ...
                    rn0Var.R(user2.f20016id, user2);
                    return;
                }
                return;
            case 19:
                ig.m mVar = (ig.m) this.f3394b;
            ...
            case 20:
                ...
                AndroidUtilities.forEachViews((RecyclerView) ((ig.i0) this.f3394b).f12093s, (e2.h) new f(3));
                return;
            case 21:
                ig.u0 u0Var = (ig.u0) this.f3394b;
                ...
                return;
            case 22:
                ig.w0 w0Var = (ig.w0) this.f3394b;
                w0Var.f12265w = w0Var.f12260e[((Integer) obj).intValue()];
                w0Var.V(true);
                return;
            case 23:
                ig.y1 y1Var = (ig.y1) this.f3394b;
                y1Var.getClass();
                ...
                return;
            case 24:
                AndroidUtilities.hideKeyboard((ig.r1) this.f3394b);
                AndroidUtilities.runOnUIThread((Runnable) obj, 80L);
                return;
            case 25:
                ji.m3 m3Var = (ji.m3) this.f3394b;
                TL_iv.RichMessage richMessage = (TL_iv.RichMessage) obj;
                int i14 = m3Var.f14060b;
                int i15 = m3Var.f14059a;
                ji.v3 v3Var = m3Var.f14062e;
                if (richMessage != null) {
                    ArrayList arrayList6 = v3Var.f14256l3;
                    ArrayList arrayList7 = v3Var.f14256l3;
                    if (i15 < arrayList6.size() && i14 < arrayList7.size()) {
                        ji.g2 g2Var = v3Var.J3;
                        if (g2Var != null) {
                            g2Var.d();
                        }
                        ji.i3 i3Var = v3Var.f14259n3;
                        if (i3Var != null) {
                            i3Var.f(false);
                        }
                        ...
                        if (!ji.v3.z3(aVar2.f13732b)) {
                            editable = "";
                        } else {
                            editable = v3Var.L4(aVar2);
                        }
                        if (ji.v3.z3(aVar3.f13732b)) {
                            charSequence = v3Var.L4(aVar3);
                        }
                        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(editable.subSequence(0, Math.max(0, Math.min(m3Var.f14061c, editable.length()))));
                        ...
                        if (arrayList8.isEmpty()) {
                            ...
                            arrayList8.add(new ji.a(pageblockparagraph, aVar2.f13733c, aVar2.d));
                        } else {
                            if (spannableStringBuilder.length() > 0) {
                                ji.a aVar4 = (ji.a) arrayList8.get(0);
                                if (ji.v3.z3(aVar4.f13732b)) {
                                    SpannableStringBuilder spannableStringBuilder4 = new SpannableStringBuilder(spannableStringBuilder);
                                    spannableStringBuilder4.append((CharSequence) ji.g6.A(aVar4.f13732b));
                                    ji.g6.e(aVar4.f13732b, spannableStringBuilder4);
                                } else {
                                    TL_iv.pageBlockParagraph pageblockparagraph2 = new TL_iv.pageBlockParagraph();
                                    ji.g6.e(pageblockparagraph2, spannableStringBuilder);
                                    arrayList8.add(0, new ji.a(pageblockparagraph2, aVar2.f13733c, aVar2.d));
                                }
                            }
                            if (spannableStringBuilder2.length() > 0) {
                                ji.a aVar5 = (ji.a) i2.g.h(1, arrayList8);
                                if (ji.v3.z3(aVar5.f13732b)) {
                                    SpannableStringBuilder spannableStringBuilder5 = new SpannableStringBuilder(ji.g6.A(aVar5.f13732b));
                                    spannableStringBuilder5.append((CharSequence) spannableStringBuilder2);
                                    ji.g6.e(aVar5.f13732b, spannableStringBuilder5);
                                } else {
                                    ...
                                    arrayList8.add(new ji.a(pageblockparagraph3, aVar3.f13733c, aVar3.d));
                                }
                            }
                        }
                        TL_iv.RichMessage richMessage2 = v3Var.f14254k3;
                        if (richMessage2 == null) {
                            v3Var.f14254k3 = richMessage;
                        } else {
                            ...
                            if (arrayList10 != null) {
                                v3Var.f14254k3.documents.addAll(arrayList10);
                            }
                        }
                ...
                return;
            case 26:
                ((ji.m) this.f3394b).f14048a.f14133r.T1((TL_iv.RichMessage) obj);
                return;
            case 27:
                ((ji.c2) this.f3394b).P.T1((TL_iv.RichMessage) obj);
                return;
            case 28:
                ji.v3 v3Var2 = (ji.v3) this.f3394b;
                ...
                return;
            default:
                AndroidUtilities.hideKeyboard((zt) this.f3394b);
                AndroidUtilities.runOnUIThread((Runnable) obj, 80L);
                return;
        }
    }
