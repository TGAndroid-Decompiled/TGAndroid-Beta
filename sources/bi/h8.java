...
public final class h8 implements Runnable {
    ...
    private final void a() {
        ...
        ConnectionsManager.getInstance(s5Var.f52598a).sendRequest(tL_payments_canPurchaseStore, new lh1(oVar, hVar, f0Var, activity, tL_inputStorePaymentStarsGiveaway, list, 3));
    }
