...
public final class db extends ov0 {
    ...
    public float f2889y0;
    public final float[] f2890z0;

    public db(pb pbVar, Context context, org.telegram.ui.ActionBar.n2 n2Var) {
        super(context, null);
        this.I0 = pbVar;
        this.H0 = n2Var;
        this.f2890z0 = new float[8];
        this.A0 = new Path();
        this.B0 = new RectF();
        this.C0 = new RectF();
        this.D0 = new RectF();
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        float f7 = 0.0f;
        if (pbVar.f3566p1 && currentPeerView != null && (fk0Var = currentPeerView.f3456r3) != null) {
            float f10 = 0.0f;
            for (View view = currentPeerView; view != null && (view.getParent() instanceof View); view = (View) view.getParent()) {
                f7 += view.getX();
                f10 += view.getY();
            }
            if (currentPeerView.f3456r3.getReactionsWindow() != null && currentPeerView.f3456r3.getReactionsWindow().f687c != null) {
                motionEvent.offsetLocation(-f7, (-f10) - currentPeerView.f3456r3.getReactionsWindow().f687c.getTranslationY());
                currentPeerView.f3456r3.getReactionsWindow().f687c.dispatchTouchEvent(motionEvent);
                return true;
            }
        ...
        if (motionEvent.getAction() != 1 && motionEvent.getAction() != 3) {
            ...
            pbVar.f3554j0 = false;
            AndroidUtilities.cancelRunOnUIThread(pbVar.f3536b1);
            float f11 = pbVar.X;
            if (f11 != 0.0f) {
                ...
                pbVar.G.setInterpolator(pr.f29466f);
                pbVar.G.start();
            }
            if (pbVar.V >= 0.3f) {
                pbVar.q(true);
        ...
        if (motionEvent.getAction() == 0) {
            pbVar.f3532a0 = false;
            if (currentPeerView != null) {
                g5 g5Var = currentPeerView.f3477y0;
                ...
                if (f4Var != null && f4Var.V && uaVar != null) {
                    if (!f4Var.f7217r0.contains(motionEvent.getX() - (currentPeerView.F0.getX() + (l4Var.getX() + currentPeerView.getX())), motionEvent.getY() - (currentPeerView.F0.getY() + (l4Var.getY() + currentPeerView.getY()))) && !currentPeerView.H0(motionEvent, uaVar)) {
                        currentPeerView.F0.e(true);
                    }
                }
                di.f4 f4Var2 = currentPeerView.G0;
                if (f4Var2 != null && f4Var2.V && g5Var != null && !f4Var2.f7217r0.contains(motionEvent.getX() - (currentPeerView.G0.getX() + (l4Var.getX() + currentPeerView.getX())), motionEvent.getY() - (currentPeerView.G0.getY() + (l4Var.getY() + currentPeerView.getY()))) && !currentPeerView.H0(motionEvent, g5Var)) {
                    currentPeerView.G0.e(true);
                }
            }
            pbVar.f3561n0.onTouchEvent(MotionEvent.obtain(0L, 0L, 3, 0.0f, 0.0f, 0));
        }
        if (!pbVar.f3584x && !pbVar.H0 && !pbVar.I0) {
            z11 = true;
        } else {
            z11 = false;
        }
        ...
        if (f12 == 0.0f && !pbVar.f3554j0 && pbVar.f3561n0.F0 == 1 && motionEvent.getAction() == 2 && z11 && (((((Float) sparseArray.get(motionEvent.getPointerId(0), Float.valueOf(0.0f))).floatValue() - motionEvent.getX(0)) != 0.0f && (((i11 = (fbVar = pbVar.f3561n0).I0) == 0 && fbVar.K0 == 0.0f && floatValue < 0.0f) || (i11 == fbVar.getAdapter().b() - 1 && fbVar.K0 == 0.0f && i10 > 0))) || pbVar.X != 0.0f)) {
            float f13 = pbVar.X;
            if (f13 == 0.0f) {
                pbVar.Y = -floatValue;
            }
        ...
        if (currentPeerView != null && pbVar.f3543e0 == 0.0f && !pbVar.f3554j0 && !pbVar.L0 && !pbVar.I0 && pbVar.f3561n0.F0 != 1) {
            AndroidUtilities.getViewPositionInParent(currentPeerView.f3409c1, this, fArr);
            motionEvent.offsetLocation(-fArr[0], -fArr[1]);
            o5 currentPeerView2 = pbVar.f3561n0.getCurrentPeerView();
            currentPeerView2.X2.a(motionEvent, currentPeerView2.f3409c1, null, null, 0);
            motionEvent.offsetLocation(fArr[0], fArr[1]);
        }
        if (motionEvent.getAction() != 1 && motionEvent.getAction() != 3) {
        ...
        if (!z12) {
            ...
            if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
                if (pbVar.f3543e0 != 0.0f && !pbVar.f3549g1 && pbVar.f3565p0 < AndroidUtilities.dp(20.0f)) {
                ...
                o5 t10 = pbVar.t();
                if (t10 != null) {
                    t10.K0.f2942w0 = false;
                }
            }
            if (z10 && !pbVar.f3532a0) {
                pbVar.m();
            }
            if (!dispatchTouchEvent && (!pb.f3528x1 || !pbVar.f3567q0)) {
                return false;
            }
        }
        return true;
    ...
    public final void onMeasure(int i10, int i11) {
        pb pbVar = this.I0;
        ((FrameLayout.LayoutParams) pbVar.f3541d1.getLayoutParams()).topMargin = AndroidUtilities.statusBarHeight - AndroidUtilities.dp(2.0f);
        pbVar.f3541d1.getLayoutParams().height = AndroidUtilities.dp(2.0f);
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!pbVar.f3554j0 && !pbVar.f3584x && pbVar.Z == 0.0f && ((pbVar.f3543e0 == 0.0f || (!pbVar.f3546f0 && !pbVar.f3548g0)) && !pbVar.f3555j1)) {
            return false;
        }
        pbVar.f3552i0.onTouchEvent(motionEvent);
        return true;
    }
