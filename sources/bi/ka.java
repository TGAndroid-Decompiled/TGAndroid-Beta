...
public final class ka extends TLObject {
    public final TL_stories.StoryItem f3245a;
    public int f3246b;
    ...
    public ka(TL_stories.StoryItem storyItem) {
        ...
        int i13 = i12 + i11;
        this.f3246b = i13;
        this.f3246b = i13 + (storyItem.translatedLng != null ? 8 : 0);
    }
    ...
    public final void readParams(InputSerializedData inputSerializedData, boolean z10) {
        ...
        this.f3246b = readInt32;
        if ((readInt32 & 1) == 0) {
            z11 = false;
        }
        TL_stories.StoryItem storyItem = this.f3245a;
    ...
    public final void serializeToStream(OutputSerializedData outputSerializedData) {
        ...
        outputSerializedData.writeInt32(this.f3246b);
        int i10 = this.f3246b & 2;
        TL_stories.StoryItem storyItem = this.f3245a;
        if (i10 != 0) {
