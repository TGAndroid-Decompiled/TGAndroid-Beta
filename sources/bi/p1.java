...
public final class p1 implements RequestDelegateTimestamp, MessagesStorage.StringCallback, m4.e1, ImageReceiver.ImageReceiverDelegate, org.telegram.ui.Components.d5, dd0, MessagesStorage.BooleanCallback, g2.g, org.telegram.ui.ActionBar.a2, a70, s5.e {
    ...
    public void J(int i10, int i11, boolean z10) {
        ...
        long j3 = this.f3494b;
        if (niVar != chatAttachAlertPhotoLayout && niVar != viVar.f31312q0) {
    ...
    public void g(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        switch (this.f3493a) {
            case 8:
                rn0 rn0Var = ((uy) this.f3495c).C0.f32951b0;
                ...
                return;
            default:
                ((gy) this.f3495c).f36811a.getMediaDataController().removePeer(this.f3494b);
                return;
        }
    }
    ...
    public void j(int i10, ArrayList arrayList) {
        ...
        org.telegram.ui.ActionBar.n2 n2Var = of1Var.f39238b;
