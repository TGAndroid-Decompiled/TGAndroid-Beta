...
public final class p1 implements RequestDelegateTimestamp, MessagesStorage.StringCallback, m4.e1, ImageReceiver.ImageReceiverDelegate, org.telegram.ui.Components.d5, dd0, MessagesStorage.BooleanCallback, g2.g, org.telegram.ui.ActionBar.a2, a70, s5.e {
    ...
    public Object apply(Object obj) {
        l5.i iVar = (l5.i) this.f3495c;
        SQLiteDatabase sQLiteDatabase = (SQLiteDatabase) obj;
        ContentValues contentValues = new ContentValues();
        contentValues.put("next_request_ms", Long.valueOf(this.f3494b));
        ...
        if (sQLiteDatabase.update("transport_contexts", contentValues, "backend_name = ? and priority = ?", new String[]{str, String.valueOf(v5.a.a(dVar))}) < 1) {
            contentValues.put("backend_name", iVar.f15283a);
    ...
    public void b(TLRPC.MessageMedia messageMedia, int i10, boolean z10, int i11, long j3) {
        ...
        switch (i12) {
            case 5:
                ...
                SendMessagesHelper.getInstance(((LocationController.SharingLocationInfo) obj).messageObject.currentAccount).sendMessage(SendMessagesHelper.SendMessageParams.of(messageMedia, this.f3494b, (MessageObject) null, (MessageObject) null, (TLRPC.ReplyMarkup) null, (HashMap<String, String>) null, true, 0, 0));
                return;
            default:
                Pattern pattern = LaunchActivity.B1;
                SendMessagesHelper.getInstance(((int[]) obj)[0]).sendMessage(SendMessagesHelper.SendMessageParams.of(messageMedia, this.f3494b, (MessageObject) null, (MessageObject) null, (TLRPC.ReplyMarkup) null, (HashMap<String, String>) null, true, 0, 0));
                return;
        }
    }
    ...
    public g2.h createDataSource() {
        return new b71(((g71) this.f3495c).h.createDataSource(), this.f3494b);
    }

    @Override
    public void didSetImage(ImageReceiver imageReceiver, boolean z10, boolean z11, boolean z12) {
        org.telegram.ui.m4 m4Var = (org.telegram.ui.m4) this.f3495c;
        ...
        if (z10 && bitmapSafe != null) {
            ...
            m4Var.onComplete(new Pair(Long.valueOf(this.f3494b), bitmap));
        }
    }
    ...
    public void g(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        switch (this.f3493a) {
            case 8:
                rn0 rn0Var = ((uy) this.f3495c).C0.f32950b0;
                a0.i iVar = rn0Var.f11100x0;
                long j3 = this.f3494b;
                hg.h0 h0Var = (hg.h0) iVar.f(j3);
                if (h0Var != null) {
                    rn0Var.f11100x0.l(j3);
                    rn0Var.f11094t0.remove(h0Var);
                    rn0Var.f11096v0.remove(h0Var);
                    rn0Var.f11095u0.remove(h0Var);
                    rn0Var.l();
                    MessagesStorage.getInstance(rn0Var.f11093s0).getStorageQueue().postRunnable(new hg.q(rn0Var, j3, 0));
                    return;
                }
                return;
            default:
                ((gy) this.f3495c).f36810a.getMediaDataController().removePeer(this.f3494b);
                return;
        }
    }
    ...
    public Object h(m4.a0 a0Var, m4.r rVar, int i10) {
        return a0Var.q(rVar, e9.i0.z((b2.k0) this.f3495c), 0, this.f3494b);
    }

    @Override
    public void j(int i10, ArrayList arrayList) {
        of1 of1Var = (of1) this.f3495c;
        org.telegram.ui.ActionBar.n2 n2Var = of1Var.f39237b;
    ...
    public void run(TLObject tLObject, TLRPC.TL_error tL_error, long j3) {
        ...
        if (nativeInstance2 != null) {
            nativeInstance2.onRequestTimeComplete(this.f3494b, r0);
        }
    }
    ...
    public void run(String str) {
        di.ba baVar = (di.ba) this.f3495c;
        baVar.W.i1().r(this.f3494b, str, new di.p9(baVar, 2));
    }

    @Override
    public void run(boolean z10) {
        co coVar = ((w21) this.f3495c).h;
        if (com.google.android.gms.internal.vision.e2.u(coVar)) {
            coVar.qa(this.f3494b, false);
        }
    }
