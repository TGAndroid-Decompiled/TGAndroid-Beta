    ...
    public final void run() {
        switch (this.f3184a) {
            ...
            case 2:
                ...
                return;
            case 3:
                t1 t1Var = this.f3185b;
                NotificationCenter.getInstance(t1Var.f3718e).lambda$postNotificationNameOnUIThread$1(NotificationCenter.liveStoryUpdated, Long.valueOf(t1Var.v.f19879id));
                t1Var.u(true);
                return;
            case 4:
                this.f3185b.w();
