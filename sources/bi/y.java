...
public final class y extends Drawable {
    public final int f3948a = 1;
    public final Path f3949b;
    public final Paint f3950c;
    ...
    public y() {
        ...
        this.e = paint3;
        this.f3952g = new org.telegram.ui.Components.d6(new kc0(this, 1), 320L, wr.h, 0);
    ...
    public final void draw(Canvas canvas) {
        switch (this.f3948a) {
            case 0:
                ...
                canvas.drawPath(this.f3949b, this.f3950c);
                if (z10) {
            ...
            default:
                ...
                Paint paint = this.f3950c;
                paint.setStrokeWidth(dpf2);
                float dpf22 = AndroidUtilities.dpf2(3.32f);
                Paint paint2 = this.e;
                paint2.setStrokeWidth(dpf22);
                float e = ((org.telegram.ui.Components.d6) this.f3952g).e(this.f3951f);
                ...
                canvas.drawPath(this.f3949b, this.d);
                canvas.restore();
                if (i10 > 0) {
                    if (this.f3951f) {
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        switch (this.f3948a) {
            case 0:
                this.f3950c.setColorFilter(colorFilter);
                return;
            default:
    ...
    public y(x xVar, boolean z10) {
        ...
        while (i12 < size) {
            ...
            float f16 = dpf25;
            float f17 = dpf26;
            rectF2.set(f11 + (max * f10) + f7, f15 + (max2 * f14) + f12, org.telegram.ui.Cells.r6.a(max, i15 + 1, f7, f11), org.telegram.ui.Cells.r6.a(max2, i14 + 1, f12, f15));
            float[] fArr = (float[]) this.f3952g;
            float f18 = 0.0f;
            ...
            fArr[7] = f18;
            fArr[6] = f18;
            this.f3949b.addRoundRect(rectF2, fArr, Path.Direction.CW);
            xVar2 = xVar;
