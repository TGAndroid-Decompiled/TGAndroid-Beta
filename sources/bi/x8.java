...
public final class x8 extends View {
    ...
    public final xi0 f4019c;
    public final Paint d;
    public final TextPaint f4020e;
    public final TextPaint f4021f;
    public final RectF h;
    public float f4022n;
    public final Rect f4023r;

    public x8(Context context, int i10, String str, String str2) {
        super(context);
        this.f4023r = new Rect();
        this.f4017a = str;
        this.f4018b = str2;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int dp2 = (int) ((AndroidUtilities.dp(8.0f) * this.f4022n) + AndroidUtilities.dp(36.0f));
        int i10 = dp2 / 2;
        int i11 = dp - i10;
        int measuredHeight = (getMeasuredHeight() / 2) - i10;
        xi0 xi0Var = this.f4019c;
        xi0Var.setBounds(i11, measuredHeight, i11 + dp2, dp2 + measuredHeight);
        xi0Var.draw(canvas);
        if (this.f4022n > 0.0f) {
            float dpf2 = (1.0f - this.f4022n) * AndroidUtilities.dpf2(4.0f);
            float f7 = dpf2 * 2.0f;
            ...
            int i12 = (int) (this.f4022n * 30.0f);
            Paint paint = this.d;
            paint.setAlpha(i12);
            canvas.drawRoundRect(rectF, AndroidUtilities.dpf2(12.0f), AndroidUtilities.dpf2(12.0f), paint);
            canvas.save();
            float f10 = this.f4022n;
            canvas.scale((f10 * 0.05f) + 1.0f, (f10 * 0.05f) + 1.0f, getMeasuredWidth() / 2.0f, getMeasuredHeight() / 2.0f);
        }
        canvas.drawText(this.f4017a, AndroidUtilities.dpf2(80.0f), (getMeasuredHeight() / 2.0f) - AndroidUtilities.dpf2(4.0f), this.f4020e);
        canvas.drawText(this.f4018b, AndroidUtilities.dpf2(80.0f), AndroidUtilities.dpf2(18.0f) + (getMeasuredHeight() / 2.0f), this.f4021f);
        if (this.f4022n > 0.0f) {
            canvas.restore();
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f4019c.setBounds(i13, measuredHeight, i13 + dp2, dp2 + measuredHeight);
    }
}
