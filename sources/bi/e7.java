...
public final class e7 extends FrameLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f2941a) {
            ...
            case 7:
                ...
                float max = Math.max(dp2 + dp2, v21Var.f31093f.d() + AndroidUtilities.dp(10.0f));
                if (z10) {
                    i11 = i13;
                    f10 = dp3;
                    f7 = width2;
                ...
                if (i11 > 0) {
                    ...
                    i6Var.setColor(org.telegram.ui.ActionBar.j6.l1(g10, i6Var.f27003b.a(org.telegram.ui.ActionBar.j6.v0(v21Var.E, i6Var.f27002a), false)));
                    canvas.drawRoundRect(rectF4, dp2, dp2, i6Var);
                    v21Var.f31093f.m(rectF4);
                    org.telegram.ui.Components.p6 p6Var = v21Var.f31093f;
            ...
            case 8:
                ...
                paint3.setColor(f70Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20691d6));
                canvas.save();
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        switch (this.f2941a) {
            case 2:
                ...
                return drawChild;
            case 10:
                rg.t2 t2Var = ((rg.v2) this.d).f45557f;
                if (view == t2Var) {
                    canvas.save();
            ...
            case 12:
                ...
                if (((zh.p7) this.d).f52464e > 1) {
                    paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20691d6, (org.telegram.ui.ActionBar.f6) this.f2943c));
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f2941a) {
            case 4:
                super.onDraw(canvas);
                Paint paint = (Paint) this.f2943c;
                paint.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20908p7, false));
                canvas.save();
    ...
    public boolean verifyDrawable(Drawable drawable) {
        switch (this.f2941a) {
            case 7:
                if (((v21) this.d).f31093f != drawable && !super.verifyDrawable(drawable)) {
                    return false;
                }
                return true;
            default:
    ...
    public e7(v21 v21Var, Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        v21Var.f31093f.setCallback(this);
    }
