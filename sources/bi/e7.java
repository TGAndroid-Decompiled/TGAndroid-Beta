...
public final class e7 implements sy {
    ...
    public final boolean k() {
        pg.b editText = ((pg.v2) this.f2630a.J0).getEditText();
    ...
    public final void x(long j3, TLRPC.Document document, String str, boolean z10) {
        ...
        if (editText != null) {
            ...
            try {
                ...
                if (document != null) {
                    y5Var = new org.telegram.ui.Components.y5(document.f17201id, 1.0f, editText.getPaint().getFontMetricsInt());
