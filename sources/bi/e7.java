...
public final class e7 extends FrameLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f2914a) {
            case 1:
                ...
                return;
            case 5:
                Paint paint2 = (Paint) this.f2916c;
            ...
            case 7:
                ...
                float max = Math.max(dp2 + dp2, v21Var.f31065f.d() + AndroidUtilities.dp(10.0f));
                if (z10) {
                    i11 = i13;
                    f10 = dp3;
                    f7 = width2;
                ...
                if (z10) {
                    ...
                    float f12 = dp * g10;
                    canvas.drawRoundRect(rectF3, f12, f12, (Paint) this.f2915b);
                    canvas.restore();
                }
                if (i11 > 0) {
                    canvas.save();
                    ...
                    org.telegram.ui.Components.i6 i6Var = (org.telegram.ui.Components.i6) this.f2916c;
                    i6Var.setColor(org.telegram.ui.ActionBar.j6.l1(g10, i6Var.f26975b.a(org.telegram.ui.ActionBar.j6.v0(v21Var.E, i6Var.f26974a), false)));
                    canvas.drawRoundRect(rectF4, dp2, dp2, i6Var);
                    v21Var.f31065f.m(rectF4);
                    org.telegram.ui.Components.p6 p6Var = v21Var.f31065f;
                ...
                return;
            case 8:
                Paint paint3 = (Paint) this.f2916c;
                f70 f70Var = (f70) this.d;
                paint3.setColor(f70Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20663d6));
                canvas.save();
                canvas.translate(0.0f, -getTop());
                RectF rectF5 = (RectF) this.f2915b;
    ...
    public void draw(Canvas canvas) {
        switch (this.f2914a) {
            case 9:
                canvas.save();
                canvas.clipPath((Path) this.f2915b);
                super.draw(canvas);
                canvas.restore();
                return;
            default:
    ...
    public boolean drawChild(Canvas canvas, View view, long j3) {
        switch (this.f2914a) {
            case 2:
                yf.z zVar = (yf.z) this.f2915b;
                yf.z zVar2 = (yf.z) this.f2916c;
                ...
                return drawChild;
            case 10:
                rg.t2 t2Var = ((rg.v2) this.d).f45528f;
                if (view == t2Var) {
                    canvas.save();
                    canvas.translate(((org.telegram.ui.Components.e6) this.f2915b).d(view.getX(), false), ((org.telegram.ui.Components.e6) this.f2916c).d(view.getY(), false));
                    t2Var.a(canvas);
                    canvas.restore();
                    return true;
                }
            ...
            case 12:
                Paint paint = (Paint) this.f2915b;
                if (((zh.p7) this.d).f52432e > 1) {
                    paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20663d6, (org.telegram.ui.ActionBar.f6) this.f2916c));
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f2914a) {
            case 4:
                super.onDraw(canvas);
                Paint paint = (Paint) this.f2916c;
                paint.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20880p7, false));
                canvas.save();
    ...
    public boolean verifyDrawable(Drawable drawable) {
        switch (this.f2914a) {
            case 7:
                if (((v21) this.d).f31065f != drawable && !super.verifyDrawable(drawable)) {
                    return false;
                }
                return true;
            default:
    ...
    public e7(rg.v2 v2Var, Context context, int i10) {
        ...
        switch (i10) {
            case 10:
                ...
                super(context);
                pr prVar = pr.h;
                this.f2915b = new org.telegram.ui.Components.e6(this, 0L, 350L, prVar);
                this.f2916c = new org.telegram.ui.Components.e6(this, 0L, 350L, prVar);
                return;
            default:
                this.d = v2Var;
                this.f2915b = new Path();
                this.f2916c = new RectF();
                return;
        }
    }
    ...
    public e7(gi.p pVar, Context context) {
        ...
        this.f2914a = 2;
        this.d = pVar;
        this.f2915b = new yf.z(2);
        this.f2916c = new yf.z(8);
    }
    ...
    public e7(v21 v21Var, Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f2915b = paint;
        this.f2916c = new org.telegram.ui.Components.i6(this, f6Var);
        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.CLEAR));
        v21Var.f31065f.setCallback(this);
    }
