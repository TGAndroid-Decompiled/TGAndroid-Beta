...
public final class m5 {
    ...
    public final String e() {
        ...
        if (o5Var.B1 > 0) {
            ...
            return String.format(Locale.US, "https://t.me/%1$s/s/%2$s", UserObject.getPublicUsername(user), Integer.valueOf(o5Var.O1.f3310a.f20106id));
        }
        ...
        return String.format(Locale.US, "https://t.me/%1$s/s/%2$s", ChatObject.getPublicUsername(chat), Integer.valueOf(o5Var.O1.f3310a.f20106id));
    }
