...
public class l8 {
    ...
    public final void A(List list) {
        ...
        if (list != null) {
            ...
            for (int i10 = 0; i10 < list.size(); i10++) {
                ...
                if (storyItem != null) {
                    Integer valueOf = Integer.valueOf(storyItem.f20106id);
                    AbstractSet abstractSet = this.f3278l;
                    boolean contains = abstractSet.contains(valueOf);
                    AbstractSet abstractSet2 = this.f3277k;
                    if (contains || abstractSet2.contains(Integer.valueOf(storyItem.f20106id))) {
                        abstractSet.remove(Integer.valueOf(storyItem.f20106id));
                        abstractSet2.remove(Integer.valueOf(storyItem.f20106id));
                        int i11 = this.f3285s;
                        if (i11 != -1) {
                            this.f3285s = i11 - 1;
                        }
    ...
    public void C(ArrayList arrayList, boolean z10) {
        ...
        if (z10) {
            ...
            tL_togglePinnedToTop.f20119id.addAll(arrayList3);
    ...
    public final void D(List list, boolean z10) {
        ...
        if (list != null) {
            ...
            while (true) {
                ...
                if (storyItem2 != null) {
                    Integer valueOf = Integer.valueOf(storyItem2.f20106id);
                    AbstractSet abstractSet = this.f3278l;
                    boolean contains = abstractSet.contains(valueOf);
                    AbstractSet abstractSet2 = this.f3277k;
                    if (!contains && !abstractSet2.contains(Integer.valueOf(storyItem2.f20106id))) {
                        z11 = false;
                    } else {
                        z11 = true;
                    }
                    ...
                    if (z11 != z12) {
                        if (!z12) {
                            i2.g.o(storyItem2.f20106id, new StringBuilder("StoriesList remove story "));
                            u(storyItem2.f20106id, true);
                            int i13 = this.f3285s;
                            if (i13 != -1) {
                                this.f3285s = i13 - 1;
                            }
                        } else if (this.f3284r) {
                            FileLog.d("StoriesList put story " + storyItem2.f20106id);
                            t(y(storyItem2), false);
                            arrayList.add(Integer.valueOf(storyItem2.f20106id));
                            int i14 = this.f3285s;
                            if (i14 != -1) {
                                this.f3285s = i14 + 1;
                            }
                        } else if (!this.f3287u) {
                            FileLog.d("StoriesList cannot put story " + storyItem2.f20106id + " -> reload");
                            if (this.A != -1) {
                    ...
                    } else if (z11 && z12 && ((messageObject = (MessageObject) hashMap.get(Integer.valueOf(storyItem2.f20106id))) == null || z10 || (storyItem = messageObject.storyItem) == null || (storyItem != storyItem2 && (storyItem.f20106id != storyItem2.f20106id || storyItem.media != storyItem2.media || !TextUtils.equals(storyItem.caption, storyItem2.caption))))) {
                        i2.g.o(storyItem2.f20106id, new StringBuilder("StoriesList update story "));
                        hashMap.put(Integer.valueOf(storyItem2.f20106id), y(storyItem2));
                    }
                    z13 = true;
                }
                i12++;
    ...
    public ArrayList h() {
        ...
        if (i11 == 0 && this.f3273f > 0) {
            ...
            while (i10 < size) {
                ...
                i10++;
                arrayList3.add(Integer.valueOf(((MessageObject) obj).storyItem.f20106id));
            }
    ...
    public boolean q(int i10, List list, boolean z10) {
        ...
        if (i12 == 0 && (i11 = this.f3273f) > 0) {
            ...
            tL_stories_getStoriesByID.f20113id.addAll(list);
            n10 = -1;
    ...
    public boolean r(int i10) {
        ...
        tL_stories_incrementStoryViews.f20117id.add(Integer.valueOf(i10));
    ...
    public final MessageObject y(TL_stories.StoryItem storyItem) {
        ...
        storyItem.messageId = storyItem.f20106id;
