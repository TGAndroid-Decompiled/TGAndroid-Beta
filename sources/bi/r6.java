    ...
    public final void c() {
        if (!this.f3670e && this.f3677m && !this.f3674j) {
            ...
            if (z10) {
                ...
                tL_getStoryReactionsList.f20134id = storyItem.f20133id;
                ...
                this.f3670e = true;
                FileLog.d("SelfStoryViewsPage reactions load next " + storyItem.f20133id + " " + this.f3676l + " offset=" + tL_getStoryReactionsList.offset);
                                        ...
                                        switch (r5) {
                                            case 0:
                                                ...
                                                if (iArr[0] != r6Var2.f3679o) {
                                                    FileLog.d("SelfStoryViewsPage " + storyItem2.f20133id + " localId != reqId");
                                                    return;
                                                }
                                                r6Var2.f3670e = false;
                                                r6Var2.f3679o = -1;
                                                ...
                                                FileLog.d("SelfStoryViewsPage " + storyItem2.f20133id + " response  totalItems " + arrayList3.size() + " has next " + r6Var2.f3677m);
                                            ...
                                            default:
                                                ...
                                                if (iArr[0] != r6Var3.f3679o) {
                                                    FileLog.d("SelfStoryViewsPage reactions " + storyItem3.f20133id + " localId != reqId");
                                                    return;
                                                }
                                                r6Var3.f3670e = false;
                                                r6Var3.f3679o = -1;
                                                ...
                                                FileLog.d("SelfStoryViewsPage reactions " + storyItem3.f20133id + " response  totalItems " + arrayList5.size() + " has next " + r6Var3.f3677m);
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r5) {
                                            case 0:
                                                ...
                                                FileLog.d("SelfStoryViewsPage " + storyItem2.f20133id + " response  totalItems " + arrayList3.size() + " has next " + r6Var22.f3677m);
                                                for (int i19 = 0; i19 < arrayList.size(); i19++) {
            ...
            tL_stories_getStoryViewsList.f20142id = storyItem.f20133id;
            tL_stories_getStoryViewsList.peer = MessagesController.getInstance(i11).getInputPeer(j3);
            if (this.f3681q) {
                tL_stories_getStoryViewsList.f20143q = "";
                ...
                tL_stories_getStoryViewsList.f20143q = str2;
                if (!TextUtils.isEmpty(str2)) {
            ...
            this.f3670e = true;
            FileLog.d("SelfStoryViewsPage load next " + storyItem.f20133id + " " + this.f3676l + " offset=" + tL_stories_getStoryViewsList.offset + " q" + tL_stories_getStoryViewsList.f20143q + " " + tL_stories_getStoryViewsList.just_contacts + " " + tL_stories_getStoryViewsList.reactions_first);
