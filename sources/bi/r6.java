    ...
    public final void c() {
        if (!this.f3643e && this.f3650m && !this.f3647j) {
            ...
            if (z10) {
                ...
                tL_getStoryReactionsList.f20107id = storyItem.f20106id;
                ...
                this.f3643e = true;
                FileLog.d("SelfStoryViewsPage reactions load next " + storyItem.f20106id + " " + this.f3649l + " offset=" + tL_getStoryReactionsList.offset);
                                        ...
                                        switch (r5) {
                                            case 0:
                                                ...
                                                if (iArr[0] != r6Var2.f3652o) {
                                                    FileLog.d("SelfStoryViewsPage " + storyItem2.f20106id + " localId != reqId");
                                                    return;
                                                }
                                                r6Var2.f3643e = false;
                                                r6Var2.f3652o = -1;
                                                ...
                                                FileLog.d("SelfStoryViewsPage " + storyItem2.f20106id + " response  totalItems " + arrayList3.size() + " has next " + r6Var2.f3650m);
                                            ...
                                            default:
                                                ...
                                                if (iArr[0] != r6Var3.f3652o) {
                                                    FileLog.d("SelfStoryViewsPage reactions " + storyItem3.f20106id + " localId != reqId");
                                                    return;
                                                }
                                                r6Var3.f3643e = false;
                                                r6Var3.f3652o = -1;
                                                ...
                                                FileLog.d("SelfStoryViewsPage reactions " + storyItem3.f20106id + " response  totalItems " + arrayList5.size() + " has next " + r6Var3.f3650m);
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r5) {
                                            case 0:
                                                ...
                                                FileLog.d("SelfStoryViewsPage " + storyItem2.f20106id + " response  totalItems " + arrayList3.size() + " has next " + r6Var22.f3650m);
                                                for (int i19 = 0; i19 < arrayList.size(); i19++) {
            ...
            tL_stories_getStoryViewsList.f20115id = storyItem.f20106id;
            tL_stories_getStoryViewsList.peer = MessagesController.getInstance(i11).getInputPeer(j3);
            if (this.f3654q) {
                tL_stories_getStoryViewsList.f20116q = "";
                ...
                tL_stories_getStoryViewsList.f20116q = str2;
                if (!TextUtils.isEmpty(str2)) {
            ...
            this.f3643e = true;
            FileLog.d("SelfStoryViewsPage load next " + storyItem.f20106id + " " + this.f3649l + " offset=" + tL_stories_getStoryViewsList.offset + " q" + tL_stories_getStoryViewsList.f20116q + " " + tL_stories_getStoryViewsList.just_contacts + " " + tL_stories_getStoryViewsList.reactions_first);
