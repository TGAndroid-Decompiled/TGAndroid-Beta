...
public final class u3 implements ti {
    ...
    public final void l0(int i10, boolean z10, boolean z11, int i11, int i12, long j3, boolean z12, boolean z13, long j10) {
        ...
        if (o5Var.J0.m0 && (storyItem = o5Var.O1.f3337a) != null && !(storyItem instanceof TL_stories.TL_storyItemSkipped)) {
            if (i10 != 8 && i10 != 7 && (i10 != 4 || o5Var.I2.f31319j0.getSelectedPhotos().isEmpty())) {
                t3 t3Var = o5Var.I2;
                if (t3Var != null) {
            ...
            HashMap<Object, Object> selectedPhotos = o5Var.I2.f31319j0.getSelectedPhotos();
            ArrayList<Object> selectedPhotosOrder = o5Var.I2.f31319j0.getSelectedPhotosOrder();
