...
public final class qe extends View {
    public final Paint f3479a;
    public final org.telegram.ui.Components.n6 f3480b;
    ...
    public qe(Activity activity) {
        ...
        sb2.append("00:00:00");
        if (!TextUtils.equals(sb2, n6Var.f25428g)) {
            n6Var.b();
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        org.telegram.ui.Components.n6 n6Var = this.f3480b;
        float d = n6Var.d();
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(5.0f), AndroidUtilities.dp(5.0f), this.f3479a);
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.f3480b != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
