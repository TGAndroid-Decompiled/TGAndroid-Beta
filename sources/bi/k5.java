...
public final class k5 extends FrameLayout {
    public final i5 f3222a;
    public final j5 f3223b;
    public final TextView[] f3224c;
    public bj0 d;
    public final m5 f3225e;
    public Paint f3226f;
    public float h;
    ...
    public k5(Context context, m5 m5Var) {
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            this.f3224c[i10] = new TextView(context);
            this.f3224c[i10].setTextSize(1, 12.0f);
            this.f3224c[i10].setMaxLines(1);
            this.f3224c[i10].setSingleLine(true);
            this.f3224c[i10].setEllipsize(TextUtils.TruncateAt.MIDDLE);
            this.f3224c[i10].setTextColor(-1);
            this.f3224c[i10].setPadding(AndroidUtilities.dp(3.0f), 0, AndroidUtilities.dp(3.0f), AndroidUtilities.dp(1.0f));
            addView(this.f3224c[i10], w7.x5.d(-2, -2.0f, 0, 51.0f, 18.0f, 83.0f, 0.0f));
        }
        this.f3223b.setTextColor(-1);
    }
    ...
    public final void b(float f7, Canvas canvas, RectF rectF, boolean z10) {
        ...
        float clamp;
        t8 t8Var;
        m5 m5Var = this.f3225e;
        if ((m5Var != null && m5Var.f3338b != null) || this.h != 0.0f) {
            if (m5Var != null && (t8Var = m5Var.f3338b) != null && !t8Var.I) {
                this.h = 1.0f;
                f10 = t8Var.h;
                if (!this.f3227n) {
                    this.f3227n = true;
            ...
            if (this.f3228r && z11 && this.d.f24749f >= 0.9f) {
                this.h = Utilities.clamp(this.h - ((1000.0f / AndroidUtilities.screenRefreshRate) / 300.0f), 1.0f, 0.0f);
            }
            if (z10) {
                if (f7 != 1.0f) {
                ...
                if (this.f3226f == null) {
                    ...
                    this.f3226f = paint;
                    paint.setColor(-1);
                    this.f3226f.setStrokeWidth(AndroidUtilities.dp(2.0f));
                    this.f3226f.setStyle(Paint.Style.STROKE);
                    this.f3226f.setStrokeCap(Paint.Cap.ROUND);
                }
                this.f3226f.setAlpha((int) (255.0f * f7 * this.h));
                bj0 bj0Var5 = this.d;
                bj0Var5.f24762t = this.f3226f;
                bj0Var5.a(canvas);
            }
        }
    }
    ...
    public final void c(CharSequence charSequence, boolean z10) {
        ValueAnimator valueAnimator = this.f3229s;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.f3229s = null;
        }
        TextView[] textViewArr = this.f3224c;
        if (z10) {
            ...
            this.f3229s.addListener(new ah.b(this, 8));
            this.f3229s.setInterpolator(pr.h);
            this.f3229s.setDuration(340L);
            this.f3229s.start();
            return;
        }
        textViewArr[0].setVisibility(0);
