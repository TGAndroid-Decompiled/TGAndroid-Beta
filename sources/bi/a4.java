...
public final class a4 extends View {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f2777a) {
            case 3:
                ...
                org.telegram.ui.Components.p6 p6Var = r21Var.f29928e;
                float g10 = p6Var.g();
                if (g10 > 0.0f) {
                    ...
                    i6Var.setColor(i6Var.f27003b.a(org.telegram.ui.ActionBar.j6.v0(r21Var.I, i6Var.f27002a), false));
            ...
            case 5:
                ...
                if (s50Var.h > 0.0f && s50Var.d != null) {
                    s50Var.f40334f.reset();
                    float width = getWidth() / s50Var.f40332c.getWidth();
                    s50Var.f40334f.postScale(width, width);
                    s50Var.f40333e.setLocalMatrix(s50Var.f40334f);
                ...
                if (t50Var != null) {
                    ...
                    if (((u50) t50Var.f40651b).a(canvas2, t50Var.getMeasuredWidth(), s50Var.h)) {
                        invalidate();
                    }
                    canvas2.restore();
                    return;
            ...
            case 6:
                ...
                int i10 = dp + ((int) f70Var.f36308b.f15403e);
                Paint paint = (Paint) this.f2779c;
                paint.setColor(f70Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20965s8));
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.f2777a) {
            case 0:
                ...
                ((o5) this.d).getClass();
                e6Var.d(0.0f, false);
                float f10 = e6Var.f25593c;
                if (f10 != 0.0f) {
                    if (f10 != 1.0f) {
                        canvas.saveLayerAlpha(0.0f, 0.0f, getLayoutParams().width, getMeasuredHeight(), (int) (e6Var.f25593c * 255.0f), 31);
                    } else {
                        canvas.save();
                    }
                    RectF rectF = AndroidUtilities.rectTmp;
            ...
            case 1:
                ...
                for (int i10 = 0; i10 < 7; i10++) {
                    canvas.drawText(((String[]) this.f2778b)[i10], (measuredWidth / 2.0f) + (i10 * measuredWidth), ((getMeasuredHeight() - AndroidUtilities.dp(2.0f)) / 2.0f) + AndroidUtilities.dp(5.0f), ((org.telegram.ui.h8) this.d).f36933f);
                }
            ...
            case 7:
                ...
                if (i13 == 0 || i13 == 1) {
                    ...
                    canvas.drawRoundRect(rectF2, AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f), org.telegram.ui.ActionBar.j6.f20976t0);
                    return;
                }
                return;
            case 8:
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.f2777a) {
            case 3:
                super.onMeasure(View.MeasureSpec.makeMeasureSpec((int) Math.max(AndroidUtilities.dp(16.66f), ((r21) this.d).f29928e.d + AndroidUtilities.dp(10.0f)), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(16.66f), 1073741824));
                return;
            default:
    ...
    public void setAlpha(float f7) {
        switch (this.f2777a) {
            case 8:
                super.setAlpha(f7);
                ((PhotoViewer) this.d).f33594g0.invalidate();
                return;
            default:
                super.setAlpha(f7);
                return;
    ...
    public boolean verifyDrawable(Drawable drawable) {
        switch (this.f2777a) {
            case 3:
                if (((r21) this.d).f29928e != drawable && !super.verifyDrawable(drawable)) {
                    return false;
                }
                return true;
            case 4:
    ...
    public a4(r21 r21Var, Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        r21Var.f29928e.setCallback(this);
    }
    ...
    public a4(o5 o5Var, Context context) {
        ...
        this.d = o5Var;
        this.f2778b = new h90();
        this.f2779c = new org.telegram.ui.Components.e6(250L, pr.f29494f);
    }
