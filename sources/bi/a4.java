...
public final class a4 extends View {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f2750a) {
            case 3:
                ...
                org.telegram.ui.Components.p6 p6Var = r21Var.f29900e;
                float g10 = p6Var.g();
                if (g10 > 0.0f) {
                    ...
                    org.telegram.ui.Components.i6 i6Var = (org.telegram.ui.Components.i6) this.f2751b;
                    i6Var.setColor(i6Var.f26975b.a(org.telegram.ui.ActionBar.j6.v0(r21Var.I, i6Var.f26974a), false));
                    ...
                    p6Var.m(rectF);
                    p6Var.f29303w = (int) (g10 * 255.0f);
                    p6Var.r(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.W8, (org.telegram.ui.ActionBar.f6) this.f2752c));
                    p6Var.draw(canvas);
                    canvas.restore();
                }
            ...
            default:
                ...
                return;
            case 5:
                int[] iArr = (int[]) this.f2751b;
                t50 t50Var = (t50) this.f2752c;
                s50 s50Var = (s50) this.d;
                if (s50Var.h > 0.0f && s50Var.d != null) {
                    s50Var.f40306f.reset();
                    float width = getWidth() / s50Var.f40304c.getWidth();
                    s50Var.f40306f.postScale(width, width);
                    s50Var.f40305e.setLocalMatrix(s50Var.f40306f);
                ...
                if (t50Var != null) {
                    ...
                    if (((u50) t50Var.f40623b).a(canvas2, t50Var.getMeasuredWidth(), s50Var.h)) {
                        invalidate();
                    }
                    canvas2.restore();
                    return;
            ...
            case 6:
                ...
                int i10 = dp + ((int) f70Var.f36280b.f15376e);
                Paint paint = (Paint) this.f2752c;
                paint.setColor(f70Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20937s8));
                RectF rectF2 = (RectF) this.f2751b;
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.f2750a) {
            case 0:
                h90 h90Var = (h90) this.f2751b;
                super.onDraw(canvas);
                org.telegram.ui.Components.e6 e6Var = (org.telegram.ui.Components.e6) this.f2752c;
                e6Var.f25563a = this;
                ((o5) this.d).getClass();
                e6Var.d(0.0f, false);
                float f10 = e6Var.f25565c;
                if (f10 != 0.0f) {
                    if (f10 != 1.0f) {
                        canvas.saveLayerAlpha(0.0f, 0.0f, getLayoutParams().width, getMeasuredHeight(), (int) (e6Var.f25565c * 255.0f), 31);
                    } else {
                        canvas.save();
                    }
                    RectF rectF = AndroidUtilities.rectTmp;
                ...
                return;
            case 1:
                Drawable drawable = (Drawable) this.f2752c;
                super.onDraw(canvas);
                float measuredWidth = getMeasuredWidth() / 7.0f;
                for (int i10 = 0; i10 < 7; i10++) {
                    canvas.drawText(((String[]) this.f2751b)[i10], (measuredWidth / 2.0f) + (i10 * measuredWidth), ((getMeasuredHeight() - AndroidUtilities.dp(2.0f)) / 2.0f) + AndroidUtilities.dp(5.0f), ((org.telegram.ui.h8) this.d).f36905f);
                }
            ...
            case 2:
                ...
                if (!eg0Var.f25693n || ((qf0Var = eg0Var.f25694r) != null && qf0Var.f29716x)) {
                    int width = getWidth();
                    int dp2 = AndroidUtilities.dp(10.0f);
                    float f11 = (width - dp2) - dp2;
                    int i11 = dp2 + ((int) (eg0Var.Z * f11));
                    float height = getHeight() - AndroidUtilities.dp(8.0f);
                    float f12 = eg0Var.f25677a0;
                    if (f12 != 0.0f) {
                        float f13 = dp2;
                        f7 = height;
                        canvas.drawLine(f13, f7, (f11 * f12) + f13, height, (Paint) this.f2752c);
                    } else {
                        f7 = height;
                    }
                    canvas.drawLine(dp2, f7, i11, f7, (Paint) this.f2751b);
                    return;
                }
                return;
            case 3:
            ...
            case 4:
                super.onDraw(canvas);
                org.telegram.ui.Components.p6 p6Var = (org.telegram.ui.Components.p6) this.f2751b;
                int dpf2 = (int) (AndroidUtilities.dpf2(30.0f) + p6Var.d());
                int width2 = (getWidth() - dpf2) / 2;
                int i12 = dpf2 + width2;
                dh.d dVar = (dh.d) this.f2752c;
                if (dVar != null) {
                    dVar.setBounds(width2, 0, i12, getHeight());
                    ((dh.d) this.f2752c).draw(canvas);
                }
                p6Var.draw(canvas);
                return;
            case 7:
                ...
                Drawable drawable2 = id0Var.f37327s;
                Rect rect = (Rect) this.f2752c;
                drawable2.setBounds(-rect.left, 0, getMeasuredWidth() + rect.right, getMeasuredHeight());
                id0Var.f37327s.draw(canvas);
                int i13 = id0Var.G0;
                if (i13 == 0 || i13 == 1) {
                    ...
                    canvas.drawRoundRect(rectF2, AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f), org.telegram.ui.ActionBar.j6.f20948t0);
                    return;
                }
                return;
            case 8:
                ...
                for (int i14 = 0; i14 < height2; i14++) {
                    ...
                    for (int i15 = 0; i15 < width3; i15++) {
                        ...
                        if ((i16 == 0 && i14 % 2 == 0) || (i16 != 0 && i14 % 2 != 0)) {
                            canvas.drawRect(0.0f, 0.0f, f17, f17, (Paint) this.f2751b);
                        }
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.f2750a) {
            case 3:
                super.onMeasure(View.MeasureSpec.makeMeasureSpec((int) Math.max(AndroidUtilities.dp(16.66f), ((r21) this.d).f29900e.d + AndroidUtilities.dp(10.0f)), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(16.66f), 1073741824));
                return;
            default:
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        switch (this.f2750a) {
            case 4:
                ...
                ((org.telegram.ui.Components.p6) this.f2751b).setBounds(0, 0, i10, i11);
                return;
            default:
                super.onSizeChanged(i10, i11, i12, i13);
                return;
    ...
    public void setAlpha(float f7) {
        switch (this.f2750a) {
            case 8:
                super.setAlpha(f7);
                ((PhotoViewer) this.d).f33566g0.invalidate();
                return;
            default:
                super.setAlpha(f7);
                return;
    ...
    public boolean verifyDrawable(Drawable drawable) {
        switch (this.f2750a) {
            case 3:
                if (((r21) this.d).f29900e != drawable && !super.verifyDrawable(drawable)) {
                    return false;
                }
                return true;
            case 4:
                if (!super.verifyDrawable(drawable) && drawable != ((org.telegram.ui.Components.p6) this.f2751b)) {
                    return false;
                }
                return true;
            default:
    ...
    public a4(f70 f70Var, Context context) {
        super(context);
        this.d = f70Var;
        this.f2751b = new RectF();
        this.f2752c = new Paint(1);
    }
    ...
    public a4(r21 r21Var, Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.d = r21Var;
        this.f2752c = f6Var;
        this.f2751b = new org.telegram.ui.Components.i6(this, f6Var);
        r21Var.f29900e.setCallback(this);
    }
    ...
    public a4(o5 o5Var, Context context) {
        ...
        this.d = o5Var;
        this.f2751b = new h90();
        this.f2752c = new org.telegram.ui.Components.e6(250L, pr.f29466f);
    }
