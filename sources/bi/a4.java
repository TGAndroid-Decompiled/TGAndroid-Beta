...
public final class a4 extends View {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f2750a) {
            case 3:
                ...
                org.telegram.ui.Components.p6 p6Var = r21Var.f29901e;
                float g10 = p6Var.g();
                if (g10 > 0.0f) {
                    ...
                    i6Var.setColor(i6Var.f26976b.a(org.telegram.ui.ActionBar.j6.v0(r21Var.I, i6Var.f26975a), false));
            ...
            case 5:
                ...
                if (s50Var.h > 0.0f && s50Var.d != null) {
                    s50Var.f40307f.reset();
                    float width = getWidth() / s50Var.f40305c.getWidth();
                    s50Var.f40307f.postScale(width, width);
                    s50Var.f40306e.setLocalMatrix(s50Var.f40307f);
                ...
                if (t50Var != null) {
                    ...
                    if (((u50) t50Var.f40624b).a(canvas2, t50Var.getMeasuredWidth(), s50Var.h)) {
                        invalidate();
                    }
                    canvas2.restore();
                    return;
            ...
            case 6:
                ...
                int i10 = dp + ((int) f70Var.f36281b.f15376e);
                Paint paint = (Paint) this.f2752c;
                paint.setColor(f70Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20938s8));
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.f2750a) {
            case 0:
                ...
                ((o5) this.d).getClass();
                e6Var.d(0.0f, false);
                float f10 = e6Var.f25566c;
                if (f10 != 0.0f) {
                    if (f10 != 1.0f) {
                        canvas.saveLayerAlpha(0.0f, 0.0f, getLayoutParams().width, getMeasuredHeight(), (int) (e6Var.f25566c * 255.0f), 31);
                    } else {
                        canvas.save();
                    }
                    RectF rectF = AndroidUtilities.rectTmp;
            ...
            case 1:
                ...
                for (int i10 = 0; i10 < 7; i10++) {
                    canvas.drawText(((String[]) this.f2751b)[i10], (measuredWidth / 2.0f) + (i10 * measuredWidth), ((getMeasuredHeight() - AndroidUtilities.dp(2.0f)) / 2.0f) + AndroidUtilities.dp(5.0f), ((org.telegram.ui.h8) this.d).f36906f);
                }
            ...
            case 7:
                ...
                if (i13 == 0 || i13 == 1) {
                    ...
                    canvas.drawRoundRect(rectF2, AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f), org.telegram.ui.ActionBar.j6.f20949t0);
                    return;
                }
                return;
            case 8:
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.f2750a) {
            case 3:
                super.onMeasure(View.MeasureSpec.makeMeasureSpec((int) Math.max(AndroidUtilities.dp(16.66f), ((r21) this.d).f29901e.d + AndroidUtilities.dp(10.0f)), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(16.66f), 1073741824));
                return;
            default:
    ...
    public void setAlpha(float f7) {
        switch (this.f2750a) {
            case 8:
                super.setAlpha(f7);
                ((PhotoViewer) this.d).f33567g0.invalidate();
                return;
            default:
                super.setAlpha(f7);
                return;
    ...
    public boolean verifyDrawable(Drawable drawable) {
        switch (this.f2750a) {
            case 3:
                if (((r21) this.d).f29901e != drawable && !super.verifyDrawable(drawable)) {
                    return false;
                }
                return true;
            case 4:
    ...
    public a4(r21 r21Var, Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        r21Var.f29901e.setCallback(this);
    }
    ...
    public a4(o5 o5Var, Context context) {
        ...
        this.d = o5Var;
        this.f2751b = new h90();
        this.f2752c = new org.telegram.ui.Components.e6(250L, pr.f29467f);
    }
