...
public final class q2 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f3621a) {
            case 0:
                this.f3622b.f3460j2.setVisibility(8);
                return;
            case 1:
                o5 o5Var = this.f3622b;
                if (!o5Var.J0.H0) {
                    o5Var.f3510z3 = null;
                    if (o5Var.H0 == null) {
            ...
            case 2:
                ...
                return;
            case 3:
                ((gb) this.f3622b.Q1).b(true);
                return;
            case 4:
                this.f3622b.r0(true);
                return;
            case 5:
                pb pbVar = this.f3622b.J0;
                if (pbVar != null) {
            ...
            case 8:
                ...
                return;
            case 9:
                pb pbVar3 = ((gb) this.f3622b.Q1).d;
                pbVar3.f3580i1 = false;
                pbVar3.P();
                return;
            case 10:
                this.f3622b.L0(null);
