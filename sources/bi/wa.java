...
public final class wa extends ra {
    ...
    public wa(Context context, ta taVar, TL_stories.TL_mediaAreaSuggestedReaction tL_mediaAreaSuggestedReaction, gz gzVar) {
        ...
        gzVar.getClass();
        String str = d.f597f;
        str = str == null ? MessageObject.findAnimatedEmojiEmoticon(org.telegram.ui.Components.q5.f(gzVar.f36814b, d.f598g)) : str;
        if (str != null && (arrayList = (ArrayList) gzVar.f36816e.get(str)) != null && !arrayList.isEmpty()) {
