...
public final class l3 extends org.telegram.ui.ActionBar.n2 {
    ...
    public Context getContext() {
        switch (this.f3239a) {
            ...
            case 4:
                return ((fu) this.f3240b).f26184a.getContext();
            case 12:
    ...
    public int getCurrentAccount() {
        switch (this.f3239a) {
            ...
            case 5:
                return this.currentAccount;
            case 6:
                return ((cy) this.f3240b).E.f27933c1;
            case 9:
                return this.currentAccount;
            case 12:
                return this.currentAccount;
    ...
    public View getFragmentView() {
        ...
        switch (this.f3239a) {
            case 5:
                viewGroup = ((org.telegram.ui.ActionBar.f3) ((mv) this.f3240b).f28547x).containerView;
                return viewGroup;
            case 6:
                return ((cy) this.f3240b).E.f27978r;
            case 7:
            case 8:
            default:
    ...
    public Activity getParentActivity() {
        switch (this.f3239a) {
            ...
            case 9:
                org.telegram.ui.ActionBar.n2 n2Var = ((sg.o1) this.f3240b).f46213t0;
                if (n2Var == null) {
                    return null;
                }
    ...
    public org.telegram.ui.ActionBar.f6 getResourceProvider() {
        ...
        switch (this.f3239a) {
            ...
            case 5:
                f6Var2 = ((org.telegram.ui.ActionBar.f3) ((mv) this.f3240b).f28547x).resourcesProvider;
                return f6Var2;
            case 6:
                return ((cy) this.f3240b).E.Z1;
            case 8:
                return new k3(9, ((org.telegram.ui.web.d1) this.f3240b).f42043e);
            case 10:
    ...
    public Dialog getVisibleDialog() {
        switch (this.f3239a) {
            case 4:
                return new eu(this, ((fu) this.f3240b).f26184a.getContext());
            default:
