...
public final class l3 extends org.telegram.ui.ActionBar.n2 {
    ...
    public Context getContext() {
        switch (this.f3266a) {
            ...
            case 4:
                return ((fu) this.f3267b).f26211a.getContext();
            case 12:
    ...
    public int getCurrentAccount() {
        switch (this.f3266a) {
            ...
            case 5:
                return this.currentAccount;
            case 6:
                return ((cy) this.f3267b).E.f27960c1;
            case 9:
                return this.currentAccount;
            case 12:
                return this.currentAccount;
    ...
    public View getFragmentView() {
        ...
        switch (this.f3266a) {
            case 5:
                viewGroup = ((org.telegram.ui.ActionBar.f3) ((mv) this.f3267b).f28574x).containerView;
                return viewGroup;
            case 6:
                return ((cy) this.f3267b).E.f28005r;
            case 7:
            case 8:
            default:
    ...
    public Activity getParentActivity() {
        switch (this.f3266a) {
            ...
            case 9:
                org.telegram.ui.ActionBar.n2 n2Var = ((sg.o1) this.f3267b).f46241t0;
                if (n2Var == null) {
                    return null;
                }
    ...
    public org.telegram.ui.ActionBar.f6 getResourceProvider() {
        ...
        switch (this.f3266a) {
            ...
            case 5:
                f6Var2 = ((org.telegram.ui.ActionBar.f3) ((mv) this.f3267b).f28574x).resourcesProvider;
                return f6Var2;
            case 6:
                return ((cy) this.f3267b).E.Z1;
            case 8:
                return new k3(9, ((org.telegram.ui.web.d1) this.f3267b).f42070e);
            case 10:
    ...
    public Dialog getVisibleDialog() {
        switch (this.f3266a) {
            case 4:
                return new eu(this, ((fu) this.f3267b).f26211a.getContext());
            default:
