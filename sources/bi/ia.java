    ...
    public final void run() {
        ...
        switch (this.f3136a) {
            ...
            case 4:
                ...
                v70Var.f41467r = false;
                if (!((org.telegram.ui.g4) this.f3140f).f36578e.isEmpty()) {
                    if (tL_error == null) {
            ...
            case 5:
                ...
                if (z10) {
                    ...
                    ConnectionsManager.getInstance(i12).sendRequest(exportgroupcallinvite, new hi(b2Var, context, i12, exportgroupcallinvite, f6Var, v60Var));
                    return;
                } else {
                    b2Var.dismiss();
                    AndroidUtilities.runOnUIThread(v60Var);
            ...
            case 11:
                ...
                if (((c5.h) this.f3139e).f4424a == 0) {
                    ...
                    ConnectionsManager.getInstance(i14).sendRequest(tL_payments_canPurchaseStore, new hi(i14, 5, n2Var2, lx0Var, fVar, tL_payments_canPurchaseStore, tL_inputStorePaymentPremiumSubscription2));
                    return;
                }
                return;
            case 12:
                ...
                if (z11) {
                    ...
                    alertDialog$Builder.f20226a.R = LocaleController.getString(R.string.BotWebViewRequestWriteTitle);
                    alertDialog$Builder.f20226a.T = LocaleController.getString(R.string.BotWebViewRequestWriteMessage);
                    ...
                    d1Var2.Y(3, alertDialog$Builder.f20226a, new org.telegram.ui.web.y(strArr2, i15, z0Var, k9Var, 1));
                    return;
                }
            case 13:
