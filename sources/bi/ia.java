    ...
    public final void run() {
        ...
        switch (this.f3109a) {
            ...
            case 4:
                ...
                v70Var.f41440r = false;
                if (!((org.telegram.ui.g4) this.f3113f).f36551e.isEmpty()) {
                    if (tL_error == null) {
            ...
            case 12:
                ...
                if (z11) {
                    ...
                    alertDialog$Builder.f20199a.R = LocaleController.getString(R.string.BotWebViewRequestWriteTitle);
                    alertDialog$Builder.f20199a.T = LocaleController.getString(R.string.BotWebViewRequestWriteMessage);
                    ...
                    d1Var2.Y(3, alertDialog$Builder.f20199a, new org.telegram.ui.web.y(strArr2, i15, z0Var, k9Var, 1));
                    return;
                }
            case 13:
