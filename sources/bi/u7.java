    ...
    public final void run() {
        ...
        switch (i10) {
                ...
                if (tLObject != null) {
                    ...
                    while (true) {
                        if (i11 < tL_stories_stories.stories.size()) {
                            if (tL_stories_stories.stories.get(i11).f20133id == i12) {
            ...
            case 11:
                ...
                int i16 = ((zh.o) obj3).f52380a;
                boolean[] zArr = nVar.d;
                boolean[] zArr2 = nVar.f52318b;
                ArrayList[] arrayListArr = nVar.f52317a;
                zArr[i12] = false;
            ...
            default:
                ...
                tL_fulfillStarsSubscription.subscription_id = ((TL_stars.StarsSubscription) obj2).f20124id;
