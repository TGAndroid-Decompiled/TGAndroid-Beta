...
public final class u7 extends View {
    ...
    public final StaticLayout f3724c;
    public final float d;
    public final float e;
    public final int f3725f;
    public final int h;
    public final boolean f3726n;
    public final org.telegram.ui.Components.d6 f3727r;
    public boolean f3728s;
    public float v;
    public ValueAnimator f3729w;
    public final v7 f3730x;
    ...
    public u7(v7 v7Var, Context context, String str, boolean z10) {
        ...
        this.f3723b = paint2;
        this.f3727r = new org.telegram.ui.Components.d6(this, 0L, 220L, wr.h);
        this.f3728s = true;
        this.f3726n = z10;
        ...
        this.f3725f = dp;
        if (!z10) {
            this.f3725f = Math.max(AndroidUtilities.dp(80.0f), dp);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float d = this.f3727r.d(f7, false);
        ...
        canvas.drawRect(AndroidUtilities.dp(25.0f), AndroidUtilities.dp(4.0f), getWidth() - AndroidUtilities.dp(25.0f), getHeight() - AndroidUtilities.dp(4.0f), this.f3723b);
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(20.0f), AndroidUtilities.dp(20.0f), this.f3722a);
        canvas.save();
        float f13 = (this.f3725f - this.e) / 2.0f;
        if (this.f3726n) {
            f10 = 3.0f;
        }
        float dp = (f13 + AndroidUtilities.dp(f10)) - this.d;
        int height = getHeight();
        StaticLayout staticLayout = this.f3724c;
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.f3725f, 1073741824), View.MeasureSpec.makeMeasureSpec(this.h, 1073741824));
    }
    ...
    public final void setPressed(boolean z10) {
        ...
        if (isPressed() != z10) {
            ...
            invalidate();
            if (z10 && (valueAnimator = this.f3729w) != null) {
            ...
            if (!z10) {
                ...
                if (f7 != 0.0f) {
                    ...
                    this.f3729w.addListener(new h(this, 5));
                    this.f3729w.setInterpolator(new OvershootInterpolator(1.5f));
                    this.f3729w.setDuration(350L);
                    this.f3729w.start();
                }
            }
        }
