    ...
    public final boolean onLongClick(View view) {
        switch (this.f2854a) {
            ...
            case 1:
                ...
                di.p5 p5Var = ((org.telegram.ui.Components.e0) this.f2855b).f25501n;
                if (p5Var != null) {
            ...
            case 5:
                ...
                org.telegram.ui.ActionBar.n1 b10 = org.telegram.ui.Components.p9.b(profileActivity, imageView, profileActivity.a(), profileActivity.f33904g1, profileActivity.f34032z0);
                if (b10 != null) {
                    b10.setOnDismissListener(new org.telegram.ui.e0(profileActivity, 3));
                    profileActivity.f34013w0 = imageView;
            ...
            default:
                ...
                if (s00Var.f30140c) {
                    ...
                    for (int i10 = 0; i10 < size; i10++) {
                        ((ka1) arrayList.get(i10)).f37990a.setChecked(false);
                        ((ka1) arrayList.get(i10)).f37991b.f15448n = false;
                        if (la1Var.f38258r.f38897c > 0 && i10 < gVar.d.size()) {
                    ...
                    fVar.f15448n = true;
                    la1Var.f38253b.z();
                    if (la1Var.f38258r.f38897c > 0) {
                        ((lg.f) gVar.d.get(ka1Var.f37992c)).f15448n = true;
                        gVar.z();
                    }
                }
                return z10;
