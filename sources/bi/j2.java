...
public final class j2 {
    ...
    public final ImageReceiver f3157f;
    public final f01 f3158g;
    public boolean h;
    public final org.telegram.ui.Components.e6 f3159i;
    public final org.telegram.ui.Components.e6 f3160j;

    public j2(k2 k2Var, View view, int i10, long j3, int i11, boolean z10) {
        Paint paint = new Paint(1);
        this.f3156e = paint;
        this.f3153a = j3;
        this.f3154b = Utilities.clamp01(Utilities.fastRandom.nextFloat());
        this.f3155c = Utilities.clamp01(Utilities.fastRandom.nextFloat());
        if (z10) {
            int[] iArr = k2Var.f3217f;
            xi0 xi0Var = new xi0(iArr[Utilities.fastRandom.nextInt(iArr.length)], AndroidUtilities.dp(70.0f), AndroidUtilities.dp(70.0f));
            this.d = xi0Var;
            xi0Var.f32605v0 = view;
            xi0Var.H(true);
            xi0Var.I(0);
            xi0Var.start();
        }
        ...
        this.f3158g = new f01(spannableStringBuilder, 10.0f, AndroidUtilities.getTypeface("fonts/num.otf"));
        org.telegram.ui.Components.e6 e6Var = new org.telegram.ui.Components.e6(view, 2000L, new LinearInterpolator());
        this.f3159i = e6Var;
        e6Var.d(0.0f, true);
        e6Var.d(1.0f, false);
        this.f3160j = new org.telegram.ui.Components.e6(view, 350L, 240L, pr.h);
    }
}
