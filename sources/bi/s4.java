...
public final class s4 extends ea {
    public final pb f3685x0;
    public final org.telegram.ui.ActionBar.f6 f3686y0;
    public final o5 f3687z0;
        ...
        if (z5Var != null) {
            ...
            if (o5Var.Q1 != null) {
                ...
                if (document != null) {
                    ...
                    org.telegram.ui.ActionBar.f6 f6Var = this.f3686y0;
                    qc h = new yc(l4Var, f6Var).h(document, 2, new o4(this, this.f3685x0, f6Var, 0));
                    if (h != null) {
                        h.f29672a = 1;
                        h.k(true);
                    }
    ...
    public final void G(CharacterStyle characterStyle, View view) {
        ...
        pb pbVar = this.f3685x0;
        o5 o5Var = this.f3687z0;
        if (z10) {
            TLRPC.User user = MessagesController.getInstance(o5Var.C2).getUser(Utilities.parseLong(((o51) characterStyle).getURL()));
            if (user != null) {
                MessagesController.getInstance(o5Var.C2).openChatOrProfileWith(user, null, pbVar.f3545f, 0, false);
            }
            ...
            if (b10 != null) {
                ...
                if (url.startsWith("@")) {
                    MessagesController.getInstance(o5Var.C2).openByUserName(lowerCase, pbVar.f3545f, 0, null);
                    return;
                } else {
            ...
            wl.o(R.string.TextCopied, new yc(o5Var.f3409c1, this.f3686y0));
    ...
    public final void H(final URLSpan uRLSpan, final View view, a3.c cVar) {
        ...
        final org.telegram.ui.ActionBar.f6 f6Var2 = this.f3686y0;
        DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() {
            ...
            public final void onClick(DialogInterface dialogInterface, int i10) {
                ...
                if (i10 == 0) {
                    ...
                    new yc(s4Var.f3687z0.f3409c1, f6Var2).k(false).j();
                }
            }
        };
    ...
    public final void I(z9 z9Var) {
        ...
        final TLRPC.Document document = z9Var.f4079g;
        o5 o5Var = this.f3687z0;
        pb pbVar = this.f3685x0;
        final org.telegram.ui.ActionBar.f6 f6Var = this.f3686y0;
        if (document != null) {
                ...
                public final void run() {
                    ...
                    switch (r4) {
                        case 0:
                            ...
                            new yc(o5Var2.f3409c1, f6Var).Q(R.raw.saved_messages, 36, AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.StoryAudioAddToSavedMessagesToast), -1, 2, new ah.j(26))).k(true);
                            return;
                        default:
                            o5 o5Var3 = this.f3308b.f3687z0;
                            ...
                            new yc(o5Var3.f3409c1, f6Var).Q(R.raw.ic_save_to_music, 36, LocaleController.getString(R.string.StoryAudioAddToProfileToast)).k(true);
                            return;
                    }
                }
            ...
            F.Z();
        } else if (z9Var.f4077e && z9Var.f4075b != null && z9Var.d != null) {
            Bundle bundle = new Bundle();
        ...
        } else if (z9Var.f4075b != null && z9Var.f4076c != null) {
            MessagesController.getInstance(o5Var.C2).getStoriesController().d0(z9Var.f4075b.longValue(), z9Var.f4076c.intValue(), new n4(this, z9Var, pbVar, f6Var, 0));
        } else {
            qc Q = new yc(o5Var.f3409c1, f6Var).Q(R.raw.error, 36, LocaleController.getString(R.string.StoryHidAccount));
            Q.f29672a = 3;
            Q.k(true);
        }
    }
    ...
    public final void M(int i10, String str, CharacterStyle characterStyle, boolean z10) {
        ...
        if (i10 != 0 && i10 != 2) {
            if (i10 == 1) {
                org.telegram.ui.Components.e5.r0(pbVar.f3545f, str, true, true, false, false, null, null, this.f3686y0);
                return;
            }
            return;
        }
        if ((characterStyle instanceof n51) && (n01Var = ((n51) characterStyle).f28624a) != null && (n01Var.f28591a & 1024) != 0) {
            z11 = true;
        } else {
            z11 = false;
        }
        org.telegram.ui.Components.e5.r0(pbVar.f3545f, str, true, true, true, z11, null, null, this.f3686y0);
    }
}
