...
public final class s4 extends ea {
    ...
    public final void G(CharacterStyle characterStyle, View view) {
        ...
        if (z10) {
            ...
            vl.o(R.string.TextCopied, new yc(o5Var.f3436c1, this.f3713y0));
    ...
    public final void M(int i10, String str, CharacterStyle characterStyle, boolean z10) {
        ...
        if ((characterStyle instanceof n51) && (n01Var = ((n51) characterStyle).f28652a) != null && (n01Var.f28619a & 1024) != 0) {
            z11 = true;
        } else {
            z11 = false;
        }
