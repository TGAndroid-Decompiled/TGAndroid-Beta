...
public final class c {
    ...
    public final ArrayList f41067a = new ArrayList();
    public final ArrayList f41068b = new ArrayList();
    public final HashMap f41069c = new HashMap();
    public float f41072i = -1.0f;
    public final sf.a f41073j = new sf.a("enter");
    public final sf.a f41074k = new sf.a("leave");
    public final Choreographer f41075l = Choreographer.getInstance();
    public final b f41076m = new b(this, 0);
    public final g f41078o = new g(this, 9);
    ...
    public final void a(boolean z10) {
        ...
        if (this.f41077n) {
            this.f41077n = false;
            this.f41075l.removeFrameCallback(this.f41076m);
        }
        this.f41070f = false;
        ArrayList arrayList2 = this.f41067a;
    ...
    public final void b() {
        ...
        int i10 = 0;
        this.f41071g = false;
        ArrayList arrayList = this.f41067a;
        int size = arrayList.size();
        int i11 = 0;
        while (i11 < size) {
            Object obj = arrayList.get(i11);
        ...
        sf.a aVar = this.f41073j;
        long j3 = aVar.f43204b;
        ArrayList arrayList2 = this.f41068b;
        int size2 = arrayList2.size();
        while (i10 < size2) {
            Object obj2 = arrayList2.get(i10);
            i10++;
        ...
        d(0.0f);
        aVar.f43205c = SystemClock.uptimeMillis();
        if (this.f41077n) {
            return;
        }
        this.f41077n = true;
        this.f41075l.postFrameCallback(this.f41076m);
    }
    ...
    public final void f() {
        int i10;
        if (!this.f41070f && (i10 = Build.VERSION.SDK_INT) < 31 && i10 >= 26 && this.h != null && e()) {
            b();
    ...
    public final void g(PictureInPictureUiState pictureInPictureUiState) {
        ...
        if (i10 >= 31) {
            ...
            if (this.f41071g != isStashed) {
                this.f41071g = isStashed;
                int i11 = 0;
                ArrayList arrayList = this.f41067a;
                if (isStashed) {
                    int size = arrayList.size();
