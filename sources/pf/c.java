...
public final class c {
    ...
    public final ArrayList f41039a = new ArrayList();
    public final ArrayList f41040b = new ArrayList();
    public final HashMap f41041c = new HashMap();
    public float f41044i = -1.0f;
    public final sf.a f41045j = new sf.a("enter");
    public final sf.a f41046k = new sf.a("leave");
    public final Choreographer f41047l = Choreographer.getInstance();
    public final b f41048m = new b(this, 0);
    public final g f41050o = new g(this, 9);
    ...
    public final void a(boolean z10) {
        d(0.0f);
        this.f41046k.a();
        ArrayList arrayList = this.f41040b;
        ...
        if (this.f41049n) {
            this.f41049n = false;
            this.f41047l.removeFrameCallback(this.f41048m);
        }
        this.f41042f = false;
        ArrayList arrayList2 = this.f41039a;
    ...
    public final void b() {
        ...
        int i10 = 0;
        this.f41043g = false;
        ArrayList arrayList = this.f41039a;
        int size = arrayList.size();
        int i11 = 0;
        while (i11 < size) {
            Object obj = arrayList.get(i11);
        ...
        sf.a aVar = this.f41045j;
        long j3 = aVar.f43191b;
        ArrayList arrayList2 = this.f41040b;
        int size2 = arrayList2.size();
        while (i10 < size2) {
            Object obj2 = arrayList2.get(i10);
            i10++;
        ...
        d(0.0f);
        aVar.f43192c = SystemClock.uptimeMillis();
        if (this.f41049n) {
            return;
        }
        this.f41049n = true;
        this.f41047l.postFrameCallback(this.f41048m);
    }
    ...
    public final void f() {
        int i10;
        if (!this.f41042f && (i10 = Build.VERSION.SDK_INT) < 31 && i10 >= 26 && this.h != null && e()) {
            b();
    ...
    public final void g(PictureInPictureUiState pictureInPictureUiState) {
        ...
        if (i10 >= 31) {
            ...
            if (this.f41043g != isStashed) {
                this.f41043g = isStashed;
                int i11 = 0;
                ArrayList arrayList = this.f41039a;
                if (isStashed) {
                    int size = arrayList.size();
