...
public final class c {
    ...
    public final ArrayList f40722a = new ArrayList();
    public final ArrayList f40723b = new ArrayList();
    public final HashMap f40724c = new HashMap();
    public float f40727i = -1.0f;
    public final sf.a f40728j = new sf.a("enter");
    public final sf.a f40729k = new sf.a("leave");
    public final Choreographer f40730l = Choreographer.getInstance();
    public final b f40731m = new b(this, 0);
    public final g f40733o = new g(this, 9);
    ...
    public final void a(boolean z10) {
        d(0.0f);
        this.f40729k.a();
        ArrayList arrayList = this.f40723b;
        ...
        if (this.f40732n) {
            this.f40732n = false;
            this.f40730l.removeFrameCallback(this.f40731m);
        }
        this.f40725f = false;
        ArrayList arrayList2 = this.f40722a;
    ...
    public final void b() {
        ...
        int i10 = 0;
        this.f40726g = false;
        ArrayList arrayList = this.f40722a;
        int size = arrayList.size();
        int i11 = 0;
        while (i11 < size) {
            Object obj = arrayList.get(i11);
        ...
        sf.a aVar = this.f40728j;
        long j3 = aVar.f42854b;
        ArrayList arrayList2 = this.f40723b;
        int size2 = arrayList2.size();
        while (i10 < size2) {
            Object obj2 = arrayList2.get(i10);
            i10++;
        ...
        d(0.0f);
        aVar.f42855c = SystemClock.uptimeMillis();
        if (this.f40732n) {
            return;
        }
        this.f40732n = true;
        this.f40730l.postFrameCallback(this.f40731m);
    }
    ...
    public final void f() {
        int i10;
        if (!this.f40725f && (i10 = Build.VERSION.SDK_INT) < 31 && i10 >= 26 && this.h != null && e()) {
            b();
    ...
    public final void g(PictureInPictureUiState pictureInPictureUiState) {
        ...
        if (i10 >= 31) {
            ...
            if (this.f40726g != isStashed) {
                this.f40726g = isStashed;
                int i11 = 0;
                ArrayList arrayList = this.f40722a;
                if (isStashed) {
                    int size = arrayList.size();
