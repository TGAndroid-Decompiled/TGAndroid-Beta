...
public final class z2 extends View {
    public final l3 f46350a;
    public final ImageReceiver f46351b;
    public final Path f46352c;
    ...
    public final void onAttachedToWindow() {
        ...
        this.f46351b.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f46351b.onDetachedFromWindow();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawPath(this.f46352c, this.d);
        canvas.restore();
        ImageReceiver imageReceiver = this.f46351b;
