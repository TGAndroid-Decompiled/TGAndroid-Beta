...
public final class u4 extends org.telegram.ui.Cells.g3 {
    public final z4 E;
    public final ch.f f46425x;
    public final int f46426y;

    public u4(z4 z4Var, Context context, bw0 bw0Var, String str, int i10, d6 d6Var, ch.f fVar, int i11) {
        super(context, bw0Var, str, true, i10, d6Var);
        this.E = z4Var;
        this.f46425x = fVar;
        this.f46426y = i11;
    }
    ...
    public final void b() {
        ...
        TLRPC.MessageAction messageAction = z4Var.f46516l0;
        ...
        CharSequence[] charSequenceArr = {z4Var.f46522s0.getText()};
        tL_textWithEntities.entities = MediaDataController.getInstance(this.f46426y).getEntities(charSequenceArr, true);
        tL_textWithEntities.text = charSequenceArr[0].toString();
        messageObject.setType();
        z4Var.f46515k0.U(messageObject, true);
