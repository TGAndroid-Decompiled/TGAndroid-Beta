...
public final class m extends Dialog {
    ...
    public final Drawable f49463c;
    public final TextView d;
    public final TextView f49464e;
    public final ActionBarPopupWindow$ActionBarPopupWindowLayout f49465f;
    public final oh0 h;
    public final j f49466n;
    public TLRPC.TL_chatInviteImporter f49467r;
    public ValueAnimator f49468s;
    public x9 v;
    public BitmapDrawable f49469w;
    public float f49470x;
    public final l f49471y;
    ...
    public m(n nVar, Activity activity, ll0 ll0Var, f6 f6Var, boolean z10) {
        ...
        this.f49461a = rect.top;
        this.f49462b = rect.left;
        ...
        this.f49465f = actionBarPopupWindow$ActionBarPopupWindowLayout;
        ...
        textView2.setTextColor(j6.v0(j6.f21070y6, n2Var.getResourceProvider()));
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        m mVar = this.f49455b;
                        n nVar2 = mVar.E;
                        TLRPC.TL_chatInviteImporter tL_chatInviteImporter = mVar.f49467r;
                        if (tL_chatInviteImporter != null) {
                            nVar2.d(tL_chatInviteImporter, true);
                        }
                        nVar2.f49488s.e(false);
                        nVar2.f49487r = null;
                        return;
                    case 1:
                        m.a(this.f49455b);
                        return;
                    default:
                        m mVar2 = this.f49455b;
                        n nVar3 = mVar2.E;
                        TLRPC.TL_chatInviteImporter tL_chatInviteImporter2 = mVar2.f49467r;
                        if (tL_chatInviteImporter2 != null) {
                            nVar3.d(tL_chatInviteImporter2, false);
                        }
                        nVar3.f49488s.e(false);
                        nVar3.f49487r = null;
                        return;
                }
            }
        ...
        f1Var3.c(j6.v0(j6.f20926q7, f6Var), j6.v0(j6.f20908p7, f6Var));
    ...
    public static void a(m mVar) {
        n nVar = mVar.E;
        if (mVar.f49467r != null) {
            nVar.f49473b = true;
            n2 n2Var = nVar.f49477g;
            super.dismiss();
            n2Var.dismissCurrentDialog();
            Bundle bundle = new Bundle();
            bundle.putLong("user_id", mVar.f49467r.user_id);
    ...
    public final int d() {
        ...
        TextView textView = this.f49464e;
        if (textView.getVisibility() != 8) {
            measuredHeight += textView.getMeasuredHeight() + AndroidUtilities.dp(4.0f);
        }
        return this.f49465f.getMeasuredHeight() + AndroidUtilities.dp(12.0f) + measuredHeight;
    }
    ...
    public final void e(boolean z10) {
        float f7;
        ValueAnimator valueAnimator = this.f49468s;
        ...
        final int i10 = (-this.f49465f.getTop()) / 2;
        if (z10) {
            f7 = 0.0f;
        } else {
            f7 = 1.0f;
        ...
        this.f49468s = ofFloat;
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                float floatValue = ((Float) valueAnimator2.getAnimatedValue()).floatValue();
                m mVar = m.this;
                mVar.f49470x = floatValue;
                float f12 = width;
                float z11 = e2.z(1.0f, f12, floatValue, f12);
                l lVar = mVar.f49471y;
                lVar.setScaleX(z11);
                lVar.setScaleY(z11);
                lVar.setTranslationX((1.0f - mVar.f49470x) * left);
                lVar.setTranslationY((1.0f - mVar.f49470x) * top);
                int i11 = (int) ((1.0f - mVar.f49470x) * width2);
                mVar.h.N(i11, i11);
                float a2 = p.a((mVar.f49470x * 2.0f) - 1.0f, 0.0f, 1.0f);
                mVar.f49463c.setAlpha((int) (a2 * 255.0f));
                mVar.d.setAlpha(a2);
                mVar.f49464e.setAlpha(a2);
                ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout = mVar.f49465f;
                actionBarPopupWindow$ActionBarPopupWindowLayout.setTranslationY((1.0f - mVar.f49470x) * i10);
                actionBarPopupWindow$ActionBarPopupWindowLayout.setAlpha(a2);
                BitmapDrawable bitmapDrawable = mVar.f49469w;
                if (bitmapDrawable != null) {
                    bitmapDrawable.setAlpha((int) (mVar.f49470x * 255.0f));
                }
                mVar.f49466n.setAlpha(a2);
            }
        });
        this.f49468s.addListener(new fm0(this, z10, width, 1));
        this.f49468s.setDuration(220L);
        this.f49468s.setInterpolator(pr.f29494f);
        this.f49468s.start();
    }

    public final void f() {
        int i10;
        BitmapDrawable bitmapDrawable = this.f49469w;
        if (bitmapDrawable != null) {
        ...
        this.f49469w = bitmapDrawable2;
        bitmapDrawable2.setAlpha(i10);
        getWindow().setBackgroundDrawable(this.f49469w);
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        setContentView(this.f49471y, new ViewGroup.LayoutParams(-1, -1));
