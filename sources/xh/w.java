...
public final class w extends FrameLayout {
    public final RectF f46454a;
    public final RectF f46455b;
    public final c0 f46456c;

    public w(c0 c0Var, Context context) {
        super(context);
        this.f46456c = c0Var;
        this.f46454a = new RectF();
        this.f46455b = new RectF();
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        super.dispatchDraw(canvas);
        c0 c0Var = this.f46456c;
        x xVar = c0Var.f46081a0;
        FrameLayout frameLayout = xVar.f48070b;
        RectF rectF = this.f46454a;
        if (hh.k.c(frameLayout, this, rectF)) {
            TextView textView = c0Var.f46082b0;
            RectF rectF2 = this.f46455b;
