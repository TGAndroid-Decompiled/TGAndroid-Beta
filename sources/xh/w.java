...
public final class w extends FrameLayout {
    public final RectF f46214a;
    public final RectF f46215b;
    public final c0 f46216c;

    public w(c0 c0Var, Context context) {
        super(context);
        this.f46216c = c0Var;
        this.f46214a = new RectF();
        this.f46215b = new RectF();
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        super.dispatchDraw(canvas);
        c0 c0Var = this.f46216c;
        x xVar = c0Var.f45842a0;
        FrameLayout frameLayout = xVar.f47993b;
        RectF rectF = this.f46214a;
        if (hh.k.c(frameLayout, this, rectF)) {
            TextView textView = c0Var.f45843b0;
            RectF rectF2 = this.f46215b;
