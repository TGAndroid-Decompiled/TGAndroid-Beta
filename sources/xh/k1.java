...
public final class k1 extends View {
    ...
    public final void a(int i10, int i11) {
        this.f46251a.f28309a.setShader(new LinearGradient(0.0f, 0.0f, AndroidUtilities.dp(48.0f), AndroidUtilities.dp(48.0f), new int[]{i10, i11}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP));
    }
    ...
    public void setColor(int i10) {
        Paint paint = this.f46251a.f28309a;
