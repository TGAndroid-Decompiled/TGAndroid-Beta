...
public final class u extends org.telegram.ui.ActionBar.j {
    public final TL_stars.StarGift f46456a;
    public final Context f46457b;
    public final f6 f46458c;

    public u(Context context, TL_stars.StarGift starGift, f6 f6Var) {
        this.f46456a = starGift;
    ...
    public final void b(int i10) {
        Context context = this.f46457b;
        TL_stars.StarGift starGift = this.f46456a;
        if (i10 != 3 && i10 != 2) {
            if (i10 == 4) {
                v.U(context, starGift, this.f46458c);
                return;
            }
            return;
        }
