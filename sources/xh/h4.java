...
public class h4 extends org.telegram.ui.ActionBar.n2 implements le.d {
    ...
    public fh.c L;
    public ah.c M;
    public final le.b f45894a;
    public final long f45895b;
    public final String f45896c;
    public final u3 d;
    public Utilities.Callback e;
    public org.telegram.ui.ActionBar.g2 f45897f;
    public View h;
    public d3 f45898n;
    public FrameLayout f45899r;
    public FrameLayout f45900s;
    public TextView v;
    public m3 f45901w;
    public boolean f45902x;
    public HorizontalScrollView f45903y;

    public h4(long j3, String str, long j10, e6 e6Var) {
        super(null);
        this.f45894a = new le.b(0, this, qr.h, 380L, false);
        this.K = true;
        this.f45895b = j3;
        this.f45896c = str;
    ...
    public static void V(h4 h4Var, Context context) {
        ...
        n70Var.R = true;
        n70Var.f26363p = new ii.h(n70Var, 3);
        String[] strArr = {""};
    ...
    public static void W(h4 h4Var, Context context) {
        u3 u3Var = h4Var.d;
        if (!h4Var.K || u3Var.f46146f.isEmpty()) {
            return;
        }
        ...
        n70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        n70Var.R = true;
        n70Var.f26363p = new ii.h(n70Var, 5);
        String[] strArr = {""};
    ...
    public static void X(h4 h4Var, Context context) {
        u3 u3Var = h4Var.d;
        if (!h4Var.K || u3Var.f46147g.isEmpty()) {
            return;
        }
        ...
        n70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        n70Var.R = true;
        n70Var.f26363p = new ii.h(n70Var, 4);
        String[] strArr = {""};
    ...
    public static void Y(h4 h4Var, i51 i51Var) {
        ...
        if (obj instanceof TL_stars.TL_starGiftUnique) {
            ...
            yh.a4 a4Var = new yh.a4(h4Var.getParentActivity(), h4Var.currentAccount, h4Var.f45895b, h4Var.resourceProvider, null);
    ...
    public final void D(int i10, float f7, float f10, le.e eVar) {
        if (i10 == 0) {
            this.f45900s.setTranslationY((-AndroidUtilities.dp(52.0f)) * f7);
            y10.d(this.f45899r, f7);
        }
    }
    ...
    public final View createView(final Context context) {
        ...
        this.actionBar.setSubtitleColor(getThemedColor(i6.f19237z6));
        ...
        m7Var.d = true;
        z5.a(m7Var);
        m7Var.setOnClickListener(new vy0(25, this, m7Var));
        ...
        this.f45898n.j(new kb0(this, 16));
        this.f45898n.setPadding(0, AndroidUtilities.dp(45.0f), 0, AndroidUtilities.dp(101.0f));
        this.f45898n.setClipToPadding(false);
        w8Var.addView(this.f45898n, x5.d(-1, -1.0f, 119, 7.33f, 0.0f, 7.33f, -45.0f));
        w8Var.addView(this.actionBar);
        View.OnClickListener onClickListener = new View.OnClickListener(this) {
            public final h4 f46240b;
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        ...
                        return;
                    default:
                        u3 u3Var2 = this.f46240b.d;
                        u3Var2.f46150k.clear();
                        u3Var2.f46149j.clear();
                        u3Var2.f46151l.clear();
                        u3Var2.h();
                        return;
                }
            }
        ...
        wl.n(i6.G6, e6Var, textView, 1, 17.0f);
        ...
        this.f45901w = frameLayout;
        this.f45902x = false;
        frameLayout.setAlpha(0.0f);
        this.f45901w.setScaleX(0.95f);
        this.f45901w.setScaleY(0.95f);
        this.f45901w.setVisibility(8);
        w8Var.addView(this.f45901w, x5.d(-1, -1.0f, 119, 0.0f, 0.0f, 0.0f, -45.0f));
        LinearLayout linearLayout = new LinearLayout(context);
        this.E = linearLayout;
        linearLayout.setPadding(AndroidUtilities.dp(11.0f), 0, AndroidUtilities.dp(11.0f), 0);
        this.E.setOrientation(0);
        HorizontalScrollView horizontalScrollView = new HorizontalScrollView(context);
        this.f45903y = horizontalScrollView;
        horizontalScrollView.setHorizontalScrollBarEnabled(false);
        this.f45903y.addView(this.E);
        this.f45903y.setBackgroundColor(v);
        this.f45903y.setClipChildren(false);
        w8Var.addView(this.f45903y, x5.e(-1, 47, 55));
        ...
        npVar.b(i6.f18909h7, i6.f18945j7, i6.f18965k7);
        ...
        wl.n(i6.f18943j5, this.resourceProvider, textView3, 1, 14.0f);
        ...
        this.f45900s = frameLayout2;
        frameLayout2.setPadding(AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f));
        FrameLayout frameLayout3 = this.f45900s;
        ...
        this.f45900s.setOnClickListener(new View.OnClickListener(this) {
            public final h4 f45797b;
            ...
            public final void onClick(View view2) {
                switch (r3) {
                    case 0:
                        u3 u3Var = this.f45797b.d;
                        if (u3Var != null) {
                            boolean z10 = !u3Var.f46157r;
                            u3Var.f46157r = z10;
                            npVar.a(z10, true);
                            u3Var.h();
                            return;
                        ...
                        return;
                    default:
                        final h4 h4Var = this.f45797b;
                        u3 u3Var2 = h4Var.d;
                        if (h4Var.K) {
                            n70 H = n70.H(h4Var, h4Var.F);
                            H.c(R.drawable.menu_sort_value, LocaleController.getString(t3.BY_PRICE.f46131a), new w2(h4Var, 3), false);
                            H.c(R.drawable.menu_sort_date, LocaleController.getString(t3.BY_DATE.f46131a), new w2(h4Var, 4), false);
                            H.c(R.drawable.menu_sort_number, LocaleController.getString(t3.BY_NUMBER.f46131a), new w2(h4Var, 5), false);
                            H.k();
                            ...
                            }, LocaleController.getString(R.string.GiftResaleFilterForStarsOnly), u3Var2.f46157r);
                            H.f26369t = false;
                            H.Y = true;
        ...
        this.f45900s.addView(linearLayout2, x5.c(-1.0f, -2));
        z5.b(this.f45900s, 0.04f, 1.5f);
        w8Var.addView(this.f45900s, x5.d(-2, 52.0f, 81, 0.0f, 0.0f, 0.0f, AndroidUtilities.navigationBarHeight / AndroidUtilities.density));
        v5 y3 = v5.y(this.currentAccount, true);
        if (y3.e && !y3.s().k()) {
            this.f45900s.setVisibility(8);
        }
        FrameLayout frameLayout4 = new FrameLayout(context);
        this.f45899r = frameLayout4;
        ...
        FrameLayout frameLayout5 = this.f45899r;
        ...
        w8Var.addView(this.f45899r, x5.d(-2, 60.0f, 81, 0.0f, 0.0f, 0.0f, AndroidUtilities.navigationBarHeight / AndroidUtilities.density));
        ...
        this.f45899r.setOnClickListener(new View.OnClickListener(this) {
            public final h4 f46240b;
        ...
        this.f45899r.addView(this.v, x5.c(-1.0f, -2));
        this.f45899r.setVisibility(8);
        z5.b(this.f45899r, 0.05f, 1.5f);
        l3 l3Var = new l3(context, this.resourceProvider);
        this.F = l3Var;
        l3Var.setSorting(this.d.f46155p);
        ...
        this.G.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view2) {
                switch (r3) {
                    case 0:
                        h4.W(this.f46120b, context);
                        return;
                    case 1:
                        h4.X(this.f46120b, context);
                        return;
                    default:
                        h4.V(this.f46120b, context);
                        return;
                }
            }
        });
    ...
    public final void d0(boolean z10, boolean z11) {
        ...
        float f14 = 0.0f;
        if (z11) {
            this.f45903y.setVisibility(0);
            ViewPropertyAnimator animate = this.f45903y.animate();
            if (z10) {
                f11 = 0.0f;
            } else {
            ...
            ViewPropertyAnimator animate3 = this.f45898n.animate();
            if (!z10) {
        ...
        HorizontalScrollView horizontalScrollView = this.f45903y;
        if (!z10) {
            i10 = 8;
        }
        horizontalScrollView.setVisibility(i10);
        HorizontalScrollView horizontalScrollView2 = this.f45903y;
        if (z10) {
            f7 = 0.0f;
        } else {
        ...
        HorizontalScrollView horizontalScrollView3 = this.f45903y;
        if (!z10) {
            f13 = 0.0f;
        }
    ...
    public final void e0(boolean z10) {
        ...
        HashSet hashSet2 = u3Var.f46150k;
        ArrayList arrayList2 = u3Var.f46147g;
        HashSet hashSet3 = u3Var.f46149j;
        ArrayList arrayList3 = u3Var.f46146f;
        if (i10 > 12) {
            d0(true, true);
        }
        d3 d3Var = this.f45898n;
        ...
        l3 l3Var = this.F;
        if (l3Var != null) {
            l3Var.setSorting(u3Var.f46155p);
        }
        if (this.G != null) {
        ...
        int i12 = 0;
        while (true) {
            if (i12 >= this.f45898n.getChildCount()) {
                break;
            } else if (this.f45898n.getChildAt(i12) instanceof t00) {
                u3Var.g(false);
                break;
            } else {
                i12++;
        ...
        if ((u3Var.f46159t || u3Var.e > 0) && (!hashSet3.isEmpty() || !hashSet2.isEmpty() || !hashSet.isEmpty())) {
            z11 = true;
        }
        this.f45894a.a(z11, true);
    }
