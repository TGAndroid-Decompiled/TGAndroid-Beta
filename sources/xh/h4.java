...
public final class h4 extends bb {
    public static final int f46140k0 = 0;
    public final String X;
    public final g4 Y;
    public final HorizontalScrollView Z;
    public final m3 f46141a0;
    public final m3 f46142b0;
    public final m3 f46143c0;
    public final m3 f46144d0;
    public final yh.j2 f46145e0;
    public yh.w0 f46146f0;
    public final HashSet f46147g0;
    public boolean f46148h0;
    public f4 f46149i0;
    public boolean f46150j0;

    public h4(final Context context, String str, final g4 g4Var) {
        super(2, context, (e6) null, false);
        this.f46147g0 = new HashSet();
        ...
        this.f46141a0 = m3Var;
        m3Var.setSorting(g4Var.f46132c.f46435p);
        ...
        m3Var2.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r4) {
                    case 0:
                        h4.R(this.f46064b, g4Var, context);
                        return;
                    case 1:
                        h4.W(this.f46064b, g4Var, context);
                        return;
                    default:
                        h4.S(this.f46064b, g4Var, context);
                        return;
                }
            }
        });
        m3 m3Var3 = new m3(context, this.resourcesProvider);
        this.f46143c0 = m3Var3;
        ...
        this.f46149i0.N(false);
        g4Var.d = new z3(this, 1);
    }

    public static void P(h4 h4Var, g4 g4Var) {
        w70 F = w70.F(h4Var.container, h4Var.resourcesProvider, h4Var.f46141a0);
        F.c(R.drawable.menu_sort_value, LocaleController.getString(u3.BY_PRICE.f46398a), new y3(g4Var, 3), false);
        F.c(R.drawable.menu_sort_date, LocaleController.getString(u3.BY_DATE.f46398a), new y3(g4Var, 4), false);
        F.c(R.drawable.menu_sort_number, LocaleController.getString(u3.BY_NUMBER.f46398a), new y3(g4Var, 5), false);
        F.f29925t = false;
        F.Y = true;
    ...
    public static void Q(h4 h4Var, g4 g4Var, int i10) {
        ...
        zf.b bVar;
        x51 G = h4Var.f46149i0.G(i10 - 1);
        if (G != null) {
            Object obj = G.G;
            if (obj instanceof TL_stars.StarGift) {
                TL_stars.StarGift starGift = (TL_stars.StarGift) obj;
                boolean z10 = G.f30254r;
                if (!TextUtils.isEmpty(starGift.gift_address) && h4Var.f46148h0) {
                    ...
                    zf.b bVar2 = bVar;
                    t5.x(h4Var.currentAccount, bVar2).H(tL_starGiftUnique, clientUserId, null, true, new cp0(h4Var, b2Var2, bVar2, tL_starGiftUnique, clientUserId));
                } else {
                    if (!z10) {
                        ArrayList arrayList = g4Var.f46131b.f47650l;
    ...
    public static void R(h4 h4Var, g4 g4Var, Context context) {
        ...
        if (v3Var.f46426f.isEmpty()) {
            return;
        }
        w70 w70Var = new w70(h4Var.container, h4Var.resourcesProvider, h4Var.f46142b0, false, true, false);
        w70Var.f29925t = false;
        w70Var.Y = true;
        w70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        w70Var.R = true;
        w70Var.f29919p = new ii.h(w70Var, 8);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(v3Var.f46426f);
        Collections.sort(arrayList, new a4(g4Var, 2));
        t61 t61Var = new t61(context, h4Var.currentAccount, 0, false, new w3(strArr, g4Var, arrayList, 0), new x3(g4Var, w70Var, 0), null, h4Var.resourcesProvider);
        ...
        buVar.addTextChangedListener(new qn(strArr, t61Var, false, 11));
        if (arrayList.size() > 8) {
    ...
    public static void S(h4 h4Var, g4 g4Var, Context context) {
        ...
        w70 w70Var = new w70(h4Var.container, h4Var.resourcesProvider, h4Var.f46144d0, false, true, false);
        w70Var.f29925t = false;
        w70Var.Y = true;
        w70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        w70Var.R = true;
        w70Var.f29919p = new ii.h(w70Var, 7);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(v3Var.h);
        Collections.sort(arrayList, new a4(g4Var, 1));
        t61 t61Var = new t61(context, h4Var.currentAccount, 0, false, new w3(strArr, g4Var, arrayList, 2), new x3(g4Var, w70Var, 2), null, h4Var.resourcesProvider);
        t61Var.Y2.f26042r = false;
        FrameLayout frameLayout = new FrameLayout(context);
        ImageView imageView = new ImageView(context);
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        ...
        buVar.setBackground(null);
        frameLayout.addView(buVar, y5.d(-1, -2.0f, 19, 43.0f, 0.0f, 8.0f, 0.0f));
        buVar.addTextChangedListener(new qn(strArr, t61Var, false, 13));
        if (arrayList.size() > 8) {
            w70Var.r(frameLayout, y5.n(-1, 44));
            w70Var.k();
        }
        ...
        if (g4Var != null) {
            ...
            if (l5Var != null && v3Var != null) {
                ...
                while (i12 < size) {
                    ...
                    if (!h4Var.f46147g0.contains(Long.valueOf(savedStarGift.gift.f18521id))) {
                ...
                if (!l5Var.f47647i && l5Var.f47648j) {
                    if (z11) {
    ...
    public static void V(h4 h4Var, TL_stars.TL_starGiftUnique tL_starGiftUnique, long j3, yh.b3 b3Var, nf.e eVar) {
        eVar.d();
        t5.x(h4Var.currentAccount, b3Var.f47224a).h(b3Var.f47225b, tL_starGiftUnique, j3, null, true, new org.telegram.tgnet.e(h4Var, eVar, tL_starGiftUnique, 6));
    }

    public static void W(h4 h4Var, g4 g4Var, Context context) {
        v3 v3Var = g4Var.f46132c;
        if (v3Var.f46427g.isEmpty()) {
            return;
        }
        w70 w70Var = new w70(h4Var.container, h4Var.resourcesProvider, h4Var.f46143c0, false, true, false);
        w70Var.f29925t = false;
        w70Var.Y = true;
        w70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        w70Var.R = true;
        w70Var.f29919p = new ii.h(w70Var, 6);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(v3Var.f46427g);
        Collections.sort(arrayList, new a4(g4Var, 0));
        t61 t61Var = new t61(context, h4Var.currentAccount, 0, false, new w3(strArr, g4Var, arrayList, 1), new x3(g4Var, w70Var, 1), null, h4Var.resourcesProvider);
        t61Var.Y2.f26042r = false;
        FrameLayout frameLayout = new FrameLayout(context);
        ImageView imageView = new ImageView(context);
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        ...
        buVar.setBackground(null);
        frameLayout.addView(buVar, y5.d(-1, -2.0f, 19, 43.0f, 0.0f, 8.0f, 0.0f));
        buVar.addTextChangedListener(new qn(strArr, t61Var, false, 12));
        if (arrayList.size() > 8) {
            w70Var.r(frameLayout, y5.n(-1, 44));
            w70Var.k();
        }
    ...
    public final void Z() {
        ...
        while (true) {
            ...
            if ((childAt instanceof t00) && (S = RecyclerView.S(childAt) - 1) >= 0 && (G = this.f46149i0.G(S)) != null) {
                if (G.d < 10) {
                    z10 = true;
                } else {
                    z11 = true;
