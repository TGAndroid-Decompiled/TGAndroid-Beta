...
public class h4 extends org.telegram.ui.ActionBar.o2 implements le.d {
    ...
    public fh.c L;
    public ah.c M;
    public final le.b f45922a;
    public final long f45923b;
    public final String f45924c;
    public final u3 d;
    public Utilities.Callback e;
    public org.telegram.ui.ActionBar.h2 f45925f;
    public View h;
    public d3 f45926n;
    public FrameLayout f45927r;
    public FrameLayout f45928s;
    public TextView v;
    public m3 f45929w;
    public boolean f45930x;
    public HorizontalScrollView f45931y;

    public h4(long j3, String str, long j10, f6 f6Var) {
        super(null);
        this.f45922a = new le.b(0, this, qr.h, 380L, false);
        this.K = true;
        this.f45923b = j3;
        this.f45924c = str;
    ...
    public static void V(h4 h4Var, Context context) {
        ...
        n70Var.R = true;
        n70Var.f26382p = new ii.h(n70Var, 3);
        String[] strArr = {""};
    ...
    public static void W(h4 h4Var, Context context) {
        u3 u3Var = h4Var.d;
        if (!h4Var.K || u3Var.f46174f.isEmpty()) {
            return;
        }
        ...
        n70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        n70Var.R = true;
        n70Var.f26382p = new ii.h(n70Var, 5);
        String[] strArr = {""};
    ...
    public static void X(h4 h4Var, Context context) {
        u3 u3Var = h4Var.d;
        if (!h4Var.K || u3Var.f46175g.isEmpty()) {
            return;
        }
        ...
        n70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        n70Var.R = true;
        n70Var.f26382p = new ii.h(n70Var, 4);
        String[] strArr = {""};
    ...
    public static void Y(h4 h4Var, j51 j51Var) {
        ...
        if (obj instanceof TL_stars.TL_starGiftUnique) {
            ...
            yh.a4 a4Var = new yh.a4(h4Var.getParentActivity(), h4Var.currentAccount, h4Var.f45923b, h4Var.resourceProvider, null);
    ...
    public final void D(int i10, float f7, float f10, le.e eVar) {
        if (i10 == 0) {
            this.f45928s.setTranslationY((-AndroidUtilities.dp(52.0f)) * f7);
            y10.d(this.f45927r, f7);
        }
    }
    ...
    public final View createView(final Context context) {
        ...
        this.actionBar.setSubtitleColor(getThemedColor(j6.f19264z6));
        ...
        this.f45926n.j(new kb0(this, 17));
        this.f45926n.setPadding(0, AndroidUtilities.dp(45.0f), 0, AndroidUtilities.dp(101.0f));
        this.f45926n.setClipToPadding(false);
        y8Var.addView(this.f45926n, x5.d(-1, -1.0f, 119, 7.33f, 0.0f, 7.33f, -45.0f));
        y8Var.addView(this.actionBar);
        View.OnClickListener onClickListener = new View.OnClickListener(this) {
            public final h4 f46268b;
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        ...
                        return;
                    default:
                        u3 u3Var2 = this.f46268b.d;
                        u3Var2.f46178k.clear();
                        u3Var2.f46177j.clear();
                        u3Var2.f46179l.clear();
                        u3Var2.h();
                        return;
                }
            }
        ...
        this.f45929w = frameLayout;
        this.f45930x = false;
        frameLayout.setAlpha(0.0f);
        this.f45929w.setScaleX(0.95f);
        this.f45929w.setScaleY(0.95f);
        this.f45929w.setVisibility(8);
        y8Var.addView(this.f45929w, x5.d(-1, -1.0f, 119, 0.0f, 0.0f, 0.0f, -45.0f));
        LinearLayout linearLayout = new LinearLayout(context);
        this.E = linearLayout;
        linearLayout.setPadding(AndroidUtilities.dp(11.0f), 0, AndroidUtilities.dp(11.0f), 0);
        this.E.setOrientation(0);
        HorizontalScrollView horizontalScrollView = new HorizontalScrollView(context);
        this.f45931y = horizontalScrollView;
        horizontalScrollView.setHorizontalScrollBarEnabled(false);
        this.f45931y.addView(this.E);
        this.f45931y.setBackgroundColor(v);
        this.f45931y.setClipChildren(false);
        y8Var.addView(this.f45931y, x5.e(-1, 47, 55));
        ...
        npVar.b(j6.f18936h7, j6.f18972j7, j6.f18992k7);
        ...
        wl.n(j6.f18970j5, this.resourceProvider, textView3, 1, 14.0f);
        ...
        this.f45928s = frameLayout2;
        frameLayout2.setPadding(AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f));
        FrameLayout frameLayout3 = this.f45928s;
        ...
        this.f45928s.setOnClickListener(new View.OnClickListener(this) {
            public final h4 f45825b;
            ...
            public final void onClick(View view2) {
                switch (r3) {
                    case 0:
                        u3 u3Var = this.f45825b.d;
                        if (u3Var != null) {
                            boolean z10 = !u3Var.f46185r;
                            u3Var.f46185r = z10;
                            npVar.a(z10, true);
                            u3Var.h();
                            return;
                        ...
                        return;
                    default:
                        final h4 h4Var = this.f45825b;
                        u3 u3Var2 = h4Var.d;
                        if (h4Var.K) {
                            n70 H = n70.H(h4Var, h4Var.F);
                            H.c(R.drawable.menu_sort_value, LocaleController.getString(t3.BY_PRICE.f46159a), new w2(h4Var, 3), false);
                            H.c(R.drawable.menu_sort_date, LocaleController.getString(t3.BY_DATE.f46159a), new w2(h4Var, 4), false);
                            H.c(R.drawable.menu_sort_number, LocaleController.getString(t3.BY_NUMBER.f46159a), new w2(h4Var, 5), false);
                            H.k();
                            ...
                            }, LocaleController.getString(R.string.GiftResaleFilterForStarsOnly), u3Var2.f46185r);
                            H.f26388t = false;
                            H.Y = true;
        ...
        this.f45928s.addView(linearLayout2, x5.c(-1.0f, -2));
        z5.b(this.f45928s, 0.04f, 1.5f);
        y8Var.addView(this.f45928s, x5.d(-2, 52.0f, 81, 0.0f, 0.0f, 0.0f, AndroidUtilities.navigationBarHeight / AndroidUtilities.density));
        v5 y3 = v5.y(this.currentAccount, true);
        if (y3.e && !y3.s().k()) {
            this.f45928s.setVisibility(8);
        }
        FrameLayout frameLayout4 = new FrameLayout(context);
        this.f45927r = frameLayout4;
        ...
        FrameLayout frameLayout5 = this.f45927r;
        ...
        y8Var.addView(this.f45927r, x5.d(-2, 60.0f, 81, 0.0f, 0.0f, 0.0f, AndroidUtilities.navigationBarHeight / AndroidUtilities.density));
        ...
        this.f45927r.setOnClickListener(new View.OnClickListener(this) {
            public final h4 f46268b;
        ...
        this.f45927r.addView(this.v, x5.c(-1.0f, -2));
        this.f45927r.setVisibility(8);
        z5.b(this.f45927r, 0.05f, 1.5f);
        l3 l3Var = new l3(context, this.resourceProvider);
        this.F = l3Var;
        l3Var.setSorting(this.d.f46183p);
        ...
        this.G.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view2) {
                switch (r3) {
                    case 0:
                        h4.W(this.f46148b, context);
                        return;
                    case 1:
                        h4.X(this.f46148b, context);
                        return;
                    default:
                        h4.V(this.f46148b, context);
                        return;
                }
            }
        });
    ...
    public final void d0(boolean z10, boolean z11) {
        ...
        float f14 = 0.0f;
        if (z11) {
            this.f45931y.setVisibility(0);
            ViewPropertyAnimator animate = this.f45931y.animate();
            if (z10) {
                f11 = 0.0f;
            } else {
            ...
            ViewPropertyAnimator animate3 = this.f45926n.animate();
            if (!z10) {
        ...
        HorizontalScrollView horizontalScrollView = this.f45931y;
        if (!z10) {
            i10 = 8;
        }
        horizontalScrollView.setVisibility(i10);
        HorizontalScrollView horizontalScrollView2 = this.f45931y;
        if (z10) {
            f7 = 0.0f;
        } else {
        ...
        HorizontalScrollView horizontalScrollView3 = this.f45931y;
        if (!z10) {
            f13 = 0.0f;
        }
    ...
    public final void e0(boolean z10) {
        ...
        u3 u3Var = this.d;
        int i10 = u3Var.e;
        HashSet hashSet = u3Var.f46179l;
        ArrayList arrayList = u3Var.h;
        HashSet hashSet2 = u3Var.f46178k;
        ArrayList arrayList2 = u3Var.f46175g;
        HashSet hashSet3 = u3Var.f46177j;
        ...
        l3 l3Var = this.F;
        if (l3Var != null) {
            l3Var.setSorting(u3Var.f46183p);
        }
        if (this.G != null) {
        ...
        int i12 = 0;
        while (true) {
            if (i12 >= this.f45926n.getChildCount()) {
                break;
            } else if (this.f45926n.getChildAt(i12) instanceof t00) {
                u3Var.g(false);
                break;
            } else {
                i12++;
        ...
        if ((u3Var.f46187t || u3Var.e > 0) && (!hashSet3.isEmpty() || !hashSet2.isEmpty() || !hashSet.isEmpty())) {
            z11 = true;
        }
        this.f45922a.a(z11, true);
    }
