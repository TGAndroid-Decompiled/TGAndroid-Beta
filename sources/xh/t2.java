...
public final class t2 extends View {
    public final Paint f46049a;
    public final Paint f46050b;
    public final Paint f46051c;
    public final RadialGradient[] d;
    public final Matrix e;
    public final org.telegram.ui.Components.d6 f46052f;
    public final RadialGradient h;
    public final Path f46053n;
    public int f46054r;
    public int f46055s;

    public t2(Context context) {
        super(context);
        this.f46049a = new Paint(1);
        this.f46050b = new Paint(1);
        Paint paint = new Paint(1);
        this.f46051c = paint;
        this.d = new RadialGradient[2];
        this.e = new Matrix();
        this.f46052f = new org.telegram.ui.Components.d6(1.0f, this, 0L, 420L, wr.h);
        this.h = new RadialGradient(0.0f, 0.0f, 100.0f, new int[]{0, -1, -1, 0}, new float[]{0.15f, 0.35f, 0.65f, 0.88f}, Shader.TileMode.CLAMP);
        this.f46053n = new Path();
        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_IN));
    }

    public final void a(int i10, int i11) {
        if (this.f46054r == i10 && this.f46055s == i11) {
            return;
        }
