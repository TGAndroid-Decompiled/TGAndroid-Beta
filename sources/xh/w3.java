...
public final class w3 implements Utilities.Callback2 {
    ...
    public final void run(Object obj, Object obj2) {
        ...
        String str2;
        int intValue3;
        int i10 = this.f46495a;
        String str3 = " ";
        ArrayList arrayList = this.d;
        g4 g4Var = this.f46497c;
        String[] strArr = this.f46496b;
        switch (i10) {
            case 0:
                ...
                boolean isEmpty = v3Var.f46476j.isEmpty();
                ...
                while (i11 < size) {
                    ...
                    boolean contains = v3Var.f46476j.contains(Long.valueOf(stargiftattributemodel.document.f18334id));
                    ...
                    if (TextUtils.isEmpty(lowerCase) || stargiftattributemodel.name.toLowerCase().startsWith(lowerCase) || stargiftattributemodel.name.toLowerCase().startsWith(translitSafe) || org.telegram.messenger.l0.v(" ", lowerCase, stargiftattributemodel.name.toLowerCase()) || org.telegram.messenger.l0.v(" ", translitSafe, stargiftattributemodel.name.toLowerCase())) {
                        Integer num = (Integer) v3Var.f46479m.get(Long.valueOf(stargiftattributemodel.document.f18334id));
                        if (num == null) {
                            intValue = 0;
                        } else {
            ...
            case 1:
                ...
                v3 v3Var2 = g4Var.f46179c;
                boolean isEmpty2 = v3Var2.f46477k.isEmpty();
                ...
                while (i13 < size2) {
                    ...
                    boolean contains2 = v3Var2.f46477k.contains(Integer.valueOf(stargiftattributebackdrop.backdrop_id));
                    ...
                    Integer num2 = (Integer) v3Var2.f46480n.get(Integer.valueOf(stargiftattributebackdrop.backdrop_id));
                    if (num2 == null) {
                        intValue2 = 0;
                    } else {
                    ...
                    J2.f29948l = lowerCase2;
                    J2.f29961z = intValue2;
            ...
            default:
                ...
                v3 v3Var3 = g4Var.f46179c;
                boolean isEmpty3 = v3Var3.f46478l.isEmpty();
                ...
                while (i15 < size3) {
                    ...
                    boolean contains3 = v3Var3.f46478l.contains(Long.valueOf(stargiftattributepattern.document.f18334id));
                    ...
                    if (!TextUtils.isEmpty(lowerCase3) && !stargiftattributepattern.name.toLowerCase().startsWith(lowerCase3) && !stargiftattributepattern.name.toLowerCase().startsWith(translitSafe3) && !org.telegram.messenger.l0.v(str3, lowerCase3, stargiftattributepattern.name.toLowerCase()) && !org.telegram.messenger.l0.v(str3, translitSafe3, stargiftattributepattern.name.toLowerCase())) {
                        ...
                        str2 = str3;
                        Integer num3 = (Integer) v3Var3.f46481o.get(Long.valueOf(stargiftattributepattern.document.f18334id));
                        if (num3 == null) {
                            intValue3 = 0;
                        } else {
                        ...
                        J3.f29948l = lowerCase3;
                        J3.f29961z = intValue3;
