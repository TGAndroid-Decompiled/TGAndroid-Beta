...
public final class w3 implements Utilities.Callback2 {
    ...
    public final void run(Object obj, Object obj2) {
        ...
        g4 g4Var = this.f46476c;
        String[] strArr = this.f46475b;
        switch (i10) {
            case 0:
                ...
                boolean isEmpty = v3Var.f46455j.isEmpty();
                ...
                while (i11 < size) {
                    ...
                    boolean contains = v3Var.f46455j.contains(Long.valueOf(stargiftattributemodel.document.f18341id));
                    ...
                    if (TextUtils.isEmpty(lowerCase) || stargiftattributemodel.name.toLowerCase().startsWith(lowerCase) || stargiftattributemodel.name.toLowerCase().startsWith(translitSafe) || org.telegram.messenger.f0.w(" ", lowerCase, stargiftattributemodel.name.toLowerCase()) || org.telegram.messenger.f0.w(" ", translitSafe, stargiftattributemodel.name.toLowerCase())) {
                        Integer num = (Integer) v3Var.f46458m.get(Long.valueOf(stargiftattributemodel.document.f18341id));
                        if (num == null) {
                            intValue = 0;
                        } else {
            ...
            case 1:
                ...
                v3 v3Var2 = g4Var.f46158c;
                boolean isEmpty2 = v3Var2.f46456k.isEmpty();
                ...
                while (i13 < size2) {
                    ...
                    boolean contains2 = v3Var2.f46456k.contains(Integer.valueOf(stargiftattributebackdrop.backdrop_id));
                    ...
                    Integer num2 = (Integer) v3Var2.f46459n.get(Integer.valueOf(stargiftattributebackdrop.backdrop_id));
                    if (num2 == null) {
                        intValue2 = 0;
                    } else {
                    ...
                    J2.f29895l = lowerCase2;
                    J2.f29908z = intValue2;
            ...
            default:
                ...
                v3 v3Var3 = g4Var.f46158c;
                boolean isEmpty3 = v3Var3.f46457l.isEmpty();
                ...
                while (i15 < size3) {
                    ...
                    boolean contains3 = v3Var3.f46457l.contains(Long.valueOf(stargiftattributepattern.document.f18341id));
                    ...
                    if (!TextUtils.isEmpty(lowerCase3) && !stargiftattributepattern.name.toLowerCase().startsWith(lowerCase3) && !stargiftattributepattern.name.toLowerCase().startsWith(translitSafe3) && !org.telegram.messenger.f0.w(str3, lowerCase3, stargiftattributepattern.name.toLowerCase()) && !org.telegram.messenger.f0.w(str3, translitSafe3, stargiftattributepattern.name.toLowerCase())) {
                        ...
                        str2 = str3;
                        Integer num3 = (Integer) v3Var3.f46460o.get(Long.valueOf(stargiftattributepattern.document.f18341id));
                        if (num3 == null) {
                            intValue3 = 0;
                        } else {
                        ...
                        J3.f29895l = lowerCase3;
                        J3.f29908z = intValue3;
