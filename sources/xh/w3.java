...
public final class w3 implements Utilities.Callback2 {
    ...
    public final void run(Object obj, Object obj2) {
        ...
        g4 g4Var = this.f46149c;
        String[] strArr = this.f46148b;
        switch (i10) {
            case 0:
                ...
                boolean isEmpty = v3Var.f46128j.isEmpty();
                ...
                while (i11 < size) {
                    ...
                    boolean contains = v3Var.f46128j.contains(Long.valueOf(stargiftattributemodel.document.f18089id));
                    ...
                    if (TextUtils.isEmpty(lowerCase) || stargiftattributemodel.name.toLowerCase().startsWith(lowerCase) || stargiftattributemodel.name.toLowerCase().startsWith(translitSafe) || org.telegram.messenger.z0.w(" ", lowerCase, stargiftattributemodel.name.toLowerCase()) || org.telegram.messenger.z0.w(" ", translitSafe, stargiftattributemodel.name.toLowerCase())) {
                        Integer num = (Integer) v3Var.f46131m.get(Long.valueOf(stargiftattributemodel.document.f18089id));
                        if (num == null) {
                            intValue = 0;
                        } else {
            ...
            default:
                ...
                v3 v3Var3 = g4Var.f45831c;
                boolean isEmpty3 = v3Var3.f46130l.isEmpty();
                ...
                while (i15 < size3) {
                    ...
                    boolean contains3 = v3Var3.f46130l.contains(Long.valueOf(stargiftattributepattern.document.f18089id));
                    boolean z12 = !contains3;
                    if (!TextUtils.isEmpty(lowerCase3) && !stargiftattributepattern.name.toLowerCase().startsWith(lowerCase3) && !stargiftattributepattern.name.toLowerCase().startsWith(translitSafe3) && !org.telegram.messenger.z0.w(str3, lowerCase3, stargiftattributepattern.name.toLowerCase()) && !org.telegram.messenger.z0.w(str3, translitSafe3, stargiftattributepattern.name.toLowerCase())) {
                        str2 = str3;
                    } else {
                        str2 = str3;
                        Integer num3 = (Integer) v3Var3.f46133o.get(Long.valueOf(stargiftattributepattern.document.f18089id));
                        if (num3 == null) {
                            intValue3 = 0;
                        } else {
