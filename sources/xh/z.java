...
public final class z extends i1 {
    ...
    public final RectF f46262n0;
    public final Path f46263o0;
    public final c0 f46264p0;

    public z(c0 c0Var, Context context, int i10, f6 f6Var) {
        super(context, i10, f6Var);
        this.f46264p0 = c0Var;
        this.m0 = new RectF();
        this.f46262n0 = new RectF();
        this.f46263o0 = new Path();
    }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        c0 c0Var = this.f46264p0;
        x xVar = c0Var.f45842a0;
        boolean drawChild = super.drawChild(canvas, view, j3);
        FrameLayout frameLayout = this.d;
        if (view == frameLayout) {
            FrameLayout frameLayout2 = xVar.f47993b;
            w wVar = c0Var.Y;
            RectF rectF = this.m0;
            if (hh.k.c(frameLayout2, wVar, rectF)) {
                RectF rectF2 = this.f46262n0;
