...
public final class z extends j1 {
    ...
    public final RectF f46483n0;
    public final Path f46484o0;
    public final c0 f46485p0;

    public z(c0 c0Var, Context context, int i10, d6 d6Var) {
        super(context, i10, d6Var);
        this.f46485p0 = c0Var;
        this.m0 = new RectF();
        this.f46483n0 = new RectF();
        this.f46484o0 = new Path();
    }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        c0 c0Var = this.f46485p0;
        x xVar = c0Var.f46081a0;
        boolean drawChild = super.drawChild(canvas, view, j3);
        FrameLayout frameLayout = this.d;
        if (view == frameLayout) {
            FrameLayout frameLayout2 = xVar.f48070b;
            w wVar = c0Var.Y;
            RectF rectF = this.m0;
            if (hh.k.c(frameLayout2, wVar, rectF)) {
                RectF rectF2 = this.f46483n0;
