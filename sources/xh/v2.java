...
public final class v2 implements Utilities.Callback2 {
    ...
    public final void run(Object obj, Object obj2) {
        ...
        String[] strArr = this.f46422c;
        i4 i4Var = this.f46421b;
        switch (i10) {
            case 0:
                ...
                v3 v3Var = i4Var.d;
                boolean isEmpty = v3Var.f46431l.isEmpty();
                ...
                while (i11 < size) {
                    ...
                    boolean contains = v3Var.f46431l.contains(Long.valueOf(stargiftattributepattern.document.f18302id));
                    ...
                    if (TextUtils.isEmpty(lowerCase) || stargiftattributepattern.name.toLowerCase().startsWith(lowerCase) || stargiftattributepattern.name.toLowerCase().startsWith(translitSafe) || wh.u(" ", lowerCase, stargiftattributepattern.name.toLowerCase()) || wh.u(" ", translitSafe, stargiftattributepattern.name.toLowerCase())) {
                        Integer num = (Integer) v3Var.f46434o.get(Long.valueOf(stargiftattributepattern.document.f18302id));
                        if (num == null) {
                            intValue = 0;
                        } else {
            ...
            default:
                ...
                v3 v3Var3 = i4Var.d;
                boolean isEmpty3 = v3Var3.f46429j.isEmpty();
                ...
                while (i15 < size3) {
                    ...
                    boolean contains3 = v3Var3.f46429j.contains(Long.valueOf(stargiftattributemodel.document.f18302id));
                    boolean z12 = !contains3;
                    if (!TextUtils.isEmpty(lowerCase3) && !stargiftattributemodel.name.toLowerCase().startsWith(lowerCase3) && !stargiftattributemodel.name.toLowerCase().startsWith(translitSafe3) && !wh.u(str3, lowerCase3, stargiftattributemodel.name.toLowerCase()) && !wh.u(str3, translitSafe3, stargiftattributemodel.name.toLowerCase())) {
                        str2 = str3;
                    } else {
                        str2 = str3;
                        Integer num3 = (Integer) v3Var3.f46432m.get(Long.valueOf(stargiftattributemodel.document.f18302id));
                        if (num3 == null) {
                            intValue3 = 0;
                        } else {
