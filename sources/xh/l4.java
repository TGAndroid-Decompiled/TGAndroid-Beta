...
public final class l4 extends za implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final nz f45974a0;
    public final FrameLayout f45975b0;
    public final ci.d f45976c0;
    public n70 f45977d0;
    public w51 f45978e0;
    public i0.b f45979f0;
    ...
    public final void S() {
        this.d.setPadding(AndroidUtilities.dp(9.0f) + this.f45979f0.f10590a + this.backgroundPaddingLeft, 0, AndroidUtilities.dp(9.0f) + this.f45979f0.f10592c + this.backgroundPaddingLeft, this.f45979f0.d);
        i0.b bVar = this.f45979f0;
        int i10 = bVar.f10590a;
        int i11 = this.backgroundPaddingLeft;
        this.f45975b0.setPadding(i10 + i11, 0, bVar.f10592c + i11, bVar.d);
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        w51 w51Var;
        if (i10 == NotificationCenter.starUserGiftsLoaded && (w51Var = this.f45978e0) != null) {
            w51Var.N(true);
            if (T()) {
                this.Y.a();
            }
    ...
    public final r0.l1 onApplyWindowInsetsToRoot(View view, r0.l1 l1Var) {
        this.f45979f0 = AndroidUtilities.getDefaultWindowInsets(l1Var, false);
        S();
