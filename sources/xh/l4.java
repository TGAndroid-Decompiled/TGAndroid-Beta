...
public final class l4 extends za implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final nz f46001a0;
    public final FrameLayout f46002b0;
    public final ci.d f46003c0;
    public n70 f46004d0;
    public x51 f46005e0;
    public i0.b f46006f0;
    ...
    public final void S() {
        this.d.setPadding(AndroidUtilities.dp(9.0f) + this.f46006f0.f10591a + this.backgroundPaddingLeft, 0, AndroidUtilities.dp(9.0f) + this.f46006f0.f10593c + this.backgroundPaddingLeft, this.f46006f0.d);
        i0.b bVar = this.f46006f0;
        int i10 = bVar.f10591a;
        int i11 = this.backgroundPaddingLeft;
        this.f46002b0.setPadding(i10 + i11, 0, bVar.f10593c + i11, bVar.d);
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        x51 x51Var;
        if (i10 == NotificationCenter.starUserGiftsLoaded && (x51Var = this.f46005e0) != null) {
            x51Var.N(true);
            if (T()) {
                this.Y.a();
            }
    ...
    public final r0.l1 onApplyWindowInsetsToRoot(View view, r0.l1 l1Var) {
        this.f46006f0 = AndroidUtilities.getDefaultWindowInsets(l1Var, false);
        S();
