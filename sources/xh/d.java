...
public final class d extends FrameLayout {
    public final ci.d f45817a;
    public final n6 f45818b;
    public final n6 f45819c;
    public final GiftAuctionController.Auction d;
    public final Paint e;
    public final yf.n f45820f;
    public final oq h;
    public final oq[] f45821n;

    public d(Context context, GiftAuctionController.Auction auction) {
        super(context);
        Paint paint = new Paint(1);
        this.e = paint;
        this.f45820f = new yf.n(new r5.e(this, 13));
        this.h = new oq(R.drawable.filled_gift_sell_24, 0);
        this.f45821n = new oq[1];
        this.d = auction;
    ...
    public final void a(long j3, boolean z10) {
        ...
        this.f45817a.g(spannableStringBuilder, z10, true);
    }
    ...
    public final void b(boolean z10) {
        ...
        if (tL_starGiftAuctionState != null) {
            this.f45818b.c(LocaleController.formatString(R.string.Gift2ActiveAuctionsActiveRound, LocaleController.formatNumber(tL_starGiftAuctionState.current_round, ','), LocaleController.formatNumber(auction.auctionStateActive.total_rounds, ',')), z10, true);
        }
        String k10 = hg.c.k(auction.auctionUserState.bid_amount, ',', new StringBuilder("⭐️"));
        boolean isOutbid = auction.getBidStatus().isOutbid();
        oq[] oqVarArr = this.f45821n;
        n6 n6Var = this.f45819c;
        if (isOutbid) {
            ...
            n6Var.setTextColor(i6.w0(null, i6.f19071q7, false));
            return;
        }
