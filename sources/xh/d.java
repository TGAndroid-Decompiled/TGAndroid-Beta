...
public final class d extends FrameLayout {
    public final ci.d f46106a;
    public final p6 f46107b;
    public final p6 f46108c;
    public final GiftAuctionController.Auction d;
    public final Paint e;
    public final yf.n f46109f;
    public final pq h;
    public final pq[] f46110n;

    public d(Context context, GiftAuctionController.Auction auction) {
        super(context);
        Paint paint = new Paint(1);
        this.e = paint;
        this.f46109f = new yf.n(new r5.d(this, 14));
        this.h = new pq(R.drawable.filled_gift_sell_24, 0);
        this.f46110n = new pq[1];
        this.d = auction;
    ...
    public final void a(long j3, boolean z10) {
        ...
        this.f46106a.g(spannableStringBuilder, z10, true);
    }
    ...
    public final void b(boolean z10) {
        ...
        if (tL_starGiftAuctionState != null) {
            this.f46107b.c(LocaleController.formatString(R.string.Gift2ActiveAuctionsActiveRound, LocaleController.formatNumber(tL_starGiftAuctionState.current_round, ','), LocaleController.formatNumber(auction.auctionStateActive.total_rounds, ',')), z10, true);
        }
        ...
        pq[] pqVarArr = this.f46110n;
        p6 p6Var = this.f46108c;
        if (isOutbid) {
