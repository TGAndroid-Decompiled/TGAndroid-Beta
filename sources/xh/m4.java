...
public final class m4 extends bb implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final oz f46279a0;
    public final FrameLayout f46280b0;
    public final ci.d f46281c0;
    public y70 f46282d0;
    public j61 f46283e0;
    public i0.b f46284f0;
    ...
    public final void S() {
        this.d.setPadding(AndroidUtilities.dp(9.0f) + this.f46284f0.f10576a + this.backgroundPaddingLeft, 0, AndroidUtilities.dp(9.0f) + this.f46284f0.f10578c + this.backgroundPaddingLeft, this.f46284f0.d);
        i0.b bVar = this.f46284f0;
        int i10 = bVar.f10576a;
        int i11 = this.backgroundPaddingLeft;
        this.f46280b0.setPadding(i10 + i11, 0, bVar.f10578c + i11, bVar.d);
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        j61 j61Var;
        if (i10 == NotificationCenter.starUserGiftsLoaded && (j61Var = this.f46283e0) != null) {
            j61Var.N(true);
            if (T()) {
                this.Y.a();
            }
    ...
    public final r0.l1 onApplyWindowInsetsToRoot(View view, r0.l1 l1Var) {
        this.f46284f0 = AndroidUtilities.getDefaultWindowInsets(l1Var, false);
        S();
