...
public final class n2 extends yh.y3 {
    public final int f45983r1;
    public final Object f45984s1;
    ...
    public int getBottomInset() {
        switch (this.f45983r1) {
            case 3:
                return ((yh.y3) this.f45984s1).getBottomInset();
            default:
    ...
    public xc getBulletinFactory() {
        switch (this.f45983r1) {
            case 0:
                return xc.a0(((o2) this.f45984s1).f45999a.f46068a);
            case 1:
                return xc.a0(((o2) this.f45984s1).f45999a.f46068a);
            case 2:
                return xc.a0(((o2) this.f45984s1).f45999a.f46068a);
