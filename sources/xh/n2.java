...
public final class n2 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final ci.d H;
    public boolean I;
    public final or0 f46062a;
    public final int f46063b;
    public final f6 f46064c;
    public boolean d;
    public n5 e;
    public final i2 f46065f;
    public ah.o h;
    public boolean f46066n;
    public int f46067r;
    public final FrameLayout f46068s;
    public final LinearLayout v;
    public final TextView f46069w;
    public final TextView f46070x;
    public final FrameLayout f46071y;

    public n2(or0 or0Var, int i10, f6 f6Var) {
        super(or0Var.getContext());
        this.f46067r = AndroidUtilities.displaySize.y;
        ...
        View view = this.f46068s;
        if (view != null) {
            removeView(view);
        }
        View view2 = this.f46071y;
        if (view2 != null) {
            removeView(view2);
        }
        if (or0Var.d == this.e) {
            ...
            this.H = null;
            this.E = null;
            this.f46068s = new FrameLayout(getContext());
            LinearLayout linearLayout = new LinearLayout(getContext());
            this.v = linearLayout;
            linearLayout.setOrientation(1);
            this.f46068s.addView(this.v, x5.e(-2, -2, 17));
            ...
            this.f46069w = textView;
            textView.setTextSize(1, 17.0f);
            this.f46069w.setTypeface(AndroidUtilities.bold());
            this.f46069w.setTextColor(j6.v0(j6.G6, f6Var));
            this.f46069w.setText(LocaleController.getString(R.string.ProfileGiftsNotFoundTitle));
            this.v.addView(this.f46069w, x5.t(-2, -2, 1, 0, 12, 0, 0));
            TextView textView2 = new TextView(getContext());
            this.f46070x = textView2;
            textView2.setTextSize(1, 14.0f);
            TextView textView3 = this.f46070x;
            int i11 = j6.Oh;
            textView3.setTextColor(j6.v0(i11, f6Var));
            this.f46070x.setText(LocaleController.getString(R.string.ProfileGiftsNotFoundButton));
            this.f46070x.setOnClickListener(new View.OnClickListener(this) {
                public final n2 f45886b;
                ...
                public final void onClick(View view3) {
                    switch (r2) {
                        case 0:
                            n5 n5Var = this.f45886b.e;
                            if (n5Var != null) {
                                if (!n5Var.e || n5Var.f47522g != 783) {
                                    n5Var.f47522g = 783;
                                    n5Var.e = true;
                                    n5Var.i(true);
                                    return;
                            ...
                            return;
                        default:
                            this.f45886b.f46062a.a();
                            return;
                    }
                }
            });
            this.f46070x.setPadding(AndroidUtilities.dp(10.0f), AndroidUtilities.dp(4.0f), AndroidUtilities.dp(10.0f), AndroidUtilities.dp(4.0f));
            this.f46070x.setBackground(j6.Y(j6.l1(0.1f, j6.v0(i11, f6Var)), 4, 4));
            z5.a(this.f46070x);
            this.v.addView(this.f46070x, x5.t(-2, -2, 1, 0, 8, 0, 0));
            addView(this.f46068s, x5.e(-1, -1, 119));
            i2Var.setEmptyView(this.f46068s);
            return;
        }
        this.f46068s = null;
        this.f46069w = null;
        this.f46070x = null;
        this.v = null;
        this.f46071y = new FrameLayout(getContext());
        LinearLayout linearLayout2 = new LinearLayout(getContext());
        this.E = linearLayout2;
        linearLayout2.setOrientation(1);
        this.f46071y.addView(this.E, x5.e(-2, -2, 17));
        ...
        this.G.setTextColor(j6.v0(j6.f19245y6, f6Var));
        ...
        addView(this.f46071y, x5.d(-1, -1.0f, 119, 0.0f, -12.0f, 0.0f, 0.0f));
        i2Var.setEmptyView(this.f46071y);
    ...
    public final void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f46063b).addObserver(this, NotificationCenter.starUserGiftsLoaded);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f46063b).removeObserver(this, NotificationCenter.starUserGiftsLoaded);
    }

    @Override
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(i10, i11);
        setVisibleHeight(this.f46067r);
    }
    ...
    public void setVisibleHeight(int i10) {
        ...
        FrameLayout frameLayout = this.f46068s;
        if (frameLayout != null) {
            frameLayout.setTranslationY((-(getMeasuredHeight() - this.f46067r)) / 2.0f);
        }
        ...
        FrameLayout frameLayout2 = this.f46071y;
        if (frameLayout2 != null) {
            frameLayout2.setTranslationY((-(getMeasuredHeight() - this.f46067r)) / 2.0f);
        }
    }
}
