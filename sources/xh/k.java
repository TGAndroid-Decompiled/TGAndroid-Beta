...
public final class k extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    public final w9 f46227a;
    public final p6 f46228b;
    public final p6 f46229c;
    public final p6 d;
    public final qq[] e;
    ...
    public final void c(TLRPC.User user) {
        ...
        h9Var.r(user);
        w9 w9Var = this.f46227a;
        w9Var.e(user, h9Var);
        w9Var.setRoundRadius(AndroidUtilities.dp(16.0f));
        this.f46229c.setText(UserObject.getUserName(user));
    }

    @Override
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        this.f46228b.invalidate();
    }
