...
public final class k extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    public final w9 f46229a;
    public final p6 f46230b;
    public final p6 f46231c;
    public final p6 d;
    public final pq[] e;
    ...
    public k(Context context, d6 d6Var) {
        ...
        this.d = p6Var2;
        p6Var2.setTextColor(h6.v0(h6.f19443y6, d6Var));
    ...
    public final void c(TLRPC.User user) {
        ...
        h9Var.r(user);
        w9 w9Var = this.f46229a;
        w9Var.e(user, h9Var);
        w9Var.setRoundRadius(AndroidUtilities.dp(16.0f));
        this.f46231c.setText(UserObject.getUserName(user));
    }

    @Override
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        this.f46230b.invalidate();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f46232f) {
            canvas.drawLine(AndroidUtilities.dp(112.0f), getMeasuredHeight() - 1, getMeasuredWidth() - AndroidUtilities.dp(16.0f), getMeasuredHeight(), h6.f19181k0);
        }
    }
