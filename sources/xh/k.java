...
public final class k extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    public final w9 f46201a;
    public final p6 f46202b;
    public final p6 f46203c;
    public final p6 d;
    public final oq[] e;
    ...
    public k(Context context, e6 e6Var) {
        ...
        this.d = p6Var2;
        p6Var2.setTextColor(j6.v0(j6.f19445y6, e6Var));
    ...
    public final void c(TLRPC.User user) {
        ...
        h9Var.r(user);
        w9 w9Var = this.f46201a;
        w9Var.e(user, h9Var);
        w9Var.setRoundRadius(AndroidUtilities.dp(16.0f));
        this.f46203c.setText(UserObject.getUserName(user));
    }

    @Override
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        this.f46202b.invalidate();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f46204f) {
            canvas.drawLine(AndroidUtilities.dp(112.0f), getMeasuredHeight() - 1, getMeasuredWidth() - AndroidUtilities.dp(16.0f), getMeasuredHeight(), j6.f19184k0);
        }
    }
