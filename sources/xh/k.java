...
public final class k extends AnimatorListenerAdapter {
    ...
    public final f2.j f50666b;
    public final ViewPropertyAnimator f50667c;
    public final View d;
    public final n f50668e;

    public k(n nVar, f2.j jVar, ViewPropertyAnimator viewPropertyAnimator, View view, int i10) {
        this.f50665a = i10;
        this.f50668e = nVar;
        this.f50666b = jVar;
        this.f50667c = viewPropertyAnimator;
        this.d = view;
    }
    ...
    public final void onAnimationEnd(Animator animator) {
        switch (this.f50665a) {
            ...
            default:
                ...
                n nVar2 = this.f50668e;
                ArrayList arrayList2 = nVar2.B;
                f2.j jVar2 = this.f50666b;
    ...
    public final void onAnimationStart(Animator animator) {
        switch (this.f50665a) {
            case 0:
                m1 m1Var = this.f50666b.f5811a;
                this.f50668e.getClass();
                return;
            default:
                m1 m1Var2 = this.f50666b.f5812b;
                this.f50668e.getClass();
                return;
        }
    }
