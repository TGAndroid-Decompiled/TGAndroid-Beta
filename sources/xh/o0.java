...
public final class o0 implements Runnable {
    ...
    public final KeyEvent.Callback f46320c;
    ...
    public final void run() {
        ...
        Object obj2 = this.d;
        KeyEvent.Callback callback = this.f46320c;
        switch (i10) {
            case 0:
                r1 r1Var = (r1) callback;
                Context context = (Context) obj2;
                TL_stars.StarGift starGift = (TL_stars.StarGift) tLObject;
                long j3 = r1Var.f46370c0;
                m0 m0Var = new m0(r1Var, (Utilities.Callback) obj, 2);
                boolean z12 = starGift.limited;
                if (z12 && (disallowedGiftsSettings2 = r1Var.f46369b0) != null && disallowedGiftsSettings2.disallow_limited_stargifts) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                if (z12 && (disallowedGiftsSettings = r1Var.f46369b0) != null && disallowedGiftsSettings.disallow_unique_stargifts) {
                    z11 = true;
                } else {
                    z11 = false;
                }
                new t0(r1Var, context, this.f46319b, starGift, j3, m0Var, z10, z11).show();
                return;
            default:
