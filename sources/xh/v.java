...
public final class v extends bb implements GiftAuctionController.OnAuctionUpdateListener {
    public static final zc[] f46100p0 = new zc[1];
    public static final nz0[] f46101q0 = new nz0[1];
    public final TL_stars.StarGift X;
    public final long Y;
    public final LinearLayout Z;
    public final FrameLayout f46102a0;
    public final TextView f46103b0;
    public final zc f46104c0;
    public final zc f46105d0;
    public final zc f46106e0;
    public final zc f46107f0;
    public final nz0 f46108g0;
    public final org.telegram.tgnet.e f46109h0;
    public final TableRow f46110i0;
    public final ci.d f46111j0;
    public final d90 f46112k0;
    public final d90 f46113l0;
    public GiftAuctionController.Auction m0;
    public final CharSequence f46114n0;
    public v51 f46115o0;
    ...
    public v(Context context, d6 d6Var, long j3, TL_stars.StarGift starGift, Runnable runnable) {
        ...
        frameLayout.addView(j1Var, x5.d(130, 130.0f, 17, 0.0f, 18.0f, 0.0f, 14.0f));
        ...
        c10.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        new rg.x0(this.f46024b.getContext(), 40, (d6) null).show();
                        return;
                    default:
                        this.f46024b.T();
                        return;
        ...
        if (starGift.sticker != null) {
            ...
            this.f46114n0 = spannableStringBuilder;
        } else {
            this.f46114n0 = "";
        }
        ...
        if (auction2 != null && auction2.previewAttributes != null) {
            ...
            this.f46102a0.addView(tVar, 0, x5.e(-1, 288, 48));
            TextView textView2 = new TextView(context);
            this.f46103b0 = textView2;
            ...
            TextView f7 = org.telegram.ui.Cells.q3.f(this.f46102a0, textView2, x5.d(-2, 26.0f, 81, 16.0f, 0.0f, 16.0f, 77.0f), context);
            f7.setTypeface(AndroidUtilities.bold());
            f7.setTextSize(1, 21.0f);
            f7.setText(str2);
            f7.setGravity(17);
            f7.setTextColor(-1);
            TextView f10 = org.telegram.ui.Cells.q3.f(this.f46102a0, f7, x5.d(-1, -2.0f, 87, 16.0f, 0.0f, 16.0f, 40.0f), context);
            ...
            z5.b(f10, 0.02f, 1.5f);
            this.f46102a0.addView(f10, x5.d(-1, -2.0f, 87, 16.0f, 0.0f, 16.0f, 12.0f));
            j1Var.setVisibility(8);
            textView.setVisibility(8);
            this.f46112k0.setVisibility(8);
            d90 d90Var3 = new d90(context, d6Var);
            d90Var3.setGravity(17);
            d90Var3.setTextSize(1, 16.0f);
            int i21 = h6.J6;
            d90Var3.setTextColor(h6.v0(i21, d6Var));
            d90Var3.setLinkTextColor(h6.v0(i21, d6Var));
        ...
        this.Z.addView(this.f46113l0, x5.k(16.0f, 0.0f, 14.0f, 18.0f, -1, -2));
        V(false);
    }
    ...
    public static void U(Context context, TL_stars.StarGift starGift, d6 d6Var) {
        ...
        if (context != null && starGift != null) {
            ...
            nw0Var.f35615a.l(LocaleController.formatPluralString("GiftAuctionInfo1Header", i11, Integer.valueOf(i11)), false);
            int i12 = starGift.gifts_per_round;
            nw0Var.f35616b.setText(LocaleController.formatPluralString("GiftAuctionInfo1Text", i12, Integer.valueOf(i12)));
            ...
            nw0Var2.f35615a.l(LocaleController.getString(R.string.GiftAuctionInfo2Header), false);
            nw0Var2.f35616b.setText(LocaleController.formatPluralString("GiftAuctionInfo2Text", starGift.gifts_per_round, new Object[0]));
            ...
            nw0Var3.f35615a.l(LocaleController.getString(R.string.GiftAuctionInfo3Header), false);
            nw0Var3.f35616b.setText(LocaleController.getString(R.string.GiftAuctionInfo3Text));
    ...
    public final void T() {
        ...
        if (auction != null && (tL_starGiftAuctionStateFinished = auction.auctionStateFinished) != null && auction.gift.title != null) {
            this.f46109h0.run(this.f46106e0, LocaleController.formatString(R.string.Gift2AveragePriceHint, Long.valueOf(tL_starGiftAuctionStateFinished.average_price), this.m0.gift.title));
        }
    }
