...
public final class v extends bb implements GiftAuctionController.OnAuctionUpdateListener {
    public static final zc[] f46427p0 = new zc[1];
    public static final zz0[] f46428q0 = new zz0[1];
    public final TL_stars.StarGift X;
    public final long Y;
    public final LinearLayout Z;
    public final FrameLayout f46429a0;
    public final TextView f46430b0;
    public final zc f46431c0;
    public final zc f46432d0;
    public final zc f46433e0;
    public final zc f46434f0;
    public final zz0 f46435g0;
    public final org.telegram.tgnet.e f46436h0;
    public final TableRow f46437i0;
    public final ci.d f46438j0;
    public final o90 f46439k0;
    public final o90 f46440l0;
    public GiftAuctionController.Auction m0;
    public final CharSequence f46441n0;
    public k61 f46442o0;
    ...
    public v(Context context, d6 d6Var, long j3, TL_stars.StarGift starGift, Runnable runnable) {
        ...
        c10.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        new rg.x0(this.f46351b.getContext(), 40, (d6) null).show();
                        return;
                    default:
                        this.f46351b.T();
                        return;
        ...
        this.f46433e0 = zcVarArr[0];
        zz0[] zz0VarArr = f46428q0;
        a01Var.c("", "", zz0VarArr, zcVarArr);
        this.f46434f0 = zcVarArr[0];
        this.f46435g0 = zz0VarArr[0];
        linearLayout.addView(frameLayout2, y5.k(16.0f, 16.0f, 14.0f, 18.0f, -1, -2));
        o90 o90Var2 = new o90(context, d6Var);
        this.f46440l0 = o90Var2;
        o90Var2.setGravity(17);
        o90Var2.setTextSize(1, 16.0f);
        o90Var2.setTextColor(h6.v0(i13, d6Var));
        o90Var2.setLinkTextColor(h6.v0(i13, d6Var));
        o90Var2.setOnClickListener(new xg.e(this, new boolean[1], d6Var, 4));
        a6.b(o90Var2, 0.02f, 1.5f);
        if (starGift.sticker != null) {
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder("*");
            spannableStringBuilder.setSpan(new z5(starGift.sticker, o90Var2.getPaint().getFontMetricsInt()), 0, spannableStringBuilder.length(), 33);
            this.f46441n0 = spannableStringBuilder;
        } else {
            this.f46441n0 = "";
        }
        ...
        xl0Var.setPadding(i16, 0, i16, AndroidUtilities.dp(64.0f));
        this.f46442o0.N(false);
        ...
        if (auction2 != null && auction2.previewAttributes != null) {
            ...
            this.f46429a0.addView(tVar, 0, y5.e(-1, 288, 48));
            TextView textView2 = new TextView(context);
            this.f46430b0 = textView2;
            ...
            TextView h = org.telegram.ui.Cells.c1.h(this.f46429a0, textView2, y5.d(-2, 26.0f, 81, 16.0f, 0.0f, 16.0f, 77.0f), context);
            h.setTypeface(AndroidUtilities.bold());
            h.setTextSize(1, 21.0f);
            h.setText(str2);
            h.setGravity(17);
            h.setTextColor(-1);
            TextView h10 = org.telegram.ui.Cells.c1.h(this.f46429a0, h, y5.d(-1, -2.0f, 87, 16.0f, 0.0f, 16.0f, 40.0f), context);
            ...
            a6.b(h10, 0.02f, 1.5f);
            this.f46429a0.addView(h10, y5.d(-1, -2.0f, 87, 16.0f, 0.0f, 16.0f, 12.0f));
            j1Var.setVisibility(8);
            textView.setVisibility(8);
            this.f46439k0.setVisibility(8);
            o90 o90Var3 = new o90(context, d6Var);
            o90Var3.setGravity(17);
            o90Var3.setTextSize(1, 16.0f);
            int i21 = h6.J6;
            o90Var3.setTextColor(h6.v0(i21, d6Var));
            o90Var3.setLinkTextColor(h6.v0(i21, d6Var));
            o90Var3.setOnClickListener(new xg.e(this, context, d6Var, 3));
            a6.b(o90Var3, 0.02f, 1.5f);
            this.Z.addView(o90Var3, y5.k(16.0f, 0.0f, 14.0f, 18.0f, -1, -2));
            ...
            for (int i22 = 0; i22 < 3; i22++) {
                ...
                if (stargiftattributemodel != null) {
                    ...
                    spannableStringBuilder2.setSpan(new z5(stargiftattributemodel.document, o90Var3.getPaint().getFontMetricsInt()), i22, i22 + 1, 33);
                }
            }
            o90Var3.setText(AndroidUtilities.replaceArrows(LocaleController.formatSpannable(R.string.Gift2AuctionVariants, spannableStringBuilder2, LocaleController.formatNumber(j11, ',')), true, AndroidUtilities.dp(2.6666667f), AndroidUtilities.dp(1.0f)));
        }
        this.Z.addView(this.f46440l0, y5.k(16.0f, 0.0f, 14.0f, 18.0f, -1, -2));
        V(false);
    }
    ...
    public static void U(Context context, TL_stars.StarGift starGift, d6 d6Var) {
        ...
        if (context != null && starGift != null) {
            ...
            lw0Var.f35421a.l(LocaleController.formatPluralString("GiftAuctionInfo1Header", i11, Integer.valueOf(i11)), false);
            int i12 = starGift.gifts_per_round;
            lw0Var.f35422b.setText(LocaleController.formatPluralString("GiftAuctionInfo1Text", i12, Integer.valueOf(i12)));
            ...
            lw0Var2.f35421a.l(LocaleController.getString(R.string.GiftAuctionInfo2Header), false);
            lw0Var2.f35422b.setText(LocaleController.formatPluralString("GiftAuctionInfo2Text", starGift.gifts_per_round, new Object[0]));
            ...
            lw0Var3.f35421a.l(LocaleController.getString(R.string.GiftAuctionInfo3Header), false);
            lw0Var3.f35422b.setText(LocaleController.getString(R.string.GiftAuctionInfo3Text));
    ...
    public final void T() {
        ...
        if (auction != null && (tL_starGiftAuctionStateFinished = auction.auctionStateFinished) != null && auction.gift.title != null) {
            this.f46436h0.run(this.f46433e0, LocaleController.formatString(R.string.Gift2AveragePriceHint, Long.valueOf(tL_starGiftAuctionStateFinished.average_price), this.m0.gift.title));
        }
    }
