...
public final class v extends za implements GiftAuctionController.OnAuctionUpdateListener {
    public static final xc[] f46189p0 = new xc[1];
    public static final pz0[] f46190q0 = new pz0[1];
    public final TL_stars.StarGift X;
    public final long Y;
    public final LinearLayout Z;
    public final FrameLayout f46191a0;
    public final TextView f46192b0;
    public final xc f46193c0;
    public final xc f46194d0;
    public final xc f46195e0;
    public final xc f46196f0;
    public final pz0 f46197g0;
    public final org.telegram.tgnet.e f46198h0;
    public final TableRow f46199i0;
    public final ci.d f46200j0;
    public final c90 f46201k0;
    public final c90 f46202l0;
    public GiftAuctionController.Auction m0;
    public final CharSequence f46203n0;
    public x51 f46204o0;
    ...
    public v(Context context, f6 f6Var, long j3, TL_stars.StarGift starGift, Runnable runnable) {
        ...
        c10.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        new rg.x0(this.f46099b.getContext(), 40, (f6) null).show();
                        return;
                    default:
                        this.f46099b.T();
                        return;
        ...
        if (starGift.sticker != null) {
            ...
            this.f46203n0 = spannableStringBuilder;
        } else {
            this.f46203n0 = "";
        }
        ...
        if (auction2 != null && auction2.previewAttributes != null) {
            ...
            this.f46191a0.addView(tVar, 0, x5.e(-1, 288, 48));
            TextView textView2 = new TextView(context);
            this.f46192b0 = textView2;
            ...
            TextView f7 = p6.f(this.f46191a0, textView2, x5.d(-2, 26.0f, 81, 16.0f, 0.0f, 16.0f, 77.0f), context);
            f7.setTypeface(AndroidUtilities.bold());
            f7.setTextSize(1, 21.0f);
            f7.setText(str2);
            f7.setGravity(17);
            f7.setTextColor(-1);
            TextView f10 = p6.f(this.f46191a0, f7, x5.d(-1, -2.0f, 87, 16.0f, 0.0f, 16.0f, 40.0f), context);
            ...
            z5.b(f10, 0.02f, 1.5f);
            this.f46191a0.addView(f10, x5.d(-1, -2.0f, 87, 16.0f, 0.0f, 16.0f, 12.0f));
            i1Var.setVisibility(8);
            textView.setVisibility(8);
            this.f46201k0.setVisibility(8);
        ...
        this.Z.addView(this.f46202l0, x5.k(16.0f, 0.0f, 14.0f, 18.0f, -1, -2));
        V(false);
    }
    ...
    public static void U(Context context, TL_stars.StarGift starGift, f6 f6Var) {
        ...
        if (context != null && starGift != null) {
            ...
            ww0Var.f39185a.l(LocaleController.formatPluralString("GiftAuctionInfo1Header", i12, Integer.valueOf(i12)), false);
            int i13 = starGift.gifts_per_round;
            ww0Var.f39186b.setText(LocaleController.formatPluralString("GiftAuctionInfo1Text", i13, Integer.valueOf(i13)));
            ...
            ww0Var2.f39185a.l(LocaleController.getString(R.string.GiftAuctionInfo2Header), false);
            ww0Var2.f39186b.setText(LocaleController.formatPluralString("GiftAuctionInfo2Text", starGift.gifts_per_round, new Object[0]));
            ...
            ww0Var3.f39185a.l(LocaleController.getString(R.string.GiftAuctionInfo3Header), false);
            ww0Var3.f39186b.setText(LocaleController.getString(R.string.GiftAuctionInfo3Text));
    ...
    public final void T() {
        ...
        if (auction != null && (tL_starGiftAuctionStateFinished = auction.auctionStateFinished) != null && auction.gift.title != null) {
            this.f46198h0.run(this.f46195e0, LocaleController.formatString(R.string.Gift2AveragePriceHint, Long.valueOf(tL_starGiftAuctionStateFinished.average_price), this.m0.gift.title));
        }
    }
