...
public final class e4 extends w51 {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            ...
            return new s4.c1(new org.telegram.ui.Cells.l4(context, i11, 13, 12, 4, false, false, e6Var2));
        } else if (i10 == 42) {
            Context context2 = g4Var.getContext();
            int i12 = i6.L6;
            e6Var = ((org.telegram.ui.ActionBar.f3) g4Var).resourcesProvider;
            return new s4.c1(new org.telegram.ui.Cells.l4(context2, i12, 13, 12, 4, false, true, e6Var));
        } else {
