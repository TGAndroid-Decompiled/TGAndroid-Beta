...
public final class r2 extends org.telegram.ui.ActionBar.f3 {
    ...
    public r2(Context context, long j3, TL_stars.SavedStarGift savedStarGift, f6 f6Var, Utilities.Callback0Return callback0Return) {
        ...
        TextView b11 = c6.b(context, 14.0f, j6.f19492y6, false, f6Var);
        ...
        u61 u61Var = new u61(context, this.currentAccount, 0, false, new ai.m0(22, this, G), new s5.e(13, this, dVar), null, f6Var);
        u61Var.setSpanCount(3);
        u61Var.setOverScrollMode(2);
        u61Var.setScrollEnabled(false);
        linearLayout.addView(u61Var, y5.k(11.0f, 0.0f, 11.0f, 0.0f, -1, -2));
