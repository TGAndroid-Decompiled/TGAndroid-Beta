...
public abstract class r2 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public z7 R;
    public ViewGroup S;
    public final org.telegram.ui.ActionBar.o2 f46133a;
    public final int f46134b;
    public final long f46135c;
    public final n5 d;
    public final m5 e;
    public final f6 f46136f;
    public final w1 h;
    public final i81 f46137n;
    public final FrameLayout f46138r;
    public final SpannableStringBuilder f46139s;
    public final SpannableStringBuilder v;
    public final ci.d f46140w;
    public int f46141x;
    public final LinearLayout f46142y;
    ...
    public final void a() {
        ...
        if (currentPage != null && (n5Var = currentPage.e) != null && currentPage.d) {
            int i10 = n5Var.d;
            new l4(this.f46133a, this.f46135c, i10, new ei.r4(this, i10, currentPage, 5)).show();
        }
    }

    public final boolean b() {
        m5 m5Var = this.e;
        if (!m5Var.h() || m5Var.d().size() >= MessagesController.getInstance(this.f46134b).config.stargiftsCollectionsLimit.get()) {
            return false;
        }
        return true;
    }
    ...
    public final boolean d() {
        if (this.f46135c >= 0 || this.d.h == null) {
            return false;
        }
        return true;
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        LinearLayout linearLayout = this.f46142y;
        ci.d dVar = this.f46140w;
        long j3 = this.f46135c;
        int i15 = 8;
        if (i10 == i14) {
    ...
    public final void e() {
        ...
        if (this.M > 0) {
            ...
            if (i10 >= 0 && tL_starGiftCollection != null) {
                this.M = 0;
                this.f46137n.d(tL_starGiftCollection.collection_id, i10 + 1);
            }
        }
    }
    ...
    public final void f(boolean z10) {
        w1 w1Var = this.h;
        if (w1Var != null && this.f46137n != null) {
            w1Var.o(z10);
            e();
        }
    }
    ...
    public final boolean g() {
        ...
        n2 currentPage = getCurrentPage();
        if (currentPage != null && currentPage.f46066n) {
            return true;
        }
        return false;
    }
    ...
    public int getBottomOffset() {
        FrameLayout frameLayout = this.f46138r;
        float translationY = frameLayout.getTranslationY() - org.telegram.messenger.w1.B(this.f46141x, Math.max(AndroidUtilities.dp(240.0f), this.Q) + (-frameLayout.getTop()), 1);
        if (this.Q < AndroidUtilities.dp(240.0f)) {
            translationY += Math.min(AndroidUtilities.dp(240.0f) - this.Q, AndroidUtilities.dp(this.f46141x));
        }
        return (int) (AndroidUtilities.dp(this.f46141x) - translationY);
    }
    ...
    public int getGiftsCount() {
        ...
        if (currentPage != null && (n5Var = currentPage.e) != n5Var2) {
            if (n5Var != null && (i11 = n5Var.f47528n) > 0) {
                return i11;
            }
        } else if (n5Var2 != null && (i10 = n5Var2.f47528n) > 0) {
            return i10;
        }
        int i12 = this.f46134b;
        long j3 = this.f46135c;
        if (j3 >= 0) {
    ...
    public long getLastEmojisHash() {
        long j3 = 0;
        n5 n5Var = this.d;
        if (n5Var != null && !n5Var.f47526l.isEmpty()) {
            HashSet hashSet = new HashSet();
            int i10 = 0;
            for (int i11 = 0; i10 < 3 && i11 < n5Var.f47526l.size(); i11++) {
                TLRPC.Document document = ((TL_stars.SavedStarGift) n5Var.f47526l.get(i11)).gift.getDocument();
                if (document != null) {
    ...
    public final void h(String str, Utilities.Callback callback) {
        ...
        f6 f6Var = this.f46136f;
        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(context, 0, f6Var);
        if (str != null) {
            alertDialog$Builder.f18447a.R = LocaleController.getString(R.string.Gift2EditCollectionNameTitle);
        } else {
            alertDialog$Builder.f18447a.R = LocaleController.getString(R.string.Gift2NewCollectionTitle);
            alertDialog$Builder.f18447a.T = LocaleController.getString(R.string.Gift2NewCollectionText);
        }
        z1 z1Var = new z1(this, context, f6Var);
        z1Var.lineYFix = true;
        z1Var.setOnEditorActionListener(new a2(z1Var, callback, c2VarArr, view));
        MediaDataController.getInstance(this.f46134b).fetchNewEmojiKeywords(AndroidUtilities.getCurrentKeyboardLanguage(), true);
        z1Var.setTextSize(1, 18.0f);
        z1Var.setTextColor(j6.v0(j6.f18970j5, f6Var));
        ...
        z1Var.setLineColors(j6.v0(j6.f18991k6, f6Var), j6.v0(j6.f19009l6, f6Var), j6.v0(j6.f19083p7, f6Var));
        ...
        alertDialog$Builder.f18447a.f18491a = AndroidUtilities.dp(292.0f);
        if (str != null) {
            i10 = R.string.Edit;
        } else {
            i10 = R.string.Create;
        ...
        n70 n70Var = this.I;
        if (n70Var != null && (i70Var = n70Var.f26377m) != null) {
            i70Var.setSoftInputMode(48);
        }
        AndroidUtilities.requestAdjustNothing(findActivity, this.f46133a.getClassGuid());
    ...
    public final void l() {
        ...
        if (w1Var != null) {
            ...
            FrameLayout frameLayout = this.f46138r;
            float B = nextPositionAlpha + org.telegram.messenger.w1.B(this.f46141x, (-frameLayout.getTop()) + this.Q, 1);
            int i10 = 0;
            ...
            if (this.e.h() && w1Var.getPositionAnimated() >= 0.5f) {
                ...
                spannableStringBuilder = this.f46139s;
            }
            this.f46140w.g(spannableStringBuilder, true, true);
            oc ocVar = oc.f26698w;
    ...
    public final void m() {
        ...
        if (viewPages != null) {
            for (View view : viewPages) {
                if (view != null) {
                    n2 n2Var = (n2) view;
                    f6 f6Var2 = n2Var.f46064c;
                    if (n2Var.f46068s != null) {
                        n2Var.f46069w.setTextColor(j6.v0(j6.G6, f6Var2));
                        TextView textView = n2Var.f46070x;
                        int i11 = j6.Oh;
                        textView.setTextColor(j6.v0(i11, f6Var2));
                        n2Var.f46070x.setBackground(j6.Y(j6.l1(0.1f, j6.v0(i11, f6Var2)), 4, 4));
                    } else {
                        n2Var.F.setTextColor(j6.v0(j6.G6, f6Var2));
                        n2Var.G.setTextColor(j6.v0(j6.f19245y6, f6Var2));
                        n2Var.H.j();
                    }
                }
            }
        }
        this.E.setTextColor(j6.v0(j6.f18970j5, f6Var));
        this.f46142y.setBackground(j6.Y(j6.v0(j6.f18953i6, f6Var), 24, 24));
    }
    ...
    public void setReorderingCollections(boolean z10) {
        if (this.L != z10) {
            this.L = z10;
            p(g());
            this.f46137n.setReordering(z10);
            if (z10) {
