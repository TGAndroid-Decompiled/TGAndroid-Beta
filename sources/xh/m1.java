...
public final class m1 extends sq {
    ...
    public m1(View view) {
        ...
        this.e = 1.0f;
        c(path, 1.0f, false);
        this.f28309a.setColor(-698031);
        this.f28309a.setPathEffect(new CornerPathEffect(AndroidUtilities.dp(2.33f)));
        paint.setColor(0);
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.drawPath(path, this.f28309a);
        ...
        if (this.f46289b != null) {
            ...
            float min = Math.min(1.0f, AndroidUtilities.dp(40.0f) / this.f46289b.f28364c);
    ...
    public final void e(int i10, CharSequence charSequence, boolean z10) {
        ...
        this.f46289b = new t01(charSequence, f7, typeface);
    }
}
