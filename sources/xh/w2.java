...
public final class w2 extends Drawable {
    public Drawable f46214g;
    public int h;
    public int f46215i;
    public final Paint f46211b = new Paint(1);
    public final Shader[] f46212c = new Shader[2];
    public final Matrix d = new Matrix();
    public final org.telegram.ui.Components.d6 e = new org.telegram.ui.Components.d6(1.0f, new x(this, 7), 0, 420, wr.h);
    public final RectF f46213f = new RectF();
    public final int f46210a = 1;

    public final void a(int i10, int i11) {
        if (this.h == i10 && this.f46215i == i11) {
            return;
        }
        Shader[] shaderArr = this.f46212c;
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.f46214g != null) {
            ...
            j0.a(canvas, 0, this.f46214g, rectF.width(), AndroidUtilities.dp(290.0f), 2.0f, 1.0f);
            canvas.restore();
        }
    }
