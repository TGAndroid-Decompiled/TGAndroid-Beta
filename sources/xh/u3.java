...
public class u3 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.f6 f46097a;
    public com.google.android.gms.common.api.internal.r f46098a0;
    public final FrameLayout f46099b;
    public com.google.android.gms.common.api.internal.r f46100b0;
    public final m3 f46101c;
    public boolean f46102c0;
    public final w9[] d;
    public boolean f46103d0;
    public final TL_stars.starGiftAttributeModel[] e;
    public float f46104e0;
    public final LinearLayout[] f46105f;
    public float f46106f0;
    public float f46107g0;
    public final FrameLayout.LayoutParams[] h;
    public ValueAnimator f46108h0;
    public final x f46109i0;
    public final Paint[] f46110j0;
    public final RadialGradient[] f46111k0;
    public final Matrix[] f46112l0;
    public RadialGradient m0;
    public final wh.i1 f46113n;
    public final Matrix f46114n0;
    public final Paint f46115o0;
    public final TL_stars.starGiftAttributePattern[] f46116p0;
    public final org.telegram.ui.Components.n5[] f46117q0;
    public final m90[] f46118r;
    public int f46119r0;
    public final m90 f46120s;
    public float f46121s0;
    public float f46122t0;
    public ValueAnimator f46123u0;
    public final TextView v;
    public final RectF f46124v0;
    public int f46125w;
    public l8 f46126w0;
    public final FrameLayout f46127x;
    public final int[] f46128x0;
    public final m90[] f46129y;
    public final int[] f46130y0;
    public final int[] f46131z0;
    ...
    public u3(Context context, org.telegram.ui.ActionBar.f6 f6Var, Runnable runnable, View.OnClickListener onClickListener, u0 u0Var, View.OnClickListener onClickListener2, View.OnClickListener onClickListener3, View.OnClickListener onClickListener4, View.OnClickListener onClickListener5, View.OnClickListener onClickListener6) {
        ...
        this.f46105f = new LinearLayout[5];
        this.h = new FrameLayout.LayoutParams[5];
        this.f46118r = new m90[5];
        this.f46129y = new m90[5];
        this.E = new LinearLayout.LayoutParams[5];
        this.F = new wh.m0[5];
        this.U = new f4.d(0, 0);
        this.V = new TL_stars.starGiftAttributeBackdrop[3];
        this.f46109i0 = new x(this, 8);
        this.f46110j0 = new Paint[3];
        this.f46111k0 = new RadialGradient[3];
        this.f46112l0 = new Matrix[3];
        this.f46114n0 = new Matrix();
        this.f46115o0 = new Paint(1);
        this.f46116p0 = new TL_stars.starGiftAttributePattern[2];
        this.f46117q0 = new org.telegram.ui.Components.n5[2];
        int i10 = 0;
        while (true) {
            Paint[] paintArr = this.f46110j0;
        ...
        int i11 = 0;
        while (true) {
            org.telegram.ui.Components.n5[] n5VarArr = this.f46117q0;
        ...
        this.f46122t0 = 1.0f;
        this.f46124v0 = new RectF();
        this.f46128x0 = new int[12];
        this.f46130y0 = new int[12];
        this.f46131z0 = new int[12];
        this.f46097a = f6Var;
        this.R = onClickListener4;
        this.S = onClickListener5;
        this.T = onClickListener6;
        setWillNotDraw(false);
        this.f46099b = new FrameLayout(context);
        int i12 = 0;
        while (true) {
            w9[] w9VarArr = this.d;
            float f10 = 0.0f;
            ...
            this.f46099b.addView(this.d[i12], w7.a6.e(-1, -1, 119));
            w9 w9Var = this.d[i12];
            if (i12 == 0) {
                f10 = 1.0f;
            }
        ...
        this.f46127x = new FrameLayout(context);
        int i14 = 0;
        while (true) {
            LinearLayout[] linearLayoutArr = this.f46105f;
            if (i14 >= linearLayoutArr.length) {
                break;
            }
            linearLayoutArr[i14] = new LinearLayout(context);
            this.f46105f[i14].setOrientation(1);
            if (i14 == 2) {
                FrameLayout frameLayout = new FrameLayout(context);
                this.J = frameLayout;
                this.f46105f[i14].addView(frameLayout, w7.a6.q(-1, 144, 119));
                ...
                this.f46118r[i14] = new m90(context, null);
                this.f46118r[i14].setTextColor(-1);
                this.f46118r[i14].setTextSize(1, 20.0f);
                this.f46118r[i14].setTypeface(AndroidUtilities.bold());
                this.f46118r[i14].setSingleLine();
                m90 m90Var2 = this.f46118r[i14];
                TextUtils.TruncateAt truncateAt = TextUtils.TruncateAt.END;
                m90Var2.setEllipsize(truncateAt);
                this.f46118r[i14].setGravity(17);
                frameLayout.addView(this.f46118r[i14], w7.a6.d(-1, -2.0f, 49, 16.0f, 95.33f, 16.0f, 0.0f));
                this.f46129y[i14] = new m90(context, null);
                this.f46129y[i14].setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18034j5, f6Var));
                this.f46129y[i14].setTextSize(1, 14.0f);
                this.f46129y[i14].setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, f6Var));
                this.f46129y[i14].setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
                this.f46129y[i14].setDisablePaddingsOffsetY(true);
                this.f46129y[i14].setSingleLine();
                this.f46129y[i14].setGravity(17);
                this.f46129y[i14].setEllipsize(truncateAt);
                frameLayout.addView(this.f46129y[i14], w7.a6.d(-1, -2.0f, 49, 16.0f, 122.0f, 16.0f, 0.0f));
            } else if (i14 == 4) {
                x2 x2Var = new x2(context, f6Var);
                this.L = x2Var;
                this.f46105f[i14].addView(x2Var, w7.a6.n(-1, -2));
                View view = this.f46105f[i14];
                ...
                this.f46118r[i14] = new m90(context, null);
                this.f46118r[i14].setTextColor(i14 == 3 ? -1 : org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18034j5, f6Var));
                this.f46118r[i14].setTextSize(1, 20.0f);
                this.f46118r[i14].setTypeface(AndroidUtilities.bold());
                this.f46118r[i14].setGravity(17);
                this.f46105f[i14].addView(this.f46118r[i14], w7.a6.t(-1, -2, 17, 24, i14 == 3 ? 10 : 0, 24, 0));
                if (i14 == 0) {
                    this.f46105f[i14].addView(this.f46120s, w7.a6.t(-2, -2, 17, 0, 4, 0, 4));
                    this.f46105f[i14].addView(this.v, w7.a6.s(-2, 17, 0, 6, 0, 19.33f, 2));
                }
                if (i14 == 0) {
                    this.f46129y[i14] = new m90(context, null);
                    this.f46129y[i14].setTextColor(i14 == 3 ? org.telegram.ui.ActionBar.j6.l1(0.75f, -1) : org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18034j5, f6Var));
                    this.f46129y[i14].setTextSize(1, 14.0f);
                    this.f46129y[i14].setGravity(17);
                    this.f46129y[i14].setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, f6Var));
                    this.f46129y[i14].setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
                    this.f46129y[i14].setDisablePaddingsOffsetY(true);
                    this.f46127x.addView(this.f46129y[i14], w7.a6.e(-2, -2, 17));
                    this.f46127x.addView(this.N, w7.a6.a(-2.0f, 20.33f, 17));
                    LinearLayout linearLayout = this.f46105f[i14];
                    FrameLayout frameLayout2 = this.f46127x;
                    ...
                    this.f46129y[i14].setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
                    this.f46129y[i14].setDisablePaddingsOffsetY(true);
                    LinearLayout linearLayout2 = this.f46105f[i14];
                    m90 m90Var3 = this.f46129y[i14];
                ...
                this.f46105f[i14].addView(this.F[i14], w7.a6.t(-1, -2, 17, 24, 8, 24, 0));
            }
            if (i14 == 0) {
                this.f46105f[i14].addView(this.H, w7.a6.t(-1, -2, 7, 0, 15, 0, 0));
            }
            View view2 = this.f46105f[i14];
        ...
        addView(this.f46099b, w7.a6.d(160, 160.0f, 49, 0.0f, 8.0f, 0.0f, 0.0f));
        ...
        wh.k1 k1Var = i1Var.f44148a;
        if (k1Var.f44173f == null) {
            l8 l8Var = new l8(2, 12);
            k1Var.f44173f = l8Var;
            l8Var.h = 5.0f;
        }
        Path path = k1Var.f44172c;
        float f11 = k1Var.e;
        k1Var.f44174g = true;
    ...
    public final void a() {
        ValueAnimator valueAnimator = this.f46123u0;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.f46123u0 = null;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        this.f46123u0 = ofFloat;
        ofFloat.addUpdateListener(new q3(this, 1));
        this.f46123u0.addListener(new r3(this, 4));
        this.f46123u0.setDuration(320L);
        this.f46123u0.setInterpolator(wr.f28820g);
        this.f46123u0.start();
    }

    public final int b(Canvas canvas, float f7, float f10, float f11, float f12) {
        int i10 = this.f46119r0;
        RadialGradient[] radialGradientArr = this.f46111k0;
        TL_stars.starGiftAttributeBackdrop[] stargiftattributebackdropArr = this.V;
        Matrix[] matrixArr = this.f46112l0;
        Paint[] paintArr = this.f46110j0;
        int i11 = 0;
        if (i10 == 0) {
            if (this.f46121s0 > 0.0f && stargiftattributebackdropArr[2] != null) {
            ...
            if (this.f46121s0 < 1.0f && stargiftattributebackdropArr[1] != null) {
                paintArr[1].setAlpha((int) ((1.0f - this.f46121s0) * this.U.a(1) * 255.0f));
                matrixArr[1].reset();
        ...
        if (this.f46121s0 > 0.0f && stargiftattributebackdropArr[2] != null) {
            paintArr[2].setAlpha((int) (this.U.a(1) * 255.0f * this.f46121s0));
            matrixArr[2].reset();
            matrixArr[2].postTranslate(f7, f10);
            radialGradientArr[2].setLocalMatrix(matrixArr[2]);
            canvas.drawRect(0.0f, 0.0f, f11, f12, paintArr[2]);
    ...
    public final void c(Canvas canvas, float f7, float f10, float f11, float f12) {
        ...
        int d = i0.a.d(this.f46121s0, i10, i11);
        org.telegram.ui.Components.n5[] n5VarArr = this.f46117q0;
        n5VarArr[1].k(Integer.valueOf(d));
        j0.a(canvas, 0, n5VarArr[1], f11, f12, this.U.a(1), this.f46122t0);
        canvas.restore();
    }
    ...
    public void d(f4.d dVar) {
        ...
        if ((stargiftattributebackdropArr[0] != null && dVar.f7758b == 2) || (stargiftattributebackdropArr[1] != null && dVar.f7758b == 1)) {
            i10 = 0;
        } else {
            i10 = 8;
        }
        ...
        int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18034j5, this.f46097a);
        int i22 = 0;
        while (true) {
            m90VarArr = this.f46129y;
            if (i22 >= 2) {
                break;
            }
            m90 m90Var = this.f46118r[i22];
            if (stargiftattributebackdropArr[Math.min(1, i22)] == null) {
                i13 = v02;
            } else {
                i13 = -1;
            }
            m90Var.setTextColor(i13);
            m90 m90Var2 = m90VarArr[i22];
            if (i22 != 0 && i22 != 2) {
                TL_stars.starGiftAttributeBackdrop stargiftattributebackdrop = stargiftattributebackdropArr[1];
                if (stargiftattributebackdrop == null) {
                    i15 = v02;
                ...
                i14 = i0.a.d(this.f46121s0, i15, i16);
            } else {
            ...
            if (z11) {
                ...
                if (i22 == 0) {
                    this.f46127x.setLayoutParams(layoutParamsArr2[i22]);
                } else {
                    m90VarArr[i22].setLayoutParams(layoutParamsArr2[i22]);
                }
            }
            i22++;
        }
        ...
        w9VarArr[1].setAlpha((1.0f - this.f46121s0) * dVar.a(1));
        w9VarArr[2].setAlpha(dVar.a(1) * this.f46121s0);
        float lerp3 = AndroidUtilities.lerp(1.0f, this.f46107g0, dVar.a(2));
        FrameLayout frameLayout = this.f46099b;
        frameLayout.setScaleX(lerp3);
        frameLayout.setScaleY(AndroidUtilities.lerp(1.0f, this.f46107g0, dVar.a(2)));
        frameLayout.setTranslationX(dVar.a(2) * this.f46104e0);
        frameLayout.setTranslationY((dVar.a(2) * this.f46106f0) + (dVar.a(1) * AndroidUtilities.dp(16.0f)));
        ...
        if (this.f46102c0 && this.U.b(0)) {
            i12 = 0;
        } else {
            i12 = 8;
        }
        wh.i1 i1Var = this.f46113n;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        int[] iArr4 = this.f46131z0;
        int[] iArr5 = this.f46130y0;
        int[] iArr6 = this.f46128x0;
        if (stargiftattributebackdrop != null) {
        ...
        m3 m3Var2 = this.f46101c;
        if (m3Var2.f45706s == null && m3Var2.v == null && m3Var2.f45707w == null) {
            u3Var = this;
            f12 = f7;
            f11 = f10;
            iArr3 = iArr4;
            ...
            float f13 = f7;
            g3 g3Var = m3Var2.f45706s;
            float f14 = f10;
            float f15 = m3Var2.f45708x;
            int[] iArr7 = this.f46130y0;
            int[] iArr8 = this.f46128x0;
            int[] iArr9 = this.f46131z0;
            f11 = f14;
            iArr = iArr5;
            iArr2 = iArr6;
            iArr3 = iArr4;
            ...
            m3Var2.a(canvas2, m3Var2.v, m3Var2.f45709y, width2, realHeight, iArr7, iArr8, iArr9);
            m3Var2.a(canvas2, m3Var2.f45707w, m3Var2.E, width2, realHeight, iArr7, iArr8, iArr9);
            m3Var = m3Var2;
            u3Var.invalidate();
        }
        if (i10 > 0 && stargiftattributebackdropArr[0] != null) {
            ...
            org.telegram.ui.Components.n5[] n5VarArr = u3Var.f46117q0;
            if (max2 > 0.0f) {
                canvas2.save();
            ...
            if (u3Var.U.a(2) > 0.0f) {
                ...
                LinearLayout[] linearLayoutArr = u3Var.f46105f;
            ...
            if (textView != null && u3Var.f46125w != i14) {
                u3Var.f46125w = i14;
                textView.setTextColor(i14);
                org.telegram.ui.ActionBar.j6.B1(textView.getBackground(), i15, false);
            }
            if (m3Var.f45706s != null || m3Var.v != null || m3Var.f45707w != null) {
                u3Var.f46129y[0].setTextColor(i14);
            }
            if (u3Var.U.a(2) > 0.0f) {
                if (u3Var.f46126w0 == null) {
                    u3Var.f46126w0 = new l8(1, 12);
                }
                FrameLayout frameLayout2 = u3Var.f46099b;
                ...
                RectF rectF2 = u3Var.f46124v0;
                rectF2.set(measuredWidth - scaleX, measuredHeight - scaleY, measuredWidth + scaleX, f17);
                u3Var.f46126w0.g(rectF2);
                u3Var.f46126w0.d();
                u3Var.f46126w0.a(canvas2, org.telegram.ui.ActionBar.j6.l1(u3Var.U.a(2), -1));
                u3Var.invalidate();
            }
        }
        if (u3Var.U.a(1) > 0.0f) {
    ...
    public final void e(int i10, TL_stars.starGiftAttributeBackdrop stargiftattributebackdrop) {
        ...
        if (i10 == 0) {
            ...
            this.f46115o0.setShader(radialGradient2);
        }
        Matrix[] matrixArr = this.f46112l0;
        if (matrixArr[i10] == null) {
            matrixArr[i10] = new Matrix();
        }
        this.f46110j0[i10].setShader(radialGradientArr[i10]);
    }
    ...
    public final void f(TL_stars.StarGift starGift, boolean z10, boolean z11, boolean z12) {
        ...
        if (z15) {
            ...
            if (z13) {
                ...
                t3Var.b(i10, LocaleController.getString(i11), false);
            }
            float f7 = 1.0f;
            if (starGift.resell_amount != null) {
                ...
                yf.a resellAmount = starGift.getResellAmount(bVar);
                int i13 = R.string.GiftOnSale;
                if (resellAmount.f46926a == bVar2) {
                    z14 = true;
                } else {
                    z14 = false;
                }
                CharSequence formatSpannable = LocaleController.formatSpannable(i13, z7.S0("⭐️ " + ((Object) z7.J0(resellAmount.o(), 1.0f, ',')), z14), Float.valueOf(0.9f));
                TextView textView = this.N;
            ...
            this.f46102c0 = starGift.crafted;
            this.f46113n.f44148a.d(stargiftattributebackdropArr[0], false, true);
        } else {
    ...
    public final void g(int i10, TL_stars.starGiftAttributePattern stargiftattributepattern, boolean z10) {
        if (stargiftattributepattern != null) {
            TL_stars.starGiftAttributePattern[] stargiftattributepatternArr = this.f46116p0;
            if (stargiftattributepatternArr[i10] != stargiftattributepattern) {
                stargiftattributepatternArr[i10] = stargiftattributepattern;
                this.f46117q0[i10].i(stargiftattributepattern.document, z10);
            }
        }
    }
    ...
    public final void h(int i10, CharSequence charSequence, CharSequence charSequence2, SpannableStringBuilder spannableStringBuilder, CharSequence charSequence3, TLObject tLObject, Spannable spannable) {
        int i11;
        int i12;
        this.f46118r[i10].setText(charSequence);
        FrameLayout frameLayout = this.f46127x;
        m90[] m90VarArr = this.f46129y;
        m90 m90Var = this.f46120s;
        ...
        if (i10 == 0 && !TextUtils.isEmpty(spannableStringBuilder)) {
            ...
            if (i10 == 0) {
                ...
                m90 m90Var2 = m90VarArr[i10];
                if (TextUtils.isEmpty(charSequence2)) {
                    i11 = 8;
                } else {
                    i11 = 0;
                }
                m90Var2.setVisibility(i11);
            }
            m90Var.setVisibility(8);
            textView.setVisibility(8);
        }
    ...
    public final void k() {
        this.f46107g0 = AndroidUtilities.dpf2(33.33f) / AndroidUtilities.dpf2(160.0f);
        FrameLayout frameLayout = this.f46099b;
        m90[] m90VarArr = this.f46118r;
        this.f46104e0 = ((((Math.min(m90VarArr[2].getPaint().measureText(m90VarArr[2].getText().toString()), m90VarArr[2].getWidth()) + m90VarArr[2].getWidth()) / 2.0f) + (m90VarArr[2].getX() + (-frameLayout.getLeft()))) + AndroidUtilities.dp(24.0f)) - (AndroidUtilities.dp(126.67f) / 2.0f);
        this.f46106f0 = (AndroidUtilities.dp(124.0f) + (-frameLayout.getTop())) - (AndroidUtilities.dp(126.67f) / 2.0f);
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        n5VarArr[0].b();
        n5VarArr[1].b();
        AndroidUtilities.cancelRunOnUIThread(this.f46109i0);
    }
    ...
    public void setPreviewAttributes(o0 o0Var) {
        f4.d dVar = this.U;
        if (dVar != null && dVar.f7758b == 1 && isAttachedToWindow()) {
            AndroidUtilities.cancelRunOnUIThread(this.f46109i0);
            ValueAnimator valueAnimator = this.f46108h0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                this.f46108h0 = null;
            }
            int i10 = 1 - this.f46119r0;
            this.f46119r0 = i10;
            w9[] w9VarArr = this.d;
            hj0 lottieAnimation = w9VarArr[2 - i10].getImageReceiver().getLottieAnimation();
            hj0 lottieAnimation2 = w9VarArr[this.f46119r0 + 1].getImageReceiver().getLottieAnimation();
            if (lottieAnimation2 != null && lottieAnimation != null) {
                lottieAnimation2.S(lottieAnimation.t(), false);
            }
            int i11 = this.f46119r0 + 1;
            ...
            g(1, o0Var.f45787b, true);
            int i12 = this.f46119r0 + 1;
            TL_stars.starGiftAttributeModel stargiftattributemodel = o0Var.f45788c;
            TL_stars.starGiftAttributeModel[] stargiftattributemodelArr = this.e;
            stargiftattributemodelArr[i12] = stargiftattributemodel;
            z7.Z0(w9VarArr[i12].getImageReceiver(), stargiftattributemodelArr[this.f46119r0 + 1].document, 160);
            a();
            float f7 = this.f46119r0;
            ValueAnimator ofFloat = ValueAnimator.ofFloat(1.0f - f7, f7);
            this.f46108h0 = ofFloat;
            ofFloat.addUpdateListener(new q3(this, 0));
            this.f46108h0.addListener(new r3(this, 3));
            this.f46108h0.setDuration(320L);
            this.f46108h0.setInterpolator(wr.h);
            this.f46108h0.start();
        }
    }
    ...
    public void setPreviewingAttributes(ArrayList<TL_stars.StarGiftAttribute> arrayList) {
        ...
        this.f46098a0 = new com.google.android.gms.common.api.internal.r(v5.m(arrayList, TL_stars.starGiftAttributePattern.class));
        this.f46100b0 = new com.google.android.gms.common.api.internal.r(v5.m(arrayList, TL_stars.starGiftAttributeBackdrop.class));
        this.f46129y[1].setTextSize(1, 14.0f);
        this.H.setVisibility(8);
        this.f46121s0 = 0.0f;
        this.f46119r0 = 0;
        g(1, (TL_stars.starGiftAttributePattern) this.f46098a0.c(), true);
        TL_stars.starGiftAttributeModel[] stargiftattributemodelArr = this.e;
        ...
        TL_stars.starGiftAttributeBackdrop stargiftattributebackdrop = (TL_stars.starGiftAttributeBackdrop) this.f46100b0.c();
        this.V[1] = stargiftattributebackdrop;
        e(1, stargiftattributebackdrop);
        stargiftattributemodelArr[2] = (TL_stars.starGiftAttributeModel) this.W.f4941f;
        z7.Z0(w9VarArr[2].getImageReceiver(), stargiftattributemodelArr[2].document, 160);
        x xVar = this.f46109i0;
    ...
    public void setResellPrice(yf.a aVar) {
        ...
        if (!k10) {
            ...
            if (aVar.f46926a == yf.b.f46929b) {
                z10 = true;
            } else {
                z10 = false;
            }
            textView.setText(LocaleController.formatSpannable(i10, z7.U0(z10, "⭐️ " + ((Object) z7.J0(aVar.o(), 1.0f, ',')), 0.9f, null, 0.0f, 1.0f)));
            ...
            wr wrVar = wr.h;
            duration.setInterpolator(wrVar).setListener(new r3(this, 0)).start();
            m90VarArr[0].animate().alpha(0.0f).setDuration(420L).setInterpolator(wrVar).start();
        } else {
            ViewPropertyAnimator duration2 = textView.animate().scaleX(0.4f).scaleY(0.4f).alpha(0.0f).setDuration(420L);
            wr wrVar2 = wr.h;
            duration2.setInterpolator(wrVar2).setListener(new r3(this, 2)).setListener(new r3(this, 1)).start();
            m90VarArr[0].animate().alpha(1.0f).setDuration(420L).setInterpolator(wrVar2).start();
        }
        boolean z11 = this.M;
        t3[] t3VarArr = this.I;
        if (z11) {
    ...
    public void setWearPreview(TLObject tLObject) {
        ...
        this.f46118r[2].setText(str2);
        this.f46129y[2].setText(str);
        k();
        d(this.U);
    }
