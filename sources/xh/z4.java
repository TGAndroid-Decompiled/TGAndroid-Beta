...
public final class z4 extends View {
    public final yh.c4 f46243a;
    public final e6 f46244b;
    public float f46245c;
    public float d;
    public Drawable e;
    ...
    public z4(Context context, int i10, e6 e6Var) {
        super(context);
        this.f46244b = e6Var;
        yh.c4 c4Var = new yh.c4(i10, this, e6Var);
        this.f46243a = c4Var;
        c4Var.f47056y.setCallback(this);
    ...
    public final void a(TL_stars.TL_starGiftUnique tL_starGiftUnique, long j3, TLRPC.TL_textWithEntities tL_textWithEntities, String str, boolean z10) {
        float dp;
        float f7;
        yh.c4 c4Var = this.f46243a;
        m5 m5Var = c4Var.e;
        l1 l1Var = c4Var.f47042j;
        ImageReceiver imageReceiver = c4Var.d;
        c4Var.K = false;
        c4Var.N = null;
        c4Var.O = null;
        c4Var.f47048p = false;
        c4Var.f47043k = (TL_stars.starGiftAttributeBackdrop) v5.l(tL_starGiftUnique.attributes, TL_stars.starGiftAttributeBackdrop.class);
        c4Var.f47044l = (TL_stars.starGiftAttributePattern) v5.l(tL_starGiftUnique.attributes, TL_stars.starGiftAttributePattern.class);
        TL_stars.starGiftAttributeModel stargiftattributemodel = c4Var.f47045m;
        c4Var.f47045m = (TL_stars.starGiftAttributeModel) v5.l(tL_starGiftUnique.attributes, TL_stars.starGiftAttributeModel.class);
        Paint paint = c4Var.f47039f;
        c4Var.h = null;
        paint.setShader(null);
        TL_stars.starGiftAttributePattern stargiftattributepattern = c4Var.f47044l;
        if (stargiftattributepattern != null) {
            m5Var.i(stargiftattributepattern.document, false);
        } else {
            m5Var.g(null, false);
        }
        TL_stars.starGiftAttributeModel stargiftattributemodel2 = c4Var.f47045m;
        if (stargiftattributemodel2 != null && (stargiftattributemodel == null || stargiftattributemodel.document.f18118id != stargiftattributemodel2.document.f18118id)) {
            imageReceiver.setAutoRepeatCount(0);
            imageReceiver.clearDecorators();
            imageReceiver.setAutoRepeat(0);
            y7.Z0(imageReceiver, c4Var.f47045m.document, 110);
        }
        boolean z11 = tL_starGiftUnique.burned;
        c4Var.J = z11;
        if (z11) {
            int v02 = i6.v0(i6.f19074q7, c4Var.f47038c);
            Paint paint2 = l1Var.f27664a;
            paint2.setShader(null);
            paint2.setColor(v02);
            l1Var.e(11, LocaleController.getString(R.string.Gift2UniqueRibbonBurned), true);
        } else {
            l1Var.d(c4Var.f47043k, true, false);
    ...
    public final void onDetachedFromWindow() {
        ...
        c4Var.e.b();
        k0 k0Var = c4Var.f47056y;
        k0Var.d.onDetachedFromWindow();
        x5.release((View) null, k0Var.f45961q);
        k0Var.f45961q = null;
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        yh.c4 c4Var = this.f46243a;
        this.f46245c = (getWidth() - ((int) c4Var.Q.e)) / 2.0f;
        ...
        this.e.draw(canvas);
        canvas.save();
        canvas.translate(this.f46245c, this.d);
        c4Var.a(canvas);
        c4Var.b(canvas);
        canvas.restore();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        yh.c4 c4Var = this.f46243a;
        this.f46245c = (size - ((int) c4Var.Q.e)) / 2.0f;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        return this.f46243a.e(this.f46245c, this.d, motionEvent);
    }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (!super.verifyDrawable(drawable) && drawable != this.f46243a.f47056y) {
            return false;
        }
        return true;
    }
