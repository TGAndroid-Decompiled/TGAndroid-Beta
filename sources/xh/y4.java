...
public final class y4 extends s4.n0 {
    public final PointF f46494a = new PointF();
    public final z4 f46495b;
    ...
    public final void c(Canvas canvas, RecyclerView recyclerView) {
        ...
        z4 z4Var = this.f46495b;
        u4 u4Var = z4Var.f46522s0;
        t4 t4Var = z4Var.f46512h0;
        xl0 xl0Var = z4Var.d;
        PointF pointF = this.f46494a;
        if (hh.k.b(t4Var, xl0Var, pointF)) {
            f7 = pointF.x;
