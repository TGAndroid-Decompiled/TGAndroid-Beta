...
public class i4 extends org.telegram.ui.ActionBar.m2 implements le.e {
    ...
    public fh.c L;
    public ah.c M;
    public final le.c f46167a;
    public final long f46168b;
    public final String f46169c;
    public final v3 d;
    public Utilities.Callback e;
    public org.telegram.ui.ActionBar.f2 f46170f;
    public View h;
    public e3 f46171n;
    public FrameLayout f46172r;
    public FrameLayout f46173s;
    public TextView v;
    public n3 f46174w;
    public boolean f46175x;
    public HorizontalScrollView f46176y;

    public i4(long j3, String str, long j10, d6 d6Var) {
        super(null);
        this.f46167a = new le.c(0, this, rr.h, 380L, false);
        this.K = true;
        this.f46168b = j3;
        this.f46169c = str;
    ...
    public static void U(i4 i4Var, TL_stars.TL_starGiftUnique tL_starGiftUnique, long j3, boolean z10) {
        ...
        if (b5Var != null && ((ActionBarLayout) b5Var).f18591b) {
    ...
    public static void V(i4 i4Var, Context context) {
        ...
        y70Var.R = true;
        y70Var.f30542p = new ii.h(y70Var, 3);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(v3Var.h);
        Collections.sort(arrayList, new u2(i4Var, 0));
        r61 r61Var = new r61(i4Var, new v2(i4Var, strArr, arrayList, 0), new w2(i4Var, y70Var, 0), null);
        ...
        cuVar.addTextChangedListener(new rn(strArr, r61Var, false, 8));
        if (arrayList.size() > 8) {
    ...
    public static void W(i4 i4Var, Context context) {
        v3 v3Var = i4Var.d;
        if (!i4Var.K || v3Var.f46439f.isEmpty()) {
            return;
        }
        ...
        y70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        y70Var.R = true;
        y70Var.f30542p = new ii.h(y70Var, 5);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(v3Var.f46439f);
        Collections.sort(arrayList, new u2(i4Var, 2));
        r61 r61Var = new r61(i4Var, new v2(i4Var, strArr, arrayList, 2), new w2(i4Var, y70Var, 2), null);
        r61Var.Y2.f25265r = false;
        FrameLayout frameLayout = new FrameLayout(context);
        ImageView imageView = new ImageView(context);
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        ...
        cuVar.setBackground(null);
        frameLayout.addView(cuVar, y5.d(-1, -2.0f, 19, 43.0f, 0.0f, 8.0f, 0.0f));
        cuVar.addTextChangedListener(new rn(strArr, r61Var, false, 9));
        if (arrayList.size() > 8) {
            y70Var.r(frameLayout, y5.n(-1, 44));
            y70Var.k();
        }
    ...
    public static void X(i4 i4Var, Context context) {
        v3 v3Var = i4Var.d;
        if (!i4Var.K || v3Var.f46440g.isEmpty()) {
            return;
        }
        ...
        y70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        y70Var.R = true;
        y70Var.f30542p = new ii.h(y70Var, 4);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(v3Var.f46440g);
        Collections.sort(arrayList, new u2(i4Var, 1));
        r61 r61Var = new r61(i4Var, new v2(i4Var, strArr, arrayList, 1), new w2(i4Var, y70Var, 1), null);
        r61Var.Y2.f25265r = false;
        FrameLayout frameLayout = new FrameLayout(context);
        ImageView imageView = new ImageView(context);
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        ...
        cuVar.setBackground(null);
        frameLayout.addView(cuVar, y5.d(-1, -2.0f, 19, 43.0f, 0.0f, 8.0f, 0.0f));
        cuVar.addTextChangedListener(new rn(strArr, r61Var, false, 10));
        if (arrayList.size() > 8) {
            y70Var.r(frameLayout, y5.n(-1, 44));
            y70Var.k();
        }
    ...
    public static void Y(i4 i4Var, v51 v51Var) {
        ...
        if (obj instanceof TL_stars.TL_starGiftUnique) {
            ...
            yh.x3 x3Var = new yh.x3(i4Var.getParentActivity(), i4Var.currentAccount, i4Var.f46168b, i4Var.resourceProvider, null);
    ...
    public final void D(int i10, float f7, float f10, le.f fVar) {
        if (i10 == 0) {
            this.f46173s.setTranslationY((-AndroidUtilities.dp(52.0f)) * f7);
            z10.d(this.f46172r, f7);
        }
    }
    ...
    public final View createView(final Context context) {
        ...
        this.actionBar.setSubtitleColor(getThemedColor(h6.f19447z6));
        ...
        ?? r61Var = new r61(this, new hi.a(this, 18), new z2(this), new z2(this));
        this.f46171n = r61Var;
        r61Var.Y2.f25265r = false;
        r61Var.setSpanCount(3);
        this.f46171n.j(new ug0(this, 15));
        this.f46171n.setPadding(0, AndroidUtilities.dp(45.0f), 0, AndroidUtilities.dp(101.0f));
        this.f46171n.setClipToPadding(false);
        w8Var.addView(this.f46171n, y5.d(-1, -1.0f, 119, 7.33f, 0.0f, 7.33f, -45.0f));
        w8Var.addView(this.actionBar);
        View.OnClickListener onClickListener = new View.OnClickListener(this) {
            public final i4 f46059b;
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        ...
                        return;
                    default:
                        v3 v3Var2 = this.f46059b.d;
                        v3Var2.f46443k.clear();
                        v3Var2.f46442j.clear();
                        v3Var2.f46444l.clear();
                        v3Var2.h();
                        return;
                }
            }
        ...
        this.f46174w = frameLayout;
        this.f46175x = false;
        frameLayout.setAlpha(0.0f);
        this.f46174w.setScaleX(0.95f);
        this.f46174w.setScaleY(0.95f);
        this.f46174w.setVisibility(8);
        w8Var.addView(this.f46174w, y5.d(-1, -1.0f, 119, 0.0f, 0.0f, 0.0f, -45.0f));
        LinearLayout linearLayout = new LinearLayout(context);
        this.E = linearLayout;
        linearLayout.setPadding(AndroidUtilities.dp(11.0f), 0, AndroidUtilities.dp(11.0f), 0);
        this.E.setOrientation(0);
        HorizontalScrollView horizontalScrollView = new HorizontalScrollView(context);
        this.f46176y = horizontalScrollView;
        horizontalScrollView.setHorizontalScrollBarEnabled(false);
        this.f46176y.addView(this.E);
        this.f46176y.setBackgroundColor(v);
        this.f46176y.setClipChildren(false);
        w8Var.addView(this.f46176y, y5.e(-1, 47, 55));
        ...
        opVar.b(h6.f19117h7, h6.f19153j7, h6.f19173k7);
        ...
        ok.n(h6.f19151j5, this.resourceProvider, textView3, 1, 14.0f);
        ...
        this.f46173s = frameLayout2;
        frameLayout2.setPadding(AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f));
        FrameLayout frameLayout3 = this.f46173s;
        ...
        this.f46173s.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view2) {
                switch (r3) {
                    case 0:
                        ...
                        return;
                    default:
                        final i4 i4Var = this.f46074b;
                        v3 v3Var2 = i4Var.d;
                        if (i4Var.K) {
                            y70 H = y70.H(i4Var, i4Var.F);
                            H.c(R.drawable.menu_sort_value, LocaleController.getString(u3.BY_PRICE.f46411a), new x2(i4Var, 3), false);
                            H.c(R.drawable.menu_sort_date, LocaleController.getString(u3.BY_DATE.f46411a), new x2(i4Var, 4), false);
                            H.c(R.drawable.menu_sort_number, LocaleController.getString(u3.BY_NUMBER.f46411a), new x2(i4Var, 5), false);
                            H.k();
                            ...
                            }, LocaleController.getString(R.string.GiftResaleFilterForStarsOnly), v3Var2.f46450r);
                            H.f30548t = false;
                            H.Y = true;
        ...
        this.f46173s.addView(linearLayout2, y5.c(-1.0f, -2));
        a6.b(this.f46173s, 0.04f, 1.5f);
        w8Var.addView(this.f46173s, y5.d(-2, 52.0f, 81, 0.0f, 0.0f, 0.0f, AndroidUtilities.navigationBarHeight / AndroidUtilities.density));
        t5 y3 = t5.y(this.currentAccount, true);
        if (y3.e && !y3.s().k()) {
            this.f46173s.setVisibility(8);
        }
        FrameLayout frameLayout4 = new FrameLayout(context);
        this.f46172r = frameLayout4;
        ...
        FrameLayout frameLayout5 = this.f46172r;
        ...
        w8Var.addView(this.f46172r, y5.d(-2, 60.0f, 81, 0.0f, 0.0f, 0.0f, AndroidUtilities.navigationBarHeight / AndroidUtilities.density));
        ...
        this.f46172r.setOnClickListener(new View.OnClickListener(this) {
            public final i4 f46059b;
        ...
        this.f46172r.addView(this.v, y5.c(-1.0f, -2));
        this.f46172r.setVisibility(8);
        a6.b(this.f46172r, 0.05f, 1.5f);
        m3 m3Var = new m3(context, this.resourceProvider);
        this.F = m3Var;
        m3Var.setSorting(this.d.f46448p);
        ...
        this.G.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view2) {
                switch (r3) {
                    case 0:
                        i4.W(this.f46397b, context);
                        return;
                    case 1:
                        i4.X(this.f46397b, context);
                        return;
                    default:
                        i4.V(this.f46397b, context);
                        return;
                }
            }
        });
    ...
    public final void d0(boolean z10, boolean z11) {
        ...
        float f14 = 0.0f;
        if (z11) {
            this.f46176y.setVisibility(0);
            ViewPropertyAnimator animate = this.f46176y.animate();
            if (z10) {
                f11 = 0.0f;
            } else {
            ...
            ViewPropertyAnimator animate3 = this.f46171n.animate();
            if (!z10) {
        ...
        HorizontalScrollView horizontalScrollView = this.f46176y;
        if (!z10) {
            i10 = 8;
        }
        horizontalScrollView.setVisibility(i10);
        HorizontalScrollView horizontalScrollView2 = this.f46176y;
        if (z10) {
            f7 = 0.0f;
        } else {
        ...
        HorizontalScrollView horizontalScrollView3 = this.f46176y;
        if (!z10) {
            f13 = 0.0f;
        }
    ...
    public final void e0(boolean z10) {
        ...
        HashSet hashSet2 = v3Var.f46443k;
        ArrayList arrayList2 = v3Var.f46440g;
        HashSet hashSet3 = v3Var.f46442j;
        ArrayList arrayList3 = v3Var.f46439f;
        if (i10 > 12) {
            d0(true, true);
        }
        e3 e3Var = this.f46171n;
        ...
        m3 m3Var = this.F;
        if (m3Var != null) {
            m3Var.setSorting(v3Var.f46448p);
        }
        if (this.G != null) {
        ...
        int i12 = 0;
        while (true) {
            if (i12 >= this.f46171n.getChildCount()) {
                break;
            } else if (this.f46171n.getChildAt(i12) instanceof u00) {
                v3Var.g(false);
                break;
            } else {
                i12++;
        ...
        if ((v3Var.f46452t || v3Var.e > 0) && (!hashSet3.isEmpty() || !hashSet2.isEmpty() || !hashSet.isEmpty())) {
            z11 = true;
        }
        this.f46167a.a(z11, true);
    }
