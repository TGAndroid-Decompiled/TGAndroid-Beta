...
public class i4 extends org.telegram.ui.ActionBar.n2 implements le.d {
    ...
    public fh.c L;
    public ah.c M;
    public final le.b f46222a;
    public final long f46223b;
    public final String f46224c;
    public final v3 d;
    public Utilities.Callback e;
    public org.telegram.ui.ActionBar.g2 f46225f;
    public View h;
    public e3 f46226n;
    public FrameLayout f46227r;
    public FrameLayout f46228s;
    public TextView v;
    public n3 f46229w;
    public boolean f46230x;
    public HorizontalScrollView f46231y;

    public i4(long j3, String str, long j10, f6 f6Var) {
        super(null);
        this.f46222a = new le.b(0, this, qr.h, 380L, false);
        this.K = true;
        this.f46223b = j3;
        this.f46224c = str;
    ...
    public static void V(i4 i4Var, Context context) {
        ...
        y70Var.R = true;
        y70Var.f30563p = new ii.h(y70Var, 3);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(v3Var.h);
        Collections.sort(arrayList, new u2(i4Var, 0));
        u61 u61Var = new u61(i4Var, new v2(i4Var, strArr, arrayList, 0), new w2(i4Var, y70Var, 0), null);
        ...
        buVar.addTextChangedListener(new qn(strArr, u61Var, false, 8));
        if (arrayList.size() > 8) {
    ...
    public static void W(i4 i4Var, Context context) {
        v3 v3Var = i4Var.d;
        if (!i4Var.K || v3Var.f46494f.isEmpty()) {
            return;
        }
        ...
        y70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        y70Var.R = true;
        y70Var.f30563p = new ii.h(y70Var, 5);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(v3Var.f46494f);
        Collections.sort(arrayList, new u2(i4Var, 2));
        u61 u61Var = new u61(i4Var, new v2(i4Var, strArr, arrayList, 2), new w2(i4Var, y70Var, 2), null);
        u61Var.Y2.f26342r = false;
        FrameLayout frameLayout = new FrameLayout(context);
        ImageView imageView = new ImageView(context);
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        ...
        buVar.setBackground(null);
        frameLayout.addView(buVar, y5.d(-1, -2.0f, 19, 43.0f, 0.0f, 8.0f, 0.0f));
        buVar.addTextChangedListener(new qn(strArr, u61Var, false, 9));
        if (arrayList.size() > 8) {
            y70Var.r(frameLayout, y5.n(-1, 44));
            y70Var.k();
        }
    ...
    public static void X(i4 i4Var, Context context) {
        v3 v3Var = i4Var.d;
        if (!i4Var.K || v3Var.f46495g.isEmpty()) {
            return;
        }
        ...
        y70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        y70Var.R = true;
        y70Var.f30563p = new ii.h(y70Var, 4);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(v3Var.f46495g);
        Collections.sort(arrayList, new u2(i4Var, 1));
        u61 u61Var = new u61(i4Var, new v2(i4Var, strArr, arrayList, 1), new w2(i4Var, y70Var, 1), null);
        u61Var.Y2.f26342r = false;
        FrameLayout frameLayout = new FrameLayout(context);
        ImageView imageView = new ImageView(context);
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        ...
        buVar.setBackground(null);
        frameLayout.addView(buVar, y5.d(-1, -2.0f, 19, 43.0f, 0.0f, 8.0f, 0.0f));
        buVar.addTextChangedListener(new qn(strArr, u61Var, false, 10));
        if (arrayList.size() > 8) {
            y70Var.r(frameLayout, y5.n(-1, 44));
            y70Var.k();
        }
    ...
    public static void Y(i4 i4Var, y51 y51Var) {
        ...
        if (obj instanceof TL_stars.TL_starGiftUnique) {
            ...
            yh.y3 y3Var = new yh.y3(i4Var.getParentActivity(), i4Var.currentAccount, i4Var.f46223b, i4Var.resourceProvider, null);
    ...
    public final void H(int i10, float f7, float f10, le.e eVar) {
        if (i10 == 0) {
            this.f46228s.setTranslationY((-AndroidUtilities.dp(52.0f)) * f7);
            y10.d(this.f46227r, f7);
        }
    }
    ...
    public final View createView(final Context context) {
        ...
        this.actionBar.setSubtitleColor(getThemedColor(j6.f19511z6));
        ...
        this.f46226n.j(new vb0(this, 17));
        this.f46226n.setPadding(0, AndroidUtilities.dp(45.0f), 0, AndroidUtilities.dp(101.0f));
        this.f46226n.setClipToPadding(false);
        x8Var.addView(this.f46226n, y5.d(-1, -1.0f, 119, 7.33f, 0.0f, 7.33f, -45.0f));
        x8Var.addView(this.actionBar);
        View.OnClickListener onClickListener = new View.OnClickListener(this) {
            public final i4 f46114b;
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        ...
                        return;
                    default:
                        v3 v3Var2 = this.f46114b.d;
                        v3Var2.f46498k.clear();
                        v3Var2.f46497j.clear();
                        v3Var2.f46499l.clear();
                        v3Var2.h();
                        return;
                }
            }
        ...
        this.f46229w = frameLayout;
        this.f46230x = false;
        frameLayout.setAlpha(0.0f);
        this.f46229w.setScaleX(0.95f);
        this.f46229w.setScaleY(0.95f);
        this.f46229w.setVisibility(8);
        x8Var.addView(this.f46229w, y5.d(-1, -1.0f, 119, 0.0f, 0.0f, 0.0f, -45.0f));
        LinearLayout linearLayout = new LinearLayout(context);
        this.E = linearLayout;
        linearLayout.setPadding(AndroidUtilities.dp(11.0f), 0, AndroidUtilities.dp(11.0f), 0);
        this.E.setOrientation(0);
        HorizontalScrollView horizontalScrollView = new HorizontalScrollView(context);
        this.f46231y = horizontalScrollView;
        horizontalScrollView.setHorizontalScrollBarEnabled(false);
        this.f46231y.addView(this.E);
        this.f46231y.setBackgroundColor(v);
        this.f46231y.setClipChildren(false);
        x8Var.addView(this.f46231y, y5.e(-1, 47, 55));
        ...
        npVar.b(j6.f19182h7, j6.f19218j7, j6.f19238k7);
        ...
        rk.n(j6.f19216j5, this.resourceProvider, textView3, 1, 14.0f);
        ...
        this.f46228s = frameLayout2;
        frameLayout2.setPadding(AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f));
        FrameLayout frameLayout3 = this.f46228s;
        ...
        this.f46228s.setOnClickListener(new View.OnClickListener(this) {
            public final i4 f46129b;
            ...
            public final void onClick(View view2) {
                switch (r3) {
                    case 0:
                        v3 v3Var = this.f46129b.d;
                        if (v3Var != null) {
                            boolean z10 = !v3Var.f46505r;
                            v3Var.f46505r = z10;
                            npVar.a(z10, true);
                            v3Var.h();
                            return;
                        ...
                        return;
                    default:
                        final i4 i4Var = this.f46129b;
                        v3 v3Var2 = i4Var.d;
                        if (i4Var.K) {
                            y70 H = y70.H(i4Var, i4Var.F);
                            H.c(R.drawable.menu_sort_value, LocaleController.getString(u3.BY_PRICE.f46466a), new x2(i4Var, 3), false);
                            H.c(R.drawable.menu_sort_date, LocaleController.getString(u3.BY_DATE.f46466a), new x2(i4Var, 4), false);
                            H.c(R.drawable.menu_sort_number, LocaleController.getString(u3.BY_NUMBER.f46466a), new x2(i4Var, 5), false);
                            H.k();
                            ...
                            }, LocaleController.getString(R.string.GiftResaleFilterForStarsOnly), v3Var2.f46505r);
                            H.f30569t = false;
                            H.Y = true;
        ...
        this.f46228s.addView(linearLayout2, y5.c(-1.0f, -2));
        a6.b(this.f46228s, 0.04f, 1.5f);
        x8Var.addView(this.f46228s, y5.d(-2, 52.0f, 81, 0.0f, 0.0f, 0.0f, AndroidUtilities.navigationBarHeight / AndroidUtilities.density));
        u5 y3 = u5.y(this.currentAccount, true);
        if (y3.e && !y3.s().k()) {
            this.f46228s.setVisibility(8);
        }
        FrameLayout frameLayout4 = new FrameLayout(context);
        this.f46227r = frameLayout4;
        ...
        FrameLayout frameLayout5 = this.f46227r;
        ...
        x8Var.addView(this.f46227r, y5.d(-2, 60.0f, 81, 0.0f, 0.0f, 0.0f, AndroidUtilities.navigationBarHeight / AndroidUtilities.density));
        ...
        this.f46227r.setOnClickListener(new View.OnClickListener(this) {
            public final i4 f46114b;
        ...
        this.f46227r.addView(this.v, y5.c(-1.0f, -2));
        this.f46227r.setVisibility(8);
        a6.b(this.f46227r, 0.05f, 1.5f);
        m3 m3Var = new m3(context, this.resourceProvider);
        this.F = m3Var;
        m3Var.setSorting(this.d.f46503p);
        ...
        this.G.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view2) {
                switch (r3) {
                    case 0:
                        i4.W(this.f46452b, context);
                        return;
                    case 1:
                        i4.X(this.f46452b, context);
                        return;
                    default:
                        i4.V(this.f46452b, context);
                        return;
                }
            }
        });
    ...
    public final void d0(boolean z10, boolean z11) {
        ...
        float f14 = 0.0f;
        if (z11) {
            this.f46231y.setVisibility(0);
            ViewPropertyAnimator animate = this.f46231y.animate();
            if (z10) {
                f11 = 0.0f;
            } else {
            ...
            ViewPropertyAnimator animate3 = this.f46226n.animate();
            if (!z10) {
        ...
        HorizontalScrollView horizontalScrollView = this.f46231y;
        if (!z10) {
            i10 = 8;
        }
        horizontalScrollView.setVisibility(i10);
        HorizontalScrollView horizontalScrollView2 = this.f46231y;
        if (z10) {
            f7 = 0.0f;
        } else {
        ...
        HorizontalScrollView horizontalScrollView3 = this.f46231y;
        if (!z10) {
            f13 = 0.0f;
        }
    ...
    public final void e0(boolean z10) {
        ...
        HashSet hashSet2 = v3Var.f46498k;
        ArrayList arrayList2 = v3Var.f46495g;
        HashSet hashSet3 = v3Var.f46497j;
        ArrayList arrayList3 = v3Var.f46494f;
        if (i10 > 12) {
            d0(true, true);
        }
        e3 e3Var = this.f46226n;
        ...
        m3 m3Var = this.F;
        if (m3Var != null) {
            m3Var.setSorting(v3Var.f46503p);
        }
        if (this.G != null) {
        ...
        int i12 = 0;
        while (true) {
            if (i12 >= this.f46226n.getChildCount()) {
                break;
            } else if (this.f46226n.getChildAt(i12) instanceof t00) {
                v3Var.g(false);
                break;
            } else {
                i12++;
        ...
        if ((v3Var.f46507t || v3Var.e > 0) && (!hashSet3.isEmpty() || !hashSet2.isEmpty() || !hashSet.isEmpty())) {
            z11 = true;
        }
        this.f46222a.a(z11, true);
    }
