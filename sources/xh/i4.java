...
public class i4 extends org.telegram.ui.ActionBar.m2 implements le.e {
    ...
    public i4(long j3, String str, long j10, d6 d6Var) {
        super(null);
        this.f46182a = new le.c(0, this, rr.h, 380L, false);
        this.K = true;
        this.f46183b = j3;
        this.f46184c = str;
    ...
    public static void V(i4 i4Var, Context context) {
        ...
        y70Var.R = true;
        y70Var.f30550p = new ii.h(y70Var, 3);
        String[] strArr = {""};
    ...
    public static void W(i4 i4Var, Context context) {
        ...
        y70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        y70Var.R = true;
        y70Var.f30550p = new ii.h(y70Var, 5);
        String[] strArr = {""};
    ...
    public static void X(i4 i4Var, Context context) {
        ...
        y70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        y70Var.R = true;
        y70Var.f30550p = new ii.h(y70Var, 4);
        String[] strArr = {""};
    ...
    public final View createView(final Context context) {
        ...
        this.f46186n.j(new ug0(this, 15));
        ...
        opVar.b(h6.f19132h7, h6.f19168j7, h6.f19188k7);
    ...
    public final void e0(boolean z10) {
        ...
        while (true) {
            if (i12 >= this.f46186n.getChildCount()) {
                break;
            } else if (this.f46186n.getChildAt(i12) instanceof u00) {
                v3Var.g(false);
                break;
            } else {
                i12++;
