...
public class i4 extends org.telegram.ui.ActionBar.m2 implements le.e {
    ...
    public i4(long j3, String str, long j10, d6 d6Var) {
        super(null);
        this.f46181a = new le.c(0, this, rr.h, 380L, false);
        this.K = true;
        this.f46182b = j3;
        this.f46183c = str;
    ...
    public static void V(i4 i4Var, Context context) {
        ...
        y70Var.R = true;
        y70Var.f30549p = new ii.h(y70Var, 3);
        String[] strArr = {""};
    ...
    public static void W(i4 i4Var, Context context) {
        ...
        y70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        y70Var.R = true;
        y70Var.f30549p = new ii.h(y70Var, 5);
        String[] strArr = {""};
    ...
    public static void X(i4 i4Var, Context context) {
        ...
        y70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        y70Var.R = true;
        y70Var.f30549p = new ii.h(y70Var, 4);
        String[] strArr = {""};
    ...
    public final View createView(final Context context) {
        ...
        this.f46185n.j(new ug0(this, 15));
        ...
        opVar.b(h6.f19131h7, h6.f19167j7, h6.f19187k7);
    ...
    public final void e0(boolean z10) {
        ...
        while (true) {
            if (i12 >= this.f46185n.getChildCount()) {
                break;
            } else if (this.f46185n.getChildAt(i12) instanceof u00) {
                v3Var.g(false);
                break;
            } else {
                i12++;
