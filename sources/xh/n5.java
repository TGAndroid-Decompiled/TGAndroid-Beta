...
public final class n5 implements o5 {
    ...
    public int f45763n;
    public boolean f45764o;
    public ArrayList f45766q;
    public boolean f45755c = false;
    public boolean e = true;
    public boolean f45756f = false;
    public int f45757g = 783;
    public final ArrayList f45761l = new ArrayList();
    public int f45762m = -1;
    public long f45765p = 0;
    ...
    public final void a() {
        ...
        if (!this.f45758i && !this.f45759j) {
            ...
            this.f45758i = true;
            long j3 = this.f45765p;
            int i10 = 30;
            String str = "";
            int i11 = this.f45753a;
            if (j3 != 0) {
                TL_stars.getCraftStarGifts getcraftstargifts = new TL_stars.getCraftStarGifts();
                getcraftstargifts.gift_id = this.f45765p;
                if (!z10) {
                    str = this.f45760k;
                }
                ...
                getsavedstargifts2.exclude_unupgradable = !TLObject.hasFlag(this.f45757g, 2);
                getsavedstargifts2.exclude_upgradable = !TLObject.hasFlag(this.f45757g, 4);
                getsavedstargifts2.exclude_unlimited = !TLObject.hasFlag(this.f45757g, 1);
                getsavedstargifts2.exclude_unique = !TLObject.hasFlag(this.f45757g, 8);
                getsavedstargifts2.exclude_saved = !TLObject.hasFlag(this.f45757g, 256);
                getsavedstargifts2.exclude_unsaved = !TLObject.hasFlag(this.f45757g, 512);
                getsavedstargifts2.peer_color_available = this.f45756f;
                long j10 = this.f45754b;
                if (j10 == 0) {
            ...
            int sendRequest = ConnectionsManager.getInstance(i11).sendRequest(getsavedstargifts, new bi.f2(this, r2, z10, 8));
            this.f45762m = sendRequest;
    ...
    public final int b(int i10) {
        if (!x3.O1(this.f45753a, this.f45754b)) {
            return -1;
        }
        int i11 = i10 + 1;
        while (true) {
            ArrayList arrayList = this.f45761l;
    ...
    @Override
    public final void d() {
        NotificationCenter.getInstance(this.f45753a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starUserGiftsLoaded, Long.valueOf(this.f45754b), this);
    }

    @Override
    public final int e() {
        return this.f45761l.size();
    }
    ...
    public final TL_stars.InputSavedStarGift g(TL_stars.SavedStarGift savedStarGift) {
        ...
        tL_inputSavedStarGiftChat.peer = MessagesController.getInstance(this.f45753a).getInputPeer(this.f45754b);
    ...
    public final ArrayList h() {
        ...
        int i10 = 0;
        while (true) {
            ArrayList arrayList2 = this.f45761l;
    ...
    public final void i(boolean z10) {
        if (this.f45762m != -1) {
            ConnectionsManager.getInstance(this.f45753a).cancelRequest(this.f45762m, true);
            this.f45762m = -1;
        }
        this.f45758i = false;
        this.f45761l.clear();
    ...
    public final int indexOf(Object obj) {
        return this.f45761l.indexOf(obj);
    }
    ...
    public final void j(ArrayList arrayList, TL_stars.StarGift starGift) {
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            while (i11 < size) {
                ...
                while (true) {
                    ...
                    if (i12 < arrayList2.size()) {
                        ...
                        if (starGift3 != null && starGift3.f17425id == starGift2.f17425id) {
                            arrayList2.remove(i12);
                            this.f45763n = Math.max(0, this.f45763n - 1);
                            z10 = true;
                            break;
                        }
                        i12++;
            ...
            if (z10) {
                NotificationCenter.getInstance(i10).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starUserGiftsLoaded, Long.valueOf(this.f45754b), this);
            }
        }
        if (starGift != null) {
    ...
    public final void l() {
        boolean z10 = this.f45755c;
        int i10 = 0;
        long j3 = this.f45754b;
        int i11 = this.f45753a;
        if (z10) {
        ...
        if (savedStarGift != null) {
            ...
            if (contains) {
                if (!z10) {
                    ...
                    arrayList = this.f45761l;
                    arrayList.removeAll(h);
                    if (this.e && !this.f45755c) {
