...
public final class x3 implements Utilities.Callback5 {
    ...
    public final g4 f46483b;
    public final y70 f46484c;
    ...
    public final void mo17run(Object obj, Object obj2, Object obj3, Object obj4, Object obj5) {
        ...
        switch (this.f46482a) {
            case 0:
                long j3 = ((TL_stars.starGiftAttributeModel) v51Var.G).document.f18341id;
                v3 v3Var = this.f46483b.f46159c;
                HashSet hashSet = v3Var.f46456j;
                HashSet hashSet2 = v3Var.f46456j;
                if (!hashSet.contains(Long.valueOf(j3))) {
                    if (hashSet2.isEmpty()) {
                        ArrayList arrayList = v3Var.f46453f;
            ...
            case 1:
                ...
                v3 v3Var2 = this.f46483b.f46159c;
                HashSet hashSet3 = v3Var2.f46457k;
                HashSet hashSet4 = v3Var2.f46457k;
                ...
                return;
            default:
                long j11 = ((TL_stars.starGiftAttributePattern) v51Var.G).document.f18341id;
                v3 v3Var3 = this.f46483b.f46159c;
                HashSet hashSet5 = v3Var3.f46458l;
                HashSet hashSet6 = v3Var3.f46458l;
