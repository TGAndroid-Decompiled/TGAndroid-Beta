...
public final class h implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final float f50622b;
    public final n f50623c;
    public final View d;
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (this.f50621a) {
            case 0:
                ...
                h0Var.setTranslationY((f10 * floatValue) + ((1.0f - floatValue) * this.f50622b));
                return;
            default:
                float floatValue2 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                n nVar2 = this.f50623c;
                xn xnVar2 = nVar2.F;
                xa xaVar = (xa) this.d;
                ...
                xaVar.setTranslationY((f11 * floatValue2) + ((1.0f - floatValue2) * this.f50622b));
                return;
        }
    }
}
