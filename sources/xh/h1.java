...
public final class h1 extends i51 {
    public static final int f45914a = 0;
    ...
    public final void bindView(View view, j51 j51Var, boolean z10, x51 x51Var, f61 f61Var) {
        ...
        if (obj instanceof rg.k) {
            ...
            i1Var.f45943n.setVisibility(8);
            i1Var.F.setVisibility(8);
            if (kVar.f42360c == null && kVar.d == null) {
            ...
            i1Var.V = kVar;
            i1Var.W = null;
            i1Var.f45931b0 = false;
            i1Var.f45933c0 = null;
            i1Var.f45934d0 = false;
            i1Var.f45935e0 = false;
            i1Var.f45937f0 = false;
            i1Var.O = null;
            i1Var.P = null;
            i1Var.c(false, false);
            i1Var.j();
            ...
            i1Var.g(starGift, z13, z11, j51Var.f25129q, j51Var.f25130r, j51Var.f25132t);
        } else if (obj instanceof TL_stars.SavedStarGift) {
            z12 = i1Var.h((TL_stars.SavedStarGift) obj, j51Var.f25129q, j51Var.f25130r);
        }
        if (j51Var.f25119f) {
    ...
    public final boolean equals(j51 j51Var, j51 j51Var2) {
        if (j51Var.f25129q == j51Var2.f25129q) {
            Object obj = j51Var.G;
            if (obj != null || j51Var2.G != null) {
                ...
                if (obj instanceof TL_stars.StarGift) {
                    ...
                    if (obj2 instanceof TL_stars.StarGift) {
                        if (((TL_stars.StarGift) obj).f18347id == ((TL_stars.StarGift) obj2).f18347id) {
                            return true;
                        }
                        return false;
                    }
                ...
                if (obj instanceof TL_stars.SavedStarGift) {
                    ...
                    if (obj3 instanceof TL_stars.SavedStarGift) {
                        ...
                        if (savedStarGift.gift.f18347id == savedStarGift2.gift.f18347id && savedStarGift.date == savedStarGift2.date && savedStarGift.saved_id == savedStarGift2.saved_id) {
                            return true;
                        }
                        return false;
                    }
            ...
            if (j51Var.f25137z == j51Var2.f25137z && j51Var.e == j51Var2.e && j51Var.B == j51Var2.B && TextUtils.equals(j51Var.f25124l, j51Var2.f25124l)) {
                return true;
            }
            return false;
        }
