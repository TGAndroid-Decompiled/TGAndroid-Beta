    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        switch (this.f46163a) {
            case 3:
                ...
                zg.q qVar = (zg.q) this.f46164b;
                if (qVar.K && z10) {
                    qVar.f49433w.setTranslationY(-qVar.f49428c.getMeasuredHeight());
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.f46163a) {
            case 0:
                ...
                ((j1) this.f46164b).K.measure(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), 1073741824));
                return;
            default:
                super.onMeasure(i10, i11);
                return;
