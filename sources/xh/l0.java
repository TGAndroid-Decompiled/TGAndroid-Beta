...
public final class l0 extends View {
    ...
    public TextPaint getTextPaint() {
        return this.f46257a.f46235c;
    }

    @Override
    public final void onAttachedToWindow() {
        super.onAttachedToWindow();
        this.f46257a.d.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        k0 k0Var = this.f46257a;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        k0 k0Var = this.f46257a;
        k0Var.b(size);
        setMeasuredDimension(getPaddingRight() + getPaddingLeft() + k0Var.f46249t, getPaddingBottom() + getPaddingTop() + k0Var.f46250u);
    }

    public void setMessage(CharSequence charSequence) {
        k0 k0Var = this.f46257a;
        k0Var.f46242m = charSequence;
        k0Var.f46248s = -1;
        requestLayout();
    }

    public void setUser(TLObject tLObject) {
        this.f46257a.c(tLObject);
        invalidate();
    }
}
