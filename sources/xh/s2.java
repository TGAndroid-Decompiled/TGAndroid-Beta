...
public abstract class s2 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public z7 R;
    public ViewGroup S;
    public final org.telegram.ui.ActionBar.n2 f46369a;
    public final int f46370b;
    public final long f46371c;
    public final l5 d;
    public final k5 e;
    public final e6 f46372f;
    public final x1 h;
    public final w81 f46373n;
    public final FrameLayout f46374r;
    public final SpannableStringBuilder f46375s;
    public final SpannableStringBuilder v;
    public final ci.d f46376w;
    public int f46377x;
    public final LinearLayout f46378y;

    public s2(int r26, long r27, android.content.Context r29, org.telegram.ui.ActionBar.n2 r30, org.telegram.ui.ActionBar.e6 r31) {
    ...
    public final void a() {
        ...
        if (currentPage != null && (l5Var = currentPage.e) != null && currentPage.d) {
            int i10 = l5Var.d;
            new m4(this.f46369a, this.f46371c, i10, new ei.r4(this, i10, currentPage, 5)).show();
        }
    }

    public final boolean b() {
        k5 k5Var = this.e;
        if (!k5Var.h() || k5Var.d().size() >= MessagesController.getInstance(this.f46370b).config.stargiftsCollectionsLimit.get()) {
            return false;
        }
        return true;
    }
    ...
    public final boolean c() {
        int i10 = this.f46370b;
        long j3 = this.f46371c;
        if (j3 >= 0) {
    ...
    public final boolean d() {
        if (this.f46371c >= 0 || this.d.h == null) {
            return false;
        }
        return true;
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        LinearLayout linearLayout = this.f46378y;
        ci.d dVar = this.f46376w;
        long j3 = this.f46371c;
        int i15 = 8;
        if (i10 == i14) {
    ...
    public final void e() {
        ...
        if (this.M > 0) {
            ...
            if (i10 >= 0 && tL_starGiftCollection != null) {
                this.M = 0;
                this.f46373n.d(tL_starGiftCollection.collection_id, i10 + 1);
            }
        }
    }
    ...
    public final void f(boolean z10) {
        x1 x1Var = this.h;
        if (x1Var != null && this.f46373n != null) {
            x1Var.o(z10);
            e();
        }
    }
    ...
    public final boolean g() {
        ...
        o2 currentPage = getCurrentPage();
        if (currentPage != null && currentPage.f46304n) {
            return true;
        }
        return false;
    }
    ...
    public int getBottomOffset() {
        FrameLayout frameLayout = this.f46374r;
        float translationY = frameLayout.getTranslationY() - org.telegram.messenger.q.C(this.f46377x, Math.max(AndroidUtilities.dp(240.0f), this.Q) + (-frameLayout.getTop()), 1);
        if (this.Q < AndroidUtilities.dp(240.0f)) {
            translationY += Math.min(AndroidUtilities.dp(240.0f) - this.Q, AndroidUtilities.dp(this.f46377x));
        }
        return (int) (AndroidUtilities.dp(this.f46377x) - translationY);
    }
    ...
    public int getGiftsCount() {
        ...
        if (currentPage != null && (l5Var = currentPage.e) != l5Var2) {
            if (l5Var != null && (i11 = l5Var.f47652n) > 0) {
                return i11;
            }
        } else if (l5Var2 != null && (i10 = l5Var2.f47652n) > 0) {
            return i10;
        }
        int i12 = this.f46370b;
        long j3 = this.f46371c;
        if (j3 >= 0) {
    ...
    public long getLastEmojisHash() {
        long j3 = 0;
        l5 l5Var = this.d;
        if (l5Var != null && !l5Var.f47650l.isEmpty()) {
            HashSet hashSet = new HashSet();
            int i10 = 0;
            for (int i11 = 0; i10 < 3 && i11 < l5Var.f47650l.size(); i11++) {
                TLRPC.Document document = ((TL_stars.SavedStarGift) l5Var.f47650l.get(i11)).gift.getDocument();
                if (document != null) {
                    hashSet.add(Long.valueOf(document.f18302id));
                    j3 = Objects.hash(Long.valueOf(j3), Long.valueOf(document.f18302id));
                    i10++;
                }
            }
        }
    ...
    public final void h(String str, Utilities.Callback callback) {
        ...
        e6 e6Var = this.f46372f;
        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(context, 0, e6Var);
        if (str != null) {
            alertDialog$Builder.f18622a.R = LocaleController.getString(R.string.Gift2EditCollectionNameTitle);
        } else {
            alertDialog$Builder.f18622a.R = LocaleController.getString(R.string.Gift2NewCollectionTitle);
            alertDialog$Builder.f18622a.T = LocaleController.getString(R.string.Gift2NewCollectionText);
        }
        a2 a2Var = new a2(this, context, e6Var);
        a2Var.lineYFix = true;
        a2Var.setOnEditorActionListener(new b2(a2Var, callback, b2VarArr, view));
        MediaDataController.getInstance(this.f46370b).fetchNewEmojiKeywords(AndroidUtilities.getCurrentKeyboardLanguage(), true);
        a2Var.setTextSize(1, 18.0f);
        a2Var.setTextColor(j6.v0(j6.f19169j5, e6Var));
        ...
        a2Var.setLineColors(j6.v0(j6.f19190k6, e6Var), j6.v0(j6.f19208l6, e6Var), j6.v0(j6.f19283p7, e6Var));
        ...
        alertDialog$Builder.f18622a.f18646a = AndroidUtilities.dp(292.0f);
        if (str != null) {
            i10 = R.string.Edit;
        } else {
            i10 = R.string.Create;
        ...
        b2VarArr[0] = alertDialog$Builder.f18622a;
        w70 w70Var = this.I;
        if (w70Var != null && (r70Var = w70Var.f29914m) != null) {
            r70Var.setSoftInputMode(48);
        }
        AndroidUtilities.requestAdjustNothing(findActivity, this.f46369a.getClassGuid());
    ...
    public final void l() {
        ...
        if (x1Var != null) {
            ...
            FrameLayout frameLayout = this.f46374r;
            float C = nextPositionAlpha + org.telegram.messenger.q.C(this.f46377x, (-frameLayout.getTop()) + this.Q, 1);
            int i10 = 0;
            ...
            bVar.a(z10, true);
            float f11 = bVar.e;
            float lerp = AndroidUtilities.lerp(AndroidUtilities.dp(60.0f) + C, C, f11);
            ...
            if (this.e.h() && x1Var.getPositionAnimated() >= 0.5f) {
                ...
                spannableStringBuilder = this.f46375s;
            }
            this.f46376w.g(spannableStringBuilder, true, true);
            qc qcVar = qc.f27543w;
    ...
    public final void m() {
        ...
        if (viewPages != null) {
            for (View view : viewPages) {
                if (view != null) {
                    o2 o2Var = (o2) view;
                    e6 e6Var2 = o2Var.f46302c;
                    if (o2Var.f46306s != null) {
                        o2Var.f46307w.setTextColor(j6.v0(j6.G6, e6Var2));
                        TextView textView = o2Var.f46308x;
                        int i11 = j6.Oh;
                        textView.setTextColor(j6.v0(i11, e6Var2));
                        o2Var.f46308x.setBackground(j6.Y(j6.l1(0.1f, j6.v0(i11, e6Var2)), 4, 4));
                    } else {
                        o2Var.F.setTextColor(j6.v0(j6.G6, e6Var2));
                        o2Var.G.setTextColor(j6.v0(j6.f19445y6, e6Var2));
                        o2Var.H.j();
                    }
                }
            }
        }
        this.E.setTextColor(j6.v0(j6.f19169j5, e6Var));
        this.f46378y.setBackground(j6.Y(j6.v0(j6.f19152i6, e6Var), 24, 24));
    }
    ...
    public void setReorderingCollections(boolean z10) {
        if (this.L != z10) {
            this.L = z10;
            p(g());
            this.f46373n.setReordering(z10);
            if (z10) {
