...
public final class g4 extends za {
    public static final int f45878k0 = 0;
    public final String X;
    public final f4 Y;
    public final HorizontalScrollView Z;
    public final l3 f45879a0;
    public final l3 f45880b0;
    public final l3 f45881c0;
    public final l3 f45882d0;
    public final yh.l2 f45883e0;
    public yh.w0 f45884f0;
    public final HashSet f45885g0;
    public boolean f45886h0;
    public e4 f45887i0;
    public boolean f45888j0;

    public g4(final Context context, String str, final f4 f4Var) {
        super(2, context, (e6) null, false);
        this.f45885g0 = new HashSet();
        ...
        this.f45879a0 = l3Var;
        l3Var.setSorting(f4Var.f45869c.f46155p);
        linearLayout.addView(l3Var, x5.t(-2, -2, 16, 0, 0, 6, 0));
        l3Var.setOnClickListener(new vy0(26, this, f4Var));
        l3 l3Var2 = new l3(context, this.resourcesProvider);
        this.f45880b0 = l3Var2;
        ...
        l3Var2.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r4) {
                    case 0:
                        g4.R(this.f45800b, f4Var, context);
                        return;
                    case 1:
                        g4.W(this.f45800b, f4Var, context);
                        return;
                    default:
                        g4.S(this.f45800b, f4Var, context);
                        return;
                }
            }
        });
        l3 l3Var3 = new l3(context, this.resourcesProvider);
        this.f45881c0 = l3Var3;
        ...
        this.f45887i0.N(false);
        f4Var.d = new y3(this, 1);
    }

    public static void P(g4 g4Var, f4 f4Var) {
        n70 F = n70.F(g4Var.container, g4Var.resourcesProvider, g4Var.f45879a0);
        F.c(R.drawable.menu_sort_value, LocaleController.getString(t3.BY_PRICE.f46131a), new x3(f4Var, 3), false);
        F.c(R.drawable.menu_sort_date, LocaleController.getString(t3.BY_DATE.f46131a), new x3(f4Var, 4), false);
        F.c(R.drawable.menu_sort_number, LocaleController.getString(t3.BY_NUMBER.f46131a), new x3(f4Var, 5), false);
        F.f26369t = false;
        F.Y = true;
    ...
    public static void Q(g4 g4Var, f4 f4Var, int i10) {
        ...
        zf.b bVar;
        i51 G = g4Var.f45887i0.G(i10 - 1);
        if (G != null) {
            Object obj = G.G;
            if (obj instanceof TL_stars.StarGift) {
                TL_stars.StarGift starGift = (TL_stars.StarGift) obj;
                boolean z10 = G.f24900r;
                if (!TextUtils.isEmpty(starGift.gift_address) && g4Var.f45886h0) {
                    ...
                    zf.b bVar2 = bVar;
                    v5.x(g4Var.currentAccount, bVar2).H(tL_starGiftUnique, clientUserId, null, true, new bp0(g4Var, b2Var2, bVar2, tL_starGiftUnique, clientUserId));
                } else {
                    if (!z10) {
                        ArrayList arrayList = f4Var.f45868b.f47498l;
    ...
    public static void R(g4 g4Var, f4 f4Var, Context context) {
        u3 u3Var = f4Var.f45869c;
        if (u3Var.f46146f.isEmpty()) {
            return;
        }
        n70 n70Var = new n70(g4Var.container, g4Var.resourcesProvider, g4Var.f45880b0, false, true, false);
        n70Var.f26369t = false;
        n70Var.Y = true;
        n70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        n70Var.R = true;
        n70Var.f26363p = new ii.h(n70Var, 8);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(u3Var.f46146f);
    ...
    public static void S(g4 g4Var, f4 f4Var, Context context) {
        ...
        n70 n70Var = new n70(g4Var.container, g4Var.resourcesProvider, g4Var.f45882d0, false, true, false);
        n70Var.f26369t = false;
        n70Var.Y = true;
        n70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        n70Var.R = true;
        n70Var.f26363p = new ii.h(n70Var, 7);
        String[] strArr = {""};
        ...
        if (f4Var != null) {
            ...
            if (n5Var != null && u3Var != null) {
                ...
                while (i12 < size) {
                    ...
                    if (!g4Var.f45885g0.contains(Long.valueOf(savedStarGift.gift.f18338id))) {
                ...
                if (!n5Var.f47495i && n5Var.f47496j) {
                    if (z11) {
    ...
    public static void U(g4 g4Var, org.telegram.ui.ActionBar.b2 b2Var, zf.b bVar, TL_stars.TL_starGiftUnique tL_starGiftUnique, long j3, TLRPC.TL_payments_paymentFormStarGift tL_payments_paymentFormStarGift) {
        ...
        sb2.append(" #");
        new yh.f3(context, e6Var, tL_starGiftUnique, d3Var, i10, j3, hg.k0.k(tL_starGiftUnique.num, ',', sb2), true, new d80(g4Var, tL_starGiftUnique, j3, 1)).b();
    }

    public static void V(g4 g4Var, TL_stars.TL_starGiftUnique tL_starGiftUnique, long j3, yh.d3 d3Var, nf.e eVar) {
        eVar.d();
        v5.x(g4Var.currentAccount, d3Var.f47073a).h(d3Var.f47074b, tL_starGiftUnique, j3, null, true, new org.telegram.tgnet.e(g4Var, eVar, tL_starGiftUnique, 6));
    }

    public static void W(g4 g4Var, f4 f4Var, Context context) {
        u3 u3Var = f4Var.f45869c;
        if (u3Var.f46147g.isEmpty()) {
            return;
        }
        n70 n70Var = new n70(g4Var.container, g4Var.resourcesProvider, g4Var.f45881c0, false, true, false);
        n70Var.f26369t = false;
        n70Var.Y = true;
        n70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        n70Var.R = true;
        n70Var.f26363p = new ii.h(n70Var, 6);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(u3Var.f46147g);
    ...
    public final void Z() {
        ...
        while (true) {
            ...
            if ((childAt instanceof t00) && (R = RecyclerView.R(childAt) - 1) >= 0 && (G = this.f45887i0.G(R)) != null) {
                if (G.d < 10) {
                    z10 = true;
                } else {
                    z11 = true;
