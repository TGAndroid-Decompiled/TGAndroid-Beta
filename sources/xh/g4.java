...
public final class g4 extends za {
    public static final int f45906k0 = 0;
    public final String X;
    public final f4 Y;
    public final HorizontalScrollView Z;
    public final l3 f45907a0;
    public final l3 f45908b0;
    public final l3 f45909c0;
    public final l3 f45910d0;
    public final yh.l2 f45911e0;
    public yh.w0 f45912f0;
    public final HashSet f45913g0;
    public boolean f45914h0;
    public e4 f45915i0;
    public boolean f45916j0;

    public g4(final Context context, String str, final f4 f4Var) {
        super(2, context, (f6) null, false);
        this.f45913g0 = new HashSet();
        ...
        this.f45907a0 = l3Var;
        l3Var.setSorting(f4Var.f45897c.f46183p);
        ...
        l3Var2.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r4) {
                    case 0:
                        g4.R(this.f45828b, f4Var, context);
                        return;
                    case 1:
                        g4.W(this.f45828b, f4Var, context);
                        return;
                    default:
                        g4.S(this.f45828b, f4Var, context);
                        return;
                }
            }
        });
        l3 l3Var3 = new l3(context, this.resourcesProvider);
        this.f45909c0 = l3Var3;
        ...
        this.f45915i0.N(false);
        f4Var.d = new y3(this, 1);
    }

    public static void P(g4 g4Var, f4 f4Var) {
        n70 F = n70.F(g4Var.container, g4Var.resourcesProvider, g4Var.f45907a0);
        F.c(R.drawable.menu_sort_value, LocaleController.getString(t3.BY_PRICE.f46159a), new x3(f4Var, 3), false);
        F.c(R.drawable.menu_sort_date, LocaleController.getString(t3.BY_DATE.f46159a), new x3(f4Var, 4), false);
        F.c(R.drawable.menu_sort_number, LocaleController.getString(t3.BY_NUMBER.f46159a), new x3(f4Var, 5), false);
        F.f26388t = false;
        F.Y = true;
    ...
    public static void Q(g4 g4Var, f4 f4Var, int i10) {
        ...
        zf.b bVar;
        j51 G = g4Var.f45915i0.G(i10 - 1);
        if (G != null) {
            Object obj = G.G;
            if (obj instanceof TL_stars.StarGift) {
                TL_stars.StarGift starGift = (TL_stars.StarGift) obj;
                boolean z10 = G.f25133r;
                if (!TextUtils.isEmpty(starGift.gift_address) && g4Var.f45914h0) {
                    ...
                    if (!z10) {
                        ArrayList arrayList = f4Var.f45896b.f47526l;
    ...
    public static void R(g4 g4Var, f4 f4Var, Context context) {
        u3 u3Var = f4Var.f45897c;
        if (u3Var.f46174f.isEmpty()) {
            return;
        }
        n70 n70Var = new n70(g4Var.container, g4Var.resourcesProvider, g4Var.f45908b0, false, true, false);
        n70Var.f26388t = false;
        n70Var.Y = true;
        n70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        n70Var.R = true;
        n70Var.f26382p = new ii.h(n70Var, 8);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(u3Var.f46174f);
    ...
    public static void S(g4 g4Var, f4 f4Var, Context context) {
        ...
        n70 n70Var = new n70(g4Var.container, g4Var.resourcesProvider, g4Var.f45910d0, false, true, false);
        n70Var.f26388t = false;
        n70Var.Y = true;
        n70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        n70Var.R = true;
        n70Var.f26382p = new ii.h(n70Var, 7);
        String[] strArr = {""};
        ...
        if (f4Var != null) {
            ...
            if (n5Var != null && u3Var != null) {
                ...
                while (i12 < size) {
                    ...
                    if (!g4Var.f45913g0.contains(Long.valueOf(savedStarGift.gift.f18346id))) {
                ...
                if (!n5Var.f47523i && n5Var.f47524j) {
                    if (z11) {
    ...
    public static void V(g4 g4Var, TL_stars.TL_starGiftUnique tL_starGiftUnique, long j3, yh.d3 d3Var, nf.e eVar) {
        eVar.d();
        v5.x(g4Var.currentAccount, d3Var.f47101a).h(d3Var.f47102b, tL_starGiftUnique, j3, null, true, new org.telegram.tgnet.e(g4Var, eVar, tL_starGiftUnique, 6));
    }

    public static void W(g4 g4Var, f4 f4Var, Context context) {
        u3 u3Var = f4Var.f45897c;
        if (u3Var.f46175g.isEmpty()) {
            return;
        }
        n70 n70Var = new n70(g4Var.container, g4Var.resourcesProvider, g4Var.f45909c0, false, true, false);
        n70Var.f26388t = false;
        n70Var.Y = true;
        n70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        n70Var.R = true;
        n70Var.f26382p = new ii.h(n70Var, 6);
        String[] strArr = {""};
        ArrayList arrayList = new ArrayList(u3Var.f46175g);
    ...
    public final void Z() {
        ...
        while (true) {
            ...
            if ((childAt instanceof t00) && (S = RecyclerView.S(childAt) - 1) >= 0 && (G = this.f45915i0.G(S)) != null) {
                if (G.d < 10) {
                    z10 = true;
                } else {
                    z11 = true;
