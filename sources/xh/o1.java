...
public final class o1 extends i51 {
    ...
    public final void bindView(View view, j51 j51Var, boolean z10, x51 x51Var, f61 f61Var) {
        ...
        dc1 dc1Var = p1Var.f46085a;
        ArrayList arrayList2 = p1Var.d;
        if (p1Var.f46090r == i10) {
            z11 = true;
        } else {
            z11 = false;
        }
        ...
        if (arrayList2.size() != arrayList.size()) {
            ...
            while (i13 < arrayList.size()) {
                ...
                c90Var.setTextColor(j6.v(j6.w0(null, j6.f18825b6, false), j6.w0(null, j6.f18844c6, false)));
    ...
    public final boolean contentsEquals(j51 j51Var, j51 j51Var2) {
        if (j51Var.f25137z == j51Var2.f25137z && j51Var.H == j51Var2.H && equals(j51Var, j51Var2)) {
            return true;
        }
        return false;
    }
