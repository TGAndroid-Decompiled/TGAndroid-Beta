...
public final class o1 extends h51 {
    public static final int f46052a = 0;
    ...
    public final void bindView(View view, i51 i51Var, boolean z10, w51 w51Var, e61 e61Var) {
        ...
        bc1 bc1Var = p1Var.f46062a;
        ArrayList arrayList2 = p1Var.d;
        if (p1Var.f46067r == i10) {
            z11 = true;
        } else {
            z11 = false;
        }
        ...
        if (arrayList2.size() != arrayList.size()) {
            ...
            while (i13 < arrayList.size()) {
                ...
                c90Var.setTextColor(i6.v(i6.w0(null, i6.f18799b6, false), i6.w0(null, i6.f18818c6, false)));
                ...
                bc1Var.addView(c90Var, x5.n(-2, 26));
    ...
    public final boolean contentsEquals(i51 i51Var, i51 i51Var2) {
        if (i51Var.f24907z == i51Var2.f24907z && i51Var.H == i51Var2.H && equals(i51Var, i51Var2)) {
            return true;
        }
        return false;
    }
