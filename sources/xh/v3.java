...
public final class v3 implements l5 {
    ...
    public final Utilities.Callback f46451c;
    public int e;
    public long f46454i;
    public String f46462q;
    public boolean f46463r;
    public boolean f46464s;
    public boolean f46465t;
    public final ArrayList d = new ArrayList();
    public final ArrayList f46452f = new ArrayList();
    public final ArrayList f46453g = new ArrayList();
    public final ArrayList h = new ArrayList();
    public final HashSet f46455j = new HashSet();
    public final HashSet f46456k = new HashSet();
    public final HashSet f46457l = new HashSet();
    public final HashMap f46458m = new HashMap();
    public final HashMap f46459n = new HashMap();
    public final HashMap f46460o = new HashMap();
    public u3 f46461p = u3.BY_PRICE;
    public boolean f46466u = false;
    public int v = -1;

    public v3(long j3, int i10, Utilities.Callback callback) {
        this.f46449a = i10;
        this.f46450b = j3;
        this.f46451c = callback;
    }
    ...
    public final void f() {
        if (this.v >= 0) {
            ConnectionsManager.getInstance(this.f46449a).cancelRequest(this.v, true);
            this.v = -1;
        }
        this.f46465t = false;
    }
    ...
    public final void g(boolean z10) {
        if (!this.f46465t) {
            if (z10 || !this.f46466u) {
                ...
                getresalestargifts.gift_id = this.f46450b;
                String str = this.f46462q;
                if (str == null) {
                    str = "";
                }
                getresalestargifts.offset = str;
                getresalestargifts.limit = 15;
                getresalestargifts.for_craft = this.f46464s;
                getresalestargifts.stars_only = this.f46463r;
                u3 u3Var = this.f46461p;
                int i10 = 0;
                ...
                long j3 = this.f46454i;
                ArrayList arrayList = this.h;
                ArrayList arrayList2 = this.f46453g;
                ArrayList arrayList3 = this.f46452f;
                if (j3 != 0) {
                ...
                HashSet hashSet = this.f46455j;
                boolean isEmpty = hashSet.isEmpty();
                HashSet hashSet2 = this.f46457l;
                HashSet hashSet3 = this.f46456k;
                ...
                this.v = ConnectionsManager.getInstance(this.f46449a).sendRequest(getresalestargifts, new ui1(5, this, getresalestargifts));
            }
        }
    }
    ...
    public final void h() {
        ...
        this.d.clear();
        g(true);
        Utilities.Callback callback = this.f46451c;
        if (callback != null) {
