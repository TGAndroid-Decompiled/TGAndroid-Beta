...
public final class v3 implements Utilities.Callback2 {
    ...
    public final void run(Object obj, Object obj2) {
        ...
        f4 f4Var = this.f46183c;
        String[] strArr = this.f46182b;
        switch (i10) {
            case 0:
                ...
                boolean isEmpty = u3Var.f46149j.isEmpty();
                ...
                while (i11 < size) {
                    ...
                    boolean contains = u3Var.f46149j.contains(Long.valueOf(stargiftattributemodel.document.f18118id));
                    ...
                    if (TextUtils.isEmpty(lowerCase) || stargiftattributemodel.name.toLowerCase().startsWith(lowerCase) || stargiftattributemodel.name.toLowerCase().startsWith(translitSafe) || org.telegram.messenger.w1.w(" ", lowerCase, stargiftattributemodel.name.toLowerCase()) || org.telegram.messenger.w1.w(" ", translitSafe, stargiftattributemodel.name.toLowerCase())) {
                        Integer num = (Integer) u3Var.f46152m.get(Long.valueOf(stargiftattributemodel.document.f18118id));
                        if (num == null) {
                            intValue = 0;
                        } else {
            ...
            case 1:
                ...
                u3 u3Var2 = f4Var.f45869c;
                boolean isEmpty2 = u3Var2.f46150k.isEmpty();
                ...
                while (i13 < size2) {
                    ...
                    boolean contains2 = u3Var2.f46150k.contains(Integer.valueOf(stargiftattributebackdrop.backdrop_id));
                    ...
                    Integer num2 = (Integer) u3Var2.f46153n.get(Integer.valueOf(stargiftattributebackdrop.backdrop_id));
                    if (num2 == null) {
                        intValue2 = 0;
                    } else {
                    ...
                    J2.f24894l = lowerCase2;
                    J2.f24907z = intValue2;
            ...
            default:
                ...
                u3 u3Var3 = f4Var.f45869c;
                boolean isEmpty3 = u3Var3.f46151l.isEmpty();
                ...
                while (i15 < size3) {
                    ...
                    boolean contains3 = u3Var3.f46151l.contains(Long.valueOf(stargiftattributepattern.document.f18118id));
                    ...
                    if (!TextUtils.isEmpty(lowerCase3) && !stargiftattributepattern.name.toLowerCase().startsWith(lowerCase3) && !stargiftattributepattern.name.toLowerCase().startsWith(translitSafe3) && !org.telegram.messenger.w1.w(str3, lowerCase3, stargiftattributepattern.name.toLowerCase()) && !org.telegram.messenger.w1.w(str3, translitSafe3, stargiftattributepattern.name.toLowerCase())) {
                        ...
                        str2 = str3;
                        Integer num3 = (Integer) u3Var3.f46154o.get(Long.valueOf(stargiftattributepattern.document.f18118id));
                        if (num3 == null) {
                            intValue3 = 0;
                        } else {
                        ...
                        J3.f24894l = lowerCase3;
                        J3.f24907z = intValue3;
