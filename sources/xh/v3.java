...
public final class v3 implements l5 {
    ...
    public final Utilities.Callback f46453c;
    public int e;
    public long f46456i;
    public String f46464q;
    public boolean f46465r;
    public boolean f46466s;
    public boolean f46467t;
    public final ArrayList d = new ArrayList();
    public final ArrayList f46454f = new ArrayList();
    public final ArrayList f46455g = new ArrayList();
    public final ArrayList h = new ArrayList();
    public final HashSet f46457j = new HashSet();
    public final HashSet f46458k = new HashSet();
    public final HashSet f46459l = new HashSet();
    public final HashMap f46460m = new HashMap();
    public final HashMap f46461n = new HashMap();
    public final HashMap f46462o = new HashMap();
    public u3 f46463p = u3.BY_PRICE;
    public boolean f46468u = false;
    public int v = -1;

    public v3(long j3, int i10, Utilities.Callback callback) {
        this.f46451a = i10;
        this.f46452b = j3;
        this.f46453c = callback;
    }
    ...
    public final void f() {
        if (this.v >= 0) {
            ConnectionsManager.getInstance(this.f46451a).cancelRequest(this.v, true);
            this.v = -1;
        }
        this.f46467t = false;
    }
    ...
    public final void g(boolean z10) {
        if (!this.f46467t) {
            if (z10 || !this.f46468u) {
                ...
                getresalestargifts.gift_id = this.f46452b;
                String str = this.f46464q;
                if (str == null) {
                    str = "";
                }
                getresalestargifts.offset = str;
                getresalestargifts.limit = 15;
                getresalestargifts.for_craft = this.f46466s;
                getresalestargifts.stars_only = this.f46465r;
                u3 u3Var = this.f46463p;
                int i10 = 0;
                ...
                long j3 = this.f46456i;
                ArrayList arrayList = this.h;
                ArrayList arrayList2 = this.f46455g;
                ArrayList arrayList3 = this.f46454f;
                if (j3 != 0) {
                ...
                HashSet hashSet = this.f46457j;
                boolean isEmpty = hashSet.isEmpty();
                HashSet hashSet2 = this.f46459l;
                HashSet hashSet3 = this.f46458k;
                if (!isEmpty || !hashSet3.isEmpty() || !hashSet2.isEmpty()) {
                    ...
                    if (!hashSet.isEmpty()) {
                        ...
                        while (i11 < size) {
                            ...
                            if (!hashSet.contains(Long.valueOf(stargiftattributemodel.document.f18342id))) {
                                TL_stars.starGiftAttributeIdModel stargiftattributeidmodel = new TL_stars.starGiftAttributeIdModel();
                                stargiftattributeidmodel.document_id = stargiftattributemodel.document.f18342id;
                    ...
                    if (!hashSet2.isEmpty()) {
                        ...
                        while (i10 < size3) {
                            ...
                            if (!hashSet2.contains(Long.valueOf(stargiftattributepattern.document.f18342id))) {
                                TL_stars.starGiftAttributeIdPattern stargiftattributeidpattern = new TL_stars.starGiftAttributeIdPattern();
                                stargiftattributeidpattern.document_id = stargiftattributepattern.document.f18342id;
                                getresalestargifts.attributes.add(stargiftattributeidpattern);
                            }
                        }
                    }
                }
                this.v = ConnectionsManager.getInstance(this.f46451a).sendRequest(getresalestargifts, new ui1(5, this, getresalestargifts));
            }
        }
    }
    ...
    public final void h() {
        ...
        this.d.clear();
        g(true);
        Utilities.Callback callback = this.f46453c;
        if (callback != null) {
