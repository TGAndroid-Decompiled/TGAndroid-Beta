...
public abstract class j0 {
    public static final float[][] f45560a;
    public static final e0.i0 f45561b;
    ...
    public static void b(Canvas canvas, int i10, Paint paint, Bitmap bitmap, float f7, float f10, float f11) {
        ...
        while (true) {
            ...
            e0.i0.b((float[]) i0Var.f7091c, i12, 0.0f, 0.0f, width, height);
            i12++;
        }
        while (true) {
            float[] fArr = f45560a[i10];
            if (i11 < fArr.length) {
                ...
                float f18 = f14 * 1.0f;
                int i13 = i11 / 4;
                e0.i0.b((float[]) i0Var.f7090b, i13, AndroidUtilities.dp(f16) - (AndroidUtilities.dp(f18) / 2.0f), AndroidUtilities.dp(f17) - (AndroidUtilities.dp(f18) / 2.0f), (AndroidUtilities.dp(f18) / 2.0f) + AndroidUtilities.dp(f16), (AndroidUtilities.dp(f18) / 2.0f) + AndroidUtilities.dp(f17));
        ...
        if (f15 > 0.0f) {
            ...
            for (int i13 = 54; i12 < i13; i13 = 54) {
                ...
                if (i12 == 18 || i12 == 19 || i12 == 6 || i12 == 7) {
                    clamp01 = wr.f28821i.getInterpolation(clamp01);
                }
                float[] fArr3 = fArr;
                ...
                if (i14 < 0) {
                    f46 = AndroidUtilities.lerp(f18, f46, wr.f28821i.getInterpolation(clamp01));
                    a2 = AndroidUtilities.lerp(f19, a2, clamp01);
                    dpf27 = AndroidUtilities.lerp(AndroidUtilities.dpf2(8.0f), dpf27, clamp01);
                }
                if (a2 > f51 + AndroidUtilities.dp(8.0f)) {
                    f45 = 1.0f;
                    f14 = 1.0f - Utilities.clamp01((((a2 - max) - f13) - AndroidUtilities.dp(8.0f)) / AndroidUtilities.dp(56.0f));
                } else {
                    f45 = 1.0f;
                    f14 = 1.0f;
                }
