...
public final class l2 extends s4.v {
            ...
            if (r(savedStarGift)) {
                ...
                if (r(savedStarGift2)) {
                    ...
                    if (z10) {
                        ...
                        l5 l5Var = o2Var.e;
                        if (l5Var.f47342q == null) {
                            l5Var.f47342q = l5Var.h();
                        }
                        l5Var.k(b10, b11);
                    }
                    j2Var.Y2.p(b10, b11);
                    ...
                    if ((U instanceof ProfileActivity) && (g0Var = ((ProfileActivity) U).f31356v0) != null) {
                        g0Var.a();
                    }
                    return true;
                }
    ...
    public final void p(s4.c1 c1Var, int i10) {
        ...
        if (i10 == 0) {
            l5 l5Var = o2Var.e;
            if (l5Var != null) {
                ArrayList arrayList = l5Var.f47342q;
                if (arrayList != null) {
                    ArrayList h = l5Var.h();
