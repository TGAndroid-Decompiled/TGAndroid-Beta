...
public final class a extends u51 {
    ...
    public final void bindView(View view, v51 v51Var, boolean z10, j61 j61Var, r61 r61Var) {
        ...
        zz0 zz0Var = new zz0(bVar.getContext(), bVar.f46080a);
        zz0Var.a(spannableStringBuilder).setFilled(true);
        zz0Var.k(LocaleController.getString(R.string.Gift2AuctionsAcquiredRecipient), bVar.f46081b, DialogObject.getPeerDialogId(tL_StarGiftAuctionAcquiredGift.peer), new u2.p0(8, bVar, onClickListener));
