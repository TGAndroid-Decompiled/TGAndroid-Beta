...
public final class a extends h51 {
    public static final int f45790a = 0;
    ...
    public final void bindView(View view, i51 i51Var, boolean z10, w51 w51Var, e61 e61Var) {
        ...
        spannableStringBuilder.setSpan(new x5(auction.giftDocumentId, i6.f19107s2.getFontMetricsInt()), 0, spannableStringBuilder.length(), 33);
        ...
        pz0 pz0Var = new pz0(bVar.getContext(), bVar.f45803a);
        pz0Var.a(spannableStringBuilder).setFilled(true);
        pz0Var.k(LocaleController.getString(R.string.Gift2AuctionsAcquiredRecipient), bVar.f45804b, DialogObject.getPeerDialogId(tL_StarGiftAuctionAcquiredGift.peer), new uh.i(3, bVar, onClickListener));
