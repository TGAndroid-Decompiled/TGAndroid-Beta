...
public final class t4 extends org.telegram.ui.Cells.f3 {
    public final y4 E;
    public final ch.f f46160x;
    public final int f46161y;
    ...
    public final void b() {
        ...
        TLRPC.MessageAction messageAction = y4Var.f46251l0;
        ...
        CharSequence[] charSequenceArr = {y4Var.f46257s0.getText()};
        tL_textWithEntities.entities = MediaDataController.getInstance(this.f46161y).getEntities(charSequenceArr, true);
        tL_textWithEntities.text = charSequenceArr[0].toString();
        messageObject.setType();
        y4Var.f46250k0.U(messageObject, true);
        y4Var.f46258t0.N(true);
        y4Var.Z(true);
    }
