...
public final class t4 extends org.telegram.ui.Cells.f3 {
    public final y4 E;
    public final ch.f f46132x;
    public final int f46133y;
    ...
    public final void b() {
        ...
        TLRPC.MessageAction messageAction = y4Var.f46223l0;
        ...
        CharSequence[] charSequenceArr = {y4Var.f46229s0.getText()};
        tL_textWithEntities.entities = MediaDataController.getInstance(this.f46133y).getEntities(charSequenceArr, true);
        tL_textWithEntities.text = charSequenceArr[0].toString();
        messageObject.setType();
        y4Var.f46222k0.U(messageObject, true);
        y4Var.f46230t0.N(true);
        y4Var.Z(true);
    }
