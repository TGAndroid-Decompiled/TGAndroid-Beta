...
public final class d implements ServiceConnection {
    ...
    public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        switch (this.f329a) {
            case 0:
                e eVar2 = (e) this.f330b;
                eVar2.f333b.b("ServiceConnectionImpl.onServiceConnected(%s)", componentName);
            ...
            case 1:
                ...
                c5.d0 d0Var = (c5.d0) this.f330b;
                int i10 = com.google.android.gms.internal.play_billing.f.f5768b;
                if (iBinder != null) {
            ...
            case 2:
                ...
                if (((of.d) ((WeakReference) this.f330b).get()) != null) {
                    of.f.f17007b = aVar2;
                    if (MessagesController.getInstance(UserConfig.selectedAccount).isWebBrowserUseCustomTabs() && (aVar = of.f.f17007b) != null) {
                        try {
                            ((vf.c) ((vf.e) aVar.f16769b)).H0();
                            return;
            ...
            default:
                ...
                fg.f fVar = (fg.f) this.f330b;
                LinkedBlockingDeque linkedBlockingDeque = (LinkedBlockingDeque) fVar.f9494c;
                sb2.append(linkedBlockingDeque.size());
                Log.d("SessionLifecycleClient", sb2.toString());
                fVar.f9493b = new Messenger(iBinder);
                ArrayList arrayList = new ArrayList();
                linkedBlockingDeque.drainTo(arrayList);
                zd.e0.q(zd.e0.b((id.h) fVar.f9492a), new bb.j(fVar, arrayList, null, 6));
                return;
        }
    }
    ...
    public final void onServiceDisconnected(ComponentName componentName) {
        switch (this.f329a) {
            case 0:
                e eVar = (e) this.f330b;
                eVar.f333b.b("ServiceConnectionImpl.onServiceDisconnected(%s)", componentName);
