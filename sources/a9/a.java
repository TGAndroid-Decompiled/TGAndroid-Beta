...
public abstract class a implements IInterface {
    ...
    public void H0(Parcel parcel, int i10) {
        try {
            this.f313b.transact(i10, parcel, null, 1);
        } finally {
            parcel.recycle();
        }
    }
    ...
    public void J0(Parcel parcel, int i10) {
        Parcel obtain = Parcel.obtain();
        try {
            this.f313b.transact(i10, parcel, obtain, 0);
    ...
    public Parcel O0() {
        switch (this.f312a) {
            ...
            case 7:
                ...
                obtain2.writeInterfaceToken(this.f314c);
                return obtain2;
            case 8:
                Parcel obtain3 = Parcel.obtain();
                obtain3.writeInterfaceToken(this.f314c);
                return obtain3;
            case 9:
                Parcel obtain4 = Parcel.obtain();
                obtain4.writeInterfaceToken(this.f314c);
                return obtain4;
            default:
                Parcel obtain5 = Parcel.obtain();
                obtain5.writeInterfaceToken(this.f314c);
                return obtain5;
        }
    }
    ...
    public Parcel Q0(Parcel parcel, int i10) {
        switch (this.f312a) {
            ...
            case 10:
                ...
                try {
                    try {
                        this.f313b.transact(i10, parcel, obtain2, 0);
            ...
            default:
                ...
                try {
                    try {
                        this.f313b.transact(i10, parcel, obtain3, 0);
    ...
    public void R0(Parcel parcel) {
        Parcel obtain = Parcel.obtain();
        try {
            this.f313b.transact(3, parcel, obtain, 0);
            obtain.readException();
        } finally {
            parcel.recycle();
            obtain.recycle();
