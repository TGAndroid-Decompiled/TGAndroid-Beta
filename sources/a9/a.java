...
public final class a implements f6 {
    ...
    public a(int i10) {
        switch (i10) {
            case 8:
                this.f142a = new int[]{2131230820, 2131230818, 2131230744};
                this.f143b = new int[]{2131230768, 2131230803, 2131230775, 2131230770, 2131230771, 2131230774, 2131230773};
                this.f144c = new int[]{2131230817, 2131230819, 2131230761, 2131230813, 2131230814, 2131230815, 2131230816};
                this.d = new int[]{2131230793, 2131230759, 2131230792};
                this.e = new int[]{2131230811, 2131230821};
                this.f145f = new int[]{2131230747, 2131230753, 2131230748, 2131230754};
                return;
            case 9:
                Paint paint = new Paint(1);
                this.f142a = paint;
                this.d = new RectF();
                this.f145f = new Matrix();
                Bitmap createBitmap = Bitmap.createBitmap(30, 40, Bitmap.Config.ARGB_8888);
                this.f144c = createBitmap;
                this.f143b = new Canvas(createBitmap);
            ...
            case 10:
                ...
                this.f145f = new ArrayList();
                return;
            default:
                this.f142a = new Bundle();
                this.f143b = "AssistAction";
                return;
        }
    }
    ...
    public static void A(Drawable drawable, int i10, PorterDuff.Mode mode) {
        ...
        PorterDuff.Mode mode2 = q.f13586b;
    ...
    public static l0 b(l0 l0Var, e eVar, s3 s3Var) {
        String str;
        a a2 = l0Var.a();
        String d = ((c) eVar.f9309b).d();
        if (d != null) {
            a2.e = new v0(d);
        } else if (Log.isLoggable("FirebaseCrashlytics", 2)) {
            Log.v("FirebaseCrashlytics", "No log data to include with this event.", null);
        }
        List q10 = q(((d) ((AtomicMarkableReference) ((m) s3Var.d).f2256b).getReference()).a());
        List q11 = q(((d) ((AtomicMarkableReference) ((m) s3Var.e).f2256b).getReference()).a());
        if (!q10.isEmpty() || !q11.isEmpty()) {
            m0 m0Var = (m0) l0Var.f10171c;
            s1 s1Var = m0Var.f10177a;
            Boolean bool = m0Var.d;
            t1 t1Var = m0Var.e;
            List list = m0Var.f10180f;
            int i10 = m0Var.f10181g;
            if (s1Var == null) {
                str = " execution";
            } else {
                str = "";
            ...
            if (str.isEmpty()) {
                a2.f144c = new m0(s1Var, q10, q11, bool, t1Var, list, i10);
            } else {
    ...
    public static a2 d(l0 l0Var, s3 s3Var) {
        ...
        for (int i10 = 0; i10 < h.size(); i10++) {
            ...
            String str = bVar.e;
            if (str != null) {
                String str2 = bVar.f9301b;
                if (str2 != null) {
                    obj.f4005b = new x0(str2, str);
                    String str3 = bVar.f9302c;
                    if (str3 != null) {
                        obj.f4004a = str3;
                        String str4 = bVar.d;
                        if (str4 != null) {
                            obj.f4006c = str4;
                            obj.d = Long.valueOf(bVar.f9303f);
                            arrayList.add(obj.c());
                        } else {
    ...
    public static a k(Context context, i9.w wVar, n9.b bVar, i9.a aVar, e eVar, s3 s3Var, c0 c0Var, g gVar, f7.b bVar2, k kVar) {
        ...
        l9.a aVar3 = o9.a.f16484b;
        y2.q.b(context);
        o9.a aVar4 = new o9.a(new o9.c(y2.q.a().c(new w2.a(o9.a.f16485c, o9.a.d)).a("FIREBASE_CRASHLYTICS_REPORT", new v2.c("json"), o9.a.e), gVar.d(), bVar2));
        ?? obj = new Object();
        obj.f142a = qVar;
        obj.f143b = aVar2;
        obj.f144c = aVar4;
    ...
    public static ColorStateList m(Context context, int i10) {
        ...
        return new ColorStateList(new int[][]{d3.f13468b, d3.d, d3.f13469c, d3.f13470f}, new int[]{d3.b(context, 2130968726), i0.a.h(c3, i10), i0.a.h(c3, i10), i10});
    }
    ...
    public static boolean s(v vVar, Object obj, boolean z4, int i10, int i11, int i12) {
        ...
        if (!z4 || i13 != i10 || vVar.f16408c != i11) {
    ...
    public Task B(String str, String str2, Bundle bundle) {
        ...
        try {
            y(str, str2, bundle);
            x5.a aVar = (x5.a) this.f144c;
            l lVar = l.f46893a;
            p2.g gVar = aVar.f46873c;
            if (gVar.g() < 12000000) {
                if (gVar.h() != 0) {
                    return aVar.a(bundle).continueWithTask(lVar, new c0(17, aVar, bundle));
                }
                return Tasks.forException(new IOException("MISSING_INSTANCEID_SERVICE"));
            }
            x5.k d = x5.k.d(aVar.f46872b);
            synchronized (d) {
                i10 = d.f46890a;
                d.f46890a = i10 + 1;
            }
            return d.e(new j(i10, 1, bundle, 1)).continueWith(lVar, x5.b.f46876a);
    ...
    public void C(boolean z4) {
        ArrayList arrayList = (ArrayList) this.f144c;
        ArrayList arrayList2 = (ArrayList) this.f143b;
        ArrayList arrayList3 = (ArrayList) this.f142a;
        ...
        for (int i12 = 0; i12 < arrayList.size(); i12++) {
            ...
            if (z4) {
                ValueAnimator ofFloat3 = ValueAnimator.ofFloat(((Float) ((ArrayList) this.f145f).get(i12)).floatValue(), 0.0f);
    ...
    public void D() {
        Bitmap bitmap = (Bitmap) this.f144c;
        RectF rectF = (RectF) this.d;
        Matrix matrix = (Matrix) this.f145f;
    ...
    public void E(o2 o2Var) {
        ...
        if (((s8.v) this.f143b).isEmpty()) {
            e(e0Var, (v) this.e, o2Var);
            if (!b7.a((v) this.f145f, (v) this.e)) {
                e(e0Var, (v) this.f145f, o2Var);
            }
            if (!b7.a((v) this.d, (v) this.e) && !b7.a((v) this.d, (v) this.f145f)) {
                e(e0Var, (v) this.d, o2Var);
            }
        } else {
            for (int i10 = 0; i10 < ((s8.v) this.f143b).size(); i10++) {
                e(e0Var, (v) ((s8.v) this.f143b).get(i10), o2Var);
            }
            if (!((s8.v) this.f143b).contains((v) this.d)) {
                e(e0Var, (v) this.d, o2Var);
            }
        }
        this.f144c = e0Var.d();
    ...
    public Paint G(String str) {
        ...
        switch (c3) {
            case 0:
                return (TextPaint) this.f143b;
            case 1:
                return (TextPaint) this.f144c;
            case 2:
                return (Paint) this.e;
            case 3:
                return (Paint) this.d;
            case 4:
                return (TextPaint) this.f142a;
            default:
                return j6.S0(str);
        }
    }
    ...
    @Override
    public boolean a() {
        return ((o4) this.f145f).f4367y0;
    }

    public void c(String str, String str2) {
        HashMap hashMap = (HashMap) this.f145f;
        if (hashMap != null) {
    ...
    public void e(e0 e0Var, v vVar, o2 o2Var) {
        if (vVar != null) {
            if (o2Var.b(vVar.f16406a) != -1) {
                e0Var.x(vVar, o2Var);
                return;
            }
            o2 o2Var2 = (o2) ((n0) this.f144c).get(vVar);
            if (o2Var2 != null) {
                e0Var.x(vVar, o2Var2);
            }
        }
    ...
    public b9.b g() {
        String str;
        String str2;
        b6.m.i((String) this.f145f, "setActionToken is required before calling build().");
        new String((String) this.e);
        u("actionToken", (String) this.f145f);
        String str3 = (String) this.f144c;
        String str4 = null;
        if (str3 == null) {
            str = null;
        } else {
        ...
        if (str4 == null) {
            String valueOf = String.valueOf((String) this.f145f);
            if (valueOf.length() != 0) {
        ...
        b6.m.i((String) this.f144c, "setObject is required before calling build().");
        b6.m.i((String) this.d, "setObject is required before calling build().");
        return new b9.b((String) this.f143b, (String) this.f144c, (String) this.d, null, new b9.a(), (String) this.e, (Bundle) this.f142a);
    }

    @Override
    public Drawable getDrawable(String str) {
        o4 o4Var = (o4) this.f145f;
        a aVar = o4Var.A0;
    ...
    public l0 h() {
        String str;
        if (((Long) this.f142a) == null) {
            str = " timestamp";
        } else {
            str = "";
        }
        if (((String) this.f143b) == null) {
            str = str.concat(" type");
        }
        if (((u1) this.f144c) == null) {
            str = w2.k(str, " app");
        }
        if (((v1) this.d) == null) {
            str = w2.k(str, " device");
        ...
        if (str.isEmpty()) {
            return new l0(((Long) this.f142a).longValue(), (String) this.f143b, (u1) this.f144c, (v1) this.d, (w1) this.e, (z1) this.f145f);
        }
        throw new IllegalStateException("Missing required properties:".concat(str));
    }
    ...
    public u0 i() {
        String str;
        if (((Integer) this.f143b) == null) {
            str = " batteryVelocity";
        } else {
            str = "";
        }
        if (((Boolean) this.f144c) == null) {
        ...
        if (((Long) this.f145f) == null) {
            str = w2.k(str, " diskUsed");
        }
        if (str.isEmpty()) {
            return new u0((Double) this.f142a, ((Integer) this.f143b).intValue(), ((Boolean) this.f144c).booleanValue(), ((Integer) this.d).intValue(), ((Long) this.e).longValue(), ((Long) this.f145f).longValue());
        }
        throw new IllegalStateException("Missing required properties:".concat(str));
    }
    ...
    public h j() {
        ...
        if (((HashMap) this.f145f) == null) {
            str = w2.k(str, " autoMetadata");
        }
        if (str.isEmpty()) {
            return new h((String) this.f143b, (Integer) this.f142a, (y2.l) this.f144c, ((Long) this.d).longValue(), ((Long) this.e).longValue(), (HashMap) this.f145f);
        }
        throw new IllegalStateException("Missing required properties:".concat(str));
    }
    ...
    public void t(Throwable th2, Thread thread, String str, String str2, long j10, boolean z4) {
        ...
        ?? obj = new Object();
        obj.f143b = str2;
        obj.f142a = Long.valueOf(j10);
        t1 b10 = f9.c.f6096a.b(context);
        int i11 = ((t0) b10).f10229c;
        if (i11 > 0) {
            if (i11 != 100) {
                z10 = true;
            } else {
        ...
        if (name != null) {
            ...
            if (d != null) {
                ...
                List a10 = qVar.a();
                if (a10 != null) {
                    obj.f144c = new m0(new k9.n0(unmodifiableList, c3, null, q0Var, a10), null, null, bool2, b10, a2, i10);
                    obj.d = qVar.b(i10);
                    l0 h = obj.h();
                    s3 s3Var = (s3) this.e;
                    ((n9.a) this.f143b).d(d(b(h, (e) this.d, s3Var), s3Var), str, equals);
                    return;
                }
    ...
    public void u(String str, String... strArr) {
        Bundle bundle = (Bundle) this.f142a;
    ...
    public Task v(Executor executor, String str) {
        ...
        String str2;
        ArrayList b10 = ((n9.a) this.f143b).b();
        ArrayList arrayList = new ArrayList();
        int size = b10.size();
        int i10 = 0;
        while (i10 < size) {
        ...
        while (i12 < size2) {
            ...
            if (str == null || str.equals(bVar.f7357b)) {
                o9.a aVar2 = (o9.a) this.f144c;
                if (bVar.f7356a.f10050f == null) {
                    try {
                        str2 = (String) y.a(((ca.c) ((i9.w) this.f145f).d).d());
                    } catch (Exception e10) {
                    ...
                    g8 a2 = bVar.f7356a.a();
                    a2.d = str2;
                    bVar = new i9.b(a2.a(), bVar.f7357b, bVar.f7358c);
                }
                if (str != null) {
                    z4 = true;
                } else {
                ...
                o9.c cVar = aVar2.f16486a;
                synchronized (cVar.f16493f) {
                    try {
                        taskCompletionSource = new TaskCompletionSource();
                        if (z4) {
                            ((AtomicInteger) cVar.f16495i.f6001b).getAndIncrement();
                            if (cVar.f16493f.size() < cVar.e) {
                                f9.b bVar2 = f9.b.f6095a;
                                bVar2.b("Enqueueing report: " + bVar.f7357b);
                                bVar2.b("Queue size: " + cVar.f16493f.size());
                                cVar.f16494g.execute(new com.google.android.gms.common.api.internal.s1(cVar, bVar, taskCompletionSource, 7));
                                bVar2.b("Closing task for report: " + bVar.f7357b);
                                taskCompletionSource.trySetResult(bVar);
                            } else {
                                cVar.a();
                                String str3 = "Dropping report due to queue being full: " + bVar.f7357b;
                                if (Log.isLoggable("FirebaseCrashlytics", 3)) {
                                    Log.d("FirebaseCrashlytics", str3, null);
                                }
                                ((AtomicInteger) cVar.f16495i.f6002c).getAndIncrement();
                                taskCompletionSource.trySetResult(bVar);
                            }
                        } else {
    ...
    public int x0(int i10) {
        return ((o4) this.f145f).f4368z0.get(i10, j6.w0(null, i10, false));
    }
