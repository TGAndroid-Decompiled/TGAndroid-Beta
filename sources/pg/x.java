...
public final class x extends g3 {
    public static final int f41057s = 0;
    public final ai.d1 f41058b;
    ...
    public final void dismiss() {
        ...
        q0.a aVar = this.h;
        if (aVar != null) {
            aVar.accept(Integer.valueOf(this.f41060f));
        }
    }
    ...
    public final void m(int i10, int i11) {
        ...
        if (!editTextBoldCursor.isFocused()) {
            ...
            StringBuilder sb2 = new StringBuilder(Integer.toHexString(wVar.f41054f.f41060f));
            while (sb2.length() < 8) {
                sb2.insert(0, "0");
            }
