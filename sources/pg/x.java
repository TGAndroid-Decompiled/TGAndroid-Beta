...
public final class x extends f3 {
    public static final int f41031s = 0;
    public final ai.d1 f41032b;
    public final ImageView f41033c;
    public final q6 d;
    public final Path e;
    public int f41034f;
    public q0.a h;
    ...
    public final void dismiss() {
        ...
        q0.a aVar = this.h;
        if (aVar != null) {
            aVar.accept(Integer.valueOf(this.f41034f));
        }
    }
    ...
    public final void m(int i10, int i11) {
        ...
        if (!editTextBoldCursor.isFocused()) {
            ...
            StringBuilder sb2 = new StringBuilder(Integer.toHexString(wVar.f41028f.f41034f));
            while (sb2.length() < 8) {
                sb2.insert(0, "0");
            }
