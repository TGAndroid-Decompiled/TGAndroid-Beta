...
public final class t extends View {
    public final Paint f40997a;
    public final int[] f40998b;
    public final Paint f40999c;
    public final LongSparseArray d;
    public long e;
    public final Path f41000f;
    public final float[] h;
    public final HashMap f41001n;
    public final x f41002r;

    public t(x xVar, Context context) {
        super(context);
        int d;
        this.f41002r = xVar;
        this.f40997a = new Paint(1);
        this.f40998b = new int[]{-16735784, -16752387, -11788361, -6804548, -4707235, -180718, -38656, -152832, -211200, -198077, -2495689, -8996289};
        Paint paint = new Paint(1);
        this.f40999c = paint;
        this.d = new LongSparseArray();
        this.e = Long.MIN_VALUE;
        this.f41000f = new Path();
        this.h = new float[8];
        this.f41001n = new HashMap();
        ...
        for (int i10 = 0; i10 < 12; i10++) {
            for (int i11 = 0; i11 < 10; i11++) {
                if (i11 == 0) {
                    this.f41001n.put(Long.valueOf((i10 << 16) + i11), Integer.valueOf(i0.a.d(i10 / 11.0f, -1, -16777216)));
                } else {
                    if (i11 < 6) {
                        d = i0.a.d(((5 - i11) / 4.0f) * 0.5f, this.f40998b[i10], -16777216);
                    } else {
                        d = i0.a.d(vl.c(9 - i11, 5.0f, 0.5f, 0.5f), this.f40998b[i10], -1);
                    }
                    this.f41001n.put(Long.valueOf((i10 << 16) + i11), Integer.valueOf(d));
                }
            }
        }
    }
    ...
    public final void a(int i10) {
        for (Map.Entry entry : this.f41001n.entrySet()) {
    ...
    public final void c(MotionEvent motionEvent) {
        ...
        Integer num = (Integer) this.f41001n.get(Long.valueOf((x10 << 16) + y3));
        if (num != null) {
            int intValue = num.intValue();
            int i10 = x.f41031s;
            this.f41002r.m(intValue, 3);
            b(x10, y3);
        }
    }
