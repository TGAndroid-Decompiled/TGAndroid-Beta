...
public final class t extends View {
    ...
    public final HashMap f41260n;
    public final x f41261r;

    public t(x xVar, Context context) {
        super(context);
        int d;
        this.f41261r = xVar;
        this.f41256a = new Paint(1);
        this.f41257b = new int[]{-16735784, -16752387, -11788361, -6804548, -4707235, -180718, -38656, -152832, -211200, -198077, -2495689, -8996289};
        ...
        for (int i10 = 0; i10 < 12; i10++) {
            for (int i11 = 0; i11 < 10; i11++) {
                if (i11 == 0) {
                    this.f41260n.put(Long.valueOf((i10 << 16) + i11), Integer.valueOf(i0.a.d(i10 / 11.0f, -1, -16777216)));
                } else {
                    if (i11 < 6) {
                        d = i0.a.d(((5 - i11) / 4.0f) * 0.5f, this.f41257b[i10], -16777216);
                    } else {
                        d = i0.a.d(ok.b(9 - i11, 5.0f, 0.5f, 0.5f), this.f41257b[i10], -1);
                    }
                    this.f41260n.put(Long.valueOf((i10 << 16) + i11), Integer.valueOf(d));
                }
            }
        }
    }
    ...
    public final void a(int i10) {
        for (Map.Entry entry : this.f41260n.entrySet()) {
    ...
    public final void c(MotionEvent motionEvent) {
        ...
        Integer num = (Integer) this.f41260n.get(Long.valueOf((x10 << 16) + y3));
        if (num != null) {
            int intValue = num.intValue();
            int i10 = x.f41304s;
            this.f41261r.m(intValue, 3);
            b(x10, y3);
        }
    }
