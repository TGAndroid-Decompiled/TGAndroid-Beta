...
public final class n0 implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final void onAnimationUpdate(final ValueAnimator valueAnimator) {
        switch (this.f41178a) {
            case 0:
                final s0 s0Var = this.f41179b;
                s0Var.f41225f.f(new Runnable() {
                    @Override
                ...
                return;
            default:
                final s0 s0Var2 = this.f41179b;
                s0Var2.f41225f.f(new Runnable() {
                    @Override
                    public final void run() {
                        switch (r3) {
                            case 0:
