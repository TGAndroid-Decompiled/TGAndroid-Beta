...
public final class l0 implements Runnable {
    ...
    public final void run() {
        ...
        boolean z11 = this.f41150b;
        Object obj = this.e;
        Object obj2 = this.d;
        Object obj3 = this.f41151c;
        switch (i12) {
            case 0:
                s0 s0Var = (s0) obj3;
                s0Var.f41210f.f(new q0(s0Var, (a5.a) obj2, 0));
                s0Var.f41210f.f(new q0(s0Var, (a5.a) obj, 0));
                s0Var.E = z11;
                return;
            case 1:
                yc ycVar = (yc) obj3;
            ...
            default:
                ...
                int i14 = k5Var.f47593a;
                if (((int[]) obj2)[0] == k5Var.f47602m) {
                    k5Var.f47598i = false;
                    k5Var.f47602m = -1;
                    if (tLObject instanceof TL_stars.TL_payments_savedStarGifts) {
                        ...
                        k5Var.f47600k = tL_payments_savedStarGifts.next_offset;
                        k5Var.f47603n = tL_payments_savedStarGifts.count;
                        ...
                        k5Var.h = bool;
                        if (arrayList.size() <= k5Var.f47603n && k5Var.f47600k != null) {
                            z10 = false;
                        } else {
                            z10 = true;
                        }
                    ...
                    NotificationCenter.getInstance(i14).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starUserGiftsLoaded, Long.valueOf(k5Var.f47594b), k5Var);
                    return;
                }
                return;
        }
