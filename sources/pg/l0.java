...
public final class l0 implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final void onAnimationUpdate(final ValueAnimator valueAnimator) {
        switch (this.f40904a) {
            case 0:
                final q0 q0Var = this.f40905b;
                q0Var.f40947f.f(new Runnable() {
                    @Override
                ...
                return;
            default:
                final q0 q0Var2 = this.f40905b;
                q0Var2.f40947f.f(new Runnable() {
                    @Override
                    public final void run() {
                        switch (r3) {
                            case 0:
