...
public final class l0 implements Runnable {
    ...
    public final void run() {
        ...
        Boolean bool;
        boolean z10;
        int i12 = this.f41152a;
        boolean z11 = this.f41153b;
        Object obj = this.e;
        Object obj2 = this.d;
        Object obj3 = this.f41154c;
        switch (i12) {
            case 0:
                s0 s0Var = (s0) obj3;
            ...
            case 1:
                ...
                qc M = xcVar.M(string, AndroidUtilities.replaceSingleTag(string2, j6.Gi, 0, new tg.c(chat), e6Var), i13);
                M.f27550j = 5000;
                M.j();
                return;
            default:
                ...
                int i14 = l5Var.f47642a;
                if (((int[]) obj2)[0] == l5Var.f47651m) {
                    l5Var.f47647i = false;
                    l5Var.f47651m = -1;
                    if (tLObject instanceof TL_stars.TL_payments_savedStarGifts) {
                        ...
                        l5Var.f47649k = tL_payments_savedStarGifts.next_offset;
                        l5Var.f47652n = tL_payments_savedStarGifts.count;
                        ...
                        l5Var.h = bool;
                        if (arrayList.size() <= l5Var.f47652n && l5Var.f47649k != null) {
                            z10 = false;
                        } else {
                            z10 = true;
                        }
                    ...
                    NotificationCenter.getInstance(i14).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starUserGiftsLoaded, Long.valueOf(l5Var.f47643b), l5Var);
                    return;
                }
                return;
        }
