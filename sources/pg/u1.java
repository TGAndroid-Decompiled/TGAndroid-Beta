...
public final class u1 {
    ...
    public static int b(vv0 vv0Var) {
        int i10 = (int) vv0Var.f29774a;
        int i11 = (int) vv0Var.f29775b;
        int[] iArr = new int[1];
    ...
    public final void a(boolean z10) {
        ...
        if (i10 != 0) {
            ...
            this.f41283b = 0;
            if (z10 && (bitmap = this.f41282a) != null && !bitmap.isRecycled()) {
                bitmap.recycle();
            }
        }
    }
    ...
    public final int c() {
        ...
        GLES20.glTexParameteri(3553, 10241, 9729);
        try {
            GLUtils.texImage2D(3553, 0, 6408, this.f41282a, 5121, 0);
        } catch (Exception e) {
            FileLog.e(e);
            ...
            this.f41282a.getPixels(iArr2, 0, width, 0, 0, width, height);
