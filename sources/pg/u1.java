...
public final class u1 {
    ...
    public static int b(wv0 wv0Var) {
        int i10 = (int) wv0Var.f30161a;
        int i11 = (int) wv0Var.f30162b;
        int[] iArr = new int[1];
    ...
    public final void a(boolean z10) {
        ...
        if (i10 != 0) {
            ...
            this.f41333b = 0;
            if (z10 && (bitmap = this.f41332a) != null && !bitmap.isRecycled()) {
                bitmap.recycle();
            }
        }
    }
    ...
    public final int c() {
        ...
        GLES20.glTexParameteri(3553, 10241, 9729);
        try {
            GLUtils.texImage2D(3553, 0, 6408, this.f41332a, 5121, 0);
        } catch (Exception e) {
            FileLog.e(e);
            ...
            this.f41332a.getPixels(iArr2, 0, width, 0, 0, width, height);
