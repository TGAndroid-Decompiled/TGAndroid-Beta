...
public final class u1 {
    ...
    public static int b(uv0 uv0Var) {
        int i10 = (int) uv0Var.f28926a;
        int i11 = (int) uv0Var.f28927b;
        int[] iArr = new int[1];
    ...
    public final void a(boolean z10) {
        ...
        if (i10 != 0) {
            ...
            this.f41270b = 0;
            if (z10 && (bitmap = this.f41269a) != null && !bitmap.isRecycled()) {
                bitmap.recycle();
            }
        }
    }
    ...
    public final int c() {
        ...
        GLES20.glTexParameteri(3553, 10241, 9729);
        try {
            GLUtils.texImage2D(3553, 0, 6408, this.f41269a, 5121, 0);
        } catch (Exception e) {
            FileLog.e(e);
            ...
            this.f41269a.getPixels(iArr2, 0, width, 0, 0, width, height);
