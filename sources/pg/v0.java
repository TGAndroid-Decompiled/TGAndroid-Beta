...
public final class v0 {
    ...
    public final PointF f41291c;
    public final PointF d;
    public final float e;
    public final PointF f41292f;
    public final PointF f41293g;
    ...
    public v0(t8.a aVar, Bitmap bitmap, uv0 uv0Var, boolean z10) {
        ...
        PointF pointF3 = null;
        PointF pointF4 = null;
        for (t8.d dVar : aVar.f43326b) {
            PointF pointF5 = dVar.f43333a;
            int i10 = dVar.f43334b;
            if (i10 != 4) {
                if (i10 != 5) {
                    if (i10 != 10) {
                        if (i10 == 11) {
        ...
        if (pointF != null && pointF2 != null) {
            ...
            this.e = hypot;
            this.f41290b = (float) Math.toDegrees(Math.atan2(pointF2.y - pointF.y, pointF2.x - pointF.x) + 3.141592653589793d);
            this.f41289a = 2.35f * hypot;
            float f7 = hypot * 0.8f;
            float f10 = pointF7.x;
            double radians = (float) Math.toRadians(degrees - 90.0f);
            this.f41291c = new PointF((((float) Math.cos(radians)) * f7) + f10, (f7 * ((float) Math.sin(radians))) + pointF7.y);
        }
        if (pointF3 != null && pointF4 != null) {
            ...
            this.f41292f = pointF9;
            float f11 = this.e * 0.7f;
            float f12 = pointF9.x;
            double radians2 = (float) Math.toRadians(this.f41290b + 90.0f);
            this.f41293g = new PointF((((float) Math.cos(radians2)) * f11) + f12, (f11 * ((float) Math.sin(radians2))) + pointF9.y);
        }
    }
    ...
    public static PointF b(PointF pointF, Bitmap bitmap, uv0 uv0Var, boolean z10) {
        ...
        return new PointF((uv0Var.f28932a * pointF.x) / f7, (uv0Var.f28933b * pointF.y) / height);
    }
