...
public class s0 extends View {
    ...
    public final Paint f40285f;
    public final Drawable h;
    public boolean f40286n;
    public final ImageReceiver f40287r;
    public final ImageReceiver f40288s;
    public TLRPC.Document v;
    public TLRPC.Document f40289w;
    public boolean f40290x;
    public final float f40291y;
    ...
    public s0(Context context, float f7) {
        ...
        this.e = textPaint;
        this.f40285f = new Paint(1);
        ImageReceiver imageReceiver = new ImageReceiver(this);
        this.f40287r = imageReceiver;
        ImageReceiver imageReceiver2 = new ImageReceiver(this);
        this.f40288s = imageReceiver2;
        this.E = 1.0f;
        this.O = new RectF();
        new Path();
    ...
    public static org.telegram.tgnet.TLRPC.Document b(java.lang.String r8, org.telegram.tgnet.TLRPC.TL_messages_stickerSet r9) {
        throw new UnsupportedOperationException("Method not decompiled: pg.s0.b(java.lang.String, org.telegram.tgnet.TLRPC$TL_messages_stickerSet):org.telegram.tgnet.TLRPC$Document");
    }
    ...
    public final void a(Canvas canvas) {
        ...
        canvas.drawRoundRect(rectF, f12, f12, this.f40285f);
        boolean z10 = this.f40286n;
        float f13 = this.f40291y;
        RectF rectF2 = this.d;
        if (z10) {
            ...
            if (e > 0.0f) {
                ...
                ImageReceiver imageReceiver = this.f40288s;
            ...
            if (e < 1.0f) {
                ...
                ImageReceiver imageReceiver2 = this.f40287r;
        ...
        if (isEmpty) {
            ...
            MediaDataController.getInstance(i10).getStickerSet(tL_inputStickerSetShortName, 0, false, new Utilities.Callback(this) {
                ...
                public final void run(Object obj) {
                    switch (r3) {
                        case 0:
                            s0 s0Var = this.f40270b;
                            s0Var.getClass();
                            String str2 = str;
                            TLRPC.Document b10 = s0.b(str2, (TLRPC.TL_messages_stickerSet) obj);
                            s0Var.v = b10;
                            s0Var.f40287r.setImage(ImageLocation.getForDocument(b10), "80_80", s0.c(str2), null, null, 0);
                            s0Var.f40288s.setImage(ImageLocation.getForDocument(s0Var.f40289w), "80_80", ImageLocation.getForDocument(s0Var.v), "80_80", null, null, s0.c(str2), 0L, null, null, 0);
                            return;
                        default:
                            s0 s0Var2 = this.f40270b;
                            s0Var2.getClass();
                            String str3 = str;
                            TLRPC.Document b11 = s0.b(str3, (TLRPC.TL_messages_stickerSet) obj);
                            s0Var2.f40289w = b11;
                            if (b11 != null) {
                                s0Var2.f40288s.setImage(ImageLocation.getForDocument(b11), "80_80", ImageLocation.getForDocument(s0Var2.v), "80_80", null, null, s0.c(str3), 0L, null, null, 0);
                                return;
                            }
                            return;
                    }
            ...
            imageReceiver.setImage(ImageLocation.getForDocument(this.f40289w), "80_80", ImageLocation.getForDocument(this.v), "80_80", null, null, c(str), 0L, null, null, 0);
        }
        this.f40284c = true;
        requestLayout();
    }
    ...
    public final void f() {
        ...
        if (min < 0.4f) {
            ...
            f10 = 1.0f;
            this.F = new StaticLayout(this.f40283b, textPaint, (int) Math.ceil(measureText), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        }
        this.G = 0.0f;
    ...
    public TLRPC.Document getCodeEmojiDocument() {
        ...
        if (this.L && (document = this.f40289w) != null) {
            return document;
        }
        return this.v;
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.K = true;
        if (this.L) {
            this.f40288s.onAttachedToWindow();
        } else {
            this.f40287r.onAttachedToWindow();
        }
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        this.K = false;
        this.f40287r.onDetachedFromWindow();
        this.f40288s.onDetachedFromWindow();
    }
