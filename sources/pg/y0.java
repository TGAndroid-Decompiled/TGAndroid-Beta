...
public final class y0 implements TextureView.SurfaceTextureListener {
    public final ha f41075a;
    public final c1 f41076b;
    ...
    public final void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i10, int i11) {
        if (surfaceTexture != null) {
            c1 c1Var = this.f41076b;
            if (c1Var.d == null) {
                a1 a1Var = new a1(c1Var, surfaceTexture, this.f41075a);
                c1Var.d = a1Var;
                a1Var.f40838n = i10;
                a1Var.f40839r = i11;
                c1Var.i();
                ...
                if (q0Var.v) {
                    q0Var.f40978f.f(new o0(q0Var, q0Var.f40993w, 0));
                    q0Var.f40993w = null;
                    q0Var.v = false;
                }
            }
    ...
    public final boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        c1 c1Var = this.f41076b;
        if (c1Var.d != null && !c1Var.f40860y) {
            q0 q0Var = c1Var.f40853c;
            q0Var.f40978f.f(new p2.b(1, q0Var, new x0(this, 2)));
        }
        return true;
    }
