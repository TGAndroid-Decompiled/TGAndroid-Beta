...
public final class v extends FrameLayout {
    ...
    public final r f41285b;
    public final EditTextBoldCursor f41286c;
    public int d;
    public boolean e;
    public final x f41287f;
    ...
    public v(x xVar, Context context) {
        ...
        this.f41286c = editTextBoldCursor;
    ...
    public final void a(int i10) {
        this.d = i10;
        this.f41285b.f41209c = i10;
        TextView textView = this.f41284a;
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 == 2) {
    ...
    public final void b() {
        this.e = true;
        r rVar = this.f41285b;
        rVar.d = i0.a.k(rVar.e.f41306f, 255);
        rVar.a();
        rVar.invalidate();
        EditTextBoldCursor editTextBoldCursor = this.f41286c;
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 == 2) {
                    editTextBoldCursor.setText(String.valueOf(Color.blue(xVar.f41306f)));
                }
            } else {
                editTextBoldCursor.setText(String.valueOf(Color.green(xVar.f41306f)));
            }
        } else {
            editTextBoldCursor.setText(String.valueOf(Color.red(xVar.f41306f)));
        }
