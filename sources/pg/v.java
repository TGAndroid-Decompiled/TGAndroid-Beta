...
public final class v extends FrameLayout {
    public final TextView f40969a;
    public final r f40970b;
    public final EditTextBoldCursor f40971c;
    public int d;
    public boolean e;
    public final x f40972f;

    public v(x xVar, Context context) {
        super(context);
        this.f40972f = xVar;
        TextView textView = new TextView(context);
        this.f40969a = textView;
        ...
        this.f40971c = editTextBoldCursor;
    ...
    public final void a(int i10) {
        this.d = i10;
        this.f40970b.f40904c = i10;
        TextView textView = this.f40969a;
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 == 2) {
    ...
    public final void b() {
        this.e = true;
        r rVar = this.f40970b;
        rVar.d = i0.a.k(rVar.e.f40990f, 255);
        rVar.a();
        rVar.invalidate();
        EditTextBoldCursor editTextBoldCursor = this.f40971c;
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 == 2) {
                    editTextBoldCursor.setText(String.valueOf(Color.blue(xVar.f40990f)));
                }
            } else {
                editTextBoldCursor.setText(String.valueOf(Color.green(xVar.f40990f)));
            }
        } else {
            editTextBoldCursor.setText(String.valueOf(Color.red(xVar.f40990f)));
        }
