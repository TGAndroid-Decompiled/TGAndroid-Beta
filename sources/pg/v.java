...
public final class v extends FrameLayout {
    ...
    public final r f41046b;
    public final EditTextBoldCursor f41047c;
    public int d;
    public boolean e;
    public final x f41048f;
    ...
    public v(x xVar, Context context) {
        ...
        this.f41047c = editTextBoldCursor;
    ...
    public final void a(int i10) {
        this.d = i10;
        this.f41046b.f41002c = i10;
        TextView textView = this.f41045a;
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 == 2) {
    ...
    public final void b() {
        this.e = true;
        r rVar = this.f41046b;
        rVar.d = i0.a.k(rVar.e.f41065f, 255);
        rVar.a();
        rVar.invalidate();
        EditTextBoldCursor editTextBoldCursor = this.f41047c;
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 == 2) {
                    editTextBoldCursor.setText(String.valueOf(Color.blue(xVar.f41065f)));
                }
            } else {
                editTextBoldCursor.setText(String.valueOf(Color.green(xVar.f41065f)));
            }
        } else {
            editTextBoldCursor.setText(String.valueOf(Color.red(xVar.f41065f)));
        }
