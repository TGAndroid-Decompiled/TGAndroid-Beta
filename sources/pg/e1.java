...
public abstract class e1 extends j {
    ...
    public h5 K0;
    public h5 L0;
    public final u5 f39982q0;
    public final x0 f39983r0;
    public final ArrayList f39984s0;
    public final MessageObject.GroupedMessages f39985t0;
    public boolean f39986u0;
    public boolean f39987v0;
    public TextureView f39988w0;
    ...
    public e1(Context context, PointF pointF, ArrayList arrayList, ia iaVar, boolean z10, d8 d8Var) {
        ...
        obj.f6103a = textPaint;
        TextPaint textPaint2 = new TextPaint();
        obj.f6104b = textPaint2;
        TextPaint textPaint3 = new TextPaint();
        obj.f6105c = textPaint3;
        new Paint(3);
        obj.d = new Paint(3);
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            if (message2 instanceof TLRPC.TL_message) {
                ...
                this.f39984s0.add(messageObject2);
            }
            tL_messageService.f17216id = message2.f17216id;
            ...
            this.f39984s0.add(messageObject22);
        }
        this.f39985t0 = null;
        if (this.f39984s0.size() > 1) {
            MessageObject.GroupedMessages groupedMessages = new MessageObject.GroupedMessages();
            this.f39985t0 = groupedMessages;
            groupedMessages.messages.addAll(this.f39984s0);
            groupedMessages.groupId = ((MessageObject) this.f39984s0.get(0)).getGroupId();
        ...
        if (d8Var != null && d8Var.f2555g) {
            ...
            d8Var.f2552b = y1Var;
            d8Var.f2553c = aVar2;
            TextureView textureView = d8Var.f2551a;
            if (textureView != null) {
                y1Var.run(textureView);
            }
            if (d8Var.d && (aVar = d8Var.f2553c) != null) {
                aVar.run(Integer.valueOf(d8Var.e), Integer.valueOf(d8Var.f2554f));
            }
        }
        k();
    }
    ...
    public static org.telegram.ui.Cells.t1 q(b7 b7Var) {
        return b7Var.getCell();
    }
    ...
    public final void onMeasure(int r5, int r6) {
        throw new UnsupportedOperationException("Method not decompiled: pg.e1.onMeasure(int, int):void");
    }
    ...
    public void setupTheme(bi.r9 r8) {
        throw new UnsupportedOperationException("Method not decompiled: pg.e1.setupTheme(bi.r9):void");
    }
}
