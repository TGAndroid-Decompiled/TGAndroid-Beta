...
public class b extends EditTextBoldCursor {
    public final Canvas f39944b;
    public final TextPaint f39945c;
    public final Paint d;
    public Bitmap e;
    public boolean f39946f;
    public int h;
    public float f39947n;
    public int f39948r;
    public final ar f39949s;
    public RectF[] v;
    public RectF f39950w;
    public boolean f39951x;
    public float f39952y;

    public b(Context context) {
        super(context);
        this.f39944b = new Canvas();
    ...
    private void setFrameRoundRadius(float f7) {
        if (Math.abs(this.f39952y - f7) > 0.1f) {
            this.f39952y = f7;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.e != null && this.h != 0) {
            boolean z11 = this.f39946f;
            TextPaint textPaint = this.f39945c;
            if (z11) {
                int measuredWidth = (getMeasuredWidth() - getPaddingLeft()) - getPaddingRight();
                int measuredHeight = getMeasuredHeight();
                Editable text = getText();
                Bitmap bitmap = this.e;
                Canvas canvas2 = this.f39944b;
                canvas2.setBitmap(bitmap);
                canvas2.drawColor(0, PorterDuff.Mode.CLEAR);
                float f7 = this.f39947n;
                if (f7 <= 0.0f) {
        ...
        if (this.f39948r != 0) {
            ...
            if (this.f39951x) {
                ...
                if (this.f39950w == null) {
                    this.f39950w = new RectF();
                }
                this.f39950w.left = getMeasuredWidth();
                this.f39950w.top = getMeasuredHeight();
                RectF rectF4 = this.f39950w;
                rectF4.bottom = 0.0f;
                rectF4.right = 0.0f;
                for (int i14 = 0; i14 < this.v.length; i14++) {
                    RectF rectF5 = this.f39950w;
                    rectF5.left = Math.min(rectF5.left, getPaddingLeft() + this.v[i14].left);
                    RectF rectF6 = this.f39950w;
                    rectF6.top = Math.min(rectF6.top, getPaddingTop() + this.v[i14].top);
                    RectF rectF7 = this.f39950w;
                    rectF7.right = Math.max(rectF7.right, getPaddingLeft() + this.v[i14].right);
                    RectF rectF8 = this.f39950w;
                    rectF8.bottom = Math.max(rectF8.bottom, getPaddingTop() + this.v[i14].bottom);
                }
                RectF rectF9 = this.f39950w;
                RectF rectF10 = this.f39950w;
                rectF9.right = getMeasuredWidth() - rectF10.right;
                rectF10.bottom = getMeasuredHeight() - this.f39950w.bottom;
            }
            ar arVar = this.f39949s;
            arVar.rewind();
    ...
    public void setFrameColor(int i10) {
        ...
        if (i10 != 0) {
            ...
            if (computePerceivedBrightness == 0.0f) {
                computePerceivedBrightness = Color.red(this.f39948r) / 255.0f;
            }
