...
public final class t1 {
    ...
    public static int b(vv0 vv0Var) {
        int i10 = (int) vv0Var.f29776a;
        int i11 = (int) vv0Var.f29777b;
        int[] iArr = new int[1];
    ...
    public final void a(boolean z10) {
        ...
        if (i10 != 0) {
            ...
            this.f41255b = 0;
            if (z10 && (bitmap = this.f41254a) != null && !bitmap.isRecycled()) {
                bitmap.recycle();
            }
        }
    }
    ...
    public final int c() {
        ...
        GLES20.glTexParameteri(3553, 10241, 9729);
        try {
            GLUtils.texImage2D(3553, 0, 6408, this.f41254a, 5121, 0);
        } catch (Exception e) {
            FileLog.e(e);
            ...
            this.f41254a.getPixels(iArr2, 0, width, 0, 0, width, height);
