...
public final class z1 extends i {
    public final int f40385n;
    public RectF f40386r;

    public z1(j jVar, Context context, int i10) {
        super(jVar, context);
        this.f40385n = i10;
    }
        ...
        switch (this.f40385n) {
            ...
            case 1:
                ...
                if (showAlpha2 > 0.0f) {
                    ...
                    Paint paint5 = this.f40021c;
                    canvas.drawCircle(dp2, f12, dpf22, paint5);
                    Paint paint6 = this.f40020b;
            ...
            default:
                ...
                if (showAlpha3 > 0.0f) {
                    ...
                    Paint paint8 = this.f40021c;
                    canvas.drawCircle(dp3, f14, dpf23, paint8);
                    Paint paint9 = this.f40020b;
