...
public final class b0 implements sy {
    ...
    public final boolean k() {
        b editText = ((v2) this.f39953a.S0).getEditText();
        ...
        if (editText != null) {
            ...
            try {
                ...
                if (document != null) {
                    ...
                    y5Var = new y5(j3, editText.getPaint().getFontMetricsInt());
                }
