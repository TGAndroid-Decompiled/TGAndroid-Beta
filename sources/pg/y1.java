...
public abstract class y1 extends View {
    public Bitmap f40375a;
    public Paint f40376b;
    public Paint f40377c;
    public Paint d;
    public float e;
    public float f40378f;
    public Path h;
    public Rect f40379n;
    public RectF f40380r;
    public int f40381s;
    public boolean v;
    public q0.a f40382w;
    public float f40383x;
    ...
    public final void onDetachedFromWindow() {
        ...
        ((og.n) this).f14429y.f14320n.d();
        this.f40375a.recycle();
        this.f40375a = null;
    }
    ...
    public final void onDraw(Canvas canvas) {
        int i10;
        float f7;
        Rect rect = this.f40379n;
        Paint paint = this.f40376b;
        RectF rectF = this.f40380r;
        Path path = this.h;
        super.onDraw(canvas);
        float min = Math.min(getWidth(), getHeight()) * 0.2f;
        float width = this.e * getWidth();
        float height = this.f40378f * getHeight();
        int round = Math.round(this.e * this.f40375a.getWidth());
        int round2 = Math.round(this.f40378f * this.f40375a.getHeight());
        Bitmap bitmap = this.f40375a;
        int pixel = bitmap.getPixel(Utilities.clamp(round, bitmap.getWidth() - 1, 0), Utilities.clamp(round2, this.f40375a.getHeight() - 1, 0));
        this.f40381s = pixel;
        Paint paint2 = this.d;
        paint2.setColor(pixel);
        float f10 = this.f40383x;
        if (f10 != 0.0f && f10 != 1.0f) {
            RectF rectF2 = AndroidUtilities.rectTmp;
            f7 = 1.0f;
            i10 = round;
            rectF2.set(width - min, height - min, width + min, height + min);
            canvas.saveLayerAlpha(rectF2, (int) (this.f40383x * 255.0f), 31);
        } else {
            i10 = round;
            f7 = 1.0f;
            canvas.save();
        }
        float f11 = (this.f40383x * 0.5f) + 0.5f;
        ...
        canvas.drawBitmap(this.f40375a, rect, rectF, (Paint) null);
        ...
        canvas.drawPath(path, this.f40377c);
        float f17 = f12 / 2.0f;
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        if (i10 != 0 && i11 != 0 && i12 != 0 && i13 != 0 && isLaidOut()) {
            ...
            this.f40378f = (i13 * this.f40378f) / i11;
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked != 1) {
                ...
                this.f40378f = motionEvent.getY() / getHeight();
                invalidate();
                return true;
            }
            a(true);
