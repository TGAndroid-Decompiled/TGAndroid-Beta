...
public final class s1 {
    ...
    public static int b(jv0 jv0Var) {
        int i10 = (int) jv0Var.f25428a;
        int i11 = (int) jv0Var.f25429b;
        int[] iArr = new int[1];
    ...
    public final void a(boolean z10) {
        ...
        if (i10 != 0) {
            ...
            this.f40939b = 0;
            if (z10 && (bitmap = this.f40938a) != null && !bitmap.isRecycled()) {
                bitmap.recycle();
            }
        }
    }
    ...
    public final int c() {
        ...
        GLES20.glTexParameteri(3553, 10241, 9729);
        try {
            GLUtils.texImage2D(3553, 0, 6408, this.f40938a, 5121, 0);
        } catch (Exception e) {
            FileLog.e(e);
            ...
            this.f40938a.getPixels(iArr2, 0, width, 0, 0, width, height);
