...
public final class r6 implements Runnable {
    ...
    public final KeyEvent.Callback f47759c;
    ...
    public final void run() {
        ...
        Object obj = this.f47760f;
        TLObject tLObject = this.e;
        Object obj2 = this.d;
        KeyEvent.Callback callback = this.f47759c;
        switch (i10) {
            case 0:
            ...
            default:
                ...
                long j3 = q1Var.f46106c0;
                xh.m0 m0Var = new xh.m0(q1Var, (Utilities.Callback) obj, 2);
                boolean z12 = starGift.limited;
                if (z12 && (disallowedGiftsSettings2 = q1Var.f46105b0) != null && disallowedGiftsSettings2.disallow_limited_stargifts) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                if (z12 && (disallowedGiftsSettings = q1Var.f46105b0) != null && disallowedGiftsSettings.disallow_unique_stargifts) {
                    z11 = true;
                } else {
                    z11 = false;
                }
                new xh.s0(q1Var, context, this.f47758b, starGift, j3, m0Var, z10, z11).show();
                return;
        }
    }
}
