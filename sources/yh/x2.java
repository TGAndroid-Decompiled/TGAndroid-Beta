...
public final class x2 extends Drawable {
    public Drawable f47892g;
    public int h;
    public int f47893i;
    public final Paint f47889b = new Paint(1);
    public final Shader[] f47890c = new Shader[2];
    public final Matrix d = new Matrix();
    public final org.telegram.ui.Components.e6 e = new org.telegram.ui.Components.e6(1.0f, new w2(this, 0), 0, 420, rr.h);
    public final RectF f47891f = new RectF();
    public final int f47888a = 1;

    public final void a(int i10, int i11) {
        if (this.h == i10 && this.f47893i == i11) {
            return;
        }
        Shader[] shaderArr = this.f47890c;
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.f47892g != null) {
            ...
            j0.a(canvas, 0, this.f47892g, rectF.width(), AndroidUtilities.dp(290.0f), 2.0f, 1.0f);
            canvas.restore();
        }
    }
