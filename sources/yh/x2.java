...
public final class x2 extends FrameLayout {
    public final xh.e1 f47986a;
    public final FrameLayout f47987b;
    public final u9 f47988c;
    ...
    public final void a(TL_stars.StarGift starGift, boolean z10) {
        ...
        if (starGift != null) {
            ...
            y7.Z0(this.f47988c.getImageReceiver(), ((TL_stars.starGiftAttributeModel) v5.l(starGift.attributes, TL_stars.starGiftAttributeModel.class)).document, 52);
    ...
    public final void b(final boolean z10, boolean z11) {
        ...
        int i11;
        float f14;
        FrameLayout frameLayout = this.f47987b;
