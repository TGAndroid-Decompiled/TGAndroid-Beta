...
public final class x2 extends Drawable {
    public Drawable f48203g;
    public int h;
    public int f48204i;
    public final Paint f48200b = new Paint(1);
    public final Shader[] f48201c = new Shader[2];
    public final Matrix d = new Matrix();
    public final org.telegram.ui.Components.e6 e = new org.telegram.ui.Components.e6(1.0f, new w2(this, 0), 0, 420, qr.h);
    public final RectF f48202f = new RectF();
    public final int f48199a = 1;

    public final void a(int i10, int i11) {
        if (this.h == i10 && this.f48204i == i11) {
            return;
        }
        Shader[] shaderArr = this.f48201c;
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.f48203g != null) {
            ...
            j0.a(canvas, 0, this.f48203g, rectF.width(), AndroidUtilities.dp(290.0f), 2.0f, 1.0f);
            canvas.restore();
        }
    }
