...
public final class z5 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f48341a) {
            case 0:
                new xc(((org.telegram.ui.ActionBar.e3[]) this.f48342b)[0].topBulletinContainer, (org.telegram.ui.ActionBar.d6) this.f48343c).Q(R.raw.copy, 36, LocaleController.getString(R.string.StarsTransactionIDCopied)).k(false);
                return;
            case 1:
                o8 o8Var = (o8) this.f48342b;
                o8Var.R = true;
                o8Var.o(new p5((r5) this.f48343c, 2));
                AndroidUtilities.runOnUIThread(new x7(o8Var, 1), 240L);
                return;
            case 2:
                zg.q qVar = (zg.q) this.f48342b;
                org.telegram.ui.Components.z5 z5Var = (org.telegram.ui.Components.z5) this.f48343c;
                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(qVar.f49428n.getText());
                ...
                return;
            case 3:
                zg.q qVar2 = (zg.q) this.f48342b;
                TLRPC.TL_error tL_error = (TLRPC.TL_error) this.f48343c;
                ...
                return;
            case 4:
                org.telegram.ui.Components.z5 z5Var3 = (org.telegram.ui.Components.z5) this.f48343c;
                zg.q qVar3 = ((zg.p) this.f48342b).f49398e2;
                SpannableStringBuilder spannableStringBuilder2 = new SpannableStringBuilder(qVar3.f49428n.getText());
                ...
                return;
            case 5:
                zg.b0 b0Var = (zg.b0) this.f48342b;
                rk0 rk0Var = (rk0) this.f48343c;
                b0Var.f49252l = true;
                b0Var.f49244a.invalidate();
                rk0Var.f27953b1 = false;
                rk0Var.invalidate();
                b0Var.c(true);
                return;
            case 6:
                zg.d0 d0Var = (zg.d0) this.f48342b;
                zg.b bVar = (zg.b) this.f48343c;
                ...
                return;
            default:
                zg.p0 p0Var = (zg.p0) this.f48342b;
                zg.m0 m0Var = (zg.m0) this.f48343c;
                p0Var.getClass();
                TLRPC.ReactionCount reactionCount = m0Var.f49361a;
                org.telegram.ui.Cells.a0 a0Var = p0Var.f49423z;
