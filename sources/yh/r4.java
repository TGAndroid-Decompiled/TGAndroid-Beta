...
public final class r4 implements Runnable {
    public final int f47947a = 1;
    public final s5 f47948b;
    public final TLObject f47949c;
    public final TLRPC.TL_error d;
    public final Utilities.Callback2 e;
    public final Context f47950f;
    public final org.telegram.ui.ActionBar.d6 h;
    public final long f47951n;
    public final String f47952r;
    public final long f47953s;
    public final TLObject v;
    public final TLObject f47954w;
    ...
    public r4(s5 s5Var, TLObject tLObject, TLRPC.TL_error tL_error, Utilities.Callback2 callback2, Context context, org.telegram.ui.ActionBar.d6 d6Var, long j3, String str, long j10, TLObject tLObject2, TLRPC.TL_textWithEntities tL_textWithEntities) {
        this.f47948b = s5Var;
        this.f47949c = tLObject;
        this.d = tL_error;
        this.e = callback2;
        this.f47950f = context;
        this.h = d6Var;
        this.f47951n = j3;
        this.f47952r = str;
        this.f47953s = j10;
        this.v = tLObject2;
        this.f47954w = tL_textWithEntities;
    }
            ...
            case 0:
                ...
                if (!(tLObject instanceof TLRPC.TL_payments_paymentResult)) {
                    if (tL_error != null && "BALANCE_TOO_LOW".equals(tL_error.text)) {
                        if (!MessagesController.getInstance(s5Var.f48010a).starsPurchaseAvailable()) {
                ...
                if (BirthdayController.getInstance(s5Var.f48010a).contains(j10)) {
                    SharedPreferences.Editor edit = MessagesController.getInstance(s5Var.f48010a).getMainSettings().edit();
                    edit.putBoolean(Calendar.getInstance().get(1) + "bdayhint_" + j10, false).apply();
                }
                SharedPreferences.Editor edit2 = MessagesController.getInstance(s5Var.f48010a).getMainSettings().edit();
                ...
                return;
            default:
                s5 s5Var2 = this.f47948b;
                TLObject tLObject2 = this.f47949c;
                TLRPC.TL_error tL_error2 = this.d;
                Utilities.Callback2 callback22 = this.e;
                Context context2 = this.f47950f;
                org.telegram.ui.ActionBar.d6 d6Var2 = this.h;
                long j11 = this.f47951n;
                String str4 = this.f47952r;
                long j12 = this.f47953s;
                TLObject tLObject3 = this.v;
                TLRPC.TL_textWithEntities tL_textWithEntities = (TLRPC.TL_textWithEntities) this.f47954w;
                ...
                if (BirthdayController.getInstance(s5Var2.f48010a).contains(j12)) {
                    SharedPreferences.Editor edit3 = MessagesController.getInstance(s5Var2.f48010a).getMainSettings().edit();
                    edit3.putBoolean(Calendar.getInstance().get(1) + "bdayhint_" + j12, false).apply();
                }
                SharedPreferences.Editor edit4 = MessagesController.getInstance(s5Var2.f48010a).getMainSettings().edit();
                ...
                if (launchActivity2 != null && (ab0Var2 = launchActivity2.f31143x0) != null) {
                    ab0Var2.c(true);
                    return;
                }
                return;
