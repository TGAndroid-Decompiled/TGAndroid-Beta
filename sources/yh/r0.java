...
public final class r0 extends oh.c implements le.e {
    public static final int f47938s = 0;
    public final le.f f47939f;
    public final ii.q1 h;
    public final oh.b[] f47940n;
    public int f47941r;

    public r0(Context context, org.telegram.ui.ActionBar.d6 d6Var, ii.q1 q1Var) {
        super(context);
        this.f47939f = new le.f(0, this, rr.h, 1600L);
        this.h = q1Var;
        ...
        this.e.setColor(l1);
        this.f47940n = new oh.b[]{oh.b.b(context, d6Var, oh.a.G, R.string.GiftPreviewModels), oh.b.b(context, d6Var, oh.a.v, R.string.GiftPreviewBackdrops), oh.b.b(context, d6Var, oh.a.J, R.string.GiftPreviewSymbols)};
        int i11 = 0;
        while (true) {
            oh.b[] bVarArr = this.f47940n;
            if (i11 < bVarArr.length) {
                this.f15738a.addView(bVarArr[i11], w7.y5.l(1.0f, 0, -1));
                this.f47940n[i11].setOnClickListener(new ci.n4(this, i11, 27));
                i11++;
            } else {
