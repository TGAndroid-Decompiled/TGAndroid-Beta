...
public final class r3 extends FrameLayout {
    public final x0 f47733a;
    public final q3 f47734b;
    public final q3 f47735c;
    public final q3 d;
    public boolean e;
    public final n20 f47736f;
    public final RectF h;

    public r3(Context context, org.telegram.ui.ActionBar.f6 f6Var, x0 x0Var) {
        super(context);
        this.f47736f = new n20();
        this.h = new RectF();
        this.f47733a = x0Var;
    ...
    public final void a(h3 h3Var, float f7, boolean z10, h3 h3Var2, float f10, boolean z11, h3 h3Var3, float f11, boolean z12) {
        x0 x0Var = this.f47733a;
        q3 q3Var = this.f47734b;
        if (h3Var != null) {
            if (z10) {
                f7 = Math.max(0.5f, f7);
            }
            q3Var.setVisibility(0);
            q3Var.e(h3Var.f47274a, h3Var.f47275b, x0Var);
            q3Var.setTranslationY(AndroidUtilities.dp(36.0f) * ((f7 - 0.5f) / 1.5f));
        } else {
            q3Var.setVisibility(4);
        }
        q3 q3Var2 = this.f47735c;
        if (h3Var2 != null) {
            float f12 = f10;
            if (z11) {
            ...
            q3Var2.e(h3Var2.f47274a, h3Var2.f47275b, x0Var);
        ...
        if (h3Var3 != null) {
            ...
            q3Var3.e(h3Var3.f47274a, h3Var3.f47275b, x0Var);
