...
public final class m3 extends rq {
    public final Path f47762b;
    public final RectF f47763c;
    public final i8 d;
    public final int e;
    public final View f47764f;
    public final ImageReceiver f47765g;
    public final org.telegram.ui.Components.n5 h;
    public RadialGradient f47766i;
    public final Matrix f47767j;
    public final w01 f47768k;
    public final w01 f47769l;
    public org.telegram.ui.Components.n6 f47770m;
    public final float f47771n;
    public yf.n f47772o;
    public int f47773p;
    public int f47774q;
    public final Paint f47775r;
    public int f47776s;
    public int f47777t;
    ...
    public m3(View view, TL_stars.StarGift starGift, int i10, float f7) {
        ...
        int i14;
        int i15;
        this.f47762b = new Path();
        this.f47763c = new RectF();
        this.f47767j = new Matrix();
        this.f47775r = new Paint(1);
        this.f47776s = AndroidUtilities.dp(16.0f);
        this.f47777t = 0;
        this.f47764f = view;
        this.f47771n = f7;
        ImageReceiver imageReceiver = new ImageReceiver(view);
        this.f47765g = imageReceiver;
        if (i10 > 180) {
            f10 = 24.0f;
        } else {
            f10 = 18.0f;
        ...
        if (starGift instanceof TL_stars.TL_starGift) {
            ...
            ArrayList arrayList3 = i8Var.f47589b;
            ...
            if (i8Var.f47596l != null) {
                ...
                while (i27 < i0Var.f7788a) {
                    int i28 = i27;
                    e0.i0.a((float[]) i0Var.f7790c, i28, 0.0f, 0.0f, width2, height2);
                    i27 = i28 + 1;
                }
            }
            long currentTimeMillis = System.currentTimeMillis();
            for (int i29 = 0; i29 < i8Var.f47594j; i29++) {
                h8 h8Var = (h8) arrayList3.get(i29);
                PointF pointF5 = (PointF) arrayList.get(i29);
                i8Var.c(h8Var, currentTimeMillis, true);
                h8Var.f47552a = pointF5.x + rectF.left;
                h8Var.f47553b = pointF5.y + rectF.top;
            ...
            if (stargiftattributebackdrop != null) {
                this.f47766i = new RadialGradient(0.0f, 0.0f, AndroidUtilities.dpf2(i10) / 2.0f, new int[]{stargiftattributebackdrop.center_color | (-16777216), stargiftattributebackdrop.edge_color | (-16777216)}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP);
        ...
        this.f28030a.setShader(this.f47766i);
    ...
    public final void a() {
        this.h.a();
        this.f47765g.onAttachedToWindow();
        if (this.f47772o != null) {
            int currentTime = ConnectionsManager.getInstance(UserConfig.selectedAccount).getCurrentTime();
            int i10 = this.f47774q;
            if (currentTime >= i10) {
                i10 = this.f47773p;
            }
            this.f47772o.a(i10 - currentTime);
        }
    }
    ...
    public final void b() {
        this.h.b();
        this.f47765g.onDetachedFromWindow();
        yf.n nVar = this.f47772o;
        if (nVar != null) {
            nVar.b();
        }
    }
    ...
    public final void d(int i10, int i11) {
        ...
        this.f47773p = i11;
        if (this.f47772o == null) {
            this.f47772o = new yf.n(new r5.d(this, 21));
        }
        int currentTime = ConnectionsManager.getInstance(UserConfig.selectedAccount).getCurrentTime();
        if (currentTime < i10) {
            i12 = i10 - currentTime;
        ...
        this.f47772o.a(i12);
        if (this.f47770m == null) {
            org.telegram.ui.Components.n6 n6Var = new org.telegram.ui.Components.n6(false, false, false, false);
            this.f47770m = n6Var;
            n6Var.r(-1);
            this.f47770m.t(AndroidUtilities.dp(12.0f));
            this.f47770m.setCallback(new ah.d(this, 10));
        }
        h();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        rectF.set(bounds);
        canvas.save();
        Path path = this.f47762b;
        path.rewind();
        float f7 = this.f47776s;
        path.addRoundRect(rectF, f7, f7, Path.Direction.CW);
        canvas.clipPath(path);
        RadialGradient radialGradient = this.f47766i;
        Paint paint = this.f28030a;
        if (radialGradient != null) {
            Matrix matrix = this.f47767j;
            matrix.reset();
            matrix.postTranslate(rectF.centerX(), rectF.centerY());
            this.f47766i.setLocalMatrix(matrix);
            paint.setShader(this.f47766i);
        }
        canvas.drawPaint(paint);
        canvas.save();
        canvas.translate(rectF.centerX(), rectF.centerY());
        j0.a(canvas, this.f47777t, this.h, rectF.width(), rectF.height(), 1.0f, this.f47771n);
        i8 i8Var = this.d;
        if (i8Var != null) {
            i8Var.b(canvas, -1, 1.0f);
        }
        canvas.restore();
        w01 w01Var2 = this.f47768k;
        ImageReceiver imageReceiver = this.f47765g;
        if (w01Var2 != null && (w01Var = this.f47769l) != null) {
            if (this.f47770m != null) {
                Paint paint2 = this.f47775r;
                paint2.setColor(1342177280);
                canvas.drawRoundRect(rectF.left + AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f) + rectF.top, rectF.left + AndroidUtilities.dp(20.0f) + Math.max(this.f47770m.d(), AndroidUtilities.dp(3.0f)), rectF.top + AndroidUtilities.dp(23.0f), AndroidUtilities.dp(8.5f), AndroidUtilities.dp(8.5f), paint2);
                canvas.save();
                canvas.translate(rectF.left + AndroidUtilities.dp(13.0f), rectF.top + AndroidUtilities.dp(14.0f));
                this.f47770m.draw(canvas);
                canvas.restore();
            }
    ...
    public final void e(int i10, int i11) {
        ...
        this.f47766i = radialGradient;
        this.f28030a.setShader(radialGradient);
    }
    ...
    public final void h() {
        ...
        if (currentTime > i10) {
            this.f47770m.q(LocaleController.getString(R.string.Gift2AuctionCountdownFinished), true, true);
        } else {
            int i11 = this.f47774q;
            if (currentTime < i11) {
                this.f47770m.q(LocaleController.formatString(R.string.Gift2AuctionCountdownStartsIn, AndroidUtilities.formatDuration(i11 - currentTime, true)), true, true);
            } else {
                this.f47770m.q(AndroidUtilities.formatDuration(i10 - currentTime, true), true, true);
            }
        }
        if (currentTime > this.f47773p && (w01Var = this.f47769l) != null) {
