...
public final class w5 implements Runnable {
    ...
    public final org.telegram.ui.ActionBar.e3[] f48173b;
    public final TL_stars.StarsTransaction f48174c;
    public final long d;

    public w5(org.telegram.ui.ActionBar.e3[] e3VarArr, long j3, TL_stars.StarsTransaction starsTransaction) {
        this.f48172a = 2;
        this.f48173b = e3VarArr;
        this.d = j3;
        this.f48174c = starsTransaction;
    }
    ...
    public final void run() {
        switch (this.f48172a) {
            case 0:
                ...
                if (U != null) {
                    TL_stars.StarsTransaction starsTransaction = this.f48174c;
            ...
            case 1:
                ...
                if (U2 != null) {
                    TL_stars.StarsTransaction starsTransaction2 = this.f48174c;
            ...
            case 2:
                ...
                if (U3 != null) {
                    ...
                    bundle.putInt("message_id", this.f48174c.msg_id);
            ...
            case 3:
                ...
                if (U4 != null) {
                    TL_stars.StarsTransaction starsTransaction3 = this.f48174c;
            ...
            default:
                ...
                if (U5 != null) {
                    TL_stars.StarsTransaction starsTransaction4 = this.f48174c;
    ...
    public w5(org.telegram.ui.ActionBar.e3[] e3VarArr, TL_stars.StarsTransaction starsTransaction, long j3, int i10) {
        this.f48172a = i10;
        this.f48173b = e3VarArr;
        this.f48174c = starsTransaction;
        this.d = j3;
