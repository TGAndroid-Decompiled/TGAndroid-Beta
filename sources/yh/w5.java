...
public final class w5 implements Runnable {
    ...
    public final org.telegram.ui.ActionBar.f3[] f48183b;
    public final TL_stars.StarsTransaction f48184c;
    public final long d;

    public w5(org.telegram.ui.ActionBar.f3[] f3VarArr, long j3, TL_stars.StarsTransaction starsTransaction) {
        this.f48182a = 2;
        this.f48183b = f3VarArr;
        this.d = j3;
        this.f48184c = starsTransaction;
    }
    ...
    public final void run() {
        switch (this.f48182a) {
            case 0:
                this.f48183b[0].dismiss();
                org.telegram.ui.ActionBar.n2 U = LaunchActivity.U();
                if (U != null) {
                    TL_stars.StarsTransaction starsTransaction = this.f48184c;
            ...
            case 1:
                ...
                if (U2 != null) {
                    TL_stars.StarsTransaction starsTransaction2 = this.f48184c;
            ...
            case 2:
                ...
                if (U3 != null) {
                    ...
                    bundle.putInt("message_id", this.f48184c.msg_id);
            ...
            case 3:
                ...
                if (U4 != null) {
                    TL_stars.StarsTransaction starsTransaction3 = this.f48184c;
            ...
            default:
                ...
                if (U5 != null) {
                    TL_stars.StarsTransaction starsTransaction4 = this.f48184c;
