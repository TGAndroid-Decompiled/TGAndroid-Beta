...
public final class s0 extends bb {
    ...
    public final ArrayList f47977a0;
    public final ArrayList f47978b0;
    public final ArrayList f47979c0;
    public final ArrayList f47980d0;
    public final com.google.android.gms.common.api.internal.r f47981e0;
    public final com.google.android.gms.common.api.internal.r f47982f0;
    public final com.google.android.gms.common.api.internal.r f47983g0;
    public final oz f47984h0;
    public final l0 f47985i0;
    public final r0 f47986j0;
    public n0 f47987k0;
    public final FrameLayout f47988l0;
    public final ImageView m0;
    public final ImageView f47989n0;
    public final m0 f47990o0;
    public final TextView f47991p0;
    public final View f47992q0;
    public final ah.n f47993r0;
    public final ah.h f47994s0;
    public final fh.d f47995t0;
    public final ah.c f47996u0;
    public o0 f47997v0;
    public final boolean f47998w0;
    public boolean f47999x0;
    public final RectF f48000y0;
    public final PointF f48001z0;
    ...
    public s0(Context context, org.telegram.ui.ActionBar.d6 d6Var, int i10, String str, ArrayList arrayList, boolean z10) {
        ...
        this.f47993r0 = new ah.n(wl0Var, c3Var, new rs(wl0Var, 0));
        ...
        this.f47982f0 = rVar2;
        rVar2.f6148b = false;
        this.f47979c0 = zf.d.c(arrayList, TL_stars.starGiftAttributeModel.class);
        ArrayList arrayList3 = new ArrayList();
        this.f47980d0 = arrayList3;
        if (z10) {
            int i12 = 0;
            while (i12 < this.f47979c0.size()) {
                TL_stars.starGiftAttributeModel stargiftattributemodel = (TL_stars.starGiftAttributeModel) this.f47979c0.get(i12);
                if (stargiftattributemodel.rarity instanceof TL_stars.TL_starGiftAttributeRarity) {
                    this.f47980d0.add(stargiftattributemodel);
                    this.f47979c0.remove(i12);
                    i12--;
                }
                i12++;
            }
        ...
        List.EL.sort(this.f47977a0, Comparator$CC.comparingDouble(new w71(4)));
        List.EL.sort(this.f47978b0, Comparator$CC.comparingDouble(new w71(5)));
        List.EL.sort(this.f47979c0, Comparator$CC.comparingDouble(new w71(6)));
        List.EL.sort(this.f47980d0, Comparator$CC.comparingDouble(new w71(6)));
        com.google.android.gms.common.api.internal.r rVar3 = new com.google.android.gms.common.api.internal.r(this.f47979c0);
        this.f47983g0 = rVar3;
        rVar3.f6148b = false;
        ...
        int i13 = org.telegram.ui.ActionBar.h6.f19148i5;
        ...
        if (Build.VERSION.SDK_INT >= 31 && SharedConfig.chatBlurEnabled()) {
            this.f47994s0 = new ah.h(false);
            fh.d dVar = new fh.d(cVar);
            this.f47995t0 = dVar;
            dVar.v = new Runnable(this) {
                public final s0 f47591b;
                    ...
                    switch (r2) {
                        case 0:
                            if (Build.VERSION.SDK_INT >= 31) {
                                s0 s0Var = this.f47591b;
                                if (s0Var.f47994s0 != null) {
                                    s0Var.Q(2);
                                    return;
                                }
                                return;
            ...
            this.f47994s0 = null;
            this.f47995t0 = null;
            this.f47996u0 = new ah.c(cVar);
        }
        hh.k kVar = new hh.k(this.container);
        ah.c cVar3 = this.f47996u0;
        ...
        this.Z = new ai.w7[3];
        this.f47986j0 = new r0(context, d6Var, new ii.q1(this, 25));
        int i19 = 0;
        while (true) {
            ...
            if (i19 < w7VarArr.length) {
                ...
                this.f47988l0.addView(this.Y, w7.y5.d(-1, -2.0f, 87, 16.0f, 0.0f, 16.0f, 18.0f));
                this.containerView.addView(this.f47988l0, w7.y5.e(-1, 315, 55));
                int d = i0.a.d(0.1f, getThemedColor(org.telegram.ui.ActionBar.h6.f19148i5), getThemedColor(org.telegram.ui.ActionBar.h6.f19130h5));
                ...
                this.f47986j0.setPadding(AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f));
                ch.d c12 = this.f47996u0.c(this.f47986j0, null, false);
                c12.p(AndroidUtilities.dp(4.0f));
                c12.q(AndroidUtilities.dp(28.0f));
                c12.o(new dh.b(org.telegram.ui.ActionBar.h6.f19060d6, d6Var));
                this.f47986j0.setBackground(c12);
                this.containerView.addView(this.f47986j0, w7.y5.d(268, 64.0f, 81, 0.0f, 0.0f, 0.0f, 5.0f));
                this.f47997v0 = new o0((TL_stars.starGiftAttributeBackdrop) zf.d.d(arrayList, TL_stars.starGiftAttributeBackdrop.class), (TL_stars.starGiftAttributePattern) zf.d.d(arrayList, TL_stars.starGiftAttributePattern.class), (TL_stars.starGiftAttributeModel) zf.d.d(arrayList, TL_stars.starGiftAttributeModel.class));
                this.f47987k0.N(false);
                T(false);
                return;
            }
        }
    ...
    public final void Q(int i10) {
        ah.h hVar;
        int dp;
        if (Build.VERSION.SDK_INT >= 31 && (hVar = this.f47994s0) != null) {
            if (w7.d0.a(i10, 2)) {
                org.telegram.ui.ActionBar.c3 c3Var = this.container;
                r0 r0Var = this.f47986j0;
                PointF pointF = this.f48001z0;
                hh.k.b(r0Var, c3Var, pointF);
                float f7 = pointF.x;
                RectF rectF = this.f48000y0;
                rectF.left = f7;
                rectF.top = pointF.y;
            ...
            if (hVar.f458j != 0) {
                hVar.e(this.f47993r0, this.container.getWidth(), this.container.getHeight());
            }
        }
    }
    ...
    public final boolean R(o0 o0Var) {
        if (this.C0 != 1) {
            int i10 = this.f47986j0.f47941r;
            o0 o0Var2 = this.f47997v0;
            if (o0Var2 != null) {
                if (i10 == 1) {
                    if (o0Var.f47794a != o0Var2.f47794a) {
                        return false;
                    }
                } else if (i10 == 2) {
                    if (o0Var.f47795b != o0Var2.f47795b) {
                        return false;
                    }
                } else if (i10 != 0 || o0Var.f47796c != o0Var2.f47796c) {
                    return false;
                }
                return true;
            }
    ...
    public final void S(int i10) {
        ...
        this.f47989n0.setImageResource(i11);
        if (i10 == 2) {
            i12 = R.string.Gift2PreviewSelectedTraits;
        } else {
            i12 = R.string.Gift2PreviewRandomTraits;
        }
        this.f47991p0.setText(LocaleController.getString(i12));
        U();
    }

    public final void T(boolean z10) {
        m0 m0Var = this.f47990o0;
    ...
    public final void U() {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if ((childAt instanceof q0) && (o0Var = (q0Var = (q0) childAt).v) != null) {
                boolean R = R(o0Var);
                q0Var.f47892c.f(R, true);
                q0Var.f47895r.a(R, true);
            }
        }
    }
    ...
    public final boolean isTouchOutside(float f7, float f10) {
        FrameLayout frameLayout = this.f47988l0;
    ...
    public final void mainContainerDispatchDraw(Canvas canvas) {
        ...
        if (Build.VERSION.SDK_INT >= 31 && canvas.isHardwareAccelerated() && (hVar = this.f47994s0) != null && (dVar = this.f47995t0) != null && !dVar.f9060n && dVar.g(width, height)) {
            RecordingCanvas a2 = dVar.a(width, height);
            a2.drawColor(getThemedColor(org.telegram.ui.ActionBar.h6.f19148i5));
            if (LiteMode.isEnabled(262144)) {
                i10 = -2;
            } else {
                i10 = -3;
