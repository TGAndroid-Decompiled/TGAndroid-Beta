...
public final class s0 extends bb {
    ...
    public final ArrayList f47654a0;
    public final ArrayList f47655b0;
    public final ArrayList f47656c0;
    public final ArrayList f47657d0;
    public final com.google.android.gms.common.api.internal.r f47658e0;
    public final com.google.android.gms.common.api.internal.r f47659f0;
    public final com.google.android.gms.common.api.internal.r f47660g0;
    public final oz f47661h0;
    public final l0 f47662i0;
    public final r0 f47663j0;
    public n0 f47664k0;
    public final FrameLayout f47665l0;
    public final ImageView m0;
    public final ImageView f47666n0;
    public final m0 f47667o0;
    public final TextView f47668p0;
    public final View f47669q0;
    public final ah.n f47670r0;
    public final ah.h f47671s0;
    public final fh.d f47672t0;
    public final ah.c f47673u0;
    public o0 f47674v0;
    public final boolean f47675w0;
    public boolean f47676x0;
    public final RectF f47677y0;
    public final PointF f47678z0;
    ...
    public s0(Context context, org.telegram.ui.ActionBar.d6 d6Var, int i10, String str, ArrayList arrayList, boolean z10) {
        ...
        this.f47670r0 = new ah.n(ml0Var, d3Var, new ts(ml0Var, 0));
        ...
        this.f47659f0 = rVar2;
        rVar2.f6148b = false;
        this.f47656c0 = zf.d.c(arrayList, TL_stars.starGiftAttributeModel.class);
        ArrayList arrayList3 = new ArrayList();
        this.f47657d0 = arrayList3;
        if (z10) {
            int i12 = 0;
            while (i12 < this.f47656c0.size()) {
                TL_stars.starGiftAttributeModel stargiftattributemodel = (TL_stars.starGiftAttributeModel) this.f47656c0.get(i12);
                if (stargiftattributemodel.rarity instanceof TL_stars.TL_starGiftAttributeRarity) {
                    this.f47657d0.add(stargiftattributemodel);
                    this.f47656c0.remove(i12);
                    i12--;
                }
                i12++;
            }
        ...
        List.EL.sort(this.f47654a0, Comparator$CC.comparingDouble(new j71(4)));
        List.EL.sort(this.f47655b0, Comparator$CC.comparingDouble(new j71(5)));
        List.EL.sort(this.f47656c0, Comparator$CC.comparingDouble(new j71(6)));
        List.EL.sort(this.f47657d0, Comparator$CC.comparingDouble(new j71(6)));
        com.google.android.gms.common.api.internal.r rVar3 = new com.google.android.gms.common.api.internal.r(this.f47656c0);
        this.f47660g0 = rVar3;
        rVar3.f6148b = false;
        ...
        int i13 = org.telegram.ui.ActionBar.h6.f18877i5;
        ...
        if (Build.VERSION.SDK_INT >= 31 && SharedConfig.chatBlurEnabled()) {
            this.f47671s0 = new ah.h(false);
            fh.d dVar = new fh.d(cVar);
            this.f47672t0 = dVar;
            dVar.v = new Runnable(this) {
                public final s0 f47269b;
                    ...
                    switch (r2) {
                        case 0:
                            if (Build.VERSION.SDK_INT >= 31) {
                                s0 s0Var = this.f47269b;
                                if (s0Var.f47671s0 != null) {
                                    s0Var.Q(2);
                                    return;
                                }
                                return;
            ...
            this.f47671s0 = null;
            this.f47672t0 = null;
            this.f47673u0 = new ah.c(cVar);
        }
        hh.k kVar = new hh.k(this.container);
        ah.c cVar3 = this.f47673u0;
        ...
        this.Z = new ai.w7[3];
        this.f47663j0 = new r0(context, d6Var, new ii.q1(this, 25));
        int i19 = 0;
        while (true) {
            ...
            if (i19 < w7VarArr.length) {
                ...
                linearLayout2.addView(w7Var2, w7.x5.p(0, 42, 1.0f, 7, 0, 0, i11, 0));
                i19++;
                i17 = 17;
                i15 = -1;
                i18 = -1879048193;
            } else {
                this.f47665l0.addView(this.Y, w7.x5.d(-1, -2.0f, 87, 16.0f, 0.0f, 16.0f, 18.0f));
                this.containerView.addView(this.f47665l0, w7.x5.e(-1, 315, 55));
                int d = i0.a.d(0.1f, getThemedColor(org.telegram.ui.ActionBar.h6.f18877i5), getThemedColor(org.telegram.ui.ActionBar.h6.f18859h5));
                ...
                this.f47663j0.setPadding(AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f));
                ch.d c12 = this.f47673u0.c(this.f47663j0, null, false);
                c12.p(AndroidUtilities.dp(4.0f));
                c12.q(AndroidUtilities.dp(28.0f));
                c12.o(new dh.b(org.telegram.ui.ActionBar.h6.f18789d6, d6Var));
                this.f47663j0.setBackground(c12);
                this.containerView.addView(this.f47663j0, w7.x5.d(268, 64.0f, 81, 0.0f, 0.0f, 0.0f, 5.0f));
                this.f47674v0 = new o0((TL_stars.starGiftAttributeBackdrop) zf.d.d(arrayList, TL_stars.starGiftAttributeBackdrop.class), (TL_stars.starGiftAttributePattern) zf.d.d(arrayList, TL_stars.starGiftAttributePattern.class), (TL_stars.starGiftAttributeModel) zf.d.d(arrayList, TL_stars.starGiftAttributeModel.class));
                this.f47664k0.N(false);
                T(false);
                return;
            }
        }
    ...
    public final void Q(int i10) {
        ah.h hVar;
        int dp;
        if (Build.VERSION.SDK_INT >= 31 && (hVar = this.f47671s0) != null) {
            if (w7.c0.a(i10, 2)) {
                org.telegram.ui.ActionBar.d3 d3Var = this.container;
                r0 r0Var = this.f47663j0;
                PointF pointF = this.f47678z0;
                hh.k.b(r0Var, d3Var, pointF);
                float f7 = pointF.x;
                RectF rectF = this.f47677y0;
                rectF.left = f7;
                rectF.top = pointF.y;
            ...
            if (hVar.f458j != 0) {
                hVar.e(this.f47670r0, this.container.getWidth(), this.container.getHeight());
            }
        }
    }
    ...
    public final boolean R(o0 o0Var) {
        if (this.C0 != 1) {
            int i10 = this.f47663j0.f47630r;
            o0 o0Var2 = this.f47674v0;
            if (o0Var2 != null) {
                if (i10 == 1) {
                    if (o0Var.f47483a != o0Var2.f47483a) {
                        return false;
                    }
                } else if (i10 == 2) {
                    if (o0Var.f47484b != o0Var2.f47484b) {
                        return false;
                    }
                } else if (i10 != 0 || o0Var.f47485c != o0Var2.f47485c) {
                    return false;
                }
                return true;
            }
    ...
    public final void S(int i10) {
        ...
        this.f47666n0.setImageResource(i11);
        if (i10 == 2) {
            i12 = R.string.Gift2PreviewSelectedTraits;
        } else {
            i12 = R.string.Gift2PreviewRandomTraits;
        }
        this.f47668p0.setText(LocaleController.getString(i12));
        U();
    }

    public final void T(boolean z10) {
        m0 m0Var = this.f47667o0;
    ...
    public final void U() {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if ((childAt instanceof q0) && (o0Var = (q0Var = (q0) childAt).v) != null) {
                boolean R = R(o0Var);
                q0Var.f47572c.f(R, true);
                q0Var.f47575r.a(R, true);
            }
        }
    }
    ...
    public final boolean isTouchOutside(float f7, float f10) {
        FrameLayout frameLayout = this.f47665l0;
    ...
    public final void mainContainerDispatchDraw(Canvas canvas) {
        ...
        if (Build.VERSION.SDK_INT >= 31 && canvas.isHardwareAccelerated() && (hVar = this.f47671s0) != null && (dVar = this.f47672t0) != null && !dVar.f9061n && dVar.f(width, height)) {
            RecordingCanvas a2 = dVar.a(width, height);
            a2.drawColor(getThemedColor(org.telegram.ui.ActionBar.h6.f18877i5));
            if (LiteMode.isEnabled(262144)) {
                i10 = -2;
            } else {
                i10 = -3;
