...
public final class s0 extends za {
    ...
    public final ArrayList f47765a0;
    public final ArrayList f47766b0;
    public final ArrayList f47767c0;
    public final ArrayList f47768d0;
    public final com.google.android.gms.common.api.internal.r f47769e0;
    public final com.google.android.gms.common.api.internal.r f47770f0;
    public final com.google.android.gms.common.api.internal.r f47771g0;
    public final nz f47772h0;
    public final l0 f47773i0;
    public final r0 f47774j0;
    public n0 f47775k0;
    public final FrameLayout f47776l0;
    public final ImageView m0;
    public final ImageView f47777n0;
    public final m0 f47778o0;
    public final TextView f47779p0;
    public final View f47780q0;
    public final ah.o f47781r0;
    public final ah.i f47782s0;
    public final fh.d f47783t0;
    public final ah.c f47784u0;
    public o0 f47785v0;
    public final boolean f47786w0;
    public boolean f47787x0;
    public final RectF f47788y0;
    public final PointF f47789z0;
    ...
    public s0(Context context, org.telegram.ui.ActionBar.f6 f6Var, int i10, String str, ArrayList arrayList, boolean z10) {
        ...
        this.f47781r0 = new ah.o(ml0Var, e3Var, new zs(ml0Var, 0));
        ...
        this.f47770f0 = rVar2;
        rVar2.f6165b = false;
        this.f47767c0 = zf.d.c(arrayList, TL_stars.starGiftAttributeModel.class);
        ArrayList arrayList3 = new ArrayList();
        this.f47768d0 = arrayList3;
        if (z10) {
            int i12 = 0;
            while (i12 < this.f47767c0.size()) {
                TL_stars.starGiftAttributeModel stargiftattributemodel = (TL_stars.starGiftAttributeModel) this.f47767c0.get(i12);
                if (stargiftattributemodel.rarity instanceof TL_stars.TL_starGiftAttributeRarity) {
                    this.f47768d0.add(stargiftattributemodel);
                    this.f47767c0.remove(i12);
                    i12--;
                }
                i12++;
            }
        ...
        List.EL.sort(this.f47765a0, Comparator$CC.comparingDouble(new l71(4)));
        List.EL.sort(this.f47766b0, Comparator$CC.comparingDouble(new l71(5)));
        List.EL.sort(this.f47767c0, Comparator$CC.comparingDouble(new l71(6)));
        List.EL.sort(this.f47768d0, Comparator$CC.comparingDouble(new l71(6)));
        com.google.android.gms.common.api.internal.r rVar3 = new com.google.android.gms.common.api.internal.r(this.f47767c0);
        this.f47771g0 = rVar3;
        rVar3.f6165b = false;
        ...
        int i13 = org.telegram.ui.ActionBar.j6.f18952i5;
        int themedColor = getThemedColor(i13);
        int i14 = org.telegram.ui.ActionBar.j6.f18934h5;
        ...
        if (Build.VERSION.SDK_INT >= 31 && SharedConfig.chatBlurEnabled()) {
            this.f47782s0 = new ah.i(false);
            fh.d dVar = new fh.d(cVar);
            this.f47783t0 = dVar;
            dVar.v = new Runnable(this) {
                public final s0 f47388b;
                    ...
                    switch (r2) {
                        case 0:
                            if (Build.VERSION.SDK_INT >= 31) {
                                s0 s0Var = this.f47388b;
                                if (s0Var.f47782s0 != null) {
                                    s0Var.Q(2);
                                    return;
                                }
                                return;
            ...
            this.f47782s0 = null;
            this.f47783t0 = null;
            this.f47784u0 = new ah.c(cVar);
        }
        hh.k kVar = new hh.k(this.container);
        ah.c cVar3 = this.f47784u0;
        ...
        this.Z = new ai.v7[3];
        this.f47774j0 = new r0(context, f6Var, new org.telegram.ui.web.b1(this, 22));
        int i19 = 0;
        while (true) {
            ...
            if (i19 < v7VarArr.length) {
                ...
                this.f47776l0.addView(this.Y, w7.x5.d(-1, -2.0f, 87, 16.0f, 0.0f, 16.0f, 18.0f));
                this.containerView.addView(this.f47776l0, w7.x5.e(-1, 315, 55));
                int d = i0.a.d(0.1f, getThemedColor(org.telegram.ui.ActionBar.j6.f18952i5), getThemedColor(org.telegram.ui.ActionBar.j6.f18934h5));
                ...
                this.f47774j0.setPadding(AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f));
                ch.d c12 = this.f47784u0.c(this.f47774j0, null, false);
                c12.p(AndroidUtilities.dp(4.0f));
                c12.q(AndroidUtilities.dp(28.0f));
                c12.o(new dh.b(org.telegram.ui.ActionBar.j6.f18863d6, f6Var));
                this.f47774j0.setBackground(c12);
                this.containerView.addView(this.f47774j0, w7.x5.d(268, 64.0f, 81, 0.0f, 0.0f, 0.0f, 5.0f));
                this.f47785v0 = new o0((TL_stars.starGiftAttributeBackdrop) zf.d.d(arrayList, TL_stars.starGiftAttributeBackdrop.class), (TL_stars.starGiftAttributePattern) zf.d.d(arrayList, TL_stars.starGiftAttributePattern.class), (TL_stars.starGiftAttributeModel) zf.d.d(arrayList, TL_stars.starGiftAttributeModel.class));
                this.f47775k0.N(false);
                T(false);
                return;
            }
        }
    ...
    public final void Q(int i10) {
        ah.i iVar;
        int dp;
        if (Build.VERSION.SDK_INT >= 31 && (iVar = this.f47782s0) != null) {
            if (w7.c0.a(i10, 2)) {
                org.telegram.ui.ActionBar.e3 e3Var = this.container;
                r0 r0Var = this.f47774j0;
                PointF pointF = this.f47789z0;
                hh.k.b(r0Var, e3Var, pointF);
                float f7 = pointF.x;
                RectF rectF = this.f47788y0;
                rectF.left = f7;
                rectF.top = pointF.y;
            ...
            if (iVar.f461k != 0) {
                iVar.e(this.f47781r0, this.container.getWidth(), this.container.getHeight());
            }
        }
    }
    ...
    public final boolean R(o0 o0Var) {
        if (this.C0 != 1) {
            int i10 = this.f47774j0.f47720r;
            o0 o0Var2 = this.f47785v0;
            if (o0Var2 != null) {
                if (i10 == 1) {
                    if (o0Var.f47578a != o0Var2.f47578a) {
                        return false;
                    }
                } else if (i10 == 2) {
                    if (o0Var.f47579b != o0Var2.f47579b) {
                        return false;
                    }
                } else if (i10 != 0 || o0Var.f47580c != o0Var2.f47580c) {
                    return false;
                }
                return true;
            }
    ...
    public final void U() {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if ((childAt instanceof q0) && (o0Var = (q0Var = (q0) childAt).v) != null) {
                boolean R = R(o0Var);
                q0Var.f47670c.f(R, true);
                q0Var.f47673r.a(R, true);
            }
        }
    }
    ...
    public final boolean isTouchOutside(float f7, float f10) {
        FrameLayout frameLayout = this.f47776l0;
    ...
    public final void mainContainerDispatchDraw(Canvas canvas) {
        ...
        if (Build.VERSION.SDK_INT >= 31 && canvas.isHardwareAccelerated() && (iVar = this.f47782s0) != null && (dVar = this.f47783t0) != null && !dVar.f9078n && dVar.f(width, height)) {
            RecordingCanvas a2 = dVar.a(width, height);
            a2.drawColor(getThemedColor(org.telegram.ui.ActionBar.j6.f18952i5));
            if (LiteMode.isEnabled(262144)) {
                i10 = -2;
            } else {
                i10 = -3;
