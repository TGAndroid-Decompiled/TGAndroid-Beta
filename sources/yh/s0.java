...
public final class s0 extends ab {
    ...
    public final ArrayList f48007a0;
    public final ArrayList f48008b0;
    public final ArrayList f48009c0;
    public final ArrayList f48010d0;
    public final com.google.android.gms.common.api.internal.r f48011e0;
    public final com.google.android.gms.common.api.internal.r f48012f0;
    public final com.google.android.gms.common.api.internal.r f48013g0;
    public final nz f48014h0;
    public final l0 f48015i0;
    public final r0 f48016j0;
    public n0 f48017k0;
    public final FrameLayout f48018l0;
    public final ImageView m0;
    public final ImageView f48019n0;
    public final m0 f48020o0;
    public final TextView f48021p0;
    public final View f48022q0;
    public final ah.o f48023r0;
    public final ah.i f48024s0;
    public final fh.d f48025t0;
    public final ah.c f48026u0;
    public o0 f48027v0;
    public final boolean f48028w0;
    public boolean f48029x0;
    public final RectF f48030y0;
    public final PointF f48031z0;
    ...
    public s0(Context context, org.telegram.ui.ActionBar.f6 f6Var, int i10, String str, ArrayList arrayList, boolean z10) {
        ...
        this.f48023r0 = new ah.o(vl0Var, d3Var, new xs(vl0Var, 0));
        ...
        this.f48012f0 = rVar2;
        rVar2.f6166b = false;
        this.f48009c0 = zf.d.c(arrayList, TL_stars.starGiftAttributeModel.class);
        ArrayList arrayList3 = new ArrayList();
        this.f48010d0 = arrayList3;
        if (z10) {
            int i12 = 0;
            while (i12 < this.f48009c0.size()) {
                TL_stars.starGiftAttributeModel stargiftattributemodel = (TL_stars.starGiftAttributeModel) this.f48009c0.get(i12);
                if (stargiftattributemodel.rarity instanceof TL_stars.TL_starGiftAttributeRarity) {
                    this.f48010d0.add(stargiftattributemodel);
                    this.f48009c0.remove(i12);
                    i12--;
                }
                i12++;
            }
        ...
        List.EL.sort(this.f48007a0, Comparator$CC.comparingDouble(new x71(4)));
        List.EL.sort(this.f48008b0, Comparator$CC.comparingDouble(new x71(5)));
        List.EL.sort(this.f48009c0, Comparator$CC.comparingDouble(new x71(6)));
        List.EL.sort(this.f48010d0, Comparator$CC.comparingDouble(new x71(6)));
        com.google.android.gms.common.api.internal.r rVar3 = new com.google.android.gms.common.api.internal.r(this.f48009c0);
        this.f48013g0 = rVar3;
        rVar3.f6166b = false;
        ...
        int i13 = org.telegram.ui.ActionBar.j6.f19183i5;
        int themedColor = getThemedColor(i13);
        int i14 = org.telegram.ui.ActionBar.j6.f19165h5;
        ...
        if (Build.VERSION.SDK_INT >= 31 && SharedConfig.chatBlurEnabled()) {
            this.f48024s0 = new ah.i(false);
            fh.d dVar = new fh.d(cVar);
            this.f48025t0 = dVar;
            dVar.v = new Runnable(this) {
                public final s0 f47621b;
                    ...
                    switch (r2) {
                        case 0:
                            if (Build.VERSION.SDK_INT >= 31) {
                                s0 s0Var = this.f47621b;
                                if (s0Var.f48024s0 != null) {
                                    s0Var.Q(2);
                                    return;
                                }
                                return;
            ...
            this.f48024s0 = null;
            this.f48025t0 = null;
            this.f48026u0 = new ah.c(cVar);
        }
        hh.k kVar = new hh.k(this.container);
        ah.c cVar3 = this.f48026u0;
        ...
        this.Z = new ai.v7[3];
        this.f48016j0 = new r0(context, f6Var, new org.telegram.ui.web.b1(this, 22));
        int i19 = 0;
        while (true) {
            ...
            if (i19 < v7VarArr.length) {
                ...
                this.f48018l0.addView(this.Y, w7.y5.d(-1, -2.0f, 87, 16.0f, 0.0f, 16.0f, 18.0f));
                this.containerView.addView(this.f48018l0, w7.y5.e(-1, 315, 55));
                int d = i0.a.d(0.1f, getThemedColor(org.telegram.ui.ActionBar.j6.f19183i5), getThemedColor(org.telegram.ui.ActionBar.j6.f19165h5));
                ...
                this.f48016j0.setPadding(AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f));
                ch.d c12 = this.f48026u0.c(this.f48016j0, null, false);
                c12.p(AndroidUtilities.dp(4.0f));
                c12.q(AndroidUtilities.dp(28.0f));
                c12.o(new dh.b(org.telegram.ui.ActionBar.j6.f19094d6, f6Var));
                this.f48016j0.setBackground(c12);
                this.containerView.addView(this.f48016j0, w7.y5.d(268, 64.0f, 81, 0.0f, 0.0f, 0.0f, 5.0f));
                this.f48027v0 = new o0((TL_stars.starGiftAttributeBackdrop) zf.d.d(arrayList, TL_stars.starGiftAttributeBackdrop.class), (TL_stars.starGiftAttributePattern) zf.d.d(arrayList, TL_stars.starGiftAttributePattern.class), (TL_stars.starGiftAttributeModel) zf.d.d(arrayList, TL_stars.starGiftAttributeModel.class));
                this.f48017k0.N(false);
                T(false);
                return;
            }
        }
    ...
    public final void Q(int i10) {
        ah.i iVar;
        int dp;
        if (Build.VERSION.SDK_INT >= 31 && (iVar = this.f48024s0) != null) {
            if (w7.d0.a(i10, 2)) {
                org.telegram.ui.ActionBar.d3 d3Var = this.container;
                r0 r0Var = this.f48016j0;
                PointF pointF = this.f48031z0;
                hh.k.b(r0Var, d3Var, pointF);
                float f7 = pointF.x;
                RectF rectF = this.f48030y0;
                rectF.left = f7;
                rectF.top = pointF.y;
            ...
            if (iVar.f461k != 0) {
                iVar.e(this.f48023r0, this.container.getWidth(), this.container.getHeight());
            }
        }
    }
    ...
    public final boolean R(o0 o0Var) {
        if (this.C0 != 1) {
            int i10 = this.f48016j0.f47983r;
            o0 o0Var2 = this.f48027v0;
            if (o0Var2 != null) {
                if (i10 == 1) {
                    if (o0Var.f47836a != o0Var2.f47836a) {
                        return false;
                    }
                } else if (i10 == 2) {
                    if (o0Var.f47837b != o0Var2.f47837b) {
                        return false;
                    }
                } else if (i10 != 0 || o0Var.f47838c != o0Var2.f47838c) {
                    return false;
                }
                return true;
            }
    ...
    public final void U() {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if ((childAt instanceof q0) && (o0Var = (q0Var = (q0) childAt).v) != null) {
                boolean R = R(o0Var);
                q0Var.f47925c.f(R, true);
                q0Var.f47928r.a(R, true);
            }
        }
    }
    ...
    public final boolean isTouchOutside(float f7, float f10) {
        FrameLayout frameLayout = this.f48018l0;
    ...
    public final void mainContainerDispatchDraw(Canvas canvas) {
        ...
        if (Build.VERSION.SDK_INT >= 31 && canvas.isHardwareAccelerated() && (iVar = this.f48024s0) != null && (dVar = this.f48025t0) != null && !dVar.f9078n && dVar.g(width, height)) {
            RecordingCanvas a2 = dVar.a(width, height);
            a2.drawColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19183i5));
            if (LiteMode.isEnabled(262144)) {
                i10 = -2;
            } else {
                i10 = -3;
