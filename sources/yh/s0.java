...
public final class s0 extends za {
    ...
    public final ArrayList f47737a0;
    public final ArrayList f47738b0;
    public final ArrayList f47739c0;
    public final ArrayList f47740d0;
    public final com.google.android.gms.common.api.internal.r f47741e0;
    public final com.google.android.gms.common.api.internal.r f47742f0;
    public final com.google.android.gms.common.api.internal.r f47743g0;
    public final nz f47744h0;
    public final l0 f47745i0;
    public final r0 f47746j0;
    public n0 f47747k0;
    public final FrameLayout f47748l0;
    public final ImageView m0;
    public final ImageView f47749n0;
    public final m0 f47750o0;
    public final TextView f47751p0;
    public final View f47752q0;
    public final ah.n f47753r0;
    public final ah.h f47754s0;
    public final fh.d f47755t0;
    public final ah.c f47756u0;
    public o0 f47757v0;
    public final boolean f47758w0;
    public boolean f47759x0;
    public final RectF f47760y0;
    public final PointF f47761z0;
    ...
    public s0(Context context, org.telegram.ui.ActionBar.e6 e6Var, int i10, String str, ArrayList arrayList, boolean z10) {
        ...
        this.f47753r0 = new ah.n(ll0Var, d3Var, new xs(ll0Var, 0));
        ...
        this.f47742f0 = rVar2;
        rVar2.f6160b = false;
        this.f47739c0 = zf.d.c(arrayList, TL_stars.starGiftAttributeModel.class);
        ArrayList arrayList3 = new ArrayList();
        this.f47740d0 = arrayList3;
        if (z10) {
            int i12 = 0;
            while (i12 < this.f47739c0.size()) {
                TL_stars.starGiftAttributeModel stargiftattributemodel = (TL_stars.starGiftAttributeModel) this.f47739c0.get(i12);
                if (stargiftattributemodel.rarity instanceof TL_stars.TL_starGiftAttributeRarity) {
                    this.f47740d0.add(stargiftattributemodel);
                    this.f47739c0.remove(i12);
                    i12--;
                }
                i12++;
            }
        ...
        List.EL.sort(this.f47737a0, Comparator$CC.comparingDouble(new k71(4)));
        List.EL.sort(this.f47738b0, Comparator$CC.comparingDouble(new k71(5)));
        List.EL.sort(this.f47739c0, Comparator$CC.comparingDouble(new k71(6)));
        List.EL.sort(this.f47740d0, Comparator$CC.comparingDouble(new k71(6)));
        com.google.android.gms.common.api.internal.r rVar3 = new com.google.android.gms.common.api.internal.r(this.f47739c0);
        this.f47743g0 = rVar3;
        rVar3.f6160b = false;
        ...
        int i13 = org.telegram.ui.ActionBar.i6.f18925i5;
        ...
        if (Build.VERSION.SDK_INT >= 31 && SharedConfig.chatBlurEnabled()) {
            this.f47754s0 = new ah.h(false);
            fh.d dVar = new fh.d(cVar);
            this.f47755t0 = dVar;
            dVar.v = new Runnable(this) {
                public final s0 f47360b;
                    ...
                    switch (r2) {
                        case 0:
                            if (Build.VERSION.SDK_INT >= 31) {
                                s0 s0Var = this.f47360b;
                                if (s0Var.f47754s0 != null) {
                                    s0Var.Q(2);
                                    return;
                                }
                                return;
            ...
            this.f47754s0 = null;
            this.f47755t0 = null;
            this.f47756u0 = new ah.c(cVar);
        }
        hh.k kVar = new hh.k(this.container);
        ah.c cVar3 = this.f47756u0;
        ...
        this.Z = new ai.v7[3];
        this.f47746j0 = new r0(context, e6Var, new org.telegram.ui.web.b1(this, 22));
        int i19 = 0;
        while (true) {
            ...
            if (i19 < v7VarArr.length) {
                ...
                if (i19 != 0) {
                    if (i19 != 1) {
                        if (i19 == 2) {
                            ((TextView) this.Z[i19].f1609b).setText(LocaleController.getString(R.string.GiftPreviewSymbol));
                        }
                    } else {
                        ((TextView) this.Z[i19].f1609b).setText(LocaleController.getString(R.string.GiftPreviewBackdrop));
                    }
                } else {
                    ((TextView) this.Z[i19].f1609b).setText(LocaleController.getString(R.string.GiftPreviewModel));
                }
                w7.z5.a(this.Z[i19]);
                ...
                this.f47748l0.addView(this.Y, w7.x5.d(-1, -2.0f, 87, 16.0f, 0.0f, 16.0f, 18.0f));
                this.containerView.addView(this.f47748l0, w7.x5.e(-1, 315, 55));
                int d = i0.a.d(0.1f, getThemedColor(org.telegram.ui.ActionBar.i6.f18925i5), getThemedColor(org.telegram.ui.ActionBar.i6.f18907h5));
                ...
                this.f47746j0.setPadding(AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f));
                ch.d c12 = this.f47756u0.c(this.f47746j0, null, false);
                c12.p(AndroidUtilities.dp(4.0f));
                c12.q(AndroidUtilities.dp(28.0f));
                c12.o(new dh.b(org.telegram.ui.ActionBar.i6.f18836d6, e6Var));
                this.f47746j0.setBackground(c12);
                this.containerView.addView(this.f47746j0, w7.x5.d(268, 64.0f, 81, 0.0f, 0.0f, 0.0f, 5.0f));
                this.f47757v0 = new o0((TL_stars.starGiftAttributeBackdrop) zf.d.d(arrayList, TL_stars.starGiftAttributeBackdrop.class), (TL_stars.starGiftAttributePattern) zf.d.d(arrayList, TL_stars.starGiftAttributePattern.class), (TL_stars.starGiftAttributeModel) zf.d.d(arrayList, TL_stars.starGiftAttributeModel.class));
                this.f47747k0.N(false);
                T(false);
                return;
            }
        }
    ...
    public final void Q(int i10) {
        ah.h hVar;
        int dp;
        if (Build.VERSION.SDK_INT >= 31 && (hVar = this.f47754s0) != null) {
            if (w7.c0.a(i10, 2)) {
                org.telegram.ui.ActionBar.d3 d3Var = this.container;
                r0 r0Var = this.f47746j0;
                PointF pointF = this.f47761z0;
                hh.k.b(r0Var, d3Var, pointF);
                float f7 = pointF.x;
                RectF rectF = this.f47760y0;
                rectF.left = f7;
                rectF.top = pointF.y;
            ...
            if (hVar.f456j != 0) {
                hVar.e(this.f47753r0, this.container.getWidth(), this.container.getHeight());
            }
        }
    }
    ...
    public final boolean R(o0 o0Var) {
        if (this.C0 != 1) {
            int i10 = this.f47746j0.f47692r;
            o0 o0Var2 = this.f47757v0;
            if (o0Var2 != null) {
                if (i10 == 1) {
                    if (o0Var.f47550a != o0Var2.f47550a) {
                        return false;
                    }
                } else if (i10 == 2) {
                    if (o0Var.f47551b != o0Var2.f47551b) {
                        return false;
                    }
                } else if (i10 != 0 || o0Var.f47552c != o0Var2.f47552c) {
                    return false;
                }
                return true;
            }
    ...
    public final void U() {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if ((childAt instanceof q0) && (o0Var = (q0Var = (q0) childAt).v) != null) {
                boolean R = R(o0Var);
                q0Var.f47642c.f(R, true);
                q0Var.f47645r.a(R, true);
            }
        }
    }
    ...
    public final boolean isTouchOutside(float f7, float f10) {
        FrameLayout frameLayout = this.f47748l0;
    ...
    public final void mainContainerDispatchDraw(Canvas canvas) {
        ...
        if (Build.VERSION.SDK_INT >= 31 && canvas.isHardwareAccelerated() && (hVar = this.f47754s0) != null && (dVar = this.f47755t0) != null && !dVar.f9073n && dVar.f(width, height)) {
            RecordingCanvas a2 = dVar.a(width, height);
            a2.drawColor(getThemedColor(org.telegram.ui.ActionBar.i6.f18925i5));
            if (LiteMode.isEnabled(262144)) {
                i10 = -2;
            } else {
                i10 = -3;
