...
public final class s0 extends ab {
    ...
    public final ArrayList f48028a0;
    public final ArrayList f48029b0;
    public final ArrayList f48030c0;
    public final ArrayList f48031d0;
    public final com.google.android.gms.common.api.internal.r f48032e0;
    public final com.google.android.gms.common.api.internal.r f48033f0;
    public final com.google.android.gms.common.api.internal.r f48034g0;
    public final nz f48035h0;
    public final l0 f48036i0;
    public final r0 f48037j0;
    public n0 f48038k0;
    public final FrameLayout f48039l0;
    public final ImageView m0;
    public final ImageView f48040n0;
    public final m0 f48041o0;
    public final TextView f48042p0;
    public final View f48043q0;
    public final ah.o f48044r0;
    public final ah.i f48045s0;
    public final fh.d f48046t0;
    public final ah.c f48047u0;
    public o0 f48048v0;
    public final boolean f48049w0;
    public boolean f48050x0;
    public final RectF f48051y0;
    public final PointF f48052z0;
    ...
    public s0(Context context, org.telegram.ui.ActionBar.f6 f6Var, int i10, String str, ArrayList arrayList, boolean z10) {
        ...
        this.f48044r0 = new ah.o(yl0Var, d3Var, new xs(yl0Var, 0));
        ...
        this.f48033f0 = rVar2;
        rVar2.f6164b = false;
        this.f48030c0 = zf.d.c(arrayList, TL_stars.starGiftAttributeModel.class);
        ArrayList arrayList3 = new ArrayList();
        this.f48031d0 = arrayList3;
        if (z10) {
            int i12 = 0;
            while (i12 < this.f48030c0.size()) {
                TL_stars.starGiftAttributeModel stargiftattributemodel = (TL_stars.starGiftAttributeModel) this.f48030c0.get(i12);
                if (stargiftattributemodel.rarity instanceof TL_stars.TL_starGiftAttributeRarity) {
                    this.f48031d0.add(stargiftattributemodel);
                    this.f48030c0.remove(i12);
                    i12--;
                }
                i12++;
            }
        ...
        List.EL.sort(this.f48028a0, Comparator$CC.comparingDouble(new z71(4)));
        List.EL.sort(this.f48029b0, Comparator$CC.comparingDouble(new z71(5)));
        List.EL.sort(this.f48030c0, Comparator$CC.comparingDouble(new z71(6)));
        List.EL.sort(this.f48031d0, Comparator$CC.comparingDouble(new z71(6)));
        com.google.android.gms.common.api.internal.r rVar3 = new com.google.android.gms.common.api.internal.r(this.f48030c0);
        this.f48034g0 = rVar3;
        rVar3.f6164b = false;
        ...
        int i13 = org.telegram.ui.ActionBar.j6.f19198i5;
        int themedColor = getThemedColor(i13);
        int i14 = org.telegram.ui.ActionBar.j6.f19180h5;
        ...
        if (Build.VERSION.SDK_INT >= 31 && SharedConfig.chatBlurEnabled()) {
            this.f48045s0 = new ah.i(false);
            fh.d dVar = new fh.d(cVar);
            this.f48046t0 = dVar;
            dVar.v = new Runnable(this) {
                public final s0 f47642b;
                    ...
                    switch (r2) {
                        case 0:
                            if (Build.VERSION.SDK_INT >= 31) {
                                s0 s0Var = this.f47642b;
                                if (s0Var.f48045s0 != null) {
                                    s0Var.Q(2);
                                    return;
                                }
                                return;
            ...
            this.f48045s0 = null;
            this.f48046t0 = null;
            this.f48047u0 = new ah.c(cVar);
        }
        hh.k kVar = new hh.k(this.container);
        ah.c cVar3 = this.f48047u0;
        ...
        this.Z = new ai.v7[3];
        this.f48037j0 = new r0(context, f6Var, new org.telegram.ui.web.b1(this, 22));
        int i19 = 0;
        while (true) {
            ...
            if (i19 < v7VarArr.length) {
                ...
                this.f48039l0.addView(this.Y, w7.y5.d(-1, -2.0f, 87, 16.0f, 0.0f, 16.0f, 18.0f));
                this.containerView.addView(this.f48039l0, w7.y5.e(-1, 315, 55));
                int d = i0.a.d(0.1f, getThemedColor(org.telegram.ui.ActionBar.j6.f19198i5), getThemedColor(org.telegram.ui.ActionBar.j6.f19180h5));
                ...
                this.f48037j0.setPadding(AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f));
                ch.d c12 = this.f48047u0.c(this.f48037j0, null, false);
                c12.p(AndroidUtilities.dp(4.0f));
                c12.q(AndroidUtilities.dp(28.0f));
                c12.o(new dh.b(org.telegram.ui.ActionBar.j6.f19109d6, f6Var));
                this.f48037j0.setBackground(c12);
                this.containerView.addView(this.f48037j0, w7.y5.d(268, 64.0f, 81, 0.0f, 0.0f, 0.0f, 5.0f));
                this.f48048v0 = new o0((TL_stars.starGiftAttributeBackdrop) zf.d.d(arrayList, TL_stars.starGiftAttributeBackdrop.class), (TL_stars.starGiftAttributePattern) zf.d.d(arrayList, TL_stars.starGiftAttributePattern.class), (TL_stars.starGiftAttributeModel) zf.d.d(arrayList, TL_stars.starGiftAttributeModel.class));
                this.f48038k0.N(false);
                T(false);
                return;
            }
        }
    ...
    public final void Q(int i10) {
        ah.i iVar;
        int dp;
        if (Build.VERSION.SDK_INT >= 31 && (iVar = this.f48045s0) != null) {
            if (w7.d0.a(i10, 2)) {
                org.telegram.ui.ActionBar.d3 d3Var = this.container;
                r0 r0Var = this.f48037j0;
                PointF pointF = this.f48052z0;
                hh.k.b(r0Var, d3Var, pointF);
                float f7 = pointF.x;
                RectF rectF = this.f48051y0;
                rectF.left = f7;
                rectF.top = pointF.y;
            ...
            if (iVar.f458k != 0) {
                iVar.e(this.f48044r0, this.container.getWidth(), this.container.getHeight());
            }
        }
    }
    ...
    public final boolean R(o0 o0Var) {
        if (this.C0 != 1) {
            int i10 = this.f48037j0.f48004r;
            o0 o0Var2 = this.f48048v0;
            if (o0Var2 != null) {
                if (i10 == 1) {
                    if (o0Var.f47857a != o0Var2.f47857a) {
                        return false;
                    }
                } else if (i10 == 2) {
                    if (o0Var.f47858b != o0Var2.f47858b) {
                        return false;
                    }
                } else if (i10 != 0 || o0Var.f47859c != o0Var2.f47859c) {
                    return false;
                }
                return true;
            }
    ...
    public final void U() {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if ((childAt instanceof q0) && (o0Var = (q0Var = (q0) childAt).v) != null) {
                boolean R = R(o0Var);
                q0Var.f47946c.f(R, true);
                q0Var.f47949r.a(R, true);
            }
        }
    }
    ...
    public final boolean isTouchOutside(float f7, float f10) {
        FrameLayout frameLayout = this.f48039l0;
    ...
    public final void mainContainerDispatchDraw(Canvas canvas) {
        ...
        if (Build.VERSION.SDK_INT >= 31 && canvas.isHardwareAccelerated() && (iVar = this.f48045s0) != null && (dVar = this.f48046t0) != null && !dVar.f9078n && dVar.f(width, height)) {
            RecordingCanvas a2 = dVar.a(width, height);
            a2.drawColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19198i5));
            if (LiteMode.isEnabled(262144)) {
                i10 = -2;
            } else {
                i10 = -3;
