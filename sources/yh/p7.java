...
public final class p7 extends i51 {
    public static final int f47661a = 0;
    ...
    public final void bindView(View view, j51 j51Var, boolean z10, x51 x51Var, f61 f61Var) {
        ...
        u9 u9Var = q7Var.f47700c;
        org.telegram.ui.ActionBar.f6 f6Var = q7Var.f47699b;
        TextView textView = q7Var.h;
        TextView textView2 = q7Var.f47701f;
        TextView textView3 = q7Var.e;
        int i12 = q7Var.f47698a;
        TextView textView4 = q7Var.f47702n;
        long peerDialogId = DialogObject.getPeerDialogId(starsSubscription.peer);
        q7Var.f47703r = !TextUtils.isEmpty(starsSubscription.title);
        if (peerDialogId < 0) {
        ...
        if (!TextUtils.isEmpty(starsSubscription.title)) {
            ...
            if (starsSubscription.photo != null) {
                ...
                z70Var.f40147b.setImage(ImageLocation.getForWebFile(WebFile.createWithWebDocument(starsSubscription.photo)), "14_14", null, null, 0, 0);
        ...
        if (!starsSubscription.canceled && !starsSubscription.bot_canceled) {
            ...
            if (j3 < currentTime) {
                ...
                textView4.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19264z6, f6Var));
        ...
        if (j51Var2 != null) {
            ...
            if (obj instanceof TL_stars.StarsSubscription) {
                ...
                if (obj2 instanceof TL_stars.StarsSubscription) {
                    return TextUtils.equals(((TL_stars.StarsSubscription) obj).f18347id, ((TL_stars.StarsSubscription) obj2).f18347id);
                }
                return false;
            }
            return false;
