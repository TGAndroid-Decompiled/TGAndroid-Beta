...
public final class p3 extends FrameLayout {
    public final x0 f47539a;
    public final o3 f47540b;
    public final o3 f47541c;
    public final o3 d;
    public boolean e;
    public final i20 f47542f;
    public final RectF h;

    public p3(Context context, org.telegram.ui.ActionBar.d6 d6Var, x0 x0Var) {
        super(context);
        this.f47542f = new i20();
        this.h = new RectF();
        this.f47539a = x0Var;
    ...
    public final void a(f3 f3Var, float f7, boolean z10, f3 f3Var2, float f10, boolean z11, f3 f3Var3, float f11, boolean z12) {
        x0 x0Var = this.f47539a;
        o3 o3Var = this.f47540b;
        if (f3Var != null) {
            if (z10) {
                f7 = Math.max(0.5f, f7);
            }
            o3Var.setVisibility(0);
            o3Var.e(f3Var.f47055a, f3Var.f47056b, x0Var);
            o3Var.setTranslationY(AndroidUtilities.dp(36.0f) * ((f7 - 0.5f) / 1.5f));
        } else {
            o3Var.setVisibility(4);
        }
        o3 o3Var2 = this.f47541c;
        if (f3Var2 != null) {
            float f12 = f10;
            if (z11) {
            ...
            o3Var2.e(f3Var2.f47055a, f3Var2.f47056b, x0Var);
        ...
        if (f3Var3 != null) {
            ...
            o3Var3.e(f3Var3.f47055a, f3Var3.f47056b, x0Var);
