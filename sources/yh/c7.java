...
public final class c7 extends LinearLayout {
    public final Path f47278a;
    public final Matrix f47279b;
    public final RadialGradient f47280c;
    ...
    public c7(Context context, Matrix matrix, RadialGradient radialGradient, Paint paint, org.telegram.ui.Components.o5 o5Var) {
        super(context);
        this.f47279b = matrix;
        this.f47280c = radialGradient;
        this.d = paint;
        this.e = o5Var;
        this.f47278a = new Path();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        Path path = this.f47278a;
        path.rewind();
        path.addRoundRect(rectF, dp, dp, Path.Direction.CW);
        canvas.save();
        canvas.clipPath(path);
        Matrix matrix = this.f47279b;
        matrix.reset();
        matrix.postTranslate(getWidth() / 2.0f, AndroidUtilities.dp(100.0f));
        this.f47280c.setLocalMatrix(matrix);
