...
public final class h3 extends f3 {
    ...
    public h3(TL_stars.starGiftAttributeBackdrop stargiftattributebackdrop) {
        this.f47408a = stargiftattributebackdrop.name;
        this.f47409b = stargiftattributebackdrop.getRarityPermille();
        ...
        this.f47507g = stargiftattributebackdrop.text_color | (-16777216);
        int i10 = stargiftattributebackdrop.pattern_color;
        this.h = i10 | (-16777216);
        this.f47506f = i0.a.d(0.25f, stargiftattributebackdrop.edge_color | (-16777216), i10 | (-16777216));
    }
}
