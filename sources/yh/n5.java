...
public final class n5 implements o5 {
    ...
    public String f47525k;
    public int f47528n;
    public boolean f47529o;
    public ArrayList f47531q;
    public boolean f47520c = false;
    public boolean e = true;
    public boolean f47521f = false;
    public int f47522g = 783;
    public final ArrayList f47526l = new ArrayList();
    public int f47527m = -1;
    public long f47530p = 0;
    ...
    public final void a() {
        ...
        if (!this.f47523i && !this.f47524j) {
            ...
            if (j3 != 0) {
                ...
                getsavedstargifts2.exclude_unupgradable = !TLObject.hasFlag(this.f47522g, 2);
                getsavedstargifts2.exclude_upgradable = !TLObject.hasFlag(this.f47522g, 4);
                getsavedstargifts2.exclude_unlimited = !TLObject.hasFlag(this.f47522g, 1);
                getsavedstargifts2.exclude_unique = !TLObject.hasFlag(this.f47522g, 8);
                getsavedstargifts2.exclude_saved = !TLObject.hasFlag(this.f47522g, 256);
                getsavedstargifts2.exclude_unsaved = !TLObject.hasFlag(this.f47522g, 512);
                getsavedstargifts2.peer_color_available = this.f47521f;
                long j10 = this.f47519b;
                if (j10 == 0) {
    ...
    public final int b(int i10) {
        if (!a4.O1(this.f47518a, this.f47519b)) {
            return -1;
        }
        int i11 = i10 + 1;
        while (true) {
            ArrayList arrayList = this.f47526l;
    ...
    @Override
    public final void d() {
        NotificationCenter.getInstance(this.f47518a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starUserGiftsLoaded, Long.valueOf(this.f47519b), this);
    }

    @Override
    public final int e() {
        return this.f47526l.size();
    }
    ...
    public final TL_stars.InputSavedStarGift g(TL_stars.SavedStarGift savedStarGift) {
        ...
        tL_inputSavedStarGiftChat.peer = MessagesController.getInstance(this.f47518a).getInputPeer(this.f47519b);
    ...
    public final ArrayList h() {
        ...
        int i10 = 0;
        while (true) {
            ArrayList arrayList2 = this.f47526l;
    ...
    public final void i(boolean z10) {
        if (this.f47527m != -1) {
            ConnectionsManager.getInstance(this.f47518a).cancelRequest(this.f47527m, true);
            this.f47527m = -1;
        }
        this.f47523i = false;
        this.f47526l.clear();
    ...
    public final int indexOf(Object obj) {
        return this.f47526l.indexOf(obj);
    }
    ...
    public final void j(ArrayList arrayList, TL_stars.StarGift starGift) {
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            while (i11 < size) {
                ...
                while (true) {
                    ...
                    if (i12 < arrayList2.size()) {
                        ...
                        if (starGift3 != null && starGift3.f18346id == starGift2.f18346id) {
                            arrayList2.remove(i12);
                            this.f47528n = Math.max(0, this.f47528n - 1);
                            z10 = true;
                            break;
                        }
                        i12++;
            ...
            if (z10) {
                NotificationCenter.getInstance(i10).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starUserGiftsLoaded, Long.valueOf(this.f47519b), this);
            }
        }
        if (starGift != null) {
        ...
        if (savedStarGift != null) {
            ...
            if (contains) {
                if (!z10) {
                    ...
                    arrayList = this.f47526l;
                    arrayList.removeAll(h);
                    if (this.e && !this.f47520c) {
