    ...
    public final void run() {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                u9[] u9VarArr = x3Var.d;
                if (u9VarArr[2 - x3Var.f48013r0].getImageReceiver().hasImageLoaded()) {
                    f4.d dVar = x3Var.U;
                    if (dVar != null && dVar.f8876b == 1 && x3Var.isAttachedToWindow()) {
                        AndroidUtilities.cancelRunOnUIThread(y2Var);
                        ValueAnimator valueAnimator = x3Var.f48002h0;
                        if (valueAnimator != null) {
                            valueAnimator.cancel();
                            x3Var.f48002h0 = null;
                        }
                        int i11 = 1 - x3Var.f48013r0;
                        x3Var.f48013r0 = i11;
                        yi0 lottieAnimation = u9VarArr[2 - i11].getImageReceiver().getLottieAnimation();
                        yi0 lottieAnimation2 = u9VarArr[x3Var.f48013r0 + 1].getImageReceiver().getLottieAnimation();
                        if (lottieAnimation2 != null && lottieAnimation != null) {
                            lottieAnimation2.T(lottieAnimation.t(), false);
                        }
                        x3Var.W.c();
                        int i12 = x3Var.f48013r0 + 1;
                        TL_stars.starGiftAttributeBackdrop[] stargiftattributebackdropArr = x3Var.V;
                        TL_stars.starGiftAttributeBackdrop stargiftattributebackdrop = (TL_stars.starGiftAttributeBackdrop) x3Var.f47994b0.c();
                        stargiftattributebackdropArr[i12] = stargiftattributebackdrop;
                        x3Var.e(i12, stargiftattributebackdrop);
                        x3Var.g(1, (TL_stars.starGiftAttributePattern) x3Var.f47992a0.c(), true);
                        x3Var.a();
                        float f7 = x3Var.f48013r0;
                        ValueAnimator ofFloat = ValueAnimator.ofFloat(1.0f - f7, f7);
                        x3Var.f48002h0 = ofFloat;
                        ofFloat.addUpdateListener(new t3(x3Var, 2));
                        x3Var.f48002h0.addListener(new v3(x3Var));
                        x3Var.f48002h0.setDuration(320L);
                        x3Var.f48002h0.setInterpolator(qr.h);
                        x3Var.f48002h0.start();
                        return;
                    }
                    return;
                }
            ...
            case 7:
                ...
                return;
            case 8:
                zg.t tVar = (zg.t) ((g2) obj).f47242a;
                zg.s sVar = tVar.f49197b;
                if (sVar != null) {
                    sVar.d();
                }
                tVar.f49196a.z7(true);
                return;
            case 9:
                ((ValueAnimator) obj).start();
                return;
            default:
                org.telegram.ui.ActionBar.o2 o2Var = ((zg.y) obj).f49218f2.f49025r;
