...
public final class y2 extends Drawable {
    ...
    public int h;
    public int f47960i;
    public final Paint f47956b = new Paint(1);
    public final Shader[] f47957c = new Shader[2];
    public final Matrix d = new Matrix();
    public final org.telegram.ui.Components.c6 e = new org.telegram.ui.Components.c6(1.0f, new x2(this, 0), 0, 420, qr.h);
    public final RectF f47958f = new RectF();
    public final int f47955a = 1;

    public final void a(int i10, int i11) {
        if (this.h == i10 && this.f47960i == i11) {
            return;
        }
        Shader[] shaderArr = this.f47957c;
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.f47959g != null) {
            ...
            j0.a(canvas, 0, this.f47959g, rectF.width(), AndroidUtilities.dp(290.0f), 2.0f, 1.0f);
            canvas.restore();
        }
    }
