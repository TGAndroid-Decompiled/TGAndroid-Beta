...
public final class a0 extends bb {
    public static final int[] f46847w0 = {21600, 43200, 86400, 129600, 172800, 259200};
    public final a X;
    public final TL_stars.TL_starGiftUnique Y;
    public final String Z;
    public final long f46848a0;
    public final m40 f46849b0;
    public final yc0 f46850c0;
    public final EditTextBoldCursor f46851d0;
    public final TextView f46852e0;
    public final y f46853f0;
    public final TextView f46854g0;
    public final ci.d f46855h0;
    public final org.telegram.ui.Components.p6 f46856i0;
    public final ImageView f46857j0;
    public final ImageView f46858k0;
    public final ka.c f46859l0;
    public zf.a m0;
    public int f46860n0;
    public int f46861o0;
    public boolean f46862p0;
    public final b1 f46863q0;
    public final pq[] f46864r0;
    public final pq[] f46865s0;
    public boolean f46866t0;
    public v51 f46867u0;
    public final h51 f46868v0;
    ...
    public a0(final Context context, final int i10, final long j3, TL_stars.TL_starGiftUnique tL_starGiftUnique, final org.telegram.ui.ActionBar.d6 d6Var, b1 b1Var) {
        ...
        n7.a1[] a1VarArr = (n7.a1[]) cVar.f13554b;
        this.f46859l0 = cVar;
        this.f46864r0 = new pq[1];
        this.f46865s0 = new pq[1];
        this.L = false;
        ...
        zf.a i11 = zf.a.i(Math.max(g10.e(bVar2).n(2).f48897b, appGlobalConfig.tonStarGiftResaleAmountMin.get()), bVar2);
        zf.a i12 = zf.a.i(Math.max(i11.f48897b * 2, appGlobalConfig.tonStarGiftResaleAmountMax.get()), bVar2);
        zf.b bVar3 = g10.f48896a;
        if (bVar3 == g11.f48896a) {
            a1VarArr[bVar3.ordinal()] = new n7.a1(29, g10, g11);
        }
        zf.b bVar4 = i11.f48896a;
        if (bVar4 == i12.f48896a) {
        ...
        this.f46851d0 = editTextBoldCursor;
        if (j10) {
            m40 m40Var = new m40(context, d6Var);
            this.f46849b0 = m40Var;
        ...
        this.f46868v0 = h51.k(linearLayout);
        this.f46867u0.N(false);
    }
    ...
    public static void P(a0 a0Var, long j3, boolean z10, zf.a aVar, long j10, org.telegram.ui.ActionBar.b2 b2Var) {
        ...
        if (i11 > 0) {
            ...
            if (z10) {
                ...
                i10 = zf.a.i(a0Var.m0.f48897b + aVar.f48897b, bVar);
            }
            if (aVar2 == null || aVar2.f48897b < i10.f48897b) {
                new l7(a0Var.getContext(), a0Var.resourcesProvider, i10.a(), 14, null, null, a0Var.f46848a0).show();
                return;
            }
        }
        ...
        tL_sendStarGiftOffer.peer = MessagesController.getInstance(a0Var.currentAccount).getInputPeer(a0Var.f46848a0);
        tL_sendStarGiftOffer.duration = a0Var.f46860n0;
    ...
    public static void Q(a0 a0Var, int i10, Context context, org.telegram.ui.ActionBar.d6 d6Var, long j3) {
        ...
        if (a0Var.f46855h0.W) {
            ...
            t5 x10 = t5.x(i10, a0Var.m0.f48896a);
            if (x10.e) {
                aVar = zf.a.l(x10.p());
            } else {
                aVar = null;
            ...
            zf.b bVar2 = zf.b.f48899b;
            if (aVar != null) {
                long j10 = aVar.f48897b;
                zf.a aVar2 = a0Var.m0;
                if (j10 >= aVar2.f48897b) {
                    String str2 = a0Var.Z;
                    long j11 = a0Var.f46848a0;
                    String d = aVar2.d();
                    if (a0Var.m0.f48896a == bVar2) {
                        str = str2;
                        z10 = true;
                    } else {
                        str = str2;
                    ...
                    oz0Var.c(LocaleController.getString(R.string.GiftOfferRowDuration), LocaleController.formatPluralString("GiftOfferHours", a0Var.f46860n0 / 3600, new Object[0]), r14, r14);
                    ...
                    if (i12 == 0) {
                        ...
                        z11 = z10;
                        spannableStringBuilder.append((CharSequence) w7.Q0(LocaleController.formatString(R.string.GiftOfferPay, zf.a.i(a0Var.m0.f48897b + g10.f48897b, bVar).d())));
    ...
    public final void S() {
        boolean z10;
        float f7;
        boolean z11 = this.f46866t0;
        a aVar = this.X;
        if ((z11 && !isDismissed() && aVar != null && this.containerView.getY() > AndroidUtilities.dp(32.0f)) || this.f46849b0 == null) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (this.f46862p0 != z10) {
            this.f46862p0 = z10;
            if (aVar != null) {
                aVar.setEnabled(z10);
    ...
    public final void T(boolean z10) {
        boolean z11;
        if (this.f46861o0 == 0 && this.m0.f48897b > 0) {
            z11 = true;
        } else {
            z11 = false;
        }
        ci.d dVar = this.f46855h0;
        if (dVar.W != z11) {
            dVar.setEnabled(z11);
    ...
    public final void U(zf.a aVar, boolean z10, boolean z11, boolean z12) {
        ...
        int i15;
        zf.a aVar2 = this.m0;
        int i16 = this.f46861o0;
        this.f46861o0 = 0;
        if (aVar != null) {
            this.m0 = aVar;
        } else {
            this.m0 = zf.a.i(0L, aVar2.f48896a);
            this.f46861o0 |= 1;
        }
        zf.b bVar2 = this.m0.f48896a;
        ka.c cVar = this.f46859l0;
        n7.a1[] a1VarArr = (n7.a1[]) cVar.f13554b;
        long j3 = ((zf.a) ((n7.a1[]) cVar.f13554b)[bVar2.ordinal()].f15084c).f48897b;
        zf.a aVar3 = this.m0;
        if (j3 < aVar3.f48897b) {
            this.f46861o0 |= 4;
        }
        if (!aVar3.k() && ((zf.a) a1VarArr[this.m0.f48896a.ordinal()].f15083b).f48897b > this.m0.f48897b) {
            this.f46861o0 |= 2;
        }
        if (!z11 && aVar2.f48896a == this.m0.f48896a) {
            z13 = false;
        } else {
            z13 = true;
        }
        if (!z11 && aVar2.f48897b == this.m0.f48897b) {
            z14 = false;
        } else {
            z14 = true;
        }
        if (!z11 && i16 == this.f46861o0) {
            z15 = false;
        } else {
            z15 = true;
        }
        zf.b bVar3 = zf.b.f48898a;
        EditTextBoldCursor editTextBoldCursor = this.f46851d0;
        zf.b bVar4 = zf.b.f48899b;
        if (z13) {
            m40 m40Var = this.f46849b0;
            if (m40Var != null) {
                if (this.m0.f48896a == bVar3) {
                    i15 = 0;
                } else {
                    i15 = 1;
                }
            ...
            String shortName = DialogObject.getShortName(this.f46848a0);
            zf.b bVar5 = this.m0.f48896a;
            TextView textView = this.f46854g0;
            if (bVar5 == bVar3) {
                ...
                editTextBoldCursor.setFilters(new InputFilter[]{new InputFilter.LengthFilter(Long.toString(((zf.a) a1VarArr[this.m0.f48896a.ordinal()].f15084c).a()).length())});
            } else if (bVar5 == bVar4) {
                ...
                editTextBoldCursor.setFilters(new InputFilter[]{new InputFilter.LengthFilter(Long.toString(((zf.a) a1VarArr[this.m0.f48896a.ordinal()].f15084c).a()).length() + 3)});
            }
            ImageView imageView = this.f46858k0;
            ImageView imageView2 = this.f46857j0;
            if (z12) {
            ...
            a aVar4 = this.X;
            if (aVar4 != null && aVar4.e != (bVar = this.m0.f48896a)) {
                aVar4.e = bVar;
                aVar4.a();
            }
        } else {
        ...
        if (z13 || z15) {
            ...
            this.f46850c0.setText(LocaleController.getString(i10));
            zf.b bVar6 = this.m0.f48896a;
            int i17 = this.f46861o0;
            int i18 = i17 & 4;
            String str = this.Z;
            TextView textView2 = this.f46852e0;
            if (i18 != 0) {
                if (bVar6 == bVar3) {
                ...
                objArr[c10] = ((zf.a) a1VarArr[bVar6.ordinal()].f15084c).d();
                objArr[1] = str;
                ul.q(i14, objArr, textView2);
            } else if ((i17 & 2) != 0) {
                if (bVar6 == bVar3) {
                ...
                objArr2[c10] = ((zf.a) a1VarArr[bVar6.ordinal()].f15083b).d();
                objArr2[1] = str;
                ul.q(i12, objArr2, textView2);
            } else {
                if (bVar6 == bVar3) {
                ...
                objArr3[c10] = str;
                ul.q(i11, objArr3, textView2);
            }
            if ((this.f46861o0 & (-9)) == 0) {
        ...
        if (z13 || z14 || z15) {
            ...
            if (z16) {
                pqVarArr = this.f46865s0;
            } else {
                pqVarArr = this.f46864r0;
            }
            this.f46855h0.g(w7.V0(z16, formatString, pqVarArr), z12, true);
            T(z12);
        }
        if (z13 || z14) {
    ...
    public final boolean isTouchOutside(float f7, float f10) {
        a aVar;
        if (this.f46862p0 && (aVar = this.X) != null && f7 >= aVar.getX() && f7 <= aVar.getX() + aVar.getWidth() && f10 >= aVar.getY() && f10 <= aVar.getY() + aVar.getHeight()) {
            return false;
        }
