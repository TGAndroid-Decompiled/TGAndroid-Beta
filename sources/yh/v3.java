...
public class v3 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.d6 f47802a;
    public com.google.android.gms.common.api.internal.r f47803a0;
    public final FrameLayout f47804b;
    public com.google.android.gms.common.api.internal.r f47805b0;
    public final n3 f47806c;
    public boolean f47807c0;
    public final w9[] d;
    public boolean f47808d0;
    public final TL_stars.starGiftAttributeModel[] e;
    public float f47809e0;
    public final LinearLayout[] f47810f;
    public float f47811f0;
    public float f47812g0;
    public final FrameLayout.LayoutParams[] h;
    public ValueAnimator f47813h0;
    public final w2 f47814i0;
    public final Paint[] f47815j0;
    public final RadialGradient[] f47816k0;
    public final Matrix[] f47817l0;
    public RadialGradient m0;
    public final xh.k1 f47818n;
    public final Matrix f47819n0;
    public final Paint f47820o0;
    public final TL_stars.starGiftAttributePattern[] f47821p0;
    public final org.telegram.ui.Components.o5[] f47822q0;
    public final d90[] f47823r;
    public int f47824r0;
    public final d90 f47825s;
    public float f47826s0;
    public float f47827t0;
    public ValueAnimator f47828u0;
    public final TextView v;
    public final RectF f47829v0;
    public int f47830w;
    public i8 f47831w0;
    public final FrameLayout f47832x;
    public final int[] f47833x0;
    public final d90[] f47834y;
    public final int[] f47835y0;
    public final int[] f47836z0;
    ...
    public v3(Context context, org.telegram.ui.ActionBar.d6 d6Var, Runnable runnable, View.OnClickListener onClickListener, u0 u0Var, View.OnClickListener onClickListener2, View.OnClickListener onClickListener3, View.OnClickListener onClickListener4, View.OnClickListener onClickListener5, View.OnClickListener onClickListener6) {
        ...
        this.f47810f = new LinearLayout[5];
        this.h = new FrameLayout.LayoutParams[5];
        this.f47823r = new d90[5];
        this.f47834y = new d90[5];
        this.E = new LinearLayout.LayoutParams[5];
        this.F = new xh.l0[5];
        this.U = new f4.d(0, 0);
        this.V = new TL_stars.starGiftAttributeBackdrop[3];
        this.f47814i0 = new w2(this, 1);
        this.f47815j0 = new Paint[3];
        this.f47816k0 = new RadialGradient[3];
        this.f47817l0 = new Matrix[3];
        this.f47819n0 = new Matrix();
        this.f47820o0 = new Paint(1);
        this.f47821p0 = new TL_stars.starGiftAttributePattern[2];
        this.f47822q0 = new org.telegram.ui.Components.o5[2];
        int i10 = 0;
        while (true) {
            Paint[] paintArr = this.f47815j0;
        ...
        int i11 = 0;
        while (true) {
            org.telegram.ui.Components.o5[] o5VarArr = this.f47822q0;
        ...
        this.f47827t0 = 1.0f;
        this.f47829v0 = new RectF();
        this.f47833x0 = new int[12];
        this.f47835y0 = new int[12];
        this.f47836z0 = new int[12];
        this.f47802a = d6Var;
        this.R = onClickListener4;
        this.S = onClickListener5;
        this.T = onClickListener6;
        setWillNotDraw(false);
        this.f47804b = new FrameLayout(context);
        int i12 = 0;
        while (true) {
            w9[] w9VarArr = this.d;
            float f10 = 0.0f;
            ...
            this.f47804b.addView(this.d[i12], w7.x5.e(-1, -1, 119));
            w9 w9Var = this.d[i12];
            if (i12 == 0) {
                f10 = 1.0f;
            }
        ...
        this.f47832x = new FrameLayout(context);
        int i14 = 0;
        while (true) {
            LinearLayout[] linearLayoutArr = this.f47810f;
            if (i14 >= linearLayoutArr.length) {
                break;
            }
            linearLayoutArr[i14] = new LinearLayout(context);
            this.f47810f[i14].setOrientation(1);
            if (i14 == 2) {
                FrameLayout frameLayout = new FrameLayout(context);
                this.J = frameLayout;
                this.f47810f[i14].addView(frameLayout, w7.x5.q(-1, 144, 119));
                ...
                this.f47823r[i14] = new d90(context, null);
                this.f47823r[i14].setTextColor(-1);
                this.f47823r[i14].setTextSize(1, 20.0f);
                this.f47823r[i14].setTypeface(AndroidUtilities.bold());
                this.f47823r[i14].setSingleLine();
                d90 d90Var2 = this.f47823r[i14];
                TextUtils.TruncateAt truncateAt = TextUtils.TruncateAt.END;
                d90Var2.setEllipsize(truncateAt);
                this.f47823r[i14].setGravity(17);
                frameLayout.addView(this.f47823r[i14], w7.x5.d(-1, -2.0f, 49, 16.0f, 95.33f, 16.0f, 0.0f));
                this.f47834y[i14] = new d90(context, null);
                this.f47834y[i14].setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18895j5, d6Var));
                this.f47834y[i14].setTextSize(1, 14.0f);
                this.f47834y[i14].setLinkTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.gc, d6Var));
                this.f47834y[i14].setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
                this.f47834y[i14].setDisablePaddingsOffsetY(true);
                this.f47834y[i14].setSingleLine();
                this.f47834y[i14].setGravity(17);
                this.f47834y[i14].setEllipsize(truncateAt);
                frameLayout.addView(this.f47834y[i14], w7.x5.d(-1, -2.0f, 49, 16.0f, 122.0f, 16.0f, 0.0f));
            } else if (i14 == 4) {
                y2 y2Var = new y2(context, d6Var);
                this.L = y2Var;
                this.f47810f[i14].addView(y2Var, w7.x5.n(-1, -2));
                View view = this.f47810f[i14];
                ...
                this.f47823r[i14] = new d90(context, null);
                this.f47823r[i14].setTextColor(i14 == 3 ? -1 : org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18895j5, d6Var));
                this.f47823r[i14].setTextSize(1, 20.0f);
                this.f47823r[i14].setTypeface(AndroidUtilities.bold());
                this.f47823r[i14].setGravity(17);
                this.f47810f[i14].addView(this.f47823r[i14], w7.x5.t(-1, -2, 17, 24, i14 == 3 ? 10 : 0, 24, 0));
                if (i14 == 0) {
                    this.f47810f[i14].addView(this.f47825s, w7.x5.t(-2, -2, 17, 0, 4, 0, 4));
                    this.f47810f[i14].addView(this.v, w7.x5.s(-2, 17, 0, 6, 0, 19.33f, 2));
                }
                if (i14 == 0) {
                    this.f47834y[i14] = new d90(context, null);
                    this.f47834y[i14].setTextColor(i14 == 3 ? org.telegram.ui.ActionBar.h6.l1(0.75f, -1) : org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18895j5, d6Var));
                    this.f47834y[i14].setTextSize(1, 14.0f);
                    this.f47834y[i14].setGravity(17);
                    this.f47834y[i14].setLinkTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.gc, d6Var));
                    this.f47834y[i14].setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
                    this.f47834y[i14].setDisablePaddingsOffsetY(true);
                    this.f47832x.addView(this.f47834y[i14], w7.x5.e(-2, -2, 17));
                    this.f47832x.addView(this.N, w7.x5.a(-2.0f, 20.33f, 17));
                    LinearLayout linearLayout = this.f47810f[i14];
                    FrameLayout frameLayout2 = this.f47832x;
                    ...
                    this.f47834y[i14].setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
                    this.f47834y[i14].setDisablePaddingsOffsetY(true);
                    LinearLayout linearLayout2 = this.f47810f[i14];
                    d90 d90Var3 = this.f47834y[i14];
                ...
                this.f47810f[i14].addView(this.F[i14], w7.x5.t(-1, -2, 17, 24, 8, 24, 0));
            }
            if (i14 == 0) {
                this.f47810f[i14].addView(this.H, w7.x5.t(-1, -2, 7, 0, 15, 0, 0));
            }
            View view2 = this.f47810f[i14];
        ...
        addView(this.f47804b, w7.x5.d(160, 160.0f, 49, 0.0f, 8.0f, 0.0f, 0.0f));
        ...
        xh.m1 m1Var = k1Var.f45922a;
        if (m1Var.f45962f == null) {
            i8 i8Var = new i8(2, 12);
            m1Var.f45962f = i8Var;
            i8Var.h = 5.0f;
        }
        Path path = m1Var.f45961c;
        float f11 = m1Var.e;
        m1Var.f45963g = true;
    ...
    public final void a() {
        ValueAnimator valueAnimator = this.f47828u0;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.f47828u0 = null;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        this.f47828u0 = ofFloat;
        ofFloat.addUpdateListener(new r3(this, 1));
        this.f47828u0.addListener(new s3(this, 4));
        this.f47828u0.setDuration(320L);
        this.f47828u0.setInterpolator(rr.f27702g);
        this.f47828u0.start();
    }

    public final int b(Canvas canvas, float f7, float f10, float f11, float f12) {
        int i10 = this.f47824r0;
        RadialGradient[] radialGradientArr = this.f47816k0;
        TL_stars.starGiftAttributeBackdrop[] stargiftattributebackdropArr = this.V;
        Matrix[] matrixArr = this.f47817l0;
        Paint[] paintArr = this.f47815j0;
        int i11 = 0;
        if (i10 == 0) {
            if (this.f47826s0 > 0.0f && stargiftattributebackdropArr[2] != null) {
            ...
            if (this.f47826s0 < 1.0f && stargiftattributebackdropArr[1] != null) {
                paintArr[1].setAlpha((int) ((1.0f - this.f47826s0) * this.U.a(1) * 255.0f));
                matrixArr[1].reset();
        ...
        if (this.f47826s0 > 0.0f && stargiftattributebackdropArr[2] != null) {
            paintArr[2].setAlpha((int) (this.U.a(1) * 255.0f * this.f47826s0));
            matrixArr[2].reset();
            matrixArr[2].postTranslate(f7, f10);
            radialGradientArr[2].setLocalMatrix(matrixArr[2]);
            canvas.drawRect(0.0f, 0.0f, f11, f12, paintArr[2]);
    ...
    public final void c(Canvas canvas, float f7, float f10, float f11, float f12) {
        ...
        int d = i0.a.d(this.f47826s0, i10, i11);
        org.telegram.ui.Components.o5[] o5VarArr = this.f47822q0;
        o5VarArr[1].k(Integer.valueOf(d));
        j0.a(canvas, 0, o5VarArr[1], f11, f12, this.U.a(1), this.f47827t0);
        canvas.restore();
    }
    ...
    public void d(f4.d dVar) {
        ...
        if ((stargiftattributebackdropArr[0] != null && dVar.f8859b == 2) || (stargiftattributebackdropArr[1] != null && dVar.f8859b == 1)) {
            i10 = 0;
        } else {
            i10 = 8;
        }
        ...
        int v02 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18895j5, this.f47802a);
        int i22 = 0;
        while (true) {
            d90VarArr = this.f47834y;
            if (i22 >= 2) {
                break;
            }
            d90 d90Var = this.f47823r[i22];
            ...
            if (i22 != 0 && i22 != 2) {
                ...
                i14 = i0.a.d(this.f47826s0, i15, i16);
            } else {
            ...
            if (z11) {
                ...
                if (i22 == 0) {
                    this.f47832x.setLayoutParams(layoutParamsArr2[i22]);
                } else {
        ...
        w9VarArr[1].setAlpha((1.0f - this.f47826s0) * dVar.a(1));
        w9VarArr[2].setAlpha(dVar.a(1) * this.f47826s0);
        float lerp3 = AndroidUtilities.lerp(1.0f, this.f47812g0, dVar.a(2));
        FrameLayout frameLayout = this.f47804b;
        frameLayout.setScaleX(lerp3);
        frameLayout.setScaleY(AndroidUtilities.lerp(1.0f, this.f47812g0, dVar.a(2)));
        frameLayout.setTranslationX(dVar.a(2) * this.f47809e0);
        frameLayout.setTranslationY((dVar.a(2) * this.f47811f0) + (dVar.a(1) * AndroidUtilities.dp(16.0f)));
        ...
        if (this.f47807c0 && this.U.b(0)) {
            i12 = 0;
        } else {
            i12 = 8;
        }
        xh.k1 k1Var = this.f47818n;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        int[] iArr4 = this.f47836z0;
        int[] iArr5 = this.f47835y0;
        int[] iArr6 = this.f47833x0;
        if (stargiftattributebackdrop != null) {
        ...
        n3 n3Var2 = this.f47806c;
        if (n3Var2.f47450s == null && n3Var2.v == null && n3Var2.f47451w == null) {
            v3Var = this;
            f12 = f7;
            f11 = f10;
            iArr3 = iArr4;
            ...
            float f13 = f7;
            h3 h3Var = n3Var2.f47450s;
            float f14 = f10;
            float f15 = n3Var2.f47452x;
            int[] iArr7 = this.f47835y0;
            int[] iArr8 = this.f47833x0;
            int[] iArr9 = this.f47836z0;
            f11 = f14;
            iArr = iArr5;
            iArr2 = iArr6;
            iArr3 = iArr4;
            ...
            n3Var2.a(canvas2, n3Var2.v, n3Var2.f47453y, width2, realHeight, iArr7, iArr8, iArr9);
            n3Var2.a(canvas2, n3Var2.f47451w, n3Var2.E, width2, realHeight, iArr7, iArr8, iArr9);
            n3Var = n3Var2;
            v3Var.invalidate();
        }
        if (i10 > 0 && stargiftattributebackdropArr[0] != null) {
            ...
            org.telegram.ui.Components.o5[] o5VarArr = v3Var.f47822q0;
            if (max2 > 0.0f) {
                canvas2.save();
            ...
            if (v3Var.U.a(2) > 0.0f) {
                ...
                LinearLayout[] linearLayoutArr = v3Var.f47810f;
            ...
            if (textView != null && v3Var.f47830w != i14) {
                v3Var.f47830w = i14;
                textView.setTextColor(i14);
                org.telegram.ui.ActionBar.h6.B1(textView.getBackground(), i15, false);
            }
            if (n3Var.f47450s != null || n3Var.v != null || n3Var.f47451w != null) {
                v3Var.f47834y[0].setTextColor(i14);
            }
            if (v3Var.U.a(2) > 0.0f) {
                if (v3Var.f47831w0 == null) {
                    v3Var.f47831w0 = new i8(1, 12);
                }
                FrameLayout frameLayout2 = v3Var.f47804b;
                ...
                RectF rectF2 = v3Var.f47829v0;
                rectF2.set(measuredWidth - scaleX, measuredHeight - scaleY, measuredWidth + scaleX, f17);
                v3Var.f47831w0.g(rectF2);
                v3Var.f47831w0.d();
                v3Var.f47831w0.a(canvas2, org.telegram.ui.ActionBar.h6.l1(v3Var.U.a(2), -1));
                v3Var.invalidate();
            }
        }
        if (v3Var.U.a(1) > 0.0f) {
    ...
    public final void e(int i10, TL_stars.starGiftAttributeBackdrop stargiftattributebackdrop) {
        ...
        if (i10 == 0) {
            ...
            this.f47820o0.setShader(radialGradient2);
        }
        Matrix[] matrixArr = this.f47817l0;
        if (matrixArr[i10] == null) {
            matrixArr[i10] = new Matrix();
        }
        this.f47815j0[i10].setShader(radialGradientArr[i10]);
    }
    ...
    public final void f(TL_stars.StarGift starGift, boolean z10, boolean z11, boolean z12) {
        ...
        if (z15) {
            ...
            this.f47807c0 = starGift.crafted;
            this.f47818n.f45922a.d(stargiftattributebackdropArr[0], false, true);
        } else {
    ...
    public final void g(int i10, TL_stars.starGiftAttributePattern stargiftattributepattern, boolean z10) {
        if (stargiftattributepattern != null) {
            TL_stars.starGiftAttributePattern[] stargiftattributepatternArr = this.f47821p0;
            if (stargiftattributepatternArr[i10] != stargiftattributepattern) {
                stargiftattributepatternArr[i10] = stargiftattributepattern;
                this.f47822q0[i10].i(stargiftattributepattern.document, z10);
            }
        }
    }
    ...
    public final void h(int i10, CharSequence charSequence, CharSequence charSequence2, SpannableStringBuilder spannableStringBuilder, CharSequence charSequence3, TLObject tLObject, Spannable spannable) {
        int i11;
        int i12;
        this.f47823r[i10].setText(charSequence);
        FrameLayout frameLayout = this.f47832x;
        d90[] d90VarArr = this.f47834y;
        d90 d90Var = this.f47825s;
    ...
    public final void k() {
        this.f47812g0 = AndroidUtilities.dpf2(33.33f) / AndroidUtilities.dpf2(160.0f);
        FrameLayout frameLayout = this.f47804b;
        d90[] d90VarArr = this.f47823r;
        this.f47809e0 = ((((Math.min(d90VarArr[2].getPaint().measureText(d90VarArr[2].getText().toString()), d90VarArr[2].getWidth()) + d90VarArr[2].getWidth()) / 2.0f) + (d90VarArr[2].getX() + (-frameLayout.getLeft()))) + AndroidUtilities.dp(24.0f)) - (AndroidUtilities.dp(126.67f) / 2.0f);
        this.f47811f0 = (AndroidUtilities.dp(124.0f) + (-frameLayout.getTop())) - (AndroidUtilities.dp(126.67f) / 2.0f);
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        o5VarArr[0].b();
        o5VarArr[1].b();
        AndroidUtilities.cancelRunOnUIThread(this.f47814i0);
    }
    ...
    public void setPreviewAttributes(o0 o0Var) {
        f4.d dVar = this.U;
        if (dVar != null && dVar.f8859b == 1 && isAttachedToWindow()) {
            AndroidUtilities.cancelRunOnUIThread(this.f47814i0);
            ValueAnimator valueAnimator = this.f47813h0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                this.f47813h0 = null;
            }
            int i10 = 1 - this.f47824r0;
            this.f47824r0 = i10;
            w9[] w9VarArr = this.d;
            yi0 lottieAnimation = w9VarArr[2 - i10].getImageReceiver().getLottieAnimation();
            yi0 lottieAnimation2 = w9VarArr[this.f47824r0 + 1].getImageReceiver().getLottieAnimation();
            if (lottieAnimation2 != null && lottieAnimation != null) {
                lottieAnimation2.T(lottieAnimation.t(), false);
            }
            int i11 = this.f47824r0 + 1;
            ...
            g(1, o0Var.f47484b, true);
            int i12 = this.f47824r0 + 1;
            TL_stars.starGiftAttributeModel stargiftattributemodel = o0Var.f47485c;
            TL_stars.starGiftAttributeModel[] stargiftattributemodelArr = this.e;
            stargiftattributemodelArr[i12] = stargiftattributemodel;
            w7.Z0(w9VarArr[i12].getImageReceiver(), stargiftattributemodelArr[this.f47824r0 + 1].document, 160);
            a();
            float f7 = this.f47824r0;
            ValueAnimator ofFloat = ValueAnimator.ofFloat(1.0f - f7, f7);
            this.f47813h0 = ofFloat;
            ofFloat.addUpdateListener(new r3(this, 0));
            this.f47813h0.addListener(new s3(this, 3));
            this.f47813h0.setDuration(320L);
            this.f47813h0.setInterpolator(rr.h);
            this.f47813h0.start();
        }
    }
    ...
    public void setPreviewingAttributes(ArrayList<TL_stars.StarGiftAttribute> arrayList) {
        ...
        this.f47803a0 = new com.google.android.gms.common.api.internal.r(t5.m(arrayList, TL_stars.starGiftAttributePattern.class));
        this.f47805b0 = new com.google.android.gms.common.api.internal.r(t5.m(arrayList, TL_stars.starGiftAttributeBackdrop.class));
        this.f47834y[1].setTextSize(1, 14.0f);
        this.H.setVisibility(8);
        this.f47826s0 = 0.0f;
        this.f47824r0 = 0;
        g(1, (TL_stars.starGiftAttributePattern) this.f47803a0.c(), true);
        TL_stars.starGiftAttributeModel[] stargiftattributemodelArr = this.e;
        ...
        TL_stars.starGiftAttributeBackdrop stargiftattributebackdrop = (TL_stars.starGiftAttributeBackdrop) this.f47805b0.c();
    ...
    public void setResellPrice(zf.a aVar) {
        ...
        if (!k10) {
            ...
            rr rrVar = rr.h;
            duration.setInterpolator(rrVar).setListener(new s3(this, 0)).start();
            d90VarArr[0].animate().alpha(0.0f).setDuration(420L).setInterpolator(rrVar).start();
        } else {
            ViewPropertyAnimator duration2 = textView.animate().scaleX(0.4f).scaleY(0.4f).alpha(0.0f).setDuration(420L);
            rr rrVar2 = rr.h;
            duration2.setInterpolator(rrVar2).setListener(new s3(this, 2)).setListener(new s3(this, 1)).start();
            d90VarArr[0].animate().alpha(1.0f).setDuration(420L).setInterpolator(rrVar2).start();
        }
        boolean z11 = this.M;
        u3[] u3VarArr = this.I;
        if (z11) {
    ...
    public void setWearPreview(TLObject tLObject) {
        ...
        this.f47823r[2].setText(str2);
        this.f47834y[2].setText(str);
        k();
        d(this.U);
    }
