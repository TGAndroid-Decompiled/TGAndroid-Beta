...
public final class v3 extends AnimatorListenerAdapter {
    ...
    public final void onAnimationEnd(Animator animator) {
        x3 x3Var = this.f47891a;
        y2 y2Var = x3Var.f47975i0;
        x3Var.f47987s0 = x3Var.f47985r0;
        x3Var.d(x3Var.U);
        TL_stars.starGiftAttributeModel[] stargiftattributemodelArr = x3Var.e;
        int i10 = 2 - x3Var.f47985r0;
        stargiftattributemodelArr[i10] = (TL_stars.starGiftAttributeModel) x3Var.W.f6162f;
        y7.Z0(x3Var.d[i10].getImageReceiver(), stargiftattributemodelArr[2 - x3Var.f47985r0].document, 160);
        TL_stars.starGiftAttributePattern stargiftattributepattern = (TL_stars.starGiftAttributePattern) x3Var.f47964a0.f6162f;
