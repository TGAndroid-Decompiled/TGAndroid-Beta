...
public final class g8 extends AnimatorListenerAdapter {
    public final zg.m0 f47494a;
    public final View f47495b;
    public final ai.h1[] f47496c;
    public final boolean[] d;
    public final RectF e;
    public final Runnable f47497f;
    public final o8 h;
    ...
    public g8(o8 o8Var, zg.m0 m0Var, View view, ai.h1[] h1VarArr, boolean[] zArr, RectF rectF, Runnable runnable) {
        ...
        this.f47494a = m0Var;
        this.f47495b = view;
        this.f47496c = h1VarArr;
        this.d = zArr;
        this.e = rectF;
        this.f47497f = runnable;
    }
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        zg.m0 m0Var = this.f47494a;
        if (m0Var != null) {
            m0Var.f49404l = true;
        }
        View view = this.f47495b;
        if (view != null) {
            view.invalidate();
        }
        ai.h1 h1Var = this.f47496c[0];
        if (h1Var != null) {
        ...
        if (!zArr[0]) {
            ...
            Runnable runnable = this.f47497f;
            if (runnable != null) {
                runnable.run();
            }
        }
