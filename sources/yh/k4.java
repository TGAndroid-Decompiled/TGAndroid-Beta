...
public final class k4 extends bb implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final nz f50411a0;
    public final FrameLayout f50412b0;
    public final di.d f50413c0;
    public n70 f50414d0;
    public v51 f50415e0;
    public i0.c f50416f0;
    ...
    public final void S() {
        this.d.setPadding(AndroidUtilities.dp(9.0f) + this.f50416f0.f11451a + this.backgroundPaddingLeft, 0, AndroidUtilities.dp(9.0f) + this.f50416f0.f11453c + this.backgroundPaddingLeft, this.f50416f0.d);
        i0.c cVar = this.f50416f0;
        int i10 = cVar.f11451a;
        int i11 = this.backgroundPaddingLeft;
        this.f50412b0.setPadding(i10 + i11, 0, cVar.f11453c + i11, cVar.d);
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        v51 v51Var;
        if (i10 == NotificationCenter.starUserGiftsLoaded && (v51Var = this.f50415e0) != null) {
            v51Var.N(true);
            if (T()) {
                this.Y.a();
            }
    ...
    public final r0.l1 onApplyWindowInsetsToRoot(View view, r0.l1 l1Var) {
        this.f50416f0 = AndroidUtilities.getDefaultWindowInsets(l1Var, false);
        S();
