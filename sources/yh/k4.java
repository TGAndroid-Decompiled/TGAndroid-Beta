...
public final class k4 extends bb implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final nz f50382a0;
    public final FrameLayout f50383b0;
    public final di.d f50384c0;
    public n70 f50385d0;
    public v51 f50386e0;
    public i0.c f50387f0;
    ...
    public final void S() {
        this.d.setPadding(AndroidUtilities.dp(9.0f) + this.f50387f0.f11425a + this.backgroundPaddingLeft, 0, AndroidUtilities.dp(9.0f) + this.f50387f0.f11427c + this.backgroundPaddingLeft, this.f50387f0.d);
        i0.c cVar = this.f50387f0;
        int i10 = cVar.f11425a;
        int i11 = this.backgroundPaddingLeft;
        this.f50383b0.setPadding(i10 + i11, 0, cVar.f11427c + i11, cVar.d);
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        v51 v51Var;
        if (i10 == NotificationCenter.starUserGiftsLoaded && (v51Var = this.f50386e0) != null) {
            v51Var.N(true);
            if (T()) {
                this.Y.a();
            }
    ...
    public final r0.l1 onApplyWindowInsetsToRoot(View view, r0.l1 l1Var) {
        this.f50387f0 = AndroidUtilities.getDefaultWindowInsets(l1Var, false);
        S();
