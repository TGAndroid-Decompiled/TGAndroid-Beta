...
public final class q6 implements Runnable {
    ...
    public final KeyEvent.Callback f47635c;
    public final Object d;
    public final TLObject e;
    public final Object f47636f;

    public q6(KeyEvent.Callback callback, Object obj, int i10, TLObject tLObject, Object obj2, int i11) {
        this.f47633a = i11;
        this.f47635c = callback;
        this.d = obj;
        this.f47634b = i10;
        this.e = tLObject;
        this.f47636f = obj2;
    ...
    public final void run() {
        ...
        Object obj = this.f47636f;
        TLObject tLObject = this.e;
        Object obj2 = this.d;
        KeyEvent.Callback callback = this.f47635c;
        switch (i10) {
            case 0:
            ...
            default:
                ...
                long j3 = q1Var.f46074c0;
                xh.m0 m0Var = new xh.m0(q1Var, (Utilities.Callback) obj, 2);
                boolean z12 = starGift.limited;
                if (z12 && (disallowedGiftsSettings2 = q1Var.f46073b0) != null && disallowedGiftsSettings2.disallow_limited_stargifts) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                if (z12 && (disallowedGiftsSettings = q1Var.f46073b0) != null && disallowedGiftsSettings.disallow_unique_stargifts) {
                    z11 = true;
                } else {
                    z11 = false;
                }
                new xh.s0(q1Var, context, this.f47634b, starGift, j3, m0Var, z10, z11).show();
                return;
        }
    }
}
