...
public final class h7 extends bb implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final tg.a1 f47470a0;
    public j61 f47471b0;
    public boolean f47472c0;
            ...
            public final void run() {
                ...
                switch (r2) {
                    case 0:
                        ...
                        return;
                    default:
                        nf.f.s(this.f47445b.getContext(), LocaleController.getString(R.string.StarsTOSLink));
                        return;
                }
            }
        }), true)));
    ...
    public static void P(h7 h7Var, int i10) {
        v51 G;
        j61 j61Var = h7Var.f47471b0;
        if (j61Var != null && (G = j61Var.G(i10 - 1)) != null) {
            j61 j61Var2 = h7Var.f47471b0;
            if (G.d == -1) {
                h7Var.f47472c0 = !h7Var.f47472c0;
                j61Var2.N(true);
                h7Var.d.v0(0, AndroidUtilities.dp(200.0f), rr.f28023g);
    ...
    public static void Q(h7 h7Var, v51 v51Var, long j3, Boolean bool, String str) {
        ...
        if (h7Var.getContext() != null) {
            if ((bool.booleanValue() || str != null) && (a1Var = h7Var.f47470a0) != null) {
                a1Var.run();
            }
            super.dismiss();
            org.telegram.ui.ActionBar.m2 U = LaunchActivity.U();
            ab0 ab0Var = LaunchActivity.G1.f31130x0;
            if (U != null) {
    ...
    public final void R(ArrayList arrayList, j61 j61Var) {
        ...
        if (u10 != null && !u10.isEmpty()) {
            ...
            for (int i13 = 0; i13 < u10.size(); i13++) {
                ...
                if (!this.f47472c0 && tL_starsGiftOption.extended) {
                    i11++;
                } else {
                    int i14 = i12 + 1;
                    int i15 = i7.f47513a;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        j61 j61Var;
        if ((i10 == NotificationCenter.starGiftOptionsLoaded || i10 == NotificationCenter.starBalanceUpdated) && (j61Var = this.f47471b0) != null) {
            j61Var.N(true);
        }
    }
