...
public final class o {
    public static volatile o[] f47786m = new o[4];
    public static final Object[] f47787n = new Object[4];
    public final int f47788a;
    public final HashMap f47789b = new HashMap();
    public final HashMap f47790c = new HashMap();
    public final HashMap d = new HashMap();
    public final HashMap e = new HashMap();
    public final HashMap f47791f = new HashMap();
    public final HashMap f47792g = new HashMap();
    public final HashMap h = new HashMap();
    public boolean f47793i;
    public ArrayList f47794j;
    public boolean f47795k;
    public ArrayList f47796l;

    static {
        for (int i10 = 0; i10 < 4; i10++) {
            f47787n[i10] = new Object();
        }
    }
    ...
    public final l d(long j3) {
        ...
        HashMap hashMap = this.f47792g;
        l lVar = (l) hashMap.get(valueOf);
        if (lVar == null) {
            Long valueOf2 = Long.valueOf(j3);
            l lVar2 = new l(this.f47788a, j3);
    ...
    public final void f(Context context, long j3, long j10, Utilities.Callback callback) {
        l lVar = (l) this.f47792g.get(Long.valueOf(j3));
        if (lVar != null) {
    ...
    public final TLRPC.TL_payments_starsRevenueStats h(long j3, boolean z10) {
        Long l4 = (Long) this.f47789b.get(Long.valueOf(j3));
        TLRPC.TL_payments_starsRevenueStats tL_payments_starsRevenueStats = (TLRPC.TL_payments_starsRevenueStats) this.f47790c.get(Long.valueOf(j3));
    ...
    public final void l(long j3) {
        ...
        for (int i10 = 0; i10 < 3; i10++) {
            if (!zArr[i10]) {
                k10.f47741a[i10].clear();
                k10.f47743c[i10] = null;
                zArr[i10] = false;
                k10.e[i10] = false;
                p(i10, j3);
            }
    ...
    public final void n() {
        if (!this.f47793i && this.f47794j == null) {
            this.f47793i = true;
            ConnectionsManager.getInstance(this.f47788a).sendRequest(new TL_bots.getAdminedBots(), new i(this, 0));
        }
    }

    public final void o() {
        if (!this.f47795k && this.f47796l == null) {
            this.f47795k = true;
            ConnectionsManager.getInstance(this.f47788a).sendRequest(new TLRPC.TL_channels_getAdminedPublicChannels(), new i(this, 1));
        }
    }
    ...
    public final void q(TL_update.TL_updateStarsRevenueStatus tL_updateStarsRevenueStatus) {
        ...
        if (peerDialogId < 0) {
            ke keVar = ke.f35039x1;
            if (keVar != null && keVar.f35066z0 == DialogObject.getPeerDialogId(tL_updateStarsRevenueStatus.peer)) {
                ke keVar2 = ke.f35039x1;
        ...
        if (h != null) {
            ...
            NotificationCenter.getInstance(this.f47788a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.botStarsUpdated, Long.valueOf(peerDialogId));
        }
        l(peerDialogId);
    }
