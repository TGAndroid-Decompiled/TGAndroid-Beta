...
public final class o {
    public static volatile o[] f47567m = new o[4];
    public static final Object[] f47568n = new Object[4];
    public final int f47569a;
    public final HashMap f47570b = new HashMap();
    public final HashMap f47571c = new HashMap();
    public final HashMap d = new HashMap();
    public final HashMap e = new HashMap();
    public final HashMap f47572f = new HashMap();
    public final HashMap f47573g = new HashMap();
    public final HashMap h = new HashMap();
    public boolean f47574i;
    public ArrayList f47575j;
    public boolean f47576k;
    public ArrayList f47577l;

    static {
        for (int i10 = 0; i10 < 4; i10++) {
            f47568n[i10] = new Object();
        }
    }
    ...
    public final l d(long j3) {
        ...
        HashMap hashMap = this.f47573g;
        l lVar = (l) hashMap.get(valueOf);
        if (lVar == null) {
            Long valueOf2 = Long.valueOf(j3);
            l lVar2 = new l(this.f47569a, j3);
    ...
    public final void f(Context context, long j3, long j10, Utilities.Callback callback) {
        l lVar = (l) this.f47573g.get(Long.valueOf(j3));
        if (lVar != null) {
    ...
    public final TLRPC.TL_payments_starsRevenueStats h(long j3, boolean z10) {
        Long l4 = (Long) this.f47570b.get(Long.valueOf(j3));
        TLRPC.TL_payments_starsRevenueStats tL_payments_starsRevenueStats = (TLRPC.TL_payments_starsRevenueStats) this.f47571c.get(Long.valueOf(j3));
    ...
    public final void l(long j3) {
        ...
        for (int i10 = 0; i10 < 3; i10++) {
            if (!zArr[i10]) {
                k10.f47505a[i10].clear();
                k10.f47507c[i10] = null;
                zArr[i10] = false;
                k10.e[i10] = false;
                p(i10, j3);
            }
    ...
    public final void n() {
        if (!this.f47574i && this.f47575j == null) {
            this.f47574i = true;
            ConnectionsManager.getInstance(this.f47569a).sendRequest(new TL_bots.getAdminedBots(), new i(this, 0));
        }
    }

    public final void o() {
        if (!this.f47576k && this.f47577l == null) {
            this.f47576k = true;
            ConnectionsManager.getInstance(this.f47569a).sendRequest(new TLRPC.TL_channels_getAdminedPublicChannels(), new i(this, 1));
        }
    }
    ...
    public final void q(TL_update.TL_updateStarsRevenueStatus tL_updateStarsRevenueStatus) {
        ...
        if (peerDialogId < 0) {
            le leVar = le.f35507x1;
            if (leVar != null && leVar.f35534z0 == DialogObject.getPeerDialogId(tL_updateStarsRevenueStatus.peer)) {
                le leVar2 = le.f35507x1;
        ...
        if (h != null) {
            ...
            NotificationCenter.getInstance(this.f47569a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.botStarsUpdated, Long.valueOf(peerDialogId));
        }
        l(peerDialogId);
    }
