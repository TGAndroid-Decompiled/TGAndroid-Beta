...
public final class o {
    public static volatile o[] f47498m = new o[4];
    public static final Object[] f47499n = new Object[4];
    public final int f47500a;
    public final HashMap f47501b = new HashMap();
    public final HashMap f47502c = new HashMap();
    public final HashMap d = new HashMap();
    public final HashMap e = new HashMap();
    public final HashMap f47503f = new HashMap();
    public final HashMap f47504g = new HashMap();
    public final HashMap h = new HashMap();
    public boolean f47505i;
    public ArrayList f47506j;
    public boolean f47507k;
    public ArrayList f47508l;

    static {
        for (int i10 = 0; i10 < 4; i10++) {
            f47499n[i10] = new Object();
        }
    }
    ...
    public final l d(long j3) {
        ...
        HashMap hashMap = this.f47504g;
        l lVar = (l) hashMap.get(valueOf);
        if (lVar == null) {
            Long valueOf2 = Long.valueOf(j3);
            l lVar2 = new l(this.f47500a, j3);
    ...
    public final void f(Context context, long j3, long j10, Utilities.Callback callback) {
        l lVar = (l) this.f47504g.get(Long.valueOf(j3));
        if (lVar != null) {
    ...
    public final TLRPC.TL_payments_starsRevenueStats h(long j3, boolean z10) {
        Long l4 = (Long) this.f47501b.get(Long.valueOf(j3));
        TLRPC.TL_payments_starsRevenueStats tL_payments_starsRevenueStats = (TLRPC.TL_payments_starsRevenueStats) this.f47502c.get(Long.valueOf(j3));
    ...
    public final void l(long j3) {
        ...
        for (int i10 = 0; i10 < 3; i10++) {
            if (!zArr[i10]) {
                k10.f47447a[i10].clear();
                k10.f47449c[i10] = null;
                zArr[i10] = false;
                k10.e[i10] = false;
                p(i10, j3);
            }
    ...
    public final void n() {
        if (!this.f47505i && this.f47506j == null) {
            this.f47505i = true;
            ConnectionsManager.getInstance(this.f47500a).sendRequest(new TL_bots.getAdminedBots(), new i(this, 0));
        }
    }

    public final void o() {
        if (!this.f47507k && this.f47508l == null) {
            this.f47507k = true;
            ConnectionsManager.getInstance(this.f47500a).sendRequest(new TLRPC.TL_channels_getAdminedPublicChannels(), new i(this, 1));
        }
    }
    ...
    public final void q(TL_update.TL_updateStarsRevenueStatus tL_updateStarsRevenueStatus) {
        ...
        if (peerDialogId < 0) {
            je jeVar = je.f34868x1;
            if (jeVar != null && jeVar.f34895z0 == DialogObject.getPeerDialogId(tL_updateStarsRevenueStatus.peer)) {
                je jeVar2 = je.f34868x1;
        ...
        if (h != null) {
            ...
            NotificationCenter.getInstance(this.f47500a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.botStarsUpdated, Long.valueOf(peerDialogId));
        }
        l(peerDialogId);
    }
