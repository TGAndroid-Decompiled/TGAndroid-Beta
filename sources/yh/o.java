...
public final class o {
    public static volatile o[] f47472m = new o[4];
    public static final Object[] f47473n = new Object[4];
    public final int f47474a;
    public final HashMap f47475b = new HashMap();
    public final HashMap f47476c = new HashMap();
    public final HashMap d = new HashMap();
    public final HashMap e = new HashMap();
    public final HashMap f47477f = new HashMap();
    public final HashMap f47478g = new HashMap();
    public final HashMap h = new HashMap();
    public boolean f47479i;
    public ArrayList f47480j;
    public boolean f47481k;
    public ArrayList f47482l;

    static {
        for (int i10 = 0; i10 < 4; i10++) {
            f47473n[i10] = new Object();
        }
    }
    ...
    public final l d(long j3) {
        ...
        HashMap hashMap = this.f47478g;
        l lVar = (l) hashMap.get(valueOf);
        if (lVar == null) {
            Long valueOf2 = Long.valueOf(j3);
            l lVar2 = new l(this.f47474a, j3);
    ...
    public final void f(Context context, long j3, long j10, Utilities.Callback callback) {
        l lVar = (l) this.f47478g.get(Long.valueOf(j3));
        if (lVar != null) {
    ...
    public final TLRPC.TL_payments_starsRevenueStats h(long j3, boolean z10) {
        Long l4 = (Long) this.f47475b.get(Long.valueOf(j3));
        TLRPC.TL_payments_starsRevenueStats tL_payments_starsRevenueStats = (TLRPC.TL_payments_starsRevenueStats) this.f47476c.get(Long.valueOf(j3));
    ...
    public final void l(long j3) {
        ...
        for (int i10 = 0; i10 < 3; i10++) {
            if (!zArr[i10]) {
                k10.f47433a[i10].clear();
                k10.f47435c[i10] = null;
                zArr[i10] = false;
                k10.e[i10] = false;
                p(i10, j3);
            }
    ...
    public final void n() {
        if (!this.f47479i && this.f47480j == null) {
            this.f47479i = true;
            ConnectionsManager.getInstance(this.f47474a).sendRequest(new TL_bots.getAdminedBots(), new i(this, 0));
        }
    }

    public final void o() {
        if (!this.f47481k && this.f47482l == null) {
            this.f47481k = true;
            ConnectionsManager.getInstance(this.f47474a).sendRequest(new TLRPC.TL_channels_getAdminedPublicChannels(), new i(this, 1));
        }
    }
    ...
    public final void q(TL_update.TL_updateStarsRevenueStatus tL_updateStarsRevenueStatus) {
        ...
        if (peerDialogId < 0) {
            je jeVar = je.f34414x1;
            if (jeVar != null && jeVar.f34441z0 == DialogObject.getPeerDialogId(tL_updateStarsRevenueStatus.peer)) {
                je jeVar2 = je.f34414x1;
        ...
        if (h != null) {
            ...
            NotificationCenter.getInstance(this.f47474a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.botStarsUpdated, Long.valueOf(peerDialogId));
        }
        l(peerDialogId);
    }
