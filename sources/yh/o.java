...
public final class o {
    public static volatile o[] f47771m = new o[4];
    public static final Object[] f47772n = new Object[4];
    public final int f47773a;
    public final HashMap f47774b = new HashMap();
    public final HashMap f47775c = new HashMap();
    public final HashMap d = new HashMap();
    public final HashMap e = new HashMap();
    public final HashMap f47776f = new HashMap();
    public final HashMap f47777g = new HashMap();
    public final HashMap h = new HashMap();
    public boolean f47778i;
    public ArrayList f47779j;
    public boolean f47780k;
    public ArrayList f47781l;

    static {
        for (int i10 = 0; i10 < 4; i10++) {
            f47772n[i10] = new Object();
        }
    }
    ...
    public final l d(long j3) {
        ...
        HashMap hashMap = this.f47777g;
        l lVar = (l) hashMap.get(valueOf);
        if (lVar == null) {
            Long valueOf2 = Long.valueOf(j3);
            l lVar2 = new l(this.f47773a, j3);
    ...
    public final void f(Context context, long j3, long j10, Utilities.Callback callback) {
        l lVar = (l) this.f47777g.get(Long.valueOf(j3));
        if (lVar != null) {
    ...
    public final TLRPC.TL_payments_starsRevenueStats h(long j3, boolean z10) {
        Long l4 = (Long) this.f47774b.get(Long.valueOf(j3));
        TLRPC.TL_payments_starsRevenueStats tL_payments_starsRevenueStats = (TLRPC.TL_payments_starsRevenueStats) this.f47775c.get(Long.valueOf(j3));
    ...
    public final void n() {
        if (!this.f47778i && this.f47779j == null) {
            this.f47778i = true;
            ConnectionsManager.getInstance(this.f47773a).sendRequest(new TL_bots.getAdminedBots(), new i(this, 0));
        }
    }

    public final void o() {
        if (!this.f47780k && this.f47781l == null) {
            this.f47780k = true;
            ConnectionsManager.getInstance(this.f47773a).sendRequest(new TLRPC.TL_channels_getAdminedPublicChannels(), new i(this, 1));
        }
    }
    ...
    public final void q(TL_update.TL_updateStarsRevenueStatus tL_updateStarsRevenueStatus) {
        ...
        if (peerDialogId < 0) {
            je jeVar = je.f34736x1;
            if (jeVar != null && jeVar.f34763z0 == DialogObject.getPeerDialogId(tL_updateStarsRevenueStatus.peer)) {
                je jeVar2 = je.f34736x1;
        ...
        if (h != null) {
            ...
            NotificationCenter.getInstance(this.f47773a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.botStarsUpdated, Long.valueOf(peerDialogId));
        }
        l(peerDialogId);
    }
