...
public final class w2 extends Drawable {
    public Drawable f48170g;
    public int h;
    public int f48171i;
    public final Paint f48167b = new Paint(1);
    public final Shader[] f48168c = new Shader[2];
    public final Matrix d = new Matrix();
    public final org.telegram.ui.Components.e6 e = new org.telegram.ui.Components.e6(1.0f, new r2(this, 1), 0, 420, rr.h);
    public final RectF f48169f = new RectF();
    public final int f48166a = 1;

    public final void a(int i10, int i11) {
        if (this.h == i10 && this.f48171i == i11) {
            return;
        }
        Shader[] shaderArr = this.f48168c;
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.f48170g != null) {
            ...
            j0.a(canvas, 0, this.f48170g, rectF.width(), AndroidUtilities.dp(290.0f), 2.0f, 1.0f);
            canvas.restore();
        }
    }
