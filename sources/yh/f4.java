    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (this.f47057a) {
            case 0:
                ...
                this.f47058b[0] = true;
                Utilities.Callback2 callback2 = this.f47059c;
                if (callback2 != null) {
            ...
            default:
                this.f47058b[0] = true;
                Utilities.Callback2 callback22 = this.f47059c;
                if (callback22 != null) {
                    if (bool.booleanValue()) {
                        str2 = "paid";
                    } else {
