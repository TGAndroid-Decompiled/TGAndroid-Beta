...
public final class f4 extends bb {
    public static final int f50275k0 = 0;
    public final String X;
    public final e4 Y;
    public final HorizontalScrollView Z;
    public final k3 f50276a0;
    public final k3 f50277b0;
    public final k3 f50278c0;
    public final k3 f50279d0;
    public final zh.i2 f50280e0;
    public zh.w0 f50281f0;
    public final HashSet f50282g0;
    public boolean f50283h0;
    public d4 f50284i0;
    public boolean f50285j0;

    public f4(final Context context, String str, final e4 e4Var) {
        super(2, context, (f6) null, false);
        this.f50282g0 = new HashSet();
        ...
        this.f50276a0 = k3Var;
        k3Var.setSorting(e4Var.f50265c.f50569p);
        ...
        k3Var2.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r4) {
                    case 0:
                        f4.R(this.f50672b, e4Var, context);
                        return;
                    case 1:
                        f4.W(this.f50672b, e4Var, context);
                        return;
                    default:
                        f4.S(this.f50672b, e4Var, context);
                        return;
                }
            }
        });
        k3 k3Var3 = new k3(context, this.resourcesProvider);
        this.f50278c0 = k3Var3;
        ...
        this.f50284i0.N(false);
        e4Var.d = new x3(this, 1);
    }

    public static void P(f4 f4Var, e4 e4Var) {
        n70 F = n70.F(f4Var.container, f4Var.resourcesProvider, f4Var.f50276a0);
        F.c(R.drawable.menu_sort_value, LocaleController.getString(s3.BY_PRICE.f50546a), new w3(e4Var, 3), false);
        F.c(R.drawable.menu_sort_date, LocaleController.getString(s3.BY_DATE.f50546a), new w3(e4Var, 4), false);
        F.c(R.drawable.menu_sort_number, LocaleController.getString(s3.BY_NUMBER.f50546a), new w3(e4Var, 5), false);
        F.f28661t = false;
        F.Y = true;
    ...
    public static void Q(f4 f4Var, e4 e4Var, int i10) {
        ...
        zf.b bVar;
        h51 G = f4Var.f50284i0.G(i10 - 1);
        if (G != null) {
            Object obj = G.G;
            if (obj instanceof TL_stars.StarGift) {
                TL_stars.StarGift starGift = (TL_stars.StarGift) obj;
                boolean z10 = G.f26600r;
                if (!TextUtils.isEmpty(starGift.gift_address) && f4Var.f50283h0) {
                    ...
                    if (!z10) {
                        ArrayList arrayList = e4Var.f50264b.f52101l;
    ...
    public static void R(f4 f4Var, e4 e4Var, Context context) {
        t3 t3Var = e4Var.f50265c;
        if (t3Var.f50560f.isEmpty()) {
            return;
        }
        n70 n70Var = new n70(f4Var.container, f4Var.resourcesProvider, f4Var.f50277b0, false, true, false);
        n70Var.f28661t = false;
        n70Var.Y = true;
        n70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        n70Var.R = true;
        n70Var.f28655p = new ji.h(n70Var, 8);
        String[] strArr = {""};
    ...
    public static void S(f4 f4Var, e4 e4Var, Context context) {
        ...
        n70 n70Var = new n70(f4Var.container, f4Var.resourcesProvider, f4Var.f50279d0, false, true, false);
        n70Var.f28661t = false;
        n70Var.Y = true;
        n70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        n70Var.R = true;
        n70Var.f28655p = new ji.h(n70Var, 7);
        String[] strArr = {""};
        ...
        if (e4Var != null) {
            ...
            if (j5Var != null && t3Var != null) {
                ...
                while (i12 < size) {
                    ...
                    if (!f4Var.f50282g0.contains(Long.valueOf(savedStarGift.gift.f20097id))) {
                ...
                if (!j5Var.f52098i && j5Var.f52099j) {
                    if (z11) {
    ...
    public static void V(f4 f4Var, TL_stars.TL_starGiftUnique tL_starGiftUnique, long j3, zh.a3 a3Var, of.e eVar) {
        eVar.d();
        s5.x(f4Var.currentAccount, a3Var.f51675a).h(a3Var.f51676b, tL_starGiftUnique, j3, null, true, new org.telegram.tgnet.e(f4Var, eVar, tL_starGiftUnique, 6));
    }

    public static void W(f4 f4Var, e4 e4Var, Context context) {
        t3 t3Var = e4Var.f50265c;
        if (t3Var.f50561g.isEmpty()) {
            return;
        }
        n70 n70Var = new n70(f4Var.container, f4Var.resourcesProvider, f4Var.f50278c0, false, true, false);
        n70Var.f28661t = false;
        n70Var.Y = true;
        n70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        n70Var.R = true;
        n70Var.f28655p = new ji.h(n70Var, 6);
        String[] strArr = {""};
    ...
    public final void Z() {
        ...
        while (true) {
            ...
            if ((childAt instanceof t00) && (R = RecyclerView.R(childAt) - 1) >= 0 && (G = this.f50284i0.G(R)) != null) {
                if (G.d < 10) {
                    z10 = true;
                } else {
                    z11 = true;
