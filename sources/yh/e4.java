...
public final class e4 extends View {
    ...
    public final int[] K;
    public final bo f47108a;
    public org.telegram.ui.Cells.a0 f47109b;
    public int f47110c;
    public final int[] d;
    public final int[] e;
    public final RectF f47111f;
    public final RectF h;
    public final Paint f47112n;
    public boolean f47113r;
    public final org.telegram.ui.Components.c6 f47114s;
    public final org.telegram.ui.Components.m6 v;
    public boolean f47115w;
    public final uh.i f47116x;
    public float f47117y;

    public e4(bo boVar) {
        super(boVar.getParentActivity());
        this.d = new int[2];
        this.e = new int[2];
        this.f47111f = new RectF();
        this.h = new RectF();
        this.f47112n = new Paint();
        new Paint();
        this.f47114s = new org.telegram.ui.Components.c6(this, 0L, 420L, qr.h);
        ...
        this.f47116x = new uh.i(20, this, boVar);
    }

    private MessageObject getMessageObject() {
        org.telegram.ui.Cells.a0 a0Var = this.f47109b;
    ...
    public final void a() {
        ...
        if (getMessageObject() != null) {
            ...
            if (y3.e && y3.q(false, false, null).amount < E) {
                ...
                new n7(boVar.getParentActivity(), boVar.getResourceProvider(), E, 5, str, new j21(this, y3, messageObject, E, 9), 0L).show();
            }
        }
    }
    ...
    public final void b(float f7, d4 d4Var) {
        ...
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f47117y, f7);
        this.E = ofFloat;
        ...
        if (this.f47109b != null && !this.I) {
            ...
            if (messageObject != null && reactionsLayoutInBubble != null) {
                ...
                if (z10) {
                    ...
                    v5.y(boVar.getCurrentAccount(), false).d0(messageObject, this.f47108a, 1L, true, false, null);
                }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.f47109b == null || this.I || (reactionsLayoutInBubble = getReactionsLayoutInBubble()) == null) {
            return false;
        }
        int action = motionEvent.getAction();
        uh.i iVar = this.f47116x;
        if (action == 0) {
    ...
    public void setMessageCell(org.telegram.ui.Cells.a0 a0Var) {
        ...
        this.f47110c = id2;
        org.telegram.ui.Cells.a0 a0Var3 = this.f47109b;
        if (a0Var3 instanceof org.telegram.ui.Cells.t1) {
            a0Var3.invalidate();
            ((org.telegram.ui.Cells.t1) this.f47109b).setInvalidateListener(new d4(this, 1));
        } else if (a0Var3 instanceof org.telegram.ui.Cells.w0) {
            a0Var3.invalidate();
            ((org.telegram.ui.Cells.w0) this.f47109b).setInvalidateListener(new d4(this, 1));
        }
        invalidate();
    }
}
