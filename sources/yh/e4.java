...
public final class e4 extends View {
    ...
    public final int[] K;
    public final bo f47136a;
    public org.telegram.ui.Cells.a0 f47137b;
    public int f47138c;
    public final int[] d;
    public final int[] e;
    public final RectF f47139f;
    public final RectF h;
    public final Paint f47140n;
    public boolean f47141r;
    public final org.telegram.ui.Components.c6 f47142s;
    public final org.telegram.ui.Components.m6 v;
    public boolean f47143w;
    public final uh.i f47144x;
    public float f47145y;

    public e4(bo boVar) {
        super(boVar.getParentActivity());
        this.d = new int[2];
        this.e = new int[2];
        this.f47139f = new RectF();
        this.h = new RectF();
        this.f47140n = new Paint();
        new Paint();
        this.f47142s = new org.telegram.ui.Components.c6(this, 0L, 420L, qr.h);
        ...
        this.f47144x = new uh.i(20, this, boVar);
    }

    private MessageObject getMessageObject() {
        org.telegram.ui.Cells.a0 a0Var = this.f47137b;
    ...
    public final void b(float f7, d4 d4Var) {
        ...
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f47145y, f7);
        this.E = ofFloat;
        ...
        if (this.f47137b != null && !this.I) {
            ...
            if (messageObject != null && reactionsLayoutInBubble != null) {
                ...
                if (z10) {
                    ...
                    v5.y(boVar.getCurrentAccount(), false).d0(messageObject, this.f47136a, 1L, true, false, null);
                }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.f47137b == null || this.I || (reactionsLayoutInBubble = getReactionsLayoutInBubble()) == null) {
            return false;
        }
        int action = motionEvent.getAction();
        uh.i iVar = this.f47144x;
        if (action == 0) {
    ...
    public void setMessageCell(org.telegram.ui.Cells.a0 a0Var) {
        ...
        this.f47138c = id2;
        org.telegram.ui.Cells.a0 a0Var3 = this.f47137b;
        if (a0Var3 instanceof org.telegram.ui.Cells.t1) {
            a0Var3.invalidate();
            ((org.telegram.ui.Cells.t1) this.f47137b).setInvalidateListener(new d4(this, 1));
        } else if (a0Var3 instanceof org.telegram.ui.Cells.w0) {
            a0Var3.invalidate();
            ((org.telegram.ui.Cells.w0) this.f47137b).setInvalidateListener(new d4(this, 1));
        }
        invalidate();
    }
}
