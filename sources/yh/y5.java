...
public final class y5 implements Runnable {
    ...
    public final org.telegram.ui.ActionBar.g3[] f48050b;
    public final TL_stars.StarsTransaction f48051c;
    public final long d;

    public y5(org.telegram.ui.ActionBar.g3[] g3VarArr, long j3, TL_stars.StarsTransaction starsTransaction) {
        this.f48049a = 2;
        this.f48050b = g3VarArr;
        this.d = j3;
        this.f48051c = starsTransaction;
    }
    ...
    public final void run() {
        switch (this.f48049a) {
            case 0:
                this.f48050b[0].dismiss();
                org.telegram.ui.ActionBar.o2 U = LaunchActivity.U();
                if (U != null) {
                    TL_stars.StarsTransaction starsTransaction = this.f48051c;
            ...
            case 1:
                ...
                if (U2 != null) {
                    TL_stars.StarsTransaction starsTransaction2 = this.f48051c;
            ...
            case 2:
                ...
                if (U3 != null) {
                    ...
                    bundle.putInt("message_id", this.f48051c.msg_id);
            ...
            case 3:
                ...
                if (U4 != null) {
                    TL_stars.StarsTransaction starsTransaction3 = this.f48051c;
            ...
            default:
                ...
                if (U5 != null) {
                    TL_stars.StarsTransaction starsTransaction4 = this.f48051c;
    ...
    public y5(org.telegram.ui.ActionBar.g3[] g3VarArr, TL_stars.StarsTransaction starsTransaction, long j3, int i10) {
        this.f48049a = i10;
        this.f48050b = g3VarArr;
        this.f48051c = starsTransaction;
        this.d = j3;
