...
public final class c3 extends View {
    public final o3 f47061a;
    public final ImageReceiver f47062b;
    public final Path f47063c;
    ...
    public final void onAttachedToWindow() {
        ...
        this.f47062b.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f47062b.onDetachedFromWindow();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawPath(this.f47063c, this.d);
        canvas.restore();
        ImageReceiver imageReceiver = this.f47062b;
