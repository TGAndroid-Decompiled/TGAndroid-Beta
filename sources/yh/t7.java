...
public final class t7 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public final r61 f48052a;
    public final org.telegram.ui.ActionBar.d6 f48053b;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i12) {
            ...
            this.h.run();
        } else if (i10 == NotificationCenter.botStarsTransactionsLoaded && ((Long) objArr[0]).longValue() == this.f48055f) {
            r61Var.Y2.N(true);
        }
    }
