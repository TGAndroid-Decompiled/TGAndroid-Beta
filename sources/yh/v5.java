...
public final class v5 implements Runnable {
    ...
    public final org.telegram.ui.ActionBar.e3[] f48152b;
    public final TL_stars.StarsTransaction f48153c;
    public final long d;

    public v5(org.telegram.ui.ActionBar.e3[] e3VarArr, long j3, TL_stars.StarsTransaction starsTransaction) {
        this.f48151a = 2;
        this.f48152b = e3VarArr;
        this.d = j3;
        this.f48153c = starsTransaction;
    }
    ...
    public final void run() {
        switch (this.f48151a) {
            case 0:
                this.f48152b[0].dismiss();
                org.telegram.ui.ActionBar.m2 U = LaunchActivity.U();
                if (U != null) {
                    TL_stars.StarsTransaction starsTransaction = this.f48153c;
            ...
            case 1:
                ...
                if (U2 != null) {
                    TL_stars.StarsTransaction starsTransaction2 = this.f48153c;
            ...
            case 2:
                ...
                if (U3 != null) {
                    ...
                    bundle.putInt("message_id", this.f48153c.msg_id);
            ...
            case 3:
                ...
                if (U4 != null) {
                    TL_stars.StarsTransaction starsTransaction3 = this.f48153c;
            ...
            default:
                ...
                if (U5 != null) {
                    TL_stars.StarsTransaction starsTransaction4 = this.f48153c;
