...
public abstract class m8 extends View {
    ...
    public final Path V;
    public final Path W;
    public final org.telegram.ui.ActionBar.e6 f47425a;
    public final RectF f47426a0;
    public final Paint f47427b;
    public final Path f47428b0;
    public final Paint f47429c;
    public float f47430c0;
    public final Paint d;
    public float f47431d0;
    public final Paint e;
    public int[] f47432e0;
    public final Paint f47433f;
    public final le.b f47434f0;
    public float f47435g0;
    public final j8 h;
    public float f47436h0;
    public long f47437i0;
    public int f47438j0;
    public boolean f47439k0;
    public ValueAnimator f47440l0;
    public final j8 f47441n;
    public int f47442r;
    public int f47443s;
    public ValueAnimator v;
    public int f47444w;
    public int f47445x;
    public LinearGradient f47446y;

    public m8(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
        this.f47427b = new Paint(1);
        this.f47429c = new Paint(1);
        this.d = new Paint(1);
        this.e = new Paint(1);
        this.f47433f = new Paint(1);
        this.h = new j8(0, 300);
        this.f47441n = new j8(2, 30);
        this.f47442r = -1135603;
        this.f47443s = -404714;
        this.f47444w = -1135603;
        this.f47445x = -404714;
        this.f47446y = new LinearGradient(0.0f, 0.0f, 255.0f, 0.0f, new int[]{this.f47442r, this.f47443s}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP);
        this.E = new Matrix();
        this.F = true;
        ...
        this.V = new Path();
        this.W = new Path();
        this.f47426a0 = new RectF();
        this.f47428b0 = new Path();
        this.f47430c0 = 0.0f;
        this.f47434f0 = new le.b(this, qrVar, 320L);
        this.f47425a = e6Var;
        ...
        m6Var2.f26085b = 17;
        paint.setColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18904h5, e6Var));
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth(AndroidUtilities.dp(1.0f));
    }

    public final void a(float f7) {
        ValueAnimator valueAnimator = this.f47440l0;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f47430c0, f7);
        this.f47440l0 = ofFloat;
        ofFloat.addUpdateListener(new org.telegram.ui.Components.voip.r0(this, 26));
        int value = getValue();
        this.f47440l0.addListener(new h00(this, f7, value));
        this.f47440l0.setDuration(320L);
        this.f47440l0.setInterpolator(qr.h);
        this.f47440l0.start();
        if (c(f7) != value) {
            e(c(f7));
        }
    ...
    public final int c(float f7) {
        ...
        int[] iArr;
        if (f7 <= 0.0f) {
            return this.f47432e0[0];
        }
        if (f7 >= 1.0f) {
            return this.f47432e0[iArr.length - 1];
        }
        int[] iArr2 = this.f47432e0;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        this.f47446y.setLocalMatrix(matrix);
        LinearGradient linearGradient = this.f47446y;
        Paint paint3 = this.f47429c;
        paint3.setShader(linearGradient);
        int d = i0.a.d(this.f47430c0, this.f47442r, this.f47443s);
        Path path = this.U;
        path.rewind();
        Path.Direction direction2 = Path.Direction.CW;
        path.addRoundRect(rectF2, AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), direction2);
        int l1 = org.telegram.ui.ActionBar.i6.l1(0.15f, this.f47442r);
        Paint paint4 = this.f47427b;
        paint4.setColor(l1);
        ...
        j8 j8Var = this.h;
        j8Var.g(rectF2);
        float f13 = this.f47430c0;
        j8Var.h = (f13 * 15.0f) + 1.0f;
        j8Var.f47290j = (int) (j8Var.f47285b.size() * ((f13 * 0.85f) + 0.15f));
        j8Var.d();
        canvas.save();
        ...
        if (j3 != -1 && b((int) j3) < 1.0f && b((int) this.P) > 0.0f) {
            ...
            float lerp = AndroidUtilities.lerp(dp, dp2, c6Var3.e(z13));
            if (clamp01 + g01Var.f24146c + (AndroidUtilities.dp(16.0f) * 2) > rectF2.right) {
                f12 = (clamp01 - lerp) - g01Var.f24146c;
            } else {
                f12 = clamp01 + lerp;
            }
            float f14 = f12;
        ...
        if (j10 != -1 && b((int) j10) < 1.0f && b((int) this.P) > 0.0f) {
            ...
            float lerp2 = AndroidUtilities.lerp(dp4, dp5, c6Var.e(z11));
            if (g01Var.f24146c + dp3 + (AndroidUtilities.dp(16.0f) * 2) > rectF2.right) {
                f11 = (dp3 - lerp2) - g01Var.f24146c;
            } else {
                f11 = lerp2 + dp3;
            }
            float f15 = f11;
            paint2.setStrokeWidth(AndroidUtilities.dp(1.0f));
            paint2.setColor(org.telegram.ui.ActionBar.i6.l1(0.4f, org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18904h5, this.f47425a)));
            i11 = i10;
        ...
        if (this.O) {
            ...
            int d10 = i0.a.d(0.5f, paint.getColor(), this.f47443s);
            Paint paint6 = this.d;
            paint6.setColor(d10);
            Path path3 = this.W;
            path3.rewind();
        ...
        float clamp5 = Utilities.clamp(this.f47430c0 - this.f47431d0, 1.0f, -1.0f) * 60.0f;
        float dp12 = rectF5.bottom + AndroidUtilities.dp(8.0f);
        Path path4 = this.f47428b0;
        path4.rewind();
        ...
        j8 j8Var2 = this.f47441n;
        j8Var2.g(rectF7);
        j8Var2.h = (this.f47430c0 * 15.0f) + 1.0f;
        j8Var2.d();
        canvas2.save();
        ...
        if (Math.abs(this.f47430c0 - this.f47431d0) > 0.001f) {
            this.f47431d0 = AndroidUtilities.lerp(this.f47431d0, this.f47430c0, 0.1f);
            invalidate();
        }
        this.f47433f.setShader(this.f47446y);
        canvas2.drawPath(path4, this.f47433f);
        canvas2.save();
        ...
        canvas2.restore();
        canvas2.save();
        float f27 = 1.0f - (this.f47434f0.e * 0.15f);
        ...
        m6Var.f26102w = (int) (this.f47434f0.e * 255.0f);
        m6Var.draw(canvas2);
        canvas2.restore();
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            this.f47435g0 = motionEvent.getX();
            this.f47436h0 = motionEvent.getY();
            this.f47438j0 = motionEvent.getPointerId(0);
            this.f47437i0 = System.currentTimeMillis();
            this.f47439k0 = false;
            return true;
        }
        if (motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.f47438j0) {
            float x10 = motionEvent.getX() - this.f47435g0;
            float y3 = motionEvent.getY() - this.f47436h0;
            if (!this.f47439k0 && Math.abs(x10) > Math.abs(y3 * 1.5f) && Math.abs(x10) > AndroidUtilities.touchSlop) {
            ...
            if (this.f47439k0) {
                int value = getValue();
                this.f47430c0 = Utilities.clamp01((x10 / (getWidth() * 1.0f)) + this.f47430c0);
                if (getValue() != value) {
                    e(getValue());
                    org.telegram.ui.Components.m6 m6Var = this.H;
                    m6Var.b();
            ...
            if (!this.f47439k0 && motionEvent.getPointerId(0) == this.f47438j0 && v7.z6.a(this.f47435g0, this.f47436h0, motionEvent.getX(), motionEvent.getY()) < AndroidUtilities.touchSlop && ((float) (System.currentTimeMillis() - this.f47437i0)) <= ViewConfiguration.getTapTimeout() * 1.5f) {
    ...
    public final void f(int i10, int i11, boolean z10) {
        if (this.f47444w == i10 && this.f47445x == i11) {
            return;
        }
        ...
        if (z10) {
            int i12 = this.f47442r;
            int i13 = this.f47443s;
            this.f47444w = i10;
            this.f47445x = i11;
    ...
    public final void g(String str) {
        this.f47434f0.a(!TextUtils.isEmpty(str), true);
        org.telegram.ui.Components.m6 m6Var = this.I;
        m6Var.b();
    ...
    public float getProgress() {
        return this.f47430c0;
    }

    public int getValue() {
        return c(this.f47430c0);
    }
