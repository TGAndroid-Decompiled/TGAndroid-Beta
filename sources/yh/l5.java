...
public final class l5 {
    ...
    public boolean f47368k;
    public final ArrayList e = new ArrayList();
    public final ArrayList f47364f = new ArrayList();
    public final HashMap h = new HashMap();
    public int f47366i = -1;
    ...
    public final void a(int i10, ArrayList arrayList) {
        ...
        m5 e = e(i10);
        int i11 = 0;
        long j3 = this.f47362b;
        int i12 = this.f47361a;
        if (e != null) {
            e.f47406l.addAll(0, arrayList);
            e.f47408n = arrayList.size() + e.f47408n;
    ...
    public final void g() {
        if (this.f47366i != -1) {
            ConnectionsManager.getInstance(this.f47361a).cancelRequest(this.f47366i, true);
            this.f47366i = -1;
        }
        this.f47363c = false;
        this.d = false;
    ...
    public final void i() {
        if (!this.f47363c && !this.d) {
            this.f47363c = true;
            TL_stars.getStarGiftCollections getstargiftcollections = new TL_stars.getStarGiftCollections();
            int i10 = this.f47361a;
            getstargiftcollections.peer = MessagesController.getInstance(i10).getInputPeer(this.f47362b);
            ArrayList arrayList = this.e;
            int size = arrayList.size();
            long j3 = 0;
            int i11 = 0;
            ...
            this.f47366i = ConnectionsManager.getInstance(i10).sendRequest(getstargiftcollections, new j5(this, 0));
        }
    }
    ...
    public final void k(int i10, TL_stars.SavedStarGift savedStarGift) {
        ...
        boolean z10 = false;
        if (e != null) {
            ArrayList arrayList2 = e.f47406l;
                ...
                while (i11 < arrayList2.size()) {
                    ...
                    while (true) {
                        if (i12 >= arrayList.size()) {
                            ...
                            e.f47408n = Math.max(0, e.f47408n - 1);
                            i11--;
                            break;
                        } else {
                            i12++;
    ...
    public final void l(TL_stars.SavedStarGift savedStarGift, int i10, boolean z10) {
        for (m5 m5Var : this.h.values()) {
            m5Var.n(savedStarGift, i10, z10);
        }
        m5 m5Var2 = this.f47365g;
        if (m5Var2 != null) {
            m5Var2.n(savedStarGift, i10, z10);
        }
    }
    ...
    public final void n(int i10) {
        ...
        if (e != null) {
            ...
            if (c10 != null) {
                ...
                NotificationCenter.getInstance(this.f47361a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starUserGiftCollectionsLoaded, Long.valueOf(this.f47362b), this);
            }
        }
    }
}
