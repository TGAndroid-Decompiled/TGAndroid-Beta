...
public final class w7 extends m20 implements NotificationCenter.NotificationCenterDelegate {
    public static DecimalFormat f48188h0;
    public static DecimalFormat f48189i0;
    ...
    public ci.d Y;
    public xh.h1 Z;
    public ci.d f48190a0;
    public ub1 f48191b0;
    public ci.d f48192c0;
    public ci.d f48193d0;
    public boolean f48194e0;
    public boolean f48195f0;
    public z6 f48196g0;
    ...
    public static void F0(a01 a01Var, int i10, TL_stars.StarGift starGift, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        t90 t90Var = new t90(textView, AndroidUtilities.dp(90.0f), 0, d6Var);
        t90Var.a(org.telegram.ui.ActionBar.h6.l1(0.21f, textView.getPaint().getColor()), org.telegram.ui.ActionBar.h6.l1(0.08f, textView.getPaint().getColor()));
        spannableStringBuilder.setSpan(t90Var, 0, 1, 33);
        textView.setText(spannableStringBuilder, TextView.BufferType.SPANNABLE);
        if (!starGift.sold_out) {
            final s5 y3 = s5.y(i10, false);
            final long j3 = starGift.f18560id;
            ...
            final NotificationCenter.NotificationCenterDelegate[] notificationCenterDelegateArr = {new NotificationCenter.NotificationCenterDelegate() {
                ...
                public final void didReceivedNotification(int i11, int i12, Object[] objArr) {
                    ...
                    if (!zArr2[0] && i11 == (i13 = NotificationCenter.starGiftsLoaded) && (J = (s5Var = s5.this).J(j3)) != null) {
                        zArr2[0] = true;
                        NotificationCenter.getInstance(s5Var.f48010a).removeObserver(notificationCenterDelegateArr[0], i13);
                        q1Var.run(J);
                    }
                }
            }};
    ...
    public static SpannableStringBuilder J0(TL_stars.StarsAmount starsAmount, float f7, char c10) {
        ...
        int i10;
        if (f48189i0 == null) {
            f48189i0 = new DecimalFormat("0.################", new DecimalFormatSymbols(Locale.US));
        }
        ...
        if (starsAmount instanceof TL_stars.TL_starsTonAmount) {
            ...
            if (j3 % 1000000000 != 0) {
                String format = f48189i0.format(j3 / 1.0E9d);
            ...
            if (i11 != 0) {
                ...
                DecimalFormat decimalFormat = f48189i0;
    ...
    public static SpannableStringBuilder K0(TL_stars.StarsAmount starsAmount, float f7, char c10) {
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        if (starsAmount instanceof TL_stars.TL_starsTonAmount) {
            String format = f48189i0.format(starsAmount.amount / 1.0E9d);
            spannableStringBuilder.append((CharSequence) format);
            int indexOf = format.indexOf(".");
            if (indexOf >= 0) {
                spannableStringBuilder.setSpan(new RelativeSizeSpan(f7), indexOf, spannableStringBuilder.length(), 33);
    ...
    public static String M0(long j3) {
        String str;
        if (f48188h0 == null) {
            f48188h0 = new DecimalFormat("0.####", new DecimalFormatSymbols(Locale.US));
        }
        if (j3 % 1000000000 != 0) {
            return f48188h0.format(j3 / 1.0E9d);
        }
        StringBuilder sb2 = new StringBuilder();
        if (j3 < 0) {
            str = "-";
    ...
    public static void Z0(ImageReceiver imageReceiver, TLRPC.Document document, int i10) {
        ...
        imageReceiver.setImage(ImageLocation.getForDocument(document), a4.a.l(i10, i10, "_"), ImageLocation.getForDocument(closestPhotoSizeWithSize, document), a4.a.l(i10, i10, "_"), DocumentObject.getSvgThumb(document.thumbs, org.telegram.ui.ActionBar.h6.f19003a7, 0.35f), 0L, null, null, 0);
    }
    ...
    public static h11 c1(w9 w9Var, ImageReceiver imageReceiver, int i10) {
        String str;
        if (i10 != 3) {
            if (i10 != 6) {
                if (i10 != 12) {
    ...
    public static void e1(Context context, int i10, long j3, TL_stories.Boost boost, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        a01Var.k(LocaleController.getString(R.string.BoostFrom), i10, j3, new u5(e3VarArr, j3, 2));
        ...
        o90Var.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.StarsTransactionTOS), new di.a(context, 9)));
        o90Var.setGravity(17);
        f7.addView(o90Var, w7.y5.k(14.0f, 15.0f, 14.0f, 7.0f, -1, -2));
    ...
    public static i0 f1(Context context, int i10, TL_stars.TL_starGiftUnique tL_starGiftUnique, Utilities.Callback2 callback2, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        if (tL_starGiftUnique == null) {
            ...
            resellAmount = tL_starGiftUnique.getResellAmount(zf.b.f49227b);
        } else {
    ...
    public static void g1(Context context, long j3, boolean z10, final Utilities.Callback2 callback2, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        kd0 kd0Var = new kd0(context, d6Var);
        ...
        editTextBoldCursor.setOnFocusChangeListener(new ei.w1(kd0Var, editTextBoldCursor, 2));
        ...
        o90Var.setText(AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.PaidContentInfo), new di.a(context, 10)), true));
        o90Var.setTextSize(1, 12.0f);
        o90Var.setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19461z6, d6Var));
        o90Var.setLinkTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.gc, d6Var));
        linearLayout.addView(o90Var, w7.y5.k(14.0f, 3.0f, 14.0f, 24.0f, -1, -2));
    ...
    public static void i1(Activity activity, int i10, int i11, TLRPC.TL_messageActionPaymentRefunded tL_messageActionPaymentRefunded, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        starsTransaction.f18562id = tL_messageActionPaymentRefunded.charge.f18463id;
    ...
    public static void j1(Context context, int i10, TLRPC.TL_payments_paymentReceiptStars tL_payments_paymentReceiptStars, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        starsTransaction.f18562id = tL_payments_paymentReceiptStars.transaction_id;
    ...
    public final View createView(final Context context) {
        ...
        this.f35448c.setOnItemClickListener(new ai.g(this, 21));
        t00 t00Var = new t00(getParentActivity());
        this.T = t00Var;
        this.f35452s.addView(t00Var, w7.y5.c(-1.0f, -1));
        s5 y3 = s5.y(this.currentAccount, false);
        ...
        jj0 jj0Var = new jj0(R.raw.star_reaction, AndroidUtilities.dp(42.0f), AndroidUtilities.dp(42.0f));
        ImageReceiver imageReceiver = s70Var.f37614b;
        imageReceiver.setImageBitmap(jj0Var);
        ...
        this.X.setTextColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19461z6, this.resourceProvider));
        ...
        this.f48190a0 = dVar;
        dVar.e();
        this.f48190a0.g("", false, true);
        this.f48190a0.setOnClickListener(new View.OnClickListener(this) {
            public final w7 f47274b;
            ...
            public final void onClick(View view) {
                switch (r3) {
                    case 0:
                        w7.B0(this.f47274b, context);
                        return;
                    default:
                        new m7(context, this.f47274b.resourceProvider).show();
                        return;
                }
            }
        });
        this.Z.addView(this.f48190a0, w7.y5.e(-1, 48, 119));
        ub1 ub1Var = new ub1(this, getParentActivity(), 20);
        this.f48191b0 = ub1Var;
        ...
        this.f48192c0.g(spannableStringBuilder, false, true);
        this.f48192c0.setOnClickListener(new View.OnClickListener(this) {
            public final w7 f47274b;
        ...
        this.f48191b0.addView(this.f48192c0, w7.y5.p(-1, 48, 17.0f, 1, 0, 0, 8, 0));
        ...
        this.f48191b0.addView(this.Y, w7.y5.p(-1, 48, 17.0f, 1, 0, 0, 0, 0));
        ...
        this.f48193d0.g(spannableStringBuilder3, false, true);
        this.f48193d0.setOnClickListener(new View.OnClickListener(this) {
            public final w7 f47304b;
        ...
        this.U.addView(this.f48193d0, w7.y5.d(-1, 48.0f, 17, 20.0f, 8.0f, 20.0f, 0.0f));
        k1();
        z6 z6Var = this.f48196g0;
        if (z6Var != null) {
            z6Var.N(false);
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.starOptionsLoaded) {
            ...
            s5 y3 = s5.y(this.currentAccount, false);
            if (this.f48194e0 != y3.O(0)) {
                this.f48194e0 = y3.O(0);
                s0();
                z6 z6Var2 = this.f48196g0;
                if (z6Var2 != null) {
                    z6Var2.N(true);
                }
                if (this.N == 0 && this.O < 0) {
    ...
    public final void l1(final boolean z10, boolean z11) {
        ...
        if (z11) {
            ...
            animate.alpha(f10).withEndAction(new Runnable(this) {
                ...
                public final void run() {
                    switch (r3) {
                        case 0:
                            if (z10) {
                                this.f47343b.Z.setVisibility(8);
                                return;
                            }
                            return;
                        default:
                            if (!z10) {
                                this.f47343b.f48191b0.setVisibility(8);
                                return;
                            }
                            return;
                    }
            ...
            ViewPropertyAnimator animate2 = this.f48191b0.animate();
            if (!z10) {
                f11 = 0.0f;
            }
        ...
        this.f48191b0.animate().cancel();
        ub1 ub1Var = this.f48191b0;
        if (z10) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
    ...
    public final s4.h0 n0() {
        z6 z6Var = new z6(this, this.f35448c, getParentActivity(), this.currentAccount, this.classGuid, new hi.a(this, 26), getResourceProvider());
        this.f48196g0 = z6Var;
        z6Var.f25644r = false;
        return z6Var;
    }
    ...
    public final boolean q0() {
        ...
        if (v7Var != null && (v7Var.getParent() instanceof View)) {
            if ((this.f35448c.getHeight() - this.f35448c.getPaddingBottom()) - ((View) this.R.getParent()).getBottom() >= 0) {
                z10 = true;
            }
        }
        return !z10;
