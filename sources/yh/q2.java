...
public abstract class q2 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public z7 R;
    public ViewGroup S;
    public final org.telegram.ui.ActionBar.n2 f50545a;
    public final int f50546b;
    public final long f50547c;
    public final j5 d;
    public final i5 f50548e;
    public final f6 f50549f;
    public final v1 h;
    public final h81 f50550n;
    public final FrameLayout f50551r;
    public final SpannableStringBuilder f50552s;
    public final SpannableStringBuilder v;
    public final di.d f50553w;
    public int f50554x;
    public final LinearLayout f50555y;
    ...
    public final void a() {
        ...
        if (currentPage != null && (j5Var = currentPage.f50472e) != null && currentPage.d) {
            int i10 = j5Var.d;
            new k4(this.f50545a, this.f50547c, i10, new fi.s4(this, i10, currentPage, 5)).show();
        }
    }

    public final boolean b() {
        i5 i5Var = this.f50548e;
        if (!i5Var.h() || i5Var.d().size() >= MessagesController.getInstance(this.f50546b).config.stargiftsCollectionsLimit.get()) {
            return false;
        }
        return true;
    }
    ...
    public final boolean d() {
        if (this.f50547c >= 0 || this.d.h == null) {
            return false;
        }
        return true;
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        LinearLayout linearLayout = this.f50555y;
        di.d dVar = this.f50553w;
        long j3 = this.f50547c;
        int i15 = 8;
        if (i10 == i14) {
    ...
    public final void e() {
        ...
        if (this.M > 0) {
            ...
            if (i10 >= 0 && tL_starGiftCollection != null) {
                this.M = 0;
                this.f50550n.d(tL_starGiftCollection.collection_id, i10 + 1);
            }
        }
    }
    ...
    public final void f(boolean z10) {
        v1 v1Var = this.h;
        if (v1Var != null && this.f50550n != null) {
            v1Var.o(z10);
            e();
        }
    }
    ...
    public final boolean g() {
        ...
        m2 currentPage = getCurrentPage();
        if (currentPage != null && currentPage.f50474n) {
            return true;
        }
        return false;
    }
    ...
    public int getBottomOffset() {
        FrameLayout frameLayout = this.f50551r;
        float translationY = frameLayout.getTranslationY() - org.telegram.messenger.w1.B(this.f50554x, Math.max(AndroidUtilities.dp(240.0f), this.Q) + (-frameLayout.getTop()), 1);
        if (this.Q < AndroidUtilities.dp(240.0f)) {
            translationY += Math.min(AndroidUtilities.dp(240.0f) - this.Q, AndroidUtilities.dp(this.f50554x));
        }
        return (int) (AndroidUtilities.dp(this.f50554x) - translationY);
    }

    public j5 getCurrentList() {
        m2 currentPage = getCurrentPage();
        if (currentPage != null) {
            return currentPage.f50472e;
        }
        return this.d;
    }
    ...
    public int getGiftsCount() {
        ...
        m2 currentPage = getCurrentPage();
        j5 j5Var2 = this.d;
        if (currentPage != null && (j5Var = currentPage.f50472e) != j5Var2) {
            if (j5Var != null && (i11 = j5Var.f52135n) > 0) {
                return i11;
            }
        } else if (j5Var2 != null && (i10 = j5Var2.f52135n) > 0) {
            return i10;
        }
        int i12 = this.f50546b;
        long j3 = this.f50547c;
        if (j3 >= 0) {
    ...
    public long getLastEmojisHash() {
        long j3 = 0;
        j5 j5Var = this.d;
        if (j5Var != null && !j5Var.f52133l.isEmpty()) {
            HashSet hashSet = new HashSet();
            int i10 = 0;
            for (int i11 = 0; i10 < 3 && i11 < j5Var.f52133l.size(); i11++) {
                TLRPC.Document document = ((TL_stars.SavedStarGift) j5Var.f52133l.get(i11)).gift.getDocument();
                if (document != null) {
    ...
    public final void h(String str, Utilities.Callback callback) {
        ...
        f6 f6Var = this.f50549f;
        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(context, 0, f6Var);
        if (str != null) {
            alertDialog$Builder.f20226a.R = LocaleController.getString(R.string.Gift2EditCollectionNameTitle);
        } else {
            alertDialog$Builder.f20226a.R = LocaleController.getString(R.string.Gift2NewCollectionTitle);
            alertDialog$Builder.f20226a.T = LocaleController.getString(R.string.Gift2NewCollectionText);
        }
        y1 y1Var = new y1(this, context, f6Var);
        y1Var.lineYFix = true;
        y1Var.setOnEditorActionListener(new z1(y1Var, callback, b2VarArr, view));
        MediaDataController.getInstance(this.f50546b).fetchNewEmojiKeywords(AndroidUtilities.getCurrentKeyboardLanguage(), true);
        y1Var.setTextSize(1, 18.0f);
        y1Var.setTextColor(j6.v0(j6.f20798j5, f6Var));
        ...
        y1Var.setLineColors(j6.v0(j6.f20819k6, f6Var), j6.v0(j6.f20837l6, f6Var), j6.v0(j6.f20908p7, f6Var));
        ...
        alertDialog$Builder.f20226a.f20252a = AndroidUtilities.dp(292.0f);
        if (str != null) {
            i10 = R.string.Edit;
        } else {
            i10 = R.string.Create;
        ...
        b2VarArr[0] = alertDialog$Builder.f20226a;
        n70 n70Var = this.I;
        if (n70Var != null && (i70Var = n70Var.f28678m) != null) {
            i70Var.setSoftInputMode(48);
        }
        AndroidUtilities.requestAdjustNothing(findActivity, this.f50545a.getClassGuid());
    ...
    public final void l() {
        ...
        if (v1Var != null) {
            ...
            FrameLayout frameLayout = this.f50551r;
            float B = nextPositionAlpha + org.telegram.messenger.w1.B(this.f50554x, (-frameLayout.getTop()) + this.Q, 1);
            int i10 = 0;
            ...
            if (this.f50548e.h() && v1Var.getPositionAnimated() >= 0.5f) {
                spannableStringBuilder = this.v;
            } else {
                spannableStringBuilder = this.f50552s;
            }
            this.f50553w.g(spannableStringBuilder, true, true);
            qc qcVar = qc.f29699w;
            if (qcVar != null && (ubVar = qcVar.f29703e) != null) {
    ...
    public final void m() {
        ...
        if (viewPages != null) {
            for (View view : viewPages) {
                if (view != null) {
                    m2 m2Var = (m2) view;
                    f6 f6Var2 = m2Var.f50471c;
                    if (m2Var.f50476s != null) {
                        m2Var.f50477w.setTextColor(j6.v0(j6.G6, f6Var2));
                        TextView textView = m2Var.f50478x;
                        int i11 = j6.Oh;
                        textView.setTextColor(j6.v0(i11, f6Var2));
                        m2Var.f50478x.setBackground(j6.Y(j6.l1(0.1f, j6.v0(i11, f6Var2)), 4, 4));
                    } else {
                        m2Var.F.setTextColor(j6.v0(j6.G6, f6Var2));
                        m2Var.G.setTextColor(j6.v0(j6.f21070y6, f6Var2));
                        m2Var.H.j();
                    }
                }
            }
        }
        this.E.setTextColor(j6.v0(j6.f20798j5, f6Var));
        this.f50555y.setBackground(j6.Y(j6.v0(j6.f20781i6, f6Var), 24, 24));
    }

    public final void n() {
        boolean z10;
        View[] viewPages;
        if (this.f50548e.d().isEmpty() && !b()) {
            z10 = false;
        } else {
            z10 = true;
        }
    ...
    public void setReorderingCollections(boolean z10) {
        if (this.L != z10) {
            this.L = z10;
            p(g());
            this.f50550n.setReordering(z10);
            if (z10) {
