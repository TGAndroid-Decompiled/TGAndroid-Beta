...
public final class j6 implements View.OnClickListener {
    public final int f47574a = 1;
    public final boolean[] f47575b;
    public final Utilities.Callback2 f47576c;
    public final ci.d d;
    public final EditTextBoldCursor e;
    public final org.telegram.ui.ActionBar.e3[] f47577f;
    ...
    public j6(boolean[] zArr, Utilities.Callback2 callback2, ci.d dVar, EditTextBoldCursor editTextBoldCursor, org.telegram.ui.ActionBar.e3[] e3VarArr) {
        this.f47575b = zArr;
        this.f47576c = callback2;
        this.d = dVar;
        this.e = editTextBoldCursor;
        this.f47577f = e3VarArr;
    }
        ...
        switch (this.f47574a) {
            case 0:
                ...
                if (!zArr[0]) {
                    ...
                    this.f47576c.run(Long.valueOf(parseLong), new k6(editTextBoldCursor, this.f47577f, 1));
                    return;
                }
                return;
            default:
                boolean[] zArr2 = this.f47575b;
                if (!zArr2[0]) {
                    zArr2[0] = true;
                    this.d.setLoading(true);
                    this.f47576c.run(0L, new tg.r(zArr2, this.e, this.f47577f, 20));
                    return;
                }
                return;
        }
