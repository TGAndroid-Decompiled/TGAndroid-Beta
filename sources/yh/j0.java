...
public abstract class j0 {
    public static final float[][] f47539a;
    public static final e0.i0 f47540b;
        ...
        if (f15 > 0.0f) {
            ...
            for (int i13 = 54; i12 < i13; i13 = 54) {
                ...
                if (i12 == 18 || i12 == 19 || i12 == 6 || i12 == 7) {
                    clamp01 = sr.f28341i.getInterpolation(clamp01);
                }
                float[] fArr3 = fArr;
                ...
                if (i14 < 0) {
                    f46 = AndroidUtilities.lerp(f18, f46, sr.f28341i.getInterpolation(clamp01));
