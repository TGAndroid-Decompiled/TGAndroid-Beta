...
public abstract class j0 {
    public static final float[][] f47229a;
    public static final e0.i0 f47230b;
    ...
    public static void b(Canvas canvas, int i10, Paint paint, Bitmap bitmap, float f7, float f10, float f11) {
        ...
        while (true) {
            ...
            e0.i0.c((float[]) i0Var.f7774c, i12, 0.0f, 0.0f, width, height);
            i12++;
        }
        while (true) {
            float[] fArr = f47229a[i10];
            if (i11 < fArr.length) {
                ...
                float f18 = f14 * 1.0f;
                int i13 = i11 / 4;
                e0.i0.c((float[]) i0Var.f7773b, i13, AndroidUtilities.dp(f16) - (AndroidUtilities.dp(f18) / 2.0f), AndroidUtilities.dp(f17) - (AndroidUtilities.dp(f18) / 2.0f), (AndroidUtilities.dp(f18) / 2.0f) + AndroidUtilities.dp(f16), (AndroidUtilities.dp(f18) / 2.0f) + AndroidUtilities.dp(f17));
        ...
        if (f15 > 0.0f) {
            ...
            for (int i13 = 54; i12 < i13; i13 = 54) {
                ...
                if (i12 == 18 || i12 == 19 || i12 == 6 || i12 == 7) {
                    clamp01 = rr.f27703i.getInterpolation(clamp01);
                }
                float[] fArr3 = fArr;
                ...
                if (i14 < 0) {
                    f46 = AndroidUtilities.lerp(f18, f46, rr.f27703i.getInterpolation(clamp01));
