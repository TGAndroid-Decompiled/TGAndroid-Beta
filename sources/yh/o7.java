...
public final class o7 extends LinearLayout {
    ...
    public final org.telegram.ui.ActionBar.d6 f47838b;
    public final w9 f47839c;
    public final org.telegram.ui.ActionBar.h5 d;
    public final TextView e;
    public final TextView f47840f;
    public final TextView h;
    public final TextView f47841n;
    public boolean f47842r;
    public boolean f47843s;
    ...
    public o7(Context context, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        this.f47840f = h;
        int i12 = org.telegram.ui.ActionBar.h6.f19461z6;
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (this.f47843s) {
            canvas.drawRect(AndroidUtilities.dp(72.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight(), org.telegram.ui.ActionBar.h6.f19180k0);
        }
    }
