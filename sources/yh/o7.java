...
public final class o7 extends h51 {
    public static final int f47542a = 0;
    ...
    public final void bindView(View view, i51 i51Var, boolean z10, w51 w51Var, e61 e61Var) {
        ...
        u9 u9Var = p7Var.f47575c;
        org.telegram.ui.ActionBar.e6 e6Var = p7Var.f47574b;
        TextView textView = p7Var.h;
        TextView textView2 = p7Var.f47576f;
        TextView textView3 = p7Var.e;
        int i12 = p7Var.f47573a;
        TextView textView4 = p7Var.f47577n;
        long peerDialogId = DialogObject.getPeerDialogId(starsSubscription.peer);
        p7Var.f47578r = !TextUtils.isEmpty(starsSubscription.title);
        if (peerDialogId < 0) {
        ...
        if (!TextUtils.isEmpty(starsSubscription.title)) {
            ...
            if (starsSubscription.photo != null) {
                ...
                x70Var.f39521b.setImage(ImageLocation.getForWebFile(WebFile.createWithWebDocument(starsSubscription.photo)), "14_14", null, null, 0, 0);
        ...
        if (!starsSubscription.canceled && !starsSubscription.bot_canceled) {
            ...
            if (j3 < currentTime) {
                ...
                textView4.setTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19234z6, e6Var));
        ...
        if (i51Var2 != null) {
            ...
            if (obj instanceof TL_stars.StarsSubscription) {
                ...
                if (obj2 instanceof TL_stars.StarsSubscription) {
                    return TextUtils.equals(((TL_stars.StarsSubscription) obj).f18335id, ((TL_stars.StarsSubscription) obj2).f18335id);
                }
                return false;
            }
            return false;
