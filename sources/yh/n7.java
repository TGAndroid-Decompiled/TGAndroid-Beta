...
public final class n7 extends za implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final r00 f47511a0;
    public Runnable f47512b0;
    public final TLRPC.InputPeer f47513c0;
    public final boolean f47514d0;
    public w51 f47515e0;
    public boolean f47516f0;

    public n7(android.content.Context r16, org.telegram.ui.ActionBar.e6 r17, long r18, int r20, java.lang.String r21, java.lang.Runnable r22, long r23) {
        throw new UnsupportedOperationException("Method not decompiled: yh.n7.<init>(android.content.Context, org.telegram.ui.ActionBar.e6, long, int, java.lang.String, java.lang.Runnable, long):void");
    }

    public static void P(n7 n7Var, int i10) {
        i51 G;
        w51 w51Var = n7Var.f47515e0;
        if (w51Var != null && (G = w51Var.G(i10 - 1)) != null) {
            w51 w51Var2 = n7Var.f47515e0;
            if (G.d == -1) {
                n7Var.f47516f0 = !n7Var.f47516f0;
                w51Var2.N(true);
                ...
                if (findActivity != null) {
                    v5.y(n7Var.currentAccount, false).f(findActivity, (TL_stars.TL_starsTopupOption) G.G, new ai.m0(25, n7Var, G), n7Var.f47513c0);
                }
            }
        }
    }
    ...
    public static void Q(n7 n7Var, i51 i51Var, Boolean bool, String str) {
        if (n7Var.getContext() != null) {
            if (bool.booleanValue()) {
                new vc((FrameLayout) n7Var.containerView, n7Var.resourcesProvider).M(LocaleController.getString(R.string.StarsAcquired), AndroidUtilities.replaceTags(LocaleController.formatPluralString("StarsAcquiredInfo", (int) i51Var.B, new Object[0])), R.raw.stars_topup).j();
                n7Var.f47511a0.c(true);
            ...
            if (z11 != null && !z11.isEmpty()) {
                ...
                while (true) {
                    ...
                    if (tL_starsTopupOption.stars >= j3) {
                        if (tL_starsTopupOption.extended && !this.f47516f0 && z12) {
                            i15++;
                        } else {
                ...
                if (i14 < 3) {
                    ...
                    if (!z14 && i15 > 0) {
                        ...
                        int i20 = g7.f47234a;
                        i51 J2 = i51.J(g7.class);
                        J2.d = -1;
                        J2.f24894l = string2;
                        J2.f24889f = !this.f47516f0;
                        J2.f24899q = true;
                        arrayList.add(J2);
                    }
                } else {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.starOptionsLoaded || i10 == NotificationCenter.starBalanceUpdated) {
            w51 w51Var = this.f47515e0;
            if (w51Var != null) {
                w51Var.N(true);
            }
            long j3 = v5.y(this.currentAccount, false).p().amount;
            long j10 = this.X;
            ((TextView) this.Y.f36086b).setText(LocaleController.formatPluralStringComma("StarsNeededTitle", (int) (j10 - j3)));
            va vaVar = this.e;
            if (vaVar != null) {
                vaVar.setTitle(y());
            }
            if (j3 >= j10 && (runnable = this.f47512b0) != null) {
                runnable.run();
                this.f47512b0 = null;
                dismiss();
            }
    ...
    public final void dismiss() {
        ...
        o20 o20Var = this.Y;
        if (o20Var != null) {
            ((sg.e) o20Var.f36087c).setPaused(true);
        }
    }
    ...
    public final void show() {
        ...
        if (!this.f47514d0) {
            ...
            Runnable runnable = this.f47512b0;
            if (runnable != null) {
                runnable.run();
                this.f47512b0 = null;
            }
    ...
    public final CharSequence y() {
        ...
        return ((TextView) o20Var.f36086b).getText();
    }
}
