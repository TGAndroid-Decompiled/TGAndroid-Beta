...
public final class n7 extends za implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final r00 f47539a0;
    public Runnable f47540b0;
    public final TLRPC.InputPeer f47541c0;
    public final boolean f47542d0;
    public x51 f47543e0;
    public boolean f47544f0;
    ...
    public static void P(n7 n7Var, int i10) {
        j51 G;
        x51 x51Var = n7Var.f47543e0;
        if (x51Var != null && (G = x51Var.G(i10 - 1)) != null) {
            x51 x51Var2 = n7Var.f47543e0;
            if (G.d == -1) {
                n7Var.f47544f0 = !n7Var.f47544f0;
                x51Var2.N(true);
                ...
                if (findActivity != null) {
                    v5.y(n7Var.currentAccount, false).f(findActivity, (TL_stars.TL_starsTopupOption) G.G, new ai.m0(25, n7Var, G), n7Var.f47541c0);
                }
            }
        }
    }
            ...
            if (z11 != null && !z11.isEmpty()) {
                ...
                while (true) {
                    ...
                    if (tL_starsTopupOption.stars >= j3) {
                        if (tL_starsTopupOption.extended && !this.f47544f0 && z12) {
                            i15++;
                        } else {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.starOptionsLoaded || i10 == NotificationCenter.starBalanceUpdated) {
            x51 x51Var = this.f47543e0;
            if (x51Var != null) {
                x51Var.N(true);
            }
            long j3 = v5.y(this.currentAccount, false).p().amount;
            long j10 = this.X;
            ((TextView) this.Y.f36784b).setText(LocaleController.formatPluralStringComma("StarsNeededTitle", (int) (j10 - j3)));
            va vaVar = this.e;
            if (vaVar != null) {
                vaVar.setTitle(y());
            }
            if (j3 >= j10 && (runnable = this.f47540b0) != null) {
                runnable.run();
                this.f47540b0 = null;
                dismiss();
            }
    ...
    public final void dismiss() {
        ...
        q20 q20Var = this.Y;
        if (q20Var != null) {
            ((sg.e) q20Var.f36785c).setPaused(true);
        }
    }
    ...
    public final void show() {
        ...
        if (!this.f47542d0) {
            ...
            Runnable runnable = this.f47540b0;
            if (runnable != null) {
                runnable.run();
                this.f47540b0 = null;
            }
    ...
    public final CharSequence y() {
        ...
        return ((TextView) q20Var.f36784b).getText();
    }
}
