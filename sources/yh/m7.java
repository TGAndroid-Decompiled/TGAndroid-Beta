...
public final class m7 extends w51 {
    public static final int f47721a = 0;
    ...
    public final void bindView(View view, x51 x51Var, boolean z10, l61 l61Var, t61 t61Var) {
        ...
        w9 w9Var = n7Var.f47775c;
        org.telegram.ui.ActionBar.e6 e6Var = n7Var.f47774b;
        TextView textView = n7Var.h;
        TextView textView2 = n7Var.f47776f;
        TextView textView3 = n7Var.e;
        int i12 = n7Var.f47773a;
        TextView textView4 = n7Var.f47777n;
        long peerDialogId = DialogObject.getPeerDialogId(starsSubscription.peer);
        n7Var.f47778r = !TextUtils.isEmpty(starsSubscription.title);
        if (peerDialogId < 0) {
        ...
        if (!TextUtils.isEmpty(starsSubscription.title)) {
            ...
            if (starsSubscription.photo != null) {
                ...
                x70Var.f39371b.setImage(ImageLocation.getForWebFile(WebFile.createWithWebDocument(starsSubscription.photo)), "14_14", null, null, 0, 0);
        ...
        if (!starsSubscription.canceled && !starsSubscription.bot_canceled) {
            ...
            if (j3 < currentTime) {
                ...
                textView4.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19464z6, e6Var));
    ...
    public final View createView(Context context, wl0 wl0Var, int i10, int i11, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        return new n7(context, i10, e6Var);
    }
        ...
        if (x51Var2 != null) {
            ...
            if (obj instanceof TL_stars.StarsSubscription) {
                ...
                if (obj2 instanceof TL_stars.StarsSubscription) {
                    return TextUtils.equals(((TL_stars.StarsSubscription) obj).f18522id, ((TL_stars.StarsSubscription) obj2).f18522id);
                }
                return false;
            }
            return false;
