...
public final class m7 extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final u00 f47493c;
    public boolean d;
    public SpannableString e;
    public long f47494f;
    public final oq[] h;
    public final oq[] f47495n;
    public ValueAnimator f47496r;

    public m7(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f47494f = -1L;
        this.h = new oq[1];
        this.f47495n = new oq[1];
        this.f47492b = i10;
        this.f47491a = UserConfig.getInstance(i10).getClientUserId();
        setOrientation(1);
        setGravity(21);
    ...
    public final void a(boolean z10) {
        ...
        long j3 = 0;
        zf.a i11 = zf.a.i(0L, zf.b.f48978b);
        u00 u00Var = this.f47493c;
        u00Var.a();
        if (this.f47491a == UserConfig.getInstance(i10).getClientUserId()) {
            z12 = !y3.e;
            j3 = y3.p().amount;
            if (v5Var != null) {
                z12 |= !v5Var.e;
            ...
            TLRPC.TL_payments_starsRevenueStats h = o.g(i10).h(this.f47491a, false);
        ...
        long j10 = this.f47494f;
        if (j3 > j10 && j10 != -1) {
            ValueAnimator valueAnimator = this.f47496r;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            ValueAnimator ofFloat = ValueAnimator.ofFloat(0.9f, 1.0f);
            this.f47496r = ofFloat;
            ofFloat.addUpdateListener(new org.telegram.ui.Components.voip.r0(this, 25));
            this.f47496r.addListener(new qg.n0(this, 10));
            this.f47496r.setDuration(320L);
            this.f47496r.setInterpolator(new OvershootInterpolator());
            this.f47496r.start();
        }
        if (z12) {
            if (this.e == null) {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.starBalanceUpdated) {
            a(true);
        } else if (i10 == NotificationCenter.botStarsUpdated && ((Long) objArr[0]).longValue() == this.f47491a) {
            a(true);
        }
    }
