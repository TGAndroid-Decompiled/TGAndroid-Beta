...
public final class j2 extends j81 {
    ...
    public final void F(View view, float f7) {
        ...
        if (view instanceof FrameLayout) {
            ...
            if (frameLayout.getChildCount() > 0) {
                ...
                if (m2Var != null && view2 == m2Var.Y && (l2Var3 = m2Var.f46979d0) != null) {
                    l2Var3.invalidate();
                }
                if (view2 == a4Var.Y && (l2Var2 = a4Var.f46979d0) != null) {
                    l2Var2.invalidate();
                }
                m2Var2 = a4Var.f46977c0;
                if (m2Var2 == null && view2 == m2Var2.Y && (l2Var = m2Var2.f46979d0) != null) {
                    l2Var.invalidate();
                    return;
                }
                return;
    ...
    public final void G() {
        ...
        if (i10 != a4Var.L1(false)) {
            if (this.f25182b > a4Var.L1(false)) {
                z10 = true;
            }
