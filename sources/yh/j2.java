...
public final class j2 extends s4.v {
    ...
    public final boolean n(RecyclerView recyclerView, s4.c1 c1Var, s4.c1 c1Var2) {
        TL_stars.SavedStarGift savedStarGift;
        zh.g0 g0Var;
        m2 m2Var = this.f50349e;
        h2 h2Var = m2Var.f50444f;
        if (m2Var.f50443e != null && m2Var.f50445n) {
            View view = c1Var.f45739a;
            ...
            if (r(savedStarGift)) {
                ...
                if (r(savedStarGift2)) {
                    ...
                    nr0 nr0Var = this.d;
                    if (z10) {
                        m2Var.f50443e.k(b10, b11);
                        nr0Var.f50519e.n(m2Var.f50443e.d);
                    } else {
                        j5 j5Var = m2Var.f50443e;
                        if (j5Var.f52107q == null) {
                            j5Var.f52107q = j5Var.h();
                        }
                        j5Var.k(b10, b11);
                    }
                    h2Var.Y2.p(b10, b11);
                    ...
                    if ((U instanceof ProfileActivity) && (g0Var = ((ProfileActivity) U).f34005v0) != null) {
                        g0Var.a();
                    }
                    return true;
                }
    ...
    public final void p(s4.c1 c1Var, int i10) {
        ...
        if (i10 == 0) {
            j5 j5Var = m2Var.f50443e;
            if (j5Var != null) {
                ArrayList arrayList = j5Var.f52107q;
                if (arrayList != null) {
                    ArrayList h = j5Var.h();
