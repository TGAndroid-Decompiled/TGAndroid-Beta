...
public abstract class l8 extends View {
    ...
    public final Path V;
    public final Path W;
    public final org.telegram.ui.ActionBar.d6 f47673a;
    public final RectF f47674a0;
    public final Paint f47675b;
    public final Path f47676b0;
    public final Paint f47677c;
    public float f47678c0;
    public final Paint d;
    public float f47679d0;
    public final Paint e;
    public int[] f47680e0;
    public final Paint f47681f;
    public final le.c f47682f0;
    public float f47683g0;
    public final i8 h;
    public float f47684h0;
    public long f47685i0;
    public int f47686j0;
    public boolean f47687k0;
    public ValueAnimator f47688l0;
    public final i8 f47689n;
    public int f47690r;
    public int f47691s;
    public ValueAnimator v;
    public int f47692w;
    public int f47693x;
    public LinearGradient f47694y;

    public l8(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f47675b = new Paint(1);
        this.f47677c = new Paint(1);
        this.d = new Paint(1);
        this.e = new Paint(1);
        this.f47681f = new Paint(1);
        this.h = new i8(0, 300);
        this.f47689n = new i8(2, 30);
        this.f47690r = -1135603;
        this.f47691s = -404714;
        this.f47692w = -1135603;
        this.f47693x = -404714;
        this.f47694y = new LinearGradient(0.0f, 0.0f, 255.0f, 0.0f, new int[]{this.f47690r, this.f47691s}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP);
        this.E = new Matrix();
        this.F = true;
        ...
        this.V = new Path();
        this.W = new Path();
        this.f47674a0 = new RectF();
        this.f47676b0 = new Path();
        this.f47678c0 = 0.0f;
        this.f47682f0 = new le.c(this, srVar, 320L);
        this.f47673a = d6Var;
        ...
        o6Var2.f26962b = 17;
        paint.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19129h5, d6Var));
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth(AndroidUtilities.dp(1.0f));
    }

    public final void a(float f7) {
        ValueAnimator valueAnimator = this.f47688l0;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f47678c0, f7);
        this.f47688l0 = ofFloat;
        ofFloat.addUpdateListener(new org.telegram.ui.Components.voip.r0(this, 26));
        int value = getValue();
        this.f47688l0.addListener(new j00(this, f7, value));
        this.f47688l0.setDuration(320L);
        this.f47688l0.setInterpolator(sr.h);
        this.f47688l0.start();
        if (c(f7) != value) {
            e(c(f7));
        }
    ...
    public final int c(float f7) {
        ...
        int[] iArr;
        if (f7 <= 0.0f) {
            return this.f47680e0[0];
        }
        if (f7 >= 1.0f) {
            return this.f47680e0[iArr.length - 1];
        }
        int[] iArr2 = this.f47680e0;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        this.f47694y.setLocalMatrix(matrix);
        LinearGradient linearGradient = this.f47694y;
        Paint paint3 = this.f47677c;
        paint3.setShader(linearGradient);
        int d = i0.a.d(this.f47678c0, this.f47690r, this.f47691s);
        Path path = this.U;
        path.rewind();
        Path.Direction direction2 = Path.Direction.CW;
        path.addRoundRect(rectF2, AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), direction2);
        int l1 = org.telegram.ui.ActionBar.h6.l1(0.15f, this.f47690r);
        Paint paint4 = this.f47675b;
        paint4.setColor(l1);
        ...
        i8 i8Var = this.h;
        i8Var.g(rectF2);
        float f13 = this.f47678c0;
        i8Var.h = (f13 * 15.0f) + 1.0f;
        i8Var.f47530j = (int) (i8Var.f47525b.size() * ((f13 * 0.85f) + 0.15f));
        i8Var.d();
        canvas.save();
        ...
        if (j3 != -1 && b((int) j3) < 1.0f && b((int) this.P) > 0.0f) {
            ...
            if (clamp01 + u01Var.f28649c + (AndroidUtilities.dp(16.0f) * 2) > rectF2.right) {
                f12 = (clamp01 - lerp) - u01Var.f28649c;
            } else {
                f12 = clamp01 + lerp;
            }
            float f14 = f12;
        ...
        if (j10 != -1 && b((int) j10) < 1.0f && b((int) this.P) > 0.0f) {
            ...
            if (u01Var.f28649c + dp3 + (AndroidUtilities.dp(16.0f) * 2) > rectF2.right) {
                f11 = (dp3 - lerp2) - u01Var.f28649c;
            } else {
                f11 = lerp2 + dp3;
            }
            float f15 = f11;
            paint2.setStrokeWidth(AndroidUtilities.dp(1.0f));
            paint2.setColor(org.telegram.ui.ActionBar.h6.l1(0.4f, org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19129h5, this.f47673a)));
            i11 = i10;
        ...
        if (this.O) {
            ...
            int d10 = i0.a.d(0.5f, paint.getColor(), this.f47691s);
            Paint paint6 = this.d;
            paint6.setColor(d10);
            Path path3 = this.W;
            path3.rewind();
        ...
        float clamp5 = Utilities.clamp(this.f47678c0 - this.f47679d0, 1.0f, -1.0f) * 60.0f;
        float dp12 = rectF5.bottom + AndroidUtilities.dp(8.0f);
        Path path4 = this.f47676b0;
        path4.rewind();
        ...
        i8 i8Var2 = this.f47689n;
        i8Var2.g(rectF7);
        i8Var2.h = (this.f47678c0 * 15.0f) + 1.0f;
        i8Var2.d();
        canvas2.save();
        ...
        if (Math.abs(this.f47678c0 - this.f47679d0) > 0.001f) {
            this.f47679d0 = AndroidUtilities.lerp(this.f47679d0, this.f47678c0, 0.1f);
            invalidate();
        }
        this.f47681f.setShader(this.f47694y);
        canvas2.drawPath(path4, this.f47681f);
        canvas2.save();
        ...
        canvas2.restore();
        canvas2.save();
        float f27 = 1.0f - (this.f47682f0.e * 0.15f);
        ...
        o6Var.f26979w = (int) (this.f47682f0.e * 255.0f);
        o6Var.draw(canvas2);
        canvas2.restore();
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            this.f47683g0 = motionEvent.getX();
            this.f47684h0 = motionEvent.getY();
            this.f47686j0 = motionEvent.getPointerId(0);
            this.f47685i0 = System.currentTimeMillis();
            this.f47687k0 = false;
            return true;
        }
        if (motionEvent.getAction() == 2 && motionEvent.getPointerId(0) == this.f47686j0) {
            float x10 = motionEvent.getX() - this.f47683g0;
            float y3 = motionEvent.getY() - this.f47684h0;
            if (!this.f47687k0 && Math.abs(x10) > Math.abs(y3 * 1.5f) && Math.abs(x10) > AndroidUtilities.touchSlop) {
            ...
            if (this.f47687k0) {
                int value = getValue();
                this.f47678c0 = Utilities.clamp01((x10 / (getWidth() * 1.0f)) + this.f47678c0);
                if (getValue() != value) {
                    e(getValue());
                    org.telegram.ui.Components.o6 o6Var = this.H;
                    o6Var.b();
            ...
            if (!this.f47687k0 && motionEvent.getPointerId(0) == this.f47686j0 && v7.a7.a(this.f47683g0, this.f47684h0, motionEvent.getX(), motionEvent.getY()) < AndroidUtilities.touchSlop && ((float) (System.currentTimeMillis() - this.f47685i0)) <= ViewConfiguration.getTapTimeout() * 1.5f) {
    ...
    public final void f(int i10, int i11, boolean z10) {
        if (this.f47692w == i10 && this.f47693x == i11) {
            return;
        }
        ...
        if (z10) {
            int i12 = this.f47690r;
            int i13 = this.f47691s;
            this.f47692w = i10;
            this.f47693x = i11;
            ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
            this.v = ofFloat;
            ofFloat.addUpdateListener(new s20(this, i12, i10, i13, i11, 2));
    ...
    public final void g(String str) {
        this.f47682f0.a(!TextUtils.isEmpty(str), true);
        org.telegram.ui.Components.o6 o6Var = this.I;
        o6Var.b();
