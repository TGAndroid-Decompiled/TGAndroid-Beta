...
public final class t2 extends View {
    public final Paint f48031a;
    public final Paint f48032b;
    public final Paint f48033c;
    public final RadialGradient[] d;
    public final Matrix e;
    public final org.telegram.ui.Components.e6 f48034f;
    public final RadialGradient h;
    public final Path f48035n;
    public int f48036r;
    public int f48037s;

    public t2(Context context) {
        super(context);
        this.f48031a = new Paint(1);
        this.f48032b = new Paint(1);
        Paint paint = new Paint(1);
        this.f48033c = paint;
        this.d = new RadialGradient[2];
        this.e = new Matrix();
        this.f48034f = new org.telegram.ui.Components.e6(1.0f, this, 0L, 420L, qr.h);
        this.h = new RadialGradient(0.0f, 0.0f, 100.0f, new int[]{0, -1, -1, 0}, new float[]{0.15f, 0.35f, 0.65f, 0.88f}, Shader.TileMode.CLAMP);
        this.f48035n = new Path();
        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_IN));
    }

    public final void a(int i10, int i11) {
        if (this.f48036r == i10 && this.f48037s == i11) {
            return;
        }
