...
public final class t2 extends View {
    public final Paint f48015a;
    public final Paint f48016b;
    public final Paint f48017c;
    public final RadialGradient[] d;
    public final Matrix e;
    public final org.telegram.ui.Components.e6 f48018f;
    public final RadialGradient h;
    public final Path f48019n;
    public int f48020r;
    public int f48021s;

    public t2(Context context) {
        super(context);
        this.f48015a = new Paint(1);
        this.f48016b = new Paint(1);
        Paint paint = new Paint(1);
        this.f48017c = paint;
        this.d = new RadialGradient[2];
        this.e = new Matrix();
        this.f48018f = new org.telegram.ui.Components.e6(1.0f, this, 0L, 420L, rr.h);
        this.h = new RadialGradient(0.0f, 0.0f, 100.0f, new int[]{0, -1, -1, 0}, new float[]{0.15f, 0.35f, 0.65f, 0.88f}, Shader.TileMode.CLAMP);
        this.f48019n = new Path();
        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_IN));
    }

    public final void a(int i10, int i11) {
        if (this.f48020r == i10 && this.f48021s == i11) {
            return;
        }
