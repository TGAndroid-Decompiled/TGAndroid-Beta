...
public final class m2 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final di.d H;
    public boolean I;
    public final nr0 f50439a;
    public final int f50440b;
    public final f6 f50441c;
    public boolean d;
    public j5 f50442e;
    public final h2 f50443f;
    public bh.l h;
    public boolean f50444n;
    public int f50445r;
    public final FrameLayout f50446s;
    ...
    public m2(nr0 nr0Var, int i10, f6 f6Var) {
        ...
        this.f50445r = AndroidUtilities.displaySize.y;
        ...
        View view = this.f50446s;
        if (view != null) {
            removeView(view);
        }
        View view2 = this.f50449y;
        if (view2 != null) {
            removeView(view2);
        }
        if (nr0Var.d == this.f50442e) {
            this.f50449y = null;
            this.F = null;
            this.G = null;
            this.H = null;
            this.E = null;
            this.f50446s = new FrameLayout(getContext());
            LinearLayout linearLayout = new LinearLayout(getContext());
            this.v = linearLayout;
            linearLayout.setOrientation(1);
            this.f50446s.addView(this.v, x5.e(-2, -2, 17));
            ...
            this.f50447w = textView;
            textView.setTextSize(1, 17.0f);
            this.f50447w.setTypeface(AndroidUtilities.bold());
            this.f50447w.setTextColor(j6.v0(j6.G6, f6Var));
            this.f50447w.setText(LocaleController.getString(R.string.ProfileGiftsNotFoundTitle));
            this.v.addView(this.f50447w, x5.t(-2, -2, 1, 0, 12, 0, 0));
            TextView textView2 = new TextView(getContext());
            this.f50448x = textView2;
            textView2.setTextSize(1, 14.0f);
            TextView textView3 = this.f50448x;
            int i11 = j6.Oh;
            textView3.setTextColor(j6.v0(i11, f6Var));
            this.f50448x.setText(LocaleController.getString(R.string.ProfileGiftsNotFoundButton));
            this.f50448x.setOnClickListener(new View.OnClickListener(this) {
                public final m2 f50232b;
                ...
                public final void onClick(View view3) {
                    switch (r2) {
                        case 0:
                            j5 j5Var = this.f50232b.f50442e;
                            if (j5Var != null) {
                                if (!j5Var.f52095e || j5Var.f52097g != 783) {
                                    j5Var.f52097g = 783;
                                    j5Var.f52095e = true;
                                    j5Var.i(true);
                                    return;
                            ...
                            return;
                        default:
                            this.f50232b.f50439a.a();
                            return;
                    }
                }
            });
            this.f50448x.setPadding(AndroidUtilities.dp(10.0f), AndroidUtilities.dp(4.0f), AndroidUtilities.dp(10.0f), AndroidUtilities.dp(4.0f));
            this.f50448x.setBackground(j6.Y(j6.l1(0.1f, j6.v0(i11, f6Var)), 4, 4));
            z5.a(this.f50448x);
            this.v.addView(this.f50448x, x5.t(-2, -2, 1, 0, 8, 0, 0));
            addView(this.f50446s, x5.e(-1, -1, 119));
            h2Var.setEmptyView(this.f50446s);
            return;
        }
        this.f50446s = null;
        this.f50447w = null;
        this.f50448x = null;
        this.v = null;
        this.f50449y = new FrameLayout(getContext());
        LinearLayout linearLayout2 = new LinearLayout(getContext());
        this.E = linearLayout2;
        linearLayout2.setOrientation(1);
        this.f50449y.addView(this.E, x5.e(-2, -2, 17));
        ...
        this.G.setTextColor(j6.v0(j6.f21042y6, f6Var));
        ...
        addView(this.f50449y, x5.d(-1, -1.0f, 119, 0.0f, -12.0f, 0.0f, 0.0f));
        h2Var.setEmptyView(this.f50449y);
        LinearLayout linearLayout3 = this.E;
        if (linearLayout3 != null) {
            linearLayout3.setVisibility(nr0Var.f50518e.h() ? 0 : 8);
        }
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.starUserGiftsLoaded && objArr[1] == this.f50442e) {
            f(true);
            if (this.f50442e != null && isAttachedToWindow()) {
                h2 h2Var = this.f50443f;
    ...
    public final void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f50440b).addObserver(this, NotificationCenter.starUserGiftsLoaded);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f50440b).removeObserver(this, NotificationCenter.starUserGiftsLoaded);
    }

    @Override
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(i10, i11);
        setVisibleHeight(this.f50445r);
    }
    ...
    public void setVisibleHeight(int i10) {
        ...
        FrameLayout frameLayout = this.f50446s;
        if (frameLayout != null) {
            frameLayout.setTranslationY((-(getMeasuredHeight() - this.f50445r)) / 2.0f);
        }
        ...
        FrameLayout frameLayout2 = this.f50449y;
        if (frameLayout2 != null) {
            frameLayout2.setTranslationY((-(getMeasuredHeight() - this.f50445r)) / 2.0f);
        }
    }
}
