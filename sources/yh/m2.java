...
public final class m2 extends FrameLayout {
    public final w9 f47695a;
    public final s2 f47696b;
    public final org.telegram.ui.Components.p6 f47697c;
    public TL_stars.starGiftAttributeBackdrop d;
    public TL_stars.starGiftAttributePattern e;
    public float f47698f;
    ...
    public m2(Context context) {
        ...
        s2Var.f47989a.setStrokeWidth(AndroidUtilities.dp(3.0f));
    ...
    public final void c(float f7, boolean z10) {
        this.f47698f = f7;
        s2 s2Var = this.f47696b;
        s2Var.d = f7;
        if (!z10) {
            s2Var.f47990b.d(f7, true);
        }
        s2Var.invalidate();
        this.f47697c.c(Math.round(f7 * 100.0f) + "%", z10, true);
    }
}
