...
public final class v7 extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final w81 f48155b;
    public final u7 f48156c;
    ...
    public wl0 getCurrentListView() {
        View currentView = this.f48155b.getCurrentView();
        if (!(currentView instanceof t7)) {
            return null;
        }
        return ((t7) currentView).f48064a;
    }

    @Override
    public final void onAttachedToWindow() {
        this.f48156c.i();
        this.f48155b.o(false);
        NotificationCenter.getInstance(this.f48154a).addObserver(this, NotificationCenter.starTransactionsLoaded);
        super.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        NotificationCenter.getInstance(this.f48154a).removeObserver(this, NotificationCenter.starTransactionsLoaded);
