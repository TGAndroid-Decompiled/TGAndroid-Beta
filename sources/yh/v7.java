...
public final class v7 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public final f61 f47947a;
    public final org.telegram.ui.ActionBar.f6 f47948b;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i12) {
            ...
            this.h.run();
        } else if (i10 == NotificationCenter.botStarsTransactionsLoaded && ((Long) objArr[0]).longValue() == this.f47950f) {
            f61Var.Y2.N(true);
        }
    }
