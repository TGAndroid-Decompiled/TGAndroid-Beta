...
public final class v7 extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final w81 f48156b;
    public final u7 f48157c;
    ...
    public wl0 getCurrentListView() {
        View currentView = this.f48156b.getCurrentView();
    ...
    public final void onAttachedToWindow() {
        this.f48157c.i();
        this.f48156b.o(false);
        NotificationCenter.getInstance(this.f48155a).addObserver(this, NotificationCenter.starTransactionsLoaded);
        super.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        NotificationCenter.getInstance(this.f48155a).removeObserver(this, NotificationCenter.starTransactionsLoaded);
