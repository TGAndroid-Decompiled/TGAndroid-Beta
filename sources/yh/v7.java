...
public final class v7 extends r20 implements NotificationCenter.NotificationCenterDelegate {
    public static DecimalFormat f48158h0;
    public static DecimalFormat f48159i0;
    ...
    public ci.d Y;
    public xh.h1 Z;
    public ci.d f48160a0;
    public bc1 f48161b0;
    public ci.d f48162c0;
    public ci.d f48163d0;
    public boolean f48164e0;
    public boolean f48165f0;
    public y6 f48166g0;
    ...
    public static void F0(b01 b01Var, int i10, TL_stars.StarGift starGift, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        if (!starGift.sold_out) {
            ...
            final long j3 = starGift.f18521id;
            ...
            final NotificationCenter.NotificationCenterDelegate[] notificationCenterDelegateArr = {new NotificationCenter.NotificationCenterDelegate() {
                ...
                public final void didReceivedNotification(int i11, int i12, Object[] objArr) {
                    ...
                    if (!zArr2[0] && i11 == (i13 = NotificationCenter.starGiftsLoaded) && (J = (t5Var = t5.this).J(j3)) != null) {
                        zArr2[0] = true;
                        NotificationCenter.getInstance(t5Var.f48042a).removeObserver(notificationCenterDelegateArr[0], i13);
                        b1Var.run(J);
                    }
                }
            }};
    ...
    public static SpannableStringBuilder J0(TL_stars.StarsAmount starsAmount, float f7, char c10) {
        ...
        int i10;
        if (f48159i0 == null) {
            f48159i0 = new DecimalFormat("0.################", new DecimalFormatSymbols(Locale.US));
        }
        ...
        if (starsAmount instanceof TL_stars.TL_starsTonAmount) {
            ...
            if (j3 % 1000000000 != 0) {
                String format = f48159i0.format(j3 / 1.0E9d);
            ...
            if (i11 != 0) {
                ...
                DecimalFormat decimalFormat = f48159i0;
    ...
    public static SpannableStringBuilder K0(TL_stars.StarsAmount starsAmount, float f7, char c10) {
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        if (starsAmount instanceof TL_stars.TL_starsTonAmount) {
            String format = f48159i0.format(starsAmount.amount / 1.0E9d);
            spannableStringBuilder.append((CharSequence) format);
            int indexOf = format.indexOf(".");
            if (indexOf >= 0) {
                spannableStringBuilder.setSpan(new RelativeSizeSpan(f7), indexOf, spannableStringBuilder.length(), 33);
    ...
    public static String M0(long j3) {
        String str;
        if (f48158h0 == null) {
            f48158h0 = new DecimalFormat("0.####", new DecimalFormatSymbols(Locale.US));
        }
        if (j3 % 1000000000 != 0) {
            return f48158h0.format(j3 / 1.0E9d);
        }
        StringBuilder sb2 = new StringBuilder();
        if (j3 < 0) {
            str = "-";
    ...
    public static java.lang.String N0(int r5, boolean r6, org.telegram.tgnet.tl.TL_stars.StarsTransaction r7) {
        throw new UnsupportedOperationException("Method not decompiled: yh.v7.N0(int, boolean, org.telegram.tgnet.tl.TL_stars$StarsTransaction):java.lang.String");
    }
    ...
    public static i11 Y0(View view, ImageReceiver imageReceiver, String str, boolean z10) {
        ...
        return new i11(notificationCenter.listen(view, i10, new Utilities.Callback() {
            @Override
    ...
    public static void Z0(ImageReceiver imageReceiver, TLRPC.Document document, int i10) {
        ...
        imageReceiver.setImage(ImageLocation.getForDocument(document), a4.a.k(i10, i10, "_"), ImageLocation.getForDocument(closestPhotoSizeWithSize, document), a4.a.k(i10, i10, "_"), DocumentObject.getSvgThumb(document.thumbs, org.telegram.ui.ActionBar.j6.f19006a7, 0.35f), 0L, null, null, 0);
    }
    ...
    public static void e1(Context context, int i10, long j3, TL_stories.Boost boost, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        e.addView(frameLayout, w7.y5.t(-1, 150, 7, 0, 0, 0, 10));
        ...
        b01Var.k(LocaleController.getString(R.string.BoostFrom), i10, j3, new v5(f3VarArr, j3, 2));
    ...
    public static i0 f1(Context context, int i10, TL_stars.TL_starGiftUnique tL_starGiftUnique, Utilities.Callback2 callback2, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        if (tL_starGiftUnique == null) {
            ...
            resellAmount = tL_starGiftUnique.getResellAmount(zf.b.f49209b);
        } else {
            resellAmount = tL_starGiftUnique.getResellAmount(bVar);
        }
        i0 i0Var = new i0(context, e6Var, i10, resellAmount, new nj0(21, callback2, r8));
        i0[] i0VarArr = {i0Var};
        i0Var.show();
        return i0VarArr[0];
    }
    ...
    public static void g1(Context context, long j3, boolean z10, final Utilities.Callback2 callback2, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        long j10;
        boolean z11 = false;
        org.telegram.ui.ActionBar.f3 i12 = wh.i(1, context, e6Var, false);
        ...
        editTextBoldCursor.setOnFocusChangeListener(new ei.w1(id0Var, editTextBoldCursor, 2));
        ...
        k6 k6Var = new k6(f3VarArr, editTextBoldCursor);
        if (z11) {
            j10 = 200;
        } else {
            j10 = 80;
    ...
    public static org.telegram.ui.ActionBar.f3 h1(final android.content.Context r60, final boolean r61, final long r62, final int r64, final org.telegram.tgnet.tl.TL_stars.StarsTransaction r65, final org.telegram.ui.ActionBar.e6 r66) {
        throw new UnsupportedOperationException("Method not decompiled: yh.v7.h1(android.content.Context, boolean, long, int, org.telegram.tgnet.tl.TL_stars$StarsTransaction, org.telegram.ui.ActionBar.e6):org.telegram.ui.ActionBar.f3");
    }
    ...
    public static void i1(Activity activity, int i10, int i11, TLRPC.TL_messageActionPaymentRefunded tL_messageActionPaymentRefunded, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        starsTransaction.f18523id = tL_messageActionPaymentRefunded.charge.f18424id;
    ...
    public static void j1(Context context, int i10, TLRPC.TL_payments_paymentReceiptStars tL_payments_paymentReceiptStars, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        starsTransaction.f18523id = tL_payments_paymentReceiptStars.transaction_id;
        h1(context, false, 0L, i10, starsTransaction, e6Var);
    }

    public static void x0(yh.v7 r39, int r40) {
        throw new UnsupportedOperationException("Method not decompiled: yh.v7.x0(yh.v7, int):void");
    }
    ...
    public final View createView(final Context context) {
        ...
        this.f36938c.setOnItemClickListener(new ai.g(this, 21));
        r00 r00Var = new r00(getParentActivity());
        this.T = r00Var;
        this.f36942s.addView(r00Var, w7.y5.c(-1.0f, -1));
        t5 y3 = t5.y(this.currentAccount, false);
        ...
        this.X.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19464z6, this.resourceProvider));
        ...
        this.f48160a0 = dVar;
        dVar.e();
        this.f48160a0.g("", false, true);
        this.f48160a0.setOnClickListener(new View.OnClickListener(this) {
            public final v7 f47266b;
            ...
            public final void onClick(View view) {
                switch (r3) {
                    case 0:
                        v7.B0(this.f47266b, context);
                        return;
                    default:
                        new l7(context, this.f47266b.resourceProvider).show();
                        return;
                }
            }
        });
        this.Z.addView(this.f48160a0, w7.y5.e(-1, 48, 119));
        bc1 bc1Var = new bc1(this, getParentActivity(), 20);
        this.f48161b0 = bc1Var;
        ...
        this.f48162c0.g(spannableStringBuilder, false, true);
        this.f48162c0.setOnClickListener(new View.OnClickListener(this) {
            public final v7 f47266b;
        ...
        this.f48161b0.addView(this.f48162c0, w7.y5.p(-1, 48, 17.0f, 1, 0, 0, 8, 0));
        ...
        this.f48161b0.addView(this.Y, w7.y5.p(-1, 48, 17.0f, 1, 0, 0, 0, 0));
        ...
        this.f48163d0.g(spannableStringBuilder3, false, true);
        this.f48163d0.setOnClickListener(new View.OnClickListener(this) {
            public final v7 f47302b;
        ...
        this.U.addView(this.f48163d0, w7.y5.d(-1, 48.0f, 17, 20.0f, 8.0f, 20.0f, 0.0f));
        k1();
        y6 y6Var = this.f48166g0;
        if (y6Var != null) {
            y6Var.N(false);
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.starOptionsLoaded) {
            ...
            t5 y3 = t5.y(this.currentAccount, false);
            if (this.f48164e0 != y3.O(0)) {
                this.f48164e0 = y3.O(0);
                s0();
                y6 y6Var2 = this.f48166g0;
                if (y6Var2 != null) {
                    y6Var2.N(true);
                }
                if (this.N == 0 && this.O < 0) {
    ...
    public final void l1(final boolean z10, boolean z11) {
        ...
        if (z11) {
            ...
            animate.alpha(f10).withEndAction(new Runnable(this) {
                ...
                public final void run() {
                    switch (r3) {
                        case 0:
                            if (z10) {
                                this.f47340b.Z.setVisibility(8);
                                return;
                            }
                            return;
                        default:
                            if (!z10) {
                                this.f47340b.f48161b0.setVisibility(8);
                                return;
                            }
                            return;
                    }
            ...
            ViewPropertyAnimator animate2 = this.f48161b0.animate();
            if (!z10) {
                f11 = 0.0f;
            }
        ...
        this.f48161b0.animate().cancel();
        bc1 bc1Var = this.f48161b0;
        if (z10) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
    ...
    public final s4.h0 n0() {
        y6 y6Var = new y6(this, this.f36938c, getParentActivity(), this.currentAccount, this.classGuid, new hi.a(this, 26), getResourceProvider());
        this.f48166g0 = y6Var;
        y6Var.f26042r = false;
        return y6Var;
    }
    ...
    public final boolean q0() {
        ...
        if (u7Var != null && (u7Var.getParent() instanceof View)) {
            if ((this.f36938c.getHeight() - this.f36938c.getPaddingBottom()) - ((View) this.R.getParent()).getBottom() >= 0) {
                z10 = true;
            }
        }
        return !z10;
