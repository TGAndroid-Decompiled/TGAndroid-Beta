...
public final class g extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public CharSequence f47206b0;
    public final boolean f47207c;
    public CharSequence f47208c0;
    public eo d;
    public CharSequence f47209d0;
    public f61 e;
    public boolean f47210e0;
    public TLRPC.TL_payments_starsRevenueStats f47211f;
    public ma1 f47212f0;
    public ma1 f47213g0;
    public TLRPC.TL_starsRevenueStatus h;
    public boolean f47214h0;
    public boolean f47215i0;
    public final ArrayList f47216j0;
    public String f47217k0;
    public DecimalFormat f47218l0;
    public SpannableStringBuilder m0;
    public ma1 f47219n;
    public final b f47220n0;
    public final int f47221o0;
    public final ie f47222r;
    public final ie f47223s;
    public final ie v;
    public final ie f47224w;
    public final ie f47225x;
    public final ie f47226y;

    public g(int i10, long j3) {
        super(null);
        boolean z10;
        String string;
        this.f47222r = ie.a("XTR", LocaleController.getString(R.string.BotStarsOverviewAvailableBalance));
        this.f47223s = ie.a("XTR", LocaleController.getString(R.string.BotStarsOverviewTotalBalance));
        this.v = ie.a("XTR", LocaleController.getString(R.string.BotStarsOverviewTotalProceeds));
        this.f47224w = ie.a("TON", LocaleController.getString(R.string.BotMonetizationOverviewAvailable));
        this.f47225x = ie.a("TON", LocaleController.getString(R.string.BotMonetizationOverviewLastWithdrawal));
        this.f47226y = ie.a("TON", LocaleController.getString(R.string.BotMonetizationOverviewTotal));
        boolean z11 = false;
        this.N = false;
        this.O = true;
        this.T = new oq[1];
        this.f47214h0 = false;
        this.f47215i0 = false;
        this.f47216j0 = new ArrayList();
        this.f47217k0 = "";
        this.f47220n0 = new b(this, 0);
        this.f47221o0 = -1;
        this.f47203a = i10;
        this.f47205b = j3;
    ...
    public static void U(g gVar) {
        ...
        oc.e();
        TLRPC.TL_payments_starsRevenueStats h = o.g(gVar.currentAccount).h(gVar.f47205b, false);
        if (h == null) {
            j3 = 0;
        } else {
    ...
    public static void W(g gVar, j51 j51Var) {
        if (j51Var.G(r7.class)) {
            y7.h1(gVar.getParentActivity(), true, gVar.f47205b, gVar.currentAccount, (TL_stars.StarsTransaction) j51Var.G, gVar.getResourceProvider());
        } else if (j51Var.G instanceof TL_stats.BroadcastRevenueTransaction) {
            le.h0(gVar.getParentActivity(), gVar.currentAccount, (TL_stats.BroadcastRevenueTransaction) j51Var.G, gVar.f47205b, gVar.resourceProvider);
        } else if (j51Var.d == 2) {
            gVar.presentFragment(new ei.e4(gVar.f47205b));
        }
    }
    ...
    public static void X(g gVar, Context context, View view) {
        if (view.isEnabled()) {
            ...
            if (!dVar.N) {
                ...
                tL_payments_getStarsRevenueAdsAccountUrl.peer = MessagesController.getInstance(gVar.currentAccount).getInputPeer(gVar.f47205b);
    ...
    public static void Y(g gVar, ArrayList arrayList) {
        ...
        int i15;
        ie ieVar = gVar.f47225x;
        ArrayList arrayList2 = gVar.f47216j0;
        ie ieVar2 = gVar.f47226y;
        ie ieVar3 = gVar.v;
        ie ieVar4 = gVar.f47223s;
        ie ieVar5 = gVar.f47222r;
        long j3 = gVar.f47205b;
        ie ieVar6 = gVar.f47224w;
        boolean z10 = gVar.f47207c;
        int i16 = gVar.f47221o0;
        o g10 = o.g(gVar.currentAccount);
        int i17 = gVar.f47203a;
        if (i17 == 0) {
            arrayList.add(j51.h(2, i16, gVar.f47219n));
            ...
            if (h != null && (tL_starsRevenueStatus2 = h.status) != null) {
                ieVar5.f34539a = false;
                ieVar5.f34543g = true;
                TL_stars.StarsAmount starsAmount = tL_starsRevenueStatus2.available_balance;
                ieVar5.f34544i = starsAmount;
                ieVar5.h = "XTR";
                ieVar5.f34542f = "USD";
                double d10 = gVar.Z;
                ieVar5.f34545j = (long) (starsAmount.amount * d10 * 100.0d);
                ieVar4.f34539a = false;
                ieVar4.f34543g = true;
                TL_stars.StarsAmount starsAmount2 = tL_starsRevenueStatus2.current_balance;
                ieVar4.f34544i = starsAmount2;
                ieVar4.h = "XTR";
                ieVar4.f34545j = (long) (starsAmount2.amount * d10 * 100.0d);
                ieVar4.f34542f = "USD";
                ieVar3.f34539a = false;
                ieVar3.f34543g = true;
                TL_stars.StarsAmount starsAmount3 = tL_starsRevenueStatus2.overall_revenue;
                ieVar3.f34544i = starsAmount3;
                ieVar3.h = "XTR";
                ieVar3.f34545j = (long) (starsAmount3.amount * d10 * 100.0d);
                ieVar3.f34542f = "USD";
            ...
            if (!z10) {
                if (gVar.f47206b0 == null) {
                    gVar.f47206b0 = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.formatString(R.string.BotMonetizationInfo, 50), -1, 3, new b(gVar, 2), gVar.resourceProvider), true);
                }
                arrayList.add(j51.g(gVar.f47206b0));
            }
            if (gVar.f47212f0 == null && j10 != null) {
            ...
            ma1 ma1Var = gVar.f47212f0;
            if (ma1Var != null && !ma1Var.f35754l) {
                arrayList.add(j51.h(5, i16, ma1Var));
                arrayList.add(j51.A(-1, null));
            }
            if (gVar.f47213g0 == null && j10 != null) {
                TL_stats.StatsGraph statsGraph = j10.revenue_graph;
                if (statsGraph != null) {
                    statsGraph.rate = (float) (1.0E7d / j10.usd_rate);
                }
                i10 = 2;
                gVar.f47213g0 = ab1.f0(statsGraph, LocaleController.getString(R.string.BotMonetizationGraphRevenue), 2, false);
            } else {
                i10 = 2;
            }
            ma1 ma1Var2 = gVar.f47213g0;
            if (ma1Var2 != null && !ma1Var2.f35754l) {
                arrayList.add(j51.h(i10, i16, ma1Var2));
                arrayList.add(j51.A(-2, null));
            }
            if (!gVar.f47210e0 && j10 != null && (tL_starsRevenueStatus = j10.status) != null) {
                ...
                ieVar6.e = j12;
                if (gVar.f47218l0 == null) {
                    DecimalFormatSymbols decimalFormatSymbols = new DecimalFormatSymbols(Locale.US);
                    decimalFormatSymbols.setDecimalSeparator('.');
                    d = d11;
                    DecimalFormat decimalFormat = new DecimalFormat("#.##", decimalFormatSymbols);
                    gVar.f47218l0 = decimalFormat;
                    decimalFormat.setMinimumFractionDigits(2);
                    i12 = 6;
                    gVar.f47218l0.setMaximumFractionDigits(6);
                    gVar.f47218l0.setGroupingUsed(false);
                } else {
                    d = d11;
                    i12 = 6;
                }
                DecimalFormat decimalFormat2 = gVar.f47218l0;
                if (d12 > 1.5d) {
                    i12 = 2;
                }
                decimalFormat2.setMaximumFractionDigits(i12);
                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(le.f0("TON " + gVar.f47218l0.format(d12), gVar.W.getPaint(), 0.9f, 0.0f, true));
            ...
            if (gVar.f47210e0) {
                ...
                if (gVar.f47208c0 == null) {
                    gVar.f47208c0 = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.BotMonetizationProceedsTONInfo), -1, 3, new qg.v(gVar, R.string.BotMonetizationProceedsTONInfoLink, 4), gVar.resourceProvider), true);
                }
                arrayList.add(j51.A(-4, gVar.f47208c0));
            }
            arrayList.add(j51.b(LocaleController.getString(R.string.BotMonetizationBalance)));
            arrayList.add(j51.k(gVar.U));
            if (gVar.f47209d0 == null) {
                ...
                gVar.f47209d0 = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(i11), -1, 3, new b(gVar, 3)), true);
            }
            arrayList.add(j51.A(-5, gVar.f47209d0));
            if (!gVar.f47215i0 || !arrayList2.isEmpty()) {
    ...
    public static void Z(g gVar, TLRPC.TL_error tL_error, TwoStepVerificationActivity twoStepVerificationActivity, Activity activity, boolean z10, long j3, TLObject tLObject) {
        ...
        if (tL_error != null) {
            ...
            alertDialog$Builder.f18447a.R = LocaleController.getString(R.string.EditAdminTransferAlertTitle);
    ...
    public static void a0(g gVar, TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tLObject instanceof TL_stars.StarsStatus) {
            ...
            gVar.f47217k0 = starsStatus.next_offset;
            gVar.f47216j0.addAll(starsStatus.history);
    ...
    public static void e0(g gVar) {
        int i10;
        if (!gVar.f47214h0 && !gVar.f47215i0 && gVar.f47217k0 != null) {
            gVar.f47214h0 = true;
            TL_stars.TL_payments_getStarsTransactions tL_payments_getStarsTransactions = new TL_stars.TL_payments_getStarsTransactions();
            tL_payments_getStarsTransactions.ton = true;
            tL_payments_getStarsTransactions.peer = MessagesController.getInstance(gVar.currentAccount).getInputPeer(gVar.f47205b);
            tL_payments_getStarsTransactions.offset = gVar.f47217k0;
            if (gVar.f47216j0.isEmpty()) {
                i10 = 5;
            } else {
                i10 = 20;
            }
    ...
    public final View createView(Context context) {
        ...
        TLRPC.User user = getMessagesController().getUser(Long.valueOf(this.f47205b));
        this.d.k(user, true);
        ...
        this.F = new x7(context, this.currentAccount, false, this.f47205b, getClassGuid(), getResourceProvider());
        ...
        this.Q.setHighlightColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19184uf));
        this.Q.setHandlesColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19201vf));
        fi.o oVar2 = this.Q;
        if (LocaleController.isRTL) {
            i10 = 5;
        } else {
                    ...
                    default:
                        if (view.isEnabled()) {
                            ...
                            if (!gVar.Y.N) {
                                ...
                                twoStepVerificationActivity.Z = 1;
                                twoStepVerificationActivity.f31608b0 = dVar4;
                                gVar.Y.setLoading(true);
                                twoStepVerificationActivity.s0(new c(gVar, twoStepVerificationActivity, 0));
                                return;
                            }
        ...
        this.e = f61Var;
        f61Var.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f18807a7));
        this.e.q1();
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.botStarsUpdated && ((Long) objArr[0]).longValue() == this.f47205b) {
            g0();
        }
    }
    ...
    public final void g0() {
        ...
        ArrayList arrayList;
        TLRPC.TL_starsRevenueStatus tL_starsRevenueStatus;
        TLRPC.TL_payments_starsRevenueStats h = o.g(this.currentAccount).h(this.f47205b, false);
        ...
        if (h != null) {
            ...
            this.f47219n = f02;
            if (f02 != null && (bVar = f02.d) != null && (arrayList = bVar.d) != null && !arrayList.isEmpty() && this.f47219n.d.d.get(0) != null) {
                ma1 ma1Var = this.f47219n;
                ma1Var.h = true;
                ((jg.a) ma1Var.d.d.get(0)).f12999g = org.telegram.ui.ActionBar.j6.yj;
                this.f47219n.d.h = (float) ((1.0d / this.Z) / 100.0d);
            }
    ...
    public final boolean isLightStatusBar() {
        if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18863d6, false)) <= 0.721f) {
            return false;
        }
        return true;
    }
    ...
    public final void k0() {
        ...
        if (qVar.W && !qVar.N) {
            ...
            if (this.G > currentTime) {
                this.f47204a0 = vc.a0(this).Q(R.raw.timer_3, 36, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.BotStarsWithdrawalToast, j0(this.G - currentTime)))).j();
                ...
                twoStepVerificationActivity.Z = 1;
                twoStepVerificationActivity.f31608b0 = t9Var;
