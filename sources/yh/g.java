...
public final class g extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public CharSequence f47178b0;
    public final boolean f47179c;
    public CharSequence f47180c0;
    public eo d;
    public CharSequence f47181d0;
    public e61 e;
    public boolean f47182e0;
    public TLRPC.TL_payments_starsRevenueStats f47183f;
    public ka1 f47184f0;
    public ka1 f47185g0;
    public TLRPC.TL_starsRevenueStatus h;
    public boolean f47186h0;
    public boolean f47187i0;
    public final ArrayList f47188j0;
    public String f47189k0;
    public DecimalFormat f47190l0;
    public SpannableStringBuilder m0;
    public ka1 f47191n;
    public final b f47192n0;
    public final int f47193o0;
    public final ge f47194r;
    public final ge f47195s;
    public final ge v;
    public final ge f47196w;
    public final ge f47197x;
    public final ge f47198y;

    public g(int i10, long j3) {
        super(null);
        boolean z10;
        String string;
        this.f47194r = ge.a("XTR", LocaleController.getString(R.string.BotStarsOverviewAvailableBalance));
        this.f47195s = ge.a("XTR", LocaleController.getString(R.string.BotStarsOverviewTotalBalance));
        this.v = ge.a("XTR", LocaleController.getString(R.string.BotStarsOverviewTotalProceeds));
        this.f47196w = ge.a("TON", LocaleController.getString(R.string.BotMonetizationOverviewAvailable));
        this.f47197x = ge.a("TON", LocaleController.getString(R.string.BotMonetizationOverviewLastWithdrawal));
        this.f47198y = ge.a("TON", LocaleController.getString(R.string.BotMonetizationOverviewTotal));
        boolean z11 = false;
        this.N = false;
        this.O = true;
        this.T = new oq[1];
        this.f47186h0 = false;
        this.f47187i0 = false;
        this.f47188j0 = new ArrayList();
        this.f47189k0 = "";
        this.f47192n0 = new b(this, 0);
        this.f47193o0 = -1;
        this.f47175a = i10;
        this.f47177b = j3;
    ...
    public static void U(g gVar) {
        ...
        oc.e();
        TLRPC.TL_payments_starsRevenueStats h = o.g(gVar.currentAccount).h(gVar.f47177b, false);
        if (h == null) {
            j3 = 0;
        } else {
    ...
    public static void W(g gVar, i51 i51Var) {
        if (i51Var.G(r7.class)) {
            y7.h1(gVar.getParentActivity(), true, gVar.f47177b, gVar.currentAccount, (TL_stars.StarsTransaction) i51Var.G, gVar.getResourceProvider());
        } else if (i51Var.G instanceof TL_stats.BroadcastRevenueTransaction) {
            je.h0(gVar.getParentActivity(), gVar.currentAccount, (TL_stats.BroadcastRevenueTransaction) i51Var.G, gVar.f47177b, gVar.resourceProvider);
        } else if (i51Var.d == 2) {
            gVar.presentFragment(new ei.e4(gVar.f47177b));
        }
    }
    ...
    public static void X(g gVar, Context context, View view) {
        if (view.isEnabled()) {
            ...
            if (!dVar.N) {
                ...
                tL_payments_getStarsRevenueAdsAccountUrl.peer = MessagesController.getInstance(gVar.currentAccount).getInputPeer(gVar.f47177b);
    ...
    public static void Y(g gVar, ArrayList arrayList) {
        ...
        int i15;
        ge geVar = gVar.f47197x;
        ArrayList arrayList2 = gVar.f47188j0;
        ge geVar2 = gVar.f47198y;
        ge geVar3 = gVar.v;
        ge geVar4 = gVar.f47195s;
        ge geVar5 = gVar.f47194r;
        long j3 = gVar.f47177b;
        ge geVar6 = gVar.f47196w;
        boolean z10 = gVar.f47179c;
        int i16 = gVar.f47193o0;
        o g10 = o.g(gVar.currentAccount);
        int i17 = gVar.f47175a;
        if (i17 == 0) {
            arrayList.add(i51.h(2, i16, gVar.f47191n));
            ...
            if (h != null && (tL_starsRevenueStatus2 = h.status) != null) {
                geVar5.f33869a = false;
                geVar5.f33873g = true;
                TL_stars.StarsAmount starsAmount = tL_starsRevenueStatus2.available_balance;
                geVar5.f33874i = starsAmount;
                geVar5.h = "XTR";
                geVar5.f33872f = "USD";
                double d10 = gVar.Z;
                geVar5.f33875j = (long) (starsAmount.amount * d10 * 100.0d);
                geVar4.f33869a = false;
                geVar4.f33873g = true;
                TL_stars.StarsAmount starsAmount2 = tL_starsRevenueStatus2.current_balance;
                geVar4.f33874i = starsAmount2;
                geVar4.h = "XTR";
                geVar4.f33875j = (long) (starsAmount2.amount * d10 * 100.0d);
                geVar4.f33872f = "USD";
                geVar3.f33869a = false;
                geVar3.f33873g = true;
                TL_stars.StarsAmount starsAmount3 = tL_starsRevenueStatus2.overall_revenue;
                geVar3.f33874i = starsAmount3;
                geVar3.h = "XTR";
                geVar3.f33875j = (long) (starsAmount3.amount * d10 * 100.0d);
                geVar3.f33872f = "USD";
            ...
            if (!z10) {
                if (gVar.f47178b0 == null) {
                    gVar.f47178b0 = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.formatString(R.string.BotMonetizationInfo, 50), -1, 3, new b(gVar, 2), gVar.resourceProvider), true);
                }
                arrayList.add(i51.g(gVar.f47178b0));
            }
            if (gVar.f47184f0 == null && j10 != null) {
                ka1 f02 = ya1.f0(j10.top_hours_graph, LocaleController.getString(R.string.BotMonetizationGraphImpressions), 0, false);
                gVar.f47184f0 = f02;
                if (f02 != null) {
                    f02.f35103n = true;
                }
            }
            ka1 ka1Var = gVar.f47184f0;
            if (ka1Var != null && !ka1Var.f35101l) {
                arrayList.add(i51.h(5, i16, ka1Var));
                arrayList.add(i51.A(-1, null));
            }
            if (gVar.f47185g0 == null && j10 != null) {
                TL_stats.StatsGraph statsGraph = j10.revenue_graph;
                if (statsGraph != null) {
                    statsGraph.rate = (float) (1.0E7d / j10.usd_rate);
                }
                i10 = 2;
                gVar.f47185g0 = ya1.f0(statsGraph, LocaleController.getString(R.string.BotMonetizationGraphRevenue), 2, false);
            } else {
                i10 = 2;
            }
            ka1 ka1Var2 = gVar.f47185g0;
            if (ka1Var2 != null && !ka1Var2.f35101l) {
                arrayList.add(i51.h(i10, i16, ka1Var2));
                arrayList.add(i51.A(-2, null));
            }
            if (!gVar.f47182e0 && j10 != null && (tL_starsRevenueStatus = j10.status) != null) {
                ...
                geVar6.e = j12;
                if (gVar.f47190l0 == null) {
                    DecimalFormatSymbols decimalFormatSymbols = new DecimalFormatSymbols(Locale.US);
                    decimalFormatSymbols.setDecimalSeparator('.');
                    d = d11;
                    DecimalFormat decimalFormat = new DecimalFormat("#.##", decimalFormatSymbols);
                    gVar.f47190l0 = decimalFormat;
                    decimalFormat.setMinimumFractionDigits(2);
                    i12 = 6;
                    gVar.f47190l0.setMaximumFractionDigits(6);
                    gVar.f47190l0.setGroupingUsed(false);
                } else {
                    d = d11;
                    i12 = 6;
                }
                DecimalFormat decimalFormat2 = gVar.f47190l0;
                if (d12 > 1.5d) {
                    i12 = 2;
                }
                decimalFormat2.setMaximumFractionDigits(i12);
                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(je.f0("TON " + gVar.f47190l0.format(d12), gVar.W.getPaint(), 0.9f, 0.0f, true));
            ...
            if (gVar.f47182e0) {
                ...
                if (gVar.f47180c0 == null) {
                    gVar.f47180c0 = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.BotMonetizationProceedsTONInfo), -1, 3, new qg.v(gVar, R.string.BotMonetizationProceedsTONInfoLink, 4), gVar.resourceProvider), true);
                }
                arrayList.add(i51.A(-4, gVar.f47180c0));
            }
            arrayList.add(i51.b(LocaleController.getString(R.string.BotMonetizationBalance)));
            arrayList.add(i51.k(gVar.U));
            if (gVar.f47181d0 == null) {
                ...
                gVar.f47181d0 = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(i11), -1, 3, new b(gVar, 3)), true);
            }
            arrayList.add(i51.A(-5, gVar.f47181d0));
            if (!gVar.f47187i0 || !arrayList2.isEmpty()) {
    ...
    public static void a0(g gVar, TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tLObject instanceof TL_stars.StarsStatus) {
            ...
            gVar.f47189k0 = starsStatus.next_offset;
            gVar.f47188j0.addAll(starsStatus.history);
    ...
    public static void e0(g gVar) {
        int i10;
        if (!gVar.f47186h0 && !gVar.f47187i0 && gVar.f47189k0 != null) {
            gVar.f47186h0 = true;
            TL_stars.TL_payments_getStarsTransactions tL_payments_getStarsTransactions = new TL_stars.TL_payments_getStarsTransactions();
            tL_payments_getStarsTransactions.ton = true;
            tL_payments_getStarsTransactions.peer = MessagesController.getInstance(gVar.currentAccount).getInputPeer(gVar.f47177b);
            tL_payments_getStarsTransactions.offset = gVar.f47189k0;
            if (gVar.f47188j0.isEmpty()) {
                i10 = 5;
            } else {
                i10 = 20;
            }
    ...
    public final View createView(Context context) {
        ...
        TLRPC.User user = getMessagesController().getUser(Long.valueOf(this.f47177b));
        this.d.k(user, true);
        ...
        this.F = new x7(context, this.currentAccount, false, this.f47177b, getClassGuid(), getResourceProvider());
        ...
        this.Q.setHighlightColor(getThemedColor(org.telegram.ui.ActionBar.i6.f19157uf));
        this.Q.setHandlesColor(getThemedColor(org.telegram.ui.ActionBar.i6.f19174vf));
        fi.o oVar2 = this.Q;
        if (LocaleController.isRTL) {
            i10 = 5;
        } else {
                    ...
                    default:
                        if (view.isEnabled()) {
                            ...
                            if (!gVar.Y.N) {
                                ...
                                twoStepVerificationActivity.Z = 1;
                                twoStepVerificationActivity.f31591b0 = dVar4;
                                gVar.Y.setLoading(true);
                                twoStepVerificationActivity.s0(new c(gVar, twoStepVerificationActivity, 0));
                                return;
                            }
        ...
        this.e = e61Var;
        e61Var.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.i6.f18780a7));
        this.e.p1();
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.botStarsUpdated && ((Long) objArr[0]).longValue() == this.f47177b) {
            g0();
        }
    }
    ...
    public final void g0() {
        ...
        ArrayList arrayList;
        TLRPC.TL_starsRevenueStatus tL_starsRevenueStatus;
        TLRPC.TL_payments_starsRevenueStats h = o.g(this.currentAccount).h(this.f47177b, false);
        ...
        if (h != null) {
            this.Z = h.usd_rate;
            ka1 f02 = ya1.f0(h.revenue_graph, LocaleController.getString(R.string.BotStarsChartRevenue), 2, false);
            this.f47191n = f02;
            if (f02 != null && (bVar = f02.d) != null && (arrayList = bVar.d) != null && !arrayList.isEmpty() && this.f47191n.d.d.get(0) != null) {
                ka1 ka1Var = this.f47191n;
                ka1Var.h = true;
                ((jg.a) ka1Var.d.d.get(0)).f12996g = org.telegram.ui.ActionBar.i6.yj;
                this.f47191n.d.h = (float) ((1.0d / this.Z) / 100.0d);
            }
    ...
    public final boolean isLightStatusBar() {
        if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.i6.w0(null, org.telegram.ui.ActionBar.i6.f18836d6, false)) <= 0.721f) {
            return false;
        }
        return true;
    }
    ...
    public final void k0() {
        ...
        if (qVar.W && !qVar.N) {
            ...
            if (this.G > currentTime) {
                this.f47176a0 = vc.a0(this).Q(R.raw.timer_3, 36, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.BotStarsWithdrawalToast, j0(this.G - currentTime)))).j();
                ...
                twoStepVerificationActivity.Z = 1;
                twoStepVerificationActivity.f31591b0 = t9Var;
