...
public final class g extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public CharSequence f47386b0;
    public final boolean f47387c;
    public CharSequence f47388c0;
    public eo d;
    public CharSequence f47389d0;
    public t61 e;
    public boolean f47390e0;
    public TLRPC.TL_payments_starsRevenueStats f47391f;
    public la1 f47392f0;
    public la1 f47393g0;
    public TLRPC.TL_starsRevenueStatus h;
    public boolean f47394h0;
    public boolean f47395i0;
    public final ArrayList f47396j0;
    public String f47397k0;
    public DecimalFormat f47398l0;
    public SpannableStringBuilder m0;
    public la1 f47399n;
    public final b f47400n0;
    public final int f47401o0;
    public final he f47402r;
    public final he f47403s;
    public final he v;
    public final he f47404w;
    public final he f47405x;
    public final he f47406y;

    public g(int i10, long j3) {
        super(null);
        boolean z10;
        String string;
        this.f47402r = he.a("XTR", LocaleController.getString(R.string.BotStarsOverviewAvailableBalance));
        this.f47403s = he.a("XTR", LocaleController.getString(R.string.BotStarsOverviewTotalBalance));
        this.v = he.a("XTR", LocaleController.getString(R.string.BotStarsOverviewTotalProceeds));
        this.f47404w = he.a("TON", LocaleController.getString(R.string.BotMonetizationOverviewAvailable));
        this.f47405x = he.a("TON", LocaleController.getString(R.string.BotMonetizationOverviewLastWithdrawal));
        this.f47406y = he.a("TON", LocaleController.getString(R.string.BotMonetizationOverviewTotal));
        boolean z11 = false;
        this.N = false;
        this.O = true;
        this.T = new oq[1];
        this.f47394h0 = false;
        this.f47395i0 = false;
        this.f47396j0 = new ArrayList();
        this.f47397k0 = "";
        this.f47400n0 = new b(this, 0);
        this.f47401o0 = -1;
        this.f47383a = i10;
        this.f47385b = j3;
    ...
    public static void U(g gVar) {
        long j3;
        b bVar = gVar.f47400n0;
        qc.e();
        TLRPC.TL_payments_starsRevenueStats h = o.g(gVar.currentAccount).h(gVar.f47385b, false);
        if (h == null) {
            j3 = 0;
        } else {
    ...
    public static void W(g gVar, x51 x51Var) {
        if (x51Var.G(o7.class)) {
            v7.h1(gVar.getParentActivity(), true, gVar.f47385b, gVar.currentAccount, (TL_stars.StarsTransaction) x51Var.G, gVar.getResourceProvider());
        } else if (x51Var.G instanceof TL_stats.BroadcastRevenueTransaction) {
            ke.h0(gVar.getParentActivity(), gVar.currentAccount, (TL_stats.BroadcastRevenueTransaction) x51Var.G, gVar.f47385b, gVar.resourceProvider);
        } else if (x51Var.d == 2) {
            gVar.presentFragment(new ei.e4(gVar.f47385b));
        }
    }
    ...
    public static void X(g gVar, Context context, View view) {
        if (view.isEnabled()) {
            ...
            if (!dVar.N) {
                ...
                tL_payments_getStarsRevenueAdsAccountUrl.peer = MessagesController.getInstance(gVar.currentAccount).getInputPeer(gVar.f47385b);
    ...
    public static void Y(g gVar, ArrayList arrayList) {
        ...
        int i15;
        he heVar = gVar.f47405x;
        ArrayList arrayList2 = gVar.f47396j0;
        he heVar2 = gVar.f47406y;
        he heVar3 = gVar.v;
        he heVar4 = gVar.f47403s;
        he heVar5 = gVar.f47402r;
        long j3 = gVar.f47385b;
        he heVar6 = gVar.f47404w;
        boolean z10 = gVar.f47387c;
        int i16 = gVar.f47401o0;
        o g10 = o.g(gVar.currentAccount);
        int i17 = gVar.f47383a;
        if (i17 == 0) {
            arrayList.add(x51.h(2, i16, gVar.f47399n));
            ...
            if (h != null && (tL_starsRevenueStatus2 = h.status) != null) {
                heVar5.f34127a = false;
                heVar5.f34131g = true;
                TL_stars.StarsAmount starsAmount = tL_starsRevenueStatus2.available_balance;
                heVar5.f34132i = starsAmount;
                heVar5.h = "XTR";
                heVar5.f34130f = "USD";
                double d = gVar.Z;
                heVar5.f34133j = (long) (starsAmount.amount * d * 100.0d);
                heVar4.f34127a = false;
                heVar4.f34131g = true;
                TL_stars.StarsAmount starsAmount2 = tL_starsRevenueStatus2.current_balance;
                heVar4.f34132i = starsAmount2;
                heVar4.h = "XTR";
                heVar4.f34133j = (long) (starsAmount2.amount * d * 100.0d);
                heVar4.f34130f = "USD";
                heVar3.f34127a = false;
                heVar3.f34131g = true;
                TL_stars.StarsAmount starsAmount3 = tL_starsRevenueStatus2.overall_revenue;
                heVar3.f34132i = starsAmount3;
                heVar3.h = "XTR";
                heVar3.f34133j = (long) (starsAmount3.amount * d * 100.0d);
                heVar3.f34130f = "USD";
            ...
            arrayList.add(x51.A(-2, LocaleController.getString(i14)));
            ...
            if (!z10) {
                if (gVar.f47386b0 == null) {
                    gVar.f47386b0 = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.formatString(R.string.BotMonetizationInfo, 50), -1, 3, new b(gVar, 2), gVar.resourceProvider), true);
                }
                arrayList.add(x51.g(gVar.f47386b0));
            }
            if (gVar.f47392f0 == null && j10 != null) {
            ...
            la1 la1Var = gVar.f47392f0;
            if (la1Var != null && !la1Var.f35330l) {
                arrayList.add(x51.h(5, i16, la1Var));
                arrayList.add(x51.A(-1, null));
            }
            if (gVar.f47393g0 == null && j10 != null) {
                TL_stats.StatsGraph statsGraph = j10.revenue_graph;
                if (statsGraph != null) {
                    statsGraph.rate = (float) (1.0E7d / j10.usd_rate);
                }
                i10 = 2;
                gVar.f47393g0 = za1.f0(statsGraph, LocaleController.getString(R.string.BotMonetizationGraphRevenue), 2, false);
            } else {
                i10 = 2;
            }
            la1 la1Var2 = gVar.f47393g0;
            if (la1Var2 != null && !la1Var2.f35330l) {
                arrayList.add(x51.h(i10, i16, la1Var2));
                arrayList.add(x51.A(-2, null));
            }
            if (!gVar.f47390e0 && j10 != null && (tL_starsRevenueStatus = j10.status) != null) {
                ...
                heVar6.e = j12;
                if (gVar.f47398l0 == null) {
                    DecimalFormatSymbols decimalFormatSymbols = new DecimalFormatSymbols(Locale.US);
                    decimalFormatSymbols.setDecimalSeparator('.');
                    DecimalFormat decimalFormat = new DecimalFormat("#.##", decimalFormatSymbols);
                    gVar.f47398l0 = decimalFormat;
                    decimalFormat.setMinimumFractionDigits(2);
                    gVar.f47398l0.setMaximumFractionDigits(6);
                    gVar.f47398l0.setGroupingUsed(false);
                }
                DecimalFormat decimalFormat2 = gVar.f47398l0;
                if (d11 > 1.5d) {
                    i12 = 2;
                } else {
                    i12 = 6;
                ...
                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(ke.f0("TON " + gVar.f47398l0.format(d11), gVar.W.getPaint(), 0.9f, 0.0f, true));
                ...
                heVar.d = j13;
                heVar.e = (long) ((j13 / 1.0E9d) * d10 * 100.0d);
                heVar.f34130f = "USD";
                heVar2.f34127a = true;
                long j14 = tL_starsRevenueStatus3.overall_revenue.amount;
                heVar2.d = j14;
                heVar2.e = (long) ((j14 / 1.0E9d) * d10 * 100.0d);
                heVar2.f34130f = "USD";
                gVar.f47390e0 = true;
                ci.d dVar = gVar.Y;
            ...
            if (gVar.f47390e0) {
                ...
                if (gVar.f47388c0 == null) {
                    gVar.f47388c0 = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.BotMonetizationProceedsTONInfo), -1, 3, new ai1(gVar, R.string.BotMonetizationProceedsTONInfoLink, 6), gVar.resourceProvider), true);
                }
                arrayList.add(x51.A(-4, gVar.f47388c0));
            }
            arrayList.add(x51.b(LocaleController.getString(R.string.BotMonetizationBalance)));
            arrayList.add(x51.k(gVar.U));
            if (gVar.f47389d0 == null) {
                ...
                gVar.f47389d0 = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(i11), -1, 3, new b(gVar, 3)), true);
            }
            arrayList.add(x51.A(-5, gVar.f47389d0));
            if (!gVar.f47395i0 || !arrayList2.isEmpty()) {
    ...
    public static void a0(g gVar, TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tLObject instanceof TL_stars.StarsStatus) {
            ...
            gVar.f47397k0 = starsStatus.next_offset;
            gVar.f47396j0.addAll(starsStatus.history);
    ...
    public static void e0(g gVar) {
        int i10;
        if (!gVar.f47394h0 && !gVar.f47395i0 && gVar.f47397k0 != null) {
            gVar.f47394h0 = true;
            TL_stars.TL_payments_getStarsTransactions tL_payments_getStarsTransactions = new TL_stars.TL_payments_getStarsTransactions();
            tL_payments_getStarsTransactions.ton = true;
            tL_payments_getStarsTransactions.peer = MessagesController.getInstance(gVar.currentAccount).getInputPeer(gVar.f47385b);
            tL_payments_getStarsTransactions.offset = gVar.f47397k0;
            if (gVar.f47396j0.isEmpty()) {
                i10 = 5;
            } else {
                i10 = 20;
            }
    ...
    public final View createView(Context context) {
        ...
        TLRPC.User user = getMessagesController().getUser(Long.valueOf(this.f47385b));
        this.d.k(user, true);
        ...
        this.F = new u7(context, this.currentAccount, false, this.f47385b, getClassGuid(), getResourceProvider());
        ...
        p6Var2.setTextColor(org.telegram.ui.ActionBar.j6.v0(i14, getResourceProvider()));
        ...
        p6Var4.setTextColor(org.telegram.ui.ActionBar.j6.v0(i15, getResourceProvider()));
        ...
        this.Q.setHighlightColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19384uf));
        this.Q.setHandlesColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19401vf));
        fi.o oVar2 = this.Q;
        if (LocaleController.isRTL) {
            i10 = 5;
        } else {
        ...
        this.e = t61Var;
        t61Var.setBackgroundColor(getThemedColor(org.telegram.ui.ActionBar.j6.f19006a7));
        this.e.q1();
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.botStarsUpdated && ((Long) objArr[0]).longValue() == this.f47385b) {
            g0();
        }
    }
    ...
    public final void g0() {
        ...
        ArrayList arrayList;
        TLRPC.TL_starsRevenueStatus tL_starsRevenueStatus;
        TLRPC.TL_payments_starsRevenueStats h = o.g(this.currentAccount).h(this.f47385b, false);
        ...
        if (h != null) {
            ...
            this.f47399n = f02;
            if (f02 != null && (bVar = f02.d) != null && (arrayList = bVar.d) != null && !arrayList.isEmpty() && this.f47399n.d.d.get(0) != null) {
                la1 la1Var = this.f47399n;
                la1Var.h = true;
                ((jg.a) la1Var.d.d.get(0)).f12999g = org.telegram.ui.ActionBar.j6.yj;
                this.f47399n.d.h = (float) ((1.0d / this.Z) / 100.0d);
            }
    ...
    public final boolean isLightStatusBar() {
        if (AndroidUtilities.computePerceivedBrightness(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19062d6, false)) <= 0.721f) {
            return false;
        }
        return true;
    }
    ...
    public final void k0() {
        ...
        if (qVar.W && !qVar.N) {
            ...
            if (this.G > currentTime) {
                this.f47384a0 = xc.a0(this).Q(R.raw.timer_3, 36, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.BotStarsWithdrawalToast, j0(this.G - currentTime)))).j();
                ...
                twoStepVerificationActivity.Z = 1;
                twoStepVerificationActivity.f31835b0 = t9Var;
