...
public final class t4 implements Runnable {
    public final int f47756a = 1;
    public final u5 f47757b;
    public final TLObject f47758c;
    ...
    public final String f47761r;
    public final long f47762s;
    public final TLObject v;
    public final TLObject f47763w;

    public t4(u5 u5Var, TLObject tLObject, TLRPC.TL_error tL_error, Utilities.Callback2 callback2, Context context, org.telegram.ui.ActionBar.e6 e6Var, long j3, String str, long j10, TLObject tLObject2, TLRPC.TL_textWithEntities tL_textWithEntities) {
        this.f47757b = u5Var;
        this.f47758c = tLObject;
        this.d = tL_error;
        this.e = callback2;
        ...
        this.f47762s = j10;
        this.v = tLObject2;
        this.f47763w = tL_textWithEntities;
    }
            ...
            case 0:
                ...
                if (!(tLObject instanceof TLRPC.TL_payments_paymentResult)) {
                    if (tL_error != null && "BALANCE_TOO_LOW".equals(tL_error.text)) {
                        if (!MessagesController.getInstance(u5Var.f47801a).starsPurchaseAvailable()) {
                            callback2.run(Boolean.FALSE, null);
                            u5.e0(context, e6Var);
                            return;
                        }
                        boolean[] zArr = {false};
                        m7 m7Var = new m7(context, e6Var, j3, 6, str3, new ga(u5Var, zArr, tL_payments_paymentFormStarGift, starGift, j10, callback2), 0L);
                ...
                if (BirthdayController.getInstance(u5Var.f47801a).contains(j10)) {
                    SharedPreferences.Editor edit = MessagesController.getInstance(u5Var.f47801a).getMainSettings().edit();
                    edit.putBoolean(Calendar.getInstance().get(1) + "bdayhint_" + j10, false).apply();
                }
                SharedPreferences.Editor edit2 = MessagesController.getInstance(u5Var.f47801a).getMainSettings().edit();
                ...
                return;
            default:
                u5 u5Var2 = this.f47757b;
                TLObject tLObject2 = this.f47758c;
                TLRPC.TL_error tL_error2 = this.d;
                Utilities.Callback2 callback22 = this.e;
                Context context2 = this.f47759f;
                org.telegram.ui.ActionBar.e6 e6Var2 = this.h;
                long j11 = this.f47760n;
                String str4 = this.f47761r;
                long j12 = this.f47762s;
                TLObject tLObject3 = this.v;
                TLRPC.TL_textWithEntities tL_textWithEntities = (TLRPC.TL_textWithEntities) this.f47763w;
                ...
                if (!(tLObject2 instanceof TLRPC.TL_payments_paymentResult)) {
                    if (tL_error2 != null && "BALANCE_TOO_LOW".equals(tL_error2.text)) {
                        ...
                        boolean[] zArr2 = {false};
                        m7 m7Var2 = new m7(context2, e6Var2, j11, 6, str4, new ga(u5Var2, zArr2, j12, tLObject3, tL_textWithEntities, callback22), 0L);
                ...
                if (BirthdayController.getInstance(u5Var2.f47801a).contains(j12)) {
                    SharedPreferences.Editor edit3 = MessagesController.getInstance(u5Var2.f47801a).getMainSettings().edit();
                    edit3.putBoolean(Calendar.getInstance().get(1) + "bdayhint_" + j12, false).apply();
                }
                SharedPreferences.Editor edit4 = MessagesController.getInstance(u5Var2.f47801a).getMainSettings().edit();
                ...
                if (launchActivity2 != null && (gb0Var2 = launchActivity2.f30855x0) != null) {
                    gb0Var2.c(true);
                    return;
                }
                return;
    ...
    public t4(u5 u5Var, TLObject tLObject, TLRPC.TL_error tL_error, Utilities.Callback2 callback2, Context context, org.telegram.ui.ActionBar.e6 e6Var, long j3, String str, TLRPC.TL_payments_paymentFormStarGift tL_payments_paymentFormStarGift, TL_stars.StarGift starGift, long j10) {
        this.f47757b = u5Var;
        this.f47758c = tLObject;
        this.d = tL_error;
        this.e = callback2;
