...
public final class v extends bb implements GiftAuctionController.OnAuctionUpdateListener {
    public static final ad[] f50588p0 = new ad[1];
    public static final nz0[] f50589q0 = new nz0[1];
    public final TL_stars.StarGift X;
    public final long Y;
    public final LinearLayout Z;
    public final FrameLayout f50590a0;
    public final TextView f50591b0;
    public final ad f50592c0;
    public final ad f50593d0;
    public final ad f50594e0;
    public final ad f50595f0;
    public final nz0 f50596g0;
    public final org.telegram.tgnet.e f50597h0;
    public final TableRow f50598i0;
    public final di.d f50599j0;
    public final d90 f50600k0;
    public final d90 f50601l0;
    public GiftAuctionController.Auction m0;
    public final CharSequence f50602n0;
    public v51 f50603o0;
    ...
    public v(Context context, f6 f6Var, long j3, TL_stars.StarGift starGift, Runnable runnable) {
        ...
        c10.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        new sg.a1(this.f50510b.getContext(), 40, (f6) null).show();
                        return;
                    default:
                        this.f50510b.T();
                        return;
        ...
        if (starGift.sticker != null) {
            ...
            this.f50602n0 = spannableStringBuilder;
        } else {
            this.f50602n0 = "";
        }
        ...
        if (auction2 != null && auction2.previewAttributes != null) {
            ...
            this.f50590a0.addView(tVar, 0, x5.e(-1, 288, 48));
            TextView textView2 = new TextView(context);
            this.f50591b0 = textView2;
            ...
            TextView f7 = p6.f(this.f50590a0, textView2, x5.d(-2, 26.0f, 81, 16.0f, 0.0f, 16.0f, 77.0f), context);
            f7.setTypeface(AndroidUtilities.bold());
            f7.setTextSize(1, 21.0f);
            f7.setText(str2);
            f7.setGravity(17);
            f7.setTextColor(-1);
            TextView f10 = p6.f(this.f50590a0, f7, x5.d(-1, -2.0f, 87, 16.0f, 0.0f, 16.0f, 40.0f), context);
            ...
            z5.b(f10, 0.02f, 1.5f);
            this.f50590a0.addView(f10, x5.d(-1, -2.0f, 87, 16.0f, 0.0f, 16.0f, 12.0f));
            h1Var.setVisibility(8);
            textView.setVisibility(8);
            this.f50600k0.setVisibility(8);
        ...
        this.Z.addView(this.f50601l0, x5.k(16.0f, 0.0f, 14.0f, 18.0f, -1, -2));
        V(false);
    }
    ...
    public static void U(Context context, TL_stars.StarGift starGift, f6 f6Var) {
        ...
        if (context != null && starGift != null) {
            ...
            uw0Var.f41225a.l(LocaleController.formatPluralString("GiftAuctionInfo1Header", i12, Integer.valueOf(i12)), false);
            int i13 = starGift.gifts_per_round;
            uw0Var.f41226b.setText(LocaleController.formatPluralString("GiftAuctionInfo1Text", i13, Integer.valueOf(i13)));
            uw0Var.d.setVisibility(8);
            int i14 = R.drawable.menu_top_bidders_24;
            ImageView imageView2 = uw0Var.f41227c;
            ...
            uw0Var2.f41225a.l(LocaleController.getString(R.string.GiftAuctionInfo2Header), false);
            uw0Var2.f41226b.setText(LocaleController.formatPluralString("GiftAuctionInfo2Text", starGift.gifts_per_round, new Object[0]));
            uw0Var2.d.setVisibility(8);
            int i15 = R.drawable.menu_carryover_24;
            ImageView imageView3 = uw0Var2.f41227c;
            ...
            uw0Var3.f41225a.l(LocaleController.getString(R.string.GiftAuctionInfo3Header), false);
            uw0Var3.f41226b.setText(LocaleController.getString(R.string.GiftAuctionInfo3Text));
            uw0Var3.d.setVisibility(8);
            int i16 = R.drawable.menu_bid_refund_24;
            ImageView imageView4 = uw0Var3.f41227c;
    ...
    public final void T() {
        ...
        if (auction != null && (tL_starGiftAuctionStateFinished = auction.auctionStateFinished) != null && auction.gift.title != null) {
            this.f50597h0.run(this.f50594e0, LocaleController.formatString(R.string.Gift2AveragePriceHint, Long.valueOf(tL_starGiftAuctionStateFinished.average_price), this.m0.gift.title));
        }
    }
