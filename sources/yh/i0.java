...
public final class i0 extends org.telegram.ui.ActionBar.e3 {
    public zf.a E;
    public int F;
    public final kd0 f47492b;
    public final EditTextBoldCursor f47493c;
    public final TextView d;
    public final org.telegram.ui.Components.p6 e;
    public final ci.d f47494f;
    public final org.telegram.ui.Components.p6 h;
    public final x8 f47495n;
    public final ImageView f47496r;
    public final ImageView f47497s;
    public final zf.a v;
    public final zf.a f47498w;
    public final zf.a f47499x;
    public final zf.a f47500y;
    ...
    public i0(Context context, org.telegram.ui.ActionBar.d6 d6Var, int i10, zf.a aVar, p6 p6Var) {
        ...
        this.f47499x = zf.a.i(max, bVar);
        this.f47500y = zf.a.i(appGlobalConfig.tonStarGiftResaleAmountMax.get(), bVar);
        zf.b bVar2 = zf.b.f49226a;
        this.v = zf.a.g(appGlobalConfig.starsStarGiftResaleAmountMin.get(), bVar2);
        this.f47498w = zf.a.g(appGlobalConfig.starsStarGiftResaleAmountMax.get(), bVar2);
        ...
        this.f47493c = editTextBoldCursor;
        ...
        p6Var3.setGravity(5);
        kd0Var.addView(p6Var3, w7.y5.d(-2, -1.0f, 21, 0.0f, 0.0f, 16.0f, 0.0f));
        ...
        if (aVar != null) {
            n(zf.a.i(aVar.f49225b, aVar.f49224a), !aVar.k(), true, false);
        } else {
    ...
    public final zf.a m() {
        if (this.E.f49224a == zf.b.f49227b) {
            return this.f47500y;
        }
        return this.f47498w;
    }
    ...
    public final void n(zf.a aVar, boolean z10, boolean z11, boolean z12) {
        ...
        if (aVar != null) {
            ...
            this.E = zf.a.i(0L, aVar5.f49224a);
            this.F |= 1;
        }
        long j10 = m().f49225b;
        zf.a aVar6 = this.E;
        if (j10 < aVar6.f49225b) {
            this.F |= 4;
        }
        boolean k10 = aVar6.k();
        zf.a aVar7 = this.v;
        zf.a aVar8 = this.f47499x;
        zf.b bVar = zf.b.f49227b;
        if (!k10) {
            zf.a aVar9 = this.E;
            if (aVar9.f49224a == bVar) {
                aVar4 = aVar8;
            } else {
                aVar4 = aVar7;
            }
        ...
        if (!z11 && aVar5.f49224a == this.E.f49224a) {
            z13 = false;
        } else {
            z13 = true;
        }
        if (!z11 && aVar5.f49225b == this.E.f49225b) {
            z14 = false;
        } else {
            z14 = true;
        }
        ...
        zf.b bVar2 = zf.b.f49226a;
        long j11 = j3;
        EditTextBoldCursor editTextBoldCursor = this.f47493c;
        if (z13) {
            c10 = 0;
            zf.b bVar3 = this.E.f49224a;
            ...
            pp ppVar = this.f47495n.f21852c;
            if (this.E.f49224a == bVar) {
                z17 = true;
            } else {
                z17 = false;
            }
            ppVar.a(z17, z12);
            ImageView imageView = this.f47497s;
            ImageView imageView2 = this.f47496r;
            if (z12) {
                ViewPropertyAnimator animate = imageView2.animate();
                if (this.E.f49224a == bVar2) {
                    f13 = 1.0f;
                } else {
                    f13 = 0.0f;
                }
        ...
        if (z13 || z14 || z15) {
            if (this.F == 0 && this.E.f49225b > j11) {
                z16 = true;
            } else {
                z16 = false;
            }
            ci.d dVar = this.f47494f;
            if (dVar.W != z16) {
                dVar.setEnabled(z16);
        ...
        if (z13 || z14) {
            ...
            zf.a aVar10 = this.E;
            zf.b bVar4 = aVar10.f49224a;
            zf.b bVar5 = aVar10.f49224a;
            long j12 = aVar10.f49225b;
