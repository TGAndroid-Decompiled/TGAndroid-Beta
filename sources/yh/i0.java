...
public final class i0 extends org.telegram.ui.ActionBar.f3 {
    public zf.a E;
    public int F;
    public final kd0 f47561b;
    public final EditTextBoldCursor f47562c;
    public final TextView d;
    public final org.telegram.ui.Components.o6 e;
    public final ci.d f47563f;
    public final org.telegram.ui.Components.o6 h;
    public final y8 f47564n;
    public final ImageView f47565r;
    public final ImageView f47566s;
    public final zf.a v;
    public final zf.a f47567w;
    public final zf.a f47568x;
    public final zf.a f47569y;
    ...
    public i0(Context context, org.telegram.ui.ActionBar.f6 f6Var, int i10, zf.a aVar, pj0 pj0Var) {
        ...
        this.f47568x = zf.a.i(max, bVar);
        this.f47569y = zf.a.i(appGlobalConfig.tonStarGiftResaleAmountMax.get(), bVar);
        zf.b bVar2 = zf.b.f49274a;
        this.v = zf.a.g(appGlobalConfig.starsStarGiftResaleAmountMin.get(), bVar2);
        this.f47567w = zf.a.g(appGlobalConfig.starsStarGiftResaleAmountMax.get(), bVar2);
        ...
        this.f47562c = editTextBoldCursor;
        ...
        this.f47564n = y8Var;
        y8Var.f21910c.setLayoutParams(w7.y5.d(20, 20.0f, (LocaleController.isRTL ? 5 : 3) | 48, 22.0f, 22.0f, 22.0f, 0.0f));
        ...
        if (aVar != null) {
            n(zf.a.i(aVar.f49273b, aVar.f49272a), !aVar.k(), true, false);
        } else {
    ...
    public final zf.a m() {
        if (this.E.f49272a == zf.b.f49275b) {
            return this.f47569y;
        }
        return this.f47567w;
    }
    ...
    public final void n(zf.a aVar, boolean z10, boolean z11, boolean z12) {
        ...
        if (aVar != null) {
            ...
            this.E = zf.a.i(0L, aVar5.f49272a);
            this.F |= 1;
        }
        long j10 = m().f49273b;
        zf.a aVar6 = this.E;
        if (j10 < aVar6.f49273b) {
            this.F |= 4;
        }
        boolean k10 = aVar6.k();
        zf.a aVar7 = this.v;
        zf.a aVar8 = this.f47568x;
        zf.b bVar = zf.b.f49275b;
        if (!k10) {
            zf.a aVar9 = this.E;
            if (aVar9.f49272a == bVar) {
                aVar4 = aVar8;
            } else {
                aVar4 = aVar7;
            }
        ...
        if (!z11 && aVar5.f49272a == this.E.f49272a) {
            z13 = false;
        } else {
            z13 = true;
        }
        if (!z11 && aVar5.f49273b == this.E.f49273b) {
            z14 = false;
        } else {
            z14 = true;
        }
        ...
        zf.b bVar2 = zf.b.f49274a;
        long j11 = j3;
        EditTextBoldCursor editTextBoldCursor = this.f47562c;
        if (z13) {
            c10 = 0;
            zf.b bVar3 = this.E.f49272a;
            ...
            np npVar = this.f47564n.f21910c;
            if (this.E.f49272a == bVar) {
                z17 = true;
            } else {
                z17 = false;
            }
            npVar.a(z17, z12);
            ImageView imageView = this.f47566s;
            ImageView imageView2 = this.f47565r;
            if (z12) {
                ViewPropertyAnimator animate = imageView2.animate();
                if (this.E.f49272a == bVar2) {
                    f13 = 1.0f;
                } else {
                    f13 = 0.0f;
                }
        ...
        if (z13 || z15) {
            ...
            if ((i12 & 4) != 0) {
                ...
                objArr[c10] = m().f();
                kd0Var.setText(LocaleController.formatString(i13, objArr));
            } else if ((i12 & 2) != 0) {
                ...
                objArr2[c10] = f20;
                kd0Var.setText(LocaleController.formatString(i14, objArr2));
            } else {
                if (this.E.f49272a == bVar2) {
        ...
        if (z13 || z14 || z15) {
            if (this.F == 0 && this.E.f49273b > j11) {
                z16 = true;
            } else {
                z16 = false;
            }
            ci.d dVar = this.f47563f;
            if (dVar.W != z16) {
                dVar.setEnabled(z16);
        ...
        if (z13 || z14) {
            ...
            zf.a aVar10 = this.E;
            zf.b bVar4 = aVar10.f49272a;
            zf.b bVar5 = aVar10.f49272a;
            long j12 = aVar10.f49273b;
