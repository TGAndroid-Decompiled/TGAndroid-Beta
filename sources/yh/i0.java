...
public final class i0 extends org.telegram.ui.ActionBar.f3 {
    public zf.a E;
    public int F;
    public final yc0 f47187b;
    public final EditTextBoldCursor f47188c;
    public final TextView d;
    public final org.telegram.ui.Components.p6 e;
    public final ci.d f47189f;
    public final org.telegram.ui.Components.p6 h;
    public final y8 f47190n;
    public final ImageView f47191r;
    public final ImageView f47192s;
    public final zf.a v;
    public final zf.a f47193w;
    public final zf.a f47194x;
    public final zf.a f47195y;
    ...
    public i0(Context context, org.telegram.ui.ActionBar.d6 d6Var, int i10, zf.a aVar, p6 p6Var) {
        ...
        this.f47194x = zf.a.i(max, bVar);
        this.f47195y = zf.a.i(appGlobalConfig.tonStarGiftResaleAmountMax.get(), bVar);
        zf.b bVar2 = zf.b.f48898a;
        this.v = zf.a.g(appGlobalConfig.starsStarGiftResaleAmountMin.get(), bVar2);
        this.f47193w = zf.a.g(appGlobalConfig.starsStarGiftResaleAmountMax.get(), bVar2);
        ...
        f10.addView(p6Var2, w7.x5.p(-1, -1, 1.0f, 119, 22, 0, 22, 0));
        ...
        this.f47188c = editTextBoldCursor;
        ...
        this.f47190n = y8Var;
        y8Var.f21641c.setLayoutParams(w7.x5.d(20, 20.0f, (LocaleController.isRTL ? 5 : 3) | 48, 22.0f, 22.0f, 22.0f, 0.0f));
        ...
        if (aVar != null) {
            n(zf.a.i(aVar.f48897b, aVar.f48896a), !aVar.k(), true, false);
        } else {
    ...
    public final zf.a m() {
        if (this.E.f48896a == zf.b.f48899b) {
            return this.f47195y;
        }
        return this.f47193w;
    }
    ...
    public final void n(zf.a aVar, boolean z10, boolean z11, boolean z12) {
        ...
        if (aVar != null) {
            ...
            this.E = zf.a.i(0L, aVar5.f48896a);
            this.F |= 1;
        }
        long j10 = m().f48897b;
        zf.a aVar6 = this.E;
        if (j10 < aVar6.f48897b) {
            this.F |= 4;
        }
        boolean k10 = aVar6.k();
        zf.a aVar7 = this.v;
        zf.a aVar8 = this.f47194x;
        zf.b bVar = zf.b.f48899b;
        if (!k10) {
            zf.a aVar9 = this.E;
            if (aVar9.f48896a == bVar) {
                aVar4 = aVar8;
            } else {
                aVar4 = aVar7;
            }
        ...
        if (!z11 && aVar5.f48896a == this.E.f48896a) {
            z13 = false;
        } else {
            z13 = true;
        }
        if (!z11 && aVar5.f48897b == this.E.f48897b) {
            z14 = false;
        } else {
            z14 = true;
        }
        ...
        zf.b bVar2 = zf.b.f48898a;
        long j11 = j3;
        EditTextBoldCursor editTextBoldCursor = this.f47188c;
        if (z13) {
            c10 = 0;
            zf.b bVar3 = this.E.f48896a;
            ...
            op opVar = this.f47190n.f21641c;
            if (this.E.f48896a == bVar) {
                z17 = true;
            } else {
                z17 = false;
            }
            opVar.a(z17, z12);
            ImageView imageView = this.f47192s;
            ImageView imageView2 = this.f47191r;
            if (z12) {
                ViewPropertyAnimator animate = imageView2.animate();
                if (this.E.f48896a == bVar2) {
                    f13 = 1.0f;
                } else {
                    f13 = 0.0f;
                }
        ...
        if (z13 || z14 || z15) {
            if (this.F == 0 && this.E.f48897b > j11) {
                z16 = true;
            } else {
                z16 = false;
            }
            ci.d dVar = this.f47189f;
            if (dVar.W != z16) {
                dVar.setEnabled(z16);
        ...
        if (z13 || z14) {
            ...
            zf.a aVar10 = this.E;
            zf.b bVar4 = aVar10.f48896a;
            zf.b bVar5 = aVar10.f48896a;
            long j12 = aVar10.f48897b;
