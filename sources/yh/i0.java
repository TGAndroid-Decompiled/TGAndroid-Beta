...
public final class i0 extends org.telegram.ui.ActionBar.f3 {
    public zf.a E;
    public int F;
    public final yc0 f47212b;
    public final EditTextBoldCursor f47213c;
    public final TextView d;
    public final org.telegram.ui.Components.n6 e;
    public final ci.d f47214f;
    public final org.telegram.ui.Components.n6 h;
    public final x8 f47215n;
    public final ImageView f47216r;
    public final ImageView f47217s;
    public final zf.a v;
    public final zf.a f47218w;
    public final zf.a f47219x;
    public final zf.a f47220y;
    ...
    public i0(Context context, org.telegram.ui.ActionBar.e6 e6Var, int i10, zf.a aVar, mj0 mj0Var) {
        ...
        this.f47219x = zf.a.i(max, bVar);
        this.f47220y = zf.a.i(appGlobalConfig.tonStarGiftResaleAmountMax.get(), bVar);
        zf.b bVar2 = zf.b.f48947a;
        this.v = zf.a.g(appGlobalConfig.starsStarGiftResaleAmountMin.get(), bVar2);
        this.f47218w = zf.a.g(appGlobalConfig.starsStarGiftResaleAmountMax.get(), bVar2);
        ...
        this.f47213c = editTextBoldCursor;
        ...
        this.f47215n = x8Var;
        x8Var.f21624c.setLayoutParams(w7.x5.d(20, 20.0f, (LocaleController.isRTL ? 5 : 3) | 48, 22.0f, 22.0f, 22.0f, 0.0f));
        ...
        if (aVar != null) {
            n(zf.a.i(aVar.f48946b, aVar.f48945a), !aVar.k(), true, false);
        } else {
    ...
    public final zf.a m() {
        if (this.E.f48945a == zf.b.f48948b) {
            return this.f47220y;
        }
        return this.f47218w;
    }
    ...
    public final void n(zf.a aVar, boolean z10, boolean z11, boolean z12) {
        ...
        if (aVar != null) {
            ...
            this.E = zf.a.i(0L, aVar5.f48945a);
            this.F |= 1;
        }
        long j10 = m().f48946b;
        zf.a aVar6 = this.E;
        if (j10 < aVar6.f48946b) {
            this.F |= 4;
        }
        boolean k10 = aVar6.k();
        zf.a aVar7 = this.v;
        zf.a aVar8 = this.f47219x;
        zf.b bVar = zf.b.f48948b;
        if (!k10) {
            zf.a aVar9 = this.E;
            if (aVar9.f48945a == bVar) {
                aVar4 = aVar8;
            } else {
                aVar4 = aVar7;
            }
        ...
        if (!z11 && aVar5.f48945a == this.E.f48945a) {
            z13 = false;
        } else {
            z13 = true;
        }
        if (!z11 && aVar5.f48946b == this.E.f48946b) {
            z14 = false;
        } else {
            z14 = true;
        }
        ...
        zf.b bVar2 = zf.b.f48947a;
        long j11 = j3;
        EditTextBoldCursor editTextBoldCursor = this.f47213c;
        if (z13) {
            c10 = 0;
            zf.b bVar3 = this.E.f48945a;
            ...
            np npVar = this.f47215n.f21624c;
            if (this.E.f48945a == bVar) {
                z17 = true;
            } else {
                z17 = false;
            }
            npVar.a(z17, z12);
            ImageView imageView = this.f47217s;
            ImageView imageView2 = this.f47216r;
            if (z12) {
                ViewPropertyAnimator animate = imageView2.animate();
                if (this.E.f48945a == bVar2) {
                    f13 = 1.0f;
                } else {
                    f13 = 0.0f;
                }
        ...
        if (z13 || z14 || z15) {
            if (this.F == 0 && this.E.f48946b > j11) {
                z16 = true;
            } else {
                z16 = false;
            }
            ci.d dVar = this.f47214f;
            if (dVar.W != z16) {
                dVar.setEnabled(z16);
        ...
        if (z13 || z14) {
            ...
            zf.a aVar10 = this.E;
            zf.b bVar4 = aVar10.f48945a;
            zf.b bVar5 = aVar10.f48945a;
            long j12 = aVar10.f48946b;
