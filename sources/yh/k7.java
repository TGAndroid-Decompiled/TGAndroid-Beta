...
public final class k7 extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final o00 f47623c;
    public boolean d;
    public SpannableString e;
    public long f47624f;
    public final pq[] h;
    public final pq[] f47625n;
    public ValueAnimator f47626r;

    public k7(Context context, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f47624f = -1L;
        this.h = new pq[1];
        this.f47625n = new pq[1];
        this.f47622b = i10;
        this.f47621a = UserConfig.getInstance(i10).getClientUserId();
        setOrientation(1);
        setGravity(21);
    ...
    public final void a(boolean z10) {
        ...
        long j3 = 0;
        zf.a i11 = zf.a.i(0L, zf.b.f49228b);
        o00 o00Var = this.f47623c;
        o00Var.a();
        if (this.f47621a == UserConfig.getInstance(i10).getClientUserId()) {
            z12 = !y3.e;
            j3 = y3.p().amount;
            if (s5Var != null) {
                z12 |= !s5Var.e;
            ...
            TLRPC.TL_payments_starsRevenueStats h = o.g(i10).h(this.f47621a, false);
        ...
        long j10 = this.f47624f;
        if (j3 > j10 && j10 != -1) {
            ValueAnimator valueAnimator = this.f47626r;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            ValueAnimator ofFloat = ValueAnimator.ofFloat(0.9f, 1.0f);
            this.f47626r = ofFloat;
            ofFloat.addUpdateListener(new org.telegram.ui.Components.voip.r0(this, 25));
            this.f47626r.addListener(new pg.d0(this, 11));
            this.f47626r.setDuration(320L);
            this.f47626r.setInterpolator(new OvershootInterpolator());
            this.f47626r.start();
        }
        if (z12) {
            if (this.e == null) {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.starBalanceUpdated) {
            a(true);
        } else if (i10 == NotificationCenter.botStarsUpdated && ((Long) objArr[0]).longValue() == this.f47621a) {
            a(true);
        }
    }
