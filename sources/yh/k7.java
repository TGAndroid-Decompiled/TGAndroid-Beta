...
public final class k7 extends FrameLayout {
    public final org.telegram.ui.ActionBar.e6 f47323a;
    public final Drawable f47324b;
    public final Drawable f47325c;
    public final TextView d;
    public final org.telegram.ui.Components.n6 e;
    public SpannableString f47326f;
    public boolean h;
    public int f47327n;
    public final org.telegram.ui.Components.c6 f47328r;

    public k7(Context context, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
        int i10;
        this.f47328r = new org.telegram.ui.Components.c6(this, 0L, 500L, qr.h);
        this.f47323a = e6Var;
        Drawable mutate = context.getResources().getDrawable(R.drawable.star_small_outline).mutate();
        this.f47324b = mutate;
        mutate.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18904h5, e6Var), PorterDuff.Mode.SRC_IN));
        this.f47325c = context.getResources().getDrawable(R.drawable.star_small_inner).mutate();
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int i10;
        super.onDraw(canvas);
        float d = this.f47328r.d(this.f47327n, false);
        if (LocaleController.isRTL) {
            f7 = -1.0f;
        } else {
            f7 = 1.0f;
