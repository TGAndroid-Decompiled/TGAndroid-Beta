...
public final class k7 extends i51 {
    public static final int f47405a = 0;
    ...
    public final void bindView(View view, j51 j51Var, boolean z10, x51 x51Var, f61 f61Var) {
        ...
        l7Var.f47450n = i10;
        if (!equals) {
            l7Var.f47451r.d(i10, true);
        }
        textView.setText(charSequence);
        if (charSequence2 == null) {
            if (l7Var.f47449f == null) {
                SpannableString spannableString = new SpannableString("x");
                l7Var.f47449f = spannableString;
                spannableString.setSpan(new h90(AndroidUtilities.dp(55.0f), n6Var), 0, l7Var.f47449f.length(), 33);
            }
            charSequence2 = l7Var.f47449f;
        }
    ...
    public final boolean contentsEquals(j51 j51Var, j51 j51Var2) {
        if (j51Var.f25140z == j51Var2.f25140z && j51Var.d == j51Var2.d && TextUtils.equals(j51Var.f25128m, j51Var2.f25128m)) {
            return true;
        }
        return false;
    }
