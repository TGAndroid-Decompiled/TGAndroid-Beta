...
public final class k7 extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final s00 f47680c;
    public boolean d;
    public SpannableString e;
    public long f47681f;
    public final oq[] h;
    public final oq[] f47682n;
    ...
    public k7(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f47681f = -1L;
        this.h = new oq[1];
        this.f47682n = new oq[1];
        this.f47679b = i10;
        this.f47678a = UserConfig.getInstance(i10).getClientUserId();
        setOrientation(1);
        setGravity(21);
    ...
    public final void a(boolean z10) {
        ...
        long j3 = 0;
        zf.a i11 = zf.a.i(0L, zf.b.f49275b);
        s00 s00Var = this.f47680c;
        s00Var.a();
        if (this.f47678a == UserConfig.getInstance(i10).getClientUserId()) {
            z12 = !y3.e;
            j3 = y3.p().amount;
            if (u5Var != null) {
                z12 |= !u5Var.e;
            ...
            TLRPC.TL_payments_starsRevenueStats h = o.g(i10).h(this.f47678a, false);
        ...
        long j10 = this.f47681f;
        if (j3 > j10 && j10 != -1) {
            ValueAnimator valueAnimator = this.f47683r;
            ...
            this.f47683r.addListener(new pg.d0(this, 11));
            this.f47683r.setDuration(320L);
            this.f47683r.setInterpolator(new OvershootInterpolator());
            this.f47683r.start();
        }
        if (z12) {
            if (this.e == null) {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.starBalanceUpdated) {
            a(true);
        } else if (i10 == NotificationCenter.botStarsUpdated && ((Long) objArr[0]).longValue() == this.f47678a) {
            a(true);
        }
    }
