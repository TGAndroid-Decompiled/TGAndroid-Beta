...
public final class g1 extends g51 {
    public static final int f50290a = 0;
    ...
    public final void bindView(View view, h51 h51Var, boolean z10, v51 v51Var, d61 d61Var) {
        ...
        if (obj instanceof sg.k) {
            ...
            e1 e1Var = h1Var.f50314e;
            x9 x9Var = h1Var.f50328y;
            TextView textView3 = h1Var.L;
            TextView textView4 = h1Var.M;
            int d = kVar.d();
            if (h1Var.f50319h0 != kVar) {
            ...
            h1Var.f50323n.setVisibility(8);
            h1Var.F.setVisibility(8);
            if (kVar.f46127c == null && kVar.d == null) {
            ...
            h1Var.V = kVar;
            h1Var.W = null;
            h1Var.f50310b0 = false;
            h1Var.f50312c0 = null;
            h1Var.f50313d0 = false;
            h1Var.f50315e0 = false;
            h1Var.f50317f0 = false;
            h1Var.O = null;
            h1Var.P = null;
            h1Var.c(false, false);
            h1Var.j();
            ...
            h1Var.g(starGift, z13, z11, h51Var.f26600q, h51Var.f26601r, h51Var.f26603t);
        } else if (obj instanceof TL_stars.SavedStarGift) {
            z12 = h1Var.h((TL_stars.SavedStarGift) obj, h51Var.f26600q, h51Var.f26601r);
        }
        if (h51Var.f26590f) {
            h1Var.b(h51Var.f26589e, z12);
        }
    ...
    public final boolean equals(h51 h51Var, h51 h51Var2) {
        if (h51Var.f26600q == h51Var2.f26600q) {
            Object obj = h51Var.G;
            if (obj != null || h51Var2.G != null) {
                ...
                if (obj instanceof TL_stars.StarGift) {
                    ...
                    if (obj2 instanceof TL_stars.StarGift) {
                        if (((TL_stars.StarGift) obj).f20096id == ((TL_stars.StarGift) obj2).f20096id) {
                            return true;
                        }
                        return false;
                    }
                ...
                if (obj instanceof TL_stars.SavedStarGift) {
                    ...
                    if (obj3 instanceof TL_stars.SavedStarGift) {
                        ...
                        if (savedStarGift.gift.f20096id == savedStarGift2.gift.f20096id && savedStarGift.date == savedStarGift2.date && savedStarGift.saved_id == savedStarGift2.saved_id) {
                            return true;
                        }
                        return false;
                    }
            ...
            if (h51Var.f26608z == h51Var2.f26608z && h51Var.f26589e == h51Var2.f26589e && h51Var.B == h51Var2.B && TextUtils.equals(h51Var.f26595l, h51Var2.f26595l)) {
                return true;
            }
            return false;
        }
