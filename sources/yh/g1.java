...
public final class g1 extends g51 {
    public static final int f50318a = 0;
    ...
    public final void bindView(View view, h51 h51Var, boolean z10, v51 v51Var, d61 d61Var) {
        ...
        if (obj instanceof sg.k) {
            ...
            h1Var.V = kVar;
            h1Var.W = null;
            h1Var.f50338b0 = false;
            h1Var.f50340c0 = null;
            h1Var.f50341d0 = false;
            h1Var.f50343e0 = false;
            h1Var.f50345f0 = false;
            h1Var.O = null;
            h1Var.P = null;
            h1Var.c(false, false);
            h1Var.j();
            ...
            h1Var.g(starGift, z13, z11, h51Var.f26626q, h51Var.f26627r, h51Var.f26629t);
        } else if (obj instanceof TL_stars.SavedStarGift) {
            z12 = h1Var.h((TL_stars.SavedStarGift) obj, h51Var.f26626q, h51Var.f26627r);
        }
        if (h51Var.f26616f) {
            h1Var.b(h51Var.f26615e, z12);
        }
    ...
    public final boolean equals(h51 h51Var, h51 h51Var2) {
        if (h51Var.f26626q == h51Var2.f26626q) {
            Object obj = h51Var.G;
            if (obj != null || h51Var2.G != null) {
                ...
                if (obj instanceof TL_stars.StarGift) {
                    ...
                    if (obj2 instanceof TL_stars.StarGift) {
                        if (((TL_stars.StarGift) obj).f20124id == ((TL_stars.StarGift) obj2).f20124id) {
                            return true;
                        }
                        return false;
                    }
                ...
                if (obj instanceof TL_stars.SavedStarGift) {
                    ...
                    if (obj3 instanceof TL_stars.SavedStarGift) {
                        ...
                        if (savedStarGift.gift.f20124id == savedStarGift2.gift.f20124id && savedStarGift.date == savedStarGift2.date && savedStarGift.saved_id == savedStarGift2.saved_id) {
                            return true;
                        }
                        return false;
                    }
            ...
            if (h51Var.f26634z == h51Var2.f26634z && h51Var.f26615e == h51Var2.f26615e && h51Var.B == h51Var2.B && TextUtils.equals(h51Var.f26621l, h51Var2.f26621l)) {
                return true;
            }
            return false;
        }
