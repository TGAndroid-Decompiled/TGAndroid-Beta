...
public final class m1 implements Runnable {
    ...
    public final a4 f47435b;
    public final TL_stars.TL_starGiftUnique f47436c;
    public final zf.a d;
    ...
    public m1(a4 a4Var, TL_stars.TL_starGiftUnique tL_starGiftUnique, zf.a aVar, Runnable runnable, int i10) {
        this.f47434a = i10;
        this.f47435b = a4Var;
        this.f47436c = tL_starGiftUnique;
        this.d = aVar;
        this.e = runnable;
    }
    ...
    public final void run() {
        ...
        zf.a aVar = this.d;
        TL_stars.TL_starGiftUnique tL_starGiftUnique = this.f47436c;
        a4 a4Var = this.f47435b;
        boolean z11 = false;
        switch (i10) {
            case 0:
                a4Var.getClass();
                tL_starGiftUnique.flags |= 16;
                if (aVar.f48952a == bVar2) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                ...
                a4Var.f46953e0.setResellPrice(aVar);
                xh.c2 c2Var = a4Var.f46952d1;
                if (c2Var != null) {
                    c2Var.run();
                }
                if (runnable != null) {
