...
public final class m1 implements Runnable {
    ...
    public final x3 f47704b;
    public final TL_stars.TL_starGiftUnique f47705c;
    public final zf.a d;
    ...
    public m1(x3 x3Var, TL_stars.TL_starGiftUnique tL_starGiftUnique, zf.a aVar, Runnable runnable, int i10) {
        this.f47703a = i10;
        this.f47704b = x3Var;
        this.f47705c = tL_starGiftUnique;
        this.d = aVar;
        this.e = runnable;
    }
    ...
    public final void run() {
        ...
        zf.a aVar = this.d;
        TL_stars.TL_starGiftUnique tL_starGiftUnique = this.f47705c;
        x3 x3Var = this.f47704b;
        boolean z11 = false;
        switch (i10) {
            case 0:
                x3Var.getClass();
                tL_starGiftUnique.flags |= 16;
                if (aVar.f49225a == bVar2) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                ...
                x3Var.f48236e0.setResellPrice(aVar);
                xh.d2 d2Var = x3Var.f48235d1;
                if (d2Var != null) {
                    d2Var.run();
                }
                if (runnable != null) {
