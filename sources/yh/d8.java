...
public final class d8 extends View {
    public final LinearGradient f47298a;
    public final Matrix f47299b;
    public final Paint f47300c;
    public final Paint d;
    public final t01 e;
    public final org.telegram.ui.ActionBar.d6 f47301f;

    public d8(Context context, org.telegram.ui.ActionBar.d6 d6Var) {
        super(context);
        this.f47301f = d6Var;
        this.f47298a = new LinearGradient(0.0f, 0.0f, 255.0f, 0.0f, new int[]{-1135603, -404714}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP);
        this.f47299b = new Matrix();
    ...
    public final void dispatchDraw(Canvas canvas) {
        Matrix matrix = this.f47299b;
        matrix.reset();
        matrix.postTranslate(AndroidUtilities.dp(14.0f), 0.0f);
        matrix.postScale((getWidth() - AndroidUtilities.dp(28.0f)) / 255.0f, 1.0f);
        LinearGradient linearGradient = this.f47298a;
        linearGradient.setLocalMatrix(matrix);
        Paint paint = this.f47300c;
        paint.setShader(linearGradient);
        t01 t01Var = this.e;
        float dp = t01Var.f28357c + AndroidUtilities.dp(30.0f);
        int v02 = org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19046d7, this.f47301f);
        Paint paint2 = this.d;
        paint2.setColor(v02);
        ...
        this.e.c((getWidth() - t01Var.f28357c) / 2.0f, getHeight() / 2.0f, 1.0f, -1, canvas);
    }
}
