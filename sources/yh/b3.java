...
public final class b3 extends View {
    public final n3 f46941a;
    public final ImageReceiver f46942b;
    public final Path f46943c;
    ...
    public final void onAttachedToWindow() {
        ...
        this.f46942b.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f46942b.onDetachedFromWindow();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawPath(this.f46943c, this.d);
        canvas.restore();
        ImageReceiver imageReceiver = this.f46942b;
