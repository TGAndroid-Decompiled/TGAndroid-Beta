...
public final class k5 implements l5 {
    ...
    public String f47610k;
    public int f47613n;
    public boolean f47614o;
    public ArrayList f47616q;
    public boolean f47605c = false;
    public boolean e = true;
    public boolean f47606f = false;
    public int f47607g = 783;
    public final ArrayList f47611l = new ArrayList();
    public int f47612m = -1;
    public long f47615p = 0;
    ...
    public final void a() {
        ...
        if (!this.f47608i && !this.f47609j) {
            ...
            if (j3 != 0) {
                ...
                getsavedstargifts2.exclude_unupgradable = !TLObject.hasFlag(this.f47607g, 2);
                getsavedstargifts2.exclude_upgradable = !TLObject.hasFlag(this.f47607g, 4);
                getsavedstargifts2.exclude_unlimited = !TLObject.hasFlag(this.f47607g, 1);
                getsavedstargifts2.exclude_unique = !TLObject.hasFlag(this.f47607g, 8);
                getsavedstargifts2.exclude_saved = !TLObject.hasFlag(this.f47607g, 256);
                getsavedstargifts2.exclude_unsaved = !TLObject.hasFlag(this.f47607g, 512);
                getsavedstargifts2.peer_color_available = this.f47606f;
    ...
    public final int b(int i10) {
        if (!x3.O1(this.f47603a, this.f47604b)) {
            return -1;
        }
        int i11 = i10 + 1;
        while (true) {
            ArrayList arrayList = this.f47611l;
    ...
    @Override
    public final void d() {
        NotificationCenter.getInstance(this.f47603a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starUserGiftsLoaded, Long.valueOf(this.f47604b), this);
    }

    @Override
    public final int e() {
        return this.f47611l.size();
    }
    ...
    public final TL_stars.InputSavedStarGift g(TL_stars.SavedStarGift savedStarGift) {
        ...
        tL_inputSavedStarGiftChat.peer = MessagesController.getInstance(this.f47603a).getInputPeer(this.f47604b);
    ...
    public final ArrayList h() {
        ...
        int i10 = 0;
        while (true) {
            ArrayList arrayList2 = this.f47611l;
    ...
    public final void i(boolean z10) {
        if (this.f47612m != -1) {
            ConnectionsManager.getInstance(this.f47603a).cancelRequest(this.f47612m, true);
            this.f47612m = -1;
        }
        this.f47608i = false;
        this.f47611l.clear();
    ...
    public final int indexOf(Object obj) {
        return this.f47611l.indexOf(obj);
    }
    ...
    public final void j(ArrayList arrayList, TL_stars.StarGift starGift) {
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
                ...
                while (true) {
                    ...
                    if (i12 < arrayList2.size()) {
                        ...
                        if (starGift3 != null && starGift3.f18560id == starGift2.f18560id) {
                            ...
                            this.f47613n = Math.max(0, this.f47613n - 1);
                            z10 = true;
                            break;
                        }
                        i12++;
            ...
            if (z10) {
                NotificationCenter.getInstance(i10).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starUserGiftsLoaded, Long.valueOf(this.f47604b), this);
            }
        }
        if (starGift != null) {
    ...
    public final void l() {
        boolean z10 = this.f47605c;
        int i10 = 0;
        long j3 = this.f47604b;
        int i11 = this.f47603a;
        if (z10) {
        ...
        if (savedStarGift != null) {
            ...
            if (contains) {
                if (!z10) {
                    ...
                    arrayList = this.f47611l;
                    arrayList.removeAll(h);
                    if (this.e && !this.f47605c) {
