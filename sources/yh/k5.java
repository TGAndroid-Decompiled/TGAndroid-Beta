...
public final class k5 {
    ...
    public boolean f47613k;
    public final ArrayList e = new ArrayList();
    public final ArrayList f47609f = new ArrayList();
    public final HashMap h = new HashMap();
    public int f47611i = -1;
    ...
    public final void a(int i10, ArrayList arrayList) {
        ...
        int i12 = this.f47606a;
        if (e != null) {
            e.f47650l.addAll(0, arrayList);
            e.f47652n = arrayList.size() + e.f47652n;
    ...
    public final void g() {
        if (this.f47611i != -1) {
            ConnectionsManager.getInstance(this.f47606a).cancelRequest(this.f47611i, true);
            this.f47611i = -1;
        }
        this.f47608c = false;
        this.d = false;
    ...
    public final void i() {
        if (!this.f47608c && !this.d) {
            this.f47608c = true;
            TL_stars.getStarGiftCollections getstargiftcollections = new TL_stars.getStarGiftCollections();
            int i10 = this.f47606a;
            getstargiftcollections.peer = MessagesController.getInstance(i10).getInputPeer(this.f47607b);
            ArrayList arrayList = this.e;
            int size = arrayList.size();
            long j3 = 0;
            int i11 = 0;
            ...
            this.f47611i = ConnectionsManager.getInstance(i10).sendRequest(getstargiftcollections, new i5(this, 0));
        }
    }

    public final void j() {
        ArrayList arrayList = this.f47609f;
        arrayList.clear();
        int i10 = 0;
        while (true) {
    ...
    public final void k(int i10, TL_stars.SavedStarGift savedStarGift) {
        ...
        boolean z10 = false;
        if (e != null) {
            ArrayList arrayList2 = e.f47650l;
                ...
                while (i11 < arrayList2.size()) {
                    ...
                    while (true) {
                        if (i12 >= arrayList.size()) {
                            ...
                            e.f47652n = Math.max(0, e.f47652n - 1);
                            i11--;
                            break;
                        } else {
                            i12++;
    ...
    public final void n(int i10) {
        ...
        if (e != null) {
            ...
            if (c10 != null) {
                ...
                NotificationCenter.getInstance(this.f47606a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starUserGiftCollectionsLoaded, Long.valueOf(this.f47607b), this);
            }
        }
    }
}
