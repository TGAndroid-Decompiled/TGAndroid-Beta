...
public final class h2 extends z81 {
    ...
    public final void F(View view, float f7) {
        ...
        if (view instanceof FrameLayout) {
            ...
            if (frameLayout.getChildCount() > 0) {
                ...
                if (n2Var != null && view2 == n2Var.Y && (j2Var3 = n2Var.f48326d0) != null) {
                    j2Var3.invalidate();
                }
                if (view2 == y3Var.Y && (j2Var2 = y3Var.f48326d0) != null) {
                    j2Var2.invalidate();
                }
                n2Var2 = y3Var.f48324c0;
                if (n2Var2 == null && view2 == n2Var2.Y && (j2Var = n2Var2.f48326d0) != null) {
                    j2Var.invalidate();
                    return;
                }
                return;
    ...
    public final void G() {
        ...
        if (i10 != y3Var.L1(false)) {
            if (this.f30849b > y3Var.L1(false)) {
                z10 = true;
            }
