...
public final class a extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final org.telegram.ui.ActionBar.d6 f47158b;
    public final TextView f47159c;
    public final n90 d;
    public zf.b e;
    public final pq[] f47160f;

    public a(Context context, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        this(context, i10, zf.b.f49216a, d6Var);
    }
    ...
    public final void a() {
        ...
        TextView textView = this.f47159c;
        org.telegram.ui.ActionBar.d6 d6Var = this.f47158b;
        n90 n90Var = this.d;
        if (bVar2 == bVar3) {
