...
public final class a extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final org.telegram.ui.ActionBar.f6 f46916b;
    public final TextView f46917c;
    public final c90 d;
    public zf.b e;
    public final oq[] f46918f;

    public a(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        this(context, i10, zf.b.f48977a, f6Var);
    }
    ...
    public final void a() {
        ...
        TextView textView = this.f46917c;
        org.telegram.ui.ActionBar.f6 f6Var = this.f46916b;
        c90 c90Var = this.d;
        if (bVar2 == bVar3) {
