...
public final class a extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final org.telegram.ui.ActionBar.e6 f46893b;
    public final TextView f46894c;
    public final c90 d;
    public zf.b e;
    public final oq[] f46895f;

    public a(Context context, int i10, org.telegram.ui.ActionBar.e6 e6Var) {
        this(context, i10, zf.b.f48954a, e6Var);
    }
    ...
    public final void a() {
        ...
        TextView textView = this.f46894c;
        org.telegram.ui.ActionBar.e6 e6Var = this.f46893b;
        c90 c90Var = this.d;
        if (bVar2 == bVar3) {
