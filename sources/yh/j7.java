...
public final class j7 extends za implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final tg.b1 f47369a0;
    public x51 f47370b0;
    public boolean f47371c0;
            ...
            public final void run() {
                ...
                switch (r2) {
                    case 0:
                        ...
                        return;
                    default:
                        nf.f.s(this.f47329b.getContext(), LocaleController.getString(R.string.StarsTOSLink));
                        return;
                }
            }
        }), true)));
    ...
    public static void P(j7 j7Var, int i10) {
        j51 G;
        x51 x51Var = j7Var.f47370b0;
        if (x51Var != null && (G = x51Var.G(i10 - 1)) != null) {
            x51 x51Var2 = j7Var.f47370b0;
            if (G.d == -1) {
                j7Var.f47371c0 = !j7Var.f47371c0;
                x51Var2.N(true);
                j7Var.d.w0(0, AndroidUtilities.dp(200.0f), qr.f27381g);
    ...
    public static void Q(j7 j7Var, j51 j51Var, long j3, Boolean bool, String str) {
        ...
        if (j7Var.getContext() != null) {
            if ((bool.booleanValue() || str != null) && (b1Var = j7Var.f47369a0) != null) {
                b1Var.run();
            }
            super.dismiss();
            org.telegram.ui.ActionBar.o2 U = LaunchActivity.U();
            ib0 ib0Var = LaunchActivity.G1.f30872x0;
            if (U != null) {
    ...
    public final void R(ArrayList arrayList, x51 x51Var) {
        ...
        if (u10 != null && !u10.isEmpty()) {
            ...
            for (int i13 = 0; i13 < u10.size(); i13++) {
                ...
                if (!this.f47371c0 && tL_starsGiftOption.extended) {
                    i11++;
                } else {
                    int i14 = i12 + 1;
                    int i15 = k7.f47400a;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        x51 x51Var;
        if ((i10 == NotificationCenter.starGiftOptionsLoaded || i10 == NotificationCenter.starBalanceUpdated) && (x51Var = this.f47370b0) != null) {
            x51Var.N(true);
        }
    }
