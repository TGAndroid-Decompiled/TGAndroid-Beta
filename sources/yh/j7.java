...
public final class j7 extends za implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final tg.b1 f47346a0;
    public w51 f47347b0;
    public boolean f47348c0;

    public j7(Context context, org.telegram.ui.ActionBar.e6 e6Var, TLRPC.User user, tg.b1 b1Var) {
        ...
        this.X = d1Var;
        ((TextView) d1Var.f682c).setText(LocaleController.getString(R.string.GiftStarsTitle));
        ...
        c90Var.setText(TextUtils.concat(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.GiftStarsSubtitle, UserObject.getForcedFirstName(user))), " ", AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.GiftStarsSubtitleLinkName).replace(' ', (char) 160), new Runnable(this) {
            ...
            public final void run() {
                ...
                switch (r2) {
                    case 0:
                        j7 j7Var = this.f47306b;
                        ew0 ew0Var = new ew0(j7Var.getContext());
                        ...
                        return;
                    default:
                        nf.f.s(this.f47306b.getContext(), LocaleController.getString(R.string.StarsTOSLink));
                        return;
                }
            }
        }), true)));
    ...
    public static void P(j7 j7Var, int i10) {
        i51 G;
        w51 w51Var = j7Var.f47347b0;
        if (w51Var != null && (G = w51Var.G(i10 - 1)) != null) {
            w51 w51Var2 = j7Var.f47347b0;
            if (G.d == -1) {
                j7Var.f47348c0 = !j7Var.f47348c0;
                w51Var2.N(true);
                j7Var.d.v0(0, AndroidUtilities.dp(200.0f), qr.f27424g);
                ...
                if (context != null) {
                    ...
                    if (!MessagesController.getInstance(i11).starsPurchaseAvailable()) {
                        ...
                        ?? obj = new Object();
                        obj.f3837b = "inapp";
                        obj.f3836a = tL_starsGiftOption.store_product;
    ...
    public static void Q(j7 j7Var, i51 i51Var, long j3, Boolean bool, String str) {
        tg.b1 b1Var;
        if (j7Var.getContext() != null) {
            if ((bool.booleanValue() || str != null) && (b1Var = j7Var.f47346a0) != null) {
                b1Var.run();
            }
            super.dismiss();
            org.telegram.ui.ActionBar.n2 U = LaunchActivity.U();
            gb0 gb0Var = LaunchActivity.G1.f30858x0;
            if (U != null) {
                if (bool.booleanValue()) {
                    oc K = vc.a0(U).K(R.raw.stars_send, LocaleController.getString(R.string.StarsGiftSentPopup), AndroidUtilities.replaceTags(LocaleController.formatPluralString("StarsGiftSentPopupInfo", (int) i51Var.B, UserObject.getForcedFirstName(j7Var.Z))), LocaleController.getString(R.string.ViewInChat), new xn0(j3, 2));
                    K.f26754j = 5000;
                    K.k(true);
                    if (gb0Var != null) {
                        gb0Var.c(true);
    ...
    public final void R(ArrayList arrayList, w51 w51Var) {
        ...
        if (u10 != null && !u10.isEmpty()) {
            ...
            for (int i13 = 0; i13 < u10.size(); i13++) {
                ...
                if (!this.f47348c0 && tL_starsGiftOption.extended) {
                    i11++;
                } else {
                    int i14 = i12 + 1;
                    int i15 = k7.f47377a;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        w51 w51Var;
        if ((i10 == NotificationCenter.starGiftOptionsLoaded || i10 == NotificationCenter.starBalanceUpdated) && (w51Var = this.f47347b0) != null) {
            w51Var.N(true);
        }
    }
