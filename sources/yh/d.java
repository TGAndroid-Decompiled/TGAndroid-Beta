...
public final class d extends FrameLayout {
    public final di.d f50224a;
    public final q6 f50225b;
    public final q6 f50226c;
    public final GiftAuctionController.Auction d;
    public final Paint f50227e;
    public final yf.n f50228f;
    public final nq h;
    public final nq[] f50229n;

    public d(Context context, GiftAuctionController.Auction auction) {
        super(context);
        Paint paint = new Paint(1);
        this.f50227e = paint;
        this.f50228f = new yf.n(new rg.p2(this, 14));
        this.h = new nq(R.drawable.filled_gift_sell_24, 0);
        this.f50229n = new nq[1];
        this.d = auction;
    ...
    public final void a(long j3, boolean z10) {
        ...
        this.f50224a.g(spannableStringBuilder, z10, true);
    }
    ...
    public final void b(boolean z10) {
        ...
        if (tL_starGiftAuctionState != null) {
            this.f50225b.c(LocaleController.formatString(R.string.Gift2ActiveAuctionsActiveRound, LocaleController.formatNumber(tL_starGiftAuctionState.current_round, ','), LocaleController.formatNumber(auction.auctionStateActive.total_rounds, ',')), z10, true);
        }
        String k10 = i2.g.k(auction.auctionUserState.bid_amount, ',', new StringBuilder("⭐️"));
        boolean isOutbid = auction.getBidStatus().isOutbid();
        nq[] nqVarArr = this.f50229n;
        q6 q6Var = this.f50226c;
        if (isOutbid) {
            ...
            q6Var.setTextColor(j6.w0(null, j6.f20899q7, false));
            return;
        }
    ...
    public final void dispatchDraw(Canvas canvas) {
        canvas.drawRoundRect(AndroidUtilities.dp(14.0f), AndroidUtilities.dp(9.0f), getMeasuredWidth() - AndroidUtilities.dp(14.0f), getMeasuredHeight() - AndroidUtilities.dp(9.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), this.f50227e);
