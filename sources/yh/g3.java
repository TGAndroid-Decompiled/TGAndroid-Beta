...
public final class g3 extends e3 {
    ...
    public g3(TL_stars.starGiftAttributeBackdrop stargiftattributebackdrop) {
        this.f47330a = stargiftattributebackdrop.name;
        this.f47331b = stargiftattributebackdrop.getRarityPermille();
        ...
        this.f47435g = stargiftattributebackdrop.text_color | (-16777216);
        int i10 = stargiftattributebackdrop.pattern_color;
        this.h = i10 | (-16777216);
        this.f47434f = i0.a.d(0.25f, stargiftattributebackdrop.edge_color | (-16777216), i10 | (-16777216));
    }
}
