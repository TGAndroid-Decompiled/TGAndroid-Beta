...
public final class g3 extends e3 {
    ...
    public g3(TL_stars.starGiftAttributeBackdrop stargiftattributebackdrop) {
        this.f47329a = stargiftattributebackdrop.name;
        this.f47330b = stargiftattributebackdrop.getRarityPermille();
        ...
        this.f47434g = stargiftattributebackdrop.text_color | (-16777216);
        int i10 = stargiftattributebackdrop.pattern_color;
        this.h = i10 | (-16777216);
        this.f47433f = i0.a.d(0.25f, stargiftattributebackdrop.edge_color | (-16777216), i10 | (-16777216));
    }
}
