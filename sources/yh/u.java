...
public final class u implements Runnable {
    ...
    public final Object f48072b;
    public final Object f48073c;
    public final Object d;
    public final Object e;
    public final Object f48074f;
    ...
    public final void run() {
        ...
        xo0 xo0Var3 = null;
        Object obj = this.f48072b;
        Object obj2 = this.f48074f;
        Object obj3 = this.e;
        Object obj4 = this.d;
        Object obj5 = this.f48073c;
        int i13 = 0;
        switch (i12) {
            case 0:
                a0 a0Var = (a0) obj5;
                ...
                if (U != null) {
                    if (updates != null) {
                        qc M = xc.a0(U).M(LocaleController.getString(R.string.GiftOfferSentTitle), AndroidUtilities.replaceTags(LocaleController.formatString(R.string.GiftOfferSentText, a0Var.Z, DialogObject.getShortName(a0Var.f47153a0))), R.raw.forward);
                        M.f27560t = true;
                        M.j();
                        return;
                    }
            ...
            case 1:
                ...
                if (tLObject instanceof TLRPC.PaymentForm) {
                    ...
                    MessagesController.getInstance(t5Var.f48042a).putUsers(paymentForm.users, false);
            ...
            case 2:
                ...
                if (tLObject2 instanceof TLRPC.PaymentForm) {
                    ...
                    MessagesController.getInstance(t5Var2.f48042a).putUsers(paymentForm2.users, false);
            ...
            case 6:
                ...
                if (tLObject4 instanceof TLRPC.PaymentForm) {
                    ...
                    MessagesController.getInstance(t5Var3.f48042a).putUsers(paymentForm3.users, false);
    ...
    public u(t5 t5Var, TLRPC.TL_error tL_error, Utilities.Callback2 callback2, TLObject tLObject, TLRPC.TL_inputInvoiceStars tL_inputInvoiceStars, int i10) {
        this.f48071a = i10;
        this.f48073c = t5Var;
        this.f48072b = tL_error;
        this.d = callback2;
        this.e = tLObject;
        this.f48074f = tL_inputInvoiceStars;
    }
    ...
    public u(t5 t5Var, org.telegram.ui.ActionBar.b2 b2Var, TLObject tLObject, TL_stars.InputSavedStarGift inputSavedStarGift, Utilities.Callback callback) {
        ...
        this.e = b2Var;
        this.d = tLObject;
        this.f48074f = inputSavedStarGift;
