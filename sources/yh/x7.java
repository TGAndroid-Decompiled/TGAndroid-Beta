...
public final class x7 extends r20 implements NotificationCenter.NotificationCenterDelegate {
    public static DecimalFormat f47939h0;
    public static DecimalFormat f47940i0;
    ...
    public ci.d Y;
    public xh.g1 Z;
    public ci.d f47941a0;
    public cc1 f47942b0;
    public ci.d f47943c0;
    public ci.d f47944d0;
    public boolean f47945e0;
    public boolean f47946f0;
    public a7 f47947g0;
    ...
    public static void B0(x7 x7Var, Context context) {
    ...
    public static void F0(pz0 pz0Var, int i10, TL_stars.StarGift starGift, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        if (!starGift.sold_out) {
            ...
            final long j3 = starGift.f18334id;
            ...
            final NotificationCenter.NotificationCenterDelegate[] notificationCenterDelegateArr = {new NotificationCenter.NotificationCenterDelegate() {
                ...
                public final void didReceivedNotification(int i11, int i12, Object[] objArr) {
                    ...
                    if (!zArr2[0] && i11 == (i13 = NotificationCenter.starGiftsLoaded) && (J = (u5Var = u5.this).J(j3)) != null) {
                        zArr2[0] = true;
                        NotificationCenter.getInstance(u5Var.f47801a).removeObserver(notificationCenterDelegateArr[0], i13);
                        b1Var.run(J);
                    }
                }
            }};
    ...
    public static SpannableStringBuilder J0(TL_stars.StarsAmount starsAmount, float f7, char c10) {
        ...
        int i10;
        if (f47940i0 == null) {
            f47940i0 = new DecimalFormat("0.################", new DecimalFormatSymbols(Locale.US));
        }
        ...
        if (starsAmount instanceof TL_stars.TL_starsTonAmount) {
            ...
            if (j3 % 1000000000 != 0) {
                String format = f47940i0.format(j3 / 1.0E9d);
            ...
            if (i11 != 0) {
                ...
                DecimalFormat decimalFormat = f47940i0;
    ...
    public static SpannableStringBuilder K0(TL_stars.StarsAmount starsAmount, float f7, char c10) {
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        if (starsAmount instanceof TL_stars.TL_starsTonAmount) {
            String format = f47940i0.format(starsAmount.amount / 1.0E9d);
            spannableStringBuilder.append((CharSequence) format);
            int indexOf = format.indexOf(".");
            if (indexOf >= 0) {
                spannableStringBuilder.setSpan(new RelativeSizeSpan(f7), indexOf, spannableStringBuilder.length(), 33);
    ...
    public static String M0(long j3) {
        String str;
        if (f47939h0 == null) {
            f47939h0 = new DecimalFormat("0.####", new DecimalFormatSymbols(Locale.US));
        }
        if (j3 % 1000000000 != 0) {
            return f47939h0.format(j3 / 1.0E9d);
        }
        StringBuilder sb2 = new StringBuilder();
        if (j3 < 0) {
            str = "-";
    ...
    public static java.lang.String N0(int r5, boolean r6, org.telegram.tgnet.tl.TL_stars.StarsTransaction r7) {
        throw new UnsupportedOperationException("Method not decompiled: yh.x7.N0(int, boolean, org.telegram.tgnet.tl.TL_stars$StarsTransaction):java.lang.String");
    }
    ...
    public static void Z0(ImageReceiver imageReceiver, TLRPC.Document document, int i10) {
        ...
        imageReceiver.setImage(ImageLocation.getForDocument(document), a4.a.l(i10, i10, "_"), ImageLocation.getForDocument(closestPhotoSizeWithSize, document), a4.a.l(i10, i10, "_"), DocumentObject.getSvgThumb(document.thumbs, org.telegram.ui.ActionBar.i6.f18778a7, 0.35f), 0L, null, null, 0);
    }
    ...
    public static void e1(Context context, int i10, long j3, TL_stories.Boost boost, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        pz0Var.k(LocaleController.getString(R.string.BoostFrom), i10, j3, new w5(f3VarArr, j3, 2));
    ...
    public static i0 f1(Context context, int i10, TL_stars.TL_starGiftUnique tL_starGiftUnique, Utilities.Callback2 callback2, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        if (tL_starGiftUnique == null) {
            ...
            resellAmount = tL_starGiftUnique.getResellAmount(zf.b.f48948b);
        } else {
    ...
    public static void g1(Context context, long j3, boolean z10, final Utilities.Callback2 callback2, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        editTextBoldCursor.setTextColor(org.telegram.ui.ActionBar.i6.v0(i12, e6Var));
        ...
        editTextBoldCursor.setHighlightColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19154uf, e6Var));
        editTextBoldCursor.setHandlesColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19171vf, e6Var));
        ...
        l6 l6Var = new l6(f3VarArr, editTextBoldCursor);
        if (z11) {
            j10 = 200;
        } else {
            j10 = 80;
        }
        AndroidUtilities.runOnUIThread(l6Var, j10);
    }
    ...
    public static org.telegram.ui.ActionBar.f3 h1(final android.content.Context r60, final boolean r61, final long r62, final int r64, final org.telegram.tgnet.tl.TL_stars.StarsTransaction r65, final org.telegram.ui.ActionBar.e6 r66) {
        throw new UnsupportedOperationException("Method not decompiled: yh.x7.h1(android.content.Context, boolean, long, int, org.telegram.tgnet.tl.TL_stars$StarsTransaction, org.telegram.ui.ActionBar.e6):org.telegram.ui.ActionBar.f3");
    }
    ...
    public static void i1(Activity activity, int i10, int i11, TLRPC.TL_messageActionPaymentRefunded tL_messageActionPaymentRefunded, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        starsTransaction.f18336id = tL_messageActionPaymentRefunded.charge.f18237id;
    ...
    public static void j1(Context context, int i10, TLRPC.TL_payments_paymentReceiptStars tL_payments_paymentReceiptStars, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        starsTransaction.f18336id = tL_payments_paymentReceiptStars.transaction_id;
        h1(context, false, 0L, i10, starsTransaction, e6Var);
    }

    public static void x0(yh.x7 r39, int r40) {
        throw new UnsupportedOperationException("Method not decompiled: yh.x7.x0(yh.x7, int):void");
    }
    ...
    public final void H0(ArrayList arrayList, w51 w51Var) {
        ...
        i51Var.f24894c = (eb) super.r0(getParentActivity());
        arrayList.add(i51Var);
        arrayList.add(i51.k(this.U));
        ci.d dVar = this.f47944d0;
        if (dVar != null) {
    ...
    public final View createView(final Context context) {
        ...
        this.f37004c.setOverScrollMode(2);
        s4.j jVar = new s4.j();
        jVar.f42706m = false;
        jVar.C = false;
        jVar.o(qr.h);
        jVar.n(350L);
        this.f37004c.setItemAnimator(jVar);
        this.f37004c.setOnItemClickListener(new ai.g(this, 21));
        r00 r00Var = new r00(getParentActivity());
        this.T = r00Var;
        this.f37008s.addView(r00Var, w7.x5.c(-1.0f, -1));
        u5 y3 = u5.y(this.currentAccount, false);
        ...
        this.X.setTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f19234z6, this.resourceProvider));
        ...
        this.f47941a0 = dVar;
        dVar.e();
        this.f47941a0.g("", false, true);
        this.f47941a0.setOnClickListener(new View.OnClickListener(this) {
            public final x7 f47022b;
            ...
            public final void onClick(View view) {
                switch (r3) {
                    case 0:
                        x7.B0(this.f47022b, context);
                        return;
                    default:
                        new n7(context, this.f47022b.resourceProvider).show();
                        return;
                }
            }
        });
        this.Z.addView(this.f47941a0, w7.x5.e(-1, 48, 119));
        cc1 cc1Var = new cc1(this, getParentActivity(), 20);
        this.f47942b0 = cc1Var;
        ...
        this.f47943c0.g(spannableStringBuilder, false, true);
        this.f47943c0.setOnClickListener(new View.OnClickListener(this) {
            public final x7 f47022b;
        ...
        this.f47942b0.addView(this.f47943c0, w7.x5.p(-1, 48, 17.0f, 1, 0, 0, 8, 0));
        ...
        this.f47942b0.addView(this.Y, w7.x5.p(-1, 48, 17.0f, 1, 0, 0, 0, 0));
        ...
        this.f47944d0.g(spannableStringBuilder3, false, true);
        this.f47944d0.setOnClickListener(new View.OnClickListener(this) {
            public final x7 f47065b;
        ...
        this.U.addView(this.f47944d0, w7.x5.d(-1, 48.0f, 17, 20.0f, 8.0f, 20.0f, 0.0f));
        k1();
        a7 a7Var = this.f47947g0;
        if (a7Var != null) {
            a7Var.N(false);
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.starOptionsLoaded) {
            ...
            u5 y3 = u5.y(this.currentAccount, false);
            if (this.f47945e0 != y3.O(0)) {
                this.f47945e0 = y3.O(0);
                s0();
                a7 a7Var2 = this.f47947g0;
                if (a7Var2 != null) {
                    a7Var2.N(true);
                }
                if (this.N == 0 && this.O < 0) {
    ...
    public final void l1(final boolean z10, boolean z11) {
        ...
        if (z11) {
            ...
            animate.alpha(f10).withEndAction(new Runnable(this) {
                ...
                public final void run() {
                    switch (r3) {
                        case 0:
                            if (z10) {
                                this.f47107b.Z.setVisibility(8);
                                return;
                            }
                            return;
                        default:
                            if (!z10) {
                                this.f47107b.f47942b0.setVisibility(8);
                                return;
                            }
                            return;
                    }
            ...
            ViewPropertyAnimator animate2 = this.f47942b0.animate();
            if (!z10) {
                f11 = 0.0f;
            }
        ...
        this.f47942b0.animate().cancel();
        cc1 cc1Var = this.f47942b0;
        if (z10) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
    ...
    public final s4.h0 n0() {
        a7 a7Var = new a7(this, this.f37004c, getParentActivity(), this.currentAccount, this.classGuid, new hi.a(this, 26), getResourceProvider());
        this.f47947g0 = a7Var;
        a7Var.f29610r = false;
        return a7Var;
    }
    ...
    public final boolean q0() {
        ...
        if (w7Var != null && (w7Var.getParent() instanceof View)) {
            if ((this.f37004c.getHeight() - this.f37004c.getPaddingBottom()) - ((View) this.R.getParent()).getBottom() >= 0) {
                z10 = true;
            }
        }
        return !z10;
