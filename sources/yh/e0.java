...
public final class e0 extends org.telegram.ui.ActionBar.g3 {
    ...
    public final int d;
    public final l40 e;
    public final yc0 f47116f;
    public final EditTextBoldCursor h;
    public final TextView f47117n;
    public final c0 f47118r;
    public final ci.d f47119s;
    public final org.telegram.ui.Components.n6 v;
    public final ImageView f47120w;
    public final ImageView f47121x;
    public final zf.a f47122y;
    ...
    public e0(final Context context, int i10, long j3, MessageSuggestionParams messageSuggestionParams, bo boVar, final org.telegram.ui.ActionBar.f6 f6Var, int i11, Utilities.Callback callback) {
        ...
        this.f47115c = canManageMonoForum;
        ...
        if (!canManageMonoForum) {
            ...
            aVar.setOnClickListener(new View.OnClickListener(this) {
                ...
                public final void onClick(View view) {
                    switch (r4) {
                        case 0:
                            if (this.f47026b.H.f48975a == zf.b.f48977a) {
                                new o7(context, f6Var).show();
                                return;
                            }
                            return;
                        default:
                            e0 e0Var = this.f47026b;
                            org.telegram.ui.Components.c5.T(context, e0Var.I, new r5.d(e0Var, 19), f6Var, 0).f18470a.show();
                            return;
                    }
                }
            });
        ...
        this.f47118r = editTextBoldCursor2;
        ...
        if (aVar3 != null) {
            z12 = false;
            q(zf.a.i(aVar3.f48976b, aVar3.f48975a), !messageSuggestionParams.amount.k(), true, false);
        } else {
            z12 = false;
    ...
    public final boolean isTouchOutside(float f7, float f10) {
        a aVar;
        if (this.K && (aVar = this.f47114b) != null && f7 >= aVar.getX() && f7 <= aVar.getX() + aVar.getWidth() && f10 >= aVar.getY() && f10 <= aVar.getY() + aVar.getHeight()) {
            return false;
        }
    ...
    public final void n(boolean z10) {
        boolean z11;
        if (this.J == 0 && (this.H.f48976b >= 0 || this.I > 0)) {
            z11 = true;
        } else {
            z11 = false;
        }
        ci.d dVar = this.f47119s;
        if (dVar.W != z11) {
            dVar.setEnabled(z11);
    ...
    public final zf.a p() {
        if (this.H.f48975a == zf.b.f48978b) {
            return this.G;
        }
        return this.E;
    }
    ...
    public final void q(zf.a aVar, boolean z10, boolean z11, boolean z12) {
        ...
        if (aVar != null) {
            ...
            this.H = zf.a.i(0L, aVar5.f48975a);
            this.J |= 1;
        }
        long j3 = p().f48976b;
        zf.a aVar6 = this.H;
        ...
        boolean k10 = aVar6.k();
        zf.a aVar7 = this.f47122y;
        zf.a aVar8 = this.F;
        zf.b bVar2 = zf.b.f48978b;
        if (!k10) {
            zf.a aVar9 = this.H;
            if (aVar9.f48975a == bVar2) {
                aVar4 = aVar8;
            } else {
                aVar4 = aVar7;
            }
            if (aVar4.f48976b > aVar9.f48976b) {
                this.J |= 2;
            }
        }
        if (!z11 && aVar5.f48975a == this.H.f48975a) {
            z13 = false;
        } else {
            z13 = true;
        }
        if (!z11 && aVar5.f48976b == this.H.f48976b) {
            z14 = false;
        } else {
            z14 = true;
        }
        ...
        if (z13) {
            ...
            zf.b bVar4 = this.H.f48975a;
            TextView textView = this.f47117n;
            if (bVar4 == bVar3) {
            ...
            ImageView imageView = this.f47121x;
            ImageView imageView2 = this.f47120w;
            if (z12) {
            ...
            a aVar10 = this.f47114b;
            if (aVar10 != null && aVar10.e != (bVar = this.H.f48975a)) {
                aVar10.e = bVar;
                aVar10.a();
            }
        } else {
