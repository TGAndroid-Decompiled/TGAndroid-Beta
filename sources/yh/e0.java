...
public final class e0 extends org.telegram.ui.ActionBar.f3 {
    ...
    public final int d;
    public final l40 e;
    public final yc0 f47033f;
    public final EditTextBoldCursor h;
    public final TextView f47034n;
    public final c0 f47035r;
    public final ci.d f47036s;
    public final org.telegram.ui.Components.n6 v;
    public final ImageView f47037w;
    public final ImageView f47038x;
    public final zf.a f47039y;
    ...
    public e0(final Context context, int i10, long j3, MessageSuggestionParams messageSuggestionParams, bo boVar, final org.telegram.ui.ActionBar.e6 e6Var, int i11, Utilities.Callback callback) {
        ...
        this.f47032c = canManageMonoForum;
        ...
        if (!canManageMonoForum) {
            ...
            aVar.setOnClickListener(new View.OnClickListener(this) {
                ...
                public final void onClick(View view) {
                    switch (r4) {
                        case 0:
                            if (this.f46934b.H.f48945a == zf.b.f48947a) {
                                new n7(context, e6Var).show();
                                return;
                            }
                            return;
                        default:
                            e0 e0Var = this.f46934b;
                            org.telegram.ui.Components.c5.T(context, e0Var.I, new r5.e(e0Var, 18), e6Var, 0).f18440a.show();
                            return;
                    }
                }
            });
        ...
        this.f47035r = editTextBoldCursor2;
        ...
        if (aVar3 != null) {
            z12 = false;
            q(zf.a.i(aVar3.f48946b, aVar3.f48945a), !messageSuggestionParams.amount.k(), true, false);
        } else {
            z12 = false;
    ...
    public final boolean isTouchOutside(float f7, float f10) {
        a aVar;
        if (this.K && (aVar = this.f47031b) != null && f7 >= aVar.getX() && f7 <= aVar.getX() + aVar.getWidth() && f10 >= aVar.getY() && f10 <= aVar.getY() + aVar.getHeight()) {
            return false;
        }
    ...
    public final void n(boolean z10) {
        boolean z11;
        if (this.J == 0 && (this.H.f48946b >= 0 || this.I > 0)) {
            z11 = true;
        } else {
            z11 = false;
        }
        ci.d dVar = this.f47036s;
        if (dVar.W != z11) {
            dVar.setEnabled(z11);
    ...
    public final zf.a p() {
        if (this.H.f48945a == zf.b.f48948b) {
            return this.G;
        }
        return this.E;
    }
    ...
    public final void q(zf.a aVar, boolean z10, boolean z11, boolean z12) {
        ...
        if (aVar != null) {
            ...
            this.H = zf.a.i(0L, aVar5.f48945a);
            this.J |= 1;
        }
        long j3 = p().f48946b;
        zf.a aVar6 = this.H;
        ...
        boolean k10 = aVar6.k();
        zf.a aVar7 = this.f47039y;
        zf.a aVar8 = this.F;
        zf.b bVar2 = zf.b.f48948b;
        if (!k10) {
            zf.a aVar9 = this.H;
            if (aVar9.f48945a == bVar2) {
                aVar4 = aVar8;
            } else {
                aVar4 = aVar7;
            }
            if (aVar4.f48946b > aVar9.f48946b) {
                this.J |= 2;
            }
        }
        if (!z11 && aVar5.f48945a == this.H.f48945a) {
            z13 = false;
        } else {
            z13 = true;
        }
        if (!z11 && aVar5.f48946b == this.H.f48946b) {
            z14 = false;
        } else {
            z14 = true;
        }
        ...
        if (z13) {
            ...
            zf.b bVar4 = this.H.f48945a;
            TextView textView = this.f47034n;
            if (bVar4 == bVar3) {
            ...
            ImageView imageView = this.f47038x;
            ImageView imageView2 = this.f47037w;
            if (z12) {
            ...
            a aVar10 = this.f47031b;
            if (aVar10 != null && aVar10.e != (bVar = this.H.f48945a)) {
                aVar10.e = bVar;
                aVar10.a();
            }
        } else {
        ...
        if (z13 || z14 || z15) {
            ...
            if (i16 == 0) {
                if (!this.H.k()) {
                    ...
                    dVar.g(x7.V0(z16, formatString, oqVarArr), z12, true);
                } else {
