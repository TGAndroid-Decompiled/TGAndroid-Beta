...
public final class e0 extends org.telegram.ui.ActionBar.f3 {
    ...
    public final oq[] M;
    public boolean N;
    public final a f47356b;
    public final boolean f47357c;
    public final int d;
    public final l40 e;
    public final hd0 f47358f;
    public final EditTextBoldCursor h;
    public final TextView f47359n;
    public final c0 f47360r;
    public final ci.d f47361s;
    public final org.telegram.ui.Components.o6 v;
    public final ImageView f47362w;
    public final ImageView f47363x;
    public final zf.a f47364y;
    ...
    public e0(final Context context, int i10, long j3, MessageSuggestionParams messageSuggestionParams, zn znVar, final org.telegram.ui.ActionBar.f6 f6Var, int i11, Utilities.Callback callback) {
        ...
        this.f47357c = canManageMonoForum;
        ...
        this.f47364y = zf.a.g(appGlobalConfig.starsSuggestedPostAmountMin.get(), bVar2);
        ...
        if (!canManageMonoForum) {
            ...
            aVar.setOnClickListener(new View.OnClickListener(this) {
                ...
                public final void onClick(View view) {
                    switch (r4) {
                        case 0:
                            if (this.f47263b.H.f49252a == zf.b.f49254a) {
                                new m7(context, f6Var).show();
                                return;
                            }
                            return;
                        default:
                            e0 e0Var = this.f47263b;
                            org.telegram.ui.Components.d5.T(context, e0Var.I, new r5.d(e0Var, 19), f6Var, 0).f18659a.show();
                            return;
                    }
                }
            });
        ...
        f11.addView(hd0Var, w7.y5.k(18.0f, 0.0f, 18.0f, 0.0f, -1, 58));
        ImageView imageView2 = new ImageView(context);
        this.f47362w = imageView2;
        ...
        this.f47360r = editTextBoldCursor2;
        ...
        f11.addView(hd0Var2, w7.y5.k(18.0f, 24.0f, 18.0f, 0.0f, -1, 58));
        ...
        if (aVar3 != null) {
            z12 = false;
            q(zf.a.i(aVar3.f49253b, aVar3.f49252a), !messageSuggestionParams.amount.k(), true, false);
        } else {
            z12 = false;
    ...
    public final boolean isTouchOutside(float f7, float f10) {
        a aVar;
        if (this.K && (aVar = this.f47356b) != null && f7 >= aVar.getX() && f7 <= aVar.getX() + aVar.getWidth() && f10 >= aVar.getY() && f10 <= aVar.getY() + aVar.getHeight()) {
            return false;
        }
    ...
    public final void n(boolean z10) {
        boolean z11;
        if (this.J == 0 && (this.H.f49253b >= 0 || this.I > 0)) {
            z11 = true;
        } else {
            z11 = false;
        }
        ci.d dVar = this.f47361s;
        if (dVar.W != z11) {
            dVar.setEnabled(z11);
    ...
    public final zf.a p() {
        if (this.H.f49252a == zf.b.f49255b) {
            return this.G;
        }
        return this.E;
    }
    ...
    public final void q(zf.a aVar, boolean z10, boolean z11, boolean z12) {
        ...
        if (aVar != null) {
            ...
            this.H = zf.a.i(0L, aVar5.f49252a);
            this.J |= 1;
        }
        long j3 = p().f49253b;
        zf.a aVar6 = this.H;
        ...
        boolean k10 = aVar6.k();
        zf.a aVar7 = this.f47364y;
        zf.a aVar8 = this.F;
        zf.b bVar2 = zf.b.f49255b;
        if (!k10) {
            zf.a aVar9 = this.H;
            if (aVar9.f49252a == bVar2) {
                aVar4 = aVar8;
            } else {
                aVar4 = aVar7;
            }
        ...
        if (!z11 && aVar5.f49252a == this.H.f49252a) {
            z13 = false;
        } else {
            z13 = true;
        }
        if (!z11 && aVar5.f49253b == this.H.f49253b) {
            z14 = false;
        } else {
            z14 = true;
        }
        ...
        if (z13) {
            ...
            zf.b bVar4 = this.H.f49252a;
            TextView textView = this.f47359n;
            if (bVar4 == bVar3) {
            ...
            ImageView imageView = this.f47363x;
            ImageView imageView2 = this.f47362w;
            if (z12) {
            ...
            a aVar10 = this.f47356b;
            if (aVar10 != null && aVar10.e != (bVar = this.H.f49252a)) {
                aVar10.e = bVar;
                aVar10.a();
            }
        } else {
