...
public final class e0 extends org.telegram.ui.ActionBar.f3 {
    ...
    public final int d;
    public final l40 e;
    public final yc0 f47093f;
    public final EditTextBoldCursor h;
    public final TextView f47094n;
    public final c0 f47095r;
    public final ci.d f47096s;
    public final org.telegram.ui.Components.n6 v;
    public final ImageView f47097w;
    public final ImageView f47098x;
    public final zf.a f47099y;
    ...
    public e0(final Context context, int i10, long j3, MessageSuggestionParams messageSuggestionParams, bo boVar, final org.telegram.ui.ActionBar.e6 e6Var, int i11, Utilities.Callback callback) {
        ...
        this.f47092c = canManageMonoForum;
        ...
        if (!canManageMonoForum) {
            ...
            aVar.setOnClickListener(new View.OnClickListener(this) {
                ...
                public final void onClick(View view) {
                    switch (r4) {
                        case 0:
                            if (this.f47003b.H.f48952a == zf.b.f48954a) {
                                new o7(context, e6Var).show();
                                return;
                            }
                            return;
                        default:
                            e0 e0Var = this.f47003b;
                            org.telegram.ui.Components.c5.T(context, e0Var.I, new r5.d(e0Var, 19), e6Var, 0).f18442a.show();
                            return;
                    }
                }
            });
        ...
        this.f47095r = editTextBoldCursor2;
        ...
        if (aVar3 != null) {
            z12 = false;
            q(zf.a.i(aVar3.f48953b, aVar3.f48952a), !messageSuggestionParams.amount.k(), true, false);
        } else {
            z12 = false;
    ...
    public final boolean isTouchOutside(float f7, float f10) {
        a aVar;
        if (this.K && (aVar = this.f47091b) != null && f7 >= aVar.getX() && f7 <= aVar.getX() + aVar.getWidth() && f10 >= aVar.getY() && f10 <= aVar.getY() + aVar.getHeight()) {
            return false;
        }
    ...
    public final void n(boolean z10) {
        boolean z11;
        if (this.J == 0 && (this.H.f48953b >= 0 || this.I > 0)) {
            z11 = true;
        } else {
            z11 = false;
        }
        ci.d dVar = this.f47096s;
        if (dVar.W != z11) {
            dVar.setEnabled(z11);
    ...
    public final zf.a p() {
        if (this.H.f48952a == zf.b.f48955b) {
            return this.G;
        }
        return this.E;
    }
    ...
    public final void q(zf.a aVar, boolean z10, boolean z11, boolean z12) {
        ...
        if (aVar != null) {
            ...
            this.H = zf.a.i(0L, aVar5.f48952a);
            this.J |= 1;
        }
        long j3 = p().f48953b;
        zf.a aVar6 = this.H;
        ...
        boolean k10 = aVar6.k();
        zf.a aVar7 = this.f47099y;
        zf.a aVar8 = this.F;
        zf.b bVar2 = zf.b.f48955b;
        if (!k10) {
            zf.a aVar9 = this.H;
            if (aVar9.f48952a == bVar2) {
                aVar4 = aVar8;
            } else {
                aVar4 = aVar7;
            }
            if (aVar4.f48953b > aVar9.f48953b) {
                this.J |= 2;
            }
        }
        if (!z11 && aVar5.f48952a == this.H.f48952a) {
            z13 = false;
        } else {
            z13 = true;
        }
        if (!z11 && aVar5.f48953b == this.H.f48953b) {
            z14 = false;
        } else {
            z14 = true;
        }
        ...
        if (z13) {
            ...
            zf.b bVar4 = this.H.f48952a;
            TextView textView = this.f47094n;
            if (bVar4 == bVar3) {
            ...
            ImageView imageView2 = this.f47097w;
            if (z12) {
            ...
            a aVar10 = this.f47091b;
            if (aVar10 != null && aVar10.e != (bVar = this.H.f48952a)) {
                aVar10.e = bVar;
                aVar10.a();
            }
        } else {
