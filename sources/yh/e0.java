...
public final class e0 extends org.telegram.ui.ActionBar.f3 {
    ...
    public final int d;
    public final m40 e;
    public final yc0 f47004f;
    public final EditTextBoldCursor h;
    public final TextView f47005n;
    public final c0 f47006r;
    public final ci.d f47007s;
    public final org.telegram.ui.Components.p6 v;
    public final ImageView f47008w;
    public final ImageView f47009x;
    public final zf.a f47010y;
    ...
    public e0(final Context context, int i10, long j3, MessageSuggestionParams messageSuggestionParams, xn xnVar, final org.telegram.ui.ActionBar.d6 d6Var, int i11, Utilities.Callback callback) {
        ...
        this.f47003c = canManageMonoForum;
        ...
        if (!canManageMonoForum) {
            ...
            aVar.setOnClickListener(new View.OnClickListener(this) {
                ...
                public final void onClick(View view) {
                    switch (r4) {
                        case 0:
                            if (this.f46911b.H.f48896a == zf.b.f48898a) {
                        ...
                        default:
                            ...
                            org.telegram.ui.Components.e5.T(context, e0Var.I, new r5.d(e0Var, 19), d6Var, 0).f18414a.show();
                            return;
                    }
                }
            });
        ...
        LinearLayout f11 = ul.f(context, 1);
        ...
        this.f47006r = editTextBoldCursor2;
        ...
        if (aVar3 != null) {
            z12 = false;
            q(zf.a.i(aVar3.f48897b, aVar3.f48896a), !messageSuggestionParams.amount.k(), true, false);
        } else {
            z12 = false;
    ...
    public final boolean isTouchOutside(float f7, float f10) {
        a aVar;
        if (this.K && (aVar = this.f47002b) != null && f7 >= aVar.getX() && f7 <= aVar.getX() + aVar.getWidth() && f10 >= aVar.getY() && f10 <= aVar.getY() + aVar.getHeight()) {
            return false;
        }
    ...
    public final void n(boolean z10) {
        boolean z11;
        if (this.J == 0 && (this.H.f48897b >= 0 || this.I > 0)) {
            z11 = true;
        } else {
            z11 = false;
        }
        ci.d dVar = this.f47007s;
        if (dVar.W != z11) {
            dVar.setEnabled(z11);
    ...
    public final zf.a p() {
        if (this.H.f48896a == zf.b.f48899b) {
            return this.G;
        }
        return this.E;
    }
    ...
    public final void q(zf.a aVar, boolean z10, boolean z11, boolean z12) {
        ...
        if (aVar != null) {
            ...
            this.H = zf.a.i(0L, aVar5.f48896a);
            this.J |= 1;
        }
        long j3 = p().f48897b;
        zf.a aVar6 = this.H;
        ...
        boolean k10 = aVar6.k();
        zf.a aVar7 = this.f47010y;
        zf.a aVar8 = this.F;
        zf.b bVar2 = zf.b.f48899b;
        if (!k10) {
            zf.a aVar9 = this.H;
            if (aVar9.f48896a == bVar2) {
                aVar4 = aVar8;
            } else {
                aVar4 = aVar7;
            }
            if (aVar4.f48897b > aVar9.f48897b) {
                this.J |= 2;
            }
        }
        if (!z11 && aVar5.f48896a == this.H.f48896a) {
            z13 = false;
        } else {
            z13 = true;
        }
        if (!z11 && aVar5.f48897b == this.H.f48897b) {
            z14 = false;
        } else {
            z14 = true;
        }
        ...
        if (z13) {
            ...
            zf.b bVar4 = this.H.f48896a;
            TextView textView = this.f47005n;
            if (bVar4 == bVar3) {
            ...
            ImageView imageView = this.f47009x;
            ImageView imageView2 = this.f47008w;
            if (z12) {
            ...
            a aVar10 = this.f47002b;
            if (aVar10 != null && aVar10.e != (bVar = this.H.f48896a)) {
                aVar10.e = bVar;
                aVar10.a();
            }
        } else {
