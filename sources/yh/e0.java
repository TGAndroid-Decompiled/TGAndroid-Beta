...
public final class e0 extends org.telegram.ui.ActionBar.e3 {
    ...
    public final int d;
    public final m40 e;
    public final jd0 f47318f;
    public final EditTextBoldCursor h;
    public final TextView f47319n;
    public final c0 f47320r;
    public final ci.d f47321s;
    public final org.telegram.ui.Components.p6 v;
    public final ImageView f47322w;
    public final ImageView f47323x;
    public final zf.a f47324y;
    ...
    public e0(final Context context, int i10, long j3, MessageSuggestionParams messageSuggestionParams, wn wnVar, final org.telegram.ui.ActionBar.d6 d6Var, int i11, Utilities.Callback callback) {
        ...
        this.f47317c = canManageMonoForum;
        ...
        this.f47324y = zf.a.g(appGlobalConfig.starsSuggestedPostAmountMin.get(), bVar2);
        ...
        if (!canManageMonoForum) {
            ...
            aVar.setOnClickListener(new View.OnClickListener(this) {
                ...
                public final void onClick(View view) {
                    switch (r4) {
                        case 0:
                            if (this.f47218b.H.f49226a == zf.b.f49228a) {
                                new m7(context, d6Var).show();
                                return;
                            }
                            return;
                        default:
                            e0 e0Var = this.f47218b;
                            org.telegram.ui.Components.e5.T(context, e0Var.I, new r5.d(e0Var, 19), d6Var, 0).f19950a.show();
                            return;
                    }
                }
            });
        ...
        this.f47320r = editTextBoldCursor2;
        ...
        if (aVar3 != null) {
            z12 = false;
            q(zf.a.i(aVar3.f49227b, aVar3.f49226a), !messageSuggestionParams.amount.k(), true, false);
        } else {
            z12 = false;
    ...
    public final boolean isTouchOutside(float f7, float f10) {
        a aVar;
        if (this.K && (aVar = this.f47316b) != null && f7 >= aVar.getX() && f7 <= aVar.getX() + aVar.getWidth() && f10 >= aVar.getY() && f10 <= aVar.getY() + aVar.getHeight()) {
            return false;
        }
    ...
    public final void n(boolean z10) {
        boolean z11;
        if (this.J == 0 && (this.H.f49227b >= 0 || this.I > 0)) {
            z11 = true;
        } else {
            z11 = false;
        }
        ci.d dVar = this.f47321s;
        if (dVar.W != z11) {
            dVar.setEnabled(z11);
    ...
    public final zf.a p() {
        if (this.H.f49226a == zf.b.f49229b) {
            return this.G;
        }
        return this.E;
    }
    ...
    public final void q(zf.a aVar, boolean z10, boolean z11, boolean z12) {
        ...
        if (aVar != null) {
            ...
            this.H = zf.a.i(0L, aVar5.f49226a);
            this.J |= 1;
        }
        long j3 = p().f49227b;
        zf.a aVar6 = this.H;
        ...
        boolean k10 = aVar6.k();
        zf.a aVar7 = this.f47324y;
        zf.a aVar8 = this.F;
        zf.b bVar2 = zf.b.f49229b;
        if (!k10) {
            zf.a aVar9 = this.H;
            if (aVar9.f49226a == bVar2) {
                aVar4 = aVar8;
            } else {
                aVar4 = aVar7;
            }
        ...
        if (!z11 && aVar5.f49226a == this.H.f49226a) {
            z13 = false;
        } else {
            z13 = true;
        }
        if (!z11 && aVar5.f49227b == this.H.f49227b) {
            z14 = false;
        } else {
            z14 = true;
        }
        ...
        if (z13) {
            ...
            zf.b bVar4 = this.H.f49226a;
            TextView textView = this.f47319n;
            if (bVar4 == bVar3) {
            ...
            ImageView imageView = this.f47323x;
            ImageView imageView2 = this.f47322w;
            if (z12) {
            ...
            a aVar10 = this.f47316b;
            if (aVar10 != null && aVar10.e != (bVar = this.H.f49226a)) {
                aVar10.e = bVar;
                aVar10.a();
            }
        } else {
