...
public final class e0 extends org.telegram.ui.ActionBar.e3 {
    ...
    public final pq[] M;
    public boolean N;
    public final a f47304b;
    public final boolean f47305c;
    public final int d;
    public final m40 e;
    public final jd0 f47306f;
    public final EditTextBoldCursor h;
    public final TextView f47307n;
    public final c0 f47308r;
    public final ci.d f47309s;
    public final org.telegram.ui.Components.p6 v;
    public final ImageView f47310w;
    public final ImageView f47311x;
    public final zf.a f47312y;
    ...
    public e0(final Context context, int i10, long j3, MessageSuggestionParams messageSuggestionParams, wn wnVar, final org.telegram.ui.ActionBar.d6 d6Var, int i11, Utilities.Callback callback) {
        ...
        this.f47305c = canManageMonoForum;
        ...
        if (!canManageMonoForum) {
            ...
            aVar.setOnClickListener(new View.OnClickListener(this) {
                ...
                public final void onClick(View view) {
                    switch (r4) {
                        case 0:
                            if (this.f47206b.H.f49214a == zf.b.f49216a) {
                                new m7(context, d6Var).show();
                                return;
                            }
                            return;
                        default:
                            e0 e0Var = this.f47206b;
                            org.telegram.ui.Components.e5.T(context, e0Var.I, new r5.d(e0Var, 19), d6Var, 0).f19935a.show();
                            return;
                    }
                }
            });
        ...
        f11.addView(jd0Var, w7.y5.k(18.0f, 0.0f, 18.0f, 0.0f, -1, 58));
        ImageView imageView2 = new ImageView(context);
        this.f47310w = imageView2;
        ...
        this.f47308r = editTextBoldCursor2;
        ...
        jd0Var2.setOnClickListener(new View.OnClickListener(this) {
            public final e0 f47206b;
        ...
        f11.addView(jd0Var2, w7.y5.k(18.0f, 24.0f, 18.0f, 0.0f, -1, 58));
        ...
        if (aVar3 != null) {
            z12 = false;
            q(zf.a.i(aVar3.f49215b, aVar3.f49214a), !messageSuggestionParams.amount.k(), true, false);
        } else {
            z12 = false;
    ...
    public final boolean isTouchOutside(float f7, float f10) {
        a aVar;
        if (this.K && (aVar = this.f47304b) != null && f7 >= aVar.getX() && f7 <= aVar.getX() + aVar.getWidth() && f10 >= aVar.getY() && f10 <= aVar.getY() + aVar.getHeight()) {
            return false;
        }
    ...
    public final void n(boolean z10) {
        boolean z11;
        if (this.J == 0 && (this.H.f49215b >= 0 || this.I > 0)) {
            z11 = true;
        } else {
            z11 = false;
        }
        ci.d dVar = this.f47309s;
        if (dVar.W != z11) {
            dVar.setEnabled(z11);
    ...
    public final zf.a p() {
        if (this.H.f49214a == zf.b.f49217b) {
            return this.G;
        }
        return this.E;
    }
    ...
    public final void q(zf.a aVar, boolean z10, boolean z11, boolean z12) {
        ...
        if (aVar != null) {
            ...
            this.H = zf.a.i(0L, aVar5.f49214a);
            this.J |= 1;
        }
        long j3 = p().f49215b;
        zf.a aVar6 = this.H;
        ...
        boolean k10 = aVar6.k();
        zf.a aVar7 = this.f47312y;
        zf.a aVar8 = this.F;
        zf.b bVar2 = zf.b.f49217b;
        if (!k10) {
            zf.a aVar9 = this.H;
            if (aVar9.f49214a == bVar2) {
                aVar4 = aVar8;
            } else {
                aVar4 = aVar7;
            }
            if (aVar4.f49215b > aVar9.f49215b) {
                this.J |= 2;
            }
        }
        if (!z11 && aVar5.f49214a == this.H.f49214a) {
            z13 = false;
        } else {
            z13 = true;
        }
        if (!z11 && aVar5.f49215b == this.H.f49215b) {
            z14 = false;
        } else {
            z14 = true;
        }
        ...
        if (z13) {
            ...
            zf.b bVar4 = this.H.f49214a;
            TextView textView = this.f47307n;
            if (bVar4 == bVar3) {
            ...
            ImageView imageView = this.f47311x;
            ImageView imageView2 = this.f47310w;
            if (z12) {
            ...
            a aVar10 = this.f47304b;
            if (aVar10 != null && aVar10.e != (bVar = this.H.f49214a)) {
                aVar10.e = bVar;
                aVar10.a();
            }
        } else {
        ...
        if (z13 || z15) {
            ...
            if ((i13 & 4) != 0) {
                ...
                objArr[c10] = p().f();
                jd0Var.setText(LocaleController.formatString(i14, objArr));
            } else if ((i13 & 2) != 0) {
                ...
                objArr2[c10] = f18;
                jd0Var.setText(LocaleController.formatString(i15, objArr2));
            } else {
                if (this.H.f49214a == bVar3) {
        ...
        if (z13 || z14 || z15) {
            ...
            if (i16 == 0) {
                if (!this.H.k()) {
                    ...
                    dVar.g(w7.V0(z16, formatString, pqVarArr), z12, true);
                } else {
