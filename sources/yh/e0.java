...
public final class e0 extends org.telegram.ui.ActionBar.f3 {
    ...
    public final oq[] M;
    public boolean N;
    public final a f47377b;
    public final boolean f47378c;
    public final int d;
    public final l40 e;
    public final kd0 f47379f;
    public final EditTextBoldCursor h;
    public final TextView f47380n;
    public final c0 f47381r;
    public final ci.d f47382s;
    public final org.telegram.ui.Components.o6 v;
    public final ImageView f47383w;
    public final ImageView f47384x;
    public final zf.a f47385y;
    ...
    public e0(final Context context, int i10, long j3, MessageSuggestionParams messageSuggestionParams, zn znVar, final org.telegram.ui.ActionBar.f6 f6Var, int i11, Utilities.Callback callback) {
        ...
        this.f47378c = canManageMonoForum;
        if (!canManageMonoForum && !u5.y(i10, true).j()) {
            z10 = false;
        } else {
            z10 = true;
        }
        ...
        if (!canManageMonoForum) {
            ...
            aVar.setOnClickListener(new View.OnClickListener(this) {
                ...
                public final void onClick(View view) {
                    switch (r4) {
                        case 0:
                            if (this.f47284b.H.f49272a == zf.b.f49274a) {
                                new m7(context, f6Var).show();
                                return;
                            }
                            return;
                        default:
                            e0 e0Var = this.f47284b;
                            org.telegram.ui.Components.d5.T(context, e0Var.I, new r5.d(e0Var, 19), f6Var, 0).f18674a.show();
                            return;
                    }
                }
            });
        ...
        LinearLayout f11 = rk.f(context, 1);
        ...
        this.f47381r = editTextBoldCursor2;
        ...
        if (aVar3 != null) {
            z12 = false;
            q(zf.a.i(aVar3.f49273b, aVar3.f49272a), !messageSuggestionParams.amount.k(), true, false);
        } else {
            z12 = false;
    ...
    public final boolean isTouchOutside(float f7, float f10) {
        a aVar;
        if (this.K && (aVar = this.f47377b) != null && f7 >= aVar.getX() && f7 <= aVar.getX() + aVar.getWidth() && f10 >= aVar.getY() && f10 <= aVar.getY() + aVar.getHeight()) {
            return false;
        }
    ...
    public final void n(boolean z10) {
        boolean z11;
        if (this.J == 0 && (this.H.f49273b >= 0 || this.I > 0)) {
            z11 = true;
        } else {
            z11 = false;
        }
        ci.d dVar = this.f47382s;
        if (dVar.W != z11) {
            dVar.setEnabled(z11);
    ...
    public final zf.a p() {
        if (this.H.f49272a == zf.b.f49275b) {
            return this.G;
        }
        return this.E;
    }
    ...
    public final void q(zf.a aVar, boolean z10, boolean z11, boolean z12) {
        ...
        if (aVar != null) {
            ...
            this.H = zf.a.i(0L, aVar5.f49272a);
            this.J |= 1;
        }
        long j3 = p().f49273b;
        zf.a aVar6 = this.H;
        ...
        boolean k10 = aVar6.k();
        zf.a aVar7 = this.f47385y;
        zf.a aVar8 = this.F;
        zf.b bVar2 = zf.b.f49275b;
        if (!k10) {
            zf.a aVar9 = this.H;
            if (aVar9.f49272a == bVar2) {
                aVar4 = aVar8;
            } else {
                aVar4 = aVar7;
            }
            if (aVar4.f49273b > aVar9.f49273b) {
                this.J |= 2;
            }
        }
        if (!z11 && aVar5.f49272a == this.H.f49272a) {
            z13 = false;
        } else {
            z13 = true;
        }
        if (!z11 && aVar5.f49273b == this.H.f49273b) {
            z14 = false;
        } else {
            z14 = true;
        }
        ...
        if (z13) {
            ...
            zf.b bVar4 = this.H.f49272a;
            TextView textView = this.f47380n;
            if (bVar4 == bVar3) {
            ...
            ImageView imageView = this.f47384x;
            ImageView imageView2 = this.f47383w;
            if (z12) {
            ...
            a aVar10 = this.f47377b;
            if (aVar10 != null && aVar10.e != (bVar = this.H.f49272a)) {
                aVar10.e = bVar;
                aVar10.a();
            }
        } else {
        ...
        if (z13 || z14 || z15) {
            ...
            if (i16 == 0) {
                if (!this.H.k()) {
                    ...
                    dVar.g(w7.V0(z16, formatString, oqVarArr), z12, true);
                } else {
