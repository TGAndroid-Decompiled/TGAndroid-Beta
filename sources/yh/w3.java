...
public class w3 extends FrameLayout {
    ...
    public final org.telegram.ui.ActionBar.e6 f47870a;
    public com.google.android.gms.common.api.internal.r f47871a0;
    public final FrameLayout f47872b;
    public com.google.android.gms.common.api.internal.r f47873b0;
    public final o3 f47874c;
    public boolean f47875c0;
    public final u9[] d;
    public boolean f47876d0;
    public final TL_stars.starGiftAttributeModel[] e;
    public float f47877e0;
    public final LinearLayout[] f47878f;
    public float f47879f0;
    public float f47880g0;
    public final FrameLayout.LayoutParams[] h;
    public ValueAnimator f47881h0;
    public final x2 f47882i0;
    public final Paint[] f47883j0;
    public final RadialGradient[] f47884k0;
    public final Matrix[] f47885l0;
    public RadialGradient m0;
    public final xh.j1 f47886n;
    public final Matrix f47887n0;
    public final Paint f47888o0;
    public final TL_stars.starGiftAttributePattern[] f47889p0;
    public final org.telegram.ui.Components.m5[] f47890q0;
    public final c90[] f47891r;
    public int f47892r0;
    public final c90 f47893s;
    public float f47894s0;
    public float f47895t0;
    public ValueAnimator f47896u0;
    public final TextView v;
    public final RectF f47897v0;
    public int f47898w;
    public j8 f47899w0;
    public final FrameLayout f47900x;
    public final int[] f47901x0;
    public final c90[] f47902y;
    public final int[] f47903y0;
    public final int[] f47904z0;
    ...
    public w3(Context context, org.telegram.ui.ActionBar.e6 e6Var, Runnable runnable, View.OnClickListener onClickListener, u0 u0Var, View.OnClickListener onClickListener2, View.OnClickListener onClickListener3, View.OnClickListener onClickListener4, View.OnClickListener onClickListener5, View.OnClickListener onClickListener6) {
        ...
        this.f47878f = new LinearLayout[5];
        this.h = new FrameLayout.LayoutParams[5];
        this.f47891r = new c90[5];
        this.f47902y = new c90[5];
        this.E = new LinearLayout.LayoutParams[5];
        this.F = new xh.l0[5];
        this.U = new f4.d(0, 0);
        this.V = new TL_stars.starGiftAttributeBackdrop[3];
        this.f47882i0 = new x2(this, 1);
        this.f47883j0 = new Paint[3];
        this.f47884k0 = new RadialGradient[3];
        this.f47885l0 = new Matrix[3];
        this.f47887n0 = new Matrix();
        this.f47888o0 = new Paint(1);
        this.f47889p0 = new TL_stars.starGiftAttributePattern[2];
        this.f47890q0 = new org.telegram.ui.Components.m5[2];
        int i10 = 0;
        while (true) {
            Paint[] paintArr = this.f47883j0;
        ...
        int i11 = 0;
        while (true) {
            org.telegram.ui.Components.m5[] m5VarArr = this.f47890q0;
        ...
        this.f47895t0 = 1.0f;
        this.f47897v0 = new RectF();
        this.f47901x0 = new int[12];
        this.f47903y0 = new int[12];
        this.f47904z0 = new int[12];
        this.f47870a = e6Var;
        this.R = onClickListener4;
        this.S = onClickListener5;
        this.T = onClickListener6;
        setWillNotDraw(false);
        this.f47872b = new FrameLayout(context);
        int i12 = 0;
        while (true) {
            u9[] u9VarArr = this.d;
            float f10 = 0.0f;
            ...
            this.f47872b.addView(this.d[i12], w7.x5.e(-1, -1, 119));
            u9 u9Var = this.d[i12];
            if (i12 == 0) {
                f10 = 1.0f;
            }
        ...
        this.f47900x = new FrameLayout(context);
        int i14 = 0;
        while (true) {
            LinearLayout[] linearLayoutArr = this.f47878f;
            if (i14 >= linearLayoutArr.length) {
                break;
            }
            linearLayoutArr[i14] = new LinearLayout(context);
            this.f47878f[i14].setOrientation(1);
            if (i14 == 2) {
                FrameLayout frameLayout = new FrameLayout(context);
                this.J = frameLayout;
                this.f47878f[i14].addView(frameLayout, w7.x5.q(-1, 144, 119));
                ...
                this.f47891r[i14] = new c90(context, null);
                this.f47891r[i14].setTextColor(-1);
                this.f47891r[i14].setTextSize(1, 20.0f);
                this.f47891r[i14].setTypeface(AndroidUtilities.bold());
                this.f47891r[i14].setSingleLine();
                c90 c90Var2 = this.f47891r[i14];
                TextUtils.TruncateAt truncateAt = TextUtils.TruncateAt.END;
                c90Var2.setEllipsize(truncateAt);
                this.f47891r[i14].setGravity(17);
                frameLayout.addView(this.f47891r[i14], w7.x5.d(-1, -2.0f, 49, 16.0f, 95.33f, 16.0f, 0.0f));
                this.f47902y[i14] = new c90(context, null);
                this.f47902y[i14].setTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18940j5, e6Var));
                this.f47902y[i14].setTextSize(1, 14.0f);
                this.f47902y[i14].setLinkTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.gc, e6Var));
                this.f47902y[i14].setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
                this.f47902y[i14].setDisablePaddingsOffsetY(true);
                this.f47902y[i14].setSingleLine();
                this.f47902y[i14].setGravity(17);
                this.f47902y[i14].setEllipsize(truncateAt);
                frameLayout.addView(this.f47902y[i14], w7.x5.d(-1, -2.0f, 49, 16.0f, 122.0f, 16.0f, 0.0f));
            } else if (i14 == 4) {
                z2 z2Var = new z2(context, e6Var);
                this.L = z2Var;
                this.f47878f[i14].addView(z2Var, w7.x5.n(-1, -2));
                View view = this.f47878f[i14];
                ...
                this.f47891r[i14] = new c90(context, null);
                this.f47891r[i14].setTextColor(i14 == 3 ? -1 : org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18940j5, e6Var));
                this.f47891r[i14].setTextSize(1, 20.0f);
                this.f47891r[i14].setTypeface(AndroidUtilities.bold());
                this.f47891r[i14].setGravity(17);
                this.f47878f[i14].addView(this.f47891r[i14], w7.x5.t(-1, -2, 17, 24, i14 == 3 ? 10 : 0, 24, 0));
                if (i14 == 0) {
                    this.f47878f[i14].addView(this.f47893s, w7.x5.t(-2, -2, 17, 0, 4, 0, 4));
                    this.f47878f[i14].addView(this.v, w7.x5.s(-2, 17, 0, 6, 0, 19.33f, 2));
                }
                if (i14 == 0) {
                    this.f47902y[i14] = new c90(context, null);
                    this.f47902y[i14].setTextColor(i14 == 3 ? org.telegram.ui.ActionBar.i6.l1(0.75f, -1) : org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18940j5, e6Var));
                    this.f47902y[i14].setTextSize(1, 14.0f);
                    this.f47902y[i14].setGravity(17);
                    this.f47902y[i14].setLinkTextColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.gc, e6Var));
                    this.f47902y[i14].setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
                    this.f47902y[i14].setDisablePaddingsOffsetY(true);
                    this.f47900x.addView(this.f47902y[i14], w7.x5.e(-2, -2, 17));
                    this.f47900x.addView(this.N, w7.x5.a(-2.0f, 20.33f, 17));
                    LinearLayout linearLayout = this.f47878f[i14];
                    FrameLayout frameLayout2 = this.f47900x;
                    ...
                    this.f47902y[i14].setLineSpacing(AndroidUtilities.dp(2.0f), 1.0f);
                    this.f47902y[i14].setDisablePaddingsOffsetY(true);
                    LinearLayout linearLayout2 = this.f47878f[i14];
                    c90 c90Var3 = this.f47902y[i14];
                ...
                this.f47878f[i14].addView(this.F[i14], w7.x5.t(-1, -2, 17, 24, 8, 24, 0));
            }
            if (i14 == 0) {
                this.f47878f[i14].addView(this.H, w7.x5.t(-1, -2, 7, 0, 15, 0, 0));
            }
            View view2 = this.f47878f[i14];
        ...
        addView(this.f47872b, w7.x5.d(160, 160.0f, 49, 0.0f, 8.0f, 0.0f, 0.0f));
        ...
        xh.l1 l1Var = j1Var.f45937a;
        if (l1Var.f45971f == null) {
            j8 j8Var = new j8(2, 12);
            l1Var.f45971f = j8Var;
            j8Var.h = 5.0f;
        }
        Path path = l1Var.f45970c;
        float f11 = l1Var.e;
        l1Var.f45972g = true;
    ...
    public final void a() {
        ValueAnimator valueAnimator = this.f47896u0;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.f47896u0 = null;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        this.f47896u0 = ofFloat;
        ofFloat.addUpdateListener(new s3(this, 1));
        this.f47896u0.addListener(new t3(this, 4));
        this.f47896u0.setDuration(320L);
        this.f47896u0.setInterpolator(qr.f27421g);
        this.f47896u0.start();
    }

    public final int b(Canvas canvas, float f7, float f10, float f11, float f12) {
        int i10 = this.f47892r0;
        RadialGradient[] radialGradientArr = this.f47884k0;
        TL_stars.starGiftAttributeBackdrop[] stargiftattributebackdropArr = this.V;
        Matrix[] matrixArr = this.f47885l0;
        Paint[] paintArr = this.f47883j0;
        int i11 = 0;
        if (i10 == 0) {
            if (this.f47894s0 > 0.0f && stargiftattributebackdropArr[2] != null) {
            ...
            if (this.f47894s0 < 1.0f && stargiftattributebackdropArr[1] != null) {
                paintArr[1].setAlpha((int) ((1.0f - this.f47894s0) * this.U.a(1) * 255.0f));
                matrixArr[1].reset();
        ...
        if (this.f47894s0 > 0.0f && stargiftattributebackdropArr[2] != null) {
            paintArr[2].setAlpha((int) (this.U.a(1) * 255.0f * this.f47894s0));
            matrixArr[2].reset();
            matrixArr[2].postTranslate(f7, f10);
            radialGradientArr[2].setLocalMatrix(matrixArr[2]);
            canvas.drawRect(0.0f, 0.0f, f11, f12, paintArr[2]);
    ...
    public final void c(Canvas canvas, float f7, float f10, float f11, float f12) {
        ...
        int d = i0.a.d(this.f47894s0, i10, i11);
        org.telegram.ui.Components.m5[] m5VarArr = this.f47890q0;
        m5VarArr[1].k(Integer.valueOf(d));
        j0.a(canvas, 0, m5VarArr[1], f11, f12, this.U.a(1), this.f47895t0);
        canvas.restore();
    }
    ...
    public void d(f4.d dVar) {
        ...
        if ((stargiftattributebackdropArr[0] != null && dVar.f8873b == 2) || (stargiftattributebackdropArr[1] != null && dVar.f8873b == 1)) {
            i10 = 0;
        } else {
            i10 = 8;
        }
        ...
        int v02 = org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18940j5, this.f47870a);
        int i22 = 0;
        while (true) {
            c90VarArr = this.f47902y;
            if (i22 >= 2) {
                break;
            }
            c90 c90Var = this.f47891r[i22];
            ...
            if (i22 != 0 && i22 != 2) {
                ...
                i14 = i0.a.d(this.f47894s0, i15, i16);
            } else {
            ...
            if (z11) {
                ...
                if (i22 == 0) {
                    this.f47900x.setLayoutParams(layoutParamsArr2[i22]);
                } else {
        ...
        u9VarArr[1].setAlpha((1.0f - this.f47894s0) * dVar.a(1));
        u9VarArr[2].setAlpha(dVar.a(1) * this.f47894s0);
        float lerp3 = AndroidUtilities.lerp(1.0f, this.f47880g0, dVar.a(2));
        FrameLayout frameLayout = this.f47872b;
        frameLayout.setScaleX(lerp3);
        frameLayout.setScaleY(AndroidUtilities.lerp(1.0f, this.f47880g0, dVar.a(2)));
        frameLayout.setTranslationX(dVar.a(2) * this.f47877e0);
        frameLayout.setTranslationY((dVar.a(2) * this.f47879f0) + (dVar.a(1) * AndroidUtilities.dp(16.0f)));
        ...
        if (this.f47875c0 && this.U.b(0)) {
            i12 = 0;
        } else {
            i12 = 8;
        }
        xh.j1 j1Var = this.f47886n;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        int[] iArr4 = this.f47904z0;
        int[] iArr5 = this.f47903y0;
        int[] iArr6 = this.f47901x0;
        if (stargiftattributebackdrop != null) {
        ...
        o3 o3Var2 = this.f47874c;
        if (o3Var2.f47527s == null && o3Var2.v == null && o3Var2.f47528w == null) {
            w3Var = this;
            f12 = f7;
            f11 = f10;
            iArr3 = iArr4;
            ...
            float f13 = f7;
            i3 i3Var = o3Var2.f47527s;
            float f14 = f10;
            float f15 = o3Var2.f47529x;
            int[] iArr7 = this.f47903y0;
            int[] iArr8 = this.f47901x0;
            int[] iArr9 = this.f47904z0;
            f11 = f14;
            iArr = iArr5;
            iArr2 = iArr6;
            iArr3 = iArr4;
            ...
            o3Var2.a(canvas2, o3Var2.v, o3Var2.f47530y, width2, realHeight, iArr7, iArr8, iArr9);
            o3Var2.a(canvas2, o3Var2.f47528w, o3Var2.E, width2, realHeight, iArr7, iArr8, iArr9);
            o3Var = o3Var2;
            w3Var.invalidate();
        }
        if (i10 > 0 && stargiftattributebackdropArr[0] != null) {
            ...
            org.telegram.ui.Components.m5[] m5VarArr = w3Var.f47890q0;
            if (max2 > 0.0f) {
                canvas2.save();
            ...
            if (w3Var.U.a(2) > 0.0f) {
                ...
                LinearLayout[] linearLayoutArr = w3Var.f47878f;
            ...
            if (textView != null && w3Var.f47898w != i14) {
                w3Var.f47898w = i14;
                textView.setTextColor(i14);
                org.telegram.ui.ActionBar.i6.B1(textView.getBackground(), i15, false);
            }
            if (o3Var.f47527s != null || o3Var.v != null || o3Var.f47528w != null) {
                w3Var.f47902y[0].setTextColor(i14);
            }
            if (w3Var.U.a(2) > 0.0f) {
                if (w3Var.f47899w0 == null) {
                    w3Var.f47899w0 = new j8(1, 12);
                }
                FrameLayout frameLayout2 = w3Var.f47872b;
                ...
                RectF rectF2 = w3Var.f47897v0;
                rectF2.set(measuredWidth - scaleX, measuredHeight - scaleY, measuredWidth + scaleX, f17);
                w3Var.f47899w0.g(rectF2);
                w3Var.f47899w0.d();
                w3Var.f47899w0.a(canvas2, org.telegram.ui.ActionBar.i6.l1(w3Var.U.a(2), -1));
                w3Var.invalidate();
            }
        }
        if (w3Var.U.a(1) > 0.0f) {
    ...
    public final void e(int i10, TL_stars.starGiftAttributeBackdrop stargiftattributebackdrop) {
        ...
        if (i10 == 0) {
            ...
            this.f47888o0.setShader(radialGradient2);
        }
        Matrix[] matrixArr = this.f47885l0;
        if (matrixArr[i10] == null) {
            matrixArr[i10] = new Matrix();
        }
        this.f47883j0[i10].setShader(radialGradientArr[i10]);
    }
    ...
    public final void f(TL_stars.StarGift starGift, boolean z10, boolean z11, boolean z12) {
        ...
        if (z15) {
            ...
            if (z13) {
                ...
                v3Var.b(i10, LocaleController.getString(i11), false);
            }
            float f7 = 1.0f;
            if (starGift.resell_amount != null) {
                ...
                if (resellAmount.f48945a == bVar2) {
                    z14 = true;
                } else {
                    z14 = false;
                }
                CharSequence formatSpannable = LocaleController.formatSpannable(i13, x7.S0("⭐️ " + ((Object) x7.J0(resellAmount.o(), 1.0f, ',')), z14), Float.valueOf(0.9f));
                TextView textView = this.N;
            ...
            this.f47875c0 = starGift.crafted;
            this.f47886n.f45937a.d(stargiftattributebackdropArr[0], false, true);
        } else {
    ...
    public final void g(int i10, TL_stars.starGiftAttributePattern stargiftattributepattern, boolean z10) {
        if (stargiftattributepattern != null) {
            TL_stars.starGiftAttributePattern[] stargiftattributepatternArr = this.f47889p0;
            if (stargiftattributepatternArr[i10] != stargiftattributepattern) {
                stargiftattributepatternArr[i10] = stargiftattributepattern;
                this.f47890q0[i10].i(stargiftattributepattern.document, z10);
            }
        }
    }
    ...
    public int getFinalHeight() {
        ...
        if (d) {
            ...
            if (this.U.d(2)) {
                ...
                z2 z2Var = this.L;
                if (z2Var.getMeasuredHeight() > 0) {
                    return z2Var.getMeasuredHeight();
                }
    ...
    public final void h(int i10, CharSequence charSequence, CharSequence charSequence2, SpannableStringBuilder spannableStringBuilder, CharSequence charSequence3, TLObject tLObject, Spannable spannable) {
        int i11;
        int i12;
        this.f47891r[i10].setText(charSequence);
        FrameLayout frameLayout = this.f47900x;
        c90[] c90VarArr = this.f47902y;
        c90 c90Var = this.f47893s;
    ...
    public final void k() {
        this.f47880g0 = AndroidUtilities.dpf2(33.33f) / AndroidUtilities.dpf2(160.0f);
        FrameLayout frameLayout = this.f47872b;
        c90[] c90VarArr = this.f47891r;
        this.f47877e0 = ((((Math.min(c90VarArr[2].getPaint().measureText(c90VarArr[2].getText().toString()), c90VarArr[2].getWidth()) + c90VarArr[2].getWidth()) / 2.0f) + (c90VarArr[2].getX() + (-frameLayout.getLeft()))) + AndroidUtilities.dp(24.0f)) - (AndroidUtilities.dp(126.67f) / 2.0f);
        this.f47879f0 = (AndroidUtilities.dp(124.0f) + (-frameLayout.getTop())) - (AndroidUtilities.dp(126.67f) / 2.0f);
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        m5VarArr[0].b();
        m5VarArr[1].b();
        AndroidUtilities.cancelRunOnUIThread(this.f47882i0);
    }
    ...
    public void setPreviewAttributes(o0 o0Var) {
        f4.d dVar = this.U;
        if (dVar != null && dVar.f8873b == 1 && isAttachedToWindow()) {
            AndroidUtilities.cancelRunOnUIThread(this.f47882i0);
            ValueAnimator valueAnimator = this.f47881h0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                this.f47881h0 = null;
            }
            int i10 = 1 - this.f47892r0;
            this.f47892r0 = i10;
            u9[] u9VarArr = this.d;
            xi0 lottieAnimation = u9VarArr[2 - i10].getImageReceiver().getLottieAnimation();
            xi0 lottieAnimation2 = u9VarArr[this.f47892r0 + 1].getImageReceiver().getLottieAnimation();
            if (lottieAnimation2 != null && lottieAnimation != null) {
                lottieAnimation2.T(lottieAnimation.t(), false);
            }
            int i11 = this.f47892r0 + 1;
            ...
            g(1, o0Var.f47510b, true);
            int i12 = this.f47892r0 + 1;
            TL_stars.starGiftAttributeModel stargiftattributemodel = o0Var.f47511c;
            TL_stars.starGiftAttributeModel[] stargiftattributemodelArr = this.e;
            stargiftattributemodelArr[i12] = stargiftattributemodel;
            x7.Z0(u9VarArr[i12].getImageReceiver(), stargiftattributemodelArr[this.f47892r0 + 1].document, 160);
            a();
            float f7 = this.f47892r0;
            ValueAnimator ofFloat = ValueAnimator.ofFloat(1.0f - f7, f7);
            this.f47881h0 = ofFloat;
            ofFloat.addUpdateListener(new s3(this, 0));
            this.f47881h0.addListener(new t3(this, 3));
            this.f47881h0.setDuration(320L);
            this.f47881h0.setInterpolator(qr.h);
            this.f47881h0.start();
        }
    }
    ...
    public void setPreviewingAttributes(ArrayList<TL_stars.StarGiftAttribute> arrayList) {
        ...
        this.f47871a0 = new com.google.android.gms.common.api.internal.r(u5.m(arrayList, TL_stars.starGiftAttributePattern.class));
        this.f47873b0 = new com.google.android.gms.common.api.internal.r(u5.m(arrayList, TL_stars.starGiftAttributeBackdrop.class));
        this.f47902y[1].setTextSize(1, 14.0f);
        this.H.setVisibility(8);
        this.f47894s0 = 0.0f;
        this.f47892r0 = 0;
        g(1, (TL_stars.starGiftAttributePattern) this.f47871a0.c(), true);
        TL_stars.starGiftAttributeModel[] stargiftattributemodelArr = this.e;
        ...
        TL_stars.starGiftAttributeBackdrop stargiftattributebackdrop = (TL_stars.starGiftAttributeBackdrop) this.f47873b0.c();
        this.V[1] = stargiftattributebackdrop;
        e(1, stargiftattributebackdrop);
        stargiftattributemodelArr[2] = (TL_stars.starGiftAttributeModel) this.W.f6164f;
        x7.Z0(u9VarArr[2].getImageReceiver(), stargiftattributemodelArr[2].document, 160);
        x2 x2Var = this.f47882i0;
    ...
    public void setResellPrice(zf.a aVar) {
        ...
        if (!k10) {
            ...
            if (aVar.f48945a == zf.b.f48948b) {
                z10 = true;
            } else {
                z10 = false;
            }
            textView.setText(LocaleController.formatSpannable(i10, x7.U0(z10, "⭐️ " + ((Object) x7.J0(aVar.o(), 1.0f, ',')), 0.9f, null, 0.0f, 1.0f)));
            ...
            qr qrVar = qr.h;
            duration.setInterpolator(qrVar).setListener(new t3(this, 0)).start();
            ...
            qr qrVar2 = qr.h;
            duration2.setInterpolator(qrVar2).setListener(new t3(this, 2)).setListener(new t3(this, 1)).start();
    ...
    public void setWearPreview(TLObject tLObject) {
        ...
        this.f47891r[2].setText(str2);
        this.f47902y[2].setText(str);
        k();
        d(this.U);
    }
