...
public final class w3 extends sq {
    ...
    public final void draw(Canvas canvas) {
        ...
        paint.setAlpha((int) (this.f47863f * 255.0f));
        canvas.drawCircle(getBounds().centerX(), getBounds().centerY(), getBounds().width() / 2.0f, paint);
        float currentTimeMillis = ((float) ((System.currentTimeMillis() - this.e) % 400)) / 400.0f;
        Paint paint2 = this.f47862c;
        int alpha = paint2.getAlpha();
        paint2.setAlpha((int) (alpha * this.f47863f));
        ...
        for (int i10 = 0; i10 < 4; i10++) {
            ...
            paint2.setAlpha((int) (f7 * 255.0f * this.f47863f));
            canvas.save();
