...
public final class d4 extends View {
    ...
    public final int[] K;
    public final bo f47008a;
    public org.telegram.ui.Cells.a0 f47009b;
    public int f47010c;
    public final int[] d;
    public final int[] e;
    public final RectF f47011f;
    public final RectF h;
    public final Paint f47012n;
    public boolean f47013r;
    public final org.telegram.ui.Components.c6 f47014s;
    public final org.telegram.ui.Components.m6 v;
    public boolean f47015w;
    public final uh.i f47016x;
    public float f47017y;

    public d4(bo boVar) {
        super(boVar.getParentActivity());
        this.d = new int[2];
        this.e = new int[2];
        this.f47011f = new RectF();
        this.h = new RectF();
        this.f47012n = new Paint();
        new Paint();
        this.f47014s = new org.telegram.ui.Components.c6(this, 0L, 420L, qr.h);
        ...
        this.f47016x = new uh.i(20, this, boVar);
    }

    private MessageObject getMessageObject() {
        org.telegram.ui.Cells.a0 a0Var = this.f47009b;
    ...
    public final void b(float f7, c4 c4Var) {
        ...
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f47017y, f7);
        this.E = ofFloat;
        ...
        if (this.f47009b != null && !this.I) {
            ...
            if (messageObject != null && reactionsLayoutInBubble != null) {
                ...
                if (z10) {
                    ...
                    u5.y(boVar.getCurrentAccount(), false).d0(messageObject, this.f47008a, 1L, true, false, null);
                }
    ...
    public final void dispatchDraw(android.graphics.Canvas r24) {
        throw new UnsupportedOperationException("Method not decompiled: yh.d4.dispatchDraw(android.graphics.Canvas):void");
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.f47009b == null || this.I || (reactionsLayoutInBubble = getReactionsLayoutInBubble()) == null) {
            return false;
        }
        int action = motionEvent.getAction();
        uh.i iVar = this.f47016x;
        if (action == 0) {
    ...
    public void setMessageCell(org.telegram.ui.Cells.a0 a0Var) {
        ...
        this.f47010c = id2;
        org.telegram.ui.Cells.a0 a0Var3 = this.f47009b;
        if (a0Var3 instanceof org.telegram.ui.Cells.t1) {
            a0Var3.invalidate();
            ((org.telegram.ui.Cells.t1) this.f47009b).setInvalidateListener(new c4(this, 1));
        } else if (a0Var3 instanceof org.telegram.ui.Cells.w0) {
            a0Var3.invalidate();
            ((org.telegram.ui.Cells.w0) this.f47009b).setInvalidateListener(new c4(this, 1));
        }
        invalidate();
    }
}
