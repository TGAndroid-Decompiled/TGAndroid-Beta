...
public final class k1 implements Runnable {
    ...
    public final KeyEvent.Callback f47271b;
    ...
    public final void run() {
        ...
        switch (this.f47270a) {
            case 0:
                y3.S0((y3) this.f47271b, (MessageObject) this.f47272c, (ArrayList) this.d, (TL_stars.StarGift) this.e);
                return;
            case 1:
                y3 y3Var = (y3) this.f47271b;
                TLRPC.TL_error tL_error = (TLRPC.TL_error) this.f47272c;
                ...
                return;
            default:
                y2 y2Var = (y2) this.f47271b;
                TL_stars.StarGift starGift = (TL_stars.StarGift) this.e;
                ArrayList arrayList = (ArrayList) this.d;
                Runnable runnable = (Runnable) this.f47272c;
                org.telegram.ui.Components.p6 p6Var = y2Var.H;
                y2Var.f47934h0 = false;
                if (starGift == null) {
                    bj0 bj0Var = y2Var.f47938l0;
                    if (bj0Var != null) {
                        bj0Var.d();
                    ...
                    while (i12 < arrayList.size()) {
                        ...
                        xh.j1 j1Var = new xh.j1(y2Var.getContext(), y2Var.W, y2Var.f47923a);
                        j1Var.g(starGift2, false, false, false, false, true);
                        j1Var.f45894x.setVisibility(8);
