...
public final class w6 extends ReplacementSpan {
    ...
    public w6(int i10, String str) {
        ...
        this.f48187b = new t01(str, 13.0f, AndroidUtilities.bold());
    }
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        ...
        int i15 = i12 + i14;
        rectF.set(f7, (i15 - AndroidUtilities.dp(20.0f)) / 2.0f, AndroidUtilities.dp(12.0f) + f7 + this.f48187b.f28363c, (AndroidUtilities.dp(20.0f) + i15) / 2.0f);
    ...
    public final int getSize(Paint paint, CharSequence charSequence, int i10, int i11, Paint.FontMetricsInt fontMetricsInt) {
        return (int) (AndroidUtilities.dp(12.0f) + this.f48187b.f28363c);
    }
}
