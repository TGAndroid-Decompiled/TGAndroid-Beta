...
public final class o3 extends FrameLayout {
    public final x0 f47798a;
    public final n3 f47799b;
    public final n3 f47800c;
    public final n3 d;
    public boolean e;
    public final g20 f47801f;
    public final RectF h;

    public o3(Context context, org.telegram.ui.ActionBar.d6 d6Var, x0 x0Var) {
        super(context);
        this.f47801f = new g20();
        this.h = new RectF();
        this.f47798a = x0Var;
    ...
    public final void a(e3 e3Var, float f7, boolean z10, e3 e3Var2, float f10, boolean z11, e3 e3Var3, float f11, boolean z12) {
        x0 x0Var = this.f47798a;
        n3 n3Var = this.f47799b;
        if (e3Var != null) {
            if (z10) {
                f7 = Math.max(0.5f, f7);
            }
            n3Var.setVisibility(0);
            n3Var.e(e3Var.f47318a, e3Var.f47319b, x0Var);
            n3Var.setTranslationY(AndroidUtilities.dp(36.0f) * ((f7 - 0.5f) / 1.5f));
        } else {
            n3Var.setVisibility(4);
        }
        n3 n3Var2 = this.f47800c;
        if (e3Var2 != null) {
            float f12 = f10;
            if (z11) {
            ...
            n3Var2.e(e3Var2.f47318a, e3Var2.f47319b, x0Var);
        ...
        if (e3Var3 != null) {
            ...
            n3Var3.e(e3Var3.f47318a, e3Var3.f47319b, x0Var);
