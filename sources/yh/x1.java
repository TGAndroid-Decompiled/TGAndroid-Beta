    ...
    public final void run(Object obj) {
        ...
        switch (this.f47979a) {
            ...
            case 1:
                ...
                a4 a4Var2 = this.f47980b;
                a4Var2.getClass();
                if (stargiftupgradepreview != null) {
                    a4Var2.f46983h1 = stargiftupgradepreview.sample_attributes;
                    a4Var2.f46985i1 = stargiftupgradepreview.prices;
                    a4Var2.f46987j1 = stargiftupgradepreview.next_prices;
                    a4Var2.b2();
                    return;
                }
                return;
            case 2:
                this.f47980b.dismiss(((Boolean) obj).booleanValue());
                return;
            default:
                TL_stars.SavedStarGift savedStarGift = (TL_stars.SavedStarGift) obj;
                a4 a4Var3 = this.f47980b;
                a4Var3.K0 = false;
                a4Var3.L0 = true;
                if (savedStarGift != null) {
                    a4Var3.f46979f1 = Boolean.valueOf(savedStarGift.unsaved);
