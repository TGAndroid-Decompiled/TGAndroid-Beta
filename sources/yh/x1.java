    ...
    public final void run(Object obj) {
        ...
        switch (this.f48260a) {
            ...
            case 1:
                ...
                y3 y3Var2 = this.f48261b;
                y3Var2.getClass();
                if (stargiftupgradepreview != null) {
                    y3Var2.f48335h1 = stargiftupgradepreview.sample_attributes;
                    y3Var2.f48337i1 = stargiftupgradepreview.prices;
                    y3Var2.f48339j1 = stargiftupgradepreview.next_prices;
                    y3Var2.b2();
                    return;
                }
                return;
            case 2:
                this.f48261b.dismiss(((Boolean) obj).booleanValue());
                return;
            default:
                TL_stars.SavedStarGift savedStarGift = (TL_stars.SavedStarGift) obj;
                y3 y3Var3 = this.f48261b;
                y3Var3.K0 = false;
                y3Var3.L0 = true;
                if (savedStarGift != null) {
                    y3Var3.f48331f1 = Boolean.valueOf(savedStarGift.unsaved);
