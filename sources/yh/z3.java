...
public final class z3 extends sa {
    public final ArrayList f48075a0;
    public final LimitPreviewView f48076b0;

    public z3(Context context, long j3, ArrayList arrayList, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context, f6Var);
        float f7;
        int i10;
        this.f48075a0 = arrayList;
        ...
        this.f48076b0 = limitPreviewView;
        ...
        this.Y = frameLayout;
        frameLayout.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18933h5, this.resourcesProvider));
        View view = new View(getContext());
        view.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f18863d7, this.resourcesProvider));
    ...
    public final void P(long j3) {
        int v02;
        ArrayList arrayList = this.f48075a0;
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            LimitPreviewView limitPreviewView = this.f48076b0;
            ...
            limitPreviewView.f22111a = AndroidUtilities.ilerp((float) j3, (float) starGiftUpgradePrice.upgrade_stars, (float) starGiftUpgradePrice2.upgrade_stars);
            ...
            limitPreviewView.f22129w.setVisibility(8);
