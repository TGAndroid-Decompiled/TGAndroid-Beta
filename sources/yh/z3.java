...
public final class z3 extends sa {
    public final ArrayList f48052a0;
    public final LimitPreviewView f48053b0;

    public z3(Context context, long j3, ArrayList arrayList, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context, e6Var);
        float f7;
        int i10;
        this.f48052a0 = arrayList;
        ...
        this.f48053b0 = limitPreviewView;
        ...
        while (i12 < arrayList.size()) {
            ...
            if (currentTime > starGiftUpgradePrice.date && ((i10 = i12 + 1) >= arrayList.size() || currentTime > ((TL_stars.StarGiftUpgradePrice) arrayList.get(i10)).date)) {
                ...
                pz0Var.c(LocaleController.getInstance().getFormatterDay().format(date) + ", " + LocaleController.getInstance().getFormatterDayMonth().format(date), y7.X0(false, hg.k0.k((int) starGiftUpgradePrice.upgrade_stars, ',', new StringBuilder("⭐️ ")), 0.8f, null), null, null);
                z10 = true;
            }
            i12++;
            f11 = f7;
        ...
        if (!z10) {
            ...
            while (i13 < size) {
                ...
                pz0Var.c(LocaleController.getInstance().getFormatterDay().format(date2) + ", " + LocaleController.getInstance().getFormatterDayMonth().format(date2), y7.X0(false, hg.k0.k((int) starGiftUpgradePrice2.upgrade_stars, ',', new StringBuilder("⭐️ ")), 0.8f, null), null, null);
            }
        }
        float f13 = f12 + 14.0f;
        ...
        this.Y = frameLayout;
        frameLayout.setBackgroundColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18907h5, this.resourcesProvider));
        View view = new View(getContext());
        view.setBackgroundColor(org.telegram.ui.ActionBar.i6.v0(org.telegram.ui.ActionBar.i6.f18837d7, this.resourcesProvider));
    ...
    public final void P(long j3) {
        int v02;
        ArrayList arrayList = this.f48052a0;
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            LimitPreviewView limitPreviewView = this.f48053b0;
            ...
            limitPreviewView.f22101a = AndroidUtilities.ilerp((float) j3, (float) starGiftUpgradePrice.upgrade_stars, (float) starGiftUpgradePrice2.upgrade_stars);
            ...
            limitPreviewView.f22119w.setVisibility(8);
