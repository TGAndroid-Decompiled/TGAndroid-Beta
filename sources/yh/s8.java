...
public final class s8 extends b2.g {
    public final ArrayList f47828b;
    public final RuntimeShader f47829c;
    public RenderEffect d;
    public int e;
    public int f47830f;
    public int f47831g;
    public float h;
    public final float[] f47832i;
    public final float[] f47833j;
    public final float[] f47834k;
    public final float[] f47835l;

    public s8(View view) {
        super(view);
        this.f47828b = new ArrayList();
        this.f47832i = new float[7];
        this.f47833j = new float[7];
        this.f47834k = new float[7];
        this.f47835l = new float[7];
        RuntimeShader runtimeShader = new RuntimeShader(AndroidUtilities.readRes(R.raw.superripple_effect));
        this.f47829c = runtimeShader;
        Z0(true);
    ...
    public final void Z0(boolean z10) {
        ...
        if (!z10 && this.f47830f == view.getWidth() && this.f47831g == view.getHeight() && Math.abs(this.h - AndroidUtilities.density) <= 0.01f) {
            return;
        }
        RuntimeShader runtimeShader = this.f47829c;
        int width = view.getWidth();
        this.f47830f = width;
        int height = view.getHeight();
        this.f47831g = height;
        runtimeShader.setFloatUniform("size", width, height);
        RuntimeShader runtimeShader2 = this.f47829c;
        ...
        RuntimeShader runtimeShader3 = this.f47829c;
    ...
    public final void a1() {
        ...
        boolean z13;
        View view = (View) this.f3000a;
        ArrayList arrayList = this.f47828b;
        boolean z14 = false;
        if (!arrayList.isEmpty()) {
            ...
            while (true) {
                ...
                float f7 = r8Var.d;
                float f10 = r8Var.f47764c;
                float f11 = r8Var.f47763b;
                float f12 = r8Var.f47762a;
                fArr4[i10] = f7;
            ...
            if (z15) {
                this.f47829c.setIntUniform("count", this.e);
                this.f47829c.setFloatUniform("t", fArr4);
                this.f47829c.setFloatUniform("centerX", fArr3);
                this.f47829c.setFloatUniform("centerY", fArr2);
                this.f47829c.setFloatUniform("intensity", fArr);
                Z0(false);
                this.d = RenderEffect.createRuntimeShaderEffect(this.f47829c, "img");
            }
            z14 = z15;
        }
        if (arrayList.isEmpty()) {
