...
public final class u3 implements Utilities.Callback2 {
    ...
    public final void run(Object obj, Object obj2) {
        ...
        e4 e4Var = this.f50585c;
        String[] strArr = this.f50584b;
        switch (i10) {
            case 0:
                ...
                boolean isEmpty = t3Var.f50564j.isEmpty();
                ...
                while (i11 < size) {
                    ...
                    boolean contains = t3Var.f50564j.contains(Long.valueOf(stargiftattributemodel.document.f19875id));
                    ...
                    if (TextUtils.isEmpty(lowerCase) || stargiftattributemodel.name.toLowerCase().startsWith(lowerCase) || stargiftattributemodel.name.toLowerCase().startsWith(translitSafe) || org.telegram.messenger.w1.w(" ", lowerCase, stargiftattributemodel.name.toLowerCase()) || org.telegram.messenger.w1.w(" ", translitSafe, stargiftattributemodel.name.toLowerCase())) {
                        Integer num = (Integer) t3Var.f50567m.get(Long.valueOf(stargiftattributemodel.document.f19875id));
                        if (num == null) {
                            intValue = 0;
                        } else {
            ...
            case 1:
                ...
                t3 t3Var2 = e4Var.f50266c;
                boolean isEmpty2 = t3Var2.f50565k.isEmpty();
                ...
                while (i13 < size2) {
                    ...
                    boolean contains2 = t3Var2.f50565k.contains(Integer.valueOf(stargiftattributebackdrop.backdrop_id));
                    ...
                    Integer num2 = (Integer) t3Var2.f50568n.get(Integer.valueOf(stargiftattributebackdrop.backdrop_id));
                    if (num2 == null) {
                        intValue2 = 0;
                    } else {
                    ...
                    J2.f26595l = lowerCase2;
                    J2.f26608z = intValue2;
            ...
            default:
                ...
                t3 t3Var3 = e4Var.f50266c;
                boolean isEmpty3 = t3Var3.f50566l.isEmpty();
                ...
                while (i15 < size3) {
                    ...
                    boolean contains3 = t3Var3.f50566l.contains(Long.valueOf(stargiftattributepattern.document.f19875id));
                    ...
                    if (!TextUtils.isEmpty(lowerCase3) && !stargiftattributepattern.name.toLowerCase().startsWith(lowerCase3) && !stargiftattributepattern.name.toLowerCase().startsWith(translitSafe3) && !org.telegram.messenger.w1.w(str3, lowerCase3, stargiftattributepattern.name.toLowerCase()) && !org.telegram.messenger.w1.w(str3, translitSafe3, stargiftattributepattern.name.toLowerCase())) {
                        ...
                        str2 = str3;
                        Integer num3 = (Integer) t3Var3.f50569o.get(Long.valueOf(stargiftattributepattern.document.f19875id));
                        if (num3 == null) {
                            intValue3 = 0;
                        } else {
                        ...
                        J3.f26595l = lowerCase3;
                        J3.f26608z = intValue3;
