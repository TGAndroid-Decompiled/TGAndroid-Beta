...
public final class u3 implements Utilities.Callback2 {
    ...
    public final void run(Object obj, Object obj2) {
        ...
        e4 e4Var = this.f50614c;
        String[] strArr = this.f50613b;
        switch (i10) {
            case 0:
                ...
                boolean isEmpty = t3Var.f50593j.isEmpty();
                ...
                while (i11 < size) {
                    ...
                    boolean contains = t3Var.f50593j.contains(Long.valueOf(stargiftattributemodel.document.f19902id));
                    ...
                    if (TextUtils.isEmpty(lowerCase) || stargiftattributemodel.name.toLowerCase().startsWith(lowerCase) || stargiftattributemodel.name.toLowerCase().startsWith(translitSafe) || org.telegram.messenger.w1.w(" ", lowerCase, stargiftattributemodel.name.toLowerCase()) || org.telegram.messenger.w1.w(" ", translitSafe, stargiftattributemodel.name.toLowerCase())) {
                        Integer num = (Integer) t3Var.f50596m.get(Long.valueOf(stargiftattributemodel.document.f19902id));
                        if (num == null) {
                            intValue = 0;
                        } else {
            ...
            case 1:
                ...
                t3 t3Var2 = e4Var.f50295c;
                boolean isEmpty2 = t3Var2.f50594k.isEmpty();
                ...
                while (i13 < size2) {
                    ...
                    boolean contains2 = t3Var2.f50594k.contains(Integer.valueOf(stargiftattributebackdrop.backdrop_id));
                    ...
                    Integer num2 = (Integer) t3Var2.f50597n.get(Integer.valueOf(stargiftattributebackdrop.backdrop_id));
                    if (num2 == null) {
                        intValue2 = 0;
                    } else {
                    ...
                    J2.f26622l = lowerCase2;
                    J2.f26635z = intValue2;
            ...
            default:
                ...
                t3 t3Var3 = e4Var.f50295c;
                boolean isEmpty3 = t3Var3.f50595l.isEmpty();
                ...
                while (i15 < size3) {
                    ...
                    boolean contains3 = t3Var3.f50595l.contains(Long.valueOf(stargiftattributepattern.document.f19902id));
                    ...
                    if (!TextUtils.isEmpty(lowerCase3) && !stargiftattributepattern.name.toLowerCase().startsWith(lowerCase3) && !stargiftattributepattern.name.toLowerCase().startsWith(translitSafe3) && !org.telegram.messenger.w1.w(str3, lowerCase3, stargiftattributepattern.name.toLowerCase()) && !org.telegram.messenger.w1.w(str3, translitSafe3, stargiftattributepattern.name.toLowerCase())) {
                        ...
                        str2 = str3;
                        Integer num3 = (Integer) t3Var3.f50598o.get(Long.valueOf(stargiftattributepattern.document.f19902id));
                        if (num3 == null) {
                            intValue3 = 0;
                        } else {
                        ...
                        J3.f26622l = lowerCase3;
                        J3.f26635z = intValue3;
