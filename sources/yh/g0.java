...
public final class g0 extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final View f47420c;
    public boolean d;
    public float e;
    public float f47421f;
    public boolean h;
    public float f47422n;
    public float f47423r;
    public float f47424s;
    public float v;
    public float f47425w;
    public float f47426x;
    public final org.telegram.ui.Components.e6 f47427y;

    public g0(Context context, int i10, long j3, org.telegram.ui.k0 k0Var) {
        super(context);
        this.d = true;
        this.f47427y = new org.telegram.ui.Components.e6(this, 0L, 350L, rr.h);
        this.E = 1.0f;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.starUserGiftsLoaded && ((Long) objArr[0]).longValue() == this.f47419b) {
            a();
        }
    }
    ...
    public final void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f47418a).addObserver(this, NotificationCenter.starUserGiftsLoaded);
    ...
    public final void onDetachedFromWindow() {
        ...
        NotificationCenter.getInstance(this.f47418a).removeObserver(this, NotificationCenter.starUserGiftsLoaded);
        ArrayList arrayList = this.H;
        int size = arrayList.size();
        int i10 = 0;
        while (i10 < size) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        while (true) {
            ...
            if (i10 < arrayList.size()) {
                if (((f0) arrayList.get(i10)).f47360l.contains(x10, y3)) {
