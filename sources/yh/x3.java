...
public final class x3 extends ua {
    public final ArrayList f48205a0;
    public final LimitPreviewView f48206b0;

    public x3(Context context, long j3, ArrayList arrayList, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context, e6Var);
        float f7;
        int i10;
        this.f48205a0 = arrayList;
        ...
        this.f48206b0 = limitPreviewView;
        ...
        while (i12 < arrayList.size()) {
            ...
            if (currentTime > starGiftUpgradePrice.date && ((i10 = i12 + 1) >= arrayList.size() || currentTime > ((TL_stars.StarGiftUpgradePrice) arrayList.get(i10)).date)) {
                ...
                b01Var.c(LocaleController.getInstance().getFormatterDay().format(date) + ", " + LocaleController.getInstance().getFormatterDayMonth().format(date), v7.X0(false, org.telegram.messenger.q.i((int) starGiftUpgradePrice.upgrade_stars, ',', new StringBuilder("⭐️ ")), 0.8f, null), null, null);
                z10 = true;
            }
            i12++;
            f11 = f7;
        ...
        if (!z10) {
            ...
            while (i13 < size) {
                ...
                b01Var.c(LocaleController.getInstance().getFormatterDay().format(date2) + ", " + LocaleController.getInstance().getFormatterDayMonth().format(date2), v7.X0(false, org.telegram.messenger.q.i((int) starGiftUpgradePrice2.upgrade_stars, ',', new StringBuilder("⭐️ ")), 0.8f, null), null, null);
            }
        }
        float f13 = f12 + 14.0f;
        this.X.addView(b01Var, w7.y5.r(-1, -2, 7, f13, 16.0f, f13, 15.0f));
        TextView b12 = w7.c6.b(context, 12.0f, org.telegram.ui.ActionBar.j6.f19445y6, false, null);
        b12.setGravity(17);
        ...
        this.Y = frameLayout;
        frameLayout.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19133h5, this.resourcesProvider));
        View view = new View(getContext());
        view.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19063d7, this.resourcesProvider));
    ...
    public final void P(long j3) {
        int v02;
        ArrayList arrayList = this.f48205a0;
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            LimitPreviewView limitPreviewView = this.f48206b0;
            ...
            limitPreviewView.f22287a = AndroidUtilities.ilerp((float) j3, (float) starGiftUpgradePrice.upgrade_stars, (float) starGiftUpgradePrice2.upgrade_stars);
            ...
            limitPreviewView.f22305w.setVisibility(8);
