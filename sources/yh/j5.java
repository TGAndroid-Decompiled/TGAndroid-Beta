            ...
            case 0:
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    public final void run() {
                        ...
                        switch (i10) {
                            case 0:
                                long j3 = l5Var2.f47362b;
                                int i11 = l5Var2.f47361a;
                                ...
                                if (tLObject2 instanceof TL_stars.TL_starGiftCollections) {
                                    ...
                                    while (i12 < size) {
                                        ...
                                        if (l5Var2.e(tL_starGiftCollection.collection_id) == null) {
                                            m5 m5Var = new m5(i11, j3, false);
                                            int i13 = tL_starGiftCollection.collection_id;
                                            m5Var.f47400c = true;
                                            m5Var.d = i13;
                                            l5Var2.h.put(Integer.valueOf(i13), m5Var);
                                        }
                                    }
                                    l5Var2.d = true;
                                    l5Var2.f47363c = false;
            ...
            case 1:
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    public final void run() {
                        ...
                        switch (i10) {
                            case 0:
                                long j3 = l5Var22.f47362b;
                                int i11 = l5Var22.f47361a;
                                ...
                                if (tLObject2 instanceof TL_stars.TL_starGiftCollections) {
                                    ...
                                    while (i12 < size) {
                                        ...
                                        if (l5Var22.e(tL_starGiftCollection.collection_id) == null) {
                                            ...
                                            m5Var.f47400c = true;
                                            m5Var.d = i13;
                                            l5Var22.h.put(Integer.valueOf(i13), m5Var);
                                        }
                                    }
                                    l5Var22.d = true;
                                    l5Var22.f47363c = false;
