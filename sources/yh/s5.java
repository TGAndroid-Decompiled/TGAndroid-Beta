...
public final class s5 {
    ...
    public final r5 d0(final MessageObject messageObject, final wn wnVar, final long j3, boolean z10, boolean z11, final Long l4) {
        ...
        if (!r5Var4.f47961i && !r5Var4.f47962j) {
            ...
            kcVar.f25747c.a();
            kcVar.f25747c.c(AndroidUtilities.replaceTags(LocaleController.formatPluralString("StarsSentText", (int) r5Var4.h, new Object[0])), true, true);
            if (r5Var4.f47965m) {
                r5Var4.f47959f.f25384b = 5000L;
            ...
            kcVar.f25746b.setText(r5Var4.d());
    ...
    public final void j0(String str, TLRPC.ChatInvite chatInvite, Utilities.Callback2 callback2) {
        ...
        if (chatInvite != null && chatInvite.subscription_pricing != null) {
            ...
            if (context2 != null) {
                ...
                h9Var.f24681n = 0;
                h9Var.f24680m = false;
                h9.a(str3, null, null, h9Var.f24684q);
