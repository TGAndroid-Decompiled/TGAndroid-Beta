...
public final class u2 extends View {
    public final Paint f47790a;
    public final Paint f47791b;
    public final Paint f47792c;
    public final RadialGradient[] d;
    public final Matrix e;
    public final org.telegram.ui.Components.c6 f47793f;
    public final RadialGradient h;
    public final Path f47794n;
    public int f47795r;
    public int f47796s;

    public u2(Context context) {
        super(context);
        this.f47790a = new Paint(1);
        this.f47791b = new Paint(1);
        Paint paint = new Paint(1);
        this.f47792c = paint;
        this.d = new RadialGradient[2];
        this.e = new Matrix();
        this.f47793f = new org.telegram.ui.Components.c6(1.0f, this, 0L, 420L, qr.h);
        this.h = new RadialGradient(0.0f, 0.0f, 100.0f, new int[]{0, -1, -1, 0}, new float[]{0.15f, 0.35f, 0.65f, 0.88f}, Shader.TileMode.CLAMP);
        this.f47794n = new Path();
        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_IN));
    }

    public final void a(int i10, int i11) {
        if (this.f47795r == i10 && this.f47796s == i11) {
            return;
        }
