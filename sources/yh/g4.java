...
public class g4 extends org.telegram.ui.ActionBar.n2 implements le.d {
    ...
    public gh.c L;
    public bh.b M;
    public final le.b f50321a;
    public final long f50322b;
    public final String f50323c;
    public final t3 d;
    public Utilities.Callback f50324e;
    public org.telegram.ui.ActionBar.g2 f50325f;
    public View h;
    public c3 f50326n;
    public FrameLayout f50327r;
    public FrameLayout f50328s;
    public TextView v;
    public l3 f50329w;
    public boolean f50330x;
    public HorizontalScrollView f50331y;

    public g4(long j3, String str, long j10, f6 f6Var) {
        super(null);
        this.f50321a = new le.b(0, this, pr.h, 380L, false);
        this.K = true;
        this.f50322b = j3;
        this.f50323c = str;
    ...
    public static void U(g4 g4Var, TL_stars.TL_starGiftUnique tL_starGiftUnique, long j3, boolean z10) {
        ...
        Utilities.Callback callback = g4Var.f50324e;
        if (callback != null) {
    ...
    public static void V(g4 g4Var, Context context) {
        ...
        n70Var.R = true;
        n70Var.f28682p = new ji.h(n70Var, 3);
        String[] strArr = {""};
    ...
    public static void W(g4 g4Var, Context context) {
        t3 t3Var = g4Var.d;
        if (!g4Var.K || t3Var.f50589f.isEmpty()) {
            return;
        }
        ...
        n70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        n70Var.R = true;
        n70Var.f28682p = new ji.h(n70Var, 5);
        String[] strArr = {""};
    ...
    public static void X(g4 g4Var, Context context) {
        t3 t3Var = g4Var.d;
        if (!g4Var.K || t3Var.f50590g.isEmpty()) {
            return;
        }
        ...
        n70Var.a0(0.0f, AndroidUtilities.dp(-8.0f));
        n70Var.R = true;
        n70Var.f28682p = new ji.h(n70Var, 4);
        String[] strArr = {""};
    ...
    public static void Y(g4 g4Var, h51 h51Var) {
        ...
        if (obj instanceof TL_stars.TL_starGiftUnique) {
            ...
            zh.w3 w3Var = new zh.w3(g4Var.getParentActivity(), g4Var.currentAccount, g4Var.f50322b, g4Var.resourceProvider, null);
    ...
    public final void E(int i10, float f7, float f10, le.e eVar) {
        if (i10 == 0) {
            this.f50328s.setTranslationY((-AndroidUtilities.dp(52.0f)) * f7);
            y10.d(this.f50327r, f7);
        }
    }
    ...
    public final View createView(final Context context) {
        ...
        this.actionBar.setSubtitleColor(getThemedColor(j6.f21088z6));
        ...
        this.f50326n.j(new lb0(this, 16));
        this.f50326n.setPadding(0, AndroidUtilities.dp(45.0f), 0, AndroidUtilities.dp(101.0f));
        this.f50326n.setClipToPadding(false);
        w8Var.addView(this.f50326n, x5.d(-1, -1.0f, 119, 7.33f, 0.0f, 7.33f, -45.0f));
        w8Var.addView(this.actionBar);
        View.OnClickListener onClickListener = new View.OnClickListener(this) {
            public final g4 f50684b;
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        ...
                        return;
                    default:
                        t3 t3Var2 = this.f50684b.d;
                        t3Var2.f50593k.clear();
                        t3Var2.f50592j.clear();
                        t3Var2.f50594l.clear();
                        t3Var2.h();
                        return;
                }
            }
        ...
        this.f50329w = frameLayout;
        this.f50330x = false;
        frameLayout.setAlpha(0.0f);
        this.f50329w.setScaleX(0.95f);
        this.f50329w.setScaleY(0.95f);
        this.f50329w.setVisibility(8);
        w8Var.addView(this.f50329w, x5.d(-1, -1.0f, 119, 0.0f, 0.0f, 0.0f, -45.0f));
        LinearLayout linearLayout = new LinearLayout(context);
        this.E = linearLayout;
        linearLayout.setPadding(AndroidUtilities.dp(11.0f), 0, AndroidUtilities.dp(11.0f), 0);
        this.E.setOrientation(0);
        HorizontalScrollView horizontalScrollView = new HorizontalScrollView(context);
        this.f50331y = horizontalScrollView;
        horizontalScrollView.setHorizontalScrollBarEnabled(false);
        this.f50331y.addView(this.E);
        this.f50331y.setBackgroundColor(v);
        this.f50331y.setClipChildren(false);
        w8Var.addView(this.f50331y, x5.e(-1, 47, 55));
        ...
        mpVar.b(j6.f20763h7, j6.f20799j7, j6.f20819k7);
        ...
        wl.n(j6.f20797j5, this.resourceProvider, textView3, 1, 14.0f);
        ...
        this.f50328s = frameLayout2;
        frameLayout2.setPadding(AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f));
        FrameLayout frameLayout3 = this.f50328s;
        ...
        this.f50328s.setOnClickListener(new View.OnClickListener(this) {
            public final g4 f50698b;
            ...
            public final void onClick(View view2) {
                switch (r3) {
                    case 0:
                        t3 t3Var = this.f50698b.d;
                        if (t3Var != null) {
                            boolean z10 = !t3Var.f50600r;
                            t3Var.f50600r = z10;
                            mpVar.a(z10, true);
                            t3Var.h();
                            return;
                        ...
                        return;
                    default:
                        final g4 g4Var = this.f50698b;
                        t3 t3Var2 = g4Var.d;
                        if (g4Var.K) {
                            n70 H = n70.H(g4Var, g4Var.F);
                            H.c(R.drawable.menu_sort_value, LocaleController.getString(s3.BY_PRICE.f50575a), new v2(g4Var, 3), false);
                            H.c(R.drawable.menu_sort_date, LocaleController.getString(s3.BY_DATE.f50575a), new v2(g4Var, 4), false);
                            H.c(R.drawable.menu_sort_number, LocaleController.getString(s3.BY_NUMBER.f50575a), new v2(g4Var, 5), false);
                            H.k();
                            ...
                            }, LocaleController.getString(R.string.GiftResaleFilterForStarsOnly), t3Var2.f50600r);
                            H.f28688t = false;
                            H.Y = true;
        ...
        this.f50328s.addView(linearLayout2, x5.c(-1.0f, -2));
        z5.b(this.f50328s, 0.04f, 1.5f);
        w8Var.addView(this.f50328s, x5.d(-2, 52.0f, 81, 0.0f, 0.0f, 0.0f, AndroidUtilities.navigationBarHeight / AndroidUtilities.density));
        s5 y3 = s5.y(this.currentAccount, true);
        if (y3.f52600e && !y3.s().k()) {
            this.f50328s.setVisibility(8);
        }
        FrameLayout frameLayout4 = new FrameLayout(context);
        this.f50327r = frameLayout4;
        ...
        FrameLayout frameLayout5 = this.f50327r;
        ...
        w8Var.addView(this.f50327r, x5.d(-2, 60.0f, 81, 0.0f, 0.0f, 0.0f, AndroidUtilities.navigationBarHeight / AndroidUtilities.density));
        ...
        this.f50327r.setOnClickListener(new View.OnClickListener(this) {
            public final g4 f50684b;
        ...
        this.f50327r.addView(this.v, x5.c(-1.0f, -2));
        this.f50327r.setVisibility(8);
        z5.b(this.f50327r, 0.05f, 1.5f);
        k3 k3Var = new k3(context, this.resourceProvider);
        this.F = k3Var;
        k3Var.setSorting(this.d.f50598p);
        ...
        this.G.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view2) {
                switch (r3) {
                    case 0:
                        g4.W(this.f50563b, context);
                        return;
                    case 1:
                        g4.X(this.f50563b, context);
                        return;
                    default:
                        g4.V(this.f50563b, context);
                        return;
                }
            }
        });
    ...
    public final void d0(boolean z10, boolean z11) {
        ...
        float f14 = 0.0f;
        if (z11) {
            this.f50331y.setVisibility(0);
            ViewPropertyAnimator animate = this.f50331y.animate();
            if (z10) {
                f11 = 0.0f;
            } else {
            ...
            ViewPropertyAnimator animate3 = this.f50326n.animate();
            if (!z10) {
        ...
        HorizontalScrollView horizontalScrollView = this.f50331y;
        if (!z10) {
            i10 = 8;
        }
        horizontalScrollView.setVisibility(i10);
        HorizontalScrollView horizontalScrollView2 = this.f50331y;
        if (z10) {
            f7 = 0.0f;
        } else {
        ...
        HorizontalScrollView horizontalScrollView3 = this.f50331y;
        if (!z10) {
            f13 = 0.0f;
        }
    ...
    public final void e0(boolean z10) {
        ...
        org.telegram.ui.ActionBar.k kVar = this.actionBar;
        if (kVar != null) {
            kVar.setTitle(this.f50323c);
            org.telegram.ui.ActionBar.k kVar2 = this.actionBar;
            int i11 = t3Var.f50588e;
            if (i11 <= 0) {
        ...
        k3 k3Var = this.F;
        if (k3Var != null) {
            k3Var.setSorting(t3Var.f50598p);
        }
        if (this.G != null) {
        ...
        int i12 = 0;
        while (true) {
            if (i12 >= this.f50326n.getChildCount()) {
                break;
            } else if (this.f50326n.getChildAt(i12) instanceof t00) {
                t3Var.g(false);
                break;
            } else {
                i12++;
        ...
        if ((t3Var.f50602t || t3Var.f50588e > 0) && (!hashSet3.isEmpty() || !hashSet2.isEmpty() || !hashSet.isEmpty())) {
            z11 = true;
        }
        this.f50321a.a(z11, true);
    }

    @Override
    public final boolean isLightStatusBar() {
        if (getLastStoryViewer() == null || getLastStoryViewer().H0) {
            int w02 = j6.w0(null, j6.f20690d6, false);
            if (this.actionBar.s()) {
                w02 = j6.w0(null, j6.f21037w8, false);
            }
