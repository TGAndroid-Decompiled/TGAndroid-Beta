...
public final class i7 extends u51 {
    public static final int f47513a = 0;
    ...
    public static v51 a(int i10, int i11, TL_stars.TL_starsTopupOption tL_starsTopupOption) {
        ...
        J.B = j3;
        J.f29042l = LocaleController.formatPluralStringSpaced("StarsCount", (int) j3);
    ...
    public final void bindView(View view, v51 v51Var, boolean z10, j61 j61Var, r61 r61Var) {
        ...
        j7Var.f47573n = i10;
        if (!equals) {
            j7Var.f47574r.d(i10, true);
        }
        textView.setText(charSequence);
        if (charSequence2 == null) {
            if (j7Var.f47572f == null) {
                SpannableString spannableString = new SpannableString("x");
                j7Var.f47572f = spannableString;
                spannableString.setSpan(new s90(AndroidUtilities.dp(55.0f), p6Var), 0, j7Var.f47572f.length(), 33);
            }
            charSequence2 = j7Var.f47572f;
        }
    ...
    public final boolean contentsEquals(v51 v51Var, v51 v51Var2) {
        if (v51Var.f29055z == v51Var2.f29055z && v51Var.d == v51Var2.d && TextUtils.equals(v51Var.f29043m, v51Var2.f29043m)) {
            return true;
        }
        return false;
    }
