...
public final class m5 {
    ...
    public final ArrayList f47460f = new ArrayList();
    public final HashMap h = new HashMap();
    public int f47462i = -1;
    ...
    public final void a(int i10, ArrayList arrayList) {
        ...
        int i12 = this.f47457a;
        if (e != null) {
            e.f47498l.addAll(0, arrayList);
            e.f47500n = arrayList.size() + e.f47500n;
    ...
    public final void g() {
        if (this.f47462i != -1) {
            ConnectionsManager.getInstance(this.f47457a).cancelRequest(this.f47462i, true);
            this.f47462i = -1;
        }
        this.f47459c = false;
        this.d = false;
    ...
    public final void i() {
        if (!this.f47459c && !this.d) {
            this.f47459c = true;
            TL_stars.getStarGiftCollections getstargiftcollections = new TL_stars.getStarGiftCollections();
            int i10 = this.f47457a;
            getstargiftcollections.peer = MessagesController.getInstance(i10).getInputPeer(this.f47458b);
            ArrayList arrayList = this.e;
            int size = arrayList.size();
            long j3 = 0;
            int i11 = 0;
            ...
            this.f47462i = ConnectionsManager.getInstance(i10).sendRequest(getstargiftcollections, new k5(this, 0));
        }
    }

    public final void j() {
        ArrayList arrayList = this.f47460f;
        arrayList.clear();
        int i10 = 0;
        while (true) {
    ...
    public final void k(int i10, TL_stars.SavedStarGift savedStarGift) {
        ...
        boolean z10 = false;
        if (e != null) {
            ArrayList arrayList2 = e.f47498l;
                ...
                while (i11 < arrayList2.size()) {
                    ...
                    while (true) {
                        if (i12 >= arrayList.size()) {
                            ...
                            e.f47500n = Math.max(0, e.f47500n - 1);
                            i11--;
                            break;
                        } else {
                            i12++;
    ...
    public final void n(int i10) {
        ...
        if (e != null) {
            ...
            if (c10 != null) {
                ...
                NotificationCenter.getInstance(this.f47457a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starUserGiftCollectionsLoaded, Long.valueOf(this.f47458b), this);
            }
        }
    }
}
