...
public final class m5 implements n5 {
    ...
    public int f47408n;
    public boolean f47409o;
    public ArrayList f47411q;
    public boolean f47400c = false;
    public boolean e = true;
    public boolean f47401f = false;
    public int f47402g = 783;
    public final ArrayList f47406l = new ArrayList();
    public int f47407m = -1;
    public long f47410p = 0;
    ...
    public final void a() {
        ...
        if (!this.f47403i && !this.f47404j) {
            ...
            if (j3 != 0) {
                ...
                getsavedstargifts2.exclude_unupgradable = !TLObject.hasFlag(this.f47402g, 2);
                getsavedstargifts2.exclude_upgradable = !TLObject.hasFlag(this.f47402g, 4);
                getsavedstargifts2.exclude_unlimited = !TLObject.hasFlag(this.f47402g, 1);
                getsavedstargifts2.exclude_unique = !TLObject.hasFlag(this.f47402g, 8);
                getsavedstargifts2.exclude_saved = !TLObject.hasFlag(this.f47402g, 256);
                getsavedstargifts2.exclude_unsaved = !TLObject.hasFlag(this.f47402g, 512);
                getsavedstargifts2.peer_color_available = this.f47401f;
                long j10 = this.f47399b;
                if (j10 == 0) {
    ...
    public final int b(int i10) {
        if (!z3.O1(this.f47398a, this.f47399b)) {
            return -1;
        }
        int i11 = i10 + 1;
        while (true) {
    ...
    @Override
    public final void d() {
        NotificationCenter.getInstance(this.f47398a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starUserGiftsLoaded, Long.valueOf(this.f47399b), this);
    }

    @Override
    public final int e() {
        return this.f47406l.size();
    }
    ...
    public final TL_stars.InputSavedStarGift g(TL_stars.SavedStarGift savedStarGift) {
        ...
        tL_inputSavedStarGiftChat.peer = MessagesController.getInstance(this.f47398a).getInputPeer(this.f47399b);
    ...
    public final ArrayList h() {
        ...
        int i10 = 0;
        while (true) {
            ArrayList arrayList2 = this.f47406l;
    ...
    public final void i(boolean z10) {
        if (this.f47407m != -1) {
            ConnectionsManager.getInstance(this.f47398a).cancelRequest(this.f47407m, true);
            this.f47407m = -1;
        }
        this.f47403i = false;
        this.f47406l.clear();
    ...
    public final int indexOf(Object obj) {
        return this.f47406l.indexOf(obj);
    }
    ...
    public final void j(ArrayList arrayList, TL_stars.StarGift starGift) {
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            while (i11 < size) {
                ...
                while (true) {
                    ...
                    if (i12 < arrayList2.size()) {
                        ...
                        if (starGift3 != null && starGift3.f18334id == starGift2.f18334id) {
                            arrayList2.remove(i12);
                            this.f47408n = Math.max(0, this.f47408n - 1);
                            z10 = true;
                            break;
                        }
                        i12++;
            ...
            if (z10) {
                NotificationCenter.getInstance(i10).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starUserGiftsLoaded, Long.valueOf(this.f47399b), this);
            }
        }
        if (starGift != null) {
        ...
        if (savedStarGift != null) {
            ...
            if (contains) {
                if (!z10) {
                    ...
                    arrayList = this.f47406l;
                    arrayList.removeAll(h);
                    if (this.e && !this.f47400c) {
