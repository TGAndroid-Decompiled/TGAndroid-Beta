...
public final class m5 {
    ...
    public boolean f47492k;
    public final ArrayList e = new ArrayList();
    public final ArrayList f47488f = new ArrayList();
    public final HashMap h = new HashMap();
    public int f47490i = -1;
    ...
    public final void a(int i10, ArrayList arrayList) {
        ...
        n5 e = e(i10);
        int i11 = 0;
        long j3 = this.f47486b;
        int i12 = this.f47485a;
        if (e != null) {
            e.f47526l.addAll(0, arrayList);
            e.f47528n = arrayList.size() + e.f47528n;
    ...
    public final void g() {
        if (this.f47490i != -1) {
            ConnectionsManager.getInstance(this.f47485a).cancelRequest(this.f47490i, true);
            this.f47490i = -1;
        }
        this.f47487c = false;
        this.d = false;
    ...
    public final void i() {
        if (!this.f47487c && !this.d) {
            this.f47487c = true;
            TL_stars.getStarGiftCollections getstargiftcollections = new TL_stars.getStarGiftCollections();
            int i10 = this.f47485a;
            getstargiftcollections.peer = MessagesController.getInstance(i10).getInputPeer(this.f47486b);
            ArrayList arrayList = this.e;
            int size = arrayList.size();
            long j3 = 0;
            int i11 = 0;
            ...
            this.f47490i = ConnectionsManager.getInstance(i10).sendRequest(getstargiftcollections, new k5(this, 0));
        }
    }

    public final void j() {
        ArrayList arrayList = this.f47488f;
        arrayList.clear();
        int i10 = 0;
        while (true) {
    ...
    public final void k(int i10, TL_stars.SavedStarGift savedStarGift) {
        ...
        boolean z10 = false;
        if (e != null) {
            ArrayList arrayList2 = e.f47526l;
                ...
                while (i11 < arrayList2.size()) {
                    ...
                    while (true) {
                        if (i12 >= arrayList.size()) {
                            ...
                            e.f47528n = Math.max(0, e.f47528n - 1);
                            i11--;
                            break;
                        } else {
                            i12++;
    ...
    public final void n(int i10) {
        ...
        if (e != null) {
            ...
            if (c10 != null) {
                ...
                NotificationCenter.getInstance(this.f47485a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starUserGiftCollectionsLoaded, Long.valueOf(this.f47486b), this);
            }
        }
    }
}
