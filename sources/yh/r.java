...
public final class r extends LinearLayout {
    public final ImageView f47933a;
    public final o90 f47934b;
    public final o90 f47935c;
    ...
    public r(Context context, int i10, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        linearLayout.addView(o90Var, w7.y5.t(-1, -2, 7, 0, 0, 0, 3));
        o90 o90Var2 = new o90(context, null);
        this.f47935c = o90Var2;
        ...
        linearLayout.addView(o90Var2, w7.y5.q(-1, -2, 7));
        addView(linearLayout, w7.y5.p(-1, -2, 1.0f, 55, 0, 0, 0, 0));
    }

    public final void a(CharSequence charSequence, CharSequence charSequence2, int i10) {
        this.f47933a.setImageResource(i10);
        this.f47934b.setText(charSequence);
