...
public final class v2 extends FrameLayout {
    public final xh.f1 f48142a;
    public final FrameLayout f48143b;
    public final w9 f48144c;
    ...
    public final void a(TL_stars.StarGift starGift, boolean z10) {
        ...
        if (starGift != null) {
            ...
            w7.Z0(this.f48144c.getImageReceiver(), ((TL_stars.starGiftAttributeModel) s5.l(starGift.attributes, TL_stars.starGiftAttributeModel.class)).document, 52);
    ...
    public final void b(final boolean z10, boolean z11) {
        ...
        int i11;
        float f14;
        FrameLayout frameLayout = this.f48143b;
