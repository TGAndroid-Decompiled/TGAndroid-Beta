...
public final class q0 extends FrameLayout implements le.d {
    public final org.telegram.ui.ActionBar.f6 f47668a;
    public final FrameLayout f47669b;
    public final xh.e1 f47670c;
    public final u9 d;
    public final TextView e;
    public final TextView f47671f;
    public Integer h;
    public TLRPC.Document f47672n;
    public final le.b f47673r;
    public boolean f47674s;
    public o0 v;

    public q0(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f47673r = new le.b(0, this, qr.h, 320L, false);
        this.f47668a = f6Var;
        FrameLayout frameLayout = new FrameLayout(context);
        this.f47669b = frameLayout;
    ...
    public static void a(q0 q0Var, TLRPC.Document document, int i10, Object obj, boolean z10) {
        ...
        if (document == null) {
            u9Var.b();
            q0Var.f47672n = null;
        } else if (q0Var.f47672n == document) {
        } else {
            q0Var.f47672n = document;
            TLRPC.PhotoSize closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(document.thumbs, AndroidUtilities.dp(100.0f));
            SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(document, org.telegram.ui.ActionBar.j6.f18807a7, 0.3f);
    ...
    public final void b() {
        int d;
        xh.e1 e1Var = this.f47670c;
        e1Var.f45882x = null;
        Integer num = this.h;
        le.b bVar = this.f47673r;
        TextView textView = this.f47671f;
        if (num != null) {
            d = org.telegram.ui.ActionBar.j6.v(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f18863d6, false), org.telegram.ui.ActionBar.j6.l1(AndroidUtilities.lerp(0.15f, 1.0f, bVar.e), this.h.intValue()));
            e1Var.f45882x = this.h;
            this.f47669b.invalidate();
            textView.setTextColor(i0.a.d(bVar.e, this.h.intValue(), -1));
        } else if (this.f47674s) {
            ...
            d = i0.a.d(0.5f, i0.a.k(this.v.f47578a.center_color, 255), i0.a.k(this.v.f47578a.pattern_color, 255));
            textView.setTextColor(-1);
        }
