...
public final class b5 implements Utilities.Callback {
    ...
    public final u5 f47297b;
    public final boolean[] f47298c;
    public final int d;
    public final Utilities.Callback e;
    public final Utilities.Callback f47299f;
    ...
    public final void run(Object obj) {
        ...
        switch (this.f47296a) {
            case 0:
                ...
                this.f47298c[0] = true;
                Utilities.Callback callback2 = this.f47299f;
                if (callback2 != null) {
            ...
            default:
                ...
                Utilities.Callback callback4 = this.f47299f;
                if (callback4 != null) {
