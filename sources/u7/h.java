...
public final class h extends c6.a {
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        g5.s(parcel, 1, 4);
        parcel.writeInt(this.f48481a ? 1 : 0);
        g5.s(parcel, 2, 4);
        parcel.writeInt(this.f48482b ? 1 : 0);
        g5.s(parcel, 3, 4);
        parcel.writeInt(this.f48483c ? 1 : 0);
        g5.s(parcel, 4, 4);
        parcel.writeInt(this.d ? 1 : 0);
        g5.s(parcel, 5, 4);
        parcel.writeInt(this.f48484e ? 1 : 0);
        g5.s(parcel, 6, 4);
        parcel.writeInt(this.f48485f ? 1 : 0);
        g5.r(parcel, q10);
    }
}
