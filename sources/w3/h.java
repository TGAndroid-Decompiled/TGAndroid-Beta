...
public final class h implements c3.o {
    ...
    public boolean M;
    public long N;
    public final z3.k f47943a;
    public final int f47944b;
    public final List f47945c;
    public final byte[] h;
    public final v f47949i;
    public final b0 f47950j;
    public final e2.c f47955o;
    public final h0 f47956p;
    public final a4.m f47957q;
    public a1 f47958r;
    public int f47959s;
    public int f47960t;
    public long f47961u;
    ...
    public int f47964y;
    public long f47965z;
    public final y f47951k = new y(27);
    public final v f47952l = new v(16);
    public final v f47946e = new v(f2.p.f9229a);
    public final v f47947f = new v(6);
    public final v f47948g = new v();
    public final ArrayDeque f47953m = new ArrayDeque();
    public final ArrayDeque f47954n = new ArrayDeque();
    ...
    public h(z3.k kVar, int i10, b0 b0Var, List list, l2.n nVar) {
        ...
        this.f47944b = i10;
        this.f47950j = b0Var;
        this.f47945c = DesugarCollections.unmodifiableList(list);
        this.f47956p = nVar;
        byte[] bArr = new byte[16];
        this.h = bArr;
        this.f47949i = new v(bArr);
        g0 g0Var = i0.f8957b;
        this.f47958r = a1.f8920e;
        this.A = -9223372036854775807L;
        this.f47965z = -9223372036854775807L;
        this.B = -9223372036854775807L;
        this.I = c3.q.f4293m;
        this.J = new h0[0];
        this.K = new h0[0];
        this.f47955o = new e2.c(new e(this));
        this.f47957q = new a4.m(8);
        this.N = -1L;
    }
    ...
    public static void e(v vVar, int i10, q qVar) {
        ...
        if ((j3 & 1) == 0) {
            ...
            int B = vVar.B();
            if (B == 0) {
                Arrays.fill(qVar.f48026l, 0, qVar.f48020e, false);
                return;
            }
            int i11 = qVar.f48020e;
            v vVar2 = qVar.f48028n;
            if (B == i11) {
                Arrays.fill(qVar.f48026l, 0, B, z10);
                vVar2.G(vVar.a());
                qVar.f48025k = true;
                qVar.f48029o = true;
    ...
    public final void g(c3.q qVar) {
        int i10;
        int i11 = this.f47944b;
        if ((i11 & 32) == 0) {
            qVar = new com.google.firebase.messaging.m(qVar, this.f47943a);
        }
        this.I = qVar;
        a();
    ...
    public final void h(long j3, long j10) {
        ...
        this.f47954n.clear();
        this.f47964y = 0;
        ((PriorityQueue) this.f47955o.f8734e).clear();
        this.f47965z = j10;
        this.f47953m.clear();
        a();
    }
