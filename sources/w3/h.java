...
public final class h implements c3.o {
    ...
    public final byte[] h;
    public final v f44537i;
    public final b0 f44538j;
    public final e2.c f44543o;
    public final h0 f44544p;
    public final xa.c f44545q;
    public a1 f44546r;
    public int f44547s;
    public int f44548t;
    public long f44549u;
    ...
    public int f44552y;
    public long f44553z;
    public final y f44539k = new y(27);
    public final v f44540l = new v(16);
    public final v e = new v(f2.o.f8850a);
    public final v f44535f = new v(6);
    public final v f44536g = new v();
    public final ArrayDeque f44541m = new ArrayDeque();
    public final ArrayDeque f44542n = new ArrayDeque();
    ...
    public h(z3.k kVar, int i10, b0 b0Var, List list, l2.n nVar) {
        ...
        this.f44533b = i10;
        this.f44538j = b0Var;
        this.f44534c = DesugarCollections.unmodifiableList(list);
        this.f44544p = nVar;
        byte[] bArr = new byte[16];
        this.h = bArr;
        this.f44537i = new v(bArr);
        g0 g0Var = i0.f8084b;
        this.f44546r = a1.e;
        this.A = -9223372036854775807L;
        this.f44553z = -9223372036854775807L;
        this.B = -9223372036854775807L;
        this.I = c3.q.f3797m;
        this.J = new h0[0];
        this.K = new h0[0];
        this.f44543o = new e2.c(new e(this));
        this.f44545q = new xa.c(7);
        this.N = -1L;
    }
    ...
    public static void e(v vVar, int i10, q qVar) {
        ...
        if ((j3 & 1) == 0) {
            ...
            int B = vVar.B();
            if (B == 0) {
                Arrays.fill(qVar.f44608l, 0, qVar.e, false);
                return;
            }
            int i11 = qVar.e;
            v vVar2 = qVar.f44610n;
            if (B == i11) {
                Arrays.fill(qVar.f44608l, 0, B, z10);
                vVar2.G(vVar.a());
                qVar.f44607k = true;
                qVar.f44611o = true;
    ...
    public final void h(long j3, long j10) {
        ...
        this.f44542n.clear();
        this.f44552y = 0;
        ((PriorityQueue) this.f44543o.e).clear();
        this.f44553z = j10;
        this.f44541m.clear();
        b();
    }
