...
public abstract class d {
    public static final byte[] f44753a;

    static {
        String str = d0.f7870a;
        f44753a = "OpusHead".getBytes(StandardCharsets.UTF_8);
    }
                    ...
                    while (true) {
                        if (i18 - i16 < i17) {
                            ...
                            if (vVar.j() == 1952804451) {
                                ...
                                num = num2;
                                qVar = new q(z13, str, x11, bArr2, i13, i12, bArr);
                            } else {
                                i18 += j12;
                            }
                        } else {
    ...
    public static e2.a0 i(e2.v r66, s4.g1 r67, java.lang.String r68, b2.o r69, boolean r70) {
        throw new UnsupportedOperationException("Method not decompiled: w3.d.i(e2.v, s4.g1, java.lang.String, b2.o, boolean):e2.a0");
    }

    public static java.util.ArrayList j(f2.c r54, c3.w r55, long r56, b2.o r58, boolean r59, boolean r60, d9.e r61) {
        throw new UnsupportedOperationException("Method not decompiled: w3.d.j(f2.c, c3.w, long, b2.o, boolean, boolean, d9.e):java.util.ArrayList");
    }

    public static b2.p0 k(f2.d r17) {
        throw new UnsupportedOperationException("Method not decompiled: w3.d.k(f2.d):b2.p0");
    }
}
