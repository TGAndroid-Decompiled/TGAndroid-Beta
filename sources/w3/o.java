...
public abstract class o {
    public static final int[] f44826a = {1769172845, 1769172786, 1769172787, 1769172788, 1769172789, 1769172790, 1769172793, 1635148593, 1752589105, 1751479857, 1635135537, 1836069937, 1836069938, 862401121, 862401122, 862417462, 862417718, 862414134, 862414646, 1295275552, 1295270176, 1714714144, 1801741417, 1295275600, 1903435808, 1297305174, 1684175153, 1769172332, 1885955686};
    ...
    public static String c(ArrayList arrayList) {
        ...
        while (i10 < size) {
            ...
            i10++;
            String str2 = ((s) obj).f44853a.f44831g.f3301r;
            if (r0.m(str2)) {
                return "video/mp4";
            }
            if (r0.i(str2)) {
    ...
    public static int h(v vVar) {
        ...
        if (vVar.j() == 1684108385) {
            ...
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 != 3) {
                        if (i10 == 4 && (vVar.f7916a[vVar.f7917b] & 128) == 0) {
                            return vVar.B();
                        }
                    } else {
                        return vVar.A();
    ...
    public static void m(int i10, p0 p0Var, b2.r rVar, p0 p0Var2, p0... p0VarArr) {
        ...
        if (p0Var != null) {
            ...
            while (true) {
                ...
                if (o0Var instanceof f2.a) {
                    f2.a aVar = (f2.a) o0Var;
                    if (aVar.f8779a.equals("com.android.capture.fps")) {
                        if (i10 == 2) {
    ...
    public static f0 n(c3.p pVar, boolean z10, boolean z11) {
        ...
        while (i15 < i13) {
            vVar.G(8);
            boolean z14 = true;
            if (!pVar.h(vVar.f7916a, i14, 8, true)) {
                break;
            }
            long z15 = vVar.z();
            int j13 = vVar.j();
