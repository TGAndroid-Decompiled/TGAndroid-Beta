...
public abstract class b extends BaseAdapter implements Filterable {
    ...
    public final int getCount() {
        Cursor cursor;
        if (this.f10063a && (cursor = this.f10065c) != null) {
    ...
    public View getDropDownView(int i10, View view, ViewGroup viewGroup) {
        if (this.f10063a) {
            this.f10065c.moveToPosition(i10);
            if (view == null) {
                z2 z2Var = (z2) this;
                view = z2Var.f14362s.inflate(z2Var.f14361r, viewGroup, false);
            }
            a(view, this.f10065c);
            return view;
        }
    ...
    public final long getItemId(int i10) {
        Cursor cursor;
        if (!this.f10063a || (cursor = this.f10065c) == null || !cursor.moveToPosition(i10)) {
            return 0L;
        }
        return this.f10065c.getLong(this.d);
    }

    @Override
    public View getView(int i10, View view, ViewGroup viewGroup) {
        if (this.f10063a) {
            if (this.f10065c.moveToPosition(i10)) {
                if (view == null) {
                    z2 z2Var = (z2) this;
                    view = z2Var.f14362s.inflate(z2Var.f14360n, viewGroup, false);
