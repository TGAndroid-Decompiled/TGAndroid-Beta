...
public final class q extends o6.a {
    ...
    public String h;
    public String f44559n;
    public String f44560r;
    public boolean f44561s;
    public String v;

    @Override
    public final void writeToParcel(Parcel parcel, int i10) {
        int q6 = f0.q(parcel, 20293);
        f0.l(parcel, 2, this.f44555a);
        f0.l(parcel, 3, this.f44556b);
        f0.l(parcel, 4, this.f44557c);
        f0.l(parcel, 5, this.d);
        f0.l(parcel, 6, this.e);
        f0.l(parcel, 7, this.f44558f);
        f0.l(parcel, 8, this.h);
        f0.l(parcel, 9, this.f44559n);
        f0.l(parcel, 10, this.f44560r);
        boolean z10 = this.f44561s;
        f0.s(parcel, 11, 4);
