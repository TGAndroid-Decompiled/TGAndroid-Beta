...
public final class j extends o6.a {
    ...
    public boolean d;
    public m e;
    public ArrayList f44509f;
    public l h;
    public n f44510n;
    public boolean f44511r;
    public String f44512s;
    public Bundle v;
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        boolean z11 = this.f44507b;
        f0.s(parcel, 2, 4);
        parcel.writeInt(z11 ? 1 : 0);
        f0.k(parcel, 3, this.f44508c, i10);
        boolean z12 = this.d;
        f0.s(parcel, 4, 4);
        parcel.writeInt(z12 ? 1 : 0);
        f0.k(parcel, 5, this.e, i10);
        f0.h(parcel, 6, this.f44509f);
        f0.k(parcel, 7, this.h, i10);
        f0.k(parcel, 8, this.f44510n, i10);
        boolean z13 = this.f44511r;
        f0.s(parcel, 9, 4);
        parcel.writeInt(z13 ? 1 : 0);
        f0.l(parcel, 10, this.f44512s);
