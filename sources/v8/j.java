...
public final class j extends o6.a {
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        boolean z10 = this.f44266a;
        e0.s(parcel, 1, 4);
        parcel.writeInt(z10 ? 1 : 0);
        boolean z11 = this.f44267b;
        e0.s(parcel, 2, 4);
        parcel.writeInt(z11 ? 1 : 0);
        e0.k(parcel, 3, this.f44268c, i10);
        boolean z12 = this.d;
        e0.s(parcel, 4, 4);
        parcel.writeInt(z12 ? 1 : 0);
        e0.k(parcel, 5, this.e, i10);
        e0.h(parcel, 6, this.f44269f);
        e0.k(parcel, 7, this.h, i10);
        e0.k(parcel, 8, this.f44270n, i10);
        boolean z13 = this.f44271r;
        e0.s(parcel, 9, 4);
        parcel.writeInt(z13 ? 1 : 0);
        e0.l(parcel, 10, this.f44272s);
