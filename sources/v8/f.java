...
public final class f extends o6.a {
    ...
    public String f44545s;
    public int v;
    public ArrayList f44546w;
    public w8.f f44547x;
    public ArrayList f44548y;
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        f0.l(parcel, 11, this.f44545s);
        int i11 = this.v;
        f0.s(parcel, 12, 4);
        parcel.writeInt(i11);
        f0.p(parcel, 13, this.f44546w);
        f0.k(parcel, 14, this.f44547x, i10);
        f0.p(parcel, 15, this.f44548y);
