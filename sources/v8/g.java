...
public final class g extends o6.a {
    ...
    public final CommonWalletObject f47714c;
    ...
    public g(int i10, String str, String str2, CommonWalletObject commonWalletObject) {
        ...
        if (i10 < 3) {
            ...
            this.f47714c = commonWalletObject2;
            return;
        }
        this.f47714c = commonWalletObject;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        e0.l(parcel, 3, this.f47713b);
        e0.k(parcel, 4, this.f47714c, i10);
        e0.r(parcel, q6);
    }
}
