...
public final class g extends o6.a {
    ...
    public final CommonWalletObject f44529c;
    ...
    public g(int i10, String str, String str2, CommonWalletObject commonWalletObject) {
        ...
        if (i10 < 3) {
            ...
            commonWalletObject2.f7130a = str;
            this.f44529c = commonWalletObject2;
            return;
        }
        this.f44529c = commonWalletObject;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        f0.l(parcel, 3, this.f44528b);
        f0.k(parcel, 4, this.f44529c, i10);
        f0.r(parcel, q6);
    }
}
