...
public final class g extends o6.a {
    ...
    public final CommonWalletObject f44259c;
    ...
    public g(int i10, String str, String str2, CommonWalletObject commonWalletObject) {
        ...
        if (i10 < 3) {
            ...
            this.f44259c = commonWalletObject2;
            return;
        }
        this.f44259c = commonWalletObject;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        e0.s(parcel, 1, 4);
        parcel.writeInt(this.f44257a);
        e0.l(parcel, 3, this.f44258b);
        e0.k(parcel, 4, this.f44259c, i10);
        e0.r(parcel, q6);
    }
}
