...
public final class g extends o6.a {
    ...
    public final CommonWalletObject f44499c;
    ...
    public g(int i10, String str, String str2, CommonWalletObject commonWalletObject) {
        ...
        if (i10 < 3) {
            ...
            this.f44499c = commonWalletObject2;
            return;
        }
        this.f44499c = commonWalletObject;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        f0.s(parcel, 1, 4);
        parcel.writeInt(this.f44497a);
        f0.l(parcel, 3, this.f44498b);
        f0.k(parcel, 4, this.f44499c, i10);
        f0.r(parcel, q6);
    }
}
