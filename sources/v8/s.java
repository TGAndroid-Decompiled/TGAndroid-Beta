...
public final class s implements com.google.android.gms.common.api.internal.s, w2.d, Continuation, y2.h, g71 {
    ...
    public void a(IBinder iBinder) {
        synchronized (((HashMap) this.f44293a)) {
            if (iBinder != null) {
                try {
            ...
            new y8.a();
            for (Map.Entry entry : ((HashMap) this.f44293a).entrySet()) {
    ...
    public k4.d n(y2.j jVar, long j3, long j10, IOException iOException, int i10) {
        ((l2.d) this.f44293a).f13826a.x(iOException);
        return y2.m.e;
    }
    ...
    public Object then(Task task) {
        return ((Callable) this.f44293a).call();
    }
