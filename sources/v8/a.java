...
public abstract class a {
    public static final long f44501a = TimeUnit.MINUTES.toMillis(10);
    public static final long f44502b = SystemClock.elapsedRealtime();
    public static final int f44503c = 0;

    public static void a(Task task, Activity activity) {
        ?? obj = new Object();
        int incrementAndGet = u.f44568f.incrementAndGet();
        obj.f44569a = incrementAndGet;
        u.e.put(incrementAndGet, obj);
        u.d.postDelayed(obj, f44501a);
        ...
        bundle.putLong("initializationElapsedRealtime", f44502b);
