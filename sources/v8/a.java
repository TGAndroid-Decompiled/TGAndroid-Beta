...
public abstract class a {
    public static final long f44484a = TimeUnit.MINUTES.toMillis(10);
    public static final long f44485b = SystemClock.elapsedRealtime();
    public static final int f44486c = 0;

    public static void a(Task task, Activity activity) {
        ?? obj = new Object();
        int incrementAndGet = u.f44551f.incrementAndGet();
        obj.f44552a = incrementAndGet;
        u.e.put(incrementAndGet, obj);
        u.d.postDelayed(obj, f44484a);
        ...
        bundle.putLong("initializationElapsedRealtime", f44485b);
