...
public abstract class a {
    public static final long f44523a = TimeUnit.MINUTES.toMillis(10);
    public static final long f44524b = SystemClock.elapsedRealtime();
    public static final int f44525c = 0;

    public static void a(Task task, Activity activity) {
        ?? obj = new Object();
        int incrementAndGet = u.f44590f.incrementAndGet();
        obj.f44591a = incrementAndGet;
        u.e.put(incrementAndGet, obj);
        u.d.postDelayed(obj, f44523a);
        ...
        bundle.putLong("initializationElapsedRealtime", f44524b);
