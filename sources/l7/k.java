...
public abstract class k implements Iterator {
    ...
    public final Object next() {
        switch (this.f11515a) {
            case 0:
                n nVar = (n) this.e;
                if (nVar.e == this.f11516b) {
                    if (hasNext()) {
                        int i10 = this.f11517c;
                        this.d = i10;
                        Object a2 = a(i10);
                        int i11 = this.f11517c + 1;
                        if (i11 >= nVar.f11564f) {
                            i11 = -1;
                        }
                        this.f11517c = i11;
            ...
            default:
                ...
                if (dVar.e == this.f11516b) {
                    if (hasNext()) {
                        int i12 = this.f11517c;
                        this.d = i12;
                        Object a10 = a(i12);
                        int i13 = this.f11517c + 1;
                        if (i13 >= dVar.f14321f) {
                            i13 = -1;
                        }
                        this.f11517c = i13;
