...
public class xa extends AbstractMap {
    ...
    public final transient Map f11804b;
    public transient AbstractSet f11805c;
    ...
    public final void clear() {
        switch (this.f11803a) {
            case 0:
                ...
                return;
            case 1:
                n7.d dVar = ((mg) this.e).f14651c;
                if (this.f11804b == dVar) {
    ...
    public final Set entrySet() {
        switch (this.f11803a) {
            case 0:
                ...
                return waVar;
            case 1:
                n7.l9 l9Var = (n7.l9) this.f11805c;
                if (l9Var == null) {
    ...
    public final boolean equals(Object obj) {
        switch (this.f11803a) {
            case 0:
                if (this != obj && !this.f11804b.equals(obj)) {
                    return false;
                }
                return true;
            case 1:
        ...
        switch (this.f11803a) {
            ...
            case 1:
                ...
                if (fdVar == null) {
                    ...
                    mgVar.f14637a = fdVar2;
                    return fdVar2;
                }
                return fdVar;
            default:
                s8.e0 e0Var = (s8.e0) this.e;
                s8.c cVar2 = e0Var.f44196a;
                if (cVar2 == null) {
                    Map map = e0Var.d;
    ...
    public final Object remove(Object obj) {
        switch (this.f11803a) {
            case 0:
                h hVar = (h) this.e;
                Collection collection = (Collection) this.f11804b.remove(obj);
                if (collection == null) {
                    return null;
                }
                hVar.getClass();
            ...
            case 1:
                mg mgVar = (mg) this.e;
                Collection collection2 = (Collection) this.f11804b.remove(obj);
                if (collection2 == null) {
                    return null;
                }
                mgVar.getClass();
            ...
            default:
                s8.e0 e0Var = (s8.e0) this.e;
                Collection collection3 = (Collection) this.f11804b.remove(obj);
                if (collection3 == null) {
                    return null;
                }
                List list = (List) e0Var.f44189f.get();
