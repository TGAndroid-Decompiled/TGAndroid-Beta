...
public final class a0 extends n7 implements m.b {
    ...
    public final void a(boolean z4) {
        ...
        if (actionBarContainer.isLaidOut()) {
            ...
            k.j jVar = new k.j();
            ArrayList arrayList = (ArrayList) jVar.f9545c;
            arrayList.add(i10);
            View view = (View) i10.f43128a.get();
            if (view != null) {
            ...
            ((o3) this.e).f13582a.setVisibility(4);
            this.f6216f.setVisibility(0);
        } else {
            ((o3) this.e).f13582a.setVisibility(0);
    ...
    public final void b(View view) {
        ...
        if (l1Var != null && this.f6216f != null && actionBarContainer != null) {
            Context context = ((o3) l1Var).f13582a.getContext();
            this.f6213a = context;
            if ((((o3) this.e).f13583b & 4) != 0) {
                z4 = true;
            } else {
                z4 = false;
            }
            ...
            this.e.getClass();
            ((o3) this.e).f13582a.setCollapsible(false);
            this.f6215c.setHasNonEmbeddedTabs(false);
            TypedArray obtainStyledAttributes = this.f6213a.obtainStyledAttributes(null, f.a.f5619a, 2130968581, 0);
            if (obtainStyledAttributes.getBoolean(14, false)) {
                ActionBarOverlayLayout actionBarOverlayLayout2 = this.f6215c;
                if (actionBarOverlayLayout2.f399n) {
                    this.f6229t = true;
        ...
        if (!z11 && z10) {
            if (this.f6227r) {
                ...
                if (i10 == 0 && z4) {
                    ...
                    k.j jVar2 = new k.j();
                    ArrayList arrayList = (ArrayList) jVar2.f9545c;
                    ...
                    m0 a2 = j0.a(this.d);
                    a2.e(f10);
                    View view2 = (View) a2.f43128a.get();
                    if (view2 != null) {
                        if (cVar != null) {
                            e5Var = new e5(cVar, view2);
                        }
            ...
            if (i11 == 0 && z4) {
                ...
                k.j jVar4 = new k.j();
                ArrayList arrayList2 = (ArrayList) jVar4.f9545c;
                m0 a11 = j0.a(this.d);
                a11.e(0.0f);
                View view3 = (View) a11.f43128a.get();
                if (view3 != null) {
                    if (cVar != null) {
                        e5Var = new e5(cVar, view3);
                    }
