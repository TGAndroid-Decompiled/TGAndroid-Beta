...
public final class b0 extends k7 implements m.b {
    ...
    public final void a(boolean z10) {
        ...
        if (actionBarContainer.isLaidOut()) {
            ...
            arrayList.add(i10);
            View view = (View) i10.f42139a.get();
            if (view != null) {
            ...
            ((l3) this.e).f14464a.setVisibility(4);
            this.f9194f.setVisibility(0);
        } else {
            ((l3) this.e).f14464a.setVisibility(0);
    ...
    public final void b(View view) {
        ...
        if (k1Var != null && this.f9194f != null && actionBarContainer != null) {
            Context context = ((l3) k1Var).f14464a.getContext();
            this.f9191a = context;
            if ((((l3) this.e).f14465b & 4) != 0) {
                z10 = true;
            } else {
                z10 = false;
            }
            ...
            this.e.getClass();
            ((l3) this.e).f14464a.setCollapsible(false);
        ...
        if (!z12 && z11) {
            if (this.f9205r) {
                ...
                if (i10 == 0 && z10) {
                    ...
                    bc.d dVar2 = new bc.d();
                    ArrayList arrayList = (ArrayList) dVar2.f3490c;
                    ...
                    l0 a2 = i0.a(this.d);
                    a2.e(f7);
                    View view2 = (View) a2.f42139a.get();
                    if (view2 != null) {
                        if (iVar != null) {
            ...
            if (i11 == 0 && z10) {
                ...
                l0 a11 = i0.a(this.d);
                a11.e(0.0f);
                View view3 = (View) a11.f42139a.get();
                if (view3 != null) {
                    if (iVar != null) {
