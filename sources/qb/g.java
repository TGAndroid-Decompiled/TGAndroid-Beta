...
public final class g {
    public static final Object f41266b = new Object();
    public static g f41267c;
    public q9.g f41268a;

    public static g c() {
        boolean z10;
        g gVar;
        synchronized (f41266b) {
            if (f41267c != null) {
                z10 = true;
            } else {
                z10 = false;
    ...
    public static g d(Context context, Executor executor) {
        ...
        synchronized (f41266b) {
            ...
            q9.g gVar2 = new q9.g(executor, arrayList, arrayList2, bs0Var);
            obj.f41268a = gVar2;
            gVar2.g(true);
            gVar = f41267c;
        }
