...
public abstract class j {
    public static final k6.c[] f44315a = new k6.c[0];
    public static final k6.c f44316b;
    public static final k6.c f44317c;
    ...
    static {
        ...
        f44317c = new k6.c("mlkit.segmentation.subject", 1L);
    ...
    public static boolean a(Context context, k6.c[] cVarArr) {
        try {
            return ((r6.a) Tasks.await(new com.google.android.gms.common.api.j(context, s6.g.f45982k, com.google.android.gms.common.api.b.f4976t, com.google.android.gms.common.api.i.f4985c).f(new r(cVarArr, 1)).addOnFailureListener(new Object()))).f44953a;
    ...
    public static void c(Context context, k6.c[] cVarArr) {
        ...
        ?? jVar = new com.google.android.gms.common.api.j(context, s6.g.f45982k, com.google.android.gms.common.api.b.f4976t, com.google.android.gms.common.api.i.f4985c);
