...
public abstract class j {
    public static final k6.c[] f44287a = new k6.c[0];
    public static final k6.c f44288b;
    public static final k6.c f44289c;
    ...
    static {
        ...
        f44289c = new k6.c("mlkit.segmentation.subject", 1L);
    ...
    public static boolean a(Context context, k6.c[] cVarArr) {
        try {
            return ((r6.a) Tasks.await(new com.google.android.gms.common.api.j(context, s6.g.f45954k, com.google.android.gms.common.api.b.f4949t, com.google.android.gms.common.api.i.f4958c).f(new r(cVarArr, 1)).addOnFailureListener(new Object()))).f44925a;
    ...
    public static void c(Context context, k6.c[] cVarArr) {
        ...
        ?? jVar = new com.google.android.gms.common.api.j(context, s6.g.f45954k, com.google.android.gms.common.api.b.f4949t, com.google.android.gms.common.api.i.f4958c);
        s6.a b10 = s6.a.b(arrayList, true);
        if (b10.f45948a.isEmpty()) {
