...
public abstract class j {
    public static final k6.c[] f44314a = new k6.c[0];
    public static final k6.c f44315b;
    public static final k6.c f44316c;
    ...
    static {
        ...
        f44316c = new k6.c("mlkit.segmentation.subject", 1L);
        ...
        if (eVar == null) {
            t7.l b10 = t7.l.b(aVar.f297b, (Object[]) aVar.f298c, aVar);
            ...
            if (eVar2 == null) {
                ...
                if (eVar3 == null) {
                    t7.l.b(aVar2.f297b, (Object[]) aVar2.f298c, aVar2);
    ...
    public static boolean a(Context context, k6.c[] cVarArr) {
        try {
            return ((r6.a) Tasks.await(new com.google.android.gms.common.api.j(context, s6.g.f45981k, com.google.android.gms.common.api.b.f4976t, com.google.android.gms.common.api.i.f4985c).f(new r(cVarArr, 1)).addOnFailureListener(new Object()))).f44952a;
    ...
    public static void c(Context context, k6.c[] cVarArr) {
        ...
        ?? jVar = new com.google.android.gms.common.api.j(context, s6.g.f45981k, com.google.android.gms.common.api.b.f4976t, com.google.android.gms.common.api.i.f4985c);
        s6.a b10 = s6.a.b(arrayList, true);
        if (b10.f45975a.isEmpty()) {
            e7 = Tasks.forResult(new r6.c(0, false));
        } else {
            v e10 = w.e();
            e10.d = new k6.c[]{k7.b.f14862c};
            e10.f5143b = true;
            e10.f5142a = 27304;
            e10.f5144c = new l.d((s6.g) jVar, b10);
            e7 = jVar.e(0, e10.a());
        }
