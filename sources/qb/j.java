...
public abstract class j {
    public static final k6.c[] f41550a = new k6.c[0];
    public static final k6.c f41551b;
    public static final k6.c f41552c;
    ...
    static {
        ...
        f41552c = new k6.c("mlkit.segmentation.subject", 1L);
    ...
    public static boolean a(Context context, k6.c[] cVarArr) {
        try {
            return ((r6.a) Tasks.await(new com.google.android.gms.common.api.j(context, s6.g.f43169k, com.google.android.gms.common.api.b.f6026t, com.google.android.gms.common.api.i.f6035c).f(new r(cVarArr, 1)).addOnFailureListener(new Object()))).f42352a;
    ...
    public static void c(Context context, k6.c[] cVarArr) {
        ...
        ?? jVar = new com.google.android.gms.common.api.j(context, s6.g.f43169k, com.google.android.gms.common.api.b.f6026t, com.google.android.gms.common.api.i.f6035c);
        s6.a b10 = s6.a.b(arrayList, true);
        if (b10.f43163a.isEmpty()) {
            ...
            e7.f6183b = true;
            e7.f6182a = 27304;
            e7.f6184c = new ka.c((s6.g) jVar, b10);
            e = jVar.e(0, e7.a());
        }
