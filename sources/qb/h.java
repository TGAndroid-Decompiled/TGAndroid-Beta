...
public final class h extends t7.m {
    public static final ThreadLocal f41242b = new ThreadLocal();
    public final ThreadPoolExecutor f41243a;
    ...
    public h() {
        ...
        this.f41243a = threadPoolExecutor;
        threadPoolExecutor.allowCoreThreadTimeOut(true);
    }

    @Override
    public final void execute(Runnable runnable) {
        Deque deque = (Deque) f41242b.get();
        ...
        this.f41243a.execute(new n(0, runnable));
    }
}
