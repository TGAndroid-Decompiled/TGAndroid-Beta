...
public final class h extends t7.m {
    public static final ThreadLocal f41531b = new ThreadLocal();
    public final ThreadPoolExecutor f41532a;
    ...
    public h() {
        ...
        this.f41532a = threadPoolExecutor;
        threadPoolExecutor.allowCoreThreadTimeOut(true);
    }

    @Override
    public final void execute(Runnable runnable) {
        Deque deque = (Deque) f41531b.get();
        ...
        this.f41532a.execute(new n(0, runnable));
    }
}
