...
public abstract class i {
    public final com.google.firebase.messaging.m f41547a;
    public final AtomicInteger f41548b = new AtomicInteger(0);
    public final AtomicBoolean f41549c = new AtomicBoolean(false);

    public i() {
        ?? obj = new Object();
        obj.f7328b = new Object();
        obj.f7329c = new ArrayDeque();
    ...
    public final Task a(final Executor executor, final Callable callable, final CancellationToken cancellationToken) {
        ...
        this.f41547a.w(new Runnable() {
            @Override
            public final void run() {
                Callable callable2 = callable;
                TaskCompletionSource taskCompletionSource2 = taskCompletionSource;
                i iVar = i.this;
                AtomicBoolean atomicBoolean = iVar.f41549c;
    ...
    public final void d(Executor executor) {
        ...
        this.f41547a.w(new i9.s(26, this, taskCompletionSource), executor);
