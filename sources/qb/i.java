...
public abstract class i {
    public final com.google.firebase.messaging.m f41244a;
    public final AtomicInteger f41245b = new AtomicInteger(0);
    public final AtomicBoolean f41246c = new AtomicBoolean(false);

    public i() {
        ?? obj = new Object();
        obj.f7329b = new Object();
        obj.f7330c = new ArrayDeque();
    ...
    public final Task a(final Executor executor, final Callable callable, final CancellationToken cancellationToken) {
        ...
        this.f41244a.w(new Runnable() {
            @Override
            public final void run() {
                Callable callable2 = callable;
                TaskCompletionSource taskCompletionSource2 = taskCompletionSource;
                i iVar = i.this;
                AtomicBoolean atomicBoolean = iVar.f41246c;
    ...
    public final void d(Executor executor) {
        ...
        this.f41244a.w(new i9.s(26, this, taskCompletionSource), executor);
