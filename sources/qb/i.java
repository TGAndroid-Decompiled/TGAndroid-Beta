...
public abstract class i {
    public final com.google.firebase.messaging.m f41568a;
    public final AtomicInteger f41569b = new AtomicInteger(0);
    public final AtomicBoolean f41570c = new AtomicBoolean(false);

    public i() {
        ?? obj = new Object();
        obj.f7326b = new Object();
        obj.f7327c = new ArrayDeque();
    ...
    public final Task a(final Executor executor, final Callable callable, final CancellationToken cancellationToken) {
        ...
        this.f41568a.w(new Runnable() {
            @Override
            public final void run() {
                Callable callable2 = callable;
                TaskCompletionSource taskCompletionSource2 = taskCompletionSource;
                i iVar = i.this;
                AtomicBoolean atomicBoolean = iVar.f41570c;
    ...
    public final void d(Executor executor) {
        ...
        this.f41568a.w(new i9.s(26, this, taskCompletionSource), executor);
