...
public abstract class i {
    public final com.google.firebase.messaging.m f41533a;
    public final AtomicInteger f41534b = new AtomicInteger(0);
    public final AtomicBoolean f41535c = new AtomicBoolean(false);
    ...
    public final Task a(final Executor executor, final Callable callable, final CancellationToken cancellationToken) {
        ...
        this.f41533a.w(new Runnable() {
            @Override
            public final void run() {
                Callable callable2 = callable;
                TaskCompletionSource taskCompletionSource2 = taskCompletionSource;
                i iVar = i.this;
                AtomicBoolean atomicBoolean = iVar.f41535c;
    ...
    public final void d(Executor executor) {
        ...
        this.f41533a.w(new i9.s(26, this, taskCompletionSource), executor);
