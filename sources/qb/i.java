...
public abstract class i {
    public final com.google.firebase.messaging.m f41532a;
    public final AtomicInteger f41533b = new AtomicInteger(0);
    public final AtomicBoolean f41534c = new AtomicBoolean(false);
    ...
    public final Task a(final Executor executor, final Callable callable, final CancellationToken cancellationToken) {
        ...
        this.f41532a.w(new Runnable() {
            @Override
            public final void run() {
                Callable callable2 = callable;
                TaskCompletionSource taskCompletionSource2 = taskCompletionSource;
                i iVar = i.this;
                AtomicBoolean atomicBoolean = iVar.f41534c;
    ...
    public final void d(Executor executor) {
        ...
        this.f41532a.w(new i9.s(26, this, taskCompletionSource), executor);
