...
public final class f implements s9.e {
    public static final Charset f8310f = Charset.forName("UTF-8");
    public static final s9.c f8311g = new s9.c("key", u3.c.h(com.google.android.recaptcha.internal.a.q(d.class, new a(1))));
    public static final s9.c h = new s9.c("value", u3.c.h(com.google.android.recaptcha.internal.a.q(d.class, new a(2))));
    public static final e f8312i = e.f8294b;
    public OutputStream f8313a;
    public final HashMap f8314b;
    public final HashMap f8315c;
    public final s9.d d;
    public final h7.l f8316e = new h7.l(this, 1);

    public f(ByteArrayOutputStream byteArrayOutputStream, HashMap hashMap, HashMap hashMap2, s9.d dVar) {
        this.f8313a = byteArrayOutputStream;
        this.f8314b = hashMap;
    ...
    public final void f(s9.c cVar, double d, boolean z10) {
        ...
        k((i(cVar) << 3) | 1);
        this.f8313a.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putDouble(d).array());
    }
        ...
        if (obj != null) {
            if (obj instanceof CharSequence) {
                ...
                if (!z10 || charSequence.length() != 0) {
                    k((i(cVar) << 3) | 2);
                    byte[] bytes = charSequence.toString().getBytes(f8310f);
                    k(bytes.length);
                    this.f8313a.write(bytes);
                }
                ...
                if (!z10 || floatValue != 0.0f) {
                    k((i(cVar) << 3) | 5);
                    this.f8313a.write(ByteBuffer.allocate(4).order(ByteOrder.LITTLE_ENDIAN).putFloat(floatValue).array());
                }
                ...
                k((i(cVar) << 3) | 2);
                k(bArr.length);
                this.f8313a.write(bArr);
            } else {
                s9.d dVar2 = (s9.d) this.f8314b.get(obj.getClass());
                if (dVar2 != null) {
                    j(dVar2, cVar, obj, z10);
                    return;
                }
                s9.f fVar = (s9.f) this.f8315c.get(obj.getClass());
                if (fVar != null) {
                    h7.l lVar = this.f8316e;
                    lVar.f7686b = false;
                    lVar.d = cVar;
                    lVar.f7687c = z10;
                    fVar.a(obj, lVar);
    ...
    public final void j(s9.d dVar, s9.c cVar, Object obj, boolean z10) {
        ...
        fVar.f7616b = 0L;
        try {
            OutputStream outputStream = this.f8313a;
            this.f8313a = fVar;
            dVar.a(obj, this);
