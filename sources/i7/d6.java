...
public abstract class d6 {
    ...
    public static void a(Path path, RectF rectF, float f9) {
        ...
        float f10 = 2.0f * f9;
        path.rewind();
        f8290a.set(0.0f, -rectF.height(), f10, (-rectF.height()) + f10);
        path.arcTo(f8290a, 180.0f, 90.0f);
        f8290a.set(rectF.width() - f10, -rectF.height(), rectF.width(), (-rectF.height()) + f10);
        path.arcTo(f8290a, 270.0f, 90.0f);
        f8290a.set(rectF.width() - f10, -f10, rectF.width(), 0.0f);
        path.arcTo(f8290a, 0.0f, 90.0f);
