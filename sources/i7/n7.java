...
public abstract class n7 {
    ...
    public static android.graphics.drawable.NinePatchDrawable b(android.graphics.Bitmap[] r37, float[] r38, float r39, float r40, int r41, rg.e r42) {
        throw new UnsupportedOperationException("Method not decompiled: i7.n7.b(android.graphics.Bitmap[], float[], float, float, int, rg.e):android.graphics.drawable.NinePatchDrawable");
    }
