...
public final class g extends n6.g {
    ...
    public g(Context context, Looper looper, p3 p3Var, w5.b bVar, k kVar, l lVar) {
        ...
        bVar = bVar == null ? w5.b.f44872c : bVar;
        o0.a aVar = new o0.a(21, (byte) 0);
        aVar.f15482b = Boolean.FALSE;
        w5.b bVar2 = w5.b.f44872c;
        bVar.getClass();
        aVar.f15482b = Boolean.valueOf(bVar.f44873a);
        aVar.f15483c = bVar.f44874b;
        aVar.f15483c = e.a();
    ...
    public final Bundle t() {
        ...
        bundle.putBoolean("force_save_dialog", bVar.f44873a);
        bundle.putString("log_session_id", bVar.f44874b);
        return bundle;
    }
