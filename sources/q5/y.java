...
public abstract class y {
    public static final y5.c f44669a;
    public static final y5.c f44670b;
    public static final y5.c f44671c;
    public static final y5.c d;
    public static final y5.c[] f44672e;
    ...
    static {
        ...
        d = cVar8;
        f44672e = new y5.c[]{cVar, cVar2, cVar3, cVar4, cVar5, cVar6, cVar7, cVar8, new y5.c("relay_casting_set_remote_casting_mode", 1L), new y5.c("get_relay_access_token", 1L), new y5.c("get_cast_settings", 1L), new y5.c("set_bundle_setting", 1L), new y5.c("get_client_updated_info", 1L)};
    }
