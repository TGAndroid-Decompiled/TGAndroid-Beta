...
public final class l extends c6.a {
    ...
    public final void e(String str, String str2) {
        f(1, str);
        this.f42827b.putString(str, str2);
    }
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof l) {
                l lVar = (l) obj;
                if (j(this.f42827b, lVar.f42827b) && this.f42826a.equals(lVar.f42826a)) {
                    return true;
                }
                return false;
            }
    ...
    public final JSONObject g() {
        ...
        try {
            jSONObject.put("metadataType", this.f42828c);
        } catch (JSONException unused) {
        }
        JSONArray b10 = v5.a.b(this.f42826a);
        if (b10.length() != 0) {
            try {
        ...
        try {
            ...
            while (true) {
                ...
                if (str != null && bundle.containsKey(str)) {
                    w0 w0Var = e;
                    String str2 = (String) ((HashMap) w0Var.f11676b).get(str);
                    if (str2 != null) {
    ...
    public final void h(JSONObject jSONObject) {
        HashSet hashSet;
        int i10;
        Bundle bundle = this.f42827b;
        bundle.clear();
        List list = this.f42826a;
        list.clear();
        this.f42828c = 0;
        try {
            this.f42828c = jSONObject.getInt("metadataType");
        } catch (JSONException unused) {
        }
        ...
        try {
            ...
            while (keys.hasNext()) {
                ...
                if (next != null && !"metadataType".equals(next)) {
                    w0 w0Var = e;
                    String str = (String) ((HashMap) w0Var.f11677c).get(next);
                    if (str != null) {
    ...
    public final int hashCode() {
        ...
        return this.f42826a.hashCode() + (i11 * 31);
    }

    @Override
    public final void writeToParcel(Parcel parcel, int i10) {
        int q10 = f5.q(parcel, 20293);
        f5.p(parcel, 2, this.f42826a);
        f5.b(parcel, 3, this.f42827b);
        int i11 = this.f42828c;
        f5.s(parcel, 4, 4);
        parcel.writeInt(i11);
        f5.r(parcel, q10);
