...
public final class t0 {
    ...
    public final f[] f11740j;
    public final x2.u f11741k;
    public final f1 f11742l;
    public t0 f11743m;
    public u2.o1 f11744n;
    public x2.v f11745o;
    public long f11746p;

    public t0(f[] fVarArr, long j3, x2.u uVar, y2.d dVar, f1 f1Var, u0 u0Var, x2.v vVar) {
        this.f11740j = fVarArr;
        this.f11746p = j3;
        this.f11741k = uVar;
        this.f11742l = f1Var;
        u2.f0 f0Var = u0Var.f11749a;
        this.f11734b = f0Var.f46667a;
        this.f11738g = u0Var;
        this.f11744n = u2.o1.d;
        this.f11745o = vVar;
        this.f11735c = new u2.b1[fVarArr.length];
        this.f11739i = new boolean[fVarArr.length];
        long j10 = u0Var.f11750b;
        long j11 = u0Var.d;
        boolean z10 = u0Var.f11753f;
        f1Var.getClass();
        ...
        d1 d1Var = (d1) f1Var.f11544f.get(e1Var);
        if (d1Var != null) {
            d1Var.f11478a.f(d1Var.f11479b);
        }
        e1Var.f11492c.add(a2);
        u2.x c10 = e1Var.f11490a.c(a2, dVar, j10);
        f1Var.f11542c.put(c10, e1Var);
        f1Var.c();
        this.f11733a = j11 != -9223372036854775807L ? new u2.d(c10, !z10, 0L, j11) : c10;
    }
    ...
    public final long a(x2.v vVar, long j3, boolean z10, boolean[] zArr) {
        ...
        while (true) {
            ...
            if (z10 || !vVar.a(this.f11745o, i10)) {
                z12 = false;
            }
            this.f11739i[i10] = z12;
            i10++;
        }
        int i11 = 0;
        while (true) {
            fVarArr = this.f11740j;
            int length = fVarArr.length;
            objArr = this.f11735c;
            if (i11 >= length) {
                break;
            }
            if (fVarArr[i11].f11495b == -2) {
                objArr[i11] = null;
            }
            i11++;
        }
        ...
        this.f11745o = vVar;
        c();
        long q6 = this.f11733a.q(vVar.f48771c, this.f11739i, this.f11735c, zArr, j3);
        for (int i12 = 0; i12 < fVarArr.length; i12++) {
            if (fVarArr[i12].f11495b == -2 && this.f11745o.b(i12)) {
        ...
        for (int i13 = 0; i13 < objArr.length; i13++) {
            if (objArr[i13] != null) {
                e2.d.g(vVar.b(i13));
                if (fVarArr[i13].f11495b != -2) {
                    this.f11737f = true;
                }
            } else {
                if (vVar.f48771c[i13] == null) {
                    z11 = true;
                } else {
                    z11 = false;
                }
    ...
    public final void b() {
        if (this.f11743m == null) {
            int i10 = 0;
            while (true) {
                x2.v vVar = this.f11745o;
                if (i10 < vVar.f48769a) {
                    boolean b10 = vVar.b(i10);
                    x2.r rVar = this.f11745o.f48771c[i10];
                    if (b10 && rVar != null) {
                        rVar.j();
                    }
                    i10++;
    ...
    public final long d() {
        ...
        if (j3 == Long.MIN_VALUE) {
            return this.f11738g.f11752e;
        }
        return j3;
    }

    public final long e() {
        return this.f11738g.f11750b + this.f11746p;
    }

    public final void f(float f7, b2.k1 k1Var, boolean z10) {
        this.f11736e = true;
        this.f11744n = this.f11733a.r();
        x2.v j3 = j(f7, k1Var, z10);
        u0 u0Var = this.f11738g;
        long j10 = u0Var.f11750b;
        long j11 = u0Var.f11752e;
        if (j11 != -9223372036854775807L && j10 >= j11) {
            j10 = Math.max(0L, j11 - 1);
        }
        long a2 = a(j3, j10, false, new boolean[this.f11740j.length]);
        long j12 = this.f11746p;
        u0 u0Var2 = this.f11738g;
        this.f11746p = (u0Var2.f11750b - a2) + j12;
        this.f11738g = u0Var2.b(a2);
    }

    public final boolean g() {
        if (this.f11736e) {
            if (!this.f11737f || this.f11733a.s() == Long.MIN_VALUE) {
                return true;
            }
            return false;
        }
    ...
    public final boolean h() {
        if (this.f11736e) {
            if (g() || d() - this.f11738g.f11750b >= -9223372036854775807L) {
                return true;
            }
            return false;
        }
    ...
    public final void i() {
        ...
        try {
            ...
            f1 f1Var = this.f11742l;
            if (z10) {
                f1Var.f(((u2.d) r02).f46650a);
            } else {
                f1Var.f(r02);
            }
    ...
    public final x2.v j(float f7, b2.k1 k1Var, boolean z10) {
        ...
        Context context;
        int[] iArr3;
        x2.u uVar = this.f11741k;
        f[] fVarArr = this.f11740j;
        u2.o1 o1Var2 = this.f11744n;
        uVar.getClass();
        ...
        for (int i17 = 0; i17 < length2; i17++) {
            iArr6[i17] = fVarArr[i17].A();
        }
        int i18 = 0;
        while (i18 < o1Var2.f46773a) {
            b2.l1 a2 = o1Var2.a(i18);
            boolean z14 = a2.f2144c == 5;
            ...
            while (i19 < fVarArr.length) {
                ...
                u2.o1 o1Var3 = o1Var2;
                int i21 = 0;
                for (int i22 = 0; i22 < a2.f2142a; i22++) {
                    i21 = Math.max(i21, fVar.z(a2.d[i22]) & 7);
                }
            ...
            if (length3 == fVarArr.length) {
                iArr3 = new int[a2.f2142a];
            } else {
                f fVar2 = fVarArr[length3];
                int[] iArr7 = new int[a2.f2142a];
                for (int i23 = 0; i23 < a2.f2142a; i23++) {
                    iArr7[i23] = fVar2.z(a2.d[i23]);
                }
                iArr3 = iArr7;
            }
        ...
        if (pVar.f48758k == null && (context = pVar.f48753e) != null) {
            pVar.f48758k = Boolean.valueOf(e2.d0.N(context));
        }
        if (iVar.f48725s0 && Build.VERSION.SDK_INT >= 32 && pVar.f48756i == null) {
            pVar.f48756i = new x2.k(pVar.f48753e, pVar, pVar.f48758k);
        }
        int i27 = tVar2.f48761a;
        Context context2 = pVar.f48753e;
        x2.q[] qVarArr = new x2.q[i27];
        int i28 = 0;
        while (true) {
            if (i28 >= tVar2.f48761a) {
                z11 = false;
                break;
            } else if (2 == iArr8[i28] && o1VarArr[i28].f46773a > 0) {
                z11 = true;
                break;
            } else {
                i28++;
        ...
        if (j10 == null) {
            ...
            str = qVar2.f48759a.d[qVar2.f48760b[0]].d;
        }
        b2.o1 o1Var5 = iVar.f2293u;
        if (o1Var5.f2228a == 2) {
            str2 = str;
            j3 = null;
            obj = null;
        } else {
            a1.d dVar = new a1.d(iVar, str, iArr6, (!iVar.f2283k || context2 == null) ? null : e2.d0.w(context2), 20);
            str2 = str;
            obj = null;
            j3 = x2.p.j(2, tVar2, iArr5, dVar, new f11(15));
        }
        int i29 = 4;
        if ((iVar.A || j3 == null) && o1Var5.f2228a != 2) {
            iArr = iArr8;
        ...
        if (o1Var5.f2228a == 2) {
            ...
            if (!iVar.f2295x || context2 == null || (captioningManager = (CaptioningManager) context2.getSystemService("captioning")) == null || !captioningManager.isEnabled() || (locale = captioningManager.getLocale()) == null) {
                str3 = obj;
            } else {
            ...
            if (i32 == 2 || i32 == 1 || i32 == i30 || i32 == i29) {
                ...
                if (o1Var5.f2228a == 2) {
                    ...
                    while (i33 < o1Var6.f46773a) {
                        ...
                        b2.l1 l1Var4 = l1Var2;
                        int i37 = 0;
                        while (i37 < a10.f2142a) {
                            u2.o1 o1Var8 = o1Var6;
                            if (g.d(iArr10[i37], iVar.f48726t0)) {
                                i13 = i37;
                                x2.g gVar2 = new x2.g(a10.d[i37], iArr10[i13]);
                                if (gVar != 0) {
                                    i14 = i33;
                                    if (e9.z.f9025a.c(gVar2.f48717b, gVar.f48717b).c(gVar2.f48716a, gVar.f48716a).e() <= 0) {
                                    }
                                } else {
                                    i14 = i33;
                                }
        ...
        int i38 = tVar2.f48761a;
        u2.o1[] o1VarArr2 = tVar2.f48763c;
        HashMap hashMap = new HashMap();
        for (int i39 = 0; i39 < i38; i39++) {
            x2.p.c(o1VarArr2[i39], iVar, hashMap);
        }
        x2.p.c(tVar2.f48765f, iVar, hashMap);
        for (int i40 = 0; i40 < i38; i40++) {
            b2.m1 m1Var = (b2.m1) hashMap.get(Integer.valueOf(tVar2.f48762b[i40]));
            if (m1Var != null) {
                b2.l1 l1Var5 = m1Var.f2171a;
                e9.i0 i0Var = m1Var.f2172b;
                qVarArr[i40] = (i0Var.isEmpty() || o1VarArr2[i40].b(l1Var5) == -1) ? obj : new x2.q(l1Var5, x7.f(i0Var));
            }
        }
        int i41 = tVar2.f48761a;
        for (int i42 = 0; i42 < i41; i42++) {
            u2.o1 o1Var9 = tVar2.f48763c[i42];
            Map map = (Map) iVar.f48728v0.get(i42);
            if (map != null && map.containsKey(o1Var9)) {
                Map map2 = (Map) iVar.f48728v0.get(i42);
        ...
        for (int i43 = 0; i43 < i27; i43++) {
            int i44 = tVar2.f48762b[i43];
            if (iVar.f48729w0.get(i43) || iVar.E.contains(Integer.valueOf(i44))) {
                qVarArr[i43] = obj;
            }
        }
        rb.a aVar = pVar.f48754f;
        y2.c cVar2 = pVar.f48767b;
        e2.d.h(cVar2);
        aVar.getClass();
        ...
        while (i45 < qVarArr.length) {
            ...
            if (qVar3 != 0 && qVar3.f48760b.length > 1) {
                e9.f0 u10 = e9.i0.u();
        ...
        while (i46 < qVarArr.length) {
            ...
            if (qVar4 == 0) {
                ...
                int[] iArr11 = qVar4.f48760b;
                jArr[i46] = new long[iArr11.length];
                int i47 = 0;
                while (i47 < iArr11.length) {
                    x2.t tVar3 = tVar2;
                    long j11 = qVar4.f48759a.d[iArr11[i47]].f2362j;
                    long[] jArr2 = jArr[i46];
                    if (j11 == -1) {
                        j11 = 0;
                    }
        ...
        TreeMap treeMap = new TreeMap(e9.x0.f9022b);
        ...
        for (int i59 = 0; i59 < qVarArr.length; i59++) {
            ...
            if (qVar5 != 0) {
                int[] iArr15 = qVar5.f48760b;
                if (iArr15.length != 0) {
                    if (iArr15.length == 1) {
                        bVar = new x2.c(qVar5.f48759a, new int[]{iArr15[0]});
                    } else {
                        long j13 = 25000;
                        bVar = new x2.b(qVar5.f48759a, iArr15, cVar3, 10000, j13, j13, (e9.i0) i58.get(i59));
                    }
                    rVarArr2[i59] = bVar;
                }
            }
        ...
        while (i60 < i27) {
            x2.t tVar5 = tVar4;
            m1VarArr[i60] = (iVar.f48729w0.get(i60) || iVar.E.contains(Integer.valueOf(tVar5.f48762b[i60])) || (tVar5.f48762b[i60] != -2 && rVarArr2[i60] == null)) ? null : m1.f11642c;
            i60++;
            tVar4 = tVar5;
        }
        x2.t tVar6 = tVar4;
        if (iVar.f2293u.f2228a != 0) {
            int i61 = 0;
            int i62 = -1;
            int i63 = 0;
            while (true) {
                if (i63 < tVar6.f48761a) {
                    int i64 = tVar6.f48762b[i63];
                    x2.r rVar = rVarArr2[i63];
                    if (i64 != 1 && rVar != null) {
                        break;
                    }
                    if (i64 == 1 && rVar != null && rVar.length() == 1) {
                        if (x2.p.i(iVar, iArr5[i63][tVar6.f48763c[i63].b(rVar.b())][rVar.h(0)], rVar.m())) {
                            i61++;
                            i62 = i63;
                        }
                    }
                    ...
                    int i65 = iVar.f2293u.f2229b ? 1 : 2;
                    m1 m1Var2 = m1VarArr[i62];
                    m1VarArr[i62] = new m1(i65, m1Var2 != null && m1Var2.f11644b);
                }
            }
        }
        ...
        int i67 = 0;
        while (true) {
            int i68 = tVar6.f48761a;
            u2.o1[] o1VarArr3 = tVar6.f48763c;
            if (i67 >= i68) {
                break;
            }
            ...
            int i69 = 0;
            while (i69 < o1Var10.f46773a) {
                b2.l1 a11 = o1Var10.a(i69);
                int i70 = o1VarArr3[i67].a(i69).f2142a;
                int[] iArr16 = new int[i70];
                int i71 = 0;
                int i72 = 0;
                while (i71 < i70) {
                    List[] listArr2 = listArr;
                    if ((tVar6.f48764e[i67][i69][i71] & 7) == 4) {
                        iArr16[i72] = i71;
                        i72++;
                    }
                    i71++;
                ...
                while (i73 < copyOf.length) {
                    String str6 = o1VarArr3[i67].a(i69).d[copyOf[i73]].f2370r;
                    int i76 = i74 + 1;
                    if (i74 == 0) {
                        str5 = str6;
                    } else {
                    ...
                    i75 = Math.min(i75, tVar6.f48764e[i67][i69][i73] & 24);
                    i73++;
                    i74 = i76;
                }
                if (z17) {
                ...
                for (int i78 = 0; i78 < a11.f2142a; i78++) {
                    iArr17[i78] = tVar6.f48764e[i67][i69][i78] & 7;
                    int i79 = 0;
                    while (true) {
                        if (i79 >= list.size()) {
                            z13 = false;
        ...
        u2.o1 o1Var12 = tVar6.f48765f;
        for (int i80 = 0; i80 < o1Var12.f46773a; i80++) {
            b2.l1 a12 = o1Var12.a(i80);
            int[] iArr18 = new int[a12.f2142a];
            Arrays.fill(iArr18, 0);
            wVar.b(new r1(a12, false, iArr18, new boolean[a12.f2142a]));
        }
        x2.v vVar = new x2.v((m1[]) create.first, (x2.r[]) create.second, new s1(wVar.i()), tVar6);
        for (int i81 = 0; i81 < vVar.f48769a; i81++) {
            if (vVar.b(i81)) {
                if (vVar.f48771c[i81] == null && this.f11740j[i81].f11495b != -2) {
                    z12 = false;
                    e2.d.g(z12);
                }
                z12 = true;
                ...
                e2.d.g(vVar.f48771c[i81] == null);
            }
        }
        for (x2.r rVar4 : vVar.f48771c) {
            if (rVar4 != null) {
                rVar4.p(f7);
                rVar4.e(z10);
            }
