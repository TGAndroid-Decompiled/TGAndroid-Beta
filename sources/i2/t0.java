...
public final class t0 {
    ...
    public final long a(x2.v vVar, long j3, boolean z10, boolean[] zArr) {
        ...
        this.f11745o = vVar;
        c();
        long q6 = this.f11733a.q(vVar.f48772c, this.f11739i, this.f11735c, zArr, j3);
        ...
        if (this.f11743m == null) {
            ...
            while (true) {
                ...
                if (i10 < vVar.f48770a) {
                    ...
                    x2.r rVar = this.f11745o.f48772c[i10];
                    if (b10 && rVar != null) {
                        rVar.j();
                    }
                    i10++;
    ...
    public final x2.v j(float f7, b2.k1 k1Var, boolean z10) {
        ...
        if (pVar.f48759k == null && (context = pVar.f48754e) != null) {
            pVar.f48759k = Boolean.valueOf(e2.d0.N(context));
        }
        if (iVar.f48726s0 && Build.VERSION.SDK_INT >= 32 && pVar.f48757i == null) {
            pVar.f48757i = new x2.k(pVar.f48754e, pVar, pVar.f48759k);
        }
        int i27 = tVar2.f48762a;
        Context context2 = pVar.f48754e;
        x2.q[] qVarArr = new x2.q[i27];
        int i28 = 0;
        while (true) {
            if (i28 >= tVar2.f48762a) {
                z11 = false;
                break;
            } else if (2 == iArr8[i28] && o1VarArr[i28].f46774a > 0) {
                z11 = true;
                break;
            } else {
                i28++;
        ...
        if (j10 == null) {
            ...
            str = qVar2.f48760a.d[qVar2.f48761b[0]].d;
        }
                ...
                if (o1Var5.f2228a == 2) {
                    ...
                    while (i33 < o1Var6.f46774a) {
                        ...
                        while (i37 < a10.f2142a) {
                            u2.o1 o1Var8 = o1Var6;
                            if (g.d(iArr10[i37], iVar.f48727t0)) {
                                i13 = i37;
                                x2.g gVar2 = new x2.g(a10.d[i37], iArr10[i13]);
                                if (gVar != 0) {
                                    i14 = i33;
                                    if (e9.z.f9025a.c(gVar2.f48718b, gVar.f48718b).c(gVar2.f48717a, gVar.f48717a).e() <= 0) {
                                    }
                                } else {
                                    i14 = i33;
                                }
        ...
        int i38 = tVar2.f48762a;
        u2.o1[] o1VarArr2 = tVar2.f48764c;
        HashMap hashMap = new HashMap();
        for (int i39 = 0; i39 < i38; i39++) {
            x2.p.c(o1VarArr2[i39], iVar, hashMap);
        }
        x2.p.c(tVar2.f48766f, iVar, hashMap);
        for (int i40 = 0; i40 < i38; i40++) {
            b2.m1 m1Var = (b2.m1) hashMap.get(Integer.valueOf(tVar2.f48763b[i40]));
            if (m1Var != null) {
        ...
        int i41 = tVar2.f48762a;
        for (int i42 = 0; i42 < i41; i42++) {
            u2.o1 o1Var9 = tVar2.f48764c[i42];
            Map map = (Map) iVar.f48729v0.get(i42);
            if (map != null && map.containsKey(o1Var9)) {
                Map map2 = (Map) iVar.f48729v0.get(i42);
        ...
        for (int i43 = 0; i43 < i27; i43++) {
            int i44 = tVar2.f48763b[i43];
            if (iVar.f48730w0.get(i43) || iVar.E.contains(Integer.valueOf(i44))) {
                qVarArr[i43] = obj;
            }
        }
        rb.a aVar = pVar.f48755f;
        y2.c cVar2 = pVar.f48768b;
        e2.d.h(cVar2);
        aVar.getClass();
        ...
        while (i45 < qVarArr.length) {
            ...
            if (qVar3 != 0 && qVar3.f48761b.length > 1) {
                e9.f0 u10 = e9.i0.u();
        ...
        while (i46 < qVarArr.length) {
            ...
            if (qVar4 == 0) {
                ...
                int[] iArr11 = qVar4.f48761b;
                jArr[i46] = new long[iArr11.length];
                int i47 = 0;
                while (i47 < iArr11.length) {
                    x2.t tVar3 = tVar2;
                    long j11 = qVar4.f48760a.d[iArr11[i47]].f2362j;
                    long[] jArr2 = jArr[i46];
                    if (j11 == -1) {
                        j11 = 0;
                    }
        ...
        for (int i59 = 0; i59 < qVarArr.length; i59++) {
            ...
            if (qVar5 != 0) {
                int[] iArr15 = qVar5.f48761b;
                if (iArr15.length != 0) {
                    if (iArr15.length == 1) {
                        bVar = new x2.c(qVar5.f48760a, new int[]{iArr15[0]});
                    } else {
                        long j13 = 25000;
                        bVar = new x2.b(qVar5.f48760a, iArr15, cVar3, 10000, j13, j13, (e9.i0) i58.get(i59));
                    }
                    rVarArr2[i59] = bVar;
                }
            }
        ...
        while (i60 < i27) {
            x2.t tVar5 = tVar4;
            m1VarArr[i60] = (iVar.f48730w0.get(i60) || iVar.E.contains(Integer.valueOf(tVar5.f48763b[i60])) || (tVar5.f48763b[i60] != -2 && rVarArr2[i60] == null)) ? null : m1.f11642c;
            i60++;
            tVar4 = tVar5;
        }
        x2.t tVar6 = tVar4;
        if (iVar.f2293u.f2228a != 0) {
            ...
            int i63 = 0;
            while (true) {
                if (i63 < tVar6.f48762a) {
                    int i64 = tVar6.f48763b[i63];
                    x2.r rVar = rVarArr2[i63];
                    if (i64 != 1 && rVar != null) {
                        break;
                    }
                    if (i64 == 1 && rVar != null && rVar.length() == 1) {
                        if (x2.p.i(iVar, iArr5[i63][tVar6.f48764c[i63].b(rVar.b())][rVar.h(0)], rVar.m())) {
                            i61++;
                            i62 = i63;
                        }
                    }
        ...
        int i67 = 0;
        while (true) {
            int i68 = tVar6.f48762a;
            u2.o1[] o1VarArr3 = tVar6.f48764c;
            if (i67 >= i68) {
                break;
            }
            ...
            while (i69 < o1Var10.f46774a) {
                ...
                while (i71 < i70) {
                    ...
                    if ((tVar6.f48765e[i67][i69][i71] & 7) == 4) {
                        iArr16[i72] = i71;
                        i72++;
                    }
                    i71++;
                ...
                while (i73 < copyOf.length) {
                    ...
                    i75 = Math.min(i75, tVar6.f48765e[i67][i69][i73] & 24);
                    i73++;
                    i74 = i76;
                }
                if (z17) {
                ...
                for (int i78 = 0; i78 < a11.f2142a; i78++) {
                    iArr17[i78] = tVar6.f48765e[i67][i69][i78] & 7;
                    int i79 = 0;
                    while (true) {
                        if (i79 >= list.size()) {
                            z13 = false;
        ...
        u2.o1 o1Var12 = tVar6.f48766f;
        for (int i80 = 0; i80 < o1Var12.f46774a; i80++) {
        ...
        for (int i81 = 0; i81 < vVar.f48770a; i81++) {
            if (vVar.b(i81)) {
                if (vVar.f48772c[i81] == null && this.f11740j[i81].f11495b != -2) {
                    z12 = false;
                    e2.d.g(z12);
                }
                z12 = true;
                ...
                e2.d.g(vVar.f48772c[i81] == null);
            }
        }
        for (x2.r rVar4 : vVar.f48772c) {
            if (rVar4 != null) {
                rVar4.p(f7);
                rVar4.e(z10);
            }
