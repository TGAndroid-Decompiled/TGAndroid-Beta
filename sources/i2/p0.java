...
public final class p0 implements Handler.Callback, u2.c0, i1, a3.y {
    ...
    public final void B0(b2.k1 k1Var, u2.f0 f0Var, b2.k1 k1Var2, u2.f0 f0Var2, long j3, boolean z10) {
        ...
        if (!k1Var2.p()) {
            obj = k1Var2.m(k1Var2.g(f0Var2.f43640a, h1Var).f3006c, j1Var, 0L).f3050a;
        } else {
            obj = null;
        }
    ...
    public final void G(int i10) {
        ...
        try {
            ...
            e2.a.f("ExoPlayerImplInternal", "Disabling track due to error: " + b2.s.c(vVar.f45497c[i10].m()), e);
            x2.v vVar2 = new x2.v((n1[]) vVar.f45496b.clone(), (x2.r[]) vVar.f45497c.clone(), vVar.d, vVar.e);
            vVar2.f45496b[i10] = null;
            vVar2.f45497c[i10] = null;
            i(i10);
            u0 u0Var2 = this.H.f10898i;
    ...
    public final void R(long j3) {
        ...
        for (u0 u0Var2 = w0Var.f10898i; u0Var2 != null; u0Var2 = u0Var2.f10878m) {
            for (x2.r rVar : u0Var2.f10880o.f45497c) {
                if (rVar != null) {
                    rVar.r();
                }
            }
    ...
    public final void k(u0 u0Var, int i10, boolean z10, long j3) {
        ...
        if (!g10) {
            ...
            n1 n1Var = vVar.f45496b[i10];
            x2.r rVar = vVar.f45497c[i10];
            if (r0() && this.V.e == 3) {
                z12 = true;
            } else {
                z12 = false;
    ...
    public final Pair p(b2.k1 k1Var) {
        ...
        if (p5.b()) {
            Object obj = p5.f43640a;
            b2.h1 h1Var = this.f10842w;
            k1Var.g(obj, h1Var);
            if (p5.f43642c == h1Var.e(p5.f43641b)) {
    ...
    public final boolean s0(b2.k1 k1Var, u2.f0 f0Var) {
        if (!f0Var.b() && !k1Var.p()) {
            int i10 = k1Var.g(f0Var.f43640a, this.f10842w).f3006c;
            b2.j1 j1Var = this.v;
            k1Var.n(i10, j1Var);
    ...
    public final void y(b2.v0 v0Var, float f7, boolean z10, boolean z11) {
        ...
        while (true) {
            ...
            x2.r[] rVarArr = u0Var.f10880o.f45497c;
            int length = rVarArr.length;
            while (i10 < length) {
                    ...
                    if (i11 < o1VarArr.length) {
                        if (vVar2.b(i11)) {
                            if (o1VarArr[i11].f10792a.f10639b != 1) {
                                z13 = false;
                                break;
                            } else if (vVar2.f45496b[i11].f10785a != 0) {
                                z16 = true;
                            }
                        }
                        i11++;
    ...
    public final void z0(int i10, int i11, int i12, boolean z10) {
        ...
        if (h1Var.f10720l != z11 || h1Var.f10722n != i11 || h1Var.f10721m != i12) {
            ...
            for (u0 u0Var = w0Var.f10898i; u0Var != null; u0Var = u0Var.f10878m) {
                for (x2.r rVar : u0Var.f10880o.f45497c) {
                    if (rVar != null) {
                        rVar.e(z11);
                    }
                }
