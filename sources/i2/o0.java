...
public final class o0 implements Handler.Callback, u2.c0, h1, a3.x {
    ...
    public final void B0(b2.k1 k1Var, u2.f0 f0Var, b2.k1 k1Var2, u2.f0 f0Var2, long j3, boolean z10) {
        ...
        if (!k1Var2.p()) {
            obj = k1Var2.m(k1Var2.g(f0Var2.f46668a, h1Var).f2056c, j1Var, 0L).f2106a;
        } else {
            obj = null;
        }
    ...
    public final void G(int i10) {
        ...
        try {
            ...
            e2.a.f("ExoPlayerImplInternal", "Disabling track due to error: " + b2.s.c(vVar.f48772c[i10].m()), e7);
            x2.v vVar2 = new x2.v((m1[]) vVar.f48771b.clone(), (x2.r[]) vVar.f48772c.clone(), vVar.d, vVar.f48773e);
            vVar2.f48771b[i10] = null;
            vVar2.f48772c[i10] = null;
            j(i10);
            t0 t0Var2 = this.H.f11764i;
    ...
    public final void J(k0 k0Var) {
        ...
        if (i10 != i11 && i10 != i12) {
            ...
            while (min <= max) {
                ...
                e1Var.d = i13;
                i13 += e1Var.f11490a.f46614o.f46788e.o();
                min++;
            }
            b10 = f1Var.b();
        } else {
    ...
    public final void R(long j3) {
        ...
        for (t0 t0Var2 = v0Var.f11764i; t0Var2 != null; t0Var2 = t0Var2.f11743m) {
            for (x2.r rVar : t0Var2.f11745o.f48772c) {
                if (rVar != null) {
                    rVar.r();
                }
            }
    ...
    public final void l(t0 t0Var, int i10, boolean z10, long j3) {
        ...
        if (!g10) {
            ...
            m1 m1Var = vVar.f48771b[i10];
            x2.r rVar = vVar.f48772c[i10];
    ...
    public final Pair p(b2.k1 k1Var) {
        ...
        if (p5.b()) {
            Object obj = p5.f46668a;
            b2.h1 h1Var = this.f11685w;
            k1Var.g(obj, h1Var);
            if (p5.f46670c == h1Var.e(p5.f46669b)) {
    ...
    public final boolean s0(b2.k1 k1Var, u2.f0 f0Var) {
        if (!f0Var.b() && !k1Var.p()) {
            int i10 = k1Var.g(f0Var.f46668a, this.f11685w).f2056c;
            b2.j1 j1Var = this.v;
            k1Var.n(i10, j1Var);
    ...
    public final void y(b2.v0 v0Var, float f7, boolean z10, boolean z11) {
        ...
        while (true) {
            ...
            x2.r[] rVarArr = t0Var.f11745o.f48772c;
            int length = rVarArr.length;
            while (i10 < length) {
                    ...
                    if (i11 < n1VarArr.length) {
                        if (vVar2.b(i11)) {
                            if (n1VarArr[i11].f11648a.f11495b != 1) {
                                z13 = false;
                                break;
                            } else if (vVar2.f48771b[i11].f11643a != 0) {
                                z16 = true;
                            }
                        }
                        i11++;
    ...
    public final void z0(int i10, int i11, int i12, boolean z10) {
        ...
        if (g1Var.f11563l != z11 || g1Var.f11565n != i11 || g1Var.f11564m != i12) {
            ...
            for (t0 t0Var = v0Var.f11764i; t0Var != null; t0Var = t0Var.f11743m) {
                for (x2.r rVar : t0Var.f11745o.f48772c) {
                    if (rVar != null) {
                        rVar.e(z11);
                    }
                }
