...
public final class z implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f10921a) {
            case 0:
                e0 e0Var = ((b0) this.d).f10621a;
                Surface surface = new Surface((SurfaceTexture) this.e);
                e0Var.t1(surface);
                e0Var.S = surface;
                e0Var.m1(this.f10922b, this.f10923c);
                return;
            case 1:
                ConnectionsManager.lambda$onIntegrityCheckClassic$27(this.f10922b, (String) this.d, (String) this.e, this.f10923c);
                return;
            case 2:
                ((bo) this.d).didReceivedNotification(this.f10922b, this.f10923c, (Object[]) this.e);
                return;
            case 3:
                em emVar = (em) this.d;
                emVar.getClass();
                ...
                boVar.Xa(this.f10922b, id2, true, i10, true, 0, Integer.valueOf(this.f10923c), null, null);
                return;
            case 4:
                t1 t1Var = (t1) this.e;
                bo boVar2 = ((nn) this.d).f36012a;
                if (boVar2.A1 != null) {
                    int[] iArr = new int[2];
                    t1Var.getLocationInWindow(iArr);
                    f4 f4Var = boVar2.A1;
                    f4Var.setTranslationY(wl.D(520.0f, iArr[1] - f4Var.getTop(), this.f10922b));
                    boVar2.A1.m(0.0f, (-AndroidUtilities.dp(16.0f)) + iArr[0] + this.f10923c);
                    boVar2.A1.u();
                    return;
                }
                return;
            default:
                ...
                if (arrayList != null) {
                    ...
                    uyVar.W0 = null;
                    tyVar.f37803a.invalidate();
                    int N0 = tyVar.f37805c.N0();
                    if (N0 == this.f10922b - 1) {
                        tyVar.f37805c.m(N0).requestLayout();
                    }
                    boolean z10 = false;
                    if (uyVar.getMessagesController().isPromoDialog(dialog.f18116id, false)) {
                    ...
                    if (uyVar.V2 == 0) {
                        if (addDialogToFolder == 2) {
                            ...
                            if (i15 == 0) {
                                ...
                                tyVar.q(true);
                                if (!SharedConfig.archiveHidden && tyVar.f37805c.L0() == 0) {
                                    uyVar.f38209e2 = true;
                            ...
                            uyVar.R1.add(0, (TLRPC.Dialog) uyVar.R3(i13, tyVar.f37809s, uyVar.V2, false).get(0));
                            tyVar.q(true);
                            ...
                            s4.c1 K = tyVar.f37803a.K(0);
                            if (K != null) {
                                View view = K.f42675a;
                                if (view instanceof r2) {
                                    r2 r2Var = (r2) view;
                                    if (r2Var.a2.f23865n == 2) {
                                        r2Var.f20665b2 = true;
                                        r2Var.f20670c2 = 0.0f;
                                        i6.f19143u1.S(0.0f, true);
                                        i6.f19143u1.start();
                                        r2Var.invalidate();
                                    }
                                }
                    ...
                    if (uyVar.V2 != 0 && uyVar.R1.isEmpty()) {
                        tyVar.f37803a.setEmptyView(null);
                        tyVar.f37810w.setVisibility(4);
                        return;
                    }
                    return;
                }
