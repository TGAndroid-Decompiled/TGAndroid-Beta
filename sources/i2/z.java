        ...
        switch (this.f10924a) {
            ...
            default:
                ...
                if (arrayList != null) {
                    ...
                    wyVar.W0 = null;
                    vyVar.f38522a.invalidate();
                    int N0 = vyVar.f38524c.N0();
                    if (N0 == this.f10925b - 1) {
                        vyVar.f38524c.m(N0).requestLayout();
                    }
                    boolean z10 = false;
                    ...
                    if (wyVar.V2 == 0) {
                        if (addDialogToFolder == 2) {
                            ...
                            if (i15 == 0) {
                                ...
                                vyVar.q(true);
                                if (!SharedConfig.archiveHidden && vyVar.f38524c.L0() == 0) {
                                    wyVar.f39217e2 = true;
                            ...
                            wyVar.R1.add(0, (TLRPC.Dialog) wyVar.R3(i13, vyVar.f38528s, wyVar.V2, false).get(0));
                            vyVar.q(true);
                            ...
                            s4.c1 L = vyVar.f38522a.L(0);
                            if (L != null) {
                                View view = L.f42697a;
                                if (view instanceof r2) {
                                    r2 r2Var = (r2) view;
                                    if (r2Var.a2.f23834n == 2) {
                                        r2Var.f20675b2 = true;
                                        r2Var.f20680c2 = 0.0f;
                                        j6.f19169u1.S(0.0f, true);
                                        j6.f19169u1.start();
                                        r2Var.invalidate();
                                    }
                                }
                    ...
                    if (wyVar.V2 != 0 && wyVar.R1.isEmpty()) {
                        vyVar.f38522a.setEmptyView(null);
                        vyVar.f38529w.setVisibility(4);
                        return;
                    }
                    return;
                }
