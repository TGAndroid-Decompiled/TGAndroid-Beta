...
public final class g0 implements Runnable {
    ...
    public final void run() {
        switch (this.f10715a) {
            ...
            case 1:
                g3 g3Var = ((i3) this.f10716b).f20240b;
                g3Var.requestFocus();
                AndroidUtilities.showKeyboard(g3Var);
                return;
            case 2:
                AndroidUtilities.showKeyboard(((ii.x) this.f10716b).f11750e0.f20240b);
                return;
            case 3:
            ...
            case 14:
                ...
                if (fg1Var.getParentLayout() != null) {
                    ...
                    bundle.putLong("chat_id", fg1Var.f33640a);
            ...
            case 20:
                ...
                if (!j1Var2.e.isInLayout()) {
                    ...
                    j1Var2.f28990f.requestLayout();
                    return;
                }
                return;
            case 21:
                ((org.telegram.ui.Components.voip.i1) this.f10716b).f28971a.i(false);
                return;
            case 22:
                org.telegram.ui.Components.voip.h2 h2Var = (org.telegram.ui.Components.voip.h2) this.f10716b;
                h2Var.e = false;
                HashMap hashMap = h2Var.f28960a;
                ArrayList arrayList = h2Var.f28962c;
                ArrayList arrayList2 = h2Var.f28961b;
                if (!arrayList2.isEmpty() || !arrayList.isEmpty()) {
                    ...
                    while (i10 < arrayList2.size()) {
                        ...
                        while (true) {
                            if (i11 >= arrayList.size()) {
                                break;
                            } else if (g2Var.f28936a.equals(((g2) arrayList.get(i11)).f28936a)) {
                    ...
                    for (int i14 = 0; i14 < h2Var.getChildCount(); i14++) {
                        ...
                        hashMap.put(g2Var2.f28936a, g2Var2);
                    }
                    arrayList2.clear();
                    arrayList.clear();
                    h2Var.e = true;
                ...
                return;
            case 23:
                TextView[] textViewArr = ((p2) this.f10716b).f29141a;
                TextView textView = textViewArr[0];
                textViewArr[0] = textViewArr[1];
                textViewArr[1] = textView;
                return;
            case 24:
                TextView[] textViewArr2 = ((p2) ((gg.k0) this.f10716b).e).f29141a;
            ...
            case 26:
                ...
                new Canvas(x2Var.e).drawText(x2Var.d, x2Var.getMeasuredWidth() / 2, (int) ((x2Var.getMeasuredHeight() / 2) - ((x2Var.f29336a.ascent() + x2Var.f29336a.descent()) / 2.0f)), x2Var.f29336a);
                x2Var.postInvalidate();
                return;
            case 27:
                ((org.telegram.ui.web.k) this.f10716b).f38855w.Y2.N(true);
                return;
            case 28:
                org.telegram.ui.web.i iVar = ((org.telegram.ui.web.o) this.f10716b).h.f38897f;
                if (iVar != null) {
                    iVar.d();
                    return;
                }
