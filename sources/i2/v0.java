...
public final class v0 {
    ...
    public t0 f10910m;
    public int f10911n;
    public Object f10912o;
    public long f10913p;
    public final b2.h1 f10901a = new b2.h1();
    public final b2.j1 f10902b = new b2.j1();
    public ArrayList f10914q = new ArrayList();
    ...
    public final t0 a() {
        ...
        if (t0Var == this.f10907j) {
            this.f10907j = t0Var.f10887m;
        }
        if (t0Var == this.f10908k) {
            this.f10908k = t0Var.f10887m;
        }
        t0Var.i();
        int i10 = this.f10911n - 1;
        this.f10911n = i10;
        if (i10 == 0) {
            this.f10909l = null;
            t0 t0Var2 = this.f10906i;
            this.f10912o = t0Var2.f10879b;
            this.f10913p = t0Var2.f10882g.f10892a.d;
        }
        this.f10906i = this.f10906i.f10887m;
        l();
        return this.f10906i;
    }
    ...
    public final void b() {
        ...
        t0 t0Var = this.f10906i;
        e2.d.h(t0Var);
        this.f10912o = t0Var.f10879b;
        this.f10913p = t0Var.f10882g.f10892a.d;
        while (t0Var != null) {
            t0Var.i();
            t0Var = t0Var.f10887m;
        }
    ...
    public final u0 c(b2.k1 k1Var, t0 t0Var, long j3) {
        ...
        long j14 = (t0Var.f10890p + u0Var.e) - j3;
        if (u0Var.h) {
            ...
            if (d != -1) {
                ...
                if (k1Var.m(i10, this.f10902b, 0L).f3067n == d) {
                    ...
                    if (j17 != null) {
                        ...
                        t0 t0Var2 = t0Var.f10887m;
                        if (t0Var2 != null && t0Var2.f10879b.equals(obj3)) {
    ...
    public final u0 h(b2.k1 k1Var, u0 u0Var) {
        ...
        return new u0(f0Var, u0Var.f10893b, u0Var.f10894c, j3, j10, u0Var.f10895f, false, z10, j11, i12);
    }
    ...
    public final void k() {
        t0 t0Var = this.f10910m;
        if (t0Var == null || t0Var.h()) {
            this.f10910m = null;
            for (int i10 = 0; i10 < this.f10914q.size(); i10++) {
                t0 t0Var2 = (t0) this.f10914q.get(i10);
                if (!t0Var2.h()) {
                    this.f10910m = t0Var2;
                    return;
                }
    ...
    public final void l() {
        u2.f0 f0Var;
        e9.f0 u10 = e9.i0.u();
        for (t0 t0Var = this.f10906i; t0Var != null; t0Var = t0Var.f10887m) {
            u10.b(t0Var.f10882g.f10892a);
        }
        t0 t0Var2 = this.f10907j;
        if (t0Var2 == null) {
            f0Var = null;
        } else {
            f0Var = t0Var2.f10882g.f10892a;
        }
    ...
    public final int n(t0 t0Var) {
        ...
        t0 t0Var3 = this.f10909l;
        t0Var3.getClass();
        if (t0Var3.f10887m != null) {
            t0Var3.b();
            t0Var3.f10887m = null;
            t0Var3.c();
        }
    ...
    public final u2.f0 p(b2.k1 k1Var, Object obj, long j3) {
        ...
        if (obj3 != null && (b10 = k1Var.b(obj3)) != -1 && k1Var.f(b10, h1Var, false).f3013c == i10) {
            ...
            while (true) {
                if (t0Var != null) {
                    if (t0Var.f10879b.equals(obj2)) {
                        q6 = t0Var.f10882g.f10892a.d;
                        break;
                    }
                    t0Var = t0Var.f10887m;
                } else {
        ...
        return o(k1Var, obj2, j3, q6, this.f10902b, this.f10901a);
    }

    public final long q(Object obj) {
        for (int i10 = 0; i10 < this.f10914q.size(); i10++) {
            t0 t0Var = (t0) this.f10914q.get(i10);
            if (t0Var.f10879b.equals(obj)) {
                return t0Var.f10882g.f10892a.d;
            }
        }
        return -1L;
    }
    ...
    public final int r(b2.k1 k1Var) {
        ...
        int b10 = k1Var.b(t0Var2.f10879b);
        while (true) {
            k1Var2 = k1Var;
            b10 = k1Var2.d(b10, this.f10901a, this.f10902b, this.f10905g, this.h);
            while (true) {
                t0Var2.getClass();
                t0Var = t0Var2.f10887m;
                if (t0Var == null || t0Var2.f10882g.h) {
                    break;
                }
                t0Var2 = t0Var;
            }
            if (b10 == -1 || t0Var == null || k1Var2.b(t0Var.f10879b) != b10) {
                break;
            }
            t0Var2 = t0Var;
            k1Var = k1Var2;
        ...
        int n10 = n(t0Var2);
        t0Var2.f10882g = h(k1Var2, t0Var2.f10882g);
        return n10;
    }
