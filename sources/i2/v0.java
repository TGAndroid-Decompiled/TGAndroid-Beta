...
public final class v0 {
    ...
    public final u0 c(b2.k1 k1Var, t0 t0Var, long j3) {
        ...
        if (u0Var.h) {
            ...
            int d = k1Var.d(k1Var.b(f0Var.f46668a), this.f11758a, this.f11759b, this.f11763g, this.h);
            if (d != -1) {
                ...
                if (j12 != -9223372036854775807L && j15 != -9223372036854775807L) {
                    int i11 = k1Var.g(f0Var.f46668a, h1Var2).f2059g.f1968a;
        ...
        Object obj4 = f0Var2.f46668a;
        int i12 = f0Var2.f46671e;
        b2.h1 h1Var3 = this.f11758a;
        k1Var.g(obj4, h1Var3);
        boolean z10 = u0Var.f11754g;
        if (f0Var2.b()) {
            int i13 = f0Var2.f46669b;
            int i14 = h1Var3.f2059g.a(i13).f1945a;
            if (i14 != -1) {
                int a2 = h1Var3.f2059g.a(i13).a(f0Var2.f46670c);
                if (a2 < i14) {
                    return e(k1Var, f0Var2.f46668a, i13, a2, u0Var.f11751c, f0Var2.d, z10);
                }
                ...
                int i16 = f0Var2.f46669b;
                k1Var2.g(obj4, h1Var);
                h1Var.d(i16);
                h1Var.f2059g.a(i16).getClass();
                return f(k1Var, f0Var2.f46668a, Math.max(j10, j18), u0Var.f11751c, f0Var2.d, z10);
            }
            return null;
        }
        if (i12 != -1) {
        ...
        if (e7 != h1Var3.f2059g.a(i12).f1945a) {
            return e(k1Var, f0Var2.f46668a, f0Var2.f46671e, e7, u0Var.f11752e, f0Var2.d, z10);
        }
        k1Var.g(obj4, h1Var3);
        h1Var3.d(i12);
        h1Var3.f2059g.a(i12).getClass();
        return f(k1Var, f0Var2.f46668a, 0L, u0Var.f11752e, f0Var2.d, false);
    }

    public final u0 d(b2.k1 k1Var, u2.f0 f0Var, long j3, long j10) {
        k1Var.g(f0Var.f46668a, this.f11758a);
        if (f0Var.b()) {
            return e(k1Var, f0Var.f46668a, f0Var.f46669b, f0Var.f46670c, j3, f0Var.d, false);
        }
        return f(k1Var, f0Var.f46668a, j10, j3, f0Var.d, false);
    }
