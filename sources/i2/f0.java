...
public final class f0 extends b2.g implements s {
    ...
    public static long i1(g1 g1Var) {
        ...
        g1Var.f11580a.g(g1Var.f11581b.f46696a, h1Var);
    ...
    public final int B() {
        ...
        return g1Var.f11580a.b(g1Var.f11581b.f46696a);
    }
    ...
    public final long C0() {
        ...
        if (this.f11547j0.f11588k.b()) {
            ...
            g1Var2.f11580a.g(g1Var2.f11588k.f46696a, this.f11555o).d(this.f11547j0.f11588k.f46697b);
        } else {
            j3 = j10;
        }
        g1 g1Var3 = this.f11547j0;
        b2.k1 k1Var = g1Var3.f11580a;
        Object obj = g1Var3.f11588k.f46696a;
    ...
    public final int O() {
        B1();
        if (o()) {
            return this.f11547j0.f11581b.f46698c;
        }
        return -1;
    }
    ...
    public final void P(int i10, int i11, List list) {
        ...
        if (min - i10 == list.size()) {
            for (int i12 = i10; i12 < min; i12++) {
                if (((e0) arrayList.get(i12)).f11514b.f46814k.a((b2.k0) list.get(i12 - i10))) {
                }
            }
            this.H++;
            e2.z zVar = this.f11550l.f11701n;
        ...
        z1(n12, 0, !n12.f11581b.f46696a.equals(this.f11547j0.f11581b.f46696a), 4, f1(n12), -1, false);
    }
    ...
    public final void U0() {
        ...
        j2.f fVar = this.f11559s;
        CopyOnWriteArrayList copyOnWriteArrayList = (CopyOnWriteArrayList) ((y2.f) cVar).f49524c.f14247b;
        Iterator it = copyOnWriteArrayList.iterator();
        while (it.hasNext()) {
            y2.b bVar = (y2.b) it.next();
            if (bVar.f49508b == fVar) {
    ...
    public final long e1(g1 g1Var) {
        ...
        b2.k1 k1Var = g1Var.f11580a;
        if (f0Var.b()) {
            Object obj = g1Var.f11581b.f46696a;
            b2.h1 h1Var = this.f11555o;
            k1Var.g(obj, h1Var);
            if (j3 == -9223372036854775807L) {
    ...
    public final int g1(g1 g1Var) {
        ...
        return g1Var.f11580a.g(g1Var.f11581b.f46696a, this.f11555o).f2083c;
    }
    ...
    public final long getDuration() {
        ...
        if (o()) {
            ...
            b2.h1 h1Var = this.f11555o;
            k1Var.g(obj, h1Var);
            return e2.d0.e0(h1Var.a(f0Var.f46697b, f0Var.f46698c));
        }
        return A();
    }
    ...
    public final int k0() {
        B1();
        if (o()) {
            return this.f11547j0.f11581b.f46697b;
        }
        return -1;
    }
    ...
    public final g1 k1(g1 g1Var, b2.k1 k1Var, Pair pair) {
        ...
        Object obj = j10.f11581b.f46696a;
        String str = e2.d0.f8765a;
        ...
        if (!equals || longValue < Q2) {
            ...
            int b10 = k1Var.b(j10.f11588k.f46696a);
            if (b10 != -1 && k1Var.f(b10, this.f11555o, false).f2083c == k1Var.g(f0Var.f46696a, this.f11555o).f2083c) {
                return j10;
            }
            k1Var.g(f0Var.f46696a, this.f11555o);
            if (f0Var.b()) {
                j3 = this.f11555o.a(f0Var.f46697b, f0Var.f46698c);
            } else {
                j3 = this.f11555o.d;
            }
            u2.f0 f0Var4 = f0Var;
    ...
    public final void r1(long j3, List list, boolean z10, int i10) {
        ...
        if (z10) {
            ...
            if (this.f11547j0.f11581b.f46696a.equals(j12.f11581b.f46696a) && !this.f11547j0.f11580a.p()) {
                z11 = true;
            } else {
                z11 = false;
            }
        ...
        j12 = j1(k122, i12);
        this.f11550l.f11701n.a(17, new j0(Z0, this.M, i11, e2.d0.Q(j10))).b();
        if (this.f11547j0.f11581b.f46696a.equals(j12.f11581b.f46696a)) {
        }
        z11 = false;
        z1(j12, 0, z11, 4, f1(j12), -1, false);
    }
    ...
    public final void z1(final g1 g1Var, int i10, boolean z10, int i11, long j3, int i12, boolean z11) {
        ...
        } else if (!k1Var.m(k1Var.g(f0Var.f46696a, h1Var).f2083c, j1Var, 0L).f2133a.equals(k1Var2.m(k1Var2.g(f0Var2.f46696a, h1Var).f2083c, j1Var, 0L).f2133a)) {
            if (z10 && i11 == 0) {
                i13 = 1;
            } else if (z10 && i11 == 1) {
                i13 = 2;
        ...
        if (booleanValue) {
            if (!g1Var.f11580a.p()) {
                k0Var = g1Var.f11580a.m(g1Var.f11580a.g(g1Var.f11581b.f46696a, this.f11555o).f2083c, (b2.j1) this.f2068a, 0L).f2135c;
            } else {
                k0Var = null;
            }
        ...
        if (z10) {
            ...
            if (!g1Var2.f11580a.p()) {
                Object obj5 = g1Var2.f11581b.f46696a;
            ...
            if (i11 == 0) {
                if (g1Var2.f11581b.b()) {
                    ...
                    j12 = h1Var2.a(f0Var3.f46697b, f0Var3.f46698c);
                    i16 = i1(g1Var2);
                } else if (g1Var2.f11581b.f46699e != -1) {
            ...
            b2.a1 a1Var = new b2.a1(obj, i14, k0Var2, obj2, i15, e02, e03, f0Var4.f46697b, f0Var4.f46698c);
            b2.j1 j1Var2 = (b2.j1) this.f2068a;
            int l02 = l0();
            if (!this.f11547j0.f11580a.p()) {
                g1 g1Var3 = this.f11547j0;
                Object obj6 = g1Var3.f11581b.f46696a;
            ...
            this.f11552m.c(11, new c2(i11, a1Var, new b2.a1(obj3, l02, k0Var3, obj4, i17, e04, j13, f0Var5.f46697b, f0Var5.f46698c), 1));
        } else {
            z15 = booleanValue;
            z16 = equals2;
            z17 = z13;
        ...
        if (vVar != vVar2) {
            x2.u uVar = this.f11544i;
            Object obj8 = vVar2.f48802e;
            uVar.getClass();
            uVar.f48798c = (x2.t) obj8;
