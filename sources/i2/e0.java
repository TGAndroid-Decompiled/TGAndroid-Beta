...
public final class e0 extends b2.g implements r {
    ...
    public e0(p pVar) {
        ...
        try {
            ...
            b11.getClass();
            fVar.getClass();
            k2.u uVar2 = b11.f46297c;
            uVar2.getClass();
            CopyOnWriteArrayList copyOnWriteArrayList = (CopyOnWriteArrayList) uVar2.f13385b;
            Iterator it = copyOnWriteArrayList.iterator();
            while (it.hasNext()) {
                y2.b bVar = (y2.b) it.next();
                if (bVar.f46282b == fVar) {
                    bVar.f46283c = true;
            ...
            try {
                ...
                ?? obj = new Object();
                obj.f7334b = context3.getApplicationContext();
                obj.d = xVar.a(looper2, callback);
                obj.f7335c = new b(obj, xVar.a(looper3, callback), b0Var2);
                e0Var.A = obj;
                obj.t();
                ...
                b2.e eVar = e0Var.Y;
                e2.y b12 = e2.z.b();
                b12.f7941a = zVar.f7943a.obtainMessage(31, 0, 0, eVar);
                b12.b();
    ...
    public static long i1(g1 g1Var) {
        ...
        g1Var.f10718a.g(g1Var.f10719b.f43380a, h1Var);
    ...
    public final int B() {
        ...
        return g1Var.f10718a.b(g1Var.f10719b.f43380a);
    }
    ...
    public final long C0() {
        ...
        if (this.f10662j0.f10725k.b()) {
            ...
            g1Var2.f10718a.g(g1Var2.f10725k.f43380a, this.f10670o).d(this.f10662j0.f10725k.f43381b);
        } else {
            j3 = j10;
        }
        g1 g1Var3 = this.f10662j0;
        b2.k1 k1Var = g1Var3.f10718a;
        Object obj = g1Var3.f10725k.f43380a;
    ...
    public final int O() {
        B1();
        if (o()) {
            return this.f10662j0.f10719b.f43382c;
        }
        return -1;
    }
    ...
    public final void P(int i10, int i11, List list) {
        ...
        if (min - i10 == list.size()) {
            for (int i12 = i10; i12 < min; i12++) {
                if (((d0) arrayList.get(i12)).f10637b.f43491k.a((b2.k0) list.get(i12 - i10))) {
                }
            }
            this.H++;
            e2.z zVar = this.f10665l.f10822n;
        ...
        z1(n12, 0, !n12.f10719b.f43380a.equals(this.f10662j0.f10719b.f43380a), 4, f1(n12), -1, false);
    }
    ...
    public final void U0() {
        ...
        this.f10667m.d();
        this.f10661j.f7943a.removeCallbacksAndMessages(null);
        y2.c cVar = this.f10676u;
        j2.f fVar = this.f10674s;
        CopyOnWriteArrayList copyOnWriteArrayList = (CopyOnWriteArrayList) ((y2.f) cVar).f46297c.f13385b;
        Iterator it = copyOnWriteArrayList.iterator();
        while (it.hasNext()) {
            y2.b bVar = (y2.b) it.next();
            if (bVar.f46282b == fVar) {
    ...
    public final b2.n0 b1() {
        ...
        if (n0Var != null) {
            e9.i0 i0Var = n0Var.J;
            byte[] bArr2 = n0Var.f3149k;
            CharSequence charSequence = n0Var.f3142a;
            if (charSequence != null) {
                a2.f3095a = charSequence;
            }
            CharSequence charSequence2 = n0Var.f3143b;
            if (charSequence2 != null) {
                a2.f3096b = charSequence2;
            }
            CharSequence charSequence3 = n0Var.f3144c;
            if (charSequence3 != null) {
                a2.f3097c = charSequence3;
            }
            ...
            CharSequence charSequence6 = n0Var.f3145f;
            if (charSequence6 != null) {
                a2.f3098f = charSequence6;
            }
            CharSequence charSequence7 = n0Var.f3146g;
            if (charSequence7 != null) {
                a2.f3099g = charSequence7;
            }
            Long l4 = n0Var.h;
            if (l4 != null) {
                if (l4.longValue() >= 0) {
            ...
            b2.c1 c1Var = n0Var.f3147i;
            if (c1Var != null) {
                a2.f3100i = c1Var;
            }
            b2.c1 c1Var2 = n0Var.f3148j;
            if (c1Var2 != null) {
                a2.f3101j = c1Var2;
            }
            Uri uri = n0Var.f3151m;
            if (uri != null || bArr2 != null) {
                a2.f3104m = uri;
                Integer num = n0Var.f3150l;
                if (bArr2 == null) {
                    bArr = null;
                } else {
            ...
            Integer num2 = n0Var.f3152n;
            if (num2 != null) {
                a2.f3105n = num2;
            }
            Integer num3 = n0Var.f3153o;
            if (num3 != null) {
                a2.f3106o = num3;
            }
            Integer num4 = n0Var.f3154p;
            if (num4 != null) {
                a2.f3107p = num4;
            }
            Boolean bool = n0Var.f3155q;
            if (bool != null) {
                a2.f3108q = bool;
            }
            Boolean bool2 = n0Var.f3156r;
            if (bool2 != null) {
                a2.f3109r = bool2;
            }
            Integer num5 = n0Var.f3157s;
            if (num5 != null) {
                a2.f3110s = num5;
            }
            Integer num6 = n0Var.f3158t;
            if (num6 != null) {
                a2.f3110s = num6;
            }
            Integer num7 = n0Var.f3159u;
            if (num7 != null) {
                a2.f3111t = num7;
            }
            ...
            Integer num9 = n0Var.f3160w;
            if (num9 != null) {
                a2.v = num9;
            }
            Integer num10 = n0Var.f3161x;
            if (num10 != null) {
                a2.f3113w = num10;
            }
            Integer num11 = n0Var.f3162y;
            if (num11 != null) {
                a2.f3114x = num11;
            }
            CharSequence charSequence8 = n0Var.f3163z;
            if (charSequence8 != null) {
                a2.f3115y = charSequence8;
            }
            CharSequence charSequence9 = n0Var.A;
            if (charSequence9 != null) {
                a2.f3116z = charSequence9;
            }
    ...
    public final long e1(g1 g1Var) {
        ...
        b2.k1 k1Var = g1Var.f10718a;
        if (f0Var.b()) {
            Object obj = g1Var.f10719b.f43380a;
            b2.h1 h1Var = this.f10670o;
            k1Var.g(obj, h1Var);
            if (j3 == -9223372036854775807L) {
    ...
    public final int g1(g1 g1Var) {
        ...
        return g1Var.f10718a.g(g1Var.f10719b.f43380a, this.f10670o).f3014c;
    }
    ...
    public final long getDuration() {
        ...
        if (o()) {
            ...
            b2.h1 h1Var = this.f10670o;
            k1Var.g(obj, h1Var);
            return e2.d0.e0(h1Var.a(f0Var.f43381b, f0Var.f43382c));
        }
        return A();
    }
    ...
    public final Pair h1(b2.k1 k1Var, l1 l1Var, int i10, long j3) {
        ...
        if (!k1Var.p() && !l1Var.p()) {
            ...
            if (U != -1) {
                ...
                l1Var.m(U, j1Var, 0L);
                return l1(l1Var, U, e2.d0.e0(j1Var.f3066l));
            }
    ...
    public final int k0() {
        B1();
        if (o()) {
            return this.f10662j0.f10719b.f43381b;
        }
        return -1;
    }
    ...
    public final g1 k1(g1 g1Var, b2.k1 k1Var, Pair pair) {
        ...
        Object obj = j10.f10719b.f43380a;
        String str = e2.d0.f7888a;
        ...
        if (!equals || longValue < Q2) {
            ...
            int b10 = k1Var.b(j10.f10725k.f43380a);
            if (b10 != -1 && k1Var.f(b10, this.f10670o, false).f3014c == k1Var.g(f0Var.f43380a, this.f10670o).f3014c) {
                return j10;
            }
            k1Var.g(f0Var.f43380a, this.f10670o);
            if (f0Var.b()) {
                j3 = this.f10670o.a(f0Var.f43381b, f0Var.f43382c);
            } else {
                j3 = this.f10670o.d;
            }
            u2.f0 f0Var4 = f0Var;
    ...
    public final g1 n1(g1 g1Var, int i10, int i11) {
        ...
        zVar.getClass();
        e2.y b10 = e2.z.b();
        b10.f7941a = zVar.f7943a.obtainMessage(20, i10, i11, g1Var2);
        b10.b();
        return k12;
    }
    ...
    public final void r1(long j3, List list, boolean z10, int i10) {
        ...
        if (z10) {
            ...
            if (this.f10662j0.f10719b.f43380a.equals(j12.f10719b.f43380a) && !this.f10662j0.f10718a.p()) {
                z11 = true;
            } else {
                z11 = false;
            }
        ...
        j12 = j1(k122, i12);
        this.f10665l.f10822n.a(17, new j0(Z0, this.M, i11, e2.d0.Q(j10))).b();
        if (this.f10662j0.f10719b.f43380a.equals(j12.f10719b.f43380a)) {
        }
        z11 = false;
        z1(j12, 0, z11, 4, f1(j12), -1, false);
    }
    ...
    public final void z1(final g1 g1Var, int i10, boolean z10, int i11, long j3, int i12, boolean z11) {
        ...
        } else if (!k1Var.m(k1Var.g(f0Var.f43380a, h1Var).f3014c, j1Var, 0L).f3058a.equals(k1Var2.m(k1Var2.g(f0Var2.f43380a, h1Var).f3014c, j1Var, 0L).f3058a)) {
            if (z10 && i11 == 0) {
                i13 = 1;
            } else if (z10 && i11 == 1) {
                i13 = 2;
        ...
        if (booleanValue) {
            if (!g1Var.f10718a.p()) {
                k0Var = g1Var.f10718a.m(g1Var.f10718a.g(g1Var.f10719b.f43380a, this.f10670o).f3014c, (b2.j1) this.f3000a, 0L).f3060c;
            } else {
                k0Var = null;
            }
        ...
        if (z10) {
            ...
            if (!g1Var2.f10718a.p()) {
                Object obj5 = g1Var2.f10719b.f43380a;
            ...
            if (i11 == 0) {
                if (g1Var2.f10719b.b()) {
                    ...
                    j12 = h1Var2.a(f0Var3.f43381b, f0Var3.f43382c);
                    i16 = i1(g1Var2);
            ...
            b2.a1 a1Var = new b2.a1(obj, i14, k0Var2, obj2, i15, e02, e03, f0Var4.f43381b, f0Var4.f43382c);
            b2.j1 j1Var2 = (b2.j1) this.f3000a;
            int l02 = l0();
            if (!this.f10662j0.f10718a.p()) {
                g1 g1Var3 = this.f10662j0;
                Object obj6 = g1Var3.f10719b.f43380a;
            ...
            this.f10667m.c(11, new d2(i11, a1Var, new b2.a1(obj3, l02, k0Var3, obj4, i17, e04, j13, f0Var5.f43381b, f0Var5.f43382c), 2));
        } else {
            z15 = booleanValue;
            z16 = equals2;
            z17 = z13;
