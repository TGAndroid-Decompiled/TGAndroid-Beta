    ...
    public final void run() {
        ...
        switch (this.f11478a) {
            ...
            case 4:
                ...
                co coVar2 = ((on) this.d).f39311a;
                if (coVar2.A1 != null) {
                    int[] iArr = new int[2];
                    t1Var.getLocationInWindow(iArr);
                    f4 f4Var = coVar2.A1;
                    f4Var.setTranslationY(vl.D(520.0f, iArr[1] - f4Var.getTop(), this.f11479b));
            ...
            default:
                ...
                if (arrayList != null) {
                    ...
                    uyVar.W0 = null;
                    tyVar.f40886a.invalidate();
                    int N0 = tyVar.f40888c.N0();
                    if (N0 == this.f11479b - 1) {
                        tyVar.f40888c.m(N0).requestLayout();
                    }
                    boolean z10 = false;
                    ...
                    if (uyVar.V2 == 0) {
                        if (addDialogToFolder == 2) {
                            ...
                            if (i15 == 0) {
                                ...
                                tyVar.q(true);
                                if (!SharedConfig.archiveHidden && tyVar.f40888c.L0() == 0) {
                                    uyVar.f41289e2 = true;
                            ...
                            uyVar.R1.add(0, (TLRPC.Dialog) uyVar.R3(i13, tyVar.f40893s, uyVar.V2, false).get(0));
                            tyVar.q(true);
                            ...
                            s4.c1 K = tyVar.f40886a.K(0);
                            if (K != null) {
                                View view = K.f45767a;
                                if (view instanceof r2) {
                                    r2 r2Var = (r2) view;
                                    if (r2Var.a2.f27064n == 2) {
                                        r2Var.f22568b2 = true;
                                        r2Var.f22573c2 = 0.0f;
                                        j6.f20995u1.Q(0.0f, true);
                                        j6.f20995u1.start();
                                        r2Var.invalidate();
                                    }
                                }
                    ...
                    if (uyVar.V2 != 0 && uyVar.R1.isEmpty()) {
                        tyVar.f40886a.setEmptyView(null);
                        tyVar.f40894w.setVisibility(4);
                        return;
                    }
                    return;
                }
