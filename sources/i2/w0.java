...
public final class w0 {
    ...
    public final v0 c(b2.k1 k1Var, u0 u0Var, long j3) {
        ...
        if (v0Var.h) {
            ...
            int d = k1Var.d(k1Var.b(f0Var.f43640a), this.f10893a, this.f10894b, this.f10897g, this.h);
            if (d != -1) {
                ...
                if (j12 != -9223372036854775807L && j15 != -9223372036854775807L) {
                    int i11 = k1Var.g(f0Var.f43640a, h1Var2).f3008g.f2928a;
        ...
        Object obj4 = f0Var2.f43640a;
        int i12 = f0Var2.e;
        b2.h1 h1Var3 = this.f10893a;
        k1Var.g(obj4, h1Var3);
        boolean z10 = v0Var.f10888g;
        if (f0Var2.b()) {
            int i13 = f0Var2.f43641b;
            int i14 = h1Var3.f3008g.a(i13).f2908a;
            if (i14 != -1) {
                int a2 = h1Var3.f3008g.a(i13).a(f0Var2.f43642c);
                if (a2 < i14) {
                    return e(k1Var, f0Var2.f43640a, i13, a2, v0Var.f10886c, f0Var2.d, z10);
                }
                ...
                int i16 = f0Var2.f43641b;
                k1Var2.g(obj4, h1Var);
                h1Var.d(i16);
                h1Var.f3008g.a(i16).getClass();
                return f(k1Var, f0Var2.f43640a, Math.max(j10, j18), v0Var.f10886c, f0Var2.d, z10);
            }
            return null;
        }
        if (i12 != -1) {
        ...
        if (e != h1Var3.f3008g.a(i12).f2908a) {
            return e(k1Var, f0Var2.f43640a, f0Var2.e, e, v0Var.e, f0Var2.d, z10);
        }
        k1Var.g(obj4, h1Var3);
        h1Var3.d(i12);
        h1Var3.f3008g.a(i12).getClass();
        return f(k1Var, f0Var2.f43640a, 0L, v0Var.e, f0Var2.d, false);
    }

    public final v0 d(b2.k1 k1Var, u2.f0 f0Var, long j3, long j10) {
        k1Var.g(f0Var.f43640a, this.f10893a);
        if (f0Var.b()) {
            return e(k1Var, f0Var.f43640a, f0Var.f43641b, f0Var.f43642c, j3, f0Var.d, false);
        }
        return f(k1Var, f0Var.f43640a, j10, j3, f0Var.d, false);
    }
