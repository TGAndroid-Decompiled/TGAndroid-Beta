...
public final class c1 implements u2.l0, n2.l {
    public final e1 f10633a;
    public final f1 f10634b;
    ...
    public final void a(int i10, u2.f0 f0Var, int i11) {
        Pair l4 = l(i10, f0Var);
        if (l4 != null) {
            this.f10634b.f10703i.c(new s1(this, l4, i11, 13));
        }
    }
    ...
    public final void b(int i10, u2.f0 f0Var, Exception exc) {
        Pair l4 = l(i10, f0Var);
        if (l4 != null) {
            this.f10634b.f10703i.c(new gg.t(this, l4, exc, 14));
        }
    }
    ...
    public final void c(int i10, u2.f0 f0Var, u2.b0 b0Var) {
        Pair l4 = l(i10, f0Var);
        if (l4 != null) {
            this.f10634b.f10703i.c(new y0(this, l4, b0Var, 0));
        }
    }
    ...
    public final void d(int i10, u2.f0 f0Var, u2.b0 b0Var) {
        Pair l4 = l(i10, f0Var);
        if (l4 != null) {
            this.f10634b.f10703i.c(new y0(this, l4, b0Var, 1));
        }
    }
    ...
    public final void e(int i10, u2.f0 f0Var, u2.t tVar, u2.b0 b0Var) {
        Pair l4 = l(i10, f0Var);
        if (l4 != null) {
            this.f10634b.f10703i.c(new a1(this, l4, tVar, b0Var, 1));
        }
    }
    ...
    public final void f(int i10, u2.f0 f0Var, u2.t tVar, u2.b0 b0Var, IOException iOException, boolean z10) {
        Pair l4 = l(i10, f0Var);
        if (l4 != null) {
            this.f10634b.f10703i.c(new b1(this, l4, tVar, b0Var, iOException, z10, 0));
        }
    }
    ...
    public final void g(int i10, u2.f0 f0Var) {
        Pair l4 = l(i10, f0Var);
        if (l4 != null) {
            this.f10634b.f10703i.c(new z0(this, l4, 1));
        }
    }
    ...
    public final void h(int i10, u2.f0 f0Var, u2.t tVar, u2.b0 b0Var, int i11) {
        Pair l4 = l(i10, f0Var);
        if (l4 != null) {
            this.f10634b.f10703i.c(new l3(this, l4, tVar, b0Var, i11, 4));
        }
    }
    ...
    public final void i(int i10, u2.f0 f0Var) {
        Pair l4 = l(i10, f0Var);
        if (l4 != null) {
            this.f10634b.f10703i.c(new z0(this, l4, 2));
        }
    }
    ...
    public final void j(int i10, u2.f0 f0Var, u2.t tVar, u2.b0 b0Var) {
        Pair l4 = l(i10, f0Var);
        if (l4 != null) {
            this.f10634b.f10703i.c(new a1(this, l4, tVar, b0Var, 0));
        }
    }
    ...
    public final void k(int i10, u2.f0 f0Var) {
        Pair l4 = l(i10, f0Var);
        if (l4 != null) {
            this.f10634b.f10703i.c(new z0(this, l4, 0));
        }
    }

    public final Pair l(int i10, u2.f0 f0Var) {
        u2.f0 f0Var2;
        e1 e1Var = this.f10633a;
        u2.f0 f0Var3 = null;
        if (f0Var != null) {
            int i11 = 0;
            while (true) {
                if (i11 < e1Var.f10684c.size()) {
                    if (((u2.f0) e1Var.f10684c.get(i11)).d == f0Var.d) {
                        Object obj = f0Var.f43653a;
                        Object obj2 = e1Var.f10683b;
                        int i12 = a.f10615g;
