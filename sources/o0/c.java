...
public abstract class c {
    public static final k f15476a = new k(2);
    public static final a4.e f15477b = new a4.e(21);
    ...
    public static ProviderInfo b(PackageManager packageManager, d dVar, Resources resources) {
        ...
        try {
            List list = dVar.d;
            String str = dVar.f15478a;
            String str2 = dVar.f15479b;
            if (list == null) {
    ...
    public static h[] c(Context context, d dVar, String str) {
        ...
        try {
            ...
            Cursor q6 = cVar.q(build, strArr, new String[]{dVar.f15480c});
            Trace.endSection();
