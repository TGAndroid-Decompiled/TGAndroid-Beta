...
public abstract class h {
    public static final a0.j f16298a = new a0.j(16);
    public static final ThreadPoolExecutor f16299b;
    public static final Object f16300c;
    ...
    public static String a(int i10, List list) {
        ...
        for (int i11 = 0; i11 < list.size(); i11++) {
            sb.append(((d) list.get(i11)).f16289e);
            sb.append("-");
            sb.append(i10);
            if (i11 < list.size() - 1) {
                sb.append(";");
