...
public abstract class d {
    public static final a0.k f15444a = new a0.k(2);
    public static final a4.e f15445b = new a4.e(21);
    ...
    public static ProviderInfo b(PackageManager packageManager, e eVar, Resources resources) {
        ...
        try {
            List list = eVar.d;
            String str = eVar.f15446a;
            String str2 = eVar.f15447b;
            if (list == null) {
    ...
    public static i[] c(Context context, e eVar, String str) {
        ...
        try {
            ...
            Cursor q6 = cVar.q(build, strArr, new String[]{eVar.f15448c});
            Trace.endSection();
