...
public final class f implements ScheduledExecutorService, AutoCloseable {
    public final ExecutorService f45049a;
    public final ScheduledExecutorService f45050b;

    public f(ExecutorService executorService, ScheduledExecutorService scheduledExecutorService) {
        this.f45049a = executorService;
        this.f45050b = scheduledExecutorService;
    }

    @Override
    public final boolean awaitTermination(long j3, TimeUnit timeUnit) {
        return this.f45049a.awaitTermination(j3, timeUnit);
    }
    ...
    public final void execute(Runnable runnable) {
        this.f45049a.execute(runnable);
    }

    @Override
    public final List invokeAll(Collection collection) {
        return this.f45049a.invokeAll(collection);
    }

    @Override
    public final Object invokeAny(Collection collection) {
        return this.f45049a.invokeAny(collection);
    }

    @Override
    public final boolean isShutdown() {
        return this.f45049a.isShutdown();
    }

    @Override
    public final boolean isTerminated() {
        return this.f45049a.isTerminated();
    }
    ...
    public final Future submit(Runnable runnable, Object obj) {
        return this.f45049a.submit(runnable, obj);
    }

    @Override
    public final Future submit(Runnable runnable) {
        return this.f45049a.submit(runnable);
    }
}
