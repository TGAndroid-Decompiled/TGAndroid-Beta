...
public final class s1 extends FrameLayout {
    public final p9 f6748a;
    public final t1 f6749b;
    ...
    public s1(Context context) {
        ...
        view.f6756a = paint2;
        view.f6757b = view.getContext().getDrawable(R.drawable.mini_boost_remove);
        int i10 = j6.f19977h5;
    ...
    public final void dispatchDraw(Canvas canvas) {
        canvas.drawCircle(getMeasuredWidth() / 2.0f, getMeasuredHeight() / 2.0f, (getMeasuredHeight() / 2.0f) - AndroidUtilities.dp(2.0f), this.f6750c);
