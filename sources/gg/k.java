...
public final class k extends og.a {
    public final TLRPC.Dialog f9799c;
    ...
    public final TL_chatlists.TL_chatlists_chatlistUpdates f9802i;
    public final int f9803j;
    public final int f9804k;
    public final String f9805l;
    public final TLRPC.Chat f9806m;
    public final TLRPC.User f9807n;

    public k(m mVar, TL_chatlists.TL_chatlists_chatlistUpdates tL_chatlists_chatlistUpdates) {
        super(17, true);
        this.f9802i = tL_chatlists_chatlistUpdates;
        int i10 = mVar.W;
        mVar.W = i10 + 1;
        this.f9804k = i10;
    }
    ...
    public final int hashCode() {
        return Objects.hash(this.f9799c, this.f9806m, this.d, this.e, this.f9805l);
    }
    ...
    public k(m mVar, TLRPC.User user) {
        ...
        mVar.W = i11 + 1;
        this.f9804k = i11;
        longSparseIntArray.put(user.f18256id, i11);
    }
    ...
    public k(m mVar, TLRPC.Chat chat) {
        ...
        mVar.W = i11 + 1;
        this.f9804k = i11;
        longSparseIntArray.put(-chat.f18109id, i11);
    }
    ...
    public k(m mVar, int i10, TLRPC.Dialog dialog) {
        ...
        this.f9799c = dialog;
        if (dialog != null) {
            int i11 = longSparseIntArray.get(dialog.f18113id, -1);
            if (i11 >= 0) {
                this.f9804k = i11;
            } else {
                int i12 = mVar.W;
                mVar.W = i12 + 1;
                this.f9804k = i12;
                longSparseIntArray.put(dialog.f18113id, i12);
            }
        } else if (i10 == 19) {
            this.f9804k = 5;
        } else {
        ...
        if (dialog != null) {
            ...
            if (i14 != 7 && i14 != 8) {
                ...
                this.f9801g = (dialogFilter == null || dialogFilter.pinnedDialogs.indexOfKey(dialog.f18113id) < 0) ? false : false;
            }
            this.h = dialog.isFolder;
            this.f9800f = MessagesController.getInstance(i15).isForum(dialog.f18113id);
        }
    }
