    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        switch (this.f9793a) {
            ...
            case 1:
                ...
                return;
            case 2:
                ((s4.c1) this.f9794b).f42946a.setAlpha(1.0f);
                ((AnimatorSet) this.f9795c).removeAllListeners();
                bt btVar = (bt) this.e;
                zs zsVar = (zs) this.d;
                btVar.d(zsVar.f30970a);
                btVar.f23062y.remove(zsVar.f30970a);
                btVar.A();
                btVar.d(zsVar.f30971b);
                btVar.f23062y.remove(zsVar.f30971b);
                btVar.A();
                return;
            case 3:
                ((jv0) this.e).H1 = false;
            ...
            case 4:
                q2 q2Var = (q2) this.e;
                TextView[] textViewArr = q2Var.f29564a;
            ...
            default:
                ...
                profileActivity.f31540e0.setProgressToExpand(0.0f);
                profileActivity.f31510a.setLayerType(0, null);
                ...
                if (profileActivity.J1 == 2) {
                    ...
                    profileActivity.f31540e0.setForegroundAlpha(1.0f);
                    profileActivity.Y.setVisibility(8);
                    profileActivity.f31601n0.setAlpha(1.0f);
                    profileActivity.f31601n0.L();
                    profileActivity.f31601n0.setVisibility(0);
                }
                profileActivity.W4 = null;
                profileActivity.Z.invalidate();
                profileActivity.f31560g5 = null;
    ...
    public void onAnimationStart(Animator animator) {
        switch (this.f9793a) {
            ...
            case 2:
                bt btVar = (bt) this.e;
                zs zsVar = (zs) this.d;
                s4.c1 c1Var = zsVar.f30970a;
                btVar.getClass();
                s4.c1 c1Var2 = zsVar.f30971b;
                btVar.getClass();
                return;
            default:
