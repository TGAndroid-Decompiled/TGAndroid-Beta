...
public final class k1 extends ll0 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public k1(Context context, long j3, long j10, ia0 ia0Var, f6 f6Var, boolean z10) {
        ...
        NotificationCenter.ObserversGroup add = NotificationCenter.getInstance(this.f9821f).createWeakObserversGroup(this).add(NotificationCenter.recentDocumentsDidLoad).add(NotificationCenter.stickersDidLoad);
        this.J0 = add;
        ...
        if (user != null && user.bot && user.bot_inline_placeholder != null) {
            ...
            if (this.f9842w0.bot_inline_geo) {
                ...
                if (!notificationsSettings.getBoolean("inlinegeo_" + this.f9842w0.f18268id, false) && (boVar = this.G0) != null && boVar.getParentActivity() != null) {
                    ...
                    alertDialog$Builder.f18447a.R = LocaleController.getString(R.string.ShareYouLocationTitle);
                    alertDialog$Builder.f18447a.T = LocaleController.getString(R.string.ShareYouLocationInline);
                    ...
                    this.G0.showDialog(alertDialog$Builder.f18447a, new ei.e0(this, zArr, 2));
                } else {
                    G();
                }
            }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i12 == 4) {
            ...
            if (i11 >= 0 && i11 < this.A0.size()) {
                ...
                rg.b1 b1Var = d8Var.f19944n;
                u9 u9Var = d8Var.f19940a;
                d8Var.f19942c = obj;
                boolean isPremiumSticker = MessageObject.isPremiumSticker(document);
                d8Var.f19946s = isPremiumSticker;
                if (isPremiumSticker) {
                    b1Var.setColor(j6.w0(null, j6.f18863d6, false));
                    b1Var.H = true;
                    b1Var.I = false;
                    b1Var.invalidate();
                }
                TLRPC.PhotoSize closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(document.thumbs, 90);
                SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(document, j6.f18807a7, 1.0f, 1.0f, d8Var.v);
                if (MessageObject.canAutoplayAnimatedSticker(document)) {
                    if (svgThumb != null) {
                        u9Var.i(ImageLocation.getForDocument(document), "80_80", null, svgThumb, d8Var.f19942c);
                        f7 = 1.0f;
                    } else if (closestPhotoSizeWithSize != null) {
                        f7 = 1.0f;
                        u9Var.j(ImageLocation.getForDocument(document), "80_80", ImageLocation.getForDocument(closestPhotoSizeWithSize, document), null, 0, d8Var.f19942c);
                    } else {
                        f7 = 1.0f;
                        u9Var.i(ImageLocation.getForDocument(document), "80_80", null, null, d8Var.f19942c);
                    }
                } else {
                    f7 = 1.0f;
                    if (svgThumb != null) {
                        if (closestPhotoSizeWithSize != null) {
                            u9Var.i(ImageLocation.getForDocument(closestPhotoSizeWithSize, document), null, "webp", svgThumb, d8Var.f19942c);
                        } else {
                            u9Var.i(ImageLocation.getForDocument(document), null, "webp", svgThumb, d8Var.f19942c);
                        }
                    } else {
                        u9Var.i(ImageLocation.getForDocument(closestPhotoSizeWithSize, document), null, "webp", null, d8Var.f19942c);
                    }
                }
                d8Var.f19941b = document;
                ...
                AndroidUtilities.updateViewVisibilityAnimated(b1Var, d8Var.f19945r, 0.9f, false);
                d8Var.invalidate();
                    ...
                    if (arrayList4 != null && i11 >= 0 && i11 < arrayList4.size()) {
                        ...
                        if (arrayList5 != null && i11 >= 0 && i11 < arrayList5.size()) {
                            ...
                            if (arrayList6 != null && i11 >= 0 && i11 < arrayList6.size()) {
                                ...
                                p4 p4Var = g5Var.f20147b;
                                TextView textView2 = g5Var.f20148c;
                                f9 f9Var = g5Var.d;
                                u9 u9Var2 = g5Var.f20146a;
                                g5Var.a();
                                if (user != null) {
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                ...
                if (i10 != 2) {
                            ...
                            if (i10 != 6) {
                                if (i10 != 7) {
                                    ...
                                    if (z10) {
                                        ...
                                        v02 = j6.v0(j6.f18807a7, f6Var);
                                    }
                                    pq pqVar = new pq(new ColorDrawable(v02), j6.U0(context, R.drawable.greydivider, j6.v0(j6.f18827b7, f6Var)), 0, 0);
                                    pqVar.f27116w = true;
                    ...
                    frameLayout2.f20236a = textView3;
