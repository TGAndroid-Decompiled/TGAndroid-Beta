...
public final class k1 extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        TextPaint textPaint = this.f6680a;
        ...
        canvas.drawText("+" + this.f6681b, measuredWidth, (int) (measuredHeight - ((textPaint.ascent() + descent) / 2.0f)), textPaint);
    }
}
