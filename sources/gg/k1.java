...
public final class k1 extends kl0 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean f9812b0;
    public int f9814c0;
    public ArrayList f9815d0;
    public int f9819g0;
    public final Context h;
    public int f9821i0;
    public int f9822j0;
    public boolean f9823k0;
    public TLRPC.Chat f9824l0;
    public long f9825n;
    public g1 f9826n0;
    public boolean f9827o0;
    public t f9828p0;
    public String f9829q0;
    public final long f9830r;
    public String f9831r0;
    public final boolean f9832s;
    public String f9833s0;
    public int f9834t0;
    public int f9835u0;
    public TLRPC.ChatFull v;
    public boolean f9836v0;
    public final c2 f9837w;
    public TLRPC.User f9838w0;
    public ArrayList f9839x;
    public boolean f9840x0;
    public a0.i f9841y;
    public b1 f9842y0;
    public Location f9843z0;
    public boolean f9813c = true;
    public boolean d = true;
    public boolean e = true;
    public int f9817f = UserConfig.selectedAccount;
    public boolean f9816e0 = true;
    public boolean f9818f0 = true;
    public boolean f9820h0 = true;
    ...
    public k1(Context context, long j3, long j10, ia0 ia0Var, e6 e6Var, boolean z10) {
        ...
        this.f9837w = c2Var;
        c2Var.f9686a = new xa.c(this, 23);
        NotificationCenter.ObserversGroup add = NotificationCenter.getInstance(this.f9817f).createWeakObserversGroup(this).add(NotificationCenter.recentDocumentsDidLoad).add(NotificationCenter.stickersDidLoad);
        this.J0 = add;
    ...
    public final boolean D(s4.c1 c1Var) {
        if ((this.f9838w0 == null || this.f9820h0) && this.A0 == null) {
            return true;
        }
        return false;
    }
    ...
    public final void E(TLRPC.Document document, String str) {
        String str2 = document.dc_id + "_" + document.f18115id;
        HashMap hashMap = this.B0;
        if (hashMap == null || !hashMap.containsKey(str2)) {
            if (UserConfig.getInstance(this.f9817f).isPremium() || !MessageObject.isPremiumSticker(document)) {
                if (this.A0 == null) {
    ...
    public final void F(String str, ArrayList arrayList) {
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            while (i10 < size) {
                ...
                String str2 = document.dc_id + "_" + document.f18115id;
                HashMap hashMap = this.B0;
                if ((hashMap == null || !hashMap.containsKey(str2)) && (UserConfig.getInstance(this.f9817f).isPremium() || !MessageObject.isPremiumSticker(document))) {
    ...
    public final void H() {
        ...
        for (int i10 = 0; i10 < min; i10++) {
            ...
            TLRPC.PhotoSize closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(j1Var.f9797a.thumbs, 90);
            if (((closestPhotoSizeWithSize instanceof TLRPC.TL_photoSize) || (closestPhotoSizeWithSize instanceof TLRPC.TL_photoSizeProgressive)) && !FileLoader.getInstance(this.f9817f).getPathToAttach(closestPhotoSizeWithSize, "webp", true).exists()) {
                arrayList.add(FileLoader.getAttachFileName(closestPhotoSizeWithSize, "webp"));
                FileLoader.getInstance(this.f9817f).loadFile(ImageLocation.getForDocument(closestPhotoSizeWithSize, j1Var.f9797a), j1Var.f9798b, "webp", 1, 1);
            }
        }
        arrayList.isEmpty();
    }
    ...
    public final TLRPC.TL_inlineBotSwitchPM I() {
        TLRPC.User user = this.f9838w0;
        if (user != null && user.f18256id != this.S) {
            return null;
        }
        return this.T;
    }
    ...
    public final Object J(int i10) {
        ...
        if (arrayList != null) {
            if (i10 >= 0 && i10 < arrayList.size()) {
                return ((j1) this.A0.get(i10)).f9797a;
            }
        } else {
            ...
            if (arrayList2 != null) {
                ...
                ArrayList arrayList3 = this.f9839x;
                if (arrayList3 != null) {
                    if (i10 >= 0 && i10 < arrayList3.size()) {
                        return this.f9839x.get(i10);
                    }
                } else {
                        ...
                        if (arrayList5 != null) {
                            ...
                            if (arrayList6 != null || this.J != null) {
                                ...
                                if (arrayList8 != null && i10 >= 0 && i10 < arrayList8.size()) {
                                    ...
                                    if (arrayList9 != null && (this.f9819g0 != 1 || (this.v instanceof TLRPC.TL_channelFull))) {
    ...
    public final int K() {
        ...
        int i11;
        int i12 = 1;
        if (this.f9838w0 != null && !this.f9820h0) {
            return 1;
        }
        int i13 = 0;
        if (this.F != null) {
    ...
    public final Object L(int i10) {
        ...
        return ((j1) this.A0.get(i10)).f9798b;
    }
    ...
    public final void P() {
        ...
        b1 b1Var = this.f9842y0;
        if (b1Var != null) {
            AndroidUtilities.cancelRunOnUIThread(b1Var);
            this.f9842y0 = null;
        }
        if (this.f9834t0 != 0) {
            ConnectionsManager.getInstance(this.f9817f).cancelRequest(this.f9834t0, true);
            this.f9834t0 = 0;
        }
        if (this.f9835u0 != 0) {
            ConnectionsManager.getInstance(this.f9817f).cancelRequest(this.f9835u0, true);
            this.f9835u0 = 0;
        }
        this.f9838w0 = null;
        this.T = null;
    ...
    public final void Q() {
        ...
        if (user != null && user.bot_inline_geo) {
            ...
            this.f9843z0 = location;
            location.setLatitude(-1000.0d);
            this.f9843z0.setLongitude(-1000.0d);
            T(true, this.f9838w0, this.f9831r0, "");
        }
    }
    ...
    public final void R(TLRPC.User user) {
        ...
        if (user != null && user.bot && user.bot_inline_placeholder != null) {
            ...
            if (this.f9838w0.bot_inline_geo) {
                SharedPreferences notificationsSettings = MessagesController.getNotificationsSettings(this.f9817f);
                if (!notificationsSettings.getBoolean("inlinegeo_" + this.f9838w0.f18256id, false) && (boVar = this.G0) != null && boVar.getParentActivity() != null) {
                    TLRPC.User user2 = this.f9838w0;
                    AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(this.G0.getParentActivity());
                    alertDialog$Builder.f18435a.R = LocaleController.getString(R.string.ShareYouLocationTitle);
                    alertDialog$Builder.f18435a.T = LocaleController.getString(R.string.ShareYouLocationInline);
                    ...
                    this.G0.showDialog(alertDialog$Builder.f18435a, new ei.e0(this, zArr, 2));
                } else {
                    G();
                }
            }
    ...
    public final void T(boolean z10, TLRPC.User user, String str, String str2) {
        ...
        if (this.f9820h0 && this.d) {
            if (str != null && user != null) {
                if (!user.bot_inline_geo || this.f9843z0 != null) {
                    ...
                    sb2.append(this.f9825n);
                    sb2.append("_");
                    sb2.append(user.f18256id);
                    sb2.append("_");
                    if (user.bot_inline_geo && this.f9843z0.getLatitude() != -1000.0d) {
                        obj = Double.valueOf(this.f9843z0.getLongitude() + this.f9843z0.getLatitude());
                    } else {
                        obj = "";
                    }
                    sb2.append(obj);
                    String sb3 = sb2.toString();
                    MessagesStorage messagesStorage = MessagesStorage.getInstance(this.f9817f);
                    ...
                    tL_messages_getInlineBotResults.bot = MessagesController.getInstance(this.f9817f).getInputUser(user);
                    tL_messages_getInlineBotResults.query = str;
                    tL_messages_getInlineBotResults.offset = str2;
                    if (user.bot_inline_geo && (location = this.f9843z0) != null && location.getLatitude() != -1000.0d) {
                        tL_messages_getInlineBotResults.flags |= 1;
                        TLRPC.TL_inputGeoPoint tL_inputGeoPoint = new TLRPC.TL_inputGeoPoint();
                        tL_messages_getInlineBotResults.geo_point = tL_inputGeoPoint;
                        tL_inputGeoPoint.lat = AndroidUtilities.fixLocationCoord(this.f9843z0.getLatitude());
                        tL_messages_getInlineBotResults.geo_point._long = AndroidUtilities.fixLocationCoord(this.f9843z0.getLongitude());
                    }
                    if (DialogObject.isEncryptedDialog(this.f9825n)) {
                        tL_messages_getInlineBotResults.peer = new TLRPC.TL_inputPeerEmpty();
                    } else {
                        tL_messages_getInlineBotResults.peer = MessagesController.getInstance(this.f9817f).getInputPeer(this.f9825n);
                    }
                    this.f9835u0 = ConnectionsManager.getInstance(this.f9817f).sendRequest(tL_messages_getInlineBotResults, x0Var, 2);
                    return;
                }
                return;
            }
    ...
    public final void W(TLRPC.ChatFull chatFull) {
        bo boVar;
        TLRPC.Chat chat;
        this.f9817f = UserConfig.selectedAccount;
        this.v = chatFull;
        if (!this.f9820h0 && this.f9838w0 != null && (boVar = this.G0) != null && (chat = boVar.e) != null) {
            boolean canSendStickers = ChatObject.canSendStickers(chat);
            this.f9820h0 = canSendStickers;
            if (canSendStickers) {
                this.f9839x = null;
        ...
        String str = this.Z;
        if (str != null) {
            U(str, this.f9814c0, this.f9815d0, this.f9812b0, this.f9811a0);
        }
    }
        ...
        if (!this.d || !this.e) {
            ...
            while (it.hasNext()) {
                ...
                if ((tLObject instanceof TLRPC.Chat) && !this.e) {
                    ...
                    if (user.bot || UserObject.isService(user.f18256id)) {
                        it.remove();
                    }
                }
            }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            if (!arrayList2.isEmpty() && this.f9827o0) {
                ...
                if (i11 >= 0) {
                    ...
                    if (i11 < objArr2.length && i11 < K) {
                        ...
                        if (!(obj instanceof hg.b2)) {
                            if (obj != obj2 && ((!(obj instanceof j1) || !(obj2 instanceof j1) || ((j1) obj).f9797a != ((j1) obj2).f9797a) && ((!(obj instanceof TLRPC.User) || !(obj2 instanceof TLRPC.User) || ((TLRPC.User) obj).f18256id != ((TLRPC.User) obj2).f18256id) && ((!(obj instanceof TLRPC.Chat) || !(obj2 instanceof TLRPC.Chat) || ((TLRPC.Chat) obj).f18109id != ((TLRPC.Chat) obj2).f18109id) && (!(obj instanceof String) || !(obj2 instanceof String) || !obj.equals(obj2)))))) {
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i12 == 4) {
            ...
            if (i11 >= 0 && i11 < this.A0.size()) {
                ...
                TLRPC.Document document = j1Var.f9797a;
                Object obj = j1Var.f9798b;
                rg.b1 b1Var = d8Var.f19912n;
                u9 u9Var = d8Var.f19908a;
                d8Var.f19910c = obj;
                boolean isPremiumSticker = MessageObject.isPremiumSticker(document);
                d8Var.f19914s = isPremiumSticker;
                if (isPremiumSticker) {
                    b1Var.setColor(i6.w0(null, i6.f18834d6, false));
                    b1Var.H = true;
                    b1Var.I = false;
                    b1Var.invalidate();
                }
                TLRPC.PhotoSize closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(document.thumbs, 90);
                SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(document, i6.f18778a7, 1.0f, 1.0f, d8Var.v);
                if (MessageObject.canAutoplayAnimatedSticker(document)) {
                    if (svgThumb != null) {
                        u9Var.i(ImageLocation.getForDocument(document), "80_80", null, svgThumb, d8Var.f19910c);
                        f7 = 1.0f;
                    } else if (closestPhotoSizeWithSize != null) {
                        f7 = 1.0f;
                        u9Var.j(ImageLocation.getForDocument(document), "80_80", ImageLocation.getForDocument(closestPhotoSizeWithSize, document), null, 0, d8Var.f19910c);
                    } else {
                        f7 = 1.0f;
                        u9Var.i(ImageLocation.getForDocument(document), "80_80", null, null, d8Var.f19910c);
                    }
                } else {
                    f7 = 1.0f;
                    if (svgThumb != null) {
                        if (closestPhotoSizeWithSize != null) {
                            u9Var.i(ImageLocation.getForDocument(closestPhotoSizeWithSize, document), null, "webp", svgThumb, d8Var.f19910c);
                        } else {
                            u9Var.i(ImageLocation.getForDocument(document), null, "webp", svgThumb, d8Var.f19910c);
                        }
                    } else {
                        u9Var.i(ImageLocation.getForDocument(closestPhotoSizeWithSize, document), null, "webp", null, d8Var.f19910c);
                    }
                }
                d8Var.f19909b = document;
                ...
                AndroidUtilities.updateViewVisibilityAnimated(b1Var, d8Var.f19913r, 0.9f, false);
                d8Var.invalidate();
            ...
            if (arrayList2 != null) {
                ...
                if (i11 >= 0 && i11 < arrayList2.size()) {
                    ...
                    e2Var.e(botInlineResult, user2, z13, z11, z12, "gif".equals(this.f9829q0));
                }
            } else if (i12 == 6) {
                i1 i1Var = (i1) view;
                int i13 = i11 + 2;
                    ...
                    if (arrayList4 != null && i11 >= 0 && i11 < arrayList4.size()) {
                        ...
                        if (arrayList5 != null && i11 >= 0 && i11 < arrayList5.size()) {
                            ...
                            if (arrayList6 != null && i11 >= 0 && i11 < arrayList6.size()) {
                                ...
                                p4 p4Var = h5Var.f20167b;
                                TextView textView2 = h5Var.f20168c;
                                f9 f9Var = h5Var.d;
                                u9 u9Var2 = h5Var.f20166a;
                                h5Var.a();
                                if (user != null) {
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                ...
                if (i10 != 2) {
                    if (i10 != 3) {
                        if (i10 != 5) {
                            boolean z10 = this.f9832s;
                            if (i10 != 6) {
                                if (i10 != 7) {
                                    ?? frameLayout = new FrameLayout(context);
                                    frameLayout.v = e6Var;
                                    u9 u9Var = new u9(context);
                                    frameLayout.f19908a = u9Var;
                                    ...
                                    if (z10) {
                                        ...
                                        v02 = i6.v0(i6.f18778a7, e6Var);
                                    }
                                    pq pqVar = new pq(new ColorDrawable(v02), i6.U0(context, R.drawable.greydivider, i6.v0(i6.f18798b7, e6Var)), 0, 0);
                                    pqVar.f27122w = true;
                    ...
                    frameLayout2.f20186a = textView3;
