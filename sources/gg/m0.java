            ...
            if (i12 == 4) {
                ...
                if (tLObject instanceof TLRPC.User) {
                    ...
                    if (tLObject2 instanceof TLRPC.User) {
                        if (((TLRPC.User) tLObject).f18482id == ((TLRPC.User) tLObject2).f18482id) {
                            return true;
                        }
                        return false;
                    }
                ...
                if (tLObject instanceof TLRPC.Chat) {
                    ...
                    if ((tLObject3 instanceof TLRPC.Chat) && ((TLRPC.Chat) tLObject).f18335id == ((TLRPC.Chat) tLObject3).f18335id) {
                        return true;
                    }
                    return false;
                }
