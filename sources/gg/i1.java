...
public final class i1 extends LinearLayout {
    public final e6 f9790a;
    public final u9 f9791b;
    public final f9 f9792c;
    ...
    public final void a(int i10, String str, TLRPC.Chat chat) {
        ...
        u9 u9Var = this.f9791b;
        if (i10 == 0) {
            pq pqVar = new pq(i6.b0(AndroidUtilities.dp(28.0f), i6.v0(i6.Oh, this.f9790a)), getContext().getResources().getDrawable(R.drawable.menu_hashtag).mutate());
            pqVar.f27124s = AndroidUtilities.dp(-0.66f);
            pqVar.v = 0;
        ...
        d10Var.f32894f = i6.w0(null, i6.Lj, false);
