...
public final class c1 implements Comparator {
    ...
    public final int a(j1 j1Var) {
        ...
        while (true) {
            ...
            if (i11 >= arrayList.size()) {
                while (true) {
                    ...
                    if (i10 < Math.min(20, arrayList2.size())) {
                        if (((TLRPC.Document) arrayList2.get(i10)).f18341id == j1Var.f9782a.f18341id) {
            ...
            } else if (((TLRPC.Document) arrayList.get(i11)).f18341id == j1Var.f9782a.f18341id) {
                return i11 + 2000000;
            } else {
                i11++;
            }
    ...
    public final int compare(Object obj, Object obj2) {
        j1 j1Var = (j1) obj;
        j1 j1Var2 = (j1) obj2;
        boolean isAnimatedStickerDocument = MessageObject.isAnimatedStickerDocument(j1Var.f9782a, true);
        if (isAnimatedStickerDocument == MessageObject.isAnimatedStickerDocument(j1Var2.f9782a, true)) {
            int a2 = a(j1Var);
            int a10 = a(j1Var2);
            if (a2 <= a10) {
                if (a2 >= a10) {
