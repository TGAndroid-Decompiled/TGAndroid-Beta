    ...
    public final void run() {
        ...
        switch (i10) {
            case 0:
                ...
                int l10 = p0.l(b1Var.f6572j0);
                int i11 = b1Var.f6569g0;
                int i12 = ig.w.f7551s;
                if (i11 == 1) {
                    z4 = true;
                } else {
                ...
                b1Var.f6575n0.b(true);
                ArrayList arrayList = b1Var.Z;
                ArrayList arrayList2 = b1Var.f6564b0;
                TLRPC.Chat chat = b1Var.Y;
                boolean z10 = b1Var.f6582u0;
                boolean z11 = b1Var.f6581t0;
                int i13 = prepaidGiveaway.quantity;
                String str = b1Var.f6580s0;
                ArrayList arrayList3 = arrayList;
                x0 x0Var = new x0(b1Var, tL_prepaidStarsGiveaway, this.f6745b, this.f6746c, prepaidGiveaway);
                ...
                if (prepaidGiveaway instanceof TL_stories.TL_prepaidGiveaway) {
                    ...
                    tL_inputStorePaymentStarsGiveaway.boost_peer = messagesController.getInputPeer(-chat.f19184id);
                    ...
                    while (i16 < size2) {
                        ...
                        if (tLObject instanceof TLRPC.Chat) {
                            tL_inputStorePaymentStarsGiveaway.additional_peers.add(messagesController.getInputPeer(-((TLRPC.Chat) tLObject).f19184id));
                        }
                    ...
                    while (i19 < size4) {
                        ...
                        if (tLObject2 instanceof TLRPC.Chat) {
                            tL_inputStorePaymentStarsGiveaway.additional_peers.add(messagesController.getInputPeer(-((TLRPC.Chat) tLObject2).f19184id));
                        }
                    }
                } else {
                    return;
                ...
                tL_payments_launchPrepaidGiveaway.giveaway_id = prepaidGiveaway.f19418id;
                tL_payments_launchPrepaidGiveaway.peer = messagesController.getInputPeer(-chat.f19184id);
                ...
                return;
            case 1:
                ((FileLoadOperation) obj3).lambda$getDownloadedLengthFromOffset$4((long[]) obj2, this.f6745b, this.f6746c, (CountDownLatch) obj);
                return;
            case 2:
                long j10 = this.f6746c;
                ((GiftAuctionController) obj3).lambda$sendBid$6((Utilities.Callback2) obj2, this.f6745b, (kh.r) obj, j10);
                return;
            case 3:
                ((MediaController) obj3).lambda$trimCurrentRecording$26((File) obj2, this.f6745b, this.f6746c, (Runnable) obj);
                return;
            case 4:
                ((MessagesStorage) obj3).lambda$getMessage$142(this.f6745b, this.f6746c, (AtomicReference) obj2, (CountDownLatch) obj);
                return;
            case 5:
                ((MessagesStorage) obj3).lambda$updateDialogsWithDeletedMessages$228(this.f6745b, this.f6746c, (ArrayList) obj2, (ArrayList) obj);
                return;
            case 6:
                ((TopicsController) obj3).lambda$getTopicRepliesCount$29((TLObject) obj2, (TLRPC.TL_forumTopic) obj, this.f6745b, this.f6746c);
                return;
            case 7:
                ((TopicsController) obj3).lambda$loadTopic$27(this.f6745b, (ArrayList) obj2, this.f6746c, (Runnable) obj);
                return;
            default:
                ((o70) obj3).u();
                Bundle bundle = new Bundle();
                bundle.putLong("dialog_id", this.f6745b);
                bundle.putLong("topic_id", this.f6746c);
