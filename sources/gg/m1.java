...
public final class m1 extends eg.e2 {
        ...
        if (arrayList2.size() == 1) {
            ...
            for (int i14 = 0; i14 < arrayList2.size(); i14++) {
                ...
                if (i14 == 0 && arrayList2.size() > 3) {
                    k1 k1Var = l1Var2.f6707b;
                    k1Var.setAlpha(1.0f);
                    k1Var.f6694b = arrayList2.size() - 3;
                }
                i13++;
                if (i14 == 2) {
                    break;
    ...
    public final void V(int i10, View view) {
        if (i10 == 0) {
            ...
            view.setBackgroundColor(j6.v0(j6.f19852a7, this.resourcesProvider));
    ...
    public final void W(hb1 hb1Var) {
        ...
        hb1Var.addView(view, b6.k(0.0f, f10, 0.0f, f11, -1, i10));
    }
