...
public abstract class u1 extends vl0 {
    ...
    public final void G(String str) {
        ...
        this.e.clear();
        if (this.f9949r) {
            this.f9947f.g(null, true, false, this.f9950s, this.v, this.f9952x, this.f9951w, 0, 0);
        }
        l();
                ...
                if (i10 != 3) {
                    if (i10 != 4) {
                        if (i10 != 5) {
                            ...
                            t00Var.setBackgroundColor(j6.w0(null, j6.f19062d6, false));
                            v3Var = t00Var;
                        }
                    } else {
