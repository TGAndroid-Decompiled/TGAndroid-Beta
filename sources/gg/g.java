...
public final class g extends s4.o {
    ...
    public final boolean b(int i10, int i11) {
        ...
        switch (this.f9738b) {
            ...
            case 2:
                return ((Integer) this.f9739c.get(i10)).equals(((sx) this.d).f27947n.get(i11));
            case 3:
                return Objects.equals(this.f9739c.get(i10), ((il0) this.d).f24960n.get(i11));
            default:
                return ((Long) this.f9739c.get(i10)).equals(((i71) this.d).f34495v0.get(i11));
        }
    }
    ...
    public final int d() {
        switch (this.f9738b) {
            ...
            case 2:
                return ((sx) this.d).f27947n.size();
            case 3:
                return ((il0) this.d).f24960n.size();
            default:
                return ((i71) this.d).f34495v0.size();
        }
    }
