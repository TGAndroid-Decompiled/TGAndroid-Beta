...
public abstract class p0 {
    ...
    public static ArrayList e(long j10) {
        ...
        for (int i10 = 0; i10 < allDialogs.size(); i10++) {
            ...
            if (DialogObject.isChatDialog(dialog.f19163id) && ChatObject.isBoostSupported(messagesController.getChat(Long.valueOf(-dialog.f19163id)))) {
    ...
    public static int j(int i10, TLRPC.Chat chat, Utilities.Callback callback) {
        ...
        if (chat != null) {
            ...
            tL_payments_getPremiumGiftCodeOptions.boost_peer = messagesController.getInputPeer(-chat.f19159id);
        }
    ...
    public static void k(ArrayList arrayList, TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption, TLRPC.Chat chat, TLRPC.TL_textWithEntities tL_textWithEntities, org.telegram.ui.ActionBar.p2 p2Var, Utilities.Callback callback, Utilities.Callback callback2) {
        ...
        if (!h()) {
            ...
            if (chat != null) {
                ...
                tL_inputStorePaymentPremiumGiftCode.boost_peer = messagesController.getInputPeer(-chat.f19159id);
            }
        ...
        if (chat != null) {
            ...
            tL_inputStorePaymentPremiumGiftCode2.boost_peer = messagesController2.getInputPeer(-chat.f19159id);
        }
        if (tL_textWithEntities != null && !TextUtils.isEmpty(tL_textWithEntities.text)) {
        ...
        b6.h hVar = new b6.h();
        hVar.f1610c = "inapp";
        hVar.f1609b = tL_premiumGiftCodeOption.store_product;
    ...
    public static void m(int i10, ArrayList arrayList) {
        ...
        f6721a.put(Integer.valueOf(i10), new Pair(Long.valueOf(System.currentTimeMillis()), arrayList));
    }
}
