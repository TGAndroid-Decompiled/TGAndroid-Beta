...
public final class c0 implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (i10) {
            case 0:
                ...
                if (tLObject instanceof TLRPC.TL_contacts_found) {
                    ...
                    for (int i11 = 0; i11 < tL_contacts_found.chats.size(); i11++) {
                        ...
                        if (chat.f19184id != j10 && ChatObject.isBoostSupported(chat)) {
                ...
                return;
            case 1:
                AndroidUtilities.runOnUIThread(new lh.c2((t7) obj2, (Object) tLObject, this.f6590b, (Object) ((Utilities.Callback) obj), 4));
                return;
            case 2:
                s7 s7Var = (s7) obj;
                s7Var.getClass();
                AndroidUtilities.runOnUIThread(new kh.g1(s7Var, tLObject, (MessagesController) obj2, tL_error, this.f6590b, 6));
                return;
            case 3:
                ...
                return;
            case 4:
                ((ConferenceCall) obj2).lambda$requestLastBlock$3(this.f6590b, (Runnable) obj, tLObject, tL_error);
                return;
            case 5:
                final oj0 oj0Var = (oj0) obj2;
                TLRPC.Chat chat2 = (TLRPC.Chat) obj;
                int i15 = oj0Var.f27578f;
                if (tLObject instanceof Vector) {
                    ...
                    if (ChatObject.isChannel(chat2)) {
                        ...
                        tL_channels_getParticipants.channel = MessagesController.getInstance(i15).getInputChannel(chat2.f19184id);
                                                    ...
                                                    case 0:
                                                        ...
                                                        if (tLObject3 != null) {
                                                            ...
                                                            for (int i18 = 0; i18 < tL_channels_channelParticipants.users.size(); i18++) {
                                                                ...
                                                                MessagesController.getInstance(oj0Var2.f27578f).putUser(user, false);
                                                                int indexOf = arrayList8.indexOf(Long.valueOf(user.f19331id));
                                                    ...
                                                    default:
                                                        ...
                                                        if (tLObject4 != null) {
                                                            ...
                                                            for (int i19 = 0; i19 < tL_messages_chatFull.users.size(); i19++) {
                                                                ...
                                                                MessagesController.getInstance(oj0Var2.f27578f).putUser(user2, false);
                                                                int indexOf2 = arrayList8.indexOf(Long.valueOf(user2.f19331id));
                                                ...
                                                switch (r7) {
                                                    case 0:
                                                        ...
                                                        if (tLObject3 != null) {
                                                            ...
                                                            for (int i18 = 0; i18 < tL_channels_channelParticipants.users.size(); i18++) {
                                                                TLRPC.User user = tL_channels_channelParticipants.users.get(i18);
                                                                MessagesController.getInstance(oj0Var3.f27578f).putUser(user, false);
                                                                int indexOf = arrayList11.indexOf(Long.valueOf(user.f19331id));
                                                                if (!user.self && indexOf >= 0) {
                                                    ...
                                                    default:
                                                        ...
                                                        if (tLObject4 != null) {
                                                            ...
                                                            for (int i19 = 0; i19 < tL_messages_chatFull.users.size(); i19++) {
                                                                TLRPC.User user2 = tL_messages_chatFull.users.get(i19);
                                                                MessagesController.getInstance(oj0Var3.f27578f).putUser(user2, false);
                                                                int indexOf2 = arrayList11.indexOf(Long.valueOf(user2.f19331id));
                                                                if (!user2.self && indexOf2 >= 0) {
                    ...
                    tL_messages_getFullChat.chat_id = chat2.f19184id;
            ...
            default:
                ...
                AndroidUtilities.runOnUIThread(new ci(tLObject, (MessagesController) obj2, this.f6590b, (rq) obj, 8));
                return;
        }
    }
    ...
    public c0(s7 s7Var, MessagesController messagesController, long j10) {
        this.f6589a = 2;
        this.d = s7Var;
        this.f6591c = messagesController;
        this.f6590b = j10;
    }
