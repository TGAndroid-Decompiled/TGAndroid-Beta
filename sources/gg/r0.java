...
public final class r0 implements y4, tv0, ig.g, ig.l {
    ...
    public void J(int i10, int i11, boolean z4) {
        b1 b1Var = this.f6727a;
        b1Var.f6559j0 = i10 * 1000;
        b1Var.a0(false, true);
    }
    ...
    public void g(int i10) {
        ...
        b1Var.f6562n0.f7470a.c(b1Var.V(), true);
        if (b1Var.f6554e0 == 3) {
            b1Var.a0(true, true);
        } else {
            b1Var.a0(false, false);
        }
        hg.b bVar = b1Var.f6553d0;
        int V = b1Var.V();
        for (int i14 = 0; i14 < bVar.f7058f.getChildCount(); i14++) {
            View childAt = bVar.f7058f.getChildAt(i14);
            if (childAt instanceof ig.z) {
                k6 k6Var = ((ig.z) childAt).f7543r;
                if (V <= 0) {
                    formatPluralString = "";
                } else {
