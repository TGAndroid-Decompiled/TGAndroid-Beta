...
public final class y implements g0, bl0 {
    ...
    public void a(a0.i iVar, ArrayList arrayList) {
        i0 i0Var = this.f9981a;
        int i10 = i0Var.f9779s0;
        i0Var.f9780t0 = arrayList;
        i0Var.f9786x0 = iVar;
        for (int i11 = 0; i11 < i0Var.f9780t0.size(); i11++) {
            h0 h0Var = (h0) i0Var.f9780t0.get(i11);
            TLObject tLObject = h0Var.f9749a;
            if (tLObject instanceof TLRPC.User) {
                MessagesController.getInstance(i10).putUser((TLRPC.User) h0Var.f9749a, true);
            } else if (tLObject instanceof TLRPC.Chat) {
                MessagesController.getInstance(i10).putChat((TLRPC.Chat) h0Var.f9749a, true);
    ...
    public boolean d(int i10, View view) {
        TLRPC.User user;
        gy gyVar = this.f9981a.U;
        if (gyVar != null) {
            Long l4 = (Long) view.getTag();
            long longValue = l4.longValue();
            uy uyVar = gyVar.f34036a;
            if (uyVar.getParentActivity() != null && (user = uyVar.getMessagesController().getUser(l4)) != null) {
                ...
                if (textView != null) {
                    textView.setTextColor(uyVar.getThemedColor(i6.f19074q7));
                }
            }
        }
        return true;
