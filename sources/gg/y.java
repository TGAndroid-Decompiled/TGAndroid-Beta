...
public final class y implements g0, ml0 {
    ...
    public void a(a0.i iVar, ArrayList arrayList) {
        ...
        int i10 = i0Var.f9783s0;
        i0Var.f9784t0 = arrayList;
        i0Var.f9790x0 = iVar;
        for (int i11 = 0; i11 < i0Var.f9784t0.size(); i11++) {
            h0 h0Var = (h0) i0Var.f9784t0.get(i11);
            TLObject tLObject = h0Var.f9753a;
            if (tLObject instanceof TLRPC.User) {
                MessagesController.getInstance(i10).putUser((TLRPC.User) h0Var.f9753a, true);
            } else if (tLObject instanceof TLRPC.Chat) {
                MessagesController.getInstance(i10).putChat((TLRPC.Chat) h0Var.f9753a, true);
            } else if (tLObject instanceof TLRPC.EncryptedChat) {
                MessagesController.getInstance(i10).putEncryptedChat((TLRPC.EncryptedChat) h0Var.f9753a, true);
            }
        }
        i0Var.G(null);
        i0Var.l();
    ...
    public boolean d(int i10, View view) {
        TLRPC.User user;
        gy gyVar = this.f9985a.U;
        if (gyVar != null) {
            Long l4 = (Long) view.getTag();
            long longValue = l4.longValue();
            uy uyVar = gyVar.f33967a;
            if (uyVar.getParentActivity() != null && (user = uyVar.getMessagesController().getUser(l4)) != null) {
                ...
                if (textView != null) {
                    textView.setTextColor(uyVar.getThemedColor(j6.f19301q7));
                }
            }
        }
        return true;
