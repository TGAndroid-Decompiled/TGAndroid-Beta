...
public final class n1 extends FrameLayout {
    ...
    public n1(Context context, d6 d6Var) {
        ...
        this.f9850b = j9Var;
        j9Var.f25321l = true;
        j9Var.f25325p = AndroidUtilities.dp(75.0f);
        j9Var.f25324o = AndroidUtilities.dp(48.0f);
        j9Var.f25332x = true;
        j9Var.f25328s = AndroidUtilities.dp(22.0f);
        for (int i11 = 0; i11 < 2; i11++) {
            ...
            this.d[i11].setTextColor(h6.v0(h6.f19447z6, d6Var));
