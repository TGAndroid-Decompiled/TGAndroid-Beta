...
public final class n1 extends FrameLayout {
    ...
    public n1(Context context, f6 f6Var) {
        ...
        this.f9869b = h9Var;
        h9Var.f24590l = true;
        h9Var.f24594p = AndroidUtilities.dp(75.0f);
        h9Var.f24593o = AndroidUtilities.dp(48.0f);
        h9Var.f24601x = true;
        h9Var.f24597s = AndroidUtilities.dp(22.0f);
        for (int i11 = 0; i11 < 2; i11++) {
            ...
            this.d[i11].setTextColor(j6.v0(j6.f19264z6, f6Var));
