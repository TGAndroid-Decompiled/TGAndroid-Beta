...
public final class f1 implements Runnable {
    public final TLRPC.Chat f9730a;
    public final String f9731b;
    public final long f9732c;
    public final ArrayList d;
    public final a0.i e;
    public final MessagesController f9733f;
    public final k1 h;
    ...
    public f1(k1 k1Var, TLRPC.Chat chat, String str, long j3, ArrayList arrayList, a0.i iVar, MessagesController messagesController) {
        ...
        this.d = arrayList;
        this.e = iVar;
        this.f9733f = messagesController;
    }
    ...
    public final void run() {
        ...
        tL_channels_getParticipants.channel = MessagesController.getInputChannel(this.f9730a);
        ...
        tL_channelParticipantsMentions.f18108q = this.f9731b;
        long j3 = this.f9732c;
        if (j3 != 0) {
        ...
        int i11 = k1Var.f9821i0 + 1;
        k1Var.f9821i0 = i11;
        k1Var.f9822j0 = ConnectionsManager.getInstance(k1Var.f9817f).sendRequest(tL_channels_getParticipants, new ya(this, i11, this.d, this.e, this.f9733f, 1));
    }
}
