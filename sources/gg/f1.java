...
public final class f1 implements Runnable {
    public final TLRPC.Chat f9729a;
    public final String f9730b;
    public final long f9731c;
    public final ArrayList d;
    public final a0.i e;
    public final MessagesController f9732f;
    public final k1 h;
    ...
    public f1(k1 k1Var, TLRPC.Chat chat, String str, long j3, ArrayList arrayList, a0.i iVar, MessagesController messagesController) {
        ...
        this.d = arrayList;
        this.e = iVar;
        this.f9732f = messagesController;
    }
    ...
    public final void run() {
        ...
        tL_channels_getParticipants.channel = MessagesController.getInputChannel(this.f9729a);
        ...
        tL_channelParticipantsMentions.f18111q = this.f9730b;
        long j3 = this.f9731c;
        if (j3 != 0) {
        ...
        int i11 = k1Var.f9820i0 + 1;
        k1Var.f9820i0 = i11;
        k1Var.f9821j0 = ConnectionsManager.getInstance(k1Var.f9816f).sendRequest(tL_channels_getParticipants, new ya(this, i11, this.d, this.e, this.f9732f, 1));
    }
}
