...
public final class x extends g3 {
    ...
    public x(Activity activity, b1 b1Var, f2 f2Var, f6 f6Var, boolean z4) {
        ...
        fixNavigationBar();
        if (i0.a.f(j6.v0(j6.f19977h5, this.resourcesProvider)) > 0.699999988079071d) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        tVar.setPosition(0);
        setCustomView(tVar);
        b1Var.f6578q0 = new s(this, 0);
        b1Var.f6576o0 = new f7.b(this, f2Var, false, 6);
        f2Var.f6642r0 = new v(this, b1Var, f6Var);
        f2Var.f6640p0 = new s(this, 1);
        if (!z4) {
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        boolean z4;
        this.f6805c.onConfigurationChanged(configuration);
