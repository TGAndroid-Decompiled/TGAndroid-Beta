...
public final class t extends l81 {
    ...
    public final f2 V;
    public final f6 W;
    public final b1 f6739a0;
    public final x f6740b0;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        x xVar = this.f6740b0;
        t tVar = xVar.f6791b;
        int v02 = j6.v0(j6.f19952h5, this.W);
        Paint paint = this.R;
        paint.setColor(v02);
        if (this.S) {
            int i12 = -AndroidUtilities.dp(16.0f);
            b1 b1Var = this.f6739a0;
            int i13 = b1Var.f6564p0;
            ...
            f2 f2Var = this.V;
            int i14 = f2Var.f6628q0;
            if (f2Var.f6622j0.f31253c == 1.0f) {
    ...
    public final boolean i(MotionEvent motionEvent) {
        if (this.f6740b0.f6791b.getCurrentPosition() == 1) {
            return true;
        }
        return false;
    }
    ...
    public final void u() {
        this.S = false;
        this.f6740b0.f6791b.invalidate();
    }
        ...
        if (positionAnimated > 0.0f && positionAnimated < 1.0f) {
            if (!this.S) {
                ...
                if (xVar.isKeyboardVisible()) {
                    AndroidUtilities.hideKeyboard(xVar.f6792c.getContainerView());
                }
            }
        } else {
            this.S = false;
