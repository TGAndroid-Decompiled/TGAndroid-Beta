...
public final class y0 implements Runnable {
    ...
    public final Object f9990n;
    public final Object f9991r;
    ...
    public final void run() {
        ...
        switch (this.f9986a) {
            case 0:
                k1 k1Var = (k1) this.f9988c;
                String str = (String) this.d;
                TLObject tLObject = (TLObject) this.h;
                TLRPC.User user = (TLRPC.User) this.f9990n;
                String str2 = (String) this.e;
                MessagesStorage messagesStorage = (MessagesStorage) this.f9991r;
                String str3 = (String) this.f9989f;
                ra0 ra0Var = k1Var.V;
                if (str.equals(k1Var.f9834r0)) {
                    int i10 = 0;
                    k1Var.f9838u0 = 0;
                    ...
                    if (tLObject instanceof TLRPC.TL_messages_botResults) {
                        ...
                        k1Var.f9836s0 = tL_messages_botResults.next_offset;
                        if (k1Var.T == null) {
                        ...
                        if (k1Var.R != null && str2.length() != 0) {
                            ...
                            k1Var.f9843x0 = tL_messages_botResults.gallery;
                            z10 = false;
                        }
                        t tVar = k1Var.f9831p0;
                        if (tVar != null) {
                ...
                return;
            case 1:
                ((ContactsController) this.f9988c).lambda$performSyncPhoneBook$19((HashMap) this.d, (HashMap) this.e, this.f9987b, (HashMap) this.f9989f, (ArrayList) this.h, (HashMap) this.f9990n, (boolean[]) this.f9991r);
                return;
            case 2:
                ((MediaDataController) this.f9988c).lambda$broadcastPinnedMessage$169((ArrayList) this.d, this.f9987b, (ArrayList) this.e, (ArrayList) this.f9989f, (ArrayList) this.h, (a0.i) this.f9990n, (a0.i) this.f9991r);
                return;
            case 3:
                ((SendMessagesHelper) this.f9988c).lambda$sendCallback$43((TLRPC.TL_error) this.d, (TLObject) this.h, (TwoStepVerificationActivity) this.e, this.f9987b, (MessageObject) this.f9989f, (TL_keyboard.KeyboardButtonProto) this.f9990n, (zn) this.f9991r);
                return;
            default:
                ((CameraController) this.f9988c).lambda$recordVideo$14((Camera) this.d, (CameraSession) this.e, this.f9987b, (File) this.f9989f, (CameraInfo) this.h, (CameraController.VideoTakeCallback) this.f9990n, (Runnable) this.f9991r);
                return;
        }
    }
    ...
    public y0(MediaDataController mediaDataController, ArrayList arrayList, boolean z10, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4, a0.i iVar, a0.i iVar2) {
        this.f9986a = 2;
        this.f9988c = mediaDataController;
        this.d = arrayList;
        this.f9987b = z10;
        this.e = arrayList2;
        this.f9989f = arrayList3;
        this.h = arrayList4;
        this.f9990n = iVar;
        this.f9991r = iVar2;
    }

    public y0(MessageObject messageObject, SendMessagesHelper sendMessagesHelper, TLObject tLObject, TLRPC.TL_error tL_error, TL_keyboard.KeyboardButtonProto keyboardButtonProto, zn znVar, TwoStepVerificationActivity twoStepVerificationActivity, boolean z10) {
        this.f9986a = 3;
        this.f9988c = sendMessagesHelper;
        this.d = tL_error;
        this.h = tLObject;
        this.e = twoStepVerificationActivity;
        this.f9987b = z10;
        this.f9989f = messageObject;
        this.f9990n = keyboardButtonProto;
        this.f9991r = znVar;
    }
}
