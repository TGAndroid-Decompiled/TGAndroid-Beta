    ...
    public final void run() {
        switch (this.f9845a) {
                ...
                try {
                    ...
                    if (!arrayList3.isEmpty()) {
                        ...
                        for (int i12 = 0; i12 < arrayList6.size(); i12++) {
                            h0 h0Var = (h0) iVar.f(DialogObject.makeEncryptedDialogId(arrayList6.get(i12).f18329id));
                            if (h0Var != null) {
                    ...
                    if (!arrayList.isEmpty()) {
                        ...
                        for (int i14 = 0; i14 < arrayList5.size(); i14++) {
                            ...
                            h0 h0Var4 = (h0) iVar.f(user.f18468id);
                            if (h0Var4 != null) {
                                h0Var4.f9735a = user;
                            }
                        }
            ...
            case 10:
                ...
                return;
            case 11:
                org.telegram.ui.Components.voip.k1 k1Var = ((org.telegram.ui.Components.voip.j1) this.d).f29400a;
                pf.e eVar = k1Var.O;
                if (eVar != null) {
