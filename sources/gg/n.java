    ...
    public final void run() {
        switch (this.f9863a) {
                ...
                try {
                        ...
                        if (isEncryptedDialog) {
                            if (i11 == 0 || i11 == 3) {
                                ...
                                if (!arrayList3.contains(Integer.valueOf(encryptedChatId))) {
                                    ...
                                    ?? obj = new Object();
                                    obj.f9755c = longValue;
                                    obj.f9754b = queryFinalized.intValue(1);
                                    arrayList4.add(obj);
                                    iVar.k(obj, obj.f9755c);
                                }
                            }
                            ...
                            if (i11 != 2 && !arrayList.contains(Long.valueOf(longValue))) {
                                ...
                                ?? obj2 = new Object();
                                obj2.f9755c = longValue;
                                obj2.f9754b = queryFinalized.intValue(1);
                                arrayList4.add(obj2);
                                iVar.k(obj2, obj2.f9755c);
                            }
                        } else {
                            long j3 = -longValue;
                            if (!arrayList2.contains(Long.valueOf(j3))) {
                                ...
                                ?? obj22 = new Object();
                                obj22.f9755c = longValue;
                                obj22.f9754b = queryFinalized.intValue(1);
                                arrayList4.add(obj22);
                                iVar.k(obj22, obj22.f9755c);
                            }
                        }
                    }
                    ...
                    if (!arrayList3.isEmpty()) {
                        ...
                        for (int i12 = 0; i12 < arrayList6.size(); i12++) {
                            h0 h0Var = (h0) iVar.f(DialogObject.makeEncryptedDialogId(arrayList6.get(i12).f18304id));
                            if (h0Var != null) {
                                h0Var.f9753a = arrayList6.get(i12);
                            }
                        }
                    }
                    ...
                    if (!arrayList.isEmpty()) {
                        ...
                        for (int i14 = 0; i14 < arrayList5.size(); i14++) {
                            ...
                            h0 h0Var4 = (h0) iVar.f(user.f18443id);
                            if (h0Var4 != null) {
                                h0Var4.f9753a = user;
                            }
                        }
            ...
            case 1:
                ...
                return;
            case 2:
                ((i2.b0) this.d).f10624a.m1(this.f9864b, this.f9865c);
                return;
            case 3:
                VoIPGroupNotification.d((Context) this.d, this.f9864b, this.f9865c);
                return;
            case 4:
                ((VoIPService) this.d).lambda$initiateActualEncryptedCall$86(this.f9864b, this.f9865c);
                return;
            case 5:
                ((ConnectionsManager) this.d).lambda$discardConnection$0(this.f9864b, this.f9865c);
                return;
            case 6:
                org.telegram.ui.web.z0 z0Var = (org.telegram.ui.web.z0) this.d;
                for (int i17 = 0; i17 < this.f9864b - this.f9865c; i17++) {
                    z0Var.goBack();
                }
                return;
            case 7:
                Bundle bundle = new Bundle();
                bundle.putLong("user_id", UserConfig.getInstance(this.f9864b).getClientUserId());
                bundle.putInt("message_id", this.f9865c);
            ...
            case 8:
                ...
                int i18 = this.f9864b;
                if (i18 != 0) {
                    SharedPreferences notificationsSettings = MessagesController.getNotificationsSettings(this.f9865c);
            ...
            case 9:
                ...
                int i19 = this.f9864b;
                if (i19 != 0) {
                    SharedPreferences notificationsSettings2 = MessagesController.getNotificationsSettings(this.f9865c);
            ...
            case 10:
                ...
                if (d != null) {
                    int top = d.getTop() + this.f9864b;
                    int top2 = d.getTop() + this.f9865c;
                    int i20 = top2 - top;
                ...
                return;
            case 11:
                org.telegram.ui.Components.voip.j1 j1Var = ((org.telegram.ui.Components.voip.i1) this.d).f29287a;
                pf.e eVar = j1Var.O;
                if (eVar != null) {
                    eVar.d(this.f9864b, this.f9865c);
                }
                j1Var.i(false);
                return;
            case 12:
                ((SurfaceTextureHelper) this.d).lambda$setTextureSize$2(this.f9864b, this.f9865c);
                return;
            case 13:
                SurfaceViewRenderer.a((SurfaceViewRenderer) this.d, this.f9864b, this.f9865c);
                return;
            default:
                ((TextureViewRenderer) this.d).lambda$updateVideoSizes$1(this.f9864b, this.f9865c);
                return;
        }
    }
