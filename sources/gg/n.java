    ...
    public final void run() {
        switch (this.f9864a) {
                ...
                try {
                    ...
                    if (!arrayList3.isEmpty()) {
                        ...
                        for (int i12 = 0; i12 < arrayList6.size(); i12++) {
                            h0 h0Var = (h0) iVar.f(DialogObject.makeEncryptedDialogId(arrayList6.get(i12).f18129id));
                            if (h0Var != null) {
                    ...
                    if (!arrayList.isEmpty()) {
                        ...
                        for (int i14 = 0; i14 < arrayList5.size(); i14++) {
                            ...
                            h0 h0Var4 = (h0) iVar.f(user.f18268id);
                            if (h0Var4 != null) {
                                h0Var4.f9754a = user;
                            }
                        }
            ...
            case 1:
                ...
                return;
            case 2:
                ((i2.b0) this.d).f10624a.m1(this.f9865b, this.f9866c);
                return;
            case 3:
            ...
            case 7:
                ...
                ((o2) this.d).presentFragment(new bo(bundle));
                return;
            case 8:
                oo ooVar = (oo) this.d;
                int i18 = this.f9865b;
            ...
            case 10:
                ...
                return;
            case 11:
                org.telegram.ui.Components.voip.j1 j1Var = ((org.telegram.ui.Components.voip.i1) this.d).f28968a;
                pf.e eVar = j1Var.O;
                if (eVar != null) {
