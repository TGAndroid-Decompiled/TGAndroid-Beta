    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.f9944a) {
            ...
            case 2:
                ...
                return;
            case 3:
                AndroidUtilities.runOnUIThread(new c9((e9) this.d, tLObject, this.f9945b, (TLRPC.User) this.f9946c, 11));
                return;
            case 4:
                AndroidUtilities.runOnUIThread(new l3(tLObject, this.f9945b, (HashSet) this.d, tL_error, (n2) this.f9946c, 15));
                return;
            case 5:
                AndroidUtilities.runOnUIThread(new c9((n2) this.d, tLObject, this.f9945b, (Utilities.Callback) this.f9946c, 18));
                return;
            case 6:
