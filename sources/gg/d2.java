    ...
    public void f(org.telegram.ui.ActionBar.c2 c2Var, int i10) {
        ...
        switch (this.f9714a) {
            ...
            case 5:
                ...
                boVar.getMessagesController().pinMessage(boVar.e, boVar.f32281f, this.f9715b, false, !zArr[1], zArr[0]);
                oc B = vc.B(boVar, true, null, null, boVar.f32279ea);
                B.j();
                sb sbVar = B.e;
            ...
            case 10:
                ...
                n50 n50Var = ((j50) this.f9716c).f34781n;
                ChatObject.Call call = n50Var.f35950b.f35017a1;
                String obj3 = editTextBoldCursor2.getText().toString();
                int i12 = this.f9715b;
                call.toggleRecord(obj3, i12);
                AndroidUtilities.hideKeyboard(editTextBoldCursor2);
                UndoView k12 = n50Var.f35950b.k1();
                if (i12 == 0) {
                    i11 = 39;
                } else {
                    i11 = 100;
