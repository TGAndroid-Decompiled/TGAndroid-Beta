...
public final class b1 extends sa implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final ArrayList f6550a0;
    public final ArrayList f6551b0;
    public final ArrayList f6552c0;
    public hg.b f6553d0;
    public int f6554e0;
    public int f6555f0;
    public int f6556g0;
    ...
    public int f6561l0;
    public long m0;
    public final ig.a f6562n0;
    public f7.b f6563o0;
    public int f6564p0;
    public s f6565q0;
    public final TL_stories.PrepaidGiveaway f6566r0;
    public String f6567s0;
    public boolean f6568t0;
    public boolean f6569u0;
    public final q0 f6570v0;
    ...
    public b1(org.telegram.ui.ActionBar.p2 p2Var, long j10, TL_stories.PrepaidGiveaway prepaidGiveaway) {
        ...
        calendar.set(12, i12);
        this.f6559j0 = calendar.getTimeInMillis();
        this.f6560k0 = 2;
        this.f6561l0 = 2;
        this.f6567s0 = "";
        this.f6569u0 = true;
        this.f6570v0 = new q0(this, 0);
        this.f6566r0 = prepaidGiveaway;
        this.v = 0.15f;
    ...
    public static void P(b1 b1Var, TL_stories.PrepaidGiveaway prepaidGiveaway, long j10, org.telegram.ui.ActionBar.p2 p2Var) {
        ...
        String str;
        long j11;
        ArrayList arrayList = b1Var.f6551b0;
        ArrayList arrayList2 = b1Var.Z;
        TLRPC.Chat chat = b1Var.Y;
        ArrayList arrayList3 = b1Var.f6550a0;
        ArrayList arrayList4 = b1Var.f6552c0;
        ig.a aVar = b1Var.f6562n0;
        if (!aVar.f7470a.K) {
            ...
            if (i11 == 3) {
                ...
                if (findActivity != null && !findActivity.isFinishing()) {
                    ...
                    int U = b1Var.U();
                    if (W != null) {
                        aVar.f7470a.setLoading(true);
                        int i13 = b1Var.f6556g0;
                        int i14 = ig.w.f7533s;
                        if (i13 == 1) {
                            z10 = true;
                        } else {
                        ...
                        boolean z11 = b1Var.f6569u0;
                        boolean z12 = b1Var.f6568t0;
                        String str2 = b1Var.f6567s0;
                ...
                for (int i18 = 0; i18 < b10.size(); i18++) {
                    ...
                    if (tL_premiumGiftCodeOption.months == b1Var.f6558i0 && arrayList3.size() > 0) {
                        if (p0.h()) {
                ...
                for (int i21 = 0; i21 < b11.size(); i21++) {
                    ...
                    if (tL_premiumGiftCodeOption3.months == b1Var.f6558i0) {
                        if (p0.h()) {
                            List list = b1Var.V;
                        ...
                        int l11 = p0.l(b1Var.f6559j0);
                        aVar.b(true);
                        boolean z13 = b1Var.f6569u0;
                        boolean z14 = b1Var.f6568t0;
                        String str3 = b1Var.f6567s0;
                        ...
                        if (!p0.h()) {
                            ...
                            while (i31 < size6) {
                                ...
                                if (tLObject instanceof TLRPC.Chat) {
                                    i10 = i32;
                                    tL_inputStorePaymentPremiumGiveaway.additional_peers.add(messagesController.getInputPeer(-((TLRPC.Chat) tLObject).f19159id));
                                } else {
                                    i10 = i32;
                                }
                                i31 = i10;
                            }
                            tL_inputStorePaymentPremiumGiveaway.boost_peer = messagesController.getInputPeer(-chat.f19159id);
                            tL_inputStorePaymentPremiumGiveaway.boost_peer = messagesController.getInputPeer(-chat.f19159id);
                        ...
                        while (i35 < size8) {
                            ...
                            if (tLObject2 instanceof TLRPC.Chat) {
                                tL_inputStorePaymentPremiumGiveaway2.additional_peers.add(messagesController2.getInputPeer(-((TLRPC.Chat) tLObject2).f19159id));
                            }
                        }
                        tL_inputStorePaymentPremiumGiveaway2.boost_peer = messagesController2.getInputPeer(-chat.f19159id);
                        ...
                        b6.h hVar2 = new b6.h();
                        hVar2.f1610c = "inapp";
                        hVar2.f1609b = tL_premiumGiftCodeOption3.store_product;
    ...
    public static void Q(b1 b1Var, org.telegram.ui.ActionBar.p2 p2Var, View view) {
        ...
        f7.b bVar;
        boolean z10;
        ArrayList arrayList = b1Var.f6550a0;
        q0 q0Var = b1Var.f6570v0;
        ...
        if (view instanceof ig.d) {
            if (view instanceof ig.e) {
                ...
                if (selectedType != 2 && selectedType != 3) {
                    if (selectedType == 1) {
                        f7.b bVar3 = b1Var.f6563o0;
                        if (bVar3 != null) {
                            ((f2) bVar3.f6001b).V(1, arrayList);
                            ((x) bVar3.f6002c).f6791b.D(1);
                        }
                    } else {
                        b1Var.f6555f0 = selectedType;
                        b1Var.a0(true, true);
                        b1Var.Z(true);
                        b1Var.N();
                    }
                } else if (selectedType == 2 && b1Var.f6554e0 == selectedType) {
                    f7.b bVar4 = b1Var.f6563o0;
                    if (bVar4 != null) {
                        ((f2) bVar4.f6001b).V(1, arrayList);
                        ((x) bVar4.f6002c).f6791b.D(1);
                        return;
                    }
                    return;
                } else {
                    b1Var.f6554e0 = selectedType;
                    b1Var.a0(true, true);
                    b1Var.Z(true);
                    b1Var.N();
                }
        ...
        if (view instanceof ig.w) {
            ...
            if (b1Var.f6556g0 == selectedType2 && (bVar = b1Var.f6563o0) != null) {
                ((f2) bVar.f6001b).V(3, b1Var.f6551b0);
                ((x) bVar.f6002c).f6791b.D(1);
            }
            b1Var.f6556g0 = selectedType2;
            b1Var.a0(false, false);
        } else if (view instanceof ig.j) {
            b1Var.f6558i0 = ((TLRPC.TL_premiumGiftCodeOption) ((ig.j) view).getGifCode()).months;
            b1Var.a0(false, false);
            b1Var.f6553d0.G();
        } else if (view instanceof ig.i) {
            Context context = p2Var.getContext();
            long j10 = b1Var.f6559j0;
            ...
            vc0 dVar3 = new d(pVar, (n) xc0Var2, (o) xc0Var3, i19, i20, xc0Var);
            xc0Var.setOnValueChangedListener(dVar3);
            xc0Var2.setMinValue(0);
            xc0Var2.setMaxValue(23);
            linearLayout.addView((View) xc0Var2, b6.l(0.2f, 0, 270));
            xc0Var2.setFormatter(new f0.d(10));
            xc0Var2.setOnValueChangedListener(dVar3);
            xc0Var3.setMinValue(0);
            xc0Var3.setMaxValue(11);
            xc0Var3.setValue(0);
            xc0Var3.setFormatter(new f0.d(11));
            linearLayout.addView((View) xc0Var3, b6.l(0.3f, 0, 270));
            xc0Var3.setOnValueChangedListener(dVar3);
            if (j10 > 0) {
                x4Var = x4Var2;
                ...
                xc0Var3.setValue(calendar.get(12) / 5);
                xc0Var2.setValue(calendar.get(11));
                xc0Var.setValue((int) ((j10 - calendar.getTimeInMillis()) / 86400000));
                xc0Var.getValue();
                dVar3.q(xc0Var, xc0Var.getValue());
                xc0Var2.getValue();
                dVar3.q(xc0Var2, xc0Var2.getValue());
            } else {
                x4Var = x4Var2;
            }
            ...
            qVar.setOnClickListener(new e(calendar, xc0Var, (Object) xc0Var2, (Object) xc0Var3, r0Var, b3Var, 0));
            b3Var.b(pVar);
            g3 g3Var = b3Var.f19500a;
            g3Var.show();
            int i21 = x4Var.f30462b;
            ...
            f7.b bVar5 = b1Var.f6563o0;
            if (bVar5 != null) {
                ((f2) bVar5.f6001b).V(2, b1Var.Z);
                ((x) bVar5.f6002c).f6791b.D(1);
            }
    ...
    public static void R(b1 b1Var) {
        eg.e2 e2Var = new eg.e2(b1Var.f28701n, b1Var.currentAccount, null, b1Var.resourcesProvider);
    ...
    public final int U() {
        int i10 = this.f6554e0;
        int i11 = ig.e.f7488s;
        if (i10 == 2) {
            return ((Integer) this.V.get(this.f6560k0)).intValue();
        }
        List X = X();
        int i12 = this.f6561l0;
        if (i12 < 0 || i12 >= X.size()) {
            this.f6561l0 = 0;
        }
        if (this.f6561l0 >= X.size()) {
            return 0;
        }
        return ((Integer) X.get(this.f6561l0)).intValue();
    }
    ...
    public final int V() {
        ...
        int i11 = ig.e.f7488s;
        if (i10 == 2) {
            U = ((Integer) this.V.get(this.f6560k0)).intValue();
            g10 = p0.g();
        } else {
    ...
    public final void Z(boolean z4) {
        boolean z10;
        boolean Y = Y();
        ig.a aVar = this.f6562n0;
        if (Y) {
            TL_stories.PrepaidGiveaway prepaidGiveaway = this.f6566r0;
            if (prepaidGiveaway instanceof TL_stories.TL_prepaidStarsGiveaway) {
        ...
        int i10 = this.f6555f0;
        int i11 = ig.e.f7488s;
        if (i10 == 0) {
            aVar.a(V(), z4);
            return;
        }
        ArrayList arrayList = this.f6550a0;
        ...
        aVar.f7471b.setBackgroundColor(j6.v0(j6.f19952h5, aVar.f7472c));
    }
