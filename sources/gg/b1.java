...
public final class b1 extends sa implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final ArrayList f6563a0;
    public final ArrayList f6564b0;
    public final ArrayList f6565c0;
    public hg.b f6566d0;
    public int f6567e0;
    public int f6568f0;
    public int f6569g0;
    public boolean f6570h0;
    public int f6571i0;
    public long f6572j0;
    public int f6573k0;
    public int f6574l0;
    public long m0;
    public final ig.a f6575n0;
    public f7.b f6576o0;
    public int f6577p0;
    public s f6578q0;
    public final TL_stories.PrepaidGiveaway f6579r0;
    public String f6580s0;
    public boolean f6581t0;
    public boolean f6582u0;
    public final q0 f6583v0;
    ...
    public b1(org.telegram.ui.ActionBar.p2 p2Var, long j10, TL_stories.PrepaidGiveaway prepaidGiveaway) {
        ...
        this.f6563a0 = new ArrayList();
        this.f6564b0 = new ArrayList();
        this.f6565c0 = new ArrayList();
        int i10 = ig.e.f7506s;
        this.f6567e0 = 2;
        this.f6568f0 = 0;
        int i11 = ig.w.f7551s;
        ...
        calendar.set(12, i12);
        this.f6572j0 = calendar.getTimeInMillis();
        this.f6573k0 = 2;
        this.f6574l0 = 2;
        this.f6580s0 = "";
        this.f6582u0 = true;
        this.f6583v0 = new q0(this, 0);
        this.f6579r0 = prepaidGiveaway;
        this.v = 0.15f;
    ...
    public static void P(b1 b1Var, TL_stories.PrepaidGiveaway prepaidGiveaway, long j10, org.telegram.ui.ActionBar.p2 p2Var) {
        ...
        String str;
        long j11;
        ArrayList arrayList = b1Var.f6564b0;
        ArrayList arrayList2 = b1Var.Z;
        TLRPC.Chat chat = b1Var.Y;
        ArrayList arrayList3 = b1Var.f6563a0;
        ArrayList arrayList4 = b1Var.f6565c0;
        ig.a aVar = b1Var.f6575n0;
        if (!aVar.f7488a.K) {
            ...
            if (i11 == 3) {
                ...
                if (findActivity != null && !findActivity.isFinishing()) {
                    ...
                    int U = b1Var.U();
                    if (W != null) {
                        aVar.f7488a.setLoading(true);
                        int i13 = b1Var.f6569g0;
                        int i14 = ig.w.f7551s;
                        if (i13 == 1) {
                            z10 = true;
                        } else {
                        ...
                        boolean z11 = b1Var.f6582u0;
                        boolean z12 = b1Var.f6581t0;
                        String str2 = b1Var.f6580s0;
                        dh.v vVar = new dh.v(1, b1Var, W);
                        int i15 = y10.f13149a;
                        ...
                        ConnectionsManager.getInstance(i15).sendRequest(tL_payments_getPaymentForm, new y(y10, vVar, tL_inputInvoiceStars, 10));
                    }
                }
            } else if (b1Var.f6568f0 == 1) {
                ...
                for (int i18 = 0; i18 < b10.size(); i18++) {
                    ...
                    if (tL_premiumGiftCodeOption.months == b1Var.f6571i0 && arrayList3.size() > 0) {
                        if (p0.h()) {
                            ...
                            if (tL_premiumGiftCodeOption.store_product == null) {
                                ...
                                alertDialog$Builder2.k(LocaleController.getString("OK", R.string.OK), new f0.d(9));
                ...
                for (int i21 = 0; i21 < b11.size(); i21++) {
                    ...
                    if (tL_premiumGiftCodeOption3.months == b1Var.f6571i0) {
                        if (p0.h()) {
                            List list = b1Var.V;
                            ...
                            if (tL_premiumGiftCodeOption3.store_product == null) {
                                ...
                                alertDialog$Builder3.h(LocaleController.getString("Cancel", R.string.Cancel), new f0.d(9));
                                alertDialog$Builder3.o();
                                return;
                            }
                        }
                        int i28 = b1Var.f6569g0;
                        int i29 = ig.w.f7551s;
                        if (i28 == 1) {
                            z4 = true;
                        } else {
                        ...
                        int l11 = p0.l(b1Var.f6572j0);
                        aVar.b(true);
                        boolean z13 = b1Var.f6582u0;
                        boolean z14 = b1Var.f6581t0;
                        String str3 = b1Var.f6580s0;
                        ...
                        if (!p0.h()) {
                            ...
                            while (i31 < size6) {
                                ...
                                if (tLObject instanceof TLRPC.Chat) {
                                    i10 = i32;
                                    tL_inputStorePaymentPremiumGiveaway.additional_peers.add(messagesController.getInputPeer(-((TLRPC.Chat) tLObject).f19184id));
                                } else {
                                    i10 = i32;
                                }
                                i31 = i10;
                            }
                            tL_inputStorePaymentPremiumGiveaway.boost_peer = messagesController.getInputPeer(-chat.f19184id);
                            tL_inputStorePaymentPremiumGiveaway.boost_peer = messagesController.getInputPeer(-chat.f19184id);
                        ...
                        while (i35 < size8) {
                            ...
                            if (tLObject2 instanceof TLRPC.Chat) {
                                tL_inputStorePaymentPremiumGiveaway2.additional_peers.add(messagesController2.getInputPeer(-((TLRPC.Chat) tLObject2).f19184id));
                            }
                        }
                        tL_inputStorePaymentPremiumGiveaway2.boost_peer = messagesController2.getInputPeer(-chat.f19184id);
                        ...
                        b6.h hVar2 = new b6.h();
                        hVar2.f1599c = "inapp";
                        hVar2.f1598b = tL_premiumGiftCodeOption3.store_product;
    ...
    public static void Q(b1 b1Var, org.telegram.ui.ActionBar.p2 p2Var, View view) {
        ...
        f7.b bVar;
        boolean z10;
        ArrayList arrayList = b1Var.f6563a0;
        q0 q0Var = b1Var.f6583v0;
        if (view instanceof ig.a0) {
            ig.a0 a0Var = (ig.a0) view;
            int type = a0Var.getType();
            boolean z11 = a0Var.e.h;
            boolean z12 = !z11;
        ...
        if (view instanceof ig.d) {
            if (view instanceof ig.e) {
                ...
                if (selectedType != 2 && selectedType != 3) {
                    if (selectedType == 1) {
                        f7.b bVar3 = b1Var.f6576o0;
                        if (bVar3 != null) {
                            ((f2) bVar3.f6012b).V(1, arrayList);
                            ((x) bVar3.f6013c).f6804b.D(1);
                        }
                    } else {
                        b1Var.f6568f0 = selectedType;
                        b1Var.a0(true, true);
                        b1Var.Z(true);
                        b1Var.N();
                    }
                } else if (selectedType == 2 && b1Var.f6567e0 == selectedType) {
                    f7.b bVar4 = b1Var.f6576o0;
                    if (bVar4 != null) {
                        ((f2) bVar4.f6012b).V(1, arrayList);
                        ((x) bVar4.f6013c).f6804b.D(1);
                        return;
                    }
                    return;
                } else {
                    b1Var.f6567e0 = selectedType;
                    b1Var.a0(true, true);
                    b1Var.Z(true);
                    b1Var.N();
                }
        ...
        if (view instanceof ig.w) {
            ...
            if (b1Var.f6569g0 == selectedType2 && (bVar = b1Var.f6576o0) != null) {
                ((f2) bVar.f6012b).V(3, b1Var.f6564b0);
                ((x) bVar.f6013c).f6804b.D(1);
            }
            b1Var.f6569g0 = selectedType2;
            b1Var.a0(false, false);
        } else if (view instanceof ig.j) {
            b1Var.f6571i0 = ((TLRPC.TL_premiumGiftCodeOption) ((ig.j) view).getGifCode()).months;
            b1Var.a0(false, false);
            b1Var.f6566d0.G();
        } else if (view instanceof ig.i) {
            Context context = p2Var.getContext();
            long j10 = b1Var.f6572j0;
            ...
            uc0 dVar3 = new d(pVar, (n) wc0Var2, (o) wc0Var3, i19, i20, wc0Var);
            wc0Var.setOnValueChangedListener(dVar3);
            wc0Var2.setMinValue(0);
            wc0Var2.setMaxValue(23);
            linearLayout.addView((View) wc0Var2, b6.l(0.2f, 0, 270));
            wc0Var2.setFormatter(new f0.d(10));
            wc0Var2.setOnValueChangedListener(dVar3);
            wc0Var3.setMinValue(0);
            wc0Var3.setMaxValue(11);
            wc0Var3.setValue(0);
            wc0Var3.setFormatter(new f0.d(11));
            linearLayout.addView((View) wc0Var3, b6.l(0.3f, 0, 270));
            wc0Var3.setOnValueChangedListener(dVar3);
            if (j10 > 0) {
                x4Var = x4Var2;
                ...
                wc0Var3.setValue(calendar.get(12) / 5);
                wc0Var2.setValue(calendar.get(11));
                wc0Var.setValue((int) ((j10 - calendar.getTimeInMillis()) / 86400000));
                wc0Var.getValue();
                dVar3.q(wc0Var, wc0Var.getValue());
                wc0Var2.getValue();
                dVar3.q(wc0Var2, wc0Var2.getValue());
            } else {
                x4Var = x4Var2;
            }
            ...
            qVar.setOnClickListener(new e(calendar, wc0Var, (Object) wc0Var2, (Object) wc0Var3, r0Var, b3Var, 0));
            b3Var.b(pVar);
            g3 g3Var = b3Var.f19525a;
            g3Var.show();
            int i21 = x4Var.f30536b;
            ...
            AndroidUtilities.setLightStatusBar(g3Var, z4);
        } else if (view instanceof ig.b) {
            f7.b bVar5 = b1Var.f6576o0;
            if (bVar5 != null) {
                ((f2) bVar5.f6012b).V(2, b1Var.Z);
                ((x) bVar5.f6013c).f6804b.D(1);
            }
        } else if (view instanceof ig.y) {
    ...
    public static void R(b1 b1Var) {
        eg.e2 e2Var = new eg.e2(b1Var.f28678n, b1Var.currentAccount, null, b1Var.resourcesProvider);
        e2Var.setOnDismissListener(new u0(b1Var, 1));
        e2Var.setOnShowListener(new w0(b1Var, 1));
        e2Var.show();
    }

    public static void S(b1 b1Var) {
        eg.e2 e2Var = new eg.e2(b1Var.f28678n, b1Var.currentAccount, null, b1Var.resourcesProvider);
        e2Var.setOnDismissListener(new u0(b1Var, 0));
        e2Var.setOnShowListener(new w0(b1Var, 0));
        e2Var.show();
    }
    ...
    public final int U() {
        int i10 = this.f6567e0;
        int i11 = ig.e.f7506s;
        if (i10 == 2) {
            return ((Integer) this.V.get(this.f6573k0)).intValue();
        }
        List X = X();
        int i12 = this.f6574l0;
        if (i12 < 0 || i12 >= X.size()) {
            this.f6574l0 = 0;
        }
        if (this.f6574l0 >= X.size()) {
            return 0;
        }
        return ((Integer) X.get(this.f6574l0)).intValue();
    }
    ...
    public final int V() {
        ...
        int i11 = ig.e.f7506s;
        if (i10 == 2) {
            U = ((Integer) this.V.get(this.f6573k0)).intValue();
            g10 = p0.g();
        } else {
    ...
    public final void Z(boolean z4) {
        boolean z10;
        boolean Y = Y();
        ig.a aVar = this.f6575n0;
        if (Y) {
            TL_stories.PrepaidGiveaway prepaidGiveaway = this.f6579r0;
            if (prepaidGiveaway instanceof TL_stories.TL_prepaidStarsGiveaway) {
        ...
        int i10 = this.f6568f0;
        int i11 = ig.e.f7506s;
        if (i10 == 0) {
            aVar.a(V(), z4);
            return;
        }
        ArrayList arrayList = this.f6563a0;
        ...
        aVar.f7489b.setBackgroundColor(j6.v0(j6.f19977h5, aVar.f7490c));
    }

    public final void a0(boolean r26, boolean r27) {
        throw new UnsupportedOperationException("Method not decompiled: gg.b1.a0(boolean, boolean):void");
    }
