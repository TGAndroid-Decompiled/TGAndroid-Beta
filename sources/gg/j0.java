...
public final class j0 extends s4.c0 {
    ...
    public int m0(int i10, of.e eVar, s4.z0 z0Var) {
        ...
        switch (this.I) {
            case 2:
                n70 n70Var = ((tw) ((k00) this.J).J).f37792b.L0;
    ...
    public void z0(s4.z0 z0Var, int[] iArr) {
        switch (this.I) {
            case 7:
                iArr[1] = ((StickersActivity) this.J).f31508a.getHeight();
                return;
            default:
                super.z0(z0Var, iArr);
                return;
