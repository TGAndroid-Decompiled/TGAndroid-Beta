...
public final class h extends c3 {
    ...
    public h(m mVar, Context context) {
        super(context);
        this.f9734f = mVar;
        this.f20070a = UserConfig.selectedAccount;
        setOrientation(1);
        setBackgroundColor(h6.w0(null, h6.f18989a7, false));
        ...
        w9Var.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        this.f20034b.f20071b.getImageReceiver().startAnimation();
                        return;
                    default:
                        this.f20034b.f9734f.K();
                        return;
                }
            }
        });
        ...
        textView2.setTextColor(h6.w0(null, h6.f19428y6, false));
