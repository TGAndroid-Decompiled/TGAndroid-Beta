...
public final class h extends b3 {
    ...
    public h(m mVar, Context context) {
        super(context);
        this.f9748f = mVar;
        this.f19826a = UserConfig.selectedAccount;
        setOrientation(1);
        setBackgroundColor(i6.w0(null, i6.f18780a7, false));
        x5 x5Var = new x5(context, 3);
        x5Var.f5752c = new Path();
        Paint paint = new Paint(1);
        x5Var.f5751b = paint;
        paint.setColor(i6.w0(null, i6.f18836d6, false));
        ...
        u9Var.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        this.f19786b.f19827b.getImageReceiver().startAnimation();
                        return;
                    default:
                        this.f19786b.f9748f.K();
                        return;
                }
            }
        });
        ...
        textView2.setTextColor(i6.w0(null, i6.f19218y6, false));
