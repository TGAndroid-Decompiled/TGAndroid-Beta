...
public final class h extends b3 {
    ...
    public h(m mVar, Context context) {
        super(context);
        this.f9753f = mVar;
        this.f19836a = UserConfig.selectedAccount;
        setOrientation(1);
        ...
        u9Var.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        this.f19796b.f19837b.getImageReceiver().startAnimation();
                        return;
                    default:
                        this.f19796b.f9753f.K();
                        return;
                }
            }
        });
        ...
        textView2.setTextColor(j6.w0(null, j6.f19244y6, false));
