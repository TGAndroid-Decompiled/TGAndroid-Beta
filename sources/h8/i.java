        ...
        switch (this.f10906b) {
            case 0:
                if (i10 == 1) {
                    ...
                    lambda$setOnMarkerClickListener$1 = ((GoogleMapsProvider.GoogleMapImpl) cVar.f17288b).lambda$setOnMarkerClickListener$1((IMapsProvider.OnMarkerClickListener) cVar.f17289c, new j8.f(aVar));
            ...
            case 2:
                if (i10 == 1) {
                    ...
                    s7.b.a(parcel);
                    c cVar2 = new c(aVar2);
                    i4 i4Var = (i4) ((f) this.f10907c);
                    i4Var.f17934a.lambda$getMapAsync$0(i4Var.f17935b, cVar2);
                    parcel2.writeNoException();
                    return true;
                }
                return false;
            case 3:
                if (i10 == 1) {
                    ...
                    s7.b.a(parcel);
                    ((g4) this.f10907c).f17717b.accept((Location) x6.b.M0(L0));
                    parcel2.writeNoException();
                    return true;
                }
                return false;
            ...
            case 5:
                if (i10 == 1) {
                    ...
                    s7.b.a(parcel);
                    GoogleMapsProvider.GoogleMapImpl.lambda$setOnCameraMoveStartedListener$0((IMapsProvider.OnCameraMoveStartedListener) ((c0) this.f10907c).f17291b, readInt);
                    parcel2.writeNoException();
                    return true;
                }
                return false;
