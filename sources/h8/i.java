        ...
        switch (this.f10145b) {
            case 0:
                if (i10 == 1) {
                    ...
                    s7.b.a(parcel);
                    org.telegram.messenger.d dVar = (org.telegram.messenger.d) this.f10146c;
                    lambda$setOnMarkerClickListener$1 = ((GoogleMapsProvider.GoogleMapImpl) dVar.f15922b).lambda$setOnMarkerClickListener$1((IMapsProvider.OnMarkerClickListener) dVar.f15923c, new j8.f(aVar));
            ...
            case 2:
                if (i10 == 1) {
                    ...
                    s7.b.a(parcel);
                    c cVar = new c(aVar2);
                    i4 i4Var = (i4) ((f) this.f10146c);
                    i4Var.f16373a.lambda$getMapAsync$0(i4Var.f16374b, cVar);
                    parcel2.writeNoException();
                    return true;
                }
                return false;
            case 3:
                if (i10 == 1) {
                    ...
                    s7.b.a(parcel);
                    ((g4) this.f10146c).f16174b.accept((Location) x6.b.M0(L0));
                    parcel2.writeNoException();
                    return true;
                }
                return false;
            ...
            case 5:
                if (i10 == 1) {
                    ...
                    s7.b.a(parcel);
                    GoogleMapsProvider.GoogleMapImpl.lambda$setOnCameraMoveStartedListener$0((IMapsProvider.OnCameraMoveStartedListener) ((c0) this.f10146c).f15792b, readInt);
                    parcel2.writeNoException();
                    return true;
                }
                return false;
