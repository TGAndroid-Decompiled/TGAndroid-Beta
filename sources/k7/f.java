...
public final class f implements u9.e {
    public static final Charset f9780f = Charset.forName("UTF-8");
    public static final u9.c f9781g = new u9.c("key", vh.w2.h(e2.c.o(d.class, new a(1))));
    public static final u9.c h = new u9.c("value", vh.w2.h(e2.c.o(d.class, new a(2))));
    public static final e f9782i = e.f9767b;
    public OutputStream f9783a;
    public final HashMap f9784b;
    public final HashMap f9785c;
    public final u9.d d;
    ...
    public final void f(u9.c cVar, double d, boolean z4) {
        ...
        k((i(cVar) << 3) | 1);
        this.f9783a.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putDouble(d).array());
    }
        ...
        if (obj != null) {
            if (obj instanceof CharSequence) {
                ...
                if (!z4 || charSequence.length() != 0) {
                    k((i(cVar) << 3) | 2);
                    byte[] bytes = charSequence.toString().getBytes(f9780f);
                    k(bytes.length);
                    this.f9783a.write(bytes);
                }
                ...
                if (!z4 || floatValue != 0.0f) {
                    k((i(cVar) << 3) | 5);
                    this.f9783a.write(ByteBuffer.allocate(4).order(ByteOrder.LITTLE_ENDIAN).putFloat(floatValue).array());
                }
                ...
                u9.d dVar2 = (u9.d) this.f9784b.get(obj.getClass());
                if (dVar2 != null) {
                    j(dVar2, cVar, obj, z4);
                    return;
                }
                u9.f fVar = (u9.f) this.f9785c.get(obj.getClass());
                if (fVar != null) {
                    j7.l lVar = this.e;
                    lVar.f9051b = false;
                    lVar.d = cVar;
    ...
    public final void j(u9.d dVar, u9.c cVar, Object obj, boolean z4) {
        ...
        fVar.f8972b = 0L;
        try {
            OutputStream outputStream = this.f9783a;
            this.f9783a = fVar;
            dVar.a(obj, this);
