...
public final class f implements u9.e {
    public static final Charset f10524f = Charset.forName("UTF-8");
    public static final u9.c f10525g = new u9.c("key", w.c.h(e2.c.o(d.class, new a(1))));
    public static final u9.c h = new u9.c("value", w.c.h(e2.c.o(d.class, new a(2))));
    public static final e f10526i = e.f10510b;
    public OutputStream f10527a;
    public final HashMap f10528b;
    public final HashMap f10529c;
    public final u9.d d;
    public final j7.l f10530e = new j7.l(this, 1);

    public f(ByteArrayOutputStream byteArrayOutputStream, HashMap hashMap, HashMap hashMap2, u9.d dVar) {
        this.f10527a = byteArrayOutputStream;
        this.f10528b = hashMap;
        this.f10529c = hashMap2;
        this.d = dVar;
    }
    ...
    public final void f(u9.c cVar, double d, boolean z4) {
        ...
        k((i(cVar) << 3) | 1);
        this.f10527a.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putDouble(d).array());
    }
        ...
        if (obj != null) {
            if (obj instanceof CharSequence) {
                ...
                if (!z4 || charSequence.length() != 0) {
                    k((i(cVar) << 3) | 2);
                    byte[] bytes = charSequence.toString().getBytes(f10524f);
                    k(bytes.length);
                    this.f10527a.write(bytes);
                }
                ...
                if (!z4 || floatValue != 0.0f) {
                    k((i(cVar) << 3) | 5);
                    this.f10527a.write(ByteBuffer.allocate(4).order(ByteOrder.LITTLE_ENDIAN).putFloat(floatValue).array());
                }
                ...
                k((i(cVar) << 3) | 2);
                k(bArr.length);
                this.f10527a.write(bArr);
            } else {
                u9.d dVar2 = (u9.d) this.f10528b.get(obj.getClass());
                if (dVar2 != null) {
                    j(dVar2, cVar, obj, z4);
                    return;
                }
                u9.f fVar = (u9.f) this.f10529c.get(obj.getClass());
                if (fVar != null) {
                    j7.l lVar = this.f10530e;
                    lVar.f9686b = false;
                    lVar.d = cVar;
                    lVar.f9687c = z4;
                    fVar.a(obj, lVar);
    ...
    public final void j(u9.d dVar, u9.c cVar, Object obj, boolean z4) {
        ...
        fVar.f9602b = 0L;
        try {
            OutputStream outputStream = this.f10527a;
            this.f10527a = fVar;
            dVar.a(obj, this);
