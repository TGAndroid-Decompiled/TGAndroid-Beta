...
public abstract class m8 {
    public static Context f9919a;
    public static w7.e f9920b;
    ...
    public static Context b(Context context) {
        Context context2;
        Context context3 = f9919a;
        if (context3 == null) {
            context.getApplicationContext();
            try {
                context2 = m6.e.c(context, m6.e.f13739b, "com.google.android.gms.maps_dynamite").f13748a;
            } catch (Exception e) {
                try {
                    if (!"com.google.android.gms.maps_dynamite".equals("com.google.android.gms.maps_dynamite")) {
                        ...
                        AtomicBoolean atomicBoolean2 = y5.g.f47178a;
                        context2 = context.createPackageContext("com.google.android.gms", 3);
                    }
