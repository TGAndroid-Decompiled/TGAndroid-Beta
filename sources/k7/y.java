...
public abstract class y {
    public static a8.e a(Context context, GoogleSignInOptions googleSignInOptions) {
        ...
        return new com.google.android.gms.common.api.j(context, k5.a.f9748a, googleSignInOptions, new com.google.android.gms.common.api.i(new Object(), Looper.getMainLooper()));
    }

    public static Task b(Intent intent) {
        n5.b bVar;
        GoogleSignInAccount googleSignInAccount;
        b4.e0 e0Var = o5.h.f16454a;
        ...
        Status status3 = bVar.f14270a;
        if (status3.e() && (googleSignInAccount = bVar.f14271b) != null) {
