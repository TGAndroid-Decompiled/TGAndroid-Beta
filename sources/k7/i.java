...
public abstract class i extends e implements List, RandomAccess {
    ...
    public static final g f14815b = new g(m.f14873e, 0);

    public static m r(int i10, Object[] objArr) {
        return i10 == 0 ? m.f14873e : new m(i10, objArr);
    }
        ...
        if (obj instanceof List) {
            ...
            if (size == list.size()) {
                ...
                while (gVarListIterator.hasNext()) {
                    if (it.hasNext() && g7.x8.a(gVarListIterator.next(), it.next())) {
                    }
                }
                if (!it.hasNext()) {
                    return true;
    ...
    public i subList(int i10, int i11) {
        ...
        return i12 == 0 ? m.f14873e : new h(this, i10, i12);
    }
    ...
    public final g listIterator(int i10) {
        ...
        return isEmpty() ? f14815b : new g(this, i10);
    }
