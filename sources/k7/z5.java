...
public abstract class z5 {
    ...
    public static void a(Path path, RectF rectF, float f10) {
        ...
        float f11 = 2.0f * f10;
        path.rewind();
        f10043a.set(0.0f, -rectF.height(), f11, (-rectF.height()) + f11);
        path.arcTo(f10043a, 180.0f, 90.0f);
        f10043a.set(rectF.width() - f11, -rectF.height(), rectF.width(), (-rectF.height()) + f11);
        path.arcTo(f10043a, 270.0f, 90.0f);
        f10043a.set(rectF.width() - f11, -f11, rectF.width(), 0.0f);
        path.arcTo(f10043a, 0.0f, 90.0f);
