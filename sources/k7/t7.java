...
public abstract class t7 {
    ...
    public static android.graphics.drawable.NinePatchDrawable b(android.graphics.Bitmap[] r37, float[] r38, float r39, float r40, int r41, tg.e r42) {
        throw new UnsupportedOperationException("Method not decompiled: k7.t7.b(android.graphics.Bitmap[], float[], float, float, int, tg.e):android.graphics.drawable.NinePatchDrawable");
    }
