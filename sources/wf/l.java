    ...
    public final void n(Canvas canvas) {
        ...
        if (bVar != null) {
            ...
            if (fArr.length < 2) {
                ...
                f10 = fArr[1] * this.f49583z0;
            }
            int i12 = 0;
            while (i12 < size) {
                yf.f fVar = (yf.f) arrayList3.get(i12);
                boolean z10 = fVar.f50932n;
                Paint paint = fVar.f50922b;
                float[] fArr2 = fVar.f50930l;
                ...
                if (!z10 && fVar.f50933o == 0.0f) {
                    ...
                    while (true) {
                        ...
                        if (j10 < 0) {
                            ...
                            arrayList2 = arrayList3;
                            float f14 = this.f49583z0 * bVar2.f50547b[i14];
                            ...
                            if (z11) {
                                ...
                                f12 = f11;
                                f13 = (float) bVar2.f50550f;
                            }
                            float f15 = (1.0f - ((((float) j10) - f13) / (f12 - f13))) * this.f49582y0;
                            if (z4) {
                                if (i13 == 0) {
                                    float f16 = f10 / 2.0f;
                                    fArr2[i13] = f14 - f16;
                    ...
                    if (fVar.f50932n || fVar.f50933o != 0.0f) {
                        paint.setAlpha((int) (fVar.f50933o * 255.0f));
                        if (z4) {
                            canvas.drawLines(fArr2, 0, fVar.f50928j, paint);
                        } else {
