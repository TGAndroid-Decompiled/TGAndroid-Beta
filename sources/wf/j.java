...
public final class j implements ViewTreeObserver.OnPreDrawListener {
    public final MediaController.CropState f49936a;
    ...
    public final boolean onPreDraw() {
        ...
        MediaController.CropState cropState = this.f49936a;
        if (cropState != null) {
            ...
            int i11 = this.f49937b;
            int i12 = this.f49938c;
            if (i10 != 90 && i10 != 270) {
                l lVar = nVar.H;
                f9 = lVar.f49943a;
                f10 = lVar.f49944b;
