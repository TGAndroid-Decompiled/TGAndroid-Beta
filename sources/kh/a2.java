...
public final class a2 extends oq {
    ...
    public a2(View view) {
        ...
        this.e = 1.0f;
        c(path, 1.0f, false);
        this.f27627a.setColor(-698031);
        this.f27627a.setPathEffect(new CornerPathEffect(AndroidUtilities.dp(2.33f)));
        paint.setColor(0);
    ...
    public static void c(Path path, float f10, final boolean z4) {
        ...
        path.cubicTo(kf.k0.f((Float) callbackReturn.run(Float.valueOf(46.56f)), f10), AndroidUtilities.dp(48.28f * f10), kf.k0.f((Float) callbackReturn.run(valueOf), f10), AndroidUtilities.dp(47.68f * f10), kf.k0.f((Float) callbackReturn.run(valueOf), f10), AndroidUtilities.dp(46.5f * f10));
    ...
    public final void draw(Canvas canvas) {
        ...
        Path path = this.f10571c;
        if (alpha > 0) {
            paint.setStrokeWidth(AndroidUtilities.dp(1.33f) * 2);
            canvas.drawPath(path, paint);
        }
        canvas.drawPath(path, this.f27627a);
        if (this.f10572f != null) {
            canvas.clipPath(path);
            this.f10572f.f(0, 0, AndroidUtilities.dp(48.0f), AndroidUtilities.dp(48.0f));
            this.f10572f.d();
            this.f10572f.a(canvas, -1);
            invalidateSelf();
        }
        if (this.f10570b != null) {
            ...
            float min = Math.min(1.0f, AndroidUtilities.dp(40.0f) / this.f10570b.f26124c);
            ...
            k01 k01Var = this.f10570b;
            float width3 = getBounds().width() / 2.0f;
            if (!this.f10573g) {
                f15 = 6.0f;
            }
            float dp3 = (width3 + AndroidUtilities.dp(f15)) - (this.f10570b.l() / 2.0f);
    ...
    public final void e(int i10, CharSequence charSequence, boolean z4) {
        ...
        this.f10570b = new k01(charSequence, f10, typeface);
    }
}
