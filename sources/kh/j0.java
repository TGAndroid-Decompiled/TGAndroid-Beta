...
public final class j0 extends x1 {
    public final RectF f10675j0;
    public final RectF f10676k0;
    public final Path f10677l0;
    public final m0 m0;

    public j0(m0 m0Var, Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context, i10, f6Var);
        this.m0 = m0Var;
        this.f10675j0 = new RectF();
        this.f10676k0 = new RectF();
        this.f10677l0 = new Path();
    }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        if (view == frameLayout) {
            FrameLayout frameLayout2 = h0Var.f12215b;
            g0 g0Var = m0Var.V;
            RectF rectF = this.f10675j0;
            if (ug.i.c(frameLayout2, g0Var, rectF)) {
                RectF rectF2 = this.f10676k0;
