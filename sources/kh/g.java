    ...
    public final boolean onLongClick(View view) {
        ...
        switch (this.f14960a) {
            ...
            default:
                ...
                if (!scrollSlidingTextTabStrip.f24133n0 && (lm0Var = scrollSlidingTextTabStrip.f24117b) != null && lm0Var.n1(this.f14961b, view)) {
                    return true;
                }
                return false;
        }
