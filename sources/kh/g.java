    ...
    public final boolean onLongClick(View view) {
        ...
        switch (this.f14986a) {
            ...
            default:
                ...
                if (!scrollSlidingTextTabStrip.f24160n0 && (lm0Var = scrollSlidingTextTabStrip.f24144b) != null && lm0Var.n1(this.f14987b, view)) {
                    return true;
                }
                return false;
        }
