...
public final class e extends FrameLayout {
    public final ph.d f10544a;
    public final k6 f10545b;
    public final k6 f10546c;
    public final GiftAuctionController.Auction d;
    public final Paint e;
    public final lf.p f10547f;
    public final mq h;
    public final mq[] f10548n;

    public e(Context context, GiftAuctionController.Auction auction) {
        super(context);
        Paint paint = new Paint(1);
        this.e = paint;
        this.f10547f = new lf.p(new gg.f(this, 19));
        this.h = new mq(R.drawable.filled_gift_sell_24, 0);
        this.f10548n = new mq[1];
        this.d = auction;
    ...
    public final void a(long j10, boolean z4) {
        ...
        this.f10544a.g(spannableStringBuilder, z4, true);
    }
    ...
    public final void b(boolean z4) {
        ...
        if (tL_starGiftAuctionState != null) {
            this.f10545b.c(LocaleController.formatString(R.string.Gift2ActiveAuctionsActiveRound, LocaleController.formatNumber(tL_starGiftAuctionState.current_round, ','), LocaleController.formatNumber(auction.auctionStateActive.total_rounds, ',')), z4, true);
        }
        String l10 = a2.l(auction.auctionUserState.bid_amount, ',', new StringBuilder("⭐️"));
        boolean isOutbid = auction.getBidStatus().isOutbid();
        mq[] mqVarArr = this.f10548n;
        k6 k6Var = this.f10546c;
        if (isOutbid) {
            ...
            k6Var.setTextColor(j6.w0(null, j6.f20141q7, false));
            return;
        }
