        ...
        if (i11 >= 0) {
            ...
            if (i11 < oVarArr.length && (oVar = oVarArr[i11]) != null && i12 == 1 && ((le.b) oVar.d).f15369f) {
                ...
                if (veVar != null) {
                    ...
                    int i13 = veVar.f41523a;
                    final co coVar = veVar.f41524b;
                    switch (i13) {
                        case 24:
                                        ...
                                        switch (r3) {
                                            case 0:
                                                ...
                                                if (coVar2.getParentActivity() != null) {
                                                    ...
                                                    f4Var4.u();
                                                    org.telegram.ui.Components.j40.f27336f.b();
                                                    return;
                                                }
                                                return;
                                            default:
                            ...
                            break;
                        default:
                            if (coVar.L0 == null && !z10 && j40.f27336f.c()) {
                                AndroidUtilities.runOnUIThread(new Runnable() {
                                    @Override
                                    public final void run() {
                                        switch (r3) {
