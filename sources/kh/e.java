...
public final class e extends FrameLayout {
    public final ph.d f10674a;
    public final k6 f10675b;
    public final k6 f10676c;
    public final GiftAuctionController.Auction d;
    public final Paint e;
    public final kf.p f10677f;
    public final lq h;
    public final lq[] f10678n;

    public e(Context context, GiftAuctionController.Auction auction) {
        super(context);
        Paint paint = new Paint(1);
        this.e = paint;
        this.f10677f = new kf.p(new gg.f(this, 20));
        this.h = new lq(R.drawable.filled_gift_sell_24, 0);
        this.f10678n = new lq[1];
        this.d = auction;
        ...
        addView((View) imageView, k7.b6.d(44, 44.0f, 51, 14.0f, 11.0f, 0.0f, 0.0f));
    ...
    public final void a(long j10, boolean z4) {
        ...
        this.f10674a.g(spannableStringBuilder, z4, true);
    }
    ...
    public final void b(boolean z4) {
        ...
        if (tL_starGiftAuctionState != null) {
            this.f10675b.c(LocaleController.formatString(R.string.Gift2ActiveAuctionsActiveRound, LocaleController.formatNumber(tL_starGiftAuctionState.current_round, ','), LocaleController.formatNumber(auction.auctionStateActive.total_rounds, ',')), z4, true);
        }
        String l10 = kf.k0.l(auction.auctionUserState.bid_amount, ',', new StringBuilder("⭐️"));
        boolean isOutbid = auction.getBidStatus().isOutbid();
        lq[] lqVarArr = this.f10678n;
        k6 k6Var = this.f10676c;
        if (isOutbid) {
            ...
            k6Var.setTextColor(j6.w0(null, j6.f20116q7, false));
            return;
        }
