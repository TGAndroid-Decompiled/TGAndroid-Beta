...
public final class q extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    public final p9 f10753a;
    public final k6 f10754b;
    public final k6 f10755c;
    public final k6 d;
    public final mq[] e;
    ...
    public q(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.d = k6Var2;
        k6Var2.setTextColor(j6.v0(j6.f20281y6, f6Var));
    ...
    public final void c(TLRPC.User user) {
        ...
        z8Var.r(user);
        p9 p9Var = this.f10753a;
        p9Var.e(user, z8Var);
        p9Var.setRoundRadius(AndroidUtilities.dp(16.0f));
        this.f10755c.setText(UserObject.getUserName(user));
    }

    @Override
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        this.f10754b.invalidate();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f10756f) {
            canvas.drawLine(AndroidUtilities.dp(112.0f), getMeasuredHeight() - 1, getMeasuredWidth() - AndroidUtilities.dp(16.0f), getMeasuredHeight(), j6.f20025k0);
        }
    }
