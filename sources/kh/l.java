    ...
    public final void b(RecyclerView recyclerView, int i10, int i11) {
        ...
        switch (this.f11274a) {
            ...
            case 1:
                ...
                return;
            case 2:
                h61 h61Var = ((ee) this.f11276c).f36450a;
            ...
            case 4:
                ...
                h61 h61Var2 = gh0Var.f27172c;
                if (TextUtils.isEmpty(gh0Var.f27178w)) {
                    arrayList = gh0Var.f27173e;
                } else {
                    arrayList = gh0Var.f27175n;
                }
                if (!arrayList.isEmpty()) {
                    if (h61Var2.canScrollVertically(1)) {
                        for (int i19 = 0; i19 < h61Var2.getChildCount(); i19++) {
                            if (!(h61Var2.getChildAt(i19) instanceof u00)) {
                            }
                        }
                    }
                    gh0Var.a(false);
            ...
            case 6:
                ...
                if (recyclerView == kvVar.d || recyclerView == kvVar.f38430e) {
            ...
            case 8:
                ((a1) this.f11275b).b(recyclerView, i10, i11);
                rq0 rq0Var = (rq0) this.f11276c;
                if (recyclerView == rq0Var.f40916n[0].d) {
                    kVar = ((p2) rq0Var).actionBar;
