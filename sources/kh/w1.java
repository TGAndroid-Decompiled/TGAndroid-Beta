...
public final class w1 extends h51 {
    ...
    public final void bindView(View view, i51 i51Var, boolean z4, w51 w51Var, g61 g61Var) {
        ...
        if (obj instanceof eg.n) {
            ...
            x1Var.f10931n.setVisibility(8);
            x1Var.C.setVisibility(8);
            if (nVar.f5364c == null && nVar.d == null) {
            ...
            x1Var.V = false;
            x1Var.W = null;
            x1Var.f10920a0 = false;
            x1Var.f10922b0 = false;
            x1Var.f10924c0 = false;
            x1Var.L = null;
            x1Var.M = null;
            x1Var.c(false, false);
            x1Var.j();
            ...
            x1Var.g(starGift, z12, z10, i51Var.f25570q, i51Var.f25571r, i51Var.f25573t);
        } else if (obj instanceof TL_stars.SavedStarGift) {
            z11 = x1Var.h((TL_stars.SavedStarGift) obj, i51Var.f25570q, i51Var.f25571r);
        }
        if (i51Var.f25560f) {
    ...
    public final boolean equals(i51 i51Var, i51 i51Var2) {
        if (i51Var.f25570q == i51Var2.f25570q) {
            Object obj = i51Var.G;
            if (obj != null || i51Var2.G != null) {
                ...
                if (obj instanceof TL_stars.StarGift) {
                    ...
                    if (obj2 instanceof TL_stars.StarGift) {
                        if (((TL_stars.StarGift) obj).f19409id == ((TL_stars.StarGift) obj2).f19409id) {
                            return true;
                        }
                        return false;
                    }
                ...
                if (obj instanceof TL_stars.SavedStarGift) {
                    ...
                    if (obj3 instanceof TL_stars.SavedStarGift) {
                        ...
                        if (savedStarGift.gift.f19409id == savedStarGift2.gift.f19409id && savedStarGift.date == savedStarGift2.date && savedStarGift.saved_id == savedStarGift2.saved_id) {
                            return true;
                        }
                        return false;
                    }
            ...
            if (i51Var.f25578z == i51Var2.f25578z && i51Var.e == i51Var2.e && i51Var.B == i51Var2.B && TextUtils.equals(i51Var.f25565l, i51Var2.f25565l)) {
                return true;
            }
            return false;
        }
