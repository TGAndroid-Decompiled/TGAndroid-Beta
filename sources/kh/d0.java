...
public final class d0 extends lh.c5 {
    public final Path f10522x0;
    public final float[] f10523y0;
    public final f0 f10524z0;
    ...
    public d0(f0 f0Var, Context context, org.telegram.ui.ActionBar.f6 f6Var, v vVar, dg.m mVar, dg.m mVar2, dg.m mVar3, dg.m mVar4, dg.m mVar5, dg.m mVar6) {
        ...
        this.f10524z0 = f0Var;
        this.f10522x0 = new Path();
        this.f10523y0 = new float[8];
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        canvas.save();
        canvas.clipPath(this.f10522x0);
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        float[] fArr = this.f10523y0;
        fArr[3] = dp;
        fArr[2] = dp;
        fArr[1] = dp;
        fArr[0] = dp;
        Path path = this.f10522x0;
        path.rewind();
        path.addRoundRect(0.0f, 0.0f, i10, i11, this.f10523y0, Path.Direction.CW);
    }
}
