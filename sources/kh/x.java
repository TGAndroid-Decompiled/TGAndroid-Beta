...
public final class x implements Runnable {
    ...
    public final void run() {
        ...
        Object obj = this.f11028f;
        Object obj2 = this.e;
        Object obj3 = this.d;
        switch (i10) {
            case 0:
                new d6((Context) obj3, this.f11026b, ((GiftAuctionController.Auction) obj2).gift, null, this.f11027c, (Runnable) obj, false, false).show();
                return;
            case 1:
                lh.a0 a0Var = (lh.a0) obj2;
                TLObject tLObject = (TLObject) obj;
                int i13 = ((lh.b0) obj3).f12115a;
                boolean[] zArr = a0Var.d;
                boolean[] zArr2 = a0Var.f12070b;
                ArrayList[] arrayListArr = a0Var.f12069a;
                zArr[i12] = false;
            ...
            case 2:
                ...
                tL_fulfillStarsSubscription.subscription_id = ((TL_stars.StarsSubscription) obj2).f19385id;
                tL_fulfillStarsSubscription.peer = new TLRPC.TL_inputPeerSelf();
                int i14 = this.f11026b;
                ConnectionsManager.getInstance(i14).sendRequest(tL_fulfillStarsSubscription, new lh.u(dVar, (org.telegram.ui.ActionBar.g3[]) obj, i14, this.f11027c, 1));
                return;
            case 3:
                t6 t6Var = (t6) obj3;
                TLObject tLObject2 = (TLObject) obj2;
                String str2 = (String) obj;
                int i15 = t6Var.f15897a;
                HashSet hashSet = t6Var.f15913t;
                if (tLObject2 != null) {
                    ...
                    while (true) {
                        if (i11 < tL_stories_stories.stories.size()) {
                            if (tL_stories_stories.stories.get(i11).f19394id == i12) {
                ...
                hashSet.add(str2);
                t6Var.f15905l.edit().putStringSet("unsupported_stories_checked", hashSet).apply();
                return;
            case 4:
                ((BotForumHelper) obj3).lambda$beforeSendingFinalRequest$3((long[]) obj2, this.f11027c, this.f11026b, (Runnable) obj);
                return;
            case 5:
                ((MediaDataController) obj3).lambda$loadStickers$100((TLObject) obj2, this.f11026b, (Utilities.Callback) obj, this.f11027c);
                return;
            case 6:
                int i16 = this.f11026b;
                ((MessagesStorage) obj3).lambda$checkMessageId$154(this.f11027c, i16, (boolean[]) obj2, (CountDownLatch) obj);
                return;
            case 7:
                ((MessagesStorage) obj3).lambda$overwriteChannel$190(this.f11027c, this.f11026b, (TLRPC.TL_updates_channelDifferenceTooLong) obj2, (Runnable) obj);
                return;
            case 8:
                ((MessagesStorage) obj3).lambda$updateMessageVoiceTranscription$109(this.f11026b, this.f11027c, (TLRPC.Message) obj2, (String) obj);
                return;
            case 9:
                ((MessagesStorage) obj3).lambda$setDialogsFolderId$244((ArrayList) obj2, (ArrayList) obj, this.f11026b, this.f11027c);
                return;
            case 10:
                ((TopicsController) obj3).lambda$loadTopics$2((TLRPC.TL_messages_savedDialogs) obj2, this.f11027c, (a0.h) obj, this.f11026b);
                return;
            case 11:
                ((TopicsController) obj3).lambda$loadTopics$3((TLRPC.TL_messages_savedDialogsSlice) obj2, this.f11027c, (a0.h) obj, this.f11026b);
                return;
            default:
