...
public final class t implements Utilities.Callback2 {
    ...
    public final void run(Object obj, Object obj2) {
        ...
        int i12;
        int i13;
        int i14 = this.f10819a;
        Object obj3 = this.f10822f;
        Object obj4 = this.e;
        switch (i14) {
            case 0:
            ...
            default:
                ...
                int i17 = this.f10820b;
                reportprofilephoto.peer = MessagesController.getInstance(i17).getInputPeer(this.f10821c);
    ...
    public t(Context context, org.telegram.ui.ActionBar.f6 f6Var, int i10, long j10, Runnable runnable) {
        this.d = context;
        this.e = f6Var;
        this.f10820b = i10;
        this.f10821c = j10;
        this.f10822f = runnable;
    }
}
