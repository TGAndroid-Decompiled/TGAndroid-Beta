...
public final class g0 extends FrameLayout {
    public final RectF f10725a;
    public final RectF f10726b;
    public final m0 f10727c;

    public g0(m0 m0Var, Context context) {
        super(context);
        this.f10727c = m0Var;
        this.f10725a = new RectF();
        this.f10726b = new RectF();
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        super.dispatchDraw(canvas);
        m0 m0Var = this.f10727c;
        h0 h0Var = m0Var.X;
        FrameLayout frameLayout = h0Var.f12199b;
        RectF rectF = this.f10725a;
        if (ug.i.c(frameLayout, this, rectF)) {
            TextView textView = m0Var.Y;
            RectF rectF2 = this.f10726b;
