...
public final class z3 implements Utilities.Callback2 {
    ...
    public final q5 f11082b;
    public final String[] f11083c;
    public final ArrayList d;

    public z3(q5 q5Var, String[] strArr, ArrayList arrayList, int i10) {
        this.f11081a = i10;
        this.f11082b = q5Var;
        this.f11083c = strArr;
        this.d = arrayList;
    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (i10) {
            case 0:
                ...
                a5 a5Var = q5Var.d;
                boolean isEmpty = a5Var.f10588l.isEmpty();
                ...
                while (i11 < size) {
                    ...
                    boolean contains = a5Var.f10588l.contains(Long.valueOf(stargiftattributepattern.document.f19165id));
                    boolean z4 = !contains;
                    if (TextUtils.isEmpty(lowerCase) || stargiftattributepattern.name.toLowerCase().startsWith(lowerCase) || stargiftattributepattern.name.toLowerCase().startsWith(translitSafe) || org.telegram.messenger.y3.w(" ", lowerCase, stargiftattributepattern.name.toLowerCase()) || org.telegram.messenger.y3.w(" ", translitSafe, stargiftattributepattern.name.toLowerCase())) {
                        Integer num = (Integer) a5Var.f10591o.get(Long.valueOf(stargiftattributepattern.document.f19165id));
                        if (num == null) {
                            intValue = 0;
                        } else {
            ...
            default:
                ...
                a5 a5Var3 = q5Var.d;
                boolean isEmpty3 = a5Var3.f10586j.isEmpty();
                ...
                while (i15 < size3) {
                    ...
                    boolean contains3 = a5Var3.f10586j.contains(Long.valueOf(stargiftattributemodel.document.f19165id));
                    ...
                    if (!TextUtils.isEmpty(lowerCase3) && !stargiftattributemodel.name.toLowerCase().startsWith(lowerCase3) && !stargiftattributemodel.name.toLowerCase().startsWith(translitSafe3) && !org.telegram.messenger.y3.w(str3, lowerCase3, stargiftattributemodel.name.toLowerCase()) && !org.telegram.messenger.y3.w(str3, translitSafe3, stargiftattributemodel.name.toLowerCase())) {
                        ...
                        str2 = str3;
                        Integer num3 = (Integer) a5Var3.f10589m.get(Long.valueOf(stargiftattributemodel.document.f19165id));
                        if (num3 == null) {
                            intValue3 = 0;
                        } else {
