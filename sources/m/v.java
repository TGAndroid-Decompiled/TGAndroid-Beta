...
public class v extends ImageView {
    public final e2.c f14510a;
    public final j6.l f14511b;
    ...
    public final void drawableStateChanged() {
        ...
        e2.c cVar = this.f14510a;
        if (cVar != null) {
            cVar.b();
        }
        j6.l lVar = this.f14511b;
        if (lVar != null) {
            lVar.b();
        }
    }
    ...
    public final boolean hasOverlappingRendering() {
        if (!(((ImageView) this.f14511b.f12911b).getBackground() instanceof RippleDrawable) && super.hasOverlappingRendering()) {
            return true;
        }
        return false;
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        j6.l lVar = this.f14511b;
        if (lVar != null && drawable != null && !this.f14512c) {
