...
public class v extends ImageView {
    public final e2.c f14313a;
    public final j6.l f14314b;
    ...
    public final void drawableStateChanged() {
        ...
        e2.c cVar = this.f14313a;
        if (cVar != null) {
            cVar.b();
        }
        j6.l lVar = this.f14314b;
        if (lVar != null) {
            lVar.b();
        }
    }
    ...
    public final boolean hasOverlappingRendering() {
        if (!(((ImageView) this.f14314b.f12900b).getBackground() instanceof RippleDrawable) && super.hasOverlappingRendering()) {
            return true;
        }
        return false;
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        j6.l lVar = this.f14314b;
        if (lVar != null && drawable != null && !this.f14315c) {
