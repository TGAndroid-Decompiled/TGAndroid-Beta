...
public final class d2 implements View.OnTouchListener {
    ...
    public final boolean onTouch(View view, MotionEvent motionEvent) {
        switch (this.f13481a) {
            ...
            case 1:
                jy jyVar = (jy) this.f13482b;
                if (motionEvent.getAction() == 0) {
                    jyVar.C.f26426f = true;
                } else if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
                    jyVar.C.f26426f = false;
                }
                return false;
            case 2:
                wy wyVar = (wy) this.f13482b;
                if (motionEvent.getAction() == 0) {
                    wyVar.D.f26426f = true;
                } else if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
                    wyVar.D.f26426f = false;
                }
                return false;
            default:
                fz fzVar = (fz) this.f13482b;
                if (motionEvent.getAction() == 0) {
                    fzVar.N.f26426f = true;
                } else if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
                    fzVar.N.f26426f = false;
                }
                return false;
        }
    }
