...
public class y {
    ...
    public KeyListener a(KeyListener keyListener) {
        if (!(keyListener instanceof NumberKeyListener)) {
            ((o0.a) ((u4) this.f15719c).f14221b).getClass();
    ...
    public void b(AttributeSet attributeSet, int i10) {
        ...
        switch (this.f15717a) {
            case 0:
                AbsSeekBar absSeekBar = (AbsSeekBar) this.f15718b;
                ...
                return;
            default:
                TypedArray obtainStyledAttributes = ((EditText) this.f15718b).getContext().obtainStyledAttributes(attributeSet, f.a.f9143i, i10, 0);
                try {
    ...
    public q1.b c(InputConnection inputConnection, EditorInfo editorInfo) {
        u4 u4Var = (u4) this.f15719c;
        if (inputConnection == null) {
            u4Var.getClass();
            inputConnection = null;
        } else {
            o0.a aVar = (o0.a) u4Var.f14221b;
            aVar.getClass();
            if (!(inputConnection instanceof q1.b)) {
                inputConnection = new q1.b((EditText) aVar.f16769b, inputConnection, editorInfo);
            }
        }
    ...
    public void d(boolean z10) {
        q1.i iVar = (q1.i) ((o0.a) ((u4) this.f15719c).f14221b).f16770c;
        if (iVar.f44120c != z10) {
            if (iVar.f44119b != null) {
                androidx.emoji2.text.l a2 = androidx.emoji2.text.l.a();
                q1.h hVar = iVar.f44119b;
                a2.getClass();
                k6.a(hVar, "initCallback cannot be null");
                ReentrantReadWriteLock reentrantReadWriteLock = a2.f1350a;
                reentrantReadWriteLock.writeLock().lock();
                try {
                    a2.f1351b.remove(hVar);
                } finally {
            ...
            iVar.f44120c = z10;
            if (z10) {
                q1.i.a(iVar.f44118a, androidx.emoji2.text.l.a().b());
            }
        }
    }
    ...
    public Drawable e(Drawable drawable, boolean z10) {
        ...
        if (drawable instanceof j0.c) {
            ...
            Drawable drawable2 = dVar.f13149f;
            if (drawable2 != null) {
    ...
    public y(AbsSeekBar absSeekBar) {
        this.f15718b = absSeekBar;
    }

    public y(EditText editText) {
        this.f15718b = editText;
        this.f15719c = new u4(editText);
    }
}
