...
public final class q0 extends Spinner {
    public static final int[] f13589r = {16843505};
    public final m f13590a;
    public final Context f13591b;
    public final e0 f13592c;
    public SpinnerAdapter d;
    public final boolean e;
    public final p0 f13593f;
    public int h;
    public final Rect f13594n;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f13593f != null && View.MeasureSpec.getMode(i10) == Integer.MIN_VALUE) {
    ...
    public final void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (o0Var.f13562a && (viewTreeObserver = getViewTreeObserver()) != null) {
    ...
    public final Parcelable onSaveInstanceState() {
        ...
        baseSavedState.f13562a = z4;
        return baseSavedState;
    }

    @Override
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        e0 e0Var = this.f13592c;
