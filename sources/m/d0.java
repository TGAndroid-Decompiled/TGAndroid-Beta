...
public final class d0 extends y {
    public final c0 e;
    public Drawable f14387f;
    public ColorStateList f14388g;
    ...
    public final void b(AttributeSet attributeSet, int i10) {
        ...
        r0.i0.j(c0Var, c0Var.getContext(), iArr, attributeSet, (TypedArray) Q.f14231c, i10);
        Drawable G = Q.G(0);
        if (G != null) {
            c0Var.setThumb(G);
        }
        Drawable F = Q.F(1);
        Drawable drawable = this.f14387f;
        if (drawable != null) {
    ...
    public final void f() {
        ...
        if (drawable != null) {
            if (this.f14389i || this.f14390j) {
                ...
                this.f14387f = d;
                if (this.f14389i) {
                    d.setTintList(this.f14388g);
                }
                if (this.f14390j) {
                    this.f14387f.setTintMode(this.h);
                }
                if (this.f14387f.isStateful()) {
                    this.f14387f.setState(this.e.getDrawableState());
                }
            }
        }
    }
    ...
    public final void g(Canvas canvas) {
        ...
        if (this.f14387f != null) {
            ...
            int i11 = 1;
            if (max > 1) {
                int intrinsicWidth = this.f14387f.getIntrinsicWidth();
                int intrinsicHeight = this.f14387f.getIntrinsicHeight();
                if (intrinsicWidth >= 0) {
                ...
                this.f14387f.setBounds(-i10, -i11, i10, i11);
