...
public final class d0 extends y {
    ...
    public final void b(AttributeSet attributeSet, int i10) {
        ...
        r0.i0.j(c0Var, c0Var.getContext(), iArr, attributeSet, (TypedArray) Q.f14034c, i10);
        Drawable G = Q.G(0);
        if (G != null) {
            c0Var.setThumb(G);
        }
    ...
    public final void f() {
        Drawable drawable = this.f14161f;
        if (drawable != null) {
            if (this.f14163i || this.f14164j) {
                Drawable d = r8.d(drawable.mutate());
                this.f14161f = d;
                if (this.f14163i) {
                    d.setTintList(this.f14162g);
                }
                if (this.f14164j) {
                    this.f14161f.setTintMode(this.h);
                }
                if (this.f14161f.isStateful()) {
                    this.f14161f.setState(this.e.getDrawableState());
                }
            }
        }
    }
    ...
    public final void g(Canvas canvas) {
        ...
        if (this.f14161f != null) {
            ...
            int i11 = 1;
            if (max > 1) {
                int intrinsicWidth = this.f14161f.getIntrinsicWidth();
                int intrinsicHeight = this.f14161f.getIntrinsicHeight();
                if (intrinsicWidth >= 0) {
                ...
                this.f14161f.setBounds(-i10, -i11, i10, i11);
