...
public abstract class w1 extends ViewGroup {
    ...
    public w1(Context context, AttributeSet attributeSet, int i10) {
        ...
        r0.i0.j(this, context, iArr, attributeSet, (TypedArray) Q.f14012c, i10);
        TypedArray typedArray = (TypedArray) Q.f14012c;
        ...
        this.f14330b = typedArray.getInt(3, -1);
        this.f14333n = typedArray.getBoolean(7, false);
        setDividerDrawable(Q.F(5));
        this.f14338y = typedArray.getInt(8, 0);
        this.E = typedArray.getDimensionPixelSize(6, 0);
        Q.R();
    }

    public final void c(Canvas canvas, int i10) {
        this.v.setBounds(getPaddingLeft() + this.E, i10, (getWidth() - getPaddingRight()) - this.E, this.f14337x + i10);
        this.v.draw(canvas);
    }
    ...
    public final void d(Canvas canvas, int i10) {
        this.v.setBounds(i10, getPaddingTop() + this.E, this.f14336w + i10, (getHeight() - getPaddingBottom()) - this.E);
        this.v.draw(canvas);
    }
    ...
    public int getBaseline() {
        ...
        if (childCount > i11) {
            ...
            if (this.d == 1 && (i10 = this.e & 112) != 48) {
                if (i10 != 16) {
                    if (i10 == 80) {
                        i12 = ((getBottom() - getTop()) - getPaddingBottom()) - this.f14332f;
                    }
                } else {
                    i12 = hg.c.C(((getBottom() - getTop()) - getPaddingTop()) - getPaddingBottom(), this.f14332f, 2, i12);
                }
            }
            ...
            if (this.d == 1) {
                ...
                while (i11 < virtualChildCount) {
                    ...
                    if (childAt != null && childAt.getVisibility() != 8 && h(i11)) {
                        c(canvas, (childAt.getTop() - ((LinearLayout.LayoutParams) ((v1) childAt.getLayoutParams())).topMargin) - this.f14337x);
                    }
                    i11++;
                }
                if (h(virtualChildCount)) {
                    ...
                    if (childAt2 == null) {
                        bottom = (getHeight() - getPaddingBottom()) - this.f14337x;
                    } else {
            ...
            while (i11 < virtualChildCount2) {
                ...
                if (childAt3 != null && childAt3.getVisibility() != 8 && h(i11)) {
                    ...
                    if (a2) {
                        ...
                        left2 = (childAt3.getLeft() - ((LinearLayout.LayoutParams) v1Var).leftMargin) - this.f14336w;
                    }
                    d(canvas, left2);
                }
                i11++;
    ...
    public void setDividerDrawable(Drawable drawable) {
        ...
        boolean z10 = false;
        if (drawable != null) {
            this.f14336w = drawable.getIntrinsicWidth();
            this.f14337x = drawable.getIntrinsicHeight();
        } else {
            this.f14336w = 0;
            this.f14337x = 0;
        }
