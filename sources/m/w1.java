...
public abstract class w1 extends ViewGroup {
    ...
    public w1(Context context, AttributeSet attributeSet, int i10) {
        ...
        this.f15699b = -1;
        this.f15700c = 0;
        this.f15701e = 8388659;
        int[] iArr = f.a.f9148n;
        aa.a y3 = aa.a.y(context, attributeSet, iArr, i10);
        r0.i0.j(this, context, iArr, attributeSet, (TypedArray) y3.f372c, i10);
        ...
        this.f15699b = typedArray.getInt(3, -1);
        this.f15703n = typedArray.getBoolean(7, false);
        setDividerDrawable(y3.r(5));
        this.f15708y = typedArray.getInt(8, 0);
        this.E = typedArray.getDimensionPixelSize(6, 0);
        y3.A();
    }

    public final void c(Canvas canvas, int i10) {
        this.v.setBounds(getPaddingLeft() + this.E, i10, (getWidth() - getPaddingRight()) - this.E, this.f15707x + i10);
        this.v.draw(canvas);
    }
    ...
    public final void d(Canvas canvas, int i10) {
        this.v.setBounds(i10, getPaddingTop() + this.E, this.f15706w + i10, (getHeight() - getPaddingBottom()) - this.E);
        this.v.draw(canvas);
    }
    ...
    public int getBaseline() {
        ...
        if (childCount > i11) {
            ...
            if (this.d == 1 && (i10 = this.f15701e & 112) != 48) {
                if (i10 != 16) {
                    if (i10 == 80) {
                        i12 = ((getBottom() - getTop()) - getPaddingBottom()) - this.f15702f;
                    }
                } else {
                    i12 = i2.g.C(((getBottom() - getTop()) - getPaddingTop()) - getPaddingBottom(), this.f15702f, 2, i12);
                }
            }
            ...
            if (this.d == 1) {
                ...
                while (i11 < virtualChildCount) {
                    ...
                    if (childAt != null && childAt.getVisibility() != 8 && h(i11)) {
                        c(canvas, (childAt.getTop() - ((LinearLayout.LayoutParams) ((v1) childAt.getLayoutParams())).topMargin) - this.f15707x);
                    }
                    i11++;
                }
                if (h(virtualChildCount)) {
                    ...
                    if (childAt2 == null) {
                        bottom = (getHeight() - getPaddingBottom()) - this.f15707x;
                    } else {
            ...
            while (i11 < virtualChildCount2) {
                ...
                if (childAt3 != null && childAt3.getVisibility() != 8 && h(i11)) {
                    ...
                    if (a2) {
                        ...
                        left2 = (childAt3.getLeft() - ((LinearLayout.LayoutParams) v1Var).leftMargin) - this.f15706w;
                    }
                    d(canvas, left2);
                }
                i11++;
    ...
    public void setDividerDrawable(Drawable drawable) {
        ...
        boolean z10 = false;
        if (drawable != null) {
            this.f15706w = drawable.getIntrinsicWidth();
            this.f15707x = drawable.getIntrinsicHeight();
        } else {
            this.f15706w = 0;
            this.f15707x = 0;
        }
    ...
    public void setHorizontalGravity(int i10) {
        int i11 = i10 & 8388615;
        int i12 = this.f15701e;
        if ((8388615 & i12) != i11) {
            this.f15701e = i11 | ((-8388616) & i12);
            requestLayout();
        }
    }
