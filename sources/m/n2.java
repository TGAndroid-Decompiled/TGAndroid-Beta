...
public final class n2 {
    public static n2 f13566i;
    public WeakHashMap f13568a;
    public a0.k f13569b;
    public a0.l f13570c;
    ...
    public static final l2 f13567j = new a0.j(6);
    ...
    public final void a(String str, m2 m2Var) {
        if (this.f13569b == null) {
            this.f13569b = new a0.k(0);
        }
        this.f13569b.put(str, m2Var);
    }
    ...
    public final synchronized ColorStateList i(Context context, int i10) {
        ...
        a0.l lVar;
        WeakHashMap weakHashMap = this.f13568a;
        ...
        if (colorStateList == null) {
            ...
            if (colorStateList2 != null) {
                ...
                a0.l lVar2 = (a0.l) this.f13568a.get(context);
                if (lVar2 == null) {
                    lVar2 = new a0.l();
                    this.f13568a.put(context, lVar2);
                }
    ...
    public final Drawable k(Context context, int i10) {
        int next;
        a0.k kVar = this.f13569b;
        if (kVar != null && !kVar.isEmpty()) {
            a0.l lVar = this.f13570c;
            if (lVar != null) {
                String str = (String) lVar.c(i10);
                if (!"appcompat_skip_skip".equals(str)) {
                    if (str != null && this.f13569b.get(str) == null) {
                        return null;
                    }
                } else {
                    return null;
            ...
            if (charSequence != null && charSequence.toString().endsWith(".xml")) {
                try {
                    ...
                    if (next == 2) {
                        ...
                        this.f13570c.a(i10, name);
                        m2 m2Var = (m2) this.f13569b.get(name);
                        if (m2Var != null) {
            ...
            if (e == null) {
                this.f13570c.a(i10, "appcompat_skip_skip");
            }
            return e;
        }
        return null;
