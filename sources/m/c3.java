...
public final class c3 extends h1.b implements View.OnClickListener {
    ...
    public final int f13470r;
    public final LayoutInflater f13471s;
    public final SearchView v;
    public final SearchableInfo f13472w;
    public final Context f13473x;
    public final WeakHashMap f13474y;
    ...
    public c3(Context context, SearchView searchView, SearchableInfo searchableInfo, WeakHashMap weakHashMap) {
        ...
        this.f6889f = new h1.a(this, 0);
        this.f13470r = suggestionRowLayout;
        this.f13469n = suggestionRowLayout;
        this.f13471s = (LayoutInflater) context.getSystemService("layout_inflater");
        this.C = 1;
        this.E = -1;
        this.F = -1;
        this.G = -1;
        ...
        this.J = -1;
        this.v = searchView;
        this.f13472w = searchableInfo;
        this.B = searchView.getSuggestionCommitIconResId();
        this.f13473x = context;
        this.f13474y = weakHashMap;
    }
    ...
    public final String c(Cursor cursor) {
        ...
        if (cursor != null) {
            ...
            SearchableInfo searchableInfo = this.f13472w;
    ...
    public final Drawable d(Uri uri) {
        ...
        if (!TextUtils.isEmpty(authority)) {
            try {
                Resources resourcesForApplication = this.f13473x.getPackageManager().getResourcesForApplication(authority);
    ...
    public final Cursor f(SearchableInfo searchableInfo, String str) {
        ...
        return this.f13473x.getContentResolver().query(fragment.build(), null, suggestSelection, strArr2, null);
    }
    ...
    public final View getDropDownView(int i10, View view, ViewGroup viewGroup) {
        try {
            ...
            View inflate = this.f13471s.inflate(this.f13470r, viewGroup, false);
            if (inflate != null) {
                ((b3) inflate.getTag()).f13464a.setText(e.toString());
            }
            return inflate;
        }
    }
    ...
    public final View getView(int i10, View view, ViewGroup viewGroup) {
        try {
            ...
            Log.w("SuggestionsAdapter", "Search suggestions cursor threw exception.", e);
            View inflate = this.f13471s.inflate(this.f13469n, viewGroup, false);
