...
public final class w0 {
    ...
    public w0(TextView textView) {
        ...
        this.f14324i = new g1(textView);
    }

    public static c3 c(Context context, q qVar, int i10) {
        ColorStateList i11;
        synchronized (qVar) {
            i11 = qVar.f14276a.i(context, i10);
        }
        if (i11 != null) {
            ?? obj = new Object();
            obj.f14135b = true;
    ...
    public final void a(Drawable drawable, c3 c3Var) {
        if (drawable != null && c3Var != null) {
            q.d(drawable, c3Var, this.f14319a.getDrawableState());
        }
    }

    public final void b() {
        c3 c3Var = this.f14320b;
        TextView textView = this.f14319a;
        if (c3Var != null || this.f14321c != null || this.d != null || this.e != null) {
            Drawable[] compoundDrawables = textView.getCompoundDrawables();
            a(compoundDrawables[0], this.f14320b);
            a(compoundDrawables[1], this.f14321c);
            a(compoundDrawables[2], this.d);
            a(compoundDrawables[3], this.e);
        }
        if (this.f14322f == null && this.f14323g == null) {
            return;
        }
    ...
    public final void g(Context context, int i10) {
        ...
        ColorStateList D2;
        ColorStateList D3;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(i10, f.a.f8767w);
        ...
        iVar.R();
        Typeface typeface = this.f14327l;
        if (typeface != null) {
            textView.setTypeface(typeface, this.f14325j);
        }
    }

    public final void i(int i10, int i11, int i12, int i13) {
        g1 g1Var = this.f14324i;
        if (g1Var.j()) {
            DisplayMetrics displayMetrics = g1Var.f14167j.getResources().getDisplayMetrics();
    ...
    public final void n(Context context, lf.i iVar) {
        ...
        TypedArray typedArray = (TypedArray) iVar.f14012c;
        this.f14325j = typedArray.getInt(2, i10);
        int i11 = Build.VERSION.SDK_INT;
        if (i11 >= 28) {
        ...
        if (!typedArray.hasValue(10) && !typedArray.hasValue(12)) {
            if (typedArray.hasValue(1)) {
                ...
                if (i14 != 1) {
                    if (i14 != 2) {
                        if (i14 == 3) {
                            this.f14327l = Typeface.MONOSPACE;
                            return;
                        }
                        return;
                    }
                    this.f14327l = Typeface.SERIF;
                    return;
                }
                this.f14327l = Typeface.SANS_SERIF;
                return;
            }
            return;
        }
        ...
        int i15 = this.f14326k;
        int i16 = this.f14325j;
        if (!context.isRestricted()) {
            WeakReference weakReference = new WeakReference(this.f14319a);
            ?? obj = new Object();
            obj.d = this;
            obj.f7857a = i15;
            obj.f7858b = i16;
            obj.f7859c = weakReference;
            try {
                Typeface H = iVar.H(i13, this.f14325j, obj);
                if (H != null) {
                    if (i11 >= 28 && this.f14326k != -1) {
                        Typeface create = Typeface.create(H, 0);
                        int i17 = this.f14326k;
                        if ((this.f14325j & 2) != 0) {
                            z11 = true;
                        } else {
                            z11 = false;
                        }
                        this.f14327l = v0.a(create, i17, z11);
                    } else {
                        this.f14327l = H;
                    }
                }
        ...
        if (this.f14327l == null && (string = typedArray.getString(i13)) != null) {
            if (Build.VERSION.SDK_INT >= 28 && this.f14326k != -1) {
                Typeface create2 = Typeface.create(string, 0);
                int i18 = this.f14326k;
                if ((this.f14325j & 2) == 0) {
                    z12 = false;
                }
                this.f14327l = v0.a(create2, i18, z12);
                return;
            }
            this.f14327l = Typeface.create(string, this.f14325j);
        }
    }
}
