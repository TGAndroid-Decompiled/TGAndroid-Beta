...
public final class w0 {
    ...
    public w0(TextView textView) {
        ...
        this.f13370i = new g1(textView);
    }

    public static e3 c(Context context, q qVar, int i10) {
        ColorStateList i11;
        synchronized (qVar) {
            i11 = qVar.f13302a.i(context, i10);
        }
        if (i11 != null) {
            ?? obj = new Object();
            obj.f13183b = true;
    ...
    public final void a(Drawable drawable, e3 e3Var) {
        if (drawable != null && e3Var != null) {
            q.d(drawable, e3Var, this.f13364a.getDrawableState());
        }
    }

    public final void b() {
        e3 e3Var = this.f13365b;
        TextView textView = this.f13364a;
        if (e3Var != null || this.f13366c != null || this.d != null || this.f13367e != null) {
            Drawable[] compoundDrawables = textView.getCompoundDrawables();
            a(compoundDrawables[0], this.f13365b);
            a(compoundDrawables[1], this.f13366c);
            a(compoundDrawables[2], this.d);
            a(compoundDrawables[3], this.f13367e);
        }
        if (this.f13368f == null && this.f13369g == null) {
            return;
        }
    ...
    public final void i(int i10, int i11, int i12, int i13) {
        g1 g1Var = this.f13370i;
        if (g1Var.j()) {
            DisplayMetrics displayMetrics = g1Var.f13196j.getResources().getDisplayMetrics();
    ...
    public final void n(Context context, l7.w0 w0Var) {
        ...
        this.f13371j = typedArray.getInt(2, i10);
        int i11 = Build.VERSION.SDK_INT;
        if (i11 >= 28) {
        ...
        if (!typedArray.hasValue(10) && !typedArray.hasValue(12)) {
            if (typedArray.hasValue(1)) {
                ...
                if (i14 != 1) {
                    if (i14 != 2) {
                        if (i14 == 3) {
                            this.f13373l = Typeface.MONOSPACE;
                            return;
                        }
                        return;
                    }
                    this.f13373l = Typeface.SERIF;
                    return;
                }
                this.f13373l = Typeface.SANS_SERIF;
                return;
            }
            return;
        }
        ...
        int i15 = this.f13372k;
        int i16 = this.f13371j;
        if (!context.isRestricted()) {
            WeakReference weakReference = new WeakReference(this.f13364a);
            ?? obj = new Object();
            obj.d = this;
            obj.f7230a = i15;
            obj.f7231b = i16;
            ...
            try {
                Typeface v = w0Var.v(i13, this.f13371j, obj);
                if (v != null) {
                    if (i11 >= 28 && this.f13372k != -1) {
                        Typeface create = Typeface.create(v, 0);
                        int i17 = this.f13372k;
                        if ((this.f13371j & 2) != 0) {
                            z10 = true;
                        } else {
                            z10 = false;
                        }
                        this.f13373l = v0.a(create, i17, z10);
                    } else {
                        this.f13373l = v;
                    }
                }
        ...
        if (this.f13373l == null && (string = typedArray.getString(i13)) != null) {
            if (Build.VERSION.SDK_INT >= 28 && this.f13372k != -1) {
                Typeface create2 = Typeface.create(string, 0);
                int i18 = this.f13372k;
                if ((this.f13371j & 2) == 0) {
                    z11 = false;
                }
                this.f13373l = v0.a(create2, i18, z11);
                return;
            }
            this.f13373l = Typeface.create(string, this.f13371j);
        }
    }
}
