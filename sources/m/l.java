...
public class l extends AutoCompleteTextView implements u0.k {
    ...
    public final e2.c f14225a;
    public final w0 f14226b;
    public final y f14227c;
    ...
    public final void drawableStateChanged() {
        ...
        e2.c cVar = this.f14225a;
        if (cVar != null) {
            cVar.b();
        }
        w0 w0Var = this.f14226b;
        if (w0Var != null) {
            w0Var.b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f14226b.d();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f14226b.e();
    }
    ...
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        return this.f14227c.c(onCreateInputConnection, editorInfo);
    }
    ...
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f14227c.a(keyListener));
    }
