...
public class l extends AutoCompleteTextView implements u0.k {
    ...
    public final e2.c f14400a;
    public final w0 f14401b;
    public final y f14402c;
    ...
    public final void drawableStateChanged() {
        ...
        e2.c cVar = this.f14400a;
        if (cVar != null) {
            cVar.b();
        }
        w0 w0Var = this.f14401b;
        if (w0Var != null) {
            w0Var.b();
        }
    }
    ...
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        return this.f14402c.c(onCreateInputConnection, editorInfo);
    }
    ...
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f14402c.a(keyListener));
    }
