...
public final class g1 {
    public static final RectF f14159l = new RectF();
    public static final ConcurrentHashMap f14160m = new ConcurrentHashMap();
    public int f14161a = 0;
    public boolean f14162b = false;
    public float f14163c = -1.0f;
    public float d = -1.0f;
    public float e = -1.0f;
    public int[] f14164f = new int[0];
    public boolean f14165g = false;
    public TextPaint h;
    public final TextView f14166i;
    public final Context f14167j;
    public final f1 f14168k;
    ...
    public g1(TextView textView) {
        this.f14166i = textView;
        this.f14167j = textView.getContext();
    ...
    public static Method d(String str) {
        try {
            ConcurrentHashMap concurrentHashMap = f14160m;
    ...
    public final void a() {
        ...
        if (f()) {
            if (this.f14162b) {
                if (this.f14166i.getMeasuredHeight() > 0 && this.f14166i.getMeasuredWidth() > 0) {
                    if (this.f14168k.b(this.f14166i)) {
                        measuredWidth = 1048576;
                    } else {
                        measuredWidth = (this.f14166i.getMeasuredWidth() - this.f14166i.getTotalPaddingLeft()) - this.f14166i.getTotalPaddingRight();
                    }
                    int height = (this.f14166i.getHeight() - this.f14166i.getCompoundPaddingBottom()) - this.f14166i.getCompoundPaddingTop();
                    if (measuredWidth > 0 && height > 0) {
                        ...
                        synchronized (rectF) {
                            try {
                                ...
                                rectF.bottom = height;
                                float c10 = c(rectF);
                                if (c10 != this.f14166i.getTextSize()) {
                                    g(c10, 0);
                                }
                            } finally {
                            }
    ...
    public final int c(RectF rectF) {
        ...
        int length = this.f14164f.length;
        if (length != 0) {
            int i10 = length - 1;
            int i11 = 1;
            int i12 = 0;
            while (i11 <= i10) {
                int i13 = (i11 + i10) / 2;
                int i14 = this.f14164f[i13];
                TextView textView = this.f14166i;
                ...
                if (i15 >= 23) {
                    a2 = c1.a(charSequence, alignment, round, b10, this.f14166i, this.h, this.f14168k);
                } else {
    ...
    public final boolean h() {
        if (j() && this.f14161a == 1) {
            if (!this.f14165g || this.f14164f.length == 0) {
                int floor = ((int) Math.floor((this.e - this.d) / this.f14163c)) + 1;
                int[] iArr = new int[floor];
                for (int i10 = 0; i10 < floor; i10++) {
                    iArr[i10] = Math.round((i10 * this.f14163c) + this.d);
                }
                this.f14164f = b(iArr);
            }
            this.f14162b = true;
    ...
    public final boolean j() {
        return !(this.f14166i instanceof s);
    }
