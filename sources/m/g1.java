...
public final class g1 {
    public static final RectF f14169l = new RectF();
    public static final ConcurrentHashMap f14170m = new ConcurrentHashMap();
    public int f14171a = 0;
    public boolean f14172b = false;
    public float f14173c = -1.0f;
    public float d = -1.0f;
    public float e = -1.0f;
    public int[] f14174f = new int[0];
    public boolean f14175g = false;
    public TextPaint h;
    public final TextView f14176i;
    public final Context f14177j;
    public final f1 f14178k;
    ...
    public g1(TextView textView) {
        this.f14176i = textView;
        this.f14177j = textView.getContext();
    ...
    public static Method d(String str) {
        try {
            ConcurrentHashMap concurrentHashMap = f14170m;
    ...
    public final void a() {
        ...
        if (f()) {
            if (this.f14172b) {
                if (this.f14176i.getMeasuredHeight() > 0 && this.f14176i.getMeasuredWidth() > 0) {
                    if (this.f14178k.b(this.f14176i)) {
                        measuredWidth = 1048576;
                    } else {
                        measuredWidth = (this.f14176i.getMeasuredWidth() - this.f14176i.getTotalPaddingLeft()) - this.f14176i.getTotalPaddingRight();
                    }
                    int height = (this.f14176i.getHeight() - this.f14176i.getCompoundPaddingBottom()) - this.f14176i.getCompoundPaddingTop();
                    if (measuredWidth > 0 && height > 0) {
                        ...
                        synchronized (rectF) {
                            try {
                                ...
                                rectF.bottom = height;
                                float c10 = c(rectF);
                                if (c10 != this.f14176i.getTextSize()) {
                                    g(c10, 0);
                                }
                            } finally {
                            }
    ...
    public final int c(RectF rectF) {
        ...
        if (length != 0) {
            ...
            while (i11 <= i10) {
                int i13 = (i11 + i10) / 2;
                int i14 = this.f14174f[i13];
                TextView textView = this.f14176i;
                ...
                if (i15 >= 23) {
                    a2 = c1.a(charSequence, alignment, round, b10, this.f14176i, this.h, this.f14178k);
                } else {
    ...
    public final boolean h() {
        if (j() && this.f14171a == 1) {
            if (!this.f14175g || this.f14174f.length == 0) {
                int floor = ((int) Math.floor((this.e - this.d) / this.f14173c)) + 1;
                int[] iArr = new int[floor];
                for (int i10 = 0; i10 < floor; i10++) {
                    iArr[i10] = Math.round((i10 * this.f14173c) + this.d);
                }
                this.f14174f = b(iArr);
            }
            this.f14172b = true;
    ...
    public final boolean j() {
        return !(this.f14176i instanceof s);
    }
