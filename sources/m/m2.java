...
public final class m2 {
    public static m2 f14474i;
    public WeakHashMap f14476a;
    public a0.m f14477b;
    public a0.n f14478c;
    public final WeakHashMap d = new WeakHashMap(0);
    public TypedValue e;
    public boolean f14479f;
    public com.google.firebase.messaging.n f14480g;
    public static final PorterDuff.Mode h = PorterDuff.Mode.SRC_IN;
    public static final k2 f14475j = new a0.k(6);
    ...
    public final void a(String str, l2 l2Var) {
        if (this.f14477b == null) {
            this.f14477b = new a0.m(0);
        }
        this.f14477b.put(str, l2Var);
    }
    ...
    public final synchronized ColorStateList i(Context context, int i10) {
        ...
        a0.n nVar;
        WeakHashMap weakHashMap = this.f14476a;
        ...
        if (colorStateList == null) {
            com.google.firebase.messaging.n nVar2 = this.f14480g;
            if (nVar2 != null) {
                colorStateList2 = nVar2.t(context, i10);
            }
            if (colorStateList2 != null) {
                if (this.f14476a == null) {
                    this.f14476a = new WeakHashMap();
                }
                a0.n nVar3 = (a0.n) this.f14476a.get(context);
                if (nVar3 == null) {
                    nVar3 = new a0.n();
                    this.f14476a.put(context, nVar3);
                }
    ...
    public final Drawable k(Context context, int i10) {
        int next;
        a0.m mVar = this.f14477b;
        if (mVar != null && !mVar.isEmpty()) {
            a0.n nVar = this.f14478c;
            if (nVar != null) {
                String str = (String) nVar.c(i10);
                if (!"appcompat_skip_skip".equals(str)) {
                    if (str != null && this.f14477b.get(str) == null) {
                        return null;
                    }
                } else {
                    return null;
            ...
            if (charSequence != null && charSequence.toString().endsWith(".xml")) {
                try {
                    ...
                    if (next == 2) {
                        ...
                        this.f14478c.a(i10, name);
                        l2 l2Var = (l2) this.f14477b.get(name);
                        if (l2Var != null) {
            ...
            if (e == null) {
                this.f14478c.a(i10, "appcompat_skip_skip");
            }
            return e;
        }
        return null;
