...
public final class m2 {
    public static m2 f14479i;
    public WeakHashMap f14481a;
    public a0.m f14482b;
    public a0.n f14483c;
    public final WeakHashMap d = new WeakHashMap(0);
    public TypedValue e;
    public boolean f14484f;
    public com.google.firebase.messaging.n f14485g;
    public static final PorterDuff.Mode h = PorterDuff.Mode.SRC_IN;
    public static final k2 f14480j = new a0.k(6);
    ...
    public final void a(String str, l2 l2Var) {
        if (this.f14482b == null) {
            this.f14482b = new a0.m(0);
        }
        this.f14482b.put(str, l2Var);
    }
    ...
    public final synchronized ColorStateList i(Context context, int i10) {
        ...
        a0.n nVar;
        WeakHashMap weakHashMap = this.f14481a;
        ...
        if (colorStateList == null) {
            com.google.firebase.messaging.n nVar2 = this.f14485g;
            if (nVar2 != null) {
                colorStateList2 = nVar2.t(context, i10);
            }
            if (colorStateList2 != null) {
                if (this.f14481a == null) {
                    this.f14481a = new WeakHashMap();
                }
                a0.n nVar3 = (a0.n) this.f14481a.get(context);
                if (nVar3 == null) {
                    nVar3 = new a0.n();
                    this.f14481a.put(context, nVar3);
                }
    ...
    public final Drawable k(Context context, int i10) {
        int next;
        a0.m mVar = this.f14482b;
        if (mVar != null && !mVar.isEmpty()) {
            a0.n nVar = this.f14483c;
            if (nVar != null) {
                String str = (String) nVar.c(i10);
                if (!"appcompat_skip_skip".equals(str)) {
                    if (str != null && this.f14482b.get(str) == null) {
                        return null;
                    }
                } else {
                    return null;
            ...
            if (charSequence != null && charSequence.toString().endsWith(".xml")) {
                try {
                    ...
                    if (next == 2) {
                        ...
                        this.f14483c.a(i10, name);
                        l2 l2Var = (l2) this.f14482b.get(name);
                        if (l2Var != null) {
            ...
            if (e == null) {
                this.f14483c.a(i10, "appcompat_skip_skip");
            }
            return e;
        }
        return null;
