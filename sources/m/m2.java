...
public final class m2 {
    ...
    public final synchronized ColorStateList i(Context context, int i10) {
        ...
        if (colorStateList == null) {
            com.google.firebase.messaging.n nVar = this.f14232g;
            if (nVar != null) {
            ...
            if (colorStateList2 != null) {
                ...
                a0.m mVar2 = (a0.m) this.f14228a.get(context);
                if (mVar2 == null) {
                    mVar2 = new a0.m();
                    this.f14228a.put(context, mVar2);
                }
    ...
    public final Drawable k(Context context, int i10) {
        int next;
        a0.l lVar = this.f14229b;
        if (lVar != null && !lVar.isEmpty()) {
            a0.m mVar = this.f14230c;
            if (mVar != null) {
