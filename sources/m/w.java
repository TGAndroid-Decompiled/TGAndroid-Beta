...
public final class w extends MultiAutoCompleteTextView implements u0.k {
    ...
    public final e2.c f15711a;
    public final w0 f15712b;
    public final y f15713c;

    public w(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, 2130968624);
        b3.a(context);
        a3.a(this, getContext());
        aa.a y3 = aa.a.y(getContext(), attributeSet, d, 2130968624);
        if (((TypedArray) y3.f384c).hasValue(0)) {
    ...
    public final void drawableStateChanged() {
        ...
        e2.c cVar = this.f15711a;
        if (cVar != null) {
            cVar.b();
        }
        w0 w0Var = this.f15712b;
        if (w0Var != null) {
            w0Var.b();
        }
    }
    ...
    public final InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        return this.f15713c.c(onCreateInputConnection, editorInfo);
    }
    ...
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f15713c.a(keyListener));
    }
