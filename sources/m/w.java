...
public final class w extends MultiAutoCompleteTextView implements u0.k {
    ...
    public final e2.c f14513a;
    public final w0 f14514b;
    public final y f14515c;
    ...
    public w(Context context, AttributeSet attributeSet) {
        ...
        if (((TypedArray) Q.f14180c).hasValue(0)) {
    ...
    public final void drawableStateChanged() {
        ...
        e2.c cVar = this.f14513a;
        if (cVar != null) {
            cVar.b();
        }
        w0 w0Var = this.f14514b;
        if (w0Var != null) {
            w0Var.b();
        }
    }
    ...
    public final InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        return this.f14515c.c(onCreateInputConnection, editorInfo);
    }
    ...
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f14515c.a(keyListener));
    }
