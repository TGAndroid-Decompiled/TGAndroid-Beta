...
public final class w extends MultiAutoCompleteTextView implements u0.k {
    ...
    public final e2.c f14328a;
    public final w0 f14329b;
    public final y f14330c;
    ...
    public w(Context context, AttributeSet attributeSet) {
        ...
        if (((TypedArray) P.f14166c).hasValue(0)) {
    ...
    public final void drawableStateChanged() {
        ...
        e2.c cVar = this.f14328a;
        if (cVar != null) {
            cVar.b();
        }
        w0 w0Var = this.f14329b;
        if (w0Var != null) {
            w0Var.b();
        }
    }
    ...
    public final InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        return this.f14330c.c(onCreateInputConnection, editorInfo);
    }
    ...
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f14330c.a(keyListener));
    }
