...
public final class p0 extends Spinner {
    public static final int[] f14266r = {16843505};
    public final e2.c f14267a;
    public final Context f14268b;
    public final e0 f14269c;
    public SpinnerAdapter d;
    public final boolean e;
    public final o0 f14270f;
    public int h;
    public final Rect f14271n;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f14270f != null && View.MeasureSpec.getMode(i10) == Integer.MIN_VALUE) {
    ...
    public final void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (n0Var.f14248a && (viewTreeObserver = getViewTreeObserver()) != null) {
    ...
    public final Parcelable onSaveInstanceState() {
        ...
        baseSavedState.f14248a = z10;
        return baseSavedState;
    }

    @Override
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        e0 e0Var = this.f14269c;
