...
public final class p0 extends Spinner {
    public static final int[] f14284r = {16843505};
    public final e2.c f14285a;
    public final Context f14286b;
    public final e0 f14287c;
    public SpinnerAdapter d;
    public final boolean e;
    public final o0 f14288f;
    public int h;
    public final Rect f14289n;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f14288f != null && View.MeasureSpec.getMode(i10) == Integer.MIN_VALUE) {
    ...
    public final void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (n0Var.f14258a && (viewTreeObserver = getViewTreeObserver()) != null) {
    ...
    public final Parcelable onSaveInstanceState() {
        ...
        baseSavedState.f14258a = z10;
        return baseSavedState;
    }

    @Override
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        e0 e0Var = this.f14287c;
