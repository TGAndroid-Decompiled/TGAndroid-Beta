...
public final class p0 extends Spinner {
    public static final int[] f14459r = {16843505};
    public final e2.c f14460a;
    public final Context f14461b;
    public final e0 f14462c;
    public SpinnerAdapter d;
    public final boolean e;
    public final o0 f14463f;
    public int h;
    public final Rect f14464n;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f14463f != null && View.MeasureSpec.getMode(i10) == Integer.MIN_VALUE) {
    ...
    public final void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (n0Var.f14433a && (viewTreeObserver = getViewTreeObserver()) != null) {
    ...
    public final Parcelable onSaveInstanceState() {
        ...
        baseSavedState.f14433a = z10;
        return baseSavedState;
    }

    @Override
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        e0 e0Var = this.f14462c;
