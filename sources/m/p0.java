...
public final class p0 extends Spinner {
    public static final int[] f14262r = {16843505};
    public final e2.c f14263a;
    public final Context f14264b;
    public final e0 f14265c;
    public SpinnerAdapter d;
    public final boolean e;
    public final o0 f14266f;
    public int h;
    public final Rect f14267n;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f14266f != null && View.MeasureSpec.getMode(i10) == Integer.MIN_VALUE) {
    ...
    public final void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (n0Var.f14236a && (viewTreeObserver = getViewTreeObserver()) != null) {
    ...
    public final Parcelable onSaveInstanceState() {
        ...
        baseSavedState.f14236a = z10;
        return baseSavedState;
    }

    @Override
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        e0 e0Var = this.f14265c;
