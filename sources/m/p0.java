...
public final class p0 extends Spinner {
    public static final int[] f14272r = {16843505};
    public final e2.c f14273a;
    public final Context f14274b;
    public final e0 f14275c;
    public SpinnerAdapter d;
    public final boolean e;
    public final o0 f14276f;
    public int h;
    public final Rect f14277n;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f14276f != null && View.MeasureSpec.getMode(i10) == Integer.MIN_VALUE) {
    ...
    public final void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (n0Var.f14246a && (viewTreeObserver = getViewTreeObserver()) != null) {
    ...
    public final Parcelable onSaveInstanceState() {
        ...
        baseSavedState.f14246a = z10;
        return baseSavedState;
    }

    @Override
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        e0 e0Var = this.f14275c;
