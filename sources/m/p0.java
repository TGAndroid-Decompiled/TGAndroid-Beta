...
public final class p0 extends Spinner {
    public static final int[] f14515r = {16843505};
    public final e2.c f14516a;
    public final Context f14517b;
    public final e0 f14518c;
    public SpinnerAdapter d;
    public final boolean e;
    public final o0 f14519f;
    public int h;
    public final Rect f14520n;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f14519f != null && View.MeasureSpec.getMode(i10) == Integer.MIN_VALUE) {
    ...
    public final void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (n0Var.f14489a && (viewTreeObserver = getViewTreeObserver()) != null) {
    ...
    public final Parcelable onSaveInstanceState() {
        ...
        baseSavedState.f14489a = z10;
        return baseSavedState;
    }

    @Override
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        e0 e0Var = this.f14518c;
