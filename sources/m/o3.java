...
public final class o3 implements View.OnLongClickListener, View.OnHoverListener, View.OnAttachStateChangeListener {
    ...
    public final n3 f15642e = new Runnable(this) {
        public final o3 f15628b;
    ...
    public o3(View view, CharSequence charSequence) {
        ...
        Method method = r0.j0.f44731a;
        if (Build.VERSION.SDK_INT >= 28) {
            scaledTouchSlop = b5.d.o(viewConfiguration);
        } else {
            scaledTouchSlop = viewConfiguration.getScaledTouchSlop() / 2;
        }
        this.f15641c = scaledTouchSlop;
        this.f15646s = true;
    ...
    public static void b(o3 o3Var) {
        o3 o3Var2 = v;
        if (o3Var2 != null) {
            o3Var2.f15639a.removeCallbacks(o3Var2.d);
        }
        v = o3Var;
        if (o3Var != null) {
            o3Var.f15639a.postDelayed(o3Var.d, ViewConfiguration.getLongPressTimeout());
        }
    }
    ...
    public final void a() {
        ...
        if (o3Var == this) {
            f15638w = null;
            p3 p3Var = this.f15644n;
            if (p3Var != null) {
                View view2 = (View) p3Var.f15662b;
                if (view2.getParent() != null) {
                    ((WindowManager) ((Context) p3Var.f15661a).getSystemService("window")).removeView(view2);
                }
                this.f15644n = null;
                this.f15646s = true;
        ...
        view.removeCallbacks(this.f15642e);
    }
    ...
    public final void c(boolean z10) {
        ...
        obj.d = layoutParams;
        obj.f15664e = new Rect();
        obj.f15665f = new int[2];
        obj.h = new int[2];
        obj.f15661a = context;
        View inflate = LayoutInflater.from(context).inflate(2131492891, (ViewGroup) null);
        obj.f15662b = inflate;
        obj.f15663c = (TextView) inflate.findViewById(2131296513);
        ...
        View view2 = (View) obj.f15662b;
        Context context2 = (Context) obj.f15661a;
        this.f15644n = obj;
        int i15 = this.f15643f;
        int i16 = this.h;
        boolean z12 = this.f15645r;
        WindowManager.LayoutParams layoutParams2 = (WindowManager.LayoutParams) obj.d;
        if (view2.getParent() != null && view2.getParent() != null) {
            ((WindowManager) context2.getSystemService("window")).removeView(view2);
        }
        ((TextView) obj.f15663c).setText(this.f15640b);
        int[] iArr = (int[]) obj.h;
        int[] iArr2 = (int[]) obj.f15665f;
        Rect rect = (Rect) obj.f15664e;
