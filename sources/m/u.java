...
public class u extends ImageButton {
    public final e2.c f13152a;
    public final j6.l f13153b;
    ...
    public final void drawableStateChanged() {
        ...
        e2.c cVar = this.f13152a;
        if (cVar != null) {
            cVar.b();
        }
        j6.l lVar = this.f13153b;
        if (lVar != null) {
            lVar.b();
        }
    }
    ...
    public final boolean hasOverlappingRendering() {
        if (!(((ImageView) this.f13153b.f11802b).getBackground() instanceof RippleDrawable) && super.hasOverlappingRendering()) {
            return true;
        }
        return false;
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        j6.l lVar = this.f13153b;
        if (lVar != null && drawable != null && !this.f13154c) {
