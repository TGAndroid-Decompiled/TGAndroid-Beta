...
public abstract class x1 extends ViewGroup {
    ...
    public x1(Context context, AttributeSet attributeSet, int i10) {
        ...
        r0.j0.j(this, context, iArr, attributeSet, (TypedArray) y10.f11677c, i10);
        ...
        this.f13682b = typedArray.getInt(3, -1);
        this.f13685n = typedArray.getBoolean(7, false);
        setDividerDrawable(y10.t(5));
        this.f13690y = typedArray.getInt(8, 0);
        this.B = typedArray.getDimensionPixelSize(6, 0);
        y10.A();
    }

    public final void c(Canvas canvas, int i10) {
        this.v.setBounds(getPaddingLeft() + this.B, i10, (getWidth() - getPaddingRight()) - this.B, this.f13689x + i10);
        this.v.draw(canvas);
    }
    ...
    public final void d(Canvas canvas, int i10) {
        this.v.setBounds(i10, getPaddingTop() + this.B, this.f13688w + i10, (getHeight() - getPaddingBottom()) - this.B);
        this.v.draw(canvas);
    }
    ...
    public int getBaseline() {
        ...
        if (childCount > i11) {
            ...
            int i12 = this.f13683c;
            if (this.d == 1 && (i10 = this.e & 112) != 48) {
                if (i10 != 16) {
                    if (i10 == 80) {
                        i12 = ((getBottom() - getTop()) - getPaddingBottom()) - this.f13684f;
                    }
                } else {
                    i12 = kh.a2.d(((getBottom() - getTop()) - getPaddingTop()) - getPaddingBottom(), this.f13684f, 2, i12);
                }
            }
            ...
            if (this.d == 1) {
                ...
                while (i11 < virtualChildCount) {
                    ...
                    if (childAt != null && childAt.getVisibility() != 8 && h(i11)) {
                        c(canvas, (childAt.getTop() - ((LinearLayout.LayoutParams) ((w1) childAt.getLayoutParams())).topMargin) - this.f13689x);
                    }
                    i11++;
                }
                if (h(virtualChildCount)) {
                    ...
                    if (childAt2 == null) {
                        bottom = (getHeight() - getPaddingBottom()) - this.f13689x;
                    } else {
            ...
            while (i11 < virtualChildCount2) {
                ...
                if (childAt3 != null && childAt3.getVisibility() != 8 && h(i11)) {
                    ...
                    if (a2) {
                        ...
                        left2 = (childAt3.getLeft() - ((LinearLayout.LayoutParams) w1Var).leftMargin) - this.f13688w;
                    }
                    d(canvas, left2);
                }
                i11++;
    ...
    public void setDividerDrawable(Drawable drawable) {
        ...
        boolean z4 = false;
        if (drawable != null) {
            this.f13688w = drawable.getIntrinsicWidth();
            this.f13689x = drawable.getIntrinsicHeight();
        } else {
            this.f13688w = 0;
            this.f13689x = 0;
        }
