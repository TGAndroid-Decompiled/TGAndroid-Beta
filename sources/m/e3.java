...
import v7.y7;
import w7.f6;
public class e3 implements ek0, zq0, n5.b, t0.i, ja.a {
    ...
    public static n2.e x(b2.c0 c0Var) {
        ...
        UUID uuid = b2.i.f3012a;
        qb.b bVar = new qb.b(26);
        UUID uuid2 = c0Var.f2946a;
        uuid2.getClass();
        boolean z13 = c0Var.d;
        boolean z14 = c0Var.e;
        int[] f7 = y7.f(c0Var.f2950g);
        for (int i10 : f7) {
            if (i10 != 2 && i10 != 1) {
                z11 = false;
            } else {
        ...
        e2.d.g(eVar.f14896w.isEmpty());
        eVar.K = bArr;
        return eVar;
    }

    public View A(int i10) {
        return ((RecyclerView) ((k2.c0) this.f14165b).f13234b).getChildAt(I(i10));
    }

    public int B() {
        return ((RecyclerView) ((k2.c0) this.f14165b).f13234b).getChildCount() - ((ArrayList) this.d).size();
    }

    public ColorStateList C(int i10) {
        int resourceId;
        ColorStateList a2;
        TypedArray typedArray = (TypedArray) this.f14166c;
        if (typedArray.hasValue(i10) && (resourceId = typedArray.getResourceId(i10, 0)) != 0 && (a2 = v7.a((Context) this.f14165b, resourceId)) != null) {
            return a2;
        }
    ...
    public Drawable E(int i10) {
        ...
        if (typedArray.hasValue(i10) && (resourceId = typedArray.getResourceId(i10, 0)) != 0) {
            return v7.b((Context) this.f14165b, resourceId);
        }
    ...
    public Drawable F(int i10) {
        int resourceId;
        Drawable f7;
        if (((TypedArray) this.f14166c).hasValue(i10) && (resourceId = ((TypedArray) this.f14166c).getResourceId(i10, 0)) != 0) {
            q a2 = q.a();
            Context context = (Context) this.f14165b;
            synchronized (a2) {
                f7 = a2.f14284a.f(resourceId, context, true);
            }
            return f7;
        }
        return null;
    ...
    public Typeface G(int i10, int i11, e2.a0 a0Var) {
        ...
        int resourceId = ((TypedArray) this.f14166c).getResourceId(i10, 0);
        if (resourceId != 0) {
            ...
            ThreadLocal threadLocal = h0.k.f10063a;
            if (!context.isRestricted()) {
                ...
                if (charSequence != null) {
                    ...
                    a0.k kVar = i0.e.f10595b;
                    Typeface typeface = (Typeface) kVar.a(i0.e.b(resources, resourceId, charSequence2, i12, i11));
                    if (typeface != null) {
                        new Handler(Looper.getMainLooper()).post(new gg.x1(1, a0Var, typeface));
                        return typeface;
                    }
                    try {
                    } catch (IOException e) {
                    ...
                    try {
                        ...
                        Typeface e12 = i0.e.f10594a.e(context, resources, resourceId, charSequence2, i11);
                        if (e12 != null) {
                            kVar.b(i0.e.b(resources, resourceId, charSequence2, i13, i11), e12);
                        }
                        if (e12 != null) {
                            new Handler(Looper.getMainLooper()).post(new gg.x1(1, a0Var, e12));
                        } else {
                            a0Var.b();
                        }
                        return e12;
    ...
    public ByteBuffer H() {
        ...
        return (ByteBuffer) this.f14166c;
    }

    public int I(int i10) {
        e6.n nVar = (e6.n) this.f14166c;
        if (i10 < 0) {
            return -1;
        }
        int childCount = ((RecyclerView) ((k2.c0) this.f14165b).f13234b).getChildCount();
        int i11 = i10;
    ...
    public View J(int i10) {
        return ((RecyclerView) ((k2.c0) this.f14165b).f13234b).getChildAt(i10);
    }

    public int K() {
        return ((RecyclerView) ((k2.c0) this.f14165b).f13234b).getChildCount();
    }

    public boolean L() {
        String trim;
        ArrayDeque arrayDeque = (ArrayDeque) this.f14166c;
        ...
        do {
            String readLine = ((BufferedReader) this.f14165b).readLine();
            this.d = readLine;
            if (readLine != null) {
                trim = readLine.trim();
                this.d = trim;
    ...
    public void M(View view) {
        ...
        k2.c0 c0Var = (k2.c0) this.f14165b;
        s4.c1 U = RecyclerView.U(view);
        if (U != null) {
            View view2 = U.f42675a;
            RecyclerView recyclerView = (RecyclerView) c0Var.f13234b;
            int i10 = U.f42690s;
            if (i10 != -1) {
                U.f42689r = i10;
            } else {
                WeakHashMap weakHashMap = r0.i0.f41843a;
                U.f42689r = view2.getImportantForAccessibility();
            }
            if (recyclerView.b0()) {
                U.f42690s = 4;
    ...
    public void N(g2.h r8, android.net.Uri r9, java.util.Map r10, long r11, long r13, u2.u0 r15) {
        throw new UnsupportedOperationException("Method not decompiled: m.e3.N(g2.h, android.net.Uri, java.util.Map, long, long, u2.u0):void");
    }
    ...
    public void Q() {
        ((TypedArray) this.f14166c).recycle();
    }

    public void R() {
        int i10;
        RecyclerView recyclerView = (RecyclerView) ((k2.c0) this.f14165b).f13234b;
        ((e6.n) this.f14166c).C();
    ...
    public void S(of.g gVar) {
        if (((of.d) this.f14165b) != null) {
            for (int i10 = 0; i10 < gVar.f15532a.size(); i10++) {
                of.d dVar = (of.d) this.f14165b;
    ...
    public void U(l5.i iVar, int i10, boolean z10) {
        ...
        String str = iVar.f13897a;
        String str2 = iVar.f13897a;
        adler32.update(str.getBytes(Charset.forName("UTF-8")));
        ByteBuffer allocate = ByteBuffer.allocate(4);
        i5.d dVar = iVar.f13899c;
        adler32.update(allocate.putInt(v5.a.a(dVar)).array());
        byte[] bArr = iVar.f13898b;
        if (bArr != null) {
            adler32.update(bArr);
        }
        ...
        Cursor rawQuery = ((s5.g) ((s5.d) this.f14166c)).a().rawQuery("SELECT next_request_ms FROM transport_contexts WHERE backend_name = ? and priority = ?", new String[]{str2, String.valueOf(v5.a.a(dVar))});
        try {
            ...
            Set set = ((r5.b) aVar.f42041b.get(dVar)).f42044c;
            if (set.contains(r5.c.f42045a)) {
                builder.setRequiredNetworkType(2);
            } else {
                builder.setRequiredNetworkType(1);
            }
            if (set.contains(r5.c.f42047c)) {
                builder.setRequiresCharging(true);
            }
            if (set.contains(r5.c.f42046b)) {
    ...
    public void V(of.a aVar) {
        of.g gVar;
        of.g gVar2 = (of.g) this.f14166c;
        if (gVar2 != null && ((of.a) this.d) == null && aVar != null) {
            r(gVar2);
        }
        if (((of.a) this.d) != null && (gVar = (of.g) this.f14166c) != null && aVar == null) {
            S(gVar);
        }
        of.a aVar2 = (of.a) this.d;
        if (aVar2 != null) {
            e6.h hVar = aVar2.f15505a;
            n6.l.e("Must be called from the main thread.");
            hVar.f8014i.remove(aVar2);
        }
        if (aVar != null) {
            aVar.f15505a.p(aVar);
            of.g gVar3 = (of.g) this.f14166c;
            if (gVar3 != null) {
                aVar.d = gVar3;
                aVar.f15509g = 0;
                aVar.h = 0;
    ...
    public FileOutputStream W() {
        File file = (File) this.f14166c;
        File file2 = (File) this.d;
        if (file2.exists()) {
            T(file2, (File) this.f14165b);
        }
        try {
    ...
    public Object mo28get() {
        return new e3((Context) ((fd.a) this.f14165b).mo28get(), (s5.d) ((fd.a) this.f14166c).mo28get(), (r5.a) ((qb.b) this.d).mo28get(), 23);
    }

    @Override
    public ClipDescription getDescription() {
        return (ClipDescription) this.f14166c;
    }

    @Override
    public void h(android.view.View r13, zg.p0 r14, boolean r15, boolean r16) {
        throw new UnsupportedOperationException("Method not decompiled: m.e3.h(android.view.View, zg.p0, boolean, boolean):void");
    }
    ...
    public void i(int i10, boolean z10, boolean z11) {
        ...
        if (!z10) {
            ok okVar = (ok) this.d;
            HashMap hashMap = (HashMap) this.f14165b;
            ArrayList arrayList = (ArrayList) this.f14166c;
    ...
    public ja.a m(Class cls, ia.d dVar) {
        ((HashMap) this.f14165b).put(cls, dVar);
        ((HashMap) this.f14166c).remove(cls);
        return this;
    }
    ...
    public void s(View view, int i10, boolean z10) {
        ...
        s4.h0 h0Var = recyclerView.f2861w;
    ...
    public void t(View view, int i10, ViewGroup.LayoutParams layoutParams, boolean z10) {
        ...
        RecyclerView.c(recyclerView, view, I, layoutParams);
    }
    ...
    public String toString() {
        switch (this.f14164a) {
            case 7:
                ...
                sb2.append((String) this.f14165b);
                sb2.append('{');
                e3 e3Var = (e3) ((e3) this.f14166c).d;
                String str = "";
                while (e3Var != null) {
                ...
                return sb2.toString();
            case 24:
                return ((e6.n) this.f14166c).toString() + ", hidden list:" + ((ArrayList) this.d).size();
            default:
    ...
    public String u(int i10, String str, long j3, long j10) {
        ArrayList arrayList = (ArrayList) this.f14165b;
        ArrayList arrayList2 = (ArrayList) this.d;
        ArrayList arrayList3 = (ArrayList) this.f14166c;
    ...
    public void v() {
        android.support.v4.media.session.b0 b0Var = (android.support.v4.media.session.b0) this.f14165b;
        if (b0Var != null) {
            int i10 = ((p4.e) this.d).f40562n.d;
            android.support.v4.media.session.v vVar = b0Var.f1833a;
            vVar.getClass();
            AudioAttributes.Builder builder = new AudioAttributes.Builder();
            builder.setLegacyStreamType(i10);
            vVar.f1855a.setPlaybackToLocal(builder.build());
            this.f14166c = null;
        }
    }
    ...
    public n2.m z(b2.k0 k0Var) {
        n2.e eVar;
        k0Var.f3073b.getClass();
        b2.c0 c0Var = k0Var.f3073b.f2990c;
        if (c0Var == null) {
            return n2.m.f14909z;
        }
        synchronized (this.f14165b) {
            try {
                if (!c0Var.equals((b2.c0) this.f14166c)) {
                    this.f14166c = c0Var;
                    this.d = x(c0Var);
                }
                eVar = (n2.e) this.d;
    ...
    public e3(k2.c0 c0Var) {
        this.f14164a = 24;
        this.f14165b = c0Var;
        this.f14166c = new e6.n(6);
    ...
    public e3(File file) {
        this.f14164a = 19;
        this.f14165b = file;
        this.f14166c = new File(file.getPath() + ".new");
    ...
    public e3(Runnable runnable) {
        this.f14164a = 22;
        this.f14166c = new CopyOnWriteArrayList();
        this.d = new HashMap();
        this.f14165b = runnable;
    }

    public e3(Context context, TypedArray typedArray) {
        this.f14164a = 0;
        this.f14165b = context;
        this.f14166c = typedArray;
    }
    ...
    public e3(ka.c cVar) {
        ...
        this.f14164a = 9;
        this.f14165b = cVar;
        this.f14166c = Choreographer.getInstance();
    ...
    public e3(ArrayDeque arrayDeque, BufferedReader bufferedReader) {
        this.f14164a = 17;
        this.f14166c = arrayDeque;
        this.f14165b = bufferedReader;
    }
