...
public final class h extends t {
    public final b e;
    public final AtomicReferenceArray f14923f;

    public h(long j10, h hVar, b bVar, int i10) {
        super(j10, hVar, i10);
        this.e = bVar;
        this.f14923f = new AtomicReferenceArray(d.f14907b * 2);
    }
    ...
    public final boolean k(int i10, Object obj, Object obj2) {
        ...
        int i11 = (i10 * 2) + 1;
        do {
            atomicReferenceArray = this.f14923f;
    ...
    public final Object l(int i10) {
        return this.f14923f.get((i10 * 2) + 1);
    }
    ...
    public final void m(int i10, boolean z4) {
        if (z4) {
            ...
            bVar.q((this.f43071c * d.f14907b) + i10);
        }
        i();
    }

    public final void n(int i10, m mVar) {
        this.f14923f.set(i10 * 2, mVar);
    }

    public final void o(int i10, Object obj) {
        this.f14923f.set((i10 * 2) + 1, obj);
    }
}
