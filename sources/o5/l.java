...
public final class l extends a7.c {
        ...
        switch (i11) {
            case 0:
                ...
                if (i10 != 1) {
                    ...
                    if (b10 != null) {
                        t0 t0Var = a10.h;
                        Context context = a10.f2852a;
                        if (a10.h() == 3) {
                            z4 = true;
                        } else {
                            z4 = false;
                        }
                        h.f16614a.g("Revoking access", new Object[0]);
                        ...
                        if (z4) {
                            if (d11 == null) {
                                ...
                                basePendingResult = cVar.f16602b;
                            }
                        } else {
                            g gVar = new g(t0Var, 1);
                            t0Var.f2816b.d(1, gVar);
            ...
            default:
                ...
                w6.f.b(parcel);
                p5.a((Status) w6.f.a(parcel, Status.CREATOR), (l5.f) w6.f.a(parcel, l5.f.CREATOR), (TaskCompletionSource) obj);
                return true;
        }
    }

    public void J0() {
        if (i6.b.e((RevocationBoundService) this.f16619c, Binder.getCallingUid())) {
            return;
        }
    ...
    public l(TaskCompletionSource taskCompletionSource) {
        ...
        this.f16619c = taskCompletionSource;
    }
}
