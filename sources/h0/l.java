...
public final class l {
    ...
    static {
        ...
        float f17 = 1.0f / ((5.0f * j10) + 1.0f);
        float C = com.google.android.recaptcha.internal.a.C(f17, f17, f17, f17);
        float f18 = 1.0f - C;
        float cbrt = (0.1f * f18 * f18 * ((float) Math.cbrt(j10 * 5.0d))) + (C * j10);
        ...
        f7493k = new l(j11, com.google.android.recaptcha.internal.a.B(fArr8[2], 0.05f, (fArr8[0] * 2.0f) + fArr8[1], pow), pow, pow, f9, 1.0f, fArr6, cbrt, (float) Math.pow(cbrt, 0.25d), sqrt);
    }
