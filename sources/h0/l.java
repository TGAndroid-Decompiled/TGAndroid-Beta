...
public final class l {
    ...
    static {
        ...
        float[] fArr = b.f10035c;
        float f10 = fArr[0];
        float[][] fArr2 = b.f10033a;
        float[] fArr3 = fArr2[0];
        float f11 = fArr[1];
        ...
        f10053k = new l(j10, e2.B(fArr8[2], 0.05f, (fArr8[0] * 2.0f) + fArr8[1], pow), pow, pow, f7, 1.0f, fArr6, cbrt, (float) Math.pow(cbrt, 0.25d), sqrt);
    }
