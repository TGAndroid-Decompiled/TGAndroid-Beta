...
public final class a {
    ...
    public static a a(int i10) {
        ...
        float[] fArr9 = lVar.f6868g;
        float f18 = lVar.f6869i;
        float f19 = lVar.d;
        float f20 = lVar.f6864a;
        ...
        float pow5 = ((float) Math.pow((f28 * lVar.f6865b) / f20, lVar.f6870j * f19)) * 100.0f;
        ...
        float pow6 = ((float) Math.pow(1.64d - Math.pow(0.29d, lVar.f6867f), 0.73d)) * ((float) Math.pow((((((((float) (Math.cos(((f10 * 3.141592653589793d) / 180.0d) + 2.0d) + 3.8d)) * 0.25f) * 3846.1538f) * lVar.e) * lVar.f6866c) * ((float) Math.sqrt((f26 * f26) + (f25 * f25)))) / (v + 0.305f), 0.9d)) * ((float) Math.sqrt(pow5 / 100.0d));
    ...
    public static a b(float f10, float f11, float f12) {
        l lVar;
        double d;
        float f13 = l.f6863k.d;
        Math.sqrt(f10 / 100.0d);
        Math.sqrt(((f11 / ((float) Math.sqrt(d))) * lVar.d) / (lVar.f6864a + 4.0f));
        float f14 = (1.7f * f10) / ((0.007f * f10) + 1.0f);
        float log = ((float) Math.log((lVar.f6869i * f11 * 0.0228d) + 1.0d)) * 43.85965f;
    ...
    public final int c(l lVar) {
        ...
        float f12 = this.f6841c;
        if (f11 != 0.0d) {
            double d = f12;
            if (d != 0.0d) {
                f10 = f11 / ((float) Math.sqrt(d / 100.0d));
                float f13 = lVar.f6867f;
                float f14 = lVar.h;
                float pow = (float) Math.pow(f10 / Math.pow(1.64d - Math.pow(0.29d, f13), 0.73d), 1.1111111111111112d);
                double d10 = (this.f6839a * 3.1415927f) / 180.0f;
                float pow2 = lVar.f6864a * ((float) Math.pow(f12 / 100.0d, (1.0d / lVar.d) / lVar.f6870j));
                float cos = ((float) (Math.cos(2.0d + d10) + 3.8d)) * 0.25f * 3846.1538f * lVar.e * lVar.f6866c;
                float f15 = pow2 / lVar.f6865b;
        ...
        f10 = 0.0f;
        float f132 = lVar.f6867f;
        float f142 = lVar.h;
        float pow3 = (float) Math.pow(f10 / Math.pow(1.64d - Math.pow(0.29d, f132), 0.73d), 1.1111111111111112d);
        double d102 = (this.f6839a * 3.1415927f) / 180.0f;
        float pow22 = lVar.f6864a * ((float) Math.pow(f12 / 100.0d, (1.0d / lVar.d) / lVar.f6870j));
        float cos3 = ((float) (Math.cos(2.0d + d102) + 3.8d)) * 0.25f * 3846.1538f * lVar.e * lVar.f6866c;
        float f152 = pow22 / lVar.f6865b;
