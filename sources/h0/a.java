...
public final class a {
    ...
    public static a a(int i10) {
        ...
        float[] fArr9 = lVar.f10057g;
        float f17 = lVar.f10058i;
        float f18 = lVar.d;
        float f19 = lVar.f10053a;
        ...
        float pow5 = ((float) Math.pow((f27 * lVar.f10054b) / f19, lVar.f10059j * f18)) * 100.0f;
        ...
        float pow6 = ((float) Math.pow(1.64d - Math.pow(0.29d, lVar.f10056f), 0.73d)) * ((float) Math.pow((((((((float) (Math.cos(((f7 * 3.141592653589793d) / 180.0d) + 2.0d) + 3.8d)) * 0.25f) * 3846.1538f) * lVar.e) * lVar.f10055c) * ((float) Math.sqrt((f25 * f25) + (f24 * f24)))) / (y3 + 0.305f), 0.9d)) * ((float) Math.sqrt(pow5 / 100.0d));
    ...
    public static a b(float f7, float f10, float f11) {
        l lVar;
        double d;
        float f12 = l.f10052k.d;
        Math.sqrt(f7 / 100.0d);
        Math.sqrt(((f10 / ((float) Math.sqrt(d))) * lVar.d) / (lVar.f10053a + 4.0f));
        float f13 = (1.7f * f7) / ((0.007f * f7) + 1.0f);
        float log = ((float) Math.log((lVar.f10058i * f10 * 0.0228d) + 1.0d)) * 43.85965f;
    ...
    public final int c(l lVar) {
        float f7;
        float[] fArr;
        float f10 = this.f10029b;
        float f11 = this.f10030c;
        if (f10 != 0.0d) {
            double d = f11;
            if (d != 0.0d) {
                f7 = f10 / ((float) Math.sqrt(d / 100.0d));
                float f12 = lVar.f10056f;
                float f13 = lVar.h;
                float pow = (float) Math.pow(f7 / Math.pow(1.64d - Math.pow(0.29d, f12), 0.73d), 1.1111111111111112d);
                double d10 = (this.f10028a * 3.1415927f) / 180.0f;
                float pow2 = lVar.f10053a * ((float) Math.pow(f11 / 100.0d, (1.0d / lVar.d) / lVar.f10059j));
                float cos = ((float) (Math.cos(2.0d + d10) + 3.8d)) * 0.25f * 3846.1538f * lVar.e * lVar.f10055c;
                float f14 = pow2 / lVar.f10054b;
        ...
        f7 = 0.0f;
        float f122 = lVar.f10056f;
        float f132 = lVar.h;
        float pow3 = (float) Math.pow(f7 / Math.pow(1.64d - Math.pow(0.29d, f122), 0.73d), 1.1111111111111112d);
        double d102 = (this.f10028a * 3.1415927f) / 180.0f;
        float pow22 = lVar.f10053a * ((float) Math.pow(f11 / 100.0d, (1.0d / lVar.d) / lVar.f10059j));
        float cos3 = ((float) (Math.cos(2.0d + d102) + 3.8d)) * 0.25f * 3846.1538f * lVar.e * lVar.f10055c;
        float f142 = pow22 / lVar.f10054b;
