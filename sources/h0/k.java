...
public abstract class k {
    public static final ThreadLocal f10063a = new ThreadLocal();
    public static final WeakHashMap f10064b = new WeakHashMap(0);
    ...
    public static void a(j jVar, int i10, ColorStateList colorStateList, Resources.Theme theme) {
        synchronized (f10065c) {
            try {
                WeakHashMap weakHashMap = f10064b;
                SparseArray sparseArray = (SparseArray) weakHashMap.get(jVar);
                if (sparseArray == null) {
                    sparseArray = new SparseArray();
                    weakHashMap.put(jVar, sparseArray);
                }
                sparseArray.append(i10, new i(colorStateList, jVar.f10061a.getConfiguration(), theme));
            } catch (Throwable th2) {
                throw th2;
            }
        }
