    ...
    public final boolean J0(int i10, Parcel parcel, Parcel parcel2) {
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                ...
                if (gVar.C()) {
                    ...
                    synchronized (a2) {
                        if (nVar == null) {
                            ...
                            n nVar2 = (n) a2.f15292a;
                            if (nVar2 != null) {
                                if (nVar2.f15293a < nVar.f15293a) {
                                }
                            }
                        }
                        a2.f15292a = nVar;
                ...
                Bundle bundle = f0Var.f15250a;
                l.i(this.f15227b, "onPostInitComplete can be called only once per call to getRemoteService");
                this.f15227b.B(readInt, readStrongBinder, bundle, this.f15228c);
                this.f15227b = null;
            } else {
                parcel.readInt();
            ...
            m7.a.b(parcel);
            l.i(this.f15227b, "onPostInitComplete can be called only once per call to getRemoteService");
            this.f15227b.B(parcel.readInt(), parcel.readStrongBinder(), (Bundle) m7.a.a(parcel, Bundle.CREATOR), this.f15228c);
            this.f15227b = null;
        }
