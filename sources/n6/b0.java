    ...
    public final boolean J0(int i10, Parcel parcel, Parcel parcel2) {
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                ...
                if (gVar.C()) {
                    ...
                    synchronized (a2) {
                        if (nVar == null) {
                            ...
                            n nVar2 = (n) a2.f16577a;
                            if (nVar2 != null) {
                                if (nVar2.f16578a < nVar.f16578a) {
                                }
                            }
                        }
                        a2.f16577a = nVar;
                ...
                Bundle bundle = f0Var.f16531a;
                l.i(this.f16506b, "onPostInitComplete can be called only once per call to getRemoteService");
                this.f16506b.B(readInt, readStrongBinder, bundle, this.f16507c);
                this.f16506b = null;
            } else {
                parcel.readInt();
            ...
            m7.a.b(parcel);
            l.i(this.f16506b, "onPostInitComplete can be called only once per call to getRemoteService");
            this.f16506b.B(parcel.readInt(), parcel.readStrongBinder(), (Bundle) m7.a.a(parcel, Bundle.CREATOR), this.f16507c);
            this.f16506b = null;
        }
