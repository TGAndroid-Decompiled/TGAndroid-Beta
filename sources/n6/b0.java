    ...
    public final boolean J0(int i10, Parcel parcel, Parcel parcel2) {
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                ...
                if (gVar.C()) {
                    ...
                    synchronized (a2) {
                        if (nVar == null) {
                            ...
                            n nVar2 = (n) a2.f15069a;
                            if (nVar2 != null) {
                                if (nVar2.f15070a < nVar.f15070a) {
                                }
                            }
                        }
                        a2.f15069a = nVar;
                ...
                Bundle bundle = f0Var.f15027a;
                l.i(this.f15004b, "onPostInitComplete can be called only once per call to getRemoteService");
                this.f15004b.B(readInt, readStrongBinder, bundle, this.f15005c);
                this.f15004b = null;
            } else {
                parcel.readInt();
            ...
            m7.a.b(parcel);
            l.i(this.f15004b, "onPostInitComplete can be called only once per call to getRemoteService");
            this.f15004b.B(parcel.readInt(), parcel.readStrongBinder(), (Bundle) m7.a.a(parcel, Bundle.CREATOR), this.f15005c);
            this.f15004b = null;
        }
