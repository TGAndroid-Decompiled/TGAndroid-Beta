...
public final class a0 extends com.google.android.gms.internal.cast.c0 {
    ...
    public final void handleMessage(Message message) {
        Boolean bool;
        if (this.f14978a.R.get() != message.arg1) {
        ...
        if ((i11 != 1 && i11 != 7 && i11 != 4 && i11 != 5) || this.f14978a.g()) {
            ...
            if (i12 == 4) {
                ...
                g gVar4 = this.f14978a;
                k6.a aVar2 = gVar4.O;
                if (aVar2 == null) {
                    aVar2 = new k6.a(8);
                }
                gVar4.E.a(aVar2);
                this.f14978a.z(aVar2);
                return;
            } else if (i12 == 3) {
                ...
                this.f14978a.E.a(aVar3);
                this.f14978a.z(aVar3);
                return;
            } else if (i12 == 6) {
                this.f14978a.F(5, null);
                m mVar = this.f14978a.J;
                if (mVar != null) {
                    ((com.google.android.gms.common.api.k) mVar.f15044a).onConnectionSuspended(message.arg2);
                }
                this.f14978a.A(message.arg2);
                g.E(this.f14978a, 5, 1, null);
                return;
            } else if (i12 == 2 && !this.f14978a.j()) {
