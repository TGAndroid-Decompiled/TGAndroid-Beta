...
public final class v extends o6.a {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null) {
            if (this != obj) {
                if (obj instanceof v) {
                    v vVar = (v) obj;
                    if (this.f15096c.equals(vVar.f15096c)) {
                        Object obj2 = null;
                        IBinder iBinder = this.f15095b;
                        if (iBinder == null) {
                            aVar = null;
                        } else {
                            int i10 = a.f15002b;
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        w7.e0.f(parcel, 2, this.f15095b);
        w7.e0.k(parcel, 3, this.f15096c, i10);
        w7.e0.s(parcel, 4, 4);
