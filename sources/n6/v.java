...
public final class v extends o6.a {
    ...
    public final IBinder f15280b;
    public final k6.a f15281c;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null) {
            if (this != obj) {
                if (obj instanceof v) {
                    v vVar = (v) obj;
                    if (this.f15281c.equals(vVar.f15281c)) {
                        Object obj2 = null;
                        IBinder iBinder = this.f15280b;
                        if (iBinder == null) {
                            aVar = null;
                        } else {
                            int i10 = a.f15187b;
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        w7.f0.f(parcel, 2, this.f15280b);
        w7.f0.k(parcel, 3, this.f15281c, i10);
        w7.f0.s(parcel, 4, 4);
