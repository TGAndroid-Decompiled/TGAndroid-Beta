...
public final class v extends o6.a {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null) {
            if (this != obj) {
                if (obj instanceof v) {
                    v vVar = (v) obj;
                    if (this.f15319c.equals(vVar.f15319c)) {
                        Object obj2 = null;
                        IBinder iBinder = this.f15318b;
                        if (iBinder == null) {
                            aVar = null;
                        } else {
                            int i10 = a.f15225b;
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        w7.f0.f(parcel, 2, this.f15318b);
        w7.f0.k(parcel, 3, this.f15319c, i10);
        w7.f0.s(parcel, 4, 4);
