...
public abstract class g implements com.google.android.gms.common.api.c {
    ...
    public int d;
    public long e;
    public volatile String f15031f;
    public androidx.activity.n h;
    public final Context f15032n;
    public final Looper f15033r;
    public final j0 f15034s;
    public final a0 v;
    public final Object f15035w;
    public final Object f15036x;
    public y f15037y;
    ...
    public g(Context context, Looper looper, int i10, p3 p3Var, com.google.android.gms.common.api.k kVar, com.google.android.gms.common.api.l lVar, int i11) {
        ...
        this.f15031f = null;
        this.f15035w = new Object();
        this.f15036x = new Object();
        ...
        Set<Scope> set = (Set) p3Var.f14281b;
        for (Scope scope : set) {
                ...
                if (i10 != 1) {
                    if (i10 != 2 && i10 != 3) {
                        if (i10 == 4) {
                            ...
                            this.f15030c = System.currentTimeMillis();
                        }
                    } else {
                        c0 c0Var = this.H;
                        if (c0Var != null && (nVar = this.h) != null) {
                            Log.e("GmsClient", "Calling connect() while still connected, missing disconnect() for " + ((String) nVar.f1906c) + " on " + ((String) nVar.d));
                            j0 j0Var = this.f15034s;
                            String str = (String) this.h.f1906c;
                            l.h(str);
                            String str2 = (String) this.h.d;
                            if (this.M == null) {
                                this.f15032n.getClass();
                            }
                            j0Var.c(str, str2, c0Var, this.h.f1905b);
                        ...
                        if (y3 && l() < 17895000) {
                            throw new IllegalStateException("Internal Error, the minimum apk version of this BaseGmsClient is too low to support dynamic lookup. Start service action: ".concat(String.valueOf((String) this.h.f1906c)));
                        }
                        j0 j0Var2 = this.f15034s;
                        String str3 = (String) this.h.f1906c;
                        l.h(str3);
                        String str4 = (String) this.h.d;
                        String str5 = this.M;
                        if (str5 == null) {
                            str5 = this.f15032n.getClass().getName();
                        }
                        k6.a b10 = j0Var2.b(new g0(str3, str4, this.h.f1905b), c0Var2, str5);
                        if (!b10.c()) {
                            androidx.activity.n nVar2 = this.h;
                            Log.w("GmsClient", "unable to connect to service: " + ((String) nVar2.f1906c) + " on " + ((String) nVar2.d));
                            int i11 = b10.f13501b;
                            if (i11 == -1) {
                                i11 = 16;
                            }
                    ...
                    c0 c0Var3 = this.H;
                    if (c0Var3 != null) {
                        j0 j0Var3 = this.f15034s;
                        String str6 = (String) this.h.f1906c;
                        l.h(str6);
                        String str7 = (String) this.h.d;
                        if (this.M == null) {
                            this.f15032n.getClass();
                        }
                        j0Var3.c(str6, str7, c0Var3, this.h.f1905b);
                        this.H = null;
                    }
                }
            } finally {
    ...
    public final void b(h hVar, Set set) {
        ...
        fVar.d = this.f15032n.getPackageName();
        fVar.h = t10;
        if (set != null) {
            fVar.f15018f = (Scope[]) set.toArray(new Scope[0]);
        }
        if (p()) {
            fVar.f15019n = new Account("<<default account>>", "com.google");
            if (hVar != null) {
    ...
    public final void f(a6.m mVar) {
        ((p0) mVar.f307b).f6153o.f6098x.post(new q4(mVar, 15));
    }
    ...
    public final void h(String str, PrintWriter printWriter) {
        ...
        if (yVar == null) {
            ...
            printWriter.append("IGmsServiceBroker@").println(Integer.toHexString(System.identityHashCode(yVar.f15099a)));
        }
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS", Locale.US);
        if (this.f15030c > 0) {
            PrintWriter append = printWriter.append((CharSequence) str).append("lastConnectedTime=");
            long j3 = this.f15030c;
