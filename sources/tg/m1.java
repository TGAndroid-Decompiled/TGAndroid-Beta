...
public class m1 extends ab implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final j1 Y;
    public final h1 Z;
    public final i1 f43472a0;
    public final g1 f43473b0;
    public final np f43474c0;
    public final o20 f43475d0;
    public final FrameLayout f43476e0;
    public final ArrayList f43477f0;
    public final ArrayList f43478g0;
    public final HashSet f43479h0;
    public final ArrayList f43480i0;
    public final ArrayList f43481j0;
    public final ArrayList f43482k0;
    public final HashMap f43483l0;
    public final ArrayList m0;
    public final LinkedHashMap f43484n0;
    public String f43485o0;
    public ug.g f43486p0;
    public int f43487q0;
    public final ArrayList f43488r0;
    public boolean f43489s0;
    public float f43490t0;
    public cb0 f43491u0;
    public final BirthdayController.BirthdayState f43492v0;
    public final pg.c1 f43493w0;
    public int f43494x0;
    public pq f43495y0;
    public String f43496z0;
    ...
    public m1(Context context, int i10, BirthdayController.BirthdayState birthdayState, int i11, f6 f6Var) {
        ...
        float f7;
        boolean z10;
        this.f43477f0 = new ArrayList();
        ArrayList arrayList = new ArrayList();
        this.f43478g0 = arrayList;
        HashSet hashSet = new HashSet();
        this.f43479h0 = hashSet;
        this.f43480i0 = new ArrayList();
        this.f43481j0 = new ArrayList();
        this.f43482k0 = new ArrayList();
        this.f43483l0 = new HashMap();
        this.m0 = new ArrayList();
        this.f43484n0 = new LinkedHashMap();
        this.f43487q0 = AndroidUtilities.dp(120.0f);
        this.f43488r0 = new ArrayList();
        this.f43489s0 = false;
        this.f43493w0 = new pg.c1(this, 5);
        this.f43494x0 = -1;
        this.C0 = new HashSet();
        ...
        this.X = i11;
        this.f43492v0 = birthdayState;
        ug.g gVar = this.f43486p0;
        if (gVar != null) {
            if (i11 == 4) {
                z10 = true;
            } else {
        ...
        h1Var.f46092b.setHintText(LocaleController.getString(i12), false);
        ...
        if (i11 == 4) {
            ...
            linearLayout.setBackground(j6.Y(getThemedColor(j6.f19199i6), 6, 6));
            np npVar = new np(context, 24, f6Var);
            this.f43474c0 = npVar;
            npVar.b(j6.Oh, j6.f19218j7, j6.f19238k7);
            npVar.setDrawUnchecked(true);
            npVar.a(false, false);
            npVar.setDrawBackgroundAsArc(10);
            linearLayout.addView(npVar, y5.t(26, 26, 16, 0, 0, 0, 0));
            TextView textView = new TextView(context);
            textView.setTextColor(getThemedColor(j6.f19216j5));
            ...
            linearLayout.setOnClickListener(new View.OnClickListener(this) {
                ...
                public final void onClick(View view) {
                    switch (r2) {
                        case 0:
                            np npVar2 = this.f43441b.f43474c0;
    ...
    public static void P(m1 m1Var, TLObject tLObject) {
        ...
        ArrayList arrayList = m1Var.f43482k0;
        arrayList.clear();
        m1Var.f43494x0 = -1;
    ...
    public static void Q(m1 m1Var, int i10, f6 f6Var, int i11, View view) {
        ...
        if (view instanceof s8) {
            ...
            d5.m(m1Var.getContext(), LocaleController.getString(R.string.EditProfileBirthdayTitle), LocaleController.getString(R.string.EditProfileBirthdayButton), null, new b1(m1Var, 2), new a1(m1Var, 9), false, false, m1Var.resourcesProvider).f18674a.show();
            ...
            if (user == null && chat == null && i10 == 3) {
                ...
                if (i10 == 1) {
                    ...
                    if (i10 == 4 && hashSet.isEmpty()) {
                        ...
                        if (callback2 != null) {
                            np npVar = m1Var.f43474c0;
                            callback2.run(Boolean.valueOf((npVar == null || !npVar.f26861a.f22209q) ? false : false), hashSet);
                            m1Var.D0 = null;
                        }
                        m1Var.dismiss();
                        return;
                    ...
                    if (hashSet.contains(Long.valueOf(j10))) {
                        ...
                        hashSet.add(Long.valueOf(j10));
                        m1Var.f43484n0.put(Long.valueOf(j10), user);
                    }
                    ...
                    if (z10 != z11) {
                        ...
                        if (gVar.f44065y != z13) {
                            gVar.f44065y = z13;
                            AndroidUtilities.forEachViews((RecyclerView) gVar.f44059f, (e2.h) new m4.n0(3, z13));
                        }
                    }
                    m1Var.W();
                    ...
                    r1 r1Var = new r1(m1Var.getContext(), i11, j10, s.c(s.b(1, m1Var.f43488r0)), new b1(m1Var, 1));
                    BirthdayController.BirthdayState birthdayState = m1Var.f43492v0;
    ...
    public static void R(m1 m1Var, TLObject tLObject, TLRPC.UserFull userFull, TL_account.TL_birthday tL_birthday, TLRPC.TL_error tL_error) {
        String str;
        FrameLayout frameLayout = m1Var.f43476e0;
            ...
            public final void run() {
                switch (r3) {
                        ...
                        if (user2 != null) {
                            ...
                            if (n2Var == null) {
                                ...
                                if (U != 0) {
                                    ...
                                    bundle.putLong("user_id", user2.f18490id);
                    ...
                    default:
                        ...
                        if (user3 != null) {
                            n2 n2Var2 = this.f43431b.f22602n;
                            if (n2Var2 == null) {
                                ...
                                if (U2 != 0) {
                                    ...
                                    bundle3.putLong("user_id", user3.f18490id);
                            ...
                            bundle4.putLong("user_id", user3.f18490id);
    ...
    public static void U(m1 m1Var, String str) {
        if (m1Var.f43494x0 >= 0) {
            ConnectionsManager.getInstance(m1Var.currentAccount).cancelRequest(m1Var.f43494x0, true);
            m1Var.f43494x0 = -1;
        }
        TLRPC.TL_contacts_search tL_contacts_search = new TLRPC.TL_contacts_search();
        tL_contacts_search.f18389q = str;
        m1Var.f43494x0 = ConnectionsManager.getInstance(m1Var.currentAccount).sendRequest(tL_contacts_search, new m8(m1Var, 21));
    }
    ...
    public final int V(String str, ArrayList arrayList, ArrayList arrayList2) {
        ...
        while (i11 < size) {
            ...
            if (user != null && !user.bot && !UserObject.isService(user.f18490id)) {
                long j3 = user.f18490id;
                if (j3 != 0 && !this.C0.contains(Long.valueOf(j3))) {
                    Long valueOf = Long.valueOf(user.f18490id);
                    HashSet hashSet = this.f43479h0;
                    hashSet.contains(valueOf);
                    i10 += AndroidUtilities.dp(56.0f);
                    ug.f c10 = ug.f.c(user, hashSet.contains(Long.valueOf(user.f18490id)));
                    Y(c10);
                    arrayList3.add(c10);
                }
            }
    ...
    public final void W() {
        int i10;
        if (this.f43479h0.isEmpty() && (i10 = this.X) != 1 && i10 != 2 && i10 != 3 && i10 != 4) {
            if (this.f43489s0) {
                this.f43489s0 = false;
                AndroidUtilities.runOnUIThread(new a1(this, 4), 10L);
            }
        } else if (!this.f43489s0) {
            this.f43489s0 = true;
    ...
    public final void X() {
        if (!TextUtils.isEmpty(this.f43485o0)) {
            this.f43485o0 = null;
            this.Z.setText("");
            AndroidUtilities.cancelRunOnUIThread(this.f43493w0);
            h0(true, true);
        }
    }
    ...
    public final ug.f Y(ug.f fVar) {
        ...
        if (i10 == 4) {
            ...
            final long j3 = user.f18490id;
            ?? r22 = new View.OnClickListener(this) {
                public final m1 f43422b;
                ...
                public final void onClick(View view) {
                    switch (r4) {
                        case 0:
                            ...
                            return;
                        default:
                            m1 m1Var2 = this.f43422b;
                            HashSet hashSet2 = m1Var2.f43479h0;
    ...
    public final void b0(boolean z10) {
        ArrayList arrayList = this.f43480i0;
        if (arrayList.isEmpty()) {
            arrayList.addAll(ContactsController.getInstance(this.currentAccount).contacts);
            this.f43483l0.putAll(ContactsController.getInstance(this.currentAccount).usersSectionsDict);
    ...
    public final void c0(boolean z10) {
        ArrayList arrayList = this.f43481j0;
        if (arrayList.isEmpty()) {
    ...
    public final void d0() {
        HashSet hashSet = this.f43479h0;
        if (hashSet.size() != 0) {
            ArrayList arrayList = this.f43488r0;
            boolean isEmpty = arrayList.isEmpty();
            int i10 = this.X;
            if (!isEmpty || i10 == 0 || i10 == 2 || i10 == 4) {
                ArrayList arrayList2 = new ArrayList();
                for (TLRPC.User user : this.f43484n0.values()) {
                ...
                if (i10 != 1) {
                    ...
                    if (arrayList2.size() == 1) {
                        long j3 = ((TLRPC.User) arrayList2.get(0)).f18490id;
                        ...
                        BirthdayController.BirthdayState birthdayState = this.f43492v0;
    ...
    public final void g0(boolean z10) {
        ...
        if (i10 == 4) {
            ...
            if (LocaleController.isRTL) {
                ...
                spannableStringBuilder.append((CharSequence) "d").setSpan(this.f43491u0, spannableStringBuilder.length() - 1, spannableStringBuilder.length(), 33);
            } else {
                spannableStringBuilder.append((CharSequence) "d").setSpan(this.f43491u0, 0, 1, 33);
                spannableStringBuilder.append((CharSequence) LocaleController.getString("GiftPremiumChooseRecipientsBtn", R.string.GiftPremiumChooseRecipientsBtn));
            }
        } else {
    ...
    public final void i0(boolean z10, boolean z11) {
        ...
        while (true) {
            ...
            if ((childAt instanceof xg.l) && (S = RecyclerView.S(childAt)) - 1 >= 0) {
                ArrayList arrayList = this.f43478g0;
