...
public final class c0 extends ug.e {
    ...
    public final void E() {
        String string;
        e6 e6Var;
        d0 d0Var = this.f43117r;
        String str = d0Var.f43123a0;
    ...
    public final void F(TLObject tLObject) {
        ...
        n2 n2Var = d0Var.f30528n;
        d0Var.dismiss();
        if (tLObject instanceof TLRPC.Chat) {
            n2Var.presentFragment(bo.R9(-((TLRPC.Chat) tLObject).f18112id));
        } else if (tLObject instanceof TLRPC.User) {
            n2Var.presentFragment(bo.R9(((TLRPC.User) tLObject).f18259id));
        } else {
