...
public final class a0 extends bb implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final List Y;
    public final List Z;
    public final List f43350a0;
    public final TLRPC.Chat f43351b0;
    public final ArrayList f43352c0;
    public final ArrayList f43353d0;
    public final ArrayList f43354e0;
    public final ArrayList f43355f0;
    public ug.b f43356g0;
    public int f43357h0;
    public int f43358i0;
    public int f43359j0;
    public boolean f43360k0;
    public int f43361l0;
    public long m0;
    public int f43362n0;
    public int f43363o0;
    public long f43364p0;
    public final vg.a f43365q0;
    public o0.a f43366r0;
    public int f43367s0;
    public j f43368t0;
    public final TL_stories.PrepaidGiveaway f43369u0;
    public String f43370v0;
    public boolean f43371w0;
    public boolean f43372x0;
    public final t f43373y0;
    ...
    public a0(m2 m2Var, long j3, TL_stories.PrepaidGiveaway prepaidGiveaway) {
        ...
        this.Z = asList2;
        this.f43350a0 = Arrays.asList(750, 10000, 50000);
        this.f43352c0 = new ArrayList();
        this.f43353d0 = new ArrayList();
        this.f43354e0 = new ArrayList();
        this.f43355f0 = new ArrayList();
        int i10 = vg.d.f44602s;
        this.f43357h0 = 2;
        this.f43358i0 = 0;
        int i11 = vg.u.f44635s;
        this.f43359j0 = 0;
        this.f43361l0 = 12;
        ...
        this.f43370v0 = "";
        this.f43372x0 = true;
        this.f43373y0 = new t(this, 0);
        this.f43369u0 = prepaidGiveaway;
        this.v = 0.15f;
    ...
    public static void P(a0 a0Var, TL_stories.PrepaidGiveaway prepaidGiveaway, long j3, m2 m2Var) {
        ...
        long j10;
        ArrayList arrayList = a0Var.f43354e0;
        ArrayList arrayList2 = a0Var.f43352c0;
        TLRPC.Chat chat = a0Var.f43351b0;
        ArrayList arrayList3 = a0Var.f43353d0;
        ArrayList arrayList4 = a0Var.f43355f0;
        vg.a aVar = a0Var.f43365q0;
        if (!aVar.f44577a.N) {
            if (a0Var.Y()) {
                if (prepaidGiveaway instanceof TL_stories.TL_prepaidStarsGiveaway) {
            ...
            if (i11 == 3) {
                ...
                if (findActivity != null && !findActivity.isFinishing()) {
                    TL_stars.TL_starsGiveawayOption W = a0Var.W(a0Var.f43364p0);
                    int U = a0Var.U();
                    if (W != null) {
                        aVar.f44577a.setLoading(true);
                        ...
                        int l4 = s.l(a0Var.m0);
                        boolean z12 = a0Var.f43372x0;
                        boolean z13 = a0Var.f43371w0;
                        String str3 = a0Var.f43370v0;
            ...
            if (a0Var.f43358i0 == 1) {
                ...
                for (int i19 = 0; i19 < b10.size(); i19++) {
                    ...
                    if (tL_premiumGiftCodeOption.months == a0Var.f43361l0 && arrayList3.size() > 0) {
                        if (s.h()) {
                        ...
                        aVar.b(true);
                        s.k(arrayList3, tL_premiumGiftCodeOption, a0Var.f43351b0, null, m2Var, new v(a0Var, 0), new v(a0Var, 1));
                        return;
                    }
                }
                return;
            ...
            while (i22 < b11.size()) {
                ...
                if (tL_premiumGiftCodeOption3.months == a0Var.f43361l0) {
                    if (s.h()) {
                        List list = a0Var.Y;
                    ...
                    int i29 = a0Var.f43359j0;
                    int i30 = vg.u.f44635s;
                    if (i29 == 1) {
                        z10 = true;
                    } else {
                        z10 = false;
                    ...
                    aVar.b(true);
                    boolean z14 = a0Var.f43372x0;
                    boolean z15 = a0Var.f43371w0;
                    String str4 = a0Var.f43370v0;
    ...
    public static void Q(a0 a0Var, m2 m2Var, View view) {
        ...
        o0.a aVar;
        boolean z11;
        ArrayList arrayList = a0Var.f43353d0;
        t tVar = a0Var.f43373y0;
        ...
        if (view instanceof vg.c) {
            if (view instanceof vg.d) {
                ...
                int i14 = vg.d.f44602s;
                if (selectedType != 2 && selectedType != 3) {
                    if (selectedType == 1) {
                        o0.a aVar3 = a0Var.f43366r0;
                        if (aVar3 != null) {
                            ((z0) aVar3.f15482b).V(1, arrayList);
                            ((m) aVar3.f15483c).f43432b.D(1);
                        }
                    } else {
                        a0Var.f43358i0 = selectedType;
                        a0Var.a0(true, true);
                        a0Var.Z(true);
                        a0Var.N();
                    }
                } else if (selectedType == 2 && a0Var.f43357h0 == selectedType) {
                    o0.a aVar4 = a0Var.f43366r0;
                    if (aVar4 != null) {
                        ((z0) aVar4.f15482b).V(1, arrayList);
                        ((m) aVar4.f15483c).f43432b.D(1);
                        return;
                    }
                    return;
                } else {
                    a0Var.f43357h0 = selectedType;
                    a0Var.a0(true, true);
                    a0Var.Z(true);
                    a0Var.N();
                }
                ...
                xl0 xl0Var = a0Var.d;
                if (cVar.b()) {
                    for (int i15 = 0; i15 < xl0Var.getChildCount(); i15++) {
        ...
        if (view instanceof vg.u) {
            ...
            if (a0Var.f43359j0 == selectedType2 && (aVar = a0Var.f43366r0) != null) {
                ((z0) aVar.f15482b).V(3, a0Var.f43354e0);
                ((m) aVar.f15483c).f43432b.D(1);
            }
            a0Var.f43359j0 = selectedType2;
            a0Var.a0(false, false);
        } else if (view instanceof vg.i) {
            a0Var.f43361l0 = ((TLRPC.TL_premiumGiftCodeOption) ((vg.i) view).getGifCode()).months;
            a0Var.a0(false, false);
            a0Var.f43356g0.G();
            ...
            c4 c4Var = new c4(context, c5Var2, fd0Var, (g) fd0Var2, (h) fd0Var3);
            ...
            fd0Var.setTag("DAY");
            fd0Var.setFormatter(new s20(currentTimeMillis, calendar, i17, 1));
            dd0 u4Var = new u4(c4Var, (g) fd0Var2, (h) fd0Var3, i19, i20, fd0Var);
            ...
            zm0Var.setTextColor(c5Var.f23208g);
            ...
            zm0Var.setOnClickListener(new org.telegram.ui.Components.m0(calendar, fd0Var, fd0Var2, fd0Var3, uVar, z2Var));
            z2Var.b(c4Var);
            e3 e3Var = z2Var.f19949a;
            e3Var.show();
            int i21 = c5Var.f23205b;
            ...
            o0.a aVar5 = a0Var.f43366r0;
            if (aVar5 != null) {
                ((z0) aVar5.f15482b).V(2, a0Var.f43352c0);
                ((m) aVar5.f15483c).f43432b.D(1);
            }
        } else if (view instanceof vg.w) {
            TL_stars.TL_starsGiveawayOption option = ((vg.w) view).getOption();
            if (option != null) {
                a0Var.f43364p0 = option.stars;
                a0Var.a0(true, true);
                a0Var.Z(true);
                a0Var.N();
            }
    ...
    public static void R(a0 a0Var) {
        rg.k1 k1Var = new rg.k1(a0Var.f22958n, a0Var.currentAccount, null, a0Var.resourcesProvider);
    ...
    public final int U() {
        int i10 = this.f43357h0;
        int i11 = vg.d.f44602s;
        if (i10 == 2) {
            return ((Integer) this.Y.get(this.f43362n0)).intValue();
        }
        List X = X();
        int i12 = this.f43363o0;
        if (i12 < 0 || i12 >= X.size()) {
            this.f43363o0 = 0;
        }
        if (this.f43363o0 >= X.size()) {
            return 0;
        }
        return ((Integer) X.get(this.f43363o0)).intValue();
    }
    ...
    public final int V() {
        ...
        int i11 = vg.d.f44602s;
        if (i10 == 2) {
            U = ((Integer) this.Y.get(this.f43362n0)).intValue();
            g10 = s.g();
        } else {
            TL_stars.TL_starsGiveawayOption W = W(this.f43364p0);
            if (W != null) {
    ...
    public final void Z(boolean z10) {
        boolean z11;
        boolean Y = Y();
        vg.a aVar = this.f43365q0;
        if (Y) {
            TL_stories.PrepaidGiveaway prepaidGiveaway = this.f43369u0;
            if (prepaidGiveaway instanceof TL_stories.TL_prepaidStarsGiveaway) {
        ...
        int i10 = this.f43358i0;
        int i11 = vg.d.f44602s;
        if (i10 == 0) {
            aVar.a(V(), z10);
            return;
        }
        ArrayList arrayList = this.f43353d0;
        ...
        aVar.e = true;
        ci.d dVar = aVar.f44577a;
        dVar.k();
        dVar.setShowZero(true);
        dVar.setEnabled(z11);
        dVar.b(g10, z10);
        dVar.g(LocaleController.getString(R.string.GiftPremium), z10, true);
        aVar.f44578b.setBackgroundColor(h6.v0(h6.f19129h5, aVar.f44579c));
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        xl0 xl0Var;
        if (i10 == NotificationCenter.starGiveawayOptionsLoaded && (xl0Var = this.d) != null && xl0Var.G) {
            a0(true, true);
        }
    }
