...
public final class a0 extends bb implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final List Y;
    public final List Z;
    public final List f43337a0;
    public final TLRPC.Chat f43338b0;
    public final ArrayList f43339c0;
    public final ArrayList f43340d0;
    public final ArrayList f43341e0;
    public final ArrayList f43342f0;
    public ug.b f43343g0;
    public int f43344h0;
    public int f43345i0;
    public int f43346j0;
    public boolean f43347k0;
    public int f43348l0;
    public long m0;
    public int f43349n0;
    public int f43350o0;
    public long f43351p0;
    public final vg.a f43352q0;
    public o0.a f43353r0;
    public int f43354s0;
    public j f43355t0;
    public final TL_stories.PrepaidGiveaway f43356u0;
    public String f43357v0;
    public boolean f43358w0;
    public boolean f43359x0;
    public final t f43360y0;
    ...
    public a0(m2 m2Var, long j3, TL_stories.PrepaidGiveaway prepaidGiveaway) {
        ...
        this.Z = asList2;
        this.f43337a0 = Arrays.asList(750, 10000, 50000);
        this.f43339c0 = new ArrayList();
        this.f43340d0 = new ArrayList();
        this.f43341e0 = new ArrayList();
        this.f43342f0 = new ArrayList();
        int i10 = vg.d.f44589s;
        this.f43344h0 = 2;
        this.f43345i0 = 0;
        int i11 = vg.u.f44622s;
        this.f43346j0 = 0;
        this.f43348l0 = 12;
        ...
        this.f43357v0 = "";
        this.f43359x0 = true;
        this.f43360y0 = new t(this, 0);
        this.f43356u0 = prepaidGiveaway;
        this.v = 0.15f;
    ...
    public static void P(a0 a0Var, TL_stories.PrepaidGiveaway prepaidGiveaway, long j3, m2 m2Var) {
        ...
        long j10;
        ArrayList arrayList = a0Var.f43341e0;
        ArrayList arrayList2 = a0Var.f43339c0;
        TLRPC.Chat chat = a0Var.f43338b0;
        ArrayList arrayList3 = a0Var.f43340d0;
        ArrayList arrayList4 = a0Var.f43342f0;
        vg.a aVar = a0Var.f43352q0;
        if (!aVar.f44564a.N) {
            if (a0Var.Y()) {
                if (prepaidGiveaway instanceof TL_stories.TL_prepaidStarsGiveaway) {
            ...
            int i11 = a0Var.f43344h0;
            int i12 = vg.d.f44589s;
            String str2 = "inapp";
            if (i11 == 3) {
                ...
                if (findActivity != null && !findActivity.isFinishing()) {
                    TL_stars.TL_starsGiveawayOption W = a0Var.W(a0Var.f43351p0);
                    int U = a0Var.U();
                    if (W != null) {
                        aVar.f44564a.setLoading(true);
                        int i13 = a0Var.f43346j0;
                        int i14 = vg.u.f44622s;
                        if (i13 == 1) {
                            z11 = true;
                        } else {
                            z11 = false;
                        ...
                        int l4 = s.l(a0Var.m0);
                        boolean z12 = a0Var.f43359x0;
                        boolean z13 = a0Var.f43358w0;
                        String str3 = a0Var.f43357v0;
            ...
            if (a0Var.f43345i0 == 1) {
                ...
                for (int i19 = 0; i19 < b10.size(); i19++) {
                    ...
                    if (tL_premiumGiftCodeOption.months == a0Var.f43348l0 && arrayList3.size() > 0) {
                        if (s.h()) {
                            ...
                            if (tL_premiumGiftCodeOption.store_product == null) {
                                ...
                                a2 a2Var2 = alertDialog$Builder2.f18647a;
                                a2Var2.R = string2;
                        ...
                        aVar.b(true);
                        s.k(arrayList3, tL_premiumGiftCodeOption, a0Var.f43338b0, null, m2Var, new v(a0Var, 0), new v(a0Var, 1));
                        return;
                    }
                }
                return;
            ...
            while (i22 < b11.size()) {
                ...
                if (tL_premiumGiftCodeOption3.months == a0Var.f43348l0) {
                    if (s.h()) {
                        List list = a0Var.Y;
                        ...
                        if (tL_premiumGiftCodeOption3.store_product == null) {
                            ...
                            a2 a2Var3 = alertDialog$Builder3.f18647a;
                            a2Var3.R = string3;
                    ...
                    int i29 = a0Var.f43346j0;
                    int i30 = vg.u.f44622s;
                    if (i29 == 1) {
                        z10 = true;
                    } else {
                        z10 = false;
                    ...
                    aVar.b(true);
                    boolean z14 = a0Var.f43359x0;
                    boolean z15 = a0Var.f43358w0;
                    String str4 = a0Var.f43357v0;
                    ...
                    if (!s.h()) {
                        ...
                        while (i32 < size6) {
                            ...
                            if (tLObject instanceof TLRPC.Chat) {
                                i10 = i33;
                                tL_inputStorePaymentPremiumGiveaway.additional_peers.add(messagesController.getInputPeer(-((TLRPC.Chat) tLObject).f18321id));
                            } else {
                                i10 = i33;
                            }
                            i32 = i10;
                        }
                        tL_inputStorePaymentPremiumGiveaway.boost_peer = messagesController.getInputPeer(-chat.f18321id);
                        tL_inputStorePaymentPremiumGiveaway.boost_peer = messagesController.getInputPeer(-chat.f18321id);
                    ...
                    while (i36 < size8) {
                        ...
                        if (tLObject2 instanceof TLRPC.Chat) {
                            tL_inputStorePaymentPremiumGiveaway2.additional_peers.add(messagesController2.getInputPeer(-((TLRPC.Chat) tLObject2).f18321id));
                        }
                    }
                    tL_inputStorePaymentPremiumGiveaway2.boost_peer = messagesController2.getInputPeer(-chat.f18321id);
    ...
    public static void Q(a0 a0Var, m2 m2Var, View view) {
        ...
        o0.a aVar;
        boolean z11;
        ArrayList arrayList = a0Var.f43340d0;
        t tVar = a0Var.f43360y0;
        ...
        if (view instanceof vg.c) {
            if (view instanceof vg.d) {
                ...
                int i14 = vg.d.f44589s;
                if (selectedType != 2 && selectedType != 3) {
                    if (selectedType == 1) {
                        o0.a aVar3 = a0Var.f43353r0;
                        if (aVar3 != null) {
                            ((z0) aVar3.f15467b).V(1, arrayList);
                            ((m) aVar3.f15468c).f43419b.D(1);
                        }
                    } else {
                        a0Var.f43345i0 = selectedType;
                        a0Var.a0(true, true);
                        a0Var.Z(true);
                        a0Var.N();
                    }
                } else if (selectedType == 2 && a0Var.f43344h0 == selectedType) {
                    o0.a aVar4 = a0Var.f43353r0;
                    if (aVar4 != null) {
                        ((z0) aVar4.f15467b).V(1, arrayList);
                        ((m) aVar4.f15468c).f43419b.D(1);
                        return;
                    }
                    return;
                } else {
                    a0Var.f43344h0 = selectedType;
                    a0Var.a0(true, true);
                    a0Var.Z(true);
                    a0Var.N();
                }
        ...
        if (view instanceof vg.u) {
            ...
            if (a0Var.f43346j0 == selectedType2 && (aVar = a0Var.f43353r0) != null) {
                ((z0) aVar.f15467b).V(3, a0Var.f43341e0);
                ((m) aVar.f15468c).f43419b.D(1);
            }
            a0Var.f43346j0 = selectedType2;
            a0Var.a0(false, false);
        } else if (view instanceof vg.i) {
            a0Var.f43348l0 = ((TLRPC.TL_premiumGiftCodeOption) ((vg.i) view).getGifCode()).months;
            a0Var.a0(false, false);
            a0Var.f43343g0.G();
            ...
            zm0Var.setTextColor(c5Var.f23166g);
            ...
            z2Var.b(c4Var);
            e3 e3Var = z2Var.f19935a;
            e3Var.show();
            int i21 = c5Var.f23163b;
            ...
            o0.a aVar5 = a0Var.f43353r0;
            if (aVar5 != null) {
                ((z0) aVar5.f15467b).V(2, a0Var.f43339c0);
                ((m) aVar5.f15468c).f43419b.D(1);
            }
        } else if (view instanceof vg.w) {
            TL_stars.TL_starsGiveawayOption option = ((vg.w) view).getOption();
            if (option != null) {
                a0Var.f43351p0 = option.stars;
                a0Var.a0(true, true);
                a0Var.Z(true);
                a0Var.N();
            }
    ...
    public static void R(a0 a0Var) {
        rg.k1 k1Var = new rg.k1(a0Var.f22949n, a0Var.currentAccount, null, a0Var.resourcesProvider);
    ...
    public final int U() {
        int i10 = this.f43344h0;
        int i11 = vg.d.f44589s;
        if (i10 == 2) {
            return ((Integer) this.Y.get(this.f43349n0)).intValue();
        }
        List X = X();
        int i12 = this.f43350o0;
        if (i12 < 0 || i12 >= X.size()) {
            this.f43350o0 = 0;
        }
        if (this.f43350o0 >= X.size()) {
            return 0;
        }
        return ((Integer) X.get(this.f43350o0)).intValue();
    }
    ...
    public final int V() {
        ...
        int i11 = vg.d.f44589s;
        if (i10 == 2) {
            U = ((Integer) this.Y.get(this.f43349n0)).intValue();
            g10 = s.g();
        } else {
            TL_stars.TL_starsGiveawayOption W = W(this.f43351p0);
            if (W != null) {
    ...
    public final void Z(boolean z10) {
        boolean z11;
        boolean Y = Y();
        vg.a aVar = this.f43352q0;
        if (Y) {
            TL_stories.PrepaidGiveaway prepaidGiveaway = this.f43356u0;
            if (prepaidGiveaway instanceof TL_stories.TL_prepaidStarsGiveaway) {
        ...
        int i10 = this.f43345i0;
        int i11 = vg.d.f44589s;
        if (i10 == 0) {
            aVar.a(V(), z10);
            return;
        }
        ArrayList arrayList = this.f43340d0;
        ...
        aVar.f44565b.setBackgroundColor(h6.v0(h6.f19115h5, aVar.f44566c));
    }
