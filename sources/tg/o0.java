...
public final class o0 extends FrameLayout {
    public final w9 f43467a;
    public final p0 f43468b;
    public final Paint f43469c;
    public TLRPC.Chat d;
    public final h9 e;
    ...
    public o0(Context context) {
        ...
        view.f43472a = paint2;
        view.f43473b = view.getContext().getDrawable(R.drawable.mini_boost_remove);
        int i10 = h6.f19129h5;
    ...
    public final void dispatchDraw(Canvas canvas) {
        canvas.drawCircle(getMeasuredWidth() / 2.0f, getMeasuredHeight() / 2.0f, (getMeasuredHeight() / 2.0f) - AndroidUtilities.dp(2.0f), this.f43469c);
