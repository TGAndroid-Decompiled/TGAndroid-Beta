...
public final class v implements b5, tv0, vg.f, vg.k {
    ...
    public void g(int i10) {
        ...
        b0Var.f43130q0.f44325a.b(b0Var.V(), true);
        if (b0Var.f43122h0 == 3) {
            b0Var.a0(true, true);
        } else {
        ...
        int V = b0Var.V();
        for (int i14 = 0; i14 < bVar.f43738f.getChildCount(); i14++) {
            View childAt = bVar.f43738f.getChildAt(i14);
            if (childAt instanceof vg.x) {
                n6 n6Var = ((vg.x) childAt).f44393r;
                if (V <= 0) {
                    formatPluralString = "";
                } else {
