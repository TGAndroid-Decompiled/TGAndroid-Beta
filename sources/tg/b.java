...
public final class b extends View {
    public final o6 f43378a;
    public float f43379b;
    public ValueAnimator f43380c;
    public int d;
    ...
    public final void a(int i10, boolean z10) {
        ...
        o6 o6Var = this.f43378a;
        if (z10) {
            o6Var.b();
        }
        if (z10 && i10 != this.d && i10 > 0) {
            ValueAnimator valueAnimator = this.f43380c;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                this.f43380c = null;
            }
            ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
            this.f43380c = ofFloat;
            ofFloat.addUpdateListener(new org.telegram.ui.Components.voip.r0(this, 18));
            this.f43380c.addListener(new pg.d0(this, 7));
            this.f43380c.setInterpolator(new OvershootInterpolator(2.0f));
            this.f43380c.setDuration(200L);
            this.f43380c.start();
        }
        this.d = i10;
        int length = o6Var.f26933g.length();
        o6Var.q("x" + i10, z10, true);
        int length2 = o6Var.f26933g.length();
        invalidate();
        if (length != length2) {
            requestLayout();
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        rectF.set(rect);
        if (this.f43379b != 1.0f) {
            canvas.save();
            float f7 = this.f43379b;
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec((int) (this.f43378a.e() + AndroidUtilities.dp(15.0f)), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(26.0f), 1073741824));
    }
}
