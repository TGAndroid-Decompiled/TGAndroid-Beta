...
public final class b extends View {
    public final m6 f43107a;
    public float f43108b;
    public ValueAnimator f43109c;
    public int d;
    ...
    public final void a(int i10, boolean z10) {
        ...
        m6 m6Var = this.f43107a;
        if (z10) {
            m6Var.b();
        }
        if (z10 && i10 != this.d && i10 > 0) {
            ValueAnimator valueAnimator = this.f43109c;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                this.f43109c = null;
            }
            ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
            this.f43109c = ofFloat;
            ofFloat.addUpdateListener(new org.telegram.ui.Components.voip.r0(this, 18));
            this.f43109c.addListener(new qg.n0(this, 6));
            this.f43109c.setInterpolator(new OvershootInterpolator(2.0f));
            this.f43109c.setDuration(200L);
            this.f43109c.start();
        }
        this.d = i10;
        int length = m6Var.f26070g.length();
        m6Var.q("x" + i10, z10, true);
        int length2 = m6Var.f26070g.length();
        invalidate();
        if (length != length2) {
            requestLayout();
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        rectF.set(rect);
        if (this.f43108b != 1.0f) {
            canvas.save();
            float f7 = this.f43108b;
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec((int) (this.f43107a.e() + AndroidUtilities.dp(15.0f)), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(26.0f), 1073741824));
    }
}
