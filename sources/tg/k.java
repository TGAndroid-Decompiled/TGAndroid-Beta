...
public final class k extends w81 {
    ...
    public boolean V;
    public boolean W;
    public final boolean f43408a0;
    public final z0 f43409b0;
    public final d6 f43410c0;
    public final a0 f43411d0;
    public final m f43412e0;
    ...
    public k(m mVar, Context context, z0 z0Var, d6 d6Var, a0 a0Var) {
        ...
        this.T = new Path();
        this.U = new Paint(1);
        this.f43408a0 = AndroidUtilities.isTablet();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int i11;
        float f7;
        m mVar = this.f43412e0;
        k kVar = mVar.f43419b;
        int v02 = h6.v0(h6.f19115h5, this.f43410c0);
        Paint paint = this.U;
        paint.setColor(v02);
        if (this.V) {
            int i12 = -AndroidUtilities.dp(16.0f);
            a0 a0Var = this.f43411d0;
            int i13 = a0Var.f43354s0;
            ...
            z0 z0Var = this.f43409b0;
            int i14 = z0Var.f43515t0;
            if (z0Var.m0.f23817c == 1.0f) {
    ...
    public final float getAvailableTranslationX() {
        if (!this.f43408a0 && !this.f43412e0.d) {
    ...
    public final boolean i(MotionEvent motionEvent) {
        if (this.f43412e0.f43419b.getCurrentPosition() == 1) {
            return true;
        }
        return false;
    }
    ...
    public final void u() {
        this.V = false;
        this.f43412e0.f43419b.invalidate();
    }
        ...
        if (positionAnimated > 0.0f && positionAnimated < 1.0f) {
            if (!this.V) {
                ...
                if (mVar.isKeyboardVisible()) {
                    AndroidUtilities.hideKeyboard(mVar.f43420c.getContainerView());
                }
            }
        } else {
            this.V = false;
