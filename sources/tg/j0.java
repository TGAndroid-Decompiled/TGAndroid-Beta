...
public final class j0 extends FrameLayout {
    public static final int f43176f = 0;
    public final u9 f43177a;
    public final i0 f43178b;
    public final Paint f43179c;
    public boolean d;
    public final f9 e;
    ...
    public final void dispatchDraw(Canvas canvas) {
        if (this.d) {
            canvas.drawCircle(getMeasuredWidth() / 2.0f, getMeasuredHeight() / 2.0f, (getMeasuredHeight() / 2.0f) - AndroidUtilities.dp(2.0f), this.f43179c);
        }
