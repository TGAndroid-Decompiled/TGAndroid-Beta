...
public final class i0 extends FrameLayout {
    public static final int f43414f = 0;
    public final w9 f43415a;
    public final h0 f43416b;
    public final Paint f43417c;
    public boolean d;
    public final h9 e;
    ...
    public final void dispatchDraw(Canvas canvas) {
        if (this.d) {
            canvas.drawCircle(getMeasuredWidth() / 2.0f, getMeasuredHeight() / 2.0f, (getMeasuredHeight() / 2.0f) - AndroidUtilities.dp(2.0f), this.f43417c);
        }
