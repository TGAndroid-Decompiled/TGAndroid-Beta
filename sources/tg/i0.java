...
public final class i0 extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        TextPaint textPaint = this.f43103a;
        ...
        canvas.drawText("+" + this.f43104b, measuredWidth, (int) (measuredHeight - ((textPaint.ascent() + descent) / 2.0f)), textPaint);
    }
}
