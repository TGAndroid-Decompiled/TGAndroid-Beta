...
public final class i0 extends FrameLayout {
    public static final int f43428f = 0;
    public final v9 f43429a;
    public final h0 f43430b;
    public final Paint f43431c;
    public boolean d;
    public final g9 e;
    ...
    public final void dispatchDraw(Canvas canvas) {
        if (this.d) {
            canvas.drawCircle(getMeasuredWidth() / 2.0f, getMeasuredHeight() / 2.0f, (getMeasuredHeight() / 2.0f) - AndroidUtilities.dp(2.0f), this.f43431c);
        }
