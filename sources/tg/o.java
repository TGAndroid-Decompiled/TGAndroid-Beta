...
public final class o extends f3 {
    public static o e;
    public final m f43195b;
    public final a1 f43196c;
    public boolean d;
    ...
    public o(Activity activity, b0 b0Var, a1 a1Var, e6 e6Var, boolean z10) {
        ...
        fixNavigationBar();
        if (i0.a.f(i6.v0(i6.f18904h5, this.resourcesProvider)) > 0.699999988079071d) {
            z11 = true;
        } else {
            z11 = false;
        }
        ...
        mVar.setPosition(0);
        setCustomView(mVar);
        b0Var.f43102t0 = new l(this, 0);
        b0Var.f43100r0 = new o0.a(this, a1Var, false, 17);
        a1Var.f43079u0 = new n(this, b0Var, e6Var);
        a1Var.f43077s0 = new l(this, 1);
        if (!z10) {
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        boolean z10;
        this.f43196c.onConfigurationChanged(configuration);
