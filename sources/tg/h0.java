...
public final class h0 extends rg.k1 {
    ...
    public h0(o2 o2Var, int i10, TLRPC.User user, rg.k kVar, String str, boolean z10, f6 f6Var) {
        ...
        if (!z10) {
            ...
            vg.a aVar2 = this.Q0;
            aVar2.e = true;
            ci.d dVar = aVar2.f44325a;
            dVar.setEnabled(true);
            dVar.g(LocaleController.getString(R.string.GiftPremiumActivateForFree), false, true);
            aVar2.f44326b.setBackgroundColor(j6.v0(j6.f18934h5, aVar2.f44327c));
    ...
    public static void d0(h0 h0Var) {
        rg.k1 k1Var = new rg.k1(h0Var.f30454n, UserConfig.selectedAccount, null, null, null, h0Var.resourcesProvider);
        k1Var.J0 = true;
        k1Var.K0 = true;
        k1Var.f42373c0 = true;
        h0Var.f30454n.showDialog(k1Var);
    }
    ...
    public static void e0(h0 h0Var) {
        ...
        h0Var.f30454n.presentFragment(wyVar);
        h0Var.dismiss();
    }
