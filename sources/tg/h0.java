...
public final class h0 extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        TextPaint textPaint = this.f43411a;
        ...
        canvas.drawText("+" + this.f43412b, measuredWidth, (int) (measuredHeight - ((textPaint.ascent() + descent) / 2.0f)), textPaint);
    }
}
