...
public class n1 extends za implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final k1 Y;
    public final i1 Z;
    public final j1 f43174a0;
    public final h1 f43175b0;
    public final np f43176c0;
    public final o20 f43177d0;
    public final FrameLayout f43178e0;
    public final ArrayList f43179f0;
    public final ArrayList f43180g0;
    public final HashSet f43181h0;
    public final ArrayList f43182i0;
    public final ArrayList f43183j0;
    public final ArrayList f43184k0;
    public final HashMap f43185l0;
    public final ArrayList m0;
    public final LinkedHashMap f43186n0;
    public String f43187o0;
    public ug.g f43188p0;
    public int f43189q0;
    public final ArrayList f43190r0;
    public boolean f43191s0;
    public float f43192t0;
    public ra0 f43193u0;
    public final BirthdayController.BirthdayState f43194v0;
    public final qg.b0 f43195w0;
    public int f43196x0;
    public pq f43197y0;
    public String f43198z0;
    ...
    public n1(Context context, int i10, BirthdayController.BirthdayState birthdayState, int i11, e6 e6Var) {
        ...
        float f7;
        boolean z10;
        this.f43179f0 = new ArrayList();
        ArrayList arrayList = new ArrayList();
        this.f43180g0 = arrayList;
        HashSet hashSet = new HashSet();
        this.f43181h0 = hashSet;
        this.f43182i0 = new ArrayList();
        this.f43183j0 = new ArrayList();
        this.f43184k0 = new ArrayList();
        this.f43185l0 = new HashMap();
        this.m0 = new ArrayList();
        this.f43186n0 = new LinkedHashMap();
        this.f43189q0 = AndroidUtilities.dp(120.0f);
        this.f43190r0 = new ArrayList();
        this.f43191s0 = false;
        this.f43195w0 = new qg.b0(this, 4);
        this.f43196x0 = -1;
        this.C0 = new HashSet();
        ...
        this.X = i11;
        this.f43194v0 = birthdayState;
        ug.g gVar = this.f43188p0;
        if (gVar != null) {
            if (i11 == 4) {
                z10 = true;
            } else {
        ...
        i1Var.f45773b.setHintText(LocaleController.getString(i12), false);
        ...
        if (i11 == 4) {
            ...
            linearLayout.setBackground(i6.Y(getThemedColor(i6.f18926i6), 6, 6));
            np npVar = new np(context, 24, e6Var);
            this.f43176c0 = npVar;
            npVar.b(i6.Oh, i6.f18945j7, i6.f18965k7);
            npVar.setDrawUnchecked(true);
            npVar.a(false, false);
            npVar.setDrawBackgroundAsArc(10);
            linearLayout.addView(npVar, x5.t(26, 26, 16, 0, 0, 0, 0));
            TextView textView = new TextView(context);
            textView.setTextColor(getThemedColor(i6.f18943j5));
            ...
            linearLayout.setOnClickListener(new View.OnClickListener(this) {
                ...
                public final void onClick(View view) {
                    switch (r2) {
                        case 0:
                            np npVar2 = this.f43141b.f43176c0;
    ...
    public static void P(n1 n1Var, TLObject tLObject) {
        ...
        ArrayList arrayList = n1Var.f43184k0;
        arrayList.clear();
        n1Var.f43196x0 = -1;
    ...
    public static void Q(n1 n1Var, int i10, e6 e6Var, int i11, View view) {
        ...
        if (view instanceof r8) {
            ...
            c5.m(n1Var.getContext(), LocaleController.getString(R.string.EditProfileBirthdayTitle), LocaleController.getString(R.string.EditProfileBirthdayButton), null, new c1(n1Var, 2), new b1(n1Var, 9), false, false, n1Var.resourcesProvider).f18442a.show();
            ...
            if (user == null && chat == null && i10 == 3) {
                ...
                if (i10 == 1) {
                    ...
                    j7 j7Var = new j7(n1Var.getContext(), e6Var, user, new b1(n1Var, 11));
                    ...
                    if (i10 == 4 && hashSet.isEmpty()) {
                        ...
                        if (callback2 != null) {
                            np npVar = n1Var.f43176c0;
                            callback2.run(Boolean.valueOf((npVar == null || !npVar.f26547a.f21972q) ? false : false), hashSet);
                            n1Var.D0 = null;
                        }
                        n1Var.dismiss();
                        return;
                    ...
                    if (hashSet.contains(Long.valueOf(j10))) {
                        ...
                        hashSet.add(Long.valueOf(j10));
                        n1Var.f43186n0.put(Long.valueOf(j10), user);
                    }
                    ...
                    if (z10 != z11) {
                        ...
                        if (gVar.f43742y != z13) {
                            gVar.f43742y = z13;
                            AndroidUtilities.forEachViews((RecyclerView) gVar.f43736f, (e2.h) new m4.o0(3, z13));
                        }
                    }
                    n1Var.W();
                    ...
                    q1 q1Var = new q1(n1Var.getContext(), i11, j10, t.c(t.b(1, n1Var.f43190r0)), new c1(n1Var, 1));
                    BirthdayController.BirthdayState birthdayState = n1Var.f43194v0;
    ...
    public static void R(n1 n1Var, TLObject tLObject, TLRPC.UserFull userFull, TL_account.TL_birthday tL_birthday, TLRPC.TL_error tL_error) {
        String str;
        FrameLayout frameLayout = n1Var.f43178e0;
            ...
            public final void run() {
                switch (r3) {
                        ...
                        if (user2 != null) {
                            ...
                            if (n2Var == null) {
                                ...
                                if (U != 0) {
                                    ...
                                    bundle.putLong("user_id", user2.f18259id);
                    ...
                    default:
                        ...
                        if (user3 != null) {
                            n2 n2Var2 = this.f43134b.f30528n;
                            if (n2Var2 == null) {
                                ...
                                if (U2 != 0) {
                                    ...
                                    bundle3.putLong("user_id", user3.f18259id);
                            ...
                            bundle4.putLong("user_id", user3.f18259id);
    ...
    public static void U(n1 n1Var, String str) {
        if (n1Var.f43196x0 >= 0) {
            ConnectionsManager.getInstance(n1Var.currentAccount).cancelRequest(n1Var.f43196x0, true);
            n1Var.f43196x0 = -1;
        }
        TLRPC.TL_contacts_search tL_contacts_search = new TLRPC.TL_contacts_search();
        tL_contacts_search.f18158q = str;
        n1Var.f43196x0 = ConnectionsManager.getInstance(n1Var.currentAccount).sendRequest(tL_contacts_search, new m8(n1Var, 21));
    }
    ...
    public final int V(String str, ArrayList arrayList, ArrayList arrayList2) {
        ...
        while (i11 < size) {
            ...
            if (user != null && !user.bot && !UserObject.isService(user.f18259id)) {
                long j3 = user.f18259id;
                if (j3 != 0 && !this.C0.contains(Long.valueOf(j3))) {
                    Long valueOf = Long.valueOf(user.f18259id);
                    HashSet hashSet = this.f43181h0;
                    hashSet.contains(valueOf);
                    i10 += AndroidUtilities.dp(56.0f);
                    ug.f c10 = ug.f.c(user, hashSet.contains(Long.valueOf(user.f18259id)));
                    Y(c10);
                    arrayList3.add(c10);
                }
            }
    ...
    public final void W() {
        int i10;
        if (this.f43181h0.isEmpty() && (i10 = this.X) != 1 && i10 != 2 && i10 != 3 && i10 != 4) {
            if (this.f43191s0) {
                this.f43191s0 = false;
                AndroidUtilities.runOnUIThread(new b1(this, 4), 10L);
            }
        } else if (!this.f43191s0) {
            this.f43191s0 = true;
    ...
    public final void X() {
        if (!TextUtils.isEmpty(this.f43187o0)) {
            this.f43187o0 = null;
            this.Z.setText("");
            AndroidUtilities.cancelRunOnUIThread(this.f43195w0);
            h0(true, true);
        }
    }
    ...
    public final ug.f Y(ug.f fVar) {
        ...
        if (i10 == 4) {
            ...
            final long j3 = user.f18259id;
            ?? r22 = new View.OnClickListener(this) {
                public final n1 f43125b;
                ...
                public final void onClick(View view) {
                    switch (r4) {
                        case 0:
                            ...
                            return;
                        default:
                            n1 n1Var2 = this.f43125b;
                            HashSet hashSet2 = n1Var2.f43181h0;
    ...
    public final void b0(boolean z10) {
        ArrayList arrayList = this.f43182i0;
        if (arrayList.isEmpty()) {
            arrayList.addAll(ContactsController.getInstance(this.currentAccount).contacts);
            this.f43185l0.putAll(ContactsController.getInstance(this.currentAccount).usersSectionsDict);
    ...
    public final void c0(boolean z10) {
        ArrayList arrayList = this.f43183j0;
        if (arrayList.isEmpty()) {
    ...
    public final void d0() {
        HashSet hashSet = this.f43181h0;
        if (hashSet.size() != 0) {
            ArrayList arrayList = this.f43190r0;
            boolean isEmpty = arrayList.isEmpty();
            int i10 = this.X;
            if (!isEmpty || i10 == 0 || i10 == 2 || i10 == 4) {
                ArrayList arrayList2 = new ArrayList();
                for (TLRPC.User user : this.f43186n0.values()) {
                ...
                if (i10 != 1) {
                    ...
                    if (arrayList2.size() == 1) {
                        long j3 = ((TLRPC.User) arrayList2.get(0)).f18259id;
                        ...
                        BirthdayController.BirthdayState birthdayState = this.f43194v0;
    ...
    public final void g0(boolean z10) {
        ...
        if (i10 == 4) {
            ...
            if (LocaleController.isRTL) {
                ...
                spannableStringBuilder.append((CharSequence) "d").setSpan(this.f43193u0, spannableStringBuilder.length() - 1, spannableStringBuilder.length(), 33);
            } else {
                spannableStringBuilder.append((CharSequence) "d").setSpan(this.f43193u0, 0, 1, 33);
                spannableStringBuilder.append((CharSequence) LocaleController.getString("GiftPremiumChooseRecipientsBtn", R.string.GiftPremiumChooseRecipientsBtn));
            }
        } else {
    ...
    public final void i0(boolean z10, boolean z11) {
        ...
        while (true) {
            ...
            if ((childAt instanceof xg.l) && (R = RecyclerView.R(childAt)) - 1 >= 0) {
                ArrayList arrayList = this.f43180g0;
