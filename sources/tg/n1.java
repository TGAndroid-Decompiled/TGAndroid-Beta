...
public class n1 extends za implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final k1 Y;
    public final i1 Z;
    public final j1 f43170a0;
    public final h1 f43171b0;
    public final np f43172c0;
    public final o20 f43173d0;
    public final FrameLayout f43174e0;
    public final ArrayList f43175f0;
    public final ArrayList f43176g0;
    public final HashSet f43177h0;
    public final ArrayList f43178i0;
    public final ArrayList f43179j0;
    public final ArrayList f43180k0;
    public final HashMap f43181l0;
    public final ArrayList m0;
    public final LinkedHashMap f43182n0;
    public String f43183o0;
    public ug.g f43184p0;
    public int f43185q0;
    public final ArrayList f43186r0;
    public boolean f43187s0;
    public float f43188t0;
    public ra0 f43189u0;
    public final BirthdayController.BirthdayState f43190v0;
    public final qg.b0 f43191w0;
    public int f43192x0;
    public pq f43193y0;
    public String f43194z0;
    ...
    public n1(Context context, int i10, BirthdayController.BirthdayState birthdayState, int i11, e6 e6Var) {
        ...
        float f7;
        boolean z10;
        this.f43175f0 = new ArrayList();
        ArrayList arrayList = new ArrayList();
        this.f43176g0 = arrayList;
        HashSet hashSet = new HashSet();
        this.f43177h0 = hashSet;
        this.f43178i0 = new ArrayList();
        this.f43179j0 = new ArrayList();
        this.f43180k0 = new ArrayList();
        this.f43181l0 = new HashMap();
        this.m0 = new ArrayList();
        this.f43182n0 = new LinkedHashMap();
        this.f43185q0 = AndroidUtilities.dp(120.0f);
        this.f43186r0 = new ArrayList();
        this.f43187s0 = false;
        this.f43191w0 = new qg.b0(this, 4);
        this.f43192x0 = -1;
        this.C0 = new HashSet();
        ...
        this.X = i11;
        this.f43190v0 = birthdayState;
        ug.g gVar = this.f43184p0;
        if (gVar != null) {
            if (i11 == 4) {
                z10 = true;
            } else {
        ...
        i1Var.f45769b.setHintText(LocaleController.getString(i12), false);
        ...
        o20Var.setBackgroundColor(i6.v0(i13, e6Var));
        if (i11 == 4) {
            ...
            linearLayout.setBackground(i6.Y(getThemedColor(i6.f18923i6), 6, 6));
            np npVar = new np(context, 24, e6Var);
            this.f43172c0 = npVar;
            npVar.b(i6.Oh, i6.f18942j7, i6.f18962k7);
            npVar.setDrawUnchecked(true);
            npVar.a(false, false);
            npVar.setDrawBackgroundAsArc(10);
            linearLayout.addView(npVar, x5.t(26, 26, 16, 0, 0, 0, 0));
            TextView textView = new TextView(context);
            textView.setTextColor(getThemedColor(i6.f18940j5));
            ...
            linearLayout.setOnClickListener(new View.OnClickListener(this) {
                ...
                public final void onClick(View view) {
                    switch (r2) {
                        case 0:
                            np npVar2 = this.f43137b.f43172c0;
    ...
    public static void P(n1 n1Var, TLObject tLObject) {
        ...
        ArrayList arrayList = n1Var.f43180k0;
        arrayList.clear();
        n1Var.f43192x0 = -1;
    ...
    public static void Q(n1 n1Var, int i10, e6 e6Var, int i11, View view) {
        ...
        float f7;
        b1 b1Var;
        o20 o20Var = n1Var.f43173d0;
        i1 i1Var = n1Var.Z;
        HashSet hashSet = n1Var.f43177h0;
        if (view instanceof r8) {
            ...
            c5.m(n1Var.getContext(), LocaleController.getString(R.string.EditProfileBirthdayTitle), LocaleController.getString(R.string.EditProfileBirthdayButton), null, new c1(n1Var, 2), new b1(n1Var, 9), false, false, n1Var.resourcesProvider).f18440a.show();
            ...
            if (user == null && chat == null && i10 == 3) {
                ...
                if (i10 == 1) {
                    ...
                    if (i10 == 4 && hashSet.isEmpty()) {
                        ...
                        if (callback2 != null) {
                            np npVar = n1Var.f43172c0;
                            callback2.run(Boolean.valueOf((npVar == null || !npVar.f26546a.f21969q) ? false : false), hashSet);
                            n1Var.D0 = null;
                        }
                        n1Var.dismiss();
                        return;
                    ...
                    if (hashSet.contains(Long.valueOf(j10))) {
                        ...
                        hashSet.add(Long.valueOf(j10));
                        n1Var.f43182n0.put(Long.valueOf(j10), user);
                    }
                    ...
                    if (z10 != z11) {
                        ...
                        ug.g gVar = n1Var.f43184p0;
                        boolean z13 = !z11;
                        if (gVar.f43738y != z13) {
                            gVar.f43738y = z13;
                            AndroidUtilities.forEachViews((RecyclerView) gVar.f43732f, (e2.h) new m4.o0(3, z13));
                        }
                    }
                    n1Var.W();
                    ...
                    new vc(n1Var.container, e6Var).Q(R.raw.error, 36, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.UserDisallowedGifts, DialogObject.getShortName(j10)))).j();
                } else {
                    q1 q1Var = new q1(n1Var.getContext(), i11, j10, t.c(t.b(1, n1Var.f43186r0)), new c1(n1Var, 1));
                    BirthdayController.BirthdayState birthdayState = n1Var.f43190v0;
    ...
    public static void R(n1 n1Var, TLObject tLObject, TLRPC.UserFull userFull, TL_account.TL_birthday tL_birthday, TLRPC.TL_error tL_error) {
        String str;
        FrameLayout frameLayout = n1Var.f43174e0;
            ...
            public final void run() {
                switch (r3) {
                        ...
                        if (user2 != null) {
                            ...
                            if (n2Var == null) {
                                ...
                                if (U != 0) {
                                    ...
                                    bundle.putLong("user_id", user2.f18256id);
                    ...
                    default:
                        ...
                        if (user3 != null) {
                            n2 n2Var2 = this.f43130b.f30525n;
                            if (n2Var2 == null) {
                                ...
                                if (U2 != 0) {
                                    ...
                                    bundle3.putLong("user_id", user3.f18256id);
                            ...
                            bundle4.putLong("user_id", user3.f18256id);
    ...
    public static void U(n1 n1Var, String str) {
        if (n1Var.f43192x0 >= 0) {
            ConnectionsManager.getInstance(n1Var.currentAccount).cancelRequest(n1Var.f43192x0, true);
            n1Var.f43192x0 = -1;
        }
        TLRPC.TL_contacts_search tL_contacts_search = new TLRPC.TL_contacts_search();
        tL_contacts_search.f18155q = str;
        n1Var.f43192x0 = ConnectionsManager.getInstance(n1Var.currentAccount).sendRequest(tL_contacts_search, new m8(n1Var, 21));
    }
    ...
    public final int V(String str, ArrayList arrayList, ArrayList arrayList2) {
        ...
        while (i11 < size) {
            ...
            if (user != null && !user.bot && !UserObject.isService(user.f18256id)) {
                long j3 = user.f18256id;
                if (j3 != 0 && !this.C0.contains(Long.valueOf(j3))) {
                    Long valueOf = Long.valueOf(user.f18256id);
                    HashSet hashSet = this.f43177h0;
                    hashSet.contains(valueOf);
                    i10 += AndroidUtilities.dp(56.0f);
                    ug.f c10 = ug.f.c(user, hashSet.contains(Long.valueOf(user.f18256id)));
                    Y(c10);
                    arrayList3.add(c10);
                }
            }
    ...
    public final void W() {
        int i10;
        if (this.f43177h0.isEmpty() && (i10 = this.X) != 1 && i10 != 2 && i10 != 3 && i10 != 4) {
            if (this.f43187s0) {
                this.f43187s0 = false;
                AndroidUtilities.runOnUIThread(new b1(this, 4), 10L);
            }
        } else if (!this.f43187s0) {
            this.f43187s0 = true;
    ...
    public final void X() {
        if (!TextUtils.isEmpty(this.f43183o0)) {
            this.f43183o0 = null;
            this.Z.setText("");
            AndroidUtilities.cancelRunOnUIThread(this.f43191w0);
            h0(true, true);
        }
    }
    ...
    public final ug.f Y(ug.f fVar) {
        ...
        int i10 = this.X;
        if (i10 == 4) {
            TLRPC.User user = fVar.f43719c;
            if (user == null) {
                return fVar;
            }
            final long j3 = user.f18256id;
            ?? r22 = new View.OnClickListener(this) {
                public final n1 f43121b;
                ...
                public final void onClick(View view) {
                    switch (r4) {
                        case 0:
                            ...
                            return;
                        default:
                            n1 n1Var2 = this.f43121b;
                            HashSet hashSet2 = n1Var2.f43177h0;
    ...
    public final void b0(boolean z10) {
        ArrayList arrayList = this.f43178i0;
        if (arrayList.isEmpty()) {
            arrayList.addAll(ContactsController.getInstance(this.currentAccount).contacts);
            this.f43181l0.putAll(ContactsController.getInstance(this.currentAccount).usersSectionsDict);
    ...
    public final void c0(boolean z10) {
        ArrayList arrayList = this.f43179j0;
        if (arrayList.isEmpty()) {
    ...
    public final void d0() {
        HashSet hashSet = this.f43177h0;
        if (hashSet.size() != 0) {
            ArrayList arrayList = this.f43186r0;
            boolean isEmpty = arrayList.isEmpty();
            int i10 = this.X;
            if (!isEmpty || i10 == 0 || i10 == 2 || i10 == 4) {
                ArrayList arrayList2 = new ArrayList();
                for (TLRPC.User user : this.f43182n0.values()) {
                ...
                if (i10 != 1) {
                    ...
                    if (arrayList2.size() == 1) {
                        long j3 = ((TLRPC.User) arrayList2.get(0)).f18256id;
                        ...
                        BirthdayController.BirthdayState birthdayState = this.f43190v0;
    ...
    public final void g0(boolean z10) {
        ...
        if (i10 == 4) {
            ...
            if (LocaleController.isRTL) {
                ...
                spannableStringBuilder.append((CharSequence) "d").setSpan(this.f43189u0, spannableStringBuilder.length() - 1, spannableStringBuilder.length(), 33);
            } else {
                spannableStringBuilder.append((CharSequence) "d").setSpan(this.f43189u0, 0, 1, 33);
                spannableStringBuilder.append((CharSequence) LocaleController.getString("GiftPremiumChooseRecipientsBtn", R.string.GiftPremiumChooseRecipientsBtn));
            }
        } else {
    ...
    public final void i0(boolean z10, boolean z11) {
        ...
        while (true) {
            ...
            if ((childAt instanceof xg.l) && (R = RecyclerView.R(childAt)) - 1 >= 0) {
                ArrayList arrayList = this.f43176g0;
                if (R2 < arrayList.size()) {
                    if (i11 == -1) {
                        i11 = R;
                    }
                    ug.f fVar = (ug.f) arrayList.get(R2);
                    xg.l lVar = (xg.l) childAt;
                    lVar.c(fVar.f43724k, z10);
                    TLRPC.Chat chat = fVar.e;
                    float f7 = 1.0f;
                    if (chat != null) {
                        if (this.f43184p0.F(chat) > 200) {
                            f7 = 0.3f;
                        }
                        lVar.i(f7, z10);
                    } else {
