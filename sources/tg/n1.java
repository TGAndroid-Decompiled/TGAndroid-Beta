...
public class n1 extends za implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final k1 Y;
    public final i1 Z;
    public final j1 f43202a0;
    public final h1 f43203b0;
    public final np f43204c0;
    public final q20 f43205d0;
    public final FrameLayout f43206e0;
    public final ArrayList f43207f0;
    public final ArrayList f43208g0;
    public final HashSet f43209h0;
    public final ArrayList f43210i0;
    public final ArrayList f43211j0;
    public final ArrayList f43212k0;
    public final HashMap f43213l0;
    public final ArrayList m0;
    public final LinkedHashMap f43214n0;
    public String f43215o0;
    public ug.g f43216p0;
    public int f43217q0;
    public final ArrayList f43218r0;
    public boolean f43219s0;
    public float f43220t0;
    public ra0 f43221u0;
    public final BirthdayController.BirthdayState f43222v0;
    public final qg.b0 f43223w0;
    public int f43224x0;
    public pq f43225y0;
    public String f43226z0;
    ...
    public n1(Context context, int i10, BirthdayController.BirthdayState birthdayState, int i11, f6 f6Var) {
        ...
        float f7;
        boolean z10;
        this.f43207f0 = new ArrayList();
        ArrayList arrayList = new ArrayList();
        this.f43208g0 = arrayList;
        HashSet hashSet = new HashSet();
        this.f43209h0 = hashSet;
        this.f43210i0 = new ArrayList();
        this.f43211j0 = new ArrayList();
        this.f43212k0 = new ArrayList();
        this.f43213l0 = new HashMap();
        this.m0 = new ArrayList();
        this.f43214n0 = new LinkedHashMap();
        this.f43217q0 = AndroidUtilities.dp(120.0f);
        this.f43218r0 = new ArrayList();
        this.f43219s0 = false;
        this.f43223w0 = new qg.b0(this, 4);
        this.f43224x0 = -1;
        this.C0 = new HashSet();
        ...
        this.X = i11;
        this.f43222v0 = birthdayState;
        ug.g gVar = this.f43216p0;
        if (gVar != null) {
            if (i11 == 4) {
                z10 = true;
            } else {
        ...
        i1Var.f45801b.setHintText(LocaleController.getString(i12), false);
        ...
        if (i11 == 4) {
            ...
            linearLayout.setBackground(j6.Y(getThemedColor(j6.f18953i6), 6, 6));
            np npVar = new np(context, 24, f6Var);
            this.f43204c0 = npVar;
            npVar.b(j6.Oh, j6.f18972j7, j6.f18992k7);
            npVar.setDrawUnchecked(true);
            npVar.a(false, false);
            npVar.setDrawBackgroundAsArc(10);
            linearLayout.addView(npVar, x5.t(26, 26, 16, 0, 0, 0, 0));
            TextView textView = new TextView(context);
            textView.setTextColor(getThemedColor(j6.f18970j5));
            ...
            linearLayout.setOnClickListener(new View.OnClickListener(this) {
                ...
                public final void onClick(View view) {
                    switch (r2) {
                        case 0:
                            np npVar2 = this.f43168b.f43204c0;
    ...
    public static void P(n1 n1Var, TLObject tLObject) {
        ...
        ArrayList arrayList = n1Var.f43212k0;
        arrayList.clear();
        n1Var.f43224x0 = -1;
    ...
    public static void Q(n1 n1Var, int i10, f6 f6Var, int i11, View view) {
        ...
        float f7;
        b1 b1Var;
        q20 q20Var = n1Var.f43205d0;
        i1 i1Var = n1Var.Z;
        HashSet hashSet = n1Var.f43209h0;
        if (view instanceof r8) {
            ...
            c5.m(n1Var.getContext(), LocaleController.getString(R.string.EditProfileBirthdayTitle), LocaleController.getString(R.string.EditProfileBirthdayButton), null, new c1(n1Var, 2), new b1(n1Var, 9), false, false, n1Var.resourcesProvider).f18471a.show();
            ...
            if (user == null && chat == null && i10 == 3) {
                ...
                if (i10 == 1) {
                    ...
                    if (i10 == 4 && hashSet.isEmpty()) {
                        ...
                        if (callback2 != null) {
                            np npVar = n1Var.f43204c0;
                            callback2.run(Boolean.valueOf((npVar == null || !npVar.f26511a.f21985q) ? false : false), hashSet);
                            n1Var.D0 = null;
                        }
                        n1Var.dismiss();
                        return;
                    ...
                    if (hashSet.contains(Long.valueOf(j10))) {
                        ...
                        hashSet.add(Long.valueOf(j10));
                        n1Var.f43214n0.put(Long.valueOf(j10), user);
                    }
                    ...
                    if (z10 != z11) {
                        ...
                        ug.g gVar = n1Var.f43216p0;
                        boolean z13 = !z11;
                        if (gVar.f43770y != z13) {
                            gVar.f43770y = z13;
                            AndroidUtilities.forEachViews((RecyclerView) gVar.f43764f, (e2.h) new m4.o0(3, z13));
                        }
                    }
                    n1Var.W();
                    ...
                    q1 q1Var = new q1(n1Var.getContext(), i11, j10, t.c(t.b(1, n1Var.f43218r0)), new c1(n1Var, 1));
                    BirthdayController.BirthdayState birthdayState = n1Var.f43222v0;
    ...
    public static void R(n1 n1Var, TLObject tLObject, TLRPC.UserFull userFull, TL_account.TL_birthday tL_birthday, TLRPC.TL_error tL_error) {
        String str;
        FrameLayout frameLayout = n1Var.f43206e0;
            ...
            public final void run() {
                switch (r3) {
                    ...
                    default:
                        ...
                        if (user3 != null) {
                            o2 o2Var2 = this.f43161b.f30454n;
                            if (o2Var2 == null) {
    ...
    public static void U(n1 n1Var, String str) {
        if (n1Var.f43224x0 >= 0) {
            ConnectionsManager.getInstance(n1Var.currentAccount).cancelRequest(n1Var.f43224x0, true);
            n1Var.f43224x0 = -1;
        }
        TLRPC.TL_contacts_search tL_contacts_search = new TLRPC.TL_contacts_search();
        tL_contacts_search.f18167q = str;
        n1Var.f43224x0 = ConnectionsManager.getInstance(n1Var.currentAccount).sendRequest(tL_contacts_search, new m8(n1Var, 21));
    }
    ...
    public final void W() {
        int i10;
        if (this.f43209h0.isEmpty() && (i10 = this.X) != 1 && i10 != 2 && i10 != 3 && i10 != 4) {
            if (this.f43219s0) {
                this.f43219s0 = false;
                AndroidUtilities.runOnUIThread(new b1(this, 4), 10L);
            }
        } else if (!this.f43219s0) {
            this.f43219s0 = true;
    ...
    public final void X() {
        if (!TextUtils.isEmpty(this.f43215o0)) {
            this.f43215o0 = null;
            this.Z.setText("");
            AndroidUtilities.cancelRunOnUIThread(this.f43223w0);
            h0(true, true);
        }
    }
                ...
                public final void onClick(View view) {
                    switch (r4) {
                        case 0:
                            ...
                            return;
                        default:
                            n1 n1Var2 = this.f43152b;
                            HashSet hashSet2 = n1Var2.f43209h0;
    ...
    public final void b0(boolean z10) {
        ArrayList arrayList = this.f43210i0;
        if (arrayList.isEmpty()) {
            arrayList.addAll(ContactsController.getInstance(this.currentAccount).contacts);
            this.f43213l0.putAll(ContactsController.getInstance(this.currentAccount).usersSectionsDict);
    ...
    public final void c0(boolean z10) {
        ArrayList arrayList = this.f43211j0;
        if (arrayList.isEmpty()) {
    ...
    public final void d0() {
        HashSet hashSet = this.f43209h0;
        if (hashSet.size() != 0) {
            ArrayList arrayList = this.f43218r0;
            boolean isEmpty = arrayList.isEmpty();
            int i10 = this.X;
            if (!isEmpty || i10 == 0 || i10 == 2 || i10 == 4) {
                ArrayList arrayList2 = new ArrayList();
                for (TLRPC.User user : this.f43214n0.values()) {
                ...
                if (i10 != 1) {
                    ...
                    if (arrayList2.size() == 1) {
                        ...
                        BirthdayController.BirthdayState birthdayState = this.f43222v0;
    ...
    public final void g0(boolean z10) {
        ...
        if (i10 == 4) {
            ...
            if (LocaleController.isRTL) {
                ...
                spannableStringBuilder.append((CharSequence) "d").setSpan(this.f43221u0, spannableStringBuilder.length() - 1, spannableStringBuilder.length(), 33);
            } else {
                spannableStringBuilder.append((CharSequence) "d").setSpan(this.f43221u0, 0, 1, 33);
                spannableStringBuilder.append((CharSequence) LocaleController.getString("GiftPremiumChooseRecipientsBtn", R.string.GiftPremiumChooseRecipientsBtn));
            }
        } else {
    ...
    public final void i0(boolean z10, boolean z11) {
        ...
        while (true) {
            ...
            if ((childAt instanceof xg.l) && (S = RecyclerView.S(childAt)) - 1 >= 0) {
                ArrayList arrayList = this.f43208g0;
