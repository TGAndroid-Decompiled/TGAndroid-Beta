...
public final class m extends f3 {
    public static m e;
    public final k f43448b;
    public final z0 f43449c;
    public boolean d;
    ...
    public m(Activity activity, a0 a0Var, z0 z0Var, f6 f6Var, boolean z10) {
        ...
        fixNavigationBar();
        if (i0.a.f(j6.v0(j6.f19165h5, this.resourcesProvider)) > 0.699999988079071d) {
            z11 = true;
        } else {
            z11 = false;
        }
        ...
        kVar.setPosition(0);
        setCustomView(kVar);
        a0Var.f43383t0 = new j(this, 0);
        a0Var.f43381r0 = new m5.e(this, z0Var, false, 22);
        z0Var.f43545u0 = new l(this, a0Var, f6Var);
        z0Var.f43543s0 = new j(this, 1);
        if (!z10) {
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        boolean z10;
        this.f43449c.onConfigurationChanged(configuration);
