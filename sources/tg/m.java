...
public final class m extends j81 {
    ...
    public boolean W;
    public boolean f43190a0;
    public final boolean f43191b0;
    public final a1 f43192c0;
    public final f6 f43193d0;
    public final b0 f43194e0;
    public final o f43195f0;
    ...
    public m(o oVar, Context context, a1 a1Var, f6 f6Var, b0 b0Var) {
        ...
        this.U = new Path();
        this.V = new Paint(1);
        this.f43191b0 = AndroidUtilities.isTablet();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int i11;
        float f7;
        o oVar = this.f43195f0;
        m mVar = oVar.f43227b;
        int v02 = j6.v0(j6.f18934h5, this.f43193d0);
        Paint paint = this.V;
        paint.setColor(v02);
        if (this.W) {
            int i12 = -AndroidUtilities.dp(16.0f);
            b0 b0Var = this.f43194e0;
            int i13 = b0Var.f43132s0;
            ...
            a1 a1Var = this.f43192c0;
            int i14 = a1Var.f43109t0;
            if (a1Var.m0.f22940c == 1.0f) {
    ...
    public final float getAvailableTranslationX() {
        if (!this.f43191b0 && !this.f43195f0.d) {
    ...
    public final boolean i(MotionEvent motionEvent) {
        if (this.f43195f0.f43227b.getCurrentPosition() == 1) {
            return true;
        }
        return false;
    }
    ...
    public final void u() {
        this.W = false;
        this.f43195f0.f43227b.invalidate();
    }
        ...
        if (positionAnimated > 0.0f && positionAnimated < 1.0f) {
            if (!this.W) {
                ...
                if (oVar.isKeyboardVisible()) {
                    AndroidUtilities.hideKeyboard(oVar.f43228c.getContainerView());
                }
            }
        } else {
            this.W = false;
