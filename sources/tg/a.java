...
public final class a extends ReplacementSpan {
    public final Drawable f43347a;
    public final Drawable f43348b;
    public boolean f43349c;
    public boolean d;
    public final o6 e;
    public final TextPaint f43350f;
    public final int h;

    public a(u1 u1Var, TextPaint textPaint, int i10) {
        this.f43350f = textPaint;
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        int i15;
        TextPaint textPaint = this.f43350f;
        int color = textPaint.getColor();
        o6 o6Var = this.e;
        int color2 = o6Var.f26928a.getColor();
        Drawable drawable = this.f43348b;
        Drawable drawable2 = this.f43347a;
        if (color != color2) {
            o6Var.r(textPaint.getColor());
            int color3 = o6Var.f26928a.getColor();
            PorterDuff.Mode mode = PorterDuff.Mode.MULTIPLY;
            drawable2.setColorFilter(new PorterDuffColorFilter(color3, mode));
            drawable.setColorFilter(new PorterDuffColorFilter(o6Var.f26928a.getColor(), mode));
        }
        canvas.save();
        if (this.d && !this.f43349c) {
