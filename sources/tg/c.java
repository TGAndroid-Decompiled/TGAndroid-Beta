...
public final class c implements Runnable {
    ...
    public final void run() {
        ...
        boolean z11 = this.f43137b;
        Object obj = this.e;
        Object obj2 = this.d;
        Object obj3 = this.f43138c;
        switch (i12) {
            case 0:
                vc vcVar = (vc) obj3;
            ...
            default:
                ...
                int i14 = n5Var.f47513a;
                if (((int[]) obj2)[0] == n5Var.f47522m) {
                    n5Var.f47518i = false;
                    n5Var.f47522m = -1;
                    if (tLObject instanceof TL_stars.TL_payments_savedStarGifts) {
                        ...
                        n5Var.f47520k = tL_payments_savedStarGifts.next_offset;
                        n5Var.f47523n = tL_payments_savedStarGifts.count;
                        ...
                        n5Var.h = bool;
                        if (arrayList.size() <= n5Var.f47523n && n5Var.f47520k != null) {
                            z10 = false;
                        } else {
                            z10 = true;
                        }
                    ...
                    NotificationCenter.getInstance(i14).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starUserGiftsLoaded, Long.valueOf(n5Var.f47514b), n5Var);
                    return;
                }
                return;
        }
