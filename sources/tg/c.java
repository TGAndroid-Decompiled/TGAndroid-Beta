...
public abstract class c {
    public static final Matrix f44991a = new Matrix();
    public static final RectF f44992b = new RectF();
    public static final RectF f44993c = new RectF();

    public static void a(og.a aVar, Canvas canvas, RectF rectF, View view, ViewGroup viewGroup, int i10) {
        boolean z4;
        if (i10 > 0) {
            RectF rectF2 = f44993c;
            if (i.c(view, viewGroup, rectF2)) {
                float f10 = rectF2.left;
                float f11 = rectF2.top;
                RectF rectF3 = f44992b;
                rectF3.set(rectF);
