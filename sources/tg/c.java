...
public final class c implements Runnable {
    public final int f43114a = 0;
    public final boolean f43115b;
    public final Object f43116c;
    ...
    public final void run() {
        ...
        Boolean bool;
        boolean z10;
        int i12 = this.f43114a;
        boolean z11 = this.f43115b;
        Object obj = this.e;
        Object obj2 = this.d;
        Object obj3 = this.f43116c;
        switch (i12) {
            case 0:
                vc vcVar = (vc) obj3;
            ...
            default:
                ...
                int i14 = n5Var.f47490a;
                if (((int[]) obj2)[0] == n5Var.f47499m) {
                    n5Var.f47495i = false;
                    n5Var.f47499m = -1;
                    if (tLObject instanceof TL_stars.TL_payments_savedStarGifts) {
                        ...
                        n5Var.f47497k = tL_payments_savedStarGifts.next_offset;
                        n5Var.f47500n = tL_payments_savedStarGifts.count;
                        ...
                        n5Var.h = bool;
                        if (arrayList.size() <= n5Var.f47500n && n5Var.f47497k != null) {
                            z10 = false;
                        } else {
                            z10 = true;
                        }
                    ...
                    NotificationCenter.getInstance(i14).lambda$postNotificationNameOnUIThread$1(NotificationCenter.starUserGiftsLoaded, Long.valueOf(n5Var.f47491b), n5Var);
                    return;
                }
                return;
        }
