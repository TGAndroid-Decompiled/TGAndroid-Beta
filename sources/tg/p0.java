...
public final class p0 extends View {
    public Paint f43443a;
    public Drawable f43444b;

    @Override
    public final void onDraw(Canvas canvas) {
        float measuredWidth = getMeasuredWidth() / 2.0f;
        float measuredHeight = getMeasuredHeight() / 2.0f;
        canvas.drawCircle(measuredWidth, measuredHeight, getMeasuredWidth() / 2.0f, this.f43443a);
        ...
        Drawable drawable = this.f43444b;
