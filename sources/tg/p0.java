...
public final class p0 extends FrameLayout {
    public final u9 f43227a;
    public final q0 f43228b;
    public final Paint f43229c;
    public TLRPC.Chat d;
    public final f9 e;
    ...
    public p0(Context context) {
        ...
        view.f43233a = paint2;
        view.f43234b = view.getContext().getDrawable(R.drawable.mini_boost_remove);
        int i10 = j6.f18933h5;
    ...
    public final void dispatchDraw(Canvas canvas) {
        canvas.drawCircle(getMeasuredWidth() / 2.0f, getMeasuredHeight() / 2.0f, (getMeasuredHeight() / 2.0f) - AndroidUtilities.dp(2.0f), this.f43229c);
