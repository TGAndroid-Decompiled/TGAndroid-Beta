...
public final class y implements Utilities.Callback {
    public final a0 f43508a;
    public final TL_stories.TL_prepaidStarsGiveaway f43509b;
    ...
    public y(a0 a0Var, TL_stories.TL_prepaidStarsGiveaway tL_prepaidStarsGiveaway, long j3, long j10, TL_stories.PrepaidGiveaway prepaidGiveaway) {
        this.f43508a = a0Var;
        this.f43509b = tL_prepaidStarsGiveaway;
        this.f43510c = j3;
        this.d = j10;
    ...
    public final void run(Object obj) {
        Void r62 = (Void) obj;
        a0 a0Var = this.f43508a;
        a0Var.dismiss();
        if (this.f43509b != null) {
            m2 U = LaunchActivity.U();
            if (U != null) {
                wn R9 = wn.R9(this.f43510c);
