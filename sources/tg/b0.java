...
public final class b0 extends ug.e {
    ...
    public final void E() {
        String string;
        d6 d6Var;
        c0 c0Var = this.f43381r;
        String str = c0Var.f43386a0;
    ...
    public final void F(TLObject tLObject) {
        ...
        if (tLObject instanceof TLRPC.Chat) {
            m2Var.presentFragment(wn.R9(-((TLRPC.Chat) tLObject).f18336id));
        } else if (tLObject instanceof TLRPC.User) {
            m2Var.presentFragment(wn.R9(((TLRPC.User) tLObject).f18483id));
        } else {
