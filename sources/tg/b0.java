...
public final class b0 extends bb implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final List Y;
    public final List Z;
    public final List f43039a0;
    public final TLRPC.Chat f43040b0;
    public final ArrayList f43041c0;
    public final ArrayList f43042d0;
    public final ArrayList f43043e0;
    public final ArrayList f43044f0;
    public ug.b f43045g0;
    public int f43046h0;
    public int f43047i0;
    public int f43048j0;
    public boolean f43049k0;
    public int f43050l0;
    public long m0;
    public int f43051n0;
    public int f43052o0;
    public long f43053p0;
    public final vg.a f43054q0;
    public o0.a f43055r0;
    public int f43056s0;
    public l f43057t0;
    public final TL_stories.PrepaidGiveaway f43058u0;
    public String f43059v0;
    public boolean f43060w0;
    public boolean f43061x0;
    public final u f43062y0;
    ...
    public b0(n2 n2Var, long j3, TL_stories.PrepaidGiveaway prepaidGiveaway) {
        ...
        this.Z = asList2;
        this.f43039a0 = Arrays.asList(750, 10000, 50000);
        this.f43041c0 = new ArrayList();
        this.f43042d0 = new ArrayList();
        this.f43043e0 = new ArrayList();
        this.f43044f0 = new ArrayList();
        int i10 = vg.d.f44272s;
        this.f43046h0 = 2;
        this.f43047i0 = 0;
        int i11 = vg.u.f44305s;
        this.f43048j0 = 0;
        this.f43050l0 = 12;
        ...
        this.f43059v0 = "";
        this.f43061x0 = true;
        this.f43062y0 = new u(this, 0);
        this.f43058u0 = prepaidGiveaway;
        this.v = 0.15f;
    ...
    public static void P(b0 b0Var, TL_stories.PrepaidGiveaway prepaidGiveaway, long j3, n2 n2Var) {
        ...
        long j10;
        ArrayList arrayList = b0Var.f43043e0;
        ArrayList arrayList2 = b0Var.f43041c0;
        TLRPC.Chat chat = b0Var.f43040b0;
        ArrayList arrayList3 = b0Var.f43042d0;
        ArrayList arrayList4 = b0Var.f43044f0;
        vg.a aVar = b0Var.f43054q0;
        if (!aVar.f44247a.N) {
            if (b0Var.Y()) {
                if (prepaidGiveaway instanceof TL_stories.TL_prepaidStarsGiveaway) {
            ...
            int i11 = b0Var.f43046h0;
            int i12 = vg.d.f44272s;
            if (i11 == 3) {
                ...
                if (findActivity != null && !findActivity.isFinishing()) {
                    TL_stars.TL_starsGiveawayOption W = b0Var.W(b0Var.f43053p0);
                    int U = b0Var.U();
                    if (W != null) {
                        aVar.f44247a.setLoading(true);
                        int i13 = b0Var.f43048j0;
                        int i14 = vg.u.f44305s;
                        if (i13 == 1) {
                            z11 = true;
                        } else {
                            z11 = false;
                        ...
                        int l4 = t.l(b0Var.m0);
                        boolean z12 = b0Var.f43061x0;
                        boolean z13 = b0Var.f43060w0;
                        String str2 = b0Var.f43059v0;
                ...
                for (int i18 = 0; i18 < b10.size(); i18++) {
                    ...
                    if (tL_premiumGiftCodeOption.months == b0Var.f43050l0 && arrayList3.size() > 0) {
                        if (t.h()) {
                            ...
                            if (tL_premiumGiftCodeOption.store_product == null) {
                                ...
                                b2 b2Var2 = alertDialog$Builder2.f18409a;
                                b2Var2.R = string2;
                        ...
                        aVar.b(true);
                        t.k(arrayList3, tL_premiumGiftCodeOption, b0Var.f43040b0, null, n2Var, new w(b0Var, 0), new w(b0Var, 1));
                        return;
                    }
                }
            } else {
                ...
                for (int i21 = 0; i21 < b11.size(); i21++) {
                    ...
                    if (tL_premiumGiftCodeOption3.months == b0Var.f43050l0) {
                        if (t.h()) {
                            List list = b0Var.Y;
                            ...
                            if (tL_premiumGiftCodeOption3.store_product == null) {
                                ...
                                b2 b2Var3 = alertDialog$Builder3.f18409a;
                                b2Var3.R = string3;
                        ...
                        int i28 = b0Var.f43048j0;
                        int i29 = vg.u.f44305s;
                        if (i28 == 1) {
                            z10 = true;
                        } else {
                            z10 = false;
                        ...
                        aVar.b(true);
                        boolean z14 = b0Var.f43061x0;
                        boolean z15 = b0Var.f43060w0;
                        String str3 = b0Var.f43059v0;
                        ...
                        if (!t.h()) {
                            ...
                            while (i31 < size6) {
                                ...
                                if (tLObject instanceof TLRPC.Chat) {
                                    i10 = i32;
                                    tL_inputStorePaymentPremiumGiveaway.additional_peers.add(messagesController.getInputPeer(-((TLRPC.Chat) tLObject).f18083id));
                                } else {
                                    i10 = i32;
                                }
                                i31 = i10;
                            }
                            tL_inputStorePaymentPremiumGiveaway.boost_peer = messagesController.getInputPeer(-chat.f18083id);
                            tL_inputStorePaymentPremiumGiveaway.boost_peer = messagesController.getInputPeer(-chat.f18083id);
                            ...
                            connectionsManager.sendRequest(tL_payments_getPaymentForm2, new hd(wVar3, messagesController, tL_inputInvoicePremiumGiftCode, n2Var, wVar2, 12));
                            return;
                        }
                        ...
                        while (i35 < size8) {
                            ...
                            if (tLObject2 instanceof TLRPC.Chat) {
                                tL_inputStorePaymentPremiumGiveaway2.additional_peers.add(messagesController2.getInputPeer(-((TLRPC.Chat) tLObject2).f18083id));
                            }
                        }
                        tL_inputStorePaymentPremiumGiveaway2.boost_peer = messagesController2.getInputPeer(-chat.f18083id);
    ...
    public static void Q(b0 b0Var, n2 n2Var, View view) {
        ...
        o0.a aVar;
        boolean z11;
        ArrayList arrayList = b0Var.f43042d0;
        u uVar = b0Var.f43062y0;
        ...
        if (view instanceof vg.c) {
            if (view instanceof vg.d) {
                ...
                int i14 = vg.d.f44272s;
                if (selectedType != 2 && selectedType != 3) {
                    if (selectedType == 1) {
                        o0.a aVar3 = b0Var.f43055r0;
                        if (aVar3 != null) {
                            ((a1) aVar3.f15275b).V(1, arrayList);
                            ((o) aVar3.f15276c).f43150b.D(1);
                        }
                    } else {
                        b0Var.f43047i0 = selectedType;
                        b0Var.a0(true, true);
                        b0Var.Z(true);
                        b0Var.N();
                    }
                } else if (selectedType == 2 && b0Var.f43046h0 == selectedType) {
                    o0.a aVar4 = b0Var.f43055r0;
                    if (aVar4 != null) {
                        ((a1) aVar4.f15275b).V(1, arrayList);
                        ((o) aVar4.f15276c).f43150b.D(1);
                        return;
                    }
                    return;
                } else {
                    b0Var.f43046h0 = selectedType;
                    b0Var.a0(true, true);
                    b0Var.Z(true);
                    b0Var.N();
                }
        ...
        if (view instanceof vg.u) {
            ...
            if (b0Var.f43048j0 == selectedType2 && (aVar = b0Var.f43055r0) != null) {
                ((a1) aVar.f15275b).V(3, b0Var.f43043e0);
                ((o) aVar.f15276c).f43150b.D(1);
            }
            b0Var.f43048j0 = selectedType2;
            b0Var.a0(false, false);
        } else if (view instanceof vg.i) {
            b0Var.f43050l0 = ((TLRPC.TL_premiumGiftCodeOption) ((vg.i) view).getGifCode()).months;
            b0Var.a0(false, false);
            b0Var.f43045g0.G();
            ...
            rc0 u4Var = new u4(c4Var, (i) tc0Var2, (j) tc0Var3, i19, i20, tc0Var);
            tc0Var.setOnValueChangedListener(u4Var);
            tc0Var2.setMinValue(0);
            tc0Var2.setMaxValue(23);
            linearLayout.addView((View) tc0Var2, x5.l(0.2f, 0, 270));
            tc0Var2.setFormatter(new s0.b(17));
            tc0Var2.setOnValueChangedListener(u4Var);
            tc0Var3.setMinValue(0);
            tc0Var3.setMaxValue(11);
            tc0Var3.setValue(0);
            tc0Var3.setFormatter(new s0.b(18));
            linearLayout.addView((View) tc0Var3, x5.l(0.3f, 0, 270));
            tc0Var3.setOnValueChangedListener(u4Var);
            if (j3 > 0) {
                c5Var = c5Var2;
                ...
                tc0Var3.setValue(calendar.get(12) / 5);
                tc0Var2.setValue(calendar.get(11));
                tc0Var.setValue((int) ((j3 - calendar.getTimeInMillis()) / 86400000));
                tc0Var.getValue();
                u4Var.q(tc0Var, tc0Var.getValue());
                tc0Var2.getValue();
                u4Var.q(tc0Var2, tc0Var2.getValue());
            } else {
                c5Var = c5Var2;
            }
            bn0Var.setPadding(AndroidUtilities.dp(34.0f), 0, AndroidUtilities.dp(34.0f), 0);
            bn0Var.setGravity(17);
            bn0Var.setTextColor(c5Var.f22926g);
            ...
            bn0Var.setOnClickListener(new org.telegram.ui.Components.m0(calendar, tc0Var, tc0Var2, tc0Var3, vVar, a3Var));
            a3Var.b(c4Var);
            f3 f3Var = a3Var.f18414a;
            f3Var.show();
            ...
            o0.a aVar5 = b0Var.f43055r0;
            if (aVar5 != null) {
                ((a1) aVar5.f15275b).V(2, b0Var.f43041c0);
                ((o) aVar5.f15276c).f43150b.D(1);
            }
        } else if (view instanceof vg.w) {
            TL_stars.TL_starsGiveawayOption option = ((vg.w) view).getOption();
            if (option != null) {
                b0Var.f43053p0 = option.stars;
                b0Var.a0(true, true);
                b0Var.Z(true);
                b0Var.N();
            }
    ...
    public static void R(b0 b0Var) {
        rg.k1 k1Var = new rg.k1(b0Var.f22661n, b0Var.currentAccount, null, b0Var.resourcesProvider);
    ...
    public final int U() {
        int i10 = this.f43046h0;
        int i11 = vg.d.f44272s;
        if (i10 == 2) {
            return ((Integer) this.Y.get(this.f43051n0)).intValue();
        }
        List X = X();
        int i12 = this.f43052o0;
        if (i12 < 0 || i12 >= X.size()) {
            this.f43052o0 = 0;
        }
        if (this.f43052o0 >= X.size()) {
            return 0;
        }
        return ((Integer) X.get(this.f43052o0)).intValue();
    }
    ...
    public final int V() {
        ...
        int i11 = vg.d.f44272s;
        if (i10 == 2) {
            U = ((Integer) this.Y.get(this.f43051n0)).intValue();
            g10 = t.g();
        } else {
            TL_stars.TL_starsGiveawayOption W = W(this.f43053p0);
            if (W != null) {
    ...
    public final void Z(boolean z10) {
        boolean z11;
        boolean Y = Y();
        vg.a aVar = this.f43054q0;
        if (Y) {
            TL_stories.PrepaidGiveaway prepaidGiveaway = this.f43058u0;
            if (prepaidGiveaway instanceof TL_stories.TL_prepaidStarsGiveaway) {
        ...
        int i10 = this.f43047i0;
        int i11 = vg.d.f44272s;
        if (i10 == 0) {
            aVar.a(V(), z10);
            return;
        }
        ArrayList arrayList = this.f43042d0;
        ...
        aVar.e = true;
        ci.d dVar = aVar.f44247a;
        dVar.k();
        dVar.setShowZero(true);
        dVar.setEnabled(z11);
        dVar.b(g10, z10);
        dVar.g(LocaleController.getString(R.string.GiftPremium), z10, true);
        aVar.f44248b.setBackgroundColor(h6.v0(h6.f18859h5, aVar.f44249c));
    }
