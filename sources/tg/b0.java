...
public final class b0 extends za implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final List Y;
    public final List Z;
    public final List f43110a0;
    public final TLRPC.Chat f43111b0;
    public final ArrayList f43112c0;
    public final ArrayList f43113d0;
    public final ArrayList f43114e0;
    public final ArrayList f43115f0;
    public ug.b f43116g0;
    public int f43117h0;
    public int f43118i0;
    public int f43119j0;
    public boolean f43120k0;
    public int f43121l0;
    public long m0;
    public int f43122n0;
    public int f43123o0;
    public long f43124p0;
    public final vg.a f43125q0;
    public o0.a f43126r0;
    public int f43127s0;
    public l f43128t0;
    public final TL_stories.PrepaidGiveaway f43129u0;
    public String f43130v0;
    public boolean f43131w0;
    public boolean f43132x0;
    public final u f43133y0;
    ...
    public b0(o2 o2Var, long j3, TL_stories.PrepaidGiveaway prepaidGiveaway) {
        ...
        this.Z = asList2;
        this.f43110a0 = Arrays.asList(750, 10000, 50000);
        this.f43112c0 = new ArrayList();
        this.f43113d0 = new ArrayList();
        this.f43114e0 = new ArrayList();
        this.f43115f0 = new ArrayList();
        int i10 = vg.d.f44345s;
        this.f43117h0 = 2;
        this.f43118i0 = 0;
        int i11 = vg.u.f44378s;
        this.f43119j0 = 0;
        this.f43121l0 = 12;
        ...
        this.f43130v0 = "";
        this.f43132x0 = true;
        this.f43133y0 = new u(this, 0);
        this.f43129u0 = prepaidGiveaway;
        this.v = 0.15f;
    ...
    public static void P(b0 b0Var, TL_stories.PrepaidGiveaway prepaidGiveaway, long j3, o2 o2Var) {
        ...
        long j10;
        ArrayList arrayList = b0Var.f43114e0;
        ArrayList arrayList2 = b0Var.f43112c0;
        TLRPC.Chat chat = b0Var.f43111b0;
        ArrayList arrayList3 = b0Var.f43113d0;
        ArrayList arrayList4 = b0Var.f43115f0;
        vg.a aVar = b0Var.f43125q0;
        if (!aVar.f44320a.N) {
            if (b0Var.Y()) {
                if (prepaidGiveaway instanceof TL_stories.TL_prepaidStarsGiveaway) {
            ...
            int i11 = b0Var.f43117h0;
            int i12 = vg.d.f44345s;
            if (i11 == 3) {
                ...
                if (findActivity != null && !findActivity.isFinishing()) {
                    TL_stars.TL_starsGiveawayOption W = b0Var.W(b0Var.f43124p0);
                    int U = b0Var.U();
                    if (W != null) {
                        aVar.f44320a.setLoading(true);
                        ...
                        int l4 = t.l(b0Var.m0);
                        boolean z12 = b0Var.f43132x0;
                        boolean z13 = b0Var.f43131w0;
                        String str2 = b0Var.f43130v0;
                ...
                for (int i18 = 0; i18 < b10.size(); i18++) {
                    ...
                    if (tL_premiumGiftCodeOption.months == b0Var.f43121l0 && arrayList3.size() > 0) {
                        if (t.h()) {
                            ...
                            if (tL_premiumGiftCodeOption.store_product == null) {
                                ...
                                c2 c2Var2 = alertDialog$Builder2.f18446a;
                                c2Var2.R = string2;
                        ...
                        aVar.b(true);
                        t.k(arrayList3, tL_premiumGiftCodeOption, b0Var.f43111b0, null, o2Var, new w(b0Var, 0), new w(b0Var, 1));
                        return;
                    }
                }
            } else {
                ...
                for (int i21 = 0; i21 < b11.size(); i21++) {
                    ...
                    if (tL_premiumGiftCodeOption3.months == b0Var.f43121l0) {
                        if (t.h()) {
                            List list = b0Var.Y;
                            ...
                            if (tL_premiumGiftCodeOption3.store_product == null) {
                                ...
                                c2 c2Var3 = alertDialog$Builder3.f18446a;
                                c2Var3.R = string3;
                        ...
                        int i28 = b0Var.f43119j0;
                        int i29 = vg.u.f44378s;
                        if (i28 == 1) {
                            z10 = true;
                        } else {
                            z10 = false;
                        ...
                        aVar.b(true);
                        boolean z14 = b0Var.f43132x0;
                        boolean z15 = b0Var.f43131w0;
                        String str3 = b0Var.f43130v0;
    ...
    public static void Q(b0 b0Var, o2 o2Var, View view) {
        ...
        o0.a aVar;
        boolean z11;
        ArrayList arrayList = b0Var.f43113d0;
        u uVar = b0Var.f43133y0;
        ...
        if (view instanceof vg.c) {
            if (view instanceof vg.d) {
                ...
                int i14 = vg.d.f44345s;
                if (selectedType != 2 && selectedType != 3) {
                    if (selectedType == 1) {
                        o0.a aVar3 = b0Var.f43126r0;
                        if (aVar3 != null) {
                            ((a1) aVar3.f15310b).V(1, arrayList);
                            ((o) aVar3.f15311c).f43222b.E(1);
                        }
                    } else {
                        b0Var.f43118i0 = selectedType;
                        b0Var.a0(true, true);
                        b0Var.Z(true);
                        b0Var.N();
                    }
                } else if (selectedType == 2 && b0Var.f43117h0 == selectedType) {
                    o0.a aVar4 = b0Var.f43126r0;
                    if (aVar4 != null) {
                        ((a1) aVar4.f15310b).V(1, arrayList);
                        ((o) aVar4.f15311c).f43222b.E(1);
                        return;
                    }
                    return;
                } else {
                    b0Var.f43117h0 = selectedType;
                    b0Var.a0(true, true);
                    b0Var.Z(true);
                    b0Var.N();
                }
        ...
        if (view instanceof vg.u) {
            ...
            if (b0Var.f43119j0 == selectedType2 && (aVar = b0Var.f43126r0) != null) {
                ((a1) aVar.f15310b).V(3, b0Var.f43114e0);
                ((o) aVar.f15311c).f43222b.E(1);
            }
            b0Var.f43119j0 = selectedType2;
            b0Var.a0(false, false);
        } else if (view instanceof vg.i) {
            b0Var.f43121l0 = ((TLRPC.TL_premiumGiftCodeOption) ((vg.i) view).getGifCode()).months;
            b0Var.a0(false, false);
            b0Var.f43116g0.G();
            ...
            jn0Var.setTextColor(a5Var.f22320g);
            ...
            b3Var.b(a4Var);
            g3 g3Var = b3Var.f18470a;
            g3Var.show();
            int i21 = a5Var.f22317b;
            ...
            o0.a aVar5 = b0Var.f43126r0;
            if (aVar5 != null) {
                ((a1) aVar5.f15310b).V(2, b0Var.f43112c0);
                ((o) aVar5.f15311c).f43222b.E(1);
            }
        } else if (view instanceof vg.w) {
            TL_stars.TL_starsGiveawayOption option = ((vg.w) view).getOption();
            if (option != null) {
                b0Var.f43124p0 = option.stars;
                b0Var.a0(true, true);
                b0Var.Z(true);
                b0Var.N();
            }
    ...
    public static void R(b0 b0Var) {
        rg.k1 k1Var = new rg.k1(b0Var.f30451n, b0Var.currentAccount, null, b0Var.resourcesProvider);
    ...
    public final int U() {
        int i10 = this.f43117h0;
        int i11 = vg.d.f44345s;
        if (i10 == 2) {
            return ((Integer) this.Y.get(this.f43122n0)).intValue();
        }
        List X = X();
        int i12 = this.f43123o0;
        if (i12 < 0 || i12 >= X.size()) {
            this.f43123o0 = 0;
        }
        if (this.f43123o0 >= X.size()) {
            return 0;
        }
        return ((Integer) X.get(this.f43123o0)).intValue();
    }
    ...
    public final int V() {
        ...
        int i11 = vg.d.f44345s;
        if (i10 == 2) {
            U = ((Integer) this.Y.get(this.f43122n0)).intValue();
            g10 = t.g();
        } else {
            TL_stars.TL_starsGiveawayOption W = W(this.f43124p0);
            if (W != null) {
    ...
    public final void Z(boolean z10) {
        boolean z11;
        boolean Y = Y();
        vg.a aVar = this.f43125q0;
        if (Y) {
            TL_stories.PrepaidGiveaway prepaidGiveaway = this.f43129u0;
            if (prepaidGiveaway instanceof TL_stories.TL_prepaidStarsGiveaway) {
        ...
        int i10 = this.f43118i0;
        int i11 = vg.d.f44345s;
        if (i10 == 0) {
            aVar.a(V(), z10);
            return;
        }
        ArrayList arrayList = this.f43113d0;
        ...
        aVar.e = true;
        ci.d dVar = aVar.f44320a;
        dVar.k();
        dVar.setShowZero(true);
        dVar.setEnabled(z11);
        dVar.b(g10, z10);
        dVar.g(LocaleController.getString(R.string.GiftPremium), z10, true);
        aVar.f44321b.setBackgroundColor(j6.v0(j6.f18933h5, aVar.f44322c));
    }
