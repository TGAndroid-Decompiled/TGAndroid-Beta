...
public final class b0 extends za implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final List Y;
    public final List Z;
    public final List f43115a0;
    public final TLRPC.Chat f43116b0;
    public final ArrayList f43117c0;
    public final ArrayList f43118d0;
    public final ArrayList f43119e0;
    public final ArrayList f43120f0;
    public ug.b f43121g0;
    public int f43122h0;
    public int f43123i0;
    public int f43124j0;
    public boolean f43125k0;
    public int f43126l0;
    public long m0;
    public int f43127n0;
    public int f43128o0;
    public long f43129p0;
    public final vg.a f43130q0;
    public o0.a f43131r0;
    public int f43132s0;
    public l f43133t0;
    public final TL_stories.PrepaidGiveaway f43134u0;
    public String f43135v0;
    public boolean f43136w0;
    public boolean f43137x0;
    public final u f43138y0;
    ...
    public b0(o2 o2Var, long j3, TL_stories.PrepaidGiveaway prepaidGiveaway) {
        ...
        this.Z = asList2;
        this.f43115a0 = Arrays.asList(750, 10000, 50000);
        this.f43117c0 = new ArrayList();
        this.f43118d0 = new ArrayList();
        this.f43119e0 = new ArrayList();
        this.f43120f0 = new ArrayList();
        int i10 = vg.d.f44350s;
        this.f43122h0 = 2;
        this.f43123i0 = 0;
        int i11 = vg.u.f44383s;
        this.f43124j0 = 0;
        this.f43126l0 = 12;
        ...
        this.f43135v0 = "";
        this.f43137x0 = true;
        this.f43138y0 = new u(this, 0);
        this.f43134u0 = prepaidGiveaway;
        this.v = 0.15f;
    ...
    public static void P(b0 b0Var, TL_stories.PrepaidGiveaway prepaidGiveaway, long j3, o2 o2Var) {
        ...
        long j10;
        ArrayList arrayList = b0Var.f43119e0;
        ArrayList arrayList2 = b0Var.f43117c0;
        TLRPC.Chat chat = b0Var.f43116b0;
        ArrayList arrayList3 = b0Var.f43118d0;
        ArrayList arrayList4 = b0Var.f43120f0;
        vg.a aVar = b0Var.f43130q0;
        if (!aVar.f44325a.N) {
            if (b0Var.Y()) {
                if (prepaidGiveaway instanceof TL_stories.TL_prepaidStarsGiveaway) {
            ...
            if (i11 == 3) {
                ...
                if (findActivity != null && !findActivity.isFinishing()) {
                    TL_stars.TL_starsGiveawayOption W = b0Var.W(b0Var.f43129p0);
                    int U = b0Var.U();
                    if (W != null) {
                        aVar.f44325a.setLoading(true);
                        int i13 = b0Var.f43124j0;
                        int i14 = vg.u.f44383s;
                        if (i13 == 1) {
                            z11 = true;
                        } else {
                            z11 = false;
                        ...
                        int l4 = t.l(b0Var.m0);
                        boolean z12 = b0Var.f43137x0;
                        boolean z13 = b0Var.f43136w0;
                        String str2 = b0Var.f43135v0;
                ...
                for (int i18 = 0; i18 < b10.size(); i18++) {
                    ...
                    if (tL_premiumGiftCodeOption.months == b0Var.f43126l0 && arrayList3.size() > 0) {
                        if (t.h()) {
                            ...
                            if (tL_premiumGiftCodeOption.store_product == null) {
                                ...
                                c2 c2Var2 = alertDialog$Builder2.f18447a;
                                c2Var2.R = string2;
                                c2Var2.T = AndroidUtilities.replaceTags(LocaleController.formatPluralString("BoostingReduceUsersTextPlural", i20, join));
                                alertDialog$Builder2.k(LocaleController.getString("OK", R.string.OK), new t0.a(3));
                                alertDialog$Builder2.o();
                                return;
                            }
                        }
                        aVar.b(true);
                        t.k(arrayList3, tL_premiumGiftCodeOption, b0Var.f43116b0, null, o2Var, new w(b0Var, 0), new w(b0Var, 1));
                        return;
                    }
                }
            } else {
                ...
                for (int i21 = 0; i21 < b11.size(); i21++) {
                    ...
                    if (tL_premiumGiftCodeOption3.months == b0Var.f43126l0) {
                        if (t.h()) {
                            List list = b0Var.Y;
                            ...
                            if (tL_premiumGiftCodeOption3.store_product == null) {
                                ...
                                c2 c2Var3 = alertDialog$Builder3.f18447a;
                                c2Var3.R = string3;
                                c2Var3.T = AndroidUtilities.replaceTags(LocaleController.formatPluralString("BoostingReduceQuantityTextPlural", i26, formatPluralString, Integer.valueOf(i27)));
                                alertDialog$Builder3.k(LocaleController.getString("Reduce", R.string.Reduce), new d(1, wVar, tL_premiumGiftCodeOption5));
                                alertDialog$Builder3.h(LocaleController.getString("Cancel", R.string.Cancel), new t0.a(3));
                                alertDialog$Builder3.o();
                                return;
                            }
                        }
                        int i28 = b0Var.f43124j0;
                        int i29 = vg.u.f44383s;
                        if (i28 == 1) {
                            z10 = true;
                        } else {
                            z10 = false;
                        ...
                        aVar.b(true);
                        boolean z14 = b0Var.f43137x0;
                        boolean z15 = b0Var.f43136w0;
                        String str3 = b0Var.f43135v0;
                        ...
                        if (!t.h()) {
                            ...
                            while (i31 < size6) {
                                ...
                                if (tLObject instanceof TLRPC.Chat) {
                                    i10 = i32;
                                    tL_inputStorePaymentPremiumGiveaway.additional_peers.add(messagesController.getInputPeer(-((TLRPC.Chat) tLObject).f18121id));
                                } else {
                                    i10 = i32;
                                }
                                i31 = i10;
                            }
                            tL_inputStorePaymentPremiumGiveaway.boost_peer = messagesController.getInputPeer(-chat.f18121id);
                            tL_inputStorePaymentPremiumGiveaway.boost_peer = messagesController.getInputPeer(-chat.f18121id);
                            ...
                            connectionsManager.sendRequest(tL_payments_getPaymentForm2, new kd(wVar3, messagesController, tL_inputInvoicePremiumGiftCode, o2Var, wVar2, 12));
                            return;
                        }
                        ...
                        while (i35 < size8) {
                            ...
                            if (tLObject2 instanceof TLRPC.Chat) {
                                tL_inputStorePaymentPremiumGiveaway2.additional_peers.add(messagesController2.getInputPeer(-((TLRPC.Chat) tLObject2).f18121id));
                            }
                        }
                        tL_inputStorePaymentPremiumGiveaway2.boost_peer = messagesController2.getInputPeer(-chat.f18121id);
                        ...
                        BillingController.getInstance().queryProductDetails(Arrays.asList(obj11.a()), new org.telegram.ui.Components.d1(tL_inputStorePaymentPremiumGiveaway2, tL_premiumGiftCodeOption3, connectionsManager2, wVar3, wVar2, o2Var, 3));
                        return;
                    }
                }
            }
    ...
    public static void Q(b0 b0Var, o2 o2Var, View view) {
        ...
        o0.a aVar;
        boolean z11;
        ArrayList arrayList = b0Var.f43118d0;
        u uVar = b0Var.f43138y0;
        ...
        if (view instanceof vg.c) {
            if (view instanceof vg.d) {
                ...
                int i14 = vg.d.f44350s;
                if (selectedType != 2 && selectedType != 3) {
                    if (selectedType == 1) {
                        o0.a aVar3 = b0Var.f43131r0;
                        if (aVar3 != null) {
                            ((a1) aVar3.f15310b).V(1, arrayList);
                            ((o) aVar3.f15311c).f43227b.E(1);
                        }
                    } else {
                        b0Var.f43123i0 = selectedType;
                        b0Var.a0(true, true);
                        b0Var.Z(true);
                        b0Var.N();
                    }
                } else if (selectedType == 2 && b0Var.f43122h0 == selectedType) {
                    o0.a aVar4 = b0Var.f43131r0;
                    if (aVar4 != null) {
                        ((a1) aVar4.f15310b).V(1, arrayList);
                        ((o) aVar4.f15311c).f43227b.E(1);
                        return;
                    }
                    return;
                } else {
                    b0Var.f43122h0 = selectedType;
                    b0Var.a0(true, true);
                    b0Var.Z(true);
                    b0Var.N();
                }
        ...
        if (view instanceof vg.u) {
            ...
            if (b0Var.f43124j0 == selectedType2 && (aVar = b0Var.f43131r0) != null) {
                ((a1) aVar.f15310b).V(3, b0Var.f43119e0);
                ((o) aVar.f15311c).f43227b.E(1);
            }
            b0Var.f43124j0 = selectedType2;
            b0Var.a0(false, false);
        } else if (view instanceof vg.i) {
            b0Var.f43126l0 = ((TLRPC.TL_premiumGiftCodeOption) ((vg.i) view).getGifCode()).months;
            b0Var.a0(false, false);
            b0Var.f43121g0.G();
            ...
            jn0Var.setTextColor(a5Var.f22323g);
            ...
            jn0Var.setOnClickListener(new org.telegram.ui.Components.m0(calendar, uc0Var, uc0Var2, uc0Var3, vVar, b3Var));
            b3Var.b(a4Var);
            g3 g3Var = b3Var.f18471a;
            g3Var.show();
            int i21 = a5Var.f22320b;
            ...
            AndroidUtilities.setLightStatusBar(g3Var, z10);
        } else if (view instanceof vg.b) {
            o0.a aVar5 = b0Var.f43131r0;
            if (aVar5 != null) {
                ((a1) aVar5.f15310b).V(2, b0Var.f43117c0);
                ((o) aVar5.f15311c).f43227b.E(1);
            }
        } else if (view instanceof vg.w) {
            TL_stars.TL_starsGiveawayOption option = ((vg.w) view).getOption();
            if (option != null) {
                b0Var.f43129p0 = option.stars;
                b0Var.a0(true, true);
                b0Var.Z(true);
                b0Var.N();
            }
    ...
    public static void R(b0 b0Var) {
        rg.k1 k1Var = new rg.k1(b0Var.f30454n, b0Var.currentAccount, null, b0Var.resourcesProvider);
    ...
    public final int U() {
        int i10 = this.f43122h0;
        int i11 = vg.d.f44350s;
        if (i10 == 2) {
            return ((Integer) this.Y.get(this.f43127n0)).intValue();
        }
        List X = X();
        int i12 = this.f43128o0;
        if (i12 < 0 || i12 >= X.size()) {
            this.f43128o0 = 0;
        }
        if (this.f43128o0 >= X.size()) {
            return 0;
        }
        return ((Integer) X.get(this.f43128o0)).intValue();
    }
    ...
    public final int V() {
        ...
        int i11 = vg.d.f44350s;
        if (i10 == 2) {
            U = ((Integer) this.Y.get(this.f43127n0)).intValue();
            g10 = t.g();
        } else {
            TL_stars.TL_starsGiveawayOption W = W(this.f43129p0);
            if (W != null) {
    ...
    public final void Z(boolean z10) {
        boolean z11;
        boolean Y = Y();
        vg.a aVar = this.f43130q0;
        if (Y) {
            TL_stories.PrepaidGiveaway prepaidGiveaway = this.f43134u0;
            if (prepaidGiveaway instanceof TL_stories.TL_prepaidStarsGiveaway) {
        ...
        int i10 = this.f43123i0;
        int i11 = vg.d.f44350s;
        if (i10 == 0) {
            aVar.a(V(), z10);
            return;
        }
        ArrayList arrayList = this.f43118d0;
        ...
        aVar.e = true;
        ci.d dVar = aVar.f44325a;
        dVar.k();
        dVar.setShowZero(true);
        dVar.setEnabled(z11);
        dVar.b(g10, z10);
        dVar.g(LocaleController.getString(R.string.GiftPremium), z10, true);
        aVar.f44326b.setBackgroundColor(j6.v0(j6.f18934h5, aVar.f44327c));
    }
