...
public final class b0 extends za implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final List Y;
    public final List Z;
    public final List f43088a0;
    public final TLRPC.Chat f43089b0;
    public final ArrayList f43090c0;
    public final ArrayList f43091d0;
    public final ArrayList f43092e0;
    public final ArrayList f43093f0;
    public ug.b f43094g0;
    public int f43095h0;
    public int f43096i0;
    public int f43097j0;
    public boolean f43098k0;
    public int f43099l0;
    public long m0;
    public int f43100n0;
    public int f43101o0;
    public long f43102p0;
    public final vg.a f43103q0;
    public o0.a f43104r0;
    public int f43105s0;
    public l f43106t0;
    public final TL_stories.PrepaidGiveaway f43107u0;
    public String f43108v0;
    public boolean f43109w0;
    public boolean f43110x0;
    public final u f43111y0;
    ...
    public b0(n2 n2Var, long j3, TL_stories.PrepaidGiveaway prepaidGiveaway) {
        ...
        this.Z = asList2;
        this.f43088a0 = Arrays.asList(750, 10000, 50000);
        this.f43090c0 = new ArrayList();
        this.f43091d0 = new ArrayList();
        this.f43092e0 = new ArrayList();
        this.f43093f0 = new ArrayList();
        int i10 = vg.d.f44322s;
        this.f43095h0 = 2;
        this.f43096i0 = 0;
        int i11 = vg.u.f44355s;
        this.f43097j0 = 0;
        this.f43099l0 = 12;
        ...
        this.f43108v0 = "";
        this.f43110x0 = true;
        this.f43111y0 = new u(this, 0);
        this.f43107u0 = prepaidGiveaway;
        this.v = 0.15f;
    ...
    public static void P(b0 b0Var, TL_stories.PrepaidGiveaway prepaidGiveaway, long j3, n2 n2Var) {
        ...
        long j10;
        ArrayList arrayList = b0Var.f43092e0;
        ArrayList arrayList2 = b0Var.f43090c0;
        TLRPC.Chat chat = b0Var.f43089b0;
        ArrayList arrayList3 = b0Var.f43091d0;
        ArrayList arrayList4 = b0Var.f43093f0;
        vg.a aVar = b0Var.f43103q0;
        if (!aVar.f44297a.N) {
            if (b0Var.Y()) {
                if (prepaidGiveaway instanceof TL_stories.TL_prepaidStarsGiveaway) {
                ...
                if (R != null) {
                    ...
                    b2 b2Var = alertDialog$Builder.f18437a;
                    b2Var.R = string;
            ...
            int i11 = b0Var.f43095h0;
            int i12 = vg.d.f44322s;
            if (i11 == 3) {
                ...
                if (findActivity != null && !findActivity.isFinishing()) {
                    TL_stars.TL_starsGiveawayOption W = b0Var.W(b0Var.f43102p0);
                    int U = b0Var.U();
                    if (W != null) {
                        aVar.f44297a.setLoading(true);
                        int i13 = b0Var.f43097j0;
                        int i14 = vg.u.f44355s;
                        if (i13 == 1) {
                            z11 = true;
                        } else {
                            z11 = false;
                        ...
                        int l4 = t.l(b0Var.m0);
                        boolean z12 = b0Var.f43110x0;
                        boolean z13 = b0Var.f43109w0;
                        String str2 = b0Var.f43108v0;
                ...
                for (int i18 = 0; i18 < b10.size(); i18++) {
                    ...
                    if (tL_premiumGiftCodeOption.months == b0Var.f43099l0 && arrayList3.size() > 0) {
                        if (t.h()) {
                            ...
                            if (tL_premiumGiftCodeOption.store_product == null) {
                                ...
                                b2 b2Var2 = alertDialog$Builder2.f18437a;
                                b2Var2.R = string2;
                        ...
                        aVar.b(true);
                        t.k(arrayList3, tL_premiumGiftCodeOption, b0Var.f43089b0, null, n2Var, new w(b0Var, 0), new w(b0Var, 1));
                        return;
                    }
                }
            } else {
                ...
                for (int i21 = 0; i21 < b11.size(); i21++) {
                    ...
                    if (tL_premiumGiftCodeOption3.months == b0Var.f43099l0) {
                        if (t.h()) {
                            List list = b0Var.Y;
                            ...
                            if (tL_premiumGiftCodeOption3.store_product == null) {
                                ...
                                b2 b2Var3 = alertDialog$Builder3.f18437a;
                                b2Var3.R = string3;
                        ...
                        int i28 = b0Var.f43097j0;
                        int i29 = vg.u.f44355s;
                        if (i28 == 1) {
                            z10 = true;
                        } else {
                            z10 = false;
                        ...
                        aVar.b(true);
                        boolean z14 = b0Var.f43110x0;
                        boolean z15 = b0Var.f43109w0;
                        String str3 = b0Var.f43108v0;
                        ...
                        if (!t.h()) {
                            ...
                            while (i31 < size6) {
                                ...
                                if (tLObject instanceof TLRPC.Chat) {
                                    i10 = i32;
                                    tL_inputStorePaymentPremiumGiveaway.additional_peers.add(messagesController.getInputPeer(-((TLRPC.Chat) tLObject).f18112id));
                                } else {
                                    i10 = i32;
                                }
                                i31 = i10;
                            }
                            tL_inputStorePaymentPremiumGiveaway.boost_peer = messagesController.getInputPeer(-chat.f18112id);
                            tL_inputStorePaymentPremiumGiveaway.boost_peer = messagesController.getInputPeer(-chat.f18112id);
                        ...
                        while (i35 < size8) {
                            ...
                            if (tLObject2 instanceof TLRPC.Chat) {
                                tL_inputStorePaymentPremiumGiveaway2.additional_peers.add(messagesController2.getInputPeer(-((TLRPC.Chat) tLObject2).f18112id));
                            }
                        }
                        tL_inputStorePaymentPremiumGiveaway2.boost_peer = messagesController2.getInputPeer(-chat.f18112id);
                        ...
                        ?? obj11 = new Object();
                        obj11.f3837b = "inapp";
                        obj11.f3836a = tL_premiumGiftCodeOption3.store_product;
    ...
    public static void Q(b0 b0Var, n2 n2Var, View view) {
        ...
        o0.a aVar;
        boolean z11;
        ArrayList arrayList = b0Var.f43091d0;
        u uVar = b0Var.f43111y0;
        ...
        if (view instanceof vg.c) {
            if (view instanceof vg.d) {
                ...
                int i14 = vg.d.f44322s;
                if (selectedType != 2 && selectedType != 3) {
                    if (selectedType == 1) {
                        o0.a aVar3 = b0Var.f43104r0;
                        if (aVar3 != null) {
                            ((a1) aVar3.f15300b).V(1, arrayList);
                            ((o) aVar3.f15301c).f43199b.D(1);
                        }
                    } else {
                        b0Var.f43096i0 = selectedType;
                        b0Var.a0(true, true);
                        b0Var.Z(true);
                        b0Var.N();
                    }
                } else if (selectedType == 2 && b0Var.f43095h0 == selectedType) {
                    o0.a aVar4 = b0Var.f43104r0;
                    if (aVar4 != null) {
                        ((a1) aVar4.f15300b).V(1, arrayList);
                        ((o) aVar4.f15301c).f43199b.D(1);
                        return;
                    }
                    return;
                } else {
                    b0Var.f43095h0 = selectedType;
                    b0Var.a0(true, true);
                    b0Var.Z(true);
                    b0Var.N();
                }
        ...
        if (view instanceof vg.u) {
            ...
            if (b0Var.f43097j0 == selectedType2 && (aVar = b0Var.f43104r0) != null) {
                ((a1) aVar.f15300b).V(3, b0Var.f43092e0);
                ((o) aVar.f15301c).f43199b.D(1);
            }
            b0Var.f43097j0 = selectedType2;
            b0Var.a0(false, false);
        } else if (view instanceof vg.i) {
            b0Var.f43099l0 = ((TLRPC.TL_premiumGiftCodeOption) ((vg.i) view).getGifCode()).months;
            b0Var.a0(false, false);
            b0Var.f43094g0.G();
            ...
            hn0Var.setTextColor(a5Var.f22309g);
            ...
            a3Var.b(a4Var);
            f3 f3Var = a3Var.f18442a;
            f3Var.show();
            int i21 = a5Var.f22306b;
            ...
            o0.a aVar5 = b0Var.f43104r0;
            if (aVar5 != null) {
                ((a1) aVar5.f15300b).V(2, b0Var.f43090c0);
                ((o) aVar5.f15301c).f43199b.D(1);
            }
        } else if (view instanceof vg.w) {
            TL_stars.TL_starsGiveawayOption option = ((vg.w) view).getOption();
            if (option != null) {
                b0Var.f43102p0 = option.stars;
                b0Var.a0(true, true);
                b0Var.Z(true);
                b0Var.N();
            }
    ...
    public static void R(b0 b0Var) {
        rg.k1 k1Var = new rg.k1(b0Var.f30528n, b0Var.currentAccount, null, b0Var.resourcesProvider);
    ...
    public final int U() {
        int i10 = this.f43095h0;
        int i11 = vg.d.f44322s;
        if (i10 == 2) {
            return ((Integer) this.Y.get(this.f43100n0)).intValue();
        }
        List X = X();
        int i12 = this.f43101o0;
        if (i12 < 0 || i12 >= X.size()) {
            this.f43101o0 = 0;
        }
        if (this.f43101o0 >= X.size()) {
            return 0;
        }
        return ((Integer) X.get(this.f43101o0)).intValue();
    }
    ...
    public final int V() {
        ...
        int i11 = vg.d.f44322s;
        if (i10 == 2) {
            U = ((Integer) this.Y.get(this.f43100n0)).intValue();
            g10 = t.g();
        } else {
            TL_stars.TL_starsGiveawayOption W = W(this.f43102p0);
            if (W != null) {
    ...
    public final void Z(boolean z10) {
        boolean z11;
        boolean Y = Y();
        vg.a aVar = this.f43103q0;
        if (Y) {
            TL_stories.PrepaidGiveaway prepaidGiveaway = this.f43107u0;
            if (prepaidGiveaway instanceof TL_stories.TL_prepaidStarsGiveaway) {
        ...
        int i10 = this.f43096i0;
        int i11 = vg.d.f44322s;
        if (i10 == 0) {
            aVar.a(V(), z10);
            return;
        }
        ArrayList arrayList = this.f43091d0;
        ...
        aVar.e = true;
        ci.d dVar = aVar.f44297a;
        dVar.k();
        dVar.setShowZero(true);
        dVar.setEnabled(z11);
        dVar.b(g10, z10);
        dVar.g(LocaleController.getString(R.string.GiftPremium), z10, true);
        aVar.f44298b.setBackgroundColor(i6.v0(i6.f18907h5, aVar.f44299c));
    }
