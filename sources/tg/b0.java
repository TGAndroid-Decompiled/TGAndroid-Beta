...
public final class b0 extends ug.e {
    ...
    public final void E() {
        String string;
        d6 d6Var;
        c0 c0Var = this.f43366r;
        String str = c0Var.f43371a0;
    ...
    public final void F(TLObject tLObject) {
        ...
        m2 m2Var = c0Var.f22949n;
        c0Var.dismiss();
        if (tLObject instanceof TLRPC.Chat) {
            m2Var.presentFragment(wn.R9(-((TLRPC.Chat) tLObject).f18321id));
        } else if (tLObject instanceof TLRPC.User) {
            m2Var.presentFragment(wn.R9(((TLRPC.User) tLObject).f18468id));
        } else {
