...
public final class z implements Utilities.Callback {
    public final b0 f43196a;
    public final TL_stories.TL_prepaidStarsGiveaway f43197b;
    ...
    public z(b0 b0Var, TL_stories.TL_prepaidStarsGiveaway tL_prepaidStarsGiveaway, long j3, long j10, TL_stories.PrepaidGiveaway prepaidGiveaway) {
        this.f43196a = b0Var;
        this.f43197b = tL_prepaidStarsGiveaway;
        this.f43198c = j3;
        this.d = j10;
    ...
    public final void run(Object obj) {
        Void r62 = (Void) obj;
        b0 b0Var = this.f43196a;
        b0Var.dismiss();
        if (this.f43197b != null) {
            n2 U = LaunchActivity.U();
            if (U != null) {
                xn R9 = xn.R9(this.f43198c);
