...
public final class z implements Utilities.Callback {
    public final b0 f43273a;
    public final TL_stories.TL_prepaidStarsGiveaway f43274b;
    ...
    public z(b0 b0Var, TL_stories.TL_prepaidStarsGiveaway tL_prepaidStarsGiveaway, long j3, long j10, TL_stories.PrepaidGiveaway prepaidGiveaway) {
        this.f43273a = b0Var;
        this.f43274b = tL_prepaidStarsGiveaway;
        this.f43275c = j3;
        this.d = j10;
    ...
    public final void run(Object obj) {
        Void r62 = (Void) obj;
        b0 b0Var = this.f43273a;
        b0Var.dismiss();
        if (this.f43274b != null) {
            o2 U = LaunchActivity.U();
            if (U != null) {
                bo R9 = bo.R9(this.f43275c);
