...
public final class v extends AbstractMap implements Serializable {
    public static final Object f8131s = new Object();
    public transient Object f8132a;
    public transient int[] f8133b;
    public transient Object[] f8134c;
    public transient Object[] d;
    public transient int e;
    public transient int f8135f;
    public transient s h;
    public transient s f8136n;
    public transient n f8137r;
    ...
    public final void clear() {
        ...
        Arrays.fill(i(), 0, this.f8135f, (Object) null);
        Arrays.fill(j(), 0, this.f8135f, (Object) null);
        Object obj = this.f8132a;
    ...
    public final boolean containsValue(Object obj) {
        ...
        for (int i10 = 0; i10 < this.f8135f; i10++) {
            if (s6.a(obj, j()[i10])) {
                return true;
            }
        }
