...
public final class v extends AbstractMap implements Serializable {
    public static final Object f8129s = new Object();
    public transient Object f8130a;
    public transient int[] f8131b;
    public transient Object[] f8132c;
    public transient Object[] d;
    public transient int e;
    public transient int f8133f;
    public transient s h;
    public transient s f8134n;
    public transient n f8135r;
    ...
    public final void clear() {
        ...
        Arrays.fill(i(), 0, this.f8133f, (Object) null);
        Arrays.fill(j(), 0, this.f8133f, (Object) null);
        Object obj = this.f8130a;
    ...
    public final boolean containsValue(Object obj) {
        ...
        for (int i10 = 0; i10 < this.f8133f; i10++) {
            if (s6.a(obj, j()[i10])) {
                return true;
            }
        }
