...
public class j1 extends AbstractCollection implements Set {
    ...
    public final boolean add(Object obj) {
        if (this.f8091b.apply(obj)) {
            return this.f8090a.add(obj);
        }
    ...
    public final boolean addAll(Collection collection) {
        ...
        return this.f8090a.addAll(collection);
    }
    ...
    public final boolean remove(Object obj) {
        if (contains(obj) && this.f8090a.remove(obj)) {
            return true;
        }
        return false;
    }
    ...
    public final boolean removeAll(Collection collection) {
        ...
        while (it.hasNext()) {
            Object next = it.next();
            if (this.f8091b.apply(next) && collection.contains(next)) {
                it.remove();
                z10 = true;
            }
        }
