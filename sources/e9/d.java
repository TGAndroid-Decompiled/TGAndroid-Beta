...
public class d extends AbstractMap {
    ...
    public final transient Map f8059b;
    public transient AbstractSet f8060c;
    ...
    public final boolean equals(Object obj) {
        switch (this.f8058a) {
            case 0:
                if (this != obj && !this.f8059b.equals(obj)) {
                    return false;
                }
                return true;
            case 1:
    ...
    public Set keySet() {
        ...
        switch (this.f8058a) {
            ...
            case 1:
                x7.f fVar = (x7.f) this.e;
                x7.a aVar = fVar.f45394a;
                if (aVar == null) {
                    x7.a aVar2 = new x7.a(fVar, fVar.f45408c);
                    fVar.f45394a = aVar2;
                    return aVar2;
                }
                return aVar;
            default:
                lg lgVar = (lg) this.e;
                ed edVar = lgVar.f48528a;
                if (edVar == null) {
                    ed edVar2 = new ed(lgVar, lgVar.f48538c);
                    lgVar.f48528a = edVar2;
                    return edVar2;
                }
                return edVar;
        }
    ...
    public final Object remove(Object obj) {
        switch (this.f8058a) {
            case 0:
                v0 v0Var = (v0) this.e;
                Collection collection = (Collection) this.f8059b.remove(obj);
                if (collection == null) {
                    return null;
                }
            ...
            case 1:
                x7.f fVar = (x7.f) this.e;
                Collection collection2 = (Collection) this.f8059b.remove(obj);
                if (collection2 == null) {
                    return null;
                }
                fVar.getClass();
            ...
            default:
                lg lgVar = (lg) this.e;
                Collection collection3 = (Collection) this.f8059b.remove(obj);
                if (collection3 == null) {
                    return null;
                }
                lgVar.getClass();
