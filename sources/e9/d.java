...
public class d extends AbstractMap {
    ...
    public Set keySet() {
        ...
        switch (this.f8063a) {
            ...
            case 1:
                x7.f fVar = (x7.f) this.e;
                x7.a aVar = fVar.f45422a;
                if (aVar == null) {
                    x7.a aVar2 = new x7.a(fVar, fVar.f45436c);
                    fVar.f45422a = aVar2;
                    return aVar2;
                }
                return aVar;
            default:
                lg lgVar = (lg) this.e;
                ed edVar = lgVar.f48556a;
                if (edVar == null) {
                    ed edVar2 = new ed(lgVar, lgVar.f48566c);
                    lgVar.f48556a = edVar2;
                    return edVar2;
                }
                return edVar;
        }
