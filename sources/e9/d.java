...
public class d extends AbstractMap {
    ...
    public Set keySet() {
        ...
        switch (this.f8062a) {
            ...
            case 1:
                x7.f fVar = (x7.f) this.e;
                x7.a aVar = fVar.f45645a;
                if (aVar == null) {
                    x7.a aVar2 = new x7.a(fVar, fVar.f45659c);
                    fVar.f45645a = aVar2;
                    return aVar2;
                }
                return aVar;
            default:
                lg lgVar = (lg) this.e;
                ed edVar = lgVar.f48782a;
                if (edVar == null) {
                    ed edVar2 = new ed(lgVar, lgVar.f48792c);
                    lgVar.f48782a = edVar2;
                    return edVar2;
                }
                return edVar;
        }
