...
public class d extends AbstractMap {
    ...
    public final transient Map f8930b;
    public transient AbstractSet f8931c;
    public transient AbstractCollection d;
    public final Serializable f8932e;

    public d(Serializable serializable, Map map, int i10) {
        this.f8929a = i10;
        this.f8932e = serializable;
        this.f8930b = map;
    }
    ...
    public final void clear() {
        switch (this.f8929a) {
            case 0:
                ...
                return;
            case 1:
                x7.f fVar = (x7.f) this.f8932e;
                x7.j jVar = fVar.f48978c;
                if (this.f8930b == jVar) {
                ...
                return;
            default:
                z7.d dVar = ((lg) this.f8932e).f51159c;
                if (this.f8930b == dVar) {
    ...
    public final boolean equals(Object obj) {
        switch (this.f8929a) {
            case 0:
                if (this != obj && !this.f8930b.equals(obj)) {
                    return false;
                }
                return true;
            case 1:
    ...
    public Set keySet() {
        ...
        switch (this.f8929a) {
            ...
            case 1:
                x7.f fVar = (x7.f) this.f8932e;
                x7.a aVar = fVar.f48963a;
                if (aVar == null) {
                    x7.a aVar2 = new x7.a(fVar, fVar.f48978c);
                    fVar.f48963a = aVar2;
                    return aVar2;
                }
                return aVar;
            default:
                lg lgVar = (lg) this.f8932e;
                ed edVar = lgVar.f51149a;
                if (edVar == null) {
                    ed edVar2 = new ed(lgVar, lgVar.f51159c);
                    lgVar.f51149a = edVar2;
                    return edVar2;
                }
                return edVar;
        }
    ...
    public final Object remove(Object obj) {
        switch (this.f8929a) {
            case 0:
                v0 v0Var = (v0) this.f8932e;
                Collection collection = (Collection) this.f8930b.remove(obj);
                if (collection == null) {
                    return null;
                }
                Collection c10 = v0Var.c();
                c10.addAll(collection);
                v0Var.f9019e -= collection.size();
                collection.clear();
                return c10;
            case 1:
                x7.f fVar = (x7.f) this.f8932e;
                Collection collection2 = (Collection) this.f8930b.remove(obj);
                if (collection2 == null) {
                    return null;
                }
                fVar.getClass();
            ...
            default:
                lg lgVar = (lg) this.f8932e;
                Collection collection3 = (Collection) this.f8930b.remove(obj);
                if (collection3 == null) {
                    return null;
                }
                lgVar.getClass();
