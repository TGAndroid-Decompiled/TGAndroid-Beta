...
public final class z0 extends c0 {
    public static final z0 f8144r = new z0();
    public final transient Object d;
    public final transient Object[] e;
    public final transient int f8145f;
    public final transient int h;
    public final transient z0 f8146n;
    ...
    @Override
    public final c1 b() {
        return new c1(this, this.e, this.f8145f, this.h);
    }

    @Override
    public final d1 c() {
        return new d1(this, new e1(this.f8145f, this.h, this.e));
    }

    @Override
    public final Object get(Object obj) {
        Object g10 = f1.g(this.d, this.e, this.h, this.f8145f, obj);
        if (g10 == null) {
            return null;
        }
        return g10;
    ...
    public z0(int i10, Object[] objArr) {
        ...
        if (!(f7 instanceof Object[])) {
            ...
            if (!(f10 instanceof Object[])) {
                this.f8146n = new z0(f10, objArr, i10, this);
                return;
            }
