        ...
        switch (this.f8969a) {
            case 1:
                ...
                if (lVar != null) {
                    ...
                    ((x7.f) this.f8973f).f48978c.put(this.f8970b, this.f8971c);
                    return;
                }
            default:
                ...
                ((lg) this.f8973f).f51159c.put(this.f8970b, this.f8971c);
                return;
        }
    }
        ...
        switch (this.f8969a) {
            case 1:
                ...
                if (lVar != null) {
                    ...
                    ((x7.f) this.f8973f).f48978c.remove(this.f8970b);
                    return;
                } else {
                    return;
                }
            default:
                ...
                if (lVar2 != null) {
                    ...
                    ((lg) this.f8973f).f51159c.remove(this.f8970b);
                    return;
                } else {
                    return;
                }
        ...
        switch (this.f8969a) {
            case 1:
                ...
                if (lVar != null) {
                    ...
                    return;
                } else if (this.f8971c.isEmpty() && (collection = (Collection) ((x7.f) this.f8973f).f48978c.get(this.f8970b)) != null) {
                    this.f8971c = collection;
                    return;
                } else {
                    return;
            ...
            default:
                ...
                if (lVar2 != null) {
                    ...
                    Collection collection2 = (Collection) ((lg) this.f8973f).f51159c.get(this.f8970b);
                    if (collection2 != null) {
