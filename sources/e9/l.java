        ...
        switch (this.f8997a) {
            case 1:
                ...
                if (lVar != null) {
                    ...
                    ((x7.f) this.f9001f).f49007c.put(this.f8998b, this.f8999c);
                    return;
                }
            default:
                ...
                ((lg) this.f9001f).f51190c.put(this.f8998b, this.f8999c);
                return;
        }
    }
        ...
        switch (this.f8997a) {
            case 1:
                ...
                if (lVar != null) {
                    ...
                    ((x7.f) this.f9001f).f49007c.remove(this.f8998b);
                    return;
                } else {
                    return;
                }
            default:
                ...
                if (lVar2 != null) {
                    ...
                    ((lg) this.f9001f).f51190c.remove(this.f8998b);
                    return;
                } else {
                    return;
                }
        ...
        switch (this.f8997a) {
            case 1:
                ...
                if (lVar != null) {
                    ...
                    return;
                } else if (this.f8999c.isEmpty() && (collection = (Collection) ((x7.f) this.f9001f).f49007c.get(this.f8998b)) != null) {
                    this.f8999c = collection;
                    return;
                } else {
                    return;
            ...
            default:
                ...
                if (lVar2 != null) {
                    ...
                    Collection collection2 = (Collection) ((lg) this.f9001f).f51190c.get(this.f8998b);
                    if (collection2 != null) {
