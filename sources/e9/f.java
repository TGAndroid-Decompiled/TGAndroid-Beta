...
public final class f extends i implements NavigableMap {
    ...
    public final NavigableMap descendingMap() {
        return new f(this.f7372n, d().descendingMap());
    }
    ...
    public final NavigableMap d() {
        return (NavigableMap) ((SortedMap) this.f7364b);
    }
    ...
    public final NavigableMap headMap(Object obj, boolean z10) {
        return new f(this.f7372n, d().headMap(obj, z10));
    }

    @Override
    public final NavigableMap subMap(Object obj, boolean z10, Object obj2, boolean z11) {
        return new f(this.f7372n, d().subMap(obj, z10, obj2, z11));
    }

    @Override
    public final NavigableMap tailMap(Object obj, boolean z10) {
        return new f(this.f7372n, d().tailMap(obj, z10));
    }
}
