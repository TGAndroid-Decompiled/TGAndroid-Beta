    ...
    public static j1 j(Set set, d9.f fVar) {
        if (set instanceof SortedSet) {
            ...
            if (sortedSet instanceof j1) {
                ...
                d9.f fVar2 = j1Var.f7391b;
                fVar2.getClass();
                return new j1((SortedSet) j1Var.f7390a, new d9.g(Arrays.asList(fVar2, fVar)));
            }
            return new j1(sortedSet, fVar);
        } else if (set instanceof j1) {
            j1 j1Var2 = (j1) set;
            d9.f fVar3 = j1Var2.f7391b;
            fVar3.getClass();
            return new j1(j1Var2.f7390a, new d9.g(Arrays.asList(fVar3, fVar)));
        } else {
            set.getClass();
