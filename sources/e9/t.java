...
public abstract class t implements Iterator {
    ...
    public final Object next() {
        switch (this.f8109a) {
            case 0:
                v vVar = (v) this.e;
                if (vVar.e == this.f8110b) {
                    if (hasNext()) {
                        int i10 = this.f8111c;
                        this.d = i10;
                        Object a2 = a(i10);
                        int i11 = this.f8111c + 1;
                        if (i11 >= vVar.f8120f) {
                            i11 = -1;
                        }
                        this.f8111c = i11;
