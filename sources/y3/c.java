...
public final class c implements g {
    ...
    public final long f47130c;

    public c(long j10, long[] jArr, long[] jArr2) {
        this.f47128a = jArr;
        this.f47129b = jArr2;
        this.f47130c = j10 == -9223372036854775807L ? d0.G(jArr2[jArr2.length - 1]) : j10;
    }
    ...
    public final long a(long j10) {
        return d0.G(((Long) d(j10, this.f47128a, this.f47129b).second).longValue());
    }
    ...
    public final r f(long j10) {
        Pair d = d(d0.S(d0.i(j10, 0L, this.f47130c)), this.f47129b, this.f47128a);
