...
public final class a extends s implements y1 {
    ...
    public final void onCustomAction(String str, Bundle bundle) {
        c cVar = this.f42732c;
        if (cVar.f42739i != null && cVar.f42738g.containsKey(str)) {
            cVar.f42738g.get(str).getClass();
            throw new ClassCastException();
        }
    }
    ...
    public final void onEvents(a2 a2Var, x1 x1Var) {
        ...
        g gVar = x1Var.f8865a;
        boolean z11 = true;
        if (gVar.f6942a.get(11)) {
            if (this.f42730a != a2Var.x()) {
                z4 = true;
            } else {
                z4 = false;
            }
        ...
        if (gVar.f6942a.get(0)) {
            int o10 = a2Var.z().o();
            z10 = (this.f42731b == o10 && this.f42730a == a2Var.x()) ? true : true;
            this.f42731b = o10;
            z4 = true;
        }
        this.f42730a = a2Var.x();
        int[] iArr = {4, 5, 7, 8, 12};
        int i10 = 0;
        while (true) {
            if (i10 >= 5) {
            ...
            if (gVar.f6942a.get(iArr[i10])) {
                z10 = true;
                break;
            }
            i10++;
        }
        if (!gVar.f6942a.get(new int[]{9}[0])) {
            z11 = z10;
        }
        c cVar = this.f42732c;
        if (z11) {
    ...
    public final void onPlay() {
        ...
        if (c.a(cVar, 4L)) {
            if (cVar.f42739i.c() == 1) {
                cVar.f42739i.b();
            } else if (cVar.f42739i.c() == 4) {
                a2 a2Var = cVar.f42739i;
                ((e) a2Var).K(a2Var.x(), 10, -9223372036854775807L);
            }
            a2 a2Var2 = cVar.f42739i;
            a2Var2.getClass();
            ((e) a2Var2).p(true);
        }
    }
    ...
    public final void onSetPlaybackSpeed(float f10) {
        ...
        if (c.a(cVar, 4194304L) && f10 > 0.0f) {
            a2 a2Var = cVar.f42739i;
            a2Var.a(new v1(f10, a2Var.d().f8839b));
        }
    }
