...
public final class o extends j {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && o.class == obj.getClass()) {
            o oVar = (o) obj;
            if (Objects.equals(this.f44184a, oVar.f44184a) && Objects.equals(this.f44194b, oVar.f44194b) && this.f44195c.equals(oVar.f44195c)) {
                return true;
            }
        }
        return false;
    ...
    public final int hashCode() {
        ...
        return this.f44195c.hashCode() + ((h + i10) * 31);
    }

    @Override
    public final String toString() {
        return this.f44184a + ": description=" + this.f44194b + ": values=" + this.f44195c;
    }
}
