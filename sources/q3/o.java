...
public final class o extends j {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && o.class == obj.getClass()) {
            o oVar = (o) obj;
            if (Objects.equals(this.f41414a, oVar.f41414a) && Objects.equals(this.f41423b, oVar.f41423b) && this.f41424c.equals(oVar.f41424c)) {
                return true;
            }
        }
        return false;
    ...
    public final int hashCode() {
        ...
        return this.f41424c.hashCode() + ((h + i10) * 31);
    }

    @Override
    public final String toString() {
        return this.f41414a + ": description=" + this.f41423b + ": values=" + this.f41424c;
    }
}
