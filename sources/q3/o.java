...
public final class o extends j {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && o.class == obj.getClass()) {
            o oVar = (o) obj;
            if (Objects.equals(this.f44156a, oVar.f44156a) && Objects.equals(this.f44166b, oVar.f44166b) && this.f44167c.equals(oVar.f44167c)) {
                return true;
            }
        }
        return false;
    ...
    public final int hashCode() {
        ...
        return this.f44167c.hashCode() + ((h + i10) * 31);
    }

    @Override
    public final String toString() {
        return this.f44156a + ": description=" + this.f44166b + ": values=" + this.f44167c;
    }
}
