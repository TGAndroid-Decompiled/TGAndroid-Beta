    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        switch (this.f12130a) {
            case 1:
                ...
                vi viVar = (vi) this.f12133e;
                int top = i14 - viVar.f31359w.getTop();
                super.onLayout(z10, i10, i11, i12, i13);
                this.f12131b = getHeight();
                if (viVar.f31359w.getVisibility() == 0 && getHeight() - viVar.f31359w.getTop() != top) {
                    viVar.f31359w.setTranslationY(viVar.f31359w.getTranslationY() + ((getHeight() - viVar.f31359w.getTop()) - top));
                    viVar.f31359w.animate().translationY(0.0f).setDuration(320L).setInterpolator(pr.h).start();
                    return;
                }
                return;
            default:
