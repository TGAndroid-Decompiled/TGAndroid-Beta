...
public abstract class g extends View implements i {
    ...
    public static final float f11116k1 = AndroidUtilities.dpf2(16.0f);
    public static final float l1 = AndroidUtilities.dpf2(1.5f);
    public static final float f11117m1 = AndroidUtilities.dpf2(12.0f);
    public static final int f11118n1 = AndroidUtilities.dp(18.0f);
    public static final int f11119o1 = AndroidUtilities.dp(14.0f);
    public static final int f11120p1 = AndroidUtilities.dp(10.0f);
    public static final int f11121q1 = AndroidUtilities.dp(16.0f);
    public static final int f11122r1 = AndroidUtilities.dp(24.0f);
    public static final int f11123s1 = AndroidUtilities.dp(16.0f);
    public static final int f11124t1 = AndroidUtilities.dp(10.0f);
    public static final int f11125u1 = AndroidUtilities.dp(12.0f);
    public static final int f11126v1 = AndroidUtilities.dp(8.0f);
    public static final int f11127w1 = AndroidUtilities.dp(6.0f);
    public static final int f11128x1 = AndroidUtilities.dp(5.0f);
    public static final int f11129y1 = AndroidUtilities.dp(2.0f);
    public static final int f11130z1 = AndroidUtilities.dp(1.0f);
    public final int A0;
    public final int B0;
    public float C0;
    public float D0;
    ...
    public f f11131a;
    public AnimatorSet f11132a0;
    public final ArrayList f11133a1;
    public final ArrayList f11134b;
    public ValueAnimator f11135b0;
    public long f11136b1;
    public final ArrayList f11137c;
    public ValueAnimator f11138c0;
    public int f11139c1;
    public final ArrayList d;
    public Animator f11140d0;
    public int f11141d1;
    public boolean e;
    public ValueAnimator f11142e0;
    public int f11143e1;
    public float f11144f;
    public boolean f11145f0;
    public int f11146f1;
    public final j f11147g0;
    public long f11148g1;
    public float h;
    public jg.b f11149h0;
    public boolean f11150h1;
    public kg.b f11151i0;
    public boolean f11152i1;
    public float f11153j0;
    public kg.c f11154j1;
    ...
    public int f11158n0;
    public int f11159o0;
    public Bitmap f11160p0;
    public Canvas f11161q0;
    public int f11162r;
    public boolean f11163r0;
    public int f11164s;
    public int f11165s0;
    public kg.e f11166t0;
    public boolean f11167u0;
    public float v;
    public float f11168v0;
    public float f11169w;
    public boolean f11170w0;
    public float f11171x;
    public boolean f11172x0;
    public float f11173y;
    public int f11174y0;
    public kg.j f11175z0;
    ...
    public g(Context context, f6 f6Var) {
        super(context);
        this.f11134b = new ArrayList(10);
        this.f11137c = new ArrayList(25);
        ...
        ?? obj = new Object();
        obj.h = new Rect();
        obj.f11186i = new Rect();
        obj.f11187j = new Rect();
        obj.f11188k = 0.7f;
        obj.f11189l = 1.0f;
        obj.f11190m = 0.1f;
        obj.f11191n = new h[]{null, null};
        obj.f11181a = this;
        this.f11147g0 = obj;
        this.f11163r0 = false;
        this.f11165s0 = -1;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                switch (r2) {
                    ...
                    default:
                        ...
                        gVar2.getClass();
                        gVar2.f11169w = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        gVar2.invalidate();
                        return;
                }
            }
    ...
    public void A(boolean z10, boolean z11, boolean z12) {
        ...
        this.G0 = f7 / (jVar.f11189l - jVar.f11188k);
        H();
        if (this.P0) {
            j3 = s(this.F, this.G);
        } else {
        ...
        if (this.f11167u0 && !z11) {
            c(false);
            x((this.G0 * jVar.f11188k) - f11116k1);
        }
        invalidate();
    }
    ...
    public void C(int i10, int i11) {
        int i12 = this.f11165s0;
        jg.b bVar = this.f11149h0;
        if (bVar != null) {
            float f7 = this.G0;
            float f10 = (this.f11147g0.f11188k * f7) - f11116k1;
            float f11 = (i10 + f10) / f7;
            if (f11 < 0.0f) {
                this.f11165s0 = 0;
            } else if (f11 > 1.0f) {
                this.f11165s0 = bVar.f13002a.length - 1;
            } else {
                int b10 = bVar.b(f11, this.F, this.G);
                this.f11165s0 = b10;
                int i13 = b10 + 1;
                float[] fArr = this.f11149h0.f13003b;
                if (i13 < fArr.length) {
                    if (Math.abs(this.f11149h0.f13003b[this.f11165s0 + 1] - f11) < Math.abs(fArr[b10] - f11)) {
                        this.f11165s0++;
                    }
                }
            }
            int i14 = this.f11165s0;
            int i15 = this.G;
            if (i14 > i15) {
                this.f11165s0 = i15;
            }
            int i16 = this.f11165s0;
            int i17 = this.F;
            if (i16 < i17) {
                this.f11165s0 = i17;
            }
            if (i12 != this.f11165s0) {
                this.f11167u0 = true;
                c(true);
                x(f10);
                e eVar = this.Q0;
    ...
    public boolean D(jg.b bVar) {
        ...
        if (bVar2 != bVar) {
            ...
            if (bVar != null) {
                if (bVar.f13002a[0] == 0) {
                    ...
                    jVar.f11190m = minDistance;
                    float f7 = jVar.f11189l;
                    if (f7 - jVar.f11188k < minDistance) {
        ...
        if (bVar != null) {
            ...
            this.f11153j0 = 0.0f;
            this.f11155k0 = 2.1474836E9f;
            u();
            int i11 = bVar.f13008j;
            if (i11 != 1 && i11 != 2) {
                this.f11166t0.setSize(arrayList.size());
            } else {
                this.f11166t0.setSize(arrayList.size() * 2);
            }
            this.H = true;
            I();
            return z10;
        ...
        this.f11153j0 = 0.0f;
        this.f11134b.clear();
        AnimatorSet animatorSet = this.f11132a0;
        if (animatorSet != null) {
            animatorSet.cancel();
        }
        ValueAnimator valueAnimator = this.f11135b0;
        if (valueAnimator != null) {
            valueAnimator.removeAllListeners();
            this.f11135b0.cancel();
        }
        return z10;
    }
    ...
    public final void E(long j3, long j10, boolean z10, boolean z11, boolean z12) {
        ...
        if ((Math.abs(((float) (((long) Math.ceil(((float) j11) / 5.0f)) * 5)) - this.f11171x) >= this.E && j3 != 0) || ((float) j3) != this.f11173y) {
            ...
            if (!z12) {
                ...
                if (((float) j12) != this.f11171x) {
                    z13 = true;
                } else {
                    z13 = false;
                }
                if (this.P0 && ((float) j13) != this.f11173y) {
                    z13 = true;
                }
                if (z13) {
                    AnimatorSet animatorSet = this.f11132a0;
                    if (animatorSet != null) {
                        ...
                        this.f11132a0.cancel();
                    }
                    this.T0 = this.v;
                    this.U0 = this.f11169w;
                    this.R0 = 0.0f;
                    this.S0 = 0.0f;
                    this.V0 = f7;
                }
            ...
            if (currentTimeMillis - this.f11136b1 < 320 && !z11) {
                return;
            }
            this.f11136b1 = currentTimeMillis;
            ValueAnimator valueAnimator = this.f11135b0;
            if (valueAnimator != null) {
                valueAnimator.removeAllListeners();
                this.f11135b0.cancel();
            ...
            arrayList.add(f10);
            if (z12) {
                AnimatorSet animatorSet2 = this.f11132a0;
                ...
                if (this.P0) {
                    animatorSet3.playTogether(e(this.f11169w, f15, this.M0));
                }
                this.f11132a0 = animatorSet3;
                animatorSet3.start();
            }
    ...
    public final void F() {
        ...
        if (f7 != 0.0f) {
            ...
            if (this.P0) {
                float f14 = this.f11169w;
                float f15 = this.f11173y;
                if (f14 != f15) {
    ...
    public final void G() {
        ...
        this.f11162r = paint2.getAlpha();
        this.f11144f = textPaint.getAlpha() / 255.0f;
        ...
        if (this.f11167u0) {
            int i13 = this.f11165s0;
            jg.b bVar = this.f11149h0;
            long[] jArr = bVar.f13002a;
            if (i13 < jArr.length) {
                this.f11166t0.c(i13, jArr[i13], arrayList, false, bVar.f13008j, bVar.h);
            }
        }
        this.H = true;
    }
    ...
    public final void H() {
        ...
        j jVar = this.f11147g0;
        int c10 = bVar.c(Math.max(jVar.f11188k, 0.0f));
        this.F = c10;
        int a2 = this.f11149h0.a(Math.min(jVar.f11189l, 1.0f), c10);
        this.G = a2;
        int i10 = this.F;
        if (a2 < i10) {
            this.G = i10;
        }
        kg.c cVar = this.f11154j1;
        if (cVar != null) {
            long[] jArr = this.f11149h0.f13002a;
    ...
    public void J(jg.b bVar, long j3) {
        int length = bVar.f13002a.length;
        long j10 = j3 - (j3 % 86400000);
        long j11 = 86399999 + j10;
        int i10 = 0;
        int i11 = 0;
        for (int i12 = 0; i12 < length; i12++) {
            long j12 = bVar.f13002a[i12];
            if (j10 > j12) {
                i10 = i12;
            }
            if (j11 > j12) {
    ...
    public void K() {
        if (B1) {
            ...
            while (i10 < size) {
                ...
                if (z10) {
                    long j12 = aVar.f12999f;
                    if (j12 < j3) {
                        j3 = j12;
                    }
                }
            }
            if ((j3 != 2147483647L && ((float) j3) != 0.0f) || (j10 > 0 && ((float) j10) != this.f11156l0)) {
                this.f11156l0 = (float) j10;
                Animator animator = this.f11140d0;
                if (animator != null) {
                    animator.cancel();
                }
                AnimatorSet animatorSet = new AnimatorSet();
                animatorSet.playTogether(e(this.f11153j0, this.f11156l0, this.J0), e(this.f11155k0, 0.0f, this.K0));
                this.f11140d0 = animatorSet;
                animatorSet.start();
            }
        }
    }
    ...
    public void a(float f7, float f10, boolean z10) {
        ...
        if (z10) {
            ...
            int a2 = this.f11149h0.a(Math.min(f10, 1.0f), c10);
    ...
    public final void c(boolean z10) {
        float f7;
        x((this.G0 * this.f11147g0.f11188k) - f11116k1);
        if (this.f11152i1 == z10) {
            return;
        }
        this.f11152i1 = z10;
        ValueAnimator valueAnimator = this.f11142e0;
        if (valueAnimator != null) {
            valueAnimator.removeAllListeners();
            this.f11142e0.cancel();
        }
        float f10 = this.f11168v0;
        if (z10) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
    ...
    public final void d() {
        ...
        this.f11167u0 = false;
        this.f11152i1 = false;
        this.f11166t0.setVisibility(8);
        this.f11168v0 = 0.0f;
    }

    public kg.d f(int i10, long j3, long j10) {
        return new kg.d(j3, j10, this.P0, this.f11149h0.h, i10, this.N, this.O);
    }
    ...
    public long getEndDate() {
        return this.f11149h0.f13002a[this.G];
    }
    ...
    public long getSelectedDate() {
        ...
        return this.f11149h0.f13002a[i10];
    }

    public long getStartDate() {
        return this.f11149h0.f13002a[this.F];
    }
    ...
    public void i(Canvas canvas) {
        ...
        if (this.f11149h0 != null) {
            ...
            TextPaint textPaint = this.N;
            textPaint.setAlpha((int) (this.f11144f * 255.0f * f7));
            this.O.setAlpha((int) (this.f11144f * 255.0f * f7));
            int textSize = (int) (f11118n1 - textPaint.getTextSize());
            float measuredHeight2 = (getMeasuredHeight() - this.f11164s) - 1;
            canvas.drawLine(this.D0, measuredHeight2, this.E0, measuredHeight2, paint);
            if (this.P0) {
                return;
            }
            canvas.drawText("0", f11116k1, measuredHeight - textSize, textPaint);
        }
    }
        ...
        if (this.f11149h0 != null) {
            ...
            while (true) {
                ...
                if (i13 < this.m0) {
                    ...
                    int i16 = this.F - this.f11159o0;
                    while (i16 % i15 != 0) {
                        i16--;
                    }
                    int i17 = this.G - this.f11159o0;
                    while (true) {
                        if (i17 % i15 == 0 && i17 >= this.f11149h0.f13002a.length - i12) {
                            break;
                        }
                        i17++;
                        i14 = i14;
                    ...
                    int i18 = this.f11159o0;
                    int i19 = i16 + i18;
                    int i20 = i17 + i18;
                    float f11 = this.G0 * this.f11147g0.f11188k;
                    float f12 = f11116k1;
                    float f13 = f11 - f12;
                    while (i19 < i20) {
                        if (i19 >= 0) {
                            ...
                            if (i19 < jArr.length - i12) {
                                ...
                                if (f15 > 0.0f) {
                                    ...
                                    if (f15 <= f16 + f12) {
                                        ...
                                        if (f15 < f17) {
                                            textPaint.setAlpha((int) (i10 * l0.x(f17, f15, f17, f10) * this.h * f7));
                                        } else if (f15 > f16) {
                                            textPaint.setAlpha((int) (i10 * l0.x(f15, f16, f12, f10) * this.h * f7));
                                        } else {
                                            textPaint.setAlpha((int) (i10 * this.h * f7));
                                        }
                                        jg.b bVar = this.f11149h0;
                                        String[] strArr = bVar.f13004c;
                                        long[] jArr2 = bVar.f13002a;
                                        canvas.drawText(strArr[(int) ((jArr2[i19] - jArr2[0]) / bVar.f13009k)], f14, AndroidUtilities.dp(3.0f) + (getMeasuredHeight() - this.f11164s) + f11119o1, textPaint);
                                        i19 += i15;
                                        i14 = i10;
                                        c10 = 0;
                                        f10 = 1.0f;
    ...
    public void o(Canvas canvas) {
        jg.b bVar;
        int i10 = this.f11165s0;
        if (i10 >= 0 && this.f11167u0 && (bVar = this.f11149h0) != null) {
            int i11 = (int) (this.f11162r * this.f11168v0);
            float f7 = this.F0;
            j jVar = this.f11147g0;
            float f10 = jVar.f11189l;
            float f11 = jVar.f11188k;
            float f12 = f7 / (f10 - f11);
            float f13 = (f11 * f12) - f11116k1;
            float[] fArr = bVar.f13003b;
            if (i10 < fArr.length) {
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (measuredWidth != i12 || getMeasuredHeight() != this.Y0) {
            ...
            float f7 = f11116k1;
            float f10 = 2.0f * f7;
            this.f11160p0 = Bitmap.createBitmap((int) (getMeasuredWidth() - f10), i13, Bitmap.Config.ARGB_4444);
            this.f11161q0 = new Canvas(this.f11160p0);
            this.f11131a.a(i13, (int) (getMeasuredWidth() - f10));
            w();
            if (this.f11167u0) {
                x((this.G0 * this.f11147g0.f11188k) - f7);
            }
            A(false, true, false);
        }
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            setSystemGestureExclusionRects(this.f11133a1);
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.f11149h0 != null) {
            ...
            if (actionMasked != 0) {
                if (actionMasked != 1) {
                    if (actionMasked != 2) {
                        ...
                        int i10 = x10 - this.f11139c1;
                        int i11 = y3 - this.f11141d1;
                        if (jVar.f11191n[0] == null && !jVar.f11183c) {
                            boolean z12 = this.f11163r0;
                            int i12 = this.A0;
                            if (z12) {
                                if ((this.f11150h1 && System.currentTimeMillis() - this.f11148g1 > 200) || Math.abs(i10) > Math.abs(i11) || Math.abs(i11) < i12) {
                                    z10 = true;
                                }
                                this.f11139c1 = x10;
                                this.f11141d1 = y3;
                            ...
                            if (rectF.contains(this.f11143e1, this.f11146f1)) {
                                int i13 = this.f11143e1 - x10;
                                int i14 = this.f11146f1 - y3;
                                if (Math.sqrt((i14 * i14) + (i13 * i13)) > i12 || System.currentTimeMillis() - this.f11148g1 > 200) {
                                    this.f11163r0 = true;
                                    C(x10, y3);
                                    return true;
                                }
                ...
                if (!jVar.c(motionEvent.getActionIndex(), motionEvent)) {
                    if (rectF.contains(this.f11143e1, this.f11146f1) && !this.f11163r0) {
                        c(false);
                    }
                    h[] hVarArr = jVar.f11191n;
                    h hVar = hVarArr[0];
            ...
            this.f11148g1 = System.currentTimeMillis();
            ...
            if (!jVar.a(x10, y3, motionEvent.getActionIndex())) {
                ...
                if (rectF.contains(x10, y3)) {
                    if (this.f11165s0 < 0 || !this.f11152i1) {
                        this.f11163r0 = true;
                        C(x10, y3);
                        return true;
                    }
        ...
        while (i10 < size) {
            ...
            if (z10) {
                ...
                if (((float) j3) > this.f11153j0) {
                    this.f11153j0 = (float) j3;
                }
            }
            if (z10) {
                long j10 = aVar.f12999f;
                if (((float) j10) < this.f11155k0) {
                    this.f11155k0 = (float) j10;
                }
            }
            float f7 = this.f11153j0;
            float f10 = this.f11155k0;
            if (f7 == f10) {
                this.f11153j0 = f7 + 1.0f;
                this.f11155k0 = f10 - 1.0f;
            }
        }
    }

    public final void v() {
        int measuredHeight = getMeasuredHeight() - this.f11164s;
        float f7 = this.f11171x;
        if (f7 != 0.0f && measuredHeight != 0) {
            this.E = (f7 / measuredHeight) * f11117m1;
        }
    }
    ...
    public final void w() {
        ...
        if (getMeasuredHeight() > 0 && getMeasuredWidth() > 0) {
            ...
            this.F0 = f12;
            j jVar = this.f11147g0;
            this.G0 = f12 / (jVar.f11189l - jVar.f11188k);
            I();
            this.f11164s = AndroidUtilities.dp(100.0f);
            this.H0.set(this.D0 - f10, 0.0f, this.E0 + f10, getMeasuredHeight() - this.f11164s);
            if (this.f11149h0 != null) {
                this.f11159o0 = (int) (AndroidUtilities.dp(20.0f) / (this.C0 / this.f11149h0.f13002a.length));
            }
            v();
        }
    }
    ...
    public final void x(float f7) {
        ...
        float f10;
        jg.b bVar = this.f11149h0;
        if (bVar != null && (i10 = this.f11165s0) >= 0) {
            long[] jArr = bVar.f13002a;
            if (i10 < jArr.length && this.f11167u0) {
                this.f11166t0.c(i10, jArr[i10], this.d, false, bVar.f13008j, bVar.h);
                this.f11166t0.setVisibility(0);
                this.f11166t0.measure(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), Integer.MIN_VALUE));
                float f11 = (this.f11149h0.f13003b[this.f11165s0] * this.G0) - f7;
                int i11 = f11128x1;
                if (f11 > (this.D0 + this.F0) / 2.0f) {
                    f10 = f11 - (this.f11166t0.getWidth() + i11);
                } else {
                    f10 = f11 + i11;
                }
                if (f10 < 0.0f) {
                    f10 = 0.0f;
                } else if (this.f11166t0.getMeasuredWidth() + f10 > getMeasuredWidth()) {
                    f10 = getMeasuredWidth() - this.f11166t0.getMeasuredWidth();
                }
                this.f11166t0.setTranslationX(f10);
            }
        }
    }
    ...
    public void z() {
        ...
        K();
        if (this.f11167u0) {
            kg.e eVar = this.f11166t0;
            int i12 = this.f11165s0;
            jg.b bVar = this.f11149h0;
            eVar.c(i12, bVar.f13002a[i12], arrayList, true, bVar.f13008j, bVar.h);
        }
    }
