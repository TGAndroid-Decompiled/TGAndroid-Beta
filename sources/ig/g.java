...
public abstract class g extends View implements i {
        ...
        if (f7 != 0.0f) {
            ...
            if (f10 != f11) {
                ...
                if (f12 > 1.0f) {
                    ...
                    float f13 = this.T0;
                    this.v = (rr.f27702g.getInterpolation(f12) * (f11 - f13)) + f13;
                }
                invalidate();
            }
            if (this.P0) {
                ...
                if (f14 != f15) {
                    ...
                    if (f16 > 1.0f) {
                        ...
                        float f17 = this.U0;
                        this.f11155w = (rr.f27702g.getInterpolation(f16) * (f15 - f17)) + f17;
                    }
                    invalidate();
                }
            }
    ...
    public final void G() {
        ...
        this.S.setColor(h6.v0(h6.f18789d6, d6Var));
    ...
    public final void I() {
        ...
        if (bVar != null) {
            ...
            if (f7 != 0.0f) {
                ...
                if (bVar2 == null || i10 >= bVar2.f13585b || i10 <= bVar2.f13586c) {
                    int highestOneBit = Integer.highestOneBit(i10) << 1;
                    kg.b bVar3 = this.f11137i0;
                    if (bVar3 == null || bVar3.f13584a != highestOneBit) {
        ...
        if (this.f11135h0 != null) {
            ...
            while (true) {
                ...
                if (i13 < this.m0) {
                    ...
                    int i15 = ((kg.b) arrayList.get(this.f11144n0)).f13584a;
                    if (i15 == 0) {
                        i15 = 1;
                    }
                            ...
                            if (i19 < jArr.length - i12) {
                                ...
                                if (f15 > 0.0f) {
                                    ...
                                    if (f15 <= f16 + f12) {
                                        ...
                                        if (f15 < f17) {
                                            textPaint.setAlpha((int) (i10 * z0.y(f17, f15, f17, f10) * this.h * f7));
                                        } else if (f15 > f16) {
                                            textPaint.setAlpha((int) (i10 * z0.y(f15, f16, f12, f10) * this.h * f7));
                                        } else {
                    ...
                    while (true) {
                        ...
                        if (i13 < this.m0) {
                            ...
                            if (z10 || fVar.f13619o != 0.0f) {
                                float f15 = (float) fVar.f13608a.f12984a[this.f11151s0];
    ...
    public long r(int i10, int i11) {
        ...
        for (int i12 = 0; i12 < size; i12++) {
            if (((kg.f) arrayList.get(i12)).f13618n) {
                long rMaxQ = ((kg.f) arrayList.get(i12)).f13608a.f12985b.rMaxQ(i10, i11);
                if (rMaxQ > j3) {
                    j3 = rMaxQ;
                }
            }
    ...
    public long s(int i10, int i11) {
        ...
        for (int i12 = 0; i12 < size; i12++) {
            if (((kg.f) arrayList.get(i12)).f13618n) {
                long rMinQ = ((kg.f) arrayList.get(i12)).f13608a.f12985b.rMinQ(i10, i11);
                if (rMinQ < j3) {
                    j3 = rMinQ;
                }
            }
    ...
    public void z() {
        ...
        while (true) {
            ...
            if (fVar.f13618n && (valueAnimator3 = fVar.f13613i) != null) {
                valueAnimator3.cancel();
            }
            if (!fVar.f13618n && (valueAnimator2 = fVar.h) != null) {
                valueAnimator2.cancel();
            }
            if (fVar.f13618n && fVar.f13619o != 1.0f) {
                ValueAnimator valueAnimator4 = fVar.h;
                if (valueAnimator4 == null || !valueAnimator4.isRunning()) {
                    ValueAnimator e = e(fVar.f13619o, 1.0f, new ValueAnimator.AnimatorUpdateListener(this) {
                        ...
                        public final void onAnimationUpdate(ValueAnimator valueAnimator5) {
                            switch (r3) {
                                case 0:
                                    g gVar = this.f11093b;
                                    gVar.getClass();
                                    fVar.f13619o = ((Float) valueAnimator5.getAnimatedValue()).floatValue();
                                    gVar.H = true;
                                    gVar.invalidate();
                                    return;
                                default:
            ...
            if (!fVar.f13618n && fVar.f13619o != 0.0f && ((valueAnimator = fVar.f13613i) == null || !valueAnimator.isRunning())) {
                ValueAnimator e7 = e(fVar.f13619o, 0.0f, new ValueAnimator.AnimatorUpdateListener(this) {
                    public final g f11093b;
