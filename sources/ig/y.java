...
public final class y extends FrameLayout {
    public final RadioButton f7554a;
    public final Drawable f7555b;
    public final Drawable f7556c;
    public final k6 d;
    public final k6 e;
    public final TextView f7557f;
    public final SpannableString h;
    public final SpannableString f7558n;
    public TL_stars.TL_starsGiveawayOption f7559r;
    public int f7560s;
    public final z5 v;
    ...
    public y(Context context, f6 f6Var) {
        ...
        this.f7555b = mutate;
        mutate.setColorFilter(new PorterDuffColorFilter(j6.v0(j6.f19977h5, f6Var), PorterDuff.Mode.SRC_IN));
        this.f7556c = context.getResources().getDrawable(R.drawable.star_small_inner).mutate();
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        float d = this.v.d(this.f7560s, false);
        ...
        for (int ceil = ((int) Math.ceil(d)) - 1; ceil >= 0; ceil--) {
            ...
            Drawable drawable2 = this.f7556c;
