    ...
    public final void run() {
        switch (this.f12176a) {
            ...
            case 2:
                ...
                return;
            case 3:
                u0 u0Var4 = this.f12177b;
                u0Var4.f12255c.Y2.N(true);
                u0Var4.Y(true);
                return;
            default:
                u0 u0Var5 = this.f12177b;
                String obj = u0Var5.f12257f.getText().toString();
                String str = u0Var5.f12263y;
                if (str == null || !TextUtils.equals(str, obj)) {
                    u0Var5.f12262x = false;
