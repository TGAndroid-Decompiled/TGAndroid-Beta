...
public final class z0 implements Utilities.Callback5, org.telegram.ui.ActionBar.a2 {
    ...
    public void mo17run(Object obj, Object obj2, Object obj3, Object obj4, Object obj5) {
        ...
        ((Float) obj5).getClass();
        int i10 = h51Var.d;
        if (i10 != 1 && h51Var.f26588c != e1Var.h) {
            if (i10 == 2) {
                AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(e1Var.getParentActivity());
                alertDialog$Builder.f20199a.R = LocaleController.getString(R.string.BusinessLocationClearTitle);
                alertDialog$Builder.f20199a.T = LocaleController.getString(R.string.BusinessLocationClearMessage);
                alertDialog$Builder.k(LocaleController.getString(R.string.Remove), new z0(e1Var, 3));
                alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
                e1Var.showDialog(alertDialog$Builder.f20199a);
            }
        } else if (e1Var.f12050x != null && h51Var.f26588c != e1Var.h) {
            e1Var.f12050x = null;
