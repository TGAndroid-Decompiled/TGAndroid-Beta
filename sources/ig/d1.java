...
public final class d1 extends View {
    public final Drawable f12053a;
    public final ImageReceiver f12054b;

    public d1(e1 e1Var, Context context) {
        super(context);
        this.f12053a = getContext().getResources().getDrawable(R.drawable.map_pin_photo).mutate();
        i9 i9Var = new i9((f6) null);
        ImageReceiver imageReceiver = new ImageReceiver(this);
        this.f12054b = imageReceiver;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        ImageReceiver imageReceiver = this.f12054b;
