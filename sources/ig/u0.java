...
public final class u0 extends n2 {
    ...
    public static void W(u0 u0Var, h51 h51Var, final View view) {
        if (h51Var.f26590g && !u0Var.v.h(h51Var)) {
            int i10 = h51Var.d;
            if (i10 == U) {
                a0 a0Var = u0Var.v;
                u0Var.I = true;
                ...
                u0Var.f12229c.Y2.N(true);
                u0Var.Y(true);
            } else if (h51Var.f44071a == 13) {
                TLRPC.User user = (TLRPC.User) u0Var.N.get(h51Var.f26605x);
                if (user != null) {
                    if (!user.bot_business) {
                        ...
                        alertDialog$Builder.f20198a.R = LocaleController.getString(R.string.BusinessBotNotSupportedTitle);
                        alertDialog$Builder.f20198a.T = AndroidUtilities.replaceTags(LocaleController.getString(R.string.BusinessBotNotSupportedMessage));
                        alertDialog$Builder.k(LocaleController.getString(R.string.OK), null);
                        u0Var.showDialog(alertDialog$Builder.f20198a);
                        return;
                    }
                    u0Var.M = user;
    ...
    public final boolean onBackPressed(boolean z10) {
        if (Z()) {
            if (z10) {
                ...
                alertDialog$Builder.f20198a.T = LocaleController.getString(R.string.BusinessBotUnsavedChanges);
            ...
            if (z10) {
                ...
                alertDialog$Builder2.f20198a.R = LocaleController.getString(R.string.BusinessBotNoAddedTitle);
                alertDialog$Builder2.f20198a.T = LocaleController.getString(R.string.BusinessBotNoAddedText);
