...
public final class u0 extends n2 {
    ...
    public static final int f12213a0 = -7;
    public static final int f12214b0 = -8;
    public static final int f12215c0 = -9;
    public static final int f12216d0 = -10;
    public static final int f12217e0 = -11;
    public static final int f12218f0 = -12;
    public static final int f12219g0 = -13;
    public static final int f12220h0 = -14;
    public static final int f12221i0 = -15;
    public static final int f12222j0 = -16;
    public static final int f12223k0 = -17;
    public static final int f12224l0 = -18;
    public static final int m0 = -19;
    public static final int f12225n0 = -20;
    public static final int f12226o0 = -21;
    public int E;
    public final m0 F;
    ...
    public boolean T;
    public or f12227a;
    public org.telegram.ui.ActionBar.v0 f12228b;
    public d61 f12229c;
    public hg.b2 d;
    public FrameLayout f12230e;
    public EditTextBoldCursor f12231f;
    public View h;
    public g5 f12232n;
    public TextView f12233r;
    public ImageView f12234s;
    public a0 v;
    ...
    public static void W(u0 u0Var, h51 h51Var, final View view) {
        if (h51Var.f26591g && !u0Var.v.h(h51Var)) {
            int i10 = h51Var.d;
            if (i10 == U) {
                a0 a0Var = u0Var.v;
                u0Var.I = true;
                ...
                u0Var.f12229c.Y2.N(true);
                u0Var.Y(true);
            } else if (h51Var.f44072a == 13) {
                TLRPC.User user = (TLRPC.User) u0Var.N.get(h51Var.f26606x);
                if (user != null) {
                    if (!user.bot_business) {
                        ...
                        alertDialog$Builder.f20199a.R = LocaleController.getString(R.string.BusinessBotNotSupportedTitle);
                        alertDialog$Builder.f20199a.T = AndroidUtilities.replaceTags(LocaleController.getString(R.string.BusinessBotNotSupportedMessage));
                        alertDialog$Builder.k(LocaleController.getString(R.string.OK), null);
                        u0Var.showDialog(alertDialog$Builder.f20199a);
                        return;
                    }
                    u0Var.M = user;
                    AndroidUtilities.hideKeyboard(u0Var.f12231f);
                    u0Var.f12229c.Y2.N(true);
                    u0Var.Y(true);
                }
            } else if (i10 == X) {
                ...
                u0Var.f12229c.Y2.N(true);
                u0Var.Y(true);
            } else if (i10 == f12216d0) {
                boolean z15 = !u0Var.Q;
                u0Var.Q = z15;
                ((v8) view).setChecked(z15);
                u0Var.f12229c.Y2.N(true);
            } else if (i10 == f12217e0) {
                    ...
                    public final void run() {
                        switch (r3) {
                            ...
                            default:
                                ...
                                u0Var7.f12229c.Y2.N(true);
                                u0Var7.Y(true);
                                return;
                        }
                    }
                });
            } else if (i10 == f12221i0) {
                boolean z19 = !u0Var.R;
                u0Var.R = z19;
                ((v8) view).setChecked(z19);
                u0Var.f12229c.Y2.N(true);
            } else if (i10 == f12222j0) {
    ...
    public final void X(int i10, boolean z10, final Runnable runnable) {
        ...
        } else if (!this.L && z10 && (i10 == f12223k0 || i10 == f12224l0 || i10 == m0 || i10 == f12225n0)) {
    ...
    public final void Y(boolean z10) {
        ...
        boolean Z2 = Z();
        this.f12228b.setEnabled(Z2);
        float f13 = 0.0f;
        if (z10) {
            ViewPropertyAnimator animate = this.f12228b.animate();
            if (Z2) {
                f11 = 1.0f;
            } else {
                f11 = 0.0f;
        ...
        org.telegram.ui.ActionBar.v0 v0Var = this.f12228b;
        if (Z2) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        ...
        v0Var.setAlpha(f7);
        org.telegram.ui.ActionBar.v0 v0Var2 = this.f12228b;
        if (Z2) {
            f10 = 1.0f;
        } else {
            f10 = 0.0f;
        ...
        org.telegram.ui.ActionBar.v0 v0Var3 = this.f12228b;
        if (Z2) {
            f13 = 1.0f;
        }
    ...
    public final void a0() {
        ...
        if (this.f12227a.f29172c <= 0.0f) {
            if (!Z()) {
                finishFragment();
            } else if (this.v.k(this.f12229c)) {
                TLRPC.User user2 = this.M;
                if (user2 != null && ((tL_connectedBot = this.H) == null || tL_connectedBot.bot_id != user2.f20016id)) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                ...
                if (tL_connectedBot2 != null && ((user = this.M) == null || tL_connectedBot2.bot_id != user.f20016id)) {
                ...
                if (this.M != null) {
                    ...
                    if (tL_connectedBot3 != null) {
                        tL_connectedBot3.bot_id = this.M.f20016id;
    ...
    public final void b0() {
        ...
        if (!e7 && !this.f12236x && longSparseArray.size() <= 0) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (z11 != z10) {
            if (!this.d.e() && !this.f12236x && longSparseArray.size() <= 0) {
                z12 = false;
            }
            this.f12235w = z12;
            ViewPropertyAnimator animate = this.f12233r.animate();
            float f11 = 1.0f;
            float f12 = 0.0f;
            if (z12) {
                f7 = 0.0f;
            ...
            ViewPropertyAnimator animate2 = this.f12234s.animate();
            if (!z12) {
                f11 = 0.0f;
            }
    ...
    public final View createView(Context context) {
        ...
        this.f12227a = new or(mutate, new sp(j6.w0(null, i12, false)));
        this.f12228b = this.actionBar.n().i(AndroidUtilities.dp(56.0f), LocaleController.getString(R.string.Done), this.f12227a);
        Y(false);
        FrameLayout frameLayout = new FrameLayout(context);
        frameLayout.setBackgroundColor(j6.w0(null, j6.f20608a7, false));
        ...
        this.f12231f = editTextBoldCursor;
        editTextBoldCursor.setTextSize(1, 17.0f);
        this.f12231f.setHintTextColor(j6.w0(null, j6.H6, false));
        EditTextBoldCursor editTextBoldCursor2 = this.f12231f;
        int i13 = j6.G6;
        editTextBoldCursor2.setTextColor(j6.w0(null, i13, false));
        this.f12231f.setBackgroundDrawable(null);
        this.f12231f.setMaxLines(1);
        this.f12231f.setLines(1);
        this.f12231f.setPadding(0, 0, 0, 0);
        this.f12231f.setSingleLine(true);
        EditTextBoldCursor editTextBoldCursor3 = this.f12231f;
        ...
        this.f12231f.setInputType(180224);
        this.f12231f.setImeOptions(6);
        this.f12231f.setHint(LocaleController.getString(R.string.BusinessBotLink));
        this.f12231f.setCursorColor(j6.w0(null, i13, false));
        this.f12231f.setCursorSize(AndroidUtilities.dp(19.0f));
        this.f12231f.setCursorWidth(1.5f);
        this.f12231f.setOnEditorActionListener(new s0(this, 0));
        this.f12231f.addTextChangedListener(new i2(this, 2));
        FrameLayout frameLayout2 = new FrameLayout(context);
        this.f12230e = frameLayout2;
        frameLayout2.addView(this.f12231f, x5.d(-1, -1.0f, 48, 21.0f, 15.0f, 21.0f, 15.0f));
        FrameLayout frameLayout3 = this.f12230e;
        int i14 = j6.f20664d6;
        frameLayout3.setBackgroundColor(getThemedColor(i14));
        View view = new View(context);
        this.h = view;
        view.setBackgroundColor(getThemedColor(j6.f20665d7));
        FrameLayout frameLayout4 = this.f12230e;
        View view2 = this.h;
        ...
        this.f12233r = textView;
        textView.setText(LocaleController.getString(R.string.BusinessBotNotFound));
        this.f12233r.setTextSize(1, 14.0f);
        TextView textView2 = this.f12233r;
        int i16 = j6.f21062z6;
        textView2.setTextColor(getThemedColor(i16));
        this.f12232n.addView(this.f12233r, x5.e(-2, -2, 17));
        this.f12234s = new ImageView(context);
        u8 u8Var = new u8(getThemedColor(i16));
        this.f12234s.setScaleType(ImageView.ScaleType.CENTER);
        this.f12234s.setImageDrawable(u8Var);
        this.f12232n.addView(this.f12234s, x5.e(-2, -2, 17));
        this.f12234s.setAlpha(0.0f);
        this.f12234s.setTranslationY(AndroidUtilities.dp(8.0f));
        hg.b2 b2Var = new hg.b2(true);
        this.d = b2Var;
        b2Var.f10979a = new a6.m(this, 24);
        ...
        this.f12229c = d61Var;
        d61Var.o1();
        d61 d61Var2 = this.f12229c;
        d61Var2.Y2.f31136r = false;
        frameLayout.addView(d61Var2, x5.c(-1.0f, -1));
        this.actionBar.A(this.f12229c, true);
    ...
    public final boolean onBackPressed(boolean z10) {
        if (Z()) {
            if (z10) {
                ...
                alertDialog$Builder.f20199a.T = LocaleController.getString(R.string.BusinessBotUnsavedChanges);
        ...
        } else if (this.M != null || Z() || (this.d.d.isEmpty() && this.d.f10982e.isEmpty())) {
            return super.onBackPressed(z10);
        } else {
            if (z10) {
                AlertDialog$Builder alertDialog$Builder2 = new AlertDialog$Builder(getParentActivity());
                alertDialog$Builder2.f20199a.R = LocaleController.getString(R.string.BusinessBotNoAddedTitle);
                alertDialog$Builder2.f20199a.T = LocaleController.getString(R.string.BusinessBotNoAddedText);
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f12229c.setPadding(0, 0, 0, i13);
        this.f12229c.setClipToPadding(false);
    }
}
