    ...
    public final void run() {
        ...
        switch (i11) {
            ...
            default:
                ...
                int i12 = nVar.f49451k;
                ArrayList arrayList3 = nVar.f49446e;
                n2 n2Var2 = nVar.f49448g;
                if (n2Var2 != null && n2Var2.getParentActivity() != null) {
                    if (tL_error == null) {
                        ...
                        xh.g gVar = nVar.f49447f;
                        xh.n nVar2 = gVar.f49419c;
                        int i14 = 0;
                        while (true) {
                            arrayList = nVar2.f49445c;
                        ...
                        if (i14 >= 0) {
                            ...
                            gVar.u((!gVar.f49419c.B ? 1 : 0) + i14);
                            if (arrayList.isEmpty()) {
                                gVar.u(1);
                            }
                        }
                        nVar.f(nVar.f49460t, false, true);
                        if (z10) {
                            ...
                            ccVar.f24967b.setText(spannableStringBuilder);
                        ...
                        if (TextUtils.isEmpty(nVar.f49460t) && nVar.f49452l) {
