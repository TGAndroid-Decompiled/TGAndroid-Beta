    ...
    public final void run() {
        ...
        switch (i11) {
            ...
            default:
                ...
                int i12 = nVar.f49480k;
                ArrayList arrayList3 = nVar.f49475e;
                n2 n2Var2 = nVar.f49477g;
                if (n2Var2 != null && n2Var2.getParentActivity() != null) {
                    if (tL_error == null) {
                        ...
                        xh.g gVar = nVar.f49476f;
                        xh.n nVar2 = gVar.f49448c;
                        int i14 = 0;
                        while (true) {
                            arrayList = nVar2.f49474c;
                        ...
                        if (i14 >= 0) {
                            ...
                            gVar.u((!gVar.f49448c.B ? 1 : 0) + i14);
                            if (arrayList.isEmpty()) {
                                gVar.u(1);
                            }
                        }
                        nVar.f(nVar.f49489t, false, true);
                        if (z10) {
                            ...
                            ccVar.f24994b.setText(spannableStringBuilder);
                        ...
                        if (TextUtils.isEmpty(nVar.f49489t) && nVar.f49481l) {
