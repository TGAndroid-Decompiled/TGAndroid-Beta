...
public final class i0 extends ni implements NotificationCenter.NotificationCenterDelegate, le.d {
    ...
    public i0(Context context, f6 f6Var, vi viVar) {
        ...
        ui uiVar = new ui(context, j6.f20663d6, f6Var);
        ...
        o0Var.setGlowColor(j6.v0(j6.A5, this.f28752a));
    ...
    public ArrayList<l6> getThemeDescriptions() {
        ...
        arrayList.add(new l6(this.E, 4, null, null, null, null, j6.f20646c7));
        arrayList.add(new l6(this.E, 2048, null, null, null, null, j6.f20735h6));
        int i10 = j6.A5;
        bi.o0 o0Var = this.f12093s;
        arrayList.add(new l6(o0Var, 32768, null, null, null, null, i10));
        arrayList.add(new l6(o0Var, 4096, null, null, null, null, j6.f20753i6));
        arrayList.add(new l6(o0Var, 0, new Class[]{View.class}, j6.f20785k0, null, null, j6.f20664d7));
        int i11 = j6.f20897q5;
        ...
        arrayList.add(new l6(o0Var, 0, new Class[]{h0.class}, null, j6.f20910r0, null, j6.J7));
    ...
    public final void y(int i10, int i11) {
        ...
        this.f12093s.n1(0, i12 + AndroidUtilities.statusBarHeight, 0, this.f28755e);
    }
