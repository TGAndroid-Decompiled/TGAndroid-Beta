...
public final class e extends FrameLayout {
    ...
    public final i9 f12057b;
    public final x9 f12058c;
    public final LinearLayout d;
    public final q6 f12059e;
    public final q6 f12060f;
    public final cq h;
    ...
    public e(Activity activity, f6 f6Var, co coVar) {
        ...
        q6Var2.setTextColor(j6.v0(j6.f20751ge, f6Var));
        ...
        this.f12061n = imageView;
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        imageView.setImageResource(R.drawable.msg_mini_customize);
        imageView.setBackground(j6.M(j6.v0(j6.f20780i6, f6Var), 0, 0));
        imageView.setColorFilter(new PorterDuffColorFilter(j6.v0(j6.f20698de, f6Var), PorterDuff.Mode.MULTIPLY));
        imageView.setOnClickListener(new bi.x(this, coVar, f6Var, 7));
        addView(imageView, x5.d(32, 32.0f, 21, 8.0f, 0.0f, 6.0f, 0.0f));
    }

    public final void a() {
        float f7 = this.f12066y;
        cq cqVar = this.h;
        float d = cqVar.getDrawable().d() + f7 + cqVar.getPaddingLeft() + cqVar.getPaddingRight() + AndroidUtilities.dp(12.0f);
        this.f12059e.setRightPadding(d);
        this.f12060f.setRightPadding(d);
    }

    public void setLeftMargin(float f7) {
        this.f12066y = f7;
        this.f12058c.setTranslationX(f7);
