...
public final class n extends q {
        ...
        if (this.f11135h0 != null && !this.L1) {
            ...
            while (true) {
                ...
                if (i13 < arrayList.size()) {
                    if (((o) arrayList.get(i13)).f13616n || ((o) arrayList.get(i13)).f13617o != 0.0f) {
                        if (f10 > f11) {
            ...
            if (this.M1 != i13 && i13 >= 0) {
                ...
                kg.g gVar = this.S1;
                String str = fVar.f13606a.d;
                int i14 = fVar.f13615m;
                gVar.M.setText(str);
            ...
            if (z10 || this.W1 != i11 || this.V1 != i12) {
                ...
                while (i12 <= i11) {
                    for (int i15 = 0; i15 < size; i15++) {
                        ...
                        if (this.L1 && ((o) arrayList.get(i15)).f13616n && ((jg.a) ((jg.e) this.f11135h0).d.get(i15)).f12984a[i12] > 0) {
                            this.L1 = false;
                        }
                    }
                    i12++;
    ...
    public final void n(Canvas canvas) {
        ...
        if (bVar != null) {
            ...
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                ((kg.f) arrayList.get(i11)).f13612j = 0;
            }
            ...
            while (i12 < length) {
                ...
                while (i14 < size) {
                    ...
                    if (!z12 && fVar.f13617o == 0.0f) {
                        ...
                        i10 = i12;
                        float f14 = ((float) fVar.f13606a.f12984a[i10]) * fVar.f13617o;
                        f13 += f14;
                        if (f14 > 0.0f) {
                            i15++;
                            if (z12) {
                ...
                while (i17 < size) {
                    ...
                    if (fVar2.f13616n || fVar2.f13617o != 0.0f) {
                        long[] jArr = fVar2.f13606a.f12984a;
                        if (i15 == i13) {
                            if (jArr[i16] != 0) {
                                f11 = fVar2.f13617o;
                                int i18 = nVar.B0;
                            ...
                            int i182 = nVar.B0;
                            float f162 = f11 * i182;
                            float[] fArr2 = fVar2.f13613k;
                            int i192 = fVar2.f13612j;
                            int i202 = i192 + 1;
                            fVar2.f13612j = i202;
                            fArr2[i192] = z10;
                            int i212 = i192 + 2;
                            ...
                            if (f13 != 0.0f) {
                                ...
                                float[] fArr22 = fVar2.f13613k;
                                int i1922 = fVar2.f13612j;
                                int i2022 = i1922 + 1;
                                fVar2.f13612j = i2022;
                                fArr22[i1922] = z10;
                                int i2122 = i1922 + 2;
                            ...
                            float[] fArr222 = fVar2.f13613k;
                            int i19222 = fVar2.f13612j;
                            int i20222 = i19222 + 1;
                            fVar2.f13612j = i20222;
                            fArr222[i19222] = z10;
                            int i21222 = i19222 + 2;
                            fVar2.f13612j = i21222;
                            fArr222[i20222] = (i18222 - f16222) - f15;
                            int i22222 = i19222 + 3;
                            fVar2.f13612j = i22222;
                            fArr222[i21222] = z10;
                            fVar2.f13612j = i19222 + 4;
    ...
    public final void q(kg.j jVar) {
        ...
        while (true) {
            ...
            if (i10 < fArr.length) {
                f7 += fArr[i10];
                jVar.f13629k[i10] = (360.0f * f7) - 180.0f;
                i10++;
            } else {
                return;
            }
