...
public final class n extends q {
    ...
    public final void A(boolean z10, boolean z11, boolean z12) {
        ...
        if (bVar != null && ((jg.e) bVar).f13003b != null) {
            j jVar = this.f11147g0;
            N(jVar.f11188k, jVar.f11189l, z11);
        }
    }
    ...
    public final void C(int i10, int i11) {
        ...
        if (this.f11149h0 != null && !this.L1) {
            ...
            x((this.G0 * this.f11147g0.f11188k) - g.f11116k1);
        }
    }
    ...
    public final void J(jg.b bVar, long j3) {
        float length;
        int length2 = bVar.f13002a.length;
        long j10 = j3 - (j3 % 86400000);
        int i10 = 0;
        for (int i11 = 0; i11 < length2; i11++) {
            if (j10 >= bVar.f13002a[i11]) {
                i10 = i11;
            }
        }
        if (bVar.f13003b.length < 2) {
            length = 0.5f;
        } else {
            length = 1.0f / bVar.f13002a.length;
        }
        j jVar = this.f11147g0;
        if (i10 == 0) {
            jVar.f11188k = 0.0f;
            jVar.f11189l = length;
        } else if (i10 >= bVar.f13002a.length - 1) {
            jVar.f11188k = 1.0f - length;
            jVar.f11189l = 1.0f;
        } else {
            float f7 = i10 * length;
            jVar.f11188k = f7;
    ...
    public final void N(float f7, float f10, boolean z10) {
        float f11;
        if (this.I1 != null) {
            int length = ((jg.e) this.f11149h0).f13003b.length;
            ...
            for (int i13 = 0; i13 < length; i13++) {
                float f12 = ((jg.e) this.f11149h0).f13003b[i13];
                if (f12 >= f7 && i12 == -1) {
                    i12 = i13;
                }
                if (f12 <= f10) {
            ...
            if (z10 || this.W1 != i11 || this.V1 != i12) {
                ...
                while (i12 <= i11) {
                    for (int i15 = 0; i15 < size; i15++) {
                        float[] fArr = this.I1;
                        fArr[i15] = fArr[i15] + ((float) ((jg.a) ((jg.e) this.f11149h0).d.get(i15)).f12996a[i12]);
                        this.K1 += (float) ((jg.a) ((jg.e) this.f11149h0).d.get(i15)).f12996a[i12];
                        if (this.L1 && ((o) arrayList.get(i15)).f13630n && ((jg.a) ((jg.e) this.f11149h0).d.get(i15)).f12996a[i12] > 0) {
                            this.L1 = false;
                        }
                    }
                    i12++;
                ...
                if (!z10) {
                    while (i10 < size) {
                        ...
                        ValueAnimator valueAnimator = oVar.f11194s;
                        ...
                        ValueAnimator e = g.e(oVar.f11193r, f11, new x(5, this, oVar));
                        oVar.f11194s = e;
                        e.start();
                        i10++;
                    }
                ...
                while (i10 < size) {
                    if (this.K1 == 0.0f) {
                        ((o) arrayList.get(i10)).f11193r = 0.0f;
                    } else {
                        ((o) arrayList.get(i10)).f11193r = this.I1[i10] / this.K1;
                    }
                    i10++;
                }
            }
    ...
    public final void n(Canvas canvas) {
        ...
        int i10;
        n nVar = this;
        jg.b bVar = nVar.f11149h0;
        if (bVar != null) {
            int length = ((jg.e) bVar).f13003b.length;
            ArrayList arrayList = nVar.d;
            int size = arrayList.size();
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                ((kg.f) arrayList.get(i11)).f13626j = 0;
            }
            float length2 = (1.0f / ((jg.e) nVar.f11149h0).f13003b.length) * nVar.C0;
            int i12 = 0;
            while (i12 < length) {
                float f12 = ((jg.e) nVar.f11149h0).f13003b[i12];
                ...
                while (i14 < size) {
                    ...
                    if (!z12 && fVar.f13631o == 0.0f) {
                        ...
                        i10 = i12;
                        float f14 = ((float) fVar.f13620a.f12996a[i10]) * fVar.f13631o;
                        f13 += f14;
                        if (f14 > 0.0f) {
                            i15++;
                            if (z12) {
                ...
                while (i17 < size) {
                    ...
                    if (fVar2.f13630n || fVar2.f13631o != 0.0f) {
                        long[] jArr = fVar2.f13620a.f12996a;
                        if (i15 == i13) {
                            if (jArr[i16] != 0) {
                                f11 = fVar2.f13631o;
                                int i18 = nVar.B0;
    ...
    public final void onDraw(Canvas canvas) {
        if (this.f11149h0 != null) {
            ...
            while (true) {
                ...
                if (i10 == this.M1) {
                    if (((o) arrayList.get(i10)).f11192q < 1.0f) {
                        ((o) arrayList.get(i10)).f11192q += 0.1f;
                        if (((o) arrayList.get(i10)).f11192q > 1.0f) {
                            ((o) arrayList.get(i10)).f11192q = 1.0f;
                        }
                        invalidate();
                    }
                } else if (((o) arrayList.get(i10)).f11192q > 0.0f) {
                    ((o) arrayList.get(i10)).f11192q -= 0.1f;
                    if (((o) arrayList.get(i10)).f11192q < 0.0f) {
                        ((o) arrayList.get(i10)).f11192q = 0.0f;
                    }
                    invalidate();
                }
                i10++;
