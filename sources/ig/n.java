...
public final class n extends q {
    ...
    public final void A(boolean z10, boolean z11, boolean z12) {
        ...
        if (bVar != null && ((jg.e) bVar).f12999b != null) {
            j jVar = this.f11143g0;
            N(jVar.f11184k, jVar.f11185l, z11);
        }
    }
        ...
        if (this.f11145h0 != null && !this.L1) {
            ...
            while (true) {
                ...
                if (i13 < arrayList.size()) {
                    if (((o) arrayList.get(i13)).f13628n || ((o) arrayList.get(i13)).f13629o != 0.0f) {
                        if (f10 > f11) {
            ...
            if (this.M1 != i13 && i13 >= 0) {
                ...
                kg.g gVar = this.S1;
                String str = fVar.f13618a.d;
                int i14 = fVar.f13627m;
                gVar.M.setText(str);
            ...
            x((this.G0 * this.f11143g0.f11184k) - g.f11112k1);
        }
    }
    ...
    public final void J(jg.b bVar, long j3) {
        float length;
        int length2 = bVar.f12998a.length;
        long j10 = j3 - (j3 % 86400000);
        int i10 = 0;
        for (int i11 = 0; i11 < length2; i11++) {
            if (j10 >= bVar.f12998a[i11]) {
                i10 = i11;
            }
        }
        if (bVar.f12999b.length < 2) {
            length = 0.5f;
        } else {
            length = 1.0f / bVar.f12998a.length;
        }
        j jVar = this.f11143g0;
        if (i10 == 0) {
            jVar.f11184k = 0.0f;
            jVar.f11185l = length;
        } else if (i10 >= bVar.f12998a.length - 1) {
            jVar.f11184k = 1.0f - length;
            jVar.f11185l = 1.0f;
        } else {
            float f7 = i10 * length;
            jVar.f11184k = f7;
    ...
    public final void N(float f7, float f10, boolean z10) {
        float f11;
        if (this.I1 != null) {
            int length = ((jg.e) this.f11145h0).f12999b.length;
            ...
            for (int i13 = 0; i13 < length; i13++) {
                float f12 = ((jg.e) this.f11145h0).f12999b[i13];
                if (f12 >= f7 && i12 == -1) {
                    i12 = i13;
                }
                if (f12 <= f10) {
            ...
            if (z10 || this.W1 != i11 || this.V1 != i12) {
                ...
                while (i12 <= i11) {
                    for (int i15 = 0; i15 < size; i15++) {
                        float[] fArr = this.I1;
                        fArr[i15] = fArr[i15] + ((float) ((jg.a) ((jg.e) this.f11145h0).d.get(i15)).f12992a[i12]);
                        this.K1 += (float) ((jg.a) ((jg.e) this.f11145h0).d.get(i15)).f12992a[i12];
                        if (this.L1 && ((o) arrayList.get(i15)).f13628n && ((jg.a) ((jg.e) this.f11145h0).d.get(i15)).f12992a[i12] > 0) {
                            this.L1 = false;
                        }
                    }
                    i12++;
                ...
                if (!z10) {
                    while (i10 < size) {
                        ...
                        ValueAnimator valueAnimator = oVar.f11190s;
                        ...
                        ValueAnimator e = g.e(oVar.f11189r, f11, new x(5, this, oVar));
                        oVar.f11190s = e;
                        e.start();
                        i10++;
                    }
                ...
                while (i10 < size) {
                    if (this.K1 == 0.0f) {
                        ((o) arrayList.get(i10)).f11189r = 0.0f;
                    } else {
                        ((o) arrayList.get(i10)).f11189r = this.I1[i10] / this.K1;
                    }
                    i10++;
                }
            }
    ...
    public final void n(Canvas canvas) {
        ...
        int i10;
        n nVar = this;
        jg.b bVar = nVar.f11145h0;
        if (bVar != null) {
            int length = ((jg.e) bVar).f12999b.length;
            ArrayList arrayList = nVar.d;
            int size = arrayList.size();
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                ((kg.f) arrayList.get(i11)).f13624j = 0;
            }
            float length2 = (1.0f / ((jg.e) nVar.f11145h0).f12999b.length) * nVar.C0;
            int i12 = 0;
            while (i12 < length) {
                float f12 = ((jg.e) nVar.f11145h0).f12999b[i12];
                ...
                while (i14 < size) {
                    ...
                    if (!z12 && fVar.f13629o == 0.0f) {
                        ...
                        i10 = i12;
                        float f14 = ((float) fVar.f13618a.f12992a[i10]) * fVar.f13629o;
                        f13 += f14;
                        if (f14 > 0.0f) {
                            i15++;
                            if (z12) {
                ...
                while (i17 < size) {
                    ...
                    if (fVar2.f13628n || fVar2.f13629o != 0.0f) {
                        long[] jArr = fVar2.f13618a.f12992a;
                        if (i15 == i13) {
                            if (jArr[i16] != 0) {
                                f11 = fVar2.f13629o;
                                int i18 = nVar.B0;
                            ...
                            int i182 = nVar.B0;
                            float f162 = f11 * i182;
                            float[] fArr2 = fVar2.f13625k;
                            int i192 = fVar2.f13624j;
                            int i202 = i192 + 1;
                            fVar2.f13624j = i202;
                            fArr2[i192] = z10;
                            int i212 = i192 + 2;
                            ...
                            if (f13 != 0.0f) {
                                ...
                                float[] fArr22 = fVar2.f13625k;
                                int i1922 = fVar2.f13624j;
                                int i2022 = i1922 + 1;
                                fVar2.f13624j = i2022;
                                fArr22[i1922] = z10;
                                int i2122 = i1922 + 2;
                            ...
                            float[] fArr222 = fVar2.f13625k;
                            int i19222 = fVar2.f13624j;
                            int i20222 = i19222 + 1;
                            fVar2.f13624j = i20222;
                            fArr222[i19222] = z10;
                            int i21222 = i19222 + 2;
                            fVar2.f13624j = i21222;
                            fArr222[i20222] = (i18222 - f16222) - f15;
                            int i22222 = i19222 + 3;
                            fVar2.f13624j = i22222;
                            fArr222[i21222] = z10;
                            fVar2.f13624j = i19222 + 4;
    ...
    public final void onDraw(Canvas canvas) {
        if (this.f11145h0 != null) {
            ...
            while (true) {
                ...
                if (i10 == this.M1) {
                    if (((o) arrayList.get(i10)).f11188q < 1.0f) {
                        ((o) arrayList.get(i10)).f11188q += 0.1f;
                        if (((o) arrayList.get(i10)).f11188q > 1.0f) {
                            ((o) arrayList.get(i10)).f11188q = 1.0f;
                        }
                        invalidate();
                    }
                } else if (((o) arrayList.get(i10)).f11188q > 0.0f) {
                    ((o) arrayList.get(i10)).f11188q -= 0.1f;
                    if (((o) arrayList.get(i10)).f11188q < 0.0f) {
                        ((o) arrayList.get(i10)).f11188q = 0.0f;
                    }
                    invalidate();
                }
                i10++;
    ...
    public final void q(kg.j jVar) {
        ...
        while (true) {
            ...
            if (i10 < fArr.length) {
                f7 += fArr[i10];
                jVar.f13641k[i10] = (360.0f * f7) - 180.0f;
                i10++;
            } else {
                return;
            }
