    ...
    public final void run() {
        switch (this.f12234a) {
            ...
            case 5:
                ...
                return;
            case 6:
                g3 g3Var = ((i3) this.f12235b).f22102b;
                g3Var.requestFocus();
                AndroidUtilities.showKeyboard(g3Var);
                return;
            case 7:
                AndroidUtilities.showKeyboard(((ji.x) this.f12235b).f14342e0.f22102b);
                return;
            case 8:
            ...
            case 19:
                ...
                if (eg1Var.getParentLayout() != null) {
                    ...
                    bundle.putLong("chat_id", eg1Var.f36053a);
            ...
            case 23:
                ...
                h1Var2.f31549e.invalidate();
                if (!h1Var2.f31549e.isInLayout()) {
                    h1Var2.f31549e.requestLayout();
                    h1Var2.d.requestLayout();
                    h1Var2.f31550f.requestLayout();
                    return;
                }
                return;
            case 24:
                ((org.telegram.ui.Components.voip.g1) this.f12235b).f31524a.i(false);
                return;
            case 25:
                org.telegram.ui.Components.voip.f2 f2Var = (org.telegram.ui.Components.voip.f2) this.f12235b;
                f2Var.f31513e = false;
                HashMap hashMap = f2Var.f31510a;
                ArrayList arrayList = f2Var.f31512c;
                ArrayList arrayList2 = f2Var.f31511b;
                if (!arrayList2.isEmpty() || !arrayList.isEmpty()) {
                    ...
                    while (i10 < arrayList2.size()) {
                        ...
                        while (true) {
                            if (i11 >= arrayList.size()) {
                                break;
                            } else if (e2Var.f31497a.equals(((org.telegram.ui.Components.voip.e2) arrayList.get(i11)).f31497a)) {
                    ...
                    for (int i14 = 0; i14 < f2Var.getChildCount(); i14++) {
                        ...
                        hashMap.put(e2Var2.f31497a, e2Var2);
                    }
                    arrayList2.clear();
                    arrayList.clear();
                    f2Var.f31513e = true;
                ...
                return;
            case 26:
                TextView[] textViewArr = ((n2) this.f12235b).f31697a;
                TextView textView = textViewArr[0];
                textViewArr[0] = textViewArr[1];
                textViewArr[1] = textView;
                return;
            case 27:
                TextView[] textViewArr2 = ((n2) ((hg.k0) this.f12235b).f11153e).f31697a;
            ...
            default:
                ...
                v2Var.f31930e = Bitmap.createBitmap(v2Var.getMeasuredWidth(), v2Var.getMeasuredHeight(), Bitmap.Config.ARGB_8888);
                new Canvas(v2Var.f31930e).drawText(v2Var.d, v2Var.getMeasuredWidth() / 2, (int) ((v2Var.getMeasuredHeight() / 2) - ((v2Var.f31927a.ascent() + v2Var.f31927a.descent()) / 2.0f)), v2Var.f31927a);
