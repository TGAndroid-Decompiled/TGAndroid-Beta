...
public final class v extends y51 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void b0(Activity activity, int i10, TL_account.TL_businessChatLink tL_businessChatLink, f6 f6Var) {
        ...
        sVar.setLineColors(j6.v0(j6.f20792k6, f6Var), j6.v0(j6.f20810l6, f6Var), j6.v0(j6.f20881p7, f6Var));
    ...
    public final boolean X(h51 h51Var, View view) {
        if (h51Var.f44072a == 29) {
            ...
            if (obj instanceof u) {
                    ...
                    public final void run() {
                        switch (r3) {
                            ...
                            default:
                                ...
                                alertDialog$Builder.f20199a.R = LocaleController.getString(R.string.BusinessLinksDeleteTitle);
                                alertDialog$Builder.f20199a.T = LocaleController.getString(R.string.BusinessLinksDeleteMessage);
                                ...
                                if (textView != null) {
                                    textView.setTextColor(vVar2.getThemedColor(j6.f20899q7));
                                    return;
                                }
                                return;
                        }
                ...
                H.W(this.f32850a.U0(view, false));
                H.Z();
                return true;
            }
        }
