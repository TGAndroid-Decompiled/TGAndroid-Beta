...
public final class v extends y51 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void b0(Activity activity, int i10, TL_account.TL_businessChatLink tL_businessChatLink, f6 f6Var) {
        ...
        sVar.setLineColors(j6.v0(j6.f20819k6, f6Var), j6.v0(j6.f20837l6, f6Var), j6.v0(j6.f20908p7, f6Var));
    ...
    public final void U(ArrayList arrayList, v51 v51Var) {
        ...
        if (d10.f12310b.size() < MessagesController.getInstance(d10.f12309a).businessChatLinksLimit) {
            h51 c10 = h51.c(1, R.drawable.menu_link_create, LocaleController.getString(R.string.BusinessLinksAdd));
            c10.f26627q = true;
            arrayList.add(c10);
        }
        ArrayList arrayList2 = y.d(this.currentAccount).f12310b;
        ...
        while (i12 < size) {
            ...
            i12++;
            ?? obj2 = new Object();
            obj2.f12238a = (TL_account.TL_businessChatLink) obj;
    ...
    public final void W(h51 h51Var, View view) {
        if (h51Var.d == 1) {
            ...
            ConnectionsManager.getInstance(d10.f12309a).sendRequest(createbusinesschatlink, new x(d10, 1));
        } else if (h51Var.f44099a == 29) {
            Object obj = h51Var.G;
            if (obj instanceof u) {
                Bundle e7 = p6.e(6, "chatMode");
                e7.putString("business_link", ((u) obj).f12238a.link);
    ...
    public final boolean X(h51 h51Var, View view) {
        if (h51Var.f44099a == 29) {
            Object obj = h51Var.G;
            if (obj instanceof u) {
                final TL_account.TL_businessChatLink tL_businessChatLink = ((u) obj).f12238a;
                    ...
                    public final void run() {
                        switch (r3) {
                            case 0:
                                ...
                                return;
                            case 1:
                                v.Y(this.f12193b, tL_businessChatLink);
                                return;
                            default:
                                v vVar2 = this.f12193b;
                                AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(vVar2.getParentActivity(), 0, vVar2.getResourceProvider());
                                alertDialog$Builder.f20226a.R = LocaleController.getString(R.string.BusinessLinksDeleteTitle);
                                alertDialog$Builder.f20226a.T = LocaleController.getString(R.string.BusinessLinksDeleteMessage);
                                ...
                                if (textView != null) {
                                    textView.setTextColor(vVar2.getThemedColor(j6.f20926q7));
                                    return;
                                }
                                return;
                        }
                ...
                H.W(this.f32877a.U0(view, false));
                H.Z();
                return true;
            }
        }
