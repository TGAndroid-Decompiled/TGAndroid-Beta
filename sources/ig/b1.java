...
public final class b1 extends EditTextBoldCursor {
    ...
    public int f12003c;
    public final p6 d;
    public final e1 f12004e;

    public b1(e1 e1Var, Activity activity) {
        super(activity);
        this.f12004e = e1Var;
        this.f12002b = new h5(this);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int a2 = this.f12002b.a(j6.v0(i10, this.f12004e.getResourceProvider()), false);
        p6 p6Var = this.d;
        p6Var.r(a2);
    ...
    public final void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
        ...
        p6 p6Var = this.d;
        if (p6Var != null) {
            this.f12003c = 96 - charSequence.length();
            p6Var.b();
            String str = "";
            if (this.f12003c <= 12) {
                str = "" + this.f12003c;
