...
public final class w1 extends ReplacementSpan {
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        ...
        switch (this.f12292a) {
            case 0:
                ...
                float f11 = dpf2 / 2.0f;
                rectF.set(f7, f10 - f11, ((int) (((f01) this.f12294c).f25875c + AndroidUtilities.dp(10.0f))) + f7, f11 + f10);
            ...
            case 1:
                ...
                rectF2.set(f7, f12 - AndroidUtilities.dp(7.66f), ((f01) this.f12294c).f25875c + f7 + AndroidUtilities.dp(6.66f), AndroidUtilities.dp(7.66f) + f12);
    ...
    public final int getSize(Paint paint, CharSequence charSequence, int i10, int i11, Paint.FontMetricsInt fontMetricsInt) {
        switch (this.f12292a) {
            case 0:
                return (int) (((f01) this.f12294c).f25875c + AndroidUtilities.dp(10.0f));
            case 1:
                return (int) (((f01) this.f12294c).f25875c + AndroidUtilities.dp(6.66f));
            default:
    ...
    public w1() {
        ...
        this.f12294c = f01Var;
        f01Var.f25873a.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.CLEAR));
    }
}
