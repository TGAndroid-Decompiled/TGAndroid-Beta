...
public final class i extends FrameLayout {
    ...
    public i(Context context, f6 f6Var) {
        ...
        k5Var.setTextColor(j6.v0(j6.f20012j5, f6Var));
    ...
    public void setDate(long j10) {
        ...
        this.f7521a.l(LocaleController.formatString("formatDateAtTime", R.string.formatDateAtTime, LocaleController.getInstance().getFormatterDayMonth().format(date), LocaleController.getInstance().getFormatterDay().format(date)), false);
    }
}
