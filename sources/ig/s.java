...
public final class s extends EditTextBoldCursor {
    public final h5 f12198b;
    public int f12199c;
    public final p6 d;
    public final f6 f12200e;

    public s(Context context, f6 f6Var) {
        super(context);
        this.f12200e = f6Var;
        this.f12198b = new h5(this);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int a2 = this.f12198b.a(j6.v0(i10, this.f12200e), false);
        p6 p6Var = this.d;
        p6Var.r(a2);
    ...
    public final void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
        ...
        p6 p6Var = this.d;
        if (p6Var != null) {
            this.f12199c = 32 - charSequence.length();
            p6Var.b();
            String str = "";
            if (this.f12199c <= 4) {
                str = "" + this.f12199c;
