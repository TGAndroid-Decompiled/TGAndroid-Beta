...
public final class s extends FrameLayout {
    public final eg.i f7521a;
    public final p f7522b;
    public final TextView f7523c;
    public final f90 d;
    public final f6 e;
    public final c90 f7524f;
    ...
    public s(Context context, f6 f6Var) {
        ...
        int i10 = j6.Mj;
        canvas.drawColor(i0.a.d(0.5f, j6.v0(i10, f6Var), j6.v0(j6.f19952h5, f6Var)));
        ...
        this.h = new Paint[20];
        a(0.0f);
        p2 p2Var = pVar.f5457a;
        p2Var.f5429q = false;
        p2Var.K = false;
        p2Var.L = true;
        p2Var.H = true;
        p2Var.f5424l = new dg.a0(this, 1);
        p2Var.c();
    ...
    public void setBoostViaGifsText(TLRPC.Chat chat) {
        ...
        this.f7523c.setText(LocaleController.formatString("BoostingBoostsViaGifts", R.string.BoostingBoostsViaGifts, new Object[0]));
        ...
        f90Var.setTextColor(j6.v0(j6.f20131r5, f6Var));
    }

    public void setPaused(boolean z4) {
        this.f7521a.setPaused(z4);
        this.f7522b.setPaused(z4);
    }

    public void setStars(final boolean z4) {
        final float f10;
        ValueAnimator valueAnimator = this.f7525n;
        ...
        this.f7525n = ValueAnimator.ofFloat(0.0f, 1.0f);
        final float[] fArr = {0.0f};
        AndroidUtilities.cancelRunOnUIThread(iVar.R);
        iVar.d();
        iVar.i();
        this.f7525n.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
        ...
        this.f7525n.addListener(new r(this, fArr, f11, f10, z4));
        this.f7525n.setDuration(680L);
        this.f7525n.setInterpolator(mr.h);
        this.f7525n.start();
    }
}
