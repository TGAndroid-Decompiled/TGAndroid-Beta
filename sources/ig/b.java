...
public final class b extends FrameLayout {
    ...
    public b(Context context, f6 f6Var) {
        ...
        drawable2.setColorFilter(new PorterDuffColorFilter(j6.v0(j6.f20007k7, f6Var), mode));
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        int measuredWidth;
        int i14 = i12 - i10;
        k5 k5Var = this.f7473a;
        int textHeight = ((i13 - i11) - k5Var.getTextHeight()) / 2;
        boolean z10 = LocaleController.isRTL;
        float f10 = 23.0f;
        ImageView imageView = this.f7474b;
        if (z10) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f7473a.measure(org.telegram.ui.b.d(94.0f, size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), 1073741824));
        this.f7474b.measure(View.MeasureSpec.makeMeasureSpec(size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(50.0f), 1073741824));
