...
public final class d extends e {
    public static final Object f47174c = new Object();
    ...
    public static void g(Activity activity, AlertDialog alertDialog, String str, DialogInterface.OnCancelListener onCancelListener) {
        try {
            if (activity instanceof v) {
                ...
                iVar.f47183x0 = alertDialog;
                iVar.f47184y0 = onCancelListener;
                iVar.f927u0 = false;
                iVar.f928v0 = true;
                s6.getClass();
        ...
        alertDialog.setOnCancelListener(null);
        alertDialog.setOnDismissListener(null);
        dialogFragment.f47168a = alertDialog;
        dialogFragment.f47169b = onCancelListener;
        dialogFragment.show(fragmentManager, str);
    }

    @Override
    public final int c(Context context) {
        return d(context, e.f47175a);
    }
    ...
    public final void h(Context context, int i10, PendingIntent pendingIntent) {
        ...
        if (i10 == 18) {
            ...
            if (i10 != 6 && i10 != 19) {
                ...
                e = r.e(context, "common_google_play_services_resolution_required_text", r.a(context));
            }
            ...
            if (i6.b.f7329b == null) {
                i6.b.f7329b = Boolean.valueOf(packageManager.hasSystemFeature("android.hardware.type.watch"));
            }
            if (i6.b.f7329b.booleanValue()) {
                tVar.E.icon = context.getApplicationInfo().icon;
                tVar.f5029j = 2;
                if (i6.b.f(context)) {
                    tVar.a(2131230970, resources.getString(2131689573), pendingIntent);
                } else {
                    tVar.f5027g = pendingIntent;
                }
            } else {
            ...
            if (i6.b.d()) {
                ...
                tVar.f5043y = "com.google.android.gms.availability";
            }
