...
public abstract class g {
    public static boolean f47085b = false;
    public static boolean f47086c = false;
    public static final int e = 0;
    public static final AtomicBoolean f47084a = new AtomicBoolean();
    ...
    public static boolean a(Context context) {
        try {
            ...
            if (!f47085b && "user".equals(Build.TYPE)) {
                return false;
            }
            return true;
        } catch (Throwable th2) {
