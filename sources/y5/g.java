...
public abstract class g {
    public static boolean f50771b = false;
    public static boolean f50772c = false;
    public static final int f50773e = 0;
    public static final AtomicBoolean f50770a = new AtomicBoolean();
    ...
    public static boolean a(Context context) {
        try {
            ...
            if (!f50771b && "user".equals(Build.TYPE)) {
                return false;
            }
            return true;
        } catch (Throwable th2) {
