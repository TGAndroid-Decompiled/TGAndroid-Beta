...
public final class i implements ViewTreeObserver.OnPreDrawListener {
    public final MediaController.CropState f51181a;
    ...
    public final boolean onPreDraw() {
        ...
        MediaController.CropState cropState = this.f51181a;
        if (cropState != null) {
            ...
            int i11 = this.f51182b;
            int i12 = this.f51183c;
            if (i10 != 90 && i10 != 270) {
                l lVar = nVar.I;
                f10 = lVar.f51191a;
                f11 = lVar.f51192b;
            ...
            if (nVar.f51210x && cropAreaView.getLockAspectRatio() > 0.0f) {
                ...
                if ((i10 + nVar.I.f51196g) % 180.0f != 0.0f) {
                    z4 = true;
                } else {
                    z4 = false;
                }
                cropAreaView.e(currentWidth, currentHeight, z4, nVar.f51210x);
            }
            l.d(nVar.I, i10);
            cropAreaView.setActualRect((aspectRatio * cropState.cropPw) / cropState.cropPh);
            l lVar3 = nVar.I;
            lVar3.f51198j = cropState.mirrored;
            l.e(lVar3, cropState.cropRotate);
            l lVar4 = nVar.I;
            float f13 = cropState.cropPx * i11;
            float f14 = lVar4.f51195f;
            ...
            l lVar5 = nVar.I;
            l.g(lVar5, cropState.cropScale * (max / lVar5.f51195f), 0.0f, 0.0f);
            nVar.r(false);
            m mVar2 = nVar.J;
            if (mVar2 != null) {
                mVar2.N(false);
