...
public abstract class b {
    public static final char[] f10162a = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ $%*+-./:".toCharArray();
    ...
    public static void c(b4.d dVar, StringBuilder sb2, int i10) {
        ...
        if (h.f7640c != null) {
            if (i10 * 13 <= dVar.d()) {
                ...
                sb2.append(new String(bArr, h.f7640c));
                return;
            }
            throw cc.c.a();
        }
    ...
    public static void d(b4.d dVar, StringBuilder sb2, int i10) {
        ...
        if (h.f7639b != null) {
            if (i10 * 13 <= dVar.d()) {
                ...
                sb2.append(new String(bArr, h.f7639b));
                return;
            }
            throw cc.c.a();
        }
