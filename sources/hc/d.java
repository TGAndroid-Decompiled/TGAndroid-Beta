...
public final class d {
    ...
    public d(int i10) {
        int i11 = (i10 >> 3) & 3;
        if (i11 >= 0 && i11 < 4) {
            this.f10167a = c.d[i11];
            this.f10168b = (byte) (i10 & 7);
            return;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        d dVar = (d) obj;
        if (this.f10167a != dVar.f10167a || this.f10168b != dVar.f10168b) {
            return false;
        }
        return true;
    }
    ...
    public final int hashCode() {
        return (this.f10167a.ordinal() << 3) | this.f10168b;
    }
}
