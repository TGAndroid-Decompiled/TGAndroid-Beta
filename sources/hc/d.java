...
public final class d {
    ...
    public d(int i10) {
        int i11 = (i10 >> 3) & 3;
        if (i11 >= 0 && i11 < 4) {
            this.f10956a = c.d[i11];
            this.f10957b = (byte) (i10 & 7);
            return;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        d dVar = (d) obj;
        if (this.f10956a != dVar.f10956a || this.f10957b != dVar.f10957b) {
            return false;
        }
        return true;
    }
    ...
    public final int hashCode() {
        return (this.f10956a.ordinal() << 3) | this.f10957b;
    }
}
