...
public final class d {
    ...
    public d(int i10) {
        int i11 = (i10 >> 3) & 3;
        if (i11 >= 0 && i11 < 4) {
            this.f10166a = c.d[i11];
            this.f10167b = (byte) (i10 & 7);
            return;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        d dVar = (d) obj;
        if (this.f10166a != dVar.f10166a || this.f10167b != dVar.f10167b) {
            return false;
        }
        return true;
    }
    ...
    public final int hashCode() {
        return (this.f10166a.ordinal() << 3) | this.f10167b;
    }
}
