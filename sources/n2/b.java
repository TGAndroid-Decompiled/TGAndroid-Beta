...
public final class b implements h {
        ...
        if (i12 == 1 && fVar2.E > 0 && fVar2.v != -9223372036854775807L) {
            ...
            if (((b) bVar.f15694c) == this) {
                ...
                if (!hashSet.isEmpty()) {
                    ...
                    m10.getClass();
                    fVar3.getClass();
                    fVar3.obtainMessage(1, new a(u2.t.f43768b.getAndIncrement(), true, SystemClock.elapsedRealtime(), m10)).sendToTarget();
                }
            }
    ...
    public final void o(int i10, boolean z10, byte[] bArr) {
        try {
            ...
            k02.getClass();
            fVar.getClass();
            fVar.obtainMessage(2, new a(u2.t.f43768b.getAndIncrement(), z10, SystemClock.elapsedRealtime(), k02)).sendToTarget();
