...
public final class a extends u {
    public static final C0000a f12944b = new C0000a();
    ...
    public final Object read(lb.a aVar) {
        ...
        synchronized (this) {
            ...
            try {
                date = new Date(this.f12945a.parse(v).getTime());
    ...
    public final void write(lb.b bVar, Object obj) {
        ...
        synchronized (this) {
            format = this.f12945a.format((java.util.Date) date);
        }
        bVar.r(format);
    }

    private a() {
        this.f12945a = new SimpleDateFormat("MMM d, yyyy");
    }
}
