...
public final class f1 implements o1.f {
    ...
    public final void a(o1.h hVar, boolean z4, float f10, float f11) {
        switch (this.f17045a) {
            case 0:
                ArrayList arrayList = hVar.f16334k;
                int indexOf = arrayList.indexOf(this);
                if (indexOf >= 0) {
                    arrayList.set(indexOf, null);
                }
                ArrayList arrayList2 = this.f17046b;
                ...
                return;
            case 1:
                ArrayList arrayList3 = hVar.f16334k;
                int indexOf2 = arrayList3.indexOf(this);
                if (indexOf2 >= 0) {
                    arrayList3.set(indexOf2, null);
                }
                ArrayList arrayList4 = this.f17046b;
                ...
                return;
            default:
                ArrayList arrayList5 = hVar.f16334k;
                int indexOf3 = arrayList5.indexOf(this);
                if (indexOf3 >= 0) {
                    arrayList5.set(indexOf3, null);
                }
                ArrayList arrayList6 = this.f17046b;
