...
public enum a {
    ...
    f15721s("CHECKLIST", R.raw.tab_checklist_reverse),
    v("COLORS", R.raw.tab_colors_reverse),
    f15722w("FILES", R.raw.tab_files_reverse),
    f15723x("GALLERY", R.raw.tab_gallery_reverse),
    EF7("GIFT", R.raw.tab_gift_reverse),
    f15724y("LOCATION", R.raw.tab_location_reverse),
