...
public enum a {
    ...
    f15537s("CHECKLIST", R.raw.tab_checklist_reverse),
    v("COLORS", R.raw.tab_colors_reverse),
    f15538w("FILES", R.raw.tab_files_reverse),
    f15539x("GALLERY", R.raw.tab_gallery_reverse),
    EF7("GIFT", R.raw.tab_gift_reverse),
    f15540y("LOCATION", R.raw.tab_location_reverse),
