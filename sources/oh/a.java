...
public enum a {
    ...
    f15706s("CHECKLIST", R.raw.tab_checklist_reverse),
    v("COLORS", R.raw.tab_colors_reverse),
    f15707w("FILES", R.raw.tab_files_reverse),
    f15708x("GALLERY", R.raw.tab_gallery_reverse),
    EF7("GIFT", R.raw.tab_gift_reverse),
    f15709y("LOCATION", R.raw.tab_location_reverse),
