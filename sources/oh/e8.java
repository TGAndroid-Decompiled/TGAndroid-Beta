...
public final class e8 extends TLObject {
    public final TL_stories.StoryItem f17044a;
    public int f17045b;
    ...
    public e8(TL_stories.StoryItem storyItem) {
        ...
        int i13 = i12 + i11;
        this.f17045b = i13;
        this.f17045b = i13 + (storyItem.translatedLng != null ? 8 : 0);
    }
    ...
    public final void readParams(InputSerializedData inputSerializedData, boolean z4) {
        ...
        this.f17045b = readInt32;
        if ((readInt32 & 1) == 0) {
            z10 = false;
        }
        TL_stories.StoryItem storyItem = this.f17044a;
    ...
    public final void serializeToStream(OutputSerializedData outputSerializedData) {
        ...
        outputSerializedData.writeInt32(this.f17045b);
        int i10 = this.f17045b & 2;
        TL_stories.StoryItem storyItem = this.f17044a;
        if (i10 != 0) {
