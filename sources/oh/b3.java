...
public final class b3 extends View {
    public final int f16885a = 4;
    public final Object f16886b;
    public Object f16887c;
    public Object d;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f16885a) {
            case 3:
                ...
                org.telegram.ui.Components.j6 j6Var = r21Var.f30628e;
                float g10 = j6Var.g();
                if (g10 > 0.0f) {
                    ...
                    org.telegram.ui.Components.d6 d6Var = (org.telegram.ui.Components.d6) this.f16886b;
                    d6Var.setColor(d6Var.f26198b.a(org.telegram.ui.ActionBar.k6.v0(r21Var.F, d6Var.f26197a), false));
                    ...
                    j6Var.r(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.W8, (org.telegram.ui.ActionBar.g6) this.f16887c));
                    j6Var.draw(canvas);
                    canvas.restore();
                }
            ...
            default:
                ...
                return;
            case 5:
                int[] iArr = (int[]) this.f16886b;
                fg.h0 h0Var = (fg.h0) this.f16887c;
                n50 n50Var = (n50) this.d;
                if (n50Var.h > 0.0f && n50Var.d != null) {
                    n50Var.f39187f.reset();
                    float width = getWidth() / n50Var.f39185c.getWidth();
                    n50Var.f39187f.postScale(width, width);
                    n50Var.f39186e.setLocalMatrix(n50Var.f39187f);
            ...
            case 6:
                ...
                int i10 = dp + ((int) z60Var.f43813b.f50546e);
                Paint paint = (Paint) this.f16887c;
                paint.setColor(z60Var.getThemedColor(org.telegram.ui.ActionBar.k6.f21932s8));
                RectF rectF2 = (RectF) this.f16886b;
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.f16885a) {
            case 0:
                k90 k90Var = (k90) this.f16886b;
                super.onDraw(canvas);
                org.telegram.ui.Components.z5 z5Var = (org.telegram.ui.Components.z5) this.f16887c;
                z5Var.f33761a = this;
                ((f4) this.d).getClass();
                z5Var.d(0.0f, false);
                float f11 = z5Var.f33763c;
                if (f11 != 0.0f) {
                    if (f11 != 1.0f) {
                        canvas.saveLayerAlpha(0.0f, 0.0f, getLayoutParams().width, getMeasuredHeight(), (int) (z5Var.f33763c * 255.0f), 31);
                    } else {
                        canvas.save();
                    }
                    RectF rectF = AndroidUtilities.rectTmp;
                ...
                return;
            case 1:
                Drawable drawable = (Drawable) this.f16887c;
                super.onDraw(canvas);
                float measuredWidth = getMeasuredWidth() / 7.0f;
                for (int i10 = 0; i10 < 7; i10++) {
                    canvas.drawText(((String[]) this.f16886b)[i10], (measuredWidth / 2.0f) + (i10 * measuredWidth), ((getMeasuredHeight() - AndroidUtilities.dp(2.0f)) / 2.0f) + AndroidUtilities.dp(5.0f), ((org.telegram.ui.j8) this.d).f37866f);
                }
            ...
            case 2:
                ...
                if (!ng0Var.f29478n || ((xf0Var = ng0Var.f29479r) != null && xf0Var.f33062x)) {
                    int width = getWidth();
                    ...
                    if (f13 != 0.0f) {
                        float f14 = dp2;
                        f10 = height;
                        canvas.drawLine(f14, f10, (f12 * f13) + f14, height, (Paint) this.f16887c);
                    } else {
                        f10 = height;
                    }
                    canvas.drawLine(dp2, f10, i11, f10, (Paint) this.f16886b);
                    return;
                }
                return;
            case 3:
            ...
            case 4:
                super.onDraw(canvas);
                org.telegram.ui.Components.j6 j6Var = (org.telegram.ui.Components.j6) this.f16886b;
                int dpf2 = (int) (AndroidUtilities.dpf2(30.0f) + j6Var.d());
                int width2 = (getWidth() - dpf2) / 2;
                int i12 = dpf2 + width2;
                qg.b bVar = (qg.b) this.f16887c;
                if (bVar != null) {
                    bVar.setBounds(width2, 0, i12, getHeight());
                    ((qg.b) this.f16887c).draw(canvas);
                }
                j6Var.draw(canvas);
                return;
            case 7:
                ...
                Drawable drawable2 = bd0Var.f35492s;
                Rect rect = (Rect) this.f16887c;
                drawable2.setBounds(-rect.left, 0, getMeasuredWidth() + rect.right, getMeasuredHeight());
                bd0Var.f35492s.draw(canvas);
                int i13 = bd0Var.D0;
                if (i13 == 0 || i13 == 1) {
                    ...
                    org.telegram.ui.ActionBar.k6.f21941t0.setColor(themedColor);
                    canvas.drawRoundRect(rectF2, AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f), org.telegram.ui.ActionBar.k6.f21941t0);
                    return;
                }
                return;
            case 8:
                ...
                for (int i14 = 0; i14 < height2; i14++) {
                    ...
                    for (int i15 = 0; i15 < width3; i15++) {
                        ...
                        if ((i16 == 0 && i14 % 2 == 0) || (i16 != 0 && i14 % 2 != 0)) {
                            canvas.drawRect(0.0f, 0.0f, f18, f18, (Paint) this.f16886b);
                        }
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.f16885a) {
            case 3:
                super.onMeasure(View.MeasureSpec.makeMeasureSpec((int) Math.max(AndroidUtilities.dp(16.66f), ((r21) this.d).f30628e.d + AndroidUtilities.dp(10.0f)), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(16.66f), 1073741824));
                return;
            default:
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        switch (this.f16885a) {
            case 4:
                ...
                ((org.telegram.ui.Components.j6) this.f16886b).setBounds(0, 0, i10, i11);
                return;
            default:
                super.onSizeChanged(i10, i11, i12, i13);
                return;
    ...
    public boolean verifyDrawable(Drawable drawable) {
        switch (this.f16885a) {
            case 3:
                if (((r21) this.d).f30628e != drawable && !super.verifyDrawable(drawable)) {
                    return false;
                }
                return true;
            case 4:
                if (!super.verifyDrawable(drawable) && drawable != ((org.telegram.ui.Components.j6) this.f16886b)) {
                    return false;
                }
                return true;
            default:
    ...
    public b3(r21 r21Var, Context context, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        this.d = r21Var;
        this.f16887c = g6Var;
        this.f16886b = new org.telegram.ui.Components.d6(this, g6Var);
        r21Var.f30628e.setCallback(this);
    }
    ...
    public b3(f4 f4Var, Context context) {
        super(context);
        this.d = f4Var;
        this.f16886b = new k90();
        this.f16887c = new org.telegram.ui.Components.z5(250L, pr.f30168f);
    }
