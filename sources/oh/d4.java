...
public final class d4 {
    public TL_stories.StoryItem f16961a = null;
    public s6 f16962b = null;
    public TL_stories.StoryItem f16963c;
    public boolean d;
    ...
    public static String c(d4 d4Var) {
        ...
        if (storyItem != null && (messageMedia = storyItem.media) != null) {
            if (messageMedia.photo != null) {
                ...
                sb.append(d4Var.f16961a.media.photo.f20867id);
                sb.append("at");
                return android.support.v4.media.a.m(d4Var.f16961a.media.photo.dc_id, "dc", sb);
            } else if (messageMedia.document != null) {
                StringBuilder sb2 = new StringBuilder("doc#");
                sb2.append(d4Var.f16961a.media.document.f20849id);
                sb2.append("at");
                return android.support.v4.media.a.m(d4Var.f16961a.media.document.dc_id, "dc", sb2);
            } else {
                return "unknown";
            }
        } else if (d4Var.f16962b != null) {
            return "uploading from " + d4Var.f16962b.f17738e;
        } else {
            return "unknown";
        }
    }
    ...
    public final boolean d() {
        s6 s6Var = this.f16962b;
        if (s6Var != null) {
            return s6Var.f17737c.H0;
        }
        TL_stories.StoryItem storyItem = this.f16961a;
        if (storyItem != null) {
            if (storyItem.noforwards) {
                return false;
            }
            if (storyItem.pinned) {
                TLRPC.Chat chat = MessagesController.getInstance(this.f16969k.f17133z2).getChat(Long.valueOf(-storyItem.dialogId));
    ...
    public final String e() {
        f4 f4Var = this.f16969k;
        if (f4Var.L1.f16961a == null) {
            return null;
        }
        if (f4Var.f17128y1 > 0) {
            TLRPC.User user = MessagesController.getInstance(f4Var.f17133z2).getUser(Long.valueOf(f4Var.f17128y1));
            ...
            return String.format(Locale.US, "https://t.me/%1$s/s/%2$s", UserObject.getPublicUsername(user), Integer.valueOf(f4Var.L1.f16961a.f21080id));
        }
        TLRPC.Chat chat = MessagesController.getInstance(f4Var.f17133z2).getChat(Long.valueOf(-f4Var.f17128y1));
        ...
        return String.format(Locale.US, "https://t.me/%1$s/s/%2$s", ChatObject.getPublicUsername(chat), Integer.valueOf(f4Var.L1.f16961a.f21080id));
    }
    ...
    public final v7 g() {
        ...
        if (this.f16967i == null && (storyItem = this.f16961a) != null) {
            ...
            if (document != null && (tL_documentAttributeAudio = (TLRPC.TL_documentAttributeAudio) AndroidUtilities.find(document.attributes, TLRPC.TL_documentAttributeAudio.class)) != null) {
                ...
                if (!TextUtils.isEmpty(str) || !TextUtils.isEmpty(str2)) {
                    v7Var = new v7();
                    v7Var.f17861f = true;
                    v7Var.f17862g = document;
                    if (TextUtils.isEmpty(str)) {
                        v7Var.f17865k = new SpannableStringBuilder(v7.d()).append((CharSequence) " ").append((CharSequence) str2);
                    } else if (TextUtils.isEmpty(str2)) {
                        v7Var.f17865k = new SpannableStringBuilder(v7.d()).append((CharSequence) " ").append((CharSequence) str);
                    } else {
                        SpannableStringBuilder append = new SpannableStringBuilder(v7.d()).append((CharSequence) " ").append((CharSequence) str2);
                        v7Var.f17865k = append;
                        int length = append.length();
                        v7Var.f17865k.append((CharSequence) " ・ ");
                        v7Var.f17865k.setSpan(new CharacterStyle(), length, v7Var.f17865k.length(), 33);
                        v7Var.f17865k.append((CharSequence) str);
                    }
                }
            }
            this.f16967i = v7Var;
    ...
    public final File h() {
        ...
        if (storyItem != null) {
            ...
            if (messageMedia != null && messageMedia.getDocument() != null) {
                return FileLoader.getInstance(f4Var.f17133z2).getPathToAttach(this.f16961a.media.getDocument());
            }
            TLRPC.MessageMedia messageMedia2 = this.f16961a.media;
            if (messageMedia2 != null && (photo = messageMedia2.photo) != null) {
                ...
                File pathToAttach = FileLoader.getInstance(f4Var.f17133z2).getPathToAttach(closestPhotoSizeWithSize, true);
                if (!pathToAttach.exists()) {
                    return FileLoader.getInstance(f4Var.f17133z2).getPathToAttach(closestPhotoSizeWithSize, false);
                }
                return pathToAttach;
            }
            return null;
            ...
            if (storyItem != null) {
                ...
                if (storyItem.fwd_from != null) {
                    ...
                    if (peer != null) {
                        ...
                        v7Var.f17858b = Long.valueOf(peerDialogId);
                        if (peerDialogId >= 0) {
                            v7Var.f17865k = new SpannableStringBuilder(MessageObject.userSpan()).append((CharSequence) " ").append((CharSequence) UserObject.getUserName(MessagesController.getInstance(i11).getUser(Long.valueOf(peerDialogId))));
                        } else {
                            ...
                            v7Var.f17865k = append.append((CharSequence) str);
                        }
                    } else if (storyFwdHeader.from_name != null) {
                        v7Var.f17865k = new SpannableStringBuilder(MessageObject.userSpan()).append((CharSequence) " ").append((CharSequence) storyItem.fwd_from.from_name);
                    }
                    v7Var.f17861f = true;
                    TL_stories.StoryFwdHeader storyFwdHeader2 = storyItem.fwd_from;
                    if ((storyFwdHeader2.flags & 4) != 0) {
                        v7Var.f17859c = Integer.valueOf(storyFwdHeader2.story_id);
                    }
                    v7Var.c();
                    ...
                    if (tL_mediaAreaChannelPost != null && (chat2 = MessagesController.getInstance(i11).getChat(Long.valueOf(tL_mediaAreaChannelPost.channel_id))) != null) {
                        v7Var = new v7();
                        v7Var.f17858b = Long.valueOf(-chat2.f20843id);
                        v7Var.f17860e = true;
                        v7Var.f17857a = i11;
                        v7Var.f17861f = true;
                        ...
                        v7Var.f17865k = new SpannableStringBuilder(groupSpan2).append((CharSequence) " ").append((CharSequence) chat2.title);
                    }
                }
                this.f16968j = v7Var;
            } else {
                ...
                if (s6Var != null) {
                    ...
                    if (s6Var2 != null) {
                        if (s6Var2.f46069n) {
                            v7Var = new v7();
                            v7Var.f17865k = s6Var2.f46073p;
                            String str2 = s6Var2.f46079s;
                            v7Var.f17866l = str2;
                            v7Var.f17861f = TextUtils.isEmpty(str2);
                        } else if (s6Var2.f46083u && (arrayList = s6Var2.v) != null && arrayList.size() > 0) {
                            ...
                            if (p10 < 0 && (chat = MessagesController.getInstance(messageObject.currentAccount).getChat(Long.valueOf(-p10))) != null) {
                                v7Var = new v7();
                                v7Var.f17858b = Long.valueOf(p10);
                                v7Var.f17860e = true;
                                v7Var.f17857a = messageObject.currentAccount;
                                v7Var.f17861f = true;
                                ...
                                v7Var.f17865k = new SpannableStringBuilder(groupSpan).append((CharSequence) " ").append((CharSequence) chat.title);
                            }
                        }
                    }
                    this.f16968j = v7Var;
    ...
    public final boolean k(long j10) {
        ...
        if (storyItem != null) {
            TLRPC.MessageMedia messageMedia = storyItem.media;
            if ((messageMedia instanceof TLRPC.TL_messageMediaVideoStream) && j10 == ((TLRPC.TL_messageMediaVideoStream) messageMedia).call.f20860id) {
                return true;
            }
            return false;
        }
    ...
    public final void o() {
        ...
        if (s6Var != null) {
            CharSequence charSequence = s6Var.f17737c.C0;
            this.h = charSequence;
            ...
            TLRPC.User user = MessagesController.getInstance(f4Var.f17133z2).getUser(Long.valueOf(f4Var.f17128y1));
            if (f4Var.f17128y1 < 0 || MessagesController.getInstance(f4Var.f17133z2).storyEntitiesAllowed(user)) {
        ...
        if (storyItem != null) {
            if (storyItem.translated && storyItem.translatedText != null && TextUtils.equals(storyItem.translatedLng, w31.B())) {
                this.f16966g = true;
                TLRPC.TL_textWithEntities tL_textWithEntities = d4Var.f16961a.translatedText;
                ...
                if (replaceEmoji2 != null && tL_textWithEntities.entities != null) {
                    ...
                    i10 = (f4Var.f17128y1 < 0 || MessagesController.getInstance(f4Var.f17133z2).storyEntitiesAllowed(MessagesController.getInstance(f4Var.f17133z2).getUser(Long.valueOf(f4Var.f17128y1)))) ? 1 : 1;
                    if (i10 != 0) {
            ...
            String str2 = d4Var.f16961a.caption;
            this.h = str2;
            CharSequence replaceEmoji3 = Emoji.replaceEmoji(str2, n3Var.V.getPaint().getFontMetricsInt(), false);
            this.h = replaceEmoji3;
            if (replaceEmoji3 != null && d4Var.f16961a.entities != null) {
                SpannableStringBuilder valueOf3 = SpannableStringBuilder.valueOf(MessageObject.replaceAnimatedEmoji(new SpannableStringBuilder(d4Var.f16961a.caption), d4Var.f16961a.entities, n3Var.V.getPaint().getFontMetricsInt(), false));
                ...
                MessageObject.addEntitiesToText(valueOf3, d4Var.f16961a.entities, false, true, true, false, i10 ^ 1);
                this.h = valueOf3;
            }
        }
    }
