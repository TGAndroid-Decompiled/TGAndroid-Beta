...
public final class h2 extends v0 {
    public final i9 f17174e0;
    public final f4 f17175f0;
    ...
    public h2(f4 f4Var, Context context, i9 i9Var, x8 x8Var, View view, FrameLayout frameLayout, i9 i9Var2) {
        ...
        this.f17175f0 = f4Var;
        this.f17174e0 = i9Var2;
    }

    @Override
    public final TLRPC.Peer getDefaultSendAs() {
        e1 e1Var = this.f17174e0.f17303x0;
        if (e1Var != null) {
            return e1Var.i();
        }
        return null;
    ...
    public final void h(long j10) {
        r1 r1Var = this.f17175f0.V1;
        if (r1Var != null) {
            ArrayList arrayList = r1Var.h;
            for (int i10 = 0; i10 < arrayList.size(); i10++) {
                if (((q1) arrayList.get(i10)).f17643a == j10) {
    ...
    public final void q(boolean z4, boolean z10) {
        float f10;
        if (!z10 || this.f17832c0 != z4) {
            this.f17832c0 = z4;
            ValueAnimator valueAnimator = this.f17830b0;
            ...
            if (z10) {
                ...
                this.f17830b0 = ofFloat;
                ofFloat.addUpdateListener(new eg.m1(this, 22));
                this.f17830b0.addListener(new eg.u2(5, this, z4));
                this.f17830b0.setDuration(420L);
                this.f17830b0.setInterpolator(pr.h);
                this.f17830b0.start();
            } else {
                if (z4) {
                    f10 = 0.0f;
    ...
    public final void setVisibility(int i10) {
        ...
        this.f17175f0.J0.setVisibility(i10);
    }
}
