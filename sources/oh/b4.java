...
public final class b4 extends FrameLayout {
    ...
    public b4(Context context, d4 d4Var) {
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            this.f16888c[i10] = new TextView(context);
            this.f16888c[i10].setTextSize(1, 12.0f);
            this.f16888c[i10].setMaxLines(1);
            this.f16888c[i10].setSingleLine(true);
            this.f16888c[i10].setEllipsize(TextUtils.TruncateAt.MIDDLE);
            this.f16888c[i10].setTextColor(-1);
            this.f16888c[i10].setPadding(AndroidUtilities.dp(3.0f), 0, AndroidUtilities.dp(3.0f), AndroidUtilities.dp(1.0f));
            addView(this.f16888c[i10], k7.c6.d(-2, -2.0f, 0, 51.0f, 18.0f, 83.0f, 0.0f));
        }
        this.f16887b.setTextColor(-1);
    }
    ...
    public final void b(float f10, Canvas canvas, RectF rectF, boolean z4) {
        ...
        float clamp;
        s6 s6Var;
        d4 d4Var = this.f16889e;
        if ((d4Var != null && d4Var.f16962b != null) || this.h != 0.0f) {
            if (d4Var != null && (s6Var = d4Var.f16962b) != null && !s6Var.F) {
                this.h = 1.0f;
                f11 = s6Var.h;
                if (!this.f16891n) {
                    this.f16891n = true;
            ...
            if (this.f16892r && z10 && this.d.f29127f >= 0.9f) {
                this.h = Utilities.clamp(this.h - ((1000.0f / AndroidUtilities.screenRefreshRate) / 300.0f), 1.0f, 0.0f);
            }
            if (z4) {
                if (f10 != 1.0f) {
                ...
                if (this.f16890f == null) {
                    ...
                    this.f16890f = paint;
                    paint.setColor(-1);
                    this.f16890f.setStrokeWidth(AndroidUtilities.dp(2.0f));
                    this.f16890f.setStyle(Paint.Style.STROKE);
                    this.f16890f.setStrokeCap(Paint.Cap.ROUND);
                }
                this.f16890f.setAlpha((int) (255.0f * f10 * this.h));
                mj0 mj0Var5 = this.d;
                mj0Var5.f29140t = this.f16890f;
                mj0Var5.a(canvas);
            }
        }
    }
    ...
    public final void c(CharSequence charSequence, boolean z4) {
        ValueAnimator valueAnimator = this.f16893s;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.f16893s = null;
        }
        TextView[] textViewArr = this.f16888c;
        if (z4) {
            ...
            this.f16893s = ofFloat;
            ofFloat.addUpdateListener(new eg.m1(this, 27));
            this.f16893s.addListener(new dg.l0(this, 20));
            this.f16893s.setInterpolator(pr.h);
            this.f16893s.setDuration(340L);
            this.f16893s.start();
            return;
        }
        textViewArr[0].setVisibility(0);
