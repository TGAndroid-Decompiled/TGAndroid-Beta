...
public final class z2 extends ImageReceiver {
    ...
    public void invalidate() {
        switch (this.f17993a) {
            case 2:
                View view = ((ao) this.f17994b).f35224b;
                if (view != null) {
                    view.invalidate();
                    return;
                }
                return;
            case 3:
                ((org.telegram.ui.Components.l5) this.f17994b).k();
                super.invalidate();
                return;
            default:
                super.invalidate();
    ...
    public boolean setImageBitmapByKey(Drawable drawable, String str, int i10, boolean z4, int i11) {
        ...
        switch (i12) {
            ...
            case 3:
                ...
                if (l5Var.f28639m && hasImageLoaded()) {
                    l5Var.f28639m = false;
            ...
            case 6:
                if (drawable != null && i10 != 1) {
                    org.telegram.ui.b.p(((vf.v0) ((a4) obj).E).f49260n.animate().alpha(1.0f).translationY(0.0f), pr.f30172k, 250L);
                }
                return super.setImageBitmapByKey(drawable, str, i10, z4, i11);
        }
    }
    ...
    public void setRoundRadius(int[] iArr) {
        switch (this.f17993a) {
            case 1:
                ...
                org.telegram.ui.Cells.t1 t1Var = (org.telegram.ui.Cells.t1) this.f17994b;
                int[] iArr2 = t1Var.O0;
                iArr2[0] = iArr[0];
                iArr2[1] = iArr[1];
