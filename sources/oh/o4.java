...
public final class o4 implements kl0 {
    public final i9 f17551a;
    public final e5 f17552b;
    ...
    public final boolean f(int i10, View view) {
        ...
        if (view instanceof org.telegram.ui.Cells.n6) {
            ...
            i9 i9Var = this.f17551a;
            if (i9Var.v != null && (storyView = ((v4) e5Var.f17035w.f16844c.get(i10)).f17850b) != null && (user = (messagesController = MessagesController.getInstance(i11)).getUser(Long.valueOf(storyView.user_id))) != null) {
                if (messagesController.blockePeers.indexOfKey(user.f20992id) >= 0) {
                    z4 = true;
                } else {
                    z4 = false;
                }
                if (!user.contact && ContactsController.getInstance(i11).contactsDict.get(Long.valueOf(user.f20992id)) == null) {
                    z10 = false;
                } else {
                    z10 = true;
                }
                ...
                F.f30315i = 3;
                F.f30317j = true;
                F.W(new ColorDrawable(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21733h5, bVar)));
                F.f30333s = 133;
                ...
                F.l(R.drawable.msg_stories_myhide, LocaleController.formatString(R.string.StoryHideFrom, str), new Runnable(this) {
                    ...
                    public final void run() {
                        ...
                        o4 o4Var = this.f17435b;
                        switch (i12) {
                            case 0:
                                messagesController2.getStoriesController().j0(user2.f20992id, true, true);
                                e5 e5Var2 = o4Var.f17552b;
                                yh.s(R.string.StoryHidFromToast, new Object[]{str3}, new qc(e5Var2, e5Var2.f17034s), R.raw.ic_ban, 36);
                                ...
                                return;
                            default:
                                messagesController2.getStoriesController().j0(user2.f20992id, false, true);
                                e5 e5Var3 = o4Var.f17552b;
                                yh.s(R.string.StoryShownBackToToast, new Object[]{str3}, new qc(e5Var3, e5Var3.f17034s), R.raw.contact_check, 36);
                ...
                F.m(z13, R.drawable.msg_user_remove, LocaleController.getString(R.string.BlockUser), true, new Runnable(this) {
                    ...
                    public final void run() {
                        ...
                        switch (r6) {
                            case 0:
                                messagesController.blockPeer(user.f20992id);
                                e5 e5Var2 = this.f17485b.f17552b;
                                new qc(e5Var2, e5Var2.f17034s).e(true).j();
                            ...
                            default:
                                ...
                                TLRPC.User user2 = user;
                                storiesController.j0(user2.f20992id, false, true);
                                messagesController2.unblockPeer(user2.f20992id);
                                e5 e5Var3 = this.f17485b.f17552b;
                                new qc(e5Var3, e5Var3.f17034s).e(false).j();
