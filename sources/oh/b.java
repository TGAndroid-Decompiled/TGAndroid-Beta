...
public final class b extends FrameLayout implements ah0, e {
    ...
    public TextPaint T;
    public h9 U;
    public final TextView f15521a;
    public final bj0 f15522b;
    public w9 f15523c;
    public d6 d;
    public final Paint e;
    public final o6 f15524f;
    public final le.c h;
    public final le.c f15525n;
    public final le.c f15526r;
    public int f15527s;
    public int v;
    public int f15528w;
    ...
    public b(Context context) {
        super(context);
        this.e = new Paint(1);
        this.h = new le.c(0, this, ke.a.f13577a, 320L, false);
        rr rrVar = rr.h;
        this.f15525n = new le.c(1, this, rrVar, 380L, false);
        this.f15526r = new le.c(2, this, rrVar, 380L, false);
        this.S = 1.0f;
    ...
    public static b b(Context context, d6 d6Var, a aVar, int i10) {
        ...
        bVar.d = d6Var;
        bVar.f15530y = aVar;
        bVar.f15521a.setText(LocaleController.getString(i10));
        bVar.a(false);
        bVar.f15522b.setLayoutParams(x5.d(24, 24.0f, 49, 0.0f, 4.0f, 0.0f, 0.0f));
        bVar.f15528w = h6.v0(h6.cl, d6Var);
        bVar.f15527s = h6.v0(h6.al, d6Var);
    ...
    public final void a(boolean z10) {
        ...
        a aVar = this.f15530y;
        if (aVar != null) {
            int i11 = aVar.f15519b;
            int i12 = aVar.f15518a;
            int i13 = aVar.f15520c;
            bj0 bj0Var = this.f15522b;
            if (i13 != -1) {
            ...
            if (aVar.d != -1) {
                ...
                if (z11) {
                    ...
                    if (animatedDrawable != null) {
                        if (z12) {
                            animatedDrawable.P(this.f15530y.d);
                            if (animatedDrawable.f30258a0 >= this.f15530y.e - 2) {
                                animatedDrawable.N(0, false, false);
                            }
                            int i14 = animatedDrawable.f30258a0;
                            int i15 = this.f15530y.d;
                            if (i14 <= i15) {
                            ...
                            int i16 = animatedDrawable.f30258a0;
                            a aVar2 = this.f15530y;
                            if (i16 >= aVar2.d - 1) {
                ...
                if (bj0Var.getAnimatedDrawable() == null) {
                    bj0Var.f(this.f15530y.f15518a, 24, 24, null);
                }
    ...
    public final float c() {
        float measureText = this.F.measureText(this.f15521a.getText().toString());
    ...
    public final void d(String str, boolean z10, boolean z11) {
        this.f15524f.q(str, z11, true);
        this.f15525n.a(!TextUtils.isEmpty(str), z11);
        this.f15526r.a(z10, z11);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        Paint paint = this.e;
        if (f7 > 0.0f && !this.K) {
            paint.setColor(h6.l1(ke.a.f13577a.getInterpolation(f7) * 0.09f, this.f15527s));
        ...
        if (i10 > 0) {
            ...
            if (this.f15529x) {
                ...
                paint.setColor(i0.a.d(this.f15526r.e, h6.w0(null, h6.hl, false), h6.w0(null, h6.f19045r7, false)));
    ...
    public final void e(boolean z10, boolean z11) {
        ...
        this.f15521a.setTypeface(bold);
    }

    public final void f() {
        int i10 = this.f15528w;
        int i11 = this.f15527s;
        le.c cVar = this.h;
        int d = i0.a.d(cVar.e, i10, i11);
        int d10 = i0.a.d(cVar.e, this.f15528w, this.v);
        ...
        if (w9Var != null && this.M) {
            ...
            this.f15523c.invalidate();
        }
        this.f15522b.setColorFilter(porterDuffColorFilter);
        this.f15521a.setTextColor(d10);
    }
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        if (this.G) {
            ...
            this.f15522b.setTranslationX(measuredWidth);
            this.f15521a.setTranslationX(measuredWidth);
        }
    }
    ...
    public void setText(CharSequence charSequence) {
        this.f15521a.setText(charSequence);
    }
