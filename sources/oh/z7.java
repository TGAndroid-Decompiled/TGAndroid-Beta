...
public final class z7 extends View implements v9 {
    ...
    public final a8 G;
    public final PorterDuffColorFilter f17999a;
    public boolean f18000b;
    public final TextPaint f18001c;
    public final TextPaint d;
    public final Paint f18002e;
    public final Paint f18003f;
    public float h;
    public float f18004n;
    public final y7[] f18005r;
    public int f18006s;
    public StaticLayout v;
    public float f18007w;
    public boolean f18008x;
    public final boolean f18009y;

    public z7(a8 a8Var, Context context) {
        super(context);
        this.G = a8Var;
        TextPaint textPaint = new TextPaint(1);
        this.f18001c = textPaint;
        ...
        this.f17999a = new PorterDuffColorFilter(-1, PorterDuff.Mode.SRC_IN);
    }
    ...
    public final void b(CharSequence charSequence, v7 v7Var, v7 v7Var2, boolean z4, boolean z10) {
        ...
        y7[] y7VarArr = this.f18005r;
        if (MediaDataController.stringsEqual(y7VarArr[0].f17977n, charSequence)) {
            y7 y7Var = y7VarArr[0];
            if (y7Var.f17978o == v7Var && y7Var.f17979p == v7Var2) {
                y7Var.f17980q = z4;
                invalidate();
                return;
            }
        ...
        if (z10) {
            ...
            y7Var2.g(y7Var3.f17977n, y7Var3.f17978o, y7Var3.f17979p);
            y7 y7Var4 = y7VarArr[1];
            y7 y7Var5 = y7VarArr[0];
            y7Var4.f17980q = y7Var5.f17980q;
            y7Var4.f17981r.d(y7Var5.f17981r.f33763c, true);
            y7VarArr[0].g(charSequence, v7Var, v7Var2);
            y7 y7Var6 = y7VarArr[0];
            y7Var6.f17980q = z4;
            y7Var6.f17981r.d(0.0f, true);
            this.D = 1.0f;
            ...
            this.F.setInterpolator(pr.f30169g);
            this.F.start();
            return;
        }
        y7VarArr[0].g(charSequence, v7Var, v7Var2);
        y7VarArr[0].f17980q = z4;
        invalidate();
        this.D = 0.0f;
    }
    ...
    public Layout getStaticTextLayout() {
        return this.f18005r[0].f17969e;
    }

    @Override
    public CharSequence getText() {
        return this.f18005r[0].f17977n;
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        int i10 = 0;
        y7 y7Var = this.f18005r[0];
        z7 z7Var = y7Var.v;
        org.telegram.ui.Components.u5.release(z7Var, y7Var.d);
        org.telegram.ui.Components.u5.release(z7Var, y7Var.f17970f);
        if (y7Var.h == null) {
            return;
        }
        while (true) {
            ...
            if (i10 < w7VarArr.length) {
                ...
                if (w7Var != null) {
                    org.telegram.ui.Components.u5.release(z7Var, w7Var.f17908a);
                }
                i10++;
            } else {
                return;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.v != null) {
            ...
            int clamp = (int) ((1.0f - Utilities.clamp(this.f18007w / 0.5f, 1.0f, 0.0f)) * 255.0f);
            Paint paint = this.f18003f;
            paint.setAlpha(clamp);
            Paint paint2 = this.f18002e;
            paint2.setAlpha(clamp);
            this.d.setAlpha(clamp);
            canvas2.save();
            canvas2.translate(this.f18004n - AndroidUtilities.dp(32.0f), scrollY);
            canvas2.drawRect(0.0f, 0.0f, AndroidUtilities.dp(32.0f), this.v.getHeight() + this.C, paint);
            canvas2.restore();
            canvas2.drawRect(this.f18004n - AndroidUtilities.dp(16.0f), scrollY, getMeasuredWidth(), this.v.getHeight() + scrollY + this.C, paint2);
            canvas2.save();
            canvas2.translate(this.f18004n, scrollY);
            this.v.draw(canvas2);
            canvas2.restore();
        }
        canvas2.restore();
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        ...
        if ((y7Var2 != null && (y7Var2.f17982s == drawable || (((v7Var3 = y7Var2.f17978o) != null && v7Var3.f17866j == drawable) || ((v7Var4 = y7Var2.f17979p) != null && v7Var4.f17866j == drawable)))) || ((y7Var = y7VarArr[1]) != null && (y7Var.f17982s == drawable || (((v7Var = y7Var.f17978o) != null && v7Var.f17866j == drawable) || ((v7Var2 = y7Var.f17979p) != null && v7Var2.f17866j == drawable))))) {
            return true;
        }
