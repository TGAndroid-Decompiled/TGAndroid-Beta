...
public final class o extends FrameLayout {
    ...
    public boolean d;
    public j7 f17519e;
    public TLRPC.User f17520f;
    public TLRPC.Chat h;
    public final org.telegram.ui.Components.z8 f17521n;
    public final ImageReceiver f17522r;
    public final ImageReceiver f17523s;
    public final org.telegram.ui.Components.z8 v;
    public boolean f17524w;
    public final FrameLayout f17525x;
    public org.telegram.ui.ActionBar.l5 f17526y;

    public o(hx hxVar, Context context) {
        super(context);
        boolean z4;
        this.V = hxVar;
        this.f17521n = new org.telegram.ui.Components.z8((org.telegram.ui.ActionBar.g6) null);
        ImageReceiver imageReceiver = new ImageReceiver(this);
        this.f17522r = imageReceiver;
        ImageReceiver imageReceiver2 = new ImageReceiver(this);
        this.f17523s = imageReceiver2;
    ...
    public final void b() {
        ...
        this.f17526y.setGravity(17);
        this.f17526y.setTextSize(11);
        this.f17526y.setTextColor(p.a(this.V));
        NotificationCenter.listenEmojiLoading(this.f17526y);
        this.f17526y.setMaxLines(1);
        this.f17525x.addView(this.f17526y, k7.c6.d(-1, -2.0f, 0, 1.0f, 0.0f, 1.0f, 0.0f));
        this.f17522r.setRoundRadius(AndroidUtilities.dp(48.0f) / 2);
        this.f17523s.setRoundRadius(AndroidUtilities.dp(48.0f) / 2);
    }

    public final void c(Canvas canvas, float f10, float f11, float f12) {
        int i10;
        hx hxVar = this.V;
        int i11 = hxVar.f17576b;
        Paint paint = hxVar.D;
        t6 t6Var = hxVar.f17598s;
        Paint paint2 = hxVar.E;
        Drawable drawable = hxVar.f17578c;
        if (this.C && !t6Var.I(this.B) && Utilities.isNullOrEmpty(t6Var.E(this.B))) {
            ...
            if (i11 == 0) {
                paint2.setColor(org.telegram.ui.ActionBar.k6.l1(f12, hxVar.f(org.telegram.ui.ActionBar.k6.f21930s8)));
            } else {
            ...
            if (i11 == 0) {
                i10 = org.telegram.ui.ActionBar.k6.f21930s8;
            } else {
                i10 = org.telegram.ui.ActionBar.k6.M8;
            }
            int f13 = hxVar.f(i10);
            if (f13 != hxVar.f17581e) {
                hxVar.f17581e = f13;
    ...
    public final void d(float f10, float f11, float f12, boolean z4) {
        ...
        if (this.K) {
            ...
            clamp = 1.0f - Utilities.clamp(hxVar.K / hxVar.f17608y0, 1.0f, 0.0f);
        }
        this.N = clamp;
        float f14 = clamp * this.M;
        FrameLayout frameLayout = this.f17525x;
    ...
    public final void invalidate() {
        if (this.K || (this.f17516a && getParent() != null)) {
            ViewParent parent = getParent();
            hx hxVar = this.V;
            h hVar = hxVar.f17596r;
            if (parent == hVar) {
                hVar.invalidate();
            } else {
                hxVar.invalidate();
    ...
    public final void onAttachedToWindow() {
        ...
        this.f17522r.onAttachedToWindow();
        this.f17523s.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f17522r.onDetachedFromWindow();
        this.f17523s.onDetachedFromWindow();
        this.L.g();
        j7 j7Var = this.f17519e;
        if (j7Var != null) {
            j7Var.a();
            this.f17519e = null;
        }
    ...
    public void setCrossfadeTo(long j10) {
        ...
        if (this.F != j10) {
            ...
            this.E = z4;
            ImageReceiver imageReceiver = this.f17523s;
            if (z4) {
                if (j10 > 0) {
