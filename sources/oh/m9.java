...
public final class m9 extends j9 {
    public final l9 f17471a;
    public final TL_stories.TL_mediaAreaWeather f17472b;
    public View f17473c;
    public final n9 d;

    public m9(n9 n9Var, TL_stories.TL_mediaAreaWeather tL_mediaAreaWeather) {
        this.d = n9Var;
        this.f17472b = tL_mediaAreaWeather;
        ...
        l9Var.d(UserConfig.selectedAccount, tLObject.f46310c);
    ...
    public final void a(Canvas canvas, float f10) {
        ...
        n9 n9Var = this.d;
        double d = n9Var.d;
        TL_stories.TL_mediaAreaWeather tL_mediaAreaWeather = this.f17472b;
        TL_stories.MediaAreaCoordinates mediaAreaCoordinates = tL_mediaAreaWeather.coordinates;
        double d10 = (mediaAreaCoordinates.f21077x * d) / 100.0d;
        double d11 = n9Var.f17515e;
        double d12 = (mediaAreaCoordinates.f21078y * d11) / 100.0d;
        float f11 = (float) ((d * mediaAreaCoordinates.f21076w) / 100.0d);
        canvas.save();
        canvas.translate((float) (d10 + n9Var.f17513b), (float) (d12 + n9Var.f17514c));
        l9 l9Var = this.f17471a;
