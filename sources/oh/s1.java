...
public final class s1 extends View {
    ...
    public final r1 f17715a;
    public final RectF f17716b;
    public final Path f17717c;
    public final wa d;
    public final org.telegram.ui.Components.z5 f17718e;
    public final org.telegram.ui.Components.z5 f17719f;
    public final org.telegram.ui.Components.j6 h;
    public final Paint f17720n;
    public final Paint f17721r;
    public final Drawable f17722s;
    public final og.i v;
    public int f17723w;
    ...
    public s1(Context context, r1 r1Var, rg.b bVar) {
        ...
        pr prVar = pr.h;
        this.f17718e = new org.telegram.ui.Components.z5(this, 320L, prVar);
        this.f17719f = new org.telegram.ui.Components.z5(this, 320L, prVar);
        ...
        this.f17715a = r1Var;
        k7.e6.a(this);
        this.f17722s = context.getResources().getDrawable(R.drawable.star).mutate();
        og.i iVar = new og.i();
        this.v = iVar;
        iVar.a(bVar);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (e10 > 0.0f) {
            ...
            canvas.drawRoundRect(rectF2, rectF2.height() / 2.0f, rectF2.height() / 2.0f, this.f17721r);
            rectF2.set(getWidth() - max, 0.0f, getWidth(), AndroidUtilities.dp(13.0f));
