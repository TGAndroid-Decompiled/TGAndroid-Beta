...
public final class q9 {
    public static final q9[] f17670f = new q9[4];
    public final int f17671a;
    public final LongSparseLongArray f17672b = new LongSparseLongArray();
    public final ArrayList f17673c = new ArrayList();
    public final ArrayList d = new ArrayList();
    public final p9 f17674e;

    public q9(int i10) {
        new ArrayList();
        this.f17674e = new p9(this);
        this.f17671a = i10;
    }
    ...
    public final void a(aa aaVar) {
        ...
        for (int i10 = 0; i10 < aaVar.getChildCount(); i10++) {
            ...
            LongSparseLongArray longSparseLongArray = this.f17672b;
            if (j10 > 0) {
