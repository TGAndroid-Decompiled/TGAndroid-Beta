...
public final class i extends ou0 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f10 = i11;
        r rVar = this.f16568n3;
        o oVar = rVar.G;
        if (rVar.f16582b) {
            pt0 pt0Var = rVar.f16586r;
            int i13 = 0;
            ...
            f10 = AndroidUtilities.lerp(f10, i13, rVar.f16583c);
        }
        if (rVar.v.h() <= 0) {
            i10 = 8;
        }
    ...
    public final int getAnimateToColumnsCount() {
        return this.f16568n3.e;
    }

    @Override
    public final float getChangeColumnsProgress() {
        return this.f16568n3.f16583c;
    }

    @Override
    public final int getColumnsCount() {
        return this.f16568n3.d;
    }

    @Override
    public final bl0 getMovingAdapter() {
        r rVar = this.f16568n3;
        if (rVar.D.f5679y == 0 && !rVar.T.D.f31172z1) {
            return rVar.v;
        }
        return null;
    }
    ...
    public final bl0 getSupportingAdapter() {
        return this.f16568n3.f16588w;
    }

    @Override
    public final pt0 getSupportingListView() {
        return this.f16568n3.f16586r;
    }

    @Override
    public final boolean y1() {
        return this.f16568n3.f16582b;
    }
