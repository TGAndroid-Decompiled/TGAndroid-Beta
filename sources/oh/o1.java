...
public final class o1 extends FrameLayout {
    ...
    public ValueAnimator f17544f;
    public boolean h;
    public float f17545n;
    public ValueAnimator f17546r;
    ...
    public final void a(boolean z4, boolean z10) {
        int i10;
        if (this.f17543e == z4 && z10) {
            return;
        }
        this.f17543e = z4;
        ValueAnimator valueAnimator = this.f17544f;
        ...
        if (!z10) {
            ...
            this.f17544f = ofFloat;
            ofFloat.addUpdateListener(new m1(this, 0));
            this.f17544f.setDuration(320L);
            this.f17544f.setInterpolator(pr.h);
            this.f17544f.start();
        }
        if (!this.h && z4) {
            z11 = false;
    ...
    public final void b(boolean z4, boolean z10) {
        ...
        int i11;
        this.h = z4;
        ImageView imageView = this.f17542c;
        if (!z10) {
            if (z4) {
    ...
    public final void c(boolean z4, boolean z10) {
        ValueAnimator valueAnimator = this.f17546r;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.f17546r = null;
        }
        ...
        if (!z10) {
            ...
            this.f17545n = f10;
            View view = this.f17541b;
            view.setAlpha(1.0f - f10);
            view.setScaleX(1.0f - this.f17545n);
            view.setScaleY(1.0f - this.f17545n);
            this.f17542c.setColorFilter(new PorterDuffColorFilter(i0.a.d(this.f17545n, -1, -2960428), PorterDuff.Mode.SRC_IN));
            this.f17540a.invalidate();
            return;
        }
        float f11 = this.f17545n;
        if (z4) {
            f10 = 1.0f;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(f11, f10);
        this.f17546r = ofFloat;
        ofFloat.addUpdateListener(new m1(this, 1));
        this.f17546r.setInterpolator(pr.h);
        this.f17546r.setDuration(420L);
        this.f17546r.start();
    }
}
