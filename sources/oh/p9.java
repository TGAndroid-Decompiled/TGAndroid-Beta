...
public final class p9 implements Runnable {
    ...
    public final void run() {
        q9 q9Var = this.f17631a;
        int i10 = q9Var.f17669a;
        ...
        if (!arrayList.isEmpty()) {
            ...
            for (int i11 = 0; i11 < arrayList2.size(); i11++) {
                tL_stories_getPeerMaxIDs.f21086id.add(MessagesController.getInstance(i10).getInputPeer(((Long) arrayList2.get(i11)).longValue()));
            }
