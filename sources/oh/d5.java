...
public final class d5 {
    public int f16972a;
    public final TL_stories.StoryItem f16973b;
    ...
    public final ArrayList f16977g = new ArrayList();
    public final ArrayList h = new ArrayList();
    public final ArrayList f16978i = new ArrayList();
    public boolean f16982m = true;
    public int f16984o = -1;
    public final HashSet f16985p = new HashSet();
    public final ArrayList f16987r = new ArrayList();
    public final q4 f16988s = new q4();
    ...
    public final void a() {
        ...
        boolean z4;
        if (!this.f16976f) {
            ArrayList arrayList = this.f16977g;
            arrayList.clear();
            q4 q4Var = this.f16988s;
            boolean z10 = q4Var.f17658b;
            ArrayList arrayList2 = this.h;
            if (!z10 && TextUtils.isEmpty(q4Var.f17659c)) {
                arrayList.addAll(arrayList2);
            } else {
                if (!TextUtils.isEmpty(q4Var.f17659c)) {
                    str = q4Var.f17659c.trim().toLowerCase();
                ...
                for (int i10 = 0; i10 < arrayList2.size(); i10++) {
                    ...
                    if (q4Var.f17658b && (user == null || !user.contact)) {
                        z4 = false;
                    } else {
                        z4 = true;
                    }
    ...
    public final int b() {
        ArrayList arrayList;
        if (this.f16976f) {
            arrayList = this.f16978i;
        } else {
            arrayList = this.f16977g;
        }
        return arrayList.size();
    }

    public final void c() {
        if (!this.f16975e && this.f16982m && !this.f16979j) {
            boolean z4 = this.f16976f;
            int i10 = 100;
            long j10 = this.f16974c;
            q4 q4Var = this.f16988s;
            int i11 = this.d;
            TL_stories.StoryItem storyItem = this.f16973b;
            if (z4) {
                TL_stories.TL_getStoryReactionsList tL_getStoryReactionsList = new TL_stories.TL_getStoryReactionsList();
                tL_getStoryReactionsList.forwards_first = q4Var.f17657a;
                tL_getStoryReactionsList.f21083id = storyItem.f21082id;
                tL_getStoryReactionsList.peer = MessagesController.getInstance(i11).getInputPeer(j10);
                tL_getStoryReactionsList.limit = (this.f16981l || this.f16978i.size() < 20) ? 20 : 20;
                String str = this.f16983n;
                ...
                this.f16975e = true;
                FileLog.d("SelfStoryViewsPage reactions load next " + storyItem.f21082id + " " + this.f16981l + " offset=" + tL_getStoryReactionsList.offset);
                int sendRequest = ConnectionsManager.getInstance(i11).sendRequest(tL_getStoryReactionsList, new RequestDelegate(this) {
                    public final d5 f16897b;
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r5) {
                                            case 0:
                                                ...
                                                int i12 = d5Var2.d;
                                                ArrayList arrayList3 = d5Var2.f16977g;
                                                TL_stories.StoryItem storyItem2 = d5Var2.f16973b;
                                                if (iArr[0] != d5Var2.f16984o) {
                                                    FileLog.d("SelfStoryViewsPage " + storyItem2.f21082id + " localId != reqId");
                                                    return;
                                                }
                                                d5Var2.f16975e = false;
                                                d5Var2.f16984o = -1;
                                                ...
                                                if (tLObject2 != null) {
                                                    ...
                                                    if (d5Var2.f16981l) {
                                                        d5Var2.f16981l = false;
                                                        for (int i14 = 0; i14 < arrayList3.size(); i14++) {
                                                            d5Var2.f16985p.add(Long.valueOf(((TL_stories.StoryView) arrayList3.get(i14)).user_id));
                                                        }
                                                        arrayList3.clear();
                                                        arrayList2.clear();
                                                    }
                                                    ...
                                                    if (i15 > storyViews.views_count) {
                                                        ...
                                                        for (int i16 = 0; i16 < Math.min(3, storyViewsList.users.size()); i16 = android.support.v4.media.a.g(storyViewsList.users.get(i16).f20992id, storyItem2.views.recent_viewers, i16, 1)) {
                                                        }
                                                ...
                                                FileLog.d("SelfStoryViewsPage " + storyItem2.f21082id + " response  totalItems " + arrayList3.size() + " has next " + d5Var2.f16982m);
                                                for (int i19 = 0; i19 < arrayList.size(); i19++) {
                                                    ((e5) arrayList.get(i19)).e(d5Var2);
                                                }
                                                if (arrayList3.size() < 20 && d5Var2.f16982m) {
                                                    d5Var2.c();
                                                    return;
                                                }
                                                return;
                                            default:
                                                d5 d5Var3 = d5Var;
                                                ArrayList arrayList4 = d5Var3.f16987r;
                                                TL_stories.StoryItem storyItem3 = d5Var3.f16973b;
                                                int i20 = d5Var3.d;
                                                ArrayList arrayList5 = d5Var3.f16978i;
                                                if (iArr[0] != d5Var3.f16984o) {
                                                    FileLog.d("SelfStoryViewsPage reactions " + storyItem3.f21082id + " localId != reqId");
                                                    return;
                                                }
                                                d5Var3.f16975e = false;
                                                d5Var3.f16984o = -1;
                                                ...
                                                if (tLObject3 != null) {
                                                    ...
                                                    if (d5Var3.f16981l) {
                                                        d5Var3.f16981l = false;
                                                        for (int i21 = 0; i21 < arrayList5.size(); i21++) {
                                                            d5Var3.f16985p.add(Long.valueOf(DialogObject.getPeerDialogId(((TL_stories.StoryReaction) arrayList5.get(i21)).peer_id)));
                                                        }
                                                        arrayList5.clear();
                                                        d5Var3.h.clear();
                                                    }
                                                ...
                                                FileLog.d("SelfStoryViewsPage reactions " + storyItem3.f21082id + " response  totalItems " + arrayList5.size() + " has next " + d5Var3.f16982m);
                                                for (int i24 = 0; i24 < arrayList4.size(); i24++) {
                                                    ((e5) arrayList4.get(i24)).e(d5Var3);
                                                }
                                                if (arrayList5.size() < 20 && d5Var3.f16982m) {
                                                    d5Var3.c();
                                                    return;
                                                }
                                                return;
                                ...
                                AndroidUtilities.runOnUIThread(new Runnable() {
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r5) {
                                            case 0:
                                                d5 d5Var22 = d5Var2;
                                                ArrayList arrayList = d5Var22.f16987r;
                                                ArrayList arrayList2 = d5Var22.h;
                                                int i12 = d5Var22.d;
                                                ArrayList arrayList3 = d5Var22.f16977g;
                                                TL_stories.StoryItem storyItem2 = d5Var22.f16973b;
                                                if (iArr2[0] != d5Var22.f16984o) {
                                                    FileLog.d("SelfStoryViewsPage " + storyItem2.f21082id + " localId != reqId");
                                                    return;
                                                }
                                                d5Var22.f16975e = false;
                                                d5Var22.f16984o = -1;
                                                TLObject tLObject2 = tLObject;
                                                if (tLObject2 != null) {
                                                    TL_stories.StoryViewsList storyViewsList = (TL_stories.StoryViewsList) tLObject2;
                                                    ...
                                                    MessagesStorage.getInstance(i12).putUsersAndChats(storyViewsList.users, storyViewsList.chats, true, false);
                                                    if (d5Var22.f16981l) {
                                                        d5Var22.f16981l = false;
                                                        for (int i14 = 0; i14 < arrayList3.size(); i14++) {
                                                            d5Var22.f16985p.add(Long.valueOf(((TL_stories.StoryView) arrayList3.get(i14)).user_id));
                                                        }
                                                        arrayList3.clear();
                                                        arrayList2.clear();
                                                    }
                                                    ...
                                                    if (!storyViewsList.views.isEmpty()) {
                                                        d5Var22.f16982m = true;
                                                    } else {
                                                        d5Var22.f16982m = false;
                                                    }
                                                    String str2 = storyViewsList.next_offset;
                                                    d5Var22.f16983n = str2;
                                                    if (TextUtils.isEmpty(str2)) {
                                                        d5Var22.f16982m = false;
                                                    }
                                                    if (storyItem2.views == null) {
                                                ...
                                                FileLog.d("SelfStoryViewsPage " + storyItem2.f21082id + " response  totalItems " + arrayList3.size() + " has next " + d5Var22.f16982m);
                                                for (int i19 = 0; i19 < arrayList.size(); i19++) {
                                                    ((e5) arrayList.get(i19)).e(d5Var22);
                                                }
                                                if (arrayList3.size() < 20 && d5Var22.f16982m) {
                                                    d5Var22.c();
                                                    return;
                                                }
                                                return;
                ...
                this.f16984o = sendRequest;
                final int[] iArr = {sendRequest};
                return;
            }
            TL_stories.TL_stories_getStoryViewsList tL_stories_getStoryViewsList = new TL_stories.TL_stories_getStoryViewsList();
            tL_stories_getStoryViewsList.f21091id = storyItem.f21082id;
            tL_stories_getStoryViewsList.peer = MessagesController.getInstance(i11).getInputPeer(j10);
            if (this.f16986q) {
                tL_stories_getStoryViewsList.f21092q = "";
                tL_stories_getStoryViewsList.just_contacts = false;
                tL_stories_getStoryViewsList.reactions_first = true;
            } else {
                String str2 = q4Var.f17659c;
                tL_stories_getStoryViewsList.f21092q = str2;
                if (!TextUtils.isEmpty(str2)) {
                    tL_stories_getStoryViewsList.flags |= 2;
                }
                tL_stories_getStoryViewsList.just_contacts = q4Var.f17658b;
                tL_stories_getStoryViewsList.reactions_first = q4Var.f17657a;
            }
            tL_stories_getStoryViewsList.limit = (this.f16981l || this.f16977g.size() < 20) ? 20 : 20;
            String str3 = this.f16983n;
            tL_stories_getStoryViewsList.offset = str3;
            if (str3 == null) {
                tL_stories_getStoryViewsList.offset = "";
            }
            this.f16975e = true;
            FileLog.d("SelfStoryViewsPage load next " + storyItem.f21082id + " " + this.f16981l + " offset=" + tL_stories_getStoryViewsList.offset + " q" + tL_stories_getStoryViewsList.f21092q + " " + tL_stories_getStoryViewsList.just_contacts + " " + tL_stories_getStoryViewsList.reactions_first);
    ...
    public final void d() {
        if (this.f16984o >= 0) {
            ConnectionsManager.getInstance(this.d).cancelRequest(this.f16984o, false);
        }
        this.f16984o = -1;
    }
    ...
    public final void e(q4 q4Var, boolean z4, boolean z10) {
        q4 q4Var2 = new q4();
        q4Var2.f17657a = q4Var.f17657a;
        q4Var2.f17658b = q4Var.f17658b;
        q4Var2.f17659c = q4Var.f17659c;
        int i10 = 0;
        if (!z4) {
            q4Var2.f17658b = false;
        }
        if (!z10) {
            q4Var2.f17657a = true;
        }
        q4 q4Var3 = this.f16988s;
        if (!q4Var3.equals(q4Var2)) {
            q4Var3.f17657a = q4Var2.f17657a;
            q4Var3.f17658b = q4Var2.f17658b;
            q4Var3.f17659c = q4Var2.f17659c;
            if (!this.f16976f && this.f16986q) {
                a();
                while (true) {
                    ArrayList arrayList = this.f16987r;
