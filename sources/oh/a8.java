...
public class a8 extends NestedScrollView implements p70 {
    ...
    public final z7 V;
    public boolean W;
    public float f16848a0;
    public float f16849b0;
    public float f16850c0;
    public float f16851d0;
    public float f16852e0;
    public float f16853f0;
    public float f16854g0;
    public final OverScroller f16855h0;
    public boolean f16856i0;
    public int f16857j0;
    public int f16858k0;
    public int f16859l0;
    public int m0;
    public int f16860n0;
    public final FrameLayout f16861o0;
    public boolean f16862p0;
    public boolean f16863q0;
    public int f16864r0;
    public boolean f16865s0;
    public boolean f16866t0;
    ...
    public a8(Context context, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        o1.j jVar = new o1.j(z7Var, o1.h.f16321n, 0.0f);
        this.U = jVar;
        ...
        try {
            ...
            this.f16855h0 = (OverScroller) declaredField.get(this);
        } catch (Exception e10) {
            this.f16855h0 = null;
            FileLog.e(e10);
        }
    ...
    public final void B(int i10) {
        ...
        if (this.W && i10 == 0) {
            this.W = false;
            if (this.f16848a0 != 0.0f && (overScroller = this.f16855h0) != null && overScroller.isFinished()) {
                K(this.f16850c0);
            }
        }
    }
    ...
    public final void a(RectF rectF) {
        ...
        if (y7VarArr != null && (y7Var = y7VarArr[0]) != null && y7Var.f17979p != null) {
            int i10 = z7Var.C;
            int i11 = z7Var.C;
            y7 y7Var2 = z7Var.f18005r[0];
            rectF.set(z7Var.B, (AndroidUtilities.lerp(y7Var.f17976m, y7Var.f17975l, z7Var.f18007w) + i10) - z7Var.f18005r[0].f17979p.b(), getWidth() - z7Var.B, AndroidUtilities.lerp(y7Var2.f17976m, y7Var2.f17975l, z7Var.f18007w) + i11);
            float x10 = z7Var.getX() - getScrollX();
            FrameLayout frameLayout = this.f16861o0;
    ...
    public final void b(Canvas canvas, float f10) {
        ...
        if (y7VarArr != null && (y7Var = y7VarArr[0]) != null && y7Var.f17979p != null) {
            ...
            canvas.translate(x11, (y10 + AndroidUtilities.lerp(y7Var2.f17976m, y7Var2.f17975l, z7Var.f18007w)) - y7VarArr2[0].f17979p.b());
            v7 v7Var = y7VarArr2[0].f17979p;
            int width = getWidth();
            int i10 = z7Var.B;
    ...
    public final void computeScroll() {
        OverScroller overScroller;
        super.computeScroll();
        if (!this.W && this.f16848a0 != 0.0f && (overScroller = this.f16855h0) != null && overScroller.isFinished()) {
            K(0.0f);
        }
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.clipRect(0, scrollY, width, this.f16864r0 + i10);
    ...
    public final boolean g(int i10, int i11, int i12, int[] iArr, int[] iArr2) {
        ...
        int i13;
        iArr[1] = 0;
        if (!this.W || (((this.f16848a0) <= 0.0f || i11 <= 0) && (f10 >= 0.0f || i11 >= 0))) {
            return false;
        }
        float f11 = i11;
        float f12 = f10 - f11;
        ...
        this.V.setTranslationY(this.f16848a0);
        this.T.x();
        return true;
    }
    ...
    public int getPendingMarginTopDiff() {
        int i10 = this.f16860n0;
        if (i10 >= 0) {
            return i10 - ((ViewGroup.MarginLayoutParams) this.f16861o0.getLayoutParams()).topMargin;
        }
        return 0;
    }
    ...
    public float getTextTop() {
        return (this.V.getTranslationY() + this.f16861o0.getTop()) - getScrollY();
    }
    ...
    public final void h(int i10, int i11, int i12, int i13, int[] iArr, int i14, int[] iArr2) {
        ...
        float f12;
        if (i13 != 0) {
            int round = Math.round((1.0f - Math.abs((-this.f16848a0) / this.f16861o0.getTop())) * i13);
            if (round != 0) {
                boolean z4 = this.W;
                z7 z7Var = this.V;
                if (!z4) {
                    if (!this.U.f16332f) {
                        OverScroller overScroller = this.f16855h0;
                        ...
                        if (!Float.isNaN(f10)) {
                            ...
                            f11 = min * (-this.f16849b0);
                        } else {
                            f11 = 0.0f;
                        }
                        if (round != 0) {
                            float f13 = this.f16848a0 - round;
                            this.f16848a0 = f13;
    ...
    public final boolean z(int i10, int i11) {
        if (i11 == 0) {
            this.U.c();
            this.W = true;
            this.f16848a0 = this.V.getTranslationY();
        }
        return true;
    }
