...
public final class r2 extends ra0 {
    ...
    public final void f(Canvas canvas, Rect rect, float f10) {
        ...
        canvas.drawRoundRect(rectF, f10, f10, f4Var.f17082k2);
        if (rectF.top < getMeasuredHeight() - 1) {
            canvas.drawRect(0.0f, getMeasuredHeight(), getMeasuredWidth(), getMeasuredHeight() - 1, f4Var.f17127y0.F("paintDivider"));
        }
    }
}
