...
public final class t4 extends xr {
    ...
    public final void b(ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout) {
        ...
        u4 u4Var = this.f17766c;
        e5 e5Var = u4Var.f17818x;
        d5 d5Var = e5Var.B;
        ...
        org.telegram.ui.ActionBar.g1 c3 = org.telegram.ui.ActionBar.w0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout, i14, LocaleController.getString(i11), false, e5Var.f17032s);
        if (!e5Var.L.f17655a) {
            c3.setAlpha(0.5f);
        }
        c3.setOnClickListener(new View.OnClickListener(this) {
            public final t4 f17732b;
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        e5 e5Var2 = this.f17732b.f17766c.f17818x;
                        q4 q4Var = e5Var2.L;
                        if (!q4Var.f17655a) {
                            q4 q4Var2 = e5Var2.J;
                            if (q4Var2 != null) {
                        ...
                        return;
                    default:
                        e5 e5Var3 = this.f17732b.f17766c.f17818x;
                        q4 q4Var3 = e5Var3.L;
                        if (q4Var3.f17655a) {
                            q4 q4Var4 = e5Var3.J;
                            if (q4Var4 != null) {
                                q4Var3.f17655a = false;
                                q4Var4.f17655a = false;
                            } else {
                                q4Var3.f17655a = false;
                            }
                            e5Var3.h(true);
        ...
        org.telegram.ui.ActionBar.g1 c10 = org.telegram.ui.ActionBar.w0.c(false, false, actionBarPopupWindow$ActionBarPopupWindowLayout, i12, LocaleController.getString(R.string.SortByTime), false, e5Var.f17032s);
        if (e5Var.L.f17655a) {
            c10.setAlpha(0.5f);
        }
        ...
        View m1Var = new org.telegram.ui.ActionBar.m1(u4Var.getContext(), org.telegram.ui.ActionBar.k6.H8, e5Var.f17032s);
