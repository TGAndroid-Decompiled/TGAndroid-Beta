...
public abstract class k4 extends View {
    ...
    public boolean v;
    public int f17360w;
    public float f17361x;
    public float f17362y;
    ...
    public final void c(int i10, boolean z4, boolean z10) {
        if ((this.H != i10 || z10) && getMeasuredHeight() > 0) {
            ...
            if (!z4) {
                ...
                this.f17355e = (i11 / 2.0f) + ((-getMeasuredWidth()) / 2.0f) + ((i11 + this.f17357n) * i10);
                invalidate();
                return;
            }
            int i12 = this.f17359s;
            float f10 = (i12 / 2.0f) + ((-getMeasuredWidth()) / 2.0f) + ((i12 + this.f17357n) * i10);
            ...
            this.J.setInterpolator(pr.f30168f);
    ...
    public final void d() {
        ...
        int i10 = this.f17359s;
        this.f17356f = (-(measuredWidth - i10)) / 2.0f;
        int i11 = i10 + this.f17357n;
        this.h = ((getMeasuredWidth() - this.f17359s) / 2.0f) + (((this.B.size() * i11) - this.f17357n) - getMeasuredWidth());
    }

    public j4 getCenteredImageReciever() {
        ArrayList arrayList = this.D;
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            if (((j4) arrayList.get(i10)).f17333b == this.H) {
    ...
    public final void onDetachedFromWindow() {
        ...
        this.v = false;
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ((j4) arrayList.get(i10)).f17332a.onDetachedFromWindow();
        }
        arrayList.clear();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.d.computeScrollOffset()) {
            this.f17355e = scroller.getCurrX();
            invalidate();
            this.I = true;
        ...
        while (i14 < this.B.size()) {
            int i16 = this.f17359s;
            float f16 = (-this.f17355e) + ((this.f17357n + i16) * i14);
            float f17 = ((i16 / f14) + f16) - measuredWidth;
            float abs = Math.abs(f17);
            if (abs < this.f17359s) {
                f10 = 1.0f - (Math.abs(f17) / this.f17359s);
                f11 = (0.2f * f10) + 1.0f;
            } else {
                f10 = 0.0f;
                f11 = 1.0f;
            ...
            if (f17 < 0.0f) {
                w10 = yh.c(1.0f, f10, this.f17359s * 0.1f, f16);
            } else {
                w10 = e2.c.w(1.0f, f10, this.f17359s * 0.1f, f16);
            }
            if (w10 > getMeasuredWidth() || this.f17359s + w10 < 0.0f) {
                ...
                while (true) {
                    if (i17 < arrayList4.size()) {
                        if (((j4) arrayList4.get(i17)).f17333b == i14) {
                ...
                float f18 = this.f17359s;
                float f19 = f18 * f11;
                float f20 = this.f17358r;
                float f21 = f11 * f20;
                f12 = measuredWidth;
                float a2 = org.telegram.messenger.y3.a(f19, f18, 2.0f, w10);
                float a10 = org.telegram.messenger.y3.a(f21, f20, 2.0f, this.f17361x);
                if (this.f17362y == 0.0f || i14 == (i12 = this.H)) {
                    arrayList2 = arrayList3;
                    arrayList = arrayList4;
                    f13 = f15;
                    i11 = i15;
                    j4Var.f17332a.setImageCoords(a2, a10, f19, f21);
                } else {
                    f13 = f15;
                    i11 = i15;
                    arrayList = arrayList4;
                    arrayList2 = arrayList3;
                    j4Var.f17332a.setImageCoords(AndroidUtilities.lerp(getMeasuredWidth() * (i14 - i12), a2, this.f17362y), AndroidUtilities.lerp(this.f17352a, a10, this.f17362y), AndroidUtilities.lerp(this.f17353b, f19, this.f17362y), AndroidUtilities.lerp(this.f17354c, f21, this.f17362y));
                }
                if (this.f17362y != 1.0f && i14 == this.H) {
                    arrayList3 = arrayList2;
                } else {
                    ImageReceiver imageReceiver = j4Var.f17332a;
                    imageReceiver.draw(canvas);
                    if (j4Var.f17334c != null) {
                        ...
                        canvas.save();
                        canvas.translate(imageReceiver.getCenterX() - (this.G / 2.0f), (imageReceiver.getImageY2() - AndroidUtilities.dp(8.0f)) - j4Var.f17334c.getHeight());
                        j4Var.d.setAlpha(y10);
                        j4Var.f17334c.draw(canvas);
                        canvas.restore();
                    }
                    arrayList3 = arrayList2;
                }
        ...
        for (int i18 = 0; i18 < arrayList5.size(); i18++) {
            ((j4) arrayList5.get(i18)).f17332a.onDetachedFromWindow();
        }
        arrayList5.clear();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f17357n = AndroidUtilities.dp(8.0f);
        int dp = (int) (AndroidUtilities.dp(180.0f) / 1.2f);
        this.f17358r = dp;
        int i12 = (int) ((dp / 16.0f) * 9.0f);
        this.f17359s = i12;
        float dp2 = i12 - AndroidUtilities.dp(8.0f);
        this.f17361x = ((AndroidUtilities.dp(180.0f) - this.f17358r) / 2.0f) + AndroidUtilities.dp(20.0f);
        d();
        if (this.f17360w >= 0 && getMeasuredWidth() > 0) {
            this.H = -1;
            c(this.f17360w, false, false);
            this.f17360w = -1;
        }
        if (this.G != dp2) {
            this.G = dp2;
            for (int i13 = 0; i13 < arrayList.size(); i13++) {
                ((j4) arrayList.get(i13)).a(((j4) arrayList.get(i13)).f17333b);
            }
        }
    }
