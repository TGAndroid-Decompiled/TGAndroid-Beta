...
public final class w8 extends qv0 {
    ...
    public final i9 F0;
    public float f17911t0;
    public float f17912u0;
    public float f17913v0;
    public final float[] f17914w0;
    public final Path f17915x0;
    public final RectF f17916y0;
    public final RectF f17917z0;

    public w8(i9 i9Var, Context context, org.telegram.ui.ActionBar.p2 p2Var) {
        super(context, null);
        this.F0 = i9Var;
        this.E0 = p2Var;
        this.f17914w0 = new float[8];
        this.f17915x0 = new Path();
        this.f17916y0 = new RectF();
        this.f17917z0 = new RectF();
        this.A0 = new RectF();
        this.B0 = new RectF();
        this.C0 = new RectF();
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        float f10 = 0.0f;
        if (i9Var.f17280m1 && currentPeerView != null && (rk0Var = currentPeerView.f17094o3) != null) {
            float f11 = 0.0f;
            for (View view = currentPeerView; view != null && (view.getParent() instanceof View); view = (View) view.getParent()) {
                f10 += view.getX();
                f11 += view.getY();
            }
            if (currentPeerView.f17094o3.getReactionsWindow() != null && currentPeerView.f17094o3.getReactionsWindow().f16035c != null) {
                motionEvent.offsetLocation(-f10, (-f11) - currentPeerView.f17094o3.getReactionsWindow().f16035c.getTranslationY());
                currentPeerView.f17094o3.getReactionsWindow().f16035c.dispatchTouchEvent(motionEvent);
                return true;
            }
        ...
        if (motionEvent.getAction() != 1 && motionEvent.getAction() != 3) {
            ...
            if (f12 != 0.0f) {
                ...
                i9Var.D.setInterpolator(pr.f30183f);
                i9Var.D.start();
            }
            if (i9Var.S >= 0.3f) {
                i9Var.q(true);
        ...
        if (motionEvent.getAction() == 0) {
            i9Var.X = false;
            if (currentPeerView != null) {
                eh.d dVar = currentPeerView.f17115v0;
                n8 n8Var = currentPeerView.f17131z0;
                j3 j3Var = currentPeerView.Z0;
                qh.f3 f3Var = currentPeerView.C0;
                if (f3Var != null && f3Var.S && n8Var != null) {
                    if (!f3Var.f45304o0.contains(motionEvent.getX() - (currentPeerView.C0.getX() + (j3Var.getX() + currentPeerView.getX())), motionEvent.getY() - (currentPeerView.C0.getY() + (j3Var.getY() + currentPeerView.getY()))) && !currentPeerView.H0(motionEvent, n8Var)) {
                        currentPeerView.C0.e(true);
                    }
                }
                qh.f3 f3Var2 = currentPeerView.D0;
                if (f3Var2 != null && f3Var2.S && dVar != null && !f3Var2.f45304o0.contains(motionEvent.getX() - (currentPeerView.D0.getX() + (j3Var.getX() + currentPeerView.getX())), motionEvent.getY() - (currentPeerView.D0.getY() + (j3Var.getY() + currentPeerView.getY()))) && !currentPeerView.H0(motionEvent, dVar)) {
                    currentPeerView.D0.e(true);
                }
            }
            i9Var.f17277k0.onTouchEvent(MotionEvent.obtain(0L, 0L, 3, 0.0f, 0.0f, 0));
        }
        if (!i9Var.f17302x && !i9Var.E0 && !i9Var.F0) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        if (f13 == 0.0f && !i9Var.f17269g0 && i9Var.f17277k0.C0 == 1 && motionEvent.getAction() == 2 && z10 && (((((Float) sparseArray.get(motionEvent.getPointerId(0), Float.valueOf(0.0f))).floatValue() - motionEvent.getX(0)) != 0.0f && (((i11 = (y8Var = i9Var.f17277k0).F0) == 0 && y8Var.H0 == 0.0f && floatValue < 0.0f) || (i11 == y8Var.getAdapter().b() - 1 && y8Var.H0 == 0.0f && i10 > 0))) || i9Var.U != 0.0f)) {
            float f14 = i9Var.U;
            if (f14 == 0.0f) {
                i9Var.V = -floatValue;
            }
        ...
        if (currentPeerView != null && i9Var.f17256b0 == 0.0f && !i9Var.f17269g0 && !i9Var.I0 && !i9Var.F0 && i9Var.f17277k0.C0 != 1) {
        ...
        if (!z11) {
            ...
            if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
                if (i9Var.f17256b0 != 0.0f && !i9Var.f17262d1 && i9Var.m0 < AndroidUtilities.dp(20.0f)) {
                ...
                f4 t6 = i9Var.t();
                if (t6 != null) {
                    t6.H0.f16864t0 = false;
                }
            }
            if (z4 && !i9Var.X) {
                i9Var.m();
            }
            if (!dispatchTouchEvent && (!i9.f17246u1 || !i9Var.f17282n0)) {
                return false;
            }
        }
        return true;
    ...
    public final void onMeasure(int i10, int i11) {
        i9 i9Var = this.F0;
        ((FrameLayout.LayoutParams) i9Var.f17254a1.getLayoutParams()).topMargin = AndroidUtilities.statusBarHeight - AndroidUtilities.dp(2.0f);
        i9Var.f17254a1.getLayoutParams().height = AndroidUtilities.dp(2.0f);
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!i9Var.f17269g0 && !i9Var.f17302x && i9Var.W == 0.0f && ((i9Var.f17256b0 == 0.0f || (!i9Var.f17259c0 && !i9Var.f17261d0)) && !i9Var.f17270g1)) {
            return false;
        }
        i9Var.f17267f0.onTouchEvent(motionEvent);
        return true;
    }
