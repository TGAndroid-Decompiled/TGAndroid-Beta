...
public final class b8 implements RequestDelegate {
    ...
    public b8(int i10, ii0 ii0Var, org.telegram.ui.ActionBar.p2 p2Var, TLRPC.TL_payments_assignPlayMarketTransaction tL_payments_assignPlayMarketTransaction) {
        ...
        this.f16902c = ii0Var;
        this.d = p2Var;
        this.f16903e = tL_payments_assignPlayMarketTransaction;
    }
        ...
        switch (i10) {
            case 0:
                ...
                if (tL_error != null && FileRefController.isFileRefError(tL_error.text) && obj3 != null) {
                    FileRefController.getInstance(this.f16901b).requestReference(obj3, tL_messages_getAttachedStickers, i0Var);
                    return;
                } else {
            ...
            case 1:
                AndroidUtilities.runOnUIThread(new lf.j0((o70) obj3, (org.telegram.ui.j4) obj2, tL_error, tLObject, this.f16901b, (org.telegram.ui.e1) obj));
                return;
            case 2:
                ...
                if (tL_error == null) {
                    AndroidUtilities.runOnUIThread(new eg.d3(sharedPreferences, (TLRPC.TL_help_support) tLObject, d2Var, this.f16901b, p2Var, 17));
                    return;
                } else {
            ...
            case 3:
                AndroidUtilities.runOnUIThread(new eg.d3((gs) obj3, tLObject, (TLRPC.InputPeer) obj2, this.f16901b, (int[]) obj, 18));
                return;
            case 4:
                zu0 zu0Var = (zu0) obj3;
            ...
            case 5:
                ...
                AndroidUtilities.runOnUIThread(new eg.d3((LaunchActivity) obj3, tLObject, (Uri) obj2, this.f16901b, (org.telegram.ui.ActionBar.d2) obj, 20), 2L);
                return;
            case 6:
                ii0 ii0Var = (ii0) obj3;
            ...
            case 7:
                AndroidUtilities.runOnUIThread(new lf.j0((org.telegram.ui.web.a1) obj3, (String) obj2, tLObject, tL_error, this.f16901b, (org.telegram.ui.web.x0) obj));
                return;
            default:
                AndroidUtilities.runOnUIThread(new eg.d3(tLObject, (boolean[]) obj3, (Utilities.Callback) obj2, this.f16901b, (TL_account.updateEmojiStatus) obj, 27));
                return;
        }
    }
