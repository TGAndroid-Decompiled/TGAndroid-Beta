...
public final class a3 extends FrameLayout {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f16840a) {
            case 0:
                f4 f4Var = this.f16841b;
                if (f4Var.C2.getVisibility() == 0 && f4Var.C2.getLayoutParams().width != (x10 = (int) (((f4Var.f17125x2.getX() + f4Var.f17125x2.getMeasuredWidth()) - f4Var.C2.getX()) + AndroidUtilities.dp(10.0f)))) {
    ...
    public boolean verifyDrawable(Drawable drawable) {
        switch (this.f16840a) {
            case 1:
                if (drawable != this.f16841b.O0 && !super.verifyDrawable(drawable)) {
                    return false;
                }
                return true;
            case 2:
                if (drawable != this.f16841b.N0 && !super.verifyDrawable(drawable)) {
                    return false;
                }
                return true;
            default:
