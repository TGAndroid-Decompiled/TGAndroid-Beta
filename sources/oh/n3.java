...
public final class n3 extends a8 {
    public final i9 f17481u0;
    public final org.telegram.ui.ActionBar.g6 f17482v0;
    public final f4 f17483w0;
    ...
    public final void F(org.telegram.ui.Components.u5 u5Var) {
        if (u5Var != null) {
            f4 f4Var = this.f17483w0;
            if (f4Var.N1 != null) {
                TLRPC.Document document = u5Var.document;
                if (document == null) {
                    document = org.telegram.ui.Components.l5.f(f4Var.f17135z2, u5Var.documentId);
                }
                if (document != null) {
                    j3 j3Var = f4Var.Z0;
                    org.telegram.ui.ActionBar.g6 g6Var = this.f17482v0;
                    ic h = new qc(j3Var, g6Var).h(document, 2, new lh.h(this, this.f17481u0, g6Var, 4));
                    if (h != null) {
                        h.f27771a = 1;
                        h.k(true);
                    }
    ...
    public final void G(CharacterStyle characterStyle, View view) {
        ...
        i9 i9Var = this.f17481u0;
        f4 f4Var = this.f17483w0;
        if (z4) {
            TLRPC.User user = MessagesController.getInstance(f4Var.f17135z2).getUser(Utilities.parseLong(((o51) characterStyle).getURL()));
            if (user != null) {
                MessagesController.getInstance(f4Var.f17135z2).openChatOrProfileWith(user, null, i9Var.f17268f, 0, false);
            }
            ...
            if (b10 != null) {
                ...
                if (url.startsWith("@")) {
                    MessagesController.getInstance(f4Var.f17135z2).openByUserName(lowerCase, i9Var.f17268f, 0, null);
                    return;
                } else {
            ...
            AndroidUtilities.addToClipboard(k51Var.f28276a.subSequence(k51Var.f28277b, k51Var.f28278c).toString());
            org.telegram.ui.b.m(R.string.TextCopied, new qc(f4Var.Z0, this.f17482v0));
    ...
    public final void H(final URLSpan uRLSpan, final View view, t3 t3Var) {
        ...
        final org.telegram.ui.ActionBar.g6 g6Var2 = this.f17482v0;
        DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() {
            ...
            public final void onClick(DialogInterface dialogInterface, int i10) {
                ...
                if (i10 == 0) {
                    ...
                    new qc(n3Var.f17483w0.Z0, g6Var2).k(false).j();
                }
            }
        };
    ...
    public final void I(v7 v7Var) {
        ...
        final TLRPC.Document document = v7Var.f17864g;
        f4 f4Var = this.f17483w0;
        i9 i9Var = this.f17481u0;
        final org.telegram.ui.ActionBar.g6 g6Var = this.f17482v0;
        if (document != null) {
            ...
            F.l(R.drawable.msg_saved, LocaleController.getString(R.string.StoryAudioAddToSavedMessages), new Runnable(this) {
                ...
                public final void run() {
                    ...
                    switch (r4) {
                        case 0:
                            f4 f4Var2 = this.f17350b.f17483w0;
                            SendMessagesHelper sendMessagesHelper = SendMessagesHelper.getInstance(f4Var2.f17135z2);
                            TLRPC.TL_document tL_document = (TLRPC.TL_document) document;
                            long clientUserId = UserConfig.getInstance(f4Var2.f17135z2).getClientUserId();
                            d4 d4Var = f4Var2.L1;
                            if (d4Var != null) {
                                storyItem = d4Var.f16963a;
                            } else {
                                storyItem = null;
                            }
                            ...
                            return;
                        default:
                            f4 f4Var3 = this.f17350b.f17483w0;
                            ...
                            if (MediaController.getInstance().currentSavedMusicList != null && MediaController.getInstance().currentSavedMusicList.dialogId == UserConfig.getInstance(f4Var3.f17135z2).getClientUserId()) {
                                MediaController.getInstance().currentSavedMusicList.add(document2);
                            }
                            ConnectionsManager.getInstance(f4Var3.f17135z2).sendRequest(tL_account_saveMusic, null);
            ...
            F.Z();
        } else if (v7Var.f17862e && v7Var.f17860b != null && v7Var.d != null) {
            Bundle bundle = new Bundle();
        ...
        } else if (v7Var.f17860b != null && v7Var.f17861c != null) {
            MessagesController.getInstance(f4Var.f17135z2).getStoriesController().d0(v7Var.f17860b.longValue(), v7Var.f17861c.intValue(), new hg.n1(this, v7Var, i9Var, g6Var, 1));
        } else {
    ...
    public final void M(int i10, String str, CharacterStyle characterStyle, boolean z4) {
        ...
        if (i10 != 0 && i10 != 2) {
            if (i10 == 1) {
                org.telegram.ui.Components.z4.r0(i9Var.f17268f, str, true, true, false, false, null, null, this.f17482v0);
                return;
            }
            return;
        }
        if ((characterStyle instanceof n51) && (s01Var = ((n51) characterStyle).f29392a) != null && (s01Var.f30949a & 1024) != 0) {
            z10 = true;
        } else {
            z10 = false;
        }
        org.telegram.ui.Components.z4.r0(i9Var.f17268f, str, true, true, true, z10, null, null, this.f17482v0);
    }
}
