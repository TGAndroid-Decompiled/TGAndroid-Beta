...
public abstract class ra extends j9 implements List, RandomAccess {
    ...
    public static final pa f8534b = new pa(ta.f8548e, 0);
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof List) {
            ...
            if (size == list.size()) {
                ...
                while (paVarListIterator.hasNext()) {
    ...
    public ra subList(int i10, int i11) {
        ...
        return i12 == 0 ? ta.f8548e : new qa(this, i10, i12);
    }
    ...
    public final pa listIterator(int i10) {
        ...
        return isEmpty() ? f8534b : new pa(this, i10);
    }
