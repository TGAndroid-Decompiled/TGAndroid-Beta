...
public enum c {
    ...
    public static final HashMap f17205c = new HashMap();
    ...
    static {
        ...
        for (c cVar : values()) {
            if (Charset.isSupported(cVar.name())) {
                for (int i10 : cVar.f17207a) {
                    f17205c.put(Integer.valueOf(i10), cVar);
                }
                d.put(cVar.name(), cVar);
                for (String str : cVar.f17208b) {
                    d.put(str, cVar);
                }
            }
        }
