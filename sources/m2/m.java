...
public abstract class m {
    public final b2.s f14666a;
    public final i0 f14667b;
    public final long f14668c;
    public final List d;
    public final List e;
    public final List f14669f;
    public final j h;
    ...
    public m(b2.s sVar, List list, s sVar2, List list2, List list3, List list4) {
        ...
        this.f14669f = list4;
        this.h = sVar2.a(this);
        long j3 = sVar2.f14681c;
        long j10 = sVar2.f14680b;
        String str = d0.f7887a;
        this.f14668c = d0.Y(j3, 1000000L, j10, RoundingMode.DOWN);
    }
