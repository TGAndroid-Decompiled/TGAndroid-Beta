...
public abstract class m {
    public final b2.s f14651a;
    public final i0 f14652b;
    ...
    public m(b2.s sVar, List list, s sVar2, List list2, List list3, List list4) {
        ...
        this.f14654f = list4;
        this.h = sVar2.a(this);
        long j3 = sVar2.f14666c;
        long j10 = sVar2.f14665b;
        String str = d0.f7888a;
        this.f14653c = d0.Y(j3, 1000000L, j10, RoundingMode.DOWN);
    }
