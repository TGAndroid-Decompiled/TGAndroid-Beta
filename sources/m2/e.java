...
public final class e extends DefaultHandler implements y2.o {
    public static final Pattern f14644b = Pattern.compile("(\\d+)(?:/(\\d+))?");
    public static final Pattern f14645c = Pattern.compile("CC([1-4])=.*");
    ...
    public static final int[] f14646f = {-1, 1, 2, 3, 4, 5, 6, 8, 2, 3, 4, 7, 8, 24, 8, 12, 10, 12, 14, 12, 14};
    public final XmlPullParserFactory f14647a;

    public e() {
        try {
            this.f14647a = XmlPullParserFactory.newInstance();
    ...
    public static ArrayList e(XmlPullParser xmlPullParser, ArrayList arrayList, boolean z10) {
        ...
        for (int i12 = 0; i12 < arrayList.size(); i12++) {
            ...
            String l4 = e2.a.l(bVar.f14626a, str2);
            if (attributeValue3 == null) {
                str = l4;
            } else {
                str = attributeValue3;
    ...
    public static float j(XmlPullParser xmlPullParser, float f7) {
        ...
        if (attributeValue != null) {
            Matcher matcher = f14644b.matcher(attributeValue);
            if (matcher.matches()) {
    ...
    public static int n(ArrayList arrayList) {
        ...
        for (int i11 = 0; i11 < arrayList.size(); i11++) {
            if (s6.a("http://dashif.org/guidelines/trickmode", ((f) arrayList.get(i11)).f14648a)) {
                i10 = 16384;
            }
        }
        return i10;
    ...
    public static p q(XmlPullParser xmlPullParser, p pVar, List list, long j3, long j10, long j11, long j12, long j13) {
        ...
        while (true) {
            if (i10 < list.size()) {
                ...
                if (s6.a("http://dashif.org/guidelines/last-segment-number", fVar.f14648a)) {
                    j17 = Long.parseLong(fVar.f14649b);
                    break;
                }
                i10++;
            } else {
    ...
    public final Object n2(Uri uri, g2.k kVar) {
        try {
            XmlPullParser newPullParser = this.f14647a.newPullParser();
