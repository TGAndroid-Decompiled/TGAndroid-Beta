...
public final class k extends m implements l2.h {
    ...
    public final long b(long j3) {
        return this.f14653n.g(j3);
    }

    @Override
    public final long c(long j3, long j10) {
        return this.f14653n.e(j3, j10);
    }
    ...
    public final long f(long j3, long j10) {
        return this.f14653n.c(j3, j10);
    }

    @Override
    public final long j(long j3, long j10) {
        n nVar = this.f14653n;
        if (nVar.f14660f != null) {
            return -9223372036854775807L;
        }
        long b10 = nVar.b(j3, j10) + nVar.c(j3, j10);
        return (nVar.e(b10, j3) + nVar.g(b10)) - nVar.f14662i;
    }

    @Override
    public final j k(long j3) {
        return this.f14653n.h(this, j3);
    }

    @Override
    public final long s(long j3, long j10) {
        return this.f14653n.f(j3, j10);
    }

    @Override
    public final boolean w() {
        return this.f14653n.i();
    }
