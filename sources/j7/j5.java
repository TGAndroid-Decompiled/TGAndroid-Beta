...
public abstract class j5 {
    public static void a(ArrayList arrayList) {
        ...
        for (Set<c9.j> set2 : hashMap.values()) {
            for (c9.j jVar2 : set2) {
                for (c9.l lVar : jVar2.f2355a.f2338c) {
                    if (lVar.f2362c == 0) {
                        c9.t tVar2 = lVar.f2360a;
                        if (lVar.f2361b == 2) {
                            z4 = true;
                        } else {
                            z4 = false;
                        ...
                        if (set3 != null) {
                            for (c9.j jVar3 : set3) {
                                jVar2.f2356b.add(jVar3);
                                jVar3.f2357c.add(jVar2);
                            }
                        }
                    }
                }
        ...
        while (!hashSet2.isEmpty()) {
            ...
            i10++;
            Iterator it2 = jVar5.f2356b.iterator();
            while (it2.hasNext()) {
                c9.j jVar6 = (c9.j) it2.next();
                jVar6.f2357c.remove(jVar5);
                if (jVar6.f2357c.isEmpty()) {
                    hashSet2.add(jVar6);
                }
            }
        }
        ...
        while (it3.hasNext()) {
            ...
            if (!jVar7.f2357c.isEmpty() && !jVar7.f2356b.isEmpty()) {
                arrayList2.add(jVar7.f2355a);
            }
        }
