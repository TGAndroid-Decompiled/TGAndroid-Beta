    ...
    public static String a(LaunchActivity launchActivity) {
        ...
        if (arrayList.isEmpty()) {
            ...
            if (arrayList.contains("com.android.chrome")) {
                f9131a = "com.android.chrome";
            } else if (arrayList.contains("com.chrome.beta")) {
                f9131a = "com.chrome.beta";
            } else if (arrayList.contains("com.chrome.dev")) {
                f9131a = "com.chrome.dev";
            } else if (arrayList.contains("com.google.android.apps.chrome")) {
                f9131a = "com.google.android.apps.chrome";
            }
        }
        try {
            if ("com.sec.android.app.sbrowser".equalsIgnoreCase(f9131a) && (applicationInfo = (packageManager = ApplicationLoader.applicationContext.getPackageManager()).getApplicationInfo("com.android.chrome", 0)) != null && applicationInfo.enabled) {
