...
public final class k implements u9.e {
    public static final Charset f9669f = Charset.forName("UTF-8");
    public static final u9.c f9670g = new u9.c("key", w.c.h(e2.c.n(i.class, new e(1))));
    public static final u9.c h = new u9.c("value", w.c.h(e2.c.n(i.class, new e(2))));
    public static final j f9671i = j.f9655b;
    public OutputStream f9672a;
    public final HashMap f9673b;
    public final HashMap f9674c;
    public final u9.d d;
    public final l f9675e = new l(this, 0);

    public k(ByteArrayOutputStream byteArrayOutputStream, HashMap hashMap, HashMap hashMap2, u9.d dVar) {
        this.f9672a = byteArrayOutputStream;
        this.f9673b = hashMap;
        this.f9674c = hashMap2;
        this.d = dVar;
    }
    ...
    public final void f(u9.c cVar, double d, boolean z4) {
        ...
        k((i(cVar) << 3) | 1);
        this.f9672a.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putDouble(d).array());
    }
        ...
        if (obj != null) {
            if (obj instanceof CharSequence) {
                ...
                if (!z4 || charSequence.length() != 0) {
                    k((i(cVar) << 3) | 2);
                    byte[] bytes = charSequence.toString().getBytes(f9669f);
                    k(bytes.length);
                    this.f9672a.write(bytes);
                }
                ...
                if (!z4 || floatValue != 0.0f) {
                    k((i(cVar) << 3) | 5);
                    this.f9672a.write(ByteBuffer.allocate(4).order(ByteOrder.LITTLE_ENDIAN).putFloat(floatValue).array());
                }
                ...
                u9.d dVar = (u9.d) this.f9673b.get(obj.getClass());
                if (dVar != null) {
                    j(dVar, cVar, obj, z4);
                    return;
                }
                u9.f fVar = (u9.f) this.f9674c.get(obj.getClass());
                if (fVar != null) {
                    l lVar = this.f9675e;
                    lVar.f9686b = false;
                    lVar.d = cVar;
    ...
    public final void j(u9.d dVar, u9.c cVar, Object obj, boolean z4) {
        ...
        fVar.f9602b = 0L;
        try {
            OutputStream outputStream = this.f9672a;
            this.f9672a = fVar;
            dVar.a(obj, this);
