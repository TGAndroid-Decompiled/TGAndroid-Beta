...
public abstract class t6 {
    public static int a(byte[] bArr, int i10, com.google.android.gms.internal.play_billing.h1 h1Var) {
        ...
        int i11 = h1Var.f3495a;
        if (i11 >= 0) {
            if (i11 <= bArr.length - f10) {
                if (i11 == 0) {
                    h1Var.d = com.google.android.gms.internal.play_billing.l1.f3530c;
                    return f10;
                }
    ...
    public static int d(byte[] bArr, int i10, com.google.android.gms.internal.play_billing.z1 z1Var, com.google.android.gms.internal.play_billing.h1 h1Var) {
        ...
        int f10 = f(bArr, i10, h1Var);
        int i11 = h1Var.f3495a + f10;
        while (f10 < i11) {
            f10 = f(bArr, f10, h1Var);
            w1Var.o(h1Var.f3495a);
        }
        if (f10 == i11) {
            return f10;
        }
        ...
        if ((i10 >>> 3) != 0) {
            ...
            if (i13 != 0) {
                if (i13 != 1) {
                    if (i13 != 2) {
                        ...
                        if (i15 < 100) {
                            ...
                            while (true) {
                                ...
                                int i17 = h1Var.f3495a;
                                if (i17 == i14) {
                                    i16 = i17;
                                    i11 = f10;
                                    break;
                                }
                                i11 = e(i17, bArr, f10, i12, b10, h1Var);
                                i16 = i17;
                            }
                            h1Var.f3496b--;
                            if (i11 <= i12 && i16 == i14) {
                    ...
                    int i18 = h1Var.f3495a;
                    if (i18 >= 0) {
                        if (i18 <= bArr.length - f11) {
                            if (i18 == 0) {
                                x2Var.c(i10, com.google.android.gms.internal.play_billing.l1.f3530c);
                            } else {
                                x2Var.c(i10, com.google.android.gms.internal.play_billing.l1.q(f11, i18, bArr));
                            }
                            return f11 + i18;
                        }
                        throw new IOException("While parsing a protocol message, the input ended unexpectedly in the middle of a field.  This could mean either that the input has been truncated or that an embedded message misreported its own length.");
            ...
            x2Var.c(i10, Long.valueOf(h1Var.f3497c));
            return i19;
        }
        throw new IOException("Protocol message contained an invalid tag (zero).");
    }
