...
public final class b {
    ...
    public b(int[] iArr, int i10, c[] cVarArr) {
        ...
        if (i13 <= i10) {
            this.f44210c = new ArrayList();
            for (int i17 = 0; i17 < i13; i17++) {
                int i18 = iArr3[i17];
                ((ArrayList) this.f44210c).add(new d(Color.rgb(b((i18 >> 10) & 31, 5, 8), b((i18 >> 5) & 31, 5, 8), b(i18 & 31, 5, 8)), iArr2[i18]));
            }
            return;
        }
        PriorityQueue priorityQueue = new PriorityQueue(i10, f44206f);
        priorityQueue.offer(new a(this, 0, ((int[]) this.f44208a).length - 1));
        while (priorityQueue.size() < i10 && (aVar = (a) priorityQueue.poll()) != null) {
            int i19 = aVar.f44199b;
            int i20 = aVar.f44198a;
            if ((i19 + 1) - i20 <= 1) {
                break;
            }
            b bVar = aVar.f44205j;
            if ((i19 + 1) - i20 > 1) {
                int i21 = aVar.f44201e - aVar.d;
                int i22 = aVar.f44203g - aVar.f44202f;
                int i23 = aVar.f44204i - aVar.h;
                int i24 = (i21 < i22 || i21 < i23) ? (i22 < i21 || i22 < i23) ? -1 : -2 : -3;
                int[] iArr4 = (int[]) bVar.f44208a;
                int[] iArr5 = (int[]) bVar.f44209b;
                a(i24, i20, i19, iArr4);
                Arrays.sort(iArr4, i20, aVar.f44199b + 1);
                a(i24, i20, aVar.f44199b, iArr4);
                int i25 = aVar.f44200c / 2;
                int i26 = i20;
                int i27 = 0;
                while (true) {
                    int i28 = aVar.f44199b;
                    if (i26 > i28) {
                        break;
                    }
                    i27 += iArr5[iArr4[i26]];
                ...
                a aVar2 = new a(bVar, i20 + 1, aVar.f44199b);
                aVar.f44199b = i20;
                aVar.a();
        ...
        while (it.hasNext()) {
            a aVar3 = (a) it.next();
            b bVar2 = aVar3.f44205j;
            int[] iArr6 = (int[]) bVar2.f44208a;
            int[] iArr7 = (int[]) bVar2.f44209b;
            int i29 = 0;
            int i30 = 0;
            int i31 = 0;
            int i32 = 0;
            for (int i33 = aVar3.f44198a; i33 <= aVar3.f44199b; i33++) {
                int i34 = iArr6[i33];
                int i35 = iArr7[i34];
                i30 += i35;
    ...
    public b(ArrayList arrayList, List list) {
        ...
        this.f44210c = new l(0);
        int size = list.size();
        int i10 = Integer.MIN_VALUE;
        d dVar = null;
        for (int i11 = 0; i11 < size; i11++) {
            d dVar2 = (d) list.get(i11);
            int i12 = dVar2.f44215e;
            if (i12 > i10) {
                dVar = dVar2;
                i10 = i12;
            }
