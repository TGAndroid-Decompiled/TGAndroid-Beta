...
public final class b {
    ...
    public b(int[] iArr, int i10, c[] cVarArr) {
        ...
        if (i13 <= i10) {
            ...
            for (int i17 = 0; i17 < i13; i17++) {
                int i18 = iArr3[i17];
                ((ArrayList) this.f44182c).add(new d(Color.rgb(b((i18 >> 10) & 31, 5, 8), b((i18 >> 5) & 31, 5, 8), b(i18 & 31, 5, 8)), iArr2[i18]));
            }
            return;
        }
        PriorityQueue priorityQueue = new PriorityQueue(i10, f44178f);
        priorityQueue.offer(new a(this, 0, ((int[]) this.f44180a).length - 1));
        while (priorityQueue.size() < i10 && (aVar = (a) priorityQueue.poll()) != null) {
            int i19 = aVar.f44171b;
            int i20 = aVar.f44170a;
            if ((i19 + 1) - i20 <= 1) {
                break;
            }
            b bVar = aVar.f44177j;
            if ((i19 + 1) - i20 > 1) {
                int i21 = aVar.f44173e - aVar.d;
                int i22 = aVar.f44175g - aVar.f44174f;
                int i23 = aVar.f44176i - aVar.h;
                int i24 = (i21 < i22 || i21 < i23) ? (i22 < i21 || i22 < i23) ? -1 : -2 : -3;
                int[] iArr4 = (int[]) bVar.f44180a;
                int[] iArr5 = (int[]) bVar.f44181b;
                a(i24, i20, i19, iArr4);
                Arrays.sort(iArr4, i20, aVar.f44171b + 1);
                a(i24, i20, aVar.f44171b, iArr4);
                int i25 = aVar.f44172c / 2;
                int i26 = i20;
                int i27 = 0;
                while (true) {
                    int i28 = aVar.f44171b;
                    if (i26 > i28) {
                        break;
                    }
                    i27 += iArr5[iArr4[i26]];
                ...
                a aVar2 = new a(bVar, i20 + 1, aVar.f44171b);
                aVar.f44171b = i20;
                aVar.a();
        ...
        while (it.hasNext()) {
            a aVar3 = (a) it.next();
            b bVar2 = aVar3.f44177j;
            int[] iArr6 = (int[]) bVar2.f44180a;
            int[] iArr7 = (int[]) bVar2.f44181b;
            int i29 = 0;
            int i30 = 0;
            int i31 = 0;
            int i32 = 0;
            for (int i33 = aVar3.f44170a; i33 <= aVar3.f44171b; i33++) {
                int i34 = iArr6[i33];
                int i35 = iArr7[i34];
                i30 += i35;
    ...
    public b(ArrayList arrayList, List list) {
        this.f44180a = list;
        this.f44181b = arrayList;
        this.d = new SparseBooleanArray();
        this.f44182c = new l(0);
        int size = list.size();
        int i10 = Integer.MIN_VALUE;
        d dVar = null;
        for (int i11 = 0; i11 < size; i11++) {
            d dVar2 = (d) list.get(i11);
            int i12 = dVar2.f44187e;
            if (i12 > i10) {
                dVar = dVar2;
                i10 = i12;
            }
