...
public final class s0 extends q1 {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof q1) {
            s0 s0Var = (s0) ((q1) obj);
            String str2 = s0Var.f46625c;
            if (this.f46623a == s0Var.f46623a && this.f46624b.equals(s0Var.f46624b) && ((str = this.f46625c) != null ? str.equals(str2) : str2 == null) && this.d == s0Var.d && this.e == s0Var.e) {
                return true;
            }
        }
        return false;
    ...
    public final int hashCode() {
        int hashCode;
        long j3 = this.f46623a;
        int hashCode2 = (((((int) (j3 ^ (j3 >>> 32))) ^ 1000003) * 1000003) ^ this.f46624b.hashCode()) * 1000003;
