...
public final class s0 extends q1 {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof q1) {
            s0 s0Var = (s0) ((q1) obj);
            String str2 = s0Var.f46893c;
            if (this.f46891a == s0Var.f46891a && this.f46892b.equals(s0Var.f46892b) && ((str = this.f46893c) != null ? str.equals(str2) : str2 == null) && this.d == s0Var.d && this.e == s0Var.e) {
                return true;
            }
        }
        return false;
    ...
    public final int hashCode() {
        int hashCode;
        long j3 = this.f46891a;
        int hashCode2 = (((((int) (j3 ^ (j3 >>> 32))) ^ 1000003) * 1000003) ^ this.f46892b.hashCode()) * 1000003;
