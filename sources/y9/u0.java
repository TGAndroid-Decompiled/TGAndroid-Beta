...
public final class u0 extends v1 {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof v1) {
            v1 v1Var = (v1) obj;
            Double d = this.f46916a;
            if (d != null ? d.equals(((u0) v1Var).f46916a) : ((u0) v1Var).f46916a == null) {
                u0 u0Var = (u0) v1Var;
                if (this.f46917b == u0Var.f46917b && this.f46918c == u0Var.f46918c && this.d == u0Var.d && this.e == u0Var.e && this.f46919f == u0Var.f46919f) {
                    return true;
                }
            }
        }
    ...
    public final int hashCode() {
        ...
        int i11 = (((hashCode ^ 1000003) * 1000003) ^ this.f46917b) * 1000003;
        if (this.f46918c) {
            i10 = 1231;
        } else {
            i10 = 1237;
    ...
    public final String toString() {
        ...
        sb2.append(this.e);
        sb2.append(", diskUsed=");
        return a4.a.s(sb2, this.f46919f, "}");
    }
}
