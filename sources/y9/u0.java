...
public final class u0 extends v1 {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof v1) {
            v1 v1Var = (v1) obj;
            Double d = this.f46636a;
            if (d != null ? d.equals(((u0) v1Var).f46636a) : ((u0) v1Var).f46636a == null) {
                u0 u0Var = (u0) v1Var;
                if (this.f46637b == u0Var.f46637b && this.f46638c == u0Var.f46638c && this.d == u0Var.d && this.e == u0Var.e && this.f46639f == u0Var.f46639f) {
                    return true;
                }
            }
        }
    ...
    public final int hashCode() {
        ...
        int i11 = (((hashCode ^ 1000003) * 1000003) ^ this.f46637b) * 1000003;
        if (this.f46638c) {
            i10 = 1231;
        } else {
            i10 = 1237;
    ...
    public final String toString() {
        ...
        sb2.append(this.e);
        sb2.append(", diskUsed=");
        return a4.a.r(sb2, this.f46639f, "}");
    }
}
