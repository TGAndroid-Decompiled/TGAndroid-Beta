    ...
    public final void run() {
        switch (this.f8830a) {
            case 0:
                ...
                return;
            case 1:
                ((c0) this.d).f8423a.T(this.f8831b, this.f8832c);
                return;
            case 2:
                VoIPGroupNotification.d((Context) this.d, this.f8831b, this.f8832c);
                return;
            case 3:
                ((VoIPService) this.d).lambda$initiateActualEncryptedCall$86(this.f8831b, this.f8832c);
                return;
            case 4:
                ((ConnectionsManager) this.d).lambda$discardConnection$0(this.f8831b, this.f8832c);
                return;
            case 5:
                org.telegram.ui.web.y0 y0Var = (org.telegram.ui.web.y0) this.d;
                for (int i12 = 0; i12 < this.f8831b - this.f8832c; i12++) {
                    y0Var.goBack();
                }
                return;
            case 6:
                Bundle bundle = new Bundle();
                bundle.putLong("user_id", UserConfig.getInstance(this.f8831b).getClientUserId());
                bundle.putInt("message_id", this.f8832c);
                ((org.telegram.ui.ActionBar.p2) this.d).presentFragment(new zn(bundle));
                return;
            case 7:
                jo joVar = (jo) this.d;
                int i13 = this.f8831b;
                if (i13 != 0) {
                    SharedPreferences notificationsSettings = MessagesController.getNotificationsSettings(this.f8832c);
            ...
            case 8:
                ...
                int i14 = this.f8831b;
                if (i14 != 0) {
                    SharedPreferences notificationsSettings2 = MessagesController.getNotificationsSettings(this.f8832c);
            ...
            case 9:
                ...
                if (d != null) {
                    int top = d.getTop() + this.f8831b;
                    int top2 = d.getTop() + this.f8832c;
                    int i15 = top2 - top;
                ...
                return;
            case 10:
                org.telegram.ui.Components.voip.g1 g1Var = ((org.telegram.ui.Components.voip.f1) this.d).f29599a;
                bf.f fVar = g1Var.L;
                if (fVar != null) {
                    fVar.d(this.f8831b, this.f8832c);
                }
                g1Var.i(false);
                return;
            case 11:
                ((SurfaceTextureHelper) this.d).lambda$setTextureSize$2(this.f8831b, this.f8832c);
                return;
            case 12:
                SurfaceViewRenderer.a((SurfaceViewRenderer) this.d, this.f8831b, this.f8832c);
                return;
            case 13:
                ((TextureViewRenderer) this.d).lambda$updateVideoSizes$1(this.f8831b, this.f8832c);
                return;
            default:
                int i17 = this.f8831b;
                ...
                try {
                        ...
                        if (isEncryptedDialog) {
                            if (i18 == 0 || i18 == 3) {
                                ...
                                if (!arrayList3.contains(Integer.valueOf(encryptedChatId))) {
                                    ...
                                    ?? obj = new Object();
                                    obj.f44944c = longValue;
                                    obj.f44943b = queryFinalized.intValue(1);
                                    arrayList4.add(obj);
                                    hVar.k(obj, obj.f44944c);
                                }
                            }
                            ...
                            if (i18 != 2 && !arrayList.contains(Long.valueOf(longValue))) {
                                ...
                                ?? obj2 = new Object();
                                obj2.f44944c = longValue;
                                obj2.f44943b = queryFinalized.intValue(1);
                                arrayList4.add(obj2);
                                hVar.k(obj2, obj2.f44944c);
                            }
                        } else {
                            long j10 = -longValue;
                            if (!arrayList2.contains(Long.valueOf(j10))) {
                                ...
                                ?? obj22 = new Object();
                                obj22.f44944c = longValue;
                                obj22.f44943b = queryFinalized.intValue(1);
                                arrayList4.add(obj22);
                                hVar.k(obj22, obj22.f44944c);
                            }
                        }
                    }
                    ...
                    if (!arrayList3.isEmpty()) {
                        ...
                        for (int i19 = 0; i19 < arrayList6.size(); i19++) {
                            tf.y yVar = (tf.y) hVar.f(DialogObject.makeEncryptedDialogId(arrayList6.get(i19).f19167id));
                            if (yVar != null) {
                                yVar.f44942a = arrayList6.get(i19);
                            }
                        }
                    }
                    ...
                    if (!arrayList.isEmpty()) {
                        ...
                        for (int i21 = 0; i21 < arrayList5.size(); i21++) {
                            ...
                            tf.y yVar4 = (tf.y) hVar.f(user.f19306id);
                            if (yVar4 != null) {
                                yVar4.f44942a = user;
                            }
                        }
