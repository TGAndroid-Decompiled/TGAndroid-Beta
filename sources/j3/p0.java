...
public final class p0 extends y {
    ...
    public final void b(ByteBuffer byteBuffer) {
        ...
        if (i12 == 3) {
            ...
            while (iPosition < iLimit) {
                short sG = (short) (d5.g0.g(byteBuffer.getFloat(iPosition), -1.0f, 1.0f) * 32767.0f);
    ...
    public final h f(h hVar) throws i {
        ...
        if (i10 == 3 || i10 == 2 || i10 == 268435456 || i10 == 536870912 || i10 == 805306368 || i10 == 4) {
            return i10 != 2 ? new h(hVar.f12343a, hVar.f12344b, 2) : h.f12342e;
        }
        throw new i(hVar);
    }
}
