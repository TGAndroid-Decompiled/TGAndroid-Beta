...
public final class f1 {
    ...
    public final o4.l0[] f8554c;
    public boolean d;
    public boolean e;
    public g1 f8555f;
    public boolean f8556g;
    public final boolean[] h;
    public final e[] f8557i;
    public final f5.t f8558j;
    public final q1 f8559k;
    public f1 f8560l;
    public o4.t0 f8561m;
    public f5.x f8562n;
    public long f8563o;
    ...
    public f1(e[] eVarArr, long j10, f5.t tVar, g5.q qVar, q1 q1Var, g1 g1Var, f5.x xVar) {
        ...
        this.f8553b = vVar.f16406a;
        this.f8555f = g1Var;
        this.f8561m = o4.t0.d;
        this.f8562n = xVar;
        this.f8554c = new o4.l0[eVarArr.length];
        this.h = new boolean[eVarArr.length];
        long j11 = g1Var.f8568b;
        long j12 = g1Var.d;
        q1Var.getClass();
        ...
        o1 o1Var = (o1) q1Var.f8778f.get(p1Var);
        if (o1Var != null) {
            o1Var.f8745a.e(o1Var.f8746b);
        }
        p1Var.f8767c.add(b10);
        o4.n b11 = p1Var.f8765a.b(b10, qVar, j11);
        q1Var.f8777c.put(b11, p1Var);
        q1Var.c();
        this.f8552a = j12 != -9223372036854775807L ? new o4.d(b11, true, 0L, j12) : b11;
    }
    ...
    public final long a(f5.x xVar, long j10, boolean z4, boolean[] zArr) {
        ...
        this.f8562n = xVar;
        c();
        long Y = this.f8552a.Y(xVar.f5991c, this.h, this.f8554c, zArr, j10);
        for (int i12 = 0; i12 < eVarArr.length; i12++) {
            if (eVarArr[i12].f8471b == -2 && this.f8562n.b(i12)) {
        ...
        for (int i13 = 0; i13 < objArr.length; i13++) {
            if (objArr[i13] != null) {
                h5.a.i(xVar.b(i13));
                if (eVarArr[i13].f8471b != -2) {
                    this.e = true;
                }
            } else {
                if (xVar.f5991c[i13] == null) {
                    z10 = true;
                } else {
                    z10 = false;
                }
    ...
    public final void b() {
        if (this.f8560l == null) {
            int i10 = 0;
            while (true) {
                f5.x xVar = this.f8562n;
                if (i10 < xVar.f5989a) {
                    boolean b10 = xVar.b(i10);
                    f5.c cVar = this.f8562n.f5991c[i10];
                    if (b10 && cVar != null) {
                        cVar.a();
                    }
                    i10++;
    ...
    public final long e() {
        return this.f8555f.f8568b + this.f8563o;
    }
    ...
    public final void f() {
        ...
        try {
            ...
            q1 q1Var = this.f8559k;
            if (z4) {
                q1Var.f(((o4.d) r02).f16290a);
            } else {
                q1Var.f(r02);
            }
    ...
    public final f5.x g(float f10, o2 o2Var) {
        ...
        int[] iArr2;
        boolean z15;
        f5.t tVar = this.f8558j;
        e[] eVarArr = this.f8557i;
        o4.t0 t0Var2 = this.f8561m;
        tVar.getClass();
        ...
        while (i17 < t0Var2.f16403a) {
            ...
            while (i19 < eVarArr.length) {
                ...
                f5.t tVar2 = tVar;
                int i20 = 0;
                for (int i21 = 0; i21 < a2.f16400a; i21++) {
            ...
            if (length3 == eVarArr.length) {
                iArr2 = new int[a2.f16400a];
            } else {
                e eVar2 = eVarArr[length3];
                int[] iArr6 = new int[a2.f16400a];
                for (int i22 = 0; i22 < a2.f16400a; i22++) {
        ...
        synchronized (pVar.d) {
            try {
                hVar = pVar.h;
                if (hVar.W && h5.d0.f6924a >= 32 && (kVar = pVar.f5943i) != null) {
        ...
        int i26 = sVar2.f5947a;
        f5.q[] qVarArr = new f5.q[i26];
        int i27 = 2;
        Pair j13 = f5.p.j(2, sVar2, iArr4, new c1.b(10, hVar, iArr5), new e5.e(6));
        if (j13 != null) {
        ...
        while (true) {
            if (i28 < sVar2.f5947a) {
                if (2 == iArr7[i28] && t0VarArr[i28].f16403a > 0) {
                    z4 = true;
                    break;
                }
                i28++;
        ...
        Pair j14 = f5.p.j(1, sVar2, iArr4, new com.google.firebase.messaging.i(pVar, hVar, z4, 1), new e5.e(7));
        if (j14 != null) {
        ...
        if (j14 == null) {
            ...
            str = qVar3.f5945a.d[qVar3.f5946b[0]].f8719c;
        }
        int i29 = 3;
        Pair j15 = f5.p.j(3, sVar2, iArr4, new c1.b(11, hVar, str), new e5.e(8));
        if (j15 != null) {
                ...
                while (i32 < t0Var3.f16403a) {
                    ...
                    while (i35 < a10.f16400a) {
                        ...
                        if (f5.p.f(iArr9[i35], hVar.X)) {
                            ...
                            if (fVar3 != null) {
                                t0Var = t0Var3;
                                if (s8.p.f44207a.c(fVar4.f5914b, fVar3.f5914b).c(fVar4.f5913a, fVar3.f5913a).e() <= 0) {
                                }
                            } else {
                                t0Var = t0Var3;
                            }
        ...
        Object obj2 = null;
        int i37 = sVar2.f5947a;
        o4.t0[] t0VarArr2 = sVar2.f5949c;
        HashMap hashMap = new HashMap();
        for (int i38 = 0; i38 < i37; i38++) {
            f5.p.c(t0VarArr2[i38], hVar, hashMap);
        }
        f5.p.c(sVar2.f5950f, hVar, hashMap);
        for (int i39 = 0; i39 < i37; i39++) {
            f5.u uVar = (f5.u) hashMap.get(Integer.valueOf(sVar2.f5948b[i39]));
            if (uVar != null) {
                o4.s0 s0Var4 = uVar.f5955a;
                s8.v vVar = uVar.f5956b;
        ...
        int i40 = sVar2.f5947a;
        for (int i41 = 0; i41 < i40; i41++) {
            o4.t0 t0Var4 = sVar2.f5949c[i41];
            Map map = (Map) hVar.f5917b0.get(i41);
            if (map != null && map.containsKey(t0Var4)) {
                Map map2 = (Map) hVar.f5917b0.get(i41);
                if (map2 != null) {
        ...
        for (int i42 = 0; i42 < i26; i42++) {
            int i43 = sVar2.f5948b[i42];
            if (hVar.f5918c0.get(i42) || hVar.M.contains(Integer.valueOf(i43))) {
                qVarArr[i42] = null;
            }
        }
        cb.b bVar2 = pVar.f5941f;
        g5.f fVar5 = pVar.f5952b;
        h5.a.j(fVar5);
        bVar2.getClass();
        ...
        while (i44 < qVarArr.length) {
            ...
            if (qVar4 != null && qVar4.f5946b.length > 1) {
                s8.t tVar5 = s8.v.f44222b;
        ...
        while (true) {
            ...
            if (qVar5 == null) {
                ...
                int[] iArr10 = qVar5.f5946b;
                jArr[i45] = new long[iArr10.length];
                int i46 = 0;
                while (i46 < iArr10.length) {
                    f5.s sVar3 = sVar2;
                    long j16 = qVar5.f5945a.d[iArr10[i46]].f8721n;
                    long[] jArr2 = jArr[i45];
                    if (j16 == -1) {
                        j16 = 0;
                    }
        ...
        TreeMap treeMap = new TreeMap(s8.g0.f44191b);
        ...
        if (treeMap.isEmpty()) {
            ...
            while (i48 < length4) {
                ...
                if (jArr5.length <= 1) {
                    ...
                    while (i53 < i52) {
                        ...
                        if (collection == null) {
                            List list = (List) obj3.f44189f.get();
            ...
            for (int i62 = 0; i62 < qVarArr.length; i62++) {
                ...
                if (qVar6 != null) {
                    int[] iArr14 = qVar6.f5946b;
                    if (iArr14.length != 0) {
                        if (iArr14.length == 1) {
                            bVar = new f5.c(qVar6.f5945a, new int[]{iArr14[0]});
                        } else {
                            long j18 = 25000;
                            bVar = new f5.b(qVar6.f5945a, iArr14, fVar6, 10000, j18, j18, (s8.v) s6.get(i62));
                        }
                        cVarArr2[i62] = bVar;
                    }
                }
            ...
            while (i63 < i26) {
                f5.s sVar6 = sVar4;
                int i64 = sVar6.f5948b[i63];
                if (!hVar.f5918c0.get(i63) && !hVar.M.contains(Integer.valueOf(i64)) && (sVar6.f5948b[i63] == -2 || cVarArr2[i63] != null)) {
                    g2Var = g2.f8573b;
                } else {
                    g2Var = null;
                }
            ...
            if (hVar.Y) {
                int i65 = -1;
                int i66 = -1;
                for (int i67 = 0; i67 < sVar7.f5947a; i67++) {
                    int i68 = sVar7.f5948b[i67];
                    f5.c cVar = cVarArr2[i67];
                    if ((i68 == 1 || i68 == 2) && cVar != null) {
                        int[][] iArr15 = iArr4[i67];
                        int b10 = sVar7.f5949c[i67].b(cVar.l());
                        int i69 = 0;
                        while (true) {
                            if (i69 < cVar.p()) {
            ...
            int i71 = 0;
            while (true) {
                int i72 = sVar7.f5947a;
                o4.t0[] t0VarArr3 = sVar7.f5949c;
                if (i71 >= i72) {
                    break;
                }
                ...
                int i73 = 0;
                while (i73 < t0Var5.f16403a) {
                    o4.s0 a11 = t0Var5.a(i73);
                    int i74 = t0VarArr3[i71].a(i73).f16400a;
                    ...
                    for (int i82 = 0; i82 < a11.f16400a; i82++) {
            ...
            o4.t0 t0Var6 = sVar7.f5950f;
            for (int i84 = 0; i84 < t0Var6.f16403a; i84++) {
                o4.s0 a12 = t0Var6.a(i84);
                int[] iArr18 = new int[a12.f16400a];
                Arrays.fill(iArr18, 0);
                wVar2.b(new p2(a12, false, iArr18, new boolean[a12.f16400a]));
            }
            f5.x xVar = new f5.x((g2[]) create.first, (f5.c[]) create.second, new q2(wVar2.i()), sVar7);
            for (f5.c cVar4 : xVar.f5991c) {
                if (cVar4 != null) {
                    cVar4.s(f10);
                }
            }
