...
public final class c implements f {
    ...
    public c(long j3, long[] jArr, long[] jArr2) {
        this.f44150a = jArr;
        this.f44151b = jArr2;
        this.f44152c = j3 == -9223372036854775807L ? d0.Q(jArr2[jArr2.length - 1]) : j3;
    }
    ...
    public final long b(long j3) {
        return d0.Q(((Long) a(j3, this.f44150a, this.f44151b).second).longValue());
    }
    ...
    public final a0 j(long j3) {
        Pair a2 = a(d0.e0(d0.i(j3, 0L, this.f44152c)), this.f44151b, this.f44150a);
