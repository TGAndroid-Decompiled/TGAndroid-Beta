...
public final class h implements f {
    ...
    public final long b(long j3) {
        long j10;
        double d;
        long j11 = j3 - this.f43890a;
        if (f() && j11 > this.f43891b) {
            long[] jArr = this.f43894g;
            e2.d.h(jArr);
    ...
    @Override
    public final long e() {
        return this.f43890a + this.f43891b;
    }
    ...
    public final a0 j(long j3) {
        ...
        long j10 = this.f43890a;
        if (!f7) {
            c0 c0Var = new c0(0L, j10 + i10);
            return new a0(c0Var, c0Var);
        }
        long i11 = d0.i(j3, 0L, this.f43892c);
        double d11 = (i11 * 100.0d) / this.f43892c;
        double d12 = 0.0d;
        if (d11 <= 0.0d) {
            d = 256.0d;
        } else if (d11 >= 100.0d) {
