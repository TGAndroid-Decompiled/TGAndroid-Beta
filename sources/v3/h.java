...
public final class h implements f {
    public final long f44175a;
    public final int f44176b;
    public final long f44177c;
    public final int d;
    public final long e;
    public final long f44178f;
    public final long[] f44179g;
    ...
    public final long b(long j3) {
        long j10;
        double d;
        long j11 = j3 - this.f44175a;
        if (f() && j11 > this.f44176b) {
            long[] jArr = this.f44179g;
            e2.d.h(jArr);
            double d10 = (j11 * 256.0d) / this.e;
            int e = d0.e(jArr, (long) d10, true);
            long j12 = this.f44177c;
            long j13 = (e * j12) / 100;
            long j14 = jArr[e];
            int i10 = e + 1;
    ...
    public final a0 j(long j3) {
        ...
        long j10 = this.f44175a;
        if (!f7) {
            c0 c0Var = new c0(0L, j10 + i10);
            return new a0(c0Var, c0Var);
        }
        long i11 = d0.i(j3, 0L, this.f44177c);
        double d11 = (i11 * 100.0d) / this.f44177c;
        double d12 = 0.0d;
        if (d11 <= 0.0d) {
            d = 256.0d;
        } else if (d11 >= 100.0d) {
