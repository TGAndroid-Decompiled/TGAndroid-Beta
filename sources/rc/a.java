...
public final class a extends com.googlecode.mp4parser.a {
    public static final c0 f42189b;
    public static final c0 f42190c;
    public static final c0 d;
    public static final c0 e;
    public static final c0 f42191f;
    public static final c0 h;
    public static final c0 f42192n;
    public static final c0 f42193r;
    public static final c0 f42194s;
    public static final c0 v;
    public static final c0 f42195w;
    public static final c0 f42196x;
    public static final c0 f42197y;
    public b f42198a;
    ...
    static {
        ...
        f42191f = aVar.e(aVar.d("setLengthSizeMinusOne", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "lengthSizeMinusOne", "void"));
        ...
        f42192n = aVar.e(aVar.d("setPictureParameterSets", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "java.util.List", "pictureParameterSets", "void"));
        aVar.e(aVar.d("getChromaFormat", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "", "", "int"));
        f42193r = aVar.e(aVar.d("setChromaFormat", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "chromaFormat", "void"));
        aVar.e(aVar.d("getBitDepthLumaMinus8", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "", "", "int"));
        f42194s = aVar.e(aVar.d("setBitDepthLumaMinus8", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "bitDepthLumaMinus8", "void"));
        ...
        f42195w = aVar.e(aVar.d("getContentSize", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "", "", "long"));
        f42196x = aVar.e(aVar.d("getContent", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "java.nio.ByteBuffer", "byteBuffer", "void"));
        ...
        f42197y = aVar.e(aVar.d("toString", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "", "", "java.lang.String"));
        ...
        f42189b = aVar.e(aVar.d("setConfigurationVersion", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "configurationVersion", "void"));
        f42190c = aVar.e(aVar.d("setAvcProfileIndication", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "avcProfileIndication", "void"));
    ...
    public final void _parseDetails(ByteBuffer byteBuffer) {
        int i10;
        ?? obj = new Object();
        obj.f42202f = new ArrayList();
        obj.f42203g = new ArrayList();
        obj.h = true;
        obj.f42204i = 1;
        obj.f42205j = 0;
        obj.f42206k = 0;
        obj.f42207l = new ArrayList();
        obj.f42208m = 63;
        obj.f42209n = 7;
        obj.f42210o = 31;
        obj.f42211p = 31;
        obj.f42212q = 31;
        obj.f42199a = e5.b.k(byteBuffer);
        obj.f42200b = e5.b.a(byteBuffer.get());
        obj.f42201c = e5.b.a(byteBuffer.get());
        obj.d = e5.b.a(byteBuffer.get());
        c cVar = new c(0, byteBuffer);
        obj.f42208m = cVar.a(6);
        obj.e = cVar.a(2);
        obj.f42209n = cVar.a(3);
        int a2 = cVar.a(5);
        for (int i11 = 0; i11 < a2; i11++) {
            byte[] bArr = new byte[e5.b.h(byteBuffer)];
            byteBuffer.get(bArr);
            obj.f42202f.add(bArr);
        }
        long a10 = e5.b.a(byteBuffer.get());
        for (int i12 = 0; i12 < a10; i12++) {
            byte[] bArr2 = new byte[e5.b.h(byteBuffer)];
            byteBuffer.get(bArr2);
            obj.f42203g.add(bArr2);
        }
        if (byteBuffer.remaining() < 4) {
            obj.h = false;
        }
        if (obj.h && ((i10 = obj.f42200b) == 100 || i10 == 110 || i10 == 122 || i10 == 144)) {
            c cVar2 = new c(0, byteBuffer);
            obj.f42210o = cVar2.a(6);
            obj.f42204i = cVar2.a(2);
            obj.f42211p = cVar2.a(5);
            obj.f42205j = cVar2.a(3);
            obj.f42212q = cVar2.a(5);
            obj.f42206k = cVar2.a(3);
            long a11 = e5.b.a(byteBuffer.get());
            for (int i13 = 0; i13 < a11; i13++) {
                byte[] bArr3 = new byte[e5.b.h(byteBuffer)];
                byteBuffer.get(bArr3);
                obj.f42207l.add(bArr3);
            }
        } else {
            obj.f42204i = -1;
            obj.f42205j = -1;
    ...
    public final void e(int i10) {
        e2.q(re.a.c(f42190c, this, this, new Integer(i10)));
        this.f42198a.f42200b = i10;
    }

    @Override
    public final void getContent(ByteBuffer byteBuffer) {
        e2.q(re.a.c(f42196x, this, this, byteBuffer));
        b bVar = this.f42198a;
        e5.b.r(bVar.f42199a, byteBuffer);
        byteBuffer.put((byte) (bVar.f42200b & 255));
        byteBuffer.put((byte) (bVar.f42201c & 255));
        byteBuffer.put((byte) (bVar.d & 255));
        c cVar = new c(1, byteBuffer);
        cVar.c(bVar.f42208m, 6);
        cVar.c(bVar.e, 2);
        cVar.c(bVar.f42209n, 3);
        cVar.c(bVar.f42203g.size(), 5);
        ArrayList arrayList = bVar.f42202f;
        ...
        byteBuffer.put((byte) (bVar.f42203g.size() & 255));
        ArrayList arrayList2 = bVar.f42203g;
        ...
        if (bVar.h) {
            int i13 = bVar.f42200b;
            if (i13 == 100 || i13 == 110 || i13 == 122 || i13 == 144) {
                c cVar2 = new c(1, byteBuffer);
                cVar2.c(bVar.f42210o, 6);
                cVar2.c(bVar.f42204i, 2);
                cVar2.c(bVar.f42211p, 5);
                cVar2.c(bVar.f42205j, 3);
                cVar2.c(bVar.f42212q, 5);
                cVar2.c(bVar.f42206k, 3);
                ArrayList arrayList3 = bVar.f42207l;
    ...
    public final long getContentSize() {
        ...
        if (bVar.h && ((i10 = bVar.f42200b) == 100 || i10 == 110 || i10 == 122 || i10 == 144)) {
            long j11 = j10 + 4;
            ArrayList arrayList3 = bVar.f42207l;
            int size3 = arrayList3.size();
            while (i11 < size3) {
    ...
    public final String toString() {
        t b10 = re.a.b(f42197y, this, this);
        g.a().getClass();
        g.b(b10);
        return "AvcConfigurationBox{avcDecoderConfigurationRecord=" + this.f42198a + '}';
    }
}
