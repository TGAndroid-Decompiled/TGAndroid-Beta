...
public final class a extends com.googlecode.mp4parser.a {
    public static final c f42463b;
    public static final c f42464c;
    public static final c d;
    public static final c e;
    public static final c f42465f;
    public static final c h;
    public static final c f42466n;
    public static final c f42467r;
    public static final c f42468s;
    public static final c v;
    public static final c f42469w;
    public static final c f42470x;
    public static final c f42471y;
    public b f42472a;
    ...
    static {
        ...
        f42465f = aVar.e(aVar.d("setLengthSizeMinusOne", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "lengthSizeMinusOne", "void"));
        ...
        f42466n = aVar.e(aVar.d("setPictureParameterSets", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "java.util.List", "pictureParameterSets", "void"));
        aVar.e(aVar.d("getChromaFormat", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "", "", "int"));
        f42467r = aVar.e(aVar.d("setChromaFormat", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "chromaFormat", "void"));
        aVar.e(aVar.d("getBitDepthLumaMinus8", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "", "", "int"));
        f42468s = aVar.e(aVar.d("setBitDepthLumaMinus8", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "bitDepthLumaMinus8", "void"));
        ...
        f42469w = aVar.e(aVar.d("getContentSize", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "", "", "long"));
        f42470x = aVar.e(aVar.d("getContent", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "java.nio.ByteBuffer", "byteBuffer", "void"));
        ...
        f42471y = aVar.e(aVar.d("toString", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "", "", "java.lang.String"));
        ...
        f42463b = aVar.e(aVar.d("setConfigurationVersion", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "configurationVersion", "void"));
        f42464c = aVar.e(aVar.d("setAvcProfileIndication", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "avcProfileIndication", "void"));
    ...
    public final void _parseDetails(ByteBuffer byteBuffer) {
        int i10;
        ?? obj = new Object();
        obj.f42476f = new ArrayList();
        obj.f42477g = new ArrayList();
        obj.h = true;
        obj.f42478i = 1;
        obj.f42479j = 0;
        obj.f42480k = 0;
        obj.f42481l = new ArrayList();
        obj.f42482m = 63;
        obj.f42483n = 7;
        obj.f42484o = 31;
        obj.f42485p = 31;
        obj.f42486q = 31;
        obj.f42473a = e5.b.k(byteBuffer);
        obj.f42474b = e5.b.a(byteBuffer.get());
        obj.f42475c = e5.b.a(byteBuffer.get());
        obj.d = e5.b.a(byteBuffer.get());
        mc.c cVar = new mc.c(0, byteBuffer);
        obj.f42482m = cVar.a(6);
        obj.e = cVar.a(2);
        obj.f42483n = cVar.a(3);
        int a2 = cVar.a(5);
        for (int i11 = 0; i11 < a2; i11++) {
            byte[] bArr = new byte[e5.b.h(byteBuffer)];
            byteBuffer.get(bArr);
            obj.f42476f.add(bArr);
        }
        long a10 = e5.b.a(byteBuffer.get());
        for (int i12 = 0; i12 < a10; i12++) {
            byte[] bArr2 = new byte[e5.b.h(byteBuffer)];
            byteBuffer.get(bArr2);
            obj.f42477g.add(bArr2);
        }
        if (byteBuffer.remaining() < 4) {
            obj.h = false;
        }
        if (obj.h && ((i10 = obj.f42474b) == 100 || i10 == 110 || i10 == 122 || i10 == 144)) {
            mc.c cVar2 = new mc.c(0, byteBuffer);
            obj.f42484o = cVar2.a(6);
            obj.f42478i = cVar2.a(2);
            obj.f42485p = cVar2.a(5);
            obj.f42479j = cVar2.a(3);
            obj.f42486q = cVar2.a(5);
            obj.f42480k = cVar2.a(3);
            long a11 = e5.b.a(byteBuffer.get());
            for (int i13 = 0; i13 < a11; i13++) {
                byte[] bArr3 = new byte[e5.b.h(byteBuffer)];
                byteBuffer.get(bArr3);
                obj.f42481l.add(bArr3);
            }
        } else {
            obj.f42478i = -1;
            obj.f42479j = -1;
    ...
    public final void e(int i10) {
        e2.q(re.a.c(f42464c, this, this, new Integer(i10)));
        this.f42472a.f42474b = i10;
    }

    @Override
    public final void getContent(ByteBuffer byteBuffer) {
        e2.q(re.a.c(f42470x, this, this, byteBuffer));
        b bVar = this.f42472a;
        e5.b.r(bVar.f42473a, byteBuffer);
        byteBuffer.put((byte) (bVar.f42474b & 255));
        byteBuffer.put((byte) (bVar.f42475c & 255));
        byteBuffer.put((byte) (bVar.d & 255));
        mc.c cVar = new mc.c(1, byteBuffer);
        cVar.c(bVar.f42482m, 6);
        cVar.c(bVar.e, 2);
        cVar.c(bVar.f42483n, 3);
        cVar.c(bVar.f42477g.size(), 5);
        ArrayList arrayList = bVar.f42476f;
        ...
        byteBuffer.put((byte) (bVar.f42477g.size() & 255));
        ArrayList arrayList2 = bVar.f42477g;
        ...
        if (bVar.h) {
            int i13 = bVar.f42474b;
            if (i13 == 100 || i13 == 110 || i13 == 122 || i13 == 144) {
                mc.c cVar2 = new mc.c(1, byteBuffer);
                cVar2.c(bVar.f42484o, 6);
                cVar2.c(bVar.f42478i, 2);
                cVar2.c(bVar.f42485p, 5);
                cVar2.c(bVar.f42479j, 3);
                cVar2.c(bVar.f42486q, 5);
                cVar2.c(bVar.f42480k, 3);
                ArrayList arrayList3 = bVar.f42481l;
    ...
    public final long getContentSize() {
        ...
        if (bVar.h && ((i10 = bVar.f42474b) == 100 || i10 == 110 || i10 == 122 || i10 == 144)) {
            long j11 = j10 + 4;
            ArrayList arrayList3 = bVar.f42481l;
            int size3 = arrayList3.size();
            while (i11 < size3) {
    ...
    public final String toString() {
        t b10 = re.a.b(f42471y, this, this);
        g.a().getClass();
        g.b(b10);
        return "AvcConfigurationBox{avcDecoderConfigurationRecord=" + this.f42472a + '}';
    }
}
