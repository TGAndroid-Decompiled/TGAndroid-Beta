...
public final class a extends com.googlecode.mp4parser.a {
    public static final c f42476b;
    public static final c f42477c;
    public static final c d;
    public static final c e;
    public static final c f42478f;
    public static final c h;
    public static final c f42479n;
    public static final c f42480r;
    public static final c f42481s;
    public static final c v;
    public static final c f42482w;
    public static final c f42483x;
    public static final c f42484y;
    public b f42485a;
    ...
    static {
        ...
        f42478f = aVar.e(aVar.d("setLengthSizeMinusOne", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "lengthSizeMinusOne", "void"));
        ...
        f42479n = aVar.e(aVar.d("setPictureParameterSets", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "java.util.List", "pictureParameterSets", "void"));
        aVar.e(aVar.d("getChromaFormat", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "", "", "int"));
        f42480r = aVar.e(aVar.d("setChromaFormat", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "chromaFormat", "void"));
        aVar.e(aVar.d("getBitDepthLumaMinus8", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "", "", "int"));
        f42481s = aVar.e(aVar.d("setBitDepthLumaMinus8", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "bitDepthLumaMinus8", "void"));
        ...
        f42482w = aVar.e(aVar.d("getContentSize", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "", "", "long"));
        f42483x = aVar.e(aVar.d("getContent", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "java.nio.ByteBuffer", "byteBuffer", "void"));
        ...
        f42484y = aVar.e(aVar.d("toString", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "", "", "java.lang.String"));
        ...
        f42476b = aVar.e(aVar.d("setConfigurationVersion", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "configurationVersion", "void"));
        f42477c = aVar.e(aVar.d("setAvcProfileIndication", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "avcProfileIndication", "void"));
    ...
    public final void _parseDetails(ByteBuffer byteBuffer) {
        ...
        obj.f42498p = 31;
        obj.f42499q = 31;
        obj.f42486a = e5.b.k(byteBuffer);
        obj.f42487b = e5.b.a(byteBuffer.get());
        obj.f42488c = e5.b.a(byteBuffer.get());
        obj.d = e5.b.a(byteBuffer.get());
        mc.c cVar = new mc.c(0, byteBuffer);
        obj.f42495m = cVar.a(6);
        obj.e = cVar.a(2);
        obj.f42496n = cVar.a(3);
        int a2 = cVar.a(5);
        for (int i11 = 0; i11 < a2; i11++) {
            byte[] bArr = new byte[e5.b.h(byteBuffer)];
            byteBuffer.get(bArr);
            obj.f42489f.add(bArr);
        }
        long a10 = e5.b.a(byteBuffer.get());
        for (int i12 = 0; i12 < a10; i12++) {
            byte[] bArr2 = new byte[e5.b.h(byteBuffer)];
            byteBuffer.get(bArr2);
            obj.f42490g.add(bArr2);
        }
        if (byteBuffer.remaining() < 4) {
            obj.h = false;
        }
        if (obj.h && ((i10 = obj.f42487b) == 100 || i10 == 110 || i10 == 122 || i10 == 144)) {
            mc.c cVar2 = new mc.c(0, byteBuffer);
            obj.f42497o = cVar2.a(6);
            obj.f42491i = cVar2.a(2);
            obj.f42498p = cVar2.a(5);
            obj.f42492j = cVar2.a(3);
            obj.f42499q = cVar2.a(5);
            obj.f42493k = cVar2.a(3);
            long a11 = e5.b.a(byteBuffer.get());
            for (int i13 = 0; i13 < a11; i13++) {
                byte[] bArr3 = new byte[e5.b.h(byteBuffer)];
                byteBuffer.get(bArr3);
                obj.f42494l.add(bArr3);
            }
        } else {
            obj.f42491i = -1;
            obj.f42492j = -1;
    ...
    public final void e(int i10) {
        e2.q(re.a.c(f42477c, this, this, new Integer(i10)));
        this.f42485a.f42487b = i10;
    }

    @Override
    public final void getContent(ByteBuffer byteBuffer) {
        e2.q(re.a.c(f42483x, this, this, byteBuffer));
        b bVar = this.f42485a;
        e5.b.r(bVar.f42486a, byteBuffer);
        byteBuffer.put((byte) (bVar.f42487b & 255));
        byteBuffer.put((byte) (bVar.f42488c & 255));
        byteBuffer.put((byte) (bVar.d & 255));
        mc.c cVar = new mc.c(1, byteBuffer);
        cVar.c(bVar.f42495m, 6);
        cVar.c(bVar.e, 2);
        cVar.c(bVar.f42496n, 3);
        cVar.c(bVar.f42490g.size(), 5);
        ArrayList arrayList = bVar.f42489f;
        ...
        byteBuffer.put((byte) (bVar.f42490g.size() & 255));
        ArrayList arrayList2 = bVar.f42490g;
        ...
        if (bVar.h) {
            int i13 = bVar.f42487b;
            if (i13 == 100 || i13 == 110 || i13 == 122 || i13 == 144) {
                mc.c cVar2 = new mc.c(1, byteBuffer);
                cVar2.c(bVar.f42497o, 6);
                cVar2.c(bVar.f42491i, 2);
                cVar2.c(bVar.f42498p, 5);
                cVar2.c(bVar.f42492j, 3);
                cVar2.c(bVar.f42499q, 5);
                cVar2.c(bVar.f42493k, 3);
                ArrayList arrayList3 = bVar.f42494l;
    ...
    public final long getContentSize() {
        ...
        if (bVar.h && ((i10 = bVar.f42487b) == 100 || i10 == 110 || i10 == 122 || i10 == 144)) {
            long j11 = j10 + 4;
            ArrayList arrayList3 = bVar.f42494l;
            int size3 = arrayList3.size();
            while (i11 < size3) {
    ...
    public final String toString() {
        t b10 = re.a.b(f42484y, this, this);
        g.a().getClass();
        g.b(b10);
        return "AvcConfigurationBox{avcDecoderConfigurationRecord=" + this.f42485a + '}';
    }
}
