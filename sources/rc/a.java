...
public final class a extends com.googlecode.mp4parser.a {
    ...
    public static final c f42494n;
    public static final c f42495r;
    public static final c f42496s;
    public static final c v;
    public static final c f42497w;
    public static final c f42498x;
    public static final c f42499y;
    public b f42500a;
    ...
    static {
        ...
        f42493f = aVar.e(aVar.d("setLengthSizeMinusOne", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "lengthSizeMinusOne", "void"));
        ...
        f42494n = aVar.e(aVar.d("setPictureParameterSets", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "java.util.List", "pictureParameterSets", "void"));
        aVar.e(aVar.d("getChromaFormat", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "", "", "int"));
        f42495r = aVar.e(aVar.d("setChromaFormat", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "chromaFormat", "void"));
        aVar.e(aVar.d("getBitDepthLumaMinus8", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "", "", "int"));
        f42496s = aVar.e(aVar.d("setBitDepthLumaMinus8", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "bitDepthLumaMinus8", "void"));
        ...
        f42497w = aVar.e(aVar.d("getContentSize", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "", "", "long"));
        f42498x = aVar.e(aVar.d("getContent", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "java.nio.ByteBuffer", "byteBuffer", "void"));
        ...
        f42499y = aVar.e(aVar.d("toString", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "", "", "java.lang.String"));
        ...
        f42491b = aVar.e(aVar.d("setConfigurationVersion", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "configurationVersion", "void"));
        f42492c = aVar.e(aVar.d("setAvcProfileIndication", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "avcProfileIndication", "void"));
    ...
    public final void _parseDetails(ByteBuffer byteBuffer) {
        int i10;
        ?? obj = new Object();
        obj.f42504f = new ArrayList();
        obj.f42505g = new ArrayList();
        obj.h = true;
        obj.f42506i = 1;
        obj.f42507j = 0;
        obj.f42508k = 0;
        obj.f42509l = new ArrayList();
        obj.f42510m = 63;
        obj.f42511n = 7;
        obj.f42512o = 31;
        obj.f42513p = 31;
        obj.f42514q = 31;
        obj.f42501a = e5.b.k(byteBuffer);
        obj.f42502b = e5.b.a(byteBuffer.get());
        obj.f42503c = e5.b.a(byteBuffer.get());
        obj.d = e5.b.a(byteBuffer.get());
        mc.c cVar = new mc.c(0, byteBuffer);
        obj.f42510m = cVar.a(6);
        obj.e = cVar.a(2);
        obj.f42511n = cVar.a(3);
        int a2 = cVar.a(5);
        for (int i11 = 0; i11 < a2; i11++) {
            byte[] bArr = new byte[e5.b.h(byteBuffer)];
            byteBuffer.get(bArr);
            obj.f42504f.add(bArr);
        }
        long a10 = e5.b.a(byteBuffer.get());
        for (int i12 = 0; i12 < a10; i12++) {
            byte[] bArr2 = new byte[e5.b.h(byteBuffer)];
            byteBuffer.get(bArr2);
            obj.f42505g.add(bArr2);
        }
        if (byteBuffer.remaining() < 4) {
            obj.h = false;
        }
        if (obj.h && ((i10 = obj.f42502b) == 100 || i10 == 110 || i10 == 122 || i10 == 144)) {
            mc.c cVar2 = new mc.c(0, byteBuffer);
            obj.f42512o = cVar2.a(6);
            obj.f42506i = cVar2.a(2);
            obj.f42513p = cVar2.a(5);
            obj.f42507j = cVar2.a(3);
            obj.f42514q = cVar2.a(5);
            obj.f42508k = cVar2.a(3);
            long a11 = e5.b.a(byteBuffer.get());
            for (int i13 = 0; i13 < a11; i13++) {
                byte[] bArr3 = new byte[e5.b.h(byteBuffer)];
                byteBuffer.get(bArr3);
                obj.f42509l.add(bArr3);
            }
        } else {
            obj.f42506i = -1;
            obj.f42507j = -1;
    ...
    public final void e(int i10) {
        e2.q(re.a.c(f42492c, this, this, new Integer(i10)));
        this.f42500a.f42502b = i10;
    }

    @Override
    public final void getContent(ByteBuffer byteBuffer) {
        e2.q(re.a.c(f42498x, this, this, byteBuffer));
        b bVar = this.f42500a;
        e5.b.r(bVar.f42501a, byteBuffer);
        byteBuffer.put((byte) (bVar.f42502b & 255));
        byteBuffer.put((byte) (bVar.f42503c & 255));
        byteBuffer.put((byte) (bVar.d & 255));
        mc.c cVar = new mc.c(1, byteBuffer);
        cVar.c(bVar.f42510m, 6);
        cVar.c(bVar.e, 2);
        cVar.c(bVar.f42511n, 3);
        cVar.c(bVar.f42505g.size(), 5);
        ArrayList arrayList = bVar.f42504f;
        ...
        byteBuffer.put((byte) (bVar.f42505g.size() & 255));
        ArrayList arrayList2 = bVar.f42505g;
        ...
        if (bVar.h) {
            int i13 = bVar.f42502b;
            if (i13 == 100 || i13 == 110 || i13 == 122 || i13 == 144) {
                mc.c cVar2 = new mc.c(1, byteBuffer);
                cVar2.c(bVar.f42512o, 6);
                cVar2.c(bVar.f42506i, 2);
                cVar2.c(bVar.f42513p, 5);
                cVar2.c(bVar.f42507j, 3);
                cVar2.c(bVar.f42514q, 5);
                cVar2.c(bVar.f42508k, 3);
                ArrayList arrayList3 = bVar.f42509l;
    ...
    public final long getContentSize() {
        ...
        if (bVar.h && ((i10 = bVar.f42502b) == 100 || i10 == 110 || i10 == 122 || i10 == 144)) {
            long j11 = j10 + 4;
            ArrayList arrayList3 = bVar.f42509l;
            int size3 = arrayList3.size();
            while (i11 < size3) {
    ...
    public final String toString() {
        t b10 = re.a.b(f42499y, this, this);
        g.a().getClass();
        g.b(b10);
        return "AvcConfigurationBox{avcDecoderConfigurationRecord=" + this.f42500a + '}';
    }
}
