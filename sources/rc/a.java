...
public final class a extends com.googlecode.mp4parser.a {
    public static final c0 f42193b;
    public static final c0 f42194c;
    public static final c0 d;
    public static final c0 e;
    public static final c0 f42195f;
    public static final c0 h;
    public static final c0 f42196n;
    public static final c0 f42197r;
    public static final c0 f42198s;
    public static final c0 v;
    public static final c0 f42199w;
    public static final c0 f42200x;
    public static final c0 f42201y;
    public b f42202a;
    ...
    static {
        ...
        f42195f = aVar.e(aVar.d("setLengthSizeMinusOne", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "lengthSizeMinusOne", "void"));
        ...
        f42196n = aVar.e(aVar.d("setPictureParameterSets", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "java.util.List", "pictureParameterSets", "void"));
        aVar.e(aVar.d("getChromaFormat", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "", "", "int"));
        f42197r = aVar.e(aVar.d("setChromaFormat", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "chromaFormat", "void"));
        aVar.e(aVar.d("getBitDepthLumaMinus8", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "", "", "int"));
        f42198s = aVar.e(aVar.d("setBitDepthLumaMinus8", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "bitDepthLumaMinus8", "void"));
        ...
        f42199w = aVar.e(aVar.d("getContentSize", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "", "", "long"));
        f42200x = aVar.e(aVar.d("getContent", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "java.nio.ByteBuffer", "byteBuffer", "void"));
        ...
        f42201y = aVar.e(aVar.d("toString", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "", "", "java.lang.String"));
        ...
        f42193b = aVar.e(aVar.d("setConfigurationVersion", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "configurationVersion", "void"));
        f42194c = aVar.e(aVar.d("setAvcProfileIndication", "com.mp4parser.iso14496.part15.AvcConfigurationBox", "int", "avcProfileIndication", "void"));
    ...
    public final void _parseDetails(ByteBuffer byteBuffer) {
        int i10;
        ?? obj = new Object();
        obj.f42206f = new ArrayList();
        obj.f42207g = new ArrayList();
        obj.h = true;
        obj.f42208i = 1;
        obj.f42209j = 0;
        obj.f42210k = 0;
        obj.f42211l = new ArrayList();
        obj.f42212m = 63;
        obj.f42213n = 7;
        obj.f42214o = 31;
        obj.f42215p = 31;
        obj.f42216q = 31;
        obj.f42203a = e5.b.k(byteBuffer);
        obj.f42204b = e5.b.a(byteBuffer.get());
        obj.f42205c = e5.b.a(byteBuffer.get());
        obj.d = e5.b.a(byteBuffer.get());
        c cVar = new c(0, byteBuffer);
        obj.f42212m = cVar.a(6);
        obj.e = cVar.a(2);
        obj.f42213n = cVar.a(3);
        int a2 = cVar.a(5);
        for (int i11 = 0; i11 < a2; i11++) {
            byte[] bArr = new byte[e5.b.h(byteBuffer)];
            byteBuffer.get(bArr);
            obj.f42206f.add(bArr);
        }
        long a10 = e5.b.a(byteBuffer.get());
        for (int i12 = 0; i12 < a10; i12++) {
            byte[] bArr2 = new byte[e5.b.h(byteBuffer)];
            byteBuffer.get(bArr2);
            obj.f42207g.add(bArr2);
        }
        if (byteBuffer.remaining() < 4) {
            obj.h = false;
        }
        if (obj.h && ((i10 = obj.f42204b) == 100 || i10 == 110 || i10 == 122 || i10 == 144)) {
            c cVar2 = new c(0, byteBuffer);
            obj.f42214o = cVar2.a(6);
            obj.f42208i = cVar2.a(2);
            obj.f42215p = cVar2.a(5);
            obj.f42209j = cVar2.a(3);
            obj.f42216q = cVar2.a(5);
            obj.f42210k = cVar2.a(3);
            long a11 = e5.b.a(byteBuffer.get());
            for (int i13 = 0; i13 < a11; i13++) {
                byte[] bArr3 = new byte[e5.b.h(byteBuffer)];
                byteBuffer.get(bArr3);
                obj.f42211l.add(bArr3);
            }
        } else {
            obj.f42208i = -1;
            obj.f42209j = -1;
    ...
    public final void e(int i10) {
        e2.q(re.a.c(f42194c, this, this, new Integer(i10)));
        this.f42202a.f42204b = i10;
    }

    @Override
    public final void getContent(ByteBuffer byteBuffer) {
        e2.q(re.a.c(f42200x, this, this, byteBuffer));
        b bVar = this.f42202a;
        e5.b.r(bVar.f42203a, byteBuffer);
        byteBuffer.put((byte) (bVar.f42204b & 255));
        byteBuffer.put((byte) (bVar.f42205c & 255));
        byteBuffer.put((byte) (bVar.d & 255));
        c cVar = new c(1, byteBuffer);
        cVar.c(bVar.f42212m, 6);
        cVar.c(bVar.e, 2);
        cVar.c(bVar.f42213n, 3);
        cVar.c(bVar.f42207g.size(), 5);
        ArrayList arrayList = bVar.f42206f;
        ...
        byteBuffer.put((byte) (bVar.f42207g.size() & 255));
        ArrayList arrayList2 = bVar.f42207g;
        ...
        if (bVar.h) {
            int i13 = bVar.f42204b;
            if (i13 == 100 || i13 == 110 || i13 == 122 || i13 == 144) {
                c cVar2 = new c(1, byteBuffer);
                cVar2.c(bVar.f42214o, 6);
                cVar2.c(bVar.f42208i, 2);
                cVar2.c(bVar.f42215p, 5);
                cVar2.c(bVar.f42209j, 3);
                cVar2.c(bVar.f42216q, 5);
                cVar2.c(bVar.f42210k, 3);
                ArrayList arrayList3 = bVar.f42211l;
    ...
    public final long getContentSize() {
        ...
        if (bVar.h && ((i10 = bVar.f42204b) == 100 || i10 == 110 || i10 == 122 || i10 == 144)) {
            long j11 = j10 + 4;
            ArrayList arrayList3 = bVar.f42211l;
            int size3 = arrayList3.size();
            while (i11 < size3) {
    ...
    public final String toString() {
        t b10 = re.a.b(f42201y, this, this);
        g.a().getClass();
        g.b(b10);
        return "AvcConfigurationBox{avcDecoderConfigurationRecord=" + this.f42202a + '}';
    }
}
