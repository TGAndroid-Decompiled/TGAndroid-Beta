...
public final class h implements Parcelable.Creator {
    ...
    public static void a(n6.f fVar, Parcel parcel, int i10) {
        ...
        int i11 = fVar.f15240a;
        f0.s(parcel, 1, 4);
        parcel.writeInt(i11);
        int i12 = fVar.f15241b;
        f0.s(parcel, 2, 4);
        parcel.writeInt(i12);
        int i13 = fVar.f15242c;
        f0.s(parcel, 3, 4);
        parcel.writeInt(i13);
        f0.l(parcel, 4, fVar.d);
        f0.f(parcel, 5, fVar.e);
        f0.o(parcel, 6, fVar.f15243f, i10);
        f0.b(parcel, 7, fVar.h);
        f0.k(parcel, 8, fVar.f15244n, i10);
        f0.o(parcel, 10, fVar.f15245r, i10);
        f0.o(parcel, 11, fVar.f15246s, i10);
        boolean z10 = fVar.v;
        f0.s(parcel, 12, 4);
        parcel.writeInt(z10 ? 1 : 0);
        int i14 = fVar.f15247w;
        f0.s(parcel, 13, 4);
        parcel.writeInt(i14);
        boolean z11 = fVar.f15248x;
        f0.s(parcel, 14, 4);
        parcel.writeInt(z11 ? 1 : 0);
        f0.l(parcel, 15, fVar.f15249y);
        f0.r(parcel, q6);
    }
