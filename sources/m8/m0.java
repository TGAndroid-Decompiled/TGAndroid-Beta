...
public final class m0 extends c6.a implements l8.h {
    ...
    public final boolean equals(Object obj) {
        ...
        return ((m0) obj).f13548a.equals(this.f13548a);
    }
    ...
    public final String toString() {
        StringBuilder m9 = yh.m("Node{", this.f13549b, ", id=", this.f13548a, ", hops=");
        m9.append(this.f13550c);
        m9.append(", isNearby=");
        m9.append(this.d);
        m9.append("}");
        return m9.toString();
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        g5.l(parcel, 2, this.f13548a);
        g5.l(parcel, 3, this.f13549b);
        g5.s(parcel, 4, 4);
        parcel.writeInt(this.f13550c);
        g5.s(parcel, 5, 4);
