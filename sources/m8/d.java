...
public final class d implements l8.c {
    public final androidx.biometric.f0 f13507a;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && d.class == obj.getClass()) {
            return this.f13507a.equals(((d) obj).f13507a);
        }
        return false;
    }
    ...
    public final void onChannelClosed(l8.b bVar, int i10, int i11) {
        ...
        ((l8.k) this.f13507a.f532b).onChannelClosed((l8.d) ((f) bVar), i10, i11);
    }

    @Override
    public final void onChannelOpened(l8.b bVar) {
        b6.m.i(bVar, "channel must not be null");
        ((l8.k) this.f13507a.f532b).onChannelOpened((l8.d) ((f) bVar));
    }

    @Override
    public final void onInputClosed(l8.b bVar, int i10, int i11) {
        b6.m.i(bVar, "channel must not be null");
        ((l8.k) this.f13507a.f532b).onInputClosed((l8.d) ((f) bVar), i10, i11);
    }

    @Override
    public final void onOutputClosed(l8.b bVar, int i10, int i11) {
        b6.m.i(bVar, "channel must not be null");
        ((l8.k) this.f13507a.f532b).onOutputClosed((l8.d) ((f) bVar), i10, i11);
    }
}
