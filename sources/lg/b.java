...
public final class b implements ScaleGestureDetector.OnScaleGestureListener {
    ...
    public void b() {
        switch (this.f14037a) {
            ...
            default:
                j1 j1Var = (j1) this.f14038b;
                WindowManager.LayoutParams layoutParams3 = j1Var.f29009c;
                int m10 = (int) (j1Var.m() * j1Var.P);
                layoutParams3.width = m10;
                j1Var.M = m10;
                WindowManager.LayoutParams layoutParams4 = j1Var.f29009c;
                int l4 = (int) (j1Var.l() * j1Var.P);
                layoutParams4.height = l4;
                j1Var.N = l4;
                AndroidUtilities.updateViewLayout(j1Var.f29008b, j1Var.d, j1Var.f29009c);
                return;
        }
    }
        ...
        switch (this.f14037a) {
            case 0:
                ...
                if (!pVar.F) {
                    ...
                    n.g(pVar.L, scaleFactor, n.a(pVar.L) * ((focusX - (imageView.getWidth() / 2)) / cropAreaView.getCropWidth()), n.b(pVar.L) * (w1.y((imageView.getHeight() - pVar.f14106y) - i10, pVar.E, 2.0f, focusY) / cropAreaView.getCropHeight()));
                    pVar.r(false);
                }
                return true;
            case 1:
                eg0 eg0Var = (eg0) this.f14038b;
                eg0Var.J = w7.p.a(scaleGestureDetector.getScaleFactor() * eg0Var.J, 0.75f, eg0Var.f23639a);
                ...
                o1.k kVar = eg0Var.M;
                if (!kVar.f15344f) {
                    kVar.f15342b = eg0Var.K;
                    kVar.f15343c = true;
                    kVar.f15351u.f15357i = dp;
                } else {
                    kVar.f15351u.f15357i = dp;
                }
                kVar.f();
            ...
            default:
                ...
                o1.k kVar5 = j1Var.T;
                kVar5.f15342b = j1Var.R;
                kVar5.f15343c = true;
                kVar5.f15351u.f15357i = w7.p.a(scaleGestureDetector.getFocusY() - (j1Var.N / 2.0f), AndroidUtilities.dp(16.0f), (AndroidUtilities.displaySize.y - j1Var.N) - AndroidUtilities.dp(16.0f));
                o1.k kVar6 = j1Var.T;
                if (!kVar6.f15344f) {
                    kVar6.f();
                }
    ...
    public final boolean onScaleBegin(ScaleGestureDetector scaleGestureDetector) {
        switch (this.f14037a) {
            ...
            case 1:
                ...
                eg0Var.f23659x = true;
                eg0Var.f23643c.width = (int) (eg0Var.t() * eg0Var.f23639a);
                eg0Var.f23643c.height = (int) (eg0Var.r() * eg0Var.f23639a);
                AndroidUtilities.updateViewLayout(eg0Var.f23641b, eg0Var.d, eg0Var.f23643c);
                return true;
            default:
                j1 j1Var = (j1) this.f14038b;
                ...
                j1Var.I = true;
                j1Var.f29009c.width = (int) (j1Var.m() * j1Var.f29006a);
                j1Var.f29009c.height = (int) (j1Var.l() * j1Var.f29006a);
                AndroidUtilities.updateViewLayout(j1Var.f29008b, j1Var.d, j1Var.f29009c);
                return true;
        }
    }
    ...
    public final void onScaleEnd(ScaleGestureDetector scaleGestureDetector) {
        switch (this.f14037a) {
            ...
            case 1:
                eg0 eg0Var = (eg0) this.f14038b;
                if (!eg0Var.M.f15344f && !eg0Var.N.f15344f) {
                    b();
                    return;
                }
            ...
            default:
                j1 j1Var = (j1) this.f14038b;
                if (!j1Var.S.f15344f && !j1Var.T.f15344f) {
                    b();
                    return;
                }
