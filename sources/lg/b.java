...
public final class b extends va {
    ...
    public Drawable W;
    public Drawable f12079a0;
    public TL_stories.Boost f12080b0;
    public final a f12081c0;

    public b(Context context) {
        super(context, 0, 0, false);
        int i10;
        int i11;
        this.f12081c0 = new a(getContext());
        this.V = new FrameLayout(getContext());
        TextView textView = new TextView(getContext());
        this.U = textView;
        textView.setTextColor(j6.v0(j6.G6, this.f22518y));
