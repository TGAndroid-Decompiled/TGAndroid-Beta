...
public class p extends FrameLayout implements a {
    ...
    public final ka.c f14329s;
    public final Matrix v;
    public Bitmap f14330w;
    public boolean f14331x;
    public float f14332y;
    ...
    public static void a(p pVar, Integer[][] numArr, int i10) {
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                ...
                if (pVar.f14323a.getAspectRatio() > 1.0f) {
        ...
        n nVar = pVar.L;
        int i11 = ((nVar.f14318g % 180.0f) > 0.0f ? 1 : ((nVar.f14318g % 180.0f) == 0.0f ? 0 : -1));
        if (i11 != 0) {
            f7 = nVar.f14315b;
        } else {
            f7 = nVar.f14314a;
    ...
    public final void b(MediaController.CropState cropState) {
        ...
        Matrix matrix = this.L.f14321k;
        float[] fArr = this.H;
        matrix.getValues(fArr);
        n nVar = this.L;
        float f11 = nVar.f14317f * cropWidth;
        ...
        if (i10 != 90 && i10 != 270) {
            n nVar2 = this.L;
            i11 = (int) nVar2.f14314a;
            f10 = nVar2.f14315b;
        } else {
            n nVar3 = this.L;
            i11 = (int) nVar3.f14315b;
            f10 = nVar3.f14314a;
        }
        int i12 = (int) f10;
        float f12 = i11;
        ...
        cropState.cropRotate = nVar4.f14319i;
        cropState.stateScale = f16;
        cropState.mirrored = nVar4.f14320j;
        cropState.scale = cropWidth;
        cropState.matrix = nVar4.f14321k;
        cropState.width = ceil;
        cropState.height = ceil2;
        cropState.freeform = this.f14331x;
    ...
    public final void d(RectF rectF) {
        ...
        ImageView imageView = this.f14324b;
        float a2 = n.a(this.L) * ((centerX - (imageView.getWidth() / 2)) / cropAreaView.getCropWidth());
        float b10 = n.b(this.L) * ((rectF.centerY() - ((((imageView.getHeight() - this.f14332y) + i10) + this.E) / 2.0f)) / cropAreaView.getCropHeight());
    ...
    public final void e(boolean z10, boolean z11, boolean z12, boolean z13) {
        ...
        if (this.L != null) {
            ...
            n nVar2 = this.L;
            PointF pointF = new PointF(nVar2.f14316c, nVar2.d);
            ...
            } else if (z11 && this.f14327n > 0.0f) {
                float width = rectF.width() / n(rectF, rectF2);
                if (this.L.e * width < this.f14327n) {
                    width = 1.0f;
                }
    ...
    public float getCropHeight() {
        return this.f14323a.getCropHeight();
    }

    public float getCropLeft() {
        return this.f14323a.getCropLeft();
    }

    public float getCropTop() {
        return this.f14323a.getCropTop();
    }

    public float getCropWidth() {
        return this.f14323a.getCropWidth();
    }
    ...
    public float getStateFullOrientation() {
        ...
        return nVar.f14318g + nVar.h;
    }

    public boolean getStateMirror() {
        n nVar = this.L;
        if (nVar != null && nVar.f14320j) {
            return true;
        }
        return false;
    }
    ...
    public final void i() {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                pVar.f14323a.setActualRect(rectF5);
                n nVar4 = pVar.L;
                float f16 = 1.0f - floatValue;
                float f17 = nVar4.f14316c - (f12 * f16);
                float f18 = nVar4.d - (f13 * f16);
                float f19 = nVar4.f14319i - (f15 * f16);
    ...
    public final boolean j() {
        ...
        nVar.f14320j = !nVar.f14320j;
        r(false);
        o oVar = this.M;
        if (oVar != null) {
            n nVar2 = this.L;
            float f7 = nVar2.h;
            float f10 = nVar2.f14318g;
            float f11 = ((f7 + f10) - f10) % 360.0f;
            if (!n.c(nVar2) && f11 == 0.0f && this.f14323a.getLockAspectRatio() == 0.0f && !this.L.f14320j) {
                z10 = true;
            }
            oVar.e0(z10);
        }
        return this.L.f14320j;
    }

    public final void k() {
        this.f14323a.g(2, false);
        if (this.f14327n < 1.0E-5f) {
            this.f14327n = this.L.e;
        }
    }
    ...
    public final void l(boolean z10) {
        ...
        n nVar = this.L;
        if (nVar != null && nVar.f14318g % 180.0f != 0.0f) {
            z11 = true;
        } else {
            z11 = false;
        }
        cropAreaView.e(currentWidth, currentHeight, z11, this.f14331x);
        if (this.f14331x) {
            f7 = 0.0f;
        } else {
            f7 = 1.0f;
    ...
    public final boolean m(float f7) {
        ...
        if (this.L != null) {
            ...
            n nVar = this.L;
            float f10 = nVar.h;
            float f11 = nVar.f14318g;
            float f12 = (((f10 + f11) - f11) + f7) % 360.0f;
            if (this.f14331x && cropAreaView.getLockAspectRatio() > 0.0f) {
                cropAreaView.setLockedAspectRatio(1.0f / cropAreaView.getLockAspectRatio());
                cropAreaView.setActualRect(cropAreaView.getLockAspectRatio());
            } else {
                int currentWidth = getCurrentWidth();
                int currentHeight = getCurrentHeight();
                if ((this.L.f14318g + f12) % 180.0f != 0.0f) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                cropAreaView.e(currentWidth, currentHeight, z10, this.f14331x);
            }
            n.d(this.L, f12);
            r(false);
            ...
            o oVar = this.M;
            if (oVar != null) {
                if (f12 == 0.0f && cropAreaView.getLockAspectRatio() == 0.0f && !this.L.f14320j) {
                    z11 = true;
                } else {
                    z11 = false;
                }
    ...
    public final void o() {
        ...
        for (int i11 = 0; i11 < 6; i11++) {
            ...
            if (this.f14323a.getAspectRatio() > 1.0f) {
    ...
    public final void q() {
        ...
        if (this.e != null && this.L != null) {
            ...
            if (i11 != 90 && i11 != 270) {
                n nVar2 = this.L;
                i10 = (int) nVar2.f14314a;
                f10 = nVar2.f14315b;
            } else {
                n nVar3 = this.L;
                i10 = (int) nVar3.f14315b;
                f10 = nVar3.f14314a;
            }
            int i12 = (int) f10;
            double d = ceil;
            ...
            float f16 = nVar4.e;
            float f17 = f16 / max;
            float f18 = f16 / nVar4.f14317f;
            float f19 = (fArr[2] / f12) / f16;
            float f20 = (fArr[5] / f13) / f16;
            float f21 = nVar4.f14319i;
            ...
            g gVar = this.e;
            n nVar5 = this.L;
            if (!nVar5.f14320j && !n.c(nVar5) && this.L.f14318g < 1.0E-5f) {
                z10 = false;
            } else {
                z10 = true;
            }
            n nVar6 = this.L;
            gVar.e(z10, f19, f20, f21, (int) nVar6.h, f17, f18, nVar6.f14317f / max, f15, f14, cropCenterX, cropCenterY, nVar6.f14320j);
        }
    }
    ...
    public final void r(boolean z10) {
        ...
        Matrix matrix = this.f14325c;
        matrix.reset();
        n nVar = this.L;
        float f7 = nVar.f14318g;
        if (f7 != 90.0f && f7 != 270.0f) {
            matrix.postTranslate((-nVar.f14314a) / 2.0f, (-nVar.f14315b) / 2.0f);
        } else {
            matrix.postTranslate((-nVar.f14315b) / 2.0f, (-nVar.f14314a) / 2.0f);
        }
        matrix.postRotate((int) this.L.h);
        matrix.postConcat(this.L.f14321k);
        CropAreaView cropAreaView = this.f14323a;
        matrix.postTranslate(cropAreaView.getCropCenterX(), cropAreaView.getCropCenterY());
        if (!this.f14331x || this.J || z10) {
            q();
            this.M.z();
        }
        invalidate();
    ...
    public void setAspectRatio(float f7) {
        this.f14323a.setActualRect(f7);
    }

    public void setBottomPadding(float f7) {
        this.f14332y = f7;
        this.f14323a.setBottomPadding(f7);
    }

    public void setFreeform(boolean z10) {
        this.f14323a.setFreeform(z10);
        this.f14331x = z10;
    }
    ...
    public void setRotation(float f7) {
        n nVar = this.L;
        n.e(nVar, f7 - nVar.f14319i);
        e(true, true, false, false);
    }

    public void setSubtitle(String str) {
        this.f14323a.setSubtitle(str);
    }

    public void setTopPadding(float f7) {
        this.E = f7;
        this.f14323a.setTopPadding(f7);
    }
}
