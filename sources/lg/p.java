...
public class p extends FrameLayout implements a {
    ...
    public final CropAreaView f14256a;
    public final ImageView f14257b;
    public final Matrix f14258c;
    public j71 d;
    public g e;
    public final RectF f14259f;
    public final RectF h;
    public float f14260n;
    public final boolean f14261r;
    public final ka.c f14262s;
    public final Matrix v;
    public Bitmap f14263w;
    ...
    public p(Context context) {
        ...
        this.f14261r = z10;
        this.f14259f = new RectF();
        this.h = new RectF();
        this.f14258c = new Matrix();
        ka.c cVar = new ka.c(1, false);
        cVar.f13565b = new float[8];
        this.f14262s = cVar;
        this.v = new Matrix();
        this.F = false;
        ...
        viewGroup.f22197f = new RectF();
        viewGroup.h = new RectF();
        viewGroup.f22205n = new RectF();
        viewGroup.f22210r = new RectF();
        viewGroup.f22212s = new RectF();
        viewGroup.v = new RectF();
        viewGroup.f22216x = new RectF();
        viewGroup.f22217y = new RectF();
        viewGroup.K = -1.0f;
        viewGroup.L = 1.0f;
        viewGroup.M = -1.0f;
        viewGroup.U = new AccelerateDecelerateInterpolator();
        viewGroup.f22198f0 = true;
        viewGroup.f22204l0 = new RectF();
        viewGroup.f22206n0 = 0.0f;
        viewGroup.f22207o0 = 1.0f;
        viewGroup.f22208p0 = 0.0f;
        viewGroup.f22209q0 = 0.0f;
        viewGroup.f22190a0 = z10;
        viewGroup.J = true;
        viewGroup.I = true;
        viewGroup.V = AndroidUtilities.dp(16.0f);
        viewGroup.W = AndroidUtilities.dp(32.0f);
        viewGroup.f22214t0 = 1;
    ...
    public static void a(p pVar, Integer[][] numArr, int i10) {
        ...
        if (i10 != 0) {
            if (i10 != 1) {
                ...
                if (pVar.f14256a.getAspectRatio() > 1.0f) {
        ...
        n nVar = pVar.L;
        int i11 = ((nVar.f14251g % 180.0f) > 0.0f ? 1 : ((nVar.f14251g % 180.0f) == 0.0f ? 0 : -1));
        if (i11 != 0) {
            f7 = nVar.f14248b;
        } else {
            f7 = nVar.f14247a;
    ...
    private void setLockedAspectRatio(float f7) {
        CropAreaView cropAreaView = this.f14256a;
    ...
    public final void b(MediaController.CropState cropState) {
        ...
        Matrix matrix = this.L.f14254k;
        float[] fArr = this.H;
        matrix.getValues(fArr);
        n nVar = this.L;
        float f11 = nVar.f14250f * cropWidth;
        ...
        if (i10 != 90 && i10 != 270) {
            n nVar2 = this.L;
            i11 = (int) nVar2.f14247a;
            f10 = nVar2.f14248b;
        } else {
            n nVar3 = this.L;
            i11 = (int) nVar3.f14248b;
            f10 = nVar3.f14247a;
        }
        int i12 = (int) f10;
        float f12 = i11;
        ...
        cropState.cropRotate = nVar4.f14252i;
        cropState.stateScale = f16;
        cropState.mirrored = nVar4.f14253j;
        cropState.scale = cropWidth;
        cropState.matrix = nVar4.f14254k;
        cropState.width = ceil;
        cropState.height = ceil2;
        cropState.freeform = this.f14264x;
    ...
    public final void d(RectF rectF) {
        ...
        ImageView imageView = this.f14257b;
        float a2 = n.a(this.L) * ((centerX - (imageView.getWidth() / 2)) / cropAreaView.getCropWidth());
        float b10 = n.b(this.L) * ((rectF.centerY() - ((((imageView.getHeight() - this.f14265y) + i10) + this.E) / 2.0f)) / cropAreaView.getCropHeight());
        ...
        AnimatorSet animatorSet = cropAreaView.f22203k0;
        if (animatorSet != null) {
            animatorSet.cancel();
            cropAreaView.f22203k0 = null;
        }
        AnimatorSet animatorSet2 = new AnimatorSet();
        cropAreaView.f22203k0 = animatorSet2;
    ...
    public final void e(boolean z10, boolean z11, boolean z12, boolean z13) {
        ...
        if (this.L != null) {
            ...
            n nVar = this.L;
            float f12 = nVar.e;
            ka.c cVar = this.f14262s;
            float[] fArr = (float[]) cVar.f13565b;
            float[] fArr2 = (float[]) cVar.f13565b;
            ...
            n nVar2 = this.L;
            PointF pointF = new PointF(nVar2.f14249c, nVar2.d);
            ...
            } else if (z11 && this.f14260n > 0.0f) {
                float width = rectF.width() / n(rectF, rectF2);
                if (this.L.e * width < this.f14260n) {
                    width = 1.0f;
                }
    ...
    public float getCropHeight() {
        return this.f14256a.getCropHeight();
    }

    public float getCropLeft() {
        return this.f14256a.getCropLeft();
    }

    public float getCropTop() {
        return this.f14256a.getCropTop();
    }

    public float getCropWidth() {
        return this.f14256a.getCropWidth();
    }
    ...
    public float getStateFullOrientation() {
        ...
        return nVar.f14251g + nVar.h;
    }

    public boolean getStateMirror() {
        n nVar = this.L;
        if (nVar != null && nVar.f14253j) {
            return true;
        }
        return false;
    }
    ...
    public final void i() {
        ...
        n nVar2 = this.L;
        if ((nVar2.h + nVar2.f14251g) % 180.0f != 0.0f) {
        ...
        rectF.set(cropAreaView.f22216x);
        n nVar3 = this.L;
        final float f12 = nVar3.f14249c;
        final float f13 = nVar3.d;
        final float f14 = nVar3.e;
        final float f15 = nVar3.f14252i;
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                pVar.f14256a.setActualRect(rectF5);
                n nVar4 = pVar.L;
                float f16 = 1.0f - floatValue;
                float f17 = nVar4.f14249c - (f12 * f16);
                float f18 = nVar4.d - (f13 * f16);
                float f19 = nVar4.f14252i - (f15 * f16);
    ...
    public final boolean j() {
        ...
        nVar.f14253j = !nVar.f14253j;
        r(false);
        o oVar = this.M;
        if (oVar != null) {
            n nVar2 = this.L;
            float f7 = nVar2.h;
            float f10 = nVar2.f14251g;
            float f11 = ((f7 + f10) - f10) % 360.0f;
            if (!n.c(nVar2) && f11 == 0.0f && this.f14256a.getLockAspectRatio() == 0.0f && !this.L.f14253j) {
                z10 = true;
            }
            oVar.e0(z10);
        }
        return this.L.f14253j;
    }

    public final void k() {
        this.f14256a.g(2, false);
        if (this.f14260n < 1.0E-5f) {
            this.f14260n = this.L.e;
        }
    }
    ...
    public final void l(boolean z10) {
        ...
        n nVar = this.L;
        if (nVar != null && nVar.f14251g % 180.0f != 0.0f) {
            z11 = true;
        } else {
            z11 = false;
        }
        cropAreaView.e(currentWidth, currentHeight, z11, this.f14264x);
        if (this.f14264x) {
            f7 = 0.0f;
        } else {
            f7 = 1.0f;
    ...
    public final boolean m(float f7) {
        ...
        if (this.L != null) {
            ...
            n nVar = this.L;
            float f10 = nVar.h;
            float f11 = nVar.f14251g;
            float f12 = (((f10 + f11) - f11) + f7) % 360.0f;
            if (this.f14264x && cropAreaView.getLockAspectRatio() > 0.0f) {
                cropAreaView.setLockedAspectRatio(1.0f / cropAreaView.getLockAspectRatio());
                cropAreaView.setActualRect(cropAreaView.getLockAspectRatio());
            } else {
                int currentWidth = getCurrentWidth();
                int currentHeight = getCurrentHeight();
                if ((this.L.f14251g + f12) % 180.0f != 0.0f) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                cropAreaView.e(currentWidth, currentHeight, z10, this.f14264x);
            }
            n.d(this.L, f12);
            r(false);
            ...
            o oVar = this.M;
            if (oVar != null) {
                if (f12 == 0.0f && cropAreaView.getLockAspectRatio() == 0.0f && !this.L.f14253j) {
                    z11 = true;
                } else {
                    z11 = false;
                }
    ...
    public final void o() {
        ...
        for (int i11 = 0; i11 < 6; i11++) {
            ...
            if (this.f14256a.getAspectRatio() > 1.0f) {
    ...
    public final void q() {
        ...
        if (this.e != null && this.L != null) {
            ...
            if (i11 != 90 && i11 != 270) {
                n nVar2 = this.L;
                i10 = (int) nVar2.f14247a;
                f10 = nVar2.f14248b;
            } else {
                n nVar3 = this.L;
                i10 = (int) nVar3.f14248b;
                f10 = nVar3.f14247a;
            }
            int i12 = (int) f10;
            double d = ceil;
            ...
            float f14 = ceil4;
            float f15 = ceil3;
            RectF rectF2 = cropAreaView.f22204l0;
            ...
            float f16 = nVar4.e;
            float f17 = f16 / max;
            float f18 = f16 / nVar4.f14250f;
            float f19 = (fArr[2] / f12) / f16;
            float f20 = (fArr[5] / f13) / f16;
            float f21 = nVar4.f14252i;
            ...
            g gVar = this.e;
            n nVar5 = this.L;
            if (!nVar5.f14253j && !n.c(nVar5) && this.L.f14251g < 1.0E-5f) {
                z10 = false;
            } else {
                z10 = true;
            }
            n nVar6 = this.L;
            gVar.e(z10, f19, f20, f21, (int) nVar6.h, f17, f18, nVar6.f14250f / max, f15, f14, cropCenterX, cropCenterY, nVar6.f14253j);
        }
    }
    ...
    public final void r(boolean z10) {
        ...
        Matrix matrix = this.f14258c;
        matrix.reset();
        n nVar = this.L;
        float f7 = nVar.f14251g;
        if (f7 != 90.0f && f7 != 270.0f) {
            matrix.postTranslate((-nVar.f14247a) / 2.0f, (-nVar.f14248b) / 2.0f);
        } else {
            matrix.postTranslate((-nVar.f14248b) / 2.0f, (-nVar.f14247a) / 2.0f);
        }
        matrix.postRotate((int) this.L.h);
        matrix.postConcat(this.L.f14254k);
        CropAreaView cropAreaView = this.f14256a;
        matrix.postTranslate(cropAreaView.getCropCenterX(), cropAreaView.getCropCenterY());
        if (!this.f14264x || this.J || z10) {
            q();
            this.M.z();
        }
        invalidate();
    ...
    public void setAspectRatio(float f7) {
        this.f14256a.setActualRect(f7);
    }

    public void setBottomPadding(float f7) {
        this.f14265y = f7;
        this.f14256a.setBottomPadding(f7);
    }

    public void setFreeform(boolean z10) {
        this.f14256a.setFreeform(z10);
        this.f14264x = z10;
    }
    ...
    public void setRotation(float f7) {
        n nVar = this.L;
        n.e(nVar, f7 - nVar.f14252i);
        e(true, true, false, false);
    }

    public void setSubtitle(String str) {
        this.f14256a.setSubtitle(str);
    }

    public void setTopPadding(float f7) {
        this.E = f7;
        this.f14256a.setTopPadding(f7);
    }
}
