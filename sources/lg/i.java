...
public final class i extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    private List<a> getBuiltInDebugItems() {
        ...
        arrayList.add(new a(str, new f0(9)));
    ...
    public final void c(final boolean z10) {
        ...
        if (z10) {
            ...
            if (getContext() instanceof LaunchActivity) {
                ...
                ActionBarLayout actionBarLayout = ((LaunchActivity) getContext()).f29961s0;
                if (actionBarLayout != null) {
                    arrayList.addAll(actionBarLayout.z());
                }
                ActionBarLayout actionBarLayout2 = ((LaunchActivity) getContext()).f29959r0;
                if (actionBarLayout2 != null) {
                    arrayList.addAll(actionBarLayout2.z());
                }
            }
            arrayList.addAll(getBuiltInDebugItems());
            this.f12962y.getAdapter().l();
        }
        ...
        kVar.b(new o1.g() {
            ...
            public final void a(o1.h hVar, float f11, float f12) {
                ...
                i iVar = i.this;
                LinearLayout linearLayout = iVar.f12960w;
                ...
                if (linearLayout.getWidth() != 0) {
                    linearLayout.setScaleX(AndroidUtilities.lerp(n7Var2.getWidth() / linearLayout.getWidth(), 1.0f, f13));
                }
                if (linearLayout.getHeight() != 0) {
                    linearLayout.setScaleY(AndroidUtilities.lerp(n7Var2.getHeight() / linearLayout.getHeight(), 1.0f, f13));
                }
                n7Var2.setTranslationX(AndroidUtilities.lerp(f14, (iVar.getWidth() / 2.0f) - AndroidUtilities.dp(28.0f), f13));
                n7Var2.setTranslationY(AndroidUtilities.lerp(f15, (iVar.getHeight() / 2.0f) - AndroidUtilities.dp(28.0f), f13));
                n7Var2.setAlpha(1.0f - f13);
    ...
    public final void d() {
        ...
        drawable.setColorFilter(new PorterDuffColorFilter(j6.w0(null, j6.f17998h5, false), mode));
        this.f12960w.setBackground(drawable);
        this.f12961x.setTextColor(j6.w0(null, j6.f18034j5, false));
        invalidate();
    }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        LinearLayout linearLayout = this.f12960w;
    ...
    public final void onAttachedToWindow() {
        ...
        n7Var.setTranslationX(a2);
        if (f10 == -1.0f) {
            b10 = b(displayMetrics, 2.1474836E9f);
        } else {
            b10 = b(displayMetrics, f10);
        }
        n7Var.setTranslationY(b10);
        k kVar = new k(n7Var, o1.h.f14116m, n7Var.getTranslationX());
        l lVar = new l(n7Var.getTranslationX());
        lVar.b(650.0f);
        lVar.a(0.75f);
        kVar.f14134u = lVar;
        this.f12955c = kVar;
        k kVar2 = new k(n7Var, o1.h.f14117n, n7Var.getTranslationY());
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        DisplayMetrics displayMetrics = getResources().getDisplayMetrics();
        n7 n7Var = this.f12953a;
        if (n7Var.getTranslationX() >= displayMetrics.widthPixels / 2.0f) {
            f7 = 2.1474836E9f;
        } else {
            f7 = -2.1474836E9f;
        }
        n7Var.setTranslationX(a(displayMetrics, f7));
        n7Var.setTranslationY(b(displayMetrics, n7Var.getTranslationY()));
        this.f12955c.f14134u.f14140i = n7Var.getTranslationX();
        this.d.f14134u.f14140i = n7Var.getTranslationY();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        this.f12954b.setAlpha((int) (n7Var.getAlpha() * 255.0f));
        this.f12954b.setBounds(n7Var.getLeft(), n7Var.getTop(), n7Var.getRight(), n7Var.getBottom());
        this.f12954b.draw(canvas);
        canvas.restore();
    }
