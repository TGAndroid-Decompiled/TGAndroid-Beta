...
public class d extends FrameLayout {
    public final g6 f12538a;
    public final ImageView f12539b;
    public final TextView f12540c;
    public Runnable d;
    public final i2 f12541e;
    public final Paint f12542f;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int v02 = k6.v0(k6.f21662d7, this.f12538a);
        Paint paint = this.f12542f;
        paint.setColor(v02);
    ...
    public void setBackImage(int i10) {
        this.f12539b.setImageResource(i10);
    }
    ...
    public void setCloseImageVisible(boolean z4) {
        ...
        this.f12539b.setVisibility(i10);
        ...
        this.f12540c.setLayoutParams(c6.d(-1, -2.0f, 23, f10, 0.0f, f11, 0.0f));
    }
