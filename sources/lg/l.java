...
public final class l implements ViewTreeObserver.OnPreDrawListener {
    public final MediaController.CropState f14293a;
    ...
    public final boolean onPreDraw() {
        ...
        MediaController.CropState cropState = this.f14293a;
        if (cropState != null) {
            ...
            if (pVar.f14316x && cropAreaView.getLockAspectRatio() > 0.0f) {
