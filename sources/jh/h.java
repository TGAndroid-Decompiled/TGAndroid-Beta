...
public final class h extends FrameLayout implements le.d {
    ...
    public final e6 f13034b;
    public final dh.a f13035c;
    public final ah.c d;
    public final aa.a[] e;
    public final n1[] f13036f;
    public a h;
    public b f13037n;
    public int f13038r;
    ...
    static {
        ...
        f13032s = new int[]{i10, i11, R.drawable.mentionbutton, R.drawable.reactionbutton, R.drawable.menu_poll_notify, i11, i11};
    }

    public h(Context context, e6 e6Var, dh.b bVar, ah.c cVar) {
        super(context);
        this.f13033a = new String[]{LocaleController.getString(R.string.AttachMenu), LocaleController.getString(R.string.AccDescrPageDown), LocaleController.getString(R.string.AccDescrMentionDown), LocaleController.getString(R.string.AccDescrReactionMentionDown), LocaleController.getString(R.string.AccDescrPollVotesMentionDown), LocaleController.getString(R.string.AccDescrSearchPrev), LocaleController.getString(R.string.AccDescrSearchNext)};
        this.e = new aa.a[7];
        this.f13036f = new n1[7];
        this.f13038r = 83;
        this.d = cVar;
        this.f13035c = bVar;
        this.f13034b = e6Var;
    ...
    public final void a() {
        ...
        while (true) {
            ...
            if (i11 < aVarArr.length) {
                ...
                if (aVar != null) {
                    ih.b bVar = (ih.b) aVar.f357b;
                    float f10 = ((le.b) aVar.f358c).e;
    ...
    public final void e(int i10, boolean z10, boolean z11) {
        ...
        if (aVar == null) {
            ...
            int i16 = f13032s[i10];
            e6 e6Var = this.f13034b;
            ih.b bVar3 = new ih.b(context, e6Var);
            ih.a d = ih.a.d(context, this.d, this.f13035c, e6Var, i16, i12);
            bVar3.f11197b = d;
            ...
            if (i10 == 1) {
                bVar3.d = true;
                wq wqVar = bVar3.f11198c;
                if (wqVar != null) {
                    wqVar.setReverse(true);
                }
            }
            addView(bVar3, x5.e(i11, i11 + 8, this.f13038r));
            aVarArr[i10] = new aa.a(bVar3, bVar, bVar2, false, 23);
            n1 n1Var = this.f13036f[i10];
            if (n1Var != null) {
                bVar3.a(n1Var.f3159a, false);
                bVar.a(false, false);
                if (n1Var.f3159a <= 0) {
                    z12 = false;
                }
                bVar2.a(z12, false);
                bVar3.c(n1Var.f3160b, false);
                bVar3.b(n1Var.f3161c, false);
            }
            a();
        }
        ((le.b) aVarArr[i10].f358c).a(z10, z11);
    }
