...
public final class h extends FrameLayout implements le.d {
    public static final int[] f13034s;
    public final String[] f13035a;
    public final e6 f13036b;
    public final dh.a f13037c;
    public final ah.c d;
    public final aa.a[] e;
    public final n1[] f13038f;
    public a h;
    public b f13039n;
    public int f13040r;
    ...
    static {
        ...
        f13034s = new int[]{i10, i11, R.drawable.mentionbutton, R.drawable.reactionbutton, R.drawable.menu_poll_notify, i11, i11};
    }

    public h(Context context, e6 e6Var, dh.b bVar, ah.c cVar) {
        super(context);
        this.f13035a = new String[]{LocaleController.getString(R.string.AttachMenu), LocaleController.getString(R.string.AccDescrPageDown), LocaleController.getString(R.string.AccDescrMentionDown), LocaleController.getString(R.string.AccDescrReactionMentionDown), LocaleController.getString(R.string.AccDescrPollVotesMentionDown), LocaleController.getString(R.string.AccDescrSearchPrev), LocaleController.getString(R.string.AccDescrSearchNext)};
        this.e = new aa.a[7];
        this.f13038f = new n1[7];
        this.f13040r = 83;
        this.d = cVar;
        this.f13037c = bVar;
        this.f13036b = e6Var;
    ...
    public final void e(int i10, boolean z10, boolean z11) {
        ...
        if (aVar == null) {
            ...
            int i16 = f13034s[i10];
            e6 e6Var = this.f13036b;
            ih.b bVar3 = new ih.b(context, e6Var);
            ih.a d = ih.a.d(context, this.d, this.f13037c, e6Var, i16, i12);
            bVar3.f11199b = d;
            ...
            if (i10 == 1) {
                bVar3.d = true;
                wq wqVar = bVar3.f11200c;
                if (wqVar != null) {
                    wqVar.setReverse(true);
                }
            }
            addView(bVar3, x5.e(i11, i11 + 8, this.f13040r));
            aVarArr[i10] = new aa.a(bVar3, bVar, bVar2, false, 24);
            n1 n1Var = this.f13038f[i10];
            if (n1Var != null) {
                bVar3.a(n1Var.f3161a, false);
                bVar.a(false, false);
                if (n1Var.f3161a <= 0) {
                    z12 = false;
                }
                bVar2.a(z12, false);
                bVar3.c(n1Var.f3162b, false);
                bVar3.b(n1Var.f3163c, false);
            }
            a();
        }
