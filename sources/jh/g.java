    ...
    public final boolean onLongClick(View view) {
        ...
        switch (this.f13032a) {
            ...
            default:
                ...
                if (!scrollSlidingTextTabStrip.f22196n0 && (mm0Var = scrollSlidingTextTabStrip.f22181b) != null && mm0Var.n1(this.f13033b, view)) {
                    return true;
                }
                return false;
        }
