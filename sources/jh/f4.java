...
public final class f4 extends Drawable {
    ...
    public int h;
    public int f12063i;
    public final Paint f12058b = new Paint(1);
    public final Shader[] f12059c = new Shader[2];
    public final Matrix d = new Matrix();
    public final org.telegram.ui.Components.d6 f12060e = new org.telegram.ui.Components.d6(1.0f, new o(this, 9), 0, 420, jr.h);
    public final RectF f12061f = new RectF();
    public final int f12057a = 1;

    public final void a(int i10, int i11) {
        if (this.h == i10 && this.f12063i == i11) {
            return;
        }
        Shader[] shaderArr = this.f12059c;
    ...
    public final void draw(Canvas canvas) {
        ...
        RectF rectF = this.f12061f;
        rectF.set(bounds);
        rectF.right = rectF.width() + rectF.left;
        int i10 = 0;
        float d = this.f12060e.d(1.0f, false);
        while (true) {
            Shader[] shaderArr = this.f12059c;
        ...
        if (this.f12062g != null) {
            ...
            x0.a(canvas, 0, this.f12062g, rectF.width(), AndroidUtilities.dp(290.0f), 2.0f, 1.0f);
            canvas.restore();
        }
    }
