...
public final class c4 extends View {
    public final Paint f11856a;
    public final Paint f11857b;
    public final Paint f11858c;
    public final RadialGradient[] d;
    public final Matrix f11859e;
    public final org.telegram.ui.Components.d6 f11860f;
    public final RadialGradient h;
    public final Path f11861n;
    public int f11862r;
    public int f11863s;

    public c4(Context context) {
        super(context);
        this.f11856a = new Paint(1);
        this.f11857b = new Paint(1);
        Paint paint = new Paint(1);
        this.f11858c = paint;
        this.d = new RadialGradient[2];
        this.f11859e = new Matrix();
        this.f11860f = new org.telegram.ui.Components.d6(1.0f, this, 0L, 420L, jr.h);
    ...
    public final void a(int i10, int i11) {
        if (this.f11862r == i10 && this.f11863s == i11) {
            return;
        }
