...
public final class e {
    ...
    public static boolean f46317f = false;
    public static int f46318g = -1;
    public static Boolean h;
    public static j f46322l;
    public static k f46323m;
    public final Context f46324a;
    public static final ThreadLocal f46319i = new ThreadLocal();
    public static final n1 f46320j = new n1(3);
    public static final rb.a f46321k = new rb.a(26);
    public static final u f46315b = new Object();
    public static final na.d f46316c = new na.d(27);
    ...
    public static e c(Context context, d dVar, String str) {
        ...
        if (applicationContext != null) {
            ThreadLocal threadLocal = f46319i;
            ...
            try {
                ...
                a3.l d10 = dVar.d(context, str, f46321k);
                j3 = longValue;
                try {
                    int i10 = d10.f142a;
                    int i11 = d10.f143b;
                                        ...
                                        if (bool != null) {
                                            if (bool.booleanValue()) {
                                                ...
                                                if (kVar != null) {
                                                    ...
                                                    if (iVar2 != null && iVar2.f46327a != null) {
                                                        Context applicationContext2 = context.getApplicationContext();
                                                        Cursor cursor = iVar2.f46327a;
                                                        new x6.b(null);
                                                        synchronized (e.class) {
                                                            if (f46318g >= 2) {
                                                                z10 = true;
                                                ...
                                                if (h10 != null) {
                                                    ...
                                                    if (readInt >= 3) {
                                                        ...
                                                        if (iVar3 != null) {
                                                            W0 = h10.X0(new x6.b(context), str, i13, new x6.b(iVar3.f46327a));
                                                        } else {
    ...
    public final IBinder b(String str) {
        try {
            return (IBinder) this.f46324a.getClassLoader().loadClass(str).newInstance();
