...
public final class e {
    ...
    public static boolean f46321f = false;
    public static int f46322g = -1;
    public static Boolean h;
    public static j f46326l;
    public static k f46327m;
    public final Context f46328a;
    public static final ThreadLocal f46323i = new ThreadLocal();
    public static final n1 f46324j = new n1(3);
    public static final rb.a f46325k = new rb.a(26);
    public static final u f46319b = new Object();
    public static final na.d f46320c = new na.d(27);
    ...
    public static e c(Context context, d dVar, String str) {
        ...
        if (applicationContext != null) {
            ThreadLocal threadLocal = f46323i;
            ...
            try {
                ...
                a3.l d10 = dVar.d(context, str, f46325k);
                j3 = longValue;
                try {
                    int i10 = d10.f140a;
                    int i11 = d10.f141b;
                        ...
                        if (i12 != 1 || d10.f141b != 0) {
                            if (i12 == -1) {
                                ...
                                try {
                                        ...
                                        if (bool != null) {
                                            if (bool.booleanValue()) {
                                                ...
                                                if (kVar != null) {
                                                    ...
                                                    if (iVar2 != null && iVar2.f46331a != null) {
                                                        Context applicationContext2 = context.getApplicationContext();
                                                        Cursor cursor = iVar2.f46331a;
                                                        new x6.b(null);
                                                        synchronized (e.class) {
                                                            if (f46322g >= 2) {
                                                                z10 = true;
                                                ...
                                                if (h10 != null) {
                                                    ...
                                                    if (readInt >= 3) {
                                                        ...
                                                        if (iVar3 != null) {
                                                            W0 = h10.X0(new x6.b(context), str, i13, new x6.b(iVar3.f46331a));
                                                        } else {
                                    ...
                                    int i14 = d10.f140a;
                                    if (i14 != 0 && dVar.d(context, str, new com.google.android.gms.internal.cast.a(i14)).f142c == -1) {
                                        Log.i("DynamiteModule", "Selected local version of ".concat(String.valueOf(str)));
                                        eVar = new e(applicationContext);
                                    } else {
    ...
    public static boolean g(Context context) {
        ...
        if (h == null) {
            ...
            if (k6.e.f13509b.d(context, 10000000) == 0 && resolveContentProvider != null && "com.google.android.gms".equals(resolveContentProvider.packageName)) {
                z10 = true;
            }
    ...
    public final IBinder b(String str) {
        try {
            return (IBinder) this.f46328a.getClassLoader().loadClass(str).newInstance();
