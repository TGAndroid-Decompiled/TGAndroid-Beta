...
public final class e {
    ...
    public static boolean f46275f = false;
    public static int f46276g = -1;
    public static Boolean h;
    public static j f46280l;
    public static k f46281m;
    public final Context f46282a;
    public static final ThreadLocal f46277i = new ThreadLocal();
    public static final n1 f46278j = new n1(3);
    public static final rb.a f46279k = new rb.a(26);
    public static final u f46273b = new Object();
    public static final na.d f46274c = new na.d(27);
    ...
    public static e c(Context context, d dVar, String str) {
        ...
        if (applicationContext != null) {
            ThreadLocal threadLocal = f46277i;
            ...
            try {
                ...
                a3.l d10 = dVar.d(context, str, f46279k);
                j3 = longValue;
                try {
                    int i10 = d10.f142a;
                    int i11 = d10.f143b;
                                        ...
                                        if (bool != null) {
                                            if (bool.booleanValue()) {
                                                ...
                                                if (kVar != null) {
                                                    ...
                                                    if (iVar2 != null && iVar2.f46285a != null) {
                                                        Context applicationContext2 = context.getApplicationContext();
                                                        Cursor cursor = iVar2.f46285a;
                                                        new x6.b(null);
                                                        synchronized (e.class) {
                                                            if (f46276g >= 2) {
                                                                z10 = true;
                                                ...
                                                if (h10 != null) {
                                                    ...
                                                    if (readInt >= 3) {
                                                        ...
                                                        if (iVar3 != null) {
                                                            W0 = h10.X0(new x6.b(context), str, i13, new x6.b(iVar3.f46285a));
                                                        } else {
    ...
    public static boolean g(Context context) {
        ...
        if (h == null) {
            ...
            if (k6.e.f13499b.d(context, 10000000) == 0 && resolveContentProvider != null && "com.google.android.gms".equals(resolveContentProvider.packageName)) {
                z10 = true;
            }
    ...
    public final IBinder b(String str) {
        try {
            return (IBinder) this.f46282a.getClassLoader().loadClass(str).newInstance();
