...
public final class e {
    ...
    public static boolean f46644f = false;
    public static int f46645g = -1;
    public static Boolean h;
    public static j f46649l;
    public static k f46650m;
    public final Context f46651a;
    public static final ThreadLocal f46646i = new ThreadLocal();
    public static final n1 f46647j = new n1(3);
    public static final rb.a f46648k = new rb.a(26);
    public static final u f46642b = new Object();
    public static final na.d f46643c = new na.d(27);
    ...
    public static e c(Context context, d dVar, String str) {
        ...
        if (applicationContext != null) {
            ThreadLocal threadLocal = f46646i;
            ...
            try {
                ...
                a3.l d10 = dVar.d(context, str, f46648k);
                j3 = longValue;
                try {
                    int i10 = d10.f142a;
                    int i11 = d10.f143b;
                        ...
                        if (i12 != 1 || d10.f143b != 0) {
                            if (i12 == -1) {
                                ...
                                try {
                                        ...
                                        if (bool != null) {
                                            if (bool.booleanValue()) {
                                                ...
                                                if (kVar != null) {
                                                    ...
                                                    if (iVar2 != null && iVar2.f46654a != null) {
                                                        Context applicationContext2 = context.getApplicationContext();
                                                        Cursor cursor = iVar2.f46654a;
                                                        new x6.b(null);
                                                        synchronized (e.class) {
                                                            if (f46645g >= 2) {
                                                                z10 = true;
                                                ...
                                                if (h10 != null) {
                                                    ...
                                                    if (readInt >= 3) {
                                                        ...
                                                        if (iVar3 != null) {
                                                            W0 = h10.X0(new x6.b(context), str, i13, new x6.b(iVar3.f46654a));
                                                        } else {
                                    ...
                                    int i14 = d10.f142a;
                                    if (i14 != 0 && dVar.d(context, str, new com.google.android.gms.internal.cast.a(i14)).f144c == -1) {
                                        Log.i("DynamiteModule", "Selected local version of ".concat(String.valueOf(str)));
                                        eVar = new e(applicationContext);
                                    } else {
    ...
    public static boolean g(Context context) {
        ...
        if (h == null) {
            ...
            if (k6.e.f13511b.d(context, 10000000) == 0 && resolveContentProvider != null && "com.google.android.gms".equals(resolveContentProvider.packageName)) {
                z10 = true;
            }
    ...
    public final IBinder b(String str) {
        try {
            return (IBinder) this.f46651a.getClassLoader().loadClass(str).newInstance();
