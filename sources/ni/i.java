    ...
    public void onPageFinished(WebView webView, String str) {
        ...
        switch (i10) {
            case 1:
                ...
                if (!ku0Var.f27289x) {
                    ku0Var.f27285n.setVisibility(4);
            ...
            case 2:
                super.onPageFinished(webView, str);
                oj1 oj1Var = (oj1) obj;
                tq tqVar = oj1Var.f36373c;
                if (tqVar != null && tqVar.getVisibility() == 0) {
                    AnimatorSet animatorSet = new AnimatorSet();
                    oj1Var.f36372b.getContentView().setVisibility(0);
                    oj1Var.f36372b.setEnabled(true);
                    animatorSet.playTogether(ObjectAnimator.ofFloat(oj1Var.f36373c, "scaleX", 1.0f, 0.1f), ObjectAnimator.ofFloat(oj1Var.f36373c, "scaleY", 1.0f, 0.1f), ObjectAnimator.ofFloat(oj1Var.f36373c, "alpha", 1.0f, 0.0f), ObjectAnimator.ofFloat(oj1Var.f36372b.getContentView(), "scaleX", 0.0f, 1.0f), ObjectAnimator.ofFloat(oj1Var.f36372b.getContentView(), "scaleY", 0.0f, 1.0f), ObjectAnimator.ofFloat(oj1Var.f36372b.getContentView(), "alpha", 0.0f, 1.0f));
    ...
    public WebResourceResponse shouldInterceptRequest(WebView webView, WebResourceRequest webResourceRequest) {
        switch (this.f15272a) {
            ...
            case 1:
                ...
                if (((ku0) this.f15273b).f27289x && uri.startsWith("https://www.youtube.com/youtubei/v1/player?key=")) {
