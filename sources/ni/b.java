...
public final class b {
    public static final Pattern f15253g = Pattern.compile("[A-Za-z0-9][A-Za-z0-9_-]*(/[A-Za-z0-9][A-Za-z0-9_-]*)*");
    public static final Pattern h = Pattern.compile("[A-Za-z0-9_-]+");
    public static final b f15254i = a().a();
    ...
    public b(a aVar) {
        int i10 = aVar.f15249a;
        this.f15255a = i10;
        this.f15256b = aVar.f15250b;
        if (i10 == 3) {
            this.f15258f = aVar.f15252f;
            this.f15257c = 0;
            this.d = "";
            this.e = "";
        } else if (i10 == 2) {
            this.f15258f = aVar.f15252f;
            this.f15257c = aVar.f15251c;
            this.d = "";
            this.e = "";
        } else if (i10 == 1) {
            this.f15258f = "";
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof b) {
                b bVar = (b) obj;
                if (this.f15257c == bVar.f15257c && this.f15255a == bVar.f15255a && Objects.equals(this.f15256b, bVar.f15256b) && Objects.equals(this.d, bVar.d) && Objects.equals(this.e, bVar.e) && Objects.equals(this.f15258f, bVar.f15258f)) {
                    return true;
                }
                return false;
            }
        ...
        if (!TextUtils.isEmpty(str3)) {
            if (this.f15255a == 3) {
                if (!TextUtils.isEmpty(str3)) {
                    ...
                    if (!TextUtils.isEmpty(str) && str.indexOf(58) < 0 && str.indexOf(63) < 0 && str.indexOf(35) < 0 && (str2 == null || (str2.length() <= 128 && f15253g.matcher(str2).matches()))) {
                        try {
                            equals = str.equals(IDN.toASCII(str, 3).toLowerCase(Locale.US));
                        } catch (IllegalArgumentException unused) {
                        }
                        if (!equals && g(this.f15258f)) {
                            return true;
                        }
                    }
                }
    ...
    public final void h(SharedPreferences.Editor editor) {
        ...
        editor.putString("proxy_ip", this.f15256b);
        int c11 = m1.j.c(i11);
    ...
    public final int hashCode() {
        return Objects.hash(m1.j.a(this.f15255a), this.f15256b, Integer.valueOf(this.f15257c), this.d, this.e, this.f15258f);
    }
}
