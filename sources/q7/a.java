...
public final class a extends Binder implements j, IInterface {
    ...
    public final TaskCompletionSource f46416b;

    public a(int i10, TaskCompletionSource taskCompletionSource) {
        this.f46415a = i10;
        attachInterface(this, "com.google.android.gms.wallet.internal.IWalletServiceCallbacks");
        this.f46416b = taskCompletionSource;
    }
    ...
    public void C(int i10, boolean z10) {
        switch (this.f46415a) {
            case 1:
                o5.a(new Status(i10, null, null, null), Boolean.valueOf(z10), this.f46416b);
                return;
            default:
                return;
        }
    ...
    public void h0(Status status, boolean z10) {
        switch (this.f46415a) {
            case 1:
                o5.a(status, Boolean.valueOf(z10), this.f46416b);
                return;
            default:
                return;
        }
    ...
    public final boolean onTransact(int i10, Parcel parcel, Parcel parcel2, int i11) {
        ...
        switch (i10) {
            ...
            case 14:
                ...
                v0((Status) c.a(parcel, Status.CREATOR), (h8.i) c.a(parcel, h8.i.CREATOR));
                return true;
            case 15:
            ...
            case 19:
                ...
                h8.h hVar2 = (h8.h) c.a(parcel, h8.h.CREATOR);
    ...
    public void v0(Status status, h8.i iVar) {
        switch (this.f46415a) {
            case 0:
                ...
                TaskCompletionSource taskCompletionSource = this.f46416b;
                if (b10) {
