...
public final class x0 extends g3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final p0 f42560c;
    public final ArrayList d;
    public float e;
    public float f42561f;
    public boolean h;
    public final u0 f42562n;
    public final n6 f42563r;
    public int f42564s;
    public final FrameLayout v;
    public boolean f42565w;
    public final SvgHelper.SvgDrawable f42566x;
    public final int f42567y;
    ...
    public final boolean canDismissWithSwipe() {
        int i10 = 0;
        while (true) {
            u0 u0Var = this.f42562n;
            if (i10 >= u0Var.getChildCount()) {
                return true;
            }
            w0 w0Var = (w0) u0Var.getChildAt(i10);
            if (w0Var.f42550a == this.G) {
                ViewGroup viewGroup = w0Var.f42553f;
                if (viewGroup instanceof b) {
                    return !((b) viewGroup).f42275b.canScrollVertically(-1);
                }
            }
            i10++;
        }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        this.N = w7Var;
        w7Var.setBackgroundColor(getThemedColor(j6.f18933h5));
        this.N.setTitleColor(getThemedColor(j6.G6));
        this.N.A(getThemedColor(j6.f19265z8), false);
        w7 w7Var2 = this.N;
        int i10 = j6.f19246y8;
    ...
    public final void y() {
        ...
        while (true) {
            ...
            int i14 = w0Var.f42550a;
            ViewGroup viewGroup = w0Var.f42553f;
            if (i14 == this.G && (viewGroup instanceof b) && ((m11 = ((b) viewGroup).f42276c.m(0)) == null || (i11 = m11.getTop()) < 0)) {
                i11 = 0;
            }
            if (w0Var.f42550a == this.H && (viewGroup instanceof b) && ((m10 = ((b) viewGroup).f42276c.m(0)) == null || (i12 = m10.getTop()) < 0)) {
                i12 = 0;
            }
            i13++;
        }
        ...
        frameLayout.setAlpha(1.0f - this.f42561f);
        if (this.e == 1.0f) {
        ...
        boolean z11 = this.h;
        n6 n6Var = this.f42563r;
        if (z11) {
            i10 = n6Var.getMeasuredWidth();
        } else {
            i10 = -n6Var.getMeasuredWidth();
        }
        n6Var.setTranslationX(i10 * this.f42561f);
        if (i15 != this.M) {
            this.M = i15;
    ...
    public final ViewGroup z(Context context, int i10) {
        ...
        int i12 = mx0Var.f35903a;
        if (i12 == 0) {
            b bVar = new b(context, this.resourcesProvider);
            bVar.f42275b.setOnScrollListener(new r0(this, 1));
            return bVar;
            ...
            return new z1(context, this.f42566x, this.currentAccount, mx0Var.f35903a, this.resourcesProvider);
        } else {
            if (i12 == 28) {
                i11 = 1;
            } else {
            ...
            jVar.f42275b.setOnScrollListener(new r0(this, 0));
            return jVar;
        }
    }
    ...
    public x0(o2 o2Var, Context context, int i10, boolean z10, int i11, boolean z11, nx0 nx0Var, f6 f6Var) {
        ...
        this.f42559b = o2Var;
        this.J = nx0Var;
        fixNavigationBar(getThemedColor(j6.f18933h5));
        this.f42567y = i11;
        this.E = z11;
        this.f42566x = SvgHelper.getDrawable(AndroidUtilities.readRes(R.raw.star_loader));
        ...
        while (true) {
            if (i12 >= this.d.size()) {
                i12 = 0;
                break;
            } else if (((mx0) this.d.get(i12)).f35903a == i11) {
                break;
            } else {
                i12++;
            }
        ...
        this.f42560c = p0Var;
        p0Var.f42448r.setOnClickListener(new m5(this, o2Var, z11, mx0Var, 5));
        ...
        frameLayout2.setBackgroundColor(getThemedColor(j6.f18933h5));
