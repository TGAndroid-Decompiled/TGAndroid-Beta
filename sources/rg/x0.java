...
public final class x0 extends f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int M;
    public w7 N;
    public final n2 f42533b;
    public final p0 f42534c;
    public final ArrayList d;
    public float e;
    public float f42535f;
    public boolean h;
    public final u0 f42536n;
    public final n6 f42537r;
    public int f42538s;
    public final FrameLayout v;
    public boolean f42539w;
    public final SvgHelper.SvgDrawable f42540x;
    public final int f42541y;
    ...
    public final boolean canDismissWithSwipe() {
        int i10 = 0;
        while (true) {
            u0 u0Var = this.f42536n;
            if (i10 >= u0Var.getChildCount()) {
                return true;
            }
            w0 w0Var = (w0) u0Var.getChildAt(i10);
            if (w0Var.f42524a == this.G) {
                ViewGroup viewGroup = w0Var.f42527f;
                if (viewGroup instanceof b) {
                    return !((b) viewGroup).f42249b.canScrollVertically(-1);
                }
            }
            i10++;
        }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        this.N = w7Var;
        w7Var.setBackgroundColor(getThemedColor(i6.f18904h5));
        this.N.setTitleColor(getThemedColor(i6.G6));
        this.N.A(getThemedColor(i6.f19236z8), false);
        w7 w7Var2 = this.N;
        int i10 = i6.f19217y8;
    ...
    public final void y() {
        ...
        while (true) {
            ...
            int i14 = w0Var.f42524a;
            ViewGroup viewGroup = w0Var.f42527f;
            if (i14 == this.G && (viewGroup instanceof b) && ((m11 = ((b) viewGroup).f42250c.m(0)) == null || (i11 = m11.getTop()) < 0)) {
                i11 = 0;
            }
            if (w0Var.f42524a == this.H && (viewGroup instanceof b) && ((m10 = ((b) viewGroup).f42250c.m(0)) == null || (i12 = m10.getTop()) < 0)) {
                i12 = 0;
            }
            i13++;
        }
        ...
        frameLayout.setAlpha(1.0f - this.f42535f);
        if (this.e == 1.0f) {
        ...
        boolean z11 = this.h;
        n6 n6Var = this.f42537r;
        if (z11) {
            i10 = n6Var.getMeasuredWidth();
        } else {
            i10 = -n6Var.getMeasuredWidth();
        }
        n6Var.setTranslationX(i10 * this.f42535f);
        if (i15 != this.M) {
            this.M = i15;
    ...
    public final ViewGroup z(Context context, int i10) {
        ...
        int i12 = kx0Var.f35277a;
        if (i12 == 0) {
            b bVar = new b(context, this.resourcesProvider);
            bVar.f42249b.setOnScrollListener(new r0(this, 1));
            return bVar;
            ...
            return new z1(context, this.f42540x, this.currentAccount, kx0Var.f35277a, this.resourcesProvider);
        } else {
            if (i12 == 28) {
                i11 = 1;
            } else {
            ...
            jVar.f42249b.setOnScrollListener(new r0(this, 0));
            return jVar;
        }
    }
    ...
    public x0(n2 n2Var, Context context, int i10, boolean z10, int i11, boolean z11, lx0 lx0Var, e6 e6Var) {
        ...
        this.f42533b = n2Var;
        this.J = lx0Var;
        fixNavigationBar(getThemedColor(i6.f18904h5));
        this.f42541y = i11;
        this.E = z11;
        this.f42540x = SvgHelper.getDrawable(AndroidUtilities.readRes(R.raw.star_loader));
        ...
        while (true) {
            if (i12 >= this.d.size()) {
                i12 = 0;
                break;
            } else if (((kx0) this.d.get(i12)).f35277a == i11) {
                break;
            } else {
                i12++;
            }
        ...
        this.f42534c = p0Var;
        p0Var.f42422r.setOnClickListener(new m5(this, n2Var, z11, kx0Var, 5));
        ...
        frameLayout2.setBackgroundColor(getThemedColor(i6.f18904h5));
