...
public abstract class g1 extends k {
    ...
    public f5 K0;
    public f5 L0;
    public final t5 f45190q0;
    public final z0 f45191r0;
    public final ArrayList f45192s0;
    public final MessageObject.GroupedMessages f45193t0;
    public boolean f45194u0;
    public boolean f45195v0;
    public TextureView f45196w0;
    public boolean f45197x0;
    public int f45198y0;
    public int f45199z0;
    ...
    public g1(Context context, PointF pointF, ArrayList arrayList, ja jaVar, boolean z10, c7 c7Var) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            if (message2 instanceof TLRPC.TL_message) {
                ...
                this.f45192s0.add(messageObject2);
            }
            ...
            this.f45192s0.add(messageObject22);
        }
        this.f45193t0 = null;
        if (this.f45192s0.size() > 1) {
            MessageObject.GroupedMessages groupedMessages = new MessageObject.GroupedMessages();
            this.f45193t0 = groupedMessages;
            groupedMessages.messages.addAll(this.f45192s0);
            groupedMessages.groupId = ((MessageObject) this.f45192s0.get(0)).getGroupId();
