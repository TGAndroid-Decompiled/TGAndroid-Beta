...
public final class b1 extends org.telegram.ui.Cells.t1 {
    ...
    public final boolean a2(Canvas canvas) {
        ...
        c1 c1Var = this.Le;
        c6 c6Var = c1Var.h;
        if (c1Var.f45144f && photoImage != null && (((c7Var = c1Var.f45143e) != null && c7Var.f6994g && c7Var.d && c6Var.f45197x0) || c6Var.f45194u0 || (c6Var.f45196w0 != null && c6Var.M0.I0))) {
            int i10 = 0;
            while (true) {
            ...
            if (textureView != null && c6Var.M0.I0) {
                ...
                if (bitmap != null) {
                    ...
                    canvas.translate(photoImage.getCenterX() - ((c6Var.f45198y0 * max) / 2.0f), photoImage.getCenterY() - ((c6Var.f45199z0 * max) / 2.0f));
                    canvas.scale((c6Var.f45198y0 / c6Var.f45196w0.getWidth()) * max, (c6Var.f45199z0 / c6Var.f45196w0.getHeight()) * max);
                    int width = bitmap.getWidth();
                    int height = bitmap.getHeight();
                    Rect rect = this.Je;
                    rect.set(0, 0, width, height);
                    RectF rectF2 = this.Ke;
                    rectF2.set(0.0f, 0.0f, c6Var.f45196w0.getWidth(), c6Var.f45196w0.getHeight());
    ...
    public final void onDraw(Canvas canvas) {
        Canvas canvas2;
        c1 c1Var = this.Le;
        c7 c7Var = c1Var.f45143e;
        if ((c7Var != null && c7Var.f6994g && c7Var.d) || c1Var.h.f45194u0) {
            canvas2 = canvas;
