...
public class b1 extends ImageView {
    ...
    public final Path f42263w;
    public Paint f42264x;
    public Paint f42265y;

    public b1(Context context, int i10, e6 e6Var) {
        super(context);
        int i11;
        this.f42257b = new float[3];
        this.f42259f = 1.0f;
        this.h = false;
        this.f42260n = -1;
        this.v = null;
        this.f42263w = new Path();
        this.f42264x = new Paint(1);
        this.G = 1.0f;
        this.f42256a = i10;
        this.d = e6Var;
        if (i10 == 0) {
        ...
        if (i10 == 0) {
            ...
            this.f42259f = 0.8f;
            this.f42264x.setColor(i6.w0(null, i6.f18780a7, false));
        } else if (i10 == 3) {
    ...
    public final void a() {
        if (this.e && getMeasuredHeight() != 0 && getMeasuredWidth() != 0) {
            int i10 = this.f42260n;
            float[] fArr = this.f42257b;
            ...
            if (this.v == null || this.f42261r != d10 || this.f42262s != d) {
                if (this.I) {
                    Paint paint = this.f42264x;
                    this.f42265y = paint;
                    paint.setAlpha(255);
                    this.G = 0.0f;
                }
                ...
                this.f42264x.setShader(linearGradient);
                invalidate();
            }
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f42256a == 0) {
            ...
            path.close();
            u1 u1Var = this.f42258c;
            u1Var.f42496a.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
            u1Var.f42496a.inset(AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f));
            return;
        }
        a();
    }
