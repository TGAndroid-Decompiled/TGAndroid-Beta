...
public final class x2 extends k {
    public String A0;
    public final w2 f45570q0;
    public qg.q1 f45571r0;
    public int f45572s0;
    public int f45573t0;
    public int f45574u0;
    public qg.j0 f45575v0;
    public int f45576w0;
    public int f45577x0;
    public Runnable f45578y0;
    public boolean f45579z0;

    public x2(Context context, PointF pointF, int i10, CharSequence charSequence, qg.q1 q1Var, int i11) {
        super(context, pointF);
        this.f45575v0 = qg.j0.f44478e;
        this.f45573t0 = i10;
        ...
        w2Var.setTextSize(0, this.f45573t0);
        w2Var.setCursorSize(AndroidUtilities.dp(this.f45573t0 * 0.4f));
        w2Var.setText(charSequence);
        s();
        w2Var.setTextColor(q1Var.f44569a);
    ...
    public int getAlign() {
        return this.f45574u0;
    }

    public int getBaseFontSize() {
        return this.f45573t0;
    }

    public b getEditText() {
        return this.f45570q0;
    }
    ...
    public Paint.FontMetricsInt getFontMetricsInt() {
        return this.f45570q0.getPaint().getFontMetricsInt();
    }

    public float getFontSize() {
        return this.f45570q0.getTextSize();
    }
    ...
    public float getStickyPaddingBottom() {
        RectF rectF = this.f45570q0.f45160w;
        if (rectF == null) {
            return 0.0f;
        }
        return rectF.bottom;
    ...
    public qg.q1 getSwatch() {
        return this.f45571r0;
    }

    public CharSequence getText() {
        return this.f45570q0.getText();
    }

    public int getTextSize() {
        return (int) this.f45570q0.getTextSize();
    }

    public int getType() {
        return this.f45572s0;
    }

    public qg.j0 getTypeface() {
        return this.f45575v0;
    }
    ...
    public final void r() {
        ...
        int i11 = this.f45571r0.f44569a;
        int i12 = this.f45572s0;
        int i13 = -1;
        if (i12 == 0) {
            w2Var.setFrameColor(i11);
            i11 = AndroidUtilities.computePerceivedBrightness(this.f45571r0.f44569a) >= 0.721f ? -16777216 : -1;
        } else if (i12 == 1) {
    ...
    public void setMaxWidth(int i10) {
        this.f45570q0.setMaxWidth(i10);
    }

    public void setSwatch(qg.q1 q1Var) {
        this.f45571r0 = new qg.q1(q1Var.f44570b, q1Var.f44571c, q1Var.f44569a);
        r();
    }

    public void setText(CharSequence charSequence) {
        this.f45570q0.setText(charSequence);
        s();
    }
    ...
    public void setTypeface(qg.j0 j0Var) {
        this.f45575v0 = j0Var;
        if (j0Var != null) {
            this.f45570q0.setTypeface(j0Var.d());
        }
        m();
    }
    ...
    public x2(Context context, x2 x2Var, PointF pointF) {
        this(context, pointF, x2Var.f45573t0, x2Var.getText(), x2Var.getSwatch(), x2Var.f45572s0);
        ...
        int align = getAlign();
        int i10 = 2;
        this.f45570q0.setGravity(align != 1 ? align != 2 ? 19 : 21 : 17);
        int align2 = getAlign();
        if (align2 == 1) {
            i10 = 4;
        ...
        this.f45570q0.setTextAlignment(i10);
    }
}
