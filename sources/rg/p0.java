...
public class p0 extends FrameLayout implements q90 {
    ...
    public final Paint f42691a;
    public float f42692b;
    ...
    public final ai.f0 f42696r;
    public ValueAnimator f42697s;
    public final Path v;
    public final org.telegram.ui.Components.voip.h f42698w;
    public boolean f42699x;
    public final lj0 f42700y;
    ...
    public final void a(String str, View.OnClickListener onClickListener, boolean z10) {
        ...
        this.E = true;
        o0 o0Var = this.d;
        if (z10 && o0Var.f27260c.f()) {
            o0Var.a();
        }
        o0Var.c(str, z10, true);
        ai.f0 f0Var = this.f42696r;
    ...
    public final void d(boolean z10) {
        ValueAnimator valueAnimator = this.f42697s;
        ...
        this.f42697s = ofFloat;
        ofFloat.addUpdateListener(new k6(this, 11));
        this.f42697s.addListener(new pg.d0(this, 4));
        this.f42697s.setDuration(250L);
        this.f42697s.setInterpolator(rr.f28022f);
        this.f42697s.start();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (xqVar != null) {
            ...
            if (wqVar.h == 0) {
                ...
                dp = AndroidUtilities.dp(wqVar.C - 0.5f) + wqVar.f30143s;
            }
            e6 e6Var = this.J;
            ...
            e6 e6Var2 = this.K;
            e6Var2.d(e, false);
            o0Var.setTranslationX(-e6Var.f23817c);
            this.G.setTranslationX(e6Var2.f23817c - e6Var.f23817c);
        } else if (o0Var != null) {
            o0Var.setTranslationX(0.0f);
        }
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
        float f7 = this.f42695n;
        Paint paint = this.f42691a;
        int i10 = this.f42694f;
        if (f7 != 1.0f || !this.f42699x) {
            if (this.f42693c) {
                float f10 = this.f42692b + 0.016f;
                this.f42692b = f10;
                if (f10 > 3.0f) {
                    this.f42693c = false;
                }
            } else {
                float f11 = this.f42692b - 0.016f;
                this.f42692b = f11;
                if (f11 < 1.0f) {
                    this.f42693c = true;
                }
            ...
            if (this.H) {
                a1.d().f((-getMeasuredWidth()) * 0.1f * this.f42692b, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                float f12 = i10;
        ...
        if (!BuildVars.IS_BILLING_UNAVAILABLE && !this.F) {
            ...
            org.telegram.ui.Components.voip.h hVar = this.f42698w;
            hVar.f29358f = measuredWidth;
            hVar.a(i10, canvas, rectF, null);
        }
        float f14 = this.f42695n;
        if (f14 != 0.0f && this.f42699x) {
            paint.setAlpha((int) (f14 * 255.0f));
            if (this.f42695n != 1.0f) {
                Path path = this.v;
                path.rewind();
                path.addCircle(getMeasuredWidth() / 2.0f, getMeasuredHeight() / 2.0f, Math.max(getMeasuredWidth(), getMeasuredHeight()) * 1.4f * this.f42695n, Path.Direction.CW);
                canvas.save();
    ...
    public final void e() {
        ...
        o0 o0Var = this.e;
        o0Var.setAlpha(f7);
        o0Var.setTranslationY((1.0f - this.f42695n) * AndroidUtilities.dp(12.0f));
        ai.f0 f0Var = this.f42696r;
        f0Var.setAlpha(1.0f - this.f42695n);
        f0Var.setTranslationY((-AndroidUtilities.dp(12.0f)) * this.f42695n);
        int i11 = 0;
        if (this.f42695n == 1.0f) {
            i10 = 4;
        } else {
    ...
    public void setIcon(int i10) {
        lj0 lj0Var = this.f42700y;
        lj0Var.f(i10, 24, 24, null);
        org.telegram.ui.Components.voip.h hVar = this.f42698w;
        hVar.f29359g = 2.0f;
        hVar.f29367p = new org.telegram.ui.web.q0(this, 27);
        invalidate();
    ...
    public p0(int i10, Context context, d6 d6Var, boolean z10) {
        ...
        addView(f0Var);
        setOutlineProvider(yf.i0.f47101b);
