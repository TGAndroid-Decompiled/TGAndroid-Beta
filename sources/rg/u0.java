...
public class u0 extends View {
    ...
    public final TextPaint f45533e;
    public final Paint f45534f;
    public final Drawable h;
    public boolean f45535n;
    public final ImageReceiver f45536r;
    public final ImageReceiver f45537s;
    public TLRPC.Document v;
    public TLRPC.Document f45538w;
    public boolean f45539x;
    public final float f45540y;
    ...
    public u0(Context context, float f7) {
        ...
        this.f45533e = textPaint;
        this.f45534f = new Paint(1);
        ImageReceiver imageReceiver = new ImageReceiver(this);
        this.f45536r = imageReceiver;
        ImageReceiver imageReceiver2 = new ImageReceiver(this);
        this.f45537s = imageReceiver2;
        this.E = 1.0f;
        this.O = new RectF();
        new Path();
    ...
    public final void a(Canvas canvas) {
        ...
        canvas.drawRoundRect(rectF, f12, f12, this.f45534f);
        boolean z10 = this.f45535n;
        float f13 = this.f45540y;
        RectF rectF2 = this.d;
        if (z10) {
            ...
            if (e7 > 0.0f) {
                ...
                ImageReceiver imageReceiver = this.f45537s;
            ...
            if (e7 < 1.0f) {
                ...
                ImageReceiver imageReceiver2 = this.f45536r;
        ...
        if (isEmpty) {
            ...
            MediaDataController.getInstance(i10).getStickerSet(tL_inputStickerSetShortName, 0, false, new Utilities.Callback(this) {
                ...
                public final void run(Object obj) {
                    switch (r3) {
                        case 0:
                            u0 u0Var = this.f45517b;
                            u0Var.getClass();
                            String str2 = str;
                            TLRPC.Document b10 = u0.b(str2, (TLRPC.TL_messages_stickerSet) obj);
                            u0Var.v = b10;
                            u0Var.f45536r.setImage(ImageLocation.getForDocument(b10), "80_80", u0.c(str2), null, null, 0);
                            u0Var.f45537s.setImage(ImageLocation.getForDocument(u0Var.f45538w), "80_80", ImageLocation.getForDocument(u0Var.v), "80_80", null, null, u0.c(str2), 0L, null, null, 0);
                            return;
                        default:
                            u0 u0Var2 = this.f45517b;
                            u0Var2.getClass();
                            String str3 = str;
                            TLRPC.Document b11 = u0.b(str3, (TLRPC.TL_messages_stickerSet) obj);
                            u0Var2.f45538w = b11;
                            if (b11 != null) {
                                u0Var2.f45537s.setImage(ImageLocation.getForDocument(b11), "80_80", ImageLocation.getForDocument(u0Var2.v), "80_80", null, null, u0.c(str3), 0L, null, null, 0);
                                return;
                            }
                            return;
                    }
            ...
            imageReceiver.setImage(ImageLocation.getForDocument(this.f45538w), "80_80", ImageLocation.getForDocument(this.v), "80_80", null, null, c(str), 0L, null, null, 0);
        }
        this.f45532c = true;
        requestLayout();
    }
    ...
    public final void e(int i10, int i11) {
        int i12 = -16777216;
        Drawable drawable = this.h;
        TextPaint textPaint = this.f45533e;
        Paint paint = this.f45534f;
        if (i10 == 0) {
    ...
    public final void f() {
        ...
        if (min < 0.4f) {
            ...
            f10 = 1.0f;
            this.F = new StaticLayout(this.f45531b, textPaint, (int) Math.ceil(measureText), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        }
        this.G = 0.0f;
    ...
    public TLRPC.Document getCodeEmojiDocument() {
        ...
        if (this.L && (document = this.f45538w) != null) {
            return document;
        }
        return this.v;
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.K = true;
        if (this.L) {
            this.f45537s.onAttachedToWindow();
        } else {
            this.f45536r.onAttachedToWindow();
        }
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        this.K = false;
        this.f45536r.onDetachedFromWindow();
        this.f45537s.onDetachedFromWindow();
    }
