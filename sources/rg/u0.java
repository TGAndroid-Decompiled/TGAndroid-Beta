...
public final class u0 extends z4.g {
    public long f42492w0;
    public boolean f42493x0;
    public final t0 f42494y0;
    public final x0 f42495z0;
    ...
    public final boolean A(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            this.f42492w0 = System.currentTimeMillis();
            return true;
        }
        if (motionEvent.getAction() == 1) {
            if (System.currentTimeMillis() - this.f42492w0 <= ViewConfiguration.getTapTimeout() && (t0Var = this.f42494y0) != null && t0Var.isFinished()) {
                this.f42493x0 = true;
                x0 x0Var = this.f42495z0;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(dp + this.f42495z0.L, 1073741824));
    }

    @Override
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (!this.f42495z0.f42543w) {
