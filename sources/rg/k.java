...
public final class k {
    public final TLRPC.TL_premiumGiftOption f42590a;
    public final TLRPC.TL_premiumGiftCodeOption f42591b;
    public final TLRPC.TL_premiumGiftOption f42592c;
    ...
    public k(TLRPC.TL_premiumGiftOption tL_premiumGiftOption) {
        this.f42590a = tL_premiumGiftOption;
        this.f42591b = null;
        this.f42592c = null;
        this.d = null;
    }
    ...
    public final String a() {
        TLRPC.TL_premiumGiftOption tL_premiumGiftOption = this.f42590a;
        if (tL_premiumGiftOption != null) {
            ...
            TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption = this.f42591b;
    ...
    public final int b() {
        if (this.e == 0) {
            ...
            if (this.f42594g != 0) {
                int f7 = (int) ((1.0d - (f() / this.f42594g)) * 100.0d);
                this.e = f7;
                if (f7 == 0) {
                    this.e = -1;
                }
    ...
    public final String c() {
        ...
        if (!BuildVars.useInvoiceBilling() && (((tL_premiumGiftOption = this.f42590a) == null || tL_premiumGiftOption.store_product != null) && ((tL_premiumGiftCodeOption = this.f42591b) == null || tL_premiumGiftCodeOption.store_product != null))) {
            if (this.h == null) {
                return "";
            }
    ...
    public final long g() {
        TLRPC.TL_premiumGiftOption tL_premiumGiftOption = this.f42592c;
        if (tL_premiumGiftOption != null) {
            return tL_premiumGiftOption.amount;
        }
    ...
    public k(TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption, TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption2) {
        this.f42590a = null;
        this.f42591b = tL_premiumGiftCodeOption;
        this.f42592c = null;
