...
public final class n0 extends FrameLayout implements l0 {
    public final f6 f42412a;
    public final ArrayList f42413b;
    public final m0 f42414c;
    public final m0 d;
    public final m0 e;
    ...
    public n0(Context context, f6 f6Var) {
        ...
        for (nb0 nb0Var : nb0.values()) {
            if (nb0Var.e) {
                this.f42413b.add(nb0Var);
            }
            if (this.f42413b.size() == 3) {
                break;
            }
        }
        if (this.f42413b.size() < 3) {
    ...
    public final m0 a(Context context, int i10) {
        nb0 nb0Var = (nb0) this.f42413b.get(i10);
        ...
        u1Var.O = this.f42412a;
        u1Var.P = j6.Zj;
        u1Var.c();
        paint.setColor(-1);
        qVar.setLayoutParams(x5.d(-2, -2.0f, 17, 0.0f, 52.0f, 0.0f, 0.0f));
        qVar.setForeground(nb0Var.f36012c);
        qVar.setBackgroundResource(nb0Var.f36011b);
    ...
    public void setOffset(float f7) {
        ...
        float interpolation = qr.f27382i.getInterpolation(abs);
        int right = getRight();
        m0 m0Var = this.e;
        ...
        float interpolation2 = qr.f27381g.getInterpolation(abs);
        int left = getLeft();
        m0 m0Var3 = this.d;
