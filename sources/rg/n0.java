...
public final class n0 extends LinearLayout {
    public final TextView f45323a;
    public final ah.w f45324b;
    public ImageView f45325c;
    public ImageView d;
    public float f45326e;
    public boolean f45327f;
    public ValueAnimator h;
    public final ImageView f45328n;
    public final o0 f45329r;
    ...
    public n0(o0 o0Var, Context context) {
        ...
        this.f45325c = imageView;
        ImageView.ScaleType scaleType = ImageView.ScaleType.CENTER;
        imageView.setScaleType(scaleType);
        ImageView imageView2 = this.f45325c;
        int i11 = j6.E8;
        imageView2.setColorFilter(j6.v0(i11, aVar));
        wVar.addView(this.f45325c, x5.e(-2, -2, 17));
        ...
        this.f45323a = textView;
        textView.setTextColor(j6.v0(i11, aVar));
        textView.setTextSize(1, 16.0f);
        addView(textView, x5.t(-2, -2, 19, 0, 0, 16, 0));
        ImageView imageView4 = new ImageView(context);
        this.f45328n = imageView4;
        imageView4.setImageResource(R.drawable.msg_text_check);
        imageView4.setScaleType(scaleType);
        imageView4.setColorFilter(new PorterDuffColorFilter(j6.v0(j6.f20737h7, aVar), PorterDuff.Mode.MULTIPLY));
    ...
    public final void a(int i10, boolean z10, boolean z11) {
        ...
        this.f45325c.setImageResource(i10);
    }
    ...
    public void setSelected(boolean z10) {
        ...
        this.f45328n.setVisibility(i10);
    }

    public void setText(CharSequence charSequence) {
        this.f45323a.setText(charSequence);
    }
}
