...
public final class n0 extends FrameLayout implements l0 {
    public final e6 f42390a;
    public final ArrayList f42391b;
    public final m0 f42392c;
    public final m0 d;
    public final m0 e;
    public final boolean f42393f;

    public n0(Context context, e6 e6Var) {
        super(context);
        lb0[] values;
        this.f42391b = new ArrayList();
        this.f42390a = e6Var;
        for (lb0 lb0Var : lb0.values()) {
            if (lb0Var.e) {
                this.f42391b.add(lb0Var);
            }
            if (this.f42391b.size() == 3) {
                break;
            }
        }
        if (this.f42391b.size() < 3) {
    ...
    public final m0 a(Context context, int i10) {
        lb0 lb0Var = (lb0) this.f42391b.get(i10);
        ...
        u1Var.O = this.f42390a;
        u1Var.P = i6.Zj;
        u1Var.c();
        paint.setColor(-1);
        qVar.setLayoutParams(x5.d(-2, -2.0f, 17, 0.0f, 52.0f, 0.0f, 0.0f));
        qVar.setForeground(lb0Var.f35411c);
        qVar.setBackgroundResource(lb0Var.f35410b);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.f42392c.getLayoutParams();
    ...
    public void setOffset(float f7) {
        ...
        float interpolation = qr.f27425i.getInterpolation(abs);
        int right = getRight();
        m0 m0Var = this.e;
        ...
        float interpolation2 = qr.f27424g.getInterpolation(abs);
        int left = getLeft();
        m0 m0Var3 = this.d;
