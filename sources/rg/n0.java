...
public final class n0 extends FrameLayout implements l0 {
    public final d6 f42673a;
    public final ArrayList f42674b;
    public final m0 f42675c;
    public final m0 d;
    public final m0 e;
    ...
    public n0(Context context, d6 d6Var) {
        super(context);
        fb0[] values;
        this.f42674b = new ArrayList();
        this.f42673a = d6Var;
        for (fb0 fb0Var : fb0.values()) {
            if (fb0Var.e) {
                this.f42674b.add(fb0Var);
            }
            if (this.f42674b.size() == 3) {
                break;
            }
        }
        if (this.f42674b.size() < 3) {
    ...
    public final m0 a(Context context, int i10) {
        fb0 fb0Var = (fb0) this.f42674b.get(i10);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.f42675c.getLayoutParams();
    ...
    public void setOffset(float f7) {
        ...
        float interpolation = sr.f28341i.getInterpolation(abs);
        int right = getRight();
        m0 m0Var = this.e;
        ...
        float interpolation2 = sr.f28340g.getInterpolation(abs);
        int left = getLeft();
        m0 m0Var3 = this.d;
