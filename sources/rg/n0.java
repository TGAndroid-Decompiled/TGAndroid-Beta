...
public final class n0 extends FrameLayout implements l0 {
    public final d6 f42660a;
    public final ArrayList f42661b;
    public final m0 f42662c;
    public final m0 d;
    public final m0 e;
    ...
    public n0(Context context, d6 d6Var) {
        ...
        for (fb0 fb0Var : fb0.values()) {
            if (fb0Var.e) {
                this.f42661b.add(fb0Var);
            }
            if (this.f42661b.size() == 3) {
                break;
            }
        }
        if (this.f42661b.size() < 3) {
    ...
    public final m0 a(Context context, int i10) {
        fb0 fb0Var = (fb0) this.f42661b.get(i10);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.f42662c.getLayoutParams();
    ...
    public void setOffset(float f7) {
        ...
        float interpolation = rr.f28024i.getInterpolation(abs);
        int right = getRight();
        m0 m0Var = this.e;
        ...
        float interpolation2 = rr.f28023g.getInterpolation(abs);
        int left = getLeft();
        m0 m0Var3 = this.d;
