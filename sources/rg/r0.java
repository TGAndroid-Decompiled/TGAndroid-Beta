...
public final class r0 extends j {
    public final int f45496n = 2;
    public final Paint f45497r;
    public final Path f45498s;

    public r0(s0 s0Var, Context context) {
        super(s0Var, context);
        Paint paint = new Paint(1);
        this.f45497r = paint;
        this.f45498s = new Path();
        ...
        switch (this.f45496n) {
            case 0:
                ...
                if (showAlpha > 0.0f) {
                    ...
                    canvas.drawPath(path, paint);
                    float f19 = dp + f12;
                    Paint paint2 = this.f45250c;
                    canvas.drawCircle(dp, f19, dpf2, paint2);
                    Paint paint3 = this.f45249b;
            ...
            case 1:
                ...
                if (showAlpha2 > 0.0f) {
                    ...
                    canvas.drawPath(path2, paint5);
                    float f32 = dp3 + f25;
                    Paint paint6 = this.f45250c;
                    canvas.drawCircle(dp3, f32, dpf22, paint6);
                    Paint paint7 = this.f45249b;
            ...
            case 2:
                ...
                if (showAlpha3 > 0.0f) {
                    ...
                    canvas.drawPath(path3, paint9);
                    float f45 = dp5 + f38;
                    Paint paint10 = this.f45250c;
                    canvas.drawCircle(dp5, f45, dpf23, paint10);
                    Paint paint11 = this.f45249b;
            ...
            case 3:
                ...
                if (showAlpha4 > 0.0f) {
                    ...
                    canvas.drawPath(path4, paint13);
                    float f58 = dp7 + f51;
                    Paint paint14 = this.f45250c;
                    canvas.drawCircle(dp7, f58, dpf24, paint14);
                    Paint paint15 = this.f45249b;
            ...
            case 4:
                ...
                if (showAlpha5 > 0.0f) {
                    ...
                    canvas.drawPath(path5, paint17);
                    float f71 = dp9 + f64;
                    Paint paint18 = this.f45250c;
                    canvas.drawCircle(dp9, f71, dpf25, paint18);
                    Paint paint19 = this.f45249b;
            ...
            default:
                ...
                if (showAlpha6 > 0.0f) {
                    ...
                    canvas2.drawPath(path6, paint21);
                    float f84 = dp11 + f77;
                    Paint paint22 = this.f45250c;
                    canvas2.drawCircle(dp11, f84, dpf26, paint22);
                    Paint paint23 = this.f45249b;
