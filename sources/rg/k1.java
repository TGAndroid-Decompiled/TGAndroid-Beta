...
public class k1 extends bb implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final k f42614a0;
    public final TL_stars.StarGift f42615b0;
    public boolean f42616c0;
    public final lw0 f42617d0;
    public int f42618e0;
    public int f42619f0;
    public int f42620g0;
    public int f42621h0;
    ...
    public int m0;
    public int f42626n0;
    public final s00 f42627o0;
    public final z0 f42628p0;
    public ei.f f42629q0;
    public yf0 f42630r0;
    public ub1 f42631s0;
    public final m2 f42632t0;
    public Integer f42633u0;
    public float f42634v0;
    public float f42635w0;
    public float f42636x0;
    public float f42637y0;
    public float f42638z0;
    ...
    public final void G(aw0 aw0Var) {
        ...
        if (!UserConfig.getInstance(this.Y).isPremium() && !(this instanceof tg.j0)) {
            ...
            this.L0.setBackgroundColor(getThemedColor(h6.f19115h5));
    ...
    public void a0(boolean z10) {
        ...
        if (n90VarArr != null && this.P0 != null) {
            ...
            if (tL_emojiStatusCollectible != null) {
                ...
                Integer num = this.f42633u0;
                if (num == null) {
                    intValue6 = getThemedColor(h6.f19358u6);
                } else {
                        ...
                        if (stickerSet.set != null) {
                            ...
                            while (true) {
                                if (i10 >= stickerSet.documents.size()) {
                                    break;
                                } else if (stickerSet.documents.get(i10).f18327id == stickerSet.set.thumb_document_id) {
                ...
                if (kVar != null) {
                    if (this.f42616c0) {
                        ...
                        Integer num2 = this.f42633u0;
                        if (num2 == null) {
                            intValue4 = getThemedColor(h6.f19358u6);
                        } else {
                        ...
                        Integer num3 = this.f42633u0;
                        if (num3 == null) {
                            intValue5 = getThemedColor(h6.f19358u6);
                        } else {
                            intValue5 = num3.intValue();
                        }
                        n90Var2.setText(AndroidUtilities.replaceSingleLink(formatString3, intValue5));
                    } else if (user != null && !TextUtils.isEmpty(user.first_name) && user.f18468id != 777000) {
                        ...
                        Integer num4 = this.f42633u0;
                        if (num4 == null) {
                            intValue3 = getThemedColor(h6.f19358u6);
                        } else {
                        ...
                        Integer num5 = this.f42633u0;
                        if (num5 == null) {
                            intValue2 = getThemedColor(h6.f19358u6);
                        } else {
                    ...
                    TL_stars.StarGift starGift = this.f42615b0;
                    if (starGift != null) {
                        ...
                        Integer num6 = this.f42633u0;
                        if (num6 == null) {
                            intValue = getThemedColor(h6.f19358u6);
                        } else {
    ...
    public void b0() {
        ...
        this.f42625l0 = size;
        if (!UserConfig.getInstance(this.Y).isPremium() && this.f42614a0 == null) {
            int i12 = this.f42619f0;
            this.f42619f0 = i12 + 1;
            this.m0 = i12;
        }
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.groupStickersDidLoad && (inputStickerSet = this.C0) != null && inputStickerSet.f18341id == ((Long) objArr[0]).longValue()) {
            a0(true);
        }
    }
    ...
    public final void mainContainerDispatchDraw(Canvas canvas) {
        ...
        if (this.A0 != null && this.H0) {
            ...
            canvas.save();
            float[] fArr = {this.f42634v0, this.f42635w0};
            ...
            if (view4 instanceof h5) {
                ...
                drawable = ((org.telegram.ui.Cells.u1) view4).f21326fc;
            } else {
                drawable = null;
            }
            if (drawable == null) {
            ...
            int[] iArr = this.F0;
            float f7 = (-iArr[0]) + this.f42636x0 + fArr[0];
            float f10 = (-iArr[1]) + this.f42637y0 + fArr[1];
            if (AndroidUtilities.isTablet()) {
                ViewGroup view5 = this.f42632t0.getParentLayout().getView();
                f7 += view5.getX() + view5.getPaddingLeft();
                f10 += view5.getY() + view5.getPaddingTop();
            }
            float intrinsicWidth = this.f42638z0 * drawable.getIntrinsicWidth();
    ...
    public k1(m2 m2Var, int i10, TLRPC.User user, k kVar, TL_stars.StarGift starGift, d6 d6Var) {
        ...
        this.Y = i10;
        this.f42614a0 = kVar;
        this.f42615b0 = starGift;
        this.f42617d0 = new lw0(getContext(), null);
