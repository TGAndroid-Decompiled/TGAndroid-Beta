...
public class k1 extends za implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final k f42371a0;
    public final TL_stars.StarGift f42372b0;
    public boolean f42373c0;
    public final ww0 f42374d0;
    public int f42375e0;
    public int f42376f0;
    public int f42377g0;
    public int f42378h0;
    ...
    public int m0;
    public int f42383n0;
    public final r00 f42384o0;
    public final z0 f42385p0;
    public ei.f f42386q0;
    public gg0 f42387r0;
    public dc1 f42388s0;
    public final o2 f42389t0;
    public Integer f42390u0;
    public float f42391v0;
    public float f42392w0;
    public float f42393x0;
    public float f42394y0;
    public float f42395z0;
    ...
    public final void G(qv0 qv0Var) {
        ...
        view.setBackgroundColor(getThemedColor(j6.f18864d7));
        ...
        if (!UserConfig.getInstance(this.Y).isPremium() && !(this instanceof tg.k0)) {
            ...
            this.L0.setBackgroundColor(getThemedColor(j6.f18934h5));
    ...
    public void a0(boolean z10) {
        ...
        if (c90VarArr != null && this.P0 != null) {
            ...
            if (tL_emojiStatusCollectible != null) {
                ...
                Integer num = this.f42390u0;
                if (num == null) {
                    intValue6 = getThemedColor(j6.f19175u6);
                } else {
                ...
                if (kVar != null) {
                    if (this.f42373c0) {
                        ...
                        Integer num2 = this.f42390u0;
                        if (num2 == null) {
                            intValue4 = getThemedColor(j6.f19175u6);
                        } else {
                        ...
                        Integer num3 = this.f42390u0;
                        if (num3 == null) {
                            intValue5 = getThemedColor(j6.f19175u6);
                        } else {
                        ...
                        Integer num4 = this.f42390u0;
                        if (num4 == null) {
                            intValue3 = getThemedColor(j6.f19175u6);
                        } else {
                        ...
                        Integer num5 = this.f42390u0;
                        if (num5 == null) {
                            intValue2 = getThemedColor(j6.f19175u6);
                        } else {
                    ...
                    TL_stars.StarGift starGift = this.f42372b0;
                    if (starGift != null) {
                        ...
                        Integer num6 = this.f42390u0;
                        if (num6 == null) {
                            intValue = getThemedColor(j6.f19175u6);
                        } else {
    ...
    public void b0() {
        ...
        this.f42381k0 = size;
        this.f42376f0 = size + 1;
        this.f42382l0 = size;
        if (!UserConfig.getInstance(this.Y).isPremium() && this.f42371a0 == null) {
            int i12 = this.f42376f0;
            this.f42376f0 = i12 + 1;
            this.m0 = i12;
        }
    }
    ...
    public final void mainContainerDispatchDraw(Canvas canvas) {
        ...
        if (this.A0 != null && this.H0) {
            ...
            canvas.save();
            float[] fArr = {this.f42391v0, this.f42392w0};
            ...
            if (view4 instanceof k5) {
                ...
                drawable = ((org.telegram.ui.Cells.t1) view4).f21065fc;
            } else {
                drawable = null;
            }
            if (drawable == null) {
            ...
            int[] iArr = this.F0;
            float f7 = (-iArr[0]) + this.f42393x0 + fArr[0];
            float f10 = (-iArr[1]) + this.f42394y0 + fArr[1];
            if (AndroidUtilities.isTablet()) {
                ViewGroup view5 = this.f42389t0.getParentLayout().getView();
                f7 += view5.getX() + view5.getPaddingLeft();
                f10 += view5.getY() + view5.getPaddingTop();
            }
            float intrinsicWidth = this.f42395z0 * drawable.getIntrinsicWidth();
    ...
    public k1(o2 o2Var, int i10, TLRPC.User user, k kVar, TL_stars.StarGift starGift, f6 f6Var) {
        ...
        this.Y = i10;
        this.f42371a0 = kVar;
        this.f42372b0 = starGift;
        this.f42374d0 = new ww0(getContext(), null);
