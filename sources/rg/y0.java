...
public abstract class y0 extends FrameLayout {
    ...
    public final qg.t1 f45553b;
    public final DispatchQueue f45554c;
    public final MediaController.CropState d;
    public final qg.c1 f45555e;
    public final Bitmap f45556f;
    public final int h;
    public final boolean f45557n;
    public final FrameLayout f45558r;
    public final TextView f45559s;
    public final TextView v;
    public final y1 f45560w;
    public iv0 f45561x;
    ...
    public y0(Context context, int i10, Bitmap bitmap, Bitmap bitmap2, int i11, MediaController.CropState cropState) {
        ...
        this.J = new Rect();
        this.f45552a = i10;
        this.f45557n = context instanceof BubbleActivity;
        qg.t1 t1Var = new qg.t1();
        this.f45553b = t1Var;
        t1Var.f44589a = new Object();
        DispatchQueue dispatchQueue = new DispatchQueue("MaskPaint");
        this.f45554c = dispatchQueue;
        this.d = cropState;
        this.f45556f = bitmap;
        this.h = i11;
    ...
    private iv0 getPaintingSize() {
        float f7;
        float f10;
        iv0 iv0Var = this.f45561x;
        if (iv0Var != null) {
            return iv0Var;
        }
        Bitmap bitmap = this.f45556f;
        ...
        if (floor > f11) {
            iv0Var2.f27272b = f11;
            iv0Var2.f27271a = (float) Math.floor((f11 * f7) / f10);
        }
        this.f45561x = iv0Var2;
        return iv0Var2;
    }

    public final void a(MotionEvent motionEvent) {
        float x10 = motionEvent.getX();
        qg.c1 c1Var = this.f45555e;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        ...
        int i10 = 0;
        if (view == this.f45555e && (cropState = this.d) != null) {
            canvas.save();
            if (!this.f45557n) {
    ...
    public Bitmap getBitmap() {
        Bitmap c10 = this.f45555e.c(false, false);
        int i10 = this.h;
        if (i10 != 0) {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        FrameLayout frameLayout = this.f45558r;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f45555e.measure(View.MeasureSpec.makeMeasureSpec((int) f11, 1073741824), View.MeasureSpec.makeMeasureSpec((int) floor, 1073741824));
        this.H = 1.0f;
        measureChild(this.f45560w, i10, i11);
        measureChild(this.f45558r, i10, i11);
        this.G = false;
