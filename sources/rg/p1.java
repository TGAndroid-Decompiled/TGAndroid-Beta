...
public class p1 extends ViewGroup {
    ...
    public final int v;
    public int f42465w;
    public LinearGradient f42466x;
    public final Paint f42467y;
    ...
    public p1(Context context) {
        ...
        this.f42461f = 12;
        this.h = 8;
        this.f42464s = j6.f18863d6;
        this.v = j6.f18807a7;
        this.f42467y = new Paint();
        this.H = new Matrix();
        np npVar = new np(context, 24, null);
        this.f42458a = npVar;
        npVar.setDrawBackgroundAsArc(10);
        int i13 = j6.f18918g7;
        npVar.b(i13, i13, j6.f18992k7);
        addView(npVar);
    ...
    public final void d() {
        ...
        int w02 = j6.w0(null, this.f42464s, false);
        ...
        this.f42466x = linearGradient;
        this.f42467y.setShader(linearGradient);
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.L) {
            ...
            drawChild(canvas, this.f42458a, getDrawingTime());
            d();
            e();
            RectF rectF = AndroidUtilities.rectTmp;
            TextView textView = this.f42460c;
            ...
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), paint);
            TextView textView3 = this.f42459b;
    ...
    public final void e() {
        ...
        if (i10 >= measuredWidth * 4) {
            this.J = (-this.f42465w) * 2;
        }
        Matrix matrix = this.H;
        matrix.setTranslate(this.J + this.K, 0.0f);
        LinearGradient linearGradient = this.f42466x;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.M) {
            ...
            if (z10) {
                canvas.drawLine(0.0f, getHeight() - 1, textView.getRight(), getHeight() - 1, j6.f18985k0);
            } else {
                canvas.drawLine(textView.getLeft(), getHeight() - 1, getWidth(), getHeight() - 1, j6.f18985k0);
            }
        }
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        TextView textView4 = this.f42463r;
        ...
        TextView textView5 = this.f42459b;
        if (visibility == 8) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f42459b.measure(View.MeasureSpec.makeMeasureSpec((size - npVar.getMeasuredWidth()) - textView.getMeasuredWidth(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(dp, Integer.MIN_VALUE));
        TextView textView2 = this.f42463r;
        int i12 = 0;
        if (textView2.getVisibility() == 0) {
    ...
    public void setCirclePaintProvider(GenericProvider<Void, Paint> genericProvider) {
        this.f42458a.setCirclePaintProvider(genericProvider);
    }
    ...
    public void setEnabled(boolean z10) {
        ...
        this.f42459b.setAlpha(f7);
        if (z10) {
            f10 = 1.0f;
        } else {
            f10 = 0.6f;
        }
        this.f42460c.setAlpha(f10);
        if (z10) {
            f11 = 1.0f;
        }
        this.f42458a.setAlpha(f11);
    }
    ...
    public void setProgressDelegate(op opVar) {
        this.f42458a.setProgressDelegate(opVar);
    }
}
