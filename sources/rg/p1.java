...
public class p1 extends ViewGroup {
    ...
    public final int v;
    public int f42460w;
    public LinearGradient f42461x;
    public final Paint f42462y;
    ...
    public p1(Context context) {
        ...
        this.f42456f = 12;
        this.h = 8;
        this.f42459s = j6.f18862d6;
        this.v = j6.f18806a7;
        this.f42462y = new Paint();
        this.H = new Matrix();
        np npVar = new np(context, 24, null);
        this.f42453a = npVar;
        npVar.setDrawBackgroundAsArc(10);
        int i13 = j6.f18917g7;
        npVar.b(i13, i13, j6.f18991k7);
        addView(npVar);
    ...
    public final void a(org.telegram.ui.nx0 r11, boolean r12) {
        throw new UnsupportedOperationException("Method not decompiled: rg.p1.a(org.telegram.ui.nx0, boolean):void");
    }
    ...
    public final void d() {
        ...
        int w02 = j6.w0(null, this.f42459s, false);
        ...
        this.f42461x = linearGradient;
        this.f42462y.setShader(linearGradient);
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.L) {
            ...
            drawChild(canvas, this.f42453a, getDrawingTime());
            d();
            e();
            RectF rectF = AndroidUtilities.rectTmp;
            TextView textView = this.f42455c;
            ...
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), paint);
            TextView textView3 = this.f42454b;
    ...
    public final void e() {
        ...
        if (i10 >= measuredWidth * 4) {
            this.J = (-this.f42460w) * 2;
        }
        Matrix matrix = this.H;
        matrix.setTranslate(this.J + this.K, 0.0f);
        LinearGradient linearGradient = this.f42461x;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.M) {
            ...
            TextView textView = this.f42454b;
            if (z10) {
                canvas.drawLine(0.0f, getHeight() - 1, textView.getRight(), getHeight() - 1, j6.f18984k0);
            } else {
                canvas.drawLine(textView.getLeft(), getHeight() - 1, getWidth(), getHeight() - 1, j6.f18984k0);
            }
        }
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        TextView textView4 = this.f42458r;
        ...
        TextView textView5 = this.f42454b;
        if (visibility == 8) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f42454b.measure(View.MeasureSpec.makeMeasureSpec((size - npVar.getMeasuredWidth()) - textView.getMeasuredWidth(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(dp, Integer.MIN_VALUE));
        TextView textView2 = this.f42458r;
        int i12 = 0;
        if (textView2.getVisibility() == 0) {
    ...
    public void setCirclePaintProvider(GenericProvider<Void, Paint> genericProvider) {
        this.f42453a.setCirclePaintProvider(genericProvider);
    }
    ...
    public void setEnabled(boolean z10) {
        ...
        this.f42454b.setAlpha(f7);
        if (z10) {
            f10 = 1.0f;
        } else {
            f10 = 0.6f;
        }
        this.f42455c.setAlpha(f10);
        if (z10) {
            f11 = 1.0f;
        }
        this.f42453a.setAlpha(f11);
    }
    ...
    public void setProgressDelegate(op opVar) {
        this.f42453a.setProgressDelegate(opVar);
    }
}
