...
public class p1 extends ViewGroup {
    ...
    public boolean L;
    public boolean M;
    public final np f42685a;
    public final TextView f42686b;
    public final TextView f42687c;
    public final TextView d;
    public final TextView e;
    public final int f42688f;
    public final int h;
    public lx0 f42689n;
    public final TextView f42690r;
    public final int f42691s;
    public final int v;
    public int f42692w;
    public LinearGradient f42693x;
    public final Paint f42694y;
    ...
    public p1(Context context) {
        ...
        this.f42688f = 12;
        this.h = 8;
        this.f42691s = j6.f19062d6;
        this.v = j6.f19006a7;
        this.f42694y = new Paint();
        this.H = new Matrix();
        np npVar = new np(context, 24, null);
        this.f42685a = npVar;
        npVar.setDrawBackgroundAsArc(10);
        int i13 = j6.f19117g7;
        npVar.b(i13, i13, j6.f19191k7);
        addView(npVar);
    ...
    public final void d() {
        ...
        int w02 = j6.w0(null, this.f42691s, false);
        ...
        this.f42693x = linearGradient;
        this.f42694y.setShader(linearGradient);
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.L) {
            ...
            drawChild(canvas, this.f42685a, getDrawingTime());
            d();
            e();
            RectF rectF = AndroidUtilities.rectTmp;
            TextView textView = this.f42687c;
            ...
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), paint);
            TextView textView3 = this.f42686b;
    ...
    public final void e() {
        ...
        if (i10 >= measuredWidth * 4) {
            this.J = (-this.f42692w) * 2;
        }
        Matrix matrix = this.H;
        matrix.setTranslate(this.J + this.K, 0.0f);
        LinearGradient linearGradient = this.f42693x;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.M) {
            ...
            TextView textView = this.f42686b;
            if (z10) {
                canvas.drawLine(0.0f, getHeight() - 1, textView.getRight(), getHeight() - 1, j6.f19184k0);
            } else {
                canvas.drawLine(textView.getLeft(), getHeight() - 1, getWidth(), getHeight() - 1, j6.f19184k0);
            }
        }
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        TextView textView4 = this.f42690r;
        ...
        TextView textView5 = this.f42686b;
        if (visibility == 8) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f42686b.measure(View.MeasureSpec.makeMeasureSpec((size - npVar.getMeasuredWidth()) - textView.getMeasuredWidth(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(dp, Integer.MIN_VALUE));
        TextView textView2 = this.f42690r;
        int i12 = 0;
        if (textView2.getVisibility() == 0) {
        ...
        int y3 = wh.y(6.0f, measuredWidth - i12, Integer.MIN_VALUE);
    ...
    public void setCirclePaintProvider(GenericProvider<Void, Paint> genericProvider) {
        this.f42685a.setCirclePaintProvider(genericProvider);
    }
    ...
    public void setEnabled(boolean z10) {
        ...
        this.f42686b.setAlpha(f7);
        if (z10) {
            f10 = 1.0f;
        } else {
            f10 = 0.6f;
        }
        this.f42687c.setAlpha(f10);
        if (z10) {
            f11 = 1.0f;
        }
        this.f42685a.setAlpha(f11);
    }
    ...
    public void setProgressDelegate(op opVar) {
        this.f42685a.setProgressDelegate(opVar);
    }
}
