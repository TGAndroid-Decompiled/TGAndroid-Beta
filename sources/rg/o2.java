...
public final class o2 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final int f45377r0 = 0;
    public l2 E;
    public float F;
    public boolean G;
    public l2[] H;
    ...
    public m2 W;
    public int f45378a;
    public final f6 f45379a0;
    public final e6 f45380b;
    public e2 f45381b0;
    public final e6 f45382c;
    public String f45383c0;
    public final Paint d;
    public di.t0 f45384d0;
    public final Paint f45385e;
    public final Matrix f45386e0;
    public final Paint f45387f;
    public float f45388f0;
    public float f45389g0;
    public final Paint h;
    public final y1 f45390h0;
    public boolean f45391i0;
    public final Matrix f45392j0;
    public Path f45393k0;
    public Path f45394l0;
    public final RectF m0;
    public final PathMeasure f45395n;
    public float f45396n0;
    public float f45397o0;
    public final ArrayList f45398p0;
    public final Rect f45399q0;
    public final Path f45400r;
    public final Path f45401s;
    public final Path v;
    public final Path f45402w;
    public volatile boolean f45403x;
    public volatile boolean f45404y;

    public o2(ContextThemeWrapper contextThemeWrapper, f6 f6Var) {
        super(contextThemeWrapper);
        this.f45378a = -1;
        pr prVar = pr.h;
        this.f45380b = new e6(0.0f, (View) null, 0L, 420L, prVar);
        this.f45382c = new e6(0.0f, (View) null, 0L, 420L, prVar);
        ...
        this.h = paint4;
        this.f45395n = new PathMeasure();
        this.f45400r = new Path();
        this.f45401s = new Path();
        this.v = new Path();
        this.f45402w = new Path();
        this.F = 2.0f;
        this.f45386e0 = new Matrix();
        this.f45392j0 = new Matrix();
        this.m0 = new RectF();
        this.f45398p0 = new ArrayList();
        this.f45399q0 = new Rect();
        this.f45379a0 = f6Var;
        paint.setColor(-1);
    ...
    public final void a() {
        ...
        if (m2Var != null) {
            ...
            m2Var.f45314o = true;
            if (m2Var.f45312m != null) {
                h();
                m2Var.f45312m.run(m2Var.f45303b, m2Var.f45305e.document);
                AndroidUtilities.runOnUIThread(new q31(13), 250L);
            } else if (m2Var.f45310k != null) {
                TLRPC.TL_stickers_replaceSticker tL_stickers_replaceSticker = new TLRPC.TL_stickers_replaceSticker();
                tL_stickers_replaceSticker.sticker = MediaDataController.getInputStickerSetItem(m2Var.f45310k, m2Var.f45304c).document;
                tL_stickers_replaceSticker.new_sticker = m2Var.f45305e;
                ConnectionsManager.getInstance(i10).sendRequest(tL_stickers_replaceSticker, new RequestDelegate(this) {
                    public final o2 f45201b;
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r6) {
                                            case 0:
                                                        ...
                                                        public final void run() {
                                                            ...
                                                            switch (i13) {
                                                                case 0:
                                                                    ...
                                                                    TLRPC.Document document = m2Var4.f45306f.document;
                                                                    String str = m2Var4.f45311l;
                                                                    Boolean bool = Boolean.FALSE;
                                                                    notificationCenter.postNotificationNameOnUIThread(i14, bool, tLObject3, document, str, bool);
                                                                    o2Var3.h();
                                                                    return;
                                                                case 1:
                                                                    NotificationCenter.getInstance(UserConfig.selectedAccount).postNotificationNameOnUIThread(NotificationCenter.customStickerCreated, Boolean.FALSE, tLObject3, m2Var4.f45306f.document, m2Var4.f45311l, Boolean.TRUE);
                                                                    o2Var3.h();
                                                                    return;
                                                                default:
                                                                    ...
                                                                    TLRPC.Document document2 = m2Var4.f45306f.document;
                                                                    String str2 = m2Var4.f45311l;
                                                ...
                                                Utilities.Callback callback = m2Var3.f45313n;
                                                if (callback != null) {
                                            ...
                                            case 1:
                                                        ...
                                                        public final void run() {
                                                            ...
                                                            switch (i132) {
                                                                case 0:
                                                                    NotificationCenter notificationCenter = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                    int i14 = NotificationCenter.customStickerCreated;
                                                                    TLRPC.Document document = m2Var42.f45306f.document;
                                                                    String str = m2Var42.f45311l;
                                                                    Boolean bool = Boolean.FALSE;
                                                                    notificationCenter.postNotificationNameOnUIThread(i14, bool, tLObject32, document, str, bool);
                                                                    o2Var32.h();
                                                                    return;
                                                                case 1:
                                                                    NotificationCenter.getInstance(UserConfig.selectedAccount).postNotificationNameOnUIThread(NotificationCenter.customStickerCreated, Boolean.FALSE, tLObject32, m2Var42.f45306f.document, m2Var42.f45311l, Boolean.TRUE);
                                                                    o2Var32.h();
                                                                    return;
                                                                default:
                                                                    NotificationCenter notificationCenter2 = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                    int i15 = NotificationCenter.customStickerCreated;
                                                                    TLRPC.Document document2 = m2Var42.f45306f.document;
                                                                    String str2 = m2Var42.f45311l;
                                                                    Boolean bool2 = Boolean.FALSE;
                                                ...
                                                Utilities.Callback callback2 = m2Var4.f45313n;
                                                if (callback2 != null) {
                                            ...
                                            default:
                                                ...
                                                Utilities.Callback callback3 = m2Var5.f45313n;
                                                if (callback3 != null) {
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r6) {
                                            case 0:
                                                ...
                                                Utilities.Callback callback = m2Var32.f45313n;
                                                if (callback != null) {
                                                    callback.run(Boolean.valueOf(z10));
                                                    m2Var32.f45313n = null;
                                                    return;
                                                }
                                                return;
                                            case 1:
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r6) {
                                            ...
                                            case 1:
                                                        ...
                                                        public final void run() {
                                                            ...
                                                            switch (i1322) {
                                                                case 0:
                                                                    NotificationCenter notificationCenter = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                    int i142 = NotificationCenter.customStickerCreated;
                                                                    TLRPC.Document document = m2Var422.f45306f.document;
                                                                    String str = m2Var422.f45311l;
                                                                    Boolean bool = Boolean.FALSE;
                                                                    notificationCenter.postNotificationNameOnUIThread(i142, bool, tLObject32, document, str, bool);
                                                                    o2Var322.h();
                                                                    return;
                                                                case 1:
                                                                    NotificationCenter.getInstance(UserConfig.selectedAccount).postNotificationNameOnUIThread(NotificationCenter.customStickerCreated, Boolean.FALSE, tLObject32, m2Var422.f45306f.document, m2Var422.f45311l, Boolean.TRUE);
                                                                    o2Var322.h();
                                                                    return;
                                                                default:
                                                                    NotificationCenter notificationCenter2 = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                    int i15 = NotificationCenter.customStickerCreated;
                                                                    TLRPC.Document document2 = m2Var422.f45306f.document;
                                                                    String str2 = m2Var422.f45311l;
                                                                    Boolean bool2 = Boolean.FALSE;
                                                                    notificationCenter2.postNotificationNameOnUIThread(i15, bool2, tLObject32, document2, str2, bool2);
                                                                    o2Var322.h();
                                                                    return;
                                                ...
                                                Utilities.Callback callback2 = m2Var42.f45313n;
                                                if (callback2 != null) {
                                                    callback2.run(Boolean.valueOf(z11));
                                                    m2Var42.f45313n = null;
                                                    return;
                                                }
                                                return;
                                            default:
                ...
                tL_stickers_createStickerSet.stickers.add(m2Var.f45305e);
                ...
                Utilities.Callback callback = m2Var.f45313n;
                if (callback != null) {
                    callback.run(Boolean.TRUE);
                }
            } else if (m2Var.f45308i != 0) {
                SendMessagesHelper.getInstance(i10).sendSticker(m2Var.f45306f.document, null, m2Var.f45308i, null, null, null, null, null, true, 0, 0, false, null, null, 0L, 0L, null);
                di.t0 t0Var = this.f45384d0;
                if (t0Var != null) {
                    t0Var.setProgress(1.0f);
                }
                AndroidUtilities.runOnUIThread(new f(this, i10, 2), 450L);
                Utilities.Callback callback2 = m2Var.f45313n;
                if (callback2 != null) {
                    callback2.run(Boolean.TRUE);
                    m2Var.f45313n = null;
                }
            } else if (m2Var.f45309j != null) {
                TLRPC.TL_stickers_addStickerToSet tL_stickers_addStickerToSet = new TLRPC.TL_stickers_addStickerToSet();
                tL_stickers_addStickerToSet.stickerset = MediaDataController.getInputStickerSet(m2Var.f45309j);
                tL_stickers_addStickerToSet.sticker = m2Var.f45305e;
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r6) {
                                            case 0:
                                                ...
                                                Utilities.Callback callback3 = m2Var32.f45313n;
                                                if (callback3 != null) {
                                            ...
                                            case 1:
                                                ...
                                                if (z14) {
                                                    ...
                                                    MediaDataController.getInstance(i132).putStickerSet((TLRPC.TL_messages_stickerSet) tLObject3);
                                                    MediaDataController.getInstance(i132).toggleStickerSet(null, tLObject3, 2, null, false, false);
                                                    di.t0 t0Var22 = o2Var32.f45384d0;
                                                    if (t0Var22 != null) {
                                                ...
                                                Utilities.Callback callback22 = m2Var42.f45313n;
                                                if (callback22 != null) {
                                            ...
                                            default:
                                                ...
                                                Utilities.Callback callback32 = m2Var5.f45313n;
                                                if (callback32 != null) {
        ...
        if (this.H != null) {
            ...
            while (true) {
                ...
                if (l2Var != null) {
                    ...
                    Bitmap bitmap3 = l2Var.f45282g;
                    if (bitmap3 != null) {
                        bitmap3.recycle();
                        l2Var.f45282g = null;
                    }
                    Bitmap bitmap4 = l2Var.f45281f;
                    if (bitmap4 != null) {
                        bitmap4.recycle();
                        l2Var.f45281f = null;
                    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.fileUploaded) {
            ...
            m2 m2Var2 = this.W;
            if (m2Var2 != null && str.equalsIgnoreCase(m2Var2.f45303b)) {
                m2 m2Var3 = this.W;
                m2Var3.f45307g = inputFile;
                TLRPC.TL_messages_uploadMedia tL_messages_uploadMedia = new TLRPC.TL_messages_uploadMedia();
                tL_messages_uploadMedia.peer = new TLRPC.TL_inputPeerSelf();
                TLRPC.TL_inputMediaUploadedDocument tL_inputMediaUploadedDocument = new TLRPC.TL_inputMediaUploadedDocument();
                tL_messages_uploadMedia.media = tL_inputMediaUploadedDocument;
                tL_inputMediaUploadedDocument.file = m2Var3.f45307g;
                if (m2Var3.f45318s != null) {
                ...
                tL_documentAttributeSticker.alt = m2Var3.f45304c;
            ...
            m2 m2Var4 = this.W;
            if (m2Var4 != null && str2.equalsIgnoreCase(m2Var4.f45303b)) {
                long longValue = ((Long) objArr[1]).longValue();
                long longValue2 = ((Long) objArr[2]).longValue();
                if (longValue2 > 0) {
                    m2 m2Var5 = this.W;
                    m2Var5.f45320u = Utilities.clamp(((float) longValue) / ((float) longValue2), 1.0f, m2Var5.f45320u);
                    di.t0 t0Var = this.f45384d0;
                    if (t0Var != null) {
            ...
            m2 m2Var6 = this.W;
            if (m2Var6 != null && str3.equalsIgnoreCase(m2Var6.f45303b)) {
                h();
            }
        } else if (i10 == NotificationCenter.filePreparingStarted) {
            m2 m2Var7 = this.W;
            if (m2Var7 != null && objArr[0] == m2Var7.f45317r) {
                FileLoader.getInstance(UserConfig.selectedAccount).uploadFile(this.W.f45303b, false, true, 67108864);
            }
        } else if (i10 == NotificationCenter.fileNewChunkAvailable) {
            m2 m2Var8 = this.W;
            if (m2Var8 != null && objArr[0] == m2Var8.f45317r) {
                String str4 = (String) objArr[1];
                long longValue3 = ((Long) objArr[2]).longValue();
                long longValue4 = ((Long) objArr[3]).longValue();
                Float f7 = (Float) objArr[4];
                float floatValue = f7.floatValue();
                this.W.f45317r.videoEditedInfo.needUpdateProgress = true;
                FileLoader.getInstance(this.f45378a).checkUploadNewDataAvailable(str4, false, Math.max(1L, longValue3), longValue4, f7);
                m2 m2Var9 = this.W;
                m2Var9.f45319t = Math.max(m2Var9.f45319t, floatValue);
                di.t0 t0Var2 = this.f45384d0;
                if (t0Var2 != null) {
                    t0Var2.setProgress(this.W.b());
                }
            }
        } else if (i10 == NotificationCenter.filePreparingFailed && (m2Var = this.W) != null && objArr[0] == m2Var.f45317r) {
            h();
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        canvas.drawPath(this.v, this.f45385e);
        canvas.drawPath(this.f45402w, this.d);
    }
        ...
        if (l2Var != null) {
            ...
            if (l2Var.f45281f != null && this.L) {
                ...
                if (l2Var2.f45279c != 0) {
                    ...
                    l2 l2Var3 = this.E;
                    matrix.postRotate(l2Var3.f45279c, l2Var3.a().getWidth() / 2.0f, this.E.a().getHeight() / 2.0f);
                    l2 l2Var4 = this.E;
                    if ((l2Var4.f45279c / 90) % 2 != 0) {
    ...
    public final void g(Canvas canvas, boolean z10, ViewGroup viewGroup, boolean z11) {
        ...
        float f7;
        Paint paint;
        e6 e6Var = this.f45382c;
        e6Var.f25564a = viewGroup;
        boolean z13 = this.f45391i0;
        if (z13 || e6Var.f25566c > 0.0f) {
            if (viewGroup == null) {
                e7 = 1.0f;
            } else {
                if (z13 && !z11) {
            ...
            if (l2VarArr != null) {
                for (l2 l2Var : l2VarArr) {
                    if (l2Var != null && l2Var == this.E) {
                        if (this.F > 0.0f) {
                            if (l2Var.f45294t.f45393k0 != null) {
                                canvas.save();
                                canvas.clipPath(l2Var.f45294t.f45393k0);
                                if (l2Var.f45294t.I != null) {
                                    if (z10) {
                                        paint = l2Var.f45291q;
                                    } else {
                                        paint = l2Var.f45290p;
                                    ...
                                    canvas.drawPath(l2Var.f45286l, paint);
                                    if (l2Var.f45294t.f45393k0 != null && z10) {
                                        canvas.clipPath(l2Var.f45286l);
                                        paint.setStrokeWidth(AndroidUtilities.dp(f7 * 2.0f));
                                        canvas.drawPath(l2Var.f45294t.f45393k0, paint);
                                    }
                                }
                                canvas.restore();
                                return;
    ...
    public final l2 j(float f7, float f10) {
        ...
        while (true) {
            ...
            if (l2Var != null) {
                ...
                RectF rectF2 = this.H[i10].f45283i;
                float f11 = width;
                float f12 = this.f45388f0;
                float f13 = height;
                float f14 = this.f45389g0;
                rectF.set((rectF2.left / f11) * f12, (rectF2.top / f13) * f14, (rectF2.right / f11) * f12, (rectF2.bottom / f13) * f14);
                this.f45386e0.mapRect(rectF);
    ...
    public final void l() {
        ...
        if (l2VarArr != null) {
            for (l2 l2Var : l2VarArr) {
                if (l2Var != null && (bitmap = l2Var.f45280e) != null) {
                    bitmap.recycle();
                    l2Var.f45280e = null;
                    Bitmap bitmap2 = l2Var.f45282g;
                    if (bitmap2 != null) {
                        bitmap2.recycle();
                        l2Var.f45282g = null;
                    }
    ...
    public final void m(Bitmap bitmap, int i10, int i11, int i12, or0 or0Var) {
        ...
        this.T = i13;
        this.U = i14;
        if (!this.f45404y && !this.f45403x && bitmap != null && Build.VERSION.SDK_INT >= 24) {
            this.I = bitmap;
            this.J = i10;
            this.f45383c0 = null;
            ...
            if (EmuDetector.with(getContext()).detect()) {
                ...
                obj.f45336e = min;
                obj.d = min;
                obj.f45333a = Bitmap.createBitmap(min, min, Bitmap.Config.ARGB_8888);
                new Canvas(obj.f45333a).drawRect(0.0f, 0.0f, obj.d, obj.f45336e, j6.Jl);
                obj.f45334b = (bitmap2.getWidth() - obj.d) / 2;
                obj.f45335c = (bitmap2.getHeight() - obj.f45336e) / 2;
                arrayList.add(obj);
                s4Var.run(arrayList);
                return;
            }
            ...
            if (this.f45383c0 == null) {
                yb.a aVar = yb.a.f49924b;
                n6.l.i(aVar, "options cannot be null");
                synchronized (wb.c.class) {
                    cVar = (wb.c) qb.g.c().a(wb.c.class);
                }
                pa.b bVar = (pa.b) cVar.f48483a.get(yb.a.class);
                n6.l.h(bVar);
                zb.d dVar2 = (zb.d) bVar.get();
                dVar2.getClass();
                fa faVar = dVar2.f51505c;
                ?? obj2 = new Object();
                obj2.f6376c = m7.TYPE_THIN;
                qb.m.f44294a.execute(new com.google.android.gms.internal.cast.p(faVar, new a5.a((com.google.firebase.messaging.n) obj2, 1), o7.ON_DEVICE_IMAGE_LABEL_CREATE, faVar.b(), 7));
                new ImageLabelerImpl((qb.e) dVar2.f51503a.O0(aVar), (Executor) dVar2.f51504b.f44275a.get(), new k6.c("vision.ica", 1L)).g(a10).addOnSuccessListener(new k5(this, 29)).addOnFailureListener(new r9.i(2));
            }
            List<TLRPC.TL_availableReaction> enabledReactionsList = MediaDataController.getInstance(this.f45378a).getEnabledReactionsList();
    ...
    public final void n(TLRPC.TL_error tL_error) {
        if (tL_error != null && !"PACK_TITLE_INVALID".equals(tL_error.text)) {
            new yc((FrameLayout) getParent(), this.f45379a0).t(tL_error.text, null).j();
        }
    }

    public final void o() {
        Path path = this.f45393k0;
        if (path == null) {
            this.f45393k0 = new Path();
        } else {
            path.rewind();
        }
        if (this.f45394l0 == null) {
            this.f45394l0 = new Path();
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(0.0f, 0.0f, 1.0f, 1.0f);
            this.f45394l0.addRoundRect(rectF, rectF.width() * 0.12f, rectF.height() * 0.12f, Path.Direction.CW);
        }
        this.f45393k0.addPath(this.f45394l0, this.f45392j0);
        this.f45393k0.computeBounds(this.m0, true);
    }

    @Override
    public final void onAttachedToWindow() {
        super.onAttachedToWindow();
        NotificationCenter.getInstance(this.f45378a).addObserver(this, NotificationCenter.fileUploaded);
        NotificationCenter.getInstance(this.f45378a).addObserver(this, NotificationCenter.fileUploadProgressChanged);
        NotificationCenter.getInstance(this.f45378a).addObserver(this, NotificationCenter.fileUploadFailed);
        NotificationCenter.getInstance(this.f45378a).addObserver(this, NotificationCenter.filePreparingFailed);
        NotificationCenter.getInstance(this.f45378a).addObserver(this, NotificationCenter.filePreparingStarted);
        NotificationCenter.getInstance(this.f45378a).addObserver(this, NotificationCenter.fileNewChunkAvailable);
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        if (i10 >= 0) {
            ...
            NotificationCenter.getInstance(this.f45378a).removeObserver(this, NotificationCenter.fileUploadProgressChanged);
            NotificationCenter.getInstance(this.f45378a).removeObserver(this, NotificationCenter.fileUploadFailed);
            NotificationCenter.getInstance(this.f45378a).removeObserver(this, NotificationCenter.filePreparingFailed);
            NotificationCenter.getInstance(this.f45378a).removeObserver(this, NotificationCenter.filePreparingStarted);
            NotificationCenter.getInstance(this.f45378a).removeObserver(this, NotificationCenter.fileNewChunkAvailable);
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ArrayList arrayList = this.f45398p0;
            arrayList.clear();
            if (this.f45391i0) {
                Rect rect = this.f45399q0;
                arrayList.add(rect);
    ...
    public final void p(final String str, final VideoEditedInfo videoEditedInfo, final String str2, final CharSequence charSequence, final boolean z10, final long j3, final TLRPC.StickerSet stickerSet, final TLRPC.Document document, final TLRPC.Document document2, final String str3, final Utilities.Callback callback, final Utilities.Callback2 callback2) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            ...
            public final void run() {
                ...
                if (callback3 != null && (m2Var = o2Var.W) != null && m2Var.f45314o) {
                    z11 = false;
                } else {
                    z11 = true;
                }
                if (z11) {
                    ...
                    ?? obj = new Object();
                    obj.f45315p = new ArrayList();
                    obj.f45316q = new ArrayList();
                    obj.f45319t = 0.0f;
                    obj.f45320u = 0.0f;
                    o2Var.W = obj;
                }
                ...
                m2Var3.h = z10;
                m2Var3.f45308i = j3;
                m2Var3.f45309j = stickerSet;
                m2Var3.f45310k = document;
                VideoEditedInfo videoEditedInfo2 = videoEditedInfo;
                m2Var3.f45318s = videoEditedInfo2;
                m2Var3.f45311l = str3;
                m2Var3.f45313n = callback3;
                m2Var3.f45312m = callback2;
                ArrayList arrayList = m2Var3.f45316q;
                if (!TextUtils.isEmpty(str4)) {
                    m2Var3.f45315p.add(new File(m2Var3.f45303b));
                }
                if (!TextUtils.isEmpty(m2Var3.f45302a) && !TextUtils.equals(m2Var3.f45302a, m2Var3.f45303b)) {
                    arrayList.add(new File(m2Var3.f45302a));
                }
                if (!TextUtils.isEmpty(m2Var3.f45311l)) {
                    arrayList.add(new File(m2Var3.f45311l));
                }
                if (!z11) {
                    o2Var.a();
                } else {
                    ...
                    if (document3 != null) {
                        m2 m2Var4 = o2Var.W;
                        m2Var4.f45305e = MediaDataController.getInputStickerSetItem(document3, m2Var4.f45304c);
                        o2Var.W.f45306f = new TLRPC.TL_messageMediaDocument();
                        TLRPC.TL_messageMediaDocument tL_messageMediaDocument = o2Var.W.f45306f;
                        ...
                        m2Var5.f45303b = absolutePath;
                        o2Var.W.f45317r = new MessageObject(UserConfig.selectedAccount, (TLRPC.Message) tL_message, (MessageObject) null, false, false);
                        o2Var.W.f45317r.videoEditedInfo = videoEditedInfo2;
                        MediaController.getInstance().scheduleVideoConvert(o2Var.W.f45317r, false, false, false);
                    } else {
                        FileLoader.getInstance(o2Var.f45378a).uploadFile(str4, false, true, 67108864);
                    }
                }
                if (callback3 == null) {
                    if (o2Var.f45384d0 == null) {
                        o2Var.f45384d0 = new di.t0(o2Var.getContext(), LocaleController.getString(R.string.PreparingSticker));
                    }
                    o2Var.f45384d0.setOnCancelListener(new f2(o2Var, 0));
                    if (o2Var.f45384d0.getParent() == null) {
                        o2Var.addView(o2Var.f45384d0, x5.e(-1, -1, 17));
                    }
                    di.t0 t0Var = o2Var.f45384d0;
                    t0Var.E = true;
                    t0Var.invalidate();
                }
            }
    ...
    public void setCurrentAccount(int i10) {
        ...
        if (i11 != i10) {
            if (i11 >= 0 && isAttachedToWindow()) {
                NotificationCenter.getInstance(this.f45378a).removeObserver(this, NotificationCenter.fileUploaded);
                NotificationCenter.getInstance(this.f45378a).removeObserver(this, NotificationCenter.fileUploadProgressChanged);
                NotificationCenter.getInstance(this.f45378a).removeObserver(this, NotificationCenter.fileUploadFailed);
                NotificationCenter.getInstance(this.f45378a).removeObserver(this, NotificationCenter.filePreparingFailed);
                NotificationCenter.getInstance(this.f45378a).removeObserver(this, NotificationCenter.filePreparingStarted);
    ...
    public void setOutlineVisible(boolean z10) {
        float f7;
        if (this.f45391i0 != z10) {
            this.f45391i0 = z10;
            ViewPropertyAnimator animate = this.f45390h0.animate();
            float f10 = 0.0f;
            if (z10) {
                f7 = 1.0f;
            } else {
