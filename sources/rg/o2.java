...
public final class o2 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final int f45376r0 = 0;
    public l2 E;
    public float F;
    public boolean G;
    public l2[] H;
    ...
    public m2 W;
    public int f45377a;
    public final f6 f45378a0;
    public final e6 f45379b;
    public e2 f45380b0;
    public final e6 f45381c;
    public String f45382c0;
    public final Paint d;
    public di.t0 f45383d0;
    public final Paint f45384e;
    public final Matrix f45385e0;
    public final Paint f45386f;
    public float f45387f0;
    public float f45388g0;
    public final Paint h;
    public final y1 f45389h0;
    public boolean f45390i0;
    public final Matrix f45391j0;
    public Path f45392k0;
    public Path f45393l0;
    public final RectF m0;
    public final PathMeasure f45394n;
    public float f45395n0;
    public float f45396o0;
    public final ArrayList f45397p0;
    public final Rect f45398q0;
    public final Path f45399r;
    public final Path f45400s;
    public final Path v;
    public final Path f45401w;
    public volatile boolean f45402x;
    public volatile boolean f45403y;

    public o2(ContextThemeWrapper contextThemeWrapper, f6 f6Var) {
        super(contextThemeWrapper);
        this.f45377a = -1;
        pr prVar = pr.h;
        this.f45379b = new e6(0.0f, (View) null, 0L, 420L, prVar);
        this.f45381c = new e6(0.0f, (View) null, 0L, 420L, prVar);
        ...
        this.h = paint4;
        this.f45394n = new PathMeasure();
        this.f45399r = new Path();
        this.f45400s = new Path();
        this.v = new Path();
        this.f45401w = new Path();
        this.F = 2.0f;
        this.f45385e0 = new Matrix();
        this.f45391j0 = new Matrix();
        this.m0 = new RectF();
        this.f45397p0 = new ArrayList();
        this.f45398q0 = new Rect();
        this.f45378a0 = f6Var;
        paint.setColor(-1);
    ...
    public final void a() {
        ...
        if (m2Var != null) {
            ...
            m2Var.f45313o = true;
            if (m2Var.f45311m != null) {
                h();
                m2Var.f45311m.run(m2Var.f45302b, m2Var.f45304e.document);
                AndroidUtilities.runOnUIThread(new q31(13), 250L);
            } else if (m2Var.f45309k != null) {
                TLRPC.TL_stickers_replaceSticker tL_stickers_replaceSticker = new TLRPC.TL_stickers_replaceSticker();
                tL_stickers_replaceSticker.sticker = MediaDataController.getInputStickerSetItem(m2Var.f45309k, m2Var.f45303c).document;
                tL_stickers_replaceSticker.new_sticker = m2Var.f45304e;
                ConnectionsManager.getInstance(i10).sendRequest(tL_stickers_replaceSticker, new RequestDelegate(this) {
                    public final o2 f45200b;
                                        ...
                                        switch (r6) {
                                            case 0:
                                                ...
                                                if (z13) {
                                                    ...
                                                    if (!MediaDataController.getInstance(i12).isStickerPackInstalled(tL_messages_stickerSet.set.f19896id)) {
                                                        MediaDataController.getInstance(i12).toggleStickerSet(null, tLObject2, 2, null, false, false);
                                                    }
                                                    di.t0 t0Var = o2Var2.f45383d0;
                                                    if (t0Var != null) {
                                                        ...
                                                        public final void run() {
                                                            ...
                                                            switch (i13) {
                                                                case 0:
                                                                    ...
                                                                    TLRPC.Document document = m2Var4.f45305f.document;
                                                                    String str = m2Var4.f45310l;
                                                                    Boolean bool = Boolean.FALSE;
                                                                    notificationCenter.postNotificationNameOnUIThread(i14, bool, tLObject3, document, str, bool);
                                                                    o2Var3.h();
                                                                    return;
                                                                case 1:
                                                                    NotificationCenter.getInstance(UserConfig.selectedAccount).postNotificationNameOnUIThread(NotificationCenter.customStickerCreated, Boolean.FALSE, tLObject3, m2Var4.f45305f.document, m2Var4.f45310l, Boolean.TRUE);
                                                                    o2Var3.h();
                                                                    return;
                                                                default:
                                                                    ...
                                                                    TLRPC.Document document2 = m2Var4.f45305f.document;
                                                                    String str2 = m2Var4.f45310l;
                                                ...
                                                Utilities.Callback callback = m2Var3.f45312n;
                                                if (callback != null) {
                                            ...
                                            case 1:
                                                        ...
                                                        public final void run() {
                                                            ...
                                                            switch (i132) {
                                                                case 0:
                                                                    NotificationCenter notificationCenter = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                    int i14 = NotificationCenter.customStickerCreated;
                                                                    TLRPC.Document document = m2Var42.f45305f.document;
                                                                    String str = m2Var42.f45310l;
                                                                    Boolean bool = Boolean.FALSE;
                                                                    notificationCenter.postNotificationNameOnUIThread(i14, bool, tLObject32, document, str, bool);
                                                                    o2Var32.h();
                                                                    return;
                                                                case 1:
                                                                    NotificationCenter.getInstance(UserConfig.selectedAccount).postNotificationNameOnUIThread(NotificationCenter.customStickerCreated, Boolean.FALSE, tLObject32, m2Var42.f45305f.document, m2Var42.f45310l, Boolean.TRUE);
                                                                    o2Var32.h();
                                                                    return;
                                                                default:
                                                                    NotificationCenter notificationCenter2 = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                    int i15 = NotificationCenter.customStickerCreated;
                                                                    TLRPC.Document document2 = m2Var42.f45305f.document;
                                                                    String str2 = m2Var42.f45310l;
                                                                    Boolean bool2 = Boolean.FALSE;
                                                ...
                                                Utilities.Callback callback2 = m2Var4.f45312n;
                                                if (callback2 != null) {
                                            ...
                                            default:
                                                ...
                                                if (z15) {
                                                    ...
                                                    if (!MediaDataController.getInstance(i14).isStickerPackInstalled(tL_messages_stickerSet2.set.f19896id)) {
                                                        MediaDataController.getInstance(i14).toggleStickerSet(null, tLObject4, 2, null, false, false);
                                                    }
                                                    di.t0 t0Var3 = o2Var4.f45383d0;
                                                    if (t0Var3 != null) {
                                                ...
                                                Utilities.Callback callback3 = m2Var5.f45312n;
                                                if (callback3 != null) {
                                        ...
                                        switch (r6) {
                                            case 0:
                                                ...
                                                if (z13) {
                                                    ...
                                                    if (!MediaDataController.getInstance(i122).isStickerPackInstalled(tL_messages_stickerSet.set.f19896id)) {
                                                        MediaDataController.getInstance(i122).toggleStickerSet(null, tLObject2, 2, null, false, false);
                                                    }
                                                    di.t0 t0Var = o2Var22.f45383d0;
                                                    if (t0Var != null) {
                                                        t0Var.setProgress(1.0f);
                                                    }
                                                    AndroidUtilities.runOnUIThread(new Runnable() {
                                                ...
                                                Utilities.Callback callback = m2Var32.f45312n;
                                                if (callback != null) {
                                                    callback.run(Boolean.valueOf(z10));
                                                    m2Var32.f45312n = null;
                                                    return;
                                                }
                                                return;
                                            case 1:
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r6) {
                                            ...
                                            case 1:
                                                        ...
                                                        public final void run() {
                                                            ...
                                                            switch (i1322) {
                                                                case 0:
                                                                    NotificationCenter notificationCenter = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                    int i142 = NotificationCenter.customStickerCreated;
                                                                    TLRPC.Document document = m2Var422.f45305f.document;
                                                                    String str = m2Var422.f45310l;
                                                                    Boolean bool = Boolean.FALSE;
                                                                    notificationCenter.postNotificationNameOnUIThread(i142, bool, tLObject32, document, str, bool);
                                                                    o2Var322.h();
                                                                    return;
                                                                case 1:
                                                                    NotificationCenter.getInstance(UserConfig.selectedAccount).postNotificationNameOnUIThread(NotificationCenter.customStickerCreated, Boolean.FALSE, tLObject32, m2Var422.f45305f.document, m2Var422.f45310l, Boolean.TRUE);
                                                                    o2Var322.h();
                                                                    return;
                                                                default:
                                                                    NotificationCenter notificationCenter2 = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                    int i15 = NotificationCenter.customStickerCreated;
                                                                    TLRPC.Document document2 = m2Var422.f45305f.document;
                                                                    String str2 = m2Var422.f45310l;
                                                                    Boolean bool2 = Boolean.FALSE;
                                                                    notificationCenter2.postNotificationNameOnUIThread(i15, bool2, tLObject32, document2, str2, bool2);
                                                                    o2Var322.h();
                                                                    return;
                                                ...
                                                Utilities.Callback callback2 = m2Var42.f45312n;
                                                if (callback2 != null) {
                                                    callback2.run(Boolean.valueOf(z11));
                                                    m2Var42.f45312n = null;
                                                    return;
                                                }
                                                return;
                                            default:
                ...
                tL_stickers_createStickerSet.stickers.add(m2Var.f45304e);
                ...
                Utilities.Callback callback = m2Var.f45312n;
                if (callback != null) {
                    callback.run(Boolean.TRUE);
                }
            } else if (m2Var.f45307i != 0) {
                SendMessagesHelper.getInstance(i10).sendSticker(m2Var.f45305f.document, null, m2Var.f45307i, null, null, null, null, null, true, 0, 0, false, null, null, 0L, 0L, null);
                di.t0 t0Var = this.f45383d0;
                if (t0Var != null) {
                    t0Var.setProgress(1.0f);
                }
                AndroidUtilities.runOnUIThread(new f(this, i10, 2), 450L);
                Utilities.Callback callback2 = m2Var.f45312n;
                if (callback2 != null) {
                    callback2.run(Boolean.TRUE);
                    m2Var.f45312n = null;
                }
            } else if (m2Var.f45308j != null) {
                TLRPC.TL_stickers_addStickerToSet tL_stickers_addStickerToSet = new TLRPC.TL_stickers_addStickerToSet();
                tL_stickers_addStickerToSet.stickerset = MediaDataController.getInputStickerSet(m2Var.f45308j);
                tL_stickers_addStickerToSet.sticker = m2Var.f45304e;
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r6) {
                                            case 0:
                                                ...
                                                Utilities.Callback callback3 = m2Var32.f45312n;
                                                if (callback3 != null) {
                                            ...
                                            case 1:
                                                ...
                                                if (z14) {
                                                    ...
                                                    MediaDataController.getInstance(i132).putStickerSet((TLRPC.TL_messages_stickerSet) tLObject3);
                                                    MediaDataController.getInstance(i132).toggleStickerSet(null, tLObject3, 2, null, false, false);
                                                    di.t0 t0Var22 = o2Var32.f45383d0;
                                                    if (t0Var22 != null) {
                                                ...
                                                Utilities.Callback callback22 = m2Var42.f45312n;
                                                if (callback22 != null) {
                                            ...
                                            default:
                                                ...
                                                Utilities.Callback callback32 = m2Var5.f45312n;
                                                if (callback32 != null) {
        ...
        if (this.H != null) {
            ...
            while (true) {
                ...
                if (l2Var != null) {
                    ...
                    Bitmap bitmap3 = l2Var.f45281g;
                    if (bitmap3 != null) {
                        bitmap3.recycle();
                        l2Var.f45281g = null;
                    }
                    Bitmap bitmap4 = l2Var.f45280f;
                    if (bitmap4 != null) {
                        bitmap4.recycle();
                        l2Var.f45280f = null;
                    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.fileUploaded) {
            ...
            m2 m2Var2 = this.W;
            if (m2Var2 != null && str.equalsIgnoreCase(m2Var2.f45302b)) {
                m2 m2Var3 = this.W;
                m2Var3.f45306g = inputFile;
                TLRPC.TL_messages_uploadMedia tL_messages_uploadMedia = new TLRPC.TL_messages_uploadMedia();
                tL_messages_uploadMedia.peer = new TLRPC.TL_inputPeerSelf();
                TLRPC.TL_inputMediaUploadedDocument tL_inputMediaUploadedDocument = new TLRPC.TL_inputMediaUploadedDocument();
                tL_messages_uploadMedia.media = tL_inputMediaUploadedDocument;
                tL_inputMediaUploadedDocument.file = m2Var3.f45306g;
                if (m2Var3.f45317s != null) {
                ...
                tL_documentAttributeSticker.alt = m2Var3.f45303c;
            ...
            m2 m2Var4 = this.W;
            if (m2Var4 != null && str2.equalsIgnoreCase(m2Var4.f45302b)) {
                long longValue = ((Long) objArr[1]).longValue();
                long longValue2 = ((Long) objArr[2]).longValue();
                if (longValue2 > 0) {
                    m2 m2Var5 = this.W;
                    m2Var5.f45319u = Utilities.clamp(((float) longValue) / ((float) longValue2), 1.0f, m2Var5.f45319u);
                    di.t0 t0Var = this.f45383d0;
                    if (t0Var != null) {
            ...
            m2 m2Var6 = this.W;
            if (m2Var6 != null && str3.equalsIgnoreCase(m2Var6.f45302b)) {
                h();
            }
        } else if (i10 == NotificationCenter.filePreparingStarted) {
            m2 m2Var7 = this.W;
            if (m2Var7 != null && objArr[0] == m2Var7.f45316r) {
                FileLoader.getInstance(UserConfig.selectedAccount).uploadFile(this.W.f45302b, false, true, 67108864);
            }
        } else if (i10 == NotificationCenter.fileNewChunkAvailable) {
            m2 m2Var8 = this.W;
            if (m2Var8 != null && objArr[0] == m2Var8.f45316r) {
                String str4 = (String) objArr[1];
                long longValue3 = ((Long) objArr[2]).longValue();
                long longValue4 = ((Long) objArr[3]).longValue();
                Float f7 = (Float) objArr[4];
                float floatValue = f7.floatValue();
                this.W.f45316r.videoEditedInfo.needUpdateProgress = true;
                FileLoader.getInstance(this.f45377a).checkUploadNewDataAvailable(str4, false, Math.max(1L, longValue3), longValue4, f7);
                m2 m2Var9 = this.W;
                m2Var9.f45318t = Math.max(m2Var9.f45318t, floatValue);
                di.t0 t0Var2 = this.f45383d0;
                if (t0Var2 != null) {
                    t0Var2.setProgress(this.W.b());
                }
            }
        } else if (i10 == NotificationCenter.filePreparingFailed && (m2Var = this.W) != null && objArr[0] == m2Var.f45316r) {
            h();
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        canvas.drawPath(this.v, this.f45384e);
        canvas.drawPath(this.f45401w, this.d);
    }
        ...
        if (l2Var != null) {
            ...
            if (l2Var.f45280f != null && this.L) {
                ...
                if (l2Var2.f45278c != 0) {
                    ...
                    l2 l2Var3 = this.E;
                    matrix.postRotate(l2Var3.f45278c, l2Var3.a().getWidth() / 2.0f, this.E.a().getHeight() / 2.0f);
                    l2 l2Var4 = this.E;
                    if ((l2Var4.f45278c / 90) % 2 != 0) {
    ...
    public final void g(Canvas canvas, boolean z10, ViewGroup viewGroup, boolean z11) {
        ...
        float f7;
        Paint paint;
        e6 e6Var = this.f45381c;
        e6Var.f25563a = viewGroup;
        boolean z13 = this.f45390i0;
        if (z13 || e6Var.f25565c > 0.0f) {
            if (viewGroup == null) {
                e7 = 1.0f;
            } else {
                if (z13 && !z11) {
            ...
            if (l2VarArr != null) {
                for (l2 l2Var : l2VarArr) {
                    if (l2Var != null && l2Var == this.E) {
                        if (this.F > 0.0f) {
                            if (l2Var.f45293t.f45392k0 != null) {
                                canvas.save();
                                canvas.clipPath(l2Var.f45293t.f45392k0);
                                if (l2Var.f45293t.I != null) {
                                    if (z10) {
                                        paint = l2Var.f45290q;
                                    } else {
                                        paint = l2Var.f45289p;
                                    ...
                                    canvas.drawPath(l2Var.f45285l, paint);
                                    if (l2Var.f45293t.f45392k0 != null && z10) {
                                        canvas.clipPath(l2Var.f45285l);
                                        paint.setStrokeWidth(AndroidUtilities.dp(f7 * 2.0f));
                                        canvas.drawPath(l2Var.f45293t.f45392k0, paint);
                                    }
                                }
                                canvas.restore();
                                return;
    ...
    public final l2 j(float f7, float f10) {
        ...
        while (true) {
            ...
            if (l2Var != null) {
                ...
                RectF rectF2 = this.H[i10].f45282i;
                float f11 = width;
                float f12 = this.f45387f0;
                float f13 = height;
                float f14 = this.f45388g0;
                rectF.set((rectF2.left / f11) * f12, (rectF2.top / f13) * f14, (rectF2.right / f11) * f12, (rectF2.bottom / f13) * f14);
                this.f45385e0.mapRect(rectF);
    ...
    public final void l() {
        ...
        if (l2VarArr != null) {
            for (l2 l2Var : l2VarArr) {
                if (l2Var != null && (bitmap = l2Var.f45279e) != null) {
                    bitmap.recycle();
                    l2Var.f45279e = null;
                    Bitmap bitmap2 = l2Var.f45281g;
                    if (bitmap2 != null) {
                        bitmap2.recycle();
                        l2Var.f45281g = null;
                    }
    ...
    public final void m(Bitmap bitmap, int i10, int i11, int i12, or0 or0Var) {
        ...
        this.T = i13;
        this.U = i14;
        if (!this.f45403y && !this.f45402x && bitmap != null && Build.VERSION.SDK_INT >= 24) {
            this.I = bitmap;
            this.J = i10;
            this.f45382c0 = null;
            ...
            if (EmuDetector.with(getContext()).detect()) {
                ...
                obj.f45335e = min;
                obj.d = min;
                obj.f45332a = Bitmap.createBitmap(min, min, Bitmap.Config.ARGB_8888);
                new Canvas(obj.f45332a).drawRect(0.0f, 0.0f, obj.d, obj.f45335e, j6.Jl);
                obj.f45333b = (bitmap2.getWidth() - obj.d) / 2;
                obj.f45334c = (bitmap2.getHeight() - obj.f45335e) / 2;
                arrayList.add(obj);
                s4Var.run(arrayList);
                return;
            }
            ...
            if (this.f45382c0 == null) {
                yb.a aVar = yb.a.f49923b;
                n6.l.i(aVar, "options cannot be null");
                synchronized (wb.c.class) {
                    cVar = (wb.c) qb.g.c().a(wb.c.class);
                }
                pa.b bVar = (pa.b) cVar.f48482a.get(yb.a.class);
                n6.l.h(bVar);
                zb.d dVar2 = (zb.d) bVar.get();
                dVar2.getClass();
                fa faVar = dVar2.f51504c;
                ?? obj2 = new Object();
                obj2.f6376c = m7.TYPE_THIN;
                qb.m.f44293a.execute(new com.google.android.gms.internal.cast.p(faVar, new a5.a((com.google.firebase.messaging.n) obj2, 1), o7.ON_DEVICE_IMAGE_LABEL_CREATE, faVar.b(), 7));
                new ImageLabelerImpl((qb.e) dVar2.f51502a.O0(aVar), (Executor) dVar2.f51503b.f44274a.get(), new k6.c("vision.ica", 1L)).g(a10).addOnSuccessListener(new k5(this, 29)).addOnFailureListener(new r9.i(2));
            }
            List<TLRPC.TL_availableReaction> enabledReactionsList = MediaDataController.getInstance(this.f45377a).getEnabledReactionsList();
    ...
    public final void n(TLRPC.TL_error tL_error) {
        if (tL_error != null && !"PACK_TITLE_INVALID".equals(tL_error.text)) {
            new yc((FrameLayout) getParent(), this.f45378a0).t(tL_error.text, null).j();
        }
    }

    public final void o() {
        Path path = this.f45392k0;
        if (path == null) {
            this.f45392k0 = new Path();
        } else {
            path.rewind();
        }
        if (this.f45393l0 == null) {
            this.f45393l0 = new Path();
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(0.0f, 0.0f, 1.0f, 1.0f);
            this.f45393l0.addRoundRect(rectF, rectF.width() * 0.12f, rectF.height() * 0.12f, Path.Direction.CW);
        }
        this.f45392k0.addPath(this.f45393l0, this.f45391j0);
        this.f45392k0.computeBounds(this.m0, true);
    }

    @Override
    public final void onAttachedToWindow() {
        super.onAttachedToWindow();
        NotificationCenter.getInstance(this.f45377a).addObserver(this, NotificationCenter.fileUploaded);
        NotificationCenter.getInstance(this.f45377a).addObserver(this, NotificationCenter.fileUploadProgressChanged);
        NotificationCenter.getInstance(this.f45377a).addObserver(this, NotificationCenter.fileUploadFailed);
        NotificationCenter.getInstance(this.f45377a).addObserver(this, NotificationCenter.filePreparingFailed);
        NotificationCenter.getInstance(this.f45377a).addObserver(this, NotificationCenter.filePreparingStarted);
        NotificationCenter.getInstance(this.f45377a).addObserver(this, NotificationCenter.fileNewChunkAvailable);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        int i10 = this.f45377a;
        if (i10 >= 0) {
            NotificationCenter.getInstance(i10).removeObserver(this, NotificationCenter.fileUploaded);
            NotificationCenter.getInstance(this.f45377a).removeObserver(this, NotificationCenter.fileUploadProgressChanged);
            NotificationCenter.getInstance(this.f45377a).removeObserver(this, NotificationCenter.fileUploadFailed);
            NotificationCenter.getInstance(this.f45377a).removeObserver(this, NotificationCenter.filePreparingFailed);
            NotificationCenter.getInstance(this.f45377a).removeObserver(this, NotificationCenter.filePreparingStarted);
            NotificationCenter.getInstance(this.f45377a).removeObserver(this, NotificationCenter.fileNewChunkAvailable);
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ArrayList arrayList = this.f45397p0;
            arrayList.clear();
            if (this.f45390i0) {
                Rect rect = this.f45398q0;
                arrayList.add(rect);
    ...
    public final void p(final String str, final VideoEditedInfo videoEditedInfo, final String str2, final CharSequence charSequence, final boolean z10, final long j3, final TLRPC.StickerSet stickerSet, final TLRPC.Document document, final TLRPC.Document document2, final String str3, final Utilities.Callback callback, final Utilities.Callback2 callback2) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            ...
            public final void run() {
                ...
                if (callback3 != null && (m2Var = o2Var.W) != null && m2Var.f45313o) {
                    z11 = false;
                } else {
                    z11 = true;
                }
                if (z11) {
                    ...
                    ?? obj = new Object();
                    obj.f45314p = new ArrayList();
                    obj.f45315q = new ArrayList();
                    obj.f45318t = 0.0f;
                    obj.f45319u = 0.0f;
                    o2Var.W = obj;
                }
                ...
                m2Var3.h = z10;
                m2Var3.f45307i = j3;
                m2Var3.f45308j = stickerSet;
                m2Var3.f45309k = document;
                VideoEditedInfo videoEditedInfo2 = videoEditedInfo;
                m2Var3.f45317s = videoEditedInfo2;
                m2Var3.f45310l = str3;
                m2Var3.f45312n = callback3;
                m2Var3.f45311m = callback2;
                ArrayList arrayList = m2Var3.f45315q;
                if (!TextUtils.isEmpty(str4)) {
                    m2Var3.f45314p.add(new File(m2Var3.f45302b));
                }
                if (!TextUtils.isEmpty(m2Var3.f45301a) && !TextUtils.equals(m2Var3.f45301a, m2Var3.f45302b)) {
                    arrayList.add(new File(m2Var3.f45301a));
                }
                if (!TextUtils.isEmpty(m2Var3.f45310l)) {
                    arrayList.add(new File(m2Var3.f45310l));
                }
                if (!z11) {
                    o2Var.a();
                } else {
                    ...
                    if (document3 != null) {
                        m2 m2Var4 = o2Var.W;
                        m2Var4.f45304e = MediaDataController.getInputStickerSetItem(document3, m2Var4.f45303c);
                        o2Var.W.f45305f = new TLRPC.TL_messageMediaDocument();
                        TLRPC.TL_messageMediaDocument tL_messageMediaDocument = o2Var.W.f45305f;
                        ...
                        m2Var5.f45302b = absolutePath;
                        o2Var.W.f45316r = new MessageObject(UserConfig.selectedAccount, (TLRPC.Message) tL_message, (MessageObject) null, false, false);
                        o2Var.W.f45316r.videoEditedInfo = videoEditedInfo2;
                        MediaController.getInstance().scheduleVideoConvert(o2Var.W.f45316r, false, false, false);
                    } else {
                        FileLoader.getInstance(o2Var.f45377a).uploadFile(str4, false, true, 67108864);
                    }
                }
                if (callback3 == null) {
                    if (o2Var.f45383d0 == null) {
                        o2Var.f45383d0 = new di.t0(o2Var.getContext(), LocaleController.getString(R.string.PreparingSticker));
                    }
                    o2Var.f45383d0.setOnCancelListener(new f2(o2Var, 0));
                    if (o2Var.f45383d0.getParent() == null) {
                        o2Var.addView(o2Var.f45383d0, x5.e(-1, -1, 17));
                    }
                    di.t0 t0Var = o2Var.f45383d0;
                    t0Var.E = true;
                    t0Var.invalidate();
                }
            }
    ...
    public void setCurrentAccount(int i10) {
        int i11 = this.f45377a;
        if (i11 != i10) {
            if (i11 >= 0 && isAttachedToWindow()) {
                NotificationCenter.getInstance(this.f45377a).removeObserver(this, NotificationCenter.fileUploaded);
                NotificationCenter.getInstance(this.f45377a).removeObserver(this, NotificationCenter.fileUploadProgressChanged);
                NotificationCenter.getInstance(this.f45377a).removeObserver(this, NotificationCenter.fileUploadFailed);
                NotificationCenter.getInstance(this.f45377a).removeObserver(this, NotificationCenter.filePreparingFailed);
                NotificationCenter.getInstance(this.f45377a).removeObserver(this, NotificationCenter.filePreparingStarted);
    ...
    public void setOutlineVisible(boolean z10) {
        float f7;
        if (this.f45390i0 != z10) {
            this.f45390i0 = z10;
            ViewPropertyAnimator animate = this.f45389h0.animate();
            float f10 = 0.0f;
            if (z10) {
                f7 = 1.0f;
            } else {
