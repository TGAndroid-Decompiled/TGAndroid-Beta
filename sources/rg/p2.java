...
public final class p2 implements ImageReceiver.ImageReceiverDelegate, le.d, t0.f, pa.a, org.telegram.ui.ActionBar.a2, al0, vh.a, Continuation, x2.m, yf.m, r0.n, BillingController.ProductDetailsResponseListenerLegacy, i5.e, d5, Utilities.Callback5, wo0 {
    ...
    public void E(int i10, float f7, float f10, le.e eVar) {
        switch (this.f45416a) {
            case 1:
                rh.c.a((rh.c) this.f45417b);
                return;
            default:
                View view = ((y3) this.f45417b).f52874b;
    ...
    public void J(int i10, int i11, boolean z10) {
        zh.e0 e0Var = (zh.e0) this.f45417b;
        if (z10) {
            long j3 = i10;
            if (e0Var.I != j3) {
                e0Var.I = j3;
                e0Var.f51812r.setText(zh.e0.o(j3));
            }
            e0Var.n(true);
        }
    }
    ...
    public void a(int i10) {
        switch (this.f45416a) {
            case 24:
                Utilities.Callback2 callback2 = (Utilities.Callback2) this.f45417b;
                if (i10 == 1) {
            ...
            case 25:
                bi.f0 f0Var = (bi.f0) this.f45417b;
                if (i10 == 1) {
    ...
    public void d(float f7, float f10, int i10, View view) {
        ug.a1.Q((ug.a1) this.f45417b, view);
    }
    ...
    public void g(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        switch (this.f45416a) {
            case 5:
                ((ug.u0) this.f45417b).run();
                return;
            case 6:
                TLRPC.TL_payments_giveawayInfoResults tL_payments_giveawayInfoResults = (TLRPC.TL_payments_giveawayInfoResults) this.f45417b;
                ...
                return;
            case 7:
                ((org.telegram.messenger.t2) this.f45417b).run();
                return;
            case 8:
                ((ug.u0) this.f45417b).run();
                return;
            case 15:
                ...
                return;
            default:
                ((Utilities.Callback) this.f45417b).run(b2Var.g(i10, true, true));
                return;
        }
    }
    ...
    public void h(pa.b bVar) {
        t9.a aVar = (t9.a) this.f45417b;
        if (Log.isLoggable("FirebaseCrashlytics", 3)) {
            Log.d("FirebaseCrashlytics", "Crashlytics native component now available.", null);
        }
        aVar.f46479b.set((t9.a) bVar.get());
    }

    @Override
    public boolean l(t0.j jVar, int i10, Bundle bundle) {
        r0.d dVar;
        m.s sVar = (m.s) this.f45417b;
        int i11 = Build.VERSION.SDK_INT;
        if (i11 >= 25 && (i10 & 1) != 0) {
            try {
                jVar.f46423a.d();
                Parcelable parcelable = (Parcelable) jVar.f46423a.i();
                if (bundle == null) {
                    bundle = new Bundle();
                } else {
    ...
    public void onProductDetailsResponse(c5.h hVar, List list) {
        int i10;
        yh.p1 p1Var = (yh.p1) this.f45417b;
        ArrayList arrayList = p1Var.f50496n0;
    ...
    public void mo17run(Object obj, Object obj2, Object obj3, Object obj4, Object obj5) {
        switch (this.f45416a) {
            case 23:
                s5.b((s5) this.f45417b, (ArrayList) obj, (Integer) obj2, (Long) obj3, (ArrayList) obj4, (ArrayList) obj5);
                return;
            default:
                s7 s7Var = (s7) this.f45417b;
                h51 h51Var = (h51) obj;
                View view = (View) obj2;
                ...
                if (h51Var.G instanceof TL_stars.StarsTransaction) {
                    v7.h1(s7Var.getContext(), false, 0L, s7Var.f52594c, (TL_stars.StarsTransaction) h51Var.G, s7Var.f52593b);
                    return;
                }
                return;
        }
    ...
    public Object then(Task task) {
        ((CountDownLatch) this.f45417b).countDown();
        return null;
    }
