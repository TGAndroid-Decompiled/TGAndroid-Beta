...
public final class s0 extends k {
    public final q0 f45506q0;
    public int f45507r0;
    public int f45508s0;
    public boolean f45509t0;
    public p0 f45510u0;
    ...
    public int getNextType() {
        int i10 = this.f45508s0 + 1;
        if (i10 == 4) {
            return !this.f45509t0 ? 1 : 0;
        }
        return i10;
    }
    ...
    public float getStickyPaddingBottom() {
        return this.f45506q0.h;
    }

    @Override
    public float getStickyPaddingLeft() {
        return this.f45506q0.f45458f;
    }
    ...
    public void setMaxWidth(int i10) {
        this.f45506q0.setMaxWidth(i10);
    }

    public void setType(int i10) {
        this.f45508s0 = i10;
        this.f45506q0.c(i10, this.f45507r0);
    }
}
