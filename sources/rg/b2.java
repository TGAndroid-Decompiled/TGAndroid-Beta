...
public final class b2 extends j {
    public final int f45138n;
    public RectF f45139r;
        ...
        switch (this.f45138n) {
            ...
            case 1:
                ...
                if (showAlpha2 > 0.0f) {
                    ...
                    Paint paint5 = this.f45222c;
                    canvas.drawCircle(dp2, f12, dpf22, paint5);
                    Paint paint6 = this.f45221b;
            ...
            default:
                ...
                if (showAlpha3 > 0.0f) {
                    ...
                    Paint paint8 = this.f45222c;
                    canvas.drawCircle(dp3, f14, dpf23, paint8);
                    Paint paint9 = this.f45221b;
