...
public final class c1 extends kl0 {
    public final Context f45170c;
    public final ja d;
    public final c7 f45171e;
    ...
    @Override
    public final int h() {
        return this.h.f45220s0.size();
    }

    @Override
    public final int j(int i10) {
        ArrayList arrayList = this.h.f45220s0;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (view instanceof org.telegram.ui.Cells.t1) {
            ...
            MessageObject.GroupedMessages groupedMessages2 = c6Var.f45221t0;
