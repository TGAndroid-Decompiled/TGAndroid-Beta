...
public final class w0 extends LinearLayout {
    public int f42555a;
    public final TextView f42556b;
    public final c90 f42557c;
    public LinearLayout d;
    public final l0 e;
    public final ViewGroup f42558f;
    public boolean h;
    public final x0 f42559n;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (view == this.f42558f) {
            boolean z10 = view instanceof b;
            if (z10) {
                setTranslationY(0.0f);
            } else {
                setTranslationY(this.f42559n.L);
            }
            if (z10) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ViewGroup viewGroup = this.f42558f;
        boolean z10 = viewGroup instanceof b;
        x0 x0Var = this.f42559n;
        if (z10) {
            ((b) viewGroup).setTopOffset(x0Var.L);
        }
        viewGroup.getLayoutParams().height = x0Var.f42569s;
        c90 c90Var = this.f42557c;
