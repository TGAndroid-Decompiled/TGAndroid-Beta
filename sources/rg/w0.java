...
public final class w0 extends LinearLayout {
    public int f42845a;
    public final TextView f42846b;
    public final n90 f42847c;
    public LinearLayout d;
    public final l0 e;
    public final ViewGroup f42848f;
    public boolean h;
    public final x0 f42849n;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (view == this.f42848f) {
            boolean z10 = view instanceof b;
            if (z10) {
                setTranslationY(0.0f);
            } else {
                setTranslationY(this.f42849n.L);
            }
            if (z10) {
    ...
    public final void onMeasure(int i10, int i11) {
        TextView textView = this.f42846b;
        textView.setVisibility(0);
        ViewGroup viewGroup = this.f42848f;
        boolean z10 = viewGroup instanceof b;
        x0 x0Var = this.f42849n;
        if (z10) {
            ((b) viewGroup).setTopOffset(x0Var.L);
        }
        viewGroup.getLayoutParams().height = x0Var.f42861s;
        n90 n90Var = this.f42847c;
