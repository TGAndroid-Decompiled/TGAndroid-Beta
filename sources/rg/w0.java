...
public final class w0 extends LinearLayout {
    ...
    public final n90 f42798c;
    public LinearLayout d;
    public final l0 e;
    public final ViewGroup f42799f;
    public boolean h;
    public final x0 f42800n;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        if (view == this.f42799f) {
            boolean z10 = view instanceof b;
            if (z10) {
                setTranslationY(0.0f);
            } else {
                setTranslationY(this.f42800n.L);
            }
            if (z10) {
    ...
    public final void onMeasure(int i10, int i11) {
        TextView textView = this.f42797b;
        textView.setVisibility(0);
        ViewGroup viewGroup = this.f42799f;
        boolean z10 = viewGroup instanceof b;
        x0 x0Var = this.f42800n;
        if (z10) {
            ((b) viewGroup).setTopOffset(x0Var.L);
        }
        viewGroup.getLayoutParams().height = x0Var.f42812s;
        n90 n90Var = this.f42798c;
