...
public final class g extends FrameLayout {
    public final w9 f42562a;
    public final p20 f42563b;
    ...
    public g(j jVar, Context context) {
        ...
        p20 p20Var = new p20();
        this.f42563b = p20Var;
        int i10 = jVar.f42579f;
        d6 d6Var = jVar.f42522a;
        if (i10 == 0) {
            this.f42564c = AndroidUtilities.dp(150.0f);
            ...
            p20Var.f27233c.setStrokeWidth(AndroidUtilities.dpf2(3.3f));
        } else if (i10 == 1) {
            ...
            int i11 = h6.Mj;
            canvas.drawColor(i0.a.d(0.5f, h6.v0(i11, d6Var), h6.v0(h6.f19115h5, d6Var)));
    ...
    public final void dispatchDraw(Canvas canvas) {
        if (this.d.f42579f == 0) {
            ...
            for (int i10 = 0; i10 < 7; i10++) {
                ...
                float f11 = 5;
                float f12 = f10 + f11;
                canvas.drawArc(AndroidUtilities.rectTmp, f12, ((f10 + f7) - f11) - f12, false, p20Var.f27233c);
            }
        }
