...
public final class g extends FrameLayout {
    ...
    public g(j jVar, Context context) {
        ...
        if (i10 == 0) {
            ...
            p20Var.f27248c.setStyle(Paint.Style.STROKE);
            p20Var.f27248c.setStrokeCap(Paint.Cap.ROUND);
            p20Var.f27248c.setStrokeWidth(AndroidUtilities.dpf2(3.3f));
        } else if (i10 == 1) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        if (this.d.f42594f == 0) {
            ...
            for (int i10 = 0; i10 < 7; i10++) {
                ...
                float f11 = 5;
                float f12 = f10 + f11;
                canvas.drawArc(AndroidUtilities.rectTmp, f12, ((f10 + f7) - f11) - f12, false, p20Var.f27248c);
            }
        }
