...
public final class g extends FrameLayout {
    public final u9 f42314a;
    public final o20 f42315b;
    ...
    public g(j jVar, Context context) {
        ...
        o20 o20Var = new o20();
        this.f42315b = o20Var;
        int i10 = jVar.f42331f;
        f6 f6Var = jVar.f42274a;
        if (i10 == 0) {
            this.f42316c = AndroidUtilities.dp(150.0f);
            ...
            o20Var.f26602c.setStyle(Paint.Style.STROKE);
            o20Var.f26602c.setStrokeCap(Paint.Cap.ROUND);
            o20Var.f26602c.setStrokeWidth(AndroidUtilities.dpf2(3.3f));
        } else if (i10 == 1) {
            ...
            int i11 = j6.Mj;
            canvas.drawColor(i0.a.d(0.5f, j6.v0(i11, f6Var), j6.v0(j6.f18933h5, f6Var)));
    ...
    public final void dispatchDraw(Canvas canvas) {
        if (this.d.f42331f == 0) {
            ...
            for (int i10 = 0; i10 < 7; i10++) {
                ...
                float f11 = 5;
                float f12 = f10 + f11;
                canvas.drawArc(AndroidUtilities.rectTmp, f12, ((f10 + f7) - f11) - f12, false, o20Var.f26602c);
            }
        }
