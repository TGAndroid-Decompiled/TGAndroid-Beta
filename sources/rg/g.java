...
public final class g extends FrameLayout {
    public final u9 f42292a;
    public final o20 f42293b;
    ...
    public g(j jVar, Context context) {
        ...
        o20 o20Var = new o20();
        this.f42293b = o20Var;
        int i10 = jVar.f42309f;
        e6 e6Var = jVar.f42252a;
        if (i10 == 0) {
            this.f42294c = AndroidUtilities.dp(150.0f);
            ...
            o20Var.f26660c.setStrokeWidth(AndroidUtilities.dpf2(3.3f));
        } else if (i10 == 1) {
            ...
            int i11 = i6.Mj;
            canvas.drawColor(i0.a.d(0.5f, i6.v0(i11, e6Var), i6.v0(i6.f18907h5, e6Var)));
    ...
    public final void dispatchDraw(Canvas canvas) {
        if (this.d.f42309f == 0) {
            ...
            for (int i10 = 0; i10 < 7; i10++) {
                ...
                float f11 = 5;
                float f12 = f10 + f11;
                canvas.drawArc(AndroidUtilities.rectTmp, f12, ((f10 + f7) - f11) - f12, false, o20Var.f26660c);
            }
        }
