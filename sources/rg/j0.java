...
public class j0 extends za implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean Y;
    public int Z;
    public long f42337a0;
    public TL_stories.TL_premium_boostsStatus f42338b0;
    public ChannelBoostsController.CanApplyBoost f42339c0;
    public i0 f42340d0;
    public boolean f42341e0;
    public boolean f42342f0;
    public org.telegram.ui.Cells.t1 f42343g0;
    public final int f42344h0;
    public final ArrayList f42345i0;
    public boolean f42346j0;
    public int f42347k0;
    public int f42348l0;
    public int m0;
    public int f42349n0;
    ...
    public int f42354s0;
    public int f42355t0;
    public ArrayList f42356u0;
    public boolean f42357v0;
    public int f42358w0;
    public h0 f42359x0;
    public final HashSet f42360y0;
    public final ArrayList f42361z0;

    public j0(int i10, int i11, Context context, o2 o2Var, f6 f6Var) {
        super(context, o2Var, false, v1(i10), f6Var);
        this.Z = -1;
        this.f42342f0 = false;
        this.f42345i0 = new ArrayList();
        this.f42348l0 = -1;
        this.m0 = -1;
        this.f42349n0 = -1;
        this.f42350o0 = -1;
        ...
        this.f42355t0 = -1;
        this.f42358w0 = -1;
        this.f42360y0 = new HashSet();
        this.f42361z0 = new ArrayList();
        ...
        this.R0 = 0;
        this.T0 = -4;
        fixNavigationBar(j6.v0(j6.f18934h5, this.resourcesProvider));
        this.K0 = o2Var;
        ...
        if (i10 == 18 || i10 == 20 || i10 == 24 || i10 == 25 || i10 == 26 || i10 == 29 || i10 == 22 || i10 == 23 || i10 == 21 || i10 == 27 || i10 == 28 || i10 == 30 || i10 == 35 || i10 == 31) {
            ...
            int k10 = i0.a.k(j6.v0(j6.f18863d6, f6Var), 120);
    ...
    public static void R(j0 j0Var, ArrayList arrayList, int i10, TLRPC.TL_messages_inactiveChats tL_messages_inactiveChats) {
        ...
        arrayList2.clear();
        ArrayList arrayList3 = j0Var.f42361z0;
        arrayList3.clear();
        ...
        j0Var.M1();
        if (j0Var.f42348l0 >= 0 && i11 != 0) {
            ((s4.c0) ml0Var.getLayoutManager()).h1(j0Var.f42348l0 + 1, i11);
        }
        if (j0Var.M0 == null) {
            j0Var.M0 = u1(j0Var.f42344h0, j0Var.currentAccount);
        }
    ...
    public static void S(j0 j0Var) {
        ...
        if (j0Var.f42346j0) {
            ...
            if (canApplyBoost.canApply) {
                j0Var.E0.f42453r.callOnClick();
                ChannelBoostsController.CanApplyBoost canApplyBoost2 = j0Var.f42339c0;
                ...
                return;
            } else if (canApplyBoost.alreadyActive && tg.t.i() && !j0Var.f42339c0.isMaxLvl) {
                tg.k.i(j0Var.f42337a0, j0Var);
                return;
            } else {
                j0Var.dismiss();
                return;
        ...
        if (i10 != 11 && i10 != 34) {
            if (!hashSet.isEmpty()) {
                if (i10 == 2) {
                    ...
                    while (it.hasNext()) {
                        j0Var.f42345i0.add((TLRPC.Chat) it.next());
                    }
                    j0Var.D1(arrayList);
                } else if (i10 == 5) {
                    ...
                    if (textView != null) {
                        textView.setTextColor(j6.v0(j6.f19101q7, j0Var.resourcesProvider));
                    }
                }
            }
        ...
        if (i11 != 11 && i11 != 34) {
            ...
            if (z10 && canApplyBoost.replaceDialogId == 0) {
                if (canApplyBoost.needSelector && tg.t.i()) {
                    j0Var.f42342f0 = true;
                    j0Var.f42359x0.f22120d0 = false;
                    o2 o2Var2 = j0Var.f30454n;
                    ChannelBoostsController.CanApplyBoost canApplyBoost2 = j0Var.f42339c0;
                ...
                paint.setColor(j6.w0(null, j6.f18934h5, false));
                ...
                imageView.setColorFilter(j6.w0(null, j6.f19028m6, false));
                ...
                TLRPC.Chat chat = MessagesController.getInstance(j0Var.currentAccount).getChat(Long.valueOf(-j0Var.f42339c0.replaceDialogId));
                f9Var.k(j0Var.currentAccount, chat);
                u9Var.e(chat, f9Var);
                f9 f9Var2 = new f9((f6) null);
                TLRPC.Chat chat2 = MessagesController.getInstance(j0Var.currentAccount).getChat(Long.valueOf(-j0Var.f42337a0));
    ...
    public static void W(j0 j0Var, View view) {
        ...
        if (view instanceof org.telegram.ui.Cells.n) {
            ...
            nVar.f20463r.a(hashSet.contains(currentChannel), true);
            j0Var.K1();
        } else if (view instanceof f4) {
            if (j0Var.Y || ((i10 = j0Var.f42344h0) != 11 && i10 != 34)) {
                f4 f4Var = (f4) view;
    ...
    public final boolean B1() {
        ...
        int i21;
        int i22;
        NotificationCenter.getInstance(this.currentAccount).postNotificationNameOnUIThread(NotificationCenter.chatWasBoostedByUser, this.f42338b0, this.f42339c0.copy(), Long.valueOf(this.f42337a0));
        ci.d dVar = this.S0;
        if (dVar != null) {
        ...
        TransitionManager.beginDelayedTransition(this.f42340d0, transitionSet);
        i0 i0Var = this.f42340d0;
        tg.b bVar = i0Var.f42334c;
        int indexOfChild = i0Var.indexOfChild(i0Var.f42333b);
        j0 j0Var = i0Var.e;
        if (j0Var.f42341e0) {
            int indexOfChild2 = i0Var.indexOfChild(i0Var.d);
            i0Var.removeView(i0Var.d);
            i0Var.d.removeView(i0Var.f42332a);
            ...
            i0Var.d.addView(i0Var.f42332a, x5.o(-2, -2, 1.0f, 0));
            i0Var.d.addView(bVar, x5.t(-2, -2, 48, 0, 2, 0, 0));
            i0Var.addView(i0Var.d, indexOfChild2, x5.t(-2, -2, 1, 25, 22, 12, 9));
        } else {
            int indexOfChild3 = i0Var.indexOfChild(i0Var.f42332a);
            i0Var.removeView(i0Var.f42332a);
            TextView textView = new TextView(i0Var.getContext());
            i0Var.f42332a = textView;
            textView.setTypeface(AndroidUtilities.bold());
            i0Var.f42332a.setTextSize(1, 20.0f);
            i0Var.f42332a.setTextColor(j6.v0(j6.G6, j0Var.resourcesProvider));
            i0Var.f42332a.setGravity(17);
            i0Var.addView(i0Var.f42332a, indexOfChild3, x5.t(-2, -2, 1, 0, 22, 0, 0));
        }
        i0Var.removeView(i0Var.f42333b);
        TextView textView2 = new TextView(i0Var.getContext());
        i0Var.f42333b = textView2;
        textView2.setTextSize(1, 14.0f);
        TextView textView3 = i0Var.f42333b;
        textView3.setLineSpacing(textView3.getLineSpacingExtra(), i0Var.f42333b.getLineSpacingMultiplier() * 1.1f);
        i0Var.f42333b.setGravity(1);
        i0Var.f42333b.setTextColor(j6.v0(j6.G6, j0Var.resourcesProvider));
        i0Var.addView(i0Var.f42333b, indexOfChild, x5.t(-2, -2, 1, 24, -2, 24, 17));
        this.f42340d0.f42332a.setText(r1());
        TextView textView4 = this.f42340d0.f42333b;
        MessagesController messagesController = MessagesController.getInstance(this.currentAccount);
        boolean x12 = x1();
        int i23 = this.f42344h0;
        if (i23 == 20) {
            if (x12) {
        ...
        this.f42340d0.f42334c.a(this.f42339c0.boostCount, true);
        this.d.y0(0);
        if (i23 == 32) {
            this.f42340d0.f42334c.setVisibility(8);
        }
        return true;
    }
    ...
    public final void D1(ArrayList arrayList) {
        ...
        TextView textView = (TextView) c2Var.d(-1);
        if (textView != null) {
            textView.setTextColor(j6.v0(j6.f19101q7, this.resourcesProvider));
        }
    }
    ...
    public final void F1(TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus, boolean z10) {
        this.f42338b0 = tL_premium_boostsStatus;
        this.f42341e0 = z10;
        M1();
    }
    ...
    public final void G(qv0 qv0Var) {
        ...
        if (!this.f30455r && (i10 = this.f42344h0) != 18 && i10 != 20 && i10 != 24 && i10 != 25 && i10 != 26 && i10 != 29 && i10 != 22 && i10 != 23 && i10 != 21 && i10 != 27 && i10 != 28 && i10 != 30 && i10 != 35) {
            u50 u50Var = new u50(this, context, 11);
            this.L0 = u50Var;
            u50Var.setBackgroundColor(j6.v0(j6.f18934h5, this.resourcesProvider));
        ...
        this.E0.f42453r.setOnClickListener(new xy0(16, this, context));
    ...
    public final void J1() {
        ...
        int i15;
        int i16;
        this.f42356u0 = new ArrayList();
        TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus = this.f42338b0;
        ...
        while (i10 <= i17) {
            ...
            if (arrayList != null && arrayList.size() == arrayList2.size()) {
                for (int i22 = 0; i22 < arrayList.size(); i22++) {
                    ...
                    int i23 = e0Var.e;
                    if (e0Var2 != null && ((e0Var.f42308f && i23 > 2) || (e0Var.f42305a == e0Var2.f42305a && e0Var.f42306b == e0Var2.f42306b && TextUtils.equals(e0Var.f42307c, e0Var2.f42307c) && TextUtils.equals(e0Var.d, e0Var2.d) && i23 == e0Var2.e))) {
                    }
                }
                i10++;
            }
            ArrayList arrayList3 = this.f42356u0;
            arrayList3.add(new d0(i10, arrayList3.isEmpty()));
            this.f42356u0.addAll(arrayList2);
            arrayList = arrayList2;
            i10++;
        }
    }
    ...
    public final void K1() {
        ...
        if (i11 != 19 && i11 != 32 && !y1()) {
            ...
            wq wqVar3 = this.E0.G;
            wqVar3.f29728a.c(hashSet.size(), true);
            this.E0.invalidate();
            return;
        }
        ChannelBoostsController.CanApplyBoost canApplyBoost = this.f42339c0;
        boolean z10 = canApplyBoost.canApply;
    ...
    public final void L1() {
        ...
        if (i12 != 19 && i12 != 32 && !y1()) {
            if (i12 != 18 && i12 != 20 && i12 != 24 && i12 != 25 && i12 != 26 && i12 != 29 && i12 != 22 && i12 != 23 && i12 != 21 && i12 != 27 && i12 != 28 && i12 != 30 && i12 != 35) {
                if (!UserConfig.getInstance(this.currentAccount).isPremium() && !MessagesController.getInstance(this.currentAccount).premiumFeaturesBlocked() && !this.N0) {
                    ...
                    if (oVar != null) {
                        ...
                        z zVar = this.E0;
                        zVar.f42455w.f28954p = null;
                        zVar.f42457y.setVisibility(8);
                        return;
                    }
                    z zVar2 = this.E0;
                    zVar2.f42455w.f28954p = null;
                    zVar2.f42457y.setVisibility(8);
                    return;
                }
                this.E0.d.setText(LocaleController.getString(R.string.OK));
                z zVar3 = this.E0;
                zVar3.f42455w.f28954p = null;
                zVar3.f42457y.setVisibility(8);
                return;
            }
            ...
            ChannelBoostsController.CanApplyBoost canApplyBoost2 = this.f42339c0;
    ...
    public final void M1() {
        ...
        if (i10 != 19 && i10 != 18 && i10 != 20 && i10 != 24 && i10 != 27 && i10 != 28 && i10 != 22 && i10 != 23 && i10 != 25 && i10 != 26 && i10 != 29 && i10 != 21 && i10 != 30 && i10 != 35) {
            if (i10 != 31 && i10 != 32) {
                if (!v1(i10)) {
                    ...
                    if (this.I0) {
                        ...
                        if (i10 != 11 || MessagesController.getInstance(this.currentAccount).premiumFeaturesBlocked() || ((((arrayList = this.D0) == null || arrayList.isEmpty()) && ((arrayList2 = this.C0) == null || arrayList2.size() < this.B0.size())) || (arrayList3 = this.D0) == null || arrayList3.size() != 1 || (arrayList4 = this.C0) == null || arrayList4.size() != 1 || !this.Y)) {
                            int i13 = this.f42347k0;
                            this.f42350o0 = i13;
                            if (i10 != 11 && i10 != 34) {
                                if (i10 == 5) {
                                    this.f42347k0 = this.f42361z0.size() + i13;
                                } else {
                                    this.f42347k0 = this.f42345i0.size() + i13;
                                }
                            } else {
                                this.f42347k0 = this.B0.size() + i13;
                            }
                            this.f42351p0 = this.f42347k0;
                        }
                        if (this.f42351p0 - this.f42350o0 > 1) {
                            int i14 = this.f42347k0;
                            this.f42347k0 = i14 + 1;
                            this.f42353r0 = i14;
                        }
                    }
                ...
                this.v = 0.24f;
                J1();
                int i15 = this.f42347k0;
                this.f42350o0 = i15;
                int i16 = i15 + 1;
                this.f42347k0 = i16;
                this.f42355t0 = i15;
                int size = (this.f42356u0.size() - 1) + i16;
                this.f42347k0 = size;
                this.f42351p0 = size;
            }
        } else {
            if (i10 != 19 || ChatObject.hasAdminRights(s1())) {
                this.v = 0.24f;
                int i17 = this.f42347k0;
                this.f42347k0 = i17 + 1;
                this.Z = i17;
                if (MessagesController.getInstance(this.currentAccount).giveawayGiftsPurchaseAvailable) {
                    int i18 = this.f42347k0;
                    this.f42347k0 = i18 + 1;
                    this.f42354s0 = i18;
                }
            }
            J1();
            int i19 = this.f42347k0;
            int i20 = i19 + 1;
            this.f42347k0 = i20;
            this.f42355t0 = i19;
            this.f42347k0 = (this.f42356u0.size() - 1) + i20;
        }
        this.d.getAdapter().l();
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.boostByChannelCreated) {
            ...
            if (tL_premium_boostsStatus != null && this.f42339c0 != null) {
                this.f42338b0.boosts += intValue;
                if (this.f42344h0 == 32 && (t12 = t1()) != null) {
                    t12.boosts_applied += intValue;
                }
                z1();
                F1(tL_premium_boostsStatus, this.f42341e0);
                ChannelBoostsController.CanApplyBoost canApplyBoost = this.f42339c0;
                if (this.f42338b0.next_level_boosts <= 0) {
                    z10 = true;
                } else {
                    z10 = false;
                }
    ...
    public final void m1(final f90 f90Var, boolean z10) {
        ...
        MessagesController.getInstance(this.currentAccount).getBoostsController().applyBoost(this.f42337a0, this.f42339c0.slot, new Utilities.Callback(this) {
            public final j0 f42575b;
            ...
            public final void run(Object obj) {
                switch (r3) {
                    case 0:
                        MessagesController.getInstance(r1.currentAccount).getBoostsController().getBoostsStats(r1.f42337a0, new s7(this.f42575b, f90Var, (TL_stories.TL_premium_myBoosts) obj, 2));
                        return;
                    default:
                        ...
                        if (startsWith) {
                            ...
                            if (intValue <= 5) {
                                AndroidUtilities.runOnUIThread(new p2.b(13, this.f42575b, f90Var2), intValue * 1000);
                                return;
                            }
                            tg.k.g(intValue);
                        }
    ...
    public final String p1() {
        ...
        if (tL_premium_boostsStatus != null && !TextUtils.isEmpty(tL_premium_boostsStatus.boost_url)) {
            return this.f42338b0.boost_url;
        }
        int i10 = this.currentAccount;
        long j3 = -this.f42337a0;
    ...
    public final String q1(boolean z10) {
        ...
        TLRPC.Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-this.f42337a0));
        if (chat == null) {
            if (x1()) {
        ...
        if (y1() && this.f42338b0.next_level_boosts != 0 && z10) {
            if (x1()) {
                i18 = R.string.GroupNeedBoostsDescriptionForNewFeatures;
            } else {
                i18 = R.string.ChannelNeedBoostsDescriptionForNewFeatures;
            }
            TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus2 = this.f42338b0;
        ...
        } else if (z11 && this.f42339c0.alreadyActive) {
            if (this.f42338b0.level == 1) {
                if (x1()) {
            ...
            return LocaleController.formatString(i16, Integer.valueOf(this.f42338b0.level), LocaleController.formatPluralString("BoostStories", this.f42338b0.level, new Object[0]));
        } else if (this.f42339c0.alreadyActive) {
            TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus3 = this.f42338b0;
            if (tL_premium_boostsStatus3.level == 0) {
                ...
                TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus4 = this.f42338b0;
                ...
                return LocaleController.formatString(i14, Integer.valueOf(this.f42338b0.level), LocaleController.formatPluralString("BoostStories", this.f42338b0.level + 1, new Object[0]));
            } else {
                if (x1()) {
                ...
                TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus5 = this.f42338b0;
            ...
            TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus6 = this.f42338b0;
            if (tL_premium_boostsStatus6.level == 0) {
                ...
                TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus7 = this.f42338b0;
                ...
                return LocaleController.formatString(i11, Integer.valueOf(this.f42338b0.level), LocaleController.formatPluralString("BoostStories", this.f42338b0.level + 1, new Object[0]));
            } else {
                if (x1()) {
                ...
                TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus8 = this.f42338b0;
    ...
    public final String r1() {
        ...
        if (tL_premium_boostsStatus.level > 0 && !this.f42339c0.alreadyActive) {
            if (x1()) {
        ...
        boolean z10 = this.f42341e0;
        int i16 = this.f42344h0;
        if (z10) {
            if (i16 == 32) {
                if (x1()) {
            ...
            TLRPC.Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-this.f42337a0));
            if (this.f42339c0.alreadyActive) {
    ...
    public final TLRPC.Chat s1() {
        return MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-this.f42337a0));
    }

    public final TLRPC.ChatFull t1() {
        return MessagesController.getInstance(this.currentAccount).getChatFull(-this.f42337a0);
    }
    ...
    public final boolean x1() {
        return !ChatObject.isChannelAndNotMegaGroup(MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-this.f42337a0)));
    }
    ...
    public final void z1() {
        ...
        h0Var.f22116b++;
        h0Var.f22114a = w7.p.a((i11 - i10) / i12, 0.0f, 1.0f);
        h0Var.W = true;
        h0Var.f22115a0 = h0Var.f22129n;
        h0Var.g(i11, true);
