...
public final class f extends LinearLayout {
    ...
    public final TextView f42554b;
    public final LimitPreviewView f42555c;
    ...
    public f(Context context, d6 d6Var) {
        ...
        this.f42555c = limitPreviewView;
        addView(limitPreviewView, y5.p(-1, -2, 0.0f, 0, 0, 8, 0, 21));
    }

    public final void a(e eVar) {
        this.f42553a.setText(eVar.f42545a);
        this.f42554b.setText(eVar.f42546b);
        LimitPreviewView limitPreviewView = this.f42555c;
        limitPreviewView.v.setText(String.format("%d", Integer.valueOf(eVar.d)));
        limitPreviewView.f22327w.setText(String.format("%d", Integer.valueOf(eVar.f42547c)));
    }
}
