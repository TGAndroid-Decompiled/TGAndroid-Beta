...
public final class v0 implements z4.e {
    public final sa f42783a;
    public final x0 f42784b;
    ...
    public final void d() {
        ...
        while (true) {
            ...
            if (!x0Var.f42826w || !(w0Var.f42812f instanceof n0)) {
                int i13 = w0Var.f42809a;
                l0 l0Var = w0Var.e;
                if (i13 == x0Var.G) {
            ...
            if (w0Var.f42812f instanceof n0) {
                w0Var.setTranslationX(-f7);
                w0Var.f42810b.setTranslationX(f7);
                w0Var.f42811c.setTranslationX(f7);
            }
            i12++;
        }
        int i14 = x0Var.G;
        if (i14 >= 0 && i14 < arrayList.size() && ((i11 = ((bx0) arrayList.get(x0Var.G)).f32506a) == 0 || i11 == 14 || i11 == 28)) {
            z10 = true;
        } else {
            z10 = false;
        }
        int i15 = x0Var.H;
        if (i15 >= 0 && i15 < arrayList.size() && ((i10 = ((bx0) arrayList.get(x0Var.H)).f32506a) == 0 || i10 == 14 || i10 == 28)) {
            z11 = true;
        } else {
            z11 = false;
        }
