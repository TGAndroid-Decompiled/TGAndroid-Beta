...
public final class v0 implements z4.e {
    public final ra f42819a;
    public final x0 f42820b;
    ...
    public final void d() {
        ...
        while (true) {
            ...
            if (!x0Var.f42862w || !(w0Var.f42848f instanceof n0)) {
                int i13 = w0Var.f42845a;
                l0 l0Var = w0Var.e;
                if (i13 == x0Var.G) {
            ...
            if (w0Var.f42848f instanceof n0) {
                w0Var.setTranslationX(-f7);
                w0Var.f42846b.setTranslationX(f7);
                w0Var.f42847c.setTranslationX(f7);
            }
            i12++;
        }
        int i14 = x0Var.G;
        if (i14 >= 0 && i14 < arrayList.size() && ((i11 = ((kx0) arrayList.get(x0Var.G)).f35278a) == 0 || i11 == 14 || i11 == 28)) {
            z10 = true;
        } else {
            z10 = false;
        }
        int i15 = x0Var.H;
        if (i15 >= 0 && i15 < arrayList.size() && ((i10 = ((kx0) arrayList.get(x0Var.H)).f35278a) == 0 || i10 == 14 || i10 == 28)) {
            z11 = true;
        } else {
            z11 = false;
        }
