...
public abstract class b extends FrameLayout implements l0 {
    public final e6 f42252a;
    public final ll0 f42253b;
    public final s4.c0 f42254c;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        Paint T0 = i6.T0("paintDivider", this.f42252a);
        if (T0 == null) {
            T0 = i6.f18958k0;
        }
    ...
    public void setOffset(float f7) {
        if (Math.abs(f7 / getMeasuredWidth()) == 1.0f) {
            ll0 ll0Var = this.f42253b;
            if (ll0Var.K(0) == null || ll0Var.K(0).f42675a.getTop() != ll0Var.getPaddingTop()) {
                ll0Var.u0(0);
            }
        }
    }
    ...
    public void setTopOffset(int i10) {
        this.f42253b.setPadding(0, i10, 0, 0);
    }
}
