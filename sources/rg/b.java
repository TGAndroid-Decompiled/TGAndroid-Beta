...
public abstract class b extends FrameLayout implements l0 {
    public final d6 f42536a;
    public final wl0 f42537b;
    public final s4.c0 f42538c;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        Paint T0 = h6.T0("paintDivider", this.f42536a);
        if (T0 == null) {
            T0 = h6.f19180k0;
        }
    ...
    public void setOffset(float f7) {
        if (Math.abs(f7 / getMeasuredWidth()) == 1.0f) {
            wl0 wl0Var = this.f42537b;
            if (wl0Var.K(0) == null || wl0Var.K(0).f42960a.getTop() != wl0Var.getPaddingTop()) {
                wl0Var.u0(0);
            }
        }
    }
    ...
    public void setTopOffset(int i10) {
        this.f42537b.setPadding(0, i10, 0, 0);
    }
}
