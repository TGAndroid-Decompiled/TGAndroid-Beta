...
public abstract class b extends FrameLayout implements l0 {
    public final d6 f42522a;
    public final wl0 f42523b;
    public final s4.c0 f42524c;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        Paint T0 = h6.T0("paintDivider", this.f42522a);
        if (T0 == null) {
            T0 = h6.f19166k0;
        }
    ...
    public void setOffset(float f7) {
        if (Math.abs(f7 / getMeasuredWidth()) == 1.0f) {
            wl0 wl0Var = this.f42523b;
            if (wl0Var.K(0) == null || wl0Var.K(0).f42946a.getTop() != wl0Var.getPaddingTop()) {
                wl0Var.u0(0);
            }
        }
    }
    ...
    public void setTopOffset(int i10) {
        this.f42523b.setPadding(0, i10, 0, 0);
    }
}
