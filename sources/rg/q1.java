...
public final class q1 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final List f45478w = Arrays.asList(new n1(0, 1, 20, 0), new n1(0, 2, 20, 40), new n1(1, 0, 0, 20), new n1(1, 2, 60, 40), new n1(2, 0, 40, 20), new n1(2, 1, 40, 60));
    public int f45479a;
    public final aj0 f45480b;
    public final ImageView f45481c;
    public final ImageView d;
    public final View f45482e;
    public final p1 f45483f;
    public o1 h;
    public int f45484n;
    public int f45485r;
    public int f45486s;
            ...
            public final void onClick(View view2) {
                switch (r2) {
                    case 0:
                        ...
                        return;
                    case 1:
                        q1 q1Var = this.f45329b;
                        q1Var.d((q1Var.f45479a + 1) % 3, true);
                        return;
                    case 2:
                        this.f45329b.h.c();
                        return;
    ...
    public final void c(View view) {
        if (view.getVisibility() != 8) {
            ...
            int i10 = this.f45485r + layoutParams.leftMargin;
            this.f45485r = i10;
            view.layout(i10, (getMeasuredHeight() - layoutParams.height) / 2, this.f45485r + layoutParams.width, (getMeasuredHeight() + layoutParams.height) / 2);
            this.f45485r = layoutParams.width + layoutParams.rightMargin + this.f45485r;
        }
    }
    ...
    public final void d(int i10, boolean z10) {
        ...
        if (i11 == i10) {
            ...
            while (true) {
                ...
                if (this.f45479a == n1Var2.f45359b) {
                    n1Var = n1Var2;
                    break;
                }
            }
        ...
        while (true) {
            ...
            if (i11 == n1Var4.f45358a && this.f45479a == n1Var4.f45359b) {
                n1Var3 = n1Var4;
                break;
            }
        }
        xi0 animatedDrawable2 = aj0Var.getAnimatedDrawable();
        animatedDrawable2.K(n1Var3.f45360c);
    ...
    public final void e(int i10, boolean z10) {
        ...
        ImageView imageView = this.f45481c;
        if (z10) {
        ...
        if (p1Var != null) {
            for (qg.j0 j0Var : qg.j0.c()) {
                if (j0Var.f44483a.equals(str)) {
                    ...
                    String str2 = j0Var.f44485c;
                    if (str2 == null) {
                        str2 = LocaleController.getString(j0Var.f44484b);
                    }
                    p1Var.setText(str2);
                    return;
                }
