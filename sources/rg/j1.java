...
public final class j1 extends ll0 {
    ...
    @Override
    public final int h() {
        return this.f42357c.f42371f0;
    }

    @Override
    public final int j(int i10) {
        k1 k1Var = this.f42357c;
        if (i10 != k1Var.f42372g0) {
            if (i10 >= k1Var.f42373h0 && i10 < k1Var.f42374i0) {
                return k1Var.X();
            }
            if (i10 >= k1Var.f42375j0 && i10 < k1Var.f42376k0) {
                return 1;
            }
            if (i10 == k1Var.f42377l0) {
                return 2;
            }
            if (i10 == k1Var.m0) {
                return 3;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        k1 k1Var = this.f42357c;
        int i11 = k1Var.f42375j0;
        if (i10 >= i11 && i10 < k1Var.f42376k0) {
            ww0 ww0Var = (ww0) view;
            mx0 mx0Var = (mx0) k1Var.X.get(i10 - i11);
            boolean z10 = true;
            if (i10 == k1Var.f42376k0 - 1) {
                z10 = false;
            }
            ww0Var.a(mx0Var, z10);
        } else if (i10 >= k1Var.f42373h0 && i10 < k1Var.f42374i0) {
            k1Var.Y(view);
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            if (i10 != 2) {
                        ...
                        if (i10 != 5) {
                            ...
                            d0Var.setText(AndroidUtilities.replaceCharSequence("%1$s", AndroidUtilities.replaceSingleTag(string, i12, 0, new Runnable(this) {
                                ...
                                public final void run() {
                                    switch (r2) {
                                        case 0:
                                            nf.f.s(this.f42323b.f42357c.f42384t0.getParentActivity(), LocaleController.getString(R.string.TermsOfServiceUrl));
                                            return;
                                        default:
                                            nf.f.s(this.f42323b.f42357c.f42384t0.getParentActivity(), LocaleController.getString(R.string.PrivacyPolicyUrl));
                                            return;
                                    }
                                }
                ...
                dx0Var = new a7(context, k1Var.getThemedColor(j6.f18806a7), 0);
            }
        } else {
            dc1 dc1Var = new dc1(this, context, 17);
            k1Var.f42383s0 = dc1Var;
            dc1Var.setOrientation(1);
            View view = k1Var.B0;
            if (view == null) {
                k1Var.f42382r0 = new gg0(context, 1, 0, 2);
                Bitmap createBitmap = Bitmap.createBitmap(50, 50, Bitmap.Config.ARGB_8888);
                Canvas canvas = new Canvas(createBitmap);
                int i13 = j6.Mj;
                canvas.drawColor(i0.a.d(0.5f, k1Var.getThemedColor(i13), k1Var.getThemedColor(j6.f18933h5)));
                k1Var.f42382r0.setBackgroundBitmap(createBitmap);
                sg.a aVar = k1Var.f42382r0.f42959b;
                aVar.f42947w = i13;
                aVar.f42948x = j6.Lj;
                aVar.b();
                dc1Var.addView(k1Var.f42382r0, x5.q(160, 160, 1));
            } else {
            ...
            if (k1Var.N0 == null) {
                ...
                Integer num = k1Var.f42385u0;
                if (num == null) {
                    intValue = k1Var.getThemedColor(j6.f19192v6);
                } else {
