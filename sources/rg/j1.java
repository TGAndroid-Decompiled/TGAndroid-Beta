...
public final class j1 extends View {
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        k1 k1Var = this.f45226c;
        k1Var.X2.setColor(this.f45224a);
        float min = Math.min((getWidth() - getPaddingLeft()) - getPaddingRight(), (getHeight() - getPaddingTop()) - getPaddingBottom()) / 2.0f;
        if (this.f45225b != 0.0f) {
            min -= (k1Var.Y2.getStrokeWidth() + AndroidUtilities.dp(3.0f)) * this.f45225b;
        }
        float width = ((getWidth() / 2.0f) + getPaddingLeft()) - getPaddingRight();
        float height = ((getHeight() / 2.0f) + getPaddingTop()) - getPaddingBottom();
        k1.w1(width, height, min, this.f45224a, canvas);
        if (this.f45225b != 0.0f) {
            ...
            k1Var.Y2.setColor(this.f45224a);
