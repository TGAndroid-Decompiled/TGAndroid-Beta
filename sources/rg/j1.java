...
public final class j1 extends vl0 {
    ...
    @Override
    public final int h() {
        return this.f42619c.f42633f0;
    }

    @Override
    public final int j(int i10) {
        k1 k1Var = this.f42619c;
        if (i10 != k1Var.f42634g0) {
            if (i10 >= k1Var.f42635h0 && i10 < k1Var.f42636i0) {
                return k1Var.X();
            }
            if (i10 >= k1Var.f42637j0 && i10 < k1Var.f42638k0) {
                return 1;
            }
            if (i10 == k1Var.f42639l0) {
                return 2;
            }
            if (i10 == k1Var.m0) {
                return 3;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        k1 k1Var = this.f42619c;
        int i11 = k1Var.f42637j0;
        if (i10 >= i11 && i10 < k1Var.f42638k0) {
            lw0 lw0Var = (lw0) view;
            bx0 bx0Var = (bx0) k1Var.X.get(i10 - i11);
            boolean z10 = true;
            if (i10 == k1Var.f42638k0 - 1) {
                z10 = false;
            }
            lw0Var.a(bx0Var, z10);
        } else if (i10 >= k1Var.f42635h0 && i10 < k1Var.f42636i0) {
            k1Var.Y(view);
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
                        ...
                        if (i10 != 5) {
                            ...
                            d0Var.setText(AndroidUtilities.replaceCharSequence("%1$s", AndroidUtilities.replaceSingleTag(string, i12, 0, new Runnable(this) {
                                ...
                                public final void run() {
                                    switch (r2) {
                                        case 0:
                                            nf.f.s(this.f42585b.f42619c.f42646t0.getParentActivity(), LocaleController.getString(R.string.TermsOfServiceUrl));
                                            return;
                                        default:
                                            nf.f.s(this.f42585b.f42619c.f42646t0.getParentActivity(), LocaleController.getString(R.string.PrivacyPolicyUrl));
                                            return;
                                    }
                                }
            ...
            k1Var.f42645s0 = ub1Var;
            ub1Var.setOrientation(1);
            View view = k1Var.B0;
            if (view == null) {
                k1Var.f42644r0 = new yf0(context, 1, 0, 2);
                Bitmap createBitmap = Bitmap.createBitmap(50, 50, Bitmap.Config.ARGB_8888);
                Canvas canvas = new Canvas(createBitmap);
                int i13 = h6.Mj;
                canvas.drawColor(i0.a.d(0.5f, k1Var.getThemedColor(i13), k1Var.getThemedColor(h6.f19129h5)));
                k1Var.f42644r0.setBackgroundBitmap(createBitmap);
                sg.a aVar = k1Var.f42644r0.f43225b;
                aVar.f43213w = i13;
                aVar.f43214x = h6.Lj;
                aVar.b();
                ub1Var.addView(k1Var.f42644r0, y5.q(160, 160, 1));
            } else {
