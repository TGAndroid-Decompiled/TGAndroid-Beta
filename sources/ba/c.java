...
public final class c {
    public final File f3450a;
    public final File f3451b;
    public final File f3452c;
    public final File d;
    public final File e;
    public final File f3453f;

    public c(Context context) {
        String str;
        File filesDir = context.getFilesDir();
        this.f3450a = filesDir;
    ...
    public final File b(String str, String str2) {
        File file = new File(this.f3452c, str);
        file.mkdirs();
