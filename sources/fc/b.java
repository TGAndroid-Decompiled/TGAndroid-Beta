...
public final class b {
    ...
    public final b a(b bVar) {
        ...
        if (aVar2.equals(aVar)) {
            ...
            int[] iArr = bVar.f9042b;
            int[] iArr2 = this.f9042b;
    ...
    public final int b(int i10) {
        ...
        for (int i14 = 1; i14 < length; i14++) {
            i13 = this.f9041a.c(i10, i13) ^ iArr[i14];
        }
        return i13;
    }
