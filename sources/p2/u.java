...
public final class u implements ServiceConnection {
    ...
    public final com.google.android.gms.internal.play_billing.m f41046b;
    public final com.google.android.gms.internal.play_billing.m f41047c;
    public final b d;

    public u(b bVar, c cVar) {
        this.d = bVar;
        com.google.android.gms.internal.play_billing.h hVar = bVar.B;
        this.f41046b = new com.google.android.gms.internal.play_billing.m(hVar);
        this.f41047c = new com.google.android.gms.internal.play_billing.m(hVar);
        this.f41045a = cVar;
    }

    public final Long a(boolean z4) {
        if (z4) {
            com.google.android.gms.internal.play_billing.m mVar = this.f41046b;
            if (mVar.f3517b) {
                long a2 = mVar.f3516a.a();
                if (mVar.f3517b) {
                    mVar.f3517b = false;
                    long j10 = (a2 - mVar.d) + mVar.f3518c;
                    mVar.f3518c = j10;
        ...
        com.google.android.gms.internal.play_billing.m mVar2 = this.f41047c;
        if (mVar2.f3517b) {
            long a10 = mVar2.f3516a.a();
            if (mVar2.f3517b) {
                mVar2.f3517b = false;
                long j11 = (a10 - mVar2.d) + mVar2.f3518c;
                mVar2.f3518c = j11;
    ...
    public final void b(h hVar, int i10, String str, boolean z4) {
        try {
            j3 s6 = k3.s();
            int i11 = hVar.f41015a;
            s6.c();
            k3.r((k3) s6.f3578b, i11);
            String str2 = hVar.f41017c;
            s6.c();
            k3.o((k3) s6.f3578b, str2);
            s6.c();
            k3.q((k3) s6.f3578b, i10);
            if (str != null) {
                s6.c();
                k3.n((k3) s6.f3578b, str);
            }
            Long a2 = a(z4);
            b bVar = this.d;
            if (z4) {
                ...
                if (a2 != null) {
                    ...
                    r10.c();
                    d4.p((d4) r10.f3578b, longValue);
                }
                f3 u10 = g3.u();
                u10.d(s6);
                u10.c();
                g3.t((g3) u10.f3578b, 6);
                u10.e(r10);
                bVar.h((g3) u10.a());
                return;
            }
            z3 p10 = a4.p();
            p10.c();
            a4.n((a4) p10.f3578b, (k3) s6.a());
            if (a2 != null) {
                long longValue2 = a2.longValue();
                p10.c();
                a4.o((a4) p10.f3578b, longValue2);
            }
            bVar.h.Y0((a4) p10.a());
        } catch (Throwable th2) {
    ...
    public final void c(h hVar) {
        ...
        synchronized (bVar.f40963a) {
            try {
                ...
                try {
                    this.f41045a.onBillingSetupFinished(hVar);
                } catch (Throwable th2) {
    ...
    public final void onBindingDied(ComponentName componentName) {
        ...
        b bVar2 = this.d;
        synchronized (bVar2.f40963a) {
            if (bVar2.f40964b != 3 && bVar2.f40964b != 0) {
                bVar2.k(0);
                bVar2.m();
                try {
                    this.f41045a.onBillingServiceDisconnected();
                } catch (Throwable th3) {
    ...
    public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        synchronized (bVar.f40963a) {
            try {
                ...
                int i10 = com.google.android.gms.internal.play_billing.b.f3428b;
                if (iBinder == null) {
                    aVar = 0;
                } else {
    ...
    public final void onServiceDisconnected(ComponentName componentName) {
        ...
        com.google.android.gms.internal.play_billing.m mVar = this.f41047c;
        mVar.f3518c = 0L;
        mVar.f3517b = false;
        mVar.a();
        b bVar2 = this.d;
