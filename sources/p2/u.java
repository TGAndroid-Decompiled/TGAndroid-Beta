...
public final class u implements ServiceConnection {
    ...
    public final com.google.android.gms.internal.play_billing.m f41024b;
    public final com.google.android.gms.internal.play_billing.m f41025c;
    public final b d;

    public u(b bVar, c cVar) {
        this.d = bVar;
        com.google.android.gms.internal.play_billing.h hVar = bVar.B;
        this.f41024b = new com.google.android.gms.internal.play_billing.m(hVar);
        this.f41025c = new com.google.android.gms.internal.play_billing.m(hVar);
        this.f41023a = cVar;
    }

    public final Long a(boolean z4) {
        if (z4) {
            com.google.android.gms.internal.play_billing.m mVar = this.f41024b;
            if (mVar.f3534b) {
        ...
        com.google.android.gms.internal.play_billing.m mVar2 = this.f41025c;
        if (mVar2.f3534b) {
    ...
    public final void b(h hVar, int i10, String str, boolean z4) {
        try {
            j3 s6 = k3.s();
            int i11 = hVar.f40993a;
            s6.c();
            k3.r((k3) s6.f3595b, i11);
            ...
            if (z4) {
                ...
                if (a2 != null) {
                    ...
                    r10.c();
                    d4.p((d4) r10.f3595b, longValue);
                }
                f3 u10 = g3.u();
                u10.d(s6);
                u10.c();
                g3.t((g3) u10.f3595b, 6);
                u10.e(r10);
                bVar.h((g3) u10.a());
                return;
            }
            z3 p10 = a4.p();
            p10.c();
            a4.n((a4) p10.f3595b, (k3) s6.a());
            if (a2 != null) {
                long longValue2 = a2.longValue();
                p10.c();
                a4.o((a4) p10.f3595b, longValue2);
            }
            bVar.h.t1((a4) p10.a());
        } catch (Throwable th2) {
    ...
    public final void c(h hVar) {
        ...
        synchronized (bVar.f40941a) {
            try {
                ...
                try {
                    this.f41023a.onBillingSetupFinished(hVar);
                } catch (Throwable th2) {
    ...
    public final void onBindingDied(ComponentName componentName) {
        ...
        b bVar2 = this.d;
        synchronized (bVar2.f40941a) {
            if (bVar2.f40942b != 3 && bVar2.f40942b != 0) {
                bVar2.k(0);
                bVar2.m();
                try {
                    this.f41023a.onBillingServiceDisconnected();
                } catch (Throwable th3) {
    ...
    public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        synchronized (bVar.f40941a) {
            try {
                ...
                int i10 = com.google.android.gms.internal.play_billing.b.f3445b;
                if (iBinder == null) {
                    aVar = 0;
                } else {
    ...
    public final void onServiceDisconnected(ComponentName componentName) {
        ...
        com.google.android.gms.internal.play_billing.m mVar = this.f41025c;
        mVar.f3535c = 0L;
        mVar.f3534b = false;
        mVar.a();
        b bVar2 = this.d;
