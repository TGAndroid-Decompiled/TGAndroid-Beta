...
public final class i {
    ...
    public final ArrayList f45463e;
    public final String f45464f;
    public final ya.a f45465g;

    public i(JSONObject jSONObject) {
        this.f45460a = jSONObject.optString("formattedPrice");
        this.f45461b = jSONObject.optLong("priceAmountMicros");
        this.f45462c = jSONObject.optString("priceCurrencyCode");
        ...
        this.f45463e = new ArrayList();
        if (optJSONArray != null) {
            for (int i10 = 0; i10 < optJSONArray.length(); i10++) {
                this.f45463e.add(optJSONArray.getString(i10));
            }
        }
        ...
        this.f45464f = jSONObject.optString("serializedDocid");
