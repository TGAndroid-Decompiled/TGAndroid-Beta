...
public abstract class z {
    ...
    public static String a(Exception exc) {
        ...
        try {
            ...
            int i10 = com.google.android.gms.internal.play_billing.u.f3575a;
            if (str.length() > 40) {
    ...
    public static g3 b(int i10, int i11, h hVar, String str, m3 m3Var) {
        try {
            j3 s6 = k3.s();
            int i12 = hVar.f41015a;
            s6.c();
            k3.r((k3) s6.f3578b, i12);
            String str2 = hVar.f41017c;
            s6.c();
            k3.o((k3) s6.f3578b, str2);
            int i13 = hVar.f41016b;
            if (i13 != 0) {
                s6.c();
                k3.p((k3) s6.f3578b, i13);
            }
            if (i10 != 0) {
                s6.c();
    ...
    public static i3 c(int i10, m3 m3Var) {
        try {
            h3 s6 = i3.s();
            s6.c();
            i3.r((i3) s6.f3578b, i10);
            if (!m3Var.equals(m3.BROADCAST_ACTION_UNSPECIFIED)) {
                s6.c();
                i3.o((i3) s6.f3578b, m3Var);
            }
            return (i3) s6.a();
        } catch (Exception e) {
