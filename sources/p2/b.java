...
public final class b implements y2.h {
    ...
    public b(c cVar, Uri uri) {
        this.f40659w = cVar;
        this.f40652a = uri;
        this.f40654c = ((g2.g) cVar.f40660a.f13909a).createDataSource();
    }
    ...
    public final void d(Uri uri) {
        ...
        this.f40653b.f(pVar, this, cVar.f40662c.L3(pVar.f46568c));
    }
        ...
        if (!this.f40657r) {
            ...
            if (!mVar.d() && !mVar.c()) {
                ...
                if (elapsedRealtime < j3) {
                    this.f40657r = true;
                    this.f40659w.f40664n.postDelayed(new f1(6, this, uri), j3 - elapsedRealtime);
                    return;
                }
                d(uri);
            }
    ...
    public final void n(y2.j jVar, long j3, long j10, int i10) {
        ...
        this.f40659w.f40663f.s(tVar, pVar.f46568c, -1, null, 0, null, -9223372036854775807L, -9223372036854775807L, i10);
    }
