...
public final class r implements y2.o {
    public final o f43812a;
    public final l f43813b;
    public static final Pattern f43780c = Pattern.compile("AVERAGE-BANDWIDTH=(\\d+)\\b");
    public static final Pattern d = Pattern.compile("VIDEO=\"((?:.|\f)+?)\"");
    public static final Pattern f43783e = Pattern.compile("AUDIO=\"((?:.|\f)+?)\"");
    public static final Pattern f43785f = Pattern.compile("SUBTITLES=\"((?:.|\f)+?)\"");
    public static final Pattern h = Pattern.compile("CLOSED-CAPTIONS=\"((?:.|\f)+?)\"");
    public static final Pattern f43793n = Pattern.compile("[^-]BANDWIDTH=(\\d+)\\b");
    public static final Pattern f43798r = Pattern.compile("CHANNELS=\"((?:.|\f)+?)\"");
    public static final Pattern f43800s = Pattern.compile("VIDEO-RANGE=(SDR|PQ|HLG)");
    public static final Pattern v = Pattern.compile("CODECS=\"((?:.|\f)+?)\"");
    public static final Pattern f43805w = Pattern.compile("SUPPLEMENTAL-CODECS=\"((?:.|\f)+?)\"");
    public static final Pattern f43807x = Pattern.compile("MIME=\"(.+?)\"");
    public static final Pattern f43809y = Pattern.compile("CACHED=\"(.+?)\"");
    ...
    public static final Pattern f43778a0 = Pattern.compile("TIME-OFFSET=(-?[\\d\\.]+)\\b");
    public static final Pattern f43779b0 = Pattern.compile("#EXT-X-BYTERANGE:(\\d+(?:@\\d+)?)\\b");
    public static final Pattern f43781c0 = Pattern.compile("BYTERANGE=\"(\\d+(?:@\\d+)?)\\b\"");
    public static final Pattern f43782d0 = Pattern.compile("BYTERANGE-START=(\\d+)\\b");
    public static final Pattern f43784e0 = Pattern.compile("BYTERANGE-LENGTH=(\\d+)\\b");
    public static final Pattern f43786f0 = Pattern.compile("METHOD=(NONE|AES-128|SAMPLE-AES|SAMPLE-AES-CENC|SAMPLE-AES-CTR)\\s*(?:,|$)");
    public static final Pattern f43787g0 = Pattern.compile("KEYFORMAT=\"((?:.|\f)+?)\"");
    public static final Pattern f43788h0 = Pattern.compile("KEYFORMATVERSIONS=\"((?:.|\f)+?)\"");
    public static final Pattern f43789i0 = Pattern.compile("URI=\"((?:.|\f)+?)\"");
    public static final Pattern f43790j0 = Pattern.compile("IV=([^,.*]+)");
    public static final Pattern f43791k0 = Pattern.compile("TYPE=(AUDIO|VIDEO|SUBTITLES|CLOSED-CAPTIONS)");
    public static final Pattern f43792l0 = Pattern.compile("TYPE=(PART|MAP)");
    public static final Pattern m0 = Pattern.compile("LANGUAGE=\"((?:.|\f)+?)\"");
    public static final Pattern f43794n0 = Pattern.compile("NAME=\"((?:.|\f)+?)\"");
    public static final Pattern f43795o0 = Pattern.compile("GROUP-ID=\"((?:.|\f)+?)\"");
    public static final Pattern f43796p0 = Pattern.compile("CHARACTERISTICS=\"((?:.|\f)+?)\"");
    public static final Pattern f43797q0 = Pattern.compile("INSTREAM-ID=\"((?:CC|SERVICE)\\d+)\"");
    public static final Pattern f43799r0 = a("AUTOSELECT");
    public static final Pattern f43801s0 = a("DEFAULT");
    public static final Pattern f43802t0 = a("FORCED");
    public static final Pattern f43803u0 = a("INDEPENDENT");
    public static final Pattern f43804v0 = a("GAP");
    public static final Pattern f43806w0 = a("PRECISE");
    public static final Pattern f43808x0 = Pattern.compile("VALUE=\"((?:.|\f)+?)\"");
    public static final Pattern f43810y0 = Pattern.compile("IMPORT=\"((?:.|\f)+?)\"");
    public static final Pattern f43811z0 = Pattern.compile("[:,]ID=\"((?:.|\f)+?)\"");
    ...
    public static b2.n c(String str, String str2, HashMap hashMap) {
        String i10 = i(str, f43788h0, "1", hashMap);
        boolean equals = "urn:uuid:edef8ba9-79d6-4ace-a3c8-27dcd51d21ed".equals(str2);
        Pattern pattern = f43789i0;
        if (equals) {
