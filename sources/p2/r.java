...
public final class r implements y2.o {
    ...
    public final l f43786b;
    public static final Pattern f43753c = Pattern.compile("AVERAGE-BANDWIDTH=(\\d+)\\b");
    public static final Pattern d = Pattern.compile("VIDEO=\"((?:.|\f)+?)\"");
    public static final Pattern f43756e = Pattern.compile("AUDIO=\"((?:.|\f)+?)\"");
    public static final Pattern f43758f = Pattern.compile("SUBTITLES=\"((?:.|\f)+?)\"");
    public static final Pattern h = Pattern.compile("CLOSED-CAPTIONS=\"((?:.|\f)+?)\"");
    public static final Pattern f43766n = Pattern.compile("[^-]BANDWIDTH=(\\d+)\\b");
    public static final Pattern f43771r = Pattern.compile("CHANNELS=\"((?:.|\f)+?)\"");
    public static final Pattern f43773s = Pattern.compile("VIDEO-RANGE=(SDR|PQ|HLG)");
    public static final Pattern v = Pattern.compile("CODECS=\"((?:.|\f)+?)\"");
    public static final Pattern f43778w = Pattern.compile("SUPPLEMENTAL-CODECS=\"((?:.|\f)+?)\"");
    public static final Pattern f43780x = Pattern.compile("MIME=\"(.+?)\"");
    public static final Pattern f43782y = Pattern.compile("CACHED=\"(.+?)\"");
    ...
    public static final Pattern f43751a0 = Pattern.compile("TIME-OFFSET=(-?[\\d\\.]+)\\b");
    public static final Pattern f43752b0 = Pattern.compile("#EXT-X-BYTERANGE:(\\d+(?:@\\d+)?)\\b");
    public static final Pattern f43754c0 = Pattern.compile("BYTERANGE=\"(\\d+(?:@\\d+)?)\\b\"");
    public static final Pattern f43755d0 = Pattern.compile("BYTERANGE-START=(\\d+)\\b");
    public static final Pattern f43757e0 = Pattern.compile("BYTERANGE-LENGTH=(\\d+)\\b");
    public static final Pattern f43759f0 = Pattern.compile("METHOD=(NONE|AES-128|SAMPLE-AES|SAMPLE-AES-CENC|SAMPLE-AES-CTR)\\s*(?:,|$)");
    public static final Pattern f43760g0 = Pattern.compile("KEYFORMAT=\"((?:.|\f)+?)\"");
    public static final Pattern f43761h0 = Pattern.compile("KEYFORMATVERSIONS=\"((?:.|\f)+?)\"");
    public static final Pattern f43762i0 = Pattern.compile("URI=\"((?:.|\f)+?)\"");
    public static final Pattern f43763j0 = Pattern.compile("IV=([^,.*]+)");
    public static final Pattern f43764k0 = Pattern.compile("TYPE=(AUDIO|VIDEO|SUBTITLES|CLOSED-CAPTIONS)");
    public static final Pattern f43765l0 = Pattern.compile("TYPE=(PART|MAP)");
    public static final Pattern m0 = Pattern.compile("LANGUAGE=\"((?:.|\f)+?)\"");
    public static final Pattern f43767n0 = Pattern.compile("NAME=\"((?:.|\f)+?)\"");
    public static final Pattern f43768o0 = Pattern.compile("GROUP-ID=\"((?:.|\f)+?)\"");
    public static final Pattern f43769p0 = Pattern.compile("CHARACTERISTICS=\"((?:.|\f)+?)\"");
    public static final Pattern f43770q0 = Pattern.compile("INSTREAM-ID=\"((?:CC|SERVICE)\\d+)\"");
    public static final Pattern f43772r0 = a("AUTOSELECT");
    public static final Pattern f43774s0 = a("DEFAULT");
    public static final Pattern f43775t0 = a("FORCED");
    public static final Pattern f43776u0 = a("INDEPENDENT");
    public static final Pattern f43777v0 = a("GAP");
    public static final Pattern f43779w0 = a("PRECISE");
    public static final Pattern f43781x0 = Pattern.compile("VALUE=\"((?:.|\f)+?)\"");
    public static final Pattern f43783y0 = Pattern.compile("IMPORT=\"((?:.|\f)+?)\"");
    public static final Pattern f43784z0 = Pattern.compile("[:,]ID=\"((?:.|\f)+?)\"");
    ...
    public static b2.n c(String str, String str2, HashMap hashMap) {
        String i10 = i(str, f43761h0, "1", hashMap);
        boolean equals = "urn:uuid:edef8ba9-79d6-4ace-a3c8-27dcd51d21ed".equals(str2);
        Pattern pattern = f43762i0;
        if (equals) {
