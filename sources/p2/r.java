...
public final class r implements y2.n {
    public final o f40800a;
    public final l f40801b;
    public static final Pattern f40769c = Pattern.compile("AVERAGE-BANDWIDTH=(\\d+)\\b");
    public static final Pattern d = Pattern.compile("VIDEO=\"((?:.|\f)+?)\"");
    public static final Pattern e = Pattern.compile("AUDIO=\"((?:.|\f)+?)\"");
    public static final Pattern f40773f = Pattern.compile("SUBTITLES=\"((?:.|\f)+?)\"");
    public static final Pattern h = Pattern.compile("CLOSED-CAPTIONS=\"((?:.|\f)+?)\"");
    public static final Pattern f40781n = Pattern.compile("[^-]BANDWIDTH=(\\d+)\\b");
    public static final Pattern f40786r = Pattern.compile("CHANNELS=\"((?:.|\f)+?)\"");
    public static final Pattern f40788s = Pattern.compile("VIDEO-RANGE=(SDR|PQ|HLG)");
    public static final Pattern v = Pattern.compile("CODECS=\"((?:.|\f)+?)\"");
    public static final Pattern f40793w = Pattern.compile("SUPPLEMENTAL-CODECS=\"((?:.|\f)+?)\"");
    public static final Pattern f40795x = Pattern.compile("MIME=\"(.+?)\"");
    public static final Pattern f40797y = Pattern.compile("CACHED=\"(.+?)\"");
    ...
    public static final Pattern f40767a0 = Pattern.compile("TIME-OFFSET=(-?[\\d\\.]+)\\b");
    public static final Pattern f40768b0 = Pattern.compile("#EXT-X-BYTERANGE:(\\d+(?:@\\d+)?)\\b");
    public static final Pattern f40770c0 = Pattern.compile("BYTERANGE=\"(\\d+(?:@\\d+)?)\\b\"");
    public static final Pattern f40771d0 = Pattern.compile("BYTERANGE-START=(\\d+)\\b");
    public static final Pattern f40772e0 = Pattern.compile("BYTERANGE-LENGTH=(\\d+)\\b");
    public static final Pattern f40774f0 = Pattern.compile("METHOD=(NONE|AES-128|SAMPLE-AES|SAMPLE-AES-CENC|SAMPLE-AES-CTR)\\s*(?:,|$)");
    public static final Pattern f40775g0 = Pattern.compile("KEYFORMAT=\"((?:.|\f)+?)\"");
    public static final Pattern f40776h0 = Pattern.compile("KEYFORMATVERSIONS=\"((?:.|\f)+?)\"");
    public static final Pattern f40777i0 = Pattern.compile("URI=\"((?:.|\f)+?)\"");
    public static final Pattern f40778j0 = Pattern.compile("IV=([^,.*]+)");
    public static final Pattern f40779k0 = Pattern.compile("TYPE=(AUDIO|VIDEO|SUBTITLES|CLOSED-CAPTIONS)");
    public static final Pattern f40780l0 = Pattern.compile("TYPE=(PART|MAP)");
    public static final Pattern m0 = Pattern.compile("LANGUAGE=\"((?:.|\f)+?)\"");
    public static final Pattern f40782n0 = Pattern.compile("NAME=\"((?:.|\f)+?)\"");
    public static final Pattern f40783o0 = Pattern.compile("GROUP-ID=\"((?:.|\f)+?)\"");
    public static final Pattern f40784p0 = Pattern.compile("CHARACTERISTICS=\"((?:.|\f)+?)\"");
    public static final Pattern f40785q0 = Pattern.compile("INSTREAM-ID=\"((?:CC|SERVICE)\\d+)\"");
    public static final Pattern f40787r0 = a("AUTOSELECT");
    public static final Pattern f40789s0 = a("DEFAULT");
    public static final Pattern f40790t0 = a("FORCED");
    public static final Pattern f40791u0 = a("INDEPENDENT");
    public static final Pattern f40792v0 = a("GAP");
    public static final Pattern f40794w0 = a("PRECISE");
    public static final Pattern f40796x0 = Pattern.compile("VALUE=\"((?:.|\f)+?)\"");
    public static final Pattern f40798y0 = Pattern.compile("IMPORT=\"((?:.|\f)+?)\"");
    public static final Pattern f40799z0 = Pattern.compile("[:,]ID=\"((?:.|\f)+?)\"");
    ...
    public static b2.n c(String str, String str2, HashMap hashMap) {
        String i10 = i(str, f40776h0, "1", hashMap);
        boolean equals = "urn:uuid:edef8ba9-79d6-4ace-a3c8-27dcd51d21ed".equals(str2);
        Pattern pattern = f40777i0;
        if (equals) {
