...
public final class r implements y2.p {
    public final o f39657a;
    public final l f39658b;
    ...
    public static final Pattern f39630f = Pattern.compile("SUBTITLES=\"((?:.|\f)+?)\"");
    public static final Pattern h = Pattern.compile("CLOSED-CAPTIONS=\"((?:.|\f)+?)\"");
    public static final Pattern f39638n = Pattern.compile("[^-]BANDWIDTH=(\\d+)\\b");
    public static final Pattern f39643r = Pattern.compile("CHANNELS=\"((?:.|\f)+?)\"");
    public static final Pattern f39645s = Pattern.compile("VIDEO-RANGE=(SDR|PQ|HLG)");
    public static final Pattern v = Pattern.compile("CODECS=\"((?:.|\f)+?)\"");
    public static final Pattern f39650w = Pattern.compile("SUPPLEMENTAL-CODECS=\"((?:.|\f)+?)\"");
    public static final Pattern f39652x = Pattern.compile("MIME=\"(.+?)\"");
    public static final Pattern f39654y = Pattern.compile("CACHED=\"(.+?)\"");
    ...
    public static final Pattern f39624a0 = Pattern.compile("TIME-OFFSET=(-?[\\d\\.]+)\\b");
    public static final Pattern f39625b0 = Pattern.compile("#EXT-X-BYTERANGE:(\\d+(?:@\\d+)?)\\b");
    public static final Pattern f39627c0 = Pattern.compile("BYTERANGE=\"(\\d+(?:@\\d+)?)\\b\"");
    public static final Pattern f39628d0 = Pattern.compile("BYTERANGE-START=(\\d+)\\b");
    public static final Pattern f39629e0 = Pattern.compile("BYTERANGE-LENGTH=(\\d+)\\b");
    public static final Pattern f39631f0 = Pattern.compile("METHOD=(NONE|AES-128|SAMPLE-AES|SAMPLE-AES-CENC|SAMPLE-AES-CTR)\\s*(?:,|$)");
    public static final Pattern f39632g0 = Pattern.compile("KEYFORMAT=\"((?:.|\f)+?)\"");
    public static final Pattern f39633h0 = Pattern.compile("KEYFORMATVERSIONS=\"((?:.|\f)+?)\"");
    public static final Pattern f39634i0 = Pattern.compile("URI=\"((?:.|\f)+?)\"");
    public static final Pattern f39635j0 = Pattern.compile("IV=([^,.*]+)");
    public static final Pattern f39636k0 = Pattern.compile("TYPE=(AUDIO|VIDEO|SUBTITLES|CLOSED-CAPTIONS)");
    public static final Pattern f39637l0 = Pattern.compile("TYPE=(PART|MAP)");
    public static final Pattern m0 = Pattern.compile("LANGUAGE=\"((?:.|\f)+?)\"");
    public static final Pattern f39639n0 = Pattern.compile("NAME=\"((?:.|\f)+?)\"");
    public static final Pattern f39640o0 = Pattern.compile("GROUP-ID=\"((?:.|\f)+?)\"");
    public static final Pattern f39641p0 = Pattern.compile("CHARACTERISTICS=\"((?:.|\f)+?)\"");
    public static final Pattern f39642q0 = Pattern.compile("INSTREAM-ID=\"((?:CC|SERVICE)\\d+)\"");
    public static final Pattern f39644r0 = a("AUTOSELECT");
    public static final Pattern f39646s0 = a("DEFAULT");
    public static final Pattern f39647t0 = a("FORCED");
    public static final Pattern f39648u0 = a("INDEPENDENT");
    public static final Pattern f39649v0 = a("GAP");
    public static final Pattern f39651w0 = a("PRECISE");
    public static final Pattern f39653x0 = Pattern.compile("VALUE=\"((?:.|\f)+?)\"");
    public static final Pattern f39655y0 = Pattern.compile("IMPORT=\"((?:.|\f)+?)\"");
    public static final Pattern f39656z0 = Pattern.compile("[:,]ID=\"((?:.|\f)+?)\"");
    ...
    public static b2.o b(String str, b2.n[] nVarArr) {
        ...
        for (int i10 = 0; i10 < nVarArr.length; i10++) {
            ...
            nVarArr2[i10] = new b2.n(nVar.f1814b, nVar.f1815c, nVar.d, null);
        }
        return new b2.o(str, true, nVarArr2);
    }

    public static b2.n c(String str, String str2, HashMap hashMap) {
        String i10 = i(str, f39633h0, "1", hashMap);
        boolean equals = "urn:uuid:edef8ba9-79d6-4ace-a3c8-27dcd51d21ed".equals(str2);
        Pattern pattern = f39634i0;
        if (equals) {
    ...
    public static p2.l d(p2.o r113, p2.l r114, m.e3 r115, java.lang.String r116) {
        throw new UnsupportedOperationException("Method not decompiled: p2.r.d(p2.o, p2.l, m.e3, java.lang.String):p2.l");
    }

    public static p2.o e(m.e3 r45, java.lang.String r46) {
        throw new UnsupportedOperationException("Method not decompiled: p2.r.e(m.e3, java.lang.String):p2.o");
    }
    ...
    @Override
    public final java.lang.Object l2(android.net.Uri r7, g2.k r8) {
        throw new UnsupportedOperationException("Method not decompiled: p2.r.l2(android.net.Uri, g2.k):java.lang.Object");
    }
}
