...
public final class d implements y2.h {
    ...
    public final k2.u f40434a;
    public final t f40435b;
    public final qb.b f40436c;
    public a5.a f40437f;
    public y2.m h;
    public Handler f40438n;
    public o2.l f40439r;
    public p f40440s;
    public Uri v;
    public m f40441w;
    ...
    public long f40443y = -9223372036854775807L;
    ...
    public final void V(y2.j jVar, long j3, long j10, boolean z10) {
        ...
        this.f40437f.o(tVar, 4, -1, null, 0, null, -9223372036854775807L, -9223372036854775807L);
    }
    ...
    public final m a(Uri uri, boolean z10) {
        ...
        if (mVar != null && z10) {
            if (!uri.equals(this.v)) {
                List list = this.f40440s.e;
                int i10 = 0;
                while (true) {
                    if (i10 >= list.size()) {
                        break;
                    } else if (uri.equals(((o) list.get(i10)).f40511a)) {
                        m mVar2 = this.f40441w;
                        if (mVar2 == null || !mVar2.f40500o) {
                            this.v = uri;
                            c cVar = (c) hashMap.get(uri);
                            m mVar3 = cVar.d;
                            if (mVar3 != null && mVar3.f40500o) {
                                this.f40441w = mVar3;
                                this.f40439r.v(mVar3);
                            } else {
                                cVar.e(b(uri));
                            }
                        }
    ...
    public final Uri b(Uri uri) {
        i iVar;
        m mVar = this.f40441w;
        if (mVar != null && mVar.v.e && (iVar = (i) mVar.f40505t.get(uri)) != null) {
            Uri.Builder buildUpon = uri.buildUpon();
            buildUpon.appendQueryParameter("_HLS_msn", String.valueOf(iVar.f40478b));
            int i10 = iVar.f40479c;
            if (i10 != -1) {
    ...
    public final boolean c(Uri uri) {
        ...
        if (cVar.d != null) {
            ...
            long max = Math.max(30000L, d0.e0(cVar.d.f40506u));
            m mVar = cVar.d;
            if (mVar.f40500o || (i10 = mVar.d) == 2 || i10 == 1 || cVar.e + max > elapsedRealtime) {
                return true;
            }
            return false;
        }
    ...
    public final void o(y2.j jVar, long j3, long j10, int i10) {
        ...
        this.f40437f.s(tVar, pVar.f46328c, -1, null, 0, null, -9223372036854775807L, -9223372036854775807L, i10);
    }
    ...
    public final void q(y2.j jVar, long j3, long j10) {
        ...
        q qVar = (q) pVar2.f46329f;
        boolean z10 = qVar instanceof m;
        if (z10) {
            String str = qVar.f40523a;
            p pVar3 = p.f40515n;
        ...
        this.f40436c.getClass();
        this.f40437f.p(tVar, 4, -1, null, 0, null, -9223372036854775807L, -9223372036854775807L);
    }
}
