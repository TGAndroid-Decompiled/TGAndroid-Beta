...
public final class s implements y2.o {
    public final p f40554a;
    public final m f40555b;
    public static final Pattern f40523c = Pattern.compile("AVERAGE-BANDWIDTH=(\\d+)\\b");
    public static final Pattern d = Pattern.compile("VIDEO=\"((?:.|\f)+?)\"");
    public static final Pattern e = Pattern.compile("AUDIO=\"((?:.|\f)+?)\"");
    public static final Pattern f40527f = Pattern.compile("SUBTITLES=\"((?:.|\f)+?)\"");
    public static final Pattern h = Pattern.compile("CLOSED-CAPTIONS=\"((?:.|\f)+?)\"");
    public static final Pattern f40535n = Pattern.compile("[^-]BANDWIDTH=(\\d+)\\b");
    public static final Pattern f40540r = Pattern.compile("CHANNELS=\"((?:.|\f)+?)\"");
    public static final Pattern f40542s = Pattern.compile("VIDEO-RANGE=(SDR|PQ|HLG)");
    public static final Pattern v = Pattern.compile("CODECS=\"((?:.|\f)+?)\"");
    public static final Pattern f40547w = Pattern.compile("SUPPLEMENTAL-CODECS=\"((?:.|\f)+?)\"");
    public static final Pattern f40549x = Pattern.compile("MIME=\"(.+?)\"");
    public static final Pattern f40551y = Pattern.compile("CACHED=\"(.+?)\"");
    ...
    public static final Pattern f40521a0 = Pattern.compile("TIME-OFFSET=(-?[\\d\\.]+)\\b");
    public static final Pattern f40522b0 = Pattern.compile("#EXT-X-BYTERANGE:(\\d+(?:@\\d+)?)\\b");
    public static final Pattern f40524c0 = Pattern.compile("BYTERANGE=\"(\\d+(?:@\\d+)?)\\b\"");
    public static final Pattern f40525d0 = Pattern.compile("BYTERANGE-START=(\\d+)\\b");
    public static final Pattern f40526e0 = Pattern.compile("BYTERANGE-LENGTH=(\\d+)\\b");
    public static final Pattern f40528f0 = Pattern.compile("METHOD=(NONE|AES-128|SAMPLE-AES|SAMPLE-AES-CENC|SAMPLE-AES-CTR)\\s*(?:,|$)");
    public static final Pattern f40529g0 = Pattern.compile("KEYFORMAT=\"((?:.|\f)+?)\"");
    public static final Pattern f40530h0 = Pattern.compile("KEYFORMATVERSIONS=\"((?:.|\f)+?)\"");
    public static final Pattern f40531i0 = Pattern.compile("URI=\"((?:.|\f)+?)\"");
    public static final Pattern f40532j0 = Pattern.compile("IV=([^,.*]+)");
    public static final Pattern f40533k0 = Pattern.compile("TYPE=(AUDIO|VIDEO|SUBTITLES|CLOSED-CAPTIONS)");
    public static final Pattern f40534l0 = Pattern.compile("TYPE=(PART|MAP)");
    public static final Pattern m0 = Pattern.compile("LANGUAGE=\"((?:.|\f)+?)\"");
    public static final Pattern f40536n0 = Pattern.compile("NAME=\"((?:.|\f)+?)\"");
    public static final Pattern f40537o0 = Pattern.compile("GROUP-ID=\"((?:.|\f)+?)\"");
    public static final Pattern f40538p0 = Pattern.compile("CHARACTERISTICS=\"((?:.|\f)+?)\"");
    public static final Pattern f40539q0 = Pattern.compile("INSTREAM-ID=\"((?:CC|SERVICE)\\d+)\"");
    public static final Pattern f40541r0 = a("AUTOSELECT");
    public static final Pattern f40543s0 = a("DEFAULT");
    public static final Pattern f40544t0 = a("FORCED");
    public static final Pattern f40545u0 = a("INDEPENDENT");
    public static final Pattern f40546v0 = a("GAP");
    public static final Pattern f40548w0 = a("PRECISE");
    public static final Pattern f40550x0 = Pattern.compile("VALUE=\"((?:.|\f)+?)\"");
    public static final Pattern f40552y0 = Pattern.compile("IMPORT=\"((?:.|\f)+?)\"");
    public static final Pattern f40553z0 = Pattern.compile("[:,]ID=\"((?:.|\f)+?)\"");
    ...
    public static b2.n c(String str, String str2, HashMap hashMap) {
        String i10 = i(str, f40530h0, "1", hashMap);
        boolean equals = "urn:uuid:edef8ba9-79d6-4ace-a3c8-27dcd51d21ed".equals(str2);
        Pattern pattern = f40531i0;
        if (equals) {
