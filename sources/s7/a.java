...
public final class a extends Binder implements j, IInterface {
    ...
    public final TaskCompletionSource f44099b;

    public a(int i10, TaskCompletionSource taskCompletionSource) {
        this.f44098a = i10;
        attachInterface(this, "com.google.android.gms.wallet.internal.IWalletServiceCallbacks");
        this.f44099b = taskCompletionSource;
    }
    ...
    public void A(int i10, boolean z4) {
        switch (this.f44098a) {
            case 1:
                r5.a(new Status(i10, null, null, null), Boolean.valueOf(z4), this.f44099b);
                return;
            default:
                return;
        }
    ...
    public void h0(Status status, boolean z4) {
        switch (this.f44098a) {
            case 1:
                r5.a(status, Boolean.valueOf(z4), this.f44099b);
                return;
            default:
                return;
        }
    ...
    public void l0(Status status, j8.i iVar) {
        switch (this.f44098a) {
            case 0:
                int i10 = j8.a.f9243c;
                boolean e = status.e();
                TaskCompletionSource taskCompletionSource = this.f44099b;
                if (e) {
