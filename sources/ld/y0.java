...
public final class y0 extends x0 implements j0 {
    ...
    public y0(Executor executor) {
        ...
        try {
            ...
            if (scheduledThreadPoolExecutor != null && (method = qd.c.f43048a) != null) {
    ...
    public final o0 a(long j10, e2 e2Var, uc.h hVar) {
        ...
        Executor executor = this.f12049c;
        ...
        return f0.f11994s.a(j10, e2Var, hVar);
    }
    ...
    public final boolean equals(Object obj) {
        if ((obj instanceof y0) && ((y0) obj).f12049c == this.f12049c) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return System.identityHashCode(this.f12049c);
    }

    @Override
    public final String toString() {
        return this.f12049c.toString();
    }
}
