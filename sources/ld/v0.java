...
public abstract class v0 extends w0 implements j0 {
    ...
    public static final AtomicReferenceFieldUpdater f11931n = AtomicReferenceFieldUpdater.newUpdater(v0.class, Object.class, "_delayed$volatile");
    public static final AtomicIntegerFieldUpdater f11932r = AtomicIntegerFieldUpdater.newUpdater(v0.class, "_isCompleted$volatile");
    ...
    public o0 a(long j10, e2 e2Var, uc.h hVar) {
        return g0.f11889a.a(j10, e2Var, hVar);
    }
    ...
    public final void o(long j10, t0 t0Var) {
        int c3;
        Thread g10;
        int i10 = f11932r.get(this);
        t0 t0Var2 = null;
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f11931n;
        if (i10 != 0) {
            c3 = 1;
        } else {
    ...
    public void shutdown() {
        ...
        long nanoTime = System.nanoTime();
        while (true) {
            u0 u0Var = (u0) f11931n.get(this);
            if (u0Var != null) {
                synchronized (u0Var) {
                    if (qd.x.f43046b.get(u0Var) > 0) {
                        t0Var = u0Var.d(0);
                    } else {
                        t0Var = null;
                    }
