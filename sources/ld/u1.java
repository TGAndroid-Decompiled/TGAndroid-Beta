...
public class u1 implements f1, r, y1 {
    public static final AtomicReferenceFieldUpdater f12037a = AtomicReferenceFieldUpdater.newUpdater(u1.class, Object.class, "_state$volatile");
    public static final AtomicReferenceFieldUpdater f12038b = AtomicReferenceFieldUpdater.newUpdater(u1.class, Object.class, "_parentHandle$volatile");
    ...
    public static q D(qd.k kVar) {
        while (kVar.h()) {
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = qd.k.f43060b;
            qd.k d = kVar.d();
            if (d == null) {
    ...
    public final void H(k1 k1Var) {
        ...
        qd.k kVar = new qd.k();
        k1Var.getClass();
        qd.k.f43060b.set(kVar, k1Var);
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = qd.k.f43059a;
        ...
        qd.k g10 = k1Var.g();
        do {
            atomicReferenceFieldUpdater = f12037a;
    ...
    public final int I(Object obj) {
        ...
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f12037a;
        if (z4) {
            if (!((q0) obj).f12022a) {
                q0 q0Var = e0.f11989j;
    ...
    public final Object K(Object obj, Object obj2) {
        ...
        synchronized (n1Var) {
            ...
            n1.f12016b.set(n1Var, 1);
            if (n1Var != a1Var2) {
                AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = f12037a;
            ...
            if (qVar2 != null) {
                while (e0.n(qVar2.e, false, new m1(this, n1Var, qVar2, obj2), 1) == w1.f12045a) {
                    qVar2 = D(qVar2);
                    if (qVar2 == null) {
                        return o(n1Var, obj2);
                    }
    ...
    public final void m(a1 a1Var, Object obj) {
        v vVar;
        Throwable th2;
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f12038b;
        p pVar = (p) atomicReferenceFieldUpdater.get(this);
        if (pVar != null) {
            pVar.dispose();
            atomicReferenceFieldUpdater.set(this, w1.f12045a);
        }
        ?? r12 = 0;
        if (obj instanceof v) {
            vVar = (v) obj;
    ...
    public final Object o(n1 n1Var, Object obj) {
        ...
        if (q10 != null && (j(q10) || v(q10))) {
            ...
            v.f12039b.compareAndSet((v) obj, 0, 1);
        }
        F(obj);
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f12037a;
        if (obj instanceof a1) {
