...
public class m extends l0 implements l, wc.d, i2 {
    public static final AtomicIntegerFieldUpdater f12008f = AtomicIntegerFieldUpdater.newUpdater(m.class, "_decisionAndIndex$volatile");
    ...
    public static final AtomicReferenceFieldUpdater f12009n = AtomicReferenceFieldUpdater.newUpdater(m.class, Object.class, "_parentHandle$volatile");
    ...
    public m(int i10, uc.c cVar) {
        ...
        this._state$volatile = b.f11969a;
    }
    ...
    public final void C(Object obj, int i10, dd.l lVar) {
        while (true) {
            ...
            if (obj2 instanceof n) {
                n nVar = (n) obj2;
                if (n.f12014c.compareAndSet(nVar, 0, 1)) {
                    if (lVar != null) {
                        l(lVar, nVar.f12040a);
                        return;
                    }
    ...
    public final void D(a0 a0Var) {
        ...
        C(sc.i.f44318a, i10, null);
    }

    public final o3.c F(dd.l lVar, Object obj) {
        o3.c cVar = e0.f11983a;
        while (true) {
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = h;
            Object obj2 = atomicReferenceFieldUpdater.get(this);
            if (obj2 instanceof x1) {
                Object E = E((x1) obj2, obj, this.f12006c, lVar);
                while (!atomicReferenceFieldUpdater.compareAndSet(this, obj2, E)) {
                    if (atomicReferenceFieldUpdater.get(this) != obj2) {
                        break;
                    }
    ...
    public final void a(qd.t tVar, int i10) {
        ...
        int i11;
        do {
            atomicIntegerFieldUpdater = f12008f;
    ...
    public final void m(qd.t tVar, Throwable th2) {
        uc.h hVar = this.e;
        int i10 = f12008f.get(this) & 536870911;
        if (i10 != 536870911) {
            try {
                tVar.h(i10, hVar);
                return;
    ...
    public final void o() {
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f12009n;
            ...
            if (i11 != 0) {
                if (i11 == 2) {
                    ...
                    if (!(obj instanceof v)) {
                        ...
                        if ((i12 == 1 || i12 == 2) && (f1Var = (f1) this.e.get(b0.f11971b)) != null && !f1Var.isActive()) {
    ...
    public final void s() {
        ...
        if (t6 != null && !(h.get(this) instanceof x1)) {
            t6.dispose();
            f12009n.set(this, w1.f12045a);
        }
    }

    public final o0 t() {
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater;
        f1 f1Var = (f1) this.e.get(b0.f11971b);
        if (f1Var == null) {
            return null;
        }
        o0 n10 = e0.n(f1Var, true, new o(this), 2);
        do {
            atomicReferenceFieldUpdater = f12009n;
    ...
    public final void v(x1 x1Var) {
        ...
        while (true) {
            ...
            if (!z4) {
                if (obj instanceof v) {
                    v vVar = (v) obj;
                    if (v.f12039b.compareAndSet(vVar, 0, 1)) {
                        if (obj instanceof n) {
                            Throwable th2 = vVar.f12040a;
                            if (x1Var instanceof k) {
                                k((k) x1Var, th2);
                                return;
                            } else {
    ...
    public final boolean x() {
        if (this.f12006c == 2) {
            ...
            if (qd.h.f43054n.get((qd.h) cVar) != null) {
                return true;
            }
            return false;
        }
