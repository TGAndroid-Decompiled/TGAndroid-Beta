...
public final class h {
    ...
    public final r5.b f48043b;
    public final o f48044c;
    public final r5.g d;
    public final s5.f f48045e;
    public final ComponentName f48046f;
    public final ComponentName f48047g;
    public final j h;
    public final j f48048i;
    public final f f48049j;
    public final a7.e f48050k;
    public final tl0 f48051l;
    public final d0 f48052m;
    public s5.h f48053n;
    public CastDevice f48054o;
    public c0 f48055p;
    public boolean f48056q;
    public PlaybackStateCompat.CustomAction f48057r;
    public PlaybackStateCompat.CustomAction f48058s;
    public PlaybackStateCompat.CustomAction f48059t;
    public PlaybackStateCompat.CustomAction f48060u;
    ...
    public h(Context context, r5.b bVar, o oVar) {
        ...
        this.f48050k = new a7.e(Looper.getMainLooper(), 2);
        u5.b bVar3 = f.f48022u;
        s5.a aVar3 = bVar.f46725f;
        if (aVar3 != null && (fVar2 = aVar3.d) != null) {
            ...
            if (pVar != null) {
                ...
                if (a2 != null && !a2.isEmpty()) {
                    if (a2.size() > 5) {
                        Log.e(bVar3.f48385a, bVar3.d(s5.e.class.getSimpleName().concat(" provides more than 5 actions."), new Object[0]));
                    } else if (b10 != null && (r1 = b10.length) != 0) {
                        for (int i10 : b10) {
                            if (i10 < 0 || i10 >= size) {
                                Log.e(bVar3.f48385a, bVar3.d(s5.e.class.getSimpleName().concat("provides a compact view action whose index is out of bounds."), new Object[0]));
                                break;
                            }
                        }
                    } else {
                        Log.e(bVar3.f48385a, bVar3.d(s5.e.class.getSimpleName().concat(" doesn't provide any actions for compact view."), new Object[0]));
                    }
                } else {
                    Log.e(bVar3.f48385a, bVar3.d(s5.e.class.getSimpleName().concat(" doesn't provide any action."), new Object[0]));
                }
            }
            fVar3 = new f(context);
        }
        this.f48049j = fVar3;
        this.f48051l = new tl0(this, 8);
    }

    public final void a(s5.h hVar, CastDevice castDevice) {
        s5.a aVar;
        ComponentName componentName;
        r5.b bVar = this.f48043b;
        if (bVar == null) {
            aVar = null;
        } else {
            aVar = bVar.f46725f;
        }
        if (!this.f48056q && bVar != null && aVar != null && this.f48045e != null && hVar != null && castDevice != null && (componentName = this.f48047g) != null) {
            this.f48053n = hVar;
            hVar.p(this.f48052m);
            this.f48054o = castDevice;
            ...
            if (aVar.f47046f) {
                ...
                this.f48055p = c0Var;
                j(0, null);
                CastDevice castDevice2 = this.f48054o;
                if (castDevice2 != null && !TextUtils.isEmpty(castDevice2.d)) {
                    Bundle bundle = new Bundle();
                    String string = context.getResources().getString(2131689513, this.f48054o.d);
    ...
    public final long c(String str, int i10, Bundle bundle) {
        ...
        if (hashCode != -945151566) {
            if (hashCode != -945080078) {
                ...
                s5.h hVar = this.f48053n;
                if (hVar != null && hVar.h()) {
                    q e6 = hVar.e();
                    m.h(e6);
                    if ((128 & e6.f44639n) == 0 && e6.C == 0) {
                        Integer num = (Integer) e6.K.get(e6.f44636c);
            ...
            s5.h hVar2 = this.f48053n;
            if (hVar2 != null && hVar2.h()) {
                q e10 = hVar2.e();
                m.h(e10);
                if ((64 & e10.f44639n) == 0 && e10.C == 0) {
                    Integer num2 = (Integer) e10.K.get(e10.f44636c);
    ...
    public final Uri d(l lVar) {
        a6.a aVar;
        s5.a aVar2 = this.f48043b.f46725f;
        if (aVar2 != null) {
            aVar2.e();
        }
        List list = lVar.f44611a;
        if (list != null && !list.isEmpty()) {
            aVar = (a6.a) lVar.f44611a.get(0);
        } else {
            aVar = null;
        }
        if (aVar == null) {
    ...
    public final void g(boolean z4) {
        if (this.f48043b.h) {
            a7.e eVar = this.f48050k;
            tl0 tl0Var = this.f48051l;
            if (tl0Var != null) {
    ...
    public final void h() {
        ...
        if (fVar != null) {
            ...
            jVar.C();
            jVar.f2318e = null;
            NotificationManager notificationManager = fVar.f48024b;
    ...
    public final void i() {
        ...
        this.f48050k.removeCallbacks(this.f48051l);
        Context context = this.f48042a;
        Intent intent = new Intent(context, ReconnectionService.class);
        intent.setPackage(context.getPackageName());
    ...
    public final void j(int i10, MediaInfo mediaInfo) {
        ...
        if (c0Var2 != null) {
            ...
            f0 f0Var = new f0();
            s5.h hVar = this.f48053n;
            s5.f fVar = this.f48045e;
            if (hVar != null && this.f48049j != null) {
                if (hVar.s() == 0 || hVar.j()) {
                    j11 = 0;
                } else {
                    j11 = hVar.a();
                ...
                if (i10 == 0) {
                    ...
                    s5.h hVar2 = this.f48053n;
                    if (hVar2 == null || hVar2.j() || this.f48053n.n()) {
                        j12 = 0;
                    } else {
                        j12 = 256;
                    }
            ...
            if (i10 != 0) {
                if (this.f48053n != null) {
                    ComponentName componentName = this.f48046f;
                    if (componentName == null) {
                        activity = null;
                    } else {
                        Intent intent = new Intent();
                        intent.setComponent(componentName);
                        activity = PendingIntent.getActivity(this.f48042a, 0, intent, x.f3164a | 134217728);
                    }
                    if (activity != null) {
                        vVar.f303a.setSessionActivity(activity);
                    }
                }
                s5.h hVar3 = this.f48053n;
                if (hVar3 != null && (c0Var = this.f48055p) != null && mediaInfo != null && (lVar = mediaInfo.d) != null) {
                    Bundle bundle2 = lVar.f44612b;
                    if (hVar3.j()) {
                        j10 = 0;
                    } else {
