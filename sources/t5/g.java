...
public final class g extends s {
    ...
    public final void onCustomAction(String str, Bundle bundle) {
        ...
        switch (hashCode) {
            ...
            case 1362116196:
                if (str.equals("com.google.android.gms.cast.framework.action.FORWARD")) {
                    long j11 = hVar.e.f44063c;
                    s5.h hVar4 = hVar.f44606n;
                    if (hVar4 != null) {
                        long min2 = Math.min(hVar4.g(), Math.max(0L, hVar4.a() + j11));
                        s5.h hVar5 = hVar.f44606n;
                        if (hVar5 != null) {
                            hVar5.q(new p(min2));
                            return;
                        }
        ...
        intent.setComponent(hVar.f44600g);
        hVar.f44596a.sendBroadcast(intent);
    }
    ...
    public final boolean onMediaButtonEvent(Intent intent) {
        ...
        if (keyEvent != null) {
            if ((keyEvent.getKeyCode() == 127 || keyEvent.getKeyCode() == 126) && (hVar = this.f44595a.f44606n) != null) {
                hVar.r();
                return true;
            }
            return true;
    ...
    public final void onPause() {
        ...
        s5.h hVar = this.f44595a.f44606n;
        if (hVar != null) {
            hVar.r();
        }
    }
