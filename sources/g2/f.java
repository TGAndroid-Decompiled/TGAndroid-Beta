...
public final class f extends c {
    ...
    public final long open(m mVar) {
        ...
        if (split.length == 2) {
            ...
            if (split[0].contains(";base64")) {
                try {
                    this.f9359b = Base64.decode(str2, 0);
                } catch (IllegalArgumentException e) {
                    throw new s0(p6.i("Error while parsing Base64 encoded string: ", str2), e, true, 0);
                }
            } else {
                this.f9359b = URLDecoder.decode(str2, StandardCharsets.US_ASCII.name()).getBytes(StandardCharsets.UTF_8);
            }
            long j10 = mVar.e;
    ...
    public final int read(byte[] bArr, int i10, int i11) {
        ...
        byte[] bArr2 = this.f9359b;
        String str = e2.d0.f7883a;
        System.arraycopy(bArr2, this.f9360c, bArr, i10, min);
        this.f9360c += min;
        this.d -= min;
