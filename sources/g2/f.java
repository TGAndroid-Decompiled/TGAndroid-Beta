...
public final class f extends c {
    ...
    public final long open(m mVar) {
        ...
        if (split.length == 2) {
            ...
            if (split[0].contains(";base64")) {
                try {
                    this.f10340b = Base64.decode(str2, 0);
                } catch (IllegalArgumentException e7) {
                    throw new s0(p6.i("Error while parsing Base64 encoded string: ", str2), e7, true, 0);
                }
            } else {
                this.f10340b = URLDecoder.decode(str2, StandardCharsets.US_ASCII.name()).getBytes(StandardCharsets.UTF_8);
            }
            long j10 = mVar.f10361e;
            byte[] bArr = this.f10340b;
            if (j10 <= bArr.length) {
                int i10 = (int) j10;
                this.f10341c = i10;
    ...
    public final int read(byte[] bArr, int i10, int i11) {
        ...
        byte[] bArr2 = this.f10340b;
        String str = e2.d0.f8765a;
        System.arraycopy(bArr2, this.f10341c, bArr, i10, min);
        this.f10341c += min;
        this.d -= min;
