...
public final class l0 implements r0.n0, qx {
    ...
    public boolean d() {
        ...
        if (chatActivityEnterView.f24682t3) {
            if ((chatActivityEnterView.f24692v3 || (ffVar = chatActivityEnterView.B0) == null || ffVar.length() <= 0) && (dzVar = chatActivityEnterView.R0.f29333v0) != null && dzVar.h() > 0 && !chatActivityEnterView.f24613g3) {
                return true;
            }
            return false;
        }
    ...
    public void e() {
        int i10;
        ChatActivityEnterView chatActivityEnterView = (ChatActivityEnterView) this.f1840c;
        pv0 pv0Var = chatActivityEnterView.f24623i1;
        if (d()) {
            AnimatorSet animatorSet = chatActivityEnterView.f24704x3;
            if (animatorSet != null) {
                animatorSet.cancel();
            }
            chatActivityEnterView.A3 = true;
            this.f1838a = chatActivityEnterView.f24692v3;
            chatActivityEnterView.f24692v3 = true;
            ...
            chatActivityEnterView.f24715z3 = height;
            if (chatActivityEnterView.N1 == 2) {
                ...
                chatActivityEnterView.f24715z3 = Math.min(height, dp + i10);
            }
            if (chatActivityEnterView.Z4 == null) {
                chatActivityEnterView.R0.getLayoutParams().height = chatActivityEnterView.f24715z3;
            }
