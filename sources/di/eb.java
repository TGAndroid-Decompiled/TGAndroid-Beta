...
public final class eb extends View {
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.f7208a) {
            case 0:
                canvas.save();
                pc pcVar = (pc) this.f7209b;
                canvas.translate(pcVar.f7878c1.getX() + pcVar.f7906l0.getX(), pcVar.f7878c1.getY() + pcVar.f7906l0.getY());
                fc fcVar = pcVar.f7878c1;
                fcVar.k(canvas, fcVar.getBounds(), pcVar.f7878c1.getOver2Alpha());
                canvas.restore();
                return;
            case 5:
                bh.c cVar = ((ih.g) this.f7209b).I;
                if (cVar != null) {
                    cVar.draw(canvas);
                }
                ...
                return;
            case 8:
                canvas.drawRect(0.0f, 0.0f, getWidth(), getHeight(), ((org.telegram.ui.ActionBar.i3) this.f7209b).d);
                return;
            default:
                super.dispatchDraw(canvas);
                return;
    ...
    public void draw(Canvas canvas) {
        switch (this.f7208a) {
            case 17:
                super.draw(canvas);
                ((f01) this.f7209b).e(canvas, (getMeasuredWidth() - ((f01) this.f7209b).l()) / 2.0f, getMeasuredHeight() / 2.0f);
                return;
            case 21:
                super.draw(canvas);
                hq0 hq0Var = (hq0) this.f7209b;
    ...
    public void onAttachedToWindow() {
        switch (this.f7208a) {
            case 4:
                ...
                ((hg.q1) this.f7209b).f11249f = true;
                return;
            case 7:
                super.onAttachedToWindow();
                ((CheckBoxBase) this.f7209b).f23930l = true;
                return;
            default:
                super.onAttachedToWindow();
                return;
    ...
    public void onDetachedFromWindow() {
        switch (this.f7208a) {
            case 4:
                ...
                ((hg.q1) this.f7209b).f11249f = false;
                return;
            case 7:
                super.onDetachedFromWindow();
                ((CheckBoxBase) this.f7209b).f23930l = false;
                return;
            default:
                super.onDetachedFromWindow();
                return;
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.f7208a) {
            case 3:
                super.onDraw(canvas);
                gi.k0 k0Var = (gi.k0) this.f7209b;
                yf.z zVar = k0Var.K;
                float max = Math.max(k0Var.f10737b.f15395e, k0Var.f10738c.f15395e);
                yf.z zVar2 = k0Var.J;
                zVar2.c(AndroidUtilities.dp(42.0f) + k0Var.U.f11452b, 0);
                zVar2.setBounds(0, 0, getWidth(), AndroidUtilities.dp(56.0f) + k0Var.U.f11452b);
            ...
            case 6:
                ...
                ((ji.t0) this.f7209b).f14205c.draw(canvas);
                canvas.restore();
                return;
            case 7:
                int dp = AndroidUtilities.dp(20.0f);
                CheckBoxBase checkBoxBase = (CheckBoxBase) this.f7209b;
                checkBoxBase.e((getWidth() - dp) / 2, (getHeight() - dp) / 2, dp, dp);
                checkBoxBase.a(canvas);
                return;
            case 11:
                org.telegram.ui.Cells.r2 r2Var = (org.telegram.ui.Cells.r2) this.f7209b;
                r2Var.f22610j4.setBounds(0, 0, getWidth(), getHeight());
                r2Var.f22610j4.draw(canvas);
                return;
            case 16:
                fr frVar = (fr) this.f7209b;
                if (frVar.Z) {
                    canvas.drawRect(fr.R(frVar), 0.0f, getMeasuredWidth() - fr.S(frVar), 1.0f, org.telegram.ui.ActionBar.j6.f20813k0);
                    return;
                }
                return;
            case 20:
                super.onDraw(canvas);
                ((hu0) this.f7209b).j(canvas, getMeasuredWidth(), getMeasuredHeight());
                return;
            case 23:
                super.onDraw(canvas);
                int offsetColor = AndroidUtilities.getOffsetColor(-9057429, -10513163, getTranslationX() / getMeasuredWidth(), 1.0f);
                int offsetColor2 = AndroidUtilities.getOffsetColor(-11554882, -4629871, getTranslationX() / getMeasuredWidth(), 1.0f);
                tp0 tp0Var = (tp0) this.f7209b;
                RectF rectF = tp0Var.h;
                Paint paint2 = tp0Var.f26518f;
                if (offsetColor != 0) {
                ...
                return;
            case 24:
                ov0 ov0Var = (ov0) this.f7209b;
                if (ov0Var.f29227b != null && !ov0Var.J) {
                    Drawable newDrawable = ov0Var.getNewDrawable();
                    boolean newDrawableMotion = ov0Var.getNewDrawableMotion();
                    Drawable drawable3 = ov0Var.f29227b;
                    if (newDrawable != drawable3 && newDrawable != null) {
                        if (org.telegram.ui.ActionBar.j6.sl != null) {
                            ov0Var.d = drawable3;
                            ov0Var.f29232e = ov0Var.f29229c;
                        }
                        if (newDrawable instanceof dc0) {
                            ((dc0) newDrawable).r(ov0Var.L);
                        }
                        ov0Var.f29227b = newDrawable;
                        if (ov0Var.M && (newDrawable instanceof go)) {
                            ((go) newDrawable).f(this);
                        }
                        if (ov0Var.M) {
                            Drawable drawable4 = ov0Var.f29227b;
                            if (drawable4 instanceof dc0) {
                                ((dc0) drawable4).k();
                            }
                        }
                        ov0Var.f29229c = newDrawableMotion;
                        ov0Var.f29241l0 = 0.0f;
                        ov0Var.U(ov0Var.f29227b);
                        ov0Var.I();
                    } else if (ov0Var.f29229c != newDrawableMotion) {
                        ov0Var.f29229c = newDrawableMotion;
                        ov0Var.I();
                    }
                    ov0Var.f29241l0 = Utilities.clamp((AndroidUtilities.screenRefreshTime / 200.0f) + ov0Var.f29241l0, 1.0f, 0.0f);
                    for (int i15 = 0; i15 < 2; i15++) {
                        if (i15 == 0) {
                            drawable = ov0Var.d;
                        } else {
                            drawable = ov0Var.f29227b;
                        }
                        if (drawable != null) {
                            boolean z11 = true;
                            if (i15 == 1 && ov0Var.d != null && ov0Var.G != null) {
                                drawable.setAlpha((int) (ov0Var.f29241l0 * 255.0f));
                            } else {
                            ...
                            if (i15 == 0 && (drawable2 = ov0Var.d) != null && ov0Var.f29241l0 >= f12) {
                                ...
                                ov0Var.d = null;
                                ov0Var.f29232e = false;
                                ov0Var.I();
                                ov0Var.L.invalidate();
                            }
                        }
                    }
                    if (ov0Var.f29241l0 != 1.0f) {
                        ov0Var.L.invalidate();
                        return;
                    }
                    return;
            ...
            case 26:
                ...
                ey0 ey0Var = (ey0) this.f7209b;
                org.telegram.ui.Components.voip.h hVar = ey0Var.L;
                Paint paint3 = ey0Var.f25833a;
                paint3.setColor(w02);
                Paint paint4 = ey0Var.f25834b;
                paint4.setColor(w02);
                Paint paint5 = ey0Var.f25835c;
                paint5.setColor(w02);
                paint4.setAlpha(255);
                paint5.setAlpha(82);
                paint3.setAlpha(46);
                Paint paint6 = ey0Var.d;
                paint6.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20691d6, false));
            ...
            case 27:
                if (getAlpha() != 0.0f) {
                    ...
                    ((org.telegram.ui.Components.voip.h1) this.f7209b).f31551n.a(AndroidUtilities.dp(10.0f), canvas, rectF3, null);
                    invalidate();
                    return;
                }
                return;
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.f7208a) {
            case 1:
                ei.i iVar = (ei.i) this.f7209b;
                if (iVar.H) {
                    i12 = (ei.i.y0(iVar).getMeasuredHeight() + iVar.I) - AndroidUtilities.dp(16.0f);
                } else {
                    int dp = AndroidUtilities.dp(140.0f) + iVar.I;
                    if (AndroidUtilities.dp(24.0f) + iVar.f40077y.getMeasuredHeight() > dp) {
                        dp = AndroidUtilities.dp(24.0f) + iVar.f40077y.getMeasuredHeight();
                    }
                    i12 = dp;
                }
                ...
                return;
            case 2:
                fi.m mVar = (fi.m) this.f7209b;
                if (mVar.H) {
                    i13 = (fi.m.B0(mVar).getMeasuredHeight() + mVar.I) - AndroidUtilities.dp(16.0f);
                } else {
                    int dp2 = AndroidUtilities.dp(140.0f) + mVar.I;
                    if (AndroidUtilities.dp(24.0f) + mVar.f40077y.getMeasuredHeight() > dp2) {
                        dp2 = AndroidUtilities.dp(24.0f) + mVar.f40077y.getMeasuredHeight();
                    }
                    i13 = dp2;
                }
            ...
            case 8:
                ...
                return;
            case 9:
                s4.c0 c0Var = ((org.telegram.ui.o5) this.f7209b).d.F;
                ...
                return;
            case 12:
                org.telegram.ui.Components.bb bbVar = (org.telegram.ui.Components.bb) this.f7209b;
                int i18 = bbVar.h;
                if (i18 == 0) {
                ...
                return;
            case 13:
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), View.MeasureSpec.makeMeasureSpec(((hm) this.f7209b).v.J, 1073741824));
                return;
            case 14:
                setMeasuredDimension(View.MeasureSpec.getSize(i10), ((rn) this.f7209b).d.R0);
                return;
            case 15:
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), View.MeasureSpec.makeMeasureSpec(((un) ((org.telegram.ui.w7) this.f7209b).d).f30956w, 1073741824));
                return;
            case 17:
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(getPaddingRight() + getPaddingLeft() + Math.round(((f01) this.f7209b).l()), 1073741824), View.MeasureSpec.makeMeasureSpec(Math.max(getPaddingBottom() + getPaddingTop() + Math.round(((f01) this.f7209b).j()), AndroidUtilities.dp(26.0f)), 1073741824));
                return;
            case 18:
                super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(48.0f) + ((v60) this.f7209b).f31170c.f24608o0, 1073741824));
                return;
            case 19:
                int dp3 = AndroidUtilities.dp(48.0f);
                b70 b70Var = ((x60) this.f7209b).f32465n;
                super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(dp3 + b70Var.f24608o0 + b70Var.f24614u0, 1073741824));
                return;
            case 22:
                super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(((dq0) this.f7209b).K.J.R, 1073741824));
                return;
            case 25:
                mw0 mw0Var = (mw0) this.f7209b;
            ...
            case 26:
                ...
                return;
            case 29:
                r20 r20Var = (r20) this.f7209b;
                if (r20Var.H) {
                    r20Var.J = (r20.U(r20Var).getMeasuredHeight() + r20Var.I) - AndroidUtilities.dp(16.0f);
                } else {
                    int dp4 = AndroidUtilities.dp(140.0f) + r20Var.I;
                    if (AndroidUtilities.dp(24.0f) + r20Var.f40077y.getMeasuredHeight() > dp4) {
                        dp4 = Math.max(dp4, (AndroidUtilities.dp(24.0f) + r20Var.f40077y.getMeasuredHeight()) - r20Var.L);
                    }
                    r20Var.J = dp4;
                }
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        switch (this.f7208a) {
            case 27:
                ...
                ((org.telegram.ui.Components.voip.h1) this.f7209b).f31551n.f31531f = i10;
                return;
            default:
                super.onSizeChanged(i10, i11, i12, i13);
                return;
    ...
    public void setAlpha(float f7) {
        switch (this.f7208a) {
            case 10:
                super.setAlpha(f7);
                View view = ((org.telegram.ui.c8) this.f7209b).f35049b.f35999x.fragmentView;
                if (view != null) {
                    view.invalidate();
                    return;
                }
            ...
            case 28:
                super.setAlpha(f7);
                View view2 = ((uy) this.f7209b).fragmentView;
                if (view2 != null) {
                    view2.invalidate();
                    return;
                }
    ...
    public void setTranslationY(float f7) {
        switch (this.f7208a) {
            case 12:
                ...
                org.telegram.ui.Components.bb.r((org.telegram.ui.Components.bb) this.f7209b).invalidate();
                return;
            default:
                super.setTranslationY(f7);
                return;
