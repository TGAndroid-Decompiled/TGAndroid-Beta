...
public final class eb extends View {
    ...
    public void onAttachedToWindow() {
        switch (this.f7180a) {
            ...
            case 7:
                super.onAttachedToWindow();
                ((CheckBoxBase) this.f7181b).f23903l = true;
                return;
            default:
                super.onAttachedToWindow();
                return;
    ...
    public void onDetachedFromWindow() {
        switch (this.f7180a) {
            ...
            case 7:
                super.onDetachedFromWindow();
                ((CheckBoxBase) this.f7181b).f23903l = false;
                return;
            default:
                super.onDetachedFromWindow();
                return;
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.f7180a) {
            ...
            case 11:
                ...
                r2Var.f22583j4.setBounds(0, 0, getWidth(), getHeight());
                r2Var.f22583j4.draw(canvas);
                return;
            case 16:
                fr frVar = (fr) this.f7181b;
                if (frVar.Z) {
                    canvas.drawRect(fr.R(frVar), 0.0f, getMeasuredWidth() - fr.S(frVar), 1.0f, org.telegram.ui.ActionBar.j6.f20786k0);
                    return;
                }
                return;
            case 20:
            ...
            case 24:
                ...
                if (ov0Var.f29200b != null && !ov0Var.J) {
                    Drawable newDrawable = ov0Var.getNewDrawable();
                    boolean newDrawableMotion = ov0Var.getNewDrawableMotion();
                    Drawable drawable3 = ov0Var.f29200b;
                    if (newDrawable != drawable3 && newDrawable != null) {
                        if (org.telegram.ui.ActionBar.j6.sl != null) {
                            ov0Var.d = drawable3;
                            ov0Var.f29205e = ov0Var.f29202c;
                        }
                        if (newDrawable instanceof dc0) {
                            ((dc0) newDrawable).r(ov0Var.L);
                        }
                        ov0Var.f29200b = newDrawable;
                        if (ov0Var.M && (newDrawable instanceof go)) {
                            ((go) newDrawable).f(this);
                        }
                        if (ov0Var.M) {
                            Drawable drawable4 = ov0Var.f29200b;
                            if (drawable4 instanceof dc0) {
                                ((dc0) drawable4).k();
                            }
                        }
                        ov0Var.f29202c = newDrawableMotion;
                        ov0Var.f29214l0 = 0.0f;
                        ov0Var.U(ov0Var.f29200b);
                        ov0Var.I();
                    } else if (ov0Var.f29202c != newDrawableMotion) {
                        ov0Var.f29202c = newDrawableMotion;
                        ov0Var.I();
                    }
                    ov0Var.f29214l0 = Utilities.clamp((AndroidUtilities.screenRefreshTime / 200.0f) + ov0Var.f29214l0, 1.0f, 0.0f);
                    for (int i15 = 0; i15 < 2; i15++) {
                        if (i15 == 0) {
                            drawable = ov0Var.d;
                        } else {
                            drawable = ov0Var.f29200b;
                        }
                        if (drawable != null) {
                            boolean z11 = true;
                            if (i15 == 1 && ov0Var.d != null && ov0Var.G != null) {
                                drawable.setAlpha((int) (ov0Var.f29214l0 * 255.0f));
                            } else {
                            ...
                            if (i15 == 0 && (drawable2 = ov0Var.d) != null && ov0Var.f29214l0 >= f12) {
                                ...
                                ov0Var.d = null;
                                ov0Var.f29205e = false;
                                ov0Var.I();
                                ov0Var.L.invalidate();
                            }
                        }
                    }
                    if (ov0Var.f29214l0 != 1.0f) {
                        ov0Var.L.invalidate();
                        return;
                    }
                    return;
            ...
            case 26:
                ...
                Paint paint3 = ey0Var.f25806a;
                paint3.setColor(w02);
                Paint paint4 = ey0Var.f25807b;
                paint4.setColor(w02);
                Paint paint5 = ey0Var.f25808c;
                paint5.setColor(w02);
                paint4.setAlpha(255);
                paint5.setAlpha(82);
                paint3.setAlpha(46);
                Paint paint6 = ey0Var.d;
                paint6.setColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20664d6, false));
            ...
            case 27:
                if (getAlpha() != 0.0f) {
                    ...
                    ((org.telegram.ui.Components.voip.h1) this.f7181b).f31524n.a(AndroidUtilities.dp(10.0f), canvas, rectF3, null);
                    invalidate();
                    return;
                }
                return;
        ...
        switch (this.f7180a) {
            case 1:
                ...
                if (iVar.H) {
                    ...
                    if (AndroidUtilities.dp(24.0f) + iVar.f40050y.getMeasuredHeight() > dp) {
                        dp = AndroidUtilities.dp(24.0f) + iVar.f40050y.getMeasuredHeight();
                    }
                    i12 = dp;
                }
            ...
            case 2:
                ...
                if (mVar.H) {
                    ...
                    if (AndroidUtilities.dp(24.0f) + mVar.f40050y.getMeasuredHeight() > dp2) {
                        dp2 = AndroidUtilities.dp(24.0f) + mVar.f40050y.getMeasuredHeight();
                    }
                    i13 = dp2;
                }
            ...
            case 14:
                ...
                return;
            case 15:
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), View.MeasureSpec.makeMeasureSpec(((un) ((org.telegram.ui.w7) this.f7181b).d).f30929w, 1073741824));
                return;
            case 17:
                ...
                return;
            case 18:
                super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(48.0f) + ((v60) this.f7181b).f31143c.f24581o0, 1073741824));
                return;
            case 19:
                int dp3 = AndroidUtilities.dp(48.0f);
                b70 b70Var = ((x60) this.f7181b).f32438n;
                super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(dp3 + b70Var.f24581o0 + b70Var.f24587u0, 1073741824));
                return;
            case 22:
            ...
            case 29:
                ...
                if (r20Var.H) {
                    ...
                    if (AndroidUtilities.dp(24.0f) + r20Var.f40050y.getMeasuredHeight() > dp4) {
                        dp4 = Math.max(dp4, (AndroidUtilities.dp(24.0f) + r20Var.f40050y.getMeasuredHeight()) - r20Var.L);
                    }
                    r20Var.J = dp4;
                }
    ...
    public void onSizeChanged(int i10, int i11, int i12, int i13) {
        switch (this.f7180a) {
            case 27:
                ...
                ((org.telegram.ui.Components.voip.h1) this.f7181b).f31524n.f31504f = i10;
                return;
            default:
                super.onSizeChanged(i10, i11, i12, i13);
                return;
    ...
    public void setAlpha(float f7) {
        switch (this.f7180a) {
            case 10:
                super.setAlpha(f7);
                View view = ((org.telegram.ui.c8) this.f7181b).f35022b.f35972x.fragmentView;
                if (view != null) {
                    view.invalidate();
                    return;
                }
