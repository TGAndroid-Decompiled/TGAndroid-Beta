...
public final class w7 extends View {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (f01Var != null && this.f8369s != null && e7 > 0.0f) {
            f01Var.f25886p = getWidth() * 0.7f;
            this.f8369s.f25886p = getWidth() * 0.7f;
            ...
            float max = Math.max(min, Math.max(this.f8368r.f25875c, this.f8369s.f25875c) + f7 + dp + AndroidUtilities.dp(15.0f) + dp);
            if (this.f8367n) {
                f10 = dp3;
            } else {
                f10 = 0.0f;
