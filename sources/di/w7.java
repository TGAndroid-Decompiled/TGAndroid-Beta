...
public final class w7 extends View {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (f01Var != null && this.f8341s != null && e7 > 0.0f) {
            f01Var.f25859p = getWidth() * 0.7f;
            this.f8341s.f25859p = getWidth() * 0.7f;
            ...
            float max = Math.max(min, Math.max(this.f8340r.f25848c, this.f8341s.f25848c) + f7 + dp + AndroidUtilities.dp(15.0f) + dp);
            if (this.f8339n) {
                f10 = dp3;
            } else {
                f10 = 0.0f;
