...
public final class a1 {
    ...
    public final o8 a() {
        ...
        if (str4 != null) {
            ...
            if (org.telegram.ui.ActionBar.j6.f20859o2 == null) {
                org.telegram.ui.ActionBar.j6.O();
            }
            CharSequence replaceEmoji = Emoji.replaceEmoji(spannableString, org.telegram.ui.ActionBar.j6.f20859o2.getFontMetricsInt(), true);
            MessageObject.addEntitiesToText(replaceEmoji, this.f6894w, true, false, true, false);
            o8Var.C0 = MessageObject.replaceAnimatedEmoji(replaceEmoji, this.f6894w, org.telegram.ui.ActionBar.j6.f20859o2.getFontMetricsInt());
        } else {
            o8Var.C0 = "";
        }
