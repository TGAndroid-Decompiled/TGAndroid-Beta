...
public final class u6 extends FrameLayout {
    ...
    public final void b(boolean z10, boolean z11) {
        ...
        ValueAnimator valueAnimator = this.f8282s;
        ...
        if (z11) {
            ...
            if (this.f8281r) {
                this.f8282s.setDuration(450L);
                this.f8282s.setInterpolator(new LinearInterpolator());
            } else {
                this.f8282s.setDuration(350L);
                this.f8282s.setInterpolator(pr.h);
            }
            this.f8282s.start();
            return;
        }
    ...
    public final void e() {
        ...
        view.setAlpha(this.f8280n);
        view.setTranslationY((1.0f - this.f8280n) * AndroidUtilities.dp(16.0f));
        for (int i10 = 1; i10 < getChildCount(); i10++) {
            View childAt = getChildAt(i10);
            float f7 = this.f8280n;
            if (this.f8281r) {
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        int i15 = i12 - i10;
        int i16 = i13 - i11;
        this.f8275a.layout(0, 0, i15, i16);
        t6 t6Var = this.f8277c;
        t6Var.layout(i15 - t6Var.getMeasuredWidth(), (i16 - this.f8277c.getMeasuredHeight()) / 2, i15, (this.f8277c.getMeasuredHeight() + i16) / 2);
        int dp = (i15 - AndroidUtilities.dp(32.33f)) - this.f8277c.getMeasuredWidth();
        int i17 = 0;
