...
public final class m6 extends FrameLayout {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        Paint paint = rbVar.f8027y1;
        Paint paint2 = rbVar.f8025x1;
        Paint paint3 = rbVar.f8029z1;
        ...
        if (barView.getChildCount() >= 1 && rbVar.D1 != 1.0f) {
            ...
            if (childAt.getAlpha() != 0.0f) {
                ...
                if (i11 != -1) {
                    ...
                    x10 = AndroidUtilities.lerp(x10, (((childAt2.getWidth() - childAt2.getPaddingLeft()) - childAt2.getPaddingRight()) / 2.0f) + childAt2.getX() + childAt2.getPaddingLeft(), rbVar.f7981a1);
                    y3 = AndroidUtilities.lerp(y3, (((childAt2.getHeight() - childAt2.getPaddingTop()) - childAt2.getPaddingBottom()) / 2.0f) + childAt2.getY() + childAt2.getPaddingTop(), rbVar.f7981a1);
                }
                if (r5Var != null && r5Var.getChildCount() > 0) {
                    ...
                    i10 = i0.a.d(rbVar.D1, q1Var.f44570a, this.f7672c.b(0));
                }
                float f7 = x10;
                float f10 = y3;
                if (f7 != this.f7670a || f10 != this.f7671b) {
                    this.f7670a = f7;
                    this.f7671b = f10;
