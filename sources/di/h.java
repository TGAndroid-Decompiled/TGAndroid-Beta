...
public final class h extends bb implements NotificationCenter.NotificationCenterDelegate {
    ...
    public h(Context context, d6 d6Var, zf.a aVar, boolean z10, Runnable runnable) {
        ...
        this.Y = d1Var;
        ((TextView) d1Var.f693c).setText(LocaleController.formatString(R.string.TonNeededTitle, zf.a.i(aVar.f49225b - s5.y(this.currentAccount, true).s().f49225b, zf.b.f49227b).d()));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.starOptionsLoaded || i10 == NotificationCenter.starBalanceUpdated) {
            ...
            zf.a aVar = this.X;
            ((TextView) this.Y.f693c).setText(LocaleController.formatString(i12, zf.a.i(aVar.f49225b - s10.f49225b, zf.b.f49227b).d()));
            xa xaVar = this.e;
            if (xaVar != null) {
                xaVar.setTitle(y());
            }
            if (s10.f49225b >= aVar.f49225b && (runnable = this.f7739a0) != null) {
                runnable.run();
                this.f7739a0 = null;
                dismiss();
            }
    ...
    public final void show() {
        jk jkVar;
        if (s5.y(this.currentAccount, true).s().f49225b >= this.X.f49225b) {
