    ...
    public ScheduledFuture a(final l.d dVar) {
        switch (this.f8476a) {
            case 5:
                ...
                return fVar.f45051b.schedule(new r9.d(fVar, (Runnable) this.d, dVar, 1), this.f8477b, (TimeUnit) this.f8479e);
            default:
                final r9.f fVar2 = (r9.f) this.f8478c;
                final Callable callable = (Callable) this.d;
                return fVar2.f45051b.schedule(new Callable() {
                    @Override
                    public final Object call() {
                        return f.this.f45050a.submit(new g1(14, callable, dVar));
                    }
    ...
    public void g(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        switch (this.f8476a) {
            ...
            default:
                ...
                ProfileActivity profileActivity = ((i01) this.f8478c).f37150b;
