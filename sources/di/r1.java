        ...
        switch (this.f8083a) {
            ...
            case 3:
                ...
                if (view instanceof org.telegram.ui.Cells.o8) {
                    ...
                    recyclerView.getClass();
                    if (RecyclerView.R(view) + 1 > kzVar.R.E && !UserConfig.getInstance(kzVar.f27960c1).isPremium() && !kzVar.U0) {
            ...
            case 5:
                recyclerView.getClass();
                if (RecyclerView.R(view) == ((gi0) this.f8084b).f36712c.size() - 1) {
                    rect.bottom = AndroidUtilities.dp(4.0f);
                    return;
                }
                return;
            case 6:
                ...
                if (R == tj0Var.f40798c0.size()) {
                    rect.bottom = tj0Var.f40807l0;
                    return;
                }
                return;
            case 7:
                ...
                int i13 = vp0Var.f41630b0;
                if (R2 >= i13) {
                    int i14 = vp0Var.f41637f0;
                    if (R2 < i13 + i14) {
                        int i15 = R2 - i13;
                        int i16 = i15 / 3;
                        boolean z13 = true;
            ...
            default:
                ...
                if (R3 == a1Var.f47075d0.size()) {
                    rect.bottom = a1Var.f47086p0;
                    return;
                }
                return;
        }
