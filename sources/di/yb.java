    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f8519a) {
            ...
            case 1:
                ...
                bdVar.f34780n0 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                bdVar.m0.invalidate();
                if (!this.f8520b && bdVar.f34780n0 > 0.5f) {
                    this.f8520b = true;
                    return;
                }
                return;
            ...
            default:
                ...
                wd1Var.f41972i2 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                wd1Var.f41969h2.invalidate();
                if (!this.f8520b && wd1Var.f41972i2 > 0.5f) {
                    this.f8520b = true;
                    return;
                }
                return;
