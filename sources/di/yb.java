    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f8491a) {
            ...
            case 1:
                ...
                bdVar.f34753n0 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                bdVar.m0.invalidate();
                if (!this.f8492b && bdVar.f34753n0 > 0.5f) {
                    this.f8492b = true;
                    return;
                }
                return;
            ...
            default:
                ...
                wd1Var.f41945i2 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                wd1Var.f41942h2.invalidate();
                if (!this.f8492b && wd1Var.f41945i2 > 0.5f) {
                    this.f8492b = true;
                    return;
                }
                return;
