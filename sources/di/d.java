...
public class d extends FrameLayout implements g90 {
    ...
    public final void d() {
        this.f7050w = true;
        setFilled(true);
        setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f21057xa, this.f7035a));
        j();
    }
    ...
    public final void f(CharSequence charSequence, boolean z10) {
        ...
        if (this.J && !z11) {
            ...
            this.I.setInterpolator(pr.f29494f);
            this.I.start();
        } else {
    ...
    public final void j() {
        ...
        if (!this.f7051x) {
            if (this.f7050w) {
                i12 = org.telegram.ui.ActionBar.j6.f21057xa;
            } else {
        ...
        if (this.f7049s) {
            if (this.f7050w) {
                i10 = org.telegram.ui.ActionBar.j6.f21074ya;
            } else {
        ...
        if (z10) {
            int v03 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20781i6, this.f7035a);
            int i13 = this.f7037b;
            view.setBackground(org.telegram.ui.ActionBar.j6.Y(v03, i13, i13));
        } else {
            int l1 = org.telegram.ui.ActionBar.j6.l1(0.1f, p6Var.f29312a.getColor());
            int i14 = this.f7037b;
            view.setBackground(org.telegram.ui.ActionBar.j6.Y(l1, i14, i14));
        }
        if (this.f7049s) {
            if (this.f7050w) {
                i11 = org.telegram.ui.ActionBar.j6.f21074ya;
            } else {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.L) {
            if (this.N) {
                if (this.K == null) {
                    ...
                    h90 h90Var2 = this.K;
                    h90Var2.f26716t = 2.0f;
                    h90Var2.C = true;
                    h90Var2.f26718w.setStrokeWidth(0.0f);
        ...
        if (f14 > 0.0f) {
            if (this.f7038b0 == null) {
                this.f7038b0 = new sp(p6Var.f29312a.getColor());
            }
        ...
        if (f15 < 1.0f) {
            ...
            rect.set((int) (((getMeasuredWidth() - a2) - getWidth()) / 2.0f), (int) (((getMeasuredHeight() - p6Var.f29315e) / 2.0f) - AndroidUtilities.dp(1.0f)), (int) org.telegram.messenger.w1.a(getMeasuredWidth() - a2, getWidth(), 2.0f, d), (int) (((getMeasuredHeight() + p6Var.f29315e) / 2.0f) - AndroidUtilities.dp(1.0f)));
            rect.offset(0, (int) ((-AndroidUtilities.dp(7.0f)) * this.H));
            p6Var.f29331w = (int) (AndroidUtilities.lerp(0.5f, 1.0f, this.V) * (1.0f - this.M) * this.f7040c0);
            p6Var.setBounds(rect);
            p6Var.draw(canvas);
            if (this.J) {
                org.telegram.ui.Components.p6 p6Var3 = this.f7042e;
                a2 = p6Var3.d();
                rect.set((int) (((getMeasuredWidth() - a2) - getWidth()) / 2.0f), (int) (((getMeasuredHeight() - p6Var3.f29315e) / 2.0f) - AndroidUtilities.dp(1.0f)), (int) org.telegram.messenger.w1.a(getMeasuredWidth() - a2, getWidth(), 2.0f, a2), (int) (((getMeasuredHeight() + p6Var3.f29315e) / 2.0f) - AndroidUtilities.dp(1.0f)));
                ...
                p6Var3.f29331w = (int) (AndroidUtilities.lerp(0.5f, 1.0f, this.V) * (1.0f - this.M) * 200.0f * this.H);
            ...
            CharSequence charSequence = p6Var2.f29317g;
            if (charSequence != null) {
