        ...
        if (o8Var != null) {
            try {
                ...
                if (string == null) {
                    ...
                    if (gaVar.f7302f.isEmpty() && gaVar.f7299b.isEmpty()) {
                        gaVar = new ga();
                    } else {
                        HashSet hashSet = new HashSet();
                        hashSet.addAll(gaVar.f7300c);
            ...
            o8Var.E0 = gaVar;
            o8Var.F0.clear();
            o8Var.F0.addAll(o8Var.E0.f7299b);
