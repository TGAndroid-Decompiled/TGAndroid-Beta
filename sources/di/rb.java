...
public final class rb extends q6 {
    ...
    public final void B(boolean z10) {
        pc pcVar = this.A2;
        pcVar.f7887o1.a(true, z10, pcVar.f7869i0);
    }

    @Override
    public final void C() {
        pc pcVar = this.A2;
        pcVar.f7910v1.O0(false);
        pcVar.f7850c1.clearAnimation();
        ViewPropertyAnimator duration = pcVar.f7850c1.animate().alpha(0.0f).setDuration(180L);
        pr prVar = pr.f29467g;
    ...
    public final void V0(boolean z10, boolean z11) {
        ...
        pc pcVar = this.A2;
        if (z10) {
            pcVar.f7890p1.setVisibility(0);
            pcVar.f7890p1.setAlpha(0.0f);
            pcVar.f7890p1.clearAnimation();
            pcVar.f7890p1.animate().alpha(1.0f).setDuration(180L).setInterpolator(pr.f29467g).start();
            return;
        }
        pcVar.f7890p1.a(false, z11);
        pcVar.f7890p1.clearAnimation();
        ViewPropertyAnimator interpolator = pcVar.f7890p1.animate().alpha(0.0f).withEndAction(new nb(this, 1)).setDuration(180L).setInterpolator(pr.f29467g);
        if (z11) {
            j3 = 500;
        } else {
            j3 = 0;
    ...
    public final void g(boolean z10) {
        ...
        pc pcVar = this.A2;
        pcVar.f7850c1.clearAnimation();
        ViewPropertyAnimator animate = pcVar.f7850c1.animate();
        float f10 = 0.0f;
        if (pcVar.f7863g0 == -1) {
            f7 = 1.0f;
        } else {
    ...
    public final void j() {
        this.f8083z2 = false;
        V0(q(), false);
        this.A2.f7887o1.a(false, false, null);
    }

    @Override
    public final void k() {
        this.f8083z2 = true;
        this.A2.f7910v1.O0(false);
        V0(false, false);
    }

    @Override
    public final void m(boolean z10) {
        this.A2.f7890p1.a(z10, false);
    }

    @Override
    public final void r0() {
        pc pcVar = this.A2;
        pcVar.f7850c1.f7593f.d();
    ...
    public final void z0(boolean z10) {
        ...
        if (dcVar != null) {
            dcVar.x(6, z10);
            r6 r6Var = pcVar.f7873j1;
            if (r6Var != null) {
                ((fg0) r6Var.f8069c).a(pcVar.X0.k(), true);
            }
        }
