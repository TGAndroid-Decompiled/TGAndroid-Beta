...
public final class rb extends q6 {
    ...
    public final void V0(boolean z10, boolean z11) {
        ...
        if (z10) {
            ...
            pcVar.f7918p1.animate().alpha(1.0f).setDuration(180L).setInterpolator(pr.f29495g).start();
            return;
        }
        pcVar.f7918p1.a(false, z11);
        pcVar.f7918p1.clearAnimation();
        ViewPropertyAnimator interpolator = pcVar.f7918p1.animate().alpha(0.0f).withEndAction(new nb(this, 1)).setDuration(180L).setInterpolator(pr.f29495g);
        if (z11) {
            j3 = 500;
        } else {
            j3 = 0;
