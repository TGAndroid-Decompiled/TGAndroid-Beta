...
public final class t7 extends v7 {
    public final TLRPC.User f8201b;
    ...
    public final String b() {
        return UserObject.getUserName(this.f8201b);
    }

    @Override
    public final void c(org.telegram.ui.ActionBar.n2 n2Var) {
        TLRPC.User user = this.f8201b;
        ...
        n2Var.presentFragment(ProfileActivity.m4(user.f20016id));
    }
