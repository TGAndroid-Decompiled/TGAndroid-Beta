    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                bwVar.f28471b.invalidate();
                return;
            case 3:
                ni1 ni1Var = (ni1) obj;
                ni1Var.f31425y = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                float dp = f10 + AndroidUtilities.dp(28.0f);
                float dp2 = f7 + AndroidUtilities.dp(52.0f);
                float f11 = ni1Var.f31425y;
                ni1Var.G = dp - (dp * f11);
            ...
            default:
                ...
                float f12 = photoViewer.f33517a6;
                cropAreaView.f23960n0 = floatValue3;
                cropAreaView.f23961o0 = ((photoViewer.f33556e6 - f12) * photoViewer.f33615l6) + f12;
                cropAreaView.f23962p0 = 0.0f;
                cropAreaView.f23963q0 = 0.0f;
                cropAreaView.invalidate();
                photoViewer.C1.f30871c.b(AndroidUtilities.lerp(f7, 0.0f, ((Float) valueAnimator.getAnimatedValue()).floatValue()));
                return;
        }
    }
}
