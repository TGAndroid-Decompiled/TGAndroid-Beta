    ...
    public final void draw(Canvas canvas) {
        switch (this.f7162a) {
            ...
            case 3:
                ...
                canvas.drawCircle(getBounds().centerX(), getBounds().centerY(), Math.min(getBounds().width(), getBounds().height()) / 2.0f, c1Var.f46036f);
                return;
            case 4:
            ...
            case 5:
                ...
                return;
            case 6:
                ((f01) this.f7163b).c(getBounds().centerX() - (((f01) this.f7163b).f25848c / 2.0f), getBounds().centerY(), 1.0f, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.G6, false), canvas);
                return;
            case 7:
                canvas.save();
