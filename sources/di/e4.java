    ...
    public final void draw(Canvas canvas) {
        switch (this.f7190a) {
            ...
            case 3:
                ...
                canvas.drawCircle(getBounds().centerX(), getBounds().centerY(), Math.min(getBounds().width(), getBounds().height()) / 2.0f, c1Var.f46064f);
                return;
            case 4:
            ...
            case 5:
                ...
                return;
            case 6:
                ((f01) this.f7191b).c(getBounds().centerX() - (((f01) this.f7191b).f25875c / 2.0f), getBounds().centerY(), 1.0f, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.G6, false), canvas);
                return;
            case 7:
                canvas.save();
