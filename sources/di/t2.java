...
public class t2 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int f8196c;
    public final g1 d;
    public final h1 f8197e;
    public final i1 f8198f;
    public final s2 h;
    public float f8199n;
    ...
    public ci.u f8202w;
    public float f8203x;
    public Utilities.Callback3Return f8204y;
    ...
    public t2(Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z10, boolean z11) {
        ...
        this.f8197e = new TLRPC.Document();
        this.f8199n = -1.0f;
        this.f8200r = z10;
        this.f8201s = z11;
    ...
    public static void m(t2 t2Var) {
        ...
        if (z10 != z11) {
            ...
            if (t2Var.keyboardVisible) {
                ...
                f7 = Math.min(0.0f, Math.max(((i10 - i11) * 0.3f) - t2Var.f8203x, (-i11) / 3.0f));
            }
            t2Var.container.animate().translationY(f7).setDuration(250L).setInterpolator(org.telegram.ui.ActionBar.p1.f21302w).start();
        }
    }

    @Override
    public final boolean canDismissWithSwipe() {
        if (this.f8198f.getTranslationY() >= ((int) this.f8199n)) {
            return true;
        }
        return false;
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.stickersDidLoad || i10 == NotificationCenter.groupStickersDidLoad) {
            for (View view : this.f8198f.getViewPages()) {
                if (view instanceof e2) {
                    e2 e2Var = (e2) view;
                    if (i10 == NotificationCenter.groupStickersDidLoad || ((e2Var.f6926a == 0 && ((Integer) objArr[0]).intValue() == 5) || (e2Var.f6926a == 1 && ((Integer) objArr[0]).intValue() == 0))) {
    ...
    public final int getContainerViewHeight() {
        ...
        return (int) (this.containerView.getMeasuredHeight() - this.f8198f.getY());
    }
    ...
    public final void o0() {
        ...
        this.container.animate().translationY(0.0f).setDuration(250L).setInterpolator(org.telegram.ui.ActionBar.p1.f21302w).start();
        for (View view : this.f8198f.getViewPages()) {
            if (view instanceof e2) {
                l2 l2Var2 = ((e2) view).f7185f;
                if (l2Var2 != null) {
