...
public class f4 extends View {
        ...
        if (e51VarArr != null && e51VarArr.length != 0) {
            ...
            for (int i13 = 0; i13 < e51VarArr.length; i13++) {
                ...
                if (i12 - max > 0) {
                    ...
                    textPaint3.setTypeface(e51VarArr[i13].f25588a);
    ...
    public final void e(boolean z10) {
        ...
        if (runnable2 != null) {
            AndroidUtilities.runOnUIThread(runnable2, e6Var.f25593c * ((float) e6Var.f25596g));
        }
        this.Q.d(true);
    }
    ...
    public final void j(xi0 xi0Var) {
        ...
        this.f7232f0 = xi0Var4.f32580b;
        this.f7233g0 = xi0Var4.f32582c;
        this.f7234h0 = true;
    }
    ...
    public final void u() {
        if (this.V && this.U) {
            ...
            this.f7240n0.setInterpolator(pr.f29498k);
