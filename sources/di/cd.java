...
public final class cd extends View {
    public final xi0 f7002a;
    public final org.telegram.ui.Components.p6 f7003b;
    public final Paint f7004c;
    public final Paint d;
    public final org.telegram.ui.Components.zc f7005e;
    ...
    public cd(Activity activity) {
        ...
        this.d = paint2;
        this.f7005e = new org.telegram.ui.Components.zc(this);
        pr prVar = pr.h;
        ...
        p6Var.r(-1);
        p6Var.p(AndroidUtilities.dpf2(1.33f), AndroidUtilities.dp(1.0f), 1073741824);
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        boolean z12 = true;
        this.f7003b.q(LocaleController.getString(i10), true, true);
        int i11 = 0;
        z12 = (!z10 || z11) ? false : false;
        this.f7006f = z12;
        xi0 xi0Var = this.f7002a;
        if (z12) {
            if (xi0Var.f32553b0 > 34) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float e7 = (this.h.e(this.f7006f) * AndroidUtilities.dp(3.0f)) + dp;
        canvas.drawCircle(width, height, e7, this.d);
        canvas.drawCircle(width, height, e7, this.f7004c);
        ...
        org.telegram.ui.Components.p6 p6Var = this.f7003b;
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f7003b && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
