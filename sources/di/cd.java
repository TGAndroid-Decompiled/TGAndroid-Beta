...
public final class cd extends View {
    public final xi0 f7030a;
    public final org.telegram.ui.Components.p6 f7031b;
    public final Paint f7032c;
    public final Paint d;
    public final org.telegram.ui.Components.zc f7033e;
    ...
    public cd(Activity activity) {
        ...
        this.d = paint2;
        this.f7033e = new org.telegram.ui.Components.zc(this);
        pr prVar = pr.h;
    ...
    public final void a(boolean z10, boolean z11) {
        ...
        boolean z12 = true;
        this.f7031b.q(LocaleController.getString(i10), true, true);
        int i11 = 0;
        z12 = (!z10 || z11) ? false : false;
        this.f7034f = z12;
        xi0 xi0Var = this.f7030a;
        if (z12) {
            if (xi0Var.f32580b0 > 34) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float e7 = (this.h.e(this.f7034f) * AndroidUtilities.dp(3.0f)) + dp;
        canvas.drawCircle(width, height, e7, this.d);
        canvas.drawCircle(width, height, e7, this.f7032c);
        ...
        org.telegram.ui.Components.p6 p6Var = this.f7031b;
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f7031b && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
