...
public final class la implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        ...
        switch (this.f7605a) {
            case 0:
                y2 y2Var = this.f7606b.f7927s;
                y2Var.f8489p = ((Float) obj).floatValue();
                y2Var.i();
                return;
            case 1:
                Bitmap bitmap = (Bitmap) obj;
                pc pcVar = this.f7606b;
                o8 o8Var = pcVar.K1;
                if (o8Var != null) {
                    AndroidUtilities.recycleBitmap(o8Var.f7785g0);
                    pcVar.K1.f7785g0 = bitmap;
                    ia iaVar = pcVar.f7920q0;
                    if (iaVar != null) {
                        iaVar.n1(bitmap);
                        return;
                    }
            ...
            case 2:
                o8 o8Var2 = (o8) obj;
                pc pcVar2 = this.f7606b;
                pcVar2.W(o8Var2, false);
                int i11 = pcVar2.f7876c;
                bi.u8 storiesController = MessagesController.getInstance(i11).getStoriesController();
                a0.i iVar = storiesController.f3835e;
                int i12 = storiesController.f3832a;
                ArrayList arrayList = storiesController.h;
                ArrayList arrayList2 = storiesController.f3837g;
                bi.t8 t8Var = new bi.t8(storiesController, o8Var2);
                boolean z14 = o8Var2.f7784g;
                long j3 = t8Var.J;
                if (z14) {
                    ...
                    hashMap.put(Integer.valueOf(o8Var2.f7782f), t8Var);
                } else {
                    storiesController.d(j3, t8Var, storiesController.f3833b, false);
                }
                storiesController.d(j3, t8Var, storiesController.f3834c, true);
                ...
                if (o8Var2.f7774c && !o8Var2.f7784g) {
                    MessagesController.getInstance(i11).getStoriesController().f3851w.b(o8Var2);
                }
                if (o8Var2.f7781e1 != 0) {
                    ConnectionsManager.getInstance(o8Var2.f7768a).cancelRequest(o8Var2.f7781e1, true);
                    return;
                }
                return;
            case 3:
                f7 f7Var = (f7) obj;
                pc pcVar3 = this.f7606b;
                if (pcVar3.C0 != null) {
                    w7 w7Var = pcVar3.D0;
                    f7 f7Var2 = null;
                    if (f7Var == null) {
            ...
            case 4:
                ...
                return;
            case 5:
                pc pcVar4 = this.f7606b;
                bi.b bVar = pcVar4.f7869a;
                int intValue = ((Integer) obj).intValue() / 3600;
                org.telegram.ui.Components.kb kbVar = new org.telegram.ui.Components.lb(pcVar4.f7872b, new c9(1)).f28155a;
                WindowManager.LayoutParams layout = kbVar.getLayout();
                if (layout != null) {
                    layout.height = -2;
                    layout.width = pcVar4.f7923r.getWidth();
                    layout.y = (int) (pcVar4.f7923r.getY() + AndroidUtilities.dp(56.0f));
                    org.telegram.ui.Components.lb lbVar = kbVar.f27822a;
            ...
            case 6:
                ...
                if (qcVar != null && qcVar.f29699a == 2) {
                    qcVar.l();
                    return;
                }
                return;
            case 7:
                pc pcVar6 = this.f7606b;
                pcVar6.l();
                pcVar6.m();
            ...
            case 8:
                ...
                pcVar7.c0(pcVar7.H0, pcVar7.I0.f8471e, true);
                l7 l7Var = pcVar7.O0;
                if (pcVar7.A0.j()) {
            ...
            case 10:
                ...
                pc pcVar9 = this.f7606b;
                if (!pcVar9.P1 && !pcVar9.Q1) {
                    int intValue2 = num2.intValue();
                    pcVar9.O1 = intValue2;
                    h8 h8Var = pcVar9.f7914o0;
                    if (intValue2 == -1) {
                        z11 = true;
                    } else {
                        z11 = false;
                    ...
                    h8Var.a(z11, true);
                    if (pcVar9.O1 == 1 && !pcVar9.I0.f8471e) {
                        z12 = true;
                    } else {
                        z12 = false;
                    }
            ...
            case 11:
                Float f11 = (Float) obj;
                pc pcVar10 = this.f7606b;
                l7 l7Var3 = pcVar10.O0;
                l7Var3.f7580n0 = f11.floatValue();
                l7Var3.invalidate();
            ...
            case 12:
                ...
                pc pcVar11 = this.f7606b;
                if (pcVar11.K1 != null) {
                    fc fcVar = pcVar11.f7878c1;
                    if (!fcVar.O1) {
                        fcVar.clearFocus();
                        if (num3.intValue() == 5) {
                            pcVar11.X();
                            ...
                            pcVar11.l0(0, false, true);
                            rb rbVar2 = pcVar11.f7938v1;
                            if (rbVar2 != null) {
                                rbVar2.R0(2);
                                rbVar2.f8002l2 = true;
                                rbVar2.o0(true);
                                pcVar11.f7938v1.M0 = true;
                                return;
                            }
                            return;
            ...
            case 13:
                ...
                pc pcVar12 = this.f7606b;
                FrameLayout frameLayout = pcVar12.Y0;
                if (frameLayout != null) {
                    if (pcVar12.f7891g0 == 2) {
                        dp = AndroidUtilities.dp(68.0f);
                    } else {
                        dp = AndroidUtilities.dp(64.0f) + (-(AndroidUtilities.dp(12.0f) + pcVar12.f7878c1.getEditTextHeight()));
                    }
                    frameLayout.setTranslationY(dp);
                }
                fb fbVar2 = pcVar12.f7881d1;
                if (fbVar2 != null) {
                    int i16 = -(AndroidUtilities.dp(24.0f) + pcVar12.f7878c1.getEditTextHeight());
                ...
                org.telegram.ui.Components.qc qcVar2 = org.telegram.ui.Components.qc.f29698w;
                if (qcVar2 != null && qcVar2.f29699a == 2) {
                    qcVar2.l();
                }
                if (pcVar12.f7878c1.f7632p0 && (fbVar = pcVar12.f7881d1) != null) {
                    fbVar.c(false, true);
                    return;
                }
                return;
            ...
            case 15:
                ...
                pc pcVar14 = this.f7606b;
                o8 o8Var5 = pcVar14.K1;
                if (o8Var5 != null) {
                    if (inputPeer == null) {
                        inputPeer = new TLRPC.TL_inputPeerSelf();
                    }
                    o8Var5.f7812v0 = inputPeer;
                    ...
                    if (arrayList4 != null) {
                        ...
                        while (i18 < size2) {
                            ...
                            i18++;
                            ((o8) obj3).f7812v0 = pcVar14.K1.f7812v0;
                        }
                        return;
                    }
                    return;
            ...
            case 16:
                ...
                pc pcVar15 = this.f7606b;
                o8 o8Var6 = pcVar15.K1;
                if (o8Var6 != null) {
                    o8Var6.f7814w0 = hashSet;
            ...
            case 17:
                ...
                pc pcVar16 = this.f7606b;
                o8 o8Var7 = pcVar16.K1;
                if (o8Var7 != null) {
                    Bitmap bitmap3 = o8Var7.f7785g0;
                    if (bitmap3 != null) {
                        bitmap3.recycle();
                    }
                    pcVar16.K1.f7785g0 = bitmap2;
                    ia iaVar2 = pcVar16.f7920q0;
                    if (iaVar2 != null) {
                        iaVar2.n1(bitmap2);
                        return;
                    }
                ...
                return;
            case 18:
                this.f7606b.f7949y0 = (ga) obj;
                return;
            case 19:
                TLRPC.InputPeer inputPeer2 = (TLRPC.InputPeer) obj;
                pc pcVar17 = this.f7606b;
                h8 h8Var2 = pcVar17.f7914o0;
                pcVar17.f7945x0 = inputPeer2;
                h8Var2.set(inputPeer2);
                return;
            case 20:
                TLRPC.InputPeer inputPeer3 = (TLRPC.InputPeer) obj;
                pc pcVar18 = this.f7606b;
                h8 h8Var3 = pcVar18.f7914o0;
                pcVar18.f7945x0 = inputPeer3;
                h8Var3.set(inputPeer3);
                return;
            default:
                y2 y2Var2 = this.f7606b.f7927s;
                float floatValue = ((Float) obj).floatValue();
                y2Var2.f8488o = floatValue;
                y2Var2.f8487n = y2.f(floatValue);
                y2Var2.g();
                return;
        }
    }
