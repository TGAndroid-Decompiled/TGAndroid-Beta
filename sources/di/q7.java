...
public abstract class q7 extends FrameLayout {
    public float E;
    public final p7 f8030a;
    public final File f8031b;
    public long f8032c;
    public long d;
    public final Paint f8033e;
    public final Paint f8034f;
    public final m7 h;
    public bi.j0 f8035n;
    public n f8036r;
    public float f8037s;
    public rg.d2 v;
    public ValueAnimator f8038w;
    public boolean f8039x;
    public ValueAnimator f8040y;

    public q7(Context context) {
        super(context);
        this.f8032c = -1L;
        this.d = -1L;
        this.f8033e = new Paint(1);
        ...
        this.f8031b = o8.x(UserConfig.selectedAccount, true);
    ...
    public final void a(boolean z10) {
        ...
        ValueAnimator valueAnimator = this.f8040y;
        ...
        this.f8040y.addListener(new ah.b(this, 20));
        this.f8040y.setInterpolator(pr.h);
        this.f8040y.setDuration(280L);
        this.f8040y.start();
    }
    ...
    public final long b() {
        ...
        return Math.min(59500L, j3 - this.f8032c);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int l1 = org.telegram.ui.ActionBar.j6.l1(this.f8037s, 536870912);
        Paint paint = this.f8033e;
        paint.setShadowLayer(AndroidUtilities.dp(2.0f), 0.0f, AndroidUtilities.dp(0.66f), l1);
        paint.setAlpha((int) (this.f8037s * 255.0f));
        ...
        if (d2Var != null && d2Var.getWidth() > 0 && this.v.getHeight() > 0) {
            ...
            this.v.setDraw(true);
            this.v.setAlpha(1.0f - this.f8037s);
            this.v.draw(canvas);
        ...
        if (this.f8032c > 0) {
            ...
            Paint paint2 = this.f8034f;
            paint2.setStrokeWidth(AndroidUtilities.dp(3.33f));
            paint2.setColor(org.telegram.ui.ActionBar.j6.l1(this.f8037s, -1090519041));
            paint2.setShadowLayer(AndroidUtilities.dp(1.0f), 0.0f, AndroidUtilities.dp(0.33f), org.telegram.ui.ActionBar.j6.l1(this.f8037s, 536870912));
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f8030a.measure(View.MeasureSpec.makeMeasureSpec(min, 1073741824), View.MeasureSpec.makeMeasureSpec(min, 1073741824));
