...
public final class c4 extends View implements x2 {
    public final org.telegram.ui.Components.p6 f7014a;
    ...
    public final void draw(Canvas canvas) {
        ...
        org.telegram.ui.Components.p6 p6Var = this.f7014a;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f7014a.G = getMeasuredWidth();
    }

    @Override
    public void setInvert(float f7) {
        this.f7014a.r(i0.a.d(f7, -1, -16777216));
    }

    @Override
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f7014a && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
