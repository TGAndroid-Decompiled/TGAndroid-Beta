...
public abstract class m extends FrameLayout {
    ...
    public m(Context context, FrameLayout frameLayout, ov0 ov0Var, FrameLayout frameLayout2, org.telegram.ui.ActionBar.f6 f6Var, org.telegram.ui.Components.ja jaVar) {
        ...
        oq oqVar = new oq(org.telegram.ui.ActionBar.j6.K(AndroidUtilities.dp(18.0f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f21098zf, f6Var)), mutate, 0, AndroidUtilities.dp(1.0f));
        this.f7629n = oqVar;
    ...
    public int getEditTextHeight() {
        return (int) this.f7640v0.f25593c;
    }
    ...
    public void x(int i10) {
        ...
        if (!(this instanceof bt0)) {
            ...
            if (max > AndroidUtilities.dp(20.0f)) {
                this.f7628l0.setInterpolator(org.telegram.ui.ActionBar.p1.f21303w);
    ...
    public void y() {
        if (this.M != null) {
            float translationY = ((View) getParent()).getTranslationY() - this.f7640v0.f25593c;
