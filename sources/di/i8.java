...
public class i8 extends View {
    ...
    public final org.telegram.ui.Components.e6 f7405f;
    public Utilities.Callback h;
    public final Paint f7406n;
    public final Paint f7407r;
    public final Paint f7408s;
    public final Paint v;
    public final Paint f7409w;
    public final org.telegram.ui.Components.p6 f7410x;
    public final org.telegram.ui.Components.p6 f7411y;
    ...
    public i8(Context context, int i10) {
        ...
        this.f7403c = 1.0f;
        pr prVar = pr.h;
        this.f7405f = new org.telegram.ui.Components.e6(this, 0L, 320L, prVar);
    ...
    public final void a(float f7) {
        this.f7404e = true;
        float f10 = this.f7402b;
        this.d = (f7 - f10) / (this.f7403c - f10);
        e(f7);
    }
    ...
    public final void d(float f7) {
        float f10 = this.f7402b;
        float f11 = (f7 - f10) / (this.f7403c - f10);
        this.d = f11;
        this.f7405f.d(f11, true);
        e(f7);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int i10 = this.f7401a;
        org.telegram.ui.Components.p6 p6Var = this.f7410x;
        if (i10 == 0) {
            ...
            org.telegram.ui.Components.p6 p6Var2 = this.f7411y;
        ...
        if (i10 == 0) {
            canvas.drawPath(this.F, this.f7407r);
            canvas.drawPath(this.G, this.f7408s);
            float f13 = this.f7403c;
            float f14 = this.f7402b;
            float f15 = f13 - f14;
            if (f15 != 0.0f) {
                f10 = (f15 * this.d) + f14;
            } else {
            ...
            Paint paint2 = this.f7409w;
            paint2.setAlpha((int) (e10 * 255.0f));
            canvas.drawPath(this.I, paint2);
            canvas.restore();
        }
        canvas.save();
        canvas.drawRect(0.0f, 0.0f, this.O * f12, this.P, this.f7406n);
        canvas.restore();
        canvas.restore();
        canvas.restore();
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            float f10 = this.f7403c;
            float f11 = this.f7402b;
            float f12 = 0.0f;
            if (f10 - f11 != 0.0f) {
    ...
    public final void e(float f7) {
        ...
        org.telegram.ui.Components.p6 p6Var = this.f7410x;
        if (!TextUtils.equals(p6Var.f29316g, str)) {
            p6Var.b();
            if (this.f7404e) {
                j3 = 320;
            } else {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f7410x.t(AndroidUtilities.dp(15.0f));
        int i12 = this.R;
        int i13 = this.f7401a;
        if (i12 > 0) {
            this.O = i12;
        ...
        if (i13 == 0) {
            ...
            this.f7407r.setPathEffect(new CornerPathEffect(AndroidUtilities.dpf2(1.33f)));
            Path path = this.F;
            path.rewind();
            ...
            path.close();
            this.f7408s.setPathEffect(new CornerPathEffect(AndroidUtilities.dpf2(2.66f)));
            Path path2 = this.G;
            path2.rewind();
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f7410x && drawable != this.f7411y && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
