...
public final class h9 extends org.telegram.ui.ActionBar.f3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final Utilities.Callback f7361e;
    public final ll0 f7362f;
    public final g9 h;
    public final TextView f7363n;
    ...
    public h9(Context context, final int i10, boolean z10, TLRPC.InputPeer inputPeer, final Utilities.Callback callback, final org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f7359b = i10;
        this.f7360c = MessagesController.getInstance(i10).getStoriesController().T;
        this.d = inputPeer;
        this.f7361e = callback;
        ...
        ll0Var.setOnItemClickListener(new zk0() {
            ...
            public final void a(int i13, View view) {
                ...
                h9 h9Var = h9.this;
                TLRPC.InputPeer inputPeer2 = (TLRPC.InputPeer) h9Var.f7360c.get(i13 - 2);
        ...
        textView.setBackgroundColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20761h5, f6Var));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.storiesSendAsUpdate) {
            this.f7360c = MessagesController.getInstance(this.f7359b).getStoriesController().T;
            this.h.l();
        }
    }
    ...
    public final void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f7359b).addObserver(this, NotificationCenter.storiesSendAsUpdate);
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        NotificationCenter.getInstance(this.f7359b).removeObserver(this, NotificationCenter.storiesSendAsUpdate);
    }
