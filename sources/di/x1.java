...
public final class x1 extends g.p {
    ...
    public final int i(int i10) {
        ...
        switch (this.f8360c) {
            ...
            case 2:
                jj jjVar = (jj) this.d;
                int i15 = jjVar.f27515r;
                int i16 = jjVar.f27517w;
                if (i10 % i16 != i16 - 1) {
            ...
            case 3:
                ...
                if (i10 != chatAttachAlertPhotoLayout.G.f26756n - 1 && ((!chatAttachAlertPhotoLayout.P0 && !chatAttachAlertPhotoLayout.O0) || i10 != 0)) {
            ...
            case 5:
                ...
                if ((ux0Var.W != null && (ux0Var.d.f29834e.get(i10) instanceof Integer)) || i10 == ux0Var.d.h) {
                    return ux0Var.d.d;
                }
                return 1;
            case 6:
                ...
                if (i10 >= vp0Var.f41606d0 && i10 < vp0Var.f41608e0) {
                    return 1;
                }
                return 3;
            case 7:
                h51 G = ((yh.f4) this.d).f50285i0.G(i10 - 1);
                if (G == null || (i13 = G.f26604u) == -1) {
                    return 3;
                }
                return i13;
            default:
                zh.s0 s0Var = (zh.s0) this.d;
                nz nzVar = s0Var.f52538h0;
                zh.n0 n0Var = s0Var.f52541k0;
                if (n0Var != null && i10 != 0) {
                    h51 G2 = n0Var.G(i10 - 1);
                    if (G2 == null || (i14 = G2.f26604u) == -1) {
                        return nzVar.J;
                    }
                    return i14;
                }
