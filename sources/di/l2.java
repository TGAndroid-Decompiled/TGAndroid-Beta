...
public final class l2 extends FrameLayout {
    ...
    public final void d(boolean z10) {
        ...
        if (h2Var.length() <= 0 && ((k2Var = this.f7542f) == null || k2Var.f32035o3 <= 0.5f || ((k2Var == null || !k2Var.j3) && k2Var.getSelectedCategory() == null))) {
            i10 = 0;
        } else {
            i10 = 1;
        }
