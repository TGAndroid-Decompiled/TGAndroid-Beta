    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        switch (i10) {
            case 0:
                ...
                return;
            case 1:
                HashSet hashSet = org.telegram.ui.i4.f37189b1;
            ...
            default:
                ...
                if (e6Var != null && rvVar.K >= 0 && rvVar.L >= 0 && rvVar.f30098n != null && this.G) {
                    ...
                    if (d > 0.0f) {
                        ...
                        if (i11 < i12) {
                            paint.setColor(org.telegram.ui.ActionBar.j6.l1(d, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Ld, this.f28225p2)));
    ...
    public void k0(int i10, int i11) {
        ...
        switch (this.X2) {
            case 1:
                ...
                if (v3Var != null && (u3Var = v3Var.f41396c) != null) {
                    u3Var.invalidate();
                    return;
                }
                return;
    ...
    public void onDetachedFromWindow() {
        switch (this.X2) {
            case 2:
                ...
                rv rvVar = (rv) this.Z2;
                org.telegram.ui.Components.z5.release(rv.s(rvVar), rvVar.f30094b);
                return;
            default:
                super.onDetachedFromWindow();
                return;
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        switch (this.X2) {
            ...
            case 1:
                ...
                if (i4Var.d != null && i4Var.f41435b == null && (((n1Var = i4Var.H) == null || !n1Var.isShowing()) && (motionEvent.getAction() == 1 || motionEvent.getAction() == 3))) {
                    i4Var.f41435b = null;
                    i4Var.d = null;
                    i4Var.f41438f = null;
                } else if (i4Var.d != null && i4Var.f41435b != null && motionEvent.getAction() == 1 && (getAdapter() instanceof org.telegram.ui.g4)) {
                    motionEvent2 = motionEvent;
                    org.telegram.ui.i4.l(i4Var, (org.telegram.ui.g4) getAdapter(), motionEvent2, i4Var.f41438f, i4Var.d, 0, 0);
            ...
            default:
                st q6 = st.q();
                rv rvVar = (rv) this.Z2;
                boolean r10 = q6.r(motionEvent, rvVar.h, rvVar.N, this.f28225p2);
