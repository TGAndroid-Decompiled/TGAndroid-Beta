    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f8382a) {
            case 0:
                ...
                q6Var.A1.f44542a = i0.a.d(floatValue, ((Integer) this.d).intValue(), this.f8383b);
                m6 m6Var = q6Var.T0;
                if (m6Var != null) {
                    m6Var.invalidate();
                    return;
                ...
                return;
            case 1:
                ((ss0) this.f8384c).f30412e.O1.put(this.f8383b, (Float) valueAnimator.getAnimatedValue());
                ((ll0) this.d).invalidate();
                return;
            default:
                rg.o0 o0Var = (rg.o0) this.f8384c;
                float floatValue2 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                o0Var.K1.f44542a = i0.a.d(floatValue2, ((Integer) this.d).intValue(), this.f8383b);
                rg.m0 m0Var = o0Var.f45342c1;
                if (m0Var != null) {
                    m0Var.invalidate();
                    return;
                }
