    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f8410a) {
            case 0:
                ...
                q6Var.A1.f44570a = i0.a.d(floatValue, ((Integer) this.d).intValue(), this.f8411b);
                m6 m6Var = q6Var.T0;
                if (m6Var != null) {
                    m6Var.invalidate();
                    return;
                ...
                return;
            case 1:
                ((ss0) this.f8412c).f30439e.O1.put(this.f8411b, (Float) valueAnimator.getAnimatedValue());
                ((ll0) this.d).invalidate();
                return;
            default:
                rg.o0 o0Var = (rg.o0) this.f8412c;
                float floatValue2 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                o0Var.K1.f44570a = i0.a.d(floatValue2, ((Integer) this.d).intValue(), this.f8411b);
                rg.m0 m0Var = o0Var.f45370c1;
                if (m0Var != null) {
                    m0Var.invalidate();
                    return;
                }
