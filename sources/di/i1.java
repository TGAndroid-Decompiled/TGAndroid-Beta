...
public final class i1 extends i81 {
    ...
    public void u() {
        switch (this.T) {
            ...
            case 7:
                ...
                bb1Var.m0(bb1Var.f34704i0.getCurrentPosition(), true);
    ...
    public void v() {
        ...
        switch (this.T) {
            case 6:
                if ((getCurrentView() instanceof d41) && (c41Var = ((d41) getCurrentView()).f35651n) != null) {
    ...
    public final void w(boolean z10) {
        switch (this.T) {
            ...
            case 4:
                ...
                bq0Var.f34865e.setProgressToGradient(1.0f - w7.p.a((positionAnimated - 0.333333f) / 0.333333f, 0.0f, 1.0f));
                bq0Var.G0();
                vp0 C0 = bq0Var.C0();
                d dVar = bq0Var.Q;
            ...
            case 7:
                bb1 bb1Var = (bb1) this.U;
                float positionAnimated2 = bb1Var.f34704i0.getPositionAnimated();
