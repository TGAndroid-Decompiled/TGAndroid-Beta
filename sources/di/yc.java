...
public final class yc extends Path {
    public final int f8522a = AndroidUtilities.dp(10.0f);
    public final float[] f8523b;
    public ArrayList f8524c;
    public ArrayList d;
    public float f8525e;
    public float f8526f;
    public float f8527g;
    ...
    public static int c(ArrayList arrayList) {
        ...
        for (int i11 = 0; i11 < arrayList.size(); i11++) {
            if (arrayList.get(i11) != null) {
                i10 += ((sc) arrayList.get(i11)).f8168e;
            }
        }
        return i10;
    }
    ...
    public final void a(float f7, float f10, float f11, float f12, float f13, float f14, ArrayList arrayList) {
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            if (Math.abs(this.f8525e - f12) <= 1.0f && Math.abs(this.f8526f - f13) <= 0.01f && Math.abs(this.f8527g - 0.0f) <= 0.1f && Math.abs(this.h - f14) <= 1.0f && Math.abs(this.f8528i - f17) <= 1.0f && Math.abs(this.f8529j - f10) <= 1.0f && Math.abs(this.f8530k - f18) <= 1.0f) {
                ArrayList arrayList2 = this.f8524c;
                if (arrayList2 != null && arrayList2.size() == arrayList.size()) {
                    for (int i12 = 0; i12 < arrayList2.size(); i12++) {
                        ...
                        if (arrayList.get(i12) == null) {
                            ...
                            i11 = ((sc) arrayList.get(i12)).f8166b;
                        }
                        if (intValue == i11) {
                        }
                    }
                ...
                if (arrayList3 != null && arrayList3.size() == arrayList.size()) {
                    for (int i13 = 0; i13 < arrayList3.size(); i13++) {
                        ...
                        if (arrayList.get(i13) == null) {
                            ...
                            d10 = ((sc) arrayList.get(i13)).f8165a.d(((sc) arrayList.get(i13)).f8167c, false);
                        }
                        if (floatValue != d10) {
                            return;
                        }
            ...
            ArrayList arrayList4 = this.f8524c;
            if (arrayList4 == null) {
            ...
            while (i14 < arrayList.size()) {
                ArrayList arrayList5 = this.f8524c;
                if (arrayList.get(i14) == null) {
                    i10 = 0;
                } else {
                    i10 = ((sc) arrayList.get(i14)).f8166b;
                }
            ...
            for (int i15 = 0; i15 < arrayList.size(); i15++) {
                ...
                if (arrayList.get(i15) == null) {
                    ...
                    d = ((sc) arrayList.get(i15)).f8165a.d(((sc) arrayList.get(i15)).f8167c, false);
                }
            ...
            for (int i17 = 0; i17 < arrayList.size(); i17++) {
                if (arrayList.get(i17) != null) {
                    i16 = Math.max(i16, ((sc) arrayList.get(i17)).f8166b);
                }
            }
            int max = Math.max(0, (int) (((f10 - this.f8522a) - f17) / round));
            ...
            while (max <= min) {
                ...
                for (int i19 = 0; i19 < arrayList.size(); i19++) {
                    if (arrayList.get(i19) != null && max < ((sc) arrayList.get(i19)).f8166b) {
                ...
                addRoundRect(rectF, this.f8523b, Path.Direction.CW);
                max++;
                f17 = f7;
                f18 = f11;
            }
    ...
    public final void b(float f7, float f10, float f11, float f12, long j3, float f13, float f14, float f15, sc scVar) {
        ...
        int i10 = scVar.f8166b;
        org.telegram.ui.Components.e6 e6Var = scVar.f8165a;
        float d = e6Var.d(scVar.f8167c, false);
        if (0 == j3 && Math.abs(this.f8525e - f13) <= 1.0f && Math.abs(this.f8526f - f14) <= 0.01f && Math.abs(this.f8527g - f12) <= 0.1f && Math.abs(this.h - f15) <= 1.0f && Math.abs(this.f8528i - f19) <= 1.0f && Math.abs(this.f8529j - f20) <= 1.0f && Math.abs(this.f8530k - f21) <= 1.0f && (arrayList = this.f8524c) != null && arrayList.size() == 1) {
        ...
        ArrayList arrayList3 = this.f8524c;
        if (arrayList3 == null) {
            this.f8524c = new ArrayList();
        } else {
            arrayList3.clear();
        }
        this.f8524c.add(Integer.valueOf(i10));
        ...
        this.f8525e = f13;
        this.h = f15;
        float d10 = e6Var.d(scVar.f8167c, false);
        rewind();
        float round = Math.round(AndroidUtilities.dpf2(3.3333f));
        int max = Math.max(0, (int) (((f20 - this.f8522a) - f19) / round));
