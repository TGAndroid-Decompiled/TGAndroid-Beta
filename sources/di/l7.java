...
public final class l7 extends View implements x2 {
    ...
    public boolean X0;
    public j7 f7534a;
    public boolean f7535a0;
    public final ImageReceiver f7536b;
    public boolean f7537b0;
    public final oq f7538c;
    public boolean f7539c0;
    public final Drawable d;
    public boolean f7540d0;
    public final Drawable f7541e;
    public boolean f7542e0;
    public final Drawable f7543f;
    public boolean f7544f0;
    public float f7545g0;
    public final Drawable h;
    public final org.telegram.ui.Components.e6 f7546h0;
    public float f7547i0;
    public float f7548j0;
    public float f7549k0;
    public float f7550l0;
    public final org.telegram.ui.Components.e6 m0;
    public final Drawable f7551n;
    public float f7552n0;
    public boolean f7553o0;
    public final org.telegram.ui.Components.e6 f7554p0;
    public final org.telegram.ui.Components.e6 f7555q0;
    public final Paint f7556r;
    public boolean f7557r0;
    public final Paint f7558s;
    public final float[] f7559s0;
    public final org.telegram.ui.Components.e6 f7560t0;
    public boolean f7561u0;
    public final Paint v;
    public long f7562v0;
    public final Paint f7563w;
    public boolean f7564w0;
    public final Paint f7565x;
    public boolean f7566x0;
    public final Paint f7567y;
    public float f7568y0;
    public boolean f7569z0;

    public l7(Activity activity) {
        super(activity);
        ImageReceiver imageReceiver = new ImageReceiver();
        this.f7536b = imageReceiver;
        this.f7556r = new Paint(1);
        ...
        this.f7546h0 = new org.telegram.ui.Components.e6(this, 0L, 200L, pr.f29466f);
        this.m0 = new org.telegram.ui.Components.e6(this, 0L, 350L, prVar);
        this.f7552n0 = -1.0f;
        this.f7553o0 = true;
        this.f7554p0 = new org.telegram.ui.Components.e6(this, 0L, 350L, prVar);
        this.f7555q0 = new org.telegram.ui.Components.e6(this, 0L, 850L, prVar);
        this.f7559s0 = new float[2];
        this.f7560t0 = new org.telegram.ui.Components.e6(this, 0L, 350L, prVar);
        this.B0 = new org.telegram.ui.Components.e6(this, 0L, 350L, prVar);
        this.C0 = new org.telegram.ui.Components.e6(this, 0L, 650L, prVar);
        this.D0 = new org.telegram.ui.Components.e6(this, 0L, 160L, pr.f29468i);
    ...
    public final void g(boolean z10) {
        this.f7561u0 = false;
        if (!z10) {
            org.telegram.ui.Components.e6 e6Var = this.f7560t0;
            e6Var.getClass();
            e6Var.d(0.0f, true);
        }
        invalidate();
    ...
    public final void h() {
        ...
        j7 j7Var = this.f7534a;
        ImageReceiver imageReceiver = this.f7536b;
        if (j7Var != null) {
            j7Var.getClass();
            ArrayList arrayList2 = MessagesController.getInstance(imageReceiver.getCurrentAccount()).getStoriesController().f3824w.f6935b;
            imageReceiver.setOrientation(0, 0, true);
            if (arrayList2 != null && !arrayList2.isEmpty() && ((o8) arrayList2.get(0)).O0 != null) {
                this.f7536b.setImage(ImageLocation.getForPath(((o8) arrayList2.get(0)).O0.getAbsolutePath()), "80_80", null, null, this.f7538c, 0L, null, null, 0);
                return;
            }
        }
        ...
        if (photoEntry != null && (str = photoEntry.thumbPath) != null) {
            this.f7536b.setImage(ImageLocation.getForPath(str), "80_80", null, null, this.f7538c, 0L, null, null, 0);
        } else if (photoEntry != null && photoEntry.path != null) {
            if (photoEntry.isVideo) {
                this.f7536b.setImage(ImageLocation.getForPath("vthumb://" + photoEntry.imageId + ":" + photoEntry.path), "80_80", null, null, this.f7538c, 0L, null, null, 0);
                return;
            }
            imageReceiver.setOrientation(photoEntry.orientation, photoEntry.invert, true);
            this.f7536b.setImage(ImageLocation.getForPath("thumb://" + photoEntry.imageId + ":" + photoEntry.path), "80_80", null, null, this.f7538c, 0L, null, null, 0);
        } else {
            imageReceiver.setImageBitmap(this.f7538c);
        }
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.f7536b.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        this.f7536b.onDetachedFromWindow();
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float d12 = this.f7554p0.d(f7, false);
        if (this.f7557r0) {
            f10 = 1.0f;
        } else {
            f10 = 0.0f;
        }
        float d13 = this.f7555q0.d(f10, false);
        float f45 = this.f7552n0;
        if (f45 < 0.0f) {
            if (this.f7553o0) {
                f44 = 1.0f;
            } else {
        ...
        if (Math.abs(this.f7568y0 - this.f7547i0) < AndroidUtilities.dp(64.0f) && (this.f7557r0 || zcVar2.h)) {
            f12 = 1.0f;
        } else {
            f12 = 0.0f;
        }
        float d15 = this.C0.d(f12, false) * d14;
        if (Math.abs(this.f7568y0 - this.f7547i0) < AndroidUtilities.dp(64.0f)) {
            f13 = 1.0f;
        } else {
            f13 = 0.0f;
        }
        float d16 = this.D0.d(f13, false) * d14;
        float clamp = Utilities.clamp((this.f7568y0 - this.f7547i0) / AndroidUtilities.dp(16.0f), 1.0f, -1.0f);
        float clamp2 = Utilities.clamp((this.f7568y0 - this.f7547i0) / AndroidUtilities.dp(64.0f), 1.0f, -1.0f);
        if (Math.min(Math.abs(this.f7568y0 - this.f7550l0), Math.abs(this.f7568y0 - this.f7549k0)) < AndroidUtilities.dp(16.0f)) {
            f14 = 1.0f;
        } else {
            f14 = 0.0f;
        }
        ...
        if (f15 > 0.0f) {
            f21 = 1.0f;
            float dp = this.f7547i0 - AndroidUtilities.dp(50.0f);
            f22 = 0.0f;
            float dp2 = this.f7547i0 + AndroidUtilities.dp(50.0f);
            Paint paint2 = this.E;
            ...
            c10 = 1;
            f19 = e10;
            canvas.drawLine(dp2, this.f7548j0, AndroidUtilities.lerp(dp2, this.f7550l0 - AndroidUtilities.dp(30.0f), f15), this.f7548j0, paint3);
            canvas.drawLine(dp2, this.f7548j0, AndroidUtilities.lerp(dp2, this.f7550l0 - AndroidUtilities.dp(30.0f), f47), this.f7548j0, paint2);
            canvas.drawLine(dp, this.f7548j0, AndroidUtilities.lerp(dp, this.f7549k0 + AndroidUtilities.dp(30.0f), f47), this.f7548j0, paint3);
            canvas2 = canvas;
            canvas2.drawLine(dp, this.f7548j0, AndroidUtilities.lerp(dp, this.f7549k0 + AndroidUtilities.dp(30.0f), f47), this.f7548j0, paint2);
        } else {
            f16 = d16;
            f17 = d17;
            f18 = e7;
        ...
        float lerp4 = AndroidUtilities.lerp(zcVar2.a(f23), (this.f7546h0.d(this.f7545g0, false) * 0.2f) + f21, d12);
        RectF rectF4 = AndroidUtilities.rectTmp;
        float f49 = lerp - lerp2;
        float f50 = this.f7548j0;
        float f51 = lerp + lerp2;
        rectF4.set(f49, f50 - lerp2, f51, f50 + lerp2);
        float f52 = f21 - f19;
        int d19 = i0.a.d(max * f52, -1, -577231);
        Paint paint4 = this.f7556r;
        paint4.setColor(d19);
        int i11 = (f19 > f22 ? 1 : (f19 == f22 ? 0 : -1));
        if (i11 > 0) {
            canvas2.save();
            canvas2.scale(lerp4, lerp4, this.f7547i0, this.f7548j0);
        ...
        canvas2.scale(f29, f29, this.f7547i0, this.f7548j0);
        paint.setAlpha(255);
        ...
        if (i11 > 0) {
            ...
            canvas2.translate(this.f7547i0, this.f7548j0);
        ...
        canvas2.scale(max2, max2, this.f7547i0, this.f7548j0);
        ...
        float e11 = this.f7560t0.e(this.f7561u0);
        Paint paint7 = this.v;
        ...
        if (e11 <= 0.0f) {
            ...
            sp.a(this.f7559s0, (float) ((SystemClock.elapsedRealtime() - this.f7562v0) % 5400));
            invalidate();
            float[] fArr = this.f7559s0;
            float f59 = fArr[0];
            float f60 = fArr[c10];
        ...
        if (this.f7557r0) {
            ...
            if (j11 != this.R / 1000) {
                ((jb) this.f7534a).f7443a.J0.a(j11, true);
            }
        ...
        if (z13) {
            ...
            if (a2 > 0.0f) {
                canvas3.save();
                canvas3.scale(a2, a2, this.f7549k0, this.f7548j0);
                canvas3.drawCircle(this.f7549k0, this.f7548j0, AndroidUtilities.dp(22.0f), this.f7563w);
                canvas3.rotate(-getRotation(), this.f7549k0, this.f7548j0);
                this.f7543f.draw(canvas3);
                canvas3.restore();
            }
        }
        ...
        if (a10 > 0.0f) {
            canvas3.save();
            canvas3.scale(a10, a10, this.f7549k0, this.f7548j0);
            canvas3.rotate(-getRotation(), this.f7549k0, this.f7548j0);
            this.f7536b.draw(canvas3);
            canvas3.restore();
        }
        if (this.O) {
            f34 = 1.0f;
        ...
        Paint paint8 = this.f7565x;
        org.telegram.ui.Components.e6 e6Var2 = this.N;
        org.telegram.ui.Components.zc zcVar4 = this.K;
        if (d20 > 0.0f) {
            canvas3.save();
            float a11 = zcVar4.a(0.2f) * d20 * f24;
            canvas3.scale(a11, a11, this.f7550l0, this.f7548j0);
            canvas3.rotate(e6Var2.d(this.M, false) - getRotation(), this.f7550l0, this.f7548j0);
            canvas3.drawCircle(this.f7550l0, this.f7548j0, AndroidUtilities.dp(22.0f), paint8);
            this.f7541e.draw(canvas3);
            canvas3.restore();
        }
        if (d20 < 1.0f) {
            canvas3.save();
            ...
            canvas3.scale(A, A, this.f7550l0, this.f7548j0);
            canvas3.rotate(e6Var2.d(this.M, false) - getRotation(), this.f7550l0, this.f7548j0);
            canvas3.drawCircle(this.f7550l0, this.f7548j0, AndroidUtilities.dp(22.0f), this.f7563w);
            this.d.draw(canvas3);
            canvas3.restore();
        } else {
            f35 = f24;
        ...
        if (i12 > 0) {
            Paint paint9 = this.f7567y;
            paint9.setAlpha(255);
            canvas3.drawCircle(this.f7568y0, this.f7548j0, f36, paint9);
            float f66 = this.f7568y0;
            f41 = 22.0f;
        ...
        if (i10 > 0 || f39 > 0.0f) {
            ...
            path3.rewind();
            if (i10 > 0) {
                path3.addCircle(this.f7568y0, this.f7548j0, f38, Path.Direction.CW);
            }
            if (f39 > 0.0f && this.A0) {
                path3.addCircle(this.f7549k0, this.f7548j0, f39 * AndroidUtilities.dp(f41) * a12, Path.Direction.CW);
            }
            canvas3.clipPath(path3);
            if (this.A0) {
                canvas3.save();
                canvas3.scale(a12, a12, this.f7549k0, this.f7548j0);
                canvas3.drawCircle(this.f7549k0, this.f7548j0, AndroidUtilities.dp(f41), paint8);
                canvas3.rotate(-getRotation(), this.f7549k0, this.f7548j0);
                this.h.draw(canvas3);
                canvas3.restore();
            }
            ...
            canvas3.save();
            canvas3.scale(a13, a13, this.f7550l0, this.f7548j0);
            canvas3.rotate(e6Var.d(this.M, false) - getRotation(), this.f7550l0, this.f7548j0);
            canvas3.drawCircle(this.f7550l0, this.f7548j0, AndroidUtilities.dp(f41), paint8);
            this.f7541e.draw(canvas3);
            canvas3.restore();
            canvas3.restore();
        }
        ...
        if (k7Var != null) {
            boolean b10 = b();
            boolean z14 = this.f7535a0;
            boolean z15 = this.f7557r0;
            if (z14 == z15 && this.f7537b0 == b10 && this.f7539c0 == this.O && this.f7540d0 == this.f7553o0 && this.f7542e0 == this.f7561u0 && this.f7544f0 == this.A0) {
                return;
            }
            this.f7535a0 = z15;
            this.f7537b0 = b10;
            this.f7539c0 = this.O;
            this.f7540d0 = this.f7553o0;
            this.f7542e0 = this.f7561u0;
            this.f7544f0 = this.A0;
            k7Var.i();
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        float f7 = size;
        this.f7547i0 = f7 / 2.0f;
        this.f7548j0 = dp / 2.0f;
        float min = Math.min(AndroidUtilities.dp(135.0f), f7 * 0.35f);
        float f10 = this.f7547i0;
        this.f7549k0 = f10 - min;
        float f11 = f10 + min;
        this.f7550l0 = f11;
        float f12 = this.f7548j0;
        float dp2 = AndroidUtilities.dp(14.0f);
        this.d.setBounds((int) (f11 - dp2), (int) (f12 - dp2), (int) (f11 + dp2), (int) (f12 + dp2));
        float f13 = this.f7550l0;
        float f14 = this.f7548j0;
        float dp3 = AndroidUtilities.dp(14.0f);
        this.f7541e.setBounds((int) (f13 - dp3), (int) (f14 - dp3), (int) (f13 + dp3), (int) (f14 + dp3));
        f(this.f7543f, this.f7549k0, this.f7548j0);
        f(this.h, this.f7549k0, this.f7548j0);
        f(this.f7551n, this.f7549k0, this.f7548j0);
        this.f7536b.setImageCoords(this.f7549k0 - AndroidUtilities.dp(20.0f), this.f7548j0 - AndroidUtilities.dp(20.0f), AndroidUtilities.dp(40.0f), AndroidUtilities.dp(40.0f));
        Matrix matrix = this.H;
        matrix.reset();
        matrix.postTranslate(this.f7547i0, this.f7548j0);
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        float clamp = Utilities.clamp(motionEvent.getX() + 0.0f, this.f7550l0, this.f7549k0);
        float y3 = motionEvent.getY() + 0.0f;
        boolean c10 = c(clamp, y3, this.f7550l0, this.f7548j0, AndroidUtilities.dp(7.0f), true);
        boolean z12 = this.f7561u0;
        ...
        if (z12) {
            ...
            zcVar3.c(false);
            zcVar.c(false);
        } else if (action == 0 || this.f7564w0) {
            zcVar2.c(c(clamp, y3, this.f7547i0, this.f7548j0, AndroidUtilities.dp(60.0f), false));
            if (c(clamp, y3, this.f7550l0, this.f7548j0, AndroidUtilities.dp(30.0f), true) && !b()) {
                z10 = true;
            } else {
                z10 = false;
            }
            zcVar3.c(z10);
            if (c(clamp, y3, this.f7549k0, this.f7548j0, AndroidUtilities.dp(30.0f), false) && !b()) {
                z11 = true;
            } else {
                z11 = false;
            }
        ...
        if (action == 0) {
            this.f7564w0 = true;
            this.f7566x0 = (zcVar2.h || zcVar3.h) ? true : true;
            System.currentTimeMillis();
            this.f7568y0 = clamp;
            if (Math.abs(clamp - this.f7547i0) < AndroidUtilities.dp(50.0f)) {
            ...
            if (this.f7564w0) {
                this.f7568y0 = Utilities.clamp(clamp, this.f7550l0, this.f7549k0);
                invalidate();
                if (this.f7557r0 && !this.X0 && c10) {
                    d(180.0f);
                    ((jb) this.f7534a).b();
                }
                if (this.f7557r0 && this.f7569z0) {
                    float clamp2 = Utilities.clamp(((this.f7548j0 - AndroidUtilities.dp(48.0f)) - y3) / (AndroidUtilities.displaySize.y / 2.0f), 1.0f, 0.0f);
                    pc pcVar = ((jb) this.f7534a).f7443a;
            ...
            if (this.f7564w0) {
                ...
                boolean z15 = this.f7557r0;
                if (!z15 && zcVar.h) {
                    pc pcVar2 = ((jb) this.f7534a).f7443a;
                    if (pcVar2.f7860f0 == 0 && !pcVar2.P1 && !pcVar2.Q1 && pc.b(pcVar2)) {
                        pcVar2.f(true);
                    }
                } else if (z15 && this.f7569z0) {
                    if (zcVar.h) {
                        this.f7569z0 = false;
                        this.G0.d(1.0f, true);
                        c4 c4Var = ((jb) this.f7534a).f7443a.T0;
                        c4Var.f6986a.q(LocaleController.getString(R.string.StoryHintPinchToZoom), true, true);
                        c4Var.invalidate();
                    } else {
                        this.f7557r0 = false;
                        this.f7562v0 = SystemClock.elapsedRealtime();
                        this.f7561u0 = true;
                        ((jb) this.f7534a).d(false);
                    }
                } else if (zcVar2.h) {
                    if (b()) {
                        ((jb) this.f7534a).a();
                    } else if (!this.f7553o0 && !this.f7557r0 && !this.f7569z0) {
                        ((jb) this.f7534a).c();
                    } else if (!this.f7557r0) {
                        if (pc.d(((jb) this.f7534a).f7443a)) {
                            this.R = 0L;
                            this.Q = System.currentTimeMillis();
                            this.A0 = false;
                            ((jb) this.f7534a).e(new i7(this, 1), false);
                        }
                    } else {
                        this.f7557r0 = false;
                        this.f7562v0 = SystemClock.elapsedRealtime();
    ...
    public void setInvert(float f7) {
        this.f7558s.setColor(i0.a.d(f7, -1, -16777216));
        this.f7563w.setColor(i0.a.d(f7, 1677721600, 369098752));
        ...
        this.f7543f.setColorFilter(new PorterDuffColorFilter(i0.a.d(f7, -1, -16777216), mode));
    }
}
