...
public final class zc extends View {
    ...
    public static void a(final zc zcVar, ViewGroup viewGroup, org.telegram.ui.ActionBar.f6 f6Var, org.telegram.ui.Components.ja jaVar, View view) {
        ...
        try {
            if (i11 == 2 && zcVar.N) {
                ...
                float min2 = Math.min((i12 - i13) - i14, ((((AndroidUtilities.lerp(zcVar.T, 1.0f, zcVar.f8578f0.f25593c) * ((float) zcVar.R)) + ((float) (zcVar.Q - zcVar.f8577f))) / ((float) min)) * zcVar.f8610u1) + i13 + i14);
                ...
                float min4 = Math.min((i15 - i16) - i17, ((((AndroidUtilities.lerp(zcVar.K, 1.0f, zcVar.f8572d0.f25593c) * ((float) zcVar.H)) + ((float) (zcVar.I - zcVar.f8577f))) / ((float) min3)) * zcVar.f8610u1) + i16 + i17);
    ...
    private float getCollageHeight() {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            f7 += AndroidUtilities.lerp(AndroidUtilities.dp(28.0f), AndroidUtilities.dp(38.0f), ((uc) arrayList.get(i10)).f8299k.f25593c);
        }
        return f7;
    }
    ...
    private float getVideoHeight() {
        ...
        return AndroidUtilities.lerp(AndroidUtilities.dp(28.0f), AndroidUtilities.dp(38.0f), ucVar.f8299k.f25593c);
    }
    ...
    public int getTimelineHeight() {
        return AndroidUtilities.lerp(AndroidUtilities.dp(28.0f) + this.f8623z1 + this.f8623z1, getContentHeight(), this.f8584i0.f25593c);
    }
