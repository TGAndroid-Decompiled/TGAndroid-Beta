...
public abstract class d7 extends FrameLayout {
    ...
    public Bitmap f7096a;
    public final float[] f7097a0;
    public final Rect f7098b;
    public float f7099b0;
    public final Rect f7100c;
    public float f7101c0;
    public o8 d;
    public float f7102d0;
    public g71 f7103e;
    public boolean f7104e0;
    public int f7105f;
    public final org.telegram.ui.Components.e6 f7106f0;
    public boolean f7107g0;
    public int h;
    public final Matrix f7108h0;
    public final Matrix f7109i0;
    public final Matrix f7110j0;
    public boolean f7111k0;
    public final PointF f7112l0;
    public final PointF m0;
    public u61 f7113n;
    public float f7114n0;
    public double f7115o0;
    public boolean f7116p0;
    public boolean f7117q0;
    public TextureView f7118r;
    public boolean f7119r0;
    public jf0 f7120s;
    public final Matrix f7121s0;
    public final Matrix f7122t0;
    public float f7123u0;
    public ka v;
    public boolean f7124v0;
    public rg.d2 f7125w;
    public boolean f7126w0;
    public g71 f7127x;
    public long f7128x0;
    public g71 f7129y;
    public Runnable f7130y0;
    public final HashSet f7131z0;
    ...
    public d7(Context context, org.telegram.ui.Components.ja jaVar, c7 c7Var) {
        ...
        this.T = new Paint(1);
        this.W = new Matrix();
        this.f7097a0 = new float[2];
        this.f7104e0 = true;
        this.f7106f0 = new org.telegram.ui.Components.e6(this, 0L, 320L, pr.f29495g);
        this.f7107g0 = false;
        this.f7108h0 = new Matrix();
        this.f7109i0 = new Matrix();
        this.f7110j0 = new Matrix();
        this.f7111k0 = true;
        this.f7112l0 = new PointF();
        this.m0 = new PointF();
        this.f7121s0 = new Matrix();
        this.f7122t0 = new Matrix();
        this.f7131z0 = new HashSet();
        this.G = jaVar;
        this.H = c7Var;
    ...
    public static Drawable g(int i10, final org.telegram.ui.ActionBar.d4 d4Var, final boolean z10) {
        if (d4Var.m()) {
            org.telegram.ui.ActionBar.j6.H(org.telegram.ui.ActionBar.d4.e(z10), d4Var.h(i10, z10 ? 1 : 0), ((org.telegram.ui.ActionBar.c4) d4Var.f20393f.get(z10 ? 1 : 0)).f20349g, 0, false);
        ...
        dc0Var.f25378g = false;
        dc0Var.t(dc0Var.f25391u, d4Var.k(z10 ? 1 : 0).settings.intensity);
    ...
    public final void d(Matrix matrix) {
        ...
        float[] fArr = this.f7097a0;
        fArr[0] = o8Var.f7792k0 / 2.0f;
        fArr[1] = o8Var.f7794l0 / 2.0f;
        matrix.mapPoints(fArr);
        this.f7099b0 = fArr[0];
        this.f7101c0 = fArr[1];
        o8 o8Var2 = this.d;
        fArr[0] = o8Var2.f7792k0;
        fArr[1] = o8Var2.f7794l0 / 2.0f;
        matrix.mapPoints(fArr);
        this.f7102d0 = (float) Math.toDegrees(Math.atan2(fArr[1] - this.f7101c0, fArr[0] - this.f7099b0));
        v7.z6.a(this.f7099b0, this.f7101c0, fArr[0], fArr[1]);
        o8 o8Var3 = this.d;
        fArr[0] = o8Var3.f7792k0 / 2.0f;
        fArr[1] = o8Var3.f7794l0;
        matrix.mapPoints(fArr);
        v7.z6.a(this.f7099b0, this.f7101c0, fArr[0], fArr[1]);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.S != null) {
            ...
            if (!(drawable instanceof dc0) || ((dc0) drawable).f25391u != null) {
        ...
        } else if (this.f7104e0 && this.d != null && !j()) {
            if (this.f7096a == null) {
                z10 = true;
            } else {
                z10 = false;
            }
            float e7 = this.f7106f0.e(z10);
            if (this.f7096a != null) {
                canvas2.save();
                canvas2.scale(getWidth() / this.d.f7788i0, getHeight() / this.d.f7790j0);
                canvas2.concat(this.d.f7797n0);
                if (this.d.m0 != null) {
                    canvas2.translate(o8Var.f7792k0 / 2.0f, o8Var.f7794l0 / 2.0f);
                    canvas2.rotate(-this.d.Q);
                    o8 o8Var2 = this.d;
                    int i10 = o8Var2.f7792k0;
                    int i11 = o8Var2.f7794l0;
                    int i12 = o8Var2.Q;
                    ...
                    canvas2.rotate(this.d.Q);
                    o8 o8Var3 = this.d;
                    canvas2.translate((-o8Var3.f7792k0) / 2.0f, (-o8Var3.f7794l0) / 2.0f);
                }
                Paint paint = this.Q;
                paint.setAlpha((int) ((1.0f - e7) * 255.0f));
                int width = this.f7096a.getWidth();
                int height = this.f7096a.getHeight();
                Rect rect = this.f7098b;
                rect.set(0, 0, width, height);
                o8 o8Var4 = this.d;
                int i13 = o8Var4.f7792k0;
                int i14 = o8Var4.f7794l0;
                Rect rect2 = this.f7100c;
                rect2.set(0, 0, i13, i14);
                canvas2.drawBitmap(this.f7096a, rect, rect2, paint);
                canvas2.restore();
            }
        }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        o8 o8Var;
        o8 o8Var2;
        u61 u61Var = this.f7113n;
        if (view == u61Var && (o8Var2 = this.d) != null && o8Var2.f7810u) {
            return false;
        }
        if ((view == u61Var || view == this.f7118r) && (o8Var = this.d) != null && o8Var.m0 != null) {
            canvas.save();
            canvas.scale(getWidth() / this.d.f7788i0, getHeight() / this.d.f7790j0);
            canvas.concat(this.d.f7797n0);
            o8 o8Var3 = this.d;
            if (o8Var3.m0 != null) {
                canvas.translate(o8Var3.f7792k0 / 2.0f, o8Var3.f7794l0 / 2.0f);
                canvas.rotate(-this.d.Q);
                o8 o8Var4 = this.d;
                int i10 = o8Var4.f7792k0;
                int i11 = o8Var4.f7794l0;
                int i12 = o8Var4.Q;
                ...
                canvas.rotate(this.d.Q);
                o8 o8Var5 = this.d;
                canvas.translate((-o8Var5.f7792k0) / 2.0f, (-o8Var5.f7794l0) / 2.0f);
            }
            canvas.concat(this.f7108h0);
            canvas.scale(1.0f / (getWidth() / this.d.f7788i0), 1.0f / (getHeight() / this.d.f7790j0));
    ...
    public Pair<Integer, Integer> getPaintSize() {
        ...
        return new Pair<>(Integer.valueOf(this.d.f7788i0), Integer.valueOf(this.d.f7790j0));
    }
    ...
    public final void h(Utilities.Callback callback, View... viewArr) {
        ...
        for (int i10 = 0; i10 < viewArr.length; i10++) {
            ...
            if (view != null && view.getWidth() >= 0 && viewArr[i10].getHeight() > 0) {
                ...
                if (view2 == this && (u61Var = this.f7113n) != null) {
    ...
    public final boolean k() {
        return !this.f7131z0.contains(-9982);
    }
    ...
    public final void o(TextureView textureView, jf0 jf0Var) {
        TextureView textureView2 = this.f7118r;
        if (textureView2 != null) {
            removeView(textureView2);
            this.f7118r = null;
        }
        this.f7120s = jf0Var;
        this.f7118r = textureView;
        if (jf0Var != null) {
            int i10 = this.U;
            int i11 = this.V;
        ...
        TextureView textureView3 = this.f7118r;
    ...
    public final void p(o8 o8Var, boolean z10) {
        ...
        if (o8Var != null) {
            ...
            if (o8Var.f7817y != null) {
                g71 g71Var2 = new g71();
                this.f7129y = g71Var2;
                g71Var2.f26345y = z11;
                g71Var2.J = new a6.i(this, 16);
                g71Var2.D(Uri.fromFile(new File(o8Var.f7817y)), "other");
                c();
                if (this.f7103e != null && getDuration() > 0) {
                    long duration = o8Var.Z * ((float) getDuration());
                    this.f7103e.L(duration, false);
            ...
            if (rbVar != null) {
                o8 o8Var2 = pcVar.K1;
                if (o8Var2 != null && o8Var2.f7817y != null) {
                    z12 = true;
                }
    ...
    public final void q(MessageObject messageObject) {
        ...
        if (o8Var != null) {
            ...
            if (messageObject != null && messageObject.messageOwner != null) {
                ...
                if (document != null && document.f19902id != 0) {
                    this.d.f7819z = new TLRPC.TL_inputDocument();
                    TLRPC.InputDocument inputDocument = this.d.f7819z;
                ...
                if (!TextUtils.isEmpty(messageObject.messageOwner.attachPath)) {
                    this.d.f7817y = messageObject.messageOwner.attachPath;
                } else {
                    ...
                    if (pathToAttach == null || !pathToAttach.exists()) {
                        ...
                        if (pathToAttach != null && pathToAttach.exists()) {
                            this.d.f7817y = pathToAttach.getAbsolutePath();
                        } else {
                            o8 o8Var2 = this.d;
                            o8Var2.f7817y = null;
                            o8Var2.f7819z = null;
    ...
    public final void r() {
        ...
        if (i11 != 0 && o8Var.B0 != 0) {
            ...
            jf0 jf0Var = this.f7120s;
            if (jf0Var != null) {
                int i16 = this.U;
                int i17 = this.V;
                vz vzVar2 = jf0Var.f27511l0;
                if (vzVar2 != null) {
                    vzVar2.i(i16, i17);
                } else {
                    jf0Var.J0 = i16;
    ...
    public final void s(o8 o8Var, rg.d2 d2Var, boolean z10) {
        g71 g71Var;
        if (o8Var != null && o8Var.f7799o0 != null) {
            g71 g71Var2 = this.f7127x;
            if (g71Var2 != null) {
                g71Var2.H();
                this.f7127x = null;
            ...
            g71 g71Var3 = new g71();
            this.f7127x = g71Var3;
            g71Var3.f26345y = true;
            g71Var3.J = new a6.m(this, 16);
            this.f7127x.D(Uri.fromFile(o8Var.f7799o0), "other");
            c();
            this.f7125w = d2Var;
            if (d2Var != null && (g71Var = this.f7127x) != null) {
                g71Var.V(d2Var.f45193u0);
            }
            this.F.n(o8Var.f7799o0.getAbsolutePath(), o8Var.f7803q0, o8Var.f7805r0, o8Var.f7807s0, o8Var.f7809t0, o8Var.f7811u0, z10);
            y(true);
            return;
        }
        g71 g71Var4 = this.f7127x;
        if (g71Var4 != null) {
            g71Var4.B();
            this.f7127x.H();
            this.f7127x = null;
    ...
    public final void t(o8 o8Var, Runnable runnable, long j3) {
        ...
        if (o8Var != null && !o8Var.v()) {
            ...
            g71 g71Var2 = new g71();
            this.f7103e = g71Var2;
            g71Var2.f26345y = true;
            g71Var2.J = new aa.a(this, o8Var, new Runnable[]{runnable});
            u61 u61Var = this.f7113n;
            if (u61Var != null) {
                u61Var.clearAnimation();
                u61 u61Var2 = this.f7113n;
                vz vzVar = u61Var2.f30849b;
                if (vzVar != null) {
                    vzVar.postRunnable(new sz(vzVar, 0));
                }
                u61Var2.f30848a = null;
                removeView(this.f7113n);
                this.f7113n = null;
            }
            this.f7113n = new u61(getContext(), this.f7103e);
            this.G.e();
            u61 u61Var3 = this.f7113n;
            if (o8Var.f7810u) {
                jaVar = null;
            } else {
                jaVar = this.G;
            }
            u61Var3.f30855s = jaVar;
            vz vzVar2 = u61Var3.f30849b;
            ...
            this.f7113n.setOpaque(false);
            b();
            c7 c7Var = this.H;
            if (c7Var != null && c7Var.f7022g) {
                c7Var.a(this.f7113n);
            } else {
                u61 u61Var4 = this.f7113n;
                if (runnable != null) {
                    f7 = 1.0f;
                }
                u61Var4.setAlpha(f7);
                addView(this.f7113n, w7.x5.e(-2, -2, 51));
            }
            ...
            this.f7103e.D(Uri.fromFile(file), "other");
            this.f7103e.P(this.f7131z0.isEmpty());
            this.f7103e.N(true);
            if (o8Var.h) {
                j3 = (o8Var.Z * ((float) o8Var.f7786h0)) + ((float) j3);
            }
            int i10 = (j3 > 0L ? 1 : (j3 == 0L ? 0 : -1));
            if (i10 > 0) {
                this.f7103e.L(j3, false);
            }
            c();
            w(true);
            if (o8Var.f7810u && (arrayList = o8Var.v) != null && arrayList.size() == 1 && ((MessageObject) o8Var.v.get(0)).type == 5) {
                z10 = true;
            } else {
                z10 = false;
            }
            ...
            this.F.setVideoRight(o8Var.f7769a0);
            zc zcVar2 = this.F;
        ...
        c7 c7Var2 = this.H;
        if (c7Var2 != null && c7Var2.f7022g) {
            c7Var2.a(null);
        } else {
            u61 u61Var5 = this.f7113n;
            if (u61Var5 != null) {
                u61Var5.clearAnimation();
                this.f7113n.animate().alpha(0.0f).withEndAction(new z6(this, 6)).start();
            }
        }
        zc zcVar3 = this.F;
        if (zcVar3 != null) {
    ...
    public final void u(o8 o8Var) {
        ...
        long j3 = o8Var.f7820z0;
        if (j3 != Long.MIN_VALUE) {
            Drawable e7 = e(this.S, o8Var.f7768a, j3, o8Var.f7818y0);
            o8Var.f7816x0 = e7;
            this.S = e7;
            if (this.R != e7) {
                this.R = null;
    ...
    public final boolean v(MotionEvent motionEvent) {
        ...
        if (this.f7111k0) {
            ...
            boolean z13 = this.f7116p0;
            PointF pointF3 = this.f7112l0;
            if (z13 != z10) {
                pointF3.x = pointF2.x;
                pointF3.y = pointF2.y;
                this.f7114n0 = f7;
            ...
            o8 o8Var = this.d;
            if (o8Var != null) {
                float width = o8Var.f7788i0 / getWidth();
                int actionMasked = motionEvent.getActionMasked();
                Matrix matrix = this.f7121s0;
                if (actionMasked == 0) {
                    this.f7123u0 = 0.0f;
                    this.f7124v0 = false;
                    invalidate();
                    this.f7126w0 = true;
                    matrix.set(this.d.f7797n0);
                }
                if (motionEvent.getActionMasked() == 2 && this.f7126w0 && this.d != null) {
                    float f10 = pointF2.x * width;
                    float f11 = pointF2.y * width;
                    float f12 = pointF3.x * width;
                    float f13 = pointF3.y * width;
                    if (motionEvent.getPointerCount() > 1) {
                        float f14 = this.f7114n0;
                        if (f14 != 0.0f) {
                            float f15 = f7 / f14;
                            matrix.postScale(f15, f15, f10, f11);
                        }
                        pointF = pointF2;
                        float degrees = (float) Math.toDegrees(d - this.f7115o0);
                        float f16 = this.f7123u0 + degrees;
                        this.f7123u0 = f16;
                        if (!this.f7119r0) {
                            ...
                            if (!z11) {
                                d(matrix);
                                if ((Math.round(this.f7102d0 / 90.0f) * 90.0f) - this.f7102d0 > 20.0f) {
                                    z12 = true;
                                } else {
                                    z12 = false;
                                }
                    ...
                    if (motionEvent.getPointerCount() > 1 || this.f7117q0) {
                        matrix.postTranslate(f10 - f12, f11 - f13);
                    }
                    Matrix matrix2 = this.f7122t0;
                    matrix2.set(matrix);
                    Matrix matrix3 = this.W;
                    matrix3.set(matrix);
                    d(matrix3);
                    float round = (Math.round(this.f7102d0 / 90.0f) * 90.0f) - this.f7102d0;
                    if (this.f7119r0) {
                        if (Math.abs(round) < 3.5f) {
                            matrix2.postRotate(round, this.f7099b0, this.f7101c0);
                            if (!this.f7124v0) {
                                AndroidUtilities.vibrateCursor(this);
                                this.f7124v0 = true;
                            }
                ...
                if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
                    if (motionEvent.getPointerCount() <= 1) {
                        this.f7117q0 = false;
                        pc pcVar = ((dc) this).C0;
                        pcVar.f7915o1.a(true, false, pcVar.f7897i0);
    ...
    public final void y(boolean z10) {
        ...
        boolean z11;
        int i10;
        if (this.f7127x != null && this.d != null) {
            boolean z12 = true;
            if (this.f7103e == null && !j()) {
                this.f7127x.P(this.f7131z0.isEmpty());
                this.f7127x.N(true);
                rg.d2 d2Var = this.f7125w;
                if (d2Var != null && !d2Var.B0) {
                    d2Var.B0 = true;
                    d2Var.C0.f(true, true);
                    d2Var.invalidate();
                }
                long n11 = this.f7127x.n();
                if (z10 && this.f7127x.p() != -9223372036854775807L) {
                    float p5 = ((float) n11) / ((float) this.f7127x.p());
                    o8 o8Var = this.d;
                    if ((p5 < o8Var.f7807s0 || p5 > o8Var.f7809t0) && System.currentTimeMillis() - this.J > 500) {
                        this.J = System.currentTimeMillis();
                        this.f7127x.L(-this.d.f7805r0, false);
                        return;
                    }
                    return;
                }
            ...
            o8 o8Var2 = this.d;
            float f10 = o8Var2.f7809t0;
            float f11 = o8Var2.f7807s0;
            long j3 = (f10 - f11) * ((float) o8Var2.f7803q0);
            long j10 = o8Var2.f7805r0;
            ...
            rg.d2 d2Var2 = this.f7125w;
            if (d2Var2 != null && d2Var2.B0 != z11) {
                d2Var2.B0 = z11;
                d2Var2.invalidate();
            }
            if (this.f7127x.y() != z12) {
                this.f7127x.P(z12);
                this.f7127x.L(j11, false);
            } else if (z10) {
                long abs = Math.abs(this.f7127x.n() - j11);
                if (j()) {
                    i10 = 300;
                } else {
                    i10 = 120;
