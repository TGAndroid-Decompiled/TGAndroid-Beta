...
public abstract class d7 extends FrameLayout {
    ...
    public d7(Context context, org.telegram.ui.Components.ja jaVar, c7 c7Var) {
        ...
        this.f7076e0 = true;
        this.f7078f0 = new org.telegram.ui.Components.e6(this, 0L, 320L, pr.f29468g);
        this.f7079g0 = false;
    ...
    public static Drawable g(int i10, final org.telegram.ui.ActionBar.d4 d4Var, final boolean z10) {
        if (d4Var.m()) {
            org.telegram.ui.ActionBar.j6.H(org.telegram.ui.ActionBar.d4.e(z10), d4Var.h(i10, z10 ? 1 : 0), ((org.telegram.ui.ActionBar.c4) d4Var.f20366f.get(z10 ? 1 : 0)).f20322g, 0, false);
        ...
        dc0Var.f25351g = false;
        dc0Var.t(dc0Var.f25364u, d4Var.k(z10 ? 1 : 0).settings.intensity);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.S != null) {
            ...
            if (!(drawable instanceof dc0) || ((dc0) drawable).f25364u != null) {
    ...
    public final void t(o8 o8Var, Runnable runnable, long j3) {
        ...
        if (o8Var != null && !o8Var.v()) {
            ...
            u61Var3.f30828s = jaVar;
            vz vzVar2 = u61Var3.f30822b;
