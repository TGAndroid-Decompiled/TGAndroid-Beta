    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.f8385a) {
            ...
            case 5:
                ...
                float e7 = ((org.telegram.ui.Components.e6) this.f8386b).e(v21Var.f31070w);
                if (e7 > 0.0f) {
                    if (v21Var.f31064c == null) {
                        v21Var.f31064c = new zo0(this);
                    }
                    canvas.translate(getWidth() / 2.0f, getHeight() / 2.0f);
                    v21Var.f31064c.a(canvas, e7);
                    canvas.translate((-getWidth()) / 2.0f, (-getHeight()) / 2.0f);
                }
                super.dispatchDraw(canvas);
                canvas.restore();
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.f8385a) {
            case 0:
                ...
                if (layout2 != null) {
                    ...
                    if (layout == null) {
                        ...
                        interpolation = pr.f29467f.getInterpolation(q6Var.f7953a1);
                    }
            ...
            case 8:
                ...
                TextView textView4 = (TextView) getChildAt(o0Var.f45350g1);
                int i11 = o0Var.f45352h1;
                Layout layout3 = null;
                if (i11 != -1) {
                ...
                if (layout3 == null) {
                    ...
                    interpolation2 = pr.f29467f.getInterpolation(o0Var.f45354i1);
                }
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.f8385a) {
            case 1:
                ...
                v0Var.f21379b.measure(i10, i11);
                if (v0Var.f21379b.getSwipeBack() != null) {
                    view.getLayoutParams().width = v0Var.f21379b.getSwipeBack().getChildAt(0).getMeasuredWidth();
                } else {
                    view.getLayoutParams().width = v0Var.f21379b.getMeasuredWidth() - AndroidUtilities.dp(16.0f);
                }
