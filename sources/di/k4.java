...
public final class k4 extends FrameLayout {
    ...
    public final org.telegram.ui.Components.x9 f7463a;
    ...
    public final void setVisibility(int i10) {
        ...
        if (i10 == 0 && !this.f7465c) {
            this.f7463a.setImageDrawable(new xi0(R.raw.utyan_empty2, AndroidUtilities.dp(130.0f), AndroidUtilities.dp(130.0f)));
            this.f7465c = true;
        }
    }
}
