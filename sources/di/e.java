    ...
    public final void run() {
        ...
        switch (i12) {
            ...
            default:
                ...
                if (mVar.f7632p0 != z10) {
                    mVar.f7632p0 = z10;
                    ValueAnimator valueAnimator = mVar.f7633q0;
                    if (valueAnimator != null) {
                        valueAnimator.cancel();
                        mVar.f7633q0 = null;
                    }
                    Utilities.Callback callback = mVar.f7627k0;
                    if (callback != null) {
                    ...
                    mVar.f7633q0 = ofFloat;
                    ofFloat.addUpdateListener(new ah.d0(mVar, 16));
                    if (!z10) {
                        gVar.getEditText().setAllowDrawCursor(false);
                    }
                    mVar.f7633q0.addListener(new ah.q0(8, mVar, z10));
                    if (z10) {
                        mVar.f7633q0.setInterpolator(org.telegram.ui.ActionBar.p1.f21302w);
                        mVar.f7633q0.setDuration(250L);
                    } else {
                        mVar.f7633q0.setInterpolator(new u1.a());
                        mVar.f7633q0.setDuration(420L);
                    }
                    mVar.f7633q0.start();
                    ...
                    if (z10 && SharedConfig.getDevicePerformanceClass() >= 1 && !LiteMode.isPowerSaverApplied()) {
                        if (mVar.f7635r0 == null) {
                            mVar.f7635r0 = Bitmap.createBitmap((int) (frameLayout.getWidth() / 12.0f), (int) (frameLayout.getHeight() / 12.0f), Bitmap.Config.ARGB_8888);
                        }
                        mVar.f7646y0 = true;
                        mVar.i(mVar.f7635r0);
                        mVar.f7646y0 = false;
                        Bitmap bitmap = mVar.f7635r0;
                        if (bitmap != null && !bitmap.isRecycled()) {
                            Bitmap bitmap2 = mVar.f7635r0;
                            Shader.TileMode tileMode = Shader.TileMode.CLAMP;
                            mVar.f7637s0 = new BitmapShader(bitmap2, tileMode, tileMode);
                            Matrix matrix = mVar.f7638t0;
                            if (matrix == null) {
                                mVar.f7638t0 = new Matrix();
                            } else {
                                matrix.reset();
                            }
                            ...
                            mVar.f7639u0.setShader(mVar.f7637s0);
                            return;
                        }
                        mVar.f7635r0 = null;
                        return;
