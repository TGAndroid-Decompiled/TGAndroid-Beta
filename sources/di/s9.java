    ...
    public void g(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        switch (this.f8156a) {
            ...
            default:
                ...
                j60Var.d.getMessagesController().addUserToChat(j60Var.i1(), (TLRPC.User) this.d, 0, null, (org.telegram.ui.ActionBar.n2) j60Var.f37575i0.O().getFragmentStack().get(j60Var.f37575i0.O().getFragmentStack().size() - 1), new bi.g(j60Var, this.f8157b, 24));
                return;
        }
    }
