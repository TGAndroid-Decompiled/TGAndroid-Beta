...
public final class p5 implements Utilities.CallbackReturn {
    ...
    public final Object run(Object obj) {
        switch (this.f7853a) {
            case 0:
                q6 q6Var = (q6) this.f7854b;
                boolean[] zArr = (boolean[]) this.f7855c;
                z5 z5Var = (z5) this.d;
            ...
            case 1:
                final org.telegram.ui.Components.f0 f0Var = (org.telegram.ui.Components.f0) this.f7854b;
                final org.telegram.ui.ActionBar.f6 f6Var = (org.telegram.ui.ActionBar.f6) this.f7855c;
                Context context = (Context) this.d;
                org.telegram.ui.Components.d0 d0Var = (org.telegram.ui.Components.d0) obj;
                TL_aicompose.AiComposeTone aiComposeTone = d0Var.f25190e;
                if (aiComposeTone instanceof TL_aicompose.TL_aiComposeTone) {
                    ...
                    F.W(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(12.0f), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20690d6, f6Var)));
                        ...
                        public final void run() {
                            ...
                            switch (r4) {
                                case 0:
                                    ...
                                    zVar.f33061j0 = tL_aiComposeTone2;
                                    zVar.f33059h0 = Long.valueOf(tL_aiComposeTone2.emoji_id);
                                    zVar.X();
                                    zVar.f33052a0.setText(zVar.f33061j0.title);
                                    zVar.f33053b0.setText(zVar.f33061j0.prompt);
                                    if (zVar.f33061j0.author_id != 0) {
                                        z10 = true;
                                    } else {
                                        z10 = false;
                                    }
                                    zVar.f33055d0.a(z10, false);
                                    zVar.f24674e.setTitle(LocaleController.getString(R.string.AIEditorEditStyle));
                                    zVar.f33058g0.setText(LocaleController.getString(R.string.AIEditorStyleEdit));
                                    zVar.W();
                                    zVar.m0.N(false);
                                    zVar.f33063l0 = new e(f0Var2, 2);
                                    zVar.show();
                                    return;
                                default:
                                    f0 f0Var3 = f0Var;
                                    AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(f0Var3.getContext(), 0, f6Var);
                                    alertDialog$Builder.f20225a.R = LocaleController.getString(R.string.AIEditorDeleteStyle);
                                    alertDialog$Builder.f20225a.T = LocaleController.getString(R.string.AIEditorDeleteStyleText);
            ...
            case 2:
                View view = (View) obj;
                MessageObject messageObject = ((sh.g) this.d).f46435b;
                return sh.c.d(view, (String) this.f7854b, (String) this.f7855c, messageObject.getDocument(), messageObject);
            default:
                ll0 ll0Var = (ll0) this.f7854b;
                Utilities.CallbackReturn callbackReturn = (Utilities.CallbackReturn) this.f7855c;
                ...
                try {
                    ...
                    if (T != null) {
                        sparseIntArray.put(T.f45770f, booleanValue ? 1 : 0);
                    }
                    return bool;
