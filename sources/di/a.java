...
public final class a extends View {
    public final ImageReceiver f6854a;
    public final String f6855b;
    public final String f6856c;
    public final TextPaint d;
    public StaticLayout f6857e;
    public float f6858f;
    public float h;
    public final TextPaint f6859n;
    public StaticLayout f6860r;
    public float f6861s;
    public float v;
    ...
    public a(Context context, MediaController.PhotoEntry photoEntry, String str, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f6854a = imageReceiver;
        TextPaint textPaint = new TextPaint(1);
        this.d = textPaint;
        TextPaint textPaint2 = new TextPaint(1);
        this.f6859n = textPaint2;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        ImageReceiver imageReceiver = this.f6854a;
        ...
        if (this.f6857e != null) {
            canvas.save();
            canvas.translate(dp - this.h, (getMeasuredHeight() - this.f6857e.getHeight()) / 2.0f);
            this.f6857e.draw(canvas);
            dp = dp + this.f6858f + AndroidUtilities.dp(6.0f);
            canvas.restore();
        }
        if (this.f6860r != null) {
            canvas.save();
            canvas.translate(dp - this.v, AndroidUtilities.dpf2(1.6f) + ((getMeasuredHeight() - this.f6860r.getHeight()) / 2.0f));
            this.f6860r.draw(canvas);
            canvas.restore();
        }
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.f6854a.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f6854a.onDetachedFromWindow();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        StaticLayout staticLayout = this.f6857e;
        if (staticLayout == null || staticLayout.getWidth() != size) {
            ...
            this.f6857e = staticLayout2;
            int lineCount = staticLayout2.getLineCount();
            float f12 = 0.0f;
            if (lineCount > 0) {
                f7 = this.f6857e.getLineLeft(0);
            } else {
                f7 = 0.0f;
            }
            this.h = f7;
            if (this.f6857e.getLineCount() > 0) {
                f10 = this.f6857e.getLineWidth(0);
            } else {
                f10 = 0.0f;
            }
            this.f6858f = f10;
            int dp = size - ((int) (f10 + AndroidUtilities.dp(8.0f)));
            TextPaint textPaint2 = this.f6859n;
            StaticLayout staticLayout3 = new StaticLayout(TextUtils.ellipsize(this.f6856c, textPaint2, dp, truncateAt), textPaint2, Math.max(0, dp), alignment, 1.0f, 0.0f, false);
            this.f6860r = staticLayout3;
            if (staticLayout3.getLineCount() > 0) {
                f11 = this.f6860r.getLineLeft(0);
            } else {
                f11 = 0.0f;
            }
            this.v = f11;
            if (this.f6860r.getLineCount() > 0) {
                f12 = this.f6860r.getLineWidth(0);
            }
            this.f6861s = f12;
        }
        if (View.MeasureSpec.getMode(i10) == Integer.MIN_VALUE) {
            setMeasuredDimension((int) Math.min(AndroidUtilities.dp(12.0f) + AndroidUtilities.dp(30.0f) + getPaddingLeft() + this.f6858f + AndroidUtilities.dp(8.0f) + this.f6861s + getPaddingRight(), View.MeasureSpec.getSize(i10)), AndroidUtilities.dp(48.0f));
