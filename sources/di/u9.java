...
public final class u9 extends s4.s0 {
    ...
    public final NotificationCenter.NotificationCenterDelegate f8287c;

    public u9(NotificationCenter.NotificationCenterDelegate notificationCenterDelegate, int i10) {
        this.f8285a = i10;
        this.f8287c = notificationCenterDelegate;
    }
    ...
    public void a(RecyclerView recyclerView, int i10) {
        ...
        switch (this.f8285a) {
            case 0:
                ba baVar = (ba) this.f8287c;
                ll0 ll0Var = baVar.f6988f;
                ia iaVar = baVar.W;
                boolean z11 = true;
                if (i10 == 1) {
                    z10 = ((org.telegram.ui.ActionBar.f3) iaVar).keyboardVisible;
                    if (z10 && baVar.f6993x != null) {
                        iaVar.f1();
                    }
                }
                if (i10 == 0) {
            ...
            default:
                return;
            case 2:
                ChatAttachAlertPhotoLayout chatAttachAlertPhotoLayout = (ChatAttachAlertPhotoLayout) this.f8287c;
                ...
                if (i10 == 0) {
                    ...
                    if (((viVar.f31293b2[0] - backgroundPaddingTop) - i12) + backgroundPaddingTop < (viVar.O0.getAlpha() * viVar.O0.getMeasuredHeight()) + org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() && (vk0Var = (vk0) tlVar.K(0)) != null) {
    ...
    public final void b(RecyclerView recyclerView, int i10, int i11) {
        ...
        switch (this.f8285a) {
            case 0:
                ...
                if (canScrollVertically != this.f8286b) {
                    baVar.f6990r.invalidate();
                    this.f8286b = canScrollVertically;
                }
                baVar.f6987e.invalidate();
                viewGroup = ((org.telegram.ui.ActionBar.f3) iaVar).containerView;
                viewGroup.invalidate();
                if (baVar.f6984a == 6 && ll0Var.getChildCount() > 0) {
                ...
                return;
            case 1:
                org.telegram.ui.z6 z6Var = (org.telegram.ui.z6) this.f8287c;
                if (z6Var.f43334c.L0() <= 0 && !org.telegram.ui.z6.a0(z6Var).s()) {
                    z10 = false;
                } else {
                    z10 = true;
                }
                org.telegram.ui.z6.b0(z6Var, z10);
                if (this.f8286b != z6Var.V.Z()) {
                    this.f8286b = z6Var.V.Z();
                    z6Var.V.invalidate();
                    return;
                }
                return;
