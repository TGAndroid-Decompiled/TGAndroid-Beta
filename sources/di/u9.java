        ...
        switch (this.f8285a) {
            ...
            case 2:
                ...
                if (i10 == 0) {
                    ...
                    if (((viVar.f31294b2[0] - backgroundPaddingTop) - i12) + backgroundPaddingTop < (viVar.O0.getAlpha() * viVar.O0.getMeasuredHeight()) + org.telegram.ui.ActionBar.k.getCurrentActionBarHeight() && (vk0Var = (vk0) tlVar.K(0)) != null) {
    ...
    public final void b(RecyclerView recyclerView, int i10, int i11) {
        ...
        switch (this.f8285a) {
            ...
            case 1:
                ...
                if (z6Var.f43335c.L0() <= 0 && !org.telegram.ui.z6.a0(z6Var).s()) {
                    z10 = false;
                } else {
                    z10 = true;
                }
