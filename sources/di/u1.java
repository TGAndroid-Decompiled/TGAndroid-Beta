    ...
    public final void run() {
        ...
        switch (i21) {
            ...
            case 15:
                ...
                if (TextUtils.equals(oaVar.f29040a, (String) obj4)) {
                    oaVar.f29044f = null;
                    Bitmap bitmap4 = oaVar.f29041b;
                    if (bitmap4 != null) {
                        bitmap4.recycle();
                    }
                    oaVar.f29041b = bitmap2;
                    Runnable runnable = oaVar.f29043e;
                    if (runnable != null) {
                        runnable.run();
                    }
                } else {
            ...
            case 17:
                ...
                syVar.f30466a.remove(str4);
                kz kzVar = syVar.f30467b;
                py pyVar = kzVar.f27982j0;
                HashMap hashMap = kzVar.f27988l0;
                boolean z13 = pyVar.v;
                boolean z14 = this.f8251b;
                if (z13 && pyVar.f29545w.equals(str3)) {
                    kzVar.f27982j0.E(str3, "", false, true, z14, str4, tLObject4);
                    return;
            ...
            case 19:
                ...
                if (tL_error == null) {
                    ...
                    if (closestPhotoSizeWithSize != null && uyVar.f41280c4 != null) {
                        ...
                        FileLoader.getInstance(i19).getPathToAttach(uyVar.f41280c4, true).renameTo(pathToAttach2);
                        StringBuilder sb2 = new StringBuilder();
                        sb2.append(uyVar.f41280c4.volume_id);
                        sb2.append("_");
                        String n10 = a4.a.n(uyVar.f41280c4.local_id, "@50_50", sb2);
                    ...
                    if (closestVideoSizeWithSize != null && str5 != null) {
                    ...
                    } else if (closestPhotoSizeWithSize2 != null && uyVar.f41285d4 != null) {
                        ...
                        FileLoader.getInstance(i16).getPathToAttach(uyVar.f41285d4, true).renameTo(pathToAttach3);
                    }
