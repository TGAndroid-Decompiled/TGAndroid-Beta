    ...
    public final void run() {
        ...
        switch (i21) {
            ...
            case 15:
                ...
                if (TextUtils.equals(oaVar.f29013a, (String) obj4)) {
                    oaVar.f29017f = null;
                    Bitmap bitmap4 = oaVar.f29014b;
                    if (bitmap4 != null) {
                        bitmap4.recycle();
                    }
                    oaVar.f29014b = bitmap2;
                    Runnable runnable = oaVar.f29016e;
                    if (runnable != null) {
                        runnable.run();
                    }
                } else {
            ...
            case 17:
                ...
                syVar.f30439a.remove(str4);
                kz kzVar = syVar.f30440b;
                py pyVar = kzVar.f27955j0;
                HashMap hashMap = kzVar.f27961l0;
                boolean z13 = pyVar.v;
                boolean z14 = this.f8223b;
                if (z13 && pyVar.f29518w.equals(str3)) {
                    kzVar.f27955j0.E(str3, "", false, true, z14, str4, tLObject4);
                    return;
            ...
            case 19:
                ...
                if (tL_error == null) {
                    ...
                    if (closestPhotoSizeWithSize != null && uyVar.f41253c4 != null) {
                        ...
                        FileLoader.getInstance(i19).getPathToAttach(uyVar.f41253c4, true).renameTo(pathToAttach2);
                        StringBuilder sb2 = new StringBuilder();
                        sb2.append(uyVar.f41253c4.volume_id);
                        sb2.append("_");
                        String n10 = a4.a.n(uyVar.f41253c4.local_id, "@50_50", sb2);
                    ...
                    if (closestVideoSizeWithSize != null && str5 != null) {
                    ...
                    } else if (closestPhotoSizeWithSize2 != null && uyVar.f41258d4 != null) {
                        ...
                        FileLoader.getInstance(i16).getPathToAttach(uyVar.f41258d4, true).renameTo(pathToAttach3);
                    }
