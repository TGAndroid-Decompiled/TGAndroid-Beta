        ...
        switch (this.f8074a) {
            case 0:
                ...
                if (tL_channels_channelParticipants != null && !tL_channels_channelParticipants.participants.isEmpty()) {
                    ...
                    baVar.d(this.f8075b, tL_chatParticipants);
                    return;
                }
                return;
            case 1:
                ResultCallback resultCallback = (ResultCallback) this.f8076c;
                dg.a aVar = (dg.a) obj;
                if (resultCallback != null) {
                    resultCallback.onComplete(new Pair(Long.valueOf(this.f8075b), aVar));
                    return;
                }
                return;
            default:
                vw0 vw0Var = (vw0) this.f8076c;
                TLRPC.TL_messages_emojiGroups tL_messages_emojiGroups = (TLRPC.TL_messages_emojiGroups) obj;
                if (tL_messages_emojiGroups != null) {
                    NotificationCenter.getInstance(UserConfig.selectedAccount).doOnIdle(new a3.g0(vw0Var, tL_messages_emojiGroups, this.f8075b, 23));
                    return;
                }
                return;
        }
