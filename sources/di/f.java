...
public final class f extends l20 {
    ...
    public final void E(ViewGroup viewGroup, int i10, int i11, int[] iArr, int i12) {
        ...
        switch (this.K0) {
            case 0:
                i iVar = (i) this.M0;
                if (viewGroup == iVar.f35448c && iVar.R.isAttachedToWindow()) {
                    ...
                    boolean z11 = false;
                    if (i11 < 0) {
                        if (iVar.f35448c.getHeight() - bottom >= 0) {
                            xl0 currentListView = iVar.R.getCurrentListView();
                            int L0 = ((c0) currentListView.getLayoutManager()).L0();
                            int i15 = -1;
                            if (L0 != -1) {
                                c1 K = currentListView.K(L0);
                                if (K != null) {
                                    i15 = K.f42959a.getTop();
                                }
                        ...
                        xl0 currentListView2 = iVar.R.getCurrentListView();
                        iArr[1] = i11;
                        if (top > 0) {
                            iArr[1] = 0;
                        }
                        ...
                        xl0 currentListView3 = iVar.R.getCurrentListView();
                        if (iVar.f35448c.getHeight() - bottom >= 0 && currentListView3 != null && !currentListView3.canScrollVertically(1)) {
                            iArr[1] = i11;
                            iVar.f35448c.B0();
                            return;
                        }
            ...
            default:
                w7 w7Var = (w7) this.M0;
                if (viewGroup == w7Var.f35448c && w7Var.R.isAttachedToWindow()) {
                    ...
                    boolean z13 = false;
                    if (i11 < 0) {
                        if ((w7Var.f35448c.getHeight() - w7Var.f35448c.getPaddingBottom()) - bottom2 >= 0) {
                            xl0 currentListView4 = w7Var.R.getCurrentListView();
                            int L02 = ((c0) currentListView4.getLayoutManager()).L0();
                            int i16 = -1;
                            if (L02 != -1) {
                                c1 K2 = currentListView4.K(L02);
                                if (K2 != null) {
                                    i16 = K2.f42959a.getTop();
                                }
                        ...
                        xl0 currentListView5 = w7Var.R.getCurrentListView();
                        iArr[1] = i11;
                        if (top2 > 0) {
                            iArr[1] = 0;
                        }
                        ...
                        xl0 currentListView6 = w7Var.R.getCurrentListView();
                        if ((w7Var.f35448c.getHeight() - w7Var.f35448c.getPaddingBottom()) - bottom2 >= 0 && currentListView6 != null && !currentListView6.canScrollVertically(1)) {
                            iArr[1] = i11;
                            w7Var.f35448c.B0();
                            return;
                        }
        ...
        switch (this.K0) {
            case 0:
                ...
                try {
                    if (viewGroup == iVar.f35448c && iVar.R.isAttachedToWindow()) {
                        xl0 currentListView = iVar.R.getCurrentListView();
                        if (iVar.f35448c.getHeight() - ((View) iVar.R.getParent()).getBottom() >= 0) {
                            iArr[1] = i13;
            ...
            default:
                ...
                try {
                    if (viewGroup == w7Var.f35448c && w7Var.R.isAttachedToWindow()) {
                        xl0 currentListView2 = w7Var.R.getCurrentListView();
                        if ((w7Var.f35448c.getHeight() - w7Var.f35448c.getPaddingBottom()) - ((View) w7Var.R.getParent()).getBottom() >= 0) {
                            iArr[1] = i13;
                            currentListView2.scrollBy(0, i13);
                            return;
                        }
