...
public final class nc extends ScaleGestureDetector.SimpleOnScaleGestureListener {
    ...
    public final boolean onScale(ScaleGestureDetector scaleGestureDetector) {
        sb sbVar;
        oc ocVar = this.f7703a;
        pc pcVar = ocVar.E0;
        if (!ocVar.A0 || (sbVar = pcVar.B0) == null || pcVar.f7860f0 != 0 || sbVar.f7047s || pcVar.A0.getFilledProgress() >= 1.0f) {
            return false;
        }
    ...
    public final boolean onScaleBegin(ScaleGestureDetector scaleGestureDetector) {
        oc ocVar = this.f7703a;
        pc pcVar = ocVar.E0;
        if (pcVar.B0 != null && pcVar.f7860f0 == 0 && !pcVar.K0) {
            ocVar.A0 = true;
