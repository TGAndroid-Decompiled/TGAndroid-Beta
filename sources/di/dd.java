...
public final class dd extends View {
    public final Paint f7141a;
    public final org.telegram.ui.Components.p6 f7142b;
    ...
    public dd(Activity activity) {
        ...
        sb2.append("00:00:00");
        if (!TextUtils.equals(sb2, p6Var.f29316g)) {
            p6Var.b();
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        org.telegram.ui.Components.p6 p6Var = this.f7142b;
        float d = p6Var.d();
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(5.0f), AndroidUtilities.dp(5.0f), this.f7141a);
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.f7142b != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
