    ...
    public final boolean a() {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                return m0Var.h.j();
            default:
                te0 te0Var = ((ue0) frameLayout).f30896a;
                if (te0Var != null) {
    ...
    public final void c() {
        switch (this.f7339a) {
            ...
            case 1:
                ...
                return;
            default:
                ((ue0) this.f7340b).f30897b.f16330a.g(1, true);
                return;
        }
    }
