...
public final class x8 extends org.telegram.ui.Components.bb implements NotificationCenter.NotificationCenterDelegate {
    ...
    public x8(Context context, e6 e6Var, d7 d7Var, m2 m2Var) {
        ...
        int themedColor = getThemedColor(org.telegram.ui.ActionBar.j6.f20890o6);
    ...
    public static void P(x8 x8Var, Context context, d7 d7Var, View view, int i10) {
        ...
        if (G != null) {
            if (G.G(v8.class) && (webPage = x8Var.f8429g0) != null && !W(webPage)) {
                ...
                p0Var.f45438c = i3Var2.f22102b.getText().toString();
                if (x8Var.m0) {
                    str = i3Var.f22102b.getText().toString();
                } else {
                    str = null;
                }
                p0Var.f45437b = str;
                ...
                p0Var.d = webPage2;
                p0Var.f45439e = x8Var.f8436o0;
                p0Var.f45440f = x8Var.f8435n0;
                ...
                vb0 vb0Var = v2Var.f45562x;
                vb0Var.setVisibility(i11);
                v2Var.f45557f.b(v2Var.f45553a, p0Var, false);
                v2Var.f45561w.a(!p0Var.f45440f, false);
                vb0Var.a(!p0Var.f45439e, false);
                v2Var.H = o1Var;
                v2Var.f45556e.setImageDrawable(new e4(d7Var, 8));
                v2Var.show();
    ...
    public static void Q(x8 x8Var) {
        ...
        getwebpagepreview.message = x8Var.Y.f22102b.getText().toString();
    ...
    public final void X() {
        ...
        if (this.f8427e0 != null) {
            rg.p0 p0Var = new rg.p0();
            p0Var.f45438c = this.Y.f22102b.getText().toString();
            if (this.m0) {
                str = this.Z.f22102b.getText().toString();
            } else {
                str = null;
            }
            p0Var.f45437b = str;
            p0Var.d = this.f8429g0;
            p0Var.f45439e = this.f8436o0;
            p0Var.f45440f = this.f8435n0;
    ...
    public final void dismiss() {
        AndroidUtilities.hideKeyboard(this.Y.f22102b);
        AndroidUtilities.hideKeyboard(this.Z.f22102b);
        super.dismiss();
