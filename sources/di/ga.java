...
public final class ga {
            ...
            if (tL_privacyValueDisallowUsers != null) {
                ...
                while (i11 < tL_privacyValueDisallowUsers.users.size()) {
                    ...
                    if (!(inputUser instanceof TLRPC.TL_inputUserEmpty)) {
                        ...
                        this.f7300c.add(l4);
                        this.f7301e.add(inputUser);
                    }
                    i11++;
                }
                this.f7299b.add(tL_inputPrivacyValueDisallowUsers);
            }
            ...
            if (tL_privacyValueAllowUsers != null) {
                ...
                while (i11 < tL_privacyValueAllowUsers.users.size()) {
                    ...
                    if (inputUser2 != null && !(inputUser2 instanceof TLRPC.TL_inputUserEmpty)) {
                        ...
                        this.f7300c.add(l10);
                        this.f7301e.add(inputUser2);
                    }
                    i11++;
                }
                this.f7299b.add(tL_inputPrivacyValueAllowUsers);
                ...
                if (tL_privacyValueDisallowUsers2 != null) {
                    ...
                    while (i11 < tL_privacyValueDisallowUsers2.users.size()) {
                        ...
                        if (!(inputUser3 instanceof TLRPC.TL_inputUserEmpty)) {
                            ...
                            this.f7300c.add(l11);
                            this.f7301e.add(inputUser3);
                        }
                        i11++;
                    }
                    this.f7299b.add(tL_inputPrivacyValueDisallowUsers2);
                }
            } else {
                this.f7298a = 4;
            }
    ...
    public final boolean b(TLRPC.User user) {
        ...
        ArrayList arrayList = this.f7300c;
        int i10 = this.f7298a;
        if (i10 == 4) {
            return !arrayList.contains(Long.valueOf(user.f20016id));
        }
        if (i10 == 2) {
            if (arrayList.contains(Long.valueOf(user.f20016id)) || !user.contact) {
                return false;
            }
            return true;
        } else if (i10 == 1) {
            ...
            if (i10 == 3) {
                if (arrayList.contains(Long.valueOf(user.f20016id))) {
                    return true;
                }
                for (ArrayList arrayList2 : this.d.values()) {
                    if (arrayList2.contains(Long.valueOf(user.f20016id))) {
                        return true;
                    }
                }
            }
    ...
    public ga(int i10, ArrayList arrayList, int i11) {
        ...
        if (i10 == 4) {
            ...
            while (i12 < arrayList.size()) {
                ...
                if (inputUser != null) {
                    tL_inputPrivacyValueDisallowUsers.users.add(inputUser);
                    this.f7300c.add(Long.valueOf(inputUser.user_id));
                    this.f7301e.add(inputUser);
                }
                i12++;
            }
            ...
            while (i12 < arrayList.size()) {
                ...
                if (inputUser2 != null) {
                    tL_inputPrivacyValueDisallowUsers2.users.add(inputUser2);
                    this.f7300c.add(Long.valueOf(inputUser2.user_id));
                    this.f7301e.add(inputUser2);
                }
                i12++;
            }
            ...
            if (i10 == 5) {
                while (i12 < arrayList.size()) {
                    ...
                    if (inputUser3 != null) {
                        this.f7302f.add(Long.valueOf(inputUser3.user_id));
                    }
                    i12++;
                }
            }
            ...
            if (!arrayList.isEmpty()) {
                while (i12 < arrayList.size()) {
                    ...
                    if (inputUser4 != null) {
                        ...
                        this.f7300c.add(Long.valueOf(inputUser4.user_id));
                        this.f7301e.add(inputUser4);
                    }
                    i12++;
                }
            }
