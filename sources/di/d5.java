    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (i10) {
            case 0:
                ...
                q6Var.A1.f44570a = i0.a.d(floatValue, i12, i11);
                q6Var.T0.invalidate();
                return;
            case 1:
            ...
            case 3:
                ...
                int i13 = ScrollSlidingTextTabStrip.f24141o0;
                float floatValue2 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                scrollSlidingTextTabStrip.W = i12 * floatValue2;
                scrollSlidingTextTabStrip.f24143a0 = i11 * floatValue2;
                scrollSlidingTextTabStrip.f24142a.invalidate();
                scrollSlidingTextTabStrip.invalidate();
                return;
            case 4:
                float animatedFraction = valueAnimator.getAnimatedFraction();
                ux0 ux0Var = (ux0) ((em0) obj).f25762b;
                ux0Var.f31022c.setAlpha(animatedFraction);
                ux0Var.h.setAlpha(animatedFraction);
                if (i12 != 0) {
                    int i14 = (int) ((1.0f - animatedFraction) * i12);
                    ux0Var.y0(i11 + i14);
                    ux0Var.f31022c.setTranslationY(i14);
                    return;
                }
                return;
            default:
                ...
                o0Var.K1.f44570a = i0.a.d(floatValue3, i12, i11);
