...
public abstract class r extends m {
    ...
    public r(Context context, FrameLayout frameLayout, ov0 ov0Var, FrameLayout frameLayout2, bi.b bVar, org.telegram.ui.Components.ja jaVar) {
        ...
        caVar.f24954a = AndroidUtilities.dp(47.0f);
        caVar.f24955b = AndroidUtilities.dp(55.0f);
        caVar.b();
        caVar2.f24954a = AndroidUtilities.dp(47.0f);
        caVar2.f24955b = AndroidUtilities.dp(55.0f);
        caVar2.b();
    ...
    public final void B() {
        if (this.Z0) {
            ...
            alertDialog$Builder.f20226a.R = LocaleController.getString(R.string.StoryRemoveRoundTitle);
            alertDialog$Builder.f20226a.T = LocaleController.getString(R.string.StoryRemoveRoundMessage);
            alertDialog$Builder.k(LocaleController.getString(R.string.Remove), new a1.c(this, 20));
            alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
            TextView textView = (TextView) alertDialog$Builder.o().d(-1);
            if (textView != null) {
                textView.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20926q7, this.f7612a));
            }
        }
    }
    ...
    public final void j(Canvas canvas, RectF rectF) {
        ...
        if (this.D1 != null) {
            ...
            p6Var.f29331w = (int) ((1.0f - e7) * 255.0f);
            p6Var.draw(canvas3);
            float f14 = 1.0f - e10;
            ...
            if (f7 > 0.0f) {
                ...
                this.f8075x1.f25886p = (int) ((rectF.width() - AndroidUtilities.dp(116.0f)) - p6Var.d());
            ...
            if (e10 > f13) {
                ...
                this.A1.f25886p = (int) ((rectF.width() - AndroidUtilities.dp(116.0f)) - p6Var.d());
    ...
    public final void k(Canvas canvas, RectF rectF, float f7) {
        ...
        if (isEnabled) {
            ...
            f12 = 0.0f;
            caVar.f24955b = (AndroidUtilities.dp(15.0f) * 0.6f) + AndroidUtilities.dp(47.0f);
            f10 = e10;
            org.telegram.ui.Components.ca caVar2 = this.f8061i1;
            caVar2.f24954a = AndroidUtilities.dp(50.0f);
            Paint paint3 = caVar2.d;
            f11 = f18;
            caVar2.f24955b = (AndroidUtilities.dp(12.0f) * 0.6f) + AndroidUtilities.dp(50.0f);
            caVar2.e(d, 1.01f);
            caVar.e(d, 1.02f);
            paint3.setColor(org.telegram.ui.ActionBar.j6.l1(0.15f * f7, paint.getColor()));
            canvas.save();
            float f20 = f19 / caVar2.f24954a;
        ...
        canvas.restore();
        float f24 = e6Var.f25593c;
        float f25 = e6Var2.f25593c;
        ...
        if (this.K1) {
            ...
            if (visibility == 4 || imageView2.getVisibility() == 4 || e6Var3.f25593c > 0.0f) {
                ...
                if (imageView.getVisibility() == 4 || e6Var3.f25593c > 0.0f) {
                    canvas.save();
                    canvas.translate((AndroidUtilities.dp(180.0f) * f11) + imageView.getX(), imageView.getY());
                    imageView.draw(canvas);
                    canvas.restore();
                }
                if (imageView2.getVisibility() == 4 || e6Var3.f25593c > 0.0f) {
                    canvas.save();
