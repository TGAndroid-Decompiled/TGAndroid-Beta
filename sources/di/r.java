...
public abstract class r extends m {
    ...
    public final void B() {
        if (this.Z0) {
            ...
            alertDialog$Builder.f20198a.R = LocaleController.getString(R.string.StoryRemoveRoundTitle);
            alertDialog$Builder.f20198a.T = LocaleController.getString(R.string.StoryRemoveRoundMessage);
            alertDialog$Builder.k(LocaleController.getString(R.string.Remove), new a1.c(this, 20));
            alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
            TextView textView = (TextView) alertDialog$Builder.o().d(-1);
            if (textView != null) {
                textView.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20898q7, this.f7584a));
            }
        }
    }
    ...
    public final void j(Canvas canvas, RectF rectF) {
        ...
        if (this.D1 != null) {
            ...
            p6Var.f29303w = (int) ((1.0f - e7) * 255.0f);
            p6Var.draw(canvas3);
            float f14 = 1.0f - e10;
            ...
            if (f7 > 0.0f) {
                ...
                this.f8047x1.f25858p = (int) ((rectF.width() - AndroidUtilities.dp(116.0f)) - p6Var.d());
            ...
            if (e10 > f13) {
                ...
                this.A1.f25858p = (int) ((rectF.width() - AndroidUtilities.dp(116.0f)) - p6Var.d());
    ...
    public final void k(Canvas canvas, RectF rectF, float f7) {
        ...
        if (isEnabled) {
            ...
            f12 = 0.0f;
            caVar.f24927b = (AndroidUtilities.dp(15.0f) * 0.6f) + AndroidUtilities.dp(47.0f);
            f10 = e10;
            org.telegram.ui.Components.ca caVar2 = this.f8033i1;
            caVar2.f24926a = AndroidUtilities.dp(50.0f);
            Paint paint3 = caVar2.d;
            f11 = f18;
            caVar2.f24927b = (AndroidUtilities.dp(12.0f) * 0.6f) + AndroidUtilities.dp(50.0f);
            caVar2.e(d, 1.01f);
            caVar.e(d, 1.02f);
            paint3.setColor(org.telegram.ui.ActionBar.j6.l1(0.15f * f7, paint.getColor()));
            canvas.save();
            float f20 = f19 / caVar2.f24926a;
        ...
        canvas.restore();
        float f24 = e6Var.f25565c;
        float f25 = e6Var2.f25565c;
        ...
        if (this.K1) {
            ...
            if (visibility == 4 || imageView2.getVisibility() == 4 || e6Var3.f25565c > 0.0f) {
                ...
                if (imageView.getVisibility() == 4 || e6Var3.f25565c > 0.0f) {
                    canvas.save();
                    canvas.translate((AndroidUtilities.dp(180.0f) * f11) + imageView.getX(), imageView.getY());
                    imageView.draw(canvas);
                    canvas.restore();
                }
                if (imageView2.getVisibility() == 4 || e6Var3.f25565c > 0.0f) {
                    canvas.save();
