...
public abstract class r extends m {
    ...
    public Drawable Y0;
    public boolean Z0;
    public final q f8025a1;
    public final org.telegram.ui.Components.p6 f8026b1;
    public float f8027c1;
    public float f8028d1;
    public long f8029e1;
    public final Paint f8030f1;
    public final Paint f8031g1;
    public final org.telegram.ui.Components.ca f8032h1;
    public final org.telegram.ui.Components.ca f8033i1;
    public final Drawable f8034j1;
    public float f8035k1;
    public final org.telegram.ui.Components.e6 l1;
    public final Path f8036m1;
    public final Path f8037n1;
    public final Paint f8038o1;
    public final Paint f8039p1;
    public final Paint f8040q1;
    public final Paint f8041r1;
    public final org.telegram.ui.Components.e6 f8042s1;
    public final RectF f8043t1;
    public final RectF f8044u1;
    public final RectF f8045v1;
    public final Path f8046w1;
    public f01 f8047x1;
    public Path f8048y1;
    public Paint f8049z1;
    ...
    public r(Context context, FrameLayout frameLayout, ov0 ov0Var, FrameLayout frameLayout2, bi.b bVar, org.telegram.ui.Components.ja jaVar) {
        ...
        this.X0 = 0;
        fc fcVar = (fc) this;
        this.f8025a1 = new q(fcVar, fcVar);
        ...
        caVar.f24927a = AndroidUtilities.dp(47.0f);
        caVar.f24928b = AndroidUtilities.dp(55.0f);
        caVar.b();
        caVar2.f24927a = AndroidUtilities.dp(47.0f);
        caVar2.f24928b = AndroidUtilities.dp(55.0f);
        caVar2.b();
        this.f8034j1 = getContext().getResources().getDrawable(R.drawable.input_video_pressed).mutate();
        this.l1 = new org.telegram.ui.Components.e6(new n(fcVar, 0), 200L, prVar, 0);
        this.f8036m1 = new Path();
        this.f8037n1 = new Path();
        this.f8038o1 = new Paint(1);
        this.f8039p1 = new Paint(1);
        this.f8040q1 = new Paint(1);
        Paint paint3 = new Paint(1);
        this.f8041r1 = paint3;
        paint3.setStyle(Paint.Style.STROKE);
        n nVar = new n(fcVar, 0);
        pr prVar2 = pr.h;
        this.f8042s1 = new org.telegram.ui.Components.e6(nVar, 350L, prVar2);
        this.f8043t1 = new RectF();
        this.f8044u1 = new RectF();
        this.f8045v1 = new RectF();
        this.f8046w1 = new Path();
    ...
    public final void B() {
        if (this.Z0) {
            AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(getContext(), 0, this.f7584a);
            alertDialog$Builder.f20199a.R = LocaleController.getString(R.string.StoryRemoveRoundTitle);
            alertDialog$Builder.f20199a.T = LocaleController.getString(R.string.StoryRemoveRoundMessage);
            alertDialog$Builder.k(LocaleController.getString(R.string.Remove), new a1.c(this, 20));
            alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
            TextView textView = (TextView) alertDialog$Builder.o().d(-1);
            if (textView != null) {
                textView.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20899q7, this.f7584a));
            }
        }
    }
    ...
    public final void j(Canvas canvas, RectF rectF) {
        ...
        if (this.D1 != null) {
            ...
            if (this.f8029e1 <= 0) {
                this.f8029e1 = System.currentTimeMillis();
            }
            float sin = (((float) Math.sin((((float) (System.currentTimeMillis() - this.f8029e1)) / 900.0f) * 3.141592653589793d)) + 1.0f) / 2.0f;
            ...
            org.telegram.ui.Components.p6 p6Var = this.f8026b1;
            ...
            p6Var.f29304w = (int) ((1.0f - e7) * 255.0f);
            p6Var.draw(canvas3);
            float f14 = 1.0f - e10;
            float f15 = (1.0f - this.f8027c1) * f14;
            ...
            int i15 = -2130706433;
            if (f7 > 0.0f) {
                if (this.f8047x1 == null) {
                    this.f8047x1 = new f01(LocaleController.getString(R.string.SlideToCancel2), 15.0f, null);
                }
                if (this.f8048y1 == null) {
                    Path path = new Path();
                    this.f8048y1 = path;
                    path.moveTo(AndroidUtilities.dp(3.83f), 0.0f);
                    this.f8048y1.lineTo(0.0f, AndroidUtilities.dp(5.0f));
                    this.f8048y1.lineTo(AndroidUtilities.dp(3.83f), AndroidUtilities.dp(f10));
                    Paint paint2 = new Paint(1);
                    this.f8049z1 = paint2;
                    paint2.setStyle(Paint.Style.STROKE);
                    this.f8049z1.setStrokeCap(Paint.Cap.ROUND);
                    this.f8049z1.setStrokeJoin(Paint.Join.ROUND);
                }
                this.f8049z1.setStrokeWidth(AndroidUtilities.dp(1.33f));
                this.f8047x1.f25859p = (int) ((rectF.width() - AndroidUtilities.dp(116.0f)) - p6Var.d());
                float centerX = (rectF.centerX() - ((this.f8047x1.l() + AndroidUtilities.dp(11.33f)) / 2.0f)) - (AndroidUtilities.lerp(this.f8027c1, 1.0f, e10) * (rectF.width() / 6.0f));
                float b11 = com.google.android.gms.internal.vision.e2.b(1.0f, this.f8027c1, AndroidUtilities.dp(6.0f) * sin, centerX);
                if (paint != null) {
                    i10 = -1;
                } else {
                    i10 = -2130706433;
                ...
                this.f8049z1.setColor(l1);
                canvas3.drawPath(this.f8048y1, this.f8049z1);
                canvas3.restore();
                f12 = 15.0f;
                f13 = 0.0f;
                this.f8047x1.c(b11 + AndroidUtilities.dp(11.33f), rectF.centerY(), 1.0f, l1, canvas3);
            } else {
                f12 = 15.0f;
                f13 = 0.0f;
            }
            if (e10 > f13) {
                ...
                this.A1.f25859p = (int) ((rectF.width() - AndroidUtilities.dp(116.0f)) - p6Var.d());
                ...
                this.f8044u1.set(width - AndroidUtilities.dp(f11), rectF.top, this.A1.l() + width + AndroidUtilities.dp(f11), rectF.bottom);
            } else {
                canvas2 = canvas;
            }
            if (paint != null) {
    ...
    public final void k(Canvas canvas, RectF rectF, float f7) {
        ...
        float d = this.l1.d(this.f8035k1, false);
        float z13 = com.google.android.gms.internal.vision.e2.z(1.0f, this.f8027c1, AndroidUtilities.dp(30.0f) * d, AndroidUtilities.dp(41.0f));
        float f18 = 1.0f - e7;
        float f19 = z13 * f18 * f7;
        float lerp = AndroidUtilities.lerp(com.google.android.gms.internal.vision.e2.b(1.0f, e10, getWidth() * 0.35f * this.f8027c1, rectF.right - AndroidUtilities.dp(20.0f)), rectF.left + AndroidUtilities.dp(20.0f), e7);
        float dp = rectF.bottom - AndroidUtilities.dp(20.0f);
        boolean isEnabled = LiteMode.isEnabled(360928);
        Paint paint = this.f8031g1;
        if (isEnabled) {
            org.telegram.ui.Components.ca caVar = this.f8032h1;
            caVar.f24927a = AndroidUtilities.dp(47.0f);
            Paint paint2 = caVar.d;
            f12 = 0.0f;
            caVar.f24928b = (AndroidUtilities.dp(15.0f) * 0.6f) + AndroidUtilities.dp(47.0f);
            f10 = e10;
            org.telegram.ui.Components.ca caVar2 = this.f8033i1;
            caVar2.f24927a = AndroidUtilities.dp(50.0f);
            Paint paint3 = caVar2.d;
            f11 = f18;
            caVar2.f24928b = (AndroidUtilities.dp(12.0f) * 0.6f) + AndroidUtilities.dp(50.0f);
            caVar2.e(d, 1.01f);
            caVar.e(d, 1.02f);
            paint3.setColor(org.telegram.ui.ActionBar.j6.l1(0.15f * f7, paint.getColor()));
            canvas.save();
            float f20 = f19 / caVar2.f24927a;
        ...
        canvas.save();
        Path path = this.f8036m1;
        path.rewind();
        Path.Direction direction = Path.Direction.CW;
        path.addCircle(lerp, dp, min, direction);
        canvas.clipPath(path);
        Drawable drawable = this.f8034j1;
        ...
        if (f10 > f12) {
            ...
            canvas.drawRoundRect(rectF2, AndroidUtilities.dp(5.33f), AndroidUtilities.dp(5.33f), this.f8030f1);
        }
        canvas.restore();
        float f24 = e6Var.f25566c;
        float f25 = e6Var2.f25566c;
        if (this.f8027c1 < 0.4f) {
            z10 = true;
        } else {
            z10 = false;
        }
        float A = org.telegram.messenger.w1.A(1.0f, f24, AndroidUtilities.lerp(this.f8042s1.e(z10), 0.0f, f25), f7);
        ...
        float f26 = 1.0f - f25;
        float lerp3 = AndroidUtilities.lerp(((rectF.bottom - AndroidUtilities.dp(80.0f)) - lerp2) - ((AndroidUtilities.dp(120.0f) * this.f8028d1) * f26), rectF.bottom - AndroidUtilities.dp(20.0f), 1.0f - A);
        float dp3 = (AndroidUtilities.dp(36.0f) * A) / 2.0f;
        RectF rectF3 = this.f8043t1;
        ...
        Paint paint7 = this.f8040q1;
        paint7.setColor(l12);
        int l13 = org.telegram.ui.ActionBar.j6.l1(A * f26, -1);
        Paint paint8 = this.f8041r1;
        paint8.setColor(l13);
        float dp4 = (AndroidUtilities.dp(4.0f) * f26) + lerp3;
        canvas.rotate(this.f8028d1 * 12.0f * f26, dp2, dp4);
        ...
        if (f25 < 1.0f) {
            canvas.save();
            canvas.rotate(this.f8028d1 * 12.0f * f26, dp2, f27);
            canvas.translate(0.0f, lerp6 * f25);
            canvas.scale(f26, f26, dp2, f27);
            Path path2 = this.f8046w1;
            path2.rewind();
            ...
            path2.lineTo(f29, (AndroidUtilities.lerp(AndroidUtilities.lerp(0.4f, 0.0f, this.f8028d1), 1.0f, f25) * AndroidUtilities.dp(3.66f)) + dp6);
        ...
        if (this.K1) {
            ...
            if (visibility == 4 || imageView2.getVisibility() == 4 || e6Var3.f25566c > 0.0f) {
                canvas.saveLayerAlpha(rectF, (int) ((1.0f - this.f7603o0) * 255.0f), 31);
                Path path3 = this.f8037n1;
                path3.rewind();
                path3.addRoundRect(rectF, AndroidUtilities.dp(21.0f), AndroidUtilities.dp(21.0f), direction);
                canvas.clipPath(path3);
                if (imageView.getVisibility() == 4 || e6Var3.f25566c > 0.0f) {
                    canvas.save();
                    canvas.translate((AndroidUtilities.dp(180.0f) * f11) + imageView.getX(), imageView.getY());
                    imageView.draw(canvas);
                    canvas.restore();
                }
                if (imageView2.getVisibility() == 4 || e6Var3.f25566c > 0.0f) {
                    canvas.save();
    ...
    public void setAmplitude(double d) {
        this.f8035k1 = (float) (Math.min(1800.0d, d) / 1800.0d);
        invalidate();
    }
    ...
    public final void z(boolean z10, boolean z11) {
        ...
        this.O1 = false;
        this.K0 = false;
        this.L0 = (int) ((getBounds().right - AndroidUtilities.dp(20.0f)) - ((getWidth() * 0.35f) * this.f8027c1));
        invalidate();
        p pVar = this.D1;
        if (pVar != null) {
            if (!z10) {
                if (z11) {
                    ...
                    CameraController.getInstance().stopVideoRecording(pVar.f8002a.getCameraSessionRecording(), false, false);
                    pVar.a(false);
                } else {
                    pVar.c();
                }
