    ...
    public final void onAnimationEnd(Animator animator) {
        switch (this.f8500a) {
            ...
            case 1:
                ...
                ((Runnable) this.d).run();
                coVar.f35214a1.setTranslationY(0.0f);
                coVar2.f35214a1.setTranslationY(0.0f);
                coVar2.f35214a1.getAvatarImageView().setTranslationY(0.0f);
                coVar.f35214a1.getAvatarImageView().setScaleX(1.0f);
                coVar.f35214a1.getAvatarImageView().setScaleY(1.0f);
                coVar.f35214a1.getAvatarImageView().setAlpha(1.0f);
                coVar2.f35214a1.getAvatarImageView().setScaleX(1.0f);
                coVar2.f35214a1.getAvatarImageView().setScaleY(1.0f);
                coVar2.f35214a1.getAvatarImageView().setAlpha(1.0f);
                dh dhVar = coVar2.M0;
                if (dhVar != null) {
                    dhVar.setAlpha(1.0f);
                    return;
