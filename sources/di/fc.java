...
public final class fc extends r {
    ...
    public final boolean e() {
        ...
        if (MessagesController.getInstance(this.U).premiumFeaturesBlocked() || ((qcVar = org.telegram.ui.Components.qc.f29699w) != null && qcVar.f29700a == 2)) {
            return false;
        }
            ...
            if (!fcVar.f7632p0) {
                ...
                for (int i10 = 0; i10 < pcVar.f7938v1.R0.getChildCount(); i10++) {
                    ...
                    if (childAt instanceof rg.k) {
                        ...
                        float f11 = selectionBounds.f26771a;
                        float f12 = selectionBounds.f26772b;
                        rectF.set(f11, f12, selectionBounds.f26773c + f11, selectionBounds.d + f12);
