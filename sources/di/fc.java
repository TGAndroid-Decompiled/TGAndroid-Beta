...
public final class fc extends r {
    ...
    public final boolean e() {
        ...
        if (MessagesController.getInstance(this.U).premiumFeaturesBlocked() || ((qcVar = org.telegram.ui.Components.qc.f29672w) != null && qcVar.f29673a == 2)) {
            return false;
        }
            ...
            if (!fcVar.f7604p0) {
                ...
                for (int i10 = 0; i10 < pcVar.f7910v1.R0.getChildCount(); i10++) {
                    ...
                    if (childAt instanceof rg.k) {
                        ...
                        float f11 = selectionBounds.f26744a;
                        float f12 = selectionBounds.f26745b;
                        rectF.set(f11, f12, selectionBounds.f26746c + f11, selectionBounds.d + f12);
