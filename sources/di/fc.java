...
public final class fc extends r {
    ...
    public final boolean e() {
        ...
        if (MessagesController.getInstance(this.U).premiumFeaturesBlocked() || ((qcVar = org.telegram.ui.Components.qc.f29698w) != null && qcVar.f29699a == 2)) {
            return false;
        }
        ...
        if (indexOf >= 0) {
            ...
            if (indexOf2 >= 0) {
                ...
                replaceTags.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.gc, this.f7612a)), indexOf, indexOf2, 33);
                replaceTags.setSpan(new ec(this, 0), indexOf, indexOf2, 33);
            }
        }
        org.telegram.ui.Components.qc M = new org.telegram.ui.Components.yc(this.S1.f7906l0, this.f7612a).M(LocaleController.getString(R.string.CaptionPremiumTitle), replaceTags, R.raw.caption_limit);
        M.f29699a = 2;
        M.f29706j = 5000;
        M.k(false);
        return true;
    ...
    public final boolean l(float f7, float f10) {
        ...
        if (rbVar != null && rbVar.R0 != null) {
            ...
            if (!fcVar.f7632p0) {
                ...
                float y3 = pcVar.f7878c1.getY() + f10;
                float x11 = pcVar.f7906l0.getX() + x10;
                float y10 = pcVar.f7906l0.getY() + y3;
                float x12 = x11 - pcVar.f7894h0.getX();
                float y11 = y10 - pcVar.f7894h0.getY();
                for (int i10 = 0; i10 < pcVar.f7938v1.R0.getChildCount(); i10++) {
                    ...
                    if (childAt instanceof rg.k) {
                        ...
                        float f11 = selectionBounds.f26770a;
                        float f12 = selectionBounds.f26771b;
                        rectF.set(f11, f12, selectionBounds.f26772c + f11, selectionBounds.d + f12);
