...
public final class h {
    ...
    public void a() {
        ...
        switch (this.f255a) {
            ...
            default:
                int i13 = this.d;
                if (i13 >= 0 && (i13 < (i11 = this.f257c) || (i13 == i11 && this.e == 0))) {
                    z11 = true;
                } else {
                    z11 = false;
                }
    ...
    public int b() {
        return ((this.e - this.f257c) * 8) - this.d;
    }
    ...
    public boolean e() {
        ...
        int i11 = this.e;
        int i12 = 0;
        while (this.d < this.f257c && !h()) {
            i12++;
        }
        if (this.d == this.f257c) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public boolean h() {
        ...
        switch (this.f255a) {
            case 1:
                if ((((this.f256b[this.d] & 255) >> this.e) & 1) == 1) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                ...
                return z10;
            case 2:
                if ((this.f256b[this.f257c] & (128 >> this.d)) != 0) {
                    z11 = true;
                } else {
                    z11 = false;
                }
                ...
                return z11;
            default:
                if ((this.f256b[this.d] & (128 >> this.e)) != 0) {
                    z12 = true;
                } else {
                    z12 = false;
                }
            ...
            case 2:
                ...
                while (true) {
                    ...
                    if (i16 > 8) {
                        int i17 = i16 - 8;
                        this.d = i17;
                        byte[] bArr2 = this.f256b;
                        int i18 = this.f257c;
                        this.f257c = i18 + 1;
                        i15 |= (bArr2[i18] & 255) << i17;
                    } else {
                        byte[] bArr3 = this.f256b;
                        int i19 = this.f257c;
    ...
    public void l(int i10, byte[] bArr) {
        ...
        e2.d.g(z10);
        System.arraycopy(this.f256b, this.f257c, bArr, 0, i10);
        this.f257c += i10;
        a();
    }
    ...
    public void t(int i10) {
        ...
        switch (this.f255a) {
            case 1:
                ...
                int i15 = this.d;
                if (i15 < 0 || (i15 >= (i11 = this.f257c) && (i15 != i11 || this.e != 0))) {
                    z10 = false;
                }
                e2.d.g(z10);
                return;
