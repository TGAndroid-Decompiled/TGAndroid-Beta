...
public final class f {
    ...
    public int d;
    public int f48824e;
    public final int[] f48825f = new int[255];
    public final v f48826g = new v(255);
    ...
    public final boolean a(p pVar, boolean z10) {
        ...
        if (z11 && vVar.z() == 1332176723) {
            if (vVar.x() != 0) {
                ...
                vVar.G(x10);
                try {
                    z12 = pVar.j(vVar.f8817a, 0, this.f48823c, z10);
                ...
                if (z12) {
                    for (int i10 = 0; i10 < this.f48823c; i10++) {
                        int x11 = vVar.x();
                        this.f48825f[i10] = x11;
                        this.f48824e += x11;
                    }
                    return true;
                }
