...
public final class l implements j {
    public final CredentialManager f44070a;

    public l(Context context) {
        kotlin.jvm.internal.i.e(context, "context");
        this.f44070a = (CredentialManager) context.getSystemService("credential");
    }

    @Override
    public final boolean isAvailableOnDevice() {
        if (Build.VERSION.SDK_INT >= 34 && this.f44070a != null) {
            return true;
        }
        return false;
    }
    ...
    public final void onCreateCredential(Context context, b bVar, CancellationSignal cancellationSignal, Executor executor, i iVar) {
        kotlin.jvm.internal.i.e(context, "context");
        u uVar = (u) iVar;
        CredentialManager credentialManager = this.f44070a;
        ...
        Bundle bundle = bVar.f44063a;
        z0 z0Var = bVar.f44065c;
        Bundle bundle2 = new Bundle();
        bundle2.putCharSequence("androidx.credentials.BUNDLE_KEY_USER_ID", (String) z0Var.f15367b);
        CharSequence charSequence = (CharSequence) z0Var.f15368c;
        ...
        CreateCredentialRequest.Builder alwaysSendAppInfoToProvider = new CreateCredentialRequest.Builder("androidx.credentials.TYPE_PUBLIC_KEY_CREDENTIAL", bundle, bVar.f44064b).setIsSystemProviderRequired(false).setAlwaysSendAppInfoToProvider(true);
    ...
    public final void onGetCredential(Context context, n nVar, CancellationSignal cancellationSignal, Executor executor, i iVar) {
        ...
        bundle.putBoolean("androidx.credentials.BUNDLE_KEY_PREFER_IMMEDIATELY_AVAILABLE_CREDENTIALS", nVar.f44072b);
        bundle.putParcelable("androidx.credentials.BUNDLE_KEY_PREFER_UI_BRANDING_COMPONENT_NAME", null);
        GetCredentialRequest.Builder builder = new GetCredentialRequest.Builder(bundle);
        for (p pVar : nVar.f44071a) {
            pVar.getClass();
            builder.addCredentialOption(new CredentialOption.Builder("androidx.credentials.TYPE_PUBLIC_KEY_CREDENTIAL", pVar.f44074a, pVar.f44075b).setIsSystemProviderRequired(false).setAllowedProviders(pVar.f44076c).build());
        }
