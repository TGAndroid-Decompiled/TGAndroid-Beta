    ...
    public final void onError(Throwable th2) {
        switch (this.f45544a) {
            case 0:
                ...
                ((o2.o) this.f45545b).onError(u8.a(error.getMessage(), type));
                return;
            default:
    ...
    public final void onResult(Object obj) {
        switch (this.f45544a) {
            case 0:
                ...
                ((o2.o) this.f45545b).onResult(c8.a("androidx.credentials.TYPE_PUBLIC_KEY_CREDENTIAL", data));
                return;
            default:
