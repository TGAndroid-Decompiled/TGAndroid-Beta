    ...
    public final void onError(Throwable th2) {
        switch (this.f44112a) {
            case 0:
                ...
                ((u) this.f44113b).onError(d9.a(error.getMessage(), type));
                return;
            default:
    ...
    public final void onResult(Object obj) {
        switch (this.f44112a) {
            case 0:
                ...
                ((u) this.f44113b).onResult(w7.a("androidx.credentials.TYPE_PUBLIC_KEY_CREDENTIAL", data));
                return;
            default:
