    ...
    public final void onError(Throwable th2) {
        switch (this.f48834a) {
            case 0:
                ...
                ((e0) this.f48835b).onError(v8.a(error.getMessage(), type));
                return;
            default:
    ...
    public final void onResult(Object obj) {
        switch (this.f48834a) {
            case 0:
                ...
                ((e0) this.f48835b).onResult(d8.a("androidx.credentials.TYPE_PUBLIC_KEY_CREDENTIAL", data));
                return;
            default:
