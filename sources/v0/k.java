...
public final class k implements OutcomeReceiver {
    public final int f44095a = 0;
    public final i f44096b;
    ...
    public final void onError(Throwable th2) {
        switch (this.f44095a) {
            case 0:
                ...
                ((u) this.f44096b).onError(c9.a(error.getMessage(), type));
                return;
            default:
    ...
    public final void onResult(Object obj) {
        switch (this.f44095a) {
            case 0:
                ...
                ((u) this.f44096b).onResult(v7.a("androidx.credentials.TYPE_PUBLIC_KEY_CREDENTIAL", data));
                return;
            default:
