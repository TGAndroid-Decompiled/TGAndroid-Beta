...
public final class d implements e2, y2.h, le.d, m.k, n5.b, o0.b, v61, d5, la0, r0.n, com.google.android.gms.common.api.internal.s, x1, h1, s0 {
    ...
    public void H(float f7) {
        ...
        qg.s0.e(y0Var.f45552a).k("-1", f7);
        y0Var.f45555e.setBrushSize(f7);
    }
    ...
    public void c(int i10, int i11, c3.p pVar) {
        ...
        u3.e eVar = dVar.f46902b;
        SparseArray sparseArray = dVar.f46904c;
        e2.v vVar = dVar.f46913k;
        e2.v vVar2 = dVar.f46911i;
        int i17 = 1;
        int i18 = 0;
        if (i10 != 161 && i10 != 163) {
            if (i10 != 165) {
                if (i10 != 16877) {
                    if (i10 != 16981) {
                        if (i10 != 18402) {
                            ...
                            vVar.J(0);
                            dVar.f46927z = (int) vVar.z();
                            return;
                        }
                        byte[] bArr4 = new byte[i11];
                        pVar.readFully(bArr4, 0, i11);
                        dVar.d(i10);
                        dVar.f46925x.f46879k = new g0(1, 0, 0, bArr4);
                        return;
                    }
                    dVar.d(i10);
                    byte[] bArr5 = new byte[i11];
                    dVar.f46925x.f46878j = bArr5;
                    pVar.readFully(bArr5, 0, i11);
                    return;
                }
                dVar.d(i10);
                u3.c cVar = dVar.f46925x;
                int i19 = cVar.h;
                ...
                int i20 = dVar.S;
                e2.v vVar3 = dVar.f46918p;
                if (i20 == 4 && "V_VP9".equals(cVar2.f46873c)) {
                    vVar3.G(i11);
        ...
        if (dVar.J == 1) {
            ...
            if (cVar3.f46874e != 2 && (i10 != 163 || (vVar2.f8789a[2] & 128) != 128)) {
                i16 = 0;
            } else {
                i16 = 1;
            }
        ...
        if (i10 == 163) {
            while (true) {
                int i37 = dVar.M;
                if (i37 < dVar.N) {
                    dVar.e(cVar3, ((dVar.M * cVar3.f46875f) / 1000) + dVar.K, dVar.R, dVar.n(pVar, cVar3, dVar.O[i37], false), 0);
                    dVar.M++;
                } else {
                    dVar.J = 0;
                    return;
    ...
    public void h(y2.j jVar, long j3, long j10, int i10) {
        ...
        gVar.f15214q.r(tVar, pVar.f49523c, -1, null, 0, null, -9223372036854775807L, -9223372036854775807L, i10);
    }
    ...
    public void i(y2.j jVar, long j3, long j10) {
        ...
        if (cVar.d) {
            ...
            int i12 = gVar.M;
            gVar.M = i12 + 1;
            if (i12 < gVar.f15210m.L3(pVar.f49523c)) {
        ...
        synchronized (gVar.f15217t) {
            try {
                if (pVar.f49522b.f10330a.equals(gVar.F)) {
    ...
    public void invalidate() {
        switch (this.f15071a) {
            case 9:
                ((t1) ((g1) this.f15072b).f21964b).invalidate();
                return;
            default:
        ...
        if (i10 != 20529) {
            if (i10 != 20530) {
                ...
                switch (i10) {
                    ...
                    case 159:
                        dVar.d(i10);
                        dVar.f46925x.Q = (int) j3;
                        return;
                    case 176:
                        dVar.d(i10);
                        dVar.f46925x.f46882n = (int) j3;
                        return;
                    case 179:
                        dVar.a(i10);
                        dVar.F.c(dVar.l(j3));
                    ...
                    case 186:
                        dVar.d(i10);
                        dVar.f46925x.f46883o = (int) j3;
                        return;
                    case 215:
                        dVar.d(i10);
                        dVar.f46925x.d = (int) j3;
                        return;
                    case 231:
                        dVar.E = dVar.l(j3);
                        return;
                    ...
                    case 21432:
                        ...
                        if (i11 != 0) {
                            if (i11 != 1) {
                                if (i11 != 3) {
                                    if (i11 == 15) {
                                        dVar.f46925x.f46892y = 3;
                                        return;
                                    }
                                    return;
                                }
                                dVar.f46925x.f46892y = 1;
                                return;
                            }
                            dVar.f46925x.f46892y = 2;
                            return;
                        }
                        dVar.f46925x.f46892y = 0;
                        return;
                    case 21680:
                        dVar.d(i10);
                        dVar.f46925x.f46885q = (int) j3;
                        return;
                    case 21682:
                        dVar.d(i10);
                        dVar.f46925x.f46887s = (int) j3;
                        return;
                    case 21690:
                        dVar.d(i10);
                        dVar.f46925x.f46886r = (int) j3;
                        return;
                    case 21930:
                        dVar.d(i10);
                        u3.c cVar2 = dVar.f46925x;
                        if (j3 == 1) {
                            z10 = true;
                        }
                        cVar2.W = z10;
                    ...
                    case 21938:
                        dVar.d(i10);
                        u3.c cVar3 = dVar.f46925x;
                        cVar3.f46893z = true;
                        cVar3.f46884p = (int) j3;
                        return;
                    case 21998:
                        dVar.d(i10);
                        dVar.f46925x.f46876g = (int) j3;
                        return;
                    case 22186:
                        dVar.d(i10);
                        dVar.f46925x.T = j3;
                    ...
                    case 30321:
                        ...
                        if (i12 != 0) {
                            if (i12 != 1) {
                                if (i12 != 2) {
                                    if (i12 == 3) {
                                        dVar.f46925x.f46888t = 3;
                                        return;
                                    }
                                    return;
                                }
                                dVar.f46925x.f46888t = 2;
                                return;
                            }
                            dVar.f46925x.f46888t = 1;
                            return;
                        }
                        dVar.f46925x.f46888t = 0;
                        return;
                    case 2352003:
                        dVar.d(i10);
                        dVar.f46925x.f46875f = (int) j3;
                        return;
                    case 2807729:
                        dVar.f46922t = j3;
                        return;
    ...
    public void u(p4.p pVar, p4.m mVar, Collection collection) {
        ...
        if (pVar == eVar.f43826y && mVar != null) {
            p4.u uVar = eVar.f43825x.f43924a;
            String d = mVar.d();
            p4.v vVar = new p4.v(uVar, d, eVar.b(uVar, d), false);
            vVar.i(mVar);
            if (eVar.d != vVar) {
                eVar.h(eVar, vVar, eVar.f43826y, 3, eVar.f43825x, collection);
                eVar.f43825x = null;
                eVar.f43826y = null;
            }
        } else if (pVar == eVar.f43808e) {
            if (mVar != null) {
                eVar.n(eVar.d, mVar);
            }
            eVar.d.n(collection);
    ...
    public float get() {
        y0 y0Var = (y0) this.f15072b;
        int i10 = y0Var.f45552a;
        qg.m currentBrush = y0Var.f45555e.getCurrentBrush();
