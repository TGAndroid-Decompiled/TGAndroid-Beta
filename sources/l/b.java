...
public final class b extends u1 {
    ...
    public final c0 b() {
        ...
        switch (this.f15095s) {
            case 0:
                c cVar = ((ActionMenuItemView) this.v).f944x;
                if (cVar != null && (dVar = ((m.e) cVar).f15535a.J) != null) {
                    return dVar.a();
                }
                return null;
            default:
    ...
    public final boolean c() {
        ...
        switch (this.f15095s) {
            case 0:
                ...
                if (kVar != null && kVar.a(actionMenuItemView.f940n) && (b10 = b()) != null && b10.a()) {
                    return true;
                }
                return false;
            default:
