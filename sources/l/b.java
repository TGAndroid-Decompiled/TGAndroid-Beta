...
public final class b extends u1 {
    ...
    public final b0 b() {
        ...
        switch (this.f13712s) {
            case 0:
                c cVar = ((ActionMenuItemView) this.v).f1953x;
                if (cVar != null && (dVar = ((m.e) cVar).f14175a.J) != null) {
                    return dVar.a();
                }
                return null;
            default:
    ...
    public final boolean c() {
        ...
        switch (this.f13712s) {
            case 0:
                ...
                if (jVar != null && jVar.a(actionMenuItemView.f1949n) && (b10 = b()) != null && b10.a()) {
                    return true;
                }
                return false;
            default:
