...
public final class b extends u1 {
    ...
    public final c0 b() {
        ...
        switch (this.f13909s) {
            case 0:
                c cVar = ((ActionMenuItemView) this.v).f1952x;
                if (cVar != null && (dVar = ((m.e) cVar).f14401a.J) != null) {
                    return dVar.a();
                }
                return null;
            default:
    ...
    public final boolean c() {
        ...
        switch (this.f13909s) {
            case 0:
                ...
                if (kVar != null && kVar.a(actionMenuItemView.f1948n) && (b10 = b()) != null && b10.a()) {
                    return true;
                }
                return false;
            default:
