...
public final class d5 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final TLRPC.Document f13868r;
    public final c5 f13869s;
    public boolean v;
    ...
    public final void a(String str) {
        int i10;
        boolean z10;
        if (!this.f13870w && !this.f13871x) {
            this.E = str;
            NotificationCenter notificationCenter = NotificationCenter.getInstance(this.f13862a);
            ...
            if (this.f13864c) {
                ...
                i10 = 50331648;
            } else if (this.f13865e) {
                i10 = 67108864;
            } else {
                i10 = 16777216;
            }
            FileLoader fileLoader = FileLoader.getInstance(this.f13862a);
            String str2 = this.E;
            if (!this.f13864c && !this.d && !this.f13865e) {
                z10 = true;
            } else {
                z10 = false;
            }
    ...
    public final void b() {
        if (!this.f13871x && !this.f13870w) {
            this.f13870w = true;
            try {
                if (this.E != null) {
                    FileLoader.getInstance(this.f13862a).cancelFileUpload(this.E, false);
                }
            } catch (Throwable unused) {
            }
            if (this.f13872y != 0) {
                ConnectionsManager.getInstance(this.f13862a).cancelRequest(this.f13872y, true);
                this.f13872y = 0;
            }
            e();
        }
    ...
    public final void c(TLRPC.InputFile inputFile, TLRPC.InputFile inputFile2) {
        ...
        if (this.f13864c) {
            ...
            tL_documentAttributeVideo.duration = this.f13867n;
            tL_documentAttributeVideo.f19876w = this.f13866f;
            ...
            if (!z10 && !z11) {
                ...
                TLRPC.Document document = this.f13868r;
                if (z11) {
        ...
        this.f13872y = ConnectionsManager.getInstance(this.f13862a).sendRequest(tL_messages_uploadMedia, new v7(this, 17));
    }

    public final void d() {
        int i10;
        int i11;
        if (!this.v && !this.f13870w && !this.f13871x) {
            this.v = true;
            if (this.f13864c) {
                c5 c5Var = this.f13869s;
                ...
                try {
                    ...
                    BitmapFactory.decodeFile(this.f13863b, options);
                    int i13 = options.outWidth;
                    if (i13 > 0 && (i10 = options.outHeight) > 0) {
                        this.f13869s.a(i13, i10);
                    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i11 == this.f13862a && !this.f13870w && !this.f13871x) {
            String str = (String) objArr[0];
            if (this.E != null && this.E.equals(str)) {
                if (i10 == NotificationCenter.fileUploaded) {
                    TLRPC.InputFile inputFile2 = (TLRPC.InputFile) objArr[1];
                    if (this.f13865e && !this.H && !TextUtils.isEmpty(this.F)) {
                        this.G = inputFile2;
                        this.H = true;
                        this.E = this.F;
                        FileLoader.getInstance(this.f13862a).uploadFile(this.E, false, true, 16777216);
                    } else if (this.f13865e && this.H) {
                        c(this.G, inputFile2);
                    } else {
                        c(inputFile2, null);
                    }
                } else if (i10 == NotificationCenter.fileUploadFailed) {
                    if (this.f13865e && this.H && (inputFile = this.G) != null) {
                        c(inputFile, null);
                        return;
                    }
                    this.f13871x = true;
                    e();
                    this.f13869s.onError();
