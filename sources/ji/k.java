...
public final class k implements Runnable {
    ...
    public final Object f14031n;
    public final Object f14032r;
    ...
    public final void run() {
        ...
        switch (this.f14026a) {
            case 0:
                final String[] strArr = (String[]) this.f14027b;
                final HorizontalScrollView horizontalScrollView = (HorizontalScrollView) this.f14028c;
                final di.d dVar = (di.d) this.d;
                final boolean[] zArr = (boolean[]) this.f14029e;
                ii.a aVar = (ii.a) this.f14030f;
                final ImageView imageView = (ImageView) this.h;
                final org.telegram.ui.ActionBar.f6 f6Var = (org.telegram.ui.ActionBar.f6) this.f14031n;
                final int[] iArr = (int[]) this.f14032r;
                ...
                aVar.run(str3, new Utilities.Callback2() {
                    ...
                    public final void run(Object obj, Object obj2) {
                        ...
                        if (booleanValue) {
                            imageView2.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20925q7, f6Var2), PorterDuff.Mode.SRC_IN));
                            if (!z10) {
                                int[] iArr2 = iArr;
                                int i11 = -iArr2[0];
                                iArr2[0] = i11;
                ...
                return;
            case 1:
                ((MessagesStorage) this.f14027b).lambda$loadUnreadMessages$76((a0.i) this.f14028c, (ArrayList) this.d, (ArrayList) this.f14029e, (ArrayList) this.f14030f, (ArrayList) this.h, (ArrayList) this.f14031n, (HashMap) this.f14032r);
                return;
            case 2:
                UserInfoActivity.Y((UserInfoActivity) this.f14027b, (TLRPC.TL_error) this.f14028c, (TLObject) this.d, (TL_account.TL_birthday) this.f14029e, (TLRPC.UserFull) this.f14030f, (TLObject) this.h, (int[]) this.f14032r, (ArrayList) this.f14031n);
                return;
            case 3:
                TLRPC.TL_error tL_error = (TLRPC.TL_error) this.f14027b;
                ug.w wVar = (ug.w) this.f14028c;
                TLObject tLObject = (TLObject) this.d;
                List list = (List) this.f14029e;
                c5.h hVar = (c5.h) this.f14030f;
                ug.w wVar2 = (ug.w) this.h;
                org.telegram.ui.ActionBar.n2 n2Var = (org.telegram.ui.ActionBar.n2) this.f14031n;
                TLRPC.TL_inputStorePaymentPremiumGiveaway tL_inputStorePaymentPremiumGiveaway = (TLRPC.TL_inputStorePaymentPremiumGiveaway) this.f14032r;
                if (tL_error != null) {
                    wVar.run(tL_error);
                    return;
                } else if (tLObject != null) {
                    BillingController.getInstance().addResultListener(((c5.o) list.get(0)).f4449c, new di.l5(3, hVar, wVar2));
            ...
            case 4:
                TLRPC.TL_error tL_error2 = (TLRPC.TL_error) this.f14027b;
                Utilities.Callback callback = (Utilities.Callback) this.f14028c;
                TLObject tLObject2 = (TLObject) this.d;
                List list2 = (List) this.f14029e;
                c5.h hVar2 = (c5.h) this.f14030f;
                Utilities.Callback callback2 = (Utilities.Callback) this.h;
                org.telegram.ui.ActionBar.n2 n2Var2 = (org.telegram.ui.ActionBar.n2) this.f14031n;
                TLRPC.TL_inputStorePaymentPremiumGiftCode tL_inputStorePaymentPremiumGiftCode = (TLRPC.TL_inputStorePaymentPremiumGiftCode) this.f14032r;
                if (tL_error2 != null) {
                    callback.run(tL_error2);
                    return;
                } else if (tLObject2 != null) {
                    BillingController.getInstance().addResultListener(((c5.o) list2.get(0)).f4449c, new di.l5(2, hVar2, callback2));
            ...
            case 5:
                TLObject tLObject3 = (TLObject) this.f14027b;
                c5.o oVar = (c5.o) this.f14028c;
                c5.h hVar3 = (c5.h) this.d;
                bi.f0 f0Var = (bi.f0) this.f14029e;
                Activity activity = (Activity) this.f14030f;
                TLRPC.TL_inputStorePaymentStarsGiveaway tL_inputStorePaymentStarsGiveaway = (TLRPC.TL_inputStorePaymentStarsGiveaway) this.h;
                List list3 = (List) this.f14031n;
                TLRPC.TL_error tL_error3 = (TLRPC.TL_error) this.f14032r;
                if (tLObject3 instanceof TLRPC.TL_boolTrue) {
                    BillingController.getInstance().addResultListener(oVar.f4449c, new di.l5(5, hVar3, f0Var));
            ...
            default:
                TLObject tLObject4 = (TLObject) this.f14027b;
                c5.o oVar2 = (c5.o) this.f14028c;
                c5.h hVar4 = (c5.h) this.d;
                d80 d80Var = (d80) this.f14029e;
                Activity activity2 = (Activity) this.f14030f;
                TLRPC.TL_inputStorePaymentStarsGift tL_inputStorePaymentStarsGift = (TLRPC.TL_inputStorePaymentStarsGift) this.h;
                List list4 = (List) this.f14031n;
                TLRPC.TL_error tL_error4 = (TLRPC.TL_error) this.f14032r;
                if (tLObject4 instanceof TLRPC.TL_boolTrue) {
                    BillingController.getInstance().addResultListener(oVar2.f4449c, new di.l5(4, hVar4, d80Var));
    ...
    public k(UserInfoActivity userInfoActivity, TLRPC.TL_error tL_error, TLObject tLObject, TL_account.TL_birthday tL_birthday, TLRPC.UserFull userFull, TLObject tLObject2, int[] iArr, ArrayList arrayList) {
        this.f14026a = 2;
        this.f14027b = userInfoActivity;
        this.f14028c = tL_error;
        this.d = tLObject;
        this.f14029e = tL_birthday;
        this.f14030f = userFull;
        this.h = tLObject2;
        this.f14032r = iArr;
        this.f14031n = arrayList;
    }
}
