...
public final class x extends bb {
                ...
                switch (r2) {
                    ...
                    default:
                        ...
                        if (!xVar.f14344g0) {
                            ...
                            String trim = i3Var.f22102b.getText().toString().trim();
                ...
                switch (r2) {
                    ...
                    default:
                        ...
                        if (!xVar.f14344g0) {
                            ...
                            String trim = i3Var2.f22102b.getText().toString().trim();
                            if (!TextUtils.isEmpty(trim)) {
                                xVar.f14344g0 = true;
                                xVar.f14343f0.setLoading(true);
                                TLRPC.TL_messages_composeRichMessageWithAI tL_messages_composeRichMessageWithAI = new TLRPC.TL_messages_composeRichMessageWithAI();
                                ...
                                tL_messages_composeRichMessageWithAI.tone = inputaicomposetonesingleuse;
                                xVar.f14345h0 = ConnectionsManager.getInstance(xVar.X).sendRequest(tL_messages_composeRichMessageWithAI, new v7(xVar, 16));
                                AndroidUtilities.hideKeyboard(i3Var2.f22102b);
                                return;
                            }
                            return;
                        }
    ...
    public final void P() {
        ...
        if (richMessage != null) {
            ...
            dVar.setEnabled(!TextUtils.isEmpty(this.f14342e0.f22102b.getText().toString().trim()));
        }
    }
    ...
    public final void dismiss() {
        ...
        AndroidUtilities.hideKeyboard(this.f14342e0.f22102b);
        super.dismiss();
    }
