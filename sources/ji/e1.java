...
public final class e1 implements TextWatcher {
    ...
    public final void afterTextChanged(Editable editable) {
        Editable editable2;
        h1 h1Var = this.f13875a;
        if (!h1Var.h && h1Var.f13947c != null) {
            ...
            if (!h1Var.f13953w && !h1Var.f13950n && !h1Var.f13951r) {
                h1Var.h = true;
                boolean z10 = false;
                ...
                h1Var.h = false;
                if (z10) {
                    h1Var.f13947c.C(h1Var);
                    return;
                } else {
                    h1Var.f13947c.N(editable2);
                    return;
                }
            }
            h1Var.f13947c.N(editable2);
    ...
    public final void beforeTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
        g1 g1Var;
        h1 h1Var = this.f13875a;
        if (!h1Var.h && (g1Var = h1Var.f13947c) != null) {
            g1Var.i(i11, i12);
        }
    }
