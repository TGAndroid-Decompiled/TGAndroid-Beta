...
public final class q1 implements bl, dj {
    public final c2 f14122a;
    public final vi f14123b;
    ...
    public void b(TLRPC.MessageMedia messageMedia, int i10, boolean z10, int i11, long j3) {
        c2 c2Var = this.f14122a;
        c2Var.getClass();
        vi viVar = this.f14123b;
        if (messageMedia != null && messageMedia.geo != null) {
            TL_iv.pageBlockMap pageblockmap = new TL_iv.pageBlockMap();
            pageblockmap.geo = messageMedia.geo;
            pageblockmap.zoom = 15;
            pageblockmap.f20092w = 600;
            pageblockmap.h = 400;
    ...
    public void i(ArrayList arrayList, CharSequence charSequence, boolean z10, int i10, int i11, long j3, boolean z11, long j10) {
        if (!arrayList.isEmpty()) {
            this.f14122a.P.a2((MessageObject) arrayList.get(0));
        }
        this.f14123b.dismiss(true);
    }
}
