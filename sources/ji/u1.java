...
public final class u1 extends ov0 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int l1 = org.telegram.ui.ActionBar.j6.l1(c2Var.I, c2Var.getThemedColor(org.telegram.ui.ActionBar.j6.f20691d6));
        ...
        if (c2Var.E && c2Var.f13863x != null) {
            ...
            if (c2Var.v != null) {
                ...
                canvas.restore();
                canvas.save();
                canvas.translate(AndroidUtilities.lerp(rectF.right, (c2Var.f13866y0.getX() + (c2Var.f13833a0.getX() + (c2Var.Z.getX() + c2Var.Y.getX()))) + c2Var.f13866y0.getWidth(), c2Var.I) - c2Var.v.f23833z1.getWidth(), AndroidUtilities.lerp(rectF.bottom, (c2Var.f13866y0.getY() + (c2Var.f13833a0.getY() + (c2Var.Z.getY() + c2Var.Y.getY()))) + c2Var.f13866y0.getHeight(), c2Var.I) - c2Var.v.f23833z1.getHeight());
                canvas.saveLayerAlpha(-AndroidUtilities.dp(6.0f), -AndroidUtilities.dp(6.0f), c2Var.v.f23833z1.getWidth(), c2Var.v.f23833z1.getHeight(), (int) ((1.0f - c2Var.I) * 255.0f), 31);
                c2Var.v.f23833z1.draw(canvas);
                canvas.restore();
                canvas.restore();
            }
            canvas.save();
