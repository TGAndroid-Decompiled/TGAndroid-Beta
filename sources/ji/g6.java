...
public final class g6 extends FrameLayout implements org.telegram.ui.ActionBar.z5, p9 {
    ...
    public final org.telegram.ui.ActionBar.f6 f13955a;
    public final LinearLayout f13956b;
    public final View f13957c;
    public final ci.n d;
    public final eb f13958e;
    public final h1 f13959f;
    public final h1 h;
    public boolean f13960n;
    public final ArrayList f13961r;
    public LinearLayout f13962s;
    public TextView v;
    public ImageView f13963w;
    public a f13964x;
    public d6 f13965y;

    public g6(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f13961r = new ArrayList();
        this.M = new RectF();
        this.Q = -1;
        this.R = -1;
        this.U = new Paint(1);
        ...
        h1Var.setDelegate(new xt(this) {
            ...
            public final void j() {
                switch (r2) {
                    case 0:
                        g6 g6Var = this.f14384b;
                        if (!g6Var.S && g6Var.f13964x != null) {
                            g6Var.J();
                            g6.e(g6Var.f13964x.f13758b, g6Var.f13959f.getText());
                            d6 d6Var = g6Var.f13965y;
                            if (d6Var != null) {
                                v3.N1(((d3) d6Var).f13887a);
                                return;
                            }
                            return;
                        }
                        return;
                    default:
                        g6 g6Var2 = this.f14384b;
                        if (g6Var2.f13964x != null) {
                            g6Var2.w();
                            d6 d6Var2 = g6Var2.f13965y;
                            if (d6Var2 != null) {
                                v3.N1(((d3) d6Var2).f13887a);
                                return;
                            }
                            return;
                        }
    ...
    public static void a(g6 g6Var, boolean z10) {
        d6 d6Var;
        g6Var.f13959f.setHint(g6Var.getHint());
        if (!z10 && (d6Var = g6Var.f13965y) != null) {
            ((d3) d6Var).f13887a.f14275h3.x(g6Var, null);
        }
    }
    ...
    public static f6 r(String str, a aVar) {
        ...
        if (str != null && aVar != null) {
            ...
            if (lowerCase.length() == 3 && lowerCase.charAt(0) == '/' && lowerCase.charAt(1) == 'h' && (charAt = lowerCase.charAt(2)) >= '1' && charAt <= '6') {
                return new f6(v(charAt - '0'), aVar.f13759c, aVar.d);
            }
        ...
        if (aVar != null && str != null && (length = str.length()) >= 2) {
            ...
            if (str.charAt(i10) == ' ') {
                ...
                if (str.charAt(0) == '#' && (z11 || z10)) {
                    ...
                    if (i11 >= 1 && i11 <= 6) {
                        return new f6(v(i11), aVar.f13759c, aVar.d);
                    }
                    return null;
                } else if (z11) {
                    if (aVar.f13759c == 0 && length == 2) {
                    ...
                    if (aVar.f13759c == 0 && length == 3 && str.charAt(0) == '[' && str.charAt(1) == ']') {
                        return t(false);
                    }
                    if (aVar.f13759c == 0 && length == 4 && str.charAt(0) == '[' && str.charAt(2) == ']') {
                    ...
                    if (aVar.f13759c == 0 && length == 3 && Character.isDigit(str.charAt(0)) && ((charAt = str.charAt(1)) == '.' || charAt == ')')) {
                        TL_iv.pageBlockParagraph pageblockparagraph2 = new TL_iv.pageBlockParagraph();
                        f(pageblockparagraph2, "");
                        return new f6(pageblockparagraph2, 1, 1);
                    } else if (aVar.f13759c == 0 && length == 4) {
    ...
    public final void C() {
        ...
        this.I++;
        Editable text = this.f13959f.getText();
        if (text != null) {
    ...
    public final void D(n0 n0Var) {
        if (this.f13965y != null && this.f13964x != null && n0Var != null) {
            List<String> list = n0Var.f14097c;
            if (!list.isEmpty()) {
                for (String str : list) {
                    int q6 = q(str);
                    if (q6 != 0) {
                        ((d3) this.f13965y).c(this.f13964x, q6);
                        return;
                    }
                    f6 r10 = r(str, this.f13964x);
                    if (r10 == null) {
                        r10 = s(p6.t(str, " "), this.f13964x);
                        continue;
                    }
                    if (r10 != null) {
                        ((d3) this.f13965y).d(this.f13964x, r10.f13928a, r10.f13929b, r10.f13930c, r10.d, r10.f13931e);
                        return;
                    }
                }
            }
    ...
    public final void E(Editable editable) {
        ...
        a aVar = this.f13964x;
        if (aVar != null && v3.B3(aVar.f13758b) && com.google.android.gms.internal.vision.e2.u(editable)) {
            h1 h1Var = this.f13959f;
    ...
    public final void F() {
        d6 d6Var;
        a aVar = this.f13964x;
        if (aVar != null && aVar.f13759c > 0 && (d6Var = this.f13965y) != null) {
            int b10 = ((d3) d6Var).b(aVar);
            int a2 = ((d3) this.f13965y).a(this.f13964x);
            a aVar2 = this.f13964x;
            if (aVar2.f13768n) {
                int i10 = aVar2.f13766l;
                if (i10 <= 0) {
                    b10 = 0;
                } else {
            ...
            a aVar3 = this.f13964x;
            if (aVar3.f13769o) {
                int i11 = aVar3.f13767m;
                if (i11 <= 0) {
                    a2 = 0;
                } else {
    ...
    public final void G() {
        ...
        h1 h1Var = this.f13959f;
        h1 h1Var2 = this.h;
        if (aVar != null && p(aVar.f13758b) && (h1Var.length() > 0 || h1Var2.length() > 0)) {
    ...
    public final void H() {
        ...
        if (h1Var.getText() != null) {
            ...
            int i11 = -1;
            if (!o() || !((TL_iv.pageBlockBlockquote) this.f13964x.f13758b).collapsed || (layout = h1Var.getLayout()) == null || layout.getLineCount() <= 3 || (lineStart = layout.getLineStart(3)) >= (i10 = text.length())) {
                i10 = -1;
            } else {
                i11 = lineStart;
            }
    ...
    public final void I(TL_iv.PageBlock pageBlock, boolean z10) {
        float f7;
        if (!(pageBlock instanceof TL_iv.pageBlockPreformatted)) {
            LinearLayout linearLayout = this.f13962s;
        ...
        LinearLayout linearLayout2 = this.f13962s;
        if (linearLayout2 != null && z10) {
            AndroidUtilities.removeFromParent(linearLayout2);
            this.f13962s = null;
        }
        LinearLayout linearLayout3 = this.f13962s;
        org.telegram.ui.ActionBar.f6 f6Var = this.f13955a;
        if (linearLayout3 == null) {
            LinearLayout linearLayout4 = new LinearLayout(getContext());
            this.f13962s = linearLayout4;
            linearLayout4.setOrientation(0);
            this.f13962s.setBackground(org.telegram.ui.ActionBar.j6.Y(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20780i6, f6Var), AndroidUtilities.dp(3.0f), AndroidUtilities.dp(3.0f)));
            this.f13962s.setPadding(AndroidUtilities.dp(6.0f), AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f));
            addView(this.f13962s, w7.x5.d(-2, -2.0f, 53, 0.0f, -15.0f, -5.0f, 0.0f));
            TextView textView = new TextView(getContext());
            this.v = textView;
            textView.setTextSize(1, 12.0f);
            this.v.setGravity(17);
            this.f13962s.addView(this.v, w7.x5.t(-2, -2, 16, 0, 0, 0, 0));
            ImageView imageView = new ImageView(getContext());
            this.f13963w = imageView;
            imageView.setImageResource(R.drawable.arrows_select);
            this.f13962s.addView(this.f13963w, w7.x5.r(16, 16, 16, 0.0f, 0.66f, 0.0f, 0.0f));
            CodeHighlighting.prepare();
            this.f13962s.setOnClickListener(new x5(this, 1));
            this.f13962s.setOnLongClickListener(new Object());
        }
        ...
        this.f13963w.setColorFilter(new PorterDuffColorFilter(l1, PorterDuff.Mode.SRC_IN));
    ...
    public final void c(a aVar) {
        ...
        if (aVar.f13760e) {
            ...
            ((CheckBoxBase) ebVar.f7209b).f(-1, aVar.f13761f, false);
            return;
        }
        ebVar.setVisibility(8);
        ...
        if (aVar.d == 0) {
            ...
            d6 d6Var = this.f13965y;
            if (d6Var != null) {
                TextPaint paint = nVar.getPaint();
                ArrayList arrayList = ((d3) d6Var).f13887a.f14282l3;
                int indexOf = arrayList.indexOf(aVar);
                if (indexOf >= 0 && (i11 = aVar.f13759c) > 0 && aVar.d > 0) {
                    int i14 = indexOf;
                    while (i14 > 0) {
                        a aVar3 = (a) arrayList.get(i14 - 1);
                        int i15 = aVar3.f13759c;
                    ...
                    int i16 = indexOf + 1;
                    while (i16 < arrayList.size() && (i12 = (aVar2 = (a) arrayList.get(i16)).f13759c) >= i11 && (i12 != i11 || aVar2.d > 0)) {
                        i16++;
                    }
                    ...
                    while (i14 < i16) {
                        ...
                        if (aVar4.f13759c == i11 && aVar4.d > 0) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int dp2;
        a aVar = this.f13964x;
        LinearLayout linearLayout = this.f13956b;
        Paint paint = this.U;
        org.telegram.ui.ActionBar.f6 f6Var = this.f13955a;
        h1 h1Var2 = this.f13959f;
        if (aVar != null && (aVar.f13758b instanceof TL_iv.pageBlockPreformatted)) {
            paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.xk, f6Var));
            int c10 = c9.c(this.f13964x);
            int d = c9.d(this.f13964x);
            int width = getWidth();
            if (c10 <= 0 && d <= 0) {
                i10 = 0;
            } else {
            ...
            h1Var = h1Var2;
            if (aVar != null && (aVar.f13758b instanceof TL_iv.pageBlockBlockquote)) {
                if (this.J == null) {
                    sl0 sl0Var = new sl0(this);
                    this.J = sl0Var;
                    sl0Var.a(null, null, null, this.f13955a, 1);
                    c9.a(this.J, f6Var);
                }
                ...
                canvas2 = canvas;
                if (aVar != null && (aVar.f13758b instanceof TL_iv.pageBlockPullquote)) {
                    if (this.J == null) {
                        sl0 sl0Var2 = new sl0(this);
                        this.J = sl0Var2;
                        sl0Var2.a(null, null, null, this.f13955a, 1);
                        c9.a(this.J, f6Var);
                    }
                    if (this.K == null) {
        ...
        d6 d6Var = this.f13965y;
        if (d6Var != null) {
            q9Var = ((d3) d6Var).f13887a.getTextSelectionHelper();
        } else {
            q9Var = null;
        }
        if (q9Var != null) {
            ArrayList arrayList = this.f13961r;
            arrayList.clear();
        ...
        this.L.a(canvas2, this.M, org.telegram.messenger.w1.B(16.0f, getWidth(), dp), B, v02, ((TL_iv.pageBlockBlockquote) this.f13964x.f13758b).collapsed, l());
    }
        ...
        if (l() && this.L != null) {
            ...
            if (actionMasked != 0) {
                if (actionMasked != 1) {
                    ...
                    this.L.b(false);
                    if (contains && o()) {
                        TL_iv.pageBlockBlockquote pageblockblockquote = (TL_iv.pageBlockBlockquote) this.f13964x.f13758b;
    ...
    public final int h(int i10, int i11) {
        ...
        if (l()) {
            ...
            if (h1Var.getVisibility() == 0 && (layout = h1Var.getLayout()) != null && layout.getLineCount() > 0) {
                ...
                int measuredHeight = this.f13956b.getMeasuredHeight() + getPaddingTop();
                ...
                this.L.getClass();
                float B = org.telegram.messenger.w1.B(16.0f, i10, dp2) - org.telegram.messenger.w1.D(3.333f, 2, AndroidUtilities.dp(23.66f) + ki0Var.f27859c);
                this.L.getClass();
                int i12 = i11 - dp2;
    ...
    public final boolean l() {
        Layout layout;
        if (!o() || (layout = this.f13959f.getLayout()) == null || layout.getLineCount() <= 3) {
            return false;
        }
        return true;
    }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (!super.verifyDrawable(drawable)) {
            ki0 ki0Var = this.L;
            if (ki0Var != null) {
                if (drawable != ki0Var.f27858b && drawable != ki0Var.f27860e) {
                    return false;
                }
                return true;
            }
    ...
    public final void w() {
        a aVar = this.f13964x;
        if (aVar != null && p(aVar.f13758b)) {
            TL_iv.PageBlock pageBlock = this.f13964x.f13758b;
    ...
    public final void x() {
        a aVar = this.f13964x;
        if (aVar != null) {
            e(aVar.f13758b, this.f13959f.getText());
        }
    }
}
