...
public final class g6 extends FrameLayout implements org.telegram.ui.ActionBar.z5, p9 {
    ...
    public final void I(TL_iv.PageBlock pageBlock, boolean z10) {
        ...
        if (linearLayout3 == null) {
            ...
            this.f13962s.setBackground(org.telegram.ui.ActionBar.j6.Y(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20781i6, f6Var), AndroidUtilities.dp(3.0f), AndroidUtilities.dp(3.0f)));
    ...
    public final int h(int i10, int i11) {
        ...
        if (l()) {
            ...
            if (h1Var.getVisibility() == 0 && (layout = h1Var.getLayout()) != null && layout.getLineCount() > 0) {
                ...
                this.L.getClass();
                float B = org.telegram.messenger.w1.B(16.0f, i10, dp2) - org.telegram.messenger.w1.D(3.333f, 2, AndroidUtilities.dp(23.66f) + ki0Var.f27860c);
                this.L.getClass();
                int i12 = i11 - dp2;
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (!super.verifyDrawable(drawable)) {
            ki0 ki0Var = this.L;
            if (ki0Var != null) {
                if (drawable != ki0Var.f27859b && drawable != ki0Var.f27861e) {
                    return false;
                }
                return true;
            }
