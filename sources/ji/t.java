...
public final class t extends ReplacementSpan {
    ...
    public final Bitmap f14199b;
    public final int f14200c;
    public final int d;
    public final int f14201e;
    public final Paint f14202f;
    ...
    public static t a(String str, int i10, float f7) {
        ...
        if (str != null && !str.isEmpty() && (a2 = s.a(str, f7, true)) != null) {
            return new t(str, a2.f14180a, a2.f14181b, a2.f14182c, i10, a2.d);
        }
        return null;
    }
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        Bitmap bitmap = this.f14199b;
        if (bitmap == null) {
            return;
        }
        int color = paint.getColor();
        Paint paint2 = this.f14202f;
        paint2.setColor(color);
        canvas.drawBitmap(bitmap, f7, i13 - (this.d - this.f14201e), paint2);
    }
