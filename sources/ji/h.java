    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (this.f13070a) {
            case 0:
                ...
                zn znVar = nVar.F;
                h0 h0Var = (h0) this.d;
                float measuredHeight = ((((nVar.G.getMeasuredHeight() - znVar.f40433s9) - znVar.Aa) / 2.0f) - (h0Var.getMeasuredHeight() / 2.0f)) + nVar.F.f40433s9;
            ...
            default:
                ...
                zn znVar2 = nVar2.F;
                bb bbVar = (bb) this.d;
                float measuredHeight2 = ((((nVar2.G.getMeasuredHeight() - znVar2.f40433s9) - znVar2.Aa) / 2.0f) - (bbVar.getMeasuredHeight() / 2.0f)) + nVar2.F.f40433s9;
                if (bbVar.getTop() > measuredHeight2) {
                    f10 = measuredHeight2 - bbVar.getTop();
                } else {
                    f10 = 0.0f;
                }
                bbVar.setTranslationY((f10 * floatValue2) + ((1.0f - floatValue2) * this.f13071b));
                return;
        }
    }
}
