    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (this.f13059a) {
            case 0:
                ...
                wn wnVar = nVar.F;
                h0 h0Var = (h0) this.d;
                float measuredHeight = ((((nVar.G.getMeasuredHeight() - wnVar.f39640s9) - wnVar.Aa) / 2.0f) - (h0Var.getMeasuredHeight() / 2.0f)) + nVar.F.f39640s9;
            ...
            default:
                ...
                wn wnVar2 = nVar2.F;
                bb bbVar = (bb) this.d;
                float measuredHeight2 = ((((nVar2.G.getMeasuredHeight() - wnVar2.f39640s9) - wnVar2.Aa) / 2.0f) - (bbVar.getMeasuredHeight() / 2.0f)) + nVar2.F.f39640s9;
