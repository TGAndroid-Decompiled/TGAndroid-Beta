...
public final class m5 implements g1 {
    public final v5 f14065a;
    public final s5 f14066b;
    ...
    public final void N(Editable editable) {
        TL_iv.pageTableCell pagetablecell = this.f14065a.f14278b;
        if (pagetablecell != null) {
            k6.d(pagetablecell, editable);
        }
        s5 s5Var = this.f14066b;
    ...
    public final boolean R(boolean z10) {
        return this.f14066b.s(this.f14065a, z10);
    }

    @Override
    public final void a(h1 h1Var) {
        b3 b3Var = this.f14066b.E;
        if (b3Var != null) {
    ...
    public final void o(final h1 h1Var, final int i10, final int i11) {
        ...
        if (!s5Var.G && i10 != i11 && (b3Var = s5Var.E) != null && (textSelectionHelper = b3Var.f13790a.getTextSelectionHelper()) != null) {
            if ((!textSelectionHelper.y() || textSelectionHelper.W != s5Var) && (k10 = s5Var.k(this.f14065a.f14278b)) >= 0) {
                s5Var.post(new Runnable() {
                    @Override
                    public final void run() {
                        s5 s5Var2 = m5.this.f14066b;
                        h1 h1Var2 = h1Var;
