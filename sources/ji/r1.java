...
public final class r1 implements ti {
    public final vi f14141a;
    public final c2 f14142b;
    ...
    public final void B(hh hhVar) {
        NotificationCenter.getInstance(this.f14142b.getCurrentAccount()).doOnIdle(hhVar);
    }
