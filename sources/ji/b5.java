    ...
    public final void run() {
        ...
        switch (i10) {
            ...
            case 26:
                ...
                if (kVar.f21111q1 != z12) {
                    ValueAnimator valueAnimator = kVar.f21117s1;
                    if (valueAnimator != null) {
                        valueAnimator.cancel();
                    }
                    float f12 = kVar.f21114r1;
                    kVar.f21111q1 = z12;
                    if (!canScrollVertically) {
                        f7 = 1.0f;
                    }
                    ValueAnimator ofFloat = ValueAnimator.ofFloat(f12, f7);
                    kVar.f21117s1 = ofFloat;
                    ofFloat.addUpdateListener(new org.telegram.ui.ActionBar.a(kVar, 4));
                    kVar.f21117s1.addListener(new org.telegram.ui.ActionBar.c(kVar, z12, 1));
                    kVar.f21117s1.setDuration(320L);
                    kVar.f21117s1.setInterpolator(pr.h);
                    kVar.f21117s1.start();
                    return;
                }
                return;
            case 27:
                ...
                if (kVar2.f21111q1 != z13) {
                    ValueAnimator valueAnimator2 = kVar2.f21117s1;
                    if (valueAnimator2 != null) {
                        valueAnimator2.cancel();
                    }
                    float f13 = kVar2.f21114r1;
                    kVar2.f21111q1 = z13;
                    if (!canScrollVertically2) {
                        f7 = 1.0f;
                    }
                    ValueAnimator ofFloat2 = ValueAnimator.ofFloat(f13, f7);
                    kVar2.f21117s1 = ofFloat2;
                    ofFloat2.addUpdateListener(new org.telegram.ui.ActionBar.a(kVar2, 3));
                    kVar2.f21117s1.addListener(new org.telegram.ui.ActionBar.c(kVar2, z13, 0));
                    kVar2.f21117s1.setDuration(320L);
                    kVar2.f21117s1.setInterpolator(pr.h);
                    kVar2.f21117s1.start();
                    return;
                }
                return;
            case 28:
