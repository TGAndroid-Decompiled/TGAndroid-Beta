...
public abstract class i6 {
    ...
    public static int d(java.lang.CharSequence r14) {
        throw new UnsupportedOperationException("Method not decompiled: ji.i6.d(java.lang.CharSequence):int");
    }
    ...
    public static int e(Spanned spanned, int i10, int i11) {
        ...
        for (o01 o01Var : o01VarArr) {
            int i13 = o01Var.f28940b.f28619a;
            if ((i13 & 512) != 0) {
                i13 |= 256;
            }
            i12 |= i13;
    ...
    public static org.telegram.tgnet.tl.TL_iv.RichText f(java.lang.CharSequence r14) {
        throw new UnsupportedOperationException("Method not decompiled: ji.i6.f(java.lang.CharSequence):org.telegram.tgnet.tl.TL_iv$RichText");
    }
    ...
    public static void o(Spannable spannable, int i10, int i11, int i12, boolean z10, TL_iv.PageBlock pageBlock) {
        ...
        if (max < max2) {
            for (o01 o01Var : (o01[]) spannable.getSpans(max, max2, o01.class)) {
                ...
                int i14 = o01Var.f28940b.f28619a;
