...
public final class y1 extends ImageView implements org.telegram.ui.ActionBar.z5 {
    ...
    public y1(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f14340e = 20;
        this.f14341f = org.telegram.ui.ActionBar.j6.f20664d6;
        this.f14342n = true;
        this.f14344s = true;
        this.f14338b = i10;
        this.f14337a = i10;
    ...
    public final void d() {
        ...
        setBackground(org.telegram.ui.ActionBar.j6.Z(org.telegram.ui.ActionBar.j6.v0(this.f14341f, f6Var), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20754i6, f6Var), AndroidUtilities.dp(this.f14340e), AndroidUtilities.dp(this.f14340e)));
