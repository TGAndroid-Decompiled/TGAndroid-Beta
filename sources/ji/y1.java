...
public final class y1 extends ImageView implements org.telegram.ui.ActionBar.z5 {
    ...
    public y1(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f14366e = 20;
        this.f14367f = org.telegram.ui.ActionBar.j6.f20691d6;
        this.f14368n = true;
        this.f14370s = true;
        this.f14364b = i10;
        this.f14363a = i10;
    ...
    public final void d() {
        ...
        setBackground(org.telegram.ui.ActionBar.j6.Z(org.telegram.ui.ActionBar.j6.v0(this.f14367f, f6Var), org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20781i6, f6Var), AndroidUtilities.dp(this.f14366e), AndroidUtilities.dp(this.f14366e)));
