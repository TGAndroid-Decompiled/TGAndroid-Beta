...
public final class i3 extends q9 {
    ...
    public final boolean k() {
        ...
        if (!arrayList.isEmpty() && i3Var.y() && i3Var.f22501u0 == 0 && i3Var.f22502v0 == 0 && i3Var.f22503w0 <= 0 && i3Var.f22504x0 == (size = arrayList.size() - 1)) {
            ...
            int i10 = !str.isEmpty();
            if (i3Var.f22505y0 == i10) {
                if (i10 == 1) {
                    length = str.length();
                } else {
                    length = g6.z(aVar.f13732b).length();
                }
                if (i3Var.f22506z0 >= length) {
                    z10 = true;
                    return !z10;
                }
            }
