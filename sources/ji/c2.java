...
public final class c2 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static boolean W(c2 c2Var, View view) {
        ...
        if (coVar != null && c2Var.f13828r == null && !coVar.c() && c2Var.P.j3() && !c2Var.P.l3()) {
            ...
            if (!Y2.isEmpty()) {
                ...
                long a2 = c2Var.J.a();
                MessageObject messageObject = c2Var.J.f35353n5;
    ...
    public static void Y(final c2 c2Var, Context context, View view) {
        ...
        J.y().f20402a.setTypeface(AndroidUtilities.getTypeface("fonts/mw_bold.ttf"));
        J.y().f20402a.setTextSize(1, SharedConfig.fontSize + 2);
        ...
        J.y().f20402a.setTypeface(AndroidUtilities.getTypeface("fonts/mw_bold.ttf"));
        J.y().f20402a.setTextSize(1, SharedConfig.fontSize + 1);
        ...
        J.y().f20402a.setTypeface(AndroidUtilities.getTypeface("fonts/mw_bold.ttf"));
        J.y().f20402a.setTextSize(1, SharedConfig.fontSize);
        ...
        J.y().f20402a.setTypeface(AndroidUtilities.getTypeface("fonts/mw_bold.ttf"));
        J.y().f20402a.setTextSize(1, SharedConfig.fontSize - 3);
        ...
        I.y().f20402a.setTypeface(AndroidUtilities.bold());
    ...
    public final View createView(Context context) {
        ...
        int i15 = org.telegram.ui.ActionBar.j6.f20754i6;
        ...
        this.f13809b0.j(zg.f33153e, false);
    ...
    public final void o0(int i10, int i11) {
        ...
        viVar.f31292j0.setIncludeVideosInGallery(true);
        viVar.f31292j0.f0();
        viVar.J1(1, true);
        viVar.h1(i10);
        viVar.f31325t2 = new q1(this, viVar);
    ...
    public final AnimatorSet onCustomTransitionAnimation(boolean z10, Runnable runnable) {
        ...
        if (!AndroidUtilities.isTablet() && this.f13830s != null && this.v != null) {
            ...
            this.v.f23806z1.setVisibility(4);
            v0();
            float f10 = 1.0f;
            if (z10) {
                f7 = 0.0f;
    ...
    public final r0.l1 onInsetsInternal(View view, r0.l1 l1Var) {
        boolean z10;
        n70 n70Var;
        i0.c f7 = l1Var.f44712a.f(3);
        int i10 = l1Var.f44712a.f(8).d;
        this.U0 = i10;
        int i11 = i10 - f7.d;
        boolean z11 = this.G0;
    ...
    public final boolean q0() {
        ...
        if (i22 != null && !this.M) {
            ...
            if (v3Var.j3() && !f5.f(v3Var.f14256l3, v3Var.f14257m3) && mkVar != null) {
                ...
                if (coVar != null) {
                    ...
                    MediaDataController.getInstance(mkVar.Q).saveDraft(coVar.a(), coVar.B7(coVar.f35353n5), charSequenceArr[0], MediaDataController.getInstance(mkVar.Q).getEntities(charSequenceArr, true, false), null, null, null, 0L, false, false, null);
                }
        ...
        long a2 = this.J.a();
        co coVar2 = this.J;
        mediaDataController.saveDraft(a2, coVar2.B7(coVar2.f35353n5), "", null, null, null, null, 0L, false, false, i22);
    ...
    public final void s0(final int i10, final int i11, final boolean z10) {
        if (m0()) {
            ...
            if (!this.P.L3()) {
                ...
                co coVar = this.J;
                final MessageObject messageObject = coVar.f35353n5;
    ...
    public final void y0() {
        ...
        if (!arrayList.isEmpty() && textSelectionHelper != null && textSelectionHelper.y()) {
            ...
            if (this.P.K3()) {
                ...
                int i10 = textSelectionHelper2.f22501u0;
                int i11 = textSelectionHelper2.f22502v0;
                int i12 = textSelectionHelper2.f22505y0;
                int i13 = textSelectionHelper2.f22503w0;
                int i14 = textSelectionHelper2.f22506z0;
                int size = arrayList.size();
                int i15 = 0;
                while (i15 < size) {
                ...
                h1 r22 = this.P.r2(textSelectionHelper3.f22501u0);
                int i16 = textSelectionHelper3.f22503w0;
                int i17 = textSelectionHelper3.f22506z0;
                if (r22 == null) {
                    max = 0;
                } else {
                ...
                int i19 = textSelectionHelper.f22501u0;
                int i20 = textSelectionHelper.f22504x0;
                int i21 = textSelectionHelper.f22503w0;
                int i22 = textSelectionHelper.f22506z0;
