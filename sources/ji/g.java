...
public final class g implements Runnable {
    ...
    public final void run() {
        switch (this.f13056a) {
            case 0:
                n nVar = (n) this.d;
                ArrayList arrayList = (ArrayList) this.f13058c;
                ...
                while (i10 < size) {
                    ...
                    i10++;
                    s4.i iVar = (s4.i) obj;
                    nVar.T(iVar.f43010a, iVar, this.f13057b);
                }
                arrayList.clear();
                nVar.f43022u.remove(arrayList);
                return;
            case 1:
            ...
            default:
                try {
                    ((yc.i) this.d).f46975a.bind(new InetSocketAddress(61578));
                    this.f13057b = true;
                    do {
                        try {
                            Socket accept = ((yc.i) this.d).f46975a.accept();
                            accept.setSoTimeout(5000);
                            InputStream inputStream = accept.getInputStream();
                            yc.i iVar2 = (yc.i) this.d;
                            iVar2.f46977c.C(new yc.a(iVar2, inputStream, accept));
                        } catch (IOException e) {
                            yc.i.d.log(Level.FINE, "Communication with the client broken", (Throwable) e);
                        }
                    } while (!((yc.i) this.d).f46975a.isClosed());
                    return;
