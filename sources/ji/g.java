        ...
        switch (this.f13067a) {
            case 0:
                ...
                while (i10 < size) {
                    ...
                    i10++;
                    s4.i iVar = (s4.i) obj;
                    nVar.T(iVar.f42748a, iVar, this.f13068b);
                }
                arrayList.clear();
                nVar.f42760u.remove(arrayList);
                return;
            case 1:
                ActionBarLayout actionBarLayout = (ActionBarLayout) this.d;
                if (actionBarLayout.e == this) {
                    actionBarLayout.e = null;
                    ((o2) this.f13069c).onTransitionAnimationStart(true, false);
            ...
            default:
                try {
                    ((yc.i) this.d).f46720a.bind(new InetSocketAddress(61578));
                    this.f13068b = true;
                    do {
                        try {
                            Socket accept = ((yc.i) this.d).f46720a.accept();
                            accept.setSoTimeout(5000);
                            InputStream inputStream = accept.getInputStream();
                            yc.i iVar2 = (yc.i) this.d;
                            iVar2.f46722c.y(new yc.a(iVar2, inputStream, accept));
                        } catch (IOException e) {
                            yc.i.d.log(Level.FINE, "Communication with the client broken", (Throwable) e);
                        }
                    } while (!((yc.i) this.d).f46720a.isClosed());
                    return;
