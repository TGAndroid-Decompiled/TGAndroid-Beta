...
public final class z extends a0 implements org.telegram.ui.ActionBar.z5, p9, l0, NotificationCenter.NotificationCenterDelegate, DownloadController.FileDownloadProgressListener {
    ...
    public final org.telegram.ui.ActionBar.f6 f14386r;
    public final Paint f14387s;
    public final TextPaint v;
    public final RadialProgress2 f14388w;
    public final bo0 f14389x;
    public final int f14390y;

    public z(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f14387s = new Paint(1);
        ...
        this.f14390y = DownloadController.getInstance(i10).generateObserverTag();
        RadialProgress2 radialProgress2 = new RadialProgress2(this, f6Var);
        this.f14388w = radialProgress2;
    ...
    private TLRPC.Document getDisplayDocument() {
        u uVar;
        a aVar = this.f13775a;
        if (aVar != null && (uVar = aVar.f13762g) != null) {
    ...
    @Override
    public final void d() {
        this.f14387s.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f21008uf, this.f14386r));
        k0 k0Var = this.U;
        if (k0Var != null) {
            k0Var.a();
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (messageObject != null && i11 == this.f14385n) {
    ...
    public final void f(int i10) {
        ...
        int i12 = this.G;
        int i13 = this.F;
        this.f14388w.q(i11, i13, i11 + i12, i12 + i13);
        requestLayout();
        invalidate();
    }
    ...
    public final void i(a aVar, p3 p3Var) {
        ...
        this.f13775a = aVar;
        this.O = p3Var;
        if (aVar != null && aVar.f13762g == null) {
            aVar.f13762g = new u();
        }
        ...
        if (j() && this.P == null && displayDocument != null) {
            ...
            tL_message.out = true;
            tL_message.f19917id = -Long.valueOf(displayDocument.f19902id).hashCode();
            tL_message.peer_id = new TLRPC.TL_peerUser();
            TLRPC.TL_peerUser tL_peerUser = new TLRPC.TL_peerUser();
            tL_message.from_id = tL_peerUser;
            TLRPC.Peer peer = tL_message.peer_id;
            int i10 = this.f14385n;
            ...
            if (aVar2 != null && (uVar = aVar2.f13762g) != null && !TextUtils.isEmpty(uVar.f14224e)) {
                tL_message.attachPath = this.f13775a.f13762g.f14224e;
            }
    ...
    public final boolean j() {
        u uVar;
        a aVar = this.f13775a;
        if (aVar != null && (uVar = aVar.f13762g) != null && uVar.b()) {
            return true;
        }
        return false;
    }
    ...
    public final boolean k() {
        u uVar;
        a aVar = this.f13775a;
        if (aVar != null && (uVar = aVar.f13762g) != null && uVar.a()) {
            return true;
        }
        return false;
    }
    ...
    public final void l() {
        ...
        this.f14389x.j(this.K, AndroidUtilities.dp(30.0f));
    }
    ...
    public final void m(boolean z10) {
        ...
        RadialProgress2 radialProgress2 = this.f14388w;
        radialProgress2.g(i10, i11, i12, i13);
        radialProgress2.d = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Bd, this.f14386r);
        boolean k10 = k();
        int i14 = this.f14385n;
        if (k10) {
            DownloadController.getInstance(i14).removeLoadingFileObserver(this);
            radialProgress2.o(this.f13775a.f13762g.f14225f, z10);
            radialProgress2.setIcon(3, false, z10);
            n();
            return;
        }
        if (j()) {
            document = this.f13775a.f13762g.h;
        } else {
            document = null;
        }
        ...
        a aVar = this.f13775a;
        int i15 = 1;
        if (aVar != null && (uVar = aVar.f13762g) != null && !TextUtils.isEmpty(uVar.f14224e) && new File(this.f13775a.f13762g.f14224e).exists()) {
            z11 = true;
        } else {
            z11 = false;
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (getDisplayDocument() != null) {
            this.f14388w.draw(canvas);
            int i11 = org.telegram.ui.ActionBar.j6.f21006ud;
            org.telegram.ui.ActionBar.f6 f6Var = this.f14386r;
            int v02 = org.telegram.ui.ActionBar.j6.v0(i11, f6Var);
            int v03 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f21023vd, f6Var);
            int i12 = org.telegram.ui.ActionBar.j6.f21058xd;
            int v04 = org.telegram.ui.ActionBar.j6.v0(i12, f6Var);
            int v05 = org.telegram.ui.ActionBar.j6.v0(i12, f6Var);
            int v06 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f21041wd, f6Var);
            bo0 bo0Var = this.f14389x;
            ...
            int v07 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20878nd, f6Var);
            TextPaint textPaint = this.v;
            ...
            p3 p3Var = this.O;
            if (p3Var != null && (textSelectionHelper = p3Var.f14138a.getTextSelectionHelper()) != null && textSelectionHelper.y() && (getParent() instanceof RecyclerView)) {
                ...
                if (R >= 0 && R > textSelectionHelper.f22527u0 && R <= textSelectionHelper.f22530x0) {
                    ...
                    canvas.drawRoundRect(dp, dp2, (width - i13) - AndroidUtilities.dp(8.0f), AndroidUtilities.dp(64.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), this.f14387s);
                }
            }
        }
    }
    ...
    public final void onProgressDownload(String str, long j3, long j10) {
        ...
        this.f14388w.o(Math.min(1.0f, f7), true);
        if (this.R != 3) {
            m(true);
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!k()) {
            if (this.f14389x.f(x10 - this.I, y3 - this.J, actionMasked)) {
                if (actionMasked == 0) {
            ...
            if (this.S) {
                ...
                if (k()) {
                    ...
                    if (p3Var != null) {
                        ...
                        d5 d5Var = (d5) v3Var.Z3.remove(aVar.f13762g);
                        if (d5Var != null) {
                            d5Var.b();
                        }
