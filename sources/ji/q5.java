...
public final class q5 extends g51 {
    ...
    public final void bindView(View view, h51 h51Var, boolean z10, v51 v51Var, d61 d61Var) {
        ...
        s5Var.f13775a = aVar;
        s5Var.E = b3Var;
        s5Var.f14197y = LocaleController.isRTL;
        s5Var.c(aVar);
        ...
        if (aVar2 != null) {
            ...
            if (pageBlock2 instanceof TL_iv.pageBlockTable) {
                ...
                h1Var.setAutoBold(s5Var.f13775a.f13772r);
        ...
        s5Var.d();
        s5Var.f14195w.requestLayout();
    }

    @Override
    public final View createView(Context context, ll0 ll0Var, int i10, int i11, org.telegram.ui.ActionBar.f6 f6Var) {
        s5 s5Var = new s5(context, f6Var);
        s5Var.setBackground(new z1(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20690d6, f6Var)));
        return s5Var;
    }
