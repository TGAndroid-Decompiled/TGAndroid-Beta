...
public final class d3 implements d6 {
    ...
    public final int a(a aVar) {
        float f7;
        int i10;
        v3 v3Var = this.f13887a;
        int indexOf = v3Var.f14282l3.indexOf(aVar);
        if (indexOf >= 0 && (i10 = indexOf + 1) < v3Var.f14282l3.size() && ((a) v3Var.f14282l3.get(i10)).f13759c > 0) {
            f7 = 5.0f;
        } else {
            f7 = 11.0f;
        }
    ...
    public final int b(a aVar) {
        ...
        v3 v3Var = this.f13887a;
        int indexOf = v3Var.f14282l3.indexOf(aVar);
        if (indexOf > 0 && ((a) v3Var.f14282l3.get(indexOf - 1)).f13759c > 0) {
            f7 = 2.0f;
        } else {
            f7 = 8.0f;
        }
    ...
    public final void c(a aVar, int i10) {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                return;
            case 3:
                r.U(v3Var.getContext(), "", new bi.o1(v3Var, 28), v3Var.f14273g3);
                return;
            case 4:
            case 5:
                t3Var.e(1);
    ...
    public final void d(a aVar, TL_iv.PageBlock pageBlock, int i10, int i11, boolean z10, boolean z11) {
        ...
        if (z13) {
            ...
            if (aVar != null) {
                ...
                if (v3Var.f14282l3.indexOf(aVar) >= 0 && !v3.w3(aVar) && !aVar.f13763i) {
                    g2 g2Var = v3Var.J3;
                    if (g2Var != null) {
                        g2Var.d();
                    }
                    if (arrayList.isEmpty() && !g6.p(aVar.f13758b)) {
                        z12 = true;
                    } else {
                        z12 = false;
                    }
