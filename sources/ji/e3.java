...
public final class e3 implements c5 {
    ...
    public final void d(TLRPC.Document document) {
        ...
        v3 v3Var = this.d;
        FileLoader.getInstance(v3Var.f14245f3).setLocalPathTo(document, str);
        u uVar = this.f13884a;
        uVar.h = document;
        uVar.f14195a = 2;
        TL_iv.PageBlock pageBlock = this.f13885b.f13732b;
        if (pageBlock instanceof TL_iv.pageBlockDocument) {
            ((TL_iv.pageBlockDocument) pageBlock).document_id = document.f19875id;
        }
    ...
    public final void onError() {
        ...
        v3 v3Var = this.d;
        v3Var.Z3.remove(uVar);
        v3Var.f14256l3.remove(this.f13885b);
        v3Var.Y2.N(true);
        v3Var.f14249h3.onContentChanged();
    }
