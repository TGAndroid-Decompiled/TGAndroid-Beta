...
public abstract class d4 {
    public static void A(java.util.ArrayList r31, java.util.ArrayList r32, java.util.Map r33) {
        throw new UnsupportedOperationException("Method not decompiled: ji.d4.A(java.util.ArrayList, java.util.ArrayList, java.util.Map):void");
    }
    ...
    public static a B(c4 c4Var, boolean z10) {
        ...
        ArrayList f32 = v3.f3(pageblockcollage);
        ArrayList arrayList = c4Var.f13846e;
        ...
        while (i10 < size) {
            ...
            c4 c4Var2 = (c4) obj;
            if (!c4Var2.f13844b) {
                if ("figcaption".equals(c4Var2.f13843a)) {
                    charSequence = w(c4Var2);
                } else {
                    boolean equals = "video".equals(c4Var2.f13843a);
                    if (equals || "img".equals(c4Var2.f13843a)) {
    ...
    public static void D(c4 c4Var, ArrayList arrayList, int i10, boolean z10) {
        ...
        int i12;
        int i13 = i10 + 1;
        ArrayList arrayList3 = c4Var.f13846e;
        ...
        while (i15 < size) {
            ...
            i15++;
            c4 c4Var2 = (c4) obj;
            if (!c4Var2.f13844b && "li".equals(c4Var2.f13843a)) {
                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
                ArrayList arrayList4 = new ArrayList();
                ArrayList arrayList5 = c4Var2.f13846e;
                int size2 = arrayList5.size();
                int i16 = 0;
                while (i16 < size2) {
                    int i17 = i16 + 1;
                    c4 c4Var3 = (c4) arrayList5.get(i16);
                    if (!c4Var3.f13844b && ("ul".equals(c4Var3.f13843a) || "ol".equals(c4Var3.f13843a))) {
                        arrayList4.add(c4Var3);
                    } else if (c4Var3.f13844b) {
                        spannableStringBuilder.append((CharSequence) q(c4Var3.f13845c));
                    } else {
                ...
                if (!c4Var2.b("data-checkbox") && ((a2 = c4Var2.a("class")) == null || !a2.toLowerCase().contains("checkbox"))) {
                    z11 = false;
                } else {
                    z11 = true;
                }
                aVar.f13734e = z11;
                aVar.f13735f = c4Var2.b("data-checked");
                arrayList.add(aVar);
                ...
                while (i18 < size3) {
                    ...
                    i18++;
                    c4 c4Var4 = (c4) obj2;
                    D(c4Var4, arrayList, i13, "ol".equals(c4Var4.f13843a));
                }
                i14++;
            }
        }
    ...
    public static void F(StringBuilder sb2, List list, int[] iArr, int i10, int i11, int i12, int i13, int i14, b4 b4Var, boolean z10, int i15, Map map) {
        ...
        b4 b4Var2 = b4Var;
        int i18 = i15;
        ArrayList arrayList = b4Var2.f13791a;
        while (true) {
            int i19 = iArr[0];
            if (i19 > i17) {
                return;
            ...
            if (!aVar.f13737i) {
                if (aVar.f13739k.size() > i18) {
                    b4Var2.c(sb3);
                    Long l4 = (Long) ((a) list3.get(iArr[0])).f13739k.get(i18);
                    ...
                    while (true) {
                        ...
                        if (aVar2.f13739k.size() <= i18 || ((Long) aVar2.f13739k.get(i18)).longValue() != longValue) {
                            break;
                        }
                        i20 = i21;
                    }
                    ...
                    if (v3.w3(aVar)) {
                        ...
                        sb3.append(((TL_iv.pageBlockDetails) aVar3.f13732b).open ? "<details open>" : "<details>");
                        sb3.append("<summary>");
                        ...
                        b4Var4.c(sb3);
                        int i22 = iArr[0];
                        if (i22 <= i16 && i22 < list2.size() && ((a) list2.get(iArr[0])).f13737i) {
                            iArr[0] = iArr[0] + 1;
                        }
                        sb3.append("</details>");
                    } else {
                        i16 = i10;
                        list2 = list3;
                        if (aVar.f13733c > 0 && l(aVar.f13732b) != null) {
                            int i23 = aVar.f13733c;
                            ...
                            if (!arrayList.isEmpty() && ((Boolean) i2.g.h(1, arrayList)).booleanValue() != z11) {
                                b4Var2.b(sb3);
                            ...
                            if (pageBlock instanceof TL_iv.pageBlockDivider) {
                                ...
                                if (pageBlock instanceof TL_iv.pageBlockPhoto) {
                                    G(sb3, "img", ((TL_iv.pageBlockPhoto) pageBlock).photo_id, aVar.f13736g, pageBlock);
                                    sb3 = sb2;
                                } else if (pageBlock instanceof TL_iv.pageBlockVideo) {
                                    sb3 = sb2;
                                    G(sb3, "video", ((TL_iv.pageBlockVideo) pageBlock).video_id, aVar.f13736g, pageBlock);
                                } else if (pageBlock instanceof TL_iv.pageBlockAudio) {
                                    sb3 = sb2;
                                    G(sb3, "audio", ((TL_iv.pageBlockAudio) pageBlock).audio_id, aVar.f13736g, pageBlock);
                                } else if (pageBlock instanceof TL_iv.pageBlockDocument) {
                                    sb3 = sb2;
                                    G(sb3, "document", ((TL_iv.pageBlockDocument) pageBlock).document_id, aVar.f13736g, pageBlock);
                                } else {
                                    sb3 = sb2;
                                    ...
                                    if (v3.A3(pageBlock)) {
                                        ...
                                        if (pageblockmap.f20093w != 0) {
                                            sb3.append(" w=\"");
                                            sb3.append(pageblockmap.f20093w);
                                            sb3.append('\"');
                                        }
                                        if (pageblockmap.h != 0) {
                                            sb3.append(" h=\"");
    ...
    public static CharSequence K(a aVar, int i10, int i11, int i12, int i13, int i14) {
        ...
        int i16;
        if (v3.w3(aVar)) {
            A = i6.r(((TL_iv.pageBlockDetails) aVar.f13732b).title, null, true);
        } else {
            A = g6.A(aVar.f13732b);
        }
        if (A == null) {
    ...
    public static void e(SpannableStringBuilder spannableStringBuilder, c4 c4Var, int i10, String str, long j3) {
        ...
        while (i12 < size) {
            ...
            if (c4Var2.f13844b) {
                ...
                str2 = str;
                j10 = j3;
                j(spannableStringBuilder2, q(c4Var2.f13845c), i11, str2, j10);
            } else {
                spannableStringBuilder2 = spannableStringBuilder;
                i11 = i10;
                str2 = str;
    ...
    public static void f(SpannableStringBuilder spannableStringBuilder, c4 c4Var) {
        ...
        while (i10 < size) {
            ...
            if (c4Var2.f13844b) {
                spannableStringBuilder2 = spannableStringBuilder;
                j(spannableStringBuilder2, q(c4Var2.f13845c), 0, null, 0L);
            } else {
                spannableStringBuilder2 = spannableStringBuilder;
                if (!"cite".equals(c4Var2.f13843a)) {
    ...
    public static void g(java.lang.StringBuilder r22, java.lang.CharSequence r23) {
        throw new UnsupportedOperationException("Method not decompiled: ji.d4.g(java.lang.StringBuilder, java.lang.CharSequence):void");
    }
    ...
    public static void h(SpannableStringBuilder spannableStringBuilder, c4 c4Var, int i10, String str, long j3) {
        ...
        if ("button".equals(c4Var.f13843a) && (v = v(c4Var)) != null) {
        ...
        if (c4Var.f13846e.isEmpty() && !c4Var.f13844b) {
            return;
        }
    ...
    public static void i(StringBuilder sb2, String str, long j3, u uVar, TL_iv.PageBlock pageBlock) {
        ...
        if (uVar != null) {
            if (uVar.f14202j > 0) {
                sb2.append(" width=\"");
                sb2.append(uVar.f14202j);
                sb2.append('\"');
            }
            if (uVar.f14203k > 0) {
                sb2.append(" height=\"");
                sb2.append(uVar.f14203k);
                sb2.append('\"');
            }
        }
    ...
    public static void j(SpannableStringBuilder spannableStringBuilder, String str, int i10, String str2, long j3) {
        if (str != null && str.length() != 0) {
            ...
            if (i10 != 0) {
                ?? obj = new Object();
                obj.f28591a = i10 & 114975;
                spannableStringBuilder.setSpan(new o01(obj, AndroidUtilities.dp(SharedConfig.fontSize)), length, length2, 33);
            }
            if (str2 != null) {
    ...
    public static ji.a m(ji.c4 r8) {
        throw new UnsupportedOperationException("Method not decompiled: ji.d4.m(ji.c4):ji.a");
    }
            ...
            if (!c4Var2.f13844b) {
                ...
                switch (c10) {
                    case 0:
                        ...
                        ArrayList arrayList3 = c4Var2.f13846e;
                        ...
                        while (i12 < size2) {
                            ...
                            c4 c4Var3 = (c4) obj2;
                            if (!c4Var3.f13844b) {
                                if ("td".equals(c4Var3.f13843a) || "th".equals(c4Var3.f13843a)) {
                                    ...
                                    if (!"th".equals(c4Var3.f13843a) && !c4Var3.b("header")) {
                                        z10 = false;
                                    } else {
                                        z10 = true;
                                    }
                                    k6.l(pagetablecell, z10);
    ...
    public static java.util.ArrayList z(java.lang.String r16, java.util.HashMap r17) {
        throw new UnsupportedOperationException("Method not decompiled: ji.d4.z(java.lang.String, java.util.HashMap):java.util.ArrayList");
    }
}
