...
public final class z0 extends a0 implements org.telegram.ui.ActionBar.z5, p9, l0, DownloadController.FileDownloadProgressListener {
    ...
    public final org.telegram.ui.ActionBar.f6 f14392r;
    public final Paint f14393s;
    public final Paint v;
    public final TextPaint f14394w;
    public final TextPaint f14395x;
    public final RadialProgress2 f14396y;

    public z0(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f14393s = new Paint(1);
        this.v = new Paint(1);
        this.f14394w = new TextPaint(1);
        this.f14395x = new TextPaint(1);
    ...
    @Override
    public final void d() {
        this.f14393s.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f21008uf, this.f14392r));
        k0 k0Var = this.F;
        if (k0Var != null) {
            k0Var.a();
        }
    ...
    public final void f(int i10) {
        ...
        int i13 = this.J;
        int i14 = this.I;
        this.f14396y.q(i13, i11, i13 + i14, i14 + i11);
        requestLayout();
    }
    ...
    public final void h(TLRPC.Document document) {
        ...
        if (z10) {
            ...
            if (q3Var == null) {
                ...
                messageObject = q3Var.f14155a.f14277i3;
            }
            imageReceiver.setImageCoords(this.K, AndroidUtilities.dp(10.0f), AndroidUtilities.dp(86.0f), AndroidUtilities.dp(86.0f));
    ...
    public final void k() {
        ...
        TextPaint textPaint = this.f14394w;
        textPaint.setTextSize(AndroidUtilities.dp(15.0f));
        textPaint.setTypeface(AndroidUtilities.bold());
        TextPaint textPaint2 = this.f14395x;
        textPaint2.setTextSize(AndroidUtilities.dp(13.0f));
        String documentFileName = FileLoader.getDocumentFileName(i13);
        if (TextUtils.isEmpty(documentFileName) && (uVar = this.f13775a.f13762g) != null && !TextUtils.isEmpty(uVar.f14224e)) {
            documentFileName = new File(this.f13775a.f13762g.f14224e).getName();
        }
        ...
        long j3 = i13.size;
        if (j3 <= 0) {
            u uVar2 = this.f13775a.f13762g;
            if (uVar2 != null && !TextUtils.isEmpty(uVar2.f14224e)) {
                j3 = new File(this.f13775a.f13762g.f14224e).length();
            } else {
                j3 = 0;
            }
        }
    ...
    public final void l(boolean r10) {
        throw new UnsupportedOperationException("Method not decompiled: ji.z0.l(boolean):void");
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        DownloadController.getInstance(this.f14391n).removeLoadingFileObserver(this);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (i() != null) {
            boolean z10 = this.L;
            org.telegram.ui.ActionBar.f6 f6Var = this.f14392r;
            ...
            int dp = AndroidUtilities.dp(f7) + i10;
            this.f14394w.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Dd, f6Var));
            ...
            this.f14395x.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20878nd, f6Var));
            ...
            if (this.S != null && (getParent() instanceof RecyclerView) && (textSelectionHelper = this.S.f14155a.getTextSelectionHelper()) != null && textSelectionHelper.y()) {
                ((RecyclerView) getParent()).getClass();
                int R = RecyclerView.R(this);
                if (R > textSelectionHelper.f22527u0 && R <= textSelectionHelper.f22530x0) {
                    if (this.M) {
                        i11 = 0;
                    } else {
                        i11 = this.f13777c;
                    ...
                    canvas.drawRoundRect(dp4, dp5, dp6, AndroidUtilities.dp(f10), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), this.f14393s);
                }
            }
        }
    }
    ...
    public final void onProgressDownload(String str, long j3, long j10) {
        ...
        this.f14396y.o(min, true);
    }

    @Override
    public final void onSuccessDownload(String str) {
        this.f14396y.o(1.0f, true);
        l(true);
    }

    @Override
    public final boolean onTouchEvent(android.view.MotionEvent r8) {
        throw new UnsupportedOperationException("Method not decompiled: ji.z0.onTouchEvent(android.view.MotionEvent):boolean");
    }
