...
public final class z0 extends a0 implements org.telegram.ui.ActionBar.z5, p9, l0, DownloadController.FileDownloadProgressListener {
    ...
    @Override
    public final void d() {
        this.f14393s.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f21009uf, this.f14392r));
        k0 k0Var = this.F;
        if (k0Var != null) {
            k0Var.a();
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (i() != null) {
            ...
            this.f14395x.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20879nd, f6Var));
            ...
            if (this.S != null && (getParent() instanceof RecyclerView) && (textSelectionHelper = this.S.f14155a.getTextSelectionHelper()) != null && textSelectionHelper.y()) {
                ...
                if (R > textSelectionHelper.f22528u0 && R <= textSelectionHelper.f22531x0) {
                    if (this.M) {
                        i11 = 0;
                    } else {
                        i11 = this.f13777c;
