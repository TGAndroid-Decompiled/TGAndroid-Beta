...
public final class z0 extends a0 implements org.telegram.ui.ActionBar.z5, p9, l0, DownloadController.FileDownloadProgressListener {
    ...
    @Override
    public final void d() {
        this.f14367s.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20982uf, this.f14366r));
        k0 k0Var = this.F;
        if (k0Var != null) {
            k0Var.a();
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (i() != null) {
            ...
            this.f14369x.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20852nd, f6Var));
            ...
            if (this.S != null && (getParent() instanceof RecyclerView) && (textSelectionHelper = this.S.f14129a.getTextSelectionHelper()) != null && textSelectionHelper.y()) {
                ...
                if (R > textSelectionHelper.f22501u0 && R <= textSelectionHelper.f22504x0) {
                    if (this.M) {
                        i11 = 0;
                    } else {
                        i11 = this.f13751c;
