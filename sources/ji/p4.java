...
public final class p4 extends a0 implements org.telegram.ui.ActionBar.z5, p9, l0 {
    ...
    public final void d() {
        ...
        this.f14142w.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f21009uf, f6Var));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (n4Var != null && (textSelectionHelper = ((r3) n4Var).f14170a.getTextSelectionHelper()) != null && textSelectionHelper.y() && (getParent() instanceof RecyclerView)) {
            ...
            if (R >= 0 && R > textSelectionHelper.f22528u0 && R <= textSelectionHelper.f22531x0) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        TL_iv.pageBlockMap map = getMap();
        if (map != null && map.f20119w > 0 && map.h > 0) {
            this.K = Math.max(Math.min((int) (((max - AndroidUtilities.dp(32.0f)) * map.h) / map.f20119w), AndroidUtilities.dp(420.0f)), AndroidUtilities.dp(120.0f));
        } else {
