...
public final class p4 extends a0 implements org.telegram.ui.ActionBar.z5, p9, l0 {
    ...
    @Override
    public final void d() {
        int i10 = org.telegram.ui.ActionBar.j6.f20888pe;
        ...
        this.f14116w.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20982uf, f6Var));
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (n4Var != null && (textSelectionHelper = ((r3) n4Var).f14144a.getTextSelectionHelper()) != null && textSelectionHelper.y() && (getParent() instanceof RecyclerView)) {
            ...
            if (R >= 0 && R > textSelectionHelper.f22501u0 && R <= textSelectionHelper.f22504x0) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        TL_iv.pageBlockMap map = getMap();
        if (map != null && map.f20092w > 0 && map.h > 0) {
            this.K = Math.max(Math.min((int) (((max - AndroidUtilities.dp(32.0f)) * map.h) / map.f20092w), AndroidUtilities.dp(420.0f)), AndroidUtilities.dp(120.0f));
        } else {
