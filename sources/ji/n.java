...
public abstract class n extends s4.j {
    ...
    public final void B(s4.h hVar) {
        ...
        if (view != null) {
            ...
            duration.translationX(hVar.e - hVar.f42749c);
            duration.translationY(hVar.f42750f - hVar.d);
            hVar2 = hVar;
    ...
    public final void U() {
        ...
        if (!this.K.isEmpty() && (y01Var = (y01) this.U.run()) != null) {
            ArrayList arrayList2 = y01Var.f30072c;
            if (!y01Var.e) {
                y01Var.e = true;
        ...
        if (transitionParams.top == 0 && transitionParams.bottom == 0 && transitionParams.left == 0 && transitionParams.right == 0) {
            ...
            while (true) {
                ...
                if (childAt instanceof t1) {
                    ...
                    if (t1Var.getTransitionParams().f20928v0 && groupedMessages.messages.contains(messageObject)) {
    ...
    public final void X(View view) {
        ...
        if (z10) {
            ...
            transitionParams.f21468b = false;
            transitionParams.f21469c = 1.0f;
        } else {
    ...
    public final boolean Z(View view) {
        ...
        if (!this.N && (U = this.G.U(view)) != null) {
            if (this.f42761q.contains(U) || this.f42768y.contains(U)) {
                return true;
            }
            return false;
        }
        ...
        if (a2 && this.N) {
            ...
            if (z10) {
                ...
                for (int i12 = 0; i12 < arrayList.size(); i12++) {
                    i10 += ((c1) arrayList.get(i12)).f42702a.getHeight();
                }
            } else {
                i10 = 0;
            }
            for (int i13 = 0; i13 < arrayList.size(); i13++) {
                ((c1) arrayList.get(i13)).f42702a.setTranslationY(i10);
            }
        }
        return a2;
    }
    ...
    public final boolean a0(View view) {
        c1 U = this.G.U(view);
        if (U != null) {
            if (this.f42760p.contains(U) || this.A.contains(U)) {
                return true;
            }
            return false;
        }
    ...
    public void g() {
        ...
        for (int size2 = arrayList2.size() - 1; size2 >= 0; size2--) {
            ...
            X(iVar.f42753a.f42702a);
            v(iVar.f42753a);
            arrayList2.remove(size2);
        }
        ArrayList arrayList3 = this.f42760p;
        ...
        ArrayList arrayList5 = this.f42763s;
        ...
        ArrayList arrayList8 = this.f42764t;
    ...
    public final q0 l(z0 z0Var, c1 c1Var, int i10, List list) {
        ...
        if (view instanceof t1) {
            ...
            obj.f13080c = transitionParams.f20838a;
            obj.d = transitionParams.f20842b;
            obj.e = transitionParams.f20847c;
    ...
    public final boolean q(c1 c1Var, c1 c1Var2, q0 q0Var, int i10, int i11, int i12, int i13) {
        ...
        view2.setAlpha(0.0f);
        this.f42763s.add(new s4.h(c1Var, c1Var2, i10, i11, i12, i13));
        F();
        return true;
    }
    ...
    public final boolean r(c1 c1Var, q0 q0Var, int i10, int i11, int i12, int i13) {
        ...
        if (view2 instanceof t1) {
            ...
            if (t1Var2.getTransitionParams().f20919s2 != t1Var2.getTopMediaOffset()) {
                i14 = (t1Var2.getTransitionParams().f20919s2 - t1Var2.getTopMediaOffset()) + i11;
            } else {
                i14 = i11;
            }
            t1Var = t1Var2;
        ...
        if (t1Var != null) {
            ...
            int[] iArr2 = transitionParams.f20921t0;
            ...
            if (z14) {
                ...
                l lVar = (l) q0Var;
                i15 = i20;
                if (transitionParams.f20928v0 && lVar.f13081f != f7 && lVar.e != f7) {
                    z13 = true;
                } else {
                    z13 = false;
                }
                ...
                if (z13) {
                    ...
                    ml0Var.invalidate();
                    transitionParams.f20861f0 = true;
                    if (t1Var.getMessageObject().isRoundVideo()) {
                        transitionParams.m0 = f12;
                        transitionParams.f20897n0 = f13;
                        transitionParams.f20901o0 = f18;
                        transitionParams.f20905p0 = f17;
                        transitionParams.A0 = iArr;
                    } else {
                        transitionParams.m0 = photoImage.getImageX();
                        transitionParams.f20897n0 = photoImage.getImageY();
                        transitionParams.f20901o0 = photoImage.getImageWidth();
                        transitionParams.f20905p0 = photoImage.getImageHeight();
                    ...
                    if (f19 == f20 && transitionParams.f20897n0 == lVar.d && transitionParams.f20905p0 == lVar.f13081f && transitionParams.f20901o0 == lVar.e && !transitionParams.B0) {
                        transitionParams.f20861f0 = false;
                        iVar.f13089n = false;
                    } else {
                        iVar.f13090o = f20;
                        iVar.f13091p = lVar.d;
                ...
                if (currentMessagesGroup == null && transitionParams.f20928v0 && (((isOutOwner = t1Var.getMessageObject().isOutOwner()) && rect.left != t1Var.getBackgroundDrawableLeft()) || ((!isOutOwner && rect.right != t1Var.getBackgroundDrawableRight()) || rect.top != t1Var.getBackgroundDrawableTop() || rect.bottom != t1Var.getBackgroundDrawableBottom()))) {
                    ...
                    iVar.f13087l = true;
                    transitionParams.f20932w0 = true;
                    transitionParams.f20866g0 = -iVar.f13094s;
                    transitionParams.f20870h0 = -iVar.f13095t;
                    transitionParams.f20880j0 = -iVar.f13096u;
                    transitionParams.f20875i0 = -iVar.v;
                    ml0Var.setClipChildren(false);
                    ml0Var.invalidate();
                }
            } else {
                    ...
                    while (i24 < ml0Var2.getChildCount()) {
                        ...
                        if (childAt instanceof t1) {
                            ...
                            if (t1Var3.getCurrentMessagesGroup() == currentMessagesGroup && !t1Var3.getMessageObject().deleted) {
                                ...
                                if (t1Var3.getTransitionParams().f20928v0 || transitionParams3.isNewGroup) {
            ...
            if (groupedMessages2 != null) {
                ...
                if (transitionParams.f20928v0) {
                    ...
                    iVar.f13087l = false;
                    transitionParams.f20866g0 = (int) ((-i16) - t1Var.getAnimationOffsetX());
                    transitionParams.f20870h0 = (int) ((-iVar.f13095t) - t1Var.getAnimationOffsetX());
                    transitionParams.f20880j0 = (int) ((-iVar.f13096u) - t1Var.getTranslationY());
                    transitionParams.f20875i0 = (int) ((-iVar.v) - t1Var.getTranslationY());
            ...
            if (!t1Var.f21132k8 && !t1Var.J && !z10) {
                z11 = false;
            } else {
                z11 = true;
            }
            if (transitionParams.f20940y0 != z11) {
                z12 = true;
                iVar.f13086k = true;
                f14 = 0.0f;
                transitionParams.f20944z0 = 0.0f;
            } else {
                f14 = 0.0f;
                z12 = true;
            }
            ...
            iVar.f13088m = a2;
            if (a2) {
                transitionParams5.f21468b = true;
                transitionParams5.f21469c = 0.0f;
            }
            if (i20 == 0 && i21 == 0 && !a2) {
                v(c1Var);
                return false;
