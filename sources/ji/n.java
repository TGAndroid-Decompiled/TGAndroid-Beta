...
public abstract class n extends s4.j {
    ...
    public final void B(s4.h hVar) {
        ...
        if (view != null) {
            ...
            duration.translationX(hVar.e - hVar.f42722c);
            duration.translationY(hVar.f42723f - hVar.d);
            hVar2 = hVar;
    ...
    public final void U() {
        ...
        if (!this.K.isEmpty() && (x01Var = (x01) this.U.run()) != null) {
            ArrayList arrayList2 = x01Var.f29842c;
            if (!x01Var.e) {
                x01Var.e = true;
        ...
        if (transitionParams.top == 0 && transitionParams.bottom == 0 && transitionParams.left == 0 && transitionParams.right == 0) {
            ...
            while (true) {
                ...
                if (childAt instanceof t1) {
                    ...
                    if (t1Var.getTransitionParams().f20917v0 && groupedMessages.messages.contains(messageObject)) {
    ...
    public final void X(View view) {
        ...
        if (z10) {
            ...
            transitionParams.f21457b = false;
            transitionParams.f21458c = 1.0f;
        } else {
    ...
    public final boolean Z(View view) {
        ...
        if (!this.N && (T = this.G.T(view)) != null) {
            if (this.f42734q.contains(T) || this.f42741y.contains(T)) {
                return true;
            }
            return false;
        }
        ...
        if (a2 && this.N) {
            ...
            if (z10) {
                ...
                for (int i12 = 0; i12 < arrayList.size(); i12++) {
                    i10 += ((c1) arrayList.get(i12)).f42675a.getHeight();
                }
            } else {
                i10 = 0;
            }
            for (int i13 = 0; i13 < arrayList.size(); i13++) {
                ((c1) arrayList.get(i13)).f42675a.setTranslationY(i10);
            }
        }
        return a2;
    }
    ...
    public final boolean a0(View view) {
        c1 T = this.G.T(view);
        if (T != null) {
            if (this.f42733p.contains(T) || this.A.contains(T)) {
                return true;
            }
            return false;
        }
    ...
    public void g() {
        ...
        for (int size2 = arrayList2.size() - 1; size2 >= 0; size2--) {
            ...
            X(iVar.f42726a.f42675a);
            v(iVar.f42726a);
            arrayList2.remove(size2);
        }
        ArrayList arrayList3 = this.f42733p;
        ...
        ArrayList arrayList5 = this.f42736s;
        ...
        ArrayList arrayList8 = this.f42737t;
    ...
    public final q0 l(z0 z0Var, c1 c1Var, int i10, List list) {
        ...
        if (view instanceof t1) {
            ?? obj = new Object();
            obj.f3198a = l4.f3198a;
            obj.f3199b = l4.f3199b;
            s1 transitionParams = ((t1) view).getTransitionParams();
            obj.f13077c = transitionParams.f20827a;
            obj.d = transitionParams.f20831b;
            obj.e = transitionParams.f20836c;
            obj.f13078f = transitionParams.d;
            return obj;
        }
        return l4;
    }
    ...
    public final boolean q(c1 c1Var, c1 c1Var2, q0 q0Var, int i10, int i11, int i12, int i13) {
        ...
        view2.setAlpha(0.0f);
        this.f42736s.add(new s4.h(c1Var, c1Var2, i10, i11, i12, i13));
        F();
        return true;
    }
    ...
    public final boolean r(c1 c1Var, q0 q0Var, int i10, int i11, int i12, int i13) {
        ...
        if (view2 instanceof t1) {
            ...
            if (t1Var2.getTransitionParams().f20908s2 != t1Var2.getTopMediaOffset()) {
                i14 = (t1Var2.getTransitionParams().f20908s2 - t1Var2.getTopMediaOffset()) + i11;
            } else {
                i14 = i11;
            }
            t1Var = t1Var2;
        ...
        if (t1Var != null) {
            ...
            int[] iArr2 = transitionParams.f20910t0;
            ...
            if (z14) {
                ...
                l lVar = (l) q0Var;
                i15 = i20;
                if (transitionParams.f20917v0 && lVar.f13078f != f7 && lVar.e != f7) {
                    z13 = true;
                } else {
                    z13 = false;
                }
                ...
                if (z13) {
                    ...
                    ll0Var.invalidate();
                    transitionParams.f20850f0 = true;
                    if (t1Var.getMessageObject().isRoundVideo()) {
                        transitionParams.m0 = f12;
                        transitionParams.f20886n0 = f13;
                        transitionParams.f20890o0 = f18;
                        transitionParams.f20894p0 = f17;
                        transitionParams.A0 = iArr;
                    } else {
                        transitionParams.m0 = photoImage.getImageX();
                        transitionParams.f20886n0 = photoImage.getImageY();
                        transitionParams.f20890o0 = photoImage.getImageWidth();
                        transitionParams.f20894p0 = photoImage.getImageHeight();
                    ...
                    float f20 = lVar.f13077c;
                    if (f19 == f20 && transitionParams.f20886n0 == lVar.d && transitionParams.f20894p0 == lVar.f13078f && transitionParams.f20890o0 == lVar.e && !transitionParams.B0) {
                        transitionParams.f20850f0 = false;
                        iVar.f13086n = false;
                    } else {
                        iVar.f13087o = f20;
                        iVar.f13088p = lVar.d;
                        iVar.f13089q = lVar.e;
                        iVar.f13090r = lVar.f13078f;
                        ...
                        t1Var.U3(iVar.f13087o, iVar.f13088p, iVar.f13089q, iVar.f13090r);
                    }
                }
                if (currentMessagesGroup == null && transitionParams.f20917v0 && (((isOutOwner = t1Var.getMessageObject().isOutOwner()) && rect.left != t1Var.getBackgroundDrawableLeft()) || ((!isOutOwner && rect.right != t1Var.getBackgroundDrawableRight()) || rect.top != t1Var.getBackgroundDrawableTop() || rect.bottom != t1Var.getBackgroundDrawableBottom()))) {
                    iVar.v = t1Var.getBackgroundDrawableBottom() - rect.bottom;
                    iVar.f13093u = t1Var.getBackgroundDrawableTop() - rect.top;
                    if (t1Var.G8 != transitionParams.E0) {
                        iVar.f13091s = t1Var.getBackgroundDrawableLeft() - rect.left;
                        iVar.f13092t = t1Var.getBackgroundDrawableRight() - rect.right;
                    } else if (isOutOwner) {
                        iVar.f13091s = t1Var.getBackgroundDrawableLeft() - rect.left;
                    } else {
                        iVar.f13092t = t1Var.getBackgroundDrawableRight() - rect.right;
                    ...
                    iVar.f13084l = true;
                    transitionParams.f20921w0 = true;
                    transitionParams.f20855g0 = -iVar.f13091s;
                    transitionParams.f20859h0 = -iVar.f13092t;
                    transitionParams.f20869j0 = -iVar.f13093u;
                    transitionParams.f20864i0 = -iVar.v;
                    ll0Var.setClipChildren(false);
                    ll0Var.invalidate();
                }
            } else {
                    ...
                    while (i24 < ll0Var2.getChildCount()) {
                        ...
                        if (childAt instanceof t1) {
                            ...
                            if (t1Var3.getCurrentMessagesGroup() == currentMessagesGroup && !t1Var3.getMessageObject().deleted) {
                                ...
                                if (t1Var3.getTransitionParams().f20917v0 || transitionParams3.isNewGroup) {
            ...
            if (groupedMessages2 != null) {
                ...
                if (transitionParams.f20917v0) {
                    ...
                    iVar.f13094w = true;
                    transitionParams.f20921w0 = true;
                    iVar.f13091s = backgroundDrawableLeft2 - transitionParams4.left;
                    iVar.f13092t = backgroundDrawableRight2 - transitionParams4.right;
                    iVar.f13093u = backgroundDrawableTop2 - transitionParams4.top;
                    iVar.v = backgroundDrawableBottom2 - transitionParams4.bottom;
                    iVar.f13084l = false;
                    transitionParams.f20855g0 = (int) ((-i16) - t1Var.getAnimationOffsetX());
                    transitionParams.f20859h0 = (int) ((-iVar.f13092t) - t1Var.getAnimationOffsetX());
                    transitionParams.f20869j0 = (int) ((-iVar.f13093u) - t1Var.getTranslationY());
                    transitionParams.f20864i0 = (int) ((-iVar.v) - t1Var.getTranslationY());
            ...
            if (!t1Var.f21121k8 && !t1Var.J && !z10) {
                z11 = false;
            } else {
                z11 = true;
            }
            if (transitionParams.f20929y0 != z11) {
                z12 = true;
                iVar.f13083k = true;
                f14 = 0.0f;
                transitionParams.f20933z0 = 0.0f;
            } else {
                f14 = 0.0f;
                z12 = true;
            }
            ...
            iVar.f13085m = f21;
            if (f21) {
                transitionParams.f20854g = z12;
                transitionParams.K1 = f14;
            }
            if (i15 == 0 && i21 == 0 && !iVar.f13086n && !iVar.f13094w && !iVar.f13082j && !iVar.f13083k && !iVar.f13084l && !f21) {
                v(c1Var);
                return false;
            }
        } else if (w0Var2 != null) {
            ...
            iVar.f13085m = a2;
            if (a2) {
                transitionParams5.f21457b = true;
                transitionParams5.f21458c = 0.0f;
            }
            if (i20 == 0 && i21 == 0 && !a2) {
                v(c1Var);
                return false;
    ...
    public final void s(c1 c1Var, q0 q0Var) {
        ...
        View view = c1Var.f42675a;
        if (q0Var != null) {
            int i10 = q0Var.f3199b;
            int top = view.getTop();
            int left = view.getLeft() - q0Var.f3198a;
            int i11 = top - i10;
            if (i11 != 0) {
            ...
            if (view instanceof t1) {
                ...
                if (q0Var instanceof l) {
                    l lVar = (l) q0Var;
                    t1Var.U3(lVar.f13077c, lVar.d, lVar.e, lVar.f13078f);
                }
            } else if (left != 0) {
