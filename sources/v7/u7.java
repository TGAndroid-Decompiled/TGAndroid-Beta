...
public abstract class u7 {
    ...
    public static android.graphics.drawable.NinePatchDrawable b(android.graphics.Bitmap[] r37, float[] r38, float r39, float r40, int r41, gh.f r42) {
        throw new UnsupportedOperationException("Method not decompiled: v7.u7.b(android.graphics.Bitmap[], float[], float, float, int, gh.f):android.graphics.drawable.NinePatchDrawable");
    }
