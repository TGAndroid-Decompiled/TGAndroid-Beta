...
public class r1 implements ja.a {
    ...
    public ja.a m(Class cls, ia.d dVar) {
        switch (this.f44027a) {
            case 4:
                ((HashMap) this.f44028b).put(cls, dVar);
    ...
    public String toString() {
        ...
        switch (this.f44027a) {
            case 1:
                ...
                sb2.append((String) this.f44028b);
                sb2.append('{');
                r1 r1Var = (r1) ((r1) this.f44029c).f44029c;
                while (r1Var != null) {
                    Object obj = r1Var.d;
                    sb2.append(str);
                    String str2 = (String) r1Var.f44028b;
                    if (str2 != null) {
                        sb2.append(str2);
                        sb2.append('=');
                    }
            ...
            case 11:
                ...
                sb3.append((String) this.f44028b);
                sb3.append('{');
                r1 r1Var2 = (r1) ((r1) this.d).f44029c;
                while (r1Var2 != null) {
                    Object obj2 = r1Var2.d;
                    sb3.append(str);
                    String str3 = (String) r1Var2.f44028b;
                    if (str3 != null) {
                        sb3.append(str3);
                        sb3.append('=');
                    }
    ...
    public r1(int i10) {
        ...
        switch (i10) {
            case 6:
                this.f44028b = new HashMap();
                this.d = new HashMap();
                this.f44029c = x7.d0.f45330c;
                return;
            case 12:
                this.f44028b = new HashMap();
                this.d = new HashMap();
                this.f44029c = z7.x.f48626c;
                return;
            default:
                this.f44028b = new HashMap();
                this.d = new HashMap();
                this.f44029c = w7.e.f44580c;
                return;
        }
    }
