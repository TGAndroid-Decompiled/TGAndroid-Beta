...
public final class i extends a7.c {
    public final int f45629b = 0;
    public final Object f45630c;
        ...
        switch (this.f45629b) {
            case 0:
                if (i10 == 1) {
                    ...
                    g7.b.a(parcel);
                    org.telegram.messenger.c cVar = (org.telegram.messenger.c) this.f45630c;
                    lambda$setOnMarkerClickListener$1 = ((GoogleMapsProvider.GoogleMapImpl) cVar.f16890b).lambda$setOnMarkerClickListener$1((IMapsProvider.OnMarkerClickListener) cVar.f16891c, new x7.f(aVar));
            ...
            case 2:
                if (i10 == 1) {
                    ...
                    g7.b.a(parcel);
                    c cVar2 = new c(aVar2);
                    k4 k4Var = (k4) ((f) this.f45630c);
                    k4Var.f17629a.lambda$getMapAsync$0(k4Var.f17630b, cVar2);
                    parcel2.writeNoException();
                    return true;
                }
                return false;
            case 3:
                if (i10 == 1) {
                    ...
                    g7.b.a(parcel);
                    ((i4) this.f45630c).f17450b.accept((Location) l6.b.K0(J0));
                    parcel2.writeNoException();
                    return true;
                }
                return false;
            ...
            case 5:
                if (i10 == 1) {
                    ...
                    g7.b.a(parcel);
                    GoogleMapsProvider.GoogleMapImpl.lambda$setOnCameraMoveStartedListener$0((IMapsProvider.OnCameraMoveStartedListener) ((org.telegram.messenger.d) this.f45630c).f17011b, readInt);
                    parcel2.writeNoException();
                    return true;
                }
                return false;
