...
public enum j6 implements f {
    ON_DEVICE_LANGUAGE_IDENTIFICATION_LOAD(0),
    ON_DEVICE_SMART_REPLY_LOAD(1),
    ON_DEVICE_SMART_REPLY_CLOSE(2),
    ...
    ON_DEVICE_LANGUAGE_IDENTIFICATION_LOAD(142),
    ON_DEVICE_SMART_REPLY_LOAD(143),
    ON_DEVICE_IMAGE_LABEL_LOAD(144),
    ON_DEVICE_LANGUAGE_IDENTIFICATION_LOAD(151),
    ON_DEVICE_SMART_REPLY_LOAD(152),
    ON_DEVICE_SMART_REPLY_CLOSE(153),
    ON_DEVICE_LANGUAGE_IDENTIFICATION_LOAD(154),
