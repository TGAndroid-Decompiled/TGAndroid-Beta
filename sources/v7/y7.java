...
public abstract class y7 {
    ...
    public static int[] f(Collection collection) {
        if (collection instanceof h9.b) {
            ...
            return Arrays.copyOfRange(bVar.f10155a, bVar.f10156b, bVar.f10157c);
        }
    ...
    public static Integer g(String str) {
        ...
        if (!str.isEmpty()) {
            ...
            if (i10 != str.length()) {
                ...
                if (charAt < 128) {
                    b10 = h9.c.f10158a[charAt];
                } else {
                    byte[] bArr = h9.c.f10158a;
                    b10 = -1;
                }
                if (b10 >= 0 && b10 < 10) {
                    long j3 = -b10;
                    ...
                    while (true) {
                        if (i11 < str.length()) {
                            ...
                            if (charAt2 < 128) {
                                b11 = h9.c.f10158a[charAt2];
                            } else {
                                byte[] bArr2 = h9.c.f10158a;
                                b11 = -1;
                            }
