...
public final class j implements ia.e {
    public static final Charset f44003f = Charset.forName("UTF-8");
    public static final ia.c f44004g = new ia.c("key", hg.c.o(org.telegram.ui.Cells.q3.k(h.class, new e(1))));
    public static final ia.c h = new ia.c("value", hg.c.o(org.telegram.ui.Cells.q3.k(h.class, new e(2))));
    public static final i f44005i = i.f43992b;
    public OutputStream f44006a;
    public final HashMap f44007b;
    public final HashMap f44008c;
    public final ia.d d;
    ...
    public j(ByteArrayOutputStream byteArrayOutputStream, HashMap hashMap, HashMap hashMap2, ia.d dVar) {
        this.f44006a = byteArrayOutputStream;
        this.f44007b = hashMap;
        this.f44008c = hashMap2;
        this.d = dVar;
    }
    ...
    public final void b(ia.c cVar, double d, boolean z10) {
        ...
        k((i(cVar) << 3) | 1);
        this.f44006a.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putDouble(d).array());
    }
        ...
        if (obj != null) {
            if (obj instanceof CharSequence) {
                ...
                if (!z10 || charSequence.length() != 0) {
                    k((i(cVar) << 3) | 2);
                    byte[] bytes = charSequence.toString().getBytes(f44003f);
                    k(bytes.length);
                    this.f44006a.write(bytes);
                }
                ...
                if (!z10 || floatValue != 0.0f) {
                    k((i(cVar) << 3) | 5);
                    this.f44006a.write(ByteBuffer.allocate(4).order(ByteOrder.LITTLE_ENDIAN).putFloat(floatValue).array());
                }
                ...
                ia.d dVar = (ia.d) this.f44007b.get(obj.getClass());
                if (dVar != null) {
                    j(dVar, cVar, obj, z10);
                    return;
                }
                ia.f fVar = (ia.f) this.f44008c.get(obj.getClass());
                if (fVar != null) {
                    la.h hVar2 = this.e;
                    hVar2.f13943b = false;
                    hVar2.d = cVar;
    ...
    public final void j(ia.d dVar, ia.c cVar, Object obj, boolean z10) {
        ...
        bVar.f13932b = 0L;
        try {
            OutputStream outputStream = this.f44006a;
            this.f44006a = bVar;
            dVar.a(obj, this);
