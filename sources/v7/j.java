...
public final class j implements ia.e {
    public static final Charset f47480f = Charset.forName("UTF-8");
    public static final ia.c f47481g = new ia.c("key", i2.g.n(org.telegram.ui.Cells.p6.k(h.class, new e(1))));
    public static final ia.c h = new ia.c("value", i2.g.n(org.telegram.ui.Cells.p6.k(h.class, new e(2))));
    public static final i f47482i = i.f47469b;
    public OutputStream f47483a;
    public final HashMap f47484b;
    public final HashMap f47485c;
    public final ia.d d;
    public final la.h f47486e = new la.h(this, 1);

    public j(ByteArrayOutputStream byteArrayOutputStream, HashMap hashMap, HashMap hashMap2, ia.d dVar) {
        this.f47483a = byteArrayOutputStream;
        this.f47484b = hashMap;
        this.f47485c = hashMap2;
        this.d = dVar;
    }
    ...
    public final void b(ia.c cVar, double d, boolean z10) {
        ...
        k((i(cVar) << 3) | 1);
        this.f47483a.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putDouble(d).array());
    }
        ...
        if (obj != null) {
            if (obj instanceof CharSequence) {
                ...
                if (!z10 || charSequence.length() != 0) {
                    k((i(cVar) << 3) | 2);
                    byte[] bytes = charSequence.toString().getBytes(f47480f);
                    k(bytes.length);
                    this.f47483a.write(bytes);
                }
                ...
                if (!z10 || floatValue != 0.0f) {
                    k((i(cVar) << 3) | 5);
                    this.f47483a.write(ByteBuffer.allocate(4).order(ByteOrder.LITTLE_ENDIAN).putFloat(floatValue).array());
                }
                ...
                k((i(cVar) << 3) | 2);
                k(bArr.length);
                this.f47483a.write(bArr);
            } else {
                ia.d dVar = (ia.d) this.f47484b.get(obj.getClass());
                if (dVar != null) {
                    j(dVar, cVar, obj, z10);
                    return;
                }
                ia.f fVar = (ia.f) this.f47485c.get(obj.getClass());
                if (fVar != null) {
                    la.h hVar2 = this.f47486e;
                    hVar2.f15334b = false;
                    hVar2.d = cVar;
                    hVar2.f15335c = z10;
                    fVar.a(obj, hVar2);
    ...
    public final void j(ia.d dVar, ia.c cVar, Object obj, boolean z10) {
        ...
        bVar.f15322b = 0L;
        try {
            OutputStream outputStream = this.f47483a;
            this.f47483a = bVar;
            dVar.a(obj, this);
            this.f47483a = outputStream;
