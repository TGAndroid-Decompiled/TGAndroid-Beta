...
public final class j implements ia.e {
    public static final Charset f44261f = Charset.forName("UTF-8");
    public static final ia.c f44262g = new ia.c("key", hg.k0.m(t8.b.l(h.class, new e(1))));
    public static final ia.c h = new ia.c("value", hg.k0.m(t8.b.l(h.class, new e(2))));
    public static final i f44263i = i.f44250b;
    public OutputStream f44264a;
    public final HashMap f44265b;
    public final HashMap f44266c;
    public final ia.d d;
    ...
    public j(ByteArrayOutputStream byteArrayOutputStream, HashMap hashMap, HashMap hashMap2, ia.d dVar) {
        this.f44264a = byteArrayOutputStream;
        this.f44265b = hashMap;
        this.f44266c = hashMap2;
        this.d = dVar;
    }
    ...
    public final void b(ia.c cVar, double d, boolean z10) {
        ...
        k((i(cVar) << 3) | 1);
        this.f44264a.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putDouble(d).array());
    }
        ...
        if (obj != null) {
            if (obj instanceof CharSequence) {
                ...
                if (!z10 || charSequence.length() != 0) {
                    k((i(cVar) << 3) | 2);
                    byte[] bytes = charSequence.toString().getBytes(f44261f);
                    k(bytes.length);
                    this.f44264a.write(bytes);
                }
                ...
                if (!z10 || floatValue != 0.0f) {
                    k((i(cVar) << 3) | 5);
                    this.f44264a.write(ByteBuffer.allocate(4).order(ByteOrder.LITTLE_ENDIAN).putFloat(floatValue).array());
                }
                ...
                k((i(cVar) << 3) | 2);
                k(bArr.length);
                this.f44264a.write(bArr);
            } else {
                ia.d dVar = (ia.d) this.f44265b.get(obj.getClass());
                if (dVar != null) {
                    j(dVar, cVar, obj, z10);
                    return;
                }
                ia.f fVar = (ia.f) this.f44266c.get(obj.getClass());
                if (fVar != null) {
                    la.h hVar2 = this.e;
                    hVar2.f14101b = false;
                    hVar2.d = cVar;
    ...
    public final void j(ia.d dVar, ia.c cVar, Object obj, boolean z10) {
        ...
        bVar.f14090b = 0L;
        try {
            OutputStream outputStream = this.f44264a;
            this.f44264a = bVar;
            dVar.a(obj, this);
            this.f44264a = outputStream;
