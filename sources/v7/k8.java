...
public abstract class k8 {
    public static Context f44310a;
    public static i8.e f44311b;
    ...
    public static Context b(Context context) {
        Context context2;
        Context context3 = f44310a;
        if (context3 == null) {
            context.getApplicationContext();
            try {
                context2 = y6.e.c(context, y6.e.f46599b, "com.google.android.gms.maps_dynamite").f46608a;
            } catch (Exception e) {
                try {
