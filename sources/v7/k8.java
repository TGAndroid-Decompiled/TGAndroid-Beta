...
public abstract class k8 {
    public static Context f44326a;
    public static i8.e f44327b;
    ...
    public static Context b(Context context) {
        Context context2;
        Context context3 = f44326a;
        if (context3 == null) {
            context.getApplicationContext();
            try {
                context2 = y6.e.c(context, y6.e.f46621b, "com.google.android.gms.maps_dynamite").f46630a;
            } catch (Exception e) {
                try {
