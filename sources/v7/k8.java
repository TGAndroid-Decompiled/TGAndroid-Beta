...
public abstract class k8 {
    public static Context f44295a;
    public static i8.e f44296b;
    ...
    public static Context b(Context context) {
        Context context2;
        Context context3 = f44295a;
        if (context3 == null) {
            context.getApplicationContext();
            try {
                context2 = y6.e.c(context, y6.e.f46587b, "com.google.android.gms.maps_dynamite").f46596a;
            } catch (Exception e) {
                try {
