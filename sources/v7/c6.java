...
public abstract class c6 {
    public static int a(byte[] bArr, int i10, com.google.android.gms.internal.play_billing.h1 h1Var) {
        ...
        int i11 = h1Var.f6792a;
        if (i11 >= 0) {
            if (i11 <= bArr.length - f7) {
                if (i11 == 0) {
                    h1Var.d = com.google.android.gms.internal.play_billing.l1.f6827c;
                    return f7;
                }
    ...
    public static int d(byte[] bArr, int i10, com.google.android.gms.internal.play_billing.z1 z1Var, com.google.android.gms.internal.play_billing.h1 h1Var) {
        ...
        int f7 = f(bArr, i10, h1Var);
        int i11 = h1Var.f6792a + f7;
        while (f7 < i11) {
            f7 = f(bArr, f7, h1Var);
            w1Var.o(h1Var.f6792a);
        }
        if (f7 == i11) {
            return f7;
        }
        ...
        if ((i10 >>> 3) != 0) {
            ...
            if (i13 != 0) {
                if (i13 != 1) {
                    ...
                    int i18 = h1Var.f6792a;
                    if (i18 >= 0) {
                        if (i18 <= bArr.length - f10) {
                            if (i18 == 0) {
                                x2Var.c(i10, com.google.android.gms.internal.play_billing.l1.f6827c);
                            } else {
            ...
            x2Var.c(i10, Long.valueOf(h1Var.f6794c));
            return i19;
        }
        throw new IOException("Protocol message contained an invalid tag (zero).");
    }
